...
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-CrG2dtax.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-BKS5g1TA.js";
import { n as isSingleUseReplyToMode } from "./reply-reference-Dxfg7IJx.js";
import { f as readNumberParam, g as readStringParam } from "./common-CqwERhgW.js";
import { c as normalizeMessagePresentation, s as normalizeInteractiveReply } from "./payload-DRvk5ABz.js";
import { n as resolveOutboundSendDep } from "./send-deps-YirS1bXi.js";
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-D37zitas.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-D_CGjCaV.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-DzbBEhwq.js";
import "./text-runtime-FOsx_CPC.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-B2c9_N7p.js";
import "./channel-core-B5hKA5Gy.js";
import "./routing-DfF4_bqH.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-Dsao2Woi.js";
...
import { i as createPairingPrefixStripper } from "./channel-pairing-DWcD6g9Y.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-ml9CygpH.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-DHN_bsdg.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-DwcF2L4t.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-BMknLxiQ.js";
import "./approval-delivery-runtime-BVbexBbC.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-EvUxh8Bh.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-DE4jDHHH.js";
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-CLLhLvMf.js";
import "./approval-native-runtime-B50UAOT8.js";
import "./reply-reference-y0SQru-n.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-BGMHIQHx.js";
import "./param-readers-BrNoWg31.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-Dv3U81GE.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-DOG-_jHi.js";
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-CYBrfQwr.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-Cs8B53vs.js";
import { n as resolveSlackThreadTsValue, r as SLACK_TEXT_LIMIT, t as normalizeSlackThreadTsCandidate } from "./thread-ts-DhEg7c-_.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-CMd41sLM.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-Bm2hV3f_.js";
import "./channel-api-CbKRkqtO.js";
import { r as createSlackWebClient } from "./client-DwrbGc7N.js";
import { r as normalizeAllowListLower } from "./allow-list-CSsWSeya.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-ByCr2Aaf.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-DH4I3AwX.js";
import { t as getOptionalSlackRuntime } from "./runtime-BEsga9cw.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-CPP9l50B.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-CPU8PGsg.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-Bv-smuFc.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-Cf66b9XF.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-mDPB6gBs.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-DmBl4BV-.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BK7XFYPz.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-DxOCD136.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CQ4o-Vwj.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-CSp5Lsgl.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-DadpZp5D.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-CgT1cJ43.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-BooIwY9N.js");
