...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-nsOwblXq.js";
import { t as formatHelpExamples } from "./help-format-M6OA6DMb.js";
import { t as runSecurityAudit } from "./audit-Dkn7QBKV.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled--j88IAri.js");
