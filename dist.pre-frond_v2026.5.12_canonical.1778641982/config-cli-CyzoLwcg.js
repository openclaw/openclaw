...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-3aotPWYV.js";
...
import { n as info, o as success, t as danger } from "./globals-BHVmraBM.js";
import { a as resolveSecretRefValue } from "./resolve-CS0U7KoA.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-C04VWQdx.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-DaaH055I.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Cm4mTdD7.js";
import { r as replaceConfigFile } from "./mutate-D5WWJ2kC.js";
import "./config-Dk0DnRek.js";
import { n as redactConfigObject } from "./redact-snapshot-jIBoVBkE.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-D4ZwerCg.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-DbgmDVMU.js";
import { n as setCommandJsonMode } from "./json-mode-DqS6WQkr.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BrzI_WZD.js");
