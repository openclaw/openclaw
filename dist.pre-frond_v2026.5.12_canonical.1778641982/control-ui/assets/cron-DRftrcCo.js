import{h as e,o as t,p as n}from"./string-coerce-LMp5Q49X.js";import{L as r,U as i,V as a,_ as o,a as s,d as c,n as l,p as u,v as d}from"./index-DiKZIuHp.js";function f(){return[{value:`ok`,label:t(`cron.runs.runStatusOk`)},{value:`error`,label:t(`cron.runs.runStatusError`)},{value:`skipped`,label:t(`cron.runs.runStatusSkipped`)}]}function p(){return[{value:`delivered`,label:t(`cron.runs.deliveryDelivered`)},{value:`not-delivered`,label:t(`cron.runs.deliveryNotDelivered`)},{value:`unknown`,label:t(`cron.runs.deliveryUnknown`)},{value:`not-requested`,label:t(`cron.runs.deliveryNotRequested`)}]}function m(e,t,n){let r=new Set(e);return n?r.add(t):r.delete(t),Array.from(r)}function h(e,t){return e.length===0?t:e.length<=2?e.join(`, `):`${e[0]} +${e.length-1}`}function g(e){let t=[`last`,...e.channels.filter(Boolean)],n=e.form.deliveryChannel?.trim();n&&!t.includes(n)&&t.push(n);let r=new Set;return t.filter(e=>r.has(e)?!1:(r.add(e),!0))}function _(e,t){if(t===`last`)return`last`;let n=e.channelMeta?.find(e=>e.id===t);return n?.label?n.label:e.channelLabels?.[t]??t}function v(n){return e`
            ...
            <div class="form-grid cron-form-grid">
              <label class="field">
                ...
                <input
                  ...
                  aria-describedby=${o(r.fieldErrors.name?b(`name`):void 0)}
          ...
          <section class="cron-form-section">
              ...
              ${a?e`
                    <label class="field">
                      ...
                      <input
                        ...
                        aria-describedby=${o(r.fieldErrors.timeoutSeconds?b(`timeoutSeconds`):void 0)}
            ...
            <label class="field cron-span-2">
              ...
              <textarea
                ...
                aria-describedby=${o(r.fieldErrors.payloadText?b(`payloadText`):void 0)}
                    ...
                    <label class="field ${F===`webhook`?`cron-span-2`:``}">
                      ...
                      ${F===`webhook`?e`
                            <input
                              ...
                              aria-describedby=${o(r.fieldErrors.deliveryTo?b(`deliveryTo`):void 0)}
                    ...
                    <div class="cron-stagger-group cron-span-2">
                      <label class="field">
                        ...
                        <input
                          ...
                          aria-describedby=${o(r.fieldErrors.staggerAmount?b(`staggerAmount`):void 0)}
                    ...
                    ${r.form.failureAlertMode===`custom`?e`
                          <label class="field">
                            ...
                            <input
                              ...
                              aria-describedby=${o(r.fieldErrors.failureAlertAfter?b(`failureAlertAfter`):void 0)}
                          ...
                          <label class="field">
                            ...
                            <input
                              ...
                              aria-describedby=${o(r.fieldErrors.failureAlertCooldownSeconds?b(`failureAlertCooldownSeconds`):void 0)}
  ...
  `}function D(n){let r=n.form;return r.scheduleKind===`at`?e`
      <label class="field cron-span-2" style="margin-top: 12px;">
        ...
        <input
          ...
          aria-describedby=${o(n.fieldErrors.scheduleAt?b(`scheduleAt`):void 0)}
      ...
      <div class="form-grid cron-form-grid" style="margin-top: 12px;">
        <label class="field">
          ...
          <input
            ...
            aria-describedby=${o(n.fieldErrors.everyAmount?b(`everyAmount`):void 0)}
    ...
    <div class="form-grid cron-form-grid" style="margin-top: 12px;">
      <label class="field">
        ...
        <input
          ...
          aria-describedby=${o(n.fieldErrors.cronExpr?b(`cronExpr`):void 0)}
  ...
  `}function O(r,i){return r?e`<div id=${o(i)} class="cron-help cron-error">${t(r)}</div>`:n}function k(r,i){let a=`list-item list-item-clickable cron-job${i.runsJobId===r.id?` list-item-selected`:``}`,o=e=>{i.onLoadRuns(r.id),e()};return e`
    <div class=${a} @click=${()=>i.onLoadRuns(r.id)}>
      <div class="cron-job-header">
        <div class="list-main">
          <div class="list-title">${r.name}</div>
          <div class="list-sub">${l(r)}</div>
  ...
  `}function A(r){let i=d(r);if(!i)return e``;if(i.kind===`systemEvent`)return e`<div class="cron-job-detail">
      <span class="cron-job-detail-label">${t(`cron.jobDetail.system`)}</span>
      <span class="muted cron-job-detail-value">${i.text}</span>
    </div>`;let a=r.delivery,o=a?.mode===`webhook`?a.to?` (${a.to})`:``:a?.channel||a?.to?` (${a.channel??`last`}${a.to?` -> ${a.to}`:``})`:``;return e`
    <div class="cron-job-detail">
      ...
      ${a?e`<div class="cron-job-detail-section">
            ...
            <span class="muted cron-job-detail-value">${a.mode}${o}</span>
          </div>`:n}
    </div>
  `}function j(e){e.target?.closest(`a,button,input,textarea,select,summary,[role='button'],[role='link']`)&&e.stopPropagation()}function M(e){return typeof e!=`number`||!Number.isFinite(e)?t(`common.na`):i(e)}function N(e,n=Date.now()){let r=i(e);return t(e>n?`cron.runEntry.next`:`cron.runEntry.due`,{rel:r})}function P(n){let r=n.state?.lastStatus,i=r===`ok`?`cron-job-status-ok`:r===`error`?`cron-job-status-error`:r===`skipped`?`cron-job-status-skipped`:`cron-job-status-na`,o=t(r===`ok`?`cron.runs.runStatusOk`:r===`error`?`cron.runs.runStatusError`:r===`skipped`?`cron.runs.runStatusSkipped`:`common.na`),s=n.state?.nextRunAtMs,c=n.state?.lastRunAtMs;return e`
    <div class="cron-job-state">
      ...
      <div class="cron-job-state-row">
        ...
        <span class="cron-job-state-value" title=${a(s)}>
          ${M(s)}
        </span>
      </div>
      <div class="cron-job-state-row">
    ...
    <div class="list-item cron-run-entry">
      <div class="cron-run-entry__header">
        ...
        <div class="list-meta cron-run-entry__meta">
          <div>${a(i.ts)}</div>
          ${typeof i.runAtMs==`number`?e`<div class="muted">${t(`cron.runEntry.runAt`)} ${a(i.runAtMs)}</div>`:n}
          <div class="muted">${i.durationMs??0}ms</div>
          ${typeof i.nextRunAtMs==`number`?e`<div class="muted">${N(i.nextRunAtMs)}</div>`:n}
          ${l?e`<div>
                <a
                  class="session-link"
                  href=${l}
...
//# sourceMappingURL=cron-DRftrcCo.js.map