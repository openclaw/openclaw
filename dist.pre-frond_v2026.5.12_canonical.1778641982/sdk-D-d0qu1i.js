...
import { n as formatMatrixErrorReason, r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-D0Gk9vQd.js";
import { t as claimCurrentTokenStorageState } from "./storage-BzVi127k.js";
import { n as resolveMatrixRoomKeyBackupReadinessError } from "./backup-health-B6fVGE9R.js";
import { t as createAsyncLock } from "./async-lock-CE6aCrY5.js";
import { n as LogService, r as noop } from "./logger-B-ZnbmLk.js";
import { t as createMatrixJsSdkClientLogger } from "./logging-DXR-AacW.js";
import { a as matrixEventToRaw, n as createMatrixGuardedFetch, o as parseMxc, t as MatrixAuthedHttpClient } from "./http-client-g5QJpZZv.js";
import { n as isRepairableSecretStorageAccessError, r as MATRIX_IDB_PERSIST_INTERVAL_MS, t as MatrixRecoveryKeyStore } from "./recovery-key-store-D6vXRNd3.js";
import { i as throwIfMatrixStartupAborted, n as createMatrixStartupAbortError } from "./startup-abort-BzIl1ai0.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState } from "./sync-state-CY9Rqu7D.js";
...
async function loadMatrixCryptoRuntime() {
	matrixCryptoRuntimePromise ??= import("./crypto-runtime-BDEUXJ7K.js").then((runtime) => {
...
var MatrixClient = class {
	...
	async getRoomKeyBackupStatus() {
		...
		let { serverVersion, trusted, matchesDecryptionKey } = await this.resolveRoomKeyBackupTrustState(crypto, null);
		serverVersion ??= await this.resolveRoomKeyBackupVersion();
