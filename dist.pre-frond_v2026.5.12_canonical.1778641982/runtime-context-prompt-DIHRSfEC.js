...
import { a as OPENCLAW_RUNTIME_CONTEXT_NOTICE, i as OPENCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE, o as OPENCLAW_RUNTIME_EVENT_HEADER, r as OPENCLAW_NEXT_TURN_RUNTIME_CONTEXT_HEADER } from "./internal-runtime-context-DXfHdhIG.js";
...
function resolveRuntimeContextPromptParts(params) {
	...
	const runtimeContext = extractionResult === null ? params.effectivePrompt.trim() || void 0 : extractionResult.trim() || void 0;
