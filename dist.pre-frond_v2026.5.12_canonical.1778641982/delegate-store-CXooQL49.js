...
import { n as registerDiagnosticContinuationQueueMetricsProvider } from "./diagnostic-continuation-queues-DOOYzfiz.js";
...
import { i as failFlow, l as listTaskFlowRecords, o as finishFlow, r as deleteTaskFlowRecordById, t as createManagedTaskFlow, u as listTaskFlowsForOwnerKey } from "./task-flow-runtime-internal-J0eTvwb0.js";
...
const AttachAsStateSchema = z.object({ mountPath: z.string().optional() });
...
function buildDelegateState(delegate) {
	...
	const attachments = Array.isArray(delegate.attachments) && delegate.attachments.length > 0 ? delegate.attachments : void 0;
	const attachAs = delegate.attachAs?.mountPath ? { mountPath: delegate.attachAs.mountPath } : void 0;
	return {
