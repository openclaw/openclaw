...
import { h as loggingState } from "./logger-CQ0p51p4.js";
...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-DW-eOI59.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-Biujw-8O.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-BC6aDKZe.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BrC1Lbq_.js");
	if (params.argv) {
