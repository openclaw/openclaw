...
import { t as collectIncludePathsRecursive } from "./includes-scan-BpWAKH3M.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-VDGNzPz2.js");
...
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-nyEeZHgb.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-BSBalC3C.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-CMv_hJMs.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-BO9fwGDt.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-BqVMKFEz.js");
