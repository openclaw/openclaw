...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-DAQiUXoS.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-KdM_ray3.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-BQNTwn7C.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-BW-XCWWx.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-DL6smlg3.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-BAnVGSrr.js"),
