import { a as consumeStagedPostCompactionDelegates$1, f as stagePostCompactionDelegate$1 } from "./delegate-store-CXooQL49.js";
...
function consumeStagedPostCompactionDelegates(sessionKey) {
	...
	return consumeStagedPostCompactionDelegates$1(sessionKey).map((d) => {
		...
		if (d.attachments) delegate.attachments = d.attachments;
		if (d.attachAs) delegate.attachAs = d.attachAs;
		return delegate;
	});
}
//#endregion
