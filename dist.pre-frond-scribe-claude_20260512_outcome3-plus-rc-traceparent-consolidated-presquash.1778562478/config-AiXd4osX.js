...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-DtOyW3pK.js";
import "./ssrf-runtime-Cup62pw7.js";
import "./retry-runtime-D3g0KFup.js";
import "./secret-input-runtime-CI0G4lqU.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-H0btHr0A.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BOtf6yNH.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-EJKtdC_v.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BzVi127k.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BTw6bqh_.js"), import("./logging-QuFCqJWE.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-DnVBBfoo.js").then((credentialsReadModule) => ({
