...
import { r as readModelListResult } from "./models-BuGQKwor.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-CKWOWVXG.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
