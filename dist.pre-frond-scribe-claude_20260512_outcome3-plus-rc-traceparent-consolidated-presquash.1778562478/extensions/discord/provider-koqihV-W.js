...
import { b as isVerbose } from "../../logger-CQ0p51p4.js";
import { t as createSubsystemLogger } from "../../subsystem-DNg_cpPU.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "../../globals-BHVmraBM.js";
import { n as logError, t as logDebug } from "../../logger-M-PaInRe.js";
...
import { n as readSessionUpdatedAt, o as updateSessionStore } from "../../store-L0DKoc8m.js";
import { o as resolveDefaultModelForAgent } from "../../model-selection-CyWx9aXc.js";
import { r as clearExpiredCooldowns, s as isProfileInCooldown } from "../../order-DrCfqEY2.js";
import { s as resolveProfilesUnavailableReason } from "../../usage-BPAEZ9Bv.js";
import { i as resolveEffectiveDebugProxyUrl, r as resolveDebugProxySettings } from "../../env-Cp6iupHT.js";
import { n as captureWsEvent, t as captureHttpExchange } from "../../runtime-y8f9iTv-.js";
import "../../provider-model-shared-BpwAf3yf.js";
import { n as fetchWithSsrFGuard } from "../../fetch-guard-DhxJOg6A.js";
import { h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "../../reply-payload-4x-lSxGs.js";
...
import { v as resolveChannelStreamingBlockEnabled } from "../../channel-streaming-EPwhY_Cu.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "../../chunk-Bkxjj_pw.js";
import { i as resolveAgentRoute } from "../../resolve-route-Cm8sGLH2.js";
import { i as resolveHumanDelayConfig } from "../../identity-D0LXZhU5.js";
import { n as writeJsonFileAtomically, t as readJsonFileWithFallback } from "../../json-store-jdewyrv_.js";
import { t as applyModelOverrideToSessionEntry } from "../../model-overrides-D48g_2g-.js";
import { i as formatDurationSeconds } from "../../format-duration-CAYQrQG3.js";
import { n as listChatCommands } from "../../commands-registry-list-BL6oiOEC.js";
import { c as parseCommandArgs, d as serializeCommandArgs, i as formatCommandArgMenuTitle, l as resolveCommandArgChoices, n as buildCommandTextFromArgs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "../../commands-registry-CIGlwS3T.js";
import { t as finalizeInboundContext } from "../../inbound-context-M-kASHx9.js";
import { n as chunkItems } from "../../text-runtime-FOsx_CPC.js";
import { t as summarizeStringEntries } from "../../string-sample-QKdGS-Go.js";
import { t as withTimeout } from "../../with-timeout-DLo9wGKw.js";
import "../../routing-DfF4_bqH.js";
import { i as matchPluginCommand, n as executePluginCommand } from "../../commands-CvVPvr1-.js";
import "../../error-runtime-RY0qqoh6.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "../../envelope-D2ilAAEE.js";
...
import { d as upsertChannelPairingRequest } from "../../pairing-store-DM-cQi74.js";
import { t as createChannelReplyPipeline } from "../../channel-reply-pipeline-ChCtYK0Y.js";
import { c as buildAllowlistResolutionSummary, d as patchAllowlistUsersInConfigEntries, f as summarizeMapping, l as canonicalizeAllowlistWithResolvedIds, s as addAllowlistUserEntriesFromConfigEntry } from "../../allow-from-Db4tTSXK.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "../../runtime-group-policy-CecGaqtk.js";
import { n as isDangerousNameMatchingEnabled } from "../../dangerous-name-matching-C2QAUJgd.js";
import { l as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "../../dm-policy-shared-CFD2FPpz.js";
import { t as createChannelPairingChallengeIssuer } from "../../channel-pairing-DWcD6g9Y.js";
import { t as resolveRequestUrl } from "../../request-url-CbIyHMU-.js";
import "../../runtime-env-DyZrKYOx.js";
import "../../proxy-capture-CypS6x8l.js";
import { t as resolveApprovalOverGateway } from "../../approval-gateway-runtime-DCTQFxnl.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "../../approval-handler-adapter-runtime-EvUxh8Bh.js";
import { r as registerChannelRuntimeContext } from "../../channel-runtime-context-GbSLjMGx.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled } from "../../commands-BuCoenN3.js";
import { t as resolveStoredModelOverride } from "../../stored-model-override-D7NsWf9Z.js";
import { n as dispatchReplyWithDispatcher } from "../../reply-dispatch-runtime-BSlYYtdB.js";
import "../../reply-chunking-D-vq0kAq.js";
import { a as runInboundReplyTurn } from "../../inbound-reply-dispatch-FCC0zawY.js";
import "../../web-media-D6vibJc1.js";
import "../../system-event-runtime-CWzhsDr-.js";
import { n as wrapFetchWithAbortSignal } from "../../fetch-9RlW8WIo.js";
import "../../runtime-config-snapshot-CGsgy2BE.js";
import "../../model-session-runtime-DorMxeIv.js";
import "../../ssrf-runtime-Cup62pw7.js";
import "../../media-runtime-Doi16sSJ.js";
import { n as resolveConfiguredBindingRoute, t as ensureConfiguredBindingRouteReady } from "../../binding-routing-BFHEYlgS.js";
import "../../conversation-binding-runtime-pOvWccc-.js";
import "../../conversation-runtime-WRmNcyfY.js";
import { t as formatThreadBindingDurationLabel } from "../../thread-bindings-messages-CcK4ee97.js";
import "../../agent-runtime-nerXkCW4.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "../../plugin-runtime-Cxsb7lLT.js";
...
import "../../markdown-table-runtime-BFElE-2D.js";
import "../../command-auth-oYbsjyAn.js";
import { t as resolveNativeCommandSessionTargets } from "../../native-command-session-targets-aZtSwB-f.js";
import { t as listSkillCommandsForAgents } from "../../skill-commands-BO7PGLBC.js";
import "../../command-auth-native-Ca83R-D_.js";
import { t as resolveDirectStatusReplyForSession } from "../../command-status-runtime-DGXqRRt4.js";
import "../../channel-inbound-CtPTvcjp.js";
import "../../fetch-runtime-D7_169QO.js";
import "../../session-store-runtime-CYNftfYH.js";
import "../../native-command-config-runtime-BXVSWlbv.js";
import "../../native-command-registry-DvsNcJmq.js";
import "../../state-paths-7tNathRX.js";
import { t as normalizeDiscordToken } from "./token-qSCOciBI.js";
import { c as resolveDiscordAccountAllowFrom, d as resolveDiscordAccountDmPolicy, f as resolveDiscordMaxLinesPerMessage, s as resolveDiscordAccount } from "./accounts-TlTpD4rD.js";
import { s as chunkDiscordTextWithMode } from "./target-resolver-YAvCjRtK.js";
import { a as resolveDiscordModalEntryWithPersistence, i as resolveDiscordComponentEntryWithPersistence, t as editDiscordComponentMessage } from "./send.components-B8giaVsA.js";
import { c as setPresence, i as unregisterGateway, r as registerGateway } from "./gateway-registry-Cus2fIcW.js";
import { B as StringSelectMenu, Bt as GatewayOpcodes, E as Modal, Ft as ChannelType, It as ComponentType, L as Row, Lt as GatewayCloseCodes, Nt as ApplicationCommandOptionType, Pt as ButtonStyle, Rt as GatewayDispatchEvents, S as User, V as TextDisplay, W as BaseMessageInteractiveComponent, a as PresenceUpdateListener, b as Guild, c as ThreadUpdateListener, d as Plugin, i as MessageReactionRemoveListener, j as Container, k as Button, m as RateLimitError, n as MessageCreateListener, o as ReadyListener, r as MessageReactionAddListener, t as InteractionCreateListener, u as Client, v as Command, x as Message, y as CommandWithSubcommands, z as Separator, zt as GatewayIntentBits } from "./discord-Bqnkc1gh.js";
import { F as DISCORD_REST_TIMEOUT_MS, I as validateDiscordProxyUrl, L as withValidatedDiscordProxy, j as createDiscordRestClient } from "./send.shared-CiYv93J8.js";
import { a as summarizeDiscordResponseBody, i as isDiscordRateLimitResponseBody } from "./api-CaZ1Hm1Q.js";
import { n as formatDiscordUserTag, t as formatDiscordReactionEmoji } from "./format-BSB30DMg.js";
import { _ as resolveGroupDmAllow, a as normalizeDiscordSlug, c as resolveDiscordChannelConfigWithFallback, d as resolveDiscordGuildEntry, f as resolveDiscordMemberAccessState, i as normalizeDiscordDisplaySlug, l as resolveDiscordChannelPolicyCommandAuthorizer, m as resolveDiscordOwnerAccess, n as isDiscordGroupAllowedByPolicy, o as resolveDiscordAllowListMatch, r as normalizeDiscordAllowList, v as shouldEmitDiscordReactionNotification } from "./allow-list-C06SVOS6.js";
import { t as formatMention } from "./mentions-C31dJ-69.js";
import { g as parseDiscordModalCustomIdForInteraction, h as parseDiscordModalCustomId, m as parseDiscordComponentCustomIdForInteraction, p as parseDiscordComponentCustomId } from "./components-BC8Y_ygy.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers } from "./approval-shared-nGaaeEVk.js";
import "./approval-native-XSMCCjqv.js";
import { t as resolveDiscordConversationIdentity } from "./conversation-identity-BFAD-sjj.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-V4D1NMFD.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-Dd8SyuBJ.js";
import { a as isThreadArchived } from "./thread-bindings.discord-api-Cn5uG-oV.js";
import { i as resolveDiscordChannelParentIdSafe, n as resolveDiscordChannelInfoSafe, o as resolveDiscordChannelTopicSafe, r as resolveDiscordChannelNameSafe, t as resolveDiscordChannelIdSafe } from "./channel-access-BBQb8w5l.js";
import { r as parseApplicationIdFromToken, t as fetchDiscordApplicationId } from "./probe-CGCM-dd9.js";
import { o as raceWithTimeout, s as withAbortTimeout } from "./timeouts-DAw2IveV.js";
import { c as resolveDiscordChannelInfo } from "./message-utils-DICBFGeR.js";
import { s as resolveDiscordThreadParentInfo } from "./threading-CPL2P3b0.js";
import { c as resolveDiscordDmAccessGroupEntries, i as resolveDiscordEffectiveRoute, n as resolveDiscordBoundConversationRoute, o as handleDiscordDmCommandDecision, s as resolveDiscordDmCommandAccess } from "./route-resolution-l3e1fHax.js";
import { t as resolveDiscordSenderIdentity } from "./sender-identity-BqaO5iun.js";
import { n as buildDiscordInboundAccessContext, t as buildDiscordGroupSystemPrompt } from "./inbound-context-D9jO6ruU.js";
import { n as resolveDiscordVoiceEnabled, t as authorizeDiscordVoiceIngress } from "./access-DurE9mUo.js";
import { n as buildDirectLabel, r as buildGuildLabel, t as deliverDiscordReply } from "./reply-delivery-BK4vf1LI.js";
import "./approval-handler.runtime-DcL1hnKl.js";
...
async function ensureDmComponentAuthorized(params) {
	...
	const storeAllowFrom = dmPolicy === "open" ? [] : await readStoreAllowFromForDmPolicy({
		provider: "discord",
		accountId: ctx.accountId,
		dmPolicy
	});
...
async function loadConversationRuntime$1() {
	conversationRuntimePromise$1 ??= import("./agent-components.runtime-Cm3VWtBR.js");
...
async function loadTypingRuntime() {
	typingRuntimePromise ??= import("./typing-CaRfuN6d.js");
...
async function loadConversationRuntime() {
	conversationRuntimePromise ??= import("./agent-components.runtime-Cm3VWtBR.js");
...
async function loadComponentsRuntime() {
	componentsRuntimePromise ??= import("./components-DgZC2IB3.js");
...
async function loadDiscordVoiceRuntime() {
	const promise = discordVoiceRuntimePromise ?? import("./manager.runtime-ByNPy2nH.js");
...
async function loadDiscordProviderSessionRuntime() {
	const promise = discordProviderSessionRuntimePromise ?? import("./provider-session.runtime-CQh7mydx.js");
