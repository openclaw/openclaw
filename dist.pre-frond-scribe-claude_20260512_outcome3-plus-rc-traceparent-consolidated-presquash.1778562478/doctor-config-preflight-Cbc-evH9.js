...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-C04VWQdx.js";
import { n as formatConfigIssueLines } from "./issue-format-DaaH055I.js";
import { t as note } from "./note-BiGDHYW2.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-DFsNkQS_.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-L5qDRhvU.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BbmuYNIS.js");
