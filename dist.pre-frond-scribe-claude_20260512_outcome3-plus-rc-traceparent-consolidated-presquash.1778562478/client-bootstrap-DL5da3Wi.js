...
import { t as getActiveMatrixClient } from "./active-client-nHUw1e1x.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-D-YgRTDf.js"), import("./shared-CkegJwKZ.js")]).then(([clientModule, sharedModule]) => ({
