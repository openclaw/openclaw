...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-qp152t5E.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-B2jYsGdZ.js")]);
