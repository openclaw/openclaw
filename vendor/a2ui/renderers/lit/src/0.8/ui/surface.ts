...
import type { A2uiMessageProcessor } from "../data/model-processor.js";
import type { SurfaceID, Surface as SurfaceState } from "../types/types";
...
export class Surface extends Root {
	...
	#renderSurface() {
      ...
      .childComponents=${
				this.surface?.componentTree ? [this.surface.componentTree] : null
			}
    ></a2ui-root>`;
	}
