...
import { a as formatDiagnosticTraceparent, o as freezeDiagnosticTraceContext, r as createDiagnosticTraceContextFromActiveScope, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-IcGaoHY8.js";
...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-BSRvKfln.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-6sSBAuF7.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BLjBtFc3.js";
import { a as listRegisteredAgentHarnesses } from "./registry-CMelDO5r.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-BBWUJAxF.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-DXf4X1LM.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-B6kzDhK6.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-BS98tpjG.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-B_IdQqVU.js";
import { u as resolveStorePath } from "./paths-D2tVOYHR.js";
import { t as loadSessionStore } from "./store-load-6WUUNuxk.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-Blxklfo1.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-DOk7wSx2.js";
import { m as MAX_IMAGE_BYTES } from "./mime-Dz_R57Df.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-Df8A1xtk.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-B6MaXn5r.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-CD5virdi.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-ClIa0TN2.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-D-0WKaTm.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-YRsDmGSB.js";
...
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-CbtPd3vL.js";
import { t as parseInlineDirectives } from "./directive-tags-BXB5jLU6.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-BnqlKNq4.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-DYW5KkT2.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-DIworFrv.js";
...
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-CyrPz5r3.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-DdUkXicY.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-DzmEOeas.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-1nrYy2wZ.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-D4I_DfXI.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-DF-C01Ei.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BRhUs5fW.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-BT3zGfR1.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BnEJNs4t.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-BZHJ6dBm.js";
...
import { t as filterHeartbeatPairs } from "./heartbeat-filter-RQKLxFrF.js";
import { D as stripProviderPrefix, E as isStrictAgenticSupportedProviderModel, O as isEmbeddedMode, d as resolveToolLoopDetectionConfig } from "./openclaw-tools-DCfAIrTy.js";
import { t as getMachineDisplayName } from "./machine-name-CZkZI6kV.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DHhPic5e.js";
...
import { t as resolveOsSummary } from "./os-summary-zzC0Yx05.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CCZLFUMD.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-BmACn1pR.js";
import { d as parseBooleanValue } from "./frontmatter-OroIq8Rd.js";
import { A as buildEmbeddedExtensionFactories, B as repairSessionFileIfNeeded, C as createEmbeddedPiResourceLoader, D as buildEmbeddedMessageActionDiscoveryInput, E as validateReplayTurns, G as findClientToolNameConflicts, I as resolveCompactionTimeoutMs, J as assessLastAssistantMessage, L as isCacheTtlEligibleProvider, O as getHistoryLimitFromSessionKey, Q as isReasoningTagProvider, R as readLastCacheTtlTimestamp, S as trackSessionManagerAccess, T as sanitizeSessionHistory, U as collectRuntimeChannelCapabilities, V as buildStreamErrorAssistantMessage, W as createClientToolNameConflictError, X as dropThinkingBlocks, Y as dropReasoningFromHistory, Z as isZeroUsageEmptyStopAssistantTurn, _ as resolveEmbeddedAgentApiKey, a as flushPendingToolResultsAfterIdle, b as resolveEmbeddedRunSkillEntries, c as PI_RESERVED_TOOL_NAMES, d as collectRegisteredToolNames, f as toSessionToolAllowlist, g as describeEmbeddedAgentStreamStrategy, h as createSystemPromptOverride, k as limitHistoryTurns, l as collectAllowedToolNames, m as buildEmbeddedSystemPrompt, o as mapThinkingLevel, p as applySystemPromptOverrideToSession, q as toClientToolDefinitions, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectCoreBuiltinToolNames, v as resolveEmbeddedAgentBaseStreamFn, w as normalizeAssistantReplayContent, x as prewarmSessionFile, y as resolveEmbeddedAgentStreamFn, z as guardSessionManager } from "./compaction-successor-transcript-BROoU-e5.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-B1AHdN5w.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-C5nPabv4.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DZP2065R.js";
import { g as resolveChannelMessageToolHints, h as listChannelSupportedActions, v as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-DfEuKG6T.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-cE4HSCGH.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-BA32n_2S.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BFVgjKw5.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-D4aIsu33.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-BdrVFyM4.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-DtILftoj.js";
...
import { f as hasCommittedMessagingToolDeliveryEvidence, p as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-CqEMXegP.js";
import { f as buildApiErrorObservationFields, p as buildTextObservationFields } from "./model-fallback-0F4gOVlY.js";
import { t as log$4 } from "./logger-CXZYJfp6.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-BmYYzD0f.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-7h1NJMu4.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CTvMeHqd.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-DpJKu3uY.js";
import { a as TOOL_SEARCH_CODE_MODE_TOOL_NAME, c as applyToolSearchCatalog, d as projectToolSearchTargetTranscriptMessages, f as resolveToolSearchConfig, i as TOOL_DESCRIBE_RAW_TOOL_NAME, l as clearToolSearchCatalog, n as resolveProcessToolScopeKey, o as TOOL_SEARCH_RAW_TOOL_NAME, r as TOOL_CALL_RAW_TOOL_NAME, s as addClientToolsToToolSearchCatalog, t as createOpenClawCodingTools, u as createToolSearchCatalogRef } from "./pi-tools-CIsT2kNl.js";
...
import { o as listControlledSubagentRuns } from "./subagent-control-ClV8FUvr.js";
...
import { _ as sanitizeTransportPayloadText, h as mergeTransportHeaders, y as buildGuardedModelFetch } from "./openai-transport-stream-BZZlqKuA.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-DXvalsBA.js";
import { o as resolveSandboxContext } from "./sandbox-WuqtRIGw.js";
import { t as detectRuntimeShell } from "./shell-utils-B1dlxH_0.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DaYBp4r0.js";
import { s as resolveSkillsPromptForRun } from "./workspace-DoHdjfCA.js";
import "./skills-27ZpQS2H.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-D2eHfHNy.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-BfyZRmoJ.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DsVwbjZJ.js";
import { n as appendAgentBootstrapSystemPromptSupplement, r as appendModelIdentitySystemPrompt } from "./system-prompt-config-DLfsTzgU.js";
import "./tool-loop-detection-Dida3mg9.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-7iotLT0z.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-FXQyU-Zj.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-B1diXvo_.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-CMWQSLqj.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-C7G8KlhI.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-ButQWBXN.js";
import { a as buildAfterTurnRuntimeContext, c as mergeOrphanedTrailingUserPrompt, d as resolveAttemptPrependSystemContext, f as resolvePromptBuildHookResult, g as shouldWarnOnOrphanedUserRepair, h as shouldInjectHeartbeatPrompt, i as shouldPersistCompletedBootstrapTurn, l as prependSystemPromptAddition, m as resolvePromptSubmissionSkipReason, n as composeSystemPromptWithHookContext, o as buildAfterTurnRuntimeContextFromUsage, p as resolvePromptModeForSession, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded, u as resolveAttemptFsWorkspaceOnly } from "./attempt.thread-helpers-CAkMUooI.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-B4wQcRs8.js";
import { t as detectAndLoadPromptImages } from "./images-g6Y680l0.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentTurnPrompt } from "./runtime-context-prompt-DlrlUGq4.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-DwTt4eiU.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-C-NABdzs.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-DqiGiWMt.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-DDhFF7WO.js"));
...
function shouldApplyNonVisibleTurnRetryGuard(params) {
	...
	if (normalizeLowercaseStringOrEmpty(params.modelApi ?? "") === "anthropic-messages" && KIMI_INCOMPLETE_TURN_PROVIDER_ID_PATTERN.test(normalizeLowercaseStringOrEmpty(params.provider ?? ""))) return true;
...
async function waitForEmbeddedAbortSettle(params) {
	...
	const outcome = await Promise.race([params.promise.then(() => "settled").catch((err) => {
		log$4.warn(`embedded abort settle failed: runId=${params.runId} sessionId=${params.sessionId} err=${String(err)}`);
		return "errored";
	}), new Promise((resolve) => {
		timeout = setTimeout(() => resolve("timed_out"), EMBEDDED_ABORT_SETTLE_TIMEOUT_MS);
	})]);
	if (timeout) clearTimeout(timeout);
	if (outcome === "timed_out") log$4.warn(`embedded abort settle timed out: runId=${params.runId} sessionId=${params.sessionId} timeoutMs=${EMBEDDED_ABORT_SETTLE_TIMEOUT_MS}`);
}
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		const toolSearchControlsEnabledForRun = toolsEnabled && params.disableTools !== true && !isRawModelRun && params.toolsAllow?.length !== 0 && resolveToolSearchConfig(params.config).enabled;
		const effectiveToolsAllow = toolSearchControlsEnabledForRun && params.toolsAllow ? [...new Set([...params.toolsAllow, ...TOOL_SEARCH_CONTROL_ALLOWLIST_NAMES])] : params.toolsAllow;
		const shouldConstructTools = toolConstructionPlan.constructTools || toolSearchControlsEnabledForRun;
		let toolSearchCatalogExecutor;
		const toolSearchCatalogRef = toolSearchControlsEnabledForRun ? createToolSearchCatalogRef() : void 0;
		...
		if (toolSearch.compacted) {
			...
			log$4.info(`tool-search: cataloged ${toolSearch.catalogToolCount} tools behind compact prompt surface`);
		}
		...
		try {
			...
			if (clientToolSearch.compacted) log$4.info(`tool-search: cataloged ${clientToolSearch.catalogToolCount} client tools behind compact prompt surface`);
			...
			try {
				...
				try {
					...
					const promptForModel = buildCurrentTurnPrompt({
						context: promptSubmission.runtimeOnly ? void 0 : params.currentTurnContext,
...
//#endregion
export { observeReplayMetadata as C, createEmbeddedRunReplayState as S, resolveReasoningOnlyRetryInstruction as _, formatEmbeddedRunStageSummary as a, resolveSilentToolResultReplyPayload as b, STRICT_AGENTIC_BLOCKED_TEXT as c, resolveAckExecutionFastPathInstruction as d, resolveAttemptReplayMetadata as f, resolvePlanningOnlyRetryLimit as g, resolvePlanningOnlyRetryInstruction as h, createEmbeddedRunStageTracker as i, extractPlanningOnlyPlanDetails as l, resolveIncompleteTurnPayloadText as m, runAgentHarnessAttempt as n, shouldWarnEmbeddedRunStageSummary as o, resolveEmptyResponseRetryInstruction as p, selectAgentHarness as r, resolveBootstrapMode as s, maybeCompactAgentHarnessSession as t, isLikelyExecutionAckPrompt as u, resolveReplayInvalidFlag as v, createTrajectoryRuntimeRecorder as w, shouldTreatEmptyAssistantReplyAsSilent as x, resolveRunLivenessState as y };
