import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-DIjOYTau.js";
import { r as loadCrestodianOverview } from "./overview-CdTbTklD.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-BPTTZM-c.js")).planCrestodianCommand)({
		input,
		overview
	});
