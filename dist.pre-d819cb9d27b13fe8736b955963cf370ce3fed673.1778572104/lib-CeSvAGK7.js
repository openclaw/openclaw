...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-D14WKSvm.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-B3MY0uoZ.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-B3hcdxQ1.js";
import { l as toRatio, n as decodeString } from "./Util-DDsqyzus.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BvzDGPmO.js";
import { t as APEv2Parser } from "./APEv2Parser-7vvFfR6j.js";
import { r as hasID3v1Header } from "./ID3v1Parser-L08tPX0u.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DgDr8Au5.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-B3fpu27h.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-AxOnAGi9.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-B9CKhoKI.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BYP3vfCr.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-64rGubNU.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DfxYxRM7.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-B2SLUKk8.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-B8IP17f8.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-C2csH7GZ.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CXmWpWHv.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CfdOxpXw.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DxkgXk2g.js")).WaveParser;
	}
};
//#endregion
