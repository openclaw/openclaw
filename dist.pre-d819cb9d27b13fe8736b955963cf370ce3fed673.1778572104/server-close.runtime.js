...
import { n as disposeRegisteredAgentHarnesses } from "./registry-CMelDO5r.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Dmrw37Ld.js";
import { n as closePluginStateSqliteStore } from "./plugin-state-store-D_OeGcHr.js";
import { i as listChannelPlugins } from "./registry-DsLW_yUZ2.js";
import "./plugins-D2XQjp5I.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-D4aIsu33.js";
import "./pi-bundle-mcp-tools-BSGh0D9x.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-Gq-0sRoF.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-BQSupRw-.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-BsmVdC1i.js");
