...
import { a as parseAccessGroupAllowFromEntry, i as mergeDmAllowFromSources, n as firstDefined, r as isSenderIdAllowed } from "./allow-from-DXxx2xeQ.js";
...
import { n as isAutoLinkedFileRef, t as FILE_REF_EXTENSIONS_WITH_TLD } from "./auto-linked-file-ref-B2H73N9r.js";
...
function markdownToTelegramHtml(markdown, options = {}) {
	const html = renderTelegramHtml(markdownToIR(preserveTelegramListBoundarySpacing(markdown ?? ""), {
		linkify: true,
		enableSpoilers: true,
		headingStyle: "none",
		blockquotePrefix: "",
...
//#endregion
export { parseTelegramReplyToMessageId as $, resolveTelegramGroupAllowFromContext as A, getTelegramTextParts as B, extractTelegramForumFlag as C, resolveTelegramDirectPeerId as D, resolveTelegramCommandAuthorization as E, withResolvedTelegramForumFlag as F, resolveTelegramPrimaryMedia as G, isBinaryContent as H, buildSenderLabel as I, isSenderAllowed as J, expandTelegramAllowFromWithAccessGroups as K, buildSenderName as L, resolveTelegramStreamMode as M, resolveTelegramThreadSpec as N, resolveTelegramForumFlag as O, shouldUseTelegramDmThreadSession as P, normalizeTelegramReplyToMessageId as Q, expandTextLinks as R, describeReplyTarget as S, resetTelegramForumFlagCacheForTest as T, normalizeForwardedContext as U, hasBotMention as V, resolveTelegramMediaPlaceholder as W, normalizeDmAllowFromWithStore as X, normalizeAllowFrom as Y, resolveTelegramEffectiveDmPolicy as Z, buildTelegramGroupPeerId as _, renderTelegramHtmlText as a, resolveTelegramTargetChatType as at, buildTelegramThreadParams as b, isRecoverableTelegramNetworkError as c, isTelegramPollingNetworkError as d, parseTelegramThreadId as et, isTelegramRateLimitError as f, buildTelegramGroupFrom as g, buildGroupLabel as h, markdownToTelegramHtmlChunks as i, parseTelegramTarget as it, resolveTelegramReplyId as j, resolveTelegramForumThreadId as k, isSafeToRetrySendError as l, tagTelegramNetworkError as m, markdownToTelegramChunks as n, normalizeTelegramChatId as nt, splitTelegramHtmlChunks as o, stripTelegramInternalPrefixes as ot, isTelegramServerError as p, resolveTelegramDmAllow as q, markdownToTelegramHtml as r, normalizeTelegramLookupTarget as rt, wrapFileReferencesInHtml as s, escapeTelegramHtml as t, isNumericTelegramChatId as tt, isTelegramClientRejection as u, buildTelegramParentPeer as v, isTelegramCommandsAllowFromConfigured as w, buildTypingThreadParams as x, buildTelegramRoutingTarget as y, extractTelegramLocation as z };
