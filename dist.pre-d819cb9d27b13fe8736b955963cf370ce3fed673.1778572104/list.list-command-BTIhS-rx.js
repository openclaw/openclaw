...
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-BcF9ys4s.js";
import { C as modelKey, T as parseModelRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-CkgNDUHT.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-BAukXI7p.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-DF3gHeUp.js";
import { n as loadModelsConfigWithSource } from "./load-config-UfJQgjTK.js";
import { n as formatErrorWithStack } from "./list.errors-BWE2dg7W.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-Br33-_pD.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-CF_oOJLX.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-LmwdMIyo.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-HFiOzzG8.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-x3VG0Lkt.js"),
		import("./agent-scope-CTa8UXYi.js"),
		import("./workspace-CcxfA4so.js")
	]);
