...
import { f as renderMessagePresentationFallbackText, l as normalizeMessagePresentation } from "./payload-CyXSKIqu.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BOaIkSuX.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DeDZq9O3.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-fOi0H-_f.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BEHncM17.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-B_dQretP.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-EUo6g5jv.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-Drh1T8Gi.js";
import { n as createFeishuSendReceipt } from "./send-result-DLOZKNvM.js";
...
import { o as resolveFeishuGroupToolPolicy } from "./policy--ti-CZaU.js";
...
import { t as resolveFeishuSessionConversation } from "./session-conversation-iFN_0PqF.js";
...
const TtsOverrideSchema = z$2.object({
	auto: z$2.enum([
		"off",
		"always",
		"inbound",
	...
	mode: z$2.enum(["final", "all"]).optional(),
	provider: z$2.string().optional(),
	persona: z$2.string().optional(),
	personas: z$2.record(z$2.string(), z$2.record(z$2.string(), z$2.unknown())).optional(),
	summaryModel: z$2.string().optional(),
	modelOverrides: z$2.record(z$2.string(), z$2.unknown()).optional(),
	providers: z$2.record(z$2.string(), z$2.record(z$2.string(), z$2.unknown())).optional(),
	prefsPath: z$2.string().optional(),
	maxTextLength: z$2.number().int().min(1).optional(),
	timeoutMs: z$2.number().int().min(1e3).max(12e4).optional()
}).strict().optional();
...
const BlockStreamingSchema = z$2.boolean().optional();
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-B4S2Hg9D.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-B4S2Hg9D.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-Dcw86ndS.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BwIv-Ovg.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-47_KbxRu.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-DXufgAJ7.js");
