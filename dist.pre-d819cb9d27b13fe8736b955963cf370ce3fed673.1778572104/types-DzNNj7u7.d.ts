import { i as OpenClawConfig, yn as CliBackendConfig } from "./types.openclaw-BlE9q7jU.js";
import { l as SecretInput } from "./types.secrets-Cn9M0bVK.js";
import { a as ModelCompatConfig, c as ModelProviderAuthMode, l as ModelProviderConfig } from "./types.models-fxeqhDwC.js";
import { b as ToolLoopDetectionConfig } from "./types.tools-rF2K5Ucb.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-7KQFfV7g.js";
import { d as UnifiedModelCatalogKind, l as PluginKind, m as PluginConfigUiHint, u as UnifiedModelCatalogEntry } from "./manifest-registry-5JHEf5jT.js";
import { t as JsonSchemaObject } from "./json-schema.types-Bhym0dYn.js";
import { n as ReasoningLevel, r as ThinkLevel } from "./thinking.shared-n4jFAre1.js";
import { t as ChannelId } from "./channel-id.types-B55g1gK4.js";
import { c as SessionSystemPromptReport, o as SessionEntry } from "./types-DW5Lfc9v.js";
import { r as AnyAgentTool } from "./common-K3KGpeVn.js";
import { a as PromptMode, h as EmbeddedPiCompactResult, p as ExecElevatedDefaults, r as RunEmbeddedPiAgentParams, s as BlockReplyChunking, v as EmbeddedRunLivenessState, x as HeartbeatToolResponse, y as MessagingToolSend } from "./params-DUjSTOLX.js";
import { c as ReplyPayload, o as SourceReplyDeliveryMode, r as GetReplyOptions } from "./get-reply-options.types-xkFn9Z_M.js";
import { c as DiagnosticEventPayload, kt as TalkTransport, o as DiagnosticEventInput, s as DiagnosticEventMetadata } from "./diagnostic-events-ePFp0eUD.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-CMtAupWW.js";
import { t as CommandQueueEnqueueFn } from "./command-queue.types-CDluMScW.js";
import { s as SandboxFsBridge } from "./backend-handle.types-DuPXgpou.js";
...
import { N as WebFetchProviderPlugin, S as OpenClawPluginHookOptions, T as OpenClawPluginToolOptions, w as OpenClawPluginToolFactory, z as WebSearchProviderPlugin } from "./types-core-C4sdPbS4.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-CLTB9t7S.js";
...
import { A as SpeechSynthesisRequest, C as SpeechProviderId, D as SpeechProviderResolveConfigContext, E as SpeechProviderPreparedSynthesis, F as SpeechTelephonySynthesisRequest, I as SpeechTelephonySynthesisResult, L as SpeechVoiceOption, M as SpeechSynthesisStreamRequest, N as SpeechSynthesisStreamResult, O as SpeechProviderResolveTalkConfigContext, S as SpeechProviderConfiguredContext, T as SpeechProviderPrepareSynthesisContext, _ as SpeechDirectiveTokenParseContext, j as SpeechSynthesisResult, k as SpeechProviderResolveTalkOverridesContext, v as SpeechDirectiveTokenParseResult, x as SpeechProviderConfig, y as SpeechListVoicesRequest } from "./tts-runtime.types-DLNUyhQz.js";
import { n as DetachedTaskLifecycleRuntime } from "./detached-task-runtime-contract-BdOolKDU.js";
import { c as ContextEngine, d as ContextEnginePromptCacheInfo, f as ContextEngineRuntimeContext, t as ContextEngineFactory } from "./registry-DoNqnkSM.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-sty8JzLK.js";
import { $ as PluginHookName, $t as PluginHookBeforeAgentStartResult, Ft as PluginJsonValue, Gt as PluginConversationBindingRequestResult, K as PluginHookHandlerMap, Mt as PluginNextTurnInjection, Nt as PluginNextTurnInjectionEnqueueResult, Ut as PluginConversationBinding, Wt as PluginConversationBindingRequestParams, qt as PluginConversationBindingResolvedEvent } from "./hook-types-14vPwBMK.js";
...
import { r as InternalHookHandler } from "./internal-hook-types-CTqlBSAu.js";
