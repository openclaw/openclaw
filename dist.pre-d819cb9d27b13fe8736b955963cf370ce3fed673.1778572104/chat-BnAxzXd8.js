...
import { l as measureDiagnosticsTimelineSpan, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-CIwNgiTD.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-9yL2I3rf.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-B0llrko_.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-TU1A55ap.js";
import { r as setSafeTimeout } from "./timer-delay-CVEMbN4N.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-CF-7GIPV.js";
...
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-Cnh_OUdm.js";
import { C as jsonUtf8Bytes, h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes } from "./session-utils.fs-66nI1FFR.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-BXB5jLU6.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-CS4QnKhP.js";
...
import { s as normalizeReplyPayloadsForDelivery } from "./deliver-B1TTk-3I.js";
import { d as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-CqEMXegP.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-BKnXsQdq.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-Cba21kyM.js";
...
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-BaKa5LVB.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-ZlHPOyQZ.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-DXr9eR2C.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-CybTanxc.js";
...
import { t as formatForLog } from "./ws-log-MlgWT1hh.js";
import "./channel-message-CBzgQfUC.js";
import { t as logLargePayload } from "./diagnostic-payload-5fxKr3CH.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-CqJw3wMt.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-0MOeiI9k.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-ClRlXqh7.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-DbeAsfiw.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-CgCCKo8O.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BJFtInLS.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-D9fccHOf.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-BnsjueIn.js";
