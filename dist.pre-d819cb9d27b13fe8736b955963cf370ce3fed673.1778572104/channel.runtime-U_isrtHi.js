...
import "./accounts-CJtoYYaW.js";
import "./runtime-api-D6I0Fa1S.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-BXHZDYqP.js";
import { t as sendMessageZalo } from "./send-BIUW-Jso.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CXGdJu5Q.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-i4ebRELH.js");
