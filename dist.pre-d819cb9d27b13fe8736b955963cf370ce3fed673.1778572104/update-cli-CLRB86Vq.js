...
import "./daemon-cli-iBvrZraJ.js";
import { E as pathExists } from "./fs-safe-DKdSS9ZL.js";
import { p as resolveUserPath, u as pathExists$1 } from "./utils-CRkrr5e6.js";
...
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-BBc-eOU_.js";
import { n as VERSION } from "./version-BHBlW4Qb.js";
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-BhAAKLLE.js";
...
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-BE4Ri7zS.js";
import { c as resolveOfficialExternalPluginInstall, r as getOfficialExternalPluginCatalogManifest, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-BHQMjyN8.js";
...
import { F as asResolvedSourceConfig, I as asRuntimeConfig, u as readConfigFileSnapshot } from "./io-BTdvKaBm.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-DBUPrZ9p.js";
...
import { r as replaceConfigFile, t as ConfigMutationConflictError } from "./mutate-B-m-KAHm.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-Bb-INTMZ.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-CjoWuSu5.js";
import { a as shellEscapeRestartLogValue, i as resolveGatewayRestartLogPath, n as renderPosixRestartLogSetup } from "./restart-logs-DFAKzr0F.js";
import "./config-DuPmRSz4.js";
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-DXIKDGJJ.js";
import { n as runDaemonInstall } from "./install-BubY4AD0.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-CJyGh1iY.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-D6ts0Zcy.js";
import { r as formatDurationPrecise } from "./format-duration-CImOQ7n-.js";
import { u as trimLogTail } from "./restart-sentinel-UA51bxjF.js";
import { n as stylePromptMessage } from "./prompt-style-BfOeIspm.js";
import { t as formatHelpExamples } from "./help-format-BMRz9Zqb.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-DfnG1h4M.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-D0psTopd.js";
import { c as resolveEffectiveUpdateChannel, i as formatUpdateChannelLabel, l as resolveRegistryUpdateChannel, r as channelToNpmTag, s as normalizeUpdateChannel, u as resolveUpdateChannelDisplay } from "./update-channels-Gej306GV.js";
import { i as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-BeYDi7UB.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-DyG8LrGV.js";
import { i as updateNpmInstalledPlugins, n as resolveTrustedSourceLinkedOfficialNpmSpec, r as syncPluginsForUpdateChannel, t as resolveTrustedSourceLinkedOfficialClawHubSpec } from "./update-BoIaWT6C.js";
import { t as doctorCommand } from "./doctor-Dd58v_EP.js";
import { t as selectStyled } from "./prompt-select-styled-BCrZb030.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-B9zoGN7W.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-CtxCu5_N.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-BnU8biT-.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as resolvePnpmGlobalDirFromGlobalRoot, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-C-537i4X.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DK7TQRrI.js";
...
async function maybeRestartService(params) {
	...
	if (params.shouldRestart) {
		...
		try {
			...
			} else if (!refreshedGatewayAlreadyHealthy && params.refreshServiceEnv && isPackageUpdate) restarted = await runUpdatedInstallGatewayRestart({
				result: params.result,
				jsonMode: Boolean(params.opts.json),
				invocationCwd: params.invocationCwd,
				env: params.serviceEnv
			});
			else if (!refreshedGatewayAlreadyHealthy && shouldUseLegacyProcessRestartAfterUpdate({ updateMode: params.result.mode })) restarted = await runDaemonRestart();
			else if (!refreshedGatewayAlreadyHealthy && !params.opts.json) defaultRuntime.log(theme.muted("No installed gateway service found; skipped restart."));
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-CLOBO58V.js");
