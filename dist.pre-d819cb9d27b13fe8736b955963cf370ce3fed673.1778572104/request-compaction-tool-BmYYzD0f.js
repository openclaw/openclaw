...
import { i as deriveTraceparentFromActiveSpan } from "./diagnostic-trace-context-IcGaoHY8.js";
import { t as createSubsystemLogger } from "./subsystem-DtPhzVBn.js";
import { S as createExpiringMapCache } from "./store-load-6WUUNuxk.js";
...
import { _ as readStringParam, l as jsonResult, r as ToolInputError } from "./common-DqyfaHgZ.js";
...
const RequestCompactionToolSchema = Type.Object({
	...
	traceparent: Type.Optional(Type.String({
		description: "Optional W3C traceparent override. When omitted, the tool automatically reuses the active OpenTelemetry span context if one is available.",
