...
export declare function deriveTraceparentFromActiveSpan(): string | undefined;
export declare function runWithActiveOtelTraceparent<T>(traceparent: string | undefined, callback: () => T): T;
