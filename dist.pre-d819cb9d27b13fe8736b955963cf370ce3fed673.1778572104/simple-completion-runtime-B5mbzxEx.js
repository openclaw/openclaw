...
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-BAukXI7p.js";
import { n as resolveModelAsync, t as resolveModel } from "./model-EFkk6Zfp.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-CobBu3XO.js");
