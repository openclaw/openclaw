...
import { s as resolveRuntimeServiceVersion } from "./version-BHBlW4Qb.js";
import { l as runWithDiagnosticTraceContext, n as createDiagnosticTraceContext } from "./diagnostic-trace-context-IcGaoHY8.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-DpXvrs-2.js";
import { i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-BCkS7lAx.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-DDx57YI1.js";
import { i as getRuntimeConfig } from "./io-BTdvKaBm.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-CjhVWpk-.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-9yL2I3rf.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-TU1A55ap.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-BuyF0OO_.js";
import { t as rawDataToString } from "./ws-DjQdI0Wi.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-M7vqTezk.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-BkNhu4qX.js";
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-CF-7GIPV.js";
import "./version-DI7vqe4q.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-nHLngmZH.js";
import "./method-scopes-DIw8NCYq.js";
import { l as roleScopesAllow } from "./pairing-token-DLbuJFe5.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-DEACd8uK.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-B3gmAcP4.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-DOtR4vfY.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist } from "./node-command-policy-BhvV3CxH.js";
import { n as logWs, t as formatForLog } from "./ws-log-MlgWT1hh.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-BgXjCQVD.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-Ccr-_nHd.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-DEx3gtCE.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-5fxKr3CH.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-ClRlXqh7.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-B8Va9crk.js";
import { r as upsertPresence } from "./system-presence-E_HtQ33f.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-BQwa0AK2.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CQObOr0m.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-C3XJIXNk.js";
import { t as truncateCloseReason } from "./close-reason-H2COdmxK.js";
...
function shouldClearUnboundScopesForMissingDeviceIdentity(params) {
	return params.decision.kind !== "allow" || !params.controlUiAuthPolicy.allowBypass && !params.preserveInsecureLocalControlUiScopes && params.trustedProxyAuthOk !== true && (params.authMethod === "token" || params.authMethod === "password" || params.authMethod === "trusted-proxy");
}
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-DMkoeXnC.js");
