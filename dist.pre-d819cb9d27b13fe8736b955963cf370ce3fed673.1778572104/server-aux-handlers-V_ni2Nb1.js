...
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-TU1A55ap.js";
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-CT2eO68J.js";
import { n as channelRouteDedupeKey } from "./channel-route-xbmFitKi.js";
import { n as getLoadedChannelPlugin } from "./registry-DsLW_yUZ2.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-D2XQjp5I.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-BYq9PWxH.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-2imGPc0t.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-BVV2Vgms.js";
import { l as roleScopesAllow } from "./pairing-token-DLbuJFe5.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CWOy0B0n.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-DYBa79Hj.js";
import { r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-Z9Jer_HF.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-Bh9wKH6M.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-Ccr-_nHd.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-BRHz2PC6.js";
import { t as diffConfigPaths } from "./config-diff-CZ78c6Pq.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Xqeakp2j.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-CFYNQ9iE.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-CMX92jUC.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-BsZfrYA9.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-BXHo5OB7.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
