import { c as readErrorName, i as formatErrorMessage } from "./errors-VfATXfah.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-B_IdQqVU.js";
...
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-47m35g2o.js";
import { A as SUBAGENT_ENDED_REASON_KILLED, C as getSubagentSessionStartedAt, D as SUBAGENT_ENDED_OUTCOME_TIMEOUT, E as SUBAGENT_ENDED_OUTCOME_KILLED, M as subagentRuns, O as SUBAGENT_ENDED_REASON_COMPLETE, S as getSubagentSessionRuntimeMs, T as SUBAGENT_ENDED_OUTCOME_ERROR, a as countActiveDescendantRunsFromRuns, b as isStaleUnendedSubagentRun, c as countPendingDescendantRunsFromRuns, f as listDescendantRunsForRequesterFromRuns, j as SUBAGENT_TARGET_KIND_SUBAGENT, k as SUBAGENT_ENDED_REASON_ERROR, l as getSubagentRunByChildSessionKeyFromRuns, n as persistSubagentRunsToDisk, o as countActiveRunsForSessionFromRuns, p as listRunsForControllerFromRuns, r as restoreSubagentRunsFromDisk, t as getSubagentRunsSnapshotForRead, w as resolveSubagentSessionStatus } from "./subagent-registry-state-ZrQyB1gH.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-CO0PxqWg.js";
import { a as isSilentReplyText } from "./tokens-1nrYy2wZ.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-D4aIsu33.js";
import "./pi-bundle-mcp-tools-BSGh0D9x.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-C9Ug_85Z.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-BkjJL_f9.js";
import "./subagent-announce-queue-BUfyTw2F.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DNZxjY_p.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-1TDjzg6F.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-Dz5jWN2E.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-ClA0EWJM.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-C3Q5WyKV.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-ClA0EWJM.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-CC_QskTr.js").then(({ scheduleOrphanRecovery }) => {
