...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-BTdvKaBm.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-BPW65iQJ.js";
...
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-BLMbMwy0.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-DPSFt8bq.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-etfJie0i.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-n_iJcEJB.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BcV52Wd5.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DXc6wJem.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DJ5dFjFy.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DJLh7RLw.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-CTEnjZ3M.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CT9FJypg.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-B2QvS1r2.js");
		emitDoctorNotes({
			note,
