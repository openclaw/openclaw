...
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-CAvZUxTt.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-Dd8YbriB.js";
...
import { r as shouldDebounceTextInbound } from "./channel-inbound-CknlNatI.js";
...
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-BCZrX3ak.js";
import { A as resolveTelegramGroupAllowFromContext, B as getTelegramTextParts, C as extractTelegramForumFlag, D as resolveTelegramDirectPeerId, E as resolveTelegramCommandAuthorization, F as withResolvedTelegramForumFlag, G as resolveTelegramPrimaryMedia, I as buildSenderLabel, J as isSenderAllowed, K as expandTelegramAllowFromWithAccessGroups, L as buildSenderName, M as resolveTelegramStreamMode, N as resolveTelegramThreadSpec, O as resolveTelegramForumFlag, P as shouldUseTelegramDmThreadSession, R as expandTextLinks, S as describeReplyTarget, U as normalizeForwardedContext, V as hasBotMention, X as normalizeDmAllowFromWithStore, Y as normalizeAllowFrom, Z as resolveTelegramEffectiveDmPolicy, _ as buildTelegramGroupPeerId, a as renderTelegramHtmlText, b as buildTelegramThreadParams, g as buildTelegramGroupFrom, h as buildGroupLabel, j as resolveTelegramReplyId, k as resolveTelegramForumThreadId, m as tagTelegramNetworkError, n as markdownToTelegramChunks, q as resolveTelegramDmAllow, v as buildTelegramParentPeer, w as isTelegramCommandsAllowFromConfigured, x as buildTypingThreadParams, y as buildTelegramRoutingTarget, z as extractTelegramLocation } from "./format-Bf4EcMGn.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-DvqmkJPA.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-CaQvEk0F.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-DRpANFcC.js";
...
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DIiAITVZ.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-D4ZvX0jP.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DHUeX0ih.js";
import { C as withTelegramApiErrorLogging, D as sequentialize, E as apiThrottler, T as Bot, a as editMessageTelegram, g as recordSentMessage, w as getOrCreateAccountThrottler, x as buildInlineKeyboard } from "./send-D1XOugdH.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-CnlbkOxR.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-CmuY_Z9h.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-B3BkpDox.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-Daato04y.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-CICSg0u0.js")).defaultTelegramBotDeps;
