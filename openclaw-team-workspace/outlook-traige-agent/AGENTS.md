...
- After classifying, use notify-main.sh to send important notifications to agent "main".
- Only use notify-main.sh for important email notifications — nothing else.
