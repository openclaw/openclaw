...
import { C as resolvePluginControlPlaneFingerprint } from "./plugin-registry-B7y3hWQJ.js";
...
import { $ as resolveProviderRuntimePlugin, _ as normalizeProviderToolSchemasWithPlugin, f as inspectProviderToolSchemasWithPlugin } from "./provider-runtime-BSjd3Cpt.js";
...
import { d as isGoogleModelApi } from "./pi-embedded-helpers-CiLGvxHU.js";
...
import { t as pluginRegistrationContractRegistry } from "./registry-BslL_IRF.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-C4MwZSBJ.js");
...
//#endregion
export { isMessagingTool as C, isMessageToolSendActionName as S, supportsModelTools as T, isToolResultError as _, logAgentRuntimeToolDiagnostics as a, sanitizeToolResult as b, normalizeProviderToolSchemas as c, extractMessagingToolSend as d, extractToolErrorCode as f, filterToolResultMediaUrls as g, extractToolResultText as h, shouldAllowProviderOwnedThinkingReplay as i, runAgentCleanupStep as l, extractToolResultMediaArtifact as m, createAgentToolResultMiddlewareRunner as n, normalizeAgentRuntimeTools as o, extractToolErrorMessage as p, resolveTranscriptPolicy as r, logProviderToolSchemaDiagnostics as s, buildEmbeddedAttemptToolRunContext as t, buildToolLifecycleErrorResult as u, isToolResultTimedOut as v, isMessagingToolSendAction as w, collectTextContentBlocks as x, sanitizeToolArgs as y };
