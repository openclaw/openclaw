...
declare const singleAccountKeysToMove: ("deviceId" | "replyToMode" | "avatarUrl" | "groups" | "responsePrefix" | "dm" | "actions" | "textChunkLimit" | "dangerouslyAllowNameMatching" | "chunkMode" | "blockStreaming" | "mediaMaxMb" | "allowBots" | "ackReaction" | "ackReactionScope" | "threadBindings" | "reactionNotifications" | "threadReplies" | "autoJoin" | "initialSyncLimit" | "encryption" | "allowlistOnly" | "startupVerification" | "startupVerificationCooldownHours" | "autoJoinAllowlist" | "rooms")[];
