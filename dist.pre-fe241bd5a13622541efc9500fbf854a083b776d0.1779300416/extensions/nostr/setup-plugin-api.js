...
import { D as patchTopLevelChannelConfigSection, f as createStandardChannelSetupStatus } from "../../setup-wizard-helpers-DjT-WELm.js";
...
import { t as NostrConfigSchema } from "../../config-schema-DQ-VEEqk.js";
...
const nostrSetupWizard = createDelegatedSetupWizardProxy({
	channel,
	loadWizard: async () => (await import("../../setup-surface-3JY2izwB.js")).nostrSetupWizard,
