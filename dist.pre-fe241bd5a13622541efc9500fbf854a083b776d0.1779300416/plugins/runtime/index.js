...
import { r as getChildLogger, v as normalizeLogLevel } from "../../logger-RkfmvLxA.js";
import { a as shouldLogVerbose } from "../../globals-xAdlid3k.js";
import { a as logWarn } from "../../logger-BhJTdrHk.js";
import { r as runCommandWithTimeout } from "../../exec-4IZJCFPU.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-C2ym8-NP.js";
...
import { o as normalizeDeliveryContext } from "../../delivery-context.shared-DtlWhKNv.js";
...
import { o as requestHeartbeat } from "../../heartbeat-wake-sS2lf3LW.js";
import { a as enqueueSystemEvent } from "../../system-events-BRDkm48Z.js";
import { c as getImageMetadata, p as resizeToJpeg } from "../../media-services-CNV3toly.js";
import { o as generateMusic, s as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-CNqNfhIn.js";
...
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "../../runtime-DGPbVPlm.js";
import { t as loadWebMedia } from "../../web-media-BSyRS66Z.js";
import { p as listTasksForFlowId } from "../../task-registry-DvGXAQV5.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-BwpoHlXv.js";
import "../../runtime-internal-DBnkQE1r.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-B1Js0LBB.js";
import { n as resolveAgentIdentity } from "../../identity-D1W0mdWU.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-47S3bsk_.js";
import { t as resolveAgentTimeoutMs } from "../../timeout-DQpX0NNX.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-9j-9c2_i.js";
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-BsMNvSN1.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-zFTrfHNT.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-CxPbKo54.js";
import { r as isVoiceCompatibleAudio } from "../../audio-CVFIRHpA.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-bvgr-JNv.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-CuHD52VP.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-mJcu7Rgs.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-E8pU-atp.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-DmQqiF17.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-MbQfTQAp.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-C7hHND2a.js"), (m) => m.createRuntimeLlm({
