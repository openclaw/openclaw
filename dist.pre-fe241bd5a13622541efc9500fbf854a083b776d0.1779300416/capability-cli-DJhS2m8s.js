...
import { r as callGateway, u as randomIdempotencyKey } from "./call-hG2jRq58.js";
...
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-C9PhwTe-.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-KwD0KwGN.js";
...
import { c as getImageMetadata, s as convertHeicToJpeg } from "./media-services-CNV3toly.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-CxF8EyJ8.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-CoAJYdGq.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-CgBeI_pc.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, d as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsProvider, u as listSpeechVoices, w as setTtsPersona } from "./tts-runtime-CKfv1i60.js";
import "./tts-DROMGg7n.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-9j-9c2_i.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-BsMNvSN1.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BT9187rN.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DM1tDlFt.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-ax79Uncj.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-BWmx1PJB.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-xJXb-25F.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Bq-ooJwu.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-ClxFBTMI.js");
