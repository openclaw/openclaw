...
import { i as getLogger } from "./logger-RkfmvLxA.js";
import { i as getRuntimeConfig } from "./io-B3cB3MOo.js";
import { i as resolveMainSessionKey } from "./main-session-DkcVDKOd.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, s as resolveStoredSessionOwnerAgentId } from "./combined-store-gateway-Dn450_GM.js";
...
import { S as parseSessionThreadInfo, c as cloneSessionStoreRecord, h as capEntryCount, i as collectSessionMaintenancePreserveKeys, k as normalizeStoreSessionKey, r as resolveMaintenanceConfig, t as loadSessionStore, v as pruneStaleEntries } from "./store-load-QI_1eBWp.js";
import { b as pruneUnreferencedSessionArtifacts, s as updateSessionStore, t as archiveRemovedSessionTranscripts, x as resolveSessionArtifactCanonicalPathsForEntry, y as enforceSessionDiskBudget } from "./store-r4WEtwxi.js";
import { a as resolveSessionStoreTargets, i as resolveAllAgentSessionStoreTargetsSync } from "./targets-Bm5kkimO.js";
...
function findSessionEntryInStore(store, keys) {
	...
	for (const key of keys) {
		...
		if (foldedLegacyKey !== normalized && Object.prototype.hasOwnProperty.call(store, foldedLegacyKey)) {
			foundRoutableCandidate ||= hasRoutableDeliveryContext(deliveryContextFromSession(store[foldedLegacyKey]));
...
//#endregion
export { canonicalizeAbsoluteSessionFilePath as a, resolveSessionLifecycleTimestamps as c, serializeSessionCleanupResult as i, resolveMainSessionKeyFromConfig as l, resolveSessionCleanupAction as n, rewriteSessionFileForNewSessionId as o, runSessionsCleanup as r, readSessionHeaderStartedAtMs as s, purgeAgentSessionStoreEntries as t, extractDeliveryInfo as u };
