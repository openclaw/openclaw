...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-D2HSDKMs.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CfJyeLFa.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-C05tDS4l.js";
import { a as resolveSecretRefValue } from "./resolve-LAZ4Lnz-.js";
import { n as info, o as success, t as danger } from "./globals-xAdlid3k.js";
import { U as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot, w as validateConfigObjectRawWithPlugins, x as collectUnsupportedSecretRefPolicyIssues } from "./io-B3cB3MOo.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-BfFDdqsq.js";
import { n as redactConfigObject } from "./redact-snapshot-euCC3zpt.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-t9kWAGEW.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-QXnF0A8Y.js";
import { n as setCommandJsonMode } from "./json-mode-CXYNa_RJ.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BIuzUfpw.js");
