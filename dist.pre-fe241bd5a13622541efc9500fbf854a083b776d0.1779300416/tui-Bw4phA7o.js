...
import { u as registerUncaughtExceptionHandler } from "./unhandled-rejections-0oOmbFbi.js";
import { n as VERSION } from "./version-CQfgAE7_.js";
import { _ as resolveSessionAgentId, c as resolveAgentIdByWorkspacePath } from "./agent-scope-C51VTAKH.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Ce_xWkNq.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-BAP1m9Ju.js";
import { c as resolveDefaultAgentId } from "./agent-scope-config-C5zL9i5G.js";
import { n as defaultRuntime } from "./runtime-yzlkhCoS.js";
import { t as privateFileStore } from "./private-file-store-Dbf8cmWU.js";
import { n as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-CrQUtBgy.js";
import { t as loggingState } from "./state-CHRYWIGY.js";
import { s as setConsoleSubsystemFilter } from "./console-BIEzsfPC.js";
import { i as isLoopbackHost } from "./net-DCUMtgJy.js";
import { i as getRuntimeConfig } from "./io-B3cB3MOo.js";
import { n as modelKey } from "./model-ref-shared-D3hTIwCC.js";
import { r as DEFAULT_PROVIDER } from "./defaults-mDjiWzE5.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-C2ym8-NP.js";
import "./config-Dh6CigU2.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BVWE_ra1.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-VS8DuUWW.js";
import "./message-channel-CKhGBxFS.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-zY0I9Wur.js";
import { n as GatewayClient, r as GatewayClientRequestError } from "./client-CyllBnBi.js";
import "./protocol-Cep1UV7i.js";
import "./version-DDqbebEG.js";
import { d as resolveExplicitGatewayAuth, n as buildGatewayConnectionDetails, s as ensureExplicitGatewayAuth } from "./call-hG2jRq58.js";
...
import { m as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-KwD0KwGN.js";
import { r as stripLeadingInboundMetadata } from "./strip-inbound-meta-D2-__BeH.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CuUvHfKt.js";
import { t as isAuthErrorMessage } from "./failover-matches-BiyHIrZb.js";
import { n as formatTokenCount } from "./usage-format-CYUFeIiq.js";
import { l as readSessionMessagesAsync, n as capArrayByJsonBytes } from "./session-utils.fs-C4fTjcHn.js";
import { c as loadSessionEntry, i as listAgentsForGateway, l as migrateAndPruneGatewaySessionStoreKey, m as resolveGatewaySessionStoreTarget, o as listSessionsFromStoreAsync, v as resolveSessionModelRef } from "./session-utils-V9h3eRNz.js";
import "./pi-embedded-helpers-CiLGvxHU.js";
import { j as setEmbeddedMode } from "./openclaw-tools-CNqNfhIn.js";
import { r as resolveToolDisplay, t as formatToolDetail } from "./tool-display-DRvuIHo7.js";
import { o as resolveSessionInfoModelSelection } from "./subagent-list-Ba77-rs0.js";
import { n as formatTimeAgo, t as formatRelativeTimestamp } from "./format-relative-Bjc3l98W.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-B968xb1-.js";
import "./commands-registry-xWP8RUXv.js";
import { c as performGatewaySessionReset } from "./session-reset-service-C9_5Kh-G.js";
import { t as normalizeGroupActivation } from "./group-activation-BxkIP-sT.js";
import { n as agentCommandFromIngress } from "./agent-command-DXzgNJb2.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-pfJY3heA.js";
...
import { t as resolveGatewayInteractiveSurfaceAuth } from "./auth-surface-resolution-nXfG_Z9A.js";
import { i as shouldSuppressAssistantEventForLiveChat, n as projectLiveAssistantBufferedText, r as resolveMergedAssistantText, t as normalizeLiveAssistantEventText } from "./live-chat-projector-CTTXO86s.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-YKClg_Dw.js";
...
function createCommandHandlers(context) {
	...
	const sendMessage = async (text) => {
		...
		if (!isBtw && (state.activeChatRunId || state.pendingChatRunId || state.pendingOptimisticUserMessage)) {
...
function createEventHandlers(context) {
	...
	const handleAgentEvent = (payload) => {
		...
		if (!(isActiveRun || isSessionRun || finalizedRuns.has(evt.runId))) return;
		if (evt.stream === "tool") {
			if (isActiveRun) armStreamingWatchdog(evt.runId);
...
async function runTui(opts) {
	...
	updateAutocompleteProvider();
	const canSubmitChatMessage = () => !state.activeChatRunId && !state.pendingChatRunId && !state.pendingOptimisticUserMessage;
...
//#endregion
export { resolveFinalAssistantText as S, scheduleProcessExitAfterTuiReturn as _, isIgnorableTuiStopError as a, createSubmitBurstCoalescer as b, resolveCtrlCAction as c, resolveLocalAuthCliInvocation as d, resolveLocalAuthSpawnCwd as f, runTui as g, resolveTuiSessionKey as h, installTuiTerminalLossExitHandler as i, resolveGatewayDisconnectState as l, resolveTuiCtrlCAction as m, createDeferredTuiFinish as n, isTuiTerminalLossError as o, resolveLocalAuthSpawnOptions as p, drainAndStopTuiSafely as r, resolveCodexCliBin as s, createBackspaceDeduper as t, resolveInitialTuiAgentId as u, stopTuiSafely as v, shouldEnableWindowsGitBashPasteFallback as x, createEditorSubmitHandler as y };
