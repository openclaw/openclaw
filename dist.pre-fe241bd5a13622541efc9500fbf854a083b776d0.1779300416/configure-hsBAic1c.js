...
import { g as shortenHomePath, p as resolveUserPath, x as isPlainObject } from "./utils-DX02THHb.js";
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-D2HSDKMs.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-BJ18q0JI.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-C4YazlBQ.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-B7y3hWQJ.js";
...
import { a as findTailscaleBinary } from "./tailscale-Y-hlmB6u.js";
...
import { t as ConfigMutationConflictError } from "./mutate-Bs39Ukz8.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CZ5M6e25.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CFC7qYcp.js";
import { n as applyAuthChoice } from "./auth-choice-Bh_DDqu5.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Ip1DCNYA.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CsX-DClg.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BcA-OcEs.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DVZ6EJD5.js";
import { n as formatHealthCheckFailure } from "./health-format-DaSqSjzQ.js";
import { n as healthCommand } from "./health-DoDbIC1q.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CJabtG_R.js";
import { t as setupSkills } from "./onboard-skills-tFS3jxZg.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-DSmu0o6W.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-_twKinrB.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-C_zndRD_.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DXx5qTwc.js");
