import { p as shouldMigrateStateFromPath } from "./argv-CIAIZU-s.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-Dywb-ncd.js")).runDoctorConfigPreflight({
			migrateState: false,
