...
import { d as runWithConcurrency, f as hasNonTextEmbeddingParts, h as splitTextToUtf8ByteLimit, m as estimateUtf8Bytes } from "./internal-ieZM1aEx.js";
...
const resolveApiKeyForProvider = async (...args) => {
	return (await import("./model-auth-BGsnaixd.js")).resolveApiKeyForProvider(...args);
};
//#endregion
