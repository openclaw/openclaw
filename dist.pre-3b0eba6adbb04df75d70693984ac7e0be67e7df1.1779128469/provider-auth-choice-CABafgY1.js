...
import { n as openUrl } from "./browser-open-DbLXvJPt.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BLbKdhdl.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-szIR3G-X.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DzxJz7_c.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-ChEeK0h4.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-BkPgmyhQ.js") };
