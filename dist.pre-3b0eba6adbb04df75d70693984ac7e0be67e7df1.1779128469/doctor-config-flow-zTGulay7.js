...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CaHWZ8wj.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CLD-Gtpn.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-CT6QtCRy.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DN5nRit0.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight--HE51fqj.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-D7A1zi5a.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-C6Y_H0G1.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DYvSubkj.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BxFKmdkj.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-EqoenUw8.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DMST7eog.js");
		emitDoctorNotes({
			note,
