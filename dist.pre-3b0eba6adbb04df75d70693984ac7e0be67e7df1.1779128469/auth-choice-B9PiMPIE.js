...
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-C3Biijam.js";
import { r as resolveManifestProviderAuthChoice, t as resolveManifestDeprecatedProviderAuthChoice } from "./provider-auth-choices-BLbKdhdl.js";
import { n as isDeprecatedAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-MWZNqPUw.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CMJBnReN.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-BfjZNh0J.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-DIXH3FL_.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-Cdm7jmKV.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-CiP7Vqec.js");
