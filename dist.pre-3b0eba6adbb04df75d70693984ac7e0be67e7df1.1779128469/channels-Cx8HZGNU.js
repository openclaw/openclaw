...
import { a as getResolvedLoggerSettings } from "./logger-tDhXRPrK.js";
import { t as danger } from "./globals-DaPK6X5S.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CaHWZ8wj.js";
...
import { r as callGateway } from "./call-CaCR3IJQ.js";
import { i as getBundledChannelSetupPlugin } from "./bundled-CjVg8wOZ.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BstTfco-.js";
import "./plugins-3tO_yYSp.js";
import "./logging-CKt9_2Pp.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-ytoPHKhA.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-gfVgcAc6.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-KuQzqklb.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BlOFYFV6.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-2y9tjTUV.js";
...
import { t as WizardCancelledError } from "./prompts-CkaDqWqf.js";
import { t as createClackPrompter } from "./clack-prompter-tPucPVzk.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-CInI7UrM.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-DK-bw-4o.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-B3nHObCh.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DL0SPUu1.js";
import { n as resolveLogFile } from "./log-tail-TJ6js-yd.js";
import { t as parseLogLine } from "./parse-log-line-BGcqgsSi.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-BBwVI72e.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation--9pBGrkD.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-DHRc0nsZ.js";
import { t as channelsListCommand } from "./list-CmLyTZEe.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-BCwSqTiD.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-4Dqs8hD6.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BvmVllxg.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BFw2kKmp.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-L5Rh1FNc.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Bt2O06x4.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-BSbonJqj.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-gxsQ0p6B.js");
