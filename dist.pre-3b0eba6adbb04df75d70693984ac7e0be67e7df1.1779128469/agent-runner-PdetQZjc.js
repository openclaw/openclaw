...
import { c as updateSessionStoreEntry, s as updateSessionStore } from "./store-PGV-10Zw.js";
...
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-BAIXA0PI.js";
...
import { a as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-B8_DhpFs.js";
...
import { r as enqueueCommitmentExtraction } from "./runtime-DVh9l4LI.js";
...
import { r as resolveLiveContinuationRuntimeConfig } from "./config-BhfUFnKQ.js";
...
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-BM0cwrvN.js";
import { r as runWithModelFallback } from "./model-fallback-DeS98mXl.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-DxQ4Tfug.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Cvuo8S8S.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-eyl9LWpl.js";
...
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DB9OmZUE.js";
import "./sandbox-BV4DDHGH.js";
import { n as readPostCompactionContext } from "./post-compaction-context-DXF4FO86.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-sNqCP2P4.js";
import { a as resolveReplyRunFireReason, c as runCliAgentWithLifecycle, i as runAgentTurnWithFallback, n as resolveRunAfterAutoFallbackPrimaryProbeRecheck, o as normalizeReplyPayloadDirectives, r as resolveSessionRuntimeOverrideForProvider, t as buildKnownAgentRunFailureReplyPayload } from "./agent-runner-execution-jTLVtDDO.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-C2kV18YB.js";
...
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-D9Ztej24.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-DD6B-O6C.js";
...
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-Bug54cwO.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-CAAOhDym.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-D6f9UPsy.js";
...
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-CLRYOTL0.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-ChFzRWG5.js"));
		...
		try {
							...
							const result = await runEmbeddedPiAgent({
								...
								requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
									...
									triggerCompaction: async (request) => {
										try {
											const { compactEmbeddedPiSession } = await import("./compact.queued-ByQ8FEdX.js");
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BNrykGzx.js"),
					import("./config-BmQKMGw0.js"),
					import("./state-Dt-L5RIQ.js"),
					import("./store-2dw-YKGl.js")
				]);
