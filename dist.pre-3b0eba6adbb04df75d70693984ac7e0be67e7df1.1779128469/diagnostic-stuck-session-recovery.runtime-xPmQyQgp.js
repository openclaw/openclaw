import { b as resolveCronSessionDiagnosticContext, v as formatRecoveryOutcome, y as formatStoppedCronSessionDiagnosticFields } from "./diagnostic-C2YY-LX7.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-BAqp3AUw.js";
import { i as isDiagnosticSessionStateCurrent } from "./diagnostic-session-state-BFBOkgJ_.js";
import { f as resolveActiveEmbeddedRunHandleSessionId, o as isEmbeddedPiRunActive, p as resolveActiveEmbeddedRunSessionId, s as isEmbeddedPiRunHandleActive, t as abortAndDrainEmbeddedPiRun } from "./runs-BAIXA0PI.js";
import { o as getCommandLaneSnapshot, p as resetCommandLane } from "./command-queue-C-_VpIyT.js";
import { t as resolveEmbeddedSessionLane } from "./lanes-C4Sn7RHt.js";
...
async function recoverStuckDiagnosticSession(params) {
	...
	try {
		...
		let activeSessionId = params.sessionKey ? resolveActiveEmbeddedRunHandleSessionId(params.sessionKey) ?? fallbackActiveSessionId : fallbackActiveSessionId;
		...
		if (!activeSessionId && activeWorkSessionId && isEmbeddedPiRunActive(activeWorkSessionId)) if (params.allowActiveAbort === true) {
			const result = await abortAndDrainEmbeddedPiRun({
