...
import { J as getShellEnvAppliedKeys, Q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-CaHWZ8wj.js";
...
import { g as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CBE9kcfX.js";
...
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-q9QOdpYp.js";
import "./workspace-CvbkPv2B.js";
import { n as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-Czl05FD0.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-B-NOl2IQ.js";
import { t as maskApiKey } from "./mask-api-key-B_lZsdmv.js";
import { t as loadModelsConfig } from "./load-config-Cvj4ko6P.js";
import { n as isRich } from "./list.format-j-ZzaNow.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-lYaJqs37.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-DcAaS8FJ.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-DWBh8zse.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-B8mUe2kU.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-CISfbDLJ.js");
			runtime.log("");
