...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-fnjb-BRI.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-C7CdfQ1e.js";
...
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-Djo7pC9M.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CdOruyBL.js";
...
import { t as buildGatewayCronService } from "./server-cron-Dsmuhdps.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B4w74UjJ.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-Bo1-ogrk.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-ytBTqK1_.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-D3-xZGqq.js"), import("./gmail-watcher-lifecycle-D8CH-iCy.js")]);
