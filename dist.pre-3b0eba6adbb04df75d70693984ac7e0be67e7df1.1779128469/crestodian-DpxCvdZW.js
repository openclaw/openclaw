...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-DnZmCii7.js";
import { r as resolveCrestodianOperation } from "./dialogue-IhFkUZLs.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BKYeoz_O.js")).runCrestodianTui;
	opts.onReady?.();
