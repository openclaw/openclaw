...
import { p as normalizeThinkLevel } from "./thinking-Bzr_rdQG.js";
...
import { r as callGateway, u as randomIdempotencyKey } from "./call-CaCR3IJQ.js";
...
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-CBE9kcfX.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-Bsh9R1Kd.js";
...
import { c as getImageMetadata, s as convertHeicToJpeg } from "./media-services-BoO-9yx1.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-B0KDp7Sm.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-BDYv2Zht.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-oEQttQPH.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, d as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsProvider, u as listSpeechVoices, w as setTtsPersona } from "./tts-runtime-CLRRXY7c.js";
import "./tts-Bia2-bW5.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DSRJr9FI.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-y6nSjrkx.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DKxAGJEZ.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DvVNsnso.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-O35DPMRs.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-L5tMRX3L.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Ck8yJT0j.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-BmQ7DKdH.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BjlRErZV.js");
