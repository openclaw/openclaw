...
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-D36pM_fW.js";
...
type DiagnosticContinuationQueueOwnerSample = {
  sessionKey: string;
...
type DiagnosticContinuationQueueHistoryPoint = {
  sampledAt: number;
  intervalMs?: number;
  totalQueued: number;
  pendingRunnable: number;
...
type DiagnosticContinuationQueueSampleEvent = DiagnosticBaseEvent & {
...
type DiagnosticRunFireReason = "timer" | "external-trigger" | "continuation-chain";
...
//#endregion
export { DiagnosticTalkEvent as $, DiagnosticMessageQueuedEvent as A, createTalkEventSequencer as At, DiagnosticRunFireReason as B, DiagnosticMemorySampleEvent as C, TalkEvent as Ct, DiagnosticMessageDeliveryKind as D, TalkEventType as Dt, DiagnosticMessageDeliveryErrorEvent as E, TalkEventSequencer as Et, DiagnosticPhaseCompletedEvent as F, DiagnosticSessionLongRunningEvent as G, DiagnosticRunStartedEvent as H, DiagnosticPhaseDetails as I, DiagnosticSessionRecoveryStatus as J, DiagnosticSessionRecoveryCompletedEvent as K, DiagnosticPhaseSnapshot as L, DiagnosticModelCallErrorEvent as M, DiagnosticModelCallStartedEvent as N, DiagnosticMessageDeliveryStartedEvent as O, TalkMode as Ot, DiagnosticPayloadLargeEvent as P, DiagnosticSessionStuckEvent as Q, DiagnosticRunAttemptEvent as R, DiagnosticMemoryPressureEvent as S, TalkBrain as St, DiagnosticMessageDeliveryCompletedEvent as T, TalkEventInput as Tt, DiagnosticSessionActiveWorkKind as U, DiagnosticRunProgressEvent as V, DiagnosticSessionAttentionClassification as W, DiagnosticSessionState as X, DiagnosticSessionStalledEvent as Y, DiagnosticSessionStateEvent as Z, DiagnosticLaneDequeueEvent as _, onDiagnosticEvent as _t, DiagnosticContinuationQueueSampleEvent as a, DiagnosticToolLoopEvent as at, DiagnosticLivenessWarningReason as b, setDiagnosticsEnabledForProcess as bt, DiagnosticEventPayload as c, DiagnosticWebhookErrorEvent as ct, DiagnosticHarnessRunCompletedEvent as d, areDiagnosticsEnabledForProcess as dt, DiagnosticTelemetryExporterEvent as et, DiagnosticHarnessRunErrorEvent as f, emitDiagnosticEvent as ft, DiagnosticHeartbeatEvent as g, isDiagnosticsEnabled as gt, DiagnosticHarnessRunStartedEvent as h, formatDiagnosticTraceparentForPropagation as ht, DiagnosticContinuationQueueOwnerSample as i, DiagnosticToolExecutionStartedEvent as it, DiagnosticModelCallCompletedEvent as j, DiagnosticMessageProcessedEvent as k, TalkTransport as kt, DiagnosticExecProcessCompletedEvent as l, DiagnosticWebhookProcessedEvent as lt, DiagnosticHarnessRunPhase as m, emitTrustedDiagnosticEvent as mt, DiagnosticContinuationQueueHistoryPoint as n, DiagnosticToolExecutionCompletedEvent as nt, DiagnosticEventInput as o, DiagnosticToolParamsSummary as ot, DiagnosticHarnessRunOutcome as p, emitFailoverEvent as pt, DiagnosticSessionRecoveryRequestedEvent as q, DiagnosticContinuationQueueMetrics as r, DiagnosticToolExecutionErrorEvent as rt, DiagnosticEventMetadata as s, DiagnosticUsageEvent as st, DiagnosticContextAssembledEvent as t, DiagnosticToolExecutionBlockedEvent as tt, DiagnosticFailoverEvent as u, DiagnosticWebhookReceivedEvent as ut, DiagnosticLaneEnqueueEvent as v, onInternalDiagnosticEvent as vt, DiagnosticMemoryUsage as w, TalkEventContext as wt, DiagnosticLogRecordEvent as x, TALK_EVENT_TYPES as xt, DiagnosticLivenessWarningEvent as y, resetDiagnosticEventsForTest as yt, DiagnosticRunCompletedEvent as z };