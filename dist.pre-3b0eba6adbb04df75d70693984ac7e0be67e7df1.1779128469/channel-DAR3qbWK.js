...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-Blaz-b6Q.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-oJSX1WKe.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-Jq5bmS3N.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-DC20QesH.js";
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-CZxSDSxY.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-qm6lMmPH.js";
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-Dmp3WXtC.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-DTV13ViS.js";
import "./channel-api-BqBqqFs2.js";
import { t as parseDiscordTarget } from "./target-parsing-C-sqxcSW.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-Da0hU3_i.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-ACqWu2_D.js";
import { t as getDiscordRuntime } from "./runtime-DXJItGYA.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-kDQ_VmgL.js";
import { t as getDiscordApprovalCapability } from "./approval-native-DYw49Ura.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-Cy9UNNVO.js";
import { t as discordMessageActions$1 } from "./channel-actions-B3-ThDKd.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-DrCc4QwX.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BqG6Uv7r.js";
import { n as discordOutbound } from "./outbound-adapter-Cc3syB7i.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-DSG7LBPs.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-DIVu4oEP.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CwN1zK6R.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-B2zIKCIc.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DiI7VW3y.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-D-jQf8ls.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-BcQQjiH-.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-BTG-vT8-.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DIx3pg4e.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DqCtZS4P.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-Dvvkjn5U.js");
