import { a as normalizeLowercaseStringOrEmpty, f as readStringValue, s as normalizeOptionalLowercaseString } from "./string-coerce-LndEvhRk.js";
import { i as resolveProviderRequestPolicy } from "./provider-attribution-DnDXhn2l.js";
import { c as resolveProviderRequestPolicyConfig } from "./provider-request-config-C4XXSCDA.js";
import { t as log } from "./logger-x1d1QPh0.js";
import { a as resolveCodexNativeSearchActivation, i as patchCodexNativeWebSearchPayload } from "./codex-native-web-search-core-BQzEgIqG.js";
import { t as applyAnthropicEphemeralCacheControlMarkers } from "./anthropic-payload-policy-C0pzzU5o.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-YXJ4p0mz.js";
import { S as emitModelTransportDebug, a as applyOpenAIResponsesPayloadPolicy, c as flattenCompletionMessagesToStringContent, i as createOpenAIResponsesTransportStreamFn, l as stripCompletionMessagesToRoleContent, o as resolveOpenAIResponsesPayloadPolicy, s as resolveOpenAIReasoningEffortForModel } from "./openai-transport-stream-CeGFuTDm.js";
import "./provider-stream-shared-BcPcn0fF.js";
...
function readPayloadToolName(tool) {
	...
	return typeof record.function?.name === "string" ? record.function.name : void 0;
}
...
//#endregion
export { isAnthropicModelRef as C, isAnthropicFamilyCacheTtlEligible as S, resolveOpenAIFastMode as _, createCodexNativeWebSearchWrapper as a, createMinimaxFastModeWrapper as b, createOpenAICompletionsToolsCompatWrapper as c, createOpenAIReasoningCompatibilityWrapper as d, createOpenAIResponsesContextManagementWrapper as f, createOpenAIThinkingLevelWrapper as g, createOpenAITextVerbosityWrapper as h, isProxyReasoningUnsupported as i, createOpenAIDefaultTransportWrapper as l, createOpenAIStringContentWrapper as m, createOpenRouterSystemCacheWrapper as n, createOpenAIAttributionHeadersWrapper as o, createOpenAIServiceTierWrapper as p, createOpenRouterWrapper as r, createOpenAICompletionsStrictMessageKeysWrapper as s, createKilocodeWrapper as t, createOpenAIFastModeWrapper as u, resolveOpenAIServiceTier as v, resolveAnthropicCacheRetentionFamily as w, createMinimaxThinkingDisabledWrapper as x, resolveOpenAITextVerbosity as y };
