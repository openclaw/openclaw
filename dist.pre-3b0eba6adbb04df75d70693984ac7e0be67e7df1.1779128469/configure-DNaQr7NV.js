...
import { t as ConfigMutationConflictError } from "./mutate-C2_btZYz.js";
...
import { n as applyAuthChoice } from "./auth-choice-xLaqZDjz.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CMJBnReN.js";
import { i as setupChannels } from "./onboard-channels-CwkfXA1z.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DFC00EAg.js";
import { t as promptCustomApiConfig } from "./onboard-custom-GnIs_-OE.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-BkPgmyhQ.js");
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-BkRldXkU.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DZcrWjzl.js");
