...
import { a as logWarn, r as logInfo } from "./logger-B-H6-XfD.js";
import { Y as getShellPathFromLoginShell, Z as resolveShellEnvFallbackTimeoutMs } from "./io-CaHWZ8wj.js";
import { f as resolveApprovalAuditTrustPath } from "./exec-safe-bin-trust-B0KACPCA.js";
import { O as normalizeExecutableToken, c as isShellWrapperExecutable, k as splitShellArgs, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-DovxfRJ_.js";
import { t as killProcessTree } from "./kill-tree-ByHPL48S.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-DJtqYoTD.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-D5DA_QCa.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CG69Vfrb.js";
import { d as sanitizeUserFacingText, f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText } from "./sanitize-user-facing-text-DF4us71R.js";
import { t as formatDurationCompact } from "./format-duration-1VggpwYc.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-YbOgD3V7.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-C8Y05xIQ.js";
import { o as failedTextResult, y as textResult } from "./common-B0XXBiTk.js";
import { t as callGatewayTool } from "./gateway-DaJcWYGA.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-wuwcSz7u.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-QXUlqyfA.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-lSLLf8II.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-DVw-2pj1.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-DFriket2.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-BLlaH9yu.js";
...
import { t as sendMessage } from "./message-B0dDtZBW.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-CJ3NeQ5L.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CT_pSSUO.js";
import { t as getProcessSupervisor } from "./supervisor-BxjCVUlT.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-DQbzVfen.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-B1EGrdp1.js";
import { u as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-Ceh-FC_p.js";
import { n as detectPolicyInlineEval } from "./policy-DWZPBGXB.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-w4DY2GNp.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-bxM8D2nO.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-evbxk-Hy.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-DZO5zK9G.js";
