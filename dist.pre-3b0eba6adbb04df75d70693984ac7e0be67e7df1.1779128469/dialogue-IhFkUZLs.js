import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BVVHPFk5.js";
import { r as loadCrestodianOverview } from "./overview-DnZmCii7.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-F-YxrnmI.js")).planCrestodianCommand)({
		input,
		overview
	});
