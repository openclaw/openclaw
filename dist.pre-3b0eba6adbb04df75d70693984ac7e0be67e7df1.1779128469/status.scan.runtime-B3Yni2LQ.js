...
import { a as asRecord } from "./record-coerce-BCLwAR3H.js";
import { n as sha256HexPrefix } from "./redact-identifier-B4X5hGr3.js";
import { p as listExplicitConfiguredChannelIdsForConfig } from "./channel-plugin-ids-sdhQ1lo-.js";
import { t as resolveMissingOfficialExternalChannelPluginRepairHint } from "./official-external-plugin-repair-hints-BB3Vbkme.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-BlOFYFV6.js";
import { r as resolveReadOnlyChannelPluginsForConfig } from "./read-only-2y9tjTUV.js";
import { t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-CFxwu5OO.js";
import { i as formatChannelAllowFrom, n as resolveInspectedChannelAccount, r as buildChannelAccountSnapshot } from "./account-inspection-Ci4GtHLD.js";
import { t as formatChannelStatusState } from "./status-state-BxmXMMRN.js";
import { n as formatTimeAgo } from "./format-relative-4CQ40LtD.js";
import { n as hasRuntimeCredentialAvailable, r as markConfiguredUnavailableCredentialStatusesAvailable, t as getRuntimeChannelAccounts } from "./read-model-Bnbg9kGc.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CZZ3dfoD.js";
import "./format-CaiCK-lC.js";
...
async function buildChannelsTable(cfg, opts) {
	...
	const readOnlyPlugins = resolveReadOnlyChannelPluginsForConfig(cfg, {
		...
		includeSetupFallbackPlugins: opts?.includeSetupFallbackPlugins ?? true
	});
	for (const plugin of readOnlyPlugins.plugins) {
		...
		const unavailableConfiguredAccounts = enabledAccounts.filter((a) => hasConfiguredUnavailableCredentialStatus(a.account) && !hasRuntimeCredentialAvailable({
			liveAccounts,
	...
	for (const channelId of missingCandidateChannelIds) {
		...
		if (!hint || hint.channelId !== channelId) continue;
		rows.push({
			id: channelId,
			label: hint.label,
			enabled: true,
