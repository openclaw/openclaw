...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-BDYv2Zht.js";
import { t as providerSupportsCapability } from "./provider-supports-DHGQBWeS.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-DuGg4IuM.js";
...
import { a as runCliEntry, c as extractGeminiResponse, d as isMediaUnderstandingSkipError, l as fileExists, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as MediaUnderstandingSkipError } from "./runner.entries-C-4U7K6D.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-DbBL_JfT.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-BGsnaixd.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-Iwg0-81T.js");
