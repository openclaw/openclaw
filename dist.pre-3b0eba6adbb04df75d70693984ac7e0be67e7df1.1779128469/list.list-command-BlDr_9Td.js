...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-q9QOdpYp.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-Czl05FD0.js";
import { n as loadModelsConfigWithSource } from "./load-config-Cvj4ko6P.js";
import { n as formatErrorWithStack } from "./list.errors-oS3XY4sK.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-j-ZzaNow.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-B_57jLIv.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-taOzGGcC.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-drHBwCWz.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DUEETVXo.js"),
		import("./agent-scope-CjTpYdDU.js"),
		import("./workspace-DQ2OhjXl.js")
	]);
