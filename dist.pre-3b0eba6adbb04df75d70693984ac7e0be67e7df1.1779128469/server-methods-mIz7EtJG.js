...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-CaHWZ8wj.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-C2_btZYz.js";
...
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-DrHD3hVx.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-CXxZNMT9.js";
...
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-C8o4N2m1.js";
...
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-PfcW1Bpv.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-VU8_c7_3.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BwLd9jbN.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-Bd5EnExW.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CBE9kcfX.js";
...
import { i as removeProviderAuthProfilesWithLock } from "./profiles-CmNoFQv6.js";
...
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-ILNIRGGs.js";
...
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-BmYOglgn.js";
...
import { s as resolveTrustedGroupId } from "./pi-tools.policy-CJwXiXZb.js";
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-DhWsniMf.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-DjP9Id5g.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-BOe-JYnI.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-CvbkPv2B.js";
import { o as isTimeoutError } from "./failover-error-X0AL4fZN.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-DxKx1YT9.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-BRs2XoZK.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-DVw-2pj1.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-ETiZ8uWq.js";
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-DRSpZ3NX.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-xJFCfgZa.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Cn6fG2kv.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-Cl-epAww.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-D-1cbtbS.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-doAfzhXJ.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-DxqsXgvO.js";
import "./runtime-internal-DxaYVJ8Y.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-CqZWuyNr.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-sdhQ1lo-.js";
...
import { i as resolveReplyToMode } from "./reply-threading-DN9PWB5E.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-ClHEcFvQ.js";
...
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-BJc5_7Q3.js";
...
import { o as dispatchChannelMessageAction } from "./message-action-runner-BYbFfc8u.js";
import "./target-resolver-CjVJ4Lfv.js";
...
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-J8WtOSJI.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-BS6dA4jK.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-BjMyPed3.js";
...
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-BI-i0J_a.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-w8tMg9Qt.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-Bx_TKqKV.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-DvVNsnso.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-D_YFo0xo.js";
import "./commands-registry-Ch-L_eke.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-ShIQKrJJ.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-DS0xFwab.js";
import "./browser-maintenance-HALT9UdE.js";
import { c as performGatewaySessionReset } from "./session-reset-service-D_ZjZ9mz.js";
import { t as getPluginCommandSpecs } from "./command-specs-f99H5Jg3.js";
import { n as listPluginCommands } from "./commands-CZ_9grqf.js";
import { t as getChannelActivity } from "./channel-activity-D7nD3rrx.js";
...
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-WNTDqw9q.js";
...
import { n as getLastHeartbeatEvent } from "./heartbeat-events-DMYXZ1zT.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-D31ZryMf.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-CQwBLAex.js";
import { n as agentCommandFromIngress } from "./agent-command-CzXWmIrl.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-DBUNOIRp.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-QnQo9lR-.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-OBsKmm21.js";
import { t as formatForLog } from "./ws-log-DPeC0KGC.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-CNBnIbzZ.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-8HG_xVVP.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-hP7FlQCT.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-CoGNN5Ok.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-Bgs2D4SK.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-CkWM2K9v.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-DEV4fYbf.js";
import { n as createOutboundSendDeps } from "./deps-BSBo9gzi.js";
import "./agent-BVozz4Aa.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-w4DY2GNp.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-bxM8D2nO.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-evbxk-Hy.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-YME4nMqN.js";
import "./server-constants-BUku2xyU.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-DyFw6gQB.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BCuXkjtP.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-BG2wS_AI.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-VbejMBdi.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-ylwJSYZX.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-DhCIgAm5.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-B-NOl2IQ.js";
import { t as buildChannelUiCatalog } from "./catalog-DakgV7z7.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-Ck8yJT0j.js";
import { s as normalizeUpdateChannel } from "./update-channels-CKSwxF-X.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-BDfoWmLx.js";
import { i as resolveConfigReloadMetadata, t as buildGatewayReloadPlan } from "./config-reload-plan-CdOruyBL.js";
import { t as readConfiguredLogTail } from "./log-tail-TJ6js-yd.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-B7QGne5d.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-BELNmU95.js";
...
import { t as installSkill } from "./skills-install-CKtScX6B.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-M7aHSL10.js";
import { r as readPackageVersion } from "./package-json-DW3aIZgA.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-JFpRvwWk.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-DUm2c-pB.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-CUkQD2ue.js";
import { t as getStatusSummary } from "./status.summary-cXvhIFqy.js";
import "./status-CFBTBfyQ.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-BPQ8kUvc.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-DryYV91w.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BT2ch_5O.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-BlIQyNvM.js";
import { t as diffConfigPaths } from "./config-diff-COyQBkhM.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-BRLc44uh.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BbNrSZPl.js";
import "./heartbeat-runner-4gquTYzM.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-Cvf1DsiN.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-Bk3BAMDO.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-C-Z6x2Ib.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DNtOGXxn.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-CdH2xhrN.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-Szwoix5v.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-DpxjTF_c.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-BYru55dk.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-CGZiuqAO.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DRnsip30.js");
