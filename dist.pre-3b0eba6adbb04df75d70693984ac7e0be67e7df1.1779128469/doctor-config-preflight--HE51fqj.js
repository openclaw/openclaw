...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CaHWZ8wj.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { t as note } from "./note-CSu06D1t.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CLD-Gtpn.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BaBPIV4-.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-CL9YCSc8.js");
