...
function createLazyCanvasTool(params) {
	...
	const loadTool = async () => {
		toolPromise ??= import("../../tool-NNn-RFKU.js").then(({ createCanvasTool }) => createCanvasTool({
...
var canvas_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerNodeCliFeature(async ({ program }) => {
			const { createDefaultCanvasCliDependencies, registerNodesCanvasCommands } = await import("../../cli-aQdksvyA.js");
