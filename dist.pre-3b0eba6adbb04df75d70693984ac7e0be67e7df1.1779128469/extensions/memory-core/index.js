...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-CG0EoilQ.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-CgEjt4b3.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-DXitmhlP.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-DJwbRxPm.js");
...
var memory_core_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-D4A-RYLQ.js");
