...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-orZb8tHo.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-7oZYS5jV.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-ChFzRWG5.js")).runEmbeddedPiAgent;
}
