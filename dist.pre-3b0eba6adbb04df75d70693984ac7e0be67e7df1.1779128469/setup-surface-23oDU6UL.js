...
import { o as isPrivateOrLoopbackHost } from "./net-CQP-kC3g.js";
import "./string-coerce-runtime-DVkpEjUr.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DHrvuj7w.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-BhUVxg8I.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-Bhn_Cx2I.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CB6Tqx_X.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-O_hDPXr-.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-CMpwkWRq.js";
import { n as updateMatrixAccountConfig } from "./config-update-BSpadOkz.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BcWCaE06.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-2cJwiSWo.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-CDI0qojX.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-DnojU5w4.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-JIgwhXUT.js");
