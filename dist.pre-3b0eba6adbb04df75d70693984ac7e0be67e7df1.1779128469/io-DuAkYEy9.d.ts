import { i as OpenClawConfig, t as ConfigFileSnapshot } from "./types.openclaw-DZQrhn8E.js";
import { n as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-rGVX0V4K.js";
import { a as RuntimeConfigWriteNotification, i as RuntimeConfigSnapshotRefreshOptions, t as ConfigWriteAfterWrite } from "./runtime-snapshot-CKhU3IX0.js";
...
//#endregion
export { resolveConfigSnapshotHash as C, registerConfigWriteListener as S, readSourceConfigBestEffort as _, ReadConfigFileSnapshotWithPluginMetadataResult as a, recoverConfigFromJsonRootSuffix as b, getRuntimeConfig as c, projectConfigOntoRuntimeSourceSnapshot as d, promoteConfigSnapshotToLastKnownGood as f, readConfigFileSnapshotWithPluginMetadata as g, readConfigFileSnapshotForWrite as h, ConfigWriteResult as i, loadConfig as l, readConfigFileSnapshot as m, ConfigWriteNotification as n, clearConfigCache as o, readBestEffortConfig as p, ConfigWriteOptions as r, createConfigIO as s, ConfigRuntimeRefreshError as t, parseConfigJson5 as u, readSourceConfigSnapshot as v, writeConfigFile as w, recoverConfigFromLastKnownGood as x, readSourceConfigSnapshotForWrite as y };