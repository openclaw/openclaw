...
import { $ as resolveProviderRuntimePlugin, _ as normalizeProviderToolSchemasWithPlugin, f as inspectProviderToolSchemasWithPlugin } from "./provider-runtime-Bd10Pd3U.js";
...
import { u as isGoogleModelApi } from "./pi-embedded-helpers-B3o9fgUx.js";
...
import { t as pluginRegistrationContractRegistry } from "./registry-s95Hjumm.js";
import { t as log$1 } from "./logger-x1d1QPh0.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-Bd4Hr4Ay.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-DWptimCw.js");
