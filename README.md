# 🦞 EasyHub — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/EasyHub/EasyHub/main/docs/assets/EasyHub-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/EasyHub/EasyHub/main/docs/assets/EasyHub-logo-text.png" alt="EasyHub" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/EasyHub/EasyHub/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/EasyHub/EasyHub/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/EasyHub/EasyHub/releases"><img src="https://img.shields.io/github/v/release/EasyHub/EasyHub?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**EasyHub** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://EasyHub.ai) · [Docs](https://docs.EasyHub.ai) · [DeepWiki](https://deepwiki.com/EasyHub/EasyHub) · [Getting Started](https://docs.EasyHub.ai/start/getting-started) · [Updating](https://docs.EasyHub.ai/install/updating) · [Showcase](https://docs.EasyHub.ai/start/showcase) · [FAQ](https://docs.EasyHub.ai/start/faq) · [Wizard](https://docs.EasyHub.ai/start/wizard) · [Nix](https://github.com/EasyHub/nix-EasyHub) · [Docker](https://docs.EasyHub.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`EasyHub onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.EasyHub.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.EasyHub.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.EasyHub.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.EasyHub.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.EasyHub.ai/start/getting-started)
...
# Send a message
EasyHub message send --to +1234567890 --message "Hello from EasyHub"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
EasyHub agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.EasyHub.ai/install/updating) (and run `EasyHub doctor`).
...
Switch channels (git + npm): `EasyHub update --channel stable|beta|dev`.
Details: [Development channels](https://docs.EasyHub.ai/install/development-channels).
...
pnpm EasyHub onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm EasyHub ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `EasyHub` binary.

## Security defaults (DM access)

EasyHub connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.EasyHub.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `EasyHub pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `EasyHub doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.EasyHub.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.EasyHub.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.EasyHub.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.EasyHub.ai/nodes/voicewake) + [Talk Mode](https://docs.EasyHub.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.EasyHub.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.EasyHub.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.EasyHub.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.EasyHub.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.EasyHub.ai/nodes).
- **[Onboarding](https://docs.EasyHub.ai/start/wizard) + [skills](https://docs.EasyHub.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=EasyHub/EasyHub&type=date&legend=top-left)](https://www.star-history.com/#EasyHub/EasyHub&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.EasyHub.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.EasyHub.ai/web), and [Canvas host](https://docs.EasyHub.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.EasyHub.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.EasyHub.ai/start/wizard), and [doctor](https://docs.EasyHub.ai/gateway/doctor).
- [Pi agent runtime](https://docs.EasyHub.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.EasyHub.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.EasyHub.ai/concepts/groups).
- [Media pipeline](https://docs.EasyHub.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.EasyHub.ai/nodes/audio).

### Channels

- [Channels](https://docs.EasyHub.ai/channels): [WhatsApp](https://docs.EasyHub.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.EasyHub.ai/channels/telegram) (grammY), [Slack](https://docs.EasyHub.ai/channels/slack) (Bolt), [Discord](https://docs.EasyHub.ai/channels/discord) (discord.js), [Google Chat](https://docs.EasyHub.ai/channels/googlechat) (Chat API), [Signal](https://docs.EasyHub.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.EasyHub.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.EasyHub.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.EasyHub.ai/channels/msteams) (extension), [Matrix](https://docs.EasyHub.ai/channels/matrix) (extension), [Zalo](https://docs.EasyHub.ai/channels/zalo) (extension), [Zalo Personal](https://docs.EasyHub.ai/channels/zalouser) (extension), [WebChat](https://docs.EasyHub.ai/web/webchat).
- [Group routing](https://docs.EasyHub.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.EasyHub.ai/channels).

### Apps + nodes

- [macOS app](https://docs.EasyHub.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.EasyHub.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.EasyHub.ai/nodes/talk) overlay, [WebChat](https://docs.EasyHub.ai/web/webchat), debug tools, [remote gateway](https://docs.EasyHub.ai/gateway/remote) control.
- [iOS node](https://docs.EasyHub.ai/platforms/ios): [Canvas](https://docs.EasyHub.ai/platforms/mac/canvas), [Voice Wake](https://docs.EasyHub.ai/nodes/voicewake), [Talk Mode](https://docs.EasyHub.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.EasyHub.ai/platforms/android): [Canvas](https://docs.EasyHub.ai/platforms/mac/canvas), [Talk Mode](https://docs.EasyHub.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.EasyHub.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.EasyHub.ai/tools/browser): dedicated EasyHub Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.EasyHub.ai/platforms/mac/canvas): [A2UI](https://docs.EasyHub.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.EasyHub.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.EasyHub.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.EasyHub.ai/automation/cron-jobs); [webhooks](https://docs.EasyHub.ai/automation/webhook); [Gmail Pub/Sub](https://docs.EasyHub.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.EasyHub.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.EasyHub.ai/concepts/channel-routing), [retry policy](https://docs.EasyHub.ai/concepts/retry), and [streaming/chunking](https://docs.EasyHub.ai/concepts/streaming).
- [Presence](https://docs.EasyHub.ai/concepts/presence), [typing indicators](https://docs.EasyHub.ai/concepts/typing-indicators), and [usage tracking](https://docs.EasyHub.ai/concepts/usage-tracking).
- [Models](https://docs.EasyHub.ai/concepts/models), [model failover](https://docs.EasyHub.ai/concepts/model-failover), and [session pruning](https://docs.EasyHub.ai/concepts/session-pruning).
- [Security](https://docs.EasyHub.ai/gateway/security) and [troubleshooting](https://docs.EasyHub.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.EasyHub.ai/web) + [WebChat](https://docs.EasyHub.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.EasyHub.ai/gateway/tailscale) or [SSH tunnels](https://docs.EasyHub.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.EasyHub.ai/install/nix) for declarative config; [Docker](https://docs.EasyHub.ai/install/docker)-based installs.
- [Doctor](https://docs.EasyHub.ai/gateway/doctor) migrations, [logging](https://docs.EasyHub.ai/logging).
...
- **[Gateway WebSocket network](https://docs.EasyHub.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.EasyHub.ai/gateway)).
- **[Tailscale exposure](https://docs.EasyHub.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.EasyHub.ai/gateway/remote)).
- **[Browser control](https://docs.EasyHub.ai/tools/browser)** — EasyHub‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.EasyHub.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.EasyHub.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.EasyHub.ai/nodes/voicewake) + [Talk Mode](https://docs.EasyHub.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.EasyHub.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

EasyHub can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (EasyHub enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.EasyHub.ai/gateway/tailscale) · [Web surfaces](https://docs.EasyHub.ai/web)
...
Details: [Remote access](https://docs.EasyHub.ai/gateway/remote) · [Nodes](https://docs.EasyHub.ai/nodes) · [Security](https://docs.EasyHub.ai/gateway/security)
...
Details: [Nodes](https://docs.EasyHub.ai/nodes) · [macOS app](https://docs.EasyHub.ai/platforms/macos) · [Gateway protocol](https://docs.EasyHub.ai/concepts/architecture)
...
Details: [Session tools](https://docs.EasyHub.ai/concepts/session-tool)
...
- Controlled via `EasyHub nodes …`.

Runbook: [iOS connect](https://docs.EasyHub.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.EasyHub.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.easyhub/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.easyhub/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.easyhub/easyhub.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.EasyHub.ai/gateway/configuration)
...
Details: [Security guide](https://docs.EasyHub.ai/gateway/security) · [Docker + sandboxing](https://docs.EasyHub.ai/install/docker) · [Sandbox config](https://docs.EasyHub.ai/gateway/configuration)

### [WhatsApp](https://docs.EasyHub.ai/channels/whatsapp)

- Link the device: `pnpm EasyHub channels login` (stores creds in `~/.easyhub/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.EasyHub.ai/channels/telegram)
...
### [Slack](https://docs.EasyHub.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.EasyHub.ai/channels/discord)
...
### [Signal](https://docs.EasyHub.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.EasyHub.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.EasyHub.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.EasyHub.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.EasyHub.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.EasyHub.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.EasyHub.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.EasyHub.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.EasyHub.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.EasyHub.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.EasyHub.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.EasyHub.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.EasyHub.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.EasyHub.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.EasyHub.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.EasyHub.ai/platforms/windows), [Linux](https://docs.EasyHub.ai/platforms/linux), [macOS](https://docs.EasyHub.ai/platforms/macos), [iOS](https://docs.EasyHub.ai/platforms/ios), [Android](https://docs.EasyHub.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.EasyHub.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.EasyHub.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.EasyHub.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.EasyHub.ai/gateway/bonjour)
- [Gateway pairing](https://docs.EasyHub.ai/gateway/pairing)
- [Remote gateway README](https://docs.EasyHub.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.EasyHub.ai/web/control-ui)
- [Dashboard](https://docs.EasyHub.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.EasyHub.ai/gateway/health)
- [Gateway lock](https://docs.EasyHub.ai/gateway/gateway-lock)
- [Background process](https://docs.EasyHub.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.EasyHub.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.EasyHub.ai/logging)

## Deep dives

- [Agent loop](https://docs.EasyHub.ai/concepts/agent-loop)
- [Presence](https://docs.EasyHub.ai/concepts/presence)
- [TypeBox schemas](https://docs.EasyHub.ai/concepts/typebox)
- [RPC adapters](https://docs.EasyHub.ai/reference/rpc)
- [Queue](https://docs.EasyHub.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.EasyHub.ai/tools/skills-config)
- [Default AGENTS](https://docs.EasyHub.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.EasyHub.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.EasyHub.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.EasyHub.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.EasyHub.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.EasyHub.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.EasyHub.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.EasyHub.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.EasyHub.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.EasyHub.ai/platforms/mac/voicewake)
- [iOS node](https://docs.EasyHub.ai/platforms/ios)
- [Android node](https://docs.EasyHub.ai/platforms/android)
- [Windows (WSL2)](https://docs.EasyHub.ai/platforms/windows)
- [Linux app](https://docs.EasyHub.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.EasyHub.ai/gmail-pubsub](https://docs.EasyHub.ai/automation/gmail-pubsub)

## Molty

EasyHub was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [EasyHub.ai](https://EasyHub.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@EasyHub](https://x.com/EasyHub)
