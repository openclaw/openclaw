...
import "./accounts-DE5EAbXS.js";
import "./runtime-api-Cb5jqTIe.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-Chu5svOf.js";
import { t as sendMessageZalo } from "./send-DWre11MQ.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BysfdfBh.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-D_W5zonA.js");
