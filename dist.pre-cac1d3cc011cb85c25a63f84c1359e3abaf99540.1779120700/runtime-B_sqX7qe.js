...
import { n as AcpRuntimeError$1 } from "./errors-zyHRqIKC.js";
import "./security-runtime-CBcdjW2R.js";
import "./runtime-api-Be5wLtNd.js";
import { l as hashAcpxProcessCommand, n as isOpenClawLeaseAwareAcpxProcessCommand, s as createAcpxProcessLeaseId, t as cleanupOpenClawOwnedAcpxProcessTree, u as withAcpxLeaseEnvironment } from "./process-reaper-slEobaju.js";
...
var AcpClient = class {
	...
	async start() {
		...
		if (isClaudeAcpCommand$1(spawnCommand, args)) {
...
async function readCodexWrapperStderrTail(params) {
	...
	try {
		return compactDiagnosticText(redactSensitiveText((await fs$1.readFile(path.join(params.wrapperRoot, codexWrapperStderrLogFileName(params.leaseId)), "utf8")).slice(-CODEX_WRAPPER_ERROR_TAIL_MAX_CHARS)));
	} catch {
		return "";
	}
}
