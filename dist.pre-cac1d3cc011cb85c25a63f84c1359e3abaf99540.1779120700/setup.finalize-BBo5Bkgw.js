...
import { t as restoreTerminalState } from "./restore-Bf3iQQZN.js";
import { t as attachChildProcessBridge } from "./child-process-bridge-F26FvTxb.js";
import { p as resolveUserPath, u as pathExists } from "./utils-CpmNtyoq.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-DEM1hK1P.js";
import { a as isSystemdUserServiceAvailable } from "./systemd-V2tE82xZ.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-qdOIPdyq.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-DOmeRato.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-D8iMHSPr.js";
import { t as resolveControlUiLinks } from "./control-ui-links-Be_aQWv8.js";
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Cf8gJN8t.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-Ck3VNkQ4.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-BbmJplLX.js";
import { n as t } from "./i18n-rRyaHfOB.js";
import { a as installCompletion, i as formatCompletionReloadCommand, l as resolveCompletionProfilePath } from "./completion-runtime-D82Fe52R.js";
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-Dmpy90OR.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-AJntwoXV.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-TpjjVIoI.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-D8V6ipkd.js";
import { n as formatHealthCheckFailure } from "./health-format-BOpxmAJ0.js";
import { n as healthCommand } from "./health-B3VzX8f7.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DRhGG7T0.js";
import { n as TUI_SETUP_AUTH_SOURCE_ENV, t as TUI_SETUP_AUTH_SOURCE_CONFIG } from "./setup-launch-env-wYz_JiBD.js";
...
function loadOnboardSearchModule() {
	onboardSearchModulePromise ??= import("./onboard-search-h_pdGn79.js");
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DErbJzra.js");
	...
	await prompter.note([
		...
		settings.authMode === "token" && settings.gatewayToken ? t("wizard.finalize.webUiWithTokenUrl", { url: authedUrl }) : void 0,
	...
	if (webSearchProvider) {
		...
		const keySource = storedKey ? t("wizard.finalize.webSearchKeyStored") : keyConfigured ? t("wizard.finalize.webSearchKeyRef") : envAvailable ? t("wizard.finalize.webSearchKeyEnv", { env: entry?.envVars.join(" / ") ?? "" }) : void 0;
