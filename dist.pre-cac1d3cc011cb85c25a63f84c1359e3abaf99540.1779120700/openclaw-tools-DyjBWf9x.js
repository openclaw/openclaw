...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-EKUvJ3MC.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BdqZvTnb.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-Oh1pWxzj.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-M9JN_JCw.js";
import { i as resolveManifestContractOwnerPluginId, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-B_Amd26i.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-Sb8iTXPv.js";
import { a as normalizeDiagnosticTraceparent, t as DIAGNOSTIC_TRACEPARENT_PATTERN } from "./diagnostic-trace-context-pure-DiETCmyi.js";
import "./diagnostic-trace-context-5yrj1tXL.js";
import { t as createSubsystemLogger } from "./subsystem-Dtm6MSVy.js";
import { t as logDebug } from "./logger-BNE2ki5B.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-CkPP2awZ.js";
import { h as isWindowsDrivePath } from "./archive-D2BjLkE_.js";
import { n as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-state-DE_1Nc0_.js";
import { n as modelKey } from "./model-ref-shared-RECrFgWB.js";
import { t as applyMergePatch } from "./merge-patch-CfIV4Y-C.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-Dg8HhGX3.js";
...
import { n as isRestartEnabled } from "./commands.flags-9Sm7Btxq.js";
import { o as normalizeChannelId } from "./registry-CqoTFbCs.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BNv08iCR.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-CNnWDHPu.js";
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-DJtqYoTD.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-Bir04kfe.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-Cwr6skDj.js";
import { i as callGateway } from "./call-DU9lzqTm.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-ClHZfhOX.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-8H72ZznJ.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-BngYe0c4.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-CFpAiITy.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DkpIHRmj.js";
import { n as assertSandboxPath } from "./sandbox-paths-P3bbVn3i.js";
import "./local-file-access-BQ4lumbi.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-gvzAeR6d.js";
import { h as stringifyRouteThreadId } from "./channel-route-DBqK_NgW.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CPgWum5w.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-_BPRx1WO.js";
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-DbrpxdE7.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-Zdwbcr5o.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BsZ0ljnC.js";
import { s as updateSessionStore } from "./store-B2ygcrQO.js";
import "./plugins-BexbDANa.js";
import { n as mergeSessionEntry } from "./types-_KZG4WBE.js";
import { u as extractDeliveryInfo } from "./sessions-DLuO5EGG.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-BjHvxzTf.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-B48-sZMq.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-BbRdg273.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-C-eeYyHn.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-CnrTn8aZ.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-MwbyxZGa.js";
import "./auth-profiles-h4Ty6I1t.js";
import { n as resolveApiKeyForProfile } from "./oauth-ZoW1C6yM.js";
import { n as listProfilesForProvider } from "./profile-list-BoQ2gPrR.js";
import { i as resolveAuthProfileOrder } from "./order-BLVt2fxp.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-DD3QApPW.js";
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-DScaxGGW.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-DKws80u8.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-F89cN-SM.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CG69Vfrb.js";
import "./tool-policy-D10jyOUl.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-BW3iLLB9.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-DRNPBKy2.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-DJnp9dMb.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-Cw9xHTiW.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-ibc9mlD1.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Z16Oayuw.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-CYv0OsxS.js";
import { n as extractTextFromChatContent } from "./chat-content-Bq0Labuy.js";
import { r as stripToolMessages } from "./chat-history-text-vVaaIL5z.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CWqFhlj3.js";
import { n as ensureOpenClawModelsJson } from "./models-config-CURQC9UN.js";
import { r as loadModelCatalog } from "./model-catalog-BMwp5Y56.js";
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-3CU3zGOn.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-CF2SYTsl.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-hel4SEnH.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-DQnVhnO6.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-dY63daNF.js";
import { l as formatActiveContinuationTraceparent } from "./continuation-tracer-BMyqgPEb.js";
import "./targeting-s1SdYp8f.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-B3Cyv1SQ.js";
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-CfEtDe7H.js";
import { t as canonicalizeBase64 } from "./base64-GgyLRXZq.js";
import { c as getImageMetadata } from "./media-services-PrZCquZK.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BxgR2qMi.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-r-m-vyGH.js";
import { a as resolvePluginTools } from "./tools-C8rHtEx3.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BE3DQCYu.js";
import { d as wrapToolWithBeforeToolCallHook, g as listChannelSupportedActions, l as isToolWrappedWithBeforeToolCallHook, m as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-C7vBLWAw.js";
...
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-z8-687TV.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-B6i3Da7N.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-BbBO3S4w.js";
import { n as extractAssistantText } from "./pi-embedded-utils-CCLx3KcF.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BFru569f.js";
import { n as runWithImageModelFallback } from "./model-fallback-DmR9iaKI.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-Dv0-45oP.js";
import "./delivery-context-DCduluTc.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-CteyDGl-.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-DGw9qB5W.js";
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-4hUR3og4.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-aDZ9VoY3.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-BjOdkkeb.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-Cn6fG2kv.js";
import { t as inferLegacyName } from "./normalize-DTHDC7wd.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-o603pjNO.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Dg_qG_Im.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-h2BX60mD.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-B9PbsSME.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DCUCdheO.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-XHrNyvPA.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-CoGKDA92.js";
import { u as saveMediaBuffer } from "./store-C25GuYX2.js";
import { t as SsrFBlockedError } from "./ssrf-DzOdS68g.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-PRYAl7ev.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BgOKFfsp.js";
import { r as getDefaultLocalRoots } from "./local-media-access-BTUqhyNQ.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-DyCVXvI7.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-DxqsXgvO.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-DB6lqhhE.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DnYQObn8.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BM8QfvKT.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-CIhYwGC2.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Buy8XnxI.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-H39gJIu5.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-BggZDbdO.js";
import { n as normalizeMediaProviderId } from "./provider-id-CxMtlOED.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BdcPtXLK.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BJ_4nJyx.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-D9IdBAVq.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-B2Jbs-o9.js";
import { s as resolveTimeoutMs } from "./resolve-CTuxrtFM.js";
import { t as buildProviderRegistry } from "./runner-bzKdve8T.js";
import "./media-understanding-D1sq19uj.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CPMcPd7m.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-jwYzK77o.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-D7G60CDK.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-Dqig_Al_.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-CesF9oWM.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-Dot_o35o.js";
import { t as parseTimeoutMs } from "./parse-timeout-C9mwJ-gQ.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-BGQWu7SE.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-Czmn2HsN.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-iHeVSOzL.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CPIJXesa.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-yLTrdrfc.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-P9HR6rGW.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-C5PRpfYV.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-hE9WGVw1.js";
import { p as registerSubagentRun } from "./subagent-registry-BY_ZiIyq.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-EH1OfFNA.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-CCESTJoT.js";
import { k as textToSpeech } from "./tts-runtime-C66aq6eG.js";
import "./tts-CsHZcgI9.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-B03LGUXR.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-sLKXJDG8.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DVuiWAoP.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-7nDtNsl6.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-BXsKBO4D.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-_4XhLC7U.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-xo9gn0fy.js";
import { i as runWebSearch } from "./runtime-BbmJplLX.js";
import "./web-search-provider-common-CyEBtVIE.js";
...
function createContinueDelegateTool(opts) {
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const requestedDelayMs = delaySeconds !== void 0 ? Math.max(0, delaySeconds) * 1e3 : void 0;
			...
			const delayMs = requestedDelayMs !== void 0 && requestedDelayMs > 0 ? clampDelayMs(requestedDelayMs, continuationConfig) : requestedDelayMs;
			...
			return jsonResult({
				status: "scheduled",
				mode: modeRaw || "normal",
				delaySeconds: delayMs ? delayMs / 1e3 : 0,
...
function createContinueWorkTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const continuationConfig = resolveContinuationRuntimeConfig();
			const resolvedDelayMs = clampDelayMs(delaySeconds * 1e3, continuationConfig);
			const resolvedDelaySeconds = Math.round(resolvedDelayMs / 1e3);
			return jsonResult({
				status: "scheduled",
				delaySeconds: resolvedDelaySeconds,
				...resolvedDelaySeconds !== delaySeconds ? { note: `Requested ${delaySeconds}s, clamped to ${resolvedDelaySeconds}s by continuation config.` } : {},
				...traceContextFields
			});
		}
	};
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-CM6u4APd.js");
		await sendMessage({
			cfg: params.config,
		...
		log$6.warn("Direct media generation failure delivery failed; falling back to agent wake", {
			taskId: params.handle.taskId,
			runId: params.handle.runId,
			toolName: params.toolName,
			error
...
function createMessageTool(options) {
	...
	return {
		...
		execute: async (_toolCallId, args, signal) => {
			...
			const toolContext = effectiveCurrentChannel.currentChannelId || effectiveCurrentChannel.currentChannelProvider || currentThreadTs || hasCurrentMessageId || replyToMode || options?.hasRepliedRef ? {
				currentChannelId: effectiveCurrentChannel.currentChannelId,
				currentChannelProvider: effectiveCurrentChannel.currentChannelProvider,
				currentThreadTs,
				currentMessageId: options?.currentMessageId,
...
function resolvePdfModelConfigForTool(params) {
	...
	if (params.cfg?.models?.providers && typeof params.cfg.models.providers === "object") for (const [providerKey, providerCfg] of Object.entries(params.cfg.models.providers)) {
		...
		if (!providerId || isMinimaxVlmProvider(providerId) || !hasAuthForProvider({
			provider: providerId,
			agentDir: params.agentDir,
			authStore: params.authStore
		})) continue;
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-Ds_XV_Ms.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CHxhzjEY.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-Db4SF64l.js"));
...
function createOpenClawTools(options) {
	...
	const runtimeSnapshot = getActiveSecretsRuntimeSnapshot$1();
