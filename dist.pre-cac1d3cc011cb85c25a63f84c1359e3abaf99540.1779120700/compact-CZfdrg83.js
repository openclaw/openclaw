...
import { g as resolveRunModelFallbacksOverride, v as resolveSessionAgentIds } from "./agent-scope-EKUvJ3MC.js";
...
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-Blblyldv.js";
...
import { k as listRegisteredPluginAgentPromptGuidance } from "./command-registration-lcVcliCL.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BHYgkojd.js";
import { a as acquireSessionWriteLock, f as resolveSessionWriteLockOptions, l as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-DGHbh-T7.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-B48-sZMq.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared-DD3QApPW.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as resolveModelAuthMode } from "./model-auth-DScaxGGW.js";
...
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-OFfXKzFY.js";
import { f as ensureSessionHeader, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-Ca2_grVa.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-jWEwXHUf.js";
import { $ as consumeCompactionSafeguardCancelReason, A as dedupeDuplicateUserMessagesForCompaction, B as resolveEmbeddedAgentStreamFn, D as rotateTranscriptAfterCompaction, F as toSessionToolAllowlist, G as sanitizeSessionHistory, H as prewarmSessionFile, I as applySystemPromptOverrideToSession, J as getHistoryLimitFromSessionKey, K as validateReplayTurns, L as buildEmbeddedSystemPrompt, M as mapThinkingLevel, N as collectAllowedToolNames, P as collectRegisteredToolNames, Q as isRealConversationMessage, R as createSystemPromptOverride, St as isReasoningTagProvider, U as trackSessionManagerAccess, V as resolveEmbeddedRunSkillEntries, W as createEmbeddedPiResourceLoader, X as buildEmbeddedExtensionFactories, Y as limitHistoryTurns, Z as hasMeaningfulConversationContent, et as setCompactionSafeguardCancelReason, it as repairSessionFileIfNeeded, j as flushPendingToolResultsAfterIdle, k as shouldRotateCompactionTranscript, nt as resolveCompactionTimeoutMs, ot as collectRuntimeChannelCapabilities, q as buildEmbeddedMessageActionDiscoveryInput, rt as guardSessionManager, tt as compactWithSafetyTimeout, z as resolveEmbeddedAgentBaseStreamFn } from "./selection-BuhNrX1s.js";
import { t as getMachineDisplayName } from "./machine-name-CxKD-q-I.js";
import { n as extractModelCompat } from "./provider-model-compat-uGbgEKb-.js";
import { i as listActiveProcessSessionReferences, n as resolveEmbeddedCompactionTarget } from "./compaction-runtime-context-CKYwaoyG.js";
import { a as resolveBootstrapContextForRun, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-Chk_aGmx.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-BKwOFW3W.js";
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-C7vBLWAw.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-DPAM-C-t.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-ChPvJX5o.js";
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-BnhlSlqS.js";
import { S as supportsModelTools } from "./attempt.tool-run-context-BeFZbJVr.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BZgBkZ_F.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-CSvTfnXt.js";
import "./pi-bundle-mcp-tools-O_pArZmx.js";
import { r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-DmR9iaKI.js";
import { t as log } from "./logger-BfMFZWp6.js";
import { a as resolveCompactionFailureReason, i as formatUnknownCompactionReasonDetail, o as createCompactionDiagId, r as classifyCompactionReason } from "./request-compaction-tool-Dv0-45oP.js";
import { _ as createPreparedEmbeddedPiSettingsManager } from "./preemptive-compaction-DYQUmw-n.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-gGDAWP1-.js";
import { t as splitSdkTools } from "./tool-split-Bic5zM3w.js";
import { s as resolveAgentPromptSurfaceForSessionKey } from "./system-prompt-config-BuvGYYIa.js";
import { t as registerProviderStreamForModel } from "./provider-stream-B_MLrerj.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-AixRxeSx.js";
import { o as resolveSandboxContext } from "./sandbox-D_U2-M8i.js";
import { l as readTranscriptFileState, s as TranscriptFileState, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-D1tgS_Lx.js";
import { t as detectRuntimeShell } from "./shell-utils-C3jJ5lMA.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-cY_XWLYq.js";
import { s as resolveSkillsPromptForRun } from "./workspace-BN3IZnEF.js";
import "./skills-CekWInLa.js";
import { n as resolveSystemPromptOverride } from "./system-prompt-report-BufgldGM.js";
import { t as applyExtraParamsToAgent } from "./extra-params-b8T9R0zo.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-yqkdzyV9.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-AWa2Xcp2.js";
...
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-B5EChZ2s.js";
...
async function compactEmbeddedPiSessionDirectOnce(params) {
	...
	try {
		...
		if (!apiKeyInfo.apiKey) {
			if (apiKeyInfo.mode !== "aws-sdk") throw new Error(formatMissingAuthError(apiKeyInfo, runtimeModel.provider));
		} else {
