...
import { a as resolveDefaultPluginNpmDir } from "./install-paths-CNzVvl2_.js";
import { f as loadInstalledPluginIndex } from "./installed-plugin-index-store-AZHgeXfd.js";
import { u as tryReadJsonSync } from "./json-files-1SmAauRO.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-BY79ETl0.js";
import { h as refreshPluginRegistry } from "./plugin-registry-B_Amd26i.js";
import { n as saveJsonFile } from "./json-file-DIl8If_4.js";
import "./installed-plugin-index-records-C2ejU59q.js";
import { i as preflightPluginRegistryInstallMigration, r as migratePluginRegistryForInstall, t as DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV } from "./plugin-registry-migration-dkZx7Dc5.js";
import { r as relinkOpenClawPeerDependenciesInManagedNpmRoot, t as auditOpenClawPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link-DKApwGlW.js";
...
async function maybeRepairManagedNpmOpenClawPeerLinks(params) {
	...
	if (result.repaired > 0) note(`Repaired OpenClaw host peer link(s) for ${result.repaired} managed npm plugin package(s).`, "Plugin registry");
...
async function maybeRepairPluginRegistryState(params) {
	...
	if (preflight.action === "skip-existing" || removedStaleManagedNpmBundledPlugins || repairedManagedNpmOpenClawPeerLinks) {
		const index = await refreshPluginRegistry({
			...migrationParams,
			reason: "migration",
			...removedStaleManagedNpmBundledPlugins ? { installRecords: await loadInstallRecordsWithoutPluginIds(params, staleManagedNpmBundledPluginIds) } : {}
		});
...
//#endregion
export { maybeRepairPluginRegistryState as n, maybeRepairStaleManagedNpmBundledPlugins as r, maybeRepairManagedNpmOpenClawPeerLinks as t };
