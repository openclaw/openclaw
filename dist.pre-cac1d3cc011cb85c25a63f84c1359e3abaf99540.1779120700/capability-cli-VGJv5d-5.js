...
import { p as normalizeThinkLevel } from "./thinking-_ETvoA77.js";
...
import { d as randomIdempotencyKey, i as callGateway } from "./call-DU9lzqTm.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-oL_rcHDu.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-BjHvxzTf.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-CxW7w0Hg.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-CnrTn8aZ.js";
...
import { c as getImageMetadata, s as convertHeicToJpeg } from "./media-services-PrZCquZK.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-B4iHcuck.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-D9IdBAVq.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-D7G60CDK.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-C66aq6eG.js";
import "./tts-CsHZcgI9.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DVuiWAoP.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-BbmJplLX.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CSRzVYa1.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-KpcTrj9Z.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-DxADm0kq.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CSstpsUu.js";
import { n as runCommandWithRuntime } from "./cli-utils-Cx7R6UOM.js";
import { t as removeCommandByName } from "./command-tree-xnQMkTsz.js";
import { t as collectOption } from "./helpers-C3RRAvWX.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-2l5yec9C.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Ca4JP8HZ.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Bds3aK7g.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-D3ueoEbu.js");
