...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-DrStN-e_.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-5hyKIuvT.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-BunFlW3J.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-BZBlIUqx.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-BJsrlisc.js";
import "./channel-api-BOfHLBu8.js";
import { t as parseDiscordTarget } from "./target-parsing-BfOCqljp.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-qNbyAngu.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-DxRZQDhd.js";
import { t as getDiscordRuntime } from "./runtime-BXuOb2D1.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-Cv5-7w0p.js";
import { t as getDiscordApprovalCapability } from "./approval-native-IfHnm5Pf.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-BFw3XEiq.js";
import { t as discordMessageActions$1 } from "./channel-actions-D2Sw7Gft.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-ZHDgFmcD.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-CKQ921q4.js";
import { n as discordOutbound } from "./outbound-adapter-CV9q8rp_.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BpBXbg2i.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-BPlHRzQ3.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-C9SjP8Gy.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Dh8cbzRD.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CcbI2o1x.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-B1CeaezG.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-CuPRSA3z.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-C-oxntFV.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-ClUUOLmm.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-gR5US_YY.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-BGPpvnaG.js");
