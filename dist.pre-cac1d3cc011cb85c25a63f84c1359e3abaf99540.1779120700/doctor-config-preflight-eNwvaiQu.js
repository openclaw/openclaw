...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CkPP2awZ.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { t as note } from "./note-Do3tkH_E.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CAQes3xi.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DGnyjQzA.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DJWd48PL.js");
