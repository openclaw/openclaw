...
import { i as resolveHumanDelayConfig, r as resolveEffectiveMessagesConfig } from "./identity-BSgBzlcQ.js";
import { $ as RecordSessionMetaFromInbound$1, Q as ReadSessionUpdatedAt$1, et as UpdateLastRoute$1, o as PluginRuntimeCore } from "./types-core-DDZhpNYe.js";
import { m as resolveStorePath } from "./store-BVjV7ZNm.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-Bo4urJG2.js";
import { n as ReplyDispatcher } from "./reply-dispatcher.types-Bxna9B14.js";
import { s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-BDodXmVQ.js";
import { i as MatchesMentionWithExplicit$1, r as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-44sFLqUO.js";
import { n as RecordInboundSession$1 } from "./session.types-DDAGLmt0.js";
import { c as SessionBindingRecord } from "./session-binding.types-DVyS6c-X.js";
import { t as hasControlCommand } from "./command-detection-CFl7OM-3.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-Db_bzeZC.js";
import { t as convertMarkdownTables } from "./tables-DFY6qnjV.js";
import { n as DispatchReplyFromConfig } from "./dispatch-from-config.types-yu1JDtKd.js";
import { t as finalizeInboundContext } from "./inbound-context-DYPOdz54.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-jX4DGWRr.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-CWqJjw6N.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-Djdboine.js";
import { t as buildPairingReply } from "./pairing-messages-sOv1EAKY.js";
import { p as saveMediaBuffer } from "./store-747Z7oon.js";
import { d as readRemoteMediaBuffer, f as saveRemoteMedia, p as saveResponseMedia, u as fetchRemoteMedia } from "./fetch-BHsZrjA_.js";
import { n as getChannelActivity, r as recordChannelActivity } from "./channel-activity-fqh-tt4b.js";
import { f as implicitMentionKindWhen, p as resolveInboundMentionDecision } from "./mention-gating-DPoY_Hhn.js";
import { a as createAckReactionHandle, c as shouldAckReaction, o as removeAckReactionAfterReply, s as removeAckReactionHandleAfterReply } from "./ack-reactions-BwwnqEVd.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-CFuRUNEm.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-Dohhb-w9.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-D2YYhIpH.js";
import { o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-CdNWxVKB.js";
import { r as buildChannelInboundEventContext } from "./context-DsGn-1sL.js";
import { a as runPreparedChannelTurn, i as runChannelTurn, o as runResolvedChannelTurn, t as dispatchAssembledChannelTurn } from "./kernel-0OJ3jPhW.js";
