...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-ClHZfhOX.js";
...
import { o as resetModelCatalogCache } from "./model-catalog-BMwp5Y56.js";
import { l as getTotalQueueSize } from "./command-queue-DW8iPPJ2.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-54NC6gsH.js";
import "./pi-bundle-mcp-tools-O_pArZmx.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-DGw9qB5W.js";
...
import { _ as resolveHooksConfig } from "./hooks-DDDgil_Z.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-DsnRmfBX.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-3VLZo-Of.js";
...
import { t as buildGatewayCronService } from "./server-cron-CzBIFGI0.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-BevZtsx2.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DLrbwppl.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-BJT2DSQG.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-aJHXMg8J.js"), import("./gmail-watcher-lifecycle-Dhy8GLwq.js")]);
