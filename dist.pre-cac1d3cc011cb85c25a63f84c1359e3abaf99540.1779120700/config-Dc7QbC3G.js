...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-DYNSxqZe.js";
import "./ssrf-runtime-DiZYIPIC.js";
import "./retry-runtime-DuiSnSN8.js";
import "./secret-input-runtime-CNF2-7sN.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-BHwRurY9.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-ClImwAjD.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-sEBsFKbW.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-CRpbQ15-.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Boh1qfEv.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-OFmAI5E6.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DvVswIGY.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CIYlfIyA.js"), import("./logging-DR3kprL5.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BQxTz4ro.js").then((credentialsReadModule) => ({
