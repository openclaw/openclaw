...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-CELNqbAh.js";
import "./channel-message-CBQ4P6FK.js";
import "./text-autolink-runtime-C8cYWoab.js";
import { t as require_src } from "./src-BDYwKYUa.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-DRm2dw6-.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-CzEyWUcb.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-DNZRceob.js";
import { t as fromBuffer } from "./lib--wcBNK8E.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BH7i-uqU.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-MatPxqOZ.js";
import { l as toRatio, n as decodeString } from "./Util-rkRc5SaJ.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-Cbt3ODVc.js";
import { t as APEv2Parser } from "./APEv2Parser-CJkCo5jb.js";
import { r as hasID3v1Header } from "./ID3v1Parser-COphUuyQ.js";
import { i as isStrictDirectRoom } from "./direct-room-BY6Vr7wH.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-B5aKp0iL.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-EJDJT09U.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-9Y3Fovpd.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-5G2UTEf0.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-B7mmavYq.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DHBgyRJM.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BTa9GFU9.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CqhLC4U4.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CKaB6nO3.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-B3Os8EWv.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-759b6MjH.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-k6PwuyjP.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BcZQ49eL.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-yISLPIAp.js")).WaveParser;
	}
};
//#endregion
