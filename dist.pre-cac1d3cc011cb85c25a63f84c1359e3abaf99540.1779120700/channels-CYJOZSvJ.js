...
import { o as getResolvedLoggerSettings } from "./logger-D4Ax5Dlv.js";
import { t as danger } from "./globals-CrpmxZTV.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CkPP2awZ.js";
import { i as replaceConfigFile } from "./mutate-DJU7W4KW.js";
import "./config-DNE9tYnH.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-W6MULocR.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-BxWPtrZ7.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-Zdwbcr5o.js";
import "./plugins-BexbDANa.js";
import "./logging-eNigivtz.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-1_kJ0pvc.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-BE3DQCYu.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Coc2kqbY.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BlOFYFV6.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-Cg6l7MEm.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-D7G60CDK.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CH11mQRi.js";
import { t as WizardCancelledError } from "./prompts-DnMPdKnD.js";
import { t as createClackPrompter } from "./clack-prompter-BBnRdus8.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-DIHxBwz-.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-IPNZUdRn.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-7CYHIwrT.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DuY9Q82g.js";
import { n as resolveLogFile } from "./log-tail-CZpvBTy4.js";
import { t as parseLogLine } from "./parse-log-line-D3egPjj2.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-D3bs7Pbh.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-vz5QNUPi.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-BJhdU6HU.js";
import { t as channelsListCommand } from "./list-Dl9v0qER.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-DDENqAeb.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CgjMKh16.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-CyIABlo3.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-C7yUy-Gh.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-CHTb5mhM.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Clx8Ky7t.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-pc16TaAN.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DzdL9pnx.js");
