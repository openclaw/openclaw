...
import "./resolve-route-B63ycOeJ.js";
...
import "./persistent-bindings.resolve-BE9XN0vO.js";
...
async function ensureConfiguredAcpBindingReady(params) {
	return (await import("./persistent-bindings.lifecycle-Dwsx8MLd.js")).ensureConfiguredAcpBindingReady(params);
}
