...
import { f as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-CbHVmPP8.js";
import { i as READ_SCOPE } from "./operator-scopes-D5DA_QCa.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-CWUo1EJD.js");
