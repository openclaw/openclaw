...
import { t as getActiveMatrixClient } from "./active-client-B9XDwodx.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DA8ZGXpo.js"), import("./shared-BTmpS2vV.js")]).then(([clientModule, sharedModule]) => ({
