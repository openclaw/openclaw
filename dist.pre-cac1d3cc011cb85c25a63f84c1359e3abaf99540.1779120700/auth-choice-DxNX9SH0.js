...
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-BHv44QR-.js";
...
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-BOuJFvEW.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-y3Z8D-8J.js";
import "./provider-auth-choice-preference-7klbaj_G.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-CfT0sgHE.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-D2SmM_39.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-CC-ZK0LU.js");
