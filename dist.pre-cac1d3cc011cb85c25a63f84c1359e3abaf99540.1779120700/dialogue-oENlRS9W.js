import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-CmDJgfgI.js";
import { r as loadCrestodianOverview } from "./overview-BxqmwnpU.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-iirvIfKL.js")).planCrestodianCommand)({
		input,
		overview
	});
