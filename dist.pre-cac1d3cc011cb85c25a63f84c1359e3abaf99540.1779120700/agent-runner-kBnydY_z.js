import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue } from "./string-coerce-LndEvhRk.js";
...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-EKUvJ3MC.js";
...
import { s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-Oh1pWxzj.js";
import { n as defaultRuntime } from "./runtime-DDH_zqCr.js";
import { i as freezeDiagnosticTraceContext, s as runWithDiagnosticTraceparent, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-5yrj1tXL.js";
import { a as isDiagnosticsEnabled, i as emitTrustedDiagnosticEvent } from "./diagnostic-events-CTnmUQ59.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-_ETvoA77.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-jdWn8ewU.js";
import { r as isInternalMessageChannel } from "./message-channel-DJtqYoTD.js";
import { c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-BHv44QR-.js";
import { t as resolveAgentHarnessPolicy } from "./policy-CGdQrvRq.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-B3shWNah.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-DkpIHRmj.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-_BPRx1WO.js";
import { A as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-DbrpxdE7.js";
import { c as updateSessionStoreEntry, s as updateSessionStore } from "./store-B2ygcrQO.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-_KZG4WBE.js";
import "./sessions-DLuO5EGG.js";
import { o as isAudioFileName } from "./mime-BjHvxzTf.js";
import { a as resolveContextTokensForModel } from "./context-C7xeEI0n.js";
import { t as isCliProvider } from "./model-selection-cli-bkZvWzQg.js";
import "./model-selection-CnrTn8aZ.js";
import { u as resolveModelAuthMode } from "./model-auth-DScaxGGW.js";
import { f as replyRunRegistry, i as createReplyOperation, t as ReplyRunAlreadyActiveError } from "./reply-run-registry-BI7XiLhN.js";
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-Cz7qmBvT.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-Cw9xHTiW.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-CYv0OsxS.js";
...
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-Buj9SpyP.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-BK25y-g_.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-3CU3zGOn.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-DNsl4mXc.js";
import { i as resolveSandboxConfigForAgent } from "./config-DVCxTzjy.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DIKFrefy.js";
import { r as hasCrossSessionDelegateTargeting } from "./targeting-pure-DQnVhnO6.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN, s as stripContinuationSignal } from "./tokens-dY63daNF.js";
import { u as stripHeartbeatToken } from "./heartbeat-Dwk0vIKl.js";
import { r as enqueueCommitmentExtraction } from "./runtime-CO5fu_-a.js";
import { c as emitContinuationWorkSpan, g as startContinuationDelegateSpan, i as emitContinuationDisabledSpan, m as resolveContinuationTraceparent, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-BMyqgPEb.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-CLbjIH9m.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-CKyp7Fy_.js";
import { a as enqueueSystemEvent } from "./system-events-CvlpBn9J.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-DW8iPPJ2.js";
import { n as resolveSendPolicy } from "./send-policy-BL24nDuY.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-B3Cyv1SQ.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-D5fP1mxU.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-CfEtDe7H.js";
import { t as checkContextPressure } from "./context-pressure-CpsZygg-.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-BCAc1tjY.js";
import { c as resolveCliRuntimeExecutionProvider, o as listLegacyRuntimeModelProviderAliases, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-CBYhshtD.js";
import "./pi-embedded-helpers-Ca2_grVa.js";
import { t as formatProviderModelRef } from "./model-runtime-C_vc2bc1.js";
import "./fallback-notice-state-CP0vSh5h.js";
import { a as copyReplyPayloadMetadata, d as setReplyPayloadMetadata, o as getReplyPayloadMetadata, r as appendReplyMediaFailureWarning, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-BMb_keYF.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-DT1jUOfQ.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BFeBXYFv.js";
import { r as getCliSessionBinding } from "./cli-session-C6zIqjw2.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-jWEwXHUf.js";
import { r as runWithModelFallback } from "./model-fallback-DmR9iaKI.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-DYQUmw-n.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Cvuo8S8S.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-oC7IQyYo.js";
import { i as isRenderablePayload, n as applyReplyThreading } from "./reply-payloads-FIje7s7X.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-HfmGV_vZ.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CfSeRhiy.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-CuRXtp4f.js";
import "./sandbox-D_U2-M8i.js";
import { n as readPostCompactionContext } from "./post-compaction-context-DoxDNW__.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-BKou4NX0.js";
import { a as resolveReplyRunFireReason, c as runCliAgentWithLifecycle, i as runAgentTurnWithFallback, n as resolveRunAfterAutoFallbackPrimaryProbeRecheck, o as normalizeReplyPayloadDirectives, r as resolveSessionRuntimeOverrideForProvider, t as buildKnownAgentRunFailureReplyPayload } from "./agent-runner-execution-D8TDOm73.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DlPE5Er9.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BAzb_NrN.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-oyGl2DfB.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-BOenHlmX.js";
import { n as incrementCompactionCount } from "./session-updates-BssP6_Df.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-yWQ9DWzS.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-QgGpg6wc.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-D2F5Gd0G.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-B5pyYWcq.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-FA_p_p-Y.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-QKUeSFcH.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-C_BUduPk.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-BD2HDiYQ.js"));
		...
		try {
							...
							const result = await runEmbeddedPiAgent({
								...
								requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
									...
									triggerCompaction: async (request) => {
										try {
											const { compactEmbeddedPiSession } = await import("./compact.queued-BoOX0XgX.js");
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BNWf4FQa.js"),
					import("./config-CMnm9JL5.js"),
					import("./state-PUsGd-Wv.js"),
					import("./store-CT2ojPO1.js")
				]);
...
async function runReplyAgent(params) {
	...
	const persistContinuationChainState = async (params) => {
		...
		const chainId = params.chainId ?? (previousCount > 0 && previousChainId !== void 0 ? previousChainId : generateChainId());
	...
	try {
		...
		if (!!toolDelegateDispatchResult && (toolDelegateDispatchResult.dispatched > 0 || toolDelegateDispatchResult.rejected > 0) && sessionKey && activeSessionEntry) {
