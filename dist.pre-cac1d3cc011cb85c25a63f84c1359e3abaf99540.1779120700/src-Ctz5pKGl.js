...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-BYPt5VOh.js";
import { n as require_extend, t as require_package$1 } from "./package-DD6fPuYb.js";
import { t as require_json_bigint } from "./json-bigint-DtdD69z7.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-1KGc0b7d.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-7wkdOq7F.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
