...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CkPP2awZ.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { r as normalizeTalkSection } from "./talk-BkPeviuV.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-BxWPtrZ7.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-WOZt-xrD.js";
import { n as getLoadedChannelPlugin } from "./registry-Zdwbcr5o.js";
import { i as listRouteBindings } from "./bindings-BB9GzFQg.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, s as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-CBYhshtD.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CAQes3xi.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-DcRE7nTb.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-C2qhCz4O.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-eNwvaiQu.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-CUOBVyi7.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DZMoBcCJ.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DiTTF2Dp.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-CJyhrdr5.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BWW2_iRF.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BtCxhFrF.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DSDp8YKw.js");
		emitDoctorNotes({
			note,
