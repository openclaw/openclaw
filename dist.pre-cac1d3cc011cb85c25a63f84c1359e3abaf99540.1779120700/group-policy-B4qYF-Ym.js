...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-CltR5Iqu.js";
import "./client-CMBiCTVu.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-XSImAhBx.js";
import { c as parseIMessageTarget } from "./targets-CFpRH-Xq.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-DTIy_2eK.js";
import "./probe-BOwFG3bF.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-DxYVUA7h.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-CDllH8X8.js");
