...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-BdqZvTnb.js";
...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-CkPP2awZ.js";
...
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-_ETvoA77.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-BkPeviuV.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-DJU7W4KW.js";
...
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-B3NER2gd.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-BngYe0c4.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-C0MDF_Wz.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CFpAiITy.js";
...
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-ClOfNYhu.js";
...
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-Zdwbcr5o.js";
...
import { t as listConfiguredSessionStoreAgentIds } from "./targets-CFCy4MVM.js";
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-DLuO5EGG.js";
...
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CxW7w0Hg.js";
import { f as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-BbRdg273.js";
...
import { i as removeProviderAuthProfilesWithLock } from "./profiles-CBtM5pD4.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-oCsqCkvl.js";
...
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-DJnp9dMb.js";
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-Cw9xHTiW.js";
...
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-3CU3zGOn.js";
...
import { l as getTotalQueueSize } from "./command-queue-DW8iPPJ2.js";
import { n as resolveSendPolicy } from "./send-policy-BL24nDuY.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-B0Vuck5n.js";
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-DyjBWf9x.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-C8rHtEx3.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-DBzFnAW-.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Cf8gJN8t.js";
import { o as isTimeoutError } from "./failover-error-BnhlSlqS.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-B10w7TKZ.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-C5zw41zm.js";
...
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-4hUR3og4.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-aDZ9VoY3.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Cn6fG2kv.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-o603pjNO.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DM2m-woO.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-B_mJ5Eh9.js";
...
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-DnYQObn8.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-CISL6B59.js";
import { a as clearSessionQueues } from "./queue-oC7IQyYo.js";
...
import { i as resolveReplyToMode } from "./reply-threading-HfmGV_vZ.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-ClHEcFvQ.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-DPGXqlAe.js";
...
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-Bnv5U0CX.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-o2ln2bpS.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BYpcaKlo.js";
...
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-KpcTrj9Z.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-B3toM5kC.js";
import "./commands-registry-DqHjJkhG.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-ShIQKrJJ.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-C5PQFYiC.js";
import "./browser-maintenance-BkbP75Zf.js";
import { c as performGatewaySessionReset } from "./session-reset-service-DxSMQBqU.js";
import { t as getPluginCommandSpecs } from "./command-specs-C-eZVoMH.js";
import { r as listPluginCommands } from "./commands-S8a9GqFm.js";
...
import { n as getLastHeartbeatEvent } from "./heartbeat-events-BEnIsDpP.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-MuWZLPnM.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-Su4Lx1a6.js";
import { r as agentCommandFromIngress } from "./agent-command-DU90MKz2.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-CylJ5Oy8.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-BjJnTzWE.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BXt7Av-g.js";
import { t as formatForLog } from "./ws-log-B2ddI0SE.js";
import { i as invokeNativeHookRelay } from "./native-hook-relay-CMYkTmhm.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BC-Oo3DF.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-C97ldlqs.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-3JKUe78m.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-BWK0MEwD.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-CFsdk-5F.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-vcBMovW5.js";
import { n as createOutboundSendDeps } from "./deps-5Dwx_RHa.js";
import "./agent-YWQYYz9j.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-D2zJU-Y4.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-aZLeY75H.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DBGPquTN.js";
...
import "./server-constants-yU33WPkD.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-Dndmh6ab.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CKr1PKwh.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-BZsDdHap.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-D8lAk6NQ.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-2Wqs4og1.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-L7ic84TR.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BcV8Kgrk.js";
import { t as buildChannelUiCatalog } from "./catalog-pzx1wo-G.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-Ca4JP8HZ.js";
import { s as normalizeUpdateChannel } from "./update-channels-DiBm3hnQ.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CGlPeKRX.js";
...
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-sASLxKmH.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-ma6Eq8e5.js";
import { t as buildChannelAccountSnapshot } from "./status-Ccvfl8A9.js";
...
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CEFcLZ95.js";
import { r as readPackageVersion } from "./package-json-CO7hxsAu.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-C-A6TPq0.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-Du2PrGBz.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-Z0KQYVE3.js";
import { t as getStatusSummary } from "./status.summary-Bcfb1Ujg.js";
import "./status-BfeiseH9.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-9e4xpeKv.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-C6TPHdj3.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BxaHUbYw.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-BriP-c-T.js";
import { t as diffConfigPaths } from "./config-diff-Ck5Y1Fjr.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Cpbp5Gxy.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CmqOTDXv.js";
import "./heartbeat-runner-DsL7V5MR.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-Cba4-95c.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-CzKqOP5E.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-0MG0LYEZ.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-B_Odr3bj.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-BQ3TjuyS.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-B_VbDt-U.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-gJhtj-aQ.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-GPt1Ls3c.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-D2EGu6Xe.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DwlK8k2e.js");
