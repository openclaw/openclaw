...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-DtohF69f.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-o9gue4SJ.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-C8q3SN6D.js");
