...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-BPWhBMep.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-DScaxGGW.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-C8zN-WcE.js";
import { n as loadModelsConfigWithSource } from "./load-config-BGON4xYt.js";
import { n as formatErrorWithStack } from "./list.errors-QUxkCywf.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-X4HCUmfg.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-BuHRYAAC.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-B330tMLH.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-Q9qY5EZL.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-yx9l9t8E.js"),
		import("./agent-scope-DKqovGIS.js"),
		import("./workspace-BDl9RKLr.js")
	]);
