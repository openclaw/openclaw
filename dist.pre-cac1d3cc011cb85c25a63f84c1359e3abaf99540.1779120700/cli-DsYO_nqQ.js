...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-ABoCZYkg.js";
import { n as matrixSetupAdapter } from "./setup-core-BeFQ54YB.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-BueMDxhe.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-CJ-Bz2WI.js";
import { t as withResolvedActionClient } from "./client-CdvGEoqC.js";
import { r as resolveMatrixAuthContext } from "./config-Dc7QbC3G.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CnpSE6Fd.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-emvZJ6Az.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-B2VG1uMZ.js");
