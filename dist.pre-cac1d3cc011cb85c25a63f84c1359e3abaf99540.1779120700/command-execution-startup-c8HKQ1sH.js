...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-jcYeg6zm.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DC7JHBo0.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-B_UBgupv.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-ChPkBspg.js");
	if (params.argv) {
