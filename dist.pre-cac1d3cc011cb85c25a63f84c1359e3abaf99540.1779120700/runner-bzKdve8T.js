...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-IT1pg8hr.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-DM2m-woO.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-BggZDbdO.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-CxMtlOED.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-D9IdBAVq.js";
import { t as providerSupportsCapability } from "./provider-supports-DHGQBWeS.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CTuxrtFM.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-CHlzIJTa.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CLPodVIq.js";
import { t as buildRandomTempFilePath } from "./temp-download-BlV8arFF.js";
import "./temp-path-CrCZNSPo.js";
import { a as runCliEntry, c as extractGeminiResponse, d as isMediaUnderstandingSkipError, l as fileExists, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as MediaUnderstandingSkipError } from "./runner.entries-DQZ2sQrg.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-DR_AgqGL.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-D7xOSHHH.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-C2OOfAUp.js");
