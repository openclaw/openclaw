...
import { t as createDirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-ST0bztQS.js";
...
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-CSiCBTI3.js";
...
import { t as attachChannelToResult } from "./channel-send-result-CA8H_YrP.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-CSE8a65A.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-wsUtA7mu.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-CZbLfx3d.js");
