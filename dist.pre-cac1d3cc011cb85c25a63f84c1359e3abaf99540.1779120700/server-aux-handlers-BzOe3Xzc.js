...
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-B_Amd26i.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-C3iwnTD7.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-Dv16RdLq.js";
import { a as resolveSecretRefValue } from "./resolve-DeoFl9S6.js";
...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-eLzlq_aI.js";
import { n as channelRouteDedupeKey } from "./channel-route-DBqK_NgW.js";
import { n as getLoadedChannelPlugin } from "./registry-Zdwbcr5o.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-BexbDANa.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-DTRT9tiy.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-DVw-2pj1.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeEnv } from "./runtime-state-DGw9qB5W.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-DLEGSQAO.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-C4QGIvrq.js";
import { r as createResolverContext } from "./runtime-shared-hQjRos-c.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-BRZtd0Es.js";
import { l as roleScopesAllow } from "./pairing-token-jvr-I4nz.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-BSz0FHK2.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-BrM8LlwC.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DJiMFKlM.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-jRZzD4h1.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-3JKUe78m.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-3VLZo-Of.js";
import { t as diffConfigPaths } from "./config-diff-Ck5Y1Fjr.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Cpbp5Gxy.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-Bh0KCaBQ.js";
import "./server-aux-methods-Kihmj0NS.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-BhOyp1hy.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-UxgFf2wp.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-h4unDGc2.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-BPhGh3d2.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
