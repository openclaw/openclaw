...
import { s as resolvePluginContributionOwners } from "./plugin-registry-B_Amd26i.js";
...
import { a as findTailscaleBinary } from "./tailscale-BWzvcIsB.js";
...
import { t as ConfigMutationConflictError } from "./mutate-DJU7W4KW.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-AJntwoXV.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-B4N_O__m.js";
import { n as applyAuthChoice } from "./auth-choice-DxNX9SH0.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DXtQCYQU.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-Cgy7ZVtf.js";
import { t as applyPrimaryModel } from "./provider-model-primary-DJQ6B7tI.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BJrFBb4w.js";
import { t as promptCustomApiConfig } from "./onboard-custom-DAMyeqaI.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DmMSYVVs.js";
import { n as formatHealthCheckFailure } from "./health-format-BOpxmAJ0.js";
import { n as healthCommand } from "./health-B3VzX8f7.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BBLrDQTA.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-BolsH1q-.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-bigajoDJ.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-h_pdGn79.js");
