...
import { n as safeParseWithSchema } from "./zod-parse-8Lg54d2A.js";
import { n as runCommandWithRuntime } from "./cli-utils-Cx7R6UOM.js";
import { t as setupWizardCommand } from "./onboard-DlROrHWB.js";
import JSON5 from "json5";
import fs from "node:fs/promises";
//#region src/commands/setup.ts
const JsonRecordSchema = record(string(), unknown());
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-BDl9RKLr.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-CkIMTh8J.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-BxOfK8ut.js");
