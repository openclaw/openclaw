import { i as resolveConfigScopedRuntimeCacheValue } from "./plugin-cache-primitives-M9JN_JCw.js";
import { n as withBundledPluginEnablementCompat, r as withBundledPluginVitestCompat, t as withBundledPluginAllowlistCompat } from "./bundled-compat-Cjp-DgDa.js";
import { a as loadManifestContractSnapshot, n as isManifestPluginAvailableForControlPlane, t as hasManifestContractValue } from "./manifest-contract-eligibility-8H72ZznJ.js";
import { d as resolvePluginRegistryLoadCacheKey, f as resolveRuntimePluginRegistry } from "./loader-BngYe0c4.js";
import { n as getLoadedRuntimePluginRegistry } from "./active-runtime-registry-09lYJBRy.js";
import { t as loadBundledCapabilityRuntimeRegistry } from "./bundled-capability-runtime-Dp2I5AVs.js";
...
function resolvePluginCapabilityProviders(params) {
	...
	if (params.key === "speechProviders") requestedProviders = missingRequestedProviders ?? (activeProviders.length === 0 ? collectRequestedCapabilityProviderIds({
		key: params.key,
		cfg: params.cfg
	}) : void 0);
	...
	if (params.key !== "memoryEmbeddingProviders") return mergeCapabilityProviders(activeProviders, activeProviders.length > 0 && missingRequestedProviders ? filterLoadedProvidersForRequestedConfig({
		key: params.key,
