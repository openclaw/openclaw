...
import { c as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-CQewiu8n.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir, t as listAgentEntries } from "./agent-scope-config-BdqZvTnb.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-DDH_zqCr.js";
import { n as saveJsonFile } from "./json-file-DIl8If_4.js";
import { l as resolveAuthStorePath } from "./runtime-snapshots-C4_kvyJE.js";
import { g as loadPersistedAuthProfileStore, m as buildPersistedAuthProfileSecretsStore, n as ensureAuthProfileStore } from "./store-CxW7w0Hg.js";
import { t as buildPortableAuthProfileSecretsStoreForAgentCopy } from "./auth-profiles-h4Ty6I1t.js";
...
import { i as transformConfigWithPendingPluginInstalls, t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-DIHxBwz-.js";
import { r as ensureWorkspaceAndSessions } from "./onboard-helpers-AJntwoXV.js";
import { a as describeBinding, n as buildChannelBindings, r as parseBindingSpecs, t as applyAgentBindings } from "./agents.bindings-D3bs7Pbh.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot$1 } from "./config-validation-vz5QNUPi.js";
import { r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-sASLxKmH.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-B4N_O__m.js";
import { n as applyAuthChoice, t as warnIfModelConfigLooksOff } from "./auth-choice-DxNX9SH0.js";
import { i as setupChannels } from "./onboard-channels-HY29bsER.js";
	...
	try {
		...
		if (defaultAgentId !== agentId) {
			...
			if (!sameAuthPath && await pathExists(sourceAuthPath) && !await pathExists(destAuthPath)) {
				const sourceStore = loadPersistedAuthProfileStore(sourceAgentDir, { resolveLegacyOAuthSidecars: false });
