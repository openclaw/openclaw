...
import { o as modelSelectionShouldEnsureCodexPlugin } from "./openai-codex-routing-BHv44QR-.js";
...
async function ensureCodexRuntimePluginForModelSelection(params) {
	...
	const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BK5Nfo7c.js");
...
async function repairCodexRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-C3fwNOsV.js");
