...
import { m as readProviderJsonResponse } from "./provider-http-errors-BoEEaNIQ.js";
import "./string-coerce-runtime-Dpi9hISx.js";
import "./secret-input-1DpfZ17p.js";
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BIlqSNP-.js";
...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BtlRWXyV.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-CO-dIWpy.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DJG9vSbP.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-C1d11FpW.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-BKraYRnB.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
