...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-Co1lNtpa.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-Xx4mdWqK.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-C3QdL7i6.js";
import { a as resolveSecretRefValue } from "./resolve-BnjGWG9X.js";
import { n as info, o as success, t as danger } from "./globals-Cnlrc0S3.js";
import { U as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot, w as validateConfigObjectRawWithPlugins, x as collectUnsupportedSecretRefPolicyIssues } from "./io-ByDvK3jv.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-O2IWAyJu.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-B3yVC3eq.js";
import { w as SecretProviderSchema } from "./zod-schema.core-DncWZ-Fw.js";
import { i as replaceConfigFile } from "./mutate-CM7Vq-cJ.js";
import "./config-CIM_gEq1.js";
import { s as formatStrictJsonParseFailure } from "./error-format-C27-4rQ7.js";
import { n as redactConfigObject } from "./redact-snapshot-C_0_XPpn.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CWUarSUG.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-DBzhUeHz.js";
import { n as setCommandJsonMode } from "./json-mode-0yJGTlHF.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-D9e5yBHe.js");
