...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout } from "./reply-payload-DIfxClWu.js";
import { f as renderMessagePresentationFallbackText } from "./payload-oUECwj42.js";
...
import { a as sendMessageMatrix, l as sendTypingMatrix, o as sendPollMatrix } from "./send-CJ8Xzvoe.js";
...
import { n as listMatrixDirectoryPeersLive, t as listMatrixDirectoryGroupsLive } from "./directory-live-CjP9-pFJ.js";
...
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-rSSChAZb.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));
