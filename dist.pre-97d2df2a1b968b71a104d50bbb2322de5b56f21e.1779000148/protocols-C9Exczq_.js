import { n as __esmMin, r as __exportAll, t as __commonJSMin } from "./chunk-HkwdBwDg.js";
...
var import_dist_cjs$7, getConfigData;
var init_getConfigData = __esmMin((() => {
	...
	getConfigData = (data) => Object.entries(data).filter(([key]) => {
		...
		return Object.values(import_dist_cjs$7.IniSectionType).includes(key.substring(0, indexOfSeparator));
	}).reduce((acc, [key, value]) => {
		const indexOfSeparator = key.indexOf(".");
		const updatedKey = key.substring(0, indexOfSeparator) === import_dist_cjs$7.IniSectionType.PROFILE ? key.substring(indexOfSeparator + 1) : key;
...
var import_dist_cjs$6, prefixKeyRegex, profileNameBlockList, parseIni;
		...
		for (const iniLine of iniData.split(/\r?\n/)) {
			...
			if (trimmedLine[0] === "[" && trimmedLine[trimmedLine.length - 1] === "]") {
				...
				if (matches) {
					...
					if (Object.values(import_dist_cjs$6.IniSectionType).includes(prefix)) currentSection = [prefix, name].join(".");
...
var import_dist_cjs$5, getSsoSessionData;
var init_getSsoSessionData = __esmMin((() => {
	import_dist_cjs$5 = require_dist_cjs();
	init_loadSharedConfigFiles();
	getSsoSessionData = (data) => Object.entries(data).filter(([key]) => key.startsWith(import_dist_cjs$5.IniSectionType.SSO_SESSION + ".")).reduce((acc, [key, value]) => ({
		...acc,
...
var import_dist_cjs$4, getSmithyContext;
var init_getSmithyContext = __esmMin((() => {
	import_dist_cjs$4 = require_dist_cjs();
	getSmithyContext = (context) => context[import_dist_cjs$4.SMITHY_CONTEXT_KEY] || (context[import_dist_cjs$4.SMITHY_CONTEXT_KEY] = {});
}));
//#endregion
...
var import_dist_cjs$3, Command, ClassBuilder;
	...
	Command = class {
		...
		resolveMiddlewareWithContext(clientStack, configuration, options, { middlewareFn, clientName, commandName, inputFilterSensitiveLog, outputFilterSensitiveLog, smithyContext, additionalContext, CommandCtor }) {
			...
			const handlerExecutionContext = {
				...
				[import_dist_cjs$3.SMITHY_CONTEXT_KEY]: {
...
var import_dist_cjs$2, knownAlgorithms, getChecksumConfiguration, resolveChecksumRuntimeConfig;
var init_checksum = __esmMin((() => {
	import_dist_cjs$2 = require_dist_cjs();
	knownAlgorithms = Object.values(import_dist_cjs$2.AlgorithmId);
	getChecksumConfiguration = (runtimeConfig) => {
		const checksumAlgorithms = [];
		for (const id in import_dist_cjs$2.AlgorithmId) {
			const algorithmId = import_dist_cjs$2.AlgorithmId[id];
...
var client_exports = /* @__PURE__ */ __exportAll({
	AlgorithmId: () => import_dist_cjs$2.AlgorithmId,
	Client: () => Client,
	Command: () => Command,
...
var import_dist_cjs$1, DEFAULT_PORTS, parseURL;
var init_parseURL = __esmMin((() => {
	import_dist_cjs$1 = require_dist_cjs();
	init_isIpAddress();
	DEFAULT_PORTS = {
		[import_dist_cjs$1.EndpointURLScheme.HTTP]: 80,
		[import_dist_cjs$1.EndpointURLScheme.HTTPS]: 443
	};
	parseURL = (value) => {
		const whatwgURL = (() => {
			try {
		...
		if (!Object.values(import_dist_cjs$1.EndpointURLScheme).includes(scheme)) return null;
...
var init_HttpProtocol = __esmMin((() => {
	...
	HttpProtocol = class extends SerdeContext {
		...
		async loadEventStreamCapability() {
			const { EventStreamSerde } = await import("./event-streams-CWqNrRIk.js");
...
//#endregion
export { schema_exports as $, customEndpointFunctions as A, client_exports as B, v4 as C, parseRfc7231DateTime as Ct, init_endpoints as D, fromUtf8$1 as Dt, getEndpointPlugin as E, toBase64$1 as Et, init_config as F, resolveDefaultRuntimeConfig as G, NoOpLogger as H, resolveDefaultsModeConfig as I, ServiceException as J, emitWarningIfUnsupportedVersion as K, resolveRegionConfig as L, BinaryDecisionDiagram as M, resolveParams as N, resolveEndpointConfig as O, fromBase64$1 as Ot, config_exports as P, init_schema as Q, NODE_REGION_CONFIG_FILE_OPTIONS as R, serde_exports as S, parseRfc3339DateTimeWithOffset as St, endpoints_exports as T, toUtf8$1 as Tt, getValueFromTextNode as U, init_client as V, getDefaultExtensionConfiguration as W, createAggregatedClient as X, decorateServiceException as Y, Command as Z, SerdeContext as _, nv as _t, getContentLengthPlugin as a, normalizeProvider as at, generateIdempotencyToken as b, dateToUtcString as bt, HttpInterceptingShapeSerializer as c, NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS as ct, determineTimestampFormat as d, ProviderError as dt, TypeRegistry as et, requestBuilder as f, toUint8Array as ft, HttpRequest as g, NumericValue as gt, HttpResponse as h, toHex as ht, buildQueryString as i, Client as it, EndpointCache as j, decideEndpoint as k, HttpInterceptingShapeDeserializer as l, loadConfig as lt, HttpBindingProtocol as m, fromHex as mt, protocols_exports as n, getSchemaSerdePlugin as nt, getHttpHandlerExtensionConfiguration as o, getSmithyContext as ot, RpcProtocol as p, calculateBodyLength as pt, loadConfigsForDefaultMode as q, parseUrl as r, deref as rt, resolveHttpHandlerRuntimeConfig as s, NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS as st, init_protocols as t, NormalizedSchema as tt, FromStringShapeDeserializer as u, require_dist_cjs as ut, extendedEncodeURIComponent as v, _parseEpochTimestamp as vt, Hash as w, expectUnion as wt, init_serde as x, parseEpochTimestamp as xt, collectBody as y, LazyJsonString as yt, NODE_REGION_CONFIG_OPTIONS as z };
