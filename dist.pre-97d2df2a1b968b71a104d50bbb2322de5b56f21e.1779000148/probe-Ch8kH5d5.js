...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-B3WUtwxI.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-BG5AlNk2.js";
import { f as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-DDADSo6k.js";
import { i as READ_SCOPE } from "./operator-scopes-Chm67yFb.js";
import "./method-scopes-CnRd7W8P.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-BQaK7fi8.js");
