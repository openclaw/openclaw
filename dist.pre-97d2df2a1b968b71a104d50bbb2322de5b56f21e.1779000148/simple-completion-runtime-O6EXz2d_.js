...
import { a as resolveAgentEffectiveModelPrimary } from "./agent-scope-DXGTDSD0.js";
import { a as resolveAgentDir } from "./agent-scope-config-DdZBnV-N.js";
import "./defaults-D0p0lnLM.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-DLmuIJtf.js";
import { i as isOpenAIProvider, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-G2-43f4W.js";
import { t as resolveAgentHarnessPolicy } from "./policy-Dm1neGPw.js";
import { b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-Dhs7ZDUG.js";
...
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-BhKUjl9s.js";
import { n as resolveModelAsync, t as resolveModel } from "./model-VfmoZ16v.js";
import { t as prepareModelForSimpleCompletion } from "./simple-completion-transport-uMZ1FqBy.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-StQKe9Yi.js");
