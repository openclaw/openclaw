...
import { a as isSystemdUserServiceAvailable } from "./systemd-Gu0uRd7h.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CJq22W2D.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-DDe-F5pW.js";
import { n as t } from "./i18n-D6Kh7qIc.js";
import { i as installCompletion } from "./completion-runtime-DsYLyn_-.js";
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-sAoRa-tl.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-C8AV8osy.js";
...
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DocCOSOG.js";
import { n as TUI_SETUP_AUTH_SOURCE_ENV, t as TUI_SETUP_AUTH_SOURCE_CONFIG } from "./setup-launch-env-DULCkWt9.js";
...
function formatReloadHint(shell, profileHint) {
	if (shell === "powershell") return t("wizard.completion.reloadPowerShell");
...
function loadOnboardSearchModule() {
	onboardSearchModulePromise ??= import("./onboard-search-BPaMtTG7.js");
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CqiwSPXL.js");
