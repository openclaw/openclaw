...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CRm4xgZt.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CKmrE4o2.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-BAJPfIZ5.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BdHzxbCH.js");
	if (params.argv) {
