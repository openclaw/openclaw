  ...
  `}function y(e,t){let n=Array.from(new Set(t.map(e=>e.trim()).filter(Boolean)));return n.length===0?u:d`<datalist id=${e}>
    ...
    <section class="card cron-summary-strip">
      ...
      <div class="cron-summary-strip__actions">
        ${e.onQuickCreate?d` <button class="btn btn--primary" @click=${e.onQuickCreate}>+ New</button> `:u}
        <button
    ...
    <section class=${`cron-workspace ${I?`cron-workspace--form-collapsed`:``}`}>
      <div class="cron-workspace-main">
        <section class="card">
          ...
          ${e.jobs.length===0?d` <div class="muted" style="margin-top: 12px">${o(`cron.jobs.noMatching`)}</div> `:d`
        ...
        <div class="cron-form-header">
          ...
          ${z?d`
                <button
                  ...
                  title=${o(I?`nav.expand`:`nav.collapse`)}
                  aria-label=${o(I?`nav.expand`:`nav.collapse`)}
          ...
          <section class="cron-form-section">
            ...
            <div class="form-grid cron-form-grid">
              <label class="field ${F===`none`?`cron-span-2`:``}">
                ...
                >
                  ${P?d` <option value="announce">${o(`cron.form.announceDefault`)}</option> `:u}
          ...
          <details class="cron-advanced">
            ...
            <div class="form-grid cron-form-grid">
              ...
              <label class="field checkbox cron-checkbox">
                ...
                />
                <span class="field-checkbox__label">${o(`cron.form.clearAgentOverride`)}</span>
...
//# sourceMappingURL=cron-BMkUdc93.js.map