import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-Bx981XXN.js";
import { r as loadCrestodianOverview } from "./overview-BAbGrrwn.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-Bk0zMVt9.js")).planCrestodianCommand)({
		input,
		overview
	});
