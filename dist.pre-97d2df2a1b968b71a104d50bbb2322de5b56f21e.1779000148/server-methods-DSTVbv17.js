...
import { c as normalizeCronJobCreate, i as triggerSessionPatchHook, u as normalizeCronJobPatch } from "./openclaw-tools-6EPkDNnl.js";
...
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BPvUdIdA.js";
...
import { r as agentCommandFromIngress } from "./agent-command-AocC_oXB.js";
...
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-B2htphhl.js";
...
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B4O9NqUa.js";
...
import "./heartbeat-runner-BogH1xa1.js";
...
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-BarvrAyA.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BfSqPgyK.js");
