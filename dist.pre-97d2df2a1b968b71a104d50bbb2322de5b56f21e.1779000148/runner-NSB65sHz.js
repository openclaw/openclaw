...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-CSYA203S.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BSgua6rv.js";
...
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-BzztNtLE.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-B9H5hWkM.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-BOxRCInf.js";
import { t as buildRandomTempFilePath } from "./temp-download-DtBvqk5a.js";
import "./temp-path-COGpsdv6.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-3M5_EbO9.js";
import "./shared-DU7vsQ8L.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-CzB6DJr0.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-B7nmNBBv.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-DJ8mPbPZ.js");
