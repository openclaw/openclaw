...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-DdZBnV-N.js";
...
import { p as normalizeThinkLevel } from "./thinking-xkGwiIJl.js";
import { t as getProviderEnvVars } from "./provider-env-vars-CfPNrdQ7.js";
import "./config-CIM_gEq1.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-1Q-QxpL0.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-D_srzPjO.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-Chm67yFb.js";
import { d as randomIdempotencyKey, i as callGateway } from "./call-CTkOURQV.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-DpgDYaud.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-XpXex0RS.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DWfYSjGf.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-BxUseaAH.js";
import "./auth-profiles-Cv2JHMp0.js";
import { n as listProfilesForProvider } from "./profile-list-BpNS60Uz.js";
import { r as loadModelCatalog } from "./model-catalog-BWexhYAC.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-CxG_QQZD.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-PuU_fW6l.js";
import { u as saveMediaBuffer } from "./store-ClC2f65S.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-6MNyQZXq.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-DAswBXRI.js";
import "./tts-IxY761Ir.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-C4tVjKKo.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-DDe-F5pW.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BLBGthxG.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-BxDrMH3X.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-NP0A-8N6.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-O6EXz2d_.js";
import { n as runCommandWithRuntime } from "./cli-utils-BivqoSMZ.js";
import { t as removeCommandByName } from "./command-tree-C4TnxdFx.js";
import { t as collectOption } from "./helpers-2hV9piQO.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-X3jhOPFV.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-2-eFnD_H.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-B54IU5bJ.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BrqwsHXm.js");
