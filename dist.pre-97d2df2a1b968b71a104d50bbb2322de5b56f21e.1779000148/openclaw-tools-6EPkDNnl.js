...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-DXGTDSD0.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-DdZBnV-N.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-ByDvK3jv.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-qUY02Z4D.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-6lcDM5MI.js";
...
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-DsyK3dCz.js";
...
import { T as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-CYzFXvuT.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-C9YnZwAO.js";
import { n as resolveSessionConversationRef } from "./session-conversation-CiULL0-K.js";
...
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-5jeH_Uur.js";
import { b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-Dhs7ZDUG.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-Dh_E0SEQ.js";
...
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CAVkwuEU.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Dl9Q222A.js";
import "./tool-policy-COpWYESI.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-DSQoh6s0.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-69KL-8Vy.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-D-MB6yyY.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES, s as normalizeSubagentTaskName } from "./subagent-spawn-B-V6uRN7.js";
...
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-CqD9oiVd.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-BMNgsL5q.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CM5s_M-b.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-OMpG-UH5.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Db95ALDF.js";
...
import { r as stripToolMessages } from "./chat-history-text-CLHd_5YU.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-6lvhIYA-.js";
...
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-CZLWtYk7.js";
...
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CrJ_QCxQ.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-CjkNfFYZ.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BY5--38a.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-UVng9Qxd.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-BHeVyjAE.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Ds5GLaT4.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-D8LHYLYL.js";
import { a as resolvePluginTools } from "./tools-BIlbf7pK.js";
...
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DRFuLDJn.js";
import { d as wrapToolWithBeforeToolCallHook, g as listChannelSupportedActions, l as isToolWrappedWithBeforeToolCallHook, m as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-DHtQ7hrx.js";
import "./delivery-context-CjTwZQJb.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-0pM9dS8t.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-DZEgFdxO.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-DHPeQHu2.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-B1l5Au18.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-CqjHNY-D.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-B2Z5g-Zb.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DDLjmBW-.js";
import { t as inferLegacyName } from "./normalize-D1Qoh2nt.js";
...
import { r as parseImageGenerationModelRef } from "./provider-registry-9QwSDe2S.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CkFuFabb.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-PuU_fW6l.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-C3-7SMzZ.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-2GEKjdaY.js";
import { u as saveMediaBuffer } from "./store-ClC2f65S.js";
import { t as SsrFBlockedError } from "./ssrf-lzTNq2GU.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-BCaGjtiJ.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-C-Atv61N.js";
import { r as getDefaultLocalRoots } from "./local-media-access-DMRkgxH4.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BPmYSHGZ.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-CVpJywob.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CRaVioT7.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-CFRPRZXK.js";
import { n as runWithImageModelFallback } from "./model-fallback-BhqFp6km.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-B1FpTDsL.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-D6zCFEVn.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-6MNyQZXq.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-C0fI458t.js";
import { s as resolveTimeoutMs } from "./resolve-BzztNtLE.js";
import { t as buildProviderRegistry } from "./runner-NSB65sHz.js";
...
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-qdFZu6jV.js";
...
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-sUcsjzrx.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DS4EGLTp.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-CcKKq-tf.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-BhN9FSp-.js";
...
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-BMyf2CQt.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-ByuoW6Bs.js";
import { p as registerSubagentRun } from "./subagent-registry-Boajx773.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-C9Rl_Mjr.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-_MXNlJPn.js";
import { k as textToSpeech } from "./tts-runtime-DAswBXRI.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CofJ7161.js";
...
import { i as runWebSearch } from "./runtime-DDe-F5pW.js";
import "./web-search-provider-common-pVm4d9Oy.js";
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CdPiniGX.js"));
...
//#endregion
export { buildActiveMusicGenerationTaskPromptContextForSession as A, wrapToolMemoryFlushAppendOnlyWrite as C, isEmbeddedMode as D, sniffMimeFromBase64 as E, setEmbeddedMode as O, wrapToolMemoryDayFileWriteGuard as S, wrapToolWorkspaceRootGuardWithOptions as T, createHostWorkspaceWriteTool as _, generateMusic as a, createSandboxedReadTool as b, normalizeCronJobCreate as c, resolveToolLoopDetectionConfig as d, isStrictAgenticExecutionContractActive as f, createHostWorkspaceEditTool as g, createHostWorkspaceAppendTool as h, triggerSessionPatchHook as i, buildActiveImageGenerationTaskPromptContextForSession as j, resolveOpenClawPluginToolsForOptions as k, normalizeCronJobInput as l, stripProviderPrefix as m, buildActiveVideoGenerationTaskPromptContextForSession as n, listRuntimeMusicGenerationProviders as o, isStrictAgenticSupportedProviderModel as p, isParentOwnedBackgroundAcpSession as r, listSupportedMusicGenerationModes as s, createOpenClawTools as t, normalizeCronJobPatch as u, createOpenClawReadTool as v, wrapToolWorkspaceRootGuard as w, createSandboxedWriteTool as x, createSandboxedEditTool as y };
