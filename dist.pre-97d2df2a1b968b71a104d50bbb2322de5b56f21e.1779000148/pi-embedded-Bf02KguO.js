...
import { o as resolveAgentExecutionContract, r as hasConfiguredModelFallbacks, v as resolveSessionAgentIds } from "./agent-scope-DXGTDSD0.js";
import { i as isCronSessionKey } from "./session-key-utils-bmH32UOR.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-DdZBnV-N.js";
import { i as freezeDiagnosticTraceContext } from "./diagnostic-trace-context-B7EOHOXE.js";
import { t as createSubsystemLogger } from "./subsystem-CwZgZA6E.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-D0p0lnLM.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-CwHl-W6V.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-TSLTSa9Q.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-B3WUtwxI.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-DpgDYaud.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime, u as resolveSelectedOpenAIPiRuntimeProvider } from "./openai-codex-routing-G2-43f4W.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-D9YraNzb.js";
import { a as resolveContextEngineOwnerPluginId, i as resolveContextEngine } from "./registry-2sJBjayk.js";
import { s as emitAgentPlanEvent } from "./agent-events-Cnxmg94X.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-CjC9AtYE.js";
import { X as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-5jeH_Uur.js";
import { n as sleepWithAbort } from "./backoff-DBWKeC_y.js";
import "./auth-profiles-Cv2JHMp0.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-CmxU0w--.js";
import { t as markAuthProfileSuccess } from "./profiles-B-RXA6ZW.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-BLaBC-20.js";
import { t as redactIdentifier } from "./redact-identifier-D73pkUbd.js";
import { t as sanitizeForConsole } from "./console-sanitize-Dx6M6fpp.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-rQt36rQK.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-BhKUjl9s.js";
import "./runs-B0OF6UPV.js";
import { t as ensureContextEnginesInitialized } from "./init-CGrf5eAx.js";
import { n as ensureOpenClawModelsJson } from "./models-config-D57gk62w.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-Dh6Nz7hQ.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-Bg3WoBM8.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-OcMk78Z7.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-fd-kR6sE.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-DpFyNNFT.js";
import { a as generateSecureToken } from "./secure-random-B3BCLMBL.js";
import { a as enqueueSystemEvent } from "./system-events-BqE7TU70.js";
import { i as enqueueCommandInLane } from "./command-queue-9-KRAwfe.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BMLB2L5F.js";
import { a as formatAssistantErrorText, b as parseImageSizeError, c as isBillingAssistantError, f as isFailoverAssistantError, h as isRateLimitAssistantError, i as extractObservedOverflowTokenCount, m as isLikelyContextOverflowError, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, y as parseImageDimensionError } from "./errors-CS--39Mi.js";
import { i as setReplyPayloadMetadata, n as getReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-Bh_zJYzf.js";
import { a as hasReplyPayloadContent } from "./payload-oUECwj42.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-DkTysg6B.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-T-G-qMvB.js";
import { i as resolveContextEngineCapabilities, r as listActiveProcessSessionReferences, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-BcMybKIr.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-Da6vsY7j.js";
import { t as log$1 } from "./logger-BDuw5LwF.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-B-I4qZ-i.js";
import { d as resolveToolLoopDetectionConfig, f as isStrictAgenticExecutionContractActive } from "./openclaw-tools-6EPkDNnl.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-Ds5GLaT4.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-TfLTWlW-.js";
import { l as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-CVpJywob.js";
import { D as formatToolAggregate } from "./channel-streaming-1LmL9FAy.js";
import { u as parseReplyDirectives } from "./payloads-CH-U9HQ6.js";
import { a as suspendSession, c as resolveSessionKeyForRequest, f as LiveSessionModelSwitchError, i as resolveSessionSuspensionReason, l as resolveStoredSessionKeyForSessionId, p as shouldAllowCooldownProbeForReason, u as buildApiErrorObservationFields } from "./model-fallback-BhqFp6km.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-pcaTzjhR.js";
import { c as retireSessionMcpRuntime, l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-Dj1xV_EG.js";
import "./pi-bundle-mcp-tools-cHHwA3eE.js";
import { r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-BOpvnZEV.js";
import { $ as resolveReplayInvalidFlag, J as resolveEmptyResponseRetryInstruction, K as resolveAckExecutionFastPathInstruction, Q as resolveReasoningOnlyRetryInstruction, U as STRICT_AGENTIC_BLOCKED_TEXT, W as extractPlanningOnlyPlanDetails, X as resolvePlanningOnlyRetryInstruction, Y as resolveIncompleteTurnPayloadText, Z as resolvePlanningOnlyRetryLimit, a as createEmbeddedRunStageTracker, et as resolveRunLivenessState, i as selectAgentHarness, it as observeReplayMetadata, nt as shouldTreatEmptyAssistantReplyAsSilent, o as formatEmbeddedRunStageSummary, q as resolveAttemptReplayMetadata, r as runAgentHarnessAttempt, rt as createEmbeddedRunReplayState, s as shouldWarnEmbeddedRunStageSummary, tt as resolveSilentToolResultReplyPayload } from "./selection-BYhBpfC3.js";
import { l as runAgentCleanupStep } from "./attempt.tool-run-context-9UadYZkf.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-InuIc_Gt.js";
import { d as resolveLiveToolResultMaxChars, f as sessionLikelyHasOversizedToolResults, p as truncateOversizedToolResultsInSession } from "./preemptive-compaction-BKgKWdjT.js";
import "./tool-split-DlOy99AH.js";
import "./extra-params-B5GR8hJH.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-DhBcJu9R.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-DKlLMOYt.js";
import { r as buildAgentRuntimePlan } from "./build-DkbUOJ_z.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-BxayM3m9.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-CNRgu43n.js";
import { n as resolveModelAsync } from "./model-VfmoZ16v.js";
import "./compact.queued-D-H0ZXKC.js";
import { n as shouldSwitchToLiveModel, r as ensureSelectedAgentHarnessPlugin, t as clearLiveModelSwitchPending } from "./live-model-switch-Dpr_9P0W.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-ClxGpeYu.js";
import fs from "node:fs/promises";
import { randomBytes } from "node:crypto";
//#region src/infra/session-keys.ts
/**
...
*/
function requireSessionKeyOrSkip(params, log, site) {
...
function resolveRunFailoverDecision(params) {
	...
	if (params.compactionFailureContext) return {
		action: "surface_error",
		reason: params.failoverReason
	};
	if (params.externalAbort) return {
	...
	if (params.timedOut && !params.aborted && !params.timedOutDuringToolExecution && !params.timedOutDuringCompaction) return {
		action: "surface_error",
		reason: params.failoverReason
	};
...
async function handleAssistantFailover(params) {
	...
	if (decision.action === "rotate_profile") {
		...
		const markFailedProfile = async () => {
			if (!failedProfileId || !failureReason || failureReason === "timeout") return;
			try {
...
function resolveAuthProfileFailureReason(params) {
	if (params.policy === "local" || !params.failoverReason || params.failoverReason === "timeout" || params.failoverReason === "server_error" || params.failoverReason === "format") return null;
...
function buildEmbeddedRunPayloads(params) {
	...
	const errorText = params.lastAssistant && lastAssistantNeedsErrorSurface ? suppressAssistantArtifacts ? void 0 : formatAssistantErrorText(params.lastAssistant, {
		cfg: params.config,
		sessionKey: params.sessionKey,
		provider: params.provider,
		model: params.model
	}) : void 0;
	const rawErrorMessage = lastAssistantNeedsErrorSurface ? normalizeOptionalString(params.lastAssistant?.errorMessage) : void 0;
	...
	const reasoningText = suppressAssistantArtifacts || runAborted ? "" : params.lastAssistant && params.reasoningLevel === "on" && params.thinkingLevel !== "off" ? extractAssistantThinking(params.lastAssistant) : "";
	...
	const shouldUseCanonicalFinalAnswer = nonEmptyAssistantTexts.length > 1 && fallbackAnswerSourceText.length > 0 && normalizedFallbackAnswerSourceText.length > 0;
...
async function runEmbeddedPiAgent(params) {
	...
	return enqueueSession(() => {
		...
		return enqueueGlobal(async () => {
			...
			const attemptAuthProfileStore = pluginHarnessOwnsTransport ? ensureAuthProfileStoreWithoutExternalProfiles(agentDir, { allowKeychainPrompt: false }) : authStore;
			...
			try {
				...
				while (true) {
					...
					if (timedOut && !timedOutDuringCompaction && !timedOutDuringToolExecution) {
						...
						if (timeoutCompactionAttempts >= MAX_TIMEOUT_COMPACTION_ATTEMPTS) log$1.warn(`[timeout-compaction] already attempted timeout compaction ${timeoutCompactionAttempts} time(s); falling through to timeout handling`);
							...
							log$1.warn(`[context-pressure:fire] mid-turn trigger=timeout ratio=${Math.round(tokenUsedRatio * 100)}% tokens=${Math.round((lastTurnPromptTokens ?? 0) / 1e3)}k/${Math.round(ctxInfo.tokens / 1e3)}k sessionKey=${params.sessionKey ?? params.sessionId}`);
							const timeoutSessionKey = requireSessionKeyOrSkip(params, log$1, "pi-runner.timeout-compaction");
							if (timeoutSessionKey) enqueueSystemEvent(`[system:context-pressure] Mid-turn compaction triggered at ${Math.round(tokenUsedRatio * 100)}% context (${Math.round((lastTurnPromptTokens ?? 0) / 1e3)}k/${Math.round(ctxInfo.tokens / 1e3)}k tokens). Your last reply hit the provider timeout ceiling. Consider evacuating working state earlier via continue_delegate(post-compaction) or memory files so the next turn starts with room to grow.`, { sessionKey: timeoutSessionKey });
							...
							if (timeoutCompactResult.compacted) {
								...
								log$1.warn(`[timeout-compaction] compaction did not reduce context for ${provider}/${modelId}; falling through to normal handling`);
							}
						}
					}
					...
					if (contextOverflowError) {
						...
						if (!isCompactionFailure && !hadAttemptLevelCompaction && overflowCompactionAttempts < MAX_OVERFLOW_COMPACTION_ATTEMPTS) {
							...
							log$1.warn(`[context-pressure:fire] mid-turn trigger=overflow attempt=${overflowCompactionAttempts}/${MAX_OVERFLOW_COMPACTION_ATTEMPTS} tokens=${observedOverflowTokens !== void 0 ? Math.round(observedOverflowTokens / 1e3) : "?"}k/${Math.round(ctxInfo.tokens / 1e3)}k sessionKey=${params.sessionKey ?? params.sessionId}`);
							const overflowSessionKey = requireSessionKeyOrSkip(params, log$1, "pi-runner.overflow-compaction");
							if (overflowSessionKey) enqueueSystemEvent(`[system:context-pressure] Context-overflow compaction triggered mid-turn (attempt ${overflowCompactionAttempts}/${MAX_OVERFLOW_COMPACTION_ATTEMPTS}). Your last reply grew the context past the model's window. Consider evacuating working state earlier via continue_delegate(post-compaction) or memory files; the pre-run context-pressure band did not catch this growth pattern.`, { sessionKey: overflowSessionKey });
							let compactResult;
					...
					if (promptError && !aborted && promptErrorSource !== "compaction") {
						...
						if (promptFailoverDecision.action === "rotate_profile" && await (pluginHarnessOwnsTransport ? advancePluginHarnessAuthProfile() : advanceAuthProfile())) {
					...
					const assistantFailoverOutcome = await handleAssistantFailover({
						...
						advanceAuthProfile: pluginHarnessOwnsTransport ? advancePluginHarnessAuthProfile : advanceAuthProfile
					});
