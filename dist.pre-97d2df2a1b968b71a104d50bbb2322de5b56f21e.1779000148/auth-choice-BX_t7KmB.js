...
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-DdZBnV-N.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-C3QdL7i6.js";
import { t as enablePluginInConfig } from "./enable-DSixIjPr.js";
import { n as ensureAuthProfileStore } from "./store-DpgDYaud.js";
import { t as normalizeOptionalSecretInput } from "./normalize-secret-input-C3wPDsUr.js";
import "./auth-profiles-Cv2JHMp0.js";
import { n as resolveApiKeyForProfile } from "./oauth-BwUN9JpE.js";
import { i as resolveAuthProfileOrder } from "./order-CmxU0w--.js";
import { t as resolveEnvApiKey } from "./model-auth-env-CzSZ24zC.js";
import "./model-auth-BhKUjl9s.js";
import { a as createLazyRuntimeSurface } from "./lazy-runtime-_E5Us7ZD.js";
import "./workspace-CJq22W2D.js";
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-Bw6x9zmm.js";
import { r as resolveManifestProviderAuthChoice, t as resolveManifestDeprecatedProviderAuthChoice } from "./provider-auth-choices-i7bXtfNj.js";
import { n as isDeprecatedAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-C67QbRdP.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-dxLKBnnF.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-XSOu-qdf.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-69hjKGEK.js";
import { n as ensureCodexRuntimePluginForModelSelection, t as CODEX_RUNTIME_PLUGIN_ID } from "./codex-runtime-plugin-install-99hSU1C3.js";
...
function createNonInteractivePluginInstallPrompter(runtime) {
	const unavailable = (message) => Promise.reject(/* @__PURE__ */ new Error(`Non-interactive setup cannot prompt for plugin install: ${message}`));
	return {
		async intro(title) {
			runtime.log(title);
		},
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-7mWLhLuD.js");
