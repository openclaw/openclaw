...
import { o as isPrivateOrLoopbackHost } from "./net-CLmerLvz.js";
import "./string-coerce-runtime-Dpi9hISx.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-B6iH-l9Y.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-CypyQ9KS.js";
import "./setup-ChJe51yi.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-BIlqSNP-.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-iD5eM-IT.js";
import { a as resolveMatrixAccountConfig } from "./account-config-O3FO9EsV.js";
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-BsKEhBQ8.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BRJjFyxU.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Cu22-Cor.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-D9jx9HzM.js";
import { n as updateMatrixAccountConfig } from "./config-update-ucgss1k2.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-vsH8TgxL.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-CCe--1Ca.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DW7r5vuN.js");
