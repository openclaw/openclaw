...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-BIlqSNP-.js";
import "./ssrf-runtime-tmjiuH_f.js";
import "./retry-runtime-BXS2eBxC.js";
import "./secret-input-runtime-Ckc8EUPu.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-iD5eM-IT.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BmZPrbUV.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-O3FO9EsV.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-BsKEhBQ8.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-D9jx9HzM.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BtpAKmIt.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BF493DmK.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CVBUfZjz.js"), import("./logging-CVgOljjx.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-DSZn5D3Q.js").then((credentialsReadModule) => ({
