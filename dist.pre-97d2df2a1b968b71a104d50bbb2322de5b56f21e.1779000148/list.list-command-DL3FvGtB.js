...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-CwHl-W6V.js";
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-G2-43f4W.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-BhKUjl9s.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-BhMXO46G.js";
import { n as loadModelsConfigWithSource } from "./load-config-NItv4ev2.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-DW5OWXK7.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-Bpj5dJlx.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BYn-FlQw.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BMTKPDsK.js"),
		import("./agent-scope-CrnftTkZ.js"),
		import("./workspace-UQUyqsBK.js")
	]);
