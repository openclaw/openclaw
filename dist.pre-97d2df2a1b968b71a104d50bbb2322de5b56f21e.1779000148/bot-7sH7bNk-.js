...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-DdZBnV-N.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-izP4MuZ5.js";
...
import { c as appendSessionTranscriptMessage, l as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript } from "./transcript-CWETPHzg.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-BxUseaAH.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CAVkwuEU.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-BWexhYAC.js";
import { h as isInsideCode, m as findCodeRegions, u as stripReasoningTagsFromText } from "./assistant-visible-text-aJIuI6UH.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-DIfxClWu.js";
import { n as MediaFetchError } from "./fetch-CSYA203S.js";
...
import { T as resolveChannelStreamingPreviewToolProgress, _ as resolveChannelProgressDraftMaxLines, a as createChannelProgressDraftGate, b as resolveChannelStreamingBlockEnabled, c as formatChannelProgressDraftText, d as mergeChannelProgressDraftLine, i as buildChannelProgressDraftLineForEntry, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./channel-streaming-1LmL9FAy.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-DoeRNEZX.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-CGZuwphf.js";
...
import { n as createPreviewMessageReceipt } from "./live-D9DtHROS.js";
...
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-K_T5hxWg.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-zG1cNbWV.js";
...
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-CHqEdPE4.js";
...
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-CeFBST2k.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-8sovS7U_.js";
import "./reply-chunking-BHNPRptZ.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-DpGbNXZd.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-CocJ6SD5.js";
...
import "./hook-runtime-B6JeaIyr.js";
import "./markdown-table-runtime-BW_YAmEw.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders--s1DqWwO.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-obbsPmjF.js";
import "./command-auth-native-ismyOPLY.js";
import "./command-primitives-runtime-gJCfBCu9.js";
import "./command-status-BRE2NLpg.js";
import "./command-detection-t1Ym5W8B.js";
import "./command-surface-ClI7hMhZ.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-cg1DqVYZ.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-vFdCrcLe.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-wPx3BFYa.js";
...
import "./skill-commands-runtime-nVsbY9Ip.js";
import "./native-command-config-runtime-CmQ85qzr.js";
import { t as mergeTelegramAccountConfig } from "./account-config-KEX9Trxl.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-CVKnOQeU.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-BKbnntys.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-C4oTc3I8.js";
import { A as buildSenderLabel, B as expandTelegramAllowFromWithAccessGroups, C as resolveTelegramForumThreadId, D as resolveTelegramThreadSpec, E as resolveTelegramStreamMode, F as hasBotMention, G as resolveTelegramEffectiveDmPolicy, H as isSenderAllowed, L as normalizeForwardedContext, M as expandTextLinks, N as extractTelegramLocation, O as shouldUseTelegramDmThreadSession, P as getTelegramTextParts, S as resolveTelegramForumFlag, T as resolveTelegramReplyId, U as normalizeAllowFrom, V as resolveTelegramDmAllow, W as normalizeDmAllowFromWithStore, _ as extractTelegramForumFlag, a as renderTelegramHtmlText, b as resolveTelegramCommandAuthorization, d as buildTelegramGroupPeerId, f as buildTelegramParentPeer, g as describeReplyTarget, h as buildTypingThreadParams, j as buildSenderName, k as withResolvedTelegramForumFlag, l as buildGroupLabel, m as buildTelegramThreadParams, n as markdownToTelegramChunks, p as buildTelegramRoutingTarget, u as buildTelegramGroupFrom, v as isTelegramCommandsAllowFromConfigured, w as resolveTelegramGroupAllowFromContext, x as resolveTelegramDirectPeerId, z as resolveTelegramPrimaryMedia } from "./format-BGbHqOaX.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-CpK6u37l.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CtrhuQYZ.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-ZoAWLZqd.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-C2pNozDx.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-CV7r3b5k.js";
import { A as Bot, C as createTelegramClientFetch, E as resolveTelegramOutboundClientTimeoutFloorSeconds, M as sequentialize, O as withTelegramApiErrorLogging, S as asTelegramClientFetch, T as resolveTelegramClientTimeoutSeconds, a as editMessageTelegram, g as recordSentMessage, j as apiThrottler, k as getOrCreateAccountThrottler, w as resolveTelegramClientTimeoutMinimumSeconds, x as buildInlineKeyboard } from "./send-DN19_ry_.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-Bg4DOlcK.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-DGOZVvek.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-CJ5mtbcD.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-BLOfavzg.js");
...
function resolveAmbientGroupTurnKind(cfg, agentId) {
	const agentGroupChat = resolveAgentConfig(cfg, agentId)?.groupChat;
	if (agentGroupChat && Object.hasOwn(agentGroupChat, "ambientTurns")) return agentGroupChat.ambientTurns ?? "user_request";
...
async function buildTelegramInboundContextPayload(params) {
	...
	const inboundTurnKind = ambientGroupTurnKind === "room_event" && isGroup && !effectiveWasMentioned && !hasControlCommand && !hasAbortRequest && commandSource !== "native" ? "room_event" : "user_request";
	...
	if (inboundTurnKind === "room_event" && historyKey) channelHistory.record({
		historyKey,
		limit: historyLimit,
		entry: {
			sender: buildSenderLabel(msg, senderId || chatId),
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-Cb8kpCcv.js")).defaultTelegramBotDeps;
	...
	const beginDeliveryCorrelation = () => beginTelegramInboundTurnDeliveryCorrelation(ctxPayload.SessionKey, {
	...
	try {
		...
		const resolveTranscriptBackedFinalText = async (text) => isPotentialTruncatedFinal(text) ? selectLongerFinalText({
			finalText: text,
...
const createTelegramMessageProcessor = (deps) => {
	...
	const sessionRuntime = {
		...telegramDeps.buildChannelTurnContext ? { buildChannelTurnContext: telegramDeps.buildChannelTurnContext } : {},
	...
	return async (primaryCtx, allMedia, storeAllowFrom, options, replyMedia, replyChain, promptContext) => {
		...
		if (context.ctxPayload.InboundTurnKind !== "room_event") context.sendTyping().catch((err) => {
