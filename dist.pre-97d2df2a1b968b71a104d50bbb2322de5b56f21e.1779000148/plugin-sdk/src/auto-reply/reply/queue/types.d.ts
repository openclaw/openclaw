...
import type { QueuedReplyDeliveryCorrelation, QueuedReplyLifecycle, SourceReplyDeliveryMode } from "../../get-reply-options.types.js";
...
export declare function isFollowupRunAborted(run: Pick<FollowupRun, "abortSignal">): boolean;
export declare function markFollowupRunEnqueued(run: Pick<FollowupRun, "queuedLifecycle">): void;
export declare function completeFollowupRunLifecycle(run: Pick<FollowupRun, "queuedLifecycle">): void;
