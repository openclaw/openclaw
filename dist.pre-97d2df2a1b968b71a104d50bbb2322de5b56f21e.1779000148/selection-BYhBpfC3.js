...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-DOxPr38W.js";
...
import { T as getCompactionProvider } from "./loader-6lcDM5MI.js";
...
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-Dq8mY7X0.js";
...
import { A as resolveCacheTtlMs, D as createExpiringMapCache, k as isCacheEnabled, t as loadSessionStore } from "./store-load-CYzFXvuT.js";
...
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-MLsIinKe.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DWfYSjGf.js";
import { u as redactTranscriptMessage } from "./transcript-CWETPHzg.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-B0OF6UPV.js";
...
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-Dh6Nz7hQ.js";
import { C as firstEnumerableOwnKeys, S as boundedJsonUtf8Bytes, T as jsonUtf8BytesOrInfinity, _ as stripInternalMetadataForDisplay } from "./session-utils.fs-CqD9oiVd.js";
...
import { d as stripRuntimeContextCustomMessages, l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-Cnu4YTEt.js";
...
import { a as stripDowngradedToolCallText, d as findFinalTagMatches, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-aJIuI6UH.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-sTCCDKjV.js";
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-OcMk78Z7.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DpFyNNFT.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-CS--39Mi.js";
import { n as extractToolResultId, o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-Chdj-ZP2.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CrJ_QCxQ.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-Bh_zJYzf.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-DIfxClWu.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-hDA364po.js";
...
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-BcMybKIr.js";
import { t as log$5 } from "./logger-BDuw5LwF.js";
import { a as TranscriptFileState, c as writeTranscriptFileAtomic, l as getRawSessionAppendMessage, s as readTranscriptFileState, t as runContextEngineMaintenance, u as setRawSessionAppendMessage } from "./context-engine-maintenance-B-I4qZ-i.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-CxN5JQXy.js";
import { D as isEmbeddedMode, d as resolveToolLoopDetectionConfig, m as stripProviderPrefix, p as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-6EPkDNnl.js";
...
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, v as resolveChannelPromptCapabilities, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-DHtQ7hrx.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-BuYOfuva.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-DHPeQHu2.js";
import { c as hasCommittedMessagingToolDeliveryEvidence, l as hasMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-CVpJywob.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-a0uhKLrw.js";
...
import { d as buildTextObservationFields, u as buildApiErrorObservationFields } from "./model-fallback-BhqFp6km.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CJq22W2D.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-BXBDPKKe.js";
...
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-BhN9FSp-.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Dj1xV_EG.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-KLjkN2HN.js";
...
import { o as listControlledSubagentRuns } from "./subagent-control-_MXNlJPn.js";
...
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-ZmvMW4OY.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-BTeqcxaZ.js";
...
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CXqot-mu.js";
...
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DHlDPQPG.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-CyX_VDK6.js";
import { S as supportsModelTools, _ as sanitizeToolArgs, a as logAgentRuntimeToolDiagnostics, b as isMessagingTool, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, i as shouldAllowProviderOwnedThinkingReplay, l as runAgentCleanupStep, m as filterToolResultMediaUrls, n as createAgentToolResultMiddlewareRunner, o as normalizeAgentRuntimeTools, p as extractToolResultText$1, r as resolveTranscriptPolicy, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as sanitizeToolResult, x as isMessagingToolSendAction, y as collectTextContentBlocks } from "./attempt.tool-run-context-9UadYZkf.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-CRj2HfTK.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-InuIc_Gt.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CijfR6-F.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-BKgKWdjT.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-Chm4QVYz.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-DlOy99AH.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-BzVrLM01.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-WoLVXquE.js";
import { s as buildCopilotIdeHeaders } from "./provider-auth-CUxupOK9.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-ui5d6tk1.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-DgkuRfWH.js";
import { o as resolveSandboxContext } from "./sandbox-CQ50mH2J.js";
import { t as detectRuntimeShell } from "./shell-utils-46AkvrhG.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DmMXzen0.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-Cs4d6U6U.js";
...
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-BkI4_A3L.js";
import "./tool-loop-detection-g1-rWTlp.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./proxy-stream-wrappers-CwhMEYcE.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-B5GR8hJH.js";
...
import { t as extractSections } from "./post-compaction-context-DRxfvq5e.js";
...
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-mycmkdsm.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DJ_86WSa.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CFSOQxtx.js";
import { t as detectAndLoadPromptImages } from "./images-6H_Uekkd.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentTurnPrompt } from "./runtime-context-prompt-BU7Dol8n.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-CaMTPBkw.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-OnAbMZWM.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-dKR9o8Qq.js"));
