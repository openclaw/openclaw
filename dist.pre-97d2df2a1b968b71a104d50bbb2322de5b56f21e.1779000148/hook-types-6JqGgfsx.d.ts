...
import { mn as TtsAutoMode } from "./types.channels-BVJ2Rte8.js";
import { c as SourceReplyDeliveryMode, u as ReplyPayload } from "./get-reply-options.types-DJsrtcW0.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-CJh7F-y9.js";
import { t as FinalizedMsgContext } from "./templating-BKUxbw7m.js";
...
//#endregion
export { PluginHookModelCallStartedEvent as $, PluginHookBeforeAgentStartOverrideResult as $t, PluginHookBeforeMessageWriteResult as A, PluginAgentTurnPrepareResult as At, PluginHookGatewayCronJobState as B, PluginHookMessageReceivedEvent as Bt, PluginHookBeforeInstallEvent as C, PluginInstallSourcePathKind as Ct, PluginHookBeforeInstallSkill as D, isPluginHookName as Dt, PluginHookBeforeInstallResult as E, isConversationHookName as Et, PluginHookCronChangedEvent as F, PluginNextTurnInjectionRecord as Ft, PluginHookGatewayStartEvent as G, PluginConversationBindingRequestParams as Gt, PluginHookGatewayCronRunStatus as H, PluginHookMessageSendingResult as Ht, PluginHookGatewayContext as I, PluginJsonValue as It, PluginHookInboundClaimResult as J, PluginConversationBindingResolvedEvent as Jt, PluginHookGatewayStopEvent as K, PluginConversationBindingRequestResult as Kt, PluginHookGatewayCronCreateInput as L, PluginHookInboundClaimContext as Lt, PluginHookBeforeToolCallEvent as M, PluginHeartbeatPromptContributionResult as Mt, PluginHookBeforeToolCallResult as N, PluginNextTurnInjection as Nt, PluginHookBeforeInstallSkillInstallSpec as O, isPromptInjectionHookName as Ot, PluginHookContextWindowSource as P, PluginNextTurnInjectionEnqueueResult as Pt, PluginHookModelCallEndedEvent as Q, PluginHookBeforeAgentStartEvent as Qt, PluginHookGatewayCronDeliveryStatus as R, PluginHookInboundClaimEvent as Rt, PluginHookBeforeInstallContext as S, PluginInstallRequestKind as St, PluginHookBeforeInstallRequest as T, PromptInjectionHookName as Tt, PluginHookGatewayCronService as U, PluginHookMessageSentEvent as Ut, PluginHookGatewayCronRemoveResult as V, PluginHookMessageSendingEvent as Vt, PluginHookGatewayCronUpdateInput as W, PluginConversationBinding as Wt, PluginHookLlmOutputEvent as X, InputGateDecision as Xt, PluginHookLlmInputEvent as Y, GateHookResult as Yt, PluginHookModelCallBaseEvent as Z, PLUGIN_PROMPT_MUTATION_RESULT_FIELDS as Zt, PluginHookBeforeCompactionEvent as _, PluginHookToolContext as _t, PluginApprovalResolution as a, PluginHookBeforePromptBuildResult as an, PluginHookSessionContext as at, PluginHookBeforeDispatchResult as b, PluginHookToolResultPersistResult as bt, PluginHookAfterToolCallEvent as c, PluginHookSessionStartEvent as ct, PluginHookBeforeAgentFinalizeEvent as d, PluginHookSubagentDeliveryTargetResult as dt, PluginHookBeforeAgentStartResult as en, PluginHookName as et, PluginHookBeforeAgentFinalizeResult as f, PluginHookSubagentEndedEvent as ft, PluginHookBeforeAgentRunResult as g, PluginHookSubagentTargetKind as gt, PluginHookBeforeAgentRunEvent as h, PluginHookSubagentSpawningResult as ht, PROMPT_INJECTION_HOOK_NAMES as i, PluginHookBeforePromptBuildEvent as in, PluginHookReplyDispatchResult as it, PluginHookBeforeResetEvent as j, PluginHeartbeatPromptContributionEvent as jt, PluginHookBeforeMessageWriteEvent as k, PluginAgentTurnPrepareEvent as kt, PluginHookAgentContext as l, PluginHookSubagentContext as lt, PluginHookBeforeAgentReplyResult as m, PluginHookSubagentSpawningEvent as mt, ConversationHookName as n, PluginHookBeforeModelResolveEvent as nn, PluginHookReplyDispatchContext as nt, PluginApprovalResolutions as o, stripPromptMutationFieldsFromLegacyHookResult as on, PluginHookSessionEndEvent as ot, PluginHookBeforeAgentReplyEvent as p, PluginHookSubagentSpawnedEvent as pt, PluginHookHandlerMap as q, PluginConversationBindingResolutionDecision as qt, PLUGIN_HOOK_NAMES as r, PluginHookBeforeModelResolveResult as rn, PluginHookReplyDispatchEvent as rt, PluginHookAfterCompactionEvent as s, PluginHookSessionEndReason as st, CONVERSATION_HOOK_NAMES as t, PluginHookBeforeModelResolveAttachment as tn, PluginHookRegistration as tt, PluginHookAgentEndEvent as u, PluginHookSubagentDeliveryTargetEvent as ut, PluginHookBeforeDispatchContext as v, PluginHookToolResultPersistContext as vt, PluginHookBeforeInstallPlugin as w, PluginInstallTargetType as wt, PluginHookBeforeInstallBuiltinScan as x, PluginInstallFinding as xt, PluginHookBeforeDispatchEvent as y, PluginHookToolResultPersistEvent as yt, PluginHookGatewayCronJob as z, PluginHookMessageContext as zt };