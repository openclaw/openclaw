...
import { i as normalizeDevicePublicKeyBase64Url } from "./device-identity-Cy5O_7Bd.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-BhjtHITW.js";
import { i as pruneExpiredPending, l as roleScopesAllow, n as verifyPairingToken, o as resolvePairingPaths, t as generatePairingToken } from "./pairing-token-XsKCmFk6.js";
import path from "node:path";
const BOOTSTRAP_HANDOFF_OPERATOR_SCOPE_SET = new Set([
	"operator.approvals",
	"operator.read",
...
//#endregion
export { restoreDeviceBootstrapToken as a, verifyDeviceBootstrapToken as c, redeemDeviceBootstrapTokenProfile as i, PAIRING_SETUP_BOOTSTRAP_PROFILE as l, getDeviceBootstrapTokenProfile as n, revokeDeviceBootstrapToken as o, issueDeviceBootstrapToken as r, revokeDeviceBootstrapTokensForDevice as s, clearDeviceBootstrapTokens as t, normalizeDeviceBootstrapProfile as u };
