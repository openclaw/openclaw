...
import { p as resolveUserPath, y as truncateUtf16Safe } from "./utils-CpmNtyoq.js";
...
import { a as isSessionArchiveArtifactName, l as isUsageCountedSessionTranscriptFileName } from "./artifacts-C9-LS6LB.js";
...
import { t as extractKeywords } from "./query-expansion-CucygoJ6.js";
import { r as classifyMemoryMultimodalPath } from "./multimodal-D5efrRaq.js";
...
import { n as listMemoryEmbeddingProviders, t as getMemoryEmbeddingProvider } from "./memory-embedding-provider-runtime-CHyeZ-cX.js";
import { u as enforceEmbeddingMaxInputTokens } from "./memory-core-host-engine-embeddings-vWpYBvq1.js";
import { a as ensureDir, c as normalizeExtraMemoryPaths, d as runWithConcurrency, f as hasNonTextEmbeddingParts, i as cosineSimilarity, l as parseEmbedding, n as buildMultimodalChunkForIndexing, r as chunkMarkdown, s as listMemoryFiles, t as buildFileEntry, u as remapChunkLines } from "./internal-CXzLZpaA.js";
import { t as isFileMissingError } from "./fs-utils-CCuhvrRj.js";
import { t as hashText } from "./hash-DMmlZj1A.js";
import "./memory-core-host-engine-foundation-Db-95WJM.js";
import { c as buildSessionEntry, l as listSessionFilesForAgent, p as sessionPathForFile } from "./engine-qmd-DxYRnFA5.js";
import "./memory-core-host-engine-qmd-DBnHfCR4.js";
import { n as readMemoryFile } from "./read-file-D-0Hw6HW.js";
import { a as ensureMemoryIndexSchema, i as loadSqliteVecExtension, n as configureMemorySqliteWalMaintenance, r as requireNodeSqlite, t as closeMemorySqliteWalMaintenance } from "./engine-storage-Bg51iS7l.js";
import "./memory-core-host-engine-storage-DEE9uj1U.js";
import "./dreaming-shared-BG-cle3G.js";
import { t as canAutoSelectLocal } from "./provider-adapters-BzeTnEA0.js";
import { n as settleMemoryWatchEventPaths, t as recordMemoryWatchEventPath } from "./watch-settle-CU0Z-KIT.js";
...
var MemoryIndexManager = class MemoryIndexManager extends MemoryManagerEmbeddingOps {
	...
	async search(query, opts) {
		...
		const keywordResults = hybrid.enabled && this.fts.enabled && this.fts.available ? await this.searchKeyword(cleaned, candidates, { boostFallbackRanking: true }, sourceFilterList).catch((err) => {
