...
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-BLaBC-20.js";
...
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-6MNyQZXq.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-BzztNtLE.js";
import { n as providerOperationRetryConfig } from "./operation-retry-3art54tf.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-7eDan3Ih.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-B7nmNBBv.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-DJ8mPbPZ.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
