import { f as readLoggingConfig, i as redactSensitiveFieldValue, r as redactSecrets, s as redactSensitiveText, t as getDefaultRedactPatterns } from "./redact-CxqQQvmK.js";
import { i as formatErrorMessage } from "./errors-ixwfrboQ.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, r as resolveDefaultSessionStorePath } from "./paths-izP4MuZ5.js";
import { c as resolveSessionStoreEntry, s as normalizeStoreSessionKey, t as loadSessionStore, w as parseSessionThreadInfo } from "./store-load-CYzFXvuT.js";
...
import { n as extractAssistantVisibleText } from "./chat-message-content-CjC9AtYE.js";
...
async function appendSessionTranscriptMessageLocked(params) {
	...
	try {
		...
		const finalMessage = isTranscriptAgentMessage(params.message) ? redactTranscriptMessage(params.message, params.config) : redactSecrets(params.message);
		const entry = {
			type: "message",
			id: messageId,
...
//#endregion
export { resolveSessionTranscriptFile as a, appendSessionTranscriptMessage as c, readTailAssistantTextFromSessionTranscript as i, resolveAndPersistSessionFile as l, appendExactAssistantMessageToSessionTranscript as n, streamSessionTranscriptLines as o, readLatestAssistantTextFromSessionTranscript as r, resolveMirroredTranscriptText as s, appendAssistantMessageToSessionTranscript as t, redactTranscriptMessage as u };
