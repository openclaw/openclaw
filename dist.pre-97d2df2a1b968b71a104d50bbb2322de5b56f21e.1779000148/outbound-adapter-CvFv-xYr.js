...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-DIfxClWu.js";
...
import { m as DiscordError } from "./discord-BD874Y9w.js";
import { t as chunkDiscordTextWithMode } from "./chunk-BpmOQ0c8.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-D2WFxXgH.js";
import { t as createDiscordSendReceipt } from "./send.receipt-VNudrM2F.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-56D89qw_.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-DJhEPkFC.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-DYqNT5eA.js");
