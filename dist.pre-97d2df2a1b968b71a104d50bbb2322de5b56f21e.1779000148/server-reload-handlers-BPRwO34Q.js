...
import "./installed-plugin-index-records-CWc7hfiR.js";
import { n as formatConfigIssueLines } from "./issue-format-O2IWAyJu.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-B8sHIDdb.js";
import { n as isRestartEnabled } from "./commands.flags-K2k3F9G8.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-CpQSFuwN.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-oSUt9FSF.js";
import { o as resetModelCatalogCache } from "./model-catalog-BWexhYAC.js";
import { l as getTotalQueueSize } from "./command-queue-9-KRAwfe.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DZEgFdxO.js";
import { r as resetDirectoryCache } from "./target-resolver-DUnCbmL5.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-Dj1xV_EG.js";
import "./pi-bundle-mcp-tools-cHHwA3eE.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-fsPNvlp0.js";
...
import { _ as resolveHooksConfig } from "./hooks-Bu83hPtX.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-ZIzOYepY.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DBzhUeHz.js";
...
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-D7dxeWs_.js";
import { t as buildGatewayCronService } from "./server-cron-CZrBrrFH.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CIM8Lv0m.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-I_o4VIkb.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-D04BLOOv.js"), import("./gmail-watcher-lifecycle-CQ8h8WcA.js")]);
