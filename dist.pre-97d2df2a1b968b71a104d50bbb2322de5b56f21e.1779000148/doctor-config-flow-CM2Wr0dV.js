...
import { n as discoverConfigSecretTargets } from "./target-registry-Xx4mdWqK.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-ByDvK3jv.js";
import { n as formatConfigIssueLines } from "./issue-format-O2IWAyJu.js";
import { r as normalizeTalkSection } from "./talk-Fv8Z5G4C.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-C9yqkVoz.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-CuNKfE8O.js";
import { n as getLoadedChannelPlugin } from "./registry-C9YnZwAO.js";
import { i as listRouteBindings } from "./bindings-Bhtm9UBU.js";
import { i as legacyRuntimeModelAliasRequiresRuntimePolicy, o as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-jZ_YBFNZ.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CHdWz4EI.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-tGvAu2Yb.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-B8guo0pu.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CT9NSY23.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DMn0d_RV.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-fEPALxdl.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-WA5xUAlW.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-QcfAB6my.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BFSIBo5B.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-Bez86md7.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-Ccatz3XH.js");
		emitDoctorNotes({
			note,
