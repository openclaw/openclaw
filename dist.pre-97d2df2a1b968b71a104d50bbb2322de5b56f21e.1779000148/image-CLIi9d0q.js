import { r as normalizeModelRef } from "./model-selection-normalize-Dh_E0SEQ.js";
import "./model-selection-BxUseaAH.js";
import { r as resolveProviderRequestCapabilities } from "./provider-attribution-DHlgOVkW.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-BiEJI1LG.js";
import { l as resolveApiKeyForProvider, r as getApiKeyForModel } from "./model-auth-BhKUjl9s.js";
import { n as ensureOpenClawModelsJson } from "./models-config-D57gk62w.js";
import { i as coerceImageAssistantText, r as minimaxUnderstandImage, s as hasImageReasoningOnlyResponse, t as isMinimaxVlmModel } from "./minimax-vlm-CFRPRZXK.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BzVrLM01.js";
import { f as resolveCopilotApiToken, i as COPILOT_INTEGRATION_ID, s as buildCopilotIdeHeaders } from "./provider-auth-CUxupOK9.js";
...
async function resolveImageRuntime(params) {
	...
	const resolved = await resolveModelAsync(resolvedRef.provider, resolvedRef.model, params.agentDir, params.cfg, { allowBundledStaticCatalogFallback: true });
