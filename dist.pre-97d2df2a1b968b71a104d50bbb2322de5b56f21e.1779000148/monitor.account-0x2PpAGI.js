...
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-aJIuI6UH.js";
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-DIfxClWu.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-DhZpRFQ2.js";
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./channel-streaming-1LmL9FAy.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-caI9TN6H.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-pcaTzjhR.js";
...
import { i as installRequestBodyLimitGuard } from "./http-body-BKLJ3a65.js";
import "./ssrf-runtime-tmjiuH_f.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CocJ6SD5.js";
...
import "./command-primitives-runtime-gJCfBCu9.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-B1TG1dWR.js";
import { t as buildFeishuConversationId } from "./conversation-id-DP1mIjk0.js";
import { i as resolveReceiveIdType } from "./targets-Csst0n9_.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-CQw8Cbw4.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-CTCuQEwv.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-Crdt2WIX.js";
import { a as resolveFeishuGroupSenderActivationIngressAccess, i as resolveFeishuGroupConversationIngressAccess, n as resolveFeishuDmIngressAccess, r as resolveFeishuGroupConfig, s as resolveFeishuReplyPolicy, t as hasExplicitFeishuGroupConfig } from "./policy-DAQ2_zjC.js";
import { t as getFeishuRuntime } from "./runtime-BNaEuHjW.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-BwG3UIrH.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-DGKmOLDR.js";
import "./runtime-api-Sgy34iA-.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as saveMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-BGLmPM11.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-DWfcR_Ge.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-vJY3f9qe.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-Pi4QLEUk.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-Pi4QLEUk.js");
