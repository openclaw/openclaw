        ...
        inspectAccount: (cfg) => {
          ...
          if (cfg === sourceConfig) {
            return {
              ...
              configured: true,
              mode: "http",
              botTokenSource: "config", // pragma: allowlist secret (status string) // pragma: allowlist secret (status string) // pragma: allowlist secret (status string)
              botTokenStatus: "configured_unavailable", // pragma: allowlist secret (status string)
              signingSecretSource: "config", // pragma: allowlist secret (status string) // pragma: allowlist secret (status string) // pragma: allowlist secret (status string)
              signingSecretStatus: "configured_unavailable", // pragma: allowlist secret (status string)
              config: channel,
            };
          }
          return {
            ...
            botTokenStatus: "available", // pragma: allowlist secret (status string) // pragma: allowlist secret (status string)
            signingSecretSource: "config",
            signingSecretStatus: "available", // pragma: allowlist secret (status string) // pragma: allowlist secret (status string)
            config: channel,
          };
        },
