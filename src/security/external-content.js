...
export { isExternalHookSession, mapHookExternalContentSource, resolveHookExternalContentSource, } from "./external-content-source.js";
import { mapHookExternalContentSource, resolveHookExternalContentSource, } from "./external-content-source.js";
/**
    ...
    for (const pattern of patterns) {
        ...
        while ((match = pattern.regex.exec(folded)) !== null) {
            ...
            replacements.push({
                ...
                end: originalEndByFoldedIndex[foldedEnd - 1] ??
