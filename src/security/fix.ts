...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ActiviConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ActiviConfig; env: NodeJS.ProcessEnv }): {
  cfg: ActiviConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
