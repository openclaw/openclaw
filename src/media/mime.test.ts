...
describe("mimeTypeFromFilePath", () => {
  it.each([
    ...
    { filePath: "root.crt", expected: "application/x-x509-ca-cert" },
    { filePath: "root.cer", expected: "application/x-x509-ca-cert" },
    { filePath: "root.pem", expected: "application/x-pem-file" },
...
describe("extensionForMime", () => {
  ...
  it.each([
    ...
    { mime: "application/x-pem-file", expected: ".pem" },
    { mime: "application/x-x509-ca-cert", expected: ".crt" },
