...
async function optimizeImageWithFallback(params: {
  ...
  let smallest: { buffer: Buffer; size: number; resizeSide: number; quality: number } | null = null;
  ...
  // Return original buffer resized to smallest attempt if nothing fits
  throw new Error(formatCapReduce("Media", cap, buffer.length));
}
