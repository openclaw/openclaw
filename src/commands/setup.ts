...
import { ensureManagedSessionsDirForAgent } from "../config/sessions.js";
...
export async function setupCommand(
  ...
  const sessionsDir = await ensureManagedSessionsDirForAgent(undefined, {
    store: next.session?.store,
  });
