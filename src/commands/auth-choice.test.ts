...
async function createDefaultProviderPlugins(): Promise<ProviderPlugin[]> {
  ...
  return [
    ...
    await createApiKeyProvider({
      ...
      noteMessage: "OpenCode Zen uses OPENCODE_ZEN_API_KEY (or OPENCODE_API_KEY as fallback).",
    ...
    await createApiKeyProvider({
      ...
      expectedProviders: ["opencode", "opencode-go"],
      noteMessage: "OpenCode Go uses OPENCODE_GO_API_KEY (or OPENCODE_API_KEY as fallback).",
