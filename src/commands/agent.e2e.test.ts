...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "smart-agent-neo-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<SmartAgentNeoConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<SmartAgentNeoConfig["telegram"]>>,
