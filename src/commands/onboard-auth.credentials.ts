...
export const DEEPINFRA_DEFAULT_MODEL_REF = "deepinfra/meta-llama/Llama-3.3-70B-Instruct-Turbo";
...
export async function setDeepinfraApiKey(
  ...
  upsertAuthProfile({
    ...
    credential: buildApiKeyCredential("deepinfra", key, undefined, options),
    agentDir: resolveAuthAgentDir(agentDir),
  });
}
