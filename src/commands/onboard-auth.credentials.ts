...
export const QINIU_DEFAULT_MODEL_REF = "qiniu/deepseek-r1";
...
export async function setQiniuApiKey(
  key: SecretInput,
  agentDir?: string,
  options?: ApiKeyStorageOptions,
) {
  upsertAuthProfile({
    ...
    credential: buildApiKeyCredential("qiniu", key, undefined, options),
    agentDir: resolveAuthAgentDir(agentDir),
  });
}
