...
export const NANOGPT_DEFAULT_MODEL_REF = "nanogpt/deepseek-r1";
...
export async function setNanogptApiKey(
  key: SecretInput,
  agentDir?: string,
  options?: ApiKeyStorageOptions,
) {
  upsertAuthProfile({
    ...
    credential: buildApiKeyCredential("nanogpt", key, undefined, options),
    agentDir: resolveAuthAgentDir(agentDir),
  });
}
