...
function resolveDefaultAccountId(cfg: SmartAgentNeoConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SmartAgentNeoConfig): boolean {
...
export function summarizeBindings(cfg: SmartAgentNeoConfig, bindings: AgentBinding[]): string[] {
