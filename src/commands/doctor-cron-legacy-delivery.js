import { z } from "zod";
import { DeliveryThreadIdFieldSchema, LowercaseNonEmptyStringFieldSchema, TrimmedNonEmptyStringFieldSchema, parseOptionalField, } from "../cron/delivery-field-schemas.js";
...
export function hasLegacyDeliveryHints(payload) {
    ...
    return (hints.deliver !== undefined ||
...
export function buildDeliveryPatchFromLegacyPayload(payload) {
    const hints = parseLegacyDeliveryHintsInput(payload);
    const next = {};
    let hasPatch = false;
...
export function mergeLegacyDeliveryInto(delivery, payload) {
