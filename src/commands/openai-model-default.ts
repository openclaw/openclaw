...
export function applyOpenAIProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyOpenAIConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
