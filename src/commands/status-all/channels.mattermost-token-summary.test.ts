  ...
  return {
    ...
    config: {
      ...
      resolveAccount: () => ({
        name: "Echo",
        enabled: true,
        botToken: "bot-token-value", // pragma: allowlist secret (fixture token)
  ...
  return {
    ...
    config: {
      ...
      inspectAccount: () => ({
        name: "Primary",
        enabled: true,
        botToken: params?.botToken ?? "bot-token", // pragma: allowlist secret (fixture token) // pragma: allowlist secret (fixture token)
        appToken: params?.appToken ?? "app-token", // pragma: allowlist secret (fixture token) // pragma: allowlist secret (fixture token)
      }),
      resolveAccount: () => ({
        name: "Primary",
        enabled: true,
        botToken: params?.botToken ?? "bot-token", // pragma: allowlist secret (fixture token)
        appToken: params?.appToken ?? "app-token", // pragma: allowlist secret (fixture token)
      }),
      isConfigured: () => true,
      isEnabled: () => true,
    },
  ...
  return {
    ...
    config: {
      ...
      resolveAccount: () => ({
        name: "Primary",
        enabled: true,
        token: "token-value", // pragma: allowlist secret (fixture token)
      }),
      isConfigured: () => true,
      isEnabled: () => true,
    },
