...
export async function updateConfig(
  mutator: (cfg: DNAConfig) => DNAConfig,
): Promise<DNAConfig> {
...
export function resolveModelTarget(params: { raw: string; cfg: DNAConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: DNAConfig): Set<string> {
