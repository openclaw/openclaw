...
export function scanLegacyToolsBySenderKeys(cfg: MullusiConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: MullusiConfig): {
