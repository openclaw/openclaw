...
function collectExecSafeBinScopes(cfg: MullusiConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: MullusiConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: MullusiConfig): {
