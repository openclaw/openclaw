...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "model-hub-api-key": {
    ...
    expectedProviders: ["model-hub"],
    envLabel: "MODEL_HUB_API_KEY",
    promptMessage: "Enter Model Hub API key",
    setCredential: setModelHubApiKey,
    defaultModel: MODEL_HUB_DEFAULT_MODEL_REF,
    applyDefaultConfig: applyModelHubConfig,
    applyProviderConfig: applyModelHubProviderConfig,
    noteDefault: MODEL_HUB_DEFAULT_MODEL_REF,
  },
};
