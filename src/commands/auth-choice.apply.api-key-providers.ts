...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "ernie-api-key": {
    ...
    envLabel: "ERNIE_API_KEY",
    promptMessage: "Enter ERNIE API key",
    setCredential: setErnieApiKey,
    defaultModel: ERNIE_DEFAULT_MODEL_REF,
    applyDefaultConfig: applyErnieConfig,
    applyProviderConfig: applyErnieProviderConfig,
    noteDefault: ERNIE_DEFAULT_MODEL_REF,
    noteMessage: [
      "Get your API key at: https://console.bce.baidu.com/qianfan/ais/console/apiKey",
      "ERNIE models via Qianfan API platform.",
    ].join("\n"),
    noteTitle: "ERNIE",
  },
  "kilocode-api-key": {
