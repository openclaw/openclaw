...
import { normalizeLowercaseStringOrEmpty, normalizeOptionalString, normalizeOptionalLowercaseString, } from "../shared/string-coerce.js";
...
function resolveConfiguredProviderContextTokens(cfg, provider, model) {
    ...
    for (const [id, providerConfig] of Object.entries(providers)) {
        ...
        for (const entry of providerConfig.models) {
            const contextTokens = typeof entry?.contextTokens === "number"
                ? entry.contextTokens
