...
type PromptDefaultModelResult = { model?: string; config?: SmartAgentNeoConfig };
...
function resolveConfiguredModelRaw(cfg: SmartAgentNeoConfig): string {
...
function resolveConfiguredModelKeys(cfg: SmartAgentNeoConfig): string[] {
...
export function applyPrimaryModel(cfg: SmartAgentNeoConfig, model: string): SmartAgentNeoConfig {
...
export function applyModelAllowlist(cfg: SmartAgentNeoConfig, models: string[]): SmartAgentNeoConfig {
  const defaults = cfg.agents?.defaults;
