...
function resolveConfiguredModelRaw(cfg: EasyHubConfig): string {
...
function resolveConfiguredModelKeys(cfg: EasyHubConfig): string[] {
...
export function applyPrimaryModel(cfg: EasyHubConfig, model: string): EasyHubConfig {
...
export function applyModelAllowlist(cfg: EasyHubConfig, models: string[]): EasyHubConfig {
  const defaults = cfg.agents?.defaults;
