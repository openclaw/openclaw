...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "EasyHub-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<EasyHubConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<EasyHubConfig["telegram"]>>,
