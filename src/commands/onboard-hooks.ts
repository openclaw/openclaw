...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.EasyHub.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("EasyHub hooks list")}`,
      `  ${formatCliCommand("EasyHub hooks enable <name>")}`,
      `  ${formatCliCommand("EasyHub hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
