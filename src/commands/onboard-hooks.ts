...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.mullusi.com/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("mullusi hooks list")}`,
      `  ${formatCliCommand("mullusi hooks enable <name>")}`,
      `  ${formatCliCommand("mullusi hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
