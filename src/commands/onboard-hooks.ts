...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.evox.sh/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("evox hooks list")}`,
      `  ${formatCliCommand("evox hooks enable <name>")}`,
      `  ${formatCliCommand("evox hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
