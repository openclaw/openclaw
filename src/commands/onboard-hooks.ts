...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.activi.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("activi hooks list")}`,
      `  ${formatCliCommand("activi hooks enable <name>")}`,
      `  ${formatCliCommand("activi hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
