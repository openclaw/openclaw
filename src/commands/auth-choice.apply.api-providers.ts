...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "opencode-zen": {
    ...
    envLabel: "OPENCODE_API_KEY (or OPENCODE_ZEN_API_KEY)",
  ...
  "opencode-go": {
    ...
    noteMessage: [
      "OpenCode Go is the $10/month OpenCode subscription for open coding models.",
      "It uses the same OpenCode API key as Zen.",
      "Current models: GLM-5, Kimi K2.5, MiniMax M2.5.",
      "Manage your subscription at: https://opencode.ai/auth",
    ].join("\n"),
