...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "sarvam-api-key": {
    ...
    envLabel: "SARVAM_API_KEY",
    promptMessage: "Enter Sarvam AI API key",
    setCredential: setSarvamApiKey,
    defaultModel: SARVAM_DEFAULT_MODEL_REF,
    applyDefaultConfig: applySarvamConfig,
    applyProviderConfig: applySarvamProviderConfig,
    noteDefault: SARVAM_DEFAULT_MODEL_REF,
    noteMessage: [
      "Sarvam AI provides state-of-the-art multilingual language models optimized for Indian languages.",
      "Get your API key at: https://www.sarvam.ai",
      "Both sarvam-30b and sarvam-105b models are available with Apache 2.0 license.",
    ].join("\n"),
    noteTitle: "Sarvam AI",
  },
  "opencode-zen": {
