...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "upstage-api-key": {
    ...
    expectedProviders: ["upstage"],
    envLabel: "UPSTAGE_API_KEY",
    promptMessage: "Enter Upstage API key",
    setCredential: setUpstageApiKey,
    ...
    noteMessage: "Get your API key at: https://console.upstage.ai",
    noteTitle: "Upstage Solar",
  },
  "mistral-api-key": {
    provider: "mistral",
