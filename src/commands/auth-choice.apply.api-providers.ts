...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "sambanova-api-key": {
    ...
    expectedProviders: ["sambanova"],
    envLabel: "SAMBANOVA_API_KEY",
    promptMessage: "Enter Sambanova API key",
    setCredential: setSambanovaApiKey,
    ...
    noteMessage: [
      "Sambanova provides access to leading open-source models including Llama, DeepSeek, Qwen, and more.",
