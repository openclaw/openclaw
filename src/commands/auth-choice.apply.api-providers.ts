...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "qiniu-api-key": {
    ...
    expectedProviders: ["qiniu"],
    envLabel: "QINIU_API_KEY",
    promptMessage: "Enter Qiniu Cloud API key",
    setCredential: setQiniuApiKey,
    defaultModel: QINIU_DEFAULT_MODEL_REF,
    applyDefaultConfig: applyQiniuConfig,
    applyProviderConfig: applyQiniuProviderConfig,
    noteDefault: QINIU_DEFAULT_MODEL_REF,
    noteMessage: [
      "Qiniu Cloud provides 100+ models via a single API key.",
      "Get your API key at: https://www.qiniu.com/ai",
    ].join("\n"),
    noteTitle: "Qiniu Cloud",
  },
  "xiaomi-api-key": {
    provider: "xiaomi",
