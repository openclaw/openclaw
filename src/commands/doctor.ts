...
export async function doctorCommand(
  ...
  // Enable lenient SecretRef handling during doctor execution
  const originalEnvValue = process.env.OPENCLAW_ALLOW_EXEC_SECRETREF_FAILURES;
  ...
  try {
    ...
    if (originalEnvValue === undefined) {
      delete process.env.OPENCLAW_ALLOW_EXEC_SECRETREF_FAILURES;
    } else {
      process.env.OPENCLAW_ALLOW_EXEC_SECRETREF_FAILURES = originalEnvValue;
    }
  }
}
