...
export function applyVercelAiGatewayProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyVercelAiGatewayConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
