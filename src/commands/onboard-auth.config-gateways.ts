...
export function applyVercelAiGatewayProviderConfig(cfg: ActiviConfig): ActiviConfig {
...
export function applyVercelAiGatewayConfig(cfg: ActiviConfig): ActiviConfig {
