...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("mullusi tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("mullusi tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: MullusiConfig) {
