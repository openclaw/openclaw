...
export async function statusCommand(
  ...
  runtime.log(theme.heading("EasyHub status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("EasyHub security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("EasyHub security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.EasyHub.ai/faq");
  runtime.log("Troubleshooting: https://docs.EasyHub.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("EasyHub status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("EasyHub logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("EasyHub status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("EasyHub gateway probe")}`);
  }
}
