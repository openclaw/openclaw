...
export async function statusCommand(
  ...
  runtime.log(theme.heading("SmartAgentNeo status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("smart-agent-neo security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("smart-agent-neo security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.smart-agent-neo.ai/faq");
  runtime.log("Troubleshooting: https://docs.smart-agent-neo.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("smart-agent-neo status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("smart-agent-neo logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("smart-agent-neo status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("smart-agent-neo gateway probe")}`);
  }
}
