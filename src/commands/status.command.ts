...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Activi status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("activi security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("activi security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.activi.ai/faq");
  runtime.log("Troubleshooting: https://docs.activi.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("activi status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("activi logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("activi status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("activi gateway probe")}`);
  }
}
