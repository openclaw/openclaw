...
export const SEARCH_PROVIDER_OPTIONS: readonly SearchProviderEntry[] = [
  {
    ...
    placeholder: "pplx-...", // pragma: allowlist secret (placeholder)
  ...
  },
  {
    ...
    placeholder: "BSA...", // pragma: allowlist secret (placeholder)
  ...
  },
  {
    ...
    placeholder: "AIza...", // pragma: allowlist secret (placeholder)
  ...
  },
  {
    ...
    envKeys: ["XAI_API_KEY"],
    placeholder: "xai-...", // pragma: allowlist secret (placeholder)
  ...
  },
  {
    ...
    placeholder: "sk-...", // pragma: allowlist secret (placeholder)
