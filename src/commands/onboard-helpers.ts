...
export function summarizeExistingConfig(config: SmartAgentNeoConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.smart-agent-neo.ai/gateway/remote",
    "https://docs.smart-agent-neo.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
