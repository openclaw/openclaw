...
async function promptWebToolsConfig(
  ...
  note(
    [
      ...
      "By default it uses Brave Search, but you can also choose other providers (Perplexity, Grok, Gemini, Kimi) or rely on providers that bundle their own browsing.",
      "If you stick with Brave Search, it requires a Brave Search API key (you can store it in the config or set BRAVE_API_KEY in the Gateway environment).",
  ...
  const enableSearch = guardCancel(
    await confirm({
      message: "Enable web_search (Brave Search or another provider)?",
