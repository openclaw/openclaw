...
import { loadPluginInstallRecords, recordPluginInstallInRecords, withoutPluginInstallRecords, writePersistedPluginInstallLedger, } from "../plugins/install-ledger-store.js";
...
async function promptInstallChoice(params) {
    ...
    const initialValue = params.defaultChoice === "local" && !params.localPath
        ? npmSpec
            ? "npm"
            : "skip"
...
export async function ensureOnboardingPluginInstalled(params) {
    ...
    const localPath = bundledLocalPath ??
        resolveLocalPath({
            entry,
            workspaceDir,
            allowLocal,
