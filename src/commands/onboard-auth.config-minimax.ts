...
export function applyMinimaxProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyMinimaxConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
