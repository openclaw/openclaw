...
import { loadSmartAgentNeoPlugins } from "../../plugins/loader.js";
...
function addPluginLoadPath(cfg: SmartAgentNeoConfig, pluginPath: string): SmartAgentNeoConfig {
