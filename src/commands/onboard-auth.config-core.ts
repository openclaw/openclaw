...
export function applyOpenrouterProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyMoonshotConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyQianfanProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
