...
export function applyZaiConfig(cfg: DNAConfig): DNAConfig {
...
export function applyOpenrouterProviderConfig(cfg: DNAConfig): DNAConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: DNAConfig): DNAConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: DNAConfig): DNAConfig {
...
export function applyOpenrouterConfig(cfg: DNAConfig): DNAConfig {
...
export function applyMoonshotProviderConfig(cfg: DNAConfig): DNAConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: DNAConfig): DNAConfig {
...
export function applyKimiCodeProviderConfig(cfg: DNAConfig): DNAConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: DNAConfig): DNAConfig {
...
export function applySyntheticProviderConfig(cfg: DNAConfig): DNAConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: DNAConfig): DNAConfig {
...
export function applyXiaomiProviderConfig(cfg: DNAConfig): DNAConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: DNAConfig): DNAConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: DNAConfig): DNAConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: DNAConfig): DNAConfig {
