...
export function applyZaiConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyOpenrouterProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyOpenrouterConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyMoonshotProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyMoonshotConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyMoonshotConfigCn(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyKimiCodeProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applySyntheticProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyXiaomiProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: EasyHubConfig): EasyHubConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyXaiProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyQianfanProviderConfig(cfg: EasyHubConfig): EasyHubConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: EasyHubConfig): EasyHubConfig {
