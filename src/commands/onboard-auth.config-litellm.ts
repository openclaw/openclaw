...
export function applyLitellmProviderConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyLitellmConfig(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
