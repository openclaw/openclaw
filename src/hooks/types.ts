...
export type SmartAgentNeoHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "smart-agent-neo-bundled" | "smart-agent-neo-managed" | "smart-agent-neo-workspace" | "smart-agent-neo-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: SmartAgentNeoHookMetadata;
