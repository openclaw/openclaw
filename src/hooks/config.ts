...
import type { DNAConfig, HookConfig } from "../config/config.js";
...
export function resolveConfigPath(config: DNAConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: DNAConfig | undefined, pathStr: string): boolean {
...
export function shouldIncludeHook(params: {
  ...
  const pluginManaged = entry.hook.source === "dna-plugin";
