...
import type { EasyHubPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: EasyHubPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: EasyHubPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
      source: "EasyHub-plugin",
      pluginId: api.id,
    },
    metadata: {
      ...entry.metadata,
