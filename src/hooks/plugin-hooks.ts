...
import type { SmartAgentNeoPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: SmartAgentNeoPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: SmartAgentNeoPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
      source: "smart-agent-neo-plugin",
      pluginId: api.id,
    },
    metadata: {
      ...entry.metadata,
