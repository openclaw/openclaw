---
name: session-memory
description: "Save session context to memory when /new, /reset, or session delete is issued"
...
metadata:
  {
    "openclaw":
      {
        "emoji": "💾",
        "events": ["command:new", "command:reset", "command:delete"],
...
Automatically saves session context to your workspace memory when you issue `/new`, `/reset`, or delete a session.

## What It Does

When you run `/new`, `/reset`, or delete a session:
