...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.DNA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: DNAConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: DNAConfig): string {
...
function mergeTelegramAccountConfig(cfg: DNAConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: DNAConfig): ResolvedTelegramAccount[] {
