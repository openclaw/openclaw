...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ACTIVI_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ActiviConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ActiviConfig): string {
...
function mergeTelegramAccountConfig(cfg: ActiviConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ActiviConfig): ResolvedTelegramAccount[] {
