...
export const TUI_ENGLISH_CATALOG = {
  ...
  "tui.status.relative.justNow": "just now",
  "tui.status.relative.minutesAgo": "{count}m ago",
  "tui.status.relative.hoursAgo": "{count}h ago",
  "tui.status.relative.daysAgo": "{count}d ago",
