import { Input, isKeyRelease, matchesKey, truncateToWidth, } from "@mariozechner/pi-tui";
...
export class SearchableSelectList {
    ...
    smartFilter(query) {
        ...
        for (const item of this.items) {
            ...
            fuzzyCandidates.push({
                item,
                searchTextLower: normalizeLowercaseStringOrEmpty([rawLabel, rawDesc, searchText]
    ...
    getDescriptionLayout(width, prefixWidth) {
        ...
        const maxValueWidth = availableWidth -
