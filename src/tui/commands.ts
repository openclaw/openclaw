...
export function getSlashCommands(options: SlashCommandOptions = {}): SlashCommand[] {
  ...
  const commands: SlashCommand[] = [
    ...
    { name: "audit", description: "Show Crestodian audit log" },
    { name: "doctor", description: "Diagnose issues (Crestodian)" },
    { name: "health", description: "Check system health (Crestodian)" },
    { name: "setup", description: "Initialize OpenClaw configuration" },
