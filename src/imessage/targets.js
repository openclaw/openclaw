...
import { parseChatAllowTargetPrefixes, parseChatTargetPrefixesOrThrow, resolveServicePrefixedAllowTarget, resolveServicePrefixedTarget, } from "./target-parsing-helpers.js";
...
export function parseIMessageTarget(raw) {
    ...
    const servicePrefixed = resolveServicePrefixedTarget({
        ...
        isChatTarget: (remainderLower) => CHAT_ID_PREFIXES.some((p) => remainderLower.startsWith(p)) ||
