...
function runDatabaseVerifyWorker(
...
/** Run the packaged worker boundary once. */
export function runOpenClawDatabaseVerificationWorker(
  targets: readonly OpenClawDatabaseVerifyTarget[],
): Promise<OpenClawDatabaseVerifyResult[]> {
  return runDatabaseVerifyWorker(targets);
}
