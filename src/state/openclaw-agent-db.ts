 ...
 */
// v11 = agent-scoped runtime leases, durable delivery operations, canonical external
// conversation addresses, bounded heartbeat outcomes, and session-owned ACP stream events.
