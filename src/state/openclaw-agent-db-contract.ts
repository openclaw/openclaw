...
// v20 adds live local session projection state (mirror checkpoints, team inputs) and
// makes `localSource` rows execution-fenced: older readers must refuse rather than run them.
