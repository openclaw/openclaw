...
// v18 fences workers that ignore physical attempt resource custody.
// v17 prevents older supervised workers from ignoring accepted workflow contracts.
...
export type OpenClawStateDatabaseSchemaMigration = {
  kind:
    ...
    | "supervised-workflow-custody-v17"
    | "supervised-attempt-custody-v18"
