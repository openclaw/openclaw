...
export function resolveTtsConfig(cfg: SmartAgentNeoConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.SMART_AGENT_NEO_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: SmartAgentNeoConfig): string | undefined {
