...
export function resolveTtsConfig(cfg: DNAConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.DNA_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: DNAConfig): string | undefined {
