...
function resolveSpeechProviderPluginEntries(cfg?: MullusiConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: MullusiConfig): SpeechProviderPlugin[] {
