...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.ACTIVI_TTS_PREFS;
      process.env.ACTIVI_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.ACTIVI_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: ActiviConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
