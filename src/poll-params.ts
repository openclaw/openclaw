...
export type PollCreationParamKind =
	| "string"
	| "stringArray"
	| "number"
	| "boolean";
...
export type SharedPollCreationParamName =
	keyof typeof SHARED_POLL_CREATION_PARAM_DEFS;
export type TelegramPollCreationParamName =
	keyof typeof TELEGRAM_POLL_CREATION_PARAM_DEFS;
...
export function hasPollCreationParams(
	params: Record<string, unknown>,
): boolean {
