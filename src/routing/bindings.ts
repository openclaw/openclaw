...
export function listBindings(cfg: EasyHubConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: EasyHubConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: EasyHubConfig) {
