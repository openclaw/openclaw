...
export function listBindings(cfg: ActiviConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: ActiviConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ActiviConfig) {
