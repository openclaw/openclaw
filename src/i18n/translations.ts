...
export const translations: Translations = {
  en: {
    ...
    "error.cron.jobRunning": "Cron job is currently running, stop it first or use cron disable",
  ...
  "zh-CN": {
    ...
    "error.cron.jobRunning": "定时任务正在运行，请先停止或使用 cron disable",
  ...
  "zh-TW": {
    ...
    "error.cron.jobRunning": "定時任務正在運行，請先停止或使用 cron disable",
  ...
  ja: {
    ...
    "error.cron.jobRunning": "Cronジョブは現在実行中です。先に停止するか、cron disable を使用してください",
  ...
  ko: {
    ...
    "error.cron.jobRunning": "Cron 작업이 현재 실행 중입니다. 먼저 중지하거나 cron disable을 사용하세요",
  ...
  es: {
    ...
    "error.cron.jobRunning":
      "El trabajo cron se está ejecutando, deténgalo primero o use cron disable",
  ...
  fr: {
    ...
    "error.cron.jobRunning":
      "La tâche cron est en cours d'exécution, arrêtez-la d'abord ou utilisez cron disable",
  ...
  de: {
    ...
    "error.cron.jobRunning": "Cron-Job läuft gerade, stoppen Sie ihn zuerst oder verwenden Sie cron disable",
