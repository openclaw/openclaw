// Narrow plugin-sdk surface for the bundled roam plugin.
// Keep this list additive and scoped to symbols used under extensions/roam.
...
// Webhook ingress helpers for shared gateway HTTP server
export {
