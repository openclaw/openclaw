...
const shouldWarnCompatImport =
  ...
  process.env.MULLUSI_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "mullusi/plugin-sdk/compat is deprecated for new plugins. Migrate to focused mullusi/plugin-sdk/<subpath> imports. See https://docs.mullusi.com/plugins/sdk-migration",
    {
      code: "MULLUSI_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.mullusi.com/plugins/sdk-migration",
    },
  );
}
