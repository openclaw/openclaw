...
export async function createWorkerRuntimeEnvironment(sessionId: string) {
  ...
  // Portable Linux/macOS workers have no native PTY; their local commands need owners
  // that survive worker loss. Native PTY and external backends retain their own cleanup.
