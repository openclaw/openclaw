...
=======
>>>>>>> 1d821b964b (Agents: restore config contract build fixes)
  ...
  subagents?: {
    ...
    /** Gateway timeout in ms for startup/launch control-plane calls (default: 10000). */
    startupWaitTimeoutMs?: number;
    /** Gateway timeout in ms for sub-agent control-plane calls (default: 10000). */
    controlTimeoutMs?: number;
    /** Gateway timeout in ms for sub-agent completion delivery calls (default: 90000). */
