...
export type AgentDefaultsConfig = {
  ...
  heartbeat?: {
    ...
    accountId?: string;
    /** Override the heartbeat prompt body (default: "Read HEARTBEAT.md if it exists (workspace context). Follow it strictly. Stay in your configured persona (SOUL.md/IDENTITY.md from your Project Context) when replying. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK."). */
    prompt?: string;
