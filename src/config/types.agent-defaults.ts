...
export type AgentDefaultsConfig = {
  ...
  embeddedPi?: {
     ...
     * - strict-agentic: keep acting until hitting a real blocker (auto-activates for GPT-5-family
     *   on OpenAI/OpenAI Codex; honored for any provider when explicitly set)
     */
