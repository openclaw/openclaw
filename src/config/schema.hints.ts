...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.remote.codexSshTarget": "openclaw-studio",
  ...
  "gateway.tailscale.binaryPath": "/opt/homebrew/bin/tailscale",
  "gateway.tailscale.socketPath": "/var/run/tailscaled.socket",
