...
export function isDangerousNameMatchingEnabled(config) {
    return config?.dangerouslyAllowNameMatching === true;
}
export function resolveDangerousNameMatchingEnabled(input) {
...
export function collectProviderDangerousNameMatchingScopes(cfg, provider) {
    const scopes = [];
    ...
    for (const key of Object.keys(accounts)) {
        ...
        scopes.push({
            ...
            dangerousFlagPath: accountDangerousNameMatching == null
