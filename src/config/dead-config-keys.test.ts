...
describe("dead config keys", () => {
  ...
  it.each([
    ...
    ["WhatsApp message prefix", { channels: { whatsapp: { messagePrefix: "x" } } }, "channels.whatsapp", "messagePrefix"],
    ["WhatsApp ack block", { channels: { whatsapp: { ackReaction: { emoji: "x" } } } }, "channels.whatsapp", "ackReaction"],
    ["Discord subagent progress", { channels: { discord: { subagentProgress: true } } }, "channels.discord", "subagentProgress"],
    ["iMessage coalesce", { channels: { imessage: { coalesceSameSenderDms: true } } }, "channels.imessage", "coalesceSameSenderDms"],
