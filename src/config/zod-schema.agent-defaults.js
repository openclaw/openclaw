...
import { HeartbeatSchema, AgentSandboxSchema, AgentContextLimitsSchema, AgentEmbeddedHarnessSchema, AgentModelSchema, MemorySearchSchema, } from "./zod-schema.agent-runtime.js";
import { BlockStreamingChunkSchema, BlockStreamingCoalesceSchema, CliBackendSchema, HumanDelaySchema, TypingModeSchema, } from "./zod-schema.core.js";
...
export const AgentDefaultsSchema = z
    ...
    llm: z
        ...
        idleTimeoutSeconds: z
            ...
            .nonnegative()
            .optional()
            .describe(`Idle timeout for LLM streaming responses in seconds. If no token is received within this time, the request is aborted. Set to 0 to disable. Default: ${DEFAULT_LLM_IDLE_TIMEOUT_SECONDS} seconds.`),
    })
        .strict()
        .optional(),
    compaction: z
