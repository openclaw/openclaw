...
describe('Config I/O Async Race-Guard', () => {
  ...
  it('should pass when the file has not been mutated', async () => {
    ...
    await expect(assertBaseSnapshotStillCurrent(snapshot, testConfigPath, createMockFs())).resolves.not.toThrow();
  ...
  it('should throw ConfigMutationConflictError when the file is mutated concurrently', async () => {
    ...
    await expect(assertBaseSnapshotStillCurrent(snapshot, testConfigPath, createMockFs()))
