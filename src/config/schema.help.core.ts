...
export const CORE_FIELD_HELP: Record<string, string> = {
  ...
  "gateway.roles.definitions.*.sessions.others":
    'Access to other people\'s sessions: "none" hides them, "view" allows reading, "suggest" permits the suggestion flow, and "write" permits participation. Explicit session membership can grant additional access at "view" and above; "none" hides sessions from non-owners regardless of membership.',
