...
import { SmartAgentNeoSchema } from "./zod-schema.js";
...
describe("mapSensitivePaths", () => {
  ...
  it("main schema yields correct hints (samples)", () => {
    const schema = SmartAgentNeoSchema.toJSONSchema({
      target: "draft-07",
      unrepresentable: "any",
    });
    schema.title = "SmartAgentNeoConfig";
    const hints = mapSensitivePaths(SmartAgentNeoSchema, "", {});
