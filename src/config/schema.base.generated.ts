...
export const GENERATED_BASE_CONFIG_SCHEMA = {
  ...
  uiHints: {
    ...
    "tools.qveris.enabled": {
      label: "Enable QVeris Tools",
      help: "Enable QVeris dynamic tool search and execution across domains like finance and research.",
      tags: ["tools"],
    },
    "tools.qveris.apiKey": {
      label: "QVeris API Key",
      help: "QVeris API key (fallback: QVERIS_API_KEY env var). Required for QVeris tools and web_search via QVeris.",
      tags: ["security", "auth", "tools"],
    },
    "tools.qveris.region": {
      label: "QVeris Region",
      help: 'QVeris region: "global" (qveris.ai, default) or "cn" (qveris.cn). Determines API endpoint and allowed OSS domains.',
      tags: ["tools"],
    },
    "tools.qveris.baseUrl": {
      label: "QVeris API Base URL",
      help: "QVeris API base URL (overrides region-derived URL when set).",
      tags: ["tools"],
    },
    "tools.qveris.timeoutSeconds": {
      label: "QVeris Timeout (sec, deprecated)",
      help: "Deprecated: use searchTimeoutSeconds / executeTimeoutSeconds instead. Fallback timeout in seconds for QVeris tool requests.",
      tags: ["performance", "tools"],
    },
    "tools.qveris.searchTimeoutSeconds": {
      label: "QVeris Search Timeout (sec)",
      help: "Timeout in seconds for qveris_discover requests (default: 5). Discovery is a lightweight index lookup.",
      tags: ["performance", "tools"],
    },
    "tools.qveris.executeTimeoutSeconds": {
      label: "QVeris Execute Timeout (sec)",
      help: "Timeout in seconds for qveris_call requests (default: 60). Long-running tools (image/video generation) may need 60-120s.",
      tags: ["performance", "tools"],
    },
    "tools.qveris.maxResponseSize": {
      label: "QVeris Max Response Size",
      help: "Max response size in bytes for QVeris tool calls.",
      tags: ["performance", "tools"],
    },
    "tools.qveris.searchLimit": {
      label: "QVeris Search Limit",
      help: "Max number of tools to search when using QVeris.",
      tags: ["performance", "tools"],
    },
    ...
    "session.transcriptRetentionDays": {
      label: "Session Transcript Retention (days)",
      help: "Limits loaded context to messages from the most recent N days before each run (default: 7). Use this to keep long-lived sessions fresh without forcing full session resets.",
      tags: ["storage"],
    },
    "session.maxRecentTurns": {
      label: "Session Max Recent Turns",
      help: "Caps loaded context to the most recent N user turns when channel-specific history limits are unset (default: 100). Combine with transcriptRetentionDays to bound prompt size while preserving recent continuity.",
      tags: ["performance", "storage"],
    },
