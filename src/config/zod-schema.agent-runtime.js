...
import { GroupChatSchema, HumanDelaySchema, IdentitySchema, SecretInputSchema, ToolsLinksSchema, ToolsMediaSchema, } from "./zod-schema.core.js";
...
export const SandboxDockerSchema = z
    ...
    if (blockedNetworkReason === "container_namespace_join") {
        ctx.addIssue({
            code: z.ZodIssueCode.custom,
            path: ["network"],
            message: 'Sandbox security: network mode "container:*" is blocked by default. ' +
...
export const AgentSandboxSchema = z
    ...
    if (blockedBrowserNetworkReason === "container_namespace_join") {
        ctx.addIssue({
            ...
            message: 'Sandbox security: browser network mode "container:*" is blocked by default. ' +
