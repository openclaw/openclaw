...
import { normalizeLowercaseStringOrEmpty, normalizeStringifiedOptionalString, } from "../shared/string-coerce.js";
import { SilentReplyPolicyConfigSchema, SilentReplyRewriteConfigSchema, } from "./zod-schema.agent-defaults.js";
...
const McpServerSchema = z
    ...
    headers: z
        .record(z.string(), z.union([z.string().register(sensitive), z.number(), z.boolean()]).register(sensitive))
        .optional(),
})
    .catchall(z.unknown());
...
export const OpenClawSchema = z
    ...
    browser: z
        ...
        profiles: z
            ...
            .strict()
            .refine((value) => value.driver === "existing-session" || value.cdpPort || value.cdpUrl, {
    ...
    gateway: z
        ...
        if (gateway.channelStaleEventThresholdMinutes != null &&
