...
const FIELD_LABELS: Record<string, string> = {
  ...
  "nodeHost.browserProxy.allowedProfiles": "Node Browser Proxy Allowed Profiles",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "limits.enabled": "Enable rate limiting and budget controls for external API calls (default: true).",
  ...
  "limits.budgets.warningThresholds": "Usage percentages at which to emit warnings (e.g. [0.8, 0.9, 1.0]).",
  "limits.budgets.hardBlock": "Whether to reject requests when the budget is exceeded (default: false).",
