...
export type ChannelStreamingProgressConfig = {
  ...
  /** Include assistant commentary/preamble text in the progress draft. Default: true. */
  commentary?: boolean;
  /** Include a compact rolling thinking line in the progress draft. Default: true. */
  thinking?: boolean;
};
