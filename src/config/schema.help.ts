...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.apiKey":
    "Deprecated: Brave Search API key alias. Prefer tools.web.search.brave.apiKey.",
  "tools.web.search.brave.apiKey": "Brave Search API key (fallback: BRAVE_API_KEY env var).",
