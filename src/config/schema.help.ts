...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "firecrawl", "gemini", "grok", "kimi", "perplexity", or "playwright-mcp"). Auto-detected from available API keys if omitted; playwright-mcp must be configured explicitly.',
