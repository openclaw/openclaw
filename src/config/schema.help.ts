...
export const FIELD_HELP: Record<string, string> = {
  ...
  "messages.statusReactions":
    "Lifecycle status reactions that update the emoji on the trigger message as the agent progresses (queued/listening → thinking → tool → done/error).",
  ...
  "messages.statusReactions.emojis":
    "Override default status reaction emojis. Keys: listening, thinking, tool, coding, web, done, error, stallSoft, stallHard. Must be valid Telegram reaction emojis.",
