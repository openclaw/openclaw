...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.apiKey":
    "Legacy Brave Search API key alias. Prefer tools.web.search.brave.apiKey (fallback: BRAVE_API_KEY env var).",
  "tools.web.search.brave.apiKey":
    "Brave Search API key (canonical path, fallback: BRAVE_API_KEY env var).",
