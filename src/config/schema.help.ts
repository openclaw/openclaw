...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "gemini", "grok", "kimi", "perplexity" or "querit"). Auto-detected from available API keys if omitted.',
  ...
  "tools.web.search.querit.apiKey": "Querit Search API key (fallback: QUERIT_API_KEY env var).", // pragma: allowlist secret
