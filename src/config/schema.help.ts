...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "perplexity", "grok", "gemini", "kimi", or "openrouter"). Auto-detected from available API keys if omitted.',
  ...
  "tools.web.search.openrouter.apiKey":
    "OpenRouter API key (fallback: OPENROUTER_API_KEY env var).",
  "tools.web.search.openrouter.baseUrl":
    'OpenRouter base URL override (default: "https://openrouter.ai/api/v1").',
  "tools.web.search.openrouter.model":
    'OpenRouter model override (default: "perplexity/sonar-pro").',
