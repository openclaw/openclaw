...
export const FIELD_HELP: Record<string, string> = {
  ...
  "approvals.plugin.language":
    'Prompt language for plugin approvals: "original" preserves the raw approval format, "simple" shows only the plain-English approval prompt, and "simple-technical" adds raw technical details below the plain summary. Default: "original".',
