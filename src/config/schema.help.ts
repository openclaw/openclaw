...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider. Built-in: "brave", "perplexity", "grok", "gemini", "kimi". Plugins can register additional providers (e.g. "serpapi"). Auto-detected from available API keys if omitted.',
