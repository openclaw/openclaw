...
export const FIELD_HELP: Record<string, string> = {
  ...
  "messages.pairingTemplate":
    "Template sent to new pairing requesters. Supports the case-sensitive variables {channel}, {senderIdLine}, {code}, and {approveCommand}; unknown variables remain unchanged.",
