...
export const FIELD_HELP: Record<string, string> = {
  ...
  "channels.discord.eventQueue.listenerTimeout":
    "Canonical Discord listener timeout control in ms for gateway event handlers. Default is 120000 in Bot; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
