...
export const FIELD_HELP: Record<string, string> = {
  ...
  "talk.idleTimeoutS":
    "Seconds of no Talk interaction before the active Talk mode session deactivates and returns to wake-word waiting. Leave unset to disable idle auto-deactivation.",
