...
export const FIELD_HELP: Record<string, string> = {
  ...
  "diagnostics.otel.protocol":
    'OTel transport protocol for telemetry export: "http/protobuf". gRPC transport is not yet implemented support. Use the protocol your observability backend expects to avoid dropped telemetry payloads.',
