...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.queryInstructionTemplate":
    "Set to true to use model-specific retrieval query instruction templates for OpenAI and OpenAI-compatible embedding models such as Qwen3, Nomic, and Mixedbread. Document/index embeddings stay raw.",
