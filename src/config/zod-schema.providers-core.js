...
import { BlockStreamingChunkSchema, BlockStreamingCoalesceSchema, ContextVisibilityModeSchema, DmConfigSchema, DmPolicySchema, ExecutableTokenSchema, GroupPolicySchema, HexColorSchema, MarkdownConfigSchema, MSTeamsReplyStyleSchema, ProviderCommandsSchema, SecretRefSchema, SecretInputSchema, ReplyToModeSchema, RetryConfigSchema, TtsConfigSchema, requireAllowlistAllowFrom, requireOpenAllowFrom, } from "./zod-schema.core.js";
import { validateSlackSigningSecretRequirements, validateTelegramWebhookSecretRequirements, } from "./zod-schema.secret-input-validation.js";
    ...
    if (typeof value === "number") {
        if (!Number.isSafeInteger(value) || value < 0) {
            ctx.addIssue({
                ...
                message: `Discord ID "${String(value)}" is not a valid non-negative safe integer. ` +
...
export const DiscordAccountSchema = z
    ...
    if (typeof autoPresenceInterval === "number" &&
