...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "mullusi.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.mullusi/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/mullusi"). */
  basePath?: string;
...
export type GatewayConfig = {
  /** Single multiplexed port for Gateway WS + HTTP (default: 18790). */
  port?: number;
  /**
