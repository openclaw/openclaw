...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "smart-agent-neo.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.smart-agent-neo/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/smart-agent-neo"). */
  basePath?: string;
 ...
 * Used when Neobot runs behind an identity-aware proxy (Pomerium, Caddy + OAuth, etc.)
