...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): MullusiConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: MullusiConfig, env: NodeJS.ProcessEnv) =>
