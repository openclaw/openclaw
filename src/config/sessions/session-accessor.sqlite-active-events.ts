...
import { readBoundedMessageTailPageFromProjection } from "./session-accessor.sqlite-bounded-tail.js";
import type {
...
function readBoundedMessageTailPage(
  ...
  return withCurrentProjectionSnapshot(scope, (projection) =>
    readBoundedMessageTailPageFromProjection(projection, options, visibility),
  );
}
