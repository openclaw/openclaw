...
/** Channel-level config for DingTalk Gateway. */
export type DingTalkGatewayChannelConfig = {
...
/** Group-level config for DingTalk Gateway. */
export type DingTalkGatewayGroupConfig = {
  ...
  channels?: Record<string, DingTalkGatewayChannelConfig>;
};

export type DingTalkGatewayConfig = {
  /** If false, do not start the DingTalk Gateway provider. Default: true. */
  enabled?: boolean;
  ...
  /** DingTalk user ID for this gateway instance. */
  userId: string;
  /** Kafka broker addresses (comma-separated or array). Default: "localhost:9092". */
  ...
  groups?: Record<string, DingTalkGatewayGroupConfig>;
