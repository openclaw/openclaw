...
function resolveAnthropicDefaultAuthMode(cfg: DNAConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: DNAConfig): DNAConfig {
...
export function applyTalkApiKey(config: DNAConfig): DNAConfig {
...
export function applyModelDefaults(cfg: DNAConfig): DNAConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: DNAConfig): DNAConfig {
...
export function applyLoggingDefaults(cfg: DNAConfig): DNAConfig {
...
export function applyContextPruningDefaults(cfg: DNAConfig): DNAConfig {
...
export function applyCompactionDefaults(cfg: DNAConfig): DNAConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
