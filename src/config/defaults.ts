...
function resolveAnthropicDefaultAuthMode(cfg: EasyHubConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyTalkApiKey(config: EasyHubConfig): EasyHubConfig {
...
export function applyModelDefaults(cfg: EasyHubConfig): EasyHubConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyLoggingDefaults(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyContextPruningDefaults(cfg: EasyHubConfig): EasyHubConfig {
...
export function applyCompactionDefaults(cfg: EasyHubConfig): EasyHubConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
