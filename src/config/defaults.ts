...
function resolveAnthropicDefaultAuthMode(cfg: SmartAgentNeoConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyTalkApiKey(config: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyModelDefaults(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyLoggingDefaults(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyContextPruningDefaults(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
...
export function applyCompactionDefaults(cfg: SmartAgentNeoConfig): SmartAgentNeoConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
