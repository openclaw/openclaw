...
export function applyMessageDefaults(cfg: MullusiConfig): MullusiConfig {
...
export function applyTalkApiKey(config: MullusiConfig): MullusiConfig {
...
export function applyTalkConfigNormalization(config: MullusiConfig): MullusiConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: MullusiConfig): MullusiConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MullusiConfig): MullusiConfig {
...
export function applyLoggingDefaults(cfg: MullusiConfig): MullusiConfig {
...
export function applyContextPruningDefaults(cfg: MullusiConfig): MullusiConfig {
  return (
...
export function applyCompactionDefaults(cfg: MullusiConfig): MullusiConfig {
