...
function isTelegramConfigured(cfg: EasyHubConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: EasyHubConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: EasyHubConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: EasyHubConfig): boolean {
...
function isIMessageConfigured(cfg: EasyHubConfig): boolean {
...
function isWhatsAppConfigured(cfg: EasyHubConfig): boolean {
...
function isGenericChannelConfigured(cfg: EasyHubConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: EasyHubConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: EasyHubConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: EasyHubConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: EasyHubConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: EasyHubConfig, pluginId: string): EasyHubConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
