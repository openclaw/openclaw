...
function isTelegramConfigured(cfg: ActiviConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ActiviConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: ActiviConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ActiviConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ActiviConfig): boolean {
...
function isIMessageConfigured(cfg: ActiviConfig): boolean {
...
function isWhatsAppConfigured(cfg: ActiviConfig): boolean {
...
function isGenericChannelConfigured(cfg: ActiviConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: ActiviConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: ActiviConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: ActiviConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: ActiviConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: ActiviConfig, pluginId: string): ActiviConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
