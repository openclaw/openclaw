...
function isTelegramConfigured(cfg: SmartAgentNeoConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: SmartAgentNeoConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: SmartAgentNeoConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: SmartAgentNeoConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: SmartAgentNeoConfig): boolean {
...
function isIMessageConfigured(cfg: SmartAgentNeoConfig): boolean {
...
function isWhatsAppConfigured(cfg: SmartAgentNeoConfig): boolean {
...
function isGenericChannelConfigured(cfg: SmartAgentNeoConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: SmartAgentNeoConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: SmartAgentNeoConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: SmartAgentNeoConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: SmartAgentNeoConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: SmartAgentNeoConfig, pluginId: string): SmartAgentNeoConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
