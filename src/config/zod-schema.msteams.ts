// Defines Microsoft Teams provider config schemas.
import { z } from "zod";
...
const ChannelStreamingProgressSchema = z
  .object({
    ...
    includePercent: z.boolean().optional(),
  })
  .strict();
...
export const MSTeamsChannelSchemaInternal = z
  .object({
...
export const MSTeamsTeamSchemaInternal = z
  .object({
    requireMention: z.boolean().optional(),
    tools: ToolPolicySchema,
    toolsBySender: ToolPolicyBySenderSchema,
    replyStyle: MSTeamsReplyStyleSchema.optional(),
    channels: z.record(z.string(), MSTeamsChannelSchemaInternal.optional()).optional(),
  })
  .strict();
...
const MSTeamsAccountConfigBaseSchema = z
  .object({
    ...
    replyStyle: MSTeamsReplyStyleSchema.optional(),
    teams: z.record(z.string(), MSTeamsTeamSchemaInternal.optional()).optional(),
