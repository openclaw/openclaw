...
export const FIELD_LABELS: Record<string, string> = {
  ...
  securityGuardrail: "Security Guardrail",
  "securityGuardrail.enable": "Enable Security Guardrail",
  "securityGuardrail.localBaseUrl": "Local Model API URL",
  "securityGuardrail.localApiKey": "Local Model API Key",
  "securityGuardrail.localModel": "Local Model ID",
  "securityGuardrail.customPrompt": "Custom Filtering Rules",
  "securityGuardrail.fallbackToRegexOnly": "Regex Fallback When Model Unavailable",
};
