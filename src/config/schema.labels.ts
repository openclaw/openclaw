...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.reasoningDefault": "Reasoning Default",
  "agents.defaults.surfaceDefaults": "Surface Defaults",
  "agents.defaults.surfaceDefaults.*.verboseDefault": "Surface Verbose Default",
  "agents.defaults.surfaceDefaults.*.reasoningDefault": "Surface Reasoning Default",
