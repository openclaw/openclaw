...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "hooks.queues": "Hook Queues",
  "hooks.queues.*.enabled": "Hook Queue Enabled",
  "hooks.queues.*.path": "Hook Queue Path",
  "hooks.queues.*.parallelism": "Hook Queue Parallelism",
  "hooks.queues.*.sessionTarget": "Hook Queue Session Target",
  "hooks.queues.*.sessionKey": "Hook Queue Session Key",
  "hooks.queues.*.name": "Hook Queue Run Name",
  "hooks.queues.*.agentId": "Hook Queue Agent ID",
  "hooks.queues.*.wakeMode": "Hook Queue Wake Mode",
  "hooks.queues.*.deliver": "Hook Queue Deliver Reply",
  "hooks.queues.*.allowUnsafeExternalContent": "Hook Queue Allow Unsafe External Content",
  "hooks.queues.*.channel": "Hook Queue Delivery Channel",
  "hooks.queues.*.to": "Hook Queue Delivery Destination",
  "hooks.queues.*.model": "Hook Queue Model Override",
  "hooks.queues.*.thinking": "Hook Queue Thinking Override",
  "hooks.queues.*.timeoutSeconds": "Hook Queue Timeout (sec)",
