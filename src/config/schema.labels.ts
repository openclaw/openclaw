...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.slack.threadBindings.enabled": "Slack Thread Binding Enabled",
  "channels.slack.threadBindings.idleHours": "Slack Thread Binding Idle Timeout (hours)",
  "channels.slack.threadBindings.maxAgeHours": "Slack Thread Binding Max Age (hours)",
  "channels.slack.threadBindings.spawnSubagentSessions": "Slack Thread-Bound Subagent Spawn",
  "channels.slack.threadBindings.spawnAcpSessions": "Slack Thread-Bound ACP Spawn",
