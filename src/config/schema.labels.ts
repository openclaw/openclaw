...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.connectChallengeTimeoutMs": "Gateway Connect Challenge Timeout (ms)",
  "gateway.timeoutMs": "Gateway RPC Timeout (ms)",
  "gateway.finalResponseTimeoutMs": "Gateway Final Response Timeout (ms)",
  "gateway.sessionSettleTimeoutMs": "Gateway Session Settle Timeout (ms)",
  ...
  "tools.web.fetch.firecrawl.enabled": "Enable Firecrawl Web Fetch Fallback",
  ...
  "models.bedrockDiscovery.enabled": "Enable Bedrock Model Discovery",
  ...
  "models.bedrockDiscovery.refreshInterval": "Bedrock Discovery Refresh Interval (sec)",
  ...
  "browser.ssrfPolicy.allowPrivateNetwork": "Browser Allow Private Network Alias",
  ...
  "hooks.internal.handlers[].event": "Internal Hook Handler Event",
  "hooks.internal.handlers[].module": "Internal Hook Handler Module",
  "hooks.internal.handlers[].export": "Internal Hook Handler Export",
