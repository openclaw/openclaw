...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "hooks.mappings[].signature": "Hook Mapping Sender Signature",
  "hooks.mappings[].signature.scheme": "Hook Signature Scheme",
  "hooks.mappings[].signature.secret": "Hook Signature Secret",
  "hooks.mappings[].signature.toleranceSeconds": "Hook Signature Timestamp Tolerance (sec)",
