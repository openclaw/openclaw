...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.subagents": "Subagent Defaults",
  "agents.defaults.subagents.maxConcurrent": "Subagent Max Concurrent",
  "agents.defaults.subagents.maxSpawnDepth": "Subagent Max Spawn Depth",
  "agents.defaults.subagents.maxChildrenPerAgent": "Subagent Max Children per Agent",
  "agents.defaults.subagents.archiveAfterMinutes": "Subagent Archive After (min)",
  "agents.defaults.subagents.model": "Subagent Default Model",
  "agents.defaults.subagents.thinking": "Subagent Default Thinking",
  "agents.defaults.subagents.runTimeoutSeconds": "Subagent Run Timeout (sec)",
  "agents.defaults.subagents.announceTimeoutMs": "Subagent Announce Timeout (ms)",
  "agents.list[].subagents": "Agent Subagent Settings",
  "agents.list[].subagents.allowAgents": "Agent Subagent Target Allowlist",
  "agents.list[].subagents.model": "Agent Subagent Default Model",
  "agents.list[].subagents.thinking": "Agent Subagent Default Thinking",
