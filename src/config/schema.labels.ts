...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "skills.commandDispatch.allowTools": "Skill Tool Dispatch Allowlist",
  "skills.commandDispatch.maxArgLength": "Skill Tool Dispatch Max Arg Length",
  "skills.commandDispatch.requireStructuredArgsTools": "Skill Tool Dispatch Structured-Args Tools",
