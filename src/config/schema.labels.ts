...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.openrouter.apiKey": "OpenRouter API Key",
  "tools.web.search.openrouter.baseUrl": "OpenRouter Base URL",
  "tools.web.search.openrouter.model": "OpenRouter Search Model",
