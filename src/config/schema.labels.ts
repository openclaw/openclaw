...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list.*.heartbeat.includeReasoning": "Heartbeat Include Reasoning",
  "agents.defaults.heartbeat.every": "Heartbeat Interval",
  "agents.list.*.heartbeat.every": "Heartbeat Interval",
  "agents.defaults.heartbeat.activeHours": "Heartbeat Active Hours",
  "agents.defaults.heartbeat.activeHours.start": "Heartbeat Active Hours Start",
  "agents.defaults.heartbeat.activeHours.end": "Heartbeat Active Hours End",
  "agents.defaults.heartbeat.activeHours.timezone": "Heartbeat Active Hours Timezone",
  "agents.defaults.heartbeat.model": "Heartbeat Model",
  "agents.list.*.heartbeat.model": "Heartbeat Model",
  "agents.defaults.heartbeat.session": "Heartbeat Session Key",
  "agents.list.*.heartbeat.session": "Heartbeat Session Key",
  "agents.defaults.heartbeat.to": "Heartbeat Delivery Override",
  "agents.list.*.heartbeat.to": "Heartbeat Delivery Override",
  "agents.defaults.heartbeat.accountId": "Heartbeat Account ID",
  "agents.list.*.heartbeat.accountId": "Heartbeat Account ID",
  "agents.defaults.heartbeat.prompt": "Heartbeat Prompt",
  "agents.list.*.heartbeat.prompt": "Heartbeat Prompt",
  "agents.defaults.heartbeat.ackMaxChars": "Heartbeat Ack Max Chars",
  "agents.list.*.heartbeat.ackMaxChars": "Heartbeat Ack Max Chars",
  "agents.list.*.heartbeat.activeHours": "Heartbeat Active Hours",
  "agents.list.*.heartbeat.activeHours.start": "Heartbeat Active Hours Start",
  "agents.list.*.heartbeat.activeHours.end": "Heartbeat Active Hours End",
  "agents.list.*.heartbeat.activeHours.timezone": "Heartbeat Active Hours Timezone",
  ...
  "agents.list[].heartbeat.lightContext": "Agent Heartbeat Light Context",
  "agents.list[].heartbeat.includeReasoning": "Agent Heartbeat Include Reasoning",
  "agents.list[].heartbeat.every": "Agent Heartbeat Interval",
  "agents.list[].heartbeat.activeHours": "Agent Heartbeat Active Hours",
  "agents.list[].heartbeat.activeHours.start": "Agent Heartbeat Active Hours Start",
  "agents.list[].heartbeat.activeHours.end": "Agent Heartbeat Active Hours End",
  "agents.list[].heartbeat.activeHours.timezone": "Agent Heartbeat Active Hours Timezone",
  "agents.list[].heartbeat.model": "Agent Heartbeat Model",
  "agents.list[].heartbeat.session": "Agent Heartbeat Session Key",
  "agents.list[].heartbeat.to": "Agent Heartbeat Delivery Override",
