...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "policy.statePath": "Policy State File Path",
  "policy.publicKey": "Policy Verification Public Key",
  "policy.publicKeys": "Policy Verification Key Set",
  "policy.failClosed": "Policy Fail-Closed Mode",
  "policy.strictFilePermissions": "Policy Strict File Permissions",
  "policy.enforceMonotonicSerial": "Policy Anti-Rollback Protection",
