...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list.*.compaction": "Per-Agent Compaction Overrides",
  "agents.list.*.compaction.mode": "Compaction Mode",
  "agents.list.*.compaction.reserveTokens": "Compaction Reserve Tokens",
  "agents.list.*.compaction.keepRecentTokens": "Compaction Keep Recent Tokens",
  "agents.list.*.compaction.reserveTokensFloor": "Compaction Reserve Token Floor",
  "agents.list.*.compaction.maxHistoryShare": "Compaction Max History Share",
  "agents.list.*.compaction.identifierPolicy": "Compaction Identifier Policy",
  "agents.list.*.compaction.identifierInstructions": "Compaction Identifier Instructions",
  "agents.list.*.compaction.recentTurnsPreserve": "Compaction Preserve Recent Turns",
  "agents.list.*.compaction.qualityGuard": "Compaction Quality Guard",
  "agents.list.*.compaction.qualityGuard.enabled": "Compaction Quality Guard Enabled",
  "agents.list.*.compaction.qualityGuard.maxRetries": "Compaction Quality Guard Max Retries",
  "agents.list.*.compaction.postIndexSync": "Compaction Post-Index Sync",
  "agents.list.*.compaction.postCompactionSections": "Post-Compaction Context Sections",
  "agents.list.*.compaction.timeoutSeconds": "Compaction Timeout (Seconds)",
  "agents.list.*.compaction.model": "Compaction Model Override",
  "agents.list.*.compaction.memoryFlush": "Compaction Memory Flush",
  "agents.list.*.compaction.memoryFlush.enabled": "Compaction Memory Flush Enabled",
  "agents.list.*.compaction.memoryFlush.softThresholdTokens":
    "Compaction Memory Flush Soft Threshold",
  "agents.list.*.compaction.memoryFlush.forceFlushTranscriptBytes":
    "Compaction Memory Flush Transcript Size Threshold",
  "agents.list.*.compaction.memoryFlush.prompt": "Compaction Memory Flush Prompt",
  "agents.list.*.compaction.memoryFlush.systemPrompt": "Compaction Memory Flush System Prompt",
