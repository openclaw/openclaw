...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.maintenance.contextFallbackGuard": "Context-engine Fallback Guard",
  "session.maintenance.contextFallbackGuard.sizeBytes": "Fallback Guard Size Threshold",
  "session.maintenance.contextFallbackGuard.action": "Fallback Guard Action",
  cron: "Cron",
