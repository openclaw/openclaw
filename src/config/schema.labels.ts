...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.fs.readWorkspaceOnly": "Workspace-only Read Tool",
  "tools.fs.writeWorkspaceOnly": "Workspace-only Write Tool",
  "tools.fs.editWorkspaceOnly": "Workspace-only Edit Tool",
  ...
  "tools.agentToAgent.sessionScope": "Agent-to-Agent Session Scope",
  ...
  "agents.list.*.skipBootstrap": "Skip Bootstrap",
  "agents.list[].skipBootstrap": "Skip Bootstrap",
  "agents.defaults.bootstrapMaxChars": "Bootstrap Max Chars",
  "agents.list.*.bootstrapMaxChars": "Bootstrap Max Chars",
  "agents.list[].bootstrapMaxChars": "Bootstrap Max Chars",
  "agents.defaults.bootstrapTotalMaxChars": "Bootstrap Total Max Chars",
  "agents.list.*.bootstrapTotalMaxChars": "Bootstrap Total Max Chars",
  "agents.list[].bootstrapTotalMaxChars": "Bootstrap Total Max Chars",
  "agents.defaults.bootstrapPromptTruncationWarning": "Bootstrap Prompt Truncation Warning",
  "agents.defaults.envelopeTimezone": "Envelope Timezone",
  "agents.defaults.envelopeTimestamp": "Envelope Timestamp",
  "agents.defaults.envelopeElapsed": "Envelope Elapsed",
  "agents.defaults.subagents.escalation": "Subagent Escalation Ladder",
  "agents.defaults.subagents.escalation.enabled": "Subagent Escalation Enabled",
  "agents.defaults.subagents.escalation.moderateModel": "Subagent Moderate Escalation Model",
  "agents.defaults.subagents.escalation.complexModel": "Subagent Complex Escalation Model",
  "agents.list[].subagents.escalation": "Agent Subagent Escalation Ladder",
  "agents.list[].subagents.escalation.enabled": "Agent Subagent Escalation Enabled",
  "agents.list[].subagents.escalation.moderateModel": "Agent Moderate Escalation Model",
  "agents.list[].subagents.escalation.complexModel": "Agent Complex Escalation Model",
  ...
  "agents.defaults.compaction.triggerTokens": "Compaction Trigger Tokens",
  "agents.defaults.compaction.targetTokens": "Compaction Target Tokens",
