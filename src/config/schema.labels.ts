...
export const FIELD_LABELS: Record<string, string> = {
  ...
  apps: "Agent Apps",
  "apps.enabled": "Agent Apps Enabled",
  ...
  "apps.registry.*.description": "Agent App Description",
  "apps.registry.*.whatItIs": "Agent App What It Is",
  "apps.registry.*.whenToUse": "Agent App When To Use",
  "apps.registry.*.promptRole": "Agent App Prompt Role",
  agents: "Agents",
  "agents.defaults": "Agent Defaults",
  "agents.defaults.apps": "Default Agent App Names",
  "agents.list": "Agent List",
  "agents.list[].apps": "Agent App Names",
  gateway: "Gateway",
