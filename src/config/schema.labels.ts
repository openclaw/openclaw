...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.relayRouting.targets.*.to": "Session Relay Target To",
  "session.relayRouting.targets.*.accountId": "Session Relay Target Account",
  "session.relayRouting.targets.*.threadId": "Session Relay Target Thread",
  ...
  "session.relayRouting.rules[].match.channel": "Session Relay Rule Channel",
  "session.relayRouting.rules[].match.chatType": "Session Relay Rule Chat Type",
  "session.relayRouting.rules[].match.keyPrefix": "Session Relay Rule Key Prefix",
  "session.relayRouting.rules[].match.rawKeyPrefix": "Session Relay Rule Raw Key Prefix",
