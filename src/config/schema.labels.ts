...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "skills.entries": "Skill entries (API keys, env)",
  "skills.entries.*": "Skill entry",
  "skills.entries.*.enabled": "Enabled",
  "skills.entries.*.apiKey": "API Key",
  "skills.entries.*.env": "Environment overrides",
  ...
  "channels.qq": "QQ",
  "channels.wechat-mp": "WeChat Official Account",
