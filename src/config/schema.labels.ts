...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.channelHealthCheckMinutes": "Channel Health Check Interval (min)",
  ...
  "agents.defaults.model.fallbackPolicy": "Fallback Policy",
  "agents.defaults.model.autoFallbackModels": "Auto-Fallback Models",
  ...
  "session.identityLinks": "Cross-Channel Identity Links",
  "session.idleMinutes": "Session Idle Timeout (min)",
  "session.resetByChannel": "Per-Channel Session Reset",
