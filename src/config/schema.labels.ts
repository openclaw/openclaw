...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "durable.mode": "Durable Runtime Mode",
  "durable.worker": "Durable Recovery Worker",
  "durable.worker.pollIntervalMs": "Durable Recovery Poll Interval (ms)",
  "durable.worker.claimTtlMs": "Durable Recovery Claim TTL (ms)",
