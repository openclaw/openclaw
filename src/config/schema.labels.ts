...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.experimental.goalDriver": "Autonomous Goal Driver",
  "tools.experimental.goalDriver.enabled": "Enable Autonomous Goal Driver",
  "tools.experimental.goalDriver.debounceMs": "Goal Driver Idle Debounce (ms)",
  "tools.experimental.goalDriver.jitterMs": "Goal Driver Arm Jitter (ms)",
  "tools.experimental.goalDriver.maxNoProgressContinuations": "Goal Driver No-Progress Ceiling",
  "tools.experimental.goalDriver.judge": "Goal Driver Completion Judge",
  "tools.experimental.goalDriver.judge.enabled": "Enable Goal Driver Judge",
  "tools.experimental.goalDriver.judge.modelRef": "Goal Driver Judge Model",
