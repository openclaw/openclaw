...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.prometheus.enabled": "Prometheus Enabled",
  "diagnostics.prometheus.metric_prefix": "Prometheus Metric Prefix",
  "diagnostics.prometheus.pull": "Prometheus Pull Endpoint Enabled",
  "diagnostics.prometheus.default_metrics": "Prometheus Default Metrics",
  "diagnostics.prometheus.external_labels": "Prometheus External Labels",
  "diagnostics.prometheus.remote_write": "Prometheus Remote Write Targets",
  "diagnostics.prometheus.push_interval_ms": "Prometheus Push Interval (ms)",
