...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "hooks.imap": "IMAP Hook",
  "hooks.imap.account": "IMAP Hook Account",
  "hooks.imap.folder": "IMAP Hook Folder",
  "hooks.imap.pollIntervalSeconds": "IMAP Hook Poll Interval (sec)",
  "hooks.imap.includeBody": "IMAP Hook Include Body",
  "hooks.imap.maxBytes": "IMAP Hook Max Body Bytes",
  "hooks.imap.markSeen": "IMAP Hook Mark Seen",
  "hooks.imap.hookUrl": "IMAP Hook Callback URL",
  "hooks.imap.model": "IMAP Hook Model Override",
  "hooks.imap.thinking": "IMAP Hook Thinking Override",
