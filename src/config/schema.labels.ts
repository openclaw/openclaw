...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.contextPruning": "Context Pruning",
  "agents.defaults.contextPruning.mode": "Context Pruning Mode",
  "agents.defaults.contextPruning.ttl": "Context Pruning Cache TTL",
  "agents.defaults.contextPruning.keepLastAssistants": "Context Pruning Keep Last Assistants",
  "agents.defaults.contextPruning.softTrimRatio": "Context Pruning Soft Trim Ratio",
  "agents.defaults.contextPruning.hardClearRatio": "Context Pruning Hard Clear Ratio",
  "agents.defaults.contextPruning.minPrunableToolChars": "Context Pruning Min Prunable Tool Chars",
  "agents.defaults.contextPruning.tools": "Context Pruning Tools Policy",
  "agents.defaults.contextPruning.tools.allow": "Context Pruning Tool Allowlist",
  "agents.defaults.contextPruning.tools.deny": "Context Pruning Tool Denylist",
  "agents.defaults.contextPruning.softTrim": "Context Pruning Soft Trim",
  "agents.defaults.contextPruning.softTrim.maxChars": "Context Pruning Soft Trim Max Chars",
  "agents.defaults.contextPruning.softTrim.headChars": "Context Pruning Soft Trim Head Chars",
  "agents.defaults.contextPruning.softTrim.tailChars": "Context Pruning Soft Trim Tail Chars",
  "agents.defaults.contextPruning.hardClear": "Context Pruning Hard Clear",
  "agents.defaults.contextPruning.hardClear.enabled": "Context Pruning Hard Clear Enabled",
  "agents.defaults.contextPruning.hardClear.placeholder": "Context Pruning Hard Clear Placeholder",
  "agents.list[].compaction": "Agent Compaction",
  "agents.list[].compaction.mode": "Agent Compaction Mode",
  "agents.list[].compaction.provider": "Agent Compaction Provider",
  "agents.list[].compaction.reserveTokens": "Agent Compaction Reserve Tokens",
  "agents.list[].compaction.keepRecentTokens": "Agent Compaction Keep Recent Tokens",
  "agents.list[].compaction.reserveTokensFloor": "Agent Compaction Reserve Token Floor",
  "agents.list[].compaction.maxHistoryShare": "Agent Compaction Max History Share",
  "agents.list[].compaction.identifierPolicy": "Agent Compaction Identifier Policy",
  "agents.list[].compaction.identifierInstructions": "Agent Compaction Identifier Instructions",
  "agents.list[].compaction.recentTurnsPreserve": "Agent Compaction Preserve Recent Turns",
  "agents.list[].compaction.qualityGuard": "Agent Compaction Quality Guard",
  "agents.list[].compaction.qualityGuard.enabled": "Agent Compaction Quality Guard Enabled",
  "agents.list[].compaction.qualityGuard.maxRetries": "Agent Compaction Quality Guard Max Retries",
  "agents.list[].compaction.midTurnPrecheck": "Agent Compaction Mid-turn Precheck",
  "agents.list[].compaction.midTurnPrecheck.enabled": "Agent Compaction Mid-turn Precheck Enabled",
  "agents.list[].compaction.postIndexSync": "Agent Compaction Post-Index Sync",
  ...
  "agents.list[].compaction.notifyUser": "Agent Compaction Notify User",
  "agents.list[].compaction.memoryFlush": "Agent Compaction Memory Flush",
  "agents.list[].compaction.memoryFlush.enabled": "Agent Compaction Memory Flush Enabled",
  "agents.list[].compaction.memoryFlush.model": "Agent Compaction Memory Flush Model Override",
  "agents.list[].compaction.memoryFlush.softThresholdTokens":
    "Agent Compaction Memory Flush Soft Threshold",
  "agents.list[].compaction.memoryFlush.forceFlushTranscriptBytes":
    "Agent Compaction Memory Flush Transcript Size Threshold",
  "agents.list[].compaction.memoryFlush.prompt": "Agent Compaction Memory Flush Prompt",
  "agents.list[].compaction.memoryFlush.systemPrompt":
    "Agent Compaction Memory Flush System Prompt",
  "agents.list[].contextPruning": "Agent Context Pruning",
  "agents.list[].contextPruning.mode": "Agent Context Pruning Mode",
  "agents.list[].contextPruning.ttl": "Agent Context Pruning Cache TTL",
  "agents.list[].contextPruning.keepLastAssistants": "Agent Context Pruning Keep Last Assistants",
  "agents.list[].contextPruning.softTrimRatio": "Agent Context Pruning Soft Trim Ratio",
  "agents.list[].contextPruning.hardClearRatio": "Agent Context Pruning Hard Clear Ratio",
  "agents.list[].contextPruning.minPrunableToolChars":
    "Agent Context Pruning Min Prunable Tool Chars",
  "agents.list[].contextPruning.tools": "Agent Context Pruning Tools Policy",
  "agents.list[].contextPruning.tools.allow": "Agent Context Pruning Tool Allowlist",
  "agents.list[].contextPruning.tools.deny": "Agent Context Pruning Tool Denylist",
  "agents.list[].contextPruning.softTrim": "Agent Context Pruning Soft Trim",
  "agents.list[].contextPruning.softTrim.maxChars": "Agent Context Pruning Soft Trim Max Chars",
  "agents.list[].contextPruning.softTrim.headChars": "Agent Context Pruning Soft Trim Head Chars",
  "agents.list[].contextPruning.softTrim.tailChars": "Agent Context Pruning Soft Trim Tail Chars",
  "agents.list[].contextPruning.hardClear": "Agent Context Pruning Hard Clear",
  "agents.list[].contextPruning.hardClear.enabled": "Agent Context Pruning Hard Clear Enabled",
  "agents.list[].contextPruning.hardClear.placeholder":
    "Agent Context Pruning Hard Clear Placeholder",
