...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "cron.failureDestination": "Cron Failure Destination",
  "cron.failureDestination.channel": "Cron Failure Destination Channel",
  "cron.failureDestination.to": "Cron Failure Destination To",
  "cron.failureDestination.mode": "Cron Failure Destination Mode",
  hooks: "Hooks",
