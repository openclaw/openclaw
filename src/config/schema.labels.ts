...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "marketplaces.feeds.*.verification.keys": "Marketplace Feed Signing Keys",
  "marketplaces.feeds.*.verification.keys[].keyId": "Marketplace Feed Signing Key ID",
  "marketplaces.feeds.*.verification.keys[].publicKey": "Marketplace Feed Signing Public Key",
  "marketplaces.feeds.*.verification.threshold": "Marketplace Feed Signing Threshold",
