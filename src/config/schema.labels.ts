...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "cron.billingGuard": "Cron Billing Guard",
  "cron.billingGuard.enabled": "Cron Billing Guard Enabled",
  "cron.billingGuard.probeBackoffMs": "Cron Billing Guard Probe Backoff (ms)",
