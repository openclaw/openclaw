...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "browser.profiles.*.proxy": "Browser Profile Proxy",
  "browser.profiles.*.proxy.server": "Browser Profile Proxy Server",
  "browser.profiles.*.proxy.username": "Browser Profile Proxy Username",
  "browser.profiles.*.proxy.password": "Browser Profile Proxy Password",
  tools: "Tools",
  ...
  "agents.defaults.browser": "Agent Default Browser Preferences",
  "agents.defaults.browser.profile": "Agent Default Browser Profile",
  ...
  "agents.list[].skills": "Agent Skill Filter",
  "agents.list[].browser": "Agent Browser Preferences",
  "agents.list[].browser.profile": "Agent Browser Default Profile",
