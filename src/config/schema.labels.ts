...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "models.providers.*.compat": "Model Provider Compat",
  "models.providers.*.compat.requestContextHeaders": "Model Provider Request Context Headers",
  "models.providers.*.compat.requestContextHeaders.runId": "Model Provider Run ID Header",
  "models.providers.*.compat.requestContextHeaders.messageChannel":
    "Model Provider Message Channel Header",
  "models.providers.*.compat.requestContextHeaders.runKind": "Model Provider Run Kind Header",
  ...
  "models.providers.*.models[].compat": "Model Compat",
  "models.providers.*.models[].compat.requestContextHeaders": "Model Request Context Headers",
  "models.providers.*.models[].compat.requestContextHeaders.runId": "Model Run ID Header",
  "models.providers.*.models[].compat.requestContextHeaders.messageChannel":
    "Model Message Channel Header",
  "models.providers.*.models[].compat.requestContextHeaders.runKind": "Model Run Kind Header",
