...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.exec.commandSecurity": "Pre-exec Command Security (tirith)",
  "tools.exec.commandSecurity.enabled": "Enable Command Security Scanning",
  "tools.exec.commandSecurity.failOpen": "Fail Open on Error",
  "tools.exec.commandSecurity.timeoutMs": "Security Scan Timeout (ms)",
  "tools.exec.commandSecurity.tirithPath": "tirith Binary Path",
