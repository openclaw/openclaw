...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "mcp.servers.*.oauth": "MCP OAuth Guard",
  "mcp.servers.*.oauth.resource": "MCP OAuth Resource",
  "mcp.servers.*.oauth.audience": "MCP OAuth Audience",
  "mcp.servers.*.oauth.protectedResourceMetadataUrl": "MCP OAuth Protected Resource Metadata URL",
