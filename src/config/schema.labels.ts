...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.subagents.agentsFile": "Subagent AGENTS File",
  "agents.defaults.subagents.agentsFilesByModel": "Subagent AGENTS Files by Model",
  ...
  "agents.list[].skills": "Agent Skill Filter",
  "agents.list[].agentsFile": "Agent Main AGENTS File",
  "agents.list[].agentsFilesByModel": "Agent Main AGENTS Files by Model",
  "agents.list[].identity.avatar": "Agent Avatar",
  "agents.list[].heartbeat.suppressToolErrorWarnings":
    "Agent Heartbeat Suppress Tool Error Warnings",
  "agents.list[].subagents.agentsFile": "Agent Subagent AGENTS File",
  "agents.list[].subagents.agentsFilesByModel": "Agent Subagent AGENTS Files by Model",
