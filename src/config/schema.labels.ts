...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.http.cors": "Gateway HTTP CORS",
  "gateway.http.cors.enabled": "Gateway HTTP CORS Enabled",
  "gateway.http.cors.allowedOrigins": "Gateway HTTP CORS Allowed Origins",
  "gateway.http.cors.allowCredentials": "Gateway HTTP CORS Allow Credentials",
  "gateway.http.cors.allowedHeaders": "Gateway HTTP CORS Allowed Headers",
  "gateway.http.cors.exposedHeaders": "Gateway HTTP CORS Exposed Headers",
  "gateway.http.cors.maxAge": "Gateway HTTP CORS Max Age",
