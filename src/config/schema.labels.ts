...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.benchCloud": "Bench Cloud Bridge",
  "gateway.benchCloud.enabled": "Bench Cloud Bridge Enabled",
  "gateway.benchCloud.apiBaseUrl": "Bench Cloud API Base URL",
  "gateway.benchCloud.instanceId": "Bench Cloud Instance ID",
  "gateway.benchCloud.installId": "Bench Cloud Install ID",
  "gateway.benchCloud.agentIdAliases": "Bench Cloud Agent ID Aliases",
  "gateway.benchCloud.pollIntervalMs": "Bench Cloud Poll Interval (ms)",
  "gateway.benchCloud.pollTimeoutMs": "Bench Cloud Poll Timeout (ms)",
