...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "models.providers.*.retry": "Model Provider Retry",
  "models.providers.*.retry.attempts": "Model Provider Retry Attempts",
  "models.providers.*.retry.minDelayMs": "Model Provider Retry Min Delay (ms)",
  "models.providers.*.retry.maxDelayMs": "Model Provider Retry Max Delay (ms)",
  "models.providers.*.retry.jitter": "Model Provider Retry Jitter",
  "models.providers.*.request": "Model Provider Request Overrides",
  "models.providers.*.request.timeoutMs": "Model Provider Request Timeout (ms)",
