...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.exec.highRiskConfirmation": "Exec High-Risk Confirmation",
  "tools.exec.highRiskConfirmation.enabled": "Confirm High-Risk Commands",
  "tools.exec.highRiskConfirmation.commands": "High-Risk Command List",
  "tools.exec.highRiskConfirmation.audit": "High-Risk Audit Logging",
  "tools.exec.highRiskConfirmation.audit.enabled": "High-Risk Audit Enabled",
  "tools.exec.highRiskConfirmation.audit.file": "High-Risk Audit File",
  "tools.exec.highRiskConfirmation.audit.mode": "High-Risk Audit Mode",
