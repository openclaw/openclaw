...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.tailscale.serve": "Gateway Tailscale Serve",
  "gateway.tailscale.serve.backend": "Gateway Tailscale Serve Backend",
  "gateway.tailscale.serve.httpsPort": "Gateway Tailscale Serve HTTPS Port",
  "gateway.tailscale.serve.service": "Gateway Tailscale Serve Service",
