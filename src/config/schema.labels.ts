...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.planSearch.budget": "Plan Search Compute Budget",
  "agents.defaults.planSearch.budget.maxTokens": "Plan Search Max Token Budget",
  "agents.defaults.planSearch.budget.maxRuntimeMs": "Plan Search Max Runtime Budget (ms)",
  "agents.defaults.planSearch.budget.maxCostUsd": "Plan Search Max Cost Budget (USD)",
  ...
  "agents.defaults.sandbox.execution": "Sandbox Execution Policy",
  "agents.defaults.sandbox.execution.template": "Sandbox Execution Template",
  "agents.defaults.sandbox.execution.imports": "Sandbox Import Policy",
  "agents.defaults.sandbox.execution.imports.allow": "Sandbox Import Allowlist",
  "agents.defaults.sandbox.execution.imports.deny": "Sandbox Import Denylist",
  "agents.defaults.sandbox.execution.dependencies": "Sandbox Dependency Policy",
  "agents.defaults.sandbox.execution.dependencies.allow": "Sandbox Dependency Allowlist",
  "agents.defaults.sandbox.execution.dependencies.deny": "Sandbox Dependency Denylist",
  ...
  "agents.list[].sandbox.execution": "Agent Sandbox Execution Policy",
  "agents.list[].sandbox.execution.template": "Agent Sandbox Execution Template",
  "agents.list[].sandbox.execution.imports": "Agent Sandbox Import Policy",
  "agents.list[].sandbox.execution.imports.allow": "Agent Sandbox Import Allowlist",
  "agents.list[].sandbox.execution.imports.deny": "Agent Sandbox Import Denylist",
  "agents.list[].sandbox.execution.dependencies": "Agent Sandbox Dependency Policy",
  "agents.list[].sandbox.execution.dependencies.allow": "Agent Sandbox Dependency Allowlist",
  "agents.list[].sandbox.execution.dependencies.deny": "Agent Sandbox Dependency Denylist",
