...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.sendPolicy.rules[].match.peerEquals": "Session Send Rule Peer Equality",
  "session.sendPolicy.rules[].match.invert": "Session Send Rule Invert Match",
  "session.sendPolicy.rules[].match.allOf": "Session Send Rule All Of",
  "session.sendPolicy.rules[].match.anyOf": "Session Send Rule Any Of",
