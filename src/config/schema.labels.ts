...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.healthMonitor.timing.staleEventThresholdMs": "Health Monitor Stale Event Threshold (ms)",
  "gateway.healthMonitor.timing.monitorStartupGraceMs": "Health Monitor Startup Grace Period (ms)",
  "gateway.healthMonitor.timing.channelConnectGraceMs": "Health Monitor Channel Connect Grace (ms)",
