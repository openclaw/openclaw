...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "aotui.apps.*.version": "AOTUI App Version",
  "aotui.apps.*.enabled": "AOTUI App Enabled",
  "aotui.apps.*.workerScript": "AOTUI App Worker Script",
  "aotui.apps.*.description": "AOTUI App Description",
  "aotui.apps.*.whatItIs": "AOTUI App What It Is",
  "aotui.apps.*.whenToUse": "AOTUI App When To Use",
  "aotui.apps.*.promptRole": "AOTUI App Prompt Role",
  agents: "Agents",
  "agents.defaults": "Agent Defaults",
  "agents.defaults.aotui": "Default Agent AOTUI Apps",
  "agents.defaults.aotui.apps": "Default Agent AOTUI App Names",
  "agents.list": "Agent List",
  "agents.list[].aotui": "Agent AOTUI Apps",
  "agents.list[].aotui.apps": "Agent AOTUI App Names",
  gateway: "Gateway",
