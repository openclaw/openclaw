...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.smartReset": "Session Smart Reset",
  "session.smartReset.enabled": "Session Smart Reset Enabled",
  "session.smartReset.prompt": "Session Smart Reset Prompt",
  "session.smartReset.wait": "Session Smart Reset Wait for Completion",
