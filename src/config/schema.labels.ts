...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.entries.*.heartbeat.includeSystemPromptSection": "Heartbeat Include System Prompt Section",
  ...
  "agents.entries.*.heartbeat.suppressToolErrorWarnings": "Heartbeat Suppress Tool Error Warnings",
  ...
  "agents.entries.*.heartbeat.skipWhenBusy": "Heartbeat Skip When Busy",
  ...
  "agents.entries.*.skills": "Agent Skill Filter",
  "agents.entries.*.identity.avatar": "Agent Avatar",
  "agents.entries.*.heartbeat.suppressToolErrorWarnings":
    "Agent Heartbeat Suppress Tool Error Warnings",
  "agents.entries.*.heartbeat.timeoutSeconds": "Agent Heartbeat Timeout (Seconds)",
  "agents.entries.*.heartbeat.skipWhenBusy": "Agent Heartbeat Skip When Busy",
  "agents.entries.*.sandbox.browser.network": "Agent Sandbox Browser Network",
  "agents.entries.*.sandbox.browser.cdpSourceRange": "Agent Sandbox Browser CDP Source Port Range",
