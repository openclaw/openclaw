...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.modelWorkerPool.enabled": "Model Worker Pool: Enabled",
  "gateway.modelWorkerPool.maxWorkers": "Model Worker Pool: Max Workers",
  "gateway.modelWorkerPool.timeoutMs": "Model Worker Pool: Timeout (ms)",
  ...
  "gateway.reload.forceDrain.gracefulMs": "Force Drain: Graceful Phase (ms)",
  "gateway.reload.forceDrain.softAbortMs": "Force Drain: Soft Abort Phase (ms)",
  "gateway.reload.forceDrain.forceCloseMs": "Force Drain: Force Close Phase (ms)",
  "gateway.reload.forceDrain.hardKillMs": "Force Drain: Hard Kill Phase (ms)",
