...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.telegram.jitsi": "Telegram Jitsi Bridge",
  "channels.telegram.jitsi.enabled": "Telegram Jitsi Enabled",
  "channels.telegram.jitsi.bridgeUrl": "Telegram Jitsi Bridge URL",
  "channels.telegram.jitsi.autoJoin": "Telegram Jitsi Auto Join",
  "channels.telegram.jitsi.inviteEmail": "Telegram Jitsi Invite Email",
  "channels.telegram.jitsi.realtimeModel": "Telegram Jitsi Realtime Model",
  "channels.telegram.jitsi.labels": "Telegram Jitsi Labels",
  "channels.telegram.jitsi.labels.createButton": "Telegram Jitsi Create Button",
  "channels.telegram.jitsi.labels.joinButton": "Telegram Jitsi Join Button",
  "channels.telegram.jitsi.labels.briefingButton": "Telegram Jitsi Briefing Button",
  "channels.telegram.jitsi.labels.questionButton": "Telegram Jitsi Question Button",
  "channels.telegram.jitsi.labels.refreshButton": "Telegram Jitsi Refresh Button",
  "channels.telegram.jitsi.labels.clearButton": "Telegram Jitsi Clear Button",
  "channels.telegram.jitsi.labels.emptyPanelText": "Telegram Jitsi Empty Panel Text",
  "channels.telegram.jitsi.labels.emptyPanelHint": "Telegram Jitsi Empty Panel Hint",
  "channels.telegram.jitsi.labels.pendingBriefingHint": "Telegram Jitsi Pending Briefing Hint",
  "channels.telegram.jitsi.labels.pendingQuestionHint": "Telegram Jitsi Pending Question Hint",
