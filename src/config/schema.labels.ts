...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "audio.immersive": "Immersive Audio",
  "audio.immersive.enabled": "Immersive Audio Enabled",
  "audio.immersive.noiseSuppression": "Noise Suppression",
  "audio.immersive.echoCancellation": "Echo Cancellation",
  "audio.immersive.autoGainControl": "Auto Gain Control",
  "audio.immersive.vadThreshold": "VAD Threshold",
  "audio.immersive.silenceTimeoutMs": "Silence Timeout (ms)",
  "audio.immersive.phaseSounds": "Phase Transition Sounds",
  bindings: "Bindings",
