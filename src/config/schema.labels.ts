...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list[].tts": "Agent TTS Config",
  "agents.list[].tts.provider": "Agent TTS Provider",
  "agents.list[].tts.auto": "Agent TTS Auto Mode",
  "agents.list[].tts.enabled": "Agent TTS Enabled",
  "agents.list[].tts.mode": "Agent TTS Mode",
  "agents.list[].tts.providers": "Agent TTS Provider Settings",
  "agents.list[].stt": "Agent STT Config",
  "agents.list[].stt.enabled": "Agent STT Enabled",
  "agents.list[].stt.language": "Agent STT Language",
  "agents.list[].stt.prompt": "Agent STT Prompt",
  "agents.list[].stt.echoTranscript": "Agent STT Echo Transcript",
  "agents.list[].stt.echoFormat": "Agent STT Echo Format",
