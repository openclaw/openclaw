...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "hooks.postCompactionAudit": "Post-Compaction Audit",
  "hooks.postCompactionAudit.enabled": "Post-Compaction Audit Enabled",
  "hooks.postCompactionAudit.requiredReads": "Post-Compaction Audit Required Reads",
