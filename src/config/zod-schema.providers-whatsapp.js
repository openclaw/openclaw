...
import { BlockStreamingCoalesceSchema, ContextVisibilityModeSchema, DmConfigSchema, DmPolicySchema, GroupPolicySchema, MarkdownConfigSchema, ReplyToModeSchema, } from "./zod-schema.core.js";
...
export const WhatsAppConfigSchema = z
    ...
    for (const [accountId, account] of Object.entries(value.accounts)) {
        ...
        const effectivePolicy = account.dmPolicy ??
