...
import { resolveLoadedHelperExecutionRoute } from "./revalidate-inference-owner.js";
import {
...
export async function verifySetupInferenceConfig(params: {
  ...
  try {
    ...
    if (requiresExecutionOwner) {
      ...
      const executionRoute = resolveLoadedHelperExecutionRoute(configuredRoute, deps);
      plan =
