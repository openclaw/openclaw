...
export type ActiviPluginConfigSchema = {
...
export type ActiviPluginToolContext = {
  config?: ActiviConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type ActiviPluginToolFactory = (
  ctx: ActiviPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type ActiviPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type ActiviPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<ActiviConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type ActiviPluginGatewayMethod = {
  method: string;
 ...
 */
export type ActiviPluginCommandDefinition = {
...
export type ActiviPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type ActiviPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type ActiviPluginCliContext = {
  program: Command;
  config: ActiviConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type ActiviPluginCliRegistrar = (ctx: ActiviPluginCliContext) => void | Promise<void>;

export type ActiviPluginServiceContext = {
  config: ActiviConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type ActiviPluginService = {
  id: string;
  start: (ctx: ActiviPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: ActiviPluginServiceContext) => void | Promise<void>;
};

export type ActiviPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type ActiviPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: ActiviPluginConfigSchema;
  register?: (api: ActiviPluginApi) => void | Promise<void>;
  activate?: (api: ActiviPluginApi) => void | Promise<void>;
};

export type ActiviPluginModule =
  | ActiviPluginDefinition
  | ((api: ActiviPluginApi) => void | Promise<void>);

export type ActiviPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | ActiviPluginToolFactory,
    opts?: ActiviPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: ActiviPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: ActiviPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: ActiviPluginHttpRouteHandler }) => void;
  registerChannel: (registration: ActiviPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: ActiviPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: ActiviPluginService) => void;
   ...
   */
  registerCommand: (command: ActiviPluginCommandDefinition) => void;
