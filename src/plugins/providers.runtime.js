...
import { isPluginRegistryLoadInFlight, loadOpenClawPlugins, resolveRuntimePluginRegistry, } from "./loader.js";
import { hasExplicitPluginIdScope } from "./plugin-scope.js";
import { resolveActivatableProviderOwnerPluginIds, resolveDiscoverableProviderOwnerPluginIds, resolveDiscoveredProviderPluginIds, resolveEnabledProviderPluginIds, resolveBundledProviderCompatPluginIds, resolveOwningPluginIdsForProvider, resolveOwningPluginIdsForModelRefs, withBundledProviderVitestCompat, } from "./providers.js";
...
function resolvePluginProviderLoadBase(params) {
    ...
    const modelOwnedPluginIds = params.modelRefs?.length
        ...
        : [];
    const requestedPluginIds = hasExplicitPluginIdScope(params.onlyPluginIds) ||
...
function resolveRuntimeProviderPluginLoadState(params, base) {
    ...
    const runtimeRequestedPluginIds = base.requestedPluginIds !== undefined
...
export function isPluginProvidersLoadInFlight(params) {
    const base = resolvePluginProviderLoadBase(params);
    const loadState = params.mode === "setup"
