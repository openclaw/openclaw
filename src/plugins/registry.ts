...
import type {
  ...
  MullusiPluginApi,
  MullusiPluginChannelRegistration,
  MullusiPluginCliCommandDescriptor,
  MullusiPluginCliRegistrar,
  MullusiPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  MullusiPluginHttpRouteAuth,
  MullusiPluginHttpRouteMatch,
  MullusiPluginHttpRouteHandler,
  MullusiPluginHttpRouteParams,
  MullusiPluginHookOptions,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: MullusiPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: MullusiPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: MullusiPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: MullusiPluginHookOptions | undefined,
  ...
  const registerHttpRoute = (record: PluginRecord, params: MullusiPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: MullusiPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as MullusiPluginChannelRegistration).plugin === "object"
        ? (registration as MullusiPluginChannelRegistration)
  ...
  const registerCli = (
    ...
    opts?: { commands?: string[]; descriptors?: MullusiPluginCliCommandDescriptor[] },
  ) => {
  ...
  const registerService = (record: PluginRecord, service: MullusiPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: MullusiPluginCommandDefinition) => {
