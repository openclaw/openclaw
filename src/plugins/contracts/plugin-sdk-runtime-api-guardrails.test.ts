...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile("imessage", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type MullusiConfig } from "mullusi/plugin-sdk/core";',
    ...
    'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "mullusi/plugin-sdk/status-helpers";',
    'export { formatTrimmedAllowFromEntries } from "mullusi/plugin-sdk/channel-config-helpers";',
    ...
    'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiMullusiConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
  ],
  [bundledPluginFile("googlechat", "runtime-api.ts")]: [
    'export * from "mullusi/plugin-sdk/googlechat";',
  ],
  [bundledPluginFile("matrix", "runtime-api.ts")]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "mullusi/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, MullusiConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "mullusi/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "mullusi/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile("nextcloud-talk", "runtime-api.ts")]: [
    'export * from "mullusi/plugin-sdk/nextcloud-talk";',
  ],
  ...
  [bundledPluginFile("telegram", "runtime-api.ts")]: [
    ...
    'export type { MullusiPluginService, MullusiPluginServiceContext, PluginLogger } from "mullusi/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "mullusi/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "mullusi/plugin-sdk/acp-runtime";',
    'export { clearAccountEntryFields, emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "mullusi/plugin-sdk/core";',
    ...
    'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "mullusi/plugin-sdk/channel-status";',
    'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "mullusi/plugin-sdk/channel-actions";',
    ...
    'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeMullusiConfig["channels"]>["telegram"] >;',
