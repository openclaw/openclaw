...
import {
  ...
  type SmartAgentNeoPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @smart-agent-neo/voice-call -> voice-call).
...
export function discoverSmartAgentNeoPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".smart-agent-neo", "extensions")];
