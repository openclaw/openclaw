...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @dna/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageDNA: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverDNAPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".dna", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
