...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @easyhub/voice-call -> voice-call).
...
export function discoverEasyHubPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".easyhub", "extensions")];
