...
export type PluginRuntimeCore = {
  ...
  tools: {
    createMemoryAddTool: typeof import("../../agents/tools/memory-tool.js").createMemoryAddTool;
    createMemoryGetTool: typeof import("../../agents/tools/memory-tool.js").createMemoryGetTool;
    createMemoryRelatedTool: typeof import("../../agents/tools/memory-tool.js").createMemoryRelatedTool;
