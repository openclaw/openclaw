...
import { withBundledPluginEnablementCompat, withBundledPluginVitestCompat, } from "./bundled-compat.js";
...
export function buildVitestCapabilityShimAliasMap() {
...
export function buildBundledCapabilityRuntimeConfig(pluginIds, env) {
...
export function loadBundledCapabilityRuntimeRegistry(params) {
    ...
    for (const candidate of discovery.candidates) {
        ...
        const record = createCapabilityPluginRecord({
            ...
            source: env?.VITEST && params.pluginSdkResolution === "dist"
