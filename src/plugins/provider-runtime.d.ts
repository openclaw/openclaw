...
}): Promise<import("../infra/provider-usage.types.js").ProviderUsageSnapshot | null | undefined>;
...
export declare function classifyProviderFailoverReasonWithPlugin(params: {
    ...
    env?: NodeJS.ProcessEnv;
    context: ProviderFailoverErrorContext;
}): import("../agents/pi-embedded-helpers.js").FailoverReason | undefined;
...
}): import("./provider-external-auth.types.js").ProviderSyntheticAuthResult | null | undefined;
...
}): Promise<import("../agents/model-catalog.types.js").ModelCatalogEntry[]>;
