...
export function applyProviderDefaultModel(cfg: MullusiConfig, modelRef: string): MullusiConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: MullusiConfig; modelId: string; modelRef: string; profileId: string } {
