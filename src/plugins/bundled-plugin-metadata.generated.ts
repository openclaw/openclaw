...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  },
  {
    ...
    packageName: "@openclaw/qveris",
    packageVersion: "2026.3.25",
    packageDescription: "QVeris web search plugin for QVerisBot",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
      ...
      uiHints: {
        "webSearch.apiKey": {
          ...
          help: "QVeris API key (fallback: QVERIS_API_KEY env var or tools.qveris.apiKey).",
          sensitive: true,
          placeholder: "qv-...",
        },
      },
  ...
  },
  {
    ...
    packageName: "@openclaw/x",
    packageVersion: "2026.3.25",
    packageDescription: "OpenClaw X (Twitter) channel plugin",
    packageManifest: {
      extensions: ["./index.ts"],
      channel: {
        id: "x",
        ...
        docsPath: "/channels/x",
        docsLabel: "x",
        blurb: "Monitor mentions, reply to tweets, and run x-actions via the X API.",
        order: 50,
        quickstartAllowFrom: true,
      },
      install: {
        npmSpec: "@openclaw/x",
        localPath: "extensions/x",
        defaultChoice: "local",
      },
    },
    manifest: {
