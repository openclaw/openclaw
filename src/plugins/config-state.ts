...
export const normalizePluginsConfig = (
  config?: SmartAgentNeoConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: SmartAgentNeoConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SmartAgentNeoConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: SmartAgentNeoConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
