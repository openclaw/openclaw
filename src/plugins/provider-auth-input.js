...
import { normalizeOptionalLowercaseString, normalizeStringifiedOptionalString, } from "../shared/string-coerce.js";
import { resolveSecretInputModeForEnvSelection, } from "./provider-auth-mode.js";
import { extractEnvVarFromSourceLabel, promptSecretRefForSetup, resolveRefFallbackInput, } from "./provider-auth-ref.js";
export { extractEnvVarFromSourceLabel, promptSecretRefForSetup, resolveRefFallbackInput, } from "./provider-auth-ref.js";
...
export function normalizeTokenProviderInput(tokenProvider) {
    return normalizeOptionalLowercaseString(tokenProvider);
}
export function normalizeSecretInputModeInput(secretInputMode) {
