...
export function normalizeBundledPluginArtifactSubpath(artifactBasename) {
    if (path.posix.isAbsolute(artifactBasename) ||
...
export function normalizeBundledPluginDirName(dirName) {
