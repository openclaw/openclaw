...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/activi/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/activi/extensions",
        global: "/Users/x/.activi/extensions",
        workspace: "/Users/x/ws/.activi/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.activi/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/activi/extensions",
        global: "/Users/x/.activi/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.activi/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/activi/extensions",
        global: "/Users/x/.activi/extensions",
