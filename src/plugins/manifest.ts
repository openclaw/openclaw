...
export const PLUGIN_MANIFEST_FILENAME = "mullusi.plugin.json";
...
// package.json "mullusi" metadata (used for setup/catalog)
...
export type MullusiPackageStartup = {
  /**
...
export type MullusiPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: MullusiPackageStartup;
};
...
): MullusiPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
