...
export const PLUGIN_MANIFEST_FILENAME = "dna.plugin.json";
...
// package.json "dna" metadata (used for onboarding/catalog)
...
export type DNAPackageManifest = {
  extensions?: string[];
...
): DNAPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.dna ?? manifest[LEGACY_MANIFEST_KEY];
}
