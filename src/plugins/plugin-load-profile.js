 ...
 */
export function shouldProfilePluginLoader() {
...
export function formatPluginLoadProfileLine(params) {
    ...
    return (`[plugin-load-profile] phase=${params.phase} plugin=${params.pluginId ?? "(core)"}` +
 ...
 * `try { … } finally { … }`.
 */
export function withProfile(scope, phase, run, extras) {
