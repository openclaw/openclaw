...
export type MemoryRoleSlotKey = Exclude<keyof PluginSlotsConfig, "memory" | "contextEngine">;

export function memoryRoleToSlotKey(role: MemoryPluginRole): MemoryRoleSlotKey {
  return `memory.${role}` as MemoryRoleSlotKey;
}
