...
export function listWhatsAppAuthDirs(cfg: SmartAgentNeoConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SmartAgentNeoConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: SmartAgentNeoConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: SmartAgentNeoConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: SmartAgentNeoConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SmartAgentNeoConfig): ResolvedWhatsAppAccount[] {
