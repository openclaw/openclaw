...
export function listWhatsAppAuthDirs(cfg: EasyHubConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: EasyHubConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: EasyHubConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: EasyHubConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: EasyHubConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: EasyHubConfig): ResolvedWhatsAppAccount[] {
