...
const CONFIG_KEY = Symbol.for("smart-agent-neo:testConfigMock");
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("smart-agent-neo:lastSocket")] =
    created.lastSocket;
  return created.mod;
});
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for("smart-agent-neo:lastSocket")];
  if (typeof getter === "function") {
