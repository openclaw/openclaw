...
import { readStoreAllowFromForDmPolicy, resolveDmGroupAccessWithCommandGate, } from "../../../security/dm-policy-shared.js";
...
async function resolveWhatsAppCommandAuthorized(params) {
    ...
    const dmAllowFrom = configuredAllowFrom.length > 0
        ? configuredAllowFrom
        : params.msg.selfE164
            ? [params.msg.selfE164]
            : [];
