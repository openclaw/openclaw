...
function withNodeServiceEnv(
  ...
  return {
    ...env,
    EASYHUB_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    EASYHUB_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    EASYHUB_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    EASYHUB_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    EASYHUB_LOG_PREFIX: "node",
    EASYHUB_SERVICE_MARKER: NODE_SERVICE_MARKER,
    EASYHUB_SERVICE_KIND: NODE_SERVICE_KIND,
  };
}
