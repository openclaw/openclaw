...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    DNA_PROFILE: profile,
    DNA_STATE_DIR: env.DNA_STATE_DIR,
    DNA_CONFIG_PATH: env.DNA_CONFIG_PATH,
    DNA_GATEWAY_PORT: String(port),
    DNA_GATEWAY_TOKEN: token,
    DNA_LAUNCHD_LABEL: resolvedLaunchdLabel,
    DNA_SYSTEMD_UNIT: systemdUnit,
    DNA_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    DNA_SERVICE_KIND: GATEWAY_SERVICE_KIND,
