...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.EASYHUB_STATE_DIR;
  const configPath = env.EASYHUB_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    EASYHUB_PROFILE: profile,
    EASYHUB_STATE_DIR: stateDir,
    EASYHUB_CONFIG_PATH: configPath,
    EASYHUB_GATEWAY_PORT: String(port),
    EASYHUB_GATEWAY_TOKEN: token,
    EASYHUB_LAUNCHD_LABEL: resolvedLaunchdLabel,
    EASYHUB_SYSTEMD_UNIT: systemdUnit,
    EASYHUB_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    EASYHUB_SERVICE_KIND: GATEWAY_SERVICE_KIND,
