...
export const LEGACY_GATEWAY_LAUNCH_AGENT_LABELS = ["com.clawdbot.gateway"];
export const LEGACY_GATEWAY_SYSTEMD_SERVICE_NAMES = ["clawdbot-gateway"];
export const LEGACY_GATEWAY_WINDOWS_TASK_NAMES = ["Clawdbot Gateway"];
