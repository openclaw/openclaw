...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.activi.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ACTIVI_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.activi.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ACTIVI_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.activi.gateway.plist",
    },
    {
      name: "uses profile-specific label when ACTIVI_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ACTIVI_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.activi.jbphoenix.plist",
    },
    {
      name: "prefers ACTIVI_LAUNCHD_LABEL over ACTIVI_PROFILE",
      env: {
        HOME: "/Users/test",
        ACTIVI_PROFILE: "jbphoenix",
        ACTIVI_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ACTIVI_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ACTIVI_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ACTIVI_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ACTIVI_PROFILE: "myprofile",
        ACTIVI_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.activi.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
