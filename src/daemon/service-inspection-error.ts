...
const SERVICE_INSPECTION_MESSAGES = {
  ...
  "systemd-inspection-deadline-exceeded":
    "The systemd manager inspection deadline was exceeded while completing required admission checks. The user session bus may still be healthy; retry the command once the manager is responsive.",
