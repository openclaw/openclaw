...
function buildParams(
  ...
  if (compat.thinkingFormat === "none") {
    // Provider explicitly opted out of thinking param injection (e.g. DeepSeek models
    // hosted on Azure AI Foundry reject the `thinking` field entirely). Skip all
    // reasoning/thinking param injection regardless of model.reasoning.
