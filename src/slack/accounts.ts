...
function mergeSlackAccountConfig(cfg: ActiviConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ActiviConfig): ResolvedSlackAccount[] {
