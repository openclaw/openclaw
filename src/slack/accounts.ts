...
export function listSlackAccountIds(cfg: SmartAgentNeoConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: SmartAgentNeoConfig): string {
...
function mergeSlackAccountConfig(cfg: SmartAgentNeoConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SmartAgentNeoConfig): ResolvedSlackAccount[] {
