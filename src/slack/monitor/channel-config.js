...
export function resolveSlackChannelConfig(params) {
    ...
    const candidates = buildChannelKeyCandidates(channelId, channelIdLower !== channelId ? channelIdLower : undefined, channelIdUpper !== channelId ? channelIdUpper : undefined, channelName ? `#${directName}` : undefined, directName, normalizedName);
