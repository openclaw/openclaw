...
import { buildMediaUnderstandingRegistry, getMediaUnderstandingProvider, normalizeMediaProviderId, } from "./provider-registry.js";
...
function resolveConfiguredKeyProviderOrder(params) {
    const configuredProviders = Object.keys(params.cfg.models?.providers ?? {})
        ...
        .filter((providerId) => providerSupportsCapability(params.providerRegistry.get(providerId), params.capability));
...
export function buildProviderRegistry(overrides, cfg) {
