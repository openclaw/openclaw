 ...
 */
export const DEFAULT_JOB_TIMEOUT_MS = 10 * 60000; // 10 minutes
/**
 ...
 */
export const AGENT_TURN_SAFETY_TIMEOUT_MS = 60 * 60000; // 60 minutes
export function resolveCronJobTimeoutMs(job) {
