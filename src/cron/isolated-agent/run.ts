...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/activi/activi/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ACTIVI_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.activi/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: ActiviConfig = {
    ...params.cfg,
