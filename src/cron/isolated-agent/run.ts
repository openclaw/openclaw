...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/betterbrand/smart-agent-neo/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.SMART_AGENT_NEO_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.smart-agent-neo/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: SmartAgentNeoConfig = {
    ...params.cfg,
