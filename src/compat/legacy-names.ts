export const LEGACY_PROJECT_NAME = "dna" as const;
...
export const LEGACY_MACOS_APP_SOURCES_DIR = "apps/macos/Sources/DNA" as const;

export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/DNA" as const;
