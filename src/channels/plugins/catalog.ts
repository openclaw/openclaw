...
import type { SmartAgentNeoPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverSmartAgentNeoPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, SmartAgentNeoPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SMART_AGENT_NEO_PLUGIN_CATALOG_PATHS", "SMART_AGENT_NEO_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SmartAgentNeoPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: SmartAgentNeoPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SmartAgentNeoPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSmartAgentNeoPlugins({ workspaceDir: options.workspaceDir });
