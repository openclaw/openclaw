...
import { discoverActiviPlugins } from "../../plugins/discovery.js";
import type { ActiviPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ActiviPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["ACTIVI_PLUGIN_CATALOG_PATHS", "ACTIVI_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ActiviPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: ActiviPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverActiviPlugins({ workspaceDir: options.workspaceDir });
