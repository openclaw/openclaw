...
export function listChannelMessageActions(cfg: MullusiConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: MullusiConfig): ChannelMessageCapability[] {
