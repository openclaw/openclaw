...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: MullusiConfig): string | undefined {
  ...
  function listAccountIds(cfg: MullusiConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: MullusiConfig): string {
