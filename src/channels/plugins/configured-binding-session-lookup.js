...
import { materializeConfiguredBindingRecord, resolveAccountMatchPriority, resolveCompiledBindingChannel, } from "./configured-binding-match.js";
export function resolveConfiguredBindingRecordBySessionKeyFromRegistry(params) {
    ...
    for (const consumer of listConfiguredBindingConsumers()) {
        ...
        for (const rule of rules) {
            ...
            const matchesSessionKey = consumer.matchesSessionKey?.({
                sessionKey,
