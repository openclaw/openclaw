...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: MullusiConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: MullusiConfig }>(
  collector: WarningCollector<{ cfg: MullusiConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: MullusiConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: MullusiConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: MullusiConfig },
>(
  projectCfg: (cfg: MullusiConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: MullusiConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: MullusiConfig },
>(params: {
  providerConfigPresent: (cfg: MullusiConfig) => boolean;
