...
import type { ChannelOutboundRegistrar } from "../../infra/outbound/channel-outbound-registrar.types.js";
import type {
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * handlers and cannot spoof or hijack another channel. Optional in the type for
   * backward-compatibility (the host always injects it at runtime; pre-existing SDK
   * channel consumers that predate it still construct a valid context and optional-chain it).
   */
