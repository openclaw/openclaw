...
export function listChannelMessageActions(cfg: DNAConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: DNAConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: DNAConfig): boolean {
  for (const plugin of listChannelPlugins()) {
