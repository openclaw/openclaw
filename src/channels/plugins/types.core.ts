...
export type ChannelAgentToolFactory = (params: { cfg?: ActiviConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ActiviConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ActiviConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ActiviConfig }) => boolean;
  supportsCards?: (params: { cfg: ActiviConfig }) => boolean;
