...
export type ChannelAgentToolFactory = (params: { cfg?: EasyHubConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: EasyHubConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: EasyHubConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: EasyHubConfig }) => boolean;
  supportsCards?: (params: { cfg: EasyHubConfig }) => boolean;
