...
export type ChannelAgentToolFactory = (params: { cfg?: SmartAgentNeoConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SmartAgentNeoConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SmartAgentNeoConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SmartAgentNeoConfig }) => boolean;
  supportsCards?: (params: { cfg: SmartAgentNeoConfig }) => boolean;
