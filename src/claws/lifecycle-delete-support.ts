...
export function planClawHistoricalAgentState(params: {
  ...
  const retainAgentDir = params.retain || params.sharedAgentDir === true;
  const retainSessionsDir = params.retain || params.sharedSessionsDir === true;
