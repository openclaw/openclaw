...
type CreateSmartAgentNeoToolsOpts = Parameters<CreateSmartAgentNeoTools>[0];

async function getSessionsSpawnTool(opts: CreateSmartAgentNeoToolsOpts) {
...
describe("smart-agent-neo-tools: subagents (sessions_spawn lifecycle)", () => {
  beforeEach(() => {
    resetSessionsSpawnConfigOverride();
  });
