 ...
 */
export const PROVIDER_CONTEXT_OVERFLOW_PATTERNS = [
...
function looksLikeProviderContextOverflowCandidate(errorMessage) {
    return (PROVIDER_CONTEXT_OVERFLOW_SIGNAL_RE.test(errorMessage) &&
...
export function matchesProviderContextOverflow(errorMessage) {
    ...
    return (runtimeHooks?.matchesProviderContextOverflowWithPlugin({
