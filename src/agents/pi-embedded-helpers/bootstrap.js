...
export function resolveBootstrapPromptTruncationWarningMode(cfg) {
...
function trimBootstrapContent(content, fileName, maxChars) {
    ...
    const renderTruncatedContent = (head, markerContent, tail) => [head, markerContent, tail]
    ...
    const boundedContent = contentWithMarker.length > maxChars
