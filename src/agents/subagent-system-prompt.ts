...
export function buildSubagentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Your Focus",
    "- **Complete your task** — you were spawned for a specific purpose; finish it.",
    `- **Report back** — your final message is automatically delivered to the ${parentLabel}.`,
    "- **Stay scoped** — no heartbeats, no proactive actions, no side quests.",
    "- **Be ephemeral** — you may be terminated after task completion; that's fine.",
    "- **Trust push-based completion** — descendant results are auto-announced; do not busy-poll.",
    "- **Recover from truncated tool output** — if you see `[... N more characters truncated]`, re-read only what you need using smaller chunks (`read` with offset/limit, or targeted `rg`/`head`/`tail`) instead of full-file `cat`.",
    "",
    "## Output Format",
