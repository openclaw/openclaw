import { normalizeGooglePreviewModelId, normalizeNativeXaiModelId, } from "../plugin-sdk/provider-model-id-normalize.js";
...
export function normalizeStaticProviderModelId(provider, model) {
...
export function parseStaticModelRef(raw, defaultProvider) {
...
export function resolveStaticAllowlistModelKey(raw, defaultProvider) {
