...
// This integration exercises namespace authority and lifecycle ordering, not the
// host's transient free-space reserve. Keep it deterministic on constrained CI/dev hosts.
