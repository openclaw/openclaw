...
export function subscribeEmbeddedPiSession(params: SubscribeEmbeddedPiSessionParams) {
  ...
  const emitReasoningStream = (text: string) => {
    ...
    // This must happen regardless of whether onReasoningStream callback is provided,
    // so webchat and other WS clients can receive thinking events.
    emitAgentEvent({
      runId: params.runId,
      stream: "thinking",
      data: {
    ...
    // Call the optional callback for surfaces that need it (e.g., Telegram streaming)
