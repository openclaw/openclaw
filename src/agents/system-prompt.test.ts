...
describe("buildAgentSystemPrompt", () => {
  ...
  it("includes Slack interactive reply guidance when runtime supports interactiveReplies", () => {
    const prompt = buildAgentSystemPrompt({
      workspaceDir: "/tmp/openclaw",
      toolNames: ["message"],
      runtimeInfo: {
    ...
    expect(prompt).toContain("[[slack_buttons:");
    expect(prompt).toContain("[[slack_select:");
