...
describe("buildAgentSystemPrompt", () => {
  ...
  it("instructs models to use skill_workshop only when the tool is available", () => {
    ...
    expect(section).toEqual([
      ...
      "Generated = pending proposal. Review: show current page; reuse expected_revision_hash for later pages/lifecycle. Apply/reject/quarantine only explicit user ask.",
