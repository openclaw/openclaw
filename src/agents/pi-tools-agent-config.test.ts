...
describe("Agent-specific tool filtering", () => {
  ...
  async function withApplyPatchEscapeCase(
    ...
    const workspaceDir = await fs.mkdtemp(path.join(os.tmpdir(), "mullusi-pi-tools-"));
...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: MullusiConfig) {
  ...
  function createMainAgentConfig(params: {
    tools: NonNullable<MullusiConfig["tools"]>;
    agentTools?: NonNullable<NonNullable<MullusiConfig["agents"]>["list"]>[number]["tools"];
  }): MullusiConfig {
    return {
      tools: params.tools,
      agents: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createMullusiCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createMullusiCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createMullusiCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createMullusiCodingTools({
      config: cfg,
    ...
    const bobTools = createMullusiCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createMullusiCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createMullusiCodingTools({
      config: cfg,
