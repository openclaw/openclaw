...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createEasyHubCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createEasyHubCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createEasyHubCodingTools({
      config: cfg,
    ...
    const defaultTools = createEasyHubCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createEasyHubCodingTools({
      config: cfg,
    ...
    const bobTools = createEasyHubCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createEasyHubCodingTools({
      config: cfg,
