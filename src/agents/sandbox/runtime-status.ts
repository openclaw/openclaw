...
function resolveMainSessionKeyForSandbox(params: { cfg?: DNAConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: DNAConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`dna sandbox explain --session ${runtime.sessionKey}`)}`,
  );
