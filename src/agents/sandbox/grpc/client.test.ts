...
// Mock generated proto modules (not present in source tree -- generated by buf at build time)
vi.mock("../proto/openclaw/sandbox/v1/browser.js", () => ({
...
vi.mock("../proto/openclaw/sandbox/v1/exec.js", () => ({
  ExecServiceDefinition: {
    name: "ExecService",
    fullName: "openclaw.sandbox.v1.ExecService",
    methods: {},
  },
}));
vi.mock("../proto/openclaw/sandbox/v1/file.js", () => ({
...
vi.mock("../proto/openclaw/sandbox/v1/sandbox.js", () => ({
