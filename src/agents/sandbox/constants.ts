...
export const DEFAULT_SANDBOX_IMAGE = "activi-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "activi-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "activi-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "activi-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "activi-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "activi-sandbox-browser";
