...
export const DEFAULT_SANDBOX_IMAGE = "EasyHub-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "EasyHub-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "EasyHub-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "EasyHub-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "EasyHub-sbx-browser-";
