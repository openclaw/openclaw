...
export const DEFAULT_SANDBOX_IMAGE = "bot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "bot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "bot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "bot-sandbox-common:bookworm-slim";
