...
export const DEFAULT_SANDBOX_IMAGE = "mullusi-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mullusi-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mullusi-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mullusi-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mullusi-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mullusi-sandbox-browser";
