...
const resolvedStateDir = STATE_DIR ?? path.join(os.homedir(), ".openclaw");
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(resolvedStateDir, "sandboxes");
...
export const SANDBOX_STATE_DIR = path.join(resolvedStateDir, "sandbox");
