...
import { dockerContainerState, ensureSandboxContainer, execDocker, execDockerRaw, } from "./docker.js";
...
export async function createDockerSandboxBackend(params) {
...
export function runDockerSandboxShellCommand(params) {
    const dockerArgs = [
        "exec",
        "-i",
