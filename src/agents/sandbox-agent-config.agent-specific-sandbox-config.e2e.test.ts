...
async function resolveContext(config: MullusiConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): MullusiConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
