...
export function normalizeAntigravityModelId(id) {
...
export async function resolveImplicitProviders(params) {
    ...
    const hasExplicitModels = Array.isArray(explicitOllama?.models) && explicitOllama.models.length > 0;
    ...
    const openrouterKey = resolveEnvApiKeyVarName("openrouter") ??
    ...
    const kilocodeKey = resolveEnvApiKeyVarName("kilocode") ??
