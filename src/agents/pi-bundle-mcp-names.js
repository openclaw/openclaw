...
export function sanitizeServerName(raw, usedNames) {
...
export function normalizeReservedToolNames(names) {
...
export function buildSafeToolName(params) {
    ...
    const maxToolChars = Math.max(1, TOOL_NAME_MAX_TOTAL - params.serverName.length - TOOL_NAME_SEPARATOR.length);
