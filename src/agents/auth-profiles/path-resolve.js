...
import { AUTH_PROFILE_FILENAME, AUTH_STATE_FILENAME, LEGACY_AUTH_FILENAME, } from "./path-constants.js";
 ...
 */
export function resolveOAuthRefreshLockPath(provider, profileId) {
