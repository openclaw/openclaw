...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveMullusiAgentDir() returns mainAgentDir
    process.env.MULLUSI_STATE_DIR = tmpDir;
    process.env.MULLUSI_AGENT_DIR = mainAgentDir;
