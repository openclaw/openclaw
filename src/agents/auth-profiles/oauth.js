...
import { formatProviderAuthProfileApiKeyWithPlugin, refreshProviderOAuthCredentialWithPlugin, } from "../../plugins/provider-runtime.runtime.js";
...
export function isRefreshTokenReusedError(error) {
...
export function resetOAuthRefreshQueuesForTest() {
...
export async function resolveApiKeyForProfile(params) {
    ...
    try {
        ...
        const refreshedStore = error instanceof OAuthManagerRefreshError
        ...
        const surfacedMessageError = error instanceof OAuthManagerRefreshError && error.code === "refresh_contention"
            ? error
            : surfacedCause;
