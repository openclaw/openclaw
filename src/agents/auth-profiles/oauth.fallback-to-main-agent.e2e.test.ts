...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveSmartAgentNeoAgentDir() returns mainAgentDir
    process.env.SMART_AGENT_NEO_STATE_DIR = tmpDir;
    process.env.SMART_AGENT_NEO_AGENT_DIR = mainAgentDir;
