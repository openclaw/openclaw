...
function computeNextProfileUsageStats(params: {
  ...
  if (params.reason === "billing" || params.reason === "auth_permanent") {
    ...
    // Always record the model that just failed so that
    // isProfileInCooldown(..., forModel) is accurate for the latest failure.
    updatedStats.cooldownModel = params.model;
  }
