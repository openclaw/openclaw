...
import { clearAuthProfileCooldown, clearExpiredCooldowns, isProfileInCooldown } from "./usage.js";
...
describe("clearAuthProfileCooldown", () => {
  it("clears disabledUntil and disabledReason along with cooldownUntil", async () => {
    const store = makeStore({
      "anthropic:default": {
