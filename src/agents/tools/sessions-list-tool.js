...
import { describeSessionsListTool, SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, } from "../tool-description-presets.js";
    ...
    return {
        ...
        execute: async (_toolCallId, args) => {
            ...
            for (const entry of sessions) {
                ...
                const entryOrigin = entry.origin && typeof entry.origin === "object"
                    ? entry.origin
                    : undefined;
                const originChannel = typeof entryOrigin?.provider === "string" ? entryOrigin.provider : undefined;
                ...
                const deliveryThreadId = typeof deliveryContext?.threadId === "string" ||
                ...
                const row = {
                    ...
                    origin: originChannel ||
                        ...
                        : undefined,
                    spawnedBy: typeof entry.spawnedBy === "string"
                    ...
                    parentSessionKey: typeof entry.parentSessionKey === "string"
                        ? resolveDisplaySessionKey({
                    ...
                    estimatedCostUsd: typeof entry.estimatedCostUsd === "number" ? entry.estimatedCostUsd : undefined,
                    ...
                    childSessions: Array.isArray(entry.childSessions)
                        ? entry.childSessions
                            ...
                            .map((value) => resolveDisplaySessionKey({
                            key: value,
                            alias,
                            mainKey,
                        }))
