      ...
      : params.provider === "perplexity"
        ...
        : params.provider === "kimi"
          ...
          : params.provider === "gemini"
            ...
            : params.provider === "ark"
              ? `${params.provider}:${params.query}:${params.arkBaseUrl ?? DEFAULT_ARK_BASE_URL}:${params.arkModel ?? DEFAULT_ARK_MODEL}`
  ...
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      const result = await runWebSearch({
        ...
        apiKey,
        timeoutSeconds: resolveTimeoutSeconds(finalTimeoutSeconds, DEFAULT_TIMEOUT_SECONDS),
