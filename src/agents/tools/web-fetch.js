...
const DEFAULT_FETCH_MAX_CHARS = 50000;
const DEFAULT_FETCH_MAX_RESPONSE_BYTES = 2000000;
const FETCH_MAX_RESPONSE_BYTES_MIN = 32000;
const FETCH_MAX_RESPONSE_BYTES_MAX = 10000000;
const DEFAULT_FETCH_MAX_REDIRECTS = 3;
const DEFAULT_ERROR_MAX_CHARS = 4000;
const DEFAULT_ERROR_MAX_BYTES = 64000;
