...
export function createCanvasTool(options?: { config?: OpenClawConfig }): AnyAgentTool {
  ...
  return {
    ...
    description: [
      ...
      "## A2UI (a2ui_push)",
      "",
      "Send newline-delimited JSON (JSONL) to render or update a UI surface. Each push is two JSONL lines.",
      "",
      "Format:",
      '  Line 1: {"beginRendering":{"surfaceId":"<id>","root":"<root-component-id>"}}',
      '  Line 2: {"surfaceUpdate":{"surfaceId":"<id>","components":[{"id":"<id>","component":{"<Type>":{...props}}}]}}',
      "",
      "To update an existing surface: send only surfaceUpdate with the same surfaceId (components merge by id).",
      "",
      "Components:",
      '  Text    — {"text":{"literalString":"Hello"},"usageHint":"h1|h2|h3|h4|h5|body|caption"}',
      '  Card    — {"child":"<component-id>"}  (single child, renders with border/shadow)',
      '  Column  — {"children":["id1","id2"],"distribution":"start|center|end|spaceBetween|spaceEvenly"}',
      '  Row     — {"children":["id1","id2"],"distribution":"..."}',
      '  Button  — {"child":"<label-id>","primary":true,"action":{"name":"<action>","context":[]}}',
      '  Image   — {"url":{"literalString":"https://..."},"fit":"contain|cover|fill"}',
      '  Icon    — {"name":{"literalString":"<material-icon-name>"}}',
      "  Divider — {}",
      "",
      "Minimal example:",
      '  {"beginRendering":{"surfaceId":"main","root":"card"}}',
      '  {"surfaceUpdate":{"surfaceId":"main","components":[{"id":"card","component":{"Card":{"child":"col"}}},{"id":"col","component":{"Column":{"children":["t1","t2"]}}},{"id":"t1","component":{"Text":{"text":{"literalString":"Title"},"usageHint":"h3"}}},{"id":"t2","component":{"Text":{"text":{"literalString":"Body text"},"usageHint":"body"}}}]}}',
      "",
      "Spec: A2UI v0.8 — https://github.com/google/A2UI",
    ].join("\n"),
