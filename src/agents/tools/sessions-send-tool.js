...
import { describeSessionsSendTool, SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, } from "../tool-description-presets.js";
import { jsonResult, readStringParam } from "./common.js";
import { createSessionVisibilityGuard, createAgentToAgentPolicy, resolveEffectiveSessionToolsVisibility, resolveSessionReference, resolveSessionToolContext, resolveVisibleSessionReference, } from "./sessions-helpers.js";
...
export function createSessionsSendTool(opts) {
    return {
        ...
        execute: async (_toolCallId, args) => {
            ...
            const baselineReply = timeoutSeconds === 0
                ? undefined
            ...
            const skipA2AFlow = isRequesterParentOfBackgroundAcpSession(targetSessionEntry, effectiveRequesterKey);
