...
function buildReactionSchema() {
  return {
    messageId: Type.Optional(
      Type.String({
        description:
          "Target message id for reaction. For Telegram and WhatsApp, if omitted, defaults to the current inbound message id when available.",
      }),
    ),
    message_id: Type.Optional(
      Type.String({
        ...
        description:
          "snake_case alias of messageId. For Telegram and WhatsApp, if omitted, defaults to the current inbound message id when available.",
      }),
    ),
