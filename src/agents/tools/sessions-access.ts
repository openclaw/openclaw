...
export function resolveSessionToolsVisibility(cfg: ActiviConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: ActiviConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: ActiviConfig): AgentToAgentPolicy {
