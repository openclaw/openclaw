...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<MullusiConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<MullusiConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: MullusiConfig): WebSearchConfig {
