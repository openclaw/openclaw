...
function resolveMemoryToolContext(options: { config?: ActiviConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: ActiviConfig): MemoryCitationsMode {
