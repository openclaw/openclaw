...
import { buildAgentMainSessionKey, DEFAULT_AGENT_ID, parseAgentSessionKey, resolveAgentIdFromSessionKey, } from "../../routing/session-key.js";
import { applyModelOverrideToSessionEntry } from "../../sessions/model-overrides.js";
import { normalizeOptionalLowercaseString } from "../../shared/string-coerce.js";
import { buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "../../tasks/task-owner-access.js";
import { formatTaskStatusDetail, formatTaskStatusTitle } from "../../tasks/task-status.js";
import { loadModelCatalog } from "../model-catalog.js";
import { buildAllowedModelSet, buildConfiguredModelCatalog, buildModelAliasIndex, modelKey, resolveDefaultModelForAgent, resolveModelRefFromString, resolveThinkingDefault, } from "../model-selection.js";
import { describeSessionStatusTool, SESSION_STATUS_TOOL_DISPLAY_SUMMARY, } from "../tool-description-presets.js";
import { readStringParam } from "./common.js";
import { createSessionVisibilityGuard, shouldResolveSessionIdInput, createAgentToAgentPolicy, resolveEffectiveSessionToolsVisibility, resolveInternalSessionKey, resolveSessionReference, resolveSandboxedSessionToolContext, resolveVisibleSessionReference, } from "./sessions-helpers.js";
...
function loadCommandsStatusRuntime() {
    commandsStatusRuntimePromise ??=
        import("./session-status.runtime.js");
...
function formatSessionTaskLine(params) {
    ...
    const headline = snapshot.activeCount > 0
    ...
    return {
        ...
        execute: async (_toolCallId, args) => {
            ...
            const resolveVisibilityMainSessionKey = (sessionAgentId) => {
                ...
                if (resolveAgentIdFromSessionKey(visibilityRequesterKey) === sessionAgentId &&
            ...
            const shouldTreatVisibilityTargetAsSelf = resolvedViaImplicitCurrentFallback ||
            ...
            const primaryModelLabel = providerForCard && defaultModelForCard
                ? `${providerForCard}/${defaultModelForCard}`
                : defaultModelForCard;
            const isGroup = statusSessionEntry.chatType === "group" ||
            ...
            const statusText = await buildStatusText({
                ...
                storePath,
                statusChannel: statusSessionEntry.channel ??
                ...
                resolveDefaultThinkingLevel: async () => {
                    ...
                    const shouldHydrateRuntimeCatalog = configuredCatalog.length === 0 ||
                    ...
                    const runtimeCatalog = shouldHydrateRuntimeCatalog
                        ...
                        : undefined;
                    const runtimeSelectedEntry = runtimeCatalog?.find((entry) => entry.provider === providerForCard && entry.id === defaultModelForCard);
                    const catalog = runtimeSelectedEntry || configuredCatalog.length === 0
