...
import { describeSessionsSpawnTool, SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, } from "../tool-description-presets.js";
...
export function createSessionsSpawnTool(opts) {
    return {
        ...
        execute: async (_toolCallId, args) => {
            ...
            if (unsupportedParam) {
                throw new ToolInputError(`sessions_spawn does not support "${unsupportedParam}". Use "message" or "sessions_send" for channel delivery.`);
            }
            ...
            const context = params.context === "fork" || params.context === "isolated" ? params.context : undefined;
            ...
            if (runtime === "acp") {
                ...
                const shouldTrackViaRegistry = result.status === "accepted" &&
            ...
            const result = await spawnSubagentDirect({
                ...
                expectsCompletionMessage,
                attachments,
                attachMountPath: params.attachAs && typeof params.attachAs === "object"
                    ? readStringParam(params.attachAs, "mountPath")
                    : undefined,
            }, {
                agentSessionKey: opts?.agentSessionKey,
                agentChannel: opts?.agentChannel,
