 ...
 */
export function detectCursorKeyMode(
	raw: string,
): "application" | "normal" | null {
...
export const DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS =
	DEFAULT_APPROVAL_TIMEOUT_MS + 10_000;
...
export function emitExecSystemEvent(
	...
	requestHeartbeatNow(
		scopedHeartbeatWakeOptions(sessionKey, { reason: "exec-event" }),
	);
}
