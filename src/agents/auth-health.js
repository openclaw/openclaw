import { DEFAULT_OAUTH_REFRESH_MARGIN_MS, evaluateStoredCredentialEligibility, resolveTokenExpiryState, } from "./auth-profiles/credential-state.js";
...
export function buildAuthHealthSummary(params) {
    ...
    const profiles = Object.entries(params.store.profiles)
        .filter(([_, cred]) => providerFilter ? providerFilter.has(normalizeProviderId(cred.provider)) : true)
