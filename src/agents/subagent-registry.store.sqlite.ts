...
export function bindSubagentRunRecord(entry: SubagentRunRecord): BoundSubagentRunRecord {
  ...
  return {
    ...
    expected_requester_lifecycle_revision: normalized.expectedRequesterLifecycleRevision ?? null,
    ...
    requester_settle_wake_lifecycle_mismatch: requesterSettleWake?.lifecycleMismatch ?? null,
