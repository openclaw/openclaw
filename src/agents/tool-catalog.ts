...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  // Per-action cron tools (WOR-317). The legacy "cron" super-tool stays in the
  // catalog for back-compat with shipped configs that reference the bundled
  // name. Newer call sites should pick the specific action.
  {
    id: "cron_status",
    label: "cron_status",
    description: "Cron runtime status",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "cron_get",
    label: "cron_get",
    description: "Get a cron job by name",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "cron_wake",
    label: "cron_wake",
    description: "Queue a wake event",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
