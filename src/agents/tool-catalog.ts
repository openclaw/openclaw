...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "mcp",
    label: "mcp",
    description: "MCP catalog and tool bridge",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "todo_write",
    label: "todo_write",
    description: "Write compatibility todo snapshots",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "config_compat",
    label: "config_compat",
    description: "Read runtime config snapshot",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    description: "Capture user question prompts",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    description: "Send compatibility user messages",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    ...
    description: "Trigger remote HTTP endpoints",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "testing_permission",
    label: "testing_permission",
    description: "Permission testing helper",
    sectionId: "automation",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
