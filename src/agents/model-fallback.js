...
import { ensureAuthProfileStore, getSoonestCooldownExpiry, isProfileInCooldown, resolveProfilesUnavailableReason, resolveAuthProfileOrder, } from "./auth-profiles.js";
...
const MIN_PROBE_INTERVAL_MS = 30000; // 30 seconds between probes per key
...
function resolveCooldownDecision(params) {
    ...
    const isPersistentIssue = inferredReason === "auth" ||
