...
export function hashCliSessionText(
...
export function resolveCliSessionReuse(params: {
	...
	const currentExtraSystemPromptHash = trimOptional(
		params.extraSystemPromptHash,
	);
	...
	const storedExtraSystemPromptHash = trimOptional(
