...
export const DEFAULT_CONSTITUTION_FILENAME = "CONSTITUTION.md";
...
export type WorkspaceBootstrapFileName =
  ...
  | typeof DEFAULT_CONSTITUTION_FILENAME
...
export async function loadWorkspaceBootstrapFiles(dir: string): Promise<WorkspaceBootstrapFile[]> {
  ...
  const entries: Array<{
    ...
    {
      name: DEFAULT_CONSTITUTION_FILENAME,
      filePath: path.join(resolvedDir, DEFAULT_CONSTITUTION_FILENAME),
    },
  ];
