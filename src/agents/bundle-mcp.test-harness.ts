...
const SDK_SERVER_MCP_PATH = require.resolve(
	"@modelcontextprotocol/sdk/server/mcp.js",
);
const SDK_SERVER_STDIO_PATH = require.resolve(
	"@modelcontextprotocol/sdk/server/stdio.js",
);
const SDK_CLIENT_INDEX_PATH = require.resolve(
	"@modelcontextprotocol/sdk/client/index.js",
);
const SDK_CLIENT_STDIO_PATH = require.resolve(
...
export async function writeClaudeBundle(params: {
	...
	await fs.mkdir(path.join(params.pluginRoot, ".claude-plugin"), {
		recursive: true,
	});
	await fs.writeFile(
