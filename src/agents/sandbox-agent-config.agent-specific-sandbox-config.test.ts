...
async function resolveContext(config: BotConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): BotConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
