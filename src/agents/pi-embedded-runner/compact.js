...
import { prepareProviderRuntimeAuth, resolveProviderTextTransforms, transformProviderSystemPrompt, } from "../../plugins/provider-runtime.js";
...
import { makeBootstrapWarn, resolveBootstrapContextForRun, resolveContextInjectionMode, } from "../bootstrap-files.js";
...
import { applyAuthHeaderOverride, applyLocalNoAuthHeaderOverride, getApiKeyForModel, resolveModelAuthMode, } from "../model-auth.js";
...
import { resolveEmbeddedAgentApiKey, resolveEmbeddedAgentBaseStreamFn, resolveEmbeddedAgentStreamFn, } from "./stream-resolution.js";
import { applySystemPromptOverrideToSession, buildEmbeddedSystemPrompt, createSystemPromptOverride, } from "./system-prompt.js";
import { collectAllowedToolNames, collectRegisteredToolNames, toSessionToolAllowlist, } from "./tool-name-allowlist.js";
...
function prepareCompactionSessionAgent(params) {
    ...
    return applyExtraParamsToAgent(params.session.agent, params.config, params.provider, params.modelId, undefined, params.thinkLevel, params.sessionAgentId, params.effectiveWorkspace, params.effectiveModel, params.agentDir, undefined, preparedRuntimeExtraParams ? { preparedExtraParams: preparedRuntimeExtraParams } : undefined);
}
...
export async function compactEmbeddedPiSessionDirect(params) {
    ...
    try {
        ...
        const effectiveModel = applyAuthHeaderOverride(applyLocalNoAuthHeaderOverride(ctxInfo.tokens < (runtimeModelWithContext.contextWindow ?? Infinity)
            ...
            : runtimeModelWithContext, apiKeyInfo), 
        ...
        hasRuntimeAuthExchange ? null : apiKeyInfo, params.config);
        const runtimePlan = params.runtimePlan ??
        ...
        try {
            ...
            const sessionManager = guardSessionManager(SessionManager.open(params.sessionFile), {
                ...
                missingToolResultText: model.api === "openai-responses" ||
            ...
            if (shouldUseWebSocketTransport && !wsApiKey) {
                log.warn(`[ws-stream] no API key for provider=${provider}; keeping compaction HTTP transport`);
            }
            while (true) {
                ...
                try {
                    ...
                    let postCompactionLeafId = typeof sessionManager.getLeafId === "function"
