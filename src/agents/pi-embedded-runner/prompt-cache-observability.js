...
export function collectPromptCacheToolNames(tools) {
...
export function completePromptCacheObservation(params) {
    ...
    const hasMeaningfulDrop = cacheRead < previousCacheRead * MAX_STABLE_CACHE_READ_RATIO &&
...
export function resetPromptCacheObservabilityForTest() {
    trackers.clear();
}
