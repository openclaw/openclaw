...
import { downgradeOpenAIFunctionCallReasoningPairs, isCloudCodeAssistFormatError, resolveBootstrapMaxChars, resolveBootstrapTotalMaxChars, validateAnthropicTurns, validateGeminiTurns, } from "../../pi-embedded-helpers.js";
...
export function wrapOllamaCompatNumCtx(baseFn, numCtx) {
    ...
    try {
        ...
        try {
            ...
            if (params.model.api === "ollama") {
                ...
                const providerBaseUrl = typeof providerConfig?.baseUrl === "string" ? providerConfig.baseUrl : undefined;
            ...
            const providerIdForNumCtx = typeof params.model.provider === "string" && params.model.provider.trim().length > 0
            ...
            if (shouldInjectNumCtx) {
                const numCtx = Math.max(1, Math.floor(params.model.contextWindow ?? params.model.maxTokens ?? DEFAULT_CONTEXT_TOKENS));
