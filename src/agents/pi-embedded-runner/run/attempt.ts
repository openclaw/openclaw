...
export async function runEmbeddedAttempt(
  ...
  const activeRunKey = params.replyRunKey?.trim() || params.sessionKey;
  ...
  try {
    ...
    try {
      ...
      const subscription = subscribeEmbeddedPiSession(
        buildEmbeddedSubscriptionParams({
          ...
          onBeforeLifecycleTerminal: () => {
            ...
            clearActiveEmbeddedRun(params.sessionId, queueHandle, activeRunKey);
          },
      ...
      setActiveEmbeddedRun(params.sessionId, queueHandle, activeRunKey);
