...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const toolsRaw = params.disableTools
      ? []
      : createSmartAgentNeoCodingTools({
          exec: {
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/betterbrand/smart-agent-neo/issues/9282
      ...
      // See: https://github.com/betterbrand/smart-agent-neo/issues/8643
      await flushPendingToolResultsAfterIdle({
        agent: session?.agent,
        sessionManager,
      });
