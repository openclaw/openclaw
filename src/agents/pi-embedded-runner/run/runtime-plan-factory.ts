...
export function buildEmbeddedRunAttemptInput(params: {
  ...
  return {
    ...
    sourceReplyDeliveryMode: params.runParams.sourceReplyDeliveryMode,
    modelRun: params.runParams.modelRun,
    promptMode: params.runParams.promptMode,
    ...
    ownerOnlyToolAllowlist: params.runParams.ownerOnlyToolAllowlist,
