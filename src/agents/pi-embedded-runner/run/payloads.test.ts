...
describe("buildEmbeddedRunPayloads", () => {
  ...
  it("adds a fallback error when a tool fails and no assistant output exists", () => {
    const payloads = buildEmbeddedRunPayloads({
      ...
      toolErrors: [{ toolName: "browser", error: "tab not found" }],
      sessionKey: "session:telegram",
      inlineToolResultsAllowed: false,
      verboseLevel: "off",
      reasoningLevel: "off",
  ...
  it("adds tool error fallback when the assistant only invoked tools", () => {
    const payloads = buildEmbeddedRunPayloads({
      ...
      toolErrors: [{ toolName: "exec", error: "Command exited with code 1" }],
      sessionKey: "session:telegram",
      inlineToolResultsAllowed: false,
      verboseLevel: "off",
      reasoningLevel: "off",
  ...
  it("suppresses recoverable tool errors containing 'required'", () => {
    const payloads = buildEmbeddedRunPayloads({
      ...
      toolMetas: [],
      lastAssistant: undefined,
      toolErrors: [{ toolName: "message", meta: "reply", error: "text required" }],
      sessionKey: "session:telegram",
      inlineToolResultsAllowed: false,
      verboseLevel: "off",
      reasoningLevel: "off",
  ...
  it("suppresses recoverable tool errors containing 'missing'", () => {
    const payloads = buildEmbeddedRunPayloads({
      ...
      toolMetas: [],
      lastAssistant: undefined,
      toolErrors: [{ toolName: "message", error: "messageId missing" }],
      sessionKey: "session:telegram",
      inlineToolResultsAllowed: false,
      verboseLevel: "off",
      reasoningLevel: "off",
  ...
  it("suppresses recoverable tool errors containing 'invalid'", () => {
    const payloads = buildEmbeddedRunPayloads({
      ...
      toolMetas: [],
      lastAssistant: undefined,
      toolErrors: [{ toolName: "message", error: "invalid parameter: to" }],
      sessionKey: "session:telegram",
      inlineToolResultsAllowed: false,
      verboseLevel: "off",
      reasoningLevel: "off",
  ...
  it("shows non-recoverable tool errors to the user", () => {
    const payloads = buildEmbeddedRunPayloads({
      ...
      toolMetas: [],
      lastAssistant: undefined,
      toolErrors: [{ toolName: "browser", error: "connection timeout" }],
      sessionKey: "session:telegram",
      inlineToolResultsAllowed: false,
      verboseLevel: "off",
      reasoningLevel: "off",
