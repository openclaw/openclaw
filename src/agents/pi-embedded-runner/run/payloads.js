...
import { extractAssistantThinking, extractAssistantVisibleText, formatReasoningMessage, } from "../../pi-embedded-utils.js";
...
function resolveRawAssistantAnswerText(lastAssistant) {
    ...
    return (normalizeOptionalString(extractAssistantTextForPhase(lastAssistant, { phase: "final_answer" }) ??
...
export function buildEmbeddedRunPayloads(params) {
    ...
    const errorText = params.lastAssistant && lastAssistantErrored
    ...
    const shouldPreferRawAnswerText = rawAnswerHasMedia &&
    ...
    if (params.lastToolError) {
        ...
        if (warningPolicy.showWarning) {
            ...
            const errorSuffix = warningPolicy.includeDetails && params.lastToolError.error
