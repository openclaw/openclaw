...
import { resolveEffectiveToolPolicy, resolveGroupContextFromSessionKey, resolveGroupToolPolicy, resolveSubagentToolPolicyForSession, } from "../pi-tools.policy.js";
...
import { applyOwnerOnlyToolPolicy, mergeAlsoAllowPolicy, resolveToolProfilePolicy, } from "../tool-policy.js";
...
export function applyFinalEffectiveToolPolicy(params) {
    ...
    if (trustedGroup.dropped) {
        params.warn("effective tool policy: dropping caller-provided groupId that does not match session-derived group context");
    }
    ...
    const subagentPolicy = params.sessionKey &&
