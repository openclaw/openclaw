...
import { createExpiringMapCache, isCacheEnabled, resolveCacheTtlMs, } from "../../config/cache-utils.js";
...
export function createSessionManagerCache(options) {
    const getTtlMs = () => typeof options?.ttlMs === "function"
        ? options.ttlMs()
...
export function isSessionManagerCached(sessionFile) {
