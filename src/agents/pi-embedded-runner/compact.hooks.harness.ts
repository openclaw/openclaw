...
export const createMullusiCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createMullusiCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveMullusiDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createMullusiCodingTools: createMullusiCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveMullusiAgentDir: vi.fn(() => "/tmp"),
  }));
