...
export function createOpenRouterSystemCacheWrapper(baseStreamFn) {
...
export function createOpenRouterWrapper(baseStreamFn, thinkingLevel) {
    const underlying = baseStreamFn ?? streamSimple;
    return (model, context, options) => {
...
export function isProxyReasoningUnsupported(modelId) {
    return isProxyReasoningUnsupportedModelHint(modelId);
}
export function createKilocodeWrapper(baseStreamFn, thinkingLevel) {
    const underlying = baseStreamFn ?? streamSimple;
    return (model, context, options) => {
        const headers = resolveProviderRequestPolicyConfig({
