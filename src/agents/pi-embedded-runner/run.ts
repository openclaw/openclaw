...
export async function runEmbeddedPiAgent(
  ...
  const effectiveReplyRunKey =
    normalizeOptionalString(params.replyRunKey) ??
    normalizeOptionalString(params.sessionKey) ??
    params.sessionId;
  const sessionLane = resolveSessionLane(
    normalizeOptionalString(params.sessionLaneKey) ?? effectiveReplyRunKey,
  );
      ...
      try {
        ...
        while (true) {
          ...
          const rawAttempt = await runEmbeddedAttemptWithBackend({
            ...
            currentMessageParticipant: params.currentMessageParticipant,
            ...
            replyRunKey: effectiveReplyRunKey,
            sessionLaneKey: normalizeOptionalString(params.sessionLaneKey) ?? effectiveReplyRunKey,
          });
