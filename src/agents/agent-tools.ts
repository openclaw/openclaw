...
import {
  type AgentRunIdentityOptions,
  type ExecCompletionRoutingOptions,
  resolveExecCompletionRouting,
} from "./agent-tools.exec-completion-routing.js";
...
type OpenClawCodingToolsOptions = AgentRunIdentityOptions &
  ...
  const coreTools = createCoreCodingTools({
    ...
    execDefaults: {
      ...
      ...resolveExecCompletionRouting({
        ...
        sessionKey: options?.sessionKey,
        runSessionKey: options?.runSessionKey,
        completionSessionKey: options?.execCompletionSessionKey,
        completionSessionGeneration: options?.execCompletionSessionGeneration,
