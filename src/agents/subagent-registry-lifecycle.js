...
import { completeTaskRunByRunId, failTaskRunByRunId, setDetachedTaskDeliveryStatusByRunId, } from "../tasks/detached-task-runtime.js";
...
export function createSubagentRegistryLifecycleController(params) {
    const scheduledResumeTimers = new Set();
    ...
    const completeSubagentRun = async (completeParams) => {
        ...
        const cleanupBrowserSessions = params.cleanupBrowserSessionsForLifecycleEnd ??
