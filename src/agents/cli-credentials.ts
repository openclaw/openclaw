...
export function readClaudeCliCredentials(options?: {
  ...
  if (platform === "darwin" && options?.allowKeychainPrompt !== false) {
    ...
    const keychainCreds = readClaudeCliKeychainCredentialsSync();
    if (keychainCreds) {
