...
// Detect synthetic fallback IDs generated by the live stream normalizer
// (e.g. "call_auto_1", "callauto", "CallAuto3"). These should never appear
// as persisted tool names — they leak when models echo back fallback IDs.
...
function hasToolCallName(block: RawToolCallBlock, allowedToolNames: Set<string> | null): boolean {
  ...
  // Synthetic auto-generated fallback IDs should never appear as tool names
  // in persisted transcripts; drop them so they don't poison later turns.
