...
export function normalizeGpt5PromptOverlayMode(value) {
...
export function resolveGpt5PromptOverlayMode(config, legacyPluginConfig, params) {
    ...
    return (normalizeGpt5PromptOverlayMode(config?.agents?.defaults?.promptOverlays?.gpt5?.personality) ??
...
export function isGpt5ModelId(modelId) {
...
export function resolveGpt5SystemPromptContribution(params) {
    ...
    return {
        ...
        sectionOverrides: mode === "friendly" ? { interaction_style: GPT5_FRIENDLY_PROMPT_OVERLAY } : {},
    };
}
