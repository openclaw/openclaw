  ...
  tools: {
    ...
    peekaboo: {
      ...
      actions: {
        ...
        see: {
          label: "see",
          detailKeys: ["app", "windowTitle", "windowId", "screenIndex", "mode"],
        },
        image: {
          label: "image",
          detailKeys: ["app", "windowTitle", "windowId", "screenIndex", "mode", "format"],
        },
        click: {
          label: "click",
          detailKeys: ["on", "id", "coords", "x", "y", "app"],
        },
        type: {
          label: "type",
          detailKeys: ["text", "app"],
        ...
        scroll: {
          label: "scroll",
          detailKeys: ["direction", "amount", "app"],
        },
        window_set_bounds: {
          label: "window bounds",
          detailKeys: ["app", "windowTitle", "windowId", "x", "y", "width", "height"],
        },
      },
    },
    canvas: {
