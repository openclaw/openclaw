...
import { ensureAuthProfileStore, loadAuthProfileStoreForSecretsRuntime, } from "./auth-profiles/store.js";
...
export function resolvePiCredentialsForDiscovery(agentDir, options) {
    const store = options?.readOnly === true
