...
import { buildFullBootstrapPromptLines, buildLimitedBootstrapPromptLines, } from "./bootstrap-prompt.js";
import { normalizePromptCapabilityIds, normalizeStructuredPromptSection, } from "./prompt-cache-stability.js";
...
function buildExecApprovalPromptGuidance(params) {
    ...
    const usesNativeApprovalUi = params.inlineButtonsEnabled ||
        (runtimeChannel
...
export function buildAgentSystemPrompt(params) {
    ...
    const providerSectionOverrides = Object.fromEntries(Object.entries(promptContribution?.sectionOverrides ?? {})
        .map(([key, value]) => [
        key,
    ...
    const fullAccessBlockedReasonLabel = elevated?.fullAccessAvailable === false
