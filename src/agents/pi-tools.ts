...
function resolveExecConfig(params: { cfg?: SmartAgentNeoConfig; agentId?: string }) {
...
function resolveFsConfig(params: { cfg?: SmartAgentNeoConfig; agentId?: string }) {
  const cfg = params.cfg;
...
export function createSmartAgentNeoCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      const wrapped = createSmartAgentNeoReadTool(freshReadTool);
