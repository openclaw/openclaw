...
export function describeSessionsListTool() {
    return [
...
export function describeSessionsHistoryTool() {
    return [
...
export function describeSessionsSendTool() {
    return [
...
export function describeSessionsSpawnTool() {
    return [
...
export function describeSessionStatusTool() {
    return [
...
export function describeUpdatePlanTool() {
    return [
