...
describe("runEmbeddedAgent incomplete-turn safety", () => {
  ...
  it.each([
    ...
    "Please provide a plan for deleting production backups.",
    "Please generate a plan for deleting production backups.",
    "Please produce an approach for deleting production backups.",
    "Please develop a strategy for deleting production backups.",
    "Please formulate a plan for deleting production backups.",
    "Please design an outline for deleting production backups.",
    "Please build a plan for deleting production backups.",
    "Please put together a plan for deleting production backups.",
    "Please come up with a plan for deleting production backups.",
    "Please suggest a plan for deleting production backups.",
  ...
  it.each([
    ...
    "Please provide a plan and then delete old backups.",
