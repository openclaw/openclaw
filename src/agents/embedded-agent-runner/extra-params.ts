...
function resolveRequestExtraParams(params: {
  ...
  return params.override ? { ...baseExtraParams, ...params.override } : params.effectiveExtraParams;
}
...
export function applyExtraParamsToAgent(
  ...
  if (hasNativeWebSearchRequest(requestExtraParams) && !providerWrapperHandled) {
    throw new Error(
      "web_search_options require native OpenAI/Codex web_search, but the selected provider does not install a native web_search wrapper",
    );
  }
