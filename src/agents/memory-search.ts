...
export type ResolvedMemorySearchConfig = {
  ...
  extraPaths: string[];
  provider: "openai" | "local" | "gemini" | "voyage" | "mistral" | "jina" | "ollama" | "auto";
  remote?: {
    baseUrl?: string;
    apiKey?: string;
  ...
  fallback: "openai" | "gemini" | "local" | "voyage" | "mistral" | "jina" | "ollama" | "none";
  model: string;
  local: {
    modelPath?: string;
...
const DEFAULT_JINA_MODEL = "jina-embeddings-v5-text-nano";
