...
type MullusiToolsDeps = {
  callGateway: typeof callGateway;
  config?: MullusiConfig;
};

const defaultMullusiToolsDeps: MullusiToolsDeps = {
  callGateway,
};

let openClawToolsDeps: MullusiToolsDeps = defaultMullusiToolsDeps;

export function createMullusiTools(
  options?: {
...
export const __testing = {
  setDepsForTest(overrides?: Partial<MullusiToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultMullusiToolsDeps,
          ...overrides,
        }
      : defaultMullusiToolsDeps;
  },
