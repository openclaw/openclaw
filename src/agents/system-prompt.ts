...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "CRITICAL: Never run `launchctl bootout` directly to restart the gateway.",
    "Use `openclaw gateway restart` instead — it handles both stop and start atomically.",
    "Running bootout alone leaves the gateway permanently stopped.",
    "",
