...
export function buildAgentSystemPrompt(params: {
  ...
  // extraSystemPrompt (group intro / subagent context) must appear before
  // Heartbeats so that its silent-token guidance cannot override HEARTBEAT_OK
  // rules via instruction-recency bias.
  ...
  // Dynamic per-conversation sections placed last for LLM prefix caching.
  lines.push(
