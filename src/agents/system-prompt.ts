...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Cached Media",
    "Media removed from context during pruning may be cached to disk. Look for `[media cached: <path> (<mime>) kind=<kind>]` markers in prior messages. For images, reference the path to re-view it. For audio/video/documents, the file is available at the cached path.",
    "",
    ...safetySection,
