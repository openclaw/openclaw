...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "When broker mode is enabled, do not rely on securitySentinelApproved; include securitySentinelToken + securitySentinelLane + securitySentinelLaneCredential from the approval UI and execute only that exact approved action.",
