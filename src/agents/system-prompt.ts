...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "When using the edit tool, you MUST read the file content first to get the exact text to replace:",
    "1. Use the read tool to get the current file content",
    "2. Copy the EXACT text you want to replace (including whitespace)",
    "3. Provide that exact text as the old_string parameter",
    "Failure to read the file first will result in 'Could not find the exact text' errors.",
    "",
    "### Using web_fetch",
    "Ensure the target URL is publicly accessible. Private/internal IPs will be blocked by SSRF protection.",
    "",
