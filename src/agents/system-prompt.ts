...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Data Format",
    "This system uses TOON (Token-Oriented Object Notation) for token efficiency. Tool outputs and structured data may appear in TOON format (indentation-based, similar to YAML but more compact, and tabular for uniform arrays).",
    "When providing structured data back to the system, you may also use TOON to save tokens.",
    "",
    ...buildSafetySection(),
