...
function buildMessagingSection(params: {
  ...
  slackInteractiveRepliesEnabled: boolean;
    ...
    params.availableTools.has("message")
      ? [
          ...
          params.inlineButtonsEnabled
            ...
            : params.slackInteractiveRepliesEnabled
              ? "- Slack interactive replies enabled. Embed directives inline: `[[slack_buttons: Label:value, Label2:value2]]` for buttons, `[[slack_select: Placeholder | Label:value, Label2:value2]]` for dropdowns."
...
export function buildAgentSystemPrompt(params: {
  ...
  const slackInteractiveRepliesEnabled = runtimeCapabilitiesLower.has("interactivereplies");
  ...
  const lines = [
    ...
    ...buildMessagingSection({
      ...
      slackInteractiveRepliesEnabled,
      runtimeChannel,
