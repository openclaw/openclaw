...
function requireWebSearchTool(config: MullusiConfig, runtimeWebSearch?: RuntimeWebSearchMetadata) {
...
function requireWebFetchTool(config: MullusiConfig, runtimeWebFetch?: RuntimeWebFetchMetadata) {
...
async function prepareAndActivate(params: { config: MullusiConfig; env?: NodeJS.ProcessEnv }) {
...
describe("mullusi tools runtime web metadata wiring", () => {
