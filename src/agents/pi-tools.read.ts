...
function resolveAdaptiveReadMaxBytes(options?: MullusiReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMullusiReadTool(base, {
...
export function createMullusiReadTool(
  base: AnyAgentTool,
  options?: MullusiReadToolOptions,
): AnyAgentTool {
