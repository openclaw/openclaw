...
function resolveAdaptiveReadMaxBytes(options?: ActiviReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createActiviReadTool(base, {
...
export function createActiviReadTool(
  base: AnyAgentTool,
  options?: ActiviReadToolOptions,
): AnyAgentTool {
