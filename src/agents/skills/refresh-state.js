...
export function setSkillsChangeListenerErrorHandler(handler) {
...
export function shouldRefreshSnapshotForVersion(cachedVersion, nextVersion) {
...
export function resetSkillsRefreshStateForTest() {
    listeners.clear();
