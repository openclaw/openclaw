...
function resolveWatchPaths(workspaceDir: string, config?: ActiviConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ActiviConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ActiviConfig }) {
