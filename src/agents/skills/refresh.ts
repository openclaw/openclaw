...
function resolveWatchPaths(workspaceDir: string, config?: EasyHubConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: EasyHubConfig }) {
