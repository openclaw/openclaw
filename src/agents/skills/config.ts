...
import type { DNAConfig, SkillConfig } from "../../config/config.js";
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "dna-bundled";
}

export function resolveBundledAllowlist(config?: DNAConfig): string[] | undefined {
