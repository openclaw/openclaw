...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.mullusi/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "mullusi doctor" and "mullusi approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
