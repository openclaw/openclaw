...
function resolveAvatarSource(cfg: SmartAgentNeoConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SmartAgentNeoConfig, agentId: string): AgentAvatarResolution {
