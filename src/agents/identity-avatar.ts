...
function resolveAvatarSource(cfg: ActiviConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ActiviConfig, agentId: string): AgentAvatarResolution {
