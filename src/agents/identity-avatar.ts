...
function resolveAvatarSource(cfg: DNAConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DNAConfig, agentId: string): AgentAvatarResolution {
