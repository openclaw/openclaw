...
function resolveAvatarSource(cfg: EasyHubConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: EasyHubConfig, agentId: string): AgentAvatarResolution {
