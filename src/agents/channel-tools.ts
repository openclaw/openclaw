...
const channelAgentToolMeta = new WeakMap<
	ChannelAgentTool,
	ChannelAgentToolMeta
>();

export function getChannelAgentToolMeta(
	tool: ChannelAgentTool,
): ChannelAgentToolMeta | undefined {
	return channelAgentToolMeta.get(tool);
}

export function copyChannelAgentToolMeta(
	source: ChannelAgentTool,
	target: ChannelAgentTool,
): void {
