...
import { classifyProviderRuntimeFailureKind, getApiErrorPayloadFingerprint, parseApiErrorInfo, } from "./pi-embedded-helpers.js";
...
export function buildApiErrorObservationFields(rawError, opts) {
...
export function buildTextObservationFields(text, opts) {
