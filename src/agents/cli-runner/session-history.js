...
import { limitAgentHookHistoryMessages, MAX_AGENT_HOOK_HISTORY_MESSAGES, } from "../harness/hook-history.js";
...
export function loadCliSessionHistoryMessages(params) {
    try {
        ...
        const history = entries.flatMap((entry) => entry?.type === "message" ? [entry.message] : []);
