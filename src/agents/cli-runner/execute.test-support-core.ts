/** Shared test doubles for CLI execution supervisor and event seams. */
...
/** Build the injectable CLI execution dependencies around shared test mocks. */
export function createCliRunnerExecuteTestDeps() {
  return {
