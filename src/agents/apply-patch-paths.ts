 ...
 * `*** Begin Patch` / `*** End Patch` envelope, it ignores hunk bodies, and it
 * tolerates malformed input by simply stopping at the first unrecognised line
 * after a header. Empty paths are dropped.
 *
