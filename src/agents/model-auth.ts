...
const AWS_BEARER_ENV = "AWS_BEARER_TOKEN_BEDROCK"; // pragma: allowlist secret (env name)
const AWS_ACCESS_KEY_ENV = "AWS_ACCESS_KEY_ID"; // pragma: allowlist secret (env name)
const AWS_SECRET_KEY_ENV = "AWS_SECRET_ACCESS_KEY"; // pragma: allowlist secret (env name)
const AWS_PROFILE_ENV = "AWS_PROFILE"; // pragma: allowlist secret (env name)
