 ...
 */
export function resolveCompactionInstructions(eventInstructions, runtimeInstructions) {
    const resolved = normalize(eventInstructions) ??
 ...
 */
export function composeSplitTurnInstructions(turnPrefixInstructions, resolvedInstructions) {
