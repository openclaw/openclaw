import type { EasyHubConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: EasyHubConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: EasyHubConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[EasyHub]";
}
