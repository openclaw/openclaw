...
export function describeProcessTool(params?: { hasCronTool?: boolean }): string {
  return [
    ...
    "Use poll/log when you need status, logs, input, intervention, quiet-success confirmation, or completion confirmation when automatic completion wake is unavailable.",
    params?.hasCronTool
