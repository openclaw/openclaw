...
export function describeProcessTool(params?: { hasCronTool?: boolean }): string {
  return [
    ...
    "Use poll/log when you need status, logs, input, intervention, or quiet-success confirmation; silent successful completions do not always auto-wake by default.",
    params?.hasCronTool
