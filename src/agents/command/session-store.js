import { mergeSessionEntry, setSessionRuntimeModel, updateSessionStore, } from "../../config/sessions.js";
...
export async function updateSessionStoreAfterAgentRun(params) {
    ...
    const contextTokens = runtimeContextTokens !== undefined
    ...
    else if (typeof entry.totalTokens === "number" &&
