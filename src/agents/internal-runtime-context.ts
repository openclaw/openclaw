export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_MULLUSI_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_MULLUSI_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[MULLUSI_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[MULLUSI_INTERNAL_CONTEXT_END]]";
