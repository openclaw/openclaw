...
const _OBSERVATION_BEARER_TOKEN = "sk-redact-test-token"; // pragma: allowlist secret
const _OBSERVATION_COOKIE_VALUE = "session-cookie-token"; // pragma: allowlist secret
