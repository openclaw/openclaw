...
function resolveGatewayPort(cfg: ActiviConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: ActiviConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
