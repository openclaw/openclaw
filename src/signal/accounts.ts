...
function mergeSignalAccountConfig(cfg: ActiviConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ActiviConfig): ResolvedSignalAccount[] {
