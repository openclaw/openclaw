...
export function listSignalAccountIds(cfg: SmartAgentNeoConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: SmartAgentNeoConfig): string {
...
function mergeSignalAccountConfig(cfg: SmartAgentNeoConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SmartAgentNeoConfig): ResolvedSignalAccount[] {
