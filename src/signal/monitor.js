...
import { resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce, } from "../config/runtime-group-policy.js";
...
import { formatSignalDaemonExit, spawnSignalDaemon } from "./daemon.js";
...
export async function monitorSignalProvider(opts = {}) {
    ...
    const startupTimeoutMs = Math.min(120000, Math.max(1000, opts.startupTimeoutMs ?? accountInfo.config.startupTimeoutMs ?? 30000));
