...
function resolveResolutionLimits(config: BotConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: BotConfig): SecretProviderConfig {
