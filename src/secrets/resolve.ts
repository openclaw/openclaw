...
function resolveResolutionLimits(config: MullusiConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: MullusiConfig): SecretProviderConfig {
