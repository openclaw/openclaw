...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.discord.accounts.*.voice.tts.minimax.apiKey",
    targetType: "channels.discord.accounts.*.voice.tts.minimax.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.accounts.*.voice.tts.minimax.apiKey",
  ...
  {
    id: "channels.discord.voice.tts.minimax.apiKey",
    targetType: "channels.discord.voice.tts.minimax.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.voice.tts.minimax.apiKey",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
