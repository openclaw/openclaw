...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "plugins.entries.querit.config.webSearch.apiKey",
    targetType: "plugins.entries.querit.config.webSearch.apiKey",
    configFile: "openclaw.json",
    pathPattern: "plugins.entries.querit.config.webSearch.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
