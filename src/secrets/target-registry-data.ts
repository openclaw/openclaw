...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.feishu.accounts.*.tts.providers.elevenlabs.apiKey",
    targetType: "channels.feishu.accounts.*.tts.providers.elevenlabs.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.feishu.accounts.*.tts.providers.elevenlabs.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.feishu.accounts.*.tts.providers.openai.apiKey",
    targetType: "channels.feishu.accounts.*.tts.providers.openai.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.feishu.accounts.*.tts.providers.openai.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
