...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.feishu.tts.elevenlabs.apiKey",
    targetType: "channels.feishu.tts.elevenlabs.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.feishu.tts.elevenlabs.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.feishu.tts.openai.apiKey",
    targetType: "channels.feishu.tts.openai.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.feishu.tts.openai.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
