...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.discord.accounts.*.voice.tts.bailian.apiKey",
    targetType: "channels.discord.accounts.*.voice.tts.bailian.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.accounts.*.voice.tts.bailian.apiKey",
  ...
  {
    id: "channels.discord.voice.tts.bailian.apiKey",
    targetType: "channels.discord.voice.tts.bailian.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.voice.tts.bailian.apiKey",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "messages.tts.bailian.apiKey",
    targetType: "messages.tts.bailian.apiKey",
    configFile: "openclaw.json",
    pathPattern: "messages.tts.bailian.apiKey",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
