...
export const MEMORY_CHECK_INTERVAL_MS = 60_000;
export const DEFAULT_MEMORY_WARN_PERCENT = 75;
export const DEFAULT_MEMORY_CRITICAL_PERCENT = 85;
export const DEFAULT_MEMORY_WARN_MB = 1536;
export const DEFAULT_MEMORY_CRITICAL_MB = 2048;
export const ABORTED_RUN_TTL_MS = 10 * 60_000;
