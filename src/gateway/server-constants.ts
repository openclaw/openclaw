export const MAX_PAYLOAD_BYTES = 5 * 1024 * 1024; // cap incoming frame size (5MB for images)
export const MAX_BUFFERED_BYTES = 10 * 1024 * 1024; // per-connection send buffer limit
...
export const SYNC_INTERVAL_MS = 45_000; // 45 seconds
