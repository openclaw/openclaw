...
beforeAll(async () => {
  previousToken = process.env.ACTIVI_GATEWAY_TOKEN;
  process.env.ACTIVI_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
afterAll(async () => {
  ...
  if (previousToken === undefined) {
    ...
    process.env.ACTIVI_GATEWAY_TOKEN = previousToken;
  }
});
...
test.each([
  { clientId: "activi-ios", platform: "ios" },
  { clientId: "activi-android", platform: "android" },
