...
import { defineSessionGroupRpcTests } from "./test/server-sessions-group-rpc.test-support.js";
import {
...
defineSessionGroupRpcTests({ createSessionStoreDir, defaultAgentWorkspace, openClient });
