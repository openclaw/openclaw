...
function listConfiguredAgentIds(cfg: BotConfig): string[] {
...
export function listAgentsForGateway(cfg: BotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: BotConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: BotConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: BotConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: BotConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: BotConfig): GatewaySessionsDefaults {
