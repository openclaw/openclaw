  ...
  let sessions = Object.entries(store)
    ...
    .map(([key, entry]) => {
      ...
      return {
        ...
        configuredThink: entry?.configuredThink ?? entry?.thinkingLevel ?? "auto",
        effectiveThink: entry?.effectiveThink ?? entry?.lastEffectiveThink,
        lastEffectiveThink: entry?.lastEffectiveThink ?? entry?.effectiveThink,
