...
function listConfiguredAgentIds(cfg: ActiviConfig): string[] {
...
export function listAgentsForGateway(cfg: ActiviConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ActiviConfig): string {
...
function resolveSessionStoreAgentId(cfg: ActiviConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ActiviConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ActiviConfig): GatewaySessionsDefaults {
