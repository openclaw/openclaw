...
function listConfiguredAgentIds(cfg: DNAConfig): string[] {
...
export function listAgentsForGateway(cfg: DNAConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: DNAConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: DNAConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: DNAConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: DNAConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: DNAConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: DNAConfig): GatewaySessionsDefaults {
