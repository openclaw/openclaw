...
function listConfiguredAgentIds(cfg: SmartAgentNeoConfig): string[] {
...
export function listAgentsForGateway(cfg: SmartAgentNeoConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SmartAgentNeoConfig): string {
...
function resolveSessionStoreAgentId(cfg: SmartAgentNeoConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: SmartAgentNeoConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: SmartAgentNeoConfig): GatewaySessionsDefaults {
