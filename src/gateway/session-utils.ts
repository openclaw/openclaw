...
function listConfiguredAgentIds(cfg: EasyHubConfig): string[] {
...
export function listAgentsForGateway(cfg: EasyHubConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: EasyHubConfig): string {
...
function resolveSessionStoreAgentId(cfg: EasyHubConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: EasyHubConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: EasyHubConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: EasyHubConfig): GatewaySessionsDefaults {
