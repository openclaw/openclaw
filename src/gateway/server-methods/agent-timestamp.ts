import type { SmartAgentNeoConfig } from "../../config/types.js";
 ...
 *
 * @see https://github.com/neobot/neobot/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an SmartAgentNeoConfig.
 */
export function timestampOptsFromConfig(cfg: SmartAgentNeoConfig): TimestampInjectionOptions {
  return {
