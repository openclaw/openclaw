import type { EasyHubConfig } from "../../config/types.js";
...
/**
 * Build TimestampInjectionOptions from an EasyHubConfig.
 */
export function timestampOptsFromConfig(cfg: EasyHubConfig): TimestampInjectionOptions {
  return {
