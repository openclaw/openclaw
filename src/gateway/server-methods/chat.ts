  ...
  "chat.send": async ({ params, respond, context, client }) => {
    ...
    try {
      ...
      const ctx: MsgContext = {
        ...
        SenderId: (canInjectSystemProvenance(client) && systemInputProvenance?.senderId) || clientInfo?.id,
        SenderName: (canInjectSystemProvenance(client) && systemInputProvenance?.senderName) || clientInfo?.displayName,
        SenderUsername: (canInjectSystemProvenance(client) && systemInputProvenance?.senderName) || clientInfo?.displayName,
