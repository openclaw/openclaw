  ...
  "tts.status": async ({ respond }) => {
    try {
      ...
      respond(true, {
        ...
        hasSarvamKey: Boolean(resolveTtsApiKey(config, "sarvam")),
    ...
    if (
      ...
      respond(
        ...
        errorShape(
          ...
          "Invalid provider. Use openai, elevenlabs, sarvam, or edge.",
        ),
      );
      return;
    }
      ...
      respond(true, {
        providers: [
          ...
          },
          {
            id: "sarvam",
            name: "Sarvam",
            configured: Boolean(resolveTtsApiKey(config, "sarvam")),
