  ...
  "tts.status": async ({ respond }) => {
    try {
      ...
      respond(true, {
        ...
        hasResembleKey: Boolean(resolveTtsApiKey(config, "resemble")),
    ...
    if (
      ...
      respond(
        ...
        errorShape(
          ...
          "Invalid provider. Use openai, elevenlabs, resemble, or edge.",
        ),
      );
      return;
    }
      ...
      respond(true, {
        providers: [
          ...
          },
          {
            id: "resemble",
            name: "Resemble AI",
            configured: Boolean(resolveTtsApiKey(config, "resemble")),
            models: [],
          },
          {
            id: "edge",
