  ...
  "tts.status": async ({ respond }) => {
    try {
      ...
      respond(true, {
        ...
        hasFishAudioKey: Boolean(resolveTtsApiKey(config, "fishaudio")),
    ...
    if (
      ...
      respond(
        ...
        errorShape(
          ...
          "Invalid provider. Use openai, elevenlabs, fishaudio, or edge.",
        ),
      );
      return;
    }
      ...
      respond(true, {
        providers: [
          ...
          },
          {
            id: "fishaudio",
            name: "Fish Audio",
            configured: Boolean(resolveTtsApiKey(config, "fishaudio")),
            models: [],
          },
          {
            id: "edge",
