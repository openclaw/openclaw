...
vi.mock("../../infra/mullusi-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/mullusi-root.js")>(
    "../../infra/mullusi-root.js",
  );
  return {
    ...actual,
    resolveMullusiPackageRoot: async () => "/tmp/mullusi",
  };
});
