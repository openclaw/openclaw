...
const DEFAULT_REALTIME_INSTRUCTIONS = [
  ...
  `If the user asks for code, repository state, tools, files, todo lists, tasks, priorities, current OpenClaw context, device or home-control actions, lights, or deeper reasoning, call ${REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME} and then summarize the result naturally.`,
  `Do not claim you cannot control devices, use tools, or reach OpenClaw unless ${REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME} returns that failure.`,
