...
// Upstream split the heartbeat runner across scheduler/run/config modules;
// mock the modules the runtime actually imports or the real scheduler starts.
...
vi.mock("../infra/heartbeat-config.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("../infra/heartbeat-config.js")>()),
