...
export function hasAmbiguousGatewayAuthModeConfig(cfg: MullusiConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: MullusiConfig): void {
