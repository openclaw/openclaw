...
import type { SmartAgentNeoConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: SmartAgentNeoConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: SmartAgentNeoConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: SmartAgentNeoConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: SmartAgentNeoConfig) => void;
  log: {
