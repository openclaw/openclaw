...
export function formatGatewayAuthFailureMessage(params: {
  ...
  const uiHint = "open the dashboard URL, click Settings (gear icon), and paste the token";
  ...
  const passwordHint = isCli
    ...
    : isControlUi || isWebchat
      ? "open the dashboard URL, click Settings (gear icon), and enter the password"
