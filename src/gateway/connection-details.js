...
export function buildGatewayConnectionDetailsWithResolvers(options = {}, resolvers = {}) {
    ...
    const urlSourceHint = options.urlSource ?? (cliUrlOverride ? "cli" : envUrlOverride ? "env" : undefined);
