...
// The cron-creator allowlist capture is orthogonal to the byNode behavior under
// test; stub it so the resolver's post-filter step doesn't pull in cron internals.
