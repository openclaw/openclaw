...
function buildSerializationKey(
  ip: string | undefined | AuthRateLimitSubject,
  scope: string | undefined,
): string {
  return `${normalizeScope(scope)}:${normalizeRateLimitClientIp(typeof ip === "object" ? ip.key : ip)}`;
}
