...
import { ConnectErrorDetailCodes, formatConnectErrorMessage, readConnectErrorDetailCode, readConnectErrorRecoveryAdvice, } from "./protocol/connect-error-details.js";
...
function readConnectChallengeTimeoutOverride(opts) {
    if (typeof opts.connectChallengeTimeoutMs === "number" &&
...
export function resolveGatewayClientConnectChallengeTimeoutMs(opts) {
...
export class GatewayClient {
    ...
    pendingConnectErrorDetailCode = null;
    ...
    resolveConnectScopes(params) {
        ...
        if (params.usingStoredDeviceToken &&
    ...
    shouldRetryWithStoredDeviceToken(params) {
        ...
        return (advice.canRetryWithDeviceToken === true ||
    ...
    selectConnectAuth(role) {
        ...
        const shouldUseDeviceRetryToken = this.pendingDeviceTokenRetry &&
            !explicitDeviceToken &&
        ...
        const resolvedDeviceToken = explicitDeviceToken ??
            (shouldUseDeviceRetryToken ||
                ...
                : undefined);
        const reusingStoredDeviceToken = Boolean(resolvedDeviceToken) &&
            !explicitDeviceToken &&
            Boolean(storedToken) &&
    ...
    armConnectChallengeTimeout() {
        ...
        this.connectTimer = setTimeout(() => {
            ...
            this.opts.onConnectError?.(new Error(`gateway connect challenge timeout (waited ${elapsedMs}ms, limit ${connectChallengeTimeoutMs}ms)`));
