...
const METHOD_SCOPE_GROUPS: Record<OperatorScope, readonly string[]> = {
  ...
  [READ_SCOPE]: [
    ...
    "goals.get",
    "goals.tree",
    "budgets.policies.list",
    "budgets.policies.get",
    "budgets.incidents.list",
    "costs.events.list",
    "agents.metrics.get",
    "agents.metrics.list",
  ...
  [ADMIN_SCOPE]: [
    ...
    "goals.update",
    "goals.delete",
    "budgets.policies.create",
    "budgets.policies.update",
    "budgets.policies.delete",
    "budgets.incidents.resolve",
    "approvals.create",
