...
export async function readMcpHttpBody(req) {
...
export function resolveMcpRequestContext(req, cfg, auth) {
    return {
        sessionKey: resolveScopedSessionKey(cfg, getHeader(req, "x-session-key")),
        messageProvider: normalizeMessageChannel(getHeader(req, "x-openclaw-message-channel")) ?? undefined,
