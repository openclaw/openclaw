...
describe("Control UI SPA fallback Accept routing", () => {
  it.each([
    ...
    {
      name: "nonmatching zero-quality parameter does not override an accepting wildcard",
      basePath: "",
      pathname: "/chat",
      method: "GET",
    ...
    {
      name: "nonmatching positive parameter does not override a rejected wildcard",
      basePath: "",
      pathname: "/chat",
      method: "GET",
    ...
    {
      name: "matching charset rejection overrides a less-specific HTML range",
      basePath: "",
      pathname: "/chat",
      method: "GET",
    ...
    {
      name: "mismatched charset rejection does not override matching HTML",
      basePath: "",
      pathname: "/chat",
      method: "GET",
    ...
    {
      name: "exact HTML rejection overrides a parameterized text wildcard",
      basePath: "",
      pathname: "/chat",
      method: "GET",
    ...
    {
      name: "quoted media parameter delimiters remain one nonmatching range",
      basePath: "",
      pathname: "/chat",
      method: "GET",
