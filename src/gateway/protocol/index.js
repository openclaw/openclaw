...
import { AgentEventSchema, AgentIdentityParamsSchema, AgentIdentityResultSchema, AgentParamsSchema, MessageActionParamsSchema, AgentSummarySchema, AgentsFileEntrySchema, AgentsCreateParamsSchema, AgentsCreateResultSchema, AgentsUpdateParamsSchema, AgentsUpdateResultSchema, AgentsDeleteParamsSchema, AgentsDeleteResultSchema, AgentsFilesGetParamsSchema, AgentsFilesGetResultSchema, AgentsFilesListParamsSchema, AgentsFilesListResultSchema, AgentsFilesSetParamsSchema, AgentsFilesSetResultSchema, AgentsListParamsSchema, AgentsListResultSchema, AgentWaitParamsSchema, ChannelsStartParamsSchema, ChannelsLogoutParamsSchema, TalkConfigParamsSchema, TalkConfigResultSchema, TalkRealtimeSessionParamsSchema, TalkRealtimeSessionResultSchema, TalkSpeakParamsSchema, TalkSpeakResultSchema, ChannelsStatusParamsSchema, ChannelsStatusResultSchema, CommandsListParamsSchema, CommandsListResultSchema, ChatAbortParamsSchema, ChatEventSchema, ChatHistoryParamsSchema, ChatInjectParamsSchema, ChatSendParamsSchema, ConfigApplyParamsSchema, ConfigGetParamsSchema, ConfigPatchParamsSchema, ConfigSchemaLookupParamsSchema, ConfigSchemaLookupResultSchema, ConfigSchemaParamsSchema, ConfigSchemaResponseSchema, ConfigSetParamsSchema, ConnectParamsSchema, CronAddParamsSchema, CronJobSchema, CronListParamsSchema, CronRemoveParamsSchema, CronRunParamsSchema, CronRunsParamsSchema, CronStatusParamsSchema, CronUpdateParamsSchema, DevicePairApproveParamsSchema, DevicePairListParamsSchema, DevicePairRemoveParamsSchema, DevicePairRejectParamsSchema, DeviceTokenRevokeParamsSchema, DeviceTokenRotateParamsSchema, ExecApprovalsGetParamsSchema, ExecApprovalsNodeGetParamsSchema, ExecApprovalsNodeSetParamsSchema, ExecApprovalsSetParamsSchema, ExecApprovalGetParamsSchema, ExecApprovalRequestParamsSchema, ExecApprovalResolveParamsSchema, PluginApprovalRequestParamsSchema, PluginApprovalResolveParamsSchema, ErrorCodes, ErrorShapeSchema, EventFrameSchema, errorShape, GatewayFrameSchema, HelloOkSchema, LogsTailParamsSchema, LogsTailResultSchema, ModelsListParamsSchema, NodeDescribeParamsSchema, NodeEventParamsSchema, NodePendingDrainParamsSchema, NodePendingDrainResultSchema, NodePendingEnqueueParamsSchema, NodePendingEnqueueResultSchema, NodeInvokeParamsSchema, NodeInvokeResultParamsSchema, NodeListParamsSchema, NodePendingAckParamsSchema, NodePairApproveParamsSchema, NodePairListParamsSchema, NodePairRejectParamsSchema, NodePairRequestParamsSchema, NodePairVerifyParamsSchema, NodeRenameParamsSchema, PollParamsSchema, PROTOCOL_VERSION, PushTestParamsSchema, PushTestResultSchema, WebPushVapidPublicKeyParamsSchema, WebPushSubscribeParamsSchema, WebPushUnsubscribeParamsSchema, WebPushTestParamsSchema, PresenceEntrySchema, ProtocolSchemas, RequestFrameSchema, ResponseFrameSchema, SendParamsSchema, SecretsResolveParamsSchema, SecretsResolveResultSchema, SessionsAbortParamsSchema, SessionsCompactParamsSchema, SessionsCompactionBranchParamsSchema, SessionsCompactionGetParamsSchema, SessionsCompactionListParamsSchema, SessionsCompactionRestoreParamsSchema, SessionsCreateParamsSchema, SessionsDeleteParamsSchema, SessionsListParamsSchema, SessionsMessagesSubscribeParamsSchema, SessionsMessagesUnsubscribeParamsSchema, SessionsPatchParamsSchema, SessionsPreviewParamsSchema, SessionsResetParamsSchema, SessionsResolveParamsSchema, SessionsSendParamsSchema, SessionsUsageParamsSchema, ShutdownEventSchema, SkillsBinsParamsSchema, SkillsDetailParamsSchema, SkillsDetailResultSchema, SkillsInstallParamsSchema, SkillsSearchParamsSchema, SkillsSearchResultSchema, SkillsStatusParamsSchema, SkillsUpdateParamsSchema, ToolsCatalogParamsSchema, ToolsEffectiveParamsSchema, SnapshotSchema, StateVersionSchema, TalkModeParamsSchema, TickEventSchema, UpdateRunParamsSchema, WakeParamsSchema, WebLoginStartParamsSchema, WebLoginWaitParamsSchema, WizardCancelParamsSchema, WizardNextParamsSchema, WizardNextResultSchema, WizardStartParamsSchema, WizardStartResultSchema, WizardStatusParamsSchema, WizardStatusResultSchema, WizardStepSchema, } from "./schema.js";
const ajv = new AjvPkg({
    allErrors: true,
    strict: false,
    removeAdditional: false,
});
export const validateCommandsListParams = ajv.compile(CommandsListParamsSchema);
...
export const validateMessageActionParams = ajv.compile(MessageActionParamsSchema);
...
export const validateNodePendingAckParams = ajv.compile(NodePendingAckParamsSchema);
...
export const validateNodePendingDrainParams = ajv.compile(NodePendingDrainParamsSchema);
export const validateNodePendingEnqueueParams = ajv.compile(NodePendingEnqueueParamsSchema);
export const validatePushTestParams = ajv.compile(PushTestParamsSchema);
export const validateWebPushVapidPublicKeyParams = ajv.compile(WebPushVapidPublicKeyParamsSchema);
export const validateWebPushSubscribeParams = ajv.compile(WebPushSubscribeParamsSchema);
export const validateWebPushUnsubscribeParams = ajv.compile(WebPushUnsubscribeParamsSchema);
export const validateWebPushTestParams = ajv.compile(WebPushTestParamsSchema);
export const validateSecretsResolveParams = ajv.compile(SecretsResolveParamsSchema);
export const validateSecretsResolveResult = ajv.compile(SecretsResolveResultSchema);
...
export const validateSessionsCreateParams = ajv.compile(SessionsCreateParamsSchema);
export const validateSessionsSendParams = ajv.compile(SessionsSendParamsSchema);
export const validateSessionsMessagesSubscribeParams = ajv.compile(SessionsMessagesSubscribeParamsSchema);
export const validateSessionsMessagesUnsubscribeParams = ajv.compile(SessionsMessagesUnsubscribeParamsSchema);
...
export const validateSessionsCompactionListParams = ajv.compile(SessionsCompactionListParamsSchema);
export const validateSessionsCompactionGetParams = ajv.compile(SessionsCompactionGetParamsSchema);
export const validateSessionsCompactionBranchParams = ajv.compile(SessionsCompactionBranchParamsSchema);
export const validateSessionsCompactionRestoreParams = ajv.compile(SessionsCompactionRestoreParamsSchema);
...
export const validateConfigSchemaLookupParams = ajv.compile(ConfigSchemaLookupParamsSchema);
export const validateConfigSchemaLookupResult = ajv.compile(ConfigSchemaLookupResultSchema);
...
export const validateTalkRealtimeSessionParams = ajv.compile(TalkRealtimeSessionParamsSchema);
export const validateTalkRealtimeSessionResult = ajv.compile(TalkRealtimeSessionResultSchema);
...
export const validateChannelsStartParams = ajv.compile(ChannelsStartParamsSchema);
...
export const validateToolsEffectiveParams = ajv.compile(ToolsEffectiveParamsSchema);
...
export const validateSkillsSearchParams = ajv.compile(SkillsSearchParamsSchema);
...
export const validateExecApprovalGetParams = ajv.compile(ExecApprovalGetParamsSchema);
...
export const validatePluginApprovalRequestParams = ajv.compile(PluginApprovalRequestParamsSchema);
export const validatePluginApprovalResolveParams = ajv.compile(PluginApprovalResolveParamsSchema);
