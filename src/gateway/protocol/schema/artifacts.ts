...
export const ArtifactsListParamsSchema = Type.Object(
  {
    ...ArtifactQueryParamsProperties,
    /** Opaque cursor from the previous page's nextCursor field; absent on the first request. */
    cursor: Type.Optional(Type.String()),
    /** Maximum number of artifacts to return per page. Defaults to 50; server-capped at 200. */
    limit: Type.Optional(Type.Integer({ minimum: 1 })),
    /** Filter artifacts by type. When provided, only artifacts whose type is in this list are returned. */
...
export const ArtifactsListResultSchema = Type.Object(
  {
    ...
    /** Cursor pointing to the next page; absent when all artifacts have been returned. */
    nextCursor: Type.Optional(Type.String()),
    /** Total artifact count after type filtering, before pagination cutoff. */
