...
const BoundedNonEmptyString = (maxLength) => Type.String({ minLength: 1, maxLength });
...
export const CommandArgSchema = Type.Object({
    ...
    choices: Type.Optional(Type.Array(CommandArgChoiceSchema, { maxItems: COMMAND_ARG_CHOICES_MAX_ITEMS })),
...
export const CommandEntrySchema = Type.Object({
    ...
    textAliases: Type.Optional(Type.Array(BoundedNonEmptyString(COMMAND_NAME_MAX_LENGTH), {
