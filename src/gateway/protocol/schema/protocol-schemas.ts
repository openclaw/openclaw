...
export const ProtocolSchemas = {
  ...
  MemoryRpcScope: MemoryRpcScopeSchema,
  MemoryProviderStatusPublic: MemoryProviderStatusPublicSchema,
  MemoryStatusParams: MemoryStatusParamsSchema,
  MemoryStatusResult: MemoryStatusResultSchema,
  MemorySourcesListParams: MemorySourcesListParamsSchema,
  MemorySourcesListResult: MemorySourcesListResultSchema,
  MemorySearchDebugParams: MemorySearchDebugParamsSchema,
  MemorySearchDebugResult: MemorySearchDebugResultSchema,
  MemoryIndexRunParams: MemoryIndexRunParamsSchema,
  MemoryIndexRunResult: MemoryIndexRunResultSchema,
  MemoryIndexJobsParams: MemoryIndexJobsParamsSchema,
  MemoryIndexJobsResult: MemoryIndexJobsResultSchema,
  MemorySourceOpenParams: MemorySourceOpenParamsSchema,
  MemorySourceOpenResult: MemorySourceOpenResultSchema,
