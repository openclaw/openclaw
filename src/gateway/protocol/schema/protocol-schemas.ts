...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  AgentsFilesTreeParams: AgentsFilesTreeParamsSchema,
  AgentsFilesTreeResult: AgentsFilesTreeResultSchema,
  AgentsFilesReadParams: AgentsFilesReadParamsSchema,
  AgentsFilesReadResult: AgentsFilesReadResultSchema,
