...
import { AGENT_INTERNAL_EVENT_SOURCES, AGENT_INTERNAL_EVENT_STATUSES, AGENT_INTERNAL_EVENT_TYPE_TASK_COMPLETION, } from "../../../agents/internal-event-contract.js";
...
export const MessageActionToolContextSchema = Type.Object({
    ...
    hasRepliedRef: Type.Optional(Type.Object({
        value: Type.Boolean(),
    }, { additionalProperties: false })),
