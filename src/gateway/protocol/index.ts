...
import {
  ...
  type AssistantContinueCandidatesParams,
  AssistantContinueCandidatesResultSchema,
  type AssistantContinueCandidatesResult,
  AssistantDecisionsListParamsSchema,
  type AssistantDecisionsListParams,
  AssistantDecisionsListResultSchema,
  type AssistantDecisionsListResult,
...
export const validateAssistantStatusParams = ajv.compile<AssistantStatusParams>(
  AssistantStatusParamsSchema,
);
export const validateAssistantDecisionsListParams = ajv.compile<AssistantDecisionsListParams>(
  AssistantDecisionsListParamsSchema,
);
export const validateAssistantContinueCandidatesParams =
  ajv.compile<AssistantContinueCandidatesParams>(AssistantContinueCandidatesParamsSchema);
...
export type {
  ...
  AssistantStatusParams,
  AssistantStatusResult,
  AssistantDecisionsListParams,
  AssistantDecisionsListResult,
  AssistantContinueCandidatesParams,
