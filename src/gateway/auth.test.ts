...
describe("gateway auth", () => {
  ...
  it("resolves token/password from MULLUSI gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
  ...
  it("accepts password mode when env provides MULLUSI_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        MULLUSI_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
