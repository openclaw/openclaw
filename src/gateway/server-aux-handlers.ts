...
export function createGatewayAuxHandlers(
  ...
  return {
    ...
    questionManager,
    extraHandlers: Object.fromEntries(
      Object.entries({
        "exec.approval.get": loadExecApprovalHandlers,
        "exec.approval.list": loadExecApprovalHandlers,
        "exec.approval.request": loadExecApprovalHandlers,
        "exec.approval.waitDecision": loadExecApprovalHandlers,
        "exec.approval.resolve": loadExecApprovalHandlers,
        "exec.approval.grants.list": loadExecApprovalHandlers,
        "exec.approval.grants.revoke": loadExecApprovalHandlers,
        "plugin.approval.list": loadPluginApprovalHandlers,
        "plugin.approval.request": loadPluginApprovalHandlers,
        "plugin.approval.waitDecision": loadPluginApprovalHandlers,
        "plugin.approval.resolve": loadPluginApprovalHandlers,
        "approval.get": loadApprovalHandlers,
        "approval.history": loadApprovalHandlers,
        "approval.resolve": loadApprovalHandlers,
        "question.request": loadQuestionHandlers,
        "question.waitAnswer": loadQuestionHandlers,
        "question.resolve": loadQuestionHandlers,
        "question.get": loadQuestionHandlers,
        "question.list": loadQuestionHandlers,
        "secrets.reload": loadSecretsHandlers,
        "secrets.resolve": loadSecretsHandlers,
        "secrets.store.list": loadSecretsHandlers,
        "secrets.store.set": loadSecretsHandlers,
        "secrets.store.delete": loadSecretsHandlers,
      }).map(([method, loadHandlers]) => [method, createLazyHandler(method, loadHandlers)]),
    ),
  };
}
