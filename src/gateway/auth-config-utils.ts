import type { GatewayAuthConfig, MullusiConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: MullusiConfig, password: string): MullusiConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
