...
const EVENT_SCOPE_GUARDS: Record<string, string[]> = {
  ...
  "claw.mission.created": [READ_SCOPE],
  "claw.mission.updated": [READ_SCOPE],
  "claw.mission.stateChanged": [READ_SCOPE],
  "claw.decision.requested": [READ_SCOPE],
  "claw.decision.resolved": [READ_SCOPE],
  "claw.inbox.updated": [READ_SCOPE],
  "claw.audit.appended": [READ_SCOPE],
  "claw.control.changed": [READ_SCOPE],
