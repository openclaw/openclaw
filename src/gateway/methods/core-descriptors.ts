...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "durable.wake.list", scope: "operator.read" },
  { name: "durable.wake.inspect", scope: "operator.read" },
  { name: "durable.wake.deliveryAttempts.list", scope: "operator.read" },
  { name: "durable.wake.acknowledge", scope: "operator.write", controlPlaneWrite: true },
  { name: "durable.wake.supersede", scope: "operator.write", controlPlaneWrite: true },
  { name: "durable.wake.mark", scope: "operator.write", controlPlaneWrite: true },
