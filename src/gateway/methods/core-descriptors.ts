...
const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "skills.write.validate", scope: "operator.read", since: "2026.7" },
  { name: "skills.write.propose", scope: "operator.admin", since: "2026.7" },
  { name: "skills.write.applyProposal", scope: "operator.admin", since: "2026.7" },
  { name: "skills.write.direct", scope: "operator.admin", since: "2026.7" },
  { name: "skills.write.refreshSnapshot", scope: "operator.admin", since: "2026.7" },
