...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "mcp.listResources", scope: "operator.read" },
  { name: "mcp.listResourceTemplates", scope: "operator.read" },
  { name: "mcp.listTools", scope: "operator.read" },
  { name: "mcp.readResource", scope: "operator.read" },
  { name: "mcp.callTool", scope: "operator.write" },
