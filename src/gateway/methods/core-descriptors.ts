...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "sessions.share.create", scope: "operator.write", controlPlaneWrite: true },
  { name: "sessions.share.list", scope: "operator.read" },
  { name: "sessions.share.revoke", scope: "operator.write", controlPlaneWrite: true },
