...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "doctor.memory.auditSuggestions", scope: "operator.read" },
  { name: "doctor.memory.auditApply", scope: "operator.write" },
  { name: "doctor.memory.auditReject", scope: "operator.write" },
