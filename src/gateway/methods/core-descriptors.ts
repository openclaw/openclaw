...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "contextEngine.capabilities", scope: "operator.read" },
  { name: "contextEngine.status", scope: "operator.read" },
  { name: "contextEngine.doctor", scope: "operator.read" },
  { name: "contextEngine.rotate", scope: "operator.admin" },
