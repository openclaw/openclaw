...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "projects.create", scope: "operator.admin" },
  { name: "projects.update", scope: "operator.admin" },
  { name: "projects.delete", scope: "operator.admin" },
  { name: "projects.restore", scope: "operator.admin" },
  { name: "projects.resources.list", scope: "operator.read" },
  { name: "projects.resources.add", scope: "operator.admin" },
  { name: "projects.resources.upload", scope: "operator.admin" },
  { name: "projects.resources.remove", scope: "operator.admin" },
  { name: "projects.resources.reindex", scope: "operator.admin" },
  { name: "projects.sessions.list", scope: "operator.read" },
  { name: "projects.sessions.attach", scope: "operator.admin" },
  { name: "projects.sessions.detach", scope: "operator.admin" },
  { name: "projects.context.preview", scope: "operator.read" },
