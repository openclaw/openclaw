...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "projects.list", scope: "operator.read" },
  { name: "projects.get", scope: "operator.read" },
  { name: "projects.create", scope: "operator.write" },
  { name: "projects.patch", scope: "operator.write" },
  { name: "projects.archive", scope: "operator.write" },
  { name: "projects.restore", scope: "operator.write" },
  { name: "projects.roles.list", scope: "operator.read" },
  { name: "projects.roles.create", scope: "operator.write" },
  { name: "projects.roles.patch", scope: "operator.write" },
  { name: "projects.roles.archive", scope: "operator.write" },
  { name: "projects.roles.restore", scope: "operator.write" },
  { name: "projects.documents.list", scope: "operator.read" },
  { name: "projects.documents.create", scope: "operator.write" },
  { name: "projects.documents.import", scope: "operator.write" },
  { name: "projects.documents.patch", scope: "operator.write" },
  { name: "projects.documents.archive", scope: "operator.write" },
  { name: "projects.documents.restore", scope: "operator.write" },
  { name: "projects.chats.list", scope: "operator.read" },
  { name: "projects.chats.resolve", scope: "operator.read" },
  { name: "projects.chats.attach", scope: "operator.write" },
  { name: "projects.chats.patch", scope: "operator.write" },
  { name: "projects.chats.archive", scope: "operator.write" },
  { name: "projects.chats.restore", scope: "operator.write" },
  { name: "projects.chats.detach", scope: "operator.write" },
  { name: "projects.context.get", scope: "operator.read" },
  { name: "projects.context.patch", scope: "operator.write" },
