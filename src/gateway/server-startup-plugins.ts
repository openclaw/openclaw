...
export async function prepareGatewayPluginBootstrap(params: {
  ...
  // Opt-in fast startup: OPENCLAW_GATEWAY_FAST_CONFIG=1 defers pre-ready channel
  // startup maintenance and startup session migration into background tasks so
  // plugin bootstrap does not block on them. Deferred failures are surfaced as
  // warnings rather than swallowed. See docs/cli/gateway.md ("Gateway profiling").
