...
describe("wakeRestoredFollowupQueueSessions", () => {
  ...
  it("wakes each session that has a non-empty restored followup queue", async () => {
  ...
  it("still wakes restored queues when a second runtime copy sees the restore-once flag", async () => {
  ...
  it("wakes summary-only restored queues using retained routing facts", async () => {
...
describe("scheduleRestoredFollowupQueueRecovery", () => {
  ...
  it("wakes restored queues when restore succeeds after the startup timer", async () => {
    vi.useFakeTimers();
  ...
  it("does not wake after dispose before the startup timer", async () => {
    vi.useFakeTimers();
  ...
  it("unregisters only the matching restore listener", async () => {
    vi.useFakeTimers();
