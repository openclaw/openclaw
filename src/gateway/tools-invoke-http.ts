...
import { createDNATools } from "../agents/dna-tools.js";
import {
  filterToolsByPolicy,
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(getHeader(req, "x-dna-message-channel") ?? "");
  const accountId = getHeader(req, "x-dna-account-id")?.trim() || undefined;
