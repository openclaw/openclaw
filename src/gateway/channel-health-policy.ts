...
// Widened from 120s so slow-startup channels (e.g. long-poll handshakes or
// heavy first-page payloads) finish the full connect sequence before the
// health monitor runs its first post-grace evaluation.
