...
const CORE_PACKAGE_NAMES = new Set(["smart-agent-neo"]);
...
export async function resolveSmartAgentNeoPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveSmartAgentNeoPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
