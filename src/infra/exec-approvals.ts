...
/**
 * Resolve the path to the exec-approvals.json file.
...
/**
 * Resolve the path to the exec-approvals.sock file.
 * Respects OPENCLAW_STATE_DIR environment variable.
 */
...
export function resolveExecApprovals(
  ...
  return resolveExecApprovalsFromFile({
    ...
    socketPath: file.socket?.path ?? resolveExecApprovalsSocketPath(),
...
export function resolveExecApprovalsFromFile(params: {
  ...
  return {
    ...
    socketPath: params.socketPath ?? file.socket?.path ?? resolveExecApprovalsSocketPath(),
