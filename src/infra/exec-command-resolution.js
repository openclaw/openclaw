...
import { resolveExecutablePath as resolveExecutableCandidatePath, resolveExecutablePathCandidate, } from "./executable-path.js";
...
export function matchAllowlist(entries, resolution, argv, platform) {
    if (!entries.length) {
        return null;
    }
