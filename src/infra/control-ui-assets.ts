...
/**
 * Resolve the root directory of the next-gen control UI (control-ui-next).
 * Mirrors the resolution logic of resolveControlUiRootSync but targets the
 * `control-ui-next` dist directory.
 */
