...
export const HOST_DANGEROUS_INHERITED_ENV_KEY_VALUES = Object.freeze([
    ...HOST_ENV_SECURITY_POLICY.blockedInheritedKeys,
]);
export const HOST_DANGEROUS_INHERITED_ENV_PREFIXES = Object.freeze([
...
export const HOST_SHELL_WRAPPER_ALLOWED_OVERRIDE_ENV_PREFIX_VALUES = Object.freeze(["LC_"]);
...
export const HOST_DANGEROUS_OVERRIDE_ENV_KEYS = new Set(HOST_DANGEROUS_OVERRIDE_ENV_KEY_VALUES);
export const HOST_SHELL_WRAPPER_ALLOWED_OVERRIDE_ENV_KEYS = new Set(HOST_SHELL_WRAPPER_ALLOWED_OVERRIDE_ENV_KEY_VALUES);
...
export function normalizeHostOverrideEnvVarKey(rawKey) {
...
export function isDangerousHostInheritedEnvVarName(rawKey) {
    const key = normalizeEnvVarKey(rawKey);
    if (!key) {
        return false;
    }
...
export function isDangerousHostEnvOverrideVarName(rawKey) {
    const key = normalizeEnvVarKey(rawKey);
    if (!key) {
        return false;
    }
