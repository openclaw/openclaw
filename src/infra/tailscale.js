...
export function getTestTailscaleBinaryOverride(env = process.env) {
...
function parseWhoisIdentity(payload) {
    ...
    const login = normalizeOptionalString(userProfile?.LoginName) ??
    ...
    const name = normalizeOptionalString(userProfile?.DisplayName) ??
