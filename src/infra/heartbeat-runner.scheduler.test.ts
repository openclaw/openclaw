...
describe("startHeartbeatRunner", () => {
  ...
  // call `requestHeartbeatNow({reason: "exec-event"})` from
  ...
  it("does not bypass interval cooldown for repeated wake reasons (regression)", async () => {
  ...
  it("does not bypass interval cooldown for repeated background-task wakes (regression)", async () => {
