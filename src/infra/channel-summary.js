...
export async function buildChannelSummary(cfg, options) {
    ...
    const plugins = options?.plugins ?? (await listChannelSummaryPlugins({ cfg: effective, sourceConfig }));
    for (const plugin of plugins) {
        ...
        const statusState = summaryRecord && typeof summaryRecord.statusState === "string"
