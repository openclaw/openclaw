      ...
      inspectAccount: (cfg) =>
        (cfg as { marker?: string }).marker === "source"
          ? {
              ...
              configured: true,
              mode: "http",
              botToken: "xoxb-http", // pragma: allowlist secret (fixture token) // pragma: allowlist secret (fixture token) // pragma: allowlist secret (fixture token)
              signingSecret: "",
          ...
          : {
              ...
              configured: false,
              mode: "http",
              botToken: "xoxb-http", // pragma: allowlist secret (fixture token) // pragma: allowlist secret (fixture token)
              botTokenSource: "config",
              botTokenStatus: "available",
            },
      resolveAccount: () => ({
        ...
        configured: false,
        mode: "http",
        botToken: "xoxb-http", // pragma: allowlist secret (fixture token)
        botTokenSource: "config",
        botTokenStatus: "available",
      }),
