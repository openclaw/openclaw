...
describe("diagnostic-events", () => {
  ...
  describe("AI safety event contracts", () => {
    ...
    it("emits ai_safety.prompt_injection.signal with required fields", () => {
      ...
      emitDiagnosticEvent(input as Parameters<typeof emitDiagnosticEvent>[0]);
      stop();
