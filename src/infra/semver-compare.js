export function normalizeLegacyDotBetaVersion(version) {
...
export function parseComparableSemver(version, options) {
    if (!version) {
        return null;
    }
...
export function comparePrereleaseIdentifiers(a, b) {
...
export function compareComparableSemver(a, b) {
    if (!a || !b) {
        return null;
    }
    if (a.major !== b.major) {
