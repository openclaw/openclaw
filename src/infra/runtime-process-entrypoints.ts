...
export const runtimeProcessEntrypoints = {
  ...
  supervisedReview: runtimeProcessEntrypoint("tasks/supervised-review-process"),
  supervisedAttempt: runtimeProcessEntrypoint("tasks/supervised-attempt-process"),
  supervisedCommand: runtimeProcessEntrypoint("tasks/supervised-command-process"),
  supervisedOperation: runtimeProcessEntrypoint("tasks/supervised-operation-process"),
