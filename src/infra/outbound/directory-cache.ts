...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: EasyHubConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: EasyHubConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: EasyHubConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: EasyHubConfig): void {
