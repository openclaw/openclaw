...
import { deliveryContextFromSession, mergeDeliveryContext, } from "../../utils/delivery-context.shared.js";
...
import { resolveOutboundTargetWithPlugin, } from "./targets-resolve-shared.js";
export { resolveSessionDeliveryTarget } from "./targets-session.js";
...
export function resolveOutboundTarget(params) {
    return (resolveOutboundTargetWithPlugin({
        ...
        target: params,
        onMissingPlugin: () => params.channel === INTERNAL_MESSAGE_CHANNEL
            ? undefined
            : {
                ok: false,
...
export function resolveHeartbeatDeliveryTarget(params) {
    ...
    const resolvedTurnSource = target === "last"
    ...
    const resolvedTarget = resolveSessionDeliveryTarget({
        ...
        mode: "heartbeat",
        turnSourceChannel: resolvedTurnSource?.channel && isDeliverableMessageChannel(resolvedTurnSource.channel)
...
function shouldReuseHeartbeatRouteThreadId(params) {
    ...
    const messaging = channel && resolveOutboundChannelPlugin({ channel, cfg: params.cfg })?.messaging;
    return (messaging?.preserveHeartbeatThreadIdForGroupRoute === true &&
