...
// Keep close private: plugins recover it via Symbol.for("openclaw.proxyFetch.close")
// so cache eviction can release the ProxyAgent without growing the public SDK surface.
