...
import { buildExecEventPrompt, buildCronEventPrompt, isCronSystemEvent, isExecCompletionEvent, } from "./heartbeat-events-filter.js";
...
function resolveHeartbeatRunPrompt(params) {
    ...
    const cronEvents = pendingEventEntries
        .filter((event) => (params.preflight.isCronEventReason || event.contextKey?.startsWith("cron:")) &&
...
export async function runHeartbeatOnce(opts) {
    ...
    try {
        ...
        const bootstrapContextMode = heartbeat?.lightContext === true ? "lightweight" : undefined;
