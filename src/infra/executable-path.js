...
export function isDriveLessWindowsRootedPath(value) {
    return process.platform === "win32" && /^:[\\/]/.test(value);
}
export function resolveExecutablePathCandidate(rawExecutable, options) {
...
export function resolveExecutableFromPathEnv(executable, pathEnv, env) {
...
export function resolveExecutablePath(rawExecutable, options) {
