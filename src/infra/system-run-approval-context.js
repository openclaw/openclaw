...
export function parsePreparedSystemRunPayload(payload) {
    ...
    const commandText = normalizeNonEmptyString(legacyPlan.rawCommand) ??
...
export function resolveSystemRunApprovalRequestContext(params) {
    ...
    const normalizedPlan = host === "node" ? normalizeSystemRunApprovalPlan(params.systemRunPlan) : null;
