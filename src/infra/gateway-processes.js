...
import { readWindowsListeningPidsOnPortSync, readWindowsProcessArgsSync, } from "./windows-port-pids.js";
export function readGatewayProcessArgsSync(pid) {
...
export function signalVerifiedGatewayPidSync(pid, signal) {
...
export function findVerifiedGatewayListenerPidsOnPortSync(port) {
    const rawPids = process.platform === "win32"
...
export function formatGatewayPidList(pids) {
    return pids.join(", ");
}
