 ...
 */
export function normalizeWindowsInstallRoot(raw) {
...
function getRegistryInstallRoots() {
    return {
        systemRoot: normalizeWindowsInstallRoot(queryRegistryValueFn(WINDOWS_NT_CURRENT_VERSION_KEY, "SystemRoot") ?? undefined) ?? undefined,
        programFiles: normalizeWindowsInstallRoot(queryRegistryValueFn(WINDOWS_CURRENT_VERSION_KEY, "ProgramFilesDir") ?? undefined) ?? undefined,
        programFilesX86: normalizeWindowsInstallRoot(queryRegistryValueFn(WINDOWS_CURRENT_VERSION_KEY, "ProgramFilesDir (x86)") ?? undefined) ?? undefined,
        programW6432: normalizeWindowsInstallRoot(queryRegistryValueFn(WINDOWS_CURRENT_VERSION_KEY, "ProgramW6432Dir") ?? undefined) ?? undefined,
    };
}
...
export function getWindowsProgramFilesRoots(env = process.env) {
...
export function _resetWindowsInstallRootsForTests(overrides = {}) {
