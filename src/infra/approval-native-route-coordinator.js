...
import { describeApprovalDeliveryDestination, resolveApprovalRoutedElsewhereNoticeText, } from "./approval-native-route-notice.js";
import { buildChannelApprovalNativeTargetKey } from "./approval-native-target-key.js";
const activeApprovalRouteRuntimes = new Map();
const pendingApprovalRouteNotices = new Map();
...
function resolveApprovalRouteNotice(params) {
    ...
    const fallbackTarget = params.reports
    ...
    const requestGateway = params.reports.find((report) => activeApprovalRouteRuntimes.has(report.runtimeId))
...
export function createApprovalNativeRouteReporter(params) {
    ...
    const report = async (payload) => {
        ...
        const entry = pendingApprovalRouteNotices.get(payload.request.id) ??
...
export function clearApprovalNativeRouteStateForTest() {
