...
describe("exec approvals safe bins", () => {
  ...
  const cases: SafeBinCase[] = [
    ...
    // Built-in profiles for common read-only bins
    {
      name: "allows echo with safe positional",
    ...
    {
      name: "allows bare date",
      argv: ["date"],
      resolvedPath: "/bin/date",
      expected: true,
      safeBins: ["date"],
      executableName: "date",
    },
    {
      name: "allows date with format positional",
      argv: ["date", "+%Y-%m-%d"],
      resolvedPath: "/bin/date",
      expected: true,
      safeBins: ["date"],
    ...
    {
      name: "blocks date --set",
      argv: ["date", "--set=2026-01-01"],
      resolvedPath: "/bin/date",
      expected: false,
      safeBins: ["date"],
      executableName: "date",
    ...
    {
      name: "allows which with binary names",
      argv: ["which", "node", "python3"],
      resolvedPath: "/usr/bin/which",
      expected: true,
      safeBins: ["which"],
      executableName: "which",
    },
    {
      name: "allows bare uptime",
      argv: ["uptime"],
      resolvedPath: "/usr/bin/uptime",
      expected: true,
      safeBins: ["uptime"],
      executableName: "uptime",
    },
    {
      name: "blocks uptime with positional",
      argv: ["uptime", "something"],
      resolvedPath: "/usr/bin/uptime",
      expected: false,
      safeBins: ["uptime"],
      executableName: "uptime",
    ...
    {
      name: "allows ls with safe filename positionals",
      argv: ["ls", "src", "README.md"],
      resolvedPath: "/bin/ls",
      expected: true,
      safeBins: ["ls"],
      executableName: "ls",
    ...
    {
      name: "blocks ls with absolute path",
      argv: ["ls", "/etc/passwd"],
      resolvedPath: "/bin/ls",
      expected: false,
      safeBins: ["ls"],
    ...
    {
      name: "allows cat with safe filename positionals",
      argv: ["cat", "package.json"],
      resolvedPath: "/bin/cat",
      expected: true,
      safeBins: ["cat"],
      executableName: "cat",
    },
    {
      name: "blocks cat with absolute path",
      argv: ["cat", "/etc/shadow"],
      resolvedPath: "/bin/cat",
      expected: false,
      safeBins: ["cat"],
    ...
    {
      name: "allows ps with single positional",
      argv: ["ps", "aux"],
      resolvedPath: "/bin/ps",
      expected: true,
      safeBins: ["ps"],
    ...
    {
      name: "blocks df with positional path",
      argv: ["df", "/tmp"],
      resolvedPath: "/bin/df",
      expected: false,
      safeBins: ["df"],
    ...
    },
    {
      name: "allows bare du",
      argv: ["du"],
      resolvedPath: "/usr/bin/du",
      expected: true,
      safeBins: ["du"],
      executableName: "du",
    },
    {
      name: "blocks du with positional path",
      argv: ["du", "/var"],
      resolvedPath: "/usr/bin/du",
      expected: false,
      safeBins: ["du"],
