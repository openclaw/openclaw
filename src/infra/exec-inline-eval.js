...
export function detectInterpreterInlineEvalArgv(argv) {
...
export function describeInterpreterInlineEval(hit) {
    if (hit.flag === "<command>") {
...
export function isInterpreterLikeAllowlistPattern(pattern) {
