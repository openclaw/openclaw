...
export function summarizeDisplayNetworkError(error) {
...
export function fallbackBindHostForDisplay(bindMode, customBindHost) {
    if (bindMode === "lan") {
        return "0.0.0.0";
    }
    if (bindMode === "custom") {
...
export function pickBestEffortPrimaryLanIPv4() {
    try {
...
export function inspectBestEffortPrimaryTailnetIPv4(params) {
    try {
