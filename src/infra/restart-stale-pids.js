...
import { readWindowsListeningPidsOnPortSync, readWindowsListeningPidsResultSync, readWindowsProcessArgsResultSync, readWindowsProcessArgsSync, } from "./windows-port-pids.js";
 ...
 */
export function cleanStaleGatewayProcessesSync(portOverride) {
    try {
        const port = typeof portOverride === "number" && Number.isFinite(portOverride) && portOverride > 0
