...
import { openClawRootFs, openClawRootFsSync } from "./mullusi-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["mullusi"]);
...
export async function resolveMullusiPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveMullusiPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
