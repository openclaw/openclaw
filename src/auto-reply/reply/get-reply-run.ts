...
let piEmbeddedRuntimePromise: Promise<
  typeof import("../../agents/pi-embedded.runtime.js")
> | null = null;
let agentRunnerRuntimePromise: Promise<
  typeof import("./agent-runner.runtime.js")
> | null = null;
let routeReplyRuntimePromise: Promise<
  typeof import("./route-reply.runtime.js")
> | null = null;
let sessionUpdatesRuntimePromise: Promise<
  typeof import("./session-updates.runtime.js")
> | null = null;
...
export async function runPreparedReply(
  ...
  prefixedBodyBase = appendUntrustedContext(
    prefixedBodyBase,
  ...
  const prefixedBody = [threadContextNote, prefixedBodyBase]
    .filter(Boolean)
    .join("\n\n");
  ...
  const queueBodyBase = [threadContextNote, bodyWithEvents]
    .filter(Boolean)
    .join("\n\n");
