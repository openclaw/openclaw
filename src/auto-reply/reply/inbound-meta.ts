...
export function buildInboundMetaSystemPrompt(
  ...
  return [
    ...
    "Channel, topic, and conversation labels describe the current route only. Do not promise to post results in a named topic based on these labels; replies already go to the current chat/topic.",
    "",
    "```json",
