...
describe("shouldBypassAcpDispatchForCommand", () => {
  ...
  it("returns true for ACP slash commands when text/native commands are enabled", () => {
    const ctx = buildTestCtx({
      Provider: "discord",
      Surface: "discord",
  ...
  it("returns true for text slash commands when text commands are disabled on non-native surfaces", () => {
    const ctx = buildTestCtx({
      CommandBody: "/acp cancel",
      BodyForCommands: "/acp cancel",
      BodyForAgent: "/acp cancel",
  ...
  it("returns true for native slash commands even when text commands are disabled", () => {
    const ctx = buildTestCtx({
      Provider: "discord",
      Surface: "discord",
