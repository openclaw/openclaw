...
import { listReservedChatSlashCommandNames, resolveSkillCommandInvocation, } from "../skill-commands-base.js";
import { readAbortCutoffFromSessionEntry, resolveAbortCutoffFromContext, shouldSkipMessageByAbortCutoff, } from "./abort-cutoff.js";
...
export async function handleInlineActions(params) {
    ...
    if (skillInvocation) {
        ...
        const rewrittenBody = skillInvocation.command.promptTemplate
            ? expandBundleCommandPromptTemplate(skillInvocation.command.promptTemplate, skillInvocation.args)
            : [
    ...
    const shouldRunCommandHandlers = inlineCommand !== null ||
