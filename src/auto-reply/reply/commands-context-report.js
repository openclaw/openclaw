import { resolveBootstrapMaxChars, resolveBootstrapTotalMaxChars, } from "../../agents/pi-embedded-helpers.js";
...
export async function buildContextReply(params) {
    ...
    const bootstrapMaxLabel = typeof report.bootstrapMaxChars === "number"
        ...
        : "? chars";
    const bootstrapTotalLabel = typeof report.bootstrapTotalMaxChars === "number"
    ...
    const perFileOverLimitCount = typeof bootstrapMaxChars === "number"
