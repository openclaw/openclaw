...
import { resolveBootstrapMaxChars, resolveBootstrapTotalMaxChars, } from "../../agents/pi-embedded-helpers/bootstrap.js";
...
export async function buildContextReply(params) {
    ...
    const bootstrapMaxChars = typeof report.bootstrapMaxChars === "number" &&
    ...
    const bootstrapTotalMaxChars = typeof report.bootstrapTotalMaxChars === "number" &&
    ...
    const totalsLine = cachedContextUsageTokens != null
