...
export async function readPostCompactionContext(workspaceDir, options) {
    ...
    try {
        ...
        const isDefaultSections = !Array.isArray(configuredSections) ||
        ...
        const safeContent = combined.length > maxContextChars
 ...
 */
export function extractSections(content, sectionNames, foundNames) {
    const results = [];
