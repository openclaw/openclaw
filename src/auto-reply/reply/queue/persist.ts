  ...
  try {
    ...
    for (const entry of entries) {
      ...
      const restored: FollowupQueueState = {
        ...
        summarySources: [],
        // Elision entries hold live FollowupRun references and WeakSets, so they
        // cannot be serialized across restart. Reset those runtime-only entries
        // while preserving the user-visible rolled-up eviction count.
        summaryElisions: [],
        evictedSummaryCount:
