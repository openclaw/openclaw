...
export const handleCompactCommand = async (params) => {
    ...
    const sessionAgentDir = sessionAgentId === currentAgentId && params.agentDir
        ? params.agentDir
    ...
    const result = await runtime.compactEmbeddedPiSession({
        ...
        model: params.model,
        agentHarnessId: targetSessionEntry.sessionId === sessionId ? targetSessionEntry.agentHarnessId : undefined,
    ...
    const totalTokens = tokensAfterCompaction ?? runtime.resolveFreshSessionTotalTokens(targetSessionEntry);
