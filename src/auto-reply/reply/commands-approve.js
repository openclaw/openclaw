...
function resolveApprovalAuthorizationError(params) {
    if (params.approvalId.startsWith("plugin:")) {
        return (params.pluginAuthorization.reason ?? "❌ You are not authorized to approve this request.");
    }
    return (params.execAuthorization.reason ??
...
export const handleApproveCommand = async (params, allowTextCommands) => {
    ...
    const hasExplicitApprovalAuthorization = (execApprovalAuthorization.explicit && execApprovalAuthorization.authorized) ||
