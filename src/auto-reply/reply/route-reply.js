...
export async function routeReply(params) {
    ...
    const shouldPreserveSilentPayload = isSilentReplyPayloadText(payload.text) &&
    ...
    const normalized = shouldPreserveSilentPayload
        ...
        : normalizeReplyPayload(payload, {
            ...
            transformReplyPayload: messaging?.transformReplyPayload
                ? (nextPayload) => messaging.transformReplyPayload?.({
                    payload: nextPayload,
                    cfg,
                    accountId,
                }) ?? nextPayload
    ...
    const resolvedThreadId = replyTransport && Object.hasOwn(replyTransport, "threadId")
