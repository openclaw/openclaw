...
describe("initSessionState reset triggers in WhatsApp groups", () => {
  ...
  it("Reset trigger /new works for authorized sender in WhatsApp group", async () => {
    ...
    const groupMessageCtx = {
      Body: `[Chat messages since your last reply - for context]\\n[WhatsApp [redacted-email] 2026-01-13T07:45Z] Someone: hello\\n\\n[Current message - respond to this]\\n[WhatsApp [redacted-email] 2026-01-13T07:45Z] Peschiño: /new\\n[from: Peschiño (+41796666864)]`,
      RawBody: "/new",
      CommandBody: "/new",
      From: "[redacted-email]",
      To: "+41779241027",
      ...
      SenderId: "41796666864:[redacted-email]",
    };
  ...
  it("Reset trigger /new blocked for unauthorized sender in existing session", async () => {
    ...
    const groupMessageCtx = {
      ...
      SenderId: "1555123456:[redacted-email]",
    };
  ...
  it("Reset trigger works when RawBody is clean but Body has wrapped context", async () => {
    ...
    const groupMessageCtx = {
      Body: `[WhatsApp [redacted-email] 2026-01-13T07:45Z] Jake: /new\n[from: Jake (+1222)]`,
      RawBody: "/new",
      CommandBody: "/new",
      From: "[redacted-email]",
      To: "+1111",
  ...
  it("Reset trigger /new works when SenderId is LID but SenderE164 is authorized", async () => {
    ...
    const groupMessageCtx = {
      Body: `[WhatsApp [redacted-email] 2026-01-13T07:45Z] Owner: /new\n[from: Owner (+41796666864)]`,
      RawBody: "/new",
      CommandBody: "/new",
      From: "[redacted-email]",
      To: "+41779241027",
  ...
  it("Reset trigger /new blocked when SenderId is LID but SenderE164 is unauthorized", async () => {
    ...
    const groupMessageCtx = {
      Body: `[WhatsApp [redacted-email] 2026-01-13T07:45Z] Other: /new\n[from: Other (+1555123456)]`,
      RawBody: "/new",
      CommandBody: "/new",
      From: "[redacted-email]",
      To: "+41779241027",
