...
import { isSilentReplyPrefixText, isSilentReplyText, SILENT_REPLY_TOKEN, startsWithSilentToken, stripLeadingSilentToken, } from "../tokens.js";
...
export const splitTrailingDirective = (text, options = {}) => {
