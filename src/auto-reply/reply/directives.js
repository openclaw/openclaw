...
import { normalizeFastMode, normalizeElevatedLevel, normalizeNoticeLevel, normalizeReasoningLevel, normalizeTraceLevel, normalizeThinkLevel, normalizeVerboseLevel, } from "../thinking.js";
...
export function extractTraceDirective(body) {
    if (!body) {
        return { cleaned: "", hasDirective: false };
    }
...
export function extractFastDirective(body) {
    if (!body) {
        return { cleaned: "", hasDirective: false };
    }
