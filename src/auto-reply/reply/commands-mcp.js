...
export const handleMcpCommand = async (params, allowTextCommands) => {
    ...
    const allowInternalReadOnlyShow = mcpCommand.action === "show" && isInternalMessageChannel(params.command.channel);
