...
export function resolveLastChannelRaw(params: {
  ...
  // Keep WebChat-owned routing only for main sessions. Channel-scoped external
  // sessions need to retain their IM delivery route so WebChat mirroring keeps
  // targeting the same peer across multiple turns.
