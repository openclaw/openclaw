import { buildConfiguredAcpSessionKey, normalizeBindingConfig, } from "../../acp/persistent-bindings.types.js";
...
function resolveRawConfiguredAcpSessionKey(params) {
    for (const binding of acpResetTargetDeps.listAcpBindings(params.cfg)) {
        ...
        const matchedConversationId = peerId === params.conversationId
...
export function resolveEffectiveResetTargetSessionKey(params) {
    ...
    const configuredSessionKey = configuredBinding?.record.targetKind === "session"
