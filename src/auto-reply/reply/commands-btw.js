...
export const handleBtwCommand = async (params, allowTextCommands) => {
    ...
    const sessionAgentId = params.sessionKey
        ...
        : params.agentId;
    const agentDir = (sessionAgentId ? resolveAgentDir(params.cfg, sessionAgentId) : undefined) ?? params.agentDir;
    if (!agentDir) {
        return {
            shouldContinue: false,
            reply: {
