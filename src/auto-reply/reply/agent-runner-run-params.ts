...
export function buildEmbeddedRunBaseParams(params: {
  ...
  return {
    ...
    forceToolAccessPolicySnapshot: params.run.forceToolAccessPolicySnapshot,
    clientCaps: params.run.clientCaps,
    taskSuggestionDeliveryMode: params.run.taskSuggestionDeliveryMode,
    promptSourceReplyDeliveryMode: params.run.promptSourceReplyDeliveryMode,
    forceMessageTool: params.run.forceMessageTool,
