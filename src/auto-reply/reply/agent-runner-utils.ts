...
export function buildEmbeddedRunBaseParams(params: {
  ...
  return {
    ...
    model: params.model,
    ...params.authProfile,
    configuredThinkLevel: params.run.configuredThinkLevel,
    thinkLevel: params.run.thinkLevel,
    verboseLevel: params.run.verboseLevel,
    reasoningLevel: params.run.reasoningLevel,
    generatingSource: params.run.generatingSource,
    autoReasoningEnabled: params.run.autoReasoningEnabled,
    generatingSelector: params.run.generatingSelector,
    emitGeneratingField: params.run.emitGeneratingField,
