...
import { DEFAULT_RESET_TRIGGERS, deriveSessionMetaPatch, evaluateSessionFreshness, loadSessionStore, resolveAndPersistSessionFile, resolveChannelResetConfig, resolveThreadFlag, resolveSessionResetPolicy, resolveSessionResetType, resolveGroupSessionKey, resolveSessionFilePath, resolveSessionKey, resolveSessionTranscriptPath, resolveStorePath, updateSessionStore, } from "../../config/sessions.js";
...
import { deliveryContextFromSession, deliveryContextKey, normalizeDeliveryContext, normalizeSessionDeliveryFields, } from "../../utils/delivery-context.js";
...
function resolveLastToRaw(params) {
    ...
    if (!isExternalRoutingChannel(originatingChannel)) {
        const hasExternalFallback = isExternalRoutingChannel(persistedChannel) || isExternalRoutingChannel(sessionKeyChannelHint);
 ...
 * See #26905.
 */
const DEFAULT_PARENT_FORK_MAX_TOKENS = 100000;
...
function maybeRetireLegacyMainDeliveryRoute(params) {
    ...
    if (legacyMain.deliveryContext === undefined &&
