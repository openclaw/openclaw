...
import { isInboundPathAllowed, resolveIMessageRemoteAttachmentRoots, } from "../../media/inbound-path-policy.js";
    ...
    for (const raw of rawPaths) {
        ...
        try {
            ...
            if (err instanceof SafeOpenError && err.code === "too-large") {
                logVerbose(`Blocking inbound media staging above ${STAGED_MEDIA_MAX_BYTES} bytes: ${source}`);
            }
            else {
