...
export async function dispatchReplyFromConfig(params) {
    ...
    const shouldRouteToOriginating = Boolean(isRoutableChannel(originatingChannel) && originatingTo && originatingChannel !== currentSurface);
    ...
    try {
        ...
        const sendPolicy = resolveSendPolicy({
            ...
            channel: sessionStoreEntry.entry?.channel ??
