...
export async function getReplyFromConfig(
  ...
  const defaultsCfg = cfg.agents?.defaults;
  const perAgentCfg = resolveAgentConfig(cfg, agentId);
  const agentCfg = {
    ...defaultsCfg,
    ...perAgentCfg,
    thinkingDefault: perAgentCfg?.thinkingDefault ?? defaultsCfg?.thinkingDefault,
  };
