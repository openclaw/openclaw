...
export function subscribeLangfuseToolLifecycle(runId: string): () => void {
    ...
    try {
      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: (provider, model, runOptions) => {
          ...
          return (async () => {
            const stopLangfuseToolLifecycle = subscribeLangfuseToolLifecycle(runId);
            try {
