        ...
        runWithModelFallback<EmbeddedAgentRunResult>({
          ...
          run: async (provider, model, runOptions) => {
            ...
            if (isCliProvider(cliExecutionProvider, runtimeConfig)) {
              ...
              // thinking_delta) into onReasoningStream. Plain claude-cli routes its
              // assistant text into the reasoning lane via runCliAgentWithLifecycle's
              // reasoningBridge gate — that path is unchanged. cliThinkingArrived
              // prevents the onReasoningText callback below from double-delivering.
