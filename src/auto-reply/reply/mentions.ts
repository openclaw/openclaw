...
function resolveMentionPatterns(cfg: SmartAgentNeoConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SmartAgentNeoConfig | undefined, agentId?: string): RegExp[] {
