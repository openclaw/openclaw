...
function resolveAcpStreamCoalesceIdleMs(cfg: MullusiConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: MullusiConfig): number {
...
export function resolveAcpProjectionSettings(cfg: MullusiConfig): AcpProjectionSettings {
