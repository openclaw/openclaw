...
export async function maybeHandleResetCommand(params) {
    ...
    if (softReset.matched) {
        ...
        const previousSessionEntry = params.previousSessionEntry ?? (targetSessionEntry ? { ...targetSessionEntry } : undefined);
