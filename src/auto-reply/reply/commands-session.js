...
import { formatThreadBindingDurationLabel, getThreadBindingManager, resolveThreadBindingIdleTimeoutMs, resolveThreadBindingInactivityExpiresAt, resolveThreadBindingMaxAgeExpiresAt, resolveThreadBindingMaxAgeMs, setThreadBindingIdleTimeoutBySessionKey, setThreadBindingMaxAgeBySessionKey, } from "../../discord/monitor/thread-bindings.js";
...
export const handleSessionCommand = async (params, allowTextCommands) => {
    ...
    const nextExpiry = action === SESSION_ACTION_IDLE
