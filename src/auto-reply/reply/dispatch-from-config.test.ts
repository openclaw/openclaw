...
describe("dispatchReplyFromConfig", () => {
  ...
  it("suppresses repeated final exec approval prompts after native approval delivery", async () => {
    setNoAbort();
    const cfg = emptyConfig;
    const dispatcher = createDispatcher();
    const ctx = buildTestCtx({
  ...
  it("suppresses stale final exec approval prompts when this turn did not create a new approval", async () => {
    setNoAbort();
    const cfg = emptyConfig;
    const dispatcher = createDispatcher();
    const ctx = buildTestCtx({
      Provider: "discord",
      ChatType: "direct",
      Body: "查看一下/data/workspace下有哪些文件",
      BodyForCommands: "查看一下/data/workspace下有哪些文件",
      CommandBody: "查看一下/data/workspace下有哪些文件",
    });
  ...
  it("suppresses stale block exec approval prompts when this turn did not create a new approval", async () => {
    setNoAbort();
    const cfg = emptyConfig;
    const dispatcher = createDispatcher();
    const ctx = buildTestCtx({
