...
describe("dispatchReplyFromConfig", () => {
  ...
  it("suppresses text-only tool summaries even when session verbose is on", async () => {
    setNoAbort();
    sessionStoreMocks.currentEntry = {
      verboseLevel: "on",
    };
  ...
  it("suppresses plan and working-status progress even when session verbose is on", async () => {
    setNoAbort();
    sessionStoreMocks.currentEntry = {
      verboseLevel: "on",
    };
