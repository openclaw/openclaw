...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@activi", { botUsername: "activi" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@activi args", {
        botUsername: "activi",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "activi" })).toBe(
      "/help@otherbot",
    );
  });
