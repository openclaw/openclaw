...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "narrativemodel",
      nativeName: "narrativemodel",
      description: "Show or set the narrative/auxiliary model.",
      textAlias: "/narrativemodel",
      category: "options",
      args: [{ name: "model", description: "provider/model or 'unset'", type: "string" }],
    }),
    defineChatCommand({
      key: "narrativemodels",
      nativeName: "narrativemodels",
      description: "Browse providers/models for the narrative model.",
      textAlias: "/narrativemodels",
      argsParsing: "none",
      acceptsArgs: true,
      category: "options",
    }),
    defineChatCommand({
      key: "graphitimodel",
      nativeName: "graphitimodel",
      description: "Show or set the graphiti/observer model.",
      textAlias: "/graphitimodel",
      category: "options",
      args: [{ name: "model", description: "provider/model or 'unset'", type: "string" }],
    }),
    defineChatCommand({
      key: "graphitimodels",
      nativeName: "graphitimodels",
      description: "Browse providers/models for the graphiti model.",
      textAlias: "/graphitimodels",
      argsParsing: "none",
      acceptsArgs: true,
      category: "options",
    }),
