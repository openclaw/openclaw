import { getLoadedChannelPluginById, listLoadedChannelPlugins, } from "../channels/plugins/registry-loaded.js";
...
function resolveOwnerAuthorizationState(params) {
    ...
    const allowAll = !params.hadResolutionError &&
...
function resolveCommandSenderAuthorization(params) {
    if (params.commandsAllowFromList !== null ||
        ...
        const commandsAllowAll = !params.providerResolutionError &&
...
export function resolveCommandAuthorization(params) {
    ...
    const plugin = providerId
        ? (getLoadedChannelPluginById(providerId) ?? undefined)
        : undefined;
    ...
    const matchedCommandOwner = ownerState.ownerCandidatesForCommands.length
        ? senderCandidates.find((candidate) => ownerState.ownerCandidatesForCommands.includes(candidate))
        : undefined;
