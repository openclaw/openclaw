...
export function isHeartbeatUserMessage(message, heartbeatPrompt) {
...
export function isHeartbeatOkResponse(message, ackMaxChars) {
...
export function filterHeartbeatPairs(messages, ackMaxChars, heartbeatPrompt) {
