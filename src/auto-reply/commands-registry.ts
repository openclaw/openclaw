...
export function isCommandEnabled(cfg: SmartAgentNeoConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: SmartAgentNeoConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: SmartAgentNeoConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: SmartAgentNeoConfig) {
