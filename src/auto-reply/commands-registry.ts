...
export function isCommandEnabled(cfg: MullusiConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: MullusiConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: MullusiConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: MullusiConfig) {
