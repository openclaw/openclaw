...
class OpenClawMCPClient:
    ...
    async def _start_memory_server(self):
        ...
        server_params = StdioServerParameters(
            command=PYTHON_BIN,
            args=[os.path.join(os.path.dirname(__file__), "memory_search.py")],
            env=None
        )
        try:
    ...
    async def _start_websearch_server(self):
        ...
        server_params = StdioServerParameters(
            command=PYTHON_BIN,
            args=[os.path.join(os.path.dirname(__file__), "websearch.py")],
            env=None
        )
        try:
            read, write = await self._exit_stack.enter_async_context(stdio_client(server_params))
    ...
    async def _start_shell_server(self):
        ...
        server_params = StdioServerParameters(
            command=PYTHON_BIN,
            args=[os.path.join(os.path.dirname(__file__), "shell.py")],
            env=None
        )
        try:
            read, write = await self._exit_stack.enter_async_context(stdio_client(server_params))
    ...
    async def _start_parsers_server(self):
        ...
        server_params = StdioServerParameters(
            command=PYTHON_BIN,
            args=[os.path.join(os.path.dirname(__file__), "parsers.py")],
            env=None
        )
        try:
            read, write = await self._exit_stack.enter_async_context(stdio_client(server_params))
    ...
    async def _start_code_analysis_server(self):
        ...
        server_params = StdioServerParameters(
            command=PYTHON_BIN,
            args=[os.path.join(os.path.dirname(__file__), "code_analysis.py")],
            env=None
        )
        try:
            read, write = await self._exit_stack.enter_async_context(stdio_client(server_params))
