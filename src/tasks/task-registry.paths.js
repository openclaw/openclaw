...
export function resolveTaskStateDir(env = process.env) {
...
export function resolveTaskRegistryDir(env = process.env) {
    return path.join(resolveTaskStateDir(env), "tasks");
}
export function resolveTaskRegistrySqlitePath(env = process.env) {
