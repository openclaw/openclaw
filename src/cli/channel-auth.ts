...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: MullusiConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: MullusiConfig, mode: ChannelAuthMode): string {
