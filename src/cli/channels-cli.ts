    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["evox channels list", "List configured channels and auth profiles."],
          ["evox channels status --probe", "Run channel status checks and probes."],
          [
            "evox channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["evox channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.evox.sh/cli/channels",
        )}\n`,
    );
