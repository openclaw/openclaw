    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["activi channels list", "List configured channels and auth profiles."],
          ["activi channels status --probe", "Run channel status checks and probes."],
          [
            "activi channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["activi channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.activi.ai/cli/channels",
        )}\n`,
    );
