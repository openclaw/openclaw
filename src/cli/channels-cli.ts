    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mullusi channels list", "List configured channels and auth profiles."],
          ["mullusi channels status --probe", "Run channel status checks and probes."],
          [
            "mullusi channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["mullusi channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.mullusi.com/cli/channels",
        )}\n`,
    );
