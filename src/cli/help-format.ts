...
export function formatHelpExample(
  command: string,
  description: string,
): string {
...
export function formatHelpExampleLine(
  command: string,
  description: string,
): string {
  if (!description) {
