      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["evox gateway run", "Run the gateway in the foreground."],
            ["evox gateway status", "Show service status and probe reachability."],
            ["evox gateway discover", "Find local and wide-area gateway beacons."],
            ["evox gateway call health", "Call a gateway RPC method directly."],
