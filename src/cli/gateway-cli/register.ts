      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["mullusi gateway run", "Run the gateway in the foreground."],
            ["mullusi gateway status", "Show service status and probe reachability."],
            ["mullusi gateway discover", "Find local and wide-area gateway beacons."],
            ["mullusi gateway call health", "Call a gateway RPC method directly."],
