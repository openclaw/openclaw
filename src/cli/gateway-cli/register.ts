      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["activi gateway run", "Run the gateway in the foreground."],
            ["activi gateway status", "Show service status and probe reachability."],
            ["activi gateway discover", "Find local and wide-area gateway beacons."],
            ["activi gateway call health", "Call a gateway RPC method directly."],
