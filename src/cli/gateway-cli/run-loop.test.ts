...
describe("runGatewayLoop", () => {
  ...
  it("keeps process alive and logs transport bootstrap failures after restart", async () => {
    vi.clearAllMocks();
  ...
  it("keeps process alive and logs sidecar startup failures after restart", async () => {
    vi.clearAllMocks();
  ...
  it("keeps process alive and logs discovery startup failures after restart", async () => {
    vi.clearAllMocks();
