...
export function resolveFileNpmSpecToLocalPath(raw) {
...
export function applySlotSelectionForPlugin(config, pluginId) {
...
export function enableInternalHookEntries(config, hookNames) {
...
export function formatPluginInstallWithHookFallbackError(pluginError, hookError) {
...
export function logSlotWarnings(warnings) {
...
export function buildPreferredClawHubSpec(raw) {
...
export function decidePreferredClawHubFallback(params) {
    if (params.code === CLAWHUB_INSTALL_ERROR_CODE.PACKAGE_NOT_FOUND ||
