...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within SmartAgentNeo temp uploads dir, e.g. /tmp/smart-agent-neo/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within smart-agent-neo temp downloads dir (default: /tmp/smart-agent-neo/downloads/...; fallback: os.tmpdir()/smart-agent-neo/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within smart-agent-neo temp downloads dir (e.g. report.pdf or /tmp/smart-agent-neo/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
