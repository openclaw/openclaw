...
const RESTART_VERIFY_TIMEOUT_BUFFER_MS = 10_000;
const RESTART_VERIFY_TIMEOUT_MS =
  DEFAULT_RESTART_HEALTH_TIMEOUT_MS * 2 +
  SERVICE_REFRESH_TIMEOUT_MS +
  RESTART_VERIFY_TIMEOUT_BUFFER_MS;
