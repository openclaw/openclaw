    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["evox directory self --channel slack", "Show the connected account identity."],
          [
            'evox directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["evox directory groups list --channel discord", "List available groups/channels."],
          [
            "evox directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.evox.sh/cli/directory",
        )}\n`,
    )
    .action(() => {
