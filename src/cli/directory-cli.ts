    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mullusi directory self --channel slack", "Show the connected account identity."],
          [
            'mullusi directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["mullusi directory groups list --channel discord", "List available groups/channels."],
          [
            "mullusi directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.mullusi.com/cli/directory",
        )}\n`,
    )
    .action(() => {
