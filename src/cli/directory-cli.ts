    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["activi directory self --channel slack", "Show the connected account identity."],
          [
            'activi directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["activi directory groups list --channel discord", "List available groups/channels."],
          [
            "activi directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.activi.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
