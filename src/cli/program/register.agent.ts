...
${formatHelpExamples([
  ['activi agent --to +15555550123 --message "status update"', "Start a new session."],
  ['activi agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['activi agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.activi.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.activi.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['activi agents set-identity --agent main --name "Activi" --emoji "🦞"', "Set name + emoji."],
  ["activi agents set-identity --agent main --avatar avatars/activi.png", "Set avatar path."],
  [
    "activi agents set-identity --workspace ~/.activi/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "activi agents set-identity --identity-file ~/.activi/workspace/IDENTITY.md --agent main",
