...
${formatHelpExamples([
  ['dna agent --to +15555550123 --message "status update"', "Start a new session."],
  ['dna agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['dna agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['dna agents set-identity --agent main --name "Clawd" --emoji "🦞"', "Set name + emoji."],
  ["dna agents set-identity --agent main --avatar avatars/clawd.png", "Set avatar path."],
  ["dna agents set-identity --workspace ~/clawd --from-identity", "Load from IDENTITY.md."],
  [
    "dna agents set-identity --identity-file ~/clawd/IDENTITY.md --agent main",
