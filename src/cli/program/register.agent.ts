...
${formatHelpExamples([
  ['mullusi agent --to +15555550123 --message "status update"', "Start a new session."],
  ['mullusi agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['mullusi agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.mullusi.com/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.mullusi.com/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['mullusi agents set-identity --agent main --name "Mullusi" --emoji "🦞"', "Set name + emoji."],
  ["mullusi agents set-identity --agent main --avatar avatars/mullusi.png", "Set avatar path."],
  [
    "mullusi agents set-identity --workspace ~/.mullusi/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "mullusi agents set-identity --identity-file ~/.mullusi/workspace/IDENTITY.md --agent main",
