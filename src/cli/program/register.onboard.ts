...
import { normalizeOnboardOptionsInput } from "../../commands/onboard-option-normalization.js";
...
export function registerOnboardCommand(program: Command) {
  ...
  command.action(async (opts, commandRuntime) => {
    await runCommandWithRuntime(defaultRuntime, async () => {
      ...
      const normalizedOpts = normalizeOnboardOptionsInput({
        ...
        gatewayPort:
          typeof gatewayPort === "number" && Number.isFinite(gatewayPort) ? gatewayPort : undefined,
