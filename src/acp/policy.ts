...
export function isAcpEnabledByPolicy(cfg: MullusiConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: MullusiConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: MullusiConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: MullusiConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: MullusiConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: MullusiConfig, agentId: string): boolean {
