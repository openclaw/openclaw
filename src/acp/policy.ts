...
export function isAcpEnabledByPolicy(cfg: BotConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: BotConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: BotConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: BotConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: BotConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: BotConfig, agentId: string): boolean {
