...
import { buildConfiguredAcpSessionKey, normalizeText, } from "./persistent-bindings.types.js";
...
function sessionMatchesConfiguredBinding(params) {
    ...
    const desiredBackend = normalizeText(params.spec.backend) ?? normalizeText(params.cfg.acp?.backend) ?? "";
    if (desiredBackend) {
