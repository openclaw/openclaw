...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: BotConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: BotConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: BotConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: BotConfig }): Promise<void> {
