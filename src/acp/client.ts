...
function resolveToolNameForPermission(
	...
	const rawInputName = fromRawInput
		? normalizeToolName(fromRawInput)
		: undefined;
...
export async function createAcpClient(
	...
	const effectiveArgs =
		opts.serverCommand || !entryPath ? serverArgs : defaultServerArgs;
	const { getActiveSkillEnvKeys } = await import(
		"../agents/skills/env-overrides.runtime.js"
	);
