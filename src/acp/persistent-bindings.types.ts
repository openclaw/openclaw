...
export function buildConfiguredAcpSessionKey(
	spec: ConfiguredAcpBindingSpec,
): string {
...
export function toConfiguredAcpBindingRecord(
	spec: ConfiguredAcpBindingSpec,
...
export function resolveConfiguredAcpBindingSpecFromRecord(
	...
	return {
		...
		conversationId,
		parentConversationId: normalizeText(
			record.conversation.parentConversationId,
		),
		agentId,
