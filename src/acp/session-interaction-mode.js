...
export function resolveAcpSessionInteractionMode(entry) {
...
export function isParentOwnedBackgroundAcpSession(entry) {
 ...
 */
export function isRequesterParentOfBackgroundAcpSession(entry, requesterSessionKey) {
