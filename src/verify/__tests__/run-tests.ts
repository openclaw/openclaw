...
assert(policies.subagentDenyAlways.length === 8, "8 deny-always tools");
assert(policies.subagentDenyAlways.includes("gateway"), "gateway in deny-always");
assert(policies.subagentDenyLeaf.length === 3, "3 deny-leaf tools");
assert(policies.subagentDenyLeaf.includes("sessions_spawn"), "sessions_spawn in deny-leaf");
