/**
 * Standalone MCP server that exposes Mullusi plugin-registered tools
...
function resolveTools(config: MullusiConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "mullusi-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
