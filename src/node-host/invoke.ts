...
const execHostEnforced = process.env.SMART_AGENT_NEO_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  process.env.SMART_AGENT_NEO_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
