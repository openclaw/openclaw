...
import { hasDiscordMessageStickers, resolveDiscordMessageChannelId, resolveDiscordMessageText, } from "./message-utils.js";
export function createDiscordMessageHandler(params) {
    ...
    const ackReactionScope = params.discordConfig?.ackReactionScope ??
