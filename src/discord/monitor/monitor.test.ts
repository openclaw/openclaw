...
describe("agent components", () => {
  const createCfg = (): ActiviConfig => ({}) as ActiviConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/activi-sessions-test.json");
  });
