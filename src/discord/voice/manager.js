...
const PLAYBACK_READY_TIMEOUT_MS = 15000;
const SPEAKING_READY_TIMEOUT_MS = 60000;
const DECRYPT_FAILURE_WINDOW_MS = 30000;
...
export class DiscordVoiceManager {
    ...
    handleReceiveError(entry, err) {
        ...
        if (entry.decryptFailureCount === 1) {
            logger.warn("discord voice: DAVE decrypt failures detected; voice receive may be unstable (upstream: discordjs/discord.js#11419)");
        }
        if (entry.decryptFailureCount < DECRYPT_FAILURE_RECONNECT_THRESHOLD ||
