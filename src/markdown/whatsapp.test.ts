...
describe("markdownToWhatsApp", () => {
  it("handles common markdown-to-whatsapp conversions", () => {
    const cases = [
      ...
      [
        "leaves single *italic* unchanged (already WhatsApp bold)",
        "*text*",
        "*text*",
      ],
      [
        "leaves _italic_ unchanged (already WhatsApp italic)",
        "_text_",
        "_text_",
      ],
      [
      ...
      [
        "handles multiple bold segments",
        "**one** then **two**",
        "*one* then *two*",
      ],
      ...
      [
        "handles bold inside a sentence",
