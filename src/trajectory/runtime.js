...
import { TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, TRAJECTORY_RUNTIME_FILE_MAX_BYTES, resolveTrajectoryFilePath, resolveTrajectoryPointerFilePath, resolveTrajectoryPointerOpenFlags, } from "./paths.js";
...
export function toTrajectoryToolDefinitions(tools) {
    return tools
        .flatMap((tool) => {
...
export function createTrajectoryRuntimeRecorder(params) {
    ...
    return {
        ...
        recordEvent: (type, data) => {
            const event = {
                ...
                data: data ? sanitizeDiagnosticPayload(data) : undefined,
            };
