...
export function resolveDoctorMode(cfg) {
...
async function runAuthProfileHealth(ctx) {
    const { maybeRepairLegacyOAuthProfileIds } = await import("../commands/doctor-auth-legacy-oauth.js");
    const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("../commands/doctor-auth.js");
...
async function runGatewayAuthHealth(ctx) {
    ...
    const shouldSetToken = ctx.options.generateGatewayToken === true
        ? true
...
async function runLegacyStateHealth(ctx) {
    const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("../commands/doctor-state-migrations.js");
    const { note } = await import("../terminal/note.js");
    ...
    const migrate = ctx.options.nonInteractive === true
        ? true
...
async function runLegacyPluginManifestHealth(ctx) {
    const { maybeRepairLegacyPluginManifestContracts } = await import("../commands/doctor-plugin-manifests.js");
...
async function runBundledPluginRuntimeDepsHealth(ctx) {
    const { maybeRepairBundledPluginRuntimeDeps } = await import("../commands/doctor-bundled-plugin-runtime-deps.js");
...
async function runSandboxHealth(ctx) {
    const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("../commands/doctor-sandbox.js");
...
async function runGatewayServicesHealth(ctx) {
    const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("../commands/doctor-gateway-services.js");
    const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("../commands/doctor-platform-notes.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
    const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance.js");
...
async function runHooksModelHealth(ctx) {
    ...
    const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("../agents/model-selection.js");
    const { note } = await import("../terminal/note.js");
...
async function runSystemdLingerHealth(ctx) {
    if (ctx.options.nonInteractive === true ||
...
async function runGatewayHealthChecks(ctx) {
    const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("../commands/doctor-gateway-health.js");
...
async function runMemorySearchHealthContribution(ctx) {
    const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("../commands/doctor-memory-search.js");
...
async function runWriteConfigHealth(ctx) {
    ...
    const shouldWriteConfig = ctx.configResult.shouldWriteConfig ||
...
async function runWorkspaceSuggestionsHealth(ctx) {
    ...
    const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("../commands/doctor-workspace.js");
    const { note } = await import("../terminal/note.js");
...
export function resolveDoctorHealthContributions() {
    return [
...
export async function runDoctorHealthContributions(ctx) {
