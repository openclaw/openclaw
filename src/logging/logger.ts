...
export const DEFAULT_LOG_DIR = resolvePreferredSmartAgentNeoTmpDir();
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "smart-agent-neo.log"); // legacy single-file path

const LOG_PREFIX = "smart-agent-neo";
...
function resolveSettings(): ResolvedSettings {
  ...
  const defaultLevel =
    process.env.VITEST === "true" && process.env.SMART_AGENT_NEO_TEST_FILE_LOG !== "1" ? "silent" : "info";
