...
// Use ~/.openclaw/logs so the log dir is always owned by the running user.
// (Previously /tmp/openclaw, which broke when the gateway uid changed.)
export const DEFAULT_LOG_DIR = path.join(os.homedir(), ".openclaw", "logs");
