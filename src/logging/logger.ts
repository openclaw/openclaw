...
export const DEFAULT_LOG_DIR = "/tmp/EasyHub";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "easyhub.log"); // legacy single-file path

const LOG_PREFIX = "EasyHub";
