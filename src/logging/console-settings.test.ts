...
let originalMullusiTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalMullusiTestConsole = process.env.MULLUSI_TEST_CONSOLE;
...
afterEach(() => {
  ...
  if (originalMullusiTestConsole === undefined) {
    delete process.env.MULLUSI_TEST_CONSOLE;
  } else {
    process.env.MULLUSI_TEST_CONSOLE = originalMullusiTestConsole;
  }
