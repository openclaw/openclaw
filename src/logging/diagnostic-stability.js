...
export function normalizeDiagnosticStabilityQuery(input = {}, options) {
    return {
...
export function startDiagnosticStabilityRecorder() {
    const state = getDiagnosticStabilityState();
...
export function stopDiagnosticStabilityRecorder() {
    const state = getDiagnosticStabilityState();
    state.unsubscribe?.();
...
export function selectDiagnosticStabilitySnapshot(snapshot, options) {
...
export function resetDiagnosticStabilityRecorderForTest() {
    const state = getDiagnosticStabilityState();
    state.unsubscribe?.();
