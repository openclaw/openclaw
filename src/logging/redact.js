...
function redactText(text, patterns) {
    ...
    for (const pattern of patterns) {
        next = replacePatternBounded(next, pattern, (...args) => redactMatch(args[0], args.slice(1, -2)));
    }
    return next;
}
...
export function resolveRedactOptions(options) {
...
export function redactSensitiveLines(lines, resolved) {
