// Message lifecycle I/O (userPrompt/finalResponse) must reach
// logMessageProcessed so OTel message.processed span capture can export it.
// Recorder-only coverage cannot catch this: the span reads private
// messageContent that dispatch must actually wire through the lifecycle.
