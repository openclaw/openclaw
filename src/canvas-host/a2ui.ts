...
export const A2UI_PATH = "/__activi__/a2ui";

export const CANVAS_HOST_PATH = "/__activi__/canvas";

export const CANVAS_WS_PATH = "/__activi__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.activiCanvasA2UIAction.postMessage(...)
  // - Android: window.activiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["activiCanvasA2UIAction"];
  ...
  globalThis.Activi = globalThis.Activi ?? {};
  globalThis.Activi.postMessage = postToNode;
  globalThis.Activi.sendUserAction = sendUserAction;
  globalThis.activiPostMessage = postToNode;
  globalThis.activiSendUserAction = sendUserAction;
