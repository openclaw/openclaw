...
export const A2UI_PATH = "/__smart-agent-neo__/a2ui";

export const CANVAS_HOST_PATH = "/__smart-agent-neo__/canvas";

export const CANVAS_WS_PATH = "/__smart-agent-neo__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.smartAgentNeoCanvasA2UIAction.postMessage(...)
  // - Android: window.smartAgentNeoCanvasA2UIAction.postMessage(...)
  const handlerNames = ["smartAgentNeoCanvasA2UIAction"];
  ...
  globalThis.SmartAgentNeo = globalThis.SmartAgentNeo ?? {};
  globalThis.SmartAgentNeo.postMessage = postToNode;
  globalThis.SmartAgentNeo.sendUserAction = sendUserAction;
  globalThis.smartAgentNeoPostMessage = postToNode;
  globalThis.smartAgentNeoSendUserAction = sendUserAction;
