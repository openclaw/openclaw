...
export const A2UI_PATH = "/__dna__/a2ui";
export const CANVAS_HOST_PATH = "/__dna__/canvas";
export const CANVAS_WS_PATH = "/__dna/ws";
...
(() => {
  ...
  const handlerNames = ["dnaCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.DNA = globalThis.DNA ?? {};
  globalThis.DNA.postMessage = postToNode;
  globalThis.DNA.sendUserAction = sendUserAction;
  globalThis.dnaPostMessage = postToNode;
  globalThis.dnaSendUserAction = sendUserAction;
  globalThis.dnaPostMessage = postToNode;
  globalThis.dnaSendUserAction = sendUserAction;
