...
async function main() {
  if (hasFlag(args, "--version") || hasFlag(args, "-v")) {
    // Match `dna --version` behavior for Swift env/version checks.
  ...
  if (token) process.env.DNA_GATEWAY_TOKEN = token;
