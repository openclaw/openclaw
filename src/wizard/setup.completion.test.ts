...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("mullusi");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "mullusi");
