...
import type { GatewayBindMode, GatewayTailscaleMode, EasyHubConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.EasyHub.ai/gateway/tailscale", "https://docs.EasyHub.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
