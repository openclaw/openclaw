...
const CLAWORKS_WIZARD_OVERRIDES: Record<string, string> = {
  ...
  "wizard.finalize.securityReminder":
    "Running an autonomous robot on your network is risky — harden your setup: https://docs.openclaw.ai/gateway/security",
};
...
const CLAWORKS_WIZARD_OVERRIDES_ZH_CN: Record<string, string> = {
  ...
  "wizard.finalize.securityReminder":
    "在网络上运行自治机器人存在风险，请加固配置：https://docs.openclaw.ai/gateway/security",
};
...
const CLAWORKS_WIZARD_OVERRIDES_ZH_TW: Record<string, string> = {
  ...
  "wizard.finalize.securityReminder":
    "在網路上執行自治機器人存在風險，請加固設定：https://docs.openclaw.ai/gateway/security",
};
