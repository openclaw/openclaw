...
export const zh_CN = {
  ...
  wizard: {
    ...
    migration: {
      ...
      includeCredentials: "同时导入支持的身份验证凭据？",
      previewTitle: "迁移预览",
      setupModelSeparately: "单独设置模型",
      setupModelSeparatelyHint: "不导入其他 agent，直接配置模型身份验证",
