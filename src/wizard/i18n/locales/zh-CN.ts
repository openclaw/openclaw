...
export const zh_CN = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      authTokenMode: "你想如何存储 Gateway 密钥？",
      authTokenStoredMessage: "这个 Gateway 密钥存在哪里？",
    ...
    remote: {
      ...
      gatewayTokenStoredMessage: "这个 Gateway 密钥存在哪里？",
      insecureRemoteUrl:
      ...
      plaintextTokenHint: "将密钥直接存储在 OpenClaw 配置中",
      plaintextTokenLabel: "现在输入密钥",
      searchProgress: "正在搜索 Gateway...",
      selectGateway: "选择 Gateway",
      sshTunnel: "SSH 隧道（loopback）",
      sshTunnelTitle: "SSH 隧道",
      secretPlaceholder: "留空以保留现有密钥或不使用密钥继续",
      keepSecretConfirm: "保留现有 Gateway 密钥？",
      noSecretConfirm: "不使用 Gateway 密钥继续？",
      tokenPrompt: "Gateway 密钥",
