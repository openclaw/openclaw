...
export const en = {
  ...
  wizard: {
    ...
    whatsapp: {
      ...
      personalPhoneLabel: "This is my personal phone number (fallback; higher ban risk)",
      ...
      scanQr:
        "Scan the QR with WhatsApp on your phone; prefer a separate number for OpenClaw instead of your everyday WhatsApp account.",
      separatePhoneLabel: "Recommended: separate phone number just for OpenClaw",
