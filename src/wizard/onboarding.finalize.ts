  ...
  const webSearchKey =
    webSearchProvider === "perplexity"
      ...
      : webSearchProvider === "exa"
        ? (nextConfig.tools?.web?.search?.exa?.apiKey ?? "").trim()
  ...
  await prompter.note(
    hasWebSearchKey
      ? [
          ...
          "",
          `Provider: ${webSearchProvider === "perplexity" ? "Perplexity Search" : webSearchProvider === "exa" ? "Exa Search" : "Brave Search"}`,
          webSearchKey
            ? `API key: stored in config (tools.web.search.${webSearchProvider === "perplexity" ? "perplexity.apiKey" : webSearchProvider === "exa" ? "exa.apiKey" : "apiKey"}).`
            : `API key: provided via ${webSearchProvider === "perplexity" ? "PERPLEXITY_API_KEY" : webSearchProvider === "exa" ? "EXA_API_KEY" : "BRAVE_API_KEY"} env var (Gateway environment).`,
          "Docs: https://docs.openclaw.ai/tools/web",
        ].join("\n")
      : [
          "To enable web search, your agent will need an API key for Perplexity Search, Exa Search, or Brave Search.",
          "",
          "Set it up interactively:",
          `- Run: ${formatCliCommand("openclaw configure --section web")}`,
          "- Choose a provider and paste your API key",
          "",
          "Alternative: set PERPLEXITY_API_KEY, EXA_API_KEY, or BRAVE_API_KEY in the Gateway environment (no config changes).",
          "Docs: https://docs.openclaw.ai/tools/web",
        ].join("\n"),
    "Web search (optional)",
  );
