...
// Workspaces share a subscription for each logical target instead of charging
// a native worker per consumer. fs-safe owns the directory pins beneath those
// targets; different target subscriptions can still have overlapping coverage.
