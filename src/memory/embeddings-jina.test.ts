...
describe("jina embedding provider", () => {
  ...
  it("normalizes model names", async () => {
    expect(normalizeJinaModel("jina/jina-embeddings-v3")).toBe("jina-embeddings-v3");
    expect(normalizeJinaModel("jina-embeddings-v5-text-nano")).toBe("jina-embeddings-v5-text-nano");
    expect(normalizeJinaModel("  jina-embeddings-v2-base-en  ")).toBe("jina-embeddings-v2-base-en");
