...
const STOP_WORDS_NB = new Set([
  // Articles and determiners (Norwegian Bokmål)
  "en",
  "ei",
  "et",
  "den",
...
const STOP_WORDS_SV = new Set([
  // Articles and determiners (Swedish)
  "en",
  "ett",
  "den",
  "det",
...
export function extractKeywords(query: string): string[] {
  ...
  for (const token of tokens) {
    ...
    if (
      ...
      STOP_WORDS_DA.has(token) ||
      STOP_WORDS_NB.has(token) ||
      STOP_WORDS_SV.has(token)
    ) {
      continue;
    }
