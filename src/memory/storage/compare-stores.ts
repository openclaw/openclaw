...
async function run() {
    ...
    for (const test of testCases) {
        ...
        try {
            ...
            sqliteResults.forEach((r, i) => console.log(`  ${i+1}. [${r.score.toFixed(4)}] ${r.text.substring(0, 50)}...`));
        } catch (e: any) {
        ...
        try {
            ...
            lanceResults.forEach((r, i) => console.log(`  ${i+1}. [${r.score.toFixed(4)}] ${r.text.substring(0, 50)}...`));
        } catch (e: any) {
