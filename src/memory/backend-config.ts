...
const DEFAULT_QMD_TIMEOUT_MS = 15_000;
...
function resolveDefaultCollections(
  ...
  // Project and docs auto-discovery removed — QMD should only index agent
  // memory files, not project repos or source docs. Additional collections
  // can be added manually via index.yml if needed.
