...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: ActiviConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__activiMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__activiMcporterColdStartWarned;
  });
