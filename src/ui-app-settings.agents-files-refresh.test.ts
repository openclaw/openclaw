...
vi.mock("../ui/src/ui/controllers/agents.ts", async (importOriginal) => {
	const actual =
		await importOriginal<typeof import("../ui/src/ui/controllers/agents.ts")>();
	return { ...actual, loadAgents: loadAgentsMock };
});

vi.mock("../ui/src/ui/controllers/config.ts", async (importOriginal) => {
	const actual =
		await importOriginal<typeof import("../ui/src/ui/controllers/config.ts")>();
	return {
		...actual,
	...
	async (importOriginal) => {
		const actual =
			await importOriginal<
				typeof import("../ui/src/ui/controllers/agent-identity.ts")
			>();
		return {
			...actual,
...
vi.mock("../ui/src/ui/controllers/agent-skills.ts", async (importOriginal) => {
	const actual =
		await importOriginal<
			typeof import("../ui/src/ui/controllers/agent-skills.ts")
		>();
...
vi.mock("../ui/src/ui/controllers/agent-files.ts", async (importOriginal) => {
	const actual =
		await importOriginal<
			typeof import("../ui/src/ui/controllers/agent-files.ts")
		>();
...
vi.mock("../ui/src/ui/controllers/channels.ts", async (importOriginal) => {
	const actual =
		await importOriginal<
			typeof import("../ui/src/ui/controllers/channels.ts")
		>();
...
vi.mock("../ui/src/ui/controllers/cron.ts", async (importOriginal) => {
	const actual =
		await importOriginal<typeof import("../ui/src/ui/controllers/cron.ts")>();
	return {
		...actual,
...
): Parameters<typeof refreshActiveTab>[0] {
	return {
		tab: "agents",
		connected: true,
		agentsPanel,
