...
import { isPrivateNetworkAllowedByPolicy, resolvePinnedHostnameWithPolicy, } from "../infra/net/ssrf.js";
...
export async function assertBrowserNavigationAllowed(opts) {
    ...
    if (hasProxyEnvConfigured() && !isPrivateNetworkAllowedByPolicy(opts.ssrfPolicy)) {
        throw new InvalidBrowserNavigationUrlError("Navigation blocked: strict browser SSRF policy cannot be enforced while env proxy variables are set");
    }
