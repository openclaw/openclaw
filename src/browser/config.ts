import type { BrowserConfig, BrowserProfileConfig, DNAConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a DNA browser profile (routing config), not a Chrome user profile.
