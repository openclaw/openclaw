...
function buildProfileQuery(opts?: { profile?: string; relay?: string }): string {
...
export async function browserStatus(
  baseUrl?: string,
  opts?: { profile?: string; relay?: string },
): Promise<BrowserStatus> {
  const q = buildProfileQuery(opts);
