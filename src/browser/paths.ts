...
import { resolvePreferredSmartAgentNeoTmpDir } from "../infra/tmp-smart-agent-neo-dir.js";

export const DEFAULT_BROWSER_TMP_DIR = resolvePreferredSmartAgentNeoTmpDir();
