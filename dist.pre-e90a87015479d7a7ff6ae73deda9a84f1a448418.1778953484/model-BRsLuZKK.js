...
import { s as resolveDefaultAgentDir } from "./agent-scope-config-D57hqxoj.js";
import "./agent-scope-cOcI3Bf3.js";
import { s as planManifestModelCatalogRows } from "./manifest-jaYnJ93U.js";
import { i as normalizeStaticProviderModelId, n as modelKey } from "./model-ref-shared-vTNR_ORQ.js";
import "./defaults-BngqyJjG.js";
import { i as hasAnyRuntimeAuthProfileStoreSource } from "./source-check-DJCsdNek.js";
import { n as isManifestPluginAvailableForControlPlane, s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-So9Tffud.js";
...
import "./model-selection-CtlJEyaP.js";
import { l as sanitizeConfiguredModelProviderRequest, o as resolveProviderRequestConfig, t as attachModelProviderRequestTransport } from "./provider-request-config-DeZBxVks.js";
import { f as isSecretRefHeaderValueMarker } from "./model-auth-markers-D4wgUP3Y.js";
import { a as normalizeModelCompat } from "./provider-model-compat-CfVz-06_.js";
import { n as resolveRuntimeSyntheticAuthProviderRefs, t as resolveRuntimeExternalAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-D0tC-Kqj.js";
import { t as attachModelProviderLocalService } from "./provider-local-service-D6JDnxTd.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-DvhRwvtp.js";
import { a as shouldUnconditionallySuppress, n as buildSuppressedBuiltInModelError, r as shouldSuppressBuiltInModel } from "./model-suppression-0oZjrYfR.js";
import { statSync } from "node:fs";
import path from "node:path";
import { AuthStorage, ModelRegistry } from "@earendil-works/pi-coding-agent";
//#region src/agents/pi-embedded-runner/model-discovery-cache.ts
...
function discoverFreshPiStores(agentDir) {
...
function discoverCachedPiStores(options) {
	...
	if (hasAnyRuntimeAuthProfileStoreSource(agentDir) || hasRuntimePluginAuthSources()) return discoverFreshPiStores(agentDir);
...
function discoverCachedPiStoresForAgent(resolvedAgentDir, cfg) {
...
function resolveModel(provider, modelId, agentDir, cfg, options) {
	...
	const cachedStores = !options?.authStorage && !options?.modelRegistry ? discoverCachedPiStoresForAgent(resolvedAgentDir, cfg) : void 0;
...
async function resolveModelAsync(provider, modelId, agentDir, cfg, options) {
	...
	const cachedStores = !emptyDiscoveryStores && !options?.authStorage && !options?.modelRegistry ? discoverCachedPiStoresForAgent(resolvedAgentDir, cfg) : void 0;
