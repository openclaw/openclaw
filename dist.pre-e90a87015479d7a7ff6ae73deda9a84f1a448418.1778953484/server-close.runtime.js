...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-BP2X418Q.js";
import { i as listChannelPlugins } from "./registry-Dapwkxqy2.js";
import "./plugins-xyXSVvnh.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-DoeKYw7j.js";
import "./pi-bundle-mcp-tools-gqgJY_kj.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-DJab6WlL.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-C5hB9hzx.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-BWeewUOH.js");
...
function createGatewayCloseHandler(params) {
	return async (opts) => {
		...
		try {
			...
			if (params.drainActiveSessionsForShutdown) await shutdownStep("session-end-drain", async () => {
