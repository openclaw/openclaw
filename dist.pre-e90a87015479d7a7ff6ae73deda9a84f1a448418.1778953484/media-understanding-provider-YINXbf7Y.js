import { t as validateJsonSchemaValue } from "./schema-validator-C50wTne4.js";
import "./json-schema-runtime-BWTlzgKL.js";
import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-C-viHDZ_.js";
import { s as resolveCodexAppServerRuntimeOptions } from "./config-SiiasJf_.js";
import { i as assertCodexTurnStartResponse, l as readCodexTurnCompletedNotification, o as readCodexErrorNotification, r as assertCodexThreadStartResponse } from "./protocol-validators-BkgIbhTh.js";
import { r as readModelListResult } from "./models-05oHgKob.js";
import { t as isJsonObject } from "./protocol-iKHXcI8H.js";
...
async function runBoundedCodexVisionTurn(params) {
	...
	const client = params.options.clientFactory ? await params.options.clientFactory(appServer.start, params.profile) : await import("./shared-client-DvG3E3fd.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
