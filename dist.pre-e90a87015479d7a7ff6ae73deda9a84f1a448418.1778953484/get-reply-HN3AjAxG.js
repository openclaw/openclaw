...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-D57hqxoj.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DEwYgSEp.js";
import { l as resolveAgentSkillsFilter, p as resolveSessionAgentId } from "./agent-scope-cOcI3Bf3.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-CK_KOC49.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-D0UHWcy1.js";
...
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-Ch_vVUeC.js";
import { o as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-DhNuNQU4.js";
...
import { s as resetRegisteredAgentHarnessSessions } from "./registry-DnVtS_Qy.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-CkZcU59h.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-Bx20tvQk.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-4e7qCqMZ.js";
import { _ as resolveMaintenanceConfigFromInput, b as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-gabseflm.js";
...
import { b as resolveGroupSessionKey, g as deriveSessionMetaPatch, m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-Cykejs_P.js";
import { t as normalizeChatType } from "./chat-type-DI9qAKzx.js";
import "./plugins-xyXSVvnh.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-CMbEWlHU.js";
...
import { b as resolveModelRefFromString } from "./model-selection-shared-DvIdVzM0.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-CtlJEyaP.js";
import { r as applyOwnerOnlyToolPolicy } from "./tool-policy-CW7uHOZt.js";
import { o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-BQBCwY4M.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-DsB9imWz.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-D0Jk4CMH.js";
import { a as generateSecureToken } from "./secure-random-DgXBJL-N.js";
import { a as enqueueSystemEvent, u as removeSystemEvents } from "./system-events-DkEeQaZd.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-CDsEEdrA.js";
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-DhBxA4Dq.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-9RcnkmOp.js";
import { r as getCliSessionBinding } from "./cli-session-D_g8Gqmd.js";
import "./selection-BBu2cWZi.js";
import { Q as isReasoningTagProvider } from "./compaction-successor-transcript-B8phGJKU.js";
...
import { o as collectTextContentBlocks } from "./tool-result-middleware-Ppz6nr2q.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-x4lPrl5-.js";
import { n as resolveSilentReplySettings } from "./silent-reply-u4mT3U5e.js";
import { t as buildOutboundSessionContext } from "./session-context-DO08klhY.js";
import { t as resolveQueueSettings } from "./queue-BK0XLxwD.js";
...
import { n as resolveOriginMessageProvider } from "./origin-routing-DuHVayTD.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-DvOed2IB.js";
...
import { r as drainFormattedSystemEvents } from "./session-updates-DPBglcHM.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-DPJ5qcId.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-DCz2brt1.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-DtAZ5rXp.js";
...
import { t as parseSoftResetCommand } from "./commands-reset-mode-xf0TWR0y.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-C01Xerji.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-CcRD-Bz-.js";
import { t as finalizeInboundContext } from "./inbound-context-D-mP9wKu.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-CoiSOz8M.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Bm6NRJXe.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-BIwHycoh.js";
...
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-Ca07WqwF.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-D97foDev.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-Ca232KhW.js";
import { t as resolveFastModeState } from "./fast-mode-D05RWx4C.js";
import { t as buildCommandContext } from "./commands-context-DjQnlu--.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-lcmAhCuO.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-CYRIi1W3.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-Ce8fppjL.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-C9335X_y.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-DNSpCqCN.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-BoePf6Wh.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-C8cncRTC.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-DfeAIFSk.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-C6JG8ANa.js";
...
import { t as isResetAuthorizedForContext } from "./reset-authorization-BGwDJbut.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-shKgVlJk.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-BrU6c2wF.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-C14RGsjs.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-pHi-Sh8d.js"));
...
function buildReplyPromptBodies(params) {
	...
	const prefixedBodyWithEvents = prependEvents(rawPrefixedBody);
...
function buildReplyPromptEnvelopeBase(params) {
	...
	return {
		effectiveBaseBody: params.hasUserBody ? resetModelBody : "[User sent media without caption]",
		transcriptBody: params.isHeartbeat ? HEARTBEAT_TRANSCRIPT_PROMPT : params.isBareSessionReset ? softResetTail || `[OpenClaw session ${params.startupAction}]` : params.hasUserBody ? params.baseBody : "[User sent media without caption]",
		currentTurnContext: !params.isBareSessionReset && params.inboundUserContext.trim() ? {
...
async function runPreparedReply(params) {
	...
	const shouldFollowup = !effectiveResetTriggered && (resolvedQueue.mode === "steer" || resolvedQueue.mode === "followup" || resolvedQueue.mode === "collect");
...
const hookRunnerGlobalLoader = createLazyImportLoader(() => import("./hook-runner-global-D_VWPUQD.js"));
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-nHZzFsMM.js"));
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-Cw2Ip95E.js");
