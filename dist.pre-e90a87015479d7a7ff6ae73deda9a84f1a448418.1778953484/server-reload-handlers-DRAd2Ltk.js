...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-DkG6k0KW.js";
import "./installed-plugin-index-records-QdshXPJh.js";
import { n as formatConfigIssueLines } from "./issue-format-7d97IRVv.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-BYo_9rMG.js";
import { n as isRestartEnabled } from "./commands.flags-Bab6g5LH.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-D1-QaV1b.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-1xbVdoup.js";
import { o as resetModelCatalogCache } from "./model-catalog-BKZVkuD4.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DHTaOByN.js";
import { r as resetDirectoryCache } from "./target-resolver-BR-n_A9R.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-CpfZfOYc.js";
...
import { _ as resolveHooksConfig } from "./hooks-BbrBMIOd.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-CEf5NMso.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Bktak-sN.js";
...
import { t as buildGatewayCronService } from "./server-cron-CkOn3OJk.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Rem_kYlX.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-BCPiU_Nq.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BWeewUOH.js"), import("./gmail-watcher-lifecycle-BQpGuslu.js")]);
