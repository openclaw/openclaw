...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-DbmotrJn.js";
import "./model-selection-CtlJEyaP.js";
import { u as isGoogleModelApi } from "./pi-embedded-helpers-BPfPcv7l.js";
import { t as log$1 } from "./logger-Bkp60SNw.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-BMpmkx54.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BQhKvgXh.js");
