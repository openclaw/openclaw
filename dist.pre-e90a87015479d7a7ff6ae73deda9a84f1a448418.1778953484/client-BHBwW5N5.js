...
import { n as privateFileStoreSync } from "./private-file-store-BFBFreLV.js";
import { n as logError, t as logDebug } from "./logger-B4cEDktr.js";
import { i as isLoopbackHost, s as isSecureWebSocketUrl } from "./net-BYZmrkLW.js";
import { a as publicKeyRawBase64UrlFromPem, o as signDevicePayload, r as loadOrCreateDeviceIdentity } from "./device-identity-AsmJPli6.js";
...
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-CHrKc_3B.js";
import { t as resolveConnectChallengeTimeoutMs } from "./handshake-timeouts-DrLwnAay.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-CuCmFH1s.js";
import { a as withManagedProxyGatewayLoopbackRouting, t as ensureInheritedManagedProxyRoutingActive } from "./proxy-lifecycle-BGDw_nvP.js";
...
import { f as readPairingConnectErrorDetails, l as readConnectErrorDetailCode, s as formatConnectErrorMessage, t as ConnectErrorDetailCodes, u as readConnectErrorRecoveryAdvice } from "./connect-error-details-CqkaXucO.js";
import { At as validateRequestFrame, Y as validateEventFrame, jt as validateResponseFrame } from "./protocol-DFiQ7lBV.js";
...
var GatewayClient = class {
	...
	start() {
		...
		const ws = withManagedProxyGatewayLoopbackRouting(url, () => new WebSocket$1(url, wsOptions));
		this.ws = ws;
		this.socketOpened = false;
		this.connectNonce = null;
		this.connectSent = false;
