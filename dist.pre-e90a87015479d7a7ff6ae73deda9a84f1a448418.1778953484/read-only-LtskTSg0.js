...
import { r as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-CK_KOC49.js";
import { n as getCachedPluginModuleLoader } from "./plugin-module-loader-cache-yexjx1d3.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BtruRpXL.js";
...
import { a as resolveSetupChannelRegistration, t as channelPluginIdBelongsToManifest } from "./loader-channel-setup-D1gc61My.js";
import { i as listChannelPlugins } from "./registry-Dapwkxqy2.js";
import { f as listConfiguredChannelIdsForReadOnlyScope, g as resolveDiscoverableScopedChannelPluginIds, u as hasExplicitChannelConfig } from "./channel-plugin-ids-DxmCOiD7.js";
import { n as normalizeChannelCommandDefaults, r as readOwnRecordValue, t as isSafeManifestChannelId } from "./read-only-command-defaults-BtT-rkZc.js";
...
function resolveReadOnlyChannelPluginsForConfig(cfg, options = {}) {
	...
	const manifestRecords = (options.stateDir === void 0 ? getCurrentPluginMetadataSnapshot({
		config: cfg,
		env,
		workspaceDir
	}) : void 0)?.plugins ?? loadPluginMetadataSnapshot({
		config: cfg,
