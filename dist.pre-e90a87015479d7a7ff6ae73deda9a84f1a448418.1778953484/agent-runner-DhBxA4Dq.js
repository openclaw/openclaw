...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-cOcI3Bf3.js";
...
import { i as freezeDiagnosticTraceContext, s as runWithDiagnosticTraceparent, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-CdxuW_9m.js";
import { a as isDiagnosticsEnabled, i as emitTrustedDiagnosticEvent } from "./diagnostic-events-B-ttv5Wu.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-D0UHWcy1.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-rQaj7GfQ.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-Ch_vVUeC.js";
...
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-B1hkQDEm.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-4e7qCqMZ.js";
import { t as loadSessionStore } from "./store-load-gabseflm.js";
import { b as resolveGroupSessionKey, c as updateSessionStoreEntry, m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-Cykejs_P.js";
...
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-1xbVdoup.js";
import { a as formatEmbeddedPiQueueFailureSummary, f as queueEmbeddedPiMessageWithOutcomeAsync } from "./runs-ChtHyhIB.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-BF8RJshP.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CmPWLuUf.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-DCHsUjMx.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-928cx93-.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-CY62u6v0.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CSjj5Sw-.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DktopFXE.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-DwiKu103.js";
import { r as hasCrossSessionDelegateTargeting } from "./targeting-pure-BOa2p7I0.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DsB9imWz.js";
import { u as stripHeartbeatToken } from "./heartbeat-D0Jk4CMH.js";
import { r as enqueueCommitmentExtraction } from "./runtime-8ggsENA-.js";
import { c as emitContinuationWorkSpan, g as startContinuationDelegateSpan, i as emitContinuationDisabledSpan, m as resolveContinuationTraceparent, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-CaLQceC6.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-rdwXvn7X.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-DgXBJL-N.js";
import { a as enqueueSystemEvent } from "./system-events-DkEeQaZd.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CDsEEdrA.js";
import { n as resolveSendPolicy } from "./send-policy-B2JQeeXU.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-BkZAXeom.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-B9Vs48SU.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-DEeiaETF.js";
import { t as checkContextPressure } from "./context-pressure-CBXeniGw.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-CEyD09KU.js";
import { a as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-eOKf0itp.js";
...
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-D2qgzoMm.js";
import { t as formatProviderModelRef } from "./model-runtime-DRuiwv6h.js";
import "./fallback-notice-state-C3eb6h0w.js";
import { i as setReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-BCYeCEKu.js";
...
import { u as isLikelyExecutionAckPrompt } from "./selection-BBu2cWZi.js";
import { h as parseReplyDirectives } from "./deliver-4BB0N4PL.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-DS56t4P8.js";
import { i as estimateMessagesTokens } from "./compaction-Bqf4Zl7d.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-u4mT3U5e.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-eOOwKpWQ.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-Cx6IiUzD.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-XgAFvKxX.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-BK0XLxwD.js";
import { n as hasCotFramePrefix } from "./normalize-reply-Bfe0E3MQ.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BXvaJb-V.js";
import "./sandbox-D9npHsLz.js";
import { n as readPostCompactionContext } from "./post-compaction-context-DUVCYzfW.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-8Kfn5UAx.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-C3svx2YE.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DuHVayTD.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-DvOed2IB.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-PdLeyPdQ.js";
import { n as incrementCompactionCount } from "./session-updates-DPBglcHM.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-Dh5W5XId.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-eL9JmlT0.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-jjiplYex.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-DPJ5qcId.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-BMETKvZF.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-DnIoJDfv.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-B8JSOObF.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-FIowoq6B.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-BKi6Vy9Q.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-BefVhan4.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-CjhFKB0N.js"),
					import("./config-DSYZI0T6.js"),
					import("./state-Ul3YkHnl.js"),
					import("./store-B11fQ1jM.js")
				]);
