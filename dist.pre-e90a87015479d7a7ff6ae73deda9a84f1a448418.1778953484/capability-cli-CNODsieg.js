...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-D57hqxoj.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details--w0HJaXO.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-7ib1D5c0.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-DVsYbNwX.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-BtDR8PEp.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-QjVsmu12.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-aeRpoKPi.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-CtlJEyaP.js";
import "./auth-profiles-CnBNHbn4.js";
import { n as listProfilesForProvider } from "./profile-list-DXxsKl_a.js";
import { r as loadModelCatalog } from "./model-catalog-BKZVkuD4.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-ByVIVrXZ.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-BKs7lFPK.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-sBv4cR6r.js";
import "./tts-Dyw8MJyF.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CIyY2JWa.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-DWFW9lTV.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DsC5xPQK.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-BKlCx8Fm.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-BtAk4moA.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-BUostmnH.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-CLnf79j6.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-ClxHN79X.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-D7qZRVbC.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-hyRunmMH.js");
