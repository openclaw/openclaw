...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout } from "./reply-payload-GL3-wijr.js";
import { f as renderMessagePresentationFallbackText } from "./payload-Um8JiSYJ.js";
...
import { a as sendMessageMatrix, l as sendTypingMatrix, o as sendPollMatrix } from "./send-CM95FJgw.js";
...
import { t as resolveMatrixTargets } from "./resolve-targets-BOyeHfT4.js";
//#region extensions/matrix/src/matrix/probe.ts
let matrixProbeRuntimeDepsPromise;
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-CgbytVoh.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));
