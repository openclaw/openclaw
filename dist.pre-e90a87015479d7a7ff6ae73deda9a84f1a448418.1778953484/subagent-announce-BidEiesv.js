...
import { s as isEmbeddedPiRunActive, v as waitForEmbeddedPiRunEnd } from "./runs-ChtHyhIB.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-C5yP4G5f.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-BDGXYXNu.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DsB9imWz.js";
import { i as consumePendingDelegates } from "./delegate-store-BkZAXeom.js";
import "./continuation-delegate-store-B9Vs48SU.js";
import { n as resolveContinuationRuntimeConfig } from "./config-DEeiaETF.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Bf54t4KO.js";
import "./delivery-context-B47X2Fvk.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BLMKB96M.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-BoScwm2W.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-bmI3-7D5.js";
import { n as buildAnnounceIdFromChildRun, r as buildAnnounceIdempotencyKey, t as resolveAnnounceOrigin } from "./subagent-announce-origin-DEB0lFln.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-Ul3YkHnl.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-C8wo8CSN.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-0VkvOfeU.js"), import("./store-load-B-i3ejaT.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { hasCrossSessionDelegateTargeting } = await import("./targeting-pure-wSlDqegs.js");
	if (!hasCrossSessionDelegateTargeting(params.targeting, params.dispatchingSessionKey)) return false;
	const { enqueueSystemEvent } = await import("./system-events-ZPBMyZT1.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-DTG2hqDZ.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-ZPBMyZT1.js");
			const { createSubsystemLogger } = await import("./subsystem-BWtkdr_G.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-Dw9gHEK8.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
