...
import { i as getPluginModuleLoaderStats } from "./plugin-module-loader-cache-yexjx1d3.js";
...
import { l as loadOpenClawPlugins, r as clearActivatedPluginRuntimeState } from "./loader-BcLmYXYK.js";
import { I as createEmptyPluginRegistry, x as setActivePluginRegistry } from "./runtime-BOa5903J.js";
import { t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-CdCbcLsX.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-E-xdi-hW.js";
import { T as parseModelRef, w as normalizeModelRef } from "./model-selection-shared-DvIdVzM0.js";
...
async function dispatchGatewayMethod(method, params, options) {
	...
	if (options?.expectFinal !== true || firstPayload?.status !== "accepted") return unwrapGatewayMethodDispatchResponse(method, firstResponse);
	return unwrapGatewayMethodDispatchResponse(method, finalResponse ?? await new Promise((resolve, reject) => {
...
//#endregion
export { setFallbackGatewayContextResolver as a, loadGatewayPlugins as i, createGatewaySubagentRuntime as n, setPluginSubagentOverridePolicies as o, dispatchGatewayMethodInProcess as r, createGatewayNodesRuntime as t };
