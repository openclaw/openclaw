...
import { l as redactToolPayloadText } from "./redact-CwdxH-4-.js";
...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-qD-NZHCY.js";
import { n as normalizeAccountId } from "./account-id-CwBWagLE.js";
import { c as normalizeAgentId, g as toAgentStoreSessionKey, p as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-DFEyR49L.js";
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-D57hqxoj.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-cOcI3Bf3.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-D985sTLL.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-D3tbFUO2.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-CKxpl45h.js";
...
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-BYo_9rMG.js";
...
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-CqkaXucO.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-So9Tffud.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-BcLmYXYK.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-B1hkQDEm.js";
import { n as assertSandboxPath } from "./sandbox-paths-CZNxMU9G.js";
import "./local-file-access-Q82fMlCA.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-KxKmtI0a.js";
import { h as stringifyRouteThreadId } from "./channel-route-B-UEK-Fu.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-Bx20tvQk.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-4e7qCqMZ.js";
import { b as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-gabseflm.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-Dapwkxqy2.js";
import { n as resolveSessionConversationRef } from "./session-conversation-DH0WvJ9X.js";
...
import { c as extractDeliveryInfo } from "./sessions-C96ZMbNO.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-aeRpoKPi.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DbmotrJn.js";
import { C as modelKey$1, b as resolveModelRefFromString, i as buildModelAliasIndex, w as normalizeModelRef } from "./model-selection-shared-DvIdVzM0.js";
...
import { r as getApiKeyForModel } from "./model-auth-ChezQtKQ.js";
...
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CTl6BNmA.js";
import "./tool-policy-CW7uHOZt.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-DjdY2pIE.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-C5yP4G5f.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BQBCwY4M.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-BF8RJshP.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-928cx93-.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-Cved_m-3.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-C8HtPsfy.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-Dq_Vhb2d.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-5ELbk8Ml.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-CY62u6v0.js";
import { n as extractTextFromChatContent } from "./chat-content-C8Zb3fHZ.js";
import { r as stripToolMessages } from "./chat-history-text-Cs777T9W.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-BOa2p7I0.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DsB9imWz.js";
import { l as formatActiveContinuationTraceparent } from "./continuation-tracer-CaLQceC6.js";
import { t as completionRequiresMessageToolDelivery } from "./completion-delivery-policy-ZjDftBJs.js";
import "./targeting-6n8AfCZT.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BkZAXeom.js";
import { n as resolveContinuationRuntimeConfig } from "./config-DEeiaETF.js";
import { a as getImageMetadata } from "./image-ops-ByVIVrXZ.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-DmBpeg_v.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-CGdM-BSy.js";
import { a as resolvePluginTools } from "./tools-Bp84G0Xj.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-gK-xaCr_.js";
import { c as isToolWrappedWithBeforeToolCallHook, h as listChannelSupportedActions, p as listAllChannelSupportedActions, u as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-D8vqoOUW.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DJE5nTKg.js";
import { n as extractAssistantText } from "./pi-embedded-utils-CWxJBVgB.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Bf54t4KO.js";
import { n as runWithImageModelFallback } from "./model-fallback-DS56t4P8.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DXHoGkrx.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-FE4txvh6.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-gqb9cO7s.js";
...
import "./delivery-context-B47X2Fvk.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BnrMn4RJ.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-DHTaOByN.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-CG3_CR-w.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-I9A1h81L.js";
import { t as inferLegacyName } from "./normalize-BehTt0Sy.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BRw3HTxP.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-CjjxqHKM.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DSDD4Lza.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-B5RdZ0dj.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CDoE4Rq7.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CioYkxO7.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-D5NJtKv-.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DHhPkD15.js";
import { u as saveMediaBuffer } from "./store-BbB-fbmJ.js";
import { t as SsrFBlockedError } from "./ssrf-CxdudCgU.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-CZ6ig3Y3.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-B1Q1xvDY.js";
import { r as getDefaultLocalRoots } from "./local-media-access-rrTTk-jj.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-C_4RkrUc.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-C-BW1-fe.js";
...
import { n as normalizeMediaProviderId } from "./config-provider-models-DnZBBGEG.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BhrUSTkB.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-D8nXiC0N.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-BKs7lFPK.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-MxV6rBEF.js";
import { s as resolveTimeoutMs } from "./resolve-Da_473g7.js";
import { t as buildProviderRegistry } from "./runner-B5F8BOQx.js";
import "./media-understanding-KaEw0z6v.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CIYh7gYL.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-Bc_YCbBD.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-TAjAsIQC.js";
import { a as resolveAllowedMessageActions, n as runMessageAction, o as POLL_CREATION_PARAM_DEFS, s as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-Bua-uFtn.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-Bn86hTSU.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-DDi0PfV-.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DvMuGnpM.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BLMKB96M.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-CkAotpdB.js";
...
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-CZIn0i0s.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-D1PIw9nA.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-BuY6mlmX.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CATeiDEF.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Di-d5b_E.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-COTWLEWq.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DKD3BQgi.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-bmI3-7D5.js";
import { p as registerSubagentRun } from "./subagent-registry-8rwhiSjK.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-Djky3MsN.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-ff4500A8.js";
import { k as textToSpeech } from "./tts-runtime-sBv4cR6r.js";
import "./tts-Dyw8MJyF.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-DrH4pjAE.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-TQVEJ67S.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-Dqopd_ap.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-gCv6IKXI.js";
...
import { i as runWebSearch } from "./runtime-DWFW9lTV.js";
import "./web-search-provider-common-Dcw_80Uz.js";
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-YNvlC7Q8.js"));
