...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-CJTlN4T8.js";
import "./channel-message-B1-LA4aR.js";
import "./text-autolink-runtime-R0nrqEEc.js";
import { t as require_src } from "./src-LrCVCkCY.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids--Ej62KQI.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-P8zWLDnr.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-DzIp6AbU.js";
import { t as fromBuffer } from "./lib-DVWG0hGC.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-Co2TEYWD.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-Dkdnadts.js";
import { l as toRatio, n as decodeString } from "./Util-CzWsELU4.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BsfQBGlD.js";
import { t as APEv2Parser } from "./APEv2Parser-CrD8izLn.js";
import { r as hasID3v1Header } from "./ID3v1Parser-z6TEV1VW.js";
import { i as isStrictDirectRoom } from "./direct-room-D7AJ6ez-.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-CGtR7fAl.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-Do0H1ABF.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-D8rW_m6e.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Cn9V5ob5.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CS7XpxVe.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-B8DrSvxS.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CrmSeHjw.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-D9mGZM6z.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-B-dtghs7.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Dngf1nBW.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DgTNooMz.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Ca0HEkAB.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DM7iVHBC.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BXuol0C6.js")).WaveParser;
	}
};
//#endregion
