...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-fcqi3mt7.js";
import "./config-l2XEsxHu.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-fIB08_O9.js"), import("./logging-BfF0maaD.js")]).then(([sdkModule, loggingModule]) => ({
