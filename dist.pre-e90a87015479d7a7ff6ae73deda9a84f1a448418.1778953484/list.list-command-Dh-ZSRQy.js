...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-D3tbFUO2.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-DQALbvMK.js";
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-MHApxXRA.js";
import { C as modelKey, T as parseModelRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-DvIdVzM0.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-ChezQtKQ.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-XhU0ktTD.js";
import { n as loadModelsConfigWithSource } from "./load-config-BZyjNZtH.js";
import { n as formatErrorWithStack } from "./list.errors-CCOqXXuG.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-BTXvedqE.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-Chh2k7fl.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources--wYG8cSJ.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BDruPgMm.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DuxvNrGi.js"),
		import("./agent-scope-DSLu8euX.js"),
		import("./workspace-BkGLmKM8.js")
	]);
