...
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-DeZBxVks.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DnZBBGEG.js";
import { t as describeImageWithModel } from "./image-runtime-D8nXiC0N.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-BKs7lFPK.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-Da_473g7.js";
import { n as providerOperationRetryConfig } from "./operation-retry-xbzd3715.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-C6lpuWil.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-BazBBjYF.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-BnXFqEyu.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
