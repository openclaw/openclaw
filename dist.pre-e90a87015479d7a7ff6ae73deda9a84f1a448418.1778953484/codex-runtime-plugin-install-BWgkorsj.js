...
import { i as modelSelectionShouldEnsureCodexPlugin } from "./openai-codex-routing-MHApxXRA.js";
...
async function ensureCodexRuntimePluginForModelSelection(params) {
	...
	const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BPUM8DD3.js");
...
async function repairCodexRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-BLZYL7lC.js");
