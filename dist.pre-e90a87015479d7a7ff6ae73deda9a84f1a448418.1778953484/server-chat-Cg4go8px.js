import { n as detectErrorKind } from "./errors-C5Jbj3g5.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-qD-NZHCY.js";
import { i as getRuntimeConfig } from "./io-CKxpl45h.js";
import { g as normalizeVerboseLevel } from "./thinking-D0UHWcy1.js";
import { r as setSafeTimeout } from "./timer-delay-CHrKc_3B.js";
import { c as getAgentRunContext } from "./agent-events-B1hkQDEm.js";
import { c as updateSessionStoreEntry } from "./store-Cykejs_P.js";
import "./sessions-C96ZMbNO.js";
import { c as loadSessionEntry, s as loadGatewaySessionRow } from "./session-utils-Cved_m-3.js";
import { u as stripHeartbeatToken } from "./heartbeat-D0Jk4CMH.js";
import { a as resolveToolSearchCodeDisplayTarget } from "./tool-display-common-CFg89dwC.js";
...
import { a as createToolEventRecipientRegistry, i as createSessionMessageSubscriberRegistry, n as createChatRunState, r as createSessionEventSubscriberRegistry, t as createChatRunRegistry } from "./server-chat-state-BLGjrLQc.js";
...
function createAgentEventHandler({ broadcast, broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients, sessionEventSubscribers, loadGatewaySessionRowForSnapshot = loadGatewaySessionRow, lifecycleErrorRetryGraceMs = AGENT_LIFECYCLE_ERROR_RETRY_GRACE_MS, isChatSendRunActive = () => false }) {
	...
	return (evt) => {
		...
		if (isToolEvent) {
			if ((typeof evt.data?.phase === "string" ? evt.data.phase : "") === "start" && isControlUiVisible && sessionKey && !isAborted && !suppressHeartbeatToolEvents) flushBufferedChatDeltaIfNeeded(sessionKey, clientRunId, evt.runId, evt.seq);
		...
		if (isControlUiVisible && sessionKey) {
			if (!isToolEvent || !suppressHeartbeatToolEvents && toolVerbose !== "off") nodeSendToSession(sessionKey, "agent", isToolEvent ? projectToolSearchCodeEventForChannelPayload({
				...channelToolPayload,
				...buildSessionEventSnapshot(sessionKey)
			}) : agentPayload);
