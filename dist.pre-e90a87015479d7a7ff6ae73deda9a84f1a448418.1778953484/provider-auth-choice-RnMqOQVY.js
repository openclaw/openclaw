...
import { n as openUrl } from "./browser-open-IdxcbFwu.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DdPGcTpK.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-D1eI83m_.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DuyuYR00.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-CmA9-v-Y.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-1_PSsQYm.js") };
