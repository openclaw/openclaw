...
import { a as isTransientNetworkError, n as isAbortError } from "./unhandled-rejections-OLZr3s0s.js";
import { n as detectMime, p as MAX_DOCUMENT_BYTES, r as extensionForMime } from "./mime-aeRpoKPi.js";
import { f as saveMediaStream, u as saveMediaBuffer } from "./store-BbB-fbmJ.js";
import { i as withStrictGuardedFetchMode, n as fetchWithSsrFGuard, o as withTrustedExplicitProxyGuardedFetchMode } from "./fetch-guard-Bdx2n6li.js";
import { n as retryAsync } from "./retry-Cm6J8T4K.js";
import { n as readResponseWithLimit, t as readResponseTextSnippet } from "./read-response-with-limit-CtXCydeR.js";
...
function resolveRemoteFileName(params) {
	...
	return parseContentDispositionFileName(params.res.headers.get("content-disposition")) || (params.filePathHint ? path.basename(params.filePathHint) : void 0) || fileNameFromUrl;
}
...
async function readRemoteMediaBufferOnce(options) {
	...
	try {
		...
		const filePathForMime = fileName && path.extname(fileName) ? fileName : options.filePathHint ?? finalUrl;
