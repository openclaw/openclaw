...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CAj0uGR5.js";
import "./local-file-access-Q82fMlCA.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-aeRpoKPi.js";
import { r as fetchWithTimeout } from "./fetch-timeout-B1Q1xvDY.js";
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-D_uP1fe5.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-DJAQxAl-.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DnZBBGEG.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-BKs7lFPK.js";
import { t as providerSupportsCapability } from "./provider-supports-B3QJvUwc.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-Da_473g7.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-BxhcVmyb.js";
import { t as buildRandomTempFilePath } from "./temp-download-CB9JHZCB.js";
import "./temp-path-B47onXYP.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-rjyv81sx.js";
import "./shared-BgAiEjHr.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-Du_YCouG.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-BazBBjYF.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BnXFqEyu.js");
