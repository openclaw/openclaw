...
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-Ch_vVUeC.js";
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-Bv-53Zd6.js";
import { n as channelRouteDedupeKey } from "./channel-route-B-UEK-Fu.js";
import { n as getLoadedChannelPlugin } from "./registry-Dapwkxqy2.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-xyXSVvnh.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-Cp7VImJb.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DHTaOByN.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-uJM2ueKK.js";
import { l as roleScopesAllow } from "./pairing-token-m4bll64i.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CKUaNGZj.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-DXQfHchL.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DwPuyUYh.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BnIHeHk3.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-Dn88wlCf.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Bktak-sN.js";
import { t as diffConfigPaths } from "./config-diff-m-bK-gqj.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CF5oJ49l.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-CFRckQqN.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-OpBFaZk8.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-meSfDgL-.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-CWsb1Le2.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
