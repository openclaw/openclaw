import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DdPGcTpK.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CWJLdVfL.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-1_PSsQYm.js");
