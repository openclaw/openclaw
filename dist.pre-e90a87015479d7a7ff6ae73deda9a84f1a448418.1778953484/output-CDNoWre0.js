...
function formatItemPrefix(item, mode) {
...
function formatMigrationItem(item, mode) {
	...
	return `${formatItemPrefix(item, mode)}${name}${sensitive}${messageSuffix}`;
}
...
//#endregion
export { writeApplyResult as a, formatMigrationResult as i, assertConflictFreePlan as n, formatMigrationPreview as r, assertApplySucceeded as t };
