...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-D57hqxoj.js";
import { i as replaceFileAtomicSync } from "./replace-file-VPhXrtU-.js";
import { t as createNonExitingRuntime } from "./runtime-BCcywdXw.js";
import { i as getChildLogger } from "./logger-D7QW7hWe.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-BjBVXBcN.js";
...
import { n as mutateConfigFile } from "./mutate-B6z3DCSc.js";
import { u as fireAndForgetHook } from "./hook-runner-global-CkZcU59h.js";
import { t as createDedupeCache } from "./dedupe-CpPayiRJ.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BcHlwuH3.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-4e7qCqMZ.js";
import { t as loadSessionStore } from "./store-load-gabseflm.js";
import { m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-Cykejs_P.js";
...
import { t as resolveAndPersistSessionFile } from "./session-file-DWzcRG8L.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-CtlJEyaP.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-p0BZRyGm.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-BKZVkuD4.js";
import { f as findCodeRegions, p as isInsideCode, u as stripReasoningTagsFromText } from "./assistant-visible-text-CY62u6v0.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-GL3-wijr.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-CWxJBVgB.js";
import { c as projectOutboundPayloadPlanForDelivery, i as createOutboundPayloadPlan } from "./deliver-4BB0N4PL.js";
import { C as resolveChannelStreamingPreviewToolProgress, a as createChannelProgressDraftGate, c as formatChannelProgressDraftText, h as resolveChannelProgressDraftMaxLines, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName, v as resolveChannelStreamingBlockEnabled } from "./channel-streaming-DJqJ584R.js";
import { n as MediaFetchError } from "./fetch-D_uP1fe5.js";
...
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-BzRcU9Kv.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-DZwoFz2Z.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-x4lPrl5-.js";
import { n as createPreviewMessageReceipt } from "./live-VfXatpzA.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-DEa-Ib2y.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-B5FShMNc.js";
import { t as resolveAckReaction } from "./identity-BNM6gytY.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-DhqFao0J.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-C01Xerji.js";
...
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-Ca07WqwF.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-Bh2uumCd.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions--MhxJxMm.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-wEWYx5ow.js";
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-Bs8XQYnd.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-i86oBmvH.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-KktCRWPM.js";
...
import { n as firstDefined } from "./allow-from-BPGE9DND.js";
import "./channel-policy-B7MF_g_y.js";
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-DsWb8zKl.js";
import "./reply-history-FWJTrfrZ.js";
import "./runtime-env-va97TstQ.js";
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-DXQfHchL.js";
...
import "./config-mutation-BgWJJLz5.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-CFLmT8TR.js";
import "./reply-chunking-BBh-9ejZ.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-B41g3V5u.js";
import "./outbound-runtime-DQGWEEKY.js";
import "./runtime-config-snapshot-BZMo_4XM.js";
import "./model-session-runtime-DZaTu7nA.js";
import "./media-runtime-DeuscnM0.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-BSnUGz7y.js";
import "./conversation-runtime-DucX94iO.js";
import "./text-chunking-WnXdOF_7.js";
import "./agent-runtime-D8uLumig.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-CrCKAKOl.js";
import "./security-runtime-CdU5WpyI.js";
import "./agent-harness-runtime-D8Rm3EGi.js";
import "./hook-runtime-BnP6nMyv.js";
import "./markdown-table-runtime-BQeKPo6R.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-DFmrHHTo.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-FBE3hca2.js";
import "./command-auth-native-Ck4HgLG-.js";
import "./command-primitives-runtime-BmQpPsSB.js";
import "./command-status-Bh5N2_1g.js";
import "./command-detection-1MxFQ5kx.js";
import "./command-surface-CiwBTv4C.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-0cFrBc44.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-CYwPbHFe.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-DV5I9l4s.js";
...
import { h as createMessageReceiveContext } from "./channel-message-B1-LA4aR.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BR8BiOoy.js";
import "./session-store-runtime-RHGjytZK.js";
import "./models-provider-runtime-y4-8vGZZ.js";
import "./skill-commands-runtime-B0BWoKJn.js";
import "./native-command-config-runtime-BLQhHdVB.js";
import { t as mergeTelegramAccountConfig } from "./account-config-vFr2EU1d.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-CcSX-LRn.js";
import { A as resolveTelegramGroupAllowFromContext, B as getTelegramTextParts, C as extractTelegramForumFlag, D as resolveTelegramDirectPeerId, E as resolveTelegramCommandAuthorization, F as withResolvedTelegramForumFlag, G as resolveTelegramPrimaryMedia, I as buildSenderLabel, J as isSenderAllowed, K as expandTelegramAllowFromWithAccessGroups, L as buildSenderName, M as resolveTelegramStreamMode, N as resolveTelegramThreadSpec, O as resolveTelegramForumFlag, P as shouldUseTelegramDmThreadSession, R as expandTextLinks, S as describeReplyTarget, U as normalizeForwardedContext, V as hasBotMention, X as normalizeDmAllowFromWithStore, Y as normalizeAllowFrom, Z as resolveTelegramEffectiveDmPolicy, _ as buildTelegramGroupPeerId, a as renderTelegramHtmlText, b as buildTelegramThreadParams, g as buildTelegramGroupFrom, h as buildGroupLabel, j as resolveTelegramReplyId, k as resolveTelegramForumThreadId, m as tagTelegramNetworkError, n as markdownToTelegramChunks, q as resolveTelegramDmAllow, v as buildTelegramParentPeer, w as isTelegramCommandsAllowFromConfigured, x as buildTypingThreadParams, y as buildTelegramRoutingTarget, z as extractTelegramLocation } from "./format-bKTCeFLI.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-ByMT4L_5.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DbI_5kxz.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-2kwKEXwt.js";
import { n as resolveTelegramRequestTimeoutMs } from "./request-timeouts-CEXR8Vya.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-D6SxnmCE.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-j0-gK6KB.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-D_ev8O8T.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-Be1z4mQe.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-L3ZfxbxF.js";
import { C as withTelegramApiErrorLogging, D as sequentialize, E as apiThrottler, T as Bot, a as editMessageTelegram, g as recordSentMessage, w as getOrCreateAccountThrottler, x as buildInlineKeyboard } from "./send-DHpeldv6.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-BWG39lQ_.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-D3TYIXnd.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-gCg6mCYS.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-CZ--Y3tm.js");
...
const registerTelegramHandlers = ({ cfg, accountId, bot, opts, telegramTransport, runtime, mediaMaxBytes, telegramCfg, allowFrom, groupAllowFrom, resolveGroupPolicy, resolveTelegramGroupConfig, shouldSkipUpdate, processMessage, logger, telegramDeps }) => {
	...
	const processMediaGroup = async (entry) => {
		try {
			...
			await processMessageWithReplyChain(primaryEntry.ctx, primaryEntry.msg, allMedia, storeAllowFrom, promptContextBoundaryOptions(entry.promptContextMinTimestampMs));
		} catch (err) {
	...
	const processInboundMessage = async (params) => {
		const { ctx, msg, chatId, resolvedThreadId, dmThreadId, storeAllowFrom, sendOversizeWarning, oversizeLogMessage, promptContextMinTimestampMs } = params;
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-Dm-SZx4G.js")).defaultTelegramBotDeps;
