...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DRvegM_Y.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-CpmNtyoq.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-CK_KOC49.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-CvqkJ-8f.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BtruRpXL.js";
import { n as createDiagnosticTraceContext, o as runWithDiagnosticTraceContext } from "./diagnostic-trace-context-CdxuW_9m.js";
import { a as isDiagnosticsEnabled, l as setDiagnosticsEnabledForProcess } from "./diagnostic-events-B-ttv5Wu.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-kcl1qAou.js";
import { t as isContainerEnvironment } from "./container-environment-CsnLUhZp.js";
import { _ as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-BYZmrkLW.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-Bir64BNb.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-7jrTF66B.js";
import { n as resolveGatewayAuth } from "./auth-resolve-DrlYDf_X.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-CKxpl45h.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CFbF_GVu.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-7ib1D5c0.js";
import "./method-scopes-BkM7aoFe.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-D1-QaV1b.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CkMqjD6g.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-BOa5903J.js";
import { i as resolveMainSessionKey } from "./main-session-DXvbLAuq.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-3KXWSqcj.js";
import "./sessions-C96ZMbNO.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-BI8QBZeI.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-DHTaOByN.js";
import { a as setFallbackGatewayContextResolver } from "./server-plugins-BoScwm2W.js";
...
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-BH2WK6nq.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-BgA34vjy.js";
...
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-CuGJOdkQ.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-DTIskQe6.js";
import { t as GatewayLockError } from "./gateway-lock-DCqsLvc5.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DuInlCzu.js";
...
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-CFRckQqN.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-BLGjrLQc.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-gf4HXb89.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Rem_kYlX.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-BBSZn1W-.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-CXWE4ZGl.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-CHinkcXA.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-Dql5RPTG.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-C1G0wxtg.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-Divj4rKP.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-Bc6cg7TP.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-CowQcbLr.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CQH0cKsQ.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-B0gfCTYT.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-CEdyqaYC.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DPrNYkic.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-BndrS5RW.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-fb4J0oxO.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-CWILCBQE.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CnhCdyBj.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-Cds03vEF.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-muhSCNRM.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-CfYO_Wqt.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-BWHcecOA.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-CgLNHnN1.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-6qF-wJQ_.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-6qF-wJQ_.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-EM2XFwnv.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-DDWQMgGO.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-HeGTErAZ.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-DEPWIi5r.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-BIrDbwi2.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-Dn0n0FX3.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-EM2XFwnv.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-BK2GTCzI.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-hwYzPc6_.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-DmipE5lr.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-A0_2tpWJ.js");
	const reloadHandlersModulePromise = import("./server-reload-handlers-DRAd2Ltk.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-CEkZN8ec.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-DdJQ4z81.js");
	...
	const { createChannelManager } = await import("./server-channels-CIqpmUGS.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-CdUe1Ofa.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-CZ2NjeoU.js"), import("./server-runtime-services-Ci5RPEXU.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-BS1gGpq7.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-CPvOKDBn.js"),
				import("./server-plugin-bootstrap-DBM6xgGd.js"),
				import("./services-DdCcprJo.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-wAh8uUJ0.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-DBM6xgGd.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-Btk2YpqG.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-BL6TbMCR.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-D_VWPUQD.js");
