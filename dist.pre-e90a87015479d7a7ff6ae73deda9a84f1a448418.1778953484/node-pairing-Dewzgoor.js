...
import { d as writeJson, i as readJsonIfExists } from "./json-files-CahFuwKs.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-DeGFSi23.js";
import { a as reconcilePendingPairingRequests, i as pruneExpiredPending, n as verifyPairingToken, o as resolvePairingPaths, r as coercePairingStateRecord, s as resolveMissingRequestedScope, t as generatePairingToken } from "./pairing-token-m4bll64i.js";
...
function samePendingApprovalSurface(existing, incoming) {
	...
	return sameApprovalSurfaceSet(existing.caps, incomingCaps) && sameApprovalSurfaceSet(existing.commands, incomingCommands) && samePermissions(existing.permissions, incomingPermissions);
}
