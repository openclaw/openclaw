...
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-C5YaEiOI.js";
import "./config-mygaHtjo.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-CZNxMU9G.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-gY2yCAUH.js";
import { n as isToolAllowed } from "./tool-policy-C_Bmhgcr.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-_OfkxVXK.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DEagdg25.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Cbmr8DnW.js";
import { f as isSameSsrFPolicy } from "./ssrf-CxdudCgU.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-BL5PF1_N.js";
import { C as readRegistry, D as updateRegistry, E as updateBrowserRegistry, O as computeSandboxBrowserConfigHash, S as readBrowserRegistry, T as removeRegistryEntry, _ as resolveSandboxScopeKey, a as execDocker, c as isDockerDaemonUnavailable, g as resolveSandboxAgentId, h as appendWorkspaceMountArgs, l as readDockerContainerEnvVar, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxWorkspaceDir, w as removeBrowserRegistryEntry, y as slugifySessionKey } from "./docker-B1tg7-cA.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-DJgYDXBb.js";
import { C as buildPinnedAppendPlan, D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedMkdirpPlan, y as normalizeContainerPath } from "./browser-bridges-DqF7J8Ym.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-D8uJukMr.js"),
				import("./exec-defaults-C66TSluf.js"),
				import("./skills-DssUrYup.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-CgJKCKQw.js")).maybePruneSandboxes(cfg);
