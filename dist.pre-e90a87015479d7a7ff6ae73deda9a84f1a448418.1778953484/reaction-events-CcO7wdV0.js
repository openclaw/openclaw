import { r as getSessionBindingService } from "./session-binding-service-DEEot9LS.js";
import "./session-binding-runtime-CcpIpYS4.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CBgav9JF.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-P8zWLDnr.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-DKWSh-L2.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-BPzs_Y1C.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-_vTZzWhx.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-Cf1B_W_E.js");
