...
const AgentDefaultsSchema = z.object({
	...
	continuation: z.object({
		...
		crossSessionTargeting: z.union([z.literal("disabled"), z.literal("enabled")]).default("disabled"),
...
const ChannelBotLoopProtectionSchema = z.object({
	enabled: z.boolean().optional(),
...
const SessionSchema = z.object({
	...
	agentToAgent: z.object({ maxPingPongTurns: z.number().int().min(0).max(20).optional() }).strict().optional(),
