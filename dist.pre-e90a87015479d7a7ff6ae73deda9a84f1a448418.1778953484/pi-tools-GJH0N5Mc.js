...
import { d as resolveGatewayMessageChannel } from "./message-channel-Ch_vVUeC.js";
import { n as assertSandboxPath } from "./sandbox-paths-CZNxMU9G.js";
import { i as toRelativeSandboxPath, n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-KxKmtI0a.js";
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName } from "./tool-policy-shared-CTl6BNmA.js";
import { a as collectExplicitAllowlist, d as mergeAlsoAllowPolicy, f as replaceWithEffectiveToolAllowlist, l as hasRestrictiveAllowPolicy, o as collectExplicitDenylist, r as applyOwnerOnlyToolPolicy } from "./tool-policy-CW7uHOZt.js";
...
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-gY2yCAUH.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-DmBpeg_v.js";
import { S as wrapToolWorkspaceRootGuardWithOptions, _ as createSandboxedReadTool, b as wrapToolMemoryFlushAppendOnlyWrite, d as resolveToolLoopDetectionConfig, f as createHostWorkspaceAppendTool, g as createSandboxedEditTool, h as createOpenClawReadTool, m as createHostWorkspaceWriteTool, p as createHostWorkspaceEditTool, t as createOpenClawTools, v as createSandboxedWriteTool, w as resolveOpenClawPluginToolsForOptions, x as wrapToolWorkspaceRootGuard, y as wrapToolMemoryDayFileWriteGuard } from "./openclaw-tools-x86BYkGX.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-Bp84G0Xj.js";
import { a as copyBeforeToolCallHookMarker, c as isToolWrappedWithBeforeToolCallHook, d as copyChannelAgentToolMeta, m as listChannelAgentTools, u as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-D8vqoOUW.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DJE5nTKg.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-FE4txvh6.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-UcXRuxBJ.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-BywHQFLW.js";
...
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-CWqwMUkx.js";
import "./codex-native-web-search-571tAARi.js";
import { t as bindAbortRelay } from "./fetch-timeout-B1Q1xvDY.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-DJAQxAl-.js";
...
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-DJhZIa9d.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-CBHRXou6.js"));
