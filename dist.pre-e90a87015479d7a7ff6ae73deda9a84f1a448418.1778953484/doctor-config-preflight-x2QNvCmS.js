...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CKxpl45h.js";
import { n as formatConfigIssueLines } from "./issue-format-7d97IRVv.js";
import { t as note } from "./note-C-Ropacj.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-v76KEzAZ.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-Bj291FUn.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-AKfAhBEO.js");
