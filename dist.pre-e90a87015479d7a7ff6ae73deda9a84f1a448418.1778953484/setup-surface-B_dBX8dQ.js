...
import { o as isPrivateOrLoopbackHost } from "./net-BYZmrkLW.js";
import "./string-coerce-runtime-BOK5X0KD.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-A0ibr4F4.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-BSvpWKOg.js";
import "./setup-CoB41C8h.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-QnRGL7xv.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-Pmp5q1Qw.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CBgav9JF.js";
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-BZo2i5po.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CZjs0F-_.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Cs-mA26t.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-cOs_WfES.js";
import { n as updateMatrixAccountConfig } from "./config-update-CqHSLjQC.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CH2orubi.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-vn-J6XyD.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-D2T_VFPf.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-BilNFZZP.js");
