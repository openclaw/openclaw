...
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-D57hqxoj.js";
import "./agent-scope-cOcI3Bf3.js";
import { t as parseDurationMs } from "./parse-duration-yXtet3oR.js";
import { s as loadAuthProfileStoreForRuntime } from "./store-BtDR8PEp.js";
import { a as resolvePluginSetupRegistry, i as resolvePluginSetupProvider } from "./setup-registry-D0yj5ont.js";
import { n as resolvePluginProviders } from "./providers.runtime-CGaHXvgG.js";
import "./model-selection-shared-DvIdVzM0.js";
import "./auth-profiles-CnBNHbn4.js";
import { r as externalCliDiscoveryForProviderAuth } from "./external-cli-discovery-CqTSoR6V.js";
import { n as listProfilesForProvider } from "./profile-list-DXxsKl_a.js";
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-DFuWvVOf.js";
import { n as clearAuthProfileCooldown } from "./usage-yjJB6e01.js";
import "./workspace-Cbmr8DnW.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-gvFLFf6N.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BXm9EA3I.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-OHoTckQw.js";
import { t as createClackPrompter } from "./clack-prompter--hvevE7D.js";
import { n as logConfigUpdated } from "./logging-yyhDNrSr.js";
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-XhU0ktTD.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DuyuYR00.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Ch-U5-eN.js";
import { t as isRemoteEnvironment } from "./remote-env-CR3hWrhF.js";
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-BWgkorsj.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: async (url) => {
			const { openUrl } = await import("./onboard-helpers-CCabvZqB.js");
			await openUrl(url);
		},
