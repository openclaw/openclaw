import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-CJo5MMVk.js";
import { r as loadCrestodianOverview } from "./overview-DsJmfAj7.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-DHq3xHeI.js")).planCrestodianCommand)({
		input,
		overview
	});
