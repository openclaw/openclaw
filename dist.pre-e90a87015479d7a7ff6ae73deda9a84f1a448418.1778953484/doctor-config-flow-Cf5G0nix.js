...
import { c as isRecord$1 } from "./utils-CpmNtyoq.js";
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-Co1lNtpa.js";
import { r as normalizeProviderId$1 } from "./provider-id-Cz7K6wgK.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-CwBWagLE.js";
import { r as normalizeChatChannelId } from "./ids-DsZU3KNK.js";
import { i as setPathExistingStrict } from "./path-utils-BxQhhMsF.js";
import { n as discoverConfigSecretTargets } from "./target-registry-CMhZ2kLQ.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CKxpl45h.js";
import { n as formatConfigIssueLines } from "./issue-format-7d97IRVv.js";
import { r as normalizeTalkSection } from "./talk-DbE9vYTr.js";
import { n as collectConfiguredModelRefs } from "./model-refs-BOaGTfbn.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-Cl6MrvvR.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-DcmOWqLo.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-D0yj5ont.js";
import { n as getLoadedChannelPlugin } from "./registry-Dapwkxqy2.js";
import { i as listRouteBindings } from "./bindings-9BQ6xg8S.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-eOKf0itp.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-DvhRwvtp.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Tksn5eHT.js";
import { t as note } from "./note-C-Ropacj.js";
import { t as asObjectRecord } from "./object-BHhR_Gtm.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-v76KEzAZ.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-BdZAESI8.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DNoaBMjw.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-x2QNvCmS.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DJBZ47it.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-JOLHZqlN.js";
...
function mergeModelEntryWithRuntimePolicy(legacyEntry, currentEntry, runtime) {
	const merged = mergeModelEntry(legacyEntry, currentEntry);
	return runtimeNeedsExplicitModelPolicy(runtime) ? modelEntryWithRuntimePolicy(merged, runtime) : merged;
}
function normalizeLegacyRuntimeAllowlistModels(rawModels, selectedRuntime) {
	...
	for (const [migratedKey, entry] of legacyEntries) next[migratedKey] = mergeModelEntryWithRuntimePolicy(entry, next[migratedKey], selectedRuntime);
	return {
		value: next,
		changed
	};
}
function ensureSelectedModelRuntimePolicies(rawModels, selectedRefs, selectedRuntime) {
	if (!runtimeNeedsExplicitModelPolicy(selectedRuntime) || selectedRefs.length === 0) return {
		value: rawModels,
		changed: false
	};
...
function normalizeLegacyRuntimeAgentContainer(raw, path, changes) {
	...
	if (model.selectedRuntime) {
		const modelRuntimes = ensureSelectedModelRuntimePolicies(next.models, model.selectedRefs, model.selectedRuntime);
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DeuvB-uv.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CXzeZgm1.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DghiabbD.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DfEVJ0Ku.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-DWvcQR5X.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DUObNMui.js");
		emitDoctorNotes({
			note,
