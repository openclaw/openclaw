...
import { i as getChildLogger, y as normalizeLogLevel } from "../../logger-D7QW7hWe.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-D0UHWcy1.js";
...
import { i as normalizeDeliveryContext } from "../../delivery-context.shared-Bx20tvQk.js";
...
import { _ as mediaKindFromMime, n as detectMime } from "../../mime-aeRpoKPi.js";
import { n as onSessionTranscriptUpdate } from "../../transcript-events-B5Cg8Hyf.js";
import { t as getPluginRuntimeGatewayRequestScope } from "../../gateway-request-scope-CdCbcLsX.js";
import "../../logging-CyZUFV1C.js";
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-DvIdVzM0.js";
import { m as resolveThinkingDefault } from "../../model-selection-CtlJEyaP.js";
import { o as requestHeartbeat } from "../../heartbeat-wake-rdwXvn7X.js";
import { a as enqueueSystemEvent } from "../../system-events-DkEeQaZd.js";
import { a as getImageMetadata, l as resizeToJpeg } from "../../image-ops-ByVIVrXZ.js";
import { a as generateMusic, o as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-x86BYkGX.js";
import { l as ensureAgentWorkspace } from "../../workspace-Cbmr8DnW.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "../../lazy-runtime-CuIooGVq.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "../../runtime-CioYkxO7.js";
import { t as loadWebMedia } from "../../web-media-C_4RkrUc.js";
import { p as listTasksForFlowId } from "../../task-registry-BNaSW8S5.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-C2o8tLYf.js";
import "../../runtime-internal-D9n8wiOJ.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-7y91_xBn.js";
import { n as resolveAgentIdentity } from "../../identity-BNM6gytY.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-Di-d5b_E.js";
import { t as resolveAgentTimeoutMs } from "../../timeout-D990wZ-l.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-CIyY2JWa.js";
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-DWFW9lTV.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-Dls4_bTA.js";
import { i as setGatewaySubagentRuntime, n as gatewaySubagentState, r as setGatewayNodesRuntime, t as clearGatewaySubagentRuntime } from "../../gateway-bindings-DNtEK71w.js";
import { t as createRuntimeChannel } from "../../runtime-channel-CaS-yIaI.js";
import { r as isVoiceCompatibleAudio } from "../../audio-BRpHoh9i.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-B8yKLHYx.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-BQCY7yXr.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-BgqKD985.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-Dsw8idrs.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-3W2-hWWc.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-DP-T7UFi.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-DT0qW9qX.js"), (m) => m.createRuntimeLlm({
