...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-Jt4iYWcM.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CV2k9Ff3.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-BMiApOOP.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-DqNIXosi.js");
	if (params.argv) {
