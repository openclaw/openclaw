...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-GL3-wijr.js";
...
import { m as DiscordError } from "./discord-DYaMtXSm.js";
import { t as chunkDiscordTextWithMode } from "./chunk-DWgli2be.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-BhglkFhx.js";
import { t as createDiscordSendReceipt } from "./send.receipt-BoTFhoSJ.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-DXZu2rFv.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-Damh_p6a.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-BNyq-Axn.js");
