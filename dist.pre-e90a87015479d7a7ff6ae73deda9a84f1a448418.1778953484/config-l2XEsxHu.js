...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-Co1lNtpa.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-CwBWagLE.js";
import { n as retryAsync } from "./retry-Cm6J8T4K.js";
import "./error-runtime-Dls4_bTA.js";
import { t as requireRuntimeConfig } from "./plugin-config-runtime--BJVVJOK.js";
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-QnRGL7xv.js";
import "./ssrf-runtime-CaWyYFbv.js";
import "./retry-runtime-C6v6SJZX.js";
import "./secret-input-runtime-CCHkb209.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-Pmp5q1Qw.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-d6tpGpCC.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CBgav9JF.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-BZo2i5po.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-cOs_WfES.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CH2orubi.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-fcqi3mt7.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-fIB08_O9.js"), import("./logging-BfF0maaD.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-C-6ez0J9.js").then((credentialsReadModule) => ({
