import { c as readErrorName, i as formatErrorMessage } from "./errors-C5Jbj3g5.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-B1hkQDEm.js";
...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-BTs8k6GC.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-DvMuGnpM.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DKD3BQgi.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-bmI3-7D5.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-Doa9uLbX.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-CjBD2vYk.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-BidEiesv.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-CjBD2vYk.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-DBSvzetH.js").then(({ scheduleOrphanRecovery }) => {
