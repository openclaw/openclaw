...
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-CUNHHLhz.js";
import { n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-D7k_7R3g.js";
import { A as ChannelBotLoopProtectionFacts, C as PreparedChannelTurn, D as RunResolvedChannelTurnParams, E as RunChannelTurnParams, M as listTrackedChannelBotPairsForTests, N as recordChannelBotPairLoopAndCheckSuppression, O as SenderFacts, S as PreflightFacts, T as RouteFacts, _ as ConversationFacts, a as ChannelDeliveryResult, b as MessageFacts, c as ChannelTurnAdmission, d as ChannelTurnHistoryFinalizeOptions, f as ChannelTurnLogEvent, g as ChannelTurnResult, h as ChannelTurnResolved, i as ChannelDeliveryIntent, j as clearChannelBotPairLoopGuardForTests, k as SupplementalContextFacts, l as ChannelTurnDeliveryAdapter, m as ChannelTurnReplyPipelineOptions, n as AssembledChannelTurn, o as ChannelEventClass, p as ChannelTurnRecordOptions, r as ChannelDeliveryInfo, s as ChannelTurnAdapter, t as AccessFacts, u as ChannelTurnDispatcherOptions, v as DispatchedChannelTurnResult, w as ReplyPlanFacts, x as NormalizedTurnInput, y as InboundMediaFacts } from "./types-CVuIrg0I.js";
import { i as filterChannelTurnSupplementalContext, r as buildChannelTurnContext, t as BuildChannelTurnContextParams } from "./context-DFJ82zWa.js";
import { a as hasVisibleChannelTurnDispatch, i as hasFinalChannelTurnDispatch, n as ChannelTurnVisibleDeliverySignals, o as resolveChannelTurnDispatchCounts, r as EMPTY_CHANNEL_TURN_DISPATCH_COUNTS, t as ChannelTurnDispatchResultLike } from "./dispatch-result-BGA4g4EF.js";
...
declare namespace kernel_d_exports {
  export { AccessFacts, AssembledChannelTurn, BuildChannelTurnContextParams, ChannelBotLoopProtectionFacts, ChannelDeliveryInfo, ChannelDeliveryResult, ChannelEventClass, ChannelTurnAdapter, ChannelTurnAdmission, ChannelTurnDeliveryAdapter, ChannelTurnDispatchResultLike, ChannelTurnDispatcherOptions, ChannelTurnHistoryFinalizeOptions, ChannelTurnLogEvent, ChannelTurnRecordOptions, ChannelTurnReplyPipelineOptions, ChannelTurnResolved, ChannelTurnResult, ChannelTurnVisibleDeliverySignals, ConversationFacts, DispatchedChannelTurnResult, DurableInboundReplyDeliveryOptions, DurableInboundReplyDeliveryParams, DurableInboundReplyDeliveryResult, EMPTY_CHANNEL_TURN_DISPATCH_COUNTS, InboundMediaFacts, MessageFacts, NormalizedTurnInput, PreflightFacts, PreparedChannelTurn, ReplyPlanFacts, RouteFacts, RunChannelTurnParams, RunResolvedChannelTurnParams, SenderFacts, SupplementalContextFacts, buildChannelTurnContext, clearChannelBotPairLoopGuardForTests, createChannelDeliveryResultFromReceipt, createChannelTurnReplyPipeline, createNoopChannelTurnDeliveryAdapter, deliverDurableInboundReplyPayload, deliverInboundReplyWithMessageSendContext, dispatchAssembledChannelTurn, filterChannelTurnSupplementalContext, hasFinalChannelTurnDispatch, hasVisibleChannelTurnDispatch, isDurableInboundReplyDeliveryHandled, listTrackedChannelBotPairsForTests, recordChannelBotPairLoopAndCheckSuppression, resolveChannelTurnDispatchCounts, runChannelTurn, runPreparedChannelTurn, runResolvedChannelTurn, throwIfDurableInboundReplyDeliveryFailed };
}
/**
