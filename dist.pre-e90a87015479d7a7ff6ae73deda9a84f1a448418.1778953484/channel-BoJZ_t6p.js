...
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-B-UEK-Fu.js";
import { n as isSingleUseReplyToMode } from "./reply-reference-CK2qcod7.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-CuIooGVq.js";
import { _ as readStringParam, p as readNumberParam } from "./common-FE4txvh6.js";
import { c as normalizeInteractiveReply, l as normalizeMessagePresentation } from "./payload-Um8JiSYJ.js";
import { t as readBooleanParam } from "./boolean-param-Bu6zFXCt.js";
import { n as resolveOutboundSendDep } from "./send-deps-DFTzfRTA.js";
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-DEa-Ib2y.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-D24n1Jjj.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-B2e8Bfhw.js";
import "./string-coerce-runtime-BOK5X0KD.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-CihBShbD.js";
import "./channel-core-CUPfy3c2.js";
import "./routing-CDKAfW0M.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-BT1HB1SJ.js";
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-Cjz_-Nzk.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-Doqq5N5x.js";
import "./approval-delivery-runtime-DNKw0zyK.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-DfQLFZJH.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-2k3Wwo2D.js";
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-BmlinHwS.js";
import "./approval-native-runtime-CMJdrc67.js";
import "./reply-reference-Cza5UiNh.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-XClZBU1O.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-BFEMF3bx.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-tKw3qSeZ.js";
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-B1-LA4aR.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BR8BiOoy.js";
import { i as createAttachedChannelResultAdapter } from "./channel-send-result-CYIs2_b2.js";
import "./param-readers-CzyxyJR9.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-Cko9Q_Ps.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-BOgtE-yN.js";
import { a as resolveSlackExecApprovalTarget, n as isSlackExecApprovalAuthorizedSender, o as shouldHandleSlackExecApprovalRequest, r as isSlackExecApprovalClientEnabled, s as shouldSuppressLocalSlackExecApprovalPrompt, t as getSlackExecApprovalApprovers } from "./exec-approvals-CukamCF5.js";
import { t as isSlackApprovalAuthorizedSender } from "./approval-auth-Dg2swolg.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-Cpb6f575.js";
import { n as resolveSlackThreadTsValue, r as SLACK_TEXT_LIMIT, t as normalizeSlackThreadTsCandidate } from "./thread-ts-DyNkP7Mc.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-DFrODGF2.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-DgPIKDxH.js";
import "./channel-api-FfwBF3fe.js";
import { r as createSlackWebClient } from "./client-BleonLFh.js";
import { r as normalizeAllowListLower } from "./allow-list-DE3YFn88.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-D2C2x5a4.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-C0ORr6qS.js";
import { t as getOptionalSlackRuntime } from "./runtime-DHL62xmA.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-CBF81vul.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-CesrVfsm.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DFKppDHD.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-vDsj_HbM.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-DLBBvwJJ.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-CxXOp8Ij.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-8MUHPYWP.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Chbkm4b5.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Dj_BHqRl.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-Cea2G4Pe.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-9iCOPCCM.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-DixWeF3t.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-BvDLP8Cw.js");
