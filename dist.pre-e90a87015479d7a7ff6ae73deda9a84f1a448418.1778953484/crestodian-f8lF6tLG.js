...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-DsJmfAj7.js";
import { r as resolveCrestodianOperation } from "./dialogue-BTqH1GmF.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CLF5X40I.js")).runCrestodianTui;
	opts.onReady?.();
