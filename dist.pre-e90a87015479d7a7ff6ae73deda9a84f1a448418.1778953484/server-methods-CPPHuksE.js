...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-C5Jbj3g5.js";
import { n as isAbortError } from "./unhandled-rejections-OLZr3s0s.js";
...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-qD-NZHCY.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-CwBWagLE.js";
import { c as normalizeAgentId, g as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-DFEyR49L.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-Cg5lIU6L.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-D57hqxoj.js";
import { p as resolveSessionAgentId } from "./agent-scope-cOcI3Bf3.js";
import { l as measureDiagnosticsTimelineSpan, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-CK_KOC49.js";
import { d as writeJson, i as readJsonIfExists, l as tryReadJson } from "./json-files-CahFuwKs.js";
...
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BuxRKQTs.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-CDj8GMGP.js";
import { v as patchPluginSessionExtension } from "./loader-BcLmYXYK.js";
import { F as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-BOa5903J.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BcHlwuH3.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-B1hkQDEm.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-DXvbLAuq.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BOfF_hjX.js";
import { h as stringifyRouteThreadId } from "./channel-route-B-UEK-Fu.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-Bx20tvQk.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-4e7qCqMZ.js";
import { t as loadSessionStore } from "./store-load-gabseflm.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-Dapwkxqy2.js";
...
import { c as extractDeliveryInfo, i as serializeSessionCleanupResult, o as resolveSessionLifecycleTimestamps, r as runSessionsCleanup, s as resolveMainSessionKeyFromConfig, t as purgeAgentSessionStoreEntries } from "./sessions-C96ZMbNO.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-BvfEZezq.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-CdCbcLsX.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-BTtq60JB.js";
import { d as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-DvIdVzM0.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-REv6s8By.js";
import "./auth-profiles-CnBNHbn4.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-CqTSoR6V.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-1xbVdoup.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-DKJb1Xij.js";
import { n as abortEmbeddedPiRun, s as isEmbeddedPiRunActive, v as waitForEmbeddedPiRunEnd } from "./runs-ChtHyhIB.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-CTl6BNmA.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-BQBCwY4M.js";
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-BF8RJshP.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CEdBanVt.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-hZGh2SdD.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-eI2rmb-4.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-928cx93-.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-Gt6lqPrm.js";
...
import { i as resolveSandboxConfigForAgent } from "./config-_OfkxVXK.js";
import { t as extractToolPayload } from "./tool-payload-C1pxLoki.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-rdwXvn7X.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-DkEeQaZd.js";
import { l as getTotalQueueSize } from "./command-queue-CDsEEdrA.js";
import { n as resolveSendPolicy } from "./send-policy-B2JQeeXU.js";
import { a as isTimeoutError } from "./failover-error-BBm6QNLV.js";
import { c as normalizeCronJobCreate, u as normalizeCronJobPatch } from "./openclaw-tools-x86BYkGX.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-Bp84G0Xj.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-C6siDFHB.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Cbmr8DnW.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-HlzJlfmI.js";
import { i as createOutboundPayloadPlan, u as projectOutboundPayloadPlanForMirror } from "./deliver-4BB0N4PL.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-Cp7VImJb.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-DHTaOByN.js";
import { i as parseAbsoluteTimeMs } from "./stagger-I9A1h81L.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BRw3HTxP.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-CjjxqHKM.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DJAQxAl-.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-BnTUxD_W.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-DxmCOiD7.js";
import { c as dispatchChannelMessageAction, i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry } from "./message-action-runner-Bua-uFtn.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-D1OSlpqW.js";
import { n as normalizePollInput } from "./polls-CLOixU06.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-Dk8Ak-ZZ.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Bqp4iPZ6.js";
import "./target-resolver-BR-n_A9R.js";
import { i as resolveReplyToMode } from "./reply-threading-eOOwKpWQ.js";
import { t as sendDurableMessageBatch } from "./send-D2eGgUO9.js";
import "./runtime-C891_X55.js";
import { t as buildOutboundSessionContext } from "./session-context-DO08klhY.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-BWKBbMq_.js";
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-R5AZaXJu.js";
import { r as resolveOutboundTarget } from "./targets-xmbXaLC2.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-DDi0PfV-.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-BNaSW8S5.js";
import "./runtime-internal-D9n8wiOJ.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-DvMuGnpM.js";
import { a as clearSessionQueues } from "./queue-BK0XLxwD.js";
import { n as resolveAgentIdentity } from "./identity-BNM6gytY.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-BAtkhEaM.js";
import { t as resolveAgentTimeoutMs } from "./timeout-D990wZ-l.js";
import { C as setTtsEnabled, E as setTtsProvider, O as synthesizeSpeech, T as setTtsPersona, _ as resolveTtsConfig, f as listTtsPersonas, g as resolveTtsAutoMode, h as resolveExplicitTtsOverrides, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, y as resolveTtsProviderOrder } from "./tts-runtime-sBv4cR6r.js";
import "./tts-Dyw8MJyF.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-D5QtNszs.js";
import "./skills-BZBVv0xm.js";
import { t as canExecRequestNode } from "./exec-defaults-DzSagqhp.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DZZtKH0-.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-Dewzgoor.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-DyY1YxNe.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-BPPOcpxl.js";
...
import { t as detectRespawnSupervisor } from "./supervisor-markers-BzYMcxMT.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-oPvEZTql.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-viKQRhl0.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-BKlCx8Fm.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-BmapIdrX.js";
import "./commands-registry-DhqFao0J.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-V9E9_BmT.js";
import "./browser-maintenance-CJyYrYTP.js";
...
import { r as listPluginCommands } from "./commands-CsEflmSk.js";
import { t as getChannelActivity } from "./channel-activity-DM0lo1DM.js";
import { t as WizardCancelledError } from "./prompts-D2XpGBmm.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-B9ptKXra.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-D6EWORLr.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CtfNg8yV.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-DWAWUy0E.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-smPkgH_r.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-DW4Ykw5k.js";
import { r as agentCommandFromIngress } from "./agent-command-xQXXGxFd.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-BH2WK6nq.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-C5_-RV_x.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CVRAkuyy.js";
import { t as formatForLog } from "./ws-log-BgA34vjy.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-a3LqQOW7.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DCWkBEBx.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-1nUAcZvT.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-Dn88wlCf.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-DLV99YYf.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-B-KTablp.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-zz1myYtq.js";
import { n as createOutboundSendDeps } from "./deps-C99hdN4C.js";
import "./agent-TD4eETZD.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-BOpUuNQb.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DK2XvDyr.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-jxu7kwbT.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-Blk0B8F2.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dr05xBtY.js";
import "./server-constants-DTIskQe6.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-C3q9eqWY.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-YO4wwLua.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-JbEACYoB.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-Cq0KTmAb.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-BmwkxaxO.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-EQSdptEo.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-5p-dWbvf.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BYkxAKiT.js";
import { t as buildChannelUiCatalog } from "./catalog-CNRQvypr.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-ClxHN79X.js";
import { s as normalizeUpdateChannel } from "./update-channels-DCwRYKZi.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CrOtnMZp.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Bktak-sN.js";
import { t as readConfiguredLogTail } from "./log-tail-DAWLYvRR.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BbdsQxmc.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-DcETdL1B.js";
import { t as buildChannelAccountSnapshot } from "./status-CLDJk1zh.js";
...
import { t as installSkill } from "./skills-install-DH1GxL58.js";
import { r as readPackageVersion } from "./package-json-EUlz3Cdp.js";
import { t as getStatusSummary } from "./status.summary-CG-pkcNu.js";
import "./status-CHggeSX7.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-ttKUcBon.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-Szh8kXme.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-B-cm24hz.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-DqHrPbWN.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-B0WSXPjq.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DPf6oP6_.js";
import { t as diffConfigPaths } from "./config-diff-m-bK-gqj.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CF5oJ49l.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-DAf-lvvD.js";
import "./heartbeat-runner-7G8b-7iQ.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-z8j0f7eS.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-If_gMjfO.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-5b7IM14S.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-K5OpAtVv.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-Bany2Va_.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-BaxbSR34.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-BptmaUVD.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-Bl3Dy2jJ.js";
...
const agentHandlers = {
	agent: async ({ params, respond, context, client, isWebchatConnect }) => {
		...
		let sessionContinuationTraceparent;
		...
		if (requestedSessionKey) {
			...
			cfgForAgent = cfg;
			sessionContinuationTraceparent = normalizeDiagnosticTraceparent(entry?.continuationTraceparent);
			const now = Date.now();
			...
			const nextEntryPatch = {
				...
				continuationTraceparent: void 0,
		...
		(async () => {
			...
			try {
				...
				const inheritedTraceparent = request.traceparent ?? consumeSubagentTraceparentHandoff({
					idempotencyKey: idem,
					sessionKey: resolvedSessionKey
				})?.traceparent ?? sessionContinuationTraceparent;
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-joljwahN.js");
