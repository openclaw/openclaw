...
import { r as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-MHApxXRA.js";
...
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-RnMqOQVY.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-DcMztHUL.js";
import "./provider-auth-choice-preference-CUdkBCwz.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-D-mgkfuj.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-BIgqE4kZ.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-Pt2EGPy_.js");
