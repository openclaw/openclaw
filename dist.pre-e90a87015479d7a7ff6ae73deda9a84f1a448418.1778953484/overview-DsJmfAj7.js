...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-D57hqxoj.js";
import { n as resolveAgentEffectiveModelPrimary } from "./agent-scope-cOcI3Bf3.js";
import { u as readConfigFileSnapshot } from "./io-CKxpl45h.js";
import "./config-mygaHtjo.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-BQxmcR0S.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-9yssJxnK.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
