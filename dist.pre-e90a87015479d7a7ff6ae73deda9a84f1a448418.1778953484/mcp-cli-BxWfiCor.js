...
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-BNEPIvFc.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-SP1tK0bd.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-Brot0b8j.js"),
			import("./client-CF85CZM0.js"),
			import("./client-start-readiness-Bg02PUvg.js"),
			import("./method-scopes-CDlIFnE0.js"),
			import("./client-info-Q2uG3iV4.js")
		]);
