...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CMhZ2kLQ.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-BdzfCDXG.js";
import { a as resolveSecretRefValue } from "./resolve-RQvCgk9E.js";
import { n as info, o as success, t as danger } from "./globals-BjBVXBcN.js";
import { C as validateConfigObjectRaw, U as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-CKxpl45h.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-7d97IRVv.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-vTNR_ORQ.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Cyrg_jVi.js";
import { i as replaceConfigFile } from "./mutate-B6z3DCSc.js";
import "./config-mygaHtjo.js";
import { s as formatStrictJsonParseFailure } from "./error-format-g2PL71zR.js";
import { n as redactConfigObject } from "./redact-snapshot-C6siDFHB.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CrOtnMZp.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Bktak-sN.js";
import { n as setCommandJsonMode } from "./json-mode-pLjamAqg.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-C-u1yfby.js");
