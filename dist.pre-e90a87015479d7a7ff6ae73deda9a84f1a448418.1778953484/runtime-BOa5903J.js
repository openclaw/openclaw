...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-DWk5fl-u.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-C1v3psde.js")]);
