...
import { s as resolvePluginContributionOwners } from "./plugin-registry-D3tbFUO2.js";
...
import { t as ConfigMutationConflictError } from "./mutate-B6z3DCSc.js";
...
import { t as note$1 } from "./note-C-Ropacj.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-C81MNmve.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CPm20LdV.js";
import { n as applyAuthChoice } from "./auth-choice-C7CX6-iq.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CUdkBCwz.js";
import { i as setupChannels } from "./onboard-channels-Cmn19MCr.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-D0gdC5EA.js";
...
import { t as promptCustomApiConfig } from "./onboard-custom-Bm66CQvh.js";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BaV4wX8g.js";
import { t as setupSkills } from "./onboard-skills-DGtOXtQP.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-BaKCvMGW.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Cn5PXk9h.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-CA-e8STR.js");
