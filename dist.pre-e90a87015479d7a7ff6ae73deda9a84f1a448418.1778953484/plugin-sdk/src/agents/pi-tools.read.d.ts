...
export declare function wrapToolMemoryDayFileWriteGuard(tool: AnyAgentTool, options?: MemoryDayFileWriteGuardOptions): AnyAgentTool;
export declare function createHostWorkspaceAppendTool(root: string, options?: {
