...
import { C as DEFAULT_SAFE_BINS, S as resolveExecWrapperTrustPlan, _ as resolvePolicyTargetCandidatePath, a as validateSafeBinArgv, c as matchAllowlist, h as resolveExecutionTargetResolution, m as resolveExecutionTargetCandidatePath, n as isTrustedSafeBinPath, p as resolveCommandResolutionFromArgv, v as resolvePolicyTargetResolution, w as SAFE_BIN_PROFILES } from "./exec-safe-bin-trust-1c1bRHVX.js";
import { D as normalizeExecutableToken, O as splitShellArgs, a as extractShellWrapperInlineCommand, b as unwrapDispatchWrappersForResolution, c as isShellWrapperExecutable, f as POSIX_INLINE_COMMAND_FLAGS, g as resolvePowerShellInlineCommandMatch, h as resolveInlineCommandMatch, n as POWERSHELL_WRAPPERS, p as isPowerShellInlineFileCommandFlag, r as extractBindableShellWrapperInlineCommand, u as resolveShellWrapperTransportArgv, v as isDispatchWrapperExecutable } from "./shell-wrapper-resolution-wnr3LYlk.js";
import { a as detectInlineEvalArgv, l as isInterpreterLikeAllowlistPattern } from "./risks-kYYjBp9w.js";
...
function executableResolutionsReferToSameTarget(left, right) {
	...
	return left.rawExecutable === right.rawExecutable && left.resolvedPath === right.resolvedPath && left.executableName === right.executableName;
}
