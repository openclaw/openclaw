...
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-BCcywdXw.js";
import { o as getResolvedLoggerSettings } from "./logger-D7QW7hWe.js";
import { t as danger } from "./globals-BjBVXBcN.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CKxpl45h.js";
import { i as replaceConfigFile } from "./mutate-B6z3DCSc.js";
import "./config-mygaHtjo.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-g2PL71zR.js";
import { o as normalizeChannelId } from "./registry-Dci87MEJ.js";
...
import { i as callGateway } from "./call-DVsYbNwX.js";
import { i as getBundledChannelSetupPlugin } from "./bundled-DcmOWqLo.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-Dapwkxqy2.js";
import "./plugins-xyXSVvnh.js";
import "./logging-CyZUFV1C.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-XyoXwVqh.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-gK-xaCr_.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-LtskTSg0.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-TAjAsIQC.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Bqp4iPZ6.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BWKBbMq_.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BpCN1yCL.js";
import { t as WizardCancelledError } from "./prompts-D2XpGBmm.js";
import { t as createClackPrompter } from "./clack-prompter--hvevE7D.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-BAZUEhY3.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-Dz87pady.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CG4DiT2n.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DW275_0b.js";
import { n as resolveLogFile } from "./log-tail-DAWLYvRR.js";
import { t as parseLogLine } from "./parse-log-line-DYC8FSrz.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-0Eo_SbFO.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-BPTTWenw.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-w3WT8pA5.js";
import { t as channelsListCommand } from "./list-BaUNRaPt.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-B_N1oluV.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-92R0Ylsa.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-CZAYwtGE.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-jUmJV3sD.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-D_tdpoyH.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-jedJblPX.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-Df2Y9mTN.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-C9Bf1s9J.js");
