...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-xWnoQnrL.js";
...
import { a as formatMissingPluginMessage } from "./error-format-g2PL71zR.js";
import { u as quietPluginJsonLogger } from "./plugins-command-helpers-BxgSRpeC.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-2M-V5Wyp.js";
...
async function runPluginsInspectCommand(id, opts) {
	const { buildAllPluginInspectReports, buildPluginDiagnosticsReport, buildPluginInspectReport, buildPluginSnapshotReport, formatPluginCompatibilityNotice } = await import("./status-CXg4fBK0.js");
	const { loadInstalledPluginIndexInstallRecords } = await import("./installed-plugin-index-records-wMv5PfT5.js");
