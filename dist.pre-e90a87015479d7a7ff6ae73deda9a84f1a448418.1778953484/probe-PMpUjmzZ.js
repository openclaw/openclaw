...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-CHrKc_3B.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-17GiFSqm.js";
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-BHBwW5N5.js";
import { i as READ_SCOPE } from "./operator-scopes-7ib1D5c0.js";
import "./method-scopes-BkM7aoFe.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-CfmMeHEf.js");
