...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-B9yYhUI5.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-O8SE3mRg.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-D5jov-5a.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-RpP0SElW.js");
	if (params.argv) {
