...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-BzQKuevh.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CTa8UXYi.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-C14WSoXY.js");
...
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-BKQ4T37s.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-CtW4VA4k.js");
