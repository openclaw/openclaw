...
import { t as getActiveMatrixClient } from "./active-client-BKmILo-5.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-OMj0Xam2.js"), import("./shared-BLMCKsvj.js")]).then(([clientModule, sharedModule]) => ({
