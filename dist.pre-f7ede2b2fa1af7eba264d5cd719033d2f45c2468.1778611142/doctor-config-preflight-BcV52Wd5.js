...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-BTdvKaBm.js";
import { n as formatConfigIssueLines } from "./issue-format-BK_NTRYi.js";
import { t as note } from "./note-De7QpaFE.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-DPSFt8bq.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DcTuf89O.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BMmYh9-w.js");
