...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-6yd24Fv9.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-CRkrr5e6.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-CIwNgiTD.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-D3qucf7X.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BPlL4CBo.js";
import { l as runWithDiagnosticTraceContext, n as createDiagnosticTraceContext } from "./diagnostic-trace-context-IcGaoHY8.js";
import { a as isDiagnosticsEnabled, l as setDiagnosticsEnabledForProcess } from "./diagnostic-events-KZsVzgRn.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-DtPhzVBn.js";
import { t as isContainerEnvironment } from "./container-environment-CsnLUhZp.js";
import { g as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-DpXvrs-2.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-BCkS7lAx.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-DDx57YI1.js";
import { n as resolveGatewayAuth } from "./auth-resolve-8eaxFLYj.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-BTdvKaBm.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-BOBTAMy3.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-nHLngmZH.js";
import "./method-scopes-DIw8NCYq.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-9Hcil0gq.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-79KkrW9-.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-B6kzDhK6.js";
import { i as resolveMainSessionKey } from "./main-session-DJ3ql58r.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-ClXRIwq0.js";
import "./sessions-XMEnIfWG.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-KqTx1C2u.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-D5_shv0K.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-qOur4_WN.js";
import { a as enqueueSystemEvent } from "./system-events-k1OmfILA.js";
import { l as getTotalQueueSize } from "./command-queue-CTJowQ-0.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-2imGPc0t.js";
...
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-DOtR4vfY.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-MlgWT1hh.js";
...
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-CyRiBH1m.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-ClRlXqh7.js";
import { t as GatewayLockError } from "./gateway-lock-DWfYdwJe.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DwqXWtYP.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-Bqj6sc34.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CwcZRN9E.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-CFYNQ9iE.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-CZ-vWk0u.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-BQwa0AK2.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-gOjwonjG.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Bb-Gvja3.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DeLn_Ddq.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-OKyZt9Qi.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-C3XJIXNk.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-sHprxVBc.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-B6qrIgnp.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-C23lPQNM.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-DUquIE6_.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-CtVVaTDu.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BPjfCr3T.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-btCMrY4J.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-BesGO8Dr.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-BMCfByNN.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-mGFI0iBL.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-B8oIs7_g.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DCmn7gEn.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-JslP-4W9.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-wzMQEaQ1.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-BiBeEsHP.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-D3rdPvWU.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DOIaeM7K.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-BdKIl8co.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-CDLDTLYx.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-CDLDTLYx.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-C5zHHWSQ.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-CjxD7zX-.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-oEuNHJGx.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-BR6rPg5Z.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-DLAWDpMi.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-C5zHHWSQ.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-BA40XSmp.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-DK8a_Z47.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-BQbBS_1V.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-wFLA7y1r.js");
	const reloadHandlersModulePromise = import("./server-reload-handlers-DT8jOWIj.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-jJUpopBe.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-DzCSB-hg.js");
	...
	const { createChannelManager } = await import("./server-channels-DSLAesij.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-DKQzXHje.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-DZnEQiMw.js"), import("./server-runtime-services-CVhqkU21.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-V_ni2Nb1.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-IDzjQDX9.js"),
				import("./server-plugin-bootstrap-C_5d6vSw.js"),
				import("./services-CAfpMw_k.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-CEy9fwvB.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-C_5d6vSw.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-CaTtFRnV.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-Cxw8iKww.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-C-NABdzs.js");
