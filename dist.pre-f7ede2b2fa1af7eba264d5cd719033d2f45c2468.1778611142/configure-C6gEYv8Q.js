...
import { a as findTailscaleBinary } from "./tailscale-D9nH6ogV.js";
...
import { t as ConfigMutationConflictError } from "./mutate-B-m-KAHm.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-BH-tmDo_.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-exmmWSYT.js";
import { n as applyAuthChoice } from "./auth-choice-COGVidvH.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DtZJtjZI.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CAMiyWhK.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DuKOF8aO.js";
import { t as promptCustomApiConfig } from "./onboard-custom-C3SQhztQ.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DodHun2L.js";
import { n as formatHealthCheckFailure } from "./health-format-oSPUdKaL.js";
import { n as healthCommand } from "./health-CkRAtOvD.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-F_Wyx2JL.js";
import { t as setupSkills } from "./onboard-skills-COGE8lIJ.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-BGq00Cmf.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-BVKP7OXV.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-DYXIXFZ3.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-CptN2NAt.js");
