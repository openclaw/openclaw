...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-DCR_Sxje.js";
import { n as getActivePluginChannelRegistrySnapshotFromState } from "./runtime-channel-state-DgULs799.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-C0plpwni.js")]);
