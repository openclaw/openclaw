...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-Ccbf-suJ.js";
import { t as providerSupportsCapability } from "./provider-supports-Dk_4E1lg.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-DRARjnwz.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-DLS1cd4p.js";
import { t as buildRandomTempFilePath } from "./temp-download-_z2gSVus.js";
import "./temp-path-D7ALviul.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-tDAo-kGh.js";
import "./shared-CyUDp380.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-CfCyG-b5.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-B71wvACt.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-ELh8PloU.js");
