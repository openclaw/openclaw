...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-DXf4X1LM.js";
import "./tokens-1nrYy2wZ.js";
import "./pi-embedded-helpers-h1B99gRo.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-D4I_DfXI.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-BrZTSCSp.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-BH0qBhLY.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-D3QikFNs.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-DKjItj2_.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-BnPJb1gm.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-C_DBYuCC.js");
