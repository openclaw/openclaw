...
import { n as normalizeAtHashSlug } from "./string-normalization-DgUPESoD.js";
import { n as sleepWithAbort } from "./backoff-1wqGgkrR.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-CYIDv5lP.js";
...
import { i as createChatChannelPlugin } from "./core-C5MRjAwL.js";
import "./channel-core-CJT3-pYB.js";
import "./error-runtime-7Da26TEA.js";
import "./channel-policy-fOi0H-_f.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CcQWQ7k0.js";
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-CitS57i5.js";
import "./runtime-env-zJY-klAY.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-PJOYaCfm.js";
...
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-CBzgQfUC.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BkOWWNUn.js";
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-HzwGZy-B.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-C4zYLC5-.js";
import "./channel-api-BLZm2VA4.js";
import { t as parseDiscordTarget } from "./target-parsing-CE3M5DI7.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CU4LhKZI.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-CRtlgnsR.js";
import { t as getDiscordRuntime } from "./runtime-DbizVxTi.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-5_kXPAs0.js";
import { t as getDiscordApprovalCapability } from "./approval-native-DHIOgIYg.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-DCVR-MQp.js";
import { t as discordMessageActions$1 } from "./channel-actions-DeZFh21E.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-C9pOaB33.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-DHDhgwr4.js";
import { n as discordOutbound } from "./outbound-adapter-54MFKVB-.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BSb2dcwa.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-39iIqwNE.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CLVPn9Jr.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CSeKt2NB.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-D-JU95Ei.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BERSfRXf.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-DVg_4j58.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-BJJc1UCU.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DNtaX6W9.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-CHUhyBt9.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-CICsdCbq.js");
