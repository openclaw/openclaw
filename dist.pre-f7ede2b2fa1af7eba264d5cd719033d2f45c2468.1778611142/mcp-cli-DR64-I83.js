...
import { r as extractFirstTextBlock } from "./chat-message-content-Df8A1xtk.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-D40gHgz3.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-nAx0HEIV.js";
import { t as applyParentDefaultHelpAction } from "./parent-default-help-pkPvSlAL.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-CPHdwD25.js"),
			import("./client-WXwHEUYo.js"),
			import("./client-start-readiness-Bzdl96UL.js"),
			import("./method-scopes-Dza-C546.js"),
			import("./client-info-B0_hTIiJ.js")
		]);
