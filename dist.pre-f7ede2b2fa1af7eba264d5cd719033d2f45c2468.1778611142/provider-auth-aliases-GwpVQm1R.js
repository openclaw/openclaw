...
import { a as resolvePluginControlPlaneFingerprint, r as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-CIwNgiTD.js";
...
function resolveProviderAuthAliasMap(params) {
	...
	const snapshot = getCurrentPluginMetadataSnapshot({
		...
		if (normalizePluginsConfig(config.plugins).loadPaths.length !== 0) return;
