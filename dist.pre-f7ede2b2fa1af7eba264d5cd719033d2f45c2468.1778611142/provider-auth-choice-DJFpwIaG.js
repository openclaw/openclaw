...
import { n as openUrl } from "./browser-open-BObLSZDt.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-Bnv-p2ul.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog--LnPu2Xq.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-C3R-ATtg.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-DeCuP7KN.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-BGq00Cmf.js") };
