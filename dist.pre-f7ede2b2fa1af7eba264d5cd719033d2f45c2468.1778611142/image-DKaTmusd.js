import { w as normalizeModelRef } from "./model-selection-shared-CkgNDUHT.js";
import "./model-selection-ClIa0TN2.js";
import { r as resolveProviderRequestCapabilities } from "./provider-attribution-D-0WKaTm.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-DZP9c2yE.js";
import { l as resolveApiKeyForProvider, r as getApiKeyForModel } from "./model-auth-BAukXI7p.js";
import { n as ensureOpenClawModelsJson } from "./models-config-CY8WcM1w.js";
import { i as coerceImageAssistantText, r as minimaxUnderstandImage, s as hasImageReasoningOnlyResponse, t as isMinimaxVlmModel } from "./minimax-vlm-D_Vzc5zr.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DaFceOuc.js";
...
async function resolveImageRuntime(params) {
	...
	const { authStorage, model } = await resolveModelAsync(resolvedRef.provider, resolvedRef.model, params.agentDir, params.cfg, { allowBundledStaticCatalogFallback: true });
