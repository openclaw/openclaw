...
import { I as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-B6kzDhK6.js";
import { c as initSubagentRegistry } from "./subagent-registry-DSqd4sY2.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-DoEq265x.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-8cXTeFNk.js";
import { n as listGatewayMethods } from "./server-methods-list-DeLn_Ddq.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-B9zs6L7B.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-CWzGxKV7.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-C_5d6vSw.js");
