...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-BMWnqYiF.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-Cbw-W_qS.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-D6oOH6Uv.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-B_J_gGA8.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-DnAiTat9.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-CZkBZk4P.js"),
