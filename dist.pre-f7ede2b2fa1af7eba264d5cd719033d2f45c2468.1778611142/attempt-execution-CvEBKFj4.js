...
import { c as runWithActiveOtelTraceparent } from "./diagnostic-trace-context-IcGaoHY8.js";
import { t as createSubsystemLogger } from "./subsystem-DtPhzVBn.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-6sSBAuF7.js";
...
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock } from "./session-write-lock-B6MaXn5r.js";
import { a as resolveSessionTranscriptFile, c as appendSessionTranscriptMessage, i as readTailAssistantTextFromSessionTranscript } from "./transcript-Cnh_OUdm.js";
import { t as isCliProvider } from "./model-selection-cli-DVaij4Yi.js";
import "./model-selection-ClIa0TN2.js";
import { i as resolveAuthProfileOrder } from "./order-CAJ20zR_.js";
import { r as formatAcpErrorChain } from "./errors-D7F9ksZg.js";
import { n as resolveAgentHarnessPolicy } from "./agent-runtime-metadata-BU_WOO7A.js";
import { a as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-BLMbMwy0.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BZHJ6dBm.js";
import { t as FailoverError } from "./failover-error-D3QikFNs.js";
import { t as runCliAgent } from "./cli-runner-LbYcDWiB.js";
import { r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BqZEugaj.js";
import "./selection-DWO3ph-n.js";
import { H as buildUsageWithNoCost } from "./compaction-successor-transcript-BROoU-e5.js";
...
import { i as resolveFallbackRetryPrompt, n as claudeCliSessionTranscriptHasContent, t as buildClaudeCliFallbackContextPrelude } from "./attempt-execution.helpers-DrXKYPj4.js";
import { t as persistSessionEntry } from "./attempt-execution.shared-D5ST8yeF.js";
import { t as clearCliSessionInStore } from "./session-store-Babq8Auj.js";
...
function runAgentAttempt(params) {
	...
	if (!isRawModelRun && isCliProvider(cliExecutionProvider, params.cfg)) {
		...
		const runCliWithSession = (nextCliSessionId, activeCliSessionBinding = cliSessionBinding) => runWithActiveOtelTraceparent(params.opts.traceparent, () => runCliAgent({
			sessionId: params.sessionId,
			sessionKey: params.sessionKey,
			agentId: params.sessionAgentId,
			trigger: "user",
	...
	return runWithActiveOtelTraceparent(params.opts.traceparent, () => runEmbeddedPiAgent({
		sessionId: params.sessionId,
		sessionKey: params.sessionKey,
		agentId: params.sessionAgentId,
		trigger: "user",
