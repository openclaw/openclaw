...
import { t as setupWizardCommand } from "./onboard-WOTE3xem.js";
import JSON5 from "json5";
import fs from "node:fs/promises";
import { z } from "zod";
//#region src/commands/setup.ts
const JsonRecordSchema = z.record(z.string(), z.unknown());
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-CcxfA4so.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-C97auTeE.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-DThRAuaA.js");
