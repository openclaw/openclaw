...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-BZjj1-ju.js";
import "./installed-plugin-index-records-DBUPrZ9p.js";
import { n as formatConfigIssueLines } from "./issue-format-BK_NTRYi.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-BZYZ5rKR.js";
import { n as isRestartEnabled } from "./commands.flags-BKSr60uc.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-9Hcil0gq.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-KqTx1C2u.js";
import { o as resetModelCatalogCache } from "./model-catalog-CdsNMKZM.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-2imGPc0t.js";
import { r as resetDirectoryCache } from "./target-resolver-Dmf2LP-9.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-BHvpI12f.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-DKbDm393.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-B3_UbdEj.js";
import { _ as resolveHooksConfig } from "./hooks-BIf_AD-i.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BIHQLa8O.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BRHz2PC6.js";
import { t as diffConfigPaths } from "./config-diff-CZ78c6Pq.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-D4POo-D0.js";
...
import { t as buildGatewayCronService } from "./server-cron-B1FNRb1n.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Bb-Gvja3.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DWEqfpr8.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BsmVdC1i.js"), import("./gmail-watcher-lifecycle-C5mJGDez.js")]);
