...
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BEHncM17.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-B785hmc4.js";
import "./setup-DODH2Khc.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-iK0Q9rn6.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-ByMro443.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DWMUx22d.js";
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-0o6MTYHU.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-B6plUOPD.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-DSvaN95H.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-C1y_dsJR.js";
import { n as updateMatrixAccountConfig } from "./config-update-B80aBKIH.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CFk-iJ-5.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-D9Thm6aX.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-B7JGDPQk.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DBZtoBk4.js");
