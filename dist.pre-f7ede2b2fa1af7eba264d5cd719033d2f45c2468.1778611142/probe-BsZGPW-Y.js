...
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-BuyF0OO_.js";
import { i as READ_SCOPE } from "./operator-scopes-nHLngmZH.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-Du7piLdm.js");
