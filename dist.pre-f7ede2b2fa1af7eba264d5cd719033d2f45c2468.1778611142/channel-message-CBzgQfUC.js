...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-sBihqJt1.js")).deliverInboundReplyWithMessageSendContext(...args);
};
...
async function sendDurableMessageBatch(params) {
	return await (await import("./runtime-yflFZG9b.js")).sendDurableMessageBatch(params);
}
async function withDurableMessageSendContext(params, run) {
	return await (await import("./runtime-yflFZG9b.js")).withDurableMessageSendContext(params, run);
}
