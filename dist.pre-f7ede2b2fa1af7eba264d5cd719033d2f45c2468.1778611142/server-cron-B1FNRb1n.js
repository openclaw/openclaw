...
import { a as isSubagentSessionKey, o as parseAgentSessionKey, r as isCronRunSessionKey } from "./session-key-utils-bmH32UOR.js";
...
import { i as getChildLogger } from "./logger-DlBx5AyB.js";
...
import { s as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-DOk7wSx2.js";
import "./sessions-XMEnIfWG.js";
import "./logging-BKe1cVY7.js";
import { t as abortAndDrainEmbeddedPiRun } from "./runs-YRsDmGSB.js";
import "./session-utils.fs-66nI1FFR.js";
import { i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-CVaEyQw8.js";
import { a as isRetryableHeartbeatBusySkipReason, o as requestHeartbeat } from "./heartbeat-wake-QXht0m6a.js";
import { a as enqueueSystemEvent } from "./system-events-k1OmfILA.js";
import { i as enqueueCommandInLane } from "./command-queue-CTJowQ-0.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-D3QikFNs.js";
import { l as normalizeCronJobInput } from "./openclaw-tools-mY9hj5j9.js";
import { n as normalizeOptionalAgentId } from "./normalize-hsV4KVcU.js";
import { a as resolveCronNotificationSessionKey, i as resolveCronDeliverySessionKey, o as resolveCronSessionTargetSessionKey, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-CqDQ6_3z.js";
import { t as SsrFBlockedError } from "./ssrf-COOL9as_.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-CTcm-Pke.js";
import { t as sendDurableMessageBatch } from "./send-FSoIzJ1c.js";
import "./runtime-ScnPRNrB.js";
import { t as buildOutboundSessionContext } from "./session-context-CnJgvNqc.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BkjJL_f9.js";
import { a as cronSchedulingInputsEqual, i as saveCronStore, r as resolveCronStorePath, t as loadCronStore } from "./store-DvsoDX0w.js";
import "./pi-embedded-BZy4MOt5.js";
import { i as markCronJobActive, t as clearCronJobActive } from "./active-jobs-BgyDdvZI.js";
import { a as summarizeCronRunDiagnostics, i as normalizeCronRunDiagnostics, n as createCronRunDiagnosticsFromError } from "./run-diagnostics-Bk5jibfE.js";
import { a as resolveCronRunLogPath, o as resolveCronRunLogPruneOptions, t as appendCronRunLog } from "./run-log-VByXqGfG.js";
import { n as resolveAgentOutboundIdentity } from "./identity-DgBY-z05.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-TptPswGX.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-UgSyENge.js";
import { n as resolveFailureDestination, t as resolveCronDeliveryPlan } from "./delivery-plan-C4yiAMy4.js";
import { t as runCronIsolatedAgentTurn } from "./isolated-agent-BcJHQv7y.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-CakKsm8z.js";
import { t as createCronExecutionId } from "./run-id-CKvvv_Eg.js";
import { n as runHeartbeatOnce } from "./heartbeat-runner-4Na5zLFq.js";
...
async function executeJobCoreWithTimeout(state, job) {
	...
	const startSetupTimeout = () => {
		if (setupTimeoutId || runnerStarted) return;
		setupTimeoutId = setTimeout(() => {
			if (!runnerStarted) triggerTimeout(setupTimeoutErrorMessage(activeExecution));
	...
	const startPreExecutionTimeout = () => {
		if (preExecutionTimeoutId || executionStarted) return;
		preExecutionTimeoutId = setTimeout(() => {
			if (!executionStarted) triggerTimeout(preExecutionTimeoutErrorMessage(activeExecution));
	...
	const corePromise = executeJobCore(state, job, runAbortController.signal, {
		onExecutionStarted: deferTimeoutUntilExecutionStart ? onExecutionStarted : void 0,
		onExecutionPhase: deferTimeoutUntilExecutionStart ? onExecutionPhase : void 0
	});
	if (!deferTimeoutUntilExecutionStart) startTimeout();
	else startSetupTimeout();
...
function isCronAgentExecutionStarted(info) {
	...
	switch (info.phase) {
		...
		case "model_call_started": return true;
...
function isTransientCronError(error, retryOn) {
	...
	if (classified && keys.includes(classified)) return true;
...
function buildGatewayCronService(params) {
	...
	const resolveCronTarget = (opts) => {
		...
		return {
			runtimeConfig,
			agentId,
			sessionKey: agentId ? resolveCronSessionKey({
				runtimeConfig,
				agentId,
				requestedSessionKey
			}) : void 0
