...
import { S as recordTalkObservabilityEvent, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, d as buildRealtimeVoiceAgentConsultPolicyInstructions, v as resolveRealtimeVoiceAgentConsultTools, y as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-BX578rTP.js";
import { f as resolveRealtimeVoiceFastContextConsult, m as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-BLn5YCm5.js";
...
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-CIgtAHSJ.js";
...
import { t as isProviderStatusTerminal } from "./call-status-D9ZWpBx7.js";
...
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-BMIrWenK.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-Dil2o2nU.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-SWoKLIyz.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-zX9S1IGj.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-ByLUbevh.js");
...
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-C8Pa0uSk.js");
