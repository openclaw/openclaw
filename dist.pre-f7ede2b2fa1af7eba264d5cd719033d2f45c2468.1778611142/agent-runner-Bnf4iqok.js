...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-CrHjLKeQ.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-CIwNgiTD.js";
import { n as defaultRuntime } from "./runtime-Bd9_VI2J.js";
import { c as runWithActiveOtelTraceparent, o as freezeDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-IcGaoHY8.js";
import { a as isDiagnosticsEnabled, i as emitTrustedDiagnosticEvent } from "./diagnostic-events-KZsVzgRn.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-DQxuGlVu.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-GfhWvi5f.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-TU1A55ap.js";
import { o as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-BcF9ys4s.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-BOq30h3Y.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-B_IdQqVU.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-D2tVOYHR.js";
import { t as loadSessionStore } from "./store-load-6WUUNuxk.js";
import { b as resolveGroupSessionKey, c as updateSessionStoreEntry, m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-DOk7wSx2.js";
...
import { o as isAudioFileName } from "./mime-Dz_R57Df.js";
import { a as resolveContextTokensForModel } from "./context-Cb9I_i3I.js";
import { b as resolveModelRefFromString } from "./model-selection-shared-CkgNDUHT.js";
import { t as isCliProvider } from "./model-selection-cli-DVaij4Yi.js";
import "./model-selection-ClIa0TN2.js";
import { u as resolveModelAuthMode } from "./model-auth-BAukXI7p.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-KqTx1C2u.js";
import { a as formatEmbeddedPiQueueFailureSummary, d as queueEmbeddedPiMessageWithOutcome } from "./runs-YRsDmGSB.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-DLGt_YXy.js";
import { n as resolveAgentHarnessPolicy } from "./agent-runtime-metadata-BU_WOO7A.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-C4AMhu2s.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-CbtPd3vL.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-CyrPz5r3.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-BprBkQJL.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DzmEOeas.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-CSfWbsDb.js";
import { r as hasCrossSessionDelegateTargeting } from "./targeting-pure-D2Ie-9bg.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-1nrYy2wZ.js";
import { u as stripHeartbeatToken } from "./heartbeat-BJHqa6W4.js";
import { r as enqueueCommitmentExtraction } from "./runtime-CUj3Satf.js";
import { c as emitContinuationWorkSpan, i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-TXxqf9FP.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-QXht0m6a.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-BGeK471x.js";
import { a as enqueueSystemEvent } from "./system-events-k1OmfILA.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CTJowQ-0.js";
import { n as resolveSendPolicy } from "./send-policy-zf_6ldBl.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-DK3C0JqL.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-BxiIJr6D.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-JDztNMSz.js";
import { t as checkContextPressure } from "./context-pressure-3goddL77.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-BgwCfa33.js";
import { a as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-BLMbMwy0.js";
import "./pi-embedded-helpers-h1B99gRo.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-CmkuuKnz.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-D4I_DfXI.js";
import { t as formatProviderModelRef } from "./model-runtime-CsOO23nY.js";
import "./fallback-notice-state-pL-xJOol.js";
import { i as setReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-BT3zGfR1.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BnEJNs4t.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BZHJ6dBm.js";
import { t as runCliAgent } from "./cli-runner-LbYcDWiB.js";
import { r as getCliSessionBinding } from "./cli-session-BqZEugaj.js";
import { u as isLikelyExecutionAckPrompt } from "./selection-DWO3ph-n.js";
import { h as parseReplyDirectives } from "./deliver-B1TTk-3I.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-0F4gOVlY.js";
import { i as estimateMessagesTokens } from "./compaction-7h1NJMu4.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-P1cX7i_8.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-Cr22gDee.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-DE09eaZ-.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-CZL5pe_v.js";
import { n as hasCotFramePrefix } from "./normalize-reply-BvKYc1Ni.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-jdHtJKF_.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-6v03PQCB.js";
import "./sandbox-WuqtRIGw.js";
import { n as readPostCompactionContext } from "./post-compaction-context-Cc2mVP0I.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CMYIlLj9.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-c2G8ODNj.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DyUwg-VV.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-tgtj4dJ2.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-ZlHPOyQZ.js";
import { n as incrementCompactionCount } from "./session-updates-DiNICPfe.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-DvsoDX0w.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-BZy4MOt5.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-BwubWNUF.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-C46jiIwA.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-DA2Liep_.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-D9Sau0DH.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-7vuSr_Sc.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-CVKY0-VF.js");
			...
			run: async (provider, model, runOptions) => {
				...
				if (isCliProvider(cliExecutionProvider, runtimeConfig)) {
					...
					return (async () => {
						...
						let lastBridgedAssistantText;
						let assistantBridgeUnsubscribed = false;
						let assistantBridgeDelivery = Promise.resolve();
						const deliverBridgedAssistantText = async (text) => {
						...
						const queueBridgedAssistantText = (text) => {
							assistantBridgeDelivery = assistantBridgeDelivery.then(() => deliverBridgedAssistantText(text)).catch(() => void 0);
						};
						const drainAssistantBridgeDelivery = async () => {
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-ynf8naO3.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-4skBvMwO.js"));
...
function buildRestrictedMemoryFlushErrorPayload(err) {
	const message = normalizeOptionalString(err instanceof Error ? err.message : String(err));
	if (!message || !message.includes("Memory flush writes are restricted to ")) return;
	return {
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-JoO9eiRh.js"),
					import("./config-DQpieXSy.js"),
					import("./state-CozUXHZV.js"),
					import("./store-BDhPwEiH.js")
				]);
...
async function runReplyAgent(params) {
	...
	if (effectiveShouldSteer && isStreaming) {
		const steerOutcome = queueEmbeddedPiMessageWithOutcome((sessionKey ? replyRunRegistry.resolveSessionId(sessionKey) : void 0) ?? followupRun.run.sessionId, followupRun.prompt, {
		...
		if (!steerOutcome.queued) {
			...
			if (summary) logVerbose(`reply queue steering failed: ${summary}`);
		}
	}
	...
	try {
		...
		const runOutcome = await runWithActiveOtelTraceparent(followupRun.run.traceparent, () => traceAgentPhase("reply.run_agent_turn", () => runAgentTurnWithFallback({
			commandBody,
		...
		if (payloadArray.length === 0 && !hasQueuedDelegateWork && !effectiveContinuationSignal) return returnWithQueuedFollowupDrain(void 0);
