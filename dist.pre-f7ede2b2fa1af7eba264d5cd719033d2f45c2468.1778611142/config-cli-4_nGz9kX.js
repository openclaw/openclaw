...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-0GsiwJ5t.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-BqhOvepS.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-D8bxvBsI.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-C_9ic1rF.js";
import { a as resolveSecretRefValue } from "./resolve-D5cztFN6.js";
import { n as info, o as success, t as danger } from "./globals-2rjcRy6M.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-BTdvKaBm.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-BK_NTRYi.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-CzNExHro.js";
import { n as redactConfigObject } from "./redact-snapshot-CMJCvPKQ.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CQ9uxhge.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-BRHz2PC6.js";
import { n as setCommandJsonMode } from "./json-mode-Dmw98JQx.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-OJ-ZXHu_.js");
