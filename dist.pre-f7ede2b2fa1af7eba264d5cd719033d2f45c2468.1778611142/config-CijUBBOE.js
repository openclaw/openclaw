...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-iK0Q9rn6.js";
import "./ssrf-runtime-CJrKqHnq.js";
import "./retry-runtime-DdYpG6_p.js";
import "./secret-input-runtime-BOTCa4V4.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-ByMro443.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DTGhKv5v.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DWMUx22d.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DtdSM6iR.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-1s8rlsjz.js"), import("./logging-BKST-v3x.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-wj2J9pvg.js").then((credentialsReadModule) => ({
