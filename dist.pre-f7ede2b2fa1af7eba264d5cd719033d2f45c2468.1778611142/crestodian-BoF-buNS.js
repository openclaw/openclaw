...
import { r as resolveCrestodianOperation } from "./dialogue-DDpMtt04.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-tXRjTbQ8.js")).runCrestodianTui;
	opts.onReady?.();
