...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.mullusi", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MullusiConfigFile.defaultWorkspaceURL() }
