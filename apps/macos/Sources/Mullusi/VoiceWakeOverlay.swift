...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.mullusi", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Mullusi windows, but below the system’s pop-up menus.
