...
/// Menu contents for the Mullusi menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Mullusi") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Mullusi Not Configured"
        case .remote:
            "Remote Mullusi Active"
        case .local:
            "Mullusi Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .mullusiSelectSettingsTab, object: tab)
        }
    }
