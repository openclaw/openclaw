...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.mullusi", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Mullusi/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__mullusi__/a2ui/").absoluteString + "?platform=macos"
    }
