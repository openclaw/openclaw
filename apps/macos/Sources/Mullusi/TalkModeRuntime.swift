...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.mullusi", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.mullusi", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MullusiChatMessage] = messages.compactMap { item in
