...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.mullusi", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".mullusi/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.mullusiCommand(
            subcommand: "gateway",
