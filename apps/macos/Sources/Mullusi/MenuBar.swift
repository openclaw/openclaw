...
struct MullusiApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.mullusi", category: "app")
    ...
    init() {
        MullusiLogging.bootstrapIfNeeded()
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.mullusi", category: "Chat")
