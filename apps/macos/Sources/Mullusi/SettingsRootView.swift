...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .mullusiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MullusiPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MullusiPaths.stateDirURL.path
...
extension Notification.Name {
    static let mullusiSelectSettingsTab = Notification.Name("mullusiSelectSettingsTab")
}
