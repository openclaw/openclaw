...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.mullusi", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        MullusiPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        MullusiPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
    ...
    private static func ensureSecureStateDirectory() {
        let url = MullusiPaths.stateDirURL
        do {
