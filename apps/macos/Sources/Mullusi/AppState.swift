...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MullusiConfigFile.loadDict()
        ...
        remoteTokenDirty: Bool) -> (remote: [String: Any], changed: Bool)
    {
        ...
        case .ssh:
            ...
            if let host = remoteHost {
                ...
                let port = parsedExisting?.port ?? 18790
    ...
    private func startConfigWatcher() {
        let configUrl = MullusiConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: MullusiConfigFile.loadDict(),
        ...
        MullusiConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/mullusi"
        state.remoteCliPath = ""
        return state
    }
}
