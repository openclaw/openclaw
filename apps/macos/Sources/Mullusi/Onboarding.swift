...
enum UIStrings {
    static let welcomeTitle = "Welcome to Mullusi"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "mullusi.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: MullusiChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g mullusi@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MullusiChatViewModel(
