...
enum MullusiLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = MullusiOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = MullusiFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        ...
        let label = MullusiLogging.makeLabel(subsystem: subsystem, category: category)
...
struct MullusiOSLogHandler: AppLogLevelBackedHandler {
...
struct MullusiFileLogHandler: AppLogLevelBackedHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = MullusiLogging.parseLabel(self.label)
