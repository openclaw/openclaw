...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/mullusi/mullusi") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/mullusi/mullusi")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://mullusi.com")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "MullusiBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MullusiBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MullusiGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MullusiGitCommit") as? String) ??
            "unknown"
    }
