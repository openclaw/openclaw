...
private func printUsage() {
    ...
    Usage:
      dna-mac connect [--url <ws://host:port>] [--token <token>] [--password <password>]
    ...
    Examples:
      dna-mac connect
      dna-mac connect --url ws://127.0.0.1:18789 --json
      dna-mac discover --timeout 3000 --json
      dna-mac wizard --mode local
    """)
}
