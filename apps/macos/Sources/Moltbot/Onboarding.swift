...
enum UIStrings {
    static let welcomeTitle = "Welcome to DNA"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: DNAOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: DNAChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g dna@\(version)"
    }
