...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .dnaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DNAPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DNAPaths.stateDirURL.path
...
extension Notification.Name {
    static let dnaSelectSettingsTab = Notification.Name("dnaSelectSettingsTab")
}
