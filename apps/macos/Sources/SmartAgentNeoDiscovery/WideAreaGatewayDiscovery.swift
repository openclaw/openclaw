...
enum WideAreaGatewayDiscovery {
        ...
        context: DiscoveryContext = .live) -> [WideAreaGatewayBeacon]
    {
        ...
        guard let domain = SmartAgentNeoBonjour.wideAreaGatewayServiceDomain else { return [] }
        let domainTrimmed = domain.trimmingCharacters(in: CharacterSet(charactersIn: "."))
        let probeName = "_smart-agent-neo-gw._tcp.\(domainTrimmed)"
        ...
        for raw in ptrLines {
            ...
            let suffix = "._smart-agent-neo-gw._tcp.\(domainTrimmed)"
    ...
    {
        guard let domain = SmartAgentNeoBonjour.wideAreaGatewayServiceDomain else { return nil }
        let domainTrimmed = domain.trimmingCharacters(in: CharacterSet(charactersIn: "."))
        let probeName = "_smart-agent-neo-gw._tcp.\(domainTrimmed)"
