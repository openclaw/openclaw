...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.smart-agent-neo", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.smart-agent-neo", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SmartAgentNeoChatMessage] = messages.compactMap { item in
