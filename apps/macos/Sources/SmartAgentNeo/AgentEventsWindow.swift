...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SmartAgentNeoProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SmartAgentNeoProtocol.AnyCodable("start"),
                "name": SmartAgentNeoProtocol.AnyCodable("bash"),
            ],
            summary: nil)
