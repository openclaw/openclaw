...
private let onboardingWizardLogger = Logger(subsystem: "ai.smart-agent-neo", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between SmartAgentNeoProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = SmartAgentNeoProtocol.AnyCodable
