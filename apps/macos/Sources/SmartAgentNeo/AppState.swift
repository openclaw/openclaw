...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SmartAgentNeoConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SmartAgentNeoConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SmartAgentNeoConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/smart-agent-neo"
        state.remoteCliPath = ""
        return state
    }
}
