...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.smart-agent-neo", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".smart-agent-neo/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.smartAgentNeoCommand(
            subcommand: "gateway",
