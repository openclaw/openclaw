...
/// Menu contents for the SmartAgentNeo menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About SmartAgentNeo") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "SmartAgentNeo Not Configured"
        case .remote:
            "Remote SmartAgentNeo Active"
        case .local:
            "SmartAgentNeo Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .smartAgentNeoSelectSettingsTab, object: tab)
        }
    }
