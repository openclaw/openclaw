...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.smart-agent-neo", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SmartAgentNeoPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SmartAgentNeoPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
