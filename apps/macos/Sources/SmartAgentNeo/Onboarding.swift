...
enum UIStrings {
    static let welcomeTitle = "Welcome to SmartAgentNeo"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SmartAgentNeoOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SmartAgentNeoChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g smart-agent-neo@\(version)"
    }
