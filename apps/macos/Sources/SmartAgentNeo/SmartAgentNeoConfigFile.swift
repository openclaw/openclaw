...
enum SmartAgentNeoConfigFile {
    private static let logger = Logger(subsystem: "ai.smart-agent-neo", category: "config")
    ...
    static func defaultWorkspaceURL() -> URL {
        SmartAgentNeoPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-smart-agent-neo-config-file",
            "event": "config.write",
