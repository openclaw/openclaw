...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.smart-agent-neo", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SmartAgentNeo/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__smart-agent-neo__/a2ui/").absoluteString + "?platform=macos"
    }
