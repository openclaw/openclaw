...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.smart-agent-neo", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SmartAgentNeoConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.smart-agent-neo/smart-agent-neo.json
