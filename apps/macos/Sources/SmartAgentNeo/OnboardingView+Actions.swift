...
extension OnboardingView {
    ...
    func selectRemoteGateway(_ gateway: GatewayDiscoveryModel.DiscoveredGateway) {
        ...
        if self.state.remoteTransport == .direct {
            ...
            SmartAgentNeoConfigFile.setRemoteGatewayUrl(
    ...
    func finish() {
        UserDefaults.standard.set(true, forKey: "smart-agent-neo.onboardingSeen")
    ...
    func finishAnthropicOAuth() async {
        ...
        do {
            ...
            try SmartAgentNeoOAuthStore.saveAnthropicOAuth(creds)
            self.refreshAnthropicOAuthStatus()
            self.anthropicAuthStatus = "Connected. SmartAgentNeo can now use Claude."
        } catch {
