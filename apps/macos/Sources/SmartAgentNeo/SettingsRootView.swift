...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .smartAgentNeoSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SmartAgentNeoPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SmartAgentNeoPaths.stateDirURL.path
...
extension Notification.Name {
    static let smartAgentNeoSelectSettingsTab = Notification.Name("smartAgentNeoSelectSettingsTab")
}
