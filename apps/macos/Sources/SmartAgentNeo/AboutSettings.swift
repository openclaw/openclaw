...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/betterbrand/smart-agent-neo") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/betterbrand/smart-agent-neo")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://smart-agent-neo.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SmartAgentNeoBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SmartAgentNeoBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SmartAgentNeoGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SmartAgentNeoGitCommit") as? String) ??
            "unknown"
    }
