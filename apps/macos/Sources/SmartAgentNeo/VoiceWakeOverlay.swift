...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.smart-agent-neo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SmartAgentNeo windows, but below the system’s pop-up menus.
