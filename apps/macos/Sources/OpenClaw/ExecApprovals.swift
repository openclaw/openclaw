...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.easyhub", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        EasyHubPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        EasyHubPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
