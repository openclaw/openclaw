...
enum UIStrings {
    static let welcomeTitle = "Welcome to EasyHub"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: EasyHubOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: EasyHubChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g EasyHub@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: EasyHubChatViewModel(
