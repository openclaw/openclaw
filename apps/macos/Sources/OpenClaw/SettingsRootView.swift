...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .EasyHubSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? EasyHubPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? EasyHubPaths.stateDirURL.path
...
extension Notification.Name {
    static let EasyHubSelectSettingsTab = Notification.Name("EasyHubSelectSettingsTab")
}
