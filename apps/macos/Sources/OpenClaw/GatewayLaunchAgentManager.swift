...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.easyhub", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".easyhub/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.EasyHubCommand(
            subcommand: "gateway",
