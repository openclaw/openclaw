...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.easyhub", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return EasyHubConfigFile.defaultWorkspaceURL() }
