...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.easyhub", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other EasyHub windows, but below the system’s pop-up menus.
