...
import OpenClawIPC
>>>>>>> upstream/main:apps/macos/Sources/OpenClaw/OnboardingView+Actions.swift
import Foundation
>>>>>>> upstream/main
import SwiftUI
...
extension OnboardingView {
    ...
    func openSettings(tab: SettingsTab) {
        ...
        self.openSettings()
<<<<<<< HEAD:apps/macos/Sources/Clawdbot/OnboardingView+Actions.swift
        NotificationCenter.default.post(name: .clawdbotSelectSettingsTab, object: tab)
=======
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .openclawSelectSettingsTab, object: tab)
        }
>>>>>>> upstream/main:apps/macos/Sources/Moltbot/OnboardingView+Actions.swift
    }
