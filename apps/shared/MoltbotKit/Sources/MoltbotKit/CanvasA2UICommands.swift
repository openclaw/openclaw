...
public enum DNACanvasA2UICommand: String, Codable, Sendable {
...
public struct DNACanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct DNACanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
