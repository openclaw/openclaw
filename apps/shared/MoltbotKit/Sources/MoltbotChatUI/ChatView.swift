...
@MainActor
public struct DNAChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private var visibleMessages: [DNAChatMessage] {
        let base: [DNAChatMessage]
    ...
    private func mergeToolResults(in messages: [DNAChatMessage]) -> [DNAChatMessage] {
        var result: [DNAChatMessage] = []
    ...
    private func isToolResultMessage(_ message: DNAChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: DNAChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: DNAChatMessage) -> String {
