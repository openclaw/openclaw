...
public typealias DNAPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias DNAPlatformImage = UIImage
#endif

public struct DNAChatUsageCost: Codable, Hashable, Sendable {
...
public struct DNAChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: DNAChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(DNAChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct DNAChatMessageContent: Codable, Hashable, Sendable {
...
public struct DNAChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [DNAChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: DNAChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [DNAChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: DNAChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(DNAChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([DNAChatMessageContent].self, forKey: .content) {
...
public struct DNAChatHistoryPayload: Codable, Sendable {
...
public struct DNASessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct DNASessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [DNASessionPreviewItem]
}

public struct DNASessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [DNASessionPreviewEntry]

    public init(ts: Int, previews: [DNASessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct DNAChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct DNAChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct DNAAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct DNAChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct DNAGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct DNAPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: DNAPlatformImage?
...
public struct DNAChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
