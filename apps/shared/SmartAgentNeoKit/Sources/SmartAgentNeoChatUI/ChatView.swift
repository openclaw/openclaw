...
@MainActor
public struct SmartAgentNeoChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: SmartAgentNeoChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                SmartAgentNeoChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [SmartAgentNeoChatMessage] {
        let base: [SmartAgentNeoChatMessage]
    ...
    private func mergeToolResults(in messages: [SmartAgentNeoChatMessage]) -> [SmartAgentNeoChatMessage] {
        var result: [SmartAgentNeoChatMessage] = []
        ...
        for message in messages {
            ...
            let merged = SmartAgentNeoChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SmartAgentNeoChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SmartAgentNeoChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SmartAgentNeoChatMessage) -> String {
