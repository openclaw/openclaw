...
private typealias ProtoAnyCodable = SmartAgentNeoProtocol.AnyCodable
...
public actor GatewayChannelActor {
    private let logger = Logger(subsystem: "ai.smart-agent-neo", category: "gateway")
    ...
    private func sendConnect() async throws {
        ...
        let options = self.connectOptions ?? GatewayConnectOptions(
            ...
            commands: [],
            permissions: [:],
            clientId: "smart-agent-neo-macos",
            clientMode: "ui",
