...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.smart-agent-neo", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.smart-agent-neo", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SmartAgentNeoProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
