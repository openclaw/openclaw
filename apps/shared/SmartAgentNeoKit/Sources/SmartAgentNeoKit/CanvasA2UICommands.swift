...
public enum SmartAgentNeoCanvasA2UICommand: String, Codable, Sendable {
...
public struct SmartAgentNeoCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SmartAgentNeoCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
