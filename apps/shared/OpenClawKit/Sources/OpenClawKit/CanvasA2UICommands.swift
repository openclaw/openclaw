...
public enum EasyHubCanvasA2UICommand: String, Codable, Sendable {
...
public struct EasyHubCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct EasyHubCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
