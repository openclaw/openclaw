...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.easyhub", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.easyhub", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: EasyHubProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
