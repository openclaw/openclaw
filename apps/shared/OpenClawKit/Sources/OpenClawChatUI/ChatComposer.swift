...
@MainActor
struct EasyHubChatComposer: View {
    @Bindable var viewModel: EasyHubChatViewModel
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(EasyHubChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(EasyHubChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \EasyHubPendingAttachment.id)
                { (att: EasyHubPendingAttachment) in
                    HStack(spacing: 6) {
    ...
    private var editor: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(EasyHubChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(EasyHubChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(EasyHubChatTheme.subtleCard)
        .clipShape(Capsule())
    }
