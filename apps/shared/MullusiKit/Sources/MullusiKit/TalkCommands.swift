...
public enum MullusiTalkCommand: String, Codable, Sendable {
...
public struct MullusiTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MullusiTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
