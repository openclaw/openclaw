...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: MullusiProtocol.AnyCodable]?
    {
        ...
        return [
            "id": MullusiProtocol.AnyCodable(identity.deviceId),
            "publicKey": MullusiProtocol.AnyCodable(publicKey),
            "signature": MullusiProtocol.AnyCodable(signature),
            "signedAt": MullusiProtocol.AnyCodable(signedAtMs),
            "nonce": MullusiProtocol.AnyCodable(nonce),
        ]
    }
}
