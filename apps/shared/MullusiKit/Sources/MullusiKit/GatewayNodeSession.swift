...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.mullusi", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.mullusi", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: MullusiProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
