...
public struct MullusiChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct MullusiChatSessionsDefaults: Codable, Sendable {
...
public struct MullusiChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct MullusiChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: MullusiChatSessionsDefaults?
    public let sessions: [MullusiChatSessionEntry]

    public init(
        ts: Double?,
        path: String?,
        count: Int?,
        defaults: MullusiChatSessionsDefaults?,
        sessions: [MullusiChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
