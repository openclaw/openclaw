...
@MainActor
public struct MullusiChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MullusiChatViewModel
    ...
    public init(
        viewModel: MullusiChatViewModel,
    ...
    private var visibleMessages: [MullusiChatMessage] {
        let base: [MullusiChatMessage]
    ...
    private func mergeToolResults(in messages: [MullusiChatMessage]) -> [MullusiChatMessage] {
        var result: [MullusiChatMessage] = []
    ...
    private func isToolResultMessage(_ message: MullusiChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func shouldDisplayMessage(_ message: MullusiChatMessage) -> Bool {
    ...
    private func primaryText(in message: MullusiChatMessage) -> String {
    ...
    private func hasInlineAttachments(in message: MullusiChatMessage) -> Bool {
    ...
    private func toolCalls(in message: MullusiChatMessage) -> [MullusiChatMessageContent] {
    ...
    private func inlineToolResults(in message: MullusiChatMessage) -> [MullusiChatMessageContent] {
        message.content.filter { content in
            let kind = (content.type ?? "").lowercased()
    ...
    private func toolCallIds(in message: MullusiChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MullusiChatMessage) -> String {
