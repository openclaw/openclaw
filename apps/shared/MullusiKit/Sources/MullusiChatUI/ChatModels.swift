...
public typealias MullusiPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MullusiPlatformImage = UIImage
#endif

public struct MullusiChatUsageCost: Codable, Hashable, Sendable {
...
public struct MullusiChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MullusiChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MullusiChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MullusiChatMessageContent: Codable, Hashable, Sendable {
...
public struct MullusiChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MullusiChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MullusiChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MullusiChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MullusiChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MullusiChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MullusiChatMessageContent].self, forKey: .content) {
...
public struct MullusiChatHistoryPayload: Codable, Sendable {
...
public struct MullusiSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MullusiSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MullusiSessionPreviewItem]
}

public struct MullusiSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MullusiSessionPreviewEntry]

    public init(ts: Int, previews: [MullusiSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MullusiChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MullusiChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MullusiAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MullusiChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MullusiGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MullusiPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MullusiPlatformImage?
...
public struct MullusiChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
