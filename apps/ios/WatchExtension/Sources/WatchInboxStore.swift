...
@MainActor @Observable final class WatchInboxStore {
    ...
    var title = "VeriClaw 爪印"
    var body = "Waiting for review requests from your iPhone."
    var transport = "none"
    var updatedAt: Date?
    var promptId: String?
    var sessionKey: String?
    ...
    func consume(message: WatchNotifyMessage, transport: String) {
        ...
        let normalizedTitle = message.title.isEmpty ? "VeriClaw 爪印" : message.title
    ...
    private func postLocalNotification(identifier: String, title: String, body: String, risk: String?) async {
        ...
        content.threadIdentifier = "vericlaw-watch"
