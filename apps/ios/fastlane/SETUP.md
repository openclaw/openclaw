...
ASC_KEYCHAIN_SERVICE=mullusi-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.mullusi.client
# or
...
- The beta flow regenerates `apps/ios/Mullusi.xcodeproj` from `apps/ios/project.yml` before archiving
