...
- Release notes are generated from `apps/ios/CHANGELOG.md` into temporary Fastlane metadata during upload; the release entry point runs `pnpm ios:release:cut` to prepare the exact encoded section automatically.
