...
typealias OpenClawBanner = OpenClawNoticeBanner
...
struct OpenClawPrimaryButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .animation(.easeOut(duration: OpenClawMotion.fast), value: configuration.isPressed)
    }
}
...
struct OpenClawGhostButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            .font(OpenClawType.headline)
            .foregroundStyle(OpenClawBrand.accent)
            ...
            .background {
                RoundedRectangle(cornerRadius: OpenClawRadius.sm, style: .continuous)
                    .fill(OpenClawBrand.accentGhost)
                    .overlay {
                        RoundedRectangle(cornerRadius: OpenClawRadius.sm, style: .continuous)
                            .strokeBorder(OpenClawBrand.accent.opacity(0.40), lineWidth: 1)
                    }
            }
            .opacity(configuration.isPressed ? 0.82 : 1)
    }
...
struct OpenClawDestructiveButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            .font(OpenClawType.headline)
            ...
            .background {
                RoundedRectangle(cornerRadius: OpenClawRadius.sm, style: .continuous)
                    .fill(OpenClawBrand.danger.opacity(0.12))
                    .overlay {
                        RoundedRectangle(cornerRadius: OpenClawRadius.sm, style: .continuous)
                            .strokeBorder(OpenClawBrand.danger.opacity(0.40), lineWidth: 1)
                    }
            }
            .opacity(configuration.isPressed ? 0.82 : 1)
    }
...
struct OpenClawTextButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            .font(OpenClawType.subheadSemiBold)
...
extension View {
    ...
    func openClawGhostButton() -> some View {
        self.buttonStyle(OpenClawGhostButtonStyle())
    }

    func openClawDestructiveButton() -> some View {
        self.buttonStyle(OpenClawDestructiveButtonStyle())
    }

    func openClawTextButton() -> some View {
        self.buttonStyle(OpenClawTextButtonStyle())
    }
}
...
/// Legacy wrapper; prefer ``OpenClawMascot`` with a scale tier directly.
struct OpenClawProMark: View {
    var size: CGFloat = 42
    var shadowRadius: CGFloat = 10

    var body: some View {
        OpenClawMascot(size: self.size)
    }
}
