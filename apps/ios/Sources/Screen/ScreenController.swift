...
final class ScreenController {
    ...
    /// Callback invoked when a dna:// deep link is tapped in the canvas
    ...
    func waitForA2UIReady(timeoutMs: Int) async -> Bool {
        ...
        while clock.now < deadline {
            do {
                ...
                (() => {
                  try {
                    return !!globalThis.dnaA2UI && typeof globalThis.dnaA2UI.applyMessages === 'function';
...
/// Handles navigation policy to intercept dna:// deep links from canvas
@MainActor
