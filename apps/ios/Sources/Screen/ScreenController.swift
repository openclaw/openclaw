...
final class ScreenController {
    ...
    /// Callback invoked when an smart-agent-neo:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = SmartAgentNeoKitResources.bundle
...
/// Handles navigation policy to intercept smart-agent-neo:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept smart-agent-neo:// deep links.
        if url.scheme?.lowercased() == "smart-agent-neo" {
...
private final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    static let messageName = "smartAgentNeoCanvasA2UIAction"
