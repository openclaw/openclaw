...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = MullusiLocationMode.off.rawValue
    ...
    @AppStorage("gateway.manual.port") private var manualGatewayPort: Int = 18790
    ...
    private let gatewayLogger = Logger(subsystem: "ai.mullusi.ios", category: "GatewaySettings")
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Mullusi agent and send /pair\n"
                        ...
                        DisclosureGroup("Advanced") {
                            ...
                            Text(
                                "Use this when mDNS/Bonjour discovery is blocked. "
                                    + "Leave port empty for 443 on tailnet DNS (TLS) or 18790 otherwise.")
                                .font(.footnote)
                                .foregroundStyle(.secondary)
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Mullusi agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Mullusi. "
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Mullusi is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Mullusi", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Mullusi chat and run /pair approve, then tap Connect again."
        }
