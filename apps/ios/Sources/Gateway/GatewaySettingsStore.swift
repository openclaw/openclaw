...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.smartagentneo.gateway"
    private static let nodeService = "ai.smartagentneo.node"
    private static let talkService = "ai.smartagentneo.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.smartagentneo.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.smartagentneo.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("smart-agent-neo-gateway.log")
    }
