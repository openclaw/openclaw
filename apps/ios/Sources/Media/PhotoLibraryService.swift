...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SmartAgentNeoPhotosLatestParams) async throws -> SmartAgentNeoPhotosLatestPayload {
        ...
        var results: [SmartAgentNeoPhotoPayload] = []
        ...
        return SmartAgentNeoPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SmartAgentNeoPhotoPayload
    {
        ...
        return SmartAgentNeoPhotoPayload(
            format: "jpeg",
