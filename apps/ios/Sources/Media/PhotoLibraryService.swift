...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MullusiPhotosLatestParams) async throws -> MullusiPhotosLatestPayload {
        ...
        var results: [MullusiPhotoPayload] = []
        ...
        return MullusiPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MullusiPhotoPayload
    {
