...
final class CalendarService: CalendarServicing {
    func events(params: SmartAgentNeoCalendarEventsParams) async throws -> SmartAgentNeoCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            SmartAgentNeoCalendarEventPayload(
        ...
        return SmartAgentNeoCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: SmartAgentNeoCalendarAddParams) async throws -> SmartAgentNeoCalendarAddPayload {
        ...
        let payload = SmartAgentNeoCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return SmartAgentNeoCalendarAddPayload(event: payload)
    }
