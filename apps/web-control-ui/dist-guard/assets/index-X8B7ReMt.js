...
`)}return``}function Y(e,t){let n=e.toLowerCase();return t===`user`?`reply`:n.includes(`vite v`)||n.includes(`built in`)||n.includes(`gzip size`)||n.includes(`build`)?`build`:n.includes(`pwsh `)||n.includes(`node .\\node_modules`)||n.includes(`git `)||n.includes(`checkpoint`)?`command`:n.includes(`connected`)||n.includes(`unauthorized`)||n.includes(`status`)||n.includes(`success`)||n.includes(`失败`)||n.includes(`成功`)?`status`:`reply`}function Rt(){let e=new URL(window.location.href);return`${e.protocol===`https:`?`wss:`:`ws:`}//${e.hostname}:18789/gateway`}var zt=`web-control-ui.bound-target`;function Bt(){try{let e=localStorage.getItem(zt);if(!e)return null;let t=JSON.parse(e),n=typeof t.agentId==`string`?t.agentId.trim():``,r=typeof t.sessionKey==`string`?t.sessionKey.trim():``;return!n&&!r?null:X(n,r)}catch{return null}}function Vt(e){try{localStorage.setItem(zt,JSON.stringify(e))}catch{}}function Ht(){try{localStorage.removeItem(zt)}catch{}}function X(e,t){let n=e.trim()||`testui`,r=t.trim()||`main`;if(r.startsWith(`agent:`)){let[,e,...t]=r.split(`:`);return{agentId:e?.trim()||n,sessionKey:t.join(`:`).trim()||`main`}}return{agentId:n,sessionKey:r}}function Ut(){try{let e=new URL(window.location.href),t=e.searchParams.get(`agentView`),n=e.searchParams.get(`agentId`)?.trim()??``,r=e.searchParams.get(`sessionKey`)?.trim()??``;return t!==`1`&&!n&&!r?null:X(n,r)}catch{return null}}var Z=class extends N{constructor(...e){super(...e),this.client=null,this.appState=Re.getInstance(),this.awaitingCheckpointHistoryFromChat=!1,this.gatewayUrl=Rt(),this.gatewayToken=``,this.targetAgentId=`testui`,this.sessionKey=`main`,this.boundTarget=null,this.standaloneAgentMode=!1,this.connectionState=`idle`,this.hello=null,this.health=null,this.statusSummary=null,this.lastEvent=null,this.errorMessage=null,this.chatInput=``,this.chatMessages=[],this.chatStream=``,this.chatRunId=null,this.chatLoading=!1,this.chatSending=!1,this.chatFilter=`all`,this.expandedMessages={},this.preferenceMemory=I(),this.preferenceDraft=Ot(I()),this.preferenceSavedAt=null,this.recommendations=We,this.promptDraft=q,this.safeEditMode=!0,this.checkpointName=`before-change`,this.restoreRef=`checkpoint/web-control-ui-YYYYMMDD-HHMMSS-before-change`,this.currentUsageVariant=`native`,this.sessionSearch=``,this.sessionsLoading=!1,this.sessionsError=null,this.sessionRows=[],this.checkpointHistory=[],this.checkpointHistoryLoading=!1,this.language=qe()??Ve()}static{this.styles=l`
  ...
  `}t(e,t){return Be(this.language,e,t)}toggleLanguage(){this.language=this.language===`zh`?`en`:`zh`,Je(this.language)}connectedCallback(){super.connectedCallback();let e=Ye();this.preferenceMemory=e,this.preferenceDraft=Ot(e),this.gatewayToken=Ft();let t=Ut(),n=Bt(),r=t??n;this.standaloneAgentMode=t!==null,r&&(this.boundTarget=X(r.agentId,r.sessionKey),this.targetAgentId=this.boundTarget.agentId,this.sessionKey=this.boundTarget.sessionKey,t&&Vt(this.boundTarget)),this.currentUsageVariant=this.appState.variant,this.unsubscribeAppState=this.appState.subscribe(()=>{this.currentUsageVariant=this.appState.variant}),It(this.gatewayToken),this.connect()}disconnectedCallback(){this.unsubscribeAppState?.(),this.client?.stop(),this.client=null,super.disconnectedCallback()}async loadSummaries(){if(!(!this.client||this.connectionState!==`connected`))try{let[e,t]=await Promise.all([this.client.request(`health`,{}),this.client.request(`status`,{})]);this.health=e??null,this.statusSummary=t??null}catch(e){this.errorMessage=`${this.t(`loadStatusError`)}：${String(e)}`}}async loadChatHistory(){if(!(!this.client||this.connectionState!==`connected`)){this.chatLoading=!0;try{let e=await this.client.request(`chat.history`,{sessionKey:this.getBoundTarget().sessionKey,limit:100});this.chatMessages=(Array.isArray(e.messages)?e.messages:[]).map(e=>{let t=e??{},n=typeof t.role==`string`?t.role:`assistant`,r=Lt(e);if(!r.trim())return null;let i=n===`user`||n===`assistant`||n===`system`?n:`assistant`;return{role:i,text:r,timestamp:Date.now(),kind:Y(r,i)}}).filter(e=>e!==null)}catch(e){this.errorMessage=`${this.t(`loadChatHistoryError`)}：${String(e)}`}finally{this.chatLoading=!1}}}async loadSessionsList(){if(!(!this.client||this.connectionState!==`connected`)){this.sessionsLoading=!0,this.sessionsError=null;try{let e=await this.client.request(`sessions.list`,{});this.sessionRows=Array.isArray(e.sessions)?e.sessions.filter(e=>!!(e&&typeof e.key==`string`)).sort((e,t)=>(t.updatedAt??0)-(e.updatedAt??0)):[]}catch(e){this.sessionsError=String(e)}finally{this.sessionsLoading=!1}}}getNormalizedSessionKey(){return this.sessionKey.trim()||`main`}getDraftTarget(){return X(this.targetAgentId,this.getNormalizedSessionKey())}getBoundTarget(){let e=this.boundTarget??this.getDraftTarget(),t=X(e.agentId,e.sessionKey);return{agentId:t.agentId,sessionKey:`agent:${t.agentId}:${t.sessionKey}`}}bindCurrentTarget(){this.boundTarget=this.getDraftTarget(),Vt(this.boundTarget),this.errorMessage=null,this.chatMessages=[],this.chatStream=``,this.chatRunId=null,this.awaitingCheckpointHistoryFromChat=!1,this.checkpointHistoryLoading=!1,this.loadChatHistory()}unbindCurrentTarget(){this.boundTarget={agentId:`testui`,sessionKey:`main`},this.targetAgentId=`testui`,this.sessionKey=`main`,this.standaloneAgentMode=!1,Ht(),this.errorMessage=null,this.chatMessages=[],this.chatStream=``,this.chatRunId=null,this.awaitingCheckpointHistoryFromChat=!1,this.checkpointHistoryLoading=!1,this.loadChatHistory()}getExpectedSessionKeys(){return[this.getBoundTarget().sessionKey]}resolveSessionTarget(e){return X(e.agentId??this.targetAgentId,e.key)}async switchSession(e){await this.switchSessionTarget(X(this.targetAgentId,e))}async switchSessionTarget(e){let t=X(e.agentId,e.sessionKey),n=this.boundTarget??this.getDraftTarget();n.agentId===t.agentId&&n.sessionKey===t.sessionKey||(this.boundTarget=t,this.targetAgentId=t.agentId,this.sessionKey=t.sessionKey,Vt(t),this.chatMessages=[],this.chatStream=``,this.chatRunId=null,this.errorMessage=null,await this.loadChatHistory())}handleChatEvent(e){let t=this.getExpectedSessionKeys();if(!(!e||!t.includes(e.sessionKey))&&!(e.runId&&this.chatRunId&&e.runId!==this.chatRunId&&e.state!==`final`)){if(e.state===`delta`){this.chatStream=Lt(e.message);return}if(e.state===`final`){let t=Lt(e.message)||this.chatStream;t.trim()&&(this.chatMessages=[...this.chatMessages,{role:`assistant`,text:t,timestamp:Date.now(),kind:Y(t,`assistant`)}]),this.awaitingCheckpointHistoryFromChat&&=(this.checkpointHistory=this.parseCheckpointHistory(t),this.checkpointHistory.length>0&&(this.restoreRef=this.checkpointHistory[0].ref),this.checkpointHistoryLoading=!1,!1),this.chatStream=``,this.chatRunId=null,this.chatSending=!1;return}if(e.state===`aborted`){this.chatStream.trim()&&(this.chatMessages=[...this.chatMessages,{role:`assistant`,text:this.chatStream,timestamp:Date.now(),kind:Y(this.chatStream,`assistant`)}]),this.awaitingCheckpointHistoryFromChat&&=(this.checkpointHistory=this.parseCheckpointHistory(this.chatStream),this.checkpointHistory.length>0&&(this.restoreRef=this.checkpointHistory[0].ref),this.checkpointHistoryLoading=!1,!1),this.chatStream=``,this.chatRunId=null,this.chatSending=!1;return}e.state===`error`&&(this.errorMessage=e.errorMessage??`chat error`,this.awaitingCheckpointHistoryFromChat&&=(this.checkpointHistoryLoading=!1,!1),this.chatStream=``,this.chatRunId=null,this.chatSending=!1)}}connect(){this.errorMessage=null,this.connectionState=`connecting`,this.hello=null,this.health=null,this.statusSummary=null,this.client?.stop();let e=new Dt({url:this.gatewayUrl.trim(),token:this.gatewayToken.trim()||void 0,clientName:`openclaw-control-ui`,clientVersion:`apps-web-control-ui-dev`,mode:`webchat`,instanceId:crypto.randomUUID(),onHello:t=>{this.client===e&&(this.connectionState=`connected`,this.hello=t,this.loadSummaries(),this.loadSessionsList(),this.loadChatHistory(),this.supportsGatewayMethod(`shell.exec`)?this.loadCheckpointHistory():this.checkpointHistory=[])},onClose:({code:t,reason:n,error:r})=>{this.client===e&&(this.connectionState=r?`error`:`disconnected`,this.errorMessage=r?.message??`${this.t(`connectionClosed`)} (${t}) ${n||``}`.trim())},onEvent:t=>{this.client===e&&(this.lastEvent=t,t.event===`chat`&&this.handleChatEvent(t.payload))},onGap:({expected:e,received:t})=>{this.errorMessage=this.t(`eventSequenceGap`,{expected:String(e),received:String(t)})}});this.client=e,e.start()}async sendRawMessage(e,t){if(!this.client||this.connectionState!==`connected`||this.chatSending)return;let n=crypto.randomUUID(),r=this.getBoundTarget();this.chatMessages=[...this.chatMessages,{role:`user`,text:e,timestamp:Date.now(),kind:`reply`}],this.chatRunId=n,this.chatStream=``,this.chatSending=!0;try{await this.client.request(`chat.send`,{sessionKey:r.sessionKey,message:t,deliver:!1,idempotencyKey:n})}catch(e){this.chatSending=!1,this.chatRunId=null,this.errorMessage=`${this.t(`sendError`)}：${String(e)}`,this.chatMessages=[...this.chatMessages,{role:`system`,text:`${this.t(`sendError`)}：${String(e)}`,timestamp:Date.now(),kind:`status`}]}}async sendChat(){if(!this.client||this.connectionState!==`connected`||this.chatSending)return;let e=this.chatInput.trim();if(!e)return;let t=jt(this.preferenceMemory,e,{safeMode:this.safeEditMode}).replace(q.trim(),this.promptDraft.trim());this.chatInput=``,await this.sendRawMessage(e,t)}buildRollbackCommandPrompt(e,t=``){return[`这是 web-control-ui 的版本管理辅助任务。`,`不要修改页面代码，不要展开解释，只执行指定命令。`,`工作目录：openclaw-src 仓库根目录。`,`执行命令：${e}`,t,`最后尽量原样返回命令输出；如果输出是 JSON，就直接只返回 JSON。`].filter(Boolean).join(`

`)}async triggerCheckpoint(){let e=this.checkpointName.trim()||`before-change`,t=`创建 checkpoint：${e}`,n=this.buildRollbackCommandPrompt(`pwsh ./scripts/web-control-ui-checkpoint.ps1 -Name \"${e.replace(/\"/g,`\\"`)}\"`);await this.sendRawMessage(t,n)}async triggerRestore(){let e=this.restoreRef.trim();if(!e){this.errorMessage=this.t(`checkpointRefRequired`);return}let t=`恢复 checkpoint：${e}`,n=this.buildRollbackCommandPrompt(`pwsh ./scripts/web-control-ui-restore.ps1 -Ref \"${e.replace(/\"/g,`\\"`)}\"`,`恢复完成后，再执行：node .\\node_modules\\vite\\bin\\vite.js build（目录：openclaw-src/apps/web-control-ui）。`);await this.sendRawMessage(t,n)}async triggerListCheckpoints(){let e=this.buildRollbackCommandPrompt(`pwsh ./scripts/web-control-ui-list-checkpoints.ps1 -Json`,`请按原样返回 JSON 数组，不要补充说明文字。`);this.errorMessage=null,this.checkpointHistoryLoading=!0,this.awaitingCheckpointHistoryFromChat=!0,await this.sendRawMessage(`查看最近 checkpoint`,e)}supportsGatewayMethod(e){return this.hello?.features?.methods?.includes(e)??!1}toCheckpointEntry(e,t,n,r){let i=n.trim()||`manual`;return{ref:e,timestamp:t,name:i,label:r?.label?.trim()||i.replace(/-/g,` `),kind:r?.kind??`parsed`,shortSha:r?.shortSha,displayTime:r?.displayTime||t.toLocaleString(`zh-CN`,{hour12:!1}),subject:r?.subject}}normalizeCheckpointHistory(e){return[...e].sort((e,t)=>t.timestamp.getTime()-e.timestamp.getTime())}parseCheckpointHistoryJson(e){let t=(e.match(/```(?:json)?\s*([\s\S]*?)```/i)?.[1]??e).trim(),n=t.indexOf(`[`),r=t.lastIndexOf(`]`);if(n===-1||r===-1||r<=n)return null;try{let e=JSON.parse(t.slice(n,r+1)).map(e=>{let t=typeof e.ref==`string`?e.ref.trim():``,n=typeof e.name==`string`?e.name.trim():``,r=typeof e.label==`string`?e.label.trim():n.replace(/-/g,` `),i=typeof e.timestamp==`string`?e.timestamp.trim():``,a=i?new Date(i):null;return!t||!a||Number.isNaN(a.getTime())?null:this.toCheckpointEntry(t,a,n||r,{label:r,kind:e.kind===`branch`||e.kind===`legacy-tag`?e.kind:`parsed`,shortSha:typeof e.shortSha==`string`?e.shortSha.trim():void 0,displayTime:typeof e.displayTime==`string`?e.displayTime.trim():void 0,subject:typeof e.subject==`string`?e.subject.trim():void 0})}).filter(e=>e!==null);return e.length>0?this.normalizeCheckpointHistory(e):null}catch{return null}}parseCheckpointHistory(e){let t=this.parseCheckpointHistoryJson(e);if(t)return t;let n=e.split(`
`).map(e=>e.trim()).filter(Boolean).map(e=>e.replace(/^[-*•\d.\s`]+/,``).replace(/`/g,``).trim());return this.normalizeCheckpointHistory(n.map(e=>{let t=e.match(/checkpoint\/web-control-ui-(\d{8})-(\d{6})-(.+)$/);if(!t)return null;let[,n,r,i]=t,a=parseInt(n.slice(0,4),10),o=parseInt(n.slice(4,6),10)-1,s=parseInt(n.slice(6,8),10),c=parseInt(r.slice(0,2),10),l=parseInt(r.slice(2,4),10),u=parseInt(r.slice(4,6),10),d=new Date(a,o,s,c,l,u);return this.toCheckpointEntry(e,d,i)}).filter(e=>e!==null))}async loadCheckpointHistory(){if(!(!this.client||this.connectionState!==`connected`)){if(!this.supportsGatewayMethod(`shell.exec`)){this.checkpointHistory=[],this.checkpointHistoryLoading=!1;return}this.checkpointHistoryLoading=!0;try{let e=(await this.client.request(`shell.exec`,{command:`pwsh`,args:[`./scripts/web-control-ui-list-checkpoints.ps1`,`-Json`],cwd:`C:\\Users\\24045\\clawd\\openclaw-src`})).output??``;this.checkpointHistory=this.parseCheckpointHistory(e),this.checkpointHistory.length>0&&(this.restoreRef=this.checkpointHistory[0].ref)}catch(e){this.errorMessage=`${this.t(`loadCheckpointError`)}：${String(e)}`}finally{this.checkpointHistoryLoading=!1}}}formatCheckpointTime(e){let t=new Date().getTime()-e.getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);if(n<1)return this.t(`justNow`);if(n<60)return`${n} ${this.t(`minutesAgo`)}`;if(r<24)return`${r} ${this.t(`hoursAgo`)}`;if(i===1){let t=this.language===`zh`?`zh-CN`:`en-US`,n=e.toLocaleTimeString(t,{hour:`2-digit`,minute:`2-digit`,hour12:!1});return`${this.t(`yesterday`)} ${n}`}if(i<7)return`${i} ${this.t(`daysAgo`)}`;let a=this.language===`zh`?`zh-CN`:`en-US`;return e.toLocaleString(a,{month:`short`,day:`numeric`,hour:`2-digit`,minute:`2-digit`,hour12:!1})}formatCheckpointAbsoluteTime(e){if(e.displayTime?.trim())return e.displayTime;let t=this.language===`zh`?`zh-CN`:`en-US`;return e.timestamp.toLocaleString(t,{hour12:!1})}checkpointKindLabel(e){return e.kind===`branch`?`git branch`:e.kind===`legacy-tag`?`legacy tag`:`parsed ref`}selectCheckpoint(e){this.restoreRef=e,this.errorMessage=null}useLatestCheckpoint(){let e=this.checkpointHistory[0];e&&this.selectCheckpoint(e.ref)}async restoreLatestCheckpoint(){let e=this.checkpointHistory[0];e&&(this.selectCheckpoint(e.ref),await this.triggerRestore())}async restoreToCheckpoint(e){this.selectCheckpoint(e),await this.triggerRestore()}savePreferenceDraft(){this.preferenceMemory=kt(this.preferenceDraft),Xe(this.preferenceMemory),this.preferenceSavedAt=new Date().toLocaleString(`zh-CN`,{hour12:!1})}resetPreferenceDraft(){let e=I();this.preferenceMemory=e,this.preferenceDraft=Ot(e),Xe(e),this.preferenceSavedAt=new Date().toLocaleString(`zh-CN`,{hour12:!1})}handleConnectSubmit(e){e.preventDefault(),this.connect()}dotClass(){return this.connectionState===`connected`?`dot connected`:this.connectionState===`connecting`?`dot connecting`:this.connectionState===`error`?`dot error`:`dot`}usageVariantLabel(e){switch(e){case`mission`:return`Mission`;case`star`:return`Star`;case`blank`:return`Blank`;default:return`Native`}}setUsageVariant(e){this.appState.setVariant(e),this.currentUsageVariant=e}acpRuntimeStatus(){return this.health?.defaultAgentId===`claude`?`Claude ready`:this.health?.defaultAgentId?`${this.health.defaultAgentId} active`:`unverified`}renderJson(e){return e==null?T`<p class="muted">暂无数据</p>`:T`<pre>${JSON.stringify(e,null,2)}</pre>`}renderTags(e){return T`<div class="tag-list">${e.map(e=>T`<span class="tag">${e}</span>`)}</div>`}currentDevUrl(){let e=this.gatewayToken.trim();return e?`http://localhost:4173/#token=${e}`:`http://localhost:4173/#token=<gateway-token>`}filteredSessionRows(){let e=this.sessionSearch.trim().toLowerCase();return e?this.sessionRows.filter(t=>[t.key,t.label??``,t.kind??``,t.model??``].join(` `).toLowerCase().includes(e)):this.sessionRows}formatSessionTime(e){if(!e)return`-`;try{return new Date(e).toLocaleString(`zh-CN`,{hour12:!1})}catch{return String(e)}}buildStandaloneAgentUrl(e){let t=X(e.agentId,e.sessionKey),n=new URL(window.location.href);return n.searchParams.set(`mode`,`control`),n.searchParams.set(`agentView`,`1`),n.searchParams.set(`agentId`,t.agentId),n.searchParams.set(`sessionKey`,t.sessionKey),n.toString()}openStandaloneAgent(e){window.open(this.buildStandaloneAgentUrl(e),`_blank`,`noopener`)}async copyStandaloneAgentLink(e){let t=this.buildStandaloneAgentUrl(e);try{await navigator.clipboard.writeText(t),this.errorMessage=null}catch(e){this.errorMessage=`复制链接失败：${String(e)}`}}exitStandaloneAgentMode(){let e=new URL(window.location.href);e.searchParams.delete(`agentView`),e.searchParams.delete(`agentId`),e.searchParams.delete(`sessionKey`),e.searchParams.get(`mode`)===`control`&&e.searchParams.delete(`mode`),window.location.href=e.toString()}messageKey(e,t){return`${e.role}:${e.timestamp}:${t}`}matchesChatFilter(e){let t=e.kind??Y(e.text,e.role);return this.chatFilter===`all`?!0:t===this.chatFilter}renderBubble(e,t){let n=this.messageKey(e,t),r=this.expandedMessages[n]===!0,i=e.text.length>600,a=i&&!r?`${e.text.slice(0,600)}\n\n…`:e.text,o=e.kind??Y(e.text,e.role),s=e.role===`system`?`system / ${o}`:o===`reply`?e.role:`${e.role} / ${o}`;return T`
            ...
            <div class="section-stack">
              <section class="panel">
                ...
                <div class="session-browser">
                  ${this.filteredSessionRows().map(e=>{let t=this.resolveSessionTarget(e),n=t.agentId===this.getDraftTarget().agentId&&t.sessionKey===this.getDraftTarget().sessionKey;return T`
                      <article class="session-item ${n?`active`:``}">
                        <div class="session-item-header">
                          <div>
                            <div><strong>${e.label?.trim()||t.sessionKey}</strong></div>
                            <div class="session-meta">agent: ${t.agentId}</div>
                          </div>
                          ${n?T`<span class="tag">当前</span>`:null}
                        </div>
                        <div class="session-meta">session: ${t.sessionKey}</div>
                        <div class="session-meta">kind: ${e.kind??`-`} · model: ${e.model??`-`}</div>
                        <div class="session-meta">updated: ${this.formatSessionTime(e.updatedAt)}</div>
                        <div class="session-actions">
                          <button class="secondary compact-button" type="button" @click=${()=>this.switchSessionTarget(t)}>切到这里</button>
                          <button class="compact-button" type="button" @click=${()=>this.openStandaloneAgent(t)}>单独打开</button>
                        </div>
                      </article>
                    `})}
              ...
              <section class="panel">
                ...
                <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid rgba(148, 163, 184, 0.18);">
                  ...
                  ${this.supportsGatewayMethod(`shell.exec`)?null:T`<p class="muted" style="padding: 0 0 16px;">${this.t(`checkpointHistoryUnavailableHint`)}</p>`}
                  ...
                  ${this.checkpointHistory.length===0&&!this.checkpointHistoryLoading?T`<p class="muted" style="text-align: center; padding: 20px 0;">${this.t(`noCheckpointHistory`)}</p>`:T`
                      <div style="display: flex; flex-direction: column; gap: 14px;">
                        ${this.checkpointHistory.map(e=>{let t=this.restoreRef.trim()===e.ref;return T`
                            <article
                              style=${[`background: rgba(15, 23, 42, 0.82)`,`border: 1px solid ${t?`rgba(96, 165, 250, 0.55)`:`rgba(148, 163, 184, 0.16)`}`,`border-radius: 16px`,`padding: 16px`,`box-shadow: ${t?`0 0 0 1px rgba(59, 130, 246, 0.28) inset`:`none`}`].join(`; `)}
                            >
                              <div style="display:flex; justify-content:space-between; gap:16px; align-items:flex-start; flex-wrap:wrap;">
                                <div style="display:flex; flex-direction:column; gap:10px; min-width:0; flex:1;">
                                  <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                                    <div style="font-size: 18px; font-weight: 700; color: #f8fafc; letter-spacing: 0.01em;">
                                      ${this.formatCheckpointAbsoluteTime(e)}
                                    </div>
                                    <span class="tag">${this.formatCheckpointTime(e.timestamp)}</span>
                                    <span class="tag">${this.checkpointKindLabel(e)}</span>
                                    ${e.shortSha?T`<span class="tag">${e.shortSha}</span>`:null}
                                    ${t?T`<span class="tag" style="background: rgba(37, 99, 235, 0.22); border-color: rgba(96, 165, 250, 0.45); color: #dbeafe;">当前选中</span>`:null}
                                  </div>
                                ...
                                <div style="display:flex; gap:8px; flex-wrap:wrap; justify-content:flex-end;">
                                  <button
                                    class="secondary"
                                    type="button"
                                    @click=${()=>this.selectCheckpoint(e.ref)}
    ...
    `}};L([F()],Z.prototype,`gatewayUrl`,void 0),L([F()],Z.prototype,`gatewayToken`,void 0),L([F()],Z.prototype,`targetAgentId`,void 0),L([F()],Z.prototype,`sessionKey`,void 0),L([F()],Z.prototype,`boundTarget`,void 0),L([F()],Z.prototype,`standaloneAgentMode`,void 0),L([F()],Z.prototype,`connectionState`,void 0),L([F()],Z.prototype,`hello`,void 0),L([F()],Z.prototype,`health`,void 0),L([F()],Z.prototype,`statusSummary`,void 0),L([F()],Z.prototype,`lastEvent`,void 0),L([F()],Z.prototype,`errorMessage`,void 0),L([F()],Z.prototype,`chatInput`,void 0),L([F()],Z.prototype,`chatMessages`,void 0),L([F()],Z.prototype,`chatStream`,void 0),L([F()],Z.prototype,`chatRunId`,void 0),L([F()],Z.prototype,`chatLoading`,void 0),L([F()],Z.prototype,`chatSending`,void 0),L([F()],Z.prototype,`chatFilter`,void 0),L([F()],Z.prototype,`expandedMessages`,void 0),L([F()],Z.prototype,`preferenceMemory`,void 0),L([F()],Z.prototype,`preferenceDraft`,void 0),L([F()],Z.prototype,`preferenceSavedAt`,void 0),L([F()],Z.prototype,`recommendations`,void 0),L([F()],Z.prototype,`promptDraft`,void 0),L([F()],Z.prototype,`safeEditMode`,void 0),L([F()],Z.prototype,`checkpointName`,void 0),L([F()],Z.prototype,`restoreRef`,void 0),L([F()],Z.prototype,`currentUsageVariant`,void 0),L([F()],Z.prototype,`sessionSearch`,void 0),L([F()],Z.prototype,`sessionsLoading`,void 0),L([F()],Z.prototype,`sessionsError`,void 0),L([F()],Z.prototype,`sessionRows`,void 0),L([F()],Z.prototype,`checkpointHistory`,void 0),L([F()],Z.prototype,`checkpointHistoryLoading`,void 0),L([F()],Z.prototype,`language`,void 0),Z=L([P(`control-mode-view`)],Z);var Wt=class extends N{constructor(...e){super(...e),this.currentTime=new Date().toLocaleTimeString()}connectedCallback(){super.connectedCallback(),this.updateTime()}disconnectedCallback(){super.disconnectedCallback(),this.timeIntervalId!==void 0&&clearInterval(this.timeIntervalId)}updateTime(){this.timeIntervalId=setInterval(()=>{this.currentTime=new Date().toLocaleTimeString()},1e3)}static{this.styles=l`
    :host {
      display: block;
      width: 100%;
      height: 100vh;
  ...
  `}render(){return T`
    ...
    `}};L([F()],Wt.prototype,`currentTime`,void 0),Wt=L([P(`usage-mode-native`)],Wt);var Gt=class extends N{constructor(...e){super(...e),this.greeting=this.getGreeting()}getGreeting(){let e=new Date().getHours();return e<12?`Good morning`:e<18?`Good afternoon`:`Good evening`}static{this.styles=l`
    :host {
      display: block;
      width: 100%;
      height: 100vh;
  ...
  `}render(){return T`
    ...
    `}};L([F()],Gt.prototype,`greeting`,void 0),Gt=L([P(`usage-mode-blank`)],Gt);var Q=class extends N{constructor(...e){super(...e),this.systemStatus=`operational`,this.activeWorkflows=3,this.completedTasks=47,this.uptime=`99.8%`}static{this.styles=l`
    :host {
      display: block;
      width: 100%;
      height: 100vh;
  ...
  `}render(){return T`
    ...
    `}};L([F()],$.prototype,`agentPresence`,void 0),L([F()],$.prototype,`recentActivity`,void 0),L([F()],$.prototype,`currentTime`,void 0),$=L([P(`star-view`)],$);var Kt=class extends N{constructor(...e){super(...e),this.variant=`native`}static{this.styles=l`
    :host {
      display: block;
      min-height: 100vh;
    }
  `}render(){switch(this.variant){case`mission`:return T`<mission-view></mission-view>`;case`star`:return T`<star-view></star-view>`;case`blank`:return T`<usage-mode-blank></usage-mode-blank>`;default:return T`<usage-mode-native></usage-mode-native>`}}};L([Le()],Kt.prototype,`variant`,void 0),Kt=L([P(`use-mode-view`)],Kt);
//# sourceMappingURL=index-X8B7ReMt.js.map