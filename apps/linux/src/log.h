...
typedef enum {
    ...
    OPENCLAW_LOG_CAT_REMOTE  = 1 << 6,   /* remote mode: tunnel, endpoint, coordinator */
    OPENCLAW_LOG_CAT_ALL     = OPENCLAW_LOG_CAT_SYSTEMD | OPENCLAW_LOG_CAT_TRAY | OPENCLAW_LOG_CAT_STATE | OPENCLAW_LOG_CAT_NOTIFY | OPENCLAW_LOG_CAT_HEALTH | OPENCLAW_LOG_CAT_GATEWAY | OPENCLAW_LOG_CAT_REMOTE
} OpenClawLogCategory;
