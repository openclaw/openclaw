    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("Mullusi Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("mullusi qr --setup-code-only")
          CommandBlock("mullusi qr --json")
          Text(
