...
import ai.mullusi.app.NotificationBurstLimiter
import ai.mullusi.app.SecurePrefs
import ai.mullusi.app.allowsPackage
import ai.mullusi.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) =
      context.applicationContext.getSharedPreferences("mullusi.secure", Context.MODE_PRIVATE)
