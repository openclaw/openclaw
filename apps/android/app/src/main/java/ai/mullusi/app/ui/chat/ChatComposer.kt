...
import ai.mullusi.app.ui.mobileSurface
import ai.mullusi.app.ui.mobileText
import ai.mullusi.app.ui.mobileTextSecondary
import ai.mullusi.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.mullusi.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.mullusi.app.ui.mobileFontFamily,
