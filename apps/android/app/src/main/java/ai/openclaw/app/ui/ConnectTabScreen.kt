...
fun ConnectTabScreen(viewModel: MainViewModel) {
  ...
  Column(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
      ...
      Text(
        if (isConnected) stringResource(R.string.gateway_ready) else stringResource(R.string.connect_to_your_gateway),
        style = mobileCallout,
    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text(if (pairingRequired) stringResource(R.string.pairing_required) else stringResource(R.string.last_gateway_error), style = mobileHeadline, color = mobileWarning)
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          Text(stringResource(R.string.run_these_on_gateway), style = mobileCallout, color = mobileTextSecondary)
          CommandBlock("openclaw qr --setup-code-only")
          CommandBlock("openclaw qr --json")
          Text(
            stringResource(R.string.for_tailscale_or_public),
