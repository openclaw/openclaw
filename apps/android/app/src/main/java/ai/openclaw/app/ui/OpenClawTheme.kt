...
/**
 * App theme wrapper that installs warm Material colors and legacy mobile color tokens.
 */
@Composable
fun OpenClawTheme(
  ...
  // Use custom warm schemes instead of dynamic system colors to ensure the "warm" look
