...
import ai.smartagentneo.android.CameraHudKind
import ai.smartagentneo.android.BuildConfig
import ai.smartagentneo.android.SecurePrefs
...
class CameraHandler(
  ...
  suspend fun handleSnap(paramsJson: String?): GatewaySession.InvokeResult {
    ...
    fun camLog(msg: String) {
      ...
      android.util.Log.w("smart-agent-neo", "camera.snap: $msg")
    }
    try {
  ...
  suspend fun handleClip(paramsJson: String?): GatewaySession.InvokeResult {
    ...
    fun clipLog(msg: String) {
      ...
      android.util.Log.w("smart-agent-neo", "camera.clip: $msg")
    }
