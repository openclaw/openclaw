...
class GatewayConfigResolverTest {
  ...
  fun parseGatewayEndpointRejectsTailnetCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://100.64.0.9:18790")
  ...
  fun parseGatewayEndpointAllowsLoopbackCleartextWsUrls() {
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 18790,
        tls = false,
        displayUrl = "http://127.0.0.1:18790",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsLocalhostCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://localhost:18790")
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 18790,
        tls = false,
        displayUrl = "http://localhost:18790",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsAndroidEmulatorCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://10.0.2.2:18790")
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 18790,
        tls = false,
        displayUrl = "http://10.0.2.2:18790",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsPrivateLanCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://192.168.1.20:18790")
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 18790,
        tls = false,
        displayUrl = "http://192.168.1.20:18790",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsMdnsCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://gateway.local:18790")
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 18790,
        tls = false,
        displayUrl = "http://gateway.local:18790",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsIpv6LoopbackCleartextWsUrls() {
    ...
    assertEquals(18790, parsed?.port)
    assertEquals(false, parsed?.tls)
    assertEquals("http://[::1]:18790", parsed?.displayUrl)
  }
  ...
  fun parseGatewayEndpointAllowsIpv4MappedIpv6LoopbackCleartextWsUrls() {
    ...
    assertEquals(18790, parsed?.port)
    assertEquals(false, parsed?.tls)
    assertEquals("http://[::ffff:127.0.0.1]:18790", parsed?.displayUrl)
  }
  ...
  fun parseGatewayEndpointAllowsLinkLocalIpv6ZoneCleartextWsUrls() {
    ...
    assertEquals(18790, parsed?.port)
    assertEquals(false, parsed?.tls)
    assertEquals("http://[fe80::1%25eth0]:18790", parsed?.displayUrl)
  }
  ...
  fun resolveScannedSetupCodeAcceptsRawSetupCode() {
    val setupCode =
      encodeSetupCode("""{"url":"wss://gateway.example:18790","bootstrapToken":"bootstrap-1"}""")
  ...
  fun resolveScannedSetupCodeAcceptsQrJsonPayload() {
    ...
    val qrJson =
      ...
      {
        "setupCode": "$setupCode",
        "gatewayUrl": "wss://gateway.example:18790",
        "auth": "password",
  ...
  fun resolveScannedSetupCodeRejectsNonLoopbackCleartextGateway() {
    val setupCode =
      encodeSetupCode("""{"url":"ws://attacker.example:18790","bootstrapToken":"bootstrap-1"}""")
  ...
  fun parseGatewayEndpointResultFlagsInsecureRemoteGateway() {
    val parsed = parseGatewayEndpointResult("ws://gateway.example:18790")
  ...
  fun parseGatewayEndpointResultAcceptsLanCleartextGateway() {
    val parsed = parseGatewayEndpointResult("ws://192.168.1.20:18790")
  ...
  fun decodeGatewaySetupCodeParsesBootstrapToken() {
    ...
    assertEquals("wss://gateway.example:18790", decoded?.url)
