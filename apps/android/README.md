## SmartAgentNeo Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_smart-agent-neo-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm smart-agent-neo gateway --port 18789 --verbose
```
