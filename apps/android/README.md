## Activi Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_activi-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm activi gateway --port 18789 --verbose
```
