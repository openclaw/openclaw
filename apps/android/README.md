## EasyHub Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_EasyHub-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm EasyHub gateway --port 18789 --verbose
```
