## DNA Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_dna-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm dna gateway --port 18789 --verbose
```
