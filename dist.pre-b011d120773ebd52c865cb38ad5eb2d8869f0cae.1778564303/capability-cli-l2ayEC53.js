...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-fFkwW_47.js";
...
import { p as normalizeThinkLevel } from "./thinking-DQxuGlVu.js";
...
import { i as callGateway, u as randomIdempotencyKey } from "./call-WDuoqUff.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-BG13PXJL.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-Bb09NmxI.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-Dz_R57Df.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-C3RHt1lm.js";
...
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-BjurmWyB.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-Z_AAwLt7.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-CV6LlGwO.js";
import "./tts-BHG5ukIz.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-Cw37-qtE.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-BEY3ash0.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BTiqhrAt.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Ch4eprtt.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-CspqdLjg.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CkKXUbHZ.js";
import { n as runCommandWithRuntime } from "./cli-utils-DSE6y8Sz.js";
import { t as removeCommandByName } from "./command-tree-CIidUWPI.js";
import { t as collectOption } from "./helpers-C231dnG5.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-D1olt-BP.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Cu0P4xF6.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-DpGFAWb-.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CvYJEMbj.js");
