...
import { c as isRecord$1 } from "./utils-CRkrr5e6.js";
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-0GsiwJ5t.js";
import { r as normalizeProviderId$1 } from "./provider-id-BvxMxU5i.js";
...
import { i as setPathExistingStrict } from "./path-utils-C67P_gpo.js";
import { n as discoverConfigSecretTargets } from "./target-registry-DKMsgwvS.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-C7AkIz5l.js";
import { n as formatConfigIssueLines } from "./issue-format-BK_NTRYi.js";
import { r as normalizeTalkSection } from "./talk-DoU1Fdqc.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-CJLwyR03.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-KUKJ2BcQ.js";
import { n as getLoadedChannelPlugin } from "./registry-BlvStC0Q2.js";
import { i as listRouteBindings } from "./bindings-CKV5s9X7.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-Ba4TigOg.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-CMWQSLqj.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Re4eNeGU.js";
import { t as note } from "./note-De7QpaFE.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-9abmu6Jg.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-BjQIuMkT.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BYVXRQcb.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-HkBm3YAe.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-C2l9KDsR.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-KF-2hUvh.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-CaTnxg05.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-COk4ZGp4.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DXoeXsw1.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-pDRK2W74.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-FOl-RrTb.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CLWeyzfw.js");
		emitDoctorNotes({
			note,
