...
import { g as loggingState } from "./logger-DoY1MBoY.js";
import { a as routeLogsToStderr } from "./console-D3q9sw1e.js";
import { t as resolveCliCommandPathPolicy } from "./command-path-policy-B-RcjsFA.js";
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CimixKXp.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-BfdZxx57.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-Zx9ppuVy.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-B9YskKgf.js");
	if (params.argv) {
