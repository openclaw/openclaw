...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-DQ9MnQcM.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-lNXfLGbb.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CZj_H93m.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-Ha0vCCdU.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-C_gIB1Z0.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-D2Hj4my4.js");
