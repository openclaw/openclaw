...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-DOz1z-K1.js";
import "./config-CeLqc6zi.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-CZjF3mdV.js"), import("./logging-DKSNfYWe.js")]).then(([sdkModule, loggingModule]) => ({
