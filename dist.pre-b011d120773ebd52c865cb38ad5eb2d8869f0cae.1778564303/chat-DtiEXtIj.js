...
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-DQhlw1in.js";
...
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-Cf6YB0c0.js";
...
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-BCZoKQ-G.js";
...
import { s as normalizeReplyPayloadsForDelivery } from "./deliver-itn6787V.js";
import { d as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-BPvMwLLv.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-BKnXsQdq.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-DgIwgW97.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-UPnf_mx7.js";
...
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-Cx2ch1hZ.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-DSPFaw62.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-DCmX260v.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-C50KwVqZ.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-DOUfFa-1.js";
...
import { t as logLargePayload } from "./diagnostic-payload-BdU_AQxr.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-DYc9M2BV.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-D1PYJklb.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-CrAjanFa.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-CiQ7Tp-6.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-edOjmEbt.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DmFX0duO.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-DdZM0Mj5.js";
