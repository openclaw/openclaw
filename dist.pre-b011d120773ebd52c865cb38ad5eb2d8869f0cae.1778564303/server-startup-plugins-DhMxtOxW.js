...
import { I as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-Bh4d6t3Z.js";
import { c as initSubagentRegistry } from "./subagent-registry-BhaanQI_.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-Bd2zSP0R.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-_v-Kv4XD.js";
import { n as listGatewayMethods } from "./server-methods-list-CENo_D7Q.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-D6EyvO6J.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-D4m6syjj.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-BZiHCyEQ.js");
