...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-iK0Q9rn6.js";
import "./ssrf-runtime-BxiaPFE4.js";
import "./security-runtime-DEiZ9bZs.js";
import { t as getMSTeamsRuntime } from "./runtime-api-B_LUGizP.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-CZD0yCuS.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-ByCHVdTq.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-n2_colGU.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-BQU16XF3.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-CXRC85h4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
