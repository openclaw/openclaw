...
import { s as redactToolPayloadText } from "./redact-R2-EdHUS.js";
...
import { S as hasEncodedFileUrlSeparator, T as trySafeFileURLToPath, t as appendFileWithinRoot } from "./fs-safe-DKdSS9ZL.js";
import { o as root } from "./secure-temp-dir-DP1EBfnW.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-CRkrr5e6.js";
...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-bmH32UOR.js";
import { n as normalizeAccountId } from "./account-id-9_btbLFO.js";
import { c as normalizeAgentId, p as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-8g_Q03Po.js";
import { o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-fFkwW_47.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-CBctHYDw.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-ip_BGHgo.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-BhkUcREW.js";
...
import { t as logDebug } from "./logger-se9wHZOU.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-C7AkIz5l.js";
import { h as isWindowsDrivePath } from "./archive-2VHG7WZe.js";
import { n as modelKey } from "./model-ref-shared-C7l6EghF.js";
import { t as applyMergePatch } from "./merge-patch-DA3t8-ai.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-BZYZ5rKR.js";
...
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-BkNhu4qX.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-pCIwgpiB.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-C51Fd3z8.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-B_IdQqVU.js";
import { n as assertSandboxPath } from "./sandbox-paths-BIBsJi54.js";
import "./local-file-access-D7QWcDEn.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-BfZtcNpF.js";
import { h as stringifyRouteThreadId } from "./channel-route-xbmFitKi.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-Cx37tn1U.js";
...
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BlvStC0Q2.js";
import { n as resolveSessionConversationRef } from "./session-conversation-CcLb_vr2.js";
...
import { c as extractDeliveryInfo } from "./sessions-DDKzhGib.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-Dz_R57Df.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-Cc6LcVZi.js";
import { C as modelKey$1, b as resolveModelRefFromString, i as buildModelAliasIndex, w as normalizeModelRef } from "./model-selection-shared-Cz4Ee-l6.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-C3RHt1lm.js";
...
import { r as getApiKeyForModel } from "./model-auth-6I9_K4TR.js";
...
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-Bz8nNpsD.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES, s as normalizeSubagentTaskName } from "./subagent-spawn-DcRje8p1.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-KaqKJYm6.js";
import { n as ensureOpenClawModelsJson } from "./models-config-Dxw1zx87.js";
import { r as loadModelCatalog } from "./model-catalog-ClJbmM2S.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-66nI1FFR.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-BCZoKQ-G.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-5rDDkoob.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DYW5KkT2.js";
import "./tool-policy-DIworFrv.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BxIyU5p6.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-DlUN6Kbw.js";
...
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-D2Ie-9bg.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-1nrYy2wZ.js";
import { t as completionRequiresMessageToolDelivery } from "./completion-delivery-policy-BzB_53vl.js";
import "./targeting-L3OaDY2R.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-f9id5UI-.js";
import { n as resolveContinuationRuntimeConfig } from "./config-CTQqYp1V.js";
import { a as getImageMetadata } from "./image-ops-BjurmWyB.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-Bh96RCcE.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-Dkf2ETUO.js";
import { a as resolvePluginTools } from "./tools-CHNWu-2k.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-CTPwDfcO.js";
import { c as isToolWrappedWithBeforeToolCallHook, h as listChannelSupportedActions, p as listAllChannelSupportedActions, u as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-7AXo47di.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DgsP50jw.js";
import { n as extractAssistantText } from "./pi-embedded-utils-DmmQvhk5.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BPvMwLLv.js";
import { n as runWithImageModelFallback } from "./model-fallback-IwdHwsBo.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DsEjVMXA.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-D4lHrpIB.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BWPwJLRs.js";
...
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BaejjEK0.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-Cr1rOGOe.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-BYub0F1_.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-rkLP5poK.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-Arwy1sys.js";
import { t as inferLegacyName } from "./normalize-hsV4KVcU.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-CqDQ6_3z.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-UA51bxjF.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BAW--4Xt.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-Ddn1Ko7r.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-C1eMOzB6.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-B_smdWKp.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CEYbD2F3.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-Cf7o9htE.js";
import { u as saveMediaBuffer } from "./store-BKnXsQdq.js";
import { t as SsrFBlockedError } from "./ssrf-COOL9as_.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-C03lkRov.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-_-8Tk5P-.js";
import { r as getDefaultLocalRoots } from "./local-media-access-UPnf_mx7.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-DRT0Hpze.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-C7ws6AkQ.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Dv6a6JIH.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CqiNhzGt.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DKb-QDxD.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DLPKKmN_.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-Dft-709g.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-Z_AAwLt7.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BcCVgK_J.js";
import { s as resolveTimeoutMs } from "./resolve-B6e9gl9E.js";
import { t as buildProviderRegistry } from "./runner-ORPODSgv.js";
...
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-eVOg7xdS.js";
import { a as resolveAllowedMessageActions, n as runMessageAction, o as POLL_CREATION_PARAM_DEFS, s as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-D_3UVelF.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-DBacWQJJ.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-nRyST1BJ.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-qBSP3DDT.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CUJZLQY8.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-D_ExfOyh.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-xOodWOdn.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-BEmgoacG.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DGB507yI.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-DDzkdWIE.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-Ni2Ocyry.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-CcfTZJmB.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-CC5Q3s5U.js";
import { p as registerSubagentRun } from "./subagent-registry-BhaanQI_.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DtbhbraT.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-35u5kwVp.js";
import { k as textToSpeech } from "./tts-runtime-CV6LlGwO.js";
import "./tts-BHG5ukIz.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-D_MqyZ3c.js";
...
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BDrXhlS4.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-B98LHuVM.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-BK9rn0qJ.js";
...
import { i as runWebSearch } from "./runtime-BEY3ash0.js";
...
function createMusicGenerateTool(options) {
	...
	return {
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			const timeout = normalizeMusicGenerationTimeoutMs(requestedTimeoutMs ?? musicGenerationModelConfig.timeoutMs);
			const timeoutMs = timeout.timeoutMs;
			const referenceFetchTimeoutMs = requestedTimeoutMs === void 0 ? void 0 : timeoutMs;
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-Dbuuc9J3.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CXunToNy.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-Cqw3sLch.js"));
