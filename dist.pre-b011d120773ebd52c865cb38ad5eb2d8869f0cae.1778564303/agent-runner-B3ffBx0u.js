...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-CBctHYDw.js";
...
import { a as isDiagnosticsEnabled, i as emitTrustedDiagnosticEvent } from "./diagnostic-events-DDo7iKXJ.js";
...
import { b as resolveGroupSessionKey, c as updateSessionStoreEntry, m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-DWV_PSjG.js";
...
import { a as formatEmbeddedPiQueueFailureSummary, d as queueEmbeddedPiMessageWithOutcome } from "./runs-B1USHROf.js";
...
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-BpTxtrDs.js";
...
import { r as enqueueCommitmentExtraction } from "./runtime-CLCgYNHh.js";
...
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-D_l61LdN.js";
import { n as resolveSendPolicy } from "./send-policy-Bo1WPmNX.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-f9id5UI-.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-DNFZcvVq.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-CTQqYp1V.js";
import { t as checkContextPressure } from "./context-pressure-DZOVN23e.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-DqMkr1-A.js";
import { a as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-Ba4TigOg.js";
...
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-jlud9YE4.js";
import { t as formatProviderModelRef } from "./model-runtime-CsOO23nY.js";
import "./fallback-notice-state-CswzEENU.js";
...
import { u as isLikelyExecutionAckPrompt } from "./selection-alQOGH7I.js";
import { h as parseReplyDirectives } from "./deliver-itn6787V.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-IwdHwsBo.js";
import { i as estimateMessagesTokens } from "./compaction-CJxSzVOd.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-7llTvGKW.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-C2eZV9UN.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BJyedCfX.js";
...
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DfWXcxCD.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-jqR7AYpg.js";
import "./sandbox-Cx2ch1hZ.js";
import { n as readPostCompactionContext } from "./post-compaction-context-BIie_hiZ.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-B5gonH6k.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-ee4x8lhY.js";
...
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-qFZ6b9CJ.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-DCmX260v.js";
...
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-ttEe331O.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-w1TGped_.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-DVqRRTyo.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-B6Qbn4KL.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-4718MrWa.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-C4IdhKhf.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-DEi4SjGo.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-CUBEewJt.js"),
					import("./config-pBebWJV9.js"),
					import("./state-BYeKmbEl.js"),
					import("./store-xQJxQ9Xs.js")
				]);
