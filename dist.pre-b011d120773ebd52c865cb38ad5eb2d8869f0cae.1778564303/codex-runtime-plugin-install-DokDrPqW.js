...
import "./installed-plugin-index-records-CsGho-_-.js";
import { t as enablePluginInConfig } from "./enable-GN3b6ek-.js";
import { i as modelSelectionShouldEnsureCodexPlugin } from "./openai-codex-routing-DLqe3PZx.js";
...
async function ensureCodexRuntimePluginForModelSelection(params) {
	...
	if (isInstalledRecordPresentOnDisk((await loadInstalledPluginIndexInstallRecords({ env: process.env }))[CODEX_RUNTIME_PLUGIN_ID], process.env)) {
	...
	const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-g3NO5P1m.js");
...
async function repairCodexRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-dG7yr9oC.js");
