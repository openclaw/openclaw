import { n as detectErrorKind } from "./errors-VfATXfah.js";
...
import { r as setSafeTimeout } from "./timer-delay-CVEMbN4N.js";
...
import { c as loadSessionEntry, s as loadGatewaySessionRow } from "./session-utils-BCZoKQ-G.js";
import { u as stripHeartbeatToken } from "./heartbeat-BJHqa6W4.js";
import { a as resolveToolSearchCodeDisplayTarget } from "./tool-display-common-BKxgLEHt.js";
import { t as resolveHeartbeatVisibility } from "./heartbeat-visibility-B1nTKfbB.js";
import { t as formatForLog } from "./ws-log-uxsqiOP0.js";
import { i as shouldSuppressAssistantEventForLiveChat, n as projectLiveAssistantBufferedText, r as resolveMergedAssistantText, t as normalizeLiveAssistantEventText } from "./live-chat-projector-BeQn8kgv.js";
import { a as createToolEventRecipientRegistry, i as createSessionMessageSubscriberRegistry, n as createChatRunState, r as createSessionEventSubscriberRegistry, t as createChatRunRegistry } from "./server-chat-state-pMCWCxLZ.js";
...
function createAgentEventHandler({ broadcast, broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients, sessionEventSubscribers, loadGatewaySessionRowForSnapshot = loadGatewaySessionRow, lifecycleErrorRetryGraceMs = AGENT_LIFECYCLE_ERROR_RETRY_GRACE_MS, isChatSendRunActive = () => false }) {
	...
	return (evt) => {
		...
		if (isControlUiVisible && sessionKey) {
			if (!isToolEvent || toolVerbose !== "off") nodeSendToSession(sessionKey, "agent", isToolEvent ? projectToolSearchCodeEventForChannelPayload({
				...channelToolPayload,
				...buildSessionEventSnapshot(sessionKey)
			}) : agentPayload);
