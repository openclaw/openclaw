...
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-DgKdQ9TD.js";
import "./pi-bundle-mcp-tools-CBsp02bf.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-TwQeeTFT.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-qBSP3DDT.js";
import "./subagent-announce-queue-BUfyTw2F.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-CcfTZJmB.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-CC5Q3s5U.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BncxLjdT.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-CXNF8JCA.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BncxLjdT.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-CluUscKm.js").then(({ scheduleOrphanRecovery }) => {
