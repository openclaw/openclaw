import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, o as normalizeNullableString, s as normalizeOptionalLowercaseString } from "./string-coerce-DyL154ka.js";
import { i as formatErrorMessage } from "./errors-D3K0qXmL.js";
import { t as createLazyImportLoader } from "./lazy-promise-Djskx0qC.js";
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-Cm1NaFpC.js";
import { b as escapeRegExp } from "./utils-BlCbsks0.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, i as isCronSessionKey } from "./session-key-utils-Ce_xWkNq.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-BAP1m9Ju.js";
import { a as logWarn, r as logInfo } from "./logger-CeySquHZ.js";
import { Y as getShellPathFromLoginShell, Z as resolveShellEnvFallbackTimeoutMs } from "./io-CmeoeBvq.js";
import { f as resolveApprovalAuditTrustPath } from "./exec-safe-bin-trust-DTg2jg2F.js";
import { O as normalizeExecutableToken, c as isShellWrapperExecutable, k as splitShellArgs, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-CehhL5X5.js";
import { t as killProcessTree } from "./kill-tree-C3duXFqv.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-DIO4k9AW.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-DGvgHuOd.js";
import { o as normalizeDeliveryContext } from "./delivery-context.shared-Bk0xEm32.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-BO6_8hHT.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-BAPT3_qw.js";
import { d as sanitizeUserFacingText, f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText } from "./sanitize-user-facing-text-K7UOIc-J.js";
import { t as formatDurationCompact } from "./format-duration-BrZ-AaEJ.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-Bw8mP98O.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-DUH8Hge2.js";
import { o as failedTextResult, y as textResult } from "./common-DSvNmzGK.js";
import { t as callGatewayTool } from "./gateway-CLvOhD7F.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-GkUMojAA.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-DTPpqpNz.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DSsnR-OG.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-BG6W8l3W.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BGFWiRti.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-C3OFedGv.js";
import "./delivery-context-BVMBgb5f.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-CeNbkptM.js";
import { t as sendMessage } from "./message-xS2gPlGU.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DsNDoiiL.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CMvu2J2g.js";
import { t as getProcessSupervisor } from "./supervisor-BhFQD6CC.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-Cgrm-n1W.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-DNEIhvkw.js";
import { u as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-CAw4btrN.js";
import { n as detectPolicyInlineEval } from "./policy-Bn29SZYa.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-C20XbeZj.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-oKbHuJTE.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-SGmZCkiR.js";
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-CCZUWTmk.js"));
