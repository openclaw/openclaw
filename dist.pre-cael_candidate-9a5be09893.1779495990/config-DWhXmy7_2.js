...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-BM3-Vmz4.js";
...
import { t as requireRuntimeConfig } from "./plugin-config-runtime-C7y_ltl1.js";
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-CIwd6x-p.js";
import "./ssrf-runtime-Db7Y0wil.js";
import "./retry-runtime-CaitszdE.js";
import "./secret-input-runtime-B21-f0r8.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-B0ilgFj9.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-J2eHsfqp.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-BlCQl7t0.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-RoZX59IM.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DExRbAi8.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CvNM4420.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BE2_ldem.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CBmrmJcr.js"), import("./logging-hgTD6ZTO.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-DOmAv4R1.js").then((credentialsReadModule) => ({
