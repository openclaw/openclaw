#!/usr/bin/env node
import { a as formatUncaughtError } from "./errors-D3K0qXmL.js";
import { t as formatCliFailureLines } from "./failure-output-CNdPwCO5.js";
import { r as runFatalErrorHooks } from "./fatal-error-hooks-gDVRMZSa.js";
import { t as isMainModule } from "./is-main-EQb8Rm7k.js";
import { c as isUncaughtExceptionHandled, r as isBenignUncaughtExceptionError, t as installUnhandledRejectionHandler } from "./unhandled-rejections-CbLkGW5P.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-BXdr2zyV.js"));
if (isMain) {
