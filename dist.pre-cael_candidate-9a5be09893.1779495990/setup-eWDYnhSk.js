...
function loadAuthChoiceModule() {
	authChoiceModulePromise ??= import("./auth-choice-BZJ5q4qR.js");
...
function loadModelPickerModule() {
	modelPickerModulePromise ??= import("./model-picker-Brx_N-qR.js");
...
async function runSetupWizard(opts, runtime, prompter) {
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-DbW_b-AT.js");
