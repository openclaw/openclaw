...
import "./accounts-DCO5g24j.js";
import "./runtime-api-DTNqMohb.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-C2n-r0PU.js";
import { t as sendMessageZalo } from "./send-DvRFNj1_.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CUfqEVoQ.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CkLyLA-s.js");
