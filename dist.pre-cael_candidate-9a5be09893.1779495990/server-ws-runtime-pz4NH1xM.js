...
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-CQsQvXio.js";
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	import("./message-handler-DPWSkNbs.js").then(({ attachGatewayWsMessageHandler }) => {
