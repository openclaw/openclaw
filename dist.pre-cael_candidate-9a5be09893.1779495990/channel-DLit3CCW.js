...
import { d as createDefaultChannelRuntimeState, l as createAsyncComputedAccountStatusAdapter } from "./status-helpers-CkwlpDZd.js";
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields, n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-C1CGXvL_.js";
...
import { a as resolveZalouserReactionMessageIds, o as buildZalouserGroupCandidates, s as findZalouserGroupEntry, t as getZalouserRuntime } from "./runtime-DfSGtoz6.js";
import { n as zalouserSetupAdapter, r as writeQrDataUrlToTempFile, t as createZalouserSetupWizardProxy } from "./setup-core-DfHwr5u7.js";
import { i as resolveZalouserOutboundSessionRoute, n as parseZalouserDirectoryGroupId, r as parseZalouserOutboundTarget, t as normalizeZalouserTarget } from "./session-route-DE3TB4tq.js";
//#region extensions/zalouser/src/channel.adapters.ts
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(() => import("./channel.runtime-DbynVyCR.js"));
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-DbynVyCR.js"));
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(async () => (await import("./setup-surface-uMVtGoHw.js")).zalouserSetupWizard);
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorZalouserProvider } = await import("./monitor-rwDiUoV1.js");
