...
import { c as readErrorName, i as formatErrorMessage, r as extractErrorCode } from "./errors-D3K0qXmL.js";
...
import { J as resolveMemoryDreamingWorkspaces, V as formatMemoryDreamingDay, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-mdgo8Jxs.js";
import { p as parseUsageCountedSessionIdFromFileName } from "./artifacts-CAhtFeLv.js";
import { u as resolveStorePath } from "./paths-DE6QEn2i.js";
import { t as loadSessionStore } from "./store-load-BKiPIr-m.js";
import { s as updateSessionStore } from "./store-CSNEKBzE.js";
import { t as RequestScopedSubagentRuntimeError } from "./error-runtime-SIsXIOqW.js";
import "./async-lock-runtime-DWDmBKGm.js";
...
import { c as buildSessionEntry, d as loadSessionTranscriptClassificationForAgent, f as normalizeSessionTranscriptPathForComparison, l as listSessionFilesForAgent, p as sessionPathForFile } from "./engine-qmd-BuXCd3Gc.js";
import "./memory-core-host-engine-qmd-C_cSyvkM.js";
import { n as appendMemoryHostEvent } from "./events-CfKYvDQq.js";
import "./memory-core-host-status-DIxEqMAx.js";
import "./memory-host-events-D13Gn4Tu.js";
import { n as withTrailingNewline, t as replaceManagedMarkdownBlock } from "./memory-host-markdown-BiLGKFxW.js";
import "./dreaming-shared-B-NQXgsB.js";
import { i as filterLiveShortTermRecallEntries, l as recordShortTermRecalls, o as readShortTermRecallEntries, s as recordDreamingPhaseSignals } from "./short-term-promotion-BQ2o4lN4.js";
...
function normalizeSessionIngestionState(raw) {
	...
	if (seenMessagesRaw) for (const [scope, value] of Object.entries(seenMessagesRaw)) {
		...
		const unique = [...new Set(value.filter((entry) => typeof entry === "string"))].map((entry) => entry.trim()).filter(Boolean).slice(-4096);
