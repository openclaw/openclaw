import { p as shouldMigrateStateFromPath } from "./argv-lFfbK1Bo.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-CtkficDD.js")).runDoctorConfigPreflight({
			migrateState: false,
