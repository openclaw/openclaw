...
import { a as saveRemoteMedia, i as readRemoteMediaBuffer } from "./fetch-NvfegT_b.js";
...
import { c as validateUrbitBaseUrl, d as formatTargetHint, f as normalizeShip, h as resolveTlonOutboundTarget, m as parseTlonTarget, p as parseChannelNest, s as normalizeUrbitHostname, u as resolveTlonAccount } from "./setup-core-BSKVcAor.js";
import { t as getTlonRuntime } from "./runtime-B0ffOFfb.js";
import { t as tlonSetupWizard } from "./setup-surface-CbveOOMD.js";
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromSSO } = await import("./dist-cjs-DMtFx63T.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromSSO(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
			const { fromIni } = await import("./dist-cjs-BTrfpT93.js").then((m) => /* @__PURE__ */ __toESM(m.default));
