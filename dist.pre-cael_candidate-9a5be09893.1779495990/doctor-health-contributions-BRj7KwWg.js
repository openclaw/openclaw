...
async function runAuthProfileHealth(ctx) {
	...
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-DIjAAnqa.js");
...
async function runStructuredHealthRepairs(ctx) {
	...
	const { registerCoreHealthChecks } = await import("./doctor-core-checks-DqDcnYz4.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-CJ2_-WQg.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-g3O96cof.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-yUSpTnK1.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-CJ2_-WQg.js");
