...
import { c as isRecord$1 } from "./utils-BlCbsks0.js";
...
import { n as privateFileStoreSync } from "./private-file-store-DMtyjgoc.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-CIwd6x-p.js";
import "./ssrf-runtime-Db7Y0wil.js";
import "./security-runtime-Dqoom-mk.js";
import "./provider-http-Bm_Fu63c.js";
import { t as getMSTeamsRuntime } from "./runtime-api-qRxCpAe5.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-6Gmy7hPl.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-BoRu0Ntq.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DDHqlodv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
