...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CmeoeBvq.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { t as note } from "./note-BhDc7CTR.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-mSTwZnYy.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-Dqw28QDe.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-C-UxiPqe.js");
