...
import { o as modelSelectionShouldEnsureCodexPlugin } from "./openai-codex-routing-W71IKIRp.js";
...
async function ensureCodexRuntimePluginForModelSelection(params) {
	...
	const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-lJnab8dm.js");
...
async function repairCodexRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-C8J7Ktxg.js");
