...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-D3K0qXmL.js";
...
import { t as movePathToTrash } from "./trash-CC_lxxsj.js";
import "./archive-CVz-FUxu.js";
...
import { c as normalizeAgentId, g as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BAP1m9Ju.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default--mMaLHGD.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-Dm11aCiH.js";
import { c as measureDiagnosticsTimelineSpanSync, s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-CTlwxWdt.js";
import { d as writeJson, i as readJsonIfExists, l as tryReadJson } from "./json-files-JsqPi2LG.js";
...
import { a as logWarn, t as logDebug } from "./logger-CeySquHZ.js";
import "./auth-BhFVnN3l.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-B-Qh9oic.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-CmeoeBvq.js";
...
import { t as applyMergePatch } from "./merge-patch-DoSboXNg.js";
import { r as DEFAULT_PROVIDER } from "./defaults-mDjiWzE5.js";
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-LTIAxzAP.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-DuhJvHOE.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-Dr5QVXI9.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-DBEDlM_g.js";
...
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-mdgo8Jxs.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-m7q4-54V.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-DP8t4y4P.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DUT-LIo-.js";
...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-DkcVDKOd.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-l8ncqr2g.js";
import { h as stringifyRouteThreadId } from "./channel-route-L2PJ-xNE.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-Bk0xEm32.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-DE6QEn2i.js";
import { t as loadSessionStore } from "./store-load-BKiPIr-m.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-CbQuetgM.js";
...
import { t as listConfiguredSessionStoreAgentIds } from "./targets-CuuVVnFS.js";
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-BgVGK7Hj.js";
...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-Dve-83S5.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-DRwuLv9x.js";
...
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DCS9L5jY.js";
...
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-BVGrLCTJ.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-yzEvhRf-.js";
import { _ as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-B_letAfx.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-BAPT3_qw.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-CE8tVafH.js";
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-bcOfCe4w.js";
...
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-KeHRzlqb.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-dJsTmt49.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-C4fTjcHn.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-CeYOf0-b.js";
...
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-CpetK3_a.js";
import { l as getTotalQueueSize } from "./command-queue-KkDNdiAZ.js";
import { n as resolveSendPolicy } from "./send-policy-3z39vgG5.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-CIx13YWi.js";
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-BtjXcS4n.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-B_plfZYh.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-Z5Gzh2pj.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-C8KVpHa_.js";
import { o as isTimeoutError } from "./failover-error-VgA84TyW.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-Db3Eq0LY.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-DvSarASC.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-BG6W8l3W.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-CxI-NeVc.js";
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-Dm3O2Zt6.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-CMiAc6gM.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Bn6ApiDa.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-CMMxw89k.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DX0gXkzP.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-55Il_c_r.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-DVGu8Z0h.js";
import "./runtime-internal-Fxexd60h.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-B4MRi1IT.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-BEWRnaSF.js";
import { a as clearSessionQueues } from "./queue-oHnn8GCQ.js";
...
import { i as resolveReplyToMode } from "./reply-threading-VSYbN1Le.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CeNbkptM.js";
...
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-BTPL6ugS.js";
...
import { o as dispatchChannelMessageAction } from "./message-action-runner-cjMT0lGM.js";
import "./target-resolver-lREaVYaQ.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-CXZgmgLf.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DQpX0NNX.js";
import { D as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, c as isTtsEnabled, d as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, k as textToSpeech, l as isTtsProviderConfigured, m as resolveExplicitTtsOverrides, o as getTtsProvider, r as getResolvedSpeechProviderConfig, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-B4YJ_gJS.js";
import "./tts-BgmrI-Of.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Bf8eH3zJ.js";
import "./skills-D-XMsnmT.js";
import { t as canExecRequestNode } from "./exec-defaults-_ZXvHhDj.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-ClPc2Aez.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-CHGxmUoY.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-CLOEGVYk.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-Bl_g0kro.js";
...
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-BNtxf-nu.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-Bpc6UwtE.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-CgDQxlOD.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DYCBfzPN.js";
import "./commands-registry-hZi_82EC.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-CYOlzQJ5.js";
import "./browser-maintenance-CyO5QcHk.js";
...
import { n as listPluginCommands } from "./commands-CXwxWvZQ.js";
import { t as getChannelActivity } from "./channel-activity-eMQlJ3BE.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CNdyNbeX.js";
...
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DG20Wxac.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-DyKNnWpT.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-BMVPfx2x.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-TISBai8a.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-_3z33knD.js";
import { n as agentCommandFromIngress } from "./agent-command-AtghHVIm.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-C7GppvZZ.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-CpHoJmrL.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-DGhrF-u9.js";
import { t as formatForLog } from "./ws-log-0n5NVjco.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-bz_H4P9v.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CSQ2tdy5.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-6R6rlOAz.js";
import { a as getPairedDevice, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-Bz9dQGHs.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-CM7R6Bh7.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-BaNDQNxD.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-C1tmIJp0.js";
import { n as createOutboundSendDeps } from "./deps-rbNI_GRb.js";
import "./agent-BYNRli8E.js";
...
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-oKbHuJTE.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-SGmZCkiR.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-C3jQbD9o.js";
import "./server-constants-BGwLM6XN.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-Cl9vTjGC.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CzLXLhi2.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-JdPenpRZ.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-e8VhsPnW.js";
import { t as loadProviderUsageSummary } from "./provider-usage-DJIXni-d.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-MZtvUNMx.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-P_IgM8CT.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-Bi0_CwNU.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BfDS2RFf.js";
import { t as buildChannelUiCatalog } from "./catalog-D6FxvMRh.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-_z2VgeSC.js";
import { s as normalizeUpdateChannel } from "./update-channels-f-ieRme5.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-9JiP45gQ.js";
import { i as resolveConfigReloadMetadata, t as buildGatewayReloadPlan } from "./config-reload-plan-CRGsLQZD.js";
import { t as readConfiguredLogTail } from "./log-tail-5dNc_mZj.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CYu8bFws.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Vf3XedFC.js";
import { t as buildChannelAccountSnapshot } from "./status-gRUpe-nK.js";
...
import { t as installSkill } from "./skills-install-r0DSsXBA.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-DAnKE3dK.js";
import { r as readPackageVersion } from "./package-json-urNmq0ON.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-Dw53ANFE.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-DxC-Zkag.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-BKQxjJf5.js";
import { t as getStatusSummary } from "./status.summary-UBREBhti.js";
import "./status-BknrGBWc.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-qMNE58qd.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-Cyz6u_AL.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-Ctxc5fzm.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-B0SYBsxh.js";
import { t as diffConfigPaths } from "./config-diff-BFU3KxZv.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-RakHfZZ4.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BCSjTPm-.js";
import "./heartbeat-runner-Bi_Lrua-.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-AYt-ugaJ.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-D7o-65eA.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-Cj1j_O4u.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-D1noYymO.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-DTTj3crT.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-Dr8C928g.js";
...
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-DxDL7PoO.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DW7b38xr.js");
...
function createTalkRealtimeRelaySession(params) {
	...
	const bridge = createRealtimeVoiceBridgeSession({
		...
		onTranscript: (role, text, final) => {
			...
			if (role === "user" && final && text.trim()) bridgeSession?.sendUserMessage(text.trim());
		},
		onToolCall: (toolCall) => {
			const turnId = relay ? ensureRelayTurn(relay) : void 0;
			emit({
