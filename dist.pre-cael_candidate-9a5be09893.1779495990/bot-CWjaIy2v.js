...
import { n as formatModelsAvailableHeader } from "./commands-models-Y0fIsUwA.js";
...
import { i as resolveUnmentionedGroupInboundPolicy, r as classifyChannelInboundEvent, s as shouldDebounceTextInbound } from "./channel-inbound-i3NSe0sJ.js";
...
import { t as createTelegramThreadBindingManager } from "./thread-bindings-BuvZMFcl.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-CsdrANIN.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-JvSLEg5a.js";
import { A as Bot, C as createTelegramClientFetch, E as resolveTelegramOutboundClientTimeoutFloorSeconds, M as sequentialize, O as withTelegramApiErrorLogging, S as asTelegramClientFetch, T as resolveTelegramClientTimeoutSeconds, a as editMessageTelegram, g as recordSentMessage, j as apiThrottler, k as getOrCreateAccountThrottler, w as resolveTelegramClientTimeoutMinimumSeconds, x as buildInlineKeyboard } from "./send-CUHCErsT.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CU-tJK1Q.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as createNativeTelegramToolProgressDraft, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands, t as defaultTelegramBotDeps } from "./bot-deps-DGhhUgO0.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DpJurUbU.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-Dy0EkRu1.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-DNJvmij9.js")).defaultTelegramBotDeps;
