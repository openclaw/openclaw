...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-BM3-Vmz4.js";
...
import { i as setPathExistingStrict } from "./path-utils-CVZNBbsa.js";
import { n as discoverConfigSecretTargets } from "./target-registry-CzmhvqCJ.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CmeoeBvq.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { r as normalizeTalkSection } from "./talk-DuhJvHOE.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-B-1MZcqQ.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BKG3NB6-.js";
import { n as getLoadedChannelPlugin } from "./registry-CbQuetgM.js";
import { i as listRouteBindings } from "./bindings-D1F1bOgs.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, o as listLegacyRuntimeModelProviderAliases, s as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-IZL5NN2g.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-mSTwZnYy.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-BkS1738j.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-CLpdCuyz.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DL3hnWZ8.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-oJqQocAY.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DAZWZuJC.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BHH4wJXf.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-trADo26i.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-ChoG4D8k.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-D7My3CDs.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CZCWSsH4.js");
		emitDoctorNotes({
			note,
