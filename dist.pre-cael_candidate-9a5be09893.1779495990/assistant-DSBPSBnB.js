...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-DtTUxwpC.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-C5jGV9XS.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-DWX8QRYo.js")).runEmbeddedPiAgent;
}
