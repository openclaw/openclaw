...
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-Cxwuuej8.js";
...
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, r as SUBAGENT_SPAWN_CONTEXT_MODES, t as spawnSubagentDirect } from "./subagent-spawn-bcOfCe4w.js";
...
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-CEltzcUr.js";
...
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Ddfy4pzb.js";
import { n as runWithImageModelFallback } from "./model-fallback-C0O7eob0.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-mg9m2z2B.js";
...
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-Dm3O2Zt6.js";
...
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CAuSc0He.js";
...
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-vXfgRQrq.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-C9iB5Jh3.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DbE2u1cl.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-B91x_CeM.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-D8PfhBEn.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-DGvNSGdr.js";
import { s as resolveTimeoutMs } from "./resolve-BK9Forly.js";
import { t as buildProviderRegistry } from "./runner-_VHkH_m3.js";
...
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-DmFT9-5Q.js";
import { p as registerSubagentRun } from "./subagent-registry--1Qcyutj.js";
...
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DOvLzGT8.js";
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-DKeOkFWN.js"));
...
function createOpenClawTools(options) {
	...
	const tools = [
		...
		...resolvedConfig?.agents?.defaults?.continuation?.enabled === true && options?.continueWorkOpts ? [createContinueWorkTool({
			agentSessionKey: options?.agentSessionKey,
			...options.continueWorkOpts
		})] : [],
		...resolvedConfig?.agents?.defaults?.continuation?.enabled === true && options?.drainsContinuationDelegateQueue !== false ? [createContinueDelegateTool({ agentSessionKey: options?.agentSessionKey })] : [],
		...resolvedConfig?.agents?.defaults?.continuation?.enabled === true && options?.requestCompactionOpts ? [createRequestCompactionTool({
			agentSessionKey: options?.agentSessionKey,
			sessionId: options?.sessionId,
			runId: options?.runId,
