...
import { c as isRecord, d as resolveConfigDir, p as resolveUserPath } from "./utils-BlCbsks0.js";
...
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-CTlwxWdt.js";
import { g as resolveInstalledPluginIndexPolicyHash } from "./installed-plugin-index-store-BwMHH1zx.js";
import { r as normalizeChatChannelId } from "./ids-BDkmfqmw.js";
import { l as resolveEffectivePluginActivationState, s as normalizePluginsConfig } from "./config-state-Davgc29h.js";
import { t as isPluginEnabledByDefaultForPlatform } from "./default-enablement-CT7_t1ee.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-B5Hb2fYv.js";
import { c as resolveProviderOwners, p as loadPluginRegistrySnapshot, r as normalizePluginsConfigWithRegistry, s as resolvePluginContributionOwners, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-BBp7PSJC.js";
import { r as withBundledPluginVitestCompat } from "./bundled-compat-Blg9Timk.js";
import { n as collectConfiguredModelRefs } from "./model-refs-C9ywT44I.js";
import { t as getChatChannelMeta } from "./chat-meta-CVABGwsC.js";
import "./registry-DbZhabyH.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-L6rqw6O0.js";
import { i as passesManifestOwnerBasePolicy, n as isActivatedManifestOwner } from "./manifest-owner-policy-D9A5yXj7.js";
import { t as createPluginIdScopeSet } from "./plugin-scope-6HF2N6kz.js";
import { t as collectConfiguredAgentHarnessRuntimes } from "./harness-runtimes-81uXd7WK.js";
import { a as listPotentialConfiguredChannelPresenceSignals } from "./config-presence-DdGlXZbf.js";
import { i as listBundledChannelIdsWithConfiguredState, r as hasBundledChannelConfiguredState, t as isChannelConfigured } from "./channel-configured-BHUUbznI.js";
import { n as resolvePluginSetupAutoEnableReasons } from "./setup-registry-BKG3NB6-.js";
...
function collectConfiguredChannelIds(cfg, env) {
	...
	return listPotentialConfiguredChannelPresenceSignals(cfg, env, { includePersistedAuthState: false }).map((signal) => ({
...
function resolveConfiguredPluginAutoEnableCandidates(params) {
	...
	for (const runtime of collectConfiguredAgentHarnessRuntimes(params.config, params.env, { includeEnvRuntime: false })) {
