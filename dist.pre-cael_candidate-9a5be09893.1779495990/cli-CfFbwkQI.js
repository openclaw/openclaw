...
import { n as matrixSetupAdapter } from "./setup-core-CT8mGrBT.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Dm_YMVFT.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BudaM_7i.js";
import { t as withResolvedActionClient } from "./client-BQ6zhEhJ.js";
import { r as resolveMatrixAuthContext } from "./config-DWhXmy7_2.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DmQtcdRZ.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CXoOHLA5.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-CysSCnI6.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DrNsYqg9.js");
