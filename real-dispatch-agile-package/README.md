...
3. Team executes handoff-by-handoff from `03-Delivery/03-PR-Plan.md` (each drop is reversible with feature flags).
...
- `03-Delivery/` – sprint plan, handoff sequence (bundle/patch), release gates, feature flags
...
- `09-Templates/` – story templates, handoff template, ADR template
