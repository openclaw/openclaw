...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-mZJcSXov.js";
import { t as enablePluginInConfig } from "./enable-De3IcG0G.js";
import "./auth-profiles-CJXJWnnJ.js";
import { o as upsertAuthProfileWithLock } from "./profiles-Q6xn5jgp.js";
...
import { n as openUrl } from "./browser-open-C2XS9-a1.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-XJBi5GJE.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CwkAAcww.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DM1RFmY0.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-BIJG9gjh.js");
		...
		if (codexInstall.installed) {
			const { offerPostInstallMigrations } = await import("./setup.post-install-migration-CwCwfwKx.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-BkBAY2HI.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-Dgkr0Uz2.js");
