import { r as createDeepSeekV4OpenAICompatibleThinkingWrapper, s as createThinkingOnlyFinalTextWrapper } from "./provider-stream-shared-CY-BNuZa.js";
import { n as isMiMoReasoningModelRef } from "./thinking-DaFsqdy3.js";
...
function shouldPromoteMiMoReasoningToVisibleText(model) {
	return model.provider === "xiaomi" && MIMO_REASONING_AS_VISIBLE_TEXT_MODEL_IDS.has(normalizeMiMoModelId(model.id) ?? "");
}
