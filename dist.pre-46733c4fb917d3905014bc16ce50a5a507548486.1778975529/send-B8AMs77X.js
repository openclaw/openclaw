...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-Cel7eNSh.js";
import "./channel-message-D8XpAab3.js";
import "./text-autolink-runtime-CsoUQPFg.js";
import { t as require_src } from "./src-DUFNLu6f.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-C_UXC-0g.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-CQIpM3pT.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-D-vKAZQQ.js";
import { t as fromBuffer } from "./lib-CY3L9GFy.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BXfWZLXd.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BUunIJBK.js";
import { l as toRatio, n as decodeString } from "./Util-Chcdv_nC.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CEfz8sIZ.js";
import { t as APEv2Parser } from "./APEv2Parser-BZxvb96H.js";
import { r as hasID3v1Header } from "./ID3v1Parser-8RLrOf-i.js";
import { i as isStrictDirectRoom } from "./direct-room-u9f8DY95.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-ChrBqWwx.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CLdBoAM6.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-F5c9hOu4.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BMzriRzp.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-nLWkc1Sm.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-pgPSmurz.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BHbiYHOf.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-B0pzz7D3.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-BqMcgjYI.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DCT05WHC.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-vakY-x6n.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BuMc-Ikq.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-zL5ndpkt.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BFYLwuCD.js")).WaveParser;
	}
};
//#endregion
