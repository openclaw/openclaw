...
import { i as setPathExistingStrict } from "./path-utils-D_6cEHNl.js";
import { n as discoverConfigSecretTargets } from "./target-registry-C_EgwiVL.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-DEZ0cwqj.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { r as normalizeTalkSection } from "./talk-CPtS1VKN.js";
import { n as collectConfiguredModelRefs } from "./model-refs-A5kELTdO.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-1v_f6WhL.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-CJXunK6C.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DjHbXB0q.js";
import { n as getLoadedChannelPlugin } from "./registry-DDfKx8qu.js";
import { i as listRouteBindings } from "./bindings-BBw0eiWM.js";
import { i as legacyRuntimeModelAliasRequiresRuntimePolicy, o as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DGv8MJIC.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-6jjbwPxx.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-DVax0xFv.js";
import { t as note } from "./note-COdbCcTu.js";
import { t as asObjectRecord } from "./object-eWEJ72p2.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-Dfj7OGhJ.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-D3JEwrCr.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-B8guo0pu.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BayC5oHS.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BZ0j8usq.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DLrxmhBX.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-XllpeUxD.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BtogYDeG.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-CIgKG5ja.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-C1b_hITE.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-Ckgsm6y2.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-sh8lxNed.js");
		emitDoctorNotes({
			note,
