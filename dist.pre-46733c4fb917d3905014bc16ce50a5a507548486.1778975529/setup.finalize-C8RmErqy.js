...
import { a as isSystemdUserServiceAvailable } from "./systemd-Dd4bTPeJ.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-D5CkWbyc.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-DQdsQNVI.js";
...
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-DDBYmmaY.js";
...
function loadOnboardSearchModule() {
	onboardSearchModulePromise ??= import("./onboard-search-B9nVNNTv.js");
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-C7fsX1mV.js");
