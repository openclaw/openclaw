...
import { t as collectIncludePathsRecursive } from "./includes-scan-C5_biLkq.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-B_-XPmkj.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CIEGx9UU.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-D8Yv2YIi.js");
...
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-X3APttnn.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-GDkYoF10.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-BJQdHClL.js");
