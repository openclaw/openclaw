import { c as readErrorName, i as formatErrorMessage } from "./errors-s6LAmrhz.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-vzMG8R0I.js";
...
import { a as registerSessionMaintenancePreserveKeysProvider, c as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-BCIPYVeV.js";
import { s as updateSessionStore } from "./store-kjdjF6vn.js";
import "./sessions-DwDN2tCH.js";
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-BGvIU76u.js";
import { A as SUBAGENT_ENDED_REASON_KILLED, C as getSubagentSessionStartedAt, D as SUBAGENT_ENDED_OUTCOME_TIMEOUT, E as SUBAGENT_ENDED_OUTCOME_KILLED, M as subagentRuns, O as SUBAGENT_ENDED_REASON_COMPLETE, S as getSubagentSessionRuntimeMs, T as SUBAGENT_ENDED_OUTCOME_ERROR, a as countActiveDescendantRunsFromRuns, b as isStaleUnendedSubagentRun, c as countPendingDescendantRunsFromRuns, f as listDescendantRunsForRequesterFromRuns, j as SUBAGENT_TARGET_KIND_SUBAGENT, k as SUBAGENT_ENDED_REASON_ERROR, l as getSubagentRunByChildSessionKeyFromRuns, n as persistSubagentRunsToDisk, o as countActiveRunsForSessionFromRuns, p as listRunsForControllerFromRuns, r as restoreSubagentRunsFromDisk, t as getSubagentRunsSnapshotForRead, w as resolveSubagentSessionStatus } from "./subagent-registry-state-RMAid_Pv.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-XdJQKbzN.js";
import { a as isSilentReplyText } from "./tokens-DB6BCUEZ.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-CDmE7ioM.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-Bh1w_2Ib.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-C1IypX8J.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-BLItM5jU.js";
import "./pi-bundle-mcp-tools-BB0c2p_S.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-CoHjKAVd.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DefLBZci.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-YyQMc5F8.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DefLBZci.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-BPEvk1k9.js").then(({ scheduleOrphanRecovery }) => {
