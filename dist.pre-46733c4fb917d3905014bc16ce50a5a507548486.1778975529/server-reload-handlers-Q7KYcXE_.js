...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-BdInu8_f.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DNTtOSbx.js";
import { o as resetModelCatalogCache } from "./model-catalog-BRDjhg8Q.js";
import { l as getTotalQueueSize } from "./command-queue-dfFoTj49.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-BgPlXrp1.js";
import { r as resetDirectoryCache } from "./target-resolver-DrQcbm7x.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-BLItM5jU.js";
...
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-Da7aHhlr.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DpOxRez1.js";
...
import { t as buildGatewayCronService } from "./server-cron-DWpJUxBj.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-BLfButXr.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-B3EknrLY.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-tTf-FXkL.js"), import("./gmail-watcher-lifecycle-C6m9ruqU.js")]);
