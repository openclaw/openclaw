...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-JoRJOGxA.js";
...
import { i as createAttachedChannelResultAdapter, t as attachChannelToResult } from "./channel-send-result-DFvyyh_M.js";
import "./retry-runtime-DKYP3Y8C.js";
import { s as resolveDiscordAccount } from "./accounts-C2Kp_t-S.js";
import { m as DiscordError } from "./discord-w-ucGyjV.js";
import { t as chunkDiscordTextWithMode } from "./chunk-D22CfcpB.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-BR3B0vye.js";
import { t as createDiscordSendReceipt } from "./send.receipt-Bd6sbyjx.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-CPPAyyab.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-B0fAfbQJ.js");
...
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-BQO4Pyc6.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-BBdMa47P.js");
