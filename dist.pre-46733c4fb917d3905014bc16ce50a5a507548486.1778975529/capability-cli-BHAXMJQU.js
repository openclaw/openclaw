...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-Bo5OijmI.js";
...
import { r as DEFAULT_PROVIDER } from "./defaults-CWlUbhpa.js";
import { p as normalizeThinkLevel } from "./thinking-C1FXVLZD.js";
import { t as getProviderEnvVars } from "./provider-env-vars-EXbGX905.js";
import "./config-qlJph4Y8.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-BNgXhSMO.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-CpiXisME.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-BsIVN9xl.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-BN8ltVBf.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-Cm1yBhEt.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-By4os6Q4.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DVjhsOz8.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-DX8uTa0m.js";
import "./auth-profiles-CJXJWnnJ.js";
import { n as listProfilesForProvider } from "./profile-list-CL0_x_9s.js";
import { r as loadModelCatalog } from "./model-catalog-BRDjhg8Q.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-CK4iWblW.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CBBJrk9X.js";
import { u as saveMediaBuffer } from "./store-Bd5Fm8ZQ.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-w-OD-dtD.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-sMwby8lS.js";
import "./tts-CjV-QTlt.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-D8ZuL0v-.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-DQdsQNVI.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DIgZIZZb.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Co_pDmpc.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-e_NeX6_s.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-BmHRGL51.js";
...
import { t as collectOption } from "./helpers-Cc_g1e4u.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-CeSHBT3Y.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-DWQ9517W.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-CW6kvlLz.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CRQxmZwd.js");
