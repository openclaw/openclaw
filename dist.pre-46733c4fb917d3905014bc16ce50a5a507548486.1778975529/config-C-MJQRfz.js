...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-CQKyIaU0.js";
import "./ssrf-runtime-DPexcW9I.js";
import "./retry-runtime-DKYP3Y8C.js";
import "./secret-input-runtime-CcWXf71y.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DZDRX_YE.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BW378V6y.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-Cn8-LN0e.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-DsVM25L1.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DdKwIAAt.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-De-8zqzp.js"), import("./logging-BFPR_8ww.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-CtGLyjUo.js").then((credentialsReadModule) => ({
