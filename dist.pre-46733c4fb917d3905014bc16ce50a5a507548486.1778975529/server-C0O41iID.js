...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-P8rEu6uV.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-BUMnYCxU.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-BED9e_wf.js");
