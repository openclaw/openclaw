import { n as BROWSER_REQUEST_GATEWAY_SCOPE, t as BROWSER_REQUEST_GATEWAY_METHOD } from "./browser-gateway-contract-C6BaSu_d.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-XoZxMMdi.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-BXcXQXPO.js");
