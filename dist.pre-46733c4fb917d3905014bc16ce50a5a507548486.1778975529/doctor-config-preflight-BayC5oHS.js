...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-DEZ0cwqj.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { t as note } from "./note-COdbCcTu.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-Dfj7OGhJ.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-89UlXZIQ.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-Cte0Gi0V.js");
