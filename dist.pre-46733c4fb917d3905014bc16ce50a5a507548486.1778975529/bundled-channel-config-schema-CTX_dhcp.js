...
import { u as ToolPolicySchema } from "./zod-schema.agent-runtime-14JSEvLc.js";
import { C as SecretInputSchema, I as requireAllowlistAllowFrom, L as requireOpenAllowFrom, S as RetryConfigSchema, T as SecretRefSchema, a as DmConfigSchema, h as MarkdownConfigSchema, i as ContextVisibilityModeSchema, j as TtsConfigSchema, l as GroupPolicySchema, m as MSTeamsReplyStyleSchema, n as BlockStreamingCoalesceSchema, o as DmPolicySchema, s as ExecutableTokenSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, v as ProviderCommandsSchema, x as ReplyToModeSchema } from "./zod-schema.core-B8KUxx0C.js";
import { t as sensitive } from "./zod-schema.sensitive-DivzVuVs.js";
import { n as ChannelHeartbeatVisibilitySchema, t as ChannelHealthMonitorSchema } from "./zod-schema.channels-ChmAABr3.js";
import "./config-schema-BvWy-UYr.js";
import { n as isValidInboundPathRootPattern } from "./inbound-path-policy-DXQLuy6O.js";
import { t as resolveAccountEntry } from "./account-lookup-CO7XjjRH.js";
import { n as normalizeSlashCommandName, r as resolveCustomCommands, t as normalizeCommandDescription } from "./custom-command-config-Bmfat6ki.js";
import { t as isSafeScpRemoteHost } from "./scp-host-C3nrNtmX.js";
import { z } from "zod";
...
const DiscordVoiceAllowedChannelSchema = z.object({
	guildId: z.string().min(1),
	channelId: z.string().min(1)
}).strict();
const DiscordVoiceRealtimeToolPolicySchema = z.enum([
	"safe-read-only",
	"owner",
	"none"
]);
const DiscordVoiceRealtimeConsultPolicySchema = z.enum(["auto", "always"]);
const DiscordVoiceRealtimeSchema = z.object({
	...
	minBargeInAudioEndMs: z.number().int().min(0).max(1e4).optional(),
	debounceMs: z.number().int().positive().max(1e4).optional(),
	providers: z.record(z.string(), z.record(z.string(), z.unknown()).optional()).optional()
}).strict();
const DiscordVoiceAgentSessionSchema = z.object({
