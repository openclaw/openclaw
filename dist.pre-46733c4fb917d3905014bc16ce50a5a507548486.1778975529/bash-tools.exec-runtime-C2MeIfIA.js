...
import { d as resolveEventSessionKey, m as scopedHeartbeatWakeOptions } from "./session-key-8g_Q03Po.js";
...
import { o as requestHeartbeat } from "./heartbeat-wake-sotqYg9D.js";
import { a as enqueueSystemEvent } from "./system-events-CD806-T7.js";
import { d as markExited, n as appendOutput, p as tail, r as createSessionSlug, t as addSession } from "./bash-process-registry-CBDKNFPh.js";
import { c as readEnvInt, i as clampWithDefault, r as chunkString, t as buildDockerExecArgs } from "./bash-tools.shared-CPHXFZxI.js";
import { E as resolveExecApprovalAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-in561jOt.js";
import "./bash-tools.schemas-yJjB17DM.js";
import { n as getShellConfig, r as sanitizeBinaryOutput } from "./shell-utils-46AkvrhG.js";
import { n as findPathKey, r as mergePathPrepend } from "./path-prepend-CYwh02Ba.js";
import { t as getProcessSupervisor } from "./supervisor-B_C8DJ6W.js";
...
function maybeNotifyOnExit(session, status) {
	...
	if (!isSubagentSessionKey(sessionKey)) requestHeartbeat(scopedHeartbeatWakeOptions(sessionKey, {
		source: "exec-event",
		intent: "event",
		reason: "exec-event",
		coalesceMs: 0
