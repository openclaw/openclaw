...
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-62uaeTn0.js";
...
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-DEZ0cwqj.js";
...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-C1FXVLZD.js";
...
import { o as transformConfigFileWithRetry } from "./mutate-9b4cZaiQ.js";
...
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-CnnAgKXd.js";
import { i as callGateway } from "./call-BN8ltVBf.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-BdInu8_f.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-Bhbacmu2.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-DEy_pmBW.js";
import { t as loadSessionStore } from "./store-load-BCIPYVeV.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-DDfKx8qu.js";
import { s as updateSessionStore } from "./store-kjdjF6vn.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-CwUH9CaF.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-T1_slPRp.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-D5Thukkn.js";
...
import "./diagnostic-3MOa2HgV.js";
import { h as replyRunRegistry } from "./run-state-DNTtOSbx.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-RsYNbdo_.js";
import { a as getActiveEmbeddedRunSnapshot, d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary, o as isEmbeddedPiRunActive, p as resolveActiveEmbeddedRunSessionId } from "./runs-CzQ1z7Ri.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BDMeLOeE.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CR_pWGmY.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BZ3WJj9F.js";
...
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-DJSdhJBp.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-D3PqtYqB.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-DhvCByXL.js";
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-BFy2QjiW.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-DW14-Yb6.js";
import { t as formatDurationCompact } from "./format-duration-DZ82gs_B.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-CBDKNFPh.js";
...
import { i as resolveReplyToMode } from "./reply-threading-Ara1l3k5.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-D_ZmBZUK.js";
import { a as clearSessionQueues } from "./queue-km-1IxD-.js";
import { n as routeReply } from "./route-reply-BdtZ5FAG.js";
import { r as getSessionBindingService } from "./session-binding-service-BCyhY_kj.js";
import { a as isCompactionSkipReason } from "./request-compaction-tool-BGXIat9p.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, a as getTtsMaxLength, b as setLastTtsAttempt, c as isSummarizationEnabled, f as listTtsPersonas, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, w as setTtsMaxLength, x as setSummarizationEnabled } from "./tts-runtime-sMwby8lS.js";
import "./tts-CjV-QTlt.js";
import { i as selectAgentHarness, n as resolveAvailableAgentHarnessPolicy } from "./selection-BPIjL3EG.js";
...
import { a as stripToolResultDetails } from "./session-transcript-repair-BX7prr1c.js";
import "./sandbox-BoIX-oUx.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-C9sSmyfI.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-DnPW45Zn.js";
import { n as formatTimeAgo } from "./format-relative-BLNvqgYu.js";
import { r as resolveModelWithRegistry } from "./model-2X0H0PHz.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-Co_pDmpc.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-DOgqA0CX.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-Cz4nEtpH.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CGNBuIUK.js";
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-bl5s_Koy.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-DC2bIsF3.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-Cwxr0cr-.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-CNW9L3cG.js";
import { n as parseActivationCommand } from "./group-activation-BzfinpW1.js";
import { t as resolveFastModeState } from "./fast-mode-DiyHHInD.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-8PTgugU4.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CoNN75P3.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-6z7PTOOM.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DtPlfXDZ.js";
import { t as extractBtwQuestion } from "./btw-command-gdmJsZKD.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-0USVxkZ0.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-C2-R9MGq.js";
import { t as handleAcpCommand } from "./commands-acp-D4vIFh8v.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BD2sj5_Y.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DLG3vnMF.js";
import { r as handleModelsCommand } from "./commands-models-D9XeAbqi.js";
import { r as createExecTool } from "./bash-tools-B0llZILh.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-lcSNx8yA.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-TJHpIUsW.js";
import { t as buildToolsMessage } from "./status-6_O-MA0A.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-BVet0xVt.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-5KsAFc5D.js";
import "./command-export-PQBtdczh.js";
import { t as buildStatusReply } from "./commands-status-B5FboMsZ.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-CX_3ebAv.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-5LY-6Uzv.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-BIPVlbN5.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-D47dIgAB.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-CxLA2aHX.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-QJKcMN0x.js";
import "./clawhub-D8TfLBBD.js";
import { r as installPluginFromClawHub } from "./clawhub-CZ8cCvyP.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-DpOQk0AW.js";
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-XqR2LHkc.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-B0YUVEG1.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-fBox5tW5.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-Bl_FXyiG.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-BKQhhzbK.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-Y1yrKh0F.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-BoUC5UsN.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-CsB-CvfG.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-CDL9Hou7.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-BicYPkPS.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-BjuqquTP.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-C6CXgX2B.js"));
