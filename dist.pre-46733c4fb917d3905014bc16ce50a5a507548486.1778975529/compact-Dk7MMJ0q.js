...
import { f as resolveRunModelFallbacksOverride, m as resolveSessionAgentIds } from "./agent-scope-TPiFaS6U.js";
import { a as isSubagentSessionKey, i as isCronSessionKey } from "./session-key-utils-bmH32UOR.js";
import { a as resolveAgentDir } from "./agent-scope-config-Bo5OijmI.js";
...
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-Dy-EZZ0v.js";
import { c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-Bhbacmu2.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C47T0fnH.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BKJ-nvQH.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-CusRtRWS.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-D5Thukkn.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as resolveModelAuthMode } from "./model-auth-Bdn-DOwA.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-XySEDvGv.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BDMeLOeE.js";
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-D-27q0l1.js";
import { f as ensureSessionHeader, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-DJSdhJBp.js";
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-BAPYZ8Ia.js";
import { n as resolveEmbeddedCompactionTarget, r as listActiveProcessSessionReferences } from "./compaction-runtime-context-BGwxif8G.js";
import { t as log } from "./logger-D9NrUrWq.js";
import { a as TranscriptFileState, c as writeTranscriptFileAtomic, s as readTranscriptFileState } from "./context-engine-maintenance-DFbJRiLg.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-ZHwAjAt-.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-CwJ_WjRt.js";
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-B9AYTMuP.js";
import { r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BlEcOjWH.js";
import { n as extractModelCompat } from "./provider-model-compat-B8Ufait7.js";
import { i as formatUnknownCompactionReasonDetail, o as resolveCompactionFailureReason, r as classifyCompactionReason, s as createCompactionDiagId } from "./request-compaction-tool-BGXIat9p.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-CwpIk5jq.js";
import "./pi-bundle-mcp-tools-BB0c2p_S.js";
import { A as getHistoryLimitFromSessionKey, B as repairSessionFileIfNeeded, C as resolveEmbeddedRunSkillEntries, D as sanitizeSessionHistory, E as createEmbeddedPiResourceLoader, F as consumeCompactionSafeguardCancelReason, H as collectRuntimeChannelCapabilities, I as setCompactionSafeguardCancelReason, L as compactWithSafetyTimeout, M as buildEmbeddedExtensionFactories, N as hasMeaningfulConversationContent, O as validateReplayTurns, P as isRealConversationMessage, R as resolveCompactionTimeoutMs, S as resolveEmbeddedAgentStreamFn, T as trackSessionManagerAccess, _ as toSessionToolAllowlist, at as isReasoningTagProvider, b as createSystemPromptOverride, d as shouldRotateCompactionTranscript, f as dedupeDuplicateUserMessagesForCompaction, g as collectRegisteredToolNames, h as collectAllowedToolNames, j as limitHistoryTurns, k as buildEmbeddedMessageActionDiscoveryInput, l as rotateTranscriptAfterCompaction, m as mapThinkingLevel, p as flushPendingToolResultsAfterIdle, v as applySystemPromptOverrideToSession, w as prewarmSessionFile, x as resolveEmbeddedAgentBaseStreamFn, y as buildEmbeddedSystemPrompt, z as guardSessionManager } from "./selection-BPIjL3EG.js";
import { t as getMachineDisplayName } from "./machine-name-CaB6VM6e.js";
import { a as resolveBootstrapContextForRun, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-DZkhv5dO.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-CyX_VDK6.js";
import { S as supportsModelTools } from "./attempt.tool-run-context-B2uPEvXQ.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-dVOKWfK6.js";
import { _ as createPreparedEmbeddedPiSettingsManager } from "./preemptive-compaction-7iRTlwQp.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CRWg9aTv.js";
import { t as splitSdkTools } from "./tool-split-B5ZMK47V.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DZJhUziu.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-BX7prr1c.js";
import { o as resolveSandboxContext } from "./sandbox-BoIX-oUx.js";
import { t as detectRuntimeShell } from "./shell-utils-46AkvrhG.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-FqDufqpo.js";
import { s as resolveSkillsPromptForRun } from "./workspace-Dp51rRUB.js";
import "./skills-C6lRUAM_.js";
import { n as resolveSystemPromptOverride } from "./system-prompt-report-C9sSmyfI.js";
import { t as applyExtraParamsToAgent } from "./extra-params-BwvmU-ls.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-_95hOV-p.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-DY-39mVW.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-TUchsRP-.js";
