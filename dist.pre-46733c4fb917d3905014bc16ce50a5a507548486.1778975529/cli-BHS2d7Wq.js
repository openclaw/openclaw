...
import { n as matrixSetupAdapter } from "./setup-core-BfJ3u3Fw.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-BrLY-5i6.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BKk5zTZt.js";
import { t as withResolvedActionClient } from "./client-BJgezm2_.js";
import { r as resolveMatrixAuthContext } from "./config-C-MJQRfz.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CYRE_U2u.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-kkkXopN2.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-BLKw6QNz.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BdULxrnD.js");
