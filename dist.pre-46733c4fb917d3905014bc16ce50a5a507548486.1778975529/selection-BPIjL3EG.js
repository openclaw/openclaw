...
import { a as redactSensitiveFieldValueWithConfig, n as isSensitiveFieldKey, r as redactSecrets, u as redactToolPayloadTextWithConfig } from "./redact-CDZ_xiJS.js";
...
import { a as getActiveDiagnosticTraceContext, i as freezeDiagnosticTraceContext, n as createDiagnosticTraceContext, r as formatDiagnosticTraceparent, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-B7EOHOXE.js";
...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-B-vaf_Ek.js";
import { a as hasInterSessionUserProvenance, i as applyInputProvenanceToUserMessage, r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-D0YvQQYE.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-Dy-EZZ0v.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C47T0fnH.js";
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-DXbSRFId.js";
import { T as getCompactionProvider } from "./loader-DB28p1_b.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-DJvpj0z6.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BKJ-nvQH.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-DwZ8VkSL.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-CAETmZ4X.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-vzMG8R0I.js";
import { u as resolveStorePath } from "./paths-DEy_pmBW.js";
import { A as resolveCacheTtlMs, D as createExpiringMapCache, k as isCacheEnabled, t as loadSessionStore } from "./store-load-BCIPYVeV.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-CPhtBFBp.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-kjdjF6vn.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DVjhsOz8.js";
import { u as redactTranscriptMessage } from "./transcript-T1_slPRp.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CyQVdiNm.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-Z4Kji8I-.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-Dm3-6KYF.js";
import { t as sanitizeForConsole } from "./console-sanitize-BldJLSVd.js";
import { u as resolveModelAuthMode } from "./model-auth-Bdn-DOwA.js";
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-CzQ1z7Ri.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-XySEDvGv.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CEtbOvRY.js";
...
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-l5OrXvqy.js";
import { t as stableStringify } from "./stable-stringify-Bw33vCOG.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-qL_fcg_p.js";
import { C as firstEnumerableOwnKeys, S as boundedJsonUtf8Bytes, T as jsonUtf8BytesOrInfinity, _ as stripInternalMetadataForDisplay } from "./session-utils.fs-D278wvn8.js";
...
import { d as stripRuntimeContextCustomMessages, l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-CO_U71MJ.js";
...
import { a as stripDowngradedToolCallText, d as findFinalTagMatches, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-CQYFU2zN.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-CHfSyeze.js";
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-BMrD9mkX.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DB6BCUEZ.js";
import { u as stripHeartbeatToken } from "./heartbeat-Ca4uwtdE.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-CPO939vI.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-C9q0yWVh.js";
import { n as extractToolResultId, o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-Dyw_VY4J.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-D3PqtYqB.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-C_Q-5cN_.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-JoRJOGxA.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-DhvCByXL.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-yGPs4wE0.js";
import { a as isTimeoutError } from "./failover-error-BAPYZ8Ia.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-BGwxif8G.js";
import { t as log$5 } from "./logger-D9NrUrWq.js";
import { a as TranscriptFileState, c as writeTranscriptFileAtomic, l as getRawSessionAppendMessage, s as readTranscriptFileState, t as runContextEngineMaintenance, u as setRawSessionAppendMessage } from "./context-engine-maintenance-DFbJRiLg.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-ZHwAjAt-.js";
import { D as isEmbeddedMode, d as resolveToolLoopDetectionConfig, m as stripProviderPrefix, p as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-DwiSH98e.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-DmUnGM3r.js";
import { i as getPluginToolMeta } from "./tools-DTaS5GqW.js";
...
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, v as resolveChannelPromptCapabilities, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-B9AYTMuP.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-D5hlpdwY.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-DXFkxE4S.js";
import { c as hasCommittedMessagingToolDeliveryEvidence, l as hasMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-CGe721s1.js";
...
import { d as buildTextObservationFields, u as buildApiErrorObservationFields } from "./model-fallback-BlEcOjWH.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-D5CkWbyc.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-B8Ufait7.js";
import { r as parseFenceSpans } from "./fences-V6fGek--.js";
import { r as splitMediaFromOutput } from "./parse-DLbSnhEr.js";
...
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./pi-tools.policy-DvjUgweE.js";
import { D as formatToolAggregate } from "./channel-streaming-DCwRXYZw.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-DYziGTTS.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-BGXIat9p.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-BLItM5jU.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-CwpIk5jq.js";
import "./pi-bundle-mcp-tools-BB0c2p_S.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BSLFv0Tt.js";
import { n as buildSubagentList } from "./subagent-list-DdOzq45O.js";
import { o as listControlledSubagentRuns } from "./subagent-control-DmIT74S3.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-BccmhdLM.js";
...
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-DbYgKaLh.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-LLgGOCbM.js";
...
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CVErfu9-.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-BGJEF4Pd.js";
import { d as parseBooleanValue } from "./frontmatter-D1xxEJfr.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DZkhv5dO.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-CyX_VDK6.js";
import { S as supportsModelTools, _ as sanitizeToolArgs, a as logAgentRuntimeToolDiagnostics, b as isMessagingTool, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, i as shouldAllowProviderOwnedThinkingReplay, l as runAgentCleanupStep, m as filterToolResultMediaUrls, n as createAgentToolResultMiddlewareRunner, o as normalizeAgentRuntimeTools, p as extractToolResultText$1, r as resolveTranscriptPolicy, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as sanitizeToolResult, x as isMessagingToolSendAction, y as collectTextContentBlocks } from "./attempt.tool-run-context-B2uPEvXQ.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-dVOKWfK6.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-DiJZ3GLJ.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CX0muS23.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-7iRTlwQp.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CRWg9aTv.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-B5ZMK47V.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-DZJhUziu.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-WoLVXquE.js";
import { s as buildCopilotIdeHeaders } from "./provider-auth-BdVaafmp.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-CjQFg5vN.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-BX7prr1c.js";
import { o as resolveSandboxContext } from "./sandbox-BoIX-oUx.js";
import { t as detectRuntimeShell } from "./shell-utils-46AkvrhG.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-FqDufqpo.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-Dp51rRUB.js";
import "./skills-C6lRUAM_.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-C9sSmyfI.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-37LP54uS.js";
import "./tool-loop-detection-D-aEat27.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./proxy-stream-wrappers-CUJwtMeM.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BwvmU-ls.js";
...
import { t as extractSections } from "./post-compaction-context-Cf2IBAfG.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-CucygoJ6.js";
import "./query-B3Cx-UdN.js";
...
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-G7-PpSup.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-Bq6YDEqR.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CFSOQxtx.js";
import { t as detectAndLoadPromptImages } from "./images-DxhM757b.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentTurnPrompt } from "./runtime-context-prompt-DOLUaH-i.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-2cRvIIZu.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-DshT1Fz6.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-D0Xzq4ZO.js"));
...
function shouldApplyNonVisibleTurnRetryGuard(params) {
	...
	if (normalizeLowercaseStringOrEmpty(params.modelApi ?? "") === "openai-completions" || normalizeLowercaseStringOrEmpty(params.modelApi ?? "") === "anthropic-messages") return true;
		...
		try {
			...
			if (cacheObservabilityEnabled) {
				if (cacheBreak) {
					...
					log$5.warn(`[prompt-cache] cache read dropped ${cacheBreak.previousCacheRead} -> ${cacheBreak.cacheRead} for ${params.provider}/${params.modelId} via ${streamStrategy}; ${changeSummary}`);
...
//#endregion
export { resolveReplayInvalidFlag as $, getHistoryLimitFromSessionKey as A, repairSessionFileIfNeeded as B, resolveEmbeddedRunSkillEntries as C, sanitizeSessionHistory as D, createEmbeddedPiResourceLoader as E, consumeCompactionSafeguardCancelReason as F, isLikelyExecutionAckPrompt as G, collectRuntimeChannelCapabilities as H, setCompactionSafeguardCancelReason as I, resolveEmptyResponseRetryInstruction as J, resolveAckExecutionFastPathInstruction as K, compactWithSafetyTimeout as L, buildEmbeddedExtensionFactories as M, hasMeaningfulConversationContent as N, validateReplayTurns as O, isRealConversationMessage as P, resolveReasoningOnlyRetryInstruction as Q, resolveCompactionTimeoutMs as R, resolveEmbeddedAgentStreamFn as S, trackSessionManagerAccess as T, STRICT_AGENTIC_BLOCKED_TEXT as U, buildUsageWithNoCost as V, extractPlanningOnlyPlanDetails as W, resolvePlanningOnlyRetryInstruction as X, resolveIncompleteTurnPayloadText as Y, resolvePlanningOnlyRetryLimit as Z, toSessionToolAllowlist as _, createEmbeddedRunStageTracker as a, isReasoningTagProvider as at, createSystemPromptOverride as b, resolveBootstrapMode as c, shouldRotateCompactionTranscript as d, resolveRunLivenessState as et, dedupeDuplicateUserMessagesForCompaction as f, collectRegisteredToolNames as g, collectAllowedToolNames as h, selectAgentHarness as i, observeReplayMetadata as it, limitHistoryTurns as j, buildEmbeddedMessageActionDiscoveryInput as k, rotateTranscriptAfterCompaction as l, mapThinkingLevel as m, resolveAvailableAgentHarnessPolicy as n, shouldTreatEmptyAssistantReplyAsSilent as nt, formatEmbeddedRunStageSummary as o, createTrajectoryRuntimeRecorder as ot, flushPendingToolResultsAfterIdle as p, resolveAttemptReplayMetadata as q, runAgentHarnessAttempt as r, createEmbeddedRunReplayState as rt, shouldWarnEmbeddedRunStageSummary as s, maybeCompactAgentHarnessSession as t, resolveSilentToolResultReplyPayload as tt, rotateTranscriptFileAfterCompaction as u, applySystemPromptOverrideToSession as v, prewarmSessionFile as w, resolveEmbeddedAgentBaseStreamFn as x, buildEmbeddedSystemPrompt as y, guardSessionManager as z };
