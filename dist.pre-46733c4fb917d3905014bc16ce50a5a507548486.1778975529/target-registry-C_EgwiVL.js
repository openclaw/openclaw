...
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-Dev8PLWv.js";
import { n as loadChannelSecretContractApiForRecord, t as loadChannelSecretContractApi } from "./channel-contract-api-B4sDPKrH.js";
import { i as parseDotPath } from "./shared-DlgDffIw.js";
import { n as getPath } from "./path-utils-D_6cEHNl.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BBmdLzbm.js";
...
function loadSecretTargetRegistryFromPluginMetadata(params) {
	const plugins = (params.preferPersisted === false ? void 0 : getCurrentPluginMetadataSnapshot({
		config: {},
		env: params.env
	}))?.plugins ?? loadPluginMetadataSnapshot({
		config: {},
		env: params.env,
