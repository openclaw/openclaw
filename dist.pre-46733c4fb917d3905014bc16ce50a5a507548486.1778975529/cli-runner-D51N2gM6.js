...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BKJ-nvQH.js";
import "./tokens-DB6BCUEZ.js";
import "./pi-embedded-helpers-DJSdhJBp.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-C9q0yWVh.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-yGPs4wE0.js";
import { i as loadCliSessionHistoryMessages, o as buildAgentHookConversationMessages, r as loadCliSessionContextEngineMessages } from "./session-history-0GoQEt98.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-BAPYZ8Ia.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-DbYgKaLh.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-BRAvdVMI.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-1VXla40O.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-DWSX9KrP.js");
