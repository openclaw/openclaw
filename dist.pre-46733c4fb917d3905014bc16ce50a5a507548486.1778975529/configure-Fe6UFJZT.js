...
import { t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-Cnwfh6dH.js";
...
import { g as shortenHomePath, p as resolveUserPath, x as isPlainObject } from "./utils-CpmNtyoq.js";
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-Co1lNtpa.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-CeHM4gAn.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-Dd4bTPeJ.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-Ci4lmHvH.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-6GBG3wLv.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-C3QdL7i6.js";
import { a as findTailscaleBinary } from "./tailscale-CFiIAyu8.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-DEZ0cwqj.js";
import { t as sanitizeTerminalText } from "./safe-text-C1oixi3E.js";
import { t as ConfigMutationConflictError } from "./mutate-9b4cZaiQ.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-MOHMpLQC.js";
import { t as randomToken } from "./random-token-1OS4kY7r.js";
import "./config-qlJph4Y8.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BlQbMiAz.js";
import { o as formatPortRangeHint } from "./error-format-Gu3TyUrf.js";
import { n as listChatChannels } from "./chat-meta-hBBI7F2O.js";
import { t as resolveControlUiLinks } from "./control-ui-links-DGlh4agS.js";
import { n as ensureAuthProfileStore } from "./store-Cm1yBhEt.js";
import "./auth-profiles-CJXJWnnJ.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-BJcOcOZC.js";
import "./workspace-D5CkWbyc.js";
import { r as withProgress } from "./progress-Ba4gvSqF.js";
import { t as WizardCancelledError } from "./prompts-Ck_pZJ0x.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-D4MfQYqz.js";
import { t as note$1 } from "./note-COdbCcTu.js";
import { t as createClackPrompter } from "./clack-prompter-TZoQSf4O.js";
import { n as logConfigUpdated } from "./logging-CreUz0fy.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-cxZgCTYZ.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-DDBYmmaY.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-B_6LI6O-.js";
import { n as applyAuthChoice } from "./auth-choice-BQPYVerF.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-IvC0dbgf.js";
import { i as setupChannels } from "./onboard-channels-B5Yyngl9.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DAcLsIsu.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-CphQztFu.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-ceb-Jy-M.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-B3rg29Hb.js";
import { t as applyPrimaryModel } from "./provider-model-primary-556HXvrQ.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-hmLxHycS.js";
import { t as promptCustomApiConfig } from "./onboard-custom-DhjFriMq.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-C4dF1S-5.js";
import { n as formatHealthCheckFailure } from "./health-format-CzVOlkTv.js";
import { n as healthCommand } from "./health-Dl_6OG7s.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-Da-hfmno.js";
import { t as setupSkills } from "./onboard-skills-C4kqW50j.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-BkBAY2HI.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-CizPl_PU.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Br7Yrvf8.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-B9nVNNTv.js");
	...
	try {
		...
		if (opts.sections) {
			...
			if (!selected || selected.length === 0) {
				outro$1("No configuration changes selected.");
				return;
			}
