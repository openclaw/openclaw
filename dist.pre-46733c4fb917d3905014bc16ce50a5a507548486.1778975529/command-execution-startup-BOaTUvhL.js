...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-BTQCN78O.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DylNFGeo.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-CmtD1Uay.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-DDipamhl.js");
	if (params.argv) {
