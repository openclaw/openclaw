...
import { u as isPrivateIpAddress } from "./ssrf-DkFiPZ53.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-BMs_6cJp.js";
import { m as readProviderJsonResponse } from "./provider-http-errors-CUUE1los.js";
import "./string-coerce-runtime-Dpi9hISx.js";
import "./secret-input-BZT0kvls.js";
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-CQKyIaU0.js";
import "./ssrf-runtime-DPexcW9I.js";
import "./security-runtime-DB3pIkn0.js";
import "./provider-http-XrTfNfZH.js";
import { t as getMSTeamsRuntime } from "./runtime-api-DCQcgxsX.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-CmvW1_ec.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-CiOeas_7.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-8BLpg1Zc.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DbxUHZA2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-BwC7DZBp.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
