...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-DGpsQ45g.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-Btn1csDe.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-Drvd6qXd.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-BIpDuCO6.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-C2Kp_t-S.js";
import "./channel-api-CfiosZEB.js";
import { t as parseDiscordTarget } from "./target-parsing-43PoAqdv.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-BAw3RO8x.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-BR3B0vye.js";
import { t as getDiscordRuntime } from "./runtime-DiGTztd9.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-5f6BUaQ7.js";
import { t as getDiscordApprovalCapability } from "./approval-native-DshuCQd3.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-CAk2nA6p.js";
import { t as discordMessageActions$1 } from "./channel-actions-C0rAqoXX.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-D8eljpL1.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BDR4B6yv.js";
import { n as discordOutbound } from "./outbound-adapter-DrO31rBy.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-CSJWyz77.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-CPjv6vqR.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-6qa71WzY.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-sIf6rtwK.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BjtMKnNu.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-D7AK6NXd.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-CEafzLJs.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-BA0936iA.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CVkDFbRy.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-BQO4Pyc6.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DoFtjSwZ.js");
