...
import { D as collectPluginSchemaMetadata, E as collectChannelSchemaMetadata, O as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-DEZ0cwqj.js";
import { t as OpenClawSchema } from "./zod-schema-BwPTb6yW.js";
import { t as sensitive } from "./zod-schema.sensitive-DivzVuVs.js";
import "./config-qlJph4Y8.js";
import { r as isSensitiveUrlConfigPath, t as SENSITIVE_URL_HINT_TAG } from "./redact-sensitive-url-DpCYK39u.js";
import { a as isSensitiveConfigPath } from "./redact-snapshot-xZe91Gj0.js";
...
const FIELD_HELP = {
	...
	"messages.groupChat.ambientTurns": "Controls how unmentioned always-on group chatter is submitted. \"user_request\" keeps legacy request semantics; \"room_event\" submits it as quiet context where visible output requires the message tool.",
	"messages.groupChat.visibleReplies": "Overrides visible source replies for group/channel conversations. Defaults to \"message_tool\" when no global visible reply policy is set. \"message_tool\" requires message(action=send) for room output and keeps normal final text private. \"automatic\" posts normal replies as before.",
