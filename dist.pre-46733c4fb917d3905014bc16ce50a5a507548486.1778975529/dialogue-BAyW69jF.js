import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-CxL4tbN-.js";
import { r as loadCrestodianOverview } from "./overview-Cbm0CFZT.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-BgHeW3mh.js")).planCrestodianCommand)({
		input,
		overview
	});
