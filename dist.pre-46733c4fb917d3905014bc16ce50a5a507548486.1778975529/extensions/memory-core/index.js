...
import "../../memory-core-host-runtime-core-BnXUN3GD.js";
import { t as resolveMemoryBackendConfig } from "../../backend-config-C06xeEP_.js";
import "../../memory-core-host-runtime-files-DEvi6KR5.js";
import { t as registerShortTermPromotionDreaming } from "../../dreaming-BbZ3mbyo.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-BtlPllnI.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-D3MayzW4.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-6J7bK9zX.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-e4KdoE3n.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-Jwtp3D2-.js");
