...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-BwQHpUYD.js";
...
import { a as formatMissingPluginMessage } from "./error-format-Gu3TyUrf.js";
import { u as quietPluginJsonLogger } from "./plugins-command-helpers-CxLA2aHX.js";
...
async function runPluginsInspectCommand(id, opts) {
	const { buildAllPluginInspectReports, buildPluginDiagnosticsReport, buildPluginInspectReport, buildPluginSnapshotReport, formatPluginCompatibilityNotice } = await import("./status-FAwjTWmx.js");
	const { loadInstalledPluginIndexInstallRecords } = await import("./installed-plugin-index-records-CpqAzv-S.js");
