...
import { t as normalizeEmbeddedAgentRuntime } from "./runtime-pgtcC-aT.js";
...
function resolveSelectedOpenAIPiRuntimeProvider(params) {
	...
	return isOpenAIProvider(params.provider) && runtime === "pi" && !params.authProfileId?.trim() && configuredOpenAIAuthOrderStartsWithCodexProfile(params.config) ? OPENAI_CODEX_PROVIDER_ID : params.provider;
}
