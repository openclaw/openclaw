...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-BegxNRAi.js";
import "./client-BVmyKr7r.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-Bv6azu2O.js";
import { c as parseIMessageTarget } from "./targets-2wcAALX2.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-C-rCnlIy.js";
import "./probe-IGTqXxBG.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-TFMt6gn8.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-Dq-fV1a2.js");
