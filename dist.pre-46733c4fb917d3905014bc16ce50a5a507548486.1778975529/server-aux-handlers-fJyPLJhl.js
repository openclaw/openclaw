...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-BM3Y5Rmt.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-CwUH9CaF.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-in561jOt.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-BgPlXrp1.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-CHah_SDo.js";
...
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-1mxI2950.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-s9QUNq-y.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-Dkv29xwL.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-cl1W4DAj.js";
...
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DcuN2b4x.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-ClCZEUlE.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-SL-i7wGe.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-GiHmoQ9t.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
