...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-opnuz2Ac.js";
import { i as runExec } from "./exec-B4GLUjjd.js";
import { t as resolveSystemBin } from "./resolve-system-bin-BQBmipp5.js";
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-UTxfCoui.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-XUFjI8Hn.js";
import { t as describeImageWithModel } from "./image-runtime-BHeJMtTx.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-w-OD-dtD.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-B3cbFsPN.js";
import { n as providerOperationRetryConfig } from "./operation-retry-BgM_MfXf.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CTTV-W69.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-6Ak1Lnay.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-BRvDT632.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
