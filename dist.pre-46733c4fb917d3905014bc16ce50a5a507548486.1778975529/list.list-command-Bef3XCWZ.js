...
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-Bhbacmu2.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-Bdn-DOwA.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-Cq0CGj9i.js";
import { n as loadModelsConfigWithSource } from "./load-config-sL_l6OO1.js";
import { n as formatErrorWithStack } from "./list.errors-BqHtUAXl.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-CUN16Lpa.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-CTYwVeue.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-ChjNlR0O.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-LoTe93jG.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BivkKIXF.js"),
		import("./agent-scope-CIEGx9UU.js"),
		import("./workspace-DqLM1eXO.js")
	]);
