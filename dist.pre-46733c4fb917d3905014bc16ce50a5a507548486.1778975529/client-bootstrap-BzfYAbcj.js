...
import { t as getActiveMatrixClient } from "./active-client-DZDI3cBM.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DkwNkGhv.js"), import("./shared-DD5ueCLQ.js")]).then(([clientModule, sharedModule]) => ({
