...
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-Bhbacmu2.js";
...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-Bdn-DOwA.js";
import { r as loadModelCatalog } from "./model-catalog-BRDjhg8Q.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-jf1a470J.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-Y_pzanwW.js";
import "./provider-auth-choice-preference-IvC0dbgf.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-BPL7m95c.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-DP_brg4g.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-CC_M2osP.js");
