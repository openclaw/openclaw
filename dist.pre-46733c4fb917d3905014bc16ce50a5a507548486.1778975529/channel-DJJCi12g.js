import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, l as normalizeOptionalStringifiedId } from "./string-coerce-LndEvhRk.js";
import { c as parseThreadSessionSuffix } from "./session-key-utils-bmH32UOR.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-CizCAL9z.js";
import { _ as readStringParam, a as createActionGate, n as ToolAuthorizationError, p as readNumberParam } from "./common-DXFkxE4S.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-D_ZmBZUK.js";
import "./string-coerce-runtime-Dpi9hISx.js";
import { n as describeAccountSnapshot } from "./account-helpers-DFpT05P7.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-CCFlZMGl.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-D3B0oqI3.js";
import "./channel-core-BmrfpPfu.js";
import "./routing-DFB_CNqX.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-DZVnEADB.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-De-BK0_Q.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-zR3EhzS0.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-30WO8fIV.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-CHP5kCxk.js";
import "./approval-delivery-runtime-BXByFKVA.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-nzZVsTvU.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-Cfjnm0YF.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-CiCuhAsK.js";
import "./approval-native-runtime-B2muhBHu.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Drvd6qXd.js";
import "./channel-status-7KUVffLE.js";
import "./channel-actions-DPYm_-L9.js";
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-D8XpAab3.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-DDbNNRH5.js";
import "./session-store-runtime-p53qxoSs.js";
import { t as extractToolSend } from "./tool-send-I8o5FKOq.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-C_UXC-0g.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-DMqhq4Yt.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-DZDRX_YE.js";
import { a as resolveMatrixAccountConfig } from "./account-config-Cn8-LN0e.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CJ7ckiyf.js";
import { n as normalizeMatrixUserId } from "./allowlist-D4tMTIu9.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-Bj6QL8OR.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-DpmUYUK8.js";
import { t as formatMatrixErrorMessage } from "./errors-Dg-q7S7M.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-DJD7q2vW.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-Bm_qoZad.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-CSD_4kse.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-N2vTdG9E.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-CoA1hINy.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-BEKoeeUo.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-DZL-3v7r.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-BQq6nqnX.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-Dj8fxnF0.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-IKWyQtne.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-C_T1N-0W.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-C_T1N-0W.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BXoWCUqu.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
