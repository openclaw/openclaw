...
import { d as parseConfiguredModelVisibilityEntries, r as buildConfiguredModelCatalog } from "./model-selection-shared-B3Eh9den.js";
import { n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-Bdkz8AFK.js";
import { d as resolveReasoningDefault, l as resolvePersistedOverrideModelRef, m as resolveThinkingDefault } from "./model-selection-DX8uTa0m.js";
...
import "./model-selection-directive-CuLgsnew.js";
...
async function createModelSelectionState(params) {
	...
	const skipStoredOverride = hasOneTurnModelOverride || params.hasResolvedHeartbeatModelOverride === true || staleHeartbeatAutoFallbackOverride && storedOverride?.source === "session";
