...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-D5Thukkn.js";
...
import { u as isGoogleModelApi } from "./pi-embedded-helpers-DJSdhJBp.js";
...
import { t as pluginRegistrationContractRegistry } from "./registry-4b_iVot6.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-BDPvUGt6.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-DTcV5Y92.js");
