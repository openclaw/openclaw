...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-DUApvxgG.js";
...
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-D3lt6ly1.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-GdJSO0xk.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-Bz7_5CJq.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-tTf-FXkL.js");
