...
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-TPiFaS6U.js";
...
import { c as normalizeAgentId, g as toAgentStoreSessionKey, p as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-8g_Q03Po.js";
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-Bo5OijmI.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-DEZ0cwqj.js";
...
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-BA8gUg1x.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-BdInu8_f.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-CXpOdLdg.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-DB28p1_b.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-Cznzc6u5.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-vzMG8R0I.js";
import { n as assertSandboxPath } from "./sandbox-paths-CxVz7Vdm.js";
import "./local-file-access-C_WLD6sm.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-bvchklCv.js";
...
import { T as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BCIPYVeV.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-DDfKx8qu.js";
...
import { n as mergeSessionEntry } from "./types-DfrHTHXx.js";
import { u as extractDeliveryInfo } from "./sessions-DwDN2tCH.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DVjhsOz8.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-D5Thukkn.js";
import { b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-B3Eh9den.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-Bdkz8AFK.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-DX8uTa0m.js";
...
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-D0f5vFna.js";
import "./tool-policy-MEdv-wce.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-Cbl3bPyU.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-l5OrXvqy.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BxSIyg8g.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-DzkPxvCl.js";
...
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-D278wvn8.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-Bb3aFhUx.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-BxcX0suN.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-Bx4pz567.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Hv3xCntn.js";
...
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-Cq098qRp.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DB6BCUEZ.js";
import { l as formatActiveContinuationTraceparent } from "./continuation-tracer-85uebPs_.js";
import { t as completionRequiresMessageToolDelivery } from "./completion-delivery-policy-DYBJsRC4.js";
import "./targeting-BSgbQn9g.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-olMifn5F.js";
...
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-D3PqtYqB.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-DW14-Yb6.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-CDmE7ioM.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-B-fee8Gp.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-CPKH6BMJ.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DmUnGM3r.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-BfCrwkI9.js";
import { a as resolvePluginTools } from "./tools-DTaS5GqW.js";
...
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-ggmdhPPs.js";
import { d as wrapToolWithBeforeToolCallHook, g as listChannelSupportedActions, l as isToolWrappedWithBeforeToolCallHook, m as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-B9AYTMuP.js";
import "./delivery-context-Cbsc6VnB.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-C1VWYwa3.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-BgPlXrp1.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-DXFkxE4S.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-D_S6enAt.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BY4T0IVY.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-COhqKCbC.js";
...
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-BjCGExQs.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CMiO0Vdz.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-Bn7eAY37.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CBIYWjUi.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CBBJrk9X.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-DC0xKPQT.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-Dm7fl9HN.js";
import { u as saveMediaBuffer } from "./store-Bd5Fm8ZQ.js";
import { t as SsrFBlockedError } from "./ssrf-DkFiPZ53.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-Dz5mWuzn.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BCTu5V8e.js";
import { r as getDefaultLocalRoots } from "./local-media-access-Csgo8zlv.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-DP8U2scw.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-CGe721s1.js";
import { n as extractAssistantText } from "./pi-embedded-utils--kG3iCgZ.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-wyoncgWW.js";
import { n as runWithImageModelFallback } from "./model-fallback-BlEcOjWH.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-js-Iev3H.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BHeJMtTx.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-w-OD-dtD.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-COEHYIkP.js";
import { s as resolveTimeoutMs } from "./resolve-B3cbFsPN.js";
import { t as buildProviderRegistry } from "./runner-sMjQvMx0.js";
import "./media-understanding-CAdOxZh1.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CNYtBkHM.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-B6wHj2VY.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-Bvt5uAw-.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-BOkCx4YU.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-D0kmabGm.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BsF9UF7K.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-CobHM5b8.js";
import { t as parseTimeoutMs } from "./parse-timeout-D4M4wJ5C.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-DigXd0JP.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BChf9yKh.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-Cbyn3CxD.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-BGXIat9p.js";
...
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-Bh1w_2Ib.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-C1IypX8J.js";
import { p as registerSubagentRun } from "./subagent-registry-DRF_a7wv.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DdOzq45O.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DmIT74S3.js";
import { k as textToSpeech } from "./tts-runtime-sMwby8lS.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DNtf_I65.js";
...
import { i as runWebSearch } from "./runtime-DQdsQNVI.js";
import "./web-search-provider-common-D90uk-up.js";
...
async function wakeMediaGenerationTaskCompletion(params) {
	...
	if (!delivery.delivered && delivery.error) log$4.error("Media generation completion wake failed; generated media may not be delivered", {
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-yPiP5N4_.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CZwrmI2f.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-H5HDPC9G.js"));
...
//#endregion
export { buildActiveMusicGenerationTaskPromptContextForSession as A, wrapToolMemoryFlushAppendOnlyWrite as C, isEmbeddedMode as D, sniffMimeFromBase64 as E, setEmbeddedMode as O, wrapToolMemoryDayFileWriteGuard as S, wrapToolWorkspaceRootGuardWithOptions as T, createHostWorkspaceWriteTool as _, generateMusic as a, createSandboxedReadTool as b, normalizeCronJobCreate as c, resolveToolLoopDetectionConfig as d, isStrictAgenticExecutionContractActive as f, createHostWorkspaceEditTool as g, createHostWorkspaceAppendTool as h, triggerSessionPatchHook as i, resolveOpenClawPluginToolsForOptions as k, normalizeCronJobInput as l, stripProviderPrefix as m, buildActiveVideoGenerationTaskPromptContextForSession as n, listRuntimeMusicGenerationProviders as o, isStrictAgenticSupportedProviderModel as p, isParentOwnedBackgroundAcpSession as r, listSupportedMusicGenerationModes as s, createOpenClawTools as t, normalizeCronJobPatch as u, createOpenClawReadTool as v, wrapToolWorkspaceRootGuard as w, createSandboxedWriteTool as x, createSandboxedEditTool as y };
