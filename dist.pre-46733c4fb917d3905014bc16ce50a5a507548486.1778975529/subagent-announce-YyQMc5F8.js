...
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DwObNTMf.js";
import "./message-channel-CnnAgKXd.js";
import { i as callGateway } from "./call-BN8ltVBf.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-DhoEU1v8.js";
import { u as resolveStorePath } from "./paths-DEy_pmBW.js";
import { s as updateSessionStore } from "./store-kjdjF6vn.js";
import "./sessions-DwDN2tCH.js";
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-CzQ1z7Ri.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-l5OrXvqy.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-De2cjx4O.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DB6BCUEZ.js";
import { i as consumePendingDelegates } from "./delegate-store-olMifn5F.js";
import "./continuation-delegate-store-CBQgZmV0.js";
import { n as resolveContinuationRuntimeConfig } from "./config-XOBxIAZE.js";
import "./delivery-context-Cbsc6VnB.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-CGe721s1.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BsF9UF7K.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-IlS3yEJZ.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-C1IypX8J.js";
import { n as buildAnnounceIdFromChildRun, r as buildAnnounceIdempotencyKey, t as resolveAnnounceOrigin } from "./subagent-announce-origin-2UGiivk-.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-S54IbQf8.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-C57XCCD0.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-DzB2kc2K.js"), import("./store-load-D0ovHnbt.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { hasCrossSessionDelegateTargeting } = await import("./targeting-pure-BMnVJxq8.js");
	if (!hasCrossSessionDelegateTargeting(params.targeting, params.dispatchingSessionKey)) return false;
	const { enqueueSystemEvent } = await import("./system-events-DgzGW0n_.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-B5Q0xrRz.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-DgzGW0n_.js");
			const { createSubsystemLogger } = await import("./subsystem-Bnzyuosv.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-B-W2VbyV.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
