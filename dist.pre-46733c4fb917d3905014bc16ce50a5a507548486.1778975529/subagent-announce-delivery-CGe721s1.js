...
import { l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-8g_Q03Po.js";
...
import "./message-channel-core-DwObNTMf.js";
import { c as isGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-CnnAgKXd.js";
import "./call-BN8ltVBf.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BKJ-nvQH.js";
import { i as resolveMainSessionKey } from "./main-session-B7p15teJ.js";
import { h as stringifyRouteThreadId } from "./channel-route-iTPrt7ke.js";
import { i as normalizeDeliveryContext, r as mergeDeliveryContext } from "./delivery-context.shared-DhoEU1v8.js";
...
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary, o as isEmbeddedPiRunActive, p as resolveActiveEmbeddedRunSessionId } from "./runs-CzQ1z7Ri.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-l5OrXvqy.js";
import { t as completionRequiresMessageToolDelivery } from "./completion-delivery-policy-DYBJsRC4.js";
import { n as resolveConversationDeliveryTarget } from "./delivery-context-Cbsc6VnB.js";
import { t as basenameFromAnyPath } from "./file-name-Ch8yBik6.js";
import "./message-DQ6ZRu_l.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-IlS3yEJZ.js";
import { t as resolveQueueSettings } from "./queue-km-1IxD-.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-C0Nvqxlw.js";
import { r as normalizeConversationRef } from "./conversation-id-DkkH8hhw.js";
import { r as getSessionBindingService } from "./session-binding-service-BCyhY_kj.js";
import { t as resolveConversationIdFromTargets } from "./conversation-id-BgBzHJOD.js";
...
async function runSubagentAnnounceDispatch(params) {
	...
	if (!params.expectsCompletionMessage) {
		...
		if (primarySteerOutcome === "dropped") return withPhases(primarySteer);
...
async function maybeSteerSubagentAnnounce(params) {
	...
	const { sessionId, isActive } = resolveRequesterSessionActivity(resolveRequesterStoreKey(cfg, params.requesterSessionKey));
	...
	if ((await resolveQueueEmbeddedPiMessageOutcome(sessionId, params.steerMessage, {
		steeringMode: "all",
...
async function sendSubagentAnnounceDirectly(params) {
	...
	try {
		...
		if (params.expectsCompletionMessage && requesterActivity.sessionId) {
			...
			const shouldFallbackToForcedAgentHandoff = requiresMessageToolDelivery && wakeOutcome.reason === "source_reply_delivery_mode_mismatch";
			if (requesterActivity.isActive && !shouldFallbackToForcedAgentHandoff) return {
				delivered: false,
				path: "direct",
...
//#endregion
export { resolveSubagentAnnounceTimeoutMs as a, hasCommittedMessagingToolDeliveryEvidence as c, hasVisibleAgentPayload as d, isNonTerminalAgentRunStatus as f, loadSessionEntryByKey as i, hasMessagingToolDeliveryEvidence as l, mediaUrlsFromGeneratedAttachments as m, isInternalAnnounceRequesterSession as n, resolveSubagentCompletionOrigin as o, formatGeneratedAttachmentLines as p, loadRequesterSessionEntry as r, runAnnounceDeliveryWithRetry as s, deliverSubagentAnnouncement as t, hasOutboundDeliveryEvidence as u };
