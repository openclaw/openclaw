...
import { s as listCoreGatewayMethodNames } from "./core-descriptors-BGs2tgKs.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DTHMom2l.js";
import "./loader-DB28p1_b.js";
import { F as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-DwZ8VkSL.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-COL1yQ5e.js";
import { c as initSubagentRegistry } from "./subagent-registry-DRF_a7wv.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-CVagB7pp.js";
import { n as listGatewayMethods } from "./server-methods-list-CuMngi_u.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-C-URE_is.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-Gl-jGFXB.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-DF1_1s3j.js");
