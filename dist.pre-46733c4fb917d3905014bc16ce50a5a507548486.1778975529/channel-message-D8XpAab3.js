import { t as createMessageReceiptFromOutboundResults } from "./receipt-ClSO3ImM.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-DAX1tFSR.js";
import { i as resolveChannelTurnDispatchCounts, n as hasFinalChannelTurnDispatch, r as hasVisibleChannelTurnDispatch } from "./dispatch-result-BlfMaaUM.js";
import "./channel-reply-core-Dre_9_7L.js";
...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-DNOf6_0V.js")).deliverInboundReplyWithMessageSendContext(...args);
};
...
async function sendDurableMessageBatch(params) {
	return await (await import("./runtime-phmbaxGm.js")).sendDurableMessageBatch(params);
}
async function withDurableMessageSendContext(params, run) {
	return await (await import("./runtime-phmbaxGm.js")).withDurableMessageSendContext(params, run);
}
