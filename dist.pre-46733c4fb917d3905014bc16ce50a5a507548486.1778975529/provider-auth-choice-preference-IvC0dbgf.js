...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-BEZ1pCIL.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-BkBAY2HI.js");
