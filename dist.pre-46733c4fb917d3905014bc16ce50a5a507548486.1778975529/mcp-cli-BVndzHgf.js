...
import { r as extractFirstTextBlock } from "./chat-message-content-Z4Kji8I-.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-hqCxaMis.js"),
			import("./client-XQoWsRxO.js"),
			import("./client-start-readiness-C0MUZoNZ.js"),
			import("./method-scopes-DQqhDJje.js"),
			import("./client-info-CtK_UVfj.js")
		]);
