...
import { r as normalizeModelRef } from "./model-selection-normalize-Bdkz8AFK.js";
import "./model-selection-DX8uTa0m.js";
import { a as resolveModelCostConfig, n as estimateUsageCost } from "./usage-format-CR_pWGmY.js";
...
async function resolveAgentId(params) {
	...
	const { resolveDefaultAgentId } = await import("./agent-scope-CIEGx9UU.js");
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ prepareSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-Dr1FS7Kr.js"), Promise.resolve(resolveRuntimeConfig(options))]);
