import { s as redactSensitiveText } from "./redact-CDZ_xiJS.js";
import { i as formatErrorMessage } from "./errors-s6LAmrhz.js";
import { a as isTransientNetworkError, n as isAbortError } from "./unhandled-rejections-CBMu22qg.js";
import { n as detectMime, p as MAX_DOCUMENT_BYTES, r as extensionForMime } from "./mime-DVjhsOz8.js";
import { f as saveMediaStream, u as saveMediaBuffer } from "./store-Bd5Fm8ZQ.js";
import { n as extnameFromAnyPath, t as basenameFromAnyPath } from "./file-name-Ch8yBik6.js";
import { i as withStrictGuardedFetchMode, n as fetchWithSsrFGuard, o as withTrustedExplicitProxyGuardedFetchMode } from "./fetch-guard-BMs_6cJp.js";
import { n as retryAsync } from "./retry-CzzRAOj7.js";
import { n as readResponseWithLimit, t as readResponseTextSnippet } from "./read-response-with-limit-C9KTfeIT.js";
...
async function fetchGuardedMediaResponse(options) {
	const { url, fetchImpl, requestInit, maxRedirects, ssrfPolicy, lookupFn, dispatcherPolicy, dispatcherAttempts, shouldRetryFetchError, trustExplicitProxyDns } = options;
...
function resolveRemoteFileName(params) {
	let fileNameFromUrl;
	try {
		fileNameFromUrl = basenameFromAnyPath(new URL(params.finalUrl).pathname) || void 0;
	} catch {}
