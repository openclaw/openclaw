...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-CQKyIaU0.js";
import "./ssrf-runtime-DPexcW9I.js";
import "./text-utility-runtime-CmVRVZ7i.js";
import "./runtime-api-YiZHdJcS.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-BmrMfv7t.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-X2eSW7P8.js")]);
			return {
