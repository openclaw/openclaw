...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout } from "./reply-payload-JoRJOGxA.js";
import { f as renderMessagePresentationFallbackText } from "./payload-B_wuzhmC.js";
...
import { a as sendMessageMatrix, l as sendTypingMatrix, o as sendPollMatrix } from "./send-B8AMs77X.js";
...
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-CCSs85Up.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));
