...
import { c as loadAuthProfileStoreForSecretsRuntime, i as ensureAuthProfileStoreWithoutExternalProfiles, l as loadAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore, s as loadAuthProfileStoreForRuntime } from "./store-Cm1yBhEt.js";
import { N as resolveProviderSyntheticAuthWithPlugin, _ as normalizeProviderResolvedModelWithPlugin, a as applyProviderResolvedTransportWithPlugin, i as applyProviderResolvedModelCompatWithPlugins } from "./provider-runtime-D5Thukkn.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-CLIkJIdR.js";
...
function createOpenClawModelRegistry(authStorage, modelsJsonPath, agentDir, options) {
	...
	const normalizeEntry = (entry) => shouldNormalize ? normalizeDiscoveredPiModel(entry, agentDir) : entry;
	registry.getAll = () => {
