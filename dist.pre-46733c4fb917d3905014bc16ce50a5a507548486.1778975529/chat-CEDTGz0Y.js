...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-s6LAmrhz.js";
...
import { d as measureDiagnosticsTimelineSpanSync, u as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-Dev8PLWv.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-IYxogv8I.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BNgXhSMO.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DwObNTMf.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-CnnAgKXd.js";
import { r as setSafeTimeout } from "./timer-delay-CSpkfA-1.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-DZ9c3mr8.js";
import { s as normalizeInputProvenance } from "./input-provenance-D0YvQQYE.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-BsIVN9xl.js";
import "./method-scopes-CokyD7q3.js";
...
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-T1_slPRp.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CyQVdiNm.js";
import { b as resolveModelRefFromString, c as inferUniqueProviderFromConfiguredModels, i as buildModelAliasIndex } from "./model-selection-shared-B3Eh9den.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-D278wvn8.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-Dk0ZjTFv.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-Bb3aFhUx.js";
...
import { n as rewriteTranscriptEntriesInSessionFile } from "./context-engine-maintenance-DFbJRiLg.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-Bd5Fm8ZQ.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-Dh1JfYL4.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-Csgo8zlv.js";
import { f as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-CGe721s1.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-_td7S6bi.js";
...
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-B8oRNFoy.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-DBiOQ8wl.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BXFt2-Dc.js";
...
import { t as logLargePayload } from "./diagnostic-payload-BA87bLmh.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-CDgqo5b0.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-CDWvLfAb.js";
...
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-DWRYmsnD.js";
import { a as resolveChatAttachmentLooksLikeImage, i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BFlPAHm1.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-BcQF_msy.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-g5vqcQgf.js";
