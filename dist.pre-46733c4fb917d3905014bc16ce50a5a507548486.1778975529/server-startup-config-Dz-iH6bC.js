...
import { A as applyConfigOverrides, f as readConfigFileSnapshotWithPluginMetadata } from "./io-DEZ0cwqj.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { t as formatInvalidConfigRecoveryHint } from "./config-recovery-hints-BksIM7Yn.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DTHMom2l.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-DcnAlZIb.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-u2fQxXIR.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = () => {
		secretsRuntimePromise ??= import("./runtime-Bzr2flt4.js");
		return secretsRuntimePromise;
	};
	const loadAuthProfiles = () => {
		authProfilesPromise ??= import("./auth-profiles-CnKDPmoy.js");
