...
async function migratePlanCommand(runtime, opts) {
	...
	else if (opts.suppressPlanLog !== true) log.message(formatMigrationPreview(plan).join("\n"));
	return plan;
}
