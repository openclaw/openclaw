...
import { n as isAbortError } from "./unhandled-rejections-CBMu22qg.js";
import { t as createLazyImportLoader } from "./lazy-promise-SFT4i6yI.js";
import { t as hasConfiguredModelFallbacks, y as hasSessionAutoModelFallbackProvenance } from "./agent-scope-TPiFaS6U.js";
...
import { u as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-Dev8PLWv.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-C1FXVLZD.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-BwPTb6yW.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-CnnAgKXd.js";
...
import { x as resolveMemoryFlushPlan } from "./memory-state-BFN1OKxH.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-vzMG8R0I.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-DEy_pmBW.js";
import { c as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-BCIPYVeV.js";
import { c as updateSessionStoreEntry, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-kjdjF6vn.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-DfrHTHXx.js";
import "./sessions-DwDN2tCH.js";
import { o as isAudioFileName } from "./mime-DVjhsOz8.js";
import { a as resolveContextTokensForModel } from "./context-DoN95pmw.js";
import { b as resolveModelRefFromString } from "./model-selection-shared-B3Eh9den.js";
...
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-DNTtOSbx.js";
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-CzQ1z7Ri.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-DzkPxvCl.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CR_pWGmY.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-qL_fcg_p.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-D278wvn8.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-QoK5oop2.js";
import { i as resolveSandboxConfigForAgent } from "./config-B-CFRbpa.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BkBBsFag.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-CQYFU2zN.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-b378ARaq.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BMrD9mkX.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-CLhO48eA.js";
import { r as hasCrossSessionDelegateTargeting } from "./targeting-pure-Cq098qRp.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DB6BCUEZ.js";
import { u as stripHeartbeatToken } from "./heartbeat-Ca4uwtdE.js";
import { r as enqueueCommitmentExtraction } from "./runtime-DvQNPfmV.js";
import { c as emitContinuationWorkSpan, g as startContinuationDelegateSpan, i as emitContinuationDisabledSpan, m as resolveContinuationTraceparent, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-85uebPs_.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-sotqYg9D.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-5O4VohDF.js";
import { a as enqueueSystemEvent } from "./system-events-CD806-T7.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-dfFoTj49.js";
import { n as resolveSendPolicy } from "./send-policy-DlkI-Img.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-olMifn5F.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-CBQgZmV0.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-XOBxIAZE.js";
import { t as checkContextPressure } from "./context-pressure-QQwLw4B2.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-BzkyG1c8.js";
import { a as listLegacyRuntimeModelProviderAliases, s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-DGv8MJIC.js";
import "./pi-embedded-helpers-DJSdhJBp.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-Ggmxu0UI.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-C9q0yWVh.js";
import { t as formatProviderModelRef } from "./model-runtime-ixG1189O.js";
import "./fallback-notice-state-D4UX_bbI.js";
import { i as setReplyPayloadMetadata, n as getReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-C_Q-5cN_.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-JoRJOGxA.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-DhvCByXL.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-D6mgIyWa.js";
import { f as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BlEcOjWH.js";
import { u as parseReplyDirectives } from "./payloads-_td7S6bi.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-Di4Xh-KA.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-Ara1l3k5.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-Bu0xOTmz.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-km-1IxD-.js";
import { n as hasCotFramePrefix } from "./normalize-reply-CEzc3F_3.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BdtZ5FAG.js";
import { t as runCliAgent } from "./cli-runner-D51N2gM6.js";
import { r as getCliSessionBinding } from "./cli-session-Cd9vE_Qt.js";
import { G as isLikelyExecutionAckPrompt } from "./selection-BPIjL3EG.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-7iRTlwQp.js";
import "./sandbox-BoIX-oUx.js";
import { n as readPostCompactionContext } from "./post-compaction-context-Cf2IBAfG.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-BdZ9fc0E.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DnPW45Zn.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-_eO2_xFW.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-DnriyYhE.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-B8oRNFoy.js";
import { n as incrementCompactionCount } from "./session-updates-BUblfExO.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-CAs2KTRL.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-DgmvDOV9.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-C-GxgcsF.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-Cwb80uM1.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-DoRJnjxZ.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-B-Gj6Orv.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-D5ABklYY.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-raxvAZLS.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-BX5JFi4A.js");
...
async function runAgentTurnWithFallback(params) {
	...
	const persistFallbackCandidateSelection = async (provider, model) => {
		if (params.followupRun.run.hasOneTurnModelOverride === true) return;
		...
		const fallbackResult = await runWithModelFallback({
			...
			run: async (provider, model, runOptions) => {
				...
				if (isCliProvider(cliExecutionProvider, runtimeConfig)) {
					...
					const cliSessionBinding = isRoomEventCliTurn ? void 0 : getCliSessionBinding(params.getActiveSessionEntry(), cliExecutionProvider);
					...
					return (async () => {
						...
						const createAssistantTextBridge = (deliver) => {
							let lastText;
						...
						const reasoningBridge = shouldBridgeCliAssistantTextToReasoning(cliExecutionProvider) ? createAssistantTextBridge(async (text) => {
						...
						try {
							...
							const result = isRoomEventCliTurn && rawResult.meta.agentMeta ? (() => {
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-FkbZW392.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-Beom2k80.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BHOBJvCa.js"),
					import("./config-DIHNYW8V.js"),
					import("./state-S54IbQf8.js"),
					import("./store-B1T8pO7v.js")
				]);
