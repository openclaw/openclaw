...
- Use standard template from `.openclaw/skills/file-todos/assets/todo-template.md`
...
2. Use file-todos skill for structured todo management:
   ...
   - Template location: `.openclaw/skills/file-todos/assets/todo-template.md`
...
5. Follow template structure from file-todos skill: `.openclaw/skills/file-todos/assets/todo-template.md`
