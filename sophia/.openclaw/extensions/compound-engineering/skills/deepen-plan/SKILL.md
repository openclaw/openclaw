...
# 2. User's global skills (~/.openclaw/)
ls ~/.openclaw/skills/

# 3. compound-engineering plugin skills
ls ~/.openclaw/plugins/cache/*/compound-engineering/*/skills/

# 4. ALL other installed plugins - check every plugin for skills
find ~/.openclaw/plugins/cache -type d -name "skills" 2>/dev/null

# 5. Also check installed_plugins.json for all plugin locations
cat ~/.openclaw/plugins/installed_plugins.json
```
...
**Example spawns:**
```
Task general-purpose: "Use the dhh-rails-style skill at ~/.openclaw/plugins/.../dhh-rails-style. Read SKILL.md and apply it to: [Rails sections of plan]"

Task general-purpose: "Use the frontend-design skill at ~/.openclaw/plugins/.../frontend-design. Read SKILL.md and apply it to: [UI sections of plan]"

Task general-purpose: "Use the agent-native-architecture skill at ~/.openclaw/plugins/.../agent-native-architecture. Read SKILL.md and apply it to: [agent/tool sections of plan]"

Task general-purpose: "Use the security-patterns skill at ~/.openclaw/skills/security-patterns. Read SKILL.md and apply it to: [full plan]"
```
...
find .openclaw/docs -name "*.md" -type f 2>/dev/null
find ~/.openclaw/docs -name "*.md" -type f 2>/dev/null
```
...
find .openclaw/agents -name "*.md" 2>/dev/null

# 2. User's global agents (~/.openclaw/)
find ~/.openclaw/agents -name "*.md" 2>/dev/null

# 3. compound-engineering plugin agents (all subdirectories)
find ~/.openclaw/plugins/cache/*/compound-engineering/*/agents -name "*.md" 2>/dev/null

# 4. ALL other installed plugins - check every plugin for agents
find ~/.openclaw/plugins/cache -path "*/agents/*.md" 2>/dev/null
