...
import { c as parseThreadSessionSuffix } from "./session-key-utils-DDEl6txh.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-BH3bWazi.js";
import { _ as readStringParam, a as createActionGate, n as ToolAuthorizationError, p as readNumberParam } from "./common-NU_RG5vx.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-B4oQiCpN.js";
import { n as describeAccountSnapshot } from "./account-helpers-BJJnugsm.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-D4d_JtEH.js";
...
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-BAbLgp6f.js";
...
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-l4StXZ7L.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-d02vmIgV.js";
import "./approval-delivery-runtime-C-Oesp5f.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-DdO7BKib.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-DKBjsDnF.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-D5gdvz_8.js";
import "./approval-native-runtime-BKDELkGG.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DUEfpOKW.js";
import "./channel-status-BOptdune.js";
import "./channel-actions-BZNPyiTu.js";
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-DLRlnHTh.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-DE1ZGqNp.js";
...
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-B0Iddw9p.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-h638O4b8.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-BMj1S_p4.js";
import { a as resolveMatrixAccountConfig } from "./account-config-COlwhlmU.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-B4rt77cH.js";
import { n as normalizeMatrixUserId } from "./allowlist-CUESTVMT.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-Bo2cRhDW.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-D_Pa6f0T.js";
import { t as formatMatrixErrorMessage } from "./errors-C9k7-TdT.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-B14c68Vw.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BUIu2m9v.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-DHDfkS-5.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-WCsGY37S.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-Bpf59i2B.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-WzV_T5Os.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-D8NvL5jL.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-TpipWyFq.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-BCmsS_2Z.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-K6cUuhXV.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-C3zM2Xsy.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-C3zM2Xsy.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-By7KsbD6.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
