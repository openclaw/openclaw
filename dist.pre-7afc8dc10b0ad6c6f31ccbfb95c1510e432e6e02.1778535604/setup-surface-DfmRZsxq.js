...
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DULhRyVw.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-Dq1BhzVz.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-CAG64CLR.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-B4rt77cH.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Bpf59i2B.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-IphK14k1.js";
import { n as updateMatrixAccountConfig } from "./config-update-5NX1nLMA.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-DVVLocdO.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-37MKPmEP.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-BAmYckBO.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-iHVlTr3P.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DXy9amMw.js");
