...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-B5t8JnF3.js";
...
import { p as DiscordError } from "./discord-DLhm__-V.js";
import { t as chunkDiscordTextWithMode } from "./chunk-CT27pxg_.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-_DVoX0ob.js";
import { t as createDiscordSendReceipt } from "./send.receipt--mKV36Al.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-D4LGVoao.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-l9folhYA.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-oIr59i1Z.js");
