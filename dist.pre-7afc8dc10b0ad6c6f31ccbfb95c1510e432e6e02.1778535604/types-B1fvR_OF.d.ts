import { a as PromptMode, d as AgentStreamParams, f as ClientToolDefinition, l as AgentInternalEvent, p as ExecElevatedDefaults } from "./params-Ca2aO1q_.js";
import { l as PromptImageOrderEntry, n as ContinuationTrigger } from "./get-reply-options.types-BQuqGiER.js";
import { t as InputProvenance } from "./input-provenance-CCgassO7.js";
import { O as ChannelOutboundTargetMode } from "./types.core-gexONR-2.js";
...
type AgentCommandOpts = {
  ...
  inputProvenance?: InputProvenance; /** Per-call stream param overrides (best-effort). */
  ...
  resultMetaOverrides?: AgentCommandResultMetaOverrides; /** Internal one-shot model probe mode: no tools, no workspace/chat prompt policy. */
