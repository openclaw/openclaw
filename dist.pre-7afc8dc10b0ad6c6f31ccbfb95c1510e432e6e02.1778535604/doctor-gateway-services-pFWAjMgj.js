...
import { i as OPENCLAW_WRAPPER_ENV_KEY } from "./daemon-install-plan.shared-BSkHzVOn.js";
import { n as buildGatewayInstallPlan } from "./auth-install-policy-6_pgxkhV.js";
import { S as readManagedServiceEnvKeysFromEnvironment, f as uninstallLegacySystemdUnits, i as isSystemdUnitActive } from "./systemd-CKuHKZAt.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-DgweF00j.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DWalIU5e.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BlWUOwkn.js";
import { r as replaceConfigFile } from "./mutate-b0m5-BMg.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-0_EACiFt.js";
import "./config-Cj3XPIio.js";
import { i as resolveGatewayService } from "./service-B9IthQhN.js";
import { i as renderGatewayServiceCleanupHints, n as findExtraGatewayServices } from "./inspect-Cw98k-yG.js";
import { t as note } from "./note-DSqXisNi.js";
import { t as summarizeGatewayServiceLayout } from "./service-layout-Blv-7gij.js";
import { a as resolveServiceRepairPolicy, i as isServiceRepairExternallyManaged, r as confirmDoctorServiceRepair, t as EXTERNAL_SERVICE_REPAIR_NOTE } from "./doctor-service-repair-policy-DLZ0qWdH.js";
import { t as isDoctorUpdateRepairMode } from "./doctor-repair-mode-CCldlKes.js";
...
async function maybeRepairGatewayServiceConfig(cfg, mode, runtime, prompter) {
	...
	if (needsNodeRuntime && !systemNodePath && runtimeChoice !== "node") {
		...
		else note("System Node 22 LTS (22.16+) or Node 24 not found. Install via Homebrew/apt/choco and rerun doctor to migrate off Bun/version managers.", "Gateway runtime");
	}
