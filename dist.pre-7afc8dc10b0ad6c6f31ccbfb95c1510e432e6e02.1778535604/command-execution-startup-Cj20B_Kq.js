...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CDmN_7JN.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DAEGwj8k.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-CcHx-Egq.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-P7EVSwl5.js");
	if (params.argv) {
