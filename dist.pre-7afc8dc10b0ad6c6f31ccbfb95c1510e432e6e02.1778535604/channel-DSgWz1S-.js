...
import { d as normalizeSecretInputString, h as resolveSecretInputString, u as normalizeResolvedSecretInputString } from "./types.secrets-m6J7qPGz.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-9_btbLFO.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-DUwpWtxL.js";
...
import { s as resolveMergedAccountConfig, t as createAccountListHelpers } from "./account-helpers-BJJnugsm.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-CQ0EhoHb.js";
...
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-DUEfpOKW.js";
...
const ClickClackAccountConfigSchema = zod_exports.z.object({
	...
	workspace: zod_exports.z.string().optional(),
	botUserId: zod_exports.z.string().optional(),
	agentId: zod_exports.z.string().optional(),
	replyMode: zod_exports.z.enum(["agent", "model"]).optional(),
	model: zod_exports.z.string().optional(),
	systemPrompt: zod_exports.z.string().optional(),
	timeoutSeconds: zod_exports.z.number().int().min(1).max(3600).optional(),
	toolsAllow: zod_exports.z.array(zod_exports.z.string()).optional(),
	senderIsOwner: zod_exports.z.boolean().optional(),
	defaultTo: zod_exports.z.string().optional(),
	allowFrom: zod_exports.z.array(zod_exports.z.string()).optional(),
	reconnectMs: zod_exports.z.number().int().min(100).max(6e4).optional()
}).strict();
const clickClackConfigSchema = buildChannelConfigSchema(ClickClackAccountConfigSchema.extend({
	accounts: zod_exports.z.record(zod_exports.z.string(), ClickClackAccountConfigSchema.partial()).optional(),
