import { c as readErrorName, i as formatErrorMessage } from "./errors-BBpaQ7HQ.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-D-QDM7gD.js";
...
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-D9j4s93E.js";
import "./pi-bundle-mcp-tools-qDUFa5UZ.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-DcDzeJZQ.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-BVOEUKMc.js";
import "./subagent-announce-queue-B240995u.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-R7TgiH0y.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-CTvrQTiX.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-ncvckxBs.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DBfEljDV.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-jHHaW_So.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DBfEljDV.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-CrovhjvN.js").then(({ scheduleOrphanRecovery }) => {
