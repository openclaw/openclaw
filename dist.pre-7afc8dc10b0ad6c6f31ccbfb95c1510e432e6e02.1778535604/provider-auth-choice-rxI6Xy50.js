import { n as normalizeAgentModelRefForConfig } from "./model-input-WCN93Is3.js";
...
import { n as openUrl } from "./browser-open-Dvy2y0C7.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-Ce9BBJgH.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CaOCKi_2.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DEZsIzgA.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-BWvX1Ar7.js";
import { t as isRemoteEnvironment } from "./remote-env-BurhsWtA.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-utnChSVk.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-B5tRvaCl.js") };
