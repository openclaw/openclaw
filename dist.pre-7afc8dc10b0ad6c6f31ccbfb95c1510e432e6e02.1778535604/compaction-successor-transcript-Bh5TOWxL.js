...
import { a as redactToolDetail, i as redactSensitiveText } from "./redact-BWh2xM0E.js";
import { i as formatErrorMessage } from "./errors-BBpaQ7HQ.js";
import { n as isAbortError } from "./unhandled-rejections-DSnERjlv.js";
...
import { i as resolveAgentContextLimits } from "./agent-scope-config-bmagiEt7.js";
...
import { n as logError, t as logDebug } from "./logger-C9OJkRW0.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-kkxFBlxd.js";
...
import { a as hasInterSessionUserProvenance, i as applyInputProvenanceToUserMessage, r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-CxTmAjhY.js";
import { S as getCompactionProvider } from "./loader-Wt_psC5v.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DLssgbug.js";
import { S as createExpiringMapCache, T as resolveCacheTtlMs, w as isCacheEnabled } from "./store-load-Dl9FHzUQ.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CMg87lFv.js";
import { A as resolveProviderReasoningOutputModeWithPlugin, E as resolveProviderCacheTtlEligibility, U as sanitizeProviderReplayHistoryWithPlugin, q as validateProviderReplayTurnsWithPlugin } from "./provider-runtime-D8nuaUJM.js";
import { t as sanitizeForConsole } from "./console-sanitize-CHtuWd7c.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BUD1z2SY.js";
import { a as makeZeroUsageSnapshot, o as normalizeUsage } from "./usage-CGE_H8UJ.js";
import { S as firstEnumerableOwnKeys, w as jsonUtf8BytesOrInfinity, x as boundedJsonUtf8Bytes } from "./session-utils.fs-k1At_GQo.js";
import { d as stripRuntimeContextCustomMessages } from "./internal-runtime-context-D1PNhbvz.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-CvAZUO4e.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-CHJlUGkv.js";
import { i as normalizeToolName } from "./tool-policy-shared-DOGm5yak.js";
import "./tool-policy-Bm4_xOG4.js";
...
import { _ as sanitizeGoogleTurnOrdering, c as downgradeOpenAIFunctionCallReasoningPairs, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns } from "./pi-embedded-helpers-CtFVlC7o.js";
import { n as extractToolResultId, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-CR-weGvf.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BPyp67rY.js";
import { a as isTimeoutError } from "./failover-error-D8XVsnCj.js";
import { c as runBeforeToolCallHook, g as resolveChannelPromptCapabilities, o as isBeforeToolCallBlockedError, r as buildBlockedToolResult, s as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-DkJi3XgM.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-COPj8Uzk.js";
import "./logger-CYMsG1R-.js";
import { a as pruneHistoryForContextShare, h as formatContextLimitTruncationNotice, i as estimateMessagesTokens, m as truncateToolResultMessage, n as SUMMARIZATION_OVERHEAD_TOKENS, o as resolveContextWindowTokens$1, r as computeAdaptiveChunkRatio, s as summarizeInStages, u as resolveLiveToolResultMaxChars } from "./compaction-CVZ7pS3t.js";
import { a as resolveEffectiveCompactionMode } from "./pi-settings-CALkUU-U.js";
import { f as payloadTextResult, l as jsonResult } from "./common-NU_RG5vx.js";
import { r as wrapUntrustedPromptDataBlock } from "./sanitize-for-prompt--Mhok0vJ.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-B5QB2VSX.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-COHwgCta.js";
import { s as buildCopilotIdeHeaders } from "./provider-auth-BTiyooTa.js";
import { n as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-CGoTQp3y.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-CaMdqN91.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-BmCLBbKy.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-pEtfAq42.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-By40G4f5.js";
import "./skills-WEWDU9BJ.js";
import { t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-CQK5n_tF.js";
import { D as isAnthropicFamilyCacheTtlEligible, O as isAnthropicModelRef } from "./provider-stream-shared-CZg7LGwE.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-DX4rM4Q1.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-CyXsx7yY.js";
import { n as resolveCronStyleNow } from "./current-time-DCfGEbFW.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-Cf3VlXzl.js";
import "./query-DJ0aroO0.js";
import { t as estimateStringChars } from "./cjk-chars-B8h97E23.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-BnEKW5Qr.js";
...
async function flushPendingToolResultsAfterIdle(opts) {
	if ((opts.timeoutMs !== void 0 && opts.timeoutMs <= 0 || await waitForAgentIdleBestEffort(opts.agent, opts.timeoutMs ?? DEFAULT_WAIT_FOR_IDLE_TIMEOUT_MS)) && opts.clearPendingOnTimeout && opts.sessionManager?.clearPendingToolResults) {
...
//#endregion
export { isRealConversationMessage as A, buildStreamErrorAssistantMessage as B, sanitizeSessionHistory as C, limitHistoryTurns as D, getHistoryLimitFromSessionKey as E, resolveCompactionTimeoutMs as F, isClientToolNameConflictError as G, collectRuntimeChannelCapabilities as H, isCacheTtlEligibleProvider as I, dropReasoningFromHistory as J, toClientToolDefinitions as K, readLastCacheTtlTimestamp as L, consumeCompactionSafeguardCancelReason as M, setCompactionSafeguardCancelReason as N, buildEmbeddedExtensionFactories as O, compactWithSafetyTimeout as P, guardSessionManager as R, normalizeAssistantReplayContent as S, buildEmbeddedMessageActionDiscoveryInput as T, createClientToolNameConflictError as U, buildUsageWithNoCost as V, findClientToolNameConflicts as W, isZeroUsageEmptyStopAssistantTurn as X, dropThinkingBlocks as Y, isReasoningTagProvider as Z, resolveEmbeddedAgentBaseStreamFn as _, flushPendingToolResultsAfterIdle as a, prewarmSessionFile as b, PI_RESERVED_TOOL_NAMES as c, toSessionToolAllowlist as d, applySystemPromptOverrideToSession as f, resolveEmbeddedAgentApiKey as g, describeEmbeddedAgentStreamStrategy as h, dedupeDuplicateUserMessagesForCompaction as i, readPostCompactionContext as j, hasMeaningfulConversationContent as k, collectAllowedToolNames as l, createSystemPromptOverride as m, rotateTranscriptFileAfterCompaction as n, mapThinkingLevel as o, buildEmbeddedSystemPrompt as p, assessLastAssistantMessage as q, shouldRotateCompactionTranscript as r, splitSdkTools as s, rotateTranscriptAfterCompaction as t, collectRegisteredToolNames as u, resolveEmbeddedAgentStreamFn as v, validateReplayTurns as w, trackSessionManagerAccess as x, resolveEmbeddedRunSkillEntries as y, repairSessionFileIfNeeded as z };
