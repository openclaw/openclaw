...
import { n as AgentEventPayload, r as AgentEventStream } from "./agent-events-CLtiaF7G.js";
import { Ft as PluginJsonValue, M as PluginHookBeforeToolCallEvent, N as PluginHookBeforeToolCallResult, gt as PluginHookToolContext } from "./hook-types-uik7367C.js";
import { lt as ErrorShape } from "./types-CLhTUA6X.js";
...
declare const SendParamsSchema: Type.TObject<{
  ...
  threadId: Type.TOptional<Type.TString>; /** Optional session key for mirroring delivered output back into the transcript. */
  sessionKey: Type.TOptional<Type.TString>;
  idempotencyKey: Type.TString;
}>;
...
declare const AgentParamsSchema: Type.TObject<{
  ...
  continuationTrigger: Type.TOptional<Type.TString>;
  ...
  drainsContinuationDelegateQueue: Type.TOptional<Type.TBoolean>;
}>;
...
declare const ChatEventSchema: Type.TObject<{
  runId: Type.TString;
  sessionKey: Type.TString;
  spawnedBy: Type.TOptional<Type.TString>;
  seq: Type.TInteger;
...
declare const validateConnectParams: AjvPkg.ValidateFunction<{
  ...
  client: {
    ...
    mode: "probe" | "webchat" | "cli" | "test" | "ui" | "backend" | "node";
    platform: string;
  };
}>;
...
declare const validateModelsListParams: AjvPkg.ValidateFunction<{
  view?: "default" | "configured" | "all" | undefined;
}>;
...
//#endregion
export { validateExecApprovalsNodeGetParams as $, SkillsSearchParamsSchema as $a, ChannelsLogoutParamsSchema as $i, WizardStartParamsSchema as $n, NodePendingDrainParamsSchema as $r, validateSkillsDetailParams as $t, validateConfigSchemaParams as A, ArtifactsDownloadParamsSchema as Aa, EnvironmentsStatusResultSchema as Ai, validateTalkSpeakResult as An, SessionsResolveParamsSchema as Ar, validateSecretsResolveResult as At, validateDevicePairApproveParams as B, AgentsFilesGetResultSchema as Ba, CronUpdateParamsSchema as Bi, validateWebLoginStartParams as Bn, WebPushUnsubscribeParamsSchema as Br, validateSessionsDeleteParams as Bt, validateChatSendParams as C, TalkSessionTurnParamsSchema as Ca, ExecApprovalsGetParamsSchema as Ci, validateTalkSessionJoinParams as Cn, PluginSessionExtensionProjection as Co, SessionsDeleteParamsSchema as Cr, validatePluginApprovalResolveParams as Ct, validateConfigPatchParams as D, WebLoginStartParamsSchema as Da, EnvironmentsListParamsSchema as Di, validateTalkSessionTurnParams as Dn, PluginToolMetadataRegistration as Do, SessionsPluginPatchParamsSchema as Dr, validateRequestFrame as Dt, validateConfigGetParams as E, TalkSpeakResultSchema as Ea, EnvironmentSummarySchema as Ei, validateTalkSessionSubmitToolResultParams as En, PluginSessionSchedulerJobRegistration as Eo, SessionsPatchParamsSchema as Er, validatePushTestParams as Et, validateCronRemoveParams as F, AgentsCreateResultSchema as Fa, CronListParamsSchema as Fi, validateToolsEffectiveParams as Fn, WebPushSubscribeParams as Fr, validateSessionsCompactionBranchParams as Ft, validateDeviceTokenRotateParams as G, AgentsListParamsSchema as Ga, ConfigSchemaLookupResultSchema as Gi, validateWebPushVapidPublicKeyParams as Gn, NodeListParamsSchema as Gr, validateSessionsPatchParams as Gt, validateDevicePairRejectParams as H, AgentsFilesListResultSchema as Ha, ConfigGetParamsSchema as Hi, validateWebPushSubscribeParams as Hn, WebPushVapidPublicKeyParamsSchema as Hr, validateSessionsListParams as Ht, validateCronRunParams as I, AgentsDeleteParamsSchema as Ia, CronRemoveParamsSchema as Ii, validateToolsInvokeParams as In, WebPushSubscribeParamsSchema as Ir, validateSessionsCompactionGetParams as It, validateEventFrame as J, AgentsUpdateResultSchema as Ja, ConfigSetParamsSchema as Ji, validateWizardStartParams as Jn, NodePairRejectParamsSchema as Jr, validateSessionsResetParams as Jt, validateEnvironmentsListParams as K, AgentsListResultSchema as Ka, ConfigSchemaParamsSchema as Ki, validateWizardCancelParams as Kn, NodePairApproveParamsSchema as Kr, validateSessionsPluginPatchParams as Kt, validateCronRunsParams as L, AgentsDeleteResultSchema as La, CronRunParamsSchema as Li, validateUpdateRunParams as Ln, WebPushTestParams as Lr, validateSessionsCompactionListParams as Lt, validateConnectParams as M, ArtifactsListParamsSchema as Ma, errorShape as Mi, validateTasksGetParams as Mn, SessionsUsageParamsSchema as Mr, validateSessionsAbortParams as Mt, validateCronAddParams as N, AgentSummarySchema as Na, CronAddParamsSchema as Ni, validateTasksListParams as Nn, PushTestParamsSchema as Nr, validateSessionsCleanupParams as Nt, validateConfigSchemaLookupParams as O, WebLoginWaitParamsSchema as Oa, EnvironmentsListResultSchema as Oi, validateTalkSessionTurnResult as On, PluginTrustedToolPolicyRegistration as Oo, SessionsPreviewParamsSchema as Or, validateResponseFrame as Ot, validateCronListParams as P, AgentsCreateParamsSchema as Pa, CronJobSchema as Pi, validateToolsCatalogParams as Pn, PushTestResultSchema as Pr, validateSessionsCompactParams as Pt, validateExecApprovalsGetParams as Q, SkillsInstallParamsSchema as Qa, CommandsListResultSchema as Qi, WizardNextResultSchema as Qn, NodePendingAckParamsSchema as Qr, validateSkillsBinsParams as Qt, validateCronStatusParams as R, AgentsFileEntrySchema as Ra, CronRunsParamsSchema as Ri, validateUpdateStatusParams as Rn, WebPushTestParamsSchema as Rr, validateSessionsCompactionRestoreParams as Rt, validateChatInjectParams as S, TalkSessionSubmitToolResultParamsSchema as Sa, ExecApprovalResolveParamsSchema as Si, validateTalkSessionCreateResult as Sn, PluginRuntimeLifecycleRegistration as So, SessionsCreateParamsSchema as Sr, validatePluginApprovalRequestParams as St, validateConfigApplyParams as T, TalkSpeakParamsSchema as Ta, EnvironmentStatusSchema as Ti, validateTalkSessionOkResult as Tn, PluginSessionSchedulerJobHandle as To, SessionsListParamsSchema as Tr, validatePollParams as Tt, validateDevicePairRemoveParams as U, AgentsFilesSetParamsSchema as Ua, ConfigPatchParamsSchema as Ui, validateWebPushTestParams as Un, NodeEventResultSchema as Ur, validateSessionsMessagesSubscribeParams as Ut, validateDevicePairListParams as V, AgentsFilesListParamsSchema as Va, ConfigApplyParamsSchema as Vi, validateWebLoginWaitParams as Vn, WebPushVapidPublicKeyParams as Vr, validateSessionsDescribeParams as Vt, validateDeviceTokenRevokeParams as W, AgentsFilesSetResultSchema as Wa, ConfigSchemaLookupParamsSchema as Wi, validateWebPushUnsubscribeParams as Wn, NodeInvokeParamsSchema as Wr, validateSessionsMessagesUnsubscribeParams as Wt, validateExecApprovalRequestParams as X, SkillsDetailParamsSchema as Xa, UpdateStatusParamsSchema as Xi, WizardCancelParamsSchema as Xn, NodePairRequestParamsSchema as Xr, validateSessionsSendParams as Xt, validateExecApprovalGetParams as Y, ModelsListParamsSchema as Ya, UpdateRunParamsSchema as Yi, validateWizardStatusParams as Yn, NodePairRemoveParamsSchema as Yr, validateSessionsResolveParams as Yt, validateExecApprovalResolveParams as Z, SkillsDetailResultSchema as Za, CommandsListParamsSchema as Zi, WizardNextParamsSchema as Zn, NodePairVerifyParamsSchema as Zr, validateSessionsUsageParams as Zt, validateChannelsStatusParams as _, TalkSessionCreateParamsSchema as _a, ResponseFrameSchema as _i, validateTalkSessionAppendAudioParams as _n, SessionsPatchResult as _o, SessionsCompactParamsSchema as _r, validateNodePendingAckParams as _t, validateAgentsCreateParams as a, TalkCatalogResultSchema as aa, ChatEventSchema as ai, validateSkillsUploadChunkParams as an, SkillsUploadCommitParamsSchema as ao, TaskSummarySchema as ar, validateNodeDescribeParams as at, validateChatEvent as b, TalkSessionJoinResultSchema as ba, ExecApprovalGetParamsSchema as bi, validateTalkSessionCloseParams as bn, PluginRunContextGetParams as bo, SessionsCompactionListParamsSchema as br, validateNodePresenceAlivePayload as bt, validateAgentsFilesListParams as c, TalkClientToolCallParamsSchema as ca, ChatSendParamsSchema as ci, validateTalkCatalogResult as cn, ToolsInvokeParamsSchema as co, TasksGetParamsSchema as cr, validateNodeInvokeParams as ct, validateAgentsUpdateParams as d, TalkConfigResultSchema as da, ConnectParamsSchema as di, validateTalkClientToolCallParams as dn, AgentIdentityResultSchema as do, TasksListResultSchema as dr, validateNodePairApproveParams as dt, ChannelsStartParamsSchema as ea, NodePendingDrainResultSchema as ei, validateSkillsInstallParams as en, SkillsSearchResultSchema as eo, WizardStartResultSchema as er, validateExecApprovalsNodeSetParams as et, validateArtifactsDownloadParams as f, TalkEventSchema as fa, ErrorShapeSchema as fi, validateTalkClientToolCallResult as fn, AgentParamsSchema as fo, PresenceEntrySchema as fr, validateNodePairListParams as ft, validateChannelsStartParams as g, TalkSessionCloseParamsSchema as ga, RequestFrameSchema as gi, validateTalkModeParams as gn, WakeParamsSchema as go, SessionsCleanupParamsSchema as gr, validateNodePairVerifyParams as gt, validateChannelsLogoutParams as h, TalkSessionCancelTurnParamsSchema as ha, HelloOkSchema as hi, validateTalkEvent as hn, SendParamsSchema as ho, SessionsAbortParamsSchema as hr, validateNodePairRequestParams as ht, validateAgentWaitParams as i, TalkCatalogParamsSchema as ia, NodePresenceAliveReasonSchema as ii, validateSkillsUploadBeginParams as in, SkillsUploadChunkParamsSchema as io, PluginsUiDescriptorsParamsSchema as ir, validateModelsListParams as it, validateConfigSetParams as j, ArtifactsGetParamsSchema as ja, ErrorCodes as ji, validateTasksCancelParams as jn, SessionsSendParamsSchema as jr, validateSendParams as jt, validateConfigSchemaLookupResult as k, ArtifactSummarySchema as ka, EnvironmentsStatusParamsSchema as ki, validateTalkSpeakParams as kn, OperatorScope as ko, SessionsResetParamsSchema as kr, validateSecretsResolveParams as kt, validateAgentsFilesSetParams as l, TalkClientToolCallResultSchema as la, LogsTailParamsSchema as li, validateTalkClientCreateParams as ln, AgentEventSchema as lo, TasksGetResultSchema as lr, validateNodeInvokeResultParams as lt, validateArtifactsListParams as m, TalkSessionCancelOutputParamsSchema as ma, GatewayFrameSchema as mi, validateTalkConfigResult as mn, PollParamsSchema as mo, StateVersionSchema as mr, validateNodePairRemoveParams as mt, validateAgentIdentityParams as n, ChannelsStatusResultSchema as na, NodePendingEnqueueResultSchema as ni, validateSkillsStatusParams as nn, SkillsUpdateParamsSchema as no, WizardStatusResultSchema as nr, validateLogsTailParams as nt, validateAgentsDeleteParams as o, TalkClientCreateParamsSchema as oa, ChatHistoryParamsSchema as oi, validateSkillsUploadCommitParams as on, ToolsCatalogParamsSchema as oo, TasksCancelParamsSchema as or, validateNodeEventParams as ot, validateArtifactsGetParams as p, TalkSessionAppendAudioParamsSchema as pa, EventFrameSchema as pi, validateTalkConfigParams as pn, MessageActionParamsSchema as po, SnapshotSchema as pr, validateNodePairRejectParams as pt, validateEnvironmentsStatusParams as q, AgentsUpdateParamsSchema as qa, ConfigSchemaResponseSchema as qi, validateWizardNextParams as qn, NodePairListParamsSchema as qr, validateSessionsPreviewParams as qt, validateAgentParams as r, ChannelsStopParamsSchema as ra, NodePresenceAlivePayloadSchema as ri, validateSkillsUpdateParams as rn, SkillsUploadBeginParamsSchema as ro, WizardStepSchema as rr, validateMessageActionParams as rt, validateAgentsFilesGetParams as s, TalkClientCreateResultSchema as sa, ChatInjectParamsSchema as si, validateTalkCatalogParams as sn, ToolsEffectiveParamsSchema as so, TasksCancelResultSchema as sr, validateNodeEventResult as st, formatValidationErrors as t, ChannelsStatusParamsSchema as ta, NodePendingEnqueueParamsSchema as ti, validateSkillsSearchParams as tn, SkillsStatusParamsSchema as to, WizardStatusParamsSchema as tr, validateExecApprovalsSetParams as tt, validateAgentsListParams as u, TalkConfigParamsSchema as ua, LogsTailResultSchema as ui, validateTalkClientCreateResult as un, AgentIdentityParamsSchema as uo, TasksListParamsSchema as ur, validateNodeListParams as ut, validateChannelsStopParams as v, TalkSessionCreateResultSchema as va, ShutdownEventSchema as vi, validateTalkSessionCancelOutputParams as vn, PluginAgentEventSubscriptionRegistration as vo, SessionsCompactionBranchParamsSchema as vr, validateNodePendingDrainParams as vt, validateCommandsListParams as w, TalkSessionTurnResultSchema as wa, ExecApprovalsSetParamsSchema as wi, validateTalkSessionJoinResult as wn, PluginSessionExtensionRegistration as wo, SessionsDescribeParamsSchema as wr, validatePluginsUiDescriptorsParams as wt, validateChatHistoryParams as x, TalkSessionOkResultSchema as xa, ExecApprovalRequestParamsSchema as xi, validateTalkSessionCreateParams as xn, PluginRunContextPatch as xo, SessionsCompactionRestoreParamsSchema as xr, validateNodeRenameParams as xt, validateChatAbortParams as y, TalkSessionJoinParamsSchema as ya, TickEventSchema as yi, validateTalkSessionCancelTurnParams as yn, PluginControlUiDescriptor as yo, SessionsCompactionGetParamsSchema as yr, validateNodePendingEnqueueParams as yt, validateCronUpdateParams as z, AgentsFilesGetParamsSchema as za, CronStatusParamsSchema as zi, validateWakeParams as zn, WebPushUnsubscribeParams as zr, validateSessionsCreateParams as zt };