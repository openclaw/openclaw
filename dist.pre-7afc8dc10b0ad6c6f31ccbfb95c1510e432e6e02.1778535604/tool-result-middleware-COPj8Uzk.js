...
import { a as resolvePluginControlPlaneFingerprint } from "./plugin-metadata-snapshot-_DHvku_p.js";
import { t as createSubsystemLogger } from "./subsystem-BIU8gc5f.js";
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-D8nuaUJM.js";
import "./model-selection-DmMcdmk8.js";
import { d as isGoogleModelApi, u as isGemma4ModelRequiringReasoningStrip } from "./pi-embedded-helpers-CtFVlC7o.js";
import { t as log$1 } from "./logger-CYMsG1R-.js";
import { E as shouldPreserveThinkingBlocks } from "./provider-model-shared-DcESXin-.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-D4d5LcaD.js");
