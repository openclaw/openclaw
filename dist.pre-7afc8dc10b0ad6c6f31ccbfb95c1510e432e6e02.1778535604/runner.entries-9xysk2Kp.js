...
import { E as pathExists, i as writeExternalFileWithinRoot } from "./fs-safe-Cew-WMeL.js";
...
import { i as runExec } from "./exec-B7osikex.js";
import { t as resolveSystemBin } from "./resolve-system-bin-lyTqsnQ9.js";
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-D_SGwGma.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-CmInKSto.js";
import { t as describeImageWithModel } from "./image-runtime-hfNfTFQH.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-CLVgZF5j.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-Ck6KRI6u.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-W5fob6fO.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-D2ATchdd.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-BtbaySQJ.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
