import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-DDYivJnt.js";
import { r as loadCrestodianOverview } from "./overview-CFN5YmRw.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-DcREMrCP.js")).planCrestodianCommand)({
		input,
		overview
	});
