...
import { i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-DDEl6txh.js";
import { c as normalizeAgentId, s as isValidAgentId } from "./session-key-CuQ3FxQd.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-bmagiEt7.js";
...
import { p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-lNqw1IL2.js";
import "./config-Cj3XPIio.js";
import "./operator-scopes-mN0Xhtlq.js";
import { r as isAdminOnlyMethod } from "./method-scopes-BwxgjVYa.js";
import { i as callGateway } from "./call-CKSu2SYN.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-eThraPUD.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DLssgbug.js";
import { i as resolveContextEngine } from "./registry-B9lTeeCB.js";
import { h as stringifyRouteThreadId } from "./channel-route-DBwZtt8r.js";
import { i as normalizeDeliveryContext, r as mergeDeliveryContext } from "./delivery-context.shared-CrLprOU4.js";
import { n as mergeSessionEntry } from "./types-B3t5vtaO.js";
import { s as updateSessionStore } from "./store-DjyTbZFp.js";
import "./sessions-DgIxQTHN.js";
import { p as resolveSubagentSpawnModelSelection } from "./model-selection-DmMcdmk8.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-s1PiPYtR.js";
import { u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BUD1z2SY.js";
import { a as normalizeSpawnedRunMetadata, i as mapToolContextToSpawnedRunMetadata, r as resolveSubagentTargetPolicy, s as resolveSpawnedWorkspaceInheritance, t as resolveRequesterOriginForChild } from "./spawn-requester-origin-Bm28t9uc.js";
import { a as getSubagentDepthFromSessionStore, r as resolveSubagentCapabilities } from "./subagent-capabilities-DboN0s7s.js";
import { n as countActiveRunsForSession, r as registerSubagentRun } from "./subagent-registry-spawn-runtime-7sEZz9Fa.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-0HAVhGHj.js";
import { t as ensureContextEnginesInitialized } from "./init-BwDpz1Tk.js";
import { m as resolveGatewaySessionStoreTarget, u as pruneLegacyStoreKeys } from "./session-utils-Hmfko1cF.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-DCExQgBw.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-d6OU1q1F.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-B-PdnjAX.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-CT5pV31z.js";
import { c as resolveMainSessionAlias, o as resolveDisplaySessionKey, s as resolveInternalSessionKey } from "./sessions-helpers-BsPY0uFn.js";
...
const SUBAGENT_SPAWN_SANDBOX_MODES = ["inherit", "require"];
...
async function spawnSubagentDirect(params, ctx) {
	...
	const effectiveRole = params.drainsContinuationDelegateQueue ? "orchestrator" : childCapabilities.role;
	const effectiveControlScope = params.drainsContinuationDelegateQueue ? "children" : childCapabilities.controlScope;
	...
	let childSystemPrompt = buildSubagentSystemPrompt({
		...
		childDepth,
		maxSpawnDepth,
		toolNames: params.drainsContinuationDelegateQueue === true && childDepth < maxSpawnDepth && !cfg.tools?.subagents?.tools?.deny?.includes("continue_delegate") ? ["continue_delegate"] : void 0
	});
	...
	try {
		registerSubagentRun({
			...
			...params.drainsContinuationDelegateQueue ? { drainsContinuationDelegateQueue: true } : {},
			...params.continuationTargetSessionKey ? { continuationTargetSessionKey: params.continuationTargetSessionKey } : {},
			...params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 ? { continuationTargetSessionKeys: params.continuationTargetSessionKeys } : {},
			...params.continuationFanoutMode ? { continuationFanoutMode: params.continuationFanoutMode } : {},
...
//#endregion
export { SUBAGENT_SPAWN_SANDBOX_MODES as a, SUBAGENT_SPAWN_ACCEPTED_NOTE as c, SUBAGENT_SPAWN_MODES as i, SUBAGENT_SPAWN_SESSION_ACCEPTED_NOTE as l, spawnSubagentDirect as n, splitModelRef as o, SUBAGENT_SPAWN_CONTEXT_MODES as r, normalizeSubagentTaskName as s, __testing as t, decodeStrictBase64 as u };
