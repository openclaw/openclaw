...
import { a as resolveAgentDir } from "./agent-scope-config-bmagiEt7.js";
...
import { i as emitAgentEvent } from "./agent-events-D-QDM7gD.js";
import { f as markDiagnosticSessionProgress } from "./diagnostic-CkLscAbT.js";
import { a as toAcpRuntimeError } from "./errors-DreUKU8A.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-C74Oh8hz.js";
import { o as generateSecureUuid } from "./secure-random-BpYYgsJ4.js";
import { s as hasOutboundReplyContent } from "./reply-payload-B5t8JnF3.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-pf1Ffs8H.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-B0QMgApv.js";
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-C0EQ0l6b.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-IcLKETse.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-BKkOUyFe.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-Dg-NL91P.js";
import { r as prefixSystemMessage } from "./system-message-BVxpJhws.js";
import { t as hasInboundMedia } from "./inbound-media-fDmLjn2C.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-B3SFymvc.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-DKVbGcDU.js";
...
const channelPluginRuntimeLoader = createLazyImportLoader(() => import("./plugins-BTwnJYqs.js"));
const messageActionRuntimeLoader = createLazyImportLoader(() => import("./message-action-runner-DbbG9qZh.js"));
...
function createAcpDispatchDeliveryCoordinator(params) {
	...
	const deliver = async (kind, payload, meta) => {
		...
		const rawFinalText = kind === "final" ? normalizeOptionalString(payload.text) : void 0;
		if (rawFinalText) {
