...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-5_1lUt6y.js";
import "./ssrf-runtime-CkUGpkoc.js";
import "./retry-runtime-BB-8cXoo.js";
import "./secret-input-runtime-BlUj5J8-.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-BMj1S_p4.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-Dtb8w4Yh.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-COlwhlmU.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-DVVLocdO.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BPONrntu.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-bk5mmOd_.js"), import("./logging-DggFqhra.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BA16_Xol.js").then((credentialsReadModule) => ({
