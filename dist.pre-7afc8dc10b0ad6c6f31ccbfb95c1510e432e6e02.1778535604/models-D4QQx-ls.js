...
function normalizeCopilotResolvedModelHeaders(ctx) {
	...
	if (contextProvider !== "github-copilot" || modelProvider !== "github-copilot") return;
	return {
		...ctx.model,
		headers: {
...
//#endregion
export { resolveCopilotForwardCompatModel as i, fetchCopilotModelCatalog as n, normalizeCopilotResolvedModelHeaders as r, PROVIDER_ID as t };
