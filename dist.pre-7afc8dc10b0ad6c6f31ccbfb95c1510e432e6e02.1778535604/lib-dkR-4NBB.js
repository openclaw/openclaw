...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-CdTANpt6.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BWM-9mp0.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-bm2UVojj.js";
import { l as toRatio, n as decodeString } from "./Util-ClC_gHzz.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CU_bvzvl.js";
import { t as APEv2Parser } from "./APEv2Parser-DfXiRV7n.js";
import { r as hasID3v1Header } from "./ID3v1Parser-COByPSod.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-Nv_rgROH.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CZEfJNlu.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BCNNcq4V.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser--qL72-Dx.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-T05bd_0W.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BYQ5Vt4x.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CzqpKcxm.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-xTurBObl.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-iyEfrB_I.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-uEanHIy3.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BH3-xTNz.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-pPsydL3y.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Brvnwrag.js")).WaveParser;
	}
};
//#endregion
