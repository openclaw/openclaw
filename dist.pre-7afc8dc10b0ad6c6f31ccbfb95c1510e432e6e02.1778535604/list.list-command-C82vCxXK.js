...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-BHJdb5-l.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-Dht_idjU.js";
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-Tk9OL05P.js";
import { C as modelKey, T as parseModelRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-DEFYGBdW.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-DjjGW9M-.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-Bsv_7FxN.js";
import { n as loadModelsConfigWithSource } from "./load-config-BmUlhc_l.js";
import { n as formatErrorWithStack } from "./list.errors-BhvfHxY-.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-BlfjdMw5.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-DB7hMENh.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-sy1crgMj.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-LFGdI2T6.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BascoMK6.js"),
		import("./agent-scope-CaaWQWiN.js"),
		import("./workspace-CR8pG-21.js")
	]);
