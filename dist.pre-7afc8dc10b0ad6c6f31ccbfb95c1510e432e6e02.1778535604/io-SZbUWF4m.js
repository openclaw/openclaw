...
import { c as planManifestModelCatalogSuppressions } from "./manifest-KJatbPY9.js";
import { n as resolveManifestCommandAliasOwnerInRegistry } from "./manifest-command-aliases-At6Dhdtw.js";
...
import { d as resolveMemorySlotDecision, l as resolveEffectivePluginActivationState, o as normalizePluginId, s as normalizePluginsConfig } from "./config-state-CRUVAZgB.js";
...
import { t as loadDotEnv } from "./dotenv-CNHsGOfl.js";
import { c as writePersistedInstalledPluginIndexInstallRecordsSync, i as resolveInstalledPluginIndexRecordsStorePath } from "./installed-plugin-index-records-DtV8NFVy.js";
...
import { v as resolveBundledProviderPolicySurface } from "./thinking-lNqw1IL2.js";
import { n as normalizeTalkConfig } from "./talk-C4gXVsBE.js";
...
import { n as listKnownChannelEnvVarNames } from "./channel-env-vars-BAAU_I14.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-WV0mVBYH.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-DzTjSvv0.js";
...
function resolvePersistCandidateForWrite(params) {
	...
	return normalizeAgentDefaultModelRefsForWrite(preserveAuthoredAgentParams({
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
	if (!raw || typeof raw !== "object") return [];
	const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-tU282Zzb.js");
