...
import { a as asRecord } from "./record-coerce-CH8CSzQH.js";
import { n as detectMime } from "./mime-DuIvuBVG.js";
import { t as resolveNodeFromNodeList } from "./node-resolve-DEuBTKqf.js";
...
import { a as CANVAS_HOST_PATH, c as isA2uiPath, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload } from "./a2ui-CZhdNWjK.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-VVleTARz.js");
