...
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-2nnfxxWy.js";
...
import { g as resolvePinnedHostnameWithPolicy } from "./ssrf-z-OH9PRk.js";
import { t as createMessageReceiptFromOutboundResults } from "./receipt-BzUE-jS6.js";
import { i as createHybridChannelConfigAdapter, l as createScopedDmSecurityResolver } from "./channel-config-helpers-B4oQiCpN.js";
import { t as buildAgentSessionKey } from "./resolve-route-B3f0n0oj.js";
import "./text-runtime-BwGO-OOf.js";
import { i as createChatChannelPlugin } from "./core-CQ0EhoHb.js";
import "./channel-core-C8jQgAm5.js";
import "./routing-D89Ljvsv.js";
import { a as waitUntilAbort } from "./channel-lifecycle.core-CbnSu8Y6.js";
import { t as createPluginRuntimeStore } from "./runtime-store-Gsztj7De.js";
import "./channel-config-schema-wNbJrSII.js";
import { T as projectAccountWarningCollector, b as createConditionalWarningCollector, h as composeWarningCollectors, w as projectAccountConfigWarningCollector } from "./channel-policy-BAbLgp6f.js";
import { o as resolveStableChannelMessageIngress } from "./runtime-NRQKnphg.js";
import { n as createEmptyChannelDirectoryAdapter } from "./directory-runtime-Cqz0lLmF.js";
import "./runtime-env-B1r2kK7q.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-v1FSi1ry.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-CFkoG3uc.js";
...
import "./extension-shared-GNA0Bbrh.js";
import "./channel-lifecycle-DKl5ZvEM.js";
import "./channel-ingress-runtime-Cazt9h9n.js";
import { r as defineChannelMessageAdapter } from "./channel-message-DLRlnHTh.js";
import { a as createFixedWindowRateLimiter } from "./webhook-ingress-ATbUhfx-.js";
import { a as createWebhookInFlightLimiter, i as beginWebhookRequestPipelineOrReject } from "./webhook-request-guards-DsJn4zAu.js";
import { t as zod_exports } from "./zod-BILJI2PX.js";
import { i as resolveAccount, n as synologyChatSetupWizard, r as listAccountIds, t as synologyChatSetupAdapter } from "./setup-surface-DH6ZBTvY.js";
import { t as collectSynologyChatSecurityAuditFindings } from "./security-audit-DmrAzLpE.js";
...
let lastSendTime = 0;
const ChatUserSchema = zod_exports.z.object({
	user_id: zod_exports.z.number(),
	username: zod_exports.z.string().optional(),
	nickname: zod_exports.z.string().optional()
}).transform((user) => ({
	user_id: user.user_id,
	username: user.username ?? "",
	nickname: user.nickname ?? ""
}));
const ChatUserListResponseSchema = zod_exports.z.object({
	success: zod_exports.z.boolean(),
	data: zod_exports.z.object({ users: zod_exports.z.array(zod_exports.z.unknown()).optional().transform((users) => (users ?? []).flatMap((user) => {
