...
import { p as resolveUserPath, y as truncateUtf16Safe } from "./utils-927g1oFZ.js";
...
import { a as freezeDiagnosticTraceContext, i as formatDiagnosticTraceparent, r as createDiagnosticTraceContextFromActiveScope, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-daKTvE-j.js";
...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-CqtHN2dI.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-CxTmAjhY.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-XX_C3efK.js";
import { a as listRegisteredAgentHarnesses } from "./registry-B94RMNbn.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-eThraPUD.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-DLssgbug.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BgjLdu4s.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-B9lTeeCB.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-D-QDM7gD.js";
import { u as resolveStorePath } from "./paths-BnX-evip.js";
import { t as loadSessionStore } from "./store-load-Dl9FHzUQ.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-DjyTbZFp.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-Uv3avQ0Q.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-BwLmcKuA.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-CQUFFHBe.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-D8nuaUJM.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-DmMcdmk8.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-BaYQmWrX.js";
...
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-YL9ro8w8.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-s1PiPYtR.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-DboN0s7s.js";
import { n as resolveAgentHarnessPolicy } from "./agent-runtime-metadata-B7LhA556.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-CGE_H8UJ.js";
import { t as parseInlineDirectives } from "./directive-tags-D5cnXRTK.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-D1PNhbvz.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-DOGm5yak.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-Bm4_xOG4.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-B-PdnjAX.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-BsPY0uFn.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-BGh2C-DM.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-DtOKzCn-.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-BDjd1p69.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DX16zuOP.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-CL6SJsVK.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-CR-weGvf.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BPyp67rY.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-BQ5OLY8T.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-B5t8JnF3.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-VK2LN6fh.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-VXJOjzmO.js";
import { a as isTimeoutError } from "./failover-error-D8XVsnCj.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-DJ6C7WVJ.js";
import { D as stripProviderPrefix, E as isStrictAgenticSupportedProviderModel, O as isEmbeddedMode, d as resolveToolLoopDetectionConfig } from "./openclaw-tools-PNBB7NZA.js";
import { t as getMachineDisplayName } from "./machine-name-dk-htx7T.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DuIvuBVG.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DsUgFn_y.js";
import { i as getPluginToolMeta } from "./tools-CZ_e0oA2.js";
import { n as redactConfigObject } from "./redact-snapshot-DKWguexK.js";
import { n as resolveCommitHash } from "./git-commit-DIZ-dAyR.js";
import { t as resolveOsSummary } from "./os-summary-Cj-_s0MR.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-B_NvPLK3.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-BsXVaISm.js";
import { d as parseBooleanValue } from "./frontmatter-CiZCud2y.js";
import { B as buildStreamErrorAssistantMessage, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getHistoryLimitFromSessionKey, F as resolveCompactionTimeoutMs, H as collectRuntimeChannelCapabilities, I as isCacheTtlEligibleProvider, J as dropReasoningFromHistory, K as toClientToolDefinitions, L as readLastCacheTtlTimestamp, O as buildEmbeddedExtensionFactories, R as guardSessionManager, S as normalizeAssistantReplayContent, T as buildEmbeddedMessageActionDiscoveryInput, U as createClientToolNameConflictError, W as findClientToolNameConflicts, X as isZeroUsageEmptyStopAssistantTurn, Y as dropThinkingBlocks, Z as isReasoningTagProvider, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as prewarmSessionFile, c as PI_RESERVED_TOOL_NAMES, d as toSessionToolAllowlist, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, l as collectAllowedToolNames, m as createSystemPromptOverride, o as mapThinkingLevel, p as buildEmbeddedSystemPrompt, q as assessLastAssistantMessage, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectRegisteredToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as repairSessionFileIfNeeded } from "./compaction-successor-transcript-Bh5TOWxL.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-BHy4swau.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DNXfPZMj.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-CIJ70WVE.js";
import { _ as resolveChannelReactionGuidance, h as resolveChannelMessageToolHints, m as listChannelSupportedActions } from "./pi-tools.before-tool-call-DkJi3XgM.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-BPq5dR5t.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-COPj8Uzk.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BEwmzi6C.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-D9j4s93E.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-C1IxJc2e.js";
import "./pi-bundle-mcp-tools-qDUFa5UZ.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-8s3rjlx8.js";
import { S as isMessagingToolSendAction, _ as isToolResultError, b as sanitizeToolResult, d as runAgentCleanupStep, f as extractMessagingToolSend, g as filterToolResultMediaUrls, h as extractToolResultText, l as logAgentRuntimeToolDiagnostics, m as extractToolResultMediaArtifact, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolErrorMessage, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as normalizeAgentRuntimeTools, v as isToolResultTimedOut, x as isMessagingTool, y as sanitizeToolArgs } from "./attempt.tool-run-context-fCy1HM7P.js";
import { r as parseFenceSpans } from "./fences-x7v0LHlT.js";
import { r as splitMediaFromOutput } from "./parse-CtHFKpE7.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-DA082tfm.js";
import { h as parseReplyDirectives } from "./deliver-16CUbVI5.js";
...
import { f as hasCommittedMessagingToolDeliveryEvidence, p as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-CMeHjfaG.js";
import { f as buildApiErrorObservationFields, p as buildTextObservationFields } from "./model-fallback-G_M26YoR.js";
import { t as log$4 } from "./logger-CYMsG1R-.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-IT-8V0Nw.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-CVZ7pS3t.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CALkUU-U.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-BHVzbeoQ.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-DWY-2w-y.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-De1nXOGV.js";
import { a as resolveSubagentToolPolicyForSession, n as resolveEffectiveToolPolicy, r as resolveGroupToolPolicy } from "./pi-tools.policy-BUvUrUc5.js";
...
import { n as buildSubagentList } from "./subagent-list-D_O3E-Dn.js";
import { o as listControlledSubagentRuns } from "./subagent-control-YFLtu9ya.js";
...
import { g as streamWithPayloadPatch } from "./provider-model-shared-DcESXin-.js";
import { g as sanitizeTransportPayloadText, m as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-BhW5c7-W.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-CaMdqN91.js";
import { o as resolveSandboxContext } from "./sandbox-DMvzpYRa.js";
import { t as detectRuntimeShell } from "./shell-utils-rp2gkOrZ.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-pEtfAq42.js";
import { s as resolveSkillsPromptForRun } from "./workspace-By40G4f5.js";
import "./skills-WEWDU9BJ.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-kvAV5OTi.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-B-x75KLp.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-BS4WWZLn.js";
import { n as appendAgentBootstrapSystemPromptSupplement, r as appendModelIdentitySystemPrompt } from "./system-prompt-config-CQK5n_tF.js";
import "./tool-loop-detection-BVf4j-09.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-CZg7LGwE.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DX4rM4Q1.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-BlM4GjsP.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-RXkDQwJp.js";
...
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-CIuEdkSE.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-DY0_hcO9.js";
import { a as buildAfterTurnRuntimeContext, c as mergeOrphanedTrailingUserPrompt, d as resolveAttemptPrependSystemContext, f as resolvePromptBuildHookResult, g as shouldWarnOnOrphanedUserRepair, h as shouldInjectHeartbeatPrompt, i as shouldPersistCompletedBootstrapTurn, l as prependSystemPromptAddition, m as resolvePromptSubmissionSkipReason, n as composeSystemPromptWithHookContext, o as buildAfterTurnRuntimeContextFromUsage, p as resolvePromptModeForSession, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded, u as resolveAttemptFsWorkspaceOnly } from "./attempt.thread-helpers-B3UxUucC.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-BglQVb2c.js";
import { t as detectAndLoadPromptImages } from "./images-BpnqNMWx.js";
import { a as resolveRuntimeContextPromptParts, i as queueRuntimeContextForNextTurn, n as buildRuntimeContextSystemContext, t as buildCurrentTurnPromptContextPrefix } from "./runtime-context-prompt-B1aFyKR0.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-D9sac19Y.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-DKHoOF5l.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-CJr1e3cV.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-rR1C3B9P.js"));
		...
		try {
			...
			try {
				...
				try {
					...
					const promptForModel = [promptSubmission.runtimeOnly ? "" : buildCurrentTurnPromptContextPrefix(params.currentTurnContext), promptSubmission.prompt].filter(Boolean).join("\n\n");
			...
			try {
				await cleanupEmbeddedAttemptResources({
					...
					bundleLspRuntime,
					sessionLock,
					aborted: Boolean(params.abortSignal?.aborted) || aborted || timedOut || idleTimedOut || timedOutDuringCompaction
				});
			} catch (err) {
				cleanupError = err;
			}
