...
import { r as extractFirstTextBlock } from "./chat-message-content-BwLmcKuA.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-CP682Q37.js"),
			import("./client-lzd2nslg.js"),
			import("./client-start-readiness-o7gAYU95.js"),
			import("./method-scopes-C4DSmXsP.js"),
			import("./client-info-DxtRXhF-.js")
		]);
