...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-CFN5YmRw.js";
import { r as resolveCrestodianOperation } from "./dialogue-DsrGcwcD.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-D22d9k7s.js")).runCrestodianTui;
	opts.onReady?.();
