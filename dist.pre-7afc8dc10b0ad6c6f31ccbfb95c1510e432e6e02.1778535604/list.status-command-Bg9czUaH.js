...
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-bmagiEt7.js";
import { i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride } from "./agent-scope-BnhYEQue.js";
import { r as writeRuntimeJson } from "./runtime-Bd9_VI2J.js";
import { G as getShellEnvAppliedKeys, Y as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-SZbUWF4m.js";
...
import { u as resolveAuthStorePathForDisplay } from "./source-check-DuCLYDLT.js";
import { h as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-B6VhslyM.js";
import { a as openAIProviderUsesCodexRuntimeByDefault, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-Tk9OL05P.js";
import { N as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-D8nuaUJM.js";
import { C as modelKey, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-DEFYGBdW.js";
...
import "./profiles-BZlI7O8p.js";
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-Cmwzf1CP.js";
import { b as resolveProviderEnvAuthEvidence, u as isNonSecretApiKeyMarker, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-CIy9u4j1.js";
import { t as resolveEnvApiKey } from "./model-auth-env-DmMVe4Ea.js";
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-DjjGW9M-.js";
import "./workspace-DNXfPZMj.js";
import { t as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-Bsv_7FxN.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Bm18NiSG.js";
import { t as maskApiKey } from "./mask-api-key-BXr8-PV2.js";
import { t as loadModelsConfig } from "./load-config-BmUlhc_l.js";
import { n as isRich } from "./list.format-BlfjdMw5.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-Pvf0OVbq.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-Cdby4XSr.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-BGVGXWkA.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-CPy62RaA.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	const resolveProviderAuthHealthId = (provider) => resolveProviderIdForAuth(provider, {
		config: cfg,
		workspaceDir
	});
	const hasUsableNonProfileAuth = (provider) => {
	...
	const hasUsableProviderAuth = (provider) => {
		const authProvider = resolveProviderAuthHealthId(provider);
		for (const candidate of new Set([provider, authProvider])) if (resolveAuthProfileOrder({
			cfg,
			store,
			provider: candidate
		}).length > 0 || hasUsableNonProfileAuth(candidate)) return true;
		return false;
	};
	const hasUsableAuthForProviderInUse = (provider, options) => {
		...
		return openAIProviderUsesCodexRuntimeByDefault({
			provider,
			config: cfg
		}) && hasUsableProviderAuth("openai-codex");
	};
	...
	const checkStatus = (() => {
		...
		for (const usage of providerUses) {
			...
			if (usage.allowCodexRuntimeFallback && openAIProviderUsesCodexRuntimeByDefault({
				...
				config: cfg
			}) && hasUsableProviderAuth("openai-codex")) providersInUse.add(OPENAI_CODEX_PROVIDER_ID);
		}
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-DeWUGWB8.js");
		runtime.log("");
