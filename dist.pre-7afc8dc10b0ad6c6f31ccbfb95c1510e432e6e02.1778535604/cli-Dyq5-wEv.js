...
import { n as matrixSetupAdapter } from "./setup-core-CTvdgSUG.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-D32e-Xw9.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BzXz7xbO.js";
import { t as withResolvedActionClient } from "./client-DOR1D25U.js";
import { r as resolveMatrixAuthContext } from "./config-D26edBd1.js";
import "./client-CBwkQyTM.js";
import "./runtime-api-B36iooH0.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-BxI9E7QL.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DwycPRrO.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CCSyDJOr.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-D26DA5eX.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DXy9amMw.js");
