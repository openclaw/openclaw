...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-SZbUWF4m.js";
import { n as formatConfigIssueLines } from "./issue-format-BFLj-aOk.js";
import { t as note } from "./note-DSqXisNi.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-CLkxxEKe.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BiFoQ-gc.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-2V9kKfCG.js");
