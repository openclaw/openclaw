...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-SZbUWF4m.js";
import { n as formatConfigIssueLines } from "./issue-format-BFLj-aOk.js";
import { r as normalizeTalkSection } from "./talk-C4gXVsBE.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-ClEUgb-c.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DKk40tN1.js";
import { n as getLoadedChannelPlugin } from "./registry-DvmWjXsU.js";
import { i as listRouteBindings } from "./bindings-BbZ2MQQO.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-Cb7uVOR5.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-BNRds_xQ.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Cr2nFtfB.js";
import { t as note } from "./note-DSqXisNi.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-CLkxxEKe.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-pwJNRSkL.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-D0SRu_AC.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CmjqhlmJ.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BuOLYxp4.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CB5iT9bG.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-CeiMVmxO.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BrT_Keoq.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-MzQqmzKu.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CCop_4Fo.js");
		emitDoctorNotes({
			note,
