...
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-DuIvuBVG.js";
import "./local-file-access-o0Qf0g_M.js";
import { r as fetchWithTimeout } from "./fetch-timeout-CZuc415a.js";
import { n as MediaFetchError, r as fetchRemoteMedia } from "./fetch-CcVppDfI.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BbOZXKYP.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-CmInKSto.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-CLVgZF5j.js";
import { t as providerSupportsCapability } from "./provider-supports-DYgXW8-k.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-Ck6KRI6u.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-BIOlJlmx.js";
import { t as buildRandomTempFilePath } from "./temp-download-QitMUw9B.js";
import "./temp-path-DaPfiFhs.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-9xysk2Kp.js";
import "./shared-N4oAePRl.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-X0Scle4u.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-D2ATchdd.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BtbaySQJ.js");
