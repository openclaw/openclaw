...
Write-Host 'OpenClaw Gateway scheduled task registered successfully.' -ForegroundColor Green

# Start the task immediately
Start-ScheduledTask -TaskName 'OpenClaw Gateway'
Write-Host 'Gateway started. It will also auto-start at next login.' -ForegroundColor Green
