...
import { r as resolveDefaultMatrixAccountId } from "./accounts-Dtt6PcDY.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-CoZRr3iE.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DExRbAi8.js";
import { n as updateMatrixAccountConfig } from "./config-update-B_TLltyo.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-B6ZOTBbF.js");
