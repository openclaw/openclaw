...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-DKjUWHDL.js";
...
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-D8iFykAD.js";
import { l as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-qNSGkXbB.js";
...
import { S as resolveGroupSessionKey, u as updateSessionStore } from "./store-CuGD5gZu.js";
...
import { l as resolvePersistedOverrideModelRef } from "./model-selection-BSyRhVPt.js";
import { d as logSessionTurnCreated } from "./diagnostic-DB6je9Lu.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BmuX9QbQ.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-Dc7B13Zv.js";
...
import { c as resolveCliRuntimeExecutionProvider, o as listLegacyRuntimeModelProviderAliases } from "./model-runtime-aliases-bVlyEZ4v.js";
...
import { d as isContextOverflowError, g as isLikelyContextOverflowError, u as isCompactionFailureError, y as isTransientHttpError } from "./errors-DoRae_Ea.js";
...
import { D as isMessagingToolSendAction } from "./attempt.tool-run-context-Bdqo6ZlY.js";
import { d as parseReplyDirectives } from "./payloads-of2tFaq2.js";
import { o as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-MWvVmxb8.js";
import { n as hasCotFramePrefix } from "./normalize-reply-CCkkW10Y.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-D40Q_Sfv.js";
import { n as buildAgentRuntimeOutcomePlan } from "./build-C9y4fmul.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-D7DK58vE.js";
import { t as runCliAgent } from "./cli-runner-DozjHxxD.js";
...
import { a as resolveAgentTurnAttachments, n as createBlockReplyContentKey } from "./block-reply-pipeline-5awmA--c.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-DGKN28y6.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-30nuCiZC.js");
						...
						const result = await runEmbeddedPiAgentDefault({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-xRVZtPm0.js");
