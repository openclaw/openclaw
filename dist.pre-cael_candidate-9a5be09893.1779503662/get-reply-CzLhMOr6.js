...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-DKjUWHDL.js";
...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-D1eqrBeU.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DiPHgdft.js";
import { s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-A_7SSRlR.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-DRLDqDU8.js";
import { n as defaultRuntime } from "./runtime-yzlkhCoS.js";
import { r as logVerbose } from "./globals-BK0H3d3V.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-BuSu5uPJ.js";
import "./config-FC9eV8ec.js";
import { a as normalizeAnyChannelId } from "./registry-DgepP4xr.js";
import "./message-channel-core-Ctzb4SJ-.js";
import { r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-D8iFykAD.js";
import { o as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-CmqYxlZ2.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-qNSGkXbB.js";
import { t as resolveAgentHarnessPolicy } from "./policy-DuVL6jyT.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-B_VlHdCE.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-Bqn2eA2l.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BShGo5vM.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-D3q_5w0B.js";
import { a as normalizeDeliveryChannelRoute, n as deliveryContextFromSession, o as normalizeDeliveryContext, r as deliveryContextKey, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-ubhMwJVk.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths---FlWJ0A.js";
import { F as resolveSessionStoreEntry, O as parseSessionThreadInfoFast, t as loadSessionStore, w as resolveMaintenanceConfigFromInput } from "./store-load-DM26fo1a.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-BYZwq82n.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-BE4M2Iz0.js";
import { S as resolveGroupSessionKey, u as updateSessionStore, v as deriveSessionMetaPatch } from "./store-CuGD5gZu.js";
...
import { c as resolveSessionLifecycleTimestamps } from "./sessions-CtFd7seb.js";
...
import { d as resolveAndPersistSessionFile } from "./transcript-CkSJhWxP.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-D9lGAOqA.js";
import { n as modelKey } from "./model-selection-normalize-CWGJNik_.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-BSyRhVPt.js";
import { o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-CR2GrkTf.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-CyCjvPeP.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-Dc7B13Zv.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, d as stripHeartbeatToken } from "./heartbeat-B444HHRI.js";
import { a as generateSecureToken } from "./secure-random-B-x2FMyg.js";
import { a as enqueueSystemEvent, u as removeSystemEvents } from "./system-events-BqSflfol.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-Cc__1ixy.js";
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-Do5jP_HJ.js";
import { r as getCliSessionBinding } from "./cli-session-DM1kAZQz.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-DSvijuiN.js";
import { Et as isReasoningTagProvider } from "./selection-CIiYFLNC.js";
import { _ as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-Djz-MO2n.js";
import { l as ensureAgentWorkspace } from "./workspace-D9JVjqOO.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-Cfp3DEcJ.js";
import { s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-BDuxOMhN.js";
import "./pi-bundle-mcp-tools-D2wcwpyn.js";
import { w as collectTextContentBlocks } from "./attempt.tool-run-context-Bdqo6ZlY.js";
import "./delivery-context-C_WB0-Lw.js";
import { s as getMediaDir } from "./store-Do3AYy_l.js";
...
import { t as resolveQueueSettings } from "./queue-C1Mfys77.js";
import { t as buildOutboundSessionContext } from "./session-context-Dlzl7WJu.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-Do2oSuc_.js";
import { n as getSessionBindingService } from "./session-binding-service-Brz3TVSF.js";
...
import { l as resolveSilentReplySettings, s as resolveCurrentTurnImages } from "./agent-runner-execution-DNfbWOXt.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BrwjqMJ_.js";
import { s as hasInboundMedia } from "./block-reply-pipeline-5awmA--c.js";
import { a as noteActiveSessionForShutdown, n as buildSessionStartHookPayload, r as forgetActiveSessionForShutdown, t as buildSessionEndHookPayload } from "./session-hooks-CXiK1vNR.js";
import { r as drainFormattedSystemEventBlock } from "./session-updates-D1EqCGba.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CEw5j-Nr.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-Ca9bMYtv.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-Pk3zlYB6.js";
...
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-DBxptxIN.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-vbIos-Dh.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-CrHFTxVv.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Baeyp9TZ.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-C56E-riR.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-DElMkF9z.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-DLITNWKK.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-Da0vBWXR.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-CFBEdpFA.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-CUIK2D5D.js";
import { t as hasControlCommand } from "./command-detection-PIh0XkDE.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-ConhVHwD.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-hq5-Cgcc.js";
import { t as resolveFastModeState } from "./fast-mode-DqaSLWuY.js";
import { t as buildCommandContext } from "./commands-context-BzrnFQZM.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-DfduM6nu.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-CH7meDmc.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-U9duiYEA.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-C7TGXN26.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-MndW2Rk1.js";
import { t as extractExplicitGroupId } from "./group-id-D_13kMaO.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-kv4SRPbi.js";
...
import { t as isResetAuthorizedForContext } from "./reset-authorization-iIGIaiJI.js";
...
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-kr7P6tky.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-C8agFBQw.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DkwUWGaP.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-BqTj2vM7.js");
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-eifnTlex.js");
