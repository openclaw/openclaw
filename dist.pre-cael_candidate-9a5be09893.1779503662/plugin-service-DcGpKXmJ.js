...
import { m as resolveExistingPathsWithinRoot } from "./fs-safe-spIZMJL6.js";
import { i as getRuntimeConfig } from "./io-BxFubSMj.js";
import { Ni as ErrorCodes, Pi as errorShape } from "./protocol-DOSi8QvH.js";
import { c as jsonResult, g as readStringParam, s as imageResultFromFile } from "./common-CrEpgrS0.js";
...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-CBnr1f2I.js";
...
import { t as BrowserToolSchema } from "./browser-tool.schema-MKhHXUzR.js";
import { n as withTimeout } from "./sdk-security-runtime-9UfEv2TU.js";
import { R as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-VAuelypy.js";
import { i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-iCy0_HbL.js";
import "./sdk-setup-tools-C-mQaHtQ.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-XTCMqlYk.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-DRF3eDeb.js";
import { r as getBrowserProfileCapabilities } from "./target-id-CmUDeJDC.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-Cy84yWwq.js"),
