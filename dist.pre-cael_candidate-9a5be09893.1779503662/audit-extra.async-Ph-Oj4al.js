...
import { t as collectIncludePathsRecursive } from "./includes-scan-D1xQv-H7.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-DoiXe2IQ.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-KBzAiuMq.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-Cz6YyxUi.js");
...
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-DuV2icMs.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-DvMlyCFe.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-C9L_8-jR.js");
