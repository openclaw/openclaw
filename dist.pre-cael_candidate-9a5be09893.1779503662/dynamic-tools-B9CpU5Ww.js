...
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-CemEI13Y.js";
import { c as isToolWrappedWithBeforeToolCallHook, d as setBeforeToolCallDiagnosticsEnabled, p as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-B39uI8tH.js";
import { D as isMessagingToolSendAction, E as isMessagingTool, _ as extractToolResultMediaArtifact, n as createAgentToolResultMiddlewareRunner, y as filterToolResultMediaUrls } from "./attempt.tool-run-context-Bdqo6ZlY.js";
import "./routing-D0bd5zTX.js";
import { s as createCodexAppServerToolResultExtensionRunner } from "./agent-harness-runtime-BdPuqkuX.js";
import { c as runAgentHarnessAfterToolCallHook } from "./native-hook-relay-Cj7AOioh.js";
import { C as sanitizeInlineImageDataUrl, x as invalidInlineImageText } from "./thread-lifecycle-v7V01XCT.js";
	...
	return {
		...
		handleToolCall: async (call, options) => {
			...
			try {
				...
				}, terminalType), terminalType !== "blocked");
			} catch (error) {
				collectToolTelemetry({
					toolName: tool.name,
					args,
