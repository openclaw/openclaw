...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-B5idDZn1.js";
import { n as isAbortError } from "./unhandled-rejections-DmgKu1By.js";
import { t as createAsyncLock } from "./async-lock-CaiUOILd.js";
import { m as FsSafeError } from "./path-BlG8lhgR.js";
import { f as movePathToTrash } from "./fs-safe-spIZMJL6.js";
import { o as root } from "./secure-temp-dir-aidxCRgA.js";
import "./archive-X4nrziMN.js";
import { p as resolveUserPath } from "./utils-CAcKzQHY.js";
import { c as isSecretRef } from "./types.secrets-BcE0iOnr.js";
...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-D1eqrBeU.js";
import { c as measureDiagnosticsTimelineSpanSync, s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-A_7SSRlR.js";
...
import { a as logWarn, t as logDebug } from "./logger-BSBKEWuF.js";
import "./auth-CCZTHYGp.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-DlSgCnyd.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-BxFubSMj.js";
...
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-BuSu5uPJ.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-CJDCzAx6.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-DgdkBEdP.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-B32DTKh8.js";
import { t as validateJsonSchemaValue } from "./schema-validator-CoHaB3Uu.js";
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-DzIqAz79.js";
import "./config-FC9eV8ec.js";
import { n as isRestartEnabled } from "./commands.flags--jYs26Rh.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-DYRJe94X.js";
...
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-7PkZ65Le.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-D8Q4w1w3.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-CrQXj4lU.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BShGo5vM.js";
...
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CqawSGEb.js";
import { h as stringifyRouteThreadId } from "./channel-route-L2PJ-xNE.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-ubhMwJVk.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths---FlWJ0A.js";
import { t as loadSessionStore } from "./store-load-DM26fo1a.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BE4M2Iz0.js";
...
import { t as listConfiguredSessionStoreAgentIds } from "./targets-C_-PZhPd.js";
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-CtFd7seb.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-D9XwPMPN.js";
import { t as appendAssistantMessageToSessionTranscript } from "./transcript-CkSJhWxP.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-B9qYB9tg.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-6yGlEqpn.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CDaJsp3I.js";
...
import { i as removeProviderAuthProfilesWithLock } from "./profiles-CorIBNhJ.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-BSPIVexi.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-BqdKyAME.js";
...
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-CR2GrkTf.js";
...
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-C51gvBmz.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-ByBEV_lG.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-BqGZxEFC.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-BG19mF4s.js";
...
import { i as resolveSandboxConfigForAgent } from "./config-Ct04xgz1.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-sS2lf3LW.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-BqSflfol.js";
import { l as getTotalQueueSize } from "./command-queue-Cc__1ixy.js";
import { n as resolveSendPolicy } from "./send-policy-rKqghZEF.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-AijCbfn8.js";
import { d as normalizeCronJobCreate, i as triggerSessionPatchHook, p as normalizeCronJobPatch } from "./openclaw-tools-DOnbfRua.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-CnZl_vVX.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-CiyTJj8k.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-D9JVjqOO.js";
import { o as isTimeoutError } from "./failover-error-BE-soLvS.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CAvCjJvQ.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-of2tFaq2.js";
...
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-3bCiIMeB.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BxRCUzNV.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Bn6ApiDa.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-CYKBibC4.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DSpxZ7Q4.js";
import { f as listTaskRecords, s as getTaskById } from "./task-registry-B7WTToIp.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-L0fBJBWD.js";
import "./runtime-internal-MjFqCVxG.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-e4CJgoDP.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-DMeJvxm5.js";
import { a as clearSessionQueues } from "./queue-C1Mfys77.js";
...
import { i as resolveReplyToMode } from "./reply-threading-D8G61K-C.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-DDrod2iS.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-DuwutdHg.js";
import { t as sendDurableMessageBatch } from "./send-BuHwQmV3.js";
import "./runtime-CzmOeQD9.js";
import { n as normalizePollInput } from "./polls-C-v11_tu.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BEb-1ba6.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-CswdXPdi.js";
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-vRAfPy1w.js";
import { r as resolveOutboundTarget } from "./targets-Dlvq1FNW.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-CQPMwA0q.js";
import { s as dispatchChannelMessageAction } from "./message-action-runner-qYoVbBt8.js";
import "./target-resolver-BA4gFGtH.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-O18hbksi.js";
import { c as normalizeProviderStarted, l as formatBlockedLivenessError, s as normalizeAgentRunTimeoutPhase, u as isBlockedLivenessState } from "./run-wait-CWLMjxsj.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DvDp8cBn.js";
import { D as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, c as isTtsEnabled, d as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, k as textToSpeech, l as isTtsProviderConfigured, m as resolveExplicitTtsOverrides, o as getTtsProvider, r as getResolvedSpeechProviderConfig, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-CU_VhcvN.js";
import "./tts-DOwbfXIU.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-i-2n4QwG.js";
import "./skills-AgD9HbY-.js";
import { t as canExecRequestNode } from "./exec-defaults-DhftlxZW.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DfgbsQ8-.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-WIpYe1Ny.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-BGOJhpvM.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-EiPnoy6x.js";
import { r as getActiveMemorySearchManager } from "./memory-runtime-GNcuFeaO.js";
...
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-DPOvrpNp.js";
...
import { n as listPluginCommands } from "./commands-C1JFwoI-.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-D5PdqX_T.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DN6tBFz6.js";
import "./commands-registry-D9tiqfZP.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-OfuwsnJu.js";
import "./browser-maintenance-CUIK2D5D.js";
import { c as performGatewaySessionReset } from "./session-reset-service-NdPYFHXU.js";
...
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-PRHONWup.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CdxTxbpn.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-BMVPfx2x.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-5EL8rrUy.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-Dteg4qKK.js";
import "./server-constants-BGwLM6XN.js";
import { n as agentCommandFromIngress } from "./agent-command-Bb4GIWjm.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-C7GppvZZ.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-BA-gqDOl.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BrgkX7RP.js";
import { t as formatForLog } from "./ws-log-CyBY2uTB.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-Cj7AOioh.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-D7n2Pdhr.js";
import { t as loadModelCatalogForBrowse } from "./model-catalog-browse-BaN38huf.js";
import { i as warmCurrentProviderAuthState, t as clearCurrentProviderAuthState } from "./model-provider-auth-B8Fdd8Xl.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-CAQgsZwk.js";
import { a as getPairedDevice, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-C0ykUH8S.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-DfIWgdvJ.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, p as buildRealtimeVoiceAgentConsultWorkingResponse, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-CoYG4HjH.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-Dk5t9Xpy.js";
import { n as createOutboundSendDeps } from "./deps-BmUXsS5j.js";
import "./agent-DM_lopxB.js";
...
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-BPMbMFLl.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Cz1-fN8R.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-aj-owVNa.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CDoRVX02.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-NF0x2Lya.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-w3oUeyu0.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DlMqoH1j.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-hcLdpaB2.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BkKeGany.js";
import { t as buildChannelUiCatalog } from "./catalog-CsRGbocD.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-BDnGzOeJ.js";
import { s as normalizeUpdateChannel } from "./update-channels-f-ieRme5.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-BEFKiRA-.js";
import { i as resolveConfigReloadMetadata, t as buildGatewayReloadPlan } from "./config-reload-plan-DJZ-5hya.js";
import { t as readConfiguredLogTail } from "./log-tail-DUCEJvW8.js";
import { a as updateSkillsFromClawHub, c as validateRequestedSkillSlug, r as searchSkillsFromClawHub, s as installSkillArchiveFromPath, t as installSkillFromClawHub } from "./skills-clawhub-BaNkKbhW.js";
import { r as readPackageVersion } from "./package-json-CWP51tfk.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-C7iWvIgw.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-Dj6-FBzo.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-BKQxjJf5.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-D9mqyGI0.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-DZkLky1o.js";
import { t as buildChannelAccountSnapshot } from "./status-BbFN51Gz.js";
...
import { t as installSkill } from "./skills-install-CaTSvQNe.js";
import { t as getStatusSummary } from "./status.summary-DZtPILoG.js";
import "./status-DWR0Iu5e.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-Cf8rKvwT.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-D-y0MJj3.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-BAddj6dz.js";
import { t as diffConfigPaths } from "./config-diff-Dg1szdZ9.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-lCaZ6W_1.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BCSjTPm-.js";
import "./heartbeat-runner-CF24rqUA.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-AYt-ugaJ.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-BHxrg3VK.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-Cj1j_O4u.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BZA0YHxc.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-CxBy8p8q.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-Dyrr5M3w.js";
...
import { t as applySessionsPatchToStore } from "./sessions-patch-Cj5axfRm.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-2Hg7uV6g.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel--EHGGM5k.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C9T29izz.js");
