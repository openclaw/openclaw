import { c as readErrorName, i as formatErrorMessage } from "./errors-B5idDZn1.js";
...
import { F as resolveSessionStoreEntry, c as registerSessionMaintenancePreserveKeysProvider, t as loadSessionStore } from "./store-load-DM26fo1a.js";
...
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-e4CJgoDP.js";
import { i as waitForAgentRun, l as formatBlockedLivenessError, t as isRecoverableAgentWaitError, u as isBlockedLivenessState } from "./run-wait-CWLMjxsj.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-WKXA5JYx.js";
import { n as resolveRequiredCompletionDeliveryFailureTerminalResult, r as resolveRequiredCompletionTerminalResult, t as resolveAgentTimeoutMs } from "./timeout-DvDp8cBn.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-ifIe146C.js"));
...
function createSubagentRegistryLifecycleController(params) {
	...
	const startSubagentAnnounceCleanupFlow = (runId, entry) => {
		...
		params.runSubagentAnnounceFlow({
			...
			finalizeSubagentCleanup(runId, entry.cleanup, false).catch((err) => {
				defaultRuntime.log(`[warn] subagent cleanup finalize failed (${runId}): ${String(err)}`);
				const current = params.runs.get(runId);
				if (!current || current.cleanupCompletedAt) return;
				current.cleanupHandled = false;
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-BNrsS2OF.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-ifIe146C.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-By50AWR-.js").then(({ scheduleOrphanRecovery }) => {
