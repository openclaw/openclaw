...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-Di7ttTAj.js";
import { i as listChannelPlugins } from "./registry-BE4M2Iz0.js";
import "./plugins-BateXvZM.js";
import { r as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-BDuxOMhN.js";
import "./pi-bundle-mcp-tools-D2wcwpyn.js";
import { t as abortChatRunById } from "./chat-abort-OfuwsnJu.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-D9gi1UmR.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-NdPYFHXU.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-irSP8h_K.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-GCp5Yyp4.js");
