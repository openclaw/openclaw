...
async function runStructuredHealthRepairs(ctx) {
	...
	const { registerCoreHealthChecks } = await import("./doctor-core-checks-DpMSl5lW.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-B48UQKPh.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-KBzAiuMq.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-B48UQKPh.js");
