...
import { n as openUrl } from "./browser-open-CGGB3d6H.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-uF3bFQ-c.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-D3qYPs-z.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-Z2GNjnsH.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-oSoH10By.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-Dni7wGCU.js") };
