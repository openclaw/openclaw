...
import { a as saveRemoteMedia, i as readRemoteMediaBuffer } from "./fetch-W-nDh9OC.js";
...
import "./runtime-api-Hk_zH22k.js";
import { c as validateUrbitBaseUrl, d as formatTargetHint, f as normalizeShip, h as resolveTlonOutboundTarget, m as parseTlonTarget, p as parseChannelNest, s as normalizeUrbitHostname, u as resolveTlonAccount } from "./setup-core-DlC03ZPo.js";
import { t as getTlonRuntime } from "./runtime-B0ffOFfb.js";
import { t as tlonSetupWizard } from "./setup-surface-VoJsqsoV.js";
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromSSO } = await import("./dist-cjs-D0ote1dm.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromSSO(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
			const { fromIni } = await import("./dist-cjs-CZ8vX8bR.js").then((m) => /* @__PURE__ */ __toESM(m.default));
