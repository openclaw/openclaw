...
import { r as enqueueCommitmentExtraction } from "./runtime-LaTiOni6.js";
...
import { Q as estimateMessagesTokens } from "./selection-CIiYFLNC.js";
...
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-C9y4fmul.js";
import { a as resolveReplyRunFireReason, c as runCliAgentWithLifecycle, i as runAgentTurnWithFallback, n as resolveRunAfterAutoFallbackPrimaryProbeRecheck, o as normalizeReplyPayloadDirectives, r as resolveSessionRuntimeOverrideForProvider, t as buildKnownAgentRunFailureReplyPayload } from "./agent-runner-execution-DNfbWOXt.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-D7DK58vE.js";
...
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-CyrjQpHu.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-Cuh6B_yP.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-CB17vMS0.js"),
