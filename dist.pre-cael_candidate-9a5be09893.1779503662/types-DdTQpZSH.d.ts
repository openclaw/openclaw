import { On as CliBackendConfig, i as OpenClawConfig } from "./types.openclaw-BorXMoYB.js";
import { l as SecretInput } from "./types.secrets-tbFW-hY6.js";
import { l as ModelProviderAuthMode, o as ModelCompatConfig, u as ModelProviderConfig } from "./types.models-tqxsISRc.js";
import { x as ToolLoopDetectionConfig } from "./types.tools-BpgZArJS.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-Ckb2OLir.js";
...
import { d as PluginKind, f as UnifiedModelCatalogEntry, p as UnifiedModelCatalogKind } from "./manifest-registry-Cy8Thi1W.js";
import { n as ReasoningLevel, r as ThinkLevel } from "./thinking.shared-DZFlsfdo.js";
...
import { c as SessionSystemPromptReport, o as SessionEntry } from "./types-DWMrIXZR.js";
import { r as AnyAgentTool } from "./common-BDN0bXby.js";
import { S as AcceptedSessionSpawn, a as PromptMode, b as MessagingToolSend, h as EmbeddedPiCompactResult, p as ExecElevatedDefaults, r as RunEmbeddedPiAgentParams, s as BlockReplyChunking, v as EmbeddedRunLivenessState, w as HeartbeatToolResponse, x as MessagingToolSourceReplyPayload, y as AgentRunTimeoutPhase } from "./params-CXb1NVsU.js";
import { c as SourceReplyDeliveryMode, r as GetReplyOptions, u as ReplyPayload } from "./get-reply-options.types-BLTPrIkz.js";
import { It as TalkTransport, c as DiagnosticEventMetadata, l as DiagnosticEventPayload, s as DiagnosticEventInput } from "./diagnostic-events-CwYgmdWG.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-CNh-gjbD.js";
import { t as CommandQueueEnqueueFn } from "./command-queue.types-CfUiTJN8.js";
...
import { E as OpenClawPluginHookOptions, L as WebFetchProviderPlugin, O as OpenClawPluginToolFactory, U as WebSearchProviderPlugin, k as OpenClawPluginToolOptions } from "./types-core-DM6WiBWx.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-BV8tXfOl.js";
...
import { A as SpeechSynthesisRequest, C as SpeechProviderId, D as SpeechProviderResolveConfigContext, E as SpeechProviderPreparedSynthesis, F as SpeechTelephonySynthesisRequest, I as SpeechTelephonySynthesisResult, L as SpeechVoiceOption, M as SpeechSynthesisStreamRequest, N as SpeechSynthesisStreamResult, O as SpeechProviderResolveTalkConfigContext, S as SpeechProviderConfiguredContext, T as SpeechProviderPrepareSynthesisContext, _ as SpeechDirectiveTokenParseContext, j as SpeechSynthesisResult, k as SpeechProviderResolveTalkOverridesContext, v as SpeechDirectiveTokenParseResult, x as SpeechProviderConfig, y as SpeechListVoicesRequest } from "./tts-runtime.types-cJWF_u78.js";
import { n as DetachedTaskLifecycleRuntime } from "./detached-task-runtime-contract-B9wkwSgU.js";
import { _ as ContextEngineRuntimeContext, g as ContextEnginePromptCacheInfo, l as ContextEngine, t as ContextEngineFactory, u as ContextEngineHostCapability } from "./registry-SvUYhvLL.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-sz9T1TPs.js";
import { Ft as PluginNextTurnInjection, It as PluginNextTurnInjectionEnqueueResult, Jt as PluginConversationBindingRequestResult, Kt as PluginConversationBinding, Rt as PluginJsonValue, Xt as PluginConversationBindingResolvedEvent, et as PluginHookName, nn as PluginHookBeforeAgentStartResult, q as PluginHookHandlerMap, qt as PluginConversationBindingRequestParams, vt as PluginHookToolInputKind, yt as PluginHookToolKind } from "./hook-types-BN69H1a7.js";
...
import { n as GatewayRequestHandler } from "./types-CQuKCESQ.js";
