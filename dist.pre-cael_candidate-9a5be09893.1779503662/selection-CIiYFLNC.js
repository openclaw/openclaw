...
import { a as redactSensitiveFieldValueWithConfig, n as isSensitiveFieldKey, r as redactSecrets, u as redactToolPayloadTextWithConfig } from "./redact-CVcFdz9b.js";
...
import { a as resolveAgentDir, i as resolveAgentContextLimits, r as resolveAgentConfig } from "./agent-scope-config-D1eqrBeU.js";
import "./boundary-file-read-CBe_wA_B.js";
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-A_7SSRlR.js";
import { n as replaceFileAtomic } from "./replace-file-C7_Inj8B.js";
import { u as readRootJsonObjectSync } from "./json-files-C2hqjU--.js";
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-CZmJPzl4.js";
import { v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-C1e5xmDO.js";
import { a as getActiveDiagnosticTraceContext, i as freezeDiagnosticTraceContext, n as createDiagnosticTraceContext, r as formatDiagnosticTraceparent, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-BhiYlOGB.js";
...
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-B_VlHdCE.js";
import { D as getCompactionProvider } from "./loader-D8Q4w1w3.js";
import { k as listRegisteredPluginAgentPromptGuidance } from "./command-registration-CJwLg4nJ.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Bqn2eA2l.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-CrQXj4lU.js";
...
import { A as createExpiringMapCache, M as isCacheEnabled, N as resolveCacheTtlMs, t as loadSessionStore } from "./store-load-DM26fo1a.js";
...
import { d as updateSessionStoreEntry, s as runQuotaSuspensionMaintenance } from "./store-CuGD5gZu.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DppuT-pZ.js";
import { f as redactTranscriptMessage, l as bindOwnedSessionTranscriptWrites, u as withOwnedSessionTranscriptWrites } from "./transcript-CkSJhWxP.js";
...
import { c as hasCopilotVisionInput, o as buildCopilotDynamicHeaders, s as buildCopilotIdeHeaders } from "./copilot-dynamic-headers-CVy4X1Kj.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-D-uijfqS.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-CkOGrSum.js";
...
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-BmuX9QbQ.js";
...
import { C as firstEnumerableOwnKeys, S as boundedJsonUtf8Bytes, T as jsonUtf8BytesOrInfinity, _ as stripInternalMetadataForDisplay } from "./session-utils.fs-BqGZxEFC.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-Dc7B13Zv.js";
import { d as stripHeartbeatToken } from "./heartbeat-B444HHRI.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-wP7icKjA.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DoRae_Ea.js";
...
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-CcNYZseK.js";
import { A as stripProviderPrefix, j as isEmbeddedMode, k as isStrictAgenticSupportedProviderModel, m as resolveToolLoopDetectionConfig } from "./openclaw-tools-DOnbfRua.js";
...
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-BYnsltS3.js";
...
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-B4d6hw5m.js";
...
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-D9JVjqOO.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-C9sAWQCX.js";
...
import { C as sanitizeToolCallInputs, E as buildGuardedModelFetch, O as supportsModelTools, S as repairToolUseResultPairing, T as stripToolResultDetails, _ as mergeTransportHeaders, w as sanitizeToolUseResultPairing, x as makeMissingToolResult, y as sanitizeTransportPayloadText } from "./openai-transport-stream-D5Hrg1gj.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-NS7ZOI34.js";
import { a as getOrCreateSessionMcpRuntime, u as loadEmbeddedPiMcpConfig } from "./pi-bundle-mcp-runtime-BDuxOMhN.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-D2RNAdMy.js";
import "./pi-bundle-mcp-tools-D2wcwpyn.js";
import { g as normalizeAcceptedSessionSpawnResult, h as hasAcceptedSessionSpawn, l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-BKT2yJYA.js";
import { C as sanitizeToolResult, D as isMessagingToolSendAction, E as isMessagingTool, S as sanitizeToolArgs, T as isMessageToolSendActionName, _ as extractToolResultMediaArtifact, a as resolveCompactionTimeoutMs, b as isToolResultError, c as logAgentRuntimeToolDiagnostics, f as runAgentCleanupStep, g as extractToolErrorMessage, h as extractToolErrorCode, l as normalizeAgentRuntimeTools, m as extractMessagingToolSend, n as createAgentToolResultMiddlewareRunner, o as resolveTranscriptPolicy, p as buildToolLifecycleErrorResult, s as shouldAllowProviderOwnedThinkingReplay, t as buildEmbeddedAttemptToolRunContext, v as extractToolResultText$1, w as collectTextContentBlocks, x as isToolResultTimedOut, y as filterToolResultMediaUrls } from "./attempt.tool-run-context-Bdqo6ZlY.js";
...
import { d as shouldSuppressRawErrorConsoleSuffix, l as buildApiErrorObservationFields, s as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-MWvVmxb8.js";
import { t as log$7 } from "./logger-CKkIRAq_.js";
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-B1Dqrgto.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, o as MIN_PROMPT_BUDGET_RATIO, r as applyPiCompactionSettingsFromConfig, s as MIN_PROMPT_BUDGET_TOKENS } from "./pi-settings-CQr0ZINO.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-BmLeck_B.js";
import { n as retryAsync } from "./retry-BWLZMs1m.js";
...
import { n as buildSubagentList } from "./subagent-list-uQS1vbrr.js";
import { o as listControlledSubagentRuns } from "./subagent-control-CW1MQTmn.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, s as resolveAgentPromptSurfaceForSessionKey, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-BO_9-ZS2.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-B6CHyy3i.js";
...
import { _ as writeTranscriptFileAtomic, a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, d as rewriteTranscriptEntriesInState, f as getRawSessionAppendMessage, g as readTranscriptFileState, h as persistTranscriptStateMutation, m as TranscriptFileState, n as bootstrapHarnessContextEngine, p as setRawSessionAppendMessage, t as assembleHarnessContextEngine, u as rewriteTranscriptEntriesInSessionManager } from "./context-engine-lifecycle-C9o9TJkA.js";
import { t as detectRuntimeShell } from "./shell-utils-BDYMhC5E.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-tpxTluOy.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-i-2n4QwG.js";
import "./skills-AgD9HbY-.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-BeK6wv9x.js";
import "./tool-loop-detection-BjJJy4Mf.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible, a as createCodexNativeWebSearchWrapper } from "./proxy-stream-wrappers-ysqrwOFU.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BFxxUlW-.js";
...
import { t as extractSections } from "./post-compaction-context-KMsMaCqE.js";
...
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-Bx8pHSa4.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DyQcFVDR.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-YUc2rvlg.js";
import { t as detectAndLoadPromptImages } from "./images-CRZzgwQb.js";
...
import { CURRENT_SESSION_VERSION, DefaultResourceLoader, SessionManager, SettingsManager, createAgentSession, estimateTokens, generateSummary } from "@earendil-works/pi-coding-agent";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-CaOVUJOl.js"));
...
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-C0VJGJN3.js"));
	...
	const emitBlockReplySafely = (payload, options) => {
		...
		try {
			...
			const task = Promise.resolve(maybeTask).catch((err) => {
				log$5.warn(`block reply callback failed: ${String(err)}`);
			});
...
const log$4 = createSubsystemLogger("embedded-pi-settings");
...
function loadBundleSettingsFile(params) {
	...
	if (!result.ok && result.reason === "open") {
		log$4.warn(`skipping unsafe bundle settings file: ${absolutePath}`);
		return null;
	}
	if (!result.ok) {
		log$4.warn(`${result.error}: ${absolutePath}`);
		return null;
	}
...
function loadEnabledBundlePiSettingsSnapshot(params) {
	...
	for (const diagnostic of embeddedPiMcp.diagnostics) log$4.warn(`bundle MCP skipped for ${diagnostic.pluginId}: ${diagnostic.message}`);
...
function truncateOversizedToolResultsInExistingSessionManager(params) {
	...
	log$7.info(`[tool-result-truncation] Truncated ${rewriteResult.rewrittenEntries} tool result(s) in session (contextWindow=${contextWindowTokens} maxChars=${maxChars} aggregateBudgetChars=${aggregateBudgetChars} oversized=${plan.oversizedReplacementCount} aggregate=${plan.aggregateReplacementCount}) sessionKey=${params.sessionKey ?? params.sessionId ?? "unknown"}`);
	return {
...
const log$3 = createSubsystemLogger("compaction");
...
async function summarizeWithFallback(params) {
	...
	try {
		...
		log$3.warn(`Full summarization failed: ${formatErrorMessage(fullError)}`);
	}
	const smallMessages = [];
	...
	if (smallMessages.length > 0 && smallMessages.length !== messages.length) try {
		...
		log$3.warn(`Partial summarization also failed: ${formatErrorMessage(partialError)}`);
	}
...
async function prepareGooglePromptCacheStreamFn(params, deps = {}) {
	...
	return async (model, context, options) => {
		...
		if (!cachedContent) {
			log$7.debug(`google prompt cache unavailable for ${params.provider}/${params.modelId}; continuing without cachedContent`);
	...
	mutableAgent.transformContext = (async (messages, signal) => {
		...
		if (params.midTurnPrecheck?.enabled) {
			...
			if (hasNewToolResultAfterFence({
				...
				log$7.debug(`[context-overflow-midturn-precheck] tool-result-guard check route=${precheck.route} messages=${contextMessages.length} prePromptMessageCount=${prePromptMessageCount} estimatedPromptTokens=${precheck.estimatedPromptTokens} promptBudgetBeforeReserve=${precheck.promptBudgetBeforeReserve} overflowTokens=${precheck.overflowTokens}`);
				if (request) {
...
async function waitForSessionsYieldAbortSettle(params) {
	...
	const outcome = await Promise.race([params.settlePromise.then(() => "settled").catch((err) => {
		log$7.warn(`sessions_yield abort settle failed: runId=${params.runId} sessionId=${params.sessionId} err=${String(err)}`);
		return "errored";
	}), new Promise((resolve) => {
		timeout = setTimeout(() => resolve("timed_out"), SESSIONS_YIELD_ABORT_SETTLE_TIMEOUT_MS);
	})]);
	if (timeout) clearTimeout(timeout);
	if (outcome === "timed_out") log$7.warn(`sessions_yield abort settle timed out: runId=${params.runId} sessionId=${params.sessionId} timeoutMs=${SESSIONS_YIELD_ABORT_SETTLE_TIMEOUT_MS}`);
}
...
async function waitForEmbeddedAbortSettle(params) {
	...
	const outcome = await Promise.race([params.promise.then(() => "settled").catch((err) => {
		log$7.warn(`embedded abort settle failed: runId=${params.runId} sessionId=${params.sessionId} err=${String(err)}`);
		return "errored";
	}), new Promise((resolve) => {
		timeout = setTimeout(() => resolve("timed_out"), EMBEDDED_ABORT_SETTLE_TIMEOUT_MS);
	})]);
	if (timeout) clearTimeout(timeout);
	if (outcome === "timed_out") log$7.warn(`embedded abort settle timed out: runId=${params.runId} sessionId=${params.sessionId} timeoutMs=${EMBEDDED_ABORT_SETTLE_TIMEOUT_MS}`);
}
			...
			if (shouldAttemptMalformedToolCallRepair(nextPartialJson, event.delta) || repairedArgsByIndex.has(event.contentIndex)) {
				...
				if (repair) {
					...
					if (!loggedRepairIndices.has(event.contentIndex) && repair.kind === "repaired") {
						...
						log$7.warn(`repairing malformed tool call arguments with ${repair.leadingPrefix.length} leading chars and ${repair.trailingSuffix.length} trailing chars`);
					}
				} else {
					repairedArgsByIndex.delete(event.contentIndex);
	...
	await new Promise((resolve, reject) => {
		...
		const rejectAfterCancellation = (message) => {
			cancelQueuedSteeringMessage(activeSession, text).then((removed) => {
				if (!removed) log$7.warn("failed to find queued steering message for cancellation");
			}).catch((err) => {
				log$7.warn(`failed to cancel queued steering message: ${String(err)}`);
			}).finally(() => {
...
function removeTrailingMidTurnPrecheckAssistantError(params) {
	...
	if (lastEntry?.type !== "message" || !isMidTurnPrecheckAssistantError(lastEntry.message)) {
		if (isMidTurnPrecheckAssistantError(params.activeSession.agent.state.messages.at(-1))) log$7.warn("[context-overflow-midturn-precheck] removed synthetic assistant error from active session but could not locate matching persisted SessionManager entry");
		return;
	}
	if (typeof mutableSessionManager["_rewriteFile"] !== "function") {
		log$7.warn("[context-overflow-midturn-precheck] removed synthetic assistant error from active session but SessionManager rewrite hook is unavailable");
		return;
	}
...
async function runEmbeddedAttempt(params) {
	...
	const emitPrepStageSummary = (phase) => {
		...
		if (!shouldWarn && !log$7.isEnabled("trace")) return;
		...
		if (shouldWarn) log$7.warn(message);
		else log$7.trace(message);
	};
	...
	try {
		...
		if (isRawModelRun && log$7.isEnabled("debug")) log$7.debug(`raw model run enabled: modelRun=${params.modelRun === true} promptMode=${params.promptMode ?? "unset"}`);
		...
		if (toolSearch.compacted) {
			...
			log$7.info(codeModeControlsEnabledForRun ? `code-mode: cataloged ${toolSearch.catalogToolCount} tools behind exec/wait` : `tool-search: cataloged ${toolSearch.catalogToolCount} tools behind compact prompt surface`);
		}
		...
		try {
			await repairSessionFileIfNeeded({
				sessionFile: params.sessionFile,
				debug: (message) => log$7.debug(message),
				warn: (message) => log$7.warn(message)
			});
			...
			if (clientToolSearch.compacted) log$7.info(codeModeControlsEnabledForRun ? `code-mode: cataloged ${clientToolSearch.catalogToolCount} client tools behind exec/wait` : `tool-search: cataloged ${clientToolSearch.catalogToolCount} client tools behind compact prompt surface`);
			...
			if (agentTransportOverride && activeSession.agent.transport !== agentTransportOverride) {
				...
				log$7.debug(`embedded agent transport override: ${previousTransport} -> ${agentTransportOverride} (${params.provider}/${params.modelId})`);
			}
			prepStages.mark("stream-setup");
			emitPrepStageSummary("stream-ready");
			const cacheObservabilityEnabled = Boolean(cacheTrace) || log$7.isEnabled("debug");
			...
			try {
				...
				if (activeContextEngine) try {
					...
					if (assembled.systemPromptAddition) {
						...
						applySystemPromptOverrideToSession(activeSession, systemPromptText);
						log$7.debug(`context engine: prepended system prompt addition (${assembled.systemPromptAddition.length} chars)`);
					}
				} catch (assembleErr) {
					log$7.warn(`context engine assemble failed, using pipeline messages: ${String(assembleErr)}`);
				}
			} catch (err) {
			...
			const abortCompaction = () => {
				...
				try {
					...
					if (!isProbeSession) log$7.warn(`embedded run abortCompaction failed: runId=${params.runId} sessionId=${params.sessionId} err=${String(err)}`);
				}
			};
			...
			const scheduleAbortTimer = (delayMs, reason) => {
				abortTimer = setTimeout(() => {
					if (resolveRunTimeoutDuringCompaction({
						...
						if (!isProbeSession) log$7.warn(`embedded run timeout reached during compaction; extending deadline: runId=${params.runId} sessionId=${params.sessionId} extraMs=${compactionTimeoutMs}`);
						scheduleAbortTimer(compactionTimeoutMs, "compaction-grace");
						return;
					}
					if (!isProbeSession) log$7.warn(reason === "compaction-grace" ? `embedded run timeout after compaction grace: runId=${params.runId} sessionId=${params.sessionId} timeoutMs=${params.timeoutMs} compactionGraceMs=${compactionTimeoutMs}` : `embedded run timeout: runId=${params.runId} sessionId=${params.sessionId} timeoutMs=${params.timeoutMs}`);
			...
			try {
				...
				if (emptyExplicitToolAllowlistError) {
					...
					log$7.warn(`[tools] ${emptyExplicitToolAllowlistError.message}`);
				}
				...
				});
				{
					...
					if (hookResult?.appendContext) {
						...
						log$7.debug(`hooks: appended context to prompt (${hookResult.appendContext.length} chars)`);
					}
					const legacySystemPrompt = normalizeOptionalString(hookResult?.systemPrompt) ?? "";
					if (legacySystemPrompt) {
						applySystemPromptOverrideToSession(activeSession, legacySystemPrompt);
						systemPromptText = legacySystemPrompt;
						log$7.debug(`hooks: applied systemPrompt override (${legacySystemPrompt.length} chars)`);
					}
					...
					if (prependedOrAppendedSystemPrompt) {
						...
						log$7.debug(`hooks: applied prependSystemContext/appendSystemContext (${prependSystemLen}+${appendSystemLen} chars)`);
					}
				}
				...
				log$7.debug(`embedded run prompt start: runId=${params.runId} sessionId=${params.sessionId} ` + routingSummary);
				...
				if (leafEntry?.type === "message" && leafEntry.message.role === "user") {
					...
					if (shouldWarnOnOrphanedUserRepair(params.trigger)) log$7.warn(orphanRepairMessage);
					else log$7.debug(orphanRepairMessage);
				}
				...
				try {
					...
					const persistBlockedBeforeAgentRun = async (block) => {
						...
						try {
							...
							log$7.warn(`before_agent_run block: failed to persist redacted user message: ${err?.message ?? String(err)}`);
							return false;
						}
					};
					if (hookRunner?.hasHooks("before_agent_run")) {
						...
						try {
							...
							log$7.warn("before_agent_run hook failed; blocking request");
						...
						if (beforeRunDecision?.outcome === "block") {
							...
							log$7.warn(`before_agent_run hook blocked by ${beforeRunPluginId}`);
							await persistBlockedBeforeAgentRun({
					...
					if (promptSkipReason) {
						...
						if (promptSkipReason === "blank_user_prompt") log$7.warn(`embedded run prompt skipped: blank user prompt ${skipContext}`);
						else log$7.info(`embedded run prompt skipped: empty prompt/history/images ${skipContext}`);
					...
					if (log$7.isEnabled("debug")) log$7.debug(`[context-diag] pre-prompt: sessionKey=${params.sessionKey ?? params.sessionId} messages=${msgCount} roleCounts=${sessionSummary.roleCounts} historyTextChars=${sessionSummary.totalTextChars} maxMessageTextChars=${sessionSummary.maxMessageTextChars} historyImageBlocks=${sessionSummary.totalImageBlocks} systemPromptChars=${systemLen} promptChars=${promptLen} promptImages=${imageResult.images.length} provider=${params.provider}/${params.modelId} sessionFile=${params.sessionFile}`);
					...
					if (preemptiveCompaction) log$7.debug(formatPrePromptPrecheckLog({
				...
				try {
					...
					if ((yieldAborted ? { timedOut: false } : await waitForCompactionRetryWithAggregateTimeout({
						...
						timedOutDuringCompaction = true;
						if (!isProbeSession) log$7.warn(`compaction retry aggregate timeout (${COMPACTION_RETRY_AGGREGATE_TIMEOUT_MS}ms): proceeding with pre-compaction state runId=${params.runId} sessionId=${params.sessionId}`);
					}
				} catch (err) {
				...
				await sessionLockController.withSessionWriteLock(async () => {
					if (shouldPersistCompletedBootstrapTurn({
						...
						log$7.warn(`failed to persist bootstrap completion entry: ${String(entryErr)}`);
					}
					if (compactionOccurredThisAttempt && !promptError && !aborted && !timedOut && !idleTimedOut && !timedOutDuringCompaction && shouldRotateCompactionTranscript(params.config)) try {
						...
						if (rotation.rotated) {
							...
							log$7.info(`[compaction] rotated active transcript after automatic compaction (sessionKey=${params.sessionKey ?? params.sessionId})`);
						}
					} catch (err) {
						log$7.warn("[compaction] automatic transcript rotation failed", { errorMessage: formatErrorMessage(err) });
					}
				});
			...
			if (cacheObservabilityEnabled) {
				...
				if (cacheBreakForLog) {
					...
					log$7.warn(`[prompt-cache] cache read dropped ${cacheBreakForLog.previousCacheRead} -> ${cacheBreakForLog.cacheRead} for ${params.provider}/${params.modelId} via ${streamStrategy}; ${changeSummary}`);
...
//#endregion
export { hasMeaningfulConversationContent as $, dedupeDuplicateUserMessagesForCompaction as A, resolveEmbeddedAgentBaseStreamFn as B, createEmbeddedRunStageTracker as C, shouldTreatEmptyAssistantReplyAsSilent as Ct, rotateTranscriptAfterCompaction as D, createTrajectoryRuntimeRecorder as Dt, resolveBootstrapMode as E, isReasoningTagProvider as Et, collectRegisteredToolNames as F, createEmbeddedPiResourceLoader as G, resolveEmbeddedRunSkillEntries as H, toSessionToolAllowlist as I, buildEmbeddedMessageActionDiscoveryInput as J, sanitizeSessionHistory as K, applySystemPromptOverrideToSession as L, mapThinkingLevel as M, shouldPreemptivelyCompactBeforePrompt as N, rotateTranscriptFileAfterCompaction as O, collectAllowedToolNames as P, estimateMessagesTokens as Q, buildEmbeddedSystemPrompt as R, EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as S, resolveSilentToolResultReplyPayload as St, shouldWarnEmbeddedRunStageSummary as T, observeReplayMetadata as Tt, prewarmSessionFile as U, resolveEmbeddedAgentStreamFn as V, trackSessionManagerAccess as W, limitHistoryTurns as X, getHistoryLimitFromSessionKey as Y, buildEmbeddedExtensionFactories as Z, resolveRateLimitProfileRotationLimit as _, resolvePlanningOnlyRetryInstruction as _t, RUNTIME_AUTH_REFRESH_MARGIN_MS as a, sessionLikelyHasOversizedToolResults as at, createUsageAccumulator as b, resolveReplayInvalidFlag as bt, buildErrorAgentMeta as c, buildUsageWithNoCost as ct, resolveActiveErrorContext as d, STRICT_AGENTIC_BLOCKED_TEXT as dt, isRealConversationMessage as et, resolveFinalAssistantRawText as f, extractPlanningOnlyPlanDetails as ft, resolveOverloadProfileRotationLimit as g, resolveIncompleteTurnPayloadText as gt, resolveOverloadFailoverBackoffMs as h, resolveEmptyResponseRetryInstruction as ht, selectAgentHarness as i, resolveLiveToolResultMaxChars as it, flushPendingToolResultsAfterIdle as j, shouldRotateCompactionTranscript as k, buildUsageAgentMetaFields as l, collectRuntimeChannelCapabilities as lt, resolveMaxRunRetryIterations as m, resolveAttemptReplayMetadata as mt, resolveAvailableAgentHarnessPolicy as n, setCompactionSafeguardCancelReason as nt, RUNTIME_AUTH_REFRESH_MIN_DELAY_MS as o, truncateOversizedToolResultsInSession as ot, resolveFinalAssistantVisibleText as p, resolveAckExecutionFastPathInstruction as pt, validateReplayTurns as q, runAgentHarnessAttempt as r, guardSessionManager as rt, RUNTIME_AUTH_REFRESH_RETRY_MS as s, repairSessionFileIfNeeded as st, maybeCompactAgentHarnessSession as t, consumeCompactionSafeguardCancelReason as tt, createCompactionDiagId as u, createPreparedEmbeddedPiSettingsManager as ut, resolveReportedModelRef as v, resolvePlanningOnlyRetryLimit as vt, formatEmbeddedRunStageSummary as w, createEmbeddedRunReplayState as wt, mergeUsageIntoAccumulator as x, resolveRunLivenessState as xt, scrubAnthropicRefusalMagic as y, resolveReasoningOnlyRetryInstruction as yt, createSystemPromptOverride as z };
