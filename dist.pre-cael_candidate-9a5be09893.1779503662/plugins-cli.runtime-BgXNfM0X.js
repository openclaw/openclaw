...
import { n as collectConfiguredRuntimePluginIds, r as resolveConfiguredRuntimePluginInstallCandidate } from "./configured-runtime-plugin-installs-D_FJhT6_.js";
...
async function runPluginsEnableCommand(id) {
	...
	const { enablePluginInConfig } = await import("./enable-B_Qm9-tA.js");
	const { normalizePluginId } = await import("./config-state-QkI5hUlL.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-BbKRx_Gk.js");
	const { applySlotSelectionForPlugin, logSlotWarnings } = await import("./plugins-command-helpers-jmGBvSJh.js");
...
async function runPluginsDisableCommand(id) {
	...
	const { normalizePluginId } = await import("./config-state-QkI5hUlL.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-BbKRx_Gk.js");
	const { setPluginEnabledInConfig } = await import("./plugins-config-D2pW2B7y.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CDba7AKF.js");
	const snapshot = await readConfigFileSnapshot();
	const cfg = snapshot.sourceConfig ?? snapshot.config;
	const report = buildPluginRegistrySnapshotReport({ config: cfg });
...
async function runPluginsRegistryCommand(opts) {
	const { inspectPluginRegistry, refreshPluginRegistry } = await import("./plugin-registry-Dy8eXqTW.js");
...
async function runPluginsDoctorCommand() {
	const { buildPluginCompatibilityNotices, buildPluginDiagnosticsReport, formatPluginCompatibilityNotice } = await import("./status-BbKRx_Gk.js");
...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-CUtXmI8b.js");
	const { createPluginInstallLogger } = await import("./plugins-command-helpers-jmGBvSJh.js");
