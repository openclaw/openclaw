...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-C6NMvIlv.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-J2eHsfqp.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-Ds6KfED3.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DJt2K1ta.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-DezmXiiC.js"), import("./logging-BF2MM5gm.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-CxR1MRrz.js").then((credentialsReadModule) => ({
