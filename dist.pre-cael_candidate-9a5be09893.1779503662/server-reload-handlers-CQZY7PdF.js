...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-vKV8v4aO.js";
...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-B6q6duKj.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-DmifARfn.js";
...
import { r as resetDirectoryCache } from "./target-resolver-BA4gFGtH.js";
...
import { _ as resolveHooksConfig } from "./hooks-Boinu44X.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-CFW2GzdC.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DJZ-5hya.js";
...
import { t as buildGatewayCronService } from "./server-cron-Dn6VoIaf.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Dnslhv2b.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-Dl5tPPhs.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-Chnx3CDw.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-Xp33sgRZ.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-GCp5Yyp4.js"), import("./gmail-watcher-lifecycle-tUNejF1T.js")]);
