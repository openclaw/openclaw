...
import { d as normalizeSecretInputString, s as hasConfiguredSecretInput, t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-BcE0iOnr.js";
...
import { t as resolveWebSearchInstallCatalogEntries } from "./web-search-install-catalog-DD63UBNl.js";
import { i as hasAuthProfileForProvider } from "./model-config.helpers-88VNrykl.js";
import { n as sortWebSearchProviders } from "./web-search-providers.shared-yFdaW8nC.js";
...
async function finalizeSearchProviderSetup(params) {
	...
	if (installEntry && next.tools?.web?.search?.enabled !== false) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-CjKejHH_.js");
