...
import { g as resolveRunModelFallbacksOverride, v as resolveSessionAgentIds } from "./agent-scope-DKjUWHDL.js";
import { a as isSubagentSessionKey, i as isCronSessionKey } from "./session-key-utils-Ce_xWkNq.js";
...
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-jHXsIkoa.js";
...
import { c as resolveSessionLockMaxHoldFromTimeout, d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-CZwyhHkI.js";
import { K as transformProviderSystemPrompt, P as resolveProviderTextTransforms, b as prepareProviderRuntimeAuth } from "./provider-runtime-B3-FaHxM.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared-cdTr1v5l.js";
import { d as resolveModelAuthMode, i as getApiKeyForModel, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-X07O9eQq.js";
...
import { g as ensureSessionHeader, i as pickFallbackThinkingLevel } from "./pi-embedded-helpers-CLiarrsd.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-CtW62TC-.js";
import { $ as hasMeaningfulConversationContent, A as dedupeDuplicateUserMessagesForCompaction, B as resolveEmbeddedAgentBaseStreamFn, D as rotateTranscriptAfterCompaction, Et as isReasoningTagProvider, F as collectRegisteredToolNames, G as createEmbeddedPiResourceLoader, H as resolveEmbeddedRunSkillEntries, I as toSessionToolAllowlist, J as buildEmbeddedMessageActionDiscoveryInput, K as sanitizeSessionHistory, L as applySystemPromptOverrideToSession, M as mapThinkingLevel, P as collectAllowedToolNames, R as buildEmbeddedSystemPrompt, U as prewarmSessionFile, V as resolveEmbeddedAgentStreamFn, W as trackSessionManagerAccess, X as limitHistoryTurns, Y as getHistoryLimitFromSessionKey, Z as buildEmbeddedExtensionFactories, et as isRealConversationMessage, j as flushPendingToolResultsAfterIdle, k as shouldRotateCompactionTranscript, lt as collectRuntimeChannelCapabilities, nt as setCompactionSafeguardCancelReason, q as validateReplayTurns, rt as guardSessionManager, st as repairSessionFileIfNeeded, tt as consumeCompactionSafeguardCancelReason, ut as createPreparedEmbeddedPiSettingsManager, z as createSystemPromptOverride } from "./selection-CIiYFLNC.js";
import { t as getMachineDisplayName } from "./machine-name-Dy5GwJ0w.js";
import { g as listActiveProcessSessionReferences, m as resolveEmbeddedCompactionTarget } from "./attempt.prompt-helpers-Djz-MO2n.js";
import { n as extractModelCompat } from "./provider-model-compat-BYnsltS3.js";
import { a as resolveBootstrapContextForRun, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-C9sAWQCX.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-DMDmv9Lu.js";
import { E as resolveChannelMessageToolHints, O as resolveChannelReactionGuidance, T as listChannelSupportedActions } from "./pi-tools.before-tool-call-B39uI8tH.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-BiVL2X1D.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-DyXQ-M1b.js";
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-BE-soLvS.js";
import { O as supportsModelTools, w as sanitizeToolUseResultPairing } from "./openai-transport-stream-D5Hrg1gj.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-NS7ZOI34.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-D2RNAdMy.js";
import "./pi-bundle-mcp-tools-D2wcwpyn.js";
import { a as resolveCompactionTimeoutMs, i as compactWithSafetyTimeout } from "./attempt.tool-run-context-Bdqo6ZlY.js";
import { r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-MWvVmxb8.js";
import { t as log } from "./logger-CKkIRAq_.js";
import { a as resolveCompactionFailureReason, i as formatUnknownCompactionReasonDetail, o as createCompactionDiagId, r as classifyCompactionReason } from "./request-compaction-tool-B1Dqrgto.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CQr0ZINO.js";
import { t as splitSdkTools } from "./tool-split-BmLeck_B.js";
import { s as resolveAgentPromptSurfaceForSessionKey } from "./system-prompt-config-BO_9-ZS2.js";
...
import { _ as writeTranscriptFileAtomic, g as readTranscriptFileState, m as TranscriptFileState } from "./context-engine-lifecycle-C9o9TJkA.js";
import { t as detectRuntimeShell } from "./shell-utils-BDYMhC5E.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-tpxTluOy.js";
import { s as resolveSkillsPromptForRun } from "./workspace-i-2n4QwG.js";
import "./skills-AgD9HbY-.js";
import { n as resolveSystemPromptOverride } from "./system-prompt-report-BeK6wv9x.js";
import { t as applyExtraParamsToAgent } from "./extra-params-BFxxUlW-.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-DTNUFWga.js";
...
import { r as buildAgentRuntimePlan } from "./build-C9y4fmul.js";
...
async function compactEmbeddedPiSessionDirectOnce(params) {
	...
	try {
		...
		const normalizedBundledTools = filteredBundledTools.length > 0 ? runtimePlan.tools.normalize(filteredBundledTools, runtimePlanModelContext) : filteredBundledTools;
...
//#endregion
export { testing as __testing, testing, compactEmbeddedPiSessionDirect, runPostCompactionSideEffects };
