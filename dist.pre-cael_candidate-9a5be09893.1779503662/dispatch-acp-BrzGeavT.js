...
import { g as markDiagnosticSessionProgress } from "./diagnostic-DB6je9Lu.js";
import { a as toAcpRuntimeError } from "./errors-CLAwtSsK.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-glJaFtPy.js";
import { o as generateSecureUuid } from "./secure-random-B-x2FMyg.js";
import { c as markReplyPayloadAsTtsSupplement, o as isReplyPayloadStatusNotice } from "./reply-payload-CiT5mlcY.js";
import { s as hasOutboundReplyContent } from "./reply-payload-DMPQsrQC.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-vCj7s1aU.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-BQzqF871.js";
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-D2EZHoze.js";
import { a as resolveAgentTurnAttachments, c as appendRecentHistoryImageContext, i as loadAgentTurnMediaRuntime, o as resolveInlineAgentImageAttachments, r as createBlockReplyPipeline, s as hasInboundMedia } from "./block-reply-pipeline-5awmA--c.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-CEw5j-Nr.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-MDZT82Pf.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-CfJbyTkx.js";
import { r as waitForReplyDispatcherIdle } from "./reply-dispatcher-D5Qk19sP.js";
...
import { t as formatAcpRuntimeErrorText } from "./error-text-su7aPVEw.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-CYNMp_8N.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-DMw-Mh2y.js";
...
const messageActionRuntimeLoader = createLazyImportLoader(() => import("./message-action-runner-CYixEaiI.js"));
...
function createAcpDispatchDeliveryCoordinator(params) {
	...
	const deliver = async (kind, payload, meta) => {
		...
		if (kind === "block" && delivered) await waitForReplyDispatcherIdle(params.dispatcher, params.abortSignal);
		return delivered;
	};
	return {
