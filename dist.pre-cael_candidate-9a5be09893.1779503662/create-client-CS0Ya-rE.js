...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-DTexQLIB.js";
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-DJt2K1ta.js";
import "./config-n24yLDOn.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DezmXiiC.js"), import("./logging-BF2MM5gm.js")]).then(([sdkModule, loggingModule]) => ({
