...
import { g as shortenHomePath, p as resolveUserPath, x as isPlainObject } from "./utils-CAcKzQHY.js";
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-BcE0iOnr.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-C1e5xmDO.js";
...
import { a as findTailscaleBinary } from "./tailscale-5dA2OUc8.js";
...
import { t as ConfigMutationConflictError } from "./mutate-DzIqAz79.js";
...
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-D1HnH655.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CzYA_OnV.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CDUIJvrz.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CTsu8_Ln.js";
import { n as applyAuthChoice } from "./auth-choice-FjSCY1Tm.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B2q_9Drh.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-Bd5F2vCL.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BpGuuPku.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-5H-r6De9.js";
import { n as formatHealthCheckFailure } from "./health-format-DaSqSjzQ.js";
import { n as healthCommand } from "./health-wEFTE2w2.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-Ce7wbyso.js";
import { t as setupSkills } from "./onboard-skills-BliSvyq7.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-Cas5CJPv.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-BRVh-CND.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-CiNclcyl.js");
