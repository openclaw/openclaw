#!/usr/bin/env node
import { a as formatUncaughtError } from "./errors-B5idDZn1.js";
import { t as formatCliFailureLines } from "./failure-output-D50vx9tK.js";
import { r as runFatalErrorHooks } from "./fatal-error-hooks-gDVRMZSa.js";
import { t as isMainModule } from "./is-main-DoKHeRG7.js";
import { c as isUncaughtExceptionHandled, r as isBenignUncaughtExceptionError, t as installUnhandledRejectionHandler } from "./unhandled-rejections-DmgKu1By.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-DWCJ-A-f.js"));
if (isMain) {
