...
import { s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-DKjUWHDL.js";
...
import { b as restoreCurrentPluginMetadataSnapshotState, g as captureCurrentPluginMetadataSnapshotState, v as getCurrentPluginMetadataSnapshot, x as setCurrentPluginMetadataSnapshot } from "./plugin-registry-C1e5xmDO.js";
import { J as getShellEnvAppliedKeys, Q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-BxFubSMj.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-mDjiWzE5.js";
import { n as resolveProviderAuthAliasMap, r as resolveProviderIdForAuth } from "./provider-auth-aliases-B32DTKh8.js";
...
import { s as openAIProviderUsesCodexRuntimeByDefault, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-qNSGkXbB.js";
import { M as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-B3-FaHxM.js";
import { g as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CDaJsp3I.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-Ddo16QWA.js";
import { b as resolveProviderEnvAuthEvidence, u as isNonSecretApiKeyMarker, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-mBAlIzS2.js";
import { t as resolveEnvApiKey } from "./model-auth-env-DVTUsECW.js";
import { a as getCustomProviderApiKey, f as resolveUsableCustomProviderApiKey } from "./model-auth-X07O9eQq.js";
import "./workspace-D9JVjqOO.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-DVGQVUdW.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BkKeGany.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-D4FWATiw.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-DI8gGVuX.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-CXwYKhjk.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-ChQxtwrb.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-Ef4pqUO4.js");
			runtime.log("");
