...
import { c as PATH_ALIAS_POLICIES, o as root } from "./secure-temp-dir-aidxCRgA.js";
...
import { c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-D1eqrBeU.js";
import "./boundary-file-read-CBe_wA_B.js";
import { a as logWarn } from "./logger-BSBKEWuF.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-D8iFykAD.js";
import { n as assertSandboxPath } from "./sandbox-paths-DWbCkkiE.js";
import { i as toRelativeSandboxPath, n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-CyO8R9o6.js";
import { c as EXEC_TOOL_DISPLAY_SUMMARY, l as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-8X_kZYZC.js";
import { a as collectExplicitDenylist, c as hasRestrictiveAllowPolicy, f as expandToolGroups, h as resolveToolProfilePolicy, i as collectExplicitAllowlist, l as mergeAlsoAllowPolicy, m as normalizeToolName, u as replaceWithEffectiveToolAllowlist } from "./tool-policy-COX5DaEj.js";
...
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-B4YxDV-6.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CeyGpKqt.js";
...
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-aAXrHXWQ.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-CemEI13Y.js";
import { C as wrapToolMemoryFlushAppendOnlyWrite, D as resolveOpenClawPluginToolsForOptions, S as wrapToolMemoryDayFileWriteGuard, T as wrapToolWorkspaceRootGuardWithOptions, _ as createHostWorkspaceWriteTool, b as createSandboxedReadTool, g as createHostWorkspaceEditTool, h as createHostWorkspaceAppendTool, m as resolveToolLoopDetectionConfig, t as createOpenClawTools, v as createOpenClawReadTool, w as wrapToolWorkspaceRootGuard, x as createSandboxedWriteTool, y as createSandboxedEditTool } from "./openclaw-tools-DOnbfRua.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-CnZl_vVX.js";
import { c as isToolWrappedWithBeforeToolCallHook, i as copyBeforeToolCallHookMarker, p as wrapToolWithBeforeToolCallHook, w as listChannelAgentTools, x as copyChannelAgentToolMeta } from "./pi-tools.before-tool-call-B39uI8tH.js";
import { c as jsonResult, n as ToolInputError, r as asToolParamsRecord } from "./common-CrEpgrS0.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-J1x6fdJL.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-BtXl3FtP.js";
import { n as resolveEventSessionRoutingPolicy } from "./event-session-routing-DWPITVBM.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-BMEWg99b.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-CXb3P75N.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-CU3AHv4K.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-DZ7vhLcg.js";
import "./codex-native-web-search-r0Z3wpTI.js";
import { t as bindAbortRelay } from "./fetch-timeout-C6XaaYGs.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-DSpxZ7Q4.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-DUhIItA1.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-gxvykAaq.js"));
