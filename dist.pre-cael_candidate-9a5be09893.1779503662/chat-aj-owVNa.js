...
import { T as safeFileURLToPath, x as assertNoWindowsNetworkPath } from "./fs-safe-spIZMJL6.js";
import { r as openLocalFileSafely } from "./secure-temp-dir-aidxCRgA.js";
...
import { o as resolveAgentWorkspaceDir } from "./agent-scope-config-D1eqrBeU.js";
...
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BVWE_ra1.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-Ctzb4SJ-.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-D8iFykAD.js";
import { r as setSafeTimeout } from "./timer-delay-awNPCchy.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-DOSi8QvH.js";
import { s as normalizeInputProvenance } from "./input-provenance-CmqYxlZ2.js";
...
import { n as deliveryContextFromSession } from "./delivery-context.shared-ubhMwJVk.js";
import { i as resolveSessionFilePath } from "./paths---FlWJ0A.js";
import "./sessions-CtFd7seb.js";
import { o as isAudioFileName } from "./mime-DppuT-pZ.js";
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-CkSJhWxP.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-ClYG_P1o.js";
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, x as resolveModelRefFromString } from "./model-selection-shared-D9lGAOqA.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-BqGZxEFC.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-CClLEtM7.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-Bm52LcEr.js";
...
import { c as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-BKT2yJYA.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-of2tFaq2.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-Do3AYy_l.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-DSpxZ7Q4.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-TFRY-Xtz.js";
import { n as getSessionBindingService } from "./session-binding-service-Brz3TVSF.js";
import { c as normalizeProviderStarted, d as normalizeBlockedLivenessWaitStatus, s as normalizeAgentRunTimeoutPhase } from "./run-wait-CWLMjxsj.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DvDp8cBn.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-B1T1wJz1.js";
import { l as rewriteTranscriptEntriesInSessionFile } from "./context-engine-lifecycle-C9o9TJkA.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-IMXTkfEf.js";
import { t as dispatchInboundMessage } from "./dispatch-Q_q4HazL.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BLbJnl4_.js";
import { t as createReplyDispatcher } from "./reply-dispatcher-D5Qk19sP.js";
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-OfuwsnJu.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-DMVjkRhw.js";
import { t as logLargePayload } from "./diagnostic-payload-DAPt2izf.js";
...
import { n as isSuppressedControlReplyText } from "./control-reply-text-vSZfBi0t.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-DV1Osb6e.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-DwSQFy-E.js";
import { a as resolveChatAttachmentLooksLikeImage, i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CDoRVX02.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-Ct3kaO1n.js";
