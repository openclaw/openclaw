...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-D1eqrBeU.js";
...
import { r as getChildLogger } from "./logger-DZLjhaVZ.js";
...
import { n as mutateConfigFile } from "./mutate-DzIqAz79.js";
import { u as fireAndForgetHook } from "./hook-runner-global-Bqn2eA2l.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths---FlWJ0A.js";
import { F as resolveSessionStoreEntry } from "./store-load-DM26fo1a.js";
import { u as updateSessionStore } from "./store-CuGD5gZu.js";
import { c as appendSessionTranscriptMessage, d as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript } from "./transcript-CkSJhWxP.js";
...
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CDMfe5qT.js";
...
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-CGbRXSXm.js";
import { n as MediaFetchError } from "./fetch-W-nDh9OC.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DSpxZ7Q4.js";
import { t as resolveAckReaction } from "./identity-BspxvuU6.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-B3ut6ovI.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-Bb3njsti.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-Do2oSuc_.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-D9tiqfZP.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-Baeyp9TZ.js";
...
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-Cvla8EaD.js";
...
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-BiTMXpCL.js";
import "./approval-reply-runtime-B4NimCe4.js";
...
import "./config-mutation-Bomix1Fl.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-B5rPEsLs.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-Cwr_lq-t.js";
...
import "./agent-harness-runtime-BdPuqkuX.js";
import "./hook-runtime-CXWd2ncX.js";
import "./markdown-table-runtime-B0T3zCQB.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-Dx-ZYcU5.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-ywT2L60k.js";
import "./command-auth-native-Bny5Lm0M.js";
import "./command-primitives-runtime-BcI_-JHA.js";
import "./command-status-Dol_K4HR.js";
import "./command-detection-DOaGHvc0.js";
import "./command-surface-CX2ABtzr.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Dr3f0mtP.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-Dv79lZRY.js";
import { i as resolveUnmentionedGroupInboundPolicy, r as classifyChannelInboundEvent, s as shouldDebounceTextInbound } from "./channel-inbound-KgnF1FoY.js";
...
import { h as createMessageReceiveContext } from "./channel-message-CO23hUpq.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-7HRhNQYy.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-Dn2DlkAp.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-vcxmLnrG.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-B9tWegUO2.js";
import { A as Bot, C as createTelegramClientFetch, E as resolveTelegramOutboundClientTimeoutFloorSeconds, M as sequentialize, O as withTelegramApiErrorLogging, S as asTelegramClientFetch, T as resolveTelegramClientTimeoutSeconds, a as editMessageTelegram, g as recordSentMessage, j as apiThrottler, k as getOrCreateAccountThrottler, w as resolveTelegramClientTimeoutMinimumSeconds, x as buildInlineKeyboard } from "./send-C2kP532X.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CU-tJK1Q.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as createNativeTelegramToolProgressDraft, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands, t as defaultTelegramBotDeps } from "./bot-deps-CTPvzHi0.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DEMCemhL.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-Cvu8x9-w.js");
...
const registerTelegramHandlers = ({ cfg, accountId, bot, opts, telegramTransport, runtime, mediaMaxBytes, telegramCfg, allowFrom, groupAllowFrom, resolveGroupPolicy, resolveTelegramGroupConfig, shouldSkipUpdate, processMessage, logger, telegramDeps, resolveGroupActivation, resolveGroupRequireMention }) => {
	...
	const processInboundMessage = async (params) => {
		const { ctx, msg, chatId, isGroup, isForum, resolvedThreadId, dmThreadId, storeAllowFrom, senderId, dmPolicy, effectiveGroupAllow, effectiveDmAllow, groupConfig, topicConfig, sendOversizeWarning, oversizeLogMessage, promptContextMinTimestampMs, dispatchDedupeKeys } = params;
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-DixmEBKE.js")).defaultTelegramBotDeps;
