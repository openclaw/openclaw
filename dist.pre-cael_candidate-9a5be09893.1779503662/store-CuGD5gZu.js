...
import { s as normalizeSessionPeerId } from "./session-key-utils-Ce_xWkNq.js";
import { d as resolveAgentIdFromSessionKey } from "./session-key-Bte0mmcq.js";
import { i as normalizeHyphenSlug } from "./string-normalization-DiPHgdft.js";
import { s as writeTextAtomic } from "./json-files-C2hqjU--.js";
import { t as createSubsystemLogger } from "./subsystem-DzLaJyoj.js";
import { i as getRuntimeConfig } from "./io-BxFubSMj.js";
import { l as listDeliverableMessageChannels, u as normalizeMessageChannel } from "./message-channel-D8iFykAD.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext, s as normalizeSessionDeliveryFields, t as deliveryContextFromChannelRoute } from "./delivery-context.shared-ubhMwJVk.js";
import { a as isSessionArchiveArtifactName, c as isTrajectorySessionArtifactName, i as isPrimarySessionTranscriptFileName, r as isCompactionCheckpointTranscriptFileName } from "./artifacts-CAhtFeLv.js";
import { i as resolveSessionFilePath, u as resolveStorePath } from "./paths---FlWJ0A.js";
import { C as pruneStaleEntries, E as shouldRunSessionEntryMaintenance, F as resolveSessionStoreEntry, P as normalizeStoreSessionKey, S as pruneQuotaSuspensions, T as shouldPreserveMaintenanceEntry, _ as takeMutableSessionStoreCache, b as capEntryCount, d as cloneSessionStoreRecord, f as dropSessionStoreObjectCache, g as setSerializedSessionStore, h as isSessionStoreCacheEnabled, i as readSessionEntry, j as getFileStatSnapshot, m as getSerializedSessionStore, n as normalizeSessionStore, o as resolveMaintenanceConfig, p as dropSessionStoreSnapshotCache, r as readSessionEntries, s as collectSessionMaintenancePreserveKeys, t as loadSessionStore, u as clearSessionStoreCaches, v as writeSessionStoreCache, x as getActiveSessionMaintenanceWarning, y as writeSessionStoreSnapshotCache } from "./store-load-DM26fo1a.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath } from "./paths-CzW2SUx5.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin } from "./registry-BE4M2Iz0.js";
...
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-BgvyBC-3.js";
...
function loadTrajectoryCleanupRuntime() {
	trajectoryCleanupRuntimePromise ??= import("./cleanup-nudwA3Au.js");
...
async function upsertSessionEntry(params) {
	...
	await runExclusiveSessionStoreWrite(storePath, async () => {
		...
		if (!params.allowDropAcpMeta && resolved.existing?.acp && !next.acp) next.acp = resolved.existing.acp;
...
//#endregion
export { enforceSessionDiskBudget as C, resolveGroupSessionKey as S, resolveSessionArtifactCanonicalPathsForEntry as T, deriveGroupSessionPatch as _, readSessionUpdatedAt as a, snapshotSessionOrigin as b, saveSessionStore as c, updateSessionStoreEntry as d, upsertSessionEntry as f, getSessionStoreWriterQueueSizeForTest as g, drainSessionStoreWriterQueuesForTest as h, patchSessionEntry as i, updateLastRoute as l, clearSessionStoreCacheForTest as m, getSessionEntry as n, recordSessionMetaFromInbound as o, withSessionStoreWriterForTest as p, listSessionEntries as r, runQuotaSuspensionMaintenance as s, archiveRemovedSessionTranscripts as t, updateSessionStore as u, deriveSessionMetaPatch as v, pruneUnreferencedSessionArtifacts as w, buildGroupDisplayName as x, deriveSessionOrigin as y };
