...
export declare function readWebAuthSnapshot(...args: Parameters<ReadWebAuthSnapshot>): ReturnType<ReadWebAuthSnapshot>;
export declare function readWebAuthState(...args: Parameters<ReadWebAuthState>): ReturnType<ReadWebAuthState>;
export declare function readWebAuthExistsBestEffort(...args: Parameters<ReadWebAuthExistsBestEffort>): ReturnType<ReadWebAuthExistsBestEffort>;
export declare function readWebAuthExistsForDecision(...args: Parameters<ReadWebAuthExistsForDecision>): ReturnType<ReadWebAuthExistsForDecision>;
export declare function readWebAuthSnapshotBestEffort(...args: Parameters<ReadWebAuthSnapshotBestEffort>): ReturnType<ReadWebAuthSnapshotBestEffort>;
