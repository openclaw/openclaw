...
export declare const DEFAULT_THREAD_BINDING_IDLE_TIMEOUT_MS: number;
export declare const DEFAULT_THREAD_BINDING_MAX_AGE_MS = 0;
export declare const DISCORD_UNKNOWN_CHANNEL_ERROR_CODE = 10003;
export declare const RECENT_UNBOUND_WEBHOOK_ECHO_WINDOW_MS = 30000;
