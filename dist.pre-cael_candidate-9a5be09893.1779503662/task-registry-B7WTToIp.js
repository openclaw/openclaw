...
import { r as shouldRouteCompletionThroughRequesterSession } from "./completion-delivery-policy-0-Ss9kMk.js";
import { _ as resolveTaskRegistryDir, g as updateFlowRecordByIdExpectedRevision, h as syncFlowFromTask, s as getTaskFlowById, v as resolveTaskRegistrySqlitePath } from "./task-flow-runtime-internal-CeHh2Jv9.js";
import { a as sanitizeTaskStatusText, i as formatTaskStatusTitleText } from "./task-status-L0fBJBWD.js";
...
function loadTaskRegistryDeliveryRuntime() {
	...
	deliveryRuntimePromise ??= import("./task-registry-delivery-runtime-jZ9TIa8f.js");
...
//#endregion
export { CODEX_NATIVE_SUBAGENT_STALE_ERROR as A, reloadTaskRegistryFromStore as C, updateTaskNotifyPolicyById as D, setTaskRunDeliveryStatusByRunId as E, isChildlessCodexNativeSubagentTask as M, CODEX_NATIVE_SUBAGENT_RUNTIME as O, recordTaskProgressByRunId as S, setTaskCleanupAfterById as T, listTasksForSessionKey as _, finalizeTaskRunByRunId as a, markTaskTerminalById as b, hasActiveTaskForChildSessionKey as c, listFreshTasksForOwnerKey as d, listTaskRecords as f, listTasksForRelatedSessionKey as g, listTasksForOwnerKey as h, ensureTaskRegistryReady as i, CODEX_NATIVE_SUBAGENT_TASK_KIND as j, CODEX_NATIVE_SUBAGENT_RUN_ID_PREFIX as k, isParentFlowLinkError as l, listTasksForFlowId as m, createTaskRecord as n, findTaskByRunId as o, listTasksForAgentId as p, deleteTaskRecordById as r, getTaskById as s, cancelTaskById as t, linkTaskToFlowById as u, markTaskLostById as v, resolveTaskForLookupToken as w, maybeDeliverTaskTerminalUpdate as x, markTaskRunningByRunId as y };
