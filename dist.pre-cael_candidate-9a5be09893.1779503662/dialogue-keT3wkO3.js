import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-D1ekgxS7.js";
import { r as loadCrestodianOverview } from "./overview-B5ObDR9s.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-C7dF0ogD.js")).planCrestodianCommand)({
		input,
		overview
	});
