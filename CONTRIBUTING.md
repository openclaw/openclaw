# Contributing to Mullusi

Welcome to the mullusi tank! 🦞

## Quick Links

- **GitHub:** https://github.com/mullusi/mullusi
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@mullusi](https://x.com/mullusi)
...
- **Vignesh** - Memory (QMD), formal modeling, TUI, IRC, and Mullusi
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/mullusi/mullusi/discussions) or ask in Discord first
...
- Test locally with your Mullusi instance
...
- Do not submit test or CI-config fixes for failures already red on `main` CI. If a failure is already visible in the [main branch CI runs](https://github.com/mullusi/mullusi/actions), it's a known issue the Maintainer team is tracking, and a PR that only addresses those failures will be closed automatically. If you spot a _new_ regression not yet shown in main CI, report it as an issue first.
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for Mullusi skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/mullusi/mullusi/issues) for
["good first issue"](https://github.com/mullusi/mullusi/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
If you're an experienced contributor who wants to help shape Mullusi's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@mullusi.com with:

- Links to your PRs on Mullusi (if you don't have any, start there first)
...
- **Core CLI and gateway** — [mullusi/mullusi](https://github.com/mullusi/mullusi)
- **macOS desktop app** — [mullusi/mullusi](https://github.com/mullusi/mullusi) (apps/macos)
- **iOS app** — [mullusi/mullusi](https://github.com/mullusi/mullusi) (apps/ios)
- **Android app** — [mullusi/mullusi](https://github.com/mullusi/mullusi) (apps/android)
- **ClawHub** — [mullusi/clawhub](https://github.com/mullusi/clawhub)
- **Trust and threat model** — [mullusi/trust](https://github.com/mullusi/trust)

For issues that don't fit a specific repo, or if you're unsure, email **security@mullusi.com** and we'll route it.
