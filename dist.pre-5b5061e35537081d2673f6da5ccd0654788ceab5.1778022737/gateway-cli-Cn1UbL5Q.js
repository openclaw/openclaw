...
import { t as addGatewayServiceCommands } from "./register-service-commands-zdKv7_GZ.js";
...
import { a as selectDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-5kGdlBIK.js";
...
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-VS28fqwr.js";
import { n as addGatewayRunCommand } from "./run-y1qsXYYl.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-Cv_V8EfA.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-DeFrSOXI.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-DWM2RERs.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-Bz1_rv-Z.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./health-style-Df7ZqWQJ.js"));
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-DNjnRSfa.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-BfamHafB.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-Bvop9xVd.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-DsLdQCek.js"));
