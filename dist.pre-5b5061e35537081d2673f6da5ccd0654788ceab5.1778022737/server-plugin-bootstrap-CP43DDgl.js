...
import { o as normalizePluginsConfig } from "./config-state-6n1ivR82.js";
...
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DGR2X1Ud.js";
import { l as loadOpenClawPlugins, r as clearActivatedPluginRuntimeState } from "./loader-COn7-q7R.js";
import { S as createEmptyPluginRegistry, d as pinActivePluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-Cqk_-fBI.js";
import { t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-2YI-i-Tm.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-Brio9Jtl.js";
import { C as parseModelRef, S as normalizeModelRef } from "./model-selection-shared-DbwzllLp.js";
import "./model-selection-aDhlumjq.js";
import { t as primeConfiguredBindingRegistry } from "./binding-registry-CbM6IHJs.js";
import { i as setGatewaySubagentRuntime, r as setGatewayNodesRuntime } from "./gateway-bindings-1VwAv3x4.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-CAeVZQ4U.js";
...
async function dispatchGatewayMethod(method, params, options) {
	...
	let result;
	const { handleGatewayRequest } = await import("./server-methods-Dz3cx70r.js");
...
//#endregion
export { mergeActivationSectionsIntoRuntimeConfig as a, setFallbackGatewayContextResolver as i, prepareGatewayPluginLoad as n, reloadDeferredGatewayPlugins as r, loadGatewayStartupPlugins as t };
