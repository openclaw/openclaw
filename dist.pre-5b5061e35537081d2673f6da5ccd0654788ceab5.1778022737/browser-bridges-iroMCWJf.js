...
import { d as isPathInside, o as resolveBoundaryPath } from "./boundary-file-read-7ScTVYIc.js";
import { n as resolvePreferredOpenClawTmpDir } from "./tmp-openclaw-dir-24Sjadc6.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Bjj9r8Wn.js";
import { n as loadActivatedBundledPluginPublicSurfaceModuleSync } from "./facade-runtime-B_PKu4cM.js";
import { i as resolveSandboxConfigForAgent } from "./config-CH6rCqnJ.js";
import { t as buildDockerExecArgs } from "./bash-tools.shared-BhNZ79LP.js";
import { t as sanitizeEnvVars } from "./sanitize-env-vars-uHGKwqkZ.js";
import { a as execDocker, i as ensureSandboxContainer, n as dockerContainerState, o as execDockerRaw } from "./docker-CKBFcy32.js";
import { t as parseSshTarget } from "./ssh-tunnel-EXi8U4cJ.js";
...
function buildPinnedAppendPlan(params) {
	return buildPinnedMutationPlan({
		checks: [params.check],
		args: [
			"append",
...
//#endregion
export { buildPinnedAppendPlan as C, buildPinnedWritePlan as D, buildPinnedRenamePlan as E, dockerSandboxBackendManager as O, resolveWritableRenameTargetsForBridge as S, buildPinnedRemovePlan as T, createRemoteShellSandboxFsBridge as _, getSandboxBackendManager as a, createWritableRenameTargetResolver as b, buildExecRemoteCommand as c, createSshSandboxSessionFromConfigText as d, createSshSandboxSessionFromSettings as f, uploadDirectoryToSshTarget as g, shellEscape as h, getSandboxBackendFactory as i, runDockerSandboxShellCommand as k, buildRemoteCommand as l, runSshSandboxCommand as m, startBrowserBridgeServer as n, registerSandboxBackend as o, disposeSshSandboxSession as p, stopBrowserBridgeServer as r, requireSandboxBackendFactory as s, BROWSER_BRIDGES as t, buildSshSandboxArgv as u, isPathInsideContainerRoot as v, buildPinnedMkdirpPlan as w, resolveWritableRenameTargets as x, normalizeContainerPath$1 as y };
