...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-B61Gbdzt.js";
...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-DAgHnxNz.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-CfdZlct7.js";
...
import { t as buildFeishuConversationId } from "./conversation-id-CxZAX8qV.js";
import { i as resolveReceiveIdType } from "./targets-BITHHR2P.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-DtpQypYR.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-SDbpuFHK.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-CzijhGUn.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-BAYAOWWe.js";
import { t as getFeishuRuntime } from "./runtime-CDZ7jhJC.js";
import { a as createEventDispatcher, c as getFeishuUserAgent, o as createFeishuClient, s as createFeishuWSClient, u as require_lib } from "./client-CXJt4R1c.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-BxcKtBBe.js";
import "./runtime-api-BhQHJ5Rb.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-DDCCx6F2.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-D92Wco4a.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-CMzeunZw.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-BN_fqxeA.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-DwUNHbfy.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
//#endregion
//#region extensions/feishu/src/monitor-transport-runtime-api.ts
	...
	server.on("request", (req, res) => {
		...
		(async () => {
			try {
				...
				const { isChallenge, challenge } = import_lib.generateChallenge(payload, { encryptKey });
				if (isChallenge) {
					res.statusCode = 200;
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-DwUNHbfy.js");
