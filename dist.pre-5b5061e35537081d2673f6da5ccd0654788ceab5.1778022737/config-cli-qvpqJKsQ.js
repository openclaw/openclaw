...
import { a as coerceSecretRef, c as isValidEnvSecretRefId, p as resolveSecretInputRef } from "./types.secrets-CyuYZNvB.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CUzC34VU.js";
...
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-3qf-jsau.js";
import { n as info, o as success, t as danger } from "./globals-C7I_COwU.js";
import { a as resolveSecretRefValue } from "./resolve-dooBHUW_.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-BD1XQ5lD.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-u844k3jY.js";
import { w as SecretProviderSchema } from "./zod-schema.core-tzF0kvzE.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-Da0TQ2wh.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Bry1sCmk.js";
import { n as setCommandJsonMode } from "./json-mode-BSVZDxy7.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-C51OM6qh.js");
