...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-DGCN0k7_.js";
import "./ssrf-runtime-B3HHI4NS.js";
import "./retry-runtime-CuxDADhl.js";
import "./secret-input-runtime-Bq54_8jT.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-BYaiDSgb.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DI8cuwoW.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-Bd4RecLK.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DlLbAc0-.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BELSZlNP.js"), import("./logging-0J2JPBvE.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-3XDV91dU.js").then((credentialsReadModule) => ({
