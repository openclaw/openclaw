...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-BxAh-at-.js";
import { l as onAgentEvent } from "./agent-events-DfaZN9JD.js";
import { i as dispatchPluginAgentEventSubscriptions, n as clearPluginHostRuntimeState } from "./host-hook-runtime-BOwdZl-7.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-HiKolQEG.js")]);
