...
import { o as unscopedPackageName, r as resolveSafeInstallDir } from "./install-safe-path-tP408MIV.js";
import { t as parseFrontmatter } from "./frontmatter-DrG_wUn6.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/hooks/install.ts
let hookInstallRuntimePromise;
async function loadHookInstallRuntime() {
	hookInstallRuntimePromise ??= import("./install.runtime-4s2EpdFl.js");
