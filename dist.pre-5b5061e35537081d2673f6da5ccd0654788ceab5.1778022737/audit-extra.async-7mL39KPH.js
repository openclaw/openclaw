...
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-BRWQ9aSR.js";
import { c as normalizeAgentId } from "./session-key-BSgfYlBK.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-tGFhFh-X.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-Dt-jYjoI.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-DoKRDxIt.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CDrug8rq.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-BfgIudLi.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-BPJmqKig.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-DLcHvT8L.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-CG_MAR19.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-CCD5Xrj8.js");
