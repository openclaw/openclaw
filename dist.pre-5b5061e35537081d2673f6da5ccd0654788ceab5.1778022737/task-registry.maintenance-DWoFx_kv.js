...
import { i as sweepExpiredPluginStateEntries, r as isPluginStateDatabaseOpen } from "./plugin-state-store-DTGa5xbV.js";
...
import { C as resolveTaskForLookupToken, _ as markTaskLostById, b as maybeDeliverTaskTerminalUpdate, c as hasActiveTaskForChildSessionKey, d as listTaskRecords, i as ensureTaskRegistryReady, r as deleteTaskRecordById, s as getTaskById, w as setTaskCleanupAfterById, y as markTaskTerminalById } from "./task-registry-Z3625DN_.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-DJ1wyFZB.js";
import "./runtime-internal-CSq50Fdx.js";
import { o as getDetachedTaskLifecycleRuntime, u as tryRecoverTaskBeforeMarkLost } from "./detached-task-runtime-C1Twctmt.js";
import { r as getSessionBindingService } from "./session-binding-service-DssF7JYi.js";
import { n as loadCronStoreSync, r as resolveCronStorePath } from "./store-D_eMq_mW.js";
import { n as getAcpSessionManager } from "./manager-B_0Yd1FW.js";
import { n as readAcpSessionEntry, t as listAcpSessionEntries } from "./session-meta-BIPz3B2G.js";
import { i as isSubagentRecoveryWedgedEntry, r as formatSubagentRecoveryWedgedReason } from "./subagent-recovery-state-BvJQ8hsr.js";
import { r as isCronJobActive } from "./active-jobs-j6vrovk-.js";
import { a as resolveCronRunLogPath, i as readCronRunLogEntriesSync } from "./run-log-QaD9w_yk.js";
import { t as deriveSessionChatTypeFromKey } from "./session-chat-type-shared-BX1Pct72.js";
import { n as listTaskAuditFindings, r as summarizeTaskAuditFindings, t as configureTaskAuditTaskProvider } from "./task-registry.audit-Cm8EttvS.js";
...
function getInspectableActiveTaskRestartBlockers() {
	...
	for (const task of reconcileInspectableTasks()) {
		if (!isActiveTaskRestartBlockerStatus(task.status)) continue;
		const blocker = {
			taskId: task.taskId,
			status: task.status,
