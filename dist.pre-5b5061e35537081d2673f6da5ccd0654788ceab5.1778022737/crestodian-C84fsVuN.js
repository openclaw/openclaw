...
import { r as resolveCrestodianOperation } from "./dialogue-CMzrRgae.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BOV5qMAb.js")).runCrestodianTui;
	opts.onReady?.();
