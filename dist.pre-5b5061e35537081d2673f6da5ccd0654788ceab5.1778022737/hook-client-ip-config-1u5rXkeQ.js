...
import { n as isVitestRuntimeEnv } from "./env-Bw2O6sSO.js";
...
import { r as isCronRunSessionKey } from "./session-key-utils-C1mGpjUn.js";
...
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-IRfwLf8I.js";
...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-CDC1ZOcb.js";
import { u as resolveStorePath } from "./paths-Dl79wsM6.js";
import { t as loadSessionStore } from "./store-load-BJuxv-vp.js";
import { o as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-IyLBOjUO.js";
import "./sessions-DCQidobb.js";
import "./logging-4uQe02ba.js";
import { t as abortAndDrainEmbeddedPiRun } from "./runs-qXGu5GiY.js";
import { i as isGatewayModelPricingEnabled } from "./model-pricing-cache-DaL5C6FJ.js";
import "./session-utils.fs-Cpvj0zGb.js";
import { i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-Bt-hwnfd.js";
import { i as enqueueCommandInLane, p as setCommandLaneConcurrency } from "./command-queue-CIYT9xfZ.js";
import { o as normalizeCronJobInput } from "./openclaw-tools-2DL7Ok1u.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-CIUKqp9x.js";
...
import { a as isRetryableHeartbeatBusySkipReason, o as requestHeartbeat } from "./heartbeat-wake-DwM6IijA.js";
import { a as enqueueSystemEvent } from "./system-events-DLvm6-8V.js";
import { a as resolveCronNotificationSessionKey, i as resolveCronDeliverySessionKey, o as resolveCronSessionTargetSessionKey, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-DodKv86d.js";
import { t as buildOutboundSessionContext } from "./session-context-1Swx5J4R.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-C1Twctmt.js";
import "./pi-embedded-R8cR5SoZ.js";
import { a as cronSchedulingInputsEqual, i as saveCronStore, r as resolveCronStorePath, t as loadCronStore } from "./store-D_eMq_mW.js";
import { i as markCronJobActive, t as clearCronJobActive } from "./active-jobs-j6vrovk-.js";
import { a as resolveCronRunLogPath, o as resolveCronRunLogPruneOptions, t as appendCronRunLog } from "./run-log-QaD9w_yk.js";
import { n as resolveAgentOutboundIdentity } from "./identity-D5i6tI7t.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-Dsvj3R7E.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-CSkf3i79.js";
import { n as resolveFailureDestination, t as resolveCronDeliveryPlan } from "./delivery-plan-VAL54pFY.js";
import { t as runCronIsolatedAgentTurn } from "./isolated-agent-BBj2JVip.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-Bc_P3rB8.js";
import { t as createCronExecutionId } from "./run-id-B0LGIMxe.js";
import { n as resolveGatewayReloadSettings } from "./config-reload-BiGXFYSb.js";
import { n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-CtW5P9BX.js";
import fs from "node:fs";
import path from "node:path";
//#region src/gateway/config-recovery-notice.ts
function formatConfigRecoveryIssueSentence(issues) {
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-20Ic-RUh.js");
		const { deliverOutboundPayloads } = await import("./deliver-CENF9D3V.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-ijxYyOvr.js");
...
function startGatewayModelPricingRefreshOnDemand(params) {
	...
	let stopRefresh;
	(async () => {
		const { startGatewayModelPricingRefresh } = await import("./model-pricing-cache-DIsYf2Ud.js");
		if (stopped) return;
