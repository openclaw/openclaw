...
import { a as requireGatewayClientScopeForInternalChannel } from "./command-gates-DjCbIhfw.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-D_unF08T.js";
//#region src/auto-reply/reply/commands-acp.ts
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-CbhCpcrD.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-C3KcUNJB.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-CgdJ5UH2.js"));
