...
import { t as getMatrixRuntime } from "./runtime-CS5p9HRe.js";
import { i as resolveMatrixAccount } from "./accounts-9iJQ7pUi.js";
import { t as formatMatrixErrorMessage } from "./errors-am9GQIsy.js";
import { n as resolveMatrixConfigPath } from "./config-paths-DwEGh6Ct.js";
import { t as updateMatrixAccountConfig } from "./config-update-CJIrvgZQ.js";
import { n as matrixSetupAdapter } from "./setup-core-yIGDAP96.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-DYK2pesD.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-DWHsYl0p.js";
import { t as withResolvedActionClient } from "./client-B6a7yAdv.js";
import { r as resolveMatrixAuthContext } from "./config-PI0HPOby.js";
import "./client-g5NtNy77.js";
import "./runtime-api-5Ab0DK_1.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-ByX1UVSm.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CF-7HQNz.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-CxzDXZ37.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-2RwgBEHf.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-BgKRTxdo.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DVGmAxjV.js");
