...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-D8KGL5tB.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-Cn1UbL5Q.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-Duulrg6M.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-CQw-XIci.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-CRWOInBi.js"),
