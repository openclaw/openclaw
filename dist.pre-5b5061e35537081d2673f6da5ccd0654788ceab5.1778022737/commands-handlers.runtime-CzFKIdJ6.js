...
import { p as resolveUserPath, r as clampInt } from "./utils-CCskKJVV.js";
import { s as normalizeStringEntries } from "./string-normalization-rJ4BOsjW.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-tcp25s--.js";
import { o as loadInstalledPluginIndexInstallRecords } from "./manifest-registry-C9Iavh95.js";
import { r as logVerbose } from "./globals-C7I_COwU.js";
import { r as normalizeOptionalAccountId } from "./account-id-DUpVOe8L.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-BSgfYlBK.js";
import { b as resolveAgentDir, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, T as validateConfigObjectWithPlugins, u as readConfigFileSnapshot } from "./io-BD1XQ5lD.js";
import { f as resolveArchiveKind } from "./archive-BRFDgIKP.js";
import "./installed-plugin-index-records-HUKXRLZh.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-D_qJbIXt.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-C-xvsTbt.js";
import { t as parseDurationMs } from "./parse-duration-Dvk1YTJm.js";
import { r as replaceConfigFile } from "./mutate-BCZFK4XP.js";
import "./config-CshcuIUd.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-D-_dSu_7.js";
import { o as normalizeChannelId } from "./registry-aY1NGwGo.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-C_DWi525.js";
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-CxR7kyT3.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-BjnlYmGj.js";
import { t as getActivePluginChannelRegistry } from "./runtime-Cqk_-fBI.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-zZSBgwJK.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-Dl79wsM6.js";
import { t as loadSessionStore } from "./store-load-BJuxv-vp.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-Cl8KmGKt.js";
import { o as resolveFreshSessionTotalTokens } from "./types-CuAWZ88l.js";
import { o as updateSessionStore } from "./store-IyLBOjUO.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-BznBxQ_f.js";
import { a as extractDeliveryInfo } from "./sessions-DCQidobb.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-5Sw8IXME.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-7ACeYwey.js";
import { g as resolveResponseUsageMode, m as normalizeUsageDisplay } from "./thinking-DXB3ip3_.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-CnZ4N-UP.js";
import { r as getApiKeyForModel } from "./model-auth-BiJ18q5C.js";
import { a as getActiveEmbeddedRunSnapshot, y as replyRunRegistry } from "./runs-qXGu5GiY.js";
import "./diagnostic-OnLcowA0.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-D46_liQE.js";
import { i as callGateway } from "./call-BolF1jqz.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BJyE4NOp.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CfSM05VC.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-BRfjg5MJ.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BgCNJn5R.js";
import { r as isSilentReplyPayloadText } from "./tokens-B5LCdh_k.js";
import { C as setTtsMaxLength, D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsMaxLength, b as setSummarizationEnabled, c as isSummarizationEnabled, f as listTtsPersonas, g as resolveTtsConfig, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, w as setTtsPersona, y as setLastTtsAttempt } from "./tts-runtime-BZA-v29I.js";
import "./tts-BbG2fjoP.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-C0xP7nOa.js";
import { a as resolveBootstrapMaxChars, s as resolveBootstrapTotalMaxChars } from "./google-v9OQvG5C.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-UHcDq1j4.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-wmBDALmq.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-CtTgp22E.js";
import { t as registerProviderStreamForModel } from "./provider-stream-AKptRcqO.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CIwnXy2g.js";
import { a as isCompactionSkipReason } from "./request-compaction-tool-69I7ME1C.js";
import { i as formatDoctorNonInteractiveHint, l as removeRestartSentinelFile, n as buildRestartSuccessContinuation, p as writeRestartSentinel } from "./restart-sentinel-BVIni1iS.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BLjhCPom.js";
import { i as resolveReplyToMode } from "./reply-threading-DChcmm7c.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-PRwm72zi.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-D-n6v_95.js";
import { n as routeReply } from "./route-reply-BBMVaujs.js";
import { s as clearSessionQueues } from "./queue-BR4Rgmvw.js";
import { r as getSessionBindingService } from "./session-binding-service-DssF7JYi.js";
import { t as formatDurationCompact } from "./format-duration-lR2DqIAf.js";
import "./sandbox-DVbI4dTa.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-BEFSrU3O.js";
import { n as estimateTokensFromChars } from "./cjk-chars-CpX0pBx7.js";
import { r as resolveModelWithRegistry } from "./model-CjWVS8xG.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-BNTYNHXq.js";
import { v as getFinishedSession, y as getSession } from "./bash-tools.exec-runtime-C260-Cxu.js";
import { n as formatTimeAgo } from "./format-relative-9--P3uwG.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-BaRGDodV.js";
import { t as isApprovalNotFoundError } from "./approval-errors-B7Urfcq1.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-CNDADEeJ.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-DJV77eQY.js";
import "./commands-registry-Bv9Wm6ed.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-B9Jpe_pm.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-BNwNcdzp.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-BmUnlrE8.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-BI1ByK4W.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-Bv-JD7Ce.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-Cp7CF3NF.js";
import { n as parseActivationCommand } from "./group-activation-Bq0qihXu.js";
import { t as resolveFastModeState } from "./fast-mode-C2yzC_Wi.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-ixJ7Ew7i.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-Bek-o-y9.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-BiBdcIc9.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-BfF65B8F.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-B1psj4ZD.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-CDHROck4.js";
import { t as extractBtwQuestion } from "./btw-command-D26nmNgn.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-BUFLyePo.js";
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-DjCbIhfw.js";
import { t as handleAcpCommand } from "./commands-acp-jwX31u7F.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BWb4A0Bo.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-uLqfOmUz.js";
import { r as handleModelsCommand } from "./commands-models-CBprL0LT.js";
import { r as createExecTool } from "./bash-tools-C45J0OQK.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-Cwdotqiz.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-hnUJB1n7.js";
import { t as buildToolsMessage } from "./status-By8FtJos.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-D0H5FSy_.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-e7UEo6rP.js";
import "./command-export-qBm4r27P.js";
import { t as buildStatusReply } from "./commands-status-BNTUabqt.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-DYQWxEtv.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-B2V8xxu8.js";
import { r as createPluginInstallLogger, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-D5RFqnOu.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-EE0LE-VY.js";
import "./clawhub-Bc84qMmk.js";
import { a as installPluginFromPath, i as installPluginFromNpmSpec } from "./install-Cp7oErY_.js";
import { r as installPluginFromClawHub } from "./clawhub-COSqnTkw.js";
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-DoRFY35s.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BBlvZ6ie.js";
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CbDSPXNV.js");
...
async function buildExportSessionReply(params) {
	...
	await fs$1.writeFile(outputPath, html, "utf-8");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-BYdjhDHL.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-B_DKJNEn.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-C2oXA8SG.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-BZ7uW5JB.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-Sgv8Kwc3.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-a_5sYuBq.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-CESU9br6.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-sYkV12Lt.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-DEsMihL3.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-Cf1z-zQR.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-ChXv3EMJ.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-BExaZYQm.js"));
