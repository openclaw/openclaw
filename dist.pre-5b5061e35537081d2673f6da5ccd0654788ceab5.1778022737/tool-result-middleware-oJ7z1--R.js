...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-7ACeYwey.js";
import "./model-selection-aDhlumjq.js";
import { n as isGoogleModelApi, t as isGemma4ModelRequiringReasoningStrip } from "./google-v9OQvG5C.js";
import { t as log$1 } from "./logger-88Co-Zqv.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-wmBDALmq.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-f8tN-JPZ.js");
