...
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-CCskKJVV.js";
...
import { a as normalizeDiagnosticTraceparent, t as DIAGNOSTIC_TRACEPARENT_PATTERN } from "./diagnostic-trace-context-pure-CAoB9zY8.js";
...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-C1mGpjUn.js";
import { n as normalizeAccountId } from "./account-id-DUpVOe8L.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BSgfYlBK.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BD1XQ5lD.js";
import { t as isWindowsDrivePath } from "./archive-path-CRS0LTI5.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-B3pr-X7V.js";
import { t as applyMergePatch } from "./merge-patch-BzwP7uYW.js";
import { g as selectApplicableRuntimeConfig } from "./runtime-snapshot-BXa0Udtg.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-DWkPvc9L.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DfaZN9JD.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-Dl79wsM6.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-C4S7NY0S.js";
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BJuxv-vp.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-Cl8KmGKt.js";
import { n as resolveSessionConversationRef } from "./session-conversation-CJH3ZpC2.js";
...
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-7ACeYwey.js";
import { S as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, x as modelKey } from "./model-selection-shared-DbwzllLp.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-aDhlumjq.js";
...
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CAviF5AZ.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-BLXvR-0g.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-CFjsGwS0.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-Cpvj0zGb.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-l6vzGR0v.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-BSOMY2VP.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, i as normalizeToolName, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, n as expandToolGroups, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-ywrO5Obc.js";
import "./tool-policy-Gps1tVLh.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-Dn3bFVQ4.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-CLhhfEgQ.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-BbjDz5HF.js";
import { n as extractTextFromChatContent } from "./chat-content-C8BtNp8Y.js";
import { r as stripToolMessages } from "./chat-history-text-Cea00_dh.js";
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-11rLH7D3.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-B5LCdh_k.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-B30DelN1.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-DNWZXyec.js";
import { D as textToSpeech } from "./tts-runtime-BZA-v29I.js";
import "./tts-BbG2fjoP.js";
import { a as getImageMetadata } from "./image-ops-CWHvHS2F.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-UHcDq1j4.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-C2hewfbk.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-BqeSuwSs.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-r0xrE0Xt.js";
import { t as SsrFBlockedError } from "./ssrf-BUVRrita.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DyvqMMGn.js";
...
import { n as runWithImageModelFallback } from "./model-fallback-CYKaQ95i.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-69I7ME1C.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-CBt8chmE.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-DzWfTiMA.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-DUItrpyH.js";
import { n as assertSandboxPath } from "./sandbox-paths-D55Xc0F2.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-CPsrzS02.js";
...
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-Bca5YskA.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-BphUzQ8_.js";
import "./delivery-context-DjnXDY-i.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-B0jifJb6.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-CeNzREEd.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-CUkWYVtg.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-Dnwbi7xc.js";
import { i as resolveMaxDelegatesPerTurn } from "./config-Cko-TbTj.js";
import "./targeting-D6CsJ6oa.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BdQs4YDx.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-C1189KtD.js";
...
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-DodKv86d.js";
...
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BSWOob0W.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-j-aQgdfu.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-D8YseGxo.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BHad_qQt.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BecgpIaj.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DJJaIpry.js";
import { l as saveMediaBuffer } from "./store-CuaIMlC4.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-D8X3Y-o4.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-Cd1lDznL.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-X_G-88PC.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BLjhCPom.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CPEueUX4.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-29rR3zs_.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CV4Ut2SD.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-8EFxT11h.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-Caok1Amj.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-B8W_-rHp.js";
import { s as resolveTimeoutMs } from "./resolve-DBjBVTd7.js";
import { t as buildProviderRegistry } from "./runner-NxZXZlaX.js";
...
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-D7PVs_O-.js";
import { t as sendMessage } from "./message-k3CM85PS.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-D_dQAi3N.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-BUIDRMKM.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-D-n6v_95.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-C1Twctmt.js";
import "./task-registry-delivery-runtime-Cls3JP9F.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-FHE2xp8J.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-CeHJibOv.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-uABYgawK.js";
import { t as parseTimeoutMs } from "./parse-timeout-BQrxeqI2.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-DPgoM5LP.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CkZPuP21.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CvZ72d8u.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-Bh68L5Oy.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-SM2r_1AU.js";
import { p as registerSubagentRun } from "./subagent-registry-BTp9tQ5h.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DLskFlrE.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DUhaEzWQ.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-CayJvISg.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-ClwNaU8j.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DceqVjYj.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-DyTL3ggw.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-jc-jJsGP.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-DGvt9waq.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-Dd5YyQGX.js";
import { i as runWebSearch } from "./runtime-DB_1SuSI.js";
import "./web-search-provider-common-CVchDKcW.js";
...
function isAsyncMediaDirectSendEnabled(params) {
	if (params.directCompletionDelivery === "disabled") return false;
...
async function wakeMediaGenerationTaskCompletion(params) {
	...
	if (isAsyncMediaDirectSendEnabled({
		config: params.config,
...
function resolveImplicitCurrentSessionFallback(params) {
	...
	if (!params.allowFallback || !requesterKey) return null;
	return {
		key: requesterKey,
		...
		execute: async (_toolCallId, args) => {
			...
			if (!resolved) {
				const fallback = resolveImplicitCurrentSessionFallback({
					allowFallback: requestedKeyRaw === "current" || requestedKeyParam === void 0,
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-CBCCjDa0.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CKPDkF5P.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-D99MT05z.js"));
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-rQuJ2JJm.js"));
...
function createWebSearchTool(options) {
	...
	return {
		...
		execute: async (_toolCallId, args, signal) => {
			const runtimeWebSearch = options?.lateBindRuntimeConfig === true ? getActiveRuntimeWebToolsMetadata()?.search : options?.runtimeWebSearch;
			const runtimeProviderId = runtimeWebSearch?.selectedProvider ?? runtimeWebSearch?.providerConfigured;
			const config = options?.lateBindRuntimeConfig === true ? void 0 : options?.config;
...
function isToolAllowedByFactoryAllowlist(toolName, allowlist) {
...
function resolveOptionalMediaToolFactoryPlan(params) {
	...
	const allowImageGenerate = isToolAllowedByFactoryAllowlist("image_generate", params.toolAllowlist);
	const allowVideoGenerate = isToolAllowedByFactoryAllowlist("video_generate", params.toolAllowlist);
	const allowMusicGenerate = isToolAllowedByFactoryAllowlist("music_generate", params.toolAllowlist);
...
//#endregion
export { isEmbeddedMode as C, stripProviderPrefix as S, wrapToolWorkspaceRootGuard as _, normalizeCronJobCreate as a, isStrictAgenticExecutionContractActive as b, createHostWorkspaceAppendTool as c, createOpenClawReadTool as d, createSandboxedEditTool as f, wrapToolMemoryFlushAppendOnlyWrite as g, wrapToolMemoryDayFileWriteGuard as h, listRuntimeMusicGenerationProviders as i, createHostWorkspaceEditTool as l, createSandboxedWriteTool as m, isParentOwnedBackgroundAcpSession as n, normalizeCronJobInput as o, createSandboxedReadTool as p, generateMusic as r, normalizeCronJobPatch as s, createOpenClawTools as t, createHostWorkspaceWriteTool as u, wrapToolWorkspaceRootGuardWithOptions as v, setEmbeddedMode as w, isStrictAgenticSupportedProviderModel as x, resolveOpenClawPluginToolsForOptions as y };
