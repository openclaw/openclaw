...
import { u as prepareScopedSetupConfig } from "./setup-helpers-t5I1EDve.js";
import "./setup-C421YIRA.js";
import { a as resolveMatrixAccountConfig } from "./account-config-Bd4RecLK.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-9iJQ7pUi.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Dy5Lq2QF.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DVGmAxjV.js");
