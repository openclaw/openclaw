import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-0iV0idbT.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-llzRy3Cd.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-BDsYiSID.js";
import { r as readModelListResult } from "./models-kUTT03f3.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-BHpbsT8N.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
