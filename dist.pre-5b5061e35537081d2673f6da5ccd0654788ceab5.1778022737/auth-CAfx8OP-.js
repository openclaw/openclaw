...
import { S as resolveDefaultAgentId, b as resolveAgentDir, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { t as parseDurationMs } from "./parse-duration-Dvk1YTJm.js";
import { s as loadAuthProfileStoreForRuntime } from "./store-Cmn8Tc5V.js";
import { n as resolvePluginProviders } from "./providers.runtime-BAEs8Ja2.js";
import "./model-selection-shared-DbwzllLp.js";
...
import { i as upsertAuthProfile } from "./profiles-nyhba-6y.js";
import { n as clearAuthProfileCooldown } from "./usage-B2Hi4H5h.js";
import "./workspace-BJnGgOZY.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-DDEHu4KM.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-CQu-GzI8.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-DrlWA6Nb.js";
import { t as createClackPrompter } from "./clack-prompter-CO31wAJL.js";
import { n as logConfigUpdated } from "./logging-C9iUgLGX.js";
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-BjZZSoRb.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-4iRhpNnC.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-BpXV_dE8.js";
import { t as isRemoteEnvironment } from "./remote-env-o6oLBAF4.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-lCjsD8sS.js");
				await openUrl(url);
			},
