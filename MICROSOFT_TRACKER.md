...
>
> **Last updated:** 2026-07-21 (post-purge audit: refreshed from currently open GitHub issues/PRs and rebuilt from PR #49126 format)
...
| ------------------------- | ------ | ------ | ------- | ------ | --------- |
| MS Teams (channel plugin) | 15     | 48     | 63      | 0      | 63        |
| Windows platform          | 52     | 40     | 92      | 0      | 92        |
| WSL                       | 3      | 0      | 3       | 0      | 3         |
| Azure                     | 10     | 7      | 17      | 0      | 17        |
| SharePoint / M365         | 0      | 1      | 1       | 0      | 1         |
| **Total**                 | **80** | **96** | **176** | **0**  | **176**   |
...
| [ ]       | P2       | #112176 | feat(channels): add channel-owned setup contracts                                                                     | XL   |              |
| [ ]       | P2       | #112078 | feat: add NVIDIA Nemotron Speech ASR and TTS                                                                          | L    |              |
| [ ]       | P2       | #112057 | docs: fix incorrect CLI command in 14 extension READMEs                                                               | XS   |              |
...
| [ ]       | P2       | #112173 | ACP workers hang forever on permission prompts when Gateway runs as a hidden-console Windows service (stdin.isTTY=true)                                                                 |                                                                                                                                                                                     |             |
| [ ]       | P2       | #112051 | Windows installer cannot repair stale Winget Node registrations                                                                                                                         |                                                                                                                                                                                     |             |
| [ ]       | P2       | #112049 | Windows source install can misreport UI build status                                                                                                                                    |                                                                                                                                                                                     |             |
| [ ]       | P2       | #111948 | [Bug]: Windows package timeout can leave command-shim descendants running                                                                                                               | `P2` `clawsweeper:no-new-fix-pr` `clawsweeper:linked-pr-open` `issue-rating: 🦪 silver shellfish` `impact:other`                                                                    |             |
...
| [ ]       | P2       | #112267 | feat(cua-computer): add experimental Windows/Linux computer-use fulfiller             | XL   |          |
| [ ]       | P2       | #112202 | fix(process): prevent Windows process-tree leaks after taskkill refusal               | M    |          |
| [ ]       | P2       | #112055 | fix(install): repair stale Winget Node registrations                                  | XS   |          |
| [ ]       | P2       | #111956 | fix(release): stop Windows package descendants after timeout                          | S    |          |
| [ ]       | P2       | #111902 | fix(codex): stop timed-out resume process trees on Windows                            | M    |          |
...
| MS Teams (channel plugin) | pr    | P1       | #92591  | feat(msteams): respond to channel messages by keyword without an @mention                                                                       |
| MS Teams (channel plugin) | pr    | P1       | #89944  | Idr msteams adaptive card tables                                                                                                                |
| MS Teams (channel plugin) | pr    | P2       | #94348  | fix(msteams): keep attachment replies in channel threads                                                                                        |
| MS Teams (channel plugin) | pr    | P2       | #93292  | feat(msteams): per-call topLevel override on send action for proactive new channel threads                                                      |
| MS Teams (channel plugin) | pr    | P2       | #91729  | fix(msteams): trim streamed prefix in long-reply fallback to stop >4000-char double-post (regressed #59297 in #76262)                           |
