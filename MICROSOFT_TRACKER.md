...
>
> **Last updated:** 2026-06-28 (post-purge audit: refreshed from currently open GitHub issues/PRs and rebuilt from PR #49126 format)
...
| ------------------------- | ------ | ------ | ------- | ------ | --------- |
| MS Teams (channel plugin) | 11     | 44     | 55      | 0      | 55        |
| Windows platform          | 51     | 42     | 93      | 0      | 93        |
| WSL                       | 9      | 1      | 10      | 0      | 10        |
| Azure                     | 8      | 4      | 12      | 0      | 12        |
...
| [ ]       | P2       | #90217 | test: make doctor state integrity symlink test robust on Windows                               | S    |             |
...
| [ ]       | P2       | #97349 | fix(azure-openai-responses): bound SSE response reads via buildGuardedModelFetch | S    |          |
