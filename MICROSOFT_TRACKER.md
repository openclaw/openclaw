...
>
> **Last updated:** 2026-07-19 (post-purge audit: refreshed from currently open GitHub issues/PRs and rebuilt from PR #49126 format)
...
| Windows platform          | 49     | 32     | 81      | 0      | 81        |
| WSL                       | 4      | 0      | 4       | 0      | 4         |
| Azure                     | 10     | 5      | 15      | 0      | 15        |
| SharePoint / M365         | 0      | 0      | 0       | 0      | 0         |
| **Total**                 | **78** | **79** | **157** | **0**  | **157**   |
...
| [ ]       | P2       | #111161 | fix(msteams): catch body cancel rejections in attachment fetch                                                        | M    |              |
...
| [ ]       | P2       | #111260 | fix(cron): run Windows exit watchers when ComSpec is blank                            | XS   |          |
