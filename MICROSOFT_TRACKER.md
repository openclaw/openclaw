...
| Resolved? | Priority | #       | Title                                                                                 | Size | Assignee |
| --------- | -------- | ------- | ------------------------------------------------------------------------------------- | ---- | -------- |
| [ ]       | P0       | #109823 | fix(agents): agent-created files get lowercased names on Windows                      | S    |          |
...
| Windows platform          | pr    | P0       | #109823 | fix(agents): agent-created files get lowercased names on Windows                                                                     |
...
| Azure                     | pr    | P0       | #107070 | refactor(whatsapp): centralize inbound turn admission and history finalization                                                       |
