...
import { s as resolvePluginContributionOwners } from "./plugin-registry-BhkUcREW.js";
...
import { t as ConfigMutationConflictError } from "./mutate-D8hwQ_06.js";
...
import { t as note$1 } from "./note-De7QpaFE.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CdTyygwd.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-B8VsXurX.js";
import { n as applyAuthChoice } from "./auth-choice-Di1VL6oy.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-xi_ICScc.js";
import { i as setupChannels } from "./onboard-channels-Agleywps.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-pvkxiJI_.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BAMlPvxJ.js";
import { t as promptCustomApiConfig } from "./onboard-custom-EICziNnf.js";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-B11JA7vf.js";
import { t as setupSkills } from "./onboard-skills-Dlr0tHto.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-DSZNt80B.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CCO316ub.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BX7sfXsA.js");
