...
import { t as extensionUsesSkippedScannerPath } from "./scan-paths-DT-qJash.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-DXFFbGYl.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-BlvY9Lyw.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-C8WmPQeX.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CO0iEP9H.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-HEzUlpOL.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-BGAxI8yL.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-BlldaBUh.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-Bpgy61rG.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-CeU-b1vd.js");
