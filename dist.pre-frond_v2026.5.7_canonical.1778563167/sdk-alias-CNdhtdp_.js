...
function shouldIncludePrivateLocalOnlyPluginSdkSubpath(params) {
	return shouldIncludePrivateLocalOnlyPluginSdkSubpaths() || params.subpath === CODEX_NATIVE_TASK_RUNTIME_PLUGIN_SDK_SUBPATH && isBundledCodexPluginModulePath({
...
function listPluginSdkExportedSubpaths(params = {}) {
	...
	if (!packageRoot) return [];
	const includeCodexPrivateRuntime = isBundledCodexPluginModulePath({
		packageRoot,
		modulePath
	});
