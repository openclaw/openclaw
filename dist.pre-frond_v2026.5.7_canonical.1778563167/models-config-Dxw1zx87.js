...
import { a as createConfigRuntimeEnv } from "./state-dir-dotenv-4IyZI5EB.js";
import { m as resolveSecretInputRef } from "./types.secrets-0GsiwJ5t.js";
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-BvxMxU5i.js";
import { c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir } from "./agent-scope-config-fFkwW_47.js";
import "./agent-scope-CBctHYDw.js";
import { t as MODEL_APIS } from "./types.models-qWDdXicG.js";
import { n as resolveInstalledManifestRegistryIndexFingerprint } from "./manifest-registry-installed-BkO3Iwhl.js";
import { t as privateFileStore } from "./private-file-store-BeCnJMlm.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DffLY5Jy.js";
import { t as createSubsystemLogger } from "./subsystem-BjA1KmGE.js";
import { i as getRuntimeConfig, s as projectConfigOntoRuntimeSourceSnapshot } from "./io-C7AkIz5l.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-C7l6EghF.js";
import { s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-BZYZ5rKR.js";
import "./config-oSZ2D4Be.js";
import { n as ensureAuthProfileStore } from "./store-BG13PXJL.js";
import { d as resolveOwningPluginIdsForProvider } from "./providers-BPM9xlh_.js";
import { D as resolveProviderConfigApiKeyWithPlugin, h as normalizeProviderConfigWithPlugin, r as applyProviderNativeStreamingUsageCompatWithPlugin } from "./provider-runtime-Cc6LcVZi.js";
import { g as resolveNonEnvSecretRefHeaderValueMarker, h as resolveNonEnvSecretRefApiKeyMarker, m as resolveEnvSecretRefHeaderValueMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-ByADKEFE.js";
import { i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-WUYbAl1V.js";
import { a as normalizeHeaderValues, c as resolveMissingProviderApiKey, i as normalizeConfiguredProviderApiKey, n as createProviderAuthResolver, o as normalizeResolvedEnvApiKey, s as resolveApiKeyFromProfiles, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-B5lt1jwi.js";
...
function normalizeProviderModelsForConfig(providerKey, provider) {
	...
	for (const model of provider.models) {
		...
		const normalizedId = rawId ? normalizeConfiguredProviderCatalogModelId(providerKey, rawId) : rawId;
...
function normalizeProviders(params) {
	...
	for (const [key, provider] of Object.entries(providers)) {
		...
		const providerWithNormalizedModels = normalizeProviderModelsForConfig(normalizedKey, normalizedProvider);
