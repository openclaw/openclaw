...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-DZaiV9pc.js";
import { r as resolveCrestodianOperation } from "./dialogue-CXAW_tfI.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CYumeDZH.js")).runCrestodianTui;
	opts.onReady?.();
