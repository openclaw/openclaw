...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-DKMsgwvS.js";
...
import { n as info, o as success, t as danger } from "./globals-CQst_TEw.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-C7AkIz5l.js";
...
import { n as redactConfigObject } from "./redact-snapshot-CZWF1oQd.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-TzMFdcv1.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Bpb6ke9x.js";
import { n as setCommandJsonMode } from "./json-mode-Q3kBWl6t.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-B3RYW8FQ.js");
