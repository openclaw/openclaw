...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-C7AkIz5l.js";
import { n as formatConfigIssueLines } from "./issue-format-BK_NTRYi.js";
import { t as note } from "./note-De7QpaFE.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-9abmu6Jg.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-C44vA3tH.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-CCs-qlhA.js");
