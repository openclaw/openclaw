...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-Dd3sTZQB.js";
import "./local-file-access-D7QWcDEn.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-Dz_R57Df.js";
...
import { a as getDefaultMediaLocalRoots } from "./local-roots-DgIwgW97.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DKb-QDxD.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-Z_AAwLt7.js";
import { t as providerSupportsCapability } from "./provider-supports-Dk_4E1lg.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-B6e9gl9E.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-DLS1cd4p.js";
import { t as buildRandomTempFilePath } from "./temp-download-BLQkHfyi.js";
import "./temp-path-DFpJh8Mx.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-e66HDQ3m.js";
import "./shared-CehXwcdG.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-DPxpKyk6.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-DyKC6U4D.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-D6uDL-nI.js");
