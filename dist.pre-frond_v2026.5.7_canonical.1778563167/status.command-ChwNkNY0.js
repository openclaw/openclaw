...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-DfjRRvrO.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-CF8BhDwY.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-CQaEidWd.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-XFVz5hS_.js"));
const statusGatewayConnectionRuntimeLoader = createLazyImportLoader(() => import("./status.gateway-connection.runtime.js"));
const statusNodeModeModuleLoader = createLazyImportLoader(() => import("./status.node-mode-Be4f3d0R.js"));
