...
import { c as readErrorName } from "./errors-ixwfrboQ.js";
...
import { i as emitAgentEvent } from "./agent-events-DkpIHRmj.js";
import { a as resolveSessionTranscriptFile, c as appendSessionTranscriptMessage, i as readTailAssistantTextFromSessionTranscript } from "./transcript-DVe7upns.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Bk5onV1S.js";
import { d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-BXScA6gP.js";
import { n as ensureAuthProfileStore } from "./store-DeL3KnJu.js";
import { t as isCliProvider } from "./model-selection-cli-CMQJK0aU.js";
import "./model-selection-Bv3hO0Wd.js";
import { i as resolveAuthProfileOrder } from "./order-DxMrLXwI.js";
import { r as formatAcpErrorChain } from "./errors-zyHRqIKC.js";
import { c as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-BjCkEewK.js";
import { l as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-CJM3mFkO.js";
import { r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-CcBPBKs7.js";
import { at as buildUsageWithNoCost, n as resolveAvailableAgentHarnessPolicy } from "./selection-DQzfB1Vz.js";
import { t as FailoverError } from "./failover-error-Ck_NFSPI.js";
import { t as normalizeReplyPayload } from "./normalize-reply-BiqnLDvJ.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-ByFIpbGP.js";
import { t as runCliAgent } from "./cli-runner-CZwLWDMN.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-DrY_nsxX.js";
import { i as resolveFallbackRetryPrompt, n as claudeCliSessionTranscriptHasContent, t as buildClaudeCliFallbackContextPrelude } from "./attempt-execution.helpers-DGJpRL6T.js";
import { t as persistSessionEntry } from "./attempt-execution.shared-iPK9a4ip.js";
import { t as clearCliSessionInStore } from "./session-store-DjfTrfAt.js";
...
function runAgentAttempt(params) {
	...
	const agentHarnessPolicy = isRawModelRun ? { runtime: "pi" } : resolveAvailableAgentHarnessPolicy({
		provider: params.providerOverride,
		modelId: params.modelOverride,
		config: params.cfg,
		agentId: params.sessionAgentId,
	...
	const embeddedPiHarnessOverride = requestedAgentHarnessId ?? (agentHarnessPolicy.runtime === "pi" && embeddedPiProvider !== params.providerOverride ? "pi" : void 0);
	if (!isRawModelRun && isCliProvider(cliExecutionProvider, params.cfg)) {
		...
		const runCliWithSession = (nextCliSessionId, activeCliSessionBinding = cliSessionBinding) => runWithDiagnosticTraceparent(params.opts.traceparent, () => runCliAgent({
			sessionId: params.sessionId,
			sessionKey: params.sessionKey,
			agentId: params.sessionAgentId,
			trigger: "user",
		...
		return resolveReusableCliSessionBinding().then(async (activeCliSessionBinding) => {
			try {
				...
				if (isClaudeCliProvider(cliExecutionProvider) && shouldClearReusedCliSessionAfterError(err) && activeCliSessionBinding?.sessionId && params.sessionKey && params.sessionStore && params.storePath) {
					log.warn(`CLI session cleared after failed reused turn: provider=${sanitizeForLog(cliExecutionProvider)} sessionKey=${params.sessionKey} reason=${sanitizeForLog(resolveClearedCliSessionReason(err))}`);
					params.sessionEntry = await clearCliSessionInStore({
						provider: cliExecutionProvider,
						sessionKey: params.sessionKey,
						sessionStore: params.sessionStore,
	...
	return runWithDiagnosticTraceparent(params.opts.traceparent, () => runEmbeddedPiAgent({
		sessionId: params.sessionId,
		sessionKey: params.sessionKey,
		agentId: params.sessionAgentId,
		trigger: "user",
