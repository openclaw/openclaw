...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-BvxgVjRy.js";
import "./client-BfKSB6up.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-BLycfJ2i.js";
import { c as parseIMessageTarget } from "./targets-DkCLwllL.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-DXOXGi_O.js";
import "./probe-cLySHS3U.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-CIRhEMew.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-QaTSfYUI.js");
