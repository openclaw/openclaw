...
import { t as ConfigMutationConflictError } from "./mutate-CxFtvytV.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-D_Jt0Cx6.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-DRc7TYrH.js";
import { n as applyAuthChoice } from "./auth-choice-XjriBOLf.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B_Rg-KF_.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DHqL8bkI.js";
import { t as promptCustomApiConfig } from "./onboard-custom-jctiTGZA.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-Chatj0zJ.js";
import { n as formatHealthCheckFailure } from "./health-format-Dh9ZoRVv.js";
import { n as healthCommand } from "./health-BqNQRnI7.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CKvdfqqE.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-cyRQxTiq.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CFUFXp3j.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-B823zQS-.js");
