...
import { s as upsertAuthProfileWithLock } from "./profiles-CXbi56y7.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-BN2u6gnA.js";
import { c as resolveClaudeThinkingProfile, l as cloneFirstTemplateModel } from "./provider-model-shared-DBCMc-LA.js";
import { n as validateAnthropicSetupToken, t as buildTokenProfileId } from "./provider-auth-token-CYz9Jg8n.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-6uXq7eLr.js";
...
import { a as fetchClaudeUsage } from "./provider-usage-BS1wG5EL.js";
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive, t as readClaudeCliCredentialsForRuntime } from "./cli-auth-seam-BxGZR0bK.js";
import { n as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS, r as CLAUDE_CLI_DEFAULT_MODEL_REF, t as CLAUDE_CLI_BACKEND_ID } from "./cli-constants-Dw_grMCy.js";
import "./cli-shared-aMvKR54D.js";
import { t as buildAnthropicCliBackend } from "./cli-backend-BowXd4xB.js";
import { t as buildClaudeCliCatalogEntries } from "./cli-catalog-CP2bjg9x.js";
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-CSSUv-Lg.js";
import { n as normalizeAnthropicProviderConfigForProvider, t as applyAnthropicConfigDefaults } from "./config-defaults-f-5xmUa6.js";
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-DpKhqY_J.js";
import { t as buildReplayPolicy } from "./replay-policy-FMpaB40r.js";
import { l as wrapAnthropicProviderStream } from "./stream-wrappers-bGt1l3QD.js";
...
function isAnthropicOpus47Model(modelId) {
	...
	return normalized.startsWith(ANTHROPIC_OPUS_47_MODEL_ID) || normalized.startsWith(ANTHROPIC_OPUS_47_DOT_MODEL_ID);
}
