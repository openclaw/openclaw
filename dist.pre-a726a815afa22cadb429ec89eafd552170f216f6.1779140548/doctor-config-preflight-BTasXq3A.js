...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CINDrze3.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { t as note } from "./note-Cibib1p3.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CHSSQciw.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BbYCD5QE.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-GCVArpDI.js");
