...
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-CajB5H9e.js";
...
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./pi-tools.policy-B8nH9d-v.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-pgIuRJwt.js";
import { C as wrapToolWorkspaceRootGuard, E as resolveOpenClawPluginToolsForOptions, S as wrapToolMemoryFlushAppendOnlyWrite, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as createHostWorkspaceAppendTool, p as resolveToolLoopDetectionConfig, t as createOpenClawTools, v as createSandboxedEditTool, w as wrapToolWorkspaceRootGuardWithOptions, x as wrapToolMemoryDayFileWriteGuard, y as createSandboxedReadTool } from "./openclaw-tools-ClhGmLV5.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-BX-_BiwW.js";
import { c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, g as listChannelAgentTools, i as copyBeforeToolCallHookMarker, p as copyChannelAgentToolMeta } from "./pi-tools.before-tool-call-DwDZAiUV.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-DZFnGYgt.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-Cetx57qA.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-C4a79nTi.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-JTrCOKmP.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-CXqrh0An.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-C_FPANo1.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-C4qHBkhm.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-B46SA62-.js";
import "./codex-native-web-search-Dh5QBinW.js";
import { t as bindAbortRelay } from "./fetch-timeout-BTClKTeN.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-DbMI_2m6.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-BMBZlqm-.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-BLqUjPGP.js"));
