import { r as ReadResult } from "./root-impl-BDq9rdI7.js";
import fs, { Stats } from "node:fs";

//#region node_modules/@openclaw/fs-safe/dist/errors.d.ts
type FsSafeErrorCode = "already-exists" | "hardlink" | "helper-failed" | "helper-unavailable" | "invalid-path" | "insecure-permissions" | "not-empty" | "not-file" | "not-found" | "not-owned" | "not-removable" | "outside-workspace" | "path-alias" | "path-mismatch" | "permission-unverified" | "symlink" | "timeout" | "too-large" | "unsupported-platform";
...
declare function appendFileWithinRoot(params: {
  rootDir: string;
  relativePath: string;
  data: string | Buffer;
  encoding?: BufferEncoding;
...
//#endregion
export { isPathInside as _, readFileWithinRoot as a, WalkDirectoryEntry as c, walkDirectory as d, walkDirectorySync as f, isNotFoundPathError as g, readSecureFile as h, ensureAbsoluteDirectory as i, WalkDirectoryOptions as l, SecureFileReadResult as m, ExternalFileWriteResult as n, writeExternalFileWithinRoot as o, SecureFileReadOptions as p, appendFileWithinRoot as r, writeFileWithinRoot as s, ExternalFileWriteOptions as t, WalkDirectoryResult as u, FsSafeError as v, FsSafeErrorCode as y };