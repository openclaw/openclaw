...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-rw2bYM9R.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-DdvF1onI.js";
...
import { i as resolveManifestContractOwnerPluginId, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-Cb7myZKf.js";
...
import { t as logDebug } from "./logger-B-H6-XfD.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-CINDrze3.js";
...
import { n as modelKey } from "./model-ref-shared-BpLaMszT.js";
...
import { r as callGateway } from "./call-BuLwg6jf.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-B1ap-pht.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-CJOtFbBC.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-CqJY7arZ.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-aiE2jKMJ.js";
...
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-D4UxZlJL.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BstTfco-.js";
import { n as resolveSessionConversationRef } from "./session-conversation-Bz1KJy05.js";
import { s as updateSessionStore } from "./store-DejgqaRd.js";
import "./plugins-3tO_yYSp.js";
import { n as mergeSessionEntry } from "./types-_KZG4WBE.js";
import { u as extractDeliveryInfo } from "./sessions-CEmQfc29.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-BjHvxzTf.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-CMfwFSWi.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-fWnBOAl-.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-B3eh25eT.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-Bv3hO0Wd.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-MwbyxZGa.js";
import "./auth-profiles-BOSw3IEW.js";
import { n as resolveApiKeyForProfile } from "./oauth-Cko2B1Lk.js";
import { n as listProfilesForProvider } from "./profile-list-Brq_BpG5.js";
import { i as resolveAuthProfileOrder } from "./order-DxMrLXwI.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-DD3QApPW.js";
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-BZNVICOw.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BoizeP8y.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Btk9SdbL.js";
...
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CajB5H9e.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BR86G80s.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, r as SUBAGENT_SPAWN_CONTEXT_MODES, t as spawnSubagentDirect } from "./subagent-spawn-DE36eEJy.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CWpC7MRq.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Dkg1uUrN.js";
...
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CEU9ZJHu.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BeR2AJYB.js";
import { n as loadModelCatalog } from "./model-catalog-DvMN6T_J.js";
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-DC7uJpmA.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-ByrcSMqc.js";
...
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BGSfZWyq.js";
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-8c1TJN-t.js";
import { t as canonicalizeBase64 } from "./base64-GgyLRXZq.js";
import { c as getImageMetadata } from "./media-services-BoO-9yx1.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-VcblLnzc.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-x5SjDjWd.js";
import { a as resolvePluginTools } from "./tools-BX-_BiwW.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DGTVJBWu.js";
import { _ as listChannelSupportedActions, c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, h as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-DwDZAiUV.js";
...
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-DZFnGYgt.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BI7tL8JQ.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-C4a79nTi.js";
import { n as extractAssistantText } from "./pi-embedded-utils-Bmxu23e2.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DWRjOcWY.js";
import { n as runWithImageModelFallback } from "./model-fallback-HyrsK6KA.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-BAUJw7N3.js";
import "./delivery-context-lU12z7kJ.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-ClRUI2lb.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-DOjm4dlk.js";
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-DVAqlQw1.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-QaHHsXX0.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-BKNFQe_U.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-xu7oSGer.js";
import { t as inferLegacyName } from "./normalize-GXbVpV1h.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-BhyggOf6.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BP5ciHf4.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BMou4PSA.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CQVF9jDD.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-Bw34222I.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-Dx97rDLC.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-C5qpCgTY.js";
import { u as saveMediaBuffer } from "./store-C6juM-Dc.js";
import { t as SsrFBlockedError } from "./ssrf-CKoSwg7F.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-B_Ulhtan.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BTClKTeN.js";
import { r as getDefaultLocalRoots } from "./local-media-access-CAghy2OY.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CJPlFteZ.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-yx8ph0pk.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-Cr7X7YCl.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-CwCkxsTJ.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CvLh0r6F.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-1jGH9ErA.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-DhXmEA8J.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-C3ZNJrCO.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-BLBdZxJX.js";
import { n as normalizeMediaProviderId } from "./provider-id-CKyFWR71.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CyTY-OAy.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DjnArj36.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-A76xfK75.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-qcuo6BK4.js";
import { s as resolveTimeoutMs } from "./resolve-uS_fYiP2.js";
import { t as buildProviderRegistry } from "./runner-DLd9wQ6s.js";
import "./media-understanding-DH_oiXsq.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-ddOTaGxR.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-sgoizqZn.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CBW2KsRt.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-C9xqSOhN.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-Dx8LsDrQ.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-D_r3x4TY.js";
import { t as parseTimeoutMs } from "./parse-timeout-Du2bXyy_.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-AgsLSaSl.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-ZD8ULPJ1.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-B79aBLJm.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DRfxE9bZ.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-HlzFMOnW.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-CMDvHSwk.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DKjqnni6.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-C13Yj3zd.js";
import { p as registerSubagentRun } from "./subagent-registry-DoSKlz2G.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CBGpKQvS.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-Cv7u-jBW.js";
import { k as textToSpeech } from "./tts-runtime-D7YdgitZ.js";
import "./tts-DlQdgeTN.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-I025iXhv.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-DBRiovtu.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CJB_Ak0H.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-Ci5vbIwq.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-Cj_LvjZ7.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-DHLOzUia.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-DKg8nDZ4.js";
import { i as runWebSearch } from "./runtime-B4VzjpS8.js";
import "./web-search-provider-common-DAh01tzd.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-DjZHKtWD.js");
		await sendMessage({
			cfg: params.config,
...
function createImageGenerateDuplicateGuardResult(sessionKey, params) {
	const activeTask = findActiveImageGenerationTaskForSession(sessionKey, { prompt: params?.prompt });
	if (!activeTask) return;
	return {
		content: [{
			type: "text",
...
function createImageGenerateTool(options) {
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const duplicateGuardResult = createImageGenerateDuplicateGuardResult(options?.agentSessionKey, { prompt });
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-yEVB3Tk9.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-0t8mhZJI.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-D39nGz-S.js"));
