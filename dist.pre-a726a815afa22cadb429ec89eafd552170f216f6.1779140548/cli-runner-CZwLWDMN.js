...
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-BJxHmbSD.js";
import { p as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-CSPlWsPH.js";
import { c as resolveFailoverStatus, i as isFailoverError, t as FailoverError } from "./failover-error-Ck_NFSPI.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-CLfeRghP.js";
import { i as loadCliSessionHistoryMessages, o as buildAgentHookConversationMessages, r as loadCliSessionContextEngineMessages } from "./session-history-CdVBvHPk.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-Ci8ZbCAp.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-OdzGe1MV.js");
