...
import { c as resolveProviderRequestPolicyConfig, n as buildProviderRequestDispatcherPolicy } from "./provider-request-config-BhPhySxb.js";
import { r as fetchWithTimeout } from "./fetch-timeout-BTClKTeN.js";
import { n as fetchWithSsrFGuard, t as GUARDED_FETCH_MODE } from "./fetch-guard-cSeYqGvl.js";
import { t as executeProviderOperationWithRetry } from "./operation-retry-CczlvZmc.js";
import { o as createProviderHttpError, p as readProviderJsonObjectResponse, r as assertOkOrThrowHttpError } from "./provider-http-errors-CrEd46gC.js";
...
async function pollProviderOperationJson(params) {
	for (let attempt = 0; attempt < params.maxAttempts; attempt += 1) {
		const payload = await readProviderJsonObjectResponse(await fetchProviderOperationResponse({
			stage: "poll",
			url: params.url,
			init: {
				method: "GET",
