...
import { An as preprocess, At as boolean, Et as array, Nn as record, Rn as string, Si as NEVER, Tn as object, Xn as union, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-Bmna8ihM.js";
import { n as ZodIssueCode } from "./compat-ze2wFLca.js";
import { u as ToolPolicySchema } from "./zod-schema.agent-runtime-BJeCsb4R.js";
import { C as SecretInputSchema, I as requireAllowlistAllowFrom, L as requireOpenAllowFrom, S as RetryConfigSchema, T as SecretRefSchema, a as DmConfigSchema, h as MarkdownConfigSchema, i as ContextVisibilityModeSchema, j as TtsConfigSchema, l as GroupPolicySchema, m as MSTeamsReplyStyleSchema, n as BlockStreamingCoalesceSchema, o as DmPolicySchema, s as ExecutableTokenSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, v as ProviderCommandsSchema, x as ReplyToModeSchema } from "./zod-schema.core-DX5KkB1Y.js";
import { t as sensitive } from "./zod-schema.sensitive-BhMo7pGI.js";
import { n as ChannelHeartbeatVisibilitySchema, t as ChannelHealthMonitorSchema } from "./zod-schema.channels-CTP0bdQr.js";
import "./config-schema-gd9RYI9s.js";
import { t as resolveAccountEntry } from "./account-lookup-Db221_ik.js";
import { n as isValidInboundPathRootPattern } from "./inbound-path-policy-a29Q6Si2.js";
import { n as normalizeSlashCommandName, r as resolveCustomCommands, t as normalizeCommandDescription } from "./custom-command-config-Drz37zrI.js";
import { t as isSafeScpRemoteHost } from "./scp-host-BVjQCWxG.js";
...
const SlackStreamingConfigSchema = ChannelPreviewStreamingConfigSchema.extend({ nativeTransport: boolean().optional() }).strict();
...
const TelegramDmSchema = object({ threadReplies: _enum([
	"off",
	"inbound",
	"always"
]).optional() }).strict();
...
const DiscordAccountSchema = object({
	...
	agentComponents: object({ enabled: boolean().optional() }).strict().optional(),
	ui: DiscordUiSchema,
...
//#endregion
export { MSTeamsConfigSchema as a, TelegramConfigSchema as c, IMessageConfigSchema as i, DiscordConfigSchema as n, SignalConfigSchema as o, GoogleChatConfigSchema as r, SlackConfigSchema as s, WhatsAppConfigSchema as t };
