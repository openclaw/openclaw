...
import { t as resolveCliCommandPathPolicy } from "./command-path-policy-BYOlCp0Z.js";
import { t as resolveCliStartupPolicy } from "./command-startup-policy-ZYbA41h9.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-BXqLa1Ui.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-DLA04_EN.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BrfLXPsX.js");
	if (params.argv) {
