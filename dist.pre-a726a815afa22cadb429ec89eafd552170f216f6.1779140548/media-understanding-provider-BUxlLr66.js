...
import "./json-schema-runtime-B49rBMzi.js";
import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-CJUCEdRK.js";
import { c as resolveCodexAppServerRuntimeOptions } from "./config-C_psHunA.js";
import { i as assertCodexTurnStartResponse, l as readCodexTurnCompletedNotification, o as readCodexErrorNotification, r as assertCodexThreadStartResponse } from "./protocol-validators-C-H_67Ck.js";
import { r as readModelListResult } from "./models-DJ8isfq7.js";
...
async function runBoundedCodexVisionTurn(params) {
	...
	const client = params.options.clientFactory ? await params.options.clientFactory(appServer.start, params.profile) : await import("./shared-client-DgeiCb4w.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
