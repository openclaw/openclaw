...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-Cltmiw-3.js";
...
import { i as buildModelAliasIndex, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-fWnBOAl-.js";
import { i as parseModelRef, n as modelKey } from "./model-selection-normalize-B3eh25eT.js";
import "./model-selection-Bv3hO0Wd.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DzPA6JEj.js";
import { t as resolveEnvApiKey } from "./model-auth-env-BDaunZZ0.js";
import { r as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-DD3QApPW.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-BZNVICOw.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-GIp2CW_t.js";
import { n as loadModelsConfigWithSource } from "./load-config-DOGB5n3c.js";
import { n as formatErrorWithStack } from "./list.errors-DZtJjJLh.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-jLHe1INr.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-Bq00-kpa.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-riOYqB-_.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-CMzZfV_s.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BOna35IA.js"),
		import("./agent-scope-CjTpYdDU.js"),
		import("./workspace-CHm0hsUZ.js")
	]);
