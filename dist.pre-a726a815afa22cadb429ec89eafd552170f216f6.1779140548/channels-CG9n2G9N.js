...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-DGTVJBWu.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Dvu2qKoQ.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BJ8ZIvo-.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BMr3e_P1.js";
import { t as WizardCancelledError } from "./prompts-giVBRodb.js";
import { t as createClackPrompter } from "./clack-prompter-DYZOTeLb.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-D5tyx51X.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BJOeE1uQ.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-EN3Bf897.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Dy8xvOkl.js";
import { n as resolveLogFile } from "./log-tail-CvDotXwY.js";
import { t as parseLogLine } from "./parse-log-line-BJjme3WG.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-BAKD1GEP.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-DPaPeRzB.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-BPyNBhw-.js";
import { t as channelsListCommand } from "./list-DzR8GS3J.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-Ck06xVz-.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-B-DsWUiT.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-adqpao8Q.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-B3_KQt64.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-C0bYAwwB.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DL9ezBbA.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-Nyj67vwI.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DXfT8_ss.js");
