...
import { u as prepareScopedSetupConfig } from "./setup-helpers-BMr3e_P1.js";
import "./setup-BM0VbrdJ.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CLP8qd8D.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-Cob72_Kj.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-IJe_Cq-g.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Dz9prEyd.js";
import { n as updateMatrixAccountConfig } from "./config-update-Bkmihxw5.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-J7rJFegE.js");
