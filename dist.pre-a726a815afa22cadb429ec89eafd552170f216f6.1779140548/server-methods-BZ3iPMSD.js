...
import { a as isSubagentSessionKey, c as parseAgentSessionKey, l as parseRawSessionConversationRef, n as isAcpSessionKey, u as parseThreadSessionSuffix } from "./session-key-utils-CJRKuBJA.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-9_btbLFO.js";
import { c as normalizeAgentId, g as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CQewiu8n.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-DaaBuyRT.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-DdvF1onI.js";
...
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-DATUeXAs.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-CINDrze3.js";
import "./archive-D2BjLkE_.js";
...
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-Bzr_rdQG.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-Do4udxrV.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-CxFtvytV.js";
import "./config-BpFERVfB.js";
import { n as isRestartEnabled } from "./commands.flags-9Sm7Btxq.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-YAlHXP_O.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BNv08iCR.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-CNnWDHPu.js";
...
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-BxRHQ0yo.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CeiEGfEA.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BCLwAR3H.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-BFFs4Xr8.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-CqJY7arZ.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-DMwZgnl2.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-aiE2jKMJ.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DkpIHRmj.js";
import { t as isPluginJsonValue } from "./host-hook-json-BvSXlkEZ.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-X0KvSFJP.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-DW4YQCkr.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-_BPRx1WO.js";
import { t as loadSessionStore } from "./store-load-D4UxZlJL.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BstTfco-.js";
...
import { t as listConfiguredSessionStoreAgentIds } from "./targets-CvEriifS.js";
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-CEmQfc29.js";
...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-BBnbLzpC.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-DeL3KnJu.js";
...
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-CIdFH7Ij.js";
import { n as listProfilesForProvider } from "./profile-list-Brq_BpG5.js";
import { i as removeProviderAuthProfilesWithLock } from "./profiles-CXbi56y7.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-BDNtJqBD.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-CG69Vfrb.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-BR86G80s.js";
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-DE36eEJy.js";
...
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DF02aLnZ.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-DZHVMOGr.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-DC7uJpmA.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-DNsl4mXc.js";
...
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-CLbjIH9m.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-CvlpBn9J.js";
import { l as getTotalQueueSize } from "./command-queue-C-_VpIyT.js";
import { n as resolveSendPolicy } from "./send-policy-DzgUmxmv.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-B8nH9d-v.js";
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-ClhGmLV5.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-BX-_BiwW.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-DOFJIUXS.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-B9GxFxq7.js";
import { o as isTimeoutError } from "./failover-error-Ck_NFSPI.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-ysMDbpeD.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-DSo0PM8D.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-DP6HewpI.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-DOjm4dlk.js";
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-DVAqlQw1.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-QaHHsXX0.js";
import { i as parseAbsoluteTimeMs } from "./stagger-xu7oSGer.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-BhyggOf6.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DbMI_2m6.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-Cf1NA2lS.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-yx8ph0pk.js";
import "./runtime-internal-Dvdm_-zR.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-CwCkxsTJ.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-DCpcDXt0.js";
import { a as clearSessionQueues } from "./queue-ChFRxxYF.js";
...
import { i as resolveReplyToMode } from "./reply-threading-BYTsKR8h.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-07626kk-.js";
...
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-B-QdUbIR.js";
...
import { o as dispatchChannelMessageAction } from "./message-action-runner-C9xqSOhN.js";
import "./target-resolver-CFE5IK3a.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-YAo8fzMZ.js";
import { t as resolveAgentTimeoutMs } from "./timeout-nqZIJh2Q.js";
import { D as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, c as isTtsEnabled, d as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, k as textToSpeech, l as isTtsProviderConfigured, m as resolveExplicitTtsOverrides, o as getTtsProvider, r as getResolvedSpeechProviderConfig, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-D7YdgitZ.js";
import "./tts-DlQdgeTN.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Bfp9Et_1.js";
import "./skills-BE5O5-5i.js";
import { t as canExecRequestNode } from "./exec-defaults-8SAFb0vI.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-B2wtWJRZ.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-1uC6FD0i.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-CZDc7iBw.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-BK-HW7xF.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-CH4SA_at.js";
import { t as compactEmbeddedPiSession } from "./compact.queued-DDAlhjfZ.js";
import "./pi-embedded-DrY_nsxX.js";
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-C0xYWoUa.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-CXVGTArk.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-DwHCJTOE.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-M3-BWFix.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-CppfqtzN.js";
import "./commands-registry-ZdjNhfQ5.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-BMBGjKHH.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-C73b_p1-.js";
import "./browser-maintenance-CoyTg5r4.js";
import { c as performGatewaySessionReset } from "./session-reset-service-BCiPyYbC.js";
import { t as getPluginCommandSpecs } from "./command-specs-Dd0eUuh0.js";
import { n as listPluginCommands } from "./commands-CfDxUUdf.js";
import { t as getChannelActivity } from "./channel-activity-BMwgQEUh.js";
...
import { n as summarizeToolDescriptionText } from "./tool-description-summary-B7v-c7zp.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-BZQeROX_.js";
...
import { n as getLastHeartbeatEvent } from "./heartbeat-events-ByxE5pm3.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-DMVTSYl6.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-Dx7fNH-7.js";
import { n as agentCommandFromIngress } from "./agent-command-D_KNUex0.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-DfTY7DRk.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-Cctll6Ef.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CagE97t4.js";
import { t as formatForLog } from "./ws-log-B_AmWiW1.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-BuPt_so8.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-9GMAamUc.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BKKwvoZw.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-C3kNjdGc.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-Dvc4D6Bv.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-C7CbdGDe.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-Dj7glYRw.js";
import { n as createOutboundSendDeps } from "./deps-fvuOn8sN.js";
import "./agent-Ci7b-6d4.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-CNr9h5w0.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-ZpRCKdpA.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DkBjmnx3.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-CA8EdhBO.js";
import "./server-constants-CAyIk_EP.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-TOGr6-88.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BzVEPDV0.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-DjtFEgkJ.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-BOjhgm54.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DuRKBnTo.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-BGByaTnh.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-mhn37gXB.js";
import { t as buildChannelUiCatalog } from "./catalog-Cvw9gFbD.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-CZ-o7-tL.js";
import { s as normalizeUpdateChannel } from "./update-channels-DqECjLKF.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-DcI0Ohox.js";
import { i as resolveConfigReloadMetadata, t as buildGatewayReloadPlan } from "./config-reload-plan-CxOcGK3p.js";
import { t as readConfiguredLogTail } from "./log-tail-CvDotXwY.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-C20Ax4l0.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-BWk4ZXmp.js";
import { t as buildChannelAccountSnapshot } from "./status-DlqybnM4.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-DYBsNG_c.js";
import { t as installSkill } from "./skills-install-CDGgMaQ4.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-Bj-4Wb-F.js";
import { r as readPackageVersion } from "./package-json-BxPdGeUR.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-KYMv3dOD.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-BCfQ6Khs.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-C3bk5QAY.js";
import { t as getStatusSummary } from "./status.summary-BfsGiWsD.js";
import "./status-Dex15gaM.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-Cv5mZK0I.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-CUPgxZ-N.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-acRmOxNb.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-jRYuIHFQ.js";
import { t as diffConfigPaths } from "./config-diff-b6ZsYzA1.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-BkKerkzy.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-YS8V1kQw.js";
import "./heartbeat-runner-CqzWigLz.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-BpX6QOpc.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-B4Cgylo8.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-ltLSqZ2f.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CuBRaNDD.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-QFxoUoBY.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-ac0RQo27.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-DWjRyLiZ.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-CKUE6fJX.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-CX2rClJb.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BnrTvHE2.js");
