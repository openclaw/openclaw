import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BQUn0HN-.js";
import { r as loadCrestodianOverview } from "./overview-DpW13xCv.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CLE76-XF.js")).planCrestodianCommand)({
		input,
		overview
	});
