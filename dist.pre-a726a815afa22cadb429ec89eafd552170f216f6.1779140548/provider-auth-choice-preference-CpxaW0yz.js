...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CbvgD0gR.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-ovGXTfri.js");
