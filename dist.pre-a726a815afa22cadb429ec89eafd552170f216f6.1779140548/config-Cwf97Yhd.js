...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-11Owfj8f.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-9_btbLFO.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-DTxqFfgy.js";
import "./ssrf-runtime-DjGTjYDE.js";
import "./retry-runtime-HEybosKX.js";
import "./secret-input-runtime-cA2ZnNCs.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-BBTdJ_QB.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-CdVAnTxd.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CLP8qd8D.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-lUcGWRiu.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Dz9prEyd.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BAxL3Srz.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-pbV4MNQ6.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-DUrFHuf9.js"), import("./logging-Bq_JPdOd.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BNNPir4w.js").then((credentialsReadModule) => ({
