import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-jTOFerJa.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CgjOmPVd.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-CSuZ7Lpy.js");
