...
import { a as logWarn, r as logInfo } from "./logger-M-PaInRe.js";
import { J as resolveShellEnvFallbackTimeoutMs, K as getShellPathFromLoginShell } from "./io-DOE5w-Qp.js";
import { U as splitShellArgs, d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-FCWb26AL.js";
import { t as killProcessTree } from "./kill-tree-DEFoQPh6.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-V4touQJP.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CrK_yjQ1.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-DkcdCKOJ.js";
import { o as failedTextResult, v as textResult } from "./common-Cf8ajZVR.js";
import { t as callGatewayTool } from "./gateway-B5-K2LSS.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand, v as buildCommandPayloadCandidates, x as describeInterpreterInlineEval } from "./exec-approvals-allowlist-B85X9M5M.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-B_iJ9MSP.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, _ as normalizeExecSecurity, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-C7NVNNq7.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-pMMQtt3I.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-C9LI97z6.js";
import "./delivery-context-BYjS16G1.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-D3lhOWCr.js";
import { t as sendMessage } from "./message-NDJELmiv.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-4nBPTXGL.js";
import { t as formatDurationCompact } from "./format-duration-jspQ-NYy.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-B2iYSPfU.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-eyBqQHTC.js";
import { t as getProcessSupervisor } from "./supervisor-Dmx-6q9a.js";
import { C as markExited, S as markBackgrounded, T as tail, _ as drainSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listFinishedSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as deleteSession, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getFinishedSession, w as setJobTtlMs, x as listRunningSessions, y as getSession } from "./bash-tools.exec-runtime-rrEu9wdQ.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-BVt1Tsai.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-6t26TiNp.js";
import { n as detectPolicyInlineEval } from "./policy-00kntq9a.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-Cru3uylP.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-9Wu4xvbF.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-BbUZPETH.js";
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-DsqBWuSl.js"));
