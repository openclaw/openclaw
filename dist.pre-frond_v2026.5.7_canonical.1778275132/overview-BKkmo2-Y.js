...
import { S as resolveDefaultAgentId, g as listAgentEntries, n as resolveAgentEffectiveModelPrimary } from "./agent-scope-CcybJBoN.js";
import { u as readConfigFileSnapshot } from "./io-DOE5w-Qp.js";
import "./config-C_YnpthU.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-BJczXEHb.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-BOLY0kNx.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
