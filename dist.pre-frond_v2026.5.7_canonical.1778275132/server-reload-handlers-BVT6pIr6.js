...
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-Dmp4nHnj.js";
import { n as isRestartEnabled } from "./commands.flags-Bh9yVyji.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-DQo-SHN2.js";
import { o as getActiveEmbeddedRunCount } from "./run-state--wxwrRI-.js";
import { o as resetModelCatalogCache } from "./model-catalog-CsooIxjE.js";
import { l as getTotalQueueSize } from "./command-queue-DVzZJKOt.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-QgVAKG0f.js";
import "./pi-bundle-mcp-tools-B6jRLn4y.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-ThtMUD6B.js";
import { r as resetDirectoryCache } from "./target-resolver-MxjnoAM0.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-DkGDACcC.js";
...
import { _ as resolveHooksConfig } from "./hooks-CPwx5In6.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-CoSlwLr_.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Cj9kZ9v6.js";
...
import { t as buildGatewayCronService } from "./server-cron-B_TsAQ66.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CqD5tA8F.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-D3jOrTkD.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-mjD_KKb6.js"), import("./gmail-watcher-lifecycle-CF1hzN_k.js")]);
