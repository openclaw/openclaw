...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-CpMIvPXz.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-SfHM6jAB.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-DjQfMLHS.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DQI2KUQE.js";
import "./delivery-context-BYjS16G1.js";
import { n as resolveContinuationRuntimeConfig } from "./config-BS9Es6Hf.js";
import { i as consumePendingDelegates } from "./delegate-store-CbYkqJ8u.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BNh1hyGd.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-Ht_82_eC.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-Bo7GuHdX.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-BBhQ1amY.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-DWHWPN32.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-tGfAWLS-.js"), import("./store-load-Coxs4K6n.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-BstqfUt-.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-BY8fLkY5.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-BwhvRyM4.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
