...
import { a as createActionGate, f as readNumberParam, g as readStringParam, n as ToolAuthorizationError } from "./common-Cf8ajZVR.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-DA-YZSMa.js";
import { n as describeAccountSnapshot } from "./account-helpers-C00UoYHr.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-DN53V7Wh.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-DYAvmXJF.js";
import "./channel-core-CUMQ1-YM.js";
import "./routing-DX0cHvtC.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-5FBdjNP7.js";
...
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-CyIoAg7W.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-BpxzCz5l.js";
import { t as extractToolSend } from "./tool-send-C4EWZ7qQ.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-CdNZAmnF.js";
...
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-B3IHdBCt.js";
...
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-C8KQ4eae.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-BwUAzMOY.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DPwuBgNJ.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-8RzQ_Zrr.js";
import { n as normalizeMatrixUserId } from "./allowlist-BwAIjoym.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-CcKtyb6b.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-Bs41Bi7j.js";
import { t as formatMatrixErrorMessage } from "./errors-CKyGfS9U.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-C0kFtwJB.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BRBm7xEQ.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-DUXvg90B.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-4zFg50OI.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-3Ltj3EeM.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-A2wqVFa6.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-ziLBsVhe.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-BziqhOIK.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DpTp1EhC.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DUGoyp9D.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Dc5H8grF.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-CPtitxO4.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-CPtitxO4.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-C46r0u_6.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
