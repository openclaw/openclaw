...
import { n as resolveMatrixConfigPath } from "./config-paths-wBEeKkmF.js";
import { t as updateMatrixAccountConfig } from "./config-update-Axz3CDgJ.js";
import { n as matrixSetupAdapter } from "./setup-core-A2wqVFa6.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Bm6dxJkV.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BptAX5lS.js";
import { t as withResolvedActionClient } from "./client-D7YSsGQc.js";
import { r as resolveMatrixAuthContext } from "./config-mU5IYErB.js";
import "./client-Chp-5ajp.js";
import "./runtime-api-C6whE1eI.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-BDyglWSB.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DuX_SfVg.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-DloJQ7ex.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-QdqmRMMs.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-X7gRZIu_.js");
