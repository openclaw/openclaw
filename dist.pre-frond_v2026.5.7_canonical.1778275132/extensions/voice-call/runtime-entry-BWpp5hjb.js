...
import { c as isBlockedHostnameOrIp } from "../../ssrf-Do8_-OpG.js";
...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "../../webhook-request-guards-Rxy-X5bK.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, h as parseRealtimeVoiceAgentConsultArgs, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "../../session-runtime-DQG5nQdB.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "../../realtime-voice-D4jIAbbP.js";
import { t as resolveConfiguredCapabilityProvider } from "../../provider-selection-runtime-CV7bHvLP.js";
import { n as getActiveMemorySearchManager } from "../../memory-host-search-dfe6Q1El.js";
import "../../speech-CXhdMyjK.js";
import { t as zod_exports } from "../../zod-Ct0CvXmO.js";
import "./api-CNUoTOgt.js";
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-CNJqH4nQ.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-TJl9js-V.js";
import { t as resolveVoiceResponseModel } from "./response-model-AiZ4dw1j.js";
import { t as isProviderStatusTerminal } from "./call-status-CGfGI2lt.js";
import { t as getHeader } from "./http-headers-JmYSMJtb.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-DT6zeViw.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-La1wDD9n.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-Cieavfsf.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-DkdQ_U1M.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-BAPebJaf.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-DC5Nf0Lw.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-B_QblVqK.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-DVWbVwd4.js");
