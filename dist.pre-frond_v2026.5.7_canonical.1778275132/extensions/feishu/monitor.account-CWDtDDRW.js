...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "../../reply-payload-sdgmUR9u.js";
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "../../channel-streaming-BS8UoDB5.js";
...
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "../../history-Cg-sRk_e.js";
...
import { c as resolveOpenDmAllowlistAccess } from "../../dm-policy-shared-WPgrRbHo.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "../../webhook-request-guards-Rxy-X5bK.js";
...
import { n as resolveAgentOutboundIdentity } from "../../identity-BjOVayRK.js";
import "../../outbound-runtime-B-qjGd38.js";
import "../../ssrf-runtime-BGM8nkUl.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "../../binding-routing-BSsRjIJE.js";
import "../../conversation-runtime-C56BaCAE.js";
import "../../security-runtime-CbBYpvzI.js";
import "../../command-primitives-runtime-CmwDBru0.js";
import "../../channel-feedback-DLgsokgN.js";
import { n as createPersistentDedupe } from "../../persistent-dedupe-CA-zm--e.js";
import { t as buildFeishuConversationId } from "./conversation-id-Bl-CnCEi.js";
import { i as resolveReceiveIdType } from "./targets-JueTriVj.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-ONyNEOFs.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-C2-bs-HJ.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-CMlBac0X.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-9A7rizoe.js";
import { t as getFeishuRuntime } from "./runtime-D7-JUzy7.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-Deyv0G2j.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-35T3luxE.js";
import "./runtime-api-CBwSu0rd.js";
import { _ as shouldSuppressFeishuTextForVoiceMedia, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent, v as normalizeFeishuExternalKey } from "./send-D-P5bEWc.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-B9kFnMLF.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-BTQQazSy.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-8xL4PQjp.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-BqiWF2sL.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-BqiWF2sL.js");
