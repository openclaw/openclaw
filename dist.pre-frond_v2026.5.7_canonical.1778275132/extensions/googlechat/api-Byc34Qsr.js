...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "../../ssrf-policy-DsfOWjYU.js";
import "../../ssrf-runtime-BGM8nkUl.js";
import "./runtime-api-BDmbi6yd.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("../../src-azXRwZNp.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../src-B0O4nj1f.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
			return {
