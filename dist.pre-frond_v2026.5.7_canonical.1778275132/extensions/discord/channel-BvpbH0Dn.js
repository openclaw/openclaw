...
import { n as resolveTargetsWithOptionalToken } from "../../target-resolvers-BQycGz0G.js";
import { i as createPairingPrefixStripper } from "../../channel-pairing-BI_ZJIJ_.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "../../status-helpers-BpxzCz5l.js";
import "../../runtime-env-DVyvKnep.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "../../allowlist-config-edit-ofDyiZVk.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-ktiX3Btp.js";
import "./channel-api-BAiWZ5cN.js";
import { n as looksLikeDiscordTargetId, o as parseDiscordTarget, r as normalizeDiscordMessagingTarget } from "./normalize-CrJrhQdw.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-D51nNVk0.js";
import { t as getDiscordRuntime } from "./runtime-DjKU-Vy-.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-B7CT20QV.js";
import { t as getDiscordApprovalCapability } from "./approval-native-Cmno_H8f.js";
import { t as discordMessageActions$1 } from "./channel-actions-1PZsYIOr.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-CDqatCfS.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-DR9tBI4X.js";
import { n as discordOutbound } from "./outbound-adapter-nXT4b6Wi.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BQQNbH8S.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-OTkDuHUn.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-D_Tqj2zw.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Cci50-wv.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DkGGBM2Y.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-C1WbS5Q-.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-C1Zo_Kbj.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-BXlFsUY5.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-Dro0QPCW.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-B5G8_HIu.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-B6QVh8RP.js");
