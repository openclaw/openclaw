...
import { i as extractFirstTextBlock } from "./chat-message-content-Dz_Aqqnx.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-Bms03WaC.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-Cw7tjS_m.js"),
			import("./client-BchpYdSQ.js"),
			import("./client-start-readiness-LZb_nlWc.js"),
			import("./method-scopes-38dM2r6g.js"),
			import("./client-info-BPPv2Tu2.js")
		]);
