...
import { s as loadAuthProfileStoreForRuntime } from "./store-DjSzcW5t.js";
import { n as resolvePluginProviders } from "./providers.runtime-CbKZhWPW.js";
import "./model-selection-shared-nVmByRp_.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-BZmehUvz.js";
import { n as clearAuthProfileCooldown } from "./usage-D8E6KMv6.js";
import "./workspace-Dxk4lm3a.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-CS_0RjcS.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-B5fsBtNf.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-BPqYzig1.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-BtorGsAr.js");
				await openUrl(url);
			},
