...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-C9ceu3jY.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-sHPykavY.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DYZ6BCer.js";
import { l as toRatio, n as decodeString } from "./Util-DSQk0LkJ.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-T5Y2xgmg.js";
import { t as APEv2Parser } from "./APEv2Parser-IrK-MsGh.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DnRbtWII.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser--eONsAyJ.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DznbNWHF.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DaS_IML-.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-HHh48wOC.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-PdwQhf6n.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DRLJSzaB.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-7r9Trp2E.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-C2t4U7dn.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Cy0RoNJe.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DMecQD0Z.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DqtA414L.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-Bm-BcdPT.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-eoDgwobH.js")).WaveParser;
	}
};
//#endregion
