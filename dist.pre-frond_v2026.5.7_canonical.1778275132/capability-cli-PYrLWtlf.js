...
import { S as resolveDefaultAgentId, b as resolveAgentDir } from "./agent-scope-CcybJBoN.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-Bll7_TJY.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CqeT9_Y1.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-CNyRnB85.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-DjSzcW5t.js";
...
import "./auth-profiles-BavBg7q6.js";
...
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-CJtvravN.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-EoHonb6Z.js";
import "./tts-BLaYzL7b.js";
import { a as getImageMetadata } from "./image-ops-Cfq3PTvh.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CnSoOOVQ.js";
import { l as saveMediaBuffer } from "./store-BVTmgrt6.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-BR-7KuGL.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-B7CkPSvl.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-D7oEGww0.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CLFEs2WB.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CrqEhDon.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-DQS0vzvM.js";
...
import { t as collectOption } from "./helpers-DDXw3mO0.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-BNaW-ECM.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-DyXzv9Ko.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-4IC03bls.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-BWZ9wNTE.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BAm5EiB7.js");
