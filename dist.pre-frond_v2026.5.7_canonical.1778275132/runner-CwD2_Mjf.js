...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-D-CKDsUn.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-CJtvravN.js";
...
import { n as MediaFetchError, r as fetchRemoteMedia } from "./fetch-CEEU7owc.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-TfZz8vJu.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-BR-7KuGL.js";
import { t as providerSupportsCapability } from "./provider-supports-C2Gc09Uk.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CL5cVp8D.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-C3m8ctIb.js";
import { t as buildRandomTempFilePath } from "./temp-download--qnsEVZo.js";
import "./temp-path-CUENfXMK.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-0l3kdJZO.js";
import "./shared-W-Rr8-V4.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-BcA2MuHI.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-DoLZMvpz.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-CO0Imb1f.js");
