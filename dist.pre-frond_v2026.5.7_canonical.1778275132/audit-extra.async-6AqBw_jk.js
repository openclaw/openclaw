...
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-DItgOv4A.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-B76neGim.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-DhLlCSBq.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-CfggSQDT.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-DncEtcmv.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-BE3o2TBV.js");
...
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-BzcmPKDx.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-Bx87yU-J.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-CGL_2JvV.js");
