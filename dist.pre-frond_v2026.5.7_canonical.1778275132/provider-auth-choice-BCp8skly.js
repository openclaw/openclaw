...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-B71MAzcF.js";
...
import { n as openUrl } from "./browser-open-DVB6DKbd.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-jTOFerJa.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BQ5wA3JW.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-BPqYzig1.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-CCvw1ozH.js";
import { t as isRemoteEnvironment } from "./remote-env-CmR9Yh66.js";
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-CSuZ7Lpy.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-D2wzfPmZ.js");
