...
import { d as createIcaclsResetCommand, f as formatIcaclsResetCommand } from "./audit-fs-Bt27VLU0.js";
...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-BmHfnNha.js";
import { t as formatHelpExamples } from "./help-format-GSSilIei.js";
import { t as runSecurityAudit } from "./audit-83l00DQ8.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-Rr443IQP.js");
