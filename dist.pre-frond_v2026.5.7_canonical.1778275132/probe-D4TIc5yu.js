...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-BPng1urH.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-2YNRzzm9.js";
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-Ifv5IktW.js";
import { i as READ_SCOPE } from "./operator-scopes-CqeT9_Y1.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-CvuAP1-r.js");
