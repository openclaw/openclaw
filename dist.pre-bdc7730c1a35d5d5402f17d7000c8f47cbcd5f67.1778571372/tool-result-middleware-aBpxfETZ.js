...
import { n as createLazyPromiseLoader } from "./lazy-promise-B6on3yPt.js";
import { y as truncateUtf16Safe } from "./utils-CRkrr5e6.js";
import { r as normalizeProviderId } from "./provider-id-BvxMxU5i.js";
import { a as resolvePluginControlPlaneFingerprint } from "./plugin-metadata-snapshot-Dz4Co62w.js";
import { t as createSubsystemLogger } from "./subsystem-BjA1KmGE.js";
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-Cc6LcVZi.js";
import "./model-selection-C3RHt1lm.js";
import { u as isGoogleModelApi } from "./pi-embedded-helpers-D7tL7XS5.js";
import { t as log$1 } from "./logger-D8-CB2o2.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-Cgj-cjho.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-CL0Bvxnd.js");
