...
import { n as listAgentIds } from "./agent-scope-config-fFkwW_47.js";
import "./agent-scope-CBctHYDw.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-Bd9_VI2J.js";
import { C as setVerbose } from "./logger-DoY1MBoY.js";
import "./globals-CQst_TEw.js";
import { a as routeLogsToStderr } from "./console-D3q9sw1e.js";
...
import { u as normalizeMessageChannel } from "./message-channel-TU1A55ap.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-nHLngmZH.js";
import { i as callGateway, l as isGatewayTransportError, u as randomIdempotencyKey } from "./call-WDuoqUff.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-BnEJNs4t.js";
import { c as resolveSessionKeyForRequest, o as buildExplicitSessionIdSessionKey } from "./model-fallback-IwdHwsBo.js";
import { r as withProgress } from "./progress-C-BqssOb.js";
import { n as agentCommand } from "./agent-command-DLO5yJ-W.js";
import { n as runCommandWithRuntime } from "./cli-utils-DSE6y8Sz.js";
import { t as formatHelpExamples } from "./help-format-BMRz9Zqb.js";
import { t as collectOption } from "./helpers-C231dnG5.js";
import { t as createDefaultDeps } from "./deps-ChrWBkhW.js";
import "./agent-B3km1hyh.js";
import { t as agentsAddCommand } from "./agents.commands.add-UTh1QLmQ.js";
import { a as agentsBindingsCommand, i as agentsBindCommand, n as agentsSetIdentityCommand, o as agentsUnbindCommand, r as agentsDeleteCommand, t as agentsListCommand } from "./agents-YLbuz0mI.js";
...
function parseTimeoutSeconds(opts) {
	...
	if (Number.isNaN(raw) || raw < 0) throw new Error(`Invalid --timeout. Use seconds as a non-negative integer, for example --timeout 600. Use --timeout 0 to disable the timeout.`);
	return raw;
}
...
async function agentViaGatewayCommand(opts, runtime) {
	...
	if (!body) throw new Error(`Missing message. Use ${formatCliCommand("openclaw agent --message \"...\" --agent <id>")} or pass --to/--session-id for an existing conversation.`);
	if (!opts.to && !opts.sessionId && !opts.agent) throw new Error(`No target session selected. Use --agent <id>, --session-id <id>, or --to <E.164>. Run ${formatCliCommand("openclaw agents list")} to see agents.`);
