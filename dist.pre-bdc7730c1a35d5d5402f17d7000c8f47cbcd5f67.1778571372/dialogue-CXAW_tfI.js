import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-tAfDM6Jn.js";
import { r as loadCrestodianOverview } from "./overview-DZaiV9pc.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-AJPflK1u.js")).planCrestodianCommand)({
		input,
		overview
	});
