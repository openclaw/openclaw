...
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-CzNExHro.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-CJLwyR03.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BlvStC0Q2.js";
...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CTPwDfcO.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-Cl3fy0EE.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-eVOg7xdS.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CRYYrWNA.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-tqh3lXOw.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CDpLJ1PE.js";
...
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-DyVC1ZY_.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CmhVNRTr.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DVnABmk9.js";
import { n as resolveLogFile } from "./log-tail-BjGjqktw.js";
import { t as parseLogLine } from "./parse-log-line-2VoubMGe.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-Bknt_bRm.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-D4JOhrGF.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-CnVjW1LA.js";
import { t as channelsListCommand } from "./list-Dvrv2sSJ.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-0_RnGX5x.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-IqUQ56Hk.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-ctrIXMx6.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-D3ip__hB.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-bBlFUvtT.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-B2k4ziMf.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-BSwvj2Nr.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-Drudzgw3.js");
