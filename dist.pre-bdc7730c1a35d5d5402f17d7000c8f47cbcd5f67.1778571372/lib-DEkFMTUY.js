...
import { t as require_src } from "./src-D21RTqaP.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-BlPzwkEJ.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-B8QqgUbi.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-B6FozQpa.js";
import { l as toRatio, n as decodeString } from "./Util-CmAH-jum.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-WZ2BV17o.js";
import { t as APEv2Parser } from "./APEv2Parser-BtgJSdK6.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BZf5LWh-.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BmwYMsOu.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-s79Jq8lN.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DN7XjJ8T.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-AY3vDxs3.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-GJkHLKT1.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-B8LY_FHV.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CU5AMCHb.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Cpwwh-3j.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-LLDQ1gR0.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DWdoXCrO.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BUOUkk2H.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-B2K0qKB8.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CZYEBXMF.js")).WaveParser;
	}
};
//#endregion
