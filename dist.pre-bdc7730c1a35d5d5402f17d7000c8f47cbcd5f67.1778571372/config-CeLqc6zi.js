...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-Ywk0jV1E.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BHuXJsV4.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DUYWHgrj.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-DYzA1BfD.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BNT8-I6O.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CtwH9LE6.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DOz1z-K1.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CZjF3mdV.js"), import("./logging-DKSNfYWe.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-Rz9ciT3H.js").then((credentialsReadModule) => ({
