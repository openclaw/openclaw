...
import { a as ModelCompatConfig } from "./types.models-DMZzPEHb.js";
import { r as ContinueWorkRequest } from "./types-AGfJm1vM.js";
import { r as AnyAgentTool } from "./common-CgYoda5e.js";
import { i as RequestCompactionToolOpts, m as ExecToolDefaults } from "./params-Bpv9dosH.js";
import { o as SourceReplyDeliveryMode } from "./get-reply-options.types-DJuvZnYu.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-BZiEt-uc.js";
import { s as AuthProfileStore } from "./types-DCVMn130.js";
import { xi as ToolOutcomeObserver } from "./types-D1CySu2x.js";
import { t as ModelAuthMode } from "./model-auth-BQ2_yLO1.js";
import { r as SandboxContext } from "./types-CgBhSIIg.js";
import { t as ProcessToolDefaults } from "./bash-tools.process-Bbn_Y4p3.js";
import { TSchema } from "typebox";
import { ToolDefinition } from "@earendil-works/pi-coding-agent";
import { AgentMessage, AgentToolResult, AgentToolUpdateCallback } from "@earendil-works/pi-agent-core";
...
//#endregion
//#region src/agents/pi-tools.d.ts
...
declare function createOpenClawCodingTools(options?: {
  ...
  allowGatewaySubagentBinding?: boolean; /** Whether this run consumes the continue_delegate staging queue. */
  ...
  sourceReplyDeliveryMode?: SourceReplyDeliveryMode; /** If true, omit the message tool from the tool list. */
  ...
  includeToolSearchControls?: boolean; /** Executes cataloged tools through the active PI run lifecycle. */
  toolSearchCatalogExecutor?: ToolSearchCatalogToolExecutor; /** Runtime-local Tool Search catalog ref shared with PI attempt compaction. */
  ...
  toolConstructionPlan?: OpenClawCodingToolConstructionPlan; /** Whether the sender is an owner (required for owner-only tools). */
   ...
   */
  ownerOnlyToolAllowlist?: string[]; /** Auth profiles already loaded for this run; used for prompt-time tool availability. */
  authProfileStore?: AuthProfileStore; /** Callback invoked when sessions_yield tool is called. */
  onYield?: (message: string) => Promise<void> | void; /** Continuation: request_compaction tool opts (injected from execution context). */
