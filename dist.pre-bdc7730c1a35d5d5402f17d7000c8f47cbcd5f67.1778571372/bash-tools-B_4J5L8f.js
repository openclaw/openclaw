...
import { Y as resolveShellEnvFallbackTimeoutMs, q as getShellPathFromLoginShell } from "./io-C7AkIz5l.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-BhizQcMs.js";
import { E as splitShellArgs, T as normalizeExecutableToken, c as isShellWrapperExecutable, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-Ct7pRemf.js";
import { t as killProcessTree } from "./kill-tree-CLGWl1PM.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-TU1A55ap.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-nHLngmZH.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DYW5KkT2.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-DzmEOeas.js";
import { t as formatDurationCompact } from "./format-duration-CImOQ7n-.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-ytwnEta0.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-DWoFcLCd.js";
import { o as failedTextResult, y as textResult } from "./common-D4lHrpIB.js";
import { t as callGatewayTool } from "./gateway-BWPwJLRs.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-YAG-z_RI.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-DCiZcl83.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-tosKUmTT.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-B8Zl3J2N.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-CPYsTCfQ.js";
import "./delivery-context-C8sZgR2o.js";
import { t as sendMessage } from "./message-By6usjd6.js";
...
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-8yejxle9.js";
import { t as getProcessSupervisor } from "./supervisor-Cxs9XtHI.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-DsLn_4Dy.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-GKytQSK_.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-D8XpPF-h.js";
import { n as detectPolicyInlineEval } from "./policy-7XYnwpvD.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-DTY1CDha.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-BOb_9j4R.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-lKSdmGn0.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-CtzlQ24D.js";
