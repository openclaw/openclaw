...
vi.mock("mullusi/plugin-sdk/provider-web-search", () => ({
...
vi.mock("mullusi/plugin-sdk/security-runtime", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: mullusi", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "mullusi" });
  });

  it("runTavilyExtract sends X-Client-Source: mullusi", async () => {
