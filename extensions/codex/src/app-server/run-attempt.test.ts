...
describe("runCodexAppServerAttempt", () => {
  ...
  it("rejects a cold host resume when project instructions belong to a sandbox environment", async () => {
    ...
    setCodexTestToolFactory(sandboxParams, codingTools);
    ...
    setCodexTestToolFactory(warmSandboxParams, codingTools);
    ...
    setCodexTestToolFactory(hostParams, codingTools);
  ...
  it("keeps an empty sandbox instruction selection resumable on the host", async () => {
    ...
    setCodexTestToolFactory(coldSandboxParams, codingTools);
  ...
  it("replays a captured host instruction snapshot on a cold sandbox resume", async () => {
    ...
    const firstParams = createParams(sessionFile, workspaceDir);
    setCodexTestToolFactory(firstParams, codingTools);
