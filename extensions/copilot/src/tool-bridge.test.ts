...
describe("createCopilotToolBridge", () => {
  ...
  it.each([
    ...
    {
      name: "an explicit invocation override enables Code Mode",
      configured: false,
      override: true,
    ...
    {
      name: "an auto invocation override engages a preferred model",
      configured: false,
      override: "auto",
      codeModeTier: "preferred",
      engaged: true,
    ...
    {
      name: "an explicit invocation override disables Code Mode",
      configured: true,
      override: false,
      codeModeTier: "preferred",
      engaged: false,
    ...
    async ({ configured, override, codeModeTier, engaged }) => {
      ...
      if (engaged) {
        expect(() => result.promptToolPolicy.apply()).toThrow(
          "upgrade OpenClaw or disable Code Mode",
        );
      } else {
