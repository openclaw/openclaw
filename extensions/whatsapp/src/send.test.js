...
vi.mock("./media.js", () => ({
  loadWebMedia: (...args) => loadWebMediaMock(...args)
}));
...
describe("web outbound", () => {
  ...
  it("sends message via active listener", async () => {
    ...
    expect(sendMessage).toHaveBeenCalledWith("+1555", "hi", void 0, void 0);
  });
  it("trims leading whitespace before sending text and captions", async () => {
    await sendMessageWhatsApp("+1555", "\n 	hello", { verbose: false });
    expect(sendMessage).toHaveBeenLastCalledWith("+1555", "hello", void 0, void 0);
