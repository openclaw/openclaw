...
describe("isBotMentionedFromTargets", () => {
  ...
  function expectMentioned(msg, cfg, expected) {
...
describe("web auto-reply util", () => {
  ...
  describe("elide", () => {
    it("returns undefined for undefined input", () => {
      expect(elide(void 0)).toBe(void 0);
    });
  ...
  describe("isLikelyWhatsAppCryptoError", () => {
    ...
    const cases = [
      ...
      { name: "handles symbol reason without throwing", value: /* @__PURE__ */ Symbol("bad mac"), expected: false },
      {
