...
describe("processMessage group system prompt wiring", () => {
  ...
  it("fires message_received hooks with canonical WhatsApp correlation fields", async () => {
    ...
    buildContextMock.mockImplementationOnce(() => ({
      ...
      MediaPath: "/tmp/openclaw/inbound/photo.jpg",
      MediaUrl: "whatsapp://media/msg1",
      MediaType: "image/jpeg",
      MediaPaths: ["/tmp/openclaw/inbound/photo.jpg", "/tmp/openclaw/inbound/audio.ogg"],
      MediaUrls: ["whatsapp://media/msg1", "whatsapp://media/msg1-audio"],
