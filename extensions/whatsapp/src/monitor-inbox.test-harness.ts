...
export type InboxOnMessage = NonNullable<
	Parameters<MonitorWebInbox>[0]["onMessage"]
>;
...
export async function waitForMessageCalls(
...
export function expectPairingPromptSent(
	sock: MockSock,
	jid: string,
	senderE164: string,
) {
