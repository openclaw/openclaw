...
// Replay dead-letter bound on TOTAL delivery attempts (reconnect replays plus
// retryable pipeline failures both bump `attempts`), so a poison event stops
// re-delivering after at most this many attempts (#97538).
