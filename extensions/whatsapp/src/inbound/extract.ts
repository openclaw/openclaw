...
function extractMessage(
	...
	return candidate && typeof candidate === "object"
		? (candidate as proto.IMessage)
		: normalized;
}

function getFutureProofInnerMessage(
	...
	if (
		...
		const inner = normalizeMessage(
			(candidate as { message: proto.IMessage }).message,
		);
		if (inner) {
