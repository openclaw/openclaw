...
export const LIMITS = {
  /** Max bytes for text messages */
  TEXT_MAX_BYTES: 2048,
  /** Token refresh buffer time (refresh ahead) */
...
/** Valid template card card_type values */
...
/** Template card cache entry TTL (ms): 24 hours */
export const TEMPLATE_CARD_CACHE_TTL_MS = 24 * 60 * 60 * 1000;

/** Template card cache max entry count */
