 ...
 * answers with `interrupted` (cleared audio) and `turnComplete` (response done). An empty
 * turn makes the model resume its task a few seconds later; this bracketed instruction keeps
 * it silent and idle instead (measured live at thinking level high).
 */
