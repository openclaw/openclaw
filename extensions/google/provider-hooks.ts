...
// Google-family gRPC status codes mapped to failover reasons. Shared across the
// google/google-vertex/google-antigravity ids that register these hooks; core's
// code classifier stays provider-agnostic.
