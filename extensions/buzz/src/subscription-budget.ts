...
// Every transient query takes one of these slots through the shared lease, so
// this reserve and that allowance must stay the same number.
const BUZZ_RELAY_MAX_CONCURRENT_QUERY_SUBSCRIPTIONS = BUZZ_MAX_CONCURRENT_RELAY_QUERIES;
