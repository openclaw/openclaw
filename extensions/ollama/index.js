      ...
      auth: [
        {
          ...
          runNonInteractive: async (ctx) => configureOllamaNonInteractive({
        ...
        run: async (ctx) => {
          ...
          if (hasExplicitModels && explicit) {
            return {
              provider: {
                ...explicit,
                baseUrl: typeof explicit.baseUrl === "string" && explicit.baseUrl.trim() ? explicit.baseUrl.trim().replace(/\/+$/, "") : OLLAMA_DEFAULT_BASE_URL,
...
var ollama_default = ollamaPlugin;
export {
  ollama_default as default
};
