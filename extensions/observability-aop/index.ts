...
export default definePluginEntry({
	...
	register(api) {
		...
		const aopUrl = (pluginConfig?.aopServerUrl as string) || process.env.AOP_SERVER_URL || "http://100.69.32.10:3010";
		const nodeName = (pluginConfig?.nodeName as string) || process.env.WORKER_NODE_NAME || "unknown";
