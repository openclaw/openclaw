    ...
    api.registerProvider({
      ...
      auth: [
        createProviderApiKeyAuthMethod({
          ...
          hint: "Global 端点 - api.minimax.io",
          optionKey: "minimaxApiKey",
          flagName: "--minimax-api-key",
          envVar: "MINIMAX_API_KEY",
          promptMessage:
            "输入 MiniMax API Key（sk-api- 或 sk-cp-）\nhttps://platform.minimax.io/user-center/basic-information/interface-key",
          ...
          wizard: {
            ...
            choiceHint: "Global 端点 - api.minimax.io",
            groupId: "minimax",
            groupLabel: "MiniMax",
        ...
        createProviderApiKeyAuthMethod({
          ...
          hint: "CN 端点 - api.minimaxi.com",
          optionKey: "minimaxApiKey",
          flagName: "--minimax-api-key",
          envVar: "MINIMAX_API_KEY",
          promptMessage:
            "输入 MiniMax CN API Key（sk-api- 或 sk-cp-）\nhttps://platform.minimaxi.com/user-center/basic-information/interface-key",
          ...
          wizard: {
            ...
            choiceHint: "CN 端点 - api.minimaxi.com",
            groupId: "minimax",
            groupLabel: "MiniMax",
            groupHint: "M2.5 (recommended)",
          },
