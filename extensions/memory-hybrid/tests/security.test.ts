...
import { mergeFacts, mergeFactsBatch } from "../src/core/consolidate.js";
import { generateReflection } from "../src/core/reflection.js";
...
describe("Security: Prompt Injection Protection", () => {
  ...
  test("dream.ts should escape facts in empathy profile prompt", async () => {
    ...
    const mockEmbeddings = {
      embed: vi.fn().mockResolvedValue(Array.from({ length: 3072 }).fill(0)),
    } as any;
