...
import type { SmartCaptureFact } from "../core/capture.js";
import type { MemoryDB } from "../core/database.js";
import type { Embeddings } from "../core/embeddings.js";
import { extractGraphFromBatch } from "../core/graph.js";
import type { GraphDB } from "../core/graph.js";
import { hybridScore, getGraphEnrichment } from "../core/recall.js";
import type { MemoryCategory } from "../infra/config.js";
import type { HookDeps } from "../infra/hooks.js";
import { TaskPriority } from "../infra/limiter.js";
import { MemoryTracer, type Logger } from "../infra/tracer.js";
...
export async function handleRecall(
  ...
  if (nPrompt.startsWith("/") || /^(hi|hello|hey|привіт|вітаю)/i.test(nPrompt)) {
    return;
  }
