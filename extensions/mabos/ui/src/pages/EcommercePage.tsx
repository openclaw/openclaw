import { ShoppingCart, MessageSquare, ChevronRight, Users } from "lucide-react";
...
export function EcommercePage() {
  ...
  const relatedAgents = agentsResponse?.agents?.filter(
    (a) => a.id.includes("ecommerce") || a.id.includes("product") || a.id.includes("fulfillment"),
  );
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant="outline"
              className="border-[var(--accent-blue)]/30 text-[var(--accent-blue)] text-[10px]"
            >
              Coming Soon
            </Badge>
          </div>
          <p className="text-sm text-[var(--text-secondary)] mt-0.5">
            Product listings, orders, and storefront management
          </p>
        </div>
      </div>
        ...
        <Card className="border-[var(--border-mabos)] bg-[var(--bg-card)] shadow-none">
          ...
          <CardContent>
            <p className="text-sm text-[var(--text-primary)] leading-relaxed">
              Manage your online storefront, product catalog, and order fulfillment pipeline.
            </p>
            <p className="text-sm text-[var(--text-muted)] mt-3 leading-relaxed">
              ...
              <span className="text-[var(--accent-blue)] font-medium">E-Commerce Manager</span>{" "}
              agent through the chat panel for store-related queries and operations.
            </p>
          </CardContent>
        </Card>
            ...
            <ul className="space-y-3">
              {upcomingFeatures.map((feature) => (
                <li key={feature} className="flex items-center gap-3">
                  <ChevronRight className="w-4 h-4 text-[var(--accent-blue)] shrink-0" />
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)] mt-0.5">
                  Open the chat panel and ask the E-Commerce Manager agent about products, orders,
                  or storefront settings.
                </p>
              </div>
            </div>
          </CardContent>
