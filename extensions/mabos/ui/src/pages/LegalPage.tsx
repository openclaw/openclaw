import { Scale, MessageSquare, ChevronRight, Users } from "lucide-react";
...
export function LegalPage() {
  ...
  const relatedAgents = agentsResponse?.agents?.filter(
    (a) => a.id.includes("legal") || a.id.includes("shield"),
  );
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-[var(--text-secondary)] mt-0.5">
            Contracts, IP management, and legal document tracking
          </p>
        </div>
      </div>
        ...
        <Card className="border-[var(--border-mabos)] bg-[var(--bg-card)] shadow-none">
          ...
          <CardContent>
            <p className="text-sm text-[var(--text-primary)] leading-relaxed">
              Manage contracts, track intellectual property, and maintain a centralized legal
              document repository.
            </p>
            <p className="text-sm text-[var(--text-muted)] mt-3 leading-relaxed">
              ...
              agent through the chat panel for legal queries and operations.
            </p>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)] mt-0.5">
                  Open the chat panel and ask the Legal Counsel agent about contracts, IP matters,
                  or legal documents.
                </p>
              </div>
            </div>
