import { DollarSign, MessageSquare, ChevronRight } from "lucide-react";
      ...
      <Card className="border-[var(--border-mabos)] bg-[var(--bg-card)] shadow-none">
        ...
        <CardContent>
          <p className="text-sm text-[var(--text-primary)] leading-relaxed">
            Financial reporting, invoicing, expense tracking, and budget
            management.
          </p>
          <p className="text-sm text-[var(--text-muted)] mt-3 leading-relaxed">
            ...
            agent through the chat panel for financial queries and operations.
          </p>
        </CardContent>
      </Card>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-muted)] mt-0.5">
                Open the chat panel and ask the CFO (Ledger) agent about
                finances, invoices, or budgets.
              </p>
            </div>
          </div>
        </CardContent>
