...
const stats: BdiStat[] = [
  { label: "Beliefs", icon: Brain, color: "var(--accent-blue)", countKey: "beliefCount", fileTab: "Beliefs.md" },
  { label: "Desires", icon: Sparkles, color: "var(--accent-purple)", countKey: "desireCount", fileTab: "Desires.md" },
  { label: "Goals", icon: Target, color: "var(--accent-green)", countKey: "goalCount", fileTab: "Goals.md" },
  { label: "Intentions", icon: Zap, color: "var(--accent-orange)", countKey: "intentionCount", fileTab: "Intentions.md" },
];
