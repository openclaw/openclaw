# Capabilities — Sales Research Analyst
...
- `prospect_research` — Profile build, social analyze, purchase history, company deep dive
- `research_brief` — Generate, list, and retrieve structured research briefs
- `apollo_prospecting` — Apollo org enrichment for company deep dives
- `lead_scoring` — Access lead scores for prioritization
