...
const MANAGERS_BY_ACCOUNT_ID = new Map<
	string,
	MatrixThreadBindingManagerCacheEntry
>();
...
export function toMatrixBindingTargetKind(
	raw: BindingTargetKind,
): MatrixThreadBindingTargetKind {
...
export function toSessionBindingRecord(
	...
	const maxAgeMs =
		typeof record.maxAgeMs === "number" ? record.maxAgeMs : defaults.maxAgeMs;
	return {
...
export function listBindingsForAccount(
	accountId: string,
): MatrixThreadBindingRecord[] {
