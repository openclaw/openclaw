...
vi.mock("./active-client.js", () => ({
	getActiveMatrixClient: (...args: unknown[]) =>
		getActiveMatrixClientMock(...args),
}));

vi.mock("./client.js", () => ({
	acquireSharedMatrixClient: (...args: unknown[]) =>
		acquireSharedMatrixClientMock(...args),
...
describe("client bootstrap", () => {
	...
	it("releases leased shared clients when readiness setup fails", async () => {
		...
		vi.mocked(sharedClient.prepareForOneOff).mockRejectedValue(
