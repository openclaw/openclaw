...
| Emote messages           | `m.emote`                                                                                          | out/tools    | explicit `emote: true` send-action mode for text-only `/me`-style events | `src/matrix/send/types.ts`, `src/matrix/send.ts`, `src/actions.ts`                                                         |
