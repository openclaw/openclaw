...
vi.mock("mullusi/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("mullusi/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("mullusi/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("mullusi/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("mullusi/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("mullusi/plugin-sdk/webhook-ingress");
  return {
    ...actual,
