...
vi.mock("./client.js", () => ({
  ...
  resolveChatUserId: vi.fn().mockResolvedValue(void 0)
}));
...
function makeReq(method, body, opts = {}) {
...
function makeStalledReq(method) {
  return makeBaseReq(method);
}
function makeBaseReq(method, opts = {}) {
...
describe("createWebhookHandler", () => {
  ...
  it("returns 408 when request body times out", async () => {
    ...
    try {
      ...
      await vi.advanceTimersByTimeAsync(3e4);
      await run;
