...
export async function makeTempRepo(prefix: string) {
...
export function requireDefaultQaFlowSuiteImplementation() {
...
export function requireDefaultQaTestFileImplementation() {
...
export function blockNextQaFlowSuite() {
  ...
  return { started: started.promise, finished: finished.promise, release: blocked.resolve };
}

export function blockNextQaTestFileRun() {
