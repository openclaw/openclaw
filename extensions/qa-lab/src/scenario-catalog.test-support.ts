...
export const agentRuntime = "agent-runtime";
export const browserUi = "control-ui";
export const cli = "cli";
export const codex = "openai";
export const memory = "session-memory";
export const otel = "observability";
export const twoPartCoverageIdPattern = /^[a-z0-9][a-z0-9-]*\.[a-z0-9][a-z0-9-]*$/;
