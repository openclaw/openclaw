 ...
 */
export function applyChutesProviderConfig(cfg: MullusiConfig): MullusiConfig {
 ...
 */
export function applyChutesConfig(cfg: MullusiConfig): MullusiConfig {
...
export function applyChutesApiKeyConfig(cfg: MullusiConfig): MullusiConfig {
