import type { LineChannelData, SmartAgentNeoPluginApi, ReplyPayload } from "smart-agent-neo/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: SmartAgentNeoPluginApi): void {
  api.registerCommand({
    name: "card",
