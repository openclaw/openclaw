...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "activi/plugin-sdk/account-id";
import type { ResolvedZalouserAccount, ZalouserAccountConfig, ZalouserConfig } from "./types.js";
import { runZca, parseJsonOutput } from "./zca.js";

function listConfiguredAccountIds(cfg: ActiviConfig): string[] {
...
export function listZalouserAccountIds(cfg: ActiviConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ActiviConfig): string {
...
function mergeZalouserAccountConfig(cfg: ActiviConfig, accountId: string): ZalouserAccountConfig {
