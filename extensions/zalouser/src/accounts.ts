import type { EasyHubConfig } from "EasyHub/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "EasyHub/plugin-sdk";
import type { ResolvedZalouserAccount, ZalouserAccountConfig, ZalouserConfig } from "./types.js";
import { runZca, parseJsonOutput } from "./zca.js";

function listConfiguredAccountIds(cfg: EasyHubConfig): string[] {
...
export function listZalouserAccountIds(cfg: EasyHubConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: EasyHubConfig): string {
...
function mergeZalouserAccountConfig(cfg: EasyHubConfig, accountId: string): ZalouserAccountConfig {
