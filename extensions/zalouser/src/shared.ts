...
const zalouserConfigAdapter =
	createScopedChannelConfigAdapter<ResolvedZalouserAccount>({
		sectionKey: "zalouser",
...
export function createZalouserPluginBase(params: {
	setupWizard: NonNullable<
		ChannelPlugin<ResolvedZalouserAccount>["setupWizard"]
	>;
