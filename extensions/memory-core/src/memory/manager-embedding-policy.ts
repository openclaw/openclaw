...
// Zhipu's item cap says `input array max 64`, and its Chinese payload says
// `input数组最大不得超过64条`. Require the whole count and message boundary so
// per-item and token limits remain terminal.
