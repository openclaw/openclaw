...
const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for(
	"openclaw.memorySearchManagerCache",
);
...
const { qmdManagerCache: QMD_MANAGER_CACHE } =
	getMemorySearchManagerCacheStore();
let managerRuntimePromise: Promise<
	typeof import("./manager-runtime.js")
> | null = null;
