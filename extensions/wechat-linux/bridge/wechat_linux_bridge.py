...
def build_daemon_args(
    ...
    *,
    ...
    return argparse.Namespace(
        ...
        send_gui_countdown_seconds=getattr(daemon, "DEFAULT_SEND_GUI_COUNTDOWN_SECONDS", 1),
        send_gui_notify_timeout_ms=getattr(daemon, "DEFAULT_SEND_GUI_NOTIFY_TIMEOUT_MS", 4000),
        no_send_gui_prompts=False,
        post_send_delay_ms=1200,
        post_send_force_minimize=True,
        send_timeout=30,
