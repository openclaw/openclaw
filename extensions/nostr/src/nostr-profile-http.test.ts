...
import { getNostrProfileState, publishNostrProfile } from "./channel.js";
...
describe("nostr-profile-http", () => {
	...
	describe("route matching", () => {
		...
		it("handles /api/channels/nostr/:accountId/profile", async () => {
			const { run } = createProfileHttpHarness(
				"GET",
	...
	describe("POST /api/channels/nostr/:accountId/profile/import", () => {
		function expectImportSuccessResponse(
			res: ReturnType<typeof createMockResponse>,
		) {
			const data = expectOkResponse(res);
