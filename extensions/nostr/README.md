...
Nostr DM channel plugin for DNA using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to DNA. It enables your bot to:
...
# Configure dna to use local relay
