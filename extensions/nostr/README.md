...
Nostr DM channel plugin for SmartAgentNeo using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SmartAgentNeo. It enables your bot to:
...
# Configure smart-agent-neo to use local relay
