...
Nostr DM channel plugin for EasyHub using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to EasyHub. It enables your bot to:
...
# Configure EasyHub to use local relay
