...
const tempDirs = [];
let sharedMockCliScriptPath = null;
...
process.exit(2);
`;
async function createMockRuntimeFixture(params) {
...
async function ensureMockCliScriptPath() {
...
async function readMockRuntimeLogEntries(logPath) {
...
async function cleanupMockRuntimeFixtures() {
