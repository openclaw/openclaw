...
import { type SpawnCommandOptions, spawnAndCollect } from "./process.js";
...
const MCP_PROXY_PATH = path.resolve(
...
export async function resolveAcpxAgentCommand(params: {
	...
	return (
		overrides[normalizedAgent] ??
		ACPX_BUILTIN_AGENT_COMMANDS[normalizedAgent] ??
		null
	);
}
