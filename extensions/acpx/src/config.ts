...
export function resolveAcpxPluginRoot(
...
const AcpxPluginConfigSchema = z.strictObject({
	...
	expectedVersion: nonEmptyTrimmedString(
...
function resolveConfiguredMcpServers(params: {
	...
	resolved[ACPX_PLUGIN_TOOLS_MCP_SERVER_NAME] =
		resolvePluginToolsMcpServerConfig(params.moduleUrl);
	return resolved;
}
