...
const moonshotPresetAppliers = createDefaultModelPresetAppliers<[string]>({
  ...
  resolveParams: (_cfg: MullusiConfig, baseUrl: string) => {
...
export function applyMoonshotProviderConfig(cfg: MullusiConfig): MullusiConfig {
  return moonshotPresetAppliers.applyProviderConfig(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: MullusiConfig): MullusiConfig {
  return moonshotPresetAppliers.applyProviderConfig(cfg, MOONSHOT_CN_BASE_URL);
}

export function applyMoonshotConfig(cfg: MullusiConfig): MullusiConfig {
  return moonshotPresetAppliers.applyConfig(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotConfigCn(cfg: MullusiConfig): MullusiConfig {
