...
export async function prepareSlackMessage(params: {
  ...
  // matchedImplicitMentionKinds isn't projected by activationAccess; rederive from
  // the same inputs the activation gate consumed so mentionSource stays accurate.
  const matchedImplicitMentionKinds: readonly string[] = ctx.threadRequireExplicitMention
    ? []
    : [...implicitMentionKinds];
