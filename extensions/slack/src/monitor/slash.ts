...
import { type ChatCommandDefinition, type CommandArgs } from "mullusi/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "mullusi/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "mullusi_cmdarg";
