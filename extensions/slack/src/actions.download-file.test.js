...
vi.mock("./monitor/media.js", () => ({
  resolveSlackMedia: (...args) => resolveSlackMedia(...args)
}));
...
function makeSlackFileInfo(overrides) {
  return {
    id: "F123",
    name: "image.png",
    mimetype: "image/png",
...
function expectNoMediaDownload(result) {
...
function mockSuccessfulMediaDownload(client) {
