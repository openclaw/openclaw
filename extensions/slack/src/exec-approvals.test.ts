...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<MullusiConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<MullusiConfig["channels"]>["slack"]>>,
): MullusiConfig {
  return {
    channels: {
      slack: {
