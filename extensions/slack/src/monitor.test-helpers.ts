...
vi.mock("openclaw/plugin-sdk/reply-runtime", async (importOriginal) => {
	...
	const replyResolver: typeof actual.getReplyFromConfig = (...args) =>
		slackTestState.replyMock(...args) as ReturnType<
	...
	return {
		...
		dispatchInboundMessage: (
			params: Parameters<typeof actual.dispatchInboundMessage>[0],
		) =>
		...
		dispatchInboundMessageWithBufferedDispatcher: (
			params: Parameters<
				typeof actual.dispatchInboundMessageWithBufferedDispatcher
			>[0],
		) =>
