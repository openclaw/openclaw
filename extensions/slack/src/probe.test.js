...
describe("probeSlack", () => {
  beforeEach(() => {
    ...
    withTimeoutMock.mockImplementation(async (promise) => await promise);
  });
  ...
  it("keeps optional auth metadata fields undefined when Slack omits them", async () => {
    ...
    expect(result.bot).toStrictEqual({ id: void 0, name: void 0 });
    expect(result.team).toStrictEqual({ id: void 0, name: void 0 });
  });
});
