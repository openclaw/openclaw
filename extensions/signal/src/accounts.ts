...
function mergeSignalAccountConfig(cfg: MullusiConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MullusiConfig): ResolvedSignalAccount[] {
