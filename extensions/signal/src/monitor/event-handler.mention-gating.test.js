...
function makeGroupEvent(opts) {
  return createSignalReceiveEvent({
    dataMessage: {
      message: opts.message ?? "",
      attachments: opts.attachments ?? [],
      quote: opts.quoteText ? { text: opts.quoteText } : void 0,
      mentions: opts.mentions ?? void 0,
...
async function expectSkippedGroupHistory(opts, expectedBody) {
  capturedCtx = void 0;
