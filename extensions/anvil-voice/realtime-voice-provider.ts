...
class AnvilRealtimeVoiceBridge implements RealtimeVoiceBridge {
  ...
  private toAnvilInputPcm(audio: Buffer): Buffer {
    ...
    return this.audioFormat.sampleRateHz === ANVIL_REALTIME_SAMPLE_RATE_HZ
      ? pcm
      : resamplePcm(pcm, this.audioFormat.sampleRateHz, ANVIL_REALTIME_SAMPLE_RATE_HZ);
  }
  ...
  private fromAnvilOutputPcm(audio: Buffer): Buffer {
    ...
    return this.audioFormat.sampleRateHz === ANVIL_REALTIME_SAMPLE_RATE_HZ
      ? audio
      : resamplePcm(audio, ANVIL_REALTIME_SAMPLE_RATE_HZ, this.audioFormat.sampleRateHz);
  }
