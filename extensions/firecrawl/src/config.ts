...
export function resolveFirecrawlSearchConfig(
	cfg?: OpenClawConfig,
): FirecrawlSearchConfig {
	const pluginConfig = cfg?.plugins?.entries?.firecrawl
...
export function resolveFirecrawlFetchConfig(
	cfg?: OpenClawConfig,
...
export function resolveFirecrawlMaxAgeMs(
	cfg?: OpenClawConfig,
	override?: number,
): number {
	if (
...
export function resolveFirecrawlSearchTimeoutSeconds(
	override?: number,
): number {
	if (
		typeof override === "number" &&
