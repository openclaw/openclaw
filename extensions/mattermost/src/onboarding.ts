import type { ChannelOnboardingAdapter, EasyHubConfig, WizardPrompter } from "EasyHub/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.EasyHub.ai/channels/mattermost",
    ].join("\n"),
