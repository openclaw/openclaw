import type { ChannelOnboardingAdapter, ActiviConfig, WizardPrompter } from "activi/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.activi.ai/channels/mattermost",
    ].join("\n"),
