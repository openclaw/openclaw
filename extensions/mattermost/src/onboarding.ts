import type { ChannelOnboardingAdapter, SmartAgentNeoConfig, WizardPrompter } from "smart-agent-neo/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.smart-agent-neo.ai/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: SmartAgentNeoConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,
