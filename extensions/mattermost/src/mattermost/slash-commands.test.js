...
describe("slash-commands", () => {
  async function registerSingleStatusCommand(request) {
  ...
  it("resolves command text with trigger map fallback", () => {
    const triggerMap = /* @__PURE__ */ new Map([["oc_status", "status"]]);
    ...
    expect(resolveCommandText("oc_models", " openai ", void 0)).toBe("/models openai");
    expect(resolveCommandText("oc_help", "", void 0)).toBe("/help");
  });
