...
export function listMattermostAccountIds(cfg: ActiviConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ActiviConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ActiviConfig): ResolvedMattermostAccount[] {
