...
export function listMattermostAccountIds(cfg: SmartAgentNeoConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SmartAgentNeoConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SmartAgentNeoConfig): ResolvedMattermostAccount[] {
