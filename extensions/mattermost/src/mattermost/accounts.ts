import { createAccountListHelpers } from "mullusi/plugin-sdk/account-helpers";
...
export function listMattermostAccountIds(cfg: MullusiConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: MullusiConfig): string {
...
export function listEnabledMattermostAccounts(cfg: MullusiConfig): ResolvedMattermostAccount[] {
