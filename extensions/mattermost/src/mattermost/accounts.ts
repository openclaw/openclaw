...
export function listMattermostAccountIds(cfg: BotConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: BotConfig): string {
...
export function listEnabledMattermostAccounts(cfg: BotConfig): ResolvedMattermostAccount[] {
