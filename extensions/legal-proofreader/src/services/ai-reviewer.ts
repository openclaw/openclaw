...
function buildSystemPrompt(glossary: GlossaryEntry[], lawDomain?: string): string {
  ...
  return [
    ...
    "Allowed categories exactly: MISTRANSLATION, OMISSION, ADDITION, TERMINOLOGY, GRAMMAR, CROSS_REF, FORMATTING.",
    "Use exact excerpts when possible.",
    "correction must be minimal in-place replacement, not full rewrite.",
    "Do not merge unrelated issues into one item.",
