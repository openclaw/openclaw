...
type AnthropicDefaultsConfig = Parameters<typeof applyAnthropicConfigDefaults>[0]["config"];
type AnthropicDefaultsResult = ReturnType<typeof applyAnthropicConfigDefaults>;

function expectAnthropicPruningDefaults(cfg: AnthropicDefaultsResult, heartbeatEvery = "30m") {
...
function applyAnthropicDefaultsForTest(config: AnthropicDefaultsConfig) {
