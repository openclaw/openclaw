...
import { removeAckReactionAfterReply, shouldAckReaction } from "dna/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/dna") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
