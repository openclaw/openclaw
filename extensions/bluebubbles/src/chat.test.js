...
describe("chat", () => {
  ...
  describe("markBlueBubblesChatRead", () => {
    ...
    it("includes password in URL query", async () => {
      await expectCalledUrlIncludesPassword({
        password: "my-secret",
        invoke: () => markBlueBubblesChatRead("chat-123", {
          serverUrl: "http://localhost:1234",
          password: "my-secret"
        })
      });
    ...
    it("resolves credentials from config", async () => {
      await expectCalledUrlUsesConfigCredentials({
        ...
        invoke: (cfg) => markBlueBubblesChatRead("chat-123", {
          cfg
        })
      });
    });
  ...
  describe("setGroupIconBlueBubbles", () => {
    ...
    it("includes password in URL query", async () => {
      await expectCalledUrlIncludesPassword({
        password: "my-secret",
        invoke: () => setGroupIconBlueBubbles("chat-123", new Uint8Array([1, 2, 3]), "icon.png", {
          serverUrl: "http://localhost:1234",
          password: "my-secret"
        })
      });
    ...
    it("resolves credentials from config", async () => {
      await expectCalledUrlUsesConfigCredentials({
        serverHost: "config-server:9999",
        password: "config-pass",
        invoke: (cfg) => setGroupIconBlueBubbles("chat-123", new Uint8Array([1]), "icon.png", {
          cfg
        })
      });
    });
