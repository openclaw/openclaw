...
describe("reactions", () => {
  ...
  describe("sendBlueBubblesReaction", () => {
    async function expectRemovedReaction(emoji, expectedReaction = "-love") {
    ...
    describe("reaction type normalization", () => {
      const testCases = [
        ...
        { input: "\u2764", expected: "love" },
        { input: "\u2665\uFE0F", expected: "love" },
        { input: "\u{1F60D}", expected: "love" },
        { input: "\u{1F44D}", expected: "like" },
        { input: "\u{1F44E}", expected: "dislike" },
        { input: "\u{1F602}", expected: "laugh" },
        { input: "\u{1F923}", expected: "laugh" },
        { input: "\u{1F606}", expected: "laugh" },
    ...
    describe("reaction removal aliases", () => {
      it("handles emoji-based removal", async () => {
        await expectRemovedReaction("\u{1F44D}", "-like");
      });
