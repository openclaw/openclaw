...
export function listBlueBubblesAccountIds(cfg: EasyHubConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: EasyHubConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: EasyHubConfig): ResolvedBlueBubblesAccount[] {
