...
export function listBlueBubblesAccountIds(cfg: ActiviConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ActiviConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ActiviConfig): ResolvedBlueBubblesAccount[] {
