...
export function listBlueBubblesAccountIds(cfg: SmartAgentNeoConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: SmartAgentNeoConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: SmartAgentNeoConfig): ResolvedBlueBubblesAccount[] {
