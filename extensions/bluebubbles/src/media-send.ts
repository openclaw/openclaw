...
import { resolveChannelMediaMaxBytes, type ActiviConfig } from "activi/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: ActiviConfig; accountId?: string }): string[] {
