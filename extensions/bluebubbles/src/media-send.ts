...
import { resolveChannelMediaMaxBytes, type SmartAgentNeoConfig } from "smart-agent-neo/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: SmartAgentNeoConfig; accountId?: string }): string[] {
