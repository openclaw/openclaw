...
type BlueBubblesConversationBindingManager = {
	...
	getByConversationId: (
		conversationId: string,
	) => BlueBubblesConversationBindingRecord | undefined;
	listBySessionKey: (
		targetSessionKey: string,
	) => BlueBubblesConversationBindingRecord[];
...
type BlueBubblesConversationBindingsState = {
	...
	bindingsByAccountConversation: Map<
		string,
		BlueBubblesConversationBindingRecord
	>;
};
...
function toSessionBindingTargetKind(
	raw: BlueBubblesBindingTargetKind,
): BindingTargetKind {
	return raw === "subagent" ? "subagent" : "session";
}

function toBlueBubblesTargetKind(
	raw: BindingTargetKind,
): BlueBubblesBindingTargetKind {
...
export function createBlueBubblesConversationBindingManager(params: {
	...
	const sessionBindingAdapter: SessionBindingAdapter = {
		...
		bind: async (input) => {
			if (
				input.conversation.channel !== "bluebubbles" ||
