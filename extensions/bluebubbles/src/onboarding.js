...
async function promptBlueBubblesAllowFrom(params) {
  const accountId = params.accountId && normalizeAccountId(params.accountId) ? normalizeAccountId(params.accountId) ?? DEFAULT_ACCOUNT_ID : resolveDefaultBlueBubblesAccountId(params.cfg);
...
const blueBubblesOnboardingAdapter = {
  channel,
  getStatus: async ({ cfg }) => {
