...
This directory contains the **BlueBubbles external channel plugin** for EasyHub.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `EasyHub/plugin-sdk` helpers.
