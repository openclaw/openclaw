...
This directory contains the **BlueBubbles external channel plugin** for Activi.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `activi/plugin-sdk` helpers.
