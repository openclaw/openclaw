...
This directory contains the **BlueBubbles external channel plugin** for SmartAgentNeo.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `smart-agent-neo/plugin-sdk` helpers.
