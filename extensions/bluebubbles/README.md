...
This package contains the **BlueBubbles external channel plugin** for Mullusi.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `mullusi/plugin-sdk` helpers.
