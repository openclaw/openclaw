...
export function listGoogleChatAccountIds(cfg: SmartAgentNeoConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SmartAgentNeoConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SmartAgentNeoConfig): ResolvedGoogleChatAccount[] {
