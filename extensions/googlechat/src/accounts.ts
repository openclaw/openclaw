...
export function listGoogleChatAccountIds(cfg: EasyHubConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: EasyHubConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: EasyHubConfig): ResolvedGoogleChatAccount[] {
