...
export function listGoogleChatAccountIds(cfg: ActiviConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ActiviConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ActiviConfig): ResolvedGoogleChatAccount[] {
