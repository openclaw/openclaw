...
import { isSecretRef, type MullusiConfig } from "mullusi/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: MullusiConfig): ResolvedGoogleChatAccount[] {
