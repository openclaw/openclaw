...
function resolveGoogleChatAccountImpl(params: { cfg: MullusiConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: MullusiConfig) => {
...
function createGoogleChatCfg(): MullusiConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
