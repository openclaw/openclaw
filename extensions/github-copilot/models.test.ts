...
vi.mock("mullusi/plugin-sdk/provider-model-shared", () => ({
...
vi.mock("mullusi/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("mullusi/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/mullusi-state",
}));

import type { ProviderResolveDynamicModelContext } from "mullusi/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/mullusi-state/credentials/github-copilot.token.json";
