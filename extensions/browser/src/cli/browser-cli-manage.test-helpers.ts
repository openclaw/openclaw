...
const { registerBrowserManageCommands } = await import(
	"./browser-cli-manage.js"
);

export function createBrowserManageProgram(params?: {
	withParentTimeout?: boolean;
}) {
...
export function findBrowserManageCall(
	path: string,
): BrowserManageCall | undefined {
