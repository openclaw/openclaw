...
vi.mock("../../../src/agents/tools/nodes-utils.js", async () => {
	const actual = await vi.importActual<
		typeof import("../../../src/agents/tools/nodes-utils.js")
...
vi.mock("../../../src/agents/tools/common.js", async () => {
	const actual = await vi.importActual<
		typeof import("../../../src/agents/tools/common.js")
...
function resetBrowserToolMocks() {
	...
	browserToolTesting.setDepsForTest({
		...
		browserScreenshotAction:
			browserActionsMocks.browserScreenshotAction as never,
		...
		trackSessionBrowserTab:
			sessionTabRegistryMocks.trackSessionBrowserTab as never,
		untrackSessionBrowserTab:
			sessionTabRegistryMocks.untrackSessionBrowserTab as never,
	});
...
describe("browser tool url alias support", () => {
	...
	it("untracks explicit tab close for tracked sessions", async () => {
		...
		expect(
			sessionTabRegistryMocks.untrackSessionBrowserTab,
