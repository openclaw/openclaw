...
async function runAbortablePlaywrightAction<T>(opts: {
  cdpUrl: string;
  targetId?: string;
  signal?: AbortSignal;
  ...
  const actionPromise = opts.action();
  try {
    return await awaitActionWithAbort(actionPromise, abortPromise);
  } finally {
    cleanup();
  }
}
...
export async function clickViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    cdpUrl: opts.cdpUrl,
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser click",
    action: async () => {
...
export async function hoverViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser hover",
    action: async () => {
      const resolved = requireRefOrSelector(opts.ref, opts.selector);
      const page = await getRestoredPageForTarget(opts);
      const label = resolved.ref ?? resolved.selector!;
...
export async function dragViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser drag",
    action: async () => {
...
export async function selectOptionViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser select",
    action: async () => {
      const resolved = requireRefOrSelector(opts.ref, opts.selector);
...
export async function pressKeyViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser press",
    action: async () => {
...
export async function typeViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser type",
    action: async () => {
      const resolved = requireRefOrSelector(opts.ref, opts.selector);
...
export async function fillFormViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser fill",
    action: async () => {
      const page = await getRestoredPageForTarget(opts);
      const timeout = resolveInteractionTimeoutMs(opts.timeoutMs);
...
export async function scrollIntoViewViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser scroll",
    action: async () => {
      const resolved = requireRefOrSelector(opts.ref, opts.selector);
      const page = await getRestoredPageForTarget(opts);
...
export async function takeScreenshotViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser screenshot",
    action: async () => {
      const page = await getPageForTargetId(opts);
      ensurePageState(page);
      restoreRoleRefsForTarget({ cdpUrl: opts.cdpUrl, targetId: opts.targetId, page });
...
export async function screenshotWithLabelsViaPlaywright(opts: {
  ...
  return await runAbortablePlaywrightAction({
    ...
    targetId: opts.targetId,
    signal: opts.signal,
    disconnectReason: "abort browser labeled screenshot",
    action: async () => {
      const page = await getPageForTargetId(opts);
      ensurePageState(page);
      restoreRoleRefsForTarget({ cdpUrl: opts.cdpUrl, targetId: opts.targetId, page });
