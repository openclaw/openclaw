...
export const CDP_WS_HANDSHAKE_TIMEOUT_MS = 10_000;
export const CDP_JSON_NEW_TIMEOUT_MS = 5000;

export const CHROME_REACHABILITY_TIMEOUT_MS = 5000;
export const CHROME_WS_READY_TIMEOUT_MS = 5000;
export const CHROME_BOOTSTRAP_PREFS_TIMEOUT_MS = 10_000;
export const CHROME_BOOTSTRAP_EXIT_TIMEOUT_MS = 5000;
export const CHROME_LAUNCH_READY_WINDOW_MS = 30_000;
export const CHROME_LAUNCH_READY_POLL_MS = 250;
...
export const PROFILE_HTTP_REACHABILITY_TIMEOUT_MS = 5000;
export const PROFILE_WS_REACHABILITY_MIN_TIMEOUT_MS = 5000;
export const PROFILE_WS_REACHABILITY_MAX_TIMEOUT_MS = 10_000;
export const PROFILE_ATTACH_RETRY_TIMEOUT_MS = 5000;
export const PROFILE_POST_RESTART_WS_TIMEOUT_MS = 5000;
export const CHROME_MCP_ATTACH_READY_WINDOW_MS = 15_000;
