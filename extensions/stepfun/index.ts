...
function createStepFunApiKeyMethod(params: {
  ...
  return createProviderApiKeyAuthMethod({
    ...
    wizard: {
      ...
      groupId: "stepfun",
      groupLabel: "StepFun",
      groupHint: "Standard API / Step Plan (China / International)",
    },
  });
}
    ...
    api.registerProvider({
      ...
      auth: [
        ...
        createStepFunApiKeyMethod({
          ...
          region: "intl",
          promptMessage: "Enter StepFun API key for the international standard endpoint",
          defaultModel: STEPFUN_DEFAULT_MODEL_REF,
    ...
    api.registerProvider({
      ...
      auth: [
        ...
        createStepFunApiKeyMethod({
          ...
          region: "intl",
          promptMessage: "Enter StepFun API key for the international Step Plan endpoint",
          defaultModel: STEPFUN_PLAN_DEFAULT_MODEL_REF,
