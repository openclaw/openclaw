...
```bash
smart-agent-neo plugins install ./extensions/twitch
```

## Install (npm)

```bash
smart-agent-neo plugins install @smart-agent-neo/twitch
```
...
See https://docs.smart-agent-neo.ai/channels/twitch for:
