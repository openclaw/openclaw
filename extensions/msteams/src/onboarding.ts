...
function setMSTeamsDmPolicy(cfg: SmartAgentNeoConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: SmartAgentNeoConfig, allowFrom: string[]): SmartAgentNeoConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
