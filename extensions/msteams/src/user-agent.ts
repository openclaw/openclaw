...
function resolveMullusiVersion(): string {
  try {
 ...
 * and appends the Mullusi version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Mullusi/<mullusi-version>"
 * Example: "teams.ts[apps]/2.0.5 Mullusi/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Mullusi/${resolveMullusiVersion()}`;
  return cachedUserAgent;
}
