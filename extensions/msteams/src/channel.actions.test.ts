...
const reactionsMissingTargetError =
	"Reactions requires a target (to) and messageId.";
...
function okMSTeamsActionDetails(
	action: string,
	details?: Record<string, unknown>,
) {
