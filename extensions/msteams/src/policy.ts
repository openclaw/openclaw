...
export function resolveMSTeamsRouteConfig(params: {
	...
	const teamCandidates = buildChannelKeyCandidates(
		...
		params.allowNameMatching && teamName
			? normalizeChannelSlug(teamName)
			: undefined,
	);
	...
	const channelCandidates = buildChannelKeyCandidates(
		...
		params.allowNameMatching && channelName
			? normalizeChannelSlug(channelName)
			: undefined,
	);
...
export function resolveMSTeamsGroupToolPolicy(
	...
	const channelCandidates = buildChannelKeyCandidates(
		...
		allowNameMatching && groupChannel
			? normalizeChannelSlug(groupChannel)
			: undefined,
	);
