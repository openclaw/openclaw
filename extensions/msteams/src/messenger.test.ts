...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "mullusi/plugin-sdk/msteams";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { resolvePreferredMullusiTmpDir } from "../../../src/infra/tmp-mullusi-dir.js";
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredMullusiTmpDir(), "msteams-mention-"));
