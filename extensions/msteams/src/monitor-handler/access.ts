...
export type MSTeamsResolvedSenderAccess = Awaited<
	ReturnType<typeof resolveMSTeamsSenderAccess>
>;
...
export async function resolveMSTeamsSenderAccess(params: {
	...
	const configuredDmAllowFrom = (msteamsCfg?.allowFrom ?? []).map((entry) =>
		String(entry),
	);
	...
	const effectiveGroupAllowFrom =
		resolvedAllowFromLists.effectiveGroupAllowFrom;
