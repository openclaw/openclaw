...
async function sendTelegramOutbound(params) {
  const send = resolveOutboundSendDep(params.deps, "telegram") ?? getTelegramRuntime().channel.telegram.sendMessageTelegram;
  return await send(
    params.to,
    params.text,
...
const telegramPlugin = {
  ...
  outbound: {
    ...
    sendPayload: async ({
      ...
      const send = resolveOutboundSendDep(deps, "telegram") ?? getTelegramRuntime().channel.telegram.sendMessageTelegram;
