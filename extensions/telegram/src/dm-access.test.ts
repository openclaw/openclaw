import type { createChannelPairingChallengeIssuer } from "mullusi/plugin-sdk/channel-pairing";
...
vi.mock("mullusi/plugin-sdk/channel-pairing", () => ({
...
vi.mock("mullusi/plugin-sdk/conversation-runtime", () => ({
