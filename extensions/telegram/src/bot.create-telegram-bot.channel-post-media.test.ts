...
import {
	useFrozenTime,
	useRealTime,
} from "../../../test/helpers/plugins/frozen-time.js";
...
function getChannelPostHandler() {
	...
	return getOnHandler("channel_post") as (
...
function resolveFlushTimer(setTimeoutSpy: ReturnType<typeof vi.spyOn>) {
	const flushTimerCallIndex = setTimeoutSpy.mock.calls.findLastIndex(
		(call: Parameters<typeof setTimeout>) =>
			call[1] === TELEGRAM_TEST_TIMINGS.mediaGroupFlushMs,
	);
	const flushTimer =
...
function createImageFetchSpy(params?: {
	body?: Uint8Array;
	contentType?: string;
}) {
...
function createChannelPostContext(params: {
	...
	return {
		...
		getFile: async () =>
			...
			(photoFileId ? { file_path: `photos/${photoFileId}.jpg` } : {}),
	};
}
