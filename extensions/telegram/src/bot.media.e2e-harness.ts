...
type FetchRemoteMediaFn =
	typeof import("openclaw/plugin-sdk/media-runtime").fetchRemoteMedia;
...
async function defaultFetchRemoteMedia(
	...
	return {
		...
		fileName: params.filePathHint
			? path.basename(params.filePathHint)
			: undefined,
...
export const telegramBotRuntimeForTest: TelegramBotRuntimeForTest = {
	...
	apiThrottler: (() =>
		throttlerSpy()) as unknown as TelegramBotRuntimeForTest["apiThrottler"],
};
...
export const telegramBotDepsForTest: TelegramBotDeps = {
	...
	listSkillCommandsForAgents: vi.fn(
		() => [],
	) as TelegramBotDeps["listSkillCommandsForAgents"],
...
vi.mock("undici", async (importOriginal) => {
	...
	return {
		...actual,
		fetch: (...args: Parameters<typeof undiciFetchSpy>) =>
			undiciFetchSpy(...args),
	};
});
...
export async function mockMediaRuntimeModuleForTest(
	...
	Object.defineProperty(mockModule, "fetchRemoteMedia", {
		...
		enumerable: true,
		writable: true,
		value: (...args: Parameters<typeof fetchRemoteMediaSpy>) =>
	...
	Object.defineProperty(mockModule, "saveMediaBuffer", {
		...
		enumerable: true,
		writable: true,
		value: (...args: Parameters<typeof saveMediaBufferSpy>) =>
	...
	async (importOriginal) => {
		...
		return {
			...
			readChannelAllowFromStore:
				telegramBotDepsForTest.readChannelAllowFromStore,
			upsertChannelPairingRequest: vi.fn(async () => ({
				code: "PAIRCODE",
				created: true,
			})),
