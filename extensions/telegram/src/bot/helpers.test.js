...
describe("resolveTelegramForumThreadId", () => {
  it.each([
    ...
    { isForum: false, messageThreadId: void 0 },
    { isForum: void 0, messageThreadId: 99 }
  ])("returns undefined for non-forum groups", (params) => {
    expect(resolveTelegramForumThreadId(params)).toBeUndefined();
  });
  it.each([
    { isForum: true, messageThreadId: void 0, expected: 1 },
...
describe("buildTelegramThreadParams", () => {
  it.each([
    { input: { id: 1, scope: "forum" }, expected: void 0 },
    { input: { id: 99, scope: "forum" }, expected: { message_thread_id: 99 } },
    { input: { id: 1, scope: "dm" }, expected: { message_thread_id: 1 } },
    { input: { id: 2, scope: "dm" }, expected: { message_thread_id: 2 } },
    { input: { id: 0, scope: "dm" }, expected: void 0 },
    { input: { id: -1, scope: "dm" }, expected: void 0 },
    { input: { id: 1.9, scope: "dm" }, expected: { message_thread_id: 1 } },
    // id=0 should be included for forum and none scopes (not falsy)
    { input: { id: 0, scope: "forum" }, expected: { message_thread_id: 0 } },
    { input: { id: 0, scope: "none" }, expected: { message_thread_id: 0 } }
...
describe("resolveTelegramDirectPeerId", () => {
  ...
  it("falls back to chat id when sender id is missing", () => {
    expect(resolveTelegramDirectPeerId({ chatId: 777777777, senderId: void 0 })).toBe(
      "777777777"
    );
  });
});
...
describe("describeReplyTarget", () => {
  it("returns null when no reply_to_message", () => {
    const result = describeReplyTarget(
      // oxlint-disable-next-line typescript/no-explicit-any
      { message_id: 1, date: 1e3, chat: { id: 1, type: "private" } }
    );
