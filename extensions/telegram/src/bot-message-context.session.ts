...
export async function buildTelegramInboundContextPayload(params: {
  ...
  const ctxPayload = await sessionRuntime.buildChannelInboundEventContext({
    ...
    extra: {
      ...
      TelegramContinuationIntent: options?.continuationIntent?.kind,
      TelegramContinuationReason: options?.continuationIntent?.reason,
      TelegramContinuationAnchorId: options?.continuationIntent?.anchorMessageId,
      TelegramContinuationAnchorSenderId: options?.continuationIntent?.anchorSenderId,
      TelegramContinuationAnchorBody: options?.continuationIntent?.anchorBody,
      TelegramContinuationCurrentMessageId: options?.continuationIntent?.currentMessageId,
      ...locationContext,
      IsForum: isForum,
