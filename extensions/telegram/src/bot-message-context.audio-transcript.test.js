...
vi.mock("../../../src/media-understanding/audio-preflight.js", () => ({
  transcribeFirstAudio: (...args) => transcribeFirstAudioMock(...args)
}));
async function buildGroupVoiceContext(params) {
  const groupConfig = {
    requireMention: true,
    ...params.groupDisableAudioPreflight === void 0 ? {} : { disableAudioPreflight: params.groupDisableAudioPreflight }
  };
  const topicConfig = params.topicDisableAudioPreflight === void 0 ? void 0 : { disableAudioPreflight: params.topicDisableAudioPreflight };
...
function expectTranscriptRendered(ctx, transcript) {
...
function expectAudioPlaceholderRendered(ctx) {
  expect(ctx).not.toBeNull();
