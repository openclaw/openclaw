...
let clearRuntimeConfigSnapshot: typeof import("mullusi/plugin-sdk/config-runtime").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("mullusi/plugin-sdk/config-runtime").setRuntimeConfigSnapshot;
