...
import { isTruthyEnvValue, isWSL2Sync } from "mullusi/plugin-sdk/runtime-env";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "MULLUSI_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "MULLUSI_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "MULLUSI_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable MULLUSI_TELEGRAM_DNS_RESULT_ORDER
