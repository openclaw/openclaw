...
describe("buildTelegramRichMarkdownFromSpec", () => {
  ...
  it("respects heading_level and clamps to [1, 6]", () => {
    expect(htmlOf({ heading: "T", heading_level: 1 })).toContain("# T");
    expect(htmlOf({ heading: "T", heading_level: 6 })).toContain("###### T");
    expect(htmlOf({ heading: "T", heading_level: 9 })).toContain("###### T");
    expect(htmlOf({ heading: "T", heading_level: 0 })).toContain("# T");
  });
