...
export function listZaloAccountIds(cfg: BotConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: BotConfig): string {
...
function mergeZaloAccountConfig(cfg: BotConfig, accountId: string): ZaloAccountConfig {
