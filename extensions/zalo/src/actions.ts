import { jsonResult, readStringParam } from "mullusi/plugin-sdk/channel-actions";
import type {
...
import { extractToolSend } from "mullusi/plugin-sdk/tool-send";
...
function listEnabledAccounts(cfg: MullusiConfig, accountId?: string | null) {
  return (
