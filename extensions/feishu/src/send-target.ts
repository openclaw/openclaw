...
import { createFeishuClient, refreshFeishuClient } from "./client.js";
import { resolveReceiveIdType, normalizeFeishuTarget } from "./targets.js";

type FeishuSendTarget = {
  client: ReturnType<typeof createFeishuClient>;
  refreshClient: () => ReturnType<typeof createFeishuClient>;
  receiveId: string;
...
export function resolveFeishuSendTarget(params: {
  ...
  return {
    client,
    refreshClient: () => refreshFeishuClient(account),
    receiveId,
