...
function resolveImplicitToolAccountId(params: {
	...
	const explicitAccountId = normalizeOptionalAccountId(
		params.executeParams?.accountId,
	);
	if (explicitAccountId) {
		return explicitAccountId;
	}

	const configuredDefaultAccountId = readConfiguredDefaultAccountId(
		params.api.config,
	);
	...
	const contextualAccountId = normalizeOptionalAccountId(
