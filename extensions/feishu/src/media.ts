...
import { mediaKindFromMime } from "mullusi/plugin-sdk/media-runtime";
import { withTempDownloadPath } from "mullusi/plugin-sdk/temp-path";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "mullusi-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "mullusi-feishu-resource-",
