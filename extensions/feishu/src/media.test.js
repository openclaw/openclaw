...
function expectPathIsolatedToTmpRoot(pathValue, key) {
...
function expectMediaTimeoutClientConfigured() {
...
describe("sanitizeFileNameForUpload", () => {
  ...
  it("preserves emoji filenames", () => {
    expect(sanitizeFileNameForUpload("report_\u{1F600}.txt")).toBe("report_\u{1F600}.txt");
  });
  it("strips control characters", () => {
    expect(sanitizeFileNameForUpload("bad\0file.txt")).toBe("bad_file.txt");
