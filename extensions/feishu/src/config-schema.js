...
const FeishuToolsConfigSchema = z.object({
  ...
  // Document operations (default: true)
  chat: z.boolean().optional(),
  // Chat info + member query operations (default: true)
  wiki: z.boolean().optional(),
  // Knowledge base operations (default: true, requires doc)
  drive: z.boolean().optional(),
  // Cloud storage operations (default: true)
  perm: z.boolean().optional(),
  // Permission management (default: false, sensitive)
  scopes: z.boolean().optional()
  // App scopes diagnostic (default: true)
}).strict().optional();
