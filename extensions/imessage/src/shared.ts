...
import { type ChannelPlugin, getChatChannelMeta } from "../runtime-api.js";
import {
...
export const imessageConfigAdapter =
	createScopedChannelConfigAdapter<ResolvedIMessageAccount>({
		...
		resolveAllowFrom: (account: ResolvedIMessageAccount) =>
			account.config.allowFrom,
		formatAllowFrom: (allowFrom) => formatTrimmedAllowFromEntries(allowFrom),
		resolveDefaultTo: (account: ResolvedIMessageAccount) =>
...
export function createIMessagePluginBase(params: {
	setupWizard?: NonNullable<
		ChannelPlugin<ResolvedIMessageAccount>["setupWizard"]
	>;
