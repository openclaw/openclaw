...
function mergeIMessageAccountConfig(cfg: MullusiConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: MullusiConfig): ResolvedIMessageAccount[] {
