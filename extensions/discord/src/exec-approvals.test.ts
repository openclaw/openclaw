...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<MullusiConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<MullusiConfig["channels"]>["discord"]>>,
): MullusiConfig {
  return {
    channels: {
      discord: {
