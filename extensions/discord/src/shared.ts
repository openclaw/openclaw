...
export const discordConfigAdapter =
	createScopedChannelConfigAdapter<ResolvedDiscordAccount>({
		...
		resolveDefaultTo: (account: ResolvedDiscordAccount) =>
			account.config.defaultTo,
	});
