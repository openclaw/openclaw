...
export async function preflightDiscordMessage(
  ...
  // When an allowlist is configured, treat unconfigured channels as not matched.
  // Using `!== false` would allow any channel not in config (undefined !== false === true),
  // defeating the purpose of the allowlist. See: https://github.com/openclaw/openclaw/issues/54277
