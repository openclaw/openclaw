...
vi.mock("../send.js", () => ({
  sendMessageDiscord: (...args) => hoisted.sendMessageDiscord(...args),
  sendWebhookMessageDiscord: (...args) => hoisted.sendWebhookMessageDiscord(...args)
}));
const { maybeSendBindingMessage, resolveChannelIdForBinding } = await import("./thread-bindings.discord-api.js");
describe("resolveChannelIdForBinding", () => {
  ...
  it("forwards cfg when resolving channel id through Discord client", async () => {
    ...
    const createDiscordRestClientCalls = hoisted.createDiscordRestClient.mock.calls;
