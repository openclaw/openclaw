...
vi.mock("mullusi/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("mullusi/plugin-sdk/retry-runtime")>(
    "mullusi/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
