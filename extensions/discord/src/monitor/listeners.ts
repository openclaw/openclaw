...
type LoadedConfig = ReturnType<typeof import("mullusi/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("mullusi/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("mullusi/plugin-sdk/runtime-env").createSubsystemLogger>;
