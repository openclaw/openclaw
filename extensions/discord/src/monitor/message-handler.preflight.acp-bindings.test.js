...
vi.mock("../../../../src/acp/persistent-bindings.js", () => ({
  ensureConfiguredAcpBindingSession: (...args) => ensureConfiguredAcpBindingSessionMock(...args),
  resolveConfiguredAcpBindingRecord: (...args) => resolveConfiguredAcpBindingRecordMock(...args)
}));
...
function createBasePreflightParams(overrides) {
