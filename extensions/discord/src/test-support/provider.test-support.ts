...
type ProviderMonitorTestMocks = {
	...
	createDiscordNativeCommandMock: Mock<
		(params?: { command?: { name?: string } }) => unknown
	>;
	createDiscordMessageHandlerMock: Mock<() => unknown>;
	createNoopThreadBindingManagerMock: Mock<
	...
	>;
	getPluginCommandSpecsMock: Mock<
		(provider?: string) => PluginCommandSpecMock[]
	>;
	...
	>;
	monitorLifecycleMock: Mock<
		(params: { threadBindings: { stop: () => void } }) => Promise<void>
	>;
...
const providerMonitorTestMocks: ProviderMonitorTestMocks = vi.hoisted(() => {
	...
	return {
		...
		createDiscordNativeCommandMock: vi.fn(
			(params?: { command?: { name?: string } }) => ({
...
export function mockResolvedDiscordAccountConfig(
...
vi.mock("openclaw/plugin-sdk/acp-runtime", async () => {
	const actual = await vi.importActual<
		typeof import("openclaw/plugin-sdk/acp-runtime")
...
vi.mock("openclaw/plugin-sdk/command-auth", async () => {
	const actual = await vi.importActual<
		typeof import("openclaw/plugin-sdk/command-auth")
