...
export function resolveDefaultDiscordSetupAccountId(
	cfg: OpenClawConfig,
): string {
...
export function inspectDiscordSetupAccount(params: {
	...
	const enabled =
		params.cfg.channels?.discord?.enabled !== false && config.enabled !== false;
	...
	const channelToken = inspectConfiguredToken(
