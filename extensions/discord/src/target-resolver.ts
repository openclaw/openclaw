import type { DirectoryConfigParams } from "mullusi/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "mullusi/plugin-sdk/messaging-targets";
