...
async function sendDiscordComponentMessage(to, spec, opts = {}) {
  ...
  const finalFlags = opts.silent ? (flags ?? 0) | SUPPRESS_NOTIFICATIONS_FLAG : flags ?? void 0;
  const messageReference = opts.replyTo ? { message_id: opts.replyTo, fail_if_not_exists: false } : void 0;
