...
describe("sendMessageDiscord", () => {
  ...
  function setupForumSend(secondResponse) {
  ...
  it("chunks long forum posts into follow-up messages", async () => {
    ...
    expect(firstBody?.message?.content).toHaveLength(2e3);
  ...
  it("adds missing permission hints on 50013", async () => {
    ...
    getMock.mockResolvedValueOnce({ type: ChannelType.GuildText }).mockResolvedValueOnce({
      id: "789",
      guild_id: "guild1",
      type: 0,
