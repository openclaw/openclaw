// Local copy of the native Anthropic thinking-replay helpers
// (src/llm/providers/anthropic-thinking-replay.ts). Bundled extensions may only
// import from the public `openclaw/plugin-sdk/*` surface, and re-exporting these
// through that surface would grow the governed plugin-SDK export budget. Keeping
// a small, dependency-free copy here lets the Bedrock converter mirror the native
// signature-replay behavior without expanding the public SDK surface. Keep this in
// sync with the native source if its logic changes.
