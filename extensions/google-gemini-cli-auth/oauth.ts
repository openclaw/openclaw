...
import { isWSL2Sync } from "smart-agent-neo/plugin-sdk";

const CLIENT_ID_KEYS = ["SMART_AGENT_NEO_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
...
async function discoverProject(accessToken: string): Promise<string> {
  ...
  const headers = {
    ...
    "X-Goog-Api-Client": "gl-node/smart-agent-neo",
  };
