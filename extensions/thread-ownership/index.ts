import type { SmartAgentNeoConfig, SmartAgentNeoPluginApi } from "smart-agent-neo/plugin-sdk";
...
function resolveOwnershipAgent(config: SmartAgentNeoConfig): { id: string; name: string } {
