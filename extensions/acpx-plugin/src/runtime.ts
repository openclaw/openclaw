...
export const ACPX_BACKEND_ID = "acpx-plugin";

const ACPX_RUNTIME_HANDLE_PREFIX = "acpx-plugin:v1:";
...
function formatPermissionModeGuidance(): string {
  return "Configure plugins.entries.acpx-plugin.config.permissionMode to one of: approve-reads, approve-all, deny-all.";
}
