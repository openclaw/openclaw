...
type DiffPayloadFileInput =
  | (Omit<FileContents, "lang"> & { lang?: string })
  | (Omit<FileDiffMetadata, "lang"> & { lang?: string });
type DiffViewerPayloadInput = Omit<
  DiffViewerPayload,
  "langs" | "oldFile" | "newFile" | "fileDiff"
> & {
  langs: string[];
  oldFile?: Omit<FileContents, "lang"> & { lang?: string };
  newFile?: Omit<FileContents, "lang"> & { lang?: string };
  fileDiff?: Omit<FileDiffMetadata, "lang"> & { lang?: string };
};
...
async function normalizeDiffPayloadFileLanguage(
  file: DiffPayloadFileInput | undefined,
): Promise<DiffPayloadFile | undefined> {
  if (!file) {
    return undefined;
  }
  if (typeof file.lang !== "string") {
    return file as DiffPayloadFile;
  }
...
export async function normalizeDiffViewerPayloadLanguages(
  payload: DiffViewerPayloadInput,
