...
class AutoreviewCompatibilityTests(unittest.TestCase):
    def test_default_reviewer_uses_astra_high_with_access_retry(self) -> None:
    ...
    def test_codex_retries_terra_after_default_astra_access_failure(self) -> None:
