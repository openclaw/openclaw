...
import { A as readGeminiCliCredentialsCached, O as readClaudeCliCredentialsCached, k as readCodexCliCredentialsCached, s as loadAuthProfileStoreForRuntime } from "./store-CWaY5GDh.js";
import { n as mergePluginTextTransforms, t as applyPluginTextReplacements } from "./plugin-text-transforms-DBO7XEZ3.js";
import { r as resolvePluginSetupCliBackend } from "./setup-registry-CMELhaVM.js";
import { t as extractMcpServerMap } from "./bundle-mcp-DEIaRQbg.js";
...
import { J as resolveRuntimeTextTransforms } from "./provider-runtime-QoyUXw0b.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CYt_vl-H.js";
import { n as resolveRuntimeCliBackends } from "./model-selection-cli-Dl_STjo6.js";
import "./model-selection-CyWx9aXc.js";
import { r as externalCliDiscoveryForProviderAuth } from "./external-cli-discovery-DrBqpSp-.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-C7iRGBXq.js";
import { i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-YeDhZ3ip.js";
import { a as resolveBootstrapContextForRun, c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn } from "./bootstrap-files-DkuHtjZt.js";
import { g as resolveBootstrapTotalMaxChars, h as resolveBootstrapPromptTruncationWarningMode, m as resolveBootstrapMaxChars } from "./pi-embedded-helpers-BKDoLWiA.js";
import { n as loadMergedBundleMcpConfig, r as toCliBundleMcpServerConfig } from "./embedded-pi-mcp-CB0A2NzH.js";
import { s as resolveSkillsPromptForRun } from "./workspace-CwruSRrC.js";
import "./skills-f5Q_xbXL.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-DqKpIRtc.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-C7v3qUY_.js";
import { c as resolvePromptBuildHookResult, s as resolveAttemptPrependSystemContext } from "./attempt.prompt-helpers-BibRB-rN.js";
import { n as composeSystemPromptWithHookContext } from "./attempt.thread-helpers-Cgwj5qsv.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-DMbBu3m9.js";
import { n as loadCliSessionHistoryMessages, r as loadCliSessionReseedMessages, t as buildCliSessionHistoryPrompt } from "./session-history-BPGIj_Hw.js";
import { a as hashCliSessionText, o as resolveCliSessionReuse } from "./cli-session-BKjwxryx.js";
import { n as claudeCliSessionTranscriptHasContent } from "./attempt-execution.helpers-D8JQEttB.js";
import { r as cliBackendLog } from "./log-Elp5m68U.js";
import { i as normalizeCliModel, n as buildSystemPrompt, p as serializeTomlInlineValue } from "./helpers-BcF6SM2E.js";
import { a as getActiveMcpLoopbackRuntime, i as createMcpLoopbackServerConfig, n as ensureMcpLoopbackServer } from "./mcp-http-BqQ8p_KX.js";
...
const prepareDeps = {
	...
	resolveOpenClawReferencePaths: async (params) => (await import("./docs-path-DFOElAWj.js")).resolveOpenClawReferencePaths(params),
