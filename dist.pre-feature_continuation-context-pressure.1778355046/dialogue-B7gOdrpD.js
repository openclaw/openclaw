import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-C0PeB1MH.js";
import { r as loadCrestodianOverview } from "./overview-D3dnX4YX.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-BqUWI_D-.js")).planCrestodianCommand)({
		input,
		overview
	});
