...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-D-zZa6x_.js";
import { C as parseModelRef, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, x as modelKey } from "./model-selection-shared-BQtX8Bw-.js";
import "./model-selection-CyWx9aXc.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-8j_EsMZw.js";
import { t as resolveEnvApiKey } from "./model-auth-env-DgoygRso.js";
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-UR3WAxL9.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-4K4rXeIE.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-CuyMvlgj.js";
import { n as loadModelsConfigWithSource } from "./load-config-B96SvIur.js";
import { n as formatErrorWithStack } from "./list.errors-C07zHiJt.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-430xE5sk.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-GRFe4Jff.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-C3znXTl5.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-DTRQCLLT.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveOpenClawAgentDir }, { resolveAgentWorkspaceDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-CYj2OXAi.js"),
		import("./agent-paths-D2t9JwZx.js"),
		import("./agent-scope-DncEtcmv.js"),
		import("./workspace-B_4PcuOh.js")
	]);
