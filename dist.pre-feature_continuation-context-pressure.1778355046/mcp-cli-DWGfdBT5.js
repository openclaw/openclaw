...
import { i as extractFirstTextBlock } from "./chat-message-content-C5fqzN9a.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-DjxLM1Fc.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-AbTQLedo.js"),
			import("./client-B5bZ_f4b.js"),
			import("./client-start-readiness-D6RIVaUc.js"),
			import("./method-scopes-BaGAQ-Ed.js"),
			import("./client-info-Bgcz54LE.js")
		]);
