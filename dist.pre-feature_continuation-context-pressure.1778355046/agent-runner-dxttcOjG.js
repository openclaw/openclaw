...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-CcybJBoN.js";
...
import { i as isDiagnosticsEnabled, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-Cq5CLuNc.js";
...
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-qkYXfTa4.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-48nkjkQl.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-NWmMKpmM.js";
import { a as resolveSessionFilePath, o as resolveSessionFilePathOptions, s as resolveSessionTranscriptPath } from "./paths-Dai9rPIo.js";
import { t as loadSessionStore } from "./store-load-CREfM4qQ.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-BKq924Jk.js";
import { b as resolveGroupSessionKey, o as updateSessionStore, p as resolveSessionStoreEntry, s as updateSessionStoreEntry } from "./store-L0DKoc8m.js";
import "./sessions-vUaNmv0h.js";
import { a as resolveContextTokensForModel } from "./context-D6_cAfsF.js";
import { g as resolveResponseUsageMode, h as normalizeVerboseLevel } from "./thinking-rQh9CEhB.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-BQtX8Bw-.js";
import { t as isCliProvider } from "./model-selection-cli-Dl_STjo6.js";
import "./model-selection-CyWx9aXc.js";
import { u as resolveModelAuthMode } from "./model-auth-4K4rXeIE.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-BCeLYk7a.js";
import { l as queueEmbeddedPiMessage } from "./runs-C1DNunYV.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-BMuKKl47.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CKtX-15X.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-DgYEKR-Z.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-B5U7sA7f.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-DojpbNPa.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-bqqtJ1Ad.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-i9c9gawC.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-xcPRwgcM.js";
import { a as resolveCliRuntimeExecutionProvider, t as isCliRuntimeAlias } from "./model-runtime-aliases-DHvS2C_F.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-qGU895-2.js";
import { u as stripHeartbeatToken } from "./heartbeat-BlVYcyNe.js";
import { o as isAudioFileName } from "./mime-DXu61ldU.js";
import { d as isLikelyExecutionAckPrompt } from "./selection-6cKfH77r.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-YeDhZ3ip.js";
import "./pi-embedded-helpers-BKDoLWiA.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-W7cChj9r.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-BcFNu4Y8.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-CwAUbJxG.js";
import { r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-le6A8sl9.js";
import { d as parseReplyDirectives } from "./deliver-Bvip2m0C.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-4x-lSxGs.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-j3H3RQoz.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-UYE7uWu5.js";
import { i as estimateMessagesTokens } from "./compaction-BIUB4YDT.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-D9MPOF2I.js";
import { c as emitContinuationWorkSpan, i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-BBwQ5F_5.js";
...
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-CXooQL49.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-BdKzZalV.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-C2YcfjSu.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-Cj4GZW_2.js";
import { n as hasCotFramePrefix } from "./normalize-reply-Bk_cykA3.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DbRrHflG.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-aPhw5Jzs.js";
import "./sandbox-G5EnSfYs.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-CriluRHn.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-BTsZ4HxF.js";
import { r as enqueueCommitmentExtraction } from "./runtime-BKdEmPRS.js";
import { n as resolveSendPolicy } from "./send-policy-TD4k-cXD.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-XlKhp10v.js";
import { t as checkContextPressure } from "./context-pressure-DjcawhAS.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-dv9ktEcj.js";
import { t as formatProviderModelRef } from "./model-runtime-CQhrogkp.js";
import { t as runCliAgent } from "./cli-runner-30Q89d5L.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BKjwxryx.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-Dp8VRegn.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DhglzSdH.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-9StaC7Yf.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-s8tylZiq.js";
import { n as incrementCompactionCount } from "./session-updates-BpOIEf9N.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-BMUHYfpl.js";
import { n as dispatchPostCompactionDelegates, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-AugCNnvm.js";
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-4WSNokqB.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-CYZbV6Jk.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BBMr4X_y.js"),
					import("./config-CSFP_Q7O.js"),
					import("./state-BZ_8jpY9.js"),
					import("./store-BJ8Gi66D.js")
				]);
	...
	try {
						...
						if (effectiveContinuationSignal.kind === "delegate") {
							...
							const doSpawn = async (plannedHop, task, options) => {
								try {
									const spawnResult = await spawnSubagentDirect({
										...
										...options?.attachAs?.mountPath ? { attachMountPath: options.attachAs.mountPath } : {}
									}, {
									...
									enqueueSystemEvent(`[continuation] ${spawnResult.error ? `DELEGATE spawn ${spawnResult.status}: ${spawnResult.error}` : `DELEGATE spawn ${spawnResult.status}: delegation was not accepted. Use sessions_spawn manually`}. Original task: ${task}`, { sessionKey });
									return false;
								} catch (err) {
							...
							if (delegateDelayMs && delegateDelayMs > 0) {
								...
								addDelayedContinuationReservation(sessionKey, {
									...
									...effectiveContinuationSignal.attachments && effectiveContinuationSignal.attachments.length > 0 ? { attachments: effectiveContinuationSignal.attachments } : {},
									...effectiveContinuationSignal.attachAs ? { attachAs: effectiveContinuationSignal.attachAs } : {}
								});
								...
								const timerHandle = setTimeout(() => {
									...
									try {
										...
										doSpawn(reservation.plannedHop, reservation.task, {
											...
											...reservation.attachments && reservation.attachments.length > 0 ? { attachments: reservation.attachments } : {},
		...
		if (continuationFeatureEnabled && sessionKey) {
			...
			if (toolDelegates.length > 0) {
				const { maxChainLength, costCapTokens, maxDelegatesPerTurn } = resolveLiveContinuationRuntimeConfig(cfg);
				...
				for (const delegate of delegatesWithinLimit) {
					...
					const doToolSpawn = async (plannedHop, task, options) => {
						try {
							...
							enqueueSystemEvent(`[continuation] ${spawnResult.error ? `Tool DELEGATE spawn ${spawnResult.status}: ${spawnResult.error}` : `Tool DELEGATE spawn ${spawnResult.status}`}. Task: ${task}`, { sessionKey });
							return false;
						} catch (err) {
					...
					await doToolSpawn(nextChainCount, delegate.task, {
						...
						...delegate.attachments && delegate.attachments.length > 0 ? { attachments: delegate.attachments } : {},
