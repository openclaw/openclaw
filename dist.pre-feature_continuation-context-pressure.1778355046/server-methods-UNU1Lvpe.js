...
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-CcybJBoN.js";
...
import { a as logWarn, t as logDebug } from "./logger-M-PaInRe.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-Byqe0C1v.js";
import "./auth-ARvHEIK7.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-DVcRO0qP.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-C04VWQdx.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-EW2E3K3c.js";
...
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-CBvuoUZH.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-Dmp4nHnj.js";
import { t as buildChannelUiCatalog } from "./catalog-CSeJmulb.js";
...
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-CaBb2Ime.js";
...
import { g as patchPluginSessionExtension } from "./loader-BC-6x6qB.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BrJOI-jT.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-UV0hAIEZ.js";
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-BOPXy9l1.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Dhu5xFAu.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-NWmMKpmM.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-CvI9APAz.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BwaZ8j7y.js";
import { a as resolveSessionFilePath, i as resolveRotatedGeneratedSessionFilePath, o as resolveSessionFilePathOptions, u as resolveSessionTranscriptsDirForAgent } from "./paths-Dai9rPIo.js";
import { h as stringifyRouteThreadId } from "./channel-route-CrG2dtax.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-D2KgAVG4.js";
import { t as loadSessionStore } from "./store-load-CREfM4qQ.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-vjc31mTI.js";
...
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-vUaNmv0h.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-ChF-_mXW.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-DKLzlwy0.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-BfIH9_sG.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CYt_vl-H.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-rQh9CEhB.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-C_7lXXBC.js";
import "./auth-profiles-BwVGW7W3.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DrBqpSp-.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-BCeLYk7a.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-DThOD_G2.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-C1DNunYV.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BN3zmyDP.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-hG-lV5hG.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BvCMFBYN.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-BOZxmRTY.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-U-TmrtAm.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-CGSVjhta.js";
import { i as resolveSandboxConfigForAgent } from "./config-rPkCMIzb.js";
import { t as extractToolPayload } from "./tool-payload-CTfo3xLn.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-CdYFc4p-.js";
import { l as getTotalQueueSize } from "./command-queue-xcPRwgcM.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-BMOf2qBg.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-C_kutp55.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-jIBoVBkE.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-C-sLqX9f.js";
import "./tts-D96XxHUA.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-BY7PlQ5_.js";
import { a as isTimeoutError } from "./failover-error-CLUtypYD.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-Bvip2m0C.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-DfnE2iZn.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-mu0ezyK2.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-Ch63UKbi.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-CoCLzqF0.js";
import { i as parseAbsoluteTimeMs } from "./stagger-CWx_ch9F.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-CMO6X7B3.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-mMW0kT--.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-DS5EhyfC.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-DBQJH8eB.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-BqaSDvpq.js";
import { n as normalizePollInput } from "./polls-BT8uAfT3.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-C71-OZtl.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Cci13-DO.js";
import "./target-resolver-n2pLg9J7.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-VN45xTVs.js";
import { i as resolveReplyToMode } from "./reply-threading-C2YcfjSu.js";
...
import { n as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-uycrT5-Y.js";
import { r as resolveOutboundTarget } from "./targets-B4xYytEt.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-BaGIstgn.js";
import { n as resolveAgentIdentity } from "./identity-D0LXZhU5.js";
import { s as clearSessionQueues } from "./queue-aPhw5Jzs.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-BialUZlK.js";
import { t as resolveAgentTimeoutMs } from "./timeout-2RGlpelQ.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-CwruSRrC.js";
...
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-DK80CR9U.js";
import { n as resolveSendPolicy } from "./send-policy-TD4k-cXD.js";
import { t as canExecRequestNode } from "./exec-defaults-CcWq-y0T.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-Dr6G4yp_.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-Djmh-sPr.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-CJg703wl.js";
import { t as detectRespawnSupervisor } from "./supervisor-markers-BNaY07Fh.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-CVOBVCbX.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-9zAA7cfM.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CDGSCEoJ.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-BL6oiOEC.js";
import "./commands-registry-CIGlwS3T.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-B_tuGwlE.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-CvVPvr1-.js";
import { t as getChannelActivity } from "./channel-activity-EMJPRkrk.js";
...
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BHPpfy-c.js";
import { t as movePathToTrash } from "./browser-trash-CsYkd0p3.js";
import "./browser-maintenance-DEUPQrWk.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-CTlzLx96.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-Cl8gFYy2.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-UrB1-hMG.js";
import { r as agentCommandFromIngress } from "./agent-command-Di6N8kom.js";
...
import { t as formatForLog } from "./ws-log-D6XyZt46.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BigKkdm3.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-6YJn9VwN.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BO7PGLBC.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-DQuwt-bY.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-Cpd13xmW.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-uu8ar2X7.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CveX6wtR.js";
import { n as createOutboundSendDeps } from "./deps-BDB7nW3S.js";
import "./agent-FdMBdEIm.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DldfR8mq.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-BCdmA4Q3.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-heMrOykm.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-hJSculzZ.js";
import "./server-constants-CwbR_uOb.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-6ftLrqjk.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-Do8iQ6ec.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BGIPfwKx.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-Ch56PnvY.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-CTDsmNTb.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DfcKRyum.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-BgmyDHxc.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-DwfeV9rU.js";
import { s as performGatewaySessionReset } from "./session-reset-service-C7B0ZLH5.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-QQCWcHvW.js";
import { s as normalizeUpdateChannel } from "./update-channels-BhcOW4ZK.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-D4ZwerCg.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-DbgmDVMU.js";
import { t as readConfiguredLogTail } from "./log-tail-C2vi1xDM.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CXwiglHL.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Uwr3FfHc.js";
import { t as buildChannelAccountSnapshot } from "./status-CZQJUI_K.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-DN40Dk7T.js";
import { t as installSkill } from "./skills-install-9pc20KiG.js";
import { n as readPackageVersion } from "./package-json-Pgm1nAXN.js";
import { t as getStatusSummary } from "./status.summary-dtk7QEl5.js";
import "./status-DOPKfFOj.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-Cic1tHIC.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-DFanXAVl.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-DHjWc4ma.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-luqCRFTR.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BPvZjcAL.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-B4AespGT.js";
import { t as diffConfigPaths } from "./config-diff-DBBv922E.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CI5o5Ly6.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BnO5GsTN.js";
import "./heartbeat-runner-BnE02CCg.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-D-KMdDlo.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-D9ob_rNH.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-CbSInf73.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-B0paHnl2.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-uBVMgDGp.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-bQZw6l2o.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-B2Hb5kYU.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-CQ4MIK0Y.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-BM_HrAl3.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CpovVC5M.js");
