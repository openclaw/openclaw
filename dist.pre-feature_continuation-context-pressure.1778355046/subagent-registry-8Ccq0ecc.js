...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-NWmMKpmM.js";
import { d as resolveStorePath } from "./paths-Dai9rPIo.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-D2KgAVG4.js";
import { t as loadSessionStore } from "./store-load-CREfM4qQ.js";
import { o as updateSessionStore, p as resolveSessionStoreEntry } from "./store-L0DKoc8m.js";
import "./sessions-vUaNmv0h.js";
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-Cx-ZUc2j.js";
import { A as SUBAGENT_ENDED_REASON_KILLED, C as getSubagentSessionStartedAt, D as SUBAGENT_ENDED_OUTCOME_TIMEOUT, E as SUBAGENT_ENDED_OUTCOME_KILLED, M as subagentRuns, O as SUBAGENT_ENDED_REASON_COMPLETE, S as getSubagentSessionRuntimeMs, T as SUBAGENT_ENDED_OUTCOME_ERROR, a as countActiveDescendantRunsFromRuns, b as isStaleUnendedSubagentRun, c as countPendingDescendantRunsFromRuns, f as listDescendantRunsForRequesterFromRuns, j as SUBAGENT_TARGET_KIND_SUBAGENT, k as SUBAGENT_ENDED_REASON_ERROR, l as getSubagentRunByChildSessionKeyFromRuns, n as persistSubagentRunsToDisk, o as countActiveRunsForSessionFromRuns, p as listRunsForControllerFromRuns, r as restoreSubagentRunsFromDisk, t as getSubagentRunsSnapshotForRead, w as resolveSubagentSessionStatus } from "./subagent-registry-state-BHwqPyzC.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-A6thzHfd.js";
import { a as isSilentReplyText } from "./tokens-qGU895-2.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-Cno5pvXr.js";
import "./pi-bundle-mcp-tools-CcEFGmnF.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-Tn-DGc8s.js";
import { c as setDetachedTaskDeliveryStatusByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BaGIstgn.js";
import "./subagent-announce-queue-bj-xAoQQ.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-BuqheXaY.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-DW7DRqrs.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-DVjusvat.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DxRC699K.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-72cunHId.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DxRC699K.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-DYnZ0ea1.js").then(({ scheduleOrphanRecovery }) => {
