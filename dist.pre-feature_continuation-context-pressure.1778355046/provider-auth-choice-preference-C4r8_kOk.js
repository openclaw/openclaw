...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-DP5XPrHs.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-oBZCaSi-.js");
