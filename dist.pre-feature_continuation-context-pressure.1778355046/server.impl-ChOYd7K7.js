...
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-ARvHEIK7.js";
import { n as resolveGatewayAuth } from "./auth-resolve-DVcRO0qP.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-C04VWQdx.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-Dmp4nHnj.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-P9MbmQq3.js";
import { n as isRestartEnabled } from "./commands.flags-DX9TfTWP.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-R01ZJF3h.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-eP-eem3j.js";
import "./method-scopes-BwQHEM3m.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-ky-rASNw.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Pl9Q3gsX.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-BOPXy9l1.js";
import { i as resolveMainSessionKey } from "./main-session-CvI9APAz.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-B7fX5d0O.js";
import "./sessions-vUaNmv0h.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-BCeLYk7a.js";
import { g as stopDiagnosticHeartbeat, h as startDiagnosticHeartbeat } from "./diagnostic-BDPogzHH.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-CjjbSSVr.js";
import { l as getTotalQueueSize } from "./command-queue-xcPRwgcM.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-mu0ezyK2.js";
import { a as enqueueSystemEvent } from "./system-events-CoCLzqF0.js";
import { i as CANVAS_HOST_PATH } from "./file-resolver-DhlhEvHn.js";
import { t as handleA2uiHttpRequest } from "./a2ui-C89i526T.js";
import { r as resolveCronStorePath } from "./store-BMUHYfpl.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-D6XyZt46.js";
import { t as createDefaultDeps } from "./deps-BDB7nW3S.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-blKEuRbB.js";
import { n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-D8RKRVVx.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-CwbR_uOb.js";
import { t as GatewayLockError } from "./gateway-lock-CurSgTme.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CtskvByb.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-nu2vyvov.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-B4AespGT.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-MtAJw9SF.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-D9kBnZU4.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-vk5rIt3R.js";
import { i as normalizeCanvasScopedUrl } from "./canvas-capability-bQZw6l2o.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-ULfMIH9i.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Cb8SlXiq.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-BSfggOLL.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-DDIfX3AO.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-DSahfpHk.js";
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext, n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-D6vx9WBt.js";
import "./paths-BXvlViiP.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-CB3UpkHk.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DFjmUt3I.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CNPZ1PHu.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-BV_rPMQg.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-BJl3OIxc.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DOHceNcI.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-m9fJeEuj.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-C6F46zkO.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-pW26EKVb.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-9tLvAMeJ.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-yqON1d6g.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-Dn-scPHN.js");
	return voiceClawRealtimeUpgradeModulePromise;
}
function getCanvasAuthModule() {
	canvasAuthModulePromise ??= import("./http-auth-BkZB8n1J.js");
	return canvasAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-DELT940S.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DbR4ET_F.js");
...
async function createGatewayRuntimeState(params) {
	...
	try {
		...
		if (params.canvasHostEnabled) try {
			const { createCanvasHostHandler } = await import("./server-DanAZC6T.js");
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-BJA9iwlu.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-DczkB9ya.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-DVsDBtTY.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-DR8STwiX.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-BQNP_sZ5.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-B02EAe9X.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-CY2iJEI3.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-fROPQLog.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-DVsDBtTY.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-BVq_GtCZ.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-D-ithLt0.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-em_SoG16.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-ChoIxUlF.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-CFg6IPOR.js");
	...
	const controlUiSeed = minimalTestGateway ? {
		...
		writeConfig: async (nextConfig) => {
			const { replaceConfigFile } = await import("./mutate-CRnaXwIE.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-RlvdDvG4.js");
	...
	const { createChannelManager } = await import("./server-channels-Hshsa1-Q.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-USs5tXDa.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-D0hZkVuJ.js"), import("./server-runtime-services-BWKeL_ny.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-BzweA_MQ.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-CqnJTykr.js"),
				import("./server-plugin-bootstrap-CfrGTivw.js"),
				import("./services-D3_tlCly.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-YJ3GvSde.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-CfrGTivw.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-BU5wU8Xw.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-B68bzFep.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-ztUFHb9i.js");
