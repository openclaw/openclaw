...
import "./session-binding-runtime-D-4cOSKi.js";
import { a as resolveMatrixAccountConfig } from "./account-config-EJKtdC_v.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-CZXw2NpL.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-Ca1c1mew.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-BY2wK_ll.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-DHqByVyt.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-BtVT3C9Y.js");
