...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-C1DNunYV.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-DiiFb3P9.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-Dsy-lv2N.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-qGU895-2.js";
import "./delivery-context-fXqAQ9-N.js";
import { n as resolveContinuationRuntimeConfig } from "./config-D9MPOF2I.js";
import { i as consumePendingDelegates } from "./delegate-store-CXooQL49.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-NIpil9YH.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-Cm67ElxW.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-DW7DRqrs.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-BZ_8jpY9.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-8n2NBojq.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-CLYZhFk9.js"), import("./store-load-KwS3G4ky.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
					...
					const doChainSpawn = async (timerTriggered = false) => {
						try {
							...
							const spawnResult = await spawnSubagentDirect({
								...
								...chainSignal.attachments && chainSignal.attachments.length > 0 ? { attachments: chainSignal.attachments } : {},
								...chainSignal.attachAs?.mountPath ? { attachMountPath: chainSignal.attachAs.mountPath } : {},
					...
					const doToolChainSpawn = async (timerTriggered = false) => {
						try {
							...
							const spawnResult = await spawnSubagentDirect({
								...
								...toolDelegate.attachments && toolDelegate.attachments.length > 0 ? { attachments: toolDelegate.attachments } : {},
								...toolDelegate.attachAs?.mountPath ? { attachMountPath: toolDelegate.attachAs.mountPath } : {},
								drainsContinuationDelegateQueue: true
							}, {
								agentSessionKey: targetRequesterSessionKey,
								agentChannel: targetRequesterOrigin?.channel ?? void 0,
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-DCb2g-pa.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-DMBcozH_.js");
			const { createSubsystemLogger } = await import("./subsystem-CoI-rTLT.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-B5b9A8XZ.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
