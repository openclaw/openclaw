...
import { f as resolveRunModelFallbacksOverride, m as resolveSessionAgentIds } from "./agent-scope-CcybJBoN.js";
import { X as resolveOwnerDisplaySetting } from "./io-C04VWQdx.js";
...
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-DBO7XEZ3.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-C28f80Kh.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-vddWzh3p.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-QoyUXw0b.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CYt_vl-H.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as resolveModelAuthMode } from "./model-auth-4K4rXeIE.js";
...
import { a as resolveBootstrapContextForRun, c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-DkuHtjZt.js";
import { p as ensureSessionHeader, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BKDoLWiA.js";
import { g as resolveChannelReactionGuidance, m as resolveChannelMessageToolHints, p as listChannelSupportedActions } from "./pi-tools.before-tool-call-B3h4zwpd.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-BdWCqqIJ.js";
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-CLUtypYD.js";
import { t as buildModelAliasLines } from "./model-alias-lines-52RzUQNF.js";
import { s as supportsModelTools } from "./tool-result-middleware-CbzEiiiD.js";
import { t as log } from "./logger-WjiJP55B.js";
import { A as isRealConversationMessage, B as collectRuntimeChannelCapabilities, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getHistoryLimitFromSessionKey, F as resolveCompactionTimeoutMs, M as consumeCompactionSafeguardCancelReason, N as setCompactionSafeguardCancelReason, O as buildEmbeddedExtensionFactories, P as compactWithSafetyTimeout, R as guardSessionManager, T as buildEmbeddedMessageActionDiscoveryInput, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as prewarmSessionFile, d as toSessionToolAllowlist, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, i as dedupeDuplicateUserMessagesForCompaction, k as hasMeaningfulConversationContent, l as collectAllowedToolNames, m as createSystemPromptOverride, o as mapThinkingLevel, p as buildEmbeddedSystemPrompt, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectRegisteredToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as repairSessionFileIfNeeded } from "./compaction-successor-transcript-CwAUbJxG.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-J28azGGi.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DjVnPTAs.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BTGzm228.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-CHmu8vaV.js";
import "./pi-bundle-mcp-tools-CcEFGmnF.js";
import { r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-j3H3RQoz.js";
import { i as formatUnknownCompactionReasonDetail, o as resolveCompactionFailureReason, r as classifyCompactionReason, s as createCompactionDiagId } from "./request-compaction-tool-Kdbe_DRo.js";
import { g as createPreparedEmbeddedPiSettingsManager } from "./compaction-BIUB4YDT.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-8FX2Q-OG.js";
...
import { c as readTranscriptFileState, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-R4bI0z7j.js";
import { t as detectRuntimeShell } from "./shell-utils-BNg70wzY.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-s1pwKDOV.js";
...
import { t as applyExtraParamsToAgent } from "./extra-params-CpQU6haL.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-C_jFDKwk.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-52wdvS-T.js";
import { n as resolveEmbeddedCompactionTarget } from "./compaction-runtime-context-BEHm5SXP.js";
import { a as shouldUseOpenAIWebSocketTransport } from "./attempt.thread-helpers-Cgwj5qsv.js";
