...
import { l as createScopedDmSecurityResolver } from "../../channel-config-helpers-D37zitas.js";
...
import { d as createDefaultChannelRuntimeState, l as createAsyncComputedAccountStatusAdapter } from "../../status-helpers-ml9CygpH.js";
import "../../conversation-runtime-D-wrA9z8.js";
import { t as chunkTextForOutbound } from "../../text-chunking-BMoWAm7A.js";
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields, n as buildPassiveProbedChannelStatusSummary } from "../../extension-shared-BpiOscFr.js";
...
import { a as resolveZalouserReactionMessageIds, o as buildZalouserGroupCandidates, s as findZalouserGroupEntry, t as getZalouserRuntime } from "./runtime-C0vi0yQY.js";
import { n as zalouserSetupAdapter, r as writeQrDataUrlToTempFile, t as createZalouserSetupWizardProxy } from "./setup-core-BZoVpc8E.js";
import { i as resolveZalouserOutboundSessionRoute, n as parseZalouserDirectoryGroupId, r as parseZalouserOutboundTarget, t as normalizeZalouserTarget } from "./session-route-BcRUTGGn.js";
//#region extensions/zalouser/src/channel.adapters.ts
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(() => import("./channel.runtime-MgbUqGds.js"));
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-MgbUqGds.js"));
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(async () => (await import("./setup-surface-C6Vfhlrg.js")).zalouserSetupWizard);
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorZalouserProvider } = await import("./monitor-C2iVSnYU.js");
