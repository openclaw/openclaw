...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "../../ssrf-policy-DtOyW3pK.js";
import "../../ssrf-runtime-Cup62pw7.js";
import { t as getMSTeamsRuntime } from "./runtime-api-C_BcZtIW.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-DUcZr7g7.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("../../dist-Io4747Nr.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../dist-BoOU4Ngw.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("../../jsonwebtoken-BkFwK2SR.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../src-BSnpYADC.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
