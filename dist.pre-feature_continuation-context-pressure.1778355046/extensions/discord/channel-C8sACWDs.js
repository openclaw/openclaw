...
import { n as normalizeAtHashSlug } from "../../string-normalization-C5SGsaST.js";
...
import { n as resolveTargetsWithOptionalToken } from "../../target-resolvers-BT4ZDL75.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "../../allowlist-config-edit-BGMHIQHx.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-TlTpD4rD.js";
import "./channel-api-CIqHkSzv.js";
import { a as normalizeDiscordMessagingTarget, c as parseDiscordTarget, i as looksLikeDiscordTargetId, n as resolveDiscordTarget } from "./target-resolver-YAvCjRtK.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-VQvsiwoY.js";
import { t as getDiscordRuntime } from "./runtime-Ds4qyJ6n.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-nGaaeEVk.js";
import { t as getDiscordApprovalCapability } from "./approval-native-XSMCCjqv.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-DB4o7eQ4.js";
import { t as discordMessageActions$1 } from "./channel-actions-CuAtlxMp.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-BFAD-sjj.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BLeMi_C5.js";
import { n as discordOutbound } from "./outbound-adapter-CTQLD_gd.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BcOHQKg6.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-BuajStJG.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CO8L98JL.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-kseYlppd.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CH8Ob7bE.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DLkD8yVz.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-DSP5eEZ6.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-i8c69DEW.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-3xIXd68L.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-Bjvp8qDq.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-BxjTu3Vc.js");
