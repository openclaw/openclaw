import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-Dd_ihitu.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-BVzPOnLj.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-6gWH5imQ.js";
import { r as readModelListResult } from "./models-Cdh0l8fD.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-c25y378T.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
