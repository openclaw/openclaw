import { S as resolveIMessageAttachmentRoots, Xt as normalizeProviderId, b as isInboundPathAllowed, fn as requireApiKey, kn as resolveOpenClawAgentDir, n as loadConfig, pn as resolveApiKeyForProvider, rn as normalizeGoogleModelId, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-DunvA-uZ.js";
import { $ as logVerbose, mt as resolvePreferredOpenClawTmpDir, nt as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-B0uKDnzH.js";
import { D as runExec, G as resolveAgentModelPrimaryValue, W as resolveAgentModelFallbackValues } from "./agent-scope-DgbjWdYv.js";
import { t as normalizeChatType } from "./chat-type-DFDuk3FY.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CmZi0_-L.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-C5t1cRmC.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Bj06Hz72.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DbFvAaXE.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-yuQ0CZRJ.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-LLLKIUZ5.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CSkMq2Ck.js").then((n) => n.r);
