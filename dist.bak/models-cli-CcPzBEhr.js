...
import { Ct as resolveUsageProviderId, St as formatUsageWindowSummary, Xt as describeFailoverError, Zt as maskApiKey, a as DEFAULT_OAUTH_WARN_MS, bt as loadProviderUsageSummary, d as runEmbeddedPiAgent, o as buildAuthHealthSummary, s as formatRemainingShort } from "./reply-D8YvfZps.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-D8K2SjR7.js";
import { f as defaultRuntime } from "./subsystem-LTWJBEIv.js";
import "./openclaw-root-PhSD0wUu.js";
import "./exec-NrPPwdAe.js";
import { $ as resolveEnvApiKey, Er as listProfilesForProvider, Mr as ensureAuthProfileStore, Or as setAuthProfileOrder, Q as resolveAwsSdkEnvVarName, Rr as resolveAuthStorePathForDisplay, Ur as resolveAuthProfileDisplayLabel, Y as getCustomProviderApiKey, Z as resolveApiKeyForProvider, c as modelKey, d as normalizeProviderId, dn as parseDurationMs, f as parseModelRef, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, ht as resolveProfileUnusableUntilForDisplay, i as findNormalizedProviderValue, kr as upsertAuthProfile, ni as DEFAULT_PROVIDER, r as buildModelAliasIndex, ti as DEFAULT_MODEL, ut as resolveAuthProfileOrder, v as resolveModelRefFromString, vr as getShellEnvAppliedKeys, xr as shouldEnableShellEnvFallback, zr as resolveOpenClawAgentDir, zt as loadConfig } from "./model-selection-DILdVnl8.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-B_bX6Iw-.js";
...
import { r as resolveForwardCompatModel } from "./model-CHWfnOl2.js";
...
import { r as withProgressTotals } from "./progress-_rXhKU7V.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./model-selection-DILdVnl8.js").then((n) => n.Ft);
	const { ensureAuthProfileStore } = await import("./model-selection-DILdVnl8.js").then((n) => n.lt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CHWfnOl2.js").then((n) => n.t);
