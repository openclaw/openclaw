...
import { i as resolveAgentConfig } from "./agent-scope-D8K2SjR7.js";
import { f as defaultRuntime } from "./subsystem-LTWJBEIv.js";
import { s as sameFileIdentity } from "./openclaw-root-PhSD0wUu.js";
import "./exec-NrPPwdAe.js";
import { In as analyzeArgvCommand, zt as loadConfig } from "./model-selection-DILdVnl8.js";
...
import { r as VERSION } from "./env-vars-Duxu9t5m.js";
import "./manifest-registry-BvFf4Q1K.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-C0KMGsnJ.js";
...
import { i as resolveBrowserConfig } from "./server-context-Byjwv8su.js";
...
import { c as detectMime } from "./image-ops-CFCg0YOh.js";
import "./store-DLi2fq1F.js";
import "./ports-CAJdnzGD.js";
import "./trash-B8xEzWgw.js";
import "./logging-_TuF9Wz5.js";
import { $t as loadOrCreateDeviceIdentity, t as GatewayClient } from "./client-xAUDLDK2.js";
import "./pairing-token-BdLe8Jtz.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, d as resolveExecApprovals, l as recordAllowlistUse, m as requestJsonlSocket, n as addAllowlistEntry, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, u as requiresExecApproval } from "./exec-approvals-Coe3V-Ad.js";
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-B_EvDB3X.js";
import { n as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-BfwBfxiF.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext, t as withTimeout } from "./with-timeout-BiWG7xFm.js";
...
import { n as resolveSystemRunCommand } from "./system-run-command-DIVRynb_.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-B0c7j49x.js";
import "./runtime-guard-C-Xp_TV0.js";
import { a as buildNodeServiceEnvironment, i as emitNodeRuntimeWarning, p as resolveNodeProgramArguments, r as resolveGatewayDevMode, u as resolvePreferredNodePath } from "./daemon-install-helpers-BbXZcxdV.js";
...
import { s as resolveGatewayLogPaths } from "./service-gv1-6Hix.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DlnT_hDz.js";
import { s as formatRuntimeStatus } from "./systemd-hints-CXkyZncY.js";
import { t as parsePort } from "./parse-port-Can_EDst.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-CK6x0xdJ.js";
import { t as resolveNodeService } from "./node-service-C_-IqoHn.js";
...
function buildSystemRunApprovalPlanV2(params) {
...
async function handleInvoke(frame, client, skillBins) {
	...
	if (command === "system.run.prepare") {
		try {
			const prepared = buildSystemRunApprovalPlanV2(decodeParams(frame.paramsJSON));
			if (!prepared.ok) {
