...
import { zr as resolveOpenClawAgentDir, zt as loadConfig } from "./model-selection-DILdVnl8.js";
import { t as ensureOpenClawModelsJson } from "./models-config-PcUiD3st.js";

//#region src/agents/model-catalog.ts
const log = createSubsystemLogger("model-catalog");
let modelCatalogPromise = null;
let hasLoggedModelCatalogError = false;
const defaultImportPiSdk = () => import("./pi-model-discovery-CaAPcNJJ.js").then((n) => n.r);
