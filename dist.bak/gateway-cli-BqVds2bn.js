...
import { $r as DEFAULT_PROVIDER, A as createConfigIO, An as isPidAlive, Bn as normalizeModelSelection, F as resolveConfigSnapshotHash, Fn as getModelRefStatus, Gn as resolveConfiguredModelRef, Kn as resolveDefaultModelForAgent, L as writeConfigFile, Ln as isCliProvider, M as parseConfigJson5, N as readConfigFileSnapshot, O as migrateLegacyConfig, P as readConfigFileSnapshotForWrite, Qn as resolveThinkingDefault, Qr as DEFAULT_MODEL, R as validateConfigObjectWithPlugins, Un as resolveAllowedModelRef, Wr as normalizeSecretInput, Xn as resolveSubagentConfiguredModelSelection, Xt as applyMergePatch, Zr as DEFAULT_CONTEXT_TOKENS, Zt as applyLegacyMigrations, at as AVATAR_MAX_BYTES, cn as resolveAgentMaxConcurrent, ct as isAvatarImageDataUrl, ft as looksLikeAvatarPath, it as parseByteSize, j as loadConfig, jn as buildAllowedModelSet, ln as resolveSubagentMaxConcurrent, on as buildTalkConfigResponse, qn as resolveHooksGmailModel, rt as parseDurationMs, st as isAvatarHttpUrl, z as OpenClawSchema } from "./auth-profiles-D6H-HVV8.js";
...
import { $ as createReplyDispatcher, $t as resolveSessionAuthProfileOverride, A as createOutboundSendDeps, An as isSystemEventContextChanged, B as buildHistoryContextFromEntries, Bn as getAcpSessionManager, Bt as normalizeRequiredName, C as computeBackoff, Cr as markGatewayDraining, Ct as runWithModelFallback, Dr as CommandLane, Dt as formatRestartSentinelMessage, E as agentCommand, Er as waitForActiveTasks, Et as formatDoctorNonInteractiveHint, Fr as getAgentRunContext, Ft as inferLegacyName, Gn as DEFAULT_INPUT_TIMEOUT_MS, Hn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Ht as buildDeliveryFromLegacyPayload, Ir as onAgentEvent, It as normalizeOptionalAgentId, Jn as normalizeMimeList, Jt as detectSuspiciousPatterns, Kn as extractFileContentFromSource, Lr as registerAgentRunContext, Lt as normalizeOptionalSessionKey, M as createOutboundSendDeps$1, Mr as stripHeartbeatToken, Mt as normalizeHttpWebhookUrl, N as resolveAgentAvatar, Nn as requestHeartbeatNow, Nr as clearAgentRunContext, Nt as normalizeCronJobCreate, O as resolveAgentDeliveryPlan, Or as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Pr as emitAgentEvent, Pt as normalizeCronJobPatch, Q as dispatchInboundMessage, Qn as resolveSendPolicy, Qt as persistBrowserProxyFiles, Rt as normalizeOptionalText, S as requestBodyErrorToText, Sr as getTotalQueueSize, Tr as setCommandLaneConcurrency, Tt as consumeRestartSentinel, Un as DEFAULT_INPUT_IMAGE_MIMES, Ut as hasLegacyDeliveryHints, Vn as resolveAgentSessionDirs, Vt as migrateLegacyCronPayload, Wn as DEFAULT_INPUT_MAX_REDIRECTS, Wt as stripLegacyDeliveryFields, Xn as resolveAgentTimeoutMs, Xt as isExternalHookSession, Yn as resolveInputFileLimits, Yt as getHookType, Zn as normalizeSendPolicy, Zt as applyBrowserProxyPaths, _ as loadOpenClawPlugins, _n as normalizeGroupActivation, _r as textToSpeech, _t as resolveOutboundTarget, a as runSubagentAnnounceFlow, an as parseVerboseOverride, ar as resolveUserTimezone, at as resolveCronStyleNow, b as handleSlackHttpRequest, br as getActiveTaskCount, c as abortEmbeddedPiRun, cn as deferGatewayRestartUntilIdle, cr as isTtsEnabled, ct as runCliAgent, d as applyToolPolicyPipeline, dn as markGatewaySigusr1RestartHandled, dr as resolveTtsAutoMode, dt as resolveAnnounceTargetFromKey, et as getTotalPendingReplies, f as buildDefaultToolPolicyPipelineSteps, fn as scheduleGatewaySigusr1Restart, fr as resolveTtsConfig, gn as unbindThreadBindingsBySessionKey, gr as setTtsProvider, h as resolvePluginTools, hn as triggerOpenClawRestart, hr as setTtsEnabled, in as applyVerboseOverride, j as createDefaultDeps, jt as writeRestartSentinel, k as resolveAgentOutboundTarget, kn as enqueueSystemEvent, kt as summarizeRestartSentinel, l as getActiveEmbeddedRunCount, ln as emitGatewayRestart, lr as isTtsProviderConfigured, lt as createOpenClawTools, m as getPluginToolMeta, mn as setPreRestartDeferralCheck, mr as resolveTtsProviderOrder, mt as resolveOutboundSessionRoute, n as initSubagentRegistry, nr as stopSubagentsForRequester, o as clearSessionQueues, on as buildOutboundSessionContext, or as clearBootstrapSnapshot, ot as getCliSessionId, pn as setGatewaySigusr1RestartPolicy, pr as resolveTtsPrefsPath, pt as ensureOutboundSessionEntry, qn as extractImageContentFromSource, qt as buildSafeExternalPrompt, r as listDescendantRunsForRequester, rn as applyModelOverrideToSessionEntry, rt as BARE_SESSION_RESET_PROMPT, s as runEmbeddedPiAgent, sn as consumeGatewaySigusr1RestartAuthorization, sr as getTtsProvider, st as setCliSessionId, t as countActiveDescendantRuns, tr as isAbortRequestText, u as waitForEmbeddedPiRunEnd, un as isGatewaySigusr1RestartExternallyAllowed, ur as resolveTtsApiKey, ut as readLatestAssistantReply, vr as OPENAI_TTS_MODELS, vt as resolveSessionDeliveryTarget, w as sleepWithAbort, wn as formatZonedTimestamp, wr as resetAllLanes, x as readJsonBodyWithLimit, xt as resetDirectoryCache, yn as loadProviderUsageSummary, yr as OPENAI_TTS_VOICES, yt as resolveOutboundChannelPlugin, zn as ACP_SESSION_IDENTITY_RENDERER_VERSION, zt as normalizePayloadToSystemText } from "./subagent-registry-BrzwRDvR.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DWsXK0S0.js";
...
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-D6IYi30Z.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-WSkvNWXx.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-3nGJ2B10.js";
...
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-DZjxKYzb.js";
import { c as detectMime } from "./image-ops-Z3_QkQPj.js";
import "./pi-embedded-helpers-GFZZHryU.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-COrmfGkR.js";
...
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-BLhOGtRw.js";
...
import { i as writeFileWithinRoot, n as openFileWithinRoot, r as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-BDinrAxW.js";
...
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-B3-7mJVU.js";
...
import { S as extractTextFromChatContent } from "./image-DrapxBiX.js";
import "./tool-display-FacPPVzc.js";
import { d as registerUnhandledRejectionHandler } from "./runner-NwpHoY5Q.js";
import { n as loadModelCatalog } from "./model-catalog-Def_bWVq.js";
import "./fetch-CgA7FwwB.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-CjsmzisR.js";
...
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-CP9tjqOm.js";
...
import { n as resolveSystemRunCommand } from "./system-run-command-BqLmA4zq.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-B6ojB03j.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-CijgoJ1t.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Db6a_HT6.js";
...
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-CkN9S7rR.js";
...
import { n as addGatewayServiceCommands } from "./daemon-cli-BVKOGnwA.js";
...
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-GQ5x4wiA.js";
import { a as isNodeCommandAllowed, n as collectEnabledInsecureOrDangerousFlags, o as resolveNodeCommandAllowlist, s as probeGateway } from "./audit-DgkVNA-0.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-COWPH6kR.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Ca6I1i-H.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-CXtv23mt.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-D-OQDxpR.js";
...
import { i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-B1Vh8h8y.js";
import { t as runOnboardingWizard } from "./onboarding-C7wlGNih.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-_pQnafYG.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-BvUMfUSA.js";
import "./node-service-YkAoOUN_.js";
import "./status.update-C-aMt2e3.js";
import { a as matchSystemRunApprovalBindingV1, i as buildSystemRunApprovalBindingV1, n as resolveSystemRunApprovalRequestContext, o as missingSystemRunApprovalBindingV1, r as resolveSystemRunApprovalRuntimeContext, s as toSystemRunApprovalMismatchError } from "./system-run-approval-context-CsSYv3Qu.js";
import { t as installSkill } from "./skills-install-D1iomS_H.js";
import { t as runGatewayUpdate } from "./update-runner-pUL_71nf.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-oRrVJPBi.js";
import { n as forceFreePortAndWait } from "./ports-2J-7IGgw.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-1HWlCvKU.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-CRAbQ_dT.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CgaC8glE.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-3nGJ2B10.js").then((n) => n.n);
