...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CijgoJ1t.js";
import { t as WizardCancelledError } from "./prompts-CfOu9uZi.js";
import { t as createClackPrompter } from "./clack-prompter-b-zJxplB.js";
import { t as assertSupportedRuntime } from "./runtime-guard-jjhyM3bE.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BKMWPnqW.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Do0oBM_8.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CXtv23mt.js").then((n) => n.i);
