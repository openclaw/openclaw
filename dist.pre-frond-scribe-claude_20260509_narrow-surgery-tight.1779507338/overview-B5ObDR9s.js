import { o as resolveConfigPath, u as resolveGatewayPort } from "./paths-r6w2eKyy.js";
import { i as resolveAgentModelPrimaryValue } from "./model-input-ChW9XXsQ.js";
import { a as resolveAgentEffectiveModelPrimary } from "./agent-scope-DKjUWHDL.js";
import { l as normalizeAgentId } from "./session-key-Bte0mmcq.js";
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-D1eqrBeU.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-ZHI51twp.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
