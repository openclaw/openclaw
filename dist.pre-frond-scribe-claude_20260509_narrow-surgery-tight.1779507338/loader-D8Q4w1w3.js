...
import { T as sanitizeCommandDescriptorDescription, w as normalizeCommandDescriptorName } from "./argv-lFfbK1Bo.js";
...
import { f as shouldRejectHardlinkedPluginFiles, t as discoverOpenClawPlugins } from "./discovery-DIKVD3UH.js";
...
import "./bundle-manifest-AlBe-iuj.js";
import { _ as getPluginCompatRecord, p as collectPluginManifestCompatCodes } from "./installed-plugin-index-store-0PHPtBHb.js";
import { h as writeJsonSync, p as tryReadJsonSync } from "./json-files-C2hqjU--.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-DT22cOei.js";
import { c as resolveEffectiveEnableState, d as resolveMemorySlotDecision, l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig, t as applyTestPluginDefaults } from "./config-state--2N-6Pm1.js";
...
import { C as fingerprintPluginDiscoveryContext, T as resolvePluginDiscoveryContext } from "./plugin-registry-C1e5xmDO.js";
import { n as getCachedPluginModuleLoader, s as toSafeImportPath, t as createPluginModuleLoaderCache } from "./plugin-module-loader-cache-D1-BKQjN.js";
import { a as listPluginSdkAliasCandidates, c as resolveExtensionApiAlias, f as resolvePluginRuntimeModulePath, g as shouldPreferNativeModuleLoad, h as resolvePluginSdkScopedAliasMap, m as resolvePluginSdkAliasFile, n as buildPluginLoaderJitiOptions, o as listPluginSdkExportedSubpaths, p as resolvePluginSdkAliasCandidateOrder, t as buildPluginLoaderAliasMap } from "./sdk-alias-BdMfVHCd.js";
import { t as createSubsystemLogger } from "./subsystem-DzLaJyoj.js";
import "./installed-plugin-index-records-DwKO2_nM.js";
import { i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-DgdkBEdP.js";
import { t as validateJsonSchemaValue } from "./schema-validator-CoHaB3Uu.js";
import { n as listChatChannels } from "./chat-meta-C-sai9hH.js";
...
import "./core-descriptors-zcE5f_RQ.js";
import { s as isOperatorScope, t as ADMIN_SCOPE } from "./operator-scopes-DGvgHuOd.js";
import { a as serializePluginIdScope, i as normalizePluginIdScope, n as hasExplicitPluginIdScope, t as createPluginIdScopeSet } from "./plugin-scope-6HF2N6kz.js";
import { m as normalizeChannelMeta } from "./bundled-DLZDi_7U.js";
...
import { a as listRegisteredAgentHarnesses, c as restoreRegisteredAgentHarnesses, o as registerAgentHarness, r as getRegisteredAgentHarness, t as clearAgentHarnesses } from "./registry-B_VlHdCE.js";
import { G as resolveMemoryDreamingConfig, K as resolveMemoryDreamingPluginConfig, _ as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-7PkZ65Le.js";
import { a as restoreDetachedTaskLifecycleRuntimeRegistration, i as registerDetachedTaskLifecycleRuntime, n as getDetachedTaskLifecycleRuntimeRegistration, t as clearDetachedTaskLifecycleRuntimeRegistration } from "./detached-task-runtime-state-B0mh7AbV.js";
import { n as inspectBundleMcpRuntimeSupport } from "./bundle-mcp-BPEJQCFR.js";
import { A as listRegisteredPluginCommands, D as clearPluginCommandsForPlugin, E as clearPluginCommands, M as restorePluginCommands, S as restorePluginInteractiveHandlers, _ as clearPluginInteractiveHandlers, b as registerPluginInteractiveHandler, f as isConversationHookName, g as stripPromptMutationFieldsFromLegacyHookResult, i as registerPluginCommand, j as pluginCommands, m as isPromptInjectionHookName, o as validatePluginCommandDefinition, p as isPluginHookName, t as isReservedCommandName, v as clearPluginInteractiveHandlersForPlugin, y as listPluginInteractiveHandlers } from "./command-registration-CJwLg4nJ.js";
import { i as initializeGlobalHookRunner, t as getGlobalHookRunner } from "./hook-runner-global-Bqn2eA2l.js";
import { a as resolveSetupChannelRegistration, i as resolveBundledRuntimeChannelRegistration, n as loadBundledRuntimeChannelPlugin, o as shouldLoadChannelPluginInSetupRuntime, r as mergeSetupRuntimeChannelPlugin, t as channelPluginIdBelongsToManifest } from "./loader-channel-setup-CdQ4H6Xc.js";
import { a as listRegisteredMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider, r as getRegisteredMemoryEmbeddingProvider, s as restoreRegisteredMemoryEmbeddingProviders, t as clearMemoryEmbeddingProviders } from "./memory-embedding-providers-816TTVuI.js";
import { S as restoreMemoryPluginState, _ as registerMemoryPromptSupplement, d as registerMemoryCapability, f as registerMemoryCorpusSupplement, g as registerMemoryPromptSectionForPlugin, l as listMemoryCorpusSupplements, m as registerMemoryFlushPlanResolverForPlugin, n as clearMemoryPluginState, r as getMemoryCapabilityRegistration, u as listMemoryPromptSupplements, y as registerMemoryRuntimeForPlugin } from "./memory-state-DKjCVvl8.js";
import { i as withProfile } from "./plugin-load-profile-DOnG9jJ5.js";
import { A as registerPluginSessionSchedulerJob, C as isPluginRegistryRetired, D as getPluginRunContext, E as deletePluginSessionSchedulerJob, F as createEmptyPluginRegistry, N as buildPluginAgentTurnPrepareContext, O as getPluginSessionSchedulerJobGeneration, P as normalizePluginHostHookId, S as isPluginRegistryActivated, T as clearPluginRunContext, a as getActivePluginRegistry, j as setPluginRunContext, l as getActivePluginRuntimeSubagentMode, o as getActivePluginRegistryKey, p as recordImportedPluginId, x as setActivePluginRegistry } from "./runtime-CrQXj4lU.js";
import { i as registerContextEngineForOwner, t as clearContextEnginesForOwner } from "./registry-DxH_0Os-.js";
import { f as registerInternalHook, h as unregisterInternalHook } from "./internal-hooks-BShGo5vM.js";
...
import { t as createPluginStateKeyedStore } from "./plugin-state-store-Di7ttTAj.js";
import { i as emitAgentEvent } from "./agent-events-BuYtWSh4.js";
import { t as isPluginJsonValue } from "./host-hook-json-BHsxXV1L.js";
import { a as normalizeAgentToolResultMiddlewareRuntimeIds, n as normalizePluginToolContractNames, o as normalizeAgentToolResultMiddlewareRuntimes, r as normalizePluginToolNames, t as findUndeclaredPluginToolNames } from "./tool-contracts-B2fQHYIP.js";
import { n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-CyO8R9o6.js";
import { n as resolveAgentMainSessionKey } from "./main-session-D3q_5w0B.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId } from "./combined-store-gateway-CqawSGEb.js";
import { u as resolveStorePath } from "./paths---FlWJ0A.js";
import { l as normalizeSessionEntrySlotKey, t as loadSessionStore } from "./store-load-DM26fo1a.js";
import { u as updateSessionStore } from "./store-CuGD5gZu.js";
import { i as resolveAllAgentSessionStoreTargetsSync } from "./targets-C_-PZhPd.js";
import { u as extractDeliveryInfo } from "./sessions-CtFd7seb.js";
import { n as detectMime, t as FILE_TYPE_SNIFF_MAX_BYTES, u as normalizeMimeType } from "./mime-DppuT-pZ.js";
import "./host-hook-cleanup-chSBFi3T.js";
import { n as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-BShPdT8Q.js";
import { i as withPluginRuntimePluginScope, r as withPluginRuntimePluginIdScope } from "./gateway-request-scope-B9qYB9tg.js";
...
const allowedParentRoots = /* @__PURE__ */ new Set();
let installed = false;
...
function addAllowedParentRoot(root) {
	allowedParentRoots.add(normalizePathForBoundary(root));
}
function registerAllowedParentRoots(options) {
	if (options.pluginModulePath) addAllowedParentRoot(findNearestPackageRoot(options.pluginModulePath));
	for (const root of options.allowedParentRoots ?? []) addAllowedParentRoot(root);
}
function isWithinRoot(candidate, root) {
	const relative = path.relative(root, normalizePathForBoundary(candidate));
	return relative === "" || !relative.startsWith("..") && !path.isAbsolute(relative);
}
function canResolveForParent(parent) {
	const parentFilename = parent?.filename;
	if (!parentFilename || allowedParentRoots.size === 0) return false;
...
function listPluginSdkNativeAliases(options) {
	...
	return Object.entries(buildPluginLoaderAliasMap(modulePath, options.argv1 ?? process.argv[1], options.moduleUrl, "dist")).filter(([specifier]) => isPluginSdkAliasSpecifier(specifier)).filter(([, target]) => isNativeLoadableSdkTarget(target)).flatMap(([specifier, target]) => {
...
function installResolver() {
	...
	moduleWithResolver[nodeResolveFilenameProperty] = ((request, parent, isMain, options) => {
		...
		if (aliasTarget && canResolveForParent(parent)) return aliasTarget;
...
function installOpenClawPluginSdkNativeResolver(options = {}) {
	for (const [specifier, target] of listPluginSdkNativeAliases(options)) pluginSdkNativeAliases.set(specifier, target);
...
async function loadSendMessage() {
	sendMessagePromise ??= import("./message-jZ9TIa8f.js").then((module) => module.sendMessage);
	return sendMessagePromise;
}
let getChannelPluginPromise;
async function loadGetChannelPlugin() {
	getChannelPluginPromise ??= import("./plugins-WiLt7XtY.js").then((module) => module.getChannelPlugin);
...
//#endregion
export { createPluginGatewayMethodDescriptors as C, getCompactionProvider as D, listRegisteredEmbeddingProviders as E, resolvePluginActivationSourceConfig as O, createGatewayMethodRegistry as S, getRegisteredEmbeddingProvider as T, getPluginSessionExtensionStateSync as _, getRuntimePluginRegistryForLoadOptions as a, listCodexAppServerExtensionFactories as b, loadOpenClawPlugins as c, resolveRuntimePluginRegistry as d, testing as f, drainPluginNextTurnInjectionContext as g, synthesizeMediaGenerationCatalogEntries as h, clearPluginRegistryLoadCache as i, resolveCompatibleRuntimePluginRegistry as l, listMediaGenerationProviderModels as m, clearActivatedPluginRuntimeState as n, isPluginRegistryLoadInFlight as o, createPluginRegistry as p, clearPluginLoaderCache as r, loadOpenClawPluginCliRegistry as s, PluginLoadFailureError as t, resolvePluginRegistryLoadCacheKey as u, patchPluginSessionExtension as v, PluginLoadReentryError as w, createGatewayMethodDescriptorsFromHandlers as x, projectPluginSessionExtensionsSync as y };
