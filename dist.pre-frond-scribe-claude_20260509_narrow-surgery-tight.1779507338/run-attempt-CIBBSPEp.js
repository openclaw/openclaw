...
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-D1eqrBeU.js";
import { a as hasPendingInternalDiagnosticEvent, c as onInternalDiagnosticEvent, i as emitTrustedDiagnosticEvent } from "./diagnostic-events-B8HAyst_.js";
...
import { r as markAuthProfileBlockedUntil } from "./usage-Ddo16QWA.js";
import { d as resolveModelAuthMode } from "./model-auth-X07O9eQq.js";
import { m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-CkOGrSum.js";
...
import { a as hasBeforeToolCallPolicy } from "./pi-tools.before-tool-call-B39uI8tH.js";
import { O as supportsModelTools } from "./openai-transport-stream-D5Hrg1gj.js";
import { a as resolveCompactionTimeoutMs, f as runAgentCleanupStep, l as normalizeAgentRuntimeTools, r as compactContextEngineWithSafetyTimeout, t as buildEmbeddedAttemptToolRunContext } from "./attempt.tool-run-context-Bdqo6ZlY.js";
...
import { a as runAgentHarnessLlmOutputHook, i as runAgentHarnessLlmInputHook, n as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-lek36N_w.js";
import "./sandbox-BZy5zJG1.js";
import "./agent-runtime-CFeYWufT.js";
import "./security-runtime-D_WAZplk.js";
import { n as deliverAgentHarnessTaskCompletion, r as isDurableAgentHarnessCompletionDelivery, t as createAgentHarnessTaskRuntime } from "./agent-harness-task-runtime-DfWi4lBM.js";
...
import { a as registerNativeHookRelay, c as runAgentHarnessAfterToolCallHook, l as runAgentHarnessBeforeMessageWriteHook } from "./native-hook-relay-Cj7AOioh.js";
...
import { a as isCodexAppServerConnectionClosedError, i as isCodexAppServerApprovalRequest, r as compareCodexAppServerVersions, s as MIN_CODEX_SANDBOX_EXEC_SERVER_APP_SERVER_VERSION } from "./client-CVqC1M0T.js";
import { E as resolveCodexContextEngineProjectionReserveTokens, S as sanitizeCodexHistoryImagePayloads, T as resolveCodexContextEngineProjectionMaxChars, b as defaultCodexAppInventoryCache, c as codexDynamicToolsFingerprint, f as startOrResumeThread, g as shouldBuildCodexPluginThreadConfig, h as mergeCodexThreadConfigs, i as buildDeveloperInstructions, l as isContextEngineBindingCompatible, m as buildCodexPluginThreadConfigInputFingerprint, p as buildCodexPluginThreadConfig, r as buildContextEngineBinding, s as buildTurnStartParams, t as areCodexDynamicToolFingerprintsCompatible, w as projectContextEngineAssemblyForCodex } from "./thread-lifecycle-bB5uBFC7.js";
...
import { t as ensureCodexComputerUse } from "./computer-use-BRP-SuR9.js";
...
async function runCodexAppServerAttempt(params, options = {}) {
	...
	try {
		...
		const completionIdleTimeoutHadPotentialSideEffects = hasCodexAppServerPotentialSideEffectEvidence(result);
		const promptTimeoutOutcome = turnCompletionIdleTimedOut && (result.itemLifecycle.completedCount > 0 || completionIdleTimeoutHadPotentialSideEffects) ? {
...
function shouldEnableCodexAppServerNativeToolSurface(params, sandbox, options = {}) {
	...
	if (isEffectiveExecHostNode(params, options.agentId)) return false;
...
function isEffectiveExecHostNode(params, agentId) {
	const agentExec = params.config && agentId ? resolveAgentConfig(params.config, agentId)?.tools?.exec : void 0;
	return (params.execOverrides?.host ?? agentExec?.host ?? params.config?.tools?.exec?.host) === "node";
}
...
function shouldExposeSandboxExecDynamicTool(input) {
	...
	if (isEffectiveExecHostNode(input.params, input.sessionAgentId)) return false;
...
function addNodeShellDynamicToolsIfNeeded(filteredTools, allTools, input) {
	if (isCodexMemoryFlushRun(input.params) || !isEffectiveExecHostNode(input.params, input.sessionAgentId)) return filteredTools;
