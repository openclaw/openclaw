...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-W-nDh9OC.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-DSpxZ7Q4.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-BE4t-I4m.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-BETgOIvU.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-7vd0TkAj.js";
import { t as providerSupportsCapability } from "./provider-supports-_vg7HvJF.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-p40Ldo9D.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-B_Dw-o8T.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-DEbcUBWg.js";
import { t as buildRandomTempFilePath } from "./temp-download-Ci8u7NDb.js";
import "./temp-path-Dr0HtrH2.js";
import { a as runCliEntry, c as fileExists, l as MediaUnderstandingSkipError, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as isMediaUnderstandingSkipError } from "./runner.entries-DRILeUIl.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-BfSyBFqE.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-DdbGkFXs.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-yzfpTRFD.js");
