...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-BZulegiw.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CfUll2ze.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-Dl4ShRNj.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-Bt_omTKY.js");
	if (params.argv) {
