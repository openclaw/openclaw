...
import { s as hasConfiguredSecretInput } from "./types.secrets-BcE0iOnr.js";
...
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-xZ4-bv2H.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DxJG0skC.js";
import "./channel-core-DVKz0cLU.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-DPWQPgLK.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-1U6PweBt.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-CQhpROmW.js";
...
import "./account-resolution-BHgLoEg4.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-C9w9gv4K.js";
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-C5mDIh9J.js";
import "./channel-status-pmRGSI7K.js";
import "./channel-config-primitives-C3bCZYk8.js";
import "./channel-actions-t0R77jqp.js";
import { r as defineChannelMessageAdapter } from "./channel-message-CO23hUpq.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BQ9lyBd_.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-BxILLxEU.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-mlj-khBS.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-BtOgeIyZ.js";
import { n as createFeishuSendReceipt } from "./send-result-DLDMf5Tl.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-BBDlmBlS.js";
import { t as messageActionTargetAliases } from "./security-audit-fyLD7rXk.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-BO1tEI5_.js";
...
import { t as resolveFeishuSessionConversation } from "./session-conversation-Dpy3x8pS.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-BkZJV6-G.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-BkZJV6-G.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-VR3Ieifn.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Dg6xup7u.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-69WXwifD.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-D-hz_VVM.js");
