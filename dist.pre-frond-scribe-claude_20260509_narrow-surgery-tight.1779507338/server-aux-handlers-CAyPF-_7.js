...
import { t as resolveChannelApprovalAdapter } from "./plugins-BateXvZM.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-Bbmp5jwY.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-Bef7TPVc.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeEnv } from "./runtime-state-ALw9K_1_.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-BRkzUjP6.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-D0N7NpUN.js";
...
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-BiTMXpCL.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-C8jZouds.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-CFGau7yJ.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-C0ykUH8S.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-DJZ-5hya.js";
import { t as diffConfigPaths } from "./config-diff-Dg1szdZ9.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-lCaZ6W_1.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-7bDn727j.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-CWibdkrx.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-t3Qx_uuS.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
