...
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-CkOGrSum.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-DbXbcB4m.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-CNUTzKrg.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-Dc7B13Zv.js";
import { i as consumePendingDelegates } from "./delegate-store-DdqYf1HI.js";
import "./continuation-delegate-store-COC6L6XF.js";
import { n as resolveContinuationRuntimeConfig } from "./config-CgkTT-_G.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BIBysQmu.js";
import "./delivery-context-C_WB0-Lw.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CP49lnl9.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-Cavpwl79.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-Dn57JMg0.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-CIz7Qnxf.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-B1sAankV.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-CzUNcYfZ.js"), import("./store-load-0SWrt7wM.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { enqueueSystemEvent } = await import("./system-events-TEGvr9vG.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-YgbQuScZ.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-TEGvr9vG.js");
			const { createSubsystemLogger } = await import("./subsystem-BJ9alVVe.js");
