...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-DIKVD3UH.js";
...
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-BnT81H5y.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-Cog1vF6e.js");
	const { buildPluginSnapshotReport } = await import("./status-BbKRx_Gk.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-CK1yo4DV.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-je5AcQKe.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CDba7AKF.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-BbUEt9O4.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-DNRVho6z.js");
