...
export type SlackInteractiveHandlerRegistration = PluginInteractiveRegistration<SlackInteractiveHandlerContext, "slack", SlackInteractiveHandlerResult>;
type SlackInteractiveDispatchContext = Omit<SlackInteractiveHandlerContext, "interaction" | "respond" | "channel" | "requestConversationBinding" | "detachConversationBinding" | "getCurrentConversationBinding"> & {
    interaction: Omit<SlackBlockInteractivePayload, "data" | "namespace" | "payload"> | Omit<SlackModalInteractivePayload, "data" | "namespace" | "payload">;
};
export declare function dispatchSlackPluginInteractiveHandler(params: {
    data: string;
    interactionId: string;
