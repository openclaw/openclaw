import type { APIGuild, APIGuildMember, APIGuildScheduledEvent, APIRole, APIVoiceState, RESTPostAPIGuildScheduledEventJSONBody } from "discord-api-types/v10";
import { type APIChannel } from "./internal/discord.js";
...
export declare function fetchGuildInfoDiscord(guildId: string, opts: DiscordReactOpts): Promise<APIGuild>;
