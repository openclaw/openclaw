...
export declare class DiscordThreadInitialMessageError extends Error {
    readonly initialMessageError: string;
    readonly thread: APIChannel;
    constructor(thread: APIChannel, error: unknown);
}
export declare function readMessagesDiscord(channelId: string, query: DiscordMessageQuery | undefined, opts: DiscordReactOpts): Promise<APIMessage[]>;
...
export declare function createThreadDiscord(channelId: string, payload: DiscordThreadCreate, opts: DiscordReactOpts): Promise<APIChannel>;
