...
import { f as resolveHomeDir } from "./utils-CAcKzQHY.js";
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-BxFubSMj.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { t as note } from "./note-Dg2Luaaq.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-BKeamB81.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BkRFyvNI.js");
