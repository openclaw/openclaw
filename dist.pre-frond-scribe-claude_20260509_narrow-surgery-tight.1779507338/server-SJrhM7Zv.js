...
import { p as resolveUserPath, s as ensureDir } from "./utils-CAcKzQHY.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-C7e9y_Er.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-C2EvMpXQ.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-Be-R6F-y.js");
