import { d as normalizeSecretInputString } from "./types.secrets-BcE0iOnr.js";
...
import "./accounts-C5k0Wq98.js";
import "./runtime-api-BQo9HwcW.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-EV2cS34s.js";
import { t as sendMessageZalo } from "./send-6OEbKyx7.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DlxyAGRf.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BzR5lRdJ.js");
