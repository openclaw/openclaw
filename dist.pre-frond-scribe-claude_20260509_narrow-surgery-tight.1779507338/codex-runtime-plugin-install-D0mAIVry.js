...
import { o as modelSelectionShouldEnsureCodexPlugin } from "./openai-codex-routing-qNSGkXbB.js";
...
async function repairCodexRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-BcnE0hZh.js");
