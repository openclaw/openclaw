...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-B32DTKh8.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-DEY7ZBri.js";
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-qNSGkXbB.js";
import { i as buildModelAliasIndex, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-D9lGAOqA.js";
import { i as parseModelRef, n as modelKey } from "./model-selection-normalize-CWGJNik_.js";
import "./model-selection-BSyRhVPt.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-mBAlIzS2.js";
...
import { c as hasSyntheticLocalProviderAuthConfig, l as hasUsableCustomProviderApiKey } from "./model-auth-X07O9eQq.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-DVGQVUdW.js";
import { n as loadModelsConfigWithSource } from "./load-config-DJuz9ZBJ.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-BAbuPiJZ.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-D6J_bXZl.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BEWoxN4x.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-B6OnC0kw.js"),
		import("./agent-scope-KBzAiuMq.js"),
		import("./workspace-OFvPq3oU.js")
	]);
