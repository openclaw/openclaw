...
import { r as getChildLogger, v as normalizeLogLevel } from "../../logger-DZLjhaVZ.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-BuSu5uPJ.js";
...
import { c as saveSessionStore, d as updateSessionStoreEntry, f as upsertSessionEntry, i as patchSessionEntry, n as getSessionEntry, r as listSessionEntries, u as updateSessionStore } from "../../store-CuGD5gZu.js";
...
import { c as getImageMetadata, p as resizeToJpeg } from "../../media-services-BrH8EG2E.js";
import { o as generateMusic, s as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-HooJv9O2.js";
...
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-DsVVnZRX.js";
import { n as resolveAgentIdentity } from "../../identity-BspxvuU6.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-JMXMH1Tw.js";
...
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-CYg2uLOi.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-Bq4H9hyN.js";
import { r as isVoiceCompatibleAudio } from "../../audio-CVFIRHpA.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-Cw8jDLqg.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-BFCjrdcv.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-uYF8gO6y.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-CddLPBTo.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-gJ1RT_tr.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-Cz6UTPmf.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-q1zvpC__.js"), (m) => m.createRuntimeLlm({
