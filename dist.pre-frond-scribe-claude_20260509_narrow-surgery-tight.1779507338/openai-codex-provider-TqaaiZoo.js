import { a as normalizeLowercaseStringOrEmpty, f as readStringValue } from "./string-coerce-DyL154ka.js";
...
import { r as ensureAuthProfileStoreForLocalUpdate } from "./store-CDaJsp3I.js";
import { n as listProfilesForProvider } from "./profile-list-B1VQYST0.js";
import { a as normalizeModelCompat } from "./provider-model-compat-BYnsltS3.js";
import "./error-runtime-Dgkgdgpq.js";
import "./string-coerce-runtime-CKTxkd64.js";
import { l as cloneFirstTemplateModel, u as matchesExactOrPrefix } from "./provider-model-shared-DsnTZA_6.js";
import { t as createProviderApiKeyAuthMethod } from "./provider-api-key-auth-CIe7tcoT.js";
import { t as buildOauthProviderAuthResult } from "./provider-auth-result-ZKd50yya.js";
import "./provider-auth-BMQAPWKU.js";
import { l as findCatalogTemplate } from "./provider-catalog-shared-C6L92Rnz.js";
import { i as fetchCodexUsage } from "./provider-usage-Bz9khKBw.js";
import { i as isOpenAICodexBaseUrl, r as isOpenAIApiBaseUrl, t as OPENAI_CODEX_RESPONSES_BASE_URL } from "./base-url-DvFiHVC-.js";
import { t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models-Mk-XcaOQ.js";
import { n as buildOpenAISyntheticCatalogEntry, t as buildOpenAIResponsesProviderHooks } from "./shared-CJLQ8uTE.js";
import { c as OPENAI_CODEX_API_KEY_BACKUP_HINT, d as OPENAI_CODEX_DEVICE_PAIRING_LABEL, f as OPENAI_CODEX_LOGIN_HINT, l as OPENAI_CODEX_API_KEY_BACKUP_LABEL, m as OPENAI_CODEX_WIZARD_GROUP, p as OPENAI_CODEX_LOGIN_LABEL, u as OPENAI_CODEX_DEVICE_PAIRING_HINT } from "./auth-choice-copy-CI2uePXw.js";
import { n as resolveCodexAuthIdentity } from "./openai-codex-auth-identity-rxfQXt7D.js";
import { t as buildOpenAICodexProvider } from "./openai-codex-catalog-DiUDsWRy.js";
import { t as loginOpenAICodexDeviceCode } from "./openai-codex-device-code-D00sO9fA.js";
import { t as loginOpenAICodexOAuth } from "./openai-codex-oauth.runtime.js";
import { t as resolveOpenAICodexThinkingProfile } from "./thinking-policy-CkZmF4BG.js";
...
function matchesOpenAICodexImageCapableModel(modelId, modelName) {
	return [modelId, modelName].filter((value) => typeof value === "string").some((candidate) => matchesExactOrPrefix(candidate, OPENAI_CODEX_MODERN_MODEL_IDS));
}
/**
...
function withDefaultCodexContextMetadata(params) {
	...
	const input = params.model.input?.includes("image") ? params.model.input : [...new Set([...params.model.input ?? ["text"], "image"])];
	return {
		...params.model,
		input,
...
function applyOpenAICodexAuthConfig(cfg) {
	return {
		...cfg,
		agents: {
			...cfg.agents,
