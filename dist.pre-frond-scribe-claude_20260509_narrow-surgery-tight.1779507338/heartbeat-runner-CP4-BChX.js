...
import { i as formatErrorMessage, o as hasErrnoCode } from "./errors-B5idDZn1.js";
...
import { c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-D1eqrBeU.js";
...
import { t as archiveRemovedSessionTranscripts, u as updateSessionStore } from "./store-CuGD5gZu.js";
...
import { n as listDueCommitmentSessionKeys, o as markCommitmentsAttempted, r as listDueCommitmentsForSession, s as markCommitmentsStatus } from "./store-D274RWl1.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-Dc7B13Zv.js";
import { c as parseHeartbeatTasks, d as stripHeartbeatToken, l as resolveHeartbeatPrompt$1, o as isHeartbeatContentEffectivelyEmpty, s as isTaskDue, u as resolveHeartbeatPromptForResponseTool } from "./heartbeat-B444HHRI.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-wP7icKjA.js";
import { a as isRetryableHeartbeatBusySkipReason, c as setHeartbeatWakeHandler, i as areHeartbeatsEnabled, n as HEARTBEAT_SKIP_LANES_BUSY, o as requestHeartbeat, r as HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT, t as HEARTBEAT_SKIP_CRON_IN_PROGRESS } from "./heartbeat-wake-sS2lf3LW.js";
import { c as peekSystemEventEntries, f as resolveSystemEventDeliveryContext, t as consumeSelectedSystemEventEntries } from "./system-events-BqSflfol.js";
import { c as getQueueSize, s as getCommandLaneSnapshots } from "./command-queue-Cc__1ixy.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-DMPQsrQC.js";
import { a as getHeartbeatToolNotificationText, s as resolveHeartbeatToolResponseFromReplyResult } from "./heartbeat-tool-response-CemEI13Y.js";
import { r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-D9JVjqOO.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-D8GbzGE5.js";
import { r as resolveMainScopedEventSessionKey } from "./event-session-routing-DWPITVBM.js";
...
import { n as resolveHeartbeatSenderContext, t as resolveHeartbeatDeliveryTarget } from "./targets-Dlvq1FNW.js";
...
import { a as isRelayableExecCompletionEvent, i as isExecCompletionEvent, n as buildExecEventPrompt, r as isCronSystemEvent, t as buildCronEventPrompt } from "./heartbeat-events-filter-ouM0kwIt.js";
...
function resolveHeartbeatSession(cfg, agentId, heartbeat, forcedSessionKey, opts) {
	...
	if (forced && isSubagentSessionKey(forced)) {
		if (opts?.reason === "continuation") return {
			sessionKey: forced,
			storePath,
			store,
			entry: store[forced],
...
async function resolveHeartbeatPreflight(params) {
	...
	const session = resolveHeartbeatSession(params.cfg, params.agentId, params.heartbeat, params.forcedSessionKey, { reason: params.reason });
...
async function runHeartbeatOnce(opts) {
	...
	const { entry: recentSessionEntry } = resolveHeartbeatSession(cfg, agentId, heartbeat, opts.sessionKey, { reason: opts.reason });
