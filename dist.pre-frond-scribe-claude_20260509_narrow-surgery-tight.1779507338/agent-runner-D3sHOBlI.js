...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-DKjUWHDL.js";
...
import { i as freezeDiagnosticTraceContext, s as runWithDiagnosticTraceparent, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-BhiYlOGB.js";
import { i as emitTrustedDiagnosticEvent, o as isDiagnosticsEnabled } from "./diagnostic-events-B8HAyst_.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-BuSu5uPJ.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-BDNGqTGO.js";
import { r as isInternalMessageChannel } from "./message-channel-D8iFykAD.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths---FlWJ0A.js";
import { F as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-DM26fo1a.js";
import { d as updateSessionStoreEntry, u as updateSessionStore } from "./store-CuGD5gZu.js";
...
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-CkOGrSum.js";
...
import { a as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-CjaiboSj.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-DKNTRfvn.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-BqGZxEFC.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-BG19mF4s.js";
...
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN, s as stripContinuationSignal } from "./tokens-Dc7B13Zv.js";
import { d as stripHeartbeatToken } from "./heartbeat-B444HHRI.js";
import { r as enqueueCommitmentExtraction } from "./runtime-C0NkCaXx.js";
import { c as emitContinuationWorkSpan, g as startContinuationDelegateSpan, i as emitContinuationDisabledSpan, m as resolveContinuationTraceparent, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-1FDA2mGm.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-sS2lf3LW.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-B-x2FMyg.js";
import { a as enqueueSystemEvent } from "./system-events-BqSflfol.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-Cc__1ixy.js";
import { n as resolveSendPolicy } from "./send-policy-rKqghZEF.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-DdqYf1HI.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-COC6L6XF.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-CgkTT-_G.js";
import { t as checkContextPressure } from "./context-pressure-BtQCLvBh.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-CW101g1V.js";
import { c as resolveCliRuntimeExecutionProvider, o as listLegacyRuntimeModelProviderAliases, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-bVlyEZ4v.js";
import "./pi-embedded-helpers-CLiarrsd.js";
import { t as formatProviderModelRef } from "./model-runtime-NSmvD3mm.js";
import "./fallback-notice-state-Bs522yNq.js";
...
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-CtW62TC-.js";
import { Q as estimateMessagesTokens } from "./selection-09xSYXB4.js";
import { r as runWithModelFallback } from "./model-fallback-MWvVmxb8.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Dng9YkQe.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-C1Mfys77.js";
import { i as isRenderablePayload, n as applyReplyThreading } from "./reply-payloads-D40Q_Sfv.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-D8G61K-C.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-stqniY6r.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DpVA1rhR.js";
import "./sandbox-B1T1wJz1.js";
import { n as readPostCompactionContext } from "./post-compaction-context-KMsMaCqE.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CrZzzylw.js";
import { a as resolveReplyRunFireReason, c as runCliAgentWithLifecycle, i as runAgentTurnWithFallback, n as resolveRunAfterAutoFallbackPrimaryProbeRecheck, o as normalizeReplyPayloadDirectives, r as resolveSessionRuntimeOverrideForProvider, t as buildKnownAgentRunFailureReplyPayload } from "./agent-runner-execution-CxlV-lVY.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DRHCW3H7.js";
...
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-5awmA--c.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-IMXTkfEf.js";
import { n as incrementCompactionCount } from "./session-updates-D1EqCGba.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-DKRDcd4W.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CEw5j-Nr.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-BHa06r-a.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-B6vvXgwM.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-Ca9bMYtv.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-Pk3zlYB6.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-D7Rep68b.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-Djw1KVru.js"));
		...
		try {
					...
					run: async (provider, model, runOptions) => {
						...
						try {
							...
							const result = await runEmbeddedPiAgent({
								...
								bootstrapPromptWarningSignaturesSeen,
								bootstrapPromptWarningSignature: bootstrapPromptWarningSignaturesSeen[bootstrapPromptWarningSignaturesSeen.length - 1],
								continueWorkOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? { requestContinuation: (request) => {
								...
								requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
									...
									triggerCompaction: async (request) => {
										try {
											const { compactEmbeddedPiSession } = await import("./compact.queued-BpiTYwNS.js");
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-CKVcxLrS.js"),
					import("./config-HX3ecXY-.js"),
					import("./state-CIz7Qnxf.js"),
					import("./store-BgAKvVwy.js")
				]);
			...
			if (attemptContinueWorkRequest && runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const { resolveLiveContinuationRuntimeConfig } = await import("./config-HX3ecXY-.js");
				const { maxChainLength, minDelayMs, maxDelayMs, defaultDelayMs } = resolveLiveContinuationRuntimeConfig(runtimeConfig);
				const { loadContinuationChainState, persistContinuationChainState } = await import("./state-CIz7Qnxf.js");
				const tailUsage = runResult.meta?.agentMeta?.usage;
				const turnTokens = (tailUsage?.input ?? 0) + (tailUsage?.output ?? 0);
				const tailEntry = (sessionKey ? sessionStore?.[sessionKey] : void 0) ?? sessionEntry;
				const chainState = loadContinuationChainState(tailEntry, turnTokens);
				const currentChainCount = chainState.currentChainCount;
				if (currentChainCount >= maxChainLength) defaultRuntime.log(`[followup-runner] continue_work cap reached for ${sessionKey}: ${currentChainCount}/${maxChainLength}`);
				else {
					const nextChainCount = currentChainCount + 1;
					const requestedDelayMs = attemptContinueWorkRequest.delaySeconds * 1e3;
					const clampedDelay = Math.max(minDelayMs, Math.min(maxDelayMs, requestedDelayMs || defaultDelayMs));
					persistContinuationChainState({
						sessionEntry: tailEntry,
					...
					const timerHandle = setTimeout(() => {
						try {
							defaultRuntime.log(`[followup-runner] continue_work timer fired for session ${sessionKey}`);
							enqueueSystemEvent(`[continuation:wake] Turn ${nextChainCount}/${maxChainLength}. The agent elected to continue working.` + (attemptContinueWorkRequest.reason ? ` Reason: ${attemptContinueWorkRequest.reason}` : ""), {
								sessionKey,
								trusted: true
							});
							requestHeartbeatNow({
