...
import { r as resolveCrestodianOperation } from "./dialogue-BMJi3_d6.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-dwqKeFe2.js")).runCrestodianTui;
	opts.onReady?.();
