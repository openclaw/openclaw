...
import { l as redactToolPayloadText } from "./redact-CVcFdz9b.js";
...
import { C as hasEncodedFileUrlSeparator, E as trySafeFileURLToPath, t as appendFileWithinRoot } from "./fs-safe-spIZMJL6.js";
import { o as root } from "./secure-temp-dir-aidxCRgA.js";
import { h as isWindowsDrivePath } from "./archive-X4nrziMN.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-CAcKzQHY.js";
...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-DKjUWHDL.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-D1eqrBeU.js";
...
import { i as resolveManifestContractOwnerPluginId, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-C1e5xmDO.js";
...
import { t as logDebug } from "./logger-BSBKEWuF.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BxFubSMj.js";
import { n as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-state-DRIYGASz.js";
import { n as modelKey } from "./model-ref-shared-DYP__lMU.js";
import { t as applyMergePatch } from "./merge-patch-Tu-gf1-r.js";
...
import { n as isRestartEnabled } from "./commands.flags--jYs26Rh.js";
import { o as normalizeChannelId } from "./registry-DgepP4xr.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BVWE_ra1.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-Ctzb4SJ-.js";
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-D8iFykAD.js";
...
import { r as callGateway } from "./call-BcpZiJRa.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-B6q6duKj.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-DEY7ZBri.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-D8Q4w1w3.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-BShGo5vM.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-BuYtWSh4.js";
import { n as assertSandboxPath } from "./sandbox-paths-DWbCkkiE.js";
import "./local-file-access-CBe_wA_B.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-CyO8R9o6.js";
import { h as stringifyRouteThreadId } from "./channel-route-L2PJ-xNE.js";
import { n as deliveryContextFromSession, o as normalizeDeliveryContext } from "./delivery-context.shared-ubhMwJVk.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths---FlWJ0A.js";
import { O as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-DM26fo1a.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BE4M2Iz0.js";
import { n as resolveSessionConversationRef } from "./session-conversation-D1pEDYy8.js";
...
import { u as extractDeliveryInfo } from "./sessions-CtFd7seb.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DppuT-pZ.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-B3-FaHxM.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-D9lGAOqA.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-CWGJNik_.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-BSyRhVPt.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CsdRhsMj.js";
import "./auth-profiles-CDHVEPhE.js";
import { n as resolveApiKeyForProfile } from "./oauth--FrPPgIG.js";
import { n as listProfilesForProvider } from "./profile-list-B1VQYST0.js";
import { i as resolveAuthProfileOrder } from "./order-BZKJ_iPF.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-cdTr1v5l.js";
import { a as getCustomProviderApiKey, i as getApiKeyForModel } from "./model-auth-X07O9eQq.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BcmC9MbZ.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CDMfe5qT.js";
...
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-DbXbcB4m.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-CR2GrkTf.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, r as SUBAGENT_SPAWN_CONTEXT_MODES, t as spawnSubagentDirect } from "./subagent-spawn-Hcc8DJDJ.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-tWo5VHEr.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-BkXNVypB.js";
...
import { r as stripToolMessages } from "./chat-history-text-DhtW_vtN.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CV4V5wx9.js";
import { n as ensureOpenClawModelsJson } from "./models-config-C2I3eHB0.js";
import { n as loadModelCatalog } from "./model-catalog-DmifARfn.js";
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-BqGZxEFC.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-Bm52LcEr.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-ReZ09_e4.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-DU9HQ1D9.js";
...
import "./targeting-DNiBXgP7.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-DdqYf1HI.js";
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-CgkTT-_G.js";
import { t as canonicalizeBase64 } from "./base64-D03BM6T6.js";
import { c as getImageMetadata } from "./media-services-BrH8EG2E.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CeyGpKqt.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-CemEI13Y.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-Q6zpyg-q.js";
import { a as resolvePluginTools } from "./tools-CnZl_vVX.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DXxNO33S.js";
import { C as listAllChannelSupportedActions, T as listChannelSupportedActions, c as isToolWrappedWithBeforeToolCallHook, p as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-B39uI8tH.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-D0b7VYTT.js";
import { c as jsonResult, f as readNumberParam, g as readStringParam$1, l as normalizeToolModelOverride, m as readStringArrayParam, n as ToolInputError, r as asToolParamsRecord, y as readSnakeCaseParamRaw } from "./common-CrEpgrS0.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-DbPtrhrk.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BIBysQmu.js";
import { n as extractAssistantText } from "./pi-embedded-utils-D8GbzGE5.js";
import { n as runWithImageModelFallback } from "./model-fallback-MWvVmxb8.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-B1Dqrgto.js";
import "./delivery-context-C_WB0-Lw.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BgXXPpNN.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-ALw9K_1_.js";
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-3bCiIMeB.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BxRCUzNV.js";
...
import { t as inferLegacyName } from "./normalize-CZ15kGv1.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-CYKBibC4.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BzHT_VF4.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-C9sjTdgu.js";
import { a as normalizeDurationToClosestMax, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, p as throwCapabilityGenerationFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-Do3mGCXH.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-Dxa1zrTt.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-Dq3flpvi.js";
...
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-DGkSrA_6.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-C6XaaYGs.js";
import { r as getDefaultLocalRoots } from "./local-media-access-TFRY-Xtz.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CFXeNTC2.js";
import { d as listFreshTasksForOwnerKey, h as listTasksForOwnerKey } from "./task-registry-B7WTToIp.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-L0fBJBWD.js";
import "./runtime-internal-MjFqCVxG.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-e4CJgoDP.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CP49lnl9.js";
import { a as hasToolModelConfig$1, n as coerceToolModelConfig, o as resolveDefaultModelRef, r as hasAuthForProvider, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-88VNrykl.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-DT8VG9Q2.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-D4AWU8ej.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-BE4t-I4m.js";
import { a as resolveConfiguredImageModelRefs, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl } from "./image-tool.helpers-JbMu-xcY.js";
import { n as normalizeMediaProviderId } from "./provider-id-BETgOIvU.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DTsE828M.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BH9b30lT.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-7vd0TkAj.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-DGvNSGdr.js";
import { s as resolveTimeoutMs } from "./resolve-p40Ldo9D.js";
import { t as buildProviderRegistry } from "./runner-C5Ktfxri.js";
import "./media-understanding-B0-020fj.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BIqH59mS.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-OSHqD2MM.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BRiY7Pfa.js";
import { a as POLL_CREATION_PARAM_DEFS, i as stripFormattedReasoningMessage, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-qYoVbBt8.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-Bp4adqGg.js";
...
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-mHmaHAcf.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-MNjk8rwD.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-x7vPm8UP.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CUnMI0Oj.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-JMXMH1Tw.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-wDDp28Di.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-CWLMjxsj.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-Dn57JMg0.js";
import { p as registerSubagentRun } from "./subagent-registry-fR03s95p.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-uQS1vbrr.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BHPBPkXK.js";
import { k as textToSpeech } from "./tts-runtime-CU_VhcvN.js";
import "./tts-DOwbfXIU.js";
...
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DUqAf-iG.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BWPoz0BU.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CKU_dkMb.js";
...
import { i as runWebSearch } from "./runtime-CYg2uLOi.js";
import "./web-search-provider-common-DZoZ45yq.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-jZ9TIa8f.js");
		await sendMessage({
			cfg: params.config,
		...
		execute: async (_toolCallId, args) => {
			...
			if (Boolean(taskHandle && options?.agentSessionKey?.trim()) && taskHandle) {
				...
				await notifyMediaGenerationAsyncTaskStarted({
					...
					toolName: "image_generate",
					handle: taskHandle,
					onFailure: (message, meta) => log$5.warn(message, meta)
				});
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			if (Boolean(taskHandle && options?.agentSessionKey?.trim()) && taskHandle) {
				...
				await notifyMediaGenerationAsyncTaskStarted({
					...
					toolName: "music_generate",
					handle: taskHandle,
					onFailure: (message, meta) => log$3.warn(message, meta)
				});
				return buildMediaGenerationStartedToolResult({
					toolName: "music_generate",
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-ZHI51twp.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-Desr3Ja3.js"));
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			if (Boolean(taskHandle && options?.agentSessionKey?.trim()) && taskHandle) {
				...
				await notifyMediaGenerationAsyncTaskStarted({
					...
					toolName: "video_generate",
					handle: taskHandle,
					onFailure: (message, meta) => log$1.warn(message, meta)
				});
				return buildMediaGenerationStartedToolResult({
					toolName: "video_generate",
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-DPdgFkna.js"));
...
//#endregion
export { stripProviderPrefix as A, wrapToolMemoryFlushAppendOnlyWrite as C, resolveOpenClawPluginToolsForOptions as D, sniffMimeFromBase64 as E, setEmbeddedMode as M, isStrictAgenticExecutionContractActive as O, wrapToolMemoryDayFileWriteGuard as S, wrapToolWorkspaceRootGuardWithOptions as T, createHostWorkspaceWriteTool as _, buildActiveMusicGenerationTaskPromptContextForSession as a, createSandboxedReadTool as b, listSupportedMusicGenerationModes as c, normalizeCronJobCreate as d, normalizeCronJobInput as f, createHostWorkspaceEditTool as g, createHostWorkspaceAppendTool as h, triggerSessionPatchHook as i, isEmbeddedMode as j, isStrictAgenticSupportedProviderModel as k, buildActiveImageGenerationTaskPromptContextForSession as l, resolveToolLoopDetectionConfig as m, buildActiveVideoGenerationTaskPromptContextForSession as n, generateMusic as o, normalizeCronJobPatch as p, isParentOwnedBackgroundAcpSession as r, listRuntimeMusicGenerationProviders as s, createOpenClawTools as t, findActiveSessionTask as u, createOpenClawReadTool as v, wrapToolWorkspaceRootGuard as w, createSandboxedWriteTool as x, createSandboxedEditTool as y };
