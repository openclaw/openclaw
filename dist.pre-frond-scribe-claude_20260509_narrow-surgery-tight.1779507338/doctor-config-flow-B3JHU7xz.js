...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-BcE0iOnr.js";
...
import { i as setPathExistingStrict } from "./path-utils-lUqelgFf.js";
import { n as discoverConfigSecretTargets } from "./target-registry-CbwHFC3V.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-BxFubSMj.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { r as normalizeTalkSection } from "./talk-CJDCzAx6.js";
...
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-DLZDi_7U.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BLrzD184.js";
import { n as getLoadedChannelPlugin } from "./registry-BE4M2Iz0.js";
import { i as listRouteBindings } from "./bindings-D1F1bOgs.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, o as listLegacyRuntimeModelProviderAliases, s as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-bVlyEZ4v.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-BKeamB81.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-BvP3tUXg.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-CX7U4cj4.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-C0WGFhEn.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DhYwb0ja.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-CUNHqbn0.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-FLgFPdWr.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DRkPt9xx.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-CIbHJw_v.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-z0F2_D2G.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-Dc3J1YUp.js");
		emitDoctorNotes({
			note,
