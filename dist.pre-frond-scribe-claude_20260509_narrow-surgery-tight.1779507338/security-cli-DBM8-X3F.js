...
import { f as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-BRiY7Pfa.js";
import { t as formatHelpExamples } from "./help-format-DXVAk021.js";
import { t as runSecurityAudit } from "./audit-zXnC2f3N.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-CyXD-QyK.js");
