...
import { c as jsonResult } from "../../common-CrEpgrS0.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-DwjmjGJM.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-C3KaKi-d.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-DpJ4v_NA.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-DNGOrUaq.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-CFHfqwsb.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-UGnCm7hh.js");
