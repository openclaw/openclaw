...
import { b as resolveSubagentModelConfigSelectionResult } from "./agent-scope-DKjUWHDL.js";
import { l as normalizeAgentId } from "./session-key-Bte0mmcq.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-D1eqrBeU.js";
...
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel } from "./thinking-BuSu5uPJ.js";
...
import { t as clearAgentRunContext } from "./agent-events-BuYtWSh4.js";
import { h as stringifyRouteThreadId } from "./channel-route-L2PJ-xNE.js";
import { o as resolveSessionTranscriptPath } from "./paths---FlWJ0A.js";
import { u as setSessionRuntimeModel } from "./types-BgvyBC-3.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-BYPaKMif.js";
import { b as resolveHooksGmailModel, d as normalizeModelSelection, v as resolveConfiguredModelRef } from "./model-selection-shared-D9lGAOqA.js";
import { i as resolveAllowedModelRef, r as getModelRefStatus, t as isCliProvider } from "./model-selection-cli-nQ0b0f0m.js";
...
import { u as isCommandLaneTaskTimeoutError } from "./command-queue-Cc__1ixy.js";
...
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-BWPoz0BU.js";
import { n as resolveCronStyleNow } from "./current-time-DEwZwyQB.js";
import { n as createCronRunDiagnosticsFromError, r as mergeCronRunDiagnostics, t as createCronRunDiagnosticsFromAgentResult } from "./run-diagnostics-uGHzogAO.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-Cf8rKvwT.js";
import { i as persistCronSkillsSnapshotIfChanged, n as createPersistCronSessionEntry, o as resolveCronChannelOutputPolicy, r as markCronSessionPreRun, t as adoptCronRunSessionMetadata } from "./run-session-state-CnVWdwIh.js";
import { a as resolveHeartbeatAckMaxChars, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-BL-OIPr6.js";
import { t as resolveCronAgentSessionKey } from "./session-key-D_ijetg2.js";
import { t as resolveCronSession } from "./session-CRIXzvg5.js";
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-Br-Eew91.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-DSizRJyM.js");
}
...
async function finalizeCronRun(params) {
	...
	let { summary, outputText, synthesizedText, deliveryPayloads, deliveryPayloadHasStructuredContent, hasFatalErrorPayload, hasFatalStructuredErrorPayload, embeddedRunError, pendingPresentationWarningError } = resolveCronPayloadOutcome({
		payloads,
...
function disposeCronRunContext(params) {
	if (params.ownsRunContext) clearAgentRunContext(params.sessionId);
