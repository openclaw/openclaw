...
import { c as parseAgentSessionKey, i as isCronSessionKey } from "./session-key-utils-Ce_xWkNq.js";
import { c as isValidAgentId, l as normalizeAgentId } from "./session-key-Bte0mmcq.js";
import { a as resolveAgentDir, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-D1eqrBeU.js";
...
import { p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-BuSu5uPJ.js";
import "./config-FC9eV8ec.js";
import "./operator-scopes-DGvgHuOd.js";
import { r as isAdminOnlyMethod } from "./method-scopes-D4RcH8qD.js";
...
import { i as mergeDeliveryContext, o as normalizeDeliveryContext } from "./delivery-context.shared-ubhMwJVk.js";
...
import { p as resolveSubagentSpawnModelSelection } from "./model-selection-BSyRhVPt.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BcmC9MbZ.js";
import { u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CDMfe5qT.js";
import { a as resolveSubagentCapabilities, f as inheritedToolAllowPatch, h as normalizeInheritedToolDenylist, m as normalizeInheritedToolAllowlist, p as inheritedToolDenyPatch, s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-DbXbcB4m.js";
import { a as normalizeSpawnedRunMetadata, i as mapToolContextToSpawnedRunMetadata, r as resolveSubagentTargetPolicy, s as resolveSpawnedWorkspaceInheritance, t as resolveRequesterOriginForChild } from "./spawn-requester-origin-CR2GrkTf.js";
import { n as countActiveRunsForSession, r as registerSubagentRun } from "./subagent-registry-spawn-runtime-CGrNy_Rc.js";
import { c as resolveMainSessionAlias, o as resolveDisplaySessionKey, s as resolveInternalSessionKey } from "./sessions-helpers-BkXNVypB.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-CyCjvPeP.js";
import { t as ensureContextEnginesInitialized } from "./init-CLbuTZJz.js";
import { m as resolveGatewaySessionStoreTarget, u as pruneLegacyStoreKeys } from "./session-utils-Bm52LcEr.js";
...
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-CNUTzKrg.js";
...
async function spawnSubagentDirect(params, ctx) {
	...
	let childSystemPrompt = buildSubagentSystemPrompt({
		...
		toolNames: (() => {
			const names = [];
			if (cfg.agents?.defaults?.continuation?.enabled === true) names.push("continue_work");
			if (params.drainsContinuationDelegateQueue === true && childDepth < maxSpawnDepth && !cfg.tools?.subagents?.tools?.deny?.includes("continue_delegate")) names.push("continue_delegate");
