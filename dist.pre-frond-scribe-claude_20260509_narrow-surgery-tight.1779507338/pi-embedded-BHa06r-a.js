...
import { o as resolveAgentExecutionContract, r as hasConfiguredModelFallbacks, v as resolveSessionAgentIds } from "./agent-scope-DKjUWHDL.js";
...
import { i as isMarkdownCapableMessageChannel } from "./message-channel-D8iFykAD.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-awNPCchy.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime, u as resolveSelectedOpenAIPiRuntimeProvider } from "./openai-codex-routing-qNSGkXbB.js";
...
import { Y as resolveProviderAuthProfileId, b as prepareProviderRuntimeAuth } from "./provider-runtime-B3-FaHxM.js";
...
import { n as markAuthProfileSuccess } from "./profiles-CorIBNhJ.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-BZKJ_iPF.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-c8bIQKoC.js";
...
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-Ddo16QWA.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared-cdTr1v5l.js";
import { i as getApiKeyForModel, n as applyLocalNoAuthHeaderOverride, p as shouldPreferExplicitConfigApiKeyAuth, t as applyAuthHeaderOverride } from "./model-auth-X07O9eQq.js";
import "./runs-CkOGrSum.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CuUvHfKt.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BmuX9QbQ.js";
...
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-Dc7B13Zv.js";
...
import { C as createEmbeddedRunStageTracker, Ct as shouldTreatEmptyAssistantReplyAsSilent, S as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, St as resolveSilentToolResultReplyPayload, T as shouldWarnEmbeddedRunStageSummary, Tt as observeReplayMetadata, _ as resolveRateLimitProfileRotationLimit, _t as resolvePlanningOnlyRetryInstruction, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, at as sessionLikelyHasOversizedToolResults, b as createUsageAccumulator, bt as resolveReplayInvalidFlag, c as buildErrorAgentMeta, d as resolveActiveErrorContext, dt as STRICT_AGENTIC_BLOCKED_TEXT, f as resolveFinalAssistantRawText, ft as extractPlanningOnlyPlanDetails, g as resolveOverloadProfileRotationLimit, gt as resolveIncompleteTurnPayloadText, h as resolveOverloadFailoverBackoffMs, ht as resolveEmptyResponseRetryInstruction, i as selectAgentHarness, it as resolveLiveToolResultMaxChars, l as buildUsageAgentMetaFields, m as resolveMaxRunRetryIterations, mt as resolveAttemptReplayMetadata, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, ot as truncateOversizedToolResultsInSession, p as resolveFinalAssistantVisibleText, pt as resolveAckExecutionFastPathInstruction, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, u as createCompactionDiagId, v as resolveReportedModelRef, vt as resolvePlanningOnlyRetryLimit, w as formatEmbeddedRunStageSummary, wt as createEmbeddedRunReplayState, x as mergeUsageIntoAccumulator, xt as resolveRunLivenessState, y as scrubAnthropicRefusalMagic, yt as resolveReasoningOnlyRetryInstruction } from "./selection-09xSYXB4.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-CemEI13Y.js";
import { O as isStrictAgenticExecutionContractActive, m as resolveToolLoopDetectionConfig } from "./openclaw-tools-HooJv9O2.js";
import { _ as buildAgentHookContextChannelFields, g as listActiveProcessSessionReferences, h as resolveContextEngineCapabilities, p as buildEmbeddedCompactionRuntimeContext, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-C4Cttjbk.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-B4djHBn2.js";
import { c as resolveFailoverStatus, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-BE-soLvS.js";
import { c as retireSessionMcpRuntimeForSessionKey, s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-BDuxOMhN.js";
import "./pi-bundle-mcp-tools-D2wcwpyn.js";
import { d as hasOutboundDeliveryEvidence, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-BIBysQmu.js";
import { a as resolveCompactionTimeoutMs, f as runAgentCleanupStep, r as compactContextEngineWithSafetyTimeout } from "./attempt.tool-run-context-Bdqo6ZlY.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-D8GbzGE5.js";
...
import { a as suspendSession, c as shouldAllowCooldownProbeForReason, d as shouldSuppressRawErrorConsoleSuffix, i as resolveSessionSuspensionReason, l as buildApiErrorObservationFields, o as LiveSessionModelSwitchError } from "./model-fallback-MWvVmxb8.js";
import { t as log$1 } from "./logger-CKkIRAq_.js";
import "./tool-split-BmLeck_B.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-BrQRlRRS.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-7eAjpcL2.js";
import { c as runContextEngineMaintenance } from "./context-engine-lifecycle-C5i1DBFD.js";
import "./extra-params-BFxxUlW-.js";
...
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-EiPnoy6x.js";
...
import "./compact.queued-B4hPP4Cj.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-Bm9izLd4.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-DJWdL-_I.js";
