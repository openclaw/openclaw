...
import { CONTINUATION_DELEGATE_FANOUT_MODES, hasContinuationDelegateTargeting, normalizeContinuationTargetKey, normalizeContinuationTargetKeys } from "./targeting-pure.js";
import type { ContinuationDelegateFanoutMode, ContinuationDelegateTargeting } from "./targeting-pure.js";
export { CONTINUATION_DELEGATE_FANOUT_MODES, hasContinuationDelegateTargeting, normalizeContinuationTargetKey, normalizeContinuationTargetKeys, };
