...
import { u as readConfigFileSnapshot } from "./io-C04VWQdx.js";
import "./config-Dk0DnRek.js";
import { n as extractAssistantText } from "./pi-embedded-utils-BLz0Bp-T.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-beDLnAAw.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-B302OyDW.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-DY4wD8p4.js")).runEmbeddedPiAgent;
}
