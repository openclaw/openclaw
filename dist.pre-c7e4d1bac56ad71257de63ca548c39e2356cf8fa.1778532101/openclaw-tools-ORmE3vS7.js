...
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-CcybJBoN.js";
...
import { a as normalizeDiagnosticTraceparent, t as DIAGNOSTIC_TRACEPARENT_PATTERN } from "./diagnostic-trace-context-pure-Byh51juu.js";
import "./diagnostic-trace-context-Bw2CWPVX.js";
import { t as createSubsystemLogger } from "./subsystem-DNg_cpPU.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-BHVmraBM.js";
import { t as logDebug } from "./logger-M-PaInRe.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-C04VWQdx.js";
import { t as isWindowsDrivePath } from "./archive-path-In2I99BE.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-EW2E3K3c.js";
import { t as applyMergePatch } from "./merge-patch-DtT1pLss.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-Dmp4nHnj.js";
...
import { t as isInboundPathAllowed } from "./inbound-path-policy-DV7uVvBt.js";
import "./config-Dk0DnRek.js";
import { n as isRestartEnabled } from "./commands.flags-DX9TfTWP.js";
import { o as normalizeChannelId } from "./registry-GJ8Za_ud.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-C_DWi525.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-C3OkJjey.js";
import { u as normalizeMessageChannel } from "./message-channel-qkYXfTa4.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-cTv8W9zW.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-CP-_Moom.js";
import { i as callGateway } from "./call-2XfkAkrz.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-ky-rASNw.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-C5sNgq2P.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-NWmMKpmM.js";
import { a as resolveSessionFilePath, d as resolveStorePath, o as resolveSessionFilePathOptions } from "./paths-Dai9rPIo.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-D2KgAVG4.js";
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-CREfM4qQ.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-vjc31mTI.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BRFlTCK3.js";
import { n as mergeSessionEntry } from "./types-BKq924Jk.js";
import { o as updateSessionStore } from "./store-L0DKoc8m.js";
import "./plugins-B_QXrzEj.js";
import { a as extractDeliveryInfo } from "./sessions-vUaNmv0h.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-QoyUXw0b.js";
import { S as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, x as modelKey } from "./model-selection-shared-BQtX8Bw-.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-CyWx9aXc.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-C_7lXXBC.js";
import "./auth-profiles-BwVGW7W3.js";
import { n as listProfilesForProvider } from "./profile-list-DOXb6axb.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-UR3WAxL9.js";
import { r as getApiKeyForModel } from "./model-auth-4K4rXeIE.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-CZfjbXAX.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Bc-KW4uH.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-CLispquW.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-CXqu3mYL.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-hG-lV5hG.js";
import { n as ensureOpenClawModelsJson } from "./models-config-qVmisVfo.js";
import { r as loadModelCatalog } from "./model-catalog-D50ZQj_F.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-BOZxmRTY.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-D5OxNbbl.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-tlr9rGev.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CGSVjhta.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CQCEkYD5.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Cvi-VjlK.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-B5U7sA7f.js";
import { n as extractTextFromChatContent } from "./chat-content-DA_W1N9k.js";
import { r as stripToolMessages } from "./chat-history-text-qTL85T3P.js";
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-X9w5LSlN.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DXu61ldU.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-C_kutp55.js";
import { D as textToSpeech } from "./tts-runtime-C-sLqX9f.js";
import "./tts-D96XxHUA.js";
import { a as getImageMetadata } from "./image-ops-C9ZeTmtk.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-D2g6FBLu.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-CiDMCezP.js";
import { c as wrapToolWithBeforeToolCallHook, d as listAllChannelSupportedActions, o as isToolWrappedWithBeforeToolCallHook, p as listChannelSupportedActions } from "./pi-tools.before-tool-call-B3h4zwpd.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-DFw1jlef.js";
import { t as SsrFBlockedError } from "./ssrf-D9lCgUAx.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Doen4xTo.js";
import { n as extractAssistantText } from "./pi-embedded-utils-BLz0Bp-T.js";
import { n as runWithImageModelFallback } from "./model-fallback-j3H3RQoz.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-Kdbe_DRo.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-CqwERhgW.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-CBGKPeLg.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-B5LBJss6.js";
import { n as assertSandboxPath } from "./sandbox-paths-D6sClj4B.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-ucJFH_LS.js";
...
import "./delivery-context-fXqAQ9-N.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BjmmBRUl.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-mu0ezyK2.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-DHa1pq4e.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-Djs0drUr.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-OPcpROlp.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-CZRTe72D.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DMYZjw6p.js";
import { i as resolveMaxDelegatesPerTurn } from "./config-D9MPOF2I.js";
import "./targeting-DFUCVhIS.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-CXooQL49.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-CdPlTsRW.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CWx_ch9F.js";
import { t as inferLegacyName } from "./normalize-u34U85eB.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-CMO6X7B3.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-mMW0kT--.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-FtqKcMWm.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BTRUx5Kl.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CTMD5JFi.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-kSnx5ps4.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CBceouB7.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DtaHfg6q.js";
import { l as saveMediaBuffer } from "./store-01IWlzZ-.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-BkA0_AwO.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CSJcyrLp.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-aYr9bnRc.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BdOR2e-9.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CQKgewfq.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-BHtwSGVy.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-95RcaGOq.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-C3QiU4p1.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-m0vkde72.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BGsRnS3b.js";
import { s as resolveTimeoutMs } from "./resolve-CJyVv-LK.js";
import { t as buildProviderRegistry } from "./runner-JD3lgIKp.js";
import "./media-understanding-CGeZLYSm.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CeIfxyYO.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-BGxwYXmS.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-nsOwblXq.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-DBQJH8eB.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-D4niipFZ.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-BhBJ1nqH.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-C4Wxl500.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-BaGIstgn.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-NIpil9YH.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Cm67ElxW.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-cCYtb36U.js";
import { t as parseTimeoutMs } from "./parse-timeout-CPz8P_ZJ.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-CjtpC-vC.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-D48g_2g-.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CMYwAyLa.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-BuqheXaY.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-C1k7oEva.js";
import { p as registerSubagentRun } from "./subagent-registry-Dj8pxzAb.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DSYGHgX1.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BREn9jwj.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-4foYKxOZ.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-DlLD24lT.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-D4Ag8cdu.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BD1GtMby.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-BnUC8V5w.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-DwAYxsaW.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-CF-8FLrz.js";
import { i as runWebSearch } from "./runtime-_dGWIfBB.js";
import "./web-search-provider-common-a8j5wNKI.js";
...
const log$7 = createSubsystemLogger("continuation/delegate-tool");
...
const ContinueDelegateToolSchema = Type.Object({
	...
	attachments: Type.Optional(Type.Array(Type.Object({
		name: Type.String({ description: "Attachment filename to materialize into the spawned delegate workspace. Must be a single basename." }),
		content: Type.String({ description: "Inline attachment contents. Use encoding='base64' for binary data; contents are redacted from persisted transcripts." }),
		encoding: Type.Optional(optionalStringEnum(["utf8", "base64"], { description: "Attachment content encoding. Defaults to utf8." })),
		mimeType: Type.Optional(Type.String({ description: "Optional attachment media type." }))
	}), {
		maxItems: 50,
		description: "Inline attachments to snapshot by value into the delegate workspace. Same safety limits as sessions_spawn."
	})),
	attachAs: Type.Optional(Type.Object({ mountPath: Type.Optional(Type.String({ description: "Mount-point hint shown to the delegate. Attachments are materialized into the workspace." })) }))
});
...
function readInlineAttachmentsParam(params) {
	const raw = readSnakeCaseParamRaw(params, "attachments");
	if (raw === void 0) return;
	if (!Array.isArray(raw)) throw new ToolInputError("attachments must be an array of inline attachment objects.");
	return raw;
}
function readAttachAsParam(params) {
	const raw = readSnakeCaseParamRaw(params, "attachAs");
	if (raw === void 0) return;
	if (!raw || typeof raw !== "object" || Array.isArray(raw)) throw new ToolInputError("attachAs must be an object with optional mountPath.");
	const mountPath = readStringParam$1(raw, "mountPath");
...
function createContinueDelegateTool(opts) {
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			log$7.debug(`[continue_delegate:enqueue] session=${sessionKey} mode=${mode} delayMs=${delayMs} fanoutMode=${fanoutMode ?? "none"} targets=${targetSessionKeys?.length ?? (targetSessionKey ? 1 : 0)} task=${task.slice(0, 80)}`);
...
const log$6 = createSubsystemLogger("continuation/continue-work");
...
function createContinueWorkTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			log$6.debug(`[continue_work:request] session=${sessionKey} delaySeconds=${delaySeconds} reason=${reason.slice(0, 80)}`);
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-XwtLQnts.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-UXioWZW9.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-DuUKmI4O.js"));
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-jixn8OGE.js"));
...
//#endregion
export { stripProviderPrefix as C, isStrictAgenticSupportedProviderModel as S, setEmbeddedMode as T, wrapToolMemoryFlushAppendOnlyWrite as _, normalizeCronJobCreate as a, resolveOpenClawPluginToolsForOptions as b, resolveToolLoopDetectionConfig as c, createHostWorkspaceWriteTool as d, createOpenClawReadTool as f, wrapToolMemoryDayFileWriteGuard as g, createSandboxedWriteTool as h, listRuntimeMusicGenerationProviders as i, createHostWorkspaceAppendTool as l, createSandboxedReadTool as m, isParentOwnedBackgroundAcpSession as n, normalizeCronJobInput as o, createSandboxedEditTool as p, generateMusic as r, normalizeCronJobPatch as s, createOpenClawTools as t, createHostWorkspaceEditTool as u, wrapToolWorkspaceRootGuard as v, isEmbeddedMode as w, isStrictAgenticExecutionContractActive as x, wrapToolWorkspaceRootGuardWithOptions as y };
