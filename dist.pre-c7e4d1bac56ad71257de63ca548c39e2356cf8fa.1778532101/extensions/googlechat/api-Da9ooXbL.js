...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "../../ssrf-policy-DtOyW3pK.js";
import "../../ssrf-runtime-Cup62pw7.js";
import "./runtime-api-CchxstIG.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("../../src-BlrQRknx.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../src-D2KjuR-x.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
			return {
