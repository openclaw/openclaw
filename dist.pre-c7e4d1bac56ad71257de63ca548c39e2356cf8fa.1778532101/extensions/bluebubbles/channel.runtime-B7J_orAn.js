...
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "../../webhook-request-guards-CLob3mYw.js";
import { t as normalizeWebhookPath } from "../../webhook-path-DeMj1syA.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "../../webhook-targets-qzHIc_0-.js";
import "../../security-runtime-DiXnHkF3.js";
import "../../string-coerce-runtime-DdUmJDgy.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-CgEZdzvn.js";
import "./secret-input-O0PpiIJK.js";
import { t as getBlueBubblesRuntime } from "./runtime-0m_O8oDo.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-DvYxYGUU.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-CtOxOGhB.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-Ds0tFu6l.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-GIDiOJQ6.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
