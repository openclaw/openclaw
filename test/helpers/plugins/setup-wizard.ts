...
export function createTestWizardPrompter(
...
type SetupWizardAdapterParams = Parameters<
	typeof buildChannelSetupWizardAdapterFromSetupWizard
>[0];
...
function resolveSetupWizardNotePrompter(
...
export async function resolveSetupWizardAllowFromEntries<
	TCfg,
	TResult,
>(params: {
	resolveEntries?: (args: {
