import { getDatabaseWorkerExtensionTestIncludePatterns } from "./vitest.extension-database-workers-paths.mjs";
...
export function createExtensionDatabaseWorkersVitestConfig(
  ...
  return createScopedVitestConfig(getDatabaseWorkerExtensionTestIncludePatterns(), {
    dir: "extensions",
    env,
