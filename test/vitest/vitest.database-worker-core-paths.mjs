...
export const databaseWorkerCoreTestFiles = [
  ...
  // Durable follow-up queue storage runs on the host-owned shared-state worker,
  // so its consumers need the forked broker instead of a worker thread.
  "src/agents/sessions/agent-session-handoff-adoption.integration.test.ts",
  "src/agents/subagents/registry/subagent-control.test.ts",
  "src/agents/subagents/registry/subagent-reset.lifecycle.test.ts",
  ...
  "src/auto-reply/reply/queue.collect-transcript.test.ts",
  "src/auto-reply/reply/queue.collect.test.ts",
  "src/auto-reply/reply/queue.dedupe-durable-failure.test.ts",
  "src/auto-reply/reply/queue.dedupe.test.ts",
  "src/auto-reply/reply/queue.drain-restart.persist.test.ts",
  "src/auto-reply/reply/queue.drain-restart.test.ts",
  "src/auto-reply/reply/queue.followup-delivery-discard.test.ts",
  "src/auto-reply/reply/queue.followup-restart-exec-policy.test.ts",
  "src/auto-reply/reply/queue.followup-restart-roundtrip.test.ts",
  "src/auto-reply/reply/queue.followup-restart-session-policy.test.ts",
  "src/auto-reply/reply/queue.in-flight.test.ts",
  "src/auto-reply/reply/queue.media-carrier.test.ts",
  "src/auto-reply/reply/queue.pending-inputs.test.ts",
  "src/auto-reply/reply/queue.personal-bootstrap-overflow.test.ts",
  "src/auto-reply/reply/queue.personal-bootstrap.test.ts",
  "src/auto-reply/reply/queue/cleanup.session-authority.test.ts",
  "src/auto-reply/reply/queue/cleanup.test.ts",
  "src/auto-reply/reply/queue/drain.identity-guard.test.ts",
  "src/auto-reply/reply/queue/persist.custody.test.ts",
  "src/auto-reply/reply/queue/persist.residual-caller.test.ts",
  "src/auto-reply/reply/queue/persist.restore-exec-policy.test.ts",
  "src/auto-reply/reply/queue/persist.restore-guards.test.ts",
  "src/auto-reply/reply/queue/persist.restore-identity.test.ts",
  "src/auto-reply/reply/queue/persist.restore-session-authority.test.ts",
  "src/auto-reply/reply/queue/persist.test.ts",
  "src/auto-reply/reply/queue/persist.tool-policy-restore.test.ts",
  ...
  "src/commands/models/auth-api-key.test.ts",
  "src/gateway/chat-queued-turns.test.ts",
  "src/gateway/server-methods/chat-pending-inputs.test.ts",
  "src/gateway/server-methods/progress-card-refresh.queued.test.ts",
  "src/gateway/server-methods/sessions-rewind.test.ts",
  "src/gateway/server-methods/sessions.abort-agent-scope.test.ts",
  "src/gateway/server-methods/sessions.abort-queue-authority.test.ts",
  "src/gateway/server-methods/sessions.abort-yielded.test.ts",
  "src/gateway/server/ws-connection/authenticated-request-dispatch.mutation-authority.test.ts",
  "src/logging/diagnostic-stuck-session-followup-recovery.integration.test.ts",
];
