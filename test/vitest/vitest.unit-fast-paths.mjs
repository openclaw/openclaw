...
const statefulTestHelperImportPattern =
  /(?:\bfrom\s+|\bimport\s+)["']([^"']*(?:test-support|\.harness|\.test-mocks|prepared-model-runtime\.test-harness|message-action-runner\.test-helpers|computer-tool\.test-helpers)(?:\.js|\.ts)?)["']/gu;
