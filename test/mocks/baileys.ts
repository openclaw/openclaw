...
export function mockNormalizeMessageContent(
...
export function mockGetContentType(
	message: MessageContentInput,
): MessageContentType {
...
export function mockExtractMessageContent(
	message: MessageContentInput,
): MessageContentOutput {
	const normalized = mockNormalizeMessageContent(message);
	if (!normalized || typeof normalized !== "object") {
...
export function createMockBaileys(): {
	...
	const mod: MockBaileysModule = {
		...
		getContentType: vi.fn<GetContentTypeFn>((message) =>
