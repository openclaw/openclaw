...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-B7Gl_3a6.js";
...
import { i as resolveManifestContractOwnerPluginId, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-giqGaBJo.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-s7xwYk1t.js";
...
import { n as modelKey } from "./model-ref-shared-BFiFeBhs.js";
import { t as applyMergePatch } from "./merge-patch-CfIV4Y-C.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-XI6kh6r8.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-B_OAjFj2.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-BlKm_Gw6.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-SyUWwFMs.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-CjfUlKb5.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CzW8tQZJ.js";
import { n as assertSandboxPath } from "./sandbox-paths-BzrLd8AE.js";
import "./local-file-access-DRAB2mQA.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-Dump4QO5.js";
import { h as stringifyRouteThreadId } from "./channel-route-vpaTrtym.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-etu5OJV7.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-789ECJN2.js";
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BRLw4_SR.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-C-gssWwS.js";
...
import { n as mergeSessionEntry } from "./types-CmPL5zcY.js";
import { u as extractDeliveryInfo } from "./sessions-Ct_pHdrL.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-B9SCuRKX.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DrNAJwj9.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-Bd49BLni.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-DeF75Ytd.js";
...
import { r as getApiKeyForModel } from "./model-auth-CWuFZQFj.js";
...
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CpP268Wb.js";
import "./tool-policy-2a4iBmpL.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-B5Ctmu01.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-BI3E_afW.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BMDeMm5u.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-CvXRducC.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CR-u9n7K.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-QNHaZNPy.js";
...
import { r as stripToolMessages } from "./chat-history-text-CwGZaV-h.js";
...
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-CEEDZAwT.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-ZJYncsRS.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-DDxwjuCx.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-CdtDWpTo.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-2q03qiGF.js";
import { l as formatActiveContinuationTraceparent } from "./continuation-tracer-DFGjjapO.js";
import "./targeting-DWeDzxZ5.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BBKN81VW.js";
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-Bfj_UQN-.js";
import { t as canonicalizeBase64 } from "./base64-Bri7OZJq.js";
import { a as getImageMetadata } from "./image-ops-CZ-pZf1L.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BUzacBuR.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-BDUbdJKj.js";
import { a as resolvePluginTools } from "./tools-IOz5rfvk.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DjG-AkuX.js";
import { d as wrapToolWithBeforeToolCallHook, g as listChannelSupportedActions, l as isToolWrappedWithBeforeToolCallHook, m as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-bCTtQV1p.js";
...
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-DnBUyMfY.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-GyV-X4ME.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Crodck_P.js";
import { n as extractAssistantText } from "./pi-embedded-utils-ChdBOKxX.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-GG7DwbUw.js";
import { n as runWithImageModelFallback } from "./model-fallback-B3DzDitP.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DKSRgDIY.js";
import "./delivery-context-CHrDmWDr.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-C-EMQOfo.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-C8gcyAL-.js";
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-DlZGD1RO.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-ByKLRDAh.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-dAI1Qr16.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BydPNDng.js";
import { t as inferLegacyName } from "./normalize-CD8hCfPV.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-C-Lub8W6.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CAabiHYN.js";
import { r as parseImageGenerationModelRef } from "./provider-registry--NjqUueV.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CV0QUYZk.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-Cqy4Vk7l.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BkqqUBkg.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-C7izeE-D.js";
import { u as saveMediaBuffer } from "./store-Uc5kTVit.js";
import { t as SsrFBlockedError } from "./ssrf-59X4Akdy.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-CjwZ3waA.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-D_VHFANi.js";
import { r as getDefaultLocalRoots } from "./local-media-access-BtGiFUmk.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CdmKP8Jc.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-A3-c7UzA.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-wEJEYPUU.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-OnQhJQHQ.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DxacOe24.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-mCndmNvV.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-DHp98cAT.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CrBdLXQ7.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-Bsvfgx77.js";
import { n as normalizeMediaProviderId } from "./provider-id-BxuTIcOV.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-2chO8FKw.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BCKoz-R9.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-DtBGDFqO.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-C9fp2BNM.js";
import { s as resolveTimeoutMs } from "./resolve-DBBXQ3Kz.js";
import { t as buildProviderRegistry } from "./runner-DZg0ZzM3.js";
import "./media-understanding-BtkhiOMl.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-f6HmGFOf.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-ttPPcM3-.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CE6wOG9Z.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-BTsD9THi.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-ivb0t81m.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-rtTvagW2.js";
import { t as parseTimeoutMs } from "./parse-timeout-B9sDLl5n.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-BaoKZ39b.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-nA6M_1ws.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-HufNH0MY.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-Bk0v4N8c.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BqLyDqal.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-UAiygz_v.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-BZ94qGVc.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-Coh_KKX1.js";
import { p as registerSubagentRun } from "./subagent-registry-BhmeZiZg.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DMyPmTKL.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-Dbh9--Cl.js";
import { k as textToSpeech } from "./tts-runtime-C_6M-vCL.js";
import "./tts-DAXIJwc7.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-BWuNJYVG.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-D1RTZBu1.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BgHhFzDD.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-Pu5JHFut.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-BmU8uedh.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-Dc8RtOak.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-BMLzbK-b.js";
import { i as runWebSearch } from "./runtime-hjKIhhmq.js";
import "./web-search-provider-common-DDqe77WZ.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-BEKCKanD.js");
		await sendMessage({
			cfg: params.config,
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-BiU8Wjl-.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-DMzw2S4X.js"));
