...
import { _ as mergeTransportHeaders, b as transformTransportMessages, f as coerceTransportToolCallArguments, g as finalizeTransportStream, h as failTransportStream, m as createWritableTransportEventStream, p as createEmptyTransportUsage, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-CJivtBjh.js";
import { _ as stripInvalidGoogleThinkingBudget, d as isGoogleGemini3ProModel, h as resolveGoogleGemini3ThinkingLevel, l as isGoogleGemini25ThinkingBudgetModel, u as isGoogleGemini3FlashModel } from "./provider-stream-shared-BHWz2mTn.js";
import "./string-coerce-runtime-CvivoIwv.js";
import "./provider-http-DWI7l03V.js";
import "./provider-transport-runtime-C_Jlpuo2.js";
import "./thinking-api-RAS8zp3d.js";
import { r as normalizeGoogleApiBaseUrl } from "./provider-policy-ji0eCJyk.js";
import { t as parseGeminiAuth } from "./gemini-auth-WyrJQv2e.js";
import { i as resolveGoogleVertexAuthorizedUserHeaders, n as isGoogleVertexCredentialsMarker } from "./vertex-adc-kHnzzTh4.js";
...
function sanitizeGeminiToolCallThoughtSignature(thoughtSignature) {
			...
			for (const block of msg.content) {
				if (block.type === "text") {
					...
					parts.push({
						...
						...isSameRoute && block.textSignature ? { thoughtSignature: block.textSignature } : {}
					});
					continue;
				}
				if (block.type === "thinking") {
					if (!block.thinking.trim()) continue;
					if (isSameRoute) parts.push({
						thought: true,
				...
				if (block.type === "toolCall") {
					...
					const ownSignature = isSameRoute ? sanitizeGeminiToolCallThoughtSignature(block.thoughtSignature) : void 0;
