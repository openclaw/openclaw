...
import { m as readProviderJsonResponse } from "./provider-http-errors-B_WM1-eK.js";
import "./string-coerce-runtime-CvivoIwv.js";
import "./secret-input-DAh6PHcY.js";
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-zPYbwwrl.js";
import "./ssrf-runtime-BDi9tXcb.js";
import "./security-runtime-ts295BWx.js";
import "./provider-http-DWI7l03V.js";
import { t as getMSTeamsRuntime } from "./runtime-api-CK7nCfqi.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-pr1so8Ed.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-C4f_vPoz.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CYwGXyER.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DS8g1UBt.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-CumHXmsz.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
