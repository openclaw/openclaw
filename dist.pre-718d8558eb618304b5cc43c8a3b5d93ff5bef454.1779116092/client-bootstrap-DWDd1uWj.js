...
import { t as getActiveMatrixClient } from "./active-client-CQhE_Epn.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CxLrA_mi.js"), import("./shared-D0o2sdSa.js")]).then(([clientModule, sharedModule]) => ({
