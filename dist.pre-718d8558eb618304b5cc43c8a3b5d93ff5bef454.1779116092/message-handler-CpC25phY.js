...
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-DDj6lESn.js";
...
import { c as GATEWAY_STARTUP_PENDING_CLOSE_CAUSE, d as buildDeviceAuthPayloadV3, l as gatewayStartupUnavailableDetails, o as GATEWAY_STARTUP_CLOSE_CODE, s as GATEWAY_STARTUP_CLOSE_REASON, u as buildDeviceAuthPayload } from "./client-BwIz3SA1.js";
...
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-CopRe_fC.js";
import "./version-1aMNfFel.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-D5DA_QCa.js";
import "./method-scopes-DfV0ICXA.js";
import { l as roleScopesAllow } from "./pairing-token-CLC5PJ34.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-C2I8IXA1.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-9qXxYaFu.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-DFmpBoLJ.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-DYeQWwzX.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-D7olCQ_J.js";
import { n as logWs, t as formatForLog } from "./ws-log-H4eQPZMm.js";
import { a as restoreDeviceBootstrapToken, c as verifyDeviceBootstrapToken, i as redeemDeviceBootstrapTokenProfile, n as getDeviceBootstrapTokenProfile, o as revokeDeviceBootstrapToken } from "./device-bootstrap-SjJT44Bi.js";
import { _ as verifyDeviceToken, c as listDevicePairing, f as requestDevicePairing, g as updatePairedDeviceMetadata, i as getPairedDevice, l as listEffectivePairedDeviceRoles, n as ensureDeviceToken, o as hasEffectivePairedDeviceRole, s as listApprovedPairedDeviceRoles, t as approveDevicePairing } from "./device-pairing-D06Zd_gH.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-DwZDXS_g.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-BVc738ca.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-DR-XtjRM.js";
import { r as upsertPresence } from "./system-presence-4Hd1Z-PG.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-DhHIN2YQ.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CaZb5Uzp.js";
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-q4EmPZ2N.js");
