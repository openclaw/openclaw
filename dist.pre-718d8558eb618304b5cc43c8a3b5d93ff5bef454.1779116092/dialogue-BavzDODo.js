import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BoBU7efr.js";
import { r as loadCrestodianOverview } from "./overview-CLXHo89U.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-PYcRZ-FM.js")).planCrestodianCommand)({
		input,
		overview
	});
