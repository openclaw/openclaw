...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-DQ08bxZ3.js";
import "./client-16vm1ZCH.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-D_-FldLB.js";
import { c as parseIMessageTarget } from "./targets-DvP3L8VH.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-yO3IaPGl.js";
import "./probe-DFPHRZce.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-CmvCufg6.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-YwxFlYdG.js");
