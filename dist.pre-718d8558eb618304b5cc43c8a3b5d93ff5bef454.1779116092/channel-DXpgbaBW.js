...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-CrxOGRJy.js";
import { _ as readStringParam, a as createActionGate, n as ToolAuthorizationError, p as readNumberParam } from "./common-DnBUyMfY.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-CsphHypk.js";
import "./string-coerce-runtime-CvivoIwv.js";
import { n as describeAccountSnapshot } from "./account-helpers-kl0tMoYW.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-CwZibVgb.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-BSbJPGGu.js";
import "./channel-core-Ore2eN-M.js";
import "./routing-BLb44SmR.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-BdE7sbCm.js";
...
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-DOfmplba.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-BVtFB-zA.js";
...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-CWIOr84Y.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-D8yi7ptS.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DoFEa01y.js";
...
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-BmUV1YSf.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-B9cZqSAE.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-Bsr13OpT.js";
import { a as resolveMatrixAccountConfig } from "./account-config-mB2kTDE1.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-D_AX-wV5.js";
import { n as normalizeMatrixUserId } from "./allowlist-BgHar2M6.js";
import { t as normalizeMatrixApproverId } from "./approval-ids--YYnUEfV.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-DZUGqkZS.js";
import { t as formatMatrixErrorMessage } from "./errors-BiU177m4.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-zeNSdIRR.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-Bta-eBJv.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-yoVHBKqU.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-D665Q7EZ.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-BJNyNBGr.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-CHhie-Wz.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-4o-jwQ5F.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-BdysiQtR.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-CnBNdiXq.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-BrqQ6boh.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-wwumBrAS.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-DxOfw-5z.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-DxOfw-5z.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-1jvrrwPV.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
