...
import { a as routeLogsToStderr } from "./console-BhchURxA.js";
import { t as resolveCliCommandPathPolicy } from "./command-path-policy-DM1tJpYr.js";
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CqAB14C0.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-D53RtPTZ.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-DI-Th-8m.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BhF_4OH5.js");
	if (params.argv) {
