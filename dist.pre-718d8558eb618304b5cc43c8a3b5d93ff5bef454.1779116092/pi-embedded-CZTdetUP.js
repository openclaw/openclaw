...
import { o as resolveAgentExecutionContract, r as hasConfiguredModelFallbacks, v as resolveSessionAgentIds } from "./agent-scope-B7Gl_3a6.js";
...
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-YuMV2PLT.js";
...
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime, u as resolveSelectedOpenAIPiRuntimeProvider } from "./openai-codex-routing-DQX5R6b3.js";
...
import { s as emitAgentPlanEvent } from "./agent-events-CzW8tQZJ.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-D2GieUdK.js";
import { X as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-DrNAJwj9.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CMEB4ZMP.js";
import { n as sleepWithAbort } from "./backoff-GJF0X7y_.js";
import "./auth-profiles-Dw7U55Mv.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-J-IZw7on.js";
import { t as markAuthProfileSuccess } from "./profiles-B0FrvxkJ.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-Q8oB6bbT.js";
import { t as redactIdentifier } from "./redact-identifier-DytL1qGX.js";
import { t as sanitizeForConsole } from "./console-sanitize-Ci4BzqkT.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-DttwImTw.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared--Gu-BVM4.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-CWuFZQFj.js";
import "./runs-BOMfzUwh.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-xfd465ce.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DOWI15tv.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-CtI5YY4c.js";
import { t as ensureContextEnginesInitialized } from "./init-vOdqtLIl.js";
import { n as ensureOpenClawModelsJson } from "./models-config-mP7zJeIt.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-BQ1hPeyh.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-2q03qiGF.js";
...
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-CcSfwRhc.js";
import { a as formatAssistantErrorText, b as parseImageSizeError, c as isBillingAssistantError, f as isFailoverAssistantError, h as isRateLimitAssistantError, i as extractObservedOverflowTokenCount, m as isLikelyContextOverflowError, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, y as parseImageDimensionError } from "./errors-yWJmaeJp.js";
import { a as copyReplyPayloadMetadata, d as setReplyPayloadMetadata, o as getReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-bhQ8Bfcq.js";
import { a as hasReplyPayloadContent } from "./payload-DKsBSWSJ.js";
import { C as createEmbeddedRunStageTracker, S as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, T as shouldWarnEmbeddedRunStageSummary, _ as resolveRateLimitProfileRotationLimit, _t as resolveRunLivenessState, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, b as createUsageAccumulator, bt as createEmbeddedRunReplayState, c as buildErrorAgentMeta, ct as extractPlanningOnlyPlanDetails, d as resolveActiveErrorContext, dt as resolveEmptyResponseRetryInstruction, f as resolveFinalAssistantRawText, ft as resolveIncompleteTurnPayloadText, g as resolveOverloadProfileRotationLimit, gt as resolveReplayInvalidFlag, h as resolveOverloadFailoverBackoffMs, ht as resolveReasoningOnlyRetryInstruction, i as selectAgentHarness, l as buildUsageAgentMetaFields, lt as resolveAckExecutionFastPathInstruction, m as resolveMaxRunRetryIterations, mt as resolvePlanningOnlyRetryLimit, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, p as resolveFinalAssistantVisibleText, pt as resolvePlanningOnlyRetryInstruction, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, st as STRICT_AGENTIC_BLOCKED_TEXT, u as createCompactionDiagId, ut as resolveAttemptReplayMetadata, v as resolveReportedModelRef, vt as resolveSilentToolResultReplyPayload, w as formatEmbeddedRunStageSummary, x as mergeUsageIntoAccumulator, xt as observeReplayMetadata, y as scrubAnthropicRefusalMagic, yt as shouldTreatEmptyAssistantReplyAsSilent } from "./selection-C_LIAzUt.js";
import { D as isStrictAgenticExecutionContractActive, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-wA1yN_oC.js";
import { p as buildAgentHookContextChannelFields, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-DAwz6VE_.js";
import { i as listActiveProcessSessionReferences, r as resolveContextEngineCapabilities, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-BTReyM6C.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-DssatADB.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Cxel0sky.js";
import { l as runAgentCleanupStep } from "./attempt.tool-run-context-B36KMRu-.js";
import { c as retireSessionMcpRuntime, l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-ClY1g8qg.js";
import "./pi-bundle-mcp-tools-BB_aflSU.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-Crodck_P.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-ChdBOKxX.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-BU0f90nW.js";
import { u as parseReplyDirectives } from "./payloads-DNfEhAOv.js";
import { j as formatToolAggregate } from "./channel-streaming-DamerS0o.js";
import { u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-GG7DwbUw.js";
import { a as suspendSession, c as buildApiErrorObservationFields, i as resolveSessionSuspensionReason, o as LiveSessionModelSwitchError, s as shouldAllowCooldownProbeForReason } from "./model-fallback-B3DzDitP.js";
import { t as log$1 } from "./logger-C04tBqzD.js";
import { d as resolveLiveToolResultMaxChars, f as sessionLikelyHasOversizedToolResults, p as truncateOversizedToolResultsInSession } from "./preemptive-compaction-C-Ec4P0x.js";
import "./tool-split-1dQpexc6.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CCPlpk0v.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-CGOHRmu2.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-DW1rdTQj.js";
import "./extra-params-BgzZkNHz.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-DBwWKUBI.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-C2NRZMsy.js";
import { r as buildAgentRuntimePlan } from "./build-3Z58ihrp.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-Dg1lXQjD.js";
...
import "./compact.queued-Dr9sWw42.js";
import { n as shouldSwitchToLiveModel, r as ensureSelectedAgentHarnessPlugin, t as clearLiveModelSwitchPending } from "./live-model-switch-fRPvIiph.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-D5jNKveR.js";
...
async function runEmbeddedPiAgent(params) {
	...
	return enqueueSession(() => {
		...
		return enqueueGlobal(async () => {
			...
			const authStore = pluginHarnessOwnsTransport && !pluginHarnessNeedsOpenClawAuthBootstrap ? createEmptyAuthProfileStore() : ensureAuthProfileStoreWithoutExternalProfiles(agentDir, { allowKeychainPrompt: false });
			...
			if (strictAgenticActive) log$1.info(`strict-agentic execution contract active: runId=${params.runId} sessionId=${params.sessionId} provider=${sanitizeForLog(provider)}/${sanitizeForLog(modelId)} harness=${sanitizeForLog(agentHarness.id)} configured=${configuredExecutionContract ?? "unspecified"}`);
			...
			try {
				...
				while (true) {
					...
					if (nextPlanningOnlyRetryInstruction && planningOnlyRetryAttempts < maxPlanningOnlyRetryAttempts) {
						...
						log$1.warn(`planning-only turn detected: runId=${params.runId} sessionId=${params.sessionId} provider=${provider}/${modelId} contract=${executionContract} configured=${configuredExecutionContractForLog} — retrying ${planningOnlyRetryAttempts}/${maxPlanningOnlyRetryAttempts} with act-now steer`);
						continue;
					}
