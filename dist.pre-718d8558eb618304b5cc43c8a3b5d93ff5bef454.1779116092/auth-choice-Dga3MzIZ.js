...
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-D4oOZ130.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-C06iISWv.js";
import "./provider-auth-choice-preference-DCeJQate.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-m5GQwWyp.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-sThXvNHV.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-CmmNsJQP.js");
