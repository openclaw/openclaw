...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-DSeWVQTn.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-BHm3hFkL.js");
