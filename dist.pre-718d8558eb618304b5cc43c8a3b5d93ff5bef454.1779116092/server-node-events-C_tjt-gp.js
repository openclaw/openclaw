...
import { d as resolveEventSessionKey, l as normalizeMainKey, m as scopedHeartbeatWakeOptions } from "./session-key-CQewiu8n.js";
...
import { c as loadSessionEntry, l as migrateAndPruneGatewaySessionStoreKey, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-ZJYncsRS.js";
import { o as requestHeartbeat } from "./heartbeat-wake-CD-OLloG.js";
import { a as enqueueSystemEvent } from "./system-events-Bff58p0o.js";
import { i as deleteMediaBuffer } from "./store-Uc5kTVit.js";
...
import { r as resolveOutboundTarget } from "./targets-DMHy7wor.js";
import { c as updatePairedNodeMetadata } from "./node-pairing-C2I8IXA1.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-DvqYThbv.js";
import { r as agentCommandFromIngress } from "./agent-command-VH6v2lUr.js";
import { t as formatForLog } from "./ws-log-H4eQPZMm.js";
import { g as updatePairedDeviceMetadata } from "./device-pairing-D06Zd_gH.js";
import "./agent-BdDISfMc.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-0pIzgj75.js";
import { i as parseMessageWithAttachments, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BSXC7u_f.js";
import { i as registerApnsRegistration } from "./push-apns-x5WYzrvt.js";
	...
	switch (evt.event) {
		...
		case "exec.denied": {
			...
			if (enqueueSystemEvent(text, {
				...
				reason: "exec-event",
				coalesceMs: 0
			}, cfg.session?.mainKey, cfg.session?.scope));
			return;
		}
