...
if [[ -z "$version_content" ]]; then
  echo "<h2>SmartAgentNeo $VERSION</h2>"
  echo "<p>Latest SmartAgentNeo update.</p>"
  echo "<p><a href=\"https://github.com/betterbrand/smart-agent-neo/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
