...
- MULLUSI_GATEWAY_VERSION = exact package.json version
- MULLUSI_MARKETING_VERSION = short iOS/App Store version
- MULLUSI_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
MULLUSI_GATEWAY_VERSION = ${PACKAGE_VERSION}
MULLUSI_MARKETING_VERSION = ${MARKETING_VERSION}
MULLUSI_BUILD_VERSION = ${BUILD_NUMBER}
EOF
