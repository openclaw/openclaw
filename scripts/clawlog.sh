...
show_usage() {
    cat << EOF
clawlog - Mullusi Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Mullusi logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Mullusi logs flow through the macOS unified log (subsystem: ai.mullusi).
