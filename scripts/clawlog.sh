...
show_usage() {
    cat << EOF
clawlog - EasyHub Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View EasyHub logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    EasyHub logs flow through the macOS unified log (subsystem: ai.EasyHub).
