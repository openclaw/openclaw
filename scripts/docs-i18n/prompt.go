...
- Keep product names in English: SmartAgentNeo, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SmartAgentNeo Gateway, use “Gateway 网关”.
