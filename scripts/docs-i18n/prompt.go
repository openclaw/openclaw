...
- Keep product names in English: Mullusi, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Mullusi Gateway, use “Gateway 网关”.
