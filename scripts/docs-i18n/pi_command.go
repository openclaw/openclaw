...
const (
	envDocsPiExecutable     = "MULLUSI_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "MULLUSI_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "MULLUSI_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "mullusi", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
