...
# Output:
# - dist/Activi.app
# - dist/Activi-<version>.zip
# - dist/Activi-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.activi.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Activi.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Activi-$VERSION.zip"
DMG="$ROOT_DIR/dist/Activi-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Activi-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Activi-$VERSION.dSYM.zip"
