...
# Output:
# - dist/DNA.app
# - dist/DNA-<version>.zip
# - dist/DNA-<version>.dmg
...
ZIP="$ROOT_DIR/dist/DNA-$VERSION.zip"
DMG="$ROOT_DIR/dist/DNA-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/DNA-$VERSION.notary.zip"
