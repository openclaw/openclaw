...
# - dist/SmartAgentNeo-<version>.zip
# - dist/SmartAgentNeo-<version>.dmg
...
APP="$ROOT_DIR/dist/SmartAgentNeo.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SmartAgentNeo-$VERSION.zip"
DMG="$ROOT_DIR/dist/SmartAgentNeo-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SmartAgentNeo-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SmartAgentNeo-$VERSION.dSYM.zip"
