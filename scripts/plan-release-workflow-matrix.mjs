...
export const RELEASE_PACKAGE_ACCEPTANCE_LANES =
  "release-typed-onboarding hosting-profiles doctor-switch update-channel-switch skill-install update-corrupt-plugin upgrade-survivor update-first-hop-compat published-upgrade-survivor root-managed-vps-upgrade update-restart-auth plugins-offline plugin-update plugin-binding-command-escape";
