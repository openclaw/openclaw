...
export const PR_EXEMPT_RUNTIME_TEST_FILES = [
  ...
  "extensions/crabbox/src/crabbox-worker-desktop-windows.test.ts",
  ...
  "extensions/logbook/src/store-batch-images.test.ts",
  ...
  "extensions/onepassword/src/secret-ref-resolver.test.ts",
  "extensions/qa-lab/src/gateway-startup-lease.integration.test.ts",
  "extensions/qa-lab/src/lab-server-ui.test.ts",
  "extensions/qa-lab/src/profile-evidence-sharding.test.ts",
  "extensions/qa-lab/src/scenario-catalog.delegation.test.ts",
  "extensions/qa-lab/src/scenario-flow-runner.test.ts",
  "extensions/qa-lab/src/suite-process-lifecycle.test.ts",
  "extensions/qa-lab/src/test-file-scenario-runner.child-bundle.test.ts",
  ...
  "src/cli/update-cli/update-command-recovery.test.ts",
  "src/cli/update-cli/update-command-rollback-executor.test.ts",
  "src/cli/update-cli/update-command-task-delivery.test.ts",
  ...
  "src/config/sessions/session-accessor.reset-progress.test.ts",
  ...
  "src/config/sessions/session-accessor.sqlite-excluded-rows.test.ts",
  ...
  "src/config/sessions/session-cold-storage.lifecycle.test.ts",
  "src/config/sessions/session-history-budget-owner.test.ts",
  "src/config/sessions/session-history-eviction.admission.test.ts",
  "src/config/sessions/session-history-eviction.preservation.test.ts",
  "src/config/sessions/session-history-eviction.test.ts",
  "src/config/sessions/session-sharing-store.worker.test.ts",
  ...
  "src/gateway/server-close.metadata.test.ts",
  ...
  "src/gateway/server-startup-legacy-pairing.test.ts",
  ...
  "src/gateway/server.sessions.agent-model-catalog.test.ts",
  "src/gateway/server.sessions.archive-failed-worker.test.ts",
  "src/gateway/server.sessions.compaction.test.ts",
  "src/gateway/server.sessions.create.accounts.test.ts",
  "src/gateway/server.sessions.create.dispatch.test.ts",
  "src/gateway/server.sessions.create.models.test.ts",
  "src/gateway/server.sessions.create.resolved-model.test.ts",
  ...
  "src/gateway/server.sessions.delete-state-lifecycle.test.ts",
  ...
  "src/gateway/server.startup-defaults-reload.test.ts",
  ...
  "src/gateway/worker-environments/workspace-reconcile-publication.test.ts",
  ...
  "src/infra/heartbeat-runner.first-isolated-outcome.test.ts",
  ...
  "src/infra/heartbeat-runner.webchat-exec-completion.test.ts",
  ...
  "src/infra/state-migrations.audit-skips.test.ts",
  "src/infra/state-migrations.caller-mode.plugin-execution.test.ts",
  "src/infra/state-migrations.caller-mode.refusal.test.ts",
  "src/infra/state-migrations.caller-mode.storage.test.ts",
  "src/infra/state-migrations.meeting-transcripts-projections.test.ts",
  "src/infra/state-migrations.meeting-transcripts.test.ts",
  "src/infra/state-migrations.skill-workshop.test.ts",
  "src/infra/state-migrations.web-push.test.ts",
  ...
  "src/state/openclaw-database-preflight.agent.test.ts",
