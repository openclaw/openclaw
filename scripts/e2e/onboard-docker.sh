...
TRASH
  ...
  run_wizard_cmd() {
    ...
    input_fifo="$(mktemp -u "/tmp/dna-onboard-${case_name}.XXXXXX")"
    mkfifo "$input_fifo"
    local log_path="/tmp/dna-onboard-${case_name}.log"
  ...
  run_case_local_basic() {
    ...
    config_path="$HOME/.dna/dna.json"
    sessions_dir="$HOME/.dna/agents/main/sessions"
