...
export OPENCLAW_SELECTED_SHA="${OPENCLAW_SELECTED_SHA:-${OPENCLAW_DOCKER_E2E_SELECTED_SHA:-$(git -C "$ROOT_DIR" rev-parse HEAD)}}"
export OPENCLAW_TOOLING_SHA="${OPENCLAW_TOOLING_SHA:-$(git -C "$HARNESS_ROOT_DIR" rev-parse HEAD)}"
...
if [ "${OPENCLAW_UPGRADE_SURVIVOR_PUBLISHED_BASELINE:-0}" = "1" ]; then
  ...
  docker_e2e_run_with_harness \
    ...
    -e OPENCLAW_UPGRADE_SURVIVOR_CLAWHUB_REQUEST_DIALECT="$OPENCLAW_UPGRADE_SURVIVOR_CLAWHUB_REQUEST_DIALECT" \
    -e OPENCLAW_UPGRADE_SURVIVOR_DISCORD_DM_CONFIG_MODE="$OPENCLAW_UPGRADE_SURVIVOR_DISCORD_DM_CONFIG_MODE" \
    -e OPENCLAW_UPGRADE_SURVIVOR_EXEC_APPROVALS_MODE="$OPENCLAW_UPGRADE_SURVIVOR_EXEC_APPROVALS_MODE" \
    -e OPENCLAW_UPGRADE_SURVIVOR_MOBILE_WATCH_REAPPROVAL_MODE="$OPENCLAW_UPGRADE_SURVIVOR_MOBILE_WATCH_REAPPROVAL_MODE" \
    -e OPENCLAW_UPGRADE_SURVIVOR_SESSION_REPAIR_MODE="$OPENCLAW_UPGRADE_SURVIVOR_SESSION_REPAIR_MODE" \
