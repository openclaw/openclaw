...
const targetModel =
  modelIds.find((id) => id === "mullusi/default") ?? modelIds.find((id) => id === "mullusi");
if (!targetModel) {
  throw new Error(`mullusi model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
