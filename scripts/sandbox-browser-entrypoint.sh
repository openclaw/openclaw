...
export DISPLAY=:1
export HOME=/tmp/mullusi-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${MULLUSI_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${MULLUSI_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${MULLUSI_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${MULLUSI_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${MULLUSI_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${MULLUSI_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${MULLUSI_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${MULLUSI_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${MULLUSI_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${MULLUSI_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${MULLUSI_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
