...
export DISPLAY=:1
export HOME=/tmp/activi-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${ACTIVI_BROWSER_CDP_PORT:-${ACTIVI_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${ACTIVI_BROWSER_CDP_SOURCE_RANGE:-${ACTIVI_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${ACTIVI_BROWSER_VNC_PORT:-${ACTIVI_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${ACTIVI_BROWSER_NOVNC_PORT:-${ACTIVI_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${ACTIVI_BROWSER_ENABLE_NOVNC:-${ACTIVI_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${ACTIVI_BROWSER_HEADLESS:-${ACTIVI_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${ACTIVI_BROWSER_NO_SANDBOX:-${ACTIVI_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${ACTIVI_BROWSER_NOVNC_PASSWORD:-${ACTIVI_BROWSER_NOVNC_PASSWORD:-}}"
