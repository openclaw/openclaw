...
export DISPLAY=:1
export HOME=/tmp/dna-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${DNA_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${DNA_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${DNA_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${DNA_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${DNA_BROWSER_HEADLESS:-0}"
