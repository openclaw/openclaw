...
const env = {
  ...process.env,
  MULLUSI_LIVE_TEST: process.env.MULLUSI_LIVE_TEST || "1",
  MULLUSI_LIVE_TEST_QUIET: quietOverride ?? process.env.MULLUSI_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.MULLUSI_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
