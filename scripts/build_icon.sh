...
# Defaults target the EasyHub assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/EasyHub/Resources/EasyHub.icns"}
