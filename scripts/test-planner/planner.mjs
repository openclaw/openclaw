...
export function buildCIExecutionManifest(scopeInput = {}, options = {}) {
  ...
  const jobs = {
    ...
    macosSwiftLint: { enabled: macosEligible },
    macosSwiftBuild: { enabled: macosEligible },
    macosSwiftTest: { enabled: macosEligible },
  ...
  return {
    ...
    requiredCheckNames: [
      ...
      ...(macosEligible ? ["macos-swift-lint", "macos-swift-build", "macos-swift-test"] : []),
