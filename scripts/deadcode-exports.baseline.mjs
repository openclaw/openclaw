...
export const KNIP_UNUSED_EXPORT_BASELINE = [
  ...
  "extensions/memory-wiki/src/open-items.ts: deriveMemoryWikiOpenItems",
  "extensions/memory-wiki/src/open-items.ts: MemoryWikiOpenItem",
  "extensions/memory-wiki/src/open-items.ts: MemoryWikiOpenItemCounts",
  "extensions/memory-wiki/src/open-items.ts: MemoryWikiOpenItemsResult",
  "extensions/memory-wiki/src/open-items.ts: MemoryWikiOpenItemVariant",
