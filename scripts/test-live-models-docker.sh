...
docker run --rm -t \
  ...
  -e ACTIVI_LIVE_MODELS="${ACTIVI_LIVE_MODELS:-${ACTIVI_LIVE_MODELS:-all}}" \
  -e ACTIVI_LIVE_PROVIDERS="${ACTIVI_LIVE_PROVIDERS:-${ACTIVI_LIVE_PROVIDERS:-}}" \
  -e ACTIVI_LIVE_MODEL_TIMEOUT_MS="${ACTIVI_LIVE_MODEL_TIMEOUT_MS:-${ACTIVI_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e ACTIVI_LIVE_REQUIRE_PROFILE_KEYS="${ACTIVI_LIVE_REQUIRE_PROFILE_KEYS:-${ACTIVI_LIVE_REQUIRE_PROFILE_KEYS:-}}" \
