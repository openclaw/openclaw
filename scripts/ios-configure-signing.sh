...
if [[ -n "${BOT_IOS_BUNDLE_SUFFIX:-}" ]]; then
  identity_source="${BOT_IOS_BUNDLE_SUFFIX}"
else
...
bundle_base="${BOT_IOS_APP_BUNDLE_ID:-${BOT_IOS_BUNDLE_ID_BASE:-}}"
if [[ -z "${bundle_base}" ]]; then
  bundle_base="ai.hanzo.ios.test.${bundle_suffix}"
fi
bundle_base="$(normalize_bundle_id "${bundle_base}")"

share_bundle_id="${BOT_IOS_SHARE_BUNDLE_ID:-${bundle_base}.share}"
watch_app_bundle_id="${BOT_IOS_WATCH_APP_BUNDLE_ID:-${bundle_base}.watchkitapp}"
watch_extension_bundle_id="${BOT_IOS_WATCH_EXTENSION_BUNDLE_ID:-${watch_app_bundle_id}.extension}"

code_sign_style="${BOT_IOS_CODE_SIGN_STYLE:-Automatic}"
app_profile="${BOT_IOS_APP_PROFILE:-}"
share_profile="${BOT_IOS_SHARE_PROFILE:-}"

tmp_file="$(mktemp "${TMPDIR:-/tmp}/bot-ios-signing.XXXXXX")"
cat >"${tmp_file}" <<EOF
// Auto-generated by scripts/ios-configure-signing.sh.
// This file is local-only and should not be committed.
// Override values with env vars if needed:
// BOT_IOS_APP_BUNDLE_ID / BOT_IOS_BUNDLE_ID_BASE
// BOT_IOS_SHARE_BUNDLE_ID / BOT_IOS_WATCH_APP_BUNDLE_ID / BOT_IOS_WATCH_EXTENSION_BUNDLE_ID
// BOT_IOS_CODE_SIGN_STYLE / BOT_IOS_APP_PROFILE / BOT_IOS_SHARE_PROFILE
BOT_CODE_SIGN_STYLE = ${code_sign_style}
BOT_DEVELOPMENT_TEAM = ${team_id}
// Keep legacy key for compatibility with older signing config paths.
BOT_IOS_SELECTED_TEAM = ${team_id}
BOT_APP_BUNDLE_ID = ${bundle_base}
BOT_SHARE_BUNDLE_ID = ${share_bundle_id}
BOT_WATCH_APP_BUNDLE_ID = ${watch_app_bundle_id}
BOT_WATCH_EXTENSION_BUNDLE_ID = ${watch_extension_bundle_id}
BOT_APP_PROFILE = ${app_profile}
BOT_SHARE_PROFILE = ${share_profile}
EOF
