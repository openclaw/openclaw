...
code_sign_entitlements="${OPENCLAW_IOS_CODE_SIGN_ENTITLEMENTS:-Sources/OpenClaw.entitlements}"
...
// OPENCLAW_IOS_CODE_SIGN_STYLE / OPENCLAW_IOS_CODE_SIGN_ENTITLEMENTS
// OPENCLAW_IOS_APP_PROFILE / OPENCLAW_IOS_SHARE_PROFILE
...
OPENCLAW_CODE_SIGN_ENTITLEMENTS = ${code_sign_entitlements}
