...
if [[ "$scope" != "ios" ]]; then
  swiftformat --lint apps/macos/Sources \
    ...
    --exclude '**/OpenClawProtocol,**/HostEnvSecurityPolicy.generated.swift,**/BrowserInspectScript.generated.swift,**/BrowserFaviconScript.generated.swift,**/ExecArgPatternSafetyJS.generated.swift'
  swiftformat --lint \
