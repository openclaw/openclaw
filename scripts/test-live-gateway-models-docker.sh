...
docker run --rm -t \
  ...
  -e SMART_AGENT_NEO_LIVE_GATEWAY_MODELS="${SMART_AGENT_NEO_LIVE_GATEWAY_MODELS:-${NEOBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e SMART_AGENT_NEO_LIVE_GATEWAY_PROVIDERS="${SMART_AGENT_NEO_LIVE_GATEWAY_PROVIDERS:-${NEOBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e SMART_AGENT_NEO_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${SMART_AGENT_NEO_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${NEOBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
