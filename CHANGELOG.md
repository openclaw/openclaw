...
- Auto-reply/Models: prioritize exact model-id matches over fuzzy scoring so similar model names like `gemini-3.1-pro-preview` no longer resolve to the wrong candidate. (#21942)
