...
- Plugins/reply dispatcher compatibility: export the provider dispatcher module as a stable package subpath so community channel plugins can dispatch replies without relying on internal bundle chunk names. (#25057)
