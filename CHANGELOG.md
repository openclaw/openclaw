...
- Slack: preserve numeric `threadId` values for `message` tool `read` actions so thread reads return replies instead of channel history when callers send unquoted Slack timestamps. (#22852, relates #15713)
