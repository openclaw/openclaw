...
- Skills/SKILL.md frontmatter parsing: recover skill discovery when unquoted colons in `description` break upstream YAML parsing, by falling back to OpenClaw frontmatter parsing for `SKILL.md` loading. (#29981)
