...
- LINE/Reply: send flex detail messages before template (button/pagination) messages in mixed rich replies so the visual hierarchy matches the documented order. (#17318) Thanks @arosstale.
