...
- Antigravity/Schema: sanitize unsupported fields from Anthropic-format requests before forwarding to Google Antigravity to prevent 400 errors on valid payloads. (#19985) Thanks @arosstale.
