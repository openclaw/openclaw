...
- Agents/Compaction: improve merge-summary context preservation with structured guidance for decisions, TODOs, constraints, files/commands, errors, preferences, and key tool outcomes. (#20075) thanks @jlwestsr.
