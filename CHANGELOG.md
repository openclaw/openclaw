...
- Auth/Anthropic: keep user-selected `anthropic:default` API-key profiles unchanged during external CLI sync, avoid re-creating deprecated `anthropic:claude-cli`, and continue syncing stale Anthropic OAuth defaults from Claude CLI credentials.
