...
- Web UI/Cron delivery persistence: submit explicit `delivery.mode="none"` for isolated cron edits so switching Result delivery to None (internal) is saved instead of silently keeping the previous announce mode. Fixes #31075.
