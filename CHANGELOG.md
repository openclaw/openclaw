...
- Plugins/Matrix keyed async queue loading: add explicit `openclaw/plugin-sdk/keyed-async-queue` loader alias mapping so plugin-sdk subpath imports resolve correctly instead of being rewritten to `index.js/<subpath>` and failing to load. (#33427) Thanks @manmis.
