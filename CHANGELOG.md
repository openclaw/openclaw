...
- Agents/Memory recall prompt precedence: clarify that when AGENTS.md or injected workspace instructions require direct bootstrap file reads first, those higher-priority instructions take precedence over memory_search/memory_get recall guidance. Fixes #29772.
