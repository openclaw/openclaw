...
- Mattermost/Outbound local media roots: pass `mediaLocalRoots` through Mattermost outbound media sends into `loadWebMedia` so workspace-scoped local attachments are uploaded instead of silently dropping files. (#30830)
