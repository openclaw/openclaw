...
- Agents/continuity context engine: add an opt-in `continuity` context engine that captures durable facts, preferences, decisions, and open loops across trusted direct chats, supports review/approval flows, materializes approved items to `memory/continuity/*.md`, and exposes continuity controls in the CLI, gateway, and Control UI while keeping `legacy` as the default context engine. Closes #37667 and relates to #28057, #14850, #38478, #38847, #18749, and #7707.
