...
- Agents/embedded tool-result delivery: preserve final tool-result payloads in embedded Pi run results so media-producing tools still deliver attachments after the assistant reply is assembled.
