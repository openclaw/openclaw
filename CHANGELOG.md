...
- Models/Onboarding: refresh provider defaults to Opus 4.6, update OpenAI/OpenAI Codex wizard defaults (`openai/gpt-5.1-codex`, `openai-codex/gpt-5.3-codex`), and harden model allowlist initialization for first-time configs with matching docs/tests. (#9911) Thanks @gumadeiras.
