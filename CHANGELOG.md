...
- Gateway/Agent messaging: add `agent.message` gateway method for lightweight P2P inter-session message relay with correlation ID tracking, plus a `scripts/agent-mailbox.sh` file-based fallback for local environments.
