...
- Commands/subagents native list routing: prefer `CommandTargetSessionKey` for `/subagents list` requester resolution so native slash invocations show runs from the routed conversation session instead of the transient command transport session. (#33508)
