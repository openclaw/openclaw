...
- Mattermost/channel mention gating: align group mention policy resolution with `chatmode` so `chatmode="onmessage"` reliably disables mention requirements in channel conversations even when account-level mention flags are absent. (#32075) Thanks @liuxiaopai-ai.
