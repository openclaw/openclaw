...
- Agents/message tool routing: prefer the active embedded agent id over session-derived fallback routing so tool-driven sends stay attributed to the correct agent in shared-session flows.
