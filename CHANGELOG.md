...
- Gateway/Auth: add `operator.write` to operator scope hierarchy so `operator.admin` satisfies `operator.write` requests, preventing gateway-client pairing loop on scope upgrade. (#22574)
