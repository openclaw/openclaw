...
- Agents/tool result format: add `matrix`, `msteams`, `whatsapp`, and `feishu` to `MARKDOWN_CAPABLE_CHANNELS` so tool results on these channels use markdown formatting instead of plain text.
