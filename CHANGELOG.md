...
- Control UI/Legacy browser compatibility: replace UI `toSorted` usage with a compatibility helper so browsers without `Array.prototype.toSorted` no longer crash into a blank page on load. Fixes #30467.
