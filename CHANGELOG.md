...
- Slack/Threading: respect `replyToMode: "off"` for inline directive reply tags (`[[reply_to_current]]`) so top-level replies stay in the channel root instead of being forced into a thread. (supersedes #16113)
