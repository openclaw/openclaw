...
- Sessions/Subagent spawn validation: fail fast when `sessions_spawn` passes an explicit unknown `agentId`, preventing accidental child-session/workspace side effects for invalid targets. (#31311)
