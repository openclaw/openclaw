...
- Cron/high-frequency advisory: warn for sub-30-minute `every` schedules across CLI add/edit and gateway add/update so short-interval jobs surface session-accumulation risk without blocking valid cron creation. Fixes #38730.
