...
- Agents/Channels: suppress exec and bash tool summaries and output from channel delivery, preventing raw shell commands and stdout from leaking to end users in Discord and other channels. (#18688)
