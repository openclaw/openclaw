...
- Build/npm: mark heavy channel extensions as optional peer dependencies in the npm package so lightweight installs don't pull in unused bundled extensions. (#19970) Thanks @arosstale.
