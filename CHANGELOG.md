...
- Firecrawl/self-hosting: allow custom Firecrawl `baseUrl` values for search and scrape while keeping public hosts on the strict SSRF path and limiting cleartext HTTP to private or loopback deployments. (#59666) Thanks @jzakirov.
