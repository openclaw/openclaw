...
- Agents/Streaming: suppress narration text (pre-tool-call "thinking out loud") from being delivered to user channels when assistant message contains tool calls. (#17154)
