...
- Models/Moonshot CN merge precedence: keep explicit `models.providers.moonshot.baseUrl` from config when regenerating `models.json` in merge mode, instead of preserving stale agent-file endpoints. (#32607)
