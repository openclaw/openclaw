...
- Telegram/Media: send a user-facing error reply when media fetch fails (network error, Telegram API error). Previously the error was only logged server-side and the user received no response at all. (#4662) Thanks @arosstale.
