...
- Sessions/Subagent spawn validation: reject malformed `sessions_spawn.agentId` input up front so error-string garbage values cannot be normalized into filesystem paths or create ghost workspace directories. Fixes #31311.
