...
- Gateway/webchat block-streaming guard: force `disableBlockStreaming: true` for webchat `chat.send` dispatch so non-final block frames do not make the previous assistant message disappear during follow-up streaming. (#33706) Thanks @Sid-Qin.
