...
- Control UI/cron: keep the New Job panel in normal document flow so the editor scrolls with the Cron page instead of sticking to the viewport or creating its own inner scroller. (#31412)
