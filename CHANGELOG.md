...
- Telegram/Models: allow colon in provider names for inline keyboard callback data so providers like `ollama:cloud` no longer trigger spurious LLM runs. (#21939)
