...
- Plugins/Registry: suppress duplicate-plugin-id warning when a user or project plugin intentionally overrides a bundled plugin with the same ID, preventing false-positive console noise on every startup.
