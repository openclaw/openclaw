...
- Telegram/Doctor multi-account guidance: clarify missing `accounts.default` warnings to call out that `channels.telegram.botToken` maps only to the default account, reducing default-routing surprises in named-account setups. (#32138) Thanks @liuxiaopai-ai.
