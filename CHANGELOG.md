...
- Cron/Scheduler: prevent timer freeze during rapid create/delete cycles by skipping timer re-arm when a tick is already in progress, eliminating race conditions between operation-triggered re-arms and the running tick's finally-block re-arm. (#18121)
