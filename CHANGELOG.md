...
- Skills/sherpa-onnx-tts: switch the `bin/sherpa-onnx-tts` launcher to ESM imports so Node 22+ can run the script from global installs without `require is not defined in ES module scope` failures. (#31956)
