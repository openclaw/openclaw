...
- Agents/Subagents: prevent infinite retry loops in sub-agent completion announcements by keeping `resumedRuns` intact during deferred-announce retries. (#18150)
