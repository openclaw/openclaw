...
- Sessions/Repair: replace lone surrogates in session history before sending to the LLM API, preventing permanent session corruption from supplementary plane emoji in tool_use arguments. (#18105)
