...
- Agents/Compaction: remove non-existent `WORKFLOW_AUTO.md` from post-compaction audit required reads so the audit no longer tells agents to read a file that does not exist. (#21957)
