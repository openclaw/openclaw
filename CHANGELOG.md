...
- Media/macOS: use `sips` for image processing on macOS Node.js to prevent spurious Photos library TCC permission dialogs on macOS 15. (#21075) Thanks @irchelper.
