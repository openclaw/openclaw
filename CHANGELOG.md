...
- Docker/Compose CLI connectivity: run `openclaw-cli` in the `openclaw-gateway` service network namespace and require gateway startup ordering so default loopback gateway calls work in containerized setups. (#12504) Thanks @bvanderdrift.
