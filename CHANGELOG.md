...
- Web UI/Agent files editor: increase default Agent > Files content editor height and keep the editor panel start-aligned so textarea resize handles visibly expand the editing area instead of appearing stuck. (#30001)
