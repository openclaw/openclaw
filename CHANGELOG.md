...
- Model directive/Auth profiles: parse `/model <model>@<profile>` using the first valid profile delimiter so profile IDs that contain `@` (for example OAuth email IDs) are preserved instead of being truncated. (#30912)
