...
- Auto-reply/Reminder note annotation: deliver unscheduled-reminder guidance as a separate `System note` payload (instead of appending to assistant-authored text), preserving agent reply content boundaries for downstream readers and parsers. (#30787)
