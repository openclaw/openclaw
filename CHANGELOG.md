...
- Queue: add `messages.queue.priorityPreemption` toggle to route heartbeat runs to a dedicated lane so they never block human messages on the main lane. Default: `false` (opt-in). (#18962)
