...
- CLI/Doctor: skip QMD false-positive warnings for agents that have memory explicitly disabled, avoiding noisy diagnostics in memory-off configurations. (#19978) Thanks @arosstale.
