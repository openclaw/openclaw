...
- Agents/WebSocket: use Responses API flat tool format for WebSocket stream connections so cron isolated sessions no longer fail tool schema validation against OpenAI endpoints. (#39359)
