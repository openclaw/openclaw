...
- Skills/skill-creator trigger guidance: broaden metadata trigger wording to include edit/refactor workflows so skill-authoring tasks load the correct guidance more reliably. (#36039) Thanks @liuxiaopai-ai.
