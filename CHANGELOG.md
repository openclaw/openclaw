...
- Signal/Group system events: ignore Signal group `groupInfo.type="UPDATE"` system notifications in inbound handling so admin/permission-change banners are not routed to the agent as user prompts. Fixes #30981.
