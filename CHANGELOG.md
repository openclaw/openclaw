...
- Config/Schema: add `"video"` and `"audio"` to `models.providers[].models[].input` schema — Gemini native multimodal configs were rejected at startup despite runtime support for these media types. (#20721) Thanks @arosstale.
