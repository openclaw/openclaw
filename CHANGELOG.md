...
- CLI/memory help example: update `openclaw memory --help` search example to use positional query syntax (`openclaw memory search "deployment notes"`), matching the documented/primary invocation path and avoiding misleading flag-only guidance. (#23231) Thanks @stuhorsman.
