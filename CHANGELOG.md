...
- Telegram/streaming multi-tool rounds: keep answer preview on a single draft message and suppress superseded intermediate assistant finals when newer assistant messages start, preventing inter-tool-call text from leaking as separate user-visible messages in streaming mode. (#32535)
