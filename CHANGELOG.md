...
- Nextcloud Talk plugin load path: stop importing `waitForAbortSignal` from core source-relative paths so npm-installed `@openclaw/nextcloud-talk` loads correctly outside the monorepo checkout. (#32662) Thanks @xxliu893.
