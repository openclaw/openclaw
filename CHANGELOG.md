...
- Agents/Announce: use task label (falling back to agent id) and model name in subagent completion announce header for clearer identification; strip provider prefix from model name. (#20146) Thanks @irchelper.
