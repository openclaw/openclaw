...
- Agents/OpenAI WebSocket: omit `tool_choice` when the resolved tools list is empty so vLLM-compatible providers no longer reject tool-less requests. (#44229) thanks @JosepLee.
