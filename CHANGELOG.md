...
- WhatsApp/allowFrom: normalize Brazilian mobile numbers so the 8-digit form (+55 XX XXXX-XXXX) and 9-digit form (+55 XX 9XXXX-XXXX) are treated as the same number, preventing silent DM/group blocks when Baileys resolves the shorter variant. (#27565)
