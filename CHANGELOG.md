...
- Telegram: send fallback response when `streamMode: "partial"` but zero messages delivered, preventing silent failures in tool-heavy runs where no streaming text is generated and final reply is empty. (#18195)
