...
- Agents/Anthropic thinking replay: when Anthropic rejects follow-up turns with `thinking`/`redacted_thinking` mutation errors, retry once with historical thinking blocks stripped to avoid signed-thinking mismatch failures on long-running sessions. (#24612)
