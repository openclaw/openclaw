...
- Gateway/Hooks: block `__proto__`, `constructor`, and `prototype` traversal in webhook template path resolution to prevent prototype-chain payload leaks in `messageTemplate` rendering. (#22213) Thanks @SleuthCo.
