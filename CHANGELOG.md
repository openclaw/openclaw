...
- Discord/Allowlist diagnostics: add debug-level preflight logs when guild messages are dropped by `groupPolicy`/channel allowlist checks so operators can quickly identify blocked channel IDs and policy reason. (#30676) Thanks @liuxiaopai-ai.
