...
- Agents/Embedded: immediately clear active run state on timeout to unblock announce queue, preventing indefinite session deadlock when embedded agent runs exceed timeoutMs during compaction or other blocking operations. (#18302)
