...
- Agents/Tools/Plugins: include sessionId in plugin tool + hook contexts and embedded tool definitions to preserve session-scoped task ownership. (#33721) Thanks @AvalokiteshvaraBodhisattva.
