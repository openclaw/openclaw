...
- Discord: unlock rich interactive agent prompts with Components v2 (buttons, selects, modals, and attachment-backed file blocks) so approvals and structured input flow straight back into the conversation. Thanks @thewilloftheshadow.
