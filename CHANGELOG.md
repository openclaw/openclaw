...
- Cron/Group context listing: default `cron list` tool output to the caller's current group/channel context (including thread parent matching), with `allContexts:true` escape hatch for cross-context admin views. (#31464)
