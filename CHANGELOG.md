...
- Matrix: add configurable startup grace period (`channels.matrix.startupGraceMs`) so the Matrix provider ignores messages received before the bot was ready, preventing stale-message replay on restart. (#19973) Thanks @arosstale.
