...
- Telegram/DM partial streaming finalization: materialize draft-stream finals directly from the final text instead of flushing one last draft update first, reducing transient duplicate reply bubbles at the end of text-only DM streams. (openclaw#36697)
