...
- Control UI/Config form unions: keep `models.providers` editable when provider fields use mixed primitive/object unions (for example `apiKey` SecretInput), instead of marking the whole section unsupported. (#31490)
