...
- Providers: add Azure OpenAI support via `azure-openai-responses` API adapter with inline provider configuration, Kubernetes deployment manifests, and documentation. (#14475) Thanks @dzianisv.
