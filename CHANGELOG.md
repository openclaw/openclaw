...
- Memory/Jina embeddings: add `memorySearch.provider = "jina"` and `memorySearch.fallback = "jina"` support with auto-selection when a Jina key is resolved, using `jina-embeddings-v5-text-nano` as default model. (#23172)
