...
- Agents/Tools: mark required-parameter validation failures as `[NON-RETRYABLE]` so repeated invalid tool calls (for example `read({})`) do not loop without corrective arguments. (#14729)
