...
- OpenRouter/Anthropic cache retention: honor `cacheRetention` for OpenRouter Anthropic system-message `cache_control` injection by mapping `long` to `ttl: "1h"` and respecting `none` to disable injected caching. (#30850)
