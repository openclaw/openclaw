...
- Agents/Transcript: preserve thinking block signatures for direct Anthropic API connections (not just Antigravity), preventing `Invalid signature in thinking block` rejections during compaction. (#18653)
