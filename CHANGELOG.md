...
- Cron/Scheduler: auto-clear stale `runningAtMs` markers when execution duration exceeds 2x job timeout, preventing permanent job blocking after crashes or timeouts without requiring manual disable/enable toggle. (#18120)
