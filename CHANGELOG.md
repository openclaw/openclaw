...
- Agents/Fallbacks: classify provider HTTP `404` errors as `model_not_found` in failover coercion so fallback chains continue when providers return bare 404 entity-not-found responses. (#23800) Thanks @builtbyrobben.
