...
- Browser/tool description: respect `browser.defaultProfile` in the browser tool description so the model omits the profile parameter for general browsing instead of always hardcoding `profile="openclaw"`. (#31085)
