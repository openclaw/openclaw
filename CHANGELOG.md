...
- Auth/Fallback profile rotation: classify OAuth `403 permission_error` failures as permanent auth failures so provider fallback rotates off expired/blocked OAuth profiles instead of repeatedly reselecting the same profile. Fixes #31306.
