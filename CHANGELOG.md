...
- Discord: reject thread creation in existing threads, voice, and stage channels — Discord returns 422 for these types; now validated before the API call. (#20627) Thanks @arosstale.
