...
- Agents/Browser host target resolution: return the configured browser control base URL for host-targeted browser tool calls so embedded browser actions no longer time out with an undefined base URL. Fixes #32814.
