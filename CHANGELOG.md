...
- Telegram/delivery queue chunking: use `markdownToTelegramChunks` for Telegram plugin outbound chunking so queue recovery/retry delivery paths split by rendered Telegram HTML boundaries instead of raw markdown length. (#31952) Thanks @liuxiaopai-ai.
