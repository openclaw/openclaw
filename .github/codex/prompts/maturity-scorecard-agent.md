...
- `docs/maturity-scores.yaml`, deletion only when migrating the old score file

Hard limits:

- If `docs/maturity-scores.yaml` exists, remove it after migrating any useful current score data into `qa/maturity-scores.yaml`.
