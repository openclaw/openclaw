import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-Cnwfh6dH.js";
...
import { n as hasBinary } from "./config-eval-CzUcaBN1.js";
...
async function ensureTailscaleEndpoint(params) {
	...
	const status = await runCommandWithTimeout([tailscaleBin, ...statusArgs], { timeoutMs: 3e4 });
	...
	const funnelResult = await runCommandWithTimeout([tailscaleBin, ...funnelArgs], { timeoutMs: 3e4 });
