...
import { a as AuthProfileStore, r as AuthProfileFailureReason } from "./types-B9g5YyO3.js";
import { r as AuthCredentialReasonCode } from "./repair-Cch-O7bY.js";
 ...
 */
declare function markAuthProfileUsed(params: {
  store: AuthProfileStore;
  profileId: string;
  agentDir?: string;
}): Promise<void>;
...
//#endregion
export { markAuthProfileUsed as a, clearExpiredCooldowns as c, resolveApiKeyForProfile as d, formatAuthDoctorHint as f, resolveAuthProfileOrder as g, resolveAuthProfileEligibility as h, markAuthProfileFailure as i, getSoonestCooldownExpiry as l, AuthProfileEligibilityReasonCode as m, clearAuthProfileCooldown as n, resolveProfileUnusableUntilForDisplay as o, resolveAuthProfileDisplayLabel as p, markAuthProfileCooldown as r, resolveProfilesUnavailableReason as s, calculateAuthProfileCooldownMs as t, isProfileInCooldown as u };