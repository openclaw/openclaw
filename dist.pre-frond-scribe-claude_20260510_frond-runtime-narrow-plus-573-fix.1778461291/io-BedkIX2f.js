...
import { n as normalizeTalkConfig } from "./talk-BaJ811in.js";
...
import { t as OpenClawSchema } from "./zod-schema-Joix_uTl.js";
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
	if (!raw || typeof raw !== "object") return [];
	const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DRE8RB3R.js");
