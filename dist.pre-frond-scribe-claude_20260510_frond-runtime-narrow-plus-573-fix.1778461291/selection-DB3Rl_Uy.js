...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-BzUkrEzd.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-f0tQe4pr.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-AdNx9jqZ.js";
import { a as listRegisteredAgentHarnesses } from "./registry-CeZae-8i.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-knFi7jVE.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Dn0qn0nC.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-DsnS2jud.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-CtVYlVLQ.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DJVWZi1F.js";
import { u as resolveStorePath } from "./paths-CQN3oihN.js";
import { t as loadSessionStore } from "./store-load-D3JA5WV4.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-DhSIRxgg.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-XYHqkWt4.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-KEj42vTQ.js";
...
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-DPuTz-lc.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-B80gzYOd.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DaR27b4S.js";
...
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-Cz0PjVYb.js";
...
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-DrhWhHCt.js";
import { t as parseInlineDirectives } from "./directive-tags-CB14FHeA.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-BooGZZiK.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-DGRY_v6j.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-CmIz0rW7.js";
...
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-Dv3fBSEg.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-DmXVwB-K.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-DFJbgGBN.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DLuewk89.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DcJEanAu.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-B8btJMc2.js";
import { i as resolveImageSanitizationLimits } from "./tool-images--o5rZQPu.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-q8m6OXvg.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-CAGPnpze.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-BkilYPBI.js";
...
import { t as filterHeartbeatPairs } from "./heartbeat-filter-DGreIXMj.js";
import { D as stripProviderPrefix, E as isStrictAgenticSupportedProviderModel, O as isEmbeddedMode, d as resolveToolLoopDetectionConfig } from "./openclaw-tools-D-G6kiLc.js";
import { t as getMachineDisplayName } from "./machine-name-QTr-ogL4.js";
import { m as MAX_IMAGE_BYTES } from "./mime-ki5Bz7zA.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-bapS9W_Y.js";
import { i as getPluginToolMeta } from "./tools-LRfQdPnA.js";
import { n as redactConfigObject } from "./redact-snapshot-Cb2rJ-bi.js";
import { n as resolveCommitHash } from "./git-commit-CbyuaBC3.js";
import { t as resolveOsSummary } from "./os-summary-_XnVKN0H.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-DaCgx2FQ.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-Bnjj5yUQ.js";
import { d as parseBooleanValue } from "./frontmatter-DW_12mZe.js";
...
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context--8YdVCLW.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-JRdJwRI9.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-KoHrqqsz.js";
...
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-Db49hsXk.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-FrCvE2ul.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-R3kK1n_P.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-CXGHwniI.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-CBoBdrmt.js";
...
import { f as hasCommittedMessagingToolDeliveryEvidence, p as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-_x3pECJI.js";
import { f as buildApiErrorObservationFields, p as buildTextObservationFields } from "./model-fallback-olxsy09f.js";
import { t as log$4 } from "./logger-DM7utI1X.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-I1rrggYG.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-ogD2h2Ys.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-c-8q9cPM.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-CKxoZR0D.js";
...
import { n as buildSubagentList } from "./subagent-list-LGc80efa.js";
...
import { g as sanitizeTransportPayloadText, m as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-BEJHlMu4.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-C6XBAZy8.js";
...
import { t as buildSystemPromptReport } from "./system-prompt-report-B_VhSLYv.js";
import { n as appendAgentBootstrapSystemPromptSupplement, r as appendModelIdentitySystemPrompt } from "./system-prompt-config-BdAktUPY.js";
import "./tool-loop-detection-f-Kz-xSY.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-CN5xC3-5.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BQoNuMfu.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-D_OdM_GJ.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-BPT7Q5AX.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-BYTfouGJ.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-B89Netg7.js"));
