import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-Bf2R3Pfm.js";
import { r as loadCrestodianOverview } from "./overview-DryfRQM2.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-bpQEBoOf.js")).planCrestodianCommand)({
		input,
		overview
	});
