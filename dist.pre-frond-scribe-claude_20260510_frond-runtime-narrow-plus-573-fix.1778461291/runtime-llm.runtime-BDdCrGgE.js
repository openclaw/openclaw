...
import { t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-DTbWHmze.js";
import "./logging-DjjIv3bg.js";
import { y as normalizeModelRef } from "./model-selection-shared-BCJZ6pnb.js";
import "./model-selection-B80gzYOd.js";
import { a as resolveModelCostConfig, n as estimateUsageCost } from "./usage-format-DdKQWCzU.js";
...
async function resolveAgentId(params) {
	...
	const { resolveDefaultAgentId } = await import("./agent-scope-DfwoQnoT.js");
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ prepareSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-CA9hZqGp.js"), Promise.resolve(resolveRuntimeConfig(options))]);
