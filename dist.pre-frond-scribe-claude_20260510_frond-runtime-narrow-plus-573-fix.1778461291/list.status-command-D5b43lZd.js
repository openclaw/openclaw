...
import { G as getShellEnvAppliedKeys, Y as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-BedkIX2f.js";
...
import { h as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-DSz4632-.js";
import { a as openAIProviderUsesCodexRuntimeByDefault, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-C3yZ-N1b.js";
import { N as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-DPuTz-lc.js";
import { f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, v as modelKey } from "./model-selection-shared-BCJZ6pnb.js";
...
import { b as resolveProviderEnvAuthEvidence, u as isNonSecretApiKeyMarker, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-FBcy_Qfy.js";
import { t as resolveEnvApiKey } from "./model-auth-env-A1L7-zzy.js";
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-Be7PFpxD.js";
import "./workspace-JRdJwRI9.js";
import { t as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-CgfCs4MA.js";
...
import { n as isRich } from "./list.format-U1Ln-Tn8.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-DcJXTwDt.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-CH152fEo.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-F7J6LAy5.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-DG-BI4zD.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-BWKJ_KJB.js");
		runtime.log("");
