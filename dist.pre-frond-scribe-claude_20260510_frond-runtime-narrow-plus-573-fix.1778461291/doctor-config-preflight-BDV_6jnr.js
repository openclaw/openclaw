...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-BedkIX2f.js";
import { n as formatConfigIssueLines } from "./issue-format-BFLj-aOk.js";
import { t as note } from "./note-D74CYeMr.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-BZ-3LTlt.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BPPJYayx.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BMJNcHiy.js");
