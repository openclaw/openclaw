...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-DKR4wP5w.js";
...
import { p as normalizeThinkLevel } from "./thinking-BttBsIY6.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-DhpR2U5R.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-QWu31Qvp.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-ClRxJfOt.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-DSz4632-.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-CWynokUh.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-B80gzYOd.js";
...
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-7qlfPgY6.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-ki5Bz7zA.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-Dc56-05M.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-BOAw3ucZ.js";
import "./tts-dDpWHKxm.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CLNMUuqv.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-BKd2w2ZM.js";
import { t as resolveMemorySearchConfig } from "./memory-search-B0OBzLXv.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CsyhkEjT.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-C9alJP4r.js";
...
import { t as collectOption } from "./helpers-B8U2OeKc.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-CiIHtsVO.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-5wo3PO65.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-9WYyCiF5.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-D5b43lZd.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BJKRWCYQ.js");
