...
import { t as ConfiguredModelProviderRequest } from "./types.provider-request-CkNfdVWA.js";
import { n as RuntimeVersionEnv } from "./version-DDjhj-A7.js";
import { Api } from "@mariozechner/pi-ai";
...
type ProviderEndpointClass = "default" | "anthropic-public" | "cerebras-native" | "chutes-native" | "deepseek-native" | "github-copilot-native" | "groq-native" | "mistral-public" | "moonshot-native" | "modelstudio-native" | "openai-public" | "openai-codex" | "opencode-native" | "azure-openai" | "openrouter" | "xai-native" | "zai-native" | "google-generative-ai" | "google-vertex" | "local" | "custom" | "invalid";
