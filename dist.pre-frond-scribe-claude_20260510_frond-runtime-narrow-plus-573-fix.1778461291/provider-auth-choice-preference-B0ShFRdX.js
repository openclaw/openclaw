import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-CsNue971.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-DBNlOx50.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-C-1FNzrf.js");
