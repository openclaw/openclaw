...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Dn0qn0nC.js";
import "./tokens-DLuewk89.js";
import "./pi-embedded-helpers-BeUybACM.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-DcJEanAu.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-smWSRy2I.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-elVhccWB.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Cg6L7q7f.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-B_XxGKML.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-BiyS9te3.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-CddsF_WF.js");
