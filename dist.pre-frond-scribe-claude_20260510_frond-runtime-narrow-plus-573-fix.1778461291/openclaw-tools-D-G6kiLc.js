...
import { o as redactToolPayloadText } from "./redact-BWh2xM0E.js";
...
import { p as FsSafeError } from "./path-n_dSWDuU.js";
import { S as hasEncodedFileUrlSeparator, T as trySafeFileURLToPath, t as appendFileWithinRoot } from "./fs-safe-Cew-WMeL.js";
import { o as root } from "./secure-temp-dir-JZ25IoOE.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-927g1oFZ.js";
...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-DDEl6txh.js";
import { n as normalizeAccountId } from "./account-id-9_btbLFO.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CuQ3FxQd.js";
import { o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-DKR4wP5w.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-ByE5d_BM.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-ip_BGHgo.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-DRDj6LDM.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-wp4oMRmV.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DcfhjO35.js";
import { a as normalizeDiagnosticTraceparent, t as DIAGNOSTIC_TRACEPARENT_PATTERN } from "./diagnostic-trace-context-pure-DT_YEIKj.js";
import "./diagnostic-trace-context-daKTvE-j.js";
import { t as createSubsystemLogger } from "./subsystem-CqiJqOXy.js";
import { t as logDebug } from "./logger-Db97zCjA.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BedkIX2f.js";
import { h as isWindowsDrivePath } from "./archive-BNeBJNaB.js";
import { t as applyMergePatch } from "./merge-patch-DrpNShJs.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-CO_gFTwv.js";
...
import { n as isRestartEnabled } from "./commands.flags-CJRplU10.js";
import { o as normalizeChannelId } from "./registry-BkmpEVNf.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-hxEKPnNB.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-va32v0dz.js";
import { u as normalizeMessageChannel } from "./message-channel-JLy5SBEA.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-CkJyQDKU.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-f0tQe4pr.js";
import { i as callGateway } from "./call-ClRxJfOt.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-D5nkerQx.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-BtnT6nhT.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-L6jCPFJ9.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DJVWZi1F.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CQN3oihN.js";
import { h as stringifyRouteThreadId } from "./channel-route-BmTwCX3N.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-C8y2NLNP.js";
import { f as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-D3JA5WV4.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-xj8wnFVP.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BOraiHN0.js";
import { n as mergeSessionEntry } from "./types-fKBR2yXy.js";
import { s as updateSessionStore } from "./store-DhSIRxgg.js";
import "./plugins-SoiUKHdH.js";
import { a as extractDeliveryInfo } from "./sessions-BthwPU0r.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DPuTz-lc.js";
import { h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as modelKey, y as normalizeModelRef } from "./model-selection-shared-BCJZ6pnb.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent, t as buildAllowedModelSet } from "./model-selection-B80gzYOd.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-yydTZYZz.js";
import "./auth-profiles-BUPPNY8D.js";
import { t as resolveApiKeyForProfile } from "./oauth-D-bXfK9j.js";
import { n as listProfilesForProvider } from "./profile-list-CKap0zUS.js";
import { r as resolveAuthProfileOrder } from "./order-DWUXLTag.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-4AKT-Ze_.js";
import { r as getApiKeyForModel } from "./model-auth-Be7PFpxD.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-evY6bkAC.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DRjtd6Gy.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-b5O2h4JR.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES, s as normalizeSubagentTaskName } from "./subagent-spawn-C1hBScBl.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-C2VBfR58.js";
import { n as ensureOpenClawModelsJson } from "./models-config-DcwDttZ3.js";
import { r as loadModelCatalog } from "./model-catalog-DtVjvfsX.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-Db1xIVtq.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-NrT64TZT.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CN5v5qqj.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DGRY_v6j.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-C0ipDjSj.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-zdOkUkjo.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-Dv3fBSEg.js";
import { n as extractTextFromChatContent } from "./chat-content-DmXVwB-K.js";
import { r as stripToolMessages } from "./chat-history-text-B8YEkjLF.js";
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-DqEiGB9Y.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DLuewk89.js";
import { t as deriveSessionChatTypeFromKey } from "./session-chat-type-shared-BdcL9Ta3.js";
import "./targeting-DDzg2J7p.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-DNb-sMEv.js";
import { i as resolveMaxDelegatesPerTurn } from "./config-Cpn_pxS-.js";
import { a as getImageMetadata } from "./image-ops-7qlfPgY6.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images--o5rZQPu.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-ki5Bz7zA.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-BBbKLF3r.js";
import { a as resolvePluginTools } from "./tools-LRfQdPnA.js";
import { n as assertSandboxPath } from "./sandbox-paths-Dl07qwai.js";
import "./local-file-access-DdPYH6zg.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BmnhCQSX.js";
import { f as listAllChannelSupportedActions, l as wrapToolWithBeforeToolCallHook, m as listChannelSupportedActions, s as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-BAsFa_dg.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-3_26S-Cy.js";
import { n as extractAssistantText } from "./pi-embedded-utils-CdQCwwSE.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-_x3pECJI.js";
import { n as runWithImageModelFallback } from "./model-fallback-olxsy09f.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-I1rrggYG.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-BOb9qduE.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-MPA8POBK.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-Bsa_MJqg.js";
...
import "./delivery-context-C94ZbjvB.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-CznJPeau.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-CuA66K2C.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-CT8IThAo.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-91vdcTNw.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DOhLm8r_.js";
import { t as inferLegacyName } from "./normalize-CsWTyeYK.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-DRZWB755.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-CkjmeDD4.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-B1JP2muM.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-6Q35z53-.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-J9Ub5Y50.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BIRuiDS0.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-pwQzIZDH.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-CV-DqIj8.js";
import { u as saveMediaBuffer } from "./store-DXDe4iqX.js";
import { t as SsrFBlockedError } from "./ssrf-jPQ1XkmH.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-g34d28cX.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-C9z7roe6.js";
import { r as getDefaultLocalRoots } from "./local-media-access-Ciopz7IS.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-DbPdoDhj.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-D7Y1Nq6M.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Dkw1311d.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CLoto8yX.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-B244JAyZ.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-Bi5epbx1.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-jpiKQA9P.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-Dc56-05M.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-1fJqYbyx.js";
import { s as resolveTimeoutMs } from "./resolve-BDVCaodp.js";
import { t as buildProviderRegistry } from "./runner-Dhd5rC6c.js";
import "./media-understanding-B_k-85tv.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CRZDWUlO.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-Bbtv3HZ1.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-DZHXgs9s.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-BWD_oaqx.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-DVFKxzi5.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-PZ4UvoHL.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-C344-GF9.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-D0m1qS2M.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-vgQV58eY.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-4jLqVRCj.js";
import { t as parseTimeoutMs } from "./parse-timeout-DuWi7NL1.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-DJHusLuD.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BzgTsgxS.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-C1c2XuMA.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DDu1Rt7g.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Dk9dbbKe.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-Bfnj70nG.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-CqcADVPc.js";
import { p as registerSubagentRun } from "./subagent-registry-BBlEhFBs.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-LGc80efa.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DGY8ZCW8.js";
import { k as textToSpeech } from "./tts-runtime-BOAw3ucZ.js";
import "./tts-dDpWHKxm.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-DS10xX0C.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-Cj4pMxxK.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CLNMUuqv.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BD_PCFYe.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-B_rFRTIi.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-BUdLbWhL.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-C5LIhU2e.js";
import { i as runWebSearch } from "./runtime-BKd2w2ZM.js";
import "./web-search-provider-common-DNPnI-7W.js";
...
const log$8 = createSubsystemLogger("continuation/delegate-tool");
...
const ContinueDelegateToolSchema = Type.Object({
	...
	traceparent: Type.Optional(Type.String({
		description: "Optional W3C traceparent carrier. When supplied by an instrumented upstream caller, the delegate and return path can stitch continuation spans into the same trace tree.",
...
function createContinueDelegateTool(opts) {
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const traceparent = traceparentRaw !== void 0 ? normalizeDiagnosticTraceparent(traceparentRaw) : void 0;
			if (traceparentRaw !== void 0 && !traceparent) throw new ToolInputError("traceparent must be a valid W3C traceparent header.");
			...
			log$8.debug(`[continue_delegate:enqueue] session=${sessionKey} mode=${mode} delayMs=${delayMs} fanoutMode=${fanoutMode ?? "none"} targets=${targetSessionKeys?.length ?? (targetSessionKey ? 1 : 0)} task=${task.slice(0, 80)}`);
...
const log$7 = createSubsystemLogger("continuation/continue-work");
...
function createContinueWorkTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			log$7.debug(`[continue_work:request] session=${sessionKey} delaySeconds=${delaySeconds} reason=${reason.slice(0, 80)}`);
...
function assertCronSelfRemoveScope(opts, action, params) {
	...
	if (action !== "remove") throw new Error(CRON_SELF_REMOVE_SCOPE_ERROR);
...
function createImageGenerateTool(options) {
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			const params = args;
			if (resolveAction$2(params) === "list") return createImageGenerateListActionResult({
				cfg,
				agentDir: options?.agentDir,
				authStore: options?.authProfileStore
			});
...
function appendMessageToolVisibleReplyHint(description, sourceReplyDeliveryMode, requireExplicitTarget) {
	...
	return `${description} For this turn, visible replies to the current source conversation must use action="send" with message. ${requireExplicitTarget ? "Include target when sending." : "The target defaults to the current source conversation, so omit target unless sending elsewhere."} Normal final answers are private and are not posted.`;
}
...
const log$4 = createSubsystemLogger("agents/tools/media-generate-background-shared");
...
function createMediaGenerationTaskRun(params) {
	...
	try {
		...
		log$4.warn("Failed to create media generation task ledger record", {
			sessionKey,
...
function buildMediaGenerationReplyInstruction(params) {
	if (params.status === "ok") {
		if (params.requiresMessageToolDelivery) return [
...
function inferMediaGenerationCompletionChatType(handle) {
	const sessionKeyChatType = deriveSessionChatTypeFromKey(handle.requesterSessionKey);
	if (sessionKeyChatType !== "unknown") return sessionKeyChatType;
	const to = handle.requesterOrigin?.to?.trim().toLowerCase();
	if (to?.startsWith("group:")) return "group";
	if (to?.startsWith("channel:")) return "channel";
	if (to?.startsWith("dm:") || to?.startsWith("direct:")) return "direct";
	return "unknown";
}
function mediaGenerationCompletionRequiresMessageToolDelivery(params) {
	...
	if (chatType === "group" || chatType === "channel") return (params.config?.messages?.groupChat?.visibleReplies ?? params.config?.messages?.visibleReplies) !== "automatic";
...
async function wakeMediaGenerationTaskCompletion(params) {
	...
	if (!delivery.delivered && delivery.error) log$4.warn("Media generation completion wake failed", {
...
function defaultScheduleMusicGenerateBackgroundWork(work) {
	queueMicrotask(() => {
		work().catch((error) => {
			log$3.error("Detached music generation job crashed", { error });
		});
	});
}
				...
				scheduleBackgroundWork(async () => {
					try {
						...
						try {
							...
							log$3.warn("Music generation completion wake failed after successful generation", {
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-JXQ1R-gW.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CBw2iO6Z.js"));
...
function defaultScheduleVideoGenerateBackgroundWork(work) {
	queueMicrotask(() => {
		work().catch((error) => {
			log$1.error("Detached video generation job crashed", { error });
		});
	});
}
				...
				scheduleBackgroundWork(async () => {
					try {
						...
						try {
							...
							log$1.warn("Video generation completion wake failed after successful generation", {
								taskId: taskHandle?.taskId,
								runId: taskHandle?.runId,
								error
							});
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-BxQVRknc.js"));
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-zgdKM0IC.js"));
...
//#endregion
export { sniffMimeFromBase64 as C, stripProviderPrefix as D, isStrictAgenticSupportedProviderModel as E, isEmbeddedMode as O, wrapToolWorkspaceRootGuardWithOptions as S, isStrictAgenticExecutionContractActive as T, createSandboxedReadTool as _, generateMusic as a, wrapToolMemoryFlushAppendOnlyWrite as b, normalizeCronJobCreate as c, resolveToolLoopDetectionConfig as d, createHostWorkspaceAppendTool as f, createSandboxedEditTool as g, createOpenClawReadTool as h, buildActiveMusicGenerationTaskPromptContextForSession as i, setEmbeddedMode as k, normalizeCronJobInput as l, createHostWorkspaceWriteTool as m, buildActiveVideoGenerationTaskPromptContextForSession as n, listRuntimeMusicGenerationProviders as o, createHostWorkspaceEditTool as p, isParentOwnedBackgroundAcpSession as r, listSupportedMusicGenerationModes as s, createOpenClawTools as t, normalizeCronJobPatch as u, createSandboxedWriteTool as v, resolveOpenClawPluginToolsForOptions as w, wrapToolWorkspaceRootGuard as x, wrapToolMemoryDayFileWriteGuard as y };
