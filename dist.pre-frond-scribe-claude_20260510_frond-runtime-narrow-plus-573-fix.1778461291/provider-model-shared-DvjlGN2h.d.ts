...
import { Jt as ProviderPlugin, Rn as ProviderThinkingProfile, Sn as ProviderSanitizeReplayHistoryContext, an as ProviderReasoningOutputMode, cn as ProviderReplayPolicyContext, mn as ProviderResolveDynamicModelContext, qr as ProviderSystemPromptContribution, sn as ProviderReplayPolicy, zn as ProviderRuntimeModel } from "./types-BYigPDoy.js";
...
declare function getModelProviderHint(modelId: string): string | null;
declare function isProxyReasoningUnsupportedModelHint(modelId: string): boolean;
declare function isClaudeOpus47ModelId(modelId: string): boolean;
...
//#endregion
export { normalizeAntigravityPreviewModelId as A, resolveTaggedReasoningOutputMode as B, GPT5_HEARTBEAT_PROMPT_OVERLAY as C, renderGpt5PromptOverlay as D, normalizeGpt5PromptOverlayMode as E, buildHybridAnthropicOrOpenAIReplayPolicy as F, buildNativeAnthropicReplayPolicyForModel as I, buildOpenAICompatibleReplayPolicy as L, normalizeNativeXaiModelId as M, buildAnthropicReplayPolicyForModel as N, resolveGpt5PromptOverlayMode as O, buildGoogleGeminiReplayPolicy as P, buildPassthroughGeminiSanitizingReplayPolicy as R, GPT5_FRIENDLY_PROMPT_OVERLAY as S, isGpt5ModelId as T, sanitizeGoogleGeminiReplayHistory as V, normalizeModelCompat as _, ProviderReplayFamily as a, GPT5_BEHAVIOR_CONTRACT as b, isClaudeAdaptiveThinkingDefaultModelId as c, resolveClaudeThinkingProfile as d, cloneFirstTemplateModel as f, hasToolSchemaProfile as g, hasNativeWebSearchTool as h, PASSTHROUGH_GEMINI_REPLAY_HOOKS as i, normalizeGooglePreviewModelId as j, resolveGpt5SystemPromptContribution as k, isClaudeOpus47ModelId as l, applyModelCompatPatch as m, NATIVE_ANTHROPIC_REPLAY_HOOKS as n, buildProviderReplayFamilyHooks as o, matchesExactOrPrefix as p, OPENAI_COMPATIBLE_REPLAY_HOOKS as r, getModelProviderHint as s, ANTHROPIC_BY_MODEL_REPLAY_HOOKS as t, isProxyReasoningUnsupportedModelHint as u, resolveToolCallArgumentsEncoding as v, Gpt5PromptOverlayMode as w, GPT5_FRIENDLY_CHAT_PROMPT_OVERLAY as x, resolveUnsupportedToolSchemaKeywords as y, buildStrictAnthropicReplayPolicy as z };