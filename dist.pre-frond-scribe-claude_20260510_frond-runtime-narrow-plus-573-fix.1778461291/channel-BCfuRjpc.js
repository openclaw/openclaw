...
import { n as isSingleUseReplyToMode } from "./reply-reference-BQPVyqtY.js";
...
import { c as normalizeInteractiveReply, l as normalizeMessagePresentation } from "./payload-BfArbl7M.js";
import { n as resolveOutboundSendDep } from "./send-deps-Bj40e9JV.js";
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-C5msK1mQ.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-tevz65vc.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-CR4_JSwo.js";
import "./text-runtime-CEUy8PW0.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-DgePbJ7i.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-9Rt44N40.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-B0QfmGBS.js";
import "./approval-delivery-runtime-ColzwyRR.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-ghITmtwn.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-CI-LN-5K.js";
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-HbxDBEwF.js";
import "./approval-native-runtime-B28IA67w.js";
import "./reply-reference-BskxBsLS.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-BMYnc6b9.js";
...
import { i as createPairingPrefixStripper } from "./channel-pairing-DX2KqVMh.js";
import { i as createAttachedChannelResultAdapter } from "./channel-send-result-DelGb_jZ.js";
import "./param-readers-BSVxnSr9.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-DJWYx_8o.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-Ldxto5gQ.js";
...
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-B9vogaaz.js";
import { n as resolveSlackThreadTsValue, r as SLACK_TEXT_LIMIT, t as normalizeSlackThreadTsCandidate } from "./thread-ts-mkAopW90.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-Bst52QxU.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-DBDTeeU1.js";
import "./channel-api-BbH2Wuky.js";
import { r as createSlackWebClient } from "./client-Ci_IqxFr.js";
import { r as normalizeAllowListLower } from "./allow-list-MqbHX_z3.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-CgtYTaSE.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-xwbOvKW-.js";
import { t as getOptionalSlackRuntime } from "./runtime-DdWO-Tp1.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-UyzGqlJz.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-DsfeMhBm.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-xvuAmyrN.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-CwdxXtke.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-DPNLqTW0.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-KB9lNF0G.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-Iqsl-G5K.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CNn-awoR.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DOwjrapR.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-DB5RxuCQ.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-_KYMhjzA.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-D1HDw_c2.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-DVzbraOz.js");
