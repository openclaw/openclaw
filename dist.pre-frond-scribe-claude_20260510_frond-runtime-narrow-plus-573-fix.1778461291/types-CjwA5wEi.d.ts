import { a as PromptMode, d as AgentStreamParams, f as ClientToolDefinition, l as AgentInternalEvent } from "./params-DQpvmtuc.js";
import { c as PromptImageOrderEntry, n as ContinuationTrigger } from "./get-reply-options.types-eDPD5YMs.js";
import { t as InputProvenance } from "./input-provenance-BI4Bdq3c.js";
import { O as ChannelOutboundTargetMode } from "./types.core-CQScvK0N.js";
...
type AgentCommandOpts = {
  ...
  runContext?: AgentRunContext; /** Whether this caller is authorized for owner-only tools (defaults true for local CLI calls). */
