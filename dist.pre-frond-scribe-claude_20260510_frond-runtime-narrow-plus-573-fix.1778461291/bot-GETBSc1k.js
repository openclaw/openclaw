...
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey } from "./session-key-CuQ3FxQd.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-DKR4wP5w.js";
...
import { u as fireAndForgetHook } from "./hook-runner-global-Dn0qn0nC.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-CQN3oihN.js";
...
import { t as resolveAndPersistSessionFile } from "./session-file-CLCPHUX4.js";
...
import { S as findModelInCatalog, r as buildConfiguredModelCatalog } from "./model-selection-shared-BCJZ6pnb.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent } from "./model-selection-B80gzYOd.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DRjtd6Gy.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-DtVjvfsX.js";
import { f as findCodeRegions, p as isInsideCode, u as stripReasoningTagsFromText } from "./assistant-visible-text-Dv3fBSEg.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-CAGPnpze.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-CdQCwwSE.js";
import { c as projectOutboundPayloadPlanForDelivery, i as createOutboundPayloadPlan } from "./deliver-DJCQ6qFt.js";
import { C as resolveChannelStreamingPreviewToolProgress, a as createChannelProgressDraftGate, c as formatChannelProgressDraftText, h as resolveChannelProgressDraftMaxLines, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName, v as resolveChannelStreamingBlockEnabled } from "./channel-streaming-0CxTMwCk.js";
import { n as MediaFetchError } from "./fetch-CzXiJg9t.js";
...
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-CVRx7IVf.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-D4-hvVxC.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-Okqfsan8.js";
import { n as createPreviewMessageReceipt } from "./live-C8G0jsyc.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-C5msK1mQ.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-DkMseGuz.js";
...
import { n as listChatCommands } from "./commands-registry-list-DlXn8ylf.js";
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-C97moQJ1.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-Cxt-D3bI.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-EUXdTG7f.js";
import "./text-runtime-CEUy8PW0.js";
import "./routing-BP67xEzz.js";
import { a as getPluginCommandSpecs } from "./commands-BjUf0B-z.js";
...
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-INQ-M0VM.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-w6ta5_fP.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-Bfi0L8nO.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-Clp6iiy-.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-HRkr5Z-Y.js";
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-CmlwcX4x.js";
...
import "./hook-runtime-CSTeOVzO.js";
import "./markdown-table-runtime-6PfhKLQ5.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-BHpzp1I5.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-Dm7EPRf5.js";
import "./command-auth-native-DjnxflQ_.js";
import "./command-primitives-runtime-BjmoZV8J.js";
import "./command-status-BD02cw_Z.js";
import "./command-detection-uU5jWnOf.js";
import "./command-surface-Hw4B2qlv.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-BKsFuiAg.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-DQNZZXP1.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-HtT6SSTJ.js";
...
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-BUjJBjkV.js";
import { A as resolveTelegramReplyId, B as hasBotMention, C as isTelegramCommandsAllowFromConfigured, D as resolveTelegramForumFlag, E as resolveTelegramDirectPeerId, F as buildSenderLabel, G as expandTelegramAllowFromWithAccessGroups, H as normalizeForwardedContext, I as buildSenderName, J as normalizeAllowFrom, K as resolveTelegramDmAllow, L as expandTextLinks, M as resolveTelegramThreadSpec, N as shouldUseTelegramDmThreadSession, O as resolveTelegramForumThreadId, P as withResolvedTelegramForumFlag, R as extractTelegramLocation, S as extractTelegramForumFlag, T as resolveTelegramCommandAuthorization, W as resolveTelegramPrimaryMedia, X as resolveSenderAllowMatch, Y as normalizeDmAllowFromWithStore, Z as resolveTelegramEffectiveDmPolicy, _ as buildTelegramParentPeer, b as buildTypingThreadParams, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as resolveTelegramStreamMode, k as resolveTelegramGroupAllowFromContext, m as buildGroupLabel, p as tagTelegramNetworkError, q as isSenderAllowed, t as markdownToTelegramChunks, v as buildTelegramRoutingTarget, x as describeReplyTarget, y as buildTelegramThreadParams, z as getTelegramTextParts } from "./format-BdZyv-rN.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-hJaObwyJ.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-B4_Bc_mL.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-CEBCALXm.js";
import { n as resolveTelegramRequestTimeoutMs } from "./request-timeouts-Dt2VBAK0.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-Q6J6IkuG.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-BYSzZ8O1.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-Dy2kBXhP.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-CONMvR2g.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-BhcXgAyf.js";
import { C as withTelegramApiErrorLogging, D as sequentialize, E as apiThrottler, T as Bot, a as editMessageTelegram, g as recordSentMessage, w as getOrCreateAccountThrottler, x as buildInlineKeyboard } from "./send-Duz8NgL-.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-DRJfUZ1H.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-DdKKPVjT.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-BRB0exGY.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-Bn0cEK4y.js");
...
const registerTelegramHandlers = ({ cfg, accountId, bot, opts, telegramTransport, runtime, mediaMaxBytes, telegramCfg, allowFrom, groupAllowFrom, resolveGroupPolicy, resolveTelegramGroupConfig, shouldSkipUpdate, processMessage, logger, telegramDeps }) => {
	...
	const buildPromptContextForMessage = (msg, replyChainNodes) => {
		...
		const entries = [];
		if (replyTargetWindow.length > 0) entries.push({
			...
			payload: {
				...
				messages: replyTargetWindow.map((node) => toPromptContextMessage(node, { replyTarget: node.messageId === replyTargetId }))
			}
		});
		if (currentWindow.length > 0) entries.push({
...
async function buildTelegramInboundContextPayload(params) {
	...
	const ctxPayload = sessionRuntime.finalizeInboundContext({
		...
		UntrustedStructuredContext: promptContext.length > 0 ? promptContext : void 0,
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-D2M-8y66.js")).defaultTelegramBotDeps;
