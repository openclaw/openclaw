import { c as readErrorName, i as formatErrorMessage } from "./errors-D0hgXIu9.js";
import { n as createLazyPromiseLoader, t as createLazyImportLoader } from "./lazy-promise-B6on3yPt.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-DJVWZi1F.js";
import { u as resolveStorePath } from "./paths-CQN3oihN.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-C8y2NLNP.js";
import { t as loadSessionStore } from "./store-load-D3JA5WV4.js";
import { m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-DhSIRxgg.js";
import "./sessions-BthwPU0r.js";
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-C9811DR2.js";
import { A as SUBAGENT_ENDED_REASON_KILLED, C as getSubagentSessionStartedAt, D as SUBAGENT_ENDED_OUTCOME_TIMEOUT, E as SUBAGENT_ENDED_OUTCOME_KILLED, M as subagentRuns, O as SUBAGENT_ENDED_REASON_COMPLETE, S as getSubagentSessionRuntimeMs, T as SUBAGENT_ENDED_OUTCOME_ERROR, a as countActiveDescendantRunsFromRuns, b as isStaleUnendedSubagentRun, c as countPendingDescendantRunsFromRuns, f as listDescendantRunsForRequesterFromRuns, j as SUBAGENT_TARGET_KIND_SUBAGENT, k as SUBAGENT_ENDED_REASON_ERROR, l as getSubagentRunByChildSessionKeyFromRuns, n as persistSubagentRunsToDisk, o as countActiveRunsForSessionFromRuns, p as listRunsForControllerFromRuns, r as restoreSubagentRunsFromDisk, t as getSubagentRunsSnapshotForRead, w as resolveSubagentSessionStatus } from "./subagent-registry-state-BRi7z0Mb.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-9VdtqbhN.js";
import { a as isSilentReplyText } from "./tokens-DLuewk89.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-R3kK1n_P.js";
import "./pi-bundle-mcp-tools-BRIo-7OK.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-DDkFnpJ6.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-C344-GF9.js";
import "./subagent-announce-queue-CuxY7LEt.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-Bfnj70nG.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-CqcADVPc.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-COBJGQf8.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-vIkK8WCD.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-CqN7p4vZ.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-vIkK8WCD.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-x-RxQ4mg.js").then(({ scheduleOrphanRecovery }) => {
