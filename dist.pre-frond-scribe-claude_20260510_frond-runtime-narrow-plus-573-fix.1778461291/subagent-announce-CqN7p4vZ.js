...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-Cz0PjVYb.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-zSUAM1uY.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-De4tDU5O.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DLuewk89.js";
import { i as consumePendingDelegates } from "./delegate-store-DNb-sMEv.js";
import "./continuation-delegate-store-C3AKTNfv.js";
import { n as resolveContinuationRuntimeConfig } from "./config-Cpn_pxS-.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-_x3pECJI.js";
import "./delivery-context-C94ZbjvB.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-D0m1qS2M.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-CqcADVPc.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-B3sAgdld.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-CXjCOKcu.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-DY1W9NSh.js"), import("./store-load-CCqmpwG-.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-DuQYemg2.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-CdDFGT4y.js");
			const { createSubsystemLogger } = await import("./subsystem-DaaOoWto.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-DsIanvVe.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
