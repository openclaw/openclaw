...
import { s as loadAuthProfileStoreForRuntime } from "./store-DSz4632-.js";
import { n as resolvePluginProviders } from "./providers.runtime-B-D3xTkv.js";
import "./model-selection-shared-BCJZ6pnb.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-CnwDcRKn.js";
import { n as clearAuthProfileCooldown } from "./usage-CQu2RZKp.js";
import "./workspace-JRdJwRI9.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-CN0DCclT.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-CgfCs4MA.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-COT4-P1C.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DJTiLb4k.js";
import { t as isRemoteEnvironment } from "./remote-env-Dk_n7ick.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-jvRecIu_.js");
				await openUrl(url);
			},
