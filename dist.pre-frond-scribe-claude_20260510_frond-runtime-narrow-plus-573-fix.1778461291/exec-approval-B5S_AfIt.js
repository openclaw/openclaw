...
import { Oi as ErrorCodes, X as validateExecApprovalRequestParams, Y as validateExecApprovalGetParams, Z as validateExecApprovalResolveParams, ki as errorShape, t as formatValidationErrors } from "./protocol-BZ5ZNWBJ.js";
import { i as detectCommandCarrierArgv, o as detectInlineEvalInSegments } from "./risks-DLQ5yOP9.js";
import { D as resolveExecApprovalRequestAllowedDecisions, E as resolveExecApprovalAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-Dv7ri0j1.js";
import { n as sanitizeExecApprovalDisplayText, r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BeYuNRyf.js";
import "./extract-0jPyDhJc.js";
import { t as analyzeCommandForPolicy } from "./policy-k6TVYX8i.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DboKJG25.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-BCgXRJWS.js";
import { a as resolvePendingApprovalRecord, i as isApprovalDecision, n as handleApprovalWaitDecision, o as respondPendingApprovalLookupError, r as handlePendingApprovalRequest, t as handleApprovalResolve } from "./approval-shared-re6LJrgc.js";
...
function createExecApprovalHandlers(manager, opts) {
	return {
		...
		"exec.approval.request": async ({ params, respond, context, client }) => {
			...
			const commandSpans = sanitizedCommandText === effectiveCommandText ? normalizeCommandSpans(p.commandSpans, sanitizedCommandText.length) : void 0;
