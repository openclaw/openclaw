...
import { c as readErrorName, i as formatErrorMessage, r as extractErrorCode } from "./errors-D0hgXIu9.js";
import { t as resolveGlobalMap } from "./global-singleton-Bq6e5lAP.js";
import { t as createAsyncLock } from "./async-lock-9gkUwD0H.js";
import { E as pathExists } from "./fs-safe-Cew-WMeL.js";
import { t as appendRegularFile } from "./regular-file-DALnZfAX.js";
import { n as replaceFileAtomic } from "./replace-file-B1BuG9mC.js";
import { t as privateFileStore } from "./private-file-store-CeulPbdH.js";
import { i as getRuntimeConfig } from "./io-BedkIX2f.js";
import { n as asNullableRecord } from "./record-coerce-liSYBwd-.js";
import { J as resolveMemoryDreamingWorkspaces, V as formatMemoryDreamingDay, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-JYtgNcqB.js";
import { p as parseUsageCountedSessionIdFromFileName } from "./artifacts-DzKf6k3j.js";
...
import { t as RequestScopedSubagentRuntimeError } from "./error-runtime-RR9SPa4x.js";
import "./async-lock-runtime-ScDpBPnx.js";
import "./runtime-config-snapshot-k67uo1ty.js";
import "./security-runtime-xUFanVUG.js";
import "./session-store-runtime-Bftap8jo.js";
import { c as buildSessionEntry, d as loadSessionTranscriptClassificationForAgent, f as normalizeSessionTranscriptPathForComparison, l as listSessionFilesForAgent, p as sessionPathForFile } from "./engine-qmd-BpM8dz4q.js";
import "./memory-core-host-engine-qmd-C9-bh3Ad.js";
import { n as appendMemoryHostEvent } from "./events-Ddh-cDNc.js";
import "./memory-core-host-status-NI9YRoTN.js";
import "./memory-core-host-runtime-core-DA8m-RvD.js";
import "./memory-host-events-BLZqWv3G.js";
import { n as withTrailingNewline, t as replaceManagedMarkdownBlock } from "./memory-host-markdown-B6V3yR-3.js";
import "./dreaming-shared-BQXc4Dpn.js";
import { i as filterLiveShortTermRecallEntries, l as recordShortTermRecalls, o as readShortTermRecallEntries, s as recordDreamingPhaseSignals } from "./short-term-promotion-BO-KaElv.js";
...
async function scrubDreamingNarrativeArtifacts(logger) {
	...
	for (const agentEntry of agentEntries) {
		...
		for (const [key, entry] of Object.entries(store)) {
			...
			if (!normalizedSessionFile || !await pathExists(normalizedSessionFile)) needsStoreUpdate = true;
		}
		if (needsStoreUpdate) {
