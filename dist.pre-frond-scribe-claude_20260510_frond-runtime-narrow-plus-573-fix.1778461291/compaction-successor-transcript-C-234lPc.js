...
import { a as hasInterSessionUserProvenance, i as applyInputProvenanceToUserMessage, r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-f0tQe4pr.js";
import { S as getCompactionProvider } from "./loader-L6jCPFJ9.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Dn0qn0nC.js";
import { S as createExpiringMapCache, T as resolveCacheTtlMs, w as isCacheEnabled } from "./store-load-D3JA5WV4.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-WgHlH1S0.js";
import { A as resolveProviderReasoningOutputModeWithPlugin, E as resolveProviderCacheTtlEligibility, U as sanitizeProviderReplayHistoryWithPlugin, q as validateProviderReplayTurnsWithPlugin } from "./provider-runtime-DPuTz-lc.js";
...
import { a as makeZeroUsageSnapshot, o as normalizeUsage } from "./usage-DrhWhHCt.js";
import { S as firstEnumerableOwnKeys, w as jsonUtf8BytesOrInfinity, x as boundedJsonUtf8Bytes } from "./session-utils.fs-Db1xIVtq.js";
...
import { _ as sanitizeGoogleTurnOrdering, c as downgradeOpenAIFunctionCallReasoningPairs, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns } from "./pi-embedded-helpers-BeUybACM.js";
...
import { c as runBeforeToolCallHook, g as resolveChannelPromptCapabilities, o as isBeforeToolCallBlockedError, r as buildBlockedToolResult, s as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-BAsFa_dg.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-Db49hsXk.js";
import "./logger-DM7utI1X.js";
import { a as pruneHistoryForContextShare, h as formatContextLimitTruncationNotice, i as estimateMessagesTokens, m as truncateToolResultMessage, n as SUMMARIZATION_OVERHEAD_TOKENS, o as resolveContextWindowTokens$1, r as computeAdaptiveChunkRatio, s as summarizeInStages, u as resolveLiveToolResultMaxChars } from "./compaction-ogD2h2Ys.js";
import { a as resolveEffectiveCompactionMode } from "./pi-settings-c-8q9cPM.js";
import { f as payloadTextResult, l as jsonResult } from "./common-BOb9qduE.js";
import { r as wrapUntrustedPromptDataBlock } from "./sanitize-for-prompt-BAT1czCP.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-CoqIS1-4.js";
...
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-C6XBAZy8.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-raJu0SUI.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-UgDW-Dl6.js";
...
import { D as isAnthropicFamilyCacheTtlEligible, O as isAnthropicModelRef } from "./provider-stream-shared-CN5xC3-5.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-BQoNuMfu.js";
...
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-ChKHi8qv.js";
import "./query-C_oscfrG.js";
