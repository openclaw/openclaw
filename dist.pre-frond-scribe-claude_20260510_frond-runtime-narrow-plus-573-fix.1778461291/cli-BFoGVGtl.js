...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-B9ADeYPD.js";
import { n as matrixSetupAdapter } from "./setup-core-D17A6wbb.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-CmfgA8jN.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-DfeZCX4O.js";
import { t as withResolvedActionClient } from "./client-CH_C4hwZ.js";
import { r as resolveMatrixAuthContext } from "./config-jP2Pem7D.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-gHV65uLe.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-HgRV8h1g.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-B4aNB1Cy.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-kI-DtTkH.js");
