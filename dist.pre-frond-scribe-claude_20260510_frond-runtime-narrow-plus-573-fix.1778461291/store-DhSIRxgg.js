...
import { t as writeTextAtomic } from "./json-files-DwmWdZ19.js";
import { t as createSubsystemLogger } from "./subsystem-CqiJqOXy.js";
import { l as listDeliverableMessageChannels, u as normalizeMessageChannel } from "./message-channel-JLy5SBEA.js";
import { a as isSessionArchiveArtifactName, c as isTrajectorySessionArtifactName, i as isPrimarySessionTranscriptFileName, r as isCompactionCheckpointTranscriptFileName } from "./artifacts-DzKf6k3j.js";
import { i as resolveSessionFilePath } from "./paths-CQN3oihN.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-C8y2NLNP.js";
import { C as getFileStatSnapshot, _ as getSerializedSessionStore, a as getActiveSessionMaintenanceWarning, b as takeMutableSessionStoreCache, c as pruneStaleEntries, g as dropSessionStoreObjectCache, i as capEntryCount, m as clearSessionStoreCaches, n as normalizeSessionStore, o as isProtectedSessionMaintenanceEntry, r as resolveMaintenanceConfig, s as pruneQuotaSuspensions, t as loadSessionStore, u as shouldRunSessionEntryMaintenance, v as isSessionStoreCacheEnabled, x as writeSessionStoreCache, y as setSerializedSessionStore } from "./store-load-D3JA5WV4.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin } from "./registry-xj8wnFVP.js";
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-fKBR2yXy.js";
import { t as normalizeChatType } from "./chat-type-UaOYCvWw.js";
import { t as resolveConversationLabel } from "./conversation-label-Ddb7qAAg.js";
import "./plugins-SoiUKHdH.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath } from "./paths-XYHqkWt4.js";
...
function resolveGroupSessionKey(ctx) {
	...
	const finalId = normalizeLowercaseStringOrEmpty(originatingGroupTargetId ? originatingGroupTargetId : headIsSurface ? secondIsKind ? parts.slice(2).join(":") : parts.slice(1).join(":") : from);
...
function loadTrajectoryCleanupRuntime() {
	trajectoryCleanupRuntimePromise ??= import("./cleanup--RQ3Dlbo.js");
...
//#endregion
export { resolveGroupSessionKey as C, buildGroupDisplayName as S, resolveSessionArtifactCanonicalPathsForEntry as _, saveSessionStore as a, deriveSessionOrigin as b, updateSessionStoreEntry as c, drainSessionStoreWriterQueuesForTest as d, getSessionStoreWriterQueueSizeForTest as f, pruneUnreferencedSessionArtifacts as g, enforceSessionDiskBudget as h, runQuotaSuspensionMaintenance as i, withSessionStoreWriterForTest as l, resolveSessionStoreEntry as m, readSessionUpdatedAt as n, updateLastRoute as o, normalizeStoreSessionKey as p, recordSessionMetaFromInbound as r, updateSessionStore as s, archiveRemovedSessionTranscripts as t, clearSessionStoreCacheForTest as u, deriveGroupSessionPatch as v, snapshotSessionOrigin as x, deriveSessionMetaPatch as y };
