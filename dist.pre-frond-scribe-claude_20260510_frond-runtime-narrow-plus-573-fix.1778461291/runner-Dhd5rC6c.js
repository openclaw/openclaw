...
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-ki5Bz7zA.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-Dc56-05M.js";
import { t as providerSupportsCapability } from "./provider-supports-CRWoeGTy.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-BDVCaodp.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-DZEfoir3.js";
import { t as buildRandomTempFilePath } from "./temp-download-BhqWTwlV.js";
import "./temp-path-BHlLpIGm.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-CzAvx7HV.js";
import "./shared-BsxeC-CP.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-Bg2uaXmz.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-D4451nOw.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-B8YlqZIs.js");
