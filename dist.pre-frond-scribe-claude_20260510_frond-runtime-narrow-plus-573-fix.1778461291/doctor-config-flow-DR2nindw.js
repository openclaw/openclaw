...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-BedkIX2f.js";
import { n as formatConfigIssueLines } from "./issue-format-BFLj-aOk.js";
import { r as normalizeTalkSection } from "./talk-BaJ811in.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-kjKUfT4R.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-CXrbWnIu.js";
import { n as getLoadedChannelPlugin } from "./registry-xj8wnFVP.js";
import { i as listRouteBindings } from "./bindings-BHSR4nGH.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-Bh79YhZT.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-DvXiksFX.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Dl2Puk-G.js";
import { t as note } from "./note-D74CYeMr.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-BZ-3LTlt.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-Is9oyo_0.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-CHD6c7Uk.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BDV_6jnr.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate--aE708Qw.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-YNDUJivk.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-B7lbyiht.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-vP4xM_92.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BySSO-eW.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-BLe8oVbN.js");
		emitDoctorNotes({
			note,
