...
import { a as ModelCompatConfig, i as ModelApi } from "./types.models-BbSYPJk1.js";
import { t as JsonSchemaObject } from "./json-schema.types-BYet9RVQ.js";
import { t as ChannelConfigRuntimeSchema } from "./types.config-C2bCroD4.js";
import { t as PluginManifestCommandAlias } from "./manifest-command-aliases-Br9IycUz.js";
...
type PluginManifestProviderAuthChoice = {
  ...
  groupId?: string;
  groupLabel?: string;
  groupHint?: string; /** Optional CLI flag metadata for one-flag auth flows such as API keys. */
  optionKey?: string;
  cliFlag?: string;
  cliOption?: string;
