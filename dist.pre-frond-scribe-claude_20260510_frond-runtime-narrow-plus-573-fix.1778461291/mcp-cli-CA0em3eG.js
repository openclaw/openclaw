...
import { r as extractFirstTextBlock } from "./chat-message-content-KEj42vTQ.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-BZMQOCZT.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-BD8eh2Sb.js"),
			import("./client-BQOaJkoi.js"),
			import("./client-start-readiness-Bgh7pbn2.js"),
			import("./method-scopes-CsMiI6KB.js"),
