...
import { t as require_src } from "./src-D-jXY5ua.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Br3PpEvG.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DOVZZGWR.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-D_ZfOIHn.js";
import { l as toRatio, n as decodeString } from "./Util-Ditillc2.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DTGzDFxs.js";
import { t as APEv2Parser } from "./APEv2Parser-DGajWjW2.js";
import { r as hasID3v1Header } from "./ID3v1Parser-_Bk_EI7i.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-Deqm9WQk.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Djgk7Tep.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BOxEiHN8.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BcWQ_76J.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DBo8jy-x.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CN8a7OG6.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-B1dyMt22.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-BLhrhu7l.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DFgnxW26.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DSeWLFh7.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DlcUOCm8.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-4AHC155A.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Cl-HUHX6.js")).WaveParser;
	}
};
//#endregion
