...
import { l as createScopedDmSecurityResolver, u as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-C5msK1mQ.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DgePbJ7i.js";
...
import { n as resolveInboundDirectDmAccessWithRuntime, t as createPreCryptoDirectDmAuthorizer } from "./direct-dm-access-Co6mMpLT.js";
...
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-BmNvhM-Y.js";
...
import { t as attachChannelToResult } from "./channel-send-result-DelGb_jZ.js";
import { t as zod_exports } from "./zod-CH7V6TB8.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-DxIZXrnV.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-CJFkhjK4.js";
...
const NostrBusStateSchema = zod_exports.z.object({
	...
	lastProcessedAt: NullableFiniteNumberSchema,
	gatewayStartedAt: NullableFiniteNumberSchema,
	recentEventIds: zod_exports.z.array(zod_exports.z.unknown()).catch([]).transform((ids) => ids.filter((id) => typeof id === "string"))
});
const NostrProfileStateSchema = zod_exports.z.object({
	...
	lastPublishResults: zod_exports.z.record(zod_exports.z.string(), zod_exports.z.enum([
		"ok",
		"failed",
		"timeout"
	])).nullable().catch(null)
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-CdFkdlS_.js");
