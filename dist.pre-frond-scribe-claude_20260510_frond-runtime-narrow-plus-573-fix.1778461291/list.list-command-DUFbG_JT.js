...
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-C3yZ-N1b.js";
import { b as parseModelRef, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, v as modelKey } from "./model-selection-shared-BCJZ6pnb.js";
import "./model-selection-B80gzYOd.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-FBcy_Qfy.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-Be7PFpxD.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-CgfCs4MA.js";
import { n as loadModelsConfigWithSource } from "./load-config-Du3m4gNo.js";
import { n as formatErrorWithStack } from "./list.errors-C8a-3Utu.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-U1Ln-Tn8.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-BoQsD-AK.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-CLBcDhnV.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-g1DacDzv.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DZ7jcNFb.js"),
		import("./agent-scope-DfwoQnoT.js"),
		import("./workspace-DJcUeyXF.js")
	]);
