...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-4-KuXw3z.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-ktVxzR-f.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-CO2i-MTL.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-Ceebh-al.js");
	if (params.argv) {
