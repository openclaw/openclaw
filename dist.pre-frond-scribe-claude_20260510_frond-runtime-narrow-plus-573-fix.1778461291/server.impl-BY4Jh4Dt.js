...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-CZe-2W0f.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-927g1oFZ.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-D1FEYvuZ.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-wp4oMRmV.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DcfhjO35.js";
...
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-CqiJqOXy.js";
...
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-ChovBn2k.js";
import { n as resolveGatewayAuth } from "./auth-resolve-C-sgxh1Y.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-BedkIX2f.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-BtAWmbQB.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-QWu31Qvp.js";
import "./method-scopes-CxQ1l6Zn.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-D5nkerQx.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Bp4JYBUF.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-DsnS2jud.js";
import { i as resolveMainSessionKey } from "./main-session-DeVPitJR.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-DGHZcIJq.js";
import "./sessions-BthwPU0r.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-NVIQAJIo.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-Dj7arlfF.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-BsK550my.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-CuA66K2C.js";
...
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-DYADVjkg.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-UsnKrjOJ.js";
import { t as createDefaultDeps } from "./deps-DJyXYmKE.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-DHZjEowv.js";
import { n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-C_Ls2SMr.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-De4Nyn0K.js";
import { t as GatewayLockError } from "./gateway-lock-DkJgzvUH.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CtrC1Uo5.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-B_UhubiG.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Je12Fddx.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-CsyvRGt4.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-DemJ9Eqt.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-C9JnjdQR.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-DZxqMsBp.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CxWzojgT.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-BsSEJuD1.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-JZCYkYc0.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-CflAl-RS.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-CxoGEE-5.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-DW8ssvFJ.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-OdRXPdK1.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-7mwaM_v0.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-CQTNhnyb.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CsSoFXhF.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-C_l5c1wf.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-CNrqqNdL.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-D8H9yXjs.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-RzdnOE1r.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-Bw0QfxgS.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-v-cDgmUU.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-pW5wu30g.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-C_DrP3G0.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-DmDPThbn.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-CQ9qHv5U.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DG_g4iTY.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-DytBeWlO.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-xtbIxXQF.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-xtbIxXQF.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-CxESxWIz.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-CpPRst8N.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-DJ3xBDJ1.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-B8xeQsgY.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-BOC4v4dn.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-CxESxWIz.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-BaQVqoR0.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-DfCF6joL.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-BFz2Aqnw.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-WTjOLJA0.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-DwjcynBn.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-DX60hXGW.js");
	...
	const { createChannelManager } = await import("./server-channels-BKq_ctT-.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-FhfmaZDf.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-Br0D-rFT.js"), import("./server-runtime-services-DxvjkMiD.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-oZH4IeeU.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-Dj5zz76c.js"),
				import("./server-plugin-bootstrap-419tNWcG.js"),
				import("./services-DE5o6l99.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-BzDGJ-6T.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-419tNWcG.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-D6hn8TOT.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-DPV4uquk.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-DMqgUJJs.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-BPT7Q5AX.js");
