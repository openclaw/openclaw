...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-D_5Zq6EX.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-DTKi439n.js")]);
