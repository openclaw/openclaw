...
type ChannelStreamingProgressConfig = {
  ...
  maxLines?: number; /** Progress draft renderer. "text" is the portable fallback; "rich" lets supported channels use structured UI. */
...
type SessionWriteLockConfig = {
  /** How long to wait while acquiring a session transcript write lock. Default: 60000. */acquireTimeoutMs?: number;
};
