...
import { f as resolveRunModelFallbacksOverride, m as resolveSessionAgentIds } from "./agent-scope-ByE5d_BM.js";
...
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-AdNx9jqZ.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Dn0qn0nC.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-DQsH82jw.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-DPuTz-lc.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as resolveModelAuthMode } from "./model-auth-Be7PFpxD.js";
...
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-DfJ7l8mN.js";
import { p as ensureSessionHeader, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BeUybACM.js";
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-Cg6L7q7f.js";
import { t as getMachineDisplayName } from "./machine-name-QTr-ogL4.js";
import { n as extractModelCompat } from "./provider-model-compat-bapS9W_Y.js";
import { A as isRealConversationMessage, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getHistoryLimitFromSessionKey, F as resolveCompactionTimeoutMs, H as collectRuntimeChannelCapabilities, M as consumeCompactionSafeguardCancelReason, N as setCompactionSafeguardCancelReason, O as buildEmbeddedExtensionFactories, P as compactWithSafetyTimeout, R as guardSessionManager, T as buildEmbeddedMessageActionDiscoveryInput, Z as isReasoningTagProvider, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as prewarmSessionFile, d as toSessionToolAllowlist, f as applySystemPromptOverrideToSession, i as dedupeDuplicateUserMessagesForCompaction, k as hasMeaningfulConversationContent, l as collectAllowedToolNames, m as createSystemPromptOverride, o as mapThinkingLevel, p as buildEmbeddedSystemPrompt, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectRegisteredToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as repairSessionFileIfNeeded } from "./compaction-successor-transcript-C-234lPc.js";
import { n as resolveEmbeddedCompactionTarget, r as listActiveProcessSessionReferences } from "./compaction-runtime-context--8YdVCLW.js";
import { a as resolveBootstrapContextForRun, c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-KoHrqqsz.js";
import { _ as resolveChannelReactionGuidance, h as resolveChannelMessageToolHints, m as listChannelSupportedActions } from "./pi-tools.before-tool-call-BAsFa_dg.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-D6yXGYRk.js";
import { s as supportsModelTools } from "./tool-result-middleware-Db49hsXk.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-FrCvE2ul.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-CXGHwniI.js";
import "./pi-bundle-mcp-tools-BRIo-7OK.js";
import { r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-olxsy09f.js";
import { t as log } from "./logger-DM7utI1X.js";
import { i as formatUnknownCompactionReasonDetail, o as resolveCompactionFailureReason, r as classifyCompactionReason, s as createCompactionDiagId } from "./request-compaction-tool-I1rrggYG.js";
import { g as createPreparedEmbeddedPiSettingsManager } from "./compaction-ogD2h2Ys.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-c-8q9cPM.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-D6nutlYP.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CoqIS1-4.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-C6XBAZy8.js";
import { o as resolveSandboxContext } from "./sandbox-BJgmPvvu.js";
import { c as readTranscriptFileState, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-raJu0SUI.js";
import { t as detectRuntimeShell } from "./shell-utils-BmcV6e9s.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-UgDW-Dl6.js";
import { s as resolveSkillsPromptForRun } from "./workspace-BWQNtDdK.js";
import "./skills-FkgelNOh.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-B__wXzhM.js";
import { t as applyExtraParamsToAgent } from "./extra-params-BQoNuMfu.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-CgDhuQQT.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-D5x3y9LJ.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-BPTjg0Ts.js";
