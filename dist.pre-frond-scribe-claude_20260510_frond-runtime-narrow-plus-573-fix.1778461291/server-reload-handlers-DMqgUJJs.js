...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-BsaRxwNE.js";
import "./installed-plugin-index-records-DGglNJn3.js";
import { n as formatConfigIssueLines } from "./issue-format-BFLj-aOk.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-CO_gFTwv.js";
import { n as isRestartEnabled } from "./commands.flags-CJRplU10.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-D5nkerQx.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-NVIQAJIo.js";
import { o as resetModelCatalogCache } from "./model-catalog-DtVjvfsX.js";
import { l as getTotalQueueSize } from "./command-queue-DJroUB7L.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-R3kK1n_P.js";
import "./pi-bundle-mcp-tools-BRIo-7OK.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-CuA66K2C.js";
import { r as resetDirectoryCache } from "./target-resolver-Bq4TtjPW.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-D0ogm_8K.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-BKm_7Tjn.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CgKY_75a.js";
import { _ as resolveHooksConfig } from "./hooks-D97ZHC4s.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-Co4zBSRo.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-C2v2DhUx.js";
import { t as diffConfigPaths } from "./config-diff-B7kqT9Qg.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CQoZtB5c.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-CsyvRGt4.js";
import { t as buildGatewayCronService } from "./server-cron-MnLyuXNf.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CxWzojgT.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-CLlSH5hz.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-Bh4Tz2Sx.js"), import("./gmail-watcher-lifecycle-CCGIedBG.js")]);
