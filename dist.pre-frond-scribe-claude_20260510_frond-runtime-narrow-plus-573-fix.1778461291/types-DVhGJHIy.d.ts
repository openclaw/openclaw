...
import { i as resolveHumanDelayConfig, r as resolveEffectiveMessagesConfig } from "./identity-dfogTIO7.js";
import { J as ReadSessionUpdatedAt$1, X as UpdateLastRoute$1, Y as RecordSessionMetaFromInbound$1, o as PluginRuntimeCore } from "./types-core-_mEOJ_c3.js";
import { m as resolveStorePath } from "./store-zg5DjjXZ.js";
import { _ as resolveChunkMode, f as chunkByNewline, g as chunkTextWithMode, h as chunkText, m as chunkMarkdownTextWithMode, n as ChannelOutboundAdapter, p as chunkMarkdownText, v as resolveTextChunkLimit } from "./outbound.types-DfHbN8bI.js";
import { n as ReplyDispatcher } from "./reply-dispatcher.types-0N-YQrvq.js";
import { s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-C0Kn9AZC.js";
import { f as implicitMentionKindWhen, g as BuildMentionRegexes$1, p as resolveInboundMentionDecision, v as MatchesMentionPatterns$1, y as MatchesMentionWithExplicit$1 } from "./mention-gating-qfLnkrwU.js";
import { n as RecordInboundSession$1 } from "./session.types-BpTftTrX.js";
import { c as SessionBindingRecord } from "./session-binding.types-Dm_ag8RX.js";
import { t as hasControlCommand } from "./command-detection-Ce3IWm30.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-DR58KKRt.js";
import { t as convertMarkdownTables } from "./tables-DOspexjv.js";
import { n as DispatchReplyFromConfig } from "./dispatch-from-config.types-DjXN9YsE.js";
import { t as finalizeInboundContext } from "./inbound-context-B4Zp8M0x.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-CMwesDF2.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-DMzOoWmk.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-adoENZue.js";
import { t as buildPairingReply } from "./pairing-messages-BR9zhRqx.js";
import { o as fetchRemoteMedia } from "./fetch-y1R1eLI6.js";
import { p as saveMediaBuffer } from "./store-GR1wLHRD.js";
import { n as getChannelActivity, r as recordChannelActivity } from "./channel-activity-bqnr3PhH.js";
import { a as createAckReactionHandle, c as shouldAckReaction, o as removeAckReactionAfterReply, s as removeAckReactionHandleAfterReply } from "./ack-reactions-B7_HFyQ-.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-BXU9JzCr.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-BibuFr6S.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-DeB0S5hg.js";
import { o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-CaRZ30w6.js";
import { a as runResolvedChannelTurn, i as runPreparedChannelTurn, r as runChannelTurn, t as dispatchAssembledChannelTurn, u as buildChannelTurnContext } from "./kernel-DNeScByC.js";
...
type PluginRuntimeChannel = {
  ...
  turn: {
    run: typeof runChannelTurn; /** @deprecated Prefer `run(...)`. */
    runResolved: typeof runResolvedChannelTurn;
    buildContext: typeof buildChannelTurnContext;
    runPrepared: typeof runPreparedChannelTurn; /** @deprecated Prefer `run(...)` or `runPrepared(...)`. */
