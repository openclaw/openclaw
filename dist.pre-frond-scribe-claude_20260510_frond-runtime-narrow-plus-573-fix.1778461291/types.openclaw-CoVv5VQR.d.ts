import { h as SecretsConfig, l as SecretInput } from "./types.secrets-dfIfyLgO.js";
import { d as AgentEmbeddedHarnessConfig, f as AgentModelConfig, m as AgentSandboxConfig, p as AgentRuntimePolicyConfig, u as ModelsConfig } from "./types.models-BbSYPJk1.js";
import { t as ChatType } from "./chat-type-DGF9cghU.js";
import { E as SessionConfig, H as TypingMode, U as WebConfig, b as LoggingConfig, g as DmScope, n as BlockStreamingChunkConfig, p as DiagnosticsConfig, r as BlockStreamingCoalesceConfig, v as HumanDelayConfig, y as IdentityConfig } from "./types.base-CN1BlTRP.js";
import { $t as GroupChatConfig, Kn as ToolsConfig, Kt as AudioConfig, Ln as MemorySearchConfig, Sn as AgentToolsConfig, Vt as ApprovalsConfig, Xn as MemoryConfig, Zt as CommandsConfig, a as ChannelsConfig, dn as TtsConfig, nn as MessagesConfig, qt as BroadcastConfig } from "./types.channels-Df4-Bt6H.js";
import { z } from "zod";
...
type AgentDefaultsConfig = {
  ...
  subagents?: {
    ...
    runTimeoutSeconds?: number; /** Gateway timeout in ms for sub-agent announce delivery calls (default: 90000). */
