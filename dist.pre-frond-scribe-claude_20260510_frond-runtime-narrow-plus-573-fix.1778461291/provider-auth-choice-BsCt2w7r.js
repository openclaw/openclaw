...
import { n as openUrl } from "./browser-open-C9c_00Tt.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-CsNue971.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CWuLGXRU.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-COT4-P1C.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-ByrYzvlq.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-C-1FNzrf.js") };
