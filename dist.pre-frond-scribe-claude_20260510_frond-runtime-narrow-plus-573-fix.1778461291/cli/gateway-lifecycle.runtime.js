...
import { c as markGatewaySigusr1RestartHandled, d as resolveGatewayRestartDeferralTimeoutMs, f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart, i as consumeGatewaySigusr1RestartAuthorization, l as peekGatewaySigusr1RestartReason, n as consumeGatewayRestartIntentPayloadSync, r as consumeGatewayRestartIntentSync, s as isGatewaySigusr1RestartExternallyAllowed, u as resetGatewayRestartStateForInProcessRestart } from "../restart-D5nkerQx.js";
import { r as writeGatewayRestartHandoffSync } from "../restart-handoff-Sa-m9B7E.js";
import { o as getActiveEmbeddedRunCount } from "../run-state-NVIQAJIo.js";
import { f as writeDiagnosticStabilityBundleForFailureSync } from "../diagnostic-stability-bundle-BW2A4fYx.js";
import { m as waitForActiveEmbeddedRuns, n as abortEmbeddedPiRun } from "../runs-Cz0PjVYb.js";
import { a as getActiveTaskCount, d as resetAllLanes, m as waitForActiveTasks, u as markGatewayDraining } from "../command-queue-DJroUB7L.js";
import { a as markUpdateRestartSentinelFailure } from "../restart-sentinel-CkjmeDD4.js";
import { S as reloadTaskRegistryFromStore } from "../task-registry-x68InV_f.js";
import "../runtime-internal-BqWPKLE1.js";
import { t as detectRespawnSupervisor } from "../supervisor-markers-DgU9CfIn.js";
import { n as getInspectableActiveTaskRestartBlockers } from "../task-registry.maintenance-BKm_7Tjn.js";
