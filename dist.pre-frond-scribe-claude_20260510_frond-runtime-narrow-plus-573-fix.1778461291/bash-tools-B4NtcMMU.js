...
import { J as resolveShellEnvFallbackTimeoutMs, K as getShellPathFromLoginShell } from "./io-BedkIX2f.js";
...
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-JLy5SBEA.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-QWu31Qvp.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DGRY_v6j.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-DFJbgGBN.js";
import { t as formatDurationCompact } from "./format-duration-zJwtFTvB.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-Uy5b-4zI.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-C3pysBVj.js";
import { o as failedTextResult, y as textResult } from "./common-BOb9qduE.js";
import { t as callGatewayTool } from "./gateway-MPA8POBK.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-DLQ5yOP9.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-DzqzSMel.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CeroISAZ.js";
...
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-2PciVvQ1.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-y5R6IwLq.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-DV7nitEZ.js";
import { n as detectPolicyInlineEval } from "./policy-k6TVYX8i.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-DboKJG25.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-BCgXRJWS.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-N7th6m1i.js";
