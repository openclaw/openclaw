...
const codexAppServerServiceTierSchema = zod_exports.z.preprocess((value) => value === null ? null : normalizeCodexServiceTier(value), zod_exports.z.string().trim().min(1).nullable().optional()).optional();
const codexPluginEntryConfigSchema = zod_exports.z.object({
...
const codexPluginsConfigSchema = zod_exports.z.object({
	enabled: zod_exports.z.boolean().optional(),
	allow_destructive_actions: zod_exports.z.boolean().optional(),
	plugins: zod_exports.z.record(zod_exports.z.string(), codexPluginEntryConfigSchema).optional()
}).strict();
const codexPluginConfigSchema = zod_exports.z.object({
	...
	discovery: zod_exports.z.object({
		enabled: zod_exports.z.boolean().optional(),
		timeoutMs: zod_exports.z.number().positive().optional()
	}).strict().optional(),
	computerUse: zod_exports.z.object({
		enabled: zod_exports.z.boolean().optional(),
	...
	appServer: zod_exports.z.object({
		...
		args: zod_exports.z.union([zod_exports.z.array(zod_exports.z.string()), zod_exports.z.string()]).optional(),
