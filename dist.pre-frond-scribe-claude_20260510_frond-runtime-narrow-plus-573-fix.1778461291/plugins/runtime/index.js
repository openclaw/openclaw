...
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-BCJZ6pnb.js";
...
import { a as getImageMetadata, l as resizeToJpeg } from "../../image-ops-7qlfPgY6.js";
import { a as generateMusic, o as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-D-G6kiLc.js";
import { _ as mediaKindFromMime, n as detectMime } from "../../mime-ki5Bz7zA.js";
import { l as ensureAgentWorkspace } from "../../workspace-JRdJwRI9.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "../../lazy-runtime-OJqeil7F.js";
...
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-zEcZBkN9.js";
import { n as resolveAgentIdentity } from "../../identity-cUlHgJlw.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-Dk9dbbKe.js";
...
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-BKd2w2ZM.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-RR9SPa4x.js";
import { i as setGatewaySubagentRuntime, n as gatewaySubagentState, r as setGatewayNodesRuntime, t as clearGatewaySubagentRuntime } from "../../gateway-bindings-D_5UcC1D.js";
import { t as createRuntimeChannel } from "../../runtime-channel-DIiIMKSV.js";
import { r as isVoiceCompatibleAudio } from "../../audio-CSdPUlCs.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-ChpMD1bh.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-CKQKhQsA.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-DKXrd9_x.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-BuDF0Czk.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-DYRcBS8a.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-B-xpvF_9.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-BDdCrGgE.js"), (m) => m.createRuntimeLlm({
