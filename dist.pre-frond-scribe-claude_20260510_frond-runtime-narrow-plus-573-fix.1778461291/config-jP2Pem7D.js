...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-BiSNj1t0.js";
import "./ssrf-runtime-BdcRu7L4.js";
import "./retry-runtime-CDXNxk1s.js";
import "./secret-input-runtime-C-_ziu-O.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CvhOYv5w.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-rRhqz-Dd.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DYZuM1DL.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BUL9okMH.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-D7jG8ByE.js"), import("./logging-DfnB0-K2.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-NLAdA54m.js").then((credentialsReadModule) => ({
