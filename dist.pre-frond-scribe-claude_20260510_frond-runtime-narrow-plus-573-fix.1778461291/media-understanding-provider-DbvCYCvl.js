...
import { r as readModelListResult } from "./models-DU7xnrbe.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-DKaMxi7G.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
