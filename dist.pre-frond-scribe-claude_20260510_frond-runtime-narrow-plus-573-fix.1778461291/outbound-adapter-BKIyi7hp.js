...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-CAGPnpze.js";
...
import { p as DiscordError } from "./discord-pupAgAj1.js";
import { t as chunkDiscordTextWithMode } from "./chunk-CvQXjp--.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-BhW97MFG.js";
import { t as createDiscordSendReceipt } from "./send.receipt-B5FnEEOK.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-ArkFHnj5.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-BmIKlCEj.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-CHeedThV.js");
