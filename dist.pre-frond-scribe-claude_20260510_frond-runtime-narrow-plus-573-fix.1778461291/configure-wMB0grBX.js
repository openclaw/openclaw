...
import { s as resolvePluginContributionOwners } from "./plugin-registry-DRDj6LDM.js";
...
import { a as findTailscaleBinary } from "./tailscale-EXEW1enj.js";
...
import { t as ConfigMutationConflictError } from "./mutate-DkqBz8pD.js";
...
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-LPUZHebc.js";
...
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared--MTHgLjI.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-Dc0_Rovt.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-BavNsfxs.js";
import { n as applyAuthChoice } from "./auth-choice-DuYUT93T.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-B0ShFRdX.js";
import { i as setupChannels } from "./onboard-channels-CGpamkE8.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CtrC1Uo5.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-BtBt7UqQ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Cot_lGL7.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-BOJ8mb9H.js";
import { t as applyPrimaryModel } from "./provider-model-primary-jsf87bc5.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DhJGPI2Q.js";
import { t as promptCustomApiConfig } from "./onboard-custom-Dy7P_0wf.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CCkdusGf.js";
import { n as formatHealthCheckFailure } from "./health-format-DRrCOSEx.js";
import { n as healthCommand } from "./health-CjsNi01j.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DcGgMi63.js";
import { t as setupSkills } from "./onboard-skills-2MGOMy-y.js";
...
function validateGatewayPortInput$1(value) {
	...
	if (!Number.isInteger(port) || port < 1 || port > 65535) return "Use a port number from 1 to 65535, for example 18789.";
}
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-DnGhxF1P.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CODSGist.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-6ov2hsAC.js");
