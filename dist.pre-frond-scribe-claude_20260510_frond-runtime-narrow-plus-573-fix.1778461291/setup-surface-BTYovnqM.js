...
import { o as resolveWhatsAppAuthDir } from "./accounts-2hbn91iK.js";
import { i as formatWhatsAppWebAuthStatusState, m as readWebAuthState } from "./auth-store-DyMquPtV.js";
...
const whatsappSetupWizard = {
	...
	credentials: [],
	finalize: async (params) => await (await import("./setup-finalize-BdSjUl_M.js")).finalizeWhatsAppSetup(params),
