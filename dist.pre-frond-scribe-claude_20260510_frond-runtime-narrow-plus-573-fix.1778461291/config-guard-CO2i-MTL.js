import { p as shouldMigrateStateFromPath } from "./argv-MdBfPgbe.js";
import { u as readConfigFileSnapshot } from "./io-BedkIX2f.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-CO_gFTwv.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-D_VJ070B.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-AKVZXvDV.js");
