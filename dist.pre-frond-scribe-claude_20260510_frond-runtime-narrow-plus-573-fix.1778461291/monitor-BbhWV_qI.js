...
import { c as isRecord, y as truncateUtf16Safe } from "./utils-927g1oFZ.js";
...
import { r as normalizeScpRemoteHost } from "./scp-host-DHtj-wI5.js";
...
import { r as stripInlineDirectiveTagsForDelivery } from "./directive-tags-CB14FHeA.js";
import { f as findCodeRegions, p as isInsideCode } from "./assistant-visible-text-Dv3fBSEg.js";
import { i as deliverTextOrMediaReply, m as resolveSendableOutboundReplyParts } from "./reply-payload-CAGPnpze.js";
import { c as kindFromMime } from "./mime-ki5Bz7zA.js";
...
import { c as resolveTextChunkLimit, o as chunkTextWithMode, s as resolveChunkMode } from "./chunk-D4-hvVxC.js";
import { t as createMessageReceiptFromOutboundResults } from "./receipt-CjyifHhz.js";
import { i as resolveAgentRoute } from "./resolve-route-DkMseGuz.js";
import { i as resolveHumanDelayConfig } from "./identity-cUlHgJlw.js";
import { i as writeJsonFileAtomically, n as readJsonFileWithFallback } from "./json-store-DUiurp7p.js";
import { t as resolveOutboundAttachmentFromUrl } from "./outbound-attachment-CzKvV-12.js";
import { a as createReplyDispatcherWithTyping, s as settleReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-D6nOukbA.js";
import { n as buildMentionRegexes, r as matchesMentionPatterns } from "./mentions-EUXdTG7f.js";
...
import { r as resolveDualTextControlCommandGate } from "./command-gating-Clp6iiy-.js";
...
import { d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-CmlwcX4x.js";
...
import { l as resolvePinnedMainDmOwnerFromAllowlist, o as resolveDmGroupAccessWithLists, t as DM_GROUP_ACCESS_REASON } from "./dm-policy-shared-DkWXKZ4l.js";
...
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-DdI0tXa7.js";
import { t as waitForTransportReady } from "./transport-ready-BJ_OHIOj.js";
import "./transport-ready-runtime-DGtDYI5B.js";
import "./runtime-config-snapshot-k67uo1ty.js";
import "./media-runtime-DMdnxXjU.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-CRe6Jnrg.js";
...
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-DX2KqVMh.js";
import "./session-store-runtime-Bftap8jo.js";
import "./state-paths-DYbtmxgZ.js";
import { i as resolveIMessageAccount } from "./accounts-CszruQH0.js";
import { t as createIMessageRpcClient } from "./client-rE_PORUI.js";
import { n as imessageRpcSupportsMethod, t as getCachedIMessagePrivateApiStatus } from "./private-api-status-DI1_2gIF.js";
import { a as normalizeIMessageHandle, r as isAllowedIMessageSender, s as parseIMessageTarget, t as formatIMessageChatTarget } from "./targets-B5kz3YxZ.js";
import { n as rememberIMessageReplyCache } from "./monitor-reply-cache-BwNT8TQK.js";
import { t as probeIMessage } from "./probe-l6igR5M4.js";
import { n as resolveIMessageInboundConversationId, t as sanitizeOutboundText } from "./sanitize-outbound-ChE2TBzr.js";
import { n as resolveIMessageAttachmentRoots, r as resolveIMessageRemoteAttachmentRoots } from "./media-contract-BPQc7thf.js";
import { t as extractMarkdownFormatRuns } from "./markdown-format-DlqHtRp2.js";
...
function parseIMessageNotification(raw) {
	...
	if (!isOptionalNumber(message.id) || !isOptionalString(message.guid) || !isOptionalNumber(message.chat_id) || !isOptionalString(message.sender) || !isOptionalString(message.destination_caller_id) || !isOptionalBoolean(message.is_from_me) || !isOptionalString(message.text) || !isOptionalStringOrNumber(message.reply_to_id) || !isOptionalString(message.reply_to_text) || !isOptionalString(message.reply_to_sender) || !isOptionalString(message.created_at) || !isOptionalBoolean(message.is_reaction) || !isOptionalString(message.reaction_type) || !isOptionalString(message.reaction_emoji) || !isOptionalBoolean(message.is_reaction_add) || !isOptionalString(message.reacted_to_guid) || !isOptionalAttachments(message.attachments) || !isOptionalString(message.chat_identifier) || !isOptionalString(message.chat_guid) || !isOptionalString(message.chat_name) || !isOptionalStringArray(message.participants) || !isOptionalBoolean(message.is_group)) return null;
	return {
		...message,
...
function formatIMessageReactionText(message) {
...
async function monitorIMessageProvider(opts = {}) {
	...
	async function handleMessageNow(message) {
		const messageText = (formatIMessageReactionText(message) ?? message.text ?? "").trim();
