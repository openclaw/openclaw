...
import { Ct as TalkEvent } from "../../diagnostic-events-vESIWy0l.js";
import { R as TtsDirectiveOverrides } from "../../tts-runtime.types-CUbzrQed.js";
import { An as RealtimeTranscriptionProviderPlugin, Br as RealtimeTranscriptionProviderConfig, Mr as RealtimeVoiceProviderConfig, Wr as RealtimeTranscriptionSession, g as OpenClawPluginApi, jn as RealtimeVoiceProviderPlugin } from "../../types-BYigPDoy.js";
import { t as zod_d_exports } from "../../zod--x3GszoM.js";
import { l as TtsConfigSchema } from "../../zod-schema.core--bngN9cq.js";
import { nt as TalkSessionController } from "../../realtime-voice-DxadJN4o.js";
...
declare class RealtimeCallHandler {
  ...
  constructor(config: VoiceCallRealtimeConfig, manager: CallManager, provider: VoiceCallProvider, realtimeProvider: RealtimeVoiceProviderPlugin, providerConfig: RealtimeVoiceProviderConfig, servePath: string);
