...
import { d as resolveIncludeRoots, o as resolveConfigPath, v as resolveStateDir } from "./paths-Cnwfh6dH.js";
import { i as formatErrorMessage } from "./errors-ixwfrboQ.js";
import { o as sanitizeHostExecEnv } from "./host-env-security-DRikErcl.js";
import { i as isPathInside } from "./path-B5B-_oAT.js";
import { c as isRecord$1, p as resolveUserPath, x as isPlainObject } from "./utils-CpmNtyoq.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-Bb8-PpWk.js";
import { i as applyConfigEnvVars } from "./state-dir-dotenv-BXrVPy7e.js";
...
import { i as replaceFileAtomicSync, n as replaceFileAtomic } from "./replace-file-DfT5iHv1.js";
import { r as normalizeChatChannelId, t as CHANNEL_IDS } from "./ids-BczttO8i.js";
import { r as hasKind } from "./slots-MFUVcT3n.js";
import { d as resolveMemorySlotDecision, l as resolveEffectivePluginActivationState, o as normalizePluginId, s as normalizePluginsConfig } from "./config-state-_YKe8RCQ.js";
import { n as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-e5bDitbk.js";
import { r as planManifestModelCatalogSuppressions } from "./model-catalog-Cb9xro6-.js";
import { n as resolveManifestCommandAliasOwnerInRegistry } from "./manifest-command-aliases-CtFXnCh0.js";
import { c as resolveOfficialExternalPluginInstall, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-Cd_w9tEa.js";
import { b as isVerbose } from "./logger-D4Ax5Dlv.js";
import { f as isLoopbackIpAddress, i as isCanonicalDottedDecimalIPv4 } from "./ip-CjB5NhB3.js";
import { t as loadDotEnv } from "./dotenv-DR4poDYD.js";
import { c as writePersistedInstalledPluginIndexInstallRecordsSync, i as resolveInstalledPluginIndexRecordsStorePath } from "./installed-plugin-index-records-BRa9naEj.js";
import { t as sanitizeTerminalText } from "./safe-text-CZdXrCEj.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-C_bBjUj2.js";
import { a as formatConfigOverwriteLogMessage, i as finalizeConfigWriteAuditRecord, n as appendConfigAuditRecordSync, r as createConfigWriteAuditRecordBase, s as snapshotConfigAuditProcessInfo, t as appendConfigAuditRecord } from "./io.audit-D0SVH1Z6.js";
import { r as formatConfigIssueSummary } from "./issue-format-C780MyYm.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-BFiFeBhs.js";
import { t as applyMergePatch } from "./merge-patch-CfIV4Y-C.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-DQNxPE51.js";
import { v as resolveBundledProviderPolicySurface } from "./thinking-BxclR8vv.js";
import { n as normalizeTalkConfig } from "./talk-mRw47yKJ.js";
import { i as normalizeTrustedSafeBinDirs, k as normalizeSafeBinProfileFixtures } from "./exec-safe-bin-trust-B0KACPCA.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-tr6w5tgz.js";
import { n as stripShippedPluginInstallConfigRecords, t as extractShippedPluginInstallConfigRecords } from "./plugin-install-config-migration-Cli0E6qi.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath } from "./config-paths-D_sI5P6N.js";
import { d as registerRuntimeConfigWriteListener, i as getRuntimeConfigSnapshot, l as loadPinnedRuntimeConfig, n as createRuntimeConfigWriteNotification, o as getRuntimeConfigSnapshotRefreshHandler, r as finalizeRuntimeSnapshotWrite, s as getRuntimeConfigSourceSnapshot, u as notifyRuntimeConfigWriteListeners } from "./runtime-snapshot-XI6kh6r8.js";
import { n as listKnownChannelEnvVarNames } from "./channel-env-vars-BL33iyFj.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-BiDW8LiX.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-C9ArK_F4.js";
import { n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-G263BTVY.js";
import { t as resolveWebSearchInstallCatalogEntries } from "./web-search-install-catalog-67AxdKr9.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-s3V4TPQz.js";
import { n as collectConfiguredModelRefs } from "./model-refs-DPSM5S9A.js";
import { t as OpenClawSchema } from "./zod-schema-bVxqDA97.js";
import { r as shouldWarnOnTouchedVersion } from "./version-CX9X4cZB.js";
...
function stampConfigWriteMetadata(cfg, now = (/* @__PURE__ */ new Date()).toISOString()) {
	return {
		...cfg,
		meta: {
			...cfg.meta,
...
function hasPathValue(value, path) {
	...
	if (isBlockedObjectKey(head) || !Object.prototype.hasOwnProperty.call(value, head)) return false;
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
	if (!raw || typeof raw !== "object") return [];
	const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DXbqEQr_.js");
...
//#endregion
export { resolveOwnerDisplaySetting as $, applyConfigOverrides as A, resolveManagedUnsetPathsForWrite as B, validateConfigObjectRaw as C, collectPluginSchemaMetadata as D, collectChannelSchemaMetadata as E, asResolvedSourceConfig as F, formatInvalidConfigDetails as G, shouldAttemptLastKnownGoodRecovery as H, asRuntimeConfig as I, getShellEnvAppliedKeys as J, createPreUpdateConfigSnapshot as K, resolveNormalizedProviderModelMaxTokens as L, resetConfigOverrides as M, setConfigOverride as N, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as O, unsetConfigOverride as P, shouldEnableShellEnvFallback as Q, normalizeProviderConfigForConfigDefaults as R, validateConfigObject as S, validateConfigObjectWithPlugins as T, AUTO_MANAGED_CONFIG_META_PATHS as U, isPluginLocalInvalidConfigSnapshot as V, createInvalidConfigError as W, loadShellEnvFallback as X, getShellPathFromLoginShell as Y, resolveShellEnvFallbackTimeoutMs as Z, recoverConfigFromLastKnownGood as _, loadConfig as a, writeConfigFile as b, promoteConfigSnapshotToLastKnownGood as c, readConfigFileSnapshotForWrite as d, readConfigFileSnapshotWithPluginMetadata as f, recoverConfigFromJsonRootSuffix as g, readSourceConfigSnapshotForWrite as h, getRuntimeConfig as i, getConfigOverrides as j, resolveShellEnvExpectedKeys as k, readBestEffortConfig as l, readSourceConfigSnapshot as m, clearConfigCache as n, parseConfigJson5 as o, readSourceConfigBestEffort as p, maintainConfigBackups as q, createConfigIO as r, projectConfigOntoRuntimeSourceSnapshot as s, ConfigRuntimeRefreshError as t, readConfigFileSnapshot as u, registerConfigWriteListener as v, validateConfigObjectRawWithPlugins as w, collectUnsupportedSecretRefPolicyIssues as x, resolveConfigSnapshotHash as y, applyUnsetPathsForWrite as z };
