...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-CzW8tQZJ.js";
...
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-OnQhJQHQ.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-BZ94qGVc.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-Coh_KKX1.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-DiRRpVQq.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BcDAzKvG.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-b2r0X7c3.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BcDAzKvG.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-DD_Ku-gQ.js").then(({ scheduleOrphanRecovery }) => {
