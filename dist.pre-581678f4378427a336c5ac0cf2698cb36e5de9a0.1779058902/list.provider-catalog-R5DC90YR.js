...
import { c as resolveProviderOwners, m as loadPluginRegistrySnapshotWithMetadata, s as resolvePluginContributionOwners } from "./plugin-registry-giqGaBJo.js";
import { t as createSubsystemLogger } from "./subsystem-Dtm6MSVy.js";
import { h as resolveOwningPluginIdsForProvider, s as resolveBundledProviderCompatPluginIds } from "./plugin-auto-enable-CpREFG4A.js";
import { l as loadAuthProfileStoreWithoutExternalProfiles } from "./store-CMEB4ZMP.js";
import { a as runProviderStaticCatalog, i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-132Jd2OS.js";
import { n as createProviderAuthResolver, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-66TDI899.js";
...
async function resolveProviderCatalogPluginIdsForFilter(params) {
	...
	const { resolveProviderContractPluginIdsForProviderAlias } = await import("./registry-B3LhDiHW.js");
