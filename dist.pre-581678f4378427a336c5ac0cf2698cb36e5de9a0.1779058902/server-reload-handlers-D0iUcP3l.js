...
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-XI6kh6r8.js";
import "./config-D2REj--_.js";
import { n as isRestartEnabled } from "./commands.flags-9Sm7Btxq.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-B_OAjFj2.js";
import { c as listActiveEmbeddedRunSessionKeys, o as getActiveEmbeddedRunCount, s as listActiveEmbeddedRunSessionIds } from "./run-state-DlJgeOXW.js";
import { o as resetModelCatalogCache } from "./model-catalog-CAIYwyOS.js";
import { l as getTotalQueueSize } from "./command-queue-COgr1nXO.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-ClY1g8qg.js";
import "./pi-bundle-mcp-tools-BB_aflSU.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-C8gcyAL-.js";
import { r as resetDirectoryCache } from "./target-resolver-BAndNh-s.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-BUbcYDs-.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-Bf-uhOy1.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-0AcR0bEH.js";
import { _ as resolveHooksConfig } from "./hooks-CUhEO74Y.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-DqSGbsKN.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-C0wF3l4Y.js";
import { t as diffConfigPaths } from "./config-diff-DG7UGyy-.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BLdDNCgf.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-zCMYwX9j.js";
import { t as buildGatewayCronService } from "./server-cron-DDCKwkSc.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B7ONtr7U.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-BjvCp05u.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-BOiAJHoy.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-DSNGH3tS.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-DC80tYl-.js"), import("./gmail-watcher-lifecycle-BLaHXe1b.js")]);
