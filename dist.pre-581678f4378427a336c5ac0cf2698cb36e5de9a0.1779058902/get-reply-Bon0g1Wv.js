...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-B7Gl_3a6.js";
...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-BdqZvTnb.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DgUPESoD.js";
import { s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-kyu7xRIn.js";
...
import { s as resetRegisteredAgentHarnessSessions } from "./registry-BHRGNcbH.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-CMmE9bEr.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-etu5OJV7.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-789ECJN2.js";
import { A as resolveSessionStoreEntry, C as parseSessionThreadInfoFast, t as loadSessionStore, y as resolveMaintenanceConfigFromInput } from "./store-load-BRLw4_SR.js";
...
import { m as deriveSessionMetaPatch, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-CTOVSWL0.js";
import { t as normalizeChatType } from "./chat-type-BW-f7-Sk.js";
import "./plugins-DToNC952.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-CmPL5zcY.js";
import { c as resolveSessionLifecycleTimestamps } from "./sessions-Ct_pHdrL.js";
...
import { l as resolveAndPersistSessionFile } from "./transcript-Co5UP2SS.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-Bd49BLni.js";
import { n as modelKey } from "./model-selection-normalize-DeF75Ytd.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-DZrSRKB-.js";
import { o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-BMDeMm5u.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-BlhleA4J.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-2q03qiGF.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-bWfG25KS.js";
import { a as generateSecureToken } from "./secure-random-CEv7m1qY.js";
import { a as enqueueSystemEvent, u as removeSystemEvents } from "./system-events-Bff58p0o.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-COgr1nXO.js";
import { a as resolveSilentReplySettings, i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-CFhmQtvX.js";
import { r as getCliSessionBinding } from "./cli-session-DynO3Ve3.js";
import { St as isReasoningTagProvider } from "./selection-C_LIAzUt.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CJavPf3D.js";
import { y as collectTextContentBlocks } from "./attempt.tool-run-context-B36KMRu-.js";
...
import { s as getMediaDir } from "./store-Uc5kTVit.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, s as resolveCommandTurnContext } from "./command-turn-context-BSbEbMm_.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-DjroHT9z.js";
...
import { n as resolveOriginMessageProvider } from "./origin-routing-D3JxJm8K.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-DKH8Gkud.js";
import { a as noteActiveSessionForShutdown, n as buildSessionStartHookPayload, r as forgetActiveSessionForShutdown, t as buildSessionEndHookPayload } from "./session-hooks-BJxPIkSi.js";
import { r as drainFormattedSystemEventBlock } from "./session-updates-C5dCmVoP.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-C0idoBnc.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-B7YAiTRP.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CwqUoBUK.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-WKZh_bur.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-C0BRmLsB.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-CkTpQPpN.js";
import "./commands-registry-zNDiJjum.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-pgO39wnC.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-C32eFLeh.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-BftsGiB1.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-DvqYThbv.js";
import { t as finalizeInboundContext } from "./inbound-context-DpJtIFSV.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BYaVWyyb.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-BDxE7fea.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-vW5YMmLd.js";
...
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DOa-VRo0.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-DM-8j0K0.js";
...
import { n as resolveSessionAuthProfileOverride } from "./session-override-B-Lp4qDY.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-Bn-wEmx_.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DTe9_VdB.js";
import { t as extractExplicitGroupId } from "./group-id-dVfC6bWF.js";
import { t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CcKjzA-V.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-DgbMv-0w.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-CHmmOJMZ.js";
import { t as hasInboundMedia } from "./inbound-media-BDsnOrhS.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context--2FYeHuX.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-B78cdBz2.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-BliRWwlv.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-DrrW7Ia-.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-CS6qwODd.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-CQ75tqRX.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DeEkgrXv.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-DtB36sbD.js");
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-DsaQ6WEY.js"));
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-B-tbH6t2.js");
