...
async function createMeetFromParams(params) {
	return (await import("../../create-CrW3VdhR.js")).createMeetFromParams(params);
}
async function createAndJoinMeetFromParams(params) {
	return (await import("../../create-CrW3VdhR.js")).createAndJoinMeetFromParams(params);
}
async function resolveGoogleMeetTokenFromParams(config, raw) {
	const { resolveGoogleMeetAccessToken } = await import("../../oauth-CCI4tvbz.js");
...
async function exportGoogleMeetBundleFromParams(config, raw) {
	...
	const { buildGoogleMeetExportManifest, googleMeetExportFileNames, writeMeetExportBundle } = await import("../../cli-CGfYmkLS.js");
...
var google_meet_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCli(async ({ program }) => {
			const { registerGoogleMeetCli } = await import("../../cli-CGfYmkLS.js");
