...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-Bg0cRVxq.js";
import "./channel-message-CHkrbl6L.js";
import "./text-autolink-runtime-BP6hC5eU.js";
import { t as require_src } from "./src-DihxB9U0.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-BmUV1YSf.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-Cm6_BxSf.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-BKdqv6fH.js";
import { t as fromBuffer } from "./lib-Cpmc9oV3.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BGihIFkE.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BSHXZ-YI.js";
import { l as toRatio, n as decodeString } from "./Util-D0RuGq3j.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BkYCv3iP.js";
import { t as APEv2Parser } from "./APEv2Parser-BYYhdZo1.js";
import { r as hasID3v1Header } from "./ID3v1Parser-aLfv-RnN.js";
import { i as isStrictDirectRoom } from "./direct-room-CVypxBZ8.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-BK8V0afC.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DpnBE-77.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-BF-JaVl9.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-tS3SDzQL.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CN0qN-vm.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-B635mUur.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-C-bnp3Hs.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-80VyCIU0.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CGI1x-bV.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-B7c6rtlo.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Dgy7BZbf.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DElmkWiU.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-D-g92rvi.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CohsDI7D.js")).WaveParser;
	}
};
//#endregion
