 ...
 */
export declare function applyAcpRuntimeOverlay(meta: AgentRuntimeMetadata, sessionKey: string | undefined | null, acpRuntime: boolean | undefined, acpBackend?: string): AgentRuntimeMetadata;
