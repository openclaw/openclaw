...
import { i as createChatChannelPlugin } from "./core-BSbJPGGu.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-DOfmplba.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-CvrnFOM7.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-B-09pTEM.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-Dr9AYcns.js";
import "./channel-api-DISf3Cpk.js";
import { t as parseDiscordTarget } from "./target-parsing-DS7HbJGF.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CpZUQiNM.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-BGaPU35G.js";
import { t as getDiscordRuntime } from "./runtime-Bbpxbr5n.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-l5xuu_2G.js";
import { t as getDiscordApprovalCapability } from "./approval-native-PZWARQgQ.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-_2DRzX2U.js";
import { t as discordMessageActions$1 } from "./channel-actions-C_cqvuI7.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-QoaXeGQ7.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-X1ouVV_b.js";
import { n as discordOutbound } from "./outbound-adapter-C0aVKR5j.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-VSXwjVra.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-DGpxvdjf.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-Cx_Pbixl.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CpRa3McE.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BY2Ilsz0.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-Jl51ODnJ.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-rASIyRQW.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-Bz0JvgSm.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CKfrNMAI.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-CETUUcl0.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-TfHr3G4C.js");
