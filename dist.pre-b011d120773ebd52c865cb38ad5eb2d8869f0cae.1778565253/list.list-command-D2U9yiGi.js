...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-Cl5E0TQB.js";
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-DLqe3PZx.js";
import { C as modelKey, T as parseModelRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-Cz4Ee-l6.js";
import "./model-selection-C3RHt1lm.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-ByADKEFE.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-6I9_K4TR.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-DKj5o1O9.js";
import { n as loadModelsConfigWithSource } from "./load-config-BWvJJBPe.js";
import { n as formatErrorWithStack } from "./list.errors-Bztb4a3X.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-uULryAkw.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-uOycOJu0.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-DXUZdLf3.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-C9RUeUrB.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DVufrzgp.js"),
		import("./agent-scope-CO0iEP9H.js"),
		import("./workspace-DArxr4tK.js")
	]);
