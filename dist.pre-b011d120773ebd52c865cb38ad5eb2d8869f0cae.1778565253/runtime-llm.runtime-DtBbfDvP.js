...
import { i as getChildLogger } from "./logger-DoY1MBoY.js";
import { t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-CrqbgX4W.js";
import "./logging-DKRa3iLG.js";
import { w as normalizeModelRef } from "./model-selection-shared-Cz4Ee-l6.js";
import "./model-selection-C3RHt1lm.js";
import { a as resolveModelCostConfig, n as estimateUsageCost } from "./usage-format-BpTxtrDs.js";
...
async function resolveAgentId(params) {
	...
	const { resolveDefaultAgentId } = await import("./agent-scope-CO0iEP9H.js");
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ prepareSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-zbnhSb2X.js"), Promise.resolve(resolveRuntimeConfig(options))]);
