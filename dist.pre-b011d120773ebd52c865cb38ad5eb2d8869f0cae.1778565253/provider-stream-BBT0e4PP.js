...
import { M as resolveProviderStreamFn } from "./provider-runtime-Cc6LcVZi.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-D-0WKaTm.js";
import { r as getModelProviderRequestTransport } from "./provider-request-config-CaQqVmIZ.js";
import { t as MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE } from "./assistant-error-format-BprBkQJL.js";
import { n as applyAnthropicPayloadPolicyToParams, r as resolveAnthropicPayloadPolicy } from "./anthropic-payload-policy-ChmMYbWK.js";
import { _ as sanitizeTransportPayloadText, b as buildCopilotDynamicHeaders, d as createEmptyTransportUsage, f as createWritableTransportEventStream, g as sanitizeNonEmptyTransportPayloadText, h as mergeTransportHeaders, i as createOpenAIResponsesTransportStreamFn, m as finalizeTransportStream, n as createAzureOpenAIResponsesTransportStreamFn, p as failTransportStream, r as createOpenAICompletionsTransportStreamFn, u as coerceTransportToolCallArguments, v as transformTransportMessages, x as hasCopilotVisionInput, y as buildGuardedModelFetch } from "./openai-transport-stream-Birt64gZ.js";
import { r as getModelProviderLocalService } from "./provider-local-service-tM1ApfL0.js";
import { calculateCost, getApiProvider, getEnvApiKey, parseStreamingJson, registerApiProvider } from "@earendil-works/pi-ai";
