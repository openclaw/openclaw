...
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-1IV421RZ.js";
...
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-DnIa9BiZ.js";
...
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-DQhlw1in.js";
...
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-CYp7FjH6.js";
...
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist } from "./node-command-policy-B_vsERP7.js";
import { n as logWs, t as formatForLog } from "./ws-log-uxsqiOP0.js";
...
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-Csm_SbeH.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BdU_AQxr.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-CrAjanFa.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-DmTN-PIH.js";
import { r as upsertPresence } from "./system-presence-CO5W47uZ.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-I9n0RsBp.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DOLHp3Xu.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Bt-Ie_OT.js";
import { t as truncateCloseReason } from "./close-reason-ghmAVyRa.js";
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-BGsoY-CI.js");
