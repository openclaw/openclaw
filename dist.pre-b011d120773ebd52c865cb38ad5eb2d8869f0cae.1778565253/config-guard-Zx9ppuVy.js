...
import { u as readConfigFileSnapshot } from "./io-C7AkIz5l.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-DDunICtb.js")).runDoctorConfigPreflight({
			migrateState: false,
