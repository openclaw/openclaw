...
import { t as getActiveMatrixClient } from "./active-client-CrkIqsZE.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DXyHPM2R.js"), import("./shared-BvPKSXJZ.js")]).then(([clientModule, sharedModule]) => ({
