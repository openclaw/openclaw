...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-DKg6-TQT.js";
import "./tokens-1nrYy2wZ.js";
import "./pi-embedded-helpers-D7tL7XS5.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-jlud9YE4.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-BrZTSCSp.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history--V8OgsrZ.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-BlczkP7u.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-KCHULi_S.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-DCHRCmsV.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-OmiOtBrq.js");
