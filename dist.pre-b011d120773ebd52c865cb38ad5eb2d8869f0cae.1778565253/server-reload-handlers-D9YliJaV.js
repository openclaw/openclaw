...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-D_m4a7AI.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-KqTx1C2u.js";
import { o as resetModelCatalogCache } from "./model-catalog-ClJbmM2S.js";
import { l as getTotalQueueSize } from "./command-queue-D_l61LdN.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-DgKdQ9TD.js";
import "./pi-bundle-mcp-tools-CBsp02bf.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-Cr1rOGOe.js";
...
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-IvDDiFMl.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Bpb6ke9x.js";
...
import { t as buildGatewayCronService } from "./server-cron-HB7FZvQq.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-BW_8cUGq.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-C0uMy5l1.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-B_NIhBMh.js"), import("./gmail-watcher-lifecycle-Dq5xxbGU.js")]);
