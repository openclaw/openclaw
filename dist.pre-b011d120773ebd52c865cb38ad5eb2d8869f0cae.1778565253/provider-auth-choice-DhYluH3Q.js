...
import { n as openUrl } from "./browser-open-2aluzTdF.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-WOsRtlET.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-Ct9sLvur.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-B--AYjUn.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-xogF3jlZ.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-LUr78Egh.js") };
