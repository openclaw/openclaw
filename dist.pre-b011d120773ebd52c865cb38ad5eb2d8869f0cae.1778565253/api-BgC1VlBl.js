...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-iK0Q9rn6.js";
import "./ssrf-runtime-BxiaPFE4.js";
import "./text-utility-runtime-Bx8a2TNS.js";
import "./runtime-api-DvOLDr8d.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-Bkot_Y0w.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-DBoWVtYy.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
			return {
