...
import { n as matrixSetupAdapter } from "./setup-core-Du5foX-2.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-B2MSEOAD.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-9wD28HfF.js";
import { t as withResolvedActionClient } from "./client-DD-pYDMs.js";
import { r as resolveMatrixAuthContext } from "./config-CeLqc6zi.js";
import "./client-DMEokZrq.js";
import "./runtime-api-dz8y1SSY.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-EA6J4tpt.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-JY0kFKT9.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-1vlc_8E0.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-BDSxLgde.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DB63Nzi5.js");
