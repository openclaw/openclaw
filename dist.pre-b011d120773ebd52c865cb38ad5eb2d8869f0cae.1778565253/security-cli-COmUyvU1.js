...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-eVOg7xdS.js";
import { t as formatHelpExamples } from "./help-format-BMRz9Zqb.js";
import { t as runSecurityAudit } from "./audit-BZCuFES5.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-BKOpbF6N.js");
