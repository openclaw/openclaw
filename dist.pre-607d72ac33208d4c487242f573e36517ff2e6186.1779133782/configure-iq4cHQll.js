...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-DAzaL1br.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-DGTV4b-3.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-Cb7myZKf.js";
...
import { t as ConfigMutationConflictError } from "./mutate-Bm2-Tz3l.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-CX3knMHh.js";
import { t as randomToken } from "./random-token-B-QfYP-0.js";
import "./config-CBeYX-pH.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-Bu5AxP-l.js";
...
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Dvkj_YGg.js";
import { t as note$1 } from "./note-CSu06D1t.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-Cara5-ZM.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-eEUekEKz.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-BLOhIfUp.js";
import { n as applyAuthChoice } from "./auth-choice-BK9YIZO7.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-VNVswizg.js";
import { i as setupChannels } from "./onboard-channels-gfXpYucu.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DIuxajgI.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-CAupWBIA.js";
import { t as applyPrimaryModel } from "./provider-model-primary-DcCoiCQO.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CxeMtsnI.js";
import { t as promptCustomApiConfig } from "./onboard-custom-DY8vlYqP.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-GTaqRl86.js";
import { n as formatHealthCheckFailure } from "./health-format-u13GUal3.js";
import { n as healthCommand } from "./health-B_IxEcw7.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-LUwEQ3v4.js";
import { t as setupSkills } from "./onboard-skills-CAUwuWoN.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-CaLhgLHB.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-Bw6BFnzg.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-gMwp0szz.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DZVOkHsa.js");
