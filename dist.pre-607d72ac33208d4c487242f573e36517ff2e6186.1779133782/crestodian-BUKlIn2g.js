...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-B4arSP2z.js";
import { r as resolveCrestodianOperation } from "./dialogue-DcaftQ17.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-DhVK9RDI.js")).runCrestodianTui;
	opts.onReady?.();
