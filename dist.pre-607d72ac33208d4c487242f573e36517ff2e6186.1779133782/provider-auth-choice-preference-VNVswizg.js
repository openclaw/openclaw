import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BLbKdhdl.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-MWZNqPUw.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-CaLhgLHB.js");
