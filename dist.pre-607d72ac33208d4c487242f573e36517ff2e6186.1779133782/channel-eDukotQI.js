...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-Cjq_t6os.js";
import "./channel-api-BqBqqFs2.js";
import { t as parseDiscordTarget } from "./target-parsing-C-sqxcSW.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DTg5OlNJ.js";
...
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-C5zjKP4a.js";
import { t as getDiscordApprovalCapability } from "./approval-native-DWPB8lU4.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-Cy9UNNVO.js";
import { t as discordMessageActions$1 } from "./channel-actions-CJiBPa_U.js";
...
import { n as discordOutbound } from "./outbound-adapter-D70lp94c.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BWpuaPmN.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-44hi5IiY.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-D7LdPpRN.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BMPxfBs3.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BBrzezQ5.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-Dj-EEJEi.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-Bigjs8LR.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-6b3CgKqn.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-Ir7bE1ne.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DZ8N7TyY.js");
