...
import "./json-schema-runtime-DHXkNJ9c.js";
import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-CXz0E9gD.js";
import { c as resolveCodexAppServerRuntimeOptions } from "./config-DEp1RR7m.js";
import { i as assertCodexTurnStartResponse, l as readCodexTurnCompletedNotification, o as readCodexErrorNotification, r as assertCodexThreadStartResponse } from "./protocol-validators-BYCwEkCQ.js";
import { r as readModelListResult } from "./models-yYszCZO-.js";
...
async function runBoundedCodexVisionTurn(params) {
	...
	const client = params.options.clientFactory ? await params.options.clientFactory(appServer.start, params.profile) : await import("./shared-client-z87fV9UL.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
