...
import { J as getShellEnvAppliedKeys, Q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-DxVmbF3R.js";
...
import { g as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-BTle0GRT.js";
...
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-B3J3XIzo.js";
import "./workspace-CvbkPv2B.js";
import { n as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-BGdZnjZb.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-BMZDV1OY.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-CpyCVVmA.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-Bqf7kdtb.js");
			runtime.log("");
