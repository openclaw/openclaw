import { c as readErrorName, i as formatErrorMessage } from "./errors-ixwfrboQ.js";
import { n as createLazyPromiseLoader, t as createLazyImportLoader } from "./lazy-promise-SFT4i6yI.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-DkpIHRmj.js";
...
import { A as resolveSessionStoreEntry, a as registerSessionMaintenancePreserveKeysProvider, t as loadSessionStore } from "./store-load-NR217KeP.js";
import { s as updateSessionStore } from "./store-DM2Qj4Ie.js";
import "./sessions-Buwioyq3.js";
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-CLrsr0SO.js";
import { A as SUBAGENT_ENDED_REASON_ERROR, C as getSubagentSessionRuntimeMs, D as SUBAGENT_ENDED_OUTCOME_KILLED, E as SUBAGENT_ENDED_OUTCOME_ERROR, M as SUBAGENT_TARGET_KIND_SUBAGENT, N as subagentRuns, O as SUBAGENT_ENDED_OUTCOME_TIMEOUT, T as resolveSubagentSessionStatus, i as restoreSubagentRunsFromDisk, j as SUBAGENT_ENDED_REASON_KILLED, k as SUBAGENT_ENDED_REASON_COMPLETE, l as countPendingDescendantRunsFromRuns, m as listRunsForControllerFromRuns, n as persistSubagentRunsToDisk, o as countActiveDescendantRunsFromRuns, p as listDescendantRunsForRequesterFromRuns, r as persistSubagentRunsToDiskOrThrow, s as countActiveRunsForSessionFromRuns, t as getSubagentRunsSnapshotForRead, u as getSubagentRunByChildSessionKeyFromRuns, w as getSubagentSessionStartedAt, x as isStaleUnendedSubagentRun } from "./subagent-registry-state-CjDwToxT.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-uSiFGe8z.js";
import { a as isSilentReplyText } from "./tokens-dY63daNF.js";
import { c as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-Dq8SuPVU.js";
import "./pi-bundle-mcp-tools-BCQm6siM.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-DuNGveo0.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DCqlvKGi.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-BnzA7YkC.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-B6pYF3lL.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DXbC7WEy.js"));
	...
	const registerSubagentRun = (registerParams) => {
		...
		try {
			...
			try {
				...
				log$1.warn("Failed to persist subagent registration rollback", {
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-CsqyR8ps.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DXbC7WEy.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-DnD6rG0q.js").then(({ scheduleOrphanRecovery }) => {
...
configureSubagentRegistrySpawnRuntime({
	countActiveRunsForSession: (requesterSessionKey) => countActiveRunsForSession(requesterSessionKey),
