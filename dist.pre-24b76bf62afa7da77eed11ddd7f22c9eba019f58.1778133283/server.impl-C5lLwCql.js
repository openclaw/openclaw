...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-BkGYa0ve.js";
import { _ as sleep } from "./utils-D5swhEXt.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-Cv9TMOcb.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-DAC6GNWm.js";
import { n as createDiagnosticTraceContext, s as runWithDiagnosticTraceContext } from "./diagnostic-trace-context-Bw2CWPVX.js";
import { c as setDiagnosticsEnabledForProcess, i as isDiagnosticsEnabled } from "./diagnostic-events-Cq5CLuNc.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-DNg_cpPU.js";
import { t as isContainerEnvironment } from "./container-environment-rrS4OBuL.js";
import { g as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-CEscmVCn.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-LkNvc0tr.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-CGBBnjxU.js";
import { n as resolveGatewayAuth } from "./auth-resolve-t9lsFrWz.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-DOE5w-Qp.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-Dmp4nHnj.js";
import { n as isRestartEnabled } from "./commands.flags-Bh9yVyji.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-BDOoRksS.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-CqeT9_Y1.js";
import "./method-scopes-BizxINu7.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-DQo-SHN2.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-C9JfWUeb.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-H_4pm-M0.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-hvvIx7oB.js";
import { i as resolveMainSessionKey } from "./main-session-C7L7pyed.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-CReq3v_K.js";
import "./sessions-BY1AKzIp.js";
import { o as getActiveEmbeddedRunCount } from "./run-state--wxwrRI-.js";
import { g as stopDiagnosticHeartbeat, h as startDiagnosticHeartbeat } from "./diagnostic-CczWv0yz.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-CEdgrVPf.js";
import { l as getTotalQueueSize } from "./command-queue-DVzZJKOt.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-ThtMUD6B.js";
import { a as enqueueSystemEvent } from "./system-events-CVKys5hy.js";
import { i as CANVAS_HOST_PATH } from "./file-resolver-Q9itbcg8.js";
import { t as handleA2uiHttpRequest } from "./a2ui-C6tz20eG.js";
import { r as resolveCronStorePath } from "./store-gWaHUfzE.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-DuqXKMQQ.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Dp1846lI.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-DpvIWZhg.js";
import { t as createDefaultDeps } from "./deps-x3_eZFpX.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-DtoIFIN4.js";
import { n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-BSOo-iN6.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-CB3bAVnx.js";
import { t as GatewayLockError } from "./gateway-lock-Blkfa-96.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-1-pzgYeN.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-QqCOcX2T.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-CLlOMHH9.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DjgnRooL.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-CxmgMswT.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-C2lQdotX.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-d2V3bnO5.js";
import { i as normalizeCanvasScopedUrl } from "./canvas-capability-DTobCzDO.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-BZBaX1li.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CqD5tA8F.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DVe5BJcd.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-BEbdog6j.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-CrNZyBTC.js";
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext, n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-D1LnF79r.js";
import "./paths-D9gSDL9N.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-Cil54EfU.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-D2XGirEE.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-Blvn0mio.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-DHrvPTXT.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-Vh0-NEQG.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-6N24Rai1.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-CeCGrhvf.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-FE4rsUMP.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-Dbyfkmht.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CDelwJX1.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-P4HdJHi2.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-BT6OJYVf.js");
	return voiceClawRealtimeUpgradeModulePromise;
}
function getCanvasAuthModule() {
	canvasAuthModulePromise ??= import("./http-auth-CIwj5aKK.js");
	return canvasAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils--O-UyLWp.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DTybgztS.js");
...
async function createGatewayRuntimeState(params) {
	...
	try {
		...
		if (params.canvasHostEnabled) try {
			const { createCanvasHostHandler } = await import("./server-Bojaqbfp.js");
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-BhF7LT46.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-Dgj8A0vr.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-BafKV6nK.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-YWEupN9J.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-C5a-a464.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-CMNtorAE.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-CvwB9w-B.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-BJSuqDU5.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-BafKV6nK.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-C5pFIMBB.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-B2JeEpiB.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-BhyrN95x.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-Qt_ehlQ7.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-zXkhkQUV.js");
	...
	const controlUiSeed = minimalTestGateway ? {
		...
		writeConfig: async (nextConfig) => {
			const { replaceConfigFile } = await import("./mutate-BzDZ_RkL.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-RgPFeqGQ.js");
	...
	const { createChannelManager } = await import("./server-channels-BlUE_hNI.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-D49_0QRl.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-BMTEERKT.js"), import("./server-runtime-services-CieBjhqY.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-DeWhXA0i.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-DK3YH7Cq.js"),
				import("./server-plugin-bootstrap-Cg_bNyf2.js"),
				import("./services-DLV576pg.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-CT9C9mix.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-Cg_bNyf2.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-lDPIZy23.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-BVT6pIr6.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-CHJrfI1d.js");
