...
import { l as jsonResult } from "../../common-Cf8ajZVR.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-Bxa-yem8.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-D_vRks5x.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-kowAh9gn.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-B4W2iKpX.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-4RalbCPd.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-Bycsdr2B.js");
