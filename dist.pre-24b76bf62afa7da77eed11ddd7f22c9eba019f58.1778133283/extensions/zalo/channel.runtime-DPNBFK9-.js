...
import "./accounts-BhLUp0WK.js";
import "./runtime-api-By8QqeG_.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-Bze1Jc-D.js";
import { t as sendMessageZalo } from "./send-kc6XTy7g.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BwbMVetf.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DldVaFBb.js");
