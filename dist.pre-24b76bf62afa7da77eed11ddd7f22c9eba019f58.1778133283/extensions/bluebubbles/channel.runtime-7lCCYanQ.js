...
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "../../webhook-request-guards-Rxy-X5bK.js";
import { t as normalizeWebhookPath } from "../../webhook-path-CjafoHoQ.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "../../webhook-targets-Cg3BzlhQ.js";
import "../../security-runtime-CbBYpvzI.js";
import "../../string-coerce-runtime-BMQDVfjj.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-ztAM4sE3.js";
import "./secret-input-D2hI_DPW.js";
import { t as getBlueBubblesRuntime } from "./runtime-BywjeLJZ.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-gTFzzeqM.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-B_NcZJKr.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-DS5ghqU4.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-BY4Kx-le.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
