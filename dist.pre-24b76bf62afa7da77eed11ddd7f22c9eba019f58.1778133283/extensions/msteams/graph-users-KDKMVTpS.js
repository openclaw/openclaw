...
import { u as isPrivateIpAddress } from "../../ssrf-Do8_-OpG.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "../../ssrf-policy-DsfOWjYU.js";
import "../../ssrf-runtime-BGM8nkUl.js";
import { t as getMSTeamsRuntime } from "./runtime-api-CAwIMIeW.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BE0eBs8c.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("../../dist-HPWZzQgV.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../dist-6ztwlHVB.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("../../jsonwebtoken-CFWWCY0Z.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../src-B6tSaX_D.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
