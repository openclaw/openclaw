...
import { i as runExec } from "./exec-Ba6yxFMA.js";
import { t as resolveSystemBin } from "./resolve-system-bin-BgZSb2D2.js";
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-Bca1NoEF.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-TfZz8vJu.js";
import { t as describeImageWithModel } from "./image-runtime-BZCYtpWp.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-BR-7KuGL.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-CL5cVp8D.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-BZGgC83i.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-DoLZMvpz.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-CO0Imb1f.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
