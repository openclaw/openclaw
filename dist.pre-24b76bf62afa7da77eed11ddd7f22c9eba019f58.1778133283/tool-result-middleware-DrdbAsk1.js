...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-CphpzAjI.js";
import "./model-selection-BWQiz_aq.js";
import { d as isGoogleModelApi, u as isGemma4ModelRequiringReasoningStrip } from "./pi-embedded-helpers-DYMwAeTk.js";
import { t as log$1 } from "./logger-Blf8M-xa.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-EoaoyeJq.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-Cq6re8py.js");
