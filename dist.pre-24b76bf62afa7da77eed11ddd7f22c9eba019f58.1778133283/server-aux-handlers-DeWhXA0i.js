...
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-V4touQJP.js";
import { a as approvalDecisionLabel, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage } from "./plugin-approvals-DcA_05gy.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-BEXErCqt.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-C7NVNNq7.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-ThtMUD6B.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-DhfAFFgq.js";
import { l as roleScopesAllow } from "./pairing-token-Dx3AHunj.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-D1tYNVKb.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-6t26TiNp.js";
import { r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DIpo31nJ.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-CtOWZcuT.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-C4OgKSl0.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Cj9kZ9v6.js";
import { t as diffConfigPaths } from "./config-diff-B5ZrrGxx.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-C7ZXbuEg.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-CxmgMswT.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-Ct6l6O7l.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-DirS1H_h.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-XMrYgpQM.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
