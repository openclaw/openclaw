...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-DOE5w-Qp.js";
...
import { t as isInboundPathAllowed } from "./inbound-path-policy-D-CKDsUn.js";
...
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-B5u1kJRC.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-D3v0JWAh.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CSgsEl_z.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-B_upRR9g.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CsinahOz.js";
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-DgTW9N4P.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-sLSHLMDf.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BzT8tbMq.js";
...
import { a as extractDeliveryInfo } from "./sessions-BY1AKzIp.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-CphpzAjI.js";
import { S as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, x as modelKey } from "./model-selection-shared-nVmByRp_.js";
...
import { t as requireApiKey } from "./model-auth-runtime-shared-BjgXqcuV.js";
import { r as getApiKeyForModel } from "./model-auth-Bbb7JlKK.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-AfaTFJZW.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BXjVg4Jy.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-D3__Fnvn.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-DgPE_w9l.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-CEtzNgYR.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-ClrlMpv1.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CwW8KZ4O.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CrK_yjQ1.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-C8ciIbc2.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-B71LoGT8.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-Bwhl71M-.js";
import { n as extractTextFromChatContent } from "./chat-content-Bno1p0HN.js";
import { r as stripToolMessages } from "./chat-history-text-C2WCNYw7.js";
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-DLbZeDB2.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-CJtvravN.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-BgPA_Rxr.js";
import { D as textToSpeech } from "./tts-runtime-EoHonb6Z.js";
import "./tts-BLaYzL7b.js";
import { a as getImageMetadata } from "./image-ops-Cfq3PTvh.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-DM-uKEyu.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BCRUftq9.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-Bv6iLCRK.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-Bb0rIp4w.js";
import { t as SsrFBlockedError } from "./ssrf-Do8_-OpG.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-BvV8lO8w.js";
import { n as extractAssistantText } from "./pi-embedded-utils-Ctg1GB4M.js";
import { n as runWithImageModelFallback } from "./model-fallback-VcoPZNIo.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DJ71BtNs.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-Cf8ajZVR.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-B5-K2LSS.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-DNlF1KyX.js";
import { n as assertSandboxPath } from "./sandbox-paths-DceyN4JP.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-DmL5UFP5.js";
...
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-ThtMUD6B.js";
...
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DamtAgtQ.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-C_ieGI5T.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-D3lhOWCr.js";
import { i as resolveMaxDelegatesPerTurn } from "./config-BS9Es6Hf.js";
import "./targeting-MP_EbQh0.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-CbYkqJ8u.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-DnJemBOu.js";
...
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-Cv0dBo6M.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Mm9tKVro.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-DDB8KH19.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-Beq4JQ6Y.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CnSoOOVQ.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BHWVTtBG.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-CQCdvQNz.js";
import { l as saveMediaBuffer } from "./store-BVTmgrt6.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-CSeP3ocj.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CWnCnAZI.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-B_VBZgcS.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BzXrYBZz.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-jIqJgdIS.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-TfZz8vJu.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DpU4a3-i.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BZCYtpWp.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-BR-7KuGL.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-Brdfh2gw.js";
import { s as resolveTimeoutMs } from "./resolve-CL5cVp8D.js";
import { t as buildProviderRegistry } from "./runner-CwD2_Mjf.js";
...
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-DirZ301v.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-9NPe3O7a.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-BEOTQ2DI.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Fc7awOrU.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-BSt5LFlc.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BNh1hyGd.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Ht_82_eC.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-D4lKAzxl.js";
import { t as parseTimeoutMs } from "./parse-timeout-DZuA3RH9.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-B9-WE1s3.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CdS29bKM.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-pyof5kuK.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DedpJYmF.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-Bo7GuHdX.js";
import { p as registerSubagentRun } from "./subagent-registry-Bv16psSa.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-BkY1fjaQ.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-D20m2TrT.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CGdJ5FXO.js";
...
import { i as runWebSearch } from "./runtime-D7oEGww0.js";
import "./web-search-provider-common-BakV75C0.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BOLY0kNx.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CSPNB51x.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-CQvzjJZP.js"));
