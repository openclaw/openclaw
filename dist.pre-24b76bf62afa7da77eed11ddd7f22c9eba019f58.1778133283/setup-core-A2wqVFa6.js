...
import { u as prepareScopedSetupConfig } from "./setup-helpers-B9-JV7kL.js";
import "./setup-D4ew-RC_.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DPwuBgNJ.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-8RzQ_Zrr.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-3Ltj3EeM.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-X7gRZIu_.js");
