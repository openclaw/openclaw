...
import { n as registerDiagnosticContinuationQueueMetricsProvider } from "./diagnostic-continuation-queues-BL5J3yzc.js";
import { n as normalizeContinuationTargetKey, r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-DLbZeDB2.js";
import { i as failFlow, l as listTaskFlowRecords, o as finishFlow, r as deleteTaskFlowRecordById, t as createManagedTaskFlow, u as listTaskFlowsForOwnerKey } from "./task-flow-runtime-internal-e0Zd2ycz.js";
import "./targeting-MP_EbQh0.js";
import { z } from "zod";
...
const TraceparentStateSchema = z.preprocess((value) => value === null ? void 0 : value, z.string().regex(new RegExp(DIAGNOSTIC_TRACEPARENT_PATTERN)).refine((value) => normalizeDiagnosticTraceparent(value) !== void 0, { message: "invalid W3C traceparent" }).transform((value) => normalizeDiagnosticTraceparent(value)).optional()).optional();
