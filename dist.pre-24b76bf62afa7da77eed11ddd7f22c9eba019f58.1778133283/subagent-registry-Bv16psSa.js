...
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-DTxVH7ZF.js";
import { A as SUBAGENT_ENDED_REASON_KILLED, C as getSubagentSessionStartedAt, D as SUBAGENT_ENDED_OUTCOME_TIMEOUT, E as SUBAGENT_ENDED_OUTCOME_KILLED, M as subagentRuns, O as SUBAGENT_ENDED_REASON_COMPLETE, S as getSubagentSessionRuntimeMs, T as SUBAGENT_ENDED_OUTCOME_ERROR, a as countActiveDescendantRunsFromRuns, b as isStaleUnendedSubagentRun, c as countPendingDescendantRunsFromRuns, f as listDescendantRunsForRequesterFromRuns, j as SUBAGENT_TARGET_KIND_SUBAGENT, k as SUBAGENT_ENDED_REASON_ERROR, l as getSubagentRunByChildSessionKeyFromRuns, n as persistSubagentRunsToDisk, o as countActiveRunsForSessionFromRuns, p as listRunsForControllerFromRuns, r as restoreSubagentRunsFromDisk, t as getSubagentRunsSnapshotForRead, w as resolveSubagentSessionStatus } from "./subagent-registry-state-CgTwO7c2.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-Bsa6lnlh.js";
import { a as isSilentReplyText } from "./tokens-DQI2KUQE.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-QgVAKG0f.js";
import "./pi-bundle-mcp-tools-B6jRLn4y.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-DqQI4WG8.js";
import { c as setDetachedTaskDeliveryStatusByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BSt5LFlc.js";
import "./subagent-announce-queue-CTST7WoU.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DedpJYmF.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-Bo7GuHdX.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-BTEh3J0y.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DSgKoFQy.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-hz9Rgr97.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-DSgKoFQy.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-C1kqnvKG.js").then(({ scheduleOrphanRecovery }) => {
