import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-LeyZQADY.js";
import { r as loadCrestodianOverview } from "./overview-BKkmo2-Y.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-0Qim_q-K.js")).planCrestodianCommand)({
		input,
		overview
	});
