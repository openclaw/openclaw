...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-DOE5w-Qp.js";
import { n as formatConfigIssueLines } from "./issue-format-DaaH055I.js";
import { t as note } from "./note-D7ZDwOsu.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis--c4JqA9j.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-ChiZcf2S.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-C_RbRTcQ.js");
