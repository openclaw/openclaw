...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-Do5P5t7E.js";
...
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-CaHZ1IJw.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-Bbb7JlKK.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-B5fsBtNf.js";
import { n as loadModelsConfigWithSource } from "./load-config-BFJyVxlx.js";
import { n as formatErrorWithStack } from "./list.errors-xwe24Fdo.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-CVReZz8c.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-DDg3ooCx.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-bgSG-ER7.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-j235O_1F.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveOpenClawAgentDir }, { resolveAgentWorkspaceDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BmlWe4pg.js"),
		import("./agent-paths-CEqt8X6t.js"),
		import("./agent-scope-DncEtcmv.js"),
		import("./workspace-COl_8oGA.js")
	]);
