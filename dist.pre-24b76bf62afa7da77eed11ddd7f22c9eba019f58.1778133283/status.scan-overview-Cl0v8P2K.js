...
import { r as normalizeControlUiBasePath } from "./control-ui-shared-DAIcGNsg.js";
import { t as resolveOsSummary } from "./os-summary-ClEI2YZ1.js";
import { l as hasConfiguredChannelsForReadOnlyScope } from "./channel-plugin-ids-DT7ehl88.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-BcalhIcm.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-UI0uVlQs.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-C5CxkKqQ.js";
import { i as isProbeReachable } from "./helpers-CX4S50kt.js";
import { existsSync } from "node:fs";
//#region src/commands/status.scan.shared.ts
const gatewayProbeModuleLoader = createLazyImportLoader(() => import("./status.gateway-probe-BAJp4YEI.js"));
const probeGatewayModuleLoader = createLazyImportLoader(() => import("./probe-DRawHKif.js"));
const gatewayCallModuleLoader$1 = createLazyImportLoader(() => import("./call-BOLY0kNx.js"));
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-BcPg3Kzh.js"));
const statusUpdateModuleLoader = createLazyImportLoader(() => import("./status.update-BLe6fTja.js"));
const statusScanRuntimeModuleLoader = createLazyImportLoader(() => import("./status.scan.runtime.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("./call-BOLY0kNx.js"));
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./status.summary--GFmnAKi.js"));
const configModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-HpAaywgh.js"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-BmnB2XEW.js"));
