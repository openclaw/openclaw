...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-BKkmo2-Y.js";
import { r as resolveCrestodianOperation } from "./dialogue-WhIMDc6L.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-C1MJz65f.js")).runCrestodianTui;
	opts.onReady?.();
