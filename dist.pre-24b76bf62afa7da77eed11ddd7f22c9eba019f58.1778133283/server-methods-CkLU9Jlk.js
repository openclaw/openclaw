...
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-t9lsFrWz.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-DOE5w-Qp.js";
...
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-4pMuTH-7.js";
...
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-CqeT9_Y1.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-BizxINu7.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-DQo-SHN2.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-DAIcGNsg.js";
...
import { g as patchPluginSessionExtension } from "./loader-DubLqLJ4.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BjNW89OI.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-ChzOkvu6.js";
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-hvvIx7oB.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BqFZqXJ_.js";
...
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-EcUZzq-s.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-B_upRR9g.js";
import { h as stringifyRouteThreadId } from "./channel-route-clbSK-46.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CsinahOz.js";
import { t as loadSessionStore } from "./store-load-DgTW9N4P.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-sLSHLMDf.js";
...
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-BY1AKzIp.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-gBCpGv7M.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-C0r0n32H.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-DnNo291y.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CoMSZwYf.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-DM5X6shA.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CsvDCti6.js";
import "./auth-profiles-BavBg7q6.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-g_CjBnn-.js";
import { o as getActiveEmbeddedRunCount } from "./run-state--wxwrRI-.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-9iyt98u7.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-CpMIvPXz.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-hcIds1OY.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-DFsev825.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BWakxzfj.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-CEtzNgYR.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-DwZck2MR.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-CrK_yjQ1.js";
import { i as resolveSandboxConfigForAgent } from "./config-Dy0ezuNE.js";
import { t as extractToolPayload } from "./tool-payload-u_SOo-c8.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-DlQyo-CW.js";
import { l as getTotalQueueSize } from "./command-queue-DVzZJKOt.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-fyWyBwVn.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-BgPA_Rxr.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-BAkdZEnr.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-EoHonb6Z.js";
import "./tts-BLaYzL7b.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Dxk4lm3a.js";
import { a as isTimeoutError } from "./failover-error-BgdQKjjd.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-DXXOWGP4.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-C7NVNNq7.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-ThtMUD6B.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-CAnqmnRy.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-CVKys5hy.js";
import { i as parseAbsoluteTimeMs } from "./stagger-CxyCxHl3.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BUhCTXIg.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-Cv0dBo6M.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-DT7ehl88.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-DirZ301v.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-DeDxf1L5.js";
import { n as normalizePollInput } from "./polls-CXU6j-rl.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-F5zO6WJs.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BVByd4DM.js";
import "./target-resolver-MxjnoAM0.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-1mrENhBI.js";
import { i as resolveReplyToMode } from "./reply-threading-CrJcd7Fu.js";
...
import { n as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-DthxxbIN.js";
import { r as resolveOutboundTarget } from "./targets-B2VtwAei.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-BSt5LFlc.js";
import { n as resolveAgentIdentity } from "./identity-GoxySUrw.js";
import { s as clearSessionQueues } from "./queue-Bl2Argz_.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-4nBPTXGL.js";
import { t as resolveAgentTimeoutMs } from "./timeout-B0AiQ35K.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-DYLAeHt8.js";
import "./skills-BPsWgxvF.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-C8WG5TDO.js";
import { t as compactEmbeddedPiSession } from "./compact.queued-Ce7Bv8ed.js";
import "./pi-embedded-IcTbURmu.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-DV3w03VE.js";
import { n as resolveSendPolicy } from "./send-policy-CIofKJNh.js";
import { t as canExecRequestNode } from "./exec-defaults-Suw6K0h9.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DocZ0rmB.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-DV92i3AQ.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-BSll4aIR.js";
import { t as detectRespawnSupervisor } from "./supervisor-markers-ByTmJCdV.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-5ti3zDoy.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-RR48O7QP.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CrqEhDon.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DyIypAJv.js";
import "./commands-registry-0pAtQCr1.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-DuqXKMQQ.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-DCvQR4Rg.js";
import { t as getChannelActivity } from "./channel-activity-CFDRdMKG.js";
import { t as WizardCancelledError } from "./prompts-DzQYj3s-.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-DOWviUxO.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-QJloIw44.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-DrXPIBXM.js";
import { t as movePathToTrash } from "./browser-trash-5T4ZTGft.js";
import "./browser-maintenance-CmptxUpw.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Ce659-Bh.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-CsELlTWz.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-DV4hD-ku.js";
import { r as agentCommandFromIngress } from "./agent-command-DfJh47KT.js";
...
import { t as formatForLog } from "./ws-log-DpvIWZhg.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CWdxEAhD.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-CgOJ7Hd5.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-C5cDRtdW.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-Z_fcu0zS.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-C4OgKSl0.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-DQG5nQdB.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CFoia8RX.js";
import { n as createOutboundSendDeps } from "./deps-x3_eZFpX.js";
import "./agent-BKDY6h-N.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-Cru3uylP.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-9Wu4xvbF.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-ClHB5koL.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CHtuGi6v.js";
import "./server-constants-CB3bAVnx.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-DhmgtGgx.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-B1IaYBDY.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CRkkcuc2.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-VRyO6jeL.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-BD5H0QVJ.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-BQZSDHJM.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-CU3q914s.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-DS5kBbpY.js";
import { s as performGatewaySessionReset } from "./session-reset-service-DKZmC8qz.js";
import { t as buildChannelUiCatalog } from "./catalog-Bg8gIfXb.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-DyXzv9Ko.js";
import { s as normalizeUpdateChannel } from "./update-channels-DCbtx52T.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-RfttEuYA.js";
...
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DJRKv1HK.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-BdVLaxIx.js";
import { t as buildChannelAccountSnapshot } from "./status-Bl2gNkes.js";
...
import { n as readPackageVersion } from "./package-json-BHvj7qf4.js";
import { t as getStatusSummary } from "./status.summary-CL_IlgEQ.js";
import "./status-kxq-Wda8.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-aolJqIq1.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-wrH3cTak.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-UfNHEPX-.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-6DopN7mU.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-B1iIs8bk.js";
...
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-C7ZXbuEg.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BkvqC5h9.js";
import "./heartbeat-runner-DUMmBEBG.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-Bs1CdIIU.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-JaNFyC1f.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-B0tR8qOp.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-XgfT_JcT.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-Ciib1guK.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-DTobCzDO.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-w2ItVDtG.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-DVjuVxhc.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-D1zqHZWs.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C1H8blNG.js");
