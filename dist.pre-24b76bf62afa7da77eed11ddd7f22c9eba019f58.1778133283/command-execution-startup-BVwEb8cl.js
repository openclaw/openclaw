...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CEbi-zmd.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DZNX4tiz.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-DdL6kvbD.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-oxAI0lqm.js");
	if (params.argv) {
