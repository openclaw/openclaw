...
import { X as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-DOE5w-Qp.js";
import "./defaults-xppxcKrw.js";
import "./config-C_YnpthU.js";
import { u as normalizeMessageChannel } from "./message-channel-V4touQJP.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-BYyKepYY.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-3ApVptBO.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-MPT_Jqoh.js";
import { t as resolveAgentRuntimePolicy } from "./agent-runtime-policy-COQbqCOp.js";
import { C as listRegisteredAgentHarnesses } from "./loader-DubLqLJ4.js";
...
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-hvvIx7oB.js";
...
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-CphpzAjI.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DzSzEwzu.js";
...
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-CpMIvPXz.js";
...
import { n as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-lBrjGbAU.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-HVbln_Qw.js";
import { t as parseInlineDirectives } from "./directive-tags-XF4RaTeD.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-D6u6GgU1.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-CrK_yjQ1.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-3ure4mbZ.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DyKLAPKW.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-Bwhl71M-.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-Bno1p0HN.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-DkcdCKOJ.js";
import { t as isCliRuntimeAlias } from "./model-runtime-aliases-DYloz3Bl.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DQI2KUQE.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-D8F_sqo2.js";
import { C as isEmbeddedMode, S as stripProviderPrefix, x as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-fyWyBwVn.js";
...
import { m as MAX_IMAGE_BYTES } from "./mime-CJtvravN.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-BWD5C9-L.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DUJvsUk1.js";
...
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-Dwnkoe3y.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-C5WtZ6yf.js";
import { n as toTrajectoryToolDefinitions, r as getQueuedFileWriter, t as createTrajectoryRuntimeRecorder } from "./runtime-DL81zabt.js";
...
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-Cz0i8G88.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Dxk4lm3a.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DbEmBqKI.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-CW3nWNSa.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-B3Qe3eE7.js";
...
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-DrdbAsk1.js";
import { g as sanitizeTransportPayloadText, p as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-CIql9h7a.js";
import { t as log$4 } from "./logger-Blf8M-xa.js";
...
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-iTSo5i-e.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-D6QAwnQ-.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-C4vzOfoT.js";
...
import { n as hasCommittedMessagingToolDeliveryEvidence, r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-Dyd1F58J.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-VcoPZNIo.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-DJ71BtNs.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-D1grzwor.js";
...
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-DggAwcNT.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-HQXT1qSw.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-D-Gx9U_l.js";
...
import { t as buildSystemPromptParams } from "./system-prompt-params-lEzbja7k.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DHKaA2Dd.js";
import "./tool-loop-detection-c0q011s4.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-Cq45fRri.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BA2KFkT3.js";
...
import { t as appendAgentBootstrapSystemPromptSupplement } from "./system-prompt-CmGKw49m.js";
...
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-OG5dJrVg.js";
...
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as shouldUseOpenAIWebSocketTransportForAttempt, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-CRXxue4V.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CN5MCPH1.js";
import { t as detectAndLoadPromptImages } from "./images-DW_Yfn8a.js";
import { a as resolveRuntimeContextPromptParts, i as queueRuntimeContextForNextTurn, t as buildCurrentTurnPromptContextSuffix } from "./runtime-context-prompt-Bv4N-iEl.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-DpwMqX_A.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-CHJrfI1d.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-CYBpEeXK.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-NSXiP17p.js"));
