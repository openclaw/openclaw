...
import { n as discoverConfigSecretTargets } from "./target-registry-3aotPWYV.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-DOE5w-Qp.js";
import { n as formatConfigIssueLines } from "./issue-format-DaaH055I.js";
import { r as normalizeTalkSection } from "./talk-4pMuTH-7.js";
import { n as collectConfiguredModelRefs } from "./model-refs-D2FaRJ_h.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-CtGPNXes.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-YTjj9IOu.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DSA33nXk.js";
import { n as getLoadedChannelPlugin } from "./registry-sLSHLMDf.js";
import { i as listRouteBindings } from "./bindings-CUL0LtkS.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DYloz3Bl.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-BZt5jTct.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BnCmW66Q.js";
import { t as note } from "./note-D7ZDwOsu.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis--c4JqA9j.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-sUOUFcWn.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BSOPiUPq.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DGkX7Lyj.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-JdOrdcHs.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DGrcvSdr.js";
import { t as asObjectRecord } from "./object-CU10En3N.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-CXox_-a9.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-C6asWpZl.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-Cr2bC1gO.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-Ds9dTeWg.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CogsciFC.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DyR32bMp.js");
		emitDoctorNotes({
			note,
