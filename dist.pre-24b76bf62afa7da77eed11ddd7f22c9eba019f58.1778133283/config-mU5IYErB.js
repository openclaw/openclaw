...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-DsfOWjYU.js";
import "./ssrf-runtime-BGM8nkUl.js";
import "./retry-runtime-DouT7iED.js";
import "./secret-input-runtime-OMJIyGod.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-BwUAzMOY.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DPqo9G9C.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DPwuBgNJ.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-DE9Hy5_8.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-wBEeKkmF.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BoA7gSAT.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DmwWoMKk.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-Dzvi2GJa.js"), import("./logging-Brd3JsDJ.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BmwJz1nk.js").then((credentialsReadModule) => ({
