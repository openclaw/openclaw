...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-CMlvZNw6.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-DuT3xIAK.js";
...
import { t as ConfigMutationConflictError } from "./mutate-BEt-dRkg.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-DJSa5BzL.js";
import { t as randomToken } from "./random-token-C3WrGJIi.js";
import "./config-C_YnpthU.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BogEqMcw.js";
import { n as listChatChannels } from "./chat-meta-YaI828S4.js";
...
import "./workspace-Dxk4lm3a.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-Cxqm5BbH.js";
...
import { t as note$1 } from "./note-D7ZDwOsu.js";
import { t as createClackPrompter } from "./clack-prompter-CSbPRyc5.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-DPQu4aZ4.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-SjuxMDzm.js";
import { n as applyAuthChoice } from "./auth-choice-CZoSQNGC.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CAUxfci2.js";
import { i as setupChannels } from "./onboard-channels-B7gULtvd.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-1-pzgYeN.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-DK4Lm8LG.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-ByOLMuot.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-C6DRpVzx.js";
import { t as applyPrimaryModel } from "./provider-model-primary-CaCdnnPD.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-wIl9M7O3.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BelY2kSv.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-n7OCPrvA.js";
import { n as formatHealthCheckFailure } from "./health-format-BN-xYuIg.js";
import { n as healthCommand } from "./health-DbX-5Qpi.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-Bes1yUDv.js";
import { t as setupSkills } from "./onboard-skills-DwLoy8HF.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-CSuZ7Lpy.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-DkgzaEVh.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Db7sVzwZ.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-CvfSeD15.js");
