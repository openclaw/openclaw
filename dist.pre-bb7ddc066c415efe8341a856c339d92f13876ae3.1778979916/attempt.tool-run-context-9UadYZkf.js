...
import { o as resolvePluginControlPlaneFingerprint } from "./plugin-metadata-snapshot-BdP7FN6x.js";
...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-5jeH_Uur.js";
...
import { u as isGoogleModelApi } from "./pi-embedded-helpers-BMLB2L5F.js";
import { t as log$1 } from "./logger-BDuw5LwF.js";
import { r as splitMediaFromOutput } from "./parse-CNAaOXnd.js";
import { o as normalizeTargetForProvider } from "./target-id-resolution-pDO0Fj--.js";
import { t as pluginRegistrationContractRegistry } from "./registry-QnbH48Hk.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-Crxhbshl.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-C5k_tpRx.js");
