...
import { t as collectIncludePathsRecursive } from "./includes-scan-D97reys1.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-ByX8E_ef.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CrnftTkZ.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-Fcx5_VYn.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-CgLA2UUY.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-DB0R--w3.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-DHW-pgxd.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-DY00T1Jg.js");
