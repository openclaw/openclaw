...
import { u as pathExists$1 } from "./utils-CpmNtyoq.js";
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-DHQHze2C.js";
import { t as movePathWithCopyFallback } from "./replace-file-DfT5iHv1.js";
import { i as readJsonIfExists } from "./json-files-1SmAauRO.js";
import { a as parseSemver } from "./runtime-guard-BuMdLq1N.js";
import { t as resolveStableNodePath } from "./stable-node-path-CClhI_bP.js";
import { r as runCommandWithTimeout } from "./exec-tETQVYqO.js";
import { n as applyPosixNpmScriptShellEnv, r as createNpmFreshnessBypassArgs, t as applyNpmFreshnessBypassEnv } from "./npm-install-env-DOlck3h3.js";
import { u as trimLogTail } from "./restart-sentinel-EtKQtKPV.js";
import { t as applyPathPrepend } from "./path-prepend-CYwh02Ba.js";
import { t as BUNDLED_RUNTIME_SIDECAR_PATHS } from "./runtime-sidecar-paths-BEaVCFF6.js";
import { a as isBetaTag, n as DEV_BRANCH, o as isStableTag, r as channelToNpmTag } from "./update-channels-DTkC9sbo.js";
import { a as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-BWK6s8zY.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-DSPfkbVD.js";
import { n as compareSemverStrings, s as detectPackageManager } from "./update-check-D7xF_R1R.js";
...
async function resolveGlobalInstallTarget(params) {
	...
	const targetGlobalRoot = (command.manager === "pnpm" && await isPnpmGlobalPackageRoot(params.pkgRoot) ? inferPnpmGlobalRootFromPackageRoot(params.pkgRoot) : null) ?? globalRoot;
	return {
		...command,
...
async function runGlobalPackageUpdateSteps(params) {
	...
	try {
		...
		const updateStep = await params.runStep({
			name: "global update",
			argv: globalInstallArgs(installCommandTarget, params.installSpec, void 0, installLocation),
			...installCwd,
			...installEnv,
