import { p as shouldMigrateStateFromPath } from "./argv-DEHjUPTf.js";
import { u as readConfigFileSnapshot } from "./io-ByDvK3jv.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-B8sHIDdb.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-DLcjNptb.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-CcOuPo2Y.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-By-25q-O.js"),
		import("./utils-Buwbi5YV.js"),
