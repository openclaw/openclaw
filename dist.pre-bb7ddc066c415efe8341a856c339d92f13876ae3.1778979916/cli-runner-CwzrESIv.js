...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-D9YraNzb.js";
import "./tokens-DpFyNNFT.js";
import "./pi-embedded-helpers-BMLB2L5F.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-CS--39Mi.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-DkTysg6B.js";
import { i as loadCliSessionHistoryMessages, o as buildAgentHookConversationMessages, r as loadCliSessionContextEngineMessages } from "./session-history-Cg2RuY13.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-T-G-qMvB.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-4B-sTGlT.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-C9a1CGFn.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-Bin4nTJQ.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-blkUWWv4.js");
