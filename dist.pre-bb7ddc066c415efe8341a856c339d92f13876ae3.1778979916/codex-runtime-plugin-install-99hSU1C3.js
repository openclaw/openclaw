...
import { o as modelSelectionShouldEnsureCodexPlugin } from "./openai-codex-routing-G2-43f4W.js";
...
async function ensureCodexRuntimePluginForModelSelection(params) {
	...
	const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-C7Zsih4i.js");
...
async function repairCodexRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-qNpBHjWU.js");
