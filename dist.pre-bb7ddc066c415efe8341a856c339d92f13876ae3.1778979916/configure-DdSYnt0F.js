...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-CnyzaJwM.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-Gu0uRd7h.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-CpmI3h2q.js";
...
import { a as findTailscaleBinary } from "./tailscale-FXZH1spk.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-ByDvK3jv.js";
import { t as sanitizeTerminalText } from "./safe-text-BqXgiOsp.js";
import { t as ConfigMutationConflictError } from "./mutate-CM7Vq-cJ.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-BkbqyzMr.js";
import { t as randomToken } from "./random-token-CkgGO5O6.js";
import "./config-CIM_gEq1.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-Cn_rpi4W.js";
import { o as formatPortRangeHint } from "./error-format-C27-4rQ7.js";
import { n as listChatChannels } from "./chat-meta-BosAS4Sd.js";
...
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-CBHYOLoU.js";
import "./workspace-CJq22W2D.js";
...
import { t as note$1 } from "./note-DqmDOrb0.js";
import { t as createClackPrompter } from "./clack-prompter-Gp1mz5Vb.js";
import { r as logConfigUpdated } from "./logging-DZvLiFyY.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-GTSJCCTS.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-C8AV8osy.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-Bafvums7.js";
import { n as applyAuthChoice } from "./auth-choice-D_HOgZCo.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-dxLKBnnF.js";
import { i as setupChannels } from "./onboard-channels-D-U_2L4e.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BWK6s8zY.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-D-XGnXRx.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CSlSXwY8.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-ebx6qcMA.js";
import { t as applyPrimaryModel } from "./provider-model-primary-556HXvrQ.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DoJwDT7N.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BNngCfy8.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CBbVj0H1.js";
import { n as formatHealthCheckFailure } from "./health-format-DaJieoZs.js";
import { n as healthCommand } from "./health-D6NY2s_6.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BXQQFhqU.js";
import { t as setupSkills } from "./onboard-skills-C17b9rSF.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-BMeE0TZr.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-DvbKFiHZ.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-X_qiYYVG.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BPaMtTG7.js");
