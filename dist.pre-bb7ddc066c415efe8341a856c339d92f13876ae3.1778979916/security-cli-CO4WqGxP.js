...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-DcdG7k00.js";
import { t as formatHelpExamples } from "./help-format-CViMN67J.js";
import { t as runSecurityAudit } from "./audit-BgnYY0wA.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-D0OiOg-F.js");
