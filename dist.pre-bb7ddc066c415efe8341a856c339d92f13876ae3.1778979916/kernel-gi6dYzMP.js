...
import { n as createCommandTurnContext, t as commandTurnKindToSource } from "./command-turn-context-BWY-4JJT.js";
import { t as buildOutboundSessionContext } from "./session-context-Csv7bmTH.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-C7G5v8mi.js";
import { r as resolveOutboundDurableFinalDeliverySupport } from "./deliver-DlImowHI.js";
import { t as normalizeDeliverableOutboundChannel } from "./channel-resolution-BH-uGIBC.js";
import { n as listMessageReceiptPlatformIds } from "./receipt-BU5wQIrc.js";
...
import { h as recordPendingHistoryEntryWithMedia, u as clearHistoryEntriesIfEnabled } from "./history-B98zrf4u.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-DPQ2tzD6.js";
import { a as resolvePairLoopGuardSettings, r as createPairLoopGuard } from "./pair-loop-guard-runtime-61pRwYdV.js";
import { t as EMPTY_CHANNEL_TURN_DISPATCH_COUNTS } from "./dispatch-result-BlfMaaUM.js";
import { r as shouldIncludeSupplementalContext } from "./context-visibility-DZlGjcpV.js";
import "./history-window-Eum4jlip.js";
...
//#endregion
//#region src/channels/turn/media.ts
...
function buildChannelTurnMediaPayload(media) {
...
function buildChannelTurnContext(params) {
	const mediaPayload = buildChannelTurnMediaPayload(params.media ?? []);
...
//#endregion
export { runPreparedChannelTurn as a, filterChannelTurnSupplementalContext as c, toInboundMediaFacts as d, deliverInboundReplyWithMessageSendContext as f, recordChannelBotPairLoopAndCheckSuppression as g, createChannelDeliveryResultFromReceipt as h, runChannelTurn as i, buildChannelTurnMediaPayload as l, throwIfDurableInboundReplyDeliveryFailed as m, dispatchAssembledChannelTurn as n, runResolvedChannelTurn as o, isDurableInboundReplyDeliveryHandled as p, recordDroppedChannelTurnHistory as r, buildChannelTurnContext as s, createNoopChannelTurnDeliveryAdapter as t, toHistoryMediaEntries as u };
