import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString$1, d as normalizeStringifiedOptionalString, f as readStringValue, o as normalizeNullableString, s as normalizeOptionalLowercaseString } from "./string-coerce-LndEvhRk.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-DDaGBMF_.js";
import { v as resolveStateDir } from "./paths-Cnwfh6dH.js";
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-ixwfrboQ.js";
import { n as isAbortError } from "./unhandled-rejections-BySXedqI.js";
import { t as createAsyncLock } from "./async-lock-BoRJFLar.js";
import { p as FsSafeError } from "./path-B5B-_oAT.js";
import "./fs-safe-D4r8mUJk.js";
import { o as root } from "./secure-temp-dir-GC3bO7Qi.js";
import { t as movePathToTrash } from "./trash-DKFoImKb.js";
...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-bmH32UOR.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-9_btbLFO.js";
import { c as normalizeAgentId, g as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-8g_Q03Po.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-DaaBuyRT.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-DdZBnV-N.js";
import { d as measureDiagnosticsTimelineSpanSync, u as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-BdP7FN6x.js";
import { d as writeJson, i as readJsonIfExists, l as tryReadJson } from "./json-files-1SmAauRO.js";
...
import { a as logWarn, t as logDebug } from "./logger-xPcOTHDV.js";
import "./auth-p1uCwunm.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-CVUyJap-.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-ByDvK3jv.js";
import "./archive-BlCQW5fB.js";
...
import { t as applyMergePatch } from "./merge-patch-lBx6TWow.js";
import { r as DEFAULT_PROVIDER } from "./defaults-D0p0lnLM.js";
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-xkGwiIJl.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-Fv8Z5G4C.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-B8sHIDdb.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-CwHl-W6V.js";
import { t as validateJsonSchemaValue } from "./schema-validator-BSHvyoOq.js";
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-CM7Vq-cJ.js";
import "./config-CIM_gEq1.js";
import { n as isRestartEnabled } from "./commands.flags-K2k3F9G8.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-Cy5O_7Bd.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-1Q-QxpL0.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-DL0-grO4.js";
import { c as isGatewayMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-TSLTSa9Q.js";
import { r as setSafeTimeout } from "./timer-delay-B3WUtwxI.js";
import { l as gatewayStartupUnavailableDetails } from "./client-DDADSo6k.js";
import { $ as validateExecApprovalsGetParams, $t as validateSessionsSendParams, A as validateConfigSchemaParams, An as validateTalkSessionTurnParams, B as validateCronUpdateParams, Bn as validateUpdateRunParams, Bt as validateSessionsCompactionListParams, Cn as validateTalkSessionCloseParams, D as validateConfigPatchParams, Dt as validatePluginsUiDescriptorsParams, E as validateConfigGetParams, En as validateTalkSessionJoinParams, Et as validatePluginsSessionActionResult, F as validateCronListParams, Fn as validateTasksGetParams, Ft as validateSessionsAbortParams, G as validateDeviceTokenRevokeParams, Gn as validateWebPushSubscribeParams, Gt as validateSessionsListParams, H as validateDevicePairListParams, Hn as validateWakeParams, Ht as validateSessionsCreateParams, I as validateCronRemoveParams, In as validateTasksListParams, It as validateSessionsCleanupParams, J as validateEnvironmentsStatusParams, Jn as validateWebPushVapidPublicKeyParams, Jt as validateSessionsPatchParams, K as validateDeviceTokenRotateParams, Kn as validateWebPushTestParams, Kt as validateSessionsMessagesSubscribeParams, L as validateCronRunParams, Ln as validateToolsCatalogParams, Lt as validateSessionsCompactParams, Mn as validateTalkSpeakParams, N as validateCronAddParams, Ni as ErrorCodes, O as validateConfigSchemaLookupParams, Ot as validatePollParams, P as validateCronGetParams, Pi as errorShape, Pn as validateTasksCancelParams, Pt as validateSendParams, Qn as validateWizardStatusParams, Qt as validateSessionsResolveParams, R as validateCronRunsParams, Rn as validateToolsEffectiveParams, Rt as validateSessionsCompactionBranchParams, Sn as validateTalkSessionCancelTurnParams, St as validateNodeRenameParams, T as validateConfigApplyParams, Tt as validatePluginsSessionActionParams, U as validateDevicePairRejectParams, Un as validateWebLoginStartParams, Ut as validateSessionsDeleteParams, V as validateDevicePairApproveParams, Vn as validateUpdateStatusParams, Vt as validateSessionsCompactionRestoreParams, W as validateDevicePairRemoveParams, Wn as validateWebLoginWaitParams, Wt as validateSessionsDescribeParams, Xn as validateWizardNextParams, Xt as validateSessionsPreviewParams, Yn as validateWizardCancelParams, Yt as validateSessionsPluginPatchParams, Zn as validateWizardStartParams, Zt as validateSessionsResetParams, _ as validateChannelsStatusParams, _t as validateNodePairVerifyParams, a as validateAgentsCreateParams, an as validateSkillsStatusParams, at as validateModelsListParams, bn as validateTalkSessionAppendAudioParams, bt as validateNodePendingEnqueueParams, c as validateAgentsFilesListParams, cn as validateSkillsUploadChunkParams, d as validateAgentsUpdateParams, dt as validateNodeListParams, ea as COMMAND_DESCRIPTION_MAX_LENGTH, en as validateSessionsUsageParams, et as validateExecApprovalsNodeGetParams, f as validateArtifactsDownloadParams, fn as validateTalkClientCreateParams, ft as validateNodePairApproveParams, g as validateChannelsStartParams, gn as validateTalkConfigParams, gt as validateNodePairRequestParams, h as validateChannelsLogoutParams, ht as validateNodePairRemoveParams, i as validateAgentWaitParams, in as validateSkillsSearchParams, it as validateMessageActionParams, j as validateConfigSetParams, k as validateConfigSchemaLookupResult, kn as validateTalkSessionSubmitToolResultParams, kt as validatePushTestParams, l as validateAgentsFilesSetParams, ln as validateSkillsUploadCommitParams, lt as validateNodeInvokeParams, m as validateArtifactsListParams, mn as validateTalkClientToolCallParams, mt as validateNodePairRejectParams, n as validateAgentIdentityParams, nn as validateSkillsDetailParams, nt as validateExecApprovalsSetParams, o as validateAgentsDeleteParams, on as validateSkillsUpdateParams, ot as validateNodeDescribeParams, p as validateArtifactsGetParams, pt as validateNodePairListParams, q as validateEnvironmentsListParams, qn as validateWebPushUnsubscribeParams, qt as validateSessionsMessagesUnsubscribeParams, r as validateAgentParams, rn as validateSkillsInstallParams, rt as validateLogsTailParams, s as validateAgentsFilesGetParams, sn as validateSkillsUploadBeginParams, st as validateNodeEventParams, t as formatValidationErrors, tn as validateSkillsBinsParams, tt as validateExecApprovalsNodeSetParams, u as validateAgentsListParams, un as validateTalkCatalogParams, ut as validateNodeInvokeResultParams, v as validateChannelsStopParams, vt as validateNodePendingAckParams, w as validateCommandsListParams, wn as validateTalkSessionCreateParams, xn as validateTalkSessionCancelOutputParams, yn as validateTalkModeParams, yt as validateNodePendingDrainParams, z as validateCronStatusParams, zn as validateToolsInvokeParams, zt as validateSessionsCompactionGetParams } from "./protocol-8H1JQJ4t.js";
import { r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-uYZeqLog.js";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-DtN_cGKo.js";
import { n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified } from "./core-descriptors-CwW7zXqN.js";
import { a as TALK_SECRETS_SCOPE, o as WRITE_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-Chm67yFb.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-CnRd7W8P.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-CpQSFuwN.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-XfwdriPL.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-DpgDYaud.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Cd4hdngq.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-DiB_AIRB.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-C86KUyvs.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-6lcDM5MI.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-Dq8mY7X0.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DbdMmy-5.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-Cnxmg94X.js";
import { t as isPluginJsonValue } from "./host-hook-json-D954Tf4Q.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-Cc6fUCKz.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-C3RO2YUD.js";
import { h as stringifyRouteThreadId } from "./channel-route-CGy6-Eam.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CzkDqCEX.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-izP4MuZ5.js";
import { t as loadSessionStore } from "./store-load-CYzFXvuT.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-C9YnZwAO.js";
import { s as updateSessionStore } from "./store-MLsIinKe.js";
import "./plugins-Cls6W1vf.js";
import { n as mergeSessionEntry } from "./types-CXS4Fv_X.js";
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-B5_JTnFp.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-Ddb9eeKo.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-DaFjr7Mb.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-Bw3XWOOM.js";
import { d as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-Dhs7ZDUG.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-C3wPDsUr.js";
import "./auth-profiles-Cv2JHMp0.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-CVGKwppA.js";
import { n as listProfilesForProvider } from "./profile-list-BpNS60Uz.js";
import { r as removeProviderAuthProfilesWithLock } from "./profiles-B-RXA6ZW.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-oSUt9FSF.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-tdqSzjqG.js";
import { _ as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-B0OF6UPV.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Dl9Q222A.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-D-MB6yyY.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CP0u4Rlo.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DzZnJAU4.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-Ca_ZeJNf.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-CqD9oiVd.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-zEPHEWSB.js";
...
import { i as resolveSandboxConfigForAgent } from "./config-Dc4B2BA8.js";
import { t as extractToolPayload } from "./tool-payload-Wv19z8yT.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-B5W_svfT.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-BqE7TU70.js";
import { l as getTotalQueueSize } from "./command-queue-9-KRAwfe.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-D4ZB_K3o.js";
import { n as resolveSendPolicy } from "./send-policy-Bj5CG7dV.js";
import { a as isTimeoutError } from "./failover-error-T-G-qMvB.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-CjkNfFYZ.js";
import "./runtime-internal-COXlJ-JZ.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-BY5--38a.js";
import { c as normalizeCronJobCreate, i as triggerSessionPatchHook, u as normalizeCronJobPatch } from "./openclaw-tools-DhJcHEwk.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-BIlbf7pK.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-Cp8Wj-JP.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, o as refreshActiveSecretsRuntimeSnapshot } from "./runtime-DZEgFdxO.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-CqjHNY-D.js";
import { i as parseAbsoluteTimeMs } from "./stagger-DDLjmBW-.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-EtKQtKPV.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-BSgua6rv.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-D9Xk2gWu.js";
import { a as clearSessionQueues } from "./queue-BZFAL7G5.js";
...
import { i as resolveReplyToMode } from "./reply-threading-9a8r57Tn.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-Nsnr9_aq.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-BNtrAgYd.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-BH-uGIBC.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-CH-U9HQ6.js";
import { t as sendDurableMessageBatch } from "./send-BpugAxu5.js";
import "./runtime-BbZatt-I.js";
import { n as normalizePollInput } from "./polls-BL1HNQQE.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BwCqGgzG.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-D8kE2zJ5.js";
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-DD_3cV3n.js";
import { r as resolveOutboundTarget } from "./targets-CrqvRhMi.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-DyMtlQB3.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-CJq22W2D.js";
import { o as dispatchChannelMessageAction } from "./message-action-runner-qdFZu6jV.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-pDO0Fj--.js";
import "./target-resolver-DUnCbmL5.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-BKv08pVf.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BSLFv0Tt.js";
import { C as setTtsEnabled, E as setTtsProvider, O as synthesizeSpeech, T as setTtsPersona, _ as resolveTtsConfig, f as listTtsPersonas, g as resolveTtsAutoMode, h as resolveExplicitTtsOverrides, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, y as resolveTtsProviderOrder } from "./tts-runtime-DAswBXRI.js";
import "./tts-IxY761Ir.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-C_0_XPpn.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Cs4d6U6U.js";
import "./skills-BO59ri45.js";
import { t as canExecRequestNode } from "./exec-defaults-L6dz2Mfu.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CAIY0tZb.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-B8_zsgE4.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-C8IwolFX.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-BxayM3m9.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BMun8ZaO.js";
import { t as compactEmbeddedPiSession } from "./compact.queued-yusK6gkQ.js";
import "./pi-embedded-ZHftI1aF.js";
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-BgJp6wQ6.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-C5PMVsob.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-LZ0nzEgX.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-BxDrMH3X.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DFV9P9ZV.js";
import "./commands-registry-zG1cNbWV.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-Bdn_LT7R.js";
import "./browser-maintenance-CeT7Q4_s.js";
import { c as performGatewaySessionReset } from "./session-reset-service-BhHdEHHC.js";
import { t as getPluginCommandSpecs } from "./command-specs-DhTtpPSi.js";
import { r as listPluginCommands } from "./commands-BLLQTxlq.js";
import { t as getChannelActivity } from "./channel-activity-BA7uFHmE.js";
import { t as WizardCancelledError } from "./prompts-CmaTLtqC.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-MYcQ3b_g.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Clm22p5V.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CF4Zkswz.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-hrQGcUJk.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-C2qrC3JD.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-CXd3_TUM.js";
import { r as agentCommandFromIngress } from "./agent-command-CMKb0mbG.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-BDDz-xUq.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-BTXSNvyB.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-LeggKC6R.js";
import { t as formatForLog } from "./ws-log-DTSe4FRT.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-Bscx-gtu.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-yF-IRZZx.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-CcDsPQ2y.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-DoNxCkO7.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-C8qQ-trh.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-DA91xFy-.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-B9LY2Kbq.js";
import { n as createOutboundSendDeps } from "./deps--NHgjdoa.js";
import "./agent-DsxQEKFb.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-CoTVq693.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-6TGZOGeU.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-zflZ4nWc.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-CFqJBpEg.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CDQQPl22.js";
import "./server-constants-v91hHrVm.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-Dt3DrDNV.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-DM8F06Gf.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-C3R7wNY2.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-BngjsQ0n.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-QRcOUPnq.js";
import { t as loadProviderUsageSummary } from "./provider-usage-BHTTTlNp.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-Duu3miVe.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-BtxRUyv0.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-jLPNcWKP.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-D2JOU6Hv.js";
import { t as buildChannelUiCatalog } from "./catalog-DlvoMd9X.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-2-eFnD_H.js";
import { s as normalizeUpdateChannel } from "./update-channels-DTkC9sbo.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CWUarSUG.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-DBzhUeHz.js";
import { t as readConfiguredLogTail } from "./log-tail-DcPhZ9ag.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CsxlUWA2.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-CSkR2rhC.js";
import { t as buildChannelAccountSnapshot } from "./status-DAS02XzV.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-BU-I7VMy.js";
import { t as installSkill } from "./skills-install-BLXX7GEn.js";
import { r as readPackageVersion } from "./package-json-DSPfkbVD.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-BhYngXwU.js";
import { t as getStatusSummary } from "./status.summary-Dj-ffqoi.js";
import "./status-Dgnj4V4Q.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CsZBOwtG.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-CiV0hi85.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-C_cfVUbf.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-BDmG3U4J.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-Ci6bcQst.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-DZGv5HOm.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-3cm6eju1.js";
import { t as diffConfigPaths } from "./config-diff-CYgQNNxg.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DEMhNL7G.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-DM1ExFqw.js";
import "./heartbeat-runner-DHuGBdPR.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-5p_EMKoc.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-DYA_0WzC.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-CdbfnqT_.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CwzWtXUJ.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-DczePLEk.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-Bgvl8s3D.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-Ds61YuWH.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-BdBGaOhj.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-BUYKTRhh.js";
...
const agentHandlers = {
	agent: async ({ params, respond, context, client, isWebchatConnect }) => {
		...
		const reserveExecApprovalFollowupDedupe = () => {
			if (agentDedupeReserved || !execApprovalFollowupApprovalId) return;
			setGatewayDedupeEntries({
				dedupe: context.dedupe,
				keys: agentDedupeKeys,
				entry: {
		...
		try {
			...
			if (requestedSessionKey) {
				...
				const labelValue = normalizeOptionalString$1(request.label) || entry?.label;
				const pluginOwnerId = entry === void 0 ? normalizeOptionalString$1(client?.internal?.pluginRuntimeOwnerId) : normalizeOptionalString$1(entry.pluginOwnerId);
				...
				const nextEntryPatch = {
					...
					sessionFile: entry?.sessionId && entry.sessionId !== sessionId ? void 0 : entry?.sessionFile,
...
async function loadModelsListCatalog(context, view, cfg) {
	if (view === "all") return await context.loadGatewayModelCatalog({ readOnly: false });
	if (parseConfiguredModelVisibilityEntries({ cfg }).providerWildcards.size > 0) return await context.loadGatewayModelCatalog({ readOnly: false });
	let timeout;
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CTU_hfcS.js");
...
function filterSessionStoreToConfiguredAgents(cfg, store) {
	...
	return Object.fromEntries(Object.entries(store).filter(([key]) => {
...
const sessionsHandlers = {
	"sessions.list": async ({ params, respond, context }) => {
		...
		respond(true, await measureDiagnosticsTimelineSpan("gateway.sessions.list", async () => {
			const { storePath, store } = measureDiagnosticsTimelineSpanSync("gateway.sessions.list.store_load", () => loadCombinedSessionStoreForGateway(cfg, {
				agentId: p.agentId,
...
async function readRecord(rootDir, uploadId) {
	const record = await readJsonIfExists(resolveMetadataPath(rootDir, uploadId));
	...
	return {
		...
		async begin(params) {
			return await withLock(`${rootDir}:begin`, async () => {
				...
				if (keyHash) {
					const existing = await readJsonIfExists(resolveIdempotencyPath(rootDir, keyHash));
					if (existing) {
...
async function startRealtimeToolCallAgentConsult(params) {
	...
	const runId = normalizeOptionalString$1(asOptionalRecord(chatResponse.result)?.runId) ?? idempotencyKey;
