...
import { n as matrixSetupAdapter } from "./setup-core-CwWwdgFS.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Dts-zEIt.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-CLpMliOu.js";
import { t as withResolvedActionClient } from "./client-BECipRkK.js";
import { r as resolveMatrixAuthContext } from "./config-CbCGF763.js";
import "./client-BvRIwKaw.js";
import "./runtime-api-CYAq4URm.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-Ddz3fjcL.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-Cmgw0Z2e.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CvzbZuvV.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-CL-aj4Tf.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DW7r5vuN.js");
