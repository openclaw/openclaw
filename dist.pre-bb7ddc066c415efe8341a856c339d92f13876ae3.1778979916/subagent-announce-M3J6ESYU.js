...
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DL0-grO4.js";
import "./message-channel-TSLTSa9Q.js";
...
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-B0OF6UPV.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-69KL-8Vy.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-D9OzlA0S.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DpFyNNFT.js";
import { i as consumePendingDelegates } from "./delegate-store-CZLWtYk7.js";
import "./continuation-delegate-store-CRo0W3zW.js";
import { n as resolveContinuationRuntimeConfig } from "./config-zW0nqMqA.js";
import "./delivery-context-CjTwZQJb.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-RmAWLqjS.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CejOtsBj.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-CAtlrcH1.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-BIscmj1v.js";
import { n as buildAnnounceIdFromChildRun, r as buildAnnounceIdempotencyKey, t as resolveAnnounceOrigin } from "./subagent-announce-origin-DPzareGL.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-CcKorSeu.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-DadeAifa.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-B4mClnj7.js"), import("./store-load-w7e3iSAO.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { hasCrossSessionDelegateTargeting } = await import("./targeting-pure-DYPOeWQT.js");
	if (!hasCrossSessionDelegateTargeting(params.targeting, params.dispatchingSessionKey)) return false;
	const { enqueueSystemEvent } = await import("./system-events-BkejHjvj.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-B7bVhVPQ.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-BkejHjvj.js");
			const { createSubsystemLogger } = await import("./subsystem-CBm3MUqP.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-CyEiUnXR.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
