...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-ByDvK3jv.js";
import { n as formatConfigIssueLines } from "./issue-format-O2IWAyJu.js";
import { t as note } from "./note-DqmDOrb0.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CHdWz4EI.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-D950FEtB.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-vYJOpojE.js");
