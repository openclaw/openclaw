...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-30WO8fIV.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-B8kD5Zjd.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-BFoNHViF.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CpKB_9Cl.js";
import "./channel-api-DMHI8H2x.js";
import { t as parseDiscordTarget } from "./target-parsing-BETp0YTb.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-z1OoqAkw.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-D2WFxXgH.js";
import { t as getDiscordRuntime } from "./runtime-By6B0gof.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-7C8seks8.js";
import { t as getDiscordApprovalCapability } from "./approval-native-DHNB005V.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-CxqCvR9T.js";
import { t as discordMessageActions$1 } from "./channel-actions-DU4C2F9n.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-_K9H0bIO.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BnHkuXxb.js";
import { n as discordOutbound } from "./outbound-adapter-LIgCsf2i.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-DVVIL8gF.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-De7sgL_u.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BpdSaj2s.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-c9LTPP6k.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Lrz_GQRT.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DwcZtxVY.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-YrouPoXz.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-CuoGKLod.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DkvDV7O5.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-pDrseSS1.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-bs2nnbUs.js");
