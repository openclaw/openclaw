import { i as OpenClawConfig, wn as CliBackendConfig } from "./types.openclaw-BuKAF4PW.js";
import { l as SecretInput } from "./types.secrets-BK49B9sN.js";
import { a as ModelCompatConfig, c as ModelProviderAuthMode, l as ModelProviderConfig } from "./types.models-DIMxudWn.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-BEeJreEW.js";
...
import { d as UnifiedModelCatalogKind, l as PluginKind, u as UnifiedModelCatalogEntry } from "./manifest-registry-DcyfKsW0.js";
import { n as ReasoningLevel, r as ThinkLevel } from "./thinking.shared-DVs1U58H.js";
import { t as ChannelId } from "./channel-id.types-BM6bwSVx.js";
import { c as SessionSystemPromptReport, o as SessionEntry } from "./types-2jXAeiOV.js";
import { r as AnyAgentTool } from "./common-DUJz-9i6.js";
import { S as HeartbeatToolResponse, a as PromptMode, b as MessagingToolSourceReplyPayload, h as EmbeddedPiCompactResult, p as ExecElevatedDefaults, r as RunEmbeddedPiAgentParams, s as BlockReplyChunking, v as EmbeddedRunLivenessState, y as MessagingToolSend } from "./params-DzsIk6Wq.js";
import { c as SourceReplyDeliveryMode, r as GetReplyOptions, u as ReplyPayload } from "./get-reply-options.types-DJsrtcW0.js";
import { c as DiagnosticEventPayload, kt as TalkTransport, o as DiagnosticEventInput, s as DiagnosticEventMetadata } from "./diagnostic-events-C9XeegY9.js";
...
import { N as WebFetchProviderPlugin, S as OpenClawPluginHookOptions, T as OpenClawPluginToolOptions, w as OpenClawPluginToolFactory, z as WebSearchProviderPlugin } from "./types-core-xB6vnoi2.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-Re9KW3tr2.js";
import { f as MediaUnderstandingProvider } from "./types-DXQk4N-G2.js";
import { l as ImageGenerationProvider } from "./types-BU72h8tR2.js";
import { s as VideoGenerationProvider } from "./types-xNNrBX_7.js";
import { c as MusicGenerationProvider } from "./types-DYJP4GnW.js";
...
import { A as SpeechSynthesisRequest, C as SpeechProviderId, D as SpeechProviderResolveConfigContext, E as SpeechProviderPreparedSynthesis, F as SpeechTelephonySynthesisRequest, I as SpeechTelephonySynthesisResult, L as SpeechVoiceOption, M as SpeechSynthesisStreamRequest, N as SpeechSynthesisStreamResult, O as SpeechProviderResolveTalkConfigContext, S as SpeechProviderConfiguredContext, T as SpeechProviderPrepareSynthesisContext, _ as SpeechDirectiveTokenParseContext, j as SpeechSynthesisResult, k as SpeechProviderResolveTalkOverridesContext, v as SpeechDirectiveTokenParseResult, x as SpeechProviderConfig, y as SpeechListVoicesRequest } from "./tts-runtime.types-TAo9Q9gY.js";
import { n as DetachedTaskLifecycleRuntime } from "./detached-task-runtime-contract-A2X3qnoT.js";
import { l as ContextEngine, m as ContextEngineRuntimeContext, p as ContextEnginePromptCacheInfo, t as ContextEngineFactory } from "./registry-dW8j1ZnN.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-CzDLXLrJ.js";
import { Gt as PluginConversationBindingRequestParams, It as PluginJsonValue, Jt as PluginConversationBindingResolvedEvent, Kt as PluginConversationBindingRequestResult, Nt as PluginNextTurnInjection, Pt as PluginNextTurnInjectionEnqueueResult, Wt as PluginConversationBinding, en as PluginHookBeforeAgentStartResult, et as PluginHookName, q as PluginHookHandlerMap } from "./hook-types-6JqGgfsx.js";
import { t as ToolOutcomeObserver } from "./pi-tools.before-tool-call-B5ehemhP.js";
...
import { r as InternalHookHandler } from "./internal-hook-types-BXNaCDJf.js";
...
//#endregion
export { OpenClawPluginSessionStateApi as $, ProviderResolveSyntheticAuthContext as $n, RealtimeTranscriptionSession as $r, ProviderNormalizeResolvedModelContext as $t, OpenClawPluginHttpRouteAuth as A, clearMemoryEmbeddingProviders as Ai, ProviderRuntimeProviderConfig as An, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as Ar, ProviderBuiltInModelSuppressionResult as At, OpenClawPluginNodeInvokePolicy as B, RealtimeVoiceProviderPlugin as Bn, RealtimeVoiceProviderCapabilities as Br, ProviderDiscoveryOrder as Bt, OpenClawPluginCliRegistrar as C, MemoryEmbeddingBatchChunk as Ci, ProviderResolveDynamicModelContext as Cn, AgentToolResultMiddlewareEvent as Cr, ProviderAuthMethod as Ct, OpenClawPluginGatewayMethod as D, MemoryEmbeddingProviderCreateOptions as Di, ProviderResolveUsageAuthContext as Dn, AgentToolResultMiddlewareRuntime as Dr, ProviderBuildMissingAuthMessageContext as Dt, OpenClawPluginDefinition as E, MemoryEmbeddingProviderAdapter as Ei, ProviderResolveTransportTurnStateContext as En, AgentToolResultMiddlewareResult as Er, ProviderAuthResult as Et, OpenClawPluginLifecycleApi as F, ProviderTransportTurnState as Fn, RealtimeVoiceBridgeCreateRequest as Fr, ProviderCatalogResult as Ft, OpenClawPluginReloadRegistration as G, ProviderDefaultThinkingPolicyContext as Gn, RealtimeVoiceRole as Gr, ProviderFetchUsageSnapshotContext as Gt, OpenClawPluginNodeInvokePolicyContext as H, UnifiedModelCatalogProviderContext as Hn, RealtimeVoiceProviderConfiguredContext as Hr, ProviderExtraParamsForTransportContext as Ht, OpenClawPluginModule as I, ProviderValidateReplayTurnsContext as In, RealtimeVoiceBridgeEvent as Ir, ProviderCreateEmbeddingProviderContext as It, OpenClawPluginSecurityAuditContext as J, ProviderRuntimeModel as Jn, RealtimeVoiceToolResultOptions as Jr, ProviderModelSelectedContext as Jt, OpenClawPluginRunContextApi as K, ProviderThinkingPolicyContext as Kn, RealtimeVoiceTool as Kr, ProviderFollowupFallbackRouteContext as Kt, OpenClawPluginNodeCliFeatureOptions as L, ProviderWebSocketSessionPolicy as Ln, RealtimeVoiceBrowserSession as Lr, ProviderCreateStreamFnContext as Lt, OpenClawPluginHttpRouteMatch as M, registerMemoryEmbeddingProvider as Mi, ProviderSystemPromptContributionContext as Mn, RealtimeVoiceBargeInOptions as Mr, ProviderCapabilities as Mt, OpenClawPluginHttpRouteParams as N, ProviderToolSchemaDiagnostic as Nn, RealtimeVoiceBridge as Nr, ProviderCatalogContext as Nt, OpenClawPluginGatewayRuntimeScopeSurface as O, MemoryEmbeddingProviderCreateResult as Oi, ProviderResolveWebSocketSessionPolicyContext as On, OpenClawAgentToolResult as Or, ProviderBuildUnknownModelHintContext as Ot, OpenClawPluginHttpRouteUpgradeHandler as P, ProviderTransformSystemPromptContext as Pn, RealtimeVoiceBridgeCallbacks as Pr, ProviderCatalogOrder as Pt, OpenClawPluginSessionControlsApi as Q, ProviderResolveExternalOAuthProfilesContext as Qn, RealtimeTranscriptionProviderResolveConfigContext as Qr, ProviderNormalizeModelIdContext as Qt, OpenClawPluginNodeHostCommand as R, ProviderWrapStreamFnContext as Rn, RealtimeVoiceBrowserSessionCreateRequest as Rr, ProviderDeferSyntheticProfileAuthContext as Rt, OpenClawPluginCliContext as S, resolveEmbeddedAgentRuntime as Si, ProviderResolveAuthProfileIdContext as Sn, AgentToolResultMiddlewareContext as Sr, ProviderAuthKind as St, OpenClawPluginConfigSchema as T, MemoryEmbeddingProvider as Ti, ProviderResolvePromptOverlayContext as Tn, AgentToolResultMiddlewareOptions as Tr, ProviderAuthOptionBag as Tt, OpenClawPluginNodeInvokePolicyResult as U, UnifiedModelCatalogProviderPlugin as Un, RealtimeVoiceProviderId as Ur, ProviderExtraParamsForTransportResult as Ut, OpenClawPluginNodeInvokePolicyApprovalRuntime as V, SpeechProviderPlugin as Vn, RealtimeVoiceProviderConfig as Vr, ProviderDiscoveryResult as Vt, OpenClawPluginNodeInvokeTransportResult as W, VideoGenerationProviderPlugin as Wn, RealtimeVoiceProviderResolveConfigContext as Wr, ProviderFailoverErrorContext as Wt, OpenClawPluginServiceContext as X, ProviderExternalOAuthProfile as Xn, RealtimeTranscriptionProviderConfiguredContext as Xr, ProviderNonInteractiveApiKeyCredentialParams as Xt, OpenClawPluginService as Y, ProviderExternalAuthProfile as Yn, RealtimeTranscriptionProviderConfig as Yr, ProviderModernModelPolicyContext as Yt, OpenClawPluginSessionApi as Z, ProviderResolveExternalAuthProfilesContext as Zn, RealtimeTranscriptionProviderId as Zr, ProviderNonInteractiveApiKeyResult as Zt, OpenClawPluginAgentApi as _, EmbeddedRunAttemptResult as _i, ProviderReplayPolicyContext as _n, CliBackendThinkingLevel as _r, PluginSpeechProviderEntry as _t, MigrationItem as a, AgentHarnessAttemptResult as ai, ProviderPluginDiscovery as an, CodexAppServerExtensionFactory as ar, PluginConfigMigration as at, OpenClawPluginChannelRegistration as b, AgentRuntimePlan as bi, ProviderReplaySessionState as bn, PluginTextTransforms as br, ProviderAuthContext as bt, MigrationItemStatus as c, AgentHarnessDeliveryDefaults as ci, ProviderPluginWizardSetup as cn, CodexAppServerToolResultHandlerResult as cr, PluginInteractiveHandlerRegistration as ct, MigrationProviderPlugin as d, AgentHarnessSideQuestionParams as di, ProviderPrepareExtraParamsContext as dn, CliBackendNormalizeConfigContext as dr, PluginLogger as dt, RealtimeTranscriptionSessionCallbacks as ei, ProviderNormalizeToolSchemasContext as en, ProviderSyntheticAuthResult as er, OpenClawPluginSessionWorkflowApi as et, MigrationProviderPreparation as f, AgentHarnessSideQuestionResult as fi, ProviderPrepareRuntimeAuthContext as fn, CliBackendPlugin as fr, PluginRealtimeTranscriptionProviderEntry as ft, OpenClawGatewayDiscoveryService as g, EmbeddedRunAttemptParams as gi, ProviderReplayPolicy as gn, CliBackendResolveExecutionArgsContext as gr, PluginSetupAutoEnableProbe as gt, OpenClawGatewayDiscoveryAdvertiseContext as h, CompactEmbeddedPiSessionParams as hi, ProviderReasoningOutputModeContext as hn, CliBackendResolveExecutionArgs as hr, PluginSetupAutoEnableContext as ht, MigrationDetection as i, AgentHarnessAttemptParams as ii, ProviderPluginCatalog as in, CodexAppServerExtensionContext as ir, PluginCommandResult as it, OpenClawPluginHttpRouteHandler as j, listRegisteredMemoryEmbeddingProviders as ji, ProviderSanitizeReplayHistoryContext as jn, RealtimeVoiceAudioFormat as jr, ProviderCacheTtlEligibilityContext as jt, OpenClawPluginHostedMediaResolver as k, MemoryEmbeddingProviderRuntime as ki, ProviderResolvedUsageAuth as kn, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as kr, ProviderBuiltInModelSuppressionContext as kt, MigrationPlan as l, AgentHarnessResetParams as li, ProviderPreferRuntimeResolvedModelContext as ln, CliBackendAuthEpochMode as lr, PluginInteractiveHandlerResult as lt, MusicGenerationProviderPlugin as m, AgentHarnessSupportContext as mi, ProviderReasoningOutputMode as mn, CliBackendPreparedExecution as mr, PluginRegistrationMode as mt, MediaUnderstandingProviderPlugin as n, ProviderSystemPromptContribution as ni, ProviderOAuthProfileIdRepair as nn, ProviderNormalizeConfigContext as nr, PluginCommandDiagnosticsSession as nt, MigrationItemAction as o, AgentHarnessCompactParams as oi, ProviderPluginWizard as on, CodexAppServerExtensionRuntime as or, PluginConfigValidation as ot, MigrationSummary as p, AgentHarnessSupport as pi, ProviderPreparedRuntimeAuth as pn, CliBackendPrepareExecutionContext as pr, PluginRealtimeVoiceProviderEntry as pt, OpenClawPluginSecurityAuditCollector as q, ProviderThinkingProfile as qn, RealtimeVoiceToolCallEvent as qr, ProviderFollowupFallbackRouteResult as qt, MigrationApplyResult as r, AgentHarness as ri, ProviderPlugin as rn, ProviderResolveConfigApiKeyContext as rr, PluginCommandHandler as rt, MigrationItemKind as s, AgentHarnessCompactResult as si, ProviderPluginWizardModelPicker as sn, CodexAppServerToolResultEvent as sr, PluginEmbeddingProvider as st, ImageGenerationProviderPlugin as t, RealtimeTranscriptionSessionCreateRequest as ti, ProviderNormalizeTransportContext as tn, ProviderApplyConfigDefaultsContext as tr, PluginCommandContext as tt, MigrationProviderContext as u, AgentHarnessResultClassification as ui, ProviderPrepareDynamicModelContext as un, CliBackendNativeToolMode as ur, PluginInteractiveRegistration as ut, OpenClawPluginAgentEventsApi as v, NormalizedUsage as vi, ProviderReplaySanitizeMode as vn, CliBundleMcpMode as vr, PluginTextTransformRegistration as vt, OpenClawPluginCommandDefinition as w, MemoryEmbeddingBatchOptions as wi, ProviderResolveNonInteractiveApiKeyParams as wn, AgentToolResultMiddlewareHarness as wr, ProviderAuthMethodNonInteractiveContext as wt, OpenClawPluginCliCommandDescriptor as x, BuildAgentRuntimePlanParams as xi, ProviderReplayToolCallIdMode as xn, AgentToolResultMiddleware as xr, ProviderAuthDoctorHintContext as xt, OpenClawPluginApi as y, normalizeUsage as yi, ProviderReplaySessionEntry as yn, PluginTextReplacement as yr, ProviderAugmentModelCatalogContext as yt, OpenClawPluginNodeInvokeApprovalDecision as z, RealtimeTranscriptionProviderPlugin as zn, RealtimeVoiceCloseReason as zr, ProviderDiscoveryContext as zt };