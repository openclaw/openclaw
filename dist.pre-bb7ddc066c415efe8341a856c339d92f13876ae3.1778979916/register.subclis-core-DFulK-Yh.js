...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-DXuAZmGA.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-DiM9VhMJ.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-Cu_jArOd.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-BOjBBaDj.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-Dm--ulql.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-Cys-LRYV.js"),
