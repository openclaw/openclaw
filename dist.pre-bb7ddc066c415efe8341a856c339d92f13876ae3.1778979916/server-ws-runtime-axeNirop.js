...
import { r as isLoopbackAddress } from "./net-CLmerLvz.js";
import { i as getRuntimeConfig } from "./io-ByDvK3jv.js";
import { o as isWebchatClient } from "./message-channel-TSLTSa9Q.js";
import { n as resolvePreauthHandshakeTimeoutMs } from "./handshake-timeouts-BqX9Dz42.js";
import "./client-DDADSo6k.js";
import { s as removeRemoteNodeInfo } from "./skills-remote-C8IwolFX.js";
import { t as resolveHostedPluginSurfaceUrl } from "./hosted-plugin-surface-url-BbdBv8Rq.js";
import { n as logWs } from "./ws-log-DTSe4FRT.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BA87bLmh.js";
import { a as MAX_PAYLOAD_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-v91hHrVm.js";
import { t as formatError } from "./server-utils-DYA_0WzC.js";
import { r as upsertPresence } from "./system-presence-CdbfnqT_.js";
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-CPJkKpvR.js";
import { i as clearNodeWakeState, t as broadcastPresenceSnapshot } from "./presence-events-Ds61YuWH.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Db4x6aa4.js";
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	import("./message-handler-kY8FngTN.js").then(({ attachGatewayWsMessageHandler }) => {
	...
	wss.on("connection", (socket, upgradeReq) => {
		...
		socket.once("close", (code, reason) => {
			...
			if (!client) {
				...
				(isNoisySwiftPmHelperClose(requestUserAgent, remoteAddr) || isExpectedStartupRetryClose ? logWsControl.debug : logWsControl.warn)(`closed before connect conn=${connId} peer=${endpoint ?? "n/a"} remote=${remoteAddr ?? "?"} fwd=${logForwardedFor || "n/a"} origin=${logOrigin || "n/a"} host=${logHost || "n/a"} ua=${logUserAgent || "n/a"} code=${code ?? "n/a"} reason=${logReason || "n/a"}`, closeContext);
			}
