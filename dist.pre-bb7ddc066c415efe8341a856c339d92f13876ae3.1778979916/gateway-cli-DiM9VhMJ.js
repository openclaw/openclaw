...
import { t as addGatewayServiceCommands } from "./register-service-commands-CwUQmzUg.js";
...
import { i as callGateway, l as formatGatewayTransportErrorJson } from "./call-CTkOURQV.js";
import { a as selectDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-tdqSzjqG.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-DQ5aPr6T.js";
...
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-D2axeQK8.js";
import { n as addGatewayRunCommand } from "./run-Bf8CewLv.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-CqvVChqE.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-os37pt2u.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-BJTkoPy8.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-swdA-6wI.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./health-style-DScO7EtQ.js"));
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-H_-rWQdi.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-BidWDJuh.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-CUlJenVV.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-BFwnIkV2.js"));
...
function runGatewayCommand(action, label, opts) {
