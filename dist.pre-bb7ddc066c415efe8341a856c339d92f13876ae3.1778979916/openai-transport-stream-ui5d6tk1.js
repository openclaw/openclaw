...
import { s as redactSensitiveText } from "./redact-CxqQQvmK.js";
import { t as createSubsystemLogger } from "./subsystem-CwZgZA6E.js";
import { d as isLinkLocalIpAddress, g as parseCanonicalIpAddress, o as isCloudMetadataIpAddress } from "./ip-Ch1-tjj_.js";
import { c as shouldUseEnvHttpProxyForUrl } from "./proxy-env-CfF7u2HQ.js";
import { L as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-5jeH_Uur.js";
import { r as resolveProviderRequestCapabilities } from "./provider-attribution-DHlgOVkW.js";
import { c as resolveProviderRequestPolicyConfig, i as mergeModelProviderRequestOverrides, n as buildProviderRequestDispatcherPolicy, r as getModelProviderRequestTransport } from "./provider-request-config-BLaBC-20.js";
import { t as redactIdentifier } from "./redact-identifier-D73pkUbd.js";
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin, m as mergeSsrFPolicies, x as ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist } from "./ssrf-lzTNq2GU.js";
import { a as withTrustedEnvProxyGuardedFetchMode, n as fetchWithSsrFGuard } from "./fetch-guard-DhZpRFQ2.js";
import { l as detectOpenAICompletionsCompat } from "./provider-model-compat-BXBDPKKe.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-Bmux7n2f.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-CXbE_Fge.js";
import { i as COPILOT_INTEGRATION_ID, s as buildCopilotIdeHeaders } from "./provider-auth-CUxupOK9.js";
import { r as resolveDebugProxySettings } from "./env--huwaqgq.js";
import { n as ensureModelProviderLocalService } from "./provider-local-service-BiFpctu-.js";
import { n as repairToolUseResultPairing } from "./session-transcript-repair-DgkuRfWH.js";
	...
	return (model, context, options) => {
		...
		(async () => {
			...
			try {
				...
				await processOpenAICompletionsStream(responseStream, output, model, stream, { signal: options?.signal });
				if (options?.signal?.aborted) throw new Error("Request was aborted");
				stream.push({
					type: "done",
					reason: output.stopReason,
...
function getCompat(model) {
	...
	return {
		...
		requiresReasoningContentOnAssistantMessages: detected.requiresReasoningContentOnAssistantMessages
	};
}
...
function resolveOpenAICompletionsMaxTokens(model, options) {
	...
	return (options?.maxTokens || void 0) ?? (paramsMaxTokens || void 0) ?? model.maxTokens;
}
...
function shouldPreserveReasoningContentReplay(model, compat) {
	if (compat.requiresReasoningContentOnAssistantMessages || compat.thinkingFormat === "deepseek" || compat.thinkingFormat === "zai") return true;
...
//#endregion
export { buildCopilotDynamicHeaders as C, emitModelTransportDebug as S, mergeTransportHeaders as _, applyOpenAIResponsesPayloadPolicy as a, transformTransportMessages as b, flattenCompletionMessagesToStringContent as c, resolveMaxTokensParam as d, coerceTransportToolCallArguments as f, finalizeTransportStream as g, failTransportStream as h, createOpenAIResponsesTransportStreamFn as i, stripCompletionMessagesToRoleContent as l, createWritableTransportEventStream as m, createAzureOpenAIResponsesTransportStreamFn as n, resolveOpenAIResponsesPayloadPolicy as o, createEmptyTransportUsage as p, createOpenAICompletionsTransportStreamFn as r, resolveOpenAIReasoningEffortForModel as s, buildOpenAICompletionsParams as t, canonicalizeMaxTokensParam as u, sanitizeNonEmptyTransportPayloadText as v, hasCopilotVisionInput as w, buildGuardedModelFetch as x, sanitizeTransportPayloadText as y };
