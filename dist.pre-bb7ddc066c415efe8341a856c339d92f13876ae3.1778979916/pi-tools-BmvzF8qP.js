...
import { d as resolveGatewayMessageChannel } from "./message-channel-TSLTSa9Q.js";
import { n as assertSandboxPath } from "./sandbox-paths-Bc_J6h0q.js";
import { i as toRelativeSandboxPath, n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-DsyK3dCz.js";
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName } from "./tool-policy-shared-Dl9Q222A.js";
import { a as collectExplicitAllowlist, d as mergeAlsoAllowPolicy, f as replaceWithEffectiveToolAllowlist, l as hasRestrictiveAllowPolicy, o as collectExplicitDenylist, r as applyOwnerOnlyToolPolicy } from "./tool-policy-COpWYESI.js";
...
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-BUwO1T6m.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CrJ_QCxQ.js";
import { C as wrapToolMemoryFlushAppendOnlyWrite, S as wrapToolMemoryDayFileWriteGuard, T as wrapToolWorkspaceRootGuardWithOptions, _ as createHostWorkspaceWriteTool, b as createSandboxedReadTool, d as resolveToolLoopDetectionConfig, g as createHostWorkspaceEditTool, h as createHostWorkspaceAppendTool, k as resolveOpenClawPluginToolsForOptions, t as createOpenClawTools, v as createOpenClawReadTool, w as wrapToolWorkspaceRootGuard, x as createSandboxedWriteTool, y as createSandboxedEditTool } from "./openclaw-tools-DhJcHEwk.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Ds5GLaT4.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-BqYbKr_z.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-BQRD93et.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-BIlbf7pK.js";
...
import { a as copyBeforeToolCallHookMarker, d as wrapToolWithBeforeToolCallHook, f as copyChannelAgentToolMeta, h as listChannelAgentTools, l as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-DHtQ7hrx.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-DzugtvHv.js";
import "./codex-native-web-search-DyAyo0sc.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-DHPeQHu2.js";
import { t as bindAbortRelay } from "./fetch-timeout-C-Atv61N.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-BSgua6rv.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-CgDk8OgE.js"));
