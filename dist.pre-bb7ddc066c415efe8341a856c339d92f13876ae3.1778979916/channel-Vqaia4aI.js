...
import { s as hasConfiguredSecretInput } from "./types.secrets-Co1lNtpa.js";
...
import { f as renderMessagePresentationFallbackText, l as normalizeMessagePresentation } from "./payload-oUECwj42.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-_E5Us7ZD.js";
import { a as createActionGate } from "./common-DHPeQHu2.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-caI9TN6H.js";
import { r as getSessionBindingService } from "./session-binding-service-jyTuWwhb.js";
import "./string-coerce-runtime-Dpi9hISx.js";
import { n as describeAccountSnapshot } from "./account-helpers-BurzH0yP.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-CDnkZFnA.js";
import "./channel-core-DvUuR0bG.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-Cgysik1Z.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-B6iH-l9Y.js";
import "./setup-ChJe51yi.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-3MafBIbe.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-BpKiD9hL.js";
...
import "./account-resolution-C_kG3SFV.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DAZut6Hh.js";
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-MWz4ebYh.js";
import "./channel-status-D8Np2Hnc.js";
import "./channel-config-primitives-gDI3pY-0.js";
import "./channel-actions-qudH-xs4.js";
import { r as defineChannelMessageAdapter } from "./channel-message-CnGoBBDG.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-CNTI8ttR.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-DP1mIjk0.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-Csst0n9_.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-CTCuQEwv.js";
import { n as createFeishuSendReceipt } from "./send-result-Crdt2WIX.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-CMDR9ojp.js";
import { t as messageActionTargetAliases } from "./security-audit-rwbPFVBj.js";
import { o as resolveFeishuGroupToolPolicy } from "./policy-DAQ2_zjC.js";
...
import { t as resolveFeishuSessionConversation } from "./session-conversation-5DsTkbAu.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-DTxAr04I.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-DTxAr04I.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-DdEHZFKC.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-fdXFvB2V.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-ChJOqEKx.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-B0Nz1gbi.js");
