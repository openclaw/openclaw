...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-DXGTDSD0.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-xkGwiIJl.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-BXXLC2c9.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-TSLTSa9Q.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-izP4MuZ5.js";
import { c as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-CYzFXvuT.js";
import { c as updateSessionStoreEntry, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-MLsIinKe.js";
...
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-oSUt9FSF.js";
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-B0OF6UPV.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-Doh6T8hM.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-B3ZcUuj5.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-Dh6Nz7hQ.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-aJIuI6UH.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-Bg3WoBM8.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-OcMk78Z7.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-fd-kR6sE.js";
import { r as hasCrossSessionDelegateTargeting } from "./targeting-pure-6lvhIYA-.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DpFyNNFT.js";
import { u as stripHeartbeatToken } from "./heartbeat-SXc7l7P7.js";
import { r as enqueueCommitmentExtraction } from "./runtime-07-ug6el.js";
import { c as emitContinuationWorkSpan, g as startContinuationDelegateSpan, i as emitContinuationDisabledSpan, m as resolveContinuationTraceparent, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-DiLKzerN.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-B5W_svfT.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-B3BCLMBL.js";
import { a as enqueueSystemEvent } from "./system-events-BqE7TU70.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-9-KRAwfe.js";
import { n as resolveSendPolicy } from "./send-policy-Bj5CG7dV.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-CZLWtYk7.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-CRo0W3zW.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-zW0nqMqA.js";
import { t as checkContextPressure } from "./context-pressure-Dv-IX_Fl.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-B73eh5Vn.js";
import { a as listLegacyRuntimeModelProviderAliases, s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-jZ_YBFNZ.js";
import "./pi-embedded-helpers-BMLB2L5F.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-CjVlE4_s.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-CS--39Mi.js";
import { t as formatProviderModelRef } from "./model-runtime-__OtKrCn.js";
import "./fallback-notice-state-CVc9oMWK.js";
...
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-DmFIb-l2.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-BZFAL7G5.js";
import { n as hasCotFramePrefix } from "./normalize-reply-HHwolK6h.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-CxY8vqc_.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-9a8r57Tn.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-DwrEawGY.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BI9-2PID.js";
import { u as parseReplyDirectives } from "./payloads-CH-U9HQ6.js";
import { f as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BhqFp6km.js";
import { t as runCliAgent } from "./cli-runner-CwzrESIv.js";
import { r as getCliSessionBinding } from "./cli-session-BeJyxwjz.js";
import { G as isLikelyExecutionAckPrompt } from "./selection-BajymN7l.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-BKgKWdjT.js";
import "./sandbox-CQ50mH2J.js";
import { n as readPostCompactionContext } from "./post-compaction-context-DRxfvq5e.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-DrjbBAci.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DrGXxIqe.js";
...
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CLFqqsA1.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-BQN1vw-S.js";
...
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-HwuftkGE.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-CIuO1STy.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-BxbMUxGS.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-DkiueLxx.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-CTxlt0L8.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-BbYJGmao.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-Bm3axsRz.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-DPZwUmGK.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-Dd-BC9k6.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-ycecd_Nh.js"),
					import("./config-ND55i0aa.js"),
					import("./state-CcKorSeu.js"),
					import("./store-AONzvYTj.js")
				]);
