...
import { n as openUrl } from "./browser-open-sAoRa-tl.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-i7bXtfNj.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BqmJobA_.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-Co2CfcIf.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-wWT0rp5a.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-BMeE0TZr.js") };
