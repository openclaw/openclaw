...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter } from "./agent-scope-DXGTDSD0.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-bmH32UOR.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-8g_Q03Po.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-DaaBuyRT.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-DdZBnV-N.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DgUPESoD.js";
import { u as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-BdP7FN6x.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-xkGwiIJl.js";
...
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-TSLTSa9Q.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-CzkDqCEX.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-izP4MuZ5.js";
import { T as parseSessionThreadInfoFast, c as resolveSessionStoreEntry, t as loadSessionStore, x as resolveMaintenanceConfigFromInput } from "./store-load-CYzFXvuT.js";
...
import { m as deriveSessionMetaPatch, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-MLsIinKe.js";
...
import { c as resolveSessionLifecycleTimestamps } from "./sessions-B5_JTnFp.js";
...
import { l as resolveAndPersistSessionFile } from "./transcript-CWETPHzg.js";
import { b as resolveModelRefFromString } from "./model-selection-shared-Dhs7ZDUG.js";
import { n as modelKey } from "./model-selection-normalize-Dh_E0SEQ.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-BxUseaAH.js";
import { r as applyOwnerOnlyToolPolicy } from "./tool-policy-COpWYESI.js";
import { o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-D-MB6yyY.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-HOjttyC7.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-DpFyNNFT.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-SXc7l7P7.js";
import { a as generateSecureToken } from "./secure-random-B3BCLMBL.js";
import { a as enqueueSystemEvent, u as removeSystemEvents } from "./system-events-BqE7TU70.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-9-KRAwfe.js";
import { a as resolveSilentReplySettings, i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-FNb2P4vk.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-DkTysg6B.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, s as resolveCommandTurnContext } from "./command-turn-context-BWY-4JJT.js";
import "./delivery-context-CjTwZQJb.js";
import { t as resolveQueueSettings } from "./queue-BZFAL7G5.js";
import { t as buildOutboundSessionContext } from "./session-context-Csv7bmTH.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-CGZuwphf.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-CXehFdkC.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-BmSPFaci.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Dj1xV_EG.js";
import "./pi-bundle-mcp-tools-cHHwA3eE.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BSLFv0Tt.js";
import { r as getCliSessionBinding } from "./cli-session-BeJyxwjz.js";
import { at as isReasoningTagProvider } from "./selection-BajymN7l.js";
import { y as collectTextContentBlocks } from "./attempt.tool-run-context-9UadYZkf.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-TUchsRP-.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-_eO2_xFW.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CLFqqsA1.js";
import { a as noteActiveSessionForShutdown, n as buildSessionStartHookPayload, r as forgetActiveSessionForShutdown, t as buildSessionEndHookPayload } from "./session-hooks-BTlyfFJ0.js";
import { r as drainFormattedSystemEventBlock } from "./session-updates-BAgmAESc.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-CIuO1STy.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-BxbMUxGS.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-B-R-yncB.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-p4ptkFB5.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-C67XXV7O.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-Dk6m4DP0.js";
import "./commands-registry-zG1cNbWV.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-CsR7T4aG.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-CXu0AQ0G.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-CgGS6TUZ.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-PAsGAfU5.js";
import { t as finalizeInboundContext } from "./inbound-context-DMWZCRo0.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-mBZJRShY.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-kRVg71Xm.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-CjQ850AT.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-CeT7Q4_s.js";
import { t as hasControlCommand } from "./command-detection-cI8e04yd.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DA44YGxg.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-B05YpEhx.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-Dk-MBOTG.js";
import { t as resolveFastModeState } from "./fast-mode-B_AXQKz6.js";
import { t as buildCommandContext } from "./commands-context-Dl5xZC3i.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-DYUNWj1d.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-DWurNsCv.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-B3C0JkBF.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-g5FT2QZN.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-zPS_KBfd.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-C2sT2gz-.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DjP8W9_U.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CXMDuVeM.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-BCjmWPRb.js";
import { t as hasInboundMedia } from "./inbound-media-DgP2j_6W.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-x5Mo8rB8.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-CfHVIlnq.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-BlE4aJu4.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-CIRcg0RL.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-M0Nk6eRI.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-D4sNNfAE.js"));
...
function buildReplyPromptEnvelopeBase(params) {
	...
	return {
		...
		currentTurnContext: !params.isBareSessionReset && currentTurnContextText ? {
...
async function runPreparedReply(params) {
	...
	let { prefixedCommandBody, queuedBody, transcriptCommandBody, currentTurnContext } = await traceRunPhase("reply.build_prompt_bodies", () => rebuildPromptBodies());
	...
	if (isActive && activeRunQueueAction === "run-now") {
		const queueState = await resolvePreparedReplyQueueState({
			...
			refreshPreparedState: async () => {
				...
				preparedSessionState = resolvePreparedSessionState();
				({prefixedCommandBody, queuedBody, transcriptCommandBody, currentTurnContext} = await traceRunPhase("reply.build_prompt_bodies", () => rebuildPromptBodies()));
			},
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-BYbyA7ey.js");
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-4B79PY11.js"));
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-RHK8JNRw.js");
