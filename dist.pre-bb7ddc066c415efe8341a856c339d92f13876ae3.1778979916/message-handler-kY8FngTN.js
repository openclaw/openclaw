...
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-CLmerLvz.js";
import { i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-9sfvTJqB.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-p1uCwunm.js";
import { i as getRuntimeConfig } from "./io-ByDvK3jv.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-Cy5O_7Bd.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-1Q-QxpL0.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-TSLTSa9Q.js";
import { c as GATEWAY_STARTUP_PENDING_CLOSE_CAUSE, d as buildDeviceAuthPayloadV3, l as gatewayStartupUnavailableDetails, o as GATEWAY_STARTUP_CLOSE_CODE, s as GATEWAY_STARTUP_CLOSE_REASON, u as buildDeviceAuthPayload } from "./client-DDADSo6k.js";
...
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-De6wq2Ku.js";
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-8H1JQJ4t.js";
...
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-B8_zsgE4.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-C8IwolFX.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-DopBg-Iu.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-BDDz-xUq.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-BTXSNvyB.js";
import { n as logWs, t as formatForLog } from "./ws-log-DTSe4FRT.js";
import { a as restoreDeviceBootstrapToken, c as verifyDeviceBootstrapToken, i as redeemDeviceBootstrapTokenProfile, n as getDeviceBootstrapTokenProfile, o as revokeDeviceBootstrapToken } from "./device-bootstrap-eqLj34wV.js";
import { _ as verifyDeviceToken, c as listDevicePairing, f as requestDevicePairing, g as updatePairedDeviceMetadata, i as getPairedDevice, l as listEffectivePairedDeviceRoles, n as ensureDeviceToken, o as hasEffectivePairedDeviceRole, s as listApprovedPairedDeviceRoles, t as approveDevicePairing } from "./device-pairing-DoNxCkO7.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BA87bLmh.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-v91hHrVm.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-DYA_0WzC.js";
import { r as upsertPresence } from "./system-presence-CdbfnqT_.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-CPJkKpvR.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CwzWtXUJ.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Db4x6aa4.js";
import { t as truncateCloseReason } from "./close-reason-DQsugrD4.js";
...
function resolvePinnedClientMetadata(params) {
	...
	const platformMismatch = hasPinnedPlatform && claimedPlatform !== pairedPlatform && !isLegacyNodeHostPlatformPin;
	const deviceFamilyMismatch = hasPinnedDeviceFamily && claimedDeviceFamily !== pairedDeviceFamily;
	const pinnedPlatform = claimedPlatform === pairedPlatform ? params.pairedPlatform : isLegacyNodeHostPlatformPin ? normalizeLegacyNodeHostPlatformPin(pairedPlatform) : void 0;
	return {
		platformMismatch,
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-DSV_YGlS.js");
