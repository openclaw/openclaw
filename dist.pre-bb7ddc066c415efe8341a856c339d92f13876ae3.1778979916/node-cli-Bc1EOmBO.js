...
import { b as resolveExecutableFromPathEnv, d as resolveApprovalAuditCandidatePath, p as resolveCommandResolutionFromArgv } from "./exec-safe-bin-trust-DTEoxDyn.js";
import { O as normalizeExecutableToken, S as unwrapKnownDispatchWrapperInvocation, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, g as resolveInlineCommandMatch, k as splitShellArgs, l as isShellWrapperInvocation, p as advancePosixInlineOptionScan, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, v as extractEnvAssignmentKeysFromDispatchWrappers } from "./shell-wrapper-resolution-CJje-O76.js";
import "./config-CIM_gEq1.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-C27-4rQ7.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-Cxv-w1g-.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-Dj0-FdFv.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-De6wq2Ku.js";
...
import { c as describeInterpreterInlineEval } from "./risks-Dhgk-X3H.js";
import { c as analyzeArgvCommand, d as buildSafeBinsShellCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-CzzndoFe.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-BQRD93et.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-Cd3aS6eZ.js";
import { t as formatHelpExamples } from "./help-format-CViMN67J.js";
import { n as detectPolicyInlineEval } from "./policy-iLQRfB4m.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-6TGZOGeU.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-paXte_fu.js";
import { t as resolveNodeService } from "./node-service-CSmMhcC0.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-DbPA9Qb_.js");
