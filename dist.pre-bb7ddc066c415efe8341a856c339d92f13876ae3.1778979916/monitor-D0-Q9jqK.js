...
import { b as escapeRegExp } from "./utils-CpmNtyoq.js";
import { c as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-CYzFXvuT.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-CAVkwuEU.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-BSgua6rv.js";
import { t as resolveAckReaction } from "./identity-E3meQIJg.js";
import { _ as resolveChannelProgressDraftMaxLines, a as createChannelProgressDraftGate, c as formatChannelProgressDraftText, d as mergeChannelProgressDraftLine, f as normalizeChannelProgressDraftLineIdentity, i as buildChannelProgressDraftLineForEntry, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./channel-streaming-1LmL9FAy.js";
import { a as deliverWithFinalizableLivePreviewAdapter, n as createPreviewMessageReceipt, r as defineFinalizableLivePreviewAdapter } from "./live-D9DtHROS.js";
import { i as writeJsonFileAtomically, n as readJsonFileWithFallback } from "./json-store-HbM3czXy.js";
import "./string-coerce-runtime-Dpi9hISx.js";
import { o as buildInboundHistoryFromEntries } from "./history-B98zrf4u.js";
import { n as createReplyPrefixOptions } from "./reply-prefix-Dv3iHgpl.js";
import { t as createTypingCallbacks } from "./typing-B-qVznmN.js";
import { i as mergePairLoopGuardConfig } from "./pair-loop-guard-runtime-61pRwYdV.js";
import { n as hasFinalChannelTurnDispatch } from "./dispatch-result-BlfMaaUM.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-DZlGjcpV.js";
import { a as waitUntilAbort } from "./channel-lifecycle.core-DDdfTHWh.js";
import { c as buildAllowlistResolutionSummary, d as patchAllowlistUsersInConfigEntries, f as summarizeMapping, l as canonicalizeAllowlistWithResolvedIds, s as addAllowlistUserEntriesFromConfigEntry } from "./allow-from-EFFBJca2.js";
...
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-CcacU6Ui.js";
import { l as resolvePinnedMainDmOwnerFromAllowlist } from "./channel-access-compat-CbVs_A5Z.js";
import "./reply-history-Ddp8pNbY.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-o0OwWyJq.js";
import { r as registerChannelRuntimeContext } from "./channel-runtime-context-l3Jr4cnz.js";
...
import { t as isMatrixQualifiedUserId } from "./target-ids-BwIkSEIR.js";
import { a as resolveMatrixAccountConfig, i as resolveMatrixAccountAllowlistConfig } from "./account-config-O3FO9EsV.js";
import { t as getMatrixRuntime } from "./runtime-BNUFrEZD.js";
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-BRJjFyxU.js";
import { n as normalizeMatrixUserId, r as resolveMatrixAllowListMatch, t as normalizeMatrixAllowList } from "./allowlist-CqPFFkHR.js";
import { r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-MZ1YNTc2.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-DZ7KUe4J.js";
import { i as resolveMatrixStateFilePath } from "./storage-BF493DmK.js";
import { a as sendMessageMatrix, g as isPollStartType, h as isPollEventType, p as formatPollAsText, t as chunkMatrixText, v as parsePollStartContent } from "./send-CJ8Xzvoe.js";
import { o as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY, r as promoteMatrixDirectRoomCandidate } from "./direct-management-ClXw-ZzA.js";
import { o as readJoinedMatrixMembers, r as isStrictDirectMembership, t as hasDirectMatrixMemberFlag } from "./direct-room-Dc30vRs2.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-DVNcIglg.js";
import { t as createAsyncLock } from "./async-lock-SMqGYcSU.js";
import { n as LogService } from "./logger-q0n5X2yq.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-2-PD0jTo.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-B15YnL9p.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState, t as isMatrixDisconnectedSyncState } from "./sync-state-ViNexZ3h.js";
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-CAuOmg0w.js";
import { n as setActiveMatrixClient } from "./active-client-DZDI3cBM.js";
import { t as isBunRuntime } from "./runtime-D-ji5Va1.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-CbCGF763.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-B24GB9PA.js";
import "./client-BvRIwKaw.js";
import "./runtime-api-CYAq4URm.js";
import { t as resolveMatrixTargets } from "./resolve-targets-CvCmBwxF.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance--R0G4rwD.js";
import { a as EventType, i as resolveMatrixThreadRouting, n as resolveMatrixReplyToEventId, o as RelationType, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-Btdix3q2.js";
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-CL-aj4Tf.js"), import("./direct-room-CycJTL9M.js")]).then(([directManagementModule, directRoomModule]) => ({
...
function loadMatrixSendModule() {
	matrixSendModulePromise ??= import("./send-ws7GsvIO.js");
...
function loadMatrixReactionEvents() {
	matrixReactionEventsPromise ??= import("./reaction-events-Dwc3gnUp.js");
	return matrixReactionEventsPromise;
}
function loadMatrixDraftStream() {
	matrixDraftStreamPromise ??= import("./draft-stream-Bs5JKNGx.js");
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-CBhYtwr2.js"),
		import("./device-health-Bg8hU_3l.js"),
		import("./profile-C74ovMuo.js"),
		import("./legacy-crypto-restore-CFs2rgmI.js"),
		import("./startup-verification-v-9skCZk.js")
