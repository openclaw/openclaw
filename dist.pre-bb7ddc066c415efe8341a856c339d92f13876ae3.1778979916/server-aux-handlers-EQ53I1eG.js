...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-DtN_cGKo.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-Cls6W1vf.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-Cp8Wj-JP.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DZEgFdxO.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-KbUhqG9A.js";
...
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-CeFBST2k.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-Ew3kHunh.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DNJ5hjDL.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-DoNxCkO7.js";
...
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DEMhNL7G.js";
...
import "./server-aux-methods-ZrkHH8rt.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-DvHXscBf.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-Sci8eMyj.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-DuuyqMcX.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
