...
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-1Q-QxpL0.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DL0-grO4.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-TSLTSa9Q.js";
import { r as setSafeTimeout } from "./timer-delay-B3WUtwxI.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-8H1JQJ4t.js";
...
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-CWETPHzg.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Pp-VxfGB.js";
import { b as resolveModelRefFromString, c as inferUniqueProviderFromConfiguredModels, i as buildModelAliasIndex } from "./model-selection-shared-Dhs7ZDUG.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-CqD9oiVd.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-B8-cafD7.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-BMNgsL5q.js";
...
import { n as rewriteTranscriptEntriesInSessionFile } from "./context-engine-maintenance-B-I4qZ-i.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-ClC2f65S.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-BSgua6rv.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-DMRkgxH4.js";
import { f as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-RmAWLqjS.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-CH-U9HQ6.js";
...
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-hfJ-ueUU.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-CsMKs3-s.js";
...
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-BP9D0NT0.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-v91hHrVm.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-BEfttJpt.js";
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-DM8F06Gf.js";
import { a as resolveChatAttachmentLooksLikeImage, i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-C3R7wNY2.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-BziBjWpF.js";
