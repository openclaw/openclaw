...
import { i as getMemoryCapabilityRegistration, l as listActiveMemoryPublicArtifacts } from "./memory-state-DzCkKlf0.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-C3RO2YUD.js";
import { o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-OMpG-UH5.js";
...
import { n as callGatewayFromCli } from "./gateway-rpc-D76C-Ud2.js";
import { r as resolveTranscriptStemToSessionKeys, t as extractTranscriptIdentityFromSessionsMemoryHit } from "./session-transcript-hit-BDpFGFZW.js";
...
import { n as getActiveMemorySearchManager } from "./memory-host-search-BnX96ksb.js";
import { d as resolveMemoryWikiConfig, o as WIKI_SEARCH_BACKENDS, s as WIKI_SEARCH_CORPORA } from "./config-qAw0_LiY.js";
...
async function createSessionMemoryPathVisibilityChecker(params) {
	...
	return (relPath) => {
		...
		const archivedOwnerAgentId = Boolean(identity.archived && identity.ownerAgentId && (!normalizedScopedAgentId || normalizedOwnerAgentId === normalizedScopedAgentId)) ? identity.ownerAgentId : void 0;
