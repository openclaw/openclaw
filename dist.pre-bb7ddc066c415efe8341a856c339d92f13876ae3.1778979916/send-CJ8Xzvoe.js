import { o as __toESM, t as __commonJSMin } from "./chunk-HkwdBwDg.js";
...
import { t as requireRuntimeConfig } from "./plugin-config-runtime-uY3mQv3I.js";
import { t as loadOutboundMediaFromUrl } from "./outbound-media-CGqnlISR.js";
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-mhsUxLHP.js";
import "./channel-message-CnGoBBDG.js";
import "./text-autolink-runtime-Bt_VEWBR.js";
import { t as require_src } from "./src-DMlHeMqS.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-BwIkSEIR.js";
import { a as resolveMatrixAccountConfig } from "./account-config-O3FO9EsV.js";
import { t as getMatrixRuntime } from "./runtime-BNUFrEZD.js";
import { r as buildMatrixReactionContent } from "./reaction-common-9EwsJ-z6.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-ClXw-ZzA.js";
import { t as fromBuffer } from "./lib-DtPsFFYN.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-B1hygtid.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-jJRTpf8m.js";
import { l as toRatio, n as decodeString } from "./Util-B_jE0d-D.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-TIiSFyW6.js";
import { t as APEv2Parser } from "./APEv2Parser-B0O3AhPM.js";
import { r as hasID3v1Header } from "./ID3v1Parser-B3iw9gFE.js";
import { i as isStrictDirectRoom } from "./direct-room-Dc30vRs2.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-D5pKhW9i.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-81i88jrS.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Dhju8yAO.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-D38KyoW9.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DwWZmd9k.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-B6ZCbKpE.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Cs0-BAD8.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BS6SnZ3i.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-C0A69ziS.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BPN6sWwf.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CVIsYAp8.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DQXXyKw-.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-UcHSbox0.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CNLKUSPV.js")).WaveParser;
	}
};
//#endregion
