...
export default defineConfig({
  resolve: {
    // Keep this ordered: the base `smart-agent-neo/plugin-sdk` alias is a prefix match.
    alias: [
      {
        find: "smart-agent-neo/plugin-sdk/account-id",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "account-id.ts"),
      },
      {
        find: "smart-agent-neo/plugin-sdk",
