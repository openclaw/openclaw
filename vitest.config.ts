...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      "extensions/wemp/src/channel-enable-disable.test.ts",
      "extensions/wemp/src/channel-media-send.test.ts",
      "extensions/wemp/src/channel-reload.test.ts",
      "extensions/wemp/src/e2e-local.test.ts",
      "extensions/wemp/src/feature-storage.test.ts",
      "extensions/wemp/src/handoff-notify.test.ts",
      "extensions/wemp/src/inbound.test.ts",
      "extensions/wemp/src/log.test.ts",
