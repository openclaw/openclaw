...
import { a as resolveAgentDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-DdvF1onI.js";
import { o as withFileLock } from "./file-lock-BhZ1fIVv.js";
import "./file-lock-BLVQdNSg.js";
import { l as resolveAuthStorePath } from "./runtime-snapshots-DMGDLaeG.js";
import { i as AUTH_STORE_LOCK_OPTIONS } from "./store-cache-b4fi2Vpf.js";
import { D as hasUsableOAuthCredential, T as areOAuthCredentialsEquivalent, f as saveAuthProfileStore, g as loadPersistedAuthProfileStore, k as isSafeToAdoptMainStoreOAuthIdentity } from "./store-DeL3KnJu.js";
...
function isLegacyOAuthRef(value) {
	return isRecord(value) && value.source === LEGACY_OAUTH_REF_SOURCE && value.provider === LEGACY_OAUTH_REF_PROVIDER && typeof value.id === "string" && /^[a-f0-9]{32}$/.test(value.id);
}
...
function hasLegacyOAuthSidecarRef(raw, profileId) {
	...
	return profile.type === "oauth" && profile.provider === LEGACY_OAUTH_REF_PROVIDER && isLegacyOAuthRef(profile.oauthRef);
}
