...
import { n as LogService } from "./logger-B2UybExv.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-2uuwZH61.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-Cwf97Yhd.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-B_YCMnjA.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
