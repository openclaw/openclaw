...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-pbV4MNQ6.js";
import "./config-Cwf97Yhd.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DUrFHuf9.js"), import("./logging-Bq_JPdOd.js")]).then(([sdkModule, loggingModule]) => ({
