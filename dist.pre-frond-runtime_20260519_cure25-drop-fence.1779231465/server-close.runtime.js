...
import { t as abortChatRunById } from "./chat-abort-C73b_p1-.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-DPkW5qrd.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-BCiPyYbC.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-DdaaT0QH.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-BjAWwaIx.js");
