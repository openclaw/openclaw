...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-BPkq9qTL.js";
import { n as require_extend, t as require_package$1 } from "./package-Bv1qR2kC.js";
import { t as require_json_bigint } from "./json-bigint-TJXDZLLl.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-CJCpfZYM.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-QSoZrJeQ.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
