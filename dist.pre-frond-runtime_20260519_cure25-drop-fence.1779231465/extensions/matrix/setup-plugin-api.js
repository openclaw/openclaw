...
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "../../config-schema-BSJygHxj.js";
...
const matrixSetupPlugin = {
	...
	setupWizard: createMatrixSetupWizardProxy(async () => ({ matrixSetupWizard: (await import("../../setup-surface-1yViOVrA.js")).matrixSetupWizard })),
