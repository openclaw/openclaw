...
import { p as resolveExistingPathsWithinRoot } from "./fs-safe-D4r8mUJk.js";
import { i as getRuntimeConfig } from "./io-CINDrze3.js";
import { Ni as ErrorCodes, Pi as errorShape } from "./protocol-Crpoog51.js";
import { _ as readStringParam, c as imageResultFromFile, l as jsonResult } from "./common-DZFnGYgt.js";
import { t as callGatewayTool } from "./gateway-BI7tL8JQ.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-ZD8ULPJ1.js";
import { i as wrapExternalContent } from "./external-content-Ci5vbIwq.js";
import "./string-coerce-runtime-vNMR229H.js";
import { n as startLazyPluginServiceModule } from "./plugin-runtime-CEfoa3GD.js";
...
import { t as BrowserToolSchema } from "./browser-tool.schema-DQDLJY9P.js";
import { n as withTimeout } from "./sdk-security-runtime-sUFyBVP0.js";
import { R as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-DYPEmSUP.js";
import { i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-DgwQGm1M.js";
import "./sdk-setup-tools-CjhTfDK5.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-BHnq8M3M.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-B84DPYoU.js";
import { r as getBrowserProfileCapabilities } from "./target-id-D69p-6n3.js";
import { r as createBrowserRouteDispatcher, t as startBrowserControlServiceFromConfig } from "./control-service-Se1rcO-X.js";
import { n as createBrowserControlContext } from "./plugin-enabled-BSqsKeFG.js";
import "./core-api-CvpqStFJ.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BwUoXeNa.js"),
