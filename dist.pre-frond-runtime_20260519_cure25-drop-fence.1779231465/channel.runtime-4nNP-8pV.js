...
import "./accounts-DGPvJSpT.js";
import "./runtime-api-PoLA6TpM.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CC4KqB5N.js";
import { t as sendMessageZalo } from "./send-P87kzuk0.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Bi7xkUHO.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BDJP3TD-.js");
