...
import { d as normalizeSecretInputString, h as resolveSecretInputString, u as normalizeResolvedSecretInputString } from "./types.secrets-11Owfj8f.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-9_btbLFO.js";
import { At as boolean, Et as array, Nn as record, Rn as string, Tn as object, wn as number, yt as _enum } from "./schemas-Bmna8ihM.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-Da5XKQDh.js";
...
import { c as resolveMergedAccountConfig, i as hasConfiguredAccountValue, t as createAccountListHelpers } from "./account-helpers-C4UmUnEQ.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-BqKK0e13.js";
...
import "./account-resolution-DDt1ZIPJ.js";
import "./channel-plugin-common-DxtLXldp.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-DFnAP_vm.js";
...
const ClickClackAccountConfigSchema = object({
	...
	replyMode: _enum(["agent", "model"]).optional(),
	model: string().optional(),
	systemPrompt: string().optional(),
	timeoutSeconds: number().int().min(1).max(3600).optional(),
	toolsAllow: array(string()).optional(),
	senderIsOwner: boolean().optional(),
	defaultTo: string().optional(),
	allowFrom: array(string()).optional(),
	reconnectMs: number().int().min(100).max(6e4).optional()
}).strict();
const clickClackConfigSchema = buildChannelConfigSchema(ClickClackAccountConfigSchema.extend({
	accounts: record(string(), ClickClackAccountConfigSchema.partial()).optional(),
