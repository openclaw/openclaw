...
import { c as readLegacyNpmPluginDeclaration } from "./discovery-DMZS_8FV.js";
import { p as resolveUserPath } from "./utils-CpmNtyoq.js";
import { n as VERSION } from "./version-DmRkhYua.js";
import { a as resolveDefaultPluginNpmDir, o as resolvePluginInstallDir, r as resolveDefaultPluginExtensionsDir } from "./install-paths-CNzVvl2_.js";
import { f as loadInstalledPluginIndex } from "./installed-plugin-index-store-Bg5VORd_.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-BY79ETl0.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-C0z3kReV.js";
import { i as isOpenClawOrgNpmSpec, s as parseRegistryNpmSpec } from "./npm-registry-spec-BT2PTNSZ.js";
import { a as listOfficialExternalPluginCatalogEntries, c as resolveOfficialExternalPluginInstall, l as resolveOfficialExternalPluginLabel, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-Cd_w9tEa.js";
import { t as buildNpmResolutionInstallFields } from "./installs-CBsqvnOe.js";
import { s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-vYt6YyMA.js";
import { n as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog-67AxdKr9.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-CJOtFbBC.js";
import { i as listPotentialConfiguredChannelIds, r as listExplicitlyDisabledChannelIdsForConfig } from "./config-presence-CJ4lJLwD.js";
import { h as resolveConfiguredChannelPresencePolicy } from "./channel-plugin-ids-DCpcDXt0.js";
import { a as installPluginFromNpmSpec } from "./install-DeAaAC8T.js";
import { r as installPluginFromClawHub, t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-Drtj1ia1.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-Cvw9gFbD.js";
import { l as resolveRegistryUpdateChannel, s as normalizeUpdateChannel } from "./update-channels-DqECjLKF.js";
import { t as buildClawHubPluginInstallRecordFields } from "./clawhub-install-records-C75pmGdw.js";
import { n as resolveNpmInstallSpecsForUpdateChannel, t as resolveClawHubInstallSpecsForUpdateChannel } from "./install-channel-specs-hwYBozDN.js";
import { i as updateNpmInstalledPlugins } from "./update-BOZRJhuk.js";
import { n as collectConfiguredRuntimePluginIds, t as CONFIGURED_RUNTIME_PLUGIN_INSTALL_CANDIDATES } from "./configured-runtime-plugin-installs-C86Cukjq.js";
import { t as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-DkaLXBnE.js";
import { i as isLegacyPackageUpdateDoctorPass, s as shouldDeferConfiguredPluginInstallRepair } from "./update-phase-CsBm7XDl.js";
...
function resolveSafeBrokenOfficialInstallRemovalPath(params) {
	...
	return pathsEqual(resolvedInstallPath, resolveNpmPackageInstallPath({
...
async function installCandidate(params) {
	...
	if (clawhubInstallSpec && !(params.preferNpm && npmInstallSpec) && candidate.defaultChoice !== "npm") {
