...
import { t as createDirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-Cwx3MyIg.js";
...
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-DoZgqBaY.js";
...
import { t as attachChannelToResult } from "./channel-send-result-BXAZIi5i.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-CqCNt7Eb.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-BEWwcP71.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-DD3KKwKy.js");
