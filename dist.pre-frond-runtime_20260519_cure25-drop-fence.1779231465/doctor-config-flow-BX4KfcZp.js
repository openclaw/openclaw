...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CINDrze3.js";
...
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-8S-kNben.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-D_G4ZVwH.js";
import { t as note } from "./note-Cibib1p3.js";
import { t as asObjectRecord } from "./object-BHhR_Gtm.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CHSSQciw.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-CsQrGNS-.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BxFa80hw.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BTasXq3A.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-C-Rxzh4X.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-Dv6Kiyp-.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-CD_k6bIB.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DXzCyDuu.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-Bp8eqr_1.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BTF-tZDI.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-C9EEiyRp.js");
		emitDoctorNotes({
			note,
