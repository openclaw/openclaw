...
import { n as wrapPromptDataBlock } from "./sanitize-for-prompt-ChpufXpk.js";
import "./server-plugins-DI5faXhR.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReply } from "./run-wait-DKjqnni6.js";
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-BSzA87Uw.js");
