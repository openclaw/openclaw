...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-BY79ETl0.js";
import { i as getRuntimeConfig } from "./io-CINDrze3.js";
import "./installed-plugin-index-records-vYt6YyMA.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-Dg8HhGX3.js";
import "./config-BpFERVfB.js";
import { n as isRestartEnabled } from "./commands.flags-9Sm7Btxq.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-B1ap-pht.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-DvMN6T_J.js";
import { l as getTotalQueueSize } from "./command-queue-C-_VpIyT.js";
import { r as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-BlDINCWL.js";
import "./pi-bundle-mcp-tools-BoF1hVc0.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-DOjm4dlk.js";
import { r as resetDirectoryCache } from "./target-resolver-CFE5IK3a.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-DmPMVQyw.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-DwHCJTOE.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-BMBGjKHH.js";
import { _ as resolveHooksConfig } from "./hooks-BsQnTvjS.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-nn8xuBWD.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CxOcGK3p.js";
import { t as diffConfigPaths } from "./config-diff-b6ZsYzA1.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-YS8V1kQw.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-B_pscNCb.js";
import { t as buildGatewayCronService } from "./server-cron-DYI56J69.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DVfcXxn_.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-CWD1DBGw.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-CsZqfE8e.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-CaFfb2JD.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BjAWwaIx.js"), import("./gmail-watcher-lifecycle-DnwooXtm.js")]);
