...
import { i as formatErrorMessage, o as hasErrnoCode } from "./errors-ixwfrboQ.js";
import { b as escapeRegExp } from "./utils-CpmNtyoq.js";
import "./agent-scope-rw2bYM9R.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey } from "./session-key-utils-CJRKuBJA.js";
import { c as normalizeAgentId, g as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-CQewiu8n.js";
import { c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-DdvF1onI.js";
...
import { r as loadOrCreateDeviceIdentity } from "./device-identity-YAlHXP_O.js";
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-BQTqLgE3.js";
import { t as getActivePluginChannelRegistry } from "./runtime-DMwZgnl2.js";
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-X0KvSFJP.js";
...
import { t as getChannelPlugin } from "./registry-BstTfco-.js";
import { s as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-DejgqaRd.js";
import "./plugins-3tO_yYSp.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-fWnBOAl-.js";
import "./model-selection-Bv3hO0Wd.js";
import { f as replyRunRegistry } from "./reply-run-registry-BI7XiLhN.js";
import { i as resolveUserTimezone } from "./date-time-OFfXKzFY.js";
import { n as listDueCommitmentSessionKeys, o as markCommitmentsAttempted, r as listDueCommitmentsForSession, s as markCommitmentsStatus } from "./store-BuZcEBpM.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-dY63daNF.js";
import { a as isHeartbeatContentEffectivelyEmpty, c as resolveHeartbeatPrompt$1, l as resolveHeartbeatPromptForResponseTool, o as isTaskDue, s as parseHeartbeatTasks, u as stripHeartbeatToken } from "./heartbeat-Dwk0vIKl.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-eTT8iz6h.js";
import { a as isRetryableHeartbeatBusySkipReason, c as setHeartbeatWakeHandler, i as areHeartbeatsEnabled, n as HEARTBEAT_SKIP_LANES_BUSY, o as requestHeartbeat, r as HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT, t as HEARTBEAT_SKIP_CRON_IN_PROGRESS } from "./heartbeat-wake-CLbjIH9m.js";
import { c as peekSystemEventEntries, f as resolveSystemEventDeliveryContext, t as consumeSelectedSystemEventEntries } from "./system-events-CvlpBn9J.js";
import { c as getQueueSize, s as getCommandLaneSnapshots } from "./command-queue-C-_VpIyT.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BxAqgm8A.js";
import { r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-B9GxFxq7.js";
import { a as getHeartbeatToolNotificationText, s as resolveHeartbeatToolResponseFromReplyResult } from "./heartbeat-tool-response-C4a79nTi.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-Bmxu23e2.js";
...
import { n as resolveHeartbeatSenderContext, t as resolveHeartbeatDeliveryTarget } from "./targets-BmtmASdP.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-KMiitmWe.js";
import { r as replaceGenericExternalRunFailureText } from "./agent-runner-failure-copy-CocwTNxL.js";
import { a as isRelayableExecCompletionEvent, i as isExecCompletionEvent, n as buildExecEventPrompt, r as isCronSystemEvent, t as buildCronEventPrompt } from "./heartbeat-events-filter-CZYNOyf6.js";
import { n as hasActiveCronJobs } from "./active-jobs-C_xL9_bm.js";
...
import { a as resolveIndicatorType, t as emitHeartbeatEvent } from "./heartbeat-events-ByxE5pm3.js";
import { t as resolveHeartbeatVisibility } from "./heartbeat-visibility-BLmvPA-r.js";
import { t as resolveCronSession } from "./session-CGAow0p9.js";
...
function resolveHeartbeatReasoningPayloads(replyResult) {
	...
	for (const payload of payloads) {
		...
		if (payload.isReasoning !== true && !hasLegacyReasoningPrefix) continue;
...
async function restoreHeartbeatUpdatedAt(params) {
	...
	await updateSessionStore(storePath, (nextStore) => {
		...
		for (const legacyKey of resolved.legacyKeys) delete nextStore[legacyKey];
	});
}
...
function inferHeartbeatWakeSourceFromReason(reason) {
	...
	if (isContinuationHeartbeatWakeReason(trimmed)) return "hook";
	if (trimmed.startsWith("acp:spawn:")) return "acp-spawn";
}
function isContinuationHeartbeatWakeReason(reason) {
	return reason === "continuation" || reason === "silent-wake-enrichment" || reason === "delegate-return";
}
function resolveHeartbeatWakePayloadFlags(params) {
	...
	return {
		...
		isWakePayload: source === "hook" || source === "acp-spawn" || reason === "wake" || isContinuationHeartbeatWakeReason(reason)
	};
}
...
async function runHeartbeatOnce(opts) {
	...
	if ((opts.deps?.isReplyRunActive ?? ((key) => replyRunRegistry.isActive(key)))(sessionKey)) {
		emitHeartbeatEvent({
			status: "skipped",
			reason: HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT,
			durationMs: Date.now() - startedAt
	...
	const hasInspectedOwnerDowngradeEvents = preflight.shouldInspectPendingEvents && preflight.pendingEventEntries.some((event) => event.forceSenderIsOwnerFalse === true);
	const hasActiveSessionOwnerDowngradeEvents = activeSessionPendingEventEntries.some((event) => event.forceSenderIsOwnerFalse === true);
	const hasOwnerDowngradeSystemEvents = hasInspectedOwnerDowngradeEvents || hasActiveSessionOwnerDowngradeEvents;
	...
	try {
		...
		const continuationTrigger = opts.reason === "continuation" ? "work-wake" : opts.reason === "silent-wake-enrichment" || opts.reason === "delegate-return" ? "delegate-return" : void 0;
		const replyOpts = {
			isHeartbeat: true,
