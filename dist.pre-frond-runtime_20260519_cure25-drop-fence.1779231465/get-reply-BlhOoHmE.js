...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-rw2bYM9R.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-CJRKuBJA.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-CQewiu8n.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-DaaBuyRT.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-DdvF1onI.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DgUPESoD.js";
import { s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-D41tLhoP.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-BczttO8i.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-Bzr_rdQG.js";
...
import { r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-DJtqYoTD.js";
import { o as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-Cwr6skDj.js";
...
import { s as resetRegisteredAgentHarnessSessions } from "./registry-Ds-bZfDD.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-Cd2Qar9Y.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-aiE2jKMJ.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-X0KvSFJP.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-CPgWum5w.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-_BPRx1WO.js";
import { A as resolveSessionStoreEntry, C as parseSessionThreadInfoFast, t as loadSessionStore, y as resolveMaintenanceConfigFromInput } from "./store-load-D4UxZlJL.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-4Y_NE_1a.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-BstTfco-.js";
import { m as deriveSessionMetaPatch, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-DejgqaRd.js";
import { t as normalizeChatType } from "./chat-type-LDAK29u-.js";
import "./plugins-3tO_yYSp.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-_KZG4WBE.js";
import { c as resolveSessionLifecycleTimestamps } from "./sessions-CEmQfc29.js";
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-BkGlAnTo.js";
import { n as resolveSessionKey } from "./session-key-OS15YMMb.js";
import { l as resolveAndPersistSessionFile } from "./transcript-DVe7upns.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-fWnBOAl-.js";
import { n as modelKey } from "./model-selection-normalize-B3eh25eT.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-Bv3hO0Wd.js";
import { o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-BR86G80s.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-BJnOJIWy.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-dY63daNF.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-Dwk0vIKl.js";
import { a as generateSecureToken } from "./secure-random-CKyp7Fy_.js";
import { a as enqueueSystemEvent, u as removeSystemEvents } from "./system-events-CvlpBn9J.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-C-_VpIyT.js";
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-Deb-ydYB.js";
import { r as getCliSessionBinding } from "./cli-session-CcBPBKs7.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-Cu6VD2v9.js";
import { St as isReasoningTagProvider } from "./selection-DQzfB1Vz.js";
import { p as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-CSPlWsPH.js";
import { l as ensureAgentWorkspace } from "./workspace-B9GxFxq7.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-DPkLfxN2.js";
import { y as collectTextContentBlocks } from "./attempt.tool-run-context-DYpPqZOp.js";
import { s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-BlDINCWL.js";
import "./pi-bundle-mcp-tools-BoF1hVc0.js";
import "./delivery-context-lU12z7kJ.js";
import { s as getMediaDir } from "./store-C6juM-Dc.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, s as resolveCommandTurnContext } from "./command-turn-context-AXxxc611.js";
import { t as resolveQueueSettings } from "./queue-ChFRxxYF.js";
import { t as buildOutboundSessionContext } from "./session-context-iNI6dgM2.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-uZfkKbCS.js";
import { n as getSessionBindingService } from "./session-binding-service-t_H1eP6M.js";
import { t as resolveAgentTimeoutMs } from "./timeout-nqZIJh2Q.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-D5qKr8rq.js";
import { l as resolveSilentReplySettings, s as resolveCurrentTurnImages } from "./agent-runner-execution-6ECzp6cB.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BqdQkcCx.js";
import { s as hasInboundMedia } from "./block-reply-pipeline-DCqABZ01.js";
import { a as noteActiveSessionForShutdown, n as buildSessionStartHookPayload, r as forgetActiveSessionForShutdown, t as buildSessionEndHookPayload } from "./session-hooks-CwrultmI.js";
import { r as drainFormattedSystemEventBlock } from "./session-updates-fYJXpIZ7.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-MsNA5rQA.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-CAbjyH0E.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-_GLN_K8b.js";
import { t as resolveChannelModelOverride } from "./model-overrides-CChey-ZM.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CyMVbBwf.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-DqQwkh1f.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CmO1xDto.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-CPFpiTtc.js";
import "./commands-registry-ZdjNhfQ5.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-kBDoXbUX.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DTYshxyE.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-B2gU4Tii.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-CgQqQUE1.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-CDh-FRPE.js";
import { t as finalizeInboundContext } from "./inbound-context-1BxuQtGw.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-IFPBl3Ah.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-ClmY4KqN.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-EoVuAgHj.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-CoyTg5r4.js";
import { t as hasControlCommand } from "./command-detection-Cjflz19I.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-BD3bCBIY.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-BTVekZ0B.js";
import { t as normalizeGroupActivation } from "./group-activation-CIBeVXLn.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-DDJk1Jjs.js";
import { t as resolveFastModeState } from "./fast-mode-BpLh067f.js";
import { t as buildCommandContext } from "./commands-context-B3GUxUZL.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-DwwZ4ZTy.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BLimxeNm.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-Dz71vhPr.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-B8htoTdD.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-qt62fkyc.js";
import { t as extractExplicitGroupId } from "./group-id-CCrXyW6c.js";
import { t as formatElevatedUnavailableMessage } from "./elevated-unavailable-caDyH2oN.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CCdW8fPS.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-BUvpY3Wl.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-Bo4PW7Zh.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-CYf-ST3T.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-Wbh2OMs1.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-8SAOUs4a.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-Bu8QxmU3.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-C6mgQBjK.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-Df-23fob.js"));
...
async function applySessionHints(params) {
	...
	if (abortedHint) {
		...
		if (params.sessionEntry && params.sessionStore && params.sessionKey) {
			...
			const runtime = await loadSessionStoreRuntime$1();
			...
			if (params.storePath) await runtime.updateSessionStore(params.storePath, (store) => {
				const resolved = runtime.resolveSessionStoreEntry({
					store,
					sessionKey
				});
...
const agentRunnerRuntimeLoader = createLazyImportLoader(() => import("./auto-reply/reply/agent-runner.runtime.js"));
...
async function runPreparedReply(params) {
	...
	const isContinuationWake = continuationTrigger === "work-wake" || continuationTrigger === "delegate-return";
	...
	const rebuildPromptBodies = async () => {
		if (!useFastReplyRuntime) {
			...
			if (eventsBlock) {
				...
				if (eventsBlock.forceSenderIsOwnerFalse) forceSenderIsOwnerFalseFromSystemEvents = true;
			}
		}
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-CMaO5YIF.js");
...
async function initSessionState(params) {
	...
	}
	{
		...
		sessionStore[resolved.normalizedKey] = {
			...resolved.existing,
			...sessionEntry
		};
		for (const legacyKey of resolved.legacyKeys) delete sessionStore[legacyKey];
	}
	await updateSessionStore(storePath, (store) => {
		const resolved = resolveSessionStoreEntry({
			store,
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-b-UFPsqX.js"));
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-jlwkO5nA.js");
