...
import { n as openUrl } from "./browser-open-loNyR6E9.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BL0ufn0m.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-DkaLXBnE.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers--np1KjUB.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-SJw9_kCb.js";
import { t as isRemoteEnvironment } from "./remote-env-D0V8U5Tt.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-DpZMguUa.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-ovGXTfri.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-CIg-T3Ad.js");
