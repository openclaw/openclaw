...
import { s as resolveMirroredTranscriptText } from "./transcript-DVe7upns.js";
import { C as createReplyToDeliveryPolicy } from "./reply-payload-BxAqgm8A.js";
import { a as hasReplyPayloadContent, f as renderMessagePresentationFallbackText, l as normalizeMessagePresentation } from "./payload-CB-WF17a.js";
import { t as diagnosticErrorCategory } from "./diagnostic-error-metadata-DbZAMoVQ.js";
import { l as summarizeOutboundPayloadForTransport, t as createOutboundPayloadPlan } from "./payloads-DSo0PM8D.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, n as chunkByParagraph, s as resolveChunkMode } from "./chunk-DUB04dEk.js";
import { n as adaptMessagePresentationForChannel } from "./interactive-BrzUSy4i.js";
import { t as loadChannelOutboundAdapter } from "./load-DXsKlG2F.js";
import { a as toInternalMessageSentContext, d as toPluginMessageSentEvent, l as toPluginMessageContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-uZfkKbCS.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-DBTBEb1v.js";
import { n as resolveOutboundChannelMessageAdapter } from "./channel-resolution-BIMdFqzU.js";
import { _ as runOutboundDeliveryCommitHooks, c as enqueueDelivery, g as attachOutboundDeliveryCommitHook, m as markDeliveryPlatformSendAttemptStarted, o as withActiveDeliveryClaim, p as markDeliveryPlatformOutcomeUnknown, s as ackDelivery, u as failDelivery } from "./delivery-queue-0WkqK4cs.js";
import { n as stripInternalRuntimeScaffolding } from "./sanitize-text-fvESWw3p.js";
...
async function loadChannelBootstrapRuntime() {
	channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-TtRzK96-.js");
