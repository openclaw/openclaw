...
import { F as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-CnYTUlm2.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-CCXLOJap.js";
import { c as initSubagentRegistry } from "./subagent-registry-BZiTnX8h.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-BvcMJRKu.js";
import { n as listGatewayMethods } from "./server-methods-list-DnV9U7bq.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-BcaXYbeq.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-DxtpYR3v.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-CWykD53D.js");
