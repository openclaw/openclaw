...
import { n as privateFileStoreSync, t as privateFileStore } from "./private-file-store-Dbf8cmWU.js";
...
import { S as recordTalkObservabilityEvent, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, d as buildRealtimeVoiceAgentConsultPolicyInstructions, v as resolveRealtimeVoiceAgentConsultTools, y as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-DLIiQkbK.js";
import { f as resolveRealtimeVoiceFastContextConsult, m as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-BoYfFZEa.js";
...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-CCqlyfti.js";
import "./api-COlThhZB.js";
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-CGE3iXKL.js";
...
import { t as isProviderStatusTerminal } from "./call-status-Jw_yWRWb.js";
...
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-C-JZmeXR.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-Z6tirAA-.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-BUJwh98w.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-jn-yCIxS.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-D6sJu0MV.js");
...
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-DWkqDhlW.js");
