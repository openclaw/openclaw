...
import { a as getResolvedLoggerSettings } from "./logger-RkfmvLxA.js";
import { t as danger } from "./globals-xAdlid3k.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-B3cB3MOo.js";
import { i as replaceConfigFile } from "./mutate-Bs39Ukz8.js";
import "./config-Dh6CigU2.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-BfFDdqsq.js";
import { o as normalizeChannelId } from "./registry-idykBo5d.js";
...
import { r as callGateway } from "./call-hG2jRq58.js";
import { i as getBundledChannelSetupPlugin } from "./bundled-DcuBWglS.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BiaPnQ59.js";
import "./plugins-BIdBW9KG.js";
import "./logging-Bqb2mn_V.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-B53UzRRO.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-DWrA5jWG.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DdIwvnG4.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-CswdXPdi.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-CmxqOObA.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CgBeI_pc.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BC9z9VvG.js";
import { t as WizardCancelledError } from "./prompts-E0FayNjJ.js";
import { t as createClackPrompter } from "./clack-prompter-Cfz0jWjY.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-CrO6WkoH.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Bf22Kogb.js";
import { n as resolveLogFile } from "./log-tail-Ch2uy6sx.js";
import { t as parseLogLine } from "./parse-log-line-Bi6tTmwR.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-yR45lVsE.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-BnJglSoO.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-D9P-pYVC.js";
import { t as channelsListCommand } from "./list-DM_2PB1F.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-ZjjvAdm-.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-3CjcapfN.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-CIdLwZDa.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-DbErDPAM.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-DrnYXPVW.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-4qgGkfma.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-aRWlNEnk.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-YmJVBZ20.js");
