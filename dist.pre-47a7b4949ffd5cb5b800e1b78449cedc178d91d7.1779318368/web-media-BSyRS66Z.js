...
import { b as assertNoWindowsNetworkPath, w as safeFileURLToPath } from "./fs-safe-BIhMf0UI.js";
import { i as readLocalFileSafely } from "./secure-temp-dir-BA4Qt7HV.js";
import { p as resolveUserPath } from "./utils-DX02THHb.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-xAdlid3k.js";
import { a as getActivePluginRegistry } from "./runtime-CnYTUlm2.js";
import "./local-file-access-CBe_wA_B.js";
import { c as kindFromMime, g as maxBytesForKind, i as getFileExtension, l as mimeTypeFromFilePath, n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DppuT-pZ.js";
import { f as optimizeImageToPng, l as hasAlphaChannel, p as resizeToJpeg, s as convertHeicToJpeg, u as isImageProcessorUnavailableError } from "./media-services-CNV3toly.js";
import { n as extnameFromAnyPath, t as basenameFromAnyPath } from "./file-name-r4prf02z.js";
import { i as resolveInboundMediaReference, t as MediaReferenceError } from "./media-reference-LN21lSHB.js";
import { i as readRemoteMediaBuffer } from "./fetch-DYw0xfJk.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-D6MhlaSf.js";
...
async function loadWebMediaInternal(mediaUrl, options = {}) {
	...
	const optimizeAndClampImage = async (buffer, cap, meta) => {
		...
		try {
			...
			if (isImageProcessorUnavailableError(err) && !isHeicSource(meta ?? {}) && buffer.length <= cap) {
...
async function optimizeImageToJpeg(buffer, maxBytes, opts = {}) {
	...
	if (isImageProcessorUnavailableError(firstResizeError)) throw firstResizeError;
