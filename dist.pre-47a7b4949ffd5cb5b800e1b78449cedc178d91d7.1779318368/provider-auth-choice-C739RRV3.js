...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-D3hTIwCC.js";
...
import { n as openUrl } from "./browser-open-1aqrn9w9.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BlGE2O8R.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-5YRr-MZy.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-ha191Iu2.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-DNVUdhY_.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-DSmu0o6W.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-CSWSqXaR.js");
