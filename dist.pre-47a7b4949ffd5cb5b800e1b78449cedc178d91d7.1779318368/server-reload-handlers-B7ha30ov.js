...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CGtCoOLf.js";
...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-BT_ChJF9.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-BjnxngjY.js";
import { l as getTotalQueueSize } from "./command-queue-Dx7TD9jt.js";
import { r as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-DwEvzZMt.js";
import "./pi-bundle-mcp-tools-BzAsb8TL.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-Dr9I9xPC.js";
import { r as resetDirectoryCache } from "./target-resolver-DfctU7Q5.js";
...
import { _ as resolveHooksConfig } from "./hooks-B6p8hdVx.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-pfJY3heA.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-QXnF0A8Y.js";
import { t as diffConfigPaths } from "./config-diff-5nKK7p0e.js";
...
import { t as buildGatewayCronService } from "./server-cron-rXvS7lHp.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-OFnwEc3P.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DwPIMpVT.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-D1d-a5Fa.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-jBEy56-Q.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-DEyYhHoc.js"), import("./gmail-watcher-lifecycle-AK8goMJR.js")]);
