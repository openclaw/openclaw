...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-Buzc_LBv.js";
...
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DX1-_dyQ.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-IayyO3Fd.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-CXtaMT0v.js";
import { n as loadModelsConfigWithSource } from "./load-config-BdrIhkDf.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-Ds5PAzFQ.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-Bjs861c8.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-C9uM1hz7.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-CzUkTC5S.js"),
		import("./agent-scope-Ddu6MOrs.js"),
		import("./workspace-BPq_bhvf.js")
	]);
