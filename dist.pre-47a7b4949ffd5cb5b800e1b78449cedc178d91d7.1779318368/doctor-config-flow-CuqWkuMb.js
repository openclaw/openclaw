...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-D2HSDKMs.js";
...
import { n as discoverConfigSecretTargets } from "./target-registry-CfJyeLFa.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-B3cB3MOo.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { r as normalizeTalkSection } from "./talk-C0fmCqSW.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-DcuBWglS.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DNrzTRKL.js";
import { n as getLoadedChannelPlugin } from "./registry-BiaPnQ59.js";
import { i as listRouteBindings } from "./bindings-D1F1bOgs.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, o as listLegacyRuntimeModelProviderAliases, s as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-n90EjWho.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-oS4P_gL_.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-B5AOR8v9.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BGFNqqYf.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-Ch-i4cw1.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-Yg26gmCQ.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-Dx87m5gz.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-BHfTIvk2.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-7sBF7Fnb.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-oriYe0g0.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CQfzr3d6.js");
		emitDoctorNotes({
			note,
