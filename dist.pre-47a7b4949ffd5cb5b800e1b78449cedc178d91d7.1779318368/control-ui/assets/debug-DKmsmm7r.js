import{i as e,it as t,rt as n,tt as r}from"./index-Bis6XYAN.js";function i(i){let a=(i.status&&typeof i.status==`object`?i.status.securityAudit:null)?.summary??null,o=a?.critical??0,s=a?.warn??0,c=a?.info??0,l=o>0?`danger`:s>0?`warn`:`success`,u=o>0?r(`debug.security.critical`,{count:String(o)}):s>0?r(`debug.security.warnings`,{count:String(s)}):r(`debug.security.noCriticalIssues`);return t`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-DKmsmm7r.js.map