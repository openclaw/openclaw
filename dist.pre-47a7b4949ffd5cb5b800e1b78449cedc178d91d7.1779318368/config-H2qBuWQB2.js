...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-D2HSDKMs.js";
...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-Dhj2e_Fx.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-J2eHsfqp.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-BjHneoP2.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CQZtOc45.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-D_fZmxg1.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-cynyw2gZ.js"), import("./logging-B64MAOB_.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-D0EBGBru.js").then((credentialsReadModule) => ({
