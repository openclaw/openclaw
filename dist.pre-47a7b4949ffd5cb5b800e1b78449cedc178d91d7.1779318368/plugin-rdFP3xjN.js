...
import { h as MarkdownConfigSchema } from "./zod-schema.core-BrhV4JOv.js";
...
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-CkYd4QGd.js";
import { h as runStoppablePassiveMonitor, n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-COLYNjY4.js";
import "./channel-config-primitives-CB79qvcv.js";
import { r as defineChannelMessageAdapter } from "./channel-message-D2DSarag.js";
import { i as createPairingPrefixStripper, r as createLoggedPairingApprovalNotifier } from "./channel-pairing-CtkLWg1v.js";
import { a as normalizeTwitchChannel, i as normalizeToken, n as isAccountConfigured, o as resolveTwitchToken, r as missingTargetError, t as generateMessageId } from "./twitch-DebSUE-g.js";
import { a as getAccountConfig, c as resolveTwitchAccountContext, i as DEFAULT_ACCOUNT_ID, l as resolveTwitchSnapshotAccountId, o as listAccountIds, r as twitchSetupWizard, s as resolveDefaultTwitchAccountId, t as twitchSetupAdapter } from "./setup-surface-nStItzue.js";
import { A as accessTokenIsExpired, C as extractUserId, D as CustomError, E as rtfm, F as Enumerable, M as mapNullable, N as mapOptional, O as DataObject, P as arrayToObject, S as HttpStatusCodeError, T as HellFreezesOverError, _ as InvalidTokenError, a as removeClientManager, b as handleTwitchApiResponseError, c as Cacheable, d as CustomError$1, f as createLogger$1, g as TokenInfo, h as EventEmitter, j as promiseWithResolvers, k as rawDataSymbol, l as PartitionedTimeBasedRateLimiter, m as StaticAuthProvider, n as stripMarkdownForTwitch, o as ChatClient, p as require_detect_node, r as getClientManager, s as CachedGetter, t as chunkTextForTwitch, u as RateLimitReachedError, v as callTwitchApi, w as extractUserName, x as transformTwitchApiResponse, y as callTwitchApiRaw } from "./markdown-Br6Lp7v4.js";
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				await runStoppablePassiveMonitor({
					...
					start: async () => {
						const { monitorTwitchProvider } = await import("./monitor-BvwCDIox.js");
