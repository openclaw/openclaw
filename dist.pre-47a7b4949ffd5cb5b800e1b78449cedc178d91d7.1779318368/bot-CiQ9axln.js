...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-D4wGeA6B.js";
import { n as appendRegularFileSync } from "./regular-file-BEF3PHba.js";
import { n as normalizeAccountId } from "./account-id-B32J-iNN.js";
import { f as resolveThreadSessionKeys, p as sanitizeAgentId, r as buildAgentMainSessionKey } from "./session-key-BAP1m9Ju.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-C5zL9i5G.js";
import { i as replaceFileAtomicSync } from "./replace-file-Dr-OmBmA.js";
import { t as createNonExitingRuntime } from "./runtime-yzlkhCoS.js";
import { r as getChildLogger } from "./logger-RkfmvLxA.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-xAdlid3k.js";
...
import { n as mutateConfigFile } from "./mutate-Bs39Ukz8.js";
import { u as fireAndForgetHook } from "./hook-runner-global-DNOIUQa8.js";
import { t as createDedupeCache } from "./dedupe-BD30U36x.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-B5zlPNZy.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-DE6QEn2i.js";
import { A as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-QI_1eBWp.js";
import { s as updateSessionStore } from "./store-r4WEtwxi.js";
import { l as appendSessionTranscriptMessage, r as readLatestAssistantTextFromSessionTranscript, u as resolveAndPersistSessionFile } from "./transcript-DONnOcmt.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-KwD0KwGN.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-C9NomKZ1.js";
...
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-D6kSS72f.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-xWP8RUXv.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-2_jEu7JQ.js";
...
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-Ck6n8xcq.js";
...
import { t as hasControlCommand } from "./command-detection-B_KnI24C.js";
...
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-BbaOAkqk.js";
import "./reply-history-0zgiNnUd.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-AIr7sQeA.js";
import "./approval-reply-runtime-Gbh-GwFZ.js";
...
import "./config-mutation-Ds613cvh.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-iEhnLEmX.js";
import "./reply-chunking-DtdMMS54.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-Ce4SAn4V.js";
import "./outbound-runtime-E4g4eO1I.js";
import "./runtime-config-snapshot-3cd1PYAP.js";
import "./model-session-runtime-0teR5Rb8.js";
import "./media-runtime-BRqBxHRo.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-DMCQPm5j.js";
import "./conversation-runtime-DP3lUeRe.js";
import "./text-chunking-DAvRGrET.js";
import "./agent-runtime-BGHDCLMX.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-By8z431K.js";
import "./security-runtime-CFCiiDJI.js";
import "./agent-harness-runtime-BrEGpRil.js";
import "./hook-runtime-Bw1KhVui.js";
import "./markdown-table-runtime-B6pPL75o.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-DD0TrR22.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-B13EseW-.js";
import "./command-auth-native-PG9GgxLf.js";
import "./command-primitives-runtime-Dj4odKB-.js";
import "./command-status-4UVfxHiv.js";
import "./command-detection-DGZXExGC.js";
import "./command-surface-BYQ79WSH.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Dr3f0mtP.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-CvMYHjjc.js";
import { i as resolveUnmentionedGroupInboundPolicy, r as classifyChannelInboundEvent, s as shouldDebounceTextInbound } from "./channel-inbound-DogZfXBW.js";
import { n as toLocationContext, t as formatLocationText } from "./location-B0jdizlz.js";
import "./channel-ingress-runtime-DJ2VWqRD.js";
import { h as createMessageReceiveContext } from "./channel-message-D2DSarag.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-CtkLWg1v.js";
import "./session-store-runtime-KFVtSaTY.js";
import "./models-provider-runtime-BvvAWdav.js";
import "./skill-commands-runtime-CCyXS7fL.js";
import "./native-command-config-runtime-MwOMJ4ER.js";
import { t as mergeTelegramAccountConfig } from "./account-config-D6zJeNKl.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-DatLJJHS.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-B2sciwME.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-ChUQ0bdK.js";
import { A as shouldUseTelegramDmThreadSession, C as resolveTelegramForumFlag, D as resolveTelegramReplyId, E as resolveTelegramMessageForumFlagHint, F as extractTelegramLocation, G as normalizeAllowFrom, H as expandTelegramAllowFromWithAccessGroups, I as getTelegramTextParts, K as normalizeDmAllowFromWithStore, L as hasBotMention, M as buildSenderLabel, N as buildSenderName, O as resolveTelegramStreamMode, P as expandTextLinks, S as resolveTelegramDirectPeerId, T as resolveTelegramGroupAllowFromContext, U as resolveTelegramDmAllow, V as resolveTelegramPrimaryMedia, W as isSenderAllowed, _ as describeReplyTarget, a as renderTelegramHtmlText, d as buildTelegramGroupPeerId, f as buildTelegramInboundOriginTarget, g as buildTypingThreadParams, h as buildTelegramThreadParams, j as withResolvedTelegramForumFlag, k as resolveTelegramThreadSpec, l as buildGroupLabel, m as buildTelegramRoutingTarget, n as markdownToTelegramChunks, p as buildTelegramParentPeer, q as resolveTelegramEffectiveDmPolicy, u as buildTelegramGroupFrom, v as extractTelegramForumFlag, w as resolveTelegramForumThreadId, x as resolveTelegramCommandAuthorization, y as isTelegramCommandsAllowFromConfigured, z as normalizeForwardedContext } from "./format-DSi0RmsF.js";
import { t as resolveTelegramInlineButtons } from "./button-types-BM7oa4zL.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-B0zJSkZz.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DIp--jsG.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-CHk0rJf5.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-B8RUJeZA.js";
import { A as Bot, C as createTelegramClientFetch, E as resolveTelegramOutboundClientTimeoutFloorSeconds, M as sequentialize, O as withTelegramApiErrorLogging, S as asTelegramClientFetch, T as resolveTelegramClientTimeoutSeconds, a as editMessageTelegram, g as recordSentMessage, j as apiThrottler, k as getOrCreateAccountThrottler, w as resolveTelegramClientTimeoutMinimumSeconds, x as buildInlineKeyboard } from "./send-BQ1uDKbt.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CU-tJK1Q.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as createNativeTelegramToolProgressDraft, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands, t as defaultTelegramBotDeps } from "./bot-deps-OQTXsrYW.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DEcfvdLN.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-DBKzY8s8.js");
...
const registerTelegramHandlers = ({ cfg, accountId, bot, opts, telegramTransport, runtime, mediaMaxBytes, telegramCfg, allowFrom, groupAllowFrom, resolveGroupPolicy, resolveTelegramGroupConfig, shouldSkipUpdate, processMessage, logger, telegramDeps, resolveGroupActivation, resolveGroupRequireMention }) => {
	...
	const processInboundMessage = async (params) => {
		const { ctx, msg, chatId, isGroup, isForum, resolvedThreadId, dmThreadId, storeAllowFrom, senderId, dmPolicy, effectiveGroupAllow, effectiveDmAllow, groupConfig, topicConfig, sendOversizeWarning, oversizeLogMessage, promptContextMinTimestampMs } = params;
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-c6VSC0Ik.js")).defaultTelegramBotDeps;
