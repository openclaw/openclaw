...
import { d as isRootHelpInvocation, f as isRootVersionInvocation, r as getCommandPositionalsWithRootOptions } from "./argv-CIAIZU-s.js";
import { t as isMainModule } from "./is-main-EQb8Rm7k.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-SnpxURm4.js";
import { a as resolveCliContainerTarget, i as parseCliContainerArgs, n as parseCliProfileArgs, t as applyCliProfileEnv } from "./profile-COsrWfpD.js";
...
async function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	try {
		...
		if (!liveRootHelpOptions) {
			if ((deps.outputPrecomputedRootHelpText ?? (await import("./root-help-metadata-BZY_1PCD.js")).outputPrecomputedRootHelpText)()) return true;
		}
		await (deps.outputRootHelp ?? (await import("./root-help-BRWqxOBi.js")).outputRootHelp)(liveRootHelpOptions ?? void 0);
		return true;
	} catch (error) {
		handleError(error);
		return true;
...
async function runMainOrRootHelp(argv) {
	...
	try {
		...
		const { formatCliFailureLines } = await import("./failure-output-DNQShfTA.js");
