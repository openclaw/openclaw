...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-D_fZmxg1.js";
import "./config-H2qBuWQB2.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-cynyw2gZ.js"), import("./logging-B64MAOB_.js")]).then(([sdkModule, loggingModule]) => ({
