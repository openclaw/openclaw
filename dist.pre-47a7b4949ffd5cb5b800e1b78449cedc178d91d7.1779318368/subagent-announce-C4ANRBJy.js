...
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-CGufEBPx.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-CALcaA7l.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-CKYB33Th.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-8qFZF4Bs.js";
import { i as consumePendingDelegates } from "./delegate-store-tMQxmuX2.js";
import "./continuation-delegate-store-BnNAA7L2.js";
import { n as resolveContinuationRuntimeConfig } from "./config-DtpxJuH0.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DB5PVhvQ.js";
import "./delivery-context-FOBNKhAY.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DWUR-WD-.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-BxopFH93.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-TIf_-pex.js";
import { n as buildAnnounceIdFromChildRun, r as buildAnnounceIdempotencyKey, t as resolveAnnounceOrigin } from "./subagent-announce-origin-CgtK1ye7.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-C52pDQJj.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-dQXHyqom.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-DJANonQf.js"), import("./store-load-BY7eE_Ix.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { hasCrossSessionDelegateTargeting } = await import("./targeting-pure-DaUheHh9.js");
	if (!hasCrossSessionDelegateTargeting(params.targeting, params.dispatchingSessionKey)) return false;
	const { enqueueSystemEvent } = await import("./system-events-13lMxIUO.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-BkpGfr3-.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-13lMxIUO.js");
			const { createSubsystemLogger } = await import("./subsystem-DqGbgG47.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-BoMW6JQN.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
