...
Vocal plan: safe-original-rap-test

## Direction

original urgent baritone West Coast rap vocal with crisp diction and no artist imitation
...
```bash
node music-creator-v1/scripts/music-creator-v1.mjs vocal-ingest --project 2026-05-14-validation-happy-path --plan safe-original-rap-test --file <vocal-audio>
