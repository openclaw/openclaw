...
STATUS_FILE="${STATUS_DIR}/macbook-node-window-status.json"
BLOCKERS_FILE="${STATUS_DIR}/macbook-node-window-blockers.txt"
LOG_FILE="${LOG_DIR}/macbook-pair-openclaw-node-window.log"
  ...
  cat > "${STATUS_FILE}" <<JSON
{
  ...
  "blockersFile": "from-macbook/macbook-node-window-blockers.txt",
  "setupLog": "logs/macbook-pair-openclaw-node-window.log"
}
JSON
  open "${BLOCKERS_FILE}"
  exit 1
