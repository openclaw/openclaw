...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-DpAHEyeh.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-BseZ_-CH.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-C34FHqGm.js")).runEmbeddedPiAgent;
}
