...
import { f as resolveThreadSessionKeys, p as sanitizeAgentId, r as buildAgentMainSessionKey } from "./session-key-CQewiu8n.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-BdqZvTnb.js";
import { i as replaceFileAtomicSync } from "./replace-file-DfT5iHv1.js";
import { t as createNonExitingRuntime } from "./runtime-DDH_zqCr.js";
import { i as getChildLogger } from "./logger-D4Ax5Dlv.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-CrpmxZTV.js";
import { t as createSubsystemLogger } from "./subsystem-Dtm6MSVy.js";
import { i as getRuntimeConfig } from "./io-s7xwYk1t.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-XI6kh6r8.js";
import { n as mutateConfigFile } from "./mutate-BAfEGIzq.js";
import { u as fireAndForgetHook } from "./hook-runner-global-CMmE9bEr.js";
import { t as createDedupeCache } from "./dedupe-CS-434lS.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CjfUlKb5.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-789ECJN2.js";
...
import { c as appendSessionTranscriptMessage, l as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript } from "./transcript-Co5UP2SS.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-DZrSRKB-.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BAPxmvid.js";
import { h as isInsideCode, m as findCodeRegions, u as stripReasoningTagsFromText } from "./assistant-visible-text-BwXXap9v.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-CAIYwyOS.js";
import { i as buildTtsSupplementMediaPayload, s as getReplyPayloadTtsSupplement } from "./reply-reference-bhQ8Bfcq.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-_ZIpTto5.js";
import { l as normalizeMessagePresentation } from "./payload-DKsBSWSJ.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-ChdBOKxX.js";
import { a as projectOutboundPayloadPlanForDelivery, t as createOutboundPayloadPlan } from "./payloads-DNfEhAOv.js";
import { A as selectLongerFinalText, D as resolveChannelStreamingPreviewToolProgress, S as resolveChannelStreamingBlockEnabled, a as createChannelProgressDraftGate, c as formatChannelProgressDraftText, d as isPotentialTruncatedFinal, f as mergeChannelProgressDraftLine, i as buildChannelProgressDraftLineForEntry, k as resolveTranscriptBackedChannelFinalText, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName, y as resolveChannelProgressDraftMaxLines } from "./channel-streaming-DamerS0o.js";
import { n as MediaFetchError } from "./fetch-Dnw-EZz8.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-CHycPDP7.js";
import { t as resolveAckReaction } from "./identity-B-C0a06U.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-BQ29QTB7.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-ekIU3ke9.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-DjroHT9z.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-DtVNGUNX.js";
import { n as createPreviewMessageReceipt } from "./live-D5k4xrlg.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-CsphHypk.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BiJ-0YOF.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-zNDiJjum.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-C32eFLeh.js";
import { n as isAbortRequestText } from "./abort-primitives-BYaVWyyb.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-CwZWV8-2.js";
...
import { t as hasControlCommand } from "./command-detection-BjKN9HEI.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-DOa-VRo0.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-NNVV2XZj.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-Bw6ebEEF.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-CTeMD0kB.js";
import "./history-CTWjVqGU.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-kPBpDXU0.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-C4yQzelX.js";
...
import { n as firstDefined } from "./allow-from-U0-KBRLB.js";
import "./channel-policy-BdE7sbCm.js";
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-DcEGb0_9.js";
import "./reply-history-CRgowW-j.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-Dx2pkZHw.js";
import "./approval-reply-runtime-qR7hO2Nu.js";
...
import "./config-mutation-Bf2WotLg.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-u851df8d.js";
import "./reply-chunking-y5ZjeVpO.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-BtUeN4Jf.js";
import "./outbound-runtime-D573769S.js";
import "./runtime-config-snapshot-5qfAr9xC.js";
import "./model-session-runtime-B20pt1q9.js";
import "./media-runtime-BqjAMS-d.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-ACQ960nn.js";
import "./conversation-runtime-BFsLS4hj.js";
import "./text-chunking-DZnxKaUJ.js";
import "./agent-runtime-C03cRAc6.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-C6l6Ij4h.js";
import "./security-runtime-ts295BWx.js";
import "./agent-harness-runtime-CyR8oriC.js";
import "./hook-runtime-BEkBZyKp.js";
import "./markdown-table-runtime-oYPbSIGt.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-P1joPX1d.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-C-7PiM6o.js";
import "./command-auth-native-Cevj03X_.js";
import "./command-primitives-runtime-BeYldtVg.js";
import "./command-status-D-JTJE7L.js";
import "./command-detection-D0Zj_MHL.js";
import "./command-surface-COoZ9ji4.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-DmW8oTyT.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-B40ZuVnV.js";
import { i as resolveUnmentionedGroupInboundPolicy, r as classifyChannelInboundEvent, s as shouldDebounceTextInbound } from "./channel-inbound-xsxc7XTK.js";
import { n as toLocationContext, t as formatLocationText } from "./location-D4Sf9Djh.js";
import "./channel-ingress-runtime-COf-J0-p.js";
import { h as createMessageReceiveContext } from "./channel-message-CHkrbl6L.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-9_fRH2pa.js";
import "./session-store-runtime--n7zDKuL.js";
import "./models-provider-runtime-BBn3uKFV.js";
import "./skill-commands-runtime-CIsPeUez.js";
import "./native-command-config-runtime-DJWtPkC-.js";
import { t as mergeTelegramAccountConfig } from "./account-config-B2o2RT6-.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-Btd65wDh.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-Swwnb2xi.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-Dtca2xop.js";
import { A as buildSenderLabel, B as expandTelegramAllowFromWithAccessGroups, C as resolveTelegramForumThreadId, D as resolveTelegramThreadSpec, E as resolveTelegramStreamMode, F as hasBotMention, G as resolveTelegramEffectiveDmPolicy, H as isSenderAllowed, L as normalizeForwardedContext, M as expandTextLinks, N as extractTelegramLocation, O as shouldUseTelegramDmThreadSession, P as getTelegramTextParts, S as resolveTelegramForumFlag, T as resolveTelegramReplyId, U as normalizeAllowFrom, V as resolveTelegramDmAllow, W as normalizeDmAllowFromWithStore, _ as extractTelegramForumFlag, a as renderTelegramHtmlText, b as resolveTelegramCommandAuthorization, d as buildTelegramGroupPeerId, f as buildTelegramParentPeer, g as describeReplyTarget, h as buildTypingThreadParams, j as buildSenderName, k as withResolvedTelegramForumFlag, l as buildGroupLabel, m as buildTelegramThreadParams, n as markdownToTelegramChunks, p as buildTelegramRoutingTarget, u as buildTelegramGroupFrom, v as isTelegramCommandsAllowFromConfigured, w as resolveTelegramGroupAllowFromContext, x as resolveTelegramDirectPeerId, z as resolveTelegramPrimaryMedia } from "./format-DiEKEc9b.js";
import { t as resolveTelegramInlineButtons } from "./button-types-BbugkZgF.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-C71FoBxg.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-B0KjHa2K.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DN7U1o_f.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-k_llQYmT.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-blxysFvj.js";
import { A as Bot, C as createTelegramClientFetch, E as resolveTelegramOutboundClientTimeoutFloorSeconds, M as sequentialize, O as withTelegramApiErrorLogging, S as asTelegramClientFetch, T as resolveTelegramClientTimeoutSeconds, a as editMessageTelegram, g as recordSentMessage, j as apiThrottler, k as getOrCreateAccountThrottler, w as resolveTelegramClientTimeoutMinimumSeconds, x as buildInlineKeyboard } from "./send-BjRtlnt8.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CxP2BNJI.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-BjN8CVGd.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DVPH0ewR.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-BNhKAfcS.js");
...
function supersedeTelegramReplyFence(key) {
	...
	state.generation += 1;
	abortTelegramReplyFenceControllers(state);
	if (state.activeDispatches <= 0 && (state.abortControllers?.size ?? 0) === 0) telegramReplyFenceByKey.delete(key);
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-3L_6fbq1.js")).defaultTelegramBotDeps;
	...
	const roomEventAbortController = isRoomEvent ? new AbortController() : void 0;
	...
	const releaseReplyFence = () => {
		...
		endTelegramReplyFence(replyFenceKey.activeKey, roomEventAbortControllerQueued ? void 0 : roomEventAbortController);
	...
	const pushStreamToolProgress = async (line, options) => {
		...
		if (streamMode !== "progress") {
			...
			const nextLines = mergeChannelProgressDraftLine(streamToolProgressLines, progressLine, { maxLines: resolveChannelProgressDraftMaxLines(telegramCfg) });
			if (nextLines === streamToolProgressLines) return;
		...
		if (streamToolProgressEnabled && !streamToolProgressSuppressed && normalized) streamToolProgressLines = mergeChannelProgressDraftLine(streamToolProgressLines, progressLine, { maxLines: resolveChannelProgressDraftMaxLines(telegramCfg) });
						...
						runDispatch: () => {
							...
							return telegramDeps.dispatchReplyWithBufferedBlockDispatcher({
								...
								replyOptions: {
									...
									queuedFollowupLifecycle: isRoomEvent && roomEventAbortController ? {
										onEnqueued: () => {
											roomEventAbortControllerQueued = true;
										},
										onComplete: () => {
											roomEventAbortControllerQueued = false;
											releaseTelegramReplyFenceAbortController(replyFenceKey.activeKey, roomEventAbortController);
										}
									} : void 0,
...
//#endregion
export { getTelegramSequentialKey as n, createTelegramBot as t };
