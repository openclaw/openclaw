...
import { At as boolean, Rn as string, Tn as object, dn as literal, wn as number, yt as _enum } from "./schemas-Bmna8ihM.js";
import { r as extractFirstTextBlock } from "./chat-message-content-D2GieUdK.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-C222GIqx.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-BC7PlkeC.js";
import { t as applyParentDefaultHelpAction } from "./parent-default-help-hEwE7WoF.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-Q6VwAs9o.js"),
			import("./client-DLvs67-Q.js"),
			import("./client-start-readiness-Dsr8T_Y5.js"),
			import("./method-scopes-BRs1lvrb.js"),
			import("./client-info-iltVSR2g.js")
		]);
