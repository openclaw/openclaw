...
import { _ as resolveOAuthPath } from "./paths-Cnwfh6dH.js";
import "./errors-ixwfrboQ.js";
import { p as resolveUserPath } from "./utils-CpmNtyoq.js";
import { d as normalizeSecretInputString, o as coerceSecretRef } from "./types.secrets-11Owfj8f.js";
import { r as normalizeProviderId } from "./provider-id-Cz7K6wgK.js";
import { n as saveJsonFile, t as loadJsonFile } from "./json-file-DIl8If_4.js";
import { t as createSubsystemLogger } from "./subsystem-Dtm6MSVy.js";
import { o as withFileLock } from "./file-lock-BhZ1fIVv.js";
import "./file-lock-BLVQdNSg.js";
import { a as replaceRuntimeAuthProfileStoreSnapshots$1, d as resolveLegacyAuthStorePath, g as cloneAuthProfileStore, i as hasRuntimeAuthProfileStoreSnapshot, l as resolveAuthStorePath, n as getRuntimeAuthProfileStoreSnapshot, o as setRuntimeAuthProfileStoreSnapshot, s as resolveAuthStatePath, t as clearRuntimeAuthProfileStoreSnapshots$1 } from "./runtime-snapshots-C4_kvyJE.js";
import { a as CLAUDE_CLI_PROFILE_ID, c as MINIMAX_CLI_PROFILE_ID, d as OPENAI_CODEX_DEFAULT_PROFILE_ID, f as log$1, i as AUTH_STORE_LOCK_OPTIONS, n as readCachedAuthProfileStore, r as writeCachedAuthProfileStore, s as EXTERNAL_CLI_SYNC_TTL_MS, t as clearLoadedAuthStoreCache } from "./store-cache-C_czQ8Pp.js";
import { C as resolveExternalAuthProfilesWithPlugins } from "./provider-runtime-DrNAJwj9.js";
import "./source-check-S5cDbzsd.js";
...
function preserveLegacyOAuthRefsForDoctorMigration(payload, existingRaw) {
	...
	for (const [profileId, rawProfile] of Object.entries(existingRaw.profiles)) {
		...
		if (credential?.type !== "oauth" || normalizeProviderId(credential.provider) !== LEGACY_OAUTH_REF_PROVIDER || hasInlineOAuthTokenMaterial(credential)) continue;
...
function saveAuthProfileStore(store, agentDir, options) {
	...
	saveJsonFile(authPath, buildPersistedAuthProfileSecretsStore(localStore, void 0, { existingRaw: loadJsonFile(authPath) }));
...
//#endregion
export { resolveTokenExpiryState as A, isSafeToAdoptBootstrapOAuthIdentity as C, DEFAULT_OAUTH_REFRESH_MARGIN_MS as D, shouldReplaceStoredOAuthCredential as E, readCodexCliCredentialsCached as M, readGeminiCliCredentialsCached as N, evaluateStoredCredentialEligibility as O, hasUsableOAuthCredential as S, shouldBootstrapFromExternalCliCredential as T, ensureAuthStoreFile as _, findPersistedAuthProfileCredential as a, areOAuthCredentialsEquivalent as b, loadAuthProfileStoreForSecretsRuntime as c, resolvePersistedAuthProfileOwnerAgentDir as d, saveAuthProfileStore as f, loadPersistedAuthProfileStore as g, coercePersistedAuthProfileStore as h, ensureAuthProfileStoreWithoutExternalProfiles as i, readClaudeCliCredentialsCached as j, hasUsableOAuthCredential$1 as k, loadAuthProfileStoreWithoutExternalProfiles as l, buildPersistedAuthProfileSecretsStore as m, ensureAuthProfileStore as n, loadAuthProfileStore as o, updateAuthProfileStoreWithLock as p, ensureAuthProfileStoreForLocalUpdate as r, loadAuthProfileStoreForRuntime as s, clearRuntimeAuthProfileStoreSnapshots as t, replaceRuntimeAuthProfileStoreSnapshots as u, readExternalCliFallbackCredential as v, isSafeToAdoptMainStoreOAuthIdentity as w, hasMatchingOAuthIdentity as x, readManagedExternalCliCredential as y };
