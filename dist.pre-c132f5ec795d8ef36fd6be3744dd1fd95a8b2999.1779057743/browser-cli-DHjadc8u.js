...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-DQShWN06.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-DQ-eg3tZ.js";
import { t as formatHelpExamples } from "./help-format-CAsniDE5.js";
import { i as registerCommandGroups } from "./register-command-groups-ChkQcpbj.js";
import "./cli-runtime-1XfFzuy3.js";
import "./core-api-CA3frwW6.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-Cp1_YOLA.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-AbtPW2YU.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-D6cSoVFa.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-9IImgURi.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-CwmYAzk4.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-Cc4IEwjQ.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
