...
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-D8BMj4Je.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-CKoZpOSv.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-DvriZ28Q.js";
import { n as loadModelsConfigWithSource } from "./load-config-B9os1Mpp.js";
import { n as formatErrorWithStack } from "./list.errors-CnTeRSES.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-BTAAgsA2.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-DPule0AI.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-DxauqGWM.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-VUsvvQDO.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DAytz34t.js"),
		import("./agent-scope-DIZzHTHq.js"),
		import("./workspace-TNra26i_.js")
	]);
