...
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-Cf8b9Fbd.js";
...
import { n as getLoadedChannelPlugin } from "./registry-no9ipK4H.js";
import { t as resolveChannelApprovalAdapter } from "./plugins--jPjX2J7.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-ChciI5en.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-CuA9qZLK.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeEnv } from "./runtime-state-CXcf51ue.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-BJQBSvu2.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-BSxMqje1.js";
import { r as createResolverContext } from "./runtime-shared-DQ9WXuB3.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-D7E_wtvU.js";
import { l as roleScopesAllow } from "./pairing-token-Bjky4zrp.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CoU0XDAm.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-CiKq6-2n.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-B8BTbg0S.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BX29xUvF.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-CZf5LfRt.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-BWt8q1EJ.js";
import { t as diffConfigPaths } from "./config-diff-Dx2fyolT.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-gmWa0SjQ.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-B07x7Q9E.js";
import "./server-aux-methods-BrIdaRvE.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-D-QOvNhs.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-CqmLZQOC.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-Cv4KMcLH.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-fNaGLEqr.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
