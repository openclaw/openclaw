...
import { o as resolveAgentExecutionContract, r as hasConfiguredModelFallbacks, v as resolveSessionAgentIds } from "./agent-scope-wct0i6B_.js";
...
import { X as resolveProviderAuthProfileId, b as prepareProviderRuntimeAuth } from "./provider-runtime-Dx2yuCyh.js";
...
import { n as markAuthProfileSuccess } from "./profiles-h30uTXRh.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order--NAQCWLC.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-BKu6Cxh9.js";
import { t as redactIdentifier } from "./redact-identifier-7YjMoQIJ.js";
import { t as sanitizeForConsole } from "./console-sanitize-BF8tr4sl.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-ACtNzdlM.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared-jDz7FHHW.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-CKoZpOSv.js";
import "./runs-F2-LpDOb.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-mKpvxoX9.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-D_GyNsXG.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-BNcVxAXn.js";
import { t as ensureContextEnginesInitialized } from "./init-Bp_op6Mx.js";
import { n as ensureOpenClawModelsJson } from "./models-config-Bccu8GJ6.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-tvgl9mFS.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-CkE1CgsH.js";
...
import { i as pickFallbackThinkingLevel, s as normalizeTextForComparison } from "./pi-embedded-helpers-Dha-TJ7m.js";
import { S as parseImageSizeError, _ as isRateLimitAssistantError, a as formatAssistantErrorText, c as isBillingAssistantError, f as isFailoverAssistantError, g as isLikelyContextOverflowError, i as extractObservedOverflowTokenCount, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, x as parseImageDimensionError } from "./errors-BssMvzbV.js";
import { a as copyReplyPayloadMetadata, d as setReplyPayloadMetadata, o as getReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-C6Wf638t.js";
...
import { C as createEmbeddedRunStageTracker, S as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, T as shouldWarnEmbeddedRunStageSummary, _ as resolveRateLimitProfileRotationLimit, _t as resolveRunLivenessState, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, b as createUsageAccumulator, bt as createEmbeddedRunReplayState, c as buildErrorAgentMeta, ct as extractPlanningOnlyPlanDetails, d as resolveActiveErrorContext, dt as resolveEmptyResponseRetryInstruction, f as resolveFinalAssistantRawText, ft as resolveIncompleteTurnPayloadText, g as resolveOverloadProfileRotationLimit, gt as resolveReplayInvalidFlag, h as resolveOverloadFailoverBackoffMs, ht as resolveReasoningOnlyRetryInstruction, i as selectAgentHarness, l as buildUsageAgentMetaFields, lt as resolveAckExecutionFastPathInstruction, m as resolveMaxRunRetryIterations, mt as resolvePlanningOnlyRetryLimit, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, p as resolveFinalAssistantVisibleText, pt as resolvePlanningOnlyRetryInstruction, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, st as STRICT_AGENTIC_BLOCKED_TEXT, u as createCompactionDiagId, ut as resolveAttemptReplayMetadata, v as resolveReportedModelRef, vt as resolveSilentToolResultReplyPayload, w as formatEmbeddedRunStageSummary, x as mergeUsageIntoAccumulator, xt as observeReplayMetadata, y as scrubAnthropicRefusalMagic, yt as shouldTreatEmptyAssistantReplyAsSilent } from "./selection-CKhK3vfL.js";
import { D as isStrictAgenticExecutionContractActive, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-CqeS3c0D.js";
import { p as buildAgentHookContextChannelFields, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-BMiLITPy.js";
import { i as listActiveProcessSessionReferences, r as resolveContextEngineCapabilities, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-C_vJv8Iq.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-CpVvjNDo.js";
import { c as resolveFailoverStatus, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-CqnFlOWd.js";
import { l as runAgentCleanupStep } from "./attempt.tool-run-context-BQAUaZ1k.js";
import { c as retireSessionMcpRuntimeForSessionKey, s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Jph91ebG.js";
import "./pi-bundle-mcp-tools-Cy2iCAjD.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-BgIvZCLr.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-DTKCVi8i.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation--4rw5aZa.js";
...
import { u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-C0fPxOwK.js";
import { a as suspendSession, c as shouldAllowCooldownProbeForReason, i as resolveSessionSuspensionReason, l as buildApiErrorObservationFields, o as LiveSessionModelSwitchError } from "./model-fallback-BPmquqfK.js";
import { t as log$1 } from "./logger-BOPLULTq.js";
import { d as resolveLiveToolResultMaxChars, f as sessionLikelyHasOversizedToolResults, p as truncateOversizedToolResultsInSession } from "./preemptive-compaction-VeF-_7Od.js";
import "./tool-split-Ta-MW_Um.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-Spu7SiTN.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-DooFy3SV.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-CgNBSvzM.js";
import "./extra-params-W4UQemrY.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-B6AvwHj6.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-DnTwJIpx.js";
import { r as buildAgentRuntimePlan } from "./build-5MDGHiXs.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-DO29kVKU.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-DKFgEoeA.js";
import { n as resolveModelAsync } from "./model-CwRSrBhF.js";
import "./compact.queued-CO9QuoN-.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-CNW7TcUF.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-C6YnSoyH.js";
