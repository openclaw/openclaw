...
import { o as normalizeDeliveryContext } from "./delivery-context.shared-DgOflY-N.js";
...
function listAncestorSessionKeysFromRuns(runs, sessionKey) {
	...
	while (current && !visited.has(current)) {
		...
		visited.add(current);
		const parent = findLatestRunForChildSession(runs, current)?.requesterSessionKey.trim();
...
//#endregion
export { SUBAGENT_ENDED_REASON_ERROR as A, getSubagentSessionRuntimeMs as C, SUBAGENT_ENDED_OUTCOME_KILLED as D, SUBAGENT_ENDED_OUTCOME_ERROR as E, SUBAGENT_TARGET_KIND_SUBAGENT as M, subagentRuns as N, SUBAGENT_ENDED_OUTCOME_TIMEOUT as O, shouldKeepSubagentRunChildLink as S, resolveSubagentSessionStatus as T, shouldIgnorePostCompletionAnnounceForSessionFromRuns as _, buildSubagentRunReadIndexFromRuns as a, isLiveUnendedSubagentRun as b, countPendingDescendantRunsExcludingRunFromRuns as c, isSubagentSessionRunActiveFromRuns as d, listAncestorSessionKeysFromRuns as f, resolveRequesterForChildSessionFromRuns as g, listRunsForRequesterFromRuns as h, restoreSubagentRunsFromDisk as i, SUBAGENT_ENDED_REASON_KILLED as j, SUBAGENT_ENDED_REASON_COMPLETE as k, countPendingDescendantRunsFromRuns as l, listRunsForControllerFromRuns as m, persistSubagentRunsToDisk as n, countActiveDescendantRunsFromRuns as o, listDescendantRunsForRequesterFromRuns as p, persistSubagentRunsToDiskOrThrow as r, countActiveRunsForSessionFromRuns as s, getSubagentRunsSnapshotForRead as t, getSubagentRunByChildSessionKeyFromRuns as u, RECENT_ENDED_SUBAGENT_CHILD_SESSION_MS as v, getSubagentSessionStartedAt as w, isStaleUnendedSubagentRun as x, hasSubagentRunEnded as y };
