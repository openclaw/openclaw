...
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-F2-LpDOb.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-BO3kog2o.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-B4M-zQ9r.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-CkE1CgsH.js";
import { i as consumePendingDelegates } from "./delegate-store-D_koarbB.js";
import "./continuation-delegate-store-DUn51nFt.js";
import { n as resolveContinuationRuntimeConfig } from "./config-CMwWMYxr.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-C0fPxOwK.js";
...
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-CnMdP0ap.js";
import { n as buildAnnounceIdFromChildRun, r as buildAnnounceIdempotencyKey, t as resolveAnnounceOrigin } from "./subagent-announce-origin-BzkRx6cG.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-Cve3EWih.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-CkVGrlAX.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-CRxe3lL8.js"), import("./store-load-BO2SxyOO.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { hasCrossSessionDelegateTargeting } = await import("./targeting-pure-oV5v0Yth.js");
	if (!hasCrossSessionDelegateTargeting(params.targeting, params.dispatchingSessionKey)) return false;
	const { enqueueSystemEvent } = await import("./system-events-_xLOKf2C.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-C-d1zrfs.js");
		...
		if (params.silentAnnounce) {
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-030Icvdm.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
