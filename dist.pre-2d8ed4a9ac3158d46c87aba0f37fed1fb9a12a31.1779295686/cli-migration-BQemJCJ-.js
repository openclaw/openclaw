...
import { a as CLAUDE_CLI_PROFILE_ID } from "./store-cache-B75aAlAf.js";
import "./string-coerce-runtime-Cf3fhT3Z.js";
import "./provider-auth-C_jMm-b4.js";
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive } from "./cli-auth-seam-B02EKvC8.js";
import { n as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS, t as CLAUDE_CLI_BACKEND_ID } from "./cli-constants-BMftISxo.js";
import "./cli-shared-5eMa-Pm6.js";
...
function rewriteModelSelection(model) {
	...
	if (Array.isArray(currentFallbacks)) {
		const nextFallbacks = currentFallbacks.map((entry) => {
			...
			if (converted) runtimeRefs.push(converted);
...
function buildAnthropicCliMigrationResult(config, credential) {
	...
	const nextModels = seedClaudeCliAllowlist(rewrittenModels.value ?? defaults?.models ?? {}, [...rewrittenModel.runtimeRefs, ...rewrittenModels.migrated]);
