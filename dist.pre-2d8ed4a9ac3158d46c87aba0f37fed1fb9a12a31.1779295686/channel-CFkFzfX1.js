...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BHO58ie_.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-xYTicrI9.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-BLG_q0yv.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-Csewe3pX.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-mXsJEaj-.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-DzQH7q_E.js";
import "./channel-api-D2WybGmS.js";
import { t as parseDiscordTarget } from "./target-parsing-Z-BadXli.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-BJTKBDCW.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-s-veCVUl.js";
import { t as getDiscordRuntime } from "./runtime-Bi9CfnLo.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-sRvQm-_v.js";
import { t as getDiscordApprovalCapability } from "./approval-native-B1rz7iWW.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-Dt73EUxE.js";
import { t as discordMessageActions$1 } from "./channel-actions-C9dpPLy0.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-DSFa1VfQ.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-B1HBvj3G.js";
import { n as discordOutbound } from "./outbound-adapter-De2zLcA7.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-Bkree0B7.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-DwfbUuzo.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-Cl2pBUPt.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-FVPBXnHa.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-B_kSPRTH.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-1E4rvzBp.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-BcpFVcGt.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-CPJfw1_V.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DSlIBbps.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-BBGWcuzm.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DNNjglpG.js");
