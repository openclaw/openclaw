...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-BuKrT2wm.js";
...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-Dn3XTR_G.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-DBgPft1J.js";
...
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-BChtciJd.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-Cq-u8i4x.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-CuTYW44m.js";
...
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-C68cy9yM.js";
import { h as stringifyRouteThreadId } from "./channel-route-DBqK_NgW.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-DgOflY-N.js";
...
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-no9ipK4H.js";
...
import { t as listConfiguredSessionStoreAgentIds } from "./targets-IdnKh4F7.js";
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-CIOmZmEg.js";
...
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CsYtUFWW.js";
import { f as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-C0W6f8jq.js";
...
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-z4bQ-qF0.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DF4vGbas.js";
import { _ as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-F2-LpDOb.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-W2OVTL7X.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-Dk3NUiXH.js";
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-BtUdYRaW.js";
import { t as extractToolPayload } from "./tool-payload-DWSPVAk_.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-zYX3Qqdt.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-B-eRfZic.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-D4XNSqY7.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-Ba8jD5Nn.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-DRqQsvQJ.js";
...
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-B5ivU3tG.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-Dv0QB_eC.js";
import { l as getTotalQueueSize } from "./command-queue-DC9ylpv7.js";
import { n as resolveSendPolicy } from "./send-policy-0ZVD2iCI.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-CDMXv_2L.js";
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-CqeS3c0D.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools--gbf5QL6.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-BxyKo6Xl.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DdOGUfrp.js";
import { o as isTimeoutError } from "./failover-error-CqnFlOWd.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-0_tRyePJ.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-f2LK310B.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-CuA9qZLK.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-CXcf51ue.js";
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-CIUW5JZh.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-3vc481TX.js";
import { i as parseAbsoluteTimeMs } from "./stagger-DBugvPPE.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-Ag0Ny_FM.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-zz7c-ujS.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-CnDuGaDR.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-Byz_-Juj.js";
import "./runtime-internal-BMRJEHf3.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-DrK_O8_-.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-D3fyMw-f.js";
...
import { i as resolveReplyToMode } from "./reply-threading-cvY3tAVe.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CWRGUgJq.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-d5mJRAse.js";
...
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-B33fwVM6.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-CExru9c-.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-DO29kVKU.js";
...
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-DDkU7OOH.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-PHetALDh.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-CGqJGRcq.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-_BOovMKb.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-B5hgqoYb.js";
import "./commands-registry-Dn9_nAsp.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-BjdUWdbl.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-CHI_1t3a.js";
import "./browser-maintenance-Bx5yNri8.js";
...
import { t as getChannelActivity } from "./channel-activity-BQnjDCWI.js";
...
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-B0hTbglD.js";
...
import { n as getLastHeartbeatEvent } from "./heartbeat-events-B5XZtIjO.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-B1hLklW5.js";
...
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-Dw9wBTun.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-DzedcYQ-.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BEC3tBsX.js";
import { t as formatForLog } from "./ws-log-CKsgGAR2.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-xHV-r-4n.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-9RuRPJdQ.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-CgliKMG4.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-CZf5LfRt.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-BIMCFVnN.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-CxRh64I4.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-NsG0eT3C.js";
import { n as createOutboundSendDeps } from "./deps-BwxNMJbZ.js";
import "./agent-BG2vad-f.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-D9ng5G8W.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-H3pm-2IY.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-CwmhfC0x.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-D0X7p6qk.js";
import "./server-constants-TTWK0ss4.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-DDKutCuf.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CKjEi8uz.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-DMp58Jj8.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-DcvePwJP.js";
import { t as loadProviderUsageSummary } from "./provider-usage-CZOEmMKw.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-vdE8qJTu.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-BDG4NWg7.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-AdfqP-6B.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-C5cC3sy0.js";
import { t as buildChannelUiCatalog } from "./catalog-Dj-4c86X.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-BQ7huxxc.js";
import { s as normalizeUpdateChannel } from "./update-channels-q-4psTjE.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-DSPvV7SE.js";
import { i as resolveConfigReloadMetadata, t as buildGatewayReloadPlan } from "./config-reload-plan-BWt8q1EJ.js";
import { t as readConfiguredLogTail } from "./log-tail-DxnwIPWD.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BNjbINwG.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-CG6-BCb8.js";
import { t as buildChannelAccountSnapshot } from "./status-DBa690jn.js";
...
import { t as installSkill } from "./skills-install-BCkQJnZy.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-C0mGI7DR.js";
import { r as readPackageVersion } from "./package-json-DRyTQaB2.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-Qztvvkqb.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-DLCwydK_.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-BP_T-4jI.js";
import { t as getStatusSummary } from "./status.summary-BDNuh2xr.js";
import "./status-Dbkg2Y5g.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-B7ST-zRn.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-XNBJbqD5.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-DsMzvu_I.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-BMkQuCdQ.js";
import { t as diffConfigPaths } from "./config-diff-Dx2fyolT.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-gmWa0SjQ.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CjTELDo1.js";
import "./heartbeat-runner-BvKZ92UE.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-BDvUYZyR.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-DeJfvtSI.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-C3tZMozm.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CzcKnfTL.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-Cd5OgiDY.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-CrSjP9jg.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-Busm3pvF.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-Dn4gK0BX.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-CNYuECy3.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-ZEPoFpuD.js");
