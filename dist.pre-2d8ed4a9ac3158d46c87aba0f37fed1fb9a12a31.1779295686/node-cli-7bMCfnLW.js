...
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-BB3dVJai.js";
import { n as VERSION } from "./version-DmRkhYua.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-DU9vj_hQ.js";
import { c as normalizeAgentId } from "./session-key-CQewiu8n.js";
import { n as defaultRuntime } from "./runtime-DDH_zqCr.js";
import "./fs-safe-advanced-jUnIgHPM.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-qdOIPdyq.js";
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-BSkQsJmS.js";
import { a as logWarn } from "./logger-B-H6-XfD.js";
import { i as getRuntimeConfig } from "./io-Dn3XTR_G.js";
import { f as resolveApprovalAuditTrustPath, m as resolveCommandResolutionFromArgv, w as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-B0KACPCA.js";
import { O as normalizeExecutableToken, S as unwrapKnownDispatchWrapperInvocation, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, g as resolveInlineCommandMatch, k as splitShellArgs, l as isShellWrapperInvocation, p as advancePosixInlineOptionScan, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, v as extractEnvAssignmentKeysFromDispatchWrappers } from "./shell-wrapper-resolution-DovxfRJ_.js";
import "./config-CKAUap-Q.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-W6MULocR.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-aUF34dV0.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BfP5vFiW.js";
import { t as parsePort } from "./parse-port-6T69iZYb.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-Bir04kfe.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-C5psAe33.js";
import { a as getActivePluginRegistry } from "./runtime-CuTYW44m.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-VTHY4CeG.js";
import { t as getMachineDisplayName } from "./machine-name-HuBeu9Nt.js";
import { c as describeInterpreterInlineEval } from "./risks-DPkp3aOj.js";
import { c as analyzeArgvCommand, d as buildSafeBinsShellCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-Bp-vcdg3.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-zqf1v4zs.js";
import { N as saveExecApprovals, O as resolveExecApprovals, P as requestJsonlSocket, T as requiresExecApproval, b as readExecApprovalsSnapshot, c as hasDurableExecApproval, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, o as addDurableCommandApproval, s as ensureExecApprovals, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-CuA9qZLK.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CrbflQnQ.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DEvk9t-S.js";
import { t as formatHelpExamples } from "./help-format-00vpEOWW.js";
import { n as detectPolicyInlineEval } from "./policy-Cl74RwRX.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-H3pm-2IY.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-DYs3QfEB.js";
import { t as resolveNodeService } from "./node-service-BFGWoeNr.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-DDhHj-aV.js");
