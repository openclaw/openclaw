...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-Dn3XTR_G.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { t as note } from "./note-BIrbbkiz.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-1th5DG3y.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BmYeSgbc.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DfySb-EM.js");
