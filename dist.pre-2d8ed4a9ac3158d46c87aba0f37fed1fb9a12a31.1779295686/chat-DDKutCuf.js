...
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-DCXkPRXp.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Bk5onV1S.js";
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, x as resolveModelRefFromString } from "./model-selection-shared-C0W6f8jq.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-Ba8jD5Nn.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-CTXNK5o-.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-0l161xdu.js";
import { n as resolveSendPolicy } from "./send-policy-0ZVD2iCI.js";
import { c as isReplyPayloadTtsSupplement, i as buildTtsSupplementMediaPayload, s as getReplyPayloadTtsSupplement } from "./reply-reference-C6Wf638t.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-29gkdZvj.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-f2LK310B.js";
import { c as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-C0fPxOwK.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-BdEF_wzT.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-zz7c-ujS.js";
...
import { n as rewriteTranscriptEntriesInSessionFile } from "./context-engine-maintenance-CgNBSvzM.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-4pUWjeIM.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-BzAKjxzA.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-CB8PMOd0.js";
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-CHI_1t3a.js";
...
import { t as logLargePayload } from "./diagnostic-payload-StjLo6Gi.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-CVDT5ypi.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-Wn68IrNa.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-TTWK0ss4.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-C1GCTdAU.js";
import { a as resolveChatAttachmentLooksLikeImage, i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CKjEi8uz.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-CONDhLHu.js";
