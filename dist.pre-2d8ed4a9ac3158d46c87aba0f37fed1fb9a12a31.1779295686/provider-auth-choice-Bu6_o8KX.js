...
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-BuKrT2wm.js";
import { t as sanitizeTerminalText } from "./safe-text-CZdXrCEj.js";
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-BpLaMszT.js";
import { t as enablePluginInConfig } from "./enable-DqnqyMFO.js";
import "./auth-profiles-B_gK5i9u.js";
import { s as upsertAuthProfileWithLock } from "./profiles-h30uTXRh.js";
import "./workspace-DdOGUfrp.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-Bu-9x8ul.js";
import { n as t } from "./i18n-e7Eoj7B-.js";
import { n as openUrl } from "./browser-open-A8N8bkca.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DZwCPvLa.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BLR4V8Uz.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-B4GnfRoQ.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-CVt-iZQk.js";
import { t as isRemoteEnvironment } from "./remote-env-5WHT2739.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-uNKI8CWX.js");
		...
		if (codexInstall.installed) {
			const { offerPostInstallMigrations } = await import("./setup.post-install-migration-BjupOII_.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-D5R9dQx_.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-CJYqaVn1.js");
