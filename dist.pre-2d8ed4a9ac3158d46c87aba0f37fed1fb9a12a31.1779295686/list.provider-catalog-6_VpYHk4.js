...
import { h as resolveOwningPluginIdsForProvider, s as resolveBundledProviderCompatPluginIds } from "./plugin-auto-enable-C8t9y5Vn.js";
import { l as loadAuthProfileStoreWithoutExternalProfiles } from "./store-CsYtUFWW.js";
import { a as runProviderStaticCatalog, i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-CMAW3qHt.js";
import { n as createProviderAuthResolver, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-Dz6T2Keh.js";
...
async function resolveProviderCatalogPluginIdsForFilter(params) {
	...
	const { resolveProviderContractPluginIdsForProviderAlias } = await import("./registry-C3y7eCY9.js");
