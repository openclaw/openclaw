...
import { n as require_extend, t as require_package } from "./package-sGTXW81s.js";
 ...
 /**
	...
	*/
	static async #getProxyAgent() {
		this.#proxyAgent ||= (await import("./dist-CBxY6u6E.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).HttpsProxyAgent;
		return this.#proxyAgent;
	}
	static async #getFetch() {
		const hasWindow = typeof window !== "undefined" && !!window;
		this.#fetch ||= hasWindow ? window.fetch : (await import("./src-BLddUiq6.js")).default;
		return this.#fetch;
	}
	/**
	* Merges headers.
