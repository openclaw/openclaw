...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-Cbe_5-zk.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DFd5Bqlu.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-yryRaT8O.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CrLE0B8W.js");
	if (params.argv) {
