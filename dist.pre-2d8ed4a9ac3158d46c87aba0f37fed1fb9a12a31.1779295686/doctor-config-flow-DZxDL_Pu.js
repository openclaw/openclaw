...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-11Owfj8f.js";
...
import { n as discoverConfigSecretTargets } from "./target-registry-Cf8b9Fbd.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-Dn3XTR_G.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { r as normalizeTalkSection } from "./talk-Do4udxrV.js";
import { n as collectConfiguredModelRefs } from "./model-refs-dUnyf8Yy.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-F8J_hk_t.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-DQmG4e6_.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DXTib1K7.js";
import { n as getLoadedChannelPlugin } from "./registry-no9ipK4H.js";
import { i as listRouteBindings } from "./bindings-D-J5s_xm.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, o as listLegacyRuntimeModelProviderAliases, s as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-CsvezYKn.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-DvHlDosG.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-CaBrSqyF.js";
import { t as note } from "./note-BIrbbkiz.js";
import { t as asObjectRecord } from "./object-Jb8gVnkH.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-1th5DG3y.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-CgQiQn3P.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-CdiIPDrR.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BcGfG5mV.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-CpEdmrbm.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-OybretMD.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-BkRs-q2H.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-9O5eNRBI.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-BGCBEb7u.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BlFuhmGJ.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CqDwAocA.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DmGv42o9.js");
		emitDoctorNotes({
			note,
