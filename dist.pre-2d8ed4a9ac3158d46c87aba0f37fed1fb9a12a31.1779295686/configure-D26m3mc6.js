...
import { t as ConfigMutationConflictError } from "./mutate-DBgPft1J.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-BlClcYoT.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-DgnANRPk.js";
import { n as applyAuthChoice } from "./auth-choice-Dd6hktG0.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-5JOu67AW.js";
import { i as setupChannels } from "./onboard-channels-BVAGGRqc.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BczwKkE7.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-ByJTa7wi.js";
import { t as promptCustomApiConfig } from "./onboard-custom-CUj40RjF.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-D1oOY4WI.js";
import { n as formatHealthCheckFailure } from "./health-format-BOHE0c59.js";
import { n as healthCommand } from "./health-CpSwrFR7.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-Czv38YCf.js";
import { t as setupSkills } from "./onboard-skills-BAJdkSnd.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-DLVVQMw-.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Cw1CmUPL.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-6fHgYnKc.js");
