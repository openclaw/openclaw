...
import { A as resolveSessionStoreEntry, a as registerSessionMaintenancePreserveKeysProvider, t as loadSessionStore } from "./store-load-Pm7UPztK.js";
import { s as updateSessionStore } from "./store-BsgW6uVr.js";
import "./sessions-CIOmZmEg.js";
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-hvNjE2n3.js";
import { A as SUBAGENT_ENDED_REASON_ERROR, C as getSubagentSessionRuntimeMs, D as SUBAGENT_ENDED_OUTCOME_KILLED, E as SUBAGENT_ENDED_OUTCOME_ERROR, M as SUBAGENT_TARGET_KIND_SUBAGENT, N as subagentRuns, O as SUBAGENT_ENDED_OUTCOME_TIMEOUT, T as resolveSubagentSessionStatus, i as restoreSubagentRunsFromDisk, j as SUBAGENT_ENDED_REASON_KILLED, k as SUBAGENT_ENDED_REASON_COMPLETE, l as countPendingDescendantRunsFromRuns, m as listRunsForControllerFromRuns, n as persistSubagentRunsToDisk, o as countActiveDescendantRunsFromRuns, p as listDescendantRunsForRequesterFromRuns, r as persistSubagentRunsToDiskOrThrow, s as countActiveRunsForSessionFromRuns, t as getSubagentRunsSnapshotForRead, u as getSubagentRunByChildSessionKeyFromRuns, w as getSubagentSessionStartedAt, x as isStaleUnendedSubagentRun } from "./subagent-registry-state-dup8TxYg.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-DiF3jNjk.js";
import { a as isSilentReplyText } from "./tokens-CkE1CgsH.js";
import { c as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-Jph91ebG.js";
import "./pi-bundle-mcp-tools-Cy2iCAjD.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-DrK_O8_-.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DC9ultmN.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-CnMdP0ap.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-C9Qgse9h.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Dd9_CYbH.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-DUHZgR2a.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Dd9_CYbH.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-C-D0vTgX.js").then(({ scheduleOrphanRecovery }) => {
