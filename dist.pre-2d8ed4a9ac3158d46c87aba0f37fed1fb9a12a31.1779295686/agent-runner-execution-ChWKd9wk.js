...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-wct0i6B_.js";
import { n as defaultRuntime } from "./runtime-DDH_zqCr.js";
import { r as logVerbose } from "./globals-DaPK6X5S.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-DJtqYoTD.js";
import { l as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-8M9hE9Ml.js";
import { t as resolveAgentHarnessPolicy } from "./policy-B-d3yKnE.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DkpIHRmj.js";
import { o as resolveSessionTranscriptPath } from "./paths-_BPRx1WO.js";
import { A as resolveSessionStoreEntry } from "./store-load-Pm7UPztK.js";
import { s as updateSessionStore, v as resolveGroupSessionKey } from "./store-BsgW6uVr.js";
import "./sessions-CIOmZmEg.js";
import { a as resolveContextTokensForModel } from "./context-DhyBZ4dO.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-C0W6f8jq.js";
import { t as isCliProvider } from "./model-selection-cli-C2xUjDlh.js";
import { l as resolvePersistedOverrideModelRef } from "./model-selection-DCMPulC-.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-D_GyNsXG.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-BNcVxAXn.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-CkE1CgsH.js";
import { u as stripHeartbeatToken } from "./heartbeat-CTxAKNnY.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-DC9ylpv7.js";
import { c as resolveCliRuntimeExecutionProvider, o as listLegacyRuntimeModelProviderAliases } from "./model-runtime-aliases-CsvezYKn.js";
import "./pi-embedded-helpers-Dha-TJ7m.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-B8Qf8IgV.js";
import { d as isContextOverflowError, g as isLikelyContextOverflowError, u as isCompactionFailureError, y as isTransientHttpError } from "./errors-BssMvzbV.js";
import { a as copyReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-C6Wf638t.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-29gkdZvj.js";
import { l as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BtwnLMsN.js";
import { r as getCliSessionBinding } from "./cli-session-d-JTOweJ.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-CIV7tydP.js";
import "./selection-CKhK3vfL.js";
import { u as parseReplyDirectives } from "./payloads-f2LK310B.js";
import { o as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BPmquqfK.js";
import { n as hasCotFramePrefix } from "./normalize-reply-CGu50IEc.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-Dey3Swur.js";
import { n as buildAgentRuntimeOutcomePlan } from "./build-5MDGHiXs.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DrRBxMzy.js";
import { t as runCliAgent } from "./cli-runner-CIrbtdpW.js";
import { n as HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT, t as GENERIC_EXTERNAL_RUN_FAILURE_TEXT } from "./agent-runner-failure-copy-CMn5jNOm.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-C3w_n7tX.js";
import { a as resolveAgentTurnAttachments, n as createBlockReplyContentKey } from "./block-reply-pipeline-CWztqxWZ.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-4pUWjeIM.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-D5d0Zihm.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-DAdKB-xO.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-rRTEOizk.js");
						...
						const result = await runEmbeddedPiAgentDefault({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-BHv3cFou.js");
...
//#endregion
export { resolveReplyRunFireReason as a, runCliAgentWithLifecycle as c, runAgentTurnWithFallback as i, resolveSilentReplySettings as l, resolveRunAfterAutoFallbackPrimaryProbeRecheck as n, normalizeReplyPayloadDirectives as o, resolveSessionRuntimeOverrideForProvider as r, resolveCurrentTurnImages as s, buildKnownAgentRunFailureReplyPayload as t };
