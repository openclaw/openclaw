...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-2deKtDuk.js";
import "./ssrf-runtime-uB3Az6qX.js";
import "./retry-runtime-JZFnfwYi.js";
import "./secret-input-runtime-DO4v24VV.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CBFLYg-m.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-CyJdHSKP.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-XjUjnAdd.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-BBqsQXM_.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BT5O1PgY.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-Dgh6OAbK.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-CETgJ1Tc.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BvIviA38.js"), import("./logging-CRj99hz6.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-e896_GWB.js").then((credentialsReadModule) => ({
