import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-C8zKd1Wc.js";
import { r as loadCrestodianOverview } from "./overview-CzAHHfJN.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CLPgkZPN.js")).planCrestodianCommand)({
		input,
		overview
	});
