...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-2deKtDuk.js";
import "./ssrf-runtime-uB3Az6qX.js";
import "./security-runtime-DpTOaPkU.js";
import "./provider-http-DIU24851.js";
import { t as getMSTeamsRuntime } from "./runtime-api-CT0y9aL0.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-CLJ516me.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-tsvtufQP.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BRshbXSk.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-C6SCGyHb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-BcInK4OC.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
