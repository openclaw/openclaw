import { Dn as CliBackendConfig, i as OpenClawConfig } from "./types.openclaw-DPnlcagS.js";
import { l as SecretInput } from "./types.secrets-CW3w8nVu.js";
import { a as ModelCompatConfig, c as ModelProviderAuthMode, l as ModelProviderConfig } from "./types.models-CpHuMVwj.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-Bppdg5tc.js";
...
import { d as UnifiedModelCatalogEntry, f as UnifiedModelCatalogKind, u as PluginKind } from "./manifest-registry-DjkW2KXL.js";
import { n as ReasoningLevel, r as ThinkLevel } from "./thinking.shared-CUJbeRQi.js";
import { t as ChannelId } from "./channel-id.types-BK_x91Vq.js";
import { c as SessionSystemPromptReport, o as SessionEntry } from "./types-CG0p47bR.js";
import { r as AnyAgentTool } from "./common-BLkNF-zo.js";
import { S as HeartbeatToolResponse, a as PromptMode, b as MessagingToolSourceReplyPayload, h as EmbeddedPiCompactResult, p as ExecElevatedDefaults, r as RunEmbeddedPiAgentParams, s as BlockReplyChunking, v as EmbeddedRunLivenessState, y as MessagingToolSend } from "./params-BhHEACo0.js";
import { c as SourceReplyDeliveryMode, r as GetReplyOptions, u as ReplyPayload } from "./get-reply-options.types-Bk9LuA2v.js";
import { c as DiagnosticEventPayload, kt as TalkTransport, o as DiagnosticEventInput, s as DiagnosticEventMetadata } from "./diagnostic-events-BKARwh_c.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-v8u6TgdW.js";
import { t as CommandQueueEnqueueFn } from "./command-queue.types-DsSAe62t.js";
import { n as FailoverReason } from "./types-F0qq34vP.js";
import { n as SkillSnapshot } from "./skills-DplSpzdS.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-BTl1WL_V.js";
import { E as OpenClawPluginHookOptions, L as WebFetchProviderPlugin, O as OpenClawPluginToolFactory, U as WebSearchProviderPlugin, k as OpenClawPluginToolOptions } from "./types-core-BCt6C0U-.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-vEwMpvub.js";
import { f as MediaUnderstandingProvider } from "./types-Cs-67MjV2.js";
import { l as ImageGenerationProvider } from "./types-DJRt10UN.js";
import { s as VideoGenerationProvider } from "./types-DkQi82mb.js";
import { c as MusicGenerationProvider } from "./types-BSGmQ-cw.js";
import { n as RuntimeEnv } from "./runtime-BvGYzQ2u.js";
import { i as WizardPrompter } from "./prompts-RT9LHx1Q.js";
import { t as SecretInputMode } from "./provider-auth-types-Brr-IZ8g.js";
import { A as SpeechSynthesisRequest, C as SpeechProviderId, D as SpeechProviderResolveConfigContext, E as SpeechProviderPreparedSynthesis, F as SpeechTelephonySynthesisRequest, I as SpeechTelephonySynthesisResult, L as SpeechVoiceOption, M as SpeechSynthesisStreamRequest, N as SpeechSynthesisStreamResult, O as SpeechProviderResolveTalkConfigContext, S as SpeechProviderConfiguredContext, T as SpeechProviderPrepareSynthesisContext, _ as SpeechDirectiveTokenParseContext, j as SpeechSynthesisResult, k as SpeechProviderResolveTalkOverridesContext, v as SpeechDirectiveTokenParseResult, x as SpeechProviderConfig, y as SpeechListVoicesRequest } from "./tts-runtime.types-CmmbzUaE.js";
import { n as DetachedTaskLifecycleRuntime } from "./detached-task-runtime-contract-CjJ-paOc.js";
import { l as ContextEngine, m as ContextEngineRuntimeContext, p as ContextEnginePromptCacheInfo, t as ContextEngineFactory } from "./registry-CStwWcQk.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state--lqd8aWx.js";
import { Gt as PluginConversationBindingRequestParams, It as PluginJsonValue, Jt as PluginConversationBindingResolvedEvent, Kt as PluginConversationBindingRequestResult, Nt as PluginNextTurnInjection, Pt as PluginNextTurnInjectionEnqueueResult, Wt as PluginConversationBinding, en as PluginHookBeforeAgentStartResult, et as PluginHookName, q as PluginHookHandlerMap } from "./hook-types-D3ftupsh.js";
import { n as ToolOutcomeObserver } from "./pi-tools.before-tool-call-BGi4cZnb.js";
...
import { n as GatewayRequestHandler } from "./types-D0GCaPiC.js";
import { r as InternalHookHandler } from "./internal-hook-types-tSQPjOsY.js";
import { t as ProviderUsageSnapshot } from "./provider-usage.types-CENmxibi.js";
 ...
 */
declare const AGENT_PROMPT_SURFACE_KINDS: readonly ["pi_main", "codex_app_server", "cli_backend", "acp_backend", "subagent"];
...
//#endregion
export { OpenClawPluginService as $, ProviderExternalAuthProfile as $n, RealtimeTranscriptionProviderConfig as $r, ProviderModernModelPolicyContext as $t, OpenClawPluginDefinition as A, MemoryEmbeddingProviderAdapter as Ai, ProviderResolveTransportTurnStateContext as An, AgentToolResultMiddlewareResult as Ar, ProviderAuthResult as At, OpenClawPluginModule as B, ProviderValidateReplayTurnsContext as Bn, RealtimeVoiceBridgeEvent as Br, ProviderCreateEmbeddingProviderContext as Bt, OpenClawPluginApi as C, normalizeUsage as Ci, ProviderReplaySessionEntry as Cn, PluginTextReplacement as Cr, ProviderAugmentModelCatalogContext as Ct, OpenClawPluginCliRegistrar as D, MemoryEmbeddingBatchChunk as Di, ProviderResolveDynamicModelContext as Dn, AgentToolResultMiddlewareEvent as Dr, ProviderAuthMethod as Dt, OpenClawPluginCliContext as E, resolveEmbeddedAgentRuntime as Ei, ProviderResolveAuthProfileIdContext as En, AgentToolResultMiddlewareContext as Er, ProviderAuthKind as Et, OpenClawPluginHttpRouteHandler as F, clearMemoryEmbeddingProviders as Fi, ProviderSanitizeReplayHistoryContext as Fn, RealtimeVoiceAudioFormat as Fr, ProviderCacheTtlEligibilityContext as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, SpeechProviderPlugin as Gn, RealtimeVoiceProviderConfig as Gr, ProviderDiscoveryResult as Gt, OpenClawPluginNodeHostCommand as H, ProviderWrapStreamFnContext as Hn, RealtimeVoiceBrowserSessionCreateRequest as Hr, ProviderDeferSyntheticProfileAuthContext as Ht, OpenClawPluginHttpRouteMatch as I, listRegisteredMemoryEmbeddingProviders as Ii, ProviderSystemPromptContributionContext as In, RealtimeVoiceBargeInOptions as Ir, ProviderCapabilities as It, OpenClawPluginNodeInvokeTransportResult as J, VideoGenerationProviderPlugin as Jn, RealtimeVoiceProviderResolveConfigContext as Jr, ProviderFailoverErrorContext as Jt, OpenClawPluginNodeInvokePolicyContext as K, UnifiedModelCatalogProviderContext as Kn, RealtimeVoiceProviderConfiguredContext as Kr, ProviderExtraParamsForTransportContext as Kt, OpenClawPluginHttpRouteParams as L, registerMemoryEmbeddingProvider as Li, ProviderToolSchemaDiagnostic as Ln, RealtimeVoiceBridge as Lr, ProviderCatalogContext as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, MemoryEmbeddingProviderCreateOptions as Mi, ProviderResolveWebSocketSessionPolicyContext as Mn, OpenClawAgentToolResult as Mr, ProviderBuildUnknownModelHintContext as Mt, OpenClawPluginHostedMediaResolver as N, MemoryEmbeddingProviderCreateResult as Ni, ProviderResolvedUsageAuth as Nn, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Nr, ProviderBuiltInModelSuppressionContext as Nt, OpenClawPluginCommandDefinition as O, MemoryEmbeddingBatchOptions as Oi, ProviderResolveNonInteractiveApiKeyParams as On, AgentToolResultMiddlewareHarness as Or, ProviderAuthMethodNonInteractiveContext as Ot, OpenClawPluginHttpRouteAuth as P, MemoryEmbeddingProviderRuntime as Pi, ProviderRuntimeProviderConfig as Pn, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as Pr, ProviderBuiltInModelSuppressionResult as Pt, OpenClawPluginSecurityAuditContext as Q, ProviderRuntimeModel as Qn, RealtimeVoiceToolResultOptions as Qr, ProviderModelSelectedContext as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, ProviderTransformSystemPromptContext as Rn, RealtimeVoiceBridgeCallbacks as Rr, ProviderCatalogOrder as Rt, OpenClawPluginAgentEventsApi as S, NormalizedUsage as Si, ProviderReplaySanitizeMode as Sn, CliBundleMcpMode as Sr, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, BuildAgentRuntimePlanParams as Ti, ProviderReplayToolCallIdMode as Tn, AgentToolResultMiddleware as Tr, ProviderAuthDoctorHintContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, RealtimeTranscriptionProviderPlugin as Un, RealtimeVoiceCloseReason as Ur, ProviderDiscoveryContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, ProviderWebSocketSessionPolicy as Vn, RealtimeVoiceBrowserSession as Vr, ProviderCreateStreamFnContext as Vt, OpenClawPluginNodeInvokePolicy as W, RealtimeVoiceProviderPlugin as Wn, RealtimeVoiceProviderCapabilities as Wr, ProviderDiscoveryOrder as Wt, OpenClawPluginRunContextApi as X, ProviderThinkingPolicyContext as Xn, RealtimeVoiceTool as Xr, ProviderFollowupFallbackRouteContext as Xt, OpenClawPluginReloadRegistration as Y, ProviderDefaultThinkingPolicyContext as Yn, RealtimeVoiceRole as Yr, ProviderFetchUsageSnapshotContext as Yt, OpenClawPluginSecurityAuditCollector as Z, ProviderThinkingProfile as Zn, RealtimeVoiceToolCallEvent as Zr, ProviderFollowupFallbackRouteResult as Zt, MigrationSummary as _, AgentHarnessSupport as _i, ProviderPreparedRuntimeAuth as _n, CliBackendPrepareExecutionContext as _r, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, RealtimeTranscriptionSessionCreateRequest as ai, ProviderNormalizeTransportContext as an, ProviderApplyConfigDefaultsContext as ar, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, EmbeddedRunAttemptParams as bi, ProviderReplayPolicy as bn, CliBackendResolveExecutionArgsContext as br, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, AgentHarnessAttemptParams as ci, ProviderPluginCatalog as cn, CodexAppServerExtensionContext as cr, PluginCommandResult as ct, MigrationItemKind as d, AgentHarnessCompactResult as di, ProviderPluginWizardModelPicker as dn, CodexAppServerToolResultEvent as dr, PluginEmbeddingProvider as dt, RealtimeTranscriptionProviderConfiguredContext as ei, ProviderNonInteractiveApiKeyCredentialParams as en, ProviderExternalOAuthProfile as er, OpenClawPluginServiceContext as et, MigrationItemStatus as f, AgentHarnessDeliveryDefaults as fi, ProviderPluginWizardSetup as fn, CodexAppServerToolResultHandlerResult as fr, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, AgentHarnessSideQuestionResult as gi, ProviderPrepareRuntimeAuthContext as gn, CliBackendPlugin as gr, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, AgentHarnessSideQuestionParams as hi, ProviderPrepareExtraParamsContext as hn, CliBackendNormalizeConfigContext as hr, PluginLogger as ht, AgentPromptSurfaceKind as i, RealtimeTranscriptionSessionCallbacks as ii, ProviderNormalizeToolSchemasContext as in, ProviderSyntheticAuthResult as ir, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, MemoryEmbeddingProviderCallOptions as ji, ProviderResolveUsageAuthContext as jn, AgentToolResultMiddlewareRuntime as jr, ProviderBuildMissingAuthMessageContext as jt, OpenClawPluginConfigSchema as k, MemoryEmbeddingProvider as ki, ProviderResolvePromptOverlayContext as kn, AgentToolResultMiddlewareOptions as kr, ProviderAuthOptionBag as kt, MigrationItem as l, AgentHarnessAttemptResult as li, ProviderPluginDiscovery as ln, CodexAppServerExtensionFactory as lr, PluginConfigMigration as lt, MigrationProviderContext as m, AgentHarnessResultClassification as mi, ProviderPrepareDynamicModelContext as mn, CliBackendNativeToolMode as mr, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, RealtimeTranscriptionProviderResolveConfigContext as ni, ProviderNormalizeModelIdContext as nn, ProviderResolveExternalOAuthProfilesContext as nr, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, ProviderSystemPromptContribution as oi, ProviderOAuthProfileIdRepair as on, ProviderNormalizeConfigContext as or, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, AgentHarnessResetParams as pi, ProviderPreferRuntimeResolvedModelContext as pn, CliBackendAuthEpochMode as pr, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, UnifiedModelCatalogProviderPlugin as qn, RealtimeVoiceProviderId as qr, ProviderExtraParamsForTransportResult as qt, AgentPromptGuidanceEntry as r, RealtimeTranscriptionSession as ri, ProviderNormalizeResolvedModelContext as rn, ProviderResolveSyntheticAuthContext as rr, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, AgentHarness as si, ProviderPlugin as sn, ProviderResolveConfigApiKeyContext as sr, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, RealtimeTranscriptionProviderId as ti, ProviderNonInteractiveApiKeyResult as tn, ProviderResolveExternalAuthProfilesContext as tr, OpenClawPluginSessionApi as tt, MigrationItemAction as u, AgentHarnessCompactParams as ui, ProviderPluginWizard as un, CodexAppServerExtensionRuntime as ur, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, AgentHarnessSupportContext as vi, ProviderReasoningOutputMode as vn, CliBackendPreparedExecution as vr, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, AgentRuntimePlan as wi, ProviderReplaySessionState as wn, PluginTextTransforms as wr, ProviderAuthContext as wt, OpenClawPluginAgentApi as x, EmbeddedRunAttemptResult as xi, ProviderReplayPolicyContext as xn, CliBackendThinkingLevel as xr, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, CompactEmbeddedPiSessionParams as yi, ProviderReasoningOutputModeContext as yn, CliBackendResolveExecutionArgs as yr, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, ProviderTransportTurnState as zn, RealtimeVoiceBridgeCreateRequest as zr, ProviderCatalogResult as zt };