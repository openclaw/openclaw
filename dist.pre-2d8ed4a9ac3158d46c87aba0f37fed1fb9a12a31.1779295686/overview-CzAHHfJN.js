...
import { a as resolveAgentEffectiveModelPrimary } from "./agent-scope-wct0i6B_.js";
import { c as normalizeAgentId } from "./session-key-CQewiu8n.js";
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-BuKrT2wm.js";
import { u as readConfigFileSnapshot } from "./io-Dn3XTR_G.js";
import "./config-CKAUap-Q.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-CqWN1uMp.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-D2U9YCvT.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
