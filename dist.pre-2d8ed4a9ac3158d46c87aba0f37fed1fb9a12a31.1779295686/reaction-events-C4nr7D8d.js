...
import "./session-binding-runtime-BsF4Mog4.js";
import { a as resolveMatrixAccountConfig } from "./account-config-XjUjnAdd.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-DzwB759X.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-CYVJqkCy.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-Dm7eSReL.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-XqvgrAm4.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-CZlQXSEG.js");
