...
import { Y as getShellPathFromLoginShell, Z as resolveShellEnvFallbackTimeoutMs } from "./io-Dn3XTR_G.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-W2OVTL7X.js";
import { d as sanitizeUserFacingText, f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText } from "./sanitize-user-facing-text-D_GyNsXG.js";
import { t as formatDurationCompact } from "./format-duration-BaYgw-dr.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-BeWyTJaf.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-CivaLDXn.js";
import { o as failedTextResult, y as textResult } from "./common-BRnn7Owx.js";
import { t as callGatewayTool } from "./gateway-BBQ1yjrG.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-DPkp3aOj.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-Bp-vcdg3.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-zqf1v4zs.js";
...
import { t as sendMessage } from "./message-B_lkzQ2A.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-C-IBHB9X.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-By1dLksb.js";
import { t as getProcessSupervisor } from "./supervisor-D2rKxnYb.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-DgkpcDqU.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-DWhTOOo8.js";
import { u as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-CiKq6-2n.js";
import { n as detectPolicyInlineEval } from "./policy-Cl74RwRX.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-D9ng5G8W.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-H3pm-2IY.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-CwmhfC0x.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-5CLCyKb8.js";
