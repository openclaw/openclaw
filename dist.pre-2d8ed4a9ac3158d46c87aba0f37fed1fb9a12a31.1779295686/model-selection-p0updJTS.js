...
import { f as parseConfiguredModelVisibilityEntries, r as buildConfiguredModelCatalog } from "./model-selection-shared-C0W6f8jq.js";
import { n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-B3eh25eT.js";
import { d as resolveReasoningDefault, l as resolvePersistedOverrideModelRef, m as resolveThinkingDefault } from "./model-selection-DCMPulC-.js";
...
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-C0aTb3TJ.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-PAx1CnLR.js";
import "./model-selection-directive-DlcGxPot.js";
	...
	if (sessionEntry && sessionStore && sessionKey && directStoredOverride && !hasOneTurnModelOverride) {
		...
		if (staleHeartbeatAutoFallbackOverride || !visibilityPolicy.allowsKey(key)) {
			...
			if (updated) {
				...
				if (storePath) await runtime.updateSessionStore(storePath, (store) => {
