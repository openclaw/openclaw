...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-CUDhYq-w.js";
import { a as createActionGate } from "./common-BRnn7Owx.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-DzU-bs8l.js";
import { n as getSessionBindingService } from "./session-binding-service-BW6zmmDL.js";
import "./string-coerce-runtime-Cf3fhT3Z.js";
import { n as describeAccountSnapshot } from "./account-helpers-BTFA7Jt-.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-Cuiiy1ZS.js";
import "./channel-core-DrLpYp9h.js";
import { r as buildSecretInputSchema } from "./secret-input-C5gh_kHA.js";
import { t as formatAllowFromLowercase } from "./allow-from-De2iiggH.js";
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-Cpup5scq.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CpmQS8bN.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BHO58ie_.js";
import { t as createSetupTranslator } from "./i18n-e7Eoj7B-.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DOPSDIHa.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Csewe3pX.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-aI0tR4MP.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-z4reajtx.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-C6RrPfDn.js";
import { n as createFeishuSendReceipt } from "./send-result-Bw6JI2VU.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-D22ikRBw.js";
import { t as messageActionTargetAliases } from "./security-audit-BmuZmAm5.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-BJnhWFqe.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-xDuoQuYw.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-BhKK0Fz_.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-CSbA3czG.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-B16OR1iw.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-B16OR1iw.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-D20YmXiD.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-AiDBgLG8.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-E4R8ilT6.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-DXMdom0M.js");
