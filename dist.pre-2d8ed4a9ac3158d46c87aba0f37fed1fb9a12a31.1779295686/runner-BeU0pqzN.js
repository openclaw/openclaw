...
import { i as runExec } from "./exec-ByXDKomR.js";
import "./local-file-access-BQ4lumbi.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-BjHvxzTf.js";
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-CtIyN_Xz.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-zz7c-ujS.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-yz-8bW7c.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-sw9BTJrA.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-Dvdvowun.js";
import { t as providerSupportsCapability } from "./provider-supports-C-mWPwZJ.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-DPJ0_jD2.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-43X36FwT.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-C2GOPNCv.js";
import { t as buildRandomTempFilePath } from "./temp-download-CuvIUOyJ.js";
import "./temp-path--gpaY1Sz.js";
import { a as runCliEntry, c as extractGeminiResponse, d as isMediaUnderstandingSkipError, l as fileExists, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as MediaUnderstandingSkipError } from "./runner.entries-COb8iHSc.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-xD8je95D.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-BUnGI-t9.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BsSp0d_Q.js");
