...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-CzAHHfJN.js";
import { r as resolveCrestodianOperation } from "./dialogue-DxHdt6nZ.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-D28KF-bE.js")).runCrestodianTui;
	opts.onReady?.();
