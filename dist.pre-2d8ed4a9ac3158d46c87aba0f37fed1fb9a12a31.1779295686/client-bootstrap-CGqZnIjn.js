...
import { t as getActiveMatrixClient } from "./active-client-NZdooGNW.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CNkvTb-l.js"), import("./shared-BBnr7ZlW.js")]).then(([clientModule, sharedModule]) => ({
