...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-wct0i6B_.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BuKrT2wm.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-Dn3XTR_G.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-SvWHK9cF.js";
...
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-Cq-u8i4x.js";
...
import { n as deliveryContextFromSession, o as normalizeDeliveryContext } from "./delivery-context.shared-DgOflY-N.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-_BPRx1WO.js";
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-Pm7UPztK.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-no9ipK4H.js";
import { n as resolveSessionConversationRef } from "./session-conversation-B9TN0iuQ.js";
...
import { u as extractDeliveryInfo } from "./sessions-CIOmZmEg.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-BjHvxzTf.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-Dx2yuCyh.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-DCMPulC-.js";
...
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-CKoZpOSv.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-5BEdQll4.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-lpM2XruD.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-W2OVTL7X.js";
import "./tool-policy-C77bFH_x.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-uvUjm3hM.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-BO3kog2o.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-Dk3NUiXH.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, r as SUBAGENT_SPAWN_CONTEXT_MODES, t as spawnSubagentDirect } from "./subagent-spawn-BtUdYRaW.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BOZWQGil.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-D1sj-4RF.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-CGhzI6Oj.js";
import { n as extractTextFromChatContent } from "./chat-content-B94z5Urn.js";
import { r as stripToolMessages } from "./chat-history-text-Ceh_a4Jm.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-zYX3Qqdt.js";
...
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-Ba8jD5Nn.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-0l161xdu.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CAyQB3yK.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-DrKUBSPi.js";
...
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-D_koarbB.js";
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-CMwWMYxr.js";
import { t as canonicalizeBase64 } from "./base64-1lVHZvDm.js";
import { c as getImageMetadata } from "./media-services-BgpAcVAA.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-B-4Zrxl5.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-Y2m8bekN.js";
import { a as resolvePluginTools } from "./tools--gbf5QL6.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-OKdbzlx0.js";
import { _ as listChannelSupportedActions, c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, h as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-Kf_EY49N.js";
...
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-BRnn7Owx.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BBQ1yjrG.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-BgIvZCLr.js";
import { n as extractAssistantText } from "./pi-embedded-utils-DTKCVi8i.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-C0fPxOwK.js";
import { n as runWithImageModelFallback } from "./model-fallback-BPmquqfK.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DmjyRZH3.js";
import "./delivery-context-D8B_mj40.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BQ39n62s.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-CXcf51ue.js";
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-CIUW5JZh.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-3vc481TX.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-CTnYqJl9.js";
...
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-Ag0Ny_FM.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BHv5o4zC.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-CZpozU73.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BXSBUP-O.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BEGMc40Y.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BDWmX38c.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-B1CP0XVJ.js";
import { u as saveMediaBuffer } from "./store-BdEF_wzT.js";
import { t as SsrFBlockedError } from "./ssrf-B0JFVjDl.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-CihGpZTg.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-C5QmHe7w.js";
import { r as getDefaultLocalRoots } from "./local-media-access-AQ95S6CC.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CWsZqtbP.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Byz_-Juj.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-BvAF_45X.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DrK_O8_-.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-C1d28qQE.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-aicppgmm.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CX_WPaUB.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DQq-lsdJ.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DW63813h.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-Dvdvowun.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-D6CfEeo2.js";
import { s as resolveTimeoutMs } from "./resolve-DPJ0_jD2.js";
import { t as buildProviderRegistry } from "./runner-BeU0pqzN.js";
import "./media-understanding-CzDig4WW.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-B4k57u4o.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CFngORWK.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CRnPt5LL.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-CJlqDo0-.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-CsyMc2C2.js";
import { t as parseTimeoutMs } from "./parse-timeout-BRg-Q0s9.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-Ccp4yBS-.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-C-IBHB9X.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-X5zJQyiq.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CpWoC6Tj.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-B-IEQ38R.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-CB91pHbW.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DC9ultmN.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-CnMdP0ap.js";
import { p as registerSubagentRun } from "./subagent-registry-DAKbh5N4.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-C-Z2VfqZ.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-Bd5fqGrT.js";
import { k as textToSpeech } from "./tts-runtime-Dx6CDcWv.js";
import "./tts-i28amsRq.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-CmYR59jD.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-Bb76yj6r.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DHoZF9pR.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-CzAjXWED.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-Rf6iELji.js";
import { i as runWebSearch } from "./runtime-DQLjDTZR.js";
import "./web-search-provider-common-CzVFLtIx.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-DZKNtHxH.js");
		await sendMessage({
			cfg: params.config,
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-D2U9YCvT.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-DaiXP8Y3.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-CNTvkQNh.js"));
