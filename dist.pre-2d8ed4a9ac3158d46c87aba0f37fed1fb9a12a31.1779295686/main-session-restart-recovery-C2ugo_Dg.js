...
import { i as resolveSessionFilePath, s as resolveSessionTranscriptPathInDir } from "./paths-_BPRx1WO.js";
import { t as loadSessionStore } from "./store-load-Pm7UPztK.js";
import { s as updateSessionStore } from "./store-BsgW6uVr.js";
import { t as resolveAgentSessionDirs } from "./session-dirs-D3FIqo37.js";
...
import { m as resolveGatewaySessionStoreTarget } from "./session-utils-0l161xdu.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-BaapXsqw.js";
...
async function markRestartAbortedMainSessions(params) {
	...
	for (const storePath of storePaths) await updateSessionStore(storePath, (store) => {
...
//#endregion
export { scheduleRestartAbortedMainSessionRecovery as i, markRestartAbortedMainSessionsFromLocks as n, recoverRestartAbortedMainSessions as r, markRestartAbortedMainSessions as t };
