...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-SvWHK9cF.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-CKOdm8XK.js";
import { l as getTotalQueueSize } from "./command-queue-DC9ylpv7.js";
import { r as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-Jph91ebG.js";
...
import { r as resetDirectoryCache } from "./target-resolver-CiEQRdlN.js";
...
import { _ as resolveHooksConfig } from "./hooks-C3lEhpY7.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-DRG8091b.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BWt8q1EJ.js";
...
import { t as buildGatewayCronService } from "./server-cron-NMSxKK10.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CpTpKOus.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DAICRec8.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-CZSJ4ilH.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-D_OgaTTJ.js"), import("./gmail-watcher-lifecycle-B5q4pSsR.js")]);
