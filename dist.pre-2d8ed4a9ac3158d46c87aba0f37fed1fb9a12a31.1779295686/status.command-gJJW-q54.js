...
import { o as readRestartSentinel } from "./restart-sentinel-Ag0Ny_FM.js";
...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-CiH4He3J.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-C8dGtCO6.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-CNzAjfDx.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-BeiBWRaN.js"));
const statusGatewayConnectionRuntimeLoader = createLazyImportLoader(() => import("./status.gateway-connection.runtime.js"));
const statusNodeModeModuleLoader = createLazyImportLoader(() => import("./status.node-mode-6f9d7mcr.js"));
