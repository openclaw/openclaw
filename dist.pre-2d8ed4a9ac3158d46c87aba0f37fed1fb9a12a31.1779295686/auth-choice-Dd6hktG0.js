...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-CKoZpOSv.js";
import { n as loadModelCatalog } from "./model-catalog-CKOdm8XK.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-Bu6_o8KX.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-C1TuzCKN.js";
import "./provider-auth-choice-preference-5JOu67AW.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-BB8MmRPS.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-kn-BciJV.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-DrR1vse3.js");
