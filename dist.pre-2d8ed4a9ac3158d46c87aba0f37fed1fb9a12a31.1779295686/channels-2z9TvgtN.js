...
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-Dn3XTR_G.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-no9ipK4H.js";
...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-OKdbzlx0.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Dc9wbfr4.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-B1IM5IVe.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-Cw1V9qa9.js";
import { t as WizardCancelledError } from "./prompts-wRHNFQjk.js";
import { t as createClackPrompter } from "./clack-prompter-CIR5kJ9P.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-DZ8V7tfr.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-BOJIIyUg.js";
import { n as resolveLogFile } from "./log-tail-DxnwIPWD.js";
import { t as parseLogLine } from "./parse-log-line-CU8QkGAa.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-DPHQ0q1O.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-Yxp5cj0d.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-DLN5WXDb.js";
import { t as channelsListCommand } from "./list-DYwjr8VF.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-Dk1JhOX8.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-DrelESNq.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels--kxNt0dd.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-CYGm0nWN.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-fItssGf9.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-B-NmMQC2.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-BGjoLu6o.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-7rnlvUaQ.js");
