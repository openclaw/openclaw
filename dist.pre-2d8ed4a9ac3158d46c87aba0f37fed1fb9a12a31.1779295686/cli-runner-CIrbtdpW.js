...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Cd2Qar9Y.js";
import "./tokens-CkE1CgsH.js";
import "./pi-embedded-helpers-Dha-TJ7m.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-BssMvzbV.js";
import { p as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-BMiLITPy.js";
import { c as resolveFailoverStatus, i as isFailoverError, t as FailoverError } from "./failover-error-CqnFlOWd.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-BLsqyVuM.js";
import { i as loadCliSessionHistoryMessages, o as buildAgentHookConversationMessages, r as loadCliSessionContextEngineMessages } from "./session-history-Bf4Zw1Qa.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-Da8MMMak.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-DO8uz-1x.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-ClUttY8C.js");
...
async function runPreparedCliAgent(context) {
	...
	const executeCliAttempt = async (cliSessionIdToUse) => {
		...
		if (!assistantText) throw new FailoverError("CLI backend returned an empty response.", {
