...
import { t as createMessageReceiptFromOutboundResults } from "./receipt-CxgO04J-.js";
import { n as normalizePollInput } from "./polls-CTmt9f_N.js";
import "./string-coerce-runtime-Cf3fhT3Z.js";
import { t as requireRuntimeConfig } from "./plugin-config-runtime-Cognmgu-.js";
import { t as loadOutboundMediaFromUrl } from "./outbound-media-BCrmNTg6.js";
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-B27SYfRv.js";
import "./channel-message-Ds8UNA42.js";
import "./text-autolink-runtime-5zi4z5Dt.js";
import { t as require_src } from "./src-C9yo5shH.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-B2auaz9D.js";
import { a as resolveMatrixAccountConfig } from "./account-config-XjUjnAdd.js";
import { t as getMatrixRuntime } from "./runtime-Ifu6t3S5.js";
import { r as buildMatrixReactionContent } from "./reaction-common-DzwB759X.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-Bb2243Df.js";
import { t as fromBuffer } from "./lib-D8SSb8_G.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-yOZ2LG4B.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BHHE2Hzu.js";
import { l as toRatio, n as decodeString } from "./Util-CfMXUxIg.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CzVhMQc3.js";
import { t as APEv2Parser } from "./APEv2Parser-294JcKfU.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DVwPdXM9.js";
import { i as isStrictDirectRoom } from "./direct-room-CatrxYxV.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-FcCgxULd.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-B2Wv67XQ.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CTOEDp29.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-C8czDCnu.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CEUxI7FO.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DaIdxrfm.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DbvULNzw.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BnQoTBQ7.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Hx07_Y6t.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BAMf6qcF.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BP8N_6ZI.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-I_aK_ZtR.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-Q5RAqd28.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-zU-riTBu.js")).WaveParser;
	}
};
//#endregion
