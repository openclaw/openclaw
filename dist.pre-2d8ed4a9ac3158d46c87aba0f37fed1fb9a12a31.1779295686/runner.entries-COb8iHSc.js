...
import { E as pathExists, i as writeExternalFileWithinRoot } from "./fs-safe-D4r8mUJk.js";
...
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-BKu6Cxh9.js";
import { y as runFfmpeg } from "./media-services-BgpAcVAA.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-sw9BTJrA.js";
import { t as describeImageWithModel } from "./image-runtime-DW63813h.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-Dvdvowun.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-DPJ0_jD2.js";
import { n as providerOperationRetryConfig } from "./operation-retry-DBQGS-UC.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BrzYpLaB.js";
import { t as applyTemplate } from "./templating-C97IUPRc.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-BypAsJtJ.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-BUnGI-t9.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-BsSp0d_Q.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
...
//#endregion
export { runCliEntry as a, extractGeminiResponse as c, isMediaUnderstandingSkipError as d, normalizeDecisionReason as i, fileExists as l, findDecisionReason as n, runProviderEntry as o, formatDecisionSummary as r, summarizeDecisionReason as s, buildModelDecision as t, MediaUnderstandingSkipError as u };
