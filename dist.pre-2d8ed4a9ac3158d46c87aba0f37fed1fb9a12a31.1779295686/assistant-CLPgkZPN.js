...
import { n as extractAssistantText } from "./pi-embedded-utils-DTKCVi8i.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-YxNm88MJ.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-nl58VGL7.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-BQWDjoMy.js")).runEmbeddedPiAgent;
}
