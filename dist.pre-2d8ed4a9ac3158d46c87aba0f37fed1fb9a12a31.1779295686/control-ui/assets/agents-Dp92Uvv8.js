import{$ as e,B as t,F as n,G as r,H as i,I as a,J as o,K as s,L as c,M as l,N as u,P as d,R as f,U as p,V as m,W as h,_ as g,a as _,b as v,g as y,h as b,it as x,j as S,k as C,n as w,nt as T,q as ee,r as E,rt as D,t as O,tt as k,x as te,y as A,z as j}from"./index-BjN3iqg_.js";import{r as M}from"./channel-config-extras-Du9QykMc.js";import{i as ne,n as N,r as re,t as ie}from"./skills-shared-sjj1h3Rm.js";var ae=A(class extends v{constructor(){super(...arguments),this.key=D}render(e,t){return this.key=e,t}update(e,[t,n]){return t!==this.key&&(te(e),this.key=t),n}});function oe(e){let{agent:n,configForm:r,agentFilesList:a,configLoading:o,configSaving:s,configDirty:c,onConfigReload:l,onConfigSave:d,onModelChange:g,onModelFallbacksChange:_,onSelectPanel:v}=e,y=!!(e.defaultId&&n.id===e.defaultId),b=t(r,n.id),S=n.model,C=(a&&a.agentId===n.id?a.workspace:null)||b.entry?.workspace||b.defaults?.workspace||n.workspace||`default`,w=b.entry?.model?p(b.entry?.model):b.defaults?.model?p(b.defaults?.model):p(S),T=m(n.agentRuntime),ee=p(b.defaults?.model??S),E=h(b.entry?.model),O=h(b.defaults?.model)||(ee===`-`?null:f(ee))||(r?null:h(S)),te=E??O??null,A=y?te:E,M=i(b.entry?.model)??i(b.defaults?.model)??(r?null:i(S))??[],ne=Array.isArray(b.entry?.skills)?b.entry?.skills:null,N=ne?.length??null,re=!r||o||s,ie=e=>{let t=M.filter((t,n)=>n!==e);_(n.id,t)};return x`
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${ne?`${N} selected`:`all skills`}</div>
        </div>
      </div>
      ...
      <div class="agent-model-select" style="margin-top: 20px;">
        ...
        <div class="agent-model-fields">
          <label class="field">
            ...
            >
              ${y?x` <option value="" ?selected=${!A}>Not set</option> `:x`
                    <option value="" ?selected=${!A}>
                      ${O?`Inherit default (${O})`:`Inherit default`}
                    </option>
                  `}
              ${u(r,te??void 0,e.modelCatalog,A)}
            </select>
          </label>
          <div class="field">
            <span>Fallbacks</span>
            ...
            >
              ...
              <input
                ?disabled=${re}
                placeholder=${M.length===0?`provider/model`:``}
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let r=j(t.value);r.length>0&&(_(n.id,[...M,...r]),t.value=``)}}}
                @blur=${e=>{let t=e.target,r=j(t.value);r.length>0&&(_(n.id,[...M,...r]),t.value=``)}}
              />
            </div>
          </div>
        </div>
...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+q(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function $(e,t){return Q.parse(e,t)}$.options=$.setOptions=function(e){return Q.setOptions(e),$.defaults=Q.defaults,Ae($.defaults),$},$.getDefaults=ke,$.defaults=L,$.use=function(...e){return Q.use(...e),$.defaults=Q.defaults,Ae($.defaults),$},$.walkTokens=function(e,t){return Q.walkTokens(e,t)},$.parseInline=Q.parseInline,$.Parser=X,$.parser=X.parse,$.Renderer=Vt,$.TextRenderer=Ht,$.Lexer=Y,$.lexer=Y.lex,$.Tokenizer=Bt,$.Hooks=Z,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,X.parse,Y.lex;function Ut(e){let t=e.trim();return t?t.split(/\s+/).length:0}function Wt(e){return e.length===0?0:e.split(/\r?\n/).length}function Gt(e){return e<=0?k(`agents.files.emptyDraft`):k(`agents.files.minRead`,{count:String(Math.max(1,Math.round(e/220)))})}function Kt(e){let t=e.split(`.`).pop()?.trim().toLowerCase();return t===`md`||t===`markdown`?k(`agents.files.markdownPreview`):t?k(`agents.files.extensionPreview`,{ext:t.toUpperCase()}):k(`agents.files.preview`)}function qt(e,t){let n=e.trim(),r=t?.trim();if(!n)return``;if(r&&n===r)return`.`;if(r&&n.startsWith(`${r}/`))return n.slice(r.length+1)||`.`;let i=n.split(/[\\/]+/);for(let e=i.length-1;e>=0;--e){let t=i[e];if(t)return t}return n}function Jt(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`preview`}function Yt(e,t){if(!(e instanceof HTMLElement))return;let n=k(t?`agents.files.collapsePreview`:`agents.files.expandPreview`);e.classList.toggle(`is-fullscreen`,t),e.setAttribute(`aria-pressed`,String(t)),e.setAttribute(`aria-label`,n),e.setAttribute(`title`,n)}function Xt(e,t,n){return x`
    ...
    <section class="grid grid-cols-2">
      ...
      <section class="card">
        ...
        <div class="muted" style="margin-top: 8px;">
          ${k(`agents.channels.lastRefresh`,{time:n})}
        </div>
        ${e.error?x`<div class="callout danger" style="margin-top: 12px;">${e.error}</div>`:D}
        ${e.snapshot?D:x`
              <div class="callout info" style="margin-top: 12px">
                ${k(`agents.channels.loadHint`)}
              </div>
            `}
        ${t.length===0?x` <div class="muted" style="margin-top: 16px">${k(`agents.channels.empty`)}</div>`:x`
              <div class="list" style="margin-top: 16px;">
                ${t.map(t=>{let n=en(t.accounts),r=n.total?k(`agents.channels.connectedCount`,{connected:String(n.connected),total:String(n.total)}):k(`agents.channels.noAccounts`),i=n.configured?k(`agents.channels.configuredCount`,{count:String(n.configured)}):k(`agents.channels.notConfigured`),a=n.total?k(`agents.channels.enabledCount`,{count:String(n.enabled)}):k(`common.disabled`),o=M({configForm:e.configForm,channelId:t.id,fields:$t});return x`
                    <div class="list-item">
                      <div class="list-main">
                      ...
                      <div class="list-meta">
                        ...
                        ${n.configured===0?x`
                            ...
                            `:D}
                        ${o.length>0?o.map(e=>x`<div>${e.label}: ${e.value}</div>`):D}
                      </div>
                    </div>
                  `})}
              </div>
  ...
  `}function nn(e){let t=e.jobs.filter(t=>t.agentId===e.agentId);return x`
    <section class="grid grid-cols-2">
      ${Xt(e.context,k(`agents.context.schedulingSubtitle`),e.onSelectPanel)}
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
            <div class="card-title">${k(`agents.cronPanel.schedulerTitle`)}</div>
            <div class="card-sub">${k(`agents.cronPanel.schedulerSubtitle`)}</div>
          </div>
          <button class="btn btn--sm" ?disabled=${e.loading} @click=${e.onRefresh}>
            ${e.loading?k(`common.refreshing`):k(`common.refresh`)}
          </button>
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          <div class="stat">
            <div class="stat-label">${k(`common.enabled`)}</div>
            <div class="stat-value">
              ${e.status?e.status.enabled?k(`common.yes`):k(`common.no`):k(`common.na`)}
            </div>
          </div>
          <div class="stat">
            <div class="stat-label">${k(`agents.cronPanel.jobs`)}</div>
            <div class="stat-value">${e.status?.jobs??k(`common.na`)}</div>
          </div>
          <div class="stat">
            <div class="stat-label">${k(`agents.cronPanel.nextWake`)}</div>
    ...
    <section class="card">
      <div class="card-title">${k(`agents.cronPanel.agentJobsTitle`)}</div>
      <div class="card-sub">${k(`agents.cronPanel.agentJobsSubtitle`)}</div>
      ${t.length===0?x` <div class="muted" style="margin-top: 16px">${k(`agents.cronPanel.noJobs`)}</div>`:x`
            <div class="list" style="margin-top: 16px;">
              ${t.map(t=>x`
                  <div class="list-item">
                    <div class="list-main">
                      <div class="list-title">${t.name}</div>
                      ${t.description?x`<div class="list-sub">${t.description}</div>`:D}
                      <div class="chip-row" style="margin-top: 6px;">
                        <span class="chip">${w(t)}</span>
                        <span class="chip ${t.enabled?`chip-ok`:`chip-warn`}">
                          ${t.enabled?k(`common.enabled`):k(`common.disabled`)}
                        </span>
                        <span class="chip">${t.sessionTarget}</span>
                      </div>
                    </div>
                    <div class="list-meta">
                      <div class="mono">${E(t)}</div>
  ...
  `}function rn(e){let t=e.agentFilesList?.agentId===e.agentId?e.agentFilesList:null,n=t?.files??[],r=e.agentFileActive??null,i=r?n.find(e=>e.name===r)??null:null,a=r?e.agentFileContents[r]??``:``,o=r?e.agentFileDrafts[r]??a:``,s=r?o!==a:!1,c=i?De($.parse(o,{gfm:!0,breaks:!0}),{sanitize:e=>b.sanitize(e)}):``,l=d(new TextEncoder().encode(o).length),u=Ut(o),f=Wt(o),p=i?qt(i.path,t?.workspace):``,m=i?`agent-file-preview-title-${Jt(i.name)}`:``,h=i?.missing?k(`agents.files.willCreateOnSave`):k(s?`agents.files.liveDraftPreview`:`agents.files.savedPreview`),_=i?.missing?`is-missing`:s?`is-dirty`:`is-synced`,v=i?.updatedAtMs?k(`agents.files.updated`,{time:C(i.updatedAtMs)}):i?.missing?k(`agents.files.notCreatedYet`):k(`agents.files.updatedUnknown`);return x`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          <div class="card-title">${k(`agents.files.coreFilesTitle`)}</div>
          <div class="card-sub">${k(`agents.files.coreFilesSubtitle`)}</div>
        </div>
        <button
          class="btn btn--sm"
      ...
      ${t?x`<div class="muted mono" style="margin-top: 8px;">
            ${k(`agents.files.workspace`)}: <span>${t.workspace}</span>
          </div>`:D}
      ${e.agentFilesError?x`<div class="callout danger" style="margin-top: 12px;">
            ${e.agentFilesError}
          </div>`:D}
      ${t?n.length===0?x` <div class="muted" style="margin-top: 16px">${k(`agents.files.empty`)}</div> `:x`
              <div class="agent-tabs" style="margin-top: 14px;">
                ${n.map(t=>{let n=r===t.name,i=t.name.replace(/\.md$/i,``);return x`
                    ...
                    >
                      ${i}${t.missing?x` <span class="agent-tab-badge">${k(`agents.files.missing`)}</span> `:D}
                    </button>
                  `})}
              </div>
              ${i?x`
                    <div class="agent-file-header" style="margin-top: 14px;">
                      ...
                      <div class="agent-file-actions">
                        <button
                          class="btn btn--sm"
                          title=${k(`agents.files.previewMarkdownTitle`)}
                      ...
                      <div class="md-preview-dialog__panel">
                        <div class="md-preview-dialog__header">
                          ...
                          <div class="md-preview-dialog__actions">
                            <button
                              ...
                              title=${k(`agents.files.expandPreview`)}
                            ...
                            <button
                              type="button"
                              class="btn btn--sm md-preview-icon-btn"
                              title=${k(`agents.files.closePreview`)}
                        ...
                        <div class="md-preview-dialog__meta">
                          ...
                          <div class="md-preview-dialog__chip">
                            <strong>${Gt(u)}</strong>
                            <span
                              >${k(`agents.files.words`,{count:String(u)})}</span
                            >
                          </div>
                          <div class="md-preview-dialog__chip">
                            <strong>${f}</strong>
  ...
  `}function on(e,t){let n=t.source??e.source,r=t.pluginId??e.pluginId,i=[];return n===`plugin`&&r?i.push(`Plugin: ${r}`):n===`core`&&i.push(`Built-In`),t.optional&&i.push(`Optional`),i}function sn(e){let t=on(e.section,e.tool);return e.activeEntry&&t.unshift(`Live Now`),t}function cn(e){return e.denied?`Disabled by agent override.`:e.allowed&&e.baseAllowed?`Enabled by the current profile.`:e.allowed?`Enabled by agent override.`:`Not included in the current profile.`}function ln(e,t){let n=t.source??e.source,r=t.pluginId??e.pluginId;return n===`plugin`&&r?`Plugin: ${r}`:`Built-In`}function un(e){return e.denied?`Override Off`:e.allowed&&e.baseAllowed?`Enabled`:e.allowed?`Override On`:`Profile Off`}function dn(e){return e.activeEntry?`Live Now`:e.runtimeSessionMatchesSelectedAgent?`Not Live`:`Other Agent`}function fn(e){return`agent-tool-${o(e).replace(/[^a-z0-9_-]+/g,`-`)}`}function pn(e,t,n=`${t}s`){return`${e} ${e===1?t:n}`}function mn(e){return(e??[]).flatMap(e=>e.tools)}var hn=12;function gn(e){let t=e.currentTarget;if(!(!(t instanceof HTMLDetailsElement)||t.open))for(let e of t.querySelectorAll(`.agent-tool-card[open]`))e.open=!1}function _n(e,t){let n=document.getElementById(t);if(!(n instanceof HTMLDetailsElement))return;e.preventDefault();let r=n.closest(`.agent-tools-group`);r&&(r.open=!0),n.open=!0;let i=new URL(window.location.href);i.hash=t,window.history.replaceState(null,``,i),requestAnimationFrame(()=>{let e=typeof window.matchMedia==`function`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;n.scrollIntoView?.({block:`center`,behavior:e?`auto`:`smooth`}),n.querySelector(`summary`)?.focus()})}function vn(e){return e.source===`plugin`?e.pluginId?k(`agentTools.connectedSource`,{id:e.pluginId}):k(`agentTools.connected`):e.source===`channel`?e.channelId?k(`agentTools.channelSource`,{id:e.channelId}):k(`agentTools.channel`):k(`agentTools.builtIn`)}function yn(e){let i=t(e.configForm,e.agentId),c=i.entry?.tools??{},l=i.globalTools??{},u=c.profile??l.profile??`full`,d=s(e.toolsCatalogResult),f=ee(e.toolsCatalogResult),p=c.profile?`agent override`:l.profile?`global default`:`default`,m=Array.isArray(c.allow)&&c.allow.length>0,h=Array.isArray(l.allow)&&l.allow.length>0,g=!!e.configForm&&!e.configLoading&&!e.configSaving&&!m&&!(e.toolsCatalogLoading&&!e.toolsCatalogResult&&!e.toolsCatalogError),_=m?[]:Array.isArray(c.alsoAllow)?c.alsoAllow:[],v=m?[]:Array.isArray(c.deny)?c.deny:[],y=m?{allow:c.allow??[],deny:c.deny??[]}:r(u)??void 0,b=f.flatMap(e=>e.tools.map(e=>e.id)),S=e=>{let t=n(e,y),r=a(e,_),i=a(e,v);return{allowed:(t||r)&&!i,baseAllowed:t,denied:i}},C=b.filter(e=>S(e).allowed).length,w=e.runtimeSessionMatchesSelectedAgent&&!e.toolsEffectiveError?mn(e.toolsEffectiveResult?.groups):[],T=Array.from(new Map(w.map(e=>[o(e.id),e])).values()),E=T.slice(0,hn),O=Math.max(0,T.length-E.length),te=T.length,A=new Map(w.map(e=>[o(e.id),e])),j=new Set(A.keys()),M=e=>e.toSorted((e,t)=>{let n=o(e.id),r=o(t.id),i=+!!j.has(n),a=+!!j.has(r);if(i!==a)return a-i;let s=+!!S(e.id).allowed,c=+!!S(t.id).allowed;return s===c?e.label.localeCompare(t.label):c-s}),ne=(t,n)=>{let r=new Set(_.map(e=>o(e)).filter(e=>e.length>0)),i=new Set(v.map(e=>o(e)).filter(e=>e.length>0)),a=S(t).baseAllowed,s=o(t);n?(i.delete(s),a||r.add(s)):(r.delete(s),i.add(s)),e.onOverridesChange(e.agentId,[...r],[...i])},N=t=>{let n=new Set(_.map(e=>o(e)).filter(e=>e.length>0)),r=new Set(v.map(e=>o(e)).filter(e=>e.length>0));for(let e of b){let i=S(e).baseAllowed,a=o(e);t?(r.delete(a),i||n.add(a)):(n.delete(a),r.add(a))}e.onOverridesChange(e.agentId,[...n],[...r])};return x`
    <section class="card">
                    ...
                    `:(e.toolsEffectiveResult?.groups?.length??0)===0?x`
                      ...
                      `:x`
                        <div class="agent-tools-runtime">
                          ${E.map(e=>{let t=fn(e.id);return x`
                              <a
      ...
      <div class="agent-tools-grid">
        ${f.map(t=>{let n=M(t.tools),r=t.tools.filter(e=>S(e.id).allowed).length,i=t.tools.filter(e=>j.has(o(e.id))).length,a=n.slice(0,4),s=Math.max(0,n.length-a.length);return x`
              ...
              <summary class="agent-tools-group__summary">
                <span class="agent-tools-group__summary-main">
                  <span class="agent-tools-group__title">
                    ${t.label}
                    ${t.source===`plugin`&&t.pluginId?x`<span class="agent-pill">Plugin: ${t.pluginId}</span>`:D}
                  </span>
                  <span class="agent-tools-group__preview" aria-label="Tool preview">
                    ${a.map(e=>x`<span class="mono" translate="no" title=${e.label}
                          >${e.label}</span
                        >`)}
                    ${s>0?x`<span>+${s} more</span>`:D}
                  </span>
                </span>
                <span class="agent-tools-group__counts">
                  <span>${pn(t.tools.length,`Tool`)}</span>
                  <span>${pn(r,`Enabled Tool`)}</span>
                  ${i>0?x`<span>${pn(i,`Live Tool`)}</span>`:D}
                </span>
              </summary>
              <div class="agent-tools-list agent-tools-list--stacked">
                ${n.map(n=>{let r=fn(n.id),i=S(n.id),a=A.get(o(n.id))??null,s=n.defaultProfiles??[],c=sn({section:t,tool:n,activeEntry:a}),l=un(i),u=dn({activeEntry:a,runtimeSessionMatchesSelectedAgent:e.runtimeSessionMatchesSelectedAgent});return x`
                      ...
                      <summary class="agent-tool-summary">
                        ...
                        >
                          <input
                            ...
                            @change=${e=>ne(n.id,e.target.checked)}
                          />
  ...
  `}function bn(n){let r=!!n.configForm&&!n.configLoading&&!n.configSaving,i=t(n.configForm,n.agentId),a=Array.isArray(i.entry?.skills)?i.entry?.skills:void 0,o=new Set((a??[]).map(e=>e.trim()).filter(Boolean)),s=a!==void 0,c=!!(n.report&&n.activeAgentId===n.agentId),l=c?n.report?.skills??[]:[],u=e(n.filter),d=u?l.filter(t=>e([t.name,t.description,t.source].join(` `)).includes(u)):l,f=ne(d),p=s?l.filter(e=>o.has(e.name)).length:l.length,m=l.length;return x`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        <div style="min-width: 0;">
          ...
          <div class="card-sub">
            ...
            ${m>0?x`<span class="mono">${p}/${m}</span>`:D}
          </div>
        </div>
        <div class="row" style="gap: 8px; flex-wrap: wrap;">
          ...
          <button class="btn btn--sm" ?disabled=${n.loading} @click=${n.onRefresh}>
            ${n.loading?k(`common.loading`):k(`common.refresh`)}
          </button>
          <button
            class="btn btn--sm primary"
      ...
      ${!c&&!n.loading?x`
          ...
          `:D}
      ${n.error?x`<div class="callout danger" style="margin-top: 12px;">${n.error}</div>`:D}
      ...
      ${d.length===0?x` <div class="muted" style="margin-top: 16px">No skills found.</div> `:x`
            <div class="agent-skills-groups" style="margin-top: 16px;">
              ${f.map(e=>xn(e,{agentId:n.agentId,allowSet:o,usingAllowlist:s,editable:r,onToggle:n.onToggle}))}
            </div>
          `}
    </section>
  `}function xn(e,t){return x`
  ...
  `}function Sn(e,t){let n=t.usingAllowlist?t.allowSet.has(e.name):!0,r=ie(e),i=N(e);return x`
    <div class="list-item agent-skill-row">
      <div class="list-main">
        <div class="list-title">${e.emoji?`${e.emoji} `:``}${e.name}</div>
        <div class="list-sub">${e.description}</div>
        ${re({skill:e})}
        ${r.length>0?x`<div class="muted" style="margin-top: 6px;">Missing: ${r.join(`, `)}</div>`:D}
        ${i.length>0?x`<div class="muted" style="margin-top: 6px;">Reason: ${i.join(`, `)}</div>`:D}
      </div>
      <div class="list-meta">
      ...
      <section class="agents-toolbar">
        <div class="agents-toolbar-row">
          <div class="agents-control-select">
            ...
            >
              ${t.length===0?x` <option value="">${k(`agents.noAgents`)}</option> `:t.map(e=>x`
          ...
          <div class="agents-toolbar-actions">
            ${i?x`
                  ...
                  <button
                    ...
                    title=${n&&i.id===n?k(`agents.alreadyDefaultTitle`):k(`agents.setDefaultTitle`)}
                  >
        ...
        ${e.error?x`<div class="callout danger" style="margin-top: 8px;">${e.error}</div>`:D}
      </section>
      <section class="agents-main">
        ${i?x`
              ${wn(e.activePanel,t=>e.onSelectPanel(t),u)}
              ${e.activePanel===`overview`?ae(i.id,oe({agent:i,basePath:e.basePath,defaultId:n,configForm:e.config.form,agentFilesList:e.agentFiles.list,agentIdentity:e.agentIdentityById[i.id]??null,agentIdentityError:e.agentIdentityError,agentIdentityLoading:e.agentIdentityLoading,configLoading:e.config.loading,configSaving:e.config.saving,configDirty:e.config.dirty,modelCatalog:e.modelCatalog,onConfigReload:e.onConfigReload,onConfigSave:e.onConfigSave,onModelChange:e.onModelChange,onModelFallbacksChange:e.onModelFallbacksChange,onSelectPanel:e.onSelectPanel})):D}
              ${e.activePanel===`files`?rn({agentId:i.id,agentFilesList:e.agentFiles.list,agentFilesLoading:e.agentFiles.loading,agentFilesError:e.agentFiles.error,agentFileActive:e.agentFiles.active,agentFileContents:e.agentFiles.contents,agentFileDrafts:e.agentFiles.drafts,agentFileSaving:e.agentFiles.saving,onLoadFiles:e.onLoadFiles,onSelectFile:e.onSelectFile,onFileDraftChange:e.onFileDraftChange,onFileReset:e.onFileReset,onFileSave:e.onFileSave}):D}
              ${e.activePanel===`tools`?yn({agentId:i.id,configForm:e.config.form,configLoading:e.config.loading,configSaving:e.config.saving,configDirty:e.config.dirty,toolsCatalogLoading:e.toolsCatalog.loading,toolsCatalogError:e.toolsCatalog.error,toolsCatalogResult:e.toolsCatalog.result,toolsEffectiveLoading:e.toolsEffective.loading,toolsEffectiveError:e.toolsEffective.error,toolsEffectiveResult:e.toolsEffective.result,runtimeSessionKey:e.runtimeSessionKey,runtimeSessionMatchesSelectedAgent:e.runtimeSessionMatchesSelectedAgent,onProfileChange:e.onToolsProfileChange,onOverridesChange:e.onToolsOverridesChange,onConfigReload:e.onConfigReload,onConfigSave:e.onConfigSave}):D}
              ${e.activePanel===`skills`?bn({agentId:i.id,report:e.agentSkills.report,loading:e.agentSkills.loading,error:e.agentSkills.error,activeAgentId:e.agentSkills.agentId,configForm:e.config.form,configLoading:e.config.loading,configSaving:e.config.saving,configDirty:e.config.dirty,filter:e.agentSkills.filter,onFilterChange:e.onSkillsFilterChange,onRefresh:e.onSkillsRefresh,onToggle:e.onAgentSkillToggle,onClear:e.onAgentSkillsClear,onDisableAll:e.onAgentSkillsDisableAll,onConfigReload:e.onConfigReload,onConfigSave:e.onConfigSave}):D}
              ${e.activePanel===`channels`?tn({context:l(i,e.config.form,e.agentFiles.list,n,e.agentIdentityById[i.id]??null),configForm:e.config.form,snapshot:e.channels.snapshot,loading:e.channels.loading,error:e.channels.error,lastSuccess:e.channels.lastSuccess,onRefresh:e.onChannelsRefresh,onSelectPanel:e.onSelectPanel}):D}
              ${e.activePanel===`cron`?nn({context:l(i,e.config.form,e.agentFiles.list,n,e.agentIdentityById[i.id]??null),agentId:i.id,jobs:e.cron.jobs,status:e.cron.status,loading:e.cron.loading,error:e.cron.error,onRefresh:e.onCronRefresh,onRunNow:e.onCronRunNow,onSelectPanel:e.onSelectPanel}):D}
            `:x`
              <div class="card">
                <div class="card-title">${k(`agents.selectTitle`)}</div>
                <div class="card-sub">${k(`agents.selectSubtitle`)}</div>
              </div>
            `}
      </section>
    </div>
  `}function wn(e,t,n){return x`
    <div class="agent-tabs">
      ${[{id:`overview`,label:k(`agents.tabs.overview`)},{id:`files`,label:k(`agents.tabs.files`)},{id:`tools`,label:k(`agents.tabs.tools`)},{id:`skills`,label:k(`agents.tabs.skills`)},{id:`channels`,label:k(`agents.tabs.channels`)},{id:`cron`,label:k(`agents.tabs.cronJobs`)}].map(r=>x`
          <button
            class="agent-tab ${e===r.id?`active`:``}"
            type="button"
            @click=${()=>t(r.id)}
          >
            ${r.label}${n[r.id]==null?D:x`<span class="agent-tab-count">${n[r.id]}</span>`}
          </button>
        `)}
    </div>
  `}export{Cn as renderAgents};
//# sourceMappingURL=agents-Dp92Uvv8.js.map