...
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-W2OVTL7X.js";
...
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-BBjW5Z2z.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-B-4Zrxl5.js";
...
import { C as wrapToolWorkspaceRootGuard, E as resolveOpenClawPluginToolsForOptions, S as wrapToolMemoryFlushAppendOnlyWrite, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as createHostWorkspaceAppendTool, p as resolveToolLoopDetectionConfig, t as createOpenClawTools, v as createSandboxedEditTool, w as wrapToolWorkspaceRootGuardWithOptions, x as wrapToolMemoryDayFileWriteGuard, y as createSandboxedReadTool } from "./openclaw-tools-CqeS3c0D.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools--gbf5QL6.js";
import { c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, g as listChannelAgentTools, i as copyBeforeToolCallHookMarker, p as copyChannelAgentToolMeta } from "./pi-tools.before-tool-call-Kf_EY49N.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-BRnn7Owx.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-28QRS8A9.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-BgIvZCLr.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-ZrL2VSwd.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-zqf1v4zs.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-swcC6y1R.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-B--ju2iZ.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-BtdAYvg0.js";
import "./codex-native-web-search-CHKB9zah.js";
import { t as bindAbortRelay } from "./fetch-timeout-C5QmHe7w.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-zz7c-ujS.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-o-Z8XsOg.js"));
