...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-DxVmbF3R.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-vkKYfkZB.js";
...
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-bq_n-Yya.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BJJZZih-.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-C42EJA9N.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-Vgwb9rxr.js");
		emitDoctorNotes({
			note,
