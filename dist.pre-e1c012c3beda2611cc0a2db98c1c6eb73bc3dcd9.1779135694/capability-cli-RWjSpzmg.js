...
import { r as callGateway, u as randomIdempotencyKey } from "./call-CiOX_d7c.js";
...
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-BTle0GRT.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-BGs61_ek.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-BuO_DiqG.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-M8C4Wfot.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-BAAfdy02.js";
...
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-zbriZr8v.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DKxAGJEZ.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-NAjno-_W.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-O4Ch8zzE.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-34zYj0AM.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-CqNyFCkQ.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CB62kknD.js");
