...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-DynBk0jf.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-DacZz4fu.js";
...
import { _ as resolveHooksConfig } from "./hooks-OLM4more.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-B42TBMAT.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DoCzcoku.js";
...
import { t as buildGatewayCronService } from "./server-cron-B3t2appu.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B4w74UjJ.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-21w3-r4F.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-DhKDGjTC.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-BiUbIR5L.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BNZxHstP.js"), import("./gmail-watcher-lifecycle-DfGp_NvI.js")]);
