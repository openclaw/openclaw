...
import { a as logWarn } from "./logger-B-H6-XfD.js";
...
import { i as toRelativeSandboxPath, n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-gvzAeR6d.js";
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-CG69Vfrb.js";
import { a as collectExplicitAllowlist, d as mergeAlsoAllowPolicy, f as replaceWithEffectiveToolAllowlist, l as hasRestrictiveAllowPolicy, o as collectExplicitDenylist, r as applyOwnerOnlyToolPolicy } from "./tool-policy-D10jyOUl.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-BW3iLLB9.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-p9yM-kRv.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-CeU3dZJS.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-VcblLnzc.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./pi-tools.policy-Cw1OC0Le.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-jVjYFP6a.js";
import { C as wrapToolWorkspaceRootGuard, E as resolveOpenClawPluginToolsForOptions, S as wrapToolMemoryFlushAppendOnlyWrite, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as createHostWorkspaceAppendTool, p as resolveToolLoopDetectionConfig, t as createOpenClawTools, v as createSandboxedEditTool, w as wrapToolWorkspaceRootGuardWithOptions, x as wrapToolMemoryDayFileWriteGuard, y as createSandboxedReadTool } from "./openclaw-tools-CWzyUnZy.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-D0odaWb_.js";
import { c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, g as listChannelAgentTools, i as copyBeforeToolCallHookMarker, p as copyChannelAgentToolMeta } from "./pi-tools.before-tool-call-CJkQVq-d.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-B0XXBiTk.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-CNQHCq8Y.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-BbBO3S4w.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-qX7VPzWo.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-lSLLf8II.js";
...
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-CdvxNygC.js";
import "./codex-native-web-search-DZU5VEfy.js";
import { t as bindAbortRelay } from "./fetch-timeout-DtlZ6Uuz.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-D-1cbtbS.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-Nm_vrvsp.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-MB9qiYsI.js"));
