...
import { _ as readStringParam, a as createActionGate, n as ToolAuthorizationError, p as readNumberParam } from "./common-B0XXBiTk.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BV5fnOX9.js";
import "./string-coerce-runtime-DVkpEjUr.js";
import { n as describeAccountSnapshot } from "./account-helpers-BsR7BVoK.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-D9rKEoK-.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-I3FPAipY.js";
import "./channel-core-o3ah7qbg.js";
import "./routing-beWSuMQ2.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-C9e05gYV.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-DGSdjeSR.js";
import "./approval-delivery-runtime-DssNofxq.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-DrRCknw8.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-CeZiEk2Q.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DhhPMkDH.js";
import "./approval-native-runtime-D0ZvjIRs.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DC20QesH.js";
...
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-E1GaFoop.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-Cntdf1K5.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-BCf7yGVs.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DEzF7p3T.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CB6Tqx_X.js";
import { n as normalizeMatrixUserId } from "./allowlist-Cf8eN9X_.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-kP-6eI5Z.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-CrmFZist.js";
...
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-CMPJRr8m.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-CwB4tlKr.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BbfOPya3.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-O_hDPXr-.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-Bm1X_dXc.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-COoRR-vw.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-r5f_L_5E.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-C_Iqpum0.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DVBEahVk.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-B_E6quId.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-B0spbuEe.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-B0spbuEe.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-V7PW2Jc8.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
