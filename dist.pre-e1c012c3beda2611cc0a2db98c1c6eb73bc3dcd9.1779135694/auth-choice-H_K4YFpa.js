...
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-BAOtRZEX.js";
...
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-Dfor4Y2k.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-DIXH3FL_.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-DfIb3jcf.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-BGmbREiI.js");
