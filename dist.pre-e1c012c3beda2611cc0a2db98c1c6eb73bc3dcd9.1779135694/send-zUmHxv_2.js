...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-DEqRD8RY.js";
import "./channel-message-BH4fSx9l.js";
import "./text-autolink-runtime-B6cWs4dw.js";
import { t as require_src } from "./src-BgKInO8k.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-E1GaFoop.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-CuH1hHzM.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-0bC5NdI1.js";
import { t as fromBuffer } from "./lib-RAhX0yYF.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-hos08dmK.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BFoKg_yJ.js";
import { l as toRatio, n as decodeString } from "./Util-CrJP00CF.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-C-cCFTPL.js";
import { t as APEv2Parser } from "./APEv2Parser-kKZGQETK.js";
import { r as hasID3v1Header } from "./ID3v1Parser-HMXV-aOw.js";
import { i as isStrictDirectRoom } from "./direct-room-BIaIIh65.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-gUbqCixc.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CTcDsEvo.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-XofVuIxc.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-T3pQioc_.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BPn5Feg2.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BokWyNvT.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CAIv0bnX.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-agQtCaps.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DU44UNFZ.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-y4EISHIO.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-B73My0lX.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-B0LBBQZn.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-_emSMU1T.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-f3ob50IG.js")).WaveParser;
	}
};
//#endregion
