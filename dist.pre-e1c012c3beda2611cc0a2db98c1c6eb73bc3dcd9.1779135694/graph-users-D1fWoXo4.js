...
import { u as isPrivateIpAddress } from "./ssrf-DzOdS68g.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BXL9fW4_.js";
import "./ssrf-runtime-Dz3vPG0b.js";
import "./security-runtime-Cu_MGTuQ.js";
import "./provider-http-Dtd9wvSZ.js";
import { t as getMSTeamsRuntime } from "./runtime-api-C2J-lf4X.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-S7sgbgez.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-CAb5gs5J.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BgkU60Ju.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-BSponems.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-C0MRmfFN.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
