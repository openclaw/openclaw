...
import { A as resolveSessionStoreEntry, C as parseSessionThreadInfoFast, t as loadSessionStore, y as resolveMaintenanceConfigFromInput } from "./store-load-NR217KeP.js";
...
import { m as deriveSessionMetaPatch, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-DM2Qj4Ie.js";
...
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-k0t5Mzqs.js";
import { n as resolveSessionKey } from "./session-key-myHZ7rdb.js";
import { l as resolveAndPersistSessionFile } from "./transcript-CdlHYvm8.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-BGs61_ek.js";
...
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-DP99HLoJ.js";
...
import { St as isReasoningTagProvider } from "./selection-vgb4-kfR.js";
import { p as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-CUEryMdC.js";
...
import { y as collectTextContentBlocks } from "./attempt.tool-run-context-CPkfTXqF.js";
...
import { t as resolveQueueSettings } from "./queue-De_yhN0d.js";
...
import { l as resolveSilentReplySettings, s as resolveCurrentTurnImages } from "./agent-runner-execution-BsM2C9rX.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BAzb_NrN.js";
import { s as hasInboundMedia } from "./block-reply-pipeline-BTfVhNHx.js";
...
import { r as drainFormattedSystemEventBlock } from "./session-updates-4WHiVGQd.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-BD6FS2NT.js";
...
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-DUzmy0cX.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-CS7hGJVM.js";
...
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-DI1IoWPX.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-D_bHEBzy.js";
...
import { n as resolveSessionAuthProfileOverride } from "./session-override-NdAWhYJY.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-Iqu9Yqx0.js";
...
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BpdEy_Pa.js";
...
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-BGZwcY7A.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-CHX8Rszs.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DCZaijB3.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-C2YTV3c9.js");
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-h-CmlDDj.js");
