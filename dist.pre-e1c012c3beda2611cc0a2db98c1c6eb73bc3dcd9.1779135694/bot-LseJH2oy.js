...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-DdvF1onI.js";
...
import { n as mutateConfigFile } from "./mutate-Bm2-Tz3l.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-_BPRx1WO.js";
...
import { c as appendSessionTranscriptMessage, l as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript } from "./transcript-CdlHYvm8.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-BGs61_ek.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Btk9SdbL.js";
import { h as isInsideCode, m as findCodeRegions, u as stripReasoningTagsFromText } from "./assistant-visible-text-CYv0OsxS.js";
...
import { n as MediaFetchError } from "./fetch-Da3eL7im.js";
...
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-B9TeD1Cb.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-Bp5FfNXu.js";
import { n as createPreviewMessageReceipt } from "./live-jW1Q94R8.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-BV5fnOX9.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-D-Piirct.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-CKaWj9oP.js";
...
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-CgMtZTWq.js";
...
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-ObJuN3V2.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-BJVD4ohc.js";
import "./reply-chunking-BAgWhEEk.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-Nzb9S1Qo.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-ebYmZlO2.js";
import "./conversation-runtime-C40u4C38.js";
import "./text-chunking-C9lv4IbI.js";
import "./agent-runtime-CI5OgG91.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-CAUqPPb0.js";
import "./security-runtime-Cu_MGTuQ.js";
import "./agent-harness-runtime-j3Q1thDv.js";
import "./hook-runtime-D9RZwmkh.js";
import "./markdown-table-runtime-ClyQu78e.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-CHDpoC7z.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-d_hfZ0e-.js";
import "./command-auth-native-ZLTy5vOi.js";
import "./command-primitives-runtime-CHSIStko.js";
import "./command-status-Dzt-rEyu.js";
import "./command-detection-CXyLRcvx.js";
import "./command-surface-BCFAtrdC.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-8oNuYv8u.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-D2osYju-.js";
import { i as resolveUnmentionedGroupInboundPolicy, r as classifyChannelInboundEvent, s as shouldDebounceTextInbound } from "./channel-inbound-DbgdptLr.js";
...
import "./models-provider-runtime-BoUydhal.js";
...
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-DVZM3Q4X.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-Bf5_r5sk.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-BVH6N-hI.js";
import { A as withResolvedTelegramForumFlag, B as resolveTelegramPrimaryMedia, C as resolveTelegramForumFlag, D as resolveTelegramStreamMode, E as resolveTelegramReplyId, F as getTelegramTextParts, G as normalizeDmAllowFromWithStore, H as resolveTelegramDmAllow, I as hasBotMention, K as resolveTelegramEffectiveDmPolicy, M as buildSenderName, N as expandTextLinks, O as resolveTelegramThreadSpec, P as extractTelegramLocation, R as normalizeForwardedContext, S as resolveTelegramDirectPeerId, T as resolveTelegramGroupAllowFromContext, U as isSenderAllowed, V as expandTelegramAllowFromWithAccessGroups, W as normalizeAllowFrom, _ as describeReplyTarget, a as renderTelegramHtmlText, d as buildTelegramGroupPeerId, f as buildTelegramInboundOriginTarget, g as buildTypingThreadParams, h as buildTelegramThreadParams, j as buildSenderLabel, k as shouldUseTelegramDmThreadSession, l as buildGroupLabel, m as buildTelegramRoutingTarget, n as markdownToTelegramChunks, p as buildTelegramParentPeer, u as buildTelegramGroupFrom, v as extractTelegramForumFlag, w as resolveTelegramForumThreadId, x as resolveTelegramCommandAuthorization, y as isTelegramCommandsAllowFromConfigured } from "./format-smm4-tzA.js";
import { t as resolveTelegramInlineButtons } from "./button-types-CUAfZXg3.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-W95CanP1.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CGpNAkUz.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-COpKU4cw.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-C7eWjJYz.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DbC8hX1c.js";
import { A as Bot, C as createTelegramClientFetch, E as resolveTelegramOutboundClientTimeoutFloorSeconds, M as sequentialize, O as withTelegramApiErrorLogging, S as asTelegramClientFetch, T as resolveTelegramClientTimeoutSeconds, a as editMessageTelegram, g as recordSentMessage, j as apiThrottler, k as getOrCreateAccountThrottler, w as resolveTelegramClientTimeoutMinimumSeconds, x as buildInlineKeyboard } from "./send-BOwTCJv-.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-DsEqQgPh.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as createNativeTelegramToolProgressDraft, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands, t as defaultTelegramBotDeps } from "./bot-deps-RfMxwfyy.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-doABT73y.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-N19fTPUG.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-BrChz8s0.js")).defaultTelegramBotDeps;
