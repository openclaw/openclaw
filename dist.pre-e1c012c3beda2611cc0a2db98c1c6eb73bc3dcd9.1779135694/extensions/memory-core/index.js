...
import "../../memory-core-host-runtime-core-BrXh9oN9.js";
import { t as resolveMemoryBackendConfig } from "../../backend-config-CRo8h6Xh.js";
import "../../memory-core-host-runtime-files-sWQNNJWz.js";
import { t as registerShortTermPromotionDreaming } from "../../dreaming-CusAqqvd.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-Dl7AF_ha.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-vGa4KhYO.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-HTugy1ko.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-ZySUetUQ.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-CKf_h4R1.js");
