import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BVlm3DDo.js";
import { r as loadCrestodianOverview } from "./overview-B4arSP2z.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CQy9Gn6g.js")).planCrestodianCommand)({
		input,
		overview
	});
