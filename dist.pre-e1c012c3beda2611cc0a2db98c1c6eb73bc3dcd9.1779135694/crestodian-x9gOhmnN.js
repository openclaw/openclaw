...
import { r as resolveCrestodianOperation } from "./dialogue-MEgKNqAi.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-Bh0s1yrb.js")).runCrestodianTui;
	opts.onReady?.();
