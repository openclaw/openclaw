...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BXL9fW4_.js";
import "./ssrf-runtime-Dz3vPG0b.js";
import "./text-utility-runtime-B64bksiI.js";
import "./runtime-api--GmEqBfs.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-_u8CWsAS.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-DJEYUqPk.js")]);
			return {
