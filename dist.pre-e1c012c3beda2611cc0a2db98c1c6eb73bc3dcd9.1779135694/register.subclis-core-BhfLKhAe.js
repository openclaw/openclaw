...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-oJ6lU_Uq.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-oe4UnIzU.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-fKFs38d3.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-RWjSpzmg.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-BsBGyW29.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-D5fqdM-s.js"),
