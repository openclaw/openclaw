...
import { i as normalizeProviderIdForAuth } from "./provider-id-Cz7K6wgK.js";
...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-giqGaBJo.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-YuMV2PLT.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BlKm_Gw6.js";
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-DQX5R6b3.js";
import { i as buildModelAliasIndex, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-Bd49BLni.js";
import { i as parseModelRef, n as modelKey } from "./model-selection-normalize-DeF75Ytd.js";
import "./model-selection-DZrSRKB-.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DZ3DKDc2.js";
import { t as resolveEnvApiKey } from "./model-auth-env-BCLOjmyc.js";
import { r as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared--Gu-BVM4.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-CWuFZQFj.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-CjTPa2eA.js";
import { n as loadModelsConfigWithSource } from "./load-config-D8AhdN11.js";
import { n as formatErrorWithStack } from "./list.errors-CqqxhGWR.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-DHcipPtp.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-X91ldJai.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-gIOLppL-.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BSpyoloJ.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DQh6iBTO.js"),
		import("./agent-scope-DwXkLiBm.js"),
		import("./workspace-BjB6Mk7v.js")
	]);
