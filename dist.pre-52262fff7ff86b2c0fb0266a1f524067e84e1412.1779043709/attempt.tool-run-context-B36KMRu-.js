...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-DrNAJwj9.js";
...
import { u as isGoogleModelApi } from "./pi-embedded-helpers-CcSfwRhc.js";
...
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-D4XJ9T3m.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-8JSlTqcF.js");
