...
import { c as PATH_ALIAS_POLICIES, o as root } from "./secure-temp-dir-GC3bO7Qi.js";
...
import { a as logWarn } from "./logger-BNE2ki5B.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-DJtqYoTD.js";
import { n as assertSandboxPath } from "./sandbox-paths-BzrLd8AE.js";
import { i as toRelativeSandboxPath, n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-Dump4QO5.js";
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-CpP268Wb.js";
import { a as collectExplicitAllowlist, d as mergeAlsoAllowPolicy, f as replaceWithEffectiveToolAllowlist, l as hasRestrictiveAllowPolicy, o as collectExplicitDenylist, r as applyOwnerOnlyToolPolicy } from "./tool-policy-2a4iBmpL.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-B5Ctmu01.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-BI3E_afW.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-DlqddXdz.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BUzacBuR.js";
import { C as wrapToolWorkspaceRootGuard, E as resolveOpenClawPluginToolsForOptions, S as wrapToolMemoryFlushAppendOnlyWrite, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as createHostWorkspaceAppendTool, p as resolveToolLoopDetectionConfig, t as createOpenClawTools, v as createSandboxedEditTool, w as wrapToolWorkspaceRootGuardWithOptions, x as wrapToolMemoryDayFileWriteGuard, y as createSandboxedReadTool } from "./openclaw-tools-zwY5wSVd.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-IOz5rfvk.js";
import { a as copyBeforeToolCallHookMarker, d as wrapToolWithBeforeToolCallHook, f as copyChannelAgentToolMeta, h as listChannelAgentTools, l as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-bCTtQV1p.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-DnBUyMfY.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-DnpanA0r.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Crodck_P.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-D9PW-JW1.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-CcdrIi4b.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BkVvhIKn.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-BVXsbZYR.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-Do2lOjcO.js";
import "./codex-native-web-search-IfF5soL2.js";
import { t as bindAbortRelay } from "./fetch-timeout-D_VHFANi.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-CHycPDP7.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./pi-tools.policy-D5yx8cA6.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-C_Ijx002.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-DAtEaTWY.js";
...
const MEMORY_FLUSH_ALLOWED_TOOL_NAMES = new Set([
	"read",
	"write",
	"append"
]);
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-DdyzOeqe.js"));
...
function createOpenClawCodingTools(options) {
	...
	const tools = [
		...
		...includeBaseCodingTools && sandboxRoot ? allowWorkspaceWrites ? [workspaceOnly ? wrapToolWorkspaceRootGuardWithOptions(createSandboxedEditTool({
			...
			root: sandboxRoot,
			bridge: sandboxFsBridge
		}), wrapToolMemoryDayFileWriteGuard(workspaceOnly ? wrapToolWorkspaceRootGuardWithOptions(createSandboxedWriteTool({
			root: sandboxRoot,
			bridge: sandboxFsBridge
		...
		...includeCoreTools && !sandboxRoot ? [workspaceOnly ? wrapToolWorkspaceRootGuard(createHostWorkspaceAppendTool(workspaceRoot, { workspaceOnly }), workspaceRoot) : createHostWorkspaceAppendTool(workspaceRoot, { workspaceOnly })] : [],
...
//#endregion
export { TOOL_SEARCH_CODE_MODE_TOOL_NAME as a, addClientToolsToToolCatalog as c, applyToolSearchCatalog as d, clearToolSearchCatalog as f, resolveToolSearchConfig as h, TOOL_DESCRIBE_RAW_TOOL_NAME as i, addClientToolsToToolSearchCatalog as l, projectToolSearchTargetTranscriptMessages as m, resolveProcessToolScopeKey as n, TOOL_SEARCH_RAW_TOOL_NAME as o, createToolSearchCatalogRef as p, TOOL_CALL_RAW_TOOL_NAME as r, ToolSearchRuntime as s, createOpenClawCodingTools as t, applyToolCatalogCompaction as u };
