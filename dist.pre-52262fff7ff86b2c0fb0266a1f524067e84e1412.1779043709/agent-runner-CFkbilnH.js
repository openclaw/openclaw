...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-B7Gl_3a6.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-BxclR8vv.js";
...
import { c as resolveContextConfigProviderForRuntime, l as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-DQX5R6b3.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C1CKCx9N.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-Dw1mJ0j_.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-CzW8tQZJ.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-789ECJN2.js";
import { A as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-BRLw4_SR.js";
import { c as updateSessionStoreEntry, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-CTOVSWL0.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-CmPL5zcY.js";
...
import { l as resolvePersistedOverrideModelRef } from "./model-selection-DZrSRKB-.js";
import { u as resolveModelAuthMode } from "./model-auth-CWuFZQFj.js";
import { f as replyRunRegistry, i as createReplyOperation, t as ReplyRunAlreadyActiveError } from "./reply-run-registry-ob9jzuSv.js";
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-BOMfzUwh.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-DpSdMJa5.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-BwXXap9v.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-xfd465ce.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DOWI15tv.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-CtI5YY4c.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-DufUJdwY.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-BQ1hPeyh.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-2q03qiGF.js";
import { u as stripHeartbeatToken } from "./heartbeat-bWfG25KS.js";
import { r as enqueueCommitmentExtraction } from "./runtime-DkYUCqqy.js";
import { c as emitContinuationWorkSpan, g as startContinuationDelegateSpan, i as emitContinuationDisabledSpan, m as resolveContinuationTraceparent, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-DFGjjapO.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-CD-OLloG.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-CEv7m1qY.js";
import { a as enqueueSystemEvent } from "./system-events-Bff58p0o.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-COgr1nXO.js";
import { n as resolveSendPolicy } from "./send-policy-BiwbAPrT.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-BBKN81VW.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-D7o_YL2y.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-Bfj_UQN-.js";
import { t as checkContextPressure } from "./context-pressure-CJ0-XzXo.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-PJGRds2i.js";
import { a as listLegacyRuntimeModelProviderAliases, s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-DhDX4zbE.js";
...
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-yWJmaeJp.js";
import { t as formatProviderModelRef } from "./model-runtime-C6QUs_MD.js";
import "./fallback-notice-state-BGNi12F-.js";
import { a as copyReplyPayloadMetadata, d as setReplyPayloadMetadata, o as getReplyPayloadMetadata, r as appendReplyMediaFailureWarning, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-bhQ8Bfcq.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-_ZIpTto5.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-DBDFUB1K.js";
...
import { o as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-B3DzDitP.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-C-Ec4P0x.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Dh1zrQPN.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-DFtTyg3X.js";
import { n as hasCotFramePrefix } from "./normalize-reply-CjOjyxKv.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-CgGD3MhV.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-BwY8Hm6C.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CwN_DE9D.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BLijBrni.js";
import "./sandbox-Cz5wMNA6.js";
import { n as readPostCompactionContext } from "./post-compaction-context-BHl-FFx0.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-Bp9YLmTU.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-icABAK9D.js";
import { t as runCliAgent } from "./cli-runner-Bx5vFIOc.js";
import { n as HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT, t as GENERIC_EXTERNAL_RUN_FAILURE_TEXT } from "./agent-runner-failure-copy-BcwSctNZ.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-D3JxJm8K.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-DKH8Gkud.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-C3ooGsMQ.js";
import { n as incrementCompactionCount } from "./session-updates-C5dCmVoP.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-DwHtoVjD.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-D-Az2EUV.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-DwLeBJpx.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-C0idoBnc.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-B7YAiTRP.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-Cpbl-Oua.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-D1QKlrEx.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-HLpWJXOU.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-CQKfgccG.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-3q61SCmy.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-D8rglKor.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BVb5fN7Z.js"),
					import("./config-DCZ_0doh.js"),
					import("./state-jvnJvUYN.js"),
					import("./store-CQYRd0cB.js")
				]);
