...
import { F as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-SttxXabE.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-Dw6gXBzw.js";
import { c as initSubagentRegistry } from "./subagent-registry-CFTjDPlx.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-1C6VTc9F.js";
import { n as listGatewayMethods } from "./server-methods-list-jDJdWdTY.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-Ie3Hapkn.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-CqPkoiIz.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-ByviVjui.js");
