...
import { Et as array, Nn as record, Rn as string, Tn as object, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-Bmna8ihM.js";
...
import { l as createScopedDmSecurityResolver, u as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-CsphHypk.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-zLAY9bah.js";
...
import { t as createDirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-GRKzWvqQ.js";
...
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-Bmoq3Tj9.js";
...
import { t as attachChannelToResult } from "./channel-send-result-CpUMb5te.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-BaO8SEmD.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-Dwr0WG5w.js";
import { t as DEFAULT_RELAYS } from "./default-relays-CHGvjyBa.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-BOPxCN5R.js");
