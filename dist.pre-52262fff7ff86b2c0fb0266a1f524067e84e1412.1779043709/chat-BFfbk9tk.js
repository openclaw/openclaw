...
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-Co5UP2SS.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-B2y1CNV1.js";
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, x as resolveModelRefFromString } from "./model-selection-shared-Bd49BLni.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-CEEDZAwT.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-DEJwwJ3D.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-ZJYncsRS.js";
import { n as resolveSendPolicy } from "./send-policy-BiwbAPrT.js";
import { c as isReplyPayloadTtsSupplement, i as buildTtsSupplementMediaPayload, s as getReplyPayloadTtsSupplement } from "./reply-reference-bhQ8Bfcq.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-_ZIpTto5.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-DNfEhAOv.js";
import { c as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-STUoYGK2.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-Uc5kTVit.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-CHycPDP7.js";
...
import { n as rewriteTranscriptEntriesInSessionFile } from "./context-engine-maintenance-DW1rdTQj.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-C3ooGsMQ.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-7bhh6IMz.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BTTgr4_b.js";
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-CUx9red3.js";
...
import { t as logLargePayload } from "./diagnostic-payload-DwZDXS_g.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-WZly1kUT.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-3cOnPQe2.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-BVc738ca.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-BoNVodfi.js";
import { a as resolveChatAttachmentLooksLikeImage, i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Df_HthOq.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-2mojh_Ad.js";
