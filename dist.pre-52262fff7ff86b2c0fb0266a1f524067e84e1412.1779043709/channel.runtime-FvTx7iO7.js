...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout } from "./reply-payload-_ZIpTto5.js";
import { f as renderMessagePresentationFallbackText } from "./payload-DKsBSWSJ.js";
...
import { a as sendMessageMatrix, l as sendTypingMatrix, o as sendPollMatrix } from "./send-CRPSzxsM.js";
import { t as isBunRuntime } from "./runtime-c-YItwme.js";
import { n as resolveMatrixAuth } from "./config-D9MkYMGv.js";
import "./client-CQioZYrO.js";
import { n as listMatrixDirectoryPeersLive, t as listMatrixDirectoryGroupsLive } from "./directory-live-B9NuQOhy.js";
import "./runtime-api-BEoXU-GO.js";
import { t as resolveMatrixTargets } from "./resolve-targets-BDU9bmls.js";
//#region extensions/matrix/src/matrix/probe.ts
let matrixProbeRuntimeDepsPromise;
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-CGb_Zjqc.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));
