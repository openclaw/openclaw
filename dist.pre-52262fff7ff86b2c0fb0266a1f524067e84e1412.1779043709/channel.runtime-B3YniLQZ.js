...
import "./accounts-DdFgzmsa.js";
import "./runtime-api-DJ3HENpH.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-C__jxyPO.js";
import { t as sendMessageZalo } from "./send-TIldevOI.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-N8pqNctt.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CNAtHXDr.js");
