...
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-3zz2hVyM.js";
import { r as fetchWithTimeout } from "./fetch-timeout-D_VHFANi.js";
import { r as makeProxyFetch } from "./proxy-fetch-CAGV_wZ_.js";
import { t as resolveTelegramAllowedUpdates } from "./allowed-updates-CsPMgndk.js";
import { r as resolveTelegramTransport, t as resolveTelegramApiBase } from "./fetch-CwZWV8-2.js";
...
import { i as isRecoverableTelegramNetworkError, s as isTelegramPollingNetworkError } from "./request-timeouts-BY83lTZv.js";
import "./routing-BLb44SmR.js";
import { c as buildExecApprovalPendingReplyPayload } from "./exec-approval-reply-Dx2pkZHw.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-C7mj83Hv.js";
import { t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-deX5rHBm.js";
import { r as registerChannelRuntimeContext } from "./channel-runtime-context-DD0hQ_Td.js";
...
import { a as listTokenSourcedAccounts, i as createUnionActionGate, r as resolveReactionMessageId } from "./channel-actions-DRZl_TLC.js";
import "./text-utility-runtime-C7HSc_wz.js";
import { t as extractToolSend } from "./tool-send-DzdjCDfd.js";
import { c as resolveTelegramPollActionGateState, n as listEnabledTelegramAccounts, o as resolveTelegramAccount, t as createTelegramActionGate } from "./accounts-C1CAVm8N.js";
import { t as isTelegramInlineButtonsEnabled } from "./inline-buttons-DwKRQap5.js";
import { a as isTelegramExecApprovalHandlerConfigured, i as isTelegramExecApprovalClientEnabled } from "./exec-approvals-MQVKPVjX.js";
import { t as fingerprintTelegramBotToken } from "./token-fingerprint-eS9PPeA0.js";
import { Type } from "typebox";
//#region extensions/telegram/src/bot-info.ts
...
function normalizeTelegramBotInfo(value) {
	...
	return {
		...
		can_join_groups: normalizeBoolean$1(bot.can_join_groups) ?? false,
		can_read_all_group_messages: normalizeBoolean$1(bot.can_read_all_group_messages) ?? false,
		can_manage_bots: normalizeBoolean$1(bot.can_manage_bots) ?? false,
		supports_inline_queries: normalizeBoolean$1(bot.supports_inline_queries) ?? false,
		can_connect_to_business: normalizeBoolean$1(bot.can_connect_to_business) ?? false,
		has_main_web_app: normalizeBoolean$1(bot.has_main_web_app) ?? false,
		has_topics_enabled: normalizeBoolean$1(bot.has_topics_enabled) ?? false,
		allows_users_to_create_topics: normalizeBoolean$1(bot.allows_users_to_create_topics) ?? false
	};
}
//#endregion
...
async function loadTelegramActionRuntime() {
	telegramActionRuntimePromise ??= import("./action-runtime-D9GbBGfN.js");
			...
			const persistedOffsetRaw = await readTelegramUpdateOffset({
				...
				onRotationDetected: async (info) => {
					...
					try {
						...
						(opts.runtime?.error ?? console.error)(`telegram: failed to delete stale update offset after rotation: ${String(err)}`);
					}
				}
			});
...
//#endregion
export { buildTelegramExecApprovalPendingPayload as a, normalizeTelegramBotInfo as c, releaseStoppedTelegramPollingLease as i, resetTelegramProbeFetcherCacheForTests as n, shouldSuppressTelegramExecApprovalForwardingFallback as o, monitorTelegramProvider as r, telegramMessageActions as s, probeTelegram as t };
