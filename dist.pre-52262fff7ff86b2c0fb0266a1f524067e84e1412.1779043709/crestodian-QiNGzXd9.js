...
import { r as resolveCrestodianOperation } from "./dialogue-BN_zy-7A.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CEu74D3u.js")).runCrestodianTui;
	opts.onReady?.();
