...
async function appendFileWithinRoot(params) {
	await (await root(params.rootDir)).append(params.relativePath, params.data, {
		encoding: params.encoding,
		mkdir: params.mkdir,
...
//#endregion
export { canonicalPathFromExistingAncestor as A, isWindowsNetworkPath as C, pathExistsSync as D, pathExists as E, resolveAbsolutePathForRead as M, resolveAbsolutePathForWrite as N, sanitizeUntrustedFileName as O, hasEncodedFileUrlSeparator as S, trySafeFileURLToPath as T, resolveWritablePathWithinRoot as _, writeFileWithinRoot as a, assertNoWindowsNetworkPath as b, readSecureFile as c, withTimeout as d, pathScope as f, resolveStrictExistingPathsWithinRoot as g, resolvePathsWithinRoot as h, writeExternalFileWithinRoot as i, findExistingAncestor as j, assertAbsolutePathInput as k, writeSiblingTempFile as l, resolvePathWithinRoot as m, ensureAbsoluteDirectory as n, walkDirectory as o, resolveExistingPathsWithinRoot as p, readFileWithinRoot as r, walkDirectorySync as s, appendFileWithinRoot as t, writeViaSiblingTempPath as u, readLocalFileFromRoots as v, safeFileURLToPath as w, basenameFromMediaSource as x, resolveLocalPathFromRootsSync as y };
