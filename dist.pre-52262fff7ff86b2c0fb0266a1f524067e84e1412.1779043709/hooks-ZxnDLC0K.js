...
import { l as resolveMainSessionKeyFromConfig } from "./sessions-Ct_pHdrL.js";
	...
	const dispatchAgentHook = (value) => {
		...
		(async () => {
			try {
				...
				const { runCronIsolatedAgentTurn } = await import("./isolated-agent-V0KYsUKY.js");
