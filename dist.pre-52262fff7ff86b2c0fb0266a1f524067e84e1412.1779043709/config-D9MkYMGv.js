...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-zPYbwwrl.js";
import "./ssrf-runtime-BDi9tXcb.js";
import "./retry-runtime-CX-mCm0d.js";
import "./secret-input-runtime-Aj8lyfY_.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-Bsr13OpT.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-CtBgJ0Ht.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-mB2kTDE1.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DPDGwJFO.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CQBAXQyx.js"), import("./logging-CyS3sOw2.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-CClkII23.js").then((credentialsReadModule) => ({
