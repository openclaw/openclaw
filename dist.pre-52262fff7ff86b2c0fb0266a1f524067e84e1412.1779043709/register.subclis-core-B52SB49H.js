...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-C07rtfVh.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-3-6xTDgq.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-Ca6x8YHF.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-MI3cA85l.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-B5gaUlbC.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-BKOeFTBO.js"),
