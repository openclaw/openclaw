import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue, n as localeLowercasePreservingWhitespace, s as normalizeOptionalLowercaseString } from "./string-coerce-LndEvhRk.js";
import { t as isTruthyEnvValue } from "./env-BE3qwYMq.js";
import { a as redactSensitiveFieldValueWithConfig, n as isSensitiveFieldKey, r as redactSecrets, u as redactToolPayloadTextWithConfig } from "./redact-CxqQQvmK.js";
...
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-BdqZvTnb.js";
...
import { a as getActiveDiagnosticTraceContext, i as freezeDiagnosticTraceContext, n as createDiagnosticTraceContext, r as formatDiagnosticTraceparent, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-5yrj1tXL.js";
...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-Be17W6eW.js";
import { a as hasInterSessionUserProvenance, i as applyInputProvenanceToUserMessage, r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-Cwr6skDj.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-Blblyldv.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C1CKCx9N.js";
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-BHRGNcbH.js";
import { T as getCompactionProvider } from "./loader-SyUWwFMs.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-BFoCUHvG.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-CMmE9bEr.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-SttxXabE.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-CTtkzWOe.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-CzW8tQZJ.js";
import { u as resolveStorePath } from "./paths-789ECJN2.js";
import { D as isCacheEnabled, O as resolveCacheTtlMs, T as createExpiringMapCache, t as loadSessionStore } from "./store-load-BRLw4_SR.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-C0F6_CiN.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-CTOVSWL0.js";
import { m as MAX_IMAGE_BYTES } from "./mime-B9SCuRKX.js";
import { u as redactTranscriptMessage } from "./transcript-Co5UP2SS.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-B2y1CNV1.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase, t as extractAssistantTextForPhase } from "./chat-message-content-D2GieUdK.js";
import { a as acquireSessionWriteLock, f as resolveSessionWriteLockOptions, l as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-B7Z5CJuw.js";
import { n as isSessionWriteLockTimeoutError } from "./session-write-lock-error-Bk_GRtQK.js";
import { A as resolveProviderReasoningOutputModeWithPlugin, E as resolveProviderCacheTtlEligibility, F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution, U as sanitizeProviderReplayHistoryWithPlugin, q as validateProviderReplayTurnsWithPlugin } from "./provider-runtime-DrNAJwj9.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-DZrSRKB-.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-BKdrgqZp.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-BOMfzUwh.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BbMqrLSw.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BAPxmvid.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-BPZWaJey.js";
import { i as normalizeToolName } from "./tool-policy-shared-CpP268Wb.js";
import "./tool-policy-2a4iBmpL.js";
...
import { a as stripDowngradedToolCallText, d as findFinalTagMatches, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-BwXXap9v.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DAF1-T7Y.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-B_UoI0go.js";
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-DOWI15tv.js";
import { d as stripRuntimeContextCustomMessages, l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-n9kAgyh9.js";
import { t as stableStringify } from "./stable-stringify-j1aIr8uY.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage } from "./usage-BQ1hPeyh.js";
import { C as firstEnumerableOwnKeys, S as boundedJsonUtf8Bytes, T as jsonUtf8BytesOrInfinity, _ as stripInternalMetadataForDisplay } from "./session-utils.fs-CEEDZAwT.js";
import { t as estimateStringChars } from "./cjk-chars-DgPyUBoP.js";
import { t as parseInlineDirectives } from "./directive-tags-DEJwwJ3D.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CqTMQfMX.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-2q03qiGF.js";
import { u as stripHeartbeatToken } from "./heartbeat-bWfG25KS.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-VCFD52Ij.js";
import { a as generateSecureToken } from "./secure-random-CEv7m1qY.js";
import { a as isMessagingToolDuplicateNormalized, c as downgradeOpenAIFunctionCallReasoningPairs, g as sanitizeGoogleTurnOrdering, h as resolveBootstrapTotalMaxChars, l as downgradeOpenAIReasoningBlocks, m as resolveBootstrapPromptTruncationWarningMode, n as validateGeminiTurns, o as normalizeTextForComparison, p as resolveBootstrapMaxChars, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns } from "./pi-embedded-helpers-CcSfwRhc.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-yWJmaeJp.js";
import { n as extractToolResultId, o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-jWv8eDhj.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BUzacBuR.js";
import { d as setReplyPayloadMetadata } from "./reply-reference-bhQ8Bfcq.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-_ZIpTto5.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-DBDFUB1K.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-CKBhnclP.js";
import { A as isEmbeddedMode, O as isStrictAgenticSupportedProviderModel, k as stripProviderPrefix, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-zwY5wSVd.js";
import { t as getMachineDisplayName } from "./machine-name-D-y3d1_0.js";
import { a as prependSystemPromptAddition, c as resolvePromptBuildHookResult, d as shouldInjectHeartbeatPrompt, f as shouldWarnOnOrphanedUserRepair, i as mergeOrphanedTrailingUserPrompt, l as resolvePromptModeForSession, n as buildAfterTurnRuntimeContextFromUsage, o as resolveAttemptFsWorkspaceOnly, p as buildAgentHookContextChannelFields, s as resolveAttemptPrependSystemContext, t as buildAfterTurnRuntimeContext, u as resolvePromptSubmissionSkipReason } from "./attempt.prompt-helpers-C_Ps_5Ut.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-Cwy9F7oS.js";
import { i as getPluginToolMeta } from "./tools-IOz5rfvk.js";
import { n as redactConfigObject } from "./redact-snapshot-B2vK1oPZ.js";
import { n as resolveCommitHash } from "./git-commit-DGTV5iZx.js";
import { t as resolveOsSummary } from "./os-summary-BZ40KCY9.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-DiC1Gqv5.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-Db9Tghfs.js";
import { d as parseBooleanValue } from "./frontmatter-fIT1FV5B.js";
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-BTReyM6C.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-RgP_eKkD.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-Bc1bASZJ.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-DXFsHzBc.js";
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, v as resolveChannelPromptCapabilities, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-bCTtQV1p.js";
import { r as optionalStringEnum } from "./typebox-oHejIQbW.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-4MelqoXX.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-DnBUyMfY.js";
import { a as TOOL_SEARCH_CODE_MODE_TOOL_NAME, c as addClientToolsToToolCatalog, d as applyToolSearchCatalog, f as clearToolSearchCatalog, h as resolveToolSearchConfig, i as TOOL_DESCRIBE_RAW_TOOL_NAME, l as addClientToolsToToolSearchCatalog, m as projectToolSearchTargetTranscriptMessages, n as resolveProcessToolScopeKey, o as TOOL_SEARCH_RAW_TOOL_NAME, p as createToolSearchCatalogRef, r as TOOL_CALL_RAW_TOOL_NAME, s as ToolSearchRuntime, t as createOpenClawCodingTools, u as applyToolCatalogCompaction } from "./pi-tools-5ksuAS_o.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-FDljmYcQ.js";
import { a as isTimeoutError } from "./failover-error-Cxel0sky.js";
import { S as supportsModelTools, _ as sanitizeToolArgs, a as logAgentRuntimeToolDiagnostics, b as isMessagingTool, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, i as shouldAllowProviderOwnedThinkingReplay, l as runAgentCleanupStep, m as filterToolResultMediaUrls, n as createAgentToolResultMiddlewareRunner, o as normalizeAgentRuntimeTools, p as extractToolResultText$1, r as resolveTranscriptPolicy, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as sanitizeToolResult, x as isMessagingToolSendAction, y as collectTextContentBlocks } from "./attempt.tool-run-context-B36KMRu-.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-rBqsDVg5.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-ClY1g8qg.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-t5xphIRn.js";
...
import { r as parseFenceSpans } from "./fences-BJtHzWw2.js";
import { r as splitMediaFromOutput } from "./parse-BRM_TCZP.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-BU0f90nW.js";
...
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-STUoYGK2.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-DKeXzpj9.js";
import { c as buildApiErrorObservationFields, l as buildTextObservationFields } from "./model-fallback-B3DzDitP.js";
import { t as log$5 } from "./logger-C04tBqzD.js";
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-DKSRgDIY.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-C-Ec4P0x.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-D7R3fKnR.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-1dQpexc6.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-B7GaPzyu.js";
...
import { n as buildSubagentList } from "./subagent-list-DMyPmTKL.js";
import { o as listControlledSubagentRuns } from "./subagent-control-DmN5aolF.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-C-fasBl2.js";
...
import { s as buildCopilotIdeHeaders } from "./provider-auth-DcjxjGXc.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-CJivtBjh.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-ljr8w7D6.js";
import { o as resolveSandboxContext } from "./sandbox-Cz5wMNA6.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-DW1rdTQj.js";
import { t as detectRuntimeShell } from "./shell-utils-d3pmRsfs.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-gALX0t4g.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-D_T5nHD0.js";
import "./skills-DlGztt-n.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-Ce4NXiae.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-CsI-A7nF.js";
import "./tool-loop-detection-C827nOBo.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./proxy-stream-wrappers-nFjqITVp.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BgzZkNHz.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-C9CPW5yb.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-DBwWKUBI.js";
import { t as extractSections } from "./post-compaction-context-BHl-FFx0.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-BXxfK7Fa.js";
import "./query-BLjfVuIW.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-B5ZVUN6v.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-lRXR2wAP.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-CTZ0xzr6.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-U0Uc4KpS.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-B4vl2Ay9.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-CPfeC73_.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CFrXQdJu.js";
import { t as detectAndLoadPromptImages } from "./images-1RIFRsfe.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-Co5gajaq.js";
...
import { CURRENT_SESSION_VERSION, DefaultResourceLoader, SessionManager, createAgentSession } from "@earendil-works/pi-coding-agent";
...
function readCodeModeRawConfig(config) {
	const codeMode = (isRecord$1(config?.tools) ? config.tools : void 0)?.codeMode;
	if (codeMode === true) return { enabled: true };
	if (codeMode === false) return { enabled: false };
	return isRecord$1(codeMode) ? codeMode : {};
}
...
function resolveCodeModeConfig(config) {
...
async function runCodeModeWorker(workerData, timeoutMs) {
	const worker = new Worker(codeModeWorkerUrl(), { workerData });
	let timer;
	try {
...
function createCodeModeTools(ctx) {
	return [markCodeModeControlTool({
		...
		label: "exec",
		description: "Run JavaScript or TypeScript in OpenClaw code mode. Use ALL_TOOLS and tools.search/describe/call inside the code to discover and call enabled tools.",
		parameters: Type.Object({
			code: Type.String({ description: "JavaScript or TypeScript source to run." }),
			language: optionalStringEnum(["javascript", "typescript"], { description: "Source language. Defaults to javascript." })
		}),
...
function applyCodeModeCatalog(params) {
	if (!resolveCodeModeConfig(params.config).enabled) return applyToolCatalogCompaction({
		...params,
		enabled: false,
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-BJIaJiP9.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-QIIHGNU8.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-O5Defvcu.js"));
...
function shouldApplyNonVisibleTurnRetryGuard(params) {
	...
	if (normalizeLowercaseStringOrEmpty(params.modelApi ?? "") === "openai-completions" || normalizeLowercaseStringOrEmpty(params.modelApi ?? "") === "anthropic-messages" || normalizeLowercaseStringOrEmpty(params.modelApi ?? "") === "bedrock-converse-stream") return true;
...
function handleMessageUpdate(ctx, evt) {
	...
	if (evtType !== "text_delta" && !delta && content && !content.startsWith(ctx.state.deltaBuffer) && !ctx.state.deltaBuffer.startsWith(content) && !ctx.state.deltaBuffer.includes(content)) shouldRebuildVisibleBuffer = true;
	...
	let visibleDelta = chunk || evtType === "text_end" ? ctx.stripBlockTags(chunk, ctx.state.partialBlockState, { final: evtType === "text_end" }) : "";
	...
	if (shouldRebuildVisibleBuffer) {
		...
		if (!shouldUsePhaseAwareBlockReply) ctx.state.visibleAssistantBuffer = rebuiltVisible;
		visibleDelta = "";
	} else if (!shouldUsePhaseAwareBlockReply && visibleDelta) ctx.state.visibleAssistantBuffer += visibleDelta;
	const next = phaseAwareVisibleText || (deliveryPhase === "final_answer" ? "" : ctx.state.visibleAssistantBuffer.trim());
	if (next) {
...
function handleCompactionEnd(ctx, evt) {
	...
	ctx.log.debug(`[compaction-attribution] end runId=${ctx.params.runId} sessionKey=${ctx.params.sessionKey ?? ctx.params.sessionId} trigger=${trigger} outcome=${outcome} willRetry=${willRetry} compactionCount.before=${compactionCountBefore} compactionCount.after=${compactionCountAfter} compactionCount.delta=${compactionCountDelta}`);
	if (willRetry) {
...
function subscribeEmbeddedPiSession(params) {
	...
	const emitBlockReplySafely = (payload, options) => {
		...
		try {
			...
			const task = Promise.resolve(maybeTask).catch((err) => {
				log$3.warn(`block reply callback failed: ${String(err)}`);
			});
	...
	const resetForCompactionRetry = () => {
		state.hadDeterministicSideEffect = state.hadDeterministicSideEffect === true || hasCommittedMessagingToolDeliveryEvidence({
			...
			messagingToolSentMediaUrls,
			messagingToolSentTargets
		}) || state.successfulCronAdds > 0 || state.visibleBlockReplyCount > 0;
...
function installSessionToolResultGuard(sessionManager, opts) {
	...
	*/
	...
	const guardedAppend = (message) => {
		...
		if (finalMessage.role === "assistant" && toolCalls.length === 0 && opts?.suppressTranscriptOnlyAssistantPersistence === true) return;
...
function resolveCompactionTimeoutMs(cfg) {
	...
	if (typeof raw === "number" && Number.isFinite(raw) && raw > 0) return Math.min(Math.floor(raw) * 1e3, MAX_SAFE_TIMEOUT_MS$1);
...
async function createEmbeddedAttemptSessionLockController(params) {
	...
	async function refreshSessionFileFence() {
		if (fenceActive && !takeoverDetected) fenceFingerprint = await readSessionFileFingerprint(params.lockOptions.sessionFile);
	}
	...
	return {
		...
		async withSessionWriteLock(run) {
			...
			if (activeWriteLock.getStore()) return await run();
			...
			try {
				...
				if (owned) return await activeWriteLock.run(lock, runWithLock);
...
function resolveLlmIdleTimeoutMs(params) {
	...
	if (typeof modelRequestTimeoutMs === "number" && Number.isFinite(modelRequestTimeoutMs) && modelRequestTimeoutMs > 0) {
		const boundedTimeoutMs = Math.min(modelRequestTimeoutMs, ...timeoutBounds);
		if (params?.trigger === "cron" || isLocalProvider) return clampTimeoutMs(boundedTimeoutMs);
...
function removeTrailingMidTurnPrecheckAssistantError(params) {
	...
	if (lastEntry?.type !== "message" || !isMidTurnPrecheckAssistantError(lastEntry.message)) {
		if (isMidTurnPrecheckAssistantError(params.activeSession.agent.state.messages.at(-1))) log$5.warn("[context-overflow-midturn-precheck] removed synthetic assistant error from active session but could not locate matching persisted SessionManager entry");
		return;
	}
	if (typeof mutableSessionManager._rewriteFile !== "function") {
		log$5.warn("[context-overflow-midturn-precheck] removed synthetic assistant error from active session but SessionManager rewrite hook is unavailable");
		return;
	}
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		if (toolSearch.compacted) {
			...
			log$5.info(codeModeControlsEnabledForRun ? `code-mode: cataloged ${toolSearch.catalogToolCount} tools behind exec/wait` : `tool-search: cataloged ${toolSearch.catalogToolCount} tools behind compact prompt surface`);
		}
		...
		const sessionWriteLockOptions = resolveSessionWriteLockOptions(params.config, { maxHoldMsFallback: resolveSessionLockMaxHoldFromTimeout({ timeoutMs: resolveRunTimeoutWithCompactionGraceMs({
		...
		try {
			await repairSessionFileIfNeeded({
				sessionFile: params.sessionFile,
				debug: (message) => log$5.debug(message),
				warn: (message) => log$5.warn(message)
			});
			...
			if (clientToolSearch.compacted) log$5.info(codeModeControlsEnabledForRun ? `code-mode: cataloged ${clientToolSearch.catalogToolCount} client tools behind exec/wait` : `tool-search: cataloged ${clientToolSearch.catalogToolCount} client tools behind compact prompt surface`);
			...
			if (agentTransportOverride && activeSession.agent.transport !== agentTransportOverride) {
				...
				log$5.debug(`embedded agent transport override: ${previousTransport} -> ${agentTransportOverride} (${params.provider}/${params.modelId})`);
			}
			prepStages.mark("stream-setup");
			emitPrepStageSummary("stream-ready");
			const cacheObservabilityEnabled = Boolean(cacheTrace) || log$5.isEnabled("debug");
			...
			try {
				...
				if (activeContextEngine) try {
					...
					log$5.warn(`context engine assemble failed, using pipeline messages: ${String(assembleErr)}`);
				}
			} catch (err) {
			...
			const abortCompaction = () => {
				...
				try {
					...
					if (!isProbeSession) log$5.warn(`embedded run abortCompaction failed: runId=${params.runId} sessionId=${params.sessionId} err=${String(err)}`);
				}
			};
			...
			const scheduleAbortTimer = (delayMs, reason) => {
				abortTimer = setTimeout(() => {
					if (resolveRunTimeoutDuringCompaction({
						...
						if (!isProbeSession) log$5.warn(`embedded run timeout reached during compaction; extending deadline: runId=${params.runId} sessionId=${params.sessionId} extraMs=${compactionTimeoutMs}`);
						scheduleAbortTimer(compactionTimeoutMs, "compaction-grace");
						return;
					}
					if (!isProbeSession) log$5.warn(reason === "compaction-grace" ? `embedded run timeout after compaction grace: runId=${params.runId} sessionId=${params.sessionId} timeoutMs=${params.timeoutMs} compactionGraceMs=${compactionTimeoutMs}` : `embedded run timeout: runId=${params.runId} sessionId=${params.sessionId} timeoutMs=${params.timeoutMs}`);
			...
			try {
				...
				if (emptyExplicitToolAllowlistError) {
					...
					log$5.warn(`[tools] ${emptyExplicitToolAllowlistError.message}`);
				}
				...
				});
				{
					...
					if (legacySystemPrompt) {
						...
						log$5.debug(`hooks: applied systemPrompt override (${legacySystemPrompt.length} chars)`);
					}
					...
					if (prependedOrAppendedSystemPrompt) {
						...
						log$5.debug(`hooks: applied prependSystemContext/appendSystemContext (${prependSystemLen}+${appendSystemLen} chars)`);
					}
				}
				...
				log$5.debug(`embedded run prompt start: runId=${params.runId} sessionId=${params.sessionId} ` + routingSummary);
				...
				if (leafEntry?.type === "message" && leafEntry.message.role === "user") {
					...
					if (shouldWarnOnOrphanedUserRepair(params.trigger)) log$5.warn(orphanRepairMessage);
					else log$5.debug(orphanRepairMessage);
				}
				...
				try {
					...
					if (hookRunner?.hasHooks("before_agent_run")) {
						...
						if (beforeRunDecision?.outcome === "block") {
							...
							log$5.warn(`before_agent_run hook blocked by ${beforeRunPluginId}`);
							await persistBlockedBeforeAgentRun({
					...
					if (log$5.isEnabled("debug")) log$5.debug(`[context-diag] pre-prompt: sessionKey=${params.sessionKey ?? params.sessionId} messages=${msgCount} roleCounts=${sessionSummary.roleCounts} historyTextChars=${sessionSummary.totalTextChars} maxMessageTextChars=${sessionSummary.maxMessageTextChars} historyImageBlocks=${sessionSummary.totalImageBlocks} systemPromptChars=${systemLen} promptChars=${promptLen} promptImages=${imageResult.images.length} provider=${params.provider}/${params.modelId} sessionFile=${params.sessionFile}`);
				...
				try {
					...
					if ((yieldAborted ? { timedOut: false } : await waitForCompactionRetryWithAggregateTimeout({
						...
						timedOutDuringCompaction = true;
						if (!isProbeSession) log$5.warn(`compaction retry aggregate timeout (${COMPACTION_RETRY_AGGREGATE_TIMEOUT_MS}ms): proceeding with pre-compaction state runId=${params.runId} sessionId=${params.sessionId}`);
					}
				} catch (err) {
				...
				await sessionLockController.withSessionWriteLock(async () => {
					...
					if (compactionOccurredThisAttempt && !promptError && !aborted && !timedOut && !idleTimedOut && !timedOutDuringCompaction && shouldRotateCompactionTranscript(params.config)) try {
						...
						if (rotation.rotated) {
							...
							log$5.info(`[compaction] rotated active transcript after automatic compaction (sessionKey=${params.sessionKey ?? params.sessionId})`);
						}
					} catch (err) {
						log$5.warn("[compaction] automatic transcript rotation failed", { errorMessage: formatErrorMessage(err) });
					}
				});
			...
			if (cacheObservabilityEnabled) {
				...
				if (cacheBreakForLog) {
					...
					log$5.warn(`[prompt-cache] cache read dropped ${cacheBreakForLog.previousCacheRead} -> ${cacheBreakForLog.cacheRead} for ${params.provider}/${params.modelId} via ${streamStrategy}; ${changeSummary}`);
			...
			const synthesizedPayloadCount = visibleBlockReplyCount + pendingToolMediaPayloadCount + (silentToolResultReplyPayload ? 1 : 0);
...
//#endregion
export { consumeCompactionSafeguardCancelReason as $, dedupeDuplicateUserMessagesForCompaction as A, resolveEmbeddedAgentStreamFn as B, createEmbeddedRunStageTracker as C, createTrajectoryRuntimeRecorder as Ct, rotateTranscriptAfterCompaction as D, resolveBootstrapMode as E, toSessionToolAllowlist as F, sanitizeSessionHistory as G, prewarmSessionFile as H, applySystemPromptOverrideToSession as I, getHistoryLimitFromSessionKey as J, validateReplayTurns as K, buildEmbeddedSystemPrompt as L, mapThinkingLevel as M, collectAllowedToolNames as N, rotateTranscriptFileAfterCompaction as O, collectRegisteredToolNames as P, isRealConversationMessage as Q, createSystemPromptOverride as R, EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as S, isReasoningTagProvider as St, shouldWarnEmbeddedRunStageSummary as T, trackSessionManagerAccess as U, resolveEmbeddedRunSkillEntries as V, createEmbeddedPiResourceLoader as W, buildEmbeddedExtensionFactories as X, limitHistoryTurns as Y, hasMeaningfulConversationContent as Z, resolveRateLimitProfileRotationLimit as _, resolveRunLivenessState as _t, RUNTIME_AUTH_REFRESH_MARGIN_MS as a, buildUsageWithNoCost as at, createUsageAccumulator as b, createEmbeddedRunReplayState as bt, buildErrorAgentMeta as c, extractPlanningOnlyPlanDetails as ct, resolveActiveErrorContext as d, resolveEmptyResponseRetryInstruction as dt, setCompactionSafeguardCancelReason as et, resolveFinalAssistantRawText as f, resolveIncompleteTurnPayloadText as ft, resolveOverloadProfileRotationLimit as g, resolveReplayInvalidFlag as gt, resolveOverloadFailoverBackoffMs as h, resolveReasoningOnlyRetryInstruction as ht, selectAgentHarness as i, repairSessionFileIfNeeded as it, flushPendingToolResultsAfterIdle as j, shouldRotateCompactionTranscript as k, buildUsageAgentMetaFields as l, resolveAckExecutionFastPathInstruction as lt, resolveMaxRunRetryIterations as m, resolvePlanningOnlyRetryLimit as mt, resolveAvailableAgentHarnessPolicy as n, resolveCompactionTimeoutMs as nt, RUNTIME_AUTH_REFRESH_MIN_DELAY_MS as o, collectRuntimeChannelCapabilities as ot, resolveFinalAssistantVisibleText as p, resolvePlanningOnlyRetryInstruction as pt, buildEmbeddedMessageActionDiscoveryInput as q, runAgentHarnessAttempt as r, guardSessionManager as rt, RUNTIME_AUTH_REFRESH_RETRY_MS as s, STRICT_AGENTIC_BLOCKED_TEXT as st, maybeCompactAgentHarnessSession as t, compactWithSafetyTimeout as tt, createCompactionDiagId as u, resolveAttemptReplayMetadata as ut, resolveReportedModelRef as v, resolveSilentToolResultReplyPayload as vt, formatEmbeddedRunStageSummary as w, mergeUsageIntoAccumulator as x, observeReplayMetadata as xt, scrubAnthropicRefusalMagic as y, shouldTreatEmptyAssistantReplyAsSilent as yt, resolveEmbeddedAgentBaseStreamFn as z };
