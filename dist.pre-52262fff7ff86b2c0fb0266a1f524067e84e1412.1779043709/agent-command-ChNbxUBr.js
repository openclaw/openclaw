...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, i as markAutoFallbackPrimaryProbe, m as resolveEffectiveModelFallbacks, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-B7Gl_3a6.js";
import { a as isSubagentSessionKey } from "./session-key-utils-CJRKuBJA.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-CQewiu8n.js";
import { a as resolveAgentDir, n as listAgentIds, o as resolveAgentWorkspaceDir } from "./agent-scope-config-BdqZvTnb.js";
import { n as defaultRuntime } from "./runtime-DDH_zqCr.js";
import { s as runWithDiagnosticTraceparent } from "./diagnostic-trace-context-5yrj1tXL.js";
import { t as createSubsystemLogger } from "./subsystem-Dtm6MSVy.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-s7xwYk1t.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-DQNxPE51.js";
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-BxclR8vv.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-XI6kh6r8.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-YuMV2PLT.js";
import { f as resolveMessageChannel } from "./message-channel-DJtqYoTD.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BlKm_Gw6.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-DQX5R6b3.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CzW8tQZJ.js";
import { h as stringifyRouteThreadId } from "./channel-route-vpaTrtym.js";
import { o as normalizeAccountId } from "./delivery-context.shared-etu5OJV7.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BHrK_jjr.js";
import { n as ensureAuthProfileStore } from "./store-CMEB4ZMP.js";
import { r as buildConfiguredModelCatalog, v as resolveConfiguredModelRef } from "./model-selection-shared-Bd49BLni.js";
import { i as parseModelRef, n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-DeF75Ytd.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent } from "./model-selection-DZrSRKB-.js";
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-J-IZw7on.js";
import { a as normalizeSpawnedRunMetadata } from "./spawn-requester-origin-BMDeMm5u.js";
import { n as loadManifestModelCatalog } from "./model-catalog-CAIYwyOS.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-DDxwjuCx.js";
import { n as resolveSendPolicy } from "./send-policy-BiwbAPrT.js";
import { Ct as createTrajectoryRuntimeRecorder, n as resolveAvailableAgentHarnessPolicy } from "./selection-DgO_TYl2.js";
import { l as ensureAgentWorkspace } from "./workspace-RgP_eKkD.js";
import { o as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-B3DzDitP.js";
import { t as buildOutboundSessionContext } from "./session-context-CFBYS-zo.js";
import { n as resolveSession } from "./session-CGOHRmu2.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-CE6wOG9Z.js";
import { n as repairProviderWrappedModelOverride, t as applyModelOverrideToSessionEntry } from "./model-overrides-Bk0v4N8c.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-UAiygz_v.js";
import { t as resolveAgentTimeoutMs } from "./timeout-ctCKMrP-.js";
import { t as classifyEmbeddedPiRunResultForModelFallback } from "./result-fallback-classifier-BMoHgAf2.js";
import { n as hydrateResolvedSkillsAsync } from "./snapshot-hydration-pZ-x9ORD.js";
import { r as ensureSelectedAgentHarnessPlugin } from "./live-model-switch-fRPvIiph.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-B7YAiTRP.js";
import { t as resolveFastModeState } from "./fast-mode-DoFTIkZC.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-B-Lp4qDY.js";
import { t as NodeRegistry } from "./node-registry-Duu6rLN4.js";
import { n as applyVerboseOverride } from "./level-overrides-BIOctwes.js";
import { r as createAcpVisibleTextAccumulator } from "./attempt-execution.helpers-DBRn6gcY.js";
import { i as resolveInternalEventTranscriptBody, n as prependInternalEventContext, r as resolveAcpPromptBody, t as persistSessionEntry$1 } from "./attempt-execution.shared-CnZrR2qE.js";
...
const acpPolicyRuntimeLoader = createLazyImportLoader(() => import("./policy-Cpjk33UY.js"));
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-DK18mBjq.js"));
const acpSessionIdentifiersRuntimeLoader = createLazyImportLoader(() => import("./session-identifiers-Dl5ZpQuU.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-slTBV6Z6.js"));
const transcriptResolveRuntimeLoader = createLazyImportLoader(() => import("./transcript-resolve.runtime.js"));
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-DxavviS6.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-DLS59vcs.js"));
const skillsRuntimeLoader = createLazyImportLoader(() => import("./skills-BPECJ5z1.js"));
const skillsFilterRuntimeLoader = createLazyImportLoader(() => import("./filter-BDluL9Xe.js"));
const skillsRefreshStateRuntimeLoader = createLazyImportLoader(() => import("./refresh-state-CucTXB0o.js"));
const skillsRemoteRuntimeLoader = createLazyImportLoader(() => import("./skills-remote-DTvcEu1K.js"));
	...
	try {
		...
		if (!isRawModelRun && acpResolution?.kind === "ready" && sessionKey) {
			...
			try {
				...
				await runWithDiagnosticTraceparent(opts.traceparent, () => acpManager.runTurn({
					cfg,
					sessionKey,
					text: body,
					mode: "prompt",
