...
import { i as getChildLogger, v as normalizeLogLevel } from "../../logger-D4Ax5Dlv.js";
import { a as shouldLogVerbose } from "../../globals-CrpmxZTV.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-BxclR8vv.js";
import { i as replaceConfigFile, n as mutateConfigFile } from "../../mutate-BAfEGIzq.js";
import "../../config-D2REj--_.js";
import { l as onAgentEvent } from "../../agent-events-CzW8tQZJ.js";
...
import { _ as mediaKindFromMime, n as detectMime } from "../../mime-B9SCuRKX.js";
import { n as onSessionTranscriptUpdate } from "../../transcript-events-B2y1CNV1.js";
import { t as getPluginRuntimeGatewayRequestScope } from "../../gateway-request-scope-BHrK_jjr.js";
import "../../logging-CVLh7JsP.js";
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-Bd49BLni.js";
...
import { a as getImageMetadata, l as resizeToJpeg } from "../../image-ops-CZ-pZf1L.js";
import { o as generateMusic, s as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-zwY5wSVd.js";
import { l as ensureAgentWorkspace } from "../../workspace-RgP_eKkD.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "../../lazy-runtime-CrxOGRJy.js";
...
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-BN5A5B9G.js";
import { n as resolveAgentIdentity } from "../../identity-B-C0a06U.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-BqLyDqal.js";
...
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-hjKIhhmq.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-6MsWMbna.js";
import { i as setGatewaySubagentRuntime, n as gatewaySubagentState, r as setGatewayNodesRuntime, t as clearGatewaySubagentRuntime } from "../../gateway-bindings-VO2eJRqH.js";
import { t as createRuntimeChannel } from "../../runtime-channel-D_h2lTYu.js";
import { r as isVoiceCompatibleAudio } from "../../audio-c7V1FZQE.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-DQNhSMyT.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-CefAyHsW.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-D217HWUp.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-B07SooNV.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-CeGw3VtS.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-C5w_G8iw.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-DN7mAiN7.js"), (m) => m.createRuntimeLlm({
