...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-CmGMypOF.js";
...
import { a as formatMissingPluginMessage } from "./error-format-W6MULocR.js";
import { u as quietPluginJsonLogger } from "./plugins-command-helpers-BNXVTTIA.js";
...
async function runPluginsInspectCommand(id, opts) {
	const { buildAllPluginInspectReports, buildPluginDiagnosticsReport, buildPluginInspectReport, buildPluginSnapshotReport, formatPluginCompatibilityNotice } = await import("./status-BJn6-XOr.js");
	const { loadInstalledPluginIndexInstallRecords } = await import("./installed-plugin-index-records-DE412dQc.js");
