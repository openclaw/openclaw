...
import { s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-B7Gl_3a6.js";
...
import { b as setCurrentPluginMetadataSnapshot, g as captureCurrentPluginMetadataSnapshotState, v as getCurrentPluginMetadataSnapshot, y as restoreCurrentPluginMetadataSnapshotState } from "./plugin-registry-giqGaBJo.js";
import { J as getShellEnvAppliedKeys, Q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-s7xwYk1t.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-DQNxPE51.js";
import { n as resolveProviderAuthAliasMap, r as resolveProviderIdForAuth } from "./provider-auth-aliases-YuMV2PLT.js";
...
import { s as openAIProviderUsesCodexRuntimeByDefault, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-DQX5R6b3.js";
import { N as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-DrNAJwj9.js";
import { g as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CMEB4ZMP.js";
...
import { b as resolveProviderEnvAuthEvidence, u as isNonSecretApiKeyMarker, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DZ3DKDc2.js";
import { t as resolveEnvApiKey } from "./model-auth-env-BCLOjmyc.js";
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-CWuFZQFj.js";
import "./workspace-RgP_eKkD.js";
import { n as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-CjTPa2eA.js";
...
import { n as isRich } from "./list.format-DHcipPtp.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-DBL3tlNS.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-H-eC-2oH.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-CDJLFinU.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-BiToePMO.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		for (const usage of providerUses) if (usage.allowCodexRuntimeFallback && openAIProviderUsesCodexRuntimeByDefault({
		...
		for (const provider of syntheticProvidersToProbe) {
			...
			const codexProvider = normalizeProviderId(OPENAI_CODEX_PROVIDER_ID);
			if (normalized === "codex" || (aliasMap[codexProvider] ?? codexProvider) === normalized) syntheticAuthByProvider.set(codexProvider, syntheticAuth);
		}
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-jbNYQoFa.js");
			runtime.log("");
