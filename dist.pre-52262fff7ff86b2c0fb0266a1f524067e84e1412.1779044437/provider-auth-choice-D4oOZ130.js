...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-BFiFeBhs.js";
...
import { n as openUrl } from "./browser-open-ClnAdmwo.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-B5P8HsMg.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-9XFRkX7x.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CKgMWzA6.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-C2ADzBsN.js";
import { t as isRemoteEnvironment } from "./remote-env-fD_jVy52.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-CBKUi-6e.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-BHm3hFkL.js") };
