...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-s7xwYk1t.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { t as note } from "./note-CW2M4CFi.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-B-knGGU7.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DinjkRJn.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-Cpo-pGH1.js");
