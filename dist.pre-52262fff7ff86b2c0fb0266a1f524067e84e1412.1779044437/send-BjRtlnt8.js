...
import { c as kindFromMime, s as isGifMedia } from "./mime-B9SCuRKX.js";
import { a as getImageMetadata } from "./image-ops-CZ-pZf1L.js";
import { t as loadWebMedia } from "./web-media-CdmKP8Jc.js";
import { n as normalizePollInput } from "./polls-Lpod_Y54.js";
import { r as makeProxyFetch } from "./proxy-fetch-CAGV_wZ_.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-dUfVORKP.js";
...
import { a as isSafeToRetrySendError, c as isTelegramRateLimitError, i as isRecoverableTelegramNetworkError, l as isTelegramServerError, n as resolveTelegramRequestTimeoutMs, u as tagTelegramNetworkError } from "./request-timeouts-BY83lTZv.js";
...
import { n as createChannelApiRetryRunner } from "./retry-policy-CMakbh1c.js";
import "./ssrf-runtime-BDi9tXcb.js";
import { s as probeVideoDimensions } from "./media-runtime-BqjAMS-d.js";
...
import "./retry-runtime-CX-mCm0d.js";
import { o as resolveTelegramAccount } from "./accounts-Btd65wDh.js";
import { i as parseTelegramTarget, n as normalizeTelegramChatId, r as normalizeTelegramLookupTarget } from "./targets-Y3xoGTrC.js";
import { K as normalizeTelegramReplyToMessageId, a as renderTelegramHtmlText, h as buildTypingThreadParams, m as buildTelegramThreadParams, o as splitTelegramHtmlChunks, s as telegramHtmlToPlainTextFallback } from "./format-DiEKEc9b.js";
...
function createTelegramClientFetch(params) {
	...
	const wrappedFetch = async (input, init) => {
		...
		try {
			...
			if (requestTimeoutMs && shouldRetryTimedOutTelegramControlRequest(method) && !shutdownSignal?.aborted && !requestSignal?.aborted && params.transport?.forceFallback?.("request-timeout")) return await runFetch();
			throw err;
		}
	};
	return (input, init) => {
