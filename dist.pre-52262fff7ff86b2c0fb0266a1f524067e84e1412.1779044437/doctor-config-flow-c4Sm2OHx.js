...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-s7xwYk1t.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { r as normalizeTalkSection } from "./talk-mRw47yKJ.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-Cf67pRiO.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-CYnJtcB2.js";
import { n as getLoadedChannelPlugin } from "./registry-C-gssWwS.js";
import { i as listRouteBindings } from "./bindings-Dpb7l6fm.js";
import { i as legacyRuntimeModelAliasRequiresRuntimePolicy, o as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DhDX4zbE.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-B5ZVUN6v.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-DH5ADYJz.js";
import { t as note } from "./note-CW2M4CFi.js";
import { t as asObjectRecord } from "./object-DAkIy4g4.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-B-knGGU7.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-CxWkCQOk.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-B-wZL5bj.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-D51frjSE.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-Cihcoh-0.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-Co7b94Wk.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-C4pijqod.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-Bur3YcYj.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BJRCHUow.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-RBd30LJP.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DgRbOvjx.js");
		emitDoctorNotes({
			note,
