...
import { i as callGateway } from "./call-DaP6vQmX.js";
...
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-BOMfzUwh.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-BI3E_afW.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-Bzb3oEXT.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-2q03qiGF.js";
import { i as consumePendingDelegates } from "./delegate-store-BBKN81VW.js";
import "./continuation-delegate-store-D7o_YL2y.js";
import { n as resolveContinuationRuntimeConfig } from "./config-Bfj_UQN-.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DwJyON9S.js";
import "./delivery-context-CHrDmWDr.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-RzHi99_X.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-BBWQcvkr.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-4RIp-d7d.js";
import { n as buildAnnounceIdFromChildRun, r as buildAnnounceIdempotencyKey, t as resolveAnnounceOrigin } from "./subagent-announce-origin-DRrCalqb.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-jvnJvUYN.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-CA8VdqU-.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-Buh9k1-M.js"), import("./store-load-DrngwLWU.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { hasCrossSessionDelegateTargeting } = await import("./targeting-pure-CJlOGum3.js");
	if (!hasCrossSessionDelegateTargeting(params.targeting, params.dispatchingSessionKey)) return false;
	const { enqueueSystemEvent } = await import("./system-events-CnT0SKT9.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-CyMHHn9e.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-CnT0SKT9.js");
			const { createSubsystemLogger } = await import("./subsystem-Byvp0tQM.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-C-_7zM4w.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
