...
import { s as resolvePluginContributionOwners } from "./plugin-registry-giqGaBJo.js";
...
import { t as ConfigMutationConflictError } from "./mutate-BAfEGIzq.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-DFNtZMZ4.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CjqRdasp.js";
import { n as applyAuthChoice } from "./auth-choice-Dga3MzIZ.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Cm87qeDB.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CiR_eBVC.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BQX0_as1.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DQ5PKqJz.js";
import { n as formatHealthCheckFailure } from "./health-format-DE02T4g6.js";
import { n as healthCommand } from "./health-Di_NtgYC.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DRT9UlnJ.js";
import { t as setupSkills } from "./onboard-skills-CmXqYfhR.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-CLp5JGC7.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-DPEe4GX0.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-Ce3OGA0C.js");
