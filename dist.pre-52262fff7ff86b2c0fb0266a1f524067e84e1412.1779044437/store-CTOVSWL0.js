...
import { s as normalizeSessionPeerId } from "./session-key-utils-CJRKuBJA.js";
import { i as normalizeHyphenSlug } from "./string-normalization-DgUPESoD.js";
import { t as writeTextAtomic } from "./json-files-1SmAauRO.js";
import { t as createSubsystemLogger } from "./subsystem-Dtm6MSVy.js";
import { l as listDeliverableMessageChannels, u as normalizeMessageChannel } from "./message-channel-DJtqYoTD.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-etu5OJV7.js";
import { a as isSessionArchiveArtifactName, c as isTrajectorySessionArtifactName, i as isPrimarySessionTranscriptFileName, r as isCompactionCheckpointTranscriptFileName } from "./artifacts-BhcaA_2u.js";
import { i as resolveSessionFilePath } from "./paths-789ECJN2.js";
import { A as resolveSessionStoreEntry, E as getFileStatSnapshot, _ as pruneQuotaSuspensions, b as shouldPreserveMaintenanceEntry, d as isSessionStoreCacheEnabled, f as setSerializedSessionStore, g as getActiveSessionMaintenanceWarning, h as capEntryCount, i as collectSessionMaintenancePreserveKeys, k as normalizeStoreSessionKey, l as dropSessionStoreObjectCache, m as writeSessionStoreCache, n as normalizeSessionStore, p as takeMutableSessionStoreCache, r as resolveMaintenanceConfig, s as clearSessionStoreCaches, t as loadSessionStore, u as getSerializedSessionStore, v as pruneStaleEntries, x as shouldRunSessionEntryMaintenance } from "./store-load-BRLw4_SR.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath } from "./paths-C0F6_CiN.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin } from "./registry-C-gssWwS.js";
import { t as normalizeChatType } from "./chat-type-BW-f7-Sk.js";
import { t as resolveConversationLabel } from "./conversation-label-CBgBUlam.js";
import "./plugins-DToNC952.js";
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-CmPL5zcY.js";
...
function getSessionStoreWriterQueueSizeForTest() {
	return WRITER_QUEUES.size;
}
//#endregion
//#region src/config/sessions/store-writer.ts
async function withSessionStoreWriterForTest(storePath, fn) {
...
function loadTrajectoryCleanupRuntime() {
	trajectoryCleanupRuntimePromise ??= import("./cleanup-C0lFttGa.js");
...
//#endregion
export { buildGroupDisplayName as _, saveSessionStore as a, pruneUnreferencedSessionArtifacts as b, updateSessionStoreEntry as c, drainSessionStoreWriterQueuesForTest as d, getSessionStoreWriterQueueSizeForTest as f, snapshotSessionOrigin as g, deriveSessionOrigin as h, runQuotaSuspensionMaintenance as i, withSessionStoreWriterForTest as l, deriveSessionMetaPatch as m, readSessionUpdatedAt as n, updateLastRoute as o, deriveGroupSessionPatch as p, recordSessionMetaFromInbound as r, updateSessionStore as s, archiveRemovedSessionTranscripts as t, clearSessionStoreCacheForTest as u, resolveGroupSessionKey as v, resolveSessionArtifactCanonicalPathsForEntry as x, enforceSessionDiskBudget as y };
