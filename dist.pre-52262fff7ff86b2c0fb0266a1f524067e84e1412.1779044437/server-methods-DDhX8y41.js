...
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-8GVF2shE.js";
...
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-SSpUvzAg.js";
...
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-C-Hno3FU.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BTjxLtf-.js";
...
import "./heartbeat-runner-qKnjE6pp.js";
...
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-B_u33fZH.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BkMzhdGg.js");
