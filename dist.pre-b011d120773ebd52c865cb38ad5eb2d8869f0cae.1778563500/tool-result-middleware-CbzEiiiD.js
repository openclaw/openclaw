...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-QoyUXw0b.js";
import "./model-selection-CyWx9aXc.js";
import { d as isGoogleModelApi, u as isGemma4ModelRequiringReasoningStrip } from "./pi-embedded-helpers-BKDoLWiA.js";
import { t as log$1 } from "./logger-WjiJP55B.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-BpwAf3yf.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-D0CCdL_w.js");
