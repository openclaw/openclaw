...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "../../webhook-request-guards-CLob3mYw.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, h as parseRealtimeVoiceAgentConsultArgs, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "../../session-runtime-uu8ar2X7.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "../../realtime-voice-BFP6Gtks.js";
import { t as resolveConfiguredCapabilityProvider } from "../../provider-selection-runtime-CTI2lGWD.js";
import { n as getActiveMemorySearchManager } from "../../memory-host-search-BbDHPEi-.js";
import "../../speech-BU5MBuhp.js";
import { t as zod_exports } from "../../zod-Cu5JZmHR.js";
import "./api-BeeCsZba.js";
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-CHi1rMXV.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-Cj0i5feL.js";
import { t as resolveVoiceResponseModel } from "./response-model-DgsakqNI.js";
import { t as isProviderStatusTerminal } from "./call-status-ClreCuE-.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-Cs9yZm7e.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-ELfWO5Pa.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DDLzaMnd.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-CuLxFfqJ.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-Co97N4J8.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-CGzoZJyM.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-DwFDIlBW.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-cst-b6lz.js");
