...
import { D as patchTopLevelChannelConfigSection, f as createStandardChannelSetupStatus } from "../../setup-wizard-helpers-BszlehmC.js";
...
import { t as NostrConfigSchema } from "./config-schema-CvwPhpLG.js";
...
const nostrSetupWizard = createDelegatedSetupWizardProxy({
	channel,
	loadWizard: async () => (await import("./setup-surface-DI4enT6W.js")).nostrSetupWizard,
