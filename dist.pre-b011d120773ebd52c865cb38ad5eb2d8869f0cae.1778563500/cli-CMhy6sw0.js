...
import { n as matrixSetupAdapter } from "./setup-core-Dv_forID.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-B6fVGE9R.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-DXR-AacW.js";
import { t as withResolvedActionClient } from "./client-D-7ez42r.js";
import { r as resolveMatrixAuthContext } from "./config-AiXd4osX.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-BrntBDqm.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-2pIIE48C.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-Cy3fhM57.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DFma0aUy.js");
