---
name: bluebubbles
description: Build or update the BlueBubbles external channel plugin for DNA (extension package, REST send/probe, webhook inbound).
---
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `dna/plugin-sdk` helpers.
