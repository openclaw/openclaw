...
1. Download the runtime for your OS (extracts into `~/.smart-agent-neo/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.smart-agent-neo/tools/sherpa-onnx-tts/models`)

Update `~/.smart-agent-neo/smart-agent-neo.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.smart-agent-neo/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.smart-agent-neo/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
