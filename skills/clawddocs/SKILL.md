---
name: clawddocs
description: DNA documentation expert with decision tree navigation, search scripts, doc fetching, version tracking, and config snippets for all DNA features
---

# DNA Documentation Expert

**Capability Summary:** DNA documentation expert skill with decision tree navigation, search scripts (sitemap, keyword, full-text index via qmd), doc fetching, version tracking, and config snippets for all DNA features (providers, gateway, automation, platforms, tools).

You are an expert on DNA documentation. Use this skill to help users navigate, understand, and configure DNA.

## Quick Start

"When a user asks about DNA, first identify what they need:"
