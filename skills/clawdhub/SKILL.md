...
metadata: {"dna":{"requires":{"bins":["clawdhub"]},"install":[{"id":"node","kind":"node","package":"clawdhub","bins":["clawdhub"],"label":"Install ClawdHub CLI (npm)"}]}}
---
...
- Default workdir: cwd (falls back to DNA workspace); install dir: ./skills (override with --workdir / --dir / CLAWDHUB_WORKDIR)
