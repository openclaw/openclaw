...
message.send.backend.login = "[redacted-email]"
...
```bash
himalaya envelope list --query "from:[redacted-email] subject:meeting"
```
...
```bash
himalaya message write -H "To:[redacted-email]" -H "Subject:Test" "Message body here"
```
