...
set +e
output="$('/Users/haruki/.nvm/versions/node/v24.13.0/bin/node' '/Users/haruki/openclaw/skills/erp-query/scripts/secure-query.cjs' --wecom-user-id 'wangpengcheng' "$@" 2>&1)"
status=$?
set -e
