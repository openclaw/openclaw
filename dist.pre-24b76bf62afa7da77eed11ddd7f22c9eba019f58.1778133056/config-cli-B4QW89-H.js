...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-B906vNsP.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-C40je0x6.js";
import { n as info, o as success, t as danger } from "./globals-Byqe4NlR.js";
import { a as resolveSecretRefValue } from "./resolve-p_Wz7srX.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-BqN-ccJq.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-CGWvAVH7.js";
...
import { n as redactConfigObject } from "./redact-snapshot-CTLN9eio.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BtaJqJ8V.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-QZgSl9pm.js";
import { n as setCommandJsonMode } from "./json-mode-AiCslhKi.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-Ceqymyxp.js");
