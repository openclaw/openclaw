...
import { s as resolveRuntimeServiceVersion } from "./version-CNIHYlXn.js";
import { n as createDiagnosticTraceContext, s as runWithDiagnosticTraceContext } from "./diagnostic-trace-context-DNuC9Kq2.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-BMdoYZVC.js";
import { i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-YLkbVqug.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-BB3qW0jS.js";
import { i as getRuntimeConfig } from "./io-BqN-ccJq.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-m4JU31o8.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-DFanYIjE.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-BWLnUh7o.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-4JCE10kG.js";
...
import { Jr as ErrorCodes, M as validateConnectParams, Tt as validateRequestFrame, Yr as errorShape, t as formatValidationErrors } from "./protocol-I0uBH5gX.js";
import "./version-BloRQp7j.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CcV4Dk4n.js";
import "./method-scopes-_pFUNS2v.js";
import { l as roleScopesAllow } from "./pairing-token-Cez2bvk8.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-9dF02Nqk.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-D3xGasnI.js";
import { a as resolveNodeCommandAllowlist, i as normalizeDeclaredNodeCommands } from "./node-command-policy-ClfqNRjF.js";
import { n as logWs, t as formatForLog } from "./ws-log-BhixL7IP.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-ClD9maFJ.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-WsERva4M.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-UQ1jcFWs.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-D7P7JoZ7.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-BRVZsYOl.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-C8u8-yJr.js";
import { r as upsertPresence } from "./system-presence-DjPkvQPQ.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-DXGamXnb.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DSApIyK3.js";
...
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-HjMW79JR.js";
import { t as truncateCloseReason } from "./close-reason-BaAqwPm7.js";
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-DmmZ_eBN.js");
