...
import { f as loadInstalledPluginIndex } from "./installed-plugin-index-store-D3X0T5Yi.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-CXCsRemB.js";
import { F as parseRegistryNpmSpec } from "./discovery-B9FIOZR8.js";
import { r as resolveDefaultPluginExtensionsDir } from "./install-paths-GsG77pMt.js";
import { o as loadInstalledPluginIndexInstallRecords } from "./manifest-registry-BVVAY7EK.js";
import { a as listOfficialExternalPluginCatalogEntries, c as resolveOfficialExternalPluginInstall, l as resolveOfficialExternalPluginLabel, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-C7RR9_Z_.js";
import { t as buildNpmResolutionInstallFields } from "./installs-B9-FJCIO.js";
import { s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-DURid-PE.js";
import { n as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog-C9gubd3b.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-x4Wd_FUC.js";
import { i as listPotentialConfiguredChannelIds, r as listExplicitlyDisabledChannelIdsForConfig } from "./config-presence-ChihH6FB.js";
import { h as resolveConfiguredChannelPresencePolicy } from "./channel-plugin-ids-CcFj9QsC.js";
import { i as installPluginFromNpmSpec } from "./install-DnWgVt52.js";
import { r as installPluginFromClawHub, t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-fT0HZ_Dj.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-DPoxgOlk.js";
import { l as resolveRegistryUpdateChannel, s as normalizeUpdateChannel } from "./update-channels-CW_zpZPK.js";
import { t as buildClawHubPluginInstallRecordFields } from "./clawhub-install-records-C5eLomtn.js";
import { n as resolveNpmInstallSpecsForUpdateChannel, t as resolveClawHubInstallSpecsForUpdateChannel } from "./install-channel-specs-DWLx8xLc.js";
import { n as updateNpmInstalledPlugins } from "./update-DfkccxxO.js";
import { t as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-CudLYwyF.js";
import { t as asObjectRecord } from "./object-CRnhucrW.js";
...
async function repairMissingPluginInstalls(params) {
	...
	const missingRecordedPluginIds = Object.keys(records).filter((pluginId) => Object.hasOwn(nextRecords, pluginId) && !bundledPluginsById.has(pluginId) && (params.pluginIds.has(pluginId) && (!knownIds.has(pluginId) || isInstalledRecordMissingOnDisk(nextRecords[pluginId], env)) || configuredPluginIdsWithStaleDescriptors.has(pluginId)));
