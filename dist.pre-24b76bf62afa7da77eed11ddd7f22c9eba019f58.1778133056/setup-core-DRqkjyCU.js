...
import { u as prepareScopedSetupConfig } from "./setup-helpers-D5cShzie.js";
import "./setup-DKguekh2.js";
import { a as resolveMatrixAccountConfig } from "./account-config-B6VETqAO.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-CxMT7zxB.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Bf2qbnMj.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-CjBxdCWd.js");
