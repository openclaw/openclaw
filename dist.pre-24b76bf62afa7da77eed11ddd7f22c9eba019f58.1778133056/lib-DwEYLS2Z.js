...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DtalmEi6.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-Voe-Yvv_.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-C7FtkbFo.js";
import { l as toRatio, n as decodeString } from "./Util-vvwJIX6G.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-vWwKgbRs.js";
import { t as APEv2Parser } from "./APEv2Parser-BZF80wfk.js";
import { r as hasID3v1Header } from "./ID3v1Parser-M1HH_y5y.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-O0cAfDGa.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-64HxxRMT.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DoEm_-E_.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-D0w4cV_L.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-lIa6PHow.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Bm5UDpDj.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CymYdHge.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-UBBSNz6S.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-tzc-5v3m.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Cy1zU1gP.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-mxUlNKpJ.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-Hczy3fR_.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BIOLPQl1.js")).WaveParser;
	}
};
//#endregion
