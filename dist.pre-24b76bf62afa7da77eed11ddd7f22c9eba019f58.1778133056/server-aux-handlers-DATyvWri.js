...
import { a as approvalDecisionLabel, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage } from "./plugin-approvals-3El2iNZO.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-ChY-kMXQ.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-BoR9QwZB.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-D-YmeQla.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-CAlhydKf.js";
import { l as roleScopesAllow } from "./pairing-token-Cez2bvk8.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-DQ-vmNlL.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-BMlYJglI.js";
import { r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BSQ27jlF.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-R2-GCqU9.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-WsERva4M.js";
...
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Cf3KO7OW.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-CuDqMTHZ.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-B9O7cjU2.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-DuFwJ5R7.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
