...
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "../../webhook-request-guards-DOcGOAX7.js";
import { t as normalizeWebhookPath } from "../../webhook-path-dxISNUzD.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "../../webhook-targets-ZH8ppUbz.js";
import "../../security-runtime-DD1ay_UN.js";
import "../../string-coerce-runtime-DAjEFAsR.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-95uA8cJS.js";
import "./secret-input-DH8366MN.js";
import { t as getBlueBubblesRuntime } from "./runtime-kSE1L0JB.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-3-6rt6ap.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-D434L1bw.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-asaLjJlW.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-BgWhj_ax.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
