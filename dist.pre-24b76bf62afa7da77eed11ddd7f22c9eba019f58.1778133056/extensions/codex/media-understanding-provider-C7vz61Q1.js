import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-bEFBkMDi.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-DLnYln7R.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-wAIlMAQ4.js";
import { r as readModelListResult } from "./models-BuZWf83r.js";
import { t as isJsonObject } from "./protocol-CNL7L15x.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-Dhclu_MO.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
