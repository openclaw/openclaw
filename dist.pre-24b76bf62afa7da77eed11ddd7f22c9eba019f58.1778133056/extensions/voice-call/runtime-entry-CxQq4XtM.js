...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "../../webhook-request-guards-DOcGOAX7.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, h as parseRealtimeVoiceAgentConsultArgs, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "../../session-runtime-DZNI5nBZ.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "../../realtime-voice-D7NxUhvP.js";
...
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-Cv3URAIm.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-DLNtM7DG.js";
import { t as resolveVoiceResponseModel } from "./response-model-tG6tO9Fc.js";
import { t as isProviderStatusTerminal } from "./call-status-BCyVGc3i.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-BRGuQhqr.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-D-DOnc0P.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-Dpj2KxDN.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-Bcz5xPqe.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-Wp3tGchh.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-ulK2zUkT.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-2sqiKRx6.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-B3aAE40c.js");
