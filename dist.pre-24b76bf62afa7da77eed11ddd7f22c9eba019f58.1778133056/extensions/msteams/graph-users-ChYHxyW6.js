...
import { u as isPrivateIpAddress } from "../../ssrf-Cmvw-sAq.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "../../ssrf-policy-CrjaYWnM.js";
import "../../ssrf-runtime-BoUUJCOc.js";
import { t as getMSTeamsRuntime } from "./runtime-api-CCWMmRED.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-B9MlmVh9.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("../../dist-3lDYu2CN.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../dist-CBcyJkGh.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("../../jsonwebtoken-BiyfqJHi.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../src-7frqNuYI.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
