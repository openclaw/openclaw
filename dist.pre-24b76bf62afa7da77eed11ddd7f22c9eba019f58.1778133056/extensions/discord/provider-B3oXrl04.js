...
import { n as readSessionUpdatedAt, o as updateSessionStore } from "../../store-DypV6NYF.js";
import { o as resolveDefaultModelForAgent } from "../../model-selection-BP-YASdB.js";
import { r as clearExpiredCooldowns, s as isProfileInCooldown } from "../../order-nRLUmC8h.js";
import { s as resolveProfilesUnavailableReason } from "../../usage-C9P09iZB.js";
import { i as resolveEffectiveDebugProxyUrl, r as resolveDebugProxySettings } from "../../env-B5g7k1D9.js";
import { n as captureWsEvent, t as captureHttpExchange } from "../../runtime-BoIQxFeO.js";
import "../../provider-model-shared-CaQCh3qI.js";
import { n as fetchWithSsrFGuard } from "../../fetch-guard-CmN33efq.js";
import { h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "../../reply-payload-C2gvzrRj.js";
...
import { v as resolveChannelStreamingBlockEnabled } from "../../channel-streaming-F827dQu5.js";
...
import { i as formatDurationSeconds } from "../../format-duration-Cp8WgTQc.js";
import { n as listChatCommands } from "../../commands-registry-list-X_Dq_EDj.js";
import { c as parseCommandArgs, d as serializeCommandArgs, i as formatCommandArgMenuTitle, l as resolveCommandArgChoices, n as buildCommandTextFromArgs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "../../commands-registry-4-T7usBZ.js";
import { t as finalizeInboundContext } from "../../inbound-context-b2ij61q1.js";
import { n as chunkItems } from "../../text-runtime-C_zPTqpT.js";
import { t as summarizeStringEntries } from "../../string-sample-PIwJz4Bf.js";
import { t as withTimeout } from "../../with-timeout-B0vltYGI.js";
import "../../routing-MIJf671J.js";
import { i as matchPluginCommand, n as executePluginCommand } from "../../commands-D1seeYBT.js";
...
import { c as buildAllowlistResolutionSummary, d as patchAllowlistUsersInConfigEntries, f as summarizeMapping, l as canonicalizeAllowlistWithResolvedIds, s as addAllowlistUserEntriesFromConfigEntry } from "../../allow-from-eZ6uedD3.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "../../runtime-group-policy-CaaZXWTO.js";
import { n as isDangerousNameMatchingEnabled } from "../../dangerous-name-matching-BqQgBxTG.js";
import { l as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "../../dm-policy-shared-C7MlRVkr.js";
...
import { r as registerChannelRuntimeContext } from "../../channel-runtime-context-Df9FvAE5.js";
...
import { n as dispatchReplyWithDispatcher } from "../../reply-dispatch-runtime-BMC9WmhZ.js";
...
import { n as wrapFetchWithAbortSignal } from "../../fetch-CjYRsrq8.js";
...
import { n as resolveConfiguredBindingRoute, t as ensureConfiguredBindingRouteReady } from "../../binding-routing-DeIvCySs.js";
import "../../conversation-binding-runtime-Dn64vcr8.js";
import "../../conversation-runtime-BKVIWKi4.js";
import { t as formatThreadBindingDurationLabel } from "../../thread-bindings-messages-D6s75YO9.js";
...
import { t as resolveDirectStatusReplyForSession } from "../../command-status-runtime-BcttsOCf.js";
...
import { c as resolveDiscordAccountAllowFrom, d as resolveDiscordAccountDmPolicy, f as resolveDiscordMaxLinesPerMessage, s as resolveDiscordAccount } from "./accounts-BdhTprtd.js";
import { a as chunkDiscordTextWithMode } from "./normalize--W8rXVCt.js";
import { a as resolveDiscordModalEntryWithPersistence, i as resolveDiscordComponentEntryWithPersistence, t as editDiscordComponentMessage } from "./send.components-BvPYqZPy.js";
import { c as setPresence, i as unregisterGateway, r as registerGateway } from "./gateway-registry-BI27950v.js";
import { B as StringSelectMenu, Bt as GatewayOpcodes, E as Modal, Ft as ChannelType, It as ComponentType, L as Row, Lt as GatewayCloseCodes, Nt as ApplicationCommandOptionType, Pt as ButtonStyle, Rt as GatewayDispatchEvents, S as User, V as TextDisplay, W as BaseMessageInteractiveComponent, a as PresenceUpdateListener, b as Guild, c as ThreadUpdateListener, d as Plugin, i as MessageReactionRemoveListener, j as Container, k as Button, m as RateLimitError, n as MessageCreateListener, o as ReadyListener, r as MessageReactionAddListener, t as InteractionCreateListener, u as Client, v as Command, x as Message, y as CommandWithSubcommands, z as Separator, zt as GatewayIntentBits } from "./discord-DNYGprx_.js";
import { L as DISCORD_REST_TIMEOUT_MS, N as createDiscordRestClient, R as validateDiscordProxyUrl, z as withValidatedDiscordProxy } from "./send.shared-BpE_bsDW.js";
import { a as summarizeDiscordResponseBody, i as isDiscordRateLimitResponseBody } from "./api-ClqnPTU5.js";
import { n as formatDiscordUserTag, t as formatDiscordReactionEmoji } from "./format-DPL1Yf7k.js";
import { _ as resolveGroupDmAllow, a as normalizeDiscordSlug, c as resolveDiscordChannelConfigWithFallback, d as resolveDiscordGuildEntry, f as resolveDiscordMemberAccessState, i as normalizeDiscordDisplaySlug, l as resolveDiscordChannelPolicyCommandAuthorizer, m as resolveDiscordOwnerAccess, n as isDiscordGroupAllowedByPolicy, o as resolveDiscordAllowListMatch, r as normalizeDiscordAllowList, v as shouldEmitDiscordReactionNotification } from "./allow-list-CRbbXQZ1.js";
import { t as formatMention } from "./mentions-fNN4W3yt.js";
import { g as parseDiscordModalCustomIdForInteraction, h as parseDiscordModalCustomId, m as parseDiscordComponentCustomIdForInteraction, p as parseDiscordComponentCustomId } from "./components-VqLEVMG0.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers } from "./approval-shared-Cx16UC51.js";
import "./approval-native-BXAeod8x.js";
import { t as resolveDiscordConversationIdentity } from "./conversation-identity-CpATZVGr.js";
...
import { a as isThreadArchived } from "./thread-bindings.discord-api-D5qujrUh.js";
import { i as resolveDiscordChannelParentIdSafe, n as resolveDiscordChannelInfoSafe, o as resolveDiscordChannelTopicSafe, r as resolveDiscordChannelNameSafe, t as resolveDiscordChannelIdSafe } from "./channel-access-hETTFyJd.js";
import { r as parseApplicationIdFromToken, t as fetchDiscordApplicationId } from "./probe-2ix0AU-L.js";
import { o as raceWithTimeout, s as withAbortTimeout } from "./timeouts-BLUScEjz.js";
import { c as resolveDiscordChannelInfo } from "./message-utils-BDqdZWgf.js";
import { s as resolveDiscordThreadParentInfo } from "./threading-DJQIlRqr.js";
import { c as resolveDiscordDmAccessGroupEntries, i as resolveDiscordEffectiveRoute, n as resolveDiscordBoundConversationRoute, o as handleDiscordDmCommandDecision, s as resolveDiscordDmCommandAccess } from "./route-resolution-E-zLi1a_.js";
import { t as resolveDiscordSenderIdentity } from "./sender-identity-mUjmYgYO.js";
import { n as buildDiscordInboundAccessContext, t as buildDiscordGroupSystemPrompt } from "./inbound-context-BB0XPDdD.js";
import { n as resolveDiscordVoiceEnabled, t as authorizeDiscordVoiceIngress } from "./access-BDx3HGJb.js";
import { n as buildDirectLabel, r as buildGuildLabel, t as deliverDiscordReply } from "./reply-delivery-DaoI7PK6.js";
import "./approval-handler.runtime-GvbcDOcS.js";
...
async function loadConversationRuntime$1() {
	conversationRuntimePromise$1 ??= import("./agent-components.runtime-VZxjEoJ7.js");
...
async function loadTypingRuntime() {
	typingRuntimePromise ??= import("./typing-BTdbASd8.js");
...
async function loadConversationRuntime() {
	conversationRuntimePromise ??= import("./agent-components.runtime-VZxjEoJ7.js");
...
async function loadComponentsRuntime() {
	componentsRuntimePromise ??= import("./components-BlnheE4o.js");
...
async function loadDiscordVoiceRuntime() {
	const promise = discordVoiceRuntimePromise ?? import("./manager.runtime-BxJz1pls.js");
...
async function loadDiscordProviderSessionRuntime() {
	const promise = discordProviderSessionRuntimePromise ?? import("./provider-session.runtime-CUwgAC00.js");
