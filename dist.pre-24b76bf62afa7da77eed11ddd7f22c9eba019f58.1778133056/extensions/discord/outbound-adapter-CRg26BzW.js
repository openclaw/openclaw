...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "../../reply-payload-C2gvzrRj.js";
import { n as resolveOutboundSendDep } from "../../send-deps-DVwwo0GW.js";
import { n as retryAsync, t as resolveRetryConfig } from "../../retry-iwEa_js_.js";
import "../../text-runtime-C_zPTqpT.js";
import "../../outbound-runtime-73MBmy8y.js";
...
import { s as resolveDiscordAccount } from "./accounts-BdhTprtd.js";
import { a as chunkDiscordTextWithMode, i as normalizeDiscordOutboundTarget } from "./normalize--W8rXVCt.js";
import { p as DiscordError } from "./discord-DNYGprx_.js";
import { s as readDiscordComponentSpec } from "./components-VqLEVMG0.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-DEKki9np.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-DcHZtrM7.js");
...
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-D0lWj9f_.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-W7tEPXtF.js");
