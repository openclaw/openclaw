...
import { g as maxBytesForKind, r as extensionForMime } from "../../mime-CeZSHsWQ.js";
import { n as fetchWithSsrFGuard } from "../../fetch-guard-CmN33efq.js";
import { n as loadWebMediaRaw } from "../../web-media-Dtu8V8bA.js";
import "../../temp-path-D5yZLChq.js";
import { c as parseFfprobeCodecAndSampleRate, d as runFfprobe, f as MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS, u as runFfmpeg } from "../../runner.entries-AcpqMe0-.js";
...
import { s as unlinkIfExists } from "../../media-runtime-CfGiZyk2.js";
import { s as resolveDiscordAccount } from "./accounts-BdhTprtd.js";
import { $ as createThread, At as removeGuildMember, Ct as listGuildActiveThreads, Dt as listGuildScheduledEvents, Et as listGuildRoles, Ft as ChannelType, Mt as timeoutGuildMember, Ot as moveGuildChannels, Q as createChannelMessage, St as getGuildVoiceState, Tt as listGuildEmojis, X as deleteOwnMessageReaction, Y as createOwnMessageReaction, Z as listMessageReactionUsers, _ as readRetryAfter, _t as createGuildScheduledEvent, at as getChannelMessage, ct as listChannelPins, dt as sendChannelTyping, et as deleteChannel, ft as unpinChannelMessage, g as readDiscordMessage, gt as createGuildEmoji, h as readDiscordCode, ht as createGuildChannel, it as getChannel, jt as removeGuildMemberRole, kt as putChannelPermission, lt as pinChannelMessage, m as RateLimitError, mt as createGuildBan, nt as editChannel, ot as listChannelArchivedThreads, p as DiscordError, pt as addGuildMemberRole, rt as editChannelMessage, st as listChannelMessages, tt as deleteChannelMessage, ut as searchGuildMessages, vt as createGuildSticker, wt as listGuildChannels, xt as getGuildMember, yt as deleteChannelPermission } from "./discord-DNYGprx_.js";
import { F as resolveDiscordClientAccountContext, I as resolveDiscordRest, M as createDiscordClient, S as DISCORD_MAX_STICKER_BYTES, b as DISCORD_MAX_EMOJI_BYTES, i as formatReactionEmoji, k as parseAndResolveRecipient, l as resolveChannelId, o as normalizeEmojiName, r as buildReactionIdentifier, s as normalizeReactionEmoji, t as buildDiscordSendError, x as DISCORD_MAX_EVENT_COVER_BYTES } from "./send.shared-BpE_bsDW.js";
import { n as rewriteDiscordKnownMentions } from "./mentions-fNN4W3yt.js";
import "./send.outbound-Dki45WTU.js";
