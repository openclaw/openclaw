...
import { n as normalizeAtHashSlug } from "../../string-normalization-BeeXgDIU.js";
import { n as sleepWithAbort } from "../../backoff-EZ9FB6Sd.js";
...
import { n as resolveTargetsWithOptionalToken } from "../../target-resolvers-KI3MmWur.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "../../allowlist-config-edit-DuPYnbCQ.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-BdhTprtd.js";
import "./channel-api-DZ2B56Xv.js";
import { n as looksLikeDiscordTargetId, o as parseDiscordTarget, r as normalizeDiscordMessagingTarget } from "./normalize--W8rXVCt.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DIf9PE9b.js";
import { t as getDiscordRuntime } from "./runtime-BFBZ7_CY.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-Cx16UC51.js";
import { t as getDiscordApprovalCapability } from "./approval-native-BXAeod8x.js";
import { t as discordMessageActions$1 } from "./channel-actions-CSaBN333.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-CpATZVGr.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BpMhA3J9.js";
import { n as discordOutbound } from "./outbound-adapter-CRg26BzW.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BjzB6Oat.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-DmT3IFw5.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-DyUBHheN.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-BWTA10k6.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Tt_tknTc.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-Bn4DXH-U.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-ChDcOKBg.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-CeSr3cTP.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-Ct5gDNVx.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-D0lWj9f_.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-PS-lly-b.js");
