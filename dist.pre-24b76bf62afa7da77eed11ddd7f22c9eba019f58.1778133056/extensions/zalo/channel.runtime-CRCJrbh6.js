...
import "./accounts-BEJ0g8Vm.js";
import "./runtime-api-CAaoSXmV.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CarM72vX.js";
import { t as sendMessageZalo } from "./send-BHppnjwV.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-zTCwH46t.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CUHW2bCz.js");
