...
import { D as patchTopLevelChannelConfigSection, f as createStandardChannelSetupStatus } from "../../setup-wizard-helpers-BmlH_00g.js";
...
import { t as NostrConfigSchema } from "./config-schema-De4lhve_.js";
...
const nostrSetupWizard = createDelegatedSetupWizardProxy({
	channel,
	loadWizard: async () => (await import("./setup-surface-CYYhkEBw.js")).nostrSetupWizard,
