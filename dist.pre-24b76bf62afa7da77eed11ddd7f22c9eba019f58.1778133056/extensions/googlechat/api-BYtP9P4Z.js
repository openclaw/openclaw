...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "../../ssrf-policy-CrjaYWnM.js";
import "../../ssrf-runtime-BoUUJCOc.js";
import "./runtime-api-Wbma5L9H.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("../../src-CZWKMs2T.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("../../src-DDDZTK-x.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
			return {
