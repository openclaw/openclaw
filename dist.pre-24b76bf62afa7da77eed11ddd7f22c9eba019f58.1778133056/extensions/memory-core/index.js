...
import { t as resolveMemoryBackendConfig } from "../../backend-config-OUIcY6Rw.js";
import "../../memory-core-host-runtime-core-B_iThT1A.js";
import "../../memory-core-host-runtime-files-B0-UteHW.js";
import { t as registerShortTermPromotionDreaming } from "../../dreaming-CE_0ALrI.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-B2AbuNaG.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CnX2EL5d.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-CChEK7iY.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-Bs5IRPQD.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-DB7KieWM.js");
