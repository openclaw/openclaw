...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "../../reply-payload-C2gvzrRj.js";
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "../../channel-streaming-F827dQu5.js";
...
import { c as resolveOpenDmAllowlistAccess } from "../../dm-policy-shared-C7MlRVkr.js";
...
import { i as installRequestBodyLimitGuard } from "../../http-body-DCt8LcT9.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "../../webhook-request-guards-DOcGOAX7.js";
...
import { t as buildFeishuConversationId } from "./conversation-id-BE1CYJ37.js";
import { i as resolveReceiveIdType } from "./targets-BuAOB0ZM.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-D4iEHdtN.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-i3bEMon3.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-DTRbkdf9.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-Dh2Pi5hZ.js";
import { t as getFeishuRuntime } from "./runtime-CSIaQLcd.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-Qb6clyKZ.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-Ck74MLKK.js";
import "./runtime-api-EnP7Ou0Z.js";
import { _ as shouldSuppressFeishuTextForVoiceMedia, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent, v as normalizeFeishuExternalKey } from "./send-C50dKHvj.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-dAKe4mW3.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-DeSDAATY.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-Cheh1yT-.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-Bu9bh2pB.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-Bu9bh2pB.js");
