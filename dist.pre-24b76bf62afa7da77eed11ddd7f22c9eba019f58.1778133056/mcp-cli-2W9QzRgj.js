...
import { u as normalizeMessageChannel } from "./message-channel-BWLnUh7o.js";
import { i as extractFirstTextBlock } from "./chat-message-content-BQXDN9PR.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-Bv5aMrm_.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-CRXTL898.js";
import { t as applyParentDefaultHelpAction } from "./parent-default-help-BjtfcuLF.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-DZn7n1_4.js"),
			import("./client-Bh0kIsmQ.js"),
			import("./client-start-readiness-fMjhwmBF.js"),
			import("./method-scopes-Dylc5ZTw.js"),
			import("./client-info-CxwQ1oIp.js")
		]);
