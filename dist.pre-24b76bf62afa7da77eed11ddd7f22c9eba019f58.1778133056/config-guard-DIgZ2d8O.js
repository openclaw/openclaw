...
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-DduCoLq2.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-AiJKMinR.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-BsrE3TNd.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		...
		import("./utils-r2Jg1zXX.js"),
		import("./command-format-DJsx2K9v.js")
	]);
	const rich = isRich();
