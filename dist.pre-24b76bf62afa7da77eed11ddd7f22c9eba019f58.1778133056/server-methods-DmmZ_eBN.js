...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-4T6nXEPg.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-05Z3mmpO.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-D4Z2yNv-.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-BpbQUiOb.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-eOlEQiLx.js";
import { n as sameFileIdentity } from "./safe-open-sync-DVjYf-SA.js";
import { i as readJsonFile, n as createAsyncLock, o as writeJsonAtomic } from "./json-files-DIcAKgYe.js";
...
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-CcV4Dk4n.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-_pFUNS2v.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-CT3W9zF0.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-BDbIgZdv.js";
import { n as ensureAuthProfileStore } from "./store-H1X3llav.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-QdD1oSti.js";
import { g as patchPluginSessionExtension } from "./loader-1TRSsxsu.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-Cp9gMSHI.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-DGj_H561.js";
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-BhHu0jrd.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-CU2gvvqC.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-yfdFay37.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-DFPf8LRE.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-DD03OJf3.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-CEC5JHmb.js";
import { h as stringifyRouteThreadId } from "./channel-route-DT81F24Z.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DqCZXuxt.js";
import { t as loadSessionStore } from "./store-load-u3EktAq0.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BkfWr-Uk.js";
import { n as mergeSessionEntry } from "./types-CciHzfwY.js";
import { o as updateSessionStore } from "./store-DypV6NYF.js";
import "./plugins-ChY-kMXQ.js";
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-CiMlHWga.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-D-lycPxU.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-9IUab6Ol.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-Bq8bZD-k.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CoNW3JiD.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-C7vNBEFy.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-C_5Cbc8u.js";
import "./auth-profiles-Ch3QVcfx.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-slbjBE7g.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-oqRhDCkA.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-f3ciQMEp.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-BDDAjvb2.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-DpdlvjD-.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-DKkpKM_m.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-CHWCg6-5.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-Dh4sJetX.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-BRUKOZBc.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-C_ey7AIg.js";
import { i as resolveSandboxConfigForAgent } from "./config-DcQ5eVSY.js";
import { t as extractToolPayload } from "./tool-payload-DOkt7AQ3.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-qMq38ZJB.js";
import { l as getTotalQueueSize } from "./command-queue-Dhp9ZwMn.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-aY6Qqinq.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-D8PYdrJu.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-CTLN9eio.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-QoMGdNjp.js";
import "./tts-CsN_ErDN.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Dxkfjv2N.js";
import { a as isTimeoutError } from "./failover-error-C0va7pTG.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-CCQW_Dx5.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-BoR9QwZB.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-D-YmeQla.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-ObqI4o0x.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-BjJbC-Fg.js";
import { i as parseAbsoluteTimeMs } from "./stagger-D59LMhh_.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-CmRMvdiM.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-B_61XCsb.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-CcFj9QsC.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-BD-R5kYp.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-CyzI_eCc.js";
import { n as normalizePollInput } from "./polls-BrJ3RoTA.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-CLsx9DAJ.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DkWROuXx.js";
import "./target-resolver-kox3kie_.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CoNWpz4_.js";
import { i as resolveReplyToMode } from "./reply-threading-DqhET9W9.js";
import { t as buildOutboundSessionContext } from "./session-context-Bd4VtqHH.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-BUOSsuwP.js";
import { n as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-b5-p-i3S.js";
import { r as resolveOutboundTarget } from "./targets-CTszVdf0.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-DZxrz5lc.js";
import { n as resolveAgentIdentity } from "./identity-BtZhHHvn.js";
import { s as clearSessionQueues } from "./queue-DreBzO1l.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-Cg8B3Sys.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DX3hMkne.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-DN3AyrXp.js";
import "./skills-BhHLGeAv.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BLX0HqR4.js";
import { t as compactEmbeddedPiSession } from "./compact.queued-Bdqsfnd3.js";
import "./pi-embedded-BXV_7L-Q.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-Z3L4r9fy.js";
import { n as resolveSendPolicy } from "./send-policy-Cn2uksTO.js";
import { t as canExecRequestNode } from "./exec-defaults-c2VmYdpo.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-_tLpA4R2.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-9dF02Nqk.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-D3xGasnI.js";
import { t as detectRespawnSupervisor } from "./supervisor-markers-B2isVJt7.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-BrMtKNgb.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-BAJ2NNiT.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-1IKNJDF4.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-X_Dq_EDj.js";
import "./commands-registry-4-T7usBZ.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CRW2tsIU.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-D1seeYBT.js";
import { t as getChannelActivity } from "./channel-activity-Ch-53b5x.js";
import { t as WizardCancelledError } from "./prompts-BTB-MajR.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-C4n0dSBO.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CyfSafsz.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-O0JNkAgY.js";
import { t as movePathToTrash } from "./browser-trash-V5pC7obm.js";
import "./browser-maintenance-BHcrQcOc.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-CEEFsg0F.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-BCkh0bT_.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-Bim53dGe.js";
import { r as agentCommandFromIngress } from "./agent-command-D42CqbDi.js";
...
import { t as formatForLog } from "./ws-log-BhixL7IP.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-Bc36PI4_.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-CsRKLD1r.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-5LiXgy9O.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-nPrRz-Re.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-WsERva4M.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-DZNI5nBZ.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-BhpD0q6O.js";
import { n as createOutboundSendDeps } from "./deps-8aUS_8MG.js";
import "./agent-DcbgB0-I.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-0IlhdVpB.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DzMpiNkN.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-CNr-JnyF.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-S3bJCT6s.js";
import "./server-constants-BRVZsYOl.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-Dud9o0me.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-C9_-UG2z.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DnXqW98t.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-DdNPUzAT.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-CsAwL0Kg.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-pq6xLqQ1.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-BzYgTkk2.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-5KyH5Qew.js";
import { a as performGatewaySessionReset } from "./session-reset-service-Cj-JGuhr.js";
import { t as buildChannelUiCatalog } from "./catalog-DPoxgOlk.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-sZep4RCL.js";
import { s as normalizeUpdateChannel } from "./update-channels-CW_zpZPK.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-BtaJqJ8V.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-QZgSl9pm.js";
import { t as readConfiguredLogTail } from "./log-tail-BGqLptLC.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-B976HZjZ.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-uPnp4BIO.js";
import { t as buildChannelAccountSnapshot } from "./status-fMeDAt7J.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-BAyp62ec.js";
import { t as installSkill } from "./skills-install-BhxKZrzF.js";
import { n as readPackageVersion } from "./package-json-MF5nwgQa.js";
import { t as getStatusSummary } from "./status.summary-tNadrxHz.js";
import "./status-Cpii4rt1.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CRWzimUh.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-CNkOU9Hi.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-D7b5wbo-.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-wMqsa8I8.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-Cdhoew3T.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DUAHTCdH.js";
import { t as diffConfigPaths } from "./config-diff-C_bqAJ36.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Cf3KO7OW.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-B35fsQEn.js";
import "./heartbeat-runner-sL3hQA17.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-Qe0jJ2VV.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-C8u8-yJr.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-DjPkvQPQ.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DSApIyK3.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-C4kMms0J.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-Q2bp-WCr.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-DhAZgcsX.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-BwjKw806.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-DvncpD8Q.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-3VPFqvCP.js");
