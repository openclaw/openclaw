...
import { a as coerceSecretRef, l as normalizeResolvedSecretInputString } from "./types.secrets-CyuYZNvB.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-05Z3mmpO.js";
...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-CrjaYWnM.js";
import "./ssrf-runtime-BoUUJCOc.js";
import "./retry-runtime-BLnodXbQ.js";
import "./secret-input-runtime-BlVIQ7VV.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CvUUeFHq.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BR0l6qga.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-B6VETqAO.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-D4fr9voD.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Bhwy4dXC.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-rh4-dpDt.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BNEPKJaq.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-Wm-LDJFa.js"), import("./logging-DnS1sWGc.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-CYesBErY.js").then((credentialsReadModule) => ({
