...
import { n as LogService } from "./logger-CrjgbblT.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-Q2Rxhrre.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-BJr6tofa.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-DF72nBmp.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
