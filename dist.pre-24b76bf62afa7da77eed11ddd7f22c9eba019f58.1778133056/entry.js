...
import { t as ensureOpenClawExecMarkerOnProcess } from "./openclaw-exec-env-CVnzxx8_.js";
...
function tryHandleRootVersionFastPath(argv, deps = {}) {
	...
	(deps.resolveVersion ?? (async () => {
		const [{ VERSION }, { resolveCommitHash }] = await Promise.all([import("./version-IzKgi5Mn.js"), import("./git-commit-CzR_SlyS.js")]);
		return {
			VERSION,
			resolveCommitHash
		};
...
async function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	try {
		...
		if (!(deps.outputPrecomputedRootHelpText ?? (await import("./root-help-metadata-AVPiCEiy.js")).outputPrecomputedRootHelpText)()) {
