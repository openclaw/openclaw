...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-eOlEQiLx.js";
...
import { i as isDiagnosticsEnabled, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-BoxUqA8f.js";
...
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-BWLnUh7o.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-_qxzpE3M.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-yfdFay37.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-CEC5JHmb.js";
import { t as loadSessionStore } from "./store-load-u3EktAq0.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-CciHzfwY.js";
import { b as resolveGroupSessionKey, o as updateSessionStore, p as resolveSessionStoreEntry, s as updateSessionStoreEntry } from "./store-DypV6NYF.js";
import "./sessions-CiMlHWga.js";
import { a as resolveContextTokensForModel } from "./context-Bi5VLtYy.js";
import { g as resolveResponseUsageMode, h as normalizeVerboseLevel } from "./thinking-C7vNBEFy.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-BBpFqu68.js";
import { t as isCliProvider } from "./model-selection-cli-Cd2NUvNJ.js";
import "./model-selection-BP-YASdB.js";
import { u as resolveModelAuthMode } from "./model-auth-Atvm_2TG.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-oqRhDCkA.js";
import { l as queueEmbeddedPiMessage } from "./runs-BDDAjvb2.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-BF7dLVyr.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-aNGDWajX.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-CcK39ra5.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-Cgh2zC6g.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-Csnw1cbR.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-63PmZyuJ.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-Deflawcb.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-Dhp9ZwMn.js";
import { a as resolveCliRuntimeExecutionProvider, t as isCliRuntimeAlias } from "./model-runtime-aliases-DkqdxDyR.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DmfxTApY.js";
import { u as stripHeartbeatToken } from "./heartbeat-BpClxfEZ.js";
import { o as isAudioFileName } from "./mime-CeZSHsWQ.js";
import { d as isLikelyExecutionAckPrompt } from "./selection-CTXbGEF_.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-B7muaM0t.js";
import "./pi-embedded-helpers-CxK3SDAv.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-gd-R0WfV.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-CTXilXy0.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-DhymM55y.js";
import { r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-B9Wakmgm.js";
import { d as parseReplyDirectives } from "./deliver-CCQW_Dx5.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-C2gvzrRj.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BgiFp2Cp.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-DJM7QqXq.js";
import { i as estimateMessagesTokens } from "./compaction-BaSN0Ktf.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-BUX26IFJ.js";
import { c as emitContinuationWorkSpan, i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-BSqUzMQw.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-ObqI4o0x.js";
import { a as enqueueSystemEvent } from "./system-events-BjJbC-Fg.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-CrkUwZFp.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-d3jgp6oX.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DqhET9W9.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BK1TAHiX.js";
import { n as hasCotFramePrefix } from "./normalize-reply-S9K702m1.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-Cu4gmb3e.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-DreBzO1l.js";
import "./sandbox-CdlmWe9c.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-BXV_7L-Q.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-DiQNx-bp.js";
import { r as enqueueCommitmentExtraction } from "./runtime-CV7273Vw.js";
import { n as resolveSendPolicy } from "./send-policy-Cn2uksTO.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-Dr1P_Rkh.js";
import { t as checkContextPressure } from "./context-pressure-BwO63Lg-.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-BIzzZcef.js";
import { t as formatProviderModelRef } from "./model-runtime-jYY9b6db.js";
import { t as runCliAgent } from "./cli-runner-DM6ulgu0.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BfZ9TYRO.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-rQHlLgNZ.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BsMCLuxm.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-C-zW0Bmk.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-CEqSyeHn.js";
import { n as incrementCompactionCount } from "./session-updates-DUvRMUpk.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-RdNrlN7M.js";
import { n as dispatchPostCompactionDelegates, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-Dtqw3pBf.js";
import { n as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-DqybuJml.js";
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-SjJujItQ.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-DxAw-Cqa.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-8VHNtGAy.js"),
					import("./config-Cllxlf4X.js"),
					import("./state-B7Nh5m6s.js"),
					import("./store-DTvRKV8_.js")
				]);
