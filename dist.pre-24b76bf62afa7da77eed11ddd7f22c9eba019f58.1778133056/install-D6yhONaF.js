...
import { o as unscopedPackageName, r as resolveSafeInstallDir } from "./install-safe-path-w-v-sDs-.js";
import { t as parseFrontmatter } from "./frontmatter-DjAQTyDu.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/hooks/install.ts
let hookInstallRuntimePromise;
async function loadHookInstallRuntime() {
	hookInstallRuntimePromise ??= import("./install.runtime-B1yncF0I.js");
