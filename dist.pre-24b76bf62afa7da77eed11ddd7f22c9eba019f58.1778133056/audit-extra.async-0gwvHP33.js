...
import { n as MANIFEST_KEY } from "./legacy-names-BDsJYoCc.js";
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-Cz0cd9aq.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-DzkVx2bZ.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-CE7dmb-f.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-DkskCKBT.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-DGkDHqbD.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-BxqWZXg_.js");
...
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-BN2x2bhc.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-CHJEZ6H1.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-BZcbEMJR.js");
