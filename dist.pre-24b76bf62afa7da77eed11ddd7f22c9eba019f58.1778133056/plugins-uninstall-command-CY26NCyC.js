...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-DbbG99N4.js");
	const { buildPluginSnapshotReport } = await import("./status-BlvEdZY_.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-C4m3rIXT.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-q6eEMg2R.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-DDo48QH4.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-D9wRxD_E.js");
	const { promptYesNo } = await import("./prompt-DjLk5tBQ.js");
