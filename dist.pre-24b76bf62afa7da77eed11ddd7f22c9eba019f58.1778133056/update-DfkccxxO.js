...
import { A as compareOpenClawReleaseVersions, F as parseRegistryNpmSpec, N as isPrereleaseResolutionAllowed } from "./discovery-B9FIOZR8.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-D5RUC2mj.js";
import { o as resolvePluginInstallDir } from "./install-paths-GsG77pMt.js";
import { c as resolveOfficialExternalPluginInstall, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-C7RR9_Z_.js";
import { i as resolveNpmSpecMetadata } from "./install-source-utils-DbqsFFbu.js";
import { n as recordPluginInstall, t as buildNpmResolutionInstallFields } from "./installs-B9-FJCIO.js";
import { i as parseComparableSemver, t as compareComparableSemver } from "./semver-compare-BvqqdvEU.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-BSknfB9K.js";
import { i as installPluginFromNpmSpec, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-DnWgVt52.js";
import { r as installPluginFromClawHub, t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-fT0HZ_Dj.js";
import { t as installPluginFromGitSpec } from "./git-install-Da2v_64q.js";
...
import { t as installPluginFromMarketplace } from "./marketplace-DtgJ8rhT.js";
import { n as installedPackageNeedsOpenClawPeerLinkRepair, r as readInstalledPackageVersion, t as expectedIntegrityForUpdate } from "./package-update-utils-B9WMt3UB.js";
...
function isTrustedSourceLinkedOfficialNpmUpdate(params) {
	...
	if (!officialPackageName || requestedPackageName !== officialPackageName) return false;
	return [
	...
	].filter((value) => Boolean(value)).includes(officialPackageName);
}
...
function resolveClawHubUpdateSpecs(params) {
	...
	return resolveClawHubInstallSpecsForUpdateChannel({
		spec: params.record.spec ?? `clawhub:${params.record.clawhubPackage}`,
		updateChannel: params.updateChannel
	});
}
