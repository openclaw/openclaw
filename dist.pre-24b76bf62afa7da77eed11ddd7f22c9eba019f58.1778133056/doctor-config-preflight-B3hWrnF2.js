...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-BqN-ccJq.js";
import { n as formatConfigIssueLines } from "./issue-format-CGWvAVH7.js";
import { t as note } from "./note-nUYTZrYm.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-BszXb8ID.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DGN8OYxC.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DZvjR4I_.js");
