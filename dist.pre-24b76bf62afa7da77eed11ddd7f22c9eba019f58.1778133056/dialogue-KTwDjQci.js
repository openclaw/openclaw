import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-CPggNyeY.js";
import { r as loadCrestodianOverview } from "./overview-DxfQLbuS.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-Bo-yaHkC.js")).planCrestodianCommand)({
		input,
		overview
	});
