...
import { s as resolvePluginContributionOwners } from "./plugin-registry-PrQukci_.js";
...
import { t as ConfigMutationConflictError } from "./mutate-BYCWuH5H.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CCA5t083.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-Dt87Ryhm.js";
import { n as applyAuthChoice } from "./auth-choice-DHUHybM8.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DYcHnYmR.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CZ-v9395.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CvJQHKLu.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BbijLpIP.js";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-Cv4BkxZz.js";
import { t as setupSkills } from "./onboard-skills-Cd8hNq2G.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-U49ijX5L.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-C1sI90Kr.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DMqP-UVi.js");
