...
import { g as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-eOlEQiLx.js";
...
import { a as freezeDiagnosticTraceContext, i as formatDiagnosticTraceparent, r as createDiagnosticTraceContextFromActiveScope, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-DNuC9Kq2.js";
...
import { X as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-BqN-ccJq.js";
import "./defaults-DadkqTRx.js";
import "./config-Cfbn58KU.js";
import { u as normalizeMessageChannel } from "./message-channel-BWLnUh7o.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-BA1pwiJV.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-DYjg_7Vd.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BX-QNwpy.js";
import { t as resolveAgentRuntimePolicy } from "./agent-runtime-policy-BeDMrz1y.js";
import { C as listRegisteredAgentHarnesses } from "./loader-1TRSsxsu.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-DU1OtlLp.js";
import { c as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-CNL1LAdZ.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BhHu0jrd.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-yfdFay37.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-BQXDN9PR.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-DPVQv4O7.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-B8Jm9zy4.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-17OsVJTk.js";
...
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-BDDAjvb2.js";
...
import { n as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-DVUpsh3o.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-CcK39ra5.js";
import { t as parseInlineDirectives } from "./directive-tags-DNq69blz.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-CRK2uWRh.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-C_ey7AIg.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-D_Qv5asT.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BPCCnNEV.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-Cgh2zC6g.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-DvGHVZV-.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-63PmZyuJ.js";
import { t as isCliRuntimeAlias } from "./model-runtime-aliases-DkqdxDyR.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DmfxTApY.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-BMfwpjPG.js";
import { C as isEmbeddedMode, S as stripProviderPrefix, x as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-aY6Qqinq.js";
...
import { m as MAX_IMAGE_BYTES } from "./mime-CeZSHsWQ.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-D0zypo9c.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CokY0CoU.js";
import { i as getPluginToolMeta } from "./tools-D8PYdrJu.js";
import { n as redactConfigObject } from "./redact-snapshot-CTLN9eio.js";
import { n as resolveCommitHash } from "./git-commit-Bk7Yoqg2.js";
import { t as resolveOsSummary } from "./os-summary-E1__UXHt.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-DfWqorok.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-Dc-PwgEV.js";
import { n as toTrajectoryToolDefinitions, r as getQueuedFileWriter, t as createTrajectoryRuntimeRecorder } from "./runtime-C0fjgZ_r.js";
...
import { t as isReasoningTagProvider } from "./provider-utils-BKlRh029.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-B7muaM0t.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Dxkfjv2N.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-KDTBY6yb.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-CA7RajE3.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-B9Wakmgm.js";
...
import { n as hasCommittedMessagingToolDeliveryEvidence, r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-6043AwaE.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-BgiFp2Cp.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-9e3g598Z.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-BaSN0Ktf.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CSESTJ98.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-BUjOko7N.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-1t8_fens.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-D9UoCSy8.js";
...
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DFZcYly_.js";
...
import "./tool-loop-detection-Bm5Lu5MX.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-PSG3LR4n.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CpmBsz1g.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-CtnmQWfj.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-5a9EriUl.js";
import { t as appendAgentBootstrapSystemPromptSupplement } from "./system-prompt-C-pTVNIY.js";
...
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-BDpYa9RD.js";
...
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as shouldUseOpenAIWebSocketTransportForAttempt, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-CCriyZzs.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-DuMsVqAv.js";
import { t as detectAndLoadPromptImages } from "./images-B7MkCmdb.js";
import { a as resolveRuntimeContextPromptParts, i as queueRuntimeContextForNextTurn, t as buildCurrentTurnPromptContextSuffix } from "./runtime-context-prompt-CuFLe0Ze.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-BPLgjpPY.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-DoeMjNZx.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-BZDRoJKm.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-D28sF8y1.js"));
