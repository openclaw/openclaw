...
import { t as attachChildProcessBridge } from "./child-process-bridge-UteASqvG.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Dxkfjv2N.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-BzF91TpB.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-1FktKTVA.js";
import { i as installCompletion } from "./completion-runtime-CaUgPN9Z.js";
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-B3Rt1aK5.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-CCA5t083.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-MrCElM2w.js";
...
import { n as TUI_SETUP_AUTH_SOURCE_ENV, t as TUI_SETUP_AUTH_SOURCE_CONFIG } from "./setup-launch-env-DnDArrI6.js";
...
function loadOnboardSearchModule() {
	onboardSearchModulePromise ??= import("./onboard-search-DMqP-UVi.js");
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DyoWdggs.js");
