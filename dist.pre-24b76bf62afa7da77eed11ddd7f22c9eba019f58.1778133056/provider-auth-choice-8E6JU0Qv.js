...
import { S as resolveDefaultAgentId, b as resolveAgentDir, x as resolveAgentWorkspaceDir } from "./agent-scope-eOlEQiLx.js";
import { t as sanitizeTerminalText } from "./safe-text-BZlsWMQt.js";
import { t as enablePluginInConfig } from "./enable-TPc00hsK.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CoNW3JiD.js";
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-e8xlsRP7.js";
import "./auth-profiles-Ch3QVcfx.js";
import { a as upsertAuthProfile } from "./profiles-C6chjHGz.js";
import "./workspace-Dxkfjv2N.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-6f1xpdbI.js";
import { n as openUrl } from "./browser-open-B3Rt1aK5.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-CY8J6PWA.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CudLYwyF.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CDzmgLVS.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-CHLtg0Is.js";
import { t as isRemoteEnvironment } from "./remote-env-BupMBWPu.js";
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-h1bW-V7Z.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-Bh_OskCo.js");
