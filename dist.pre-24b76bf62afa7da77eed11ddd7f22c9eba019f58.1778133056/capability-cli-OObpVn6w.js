...
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-DFanYIjE.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-Dl3nNEBT.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CcV4Dk4n.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-CQ3XcxPH.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-H1X3llav.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-C-2-t5P-.js";
import "./auth-profiles-Ch3QVcfx.js";
import { n as listProfilesForProvider } from "./profile-list-CVSfDnvE.js";
import { r as loadModelCatalog } from "./model-catalog-D3O5e8PY.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-CeZSHsWQ.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-QoMGdNjp.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-bnZLQWnk.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DFpVAueA.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-1FktKTVA.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DzbwdPCh.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-1IKNJDF4.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-DlzTvXPt.js";
...
import { t as collectOption } from "./helpers-Bu6tpk-p.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-BSlqqKJt.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-sZep4RCL.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-BR_hyW4I.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Caj3kNOO.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CAtlITjB.js");
