...
import { f as parseLegacySecretRefEnvMarker, r as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-CyuYZNvB.js";
...
import { r as normalizeProviderId$1 } from "./provider-id-DifICj6R.js";
import { i as setPathExistingStrict } from "./path-utils-BITS1ZaA.js";
import { n as discoverConfigSecretTargets } from "./target-registry-B906vNsP.js";
import { L as resolveNormalizedProviderModelMaxTokens, T as validateConfigObjectWithPlugins } from "./io-BqN-ccJq.js";
import { n as formatConfigIssueLines } from "./issue-format-CGWvAVH7.js";
import { r as normalizeTalkSection } from "./talk-rTC8aQqT.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-CYDoOvq5.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-DHGuiWHx.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-Ba99mplF.js";
import { n as getLoadedChannelPlugin } from "./registry-BkfWr-Uk.js";
import { i as listRouteBindings } from "./bindings-Cp38UWC-.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DkqdxDyR.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-CUtO9l1R.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-oQEQhSqG.js";
import { t as note } from "./note-nUYTZrYm.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-BszXb8ID.js";
import { t as applyPluginDoctorCompatibilityMigrations } from "./doctor-contract-registry-DrXCBvum.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, n as LEGACY_CONFIG_MIGRATIONS, o as loadBundledChannelDoctorContractApi, r as migrateLegacyWebSearchConfig } from "./legacy-config-issues-DGN8OYxC.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BAkioipr.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-B3hWrnF2.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CDYRbrQB.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-wMZTP8uP.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-XwoTv96R.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-Kb-eP9yZ.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-BcPRdsIA.js");
		emitDoctorNotes({
			note,
