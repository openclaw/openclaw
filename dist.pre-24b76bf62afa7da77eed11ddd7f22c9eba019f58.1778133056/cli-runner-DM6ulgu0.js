...
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-CTXilXy0.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-C0va7pTG.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-EMCS5efL.js";
import { i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-BmSQCiCx.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-Be6MS-vc.js");
