...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-yfdFay37.js";
...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-BO1p84Yi.js";
import { c as setDetachedTaskDeliveryStatusByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-DZxrz5lc.js";
import "./subagent-announce-queue-DrhO8fWr.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DbAOnumF.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-C_fx9ex8.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-SyH5LBfe.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-CW3-Udbx.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-DQYJ_3Mh.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-CW3-Udbx.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-B10HvLiH.js").then(({ scheduleOrphanRecovery }) => {
