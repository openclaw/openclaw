...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-4T6nXEPg.js";
import { n as normalizeAccountId } from "./account-id-05Z3mmpO.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-D4Z2yNv-.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-eOlEQiLx.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BqN-ccJq.js";
import { t as isWindowsDrivePath } from "./archive-path-ahtrDsFq.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-BPY-vj85.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-x4Wd_FUC.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-yfdFay37.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CEC5JHmb.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DqCZXuxt.js";
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-u3EktAq0.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BkfWr-Uk.js";
...
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-B8Jm9zy4.js";
import { S as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, x as modelKey } from "./model-selection-shared-BBpFqu68.js";
...
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-BF7dLVyr.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BIyIYz-B.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-Dh4sJetX.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-EvD7NRX-.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CAKoHGQn.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-C_ey7AIg.js";
...
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-CKNRYbHT.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-CeZSHsWQ.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-D8PYdrJu.js";
import { D as textToSpeech } from "./tts-runtime-QoMGdNjp.js";
import "./tts-CsN_ErDN.js";
import { a as getImageMetadata } from "./image-ops-Bt73y1bJ.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CTKoI6-Z.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-B2Q_yI6r.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-DDbbegbL.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-CYhh_pIb.js";
import { t as SsrFBlockedError } from "./ssrf-Cmvw-sAq.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DocDwfhK.js";
import { n as extractAssistantText } from "./pi-embedded-utils-BjtEeFth.js";
import { n as runWithImageModelFallback } from "./model-fallback-BgiFp2Cp.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-9e3g598Z.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-DZqX8QYm.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-CXSXxbyT.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-BFRyoFSV.js";
import { n as assertSandboxPath } from "./sandbox-paths-m3j0HSsc.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-CLLo_Zfx.js";
...
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-D-YmeQla.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-CGzUgGSI.js";
import { i as resolveMaxDelegatesPerTurn } from "./config-BUX26IFJ.js";
import "./targeting-4VeOvYYT.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-CrkUwZFp.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-Kjj0jFaN.js";
...
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-CmRMvdiM.js";
...
import { r as parseImageGenerationModelRef } from "./provider-registry-qYVmsy2h.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-qTIhCVPo.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-V9lTF6fE.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CpDOMY15.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-g48U1d_H.js";
import { l as saveMediaBuffer } from "./store-yK49THmd.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-DkLbdRZ1.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-Dtu8V8bA.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-DFygoMU0.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CjUfYn-S.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DtoI0-KV.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-bnZLQWnk.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BajJgvEz.js";
import { s as resolveTimeoutMs } from "./resolve-BCrFsWS4.js";
import { t as buildProviderRegistry } from "./runner-4tmd0YGV.js";
...
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-BD-R5kYp.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-DnVu66Fo.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-t-eIyUk4.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-djeAgLK2.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-DZxrz5lc.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CZ1dwr0K.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BJ8GVFjn.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-aA_G0LIx.js";
import { t as parseTimeoutMs } from "./parse-timeout-Cv1gd2_j.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-D3a79G2u.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BS8-omKD.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Cl9nMxGl.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DbAOnumF.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-C_fx9ex8.js";
import { p as registerSubagentRun } from "./subagent-registry-BGxGPL79.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-IwSf7yvd.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-2zVpFdIF.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-BEIm2l2o.js";
...
import { i as runWebSearch } from "./runtime-1FktKTVA.js";
import "./web-search-provider-common-DZgyRyNZ.js";
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-B8sG0DxT.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-CRFKGAHZ.js"));
