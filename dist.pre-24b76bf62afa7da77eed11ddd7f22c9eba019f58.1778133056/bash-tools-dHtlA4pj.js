...
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-CUEsxn1u.js";
import { b as escapeRegExp } from "./utils-CCskKJVV.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-4T6nXEPg.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-D4Z2yNv-.js";
import { a as logWarn, r as logInfo } from "./logger-CfoDhHSt.js";
import { J as resolveShellEnvFallbackTimeoutMs, K as getShellPathFromLoginShell } from "./io-BqN-ccJq.js";
import { U as splitShellArgs, d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-DVNAgbbb.js";
import { t as killProcessTree } from "./kill-tree-DJ2ZMRys.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-BWLnUh7o.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-DqCZXuxt.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-ths1BPNk.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-C_ey7AIg.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-63PmZyuJ.js";
import { o as failedTextResult, v as textResult } from "./common-DZqX8QYm.js";
import { t as callGatewayTool } from "./gateway-CXSXxbyT.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand, v as buildCommandPayloadCandidates, x as describeInterpreterInlineEval } from "./exec-approvals-allowlist-DUYdZgP4.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-D8kquDw_.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, _ as normalizeExecSecurity, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-BoR9QwZB.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-Cbzf7qtc.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-J4WDrfJh.js";
import "./delivery-context-zfhYzcsQ.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-CGzUgGSI.js";
import { t as sendMessage } from "./message-DA3u6vNb.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-Cg8B3Sys.js";
import { t as formatDurationCompact } from "./format-duration-Cp8WgTQc.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-evjo8_W6.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-BjEHnxrL.js";
import { t as getProcessSupervisor } from "./supervisor-DToxfbTM.js";
import { C as markExited, S as markBackgrounded, T as tail, _ as drainSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listFinishedSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as deleteSession, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getFinishedSession, w as setJobTtlMs, x as listRunningSessions, y as getSession } from "./bash-tools.exec-runtime-DsUG9oNt.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-vRv_3qk_.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-BMlYJglI.js";
import { n as detectPolicyInlineEval } from "./policy-mregFX_E.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-0IlhdVpB.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-DzMpiNkN.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-CCoaH2Fw.js";
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-C5Ar_nC2.js"));
