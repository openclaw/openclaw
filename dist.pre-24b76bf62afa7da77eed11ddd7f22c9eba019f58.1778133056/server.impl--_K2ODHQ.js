...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-p2fClQGo.js";
import { _ as sleep } from "./utils-CCskKJVV.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-BENAkAnN.js";
...
import { c as setDiagnosticsEnabledForProcess, i as isDiagnosticsEnabled } from "./diagnostic-events-BoxUqA8f.js";
...
import { g as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-BMdoYZVC.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-YLkbVqug.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-BB3qW0jS.js";
import { n as resolveGatewayAuth } from "./auth-resolve-CNSmX7Ye.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-BqN-ccJq.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CYc2CL3e.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-CcV4Dk4n.js";
import "./method-scopes-_pFUNS2v.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-CT3W9zF0.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-Dq--d3wY.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-QdD1oSti.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-BhHu0jrd.js";
import { i as resolveMainSessionKey } from "./main-session-DFPf8LRE.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-CLMDhyjG.js";
import "./sessions-CiMlHWga.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-oqRhDCkA.js";
import { g as stopDiagnosticHeartbeat, h as startDiagnosticHeartbeat } from "./diagnostic-UYxVLLff.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-D-YmeQla.js";
import { a as enqueueSystemEvent } from "./system-events-BjJbC-Fg.js";
import { i as CANVAS_HOST_PATH } from "./file-resolver-Ri8I9Jrw.js";
import { t as handleA2uiHttpRequest } from "./a2ui-BQzioe6C.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-BhixL7IP.js";
...
import { n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-BJDvPSX8.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-BRVZsYOl.js";
import { t as GatewayLockError } from "./gateway-lock-CU9Klr-6.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-MrCElM2w.js";
...
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-BGWNnnqY.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-B15VTIWH.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-DXGamXnb.js";
import { i as normalizeCanvasScopedUrl } from "./canvas-capability-Q2bp-WCr.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-HRRgBZvc.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-BxVzfXwn.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-tNfNSDiz.js";
...
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext, n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-DbwZ726V.js";
import "./paths-I_ZUXcWC.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-BwImZEjw.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DgWco7EL.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-DaHLThjy.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-1JPZ7u7w.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-D9lvKJsa.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-D8cv8jbV.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-IeFw6r9o.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-BqxbJpyZ.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DEx899BR.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-nGBP6uYv.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-DTtfV0j6.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-BbZeDnJG.js");
	return voiceClawRealtimeUpgradeModulePromise;
}
function getCanvasAuthModule() {
	canvasAuthModulePromise ??= import("./http-auth-B3j80Pcw.js");
	return canvasAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-O3dY7HZD.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DTRVfX8X.js");
...
async function createGatewayRuntimeState(params) {
	...
	try {
		...
		if (params.canvasHostEnabled) try {
			const { createCanvasHostHandler } = await import("./server-BpKD_cZx.js");
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-Bpl22qAI.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-np_DZgia.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-VLSXuM5O.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-mHAiPod8.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-C5HwI2cE.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-2T7U9zUe.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-DJ3UsfqB.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-DlLL-ykt.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-VLSXuM5O.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-a2ENf1gF.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-Bc827r9h.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-CAcfUfeK.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-DMNkSaoa.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-CPVZHfBW.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-Bd_la55-.js");
	...
	const { createChannelManager } = await import("./server-channels-DWaxc7wl.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-CFADJRnx.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-9d2Ow7H7.js"), import("./server-runtime-services-dCbsQe1b.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-DATyvWri.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-BPINnoOg.js"),
				import("./server-plugin-bootstrap-CQNeFRCW.js"),
				import("./services-C8-Gpg_s.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-c6iBMMPy.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-CQNeFRCW.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-DbHO9vYG.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-B4CHDZMi.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-DoeMjNZx.js");
