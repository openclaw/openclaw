...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-BDDAjvb2.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-DLpqBfQP.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-DCkBCQfX.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DmfxTApY.js";
import "./delivery-context-zfhYzcsQ.js";
import { n as resolveContinuationRuntimeConfig } from "./config-BUX26IFJ.js";
import { i as consumePendingDelegates } from "./delegate-store-CrkUwZFp.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CZ1dwr0K.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-BJ8GVFjn.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-C_fx9ex8.js";
import "./continuation-delegate-store-Dr1P_Rkh.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-B7Nh5m6s.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-C7czLeYD.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-QpUhK-S5.js"), import("./store-load-BDsY5Zgy.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-Dn0yHooA.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-CiYSlIGv.js");
			const { createSubsystemLogger } = await import("./subsystem-zIsdvoq_.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-B9Ue315Z.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
