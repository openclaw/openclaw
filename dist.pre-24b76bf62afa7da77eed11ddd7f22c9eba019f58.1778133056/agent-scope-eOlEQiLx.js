...
import { t as resolveAgentModelFallbackValues } from "./model-input-DmUH8dul.js";
import { o as parseAgentSessionKey } from "./session-key-utils-4T6nXEPg.js";
import { c as normalizeAgentId, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-D4Z2yNv-.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-BpbQUiOb.js";
import { t as resolveEffectiveAgentSkillFilter } from "./agent-filter-G-5tU91i.js";
import fs from "node:fs";
import path from "node:path";
//#region src/agents/agent-scope-config.ts
let defaultAgentWarned = false;
function warnMultipleDefaultAgents() {
	import("./subsystem-zIsdvoq_.js").then(({ createSubsystemLogger }) => {
