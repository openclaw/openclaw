...
import { a as resolveMatrixAccountConfig } from "./account-config-B6VETqAO.js";
import { t as getMatrixRuntime } from "./runtime-D5mS4nHe.js";
import { i as resolveMatrixAccount } from "./accounts-CxMT7zxB.js";
...
import { n as matrixSetupAdapter } from "./setup-core-DRqkjyCU.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-DjKwYV5O.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BORy_bDk.js";
import { t as withResolvedActionClient } from "./client-BI3OzGUP.js";
import { r as resolveMatrixAuthContext } from "./config-BJr6tofa.js";
import "./client-dcAHfAxS.js";
import "./runtime-api-CpEQFkE0.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-CqaHdY3s.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DID6S0ic.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-BiXAoiB_.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-C8ZxJwR0.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-Bh8fiaWR.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-CjBxdCWd.js");
