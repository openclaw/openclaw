...
import { t as getActiveMatrixClient } from "./active-client-WaXU0lw1.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DMzdKpn3.js"), import("./shared-C2ZBjLph.js")]).then(([clientModule, sharedModule]) => ({
