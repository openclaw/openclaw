---
summary: "Mullusi is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Mullusi to newcomers
title: "Mullusi"
---
...
<p align="center">
    <img
        src="/assets/mullusi-logo-text-dark.png"
        alt="Mullusi"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/mullusi-logo-text.png"
        alt="Mullusi"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Mullusi and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `mullusi onboard` and pairing flows.
  </Card>
...
Mullusi is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents like Pi. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
- Local default: [http://127.0.0.1:18790/](http://127.0.0.1:18790/)
- Remote access: [Web surfaces](/web) and [Tailscale](/gateway/tailscale)

<p align="center">
  <img src="/whatsapp-mullusi.jpg" alt="Mullusi" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.mullusi/mullusi.json`.

- If you **do nothing**, Mullusi uses the bundled Pi binary in RPC mode with per-sender sessions.
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@mullusi"] } },
}
```
