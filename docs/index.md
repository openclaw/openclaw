...
<<<<<<< HEAD
**What do you need?** Node 22+, an API key (Anthropic recommended), and an NVIDIA RTX 5060 Ti (16GB VRAM) if you plan to run autonomous agents with local heavy models.
=======
