...
| 2 | gemini | *(user configured)* | TO INSTALL LATER | `GEMINI_API_KEY` |
| 3 | openai | *(user configured)* | TO INSTALL LATER | `OPENAI_API_KEY` |
...
| Name | Package | API Key Needed | What It Does | Get Key |
|------|---------|---------------|-------------|---------|
| Gemini | *(varies)* | `GEMINI_API_KEY` | Google Gemini models | https://aistudio.google.com/apikey |
| OpenAI | *(varies)* | `OPENAI_API_KEY` | GPT models | https://platform.openai.com/api-keys |
