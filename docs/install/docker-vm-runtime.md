---
summary: "Shared Docker VM runtime steps for long-lived EVOX.sh Gateway hosts"
read_when:
  - You are deploying EVOX.sh on a cloud VM with Docker
...
EVOX.sh runs in Docker, but Docker is not the source of truth.
