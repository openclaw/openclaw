...
<Tip>
The bundled config at `deploy/railway/openclaw.json` sets
`gateway.controlUi.allowedOrigins` and `gateway.trustedProxies` for the
default Railway domain. If you use a custom domain, edit that file or
