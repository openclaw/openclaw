...
Deploy Activi on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/activi` — Control UI

## What you get

- Hosted Activi Gateway + Control UI
...
- `ACTIVI_STATE_DIR=/data/.activi` (recommended)
- `ACTIVI_WORKSPACE_DIR=/data/workspace` (recommended)
- `ACTIVI_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Activi state + workspace so you can migrate to another host without losing config or memory.
