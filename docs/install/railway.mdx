...
Deploy SmartAgentNeo on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/smart-agent-neo` — Control UI
...
- `SMART_AGENT_NEO_STATE_DIR=/data/.smart-agent-neo` (recommended)
- `SMART_AGENT_NEO_WORKSPACE_DIR=/data/workspace` (recommended)
- `SMART_AGENT_NEO_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your SmartAgentNeo state + workspace so you can migrate to another host without losing config or memory.
