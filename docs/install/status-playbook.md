...
| `playwright install chromium` errors inside Docker       | Container lacks browsers/system deps.                                                                                 | Rebuild the image with `OPENCLAW_DOCKER_APT_PACKAGES="ffmpeg ..."` or run the installer inside a persisted `/home/node`.                                                                                                         | Rebuild time               |
