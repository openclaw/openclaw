...
DNA ships three update channels:
...
When you **explicitly** switch channels with `--channel`, DNA also aligns
the install method:
...
When you switch channels with `dna update`, DNA also syncs plugin sources:
