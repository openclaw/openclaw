...
SmartAgentNeo ships three update channels:
...
When you **explicitly** switch channels with `--channel`, SmartAgentNeo also aligns
the install method:
...
When you switch channels with `smart-agent-neo update`, SmartAgentNeo also syncs plugin sources:
