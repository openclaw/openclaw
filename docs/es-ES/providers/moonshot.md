---
summary: "Configura Moonshot K2 vs Kimi Coding (proveedores + claves separados)"
read_when:
  - Quieres configuración de Moonshot K2 (Moonshot Open Platform) vs Kimi Coding
  - Necesitas entender endpoints, claves y referencias de modelo separados
  - Quieres configuración de copiar/pegar para cualquier proveedor
title: "Moonshot AI"
---
...
proveedor y establece el modelo por defecto a `moonshot/kimi-k2.5`, o usa
...
- Anula precios y metadatos de contexto en `models.providers` si es necesario.
