...
read_when:
  - Quieres usar Synthetic como proveedor de modelo
  - Necesitas configuración de clave API o URL base de Synthetic
title: "Synthetic"
---
...
El modelo predeterminado se establece a:
...
Nota: El cliente de Anthropic de OpenClaw agrega `/v1` a la URL base, así que usa
...
- Si habilitas una lista de modelos permitidos (`agents.defaults.models`), agrega cada modelo que
  planees usar.
- Consulta [Proveedores de modelo](/es-ES/concepts/model-providers) para las reglas del proveedor.
