...
If you searched for things like `self-hosted AI assistant`, `Discord AI bot`,
`Telegram AI bot`, `WhatsApp AI gateway`, `MCP-compatible gateway`, or
`browser automation assistant`, start with [FAQ (concepts)](/help/faq) and
