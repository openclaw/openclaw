...
You can also set `DNA_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `dna config get agents.defaults.models`
...
If you can, include the relevant log tail from `dna logs --follow`.
