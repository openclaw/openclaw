...
- `OPENCLAW_AGENT_ID`: set for commands run through the `exec` tool when an agent id is available (e.g., `it`). This allows scripts to reliably identify the calling agent.
