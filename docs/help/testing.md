...
- `OPENCLAW_CONFIG_DIR=...` (default: `./volumes/config` from the repo root) mounted to `/home/node/.openclaw`
- `OPENCLAW_WORKSPACE_DIR=...` (default: `./volumes/workspace` from the repo root) mounted to `/home/node/.openclaw/workspace`
