---
summary: "Frequently asked questions about DNA setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up DNA?](#whats-the-recommended-way-to-install-and-set-up-dna)
  ...
  - [I can't access docs.molt.bot (SSL error). What now?](#i-cant-access-docsdna-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or dna not recognized](#windows-install-says-git-not-found-or-dna-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install DNA on Linux?](#how-do-i-install-dna-on-linux)
  - [How do I install DNA on a VPS?](#how-do-i-install-dna-on-a-vps)
  ...
  - [If I buy a Mac mini to run DNA, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-dna-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different DNAs?](#can-multiple-people-use-one-whatsapp-number-with-different-dnas)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run DNA on a dedicated machine?](#how-important-is-it-to-run-dna-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run DNA in a VM and what are the requirements](#can-i-run-dna-in-a-vm-and-what-are-the-requirements)
- [What is DNA?](#what-is-dna)
  - [What is DNA, in one paragraph?](#what-is-dna-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for DNA](#what-are-the-top-five-everyday-use-cases-for-dna)
  - [Can DNA help with lead gen outreach ads and blogs for a SaaS](#can-dna-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can DNA run tasks on a schedule or continuously in the background?](#can-dna-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with DNA saved locally?](#is-all-data-used-with-dna-saved-locally)
  - [Where does DNA store its data?](#where-does-dna-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall DNA?](#how-do-i-completely-uninstall-dna)
...
- [Config basics](#config-basics)
  ...
  - [Can the DNA browser run headless?](#can-the-dna-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two DNAs talk to each other (local + VPS)?](#can-two-dnas-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does DNA load environment variables?](#how-does-dna-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of DNAs one CEO and many agents](#is-there-a-way-to-make-a-team-of-dnas-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset DNA but keep it installed?](#how-do-i-completely-reset-dna-but-keep-it-installed)
  ...
  - [Why doesn’t DNA reply in a group?](#why-doesnt-dna-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `dna gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-dna-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `dna gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-dna-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run DNA in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-dna-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart DNA?](#i-closed-my-terminal-on-windows-how-do-i-restart-dna)
  ...
  - [ELI5: `dna gateway restart` vs `dna gateway`](#eli5-dna-gateway-restart-vs-dna-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose DNA to inbound DMs?](#is-it-safe-to-expose-dna-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/dna/dna-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ```bash
   dna health --json
   dna health --verbose   # shows the target URL + config path on errors
   ```
...
This installs DNA **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/dna/dna/issues
https://github.com/dna/dna/pulls
...
What they do:
- `dna status`: quick snapshot of gateway/agent health + basic config.
- `dna models status`: checks provider auth + model availability.
- `dna doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `dna status --all`, `dna logs --follow`,
`dna gateway status`, `dna health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up DNA
...
If you don’t have a global install yet, run it via `pnpm dna onboard`.
...
- If it asks for auth, run `dna dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `DNA_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `dna gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `dna gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `dna dashboard`.
...
1) Install DNA on the new machine.
2) Copy `$DNA_STATE_DIR` (default: `~/.dna`) from the old machine.
3) Copy your workspace (default: `~/clawd`).
4) Run `dna doctor` and restart the Gateway service.
...
under `~/.dna/` (for example `~/.dna/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-dna-store-its-data),
...
https://github.com/dna/dna/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docsdna SSL error What now
...
detail: [Troubleshooting](/help/troubleshooting#docsdna-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/dna/dna/tree/main/docs
...
### Windows install says git not found or dna not recognized
...
**2) dna is not recognized after install**
...
dna update
dna update status
dna update --channel stable|beta|dev
dna update --tag <dist-tag|version>
dna update --no-restart
```

If you must automate from an agent:

```bash
dna update --yes --no-restart
dna gateway restart
```
...
`dna onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run DNA with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `dna models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `dna models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `dna models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. DNA no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so DNA can keep replying while a provider is rate‑limited.
...
DNA supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. DNA fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `dna.json`.

Steps:
1) Enable the plugin: `dna plugins enable google-gemini-cli-auth`
2) Login: `dna models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. DNA needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. DNA runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. DNA’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run DNA can I connect it to my MacBook Pro
...
- Use `dna nodes status` / `dna nodes list` to see it.
...
- DM your bot, then run `dna logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different DNAs
...
If you run DNA via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the DNA code install. Your state
(`~/.dna`) and workspace (`~/clawd`) stay untouched.
...
**DNA-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run DNA on a dedicated machine
...
DNA is lightweight. For a basic Gateway + one chat channel:
...
### Can I run DNA in a VM and what are the requirements
...
### What is DNA in one paragraph

DNA is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

DNA is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for DNA
...
### Can DNA help with lead gen outreach ads and blogs for a SaaS
...
DNA draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

DNA is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use DNA when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.dna/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.dna/dna.json`). Precedence is `<workspace>/skills` > `~/.dna/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.dna/dna.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.dna/skills` → bundled → `skills.load.extraDirs`. `clawdhub` installs into `./skills` by default, which DNA treats as `<workspace>/skills`.
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `DNA_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
dna cron run <jobId> --force
dna cron runs --id <jobId> --limit 50
```
...
### Can DNA run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.dna.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-dna-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. DNA can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.dna/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"dna":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (DNA only needs stdio). See [iMessage](/channels/imessage).
...
ClawdHub installs into `./skills` under your current directory (or falls back to your configured DNA workspace); DNA treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.dna/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawdHub](/tools/clawdhub).
...
```bash
dna browser extension install
dna browser extension path
```
...
DNA memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

DNA also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, DNA auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, DNA
prefers `local`.
...
### Is all data used with DNA saved locally

No - **DNA’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.dna` + your workspace directory).
...
### Where does DNA store its data

Everything lives under `$DNA_STATE_DIR` (default: `~/.dna`):

| Path | Purpose |
|------|---------|
| `$DNA_STATE_DIR/dna.json` | Main config (JSON5) |
| `$DNA_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$DNA_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$DNA_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$DNA_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$DNA_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$DNA_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$DNA_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |

Legacy single‑agent path: `~/.dna/agent/*` (migrated by `dna doctor`).
...
These files live in the **agent workspace**, not `~/.dna`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.dna`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.dna/skills`).
...
Do **not** commit anything under `~/.dna` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall DNA
...
`workspace` to the repo root. The DNA repo is just source code; keep the
...
DNA reads an optional **JSON5** config from `$DNA_CONFIG_PATH` (default: `~/.dna/dna.json`):
...
Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `DNA_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `dna doctor --generate-gateway-token`.
...
key. **Recommended:** run `dna configure --section web` to store it in
...
- Daemons read env vars from `~/.dna/.env` (or the service environment).
...
### Can the DNA browser run headless
...
Check the basics:
- Gateway is running: `dna gateway status`
- Gateway health: `dna status`
- Channel health: `dna channels status`
...
### Can two DNAs talk to each other local VPS
...
`dna agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
dna agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.dna/dna.json`).
- If you have no backup, re-run `dna doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `dna config set` for small changes.
- Use `dna configure` for interactive edits.
...
### How does DNA load environment variables

DNA reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.dna/.env` (aka `$DNA_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.dna/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`DNA_LOAD_SHELL_ENV=1`, `DNA_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`dna models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means DNA won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.dna/.env`:
   ```
...
### Is there a way to make a team of DNAs one CEO and many agents
...
### How do I completely reset DNA but keep it installed
...
```bash
dna reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `DNA_PROFILE`), reset each state dir (defaults are `~/.dna-<profile>`).
- Dev reset: `dna gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
No. DNA runs on **your own account**, so if you’re in the group, DNA can see it.
...
```bash
dna directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt DNA reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.dna/agents/<agentId>/sessions/`.
...
- Use `dna doctor` to spot stray workspaces and profile mismatches.
...
DNA’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, DNA currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `dna models set ...` (updates just model config)
- `dna configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.dna/dna.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `dna doctor` to repair.
...
Yes. DNA ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
Fix options:
- Run `dna agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so DNA can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.dna/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.dna/agent/*` (migrated by `dna doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.dna/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `dna models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `dna models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `dna models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.dna/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    dna models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), DNA will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: DNA now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
DNA uses provider‑prefixed IDs like:
...
DNA may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `dna models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
dna models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
dna models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
dna models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
dna models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > DNA_GATEWAY_PORT > gateway.port > default 18789
```

### Why does dna gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `dna gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does dna gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `DNA_STATE_DIR` mismatch).

Fix:
```bash
dna gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

DNA enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `dna gateway --port <port>`.

### How do I run DNA in remote mode client connects to a Gateway elsewhere
...
Notes:
- `dna gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `dna.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `dna dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `dna doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `DNA_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `dna status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `DNA_CONFIG_PATH` (per‑instance config)
- `DNA_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):
- Use `dna --profile <name> …` per instance (auto-creates `~/.dna-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `dna --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.dna.*`, `dna-gateway-<profile>.service`, `DNA Gateway (<profile>)`).
...
```
dna tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$DNA_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.dna/logs/...`; profiles use `~/.dna-<profile>/logs/...`)
- Linux: `journalctl --user -u dna-gateway[-<profile>].service -n 200 --no-pager`
...
If you run the gateway manually, `dna gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart DNA
...
1) Is the Gateway running? `dna gateway status`
2) Is the Gateway healthy? `dna status`
3) Does the UI have the right token? `dna dashboard`
...
```bash
dna channels status
dna channels logs --channel telegram
```
...
### ELI5 dna gateway restart vs dna gateway

- `dna gateway restart`: restarts the **background service** (launchd/systemd).
- `dna gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `dna gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [DNA assistant setup](/start/clawd) and [Agent send](/tools/agent-send).

CLI sending:

```bash
dna message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose DNA to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `dna pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `dna pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `dna doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. DNA only replies to chats it receives or to explicit sends you trigger.
...
DNA blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In DNA, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/dna/dna/discussions).
