...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Hanzo Bot?](#whats-the-recommended-way-to-install-and-set-up-hanzo-bot)
  ...
  - [I can't access docs.hanzo.bot (SSL error). What now?](#i-cant-access-docshanzobot-ssl-error-what-now)
  ...
  - [How do I install Hanzo Bot on Linux?](#how-do-i-install-hanzo-bot-on-linux)
  - [How do I install Hanzo Bot on a VPS?](#how-do-i-install-hanzo-bot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Hanzo Bot to update itself?](#can-i-ask-hanzo-bot-to-update-itself)
  ...
  - [If I buy a Mac mini to run Hanzo Bot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-hanzo-bot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Hanzo Bot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-hanzo-bot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Hanzo Bot on a dedicated machine?](#how-important-is-it-to-run-hanzo-bot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Hanzo Bot in a VM and what are the requirements](#can-i-run-hanzo-bot-in-a-vm-and-what-are-the-requirements)
- [What is Hanzo Bot?](#what-is-hanzo-bot)
  - [What is Hanzo Bot, in one paragraph?](#what-is-hanzo-bot-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Hanzo Bot](#what-are-the-top-five-everyday-use-cases-for-hanzo-bot)
  - [Can Hanzo Bot help with lead gen outreach ads and blogs for a SaaS](#can-hanzo-bot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Hanzo Bot run tasks on a schedule or continuously in the background?](#can-hanzo-bot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Hanzo Bot saved locally?](#is-all-data-used-with-hanzo-bot-saved-locally)
  - [Where does Hanzo Bot store its data?](#where-does-hanzo-bot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Hanzo Bot?](#how-do-i-completely-uninstall-hanzo-bot)
...
- [Config basics](#config-basics)
  ...
  - [Can the Hanzo Bot browser run headless?](#can-the-hanzo-bot-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Hanzo Bot instances talk to each other (local + VPS)?](#can-two-hanzo-bot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Hanzo Bot load environment variables?](#how-does-hanzo-bot-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Hanzo Bot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-hanzo-bot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Hanzo Bot but keep it installed?](#how-do-i-completely-reset-hanzo-bot-but-keep-it-installed)
  ...
  - [Why doesn't Hanzo Bot reply in a group?](#why-doesnt-hanzo-bot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Hanzo Bot, Flawd, and Krill use for models?](#what-do-hanzo-bot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run Hanzo Bot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-hanzo-bot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Hanzo Bot?](#i-closed-my-terminal-on-windows-how-do-i-restart-hanzo-bot)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Hanzo Bot to inbound DMs?](#is-it-safe-to-expose-hanzo-bot-to-inbound-dms)
...
### What's the recommended way to install and set up Hanzo Bot
...
- **Tailscale Serve** (recommended): keep bind loopback, run `hanzo-bot gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
...
### I cant access docs.hanzo.bot SSL error What now
...
detail: [Troubleshooting](/help/troubleshooting#docsbotai-shows-an-ssl-error-comcastxfinity).
...
Hanzo Bot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Hanzo Bot fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Usually no. Hanzo Bot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.hanzo/bot/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.hanzo/bot/bot.json`). Precedence is `<workspace>/skills` > `~/.hanzo/bot/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.hanzo/bot/bot.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.hanzo/bot/skills` → bundled → `skills.load.extraDirs`. `skills-hub` installs into `./skills` by default, which Hanzo Bot treats as `<workspace>/skills`.
...
Use **Hanzo Skills Hub** (CLI) or drop skills into your workspace. The macOS Skills UI isn't available on Linux.
Browse skills at [https://skills.hanzo.bot](https://skills.hanzo.bot).

Install the Hanzo Skills Hub CLI (pick one package manager):
...
configure it. If you have a local model path configured and present, Hanzo Bot
prefers `local`.
...
Hanzo Bot reads an optional **JSON5** config from `$BOT_CONFIG_PATH` (default: `~/.hanzo/bot/bot.json`):
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `hanzo-bot doctor --generate-gateway-token`.
...
- Restore from backup (git or a copied `~/.hanzo/bot/bot.json`).
...
### Why doesnt Hanzo Bot reply in a group
...
- edit `agents.defaults.model` in `~/.hanzo/bot/bot.json`
...
- **Hanzo Bot + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Hanzo Bot assistant setup](/start/bot) and [Agent send](/tools/agent-send).
...
- Default behavior on DM-capable channels is **pairing**:
  ...
  - Approve with: `hanzo-bot pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `hanzo-bot pairing list <channel>` if a code didn't arrive.
...
Still stuck? Ask in [Discord](https://discord.gg/XthHQQj) or open a [GitHub discussion](https://github.com/hanzoai/bot/discussions).
