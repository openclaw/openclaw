---
summary: "Mattermost bot setup and Activi config"
read_when:
...
4. Configure Activi and start the gateway.
...
Use these target formats with `activi message send` or cron/webhooks:
