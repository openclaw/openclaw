...
Pair loop protection bounds rapid exchanges between two bot identities. It is a sliding-window rate guard, so slower exchanges below the budget can continue. An optional conversation-wide budget covers multi-bot storms.
