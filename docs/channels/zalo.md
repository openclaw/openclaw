...
- Install via CLI: `dna plugins install @dna/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `dna plugins install ./extensions/zalo`
   - From npm (if published): `dna plugins install @dna/zalo`
...
- Approve via:
  - `dna pairing list zalo`
  - `dna pairing approve zalo <CODE>`
...
- Example: `dna message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `dna channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `dna logs --follow`
