...
- Install: `openclaw plugins install npm:@openclaw/zalo --acknowledge-non-clawhub-install`
- Pinned version: `openclaw plugins install npm:@openclaw/zalo@2026.6.11 --acknowledge-non-clawhub-install`
