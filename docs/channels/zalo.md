...
- Install via CLI: `smart-agent-neo plugins install @smart-agent-neo/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `smart-agent-neo plugins install ./extensions/zalo`
   - From npm (if published): `smart-agent-neo plugins install @smart-agent-neo/zalo`
...
- Example: `smart-agent-neo message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `smart-agent-neo channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `smart-agent-neo logs --follow`
