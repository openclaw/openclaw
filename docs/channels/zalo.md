...
- Install via CLI: `activi plugins install @activi/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `activi plugins install ./extensions/zalo`
   - From npm (if published): `activi plugins install @activi/zalo`
...
- Example: `activi message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `activi channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `activi logs --follow`
