...
- Use `message action=poll-vote` to vote in a poll.
- Use `message action=poll-terminate` to close a poll (only the poll creator can close).
...
message action=poll-vote channel=signal target=+15551234567 messageId=1737630212345 targetAuthor=+15559999999 pollOption=[0,2]
message action=poll-vote channel=signal target=signal:group:<groupId> messageId=1737630212345 targetAuthor=uuid:<creator-uuid> pollOption=[1]
message action=poll-terminate channel=signal target=+15551234567 messageId=1737630212345
message action=poll-terminate channel=signal target=signal:group:<groupId> messageId=1737630212345
```
