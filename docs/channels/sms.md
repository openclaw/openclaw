...
- `POST` only.
- Pre-validation rate limit of 300 requests per minute per SMS account, webhook route, and resolved client address before signature validation (HTTP 429 above that).
