...
EVOX.sh treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

EVOX.sh “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, EVOX.sh can see that group and respond there.
...
Translation: allowlisted senders can trigger EVOX.sh by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@openclaw", "evox", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
