...
<AccordionGroup>
  <Accordion title="Mention gating notes">
    ...
    - Per-agent overrides: `agents.list[].groupChat.mentionPatterns` and `agents.list[].groupChat.mentionPatternsMode: "allow" | "deny"` (useful when multiple agents share a group).
