...
read_when:
  - You want SmartAgentNeo to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables SmartAgentNeo to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`smart-agent-neo onboard`) and `smart-agent-neo channels add` list optional channel plugins.
...
```bash
smart-agent-neo plugins install @smart-agent-neo/nostr
```

Use a local checkout (dev workflows):

```bash
smart-agent-neo plugins install --link <path-to-smart-agent-neo>/extensions/nostr
```
  ...
  "channels": {
    "nostr": {
      ...
      "profile": {
        ...
        "displayName": "SmartAgentNeo",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "smart-agent-neo@example.com",
        "lud16": "smart-agent-neo@example.com"
      }
    }
  }
}
