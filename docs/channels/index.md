---
summary: "Messaging platforms EVOX.sh can connect to"
read_when:
  - You want to choose a chat channel for EVOX.sh
...
EVOX.sh can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and EVOX.sh will route per chat.
