...
read_when:
  - Setting up Zalo Personal for Activi
...
- Install via CLI: `activi plugins install @activi/zalouser`
- Or from a source checkout: `activi plugins install ./extensions/zalouser`
...
- On startup, Activi resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `activi channels logout --channel zalouser && activi channels login --channel zalouser`
