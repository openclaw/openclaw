...
<AccordionGroup>
  ...
  <Accordion title="Auth and security subpaths">
    ...
    | `plugin-sdk/approval-reaction-runtime` | Hardcoded approval reaction bindings, reaction prompt payloads, reaction target stores, and local native exec prompt suppression |
