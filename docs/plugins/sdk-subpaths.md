...
are private-local.
  ...
  <Accordion title="Provider subpaths">
    ...
    | `plugin-sdk/embedding-provider-runtime-contract` | Typed contract for provider-owned text batching: `EmbeddingBatchChunk`, `EmbeddingBatchOptions`, and `EmbeddingProviderBatchRuntime` with `batchEmbed(...)` and `sourceWideBatchEmbed` |
