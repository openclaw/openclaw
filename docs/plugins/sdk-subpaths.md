...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/channel-lifecycle` | `createAccountStatusSink`, `createChannelRunQueue` including skipped-run cleanup hooks, and legacy draft stream lifecycle helpers. New preview finalization code should use `plugin-sdk/channel-message`. |
