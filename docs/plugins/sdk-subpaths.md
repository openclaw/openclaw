...
and pairing-path families.
  ...
  <Accordion title="Capability and testing subpaths">
    ...
    | `plugin-sdk/image-generation` | Image generation provider types plus image asset/data URL and OpenAI-compatible response helpers, including guarded URL image downloads |
