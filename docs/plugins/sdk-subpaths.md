...
<AccordionGroup>
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/codex-mcp-projection` | Bundled Codex plugin helper for projecting user MCP server config into Codex thread config |
    | `plugin-sdk/codex-native-task-runtime` | Bundled Codex plugin helper for mirroring native Codex task runs into OpenClaw's task registry |
