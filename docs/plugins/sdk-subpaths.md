...
| `plugin-sdk/live-visual`            | `LiveVisualProvider`, session/input/output contracts, and `resolveLiveVisualProvider` for realtime browser surfaces driven by caller-owned media                                                        |
