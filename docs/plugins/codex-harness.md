...
disallows `danger-full-access`, OpenClaw treats the implicit default as guardian
instead and selects an allowed guardian sandbox so it does not send a sandbox
override that Codex app-server will reject.
