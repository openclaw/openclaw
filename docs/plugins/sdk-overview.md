...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/config-runtime` | Config load/write helpers plus fallback-stable Telegram custom-command normalization/validation helpers |
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/config-runtime` | Config load/write helpers, including Telegram command-name/description normalization and duplicate/conflict checks when the bundled Telegram contract surface is unavailable |
