...
- **[gandr](/plugins/reference/gandr)** (`@openclaw/gandr-speech`) - npm; ClawHub: `clawhub:@openclaw/gandr-speech`. Gandr OpenAI compatible text-to-speech (MP3, WAV, PCM telephony).
