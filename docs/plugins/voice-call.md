...
read_when:
  - You want to place an outbound voice call from Activi
...
Voice calls for Activi via a plugin. Supports outbound notifications and
...
- Use `activi voicecall ...` or the `voice_call` tool
