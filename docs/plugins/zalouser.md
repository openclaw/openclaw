...
read_when:
  - You want Zalo Personal (unofficial) support in Mullusi
...
Zalo Personal support for Mullusi via a plugin, using native `zca-js` to automate a normal Zalo user account.
