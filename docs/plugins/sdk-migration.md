...
<Accordion title="Common import path table">
  ...
  | `plugin-sdk/config-runtime` | Config helpers | Config load/write helpers plus Telegram command-name normalization, description trimming, and duplicate/conflict validation |
  ...
  | `plugin-sdk/config-runtime` | Config helpers | Config load/write helpers, including fallback-stable Telegram command validation helpers when the bundled Telegram contract surface is unavailable |
