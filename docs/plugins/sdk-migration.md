...
<Accordion title="Common import path table">
  ...
  | `plugin-sdk/provider-transport-runtime` | Provider transport helpers | Native provider transport helpers such as guarded fetch, transport message transforms, tool-result replay helpers, and writable transport event streams |
