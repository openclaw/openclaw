...
<Accordion title="Common import path table">
  ...
  | `plugin-sdk/image-generation` | Image-generation helpers | Image generation provider types plus image asset/data URL and OpenAI-compatible response helpers, including guarded URL image downloads |
