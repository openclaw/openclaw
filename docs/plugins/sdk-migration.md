...
read_when:
  ...
  - You maintain an external EVOX.sh plugin
---

# Plugin SDK Migration

EVOX.sh has moved from a broad backwards-compatibility layer to a modern plugin
...
```bash
OPENCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING=1 evox gateway run
OPENCLAW_SUPPRESS_EXTENSION_API_WARNING=1 evox gateway run
```
