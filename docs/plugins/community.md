...
- **Berry Shield** — Runtime security governance for OpenClaw with mandatory `berry_check` gating and 6-layer protection (Root-to-Pulp) managed via a dedicated `bshield` CLI.
