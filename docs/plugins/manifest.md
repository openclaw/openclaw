...
read_when:
  - You are building a DNA plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (dna.plugin.json)

Every plugin **must** ship a `dna.plugin.json` file in the **plugin root**.
DNA uses this manifest to validate configuration **without executing plugin
