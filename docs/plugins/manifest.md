...
read_when:
  - You are building a Activi plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (activi.plugin.json)

Every plugin **must** ship a `activi.plugin.json` file in the **plugin root**.
Activi uses this manifest to validate configuration **without executing plugin
