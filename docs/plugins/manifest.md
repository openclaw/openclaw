...
| `supervisorGuidance`                 | No       | `object`                     | Static, versioned display-only external-supervisor instructions supplied by the plugin package. Exactly one enabled plugin may provide valid guidance. See [Supervisor guidance](/plugins/manifest/surfaces#supervisor-guidance).                                                                                                                                                                |
