...
read_when:
  - You are building a EasyHub plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (EasyHub.plugin.json)

Every plugin **must** ship a `EasyHub.plugin.json` file in the **plugin root**.
EasyHub uses this manifest to validate configuration **without executing plugin
