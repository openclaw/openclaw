...
`workspacePromptSurface` accepts:

| Value                | Effect                                                                                                                                                                                                                      |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `"per_turn_context"` | Default. `SOUL.md`, `IDENTITY.md`, `TOOLS.md`, `USER.md`, `MEMORY.md`, and active `BOOTSTRAP.md` are included as current turn context. This preserves edit freshness and the legacy quality-first behavior.                 |
| `"thread_developer"` | Promotes only `SOUL.md`, `IDENTITY.md`, `TOOLS.md`, and `USER.md` into Codex thread developer instructions. This reduces repeated turn tokens and gives stable profile files higher priority, but changes prompt authority. |
