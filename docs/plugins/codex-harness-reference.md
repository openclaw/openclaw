...
with the official plugin (currently `@openai/codex` `0.153.1`):
...
The plugin manages stable Codex app-server `0.153.1`. Explicit custom
...
This preview path uses the pinned Codex `0.153.1` app-server.
