...
configured and defaults to 60 seconds otherwise. Replay-safe stdio app-server
...
the OpenClaw session lane, but they are surfaced for user or maintainer judgment
instead of being replayed automatically. Timeout diagnostics include the last
