...
probe against the official `0.156.1` app-server verified this public subset of
picker rows:

| Model id        | Input modalities | Reasoning efforts                    |
| --------------- | ---------------- | ------------------------------------ |
| `gpt-6-astra`   | text, image      | low, medium, high, xhigh, max, ultra |
| `gpt-6-sol`     | text, image      | low, medium, high, xhigh, max, ultra |
| `gpt-6-luna`    | text, image      | low, medium, high, xhigh, max        |
