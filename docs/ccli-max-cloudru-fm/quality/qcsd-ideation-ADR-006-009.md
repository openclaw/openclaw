...
| X-089-5 | ADR-009 TenantId uses (platform, userId, chatId?) while ADR-008 TenantId is a string "tg\_{userId}". Format mismatch                                   | 3   | 3   | Test: verify ADR-009 TenantId.userId + platform maps correctly to ADR-008 TenantId string format                                                    |
