...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:52:17Z
---
...
และคำตอบสุดท้าย โดยยังคงทำให้สถานะของเซสชันสอดคล้องกัน

ใน OpenClaw หนึ่งลูปคือการรันแบบลำดับเดียวต่อหนึ่งเซสชัน ซึ่งจะปล่อยอีเวนต์ของวงจรชีวิตและสตรีม
ขณะที่โมเดลคิด เรียกใช้เครื่องมือ และสตรีมเอาต์พุต เอกสารนี้อธิบายว่าลูปที่แท้จริงนั้นถูกเชื่อมต่อแบบครบวงจรอย่างไร
...
- ค่าเริ่มต้นของ `agent.wait`: 30 วินาที (เฉพาะการรอ) พารามิเตอร์ `timeoutMs` ใช้ override ได้
