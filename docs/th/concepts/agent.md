...
ไฟล์ว่างจะถูกข้าม ไฟล์ขนาดใหญ่จะถูกตัดและย่อพร้อมตัวบ่งชี้ เพื่อให้พรอมป์ตคงความกระชับ(อ่านไฟล์เพื่อดูเนื้อหาฉบับเต็ม)
...
`BOOTSTRAP.md` จะถูกสร้างเฉพาะสำหรับ **เวิร์กสเปซใหม่เอี่ยม** (ไม่มีไฟล์บูตสแตรปอื่นอยู่) หากคุณลบมันหลังจากทำพิธีเสร็จแล้ว ไม่ควรถูกสร้างขึ้นใหม่ในการรีสตาร์ตครั้งถัดไป
...
แนวทางว่าคุณต้องการให้ใช้งานอย่างไร
...
การเรียกเครื่องมือที่เหลือจากข้อความผู้ช่วยปัจจุบันจะถูกข้าม (ผลลัพธ์เครื่องมือเป็นข้อผิดพลาดพร้อมข้อความ "Skipped due to queued user message.") จากนั้นข้อความผู้ใช้ที่เข้าคิวจะถูกฉีดก่อนการตอบกลับของผู้ช่วยถัดไป
...
[Queue](/concepts/queue) สำหรับโหมดและพฤติกรรม debounce/cap
