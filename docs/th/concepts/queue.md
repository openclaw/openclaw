...
- `steer`: แทรกเข้าสู่การรันปัจจุบันทันที (ยกเลิกการเรียกเครื่องมือที่ค้างอยู่หลังขอบเขตเครื่องมือถัดไป) หากไม่สตรีมจะถอยกลับไปเป็น followup
- `followup`: เข้าคิวสำหรับรอบเอเจนต์ถัดไปหลังการรันปัจจุบันจบ
- `collect`: รวมข้อความที่เข้าคิวทั้งหมดเป็นรอบ followup **เดียว** (ค่าเริ่มต้น) หากข้อความมุ่งไปยังช่องทาง/เธรดต่างกัน จะระบายแยกกันเพื่อคงการกำหนดเส้นทาง
