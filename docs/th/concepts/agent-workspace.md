...
เวิร์กสเปซคือบ้านของเอเจนต์ เป็นไดเรกทอรีทำงานเพียงแห่งเดียวที่ใช้กับเครื่องมือจัดการไฟล์และบริบทของเวิร์กสเปซ ควรเก็บไว้เป็นส่วนตัวและปฏิบัติกับมันเหมือนหน่วยความจำ
...
การติดตั้งรุ่นเก่าอาจเคยสร้าง `~/openclaw` การเก็บไดเรกทอรีเวิร์กสเปซหลายแห่งพร้อมกันอาจทำให้เกิดความสับสนด้านการยืนยันตัวตนหรือสถานะไม่ตรงกัน เนื่องจากจะมีเวิร์กสเปซที่ทำงานอยู่ได้เพียงแห่งเดียวในแต่ละครั้ง
...
- `IDENTITY.md`
  - ชื่อ สไตล์ และอีโมจิของเอเจนต์
  - สร้าง/อัปเดตระหว่างพิธี bootstrap

- `TOOLS.md`
  - บันทึกเกี่ยวกับเครื่องมือภายในเครื่องและแนวปฏิบัติของคุณ
...
หากไฟล์ bootstrap ใดหายไป OpenClaw จะใส่ตัวบ่งชี้ “missing file” เข้าไปในเซสชันและดำเนินการต่อ ไฟล์ bootstrap ที่มีขนาดใหญ่จะถูกตัดทอนเมื่อถูกฉีดเข้าไป สามารถปรับขีดจำกัดได้ด้วย `agents.defaults.bootstrapMaxChars` (ค่าเริ่มต้น: 20000)
...
ปฏิบัติกับเวิร์กสเปซเหมือนหน่วยความจำส่วนตัว ใส่ไว้ในรีโป git แบบ **ส่วนตัว** เพื่อให้มีการสำรองและกู้คืนได้

ให้รันขั้นตอนเหล่านี้บนเครื่องที่ Gateway ทำงานอยู่ (เพราะเวิร์กสเปซอยู่ที่นั่น)

### 1) เริ่มต้นรีโป

หากติดตั้ง git แล้ว เวิร์กสเปซใหม่เอี่ยมจะถูกเริ่มต้นอัตโนมัติ หากเวิร์กสเปซนี้ยังไม่ใช่รีโป ให้รัน:
...
- การทำ multi-agent routing สามารถใช้เวิร์กสเปซที่แตกต่างกันต่อเอเจนต์ ดู
  [Channel routing](/channels/channel-routing) สำหรับการกำหนดค่าการ routing
