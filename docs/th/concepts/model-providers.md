...
OpenClaw มาพร้อมแคตตาล็อก pi‑ai ผู้ให้บริการเหล่านี้ **ไม่ต้อง**
...
- OAuth ของ Gemini CLI ถูกจัดส่งเป็นปลั๊กอินแบบรวม (`google-gemini-cli-auth`, ปิดใช้งานเป็นค่าเริ่มต้น)
  ...
  - หมายเหตุ: คุณ **ไม่ต้อง** วาง client id หรือ secret ลงใน `openclaw.json` โฟลว์การเข้าสู่ระบบของ CLI จะจัดเก็บโทเคนไว้ในโปรไฟล์การยืนยันตัวตนบนโฮสต์Gateway
...
Ollama จะถูกตรวจพบโดยอัตโนมัติเมื่อรันภายในเครื่องที่ `http://127.0.0.1:11434/v1` ดู [/providers/ollama](/providers/ollama) สำหรับคำแนะนำโมเดลและการกำหนดค่าแบบกำหนดเอง
