...
ทุกโมเดลมี **หน้าต่างบริบท** (จำนวนโทเค็นสูงสุดที่มองเห็นได้) แชตที่ทำงานต่อเนื่องจะสะสมข้อความและผลลัพธ์จากเครื่องมือ เมื่อหน้าต่างเริ่มคับแคบ OpenClaw จะทำการ **บีบอัด** ประวัติที่เก่ากว่าเพื่อให้อยู่ภายในขีดจำกัด

## การบีบอัดคืออะไร

การบีบอัดจะ **สรุปบทสนทนาเก่า** ให้เป็นรายการสรุปแบบกระชับ และคงข้อความล่าสุดไว้เหมือนเดิม สรุปนี้ถูกเก็บไว้ในประวัติเซสชัน ดังนั้นคำขอถัดไปจะใช้:
...
ก่อนการบีบอัด OpenClaw สามารถรันเทิร์น **silent memory flush** เพื่อบันทึกโน้ตที่คงทนลงดิสก์ ดูรายละเอียดและการกำหนดค่าได้ที่ [Memory](/concepts/memory)
...
หน้าต่างบริบทขึ้นกับโมเดล OpenClaw ใช้นิยามโมเดลจากแคตตาล็อกผู้ให้บริการที่กำหนดค่าไว้เพื่อกำหนดขีดจำกัด

## การบีบอัดเทียบกับการตัดทอน
