...
การเรียกใช้เครื่องมือ (`channels.discord.readMessages`, `channels.slack.readMessages` เป็นต้น) จะส่งกลับ **เวลาประทับดิบจากผู้ให้บริการ**.
...
ตั้งค่า `agents.defaults.userTimezone` เพื่อบอกโมเดลถึงเขตเวลาท้องถิ่นของผู้ใช้ หากไม่ได้ตั้งค่า
