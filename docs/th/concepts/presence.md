...
CLI มักเชื่อมต่อสั้นๆเพื่อรันคำสั่งแบบครั้งเดียว เพื่อหลีกเลี่ยงการรบกวนรายการ
Instances จึง **ไม่** นำ `client.mode === "cli"` มาสร้างเป็นรายการ presence

### 3) บีคอน `system-event`

ไคลเอนต์สามารถส่งบีคอนตามช่วงเวลาที่มีข้อมูลมากขึ้นผ่านเมธอด `system-event`
...
presence ถูกออกแบบให้เป็นแบบชั่วคราวโดยตั้งใจ:
...
ที่อยู่รีโมตแบบ loopback จะถูกเพิกเฉย
