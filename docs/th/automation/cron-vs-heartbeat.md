...
ทั้ง heartbeat และ cron jobs ช่วยให้คุณรันงานตามตารางเวลาได้ คู่มือนี้ช่วยให้คุณเลือกกลไกที่เหมาะสมกับกรณีการใช้งานของคุณ
...
| ตรวจสอบสุขภาพโปรเจ็กต์เบื้องหลัง       | Heartbeat           | อาศัยรอบการทำงานที่มีอยู่                 |

## Heartbeat: การรับรู้เป็นระยะ

Heartbeat จะรันใน **main session** ตามช่วงเวลาที่กำหนดอย่างสม่ำเสมอ (ค่าเริ่มต้น: 30 นาที) ออกแบบมาเพื่อให้เอเจนต์ตรวจสอบสิ่งต่างๆและนำเสนอสิ่งสำคัญ
...
- เริ่มต้นใหม่โดยไม่มีบริบทก่อนหน้า
