...
Open Responses เป็นมาตรฐานการอนุมานแบบเปิดที่อิงตาม OpenAI Responses API โดยออกแบบมาสำหรับเวิร์กโฟลว์เชิงเอเจนต์ และใช้ข้อมูลนำเข้าแบบเป็นรายการร่วมกับอีเวนต์การสตรีมเชิงความหมาย สเปก OpenResponses กำหนด `/v1/responses` ไม่ใช่ `/v1/chat/completions`.
