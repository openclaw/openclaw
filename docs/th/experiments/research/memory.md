...
read_when:
  ...
  - การตัดสินใจ: CLI แบบสแตนด์อโลน vs การผสานรวมกับOpenClawอย่างลึก
...
- **บันทึกรายวันยังคงเป็นบันทึกรายวัน** ไม่จำเป็นต้องแปลงเป็นJSON
...
- พิจารณาโซลูชันระดับSuCo/HNSW/ScaNNก็ต่อเมื่อ:
  ...
  - คุณภาพการเรียกคืนถูกจำกัดอย่างมีนัยสำคัญโดยการค้นหาเชิงคำศัพท์
...
## พิล็อตที่เล็กที่สุดแต่มีประโยชน์
