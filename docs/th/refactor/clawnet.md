...
## สิ่งที่ไม่อยู่ในขอบเขต (ระบุชัด)
...
- การผูกค่าเริ่มต้น: loopback การเข้าถึงระยะไกลผ่าน SSH/Tailscale
...
## สถานะการเชื่อมต่อ + อัตลักษณ์ในปัจจุบัน
...
บทบาทเป็นต่อการเชื่อมต่อ ไม่ใช่ต่ออุปกรณ์ อุปกรณ์หนึ่งอาจเปิดทั้งสองบทบาทได้ แยกกัน
...
กำหนดให้ชัดเพื่อเลี่ยงจุดอ่อน เลือกอย่างใดอย่างหนึ่ง:
...
การอนุมัติเกิดบนโฮสต์โหนด (รันไทม์โหนดของแอปmac) พรอมป์ต์ปรากฏที่ที่โหนดรัน
