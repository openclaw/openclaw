---
title: การปรับโครงสร้างการมิเรอร์เซสชันขาออก (Issue #1520)
...
# การปรับโครงสร้างการมิเรอร์เซสชันขาออก (Issue #1520)
...
การส่งขาออกเคยถูกมิเรอร์ไปยังเซสชันเอเจนต์ _ปัจจุบัน_ (tool session key) แทนที่จะเป็นเซสชันของช่องทางเป้าหมาย การกำหนดเส้นทางขาเข้าใช้คีย์เซสชันตามช่องทาง/เพียร์ ดังนั้นการตอบกลับขาออกจึงไปลงผิดเซสชัน และเป้าหมายที่ติดต่อครั้งแรกมักไม่มีรายการเซสชัน
...
- **การอนุมานเซสชันในการส่งผ่านGateway**: หากมี `sessionKey` ให้ใช้ค่านั้น หากไม่ระบุ ให้อนุมาน sessionKey จากเป้าหมาย + เอเจนต์เริ่มต้น และมิเรอร์ไปที่นั่น
...
- ปลั๊กอินการโทรด้วยเสียงใช้คีย์เซสชัน `voice:<phone>` แบบกำหนดเอง การแมปขาออกยังไม่เป็นมาตรฐานในส่วนนี้ หากเครื่องมือส่งข้อความควรรองรับการส่งแบบโทรด้วยเสียง ให้เพิ่มการแมปอย่างชัดเจน
