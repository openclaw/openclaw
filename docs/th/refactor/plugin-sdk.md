...
ไม่มีปลั๊กอินใดนำเข้าโดยตรงจาก `src/**` การพึ่งพาทั้งหมดต้องผ่าน SDK หรือ runtime
...
ขอบเขต: ประเภทข้อมูล, ตัวช่วย, และยูทิลิตีการตั้งค่า ไม่มีสถานะขณะรัน ไม่มีผลข้างเคียง
...
ขอบเขต: ทุกอย่างที่แตะพฤติกรรมหลักของ runtime
...
- Runtime: กำหนดเวอร์ชันตามการปล่อยแกนหลัก เพิ่ม `api.runtime.version`. เพิ่ม `api.runtime.version`
