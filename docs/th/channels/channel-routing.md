...
OpenClaw จะส่งคำตอบ **กลับไปยังช่องทางเดียวกับที่ข้อความถูกส่งมา** โมเดลจะไม่เป็นผู้เลือกช่องทาง การกำหนดเส้นทางเป็นแบบกำหนดตายตัวและถูกควบคุมโดยการกำหนดค่าของโฮสต์
...
WebChat จะเชื่อมต่อกับ **เอเจนต์ที่เลือก** และใช้ค่าเริ่มต้นเป็นเซสชัน main ของเอเจนต์ ด้วยเหตุนี้ WebChat จึงช่วยให้คุณเห็นบริบทข้ามช่องทางของเอเจนต์นั้นได้ในที่เดียว
