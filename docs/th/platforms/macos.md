...
แอป macOS คือ **แอปคู่หูบนแถบเมนู** สำหรับ OpenClaw ทำหน้าที่จัดการสิทธิ์,
...
แอป macOS จะแสดงตัวเองเป็นโหนด คำสั่งที่ใช้บ่อย:
...
- **การรายงาน IP:** อุโมงค์SSH ใช้ loopback ดังนั้น Gateway จะเห็น IP ของโหนดเป็น
  ...
  (ดู [macOS remote access](/platforms/mac/remote))

ขั้นตอนการตั้งค่า ดูที่ [macOS remote access](/platforms/mac/remote)
รายละเอียดโปรโตคอล ดูที่ [Gateway protocol](/gateway/protocol)
