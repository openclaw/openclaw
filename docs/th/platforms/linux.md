...
Gateway（เกตเวย์）รองรับบน Linux อย่างเต็มรูปแบบ **แนะนำให้ใช้โหนดเป็นรันไทม์**
ไม่แนะนำให้ใช้ Bun สำหรับ Gateway（เกตเวย์）(มีบั๊กกับ WhatsApp/Telegram)

มีแผนพัฒนาแอปคู่หูแบบเนทีฟสำหรับ Linux หากต้องการช่วยสร้าง ยินดีรับการมีส่วนร่วม
...
อยู่ใน [คู่มือการรัน Gateway](/gateway)
