...
- เซสชัน: อีเวนต์มาพร้อมกับ `runId` (ต่อการรัน) และ `sessionKey` ในเพย์โหลด เซสชัน “หลัก” คือคีย์ `main`; หากไม่มี จะใช้เซสชันที่อัปเดตล่าสุดแทน
- ลำดับความสำคัญ: เซสชันหลักชนะเสมอ หากเซสชันหลักกำลังทำงาน จะแสดงสถานะทันที หากเซสชันหลักว่าง จะแสดงเซสชันที่ไม่ใช่หลักซึ่งทำงานล่าสุด เราจะไม่สลับไปมาระหว่างกิจกรรม; จะสลับเฉพาะเมื่อเซสชันปัจจุบันว่างหรือเซสชันหลักเริ่มทำงาน
- ประเภทกิจกรรม:
