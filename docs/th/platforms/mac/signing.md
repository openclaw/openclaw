...
เมื่อทำการลงนามด้วย `SIGN_IDENTITY="-"`(ad-hoc) สคริปต์จะปิดใช้งาน **Hardened Runtime** (`--options runtime`) โดยอัตโนมัติ ซึ่งจำเป็นเพื่อป้องกันการแครชเมื่อแอปพยายามโหลดเฟรมเวิร์กที่ฝังมา(เช่น Sparkle)ซึ่งไม่ได้ใช้ Team ID เดียวกัน ลายเซ็นแบบ ad-hoc ยังทำให้การคงอยู่ของสิทธิ์TCCเสียหาย; ดูขั้นตอนการกู้คืนได้ที่ [macOS permissions](/platforms/mac/permissions)

## เมทาดาทาบิลด์สำหรับหน้า About
