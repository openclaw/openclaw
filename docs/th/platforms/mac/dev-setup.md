...
> **หมายเหตุ**: แอปที่เซ็นแบบ ad-hoc อาจทำให้เกิดพรอมต์ด้านความปลอดภัย หากแอปแครชทันทีพร้อมข้อความ "Abort trap 6" โปรดดูส่วน [การแก้ไขปัญหา](#troubleshooting)
...
หากมีการรันแบบแมนนวลที่ยึดพอร์ตอยู่ ให้หยุดโปรเซสนั้น (Ctrl+C) และหากจำเป็นจริงๆ ให้ kill PID ที่คุณพบจากขั้นตอนข้างต้น
