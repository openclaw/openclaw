...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:52:38Z
---

# คู่มือผู้ให้บริการ Qianfan

Qianfan เป็นแพลตฟอร์ม MaaS ของ Baidu ที่ให้ **API แบบรวมศูนย์** ซึ่งกำหนดเส้นทางคำขอไปยังโมเดลจำนวนมากผ่านเอ็นด์พอยต์และคีย์APIเพียงชุดเดียว รองรับความเข้ากันได้กับ OpenAI ดังนั้น SDK ของ OpenAI ส่วนใหญ่สามารถใช้งานได้เพียงสลับ base URL
