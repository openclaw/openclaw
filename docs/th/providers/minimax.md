...
MiniMax เป็นบริษัท AI ที่พัฒนาโมเดลตระกูล **M2/M2.1** โดยรุ่นที่เน้นงานเขียนโค้ดในปัจจุบันคือ **MiniMax M2.1** (23 ธันวาคม 2025) ซึ่งถูกสร้างมาเพื่อรองรับงานที่ซับซ้อนในโลกจริง
...
- **การกำหนดเส้นทางแผนเขียนโค้ด:** แบ็กเอนด์ Lightning ไม่ได้เปิดให้ใช้โดยตรงในแผนเขียนโค้ดของ MiniMax โดย MiniMax จะกำหนดเส้นทางคำขอส่วนใหญ่ไปยัง Lightning อัตโนมัติ แต่จะสลับกลับไปใช้แบ็กเอนด์ M2.1 ปกติเมื่อมีทราฟฟิกพุ่งสูง
...
โดยทั่วไปหมายความว่า **ยังไม่ได้กำหนดค่า MiniMax provider** (ไม่มีรายการ provider และไม่พบโปรไฟล์การยืนยันตัวตน/คีย์ env ของ MiniMax) การแก้ไขสำหรับการตรวจจับนี้อยู่ในเวอร์ชัน **2026.1.12** (ยังไม่ปล่อยในขณะเขียน) แก้ไขได้โดย:
