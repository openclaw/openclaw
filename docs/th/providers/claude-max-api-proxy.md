...
**claude-max-api-proxy** เป็นเครื่องมือจากชุมชนที่เปิดเผยการสมัครสมาชิก Claude Max/Pro ของคุณเป็นเอ็นด์พอยต์ API ที่เข้ากันได้กับ OpenAI ซึ่งช่วยให้คุณสามารถใช้การสมัครสมาชิกกับเครื่องมือใดๆที่รองรับรูปแบบ OpenAI API ได้
