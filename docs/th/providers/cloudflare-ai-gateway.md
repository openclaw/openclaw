...
Cloudflare AI Gatewayทำหน้าที่อยู่หน้าสุดของAPIจากผู้ให้บริการและช่วยให้คุณเพิ่มการวิเคราะห์ การแคช และการควบคุมต่างๆสำหรับAnthropicนั้นOpenClawจะใช้Anthropic Messages APIผ่านGateway endpointของคุณ
