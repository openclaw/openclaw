...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:52:33Z
---

# การอัปเดต

OpenClaw พัฒนาอย่างรวดเร็ว(ก่อนเวอร์ชัน“1.0”)ให้ปฏิบัติกับการอัปเดตเหมือนการส่งโครงสร้างพื้นฐาน: อัปเดต→รันการตรวจสอบ→รีสตาร์ต(หรือใช้ `openclaw update` ซึ่งจะรีสตาร์ตให้)→ยืนยันผลลัพธ์

## แนะนำ: รันตัวติดตั้งจากเว็บไซต์อีกครั้ง(อัปเกรดทับของเดิม)

เส้นทางการอัปเดตที่ **แนะนำ** คือการรันตัวติดตั้งจากเว็บไซต์อีกครั้ง ตัวติดตั้งจะตรวจพบการติดตั้งที่มีอยู่ อัปเกรดทับของเดิม และรัน `openclaw doctor` เมื่อจำเป็น
...
- สำรองสแนปช็อตการปรับแต่งของคุณ:
...
หมายเหตุ: สำหรับการติดตั้งผ่าน npm เกตเวย์จะบันทึกคำแนะนำการอัปเดตตอนเริ่มต้น(ตรวจแท็กของช่องทางปัจจุบัน)ปิดได้ด้วย `update.checkOnStart: false`.
...
หากคุณติดตั้งผ่าน **npm/pnpm** (ไม่มีเมตาดาทา git) `openclaw update` จะพยายามอัปเดตผ่านตัวจัดการแพ็กเกจของคุณ หากตรวจไม่พบการติดตั้ง ให้ใช้ “อัปเดต(ติดตั้งแบบ global)” แทน

## อัปเดต(Control UI / RPC)

Control UI มีปุ่ม **Update & Restart** (RPC: `update.run`) ซึ่งจะ:
...
Doctor คือคำสั่ง “อัปเดตอย่างปลอดภัย” มันตั้งใจให้เรียบง่าย: ซ่อมแซม + ย้าย + เตือน
