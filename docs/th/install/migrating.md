...
มองหาการอ้างถึง `OPENCLAW_STATE_DIR` / โปรไฟล์ในเอาต์พุต หากคุณรัน Gateway หลายตัว ให้ทำซ้ำสำหรับแต่ละโปรไฟล์.
...
Doctor เป็นคำสั่งที่ “ปลอดภัยและเรียบง่าย” ใช้ซ่อมแซมบริการ ใช้การไมเกรตคอนฟิก และแจ้งเตือนความไม่ตรงกัน.
...
## จุดพลาดที่พบบ่อย(และวิธีหลีกเลี่ยง)
...
`openclaw.json` อย่างเดียวไม่เพียงพอ ผู้ให้บริการหลายรายเก็บสถานะไว้ภายใต้:
...
`$OPENCLAW_STATE_DIR` มีความลับ(คีย์API โทเคนOAuth ข้อมูลรับรอง WhatsApp) ปฏิบัติกับแบ็กอัปเสมือนความลับระดับโปรดักชัน:
