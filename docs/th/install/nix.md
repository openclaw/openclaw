...
>
> รีโป nix-openclaw เป็นแหล่งอ้างอิงหลักสำหรับการติดตั้งด้วย Nix หน้านี้เป็นเพียงภาพรวมแบบย่อเท่านั้น
...
บน macOS แอป GUI จะไม่รับช่วงตัวแปรสภาพแวดล้อมจากเชลล์โดยอัตโนมัติ คุณยังสามารถ
...
- การพึ่งพาที่ขาดหายจะแสดงข้อความแนะนำการแก้ไขเฉพาะของ Nix
