...
8. ฝังไบนารีที่จำเป็น สร้างอิมเมจ และเปิดใช้งาน
...
- ข้อมูลผู้ให้บริการเพิ่มเติม(ไม่บังคับ)
  - QRของWhatsApp
  - โทเคนบอตTelegram
  - Gmail OAuth
...
หมายเหตุ: การกระจายคีย์SSHอาจใช้เวลา1-2นาทีหลังสร้างVM หากเชื่อมต่อไม่ได้ให้รอแล้วลองใหม่
...
| External binaries   | `/usr/local/bin/`                 | อิมเมจDocker          | ต้องฝังตั้งแต่สร้างอิมเมจ     |
| Node runtime        | ระบบไฟล์คอนเทนเนอร์               | อิมเมจDocker          | สร้างใหม่ทุกครั้งที่บิลด์     |
| OS packages         | ระบบไฟล์คอนเทนเนอร์               | อิมเมจDocker          | ห้ามติดตั้งขณะรัน             |
| Docker container    | ชั่วคราว                          | รีสตาร์ตได้           | ทำลายได้อย่างปลอดภัย          |
...
การกระจายคีย์SSHอาจใช้เวลา1-2นาทีหลังสร้างVM รอแล้วลองใหม่
...
หลีกเลี่ยงการใช้บทบาทOwnerสำหรับระบบอัตโนมัติ ใช้หลักการให้สิทธิ์เท่าที่จำเป็น
