...
PR ที่ดีจะรีวิวได้ง่าย: ผู้รีวิวควรเข้าใจเจตนาได้อย่างรวดเร็ว ตรวจสอบพฤติกรรมได้ และนำการเปลี่ยนแปลงขึ้นระบบได้อย่างปลอดภัย คู่มือนี้ครอบคลุมการส่งงานที่กระชับและมีสัญญาณสูงสำหรับการรีวิวทั้งโดยมนุษย์และ LLM

## อะไรทำให้ PR ดี

- [ ] อธิบายปัญหา เหตุผลที่สำคัญ และการเปลี่ยนแปลง
- [ ] รักษาขอบเขตการเปลี่ยนแปลงให้โฟกัส หลีกเลี่ยงการรีแฟกเตอร์กว้างๆ
...
เขียนให้กระชับ; การรีวิวที่กระชับสำคัญกว่าหลักไวยากรณ์ ละเว้นส่วนที่ไม่เกี่ยวข้อง
...
- [ ] ความปลอดภัย: สรุปความเสี่ยง ขั้นตอนทำซ้ำ การยืนยัน ไม่มีข้อมูลอ่อนไหว อ้างอิงเฉพาะข้อกล่าวอ้างที่มีหลักฐาน
