...
- ขอบเขต:
  ...
  - รีเกรสชันแบบกำหนดผลลัพธ์แน่นอนสำหรับบั๊กที่ทราบ
- ความคาดหวัง:
  - รันใน CI
  - ไม่ต้องใช้คีย์จริง
  - ควรเร็วและเสถียร
...
รวมอย่างน้อยหนึ่งโมเดลที่รองรับรูปภาพใน `OPENCLAW_LIVE_GATEWAY_MODELS` (Claude/Gemini/OpenAI รุ่นที่รองรับ vision ฯลฯ) เพื่อทดสอบ image probe
...
เคล็ดลับ: อย่าพยายามฮาร์ดโค้ด “ทุกโมเดล” ในเอกสาร รายการที่เป็นทางการคือสิ่งที่ `discoverModels(...)` ส่งกลับบนเครื่องของคุณ + คีย์ที่มีอยู่

## ข้อมูลรับรอง (ห้ามคอมมิต)

การทดสอบ live ค้นหาข้อมูลรับรองแบบเดียวกับ CLI นัยเชิงปฏิบัติ:
