...
- **Gateway**: โพรเซสเกตเวย์แบบรันยาวหนึ่งตัวที่เป็นเจ้าของสถานะ(เซสชัน การจับคู่ ทะเบียนโหนด)และรันช่องทางต่างๆ การตั้งค่าส่วนใหญ่มักใช้หนึ่งตัวต่อโฮสต์; สามารถตั้งค่าแบบหลายเกตเวย์ที่แยกจากกันได้
...
- **Direct WS** ให้ประสบการณ์ผู้ใช้ที่ดีที่สุดบนเครือข่ายเดียวกันและภายในtailnet:
  ...
  - โทเคนการจับคู่และACLsถูกดูแลโดยเกตเวย์
...
Bonjourเป็นแบบbest-effortและไม่ข้ามเครือข่าย ใช้เพื่อความสะดวกในกรณี “LANเดียวกัน” เท่านั้น
...
สำหรับการตั้งค่าแบบลอนดอน/เวียนนา Bonjourจะช่วยไม่ได้ เป้าหมาย “โดยตรง” ที่แนะนำคือ:
