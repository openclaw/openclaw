...
OpenClaw รันคำสั่งเชลล์ผ่านเครื่องมือ `exec` และเก็บงานที่รันเป็นเวลานานไว้ในหน่วยความจำ เครื่องมือ `process` ใช้จัดการเซสชันเบื้องหลังเหล่านั้น
...
## การเชื่อมบริดจ์โพรเซสลูก

เมื่อสปอว์นโพรเซสลูกที่รันยาวนานนอกเครื่องมือ exec/process (เช่น การ respawn ของ CLI หรือ helper ของ Gateway) ให้ผูกตัวช่วยบริดจ์โพรเซสลูกเพื่อให้สัญญาณยุติถูกส่งต่อ และถอดตัวรับฟังเมื่อออก/เกิดข้อผิดพลาด วิธีนี้ช่วยหลีกเลี่ยงโพรเซสกำพร้าบน systemd และทำให้พฤติกรรมการปิดระบบสอดคล้องกันข้ามแพลตฟอร์ม
