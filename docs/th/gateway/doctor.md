...
read_when:
  ...
  - การแนะนำการเปลี่ยนแปลงคอนฟิกที่ไม่เข้ากันย้อนหลัง
title: "Doctor"
x-i18n:
...
คอนฟิก/สถานะที่ค้าง ตรวจสุขภาพ และให้ขั้นตอนการซ่อมแซมที่ทำได้จริง
...
การย้ายสถานะรุ่นเก่าจะรันอัตโนมัติเมื่อถูกตรวจพบ
...
- ตรวจพบไดเรกทอรีเวิร์กสเปซส่วนเกิน (`~/openclaw`)
...
เพื่อให้คุณลบ override และกู้คืนการกำหนดเส้นทาง API และค่าใช้จ่ายรายโมเดล
...
การย้ายเหล่านี้เป็นแบบ best-effort และ idempotent; doctor จะส่งคำเตือนเมื่อ
...
ตั้งใจให้ย้ายผ่าน `openclaw doctor` เท่านั้น

### 4) การตรวจความถูกต้องของสถานะ (การคงอยู่ของเซสชัน การกำหนดเส้นทาง และความปลอดภัย)

ไดเรกทอรีสถานะคือศูนย์กลางการทำงาน หากหายไป คุณจะสูญเสีย
...
Doctor เตือนเมื่อไม่มี `gateway.auth` บน gateway ภายในเครื่อง และเสนอให้
...
เขียนไฟล์บริการ/งานใหม่เป็นค่าเริ่มต้นปัจจุบัน
...
Doctor ตรวจรันไทม์ของบริการ (PID, สถานะการออกล่าสุด) และเตือนเมื่อ
...
Doctor จะเสนอให้ย้ายไปใช้ Node ที่ติดตั้งในระบบเมื่อมี (Homebrew/apt/choco)
