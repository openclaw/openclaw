...
ถูกจำกัดอัตรา หรือทำงานผิดพลาดชั่วคราว แนวทางนี้ตั้งใจให้保守เป็นพิเศษ:
...
ออกแบบมาเป็น**ตาข่ายนิรภัย**มากกว่าเส้นทางหลัก ใช้เมื่อคุณต้องการคำตอบแบบข้อความที่
...
เพียงเท่านี้ ไม่ต้องใช้คีย์ และไม่ต้องตั้งค่าการยืนยันตัวตนเพิ่มเติมนอกเหนือจากตัวCLIเอง
...
OpenClawจะเขียนรูปภาพแบบbase64ลงไฟล์ชั่วคราว หากตั้งค่า`imageArg`
...
- **ไม่มีเครื่องมือของOpenClaw**(แบ็กเอนด์CLIจะไม่รับการเรียกเครื่องมือ)บางCLI
  อาจยังรันเครื่องมือเอเจนต์ของตนเอง
...
- **เซสชันของCodex CLI**resumeผ่านเอาต์พุตข้อความ(ไม่ใช่JSONL)ซึ่งมีโครงสร้างน้อยกว่า
  การรัน`--json`ครั้งแรก เซสชันของOpenClawยังทำงานตามปกติ
