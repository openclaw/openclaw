...
ใช้แทนการเชื่อมต่อผ่าน SSH หรือ Tailnet

## Bonjour แบบเครือข่ายกว้าง (Unicast DNS‑SD) ผ่าน Tailscale

หากโหนดและGateway อยู่คนละเครือข่าย การมัลติคาสต์ mDNS จะไม่ข้ามขอบเขตเครือข่าย
...
สำหรับการเข้าถึงแบบ LAN/tailnet ให้ผูกแบบชัดเจนและคงการยืนยันตัวตนไว้
...
- **เรียกดูได้แต่แก้ชื่อไม่สำเร็จ**: ตั้งชื่อเครื่องให้ง่าย (หลีกเลี่ยงอีโมจิหรือ
