...
โปรโตคอลWSของGatewayเป็น **ระนาบควบคุมเดียว+ทรานสปอร์ตของโหนด** สำหรับ
...
- หลังการจับคู่ Gatewayจะออก **โทเคนอุปกรณ์** ที่ผูกกับบทบาท+ขอบเขตของการเชื่อมต่อ
  โทเคนจะถูกส่งกลับใน `hello-ok.auth.deviceToken` และควรถูกบันทึกโดยไคลเอนต์เพื่อการเชื่อมต่อครั้งถัดไป
...
สคีมาTypeBoxใน `src/gateway/protocol/schema.ts`
