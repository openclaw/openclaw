...
title: "การจับคู่ที่เป็นเจ้าของโดยGateway"
x-i18n:
...
ในการจับคู่ที่เป็นเจ้าของโดยGateway **Gateway**คือแหล่งอ้างอิงหลักสำหรับการกำหนดว่าโหนดใดได้รับอนุญาตให้เข้าร่วม UIต่างๆ(แอปmacOSและไคลเอนต์ในอนาคต)เป็นเพียงส่วนหน้าในการอนุมัติหรือปฏิเสธคำขอที่รอดำเนินการ
...
- **ทรานสปอร์ต**: ปลายทางWSของGatewayทำหน้าที่ส่งต่อคำขอแต่ไม่ตัดสินใจเรื่องสมาชิกภาพ(การรองรับTCP bridge แบบเดิมเลิกใช้/ถูกนำออกแล้ว)
