...
โปรไฟล์คือคอนฟิกรูตติ้งของเบราว์เซอร์ที่ตั้งชื่อไว้ โดยในทางปฏิบัติ:
...
หากGatewayรันอยู่คนละเครื่องกับเบราว์เซอร์ ให้รัน **โฮสต์โหนด** บนเครื่องที่มี Chrome/Brave/Edge/Chromium จากนั้นGatewayจะพร็อกซีแอ็กชันของเบราว์เซอร์ไปยังโหนดนั้น (ไม่ต้องมีเซิร์ฟเวอร์ควบคุมเบราว์เซอร์แยกต่างหาก)
