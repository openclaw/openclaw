...
**วิธีแก้ไข:** ใช้ `openclaw sandbox recreate` เพื่อบังคับลบคอนเทนเนอร์เก่า คอนเทนเนอร์จะถูกสร้างใหม่โดยอัตโนมัติด้วยการตั้งค่าปัจจุบันเมื่อจำเป็นต้องใช้งานครั้งถัดไป

เคล็ดลับ: ควรใช้ `openclaw sandbox recreate` แทนการใช้ `docker rm` ด้วยตนเอง วิธีนี้ใช้รูปแบบการตั้งชื่อคอนเทนเนอร์ของGatewayและหลีกเลี่ยงความไม่ตรงกันเมื่อคีย์ขอบเขต/เซสชันเปลี่ยนแปลง
