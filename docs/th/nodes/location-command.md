...
- iOS/macOS: ผู้ใช้สามารถเลือก **ขณะใช้งาน** หรือ **ตลอดเวลา** ในพรอมต์/การตั้งค่าระบบ แอปสามารถขออัปเกรดได้ แต่ระบบปฏิบัติการอาจบังคับให้ไปที่การตั้งค่า
...
ไม่บังคับ โหนดmacOSรายงาน `location` ผ่านแผนที่สิทธิ์; iOS/Androidอาจไม่รายงาน
...
- iOS: ต้องมีสิทธิ์ตลอดเวลา+โหมดตำแหน่งเบื้องหลัง พุชแบบเงียบอาจถูกจำกัด คาดว่าจะล้มเหลวเป็นครั้งคราว
...
- ตลอดเวลา: “อนุญาตตำแหน่งเบื้องหลัง ต้องได้รับสิทธิ์จากระบบ”
- แม่นยำ: “ใช้ตำแหน่งGPSแบบแม่นยำ ปิดเพื่อแชร์ตำแหน่งโดยประมาณ”
