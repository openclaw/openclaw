...
OpenClaw สามารถ**สรุปสื่อขาเข้า**(รูปภาพ/เสียง/วิดีโอ)ก่อนที่กระบวนการตอบกลับจะเริ่มทำงาน ระบบจะตรวจจับอัตโนมัติเมื่อมีเครื่องมือภายในเครื่องหรือคีย์ของผู้ให้บริการพร้อมใช้งาน และสามารถปิดใช้งานหรือปรับแต่งได้ หากปิดการทำความเข้าใจ โมเดลจะยังคงได้รับไฟล์/URLต้นฉบับตามปกติ
...
หากคุณตั้งค่า `capabilities` รายการจะทำงานเฉพาะประเภทสื่อเหล่านั้น สำหรับรายการที่ใช้ร่วมกัน OpenClaw สามารถอนุมานค่าเริ่มต้นได้:
