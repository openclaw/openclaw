...
read_when:
  ...
  - แก้ไขปัญหาการตั้งค่าอัตลักษณ์ระหว่างการเริ่มต้นใช้งาน
...
การบูตสแตรปคือพิธีการของการรัน **ครั้งแรก** ที่เตรียมเวิร์กสเปซของเอเจนต์และรวบรวมรายละเอียดอัตลักษณ์ กระบวนการนี้จะเกิดขึ้นหลังการเริ่มต้นใช้งาน เมื่อเอเจนต์เริ่มทำงานเป็นครั้งแรก
...
การบูตสแตรปจะรันบน **gateway host** เสมอ หากแอปmacOS เชื่อมต่อกับ Gateway ระยะไกล เวิร์กสเปซและไฟล์บูตสแตรปจะอยู่บนเครื่องระยะไกลนั้น
