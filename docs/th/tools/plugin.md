...
ปลั๊กอินของOpenClawเป็น **โมดูลTypeScript** ที่โหลดขณะรันผ่าน jiti **การตรวจสอบคอนฟิกจะไม่รันโค้ดปลั๊กอิน**; จะใช้ไฟล์แมนิฟेस्टของปลั๊กอินและJSON Schemaแทน ดู [Plugin manifest](/plugins/manifest)
...
- คืนค่าเป็นบัฟเฟอร์เสียงPCM + อัตราการสุ่มตัวอย่าง ปลั๊กอินต้องรีแซมเปิล/เข้ารหัสให้ผู้ให้บริการ
...
รากของปลั๊กอินคือไดเรกทอรีของไฟล์นั้นและต้องมีแมนิฟেস্ট
...
แต่ละรายการจะกลายเป็นปลั๊กอิน หากแพ็กระบุส่วนขยายหลายรายการ idของปลั๊กอิน
...
วางไฟล์JSONไว้ที่หนึ่งในตำแหน่ง:
...
`plugins.slots` เพื่อเลือกว่าปลั๊กอินใดเป็นเจ้าของสล็อต:
...
ปลั๊กอินสามารถบรรจุฮุคและลงทะเบียนขณะรันไทม์ได้ วิธีนี้ทำให้ปลั๊กอินรวมระบบอัตโนมัติแบบขับเคลื่อนด้วยอีเวนต์โดยไม่ต้องติดตั้งแพ็กฮุคแยกต่างหาก
...
ลงทะเบียนผู้ให้บริการผ่าน `api.registerProvider(...)`. ผู้ให้บริการแต่ละรายเปิดเผยวิธีการยืนยันตัวตนหนึ่งอย่างหรือมากกว่า(OAuth, API key, device code ฯลฯ) วิธีเหล่านี้ขับเคลื่อน:
...
(WhatsApp, Telegram เป็นต้น) คอนฟิกช่องทางอยู่ภายใต้ `channels.<id>` และถูกตรวจสอบโดยโค้ดปลั๊กอินช่องทางของคุณ
...
ปลั๊กอินสามารถลงทะเบียนคำสั่งสแลชแบบกำหนดเองที่รัน **โดยไม่เรียกเอเจนต์AI** เหมาะสำหรับคำสั่งสลับสถานะ การตรวจสอบสถานะ หรือการกระทำด่วนที่ไม่ต้องประมวลผลด้วยLLM
...
- ชื่อคำสั่งที่สงวนไว้(เช่น `help`, `status`, `reset` เป็นต้น) ไม่สามารถถูกแทนที่โดยปลั๊กอินได้
...
ปลั๊กอินรันในโปรเซสเดียวกับGateway（เกตเวย์） ควรมองว่าเป็นโค้ดที่เชื่อถือได้:
