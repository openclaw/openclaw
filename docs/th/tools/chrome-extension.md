...
ส่วนขยายถูกจัดส่งมาพร้อมกับรีลีสของ OpenClaw(แพ็กเกจ npm)ในรูปแบบไฟล์สแตติก ไม่มีขั้นตอน “build” แยกต่างหาก
...
และเริ่มเซิร์ฟเวอร์รีเลย์โดยอัตโนมัติ ส่วนขยายจะสื่อสารกับรีเลย์ภายในเครื่อง ขณะที่การเรียกจาก CLI/เครื่องมือจะไปยัง Gateway
...
นี่เป็นความสามารถที่ทรงพลังและมีความเสี่ยง ควรปฏิบัติเสมือนว่าคุณให้โมเดล “มีมืออยู่บนเบราว์เซอร์ของคุณ”

- ส่วนขยายใช้ Chrome debugger API(`chrome.debugger`) เมื่อแนบแล้ว โมเดลสามารถ:
