...
OpenClaw ถูกออกแบบมาให้ขยายความสามารถได้อย่างง่ายดาย โดย "Skills" คือวิธีหลักในการเพิ่มความสามารถใหม่ให้กับผู้ช่วยของคุณ
...
Skills จะอยู่ในเวิร์กสเปซของคุณ โดยปกติคือ `~/.openclaw/workspace/skills/` สร้างโฟลเดอร์ใหม่สำหรับ Skill ของคุณ:
...
สร้างไฟล์ `SKILL.md` ในไดเรกทอรีนั้น ไฟล์นี้ใช้ YAML frontmatter สำหรับเมตาดาตา และใช้ Markdown สำหรับคำสั่งการทำงาน
...
ขอให้เอเจนต์ของคุณ "refresh skills" หรือรีสตาร์ท Gateway OpenClaw จะค้นหาไดเรกทอรีใหม่และทำดัชนีไฟล์ `SKILL.md`
