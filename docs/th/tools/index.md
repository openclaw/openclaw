...
(การปฏิเสธมีผลเหนือกว่า) วิธีนี้ป้องกันไม่ให้ส่งเครื่องมือที่ไม่อนุญาตไปยังผู้ให้บริการโมเดล
...
ดู [Plugins](/tools/plugin) สำหรับการติดตั้ง+คอนฟิก และ [Skills](/tools/skills) สำหรับวิธีการแทรกแนวทางการใช้เครื่องมือเข้าไปในพรอมป์ต์ ปลั๊กอินบางตัวมาพร้อมSkillsของตนเองควบคู่กับเครื่องมือ(เช่นปลั๊กอินโทรด้วยเสียง)
...
หมายเหตุ: เมื่อมีการตั้งค่า `gatewayUrl` ให้ใส่ `gatewayToken` อย่างชัดเจน เครื่องมือจะไม่สืบทอดคอนฟิก
...
นั่นหมายความว่าเอเจนต์จะเห็นทั้ง“มีเครื่องมืออะไรบ้าง”และ“เรียกใช้อย่างไร” หากเครื่องมือ
