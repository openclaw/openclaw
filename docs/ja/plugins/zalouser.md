...
> **警告:** 非公式の自動化は、アカウントの停止や BAN につながる可能性があります。自己責任で使用してください。

## 命名

チャンネル id は、**個人用 Zalo ユーザーアカウント**（非公式）を自動化することを明確にするため `zalouser` です。将来の公式 Zalo API 統合の可能性に備えて、`zalo` は予約しています。
