...
installation work. Repair Doctor has no automatic deadline, including its
enclosing post-plugin convergence phase. Separate post-plugin config and
readiness checks retain their 180-second bound. `--timeout` overrides each
phase budget.
