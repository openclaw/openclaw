...
- `--auth-choice <setup-token|token|chutes-api-key|chutes|openai-codex|openai-api-key|openrouter-api-key|ai-gateway-api-key|moonshot-api-key|moonshot-api-key-cn|kimi-code-api-key|synthetic-api-key|venice-api-key|gemini-api-key|zai-api-key|apiKey|minimax-api|minimax-api-lightning|opencode-zen|skip>`
...
- `--minimax-api-key <key>`
- `--chutes-api-key <key>`
- `--chutes-model-id <id>` (required for non-interactive Chutes setup)
