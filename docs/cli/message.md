...
| `edit`          | Discord, Matrix, Microsoft Teams, Slack, Telegram, WhatsApp                                                     | `--message-id`, `--message`, `--target`                        | Telegram forum threads use `--thread-id`. WhatsApp edits bot-owned sent messages.                                                                                                                                                                                                                      |
| `delete`        | Discord, Matrix, Microsoft Teams, Slack, Telegram, WhatsApp                                                     | `--message-id`, `--target`                                     | WhatsApp deletes/revokes bot-owned sent messages; `unsend` is also accepted as a WhatsApp alias.                                                                                                                                                                                                       |
| `unsend`        | iMessage, WhatsApp                                                                                              | `--message-id`, `--target`                                     | iMessage unsends private-API messages when available. WhatsApp accepts `unsend` as a bot-owned message delete/revoke alias.                                                                                                                                                                            |
