...
- <a id="durable-serving-recovery"></a>[Durable serving recovery](/cli/update/how-updates-run#durable-serving-recovery)
- <a id="legacy-package-rollback"></a>[Legacy package rollback](/cli/update/how-updates-run#legacy-package-rollback)
