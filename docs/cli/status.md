...
- `--usage` prints provider usage windows using provider-native remaining labels
  when available, such as OpenRouter dollar credits, and otherwise falls back
  to normalized `X% left`.
