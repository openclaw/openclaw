...
<Steps>
  ...
  <Step title="프리픽스 아래에 OpenClaw 설치">
    `--prefix <prefix>` 를 사용하여 npm 으로 설치한 뒤, `<prefix>/bin/openclaw` 에 래퍼를 작성합니다.
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="설치 후 openclaw 를 찾을 수 없음">
