...
- تستخدم قائمة سماح للرسائل المباشرة تحتوي على عدة إدخالات
- تضبط `dmPolicy: "open"`
...
تعود **ملكية** حالة الجلسة بالكامل إلى **Gateway** (النسخة «الرئيسية» من OpenClaw). يجب على عملاء واجهة المستخدم (تطبيق macOS، WebChat، إلخ) الاستعلام من الـ Gateway عن قوائم الجلسات وعدّادات الرموز بدل قراءة الملفات المحلية.
