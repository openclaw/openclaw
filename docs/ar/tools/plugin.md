...
1. اطّلع على ما هو محمّل بالفعل:
...
## واجهة برمجة الإضافات (نظرة عامة)

تُصدِّر الإضافات أحد الخيارين:
...
- لا يمكن للإضافات تجاوز أسماء الأوامر المحجوزة (مثل `help`، `status`، `reset`، إلخ)
