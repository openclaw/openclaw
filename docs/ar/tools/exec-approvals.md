...
قوائم السماح تكون **لكل وكيل**. إذا وُجد عدة وكلاء، بدّل الوكيل الذي تعدّل إعداداته في تطبيق macOS.
الأنماط هي **مطابقات glob غير حسّاسة لحالة الأحرف**.
...
يُعرض مسار تنفيذ exec كرسائل نظام:
