...
- الأوامر التي يجب تشغيلها لسير العمل الشائع (محليًا، قبل الدفع، أثناء التصحيح)
...
- النطاق:
  ...
  - اختبارات انحدار حتمية لأخطاء معروفة
- التوقعات:
  - تعمل في CI
...
- من أين تأتي المفاتيح:
  - افتراضيًا: مخزن الملفات التعريفية وبدائل متغيرات البيئة
...
ضمّن نموذجًا واحدًا على الأقل يدعم الصور في `OPENCLAW_LIVE_GATEWAY_MODELS` (متغيرات Claude/Gemini/OpenAI الداعمة للرؤية، إلخ) لاختبار فحص الصورة.
