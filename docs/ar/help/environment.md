...
read_when:
  - "تحتاج إلى معرفة أي متغيرات بيئة يتم تحميلها وبأي ترتيب"
...
طريقتان متكافئتان لتعيين متغيرات بيئة مضمّنة (كلتاهما لا تتجاوزان):
...
## استيراد متغيرات البيئة من الغلاف
