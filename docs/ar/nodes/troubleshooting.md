...
read_when:
  ...
  - تحتاج إلى النموذج الذهني للفصل بين إقران العُقدة والموافقات
...
# استكشاف أخطاء العُقدة وإصلاحها
...
| `system.run`                 | غير متاح (مسار مضيف العُقدة)                | غير متاح (مسار مضيف العُقدة)                | تتطلب موافقات التنفيذ               | `SYSTEM_RUN_DENIED`            |
