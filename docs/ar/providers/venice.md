...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:48:56Z
---
...
| **خصوصية + جودة Claude** | `claude-opus-45`                 | أفضل استدلال عبر الوكيل المُجهّل  |
...
| معرّف النموذج                    | الاسم                   | السياق (رموز) | الميزات               |
| -------------------------------- | ----------------------- | ------------- | --------------------- |
...
| `qwen3-coder-480b-a35b-instruct` | Qwen3 Coder 480B        | 262k          | برمجة                 |
...
| `venice-uncensored`              | Venice Uncensored       | 32k           | غير خاضع للرقابة      |
...
| معرّف النموذج            | الأصل             | السياق (رموز) | الميزات        |
| ------------------------ | ----------------- | ------------- | -------------- |
...
| ------------ | ------------------------------ | ------------------ |
| **الخصوصية** | إزالة البيانات الوصفية، مُجهّل | حسابك مرتبط        |
| **الكمون**   | +10–50 مللي ثانية (وكيل)       | مباشر              |
