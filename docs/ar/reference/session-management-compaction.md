...
- مفتاح الجلسة خاطئ؟ ابدأ بـ [/concepts/session](/concepts/session) وأكّد `sessionKey` في `/status`.
- عدم تطابق المخزن مع السجل النصي؟ أكّد مضيف الـ Gateway ومسار المخزن من `openclaw status`.
- تكرار ضغط مفرط؟ تحقّق من:
...
- تسرّب الأدوار الصامتة؟ أكّد أن الرد يبدأ بـ `NO_REPLY` (الرمز الدقيق) وأنك على إصدار يتضمن إصلاح كبت البثّ.
