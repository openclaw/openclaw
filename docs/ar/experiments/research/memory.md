...
read_when:
  ...
  - اتخاذ قرار: CLI مستقل مقابل تكامل عميق مع OpenClaw
...
- قيود الزمن («ما الذي كان صحيحًا خلال نوفمبر 2025؟») وحل التعارضات
...
- فصل ما هو مُلاحظ عمّا هو مُعتقد عمّا هو مُلخّص
...
- **آراء**: «ما الذي يفضّله Peter؟» (مع الثقة + الأدلة)
...
- تضمينات + قوة غاشمة (تعمل لمسافة مدهشة إذا كان عدد المقاطع منخفضًا)
