...
Activi treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.activi/settings/voicewake.json`

Shape:

```json
{ "triggers": ["activi", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
