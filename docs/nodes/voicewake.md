...
Mullusi treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.mullusi/settings/voicewake.json`

Shape:

```json
{ "triggers": ["mullusi", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
