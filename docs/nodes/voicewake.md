...
EasyHub treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.easyhub/settings/voicewake.json`

Shape:

```json
{ "triggers": ["EasyHub", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
