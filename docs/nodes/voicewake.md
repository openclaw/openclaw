...
SmartAgentNeo treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.smart-agent-neo/settings/voicewake.json`

Shape:

```json
{ "triggers": ["smart-agent-neo", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
