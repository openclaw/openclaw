...
| `idleTimeoutS`                           | unset                                      | Optional seconds of no Talk interaction before macOS Talk Mode deactivates and returns to Voice Wake waiting. Set `30` for the common wake-word idle timeout; leave unset to keep Talk active until manually stopped.                                                      |
| `interruptOnSpeech`                      | `true`                                     |                                                                                                                                                                                                                                                                            |
