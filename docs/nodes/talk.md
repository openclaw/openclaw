...
| `idleTimeoutS`                           | unset                                      | Optional seconds without recognized user speech or an assistant reply before macOS Talk Mode deactivates and returns to Voice Wake waiting. Set `30` for the common wake-word idle timeout; leave unset to keep Talk active until manually stopped.                        |
| `interruptOnSpeech`                      | `true`                                     |                                                                                                                                                                                                                                                                            |
