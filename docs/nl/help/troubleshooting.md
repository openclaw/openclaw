...
<AccordionGroup>
  ...
  <Accordion title="Kanaal verbindt maar berichten stromen niet">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Cron of heartbeat is niet afgegaan of niet afgeleverd">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Node is gekoppeld maar tool faalt bij camera/canvas/scherm/exec">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Browser-tool faalt">
    ```bash
    openclaw status
    openclaw gateway status
