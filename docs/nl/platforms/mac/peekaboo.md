...
OpenClaw kan **PeekabooBridge** hosten als een lokale, permissiebewuste UI‑automatiseringsbroker.
Dit stelt de `peekaboo` CLI in staat UI‑automatisering aan te sturen terwijl de TCC‑rechten
