...
<Steps>
  ...
  <Step title="Post-installatietaken">
...
<AccordionGroup>
  <Accordion title="Flags-referentie">
...
| `--help`                        | Gebruik tonen (`-h`)                                                     |
  ...
  <Accordion title="Referentie omgevingsvariabelen">
...
<Tabs>
  ...
  <Tab title="Automatisering JSON-uitvoer">
    ```bash
...
<Tabs>
  ...
  <Tab title="Aangepaste git-directory">
    ```powershell
