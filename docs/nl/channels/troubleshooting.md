...
| Willekeurige verbreek-/herinloglussen | `openclaw channels status --probe` + logs                | Log opnieuw in en verifieer dat de credentials-map gezond is. |
...
| DM-afzender geblokkeerd                    | `openclaw pairing list imessage` of `openclaw pairing list bluebubbles` | Keur koppeling goed of werk de toegestane lijst bij.      |
...
| Versleutelde kamers falen            | Verifieer cryptomodule en versleutelingsinstellingen | Schakel versleutelingsondersteuning in en sluit opnieuw aan/synchroniseer de kamer. |
