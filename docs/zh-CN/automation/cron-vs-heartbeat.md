...
完整配置请参阅[心跳](/zh-CN/gateway/heartbeat)。
...
完整 CLI 参考请参阅[定时任务](/zh-CN/automation/cron-jobs)。
...
完整用法和示例请参阅 [Lobster](/zh-CN/tools/lobster)。
...
- [心跳](/zh-CN/gateway/heartbeat) - 完整的心跳配置
- [定时任务](/zh-CN/automation/cron-jobs) - 完整的定时任务 CLI 和 API 参考
- [系统](/zh-CN/cli/system) - 系统事件 + 心跳控制
