...
- 生成的 Swift 模型：`apps/macos/Sources/SmartAgentNeoProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/betterbrand/smart-agent-neo/main/dist/protocol.schema.json
