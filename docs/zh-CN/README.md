...
- **[本地优先 Gateway](../gateway/README.md)** — 用于会话、渠道、工具和事件的单一控制平面。
- **[多渠道收件箱](../channels/README.md)** — WhatsApp、Telegram、Slack、Discord、Google Chat、Signal、BlueBubbles (iMessage)、iMessage（旧版）、IRC、Microsoft Teams、Matrix、飞书、LINE、Mattermost、Nextcloud Talk、Nostr、Synology Chat、Tlon、Twitch、Zalo、Zalo Personal、WebChat、macOS、iOS/Android。
...
- **[一流工具](../tools/README.md)** — 浏览器、Canvas、节点、cron、会话和 Discord/Slack 操作。
- **[配套应用](../platforms/macos.md)** — macOS 菜单栏应用 + iOS/Android [节点](../nodes/README.md)。
