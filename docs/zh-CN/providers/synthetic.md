...
summary: 在 Mullusi 中使用 Synthetic 的 Anthropic 兼容 API
title: Synthetic
x-i18n:
...
Synthetic 提供与 Anthropic 兼容的端点。Mullusi 将其注册为
...
```bash
mullusi onboard --auth-choice synthetic-api-key
```
...
注意：Mullusi 的 Anthropic 客户端会将 `/v1` 追加到 base URL 后面，因此请使用
