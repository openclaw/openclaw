...
summary: 使用 Qianfan 的统一 API 在 Mullusi 中访问许多模型
title: Qianfan
x-i18n:
...
4. 复制该 API key 以在 Mullusi 中使用

## CLI 设置

```bash
mullusi onboard --auth-choice qianfan-api-key
```

## 相关文档

- [Mullusi Configuration](/gateway/configuration)
