...
summary: 社区构建的基于 OpenClaw 的独立项目和集成项目
title: 案例展示
x-i18n:
...
这些事来自社区的真实项目，让我们看看大家用 OpenClaw 搞了什么脑洞大开的小玩意儿。

<Info>
**想要在这里展示你的项目？** 在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 或 [X 上 @openclaw](https://x.com/openclaw) 上提交申请吧。
</Info>
