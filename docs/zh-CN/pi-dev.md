...
本指南总结了在 SmartAgentNeo 中开发 Pi 集成的合理工作流程。
...
状态存储在 SmartAgentNeo 状态目录下。默认为 `~/.smart-agent-neo`。如果设置了 `SMART_AGENT_NEO_STATE_DIR`，则使用该目录。

要重置所有内容：

- `smart-agent-neo.json` 用于配置
...
- https://docs.smart-agent-neo.ai/testing
- https://docs.smart-agent-neo.ai/start/getting-started
