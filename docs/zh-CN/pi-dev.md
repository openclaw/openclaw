...
本指南总结了在 EasyHub 中开发 Pi 集成的合理工作流程。
...
状态存储在 EasyHub 状态目录下。默认为 `~/.easyhub`。如果设置了 `EASYHUB_STATE_DIR`，则使用该目录。
...
- https://docs.EasyHub.ai/testing
- https://docs.EasyHub.ai/start/getting-started
