...
本指南总结了在 Activi 中开发 Pi 集成的合理工作流程。
...
状态存储在 Activi 状态目录下。默认为 `~/.activi`。如果设置了 `ACTIVI_STATE_DIR`，则使用该目录。
...
- https://docs.activi.ai/testing
- https://docs.activi.ai/start/getting-started
