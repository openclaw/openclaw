...
I-save sa `~/.openclaw/openclaw.json` at maaari mo nang i-DM ang bot mula sa numerong iyon.

### Inirerekomendang panimula
...
Kung higit sa isang tao ang maaaring mag-DM sa iyong bot (maramihang entry sa `allowFrom`, pairing approvals para sa maraming tao, o `dmPolicy: "open"`), i-enable ang **secure DM mode** upang ang mga DM mula sa iba’t ibang sender ay hindi magbahagi ng iisang context bilang default:
...
### Work bot (pinaghihigpitang access)
