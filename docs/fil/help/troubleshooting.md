...
<AccordionGroup>
  <Accordion title="Walang mga reply">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw channels status --probe
  ...
  <Accordion title="Hindi kumokonek ang Dashboard o Control UI">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Hindi nagsisimula ang Gateway o naka-install ang serbisyo pero hindi tumatakbo">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Kumokonek ang channel pero hindi dumadaloy ang mga mensahe">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Hindi nag-fire ang Cron o heartbeat o hindi nakapag-deliver">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Naka-pair ang node pero pumapalya ang tool sa camera canvas screen exec">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Pumapalya ang browser tool">
    ```bash
    openclaw status
    openclaw gateway status
