...
سب ایجنٹس پس منظر (background) میں چلنے والی ایجنٹ رنز ہوتے ہیں جو کسی موجودہ ایجنٹ رن سے شروع کیے جاتے ہیں۔ یہ اپنی الگ سیشن میں چلتے ہیں (`agent:<agentId>:subagent:<uuid>`) اور مکمل ہونے پر درخواست کرنے والے چیٹ چینل میں اپنا نتیجہ **announce** کرتے ہیں۔
...
لاگت کا نوٹ: ہر سب ایجنٹ کا **اپنا** کانٹیکسٹ اور ٹوکن استعمال ہوتا ہے۔ بھاری یا دہرائے جانے والے کاموں کے لیے، سب ایجنٹس پر سستا ماڈل سیٹ کریں اور اپنے مین ایجنٹ کو زیادہ معیاری ماڈل پر رکھیں۔
آپ اسے `agents.defaults.subagents.model` کے ذریعے یا فی ایجنٹ اووررائیڈز کے ساتھ کنفیگر کر سکتے ہیں۔
...
- `agents.list[].subagents.allowAgents`: ان ایجنٹ IDs کی فہرست جنہیں `agentId` کے ذریعے ٹارگٹ کیا جا سکتا ہے (`["*"]` کسی کو بھی اجازت دینے کے لیے)۔ ڈیفالٹ: صرف درخواست کرنے والا ایجنٹ۔
...
- `runTimeoutSeconds` خودکار آرکائیو نہیں کرتا؛ یہ صرف رن کو روکتا ہے۔ The session remains until auto-archive.
...
نوٹ: مرج اضافی نوعیت کا ہے، اس لیے مین پروفائلز ہمیشہ بیک اپ کے طور پر دستیاب رہتے ہیں۔ ہر ایجنٹ کے لیے مکمل طور پر علیحدہ auth فی الحال سپورٹڈ نہیں ہے۔
...
- سب ایجنٹ اعلان **best-effort** ہے۔ اگر گیٹ وے دوبارہ شروع ہو جائے تو زیرِ التوا “announce back” کام ضائع ہو جاتا ہے۔
