...
- سیشنز: ایونٹس `runId` (فی رن) کے ساتھ آتے ہیں اور پے لوڈ میں `sessionKey` شامل ہوتا ہے۔ “مین” سیشن کی کلید `main` ہے؛ اگر موجود نہ ہو تو ہم تازہ ترین اپڈیٹ ہونے والے سیشن پر واپس چلے جاتے ہیں۔
- ترجیح: مین ہمیشہ غالب رہتا ہے۔ اگر مین فعال ہو تو اس کی حالت فوراً دکھائی جاتی ہے۔ اگر مین فارغ ہو تو سب سے حالیہ فعال غیر‑مین سیشن دکھایا جاتا ہے۔ ہم سرگرمی کے دوران بار بار تبدیلی نہیں کرتے؛ ہم صرف اسی وقت سوئچ کرتے ہیں جب موجودہ سیشن فارغ ہو جائے یا مین فعال ہو جائے۔
- سرگرمی کی اقسام:
