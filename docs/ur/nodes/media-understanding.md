...
OpenClaw جواب کے پائپ لائن کے چلنے سے پہلے **ان باؤنڈ میڈیا** (تصویر/آڈیو/ویڈیو) کا **خلاصہ** بنا سکتا ہے۔ یہ خودکار طور پر معلوم کرتا ہے کہ مقامی اوزار یا فراہم کنندہ کی کلیدیں دستیاب ہیں یا نہیں، اور اسے غیر فعال یا حسبِ ضرورت بنایا جا سکتا ہے۔ اگر سمجھ بوجھ بند ہو تو بھی ماڈلز کو اصل فائلیں/URLs حسبِ معمول موصول ہوتی رہتی ہیں۔
...
- `prompt` بطورِ طے شدہ سادہ “Describe the {media}.” کے ساتھ `maxChars` رہنمائی (صرف تصویر/ویڈیو) شامل کرتا ہے۔
...
اگر `tools.media.<capability>.enabled` کو `false` پر سیٹ **نہ** کیا گیا ہو اور آپ نے
ماڈلز کنفیگر نہ کیے ہوں تو OpenClaw اس ترتیب سے خودکار شناخت کرتا ہے اور **پہلے
کام کرنے والے آپشن پر رک جاتا ہے**:
...
اگر آپ `capabilities` سیٹ کریں تو انٹری صرف انہی میڈیا اقسام کے لیے چلتی ہے۔ مشترکہ
فہرستوں کے لیے OpenClaw ڈیفالٹس اخذ کر سکتا ہے:
...
CLI انٹریز کے لیے، غیر متوقع میچز سے بچنے کے لیے **`capabilities` واضح طور پر سیٹ کریں**۔
اگر آپ `capabilities` چھوڑ دیں تو انٹری اس فہرست کے لیے اہل ہوتی ہے جس میں وہ موجود ہو۔
...
- سمجھ بوجھ **بہترین کوشش** کی بنیاد پر ہوتی ہے۔ غلطیاں جوابات کو بلاک نہیں کرتیں۔
