...
یہ مسئلہ ڈویلپمنٹ اسکرپٹس کو Bun سے `tsx` پر منتقل کرنے کے بعد شروع ہوا (کمٹ `2871657e`, 2026-01-06)۔ وہی رن ٹائم راستہ Bun کے ساتھ درست کام کرتا تھا۔
...
- `tsx`، TS/ESM کو تبدیل کرنے کے لیے esbuild استعمال کرتا ہے۔ esbuild کا `keepNames` ایک `__name` ہیلپر خارج کرتا ہے اور فنکشن کی تعریفوں کو `__name(...)` کے ساتھ لپیٹتا ہے۔
