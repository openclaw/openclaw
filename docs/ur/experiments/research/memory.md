...
read_when:
  ...
  - فیصلہ کرتے ہوئے: علیحدہ CLI بمقابلہ گہرا OpenClaw انضمام
...
- وقتی حدود (“نومبر 2025 کے دوران کیا درست تھا؟”) اور تضاد کا حل
...
- **Daily log روزانہ ہی رہے**۔ اسے JSON میں بدلنے کی ضرورت نہیں۔
...
- **رائے**: “Peter کیا ترجیح دیتا ہے؟” (اعتماد + شواہد کے ساتھ)
