...
سیشن پروننگ ہر LLM کال سے عین پہلے اِن-میموری سیاق سے **پرانے ٹول نتائج** کو تراش دیتی ہے۔ یہ ڈسک پر محفوظ سیشن ہسٹری کو **دوبارہ نہیں لکھتی** (`*.jsonl`)۔
...
- **پرون کیوں کریں:** Anthropic پرامپٹ کیشنگ صرف TTL کے اندر لاگو ہوتی ہے۔ اگر کوئی سیشن TTL سے زیادہ وقت تک غیر فعال رہے تو اگلی درخواست پورا پرامپٹ دوبارہ کیش کرتی ہے، جب تک آپ پہلے اسے تراش نہ دیں۔
...
پروننگ ایک تخمینی سیاق ونڈو استعمال کرتی ہے (حروف ≈ ٹوکن × 4)۔ بنیادی ونڈو اس ترتیب سے طے ہوتی ہے:
...
- کمپیکشن الگ ہے: کمپیکشن خلاصہ بنا کر محفوظ کرتی ہے، جبکہ پروننگ ہر درخواست کے لیے عارضی ہوتی ہے۔ دیکھیں [/concepts/compaction](/concepts/compaction)۔
