...
ہر WS کلائنٹ ایک `connect` درخواست سے آغاز کرتا ہے۔ کامیاب ہینڈ شیک پر
Gateway اس کنیکشن کے لیے presence اندراج کو upsert کرتا ہے۔

#### ایک وقتی CLI کمانڈز کیوں نظر نہیں آتیں

CLI اکثر مختصر، ایک وقتی کمانڈز کے لیے کنیکٹ ہوتا ہے۔ Instances فہرست میں
اسپام سے بچنے کے لیے، `client.mode === "cli"` کو presence اندراج میں **تبدیل نہیں** کیا جاتا۔

### 3) `system-event` بیکنز

کلائنٹس `system-event` طریقہ کے ذریعے زیادہ معلوماتی دورانیہ وار بیکنز بھیج سکتے ہیں۔
mac ایپ اس کا استعمال ہوسٹ نام، IP، اور `lastInputSeconds` رپورٹ کرنے کے لیے کرتی ہے۔
...
جب کوئی کلائنٹ SSH سرنگ / لوکل پورٹ فارورڈ کے ذریعے کنیکٹ ہوتا ہے تو Gateway
ریموٹ ایڈریس کو `127.0.0.1` کے طور پر دیکھ سکتا ہے۔ اچھے کلائنٹ‑رپورٹ کردہ
IP کو اوور رائٹ کرنے سے بچنے کے لیے، loopback ریموٹ ایڈریسز کو نظرانداز کیا جاتا ہے۔
