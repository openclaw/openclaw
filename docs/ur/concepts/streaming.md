...
- **بلاک اسٹریمنگ (چینلز):** اسسٹنٹ کے لکھتے ہی مکمل شدہ **بلاکس** خارج کرتا ہے۔ یہ عام چینل پیغامات ہوتے ہیں (ٹوکن ڈیلٹاز نہیں)۔
...
اس وقت بیرونی چینل پیغامات کے لیے **حقیقی ٹوکن اسٹریمنگ موجود نہیں**۔ جزوی اسٹریمنگ کی واحد سطح Telegram ڈرافٹ اسٹریمنگ ہے۔
...
- `agents.defaults.blockStreamingCoalesce`: `{ minChars?, maxChars?, idleMs? }` (بھیجنے سے پہلے اسٹریمنگ شدہ بلاکس کو ضم کریں)۔
...
جب بلاک اسٹریمنگ فعال ہو، OpenClaw بھیجنے سے پہلے **مسلسل بلاک چنکس کو ضم** کر سکتا ہے۔
اس سے “ایک سطر کا اسپام” کم ہوتا ہے جبکہ تدریجی آؤٹ پٹ برقرار رہتا ہے۔
...
جب بلاک اسٹریمنگ فعال ہو، آپ بلاک جوابات کے درمیان **بے ترتیب وقفہ** شامل کر سکتے ہیں
(پہلے بلاک کے بعد)۔ اس سے کثیر-ببل جوابات زیادہ فطری محسوس ہوتے ہیں۔
...
- **چنکس اسٹریمنگ کریں:** `blockStreamingDefault: "on"` + `blockStreamingBreak: "text_end"` (جیسے جیسے بنے خارج کریں)۔ غیر-Telegram چینلز کے لیے `*.blockStreaming: true` بھی درکار ہے۔
...
**چینل نوٹ:** غیر-Telegram چینلز کے لیے بلاک اسٹریمنگ **بند رہتی ہے جب تک**
`*.blockStreaming` کو واضح طور پر `true` پر سیٹ نہ کیا جائے۔ Telegram بلاک جوابات کے بغیر بھی ڈرافٹس اسٹریمنگ کر سکتا ہے
