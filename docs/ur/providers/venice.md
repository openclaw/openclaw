...
Venice AI رازداری پر مبنی AI انفیرینس فراہم کرتا ہے، جس میں غیر سنسر شدہ ماڈلز کی سپورٹ اور اپنے گمنام پراکسی کے ذریعے بڑے ملکیتی ماڈلز تک رسائی شامل ہے۔ تمام انفیرینس بطورِ طے شدہ نجی ہوتی ہے—آپ کے ڈیٹا پر کوئی تربیت نہیں، کوئی لاگنگ نہیں۔
...
| موڈ       | وضاحت                                                                                                               | ماڈلز                                           |
| --------- | ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| **نجی**   | مکمل طور پر نجی۔ پرامپٹس/جوابات **کبھی محفوظ یا لاگ نہیں ہوتے**۔ عارضی۔                                             | Llama، Qwen، DeepSeek، Venice Uncensored، وغیرہ |
| **گمنام** | Venice کے ذریعے پراکسی، میٹاڈیٹا ہٹا دیا جاتا ہے۔ بنیادی فراہم کنندہ (OpenAI، Anthropic) گمنام درخواستیں دیکھتا ہے۔ | Claude، GPT، Gemini، Grok، Kimi، MiniMax        |
...
سیٹ اپ کے بعد، OpenClaw تمام دستیاب Venice ماڈلز دکھاتا ہے۔ اپنی ضرورت کے مطابق انتخاب کریں:
...
جب `VENICE_API_KEY` سیٹ ہو تو OpenClaw Venice API سے خودکار طور پر ماڈلز دریافت کرتا ہے۔ اگر API ناقابلِ رسائی ہو تو یہ جامد کیٹلاگ پر واپس آ جاتا ہے۔
...
Venice کریڈٹ پر مبنی نظام استعمال کرتا ہے۔ موجودہ نرخوں کے لیے [venice.ai/pricing](https://venice.ai/pricing) دیکھیں:
...
Venice ماڈل کیٹلاگ متحرک طور پر اپ ڈیٹ ہوتا ہے۔ اس وقت دستیاب ماڈلز دیکھنے کے لیے `openclaw models list` چلائیں۔ کچھ ماڈلز عارضی طور پر آف لائن ہو سکتے ہیں۔

### کنکشن کے مسائل

Venice API یہاں ہے: `https://api.venice.ai/api/v1`۔ یقینی بنائیں کہ آپ کا نیٹ ورک HTTPS کنکشنز کی اجازت دیتا ہے۔
