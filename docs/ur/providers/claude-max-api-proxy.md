...
**claude-max-api-proxy** ایک کمیونٹی ٹول ہے جو آپ کی Claude Max/Pro سبسکرپشن کو OpenAI-مطابقت رکھنے والے API اینڈپوائنٹ کے طور پر پیش کرتا ہے۔ اس سے آپ اپنی سبسکرپشن کو کسی بھی ایسے ٹول کے ساتھ استعمال کر سکتے ہیں جو OpenAI API فارمیٹ کو سپورٹ کرتا ہو۔
