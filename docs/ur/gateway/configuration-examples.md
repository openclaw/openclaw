---
summary: "عام OpenClaw سیٹ اپس کے لیے اسکیمہ کے عین مطابق کنفیگریشن مثالیں"
read_when:
  - OpenClaw کو کنفیگر کرنے کا طریقہ سیکھتے وقت
...
اسے `~/.openclaw/openclaw.json` میں محفوظ کریں، اور آپ اس نمبر سے بوٹ کو DM کر سکتے ہیں۔

### سفارش کردہ ابتدائی سیٹ اپ
...
### محفوظ DM موڈ (مشترکہ ان باکس / متعدد صارفین کے DMs)

اگر ایک سے زیادہ افراد آپ کے بوٹ کو DM کر سکتے ہیں (`allowFrom` میں متعدد اندراجات، متعدد افراد کے لیے pairing منظوریات، یا `dmPolicy: "open"`)، تو **محفوظ DM موڈ** فعال کریں تاکہ مختلف ارسال کنندگان کے DMs بطورِ طے شدہ ایک ہی سیاق کا اشتراک نہ کریں:
...
### API کلید کے ساتھ OAuth فیل اوور
...
### Anthropic سبسکرپشن + API کلید، MiniMax فال بیک
