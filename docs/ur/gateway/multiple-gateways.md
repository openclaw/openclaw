...
زیادہ تر سیٹ اپس میں ایک Gateway کافی ہوتا ہے کیونکہ ایک ہی Gateway متعدد میسجنگ کنیکشنز اور ایجنٹس سنبھال سکتا ہے۔ اگر آپ کو زیادہ مضبوط آئسولیشن یا ریڈنڈنسی درکار ہو (مثلاً ایک ریسکیو بوٹ)، تو الگ الگ پروفائلز/پورٹس کے ساتھ علیحدہ Gateways چلائیں۔
...
- براؤزر پروفائل CDP پورٹس خودکار طور پر `browser.controlPort + 9 .. + 108` سے الاٹ ہوتے ہیں
...
- اگر آپ کو واضح CDP پورٹس درکار ہوں تو ہر انسٹینس کے لیے `browser.profiles.<name>.cdpPort` سیٹ کریں۔
- ریموٹ Chrome: `browser.profiles.<name>.cdpUrl` استعمال کریں (ہر پروفائل، ہر انسٹینس)۔
