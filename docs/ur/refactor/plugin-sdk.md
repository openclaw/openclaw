...
ہدف: ہر میسجنگ کنیکٹر ایک پلگ اِن ہو (بنڈل شدہ یا بیرونی) جو ایک مستحکم API استعمال کرے۔
کوئی پلگ اِن براہِ راست `src/**` سے امپورٹ نہ کرے۔ تمام انحصارات SDK یا رَن ٹائم کے ذریعے ہوں۔
...
دائرہ: اقسام، ہیلپرز، اور کنفیگ یوٹیلیٹیز۔ کوئی رَن ٹائم اسٹیٹ نہیں، کوئی سائیڈ ایفیکٹس نہیں۔
...
دائرہ: ہر وہ چیز جو کور رَن ٹائم کے رویے کو چھوتی ہے۔
...
- رَن ٹائم: ہر کور ریلیز کے ساتھ ورژنڈ۔ `api.runtime.version` شامل کریں۔
