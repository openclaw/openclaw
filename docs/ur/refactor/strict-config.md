...
- `plugins.entries.<id>.config` کی توثیق پلگ اِن کے اسکیما کے ذریعے ہونا لازم ہے۔
  - اگر کسی پلگ اِن میں اسکیما موجود نہ ہو تو **پلگ اِن لوڈ کو مسترد کریں** اور واضح غلطی ظاہر کریں۔
- نامعلوم `channels.<id>` کیز اس وقت تک غلطی ہیں جب تک پلگ اِن مینی فیسٹ چینل آئی ڈی کا اعلان نہ کرے۔
...
باقی سب کچھ سختی سے ناکام ہو اور یہ پیغام دے: “کنفیگ غلط ہے۔ `openclaw doctor --fix` چلائیں۔”
