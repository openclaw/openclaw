...
واضح اور مختصر مسائل تشخیص اور درستگی کو تیز کرتے ہیں۔ بگز، ریگریشنز، یا فیچر کی کمی کے لیے درج ذیل شامل کریں:
...
_عوامی طور پر راز/ایکسپلائٹ کی تفصیلات سے گریز کریں۔ حساس مسائل کے لیے تفصیل کم رکھیں اور نجی انکشاف کی درخواست کریں۔_
...
PR سے پہلے ایشو اختیاری ہے۔ اگر چھوڑ رہے ہوں تو PR میں تفصیلات شامل کریں۔ PR کو مرکوز رکھیں، ایشو نمبر نوٹ کریں، ٹیسٹس شامل کریں یا عدم موجودگی کی وضاحت کریں، رویے کی تبدیلیوں/خطرات کی دستاویز بنائیں، ثبوت کے طور پر ریڈیکٹڈ لاگز/اسکرین شاٹس شامل کریں، اور جمع کرانے سے پہلے مناسب تصدیق چلائیں۔
