...
اچھے PRs کا جائزہ لینا آسان ہوتا ہے: جائزہ لینے والوں کو فوراً مقصد سمجھ آ جانا چاہیے، رویّے کی تصدیق ہو سکے، اور تبدیلیاں محفوظ طریقے سے شامل کی جا سکیں۔ یہ رہنما انسانوں اور LLM کے جائزے کے لیے مختصر، اعلیٰ سگنل سبمشنز کا احاطہ کرتا ہے۔

## ایک اچھے PR کی خصوصیات

- [ ] مسئلہ، اس کی اہمیت، اور کی گئی تبدیلی کی وضاحت کریں۔
- [ ] تبدیلیوں کو مرکوز رکھیں۔ وسیع ری فیکٹرز سے گریز کریں۔
...
مختصر رہیں؛ مختصر جائزہ > گرامر۔ جو حصے لاگو نہ ہوں انہیں حذف کر دیں۔
...
- [ ] سکیورٹی: خطرے کا خلاصہ، ری پرو، تصدیق، کوئی حساس ڈیٹا نہیں۔ صرف مستند دعوے۔
