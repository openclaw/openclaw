...
اگر آپ "$~5-12/ماہ میں OpenClaw 24/7" چاہتے ہیں، تو یہ Google Cloud پر ایک قابلِ اعتماد سیٹ اپ ہے۔
قیمت مشین ٹائپ اور ریجن کے مطابق بدلتی ہے؛ اپنے ورک لوڈ کے مطابق سب سے چھوٹی VM منتخب کریں اور اگر OOM آئیں تو اسکیل اپ کریں۔
...
یہ گائیڈ GCP Compute Engine پر Debian استعمال کرتی ہے۔
Ubuntu بھی کام کرتا ہے؛ پیکجز کے مطابق میپ کریں۔
عام Docker فلو کے لیے دیکھیں: [Docker](/install/docker)۔
...
نوٹ: VM بننے کے بعد SSH کی پروپیگیشن میں 1-2 منٹ لگ سکتے ہیں۔ اگر کنکشن ریفیوز ہو تو انتظار کریں اور دوبارہ کوشش کریں۔
...
تمام طویل مدتی اسٹیٹ کو ہوسٹ پر ہونا چاہیے۔
...
چلتے ہوئے کنٹینر کے اندر بائنریز انسٹال کرنا ایک غلطی ہے۔
رن ٹائم پر انسٹال کی گئی ہر چیز ری اسٹارٹ پر ضائع ہو جائے گی۔
...
اسی پیٹرن سے آپ جتنی چاہیں بائنریز انسٹال کر سکتے ہیں۔
...
OpenClaw Docker میں چلتا ہے، مگر Docker سورس آف ٹروتھ نہیں ہے۔
تمام طویل مدتی اسٹیٹ کو ری اسٹارٹس، ری بلڈز، اور ری بوٹس کے بعد بھی برقرار رہنا چاہیے۔
...
VM بننے کے بعد SSH کی پروپیگیشن میں 1-2 منٹ لگ سکتے ہیں۔ انتظار کریں اور دوبارہ کوشش کریں۔
...
آٹومیشن کے لیے Owner رول استعمال کرنے سے گریز کریں۔ کم سے کم اختیار کے اصول پر عمل کریں۔
