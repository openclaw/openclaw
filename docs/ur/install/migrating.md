...
آؤٹ پٹ میں `OPENCLAW_STATE_DIR` / پروفائل کے حوالہ جات دیکھیں۔ اگر آپ متعدد گیٹ ویز چلاتے ہیں، تو ہر پروفائل کے لیے دہرائیں۔
...
Doctor ایک “محفوظ اور سادہ” کمانڈ ہے۔ یہ سروسز کی مرمت کرتی ہے، کنفیگ مائیگریشنز لاگو کرتی ہے، اور عدم مطابقت کی وارننگ دیتی ہے۔
...
`openclaw.json` کافی نہیں ہے۔ بہت سے فراہم کنندگان اسٹیٹ یہاں محفوظ کرتے ہیں:
...
`$OPENCLAW_STATE_DIR` میں راز شامل ہوتے ہیں (API کلیدیں، OAuth ٹوکنز، WhatsApp اسناد)۔ بیک اپس کو پروڈکشن رازوں کی طرح ہینڈل کریں:
