...
heartbeat اور cron جابز دونوں آپ کو شیڈول کے مطابق کام چلانے دیتے ہیں۔ یہ گائیڈ آپ کے استعمال کے کیس کے لیے درست طریقہ کار منتخب کرنے میں مدد دیتی ہے۔
...
Heartbeat باقاعدہ وقفے پر **main session** میں چلتا ہے (بطورِ طے شدہ: 30 منٹ)۔ اسے اس لیے ڈیزائن کیا گیا ہے کہ ایجنٹ چیزوں کی جانچ کرے اور جو بھی اہم ہو اسے سامنے لائے۔
...
Lobster **کئی مرحلہ وار ٹول پائپ لائنز** کے لیے ورک فلو رن ٹائم ہے جنہیں متعین عمل درآمد اور واضح منظوریوں کی ضرورت ہوتی ہے۔
جب کام ایک واحد ایجنٹ ٹرن سے زیادہ ہو، اور آپ انسانی چیک پوائنٹس کے ساتھ قابلِ دوبارہ آغاز ورک فلو چاہتے ہوں، تو اسے استعمال کریں۔
...
شیڈولڈ ورک فلو کے لیے، cron یا heartbeat سے ایک ایجنٹ ٹرن ٹرگر کریں جو Lobster کو کال کرے۔
ایڈ ہاک ورک فلو کے لیے، Lobster کو براہِ راست کال کریں۔
