...
- `/trust [minutes]` — trust all exec in this session for X minutes (sets exec security to `full`); default 15m, max 480m
- `/untrust` — end the active trust window for this session immediately
