...
| Teach an agent a workflow                   | [Skills](#choose-tools-skills-or-plugins)      | [Creating skills](/tools/creating-skills), [Skills config](/tools/skills-config), and [Skill Workshop](/tools/skill-workshop) |
...
<Steps>
  ...
  <Step title="Use a skill when the agent needs instructions">
    ...
    [Creating skills](/tools/creating-skills) | [Skill Workshop](/tools/skill-workshop) | [Skills config](/tools/skills-config)
...
- Add or tune reusable agent instructions with [Creating skills](/tools/creating-skills) and
...
- [Skills config](/tools/skills-config) for skill visibility, gating, and config
