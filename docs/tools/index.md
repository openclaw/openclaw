---
summary: "Mullusi tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Mullusi provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Mullusi), others are **external** (published on npm by the community).
...
These tools ship with Mullusi and are available without installing any plugins:
...
- [Mullusi](/tools/mullusi) — typed workflow runtime with resumable approvals
...
| `group:mullusi`   | All built-in Mullusi tools (excludes plugin tools)                                                       |
