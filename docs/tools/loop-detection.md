...
EVOX.sh can keep agents from getting stuck in repeated tool-call patterns.
...
When a loop is detected, EVOX.sh reports a loop event and blocks or dampens the next tool-cycle depending on severity.
