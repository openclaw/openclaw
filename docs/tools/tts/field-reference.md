...
<AccordionGroup>
  ...
  <Accordion title="Google Gemini">
    ...
    <ParamField path="model" type="string">Gemini TTS model. Default `gemini-3.8-flash-tts`. Also `gemini-3.8-flash-lite-tts`, `gemini-3.1-flash-tts-preview`, `gemini-2.5-flash-preview-tts`, and `gemini-2.5-pro-preview-tts`.</ParamField>
