...
| KlingAI               | `kling-v3`                      | Yes  | 1 image                                              | No               | `KLING_API_KEY`                          |
...
| KlingAI  | Yes        | Yes            | No             | Not in the shared sweep                                                                                                                  |
...
| KlingAI               | Uses async submit/poll task flow. Supports text-to-video and single-image reference flows.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
