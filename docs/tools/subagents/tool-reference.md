...
<ParamField path="thinking" type="string">
  Override thinking level for the sub-agent run. Supported with `visible: true` for child sessions.
</ParamField>
