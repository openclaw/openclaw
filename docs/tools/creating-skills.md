...
- **Config overrides** — Customize skill behavior per-agent via `openclaw.json`. See [Config overrides](./skills.md#config-overrides-openclawopenclawjson).
- **Testing** — Run `openclaw skills check` to validate your skills locally before publishing.
