---
summary: "Web search + fetch tools (Perplexity Search API, Brave, Gemini, Grok, Kimi, and SearXNG providers)"
read_when:
...
- `web_search` — Search the web using Perplexity Search API, Brave Search API, Gemini with Google Search grounding, Grok, Kimi, or a self-hosted SearXNG instance (no API key required).
