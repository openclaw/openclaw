...
<Steps>
  ...
  <Step title="Node.js 22+ sicherstellen">
  ...
  <Step title="Post-Installationsaufgaben">
...
<Steps>
  <Step title="Lokale Node-Runtime installieren">
...
<Tabs>
  ...
  <Tab title="Automatisierung mit JSON-Ausgabe">
    ```bash
