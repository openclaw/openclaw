...
smart-agent-neo system heartbeat last
smart-agent-neo logs --follow
smart-agent-neo config get agents.defaults.heartbeat
smart-agent-neo channels status --probe
```
...
```bash
smart-agent-neo config get agents.defaults.heartbeat.activeHours
smart-agent-neo config get agents.defaults.heartbeat.activeHours.timezone
smart-agent-neo config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
smart-agent-neo cron list
smart-agent-neo logs --follow
```
