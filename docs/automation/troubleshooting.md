...
hanzo-bot system heartbeat last
hanzo-bot logs --follow
hanzo-bot config get agents.defaults.heartbeat
hanzo-bot channels status --probe
```
...
```bash
hanzo-bot config get agents.defaults.heartbeat.activeHours
hanzo-bot config get agents.defaults.heartbeat.activeHours.timezone
hanzo-bot config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
hanzo-bot cron list
hanzo-bot logs --follow
```
