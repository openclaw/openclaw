...
Injects additional bootstrap files (for example monorepo-local `AGENTS.md` / `TOOLS.md` or a companion file like `tone_skills.md`) during `agent:bootstrap`.
...
- Only recognized bootstrap basenames are loaded (`AGENTS.md`, `SOUL.md`, `TOOLS.md`, `IDENTITY.md`, `USER.md`, `HEARTBEAT.md`, `BOOTSTRAP.md`, `MEMORY.md`, `memory.md`, `tone_skills.md`).
