...
Zalo वियतनाम-केंद्रित मैसेजिंग ऐप है; इसका Bot API Gateway को 1:1 बातचीत के लिए बॉट चलाने देता है।
यह सपोर्ट या नोटिफ़िकेशन के लिए उपयुक्त है जहाँ आप Zalo तक निश्चित रूटिंग चाहते हैं।
...
3. Gateway को पुनः प्रारंभ करें। टोकन (env या config) रिज़ॉल्व होने पर Zalo शुरू हो जाता है।
4. DM एक्सेस डिफ़ॉल्ट रूप से pairing है। बॉट से पहली बार संपर्क होने पर कोड स्वीकृत करें।
...
- डिफ़ॉल्ट: `channels.zalo.dmPolicy = "pairing"`. अज्ञात प्रेषकों को pairing कोड मिलता है; स्वीकृति तक संदेश अनदेखे रहते हैं (कोड 1 घंटे बाद समाप्त हो जाते हैं)।
- स्वीकृति के तरीके:
...
- `channels.zalo.allowFrom`: DM अनुमति-सूची (यूज़र आईडी)। `open` के लिए `"*"` आवश्यक है। विज़ार्ड संख्यात्मक आईडी पूछेगा।
...
- `channels.zalo.accounts.<id>.botToken`: प्रति-अकाउंट टोकन।
- `channels.zalo.accounts.<id>.tokenFile`: प्रति-अकाउंट टोकन फ़ाइल।
- `channels.zalo.accounts.<id>.name`: डिस्प्ले नाम।
- `channels.zalo.accounts.<id>.enabled`: अकाउंट सक्षम/अक्षम करें।
- `channels.zalo.accounts.<id>.dmPolicy`: प्रति-अकाउंट DM नीति।
- `channels.zalo.accounts.<id>.allowFrom`: प्रति-अकाउंट अनुमति-सूची।
- `channels.zalo.accounts.<id>.webhookUrl`: प्रति-अकाउंट वेबहुक URL।
- `channels.zalo.accounts.<id>.webhookSecret`: प्रति-अकाउंट वेबहुक सीक्रेट।
- `channels.zalo.accounts.<id>.webhookPath`: प्रति-अकाउंट वेबहुक पाथ।
- `channels.zalo.accounts.<id>.proxy`: प्रति-अकाउंट प्रॉक्सी URL।
