...
ब्रॉडकास्ट समूह कई एजेंट्स को एक ही संदेश को एक साथ संसाधित करने और उत्तर देने में सक्षम बनाते हैं। इससे आप विशेषीकृत एजेंट टीम्स बना सकते हैं जो एक ही WhatsApp समूह या DM में मिलकर काम करती हैं — और वह भी एक ही फ़ोन नंबर का उपयोग करते हुए।

वर्तमान दायरा: **केवल WhatsApp** (वेब चैनल)।

ब्रॉडकास्ट समूहों का मूल्यांकन चैनल allowlists और समूह सक्रियण नियमों के बाद किया जाता है। WhatsApp समूहों में, इसका अर्थ है कि ब्रॉडकास्ट तब होता है जब OpenClaw सामान्य रूप से उत्तर देता (उदाहरण के लिए: मेंशन पर, आपके समूह सेटिंग्स के अनुसार)।

## उपयोग के मामले

### 1. विशेषीकृत एजेंट टीम्स
...
एक शीर्ष-स्तरीय `broadcast` अनुभाग जोड़ें (`bindings` के बगल में)। कुंजियाँ WhatsApp peer ids होती हैं:

- समूह चैट्स: समूह JID (उदा. `120363403215116621@g.us`)
...
टिप्पणी: ब्रॉडकास्ट समूह चैनल allowlists या समूह सक्रियण नियमों (मेंटions/कमांड्स/आदि) को बायपास नहीं करते। वे केवल यह बदलते हैं कि कोई संदेश संसाधन के लिए पात्र होने पर _कौन से एजेंट चलते हैं_।
...
### 3. अलग-अलग टूल पहुँच विन्यस्त करें
...
एजेंट्स स्वतंत्र रूप से विफल होते हैं। एक एजेंट की त्रुटि दूसरों को अवरुद्ध नहीं करती:
...
2. Peer ID का फ़ॉर्मेट सही है (उदा. `120363403215116621@g.us`)
