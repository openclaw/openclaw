...
Feishu (Lark) एक टीम चैट प्लेटफ़ॉर्म है जिसका उपयोग कंपनियाँ संदेश भेजने और सहयोग के लिए करती हैं। यह प्लगइन प्लेटफ़ॉर्म की WebSocket इवेंट सब्सक्रिप्शन का उपयोग करके OpenClaw को Feishu/Lark बॉट से जोड़ता है, ताकि सार्वजनिक वेबहुक URL को उजागर किए बिना संदेश प्राप्त किए जा सकें।
...
### 6. इवेंट सब्सक्रिप्शन विन्यस्त करें
...
यदि आपका टेनेंट Lark (अंतरराष्ट्रीय) पर है, तो डोमेन को `lark` (या पूर्ण डोमेन स्ट्रिंग) पर सेट करें। आप इसे `channels.feishu.domain` पर या प्रति खाता (`channels.feishu.accounts.<id>.domain`) सेट कर सकते हैं।
...
### 2. परीक्षण संदेश भेजें

Feishu में अपने बॉट को खोजें और एक संदेश भेजें।

### 3. पेयरिंग स्वीकृत करें

डिफ़ॉल्ट रूप से, बॉट एक पेयरिंग कोड के साथ उत्तर देता है। इसे स्वीकृत करें:
...
Feishu इंटरैक्टिव कार्ड के माध्यम से स्ट्रीमिंग उत्तरों का समर्थन करता है। सक्षम होने पर, बॉट टेक्स्ट उत्पन्न करते समय कार्ड को अपडेट करता है।
