...
स्थिति: प्रायोगिक। यह एकीकरण `zca-cli` के माध्यम से **व्यक्तिगत Zalo खाते** को स्वचालित करता है।

> **चेतावनी:** यह एक अनौपचारिक एकीकरण है और इससे खाता निलंबन/प्रतिबंध हो सकता है। अपने जोखिम पर उपयोग करें।
...
चैनल आईडी `zalouser` है ताकि यह स्पष्ट रहे कि यह **व्यक्तिगत Zalo उपयोगकर्ता खाते** (अनौपचारिक) को स्वचालित करता है। संभावित भविष्य के आधिकारिक Zalo API एकीकरण के लिए हम `zalo` को आरक्षित रखते हैं।
...
`channels.zalouser.allowFrom` उपयोगकर्ता IDs या नाम स्वीकार करता है। जहाँ उपलब्ध हो, विज़ार्ड `zca friend find` के माध्यम से नामों को IDs में परिवर्तित करता है।
...
- डिफ़ॉल्ट: `channels.zalouser.groupPolicy = "open"` (समूह अनुमत)। यदि सेट न हो तो डिफ़ॉल्ट को ओवरराइड करने के लिए `channels.defaults.groupPolicy` का उपयोग करें।
...
खाते zca प्रोफ़ाइलों से मैप होते हैं। उदाहरण:
