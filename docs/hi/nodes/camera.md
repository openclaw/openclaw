...
`canvas.*` की तरह, iOS नोड केवल **फ़ोरग्राउंड** में `camera.*` कमांड की अनुमति देता है। बैकग्राउंड इन्वोकेशन `NODE_BACKGROUND_UNAVAILABLE` लौटाते हैं।
...
`canvas.*` की तरह, Android नोड केवल **फ़ोरग्राउंड** में `camera.*` कमांड की अनुमति देता है। बैकग्राउंड इन्वोकेशन `NODE_BACKGROUND_UNAVAILABLE` लौटाते हैं।
