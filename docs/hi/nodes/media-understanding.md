...
OpenClaw उत्तर पाइपलाइन चलने से पहले **इनबाउंड मीडिया** (इमेज/ऑडियो/वीडियो) का **सार** बना सकता है। यह स्वतः पहचान लेता है कि स्थानीय टूल या प्रदाता कुंजियाँ उपलब्ध हैं या नहीं, और इसे अक्षम या अनुकूलित किया जा सकता है। यदि समझ बंद है, तो मॉडल सामान्य रूप से मूल फ़ाइलें/URL ही प्राप्त करते हैं।
...
- `prompt` का डिफ़ॉल्ट सरल “Describe the {media}.” है, साथ में `maxChars` मार्गदर्शन (केवल इमेज/वीडियो)।
...
यदि `tools.media.<capability>.enabled` को `false` पर **सेट नहीं** किया गया है और आपने
मॉडल कॉन्फ़िगर नहीं किए हैं, तो OpenClaw इस क्रम में ऑटो‑डिटेक्ट करता है और **पहले
कार्यशील विकल्प पर रुक जाता है**:
...
यदि आप `capabilities` सेट करते हैं, तो एंट्री केवल उन्हीं मीडिया प्रकारों के लिए चलती है। साझा
सूचियों के लिए, OpenClaw डिफ़ॉल्ट्स का अनुमान लगा सकता है:
...
CLI एंट्रीज़ के लिए, **अप्रत्याशित मैच से बचने हेतु `capabilities` स्पष्ट रूप से सेट करें**।
यदि आप `capabilities` छोड़ देते हैं, तो एंट्री जिस सूची में दिखाई देती है उसके लिए पात्र होती है।
...
- समझ **best‑effort** है। त्रुटियाँ उत्तरों को अवरुद्ध नहीं करतीं।
