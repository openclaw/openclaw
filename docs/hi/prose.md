...
OpenProse AI सत्रों का ऑर्केस्ट्रेशन करने के लिए एक पोर्टेबल, मार्कडाउन-प्रथम वर्कफ़्लो फ़ॉर्मैट है। OpenClaw में यह एक प्लगइन के रूप में आता है जो एक OpenProse skill pack के साथ एक `/prose` स्लैश कमांड इंस्टॉल करता है। प्रोग्राम `.prose` फ़ाइलों में रहते हैं और स्पष्ट नियंत्रण प्रवाह के साथ कई उप-एजेंट्स स्पॉन कर सकते हैं।
...
बंडल किए गए प्लगइन्स डिफ़ॉल्ट रूप से अक्षम होते हैं। OpenProse सक्षम करें:
...
OpenProse `/prose` को एक उपयोगकर्ता-आह्वान योग्य skill कमांड के रूप में पंजीकृत करता है। यह OpenProse VM निर्देशों तक रूट करता है और आंतरिक रूप से OpenClaw टूल्स का उपयोग करता है।
...
`/prose run <handle/slug>` का समाधान `https://p.prose.md/<handle>/<slug>` में होता है।
प्रत्यक्ष URLs को जैसा-का-तैसा फ़ेच किया जाता है। यह `web_fetch` टूल का उपयोग करता है (या POST के लिए `exec`)।
...
यदि आपकी टूल अलाउलिस्ट इन टूल्स को ब्लॉक करती है, तो OpenProse प्रोग्राम विफल हो जाएंगे। देखें [Skills config](/tools/skills-config).

## सुरक्षा + अनुमोदन

`.prose` फ़ाइलों को कोड की तरह मानें। चलाने से पहले समीक्षा करें। साइड इफ़ेक्ट्स को नियंत्रित करने के लिए OpenClaw टूल अलाउलिस्ट्स और अनुमोदन गेट्स का उपयोग करें।
