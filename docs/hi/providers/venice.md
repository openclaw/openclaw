...
Venice AI गोपनीयता-केंद्रित AI इनफेरेंस प्रदान करता है, जिसमें अनसेंसरड मॉडलों का समर्थन और उनके अनामीकृत प्रॉक्सी के माध्यम से प्रमुख स्वामित्व वाले मॉडलों तक पहुँच शामिल है। सभी इनफेरेंस डिफ़ॉल्ट रूप से निजी होते हैं—आपके डेटा पर कोई प्रशिक्षण नहीं, कोई लॉगिंग नहीं।
...
| मोड            | विवरण                                                                                                               | मॉडल                                          |
| -------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| **Private**    | पूर्णतः निजी। प्रॉम्प्ट/प्रतिक्रियाएँ **कभी संग्रहीत या लॉग नहीं** की जातीं। अल्पकालिक।                             | Llama, Qwen, DeepSeek, Venice Uncensored, आदि |
| **Anonymized** | Venice के माध्यम से प्रॉक्सी, मेटाडेटा हटाया जाता है। मूल प्रदाता (OpenAI, Anthropic) को अनामीकृत अनुरोध दिखते हैं। | Claude, GPT, Gemini, Grok, Kimi, MiniMax      |
...
सेटअप के बाद, OpenClaw सभी उपलब्ध Venice मॉडल दिखाता है। अपनी आवश्यकताओं के आधार पर चुनें:
...
जब `VENICE_API_KEY` सेट होता है, OpenClaw Venice API से मॉडलों को स्वचालित रूप से खोजता है। यदि API उपलब्ध न हो, तो यह एक स्थिर कैटलॉग पर वापस जाता है।
...
Venice क्रेडिट-आधारित प्रणाली का उपयोग करता है। वर्तमान दरों के लिए [venice.ai/pricing](https://venice.ai/pricing) देखें:
...
Venice मॉडल कैटलॉग गतिशील रूप से अपडेट होता है। वर्तमान में उपलब्ध मॉडलों को देखने के लिए `openclaw models list` चलाएँ। कुछ मॉडल अस्थायी रूप से ऑफ़लाइन हो सकते हैं।

### कनेक्शन समस्याएँ

Venice API `https://api.venice.ai/api/v1` पर है। सुनिश्चित करें कि आपका नेटवर्क HTTPS कनेक्शनों की अनुमति देता है।
