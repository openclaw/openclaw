...
Ollama एक स्थानीय LLM रनटाइम है जो आपकी मशीन पर ओपन-सोर्स मॉडलों को चलाना आसान बनाता है। OpenClaw, Ollama के OpenAI-संगत API के साथ एकीकृत होता है और **टूल-सक्षम मॉडलों की स्वतः खोज** कर सकता है जब आप `OLLAMA_API_KEY` (या किसी auth प्रोफ़ाइल) के साथ ऑप्ट-इन करते हैं और कोई स्पष्ट `models.providers.ollama` प्रविष्टि परिभाषित नहीं करते।
...
Ollama के रिस्पॉन्स फ़ॉर्मेट के साथ अंतर्निहित SDK में एक [ज्ञात समस्या](https://github.com/badlogic/pi-mono/issues/1205) के कारण, **Ollama मॉडलों के लिए स्ट्रीमिंग डिफ़ॉल्ट रूप से अक्षम** रहती है। यह टूल-सक्षम मॉडलों का उपयोग करते समय भ्रष्ट प्रतिक्रियाओं को रोकता है।
...
स्वतः-खोजे गए मॉडलों के लिए, OpenClaw उपलब्ध होने पर Ollama द्वारा रिपोर्ट की गई कॉन्टेक्स्ट विंडो का उपयोग करता है; अन्यथा यह `8192` पर डिफ़ॉल्ट करता है। आप स्पष्ट प्रदाता विन्यास में `contextWindow` और `maxTokens` को ओवरराइड कर सकते हैं।
...
OpenClaw केवल उन मॉडलों को स्वतः खोजता है जो टूल समर्थन रिपोर्ट करते हैं। यदि आपका मॉडल सूचीबद्ध नहीं है, तो इनमें से कोई एक करें:
...
यदि Ollama मॉडलों का उपयोग करते समय आपको टूल नामों (जैसे `sessions_send`, `memory_get`) या खंडित पाठ वाली बिगड़ी प्रतिक्रियाएँ दिखती हैं, तो यह स्ट्रीमिंग प्रतिक्रियाओं के साथ अपस्ट्रीम SDK की समस्या के कारण है। नवीनतम OpenClaw संस्करण में Ollama मॉडलों के लिए स्ट्रीमिंग अक्षम करके **यह डिफ़ॉल्ट रूप से ठीक कर दिया गया है**।
