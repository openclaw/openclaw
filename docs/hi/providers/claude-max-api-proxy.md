...
**claude-max-api-proxy** एक समुदाय द्वारा बनाया गया टूल है जो आपके Claude Max/Pro सब्सक्रिप्शन को OpenAI-संगत API एंडपॉइंट के रूप में उपलब्ध कराता है। इससे आप अपने सब्सक्रिप्शन को किसी भी ऐसे टूल के साथ उपयोग कर सकते हैं जो OpenAI API फ़ॉर्मेट का समर्थन करता हो।
