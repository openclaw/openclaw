...
Heartbeat और cron जॉब्स—दोनों—आपको शेड्यूल पर कार्य चलाने देते हैं। यह मार्गदर्शिका आपके उपयोग‑मामले के लिए सही तंत्र चुनने में मदद करती है।
...
Heartbeat **मुख्य सत्र** में नियमित अंतराल पर (डिफ़ॉल्ट: 30 मिनट) चलता है। इन्हें एजेंट द्वारा चीज़ों की जाँच करने और महत्वपूर्ण बातों को सामने लाने के लिए डिज़ाइन किया गया है।
...
Lobster **बहु‑चरण टूल पाइपलाइनों** के लिए वर्कफ़्लो रनटाइम है, जिन्हें निर्धारक निष्पादन और स्पष्ट अनुमोदनों की आवश्यकता होती है।
जब कार्य एकल एजेंट टर्न से अधिक हो, और आप मानव चेकपॉइंट्स के साथ पुनःआरंभ योग्य वर्कफ़्लो चाहते हों, तब इसका उपयोग करें।
...
शेड्यूल्ड वर्कफ़्लो के लिए, cron या heartbeat का उपयोग करके एक एजेंट टर्न ट्रिगर करें जो Lobster को कॉल करे।
ऐड‑हॉक वर्कफ़्लो के लिए, Lobster को सीधे कॉल करें।
