...
>
> openclaw-ansible रिपॉज़िटरी Ansible परिनियोजन के लिए स्रोत-प्रमाण (source of truth) है। यह पृष्ठ केवल एक संक्षिप्त अवलोकन है।
...
टिप्पणी: Gateway **सीधे होस्ट पर** चलता है (Docker में नहीं), लेकिन एजेंट sandbox आइसोलेशन के लिए Docker का उपयोग करते हैं। विवरण के लिए [Sandboxing](/gateway/sandboxing) देखें।
...
यह **केवल पोर्ट 22** (SSH) खुला दिखाना चाहिए। अन्य सभी सेवाएँ (Gateway, Docker) लॉक डाउन रहती हैं।

### Docker उपलब्धता

Docker **एजेंट sandbox** (आइसोलेटेड टूल निष्पादन) के लिए स्थापित किया जाता है, स्वयं Gateway चलाने के लिए नहीं। Gateway केवल localhost पर बाइंड होता है और Tailscale VPN के माध्यम से सुलभ होता है।
...
Ansible इंस्टॉलर OpenClaw को मैनुअल अपडेट के लिए सेट करता है। मानक अपडेट प्रक्रिया के लिए [Updating](/install/updating) देखें।
