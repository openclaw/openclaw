...
आउटपुट में `OPENCLAW_STATE_DIR` / प्रोफ़ाइल के उल्लेख देखें। यदि आप कई Gateway चलाते हैं, तो प्रत्येक प्रोफ़ाइल के लिए दोहराएँ।
...
यदि आपके पास कई प्रोफ़ाइल/स्टेट डायरेक्टरी हैं (उदा. `~/.openclaw-main`, `~/.openclaw-work`), तो प्रत्येक को आर्काइव करें।
...
- छिपी हुई डायरेक्टरी शामिल थीं (उदा. `.openclaw/`)
...
Doctor एक “सुरक्षित और साधारण” कमांड है। यह सेवाओं की मरम्मत करता है, विन्यास माइग्रेशन लागू करता है, और असंगतियों के बारे में चेतावनी देता है।
...
`openclaw.json` पर्याप्त नहीं है। कई प्रदाता स्टेट यहाँ संग्रहीत करते हैं:
...
`$OPENCLAW_STATE_DIR` में सीक्रेट्स (एपीआई कुंजियाँ, OAuth टोकन, WhatsApp क्रेडेंशियल्स) होते हैं। बैकअप को प्रोडक्शन सीक्रेट्स की तरह संभालें:
...
- आपके चैनल अभी भी कनेक्टेड हैं (उदा. WhatsApp को दोबारा पेयर करने की आवश्यकता नहीं)
