...
| [`install-cli.sh`](#install-clish) | macOS / Linux / WSL  | Node + OpenClaw को एक स्थानीय प्रीफ़िक्स (`~/.openclaw`) में इंस्टॉल करता है। रूट आवश्यक नहीं।                                 |
...
<Steps>
  <Step title="OS का पता लगाएँ">
    macOS और Linux (WSL सहित) समर्थित हैं। यदि macOS का पता चलता है, तो अनुपस्थित होने पर Homebrew इंस्टॉल किया जाता है।
  </Step>
  <Step title="Node.js 22+ सुनिश्चित करें">
  ...
  <Step title="पोस्ट-इंस्टॉल कार्य">
...
<AccordionGroup>
  <Accordion title="फ़्लैग्स संदर्भ">

| Flag                            | विवरण                                                                  |
| ------------------------------- | ---------------------------------------------------------------------- |
| `--install-method npm\|git`     | इंस्टॉल विधि चुनें (डिफ़ॉल्ट: `npm`)। उपनाम: `--method`                |
| `--npm`                         | npm विधि के लिए शॉर्टकट                                                |
| `--git`                         | git विधि के लिए शॉर्टकट। उपनाम: `--github`                             |
...
| `--git-dir <path>`              | चेकआउट निर्देशिका (डिफ़ॉल्ट: `~/openclaw`)। उपनाम: `--dir`             |
...
| `--help`                        | उपयोग दिखाएँ (`-h`)                                                    |
  ...
  <Accordion title="पर्यावरण चर संदर्भ">
...
<Tabs>
  ...
  <Tab title="कस्टम git निर्देशिका">
    ```powershell
...
<Tabs>
  <Tab title="install.sh (नॉन-इंटरैक्टिव npm)">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://openclaw.ai/install.sh | bash -s -- --no-prompt --no-onboard
    ```
  </Tab>
  <Tab title="install.sh (नॉन-इंटरैक्टिव git)">
    ```bash
...
<AccordionGroup>
  <Accordion title="Git क्यों आवश्यक है?">
    `git` इंस्टॉल विधि के लिए Git आवश्यक है। `npm` इंस्टॉल्स के लिए भी, Git की जाँच/इंस्टॉल किया जाता है ताकि जब डिपेंडेंसीज़ git URLs का उपयोग करें तो `spawn git ENOENT` विफलताओं से बचा जा सके।
  </Accordion>

  <Accordion title="Linux पर npm EACCES क्यों देता है?">
    कुछ Linux सेटअप npm वैश्विक प्रीफ़िक्स को रूट-स्वामित्व वाले पाथ्स पर इंगित करते हैं। `install.sh` प्रीफ़िक्स को `~/.npm-global` पर स्विच कर सकता है और शेल rc फ़ाइलों में PATH एक्सपोर्ट्स जोड़ सकता है (जब वे फ़ाइलें मौजूद हों)।
  </Accordion>

  <Accordion title="sharp/libvips समस्याएँ">
    स्क्रिप्ट्स डिफ़ॉल्ट रूप से `SHARP_IGNORE_GLOBAL_LIBVIPS=1` सेट करती हैं ताकि sharp सिस्टम libvips के विरुद्ध बिल्ड न करे। ओवरराइड करने के लिए:
  ...
  <Accordion title="इंस्टॉल के बाद openclaw नहीं मिला">
    आमतौर पर PATH की समस्या होती है। [Node.js समस्या-निवारण](/install/node#troubleshooting) देखें।
  </Accordion>
</AccordionGroup>
