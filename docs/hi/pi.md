...
OpenClaw, pi SDK का उपयोग करके अपने मैसेजिंग Gateway वास्तुकला में एक एआई कोडिंग एजेंट एम्बेड करता है। pi को subprocess के रूप में चलाने या RPC मोड का उपयोग करने के बजाय, OpenClaw सीधे `createAgentSession()` के माध्यम से pi का `AgentSession` इम्पोर्ट और इंस्टैंशिएट करता है। यह एम्बेडेड दृष्टिकोण निम्नलिखित प्रदान करता है:
...
pi-agent-core का `AgentTool`, pi-coding-agent के `ToolDefinition` की तुलना में अलग `execute` सिग्नेचर रखता है। `pi-tool-definition-adapter.ts` में मौजूद एडेप्टर इसे ब्रिज करता है:
...
सिस्टम प्रॉम्प्ट `buildAgentSystemPrompt()` (`system-prompt.ts`) में बनाया जाता है। यह Tooling, Tool Call Style, Safety guardrails, OpenClaw CLI संदर्भ, Skills, Docs, Workspace, Sandbox, Messaging, Reply Tags, Voice, Silent Replies, Heartbeats, Runtime मेटाडेटा जैसे अनुभागों के साथ एक पूर्ण प्रॉम्प्ट तैयार करता है; साथ ही सक्षम होने पर Memory और Reactions, तथा वैकल्पिक संदर्भ फ़ाइलें और अतिरिक्त सिस्टम प्रॉम्प्ट सामग्री शामिल करता है। उप-एजेंट्स द्वारा उपयोग किए जाने वाले न्यूनतम प्रॉम्प्ट मोड के लिए अनुभागों को ट्रिम किया जाता है।
...
सत्र JSONL फ़ाइलें होती हैं जिनमें ट्री संरचना (id/parentId लिंकिंग) होती है। स्थायित्व को pi का `SessionManager` संभालता है:
...
संदर्भ ओवरफ़्लो पर ऑटो-कम्पैक्शन ट्रिगर होता है। मैनुअल कम्पैक्शन को `compactEmbeddedPiSessionDirect()` संभालता है:
