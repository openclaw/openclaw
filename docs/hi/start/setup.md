...
<Note>
यदि आप पहली बार सेटअप कर रहे हैं, तो [Getting Started](/start/getting-started) से शुरू करें।
विज़ार्ड के विवरण के लिए [Onboarding Wizard](/start/wizard) देखें।
</Note>
...
Linux इंस्टॉलेशन systemd **user** service का उपयोग करते हैं। डिफ़ॉल्ट रूप से, systemd logout/idle पर user
services को रोक देता है, जिससे Gateway बंद हो जाता है। onboarding आपके लिए lingering सक्षम करने का प्रयास करता है
(शायद sudo के लिए पूछे)। यदि यह अभी भी बंद है, तो चलाएँ:

```bash
sudo loginctl enable-linger $USER
```

हमेशा-चालू या multi-user सर्वरों के लिए, user service के बजाय **system** service पर विचार करें
(user service में lingering की आवश्यकता नहीं)। systemd नोट्स के लिए [Gateway runbook](/gateway) देखें।
