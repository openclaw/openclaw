...
OpenClaw आउटबाउंड Markdown को पहले एक साझा मध्यवर्ती
प्रतिनिधित्व (IR) में बदलकर फ़ॉर्मैट करता है, उसके बाद चैनल-विशिष्ट आउटपुट रेंडर करता है। IR स्रोत पाठ को यथावत रखता है और साथ में स्टाइल/लिंक स्पैन ले जाता है, ताकि चंकिंग और रेंडरिंग चैनलों के बीच सुसंगत रह सकें।
...
Markdown तालिकाएँ चैट क्लाइंट्स में समान रूप से समर्थित नहीं हैं। प्रति चैनल (और प्रति खाते) रूपांतरण नियंत्रित करने के लिए
...
- **Slack:** `[label](url)` -> `<url|label>`; साधारण URL वैसे ही रहते हैं। डबल-लिंकिंग से बचने के लिए पार्स के दौरान ऑटो-लिंक अक्षम रहता है।
- **Telegram:** `[label](url)` -> `<a href="url">label</a>` (HTML पार्स मोड)।
- **Signal:** `[label](url)` -> `label (url)` जब तक लेबल URL से मेल न खाए।

## स्पॉइलर

स्पॉइलर मार्कर (`||spoiler||`) केवल Signal के लिए पार्स किए जाते हैं, जहाँ वे
SPOILER स्टाइल रेंज में मैप होते हैं। अन्य चैनल उन्हें सादा पाठ के रूप में मानते हैं।
