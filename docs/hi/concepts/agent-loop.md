...
एक एजेंटिक लूप किसी एजेंट का पूर्ण “वास्तविक” रन होता है: इनटेक → संदर्भ संयोजन → मॉडल अनुमान →
टूल निष्पादन → स्ट्रीमिंग प्रतिक्रियाएँ → स्थायित्व। यह वह प्रामाणिक पथ है जो किसी संदेश को
कार्रवाइयों और अंतिम उत्तर में बदलता है, साथ ही सत्र की स्थिति को सुसंगत रखता है।

OpenClaw में, एक लूप प्रति सत्र एकल, क्रमबद्ध रन होता है जो मॉडल के सोचने, टूल कॉल करने, और आउटपुट
स्ट्रीम करने के दौरान जीवनचक्र और स्ट्रीम घटनाएँ उत्सर्जित करता है। यह दस्तावेज़ बताता है कि वह
प्रामाणिक लूप आरंभ से अंत तक कैसे जुड़ा होता है।
...
- मैसेजिंग चैनल कतार मोड (collect/steer/followup) चुन सकते हैं जो इस लेन सिस्टम में फ़ीड करते हैं।
  देखें [Command Queue](/concepts/queue)।
...
- **`agent:bootstrap`**: सिस्टम प्रॉम्प्ट अंतिम होने से पहले bootstrap फ़ाइलें बनाते समय चलता है।
  इसका उपयोग bootstrap संदर्भ फ़ाइलें जोड़ने/हटाने के लिए करें।
...
- `agent.wait` डिफ़ॉल्ट: 30s (केवल प्रतीक्षा)। `timeoutMs` पैरामीटर ओवरराइड करता है।
