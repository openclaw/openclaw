...
TypeBox एक TypeScript‑first स्कीमा लाइब्रेरी है। हम इसका उपयोग **Gateway
WebSocket प्रोटोकॉल** (हैंडशेक, अनुरोध/प्रतिक्रिया, सर्वर इवेंट्स) को परिभाषित करने के लिए करते हैं।
ये स्कीमा **रनटाइम वैलिडेशन**, **JSON Schema निर्यात**, और macOS ऐप के लिए
**Swift कोडजन** को संचालित करते हैं। एक ही सत्य स्रोत; बाकी सब कुछ उससे जनरेट होता है।
...
पहला फ्रेम **अनिवार्य रूप से** `connect` अनुरोध होना चाहिए। उसके बाद,
क्लाइंट मेथड कॉल कर सकते हैं (जैसे `health`, `send`, `chat.send`)
और इवेंट्स को सब्सक्राइब कर सकते हैं (जैसे `presence`, `tick`, `agent`)।
...
- **Server side**: हर इनबाउंड फ्रेम को AJV से वैलिडेट किया जाता है। हैंडशेक केवल
  उसी `connect` अनुरोध को स्वीकार करता है जिसके params `ConnectParams` से मेल खाते हों।
...
जनरेट किया गया JSON Schema रिपॉज़िटरी में `dist/protocol.schema.json` पर है।
प्रकाशित raw फ़ाइल सामान्यतः यहाँ उपलब्ध होती है:
