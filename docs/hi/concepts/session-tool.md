...
`global` और `unknown` आरक्षित मान हैं और कभी सूचीबद्ध नहीं होते। यदि `session.scope = "global"`, तो हम सभी टूल्स के लिए इसे `main` का उपनाम बनाते हैं ताकि कॉलर्स कभी `global` न देखें।
...
- यदि प्रतीक्षा समय समाप्त हो जाए: `{ runId, status: "timeout", error }`। रन जारी रहता है; बाद में `sessions_history` कॉल करें।
...
- `agents.list[].subagents.allowAgents`: `agentId` के माध्यम से अनुमत एजेंट ids की सूची (`["*"]` किसी को भी अनुमति देने के लिए)। डिफ़ॉल्ट: केवल अनुरोधकर्ता एजेंट।
