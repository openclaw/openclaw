...
- **ब्लॉक स्ट्रीमिंग (चैनल):** सहायक लिखते समय पूर्ण **ब्लॉक्स** उत्सर्जित करता है। ये सामान्य चैनल संदेश होते हैं (टोकन डेल्टा नहीं)।
...
आज बाहरी चैनल संदेशों तक **वास्तविक टोकन स्ट्रीमिंग नहीं** है। Telegram ड्राफ्ट स्ट्रीमिंग ही एकमात्र आंशिक-स्ट्रीम सतह है।
...
- `agents.defaults.blockStreamingCoalesce`: `{ minChars?, maxChars?, idleMs? }` (भेजने से पहले स्ट्रीम किए गए ब्लॉक्स को मर्ज करें)।
...
जब ब्लॉक स्ट्रीमिंग सक्षम होती है, OpenClaw भेजने से पहले **लगातार ब्लॉक चंक्स को मर्ज** कर सकता है। इससे “सिंगल-लाइन स्पैम” कम होता है, जबकि प्रगतिशील आउटपुट बना रहता है।
...
जब ब्लॉक स्ट्रीमिंग सक्षम होती है, आप ब्लॉक उत्तरों के बीच **यादृच्छिक विराम** जोड़ सकते हैं (पहले ब्लॉक के बाद)। इससे मल्टी-बबल प्रतिक्रियाएँ अधिक स्वाभाविक लगती हैं।
...
- **चंक्स स्ट्रीम करें:** `blockStreamingDefault: "on"` + `blockStreamingBreak: "text_end"` (चलते-चलते उत्सर्जित करें)। नॉन-Telegram चैनलों को `*.blockStreaming: true` भी चाहिए।
...
**चैनल नोट:** नॉन-Telegram चैनलों के लिए, ब्लॉक स्ट्रीमिंग **डिफ़ॉल्ट रूप से बंद** है जब तक
`*.blockStreaming` को स्पष्ट रूप से `true` पर सेट न किया जाए। Telegram ड्राफ्ट्स स्ट्रीम कर सकता है
(`channels.telegram.streamMode`) बिना ब्लॉक उत्तरों के।
