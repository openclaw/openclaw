...
यह कमांड IDEs के लिए stdio पर ACP बोलता है और प्रॉम्प्ट्स को WebSocket के माध्यम से Gateway तक अग्रेषित करता है। यह ACP सत्रों को Gateway सत्र कुंजियों से मैप करके रखता है।
...
यह ACP ब्रिज को स्पॉन करता है और आपको इंटरैक्टिव रूप से प्रॉम्प्ट टाइप करने देता है।
...
प्रत्येक ACP सत्र एक एकल Gateway सत्र कुंजी से मैप होता है। एक एजेंट के कई सत्र हो सकते हैं; जब तक आप कुंजी या लेबल को ओवरराइड नहीं करते, ACP डिफ़ॉल्ट रूप से एक अलग-थलग `acp:<uuid>` सत्र का उपयोग करता है।
...
डिफ़ॉल्ट रूप से, ACP सत्रों को `acp:` प्रीफ़िक्स के साथ एक अलग-थलग Gateway सत्र कुंजी मिलती है।
किसी ज्ञात सत्र का पुनः उपयोग करने के लिए, सत्र कुंजी या लेबल पास करें:
