...
**स्थानीय होस्ट**, **Gateway होस्ट**, या किसी **नोड होस्ट** के लिए exec अनुमोदनों का प्रबंधन करें।
डिफ़ॉल्ट रूप से, कमांड डिस्क पर स्थानीय अनुमोदन फ़ाइल को लक्षित करते हैं। Gateway को लक्षित करने के लिए `--gateway` का उपयोग करें, या किसी विशिष्ट नोड को लक्षित करने के लिए `--node` का उपयोग करें।
