...
<AccordionGroup>
  ...
  <Accordion title="डैशबोर्ड या Control UI कनेक्ट नहीं हो रहा">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Gateway शुरू नहीं होता या सेवा इंस्टॉल है लेकिन चल नहीं रही">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Cron या heartbeat नहीं चला या डिलीवर नहीं हुआ">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Node paired है लेकिन टूल camera/canvas/screen exec में विफल">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Browser टूल विफल होता है">
    ```bash
    openclaw status
    openclaw gateway status
