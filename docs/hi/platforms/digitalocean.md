...
Gateway डिफ़ॉल्ट रूप से loopback से बाइंड होता है। Control UI तक पहुँचने के लिए:
...
$6 का droplet केवल 1GB RAM के साथ आता है। सब कुछ सुचारू रखने के लिए:
...
ये रीबूट के बाद भी बनी रहती हैं। इन्हें समय-समय पर बैकअप करें:
...
पूरे सेटअप गाइड के लिए [Oracle Cloud](/platforms/oracle) देखें। साइनअप टिप्स और नामांकन प्रक्रिया की समस्या-निवारण के लिए यह [समुदाय गाइड](https://gist.github.com/rssnyder/51e3cfedd730e7dd5f4a816143b25dbd) देखें।
