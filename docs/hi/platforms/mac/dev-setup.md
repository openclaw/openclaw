...
> **टिप्पणी**: Ad-hoc साइन किए गए ऐप्स सुरक्षा संकेत दिखा सकते हैं। यदि ऐप तुरंत "Abort trap 6" के साथ क्रैश हो जाता है, तो [समस्या-निवारण](#troubleshooting) अनुभाग देखें।
...
### Gateway "Starting..." पर अनिश्चितकाल तक अटका रहता है

यदि Gateway की स्थिति "Starting..." पर बनी रहती है, तो जाँचें कि कोई ज़ॉम्बी प्रक्रिया पोर्ट को होल्ड तो नहीं कर रही है:
...
यदि कोई मैन्युअल रन पोर्ट को होल्ड कर रहा है, तो उस प्रक्रिया को रोकें (Ctrl+C)। अंतिम उपाय के रूप में, ऊपर मिले PID को समाप्त करें।
