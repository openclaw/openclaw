...
Windows पर OpenClaw को **WSL2 के माध्यम से** उपयोग करने की अनुशंसा की जाती है (Ubuntu अनुशंसित)।  
CLI + Gateway Linux के भीतर चलते हैं, जिससे रनटाइम सुसंगत रहता है और टूलिंग कहीं अधिक संगत बनती है (Node/Bun/pnpm, Linux binaries, Skills)।  
नेटिव Windows अधिक जटिल हो सकता है। WSL2 आपको पूर्ण Linux अनुभव देता है — इंस्टॉल करने के लिए एक ही कमांड: `wsl --install`।
...
WSL का अपना वर्चुअल नेटवर्क होता है। यदि किसी अन्य मशीन को **WSL के भीतर** चल रही सेवा (SSH, एक लोकल TTS सर्वर, या Gateway) तक पहुँचना हो, तो आपको Windows पोर्ट को वर्तमान WSL IP पर फ़ॉरवर्ड करना होगा। WSL IP रीस्टार्ट के बाद बदल जाता है, इसलिए आपको फ़ॉरवर्डिंग नियम को रिफ़्रेश करना पड़ सकता है।
...
हमारे पास अभी Windows के लिए कोई सहचर ऐप नहीं है। यदि आप इसे संभव बनाने में योगदान देना चाहते हैं, तो योगदान का स्वागत है।
