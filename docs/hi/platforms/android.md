...
सिस्टम नियंत्रण (launchd/systemd) Gateway होस्ट पर रहता है। देखें [Gateway](/gateway)।
...
Android NSD/mDNS डिस्कवरी नेटवर्क्स के पार काम नहीं करती। यदि आपका Android नोड और Gateway अलग-अलग नेटवर्क पर हैं लेकिन Tailscale के माध्यम से जुड़े हैं, तो Wide-Area Bonjour / unicast DNS-SD का उपयोग करें:
...
यह सर्वर HTML में एक live-reload क्लाइंट इंजेक्ट करता है और फ़ाइल परिवर्तनों पर रीलोड करता है।
A2UI होस्ट `http://<gateway-host>:18793/__openclaw__/a2ui/` पर रहता है।
