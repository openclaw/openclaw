...
**सुझाव:** यदि इंस्टेंस निर्माण “Out of capacity” के साथ विफल हो जाए, तो किसी अन्य availability domain को आज़माएँ या बाद में पुनः प्रयास करें। फ्री टियर की क्षमता सीमित होती है।
...
डिफ़ॉल्ट के रूप में टोकन प्रमाणीकरण का उपयोग करें। यह पूर्वानुमेय है और किसी भी “insecure auth” Control UI फ़्लैग की आवश्यकता से बचाता है।
...
अब जब सब कुछ काम कर रहा है, तो VCN को लॉक डाउन करें ताकि Tailscale के अलावा सभी ट्रैफ़िक ब्लॉक हो जाए। OCI का Virtual Cloud Network नेटवर्क एज पर फ़ायरवॉल की तरह काम करता है — ट्रैफ़िक आपके इंस्टेंस तक पहुँचने से पहले ही ब्लॉक हो जाता है।
...
SSH टनल की आवश्यकता नहीं। Tailscale प्रदान करता है:
...
फ्री टियर ARM इंस्टेंस लोकप्रिय हैं। प्रयास करें:
...
कुछ टूल्स के ARM बिल्ड उपलब्ध नहीं हो सकते। जाँचें:

```bash
uname -m  # Should show aarch64
```

अधिकांश npm पैकेज ठीक काम करते हैं। बाइनरी के लिए, `linux-arm64` या `aarch64` रिलीज़ देखें।
