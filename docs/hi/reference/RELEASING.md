...
रेपो रूट से `pnpm` (Node 22+) का उपयोग करें। टैगिंग/पब्लिशिंग से पहले वर्किंग ट्री को साफ़ रखें।
...
- **npm pack/publish अटक जाता है या बहुत बड़ा टारबॉल बनता है**: `dist/OpenClaw.app` में macOS ऐप बंडल (और रिलीज़ ज़िप्स) पैकेज में शामिल हो जाते हैं। समाधान: `package.json` `files` के माध्यम से publish सामग्री को व्हाइटलिस्ट करें (dist सबडायरेक्टरीज़, docs, skills शामिल करें; ऐप बंडल्स को बाहर रखें)। `npm pack --dry-run` से पुष्टि करें कि `dist/OpenClaw.app` सूचीबद्ध नहीं है।
...
हम केवल `@openclaw/*` स्कोप के अंतर्गत **मौजूदा npm प्लगइन्स** प्रकाशित करते हैं। जो बंडल्ड
प्लगइन्स npm पर नहीं हैं, वे **केवल डिस्क-ट्री** रहते हैं (फिर भी
`extensions/**` में शिप किए जाते हैं)।
