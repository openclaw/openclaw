...
- **साइलेंट हाउसकीपिंग** (उदा. ऐसे मेमोरी राइट्स जो उपयोगकर्ता-प्रदर्शित आउटपुट उत्पन्न नहीं करने चाहिए)
...
- **निष्क्रियता समाप्ति** (`session.reset.idleMinutes` या लेगेसी `session.idleMinutes`) तब एक नया `sessionId` बनाती है जब निष्क्रिय विंडो के बाद संदेश आता है। जब दैनिक + निष्क्रिय दोनों कॉन्फ़िगर हों, तो जो पहले समाप्त होता है वही प्रभावी होता है।
...
संपीड़न **स्थायी** है (सत्र प्रूनिंग के विपरीत)। देखें [/concepts/session-pruning](/concepts/session-pruning)।
...
लक्ष्य: स्वचालित-संपीड़न होने से पहले, एक साइलेंट एजेंटिक टर्न चलाना जो टिकाऊ
स्थिति को डिस्क पर लिख दे (उदा. एजेंट वर्कस्पेस में `memory/YYYY-MM-DD.md`), ताकि संपीड़न
महत्वपूर्ण कॉन्टेक्स्ट को मिटा न सके।
...
- वर्कस्पेस फ़ाइल लेआउट और राइट पैटर्न के लिए [Memory](/concepts/memory) देखें।
...
- सत्र कुंजी गलत? [/concepts/session](/concepts/session) से शुरू करें और `/status` में `sessionKey` की पुष्टि करें।
- स्टोर बनाम ट्रांसक्रिप्ट मिसमैच? Gateway होस्ट और `openclaw status` से स्टोर पथ की पुष्टि करें।
- संपीड़न स्पैम? जाँचें:
...
- साइलेंट टर्न लीक हो रहे हैं? पुष्टि करें कि उत्तर `NO_REPLY` (सटीक टोकन) से शुरू होता है और आप उस बिल्ड पर हैं जिसमें स्ट्रीमिंग सप्रेशन फ़िक्स शामिल है।
