...
read_when:
  ...
  - निर्णय लेते समय: स्टैंडअलोन CLI बनाम गहरी OpenClaw एकीकरण
...
- समय‑सीमा वाले प्रश्न (“नवंबर 2025 में क्या सही था?”) और संघर्ष समाधान
...
- **Daily log वही daily log रहता है**। इसे JSON में बदलने की आवश्यकता नहीं।
...
- **opinion**: “Peter क्या पसंद करता है?” (कॉन्फ़िडेंस + साक्ष्य के साथ)
