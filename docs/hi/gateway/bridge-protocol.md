...
ब्रिज प्रोटोकॉल एक **लीगेसी** नोड ट्रांसपोर्ट (TCP JSONL) है। नए नोड क्लाइंट्स को
इसके बजाय एकीकृत Gateway वेब-सॉकेट प्रोटोकॉल का उपयोग करना चाहिए।

यदि आप कोई ऑपरेटर या नोड क्लाइंट बना रहे हैं, तो
[Gateway प्रोटोकॉल](/gateway/protocol) का उपयोग करें।

**टिप्पणी:** वर्तमान OpenClaw बिल्ड्स में अब TCP ब्रिज लिस्नर शामिल नहीं है; यह दस्तावेज़ ऐतिहासिक संदर्भ के लिए रखा गया है।
लीगेसी `bridge.*` विन्यास कुंजियाँ अब विन्यास स्कीमा का हिस्सा नहीं हैं।
...
नोड्स सिस्टम.run गतिविधि को सतह पर लाने के लिए `exec.finished` या `exec.denied` इवेंट्स उत्सर्जित कर सकते हैं।
इन्हें Gateway में सिस्टम इवेंट्स से मैप किया जाता है। (लीगेसी नोड्स अभी भी `exec.started` उत्सर्जित कर सकते हैं।)
...
ब्रिज वर्तमान में **अप्रत्यक्ष v1** है (कोई न्यूनतम/अधिकतम नेगोशिएशन नहीं)। बैकवर्ड‑कम्पैट की अपेक्षा है; किसी भी ब्रेकिंग परिवर्तन से पहले ब्रिज प्रोटोकॉल संस्करण फ़ील्ड जोड़ें।
