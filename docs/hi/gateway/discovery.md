...
- **Gateway**: एक एकल, दीर्घकालिक Gateway प्रक्रिया जो स्टेट (सत्र, पेयरिंग, नोड रजिस्ट्री) की मालिक होती है और चैनल्स चलाती है। अधिकांश सेटअप प्रति होस्ट एक का उपयोग करते हैं; अलग-थलग मल्टी-गेटवे सेटअप संभव हैं।
...
Bonjour बेस्ट-एफ़र्ट है और नेटवर्क्स के पार नहीं जाता। इसका उपयोग केवल “समान LAN” सुविधा के लिए किया जाता है।
...
London/Vienna शैली के सेटअप के लिए Bonjour मदद नहीं करेगा। अनुशंसित “direct” लक्ष्य है:
