...
OpenClaw मॉडल प्रदाताओं के लिए OAuth और API कुंजियों का समर्थन करता है। Anthropic
खातों के लिए, हम **API कुंजी** का उपयोग करने की अनुशंसा करते हैं। Claude सदस्यता
एक्सेस के लिए, `claude setup-token` द्वारा बनाया गया दीर्घ‑कालिक टोकन उपयोग करें।
...
Anthropic के लिए, अनुशंसित मार्ग **API कुंजी** है। यदि आप Claude सदस्यता का उपयोग कर रहे हैं,
तो सेटअप-टोकन फ़्लो भी समर्थित है। इसे **Gateway होस्ट** पर चलाएँ:
...
कौन‑सा प्रोफ़ाइल समाप्त हो रहा है, यह पुष्टि करने के लिए `openclaw models status` चलाएँ। यदि प्रोफ़ाइल
अनुपस्थित है, तो `claude setup-token` पुनः चलाएँ और टोकन फिर से पेस्ट करें।
