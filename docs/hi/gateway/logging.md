...
Control UI का Logs टैब Gateway के माध्यम से इस फ़ाइल को टेल करता है (`logs.tail`)।
...
Verbose टूल सारांश (उदा. `🛠️ Exec: ...`) कंसोल स्ट्रीम तक पहुँचने से पहले संवेदनशील टोकन को मास्क कर सकते हैं। यह **केवल टूल्स** के लिए है और फ़ाइल लॉग को नहीं बदलता।
...
कंसोल फ़ॉर्मैटर **TTY-अवेयर** है और सुसंगत, प्रीफ़िक्स्ड लाइन्स प्रिंट करता है।
सब-सिस्टम लॉगर्स आउटपुट को समूहित और स्कैन करने योग्य रखते हैं।

व्यवहार:

- **सब-सिस्टम प्रीफ़िक्स** हर पंक्ति पर (उदा. `[gateway]`, `[canvas]`, `[tailscale]`)
...
- **संक्षिप्त सब-सिस्टम प्रीफ़िक्स**: अग्रणी `gateway/` + `channels/` हटाता है, अंतिम 2 सेगमेंट रखता है (उदा. `whatsapp/outbound`)
...
- **कंसोल शैलियाँ** (उदा. `pretty | compact | json`)
