...
**Gateway होस्ट** को “जहाँ एजेंट रहता है” के रूप में सोचें। वही सत्र, प्रमाणीकरण प्रोफ़ाइल, चैनल और स्थिति का स्वामी होता है।
आपका लैपटॉप/डेस्कटॉप (और नोड्स) उसी होस्ट से कनेक्ट होते हैं।
...
लैपटॉप एजेंट **नहीं** चलाता। वह दूरस्थ रूप से कनेक्ट करता है:
...
एक gateway सेवा स्थिति + चैनलों की मालिक होती है। नोड्स परिधीय होते हैं।
...
टिप्पणी: `18789` को अपने कॉन्फ़िगर किए गए `gateway.port` (या `--port`/`OPENCLAW_GATEWAY_PORT`) से बदलें।
टिप्पणी: जब आप `--url` पास करते हैं, तो CLI कॉन्फ़िग या पर्यावरण क्रेडेंशियल्स पर फ़ॉलबैक नहीं करता।
`--token` या `--password` को स्पष्ट रूप से शामिल करें। स्पष्ट क्रेडेंशियल्स का अभाव एक त्रुटि है।
...
- **Tailscale Serve** पहचान हेडर्स के माध्यम से प्रमाणीकरण कर सकता है जब `gateway.auth.allowTailscale: true`।
  यदि आप इसके बजाय टोकन/पासवर्ड चाहते हैं तो इसे `false` पर सेट करें।
