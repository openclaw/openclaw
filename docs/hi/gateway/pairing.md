...
Gateway-स्वामित्व वाले पेयरिंग में, **Gateway** यह तय करने के लिए सत्य का स्रोत होता है कि किन नोड्स को जुड़ने की अनुमति है।
UI (macOS ऐप, भविष्य के क्लाइंट) केवल फ्रंटएंड होते हैं जो लंबित अनुरोधों को स्वीकृत या अस्वीकृत करते हैं।

**महत्वपूर्ण:** WS नोड्स `connect` के दौरान **डिवाइस पेयरिंग** (भूमिका `node`) का उपयोग करते हैं।
`node.pair.*` एक अलग पेयरिंग स्टोर है और WS हैंडशेक को **नियंत्रित नहीं** करता।
केवल वे क्लाइंट जो स्पष्ट रूप से `node.pair.*` को कॉल करते हैं, इस फ्लो का उपयोग करते हैं।
...
- **परिवहन**: Gateway WS एंडपॉइंट अनुरोधों को अग्रेषित करता है, लेकिन सदस्यता का निर्णय नहीं करता।
  (विरासत TCP ब्रिज समर्थन अप्रचलित/हटा दिया गया है।)
