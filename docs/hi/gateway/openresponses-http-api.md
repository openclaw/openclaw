...
यह एंडपॉइंट **डिफ़ॉल्ट रूप से निष्क्रिय** होता है। पहले इसे विन्यास में सक्षम करें।
...
Gateway के प्रमाणीकरण विन्यास का उपयोग करता है। एक बेयरर टोकन भेजें:
...
अनुरोध आइटम-आधारित इनपुट के साथ OpenResponses API का पालन करता है। वर्तमान समर्थन:
...
यदि एजेंट किसी टूल को कॉल करने का निर्णय लेता है, तो प्रतिक्रिया एक `function_call` आउटपुट आइटम लौटाती है।
इसके बाद टर्न जारी रखने के लिए `function_call_output` के साथ एक फ़ॉलो-अप अनुरोध भेजें।
...
- PDF को टेक्स्ट के लिए पार्स किया जाता है। यदि कम टेक्स्ट मिलता है, तो शुरुआती पृष्ठों को रैस्टराइज़ करके
  छवियों के रूप में मॉडल को भेजा जाता है।

PDF पार्सिंग Node-फ्रेंडली `pdfjs-dist` लेगेसी बिल्ड का उपयोग करती है (बिना वर्कर)। आधुनिक
PDF.js बिल्ड ब्राउज़र वर्कर्स/DOM ग्लोबल्स की अपेक्षा करता है, इसलिए Gateway में उपयोग नहीं किया जाता।
