...
- प्रदाता नोट्स:
  - Z.AI (`zai/*`) केवल बाइनरी थिंकिंग (`on`/`off`) का समर्थन करता है। कोई भी गैर-`off` स्तर `on` के रूप में माना जाता है (जिसे `low` पर मैप किया जाता है)।
...
- पुष्टि उत्तर भेजा जाता है (`Thinking level set to high.` / `Thinking disabled.`)। यदि स्तर अमान्य है (जैसे `/thinking big`), तो संकेत के साथ कमांड अस्वीकार कर दी जाती है और सत्र की स्थिति अपरिवर्तित रहती है।
...
- जब verbose चालू होता है, संरचित टूल परिणाम (Pi, अन्य JSON एजेंट) भेजने वाले एजेंट प्रत्येक टूल कॉल को उसकी अपनी केवल-मेटाडेटा संदेश के रूप में भेजते हैं, उपलब्ध होने पर `<emoji> <tool-name>: <arg>` (पथ/कमांड) के साथ प्रीफ़िक्स किया जाता है। ये टूल सारांश प्रत्येक टूल के शुरू होते ही भेजे जाते हैं (अलग-अलग बबल), स्ट्रीमिंग डेल्टा के रूप में नहीं।
- जब verbose `full` होता है, तो टूल आउटपुट पूर्ण होने के बाद भी फ़ॉरवर्ड किए जाते हैं (अलग बबल, सुरक्षित लंबाई तक ट्रंकेटेड)। यदि रन के दौरान आप `/verbose on|full|off` टॉगल करते हैं, तो बाद के टूल बबल नई सेटिंग का पालन करेंगे।
...
- हार्टबीट प्रोब बॉडी कॉन्फ़िगर किया गया हार्टबीट प्रॉम्प्ट होता है (डिफ़ॉल्ट: `Read HEARTBEAT.md if it exists (workspace context). Follow it strictly. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK.`)। हार्टबीट संदेश में इनलाइन निर्देश सामान्य रूप से लागू होते हैं (लेकिन हार्टबीट से सत्र डिफ़ॉल्ट बदलने से बचें)।
- हार्टबीट डिलीवरी डिफ़ॉल्ट रूप से केवल अंतिम पेलोड भेजती है। अलग `Reasoning:` संदेश (उपलब्ध होने पर) भी भेजने के लिए `agents.defaults.heartbeat.includeReasoning: true` या प्रति-एजेंट `agents.list[].heartbeat.includeReasoning: true` सेट करें।
