...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:49:45Z
---
...
Ubuntu (और कई Linux डिस्ट्रीब्यूशनों) पर, Chromium की डिफ़ॉल्ट स्थापना एक **snap पैकेज** होती है। Snap का AppArmor confinement इस बात में हस्तक्षेप करता है कि OpenClaw ब्राउज़र प्रक्रिया को कैसे स्पॉन और मॉनिटर करता है।
...
आप `chrome` प्रोफ़ाइल (extension relay) का उपयोग कर रहे हैं। यह अपेक्षा करता है कि OpenClaw
ब्राउज़र एक्सटेंशन किसी लाइव टैब से अटैच हो।
