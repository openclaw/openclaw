...
- `allowBundled`: केवल **bundled** skills के लिए वैकल्पिक allowlist। जब सेट किया जाता है, तो सूची में मौजूद bundled skills ही पात्र होते हैं (managed/workspace skills अप्रभावित रहते हैं)।
...
- `install.nodeManager`: node installer वरीयता (`npm` | `pnpm` | `yarn` | `bun`, डिफ़ॉल्ट: npm)।
  यह केवल **skill installs** को प्रभावित करता है; Gateway runtime अभी भी Node होना चाहिए
  (WhatsApp/Telegram के लिए Bun अनुशंसित नहीं है)।
- `entries.<skillKey>`: प्रति-skill overrides।
...
- `entries` के अंतर्गत कुंजियाँ डिफ़ॉल्ट रूप से skill नाम से मैप होती हैं। यदि कोई skill
  `metadata.openclaw.skillKey` परिभाषित करता है, तो उसके बजाय उसी कुंजी का उपयोग करें।
- watcher सक्षम होने पर skills में किए गए परिवर्तन अगले एजेंट टर्न पर लागू हो जाते हैं।

### Sandboxed skills + env vars

जब कोई सत्र **sandboxed** होता है, तो skill प्रक्रियाएँ Docker के अंदर चलती हैं। sandbox
होस्ट के `process.env` को **inherit नहीं** करता।
...
Global `env` और `skills.entries.<skill>.env/apiKey` केवल **host** रन पर लागू होते हैं।
