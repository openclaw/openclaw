...
क्रेडेंशियल्स एजेंटों के बीच साझा **नहीं** होते। एजेंटों के बीच कभी भी `agentDir` का पुनः उपयोग न करें।
यदि आप क्रेडेंशियल साझा करना चाहते हैं, तो `auth-profiles.json` को दूसरे एजेंट के `agentDir` में कॉपी करें।

रनटाइम पर sandboxing कैसे व्यवहार करता है, इसके लिए [Sandboxing](/gateway/sandboxing) देखें।
“यह क्यों ब्लॉक हुआ?” के डिबग के लिए [Sandbox vs Tool Policy vs Elevated](/gateway/sandbox-vs-tool-policy-vs-elevated) और `openclaw sandbox explain` देखें।
...
प्रत्येक स्तर टूल्स को और अधिक प्रतिबंधित कर सकता है, लेकिन पहले के स्तरों पर अस्वीकृत टूल्स को वापस अनुमति नहीं दे सकता।
यदि `agents.list[].tools.sandbox.tools` सेट है, तो वह उस एजेंट के लिए `tools.sandbox.tools` को प्रतिस्थापित करता है।
यदि `agents.list[].tools.profile` सेट है, तो वह उस एजेंट के लिए `tools.profile` को ओवरराइड करता है।
प्रदाता टूल कुंजियाँ `provider` (उदाहरण: `google-antigravity`) या `provider/model` (उदाहरण: `openai/gpt-5.2`) में से किसी एक को स्वीकार करती हैं।
...
`tools.elevated` वैश्विक आधाररेखा है (प्रेषक-आधारित allowlist)। `agents.list[].tools.elevated` विशिष्ट एजेंटों के लिए elevated को और सीमित कर सकता है (दोनों का अनुमति देना आवश्यक है)।
...
`agents.defaults.sandbox.mode: "non-main"` का आधार `session.mainKey` है (डिफ़ॉल्ट `"main"`),
न कि एजेंट id। समूह/चैनल सत्रों को हमेशा अपनी स्वयं की कुंजियाँ मिलती हैं, इसलिए
उन्हें non-main माना जाता है और वे sandbox में चलेंगे। यदि आप चाहते हैं कि कोई एजेंट कभी
sandbox में न चले, तो `agents.list[].sandbox.mode: "off"` सेट करें।
