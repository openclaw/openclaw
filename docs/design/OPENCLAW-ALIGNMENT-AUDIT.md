...
| Extension doctor-contract（ollama/vllm/plugin-sdk ssrf 等）                                                | ✅   | ollama/vllm `buildUnknownModelHint` 与 `createLegacyPrivateNetworkDoctorContract` 经 `formatCliCommand`  |
