...
SmartAgentNeo can use Perplexity Sonar for the `web_search` tool. You can connect
...
If no base URL is set, SmartAgentNeo chooses a default based on the API key source:
