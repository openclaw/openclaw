...
| Variable                                                                                                          | Purpose                                                                                                                                                                                                                                                                                                                                        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OTEL_EXPORTER_OTLP_ENDPOINT`                                                                                     | Override `diagnostics.otel.endpoint`. Shared endpoints are expanded per signal; if the value already ends in `/v1/traces`, `/v1/metrics`, or `/v1/logs`, that suffix is normalized to the enabled signal being exported.                                                                                                                       |
