    ...
    defaults: {
      compaction: {
        ...
        memoryFlush: {
          ...
          fallbacks: ["anthropic/claude-haiku-4-5"], // optional; unset keeps the exact override
