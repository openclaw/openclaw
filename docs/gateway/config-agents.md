...
- `idleTimeoutS` controls how long macOS Talk mode can sit with no user speech or assistant reply before it deactivates and returns to Voice Wake waiting. Leave unset to keep Talk active until manually stopped.
