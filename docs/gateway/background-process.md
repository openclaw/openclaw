...
- `timeout` (seconds, default 1800): kill the process after this timeout; use `0` to disable it for a single local/sandbox/gateway exec call; for `host=node`, use a large positive timeout
