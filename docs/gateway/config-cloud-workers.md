...
the required profile does not silently move them. Stop and recovery retain the
normal placement lifecycle; stopping a worker does not authorize local turns.
