...
- `talk.*` (Talk mode)
  ...
  - `talk.idleTimeoutS`: optional seconds without recognized user speech or an assistant reply before macOS Talk Mode deactivates and returns to Voice Wake waiting
