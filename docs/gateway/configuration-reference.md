...
- `memoryPressureThresholds`: overrides the hardcoded memory pressure warning/critical thresholds. Accepts an object with any of `rssWarningBytes` (default: `1_610_612_736` / 1.5 GB), `rssCriticalBytes` (default: `3_221_225_472` / 3 GB), `heapUsedWarningBytes` (default: `1_073_741_824` / 1 GB), `heapUsedCriticalBytes` (default: `2_147_483_648` / 2 GB). Unset fields keep their defaults, and partial overrides are validated against those defaults so warning thresholds stay below the effective critical threshold. Hot-reload supported.
