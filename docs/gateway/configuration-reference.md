...
- In strict mode, use `ssrfPolicy.allowedHostnames` for explicit exceptions, including wildcard patterns such as `*.example.com`, which do not match the bare domain.
