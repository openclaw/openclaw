...
- `gateway.controlUi.dangerouslyDisableDeviceAuth`: retired break-glass input. Older configs use it only to enter the bounded, explicit Control UI self-pairing migration; do not add it to current config.
