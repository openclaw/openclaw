...
- In strict mode, use `allowedHostnames` (patterns like `*.example.com` and exact host exceptions, including otherwise-blocked names like `localhost`) for explicit exceptions.
