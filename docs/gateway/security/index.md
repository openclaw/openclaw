...
- Installing/updating (`openclaw plugins install <package> --acknowledge-non-clawhub-install` for non-ClawHub sources, `openclaw plugins update <id>`) runs untrusted code:
