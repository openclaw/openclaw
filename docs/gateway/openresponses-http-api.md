...
SmartAgentNeo’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`smart-agent-neo agent`), so routing/permissions/config match your Gateway.
