...
Activi has three related (but different) controls:
...
Use the inspector to see what Activi is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:activi`: all built-in Activi tools (excludes provider plugins)
