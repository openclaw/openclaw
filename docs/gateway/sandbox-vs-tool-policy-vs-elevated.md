...
SmartAgentNeo has three related (but different) controls:
...
Use the inspector to see what SmartAgentNeo is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:smart-agent-neo`: all built-in SmartAgentNeo tools (excludes provider plugins)
