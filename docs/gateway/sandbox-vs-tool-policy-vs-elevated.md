...
EasyHub has three related (but different) controls:
...
Use the inspector to see what EasyHub is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:EasyHub`: all built-in EasyHub tools (excludes provider plugins)
