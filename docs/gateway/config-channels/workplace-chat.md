...
- Full Teams config (credentials, webhook, DM/group policy, multiple bot
  accounts, and per-team/per-channel overrides) is documented in [Microsoft Teams](/channels/msteams).
