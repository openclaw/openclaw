...
Para uma instalação de gateway, coloque em `~/.openclaw/.env` (ou no ambiente do seu serviço).
Veja [Env vars](/help/faq#how-does-openclaw-load-environment-variables).
