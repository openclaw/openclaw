...
- Same path: run the app from a fixed location (for SmartAgentNeo, `dist/SmartAgentNeo.app`).
...
Workaround: move files into the SmartAgentNeo workspace (`~/.smart-agent-neo/workspace`) if you want to avoid per-folder grants.
