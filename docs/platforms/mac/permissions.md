...
- Same path: run the app from a fixed location (for EasyHub, `dist/EasyHub.app`).
...
Workaround: move files into the EasyHub workspace (`~/.easyhub/workspace`) if you want to avoid per-folder grants.
