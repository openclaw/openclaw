...
- Same path: run the app from a fixed location (for Activi, `dist/Activi.app`).
...
Workaround: move files into the Activi workspace (`~/.activi/workspace`) if you want to avoid per-folder grants.
