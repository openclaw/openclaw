---
summary: "macOS IPC architecture for EVOX.sh app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# EVOX.sh macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → EVOX.sh.app → local execution.
