...
- Agent narration appears inline as each segment finishes, including after reconnect. Agent avatars align with the top of their messages. Completed chat turns fold earlier work into a **Worked for …** disclosure above the reply on iPhone and iPad. Tap it to inspect the work. Final answers and media stay visible, and active or unanswered work stays expanded.
