...
In the macOS app's embedded dashboard, clicking an external web link opens it in a resizable browser sidebar. The sidebar has back, forward, reload, open-in-default-browser, and close controls, and it remembers its width.
