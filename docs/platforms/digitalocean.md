---
summary: "Activi on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up Activi on DigitalOcean
  - Looking for cheap VPS hosting for Activi
title: "DigitalOcean"
---

# Activi on DigitalOcean

## Goal

Run a persistent Activi Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
- `~/.activi/workspace/` — workspace (SOUL.md, memory, etc.)
