...
- After pairing, choose the phone permissions to enable. If the Gateway requires node approval and your operator connection can approve the requested capabilities, review them and tap **Approve access and continue**. Setup finishes after the app verifies approval. Otherwise, follow the displayed Gateway approval commands, then tap **I have approved**.
