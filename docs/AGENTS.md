...
- Generated docs, never hand-edit: `docs/plugins/reference/**`, `docs/plugins/reference.md`, and `docs/plugins/plugin-inventory.md` come from `pnpm plugins:inventory:gen`; `docs/cli/commands.md` from `pnpm docs:commands:gen`; `docs/maturity/**` from `pnpm maturity:render`.
