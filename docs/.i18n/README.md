...
- Docs translation workflows generate non-English docs in `openclaw/docs` for the same locale set, except Galician (`gl`), which is currently supported in the Control UI only.
