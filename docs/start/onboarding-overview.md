---
summary: "Overview of SmartAgentNeo onboarding options and flows"
read_when:
...
SmartAgentNeo supports multiple onboarding paths depending on where the Gateway runs
...
- [`smart-agent-neo onboard` command](/cli/onboard)

## macOS app onboarding

Use the SmartAgentNeo app when you want a fully guided setup on macOS. Docs:
