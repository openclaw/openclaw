---
summary: "Overview of EVOX.sh onboarding options and flows"
read_when:
...
EVOX.sh has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `evox onboard`                     | Launch the app            |
...
CLI command docs: [`evox onboard`](/cli/onboard)

## macOS app onboarding

Open the EVOX.sh app. The first-run wizard walks you through the same steps
