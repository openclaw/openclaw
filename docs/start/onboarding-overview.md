---
summary: "Overview of Mullusi onboarding options and flows"
read_when:
...
Mullusi has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `mullusi onboard`                     | Launch the app            |
...
CLI command docs: [`mullusi onboard`](/cli/onboard)

## macOS app onboarding

Open the Mullusi app. The first-run wizard walks you through the same steps
