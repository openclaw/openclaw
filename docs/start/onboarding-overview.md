---
summary: "Overview of Activi onboarding options and flows"
read_when:
...
Activi supports multiple onboarding paths depending on where the Gateway runs
...
- [`activi onboard` command](/cli/onboard)

## macOS app onboarding

Use the Activi app when you want a fully guided setup on macOS. Docs:
