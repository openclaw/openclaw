...
summary: "Community-built projects and integrations powered by EasyHub"
---

# Showcase

Real projects from the community. See what people are building with EasyHub.

<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @EasyHub on X](https://x.com/EasyHub).
</Info>
...
OpenCode finishes the change → opens a PR → EasyHub reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).
...
Asked “Robby” (@EasyHub) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).
...
Desktop app to manage skills/commands across Agents, Claude, Codex, and EasyHub.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote EasyHub instances.
</Card>
...
CLI for Linear that integrates with agentic workflows (Claude Code, EasyHub). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then EasyHub takes over to manage room air quality.
...
Triggered by a roof camera: ask EasyHub to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a EasyHub persona.
</Card>
...
EasyHub connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had EasyHub generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via EasyHub.
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi voice assistant ↔ EasyHub HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/EasyHub-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  EasyHub gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/EasyHub/nix-EasyHub">
  **@EasyHub** • `nix` `packaging` `deployment`
  
  Batteries-included nixified EasyHub configuration for reproducible deployments.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with EasyHub as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the EasyHub ecosystem.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @EasyHub](https://x.com/EasyHub)
  </Step>
