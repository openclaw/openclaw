---
title: "Showcase"
summary: "Community-built projects and integrations powered by Mullusi"
read_when:
  - Looking for real Mullusi usage examples
  - Updating community project highlights
---

# Showcase

Real projects from the community. See what people are building with Mullusi.

<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/mullusi) or [tag @mullusi on X](https://x.com/mullusi).
</Info>
...
OpenCode finishes the change → opens a PR → Mullusi reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).
...
Asked “Robby” (@mullusi) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).
...
Desktop app to manage skills/commands across Agents, Claude, Codex, and Mullusi.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote Mullusi instances.
</Card>
...
14+ agents under one gateway with Opus 4.5 orchestrator delegating to Codex workers. Comprehensive [technical write-up](https://github.com/adam91holt/orchestrated-ai-articles) covering the Dream Team roster, model selection, sandboxing, webhooks, heartbeats, and delegation flows. [Mullusispace](https://github.com/adam91holt/mullusispace) for agent sandboxing. [Blog post](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/).
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`

CLI for Linear that integrates with agentic workflows (Claude Code, Mullusi). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Mullusi takes over to manage room air quality.
...
Triggered by a roof camera: ask Mullusi to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via an Mullusi persona.
</Card>
...
Mullusi connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had Mullusi generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via Mullusi.
...
<Card title="Mullusiia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/mullusiia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  
  Vapi voice assistant ↔ Mullusi HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/mullusi-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  Mullusi gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/mullusi/nix-mullusi">
  **@mullusi** • `nix` `packaging` `deployment`
  
  Batteries-included nixified Mullusi configuration for reproducible deployments.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with Mullusi as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the Mullusi ecosystem.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#self-promotion on Discord](https://discord.gg/mullusi) or [tweet @mullusi](https://x.com/mullusi)
  </Step>
