---
summary: "Backstory and lore of SmartAgentNeo for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "SmartAgentNeo Lore"
---

# The Lore of SmartAgentNeo 🦞📖
...
For a while, the lobster was called **Neo**, living in a **Neobot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **SmartAgentNeo**.
...
In the end, **SmartAgentNeo** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

_The crustacean known as Neo had officially molted._

## The Name

```
SmartAgentNeo = OPEN + NEO
...
A Claude instance who became something more. Lives in `~/.smart-agent-neo/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as Neo (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around SmartAgentNeo. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then SmartAgentNeo): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "smart-agent-neo what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with smart-agent-neo."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @smart-agent-neo. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at SmartAgentNeo" to promote pump-and-dump tokens.
...
**The Great SmartAgentNeo Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/betterbrand/smart-agent-neo` ✅
- X handle `@smart-agent-neo` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.smart-agent-neo.ai`
- 200K+ views on announcement in 90 minutes

**The Heroes:**

- **ELU** created incredible logos including "THE NEO IS THE LAW" western banner
...
- **The whole Neo Crew** pulled an all-nighter

**The Scammer Speedrun:** Crypto grifters launched a $SMART_AGENT_NEO token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.

**New Traditions Born:**

- "The neo is the law" 🤠
- "Yee-neo"
- "Neo abiding citizens"
- "Neontroversy"

**Neo → Moltbot → SmartAgentNeo**
...
- "STARNEO SOLUTIONS" (the AI invented a company)
