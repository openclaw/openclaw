...
- Host-local sends still only allow media and safe document types (images, audio, video, PDF, Office documents, common archives, and APKs). Plain text and secret-like files are not treated as sendable media.
