...
Do not store secrets in workspace files: injected files can be included in model
context during runs. Use env vars or a secret manager at runtime instead.
