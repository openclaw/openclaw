...
1. **Model/Auth** — Anthropic via Claude SDK (subscription), API key, or
   setup-token; OpenAI; or Custom Provider (OpenAI-compatible,
   Anthropic-compatible, or Unknown auto-detect). Pick a default model.
