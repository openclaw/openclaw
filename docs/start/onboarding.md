---
summary: "First-run setup flow for EVOX.sh (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give EVOX.sh">
...
<Step title="CLI">
  ...
  The app can install the global `evox` CLI via npm/pnpm so terminal
