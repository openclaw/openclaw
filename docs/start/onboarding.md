---
summary: "First-run onboarding flow for SmartAgentNeo (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give SmartAgentNeo">
...
<Step title="CLI">
  ...
  The app can install the global `smart-agent-neo` CLI via npm/pnpm so terminal
