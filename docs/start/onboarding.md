---
summary: "First-run setup flow for VeriClaw (macOS app)"
read_when:
...
- By default, VeriClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give VeriClaw">
