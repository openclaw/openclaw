---
summary: "First-run onboarding flow for Activi (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Activi">
...
<Step title="CLI">
  ...
  The app can install the global `activi` CLI via npm/pnpm so terminal
