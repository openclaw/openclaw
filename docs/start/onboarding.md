---
summary: "First-run setup flow for Mullusi (macOS app)"
read_when:
...
- By default, Mullusi is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Mullusi">
...
<Step title="CLI">
  ...
  The app can install the global `mullusi` CLI via npm, pnpm, or bun.
