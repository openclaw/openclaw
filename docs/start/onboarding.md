---
summary: "First-run onboarding flow for EasyHub (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give EasyHub">
...
<Step title="CLI">
  ...
  The app can install the global `EasyHub` CLI via npm/pnpm so terminal
