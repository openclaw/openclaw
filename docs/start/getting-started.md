---
summary: "Get EVOX.sh installed and run your first chat in minutes."
read_when:
...
Install EVOX.sh, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run EVOX.sh as a service account or want custom paths:
