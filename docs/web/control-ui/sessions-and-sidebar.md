...
Root sessions and dashboard sessions can be pinned. Ordinary child/subagent sessions live in their parent's tree and reject pin requests, including when they appear as top-level threads; dashboard children remain eligible because they are user-facing destinations.
