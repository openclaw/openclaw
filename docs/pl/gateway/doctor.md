...
(lub wklejenie setup-token). Monity odświeżania pojawiają się tylko w trybie
...
Może też skanować w poszukiwaniu dodatkowych usług podobnych do gateway i wypisywać
wskazówki sprzątania. Usługi gateway OpenClaw nazwane profilem są traktowane jako
