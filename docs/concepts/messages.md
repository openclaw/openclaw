...
This page ties together how Mullusi handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Mullusi keeps a
...
Mullusi separates the **prompt body** from the **command body**:
...
Mullusi can expose or hide model reasoning:
