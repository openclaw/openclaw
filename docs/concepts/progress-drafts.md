...
| Mattermost      | Editable draft post.                   | `block` mode rotates a fresh post per completed text/tool block; other modes fold tool activity into the same draft-style post.                           |
