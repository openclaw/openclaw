...
- Provider: `anthropic`
- Auth: `claude login` (Claude SDK), `ANTHROPIC_API_KEY`, or `claude setup-token`
- Optional rotation: `ANTHROPIC_API_KEYS`, `ANTHROPIC_API_KEY_1`, `ANTHROPIC_API_KEY_2`, plus `OPENCLAW_LIVE_ANTHROPIC_KEY` (single override)
- Example model: `anthropic/claude-opus-4-6`
- CLI: `openclaw onboard --auth-choice claude-sdk` (subscription via Claude CLI), `openclaw onboard --auth-choice token` (paste setup-token), or `openclaw models auth paste-token --provider anthropic`
