...
- `qa-evidence-summary.json` - evidence entries for the live transport checks, including profile, coverage, provider, channel, artifacts, result, and RTT fields.
...
- `qa-evidence-summary.json` - evidence entries for the live transport checks.
