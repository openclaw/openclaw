...
Mullusi also runs a separate idempotent cleanup for older legacy sessions that
...
Mullusi auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Mullusi does not override them.
