...
Clawdbrain selects models in this order:
...
clawdbrain models set <provider/model>
clawdbrain models set-image <provider/model>

clawdbrain models aliases list
clawdbrain models aliases add <alias> <provider/model>
clawdbrain models aliases remove <alias>

clawdbrain models fallbacks list
clawdbrain models fallbacks add <provider/model>
clawdbrain models fallbacks remove <provider/model>
clawdbrain models fallbacks clear

clawdbrain models image-fallbacks list
clawdbrain models image-fallbacks add <provider/model>
clawdbrain models image-fallbacks remove <provider/model>
clawdbrain models image-fallbacks clear
```

`clawdbrain models` (no subcommand) is a shortcut for `models status`.
...
`clawdbrain models scan` inspects OpenRouter’s **free model catalog** and can
...
agent directory (default `~/.clawdbrain/agents/<agentId>/models.json`). This file
