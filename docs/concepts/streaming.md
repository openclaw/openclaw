...
DNA has two separate “streaming” layers:
...
When block streaming is enabled, DNA can **merge consecutive block chunks**
...
When draft streaming is active, DNA disables block streaming for that reply to avoid double-streaming.
