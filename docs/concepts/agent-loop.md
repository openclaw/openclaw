...
- Agent runtime: `agents.defaults.timeoutSeconds` default 3600s; direct env fallback: `OPENCLAW_AGENT_TIMEOUT_SECONDS`; enforced in `runEmbeddedPiAgent` abort timer.
