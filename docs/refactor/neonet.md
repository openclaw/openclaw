---
summary: "Neonet refactor: unify network protocol, roles, auth, approvals, identity"
read_when:
...
title: "Neonet Refactor"
---

# Neonet refactor (protocol + auth unification)
...
- Example: `scarlet-neo`, `saltwave`, `mantis-pinch`.
