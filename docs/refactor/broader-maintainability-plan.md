...
- Stage 3B: started with a shared gateway reachability and health-check workflow plus a shared workspace resolution and workspace-config seam reused by wizard and non-interactive local onboarding.
