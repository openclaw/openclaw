...
1. Stage 3A: classify any remaining late-startup boundaries after Tailscale exposure, then decide whether Stage 3A is complete enough to pause in favor of Stage 3B or Stage 2B follow-on cleanup.
