...
Распространённые сценарии (копировать/вставить):
...
- `WasMentioned` (результат управления упоминаниями)
...
См. [Групповые сообщения](/channels/group-messages) для поведения, специфичного для WhatsApp (внедрение истории, детали обработки упоминаний).
