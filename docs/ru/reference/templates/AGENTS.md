...
- Никогда не эксфильтрируйте приватные данные.
...
- Прошло >8 часов с момента последнего сообщения от вас
