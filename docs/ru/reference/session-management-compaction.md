---
summary: "Подробный разбор: хранилище сеансов + транскрипты, жизненный цикл и внутреннее устройство (авто)уплотнения"
read_when:
  - Вам нужно отладить идентификаторы сеансов, JSONL транскриптов или поля sessions.json
  - Вы меняете поведение автоуплотнения или добавляете «предуплотнительную» служебную обработку
  - Вы хотите реализовать сброс памяти или тихие системные ходы
