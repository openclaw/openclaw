...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:56:48Z
---
...
Пример (список разрешённых для провайдера/модели для нестабильного эндпоинта):
...
Плагины могут регистрировать **дополнительные инструменты** (и команды CLI) помимо базового набора.
...
- См. [Web tools](/tools/web) для настройки.
- См. [Firecrawl](/tools/firecrawl) для необязательного антибот‑фолбэка.
