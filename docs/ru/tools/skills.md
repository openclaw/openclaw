...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:56:26Z
---
...
Их можно ограничивать через `metadata.openclaw.requires.config` в записи конфига плагина.
...
- Для недоверенных входных данных и рискованных инструментов предпочитайте изолированные запуски. См. [Sandboxing](/gateway/sandboxing).
