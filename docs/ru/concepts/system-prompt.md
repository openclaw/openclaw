...
Чтобы проверить вклад каждого внедрённого файла (сырой vs внедрённый, усечение, плюс накладные расходы схемы инструментов), используйте `/context list` или `/context detail`. См. [Context](/concepts/context).
