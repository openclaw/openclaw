...
read_when:
  ...
  - Принятие решения: автономный CLI vs глубокая интеграция с OpenClaw
...
- разделение наблюдаемого, предполагаемого и суммарного
...
- Эмбеддинги + брутфорс (удивительно долго работает при небольшом числе чанков)
