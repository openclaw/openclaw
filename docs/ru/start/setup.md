...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T10:56:07Z
---
...
Загрузите начальную конфигурацию один раз:
...
2. Завершите чек-лист онбординга/разрешений (запросы TCC).
...
Для постоянно работающих или многопользовательских серверов рассмотрите **системный** сервис вместо
пользовательского (lingering не требуется). См. [Gateway runbook](/gateway) для заметок по systemd.
