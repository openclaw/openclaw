...
- **Webhooks**: внешние HTTP‑вебхуки, которые позволяют другим системам инициировать работу в OpenClaw. См. [Webhook Hooks](/automation/webhook) или используйте `openclaw webhooks` для вспомогательных команд Gmail.
