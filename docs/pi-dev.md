...
This guide summarizes a sane workflow for working on the pi integration in Activi.
...
- Trigger the agent directly:
  - `pnpm activi agent --message "Hello" --thinking low`
...
State lives under the Activi state directory. Default is `~/.activi`. If `ACTIVI_STATE_DIR` is set, use that directory instead.

To reset everything:

- `activi.json` for config
...
- [https://docs.activi.ai/testing](https://docs.activi.ai/testing)
- [https://docs.activi.ai/start/getting-started](https://docs.activi.ai/start/getting-started)
