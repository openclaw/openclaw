...
This guide summarizes a sane workflow for working on the pi integration in SmartAgentNeo.
...
- Trigger the agent directly:
  - `pnpm smart-agent-neo agent --message "Hello" --thinking low`
...
State lives under the SmartAgentNeo state directory. Default is `~/.smart-agent-neo`. If `SMART_AGENT_NEO_STATE_DIR` is set, use that directory instead.

To reset everything:

- `smart-agent-neo.json` for config
...
- [https://docs.smart-agent-neo.ai/testing](https://docs.smart-agent-neo.ai/testing)
- [https://docs.smart-agent-neo.ai/start/getting-started](https://docs.smart-agent-neo.ai/start/getting-started)
