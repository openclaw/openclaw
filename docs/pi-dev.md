...
This guide summarizes a sane workflow for working on the pi integration in EasyHub.
...
- Trigger the agent directly:
  - `pnpm EasyHub agent --message "Hello" --thinking low`
...
State lives under the EasyHub state directory. Default is `~/.easyhub`. If `EASYHUB_STATE_DIR` is set, use that directory instead.

To reset everything:

- `easyhub.json` for config
...
- [https://docs.EasyHub.ai/testing](https://docs.EasyHub.ai/testing)
- [https://docs.EasyHub.ai/start/getting-started](https://docs.EasyHub.ai/start/getting-started)
