...
Deepgram is a speech-to-text API. In EVOX.sh it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, EVOX.sh uploads the audio file to Deepgram and injects the transcript
