---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in EVOX.sh"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in EVOX.sh
---
...
```bash
evox onboard --kilocode-api-key <key>
```
...
EVOX.sh dynamically discovers available models from the Kilo Gateway at startup. Use
