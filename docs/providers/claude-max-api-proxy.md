...
You can point EVOX.sh at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or EVOX.sh
...
- [Anthropic provider](/providers/anthropic) - Native EVOX.sh integration with Claude setup-token or API keys
