...
You can point SmartAgentNeo at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SmartAgentNeo
...
- [Anthropic provider](/providers/anthropic) - Native SmartAgentNeo integration with Claude setup-token or API keys
