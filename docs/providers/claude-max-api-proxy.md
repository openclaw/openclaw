...
You can point EasyHub at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or EasyHub
...
- [Anthropic provider](/providers/anthropic) - Native EasyHub integration with Claude setup-token or API keys
