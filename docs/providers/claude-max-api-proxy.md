...
You can point Activi at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Activi
...
- [Anthropic provider](/providers/anthropic) - Native Activi integration with Claude setup-token or API keys
