...
You can point DNA at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or DNA
...
- [Anthropic provider](/providers/anthropic) - Native DNA integration with Claude setup-token or API keys
