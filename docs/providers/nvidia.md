---
summary: "Use NVIDIA's OpenAI-compatible API in Activi"
read_when:
  - You want to use NVIDIA models in Activi
...
activi onboard --auth-choice skip
activi models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
