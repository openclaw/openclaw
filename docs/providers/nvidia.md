---
summary: "Use NVIDIA's OpenAI-compatible API in Mullusi"
read_when:
  - You want to use NVIDIA models in Mullusi
...
mullusi onboard --auth-choice skip
mullusi models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
