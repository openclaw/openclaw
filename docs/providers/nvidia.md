---
summary: "Use NVIDIA's OpenAI-compatible API in EVOX.sh"
read_when:
  - You want to use NVIDIA models in EVOX.sh
...
evox onboard --auth-choice skip
evox models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
