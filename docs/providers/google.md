...
read_when:
  ...
  - You want Gemini CLI OAuth instead of an API key
title: "Google"
---
...
with an API key or the Gemini CLI OAuth flow.
...
- The Gemini CLI OAuth plugin is auto-enabled when its provider is referenced in
  your config. You can also enable it manually with
