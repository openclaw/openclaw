...
tells the model it was interrupted (an empty turn makes it resume); other Gemini Live
models interrupt only through server-side voice activity detection. See the
