---
summary: "GLM model family overview + how to use it in Mullusi"
read_when:
  - You want GLM models in Mullusi
...
GLM is a **model family** (not a company) available through the Z.AI platform. In Mullusi, GLM
...
Mullusi currently seeds the bundled `zai` provider with these GLM refs:
