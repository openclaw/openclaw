---
summary: "Use Qianfan's unified API to access many models in EasyHub"
read_when:
...
3. EasyHub installed on your system
...
4. Copy the API key for use with EasyHub

## CLI setup

```bash
EasyHub onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [EasyHub Configuration](/gateway/configuration)
