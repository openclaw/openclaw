---
summary: "Use Qianfan's unified API to access many models in Activi"
read_when:
...
3. Activi installed on your system
...
4. Copy the API key for use with Activi

## CLI setup

```bash
activi onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Activi Configuration](/gateway/configuration)
