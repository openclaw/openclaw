---
summary: "Use Qianfan's unified API to access many models in SmartAgentNeo"
read_when:
...
3. SmartAgentNeo installed on your system
...
4. Copy the API key for use with SmartAgentNeo

## CLI setup

```bash
smart-agent-neo onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [SmartAgentNeo Configuration](/gateway/configuration)
