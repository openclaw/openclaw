---
summary: "Use Qianfan's unified API to access many models in EVOX.sh"
read_when:
...
3. EVOX.sh installed on your system
...
4. Copy the API key for use with EVOX.sh

## CLI setup

```bash
evox onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [EVOX.sh Configuration](/gateway/configuration)
