...
<Tabs>
  ...
  <Tab title="鏄庣‘鐨勫尯鍩熺鐐?>
    **鏈€閫傚悎锛?*鎯宠寮哄埗浣跨敤鐗瑰畾 Coding Plan 鎴栭€氱敤 API 鎺ュ彛鐨勭敤鎴枫€?
    <Steps>
      <Step title="閫夋嫨姝ｇ‘鐨勮缃€夐」">
        ```bash
        # Coding Plan 鍏ㄧ悆锛堟帹鑽愮粰 Coding Plan 鐢ㄦ埛锛?        openclaw onboard --auth-choice zai-coding-global
