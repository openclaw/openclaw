---
summary: "Use Synthetic's Anthropic-compatible API in EasyHub"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. EasyHub registers it as the
...
Note: EasyHub's Anthropic client appends `/v1` to the base URL, so use
