---
summary: "Use Synthetic's Anthropic-compatible API in Activi"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Activi registers it as the
...
Note: Activi's Anthropic client appends `/v1` to the base URL, so use
