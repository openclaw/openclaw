---
summary: "Use Synthetic's Anthropic-compatible API in Mullusi"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Mullusi registers it as the
...
Note: Mullusi's Anthropic client appends `/v1` to the base URL, so use
