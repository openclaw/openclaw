---
summary: "Use Synthetic's Anthropic-compatible API in SmartAgentNeo"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. SmartAgentNeo registers it as the
...
Note: SmartAgentNeo's Anthropic client appends `/v1` to the base URL, so use
