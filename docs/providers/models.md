---
summary: "Model providers (LLMs) supported by DNA"
read_when:
...
DNA can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `dna onboard`).
