---
summary: "Use Qwen OAuth (free tier) in SmartAgentNeo"
read_when:
  - You want to use Qwen with SmartAgentNeo
...
```bash
smart-agent-neo models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, SmartAgentNeo will sync credentials
