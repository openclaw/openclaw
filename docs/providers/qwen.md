---
summary: "Use Qwen OAuth (free tier) in DNA"
read_when:
  - You want to use Qwen with DNA
...
```bash
dna models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, DNA will sync credentials
