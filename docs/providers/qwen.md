---
summary: "Use Qwen OAuth (free tier) in EasyHub"
read_when:
  - You want to use Qwen with EasyHub
...
```bash
EasyHub models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, EasyHub will sync credentials
