---
summary: "Use Qwen OAuth (free tier) in Activi"
read_when:
  - You want to use Qwen with Activi
...
```bash
activi models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Activi will sync credentials
