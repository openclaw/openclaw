...
<Tip>
瀵逛簬闈炰氦浜掑紡璁剧疆锛圕I銆佽剼鏈級锛岀洿鎺ヤ紶閫掑瘑閽ワ細
...
<AccordionGroup>
  <Accordion title="璁剧疆鍚庣殑榛樿妯″瀷">
    `openclaw onboard --auth-choice volcengine-api-key` 褰撳墠浼氬皢 `volcengine-plan/ark-code-latest` 璁剧疆涓洪粯璁ゆā鍨嬶紝鍚屾椂涔熶細娉ㄥ唽閫氱敤鐨?`volcengine` 鐩綍銆?  </Accordion>
