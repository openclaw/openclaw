---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with SmartAgentNeo"
read_when:
  - You want Xiaomi MiMo models in SmartAgentNeo
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). SmartAgentNeo uses
