---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Activi"
read_when:
  - You want Xiaomi MiMo models in Activi
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Activi uses
