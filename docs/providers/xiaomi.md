---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with EasyHub"
read_when:
  - You want Xiaomi MiMo models in EasyHub
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). EasyHub uses
