---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with DNA"
read_when:
  - You want Xiaomi MiMo models in DNA
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). DNA uses
...
```bash
dna onboard --auth-choice xiaomi-api-key
# or non-interactive
dna onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
