---
summary: "Use Xiaomi MiMo models with EVOX.sh"
read_when:
  - You want Xiaomi MiMo models in EVOX.sh
...
Xiaomi MiMo is the API platform for **MiMo** models. EVOX.sh uses the Xiaomi
...
```bash
evox onboard --auth-choice xiaomi-api-key
# or non-interactive
evox onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
