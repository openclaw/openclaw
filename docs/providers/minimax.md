---
summary: "Use MiniMax M2.1 in DNA"
read_when:
  - You want MiniMax models in DNA
...
Configure manually via `dna.json`:
...
- Use `dna models list` and `dna models set minimax/MiniMax-M2.1` to switch.
...
- Running `dna configure` and selecting **MiniMax M2.1**, or
