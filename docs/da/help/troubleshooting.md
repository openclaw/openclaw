...
<AccordionGroup>
  ...
  <Accordion title="Dashboard eller Control UI vil ikke forbinde">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Gateway vil ikke starte, eller service er installeret men kører ikke">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Kanal forbinder, men beskeder flyder ikke">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Cron eller heartbeat affyrede ikke eller blev ikke leveret">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Node er parret, men værktøjet fejler kamera/canvas/skærm/exec">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Browser-værktøj fejler">
    ```bash
    openclaw status
    openclaw gateway status
