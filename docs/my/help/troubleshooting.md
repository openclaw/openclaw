...
<AccordionGroup>
  ...
  <Accordion title="Dashboard သို့မဟုတ် Control UI ချိတ်ဆက်မရပါ">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Gateway စတင်မလုပ်နိုင်ပါ သို့မဟုတ် service ကို ထည့်သွင်းထားသော်လည်း မလည်ပတ်ပါ">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="ချန်နယ် ချိတ်ဆက်ပြီးသားဖြစ်သော်လည်း မက်ဆေ့ချ်များ မစီးဆင်းပါ">
    ```bash
    openclaw status
    openclaw gateway status
    openclaw logs --follow
  ...
  <Accordion title="Cron သို့မဟုတ် heartbeat မလုပ်ဆောင်ပါ သို့မဟုတ် မပို့ဆောင်နိုင်ပါ">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Node ကို pair ပြုလုပ်ပြီးသားဖြစ်သော်လည်း tool သည် camera/canvas/screen exec မအောင်မြင်ပါ">
    ```bash
    openclaw status
    openclaw gateway status
  ...
  <Accordion title="Browser tool မအောင်မြင်ပါ">
    ```bash
    openclaw status
    openclaw gateway status
