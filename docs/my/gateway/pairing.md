...
Gateway ပိုင်ဆိုင်သည့် ချိတ်ဆက်မှုတွင် **Gateway** သည် မည်သည့် နိုဒ်များကို ဝင်ရောက်ခွင့်ပြုမည်ကို ဆုံးဖြတ်ရန် အမှန်တရားရင်းမြစ်ဖြစ်သည်။ UI များ (macOS အက်ပ်၊ အနာဂတ် ကလိုင်းယင့်များ) သည် စောင့်ဆိုင်းနေသော တောင်းဆိုချက်များကို အတည်ပြု သို့မဟုတ် ငြင်းပယ်ရန်အတွက် frontend များသာ ဖြစ်သည်။

**အရေးကြီးချက်:** WS နိုဒ်များသည် `connect` အတွင်း **device pairing** (အခန်းကဏ္ဍ `node`) ကို အသုံးပြုသည်။
`node.pair.*` သည် သီးခြား ချိတ်ဆက်မှု သိုလှောင်ရုံဖြစ်ပြီး WS handshake ကို **မကန့်သတ်ပါ**။
`node.pair.*` ကို တိတိကျကျ ခေါ်ဆိုသော ကလိုင်းယင့်များသာ ဤ လုပ်ငန်းစဉ်ကို အသုံးပြုသည်။
...
- **Transport**: Gateway WS endpoint သည် တောင်းဆိုချက်များကို ဆက်လက်ပို့ဆောင်ပေးသော်လည်း အဖွဲ့ဝင်မှုကို ဆုံးဖြတ်ခြင်း မပြုလုပ်ပါ။ (Legacy TCP bridge ပံ့ပိုးမှုကို မထောက်ခံတော့ပါ/ဖယ်ရှားပြီးပါပြီ)
