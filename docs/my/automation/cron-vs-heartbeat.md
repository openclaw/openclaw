...
Heartbeats နှင့် cron jobs နှစ်မျိုးလုံးသည် အချိန်ဇယားအလိုက် တာဝန်များကို လုပ်ဆောင်စေနိုင်ပါသည်။ ဤလမ်းညွှန်သည် သင်၏ အသုံးပြုမှုအတွက် သင့်တော်သည့် နည်းလမ်းကို ရွေးချယ်နိုင်ရန် ကူညီပေးပါသည်။
...
Heartbeats သည် ပုံမှန် ကြားကာလ (ပုံမှန်အားဖြင့် မိနစ် 30) ဖြင့် **main session** အတွင်း လုပ်ဆောင်ပါသည်။ အရေးကြီးသည့် အချက်အလက်များကို ရှာဖွေဖော်ထုတ်ရန် အေးဂျင့်အတွက် ဒီဇိုင်းပြုလုပ်ထားပါသည်။
...
Lobster သည် **အဆင့်များစွာပါသော tool pipeline များ** ကို သတ်မှတ်ထားသည့် အတိုင်း လုပ်ဆောင်ရန်နှင့် အတည်ပြုချက်များကို ထင်ရှားစွာ တောင်းဆိုရန် အသုံးပြုသည့် workflow runtime ဖြစ်ပါသည်။
တစ်ကြိမ်တည်း အေးဂျင့် turn ထက် ပိုမိုရှုပ်ထွေးပြီး လူသား စစ်ဆေးချက်များပါသော ပြန်လည်စတင်နိုင်သည့် workflow ကို လိုအပ်သည့်အခါ အသုံးပြုပါ။
...
အချိန်ဇယားချထားသော workflow များအတွက် cron သို့မဟုတ် heartbeat ကို အသုံးပြုပြီး Lobster ကို ခေါ်သော အေးဂျင့် turn ကို trigger လုပ်ပါ။
ad-hoc workflow များအတွက် Lobster ကို တိုက်ရိုက် ခေါ်ပါ။
