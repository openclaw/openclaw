...
ထုတ်လွှင့် အုပ်စုများသည် အေးဂျင့်များစွာကို မက်ဆေ့ချ်တစ်ခုတည်းကို တစ်ပြိုင်နက်တည်း ကိုင်တွယ်ဆောင်ရွက်ပြီး ပြန်ကြားစေရန် ခွင့်ပြုပါသည်။ ယင်းကြောင့် WhatsApp အုပ်စုတစ်ခု သို့မဟုတ် DM တစ်ခုအတွင်း ဖုန်းနံပါတ်တစ်ခုတည်းကို အသုံးပြုပြီး အထူးပြု အေးဂျင့်အဖွဲ့များကို အတူတကွ လုပ်ကိုင်စေနိုင်ပါသည်။

လက်ရှိ အကျုံးဝင်မှု: **WhatsApp သာလျှင်** (web channel)။

ထုတ်လွှင့် အုပ်စုများကို channel allowlists နှင့် group activation စည်းမျဉ်းများအပြီးတွင် သုံးသပ်အကဲဖြတ်ပါသည်။ WhatsApp အုပ်စုများတွင် OpenClaw သည် ပုံမှန်အားဖြင့် ပြန်ကြားမည့်အချိန်တွင် (ဥပမာ—အုပ်စုဆက်တင်များအပေါ်မူတည်၍ mention ဖြစ်သည့်အခါ) ထုတ်လွှင့်ခြင်းများ ဖြစ်ပေါ်ပါသည်။

## အသုံးပြုမှုများ

### 1. အထူးပြု အေးဂျင့်အဖွဲ့များ
...
### 2. ဘာသာစကားအများအပြား ပံ့ပိုးမှု
...
### 3. အရည်အသွေးအာမခံ လုပ်ငန်းစဉ်များ
...
### 4. တာဝန် အလိုအလျောက်လုပ်ဆောင်ခြင်း
...
အပေါ်ဆုံးအဆင့်တွင် `broadcast` အပိုင်းကို (`bindings` အနီးတွင်) ထည့်ပါ။ ကီးများမှာ WhatsApp peer id များဖြစ်ပါသည်—
...
မှတ်ချက်: ထုတ်လွှင့် အုပ်စုများသည် channel allowlists သို့မဟုတ် group activation စည်းမျဉ်းများ (mentions/commands စသည်) ကို မကျော်လွှားပါ။ မက်ဆေ့ချ်ကို ကိုင်တွယ်ရန် အရည်အချင်းပြည့်မီသည့်အခါ _မည်သည့် အေးဂျင့်များ လည်ပတ်မည်_ ကိုသာ ပြောင်းလဲပေးပါသည်။
...
### 1. အေးဂျင့်များကို အာရုံစိုက်စေပါ
...
### 3. ကိရိယာ အသုံးပြုခွင့် မတူညီစွာ ဖွဲ့စည်းပါ
...
### 5. မအောင်မြင်မှုများကို နူးညံ့စွာ ကိုင်တွယ်ပါ

အေးဂျင့်များသည် သီးခြားစီ မအောင်မြင်နိုင်ပါသည်။ အေးဂျင့်တစ်ဦး၏ အမှားသည် အခြားသူများကို မပိတ်ဆို့ပါ—
