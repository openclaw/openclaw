...
**claude-max-api-proxy** သည် သင့် Claude Max/Pro စာရင်းသွင်းမှုကို OpenAI နှင့် ကိုက်ညီသော API endpoint အဖြစ် ဖော်ထုတ်ပေးသော community tool တစ်ခုဖြစ်သည်။ ၎င်းကြောင့် OpenAI API ဖော်မတ်ကို ပံ့ပိုးသော မည်သည့်ကိရိယာနှင့်မဆို သင့်စာရင်းသွင်းမှုကို အသုံးပြုနိုင်ပါသည်။
