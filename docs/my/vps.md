...
VPS/ဟို့စ်တင်ခြင်း လမ်းညွှန်များသို့ လင့်ခ်များကို စုစည်းပေးပြီး cloud
တပ်ဆင်မှုများ မည်သို့ အလုပ်လုပ်သည်ကို အထွေထွေအဆင့်တွင် ရှင်းလင်းဖော်ပြထားသည်။

## ပံ့ပိုးသူကို ရွေးချယ်ပါ

- **Railway** (တစ်ချက်နှိပ် + browser ဖြင့် တပ်ဆင်ခြင်း): [Railway](/install/railway)
- **Northflank** (တစ်ချက်နှိပ် + browser ဖြင့် တပ်ဆင်ခြင်း): [Northflank](/install/northflank)
