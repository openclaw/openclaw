...
SOUL Evil ဟုခ်သည် purge window အတွင်း သို့မဟုတ် ကျပန်းအခွင့်အလမ်းဖြင့် **injected** `SOUL.md` အကြောင်းအရာကို `SOUL_EVIL.md` နှင့် လဲလှယ်ပေးပါသည်။ ဒစ်စ်ပေါ်ရှိ ဖိုင်များကို **မည်သည့်အခါမျှ** ပြင်ဆင်ခြင်းမပြုပါ။

## အလုပ်လုပ်ပုံ

`agent:bootstrap` ကို လည်ပတ်သည့်အခါ၊ စနစ်ပရိုမ့်ကို ဖွဲ့စည်းမည့်အချိန်မတိုင်မီ ဟုခ်သည် မမ်မိုရီအတွင်းရှိ `SOUL.md` အကြောင်းအရာကို အစားထိုးနိုင်ပါသည်။ `SOUL_EVIL.md` မရှိပါက သို့မဟုတ် ဗလာဖြစ်နေပါက OpenClaw သည် သတိပေးချက်ကို မှတ်တမ်းတင်ပြီး ပုံမှန် `SOUL.md` ကို ဆက်လက်အသုံးပြုပါမည်။
