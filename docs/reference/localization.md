...
| Updater dry-run                  | `src/cli/i18n/locales/en.ts`                                                            | Update updater-owned catalogs together; shared generated-catalog adoption remains a later updater-owner slice | `node scripts/run-vitest.mjs src/cli/i18n/runtime.test.ts src/cli/update-cli.test.ts`              |
