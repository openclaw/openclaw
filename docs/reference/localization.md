...
| CLI updater dry-run              | `src/cli/i18n/locales/en.ts`                                        | Update the typed CLI catalog and its reviewed locale catalogs                                    | `pnpm exec vitest run src/cli/i18n/runtime.test.ts src/cli/update-cli.test.ts`   |
| CLI onboarding and channel setup | `src/wizard/i18n/locales/en.ts`                                     | Update the wizard-owned catalogs                                                                 | `pnpm exec vitest run src/wizard/i18n/index.test.ts`                             |
