...
| `phases.deep.maxPromotedSnippetTokens` | `number`  | `160`         | Maximum estimated tokens kept from each archived short-term promotion excerpt; provenance metadata remains visible |
