...
- **Protected Files:** Any file in the workspace root that is not in an explicitly writable directory (e.g., memory/, projects/, notes/) and any file whose name matches *.env, secrets/*, *.key, *.pem.
