...
<Steps>
  ...
  <Step title="Model/Auth">
    ...
    - **OpenCode**: prompts for `OPENCODE_API_KEY` (or `OPENCODE_ZEN_API_KEY`, or `OPENCODE_GO_API_KEY`, get it at https://opencode.ai/auth) and lets you pick the Zen or Go catalog.
