...
Selected normal CI lanes, including Windows Node, macOS Swift, and Control UI, remain blocking. Windows/macOS cross-OS release-check lanes retain their separate advisory policy.
