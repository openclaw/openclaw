...
- `bypass_extended_stable_guard`: testing-only boolean, default `false`. With `npm_dist_tag=extended-stable`, it bypasses monthly extended-stable eligibility while preserving release identity, artifact, approval, and readback checks.
