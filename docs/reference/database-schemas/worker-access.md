...
Doctor passes its live repair authority to the same ingress queue owner. The owner
rechecks it around asynchronous reads and recovery decisions and before transaction
and commit admission; accepted commits still settle.
