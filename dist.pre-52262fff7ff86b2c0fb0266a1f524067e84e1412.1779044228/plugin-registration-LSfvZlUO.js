import { n as BROWSER_REQUEST_GATEWAY_SCOPE, t as BROWSER_REQUEST_GATEWAY_METHOD } from "./browser-gateway-contract-CoOuIQBH.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-IfX40Cut.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-DA6Mi2yF.js");
