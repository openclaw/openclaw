...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-kATa7Omo.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-DaksUq4K.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-DW9DoLK2.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-NRnXfCEB.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-Bqc2KKCl.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-Dyc7nHND.js"),
