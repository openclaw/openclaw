...
export declare function formatActiveDiagnosticTraceparent(): string | undefined;
export declare function runWithDiagnosticTraceContext<T>(trace: DiagnosticTraceContext, callback: () => T): T;
export declare function runWithDiagnosticTraceparent<T>(traceparent: string | undefined, callback: () => T): T;
