...
import { _ as resolveBareModelDefaultProvider, i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-Bd49BLni.js";
...
import { a as listLegacyRuntimeModelProviderAliases, n as isCliRuntimeProvider } from "./model-runtime-aliases-DhDX4zbE.js";
import "./workspace-RgP_eKkD.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-UAiygz_v.js";
import { t as resolveAgentRuntimeLabel } from "./agent-runtime-label-fwSKNC1F.js";
import { r as rejectUnauthorizedCommand } from "./command-gates-p79cDON4.js";
import { t as resolveModelAuthLabel } from "./model-auth-label-F31U0EOF.js";
import { n as createProviderAuthChecker, t as resolveVisibleModelCatalog } from "./model-catalog-visibility-CwmxwBVZ.js";
import { n as isModelPickerVisibleProvider } from "./model-picker-visibility-ClO_qHFJ.js";
...
async function buildModelsProviderData(cfg, agentId, options = {}) {
	...
	const hasAuth = options.view === "all" ? () => true : createProviderAuthChecker({
		cfg,
		workspaceDir: options.workspaceDir ?? (agentId ? resolveAgentWorkspaceDir(cfg, agentId) : void 0) ?? resolveDefaultAgentWorkspaceDir(),
		agentDir: agentId ? resolveAgentDir(cfg, agentId) : void 0
	});
	for (const entry of catalog) if (usesUnfilteredCatalogModels(entry.provider) && hasAuth(entry.provider)) add(entry.provider, entry.id);
