...
import { b as resolveSubagentModelConfigSelectionResult } from "./agent-scope-B7Gl_3a6.js";
import { c as normalizeAgentId } from "./session-key-CQewiu8n.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BdqZvTnb.js";
...
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel } from "./thinking-BxclR8vv.js";
...
import { o as resolveSessionTranscriptPath } from "./paths-789ECJN2.js";
import { u as setSessionRuntimeModel } from "./types-CmPL5zcY.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-S5cDbzsd.js";
import { b as resolveHooksGmailModel, d as normalizeModelSelection, v as resolveConfiguredModelRef } from "./model-selection-shared-Bd49BLni.js";
import { i as resolveAllowedModelRef, r as getModelRefStatus, t as isCliProvider } from "./model-selection-cli-CYG4T4aj.js";
import { m as resolveThinkingDefault } from "./model-selection-DZrSRKB-.js";
import { r as loadModelCatalog } from "./model-catalog-CAIYwyOS.js";
import { i as hasNonzeroUsage, r as deriveSessionTotalTokens } from "./usage-BQ1hPeyh.js";
import { u as isCommandLaneTaskTimeoutError } from "./command-queue-COgr1nXO.js";
import "./selection-Crk8Ihvy.js";
import { l as ensureAgentWorkspace } from "./workspace-RgP_eKkD.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-ClY1g8qg.js";
import "./pi-bundle-mcp-tools-BB_aflSU.js";
import { t as resolveAgentTimeoutMs } from "./timeout-ctCKMrP-.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-Pu5JHFut.js";
import { n as resolveCronStyleNow } from "./current-time-dX5eOhq1.js";
import { n as createCronRunDiagnosticsFromError, r as mergeCronRunDiagnostics, t as createCronRunDiagnosticsFromAgentResult } from "./run-diagnostics-DCanpcWq.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-BRfIh2Tt.js";
import { i as persistCronSkillsSnapshotIfChanged, n as createPersistCronSessionEntry, o as resolveCronChannelOutputPolicy, r as markCronSessionPreRun, t as adoptCronRunSessionMetadata } from "./run-session-state-CH_-gQHL.js";
import { a as resolveHeartbeatAckMaxChars, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-TWkZB_6F.js";
import { t as resolveCronAgentSessionKey } from "./session-key-2ouBB-P8.js";
import { t as resolveCronSession } from "./session-CmeTbVRt.js";
...
const runtimePluginsLoader = createLazyImportLoader(() => import("./run-runtime-plugins.runtime.js"));
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-B24BfVq3.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-C_sAoDhA.js");
}
async function prepareCronRunContext(params) {
	...
	const runTimeoutOverrideMs = typeof explicitTimeoutSeconds === "number" && Number.isFinite(explicitTimeoutSeconds) && explicitTimeoutSeconds > 0 ? explicitTimeoutSeconds * 1e3 : void 0;
