...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-CpnazxrM.js";
import { n as require_extend, t as require_package$1 } from "./package-DvlSnC4-.js";
import { t as require_json_bigint } from "./json-bigint-PP0UZlI8.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-CqToUD8s.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-BoQb9aey.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
