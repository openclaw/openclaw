...
import { n as resolveCronStyleNow } from "../../current-time-KMiitmWe.js";
import { t as resolveMemorySearchConfig } from "../../memory-search-DvxYo9Gp.js";
import { t as definePluginEntry } from "../../plugin-entry-CCu4Tzpv.js";
import "../../memory-core-host-runtime-core-D8qOhcKN.js";
import { t as resolveMemoryBackendConfig } from "../../backend-config-Yi9pgA-Q.js";
import "../../memory-core-host-runtime-files-DbLB62JD.js";
import { t as registerShortTermPromotionDreaming } from "../../dreaming-Dx-9A1AL.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-WQSiw7nK.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CTuCLPtV.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-nXsknBN4.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-CYGu6Xxw.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-CzMmKVBl.js");
