...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-DdvF1onI.js";
import { u as readConfigFileSnapshot } from "./io-CINDrze3.js";
import "./config-BpFERVfB.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-mlIa5m7u.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-yEVB3Tk9.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
