...
import { T as getCompactionProvider } from "./loader-CqJY7arZ.js";
...
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-DMwZgnl2.js";
...
import { D as isCacheEnabled, O as resolveCacheTtlMs, T as createExpiringMapCache, t as loadSessionStore } from "./store-load-D4UxZlJL.js";
...
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-DejgqaRd.js";
import { m as MAX_IMAGE_BYTES } from "./mime-BjHvxzTf.js";
import { u as redactTranscriptMessage } from "./transcript-DVe7upns.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-CtwzSE49.js";
...
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-Dkg1uUrN.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-BJxHmbSD.js";
import { i as sanitizeToolCallIdsForCloudCodeAssist, n as extractToolResultId, s as hasUnredactedSessionsSpawnAttachments, t as extractToolCallsFromAssistant } from "./tool-call-id-BaLDpm69.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-VcblLnzc.js";
import { d as setReplyPayloadMetadata } from "./reply-reference-Cwph674D.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BxAqgm8A.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-CJM3mFkO.js";
...
import { t as filterHeartbeatPairs } from "./heartbeat-filter-CkEfqgW5.js";
import { A as isEmbeddedMode, O as isStrictAgenticSupportedProviderModel, k as stripProviderPrefix, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-ClhGmLV5.js";
...
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-C4-MXeIm.js";
import { i as getPluginToolMeta } from "./tools-BX-_BiwW.js";
import { n as redactConfigObject } from "./redact-snapshot-DOFJIUXS.js";
import { t as resolveCommitHash } from "./git-commit-CaW4-SLf.js";
import { t as resolveOsSummary } from "./os-summary-DHvqMKPU.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-x5y5OZBw.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-DYpz0c0Z.js";
import { d as parseBooleanValue } from "./frontmatter-tuMF0h7h.js";
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-CDKDQaXK.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-B9GxFxq7.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-CHKI6cHH.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-DolNNrl-.js";
import { _ as listChannelSupportedActions, b as resolveChannelReactionGuidance, v as resolveChannelMessageToolHints, y as resolveChannelPromptCapabilities } from "./pi-tools.before-tool-call-DwDZAiUV.js";
import { r as optionalStringEnum } from "./typebox-BCNP5mx9.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-DbZAMoVQ.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-CjLkX4q8.js";
...
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-DWRjOcWY.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-_FSXnKX8.js";
import { l as buildApiErrorObservationFields, s as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-HyrsK6KA.js";
import { t as log$5 } from "./logger-SygyosNn.js";
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-BAUJw7N3.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-CvDqNMzI.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BxguvEfz.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-Cn18Q53L.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-ChpufXpk.js";
import { t as resolveAgentTimeoutMs } from "./timeout-nqZIJh2Q.js";
import { n as buildSubagentList } from "./subagent-list-CBGpKQvS.js";
import { o as listControlledSubagentRuns } from "./subagent-control-Cv7u-jBW.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, s as resolveAgentPromptSurfaceForSessionKey, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-DfZmg8gh.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-Bw13LFXV.js";
...
import { s as buildCopilotIdeHeaders } from "./provider-auth-BvT107_A.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-Csu9XZDc.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-DOCpCPod.js";
import { o as resolveSandboxContext } from "./sandbox-DmQJncCf.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-D1ovfmlS.js";
import { t as detectRuntimeShell } from "./shell-utils-DVxcRJBZ.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-BznoBypi.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-Bfp9Et_1.js";
import "./skills-BE5O5-5i.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-D8UP6sS1.js";
import "./tool-loop-detection-BtEL7VEP.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible, a as createCodexNativeWebSearchWrapper } from "./proxy-stream-wrappers-GFeLarVw.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DYLuaDbk.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-ySJaVHRJ.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-BdCn2dMQ.js";
import { t as extractSections } from "./post-compaction-context-BrbsPqFJ.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-Dm2nXbH4.js";
import "./query-D-fAeCKf.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-8S-kNben.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-D5qKr8rq.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-DlWxdfLM.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-DnNvrM4_.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-CLfeRghP.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-D5dbiHJo.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-BjluZcnK.js";
import { t as detectAndLoadPromptImages } from "./images-CkzE6qUi.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-CU1NdX72.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-BzTNiU5F.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-D86U5W1n.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-yg5apDL5.js"));
