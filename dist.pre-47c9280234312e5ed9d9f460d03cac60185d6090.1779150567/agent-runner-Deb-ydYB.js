...
import { c as updateSessionStoreEntry, s as updateSessionStore } from "./store-DejgqaRd.js";
...
import { a as resolveContextTokensForModel } from "./context-Bzj6l_IR.js";
...
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-CtwzSE49.js";
import { t as spawnSubagentDirect } from "./subagent-spawn-DE36eEJy.js";
...
import { a as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-D1ebGGuR.js";
...
import { r as enqueueCommitmentExtraction } from "./runtime-CQSNeKDR.js";
...
import { r as resolveLiveContinuationRuntimeConfig } from "./config-8c1TJN-t.js";
...
import { t as formatProviderModelRef } from "./model-runtime-DEzTih2f.js";
import "./fallback-notice-state-DmFKynvO.js";
import { a as copyReplyPayloadMetadata, d as setReplyPayloadMetadata, o as getReplyPayloadMetadata, r as appendReplyMediaFailureWarning, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-Cwph674D.js";
...
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-CokNqnDR.js";
import { r as runWithModelFallback } from "./model-fallback-HyrsK6KA.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-CvDqNMzI.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-2TZz9oSB.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-ChFRxxYF.js";
import { i as isRenderablePayload, n as applyReplyThreading } from "./reply-payloads-X_aytu3k.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-BYTsKR8h.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BVB-I5Z7.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-V7r3ggKx.js";
import "./sandbox-DmQJncCf.js";
import { n as readPostCompactionContext } from "./post-compaction-context-BrbsPqFJ.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-C9RXXNYJ.js";
import { a as resolveReplyRunFireReason, c as runCliAgentWithLifecycle, i as runAgentTurnWithFallback, n as resolveRunAfterAutoFallbackPrimaryProbeRecheck, o as normalizeReplyPayloadDirectives, r as resolveSessionRuntimeOverrideForProvider, t as buildKnownAgentRunFailureReplyPayload } from "./agent-runner-execution-6ECzp6cB.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-COWLDTzm.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BqdQkcCx.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-DCqABZ01.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-Bfpb0_5l.js";
import { n as incrementCompactionCount } from "./session-updates-fYJXpIZ7.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-CHUkikI8.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-MsNA5rQA.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-DrY_nsxX.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-D7vGRg2s.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-CAbjyH0E.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-_GLN_K8b.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-BD0Cc4Hr.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-CLelzKIg.js"));
		...
		try {
							...
							const result = await runEmbeddedPiAgent({
								...
								requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
									...
									triggerCompaction: async (request) => {
										try {
											const { compactEmbeddedPiSession } = await import("./compact.queued-C0ezJdrd.js");
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BIruEzoM.js"),
					import("./config-CQnRo2HL.js"),
					import("./state-Dt-L5RIQ.js"),
					import("./store-gV58Wb8A.js")
				]);
