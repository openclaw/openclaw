...
import { s as resolveRuntimeServiceVersion } from "./version-DmRkhYua.js";
import { t as normalizeArrayBackedTrimmedStringList } from "./string-normalization-DgUPESoD.js";
import { n as createDiagnosticTraceContext, o as runWithDiagnosticTraceContext } from "./diagnostic-trace-context-5yrj1tXL.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-CQP-kC3g.js";
import { i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-CbQEMrWm.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-0uXHmmHu.js";
import { i as getRuntimeConfig } from "./io-CINDrze3.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-YAlHXP_O.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BNv08iCR.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-DJtqYoTD.js";
import { c as GATEWAY_STARTUP_PENDING_CLOSE_CAUSE, d as buildDeviceAuthPayloadV3, l as gatewayStartupUnavailableDetails, o as GATEWAY_STARTUP_CLOSE_CODE, s as GATEWAY_STARTUP_CLOSE_REASON, u as buildDeviceAuthPayload } from "./client-D80gnOaX.js";
import { t as rawDataToString } from "./ws-DiQx3WFe.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-nqH9B-aI.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-Bir04kfe.js";
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-Crpoog51.js";
import "./version-1aMNfFel.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-D5DA_QCa.js";
import "./method-scopes-DfV0ICXA.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-KD7pf53L.js";
import { l as roleScopesAllow } from "./pairing-token-D01V6DO_.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-1uC6FD0i.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-CZDc7iBw.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-DfTY7DRk.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-Cctll6Ef.js";
import { n as logWs, t as formatForLog } from "./ws-log-B_AmWiW1.js";
import { a as restoreDeviceBootstrapToken, c as verifyDeviceBootstrapToken, i as redeemDeviceBootstrapTokenProfile, n as getDeviceBootstrapTokenProfile, o as revokeDeviceBootstrapToken } from "./device-bootstrap-I5Mrq6PY.js";
import { _ as verifyDeviceToken, c as listDevicePairing, f as requestDevicePairing, g as updatePairedDeviceMetadata, i as getPairedDevice, l as listEffectivePairedDeviceRoles, n as ensureDeviceToken, o as hasEffectivePairedDeviceRole, s as listApprovedPairedDeviceRoles, t as approveDevicePairing } from "./device-pairing-C3kNjdGc.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-jwr3-rxV.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-CAyIk_EP.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-B4Cgylo8.js";
import { r as upsertPresence } from "./system-presence-ltLSqZ2f.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-B7hNMm25.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CuBRaNDD.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-lgaP-Nqk.js";
import { t as truncateCloseReason } from "./close-reason-CgdYMc-r.js";
...
function shouldAllowSilentLocalPairing(params) {
	...
	if (params.hasBrowserOriginHeader) return false;
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
				...
				if (device && devicePublicKey) {
					...
					const requirePairing = async (reason, existingPairedDevice = null) => {
						...
						const pairing = await requestDevicePairing({
							...
							silent: reason === "scope-upgrade" ? false : allowSilentLocalPairing || allowSilentTrustedCidrsNodePairing
						});
						...
						if (pairing.request.silent === true) {
							approved = await approveDevicePairing(pairing.request.requestId, { callerScopes: scopes });
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-BZ3iPMSD.js");
