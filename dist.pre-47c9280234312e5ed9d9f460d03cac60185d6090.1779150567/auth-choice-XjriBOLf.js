...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-BZNVICOw.js";
import { n as loadModelCatalog } from "./model-catalog-DvMN6T_J.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-IcYfM0XZ.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-Dw6m8fGJ.js";
import "./provider-auth-choice-preference-CpxaW0yz.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-C6BUfvQa.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-BSZbsVxv.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-Dprb43Zf.js");
