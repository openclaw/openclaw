...
type MessagePresentationButton = {
  ...
  disabled?: boolean; /** Optional visual style hint; unsupported channels ignore or normalize it. */
...
//#endregion
export { MessagePresentationInteractiveBlock as A, hasReplyContent as B, MessagePresentation as C, MessagePresentationButtonsBlock as D, MessagePresentationButtonStyle as E, ReplyPayloadDelivery as F, presentationToInteractiveControlsReply as G, isMessagePresentationInteractiveBlock as H, ReplyPayloadDeliveryPin as I, resolveInteractiveTextFallback as J, presentationToInteractiveReply as K, hasInteractiveReplyBlocks as L, MessagePresentationSelectBlock as M, MessagePresentationTextBlock as N, MessagePresentationContextBlock as O, MessagePresentationTone as P, hasMessagePresentationBlocks as R, InteractiveReplyTextBlock as S, MessagePresentationButton as T, normalizeInteractiveReply as U, interactiveReplyToPresentation as V, normalizeMessagePresentation as W, PromptImageOrderEntry as Y, InteractiveReply as _, QueuedReplyDeliveryCorrelation as a, InteractiveReplyOption as b, SourceReplyDeliveryMode as c, ReplyPayloadTtsSupplement as d, buildTtsSupplementMediaPayload as f, InteractiveButtonStyle as g, markReplyPayloadAsTtsSupplement as h, PartialReplyPayload as i, MessagePresentationOption as j, MessagePresentationDividerBlock as k, TypingController as l, isReplyPayloadTtsSupplement as m, ContinuationTrigger as n, QueuedReplyLifecycle as o, getReplyPayloadTtsSupplement as p, renderMessagePresentationFallbackText as q, GetReplyOptions as r, ReplyThreadingPolicy as s, BlockReplyContext as t, ReplyPayload as u, InteractiveReplyBlock as v, MessagePresentationBlock as w, InteractiveReplySelectBlock as x, InteractiveReplyButton as y, hasReplyChannelData as z };