...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-Cv41idc1.js";
import "./channel-message-BRLoIsXC.js";
import "./text-autolink-runtime-Cz-SsjyL.js";
import { t as require_src } from "./src-CXOgJA98.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-CG9zHALv.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CLP8qd8D.js";
import { t as getMatrixRuntime } from "./runtime-DNrUP3D9.js";
import { r as buildMatrixReactionContent } from "./reaction-common-DmyDACbJ.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-ZIQuBDyb.js";
import { t as fromBuffer } from "./lib-XnVjzBJb.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-dzAxUCtk.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BUaptFAH.js";
import { l as toRatio, n as decodeString } from "./Util-DST2ftI-.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-C-0m8A2O.js";
import { t as APEv2Parser } from "./APEv2Parser-uZdIfybN.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DBj-vcMc.js";
import { i as isStrictDirectRoom } from "./direct-room-DYWfIUDY.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-CwgwDGti.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-ClegnMI6.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-D98J1fTn.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-TiHJQ-aV.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-QWOCjqB0.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CZy3Un0e.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-1Nt-0G18.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-C_bpV9qm.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Cl5RCSL6.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-FsBFQSsW.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Df4dES46.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Ze5LQOJf.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BV3sErSo.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-C6Ln6i7t.js")).WaveParser;
	}
};
//#endregion
