...
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-DxdqJz8n.js";
import { i as replaceConfigFile } from "./mutate-BCdnM3Sq.js";
import "./config-CddmOexD.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-Gu3TyUrf.js";
...
import "./message-channel-B9xZ12q8.js";
import { i as callGateway } from "./call-Ch2fB07i.js";
import { i as getBundledChannelSetupPlugin } from "./bundled-DU2aLv7r.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BDy7VEax.js";
import "./plugins-BwY4oKrD.js";
import "./logging-DEMPYKjw.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-C6B1imhd.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-DdRRk2wx.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CAmYkjAt.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-DPsLTTfB.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BELDHN77.js";
import { t as WizardCancelledError } from "./prompts-BDlju8KH.js";
import { t as createClackPrompter } from "./clack-prompter-BoinKWL1.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-CelW4dQz.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-Ba-NEln8.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-wTFUWOz1.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CM9jSVRc.js";
import { n as resolveLogFile } from "./log-tail-D6flqQ1h.js";
import { t as parseLogLine } from "./parse-log-line-DukR7wdZ.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-CT3CUYdm.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-COqg5oe4.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-Dv6WI1eE.js";
import { t as channelsListCommand } from "./list-DIJCRNwh.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-hfQB3tdT.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-2-UCYW5-.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BGU-nZhH.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-GIUPVbTL.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-3Ydq_xaC.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-COvLwaPh.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-DWP2YRP3.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-BmT3Gkdy.js");
