...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-s2J_SeIG.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BpeFVMP3.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-BOvQU86k.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-BmFyFWYe.js";
import { t as providerSupportsCapability } from "./provider-supports-CJ3N9uQw.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CH0HPlFY.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-B8QBEym2.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CykSxu4x.js";
import { t as buildRandomTempFilePath } from "./temp-download-BPrVIPls.js";
import "./temp-path-Cizku8_A.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-MszWnoXF.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-CwKHZJVA.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-MEC6s9Zn.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-DF2Lhr8c.js");
