...
import { r as buildConfiguredModelCatalog, s as hasConfiguredProviderModelRows, w as modelSupportsInput } from "./model-selection-shared-D-NMyYXW.js";
...
function loadReadOnlyStaticModelCatalog(params) {
	...
	const configuredModels = buildConfiguredModelCatalog({
		cfg,
		manifestPlugins: hasConfiguredProviderRowsNeedingManifestLookup(cfg) ? loadPluginMetadataSnapshot({
			config: cfg,
			env: process.env
		}).plugins : []
	});
