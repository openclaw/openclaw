...
import { n as LogService } from "./logger-ClbVzmrZ.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-DALM-xEc.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-DpcCIrHM.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-EWawP8N5.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
