...
import { f as markDiagnosticSessionProgress } from "./diagnostic-CtRNdYJs.js";
import { a as toAcpRuntimeError } from "./errors-xHDsvJP6.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-zqp8c40e.js";
import { o as generateSecureUuid } from "./secure-random-BlwDsoUi.js";
import { c as markReplyPayloadAsTtsSupplement } from "./reply-reference-5lfRIcWs.js";
import { s as hasOutboundReplyContent } from "./reply-payload-Cx3id63H.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-Ds5WTlsB.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CXXHy-y4.js";
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-CvSQGsMN.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-I9qgE8XA.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-CIDZ_DCu.js";
...
import { t as hasInboundMedia } from "./inbound-media-ChwSeqLi.js";
import { r as prefixSystemMessage } from "./system-message-BwxIBjbC.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-DMeWGpnx.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-XLDrmc93.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-CcFaTlAY.js";
...
async function resolveAgentTurnAttachments(params) {
	...
	if (!currentImageResolved && (!hasCurrentMedia || hasCurrentImageCandidate)) for (const attachment of historyAttachments) await resolveImageAttachment(attachment);
	return {
		attachments: results,
...
const channelPluginRuntimeLoader = createLazyImportLoader(() => import("./plugins-Bm8oXo10.js"));
const messageActionRuntimeLoader = createLazyImportLoader(() => import("./message-action-runner-Dcu_rHyM.js"));
