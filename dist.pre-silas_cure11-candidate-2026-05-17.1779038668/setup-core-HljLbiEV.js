...
import { u as prepareScopedSetupConfig } from "./setup-helpers-BELDHN77.js";
import "./setup-DJSz_jyO.js";
import { a as resolveMatrixAccountConfig } from "./account-config-NMdC91jF.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-CPysNHum.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-DnmaS5VN.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Cdwt61yT.js";
import { n as updateMatrixAccountConfig } from "./config-update-CFVLWTR9.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DnLHUL9_.js");
