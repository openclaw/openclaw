...
import { i as markdownToIR, n as renderMarkdownWithMarkers } from "./tables-CAZXQvLE.js";
import { a as readChannelAllowFromStore } from "./pairing-store-CEZUwm53.js";
import { a as parseAccessGroupAllowFromEntry, i as mergeDmAllowFromSources, n as firstDefined, r as isSenderIdAllowed } from "./allow-from-DEV0rzrn.js";
import "./conversation-runtime-BapgCzE6.js";
import { r as renderMarkdownIRChunksWithinLimit } from "./chunk-items-BD63a_k_.js";
import { n as isAutoLinkedFileRef, t as FILE_REF_EXTENSIONS_WITH_TLD } from "./auto-linked-file-ref-CyB-Nlhp.js";
import "./text-chunking-BdRhujLD.js";
import "./security-runtime-ABjFIZME.js";
import { t as expandAllowFromWithAccessGroups } from "./access-groups-Q9HAuS1W.js";
import "./command-auth-native-mZCFgDWC.js";
import "./channel-inbound-Cs1W7zVE.js";
import { t as formatLocationText } from "./location-CHTOIOme.js";
import { t as resolveTelegramPreviewStreamMode } from "./preview-streaming-CJ_HvvER.js";
...
//#endregion
export { buildSenderLabel as A, expandTelegramAllowFromWithAccessGroups as B, resolveTelegramForumThreadId as C, resolveTelegramThreadSpec as D, resolveTelegramStreamMode as E, hasBotMention as F, resolveTelegramEffectiveDmPolicy as G, isSenderAllowed as H, isBinaryContent as I, parseTelegramThreadId as J, normalizeTelegramReplyToMessageId as K, normalizeForwardedContext as L, expandTextLinks as M, extractTelegramLocation as N, shouldUseTelegramDmThreadSession as O, getTelegramTextParts as P, resolveTelegramMediaPlaceholder as R, resolveTelegramForumFlag as S, resolveTelegramReplyId as T, normalizeAllowFrom as U, resolveTelegramDmAllow as V, normalizeDmAllowFromWithStore as W, extractTelegramForumFlag as _, renderTelegramHtmlText as a, resolveTelegramCommandAuthorization as b, wrapFileReferencesInHtml as c, buildTelegramGroupPeerId as d, buildTelegramParentPeer as f, describeReplyTarget as g, buildTypingThreadParams as h, markdownToTelegramHtmlChunks as i, buildSenderName as j, withResolvedTelegramForumFlag as k, buildGroupLabel as l, buildTelegramThreadParams as m, markdownToTelegramChunks as n, splitTelegramHtmlChunks as o, buildTelegramRoutingTarget as p, parseTelegramReplyToMessageId as q, markdownToTelegramHtml as r, telegramHtmlToPlainTextFallback as s, escapeTelegramHtml as t, buildTelegramGroupFrom as u, isTelegramCommandsAllowFromConfigured as v, resolveTelegramGroupAllowFromContext as w, resolveTelegramDirectPeerId as x, resetTelegramForumFlagCacheForTest as y, resolveTelegramPrimaryMedia as z };
