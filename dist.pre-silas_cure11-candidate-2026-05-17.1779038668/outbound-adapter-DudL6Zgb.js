...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-Cx3id63H.js";
...
import { m as DiscordError } from "./discord-BOCGVLrF.js";
import { t as chunkDiscordTextWithMode } from "./chunk-Bk1ZMJj3.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-CzyeXHKW.js";
import { t as createDiscordSendReceipt } from "./send.receipt-hkzJfQbi.js";
import { s as readDiscordComponentSpec } from "./components-DId2Dibu.js";
import { n as notifyDiscordInboundEventOutboundPayloadSuccess } from "./inbound-event-delivery-D6rLureX.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-BTS83Ljm.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-B-BTgYIu.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-KukqYSsY.js");
