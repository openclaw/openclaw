...
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-CjXv1zM-.js";
...
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-DxdqJz8n.js";
...
import { o as transformConfigFileWithRetry } from "./mutate-BCdnM3Sq.js";
...
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-DD_XDFb-.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-BwA2H4Ph.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-DeZOWwm4.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-OGWeRbnz.js";
...
import "./diagnostic-CtRNdYJs.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-CFFwo_Of.js";
import { a as getActiveEmbeddedRunSnapshot, d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary, o as isEmbeddedPiRunActive, p as resolveActiveEmbeddedRunSessionId } from "./runs-DJy1UN9B.js";
import { n as ensureOpenClawModelsJson } from "./models-config-2UUMeHDV.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-DjQcCpJ_.js";
...
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-D0C_A1Bp.js";
import { i as selectAgentHarness, n as resolveAvailableAgentHarnessPolicy } from "./selection-DGkFQnDs.js";
import { t as formatDurationCompact } from "./format-duration-CGB27P5d.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-BFheRno4.js";
...
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-sRFflRVk.js";
import { a as clearSessionQueues } from "./queue-B_zvD5C4.js";
import { i as resolveReplyToMode } from "./reply-threading-Ds7N3H_W.js";
import { n as routeReply } from "./route-reply-B4nSTq2h.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-DWm_E9mv.js";
...
import { a as stripToolResultDetails } from "./session-transcript-repair-DyqIu5dy.js";
import "./sandbox-BNe95-oa.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-ceUG4mIn.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-D9-DG02Q.js";
import { n as formatTimeAgo } from "./format-relative-CdmdH_x_.js";
import { r as resolveModelWithRegistry } from "./model-BY1lmHLz.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-CRdIgD7B.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-D5wdh8wI.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-BTVlZ42y.js";
import "./commands-registry-CdZhpJXU.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-DgpyFKKg.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-DKm_m5sy.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CFcwWSGZ.js";
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-B6bZe4av.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-CEZUwm53.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-6kNx6xGl.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-Cq5NN7vq.js";
import { n as parseActivationCommand } from "./group-activation-B2XphbyD.js";
import { t as resolveFastModeState } from "./fast-mode-DYdFn138.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CK_jpwm6.js";
import { t as extractExplicitGroupId } from "./group-id-Bi6GhE9G.js";
import { t as formatElevatedUnavailableMessage } from "./elevated-unavailable-e5Rc7uSA.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CDD7IcXK.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-6sGu36AQ.js";
import { t as extractBtwQuestion } from "./btw-command-USN5q-3R.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-DcqIKv92.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-3YJSYAhn.js";
import { t as handleAcpCommand } from "./commands-acp-B5rVpmbT.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-D2iJAbpz.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BBrK32pv.js";
import { r as handleModelsCommand } from "./commands-models-P7o9eFYJ.js";
import { r as createExecTool } from "./bash-tools-BAtP7WYH.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-3toR5aTf.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-1n8KMkU2.js";
import { t as buildToolsMessage } from "./status-CbbhLegu.js";
...
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-DRXEHVKZ.js";
import "./command-export-DeVs16ed.js";
import { t as buildStatusReply } from "./commands-status-DNMxq_R2.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-D7AmfZHh.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-y64Utb8E.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-ClC7vrHo.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-COT55ttW.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-CUPOSUlk.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-Ba-NEln8.js";
import "./clawhub-CByCeaXg.js";
import { r as installPluginFromClawHub } from "./clawhub-DUyvuNBt.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-t65uvVGD.js";
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-ivWyK3dW.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-sXKSmP1L.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-0ERX7O5b.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-VSpOvCsQ.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-Dtk7aELh.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-DYqplA9S.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-DrwQbRhv.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-dw-2hRTd.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-DbdFkjEH.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-Bpb6Jr54.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-ByEIc0wH.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-tvJYwssc.js"));
