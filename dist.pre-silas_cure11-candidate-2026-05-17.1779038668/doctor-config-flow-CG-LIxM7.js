...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-DxdqJz8n.js";
...
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-ChUSXMmn.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BW_RZ8_W.js";
import { t as note } from "./note-B7V1z9JE.js";
import { t as asObjectRecord } from "./object-DugGaggr.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CaoNAP46.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-DiIOTwyq.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BfTLPnYL.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-B5XgSxPY.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-Gqxxvy1v.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DxzOnQbf.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-LOKGX3wA.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-DyB4yF68.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-C6tb5jic.js");
		emitDoctorNotes({
			note,
