...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-BylJ5ImC.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CEUutO2W.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-CRwWRdcg.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-DACdTCax.js");
	if (params.argv) {
