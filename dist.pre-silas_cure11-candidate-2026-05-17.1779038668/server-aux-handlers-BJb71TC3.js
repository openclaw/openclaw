...
import { t as resolveChannelApprovalAdapter } from "./plugins-BwY4oKrD.js";
...
import { a as getActiveSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeEnv, t as activateSecretsRuntimeSnapshot } from "./runtime-6yWo28i6.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-V9FHnVRG.js";
...
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-CjeNSzbs.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-5uqIXxiw.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DG2KN7OZ.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-R72ADz20.js";
...
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-BaPCxDid.js";
...
import "./server-aux-methods-BDNVM6SG.js";
...
function filterInactiveRefPathsForProviderOverrides(params) {
	if (!hasProviderOverrides(params.providerOverrides)) return [...params.inactiveRefPaths];
	return params.inactiveRefPaths.filter((path) => !isProviderOverridePath({
		config: params.config,
		path,
		providerOverrides: params.providerOverrides
	}));
...
async function resolveCommandSecretsFromSnapshot(params) {
	...
	if (analyzed.unresolved.filter((entry) => isProviderOverridePath({
		config: sourceConfig,
		path: entry.path,
		providerOverrides: params.providerOverrides
	})).length > 0) return {
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-DVey9ROR.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-07TPQbhE.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-BqlcWk4S.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
