import { t as validateJsonSchemaValue } from "./schema-validator-wgurAMJR.js";
import "./json-schema-runtime-B2efwrLr.js";
import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-DK0WQxTZ.js";
import { c as resolveCodexAppServerRuntimeOptions } from "./config-7bwgBYbm.js";
import { i as assertCodexTurnStartResponse, l as readCodexTurnCompletedNotification, o as readCodexErrorNotification, r as assertCodexThreadStartResponse } from "./protocol-validators-BmHY9x94.js";
import { r as readModelListResult } from "./models-C6wwOEgk.js";
...
async function runBoundedCodexVisionTurn(params) {
	...
	const client = params.options.clientFactory ? await params.options.clientFactory(appServer.start, params.profile) : await import("./shared-client-CJUmBOBB.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
