...
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-BwA2H4Ph.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-DQ_05Gif.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-DIJuQKvY.js";
import { n as loadModelsConfigWithSource } from "./load-config-BywezyNj.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-TxNDtzqi.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-BI1LAHWE.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BYUBVOqU.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-YAd-Ujwh.js"),
		import("./agent-scope-Cfm19yoq.js"),
		import("./workspace-DpgSJqqn.js")
	]);
