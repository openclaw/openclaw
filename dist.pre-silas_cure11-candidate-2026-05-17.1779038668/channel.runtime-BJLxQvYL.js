...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout } from "./reply-payload-Cx3id63H.js";
import { f as renderMessagePresentationFallbackText } from "./payload-MntxVKMU.js";
...
import { a as sendMessageMatrix, l as sendTypingMatrix, o as sendPollMatrix } from "./send-CbsTk171.js";
import { t as isBunRuntime } from "./runtime-CBg6D_3E2.js";
import { n as resolveMatrixAuth } from "./config-DpcCIrHM.js";
import "./client-EsqsTmCz.js";
import { n as listMatrixDirectoryPeersLive, t as listMatrixDirectoryGroupsLive } from "./directory-live-CQbvjsMq.js";
import "./runtime-api-CA_lMnSX.js";
import { t as resolveMatrixTargets } from "./resolve-targets-DLoz0HPH.js";
//#region extensions/matrix/src/matrix/probe.ts
let matrixProbeRuntimeDepsPromise;
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-rZwJz2rG.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));
