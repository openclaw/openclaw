...
import { i as resolveHumanDelayConfig, r as resolveEffectiveMessagesConfig } from "./identity-BhKo4rWR.js";
import { J as ReadSessionUpdatedAt$1, X as UpdateLastRoute$1, Y as RecordSessionMetaFromInbound$1, o as PluginRuntimeCore } from "./types-core-BqOguxg5.js";
import { m as resolveStorePath } from "./store-Dv1fpnmG.js";
import { _ as resolveChunkMode, f as chunkByNewline, g as chunkTextWithMode, h as chunkText, m as chunkMarkdownTextWithMode, n as ChannelOutboundAdapter, p as chunkMarkdownText, v as resolveTextChunkLimit } from "./outbound.types-GcP9rxun.js";
import { n as ReplyDispatcher } from "./reply-dispatcher.types-DalfsoUI.js";
import { s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-3bE8Hjrh.js";
import { i as MatchesMentionWithExplicit$1, r as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-B_FmK5xB.js";
import { n as RecordInboundSession$1 } from "./session.types-BtpSDmTm.js";
import { c as SessionBindingRecord } from "./session-binding.types-D7L1IaIY.js";
import { t as hasControlCommand } from "./command-detection-C4q79R19.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-BgxBTBhV.js";
import { t as convertMarkdownTables } from "./tables-C_K8NMkq.js";
import { n as DispatchReplyFromConfig } from "./dispatch-from-config.types-DrKHlARb.js";
import { t as finalizeInboundContext } from "./inbound-context-D3TmevZV.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-4pltNxAh.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-iznC6oTx.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-Dk62gWjI.js";
import { t as buildPairingReply } from "./pairing-messages-vsz_kX8r.js";
import { p as saveMediaBuffer } from "./store-9SHEa1J8.js";
import { d as readRemoteMediaBuffer, f as saveRemoteMedia, p as saveResponseMedia, u as fetchRemoteMedia } from "./fetch-CvmcaExb.js";
import { n as getChannelActivity, r as recordChannelActivity } from "./channel-activity-Cnzt2siN.js";
import { f as implicitMentionKindWhen, p as resolveInboundMentionDecision } from "./mention-gating-Y-5fsO7u.js";
import { a as createAckReactionHandle, c as shouldAckReaction, o as removeAckReactionAfterReply, s as removeAckReactionHandleAfterReply } from "./ack-reactions-DbeAWkT6.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-DGZv_pOI.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-CBAeaWUp.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-BLcbqgCR.js";
import { o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-D3C7wHP5.js";
import { r as buildChannelInboundEventContext } from "./context-CgWm9DUU.js";
import { a as runPreparedChannelTurn, i as runChannelTurn, o as runResolvedChannelTurn, t as dispatchAssembledChannelTurn } from "./kernel-ghkcvEm7.js";
