...
import { T as getCompactionProvider } from "./loader-vCTqpi_M.js";
...
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-C8sV72BT.js";
...
import { D as isCacheEnabled, O as resolveCacheTtlMs, T as createExpiringMapCache, t as loadSessionStore } from "./store-load-lvssy8TE.js";
...
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-BqYSXyaO.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DWfYSjGf.js";
import { u as redactTranscriptMessage } from "./transcript-DeZOWwm4.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-DJy1UN9B.js";
...
import { u as setReplyPayloadMetadata } from "./reply-reference-5lfRIcWs.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Cx3id63H.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-D0C_A1Bp.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-DiFLYv2n.js";
import { A as isEmbeddedMode, O as isStrictAgenticSupportedProviderModel, k as stripProviderPrefix, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-Dl4PTN81.js";
...
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CGM3ApNj.js";
...
import { t as resolveOsSummary } from "./os-summary-BQ_216I7.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-BjXcohhm.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-CT9MDqk7.js";
import { d as parseBooleanValue } from "./frontmatter-DHFfn4kq.js";
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-DpxY17Y8.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DuUxZXiF.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-rtTujMCL.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-Cm0BVF8A.js";
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, v as resolveChannelPromptCapabilities, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-KAp9b0Qw.js";
import { r as optionalStringEnum } from "./typebox-Buv3OLmV.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-CteiaGpy.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-FjdctQMa.js";
...
import { r as parseFenceSpans } from "./fences-CAXFPbls.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-C-j7wcka.js";
...
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-56zGcXcS.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CXXHy-y4.js";
import { f as buildApiErrorObservationFields, p as buildTextObservationFields } from "./model-fallback-BaTZ2syz.js";
import { t as log$5 } from "./logger-D1EcQdNR.js";
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-judQRk70.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-BS569JHN.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DRJ9jYAs.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-DKMVwH1U.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-u5M7SmQq.js";
...
import { o as listControlledSubagentRuns } from "./subagent-control-CS95F2sk.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-D54RJdSn.js";
...
import { s as buildCopilotIdeHeaders } from "./provider-auth-CFF9dk4g.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-Dg21eCNJ.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-DyqIu5dy.js";
import { o as resolveSandboxContext } from "./sandbox-BNe95-oa.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-CbWRAEXG.js";
import { t as detectRuntimeShell } from "./shell-utils-B4DQtYPz.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-lr1nSzQo.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-Bxtl8bfg.js";
import "./skills-CxayVx9x.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-ceUG4mIn.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-DsHoT077.js";
import "./tool-loop-detection-D5x22fT8.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./proxy-stream-wrappers-3HFR7Bub.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CD1jCvpC.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-C0yz2kBK.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-B4fPp95Y.js";
import { t as extractSections } from "./post-compaction-context--SseJNF6.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-DKVhtAPM.js";
import "./query-CKA8KPdv.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-ChUSXMmn.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-CfsVLKK-.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-ugGasKG5.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-BOjoZ_dJ.js";
...
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-WDcnkigc.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DfuCypi5.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-C2qrURy4.js";
import { t as detectAndLoadPromptImages } from "./images-LCjx9m8-.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-CVPAgREN.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-rGv5xSqb.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-CnjzvSge.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-Cd3koBkt.js"));
