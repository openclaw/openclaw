...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-BFJgB0Tb.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-B9WpqK9E.js";
import { a as resolveSecretRefValue } from "./resolve-CmLbiGKO.js";
import { n as info, o as success, t as danger } from "./globals-Cnlrc0S3.js";
import { U as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot, w as validateConfigObjectRawWithPlugins, x as collectUnsupportedSecretRefPolicyIssues } from "./io-DxdqJz8n.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-BTP4B7ls.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-Gu3TyUrf.js";
import { n as redactConfigObject } from "./redact-snapshot-CDekM8PH.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BUUZfR0p.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-O2p9btFY.js";
import { n as setCommandJsonMode } from "./json-mode-BFK5wYxv.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CuDAPGye.js");
