...
import { r as theme, t as colorize } from "./theme-CStEj1vt.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-DRikErcl.js";
import { t as sameFileIdentity } from "./file-identity-PAmF0zvV.js";
import { _ as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeSystemdServiceName, y as resolveNodeWindowsTaskName } from "./paths-DySiDD2J.js";
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-dPS3MUSb.js";
import { n as VERSION } from "./version-B2G3zXnp.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-DL56_OdV.js";
...
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-6GBG3wLv.js";
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-DJ7ha6z1.js";
import { a as logWarn } from "./logger-xPcOTHDV.js";
import { i as getRuntimeConfig } from "./io-DxdqJz8n.js";
import { f as resolveApprovalAuditTrustPath, m as resolveCommandResolutionFromArgv, w as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-IrNaZViN.js";
import { O as normalizeExecutableToken, S as unwrapKnownDispatchWrapperInvocation, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, g as resolveInlineCommandMatch, k as splitShellArgs, l as isShellWrapperInvocation, p as advancePosixInlineOptionScan, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, v as extractEnvAssignmentKeysFromDispatchWrappers } from "./shell-wrapper-resolution-BOPTchHQ.js";
import "./config-CddmOexD.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-Gu3TyUrf.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints--ObtdCLg.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BAzKvPEC.js";
import { t as parsePort } from "./parse-port-DKhXVTFA.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-CR5QKoIG.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-wu-8nEST.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-C14z2rxK.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-UWAL5IS6.js";
import { a as getActivePluginRegistry } from "./runtime-C8sV72BT.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-DRObnTBd.js";
import { t as getMachineDisplayName } from "./machine-name-BiiUDOPC.js";
import { c as describeInterpreterInlineEval } from "./risks-Dq8q36kg.js";
import { c as analyzeArgvCommand, d as buildSafeBinsShellCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-B7EgQNWr.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-Btea9qTD.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-UZuCStN0.js";
import { t as formatHelpExamples } from "./help-format-CdadU27C.js";
import { n as detectPolicyInlineEval } from "./policy-nX3BfFir.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-C0goLBF7.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-DbedbdUl.js";
import { t as resolveNodeService } from "./node-service-BjEnqbQ_.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-zUrm5yMP.js");
