...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-rAd33PTP.js";
import { n as require_extend, t as require_package$1 } from "./package-DZXu8stY.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-GEl6Mggy.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-DnXkO9n1.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
