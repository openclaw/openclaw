...
import { t as ConfigMutationConflictError } from "./mutate-BCdnM3Sq.js";
...
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-D2lSZ97j.js";
...
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-GR83Cq8Z.js";
import { r as withProgress } from "./progress-C7IpeSeh.js";
import { t as WizardCancelledError } from "./prompts-BDlju8KH.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CP6a5XPn.js";
import { t as note$1 } from "./note-B7V1z9JE.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-B8-I-wxR.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-B7SmZsBi.js";
import { n as applyAuthChoice } from "./auth-choice-C0w-06fW.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-Bor9rggK.js";
import { i as setupChannels } from "./onboard-channels-thv5b6xV.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-nMWlSWbi.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BcR77yv3.js";
import { t as promptCustomApiConfig } from "./onboard-custom-CTZgTTgd.js";
...
import { n as healthCommand } from "./health-DPBmViOk.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-B9aet5tg.js";
import { t as setupSkills } from "./onboard-skills-D_6TrWwI.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-BmV362ZZ.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-CYv6L6Eq.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CKM9Cnl4.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-49f7BHAZ.js");
