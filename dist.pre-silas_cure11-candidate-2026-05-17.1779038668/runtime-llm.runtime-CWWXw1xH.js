...
import { r as normalizeModelRef } from "./model-selection-normalize-D1wAzSpK.js";
import "./model-selection-T92uY7wQ.js";
import { a as resolveModelCostConfig, n as estimateUsageCost } from "./usage-format-DjQcCpJ_.js";
...
async function resolveAgentId(params) {
	...
	const { resolveDefaultAgentId } = await import("./agent-scope-Cfm19yoq.js");
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ prepareSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-CorwtTam.js"), Promise.resolve(resolveRuntimeConfig(options))]);
