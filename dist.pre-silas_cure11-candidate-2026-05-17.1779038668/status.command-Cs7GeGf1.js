...
import { o as readRestartSentinel } from "./restart-sentinel-BO0EVNis.js";
...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-BqTIF2h5.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-eMjWXm4w.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-ChxEfpZw.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-B4vW_Ojf.js"));
const statusGatewayConnectionRuntimeLoader = createLazyImportLoader(() => import("./status.gateway-connection.runtime.js"));
const statusNodeModeModuleLoader = createLazyImportLoader(() => import("./status.node-mode-BVhq9Sro.js"));
