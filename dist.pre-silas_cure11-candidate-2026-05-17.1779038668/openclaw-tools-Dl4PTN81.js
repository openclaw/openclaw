...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-DxdqJz8n.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-DD_XDFb-.js";
...
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-vCTqpi_M.js";
...
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-lvssy8TE.js";
...
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-OGWeRbnz.js";
...
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CXaUlUtG.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-ukZWE_8u.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-CBsylqpw.js";
...
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-Bf98_Mnf.js";
import { a as resolvePluginTools } from "./tools-OO07584g.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DdRRk2wx.js";
import { d as wrapToolWithBeforeToolCallHook, g as listChannelSupportedActions, l as isToolWrappedWithBeforeToolCallHook, m as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-KAp9b0Qw.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-Buv3OLmV.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-FjdctQMa.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-fCj21SAU.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DIkhKQBs.js";
import { n as extractAssistantText } from "./pi-embedded-utils-BPp-rJKH.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-56zGcXcS.js";
import { n as runWithImageModelFallback } from "./model-fallback-BaTZ2syz.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-judQRk70.js";
import "./delivery-context-cGnh0m1Q.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BDPCgrLJ.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-6yWo28i6.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BwUXBYMW.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-CMkoT2BH.js";
...
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-BO0EVNis.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DgdwIcVS.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BvrQgat2.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-DdxAqPln.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DTI0PwJW.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BL3kacP1.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DwFNF0vD.js";
import { u as saveMediaBuffer } from "./store-aoALqUZR.js";
import { t as SsrFBlockedError } from "./ssrf-DZjn8bFZ.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-BgEZcP2n.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-DxpoNvN8.js";
import { r as getDefaultLocalRoots } from "./local-media-access-CrII2t1w.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-B-0bTlwo.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-sRFflRVk.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-BmnoP3ON.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-CRTak8Sd.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BgHw03bG.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-BI-we7Mn.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CEcwguJI.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DgVthf0T.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-BmFyFWYe.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-AUw9izGH.js";
import { s as resolveTimeoutMs } from "./resolve-CH0HPlFY.js";
import { t as buildProviderRegistry } from "./runner-BAYbc_2f.js";
import "./media-understanding-Djc6gw25.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-ffn7s1iF.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CHXTf7xx.js";
import { s as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-B_TetgOD.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-Dp6MfYG_.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-DEoLyvWI.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz--pebbZgs.js";
import { t as parseTimeoutMs } from "./parse-timeout-ZFrJWRfp.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-BPk2k07b.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BLu-srHI.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-_GfYkvIQ.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BmTV12s2.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-DGKpGyuC.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-BR6wf51l.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-Dw5r0tOm.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-g4xSnAbx.js";
import { p as registerSubagentRun } from "./subagent-registry-CGSk-LYW.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-VPM4fmFW.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-CS95F2sk.js";
import { k as textToSpeech } from "./tts-runtime-CFrTYP8N.js";
import "./tts-DrMPB9BJ.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-BUWVPbKW.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-ccYz17Pg.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-D7x_6y5N.js";
...
import { i as runWebSearch } from "./runtime-CgEgb_3J.js";
import "./web-search-provider-common-iIQzLkL6.js";
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CC9cwNCC.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-BwYwRCBg.js"));
