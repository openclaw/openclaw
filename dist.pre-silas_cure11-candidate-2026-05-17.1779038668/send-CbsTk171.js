...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-CyB-Nlhp.js";
import "./channel-message-D59fEK6f.js";
import "./text-autolink-runtime-gLDLV3fx.js";
import { t as require_src } from "./src-B07TCneS.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-CnIVLcyu.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-x0ATs8LQ.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-DUTcjiOm.js";
import { t as fromBuffer } from "./lib-CluSdxYk.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CLSl4tcq.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-D3nyW2-T.js";
import { l as toRatio, n as decodeString } from "./Util-By4u6sbk.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-B529awmo.js";
import { t as APEv2Parser } from "./APEv2Parser-CimZMXvp.js";
import { r as hasID3v1Header } from "./ID3v1Parser-_T1Ch2On.js";
import { i as isStrictDirectRoom } from "./direct-room-BR7Jbiu6.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-kayYHCvX.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-f58qgsBh.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CM6mopwg.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BdGa5xxf.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CRFDznxf.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-Dn7Ljo3s.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-4ukDupuA.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DF_-cUh2.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-vziSyQKO.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DG0LAmG_.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-COUqhF7X.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DG788CKV.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-5kIyVzEq.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-C4FbR9xC.js")).WaveParser;
	}
};
//#endregion
