...
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-DJy1UN9B.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-CXaUlUtG.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-BqjrcC9W.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-CF0uy0oR.js";
import { i as consumePendingDelegates } from "./delegate-store-C8ETMWnz.js";
import "./continuation-delegate-store-DS3e9cJy.js";
import { n as resolveContinuationRuntimeConfig } from "./config-CNyWQies.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-56zGcXcS.js";
import "./delivery-context-cGnh0m1Q.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BgHw03bG.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-BaqaCVZm.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-g4xSnAbx.js";
import { n as buildAnnounceIdFromChildRun, r as buildAnnounceIdempotencyKey, t as resolveAnnounceOrigin } from "./subagent-announce-origin-D_nNeTKK.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-432R9vCc.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-C6198ccL.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-rTcyUKsp.js"), import("./store-load-B2-0nnqZ.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { hasCrossSessionDelegateTargeting } = await import("./targeting-pure-DHkZAaCU.js");
	if (!hasCrossSessionDelegateTargeting(params.targeting, params.dispatchingSessionKey)) return false;
	const { enqueueSystemEvent } = await import("./system-events-fXxiP8x4.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-BUHHQNpC.js");
		...
		if (params.silentAnnounce) {
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-NybGDJMF.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
