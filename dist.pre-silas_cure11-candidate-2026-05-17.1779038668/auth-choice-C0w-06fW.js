...
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-BwA2H4Ph.js";
...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-DQ_05Gif.js";
import { r as loadModelCatalog } from "./model-catalog-D9WmDtLe.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-DNuUcqUU.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-NzWX87yz.js";
import "./provider-auth-choice-preference-Bor9rggK.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-rp3naN78.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-BY5V1eZH.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-DhW0Oefj.js");
