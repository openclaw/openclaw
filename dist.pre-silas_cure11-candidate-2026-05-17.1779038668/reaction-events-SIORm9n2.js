...
import "./session-binding-runtime-CrAtrK_M.js";
import { a as resolveMatrixAccountConfig } from "./account-config-NMdC91jF.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-x0ATs8LQ.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-91lbx_Mq.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-CzOFsxAT.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-BI5CLyq4.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-nNhXh4Uh.js");
