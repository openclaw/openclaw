import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BwXmDqXq.js";
import { r as loadCrestodianOverview } from "./overview-DKVZpnaa.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CTJ49kmx.js")).planCrestodianCommand)({
		input,
		overview
	});
