...
import { D as patchTopLevelChannelConfigSection, f as createStandardChannelSetupStatus } from "../../setup-wizard-helpers-Df2dyp28.js";
...
import { t as NostrConfigSchema } from "../../config-schema-Dr7C5H-e.js";
...
const nostrSetupWizard = createDelegatedSetupWizardProxy({
	channel,
	loadWizard: async () => (await import("../../setup-surface-Co1CZQuc.js")).nostrSetupWizard,
