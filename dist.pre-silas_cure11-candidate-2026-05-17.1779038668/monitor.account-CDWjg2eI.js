...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-Cx3id63H.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-BPp-rJKH.js";
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./channel-streaming-BhCgCZmr.js";
...
import { i as installRequestBodyLimitGuard } from "./http-body-C_X5bFXj.js";
import "./ssrf-runtime-Cvk-tl6n.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CReOfbTf.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-Bf58hdP0.js";
import { t as buildFeishuConversationId } from "./conversation-id-BqtpmROG.js";
import { i as resolveReceiveIdType } from "./targets-DwugDIcJ.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-DFjGjmjf.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-CBPvyAXe.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-BRGPltTz.js";
import { a as resolveFeishuGroupSenderActivationIngressAccess, i as resolveFeishuGroupConversationIngressAccess, n as resolveFeishuDmIngressAccess, r as resolveFeishuGroupConfig, s as resolveFeishuReplyPolicy, t as hasExplicitFeishuGroupConfig } from "./policy-BALaXcgO.js";
import { t as getFeishuRuntime } from "./runtime-BoMRvm6T.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-O7AlJ3mp.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-Csj1DEG-.js";
import "./runtime-api-KkOXuubn.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as saveMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-Dft1xwyA.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-DxHA9vLA.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-Ev5AJDyr.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-DPsAO038.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-DPsAO038.js");
