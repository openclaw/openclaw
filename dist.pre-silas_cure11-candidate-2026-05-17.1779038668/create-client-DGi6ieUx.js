...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-CFYNdZX4.js";
import "./config-DpcCIrHM.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-BL6wYooS.js"), import("./logging-CVPXoZbm.js")]).then(([sdkModule, loggingModule]) => ({
