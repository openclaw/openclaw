...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-DxdqJz8n.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-BCdnM3Sq.js";
...
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-B65Fparu.js";
...
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-vCTqpi_M.js";
...
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-B9_SJnTA.js";
...
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-BVCHk8wn.js";
...
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-CBsylqpw.js";
...
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-DlAjISO1.js";
...
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-Dl4PTN81.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-OO07584g.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-CDekM8PH.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DuUxZXiF.js";
import { a as isTimeoutError } from "./failover-error-BSbT38yv.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CGmI7D8O.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-Cf89pHx4.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-U7v4XONC.js";
import { a as getActiveSecretsRuntimeSnapshot, o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-6yWo28i6.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BwUXBYMW.js";
import { i as parseAbsoluteTimeMs } from "./stagger-BWKojr91.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-BO0EVNis.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-BpeFVMP3.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-sRFflRVk.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-yiD-WWdH.js";
import "./runtime-internal-CCQ_VPFT.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-CRTak8Sd.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-BMgnGguP.js";
...
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-B0hkZ6vg.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-DOQ5HnSe.js";
...
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-kgUkNV05.js";
...
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-CP7or-H4.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-Bs3punwU.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-B5HXS8-e.js";
...
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-Clsofc9T.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-CMdJb9Hv.js";
...
import { r as listChatCommandsForConfig } from "./commands-registry-list-BsTdGS2j.js";
import "./commands-registry-CdZhpJXU.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CfRMY352.js";
import "./browser-maintenance-IaE2FUxE.js";
...
import { t as getChannelActivity } from "./channel-activity-DmLiZ1dd.js";
...
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-Cf1dD_7H.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-C7w9jDpd.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-7XKu2PCL.js";
...
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-C2IjQrqk.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-arujM8Bg.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-uYaLkesO.js";
import { t as formatForLog } from "./ws-log-DqK-3nlG.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-ddTwV9ho.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BBrK32pv.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BeMF1e_s.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-R72ADz20.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-8G_xnS9U.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-M96YcKfd.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CJNQ8ReP.js";
import { n as createOutboundSendDeps } from "./deps-DU75v5Kx.js";
import "./agent-DTEDI8zY.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-DtPwuJPY.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-C0goLBF7.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-BN3dqNsF.js";
...
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-BlXM9gq0.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-DBwqJf5N.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Dr3KdlXw.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-C45NpYbR.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-3toR5aTf.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-CByCeaXg.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-t65uvVGD.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-B3bEuOqj.js";
import { t as buildChannelUiCatalog } from "./catalog-C3JDKTSD.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-BnZbBD3D.js";
import { s as normalizeUpdateChannel } from "./update-channels-DwflzTzt.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-BUUZfR0p.js";
...
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CyYsodg-.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-BPJI92Rh.js";
import { t as buildChannelAccountSnapshot } from "./status-Dn9pSrBJ.js";
...
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-mid8NPxs.js";
import { t as getStatusSummary } from "./status.summary-BpXtNVA3.js";
import "./status-rTfcEcnU.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BIYQR5Tk.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-NUCswpuL.js";
...
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-Bg3BXqF7.js";
...
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-BaPCxDid.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-Bem-Mbaf.js";
import "./heartbeat-runner-OyiNnEld.js";
...
import { n as resolveSessionKeyForRun } from "./server-session-key-CFOSr0DU.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-ixjd3XDb.js";
...
import { t as invokeGatewayTool } from "./tools-invoke-shared-BDJC-Yfx.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-DFmpSqaq.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-pP-44965.js");
