...
import { u as isPrivateIpAddress } from "./ssrf-DZjn8bFZ.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-CCmhPmgY.js";
import "./ssrf-runtime-Cvk-tl6n.js";
import "./security-runtime-ABjFIZME.js";
import "./provider-http-CZWOz3to.js";
import { t as getMSTeamsRuntime } from "./runtime-api-DvgCcwye.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-CcMSD6ve.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-DZbriieG.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DzmVcJG5.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DqOvMj69.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-Cp-uY71D.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
