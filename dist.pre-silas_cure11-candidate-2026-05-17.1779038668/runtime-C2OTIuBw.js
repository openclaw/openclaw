import { a as resolveAgentModelTimeoutMsValue } from "./model-input-B9p-bobB.js";
import { t as createSubsystemLogger } from "./subsystem-CwZgZA6E.js";
import { c as resolveClosestAspectRatio, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, l as resolveClosestResolution, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata, u as resolveClosestSize } from "./runtime-shared-DdxAqPln.js";
import { a as resolveVideoGenerationModeCapabilities, n as resolveVideoGenerationSupportedDurations, t as normalizeVideoGenerationDuration } from "./duration-support-BUWVPbKW.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-E7ckA80k.js";
import { n as listVideoGenerationProviders, t as getVideoGenerationProvider } from "./provider-registry-BTzWWjG1.js";
...
async function generateVideo(params, deps = {}) {
	...
	const timeoutMs = params.timeoutMs ?? resolveAgentModelTimeoutMsValue(params.cfg.agents?.defaults?.videoGenerationModel);
