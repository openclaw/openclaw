...
import { t as getActiveMatrixClient } from "./active-client-tJnX0bXC.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DBFzks2U.js"), import("./shared-BDd64E51.js")]).then(([clientModule, sharedModule]) => ({
