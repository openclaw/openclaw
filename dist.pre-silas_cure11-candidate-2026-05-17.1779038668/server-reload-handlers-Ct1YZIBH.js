...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-e5bDitbk.js";
import { i as getRuntimeConfig } from "./io-DxdqJz8n.js";
import "./installed-plugin-index-records-DJAK9L5P.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-BCdniHcd.js";
import "./config-CddmOexD.js";
import { n as isRestartEnabled } from "./commands.flags-Bh-3SVDK.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-DD_XDFb-.js";
...
import { o as resetModelCatalogCache } from "./model-catalog-D9WmDtLe.js";
import { l as getTotalQueueSize } from "./command-queue-B_ee8LAq.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-CQSXOWoW.js";
import "./pi-bundle-mcp-tools-BeueVPo4.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-6yWo28i6.js";
import { r as resetDirectoryCache } from "./target-resolver-BTJH5aMJ.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-BnuWajRA.js";
...
import { _ as resolveHooksConfig } from "./hooks-N9DWMo9j.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BnV9RqTm.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-O2p9btFY.js";
import { t as diffConfigPaths } from "./config-diff-Dy1Oegsi.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-Bem-Mbaf.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-eEBqFuLr.js";
import { t as buildGatewayCronService } from "./server-cron-CKKhE-Lp.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-D7r_8sNM.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-I0fX2ETo.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-BY9uk6zn.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-cdgSOwv2.js"), import("./gmail-watcher-lifecycle-Co0fQkXB.js")]);
...
//#endregion
export { createGatewayReloadHandlers, startManagedGatewayConfigReloader };
