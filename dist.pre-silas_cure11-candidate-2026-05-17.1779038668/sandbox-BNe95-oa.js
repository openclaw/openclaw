...
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-CtvCbuVZ.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-CKAisWht.js";
import { n as isToolAllowed } from "./tool-policy-CXtaFI1V.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-BPiSDmWi.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D3ljnFJW.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DuUxZXiF.js";
import { f as isSameSsrFPolicy } from "./ssrf-DZjn8bFZ.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-Dbvsvuot.js";
import { C as readBrowserRegistry, D as updateBrowserRegistry, E as removeRegistryEntry, O as updateRegistry, T as removeBrowserRegistryEntry, _ as resolveSandboxAgentId, a as execDocker, b as slugifySessionKey, c as isDockerDaemonUnavailable, g as appendWorkspaceMountArgs, k as computeSandboxBrowserConfigHash, l as readDockerContainerEnvVar, m as resolveDockerEnvPolicyEpoch, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxScopeKey, w as readRegistry, y as resolveSandboxWorkspaceDir } from "./docker-Dad6JYmK.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-jxJ4W2uf.js";
import { A as runDockerSandboxShellCommand, D as buildPinnedRenamePlan, E as buildPinnedRemovePlan, O as buildPinnedWritePlan, T as buildPinnedMkdirpPlan, a as getSandboxBackendManager, b as relativePathEscapesContainerRoot, k as dockerSandboxBackendManager, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedAppendPlan, y as normalizeContainerPath } from "./browser-bridges-DwRIr5j0.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-DVJ1RR2i.js"),
				import("./exec-defaults-BErRqQ2q.js"),
				import("./skills-D9JWyzM4.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-DRCWTYDK.js")).maybePruneSandboxes(cfg);
