...
import { n as extractAssistantText } from "./pi-embedded-utils-BPp-rJKH.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-DqJqJfp3.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-Daj1svqX.js")).runEmbeddedPiAgent;
}
