...
import { r as extractFirstTextBlock } from "./chat-message-content-CjC9AtYE.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-DG7PI6KS.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-BjnBwPzT.js";
import { t as applyParentDefaultHelpAction } from "./parent-default-help-B4t_OY_f.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-DfmqryVC.js"),
			import("./client-DwpWutyi.js"),
			import("./client-start-readiness-BglLmXU_.js"),
			import("./method-scopes-CG6SHkDr.js"),
			import("./client-info-bcjTFe5i.js")
		]);
