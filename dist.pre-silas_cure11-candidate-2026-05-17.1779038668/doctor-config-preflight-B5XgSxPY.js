...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-DxdqJz8n.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { t as note } from "./note-B7V1z9JE.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CaoNAP46.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BwcztgdB.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-d1Hbd__v.js");
