...
import { i as resolveChannelTurnDispatchCounts, n as hasFinalChannelTurnDispatch, r as hasVisibleChannelTurnDispatch } from "./dispatch-result-DhctZi_Z.js";
import "./channel-reply-core-BSUL5PKL.js";
...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-Dm91NFGd.js")).deliverInboundReplyWithMessageSendContext(...args);
};
...
async function sendDurableMessageBatch(params) {
	return await (await import("./runtime-BlNTUvI8.js")).sendDurableMessageBatch(params);
}
async function withDurableMessageSendContext(params, run) {
	return await (await import("./runtime-BlNTUvI8.js")).withDurableMessageSendContext(params, run);
}
