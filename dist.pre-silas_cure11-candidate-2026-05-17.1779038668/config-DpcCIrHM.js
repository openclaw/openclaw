...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-CCmhPmgY.js";
import "./ssrf-runtime-Cvk-tl6n.js";
import "./retry-runtime-DJd_8oek.js";
import "./secret-input-runtime-D_vy5RR5.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DH-J6xpP.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-C0ewhPgu.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-NMdC91jF.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-CV1y5RCM.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Cdwt61yT.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-hKnBsW3F.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-CFYNdZX4.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BL6wYooS.js"), import("./logging-CVPXoZbm.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-feKXPN63.js").then((credentialsReadModule) => ({
