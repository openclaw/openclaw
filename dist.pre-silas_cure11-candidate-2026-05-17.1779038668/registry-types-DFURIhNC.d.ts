import { i as PluginCompatCode } from "./installed-plugin-index-CZJx4Lh-.js";
import { i as PluginFormat, n as PluginConfigUiHint, r as PluginDiagnostic, t as PluginBundleFormat } from "./manifest-types-BJ1lcL4h.js";
import { t as JsonSchemaObject } from "./json-schema.types-Dcq36HZ-.js";
import { a as PluginDependencyStatus, l as PluginKind, o as PluginManifestContracts } from "./manifest-registry-lrVHRP3o.js";
import { t as PluginOrigin } from "./plugin-origin.types-SvaoVx6a.js";
import { N as WebFetchProviderPlugin, w as OpenClawPluginToolFactory, z as WebSearchProviderPlugin } from "./types-core-BqOguxg5.js";
import { t as HookEntry } from "./types-CxTh-7YH.js";
import { A as OpenClawPluginHttpRouteAuth, B as OpenClawPluginNodeInvokePolicy, Bn as RealtimeVoiceProviderPlugin, C as OpenClawPluginCliRegistrar, Dr as AgentToolResultMiddlewareRuntime, Ei as MemoryEmbeddingProviderAdapter, G as OpenClawPluginReloadRegistration, M as OpenClawPluginHttpRouteMatch, O as OpenClawPluginGatewayRuntimeScopeSurface, P as OpenClawPluginHttpRouteUpgradeHandler, R as OpenClawPluginNodeHostCommand, Un as UnifiedModelCatalogProviderPlugin, Vn as SpeechProviderPlugin, Wn as VideoGenerationProviderPlugin, Y as OpenClawPluginService, ar as CodexAppServerExtensionFactory, d as MigrationProviderPlugin, dt as PluginLogger, fr as CliBackendPlugin, g as OpenClawGatewayDiscoveryService, j as OpenClawPluginHttpRouteHandler, k as OpenClawPluginHostedMediaResolver, m as MusicGenerationProviderPlugin, n as MediaUnderstandingProviderPlugin, q as OpenClawPluginSecurityAuditCollector, ri as AgentHarness, rn as ProviderPlugin, t as ImageGenerationProviderPlugin, vt as PluginTextTransformRegistration, w as OpenClawPluginCommandDefinition, x as OpenClawPluginCliCommandDescriptor, xr as AgentToolResultMiddleware, zn as RealtimeTranscriptionProviderPlugin } from "./types-wNLvWYuA.js";
import { Jt as PluginConversationBindingResolvedEvent, tt as PluginHookRegistration$1 } from "./hook-types-AyXrRN7k.js";
...
import { g as CronServiceContract, h as GatewayMethodDescriptor, i as GatewayRequestHandlers } from "./types-Gix-8Zvv.js";
import { n as PluginRuntime } from "./types-DBMmCO8F.js";
import { a as PluginActivationSource } from "./config-state-d0p-lWzi.js";
