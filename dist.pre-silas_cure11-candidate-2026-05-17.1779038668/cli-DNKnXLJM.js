...
import { i as resolveMatrixAccount } from "./accounts-CPysNHum.js";
...
import { n as matrixSetupAdapter } from "./setup-core-HljLbiEV.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-BoFpigsw.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-bLvo3bPD.js";
import { t as withResolvedActionClient } from "./client-BwSQ7Qqx.js";
import { r as resolveMatrixAuthContext } from "./config-DpcCIrHM.js";
import "./client-EsqsTmCz.js";
import "./runtime-api-CA_lMnSX.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-imCYgoOZ.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DOrExnaY.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-C-BZRhuy.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-DIsryIek.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DnLHUL9_.js");
