...
import { c as updateSessionStoreEntry, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-BqYSXyaO.js";
...
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-DJy1UN9B.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-CBsylqpw.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-DjQcCpJ_.js";
...
import { r as enqueueCommitmentExtraction } from "./runtime-BopzjvEz.js";
...
import { r as resolveLiveContinuationRuntimeConfig } from "./config-CNyWQies.js";
...
import { r as getCliSessionBinding } from "./cli-session-BwCzNWcw.js";
import { lt as isLikelyExecutionAckPrompt } from "./selection-DGkFQnDs.js";
import { u as parseReplyDirectives } from "./payloads-Cf89pHx4.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-BaTZ2syz.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-BS569JHN.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-CwAEN362.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-B_zvD5C4.js";
import { n as hasCotFramePrefix } from "./normalize-reply-D7kDVyAI.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-CcKD9s1x.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-Ds7N3H_W.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-tH1Nb3gi.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-B4nSTq2h.js";
import "./sandbox-BNe95-oa.js";
import { n as readPostCompactionContext } from "./post-compaction-context--SseJNF6.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CjfqLDjN.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-D9-DG02Q.js";
import { t as runCliAgent } from "./cli-runner-K-_rGwFx.js";
import { n as HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT, t as GENERIC_EXTERNAL_RUN_FAILURE_TEXT } from "./agent-runner-failure-copy-Cl4jgUIS.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-D4D0Y9vG.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-I9qgE8XA.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-CUursPNB.js";
import { n as incrementCompactionCount } from "./session-updates-CWz9BjbA.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-6Td9t3nK.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-C8-Hks7e.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-C_Cde3AR.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-RocAIlZq.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-C5khIkZw.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-D2dXNpHy.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-DLsdpb4H.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-CVbxMzPN.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-C8RuAEti.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-Daj1svqX.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-DYdNibwu.js"),
					import("./config-D_V_3cts.js"),
					import("./state-432R9vCc.js"),
					import("./store-CEc597sn.js")
				]);
