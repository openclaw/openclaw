...
import { n as normalizeMediaProviderId } from "./config-provider-models-BOvQU86k.js";
import { t as describeImageWithModel } from "./image-runtime-DgVthf0T.js";
import { d as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, u as buildMediaUnderstandingRegistry } from "./defaults.constants-BmFyFWYe.js";
import { a as runCapability, o as createMediaAttachmentCache, s as normalizeMediaAttachments, t as buildProviderRegistry } from "./runner-BAYbc_2f.js";
import { i as normalizeDecisionReason, n as findDecisionReason } from "./runner.entries-MszWnoXF.js";
...
async function describeImageFileWithModel(params) {
	...
	if (params.mediaUrl) {
		const cache = createMediaAttachmentCache(normalizeMediaAttachments(buildFileContext(params)), { ssrfPolicy: params.cfg.tools?.web?.fetch?.ssrfPolicy });
		try {
	...
	} else buffer = (await readLocalFileSafely({ filePath: params.filePath })).buffer;
