...
import { p as normalizeThinkLevel } from "./thinking-Cq1bOxic.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-ECyZSF-c.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-Chm67yFb.js";
import { d as randomIdempotencyKey, i as callGateway } from "./call-Ch2fB07i.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-B65Fparu.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-T92uY7wQ.js";
import "./auth-profiles-gVfSu9c_.js";
import { n as listProfilesForProvider } from "./profile-list-furv_b84.js";
import { r as loadModelCatalog } from "./model-catalog-D9WmDtLe.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-D4C6wL2g.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DTI0PwJW.js";
import { u as saveMediaBuffer } from "./store-aoALqUZR.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-BmFyFWYe.js";
import { a as getModelsCommandSecretTargetIds, f as getWebFetchCommandSecretTargets, i as getMemoryEmbeddingCommandSecretTargetIds, m as getWebSearchCommandSecretTargets, u as getTtsCommandSecretTargetIds } from "./command-secret-targets-B_TetgOD.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-CFrTYP8N.js";
import "./tts-DrMPB9BJ.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-C2OTIuBw.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-CgEgb_3J.js";
import { t as resolveMemorySearchConfig } from "./memory-search-cDaEwlE-.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CRdIgD7B.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-DBlM73e_.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-DI_QVZBh.js";
...
import { t as collectOption } from "./helpers-LIF0l44D.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-DSUa-ewH.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-BnZbBD3D.js";
...
async function resolveLocalCapabilityRuntimeConfig(params) {
	...
	if (sourceConfig) setRuntimeConfigSnapshot(resolvedConfig, sourceConfig);
	else setRuntimeConfigSnapshot(resolvedConfig);
	return resolvedConfig;
}
function withWebProviderOverride(config, kind, provider) {
	const normalizedProvider = normalizeOptionalString(provider);
	if (!normalizedProvider) return config;
	const next = structuredClone(config);
	const tools = next.tools ??= {};
	const web = tools.web ??= {};
	const existing = web[kind];
	web[kind] = existing && typeof existing === "object" ? {
		...existing,
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-g97CXxTH.js");
...
async function runWebSearchCommand(params) {
	const config = withWebProviderOverride(getRuntimeConfig(), "search", params.provider);
...
async function runWebFetchCommand(params) {
	const config = withWebProviderOverride(getRuntimeConfig(), "fetch", params.provider);
	const provider = normalizeOptionalString(params.provider);
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-DNPA2sjd.js");
