import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, o as normalizeNullableString, s as normalizeOptionalLowercaseString } from "./string-coerce-LndEvhRk.js";
import { i as formatErrorMessage } from "./errors-ixwfrboQ.js";
import { t as createLazyImportLoader } from "./lazy-promise-SFT4i6yI.js";
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-DRikErcl.js";
import { b as escapeRegExp } from "./utils-CpmNtyoq.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, i as isCronSessionKey } from "./session-key-utils-CJRKuBJA.js";
...
import { Y as getShellPathFromLoginShell, Z as resolveShellEnvFallbackTimeoutMs } from "./io-DxdqJz8n.js";
import { f as resolveApprovalAuditTrustPath } from "./exec-safe-bin-trust-IrNaZViN.js";
import { O as normalizeExecutableToken, c as isShellWrapperExecutable, k as splitShellArgs, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-BOPTchHQ.js";
import { t as killProcessTree } from "./kill-tree-bFDNPO4m.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-B9xZ12q8.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-Chm67yFb.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-mlXU8Wcs.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-DSMO_yiE.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-C1aFN6-6.js";
import { d as sanitizeUserFacingText, f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText } from "./sanitize-user-facing-text-CB4MRZOj.js";
import { t as formatDurationCompact } from "./format-duration-CGB27P5d.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-BFheRno4.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-B2qqAn-B.js";
import { o as failedTextResult, y as textResult } from "./common-FjdctQMa.js";
import { t as callGatewayTool } from "./gateway-fCj21SAU.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-Dq8q36kg.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-B7EgQNWr.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-Btea9qTD.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-U7v4XONC.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-CBsDOteb.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-B6_ku-SK.js";
import "./delivery-context-cGnh0m1Q.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-B0hkZ6vg.js";
import { t as sendMessage } from "./message-U4dd7HBr.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-BLu-srHI.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-BPGKn2tg.js";
import { t as getProcessSupervisor } from "./supervisor-BDM-DrOp.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-bzQBnLPw.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-Bm7BSTZM.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-CjeNSzbs.js";
import { n as detectPolicyInlineEval } from "./policy-nX3BfFir.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-DtPwuJPY.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-C0goLBF7.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-BN3dqNsF.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-BWr9nkTz.js";
...
async function sendExecApprovalFollowupResult(target, resultText, deps = {}) {
	...
	const runtimeHandoff = target.direct === true || !target.sessionKey ? void 0 : registerExecApprovalFollowupRuntimeHandoff({
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-CITvm6a8.js"));
...
function createExecTool(defaults) {
	...
	return {
		...
		execute: async (_toolCallId, args, signal, onUpdate) => {
			...
			let security = defaults?.security ?? approvalDefaults?.security ?? (host === "sandbox" ? "deny" : "full");
