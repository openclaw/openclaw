import { x as isPlainObject } from "./utils-CpmNtyoq.js";
import { i as freezeDiagnosticTraceContext, o as runWithDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-B7EOHOXE.js";
...
import { a as normalizeAnyChannelId } from "./registry-GgtzeCf_.js";
import { _ as getPluginSessionExtensionStateSync } from "./loader-vCTqpi_M.js";
import { i as PluginApprovalResolutions } from "./types-DAMYCUym.js";
...
import { i as resolveSandboxInputPath } from "./sandbox-paths-CtvCbuVZ.js";
import { i as listChannelPlugins, t as getChannelPlugin } from "./registry-BDy7VEax.js";
import "./plugins-BwY4oKrD.js";
import { i as normalizeToolName } from "./tool-policy-shared-C1aFN6-6.js";
import "./tool-policy-Bk3UGpSR.js";
import { n as copyPluginToolMeta } from "./tools-OO07584g.js";
import { c as resolveMessageActionDiscoveryChannelId, l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext, s as resolveCurrentChannelMessageToolDiscoveryAdapter } from "./message-action-discovery-DdRRk2wx.js";
import { n as channelPluginHasNativeApprovalPromptUi, t as NATIVE_APPROVAL_PROMPT_RUNTIME_CAPABILITY } from "./native-approval-prompt-nKk4e_0Q.js";
import { r as diagnosticHttpStatusCode, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-CteiaGpy.js";
import { a as createLazyRuntimeSurface } from "./lazy-runtime-_xfZBfXC.js";
import { t as adjustedParamsByToolCallId } from "./pi-tools.before-tool-call.state-By1e2NsK.js";
	...
	const wrappedTool = {
		...
		execute: async (toolCallId, params, signal, onUpdate) => {
			...
			try {
				...
				const result = await (trace ? runWithDiagnosticTraceContext(trace, executeTool) : executeTool());
...
//#endregion
export { resolveChannelMessageToolHints as _, copyBeforeToolCallHookMarker as a, isBeforeToolCallBlockedError as c, wrapToolWithBeforeToolCallHook as d, copyChannelAgentToolMeta as f, listChannelSupportedActions as g, listChannelAgentTools as h, consumeAdjustedParamsForToolCall as i, isToolWrappedWithBeforeToolCallHook as l, listAllChannelSupportedActions as m, __testing as n, hasBeforeToolCallPolicy as o, getChannelAgentToolMeta as p, buildBlockedToolResult as r, isAbortSignalCancellation as s, BeforeToolCallBlockedError as t, runBeforeToolCallHook as u, resolveChannelPromptCapabilities as v, resolveChannelReactionGuidance as y };
