...
export declare function getWebSearchCommandSecretTargetIds(): Set<string>;
export declare function getWebFetchCommandSecretTargetIds(): Set<string>;
export declare function getWebSearchCommandSecretTargets(params: {
    config: OpenClawConfig;
    provider?: string | null;
}): CommandSecretTargetSelection;
export declare function getWebFetchCommandSecretTargets(params: {
    config: OpenClawConfig;
    provider?: string | null;
}): CommandSecretTargetSelection;
