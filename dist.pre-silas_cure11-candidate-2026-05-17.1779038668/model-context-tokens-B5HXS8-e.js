...
import { r as isCompactionCheckpointTranscriptFileName } from "./artifacts-C9-LS6LB.js";
import { s as updateSessionStore } from "./store-BqYSXyaO.js";
import "./sessions-BVCHk8wn.js";
import { o as streamSessionTranscriptLines } from "./transcript-DeZOWwm4.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Pp-VxfGB.js";
import { m as resolveGatewaySessionStoreTarget } from "./session-utils-B3lYtRuo.js";
import { t as log$1 } from "./logger-D1EcQdNR.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BHOAl8lI.js";
import { t as resolveMemorySearchConfig } from "./memory-search-cDaEwlE-.js";
import path from "node:path";
import fs from "node:fs/promises";
import { randomUUID } from "node:crypto";
import { CURRENT_SESSION_VERSION, migrateSessionEntries } from "@earendil-works/pi-coding-agent";
...
async function readTranscriptEntriesForForkAsync(sessionFile) {
	const entries = [];
	try {
		for await (const line of streamSessionTranscriptLines(sessionFile)) try {
			const parsed = JSON.parse(line);
