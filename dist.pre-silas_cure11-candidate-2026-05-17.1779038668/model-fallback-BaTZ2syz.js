...
import { f as readLoggingConfig, s as redactSensitiveText, t as getDefaultRedactPatterns } from "./redact-CxqQQvmK.js";
...
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CQewiu8n.js";
import { c as resolveDefaultAgentId, n as listAgentIds } from "./agent-scope-config-BWnA6LIS.js";
import { r as emitFailoverEvent } from "./diagnostic-events-QP40Y1ku.js";
...
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-BH4ClELL.js";
import { g as normalizeVerboseLevel, p as normalizeThinkLevel } from "./thinking-Cq1bOxic.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-CVEfE2Xf.js";
import { r as resolveExplicitAgentSessionKey } from "./main-session-B4hR9U8Q.js";
...
import { c as resolveSessionLifecycleTimestamps } from "./sessions-BVCHk8wn.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-Do_oZVzj.js";
import { n as resolveSessionKey } from "./session-key-CTkm-Ncg.js";
import { i as buildModelAliasIndex, n as buildConfiguredAllowlistKeys, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-D-NMyYXW.js";
import { n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-D1wAzSpK.js";
import "./model-selection-cli-mqbw_UX3.js";
import { i as externalCliDiscoveryForProviders } from "./external-cli-discovery-CVGKwppA.js";
import { t as redactIdentifier } from "./redact-identifier-D73pkUbd.js";
import { t as stableStringify } from "./stable-stringify-CBtPD8yj.js";
import { o as parseApiErrorInfo } from "./assistant-error-format-COp9PdIZ.js";
import { o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-CB4MRZOj.js";
import { m as setCommandLaneConcurrency, u as isCommandLaneTaskTimeoutError } from "./command-queue-B_ee8LAq.js";
import "./pi-embedded-helpers-CirFrq6J.js";
import { m as isLikelyContextOverflowError, r as classifyProviderRuntimeFailureKind } from "./errors-DcasbQCL.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-Dy6JQLS0.js";
import { a as isTimeoutError, i as isFailoverError, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-BSbT38yv.js";
import { n as resolveSessionIdMatchSelection } from "./session-id-resolution-tySlFT_c.js";
...
function resolveFallbackCandidates(params) {
	...
	const normalizedPrimary = normalizeModelRef(providerRaw, modelRaw, { manifestPlugins: params.manifestPlugins });
	const aliasIndex = buildModelAliasIndex({
		cfg: params.cfg ?? {},
		defaultProvider,
		manifestPlugins: params.manifestPlugins
	...
	addExplicitCandidate(normalizeModelRef(resolvedPrimary.provider, resolvedPrimary.model, { manifestPlugins: params.manifestPlugins }));
