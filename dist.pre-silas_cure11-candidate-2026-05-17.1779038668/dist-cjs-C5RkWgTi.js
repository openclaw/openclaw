...
import { F as init_config, P as config_exports } from "./protocols-BDL1JJba.js";
import { n as init_client, t as client_exports } from "./client-B7XRAete.js";
...
var require_fromWebToken = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const fromWebToken = (init) => async (awsIdentityProperties) => {
		...
		if (!roleAssumerWithWebIdentity) {
			const { getDefaultRoleAssumerWithWebIdentity } = await import("./sts-YvhqHQSz.js");
