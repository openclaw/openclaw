import { a as isPathInsideWithRealpath, d as safeRealpathSync } from "./path-B5B-_oAT.js";
import { t as discoverOpenClawPlugins } from "./discovery-CmGMypOF.js";
...
import { d as writeJson, l as tryReadJson, u as tryReadJsonSync } from "./json-files-1SmAauRO.js";
import { r as hasKind } from "./slots-MFUVcT3n.js";
import { c as resolveEffectiveEnableState, l as resolveEffectivePluginActivationState, s as normalizePluginsConfig } from "./config-state-_YKe8RCQ.js";
import { a as resolveInstalledPluginIndexStorePath, n as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-e5bDitbk.js";
import { t as describePluginInstallSource } from "./install-source-info-CbwORCCi.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-5GfSnrcF.js";
import { n as saveJsonFile } from "./json-file-CuVcyv5a.js";
...
function resolvePackageJsonPath(candidate) {
	...
	return fs.existsSync(packageJsonPath) && isPathInsideWithRealpath(rootDir, packageJsonPath) ? packageJsonPath : void 0;
}
