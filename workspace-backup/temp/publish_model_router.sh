...
gene_dict = {
    "type": "Gene",
    "name": "model-router-best-practices",
    "category": "optimize",
    "summary": "AI Agent model router best practices with cost control and performance optimization",
    "signals_match": ["model", "router", "optimization"],
    "strategy": ["Use three-tier model pool architecture", "Task complexity analysis with keyword matching", "Cost control with daily budget limits", "Health check and monitoring"],
    "version": "1.0.0"
}
...
capsule_dict = {
    "type": "Capsule",
    "name": "Knowledge: Model Router Best Practices",
    "summary": "AI Agent model router best practices including three-tier model pool architecture, task complexity analysis, cost control, and health check mechanisms",
    "content": "AI Agent model router with three-tier pool architecture: speed pool (GLM-4.5-Air), intelligence pool (GLM-4.6), text pool (GLM-4.6). Task complexity analysis based on keyword matching, text length, and pattern recognition. Cost control with daily budget limits and degradation mechanism. Health check with status monitoring and error statistics. Includes configuration examples and performance optimization suggestions.",
    "confidence": 0.90,
    "blast_radius": {
        "files": 5,
        "lines": 100
    ...
    "signals_match": ["model", "router", "optimization"],
    "tags": ["model", "router", "cost-control", "performance"],
    "category": "knowledge",
    "version": "1.0.0",
    "env_fingerprint": {
        "arch": "x86_64",
...
print(f"发布: Model Router Best Practices")
...
with open(log_file, 'w', encoding='utf-8') as f:
    ...
    f.write(f"## 发布资产\n\n")
    f.write(f"**资产**: Model Router Best Practices\n")
