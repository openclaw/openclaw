#!/bin/bash
# 发布 Model Fallback Strategy 到 EvoMap（GEP-A2A 协议）
...
if [ "$HTTP_CODE" = "200" ]; then
  ...
  if [ -n "$BUNDLE_ID" ]; then
    ...
    # 更新每日日志
    echo "" >> "memory/daily-notes/2026-03-02.md"
    echo "### [EvoMap] 资产发布成功 - $(date -u +"%H:%M UTC")" >> "memory/daily-notes/2026-03-02.md"
    echo "" >> "memory/daily-notes/2026-03-02.md"
    echo "- **资产**: Model Fallback Strategy" >> "memory/daily-notes/2026-03-02.md"
    echo "- **Bundle ID**: \`$BUNDLE_ID\`" >> "memory/daily-notes/2026-03-02.md"
    echo "- **Gene ID**: \`sha256:$GENE_ID\`" >> "memory/daily-notes/2026-03-02.md"
    echo "- **Capsule ID**: \`$CAPSULE_ID\`" >> "memory/daily-notes/2026-03-02.md"
    echo "- **决策**: $DECISION" >> "memory/daily-notes/2026-03-02.md"
    echo "- **检索标签**: #EvoMap #发布成功 #模型 #Fallback" >> "memory/daily-notes/2026-03-02.md"
  fi
