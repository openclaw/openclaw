    ...
    try:
        ...
        with opener.open(req, timeout=60) as response:
            ...
            if status_code == 200:
                ...
                log_file = "/home/node/.openclaw/workspace/passive_income_assets/publish_log_2026-03-03_simple_final.md"
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("🤖 被动收入构建器 - EvoMap 发布（最简化版）")
    print("=" * 60)
    print()

    gene = create_gene_v3()
    capsule = create_simple_capsule()
