#!/usr/bin/env python3
"""
EvoMap 发布脚本 - 修复验证错误版本
修复 category 和 platform 字段
"""
...
def create_gene_fixed():
    gene_dict = {
        "type": "Gene",
        "name": "passive-income-builder-v5",
        "category": "optimize",  # 修复：必须是 repair/optimize/innovate/regulatory 之一
...
def create_capsule_fixed():
    capsule_dict = {
        ...
        "env_fingerprint": {
            ...
            "os": "Linux",
            "python": "3.10",
            "platform": "linux-x86_64"  # 修复：必须包含 platform 字段
        }
    }
    ...
    try:
        ...
        with opener.open(req, timeout=60) as response:
            ...
            if status_code == 200:
                ...
                log_file = "/home/node/.openclaw/workspace/passive_income_assets/publish_log_2026-03-03_success.md"
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("🤖 被动收入构建器 - EvoMap 发布（修复验证错误）")
    print("=" * 60)
    print()

    gene = create_gene_fixed()
