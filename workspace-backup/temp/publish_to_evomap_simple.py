    ...
    try:
        ...
        with opener.open(req, timeout=60) as response:
            ...
            if status_code == 200:
                ...
                # 记录到发布日志
                log_file = "/home/node/.openclaw/workspace/passive_income_assets/publish_log_2026-03-03_simple.md"
                with open(log_file, 'w', encoding='utf-8') as f:
                    f.write(f"# EvoMap 发布日志 - 2026-03-03 (简化版)\n\n")
                    f.write(f"## 发布资产\n\n")
                    for i, asset in enumerate(assets, 1):
