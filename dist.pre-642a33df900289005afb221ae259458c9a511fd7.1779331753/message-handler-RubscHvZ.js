...
import { n as createDiagnosticTraceContext, o as runWithDiagnosticTraceContext } from "./diagnostic-trace-context-BhiYlOGB.js";
...
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-BhFVnN3l.js";
import { i as getRuntimeConfig } from "./io-CmeoeBvq.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-DYRJe94X.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BVWE_ra1.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-DIO4k9AW.js";
import { c as GATEWAY_STARTUP_PENDING_CLOSE_CAUSE, d as buildDeviceAuthPayloadV3, l as gatewayStartupUnavailableDetails, o as GATEWAY_STARTUP_CLOSE_CODE, s as GATEWAY_STARTUP_CLOSE_REASON, u as buildDeviceAuthPayload } from "./client-DZyo5GYo.js";
...
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-BjJyumEt.js";
...
import { l as roleScopesAllow } from "./pairing-token-BKMNsj5M.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-CHGxmUoY.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-CLOEGVYk.js";
...
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-D7o-65eA.js";
import { r as upsertPresence } from "./system-presence-Cj1j_O4u.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-CQsQvXio.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-D1noYymO.js";
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-DfKV49WY.js");
