...
import { a as formatMissingPluginMessage } from "./error-format-BfFDdqsq.js";
import { n as collectConfiguredRuntimePluginIds, r as resolveConfiguredRuntimePluginInstallCandidate } from "./configured-runtime-plugin-installs-Bbk8TCSC.js";
...
async function runPluginsEnableCommand(id) {
	...
	const { enablePluginInConfig } = await import("./enable-DWozKmuw.js");
	const { normalizePluginId } = await import("./config-state-CebtZhlW.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-lQcm_1NT.js");
	const { applySlotSelectionForPlugin, logSlotWarnings } = await import("./plugins-command-helpers-DmzSGmnt.js");
...
async function runPluginsDisableCommand(id) {
	...
	const { normalizePluginId } = await import("./config-state-CebtZhlW.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-lQcm_1NT.js");
	const { setPluginEnabledInConfig } = await import("./plugins-config-Dka2TPQx.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-ByZ4RLRA.js");
	const snapshot = await readConfigFileSnapshot();
	const cfg = snapshot.sourceConfig ?? snapshot.config;
	const report = buildPluginRegistrySnapshotReport({ config: cfg });
...
async function runPluginsInstallAction(raw, opts) {
	await tracePluginLifecyclePhaseAsync("install command", async () => {
		const { runPluginInstallCommand } = await import("./plugins-install-command-CX4sCoMN.js");
...
async function runPluginsRegistryCommand(opts) {
	const { inspectPluginRegistry, refreshPluginRegistry } = await import("./plugin-registry-B6XkwPmD.js");
...
async function runPluginsDoctorCommand() {
	const { buildPluginCompatibilityNotices, buildPluginDiagnosticsReport, formatPluginCompatibilityNotice } = await import("./status-lQcm_1NT.js");
...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-gdswRKRv.js");
	const { createPluginInstallLogger } = await import("./plugins-command-helpers-DmzSGmnt.js");
