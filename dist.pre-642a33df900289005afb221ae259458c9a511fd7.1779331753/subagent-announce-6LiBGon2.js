...
import { _ as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-B_letAfx.js";
import { s as getSubagentDepthFromSessionStore } from "./subagent-capabilities-CMah3pTj.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-CKYB33Th.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-CjU2eT93.js";
import { i as consumePendingDelegates } from "./delegate-store-BQ2LResO.js";
import "./continuation-delegate-store-yNo1XvmF.js";
import { n as resolveContinuationRuntimeConfig } from "./config-Dbywwcxa.js";
import { a as resolveSubagentAnnounceTimeoutMs, i as loadSessionEntryByKey, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DrFsuJli.js";
import "./delivery-context-BVMBgb5f.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DVW0PF4P.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-CuHVPMh-.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-BgnfPGsQ.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-DGp_14uL.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-CiUyulEV.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-Bh_5xn6m.js"), import("./store-load-FDlgIw4I.js")]);
...
async function rejectCrossSessionTargetingForSubagentDispatch(params) {
	...
	const { enqueueSystemEvent } = await import("./system-events-CHzBApeg.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-Xct7E8cU.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-CHzBApeg.js");
			const { createSubsystemLogger } = await import("./subsystem-3lXm-89L.js");
