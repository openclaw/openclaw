...
import { r as getChildLogger, v as normalizeLogLevel } from "../../logger-CPfF9hOi.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-LTIAxzAP.js";
...
import { c as getImageMetadata, p as resizeToJpeg } from "../../media-services-ndemcXB-.js";
import { o as generateMusic, s as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-CoWUKlJv.js";
...
import { p as listTasksForFlowId } from "../../task-registry-55Il_c_r.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-BwpoHlXv.js";
import "../../runtime-internal-Fxexd60h.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-BssW4-2n.js";
import { n as resolveAgentIdentity } from "../../identity-CO-SOE_j.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-ChCdEb_d.js";
...
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-CPhxFV6H.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-B_ecLoyi.js";
import { r as isVoiceCompatibleAudio } from "../../audio-CVFIRHpA.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-9oR3u-Bg.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-CK6DxiJb.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-DYcgD6cT.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-DGX928W9.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-PccLM_47.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-DOLi_Kz9.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-B6tYnN6o.js"), (m) => m.createRuntimeLlm({
