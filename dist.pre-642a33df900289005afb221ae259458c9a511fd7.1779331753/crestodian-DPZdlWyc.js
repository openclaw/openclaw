...
import { r as resolveCrestodianOperation } from "./dialogue-d26VtOUp.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BD7YFx5w.js")).runCrestodianTui;
	opts.onReady?.();
