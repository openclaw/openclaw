...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-Dq5B1soR.js";
...
import { t as abortChatRunById } from "./chat-abort-CYOlzQJ5.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-DU-6eXn8.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-DV4spEGz.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-CSkUolIU.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-Doo1cJVN.js");
