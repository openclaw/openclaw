...
import { l as redactToolPayloadText } from "./redact-Dt7UuSgF.js";
...
import { S as hasEncodedFileUrlSeparator, T as trySafeFileURLToPath, t as appendFileWithinRoot } from "./fs-safe-Cs1EEnPP.js";
import { o as root } from "./secure-temp-dir-aidxCRgA.js";
import { h as isWindowsDrivePath } from "./archive-CVz-FUxu.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-BlCbsks0.js";
...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-Bl5pjInQ.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-Dm11aCiH.js";
...
import { i as resolveManifestContractOwnerPluginId, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-BBp7PSJC.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-CmeoeBvq.js";
...
import { o as normalizeChannelId } from "./registry-DbZhabyH.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-DlHWp9od.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-m7q4-54V.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-DUT-LIo-.js";
...
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-CKOXzvbe.js";
import { h as stringifyRouteThreadId } from "./channel-route-L2PJ-xNE.js";
import { n as deliveryContextFromSession, o as normalizeDeliveryContext } from "./delivery-context.shared-Bk0xEm32.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-DE6QEn2i.js";
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BKiPIr-m.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-CbQuetgM.js";
...
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-CQN_Tf5x.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-llLdXKCQ.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-D4b9-pI0.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-Buvz1_IB.js";
...
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-DTs9uBmU.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-D7yiNEoG.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BQRka0AJ.js";
...
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CMah3pTj.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-CE8tVafH.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, r as SUBAGENT_SPAWN_CONTEXT_MODES, t as spawnSubagentDirect } from "./subagent-spawn-D7C_glQv.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-DleleE1E.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Oe66c2-s.js";
...
import { n as ensureOpenClawModelsJson } from "./models-config-C2dPTNYD.js";
...
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-CU8laKY4.js";
...
import "./targeting-BNb-MQoy.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BQ2LResO.js";
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-Dbywwcxa.js";
import { t as canonicalizeBase64 } from "./base64-D03BM6T6.js";
import { c as getImageMetadata } from "./media-services-ndemcXB-.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-ChiCqNpp.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DyfNPUEq.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-IaiDdFos.js";
import { a as resolvePluginTools } from "./tools-B_plfZYh.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-Sek2fgzd.js";
import { _ as listChannelSupportedActions, c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, h as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-28rCfk3u.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-hktV2Azn.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-DSvNmzGK.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-CLvOhD7F.js";
import { n as extractAssistantText } from "./pi-embedded-utils-CqP0AtyL.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DrFsuJli.js";
import { n as runWithImageModelFallback } from "./model-fallback-Ba61o-mZ.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-B9-fki2l.js";
...
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-DEus8bFK.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-CMiAc6gM.js";
...
import { t as inferLegacyName } from "./normalize-hQdE4s_b.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-CMMxw89k.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BHBhpHgb.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BH3U4V_P.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CD2NWkwu.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-D-hYmazJ.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-DnKjsjKj.js";
...
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-DVS-l3s9.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BExkmwzd.js";
import { r as getDefaultLocalRoots } from "./local-media-access-otonztLX.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-MTVobrIj.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-DVGu8Z0h.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-t_BxH3_n.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-B4MRi1IT.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DVW0PF4P.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-tTNjcGp7.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-XHEPXJZi.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-6ygvgBlK.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-CVUwuD2Z.js";
import { n as normalizeMediaProviderId } from "./provider-id-BETgOIvU.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CTGJv8v7.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-C58JTJa2.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-B0Y_iHbF.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-DGvNSGdr.js";
import { s as resolveTimeoutMs } from "./resolve-C3OTQ5On.js";
import { t as buildProviderRegistry } from "./runner-4XRKG6CE.js";
import "./media-understanding-hOvuvo2x.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BhdMvmpy.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-sTntibO6.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-at-ryxI-.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-cjMT0lGM.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-DRPgwscB.js";
...
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-pdIrz0tc.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DsNDoiiL.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-DMilWVcO.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CUnMI0Oj.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-ChCdEb_d.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-BbJgJFzW.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DzXYSrRS.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-BgnfPGsQ.js";
import { p as registerSubagentRun } from "./subagent-registry-DwBMKyZB.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DjV2lCrU.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-C62LtOj2.js";
import { k as textToSpeech } from "./tts-runtime-B4YJ_gJS.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CW39k6Cc.js";
...
import { i as runWebSearch } from "./runtime-CPhxFV6H.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-DWx47QZU.js");
		await sendMessage({
			cfg: params.config,
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-C_AiJGgi.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-Be4P7gMS.js"));
