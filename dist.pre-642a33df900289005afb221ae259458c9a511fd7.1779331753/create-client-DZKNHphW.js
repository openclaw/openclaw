...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-BE2_ldem.js";
import "./config-DWhXmy7_2.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-CBmrmJcr.js"), import("./logging-hgTD6ZTO.js")]).then(([sdkModule, loggingModule]) => ({
