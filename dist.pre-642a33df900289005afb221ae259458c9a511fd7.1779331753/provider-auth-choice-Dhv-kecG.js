...
import { n as openUrl } from "./browser-open-DlIKw4f4.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-B9C5op3m.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-1xltT4N5.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-BqF-6amy.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-BdMA93oX.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-DwK-RCgn.js") };
