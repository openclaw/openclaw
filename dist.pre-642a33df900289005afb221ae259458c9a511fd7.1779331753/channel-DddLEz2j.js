...
import { n as normalizeAtHashSlug } from "./string-normalization-DiPHgdft.js";
...
import { i as createChatChannelPlugin } from "./core-npnlPG1m.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-OwKyYFCD.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-C9w9gv4K.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-CkwlpDZd.js";
...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-qlbJfXtz.js";
import "./channel-api-CPYavQ2h.js";
import { t as parseDiscordTarget } from "./target-parsing-D1FhMbX6.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-ysPM1HV2.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-CECmG1sg.js";
import { t as getDiscordRuntime } from "./runtime-B_MWZ4rH.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-BhsvVE1x.js";
import { t as getDiscordApprovalCapability } from "./approval-native-eg38aM8E.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-E0mQsZbE.js";
import { t as discordMessageActions$1 } from "./channel-actions-CzcT2wdi.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-BvMQV5p9.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BPox3YVE.js";
import { n as discordOutbound } from "./outbound-adapter-DAW4nn56.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-ESsTVU97.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-CE4YB4tH.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-DqGFiK-z.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-DwGv47BY.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Zhb7y_K8.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DW9kcjlL.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-CKDyTb67.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-DngBeHvV.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CncARVsL.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-Ds6BgiZ5.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-BkFpwERe.js");
