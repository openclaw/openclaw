...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-XUCBPbna.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DOrqeC4K.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-BLeNJ_B2.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-3UkMKKCd.js");
	if (params.argv) {
