...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-DN7Rz38E.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-BHEhhzEj.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-dTaCKqas.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-BiNJwH7y.js");
...
var memory_core_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-D1BYlXT3.js");
