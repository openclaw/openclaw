...
import { i as parseHealthFindingSeverity, r as healthFindingMeetsSeverity, t as exitCodeFromFindings } from "../../doctor-lint-flow-BYFq29TI.js";
import "../../health-BDl3Vg9h.js";
import { i as createPolicyAttestation, n as evaluatePolicy, r as registerPolicyDoctorChecks, t as POLICY_CHECK_IDS } from "../../register-C1FbPI5R.js";
...
function registerPolicyCli(program) {
	program.command("policy").description("Verify workspace policy conformance").command("check").description("Check policy requirements and emit an audit attestation").option("--json", "Emit JSON output").option("--severity-min <severity>", "Minimum severity: info, warning, or error").action(async (options) => {
