...
import { F as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-DP8t4y4P.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-64cTvvOa.js";
import { c as initSubagentRegistry } from "./subagent-registry-DwBMKyZB.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-DAhP8nz7.js";
import { n as listGatewayMethods } from "./server-methods-list-bsyJQHh0.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-Ejd6-BQg.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-36ZhMvZ2.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-D6Sks2Ci.js");
