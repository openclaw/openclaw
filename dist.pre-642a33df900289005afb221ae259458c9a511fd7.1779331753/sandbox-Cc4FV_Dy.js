...
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-BOyl1wgY.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-BsDXLi7j.js";
import { n as isToolAllowed } from "./tool-policy-Dg2OPt4q.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-Bo2jacA3.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-PLaGM2kn.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-C8KVpHa_.js";
import { f as isSameSsrFPolicy } from "./ssrf-DdDeGa5L.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-BTvyZC5v.js";
import { C as readBrowserRegistry, D as updateBrowserRegistry, E as removeRegistryEntry, O as updateRegistry, T as removeBrowserRegistryEntry, _ as resolveSandboxAgentId, a as execDocker, b as slugifySessionKey, c as isDockerDaemonUnavailable, g as appendWorkspaceMountArgs, k as computeSandboxBrowserConfigHash, l as readDockerContainerEnvVar, m as resolveDockerEnvPolicyEpoch, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxScopeKey, w as readRegistry, y as resolveSandboxWorkspaceDir } from "./docker-CA7YkaUF.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-Cp9YXiQ_.js";
import { A as runDockerSandboxShellCommand, D as buildPinnedRenamePlan, E as buildPinnedRemovePlan, O as buildPinnedWritePlan, T as buildPinnedMkdirpPlan, a as getSandboxBackendManager, b as relativePathEscapesContainerRoot, k as dockerSandboxBackendManager, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedAppendPlan, y as normalizeContainerPath } from "./browser-bridges-DTdew3cl.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-BGPMCxvu.js"),
				import("./exec-defaults-1t5X4Vka.js"),
				import("./skills-KHKV5XL4.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-Cf0KtBOK.js")).maybePruneSandboxes(cfg);
