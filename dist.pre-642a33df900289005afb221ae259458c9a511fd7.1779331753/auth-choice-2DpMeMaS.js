...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-DTs9uBmU.js";
import { n as loadModelCatalog } from "./model-catalog-Dwifi2Ap.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-Dhv-kecG.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CnJySSic.js";
import "./provider-auth-choice-preference-DCYLZh3O.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-B5Qrssvv.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-D_LkD93M.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-Clo31tK7.js");
