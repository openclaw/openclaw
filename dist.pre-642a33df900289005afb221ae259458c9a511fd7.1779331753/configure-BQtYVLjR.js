...
import { g as shortenHomePath, p as resolveUserPath, x as isPlainObject } from "./utils-BlCbsks0.js";
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-BM3-Vmz4.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-BBp7PSJC.js";
...
import { a as findTailscaleBinary } from "./tailscale-B58N5v3a.js";
...
import { t as ConfigMutationConflictError } from "./mutate-Dr5QVXI9.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-C1l4sccm.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-B6RIH74M.js";
import { n as applyAuthChoice } from "./auth-choice-2DpMeMaS.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DO_kM7QL.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-DCh_Nt6C.js";
import { t as applyPrimaryModel } from "./provider-model-primary-CqRIugJ-.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-B9citG0U.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BttWPrjj.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CuEnoYUt.js";
import { n as formatHealthCheckFailure } from "./health-format-DaSqSjzQ.js";
import { n as healthCommand } from "./health-CMloLdFh.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CKaRKvw5.js";
import { t as setupSkills } from "./onboard-skills-BYAas95K.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-DwK-RCgn.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-C217JJv-.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-DD81qeTA.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-C6h-THtX.js");
