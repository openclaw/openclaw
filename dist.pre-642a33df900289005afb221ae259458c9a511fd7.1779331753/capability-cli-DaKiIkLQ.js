...
import { p as normalizeThinkLevel } from "./thinking-LTIAxzAP.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-D4RL3CBM.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-DGvgHuOd.js";
import { r as callGateway, u as randomIdempotencyKey } from "./call-C4cvr8It.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-816TTVuI.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DppuT-pZ.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-DRwuLv9x.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-Buvz1_IB.js";
...
import { c as getImageMetadata, s as convertHeicToJpeg } from "./media-services-ndemcXB-.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-D-hYmazJ.js";
import { u as saveMediaBuffer } from "./store-De_Ewk5o.js";
import { t as buildExplicitSessionIdSessionKey } from "./session-Kc5hkv3I.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-B0Y_iHbF.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-at-ryxI-.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, d as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsProvider, u as listSpeechVoices, w as setTtsPersona } from "./tts-runtime-B4YJ_gJS.js";
import "./tts-BgmrI-Of.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BCjOIVNq.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-CPhxFV6H.js";
import { t as resolveMemorySearchConfig } from "./memory-search-tZUVyo_K.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CgDQxlOD.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-CePLLA1B.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CoUZxeBW.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-Bq0V9wOK.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-_z2VgeSC.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DFA3R-7w.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-BzhDLaoj.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CADbnImZ.js");
