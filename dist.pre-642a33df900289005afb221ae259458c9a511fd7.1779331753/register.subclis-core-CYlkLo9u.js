...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-CSgl8wlv.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-B3aKId6c.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-DI0bpdmR.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-DaKiIkLQ.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-CoGXtQya.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./secrets-cli-CudITUxb.js"),
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-kS5YsX22.js"),
