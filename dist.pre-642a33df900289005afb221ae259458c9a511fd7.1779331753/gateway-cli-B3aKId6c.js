...
import { t as addGatewayRunCommand } from "./run-command-dnq5DSjO.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-CuRLwikb.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-DHcsL3pB.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-bpVCPETY.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-DqagIQuT.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./health-style-DGWAk6Wn.js"));
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-Zo5DJH_d.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-DRN0XdXn.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-BVAg4sQL.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-Cwa8w7gc.js"));
...
async function callGatewayCli(method, opts, params) {
	return (await import("./call-fmoa7ur9.js")).callGatewayCli(method, opts, params);
}
async function runGatewayCommand(action, label, opts) {
	try {
		...
		if (opts?.json) {
			const { formatGatewayTransportErrorJson } = await import("./call-ClSAMpce.js");
