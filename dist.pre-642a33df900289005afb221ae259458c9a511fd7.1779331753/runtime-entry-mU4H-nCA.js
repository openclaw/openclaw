...
import { S as recordTalkObservabilityEvent, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, d as buildRealtimeVoiceAgentConsultPolicyInstructions, v as resolveRealtimeVoiceAgentConsultTools, y as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-BaNDQNxD.js";
import { f as resolveRealtimeVoiceFastContextConsult, m as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-D-5dCRKQ.js";
...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-2eUfWk3O.js";
import "./api-BA54BV7l.js";
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-CRvbGGwc.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CAXIYJM7.js";
import { t as resolveVoiceResponseModel } from "./response-model-Ci4XSDqB.js";
import { t as isProviderStatusTerminal } from "./call-status-CrtXbTqm.js";
...
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-Ffl7QAEU.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-lG80OGNj.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-lb9VgEps.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-C75IAsNM.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-DO_xxLMd.js");
...
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BwcRQMfW.js");
