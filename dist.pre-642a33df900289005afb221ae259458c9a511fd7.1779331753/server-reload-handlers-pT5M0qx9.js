...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CeDMH5dS.js";
import { i as getRuntimeConfig } from "./io-CmeoeBvq.js";
import "./installed-plugin-index-records-DhAWzfU1.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-DgdkBEdP.js";
import "./config-B3BdVqTi.js";
import { n as isRestartEnabled } from "./commands.flags-dMXmXPMW.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-DBEDlM_g.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-Dwifi2Ap.js";
import { l as getTotalQueueSize } from "./command-queue-KkDNdiAZ.js";
import { r as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-txAsA1y5.js";
import "./pi-bundle-mcp-tools-Cts4kShB.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-CxI-NeVc.js";
import { r as resetDirectoryCache } from "./target-resolver-lREaVYaQ.js";
...
import { _ as resolveHooksConfig } from "./hooks-ok1xCx-L.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BzMLNEFQ.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CRGsLQZD.js";
import { t as diffConfigPaths } from "./config-diff-BFU3KxZv.js";
...
import { t as buildGatewayCronService } from "./server-cron-DElBs6IO.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-cdMExpX7.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-Dx3ViteM.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-TVoBCmrG.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-BjGvEwBk.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-Doo1cJVN.js"), import("./gmail-watcher-lifecycle-B2do0-4g.js")]);
