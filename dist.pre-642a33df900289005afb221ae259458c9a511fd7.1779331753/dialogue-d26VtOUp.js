import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-Ds2WUy67.js";
import { r as loadCrestodianOverview } from "./overview-D_I6iHj0.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-_2iXT721.js")).planCrestodianCommand)({
		input,
		overview
	});
