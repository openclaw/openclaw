...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-C51VTAKH.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-C2ym8-NP.js";
...
import { c as updateSessionStoreEntry, s as updateSessionStore } from "./store-r4WEtwxi.js";
...
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-CGufEBPx.js";
...
import { a as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-CYUFeIiq.js";
...
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN, s as stripContinuationSignal } from "./tokens-8qFZF4Bs.js";
import { d as stripHeartbeatToken } from "./heartbeat-BflnohTA.js";
import { r as enqueueCommitmentExtraction } from "./runtime-tAY_74Df.js";
...
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-Dx7TD9jt.js";
import { n as resolveSendPolicy } from "./send-policy-B2F_FIHU.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-tMQxmuX2.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-BnNAA7L2.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-DtpxJuH0.js";
import { t as checkContextPressure } from "./context-pressure-D_nK6fmw.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-CUBTwhXl.js";
import { c as resolveCliRuntimeExecutionProvider, o as listLegacyRuntimeModelProviderAliases, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-n90EjWho.js";
import "./pi-embedded-helpers-CiLGvxHU.js";
import { t as formatProviderModelRef } from "./model-runtime-NSmvD3mm.js";
import "./fallback-notice-state-DevLG45p.js";
...
import { r as runWithModelFallback } from "./model-fallback-D670_taC.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-CVtWTJVS.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Dng9YkQe.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-DxULzr7i.js";
import { i as isRenderablePayload, n as applyReplyThreading } from "./reply-payloads-hWjOKEB7.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-Divmsywq.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CEiCyhgk.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BWqVJcRH.js";
import "./sandbox-C22p0rRQ.js";
import { n as readPostCompactionContext } from "./post-compaction-context-BtcB2sTb.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-DqHXnAAv.js";
import { a as resolveReplyRunFireReason, c as runCliAgentWithLifecycle, i as runAgentTurnWithFallback, n as resolveRunAfterAutoFallbackPrimaryProbeRecheck, o as normalizeReplyPayloadDirectives, r as resolveSessionRuntimeOverrideForProvider, t as buildKnownAgentRunFailureReplyPayload } from "./agent-runner-execution-C7-h9zLP.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-C-Bn86Ir.js";
...
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-BbiFuDop.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-Dc6S_yRq.js";
import { n as incrementCompactionCount } from "./session-updates-Bs8V9MO4.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-B2c-z_vZ.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CcKQU6xI.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-D4-eJ3Cf.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-C0aTBft8.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-C-HlAkgn.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-BoFamVvN.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-D0EHPDVD.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-BhWlEU4F.js"));
		...
		try {
							...
							const result = await runEmbeddedPiAgent({
								...
								requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
									...
									triggerCompaction: async (request) => {
										try {
											const { compactEmbeddedPiSession } = await import("./compact.queued-BRans9CM.js");
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-CbOsk_mu.js"),
					import("./config-DJVo0Lj9.js"),
					import("./state-C52pDQJj.js"),
					import("./store-BGEHd0k_.js")
				]);
