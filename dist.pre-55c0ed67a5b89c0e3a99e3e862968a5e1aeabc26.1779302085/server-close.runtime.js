...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-4LmbsLba.js";
...
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-Bij0aCQe.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-C9_5Kh-G.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-hAJ8VHb1.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-DEyYhHoc.js");
