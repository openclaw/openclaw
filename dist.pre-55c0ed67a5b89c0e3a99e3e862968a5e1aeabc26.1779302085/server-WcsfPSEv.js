import { c as normalizeOptionalString, r as lowercasePreservingWhitespace } from "./string-coerce-DyL154ka.js";
import { t as isTruthyEnvValue } from "./env-ZQdwOS7s.js";
import { v as resolveStateDir } from "./paths-r6w2eKyy.js";
import { p as resolveUserPath, s as ensureDir } from "./utils-DX02THHb.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-C6UeTsMV.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-B126I5Yx.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-B1Tss5ib.js");
