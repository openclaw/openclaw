...
import { l as redactToolPayloadText } from "./redact-Ey2piJyN.js";
...
import { S as hasEncodedFileUrlSeparator, T as trySafeFileURLToPath, t as appendFileWithinRoot } from "./fs-safe-BIhMf0UI.js";
import { o as root } from "./secure-temp-dir-BA4Qt7HV.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-DX02THHb.js";
import { r as normalizeProviderId } from "./provider-id-zTW9Rdln.js";
import { a as resolveAgentModelTimeoutMsValue, i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-O00I3vtj.js";
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-C51VTAKH.js";
...
import { c as normalizeAgentId, g as toAgentStoreSessionKey, p as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BAP1m9Ju.js";
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-C5zL9i5G.js";
...
import { i as resolveManifestContractOwnerPluginId, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-B7y3hWQJ.js";
...
import { t as logDebug } from "./logger-BhJTdrHk.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-B3cB3MOo.js";
import { h as isWindowsDrivePath } from "./archive-CGUiwoDw.js";
...
import { t as applyMergePatch } from "./merge-patch-D-5CRU16.js";
...
import { n as isRestartEnabled } from "./commands.flags-P4345ziW.js";
...
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-CKhGBxFS.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-BT_ChJF9.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-jkjR4KKF.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-C2CKR7AD.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-B5zlPNZy.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-BuYtWSh4.js";
import { n as assertSandboxPath } from "./sandbox-paths-IsaTHaDu.js";
import "./local-file-access-CBe_wA_B.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-T-Mdri40.js";
...
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-QI_1eBWp.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BiaPnQ59.js";
import { n as resolveSessionConversationRef } from "./session-conversation-e4UeXnbe.js";
...
import { u as extractDeliveryInfo } from "./sessions-Cq6eeDnZ.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DppuT-pZ.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-BSjd3Cpt.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-DNNsssL9.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-DYH-0Q9Z.js";
...
import { n as resolveApiKeyForProfile } from "./oauth-Dm9ArmB2.js";
import { n as listProfilesForProvider } from "./profile-list-CHoS1zzi.js";
import { i as resolveAuthProfileOrder } from "./order-CBFEqgPs.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-cdTr1v5l.js";
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-IayyO3Fd.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-D0oEsPXl.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-C9NomKZ1.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-BAPT3_qw.js";
import "./tool-policy-BlP6C_g2.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-DtgNHAc_.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CALcaA7l.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BTY0v6hD.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, r as SUBAGENT_SPAWN_CONTEXT_MODES, t as spawnSubagentDirect } from "./subagent-spawn-Dgyk7GtE.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BhdCJUty.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-8u25srBl.js";
...
import { r as stripToolMessages } from "./chat-history-text-BCtP16d0.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-B_rDsTfn.js";
...
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-C4fTjcHn.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-V9h3eRNz.js";
...
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-tMQxmuX2.js";
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-DtpxJuH0.js";
import { t as canonicalizeBase64 } from "./base64-D03BM6T6.js";
import { c as getImageMetadata } from "./media-services-CNV3toly.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-UsovVVr3.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-D7NmlpvJ.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-BOWOouZ8.js";
import { a as resolvePluginTools } from "./tools-Cb1I9nR6.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DWrA5jWG.js";
import { _ as listChannelSupportedActions, c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, h as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-C7WnUagP.js";
...
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-Co446nPw.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-W5tOLpT6.js";
import { n as extractAssistantText } from "./pi-embedded-utils-GHGbET4o.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DB5PVhvQ.js";
import { n as runWithImageModelFallback } from "./model-fallback-D670_taC.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-D_CtWWti.js";
import "./delivery-context-FOBNKhAY.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BgXXPpNN.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-Dr9I9xPC.js";
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-DrUMMJCy.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-IDt7VwpB.js";
...
import { t as inferLegacyName } from "./normalize-C4yvCBAK.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-d09aZBE_.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-B-l_OYPF.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-DvaYRd7s.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BCSnkjue.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DGPbVPlm.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-Cg82iFoi.js";
...
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-LN21lSHB.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-VNjCvos2.js";
import { r as getDefaultLocalRoots } from "./local-media-access-D6MhlaSf.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BSyRS66Z.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-ewoyIEIK.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-BRdfa-jq.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BIGZmdOg.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DWUR-WD-.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-BdYnCMua.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Bz-BOjpk.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-Bxp7ZTm4.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-BGCdi2WR.js";
import { n as normalizeMediaProviderId } from "./provider-id-BETgOIvU.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BNGCThGB.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-CSbta5C6.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-CoAJYdGq.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-DGvNSGdr.js";
import { s as resolveTimeoutMs } from "./resolve-BIw9w_kw.js";
import { t as buildProviderRegistry } from "./runner-C4oL2ZPM.js";
...
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-CpDok1qA.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-D79t6FZ4.js";
...
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-W4P3O6Nc.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BZh3AVM8.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-B7YfQL1b.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CUnMI0Oj.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-47S3bsk_.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-DSEbWPuJ.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-BYjdb91K.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-TIf_-pex.js";
import { p as registerSubagentRun } from "./subagent-registry-BZiTnX8h.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-Ba77-rs0.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-C21uhAL5.js";
import { k as textToSpeech } from "./tts-runtime-CKfv1i60.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-C1p7ISu5.js";
...
import { i as runWebSearch } from "./runtime-BsMNvSN1.js";
import "./web-search-provider-common-BriPFL-w.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-CQ7RjtbL.js");
		await sendMessage({
			cfg: params.config,
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-Dnv5qMRx.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-CLK6qisw.js"));
