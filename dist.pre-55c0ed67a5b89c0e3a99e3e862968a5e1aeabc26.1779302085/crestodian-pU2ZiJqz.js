...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-CZVfLUWo.js";
import { r as resolveCrestodianOperation } from "./dialogue-DLqn5tGB.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BZMu5n2f.js")).runCrestodianTui;
	opts.onReady?.();
