import { c as normalizeOptionalString, d as normalizeStringifiedOptionalString } from "./string-coerce-DyL154ka.js";
import { t as formatCliCommand } from "./command-format-BPjMauol.js";
import { r as normalizeProviderId } from "./provider-id-zTW9Rdln.js";
import { n as normalizeAgentModelRefForConfig } from "./model-input-O00I3vtj.js";
import "./agent-scope-C51VTAKH.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default--mMaLHGD.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-C5zL9i5G.js";
import { t as parseDurationMs } from "./parse-duration-CD4d_yk2.js";
import { a as resolvePluginSetupRegistry, i as resolvePluginSetupProvider } from "./setup-registry-DNrzTRKL.js";
import { n as resolvePluginProviders } from "./providers.runtime-dlEtSaSq.js";
import { s as loadAuthProfileStoreForRuntime } from "./store-C9PhwTe-.js";
import "./model-selection-normalize-DYH-0Q9Z.js";
...
import { r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-B4o8ulLL.js";
import { n as clearAuthProfileCooldown } from "./usage-BIRjpfuK.js";
import "./workspace-Czw4sUL8.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-ByHszczc.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-SxJSzzKf.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-CXtaMT0v.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-ha191Iu2.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-yFbEzcQS.js";
import { t as isRemoteEnvironment } from "./remote-env-CBc5PaHP.js";
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-DN88h2d3.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: async (url) => {
			const { openUrl } = await import("./onboard-helpers-O3jcgqHu.js");
			await openUrl(url);
		},
