...
import { o as isPrivateOrLoopbackHost } from "./net-DCUMtgJy.js";
import "./string-coerce-runtime-CuC2PU-F.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DjT-WELm.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-BK_JJlXA.js";
import "./setup-DTR6AGFR.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-CIwd6x-p.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-Dhj2e_Fx.js";
import { a as resolveMatrixAccountConfig } from "./account-config-BjHneoP2.js";
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-RoZX59IM.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CFMnosAp.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-DIUWnXNy.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DExRbAi8.js";
import { n as updateMatrixAccountConfig } from "./config-update-CtZZiOv1.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CQZtOc45.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-DANMbou9.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-rYBh7ZDo.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-CMbyLLsh.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-B21XR95e.js");
