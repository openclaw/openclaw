...
import { n as extractAssistantText } from "./pi-embedded-utils-GHGbET4o.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-mYtMMDd7.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-fqZlS96e.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-BhWlEU4F.js")).runEmbeddedPiAgent;
}
