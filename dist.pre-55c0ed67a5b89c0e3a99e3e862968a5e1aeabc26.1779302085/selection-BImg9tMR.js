...
import { a as redactSensitiveFieldValueWithConfig, n as isSensitiveFieldKey, r as redactSecrets, u as redactToolPayloadTextWithConfig } from "./redact-Ey2piJyN.js";
...
import { p as resolveUserPath, y as truncateUtf16Safe } from "./utils-DX02THHb.js";
...
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-C5zL9i5G.js";
...
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-ClEEi6Gi.js";
import { T as getCompactionProvider } from "./loader-C2CKR7AD.js";
import { k as listRegisteredPluginAgentPromptGuidance } from "./command-registration-B3--5SDz.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-DNOIUQa8.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-CnYTUlm2.js";
...
import { D as isCacheEnabled, O as resolveCacheTtlMs, T as createExpiringMapCache, t as loadSessionStore } from "./store-load-QI_1eBWp.js";
...
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-r4WEtwxi.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DppuT-pZ.js";
import { d as redactTranscriptMessage, o as withOwnedSessionTranscriptWrites } from "./transcript-DONnOcmt.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-CGufEBPx.js";
...
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-K7UOIc-J.js";
...
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage } from "./usage-HiJpzhay.js";
import { C as firstEnumerableOwnKeys, S as boundedJsonUtf8Bytes, T as jsonUtf8BytesOrInfinity, _ as stripInternalMetadataForDisplay } from "./session-utils.fs-C4fTjcHn.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-8qFZF4Bs.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DbpcwfOZ.js";
...
import { l as setReplyPayloadMetadata } from "./reply-payload-zK8rsIcE.js";
...
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-CytkDZmG.js";
import { A as isEmbeddedMode, O as isStrictAgenticSupportedProviderModel, k as stripProviderPrefix, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-CNqNfhIn.js";
...
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-wP74LKJz.js";
...
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-DFRBcvSQ.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Czw4sUL8.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DVTD7Kwp.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-ku9xSgCV.js";
import { _ as listChannelSupportedActions, b as resolveChannelReactionGuidance, v as resolveChannelMessageToolHints, y as resolveChannelPromptCapabilities } from "./pi-tools.before-tool-call-C7WnUagP.js";
...
import { C as isMessagingTool, S as isMessageToolSendActionName, T as supportsModelTools, _ as isToolResultError, a as logAgentRuntimeToolDiagnostics, b as sanitizeToolResult, d as extractMessagingToolSend, f as extractToolErrorCode, g as filterToolResultMediaUrls, h as extractToolResultText$1, i as shouldAllowProviderOwnedThinkingReplay, l as runAgentCleanupStep, m as extractToolResultMediaArtifact, n as createAgentToolResultMiddlewareRunner, o as normalizeAgentRuntimeTools, p as extractToolErrorMessage, r as resolveTranscriptPolicy, t as buildEmbeddedAttemptToolRunContext, u as buildToolLifecycleErrorResult, v as isToolResultTimedOut, w as isMessagingToolSendAction, x as collectTextContentBlocks, y as sanitizeToolArgs } from "./attempt.tool-run-context-Dd_0-Enh.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-B1Z1qMqF.js";
import { a as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-DwEvzZMt.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-C2Q0cN7b.js";
...
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-DB5PVhvQ.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-BQzqF871.js";
import { l as buildApiErrorObservationFields, s as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-D670_taC.js";
import { t as log$5 } from "./logger-JwYbMk1I.js";
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-D_CtWWti.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-CVtWTJVS.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-cJFr_H_g.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-C7dE3f5_.js";
...
import { n as buildSubagentList } from "./subagent-list-Ba77-rs0.js";
import { o as listControlledSubagentRuns } from "./subagent-control-C21uhAL5.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, s as resolveAgentPromptSurfaceForSessionKey, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-BDRnYSfB.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-TEx-s2oD.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-T51pGsv9.js";
import { _ as mergeTransportHeaders, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-B3HrHjqh.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-0_XsWjZ0.js";
import { o as resolveSandboxContext } from "./sandbox-C22p0rRQ.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-CuzqmS_Z.js";
import { t as detectRuntimeShell } from "./shell-utils-BDYMhC5E.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-ByJbp-cx.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-BW2i4mhX.js";
import "./skills-DfvSkthc.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-3GXn1Tt3.js";
import "./tool-loop-detection-C9_Q6X7R.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible, a as createCodexNativeWebSearchWrapper } from "./proxy-stream-wrappers-BhlrI-GZ.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-Ci2T6c4V.js";
import { r as resolveCompactionTimeoutMs } from "./compaction-safety-timeout-DZX3bbpS.js";
...
import { t as extractSections } from "./post-compaction-context-BtcB2sTb.js";
...
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-CEH_spMV.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-CjiQgpVM.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-BPqo3InZ.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-C7SUYm6I.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-YUc2rvlg.js";
import { t as detectAndLoadPromptImages } from "./images-CdcSd2Qu.js";
...
function createCodeModeTools(ctx) {
	return [markCodeModeControlTool({
		...
		parameters: Type.Object({
			code: Type.String({ description: "JavaScript or TypeScript source to run. The `tools` object (search/describe/call) and `ALL_TOOLS` are available in scope; Node built-in modules are not." }),
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-CuZissCA.js"));
...
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-B0tVXf14.js"));
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		try {
			...
			const promptActiveSession = (prompt, options) => withOwnedSessionTranscriptWrites({
				sessionFile: params.sessionFile,
				sessionKey: params.sessionKey,
				withSessionWriteLock: (operation) => sessionLockController.withSessionWriteLock(operation)
			}, async () => abortable$1(trackPromptSettlePromise(activeSession.prompt(prompt, options))));
...
//#endregion
export { consumeCompactionSafeguardCancelReason as $, dedupeDuplicateUserMessagesForCompaction as A, resolveEmbeddedAgentStreamFn as B, createEmbeddedRunStageTracker as C, rotateTranscriptAfterCompaction as D, resolveBootstrapMode as E, toSessionToolAllowlist as F, sanitizeSessionHistory as G, prewarmSessionFile as H, applySystemPromptOverrideToSession as I, getHistoryLimitFromSessionKey as J, validateReplayTurns as K, buildEmbeddedSystemPrompt as L, mapThinkingLevel as M, collectAllowedToolNames as N, rotateTranscriptFileAfterCompaction as O, collectRegisteredToolNames as P, isRealConversationMessage as Q, createSystemPromptOverride as R, EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as S, shouldWarnEmbeddedRunStageSummary as T, trackSessionManagerAccess as U, resolveEmbeddedRunSkillEntries as V, createEmbeddedPiResourceLoader as W, buildEmbeddedExtensionFactories as X, limitHistoryTurns as Y, hasMeaningfulConversationContent as Z, resolveRateLimitProfileRotationLimit as _, shouldTreatEmptyAssistantReplyAsSilent as _t, RUNTIME_AUTH_REFRESH_MARGIN_MS as a, STRICT_AGENTIC_BLOCKED_TEXT as at, createUsageAccumulator as b, isReasoningTagProvider as bt, buildErrorAgentMeta as c, resolveAttemptReplayMetadata as ct, resolveActiveErrorContext as d, resolvePlanningOnlyRetryInstruction as dt, setCompactionSafeguardCancelReason as et, resolveFinalAssistantRawText as f, resolvePlanningOnlyRetryLimit as ft, resolveOverloadProfileRotationLimit as g, resolveSilentToolResultReplyPayload as gt, resolveOverloadFailoverBackoffMs as h, resolveRunLivenessState as ht, selectAgentHarness as i, collectRuntimeChannelCapabilities as it, flushPendingToolResultsAfterIdle as j, shouldRotateCompactionTranscript as k, buildUsageAgentMetaFields as l, resolveEmptyResponseRetryInstruction as lt, resolveMaxRunRetryIterations as m, resolveReplayInvalidFlag as mt, resolveAvailableAgentHarnessPolicy as n, repairSessionFileIfNeeded as nt, RUNTIME_AUTH_REFRESH_MIN_DELAY_MS as o, extractPlanningOnlyPlanDetails as ot, resolveFinalAssistantVisibleText as p, resolveReasoningOnlyRetryInstruction as pt, buildEmbeddedMessageActionDiscoveryInput as q, runAgentHarnessAttempt as r, buildUsageWithNoCost as rt, RUNTIME_AUTH_REFRESH_RETRY_MS as s, resolveAckExecutionFastPathInstruction as st, maybeCompactAgentHarnessSession as t, guardSessionManager as tt, createCompactionDiagId as u, resolveIncompleteTurnPayloadText as ut, resolveReportedModelRef as v, createEmbeddedRunReplayState as vt, formatEmbeddedRunStageSummary as w, mergeUsageIntoAccumulator as x, createTrajectoryRuntimeRecorder as xt, scrubAnthropicRefusalMagic as y, observeReplayMetadata as yt, resolveEmbeddedAgentBaseStreamFn as z };
