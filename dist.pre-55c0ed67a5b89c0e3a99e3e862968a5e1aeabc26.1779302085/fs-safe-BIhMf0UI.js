...
import { i as isPathInside, m as FsSafeError, r as isNotFoundPathError, s as isSymlinkOpenError } from "./path-BlG8lhgR.js";
...
import { d as expandHomePrefix, o as root, p as resolveUserPath, s as getFsSafeTestHooks, t as resolveSecureTempRoot } from "./secure-temp-dir-BA4Qt7HV.js";
import { t as assertSafePathPrefix } from "./safe-path-segment-km_q4Jns.js";
...
async function assertNoSymlinkSegments(params) {
	...
	if (relative === ".." || relative.startsWith(`..${path.sep}`) || path.isAbsolute(relative)) throw new Error(`Invalid path: must stay within ${params.scopeLabel}`);
