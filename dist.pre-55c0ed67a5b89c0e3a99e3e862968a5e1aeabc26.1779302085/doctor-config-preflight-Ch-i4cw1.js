...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-B3cB3MOo.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { t as note } from "./note-BhDc7CTR.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-oS4P_gL_.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DVsQUZqO.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DR7rBvYS.js");
