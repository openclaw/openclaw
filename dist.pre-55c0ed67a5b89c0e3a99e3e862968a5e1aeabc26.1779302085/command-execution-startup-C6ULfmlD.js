...
import { a as routeLogsToStderr } from "./console-BIEzsfPC.js";
import { t as resolveCliCommandPathPolicy } from "./command-path-policy-CwMPpkw7.js";
import { t as resolveCliStartupPolicy } from "./command-startup-policy-ufiwoWfY.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DKDCZWUL.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-D4CFbhQH.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CWac3jx1.js");
	if (params.argv) {
