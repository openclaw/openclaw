...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef } from "./types.secrets-D2HSDKMs.js";
...
import { r as formatInvalidPortOption } from "./error-format-BfFDdqsq.js";
import { t as resolveControlUiLinks } from "./control-ui-links-BSo6xNaU.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CZ5M6e25.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DxIyCsU_.js";
import { t as runSetupWizard } from "./setup-Djyw7Jnb.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-CGPDOJMx.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BR9CWo8s.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-BvGc-u1k.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-D00pMG35.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-DMZBfESi.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BFlvGa-l.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-sXdqh1rG.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-jGcfgCBT.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-C8NYUQ8I.js");
