import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-sxyuqPfY.js";
import { r as loadCrestodianOverview } from "./overview-CZVfLUWo.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-S5JXK9KB.js")).planCrestodianCommand)({
		input,
		overview
	});
