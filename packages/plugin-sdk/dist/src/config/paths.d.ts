...
export declare function isClaworksProduct(env?: NodeJS.ProcessEnv): boolean;
...
export declare function resolveNewStateDir(homedir?: () => string, env?: NodeJS.ProcessEnv): string;
/**
 ...
 */
export declare function resolveGatewayLockDir(tmpdir?: () => string, env?: NodeJS.ProcessEnv): string;
/**
