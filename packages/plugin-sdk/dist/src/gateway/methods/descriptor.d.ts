...
export declare const NODE_GATEWAY_METHOD_SCOPE: "node";
export declare const DYNAMIC_GATEWAY_METHOD_SCOPE: "dynamic";
export type GatewayMethodScope = OperatorScope | typeof NODE_GATEWAY_METHOD_SCOPE | typeof DYNAMIC_GATEWAY_METHOD_SCOPE;
