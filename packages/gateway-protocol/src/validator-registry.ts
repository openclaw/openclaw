...
export const validateSessionsDiagnoseParams = compile(S.SessionsDiagnoseParamsSchema);
export const validateSessionsDiagnoseResult = compile(S.SessionsDiagnoseResultSchema);
