...
export const ProtocolSchemas = {
  ...
  // Project workspace grouping, project chats, and shared context.
  ProjectStatus: ProjectStatusSchema,
  ProjectChatStatus: ProjectChatStatusSchema,
  ProjectSummary: ProjectSummarySchema,
  ProjectDetail: ProjectDetailSchema,
  ProjectChatSummary: ProjectChatSummarySchema,
  ProjectContext: ProjectContextSchema,
  ProjectRoleStatus: ProjectRoleStatusSchema,
  ProjectRoleSummary: ProjectRoleSummarySchema,
  ProjectDocumentStatus: ProjectDocumentStatusSchema,
  ProjectDocumentSummary: ProjectDocumentSummarySchema,
  ...
  ProjectsGetResult: ProjectsGetResultSchema,
  ProjectsMutationResult: ProjectsMutationResultSchema,
  ProjectsCreateParams: ProjectsCreateParamsSchema,
  ProjectsPatchParams: ProjectsPatchParamsSchema,
  ProjectsArchiveParams: ProjectsArchiveParamsSchema,
  ProjectsRestoreParams: ProjectsRestoreParamsSchema,
  ProjectsRolesListParams: ProjectsRolesListParamsSchema,
  ProjectsRolesListResult: ProjectsRolesListResultSchema,
  ProjectsRoleMutationResult: ProjectsRoleMutationResultSchema,
  ProjectsRolesCreateParams: ProjectsRolesCreateParamsSchema,
  ProjectsRolesPatchParams: ProjectsRolesPatchParamsSchema,
  ProjectsRolesArchiveParams: ProjectsRolesArchiveParamsSchema,
  ProjectsRolesRestoreParams: ProjectsRolesRestoreParamsSchema,
  ProjectsDocumentsListParams: ProjectsDocumentsListParamsSchema,
  ProjectsDocumentsListResult: ProjectsDocumentsListResultSchema,
  ProjectsDocumentMutationResult: ProjectsDocumentMutationResultSchema,
  ProjectsDocumentsCreateParams: ProjectsDocumentsCreateParamsSchema,
  ProjectsDocumentsImportParams: ProjectsDocumentsImportParamsSchema,
  ProjectsDocumentsImportResult: ProjectsDocumentsImportResultSchema,
  ProjectsDocumentsPatchParams: ProjectsDocumentsPatchParamsSchema,
  ProjectsDocumentsArchiveParams: ProjectsDocumentsArchiveParamsSchema,
  ProjectsDocumentsRestoreParams: ProjectsDocumentsRestoreParamsSchema,
  ProjectsChatsListParams: ProjectsChatsListParamsSchema,
  ProjectsChatsListResult: ProjectsChatsListResultSchema,
  ProjectsChatsResolveParams: ProjectsChatsResolveParamsSchema,
  ProjectsChatsResolveResult: ProjectsChatsResolveResultSchema,
  ProjectsChatMutationResult: ProjectsChatMutationResultSchema,
  ProjectsChatsAttachParams: ProjectsChatsAttachParamsSchema,
  ProjectsChatsPatchParams: ProjectsChatsPatchParamsSchema,
  ProjectsChatsArchiveParams: ProjectsChatsArchiveParamsSchema,
  ProjectsChatsRestoreParams: ProjectsChatsRestoreParamsSchema,
  ProjectsChatsDetachParams: ProjectsChatsDetachParamsSchema,
  ProjectsContextGetParams: ProjectsContextGetParamsSchema,
  ProjectsContextPatchParams: ProjectsContextPatchParamsSchema,
  ProjectsContextResult: ProjectsContextResultSchema,
