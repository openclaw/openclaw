...
import {
  ...
  DurableWakeDeliveryAttemptSchema,
...
export const ProtocolSchemas = {
  ...
  DurableWakeIdParams: DurableWakeIdParamsSchema,
  DurableWakeDeliveryAttemptsListParams: DurableWakeDeliveryAttemptsListParamsSchema,
  DurableWakeControlParams: DurableWakeControlParamsSchema,
  DurableWakeSupersedeParams: DurableWakeSupersedeParamsSchema,
  DurableWakeMarkParams: DurableWakeMarkParamsSchema,
  DurableWake: DurableWakeSchema,
  DurableWakeDeliveryAttempt: DurableWakeDeliveryAttemptSchema,
  DurableWakeInspection: DurableWakeInspectionSchema,
  DurableUnresolvedObligation: DurableUnresolvedObligationSchema,
  DurableWakeListResult: DurableWakeListResultSchema,
  DurableObligationsListResult: DurableObligationsListResultSchema,
  DurableWakeInspectResult: DurableWakeInspectResultSchema,
  DurableWakeDeliveryAttemptsListResult: DurableWakeDeliveryAttemptsListResultSchema,
  DurableWakeControlResult: DurableWakeControlResultSchema,
