...
export type QuestionAnswer = SchemaType<"QuestionAnswer">;
export type QuestionListParams = SchemaType<"QuestionListParams">;
export type QuestionResolveParams = SchemaType<"QuestionResolveParams">;
