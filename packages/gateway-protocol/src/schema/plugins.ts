...
/** One plugin-provided Control UI navigation entry. */
export const PluginControlUiEntryPointSchema = closedObject({
  id: NonEmptyString,
  pluginId: NonEmptyString,
  pluginName: Type.Optional(NonEmptyString),
...
/** Empty request payload for listing plugin Control UI entries. */
export const PluginsUiEntryPointsParamsSchema = closedObject({});

export const PluginsUiEntryPointsResultSchema = closedObject({
  ok: Type.Literal(true),
  entryPoints: Type.Array(PluginControlUiEntryPointSchema),
});

export const PluginsUiEntryPointLaunchParamsSchema = closedObject({
  id: NonEmptyString,
  pluginId: NonEmptyString,
  path: NonEmptyString,
...
export const PluginsUiEntryPointLaunchResultSchema = closedObject({
  ok: Type.Literal(true),
  path: NonEmptyString,
...
export type PluginControlUiEntryPoint = Static<typeof PluginControlUiEntryPointSchema>;
...
export type PluginsUiEntryPointsParams = Static<typeof PluginsUiEntryPointsParamsSchema>;
export type PluginsUiEntryPointsResult = Static<typeof PluginsUiEntryPointsResultSchema>;
export type PluginsUiEntryPointLaunchParams = Static<typeof PluginsUiEntryPointLaunchParamsSchema>;
export type PluginsUiEntryPointLaunchResult = Static<typeof PluginsUiEntryPointLaunchResultSchema>;
