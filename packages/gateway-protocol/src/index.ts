...
export const validateSessionsDiagnoseParams = lazyCompile(SessionsDiagnoseParamsSchema);
export const validateSessionsDiagnoseResult = lazyCompile(SessionsDiagnoseResultSchema);
