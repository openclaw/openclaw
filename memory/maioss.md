...
- `f8b2c17 fix: suppress flake8 F401 false positive on CAVDSearchResponse (used as response_model) (02-23)`
- `22a39e0 fix: rewrite region.ts with proper UTF-8 Korean text (was UTF-16 LE with mojibake) (02-23)`
- `ae6a4f0 fix: convert region.ts to UTF-8 and drop arm64 Docker build (02-23)`
- `3956ef8 fix: resolve flake8 F401 unused imports and prefer-const ESLint error (02-23)`
- `b008dde fix: add libicu-dev to fix scancode-toolkit ICU_VERSION build error (02-23)`
