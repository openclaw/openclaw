...
- [ ] OpenAI API Key → `.env`
- [ ] Zalo OA 생성 ← **✅ +84867421036 번호 개통 완료 (2026-03-12, 호치민 현지 개통)** → 즉시 진행 가능!
...
| 2026-03-12 | 지니님 베트남 호치민 도착 + +84867421036 개통 완료 | Zalo OA 블로커 해소 — M03 Dead Lead Reactivator Zalo 전환 즉시 착수 가능    |
...
- `63791be docs: add TikTok account setup status (2026-03-12) (03-12)`
- `462f75f chore: apply regression-guard skill (scaffold) (03-12)`
- `b67948d chore: sync local changes (03-02)`
...
- **Path**: gcloud.cmd (User PATH에 있음)
- **Version**: 554.0.0
- 주요 명령: `gcloud auth login`, `gcloud config set project <ID>`, `gcloud services enable sheets.googleapis.com`

## Zalo OA (2026-03-12)

- **OA 이름**: BnF Beauty Vietnam
- **OA ID**: 3248206969121202907
- **상태**: 심사 중 (Đang chờ duyệt), 기한 2026-03-26
- **기업 인증 필요**: Cách 1 — 사업자등록증 제출 후 활성화
- **다음**: Zalo Developer App 생성 → ZALO_APP_ID/SECRET 획득

---

## TikTok 계정 & Developer 앱 셋업 완료 (2026-03-12)
...
| Business Center ID | 7616322553153454097 (BnF Beauty Vietnam_bc_faxesl)            |
| Ads Manager ID     | 7616322598095552513 (BnF Beauty Vietnam_adv)                  |
| Developer App ID   | 7616319646207363128 (MAIBEAUTY)                               |
| Developer App URL  | https://developers.tiktok.com/app/7616319646207363128/pending |

### Content Posting API 신청 완료

- Products: Login Kit, Content Posting API (video.upload), Share Kit, Webhooks
- Status: Draft (Production 리뷰 전 Sandbox에서 개발 가능)
- Client Key/Secret: 앱 페이지 Credentials 섹션 ▼ 클릭으로 확인

### M01 TikTok Commerce 다음 단계

1. Client Key/Secret 복사 → MAIBEAUTY .env 추가
2. TikTok OAuth callback URL 구현
3. video.upload API 연동 (Content Posting API)
4. Sandbox 테스트 완료 후 Production 리뷰 제출 (아이콘, 데모영상 필요)

---

## 🔑 MAIBEAUTY 전체 Credential 마스터 (2026-03-12)

> ⚠️ 이 파일은 private repo — API 키 보관 안전
...
| ----------------------- | -------------------------------- |
| 이메일                  | jini92.lee@gmail.com             |
| Business Center 이름    | BnF Beauty Vietnam_bc_faxesl     |
| Business Center ID      | 7616322553153454097              |
| Ads Manager 이름        | BnF Beauty Vietnam_adv           |
| Ads Manager ID (aadvid) | 7616322598095552513              |
| 로그인 URL              | https://ads.tiktok.com/i18n/home |
...
| ------------------ | ------------------------------------------------------------- |
| 이메일             | jini92.lee@gmail.com                                          |
| Developer App 이름 | MAIBEAUTY                                                     |
| App ID             | 7616319646207363128                                           |
| App URL            | https://developers.tiktok.com/app/7616319646207363128/pending |
| Client Key         | ⚠️ 앱 페이지 Credentials ▼ 클릭 후 확인/복사 필요             |
| Client Secret      | ⚠️ 앱 페이지 Credentials ▼ 클릭 후 확인/복사 필요             |
| Products           | Login Kit, Content Posting API, Share Kit, Webhooks           |
| video.upload scope | ✅ 포함됨                                                     |
| App Status         | Draft (Sandbox 개발 가능, Production 리뷰 전)                 |
...
| OA 이름           | Lov2Luv                                    |
| OA ID             | 3248206969121202907                        |
| 상태              | Đang chờ duyệt (심사 중)                   |
| 관리 URL          | https://oa.zalo.me/manage/profile          |
| 담당자 이메일     | jini92.lee@gmail.com                       |
| 담당자 전화       | +84867421036                               |
| Zalo 앱 ID/Secret | ⚠️ OA 승인 후 Zalo Developer에서 발급 필요 |
| 마감              | 2026-03-26 (기업 인증)                     |
...
| 항목             | 값                                                  |
| ---------------- | --------------------------------------------------- |
| Admin URL        | https://jini92.github.io/MAIBEAUTY/                 |
| API URL          | https://maibeauty-api-production.up.railway.app     |
| Admin 로그인     | admin@maibeauty.com / Maibeauty2026!                |
| Worker 로그인    | worker-test@maibeauty.com / WorkerTest2026!         |
| VIDEO_WORKER_KEY | 0aP87uilc4OH93kTwjYbXpNnhBgrQx6e                    |
| R2 Public URL    | https://pub-256514584116411a85e99da201cfc4a6.r2.dev |

### Google Services

| 항목             | 값                                                                                       |
| ---------------- | ---------------------------------------------------------------------------------------- |
| Google SA 이메일 | maibeauty-crm@maibeauty.iam.gserviceaccount.com                                          |
| CRM 스프레드시트 | https://docs.google.com/spreadsheets/d/1r_CSTQDPdZtiPTqPdXjYvpRmtZe0oH6cGoMaoboBFO4/edit |
...
| 항목                  | 값                           |
| --------------------- | ---------------------------- |
| 지니 한국 연락처      | 미등록 (베트남 번호 사용 중) |
| 지니 베트남 번호      | +84867421036                 |
| 김미정 대표 한국 번호 | +821025881057                |
| 김미정 여권번호       | M995P8829                    |
| Lov2Luv 사업자번호    | 315-20-72461                 |
