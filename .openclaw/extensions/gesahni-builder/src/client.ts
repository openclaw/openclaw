import type { GesahniBuilderConfig } from "./config.js";
...
function resolveBearerToken(config: GesahniBuilderConfig, auth: BridgeAuthMode): string {
...
export function createGesahniBuilderClient(params: {
  config: GesahniBuilderConfig;
