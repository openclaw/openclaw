import type { GesahniResearcherConfig } from "./config.js";
...
function resolveBearerToken(config: GesahniResearcherConfig, auth: BridgeAuthMode): string {
...
export function createGesahniResearcherClient(params: {
  config: GesahniResearcherConfig;
