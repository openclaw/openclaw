import type { GesahniOperatorConfig } from "./config.js";
...
function resolveBearerToken(config: GesahniOperatorConfig, auth: BridgeAuthMode): string {
...
export function createGesahniOperatorClient(params: {
  config: GesahniOperatorConfig;
