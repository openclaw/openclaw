...
export OPENCLAW_INSTALL_RUNTIME_PNPM="${OPENCLAW_INSTALL_RUNTIME_PNPM:-}"
...
if [[ "$IMAGE_NAME" == "openclaw:local" ]]; then
  ...
  docker build \
    ...
    --build-arg "OPENCLAW_INSTALL_RUNTIME_PNPM=${OPENCLAW_INSTALL_RUNTIME_PNPM}" \
