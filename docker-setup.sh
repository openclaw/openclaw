...
export OPENCLAW_DOCKER_OFFICIAL_REPO="${OPENCLAW_DOCKER_OFFICIAL_REPO:-}"
...
upsert_env "$ENV_FILE" \
  ...
  OPENCLAW_DOCKER_OFFICIAL_REPO

echo "==> Building Docker image: $IMAGE_NAME"
docker build \
  --build-arg "OPENCLAW_DOCKER_APT_PACKAGES=${OPENCLAW_DOCKER_APT_PACKAGES}" \
  --build-arg "OPENCLAW_DOCKER_OFFICIAL_REPO=${OPENCLAW_DOCKER_OFFICIAL_REPO}" \
  -t "$IMAGE_NAME" \
