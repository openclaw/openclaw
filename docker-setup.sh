...
echo ""
echo "Dashboard access (HTTP requires browser secure context or allowInsecureAuth):"
echo "  From Docker host: http://127.0.0.1:${OPENCLAW_GATEWAY_PORT}/#token=${OPENCLAW_GATEWAY_TOKEN}"
echo "  Note: HTTP access may require gateway.controlUi.allowInsecureAuth=true"
echo "  Docs: https://docs.openclaw.ai/install/docker#control-ui-token-pairing-docker"
echo ""
echo "Commands:"
