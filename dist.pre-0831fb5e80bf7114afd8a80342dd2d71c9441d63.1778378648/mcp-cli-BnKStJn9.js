...
import { r as extractFirstTextBlock } from "./chat-message-content-CLyYmXKm.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-DxIM0taD.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-BTrKQNkz.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-Dl361owD.js"),
			import("./client-CFGkhyXC.js"),
			import("./client-start-readiness-DiXv76MG.js"),
			import("./method-scopes-DXLtmCxo.js"),
			import("./client-info-mWRhXYzT.js")
		]);
