...
import { a as unregisterAcpRuntimeBackend, r as registerAcpRuntimeBackend } from "./registry-CkGUpQSo.js";
...
import { s as formatPluginConfigIssue } from "./extension-shared-DdhMvWQK.js";
import { t as zod_exports } from "./zod-BDvGsSs8.js";
import "./runtime-api-CnGYL24-.js";
import { a as OPENCLAW_GATEWAY_INSTANCE_ID_ARG, i as OPENCLAW_ACPX_LEASE_ID_ARG, r as reapStaleOpenClawOwnedAcpxOrphans, s as createAcpxProcessLeaseStore, t as cleanupOpenClawOwnedAcpxProcessTree } from "./process-reaper-BpAN9EWm.js";
...
const AcpxPluginConfigSchema = zod_exports.z.strictObject({
	...
	agents: zod_exports.z.record(zod_exports.z.string(), zod_exports.z.strictObject({
		command: nonEmptyTrimmedString("agents.<id>.command must be a non-empty string"),
		args: zod_exports.z.array(zod_exports.z.string({ error: "args must be an array of strings" })).optional()
	})).optional()
});
//#endregion
...
function loadRuntimeModule() {
	runtimeModulePromise ??= import("./runtime-D26ScK3-.js");
