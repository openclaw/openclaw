...
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-BSkHzVOn.js";
...
import { b as resolveExecutableFromPathEnv, d as resolveApprovalAuditCandidatePath, p as resolveCommandResolutionFromArgv } from "./exec-safe-bin-trust-jmMsEY6g.js";
import { E as splitShellArgs, T as normalizeExecutableToken, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, h as extractEnvAssignmentKeysFromDispatchWrappers, l as isShellWrapperInvocation, m as resolveInlineCommandMatch, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, y as unwrapKnownDispatchWrapperInvocation } from "./shell-wrapper-resolution-B-rHDxqk.js";
import "./config-CW5G5Uky.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-MLkxToGL.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-CvDpDr93.js";
import { t as parsePort } from "./parse-port-BX_QYjNu.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-CsVmqHft.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-hxEKPnNB.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-Bvei-t59.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-mXC9ivDc.js";
import { a as getActivePluginRegistry } from "./runtime-DLcM2w72.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-DK2Pykna.js";
import { t as getMachineDisplayName } from "./machine-name-DF9WlEDe.js";
import { c as describeInterpreterInlineEval } from "./risks-DQVApvSX.js";
import { c as analyzeArgvCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-BGvgZRYm.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-DSSn78vz.js";
import { N as saveExecApprovals, O as resolveExecApprovals, P as requestJsonlSocket, T as requiresExecApproval, b as readExecApprovalsSnapshot, c as hasDurableExecApproval, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, o as addDurableCommandApproval, s as ensureExecApprovals, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-CtANqQBU.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DeXKnsI5.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-BjU9aQ8c.js";
import { t as formatHelpExamples } from "./help-format-Cw3bkuYB.js";
import { n as detectPolicyInlineEval } from "./policy-B7vNgCfD.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-C5FpIcHC.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-CS2HXgiI.js";
import { t as resolveNodeService } from "./node-service-D5lkBIJ6.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-tcjWgk0w.js");
