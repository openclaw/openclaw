...
import { b as assertNoWindowsNetworkPath, w as safeFileURLToPath } from "./fs-safe-Cew-WMeL.js";
...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-ZEce9oym.js";
import { a as logWarn } from "./logger-Db97zCjA.js";
import { i as runExec } from "./exec-DfATC6XG.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-Ck-o65Un.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-6W7adQeC.js";
import "./local-file-access-BcHhlnN_.js";
import { r as fetchWithTimeout } from "./fetch-timeout-DnFd5Ejx.js";
import { n as MediaFetchError, r as fetchRemoteMedia } from "./fetch-D7ooysS6.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-x20um5FI.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-BV2vYK7-.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-B-0O7VWt.js";
import { t as providerSupportsCapability } from "./provider-supports-DapH-Uqs.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CiXEcm2L.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-BevNLy6o.js";
import { t as buildRandomTempFilePath } from "./temp-download-B5TiXRtA.js";
import "./temp-path-D1jrczoF.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-By9euBqs.js";
import "./shared-CB21xtot.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-D7qU4EE2.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-C0Cdt4lf.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BzV1wJtl.js");
