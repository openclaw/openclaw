...
import { t as ConfigMutationConflictError } from "./mutate-DeaT-EF6.js";
...
import { t as note$1 } from "./note-BSRgI2Bk.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-Dqqppk7w.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-DXEnviI0.js";
import { n as applyAuthChoice } from "./auth-choice-DeAu17ql.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-BuCieif9.js";
import { i as setupChannels } from "./onboard-channels-Cg6Mhv4D.js";
...
import { t as promptCustomApiConfig } from "./onboard-custom-CyCySRFp.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CvH6K-HD.js";
import { n as formatHealthCheckFailure } from "./health-format-BOpJMHP3.js";
import { n as healthCommand } from "./health-CtHuLvho.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-C7SlG4r7.js";
import { t as setupSkills } from "./onboard-skills-CIH_SHdB.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-C7wHuea3.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CBTVvoA4.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-B2q8dmy7.js");
