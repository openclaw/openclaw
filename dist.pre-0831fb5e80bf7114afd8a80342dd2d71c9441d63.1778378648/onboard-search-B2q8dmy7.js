...
import { d as normalizeSecretInputString, s as hasConfiguredSecretInput, t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-m6J7qPGz.js";
...
import { n as sortWebSearchProviders } from "./web-search-providers.shared-BePUwjbQ.js";
import { t as resolvePluginWebSearchProviders } from "./web-search-providers.runtime.js";
import { t as sortFlowContributionsByLabel } from "./types-NEvgp89u.js";
...
async function finalizeSearchProviderSetup(params) {
	...
	if (installEntry && next.tools?.web?.search?.enabled !== false) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-2HKHR4NQ.js");
