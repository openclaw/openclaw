...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-CnELjMLl.js";
import "./model-selection-DXhHIora.js";
import { d as isGoogleModelApi, u as isGemma4ModelRequiringReasoningStrip } from "./pi-embedded-helpers-CKo0yA7g.js";
import { t as log$1 } from "./logger-LoGcZl5y.js";
import { E as shouldPreserveThinkingBlocks } from "./provider-model-shared-CaJQJU2U.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-DG3T-mZU.js");
