...
import { i as resolveAgentModelPrimaryValue, n as normalizeAgentModelRefForConfig, r as resolveAgentModelFallbackValues, t as normalizeAgentModelMapForConfig } from "./model-input-iH6kLgu0.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-kkxFBlxd.js";
import { d as resolveOwningPluginIdsForProvider } from "./providers-BqbzCAEu.js";
import { f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as modelKey, y as normalizeModelRef } from "./model-selection-shared-ydI43vWj.js";
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-B-XKgocr.js";
import "./model-selection-DXhHIora.js";
import { r as loadModelCatalog } from "./model-catalog-Cjeym3yt.js";
import { a as createLazyRuntimeSurface } from "./lazy-runtime-DugTTnYG.js";
import { i as formatTokenK } from "./shared-TEj_lGHq.js";
import { n as createProviderAuthChecker, t as resolveVisibleModelCatalog } from "./model-catalog-visibility-4xtzVUrT.js";
import { n as isModelPickerVisibleProvider, t as isModelPickerVisibleModelRef } from "./model-picker-visibility-DS1qClMj.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-CQjvUC_U.js";
...
function addModelSelectOption(params) {
	...
	if (params.seen.has(key) || HIDDEN_ROUTER_MODELS.has(key) || !isModelPickerVisibleProvider(normalizedRef.provider)) return;
	const hints = [];
	...
	if (!params.hasAuth(normalizedRef.provider)) return;
	const label = params.literalPrefixProviders.has(normalizeProviderId(normalizedRef.provider)) ? formatLiteralProviderPrefixedModelRef(normalizedRef.provider, key) : key;
	params.options.push({
		value: key,
		label,
