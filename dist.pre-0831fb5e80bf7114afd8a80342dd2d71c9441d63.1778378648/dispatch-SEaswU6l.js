...
import { n as isAcpSessionKey } from "./session-key-utils-DDEl6txh.js";
...
import { l as measureDiagnosticsTimelineSpan, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-D1FEYvuZ.js";
import { a as isDiagnosticsEnabled } from "./diagnostic-events-B9rpcO0g.js";
...
import { g as normalizeVerboseLevel } from "./thinking-BttBsIY6.js";
import "./message-channel-core-DEuXm_OH.js";
import { u as normalizeMessageChannel } from "./message-channel-CAROpxkS.js";
import { n as getGlobalPluginRegistry, t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-CIFefWGH.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-C2zlg6V4.js";
import { u as resolveStorePath } from "./paths-CaksWsrq.js";
import { f as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-qCUuej4o.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-BNE2xT6T.js";
import { C as resolveGroupSessionKey, c as updateSessionStoreEntry, m as resolveSessionStoreEntry } from "./store-DFBhxZSz.js";
import { t as normalizeChatType } from "./chat-type-HOkQqAnR.js";
import { f as markDiagnosticSessionProgress, i as logMessageQueued, r as logMessageProcessed, s as logSessionStateChange } from "./diagnostic-Be67-3Uu.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-DIRuWhms.js";
import { a as resolveToolProfilePolicy } from "./tool-policy-shared-DSnP6-Qd.js";
import { u as mergeAlsoAllowPolicy } from "./tool-policy-DpfAUcw1.js";
import { r as selectAgentHarness } from "./selection-B3n6fBiC.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-BBeT4wJ7.js";
import { r as isParentOwnedBackgroundAcpSession } from "./openclaw-tools-BRbeVxfM.js";
import { i as generateSecureInt } from "./secure-random-Bkwf8hY4.js";
import { n as getReplyPayloadMetadata } from "./reply-payload-CfCL9mne.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-CyLnxZJH.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-DkwF4ayM.js";
import { n as normalizeTtsAutoMode } from "./tts-auto-mode-D0Grccmq.js";
import { i as shouldCleanTtsDirectiveText, r as shouldAttemptTtsPayload, t as resolveConfiguredTtsMode } from "./tts-config-BWzANLz8.js";
import { i as resolveSubagentToolPolicyForSession, n as resolveEffectiveToolPolicy, r as resolveGroupToolPolicy } from "./pi-tools.policy-5WCcjGY6.js";
import { c as toPluginInboundClaimEvent, i as toInternalMessageReceivedContext, l as toPluginMessageContext, n as deriveInboundMessageHookContext, s as toPluginInboundClaimContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-IXqpbqtz.js";
import { n as resolveSilentReplySettings, r as resolveSilentReplyRewriteText } from "./silent-reply-ByjE5iJi.js";
import { t as normalizeReplyPayload } from "./normalize-reply-CHLJeYiK.js";
import { r as getSessionBindingService } from "./session-binding-service-mvdq1kQg.js";
import { n as resolveSendPolicy } from "./send-policy-C5q6tsjr.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-DFajdmTl.js";
import { r as resolveSourceReplyVisibilityPolicy, t as isExplicitSourceReplyCommand } from "./source-reply-delivery-mode-DbNm81vp.js";
import { a as buildPluginBindingUnavailableText, b as touchConversationBindingRecord, c as hasShownPluginBindingFallbackNotice, d as markPluginBindingFallbackNoticeShown, h as toPluginConversationBinding, n as buildPluginBindingDeclinedText, r as buildPluginBindingErrorText, u as isPluginOwnedSessionBindingRecord, y as resolveConversationBindingRecord } from "./conversation-binding-BC3vx4Gt.js";
import { n as hasActiveApprovalNativeRouteRuntime } from "./approval-native-route-coordinator-4ndpXRWa.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-C0xrTE_f.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CZykI8Ur.js";
import { d as resolveEffectiveReplyRoute, l as withFullRuntimeReplyConfig, t as resolveRunTypingPolicy } from "./typing-policy-R8BSJO5W.js";
import { n as commitInboundDedupe, r as releaseInboundDedupe, t as claimInboundDedupe } from "./inbound-dedupe-CUP1zmV7.js";
import { t as finalizeInboundContext } from "./inbound-context-3ZW5cwXQ.js";
import { n as registerDispatcher } from "./dispatcher-registry-zDYUrWOj.js";
...
const ttsRuntimeLoader = createLazyImportLoader(() => import("./tts.runtime-D7H3k1hT.js"));
const runtimePluginsLoader = createLazyImportLoader(() => import("./runtime-plugins.runtime.js"));
const replyMediaPathsRuntimeLoader = createLazyImportLoader(() => import("./reply-media-paths.runtime-DFuYqsP_.js"));
...
async function dispatchReplyFromConfig(params) {
	...
	*/
	...
	const runtimeProfileAlsoAllow = params.replyOptions?.sourceReplyDeliveryMode === "message_tool_only" || params.replyOptions?.sourceReplyDeliveryMode === void 0 && !isExplicitSourceReplyCommand(ctx) && (chatType === "group" || chatType === "channel" ? effectiveVisibleReplies !== "automatic" : effectiveVisibleReplies === "message_tool") ? ["message"] : [];
	...
	try {
		...
		if (hookRunner?.hasHooks("before_dispatch")) {
			const beforeDispatchResult = await traceReplyPhase("reply.before_dispatch_hooks", () => hookRunner.runBeforeDispatch({
		...
		if (hookRunner?.hasHooks("reply_dispatch")) {
			const replyDispatchResult = await traceReplyPhase("reply.reply_dispatch_hooks", () => hookRunner.runReplyDispatch({
				ctx,
		...
		const replyResult = await traceReplyPhase("reply.run_reply_resolver", () => replyResolver(ctx, {
			...params.replyOptions,
			sourceReplyDeliveryMode,
