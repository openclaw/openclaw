...
import { s as loadAuthProfileStoreForRuntime } from "./store-CcHu_gla.js";
import { n as resolvePluginProviders } from "./providers.runtime-gzKbZUp0.js";
import "./model-selection-shared-ydI43vWj.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-5L2wXORC.js";
import { n as clearAuthProfileCooldown } from "./usage-BtJjnRJd.js";
import "./workspace-S7Sb_AzB.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-CoTblExj.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-C_Mf3HcQ.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-V6Kxf_6c.js";
import { t as createClackPrompter } from "./clack-prompter-DPr9ufNT.js";
import { n as logConfigUpdated } from "./logging-B7v9REH4.js";
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-TEj_lGHq.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-Bnn7ooGa.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-CNVDu44T.js";
import { t as isRemoteEnvironment } from "./remote-env-Q4Lsz-1P.js";
import { n as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-DWw-oG_z.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-DR6IlYne.js");
				await openUrl(url);
			},
