...
import { t as movePathToTrash } from "./trash-MLFC2x8b.js";
...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-DDEl6txh.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-9_btbLFO.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CuQ3FxQd.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-CBPCnNAj.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-DKR4wP5w.js";
...
import { a as logWarn, t as logDebug } from "./logger-Db97zCjA.js";
import "./auth-ChovBn2k.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-C-sgxh1Y.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-q2yb7vWQ.js";
...
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-BttBsIY6.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-oHlE_j6N.js";
...
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-CsVmqHft.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-hxEKPnNB.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-DEuXm_OH.js";
import { c as isGatewayMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-CAROpxkS.js";
import { r as setSafeTimeout } from "./timer-delay-v8N_zzbm.js";
import { o as gatewayStartupUnavailableDetails } from "./client-C0Fm1GXS.js";
import { $ as validateExecApprovalsNodeGetParams, $t as validateSkillsDetailParams, A as validateConfigSchemaParams, An as validateTasksListParams, B as validateDevicePairApproveParams, Bn as validateWebPushTestParams, Bt as validateSessionsDeleteParams, Cn as validateTalkSessionSubmitToolResultParams, D as validateConfigPatchParams, E as validateConfigGetParams, Ei as errorShape, En as validateTalkSpeakParams, Et as validatePushTestParams, F as validateCronRemoveParams, Fn as validateUpdateStatusParams, Ft as validateSessionsCompactionBranchParams, G as validateDeviceTokenRotateParams, Gi as COMMAND_DESCRIPTION_MAX_LENGTH, Gn as validateWizardStartParams, Gt as validateSessionsPatchParams, H as validateDevicePairRejectParams, Hn as validateWebPushVapidPublicKeyParams, Ht as validateSessionsListParams, I as validateCronRunParams, In as validateWakeParams, It as validateSessionsCompactionGetParams, Jt as validateSessionsResetParams, K as validateEnvironmentsListParams, Kn as validateWizardStatusParams, Kt as validateSessionsPluginPatchParams, L as validateCronRunsParams, Ln as validateWebLoginStartParams, Lt as validateSessionsCompactionListParams, Mn as validateToolsEffectiveParams, Mt as validateSessionsAbortParams, N as validateCronAddParams, Nn as validateToolsInvokeParams, Nt as validateSessionsCleanupParams, O as validateConfigSchemaLookupParams, On as validateTasksCancelParams, P as validateCronListParams, Pn as validateUpdateRunParams, Pt as validateSessionsCompactParams, Q as validateExecApprovalsGetParams, Qt as validateSkillsBinsParams, R as validateCronStatusParams, Rn as validateWebLoginWaitParams, Rt as validateSessionsCompactionRestoreParams, T as validateConfigApplyParams, Ti as ErrorCodes, Tt as validatePollParams, U as validateDevicePairRemoveParams, Un as validateWizardCancelParams, Ut as validateSessionsMessagesSubscribeParams, V as validateDevicePairListParams, Vn as validateWebPushUnsubscribeParams, Vt as validateSessionsDescribeParams, W as validateDeviceTokenRevokeParams, Wn as validateWizardNextParams, Wt as validateSessionsMessagesUnsubscribeParams, Xt as validateSessionsSendParams, Yt as validateSessionsResolveParams, Zt as validateSessionsUsageParams, _ as validateChannelsStatusParams, _n as validateTalkSessionCloseParams, _t as validateNodePendingAckParams, a as validateAgentsCreateParams, at as validateNodeDescribeParams, bn as validateTalkSessionJoinParams, c as validateAgentsFilesListParams, cn as validateTalkClientToolCallParams, ct as validateNodeInvokeParams, d as validateAgentsUpdateParams, dt as validateNodePairApproveParams, en as validateSkillsInstallParams, et as validateExecApprovalsNodeSetParams, f as validateArtifactsDownloadParams, ft as validateNodePairListParams, g as validateChannelsStartParams, gn as validateTalkSessionCancelTurnParams, gt as validateNodePairVerifyParams, h as validateChannelsLogoutParams, hn as validateTalkSessionCancelOutputParams, ht as validateNodePairRequestParams, i as validateAgentWaitParams, in as validateTalkCatalogParams, it as validateModelsListParams, j as validateConfigSetParams, jn as validateToolsCatalogParams, jt as validateSendParams, k as validateConfigSchemaLookupResult, kn as validateTasksGetParams, l as validateAgentsFilesSetParams, lt as validateNodeInvokeResultParams, m as validateArtifactsListParams, mn as validateTalkSessionAppendAudioParams, mt as validateNodePairRemoveParams, n as validateAgentIdentityParams, nn as validateSkillsStatusParams, nt as validateLogsTailParams, o as validateAgentsDeleteParams, on as validateTalkClientCreateParams, ot as validateNodeEventParams, p as validateArtifactsGetParams, pn as validateTalkModeParams, pt as validateNodePairRejectParams, q as validateEnvironmentsStatusParams, qt as validateSessionsPreviewParams, r as validateAgentParams, rn as validateSkillsUpdateParams, rt as validateMessageActionParams, s as validateAgentsFilesGetParams, t as formatValidationErrors, tn as validateSkillsSearchParams, tt as validateExecApprovalsSetParams, u as validateAgentsListParams, un as validateTalkConfigParams, ut as validateNodeListParams, v as validateChannelsStopParams, vn as validateTalkSessionCreateParams, vt as validateNodePendingDrainParams, w as validateCommandsListParams, wn as validateTalkSessionTurnParams, wt as validatePluginsUiDescriptorsParams, xt as validateNodeRenameParams, yt as validateNodePendingEnqueueParams, z as validateCronUpdateParams, zn as validateWebPushSubscribeParams, zt as validateSessionsCreateParams } from "./protocol-CAWpVK5t.js";
import { r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-B6MwyGcC.js";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-CKxMN4ay.js";
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-DnLX99-0.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-DBW2bjZx.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-DgmKlEgH.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-CpkbV5JS.js";
...
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-DZbLtwR4.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-BgPKH-dU.js";
import { v as patchPluginSessionExtension } from "./loader-BW9hyS7Z.js";
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-DLcM2w72.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-C2zlg6V4.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-G96-vmZx.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-C6HttWrf.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CpFHPJve.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-CaksWsrq.js";
import { h as stringifyRouteThreadId } from "./channel-route-A_DbE0Oz.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-D0nbGXBW.js";
import { t as loadSessionStore } from "./store-load-qCUuej4o.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BNE2xT6T.js";
import { n as mergeSessionEntry } from "./types-Dp1z0xM2.js";
import { s as updateSessionStore } from "./store-DFBhxZSz.js";
import "./plugins-DW5FeKSD.js";
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-Do2ziPO_.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-vRYLAYIe.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-DvCS4wul.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-BiWvZTxr.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CWdmmURh.js";
import "./auth-profiles-CKtwb4w_.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DvEtDqRf.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DiEMnEv0.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-BtA8kSRW.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-B1mS1E6k.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-DK6Rtk73.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-BNMJuERZ.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BoHE0jJN.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-CQgwYA3e.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-Q4jTVDu8.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-DSnP6-Qd.js";
import { i as resolveSandboxConfigForAgent } from "./config-CfYzKWKw.js";
import { t as extractToolPayload } from "./tool-payload-7CwQeyRy.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-5MFseD6Z.js";
import { l as getTotalQueueSize } from "./command-queue-CP0QCgD4.js";
import { c as normalizeCronJobCreate, u as normalizeCronJobPatch } from "./openclaw-tools-BRbeVxfM.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-CNmYisRF.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-o4yZkDss.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-S7Sb_AzB.js";
import { a as isTimeoutError } from "./failover-error-Ba5pAjxB.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-jppXuzBj.js";
import { i as createOutboundPayloadPlan, u as projectOutboundPayloadPlanForMirror } from "./deliver-BNq4o7w-.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-CtANqQBU.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-D_McQOJQ.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-DPaKOTgR.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-PuZ90yer.js";
import { i as parseAbsoluteTimeMs } from "./stagger-dyHzZ1xa.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url--n1b45Dp.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-B7N5vTz7.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-B5JX-z2a.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-BaNseeSH.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-C4aCEpzE.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-5WCcjGY6.js";
import { n as normalizePollInput } from "./polls-BJ2XUT77.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-B95RpiEr.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BGIt1hby.js";
import "./target-resolver-7DiYDdCk.js";
import { i as resolveReplyToMode } from "./reply-threading-B2LR-VAI.js";
import { t as sendDurableMessageBatch } from "./send-D2JjNW9P.js";
import "./runtime-WUwXdpAj.js";
import { t as buildOutboundSessionContext } from "./session-context-DvgNQLdE.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-jZ7BUHHD.js";
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-DiG4_JGd.js";
import { r as resolveOutboundTarget } from "./targets-DuNOym3l.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-D3wuzc5R.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-ketv1Mq9.js";
import "./runtime-internal-CkxVx1Kf.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-DbgvkI_8.js";
import { n as resolveAgentIdentity } from "./identity-BsLn8TPu.js";
import { s as clearSessionQueues } from "./queue-ri8-6b_E.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-BKJ9MUrM.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Cf3dLTGC.js";
import { C as setTtsEnabled, E as setTtsProvider, O as synthesizeSpeech, T as setTtsPersona, _ as resolveTtsConfig, f as listTtsPersonas, g as resolveTtsAutoMode, h as resolveExplicitTtsOverrides, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, y as resolveTtsProviderOrder } from "./tts-runtime-DBMO6awq.js";
import "./tts-D14cTPgc.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-DHoWAU4Y.js";
import "./skills-BRvyFoKM.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-DLKqdTkB.js";
...
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-DUYPEGwi.js";
...
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-CgBnuM_N.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-B2oBiLDp.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-DVvppdBZ.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-C6lAU5fj.js";
import "./commands-registry-DXTOp5vC.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-zDYUrWOj.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-BUZX_hA1.js";
import { t as getChannelActivity } from "./channel-activity-JFXwpKk2.js";
import { t as WizardCancelledError } from "./prompts-DtVIaWCx.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-B6jjIRcD.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DeaxC9ez.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CwkEU6vF.js";
import "./browser-maintenance-CMcXcFr-.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-C1OIvEdU.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-BAB1P4nG.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-B-28OKll.js";
import { r as agentCommandFromIngress } from "./agent-command-D8k7y_C6.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-Bk0p2sJq.js";
import { n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-BYWmDocl.js";
import { t as safeParseJson } from "./server-json-DPRtFzi2.js";
import { t as formatForLog } from "./ws-log-BN0uVPJk.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CK0kJ4wX.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-Bxv2fbBd.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CdYPvFwX.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-4xtzVUrT.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-D3dCLfvz.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-CF4a-nT8.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-C6dM00ys.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-BbRb-r_n.js";
import { n as createOutboundSendDeps } from "./deps-6TnuERHB.js";
import "./agent-B0DxXe-s.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-C5FpIcHC.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DeYIxHbd.js";
...
import "./server-constants-K5sftkgn.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-DZxB0cTb.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BWegzP1w.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Bae6tKOS.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp--X6WK2bM.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-CBxjU1i0.js";
import { t as loadProviderUsageSummary } from "./provider-usage-jMNg99jH.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-BSgeo8VY.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-C8j70KEW.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-C4ar7MkD.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BBd1o3r0.js";
import { s as performGatewaySessionReset } from "./session-reset-service-BDEmTvjz.js";
import { t as buildChannelUiCatalog } from "./catalog-Yhw2M48Z.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-Ci2f4BlU.js";
import { s as normalizeUpdateChannel } from "./update-channels-CqgCVy7-.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-B8054gMu.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-C2wGThyA.js";
import { t as readConfiguredLogTail } from "./log-tail-BvHmdPoq.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-xn-UOoFI.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Cw-gq18Z.js";
import { t as buildChannelAccountSnapshot } from "./status-Cj1cG7uE.js";
...
import { t as installSkill } from "./skills-install-CoE3Jp_A.js";
import { r as readPackageVersion } from "./package-json-adQNW9vl.js";
import { t as getStatusSummary } from "./status.summary-CAFrSoSH.js";
import "./status-FI4bYU4W.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-B521H_fe.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-D5BF9N_m.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-B1cMUuqT.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-D0QpfWF-.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BmRfIsf7.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Dg55fJVf.js";
import { t as diffConfigPaths } from "./config-diff-CfOsnN-B.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DvHTjIfB.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CrC6W5s1.js";
import "./heartbeat-runner-BufEFO13.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-DWfKtZzi.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-lPAOZiBy.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-YwEKA5LH.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BL7x9sht.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-DOpP9uRE.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-AA53HRhr.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-BFKDD3mW.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-hQkUNECx.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BnZqo4dC.js");
...
const usageHandlers = {
	...
	"sessions.usage": async ({ respond, params, context }) => {
		...
		if (specificKey) {
			...
			if (groupingMode === "family") for (const entry of Object.values(store)) for (const sessionId of entry?.usageFamilySessionIds ?? []) storeFamilySessionIds.add(sessionId);
