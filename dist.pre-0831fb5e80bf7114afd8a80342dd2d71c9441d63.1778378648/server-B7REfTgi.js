...
import { O as sanitizeUntrustedFileName } from "./fs-safe-Cew-WMeL.js";
import { o as root } from "./secure-temp-dir-JZ25IoOE.js";
import { g as shortenHomePath, p as resolveUserPath, s as ensureDir } from "./utils-927g1oFZ.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-B2uvySpw.js";
...
import { t as resolveNodeFromNodeList } from "./node-resolve-DDa3aRaZ.js";
...
import { a as CANVAS_HOST_PATH, c as isA2uiPath, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload } from "./a2ui-DQMCp7_1.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-jcomoXzy.js");
