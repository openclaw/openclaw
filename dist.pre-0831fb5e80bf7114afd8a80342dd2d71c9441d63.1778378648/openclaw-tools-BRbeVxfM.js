...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-q2yb7vWQ.js";
...
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-Bvei-t59.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-Tc4c0ILM.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-BW9hyS7Z.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-G96-vmZx.js";
...
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BNE2xT6T.js";
import { n as resolveSessionConversationRef } from "./session-conversation-CZ52DRPS.js";
...
import { a as extractDeliveryInfo } from "./sessions-Do2ziPO_.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-CnELjMLl.js";
import { h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as modelKey, y as normalizeModelRef } from "./model-selection-shared-ydI43vWj.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent, t as buildAllowedModelSet } from "./model-selection-DXhHIora.js";
...
import { r as getApiKeyForModel } from "./model-auth-Auz6TPkf.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BMDHbPWX.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-bWSOYtb1.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-DK6Rtk73.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-Bx_tBZkb.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-CQgwYA3e.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-CF28i0kQ.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-ClsFKrmC.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DSnP6-Qd.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-Dsvo8JBO.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-BDPU4Tqj.js";
...
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-C2l4vMog.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-BBeT4wJ7.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-6W7adQeC.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-DbQxSBED.js";
import { a as resolvePluginTools } from "./tools-CNmYisRF.js";
...
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-KePzJNtK.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BRw_bWNa.js";
import { f as listAllChannelSupportedActions, l as wrapToolWithBeforeToolCallHook, m as listChannelSupportedActions, s as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-ChXcz0No.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Cc3hB7hT.js";
import { n as extractAssistantText } from "./pi-embedded-utils-D2LAxhbc.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DBd2LSAd.js";
import { n as runWithImageModelFallback } from "./model-fallback-rnPraNTM.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-y503mEBQ.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-cLEq6pXD.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-Bw2KsIIC.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-Dglgdybd.js";
...
import "./delivery-context-BENo8jOd.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-Cq60k8LL.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-D_McQOJQ.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-DkwF4ayM.js";
import { i as resolveMaxDelegatesPerTurn } from "./config-DTXfTkpg.js";
import "./targeting-D5FoGogO.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-DeU2UTcw.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-PiyK53Xm.js";
...
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url--n1b45Dp.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-B7N5vTz7.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CMGfzDPo.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BG9_LsFR.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BGAdLDaE.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-m4e_ScuX.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CH22KOKM.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-0l1h1j88.js";
import { u as saveMediaBuffer } from "./store-BD7-hCkQ.js";
import { t as SsrFBlockedError } from "./ssrf-Du39boJ_.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-Cp0fZNM6.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-DnFd5Ejx.js";
import { r as getDefaultLocalRoots } from "./local-media-access-BRXK0dPk.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-B_vay4PO.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-DKqcUxt0.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CJnVIvjR.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-C6JNtWSZ.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-B-0O7VWt.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-D9LzW0J2.js";
import { s as resolveTimeoutMs } from "./resolve-CiXEcm2L.js";
import { t as buildProviderRegistry } from "./runner-BdHZgqSb.js";
...
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-C4aCEpzE.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-9EumuQKK.js";
import { t as deriveSessionChatTypeFromKey } from "./session-chat-type-shared-SoAvpcFe.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-D3wuzc5R.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DbgvkI_8.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DRJ3EH4V.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-Beg00KD3.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-CPoYBgGA.js";
import { t as parseTimeoutMs } from "./parse-timeout-B9tKlHF2.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-DjDAU6zE.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BWpnsCa4.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-EIDlnC4v.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-NcvD_Mge.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Nprldzuy.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-CnTPyTA4.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-Cmtqv-5Q.js";
import { p as registerSubagentRun } from "./subagent-registry-BEKwk_2h.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CacF0Znf.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DbIAPv1h.js";
import { k as textToSpeech } from "./tts-runtime-DBMO6awq.js";
...
import { t as parseVideoGenerationModelRef } from "./model-ref-qxilurNH.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BuSfcrkP.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-ict-s765.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-D0KnAiqm.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-BqS-Il9Q.js";
...
import { i as runWebSearch } from "./runtime-C-T6RXc3.js";
import "./web-search-provider-common-C3RkXlnE.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BIyJqcrr.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-DEIbDBG8.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-aOkiUaYt.js"));
