...
import { y as normalizeModelRef } from "./model-selection-shared-ydI43vWj.js";
import "./model-selection-DXhHIora.js";
import { a as resolveModelCostConfig, n as estimateUsageCost } from "./usage-format-CwoOPdzL.js";
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ prepareSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-DOWyECkB.js"), Promise.resolve(resolveRuntimeConfig(options))]);
