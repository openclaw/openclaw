...
import { t as clearRuntimeAuthProfileStoreSnapshots } from "../store-CcHu_gla.js";
import { i as runProviderCatalog } from "../provider-discovery-pxQvMCbD.js";
import { s as listSupportedMusicGenerationModes } from "../openclaw-tools-BRbeVxfM.js";
import { r as createCapturedPluginRegistration } from "../bundled-capability-runtime-CjUDACB9.js";
import { a as resolveWebFetchProviderContractEntriesForPluginId, i as resolveProviderContractProvidersForPluginIds, n as providerContractLoadError, o as resolveWebSearchProviderContractEntriesForPluginId, s as resolveBundledExplicitProviderContractsFromPublicArtifacts, t as pluginRegistrationContractRegistry } from "../registry-CdqdNEJp.js";
...
import "../provider-onboard-Cdiv1SIA.js";
import "../runtime-D3waxCCx.js";
import "../agent-runtime-CLe15ipX.js";
import { a as describe, c as it, i as beforeEach, n as afterEach, r as beforeAll, t as afterAll } from "../dist-BloWqfp3.js";
import { n as vi, t as globalExpect } from "../test.DNmyFkvJ-CruGCSPy.js";
import { b as registerSingleProviderPlugin, v as registerProviderPlugin, x as requireRegisteredProvider, y as registerProviderPlugins } from "../plugin-setup-wizard-DzSIFEUV.js";
import { a as expectedAugmentedOpenaiCodexCatalogEntriesWithGpt55, i as expectCodexMissingAuthHint, o as expectedOpenaiPluginCodexCatalogEntriesWithGpt55, r as expectAugmentedCodexCatalog } from "../testing-DDH1iQZc.js";
import { i as resolveProviderWizardOptions, n as resolveProviderModelPickerEntries, o as setProviderWizardProvidersResolverForTest, t as buildProviderPluginMethodChoice } from "../provider-wizard-B1fqtcHS.js";
import { r as resolveProviderPluginChoice } from "../provider-auth-choice.runtime-1RTCPK_D.js";
import { i as makeResponse, r as createProviderUsageFetch } from "../frozen-time-CbBtpXv6.js";
import { n as loadBundledPluginPublicSurfaceSync, t as loadBundledPluginPublicSurface } from "../public-surface-loader-Bdk22JK3.js";
import "../plugin-test-runtime-BHS1aaPG.js";
import "../test-env-BSmbxC8K.js";
...
function expectUnifiedModelCatalogEntries(rows, params) {
	globalExpect(rows).toBeTruthy();
	for (const row of rows ?? []) {
		globalExpect(row).toEqual(globalExpect.objectContaining({
			provider: params.provider,
			kind: params.kind
		}));
		globalExpect(row.model.trim()).toBe(row.model);
		globalExpect(row.model).not.toBe("");
		globalExpect(row.source).not.toBe("");
	}
}
function expectUnifiedModelCatalogProviderRegistration(params) {
	...
	globalExpect(registration).toBeTruthy();
	return registration;
}
//#endregion
