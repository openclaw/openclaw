...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-v8N_zzbm.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-BdfEOIOJ.js";
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-C0Fm1GXS.js";
import { i as READ_SCOPE } from "./operator-scopes-DnLX99-0.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-3OH4rGPp.js");
