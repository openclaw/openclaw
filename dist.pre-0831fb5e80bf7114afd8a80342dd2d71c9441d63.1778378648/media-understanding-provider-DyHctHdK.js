import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-Dz2Kr8L7.js";
import { s as resolveCodexAppServerRuntimeOptions } from "./config-B8fgH0ri.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-DNrgzxsT.js";
import { r as readModelListResult } from "./models-C_nCO2rc.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-CP5yRgjE.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
