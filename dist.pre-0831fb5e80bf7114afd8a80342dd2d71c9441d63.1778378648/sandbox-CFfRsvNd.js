...
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, b as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-BijlGGMM.js";
import { n as isToolAllowed } from "./tool-policy-CdwA6v7w.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-CfYzKWKw.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CbUUztkf.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-BNadb7Jh.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-S7Sb_AzB.js";
import { f as isSameSsrFPolicy } from "./ssrf-Du39boJ_.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-CjGrlzdu.js";
import { C as readRegistry, D as updateRegistry, E as updateBrowserRegistry, O as computeSandboxBrowserConfigHash, S as readBrowserRegistry, T as removeRegistryEntry, _ as resolveSandboxScopeKey, a as execDocker, c as isDockerDaemonUnavailable, d as readDockerNetworkDriver, f as readDockerNetworkGateway, g as resolveSandboxAgentId, h as appendWorkspaceMountArgs, l as readDockerContainerEnvVar, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxWorkspaceDir, w as removeBrowserRegistryEntry, y as slugifySessionKey } from "./docker-DUcqj8Xs.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-CIBTqGS3.js";
import { C as buildPinnedAppendPlan, D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedMkdirpPlan, y as normalizeContainerPath } from "./browser-bridges-CeW1lzPf.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-CJYy95ig.js"),
				import("./exec-defaults-CaK0YI4x.js"),
				import("./skills-DWuxsUfI.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-Cool9Plq.js")).maybePruneSandboxes(cfg);
