...
import { c as normalizeAgentId$1 } from "./session-key-CuQ3FxQd.js";
...
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-4F8gdkEc.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-D2LAxhbc.js";
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-CyLnxZJH.js";
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./channel-streaming-CLRZMbsV.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-SM3_DGaZ.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-Dd68-pWO.js";
...
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-DTA23QuL.js";
...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-BZ2cXOUe.js";
...
import { n as resolveAgentOutboundIdentity } from "./identity-D_Jch3tt.js";
import "./outbound-runtime-CPrFRc-_.js";
import { i as installRequestBodyLimitGuard } from "./http-body-B8VSBCXN.js";
import "./ssrf-runtime-CN3oFExA.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-BHWNPd4j.js";
import "./conversation-runtime-CjuHFBPF.js";
import "./agent-runtime-CLe15ipX.js";
import "./security-runtime-Bu3Zxg1T.js";
import "./command-primitives-runtime-Czua-qgC.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-BYYa19g0.js";
import { t as buildFeishuConversationId } from "./conversation-id-CkYjtDiM.js";
import { i as resolveReceiveIdType } from "./targets-CYxUZieq.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-Bt2q9vbl.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-TVDVgcQ9.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-D1Ac7XI9.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-D0v00q9q.js";
import { t as getFeishuRuntime } from "./runtime-BBrEo5Z_.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-Bj7UIRDC.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-akmABCzr.js";
import "./runtime-api-CuyMaYR9.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as downloadMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-DsRPbTX5.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-D-VD8Im_.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-14mmrTW_.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-C2j3Ac8f.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-BW3UJ9z7.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-BW3UJ9z7.js");
