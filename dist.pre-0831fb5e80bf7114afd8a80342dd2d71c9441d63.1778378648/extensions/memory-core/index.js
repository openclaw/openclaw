...
import "../../memory-core-host-runtime-core-R-ID1651.js";
import "../../memory-core-host-runtime-files-OXCb3wW0.js";
import { t as registerShortTermPromotionDreaming } from "../../dreaming-C6y7d0R7.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-CyGPNqgn.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-BQgC-xKa.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-CO69zRBK.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-Dz565t7T.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-feGxWLLz.js");
				return await handleDreamingCommand(api, ctx);
			}
		});
		api.registerCli(async ({ program }) => {
			const { registerMemoryCli } = await import("../../cli-CApz2OYG.js");
