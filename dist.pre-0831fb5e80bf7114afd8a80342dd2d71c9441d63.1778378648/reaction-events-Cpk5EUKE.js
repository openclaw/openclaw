...
import "./session-binding-runtime-C3p-Kije.js";
import { a as resolveMatrixAccountConfig } from "./account-config-bNcL1MaW.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-RaXIfPaR.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-C_9aM0Pd.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-DzdBQyqF.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-BYDxVhCC.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-DtchkYXm.js");
