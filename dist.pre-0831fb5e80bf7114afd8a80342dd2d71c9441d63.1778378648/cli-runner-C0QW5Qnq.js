...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-CIFefWGH.js";
import "./tokens-BBeT4wJ7.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-UySSrni8.js";
import "./pi-embedded-helpers-CKo0yA7g.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-C0jk1zeo.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Ba5pAjxB.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-BWVowy3h.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-DZX-yyd3.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-CeYA2r1L.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-B000A1V4.js");
