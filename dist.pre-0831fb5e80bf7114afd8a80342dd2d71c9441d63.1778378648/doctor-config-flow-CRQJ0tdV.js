...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-m6J7qPGz.js";
import { r as normalizeProviderId$1 } from "./provider-id-C3dkeX_L.js";
...
import { i as setPathExistingStrict } from "./path-utils--7qWWbpv.js";
import { n as discoverConfigSecretTargets } from "./target-registry-C7VuErIE.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-q2yb7vWQ.js";
import { n as formatConfigIssueLines } from "./issue-format-BFLj-aOk.js";
import { r as normalizeTalkSection } from "./talk-oHlE_j6N.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-D8oONAQi.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DP2iGf13.js";
import { n as getLoadedChannelPlugin } from "./registry-BNE2xT6T.js";
import { i as listRouteBindings } from "./bindings-J4M1TzZ2.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-DrRKztsW.js";
import { r as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-E-BeggwA.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-D0MSUdMs.js";
import { t as note } from "./note-BSRgI2Bk.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-C65pl3lQ.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-DF6WxAF3.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DcSk9w4k.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BZ9ge4lb.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DzN32nmE.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-Cx2hxXGc.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-B9f0CNCS.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BCiVu19V.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-Bg4anGJE.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings--5NFVcz5.js");
		emitDoctorNotes({
			note,
