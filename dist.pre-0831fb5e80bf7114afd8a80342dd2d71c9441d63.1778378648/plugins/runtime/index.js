...
import { i as getChildLogger, y as normalizeLogLevel } from "../../logger-C-XERP1U.js";
import { a as shouldLogVerbose } from "../../globals-ZEce9oym.js";
import { a as logWarn } from "../../logger-Db97zCjA.js";
import { r as runCommandWithTimeout } from "../../exec-DfATC6XG.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-BttBsIY6.js";
import { n as mutateConfigFile, r as replaceConfigFile } from "../../mutate-DeaT-EF6.js";
import "../../config-CW5G5Uky.js";
import { l as onAgentEvent } from "../../agent-events-G96-vmZx.js";
import { i as resolveSessionFilePath, u as resolveStorePath } from "../../paths-CaksWsrq.js";
import { i as normalizeDeliveryContext } from "../../delivery-context.shared-D0nbGXBW.js";
...
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-ydI43vWj.js";
import { m as resolveThinkingDefault } from "../../model-selection-DXhHIora.js";
import { a as generateMusic, o as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-BRbeVxfM.js";
import { _ as mediaKindFromMime, n as detectMime } from "../../mime-6W7adQeC.js";
import { l as ensureAgentWorkspace } from "../../workspace-S7Sb_AzB.js";
import { a as getImageMetadata, l as resizeToJpeg } from "../../image-ops-CdStQP22.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "../../lazy-runtime-DugTTnYG.js";
import { o as requestHeartbeat } from "../../heartbeat-wake-DPaKOTgR.js";
import { a as enqueueSystemEvent } from "../../system-events-PuZ90yer.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "../../runtime-m4e_ScuX.js";
import { t as loadWebMedia } from "../../web-media-B_vay4PO.js";
import { p as listTasksForFlowId } from "../../task-registry-ketv1Mq9.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-odYbdk7A.js";
import "../../runtime-internal-CkxVx1Kf.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-DS6Ms-w7.js";
import { n as resolveAgentIdentity } from "../../identity-BsLn8TPu.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-Nprldzuy.js";
import { t as resolveAgentTimeoutMs } from "../../timeout-Cf3dLTGC.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-BuSfcrkP.js";
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-C-T6RXc3.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-CEjhuOxx.js";
import { i as setGatewaySubagentRuntime, n as gatewaySubagentState, r as setGatewayNodesRuntime, t as clearGatewaySubagentRuntime } from "../../gateway-bindings-BN18xio1.js";
import { t as createRuntimeChannel } from "../../runtime-channel-B_7zByUJ.js";
import { r as isVoiceCompatibleAudio } from "../../audio-D0WcMIe0.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-DEKY1eaU.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-plNHmeKQ.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-BaK7a9nV.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-CuRl7pOb.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-1BNASCqL.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-CDT4dIOx.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-DofS0twT.js"), (m) => m.createRuntimeLlm({
