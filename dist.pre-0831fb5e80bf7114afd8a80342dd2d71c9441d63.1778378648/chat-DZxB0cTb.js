...
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DEuXm_OH.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-CAROpxkS.js";
import { r as setSafeTimeout } from "./timer-delay-v8N_zzbm.js";
import { C as validateChatSendParams, Ei as errorShape, S as validateChatInjectParams, Ti as ErrorCodes, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-CAWpVK5t.js";
import { s as normalizeInputProvenance } from "./input-provenance-B6MwyGcC.js";
...
import { C as jsonUtf8Bytes, h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes } from "./session-utils.fs-CQgwYA3e.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-7VKal0DV.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-CF28i0kQ.js";
import { o as isAudioFileName } from "./mime-6W7adQeC.js";
import "./local-file-access-BcHhlnN_.js";
import { s as normalizeReplyPayloadsForDelivery } from "./deliver-BNq4o7w-.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-CyLnxZJH.js";
import { d as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-DBd2LSAd.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-BD7-hCkQ.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-x20um5FI.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-BRXK0dPk.js";
...
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-7f8M7BSK.js";
...
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-SEaswU6l.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BC3vx4Gt.js";
...
import { t as logLargePayload } from "./diagnostic-payload-2cAAM9ai.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-BizKRak1.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-DKS24TW2.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-K5sftkgn.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-m6WpZm7x.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BWegzP1w.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Bae6tKOS.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-CiEJVZJj.js";
