...
import { t as extensionUsesSkippedScannerPath } from "./scan-paths-DcgqJZaC.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-Dko9NctP.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-DWuxsUfI.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-BbVKmLUg.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-DfwoQnoT.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-p5_7Lz5c.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-BCqKqKK6.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-BPu1NfVN.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-CQi8prlq.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-CHooCM9m.js");
