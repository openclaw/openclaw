import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, r as lowercasePreservingWhitespace } from "./string-coerce-LndEvhRk.js";
...
import { o as normalizeSingleOrTrimmedStringList } from "./string-normalization-DgUPESoD.js";
import { p as resolveSessionAgentId } from "./agent-scope-ByE5d_BM.js";
import { i as getMemoryCapabilityRegistration, l as listActiveMemoryPublicArtifacts } from "./memory-state-Ta1XBGV3.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CpFHPJve.js";
import { o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-Dsvo8JBO.js";
import { i as writeJsonFileAtomically, n as readJsonFileWithFallback } from "./json-store-eK63qI0i.js";
...
import { n as extractTranscriptStemFromSessionsMemoryHit, r as resolveTranscriptStemToSessionKeys } from "./session-transcript-hit-DBZFajy8.js";
import "./memory-host-core-B9drehsJ.js";
import { n as withTrailingNewline, t as replaceManagedMarkdownBlock } from "./memory-host-markdown-CDNqWnEe.js";
import { n as getActiveMemorySearchManager } from "./memory-host-search-Cc0TTyoh.js";
import { d as resolveMemoryWikiConfig, o as WIKI_SEARCH_BACKENDS, s as WIKI_SEARCH_CORPORA } from "./config-BkZ1tfHM.js";
...
async function createSessionMemoryPathVisibilityChecker(params) {
	...
	return (relPath) => {
		...
		return resolveTranscriptStemToSessionKeys({
			...
			stem
		}).some((key) => guard.check(key).allowed);
	};
}
...
async function writeImportedSourcePage(params) {
	...
	if (existing !== rendered) try {
		if (pageStat && pageStat.nlink > 1) await vault.remove(params.pagePath);
		await vault.write(params.pagePath, rendered);
	} catch (error) {
		if (error instanceof FsSafeError) throw new Error(`Refusing to write imported source page through symlink: ${params.pagePath}`, { cause: error });
		throw error;
	}
