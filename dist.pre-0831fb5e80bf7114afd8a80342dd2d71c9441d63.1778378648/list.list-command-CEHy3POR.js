...
import { i as normalizeProviderIdForAuth } from "./provider-id-C3dkeX_L.js";
...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-DRDj6LDM.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-CjYQInDW.js";
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-DZWqGez1.js";
import { b as parseModelRef, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, v as modelKey } from "./model-selection-shared-ydI43vWj.js";
import "./model-selection-DXhHIora.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DmHGyBd_.js";
import { t as resolveEnvApiKey } from "./model-auth-env-D9uBAONf.js";
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-BbzO1rcS.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-Auz6TPkf.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-TEj_lGHq.js";
import { n as loadModelsConfigWithSource } from "./load-config-By6LZhv-.js";
import { n as formatErrorWithStack } from "./list.errors-etZRu2o4.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-3YhuT1ex.js";
...
function createModelListAuthIndex(params) {
	...
	const hasOpenAICodexRuntimeAuth = (provider) => {
		return openAIProviderUsesCodexRuntimeByDefault({
			...
			config: params.cfg
		}) && authenticatedProviders.has("openai-codex");
	};
	return {
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-D67boKVa.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-CRGAK3eq.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-D5oRaUuz.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DTCzmqC4.js"),
		import("./agent-scope-DfwoQnoT.js"),
		import("./workspace-Cu357gfz.js")
	]);
