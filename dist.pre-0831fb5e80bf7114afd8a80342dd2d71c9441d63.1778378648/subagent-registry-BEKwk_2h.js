...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-G96-vmZx.js";
...
import { m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-DFBhxZSz.js";
import "./sessions-Do2ziPO_.js";
import { t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-DrseKQVy.js";
import { A as SUBAGENT_ENDED_REASON_KILLED, C as getSubagentSessionStartedAt, D as SUBAGENT_ENDED_OUTCOME_TIMEOUT, E as SUBAGENT_ENDED_OUTCOME_KILLED, M as subagentRuns, O as SUBAGENT_ENDED_REASON_COMPLETE, S as getSubagentSessionRuntimeMs, T as SUBAGENT_ENDED_OUTCOME_ERROR, a as countActiveDescendantRunsFromRuns, b as isStaleUnendedSubagentRun, c as countPendingDescendantRunsFromRuns, f as listDescendantRunsForRequesterFromRuns, j as SUBAGENT_TARGET_KIND_SUBAGENT, k as SUBAGENT_ENDED_REASON_ERROR, l as getSubagentRunByChildSessionKeyFromRuns, n as persistSubagentRunsToDisk, o as countActiveRunsForSessionFromRuns, p as listRunsForControllerFromRuns, r as restoreSubagentRunsFromDisk, t as getSubagentRunsSnapshotForRead, w as resolveSubagentSessionStatus } from "./subagent-registry-state-DQRlI3Zm.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-Df0Iylxr.js";
import { a as isSilentReplyText } from "./tokens-BBeT4wJ7.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-B7GVgRkN.js";
import "./pi-bundle-mcp-tools-BsSkhspa.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-CvhA_Owi.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-DbgvkI_8.js";
import "./subagent-announce-queue-BFWUcNMO.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-CnTPyTA4.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-Cmtqv-5Q.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-eS68XapW.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-VZIco_2k.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-Bd5s0jGu.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-VZIco_2k.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-CUGpm8fz.js").then(({ scheduleOrphanRecovery }) => {
