import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-2ew-InBY.js";
import { r as loadCrestodianOverview } from "./overview-CugAUEKp.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CT4gZQZV.js")).planCrestodianCommand)({
		input,
		overview
	});
