...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-B5P4wP4a.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-CVOvPQly.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded--Vp-sTmM.js")).runEmbeddedPiAgent;
}
