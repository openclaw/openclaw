...
import { r as isInternalMessageChannel } from "./message-channel-CAROpxkS.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-BNE2xT6T.js";
import "./plugins-DW5FeKSD.js";
import { n as isNestedAgentLane } from "./lanes-ClsFKrmC.js";
import { a as formatOutboundPayloadLog, d as projectOutboundPayloadPlanForOutbound, i as createOutboundPayloadPlan, l as projectOutboundPayloadPlanForJson, o as normalizeOutboundPayloadsForJson } from "./deliver-BNq4o7w-.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BGIt1hby.js";
import { t as sendDurableMessageBatch } from "./send-D2JjNW9P.js";
import "./runtime-WUwXdpAj.js";
import { t as normalizeReplyPayload } from "./normalize-reply-CHLJeYiK.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-DJ4EjrJB.js";
...
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-BuOLvlW2.js";
...
async function deliverAgentCommandResult(params) {
	...
	if (deliver && deliveryChannel && !isInternalMessageChannel(deliveryChannel)) {
		if (deliveryTarget) {
			...
			if (!bestEffortDeliver && (send.status === "failed" || send.status === "partial_failed")) throw send.error;
			if (send.status === "failed" || send.status === "partial_failed") deliveryHadError = true;
