...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-DgmKlEgH.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DiEMnEv0.js";
import { o as resetModelCatalogCache } from "./model-catalog-Cjeym3yt.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-D_McQOJQ.js";
import { r as resetDirectoryCache } from "./target-resolver-7DiYDdCk.js";
...
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BoK2-Ayq.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-C2wGThyA.js";
...
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-D16584rb.js";
import { t as buildGatewayCronService } from "./server-cron-8iq1oEQF.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-15nSf6al.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DTNFDxMg.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-DxRfL48Y.js"), import("./gmail-watcher-lifecycle-Dk3Q-l3e.js")]);
