...
import { c as isRecord$1 } from "./utils-927g1oFZ.js";
...
import { u as isPrivateIpAddress } from "./ssrf-Du39boJ_.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-CpMnAOBT.js";
import "./ssrf-runtime-CN3oFExA.js";
import "./security-runtime-Bu3Zxg1T.js";
import { t as getMSTeamsRuntime } from "./runtime-api-W5H90rnr.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-DYIuuQjn.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-BCdt6PQS.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-Ct-hwozZ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DaGRMduf.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-DT6g45xh.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
