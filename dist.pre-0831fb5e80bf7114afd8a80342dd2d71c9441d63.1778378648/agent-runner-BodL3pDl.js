...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-ByE5d_BM.js";
import { n as defaultRuntime } from "./runtime-Bd9_VI2J.js";
import { a as freezeDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-daKTvE-j.js";
import { a as isDiagnosticsEnabled, i as emitTrustedDiagnosticEvent } from "./diagnostic-events-B9rpcO0g.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-BttBsIY6.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-BwNUUARP.js";
import "./config-CW5G5Uky.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-CAROpxkS.js";
import { o as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-DZWqGez1.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-Ta1XBGV3.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-G96-vmZx.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-CaksWsrq.js";
import { t as loadSessionStore } from "./store-load-qCUuej4o.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-Dp1z0xM2.js";
import { C as resolveGroupSessionKey, c as updateSessionStoreEntry, m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-DFBhxZSz.js";
import "./sessions-Do2ziPO_.js";
import { a as resolveContextTokensForModel } from "./context-CXmRYhH2.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-ydI43vWj.js";
import { t as isCliProvider } from "./model-selection-cli-she5khPO.js";
import "./model-selection-DXhHIora.js";
import { u as resolveModelAuthMode } from "./model-auth-Auz6TPkf.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-DiEMnEv0.js";
import { l as queueEmbeddedPiMessage } from "./runs-B1mS1E6k.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-Bx_tBZkb.js";
import { n as resolveAgentHarnessPolicy } from "./agent-runtime-metadata-BNMJuERZ.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CwoOPdzL.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-CFaJqJa9.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-CQgwYA3e.js";
...
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CbUUztkf.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-4F8gdkEc.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CNRzpKK0.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-C_5-HTcn.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-dfkzSjOE.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CP0QCgD4.js";
import { u as isLikelyExecutionAckPrompt } from "./selection-B3n6fBiC.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-BBeT4wJ7.js";
import { u as stripHeartbeatToken } from "./heartbeat-Cqb-R5gB.js";
import { o as isAudioFileName } from "./mime-6W7adQeC.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-RoR2JgTC.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-Bkwf8hY4.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-D44uLZHZ.js";
...
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-C0jk1zeo.js";
import { i as setReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-CfCL9mne.js";
import { h as parseReplyDirectives } from "./deliver-BNq4o7w-.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-CyLnxZJH.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-rnPraNTM.js";
import { i as estimateMessagesTokens } from "./compaction-BwFGYj1j.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-DTXfTkpg.js";
import { c as emitContinuationWorkSpan, i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-Bd-12uGR.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-DPaKOTgR.js";
import { a as enqueueSystemEvent } from "./system-events-PuZ90yer.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-DeU2UTcw.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-ByjE5iJi.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-B2LR-VAI.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BMam7urf.js";
import { n as hasCotFramePrefix } from "./normalize-reply-CHLJeYiK.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BqoIub1F.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-ri8-6b_E.js";
import "./sandbox-CFfRsvNd.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-BvhL9isj.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CMJ7twjC.js";
import { r as enqueueCommitmentExtraction } from "./runtime-qK6BjFkm.js";
import { n as resolveSendPolicy } from "./send-policy-C5q6tsjr.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-Bx8RQU5c.js";
import { t as checkContextPressure } from "./context-pressure-BgEortrb.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-CRzAKn08.js";
import { t as formatProviderModelRef } from "./model-runtime-tOtpWFpQ.js";
import { t as runCliAgent } from "./cli-runner-C0QW5Qnq.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-Blc7qA6e.js";
import { i as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-E-BeggwA.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-B0IpSYIa.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DFajdmTl.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-COU6E1U1.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-DJ4EjrJB.js";
import { n as incrementCompactionCount } from "./session-updates-C0PKJmaj.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-Ds5uU8zb.js";
import { n as dispatchPostCompactionDelegates, o as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-B92xgo7t.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-DbNm81vp.js";
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-DJMfOynn.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded--Vp-sTmM.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-C4cmMhjx.js"),
					import("./config-CwO86tYS.js"),
					import("./state-Cga_HNte.js"),
					import("./store-vtzcCPay.js")
				]);
