...
import { d as resolveGatewayLaunchAgentLabel, g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-DGSVeClm.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-BPOOdjru.js";
import { a as isSystemdUserServiceAvailable, m as classifySystemdUnavailableDetail } from "./systemd-jCGdgony.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DWalIU5e.js";
import { o as getResolvedLoggerSettings } from "./logger-C-XERP1U.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-KmLP05hz.js";
import { n as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as launchAgentPlistExists } from "./launchd-kwrS3hYe.js";
import "./config-CW5G5Uky.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service--QQh0Xkw.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-6eUpy_ML.js";
import { a as isSystemdUnavailableDetail, i as resolveDaemonContainerContext, o as renderSystemdUnavailableHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-MLkxToGL.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-ByGz5E7r.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-YyzFb9AT.js";
import { n as readGatewayRestartHandoffSync, t as formatGatewayRestartHandoffDiagnostic } from "./restart-handoff-DqjH-nN8.js";
import { r as findSystemGatewayServices } from "./inspect-CzaQm9Ds.js";
import "./logging-B6EpUXFV.js";
import { t as note } from "./note-BSRgI2Bk.js";
import { n as formatHealthCheckFailure } from "./health-format-BOpJMHP3.js";
import { n as healthCommand } from "./health-CtHuLvho.js";
import { a as resolveServiceRepairPolicy, i as isServiceRepairExternallyManaged, n as SERVICE_REPAIR_POLICY_ENV, r as confirmDoctorServiceRepair, t as EXTERNAL_SERVICE_REPAIR_NOTE } from "./doctor-service-repair-policy-DSo_TbxN.js";
...
async function maybeRepairGatewayDaemon(params) {
	...
	if (loaded) serviceRuntime = await service.readRuntime(serviceEnv).catch(() => void 0);
