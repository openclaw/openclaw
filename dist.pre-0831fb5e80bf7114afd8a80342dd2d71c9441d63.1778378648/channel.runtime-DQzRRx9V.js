...
import "./accounts-BFLaAY8f.js";
import "./runtime-api-KzzFBSIh.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-UJwtlNuT.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DV_abKCg.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-sMRJZreg.js");
