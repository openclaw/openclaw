...
import { J as resolveShellEnvFallbackTimeoutMs, K as getShellPathFromLoginShell } from "./io-q2yb7vWQ.js";
...
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-CAROpxkS.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-DnLX99-0.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DSnP6-Qd.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-C_5-HTcn.js";
import { t as formatDurationCompact } from "./format-duration-BShfl0If.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-Q5uqSWIm.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-UfHTKIzj.js";
import { o as failedTextResult, y as textResult } from "./common-cLEq6pXD.js";
import { t as callGatewayTool } from "./gateway-Bw2KsIIC.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-DQVApvSX.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-BGvgZRYm.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DSSn78vz.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-DqNNrN2u.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-ChHpzDZl.js";
import "./delivery-context-BENo8jOd.js";
import { t as sendMessage } from "./message-pQrkO_oy.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-BKJ9MUrM.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-BWpnsCa4.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CBpUTMoV.js";
import { t as getProcessSupervisor } from "./supervisor-CbNO4z_S.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-Ds72AQ70.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-C6eZhLmT.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-BsZmGlpE.js";
import { n as detectPolicyInlineEval } from "./policy-B7vNgCfD.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-C5FpIcHC.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-DeYIxHbd.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-BCWDJ8LS.js";
