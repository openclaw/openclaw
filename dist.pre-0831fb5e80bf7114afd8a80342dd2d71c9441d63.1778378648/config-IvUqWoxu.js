...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-CpMnAOBT.js";
import "./ssrf-runtime-CN3oFExA.js";
import "./retry-runtime-DJRUB8df.js";
import "./secret-input-runtime-kiV2T4bE.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-C3B4Quut.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-rRhqz-Dd.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-bNcL1MaW.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BvleLYFW.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CS4ZOqI6.js"), import("./logging-Bz9mBn6x.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-ByFR2_H0.js").then((credentialsReadModule) => ({
