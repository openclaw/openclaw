...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-CaVj1L8o.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-DY6dZwx1.js")]);
