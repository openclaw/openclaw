...
import { t as CHANNEL_IDS } from "./ids-DbFBIQba.js";
...
import { D as collectPluginSchemaMetadata, E as collectChannelSchemaMetadata, O as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-q2yb7vWQ.js";
import { t as OpenClawSchema } from "./zod-schema-BwNUUARP.js";
import { t as sensitive } from "./zod-schema.sensitive-DQtRIUQZ.js";
import "./config-CW5G5Uky.js";
import { r as isSensitiveUrlConfigPath, t as SENSITIVE_URL_HINT_TAG } from "./redact-sensitive-url-4vXw3R25.js";
import { a as isSensitiveConfigPath } from "./redact-snapshot-o4yZkDss.js";
...
const FIELD_HELP = {
	...
	"agents.defaults.heartbeat.skipWhenBusy": "When true, defer heartbeat turns on extra busy lanes: subagent or nested command work. Cron lanes always defer heartbeat turns.",
	"agents.list[].heartbeat.skipWhenBusy": "Per-agent override that defers heartbeat turns on extra busy lanes: subagent or nested command work. Cron lanes always defer heartbeat turns.",
