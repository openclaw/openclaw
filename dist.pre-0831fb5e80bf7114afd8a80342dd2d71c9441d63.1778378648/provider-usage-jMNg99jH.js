...
import { a as resolveProviderAuthEnvVarCandidates } from "./provider-env-vars-DUoPzoXP.js";
import "./config-CW5G5Uky.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-qOag1K6G.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CcHu_gla.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-Tc4c0ILM.js";
import { b as passesManifestOwnerBasePolicy, v as isActivatedManifestOwner } from "./bundled-D8oONAQi.js";
import { R as resolveProviderUsageAuthWithPlugin, z as resolveProviderUsageSnapshotWithPlugin } from "./provider-runtime-CnELjMLl.js";
import "./model-selection-DXhHIora.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CWdmmURh.js";
import "./auth-profiles-CKtwb4w_.js";
import { t as resolveApiKeyForProfile } from "./oauth-D-nEMhap.js";
import { n as listProfilesForProvider, t as dedupeProfileIds } from "./profile-list-DoiLhRfy.js";
import { r as resolveAuthProfileOrder } from "./order-Bi_QvguU.js";
import { u as isNonSecretApiKeyMarker } from "./model-auth-markers-DmHGyBd_.js";
import { t as resolveEnvApiKey } from "./model-auth-env-D9uBAONf.js";
import { d as resolveUsableCustomProviderApiKey } from "./model-auth-Auz6TPkf.js";
import { t as resolveFetch } from "./fetch-C2NHS_t_.js";
import { a as resolveLegacyPiAgentAccessToken, c as withTimeout, i as ignoredErrors, n as PROVIDER_LABELS, r as clampPercent, s as usageProviders } from "./provider-usage.shared-BbRb-r_n.js";
...
async function resolveProviderAuths(params) {
	...
	for (const provider of params.providers) {
		...
		if (hasDirectCredentialSource || allowAuthProfileStore || hasLegacyPiAgentCredentialSource) {
			const pluginAuth = await resolveProviderUsageAuthViaPlugin({
				state,
				provider
			});
