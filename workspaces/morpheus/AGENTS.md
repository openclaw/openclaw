...
**MANDATORY at end of every session with more than 5 messages:** Write a daily note to `memory/YYYY-MM-DD.md`. Include: what task you were given, what you created or decided, and any pending items. In subagent mode: write memory FIRST, then return your final answer.
...
3. Update `MEMORY.md` — add 1-3 bullet points under the relevant section for any decision or insight worth remembering long-term
4. Write memory FIRST, then return your final answer. Do not skip step 1 even if the session will end soon.
