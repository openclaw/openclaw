...
import { StreamableHTTPTransport } from "./streamableHttp.js";
...
async function main() {
  ...
  console.log(`Shopify MCP Server running on HTTP port ${port}`);
  console.log(`Health check: http://localhost:${port}/health`);
  console.log(`MCP endpoint: http://localhost:${port}/mcp/v1/message`);
