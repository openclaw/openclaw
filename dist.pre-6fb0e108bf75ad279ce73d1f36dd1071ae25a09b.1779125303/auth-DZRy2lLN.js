...
import { s as loadAuthProfileStoreForRuntime } from "./store-DyEwxu9l.js";
...
import { r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-CfM2F8tR.js";
import { n as clearAuthProfileCooldown } from "./usage-CAsNPmFe.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-DeidZ5wp.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-BOjJIFOz.js";
...
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-7apgh2NU.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: async (url) => {
			const { openUrl } = await import("./onboard-helpers-BCoC8YR9.js");
			await openUrl(url);
		},
