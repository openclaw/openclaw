...
import { r as markAuthProfileBlockedUntil } from "./usage-CAsNPmFe.js";
import { u as resolveModelAuthMode } from "./model-auth-B-ZTCWdm.js";
import { m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-D5kx4FJD.js";
...
import { a as hasBeforeToolCallPolicy } from "./pi-tools.before-tool-call-BdkZDYDJ.js";
import { S as supportsModelTools, l as runAgentCleanupStep, o as normalizeAgentRuntimeTools, t as buildEmbeddedAttemptToolRunContext } from "./attempt.tool-run-context-BgVZIgnr.js";
import { j as formatToolAggregate } from "./channel-streaming-jz9bt7qz.js";
import { t as log } from "./logger-x1d1QPh0.js";
import { A as CODEX_NATIVE_SUBAGENT_TASK_KIND, D as CODEX_NATIVE_SUBAGENT_RUNTIME, O as CODEX_NATIVE_SUBAGENT_RUN_ID_PREFIX } from "./task-registry-BIjrT3Xz.js";
import { c as recordTaskRunProgressByRunId, i as createRunningTaskRun, o as finalizeTaskRunByRunId } from "./detached-task-runtime-Bes_IDyE.js";
...
import "./codex-native-task-runtime-DSNMNrH8.js";
...
import { a as registerNativeHookRelay, c as runAgentHarnessAfterToolCallHook, l as runAgentHarnessBeforeMessageWriteHook } from "./native-hook-relay-E7nmNoxu.js";
import "./logging-core-Cqgysqf2.js";
import "./diagnostic-runtime-BFFfosbI.js";
import { c as resolveCodexAppServerRuntimeOptions, d as withMcpElicitationsApprovalPolicy, i as isCodexAppServerApprovalPolicyAllowedByRequirements, s as readCodexPluginConfig, u as resolveCodexPluginsPolicy } from "./config-BTXEeCZn.js";
import { a as readCodexDynamicToolCallParams, c as readCodexTurn, i as assertCodexTurnStartResponse } from "./protocol-validators-BS6fG6s8.js";
import { t as isJsonObject } from "./protocol-DGKLHosd.js";
import { i as isCodexAppServerConnectionClosedError, r as isCodexAppServerApprovalRequest } from "./client-Csgep1lz.js";
import { n as CODEX_CONTROL_METHODS } from "./request-DFresnGb.js";
import { d as resolveCodexUsageLimitResetAtMs, f as shouldRefreshCodexRateLimitsForUsageLimitMessage, r as formatCodexDisplayText, u as formatCodexUsageLimitErrorMessage } from "./command-formatters-CSETdfzE.js";
import { c as resolveCodexAppServerAuthAccountCacheKey, d as resolveCodexAppServerEnvApiKeyCacheKey, f as resolveCodexAppServerHomeDir, l as resolveCodexAppServerAuthProfileId, n as clearSharedCodexAppServerClientIfCurrent, s as refreshCodexAppServerAuthTokens, u as resolveCodexAppServerAuthProfileIdForAgent } from "./shared-client-BjLKq3ew.js";
import { i as readCodexAppServerBinding, t as clearCodexAppServerBinding } from "./session-binding-C3nrjt2R.js";
import { a as defaultCodexAppInventoryCache } from "./plugin-activation-DUwrZ8Y8.js";
import { t as buildCodexPluginAppCacheKey } from "./plugin-app-cache-key-BSzBmdD-.js";
import { C as isForcedPrivateQaCodexRuntime, S as filterCodexDynamicTools, T as resolveCodexDynamicToolsLoading, _ as projectContextEngineAssemblyForCodex, b as createCodexDynamicToolBridge, c as codexDynamicToolsFingerprint, f as startOrResumeThread, g as shouldBuildCodexPluginThreadConfig, h as mergeCodexThreadConfigs, i as buildDeveloperInstructions, l as isContextEngineBindingCompatible, m as buildCodexPluginThreadConfigInputFingerprint, p as buildCodexPluginThreadConfig, r as buildContextEngineBinding, s as buildTurnStartParams, t as areCodexDynamicToolFingerprintsCompatible, v as resolveCodexContextEngineProjectionMaxChars, w as normalizeCodexDynamicToolName, x as sanitizeCodexHistoryImagePayloads, y as resolveCodexContextEngineProjectionReserveTokens } from "./thread-lifecycle-dMIUBxKp.js";
import { t as defaultCodexAppServerClientFactory } from "./client-factory-DwOPc68G.js";
import { a as handleCodexAppServerElicitationRequest, c as emitDynamicToolTerminalDiagnostic, i as buildCodexNativeHookRelayDisabledConfig, l as handleCodexAppServerApprovalRequest, n as CODEX_NATIVE_HOOK_RELAY_EVENTS, o as emitDynamicToolErrorDiagnostic, r as buildCodexNativeHookRelayConfig, s as emitDynamicToolStartedDiagnostic, t as filterToolsForVisionInputs } from "./vision-tools-QuyAQyT3.js";
import { t as ensureCodexComputerUse } from "./computer-use-Czdqclxw.js";
import { n as rememberCodexRateLimits, t as readRecentCodexRateLimits } from "./rate-limit-cache-DeWShwM3.js";
