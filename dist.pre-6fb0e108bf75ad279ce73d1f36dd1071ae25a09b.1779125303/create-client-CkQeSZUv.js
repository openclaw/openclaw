...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-DtSw6SG6.js";
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-iH5AFB5p.js";
import "./config-__km5SrC.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-Cz-WaDqJ.js"), import("./logging-DWgONDJk.js")]).then(([sdkModule, loggingModule]) => ({
