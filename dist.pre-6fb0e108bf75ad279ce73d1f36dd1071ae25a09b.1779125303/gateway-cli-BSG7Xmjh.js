...
import { t as addGatewayServiceCommands } from "./register-service-commands-gmHQ8GCt.js";
import { n as defaultRuntime } from "./runtime-DDH_zqCr.js";
import { t as formatHelpExamples } from "./help-format-DARfDIxH.js";
import { t as addGatewayRunCommand } from "./run-command-Bq_bsj3T.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-CecpfA_d.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-B1SSh31H.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-K9ps4B5Y.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-CYHh7KeQ.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./health-style-CJtSZimh.js"));
...
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-Cx1TIvj7.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-BfCOUiD4.js"));
...
async function callGatewayCli(method, opts, params) {
	return (await import("./call-DWno0CTu.js")).callGatewayCli(method, opts, params);
}
async function runGatewayCommand(action, label, opts) {
	try {
		...
		if (opts?.json) {
			const { formatGatewayTransportErrorJson } = await import("./call-CMQ07sIs.js");
