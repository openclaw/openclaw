...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-1hzKg7LK.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { t as note } from "./note-Do3tkH_E.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-Hip4AP9O.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DPZzSSV8.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-9G0ZFEP6.js");
