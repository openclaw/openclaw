...
import { o as statRegularFile, r as readRegularFile } from "./regular-file-6GdZVPgG.js";
import { r as isCronRunSessionKey } from "./session-key-utils-CJRKuBJA.js";
import { t as createSubsystemLogger } from "./subsystem-BCvJ25zm.js";
import { a as hasInterSessionUserProvenance } from "./input-provenance-Cwr6skDj.js";
import { a as isSessionArchiveArtifactName, l as isUsageCountedSessionTranscriptFileName, p as parseUsageCountedSessionIdFromFileName, r as isCompactionCheckpointTranscriptFileName } from "./artifacts-CqGVp34X.js";
import { l as resolveSessionTranscriptsDirForAgent } from "./paths-_BPRx1WO.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-y3ANmeRx.js";
import { u as stripInternalRuntimeContext } from "./internal-runtime-context-tBUvZkew.js";
import { r as isSilentReplyPayloadText } from "./tokens-dY63daNF.js";
import { n as HEARTBEAT_PROMPT } from "./heartbeat-Dwk0vIKl.js";
import { r as isHeartbeatUserMessage } from "./heartbeat-filter-BYyAChZr.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-T1y2bTqV.js";
import { n as normalizeOptionalLowercaseString, t as normalizeLowercaseStringOrEmpty } from "./string-utils-CJAp5FPP.js";
import "./query-expansion-BrQsKNJ2.js";
import { i as isExecCompletionEvent } from "./heartbeat-events-filter-edWSlyBk.js";
import "./openclaw-runtime-session-DW2-_L_x.js";
import { t as formatErrorMessage } from "./error-utils-BGyNrsp0.js";
import "./fs-utils-BVpDnVLQ.js";
import "./openclaw-runtime-io-CipK-x4_.js";
import { t as hashText } from "./hash-CUZ6wWt6.js";
...
async function listSessionFilesForAgent(agentId) {
	...
	try {
		return (await fs$1.readdir(dir, { withFileTypes: true })).filter((entry) => entry.isFile()).map((entry) => entry.name).filter((name) => isUsageCountedSessionTranscriptFileName(name) && !isCompactionCheckpointTranscriptFileName(name)).map((name) => path.join(dir, name));
	} catch {
		return [];
	}
}
