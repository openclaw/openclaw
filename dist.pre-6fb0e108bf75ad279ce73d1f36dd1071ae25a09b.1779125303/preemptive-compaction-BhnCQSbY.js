...
import { i as resolveAgentContextLimits } from "./agent-scope-config-DdvF1onI.js";
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-D41tLhoP.js";
import { o as readRootJsonObjectSync } from "./json-files-1SmAauRO.js";
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-7SzmZTGQ.js";
import { v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-Cb7myZKf.js";
...
import { d as stripRuntimeContextCustomMessages } from "./internal-runtime-context-tBUvZkew.js";
import { n as extractToolResultId, t as extractToolCallsFromAssistant } from "./tool-call-id-Dg5v7mDo.js";
import { o as isTimeoutError } from "./failover-error-X0AL4fZN.js";
import { t as loadEmbeddedPiMcpConfig } from "./embedded-pi-mcp-fsuhwKUw.js";
import { t as log$2 } from "./logger-x1d1QPh0.js";
import { o as MIN_PROMPT_BUDGET_RATIO, r as applyPiCompactionSettingsFromConfig, s as MIN_PROMPT_BUDGET_TOKENS } from "./pi-settings-Dsa5RJWA.js";
import { n as retryAsync } from "./retry-CjAUzHMZ.js";
import { a as stripToolResultDetails, n as repairToolUseResultPairing } from "./session-transcript-repair-AixRxeSx.js";
import { c as persistTranscriptStateMutation, i as rewriteTranscriptEntriesInState, l as readTranscriptFileState, r as rewriteTranscriptEntriesInSessionManager } from "./context-engine-maintenance-DKExq-JS.js";
import path from "node:path";
import { SettingsManager, estimateTokens, generateSummary } from "@earendil-works/pi-coding-agent";
...
function loadBundleSettingsFile(params) {
	...
	if (!result.ok) {
		log$1.warn(`${result.error}: ${absolutePath}`);
		return null;
	}
...
//#endregion
export { createPreparedEmbeddedPiSettingsManager as _, computeAdaptiveChunkRatio as a, resolveContextWindowTokens as c, resolveLiveToolResultMaxChars as d, sessionLikelyHasOversizedToolResults as f, formatContextLimitTruncationNotice as g, truncateToolResultMessage as h, SUMMARIZATION_OVERHEAD_TOKENS as i, summarizeInStages as l, truncateOversizedToolResultsInSessionManager as m, shouldPreemptivelyCompactBeforePrompt as n, estimateMessagesTokens as o, truncateOversizedToolResultsInSession as p, SAFETY_MARGIN as r, pruneHistoryForContextShare as s, PREEMPTIVE_OVERFLOW_ERROR_TEXT as t, DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS as u };
