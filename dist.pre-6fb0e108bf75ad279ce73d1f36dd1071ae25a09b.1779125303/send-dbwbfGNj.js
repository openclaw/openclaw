...
import "./text-autolink-runtime-DpRhEuxU.js";
import { t as require_src } from "./src-VIxSHKKW.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-Bz4-GmwE.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-CroEDi3V.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-CDus_qFr.js";
import { t as fromBuffer } from "./lib-dNTLGCbx.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DKp6BVIL.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-91XOoFRV.js";
import { l as toRatio, n as decodeString } from "./Util-YggAID_m.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BWZbVx_6.js";
import { t as APEv2Parser } from "./APEv2Parser-CWzG6T7Y.js";
import { r as hasID3v1Header } from "./ID3v1Parser-C4eQdxrQ.js";
import { i as isStrictDirectRoom } from "./direct-room--McSw5y5.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-CAWsXpBp.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-C7VOi08M.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-BgWhtA67.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Cx2nEWY0.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DlV52Xdq.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-LFTshifY.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DXeJwrLz.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BTVR0Pip.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CK1-RdIJ.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DHBQxL_7.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-INiffkhZ.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BEcdPLIW.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CzzRQvCO.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-wzkLw8SE.js")).WaveParser;
	}
};
//#endregion
