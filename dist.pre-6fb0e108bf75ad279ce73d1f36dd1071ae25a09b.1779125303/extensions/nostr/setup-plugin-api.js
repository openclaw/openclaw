...
import { D as patchTopLevelChannelConfigSection, f as createStandardChannelSetupStatus } from "../../setup-wizard-helpers-DtRuTTnD.js";
...
import { t as NostrConfigSchema } from "../../config-schema-BYDKIkLq.js";
...
const nostrSetupWizard = createDelegatedSetupWizardProxy({
	channel,
	loadWizard: async () => (await import("../../setup-surface-BL1ulSPI.js")).nostrSetupWizard,
