...
import { A as resolveSessionStoreEntry } from "./store-load-CummK8JT.js";
import { s as updateSessionStore, v as resolveGroupSessionKey } from "./store-B9TKWqn_.js";
import "./sessions-CFVisdNZ.js";
import { a as resolveContextTokensForModel } from "./context-BZMCKdTj.js";
...
import { l as resolvePersistedOverrideModelRef } from "./model-selection-CiNpBU0C.js";
...
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-CLUecfTb.js";
import { a as copyReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-BMb_keYF.js";
...
import { r as getCliSessionBinding } from "./cli-session-BXA0HuBb.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-cvcbXcSK.js";
import "./selection-CxLqXYMv.js";
import { u as parseReplyDirectives } from "./payloads-BRs2XoZK.js";
import { o as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-CLfm2Rck.js";
import { n as hasCotFramePrefix } from "./normalize-reply-QRu2rSyz.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-De9GD36e.js";
import { n as buildAgentRuntimeOutcomePlan } from "./build-CaRKDsbY.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-C0M6GBgE.js";
import { t as runCliAgent } from "./cli-runner-BHhbzs45.js";
import { n as HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT, t as GENERIC_EXTERNAL_RUN_FAILURE_TEXT } from "./agent-runner-failure-copy-MD5qNHYw.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BAzb_NrN.js";
import { a as resolveAgentTurnAttachments, n as createBlockReplyContentKey } from "./block-reply-pipeline-DJNhkTmi.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-UMXyB4No.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-BlO_fHlR.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-X3KzGmuc.js");
						...
						const result = await runEmbeddedPiAgentDefault({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-DmIBbqm-.js");
