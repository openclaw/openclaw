...
import { t as backupCreateCommand } from "./backup-C58k0NbM.js";
import { n as resolvePluginMigrationProvider, r as resolvePluginMigrationProviders, t as ensureStandaloneMigrationProviderRegistryLoaded } from "./migration-provider-runtime-D8-aC1js.js";
import { n as buildMigrationReportDir, t as buildMigrationContext } from "./context-D-2CLw7V.js";
import { n as assertApplySucceeded, o as writeApplyResult, r as assertConflictFreePlan, t as MIGRATION_CONFLICT_REASON_PHRASES } from "./output-C1KZLeCe.js";
...
function buildMigrationProviderOptions(opts) {
	const options = {};
	if (opts.provider === "codex" && opts.verifyPluginApps === true) options.verifyPluginApps = true;
	if (opts.provider === "codex" && opts.configPatchMode) options.configPatchMode = opts.configPatchMode;
