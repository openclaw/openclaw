...
import { u as prepareScopedSetupConfig } from "./setup-helpers-CH11mQRi.js";
import "./setup-GoygcRQE.js";
import { a as resolveMatrixAccountConfig } from "./account-config-M60ihwbX.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-DqzGihqe.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Cxz1YGsN.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BLPI8kIM.js";
import { n as updateMatrixAccountConfig } from "./config-update-gJfwf4rM.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-B7oSGgwt.js");
