...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-BrXaC85A.js";
import { i as listChannelPlugins } from "./registry-BstTfco-.js";
import "./plugins-3tO_yYSp.js";
import { r as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-Dq8SuPVU.js";
import "./pi-bundle-mcp-tools-B8lUrUKg.js";
import { t as abortChatRunById } from "./chat-abort-DS0xFwab.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-BBKjfMnE.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-Cr8hQKhR.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-Bc_1NEbi.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-CshPQlht.js");
