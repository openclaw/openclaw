...
import "./server-plugins-DIdzi7S0.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReply } from "./run-wait-ChaYrEdk.js";
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-Bvf6T2P2.js");
