...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { buildPluginSnapshotReport } = await import("./status-B0T_I73v.js");
	...
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-YhKjFMSL.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-BTVqszOz.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-BYQ5s6Ph.js");
