...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-BprqTezz.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-B6u8FYA8.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-DHLm2ygQ.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CeEmy9eh.js");
	if (params.argv) {
