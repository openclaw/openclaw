...
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DSaoONSG.js";
import { n as t } from "./i18n-rRyaHfOB.js";
import { n as openUrl } from "./browser-open-BkhtTSEW.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-8lDhHenZ.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-Bil83c6f.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-BOjJIFOz.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-D_55ErzI.js";
import { t as isRemoteEnvironment } from "./remote-env-CVJu7br0.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-DjGc1py6.js");
		...
		if (codexInstall.installed) {
			const { offerPostInstallMigrations } = await import("./setup.post-install-migration-D1gDev4n.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-bjv_hxDR.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-C5ufC74_.js");
