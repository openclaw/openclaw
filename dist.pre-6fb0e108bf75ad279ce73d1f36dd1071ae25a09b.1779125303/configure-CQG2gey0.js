...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-CGS_KNEY.js";
...
import { t as ConfigMutationConflictError } from "./mutate-CzFeplWF.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-D1tXrpE1.js";
import { t as randomToken } from "./random-token-B-QfYP-0.js";
import "./config-B3X1PiiJ.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-C2lyf-36.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-B7N8N7Du.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-Bunu2uxF.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-Dm_ZdBv7.js";
import { n as applyAuthChoice } from "./auth-choice-D7uk3i3U.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DVULjRMO.js";
import { i as setupChannels } from "./onboard-channels-Cqehu-m6.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-B22iMe-O.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-vMe-6D3H.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B3I6gnRN.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-Bgz6d3Ua.js";
import { t as applyPrimaryModel } from "./provider-model-primary-CjHpD9lE.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-B2gQUHNt.js";
import { t as promptCustomApiConfig } from "./onboard-custom-CPRMpwUf.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-upp_J9gP.js";
import { n as formatHealthCheckFailure } from "./health-format-6NtUvdTi.js";
import { n as healthCommand } from "./health-BQtELmal.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DZQw2d0Z.js";
import { t as setupSkills } from "./onboard-skills-TwYtBSc6.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-bjv_hxDR.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-Ue7CnTsx.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CwT-UJeY.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-1vjsjfNB.js");
