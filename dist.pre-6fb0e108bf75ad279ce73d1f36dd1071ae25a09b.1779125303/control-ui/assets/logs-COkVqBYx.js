import{Q as e,et as t,nt as n,rt as r}from"./index-Uvfbadz0.js";var i=[`trace`,`debug`,`info`,`warn`,`error`,`fatal`];function a(e){if(!e)return``;let t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleTimeString()}function o(t,n){return n?e([t.message,t.subsystem,t.raw].filter(Boolean).join(` `)).includes(n):!0}function s(s){let c=e(s.filterText),l=i.some(e=>!s.levelFilters[e]),u=s.entries.filter(e=>e.level&&!s.levelFilters[e.level]?!1:o(e,c)),d=c||l?`filtered`:`visible`;return r`
    <section class="card">
      ...
      ${s.file?r`<div class="muted" style="margin-top: 10px;">File: ${s.file}</div>`:n}
      ${s.truncated?r`
            <div class="callout" style="margin-top: 10px">
              Log output truncated; showing latest chunk.
            </div>
          `:n}
      ${s.error?r`<div class="callout danger" style="margin-top: 10px;">${s.error}</div>`:n}

      <div class="log-stream" style="margin-top: 12px;" @scroll=${s.onScroll}>
        ${u.length===0?r` <div class="muted" style="padding: 12px">No log entries.</div> `:u.map(e=>r`
                <div class="log-row">
...
//# sourceMappingURL=logs-COkVqBYx.js.map