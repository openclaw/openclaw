...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DtRuTTnD.js";
...
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DGiJBKW6.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-B0_sAw74.js";
import { n as createFeishuSendReceipt } from "./send-result-B-LwX_V_.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-PzH71q2u.js";
import { t as messageActionTargetAliases } from "./security-audit-DOuoCt7-.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-9OLg7Ct0.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CV3m0Hr7.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-DLn4WMVW.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-BlleH1b-.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-dTmFBeO2.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-dTmFBeO2.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-BpqWQmTe.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BlI3DKJo.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-DByn_IQg.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-CHChW8JP.js");
