...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-1hzKg7LK.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-CzFeplWF.js";
...
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-MUoUmweT.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-C_PBk4ZY.js";
...
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BsmatCHS.js";
...
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-CFVisdNZ.js";
...
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-DyEwxu9l.js";
...
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-DiSkIL-u.js";
...
import { s as resolveTrustedGroupId } from "./pi-tools.policy-DR83lbED.js";
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-CtcayrYM.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-DkIcGLo1.js";
...
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-C9sBw16-.js";
...
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-BnoyJNYX.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-08EiJIEP.js";
...
import { d as listTaskRecords, s as getTaskById } from "./task-registry-BIjrT3Xz.js";
...
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-Bes_IDyE.js";
...
import { o as dispatchChannelMessageAction } from "./message-action-runner-IfKcaD-c.js";
import "./target-resolver-DdryPzG0.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-BOXRFKTl.js";
...
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-Ce3qLeZ3.js";
...
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-D1ubqyvd.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-BEnIsDpP.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-BUVKQSXc.js";
...
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-CMogBMai.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-DXDDO0HJ.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-vo1FCSEs.js";
import { t as formatForLog } from "./ws-log-CSg8ADH7.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-E7nmNoxu.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DEMwJbUP.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-CgqNLKsR.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-CxYG8ohN.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-DhFBN-8-.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-BSBrQera.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-Bo5iAGX5.js";
import { n as createOutboundSendDeps } from "./deps-bAQf-uqM.js";
import "./agent-CIWudW7f.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-BSzZUfbF.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DW9B911z.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-A8eJ-gNm.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-DcPARzdY.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C6JuMPQm.js";
import "./server-constants-CI_c5cWv.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-CbIPy56H.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CPeNaPT8.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-Mpushd8h.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-C_q7CAQI.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-C8Vxk-RO.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-Bz_vhCJM.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-Xq7VoH_F.js";
import { t as buildChannelUiCatalog } from "./catalog-C92bYv9U.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-DQZY7T9r.js";
import { s as normalizeUpdateChannel } from "./update-channels-B490jZ4K.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CcxlKuhh.js";
import { i as resolveConfigReloadMetadata, t as buildGatewayReloadPlan } from "./config-reload-plan-C3JMfGuK.js";
import { t as readConfiguredLogTail } from "./log-tail-DVVtkoTu.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-t9ofQrUr.js";
...
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-C2xzXBcO.js";
import { r as readPackageVersion } from "./package-json-h0hJQdz8.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-DchKfyx9.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-CDBms_4j.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-CiUfy889.js";
import { t as getStatusSummary } from "./status.summary-DbXakpCj.js";
import "./status-DTjPuV4R.js";
...
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-Bqv1z10s.js";
...
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-BxMZZo4k.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-D6bamQBc.js";
import "./heartbeat-runner-DZN352KI.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-BG_8tL6t.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-nDeCMXCg.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-Cn-fE2m_.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BF7HLIym.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-DHX73yIb.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-BJkCNUnd.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-C0aq4lc-.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-CCFatqKj.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-C-5JuUAx.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CS5Kv3Y6.js");
