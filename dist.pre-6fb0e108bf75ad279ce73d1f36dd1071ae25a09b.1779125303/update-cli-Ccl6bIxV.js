...
import { d as resolveIncludeRoots, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-Cnwfh6dH.js";
import { n as resolveCliName, t as replaceCliName } from "./cli-name-DBD8zPGg.js";
...
import "./daemon-cli-BiMy8RUO.js";
import { E as pathExists } from "./fs-safe-D4r8mUJk.js";
import { p as resolveUserPath, u as pathExists$1 } from "./utils-CpmNtyoq.js";
import { r as resolveConfigEnvVars } from "./env-substitution-Bb8-PpWk.js";
...
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-Bg5VORd_.js";
...
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-DkWiFxll.js";
import { c as resolveOfficialExternalPluginInstall, r as getOfficialExternalPluginCatalogManifest, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-Cd_w9tEa.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-D_ujnZcp.js";
import { r as runCommandWithTimeout } from "./exec-ByXDKomR.js";
import { F as asResolvedSourceConfig, I as asRuntimeConfig, K as createPreUpdateConfigSnapshot, o as parseConfigJson5, p as readSourceConfigBestEffort, u as readConfigFileSnapshot } from "./io-1hzKg7LK.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-vYt6YyMA.js";
import { a as resolveConfigIncludes } from "./includes-C_bBjUj2.js";
...
import { r as mutateConfigFileWithRetry } from "./mutate-CzFeplWF.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-CorvVGRh.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-C6ekBsdE.js";
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-Cb2yso3w.js";
import { i as resolveGatewayRestartLogPath, n as renderPosixRestartLogSetup, o as shellEscapeRestartLogValue } from "./restart-logs-QACcbOVZ.js";
import "./config-B3X1PiiJ.js";
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-C2lyf-36.js";
import { n as runDaemonInstall } from "./install-CY5aWH93.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-i6KTODux.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-xvGkqkO0.js";
import { r as formatDurationPrecise } from "./format-duration-1VggpwYc.js";
import { u as trimLogTail } from "./restart-sentinel-Cl-epAww.js";
import { n as stylePromptMessage } from "./prompt-style-YjPsDxhY.js";
import { t as formatHelpExamples } from "./help-format-DARfDIxH.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-B7N8N7Du.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-B2cuGje-.js";
import { c as resolveEffectiveUpdateChannel, i as formatUpdateChannelLabel, l as resolveRegistryUpdateChannel, r as channelToNpmTag, s as normalizeUpdateChannel, u as resolveUpdateChannelDisplay } from "./update-channels-B490jZ4K.js";
import { a as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-x67mwOg4.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-BJSPjpVm.js";
import { i as updateNpmInstalledPlugins, n as resolveTrustedSourceLinkedOfficialNpmSpec, r as syncPluginsForUpdateChannel, t as resolveTrustedSourceLinkedOfficialClawHubSpec } from "./update-YAt9xsQB.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-h0hJQdz8.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-D-3AsD47.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-CRQcEggJ.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as resolvePnpmGlobalDirFromGlobalRoot, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-DchKfyx9.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-BkrYTnjl.js";
import { t as doctorCommand } from "./doctor-BoPKk-U5.js";
import { n as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, r as UPDATE_POST_CORE_CONVERGENCE_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-CVbcpyv1.js";
import { t as summarizeGatewayServiceLayout } from "./service-layout-BQRjadwd.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-CDBms_4j.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-CiUfy889.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-h2xa-ALq.js";
import { t as selectStyled } from "./prompt-select-styled-Wfr3u-LN.js";
...
async function resolveManagedServicePackageUpdateRoot(params) {
	const layout = await summarizeGatewayServiceLayout(await resolveGatewayService().readCommand(process.env).catch(() => null));
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-Cmz-ZAqU.js");
...
async function updateCommand(opts) {
	...
	if (updateInstallKind === "package") {
		...
		if (managedServiceRootRedirect) {
			...
			if (!opts.json) defaultRuntime.log(theme.muted(`Targeting managed gateway service package root: ${managedServiceRootRedirect.root}`));
		}
	}
