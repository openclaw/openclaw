...
import { r as extractFirstTextBlock } from "./chat-message-content-ZRefYnI2.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-CCt-XKzl.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-dx5MvnuR.js";
import { t as applyParentDefaultHelpAction } from "./parent-default-help-D7ZIjyqv.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-DuKQ-H4P.js"),
			import("./client-CucKFSY8.js"),
