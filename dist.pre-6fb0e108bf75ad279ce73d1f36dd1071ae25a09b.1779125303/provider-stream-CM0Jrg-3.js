...
import { j as resolveProviderStreamFn } from "./provider-runtime-CQCG-5CG.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-DnDXhn2l.js";
import { r as getModelProviderRequestTransport } from "./provider-request-config-C4XXSCDA.js";
import { t as MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE } from "./assistant-error-format-UFgypZLY.js";
import { n as applyAnthropicPayloadPolicyToParams, r as resolveAnthropicPayloadPolicy } from "./anthropic-payload-policy-C0pzzU5o.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, b as transformTransportMessages, f as coerceTransportToolCallArguments, g as finalizeTransportStream, h as failTransportStream, i as createOpenAIResponsesTransportStreamFn, m as createWritableTransportEventStream, n as createAzureOpenAIResponsesTransportStreamFn, p as createEmptyTransportUsage, r as createOpenAICompletionsTransportStreamFn, v as sanitizeNonEmptyTransportPayloadText, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-Bz_7DUZS.js";
import { r as getModelProviderLocalService } from "./provider-local-service-BY99oi9X.js";
