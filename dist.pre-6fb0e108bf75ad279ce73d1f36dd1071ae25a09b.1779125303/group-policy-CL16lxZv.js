...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-BYnt-N-e.js";
import "./client-Dqk7uuKg.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-CSAXE3h5.js";
import { c as parseIMessageTarget } from "./targets-bP5VZz9p.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-C-e2KmdT.js";
import "./probe-Cv_8UwWj.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-B5ySuMGB.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-CTuT15XA.js");
