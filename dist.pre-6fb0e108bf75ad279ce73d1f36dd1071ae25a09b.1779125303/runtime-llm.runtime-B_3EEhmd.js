...
import { a as resolveModelCostConfig, t as estimateUsageCost } from "./usage-format-DageHPFn.js";
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ prepareSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-U_Kap7iC.js"), Promise.resolve(resolveRuntimeConfig(options))]);
