...
import { i as resolveSecretRefString } from "./resolve-DeoFl9S6.js";
...
import { f as resolveOAuthRefreshLockPath, i as hasRuntimeAuthProfileStoreSnapshot, l as resolveAuthStorePath, n as getRuntimeAuthProfileStoreSnapshot, o as setRuntimeAuthProfileStoreSnapshot } from "./runtime-snapshots-DMGDLaeG.js";
import { f as log, i as AUTH_STORE_LOCK_OPTIONS, l as OAUTH_REFRESH_CALL_TIMEOUT_MS, u as OAUTH_REFRESH_LOCK_OPTIONS } from "./store-cache-b4fi2Vpf.js";
import { A as shouldBootstrapFromExternalCliCredential, C as readExternalCliFallbackCredential, D as hasUsableOAuthCredential, E as hasMatchingOAuthIdentity, F as resolveTokenExpiryState, O as isSafeToAdoptBootstrapOAuthIdentity, S as ensureAuthStoreFile, T as areOAuthCredentialsEquivalent, c as loadAuthProfileStoreForSecretsRuntime, d as resolvePersistedAuthProfileOwnerAgentDir, f as saveAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles, j as shouldReplaceStoredOAuthCredential, k as isSafeToAdoptMainStoreOAuthIdentity, l as loadAuthProfileStoreWithoutExternalProfiles, p as updateAuthProfileStoreWithLock, w as readManagedExternalCliCredential } from "./store-DyEwxu9l.js";
import { t as normalizeOptionalSecretInput } from "./normalize-secret-input-MwbyxZGa.js";
...
import { a as refreshChutesTokens } from "./chutes-oauth-hZRVDJsx.js";
import { t as assertNoOAuthSecretRefPolicyViolations } from "./policy-CApXuaWJ.js";
import { t as clearLastGoodProfileWithLock } from "./profiles-CfM2F8tR.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-BN2u6gnA.js";
...
const oauthManager = createOAuthManager({
	...
	readFallbackCredential: ({ profileId, credential }) => credential.provider === "openai-codex" ? readExternalCliFallbackCredential({
		profileId,
		credential,
