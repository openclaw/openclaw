...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-B33KQ_0q.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-DP9T6L0d.js";
...
import { r as resetDirectoryCache } from "./target-resolver-DdryPzG0.js";
...
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-_R08XBjX.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-C3JMfGuK.js";
...
import { t as buildGatewayCronService } from "./server-cron-CUpsUFLa.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B6SHLJcB.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DNmhq0Tq.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-B_7AYt2s.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-CshPQlht.js"), import("./gmail-watcher-lifecycle-d_ZuGlzv.js")]);
