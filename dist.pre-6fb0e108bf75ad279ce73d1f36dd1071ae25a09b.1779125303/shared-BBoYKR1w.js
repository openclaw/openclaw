...
import { n as LogService } from "./logger-4s2p7YRt.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-Crv9PtXL.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-__km5SrC.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-Bji65_9F.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
