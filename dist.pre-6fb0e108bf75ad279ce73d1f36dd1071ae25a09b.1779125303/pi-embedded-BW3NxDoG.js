...
import { o as resolveAgentExecutionContract, r as hasConfiguredModelFallbacks, v as resolveSessionAgentIds } from "./agent-scope-rw2bYM9R.js";
...
import { i as freezeDiagnosticTraceContext } from "./diagnostic-trace-context-5yrj1tXL.js";
...
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-Cltmiw-3.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-DJtqYoTD.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-BQTqLgE3.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime, u as resolveSelectedOpenAIPiRuntimeProvider } from "./openai-codex-routing-8M9hE9Ml.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Cd2Qar9Y.js";
import { a as resolveContextEngineOwnerPluginId, i as resolveContextEngine } from "./registry-Q0MBSM-3.js";
import { s as emitAgentPlanEvent } from "./agent-events-DkpIHRmj.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-ZRefYnI2.js";
import { X as resolveProviderAuthProfileId, b as prepareProviderRuntimeAuth } from "./provider-runtime-CQCG-5CG.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-DyEwxu9l.js";
import { n as sleepWithAbort } from "./backoff-eS-jP5b6.js";
import "./auth-profiles-K7ltUfHT.js";
import { n as markAuthProfileSuccess } from "./profiles-CfM2F8tR.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-Jt7GQPPD.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-C4XXSCDA.js";
import { t as redactIdentifier } from "./redact-identifier-B4X5hGr3.js";
import { t as sanitizeForConsole } from "./console-sanitize-DbpCX40S.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-CAsNPmFe.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared-DD3QApPW.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-B-ZTCWdm.js";
import "./runs-D5kx4FJD.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-UFgypZLY.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DF4us71R.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-DSifyx0L.js";
import { t as ensureContextEnginesInitialized } from "./init-DoEwB1KC.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BcPqSj44.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-BK25y-g_.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-dY63daNF.js";
import { a as enqueueSystemEvent } from "./system-events-CvlpBn9J.js";
import { i as enqueueCommandInLane } from "./command-queue-C-_VpIyT.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-B3o9fgUx.js";
import { a as formatAssistantErrorText, b as parseImageSizeError, c as isBillingAssistantError, f as isFailoverAssistantError, h as isRateLimitAssistantError, i as extractObservedOverflowTokenCount, m as isLikelyContextOverflowError, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, y as parseImageDimensionError } from "./errors-CLUecfTb.js";
import { a as copyReplyPayloadMetadata, d as setReplyPayloadMetadata, o as getReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-BMb_keYF.js";
import { a as hasReplyPayloadContent } from "./payload-DbjTNHKL.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-cvcbXcSK.js";
import { C as createEmbeddedRunStageTracker, S as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, T as shouldWarnEmbeddedRunStageSummary, _ as resolveRateLimitProfileRotationLimit, _t as resolveRunLivenessState, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, b as createUsageAccumulator, bt as createEmbeddedRunReplayState, c as buildErrorAgentMeta, ct as extractPlanningOnlyPlanDetails, d as resolveActiveErrorContext, dt as resolveEmptyResponseRetryInstruction, f as resolveFinalAssistantRawText, ft as resolveIncompleteTurnPayloadText, g as resolveOverloadProfileRotationLimit, gt as resolveReplayInvalidFlag, h as resolveOverloadFailoverBackoffMs, ht as resolveReasoningOnlyRetryInstruction, i as selectAgentHarness, l as buildUsageAgentMetaFields, lt as resolveAckExecutionFastPathInstruction, m as resolveMaxRunRetryIterations, mt as resolvePlanningOnlyRetryLimit, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, p as resolveFinalAssistantVisibleText, pt as resolvePlanningOnlyRetryInstruction, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, st as STRICT_AGENTIC_BLOCKED_TEXT, u as createCompactionDiagId, ut as resolveAttemptReplayMetadata, v as resolveReportedModelRef, vt as resolveSilentToolResultReplyPayload, w as formatEmbeddedRunStageSummary, x as mergeUsageIntoAccumulator, xt as observeReplayMetadata, y as scrubAnthropicRefusalMagic, yt as shouldTreatEmptyAssistantReplyAsSilent } from "./selection-CxLqXYMv.js";
import { D as isStrictAgenticExecutionContractActive, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-CtcayrYM.js";
import { p as buildAgentHookContextChannelFields, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-DNOLCNDp.js";
import { i as listActiveProcessSessionReferences, r as resolveContextEngineCapabilities, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-Bpof4tXZ.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-GzHz8BCE.js";
import { c as resolveFailoverStatus, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-X0AL4fZN.js";
import { l as runAgentCleanupStep } from "./attempt.tool-run-context-BgVZIgnr.js";
import { c as retireSessionMcpRuntimeForSessionKey, s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Dq8SuPVU.js";
import "./pi-bundle-mcp-tools-B8lUrUKg.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-BbBO3S4w.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-CCLx3KcF.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-B13pK4IE.js";
import { u as parseReplyDirectives } from "./payloads-BRs2XoZK.js";
import { j as formatToolAggregate } from "./channel-streaming-jz9bt7qz.js";
import { u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-CYFo7SlJ.js";
import { a as suspendSession, c as shouldAllowCooldownProbeForReason, i as resolveSessionSuspensionReason, l as buildApiErrorObservationFields, o as LiveSessionModelSwitchError } from "./model-fallback-CLfm2Rck.js";
import { t as log$1 } from "./logger-x1d1QPh0.js";
import { d as resolveLiveToolResultMaxChars, f as sessionLikelyHasOversizedToolResults, p as truncateOversizedToolResultsInSession } from "./preemptive-compaction-BhnCQSbY.js";
import "./tool-split-Bih9ck-5.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-C4Sn7RHt.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-DSQESaZ0.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-DKExq-JS.js";
import "./extra-params-CMsQNC0R.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-BkBTCGvc.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-DazbwoJO.js";
import { r as buildAgentRuntimePlan } from "./build-CaRKDsbY.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-Ce3qLeZ3.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-CdXC9fQD.js";
import { n as resolveModelAsync } from "./model-thrtzMee.js";
import "./compact.queued-5CwEcCw5.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-ChJ0Hrq9.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-W_BMXwWH.js";
...
function resolveAuthProfileFailureReason(params) {
	if (params.policy === "local" || !params.failoverReason || params.failoverReason === "timeout" || params.failoverReason === "server_error" || params.failoverReason === "empty_response" || params.failoverReason === "format") return null;
...
async function runEmbeddedPiAgent(params) {
	...
	return enqueueSession(() => {
		...
		return enqueueGlobal(async () => {
			...
			const pluginHarnessNeedsOpenClawAuthBootstrap = pluginHarnessOwnsTransport && provider === "openai-codex" && effectiveModel.api === "openai-codex-responses";
			const authStore = pluginHarnessNeedsOpenClawAuthBootstrap ? ensureAuthProfileStore(agentDir, { allowKeychainPrompt: false }) : pluginHarnessOwnsTransport ? createEmptyAuthProfileStore() : ensureAuthProfileStoreWithoutExternalProfiles(agentDir, { allowKeychainPrompt: false });
