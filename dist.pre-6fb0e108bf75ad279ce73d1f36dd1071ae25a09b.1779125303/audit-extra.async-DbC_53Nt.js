...
import { t as collectIncludePathsRecursive } from "./includes-scan-DKBYoCmd.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-CEbemzX5.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-BSIusln-.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CjTpYdDU.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-CXJIGEMA.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-Nug7d7oV.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-v0OcnUJI.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-Be3vqt6B.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-j8cTl7Dw.js");
