...
import { E as consumeRootOptionToken, u as isHelpOrVersionInvocation } from "./argv-DEHjUPTf.js";
...
import { t as computeBackoff } from "./backoff-eS-jP5b6.js";
...
function resolveContextTokensForModel(params) {
	...
	if (ref) {
		if (explicitProvider && isAnthropic1MModel(ref.provider, ref.model)) return ANTHROPIC_CONTEXT_1M_TOKENS;
		if (explicitProvider) {
