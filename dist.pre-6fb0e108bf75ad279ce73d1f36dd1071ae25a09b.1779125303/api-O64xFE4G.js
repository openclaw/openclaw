...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-DYNSxqZe.js";
import "./ssrf-runtime-Cu4zbqxY.js";
import "./text-utility-runtime-Bj7O9lbY.js";
import "./runtime-api-CN7a4ECB.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-CgNCoEoC.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-COp6f0gc.js")]);
			return {
