import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-DKfds54C.js";
import { r as loadCrestodianOverview } from "./overview-Do_SfyjV.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-Bjoz9hAo.js")).planCrestodianCommand)({
		input,
		overview
	});
