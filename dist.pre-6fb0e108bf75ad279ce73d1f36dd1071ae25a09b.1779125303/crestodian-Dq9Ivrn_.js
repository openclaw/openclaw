...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-Do_SfyjV.js";
import { r as resolveCrestodianOperation } from "./dialogue-Brbg6ZCi.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CRY0ng8g.js")).runCrestodianTui;
	opts.onReady?.();
