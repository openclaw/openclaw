...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-DQypTXmR.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-CC2Hqi9z.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CXV3yr2x.js";
import "./channel-api-C2DE_Orp.js";
import { t as parseDiscordTarget } from "./target-parsing-Dmrbc9no.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-D7kz95ry.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-BLL1XJSk.js";
import { t as getDiscordRuntime } from "./runtime-C6oPaQ3q.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-BvnjrFqj.js";
import { t as getDiscordApprovalCapability } from "./approval-native-CilPSbcy.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-hHnAzQuW.js";
import { t as discordMessageActions$1 } from "./channel-actions-9tgHFv9I.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-DCOs6Mgl.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-CMFvBU9_.js";
import { n as discordOutbound } from "./outbound-adapter-Ci_y427w.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared--p1IHIdw.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-CWJaEwfs.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CmSgrnpn.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-D5LUaW2G.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BG21bqxV.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-COb794gR.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-BpWvQAvF.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-rX1zuVr_.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-BROXfBXY.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DBOiYSdx.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-CwpKJHOV.js");
