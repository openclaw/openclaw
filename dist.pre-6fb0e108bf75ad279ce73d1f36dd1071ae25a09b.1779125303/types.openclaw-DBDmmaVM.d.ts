import { h as SecretsConfig, l as SecretInput } from "./types.secrets-CD6lO6cv.js";
import { d as ModelsConfig, f as AgentEmbeddedHarnessConfig, g as AgentToolModelConfig, h as AgentSandboxConfig, m as AgentRuntimePolicyConfig, p as AgentModelConfig } from "./types.models-BQ31eD8b.js";
import { t as ChatType } from "./chat-type-DN6x5145.js";
import { E as SessionConfig, H as TypingMode, U as WebConfig, b as LoggingConfig, g as DmScope, n as BlockStreamingChunkConfig, p as DiagnosticsConfig, r as BlockStreamingCoalesceConfig, v as HumanDelayConfig, y as IdentityConfig } from "./types.base-CzXKYjot.js";
import { M as MemoryConfig, O as ToolsConfig, _ as MemorySearchConfig, t as AgentToolsConfig } from "./types.tools-9EnNA1hP.js";
import { Gt as ApprovalsConfig, Xt as AudioConfig, Zt as BroadcastConfig, hn as TtsConfig, on as MessagesConfig, r as ChannelsConfig, rn as GroupChatConfig, tn as CommandsConfig } from "./types.channels-B8PNxvXK.js";
import { t as ProxyConfig } from "./zod-schema.proxy-DwbEL6hi.js";
...
type AgentDefaultsConfig = {
  ...
  runRetries?: AgentRunRetriesConfig; /** Embedded Pi runner hardening and compatibility controls. */
  embeddedPi?: {
    /**
  ...
  sandbox?: AgentSandboxConfig; /** Agent self-elected turn continuation (CONTINUE_WORK signal). */
  continuation?: {
    enabled?: boolean;
    ...
    costCapTokens?: number; /** Maximum number of continue_delegate tool calls per agent turn (default: 5). */
...
type AgentConfig = {
  ...
  bootstrapTotalMaxChars?: AgentDefaultsConfig["bootstrapTotalMaxChars"]; /** Optional allowlist of skills for this agent; omitting it inherits agents.defaults.skills when set, and an explicit list replaces defaults instead of merging. */
  skills?: string[];
  ...
  runRetries?: AgentDefaultsConfig["runRetries"]; /** Optional per-agent embedded Pi overrides. */
  embeddedPi?: {
...
//#endregion
export { GatewayReloadMode as $, AgentAcpBinding as $t, InternalHooksConfig as A, OptionalBootstrapFileName as An, AccessGroupConfig as At, GatewayHttpConfig as B, AcpRuntimeDoctorReport as Bt, HookInstallRecord as C, AgentModelEntryConfig as Cn, BrowserConfig as Ct, HooksConfig as D, CliBackendConfig as Dn, BrowserTabCleanupConfig as Dt, HookMappingTransform as E, AgentStartupContextConfig as En, BrowserSsrFPolicyConfig as Et, GatewayBindMode as F, AcpDispatchConfig as Ft, GatewayHttpResponsesPdfConfig as G, AcpRuntimeSessionMode as Gt, GatewayHttpResponsesConfig as H, AcpRuntimeEvent as Ht, GatewayConfig as I, AcpRuntimeConfig as It, GatewayNodesConfig as J, AcpRuntimeTurnAttachment as Jt, GatewayHttpSecurityHeadersConfig as K, AcpRuntimeStatus as Kt, GatewayControlUiConfig as L, AcpStreamConfig as Lt, GatewayAuthConfig as M, SubagentDelegationMode as Mn, DiscordChannelAudienceAccessGroup as Mt, GatewayAuthMode as N, SilentReplyConversationType as Nn, MessageSendersAccessGroup as Nt, HooksGmailConfig as O, EmbeddedPiExecutionContract as On, AuthConfig as Ot, GatewayAuthRateLimitConfig as P, AcpConfig as Pt, GatewayReloadConfig as Q, AcpSessionUpdateTag as Qt, GatewayHttpChatCompletionsConfig as R, AcpRuntime as Rt, HookConfig as S, AgentDefaultsConfig as Sn, CliConfig as St, HookMappingMatch as T, AgentRunRetriesConfig as Tn, BrowserSnapshotDefaults as Tt, GatewayHttpResponsesFilesConfig as U, AcpRuntimeHandle as Ut, GatewayHttpEndpointsConfig as V, AcpRuntimeEnsureInput as Vt, GatewayHttpResponsesImagesConfig as W, AcpRuntimePromptMode as Wt, GatewayPushApnsRelayConfig as X, AcpRuntimeTurnResult as Xt, GatewayPushApnsConfig as Y, AcpRuntimeTurnInput as Yt, GatewayPushConfig as Z, AcpRuntimeTurnResultError as Zt, NodeHostConfig as _, AgentCompactionPostIndexSyncMode as _n, CronFailureDestinationConfig as _t, ResolvedSourceConfig as a, AgentRuntimeConfig as an, GatewayTrustedProxyConfig as at, McpServerCodexConfig as b, AgentContextLimitsConfig as bn, CommitmentsConfig as bt, SecurityConfig as c, SkillsConfig as cn, MdnsDiscoveryMode as ct, PluginEntryConfig as d, SkillsLoadConfig as dn, TalkConfigResponse as dt, AgentBinding as en, GatewayRemoteConfig as et, PluginInstallRecord as f, AgentCompactionConfig as fn, TalkProviderConfig as ft, NodeHostBrowserProxyConfig as g, AgentCompactionMode as gn, CronFailureAlertConfig as gt, PluginsLoadConfig as h, AgentCompactionMidTurnPrecheckConfig as hn, CronConfig as ht, OpenClawConfig as i, AgentRuntimeAcpConfig as in, GatewayToolsConfig as it, DiscoveryConfig as j, PromptOverlaysConfig as jn, AccessGroupsConfig as jt, HooksGmailTailscaleMode as k, Gpt5PromptOverlayConfig as kn, AuthProfileConfig as kt, SourceConfig as l, SkillsInstallConfig as ln, ResolvedTalkConfig as lt, PluginsConfig as m, AgentCompactionMemoryFlushConfig as mn, WideAreaDiscoveryConfig as mt, ConfigValidationIssue as n, AgentConfig as nn, GatewayTailscaleMode as nt, RuntimeConfig as o, AgentsConfig as on, GatewayWebchatConfig as ot, PluginSlotsConfig as p, AgentCompactionIdentifierPolicy as pn, TalkRealtimeConfig as pt, GatewayNodePairingConfig as q, AcpRuntimeTurn as qt, LegacyConfigIssue as r, AgentRouteBinding as rn, GatewayTlsConfig as rt, SecurityAuditSuppression as s, SkillConfig as sn, MdnsDiscoveryConfig as st, ConfigFileSnapshot as t, AgentBindingMatch as tn, GatewayTailscaleConfig as tt, SurfaceConfigEntry as u, SkillsLimitsConfig as un, TalkConfig as ut, McpCodexToolApprovalMode as v, AgentCompactionQualityGuardConfig as vn, CronRetryConfig as vt, HookMappingConfig as w, AgentModelListConfig as wn, BrowserProfileConfig as wt, McpServerConfig as x, AgentContextPruningConfig as xn, CliBannerTaglineMode as xt, McpConfig as y, AgentContextInjection as yn, CronRetryOn as yt, GatewayHttpChatCompletionsImagesConfig as z, AcpRuntimeCapabilities as zt };