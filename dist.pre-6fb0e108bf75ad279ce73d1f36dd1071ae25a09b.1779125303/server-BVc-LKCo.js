...
import { p as resolveUserPath, s as ensureDir } from "./utils-CpmNtyoq.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-BwNQflYJ.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-Cjg8t4A5.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-BM00XOzV.js");
