...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-CdvBpLCm.js";
import { t as providerSupportsCapability } from "./provider-supports-DHGQBWeS.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-BQApWS6P.js";
...
import { a as runCliEntry, c as extractGeminiResponse, d as isMediaUnderstandingSkipError, l as fileExists, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as MediaUnderstandingSkipError } from "./runner.entries-TtYIMhjW.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-AIN7gySq.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-Dn-r85_h.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BYJX8bu5.js");
