...
import { n as discoverConfigSecretTargets } from "./target-registry-CUu9liyz.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-1hzKg7LK.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-CjVg8wOZ.js";
...
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, o as listLegacyRuntimeModelProviderAliases, s as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-BjCkEewK.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-BgFPbp3m.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-DVZsqeEE.js";
import { t as note } from "./note-Do3tkH_E.js";
import { t as asObjectRecord } from "./object-r4XeS6Ib.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-Hip4AP9O.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-DZdkc3cU.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BFoCeX1Y.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BTEGfu_I.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DbSX19Gd.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-B4v-ZwMJ.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DbUr0gU7.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CsKD_wTq.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-B7kRKf__.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DMenGJMh.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-DmajU_Ip.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DGNnprtp.js");
		emitDoctorNotes({
			note,
