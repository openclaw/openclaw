...
import { c as updateSessionStoreEntry, s as updateSessionStore } from "./store-B9TKWqn_.js";
...
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-D5kx4FJD.js";
...
import { a as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-DageHPFn.js";
...
import { r as enqueueCommitmentExtraction } from "./runtime-DlbXScTM.js";
...
import { r as resolveLiveContinuationRuntimeConfig } from "./config-DwtBFSde.js";
...
import { r as runWithModelFallback } from "./model-fallback-CLfm2Rck.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-BhnCQSbY.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Cvuo8S8S.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-B6wzCfNt.js";
...
import { n as routeReply, t as isRoutableChannel } from "./route-reply-MWwjybga.js";
import "./sandbox-C8SCsMbP.js";
import { n as readPostCompactionContext } from "./post-compaction-context-DXF4FO86.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CaRKDsbY.js";
import { a as resolveReplyRunFireReason, c as runCliAgentWithLifecycle, i as runAgentTurnWithFallback, n as resolveRunAfterAutoFallbackPrimaryProbeRecheck, o as normalizeReplyPayloadDirectives, r as resolveSessionRuntimeOverrideForProvider, t as buildKnownAgentRunFailureReplyPayload } from "./agent-runner-execution-CJZlUVTc.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-C0M6GBgE.js";
...
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-DJNhkTmi.js";
...
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-LdkQAdLA.js";
...
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-CNqf6mAr.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-_bjiglqK.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BE4xtdzw.js"),
					import("./config-DDESm4Lu.js"),
					import("./state-Dt-L5RIQ.js"),
					import("./store-sn3uyhN0.js")
				]);
