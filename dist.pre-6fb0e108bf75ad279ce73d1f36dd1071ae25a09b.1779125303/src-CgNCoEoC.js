...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-CPnLV12E.js";
import { n as require_extend, t as require_package$1 } from "./package-Cvj16V3B.js";
import { t as require_json_bigint } from "./json-bigint-DDhZWfYe.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-r1y0G1Mr.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-DQ7oq2th.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
