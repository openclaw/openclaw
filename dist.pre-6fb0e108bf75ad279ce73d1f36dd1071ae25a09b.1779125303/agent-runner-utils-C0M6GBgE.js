...
import { m as resolveEffectiveModelFallbacks } from "./agent-scope-rw2bYM9R.js";
...
import { a as normalizeAnyChannelId, o as normalizeChannelId } from "./registry-CqoTFbCs.js";
import { t as getChannelPlugin } from "./registry-BstTfco-.js";
import "./plugins-3tO_yYSp.js";
import { St as isReasoningTagProvider } from "./selection-CxLqXYMv.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-CPMcPd7m.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-BjS5t86C.js";
import { d as getScopedChannelsCommandSecretTargets, t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-D-8REAPe.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo } from "./origin-routing-BAzb_NrN.js";
...
function resolveModelFallbackOptions(run, configOverride = run.config) {
	...
	const fallbacksOverride = run.imageModelFallbacksOverride ?? resolveEffectiveModelFallbacks({
		cfg: config,
		agentId: run.agentId,
...
function buildEmbeddedRunBaseParams$1(params) {
	...
	const modelFallbacksOverride = params.run.imageModelFallbacksOverride ?? resolveEffectiveModelFallbacks({
		cfg: config,
