...
import { V as formatMemoryDreamingDay } from "./dreaming-BFFs4Xr8.js";
import "./string-coerce-runtime-DVkpEjUr.js";
import "./security-runtime-BosJLfjB.js";
import { n as appendMemoryHostEvent } from "./events-DreXPiCK.js";
import "./memory-core-host-status-4BqbiH69.js";
import "./memory-host-events-TlrXhmvK.js";
import "./dreaming-shared-BDzbDiOZ.js";
...
async function readStore(workspaceDir, nowIso) {
	try {
		return normalizeStore(await privateFileStore(workspaceDir).readJsonIfExists(SHORT_TERM_STORE_RELATIVE_PATH), nowIso);
	} catch (err) {
