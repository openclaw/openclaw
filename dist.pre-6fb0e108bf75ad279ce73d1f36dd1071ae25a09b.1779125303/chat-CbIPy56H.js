...
import { b as assertNoWindowsNetworkPath, w as safeFileURLToPath } from "./fs-safe-D4r8mUJk.js";
import { r as openLocalFileSafely } from "./secure-temp-dir-GC3bO7Qi.js";
...
import { c as measureDiagnosticsTimelineSpanSync, s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-D41tLhoP.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-Cltmiw-3.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BNv08iCR.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-CNnWDHPu.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-DJtqYoTD.js";
import { r as setSafeTimeout } from "./timer-delay-BQTqLgE3.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-UtR7bV2l.js";
import { s as normalizeInputProvenance } from "./input-provenance-Cwr6skDj.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-D5DA_QCa.js";
import "./method-scopes-DfV0ICXA.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Cd2Qar9Y.js";
import "./local-file-access-BQ4lumbi.js";
import { t as isPassThroughRemoteMediaSource } from "./media-source-url-BHCwpZ_Z.js";
import { i as resolveSessionFilePath } from "./paths-_BPRx1WO.js";
import "./sessions-CFVisdNZ.js";
import { o as isAudioFileName } from "./mime-BjHvxzTf.js";
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-lk2Qo398.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Bk5onV1S.js";
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, x as resolveModelRefFromString } from "./model-selection-shared-fWnBOAl-.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-DC7uJpmA.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-PddAQNi6.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-CY8iyrqK.js";
import { n as resolveSendPolicy } from "./send-policy-v1xxWDxl.js";
import { c as isReplyPayloadTtsSupplement, i as buildTtsSupplementMediaPayload, s as getReplyPayloadTtsSupplement } from "./reply-reference-BMb_keYF.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-DT1jUOfQ.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-BRs2XoZK.js";
import { c as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-CYFo7SlJ.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-C25GuYX2.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-D-1cbtbS.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-DLoYDOLF.js";
...
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-C8SCsMbP.js";
import { n as rewriteTranscriptEntriesInSessionFile } from "./context-engine-maintenance-DKExq-JS.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-UMXyB4No.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-DKzAF9cf.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-Ci7Zzn08.js";
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-DS0xFwab.js";
...
import { t as formatForLog } from "./ws-log-CSg8ADH7.js";
import "./channel-message-DeX9rRst.js";
import { t as logLargePayload } from "./diagnostic-payload-D7gAcunS.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-Bzwl8nJF.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-Ilg4B9lI.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-CI_c5cWv.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-6WMzP9LS.js";
import { a as resolveChatAttachmentLooksLikeImage, i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CPeNaPT8.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-Ct3EhHcm.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-vktq-DQ7.js";
...
async function abortChatRunsForSessionKeyWithPartials(params) {
	...
	if (authorizedRuns.length === 0) return {
		aborted: false,
		runIds: [],
		...
		try {
			...
			measureDiagnosticsTimelineSpan("gateway.chat_send.dispatch_inbound", () => dispatchInboundMessage({
				...
				await measureDiagnosticsTimelineSpan("gateway.chat_send.post_dispatch", async () => {
					...
					} else if (!hasBeforeAgentRunGate) await emitUserTranscriptUpdate().catch((transcriptErr) => {
