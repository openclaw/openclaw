...
import { t as setupWizardCommand } from "./onboard-D1lglraL.js";
...
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-BPgBaExs.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-h-CmlDDj.js");
