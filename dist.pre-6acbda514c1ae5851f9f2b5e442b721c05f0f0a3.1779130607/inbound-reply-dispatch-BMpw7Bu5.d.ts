...
import { r as GetReplyOptions } from "./get-reply-options.types-C9Ngv65K.js";
import { t as FinalizedMsgContext } from "./templating-8_WokN_0.js";
import { t as OutboundReplyPayload } from "./reply-payload-DpKGqclz.js";
import { n as ReplyDispatcher } from "./reply-dispatcher.types-Dldn6GIv.js";
import { t as DispatchFromConfigResult } from "./dispatch-from-config.types-V4BGxB-7.js";
import { t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-CbSQv3G0.js";
import { F as recordChannelBotPairLoopAndCheckSuppression, M as ChannelBotLoopProtectionFacts, O as RunChannelTurnParams, T as PreparedChannelTurn, _ as ChannelTurnResult, b as DispatchedChannelTurnResult, d as ChannelTurnDroppedHistoryOptions, m as ChannelTurnRecordOptions } from "./types-BkgU1SYJ.js";
import { c as DurableInboundReplyDeliveryParams, r as recordDroppedChannelTurnHistory, s as DurableInboundReplyDeliveryOptions, u as deliverInboundReplyWithMessageSendContext } from "./kernel-LPf7PHY2.js";
import { a as hasVisibleChannelTurnDispatch, i as hasFinalChannelTurnDispatch, o as resolveChannelTurnDispatchCounts } from "./dispatch-result-1zUcpDVu.js";
import { t as recordInboundSession } from "./session-29zTrfxW.js";

//#region src/plugin-sdk/inbound-reply-dispatch.d.ts
declare namespace inbound_reply_dispatch_d_exports {
  export { ChannelBotLoopProtectionFacts, ChannelTurnDroppedHistoryOptions, ChannelTurnRecordOptions, DurableInboundReplyDeliveryParams, buildChannelMessageReplyDispatchBase, buildInboundReplyDispatchBase, deliverInboundReplyWithMessageSendContext as deliverDurableInboundReplyPayload, deliverInboundReplyWithMessageSendContext, dispatchChannelMessageReplyWithBase, dispatchInboundReplyWithBase, dispatchReplyFromConfigWithSettledDispatcher, hasFinalChannelMessageReplyDispatch, hasFinalChannelTurnDispatch as hasFinalInboundReplyDispatch, hasVisibleChannelMessageReplyDispatch, hasVisibleChannelTurnDispatch as hasVisibleInboundReplyDispatch, recordChannelBotPairLoopAndCheckSuppression, recordChannelMessageReplyDispatch, recordDroppedChannelTurnHistory, recordInboundSessionAndDispatchReply, resolveChannelMessageReplyDispatchCounts, resolveChannelTurnDispatchCounts as resolveInboundReplyDispatchCounts, runInboundReplyTurn, runPreparedInboundReplyTurn };
}
