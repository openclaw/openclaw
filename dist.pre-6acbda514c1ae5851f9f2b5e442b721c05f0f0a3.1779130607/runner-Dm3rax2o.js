...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-Da3eL7im.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-D-1cbtbS.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-IMtXxaK_.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-CxMtlOED.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-M8C4Wfot.js";
import { t as providerSupportsCapability } from "./provider-supports-DHGQBWeS.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CnI6W1hF.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-BKtR9vsk.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CLPodVIq.js";
import { t as buildRandomTempFilePath } from "./temp-download-DHYgYMZm.js";
import "./temp-path-BJxcHOwI.js";
import { a as runCliEntry, c as extractGeminiResponse, d as isMediaUnderstandingSkipError, l as fileExists, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as MediaUnderstandingSkipError } from "./runner.entries-B6CFPvRY.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-BxZY5_Dk.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-CWKv3H72.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-DfXTBaTr.js");
