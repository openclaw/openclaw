...
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-CLUecfTb.js";
import { p as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-WIoUdgJQ.js";
import { c as resolveFailoverStatus, i as isFailoverError, t as FailoverError } from "./failover-error-X0AL4fZN.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-W7c_ATBY.js";
import { i as loadCliSessionHistoryMessages, o as buildAgentHookConversationMessages, r as loadCliSessionContextEngineMessages } from "./session-history-QS08D4pG.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-Cg_QdVT6.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-Bv6nynGF.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-DBbNTbbq.js");
