...
export type PluginCapabilityKind = "cli-backend" | "text-inference" | "speech" | "realtime-transcription" | "realtime-voice" | "media-understanding" | "image-generation" | "video-generation" | "music-generation" | "web-search" | "agent-harness" | "context-engine" | "channel";
