...
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-CLqI5G-i.js";
import { l as roleScopesAllow } from "./pairing-token-jvr-I4nz.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-J8WtOSJI.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-BS6dA4jK.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-DBUNOIRp.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-Dzl222hW.js";
import { n as logWs, t as formatForLog } from "./ws-log-DPeC0KGC.js";
import { a as restoreDeviceBootstrapToken, c as verifyDeviceBootstrapToken, i as redeemDeviceBootstrapTokenProfile, n as getDeviceBootstrapTokenProfile, o as revokeDeviceBootstrapToken } from "./device-bootstrap-vr_MPRfj.js";
import { _ as verifyDeviceToken, c as listDevicePairing, f as requestDevicePairing, g as updatePairedDeviceMetadata, i as getPairedDevice, l as listEffectivePairedDeviceRoles, n as ensureDeviceToken, o as hasEffectivePairedDeviceRole, s as listApprovedPairedDeviceRoles, t as approveDevicePairing } from "./device-pairing-CoGNN5Ok.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BaTEky9-.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-BUku2xyU.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-Bk3BAMDO.js";
import { r as upsertPresence } from "./system-presence-C-Z6x2Ib.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-C1IUpMiv.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DNtOGXxn.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-COEKCuDW.js";
import { t as truncateCloseReason } from "./close-reason-IK2BVk4j.js";
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-BSytUi5w.js");
