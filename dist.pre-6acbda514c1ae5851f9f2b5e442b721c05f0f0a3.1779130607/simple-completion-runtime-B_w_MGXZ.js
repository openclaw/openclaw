...
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-B3J3XIzo.js";
import { n as resolveModelAsync, t as resolveModel } from "./model-DJtKWYjH.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-tcxZsS7e.js");
