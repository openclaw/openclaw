...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-DxVmbF3R.js";
import { n as formatConfigIssueLines } from "./issue-format-C780MyYm.js";
import { t as note } from "./note-CSu06D1t.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-vkKYfkZB.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-B6BGvXAm.js");
