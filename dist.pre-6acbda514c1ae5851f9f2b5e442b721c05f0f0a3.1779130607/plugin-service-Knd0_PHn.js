...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-CAUqPPb0.js";
...
import { n as withTimeout } from "./sdk-security-runtime-ByMDg_YY.js";
import { R as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-CbPXKQ3N.js";
import { i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-BYwpQT-2.js";
import "./sdk-setup-tools-BIeyOSku.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-CO5tpKcP.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-C-1cItpt.js";
import { r as getBrowserProfileCapabilities } from "./target-id-BapXs-jG.js";
import { r as createBrowserRouteDispatcher, t as startBrowserControlServiceFromConfig } from "./control-service-CdOUlvwR.js";
import { n as createBrowserControlContext } from "./plugin-enabled-TzUJYaiK.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BzU5ZFK_.js"),
