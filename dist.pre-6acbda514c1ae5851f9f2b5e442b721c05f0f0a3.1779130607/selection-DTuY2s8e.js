...
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-DdvF1onI.js";
...
import { n as ensureGlobalUndiciDispatcherStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-g5Mnd971.js";
...
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-Ds-bZfDD.js";
import { T as getCompactionProvider } from "./loader-CApQ3uf0.js";
import { k as listRegisteredPluginAgentPromptGuidance } from "./command-registration-BXHgIlm4.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Cd2Qar9Y.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BX7XmAog.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-Q0MBSM-3.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DkpIHRmj.js";
import { u as resolveStorePath } from "./paths-_BPRx1WO.js";
import { D as isCacheEnabled, O as resolveCacheTtlMs, T as createExpiringMapCache, t as loadSessionStore } from "./store-load-NR217KeP.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-CIEfCcIn.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-DM2Qj4Ie.js";
import { m as MAX_IMAGE_BYTES } from "./mime-BjHvxzTf.js";
import { u as redactTranscriptMessage } from "./transcript-CdlHYvm8.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Bk5onV1S.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase, t as extractAssistantTextForPhase } from "./chat-message-content-ZRefYnI2.js";
import { c as resolveSessionLockMaxHoldFromTimeout, d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-BXScA6gP.js";
import { n as isSessionWriteLockTimeoutError } from "./session-write-lock-error-l7kI1EvK.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-ts0oybUp.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-ClbTjXdu.js";
...
import { a as stripDowngradedToolCallText, d as findFinalTagMatches, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-CYv0OsxS.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-y3ANmeRx.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-Bq0Labuy.js";
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-DF4us71R.js";
import { d as stripRuntimeContextCustomMessages, l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-tBUvZkew.js";
import { t as stableStringify } from "./stable-stringify-DlXUsXSs.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage } from "./usage-BK25y-g_.js";
import { C as firstEnumerableOwnKeys, S as boundedJsonUtf8Bytes, T as jsonUtf8BytesOrInfinity, _ as stripInternalMetadataForDisplay } from "./session-utils.fs-DC7uJpmA.js";
import { t as estimateStringChars } from "./cjk-chars-BLIsy9ai.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-dY63daNF.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-CLUecfTb.js";
import { n as extractToolResultId, o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-Dg5v7mDo.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-VcblLnzc.js";
import { d as setReplyPayloadMetadata } from "./reply-reference-BMb_keYF.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-DT1jUOfQ.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-BFeBXYFv.js";
...
import { t as filterHeartbeatPairs } from "./heartbeat-filter-BYyAChZr.js";
import { A as isEmbeddedMode, O as isStrictAgenticSupportedProviderModel, k as stripProviderPrefix, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-CcfwCZZZ.js";
import { t as getMachineDisplayName } from "./machine-name-CxKD-q-I.js";
...
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CkbsSprg.js";
...
import { t as resolveOsSummary } from "./os-summary-CchhOpL9.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-C9-8aDoh.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-CxBwiGjQ.js";
import { d as parseBooleanValue } from "./frontmatter-Djo4BkS_.js";
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-B2nqXV0l.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CvbkPv2B.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-D6j9ODNP.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-CAfo8gAh.js";
import { _ as listChannelSupportedActions, b as resolveChannelReactionGuidance, v as resolveChannelMessageToolHints, y as resolveChannelPromptCapabilities } from "./pi-tools.before-tool-call-CJkQVq-d.js";
import { r as optionalStringEnum } from "./typebox-C1Hyx0Mt.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-CfhZp40I.js";
...
import { r as parseFenceSpans } from "./fences-DplaFNYG.js";
import { r as splitMediaFromOutput } from "./parse-DFdb5q_1.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-B13pK4IE.js";
...
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-BK_djli_.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CG1vJpRR.js";
import { l as buildApiErrorObservationFields, s as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-C_hyZt2g.js";
import { t as log$5 } from "./logger-x1d1QPh0.js";
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-CafzeqOe.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-Bd5yezqg.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CchQ7Sms.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-CnDM1Swo.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-CzduqgMF.js";
import { t as resolveAgentTimeoutMs } from "./timeout-C5-yOoIv.js";
import { n as buildSubagentList } from "./subagent-list-HA29he8z.js";
import { o as listControlledSubagentRuns } from "./subagent-control-BSYy3b2t.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, s as resolveAgentPromptSurfaceForSessionKey, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-BVzGuudl.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-DBJ96Ajc.js";
...
import { s as buildCopilotIdeHeaders } from "./provider-auth-B7pd3okH.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-vKLLn6dm.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-AixRxeSx.js";
import { o as resolveSandboxContext } from "./sandbox-B3w5LTxu.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-BQkpJosb.js";
import { t as detectRuntimeShell } from "./shell-utils-C3jJ5lMA.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-M_clBf6W.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-BsbOMA6r.js";
import "./skills-DaAO3VHR.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-BVrl7sFq.js";
import "./tool-loop-detection-ykChQWed.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible, a as createCodexNativeWebSearchWrapper } from "./proxy-stream-wrappers-g3xlANgx.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CNjm6VVz.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-mFsF8Jtr.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-CS2Vj0Wb.js";
import { t as extractSections } from "./post-compaction-context-DXF4FO86.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-BrQsKNJ2.js";
import "./query-B-zYdaWS.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-BgFPbp3m.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-B7N2vX6Y.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-aUenwd0L.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-DtvtmE4B.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-W7c_ATBY.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DqNb22uQ.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CcWRjlwK.js";
import { t as detectAndLoadPromptImages } from "./images-C4eIk59H.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-D-ri7QzX.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-BmbZSTGX.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-CWTGP0e2.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-D_UVo3Ju.js"));
