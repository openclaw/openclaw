...
async function runPluginsEnableCommand(id) {
	...
	const { applySlotSelectionForPlugin, logSlotWarnings } = await import("./plugins-command-helpers-dUQEBIN-.js");
...
async function runPluginsDoctorCommand() {
	const { buildPluginCompatibilityNotices, buildPluginDiagnosticsReport, formatPluginCompatibilityNotice } = await import("./status-ztNgZMi9.js");
...
async function runPluginMarketplaceListCommand(source, opts) {
	...
	const { createPluginInstallLogger } = await import("./plugins-command-helpers-dUQEBIN-.js");
