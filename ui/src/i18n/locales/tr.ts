...
export const tr: TranslationMap = {
  ...
  agents: {
    ...
    copyIdTitle: "Ajan kimliğini panoya kopyala",
    default: "Varsayılan",
    setDefault: "Varsayılan Yap",
    alreadyDefaultTitle: "Zaten varsayılan ajan",
    setDefaultTitle: "Varsayılan ajan olarak ayarla",
    selectTitle: "Bir ajan seç",
    selectSubtitle: "Çalışma alanını ve araçlarını incelemek için bir ajan seçin.",
    tabs: {
    ...
    context: {
      ...
      openFilesTab: "Dosyalar sekmesini aç",
      primaryModel: "Birincil Model",
      runtime: "Çalışma zamanı",
      identityName: "Kimlik Adı",
      identityAvatar: "Kimlik Avatarı",
      skillsFilter: "Beceri Filtresi",
      default: "Varsayılan",
      configurationSubtitle: "Çalışma alanı, kimlik ve model yapılandırması.",
      schedulingSubtitle: "Çalışma alanı ve zamanlama hedefleri.",
    },
    channels: {
      title: "Kanallar",
      subtitle: "Gateway genelinde kanal durumu anlık görüntüsü.",
      lastRefresh: "Son yenileme: {time}",
      loadHint: "Canlı durumu görmek için kanalları yükleyin.",
      empty: "Kanal bulunamadı.",
    ...
    cronPanel: {
      schedulerTitle: "Zamanlayıcı",
      schedulerSubtitle: "Gateway cron durumu.",
      jobs: "İşler",
      nextWake: "Sonraki uyandırma",
      agentJobsTitle: "Ajan Cron İşleri",
      agentJobsSubtitle: "Bu ajana yönelik zamanlanmış işler.",
      noJobs: "Atanmış iş yok.",
    ...
    files: {
      ...
      preview: "Önizleme",
      expandPreview: "Önizlemeyi genişlet",
      collapsePreview: "Önizlemeyi daralt",
      editFile: "Dosyayı düzenle",
      closePreview: "Önizlemeyi kapat",
      coreFilesTitle: "Temel Dosyalar",
      coreFilesSubtitle: "Başlangıç kişiliği, kimlik ve araç kılavuzu.",
      workspace: "Çalışma Alanı",
      loadHint: "Temel talimatları düzenlemek için ajan çalışma alanı dosyalarını yükleyin.",
      empty: "Dosya bulunamadı.",
      missing: "eksik",
      selectFile: "Düzenlemek için bir dosya seçin.",
      previewMarkdownTitle: "İşlenmiş markdown önizleme",
      willCreateOnSave: "Kaydedilince Oluşturulacak",
      liveDraftPreview: "Canlı Taslak Önizleme",
      savedPreview: "Kaydedilen Önizleme",
      updated: "Updated {time}",
      notCreatedYet: "Henüz Oluşturulmadı",
      updatedUnknown: "Güncelleme Bilinmiyor",
      missingHint: "Bu dosya eksik. Kaydedildiğinde ajan çalışma alanında oluşturulacak.",
      content: "İçerik",
      words: "{count} words",
      lines: "satır",
    },
  ...
  debug: {
    ...
    snapshotsSubtitle: "Durum, sağlık ve sinyal verileri.",
    status: "Durum",
    health: "Sağlık",
    ...
    security: {
      ...
      noCriticalIssues: "Kritik sorun yok",
      info: "{count} info",
      runPrefix: "Çalıştır",
      runSuffix: "ayrıntılar için.",
    },
    manualRpcTitle: "Manuel RPC",
    manualRpcSubtitle: "JSON parametreleriyle ham bir gateway metodu gönderin.",
    method: "Metot",
    selectMethod: "Bir metot seçin…",
    paramsJson: "Parametreler (JSON)",
    modelsTitle: "Modeller",
    modelsSubtitle: "models.list kaynağından katalog.",
    eventLogTitle: "Olay Günlüğü",
    eventLogSubtitle: "Son gateway olayları.",
    noEvents: "Henüz olay yok.",
  },
  quickSettings: {
    security: {
      browserEnabled: "Tarayıcı etkin",
      toolProfile: "Araç profili",
    },
  },
  execApproval: {
    expiresIn: "expires in {time}",
    expired: "süresi doldu",
    execApprovalNeeded: "Yürütme onayı gerekli",
    pluginApprovalNeeded: "Eklenti onayı gerekli",
  ...
  chat: {
    ...
    welcome: {
      ready: "Sohbete hazır",
      hintBeforeShortcut: "Aşağıya bir mesaj yazın ·",
      hintAfterShortcut: "komutlar için",
      suggestions: {
        whatCanYouDo: "Ne yapabilirsin?",
        summarizeRecentSessions: "Son oturumlarımı özetle",
        configureChannel: "Kanal yapılandırmama yardım et",
        checkSystemHealth: "Sistem sağlığını kontrol et",
      },
    },
    runControls: {
      newSession: "Yeni oturum",
      ...
      queue: "Kuyruk",
      queueMessage: "Mesajı kuyruğa ekle",
      stop: "Durdur",
    ...
    composer: {
      placeholder: "Mesaj {name} (Göndermek için Enter)",
      placeholderWithAttachments: "Mesaj ekleyin veya daha fazla görsel yapıştırın...",
      placeholderDisconnected: "Sohbete başlamak için gateway'e bağlanın...",
      attachFile: "Dosya ekle",
      startTalk: "Konuşmayı Başlat",
      stopTalk: "Konuşmayı Durdur",
    },
    selectors: {
      agentFilter: "Oturumları ajana göre filtrele",
      session: "Chat session",
      model: "Chat model",
      thinkingLevel: "Sohbet düşünme seviyesi",
    },
  },
  languages: {
    en: "İngilizce",
