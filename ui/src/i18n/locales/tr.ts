...
export const tr: TranslationMap = {
  ...
  settings: {
    modeForm: "Form",
    modeRaw: "Ham",
    formViewUnsafeTooltip: "Form görünümü bazı alanları güvenli şekilde düzenleyemez",
    rawModeTooltip: "Ham JSON/JSON5 yapılandırmasını düzenle",
    rawModeUnavailable: "Bu anlık görüntü için ham mod kullanılamıyor",
    rawModeDisabledNotice:
      "Ham mod devre dışı (anlık görüntü ham metni güvenli şekilde koruyamıyor).",
    unsavedChanges: "Kaydedilmemiş değişiklikler",
    unsavedChangeCount: "{count} kaydedilmemiş değişiklik",
    unsavedChangesCount: "{count} kaydedilmemiş değişiklik",
