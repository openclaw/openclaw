...
export const tr: TranslationMap = {
  ...
  config: {
    ...
    raw: {
      ...
      hiddenHint: "{values} hidden. Use the reveal button above to edit the raw config.",
    ...
    quick: {
      ...
      presetNotSaved: "{preset} is selected but not saved yet.",
      presetCurrentDefault: "{preset} is your current default.",
      ...
      current: "Current",
      selected: "Selected",
      charBudget: "{value} chars",
      everyTurn: "Every turn",
      skipFollowUps: "Skip safe follow-ups",
      reinjectContext: "Reinject workspace bootstrap context on every turn.",
      skipReinjection: "Skip bootstrap reinjection after a completed safe follow-up.",
      wasValue: "Was {value}",
      matchesCurrentDefault: "Matches current default",
      commitCopyProfile:
