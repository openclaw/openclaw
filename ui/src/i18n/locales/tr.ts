...
export const tr: TranslationMap = {
  ...
  browser: {
    ...
    annotateHint: "Sayfanın üzerine çizin, ardından işaretlemeyi sohbetinize gönderin.",
    ...
    empty: "Açık sekme yok. Gezinmek için yukarıya bir URL girin.",
    refresh: "Görünümü yenile",
    noChatTarget: "Açıklamanın gideceği bir yer olması için önce bir sohbet oturumu açın.",
