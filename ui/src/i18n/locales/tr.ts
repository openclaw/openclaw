...
export const tr: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "Zamanlanmış görevlerde ara",
      newTask: "Yeni görev",
      filters: "Filtreler",
      shownOf: "{total} öğeden {shown} tanesi",
      emptyTitle: "Henüz zamanlanmış görev yok",
      emptyHint:
        "OpenClaw'ın neyi ne zaman yapması gerektiğini açıklayın — zamanı geldiğinde çalışır.",
      noMatching: "Mevcut filtrelerle eşleşen görev yok.",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "Hafta içi saat 09:00'da",
        everyMorning: "Her gün saat 08:00'de",
        weekly: "Pazartesi günleri saat 09:00'da",
        hourly: "Her saat",
      },
      ideas: {
        repoPulse: {
    ...
    form: {
      ...
      runsIn: "Çalışacağı yer",
      mainSession: "Ana oturum",
      isolatedSession: "Yalıtılmış oturum",
      sessionHelp:
      ...
      startEnabled: "Etkin olarak başlat",
