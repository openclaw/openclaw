...
export const tr: TranslationMap = {
  ...
  chat: {
    ...
    slashCommands: {
      ...
      showMore_one: "Show {count} more command",
      showMore_other: "Show {count} more commands",
      badge: {
        options: "{count} options",
        instant: "instant",
      },
      ariaLabel: "Slash commands",
      commandAriaLabel: "Command arguments",
      commandDescriptions: {
        ...
        "export-session": "Export current session to HTML file with full system prompt.",
        "export-trajectory": "Export a JSONL trajectory bundle for the active session.",
        ...
        phone: "Arm/disarm high-risk phone node commands (camera/screen/writes).",
        voice: "List/set Talk provider voices (affects iOS Talk playback).",
      },
      argChoices: {
        on: "On",
        off: "Off",
