...
export const tr: TranslationMap = {
  ...
  mcpApp: {
    title: "MCP Uygulaması",
    unavailable: "MCP Uygulaması kullanılamıyor: {error}",
  },
  githubPreview: {
  ...
  channels: {
    ...
    nostr: {
      title: "Nostr",
      subtitle: "Nostr relay'leri üzerinden merkeziyetsiz DM'ler (NIP-04).",
      profile: "Profil",
  ...
  nodes: {
    ...
    binding: {
      ...
      noNodes: "system.run kullanılabilir düğüm yok.",
    ...
    inventory: {
      title: "Cihazlar",
      subtitle: "Eşleşen her istemci için bir satır: durum, roller, tokenlar.",
      cleanupStale: "{count} eski öğeyi temizle",
      pendingApproval: "Onay bekliyor",
      paired: "Eşleşti",
      empty: "Eşleşmiş cihaz yok.",
      connectedWithoutPairing: "Eşleşme olmadan bağlandı",
      olderPairing: "{name} için {count} eski eşleşme",
      olderPairings: "{name} için {count} eski eşleşme",
      autoPaired: "otomatik eşleşti",
      versionDrift: "sürüm farkı",
      versionDriftTitle:
      ...
      scopeUpgrade: "kapsam yükseltmesi onay gerektiriyor",
      roleUpgrade: "rol yükseltmesi onay gerektiriyor",
      reapproval: "yeniden bağlanma ayrıntıları değişti; onay gerekiyor",
    ...
    execApprovals: {
      ...
      hostNativePolicy: "Ana bilgisayar yerel politikası",
      hostNativeHint: "Burada salt okunur. Yardımcı uygulamadan veya CLI'dan düzenleyin.",
      native: "Yerel",
      ...
      on: "açık",
      target: "Hedef",
      targetHint: "Gateway yerel onayları düzenler; düğüm seçili düğümü düzenler.",
      host: "Ana bilgisayar",
      gateway: "Gateway",
      node: "Düğüm",
      ...
      askFallback: "Sorma yedeği",
      promptUnavailable: "UI istemi kullanılamadığında uygulanır.",
      fallback: "Yedek",
      autoAllowSkills: "Skill CLI'lerine otomatik izin ver",
      autoAllowSkillsHint:
      ...
      emptyAllowlist: "Henüz izin listesi girişi yok.",
  ...
  sessionsView: {
    ...
    pagination: "{total} satırdan {start}-{end}",
  ...
  agents: {
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Aracı bazlı Skills izin listesi ve çalışma alanı becerileri.",
      loadConfig: "Aracı bazlı becerileri ayarlamak için gateway yapılandırmasını yükleyin.",
      customAllowlist: "Bu aracı özel bir Skills izin listesi kullanıyor.",
      allEnabled:
        "Tüm beceriler etkin. Herhangi bir beceriyi devre dışı bırakmak aracı bazlı bir izin listesi oluşturur.",
      loadAgent:
        "Çalışma alanına özel girişleri görüntülemek için bu aracının becerilerini yükleyin.",
      filter: "Filtrele",
      searchPlaceholder: "Becerilerde ara",
  ...
  configForm: {
    ...
    sections: {
      env: {
        ...
        description: "Gateway sürecine iletilen ortam değişkenleri",
      },
      update: {
        label: "Güncellemeler",
      ...
      agents: {
        label: "Ajanlar",
        description: "Ajan yapılandırmaları, modeller ve kimlikler",
      },
      auth: {
      ...
      hooks: {
        label: "Kancalar",
        description: "Webhook'lar ve olay kancaları",
      },
      skills: {
        label: "Skills",
      ...
      meta: {
        label: "Meta Veri",
        description: "Gateway meta verisi ve sürüm bilgileri",
      },
      logging: {
        label: "Günlükleme",
      ...
      models: {
        label: "Modeller",
        description: "AI model yapılandırmaları ve sağlayıcılar",
      },
      bindings: {
        label: "Bağlamalar",
      ...
      discovery: {
        label: "Keşif",
        description: "Hizmet keşfi ve ağ oluşturma",
      },
      canvasHost: {
        label: "Canvas Ana Bilgisayarı",
      ...
      diagnostics: {
        label: "Tanılama",
        description: "Enstrümantasyon, OpenTelemetry ve önbellek izleme ayarları",
      },
      cli: {
        label: "CLI",
        description: "CLI başlığı ve başlangıç davranışı",
      },
      secrets: {
        label: "Gizli Anahtarlar",
        description: "Gizli anahtar sağlayıcı yapılandırması",
      },
      acp: {
        label: "ACP",
  ...
  quickSettings: {
    ...
    automation: {
      ...
      installedSkill: "{count} beceri yüklü",
      installedSkills: "{count} beceri yüklü",
    ...
    security: {
      title: "Güvenlik",
      configure: "Yapılandır →",
      gatewayAuth: "Gateway kimlik doğrulaması",
    ...
    system: {
      ...
      loadAverage: "Ortalama yük: {values}",
      core: "{count} çekirdek",
      cores: "{count} çekirdek",
      load: "yük",
      used: "kullanılan",
      freeOf: "{total} içinden {free} boş",
    ...
    personal: {
      ...
      avatarIssues: {
        remoteBlocked: "Uzak URL'ler Control UI görüntü ilkesi tarafından engellendi",
        ...
        cannotRender: "Avatar görüntülenemiyor",
      },
    },
    pending: {
      title: "Kaydedilmemiş değişiklikler",
      hint: "Kaydet, değişikliklerinizi saklar. Şimdi Uygula ayrıca mevcut oturumu yeniden yükler.",
      discard: "Yoksay",
  ...
  configView: {
    ...
    sections: {
      ...
      web: "Web",
      browser: "Tarayıcı",
      nodeHost: "Düğüm Sunucusu",
      canvasHost: "Canvas Sunucusu",
      discovery: "Keşif",
      media: "Medya",
      acp: "ACP",
      mcp: "MCP",
    ...
    appearance: {
      ...
      importHint: "Bir tweakcn temasını bu tarayıcıya özel yuvaya içe aktarın",
      importFromTweakcn: "tweakcn'den içe aktar",
      tweakcnInstructions:
        "tweakcn.com'u açın, bir tema seçin veya oluşturun, Share'e tıklayın, ardından kopyalanan tema bağlantısını buraya yapıştırın. Paylaşım bağlantıları, düzenleyici URL'leri, kayıt defteri URL'leri, tema kimlikleri ve amethyst-haze gibi varsayılan tema adları kabul edilir.",
    ...
    rawDisabled: "Ham mod devre dışı (anlık görüntü ham metni güvenli şekilde koruyamaz).",
    open: "Aç",
    clear: "Temizle",
    apply: "Uygula",
    applying: "Uygulanıyor…",
    ...
    rawDiffUnavailable: "Değişiklikler algılandı (JSON farkı kullanılamıyor)",
    hideEnvValues: "Ortam değerlerini gizle",
    revealEnvValues: "Ortam değerlerini göster",
    peek: "Göz At",
    loadingSchema: "Şema yükleniyor…",
    formUnsafe:
      "Yapılandırmanız, form düzenleyicinin güvenli bir şekilde temsil edemeyeceği alanlar içeriyor. Bu girdileri düzenlemek için Raw modunu kullanın.",
    ...
    toggleRawRedaction: "Ham yapılandırma gizlemeyi değiştir",
    sensitiveHidden:
      "{count} hassas değer gizli. Ham yapılandırmayı düzenlemek için yukarıdaki göster düğmesini kullanın.",
  ...
  agentTools: {
    ...
    liveNow: "Şimdi Canlı",
    disabledByOverride: "Aracı geçersiz kılma ile devre dışı bırakıldı.",
    enabledByProfile: "Geçerli profil tarafından etkinleştirildi.",
    enabledByOverride: "Aracı geçersiz kılma ile etkinleştirildi.",
    ...
    notLive: "Canlı Değil",
    otherAgent: "Diğer Aracı",
    title: "Araç Erişimi",
    subtitle: "Bu aracı için profil + araç bazlı geçersiz kılmalar.",
    ...
    explicitAllowlist:
      "Bu aracı yapılandırmada açık bir izin listesi kullanıyor. Araç geçersiz kılmaları Config sekmesinde yönetilir.",
    globalAllowlist:
      "Global tools.allow ayarlanmış. Aracı geçersiz kılmaları, globalde engellenen araçları etkinleştiremez.",
    ...
    availableNowSubtitle: "Bu aracının mevcut sohbet oturumunda kullanabilecekleri.",
    noSession: "oturum yok",
    switchAgent: "Canlı çalışma zamanı araçlarını görmek için sohbeti bu aracıya geçirin.",
    ...
    moreLiveTitle: "Aşağıdaki gruplarda {count} canlı araç daha mevcut.",
    ...
    availableVia: "{source} üzerinden şimdi kullanılabilir.",
  ...
  skillsPage: {
    ...
    filterPlaceholder: "Yüklü skills'i filtrele",
    shown: "{count} gösteriliyor",
    clawHub: "ClawHub",
    clawHubSubtitle: "Kayıt defterinden skills arayın ve yükleyin",
    searchClawHub: "ClawHub skills ara…",
    searching: "Aranıyor…",
    acknowledgeRisk: "Riski kabul et ve yükle",
    disconnected: "Gateway'e bağlı değil.",
    empty: "Skill bulunamadı.",
    noClawHubResults: "ClawHub'da skill bulunamadı.",
    install: "Yükle",
    ...
    notFound: "Skill bulunamadı.",
    invalidLink: "ClawHub bağlantısı geçersiz",
    overview: "Genel Bakış",
    skillCard: "Skill Kartı",
    ...
    loadingSkillCard: "Skill Kartı yükleniyor…",
    skillCardNotLoaded: "Skill Kartı yüklenmedi.",
    verdict: {
      unavailable: "Kullanılamıyor",
      clean: "Temiz",
      pending: "Beklemede",
  ...
  mcpPage: {
    ...
    operatorCommandsHint:
      "Durum, tanılama, kimlik doğrulama, sınama ve çalışma zamanı yeniden yükleme.",
    runtimeHint:
      "Çalışma zamanı değişiklikleri kaydetme ve yayınlamadan sonra uygulanır; etkin aracılar bir sonraki kullanımda MCP çalışma zamanlarını yeniden oluşturur.",
    toolFilter: "araç filtresi",
    parallel: "paralel",
    missingTransport: "aktarım eksik",
    tlsVerifyOff: "TLS doğrulama kapalı",
    mtls: "mTLS",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      linear: "Sorunları triyaj edin, döngüleri güncelleyin ve doğrudan sohbetten hata bildirin.",
      todoist: "Todoist'teki görevleri ve projeleri okuyun, ekleyin ve tamamlayın.",
      airtable: "Airtable'da kayıtları, tabloları ve tabanları sorgulayın ve güncelleyin.",
      jira: "Sohbet üzerinden Jira biletleri oluşturun, arayın ve triyaj yapın.",
      canva:
      ...
      googleCalendar:
        "Etkinlikleri okuyun, oluşturun ve özet alın — ajanınız programınızı yönetir.",
      email: "Onayla-gönder özelliğiyle posta kutusu triyajı, özetler ve taslaklar.",
      pdf: "PDF belgelerini çıkarın, birleştirin, dönüştürün ve OCR yapın.",
      transcription: "Ses ve videoyu temiz, yapılandırılmış transkriptlere dönüştürün.",
      github:
        "Resmi GitHub MCP üzerinden PR inceleme kuyrukları, sorun triyajı ve depo Soru-Cevap.",
      sentry: "Çökme uyarıları, ortaya çıktıkları anda açıklanır ve triyaj edilir.",
      context7:
        "Kodlama sırasında sürüme özgü kütüphane belgeleri ve kod örnekleri. Kayıt gerekmez.",
      deepwiki:
      ...
      grafana: "Panolar ve uyarılar için Grafana bilgi birikimi ve topluluk konektörleri.",
      kubernetes: "Sohbet üzerinden küme işlemleri ve sorun giderme.",
      homeAssistant: "Tüm evinizde ışıkları, iklimi ve otomasyonları kontrol edin.",
      spotify: "Ruh haline dayalı çalma listeleriyle gününüzü arayın, kuyruğa alın ve müzikleyin.",
      sonos: "Ev geneli ses: sohbetle çalma, odaları gruplandırma ve sıraya alma.",
      reddit: "Subreddit'leri ve konuları göz atın, arayın ve özetleyin.",
      ...
      news: "Kişiselleştirilmiş günlük brifing: haberler, hava durumu ve görevler tek mesajda.",
      maps: "Yerler, rotalar ve seyahat süresi yanıtları.",
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "Öneriyi {verb}",
      description:
        "Ajana neyin değişmesi gerektiğini söyleyin. Öneri beklemede kalır ve workshop düzeltilmiş bir sürüm oluşturur.",
      placeholder:
        "Örnek: Bunu okunmamış arama yerine Gmail etiketlerini kullanacak şekilde ayarla ve daha güvenli bir deneme adımı ekle.",
      preparing: "Düzeltme aktarımı hazırlanıyor",
      send: "Düzeltmeyi gönder",
    },
    queue: {
    ...
    empty: {
      searchTitle: "Eşleşen teklif yok",
      searchBody: "Aramayı temizleyin veya farklı bir anahtar kelime deneyin.",
      pendingTitle: "Bekleyen teklif yok",
      pendingBody: "Yeni taslaklar incelenmesi gerektiğinde burada görünür.",
      appliedTitle: "Henüz hiçbir şey uygulanmadı",
      appliedBody: "Bekleyen bir teklifi kullanın; canlı bir skill olarak burada görünecektir.",
      rejectedTitle: "Reddedilen teklif yok",
      rejectedBody: "Atlanan teklifler, temiz bir inceleme geçmişi için burada kalır.",
      quarantinedTitle: "Karantinaya alınan bir şey yok",
      quarantinedBody:
        "Tarayıcı tarafından engellenen veya güvenlik nedeniyle bekletilen teklifler burada görünür.",
      staleTitle: "Eski teklif yok",
      staleBody: "Artık sorunsuz uygulanamayan teklifler burada görünür.",
      allTitle: "Burada teklif yok",
      allBody:
        "Skill Workshop teklifleri, temsilciniz bunları taslak haline getirdiğinde burada görünür.",
      defaultAgent: "Aracınız",
      noProposalsAria: "Skill Workshop önerisi yok",
      noProposalsTitle: "Henüz öneri yok",
      noProposalsBody: "{agent} henüz herhangi bir beceri önerisi hazırlamadı.",
    ...
    today: {
      ...
      browseApplied: "Zaten uygulanmış olanlara göz atın.",
      progress: "{total} içinden {current}",
      draftedBy: "Hazırlayan",
      supportFile: "{count} destek dosyası",
      supportFiles: "{count} destek dosyası",
      comeWithIt: "birlikte gelir.",
      useIt: "Kullan",
      addToSkills: "Becerilerinize ekleyin",
      tweakIt: "İnce ayar yap",
      askAgent: "Aracıdan bir şeyi değiştirmesini iste",
      skipping: "Atlanıyor…",
      skip: "Atla",
      notForMe: "Bana göre değil",
      upNext: "Sıradaki · {count} tane daha bekliyor",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      palaceTab: "Bellek Sarayı",
      dreamsExplainer:
        "Bu, sistemin belleği tekrar oynatıp pekiştirirken yazdığı ham rüya günlüğüdür; bellek sisteminin neyi fark ettiğini ve nerede hâlâ gürültülü veya zayıf göründüğünü incelemek için kullanın.",
      insightsExplainer:
        "Bunlar, harici geçmişten kümelenmiş içe aktarılan içgörülerdir; bunlar kalıcı belleğe geçmeden önce içe aktarmaların neyi ortaya çıkardığını gözden geçirmek için kullanın.",
      palaceExplainer:
        "Bu, sistemin arama yapabildiği ve üzerinde akıl yürütebildiği derlenmiş bellek wiki yüzeyidir; ham içe aktarılan kaynak sohbetlerinden ziyade gerçek bellek sayfalarını, iddiaları, açık soruları ve çelişkileri incelemek için kullanın.",
      ...
      noInsightsHint:
        "Kümelenmiş içe aktarılan içgörüleri burada görüntülemek için uygula seçeneğiyle bir ChatGPT içe aktarması çalıştırın.",
  ...
  chat: {
    ...
    compaction: {
      ...
      description:
        "Sıkıştırılmış döküm bir kontrol noktası olarak korunur. Bu sıkıştırılmış görünümden dallanmak veya geri yüklemek için oturum kontrol noktalarını açın.",
    ...
    sideChat: {
      ...
      followUp: "Devam et…",
      followUpLabel: "Yan sohbette devam et",
      sendFollowUp: "Devam mesajı gönder",
    },
    detailPanel: {
    ...
    composer: {
      ...
      runDone: "Tamamlandı",
      runInterrupted: "Kesintiye uğradı",
      runStatus: "Çalıştırma durumu: {status}",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "OpenClaw'un ne ve ne zaman yapması gerektiğini açıklayın — zamanlamaya göre çalışır.",
    ...
    form: {
      ...
      onExitHelp: "İzlenen bir komut sonlandığında çalışır. Zamanlama burada düzenlenemez.",
      every: "Her",
      at: "Saat",
      cronOption: "Cron",
      ...
      accountIdHelp: "Çok hesaplı kurulumlar için isteğe bağlı kanal hesap kimliği.",
      lightContext: "Hafif bağlam",
      lightContextHelp: "Bu aracı işi için hafif önyükleme bağlamını kullan.",
      model: "Model",
      ...
      failureAlertsHelp: "Bu işin tekrarlanan hata uyarılarını ne zaman göndereceğini denetleyin.",
      failureAlertAfter: "Şundan sonra uyar",
      failureAlertAfterHelp: "Uyarı öncesi ardışık hata sayısı.",
