...
export const tr: TranslationMap = {
  ...
  overview: {
    ...
    operator: {
      ...
      expiredCount: "{count} süresi dolmuş",
      expiredCountPlural: "{count} süresi dolmuş",
      expiringCount: "{count} süresi yakında dolacak",
      expiringCountPlural: "{count} süresi yakında dolacak",
      failed: "failed",
