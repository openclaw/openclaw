...
export const tr: TranslationMap = {
  ...
  login: {
    ...
    togglePasswordVisibility: "Parola görünürlüğünü değiştir",
    desktop: {
      subtitle: "Local desktop setup",
      startingTitle: "Starting local OpenClaw",
      startingSummary: "Preparing the local Gateway and bundled plugins.",
      connectingTitle: "Opening OpenClaw",
      connectingSummary: "The desktop app is connecting to the local Gateway.",
      failedTitle: "Could not start local OpenClaw",
      failedSummary: "OpenClaw could not start the local Gateway for this desktop session.",
  ...
  desktopModelSetup: {
    ...
    subtitle: "Add the model credentials this desktop app should use before opening OpenClaw.",
    checkingTitle: "Checking local model setup",
    checkingSummary: "OpenClaw is reading the local configuration and configured model catalog.",
    provider: "Sağlayıcı",
    providerId: "Provider ID",
    modelId: "Model ID",
    modelPlaceholder: "gpt-5.4 or provider/model-id",
    displayName: "Display name",
    displayNamePlaceholder: "Shown in the model picker",
    baseUrl: "Temel URL",
    apiKey: "API key",
    apiKeyOptional: "API key (optional)",
    apiKeyPlaceholder: "Paste the provider API key",
    apiKeyOptionalPlaceholder: "Leave empty for local servers that do not require auth",
    errorTitle: "Could not save model setup",
    save: "Save and open OpenClaw",
    saving: "Saving",
    ...
    presets: {
      ...
      custom: "Local or OpenAI-compatible",
    },
  },
  chat: {
