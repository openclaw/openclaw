...
export const tr: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "ClawHub'da ara",
    ...
    searchClawHubTitle: "ClawHub'da Ara",
    searchClawHubBody: "Kod ve paket eklentilerini bulmak için en az iki karakter girin.",
    noClawHubResultsTitle: "Eklenti bulunamadı",
    ...
    statInstalled: "Yüklü",
    statEnabled: "Etkin",
    statIssues: "İlgilenilmesi gerekiyor",
    statMcpServers: "MCP sunucuları",
