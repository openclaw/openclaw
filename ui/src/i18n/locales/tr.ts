...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Plan, kota ve maliyetle yapılandırılmış sağlayıcılar.",
  ...
  modelProviders: {
    ...
    subtitle: "Kimlik doğrulama, plan, kota ve maliyet verileriyle model sağlayıcıları.",
    updated: "Güncellendi {time}",
    refreshing: "Yenileniyor…",
    disconnected: "Yapılandırılmış model sağlayıcılarını görmek için ağ geçidine bağlanın.",
    emptyTitle: "Yapılandırılmış model sağlayıcısı yok",
    emptySubtitle: "Bir sağlayıcıda oturum açın veya bir API anahtarı ekleyin, ardından yenileyin.",
    status: {
      ok: "Bağlı",
      expiring: "Süresi doluyor",
      expired: "Süresi doldu",
      missing: "Oturum açılmadı",
      apiKey: "API anahtarı",
    },
    expiresIn: "Kimlik bilgisi {time} sonra sona eriyor",
    models: "{count} model",
    modelOne: "1 model",
    modelsAvailable: "{count} modelden {available} tanesi kullanılabilir",
    noStats: "Bu sağlayıcı tarafından canlı kullanım verisi bildirilmedi.",
    localCost: "Oturum harcaması · {days}g",
    localCostDetail: "{tokens} jeton · {sessions} oturum",
    saving: "Kaydediliyor…",
