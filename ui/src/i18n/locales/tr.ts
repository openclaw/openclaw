...
export const tr: TranslationMap = {
  ...
  usage: {
    ...
    overview: {
      ...
      activeTimeHint: "Bu aralıktaki süre verisi olan oturumların toplam aktif süresi.",
      activeTimeSub: "Ort. oturum {avgDuration} · süre verisi olan {count} oturum",
      acrossTimedSessions: "Süre verisi olan {count} oturumda",
