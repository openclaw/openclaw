...
export const tr: TranslationMap = {
  ...
  question: {
    title: "Aracının bir sorusu var",
    recommended: "Önerilen",
    otherLabel: "Diğer…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Yanıtınızı yazın",
    secretWarning: "Yanıtınız bu kanaldaki diğer katılımcılar tarafından görülebilir.",
    submit: "Gönder",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Plan modu",
      goal: "Hedef modu",
      switchConfirm: "Mod değiştirilsin mi? Bu, geçerli modu durdurur.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Görüntüle",
    approveTitle: "Bu plan uygulansın mı?",
    approveCta: "Onayla",
    revise: "Geri bildirimle düzenle",
    reviseSubmit: "Geri bildirim gönder",
    revisePlaceholder: "Ne değişmeli?",
    cancel: "İptal",
