...
export const tr: TranslationMap = {
  ...
  nodes: {
    ...
    approval: {
      ...
      newPairing: "new pairing request",
    },
    repairSuffix: " · repair",
    requested: "requested",
    requestedLabel: "requested:",
    approvedNowLabel: "approved now:",
    approve: "Approve",
    reject: "Reject",
  ...
  execApprovalsConfig: {
    ...
    saving: "Kaydediliyor…",
    save: "Kaydet",
    loadApprovals: "Load exec approvals to edit allowlists.",
    target: {
      title: "Target",
    ...
    ask: {
      title: "Ask",
      defaultPolicy: "Default prompt policy.",
      defaultValue: "Default: {value}.",
      mode: "Mod",
      useDefault: "Use default ({value})",
      off: "Off",
    ...
    autoAllowSkills: {
      ...
      description: "Allow skill executables listed by the Gateway.",
