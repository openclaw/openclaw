...
export const th: TranslationMap = {
  ...
  settings: {
    modeForm: "ฟอร์ม",
    modeRaw: "ดิบ",
    formViewUnsafeTooltip: "มุมมองฟอร์มไม่สามารถแก้ไขบางฟิลด์ได้อย่างปลอดภัย",
    rawModeTooltip: "แก้ไขการตั้งค่า JSON/JSON5 แบบดิบ",
    rawModeUnavailable: "โหมดดิบไม่พร้อมใช้งานสำหรับสแนปช็อตนี้",
    rawModeDisabledNotice: "ปิดใช้งานโหมดดิบ (สแนปช็อตไม่สามารถคงข้อความดิบไว้ได้อย่างปลอดภัย)",
    unsavedChanges: "การเปลี่ยนแปลงที่ยังไม่ได้บันทึก",
    unsavedChangeCount: "{count} การเปลี่ยนแปลงที่ยังไม่ได้บันทึก",
    unsavedChangesCount: "{count} การเปลี่ยนแปลงที่ยังไม่ได้บันทึก",
