...
export const th: TranslationMap = {
  ...
  filePreview: {
    ...
    emptySubtitle: "ลองค้นหาด้วยชื่อไฟล์หรือเนื้อหาอื่น",
    copyFile: "คัดลอกไฟล์",
  ...
  mcpApp: {
    title: "แอป MCP",
    unavailable: "แอป MCP ไม่พร้อมใช้งาน: {error}",
  },
  githubPreview: {
    loading: "กำลังโหลดรายละเอียด GitHub…",
    unavailable: "ตัวอย่าง GitHub ไม่พร้อมใช้งาน",
    states: {
      merged: "รวมแล้ว",
      draft: "ฉบับร่าง",
      open: "เปิด",
      closed: "ปิด",
      notPlanned: "ไม่ได้วางแผน",
    },
    file: "{count} ไฟล์",
    files: "{count} ไฟล์",
  ...
  channels: {
    refreshingStaleSnapshot: "กำลังรีเฟรชสถานะช่องในเบื้องหลัง กำลังแสดงสแนปช็อตที่สำเร็จล่าสุด",
    config: {
      schemaUnavailable: "ไม่มีสคีมา ใช้ Raw",
      channelSchemaUnavailable: "ไม่มีสคีมาการกำหนดค่าช่อง",
      loadingSchema: "กำลังโหลดสคีมาการกำหนดค่า…",
    },
    health: {
      title: "สถานะช่องทาง",
    ...
    discord: {
      title: "Discord",
      subtitle: "สถานะบอทและการกำหนดค่าช่อง",
    },
    googleChat: {
      title: "Google Chat",
      subtitle: "สถานะ webhook ของ Chat API และการกำหนดค่าช่อง",
    },
    imessage: {
      title: "iMessage",
      subtitle: "สถานะบริดจ์ macOS และการกำหนดค่าช่อง",
    },
    signal: {
      title: "Signal",
      subtitle: "สถานะ signal-cli และการกำหนดค่าช่อง",
    },
    slack: {
      title: "Slack",
    ...
    whatsapp: {
      title: "WhatsApp",
      subtitle: "เชื่อมโยง WhatsApp Web และตรวจสอบสถานะการเชื่อมต่อ",
    },
    ...
    nostr: {
      title: "Nostr",
      subtitle: "DM แบบกระจายศูนย์ผ่านรีเลย์ Nostr (NIP-04)",
      profile: "โปรไฟล์",
  ...
  nodes: {
    ...
    inventory: {
      ...
      cleanupStale: "ล้าง {count} รายการที่ค้าง",
      pendingApproval: "รอการอนุมัติ",
      paired: "จับคู่แล้ว",
      empty: "ไม่มีอุปกรณ์ที่จับคู่",
      connectedWithoutPairing: "เชื่อมต่อโดยไม่ได้จับคู่",
      olderPairing: "การจับคู่เก่า {count} รายการของ {name}",
      olderPairings: "การจับคู่เก่า {count} รายการของ {name}",
      autoPaired: "จับคู่อัตโนมัติ",
      versionDrift: "เวอร์ชันไม่ตรงกัน",
      versionDriftTitle:
        "โหนด {nodeVersion}; Gateway {gatewayVersion} อัปเดตส่วนประกอบที่เก่ากว่าเพื่อให้ทั้งกลุ่มตรงกัน",
      manualWake: "ต้องปลุกด้วยตนเอง",
      manualWakeTitle:
        "Gateway ไม่สามารถปลุกโหนด Windows ที่ออฟไลน์ได้ เริ่มการทำงานของเครื่องหรือกู้คืนการเชื่อมต่อเครือข่าย",
      ...
      unknownClient: "ไคลเอนต์ไม่ทราบชื่อ",
      revoked: "ถูกเพิกถอน",
      active: "ใช้งานอยู่",
      rotate: "หมุนเวียน",
      revoke: "เพิกถอน",
      ...
      reapproval: "รายละเอียดการเชื่อมต่อใหม่เปลี่ยนแปลง; ต้องได้รับการอนุมัติ",
      newPairing: "คำขอจับคู่อุปกรณ์ใหม่",
      repair: "ซ่อมแซม",
      requestedAt: "{note} · ร้องขอเมื่อ {time}",
    ...
    execApprovals: {
      ...
      hostNativeHint: "อ่านอย่างเดียวที่นี่ แก้ไขจากแอปคู่หรือ CLI",
      native: "Native",
      defaultAction: "การกระทำเริ่มต้น",
      rule: "{count} กฎ",
      rules: "{count} กฎ",
      allShells: "เชลล์ทั้งหมด",
      off: "ปิด",
      on: "เปิด",
      target: "เป้าหมาย",
      ...
      noNodes: "ยังไม่มีโหนดใดประกาศการอนุมัติ exec",
      scope: "ขอบเขต",
      ...
      promptUnavailable: "ใช้เมื่อไม่สามารถแสดงพรอมต์ UI ได้",
      fallback: "สำรอง",
      autoAllowSkills: "อนุญาต skill CLI อัตโนมัติ",
      autoAllowSkillsHint: "อนุญาตไฟล์ปฏิบัติการของ Skills ที่ Gateway แสดงรายการไว้",
      usingDefault: "ใช้ค่าเริ่มต้น ({value})",
      override: "แทนที่ ({value})",
      enabled: "เปิดใช้งาน",
      useDefault: "ใช้ค่าเริ่มต้น",
      allowlist: "รายการที่อนุญาต",
      allowlistHint: "รูปแบบ glob ไม่คำนึงถึงตัวพิมพ์เล็กใหญ่",
      addPattern: "เพิ่มรูปแบบ",
      emptyAllowlist: "ยังไม่มีรายการที่อนุญาต",
  ...
  agents: {
    ...
    overview: {
      title: "ภาพรวม",
      subtitle: "เส้นทาง Workspace และข้อมูลเมตาระบุตัวตน",
    ...
    toolCatalog: {
      ...
      descriptions: {
        ...
        exec: "รันคำสั่งเชลล์",
        process: "จัดการโปรเซสเบื้องหลัง",
        webSearch: "ค้นหาบนเว็บ",
        webFetch: "ดึงเนื้อหาเว็บ",
        memorySearch: "การค้นหาเชิงความหมาย",
        ...
        canvas: "ควบคุม canvas",
        message: "ส่งข้อความ",
        cron: "กำหนดเวลางาน",
        gateway: "การควบคุม Gateway",
        nodes: "โหนด + อุปกรณ์",
        agentsList: "แสดงรายการเอเจนต์",
        image: "การทำความเข้าใจรูปภาพ",
      },
      profiles: {
        minimal: "น้อยที่สุด",
        coding: "การเขียนโค้ด",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "รายการอนุญาต Skills ต่อเอเจนต์และ Skills ของเวิร์กสเปซ",
      loadConfig: "โหลดการกำหนดค่า gateway เพื่อตั้งค่า Skills ต่อเอเจนต์",
      customAllowlist: "เอเจนต์นี้ใช้รายการอนุญาต Skills แบบกำหนดเอง",
      allEnabled: "เปิดใช้งาน Skills ทั้งหมดแล้ว การปิดใช้งาน Skill ใดๆ จะสร้างรายการอนุญาตต่อเอเจนต์",
      loadAgent: "โหลด Skills สำหรับเอเจนต์นี้เพื่อดูรายการเฉพาะเวิร์กสเปซ",
      filter: "ตัวกรอง",
  ...
  configForm: {
    ...
    unsupportedType: "ประเภทที่ไม่รองรับ: {type} ใช้โหมด Raw",
    structuredSecretRaw: "ค่าแบบมีโครงสร้าง (SecretRef) - ใช้โหมด Raw เพื่อแก้ไข",
    structuredSecretFile: "ค่าแบบมีโครงสร้าง (SecretRef) - แก้ไขไฟล์การกำหนดค่าโดยตรง",
    defaultValue: "ค่าเริ่มต้น: {value}",
    resetToDefault: "รีเซ็ตเป็นค่าเริ่มต้น",
    select: "เลือก...",
    jsonValue: "ค่า JSON",
    unsupportedArray: "สคีมาอาร์เรย์ที่ไม่รองรับ ใช้โหมด Raw",
    ...
    sections: {
      ...
      messages: {
        label: "ข้อความ",
        description: "การตั้งค่าการจัดการและกำหนดเส้นทางข้อความ",
      },
      commands: {
        label: "คำสั่ง",
        description: "คำสั่งสแลชแบบกำหนดเอง",
      },
      hooks: {
        label: "Hooks",
      ...
      skills: {
        label: "Skills",
        description: "แพ็กและความสามารถของ Skills",
      },
      tools: {
        label: "เครื่องมือ",
        description: "การกำหนดค่าเครื่องมือ (เบราว์เซอร์ ค้นหา ฯลฯ)",
      },
      gateway: {
        label: "Gateway",
      ...
      bindings: {
        label: "การผูกคีย์",
        description: "การผูกคีย์และทางลัด",
      },
      broadcast: {
        label: "การกระจายเสียง",
        description: "การตั้งค่าการกระจายเสียงและการแจ้งเตือน",
      },
      audio: {
        label: "เสียง",
      ...
      session: {
        label: "เซสชัน",
        description: "การจัดการเซสชันและการคงอยู่",
      },
      cron: {
        label: "Cron",
        description: "งานตามกำหนดเวลาและการทำงานอัตโนมัติ",
      },
      web: {
        label: "Web",
      ...
      talk: {
        label: "Talk",
        description: "การตั้งค่าเสียงและคำพูด",
      },
      plugins: {
        label: "ปลั๊กอิน",
      ...
      cli: {
        label: "CLI",
        description: "แบนเนอร์ CLI และพฤติกรรมเมื่อเริ่มต้น",
      },
      secrets: {
        label: "Secrets",
  ...
  quickSettings: {
    ...
    automation: {
      ...
      scheduledTask: "งานที่กำหนดเวลา {count} รายการ",
      scheduledTasks: "งานที่กำหนดเวลา {count} รายการ",
    ...
    security: {
      title: "ความปลอดภัย",
      configure: "กำหนดค่า →",
      gatewayAuth: "การตรวจสอบสิทธิ์ Gateway",
      execPolicy: "นโยบายการเรียกใช้",
      deviceAuth: "การตรวจสอบสิทธิ์อุปกรณ์",
      browserEnabled: "Browser enabled",
      toolProfile: "Tool profile",
    },
    system: {
      gatewayHost: "โฮสต์ Gateway",
    ...
    personal: {
      ...
      you: "คุณ",
      assistant: "ผู้ช่วย",
      localIdentity: "ตัวตนแชทในเครื่องของคุณ",
      assistantIdentity: "ตัวตนของผู้ช่วย",
      avatarText: "ข้อความ / อิโมจิของอวาตาร์",
    ...
    pending: {
      ...
      hint: "บันทึกเพื่อจัดเก็บการเปลี่ยนแปลงของคุณ การใช้ตอนนี้จะโหลดเซสชันปัจจุบันใหม่ด้วย",
      discard: "ละทิ้ง",
      applying: "กำลังใช้…",
      applyNow: "ใช้ตอนนี้",
    },
  ...
  configPage: {
    ...
    themeRemoved: "ลบธีมกำหนดเองแล้ว",
    channels: {
      telegram: "Telegram",
      discord: "Discord",
      slack: "Slack",
  ...
  configView: {
    ...
    notifications: {
      ...
      blockedHint: "การแจ้งเตือนถูกบล็อก อัปเดตสิทธิ์ของเว็บไซต์ในเบราว์เซอร์เพื่ออนุญาตการแจ้งเตือน",
    },
    appearance: {
      theme: "ธีม",
      ...
      importHint: "นำเข้าธีม tweakcn ไปยังช่องเฉพาะเบราว์เซอร์นี้",
      importFromTweakcn: "นำเข้าจาก tweakcn",
      tweakcnInstructions:
        "เปิด tweakcn.com เลือกหรือสร้างธีม คลิก Share จากนั้นวางลิงก์ธีมที่คัดลอกไว้ที่นี่ รองรับลิงก์แชร์ URL ตัวแก้ไข URL รีจิสทรี รหัสธีม และชื่อธีมเริ่มต้น เช่น amethyst-haze",
      browseTweakcn: "เรียกดูธีม tweakcn",
      themeLink: "ลิงก์หรือรหัสธีม",
      replace: "แทนที่ {name}",
      ...
      inlineHintAfter:
        "เพื่อเพิ่มธีม tweakcn แบบเฉพาะเบราว์เซอร์หนึ่งธีม ใน tweakcn ให้ใช้ Share แล้ววางลิงก์ที่คัดลอกไว้ที่นี่",
      textSize: "ขนาดข้อความ",
    },
    connection: {
      title: "การเชื่อมต่อ",
    ...
    form: "ฟอร์ม",
    raw: "ดิบ",
    formUnsafeTitle: "มุมมองฟอร์มไม่สามารถแก้ไขบางฟิลด์ได้อย่างปลอดภัย",
    rawTitle: "แก้ไขการตั้งค่า JSON/JSON5 แบบดิบ",
    rawUnavailableTitle: "โหมดดิบไม่พร้อมใช้งานสำหรับสแนปช็อตนี้",
    unsavedChange: "{count} การเปลี่ยนแปลงที่ยังไม่ได้บันทึก",
    unsavedChanges: "{count} การเปลี่ยนแปลงที่ยังไม่ได้บันทึก",
    noChanges: "ไม่มีการเปลี่ยนแปลง",
    rawDisabled: "ปิดใช้งานโหมด Raw แล้ว (สแนปช็อตไม่สามารถแปลงกลับเป็นข้อความ Raw ได้อย่างปลอดภัย)",
    open: "เปิด",
    clear: "ล้าง",
    apply: "นำไปใช้",
    ...
    sensitiveHidden: "ซ่อนค่าที่ละเอียดอ่อนไว้ {count} ค่า ใช้ปุ่มแสดงด้านบนเพื่อแก้ไขการกำหนดค่าดิบ",
    sensitiveHiddenPlural: "ซ่อนค่าที่ละเอียดอ่อนไว้ {count} ค่า ใช้ปุ่มแสดงด้านบนเพื่อแก้ไขการกำหนดค่าดิบ",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    explicitAllowlist:
      "เอเจนต์นี้ใช้ allowlist แบบระบุชัดเจนในการตั้งค่า การแทนที่เครื่องมือจะถูกจัดการในแท็บ Config",
    globalAllowlist:
      "มีการตั้งค่า tools.allow แบบส่วนกลาง การแทนที่ของเอเจนต์ไม่สามารถเปิดใช้งานเครื่องมือที่ถูกบล็อกแบบส่วนกลางได้",
    loadingCatalog: "กำลังโหลดแคตตาล็อกเครื่องมือรันไทม์…",
    catalogFallback: "ไม่สามารถโหลดแคตตาล็อกเครื่องมือรันไทม์ได้ กำลังแสดงรายการสำรองในตัวแทน",
    availableNow: "พร้อมใช้งานตอนนี้",
    availableNowSubtitle: "สิ่งที่เอเจนต์นี้สามารถใช้ได้ในเซสชันแชทปัจจุบัน",
    noSession: "ไม่มีเซสชัน",
    switchAgent: "สลับแชทไปยังเอเจนต์นี้เพื่อดูเครื่องมือรันไทม์ที่ทำงานอยู่",
    loadingAvailable: "กำลังโหลดเครื่องมือที่ใช้ได้…",
    availableError: "ไม่สามารถโหลดเครื่องมือที่ใช้ได้สำหรับเซสชันนี้",
    noAvailable: "ขณะนี้ไม่มีเครื่องมือที่ใช้ได้สำหรับเซสชันนี้",
    moreLiveTitle: "มีเครื่องมือแบบสดอีก {count} รายการในกลุ่มด้านล่าง",
    moreLive: "+{count} เครื่องมือแบบสดเพิ่มเติม",
    quickPresets: "ค่าที่ตั้งไว้แบบด่วน",
    inherit: "สืบทอด",
    profile: "โปรไฟล์",
    source: "แหล่งที่มา",
    live: "สด",
    status: "สถานะ",
    profileSourceAgent: "การแทนที่ของเอเจนต์",
    ...
    liveToolsOne: "เครื่องมือที่ใช้งานได้ {count} รายการ",
    liveTools: "เครื่องมือที่ใช้งานได้ {count} รายการ",
    access: "การเข้าถึง",
    ...
    unavailableSession: "ไม่พร้อมใช้งานในเซสชันแชทนี้ในขณะนี้",
    inspectAgent: "สลับแชทไปยังเอเจนต์นี้เพื่อตรวจสอบความพร้อมใช้งานแบบสด",
    linkTool: "ลิงก์ไปยังเครื่องมือนี้",
  },
  skillGroups: {
    workspace: "Skills ของพื้นที่ทำงาน",
    builtIn: "Skills ในตัว",
  ...
  skillsPage: {
    ...
    searchClawHub: "ค้นหา Skills บน ClawHub…",
    searching: "กำลังค้นหา…",
    acknowledgeRisk: "ยอมรับความเสี่ยงและติดตั้ง",
    disconnected: "ยังไม่ได้เชื่อมต่อกับ Gateway",
    empty: "ไม่พบ Skills",
    ...
    missingRequirements: "ขาดข้อกำหนดที่จำเป็น",
  ...
  mcpPage: {
    ...
    operatorCommands: "คำสั่งสำหรับผู้ดูแล MCP",
    operatorCommandsHint: "สถานะ การวินิจฉัย การยืนยันตัวตน การตรวจสอบ และการโหลดรันไทม์ใหม่",
    runtimeHint:
      "การเปลี่ยนแปลงรันไทม์จะมีผลหลังบันทึกและเผยแพร่ เอเจนต์ที่ทำงานอยู่จะสร้างรันไทม์ MCP ใหม่ในการใช้งานครั้งถัดไป",
    toolFilter: "ตัวกรองเครื่องมือ",
    parallel: "ขนาน",
    missingTransport: "ขาดการขนส่ง",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      linear: "จัดลำดับปัญหา อัปเดตรอบ และแจ้งข้อบกพร่องได้โดยตรงจากแชท",
      todoist: "อ่าน เพิ่ม และทำงานและโปรเจกต์ให้เสร็จใน Todoist",
      airtable: "ค้นหาและอัปเดตเรคคอร์ด ตาราง และเบสใน Airtable",
      jira: "สร้าง ค้นหา และคัดแยกทิกเก็ต Jira จากแชท",
      canva: "สร้างและแก้ไขดีไซน์ Canva จัดการแอสเซท และส่งออกผลลัพธ์",
      stripe: "ตรวจสอบการชำระเงิน ลูกค้า ใบแจ้งหนี้ และการสมัครสมาชิกในบัญชี Stripe ของคุณ",
      googleCalendar: "อ่าน สร้าง และรับสรุปกิจกรรม — เอเจนต์ของคุณดูแลตารางเวลาของคุณ",
      email: "คัดแยกกล่องจดหมาย สรุป และร่างข้อความพร้อมส่งเมื่อได้รับอนุมัติ",
      pdf: "แยกข้อมูล รวม แปลง และ OCR เอกสาร PDF",
      transcription: "เปลี่ยนเสียงและวิดีโอให้เป็นสำเนาถอดความที่สะอาดและมีโครงสร้าง",
      github: "คิวรีวิว PR การคัดแยกอิชชู และถาม-ตอบเกี่ยวกับ repo ผ่าน GitHub MCP อย่างเป็นทางการ",
      sentry: "อธิบายและคัดแยกการแจ้งเตือนข้อขัดข้องทันทีที่เกิดขึ้น",
      context7: "เอกสารไลบรารีเฉพาะเวอร์ชันและตัวอย่างโค้ดขณะเขียนโค้ด ไม่ต้องสมัคร",
      deepwiki: "ถามคำถามเกี่ยวกับ repo สาธารณะบน GitHub ใดก็ได้ ฟรี ไม่ต้องมีบัญชี",
      huggingFace: "ค้นหาโมเดล ชุดข้อมูล และเปเปอร์ รวมถึงรัน Spaces เป็นเครื่องมือ",
      grafana: "ความรู้ Grafana และคอนเนกเตอร์จากชุมชนสำหรับแดชบอร์ดและการแจ้งเตือน",
      ...
      sonos: "ระบบเสียงทั่วทั้งบ้าน: เล่น จัดกลุ่มห้อง และจัดคิวผ่านแชท",
      reddit: "เรียกดู ค้นหา และสรุป subreddit และเธรดต่างๆ",
      markets: "หุ้นและคริปโตแบบเรียลไทม์ พร้อมการแจ้งเตือนราคาและสรุปประจำวัน",
      travel: "ค้นหาเที่ยวบินและโรงแรม พร้อมติดตามราคาและจดจำการเดินทาง",
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "{verb} ข้อเสนอ",
      description: "บอกเอเจนต์ว่าควรเปลี่ยนอะไร ข้อเสนอจะยังคงรอดำเนินการ และเวิร์กช็อปจะสร้างเวอร์ชันที่แก้ไขแล้ว",
      placeholder:
        "ตัวอย่าง: ให้ใช้ป้ายกำกับ Gmail แทนการค้นหาข้อความที่ยังไม่ได้อ่าน และเพิ่มขั้นตอน dry-run ที่ปลอดภัยกว่า",
      preparing: "กำลังเตรียมส่งต่อการแก้ไข",
      send: "ส่งการแก้ไข",
    },
    queue: {
      ...
      noStatus: "ไม่มีข้อเสนอที่ {status}",
    ...
    detail: {
      ...
      noSupportFiles: "ไฟล์สนับสนุน 0 ไฟล์",
      loading: "กำลังโหลดข้อเสนอ…",
      supportFilesTitle: "ไฟล์สนับสนุน",
      clickToPreview: "· คลิกเพื่อดูตัวอย่าง",
    },
    empty: {
      searchTitle: "ไม่พบข้อเสนอที่ตรงกัน",
      searchBody: "ล้างการค้นหาหรือลองใช้คำค้นอื่น",
      ...
      appliedBody: "ใช้ข้อเสนอที่รอดำเนินการ แล้วมันจะปรากฏที่นี่ในรูปแบบ Skill ที่ใช้งานได้",
      rejectedTitle: "ไม่มีข้อเสนอที่ถูกปฏิเสธ",
      rejectedBody: "ข้อเสนอที่ข้ามไปจะยังอยู่ที่นี่เพื่อประวัติการตรวจสอบที่เป็นระเบียบ",
      ...
      staleBody: "ข้อเสนอที่ไม่สามารถนำไปใช้ได้อย่างเรียบร้อยอีกต่อไปจะปรากฏที่นี่",
      allTitle: "ไม่มีข้อเสนอที่นี่",
      allBody: "ข้อเสนอ Skill Workshop จะปรากฏที่นี่เมื่อเอเจนต์ของคุณร่างขึ้น",
      defaultAgent: "เอเจนต์ของคุณ",
      ...
      noProposalsFooter: "ข้อเสนอใหม่จะปรากฏที่นี่เพื่อการตรวจสอบ",
    },
    today: {
      emptyTitle: "ไม่มีอะไรรอดำเนินการวันนี้",
      emptyBody: "เอเจนต์ของคุณยังไม่ได้ร่างสิ่งใหม่ สลับไปที่ Board เพื่อดูประวัติ",
      new: "ใหม่",
      waiting: "กำลังรอ",
      reviewed: "ตรวจสอบแล้ว",
      agent: "เอเจนต์",
      proposalsWaiting: "{count} ข้อเสนอกำลังรอ",
      browseApplied: "เรียกดูสิ่งที่นำไปใช้แล้ว",
      progress: "{current} จาก {total}",
      draftedBy: "ร่างโดย",
      supportFile: "{count} ไฟล์สนับสนุน",
      supportFiles: "{count} ไฟล์สนับสนุน",
      comeWithIt: "มาพร้อมกัน",
      useIt: "ใช้งาน",
      addToSkills: "เพิ่มลงใน Skills ของคุณ",
      tweakIt: "ปรับแต่ง",
      askAgent: "ขอให้เอเจนต์เปลี่ยนบางอย่าง",
      skipping: "กำลังข้าม…",
      skip: "ข้าม",
      notForMe: "ไม่เหมาะกับฉัน",
      upNext: "ถัดไป · รออีก {count} รายการ",
      seeAll: "ดูข้อเสนอทั้งหมด →",
      collection: "คอลเลกชันของคุณ · ใช้งานอยู่ {count} รายการ",
      manage: "จัดการ →",
      workflowHeading: "เอเจนต์จะใช้งานอย่างไร",
      applicabilityHeading: "เมื่อใดที่เอเจนต์ควรใช้งาน",
    },
    relative: {
      secondsAgo: "{count} วินาทีที่แล้ว",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      palaceTab: "วังความทรงจำ",
      dreamsExplainer:
        "นี่คือไดอารีความฝันดิบที่ระบบเขียนขึ้นในขณะเล่นซ้ำและรวมความทรงจำ ใช้มันเพื่อตรวจสอบว่าระบบความทรงจำกำลังสังเกตอะไรอยู่ และยังดูมีสัญญาณรบกวนหรือบางเบาตรงไหน",
      insightsExplainer:
        "เหล่านี้คือข้อมูลเชิงลึกที่นำเข้าซึ่งถูกจัดกลุ่มจากประวัติภายนอก ใช้มันเพื่อทบทวนสิ่งที่การนำเข้าค้นพบก่อนที่สิ่งใดจะยกระดับเป็นความทรงจำถาวร",
      palaceExplainer:
        "นี่คือพื้นผิววิกิความทรงจำที่คอมไพล์แล้วซึ่งระบบสามารถค้นหาและใช้เหตุผลได้ ใช้มันเพื่อตรวจสอบหน้าความทรงจำจริง ข้อกล่าวอ้าง คำถามที่ยังเปิดอยู่ และความขัดแย้ง แทนที่จะเป็นแชตต้นฉบับที่นำเข้ามาแบบดิบ",
      copyArchivePath: "คัดลอกเส้นทางไฟล์เก็บถาวร",
      loadingInsights: "กำลังโหลดข้อมูลเชิงลึกที่นำเข้า…",
      noInsights: "ยังไม่มีข้อมูลเชิงลึกที่นำเข้า",
      noInsightsHint: "รันการนำเข้า ChatGPT พร้อมกับ apply เพื่อแสดงข้อมูลเชิงลึกที่นำเข้าและจัดกลุ่มไว้ที่นี่",
      ...
      loadingPalace: "กำลังโหลดวังความจำ…",
      emptyPalace: "วังความจำยังไม่มีข้อมูล",
      emptyPalaceHint:
        "ขณะนี้วิกิส่วนใหญ่มีเพียงการนำเข้าต้นฉบับดิบและรายงานการดำเนินงาน แท็บนี้จะมีประโยชน์เมื่อเริ่มมีการเขียนการสังเคราะห์ เอนทิตี หรือแนวคิด",
      claims: "ข้ออ้าง",
      openQuestions: "คำถามที่ยังไม่มีคำตอบ",
      contradictions: "ข้อขัดแย้ง",
      pageDetails: "รายละเอียดหน้า",
      wikiPage: "หน้าวิกิ:",
      id: "รหัส:",
      openWikiPage: "เปิดหน้าวิกิ",
      unavailable: "Memory Wiki ไม่ได้เปิดใช้งาน",
      unavailablePluginPrefix: "Imported Insights และ Memory Palace ให้บริการโดยส่วนที่มาพร้อมกัน",
      unavailablePluginSuffix: "plugin.",
      enablePrefix: "เปิดใช้งาน",
      enableSuffix: " แล้วโหลดแท็บนี้ใหม่",
  ...
  chat: {
    ...
    compaction: {
      ...
      description: "บทสนทนาที่ย่อไว้จะถูกเก็บเป็นจุดตรวจสอบ เปิดจุดตรวจสอบเซสชันเพื่อแยกสาขาหรือกู้คืนจากมุมมองที่ย่อนั้น",
    ...
    commands: {
      ...
      select: "เลือก",
      close: "ปิด",
      clearDescription: "ล้างประวัติการแชท",
      redirectDescription: "ยกเลิกและเริ่มใหม่ด้วยข้อความใหม่",
      steerDescription: "แทรกข้อความเข้าสู่การทำงานที่กำลังดำเนินอยู่",
      categories: {
        session: "เซสชัน",
        model: "โมเดล",
        agents: "เอเจนต์",
    ...
    queue: {
      ...
      steer: "กำกับทิศทาง",
      steered: "กำกับทิศทางแล้ว",
      steerQueuedMessage: "กำกับทิศทางข้อความในคิว",
    ...
    detailPanel: {
      ...
      renderedMarkdown: "Markdown ที่แสดงผล",
      renderedMarkdownHint: "ตัวอย่างข้อความริชเท็กซ์ที่ผ่านการทำความสะอาดเพื่ออ่านอย่างรวดเร็ว",
    ...
    thread: {
      ...
      noMatches: "ไม่มีข้อความที่ตรงกัน",
    },
    pairingQrExpired: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "อธิบายว่า OpenClaw ควรทำอะไรและเมื่อใด — มันจะทำงานตามกำหนดเวลา",
    ...
    form: {
      ...
      onExitHelp: "ทำงานเมื่อคำสั่งที่เฝ้าดูออก ไม่สามารถแก้ไขกำหนดการได้ที่นี่",
      every: "ทุก",
      at: "เวลา",
      cronOption: "Cron",
      runAt: "ทำงานเมื่อ",
      ...
      isolatedSession: "เซสชันแยกต่างหาก",
      ...
      sessionKeyHelp: "คีย์การกำหนดเส้นทางที่ไม่บังคับสำหรับการส่งงานและการกำหนดเส้นทางปลุก",
      ...
      seconds: "วินาที",
      accountId: "รหัสบัญชี",
      accountIdHelp: "รหัสบัญชีช่องทางที่ไม่บังคับสำหรับการตั้งค่าหลายบัญชี",
      ...
      failureAlertCustom: "การตั้งค่าเฉพาะแต่ละงานแบบกำหนดเอง",
      failureAlertsHelp: "ควบคุมว่างานนี้จะส่งการแจ้งเตือนความล้มเหลวซ้ำเมื่อใด",
      failureAlertAfter: "แจ้งเตือนหลังจาก",
      failureAlertAfterHelp: "จำนวนข้อผิดพลาดต่อเนื่องก่อนแจ้งเตือน",
      failureAlertCooldown: "ระยะพัก (วินาที)",
      failureAlertCooldownHelp: "จำนวนวินาทีขั้นต่ำระหว่างการแจ้งเตือน",
      failureAlertChannel: "ช่องทางแจ้งเตือน",
      failureAlertTo: "แจ้งเตือนถึง",
      failureAlertToPlaceholder: "+1555... หรือ chat id",
      failureAlertToHelp: "ผู้รับที่กำหนดเองสำหรับการแจ้งเตือนความล้มเหลว (ไม่บังคับ)",
      failureAlertMode: "โหมดแจ้งเตือน",
      failureAlertAnnounce: "ประกาศ (ผ่านช่องทาง)",
      failureAlertWebhook: "Webhook (HTTP POST)",
      failureAlertAccountId: "Account ID สำหรับแจ้งเตือน",
      failureAlertAccountPlaceholder: "Account ID สำหรับการตั้งค่าแบบหลายบัญชี",
