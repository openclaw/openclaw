...
export const th: TranslationMap = {
  ...
  agents: {
    ...
    copyId: "คัดลอก ID",
    copyIdTitle: "คัดลอก ID เอเจนต์ไปยังคลิปบอร์ด",
    default: "ค่าเริ่มต้น",
    setDefault: "ตั้งเป็นค่าเริ่มต้น",
    alreadyDefaultTitle: "เป็นเอเจนต์ค่าเริ่มต้นอยู่แล้ว",
    setDefaultTitle: "ตั้งเป็นเอเจนต์ค่าเริ่มต้น",
    selectTitle: "เลือกเอเจนต์",
    selectSubtitle: "เลือกเอเจนต์เพื่อตรวจดูเวิร์กสเปซและเครื่องมือ",
    tabs: {
      overview: "ภาพรวม",
      files: "ไฟล์",
      tools: "เครื่องมือ",
    ...
    context: {
      ...
      openFilesTab: "เปิดแท็บไฟล์",
      primaryModel: "โมเดลหลัก",
      runtime: "รันไทม์",
      identityName: "ชื่อ Identity",
      identityAvatar: "รูปแทนตัว Identity",
      skillsFilter: "ตัวกรอง Skills",
      default: "ค่าเริ่มต้น",
      configurationSubtitle: "การตั้งค่าเวิร์กสเปซ, Identity และโมเดล",
      schedulingSubtitle: "เวิร์กสเปซและปลายทางการจัดกำหนดการ",
    },
    channels: {
      title: "ช่องทาง",
      subtitle: "ภาพรวมสถานะช่องทางทั้ง Gateway",
      lastRefresh: "รีเฟรชล่าสุด: {time}",
      loadHint: "โหลดช่องทางเพื่อดูสถานะล่าสุด",
      empty: "ไม่พบช่องทาง",
      connectedCount: "เชื่อมต่อแล้ว {connected}/{total}",
      noAccounts: "ไม่มีบัญชี",
      configuredCount: "กำหนดค่าแล้ว {count} รายการ",
      notConfigured: "ยังไม่ได้กำหนดค่า",
      enabledCount: "เปิดใช้งาน {count} รายการ",
      setupGuide: "คู่มือการตั้งค่า",
    },
    cronPanel: {
      schedulerTitle: "ตัวจัดกำหนดการ",
      schedulerSubtitle: "สถานะ Cron ของ Gateway",
      jobs: "งาน",
      nextWake: "ปลุกครั้งถัดไป",
      agentJobsTitle: "งาน Cron ของเอเจนต์",
      agentJobsSubtitle: "งานที่กำหนดเวลาไว้สำหรับเอเจนต์นี้",
      noJobs: "ไม่มีงานที่มอบหมาย",
      runNow: "เรียกใช้ตอนนี้",
    },
    files: {
      emptyDraft: "ร่างว่าง",
      minRead: "อ่าน {count} นาที",
      markdownPreview: "ดูตัวอย่าง Markdown",
      extensionPreview: "ดูตัวอย่าง {ext}",
      preview: "ดูตัวอย่าง",
      expandPreview: "ขยายตัวอย่าง",
      collapsePreview: "ย่อตัวอย่าง",
      editFile: "แก้ไขไฟล์",
      closePreview: "ปิดตัวอย่าง",
      coreFilesTitle: "ไฟล์หลัก",
      coreFilesSubtitle: "คำแนะนำ persona, identity และเครื่องมือหลักสำหรับ bootstrap",
      workspace: "เวิร์กสเปซ",
      loadHint: "โหลดไฟล์เวิร์กสเปซของเอเจนต์เพื่อแก้ไขคำสั่งหลัก",
      empty: "ไม่พบไฟล์",
      missing: "หายไป",
      selectFile: "เลือกไฟล์เพื่อแก้ไข",
      previewMarkdownTitle: "ดูตัวอย่าง Markdown ที่เรนเดอร์แล้ว",
      willCreateOnSave: "จะสร้างเมื่อบันทึก",
      liveDraftPreview: "ดูตัวอย่างร่างแบบสด",
      savedPreview: "ดูตัวอย่างที่บันทึกแล้ว",
      updated: "อัปเดต {time}",
      notCreatedYet: "ยังไม่ได้สร้าง",
      updatedUnknown: "ไม่ทราบเวลาอัปเดต",
      missingHint: "ไฟล์นี้หายไป การบันทึกจะสร้างไฟล์ในเวิร์กสเปซของเอเจนต์",
      content: "เนื้อหา",
      words: "{count} คำ",
      lines: "บรรทัด",
    },
