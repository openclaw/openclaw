...
export const th: TranslationMap = {
  ...
  overview: {
    ...
    connection: {
      title: "วิธีเชื่อมต่อ",
      lead: "OpenClaw Control จะเชื่อมต่อกับเกตเวย์ที่กำลังทำงานอยู่ ใช้ URL ของเกตเวย์และโทเค็นจากเครื่องที่โฮสต์ OpenClaw",
      beforeStartTitle: "ก่อนเริ่มต้น",
      beforeStartToken:
        "โดยปกติจำเป็นต้องมีโทเค็นของเกตเวย์ เว้นแต่คุณจะปิดการยืนยันตัวตนของ Control UI ไว้อย่างชัดเจน",
      beforeStartHost:
        "ws://127.0.0.1:18789 ใช้งานได้เฉพาะบนเครื่องโฮสต์เท่านั้น หากใช้อีกอุปกรณ์ ให้ใช้ IP ของโฮสต์, URL ของ Tailscale หรือแดชบอร์ดลิงก์ที่มีโทเค็น",
      beforeStartPassword: "ต้องใช้รหัสผ่านของเกตเวย์ก็ต่อเมื่อเกตเวย์ของคุณถูกตั้งค่าให้ใช้เท่านั้น",
      afterConnectTitle: "สิ่งที่จะเกิดขึ้นหลังเชื่อมต่อ",
      afterConnectBody:
        "เมื่อเชื่อมต่อแล้ว หน้านี้จะกลายเป็นคอนโซลปฏิบัติการแบบสดสำหรับเซสชัน ช่องทาง บันทึก โมเดล อุปกรณ์ และระบบอัตโนมัติ",
      authRequiredTitle: "ไม่มีโทเค็นของเกตเวย์หรือโทเค็นถูกปฏิเสธ",
      authRequiredBody:
        "หากคุณเห็นข้อผิดพลาดว่าไม่ได้รับอนุญาต แปลว่าโทเค็นหายไป หมดอายุ หรือมาจากอินสแตนซ์เกตเวย์คนละตัว",
