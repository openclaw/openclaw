...
export const th: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "อธิบายว่า OpenClaw ควรทำอะไรและเมื่อใด — ระบบจะทำงานตามกำหนดเวลา",
      noMatching: "ไม่มีงานที่ตรงกับตัวกรองปัจจุบัน",
      loadMore: "โหลดเพิ่มเติม",
      loading: "กำลังโหลด...",
      schedulerOff: "ปิดใช้งานตัวกำหนดเวลาแล้ว",
      refresh: "รีเฟรช",
      refreshing: "กำลังรีเฟรช...",
      paused: "หยุดชั่วคราว",
    },
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "วันจันทร์ถึงศุกร์ เวลา 9:00 น.",
    ...
    stats: {
      ...
      tasks: "งาน",
      nextWake: "การเริ่มทำงานครั้งถัดไป",
    },
    detail: {
      newTitle: "งานที่ตั้งเวลาไว้ใหม่",
      newSubtitle: "อธิบายสิ่งที่ต้องการให้ OpenClaw ทำ แล้วเลือกเวลาที่จะให้ทำงาน",
      overviewTitle: "กิจกรรมล่าสุด",
      overviewSubtitle: "การทำงานล่าสุดของงานที่กำหนดเวลาไว้ทั้งหมด",
    ...
    form: {
      ...
      promptPlaceholder: "อธิบายสิ่งที่ต้องการให้ OpenClaw ทำ...",
      repeat: "ทำซ้ำ",
      repeatInterval: "ช่วงเวลา",
      repeatOnce: "ครั้งเดียว",
      repeatCron: "นิพจน์ Cron",
      repeatOnExit: "เมื่อออก",
      onExitHelp: "ทำงานเมื่อคำสั่งที่เฝ้าดูสิ้นสุดลง ไม่สามารถแก้ไขกำหนดการได้ที่นี่",
      every: "ทุก",
      at: "เวลา",
      cronOption: "Cron",
      runAt: "ทำงานเมื่อ",
      ...
      startEnabled: "เปิดใช้งานตั้งแต่เริ่มต้น",
