...
export const th: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "ผู้ให้บริการที่กำหนดค่าพร้อมแผน โควต้า และค่าใช้จ่าย",
  ...
  modelProviders: {
    title: "ผู้ให้บริการที่กำหนดค่า",
    subtitle: "ผู้ให้บริการโมเดลพร้อมการรับรองความถูกต้อง แผน โควต้า และข้อมูลค่าใช้จ่าย",
    updated: "อัปเดตเมื่อ {time}",
    refreshing: "กำลังรีเฟรช…",
    disconnected: "เชื่อมต่อกับเกตเวย์เพื่อดูผู้ให้บริการโมเดลที่กำหนดค่า",
    emptyTitle: "ยังไม่ได้กำหนดค่าผู้ให้บริการโมเดล",
    emptySubtitle: "ลงชื่อเข้าใช้ผู้ให้บริการหรือเพิ่มคีย์ API แล้วรีเฟรช",
    status: {
      ok: "เชื่อมต่อแล้ว",
      expiring: "กำลังหมดอายุ",
      expired: "หมดอายุ",
      missing: "ไม่ได้ลงชื่อเข้าใช้",
      apiKey: "คีย์ API",
    },
    expiresIn: "ข้อมูลรับรองจะหมดอายุใน {time}",
    models: "{count} โมเดล",
    modelOne: "1 โมเดล",
    modelsAvailable: "มี {available} จาก {count} โมเดล",
    noStats: "ผู้ให้บริการนี้ไม่ได้รายงานข้อมูลการใช้งานสด",
    localCost: "การใช้จ่ายต่อเซสชัน · {days} วัน",
    localCostDetail: "{tokens} โทเค็น · {sessions} เซสชัน",
    saving: "กำลังบันทึก…",
