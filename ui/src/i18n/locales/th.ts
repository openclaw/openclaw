...
export const th: TranslationMap = {
  ...
  overview: {
    ...
    operator: {
      ...
      expiredCount: "{count} หมดอายุแล้ว",
      expiredCountPlural: "{count} หมดอายุแล้ว",
      expiringCount: "{count} ใกล้หมดอายุ",
      expiringCountPlural: "{count} ใกล้หมดอายุ",
      failed: "failed",
