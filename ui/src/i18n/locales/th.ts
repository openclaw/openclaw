...
export const th: TranslationMap = {
  common: {
    ...
    lastReadback: "การอ่านกลับล่าสุด",
  ...
  channels: {
    health: {
      ...
      noAttentionItems: "ไม่มีรายการช่องที่ต้องตรวจสอบ",
      metrics: {
        configured: "กำหนดค่าแล้ว",
        running: "กำลังทำงาน",
        connected: "เชื่อมต่อแล้ว",
      ...
      warnings: {
        noActiveConnection: "{channel} กำลังทำงาน แต่ไม่มีรายงานการเชื่อมต่อ/การอ่านกลับที่ใช้งานอยู่",
        healthState: "สถานะสุขภาพของ {channel} คือ {state}",
        reports: "{channel} รายงาน: {error}",
        accountHealthState: "สถานะสุขภาพของ {account} คือ {state}",
        accountReports: "{account} รายงาน: {error}",
        accountReadback: "การอ่านกลับของ {account} คือ {state}",
        accountReadbackWithError: "การอ่านกลับของ {account} คือ {state}: {error}",
        accountMissingScopes: "{account} ไม่มีขอบเขตประวัติ/การอ่านกลับ: {scopes}",
        accountDisconnected: "{account} กำลังทำงานแต่ถูกตัดการเชื่อมต่อ",
        accountStaleActivity: "กิจกรรมของ {account} ล้าสมัยแล้ว",
      },
    },
    generic: {
    ...
    slack: {
      attention: {
        noSocketModeReadback: "Slack Socket Mode กำลังทำงาน แต่ไม่มีรายงานการเชื่อมต่อการอ่านกลับที่ใช้งานอยู่",
        healthState: "สถานะสุขภาพของ Slack คือ {state}; ประวัติขาเข้า/การอ่านกลับอาจล้าสมัย",
        staleTransport: "กิจกรรมการรับส่งของ Slack ล้าสมัยแล้ว; ตรวจสอบ Socket Mode และขอบเขตประวัติ",
        readbackWithError: "การอ่านกลับข้อความ Slack คือ {state}: {error}",
        readbackMissingScopes: "การอ่านกลับข้อความ Slack คือ {state}; อาจไม่มีขอบเขตประวัติ/การอ่านกลับ",
        missingScopes: "Slack ไม่มีขอบเขตประวัติ/การอ่านกลับ: {scopes}",
      },
    },
  ...
  debug: {
    ...
    buildProvenance: "แหล่งที่มาของบิลด์",
    status: "สถานะ",
    health: "สถานะ",
  ...
  cron: {
    ...
    form: {
      ...
      exactTimingHelp: "รันตามเวลา cron ที่กำหนดอย่างแม่นยำโดยไม่มีการกระจายเวลา",
