...
export const th: TranslationMap = {
  ...
  cron: {
    ...
    suggestions: {
      title: "คำแนะนำ",
      schedules: {
        weekdayMornings: "วันธรรมดา เวลา 9:00 AM",
      ...
      ideas: {
        repoPulse: {
          name: "ความเคลื่อนไหวของรีโพ",
          tagline: "ปัญหา, PR และความล้มเหลวของ CI ที่เกิดขึ้นข้ามคืน จัดอันดับตามความเร่งด่วน",
          prompt:
            "ตรวจสอบกิจกรรมที่เกิดขึ้นข้ามคืนในรีโพของฉัน ได้แก่ ปัญหาใหม่, pull request และความล้มเหลวของ CI สรุปสามสิ่งที่ฉันควรให้ความสนใจมากที่สุดในวันนี้ โดยแต่ละรายการต้องมีลิงก์และเหตุผลหนึ่งบรรทัด",
        },
        standupGhostwriter: {
          name: "ผู้ช่วยร่างสแตนด์อัป",
          tagline: "ร่างอัปเดตสแตนด์อัปของคุณจากงานเมื่อวาน",
          prompt:
            "ร่างอัปเดตสแตนด์อัปของฉันจาก commit เมื่อวาน, pull request ที่ merge แล้ว และเธรดรีวิวที่ยังเปิดอยู่ ไม่เกินสามหัวข้อย่อย: เสร็จแล้ว, กำลังทำ, ติดขัด",
        },
        hackerNewsScout: {
          name: "ผู้สอดส่อง Hacker News",
          tagline: "สามลิงก์ที่ควรค่าแก่การอ่านระหว่างจิบกาแฟ พร้อมมุมมองร้อนแรง",
          prompt:
            "สแกนหน้าแรกของ Hacker News วันนี้เพื่อหาโพสต์เกี่ยวกับเอเจนต์ AI, เครื่องมือสำหรับนักพัฒนา และ TypeScript ส่งลิงก์ที่น่าสนใจที่สุดสามรายการให้ฉัน โดยแต่ละรายการมีมุมมองร้อนแรงหนึ่งบรรทัด",
        },
        dependencyRadar: {
          name: "เรดาร์ dependency",
          tagline: "dependency ที่ล้าสมัยหรือมีช่องโหว่ พร้อมหมายเหตุการอัปเกรด",
          prompt:
            "ตรวจสอบโปรเจกต์หลักของฉันเพื่อหา dependency ที่ล้าสมัยหรือมีช่องโหว่ แสดงรายการอัปเดตสำคัญพร้อมหมายเหตุความเสี่ยงรายการละหนึ่งบรรทัด และร่างคำสั่งอัปเกรด",
        },
        watchdog: {
          name: "ยามเฝ้าระวังกลางคืน",
          tagline: "ตรวจสอบสถานะทุกชั่วโมงพร้อมผลสรุปหนึ่งบรรทัด",
          prompt:
            "ตรวจสอบว่าบริการและ Gateway ของฉันทำงานเป็นปกติ: สแกนบันทึกล่าสุดเพื่อหาข้อผิดพลาดใหม่ การรีสตาร์ต หรือภาระงานที่ผิดปกติ หากทุกอย่างเรียบร้อย ให้ตอบยืนยันสั้น ๆ เพียงบรรทัดเดียว หากมีบางอย่างขัดข้อง ให้รายงานว่าส่วนใดล้มเหลวและควรเริ่มตรวจสอบจากที่ใด",
        },
        polyglotMinute: {
          name: "นาทีพหุภาษา",
          tagline: "วลีภาษาต่างประเทศที่มีประโยชน์หนึ่งวลีสำหรับกาแฟยามเช้าของคุณ",
          prompt:
            "สอนวลีภาษาญี่ปุ่นที่มีประโยชน์หนึ่งวลี: ระบุวลี วิธีออกเสียง ความหมายตามตัวอักษร และเวลาที่ควรใช้ เขียนให้ไม่เกินห้าบรรทัด",
        },
      },
    },
    stats: {
    ...
    form: {
      ...
      createTask: "สร้างงาน",
      createAndRun: "สร้างและเรียกใช้ตอนนี้",
      cancel: "ยกเลิก",
    },
    jobState: {
      next: "ถัดไป",
