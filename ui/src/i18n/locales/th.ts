  ...
  cron: {
    ...
    suggestions: {
      ...
      ideas: {
        ...
        nightWatch: {
          name: "ยามราตรี",
          tagline: "ตรวจสอบสุขภาพระบบทุกชั่วโมงอย่างเงียบๆ — แจ้งเตือนเฉพาะเมื่อมีสิ่งผิดปกติ",
          prompt:
            "ตรวจสอบว่าบริการและ Gateway ของฉันทำงานปกติหรือไม่: สแกนบันทึกล่าสุดเพื่อหาข้อผิดพลาดใหม่ การรีสตาร์ท หรือโหลดที่ผิดปกติ หากทุกอย่างเรียบร้อยไม่ต้องแจ้ง แต่ถ้าพบปัญหาให้แจ้งว่ามีอะไรล้มเหลวและควรเริ่มตรวจสอบที่ไหน",
        },
        polyglotMinute: {
          name: "นาทีหลายภาษา",
