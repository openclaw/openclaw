...
export const th: TranslationMap = {
  ...
  question: {
    title: "เอเจนต์มีคำถาม",
    recommended: "แนะนำ",
    otherLabel: "อื่นๆ…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "พิมพ์คำตอบของคุณ",
    secretWarning: "คำตอบของคุณอาจปรากฏให้ผู้เข้าร่วมรายอื่นในช่องนี้เห็น",
    submit: "ส่ง",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "โหมดแผน",
      goal: "โหมดเป้าหมาย",
      switchConfirm: "สลับโหมดหรือไม่? การดำเนินการนี้จะหยุดโหมดปัจจุบัน",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "ดู",
    approveTitle: "ดำเนินการตามแผนนี้หรือไม่?",
    approveCta: "อนุมัติ",
    revise: "แก้ไขตามความคิดเห็น",
    reviseSubmit: "ส่งความคิดเห็น",
    revisePlaceholder: "ควรเปลี่ยนแปลงอะไร?",
    cancel: "ยกเลิก",
