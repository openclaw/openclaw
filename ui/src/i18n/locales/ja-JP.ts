...
export const ja_JP: TranslationMap = {
  ...
  filePreview: {
    ...
    filteredFileCount: "{count}/{total} 個のファイル",
    noMatches: "一致するファイルがありません。",
    navigate: "移動",
  },
  mcpApp: {
    title: "MCP アプリ",
    unavailable: "MCP アプリを利用できません: {error}",
  },
  githubPreview: {
  ...
  channels: {
    refreshingStaleSnapshot:
      "バックグラウンドでチャンネルステータスを更新しています。最後に成功したスナップショットを表示しています。",
    config: {
    ...
    googleChat: {
      title: "Google Chat",
      subtitle: "Chat API Webhook のステータスとチャンネル設定。",
    },
    imessage: {
      title: "iMessage",
      subtitle: "macOS ブリッジのステータスとチャンネル設定。",
    },
    signal: {
      title: "Signal",
      subtitle: "signal-cli のステータスとチャンネル設定。",
    },
    slack: {
      title: "Slack",
    ...
    whatsapp: {
      title: "WhatsApp",
      subtitle: "WhatsApp Web を連携して接続状態を監視します。",
    },
  ...
  nodes: {
    ...
    inventory: {
      title: "デバイス",
      subtitle: "ペアリング済みクライアントごとに1行: ステータス、ロール、トークン。",
      cleanupStale: "{count} 件の古い項目をクリーンアップ",
      pendingApproval: "承認待ち",
      paired: "ペアリング済み",
      empty: "ペアリング済みのデバイスはありません。",
      connectedWithoutPairing: "ペアリングなしで接続",
      olderPairing: "{name} の古いペアリング {count} 件",
      olderPairings: "{name} の古いペアリング {count} 件",
      autoPaired: "自動ペアリング",
      versionDrift: "バージョンの相違",
      versionDriftTitle:
        "ノード {nodeVersion}、Gateway {gatewayVersion}。古いコンポーネントを更新してフリートを揃えてください。",
    ...
    execApprovals: {
      ...
      loadHint: "許可リストを編集するには実行の承認を読み込みます。",
      hostNativePolicy: "ホストネイティブポリシー",
      hostNativeHint: "ここでは読み取り専用です。コンパニオンアプリまたはCLIから編集してください。",
      native: "ネイティブ",
      ...
      askFallback: "確認のフォールバック",
      promptUnavailable: "UI プロンプトが利用できない場合に適用されます。",
      fallback: "フォールバック",
      autoAllowSkills: "Skill CLI を自動的に許可",
      autoAllowSkillsHint: "Gateway に列挙された Skill 実行ファイルを許可します。",
      usingDefault: "デフォルト（{value}）を使用中。",
      override: "上書き（{value}）。",
      enabled: "有効",
      useDefault: "デフォルトを使用",
      allowlist: "許可リスト",
      allowlistHint: "大文字小文字を区別しない glob パターン。",
      addPattern: "パターンを追加",
  ...
  agents: {
    ...
    toolCatalog: {
      ...
      descriptions: {
        ...
        sessionsList: "セッション一覧",
        sessionsHistory: "セッション履歴",
        sessionsSend: "セッションに送信",
        sessionsSpawn: "サブエージェントを生成",
    ...
    skillsPanel: {
      ...
      loadConfig: "Gateway構成を読み込んで、エージェントごとのSkillsを設定します。",
      customAllowlist: "このエージェントはカスタムSkill許可リストを使用しています。",
      allEnabled:
        "すべてのSkillsが有効です。いずれかのSkillを無効にすると、エージェントごとの許可リストが作成されます。",
      loadAgent: "このエージェントのSkillsを読み込んで、ワークスペース固有のエントリを表示します。",
      filter: "フィルター",
  ...
  configForm: {
    ...
    select: "選択...",
    jsonValue: "JSON値",
    unsupportedArray: "サポートされていない配列スキーマです。Rawモードを使用してください。",
    itemCountOne: "{count} 件",
    itemCount: "{count} 件",
    add: "追加",
    noItems: "まだ項目がありません。「追加」をクリックして作成してください。",
    removeItem: "項目を削除",
    customEntries: "カスタムエントリ",
    addEntry: "エントリを追加",
    noCustomEntries: "カスタムエントリがありません。",
    key: "キー",
    removeEntry: "エントリを削除",
    schemaUnavailable: "スキーマを利用できません。",
    unsupportedSchema: "サポートされていないスキーマです。Rawを使用してください。",
    unsupportedNode: "サポートされていないスキーマノードです。Rawモードを使用してください。",
    noSettingsMatch: '"{query}" に一致する設定がありません',
    ...
    sections: {
      ...
      gateway: {
        label: "Gateway",
        description: "Gateway サーバーの設定（ポート、認証、バインディング）",
      },
      wizard: {
        label: "セットアップウィザード",
      ...
      meta: {
        label: "メタデータ",
        description: "Gateway のメタデータとバージョン情報",
      },
      logging: {
        label: "ログ",
      ...
      models: {
        label: "モデル",
        description: "AIモデルの構成とプロバイダー",
      },
      bindings: {
        label: "バインディング",
        description: "キーバインディングとショートカット",
      },
      broadcast: {
        label: "ブロードキャスト",
      ...
      discovery: {
        label: "ディスカバリー",
        description: "サービスディスカバリーとネットワーキング",
      },
      canvasHost: {
        label: "Canvasホスト",
        description: "Canvasのレンダリングと表示",
      },
      talk: {
        label: "トーク",
  ...
  quickSettings: {
    ...
    automation: {
      title: "オートメーション",
      scheduledTask: "{count}件のスケジュール済みタスク",
      scheduledTasks: "{count}件のスケジュール済みタスク",
      installedSkill: "{count} 個の skill をインストール済み",
      installedSkills: "{count} 個の skills をインストール済み",
      mcpServer: "{count} 個の MCP server",
      mcpServers: "{count} 個の MCP servers",
      manage: "管理 →",
      browse: "参照 →",
      configure: "設定 →",
    },
    ...
    personal: {
      ...
      browserOnly: "このブラウザにのみ保存されます。",
      overrideHint:
        "Control UI のオーバーライドを保存します。クリアすると設定済みのアバターに戻ります。",
      ...
      avatarIssues: {
        remoteBlocked: "リモート URL は Control UI の画像ポリシーによってブロックされています",
    ...
    pending: {
      title: "未保存の変更",
      hint: "保存すると変更が保存されます。今すぐ適用は現在のセッションも再読み込みします。",
      discard: "破棄",
      applying: "適用中…",
      applyNow: "今すぐ適用",
    },
  ...
  configView: {
    ...
    notifications: {
      title: "プッシュ通知",
      hint: "Gatewayからブラウザのプッシュ通知を受信します。",
    ...
    appearance: {
      ...
      importHint: "tweakcn テーマをこのブラウザローカルのスロットにインポートします",
      importFromTweakcn: "tweakcn からインポート",
      tweakcnInstructions:
        "tweakcn.com を開き、テーマを選択または作成して Share をクリックし、コピーしたテーマリンクをここに貼り付けてください。共有リンク、エディター URL、レジストリ URL、テーマ ID、amethyst-haze などのデフォルトテーマ名を使用できます。",
      ...
      inlineHintAfter:
        "してブラウザローカルの tweakcn テーマを1つ追加します。tweakcn で Share を使用し、コピーしたリンクをここに貼り付けてください。",
      textSize: "文字サイズ",
    },
    connection: {
      title: "接続",
    ...
    root: "<root>",
    itemCount: "[{count} 項目]",
    itemCountPlural: "[{count} 項目]",
    form: "フォーム",
    raw: "Raw",
    formUnsafeTitle: "フォームビューでは一部のフィールドを安全に編集できません",
    rawTitle: "生の JSON/JSON5 設定を編集",
    rawUnavailableTitle: "このスナップショットでは Raw モードを利用できません",
    unsavedChange: "{count} 件の未保存の変更",
    unsavedChanges: "{count} 件の未保存の変更",
    noChanges: "変更なし",
    rawDisabled:
      "Raw モードは無効です（スナップショットは生テキストを安全にラウンドトリップできません）。",
    open: "開く",
    clear: "クリア",
    apply: "適用",
    applying: "適用中…",
    ...
    dismissWarning: "今後表示しない",
    viewPendingChange: "{count}件の保留中の変更を表示",
    viewPendingChanges: "{count}件の保留中の変更を表示",
    viewPendingChangesRaw: "保留中の変更を表示",
    rawDiffUnavailable: "変更が検出されました（JSON差分は利用できません）",
    hideEnvValues: "環境変数の値を非表示",
    revealEnvValues: "環境変数の値を表示",
    peek: "プレビュー",
    loadingSchema: "スキーマを読み込み中…",
    formUnsafe:
      "設定にはフォームエディターで安全に表現できないフィールドが含まれています。それらの項目を編集するにはRawモードを使用してください。",
    rawConfig: "Raw設定（JSON/JSON5）",
    secretCount: "{count}件のシークレット",
    secretCountPlural: "{count}件のシークレット",
    redacted: "非表示",
    visible: "表示",
    ...
    sensitiveHidden:
      "{count}個の機密の値が非表示です。生の設定を編集するには、上部の表示ボタンを使用してください。",
  ...
  agentTools: {
    ...
    notIncluded: "現在のプロファイルに含まれていません。",
    ...
    enabledSummary: "{enabled}/{total}が有効です。",
    enableAll: "すべて有効化",
    disableAll: "すべて無効化",
    loadConfig: "gateway 設定を読み込んでツールプロファイルを調整します。",
    explicitAllowlist:
      "このエージェントは設定で明示的な許可リストを使用しています。ツールのオーバーライドは Config タブで管理されます。",
    globalAllowlist:
      "グローバルの tools.allow が設定されています。エージェントのオーバーライドでは、グローバルにブロックされているツールを有効化できません。",
    loadingCatalog: "ランタイムツールカタログを読み込み中…",
    catalogFallback:
      "ランタイムツールカタログを読み込めませんでした。代わりに組み込みのフォールバックリストを表示しています。",
    availableNow: "現在利用可能",
    availableNowSubtitle: "このエージェントが現在のチャットセッションで使用できるもの。",
    noSession: "セッションなし",
    switchAgent: "チャットをこのエージェントに切り替えて、ライブランタイムツールを表示します。",
    loadingAvailable: "利用可能なツールを読み込み中…",
    availableError: "このセッションで利用可能なツールを読み込めませんでした。",
    noAvailable: "現在このセッションで利用可能なツールはありません。",
    moreLiveTitle: "下のグループにさらに {count} 個のライブツールが利用可能です。",
    moreLive: "他 {count} 個のライブツール",
    ...
    profileSourceGlobal: "グローバルの既定値",
    profileSourceDefault: "既定値",
    statusSaving: "保存中…",
    statusUnsaved: "未保存",
    statusSaved: "保存済み",
    ...
    availableVia: "現在 {source} 経由で利用可能です。",
    unavailableSession: "現在このチャットセッションでは利用できません。",
    inspectAgent:
      "このエージェントにチャットを切り替えて、リアルタイムの利用可否を確認してください。",
    linkTool: "このツールへのリンク",
  },
  skillGroups: {
    workspace: "ワークスペーススキル",
    builtIn: "組み込みスキル",
  ...
  skillsPage: {
    ...
    filterPlaceholder: "インストール済みスキルを絞り込む",
    shown: "{count} 件表示",
    clawHub: "ClawHub",
    clawHubSubtitle: "レジストリからスキルを検索してインストール",
    searchClawHub: "ClawHub のスキルを検索…",
    searching: "検索中…",
  ...
  mcpPage: {
    ...
    operatorCommandsHint: "ステータス、診断、認証、プローブ、ランタイムのリロード。",
    runtimeHint:
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      linear: "チャットから直接、課題のトリアージ、サイクルの更新、バグの登録を行います。",
      todoist: "Todoist のタスクやプロジェクトを読み取り、追加、完了します。",
      airtable: "Airtable のレコード、テーブル、ベースをクエリして更新します。",
      jira: "チャットから Jira チケットを作成、検索、トリアージします。",
      canva: "Canva のデザインを作成・編集し、アセットを管理して結果をエクスポートします。",
      stripe: "Stripe アカウントの支払い、顧客、請求書、サブスクリプションを確認します。",
      googleCalendar:
        "予定の読み取り、作成、概要の把握が可能 — エージェントがスケジュールを管理します。",
      email: "メールボックスのトリアージ、要約、承認後送信付きの下書き作成。",
      pdf: "PDF ドキュメントの抽出、結合、変換、OCR を行います。",
      transcription: "音声や動画を、整理された構造的な文字起こしに変換します。",
      github:
        "公式のGitHub MCPを通じて、PRレビューのキュー管理、Issueのトリアージ、リポジトリのQ&Aを行います。",
      sentry: "クラッシュアラートが発生した瞬間に、内容を説明しトリアージします。",
      context7:
        "コーディング中にバージョン固有のライブラリドキュメントとコード例を提供します。サインアップ不要。",
      deepwiki: "公開GitHubリポジトリについて質問できます。無料でアカウント不要。",
      ...
      spotify:
        "気分に合わせたプレイリストで、検索・キュー追加し、一日をサウンドトラックで彩ります。",
      sonos: "家全体のオーディオ：チャットで再生、部屋のグループ化、キュー追加ができます。",
      reddit: "サブレディットやスレッドを閲覧・検索・要約します。",
      markets: "株式や暗号資産のリアルタイム情報、価格アラート、日次ダイジェストを提供します。",
      travel: "運賃監視と旅程メモリを備えたフライトとホテルの検索。",
      news: "パーソナライズされた日次ブリーフィング：ニュース、天気、タスクを1つのメッセージで。",
      maps: "場所、ルート、移動時間の回答。",
      translation: "テキストやドキュメントを翻訳・ローカライズします。",
      notes: "メモをMarkdown、Obsidian、Notion、Bearに保存します。",
    },
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "{verb}の提案",
      description:
        "変更すべき内容をエージェントに伝えてください。提案は保留のまま残り、workshop が改訂版を作成します。",
      placeholder:
    ...
    detail: {
      edited: "編集日時 {time}",
      created: "作成日時 {time}",
      supportFiles: "{count} 個のサポートファイル",
      noSupportFiles: "サポートファイル 0 個",
      loading: "提案を読み込み中…",
    ...
    empty: {
      ...
      searchBody: "検索をクリアするか、別のキーワードをお試しください。",
      pendingTitle: "保留中の提案はありません",
      pendingBody: "レビューが必要な新しいドラフトはここに表示されます。",
      appliedTitle: "まだ何も適用されていません",
      appliedBody: "保留中の提案を使用すると、ライブスキルとしてここに表示されます。",
      rejectedTitle: "却下された提案はありません",
      rejectedBody: "スキップした提案は、レビュー履歴を整理しておくためここに残ります。",
      quarantinedTitle: "隔離された項目はありません",
      quarantinedBody:
        "スキャナーによってブロックされた提案や、安全のため保留された提案はここに表示されます。",
      staleTitle: "古い提案はありません",
      staleBody: "クリーンに適用できなくなった提案はここに表示されます。",
      allTitle: "ここに提案はありません",
      allBody: "Skill Workshop の提案は、エージェントがドラフトを作成するとここに表示されます。",
      defaultAgent: "あなたのエージェント",
      noProposalsAria: "Skill Workshop の提案はありません",
      noProposalsTitle: "まだ提案はありません",
      noProposalsBody: "{agent} はまだスキル提案をドラフトしていません。",
      noProposalsFooter: "新しい提案はレビュー用にここに表示されます。",
    },
    today: {
      emptyTitle: "今日は待機中の項目はありません",
      emptyBody:
        "エージェントは新しいドラフトを作成していません。履歴を閲覧するには Board に切り替えてください。",
      new: "新規",
      waiting: "待機中",
      reviewed: "レビュー済み",
      agent: "エージェント",
      proposalsWaiting: "{count} 件の提案が待機中",
      browseApplied: "すでに適用されている内容を確認できます。",
      ...
      tweakIt: "調整する",
      askAgent: "エージェントに変更を依頼",
      skipping: "スキップ中…",
      skip: "スキップ",
      notForMe: "自分には不要",
      upNext: "次へ · あと {count} 件が待機中",
      seeAll: "すべての提案を見る →",
      collection: "コレクション · {count} 件使用中",
      manage: "管理 →",
      workflowHeading: "エージェントの利用方法",
      applicabilityHeading: "エージェントが使用すべきタイミング",
    },
    relative: {
      secondsAgo: "{count}秒前",
      minutesAgo: "{count}分前",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      palaceTab: "記憶の宮殿",
      dreamsExplainer:
        "これは、記憶を再生して統合する際にシステムが書き込む生の夢日記です。記憶システムが何に気づいているか、またどこがまだノイズが多かったり薄く見えるかを調べるために使用します。",
      insightsExplainer:
        "これらは外部履歴からクラスタリングされた、インポートされたインサイトです。永続的な記憶へと昇格する前に、インポートで浮かび上がったものを確認するために使用します。",
      palaceExplainer:
        "これはシステムが検索して推論できる、コンパイル済みの記憶Wiki面です。生のインポート元チャットではなく、実際の記憶ページ、主張、未解決の疑問、矛盾を調べるために使用します。",
      copyArchivePath: "アーカイブパスをコピー",
      loadingInsights: "インポートされたインサイトを読み込み中…",
      noInsights: "まだインポートされたインサイトはありません",
      noInsightsHint:
        "適用付きのChatGPTインポートを実行すると、クラスタリングされたインポート済みインサイトがここに表示されます。",
      ...
      emptyPalace: "メモリーパレスはまだ作成されていません",
      emptyPalaceHint:
        "現在、wiki には主に生のソースインポートと運用レポートしかありません。このタブは、統合、エンティティ、またはコンセプトの記述が始まると役立つようになります。",
      claims: "クレーム",
      ...
      unavailable: "メモリー Wiki は有効になっていません",
      unavailablePluginPrefix: "インポートされたインサイトとメモリーパレスは、バンドルされている",
  ...
  chat: {
    ...
    compaction: {
      label: "圧縮された履歴",
      description:
        "圧縮されたトランスクリプトはチェックポイントとして保持されます。セッションのチェックポイントを開いて、その圧縮ビューから分岐または復元できます。",
    ...
    detailPanel: {
      ...
      renderedMarkdownHint: "すばやく読むためのサニタイズされたリッチテキストプレビュー。",
      noPreviewableMarkdown: "プレビュー可能なMarkdownコンテンツはありません。",
    ...
    composer: {
      ...
      compactRecommendedContext: "推奨されるセッションコンテキストを圧縮",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "OpenClaw が何をいつ実行するかを記述すると、スケジュールに沿って実行されます。",
    ...
    detail: {
      ...
      newSubtitle: "OpenClaw が何をするかを記述し、実行タイミングを選択してください。",
      overviewTitle: "最近のアクティビティ",
      overviewSubtitle: "すべてのスケジュールされたタスクにおける最新の実行。",
      historyTitle: "実行履歴",
      detailsSection: "詳細",
      frequencySection: "頻度",
      paused: "一時停止中",
    ...
    form: {
      ...
      promptPlaceholder: "OpenClaw に実行させたい内容を記述してください...",
      repeat: "繰り返し",
      repeatInterval: "間隔",
      repeatOnce: "1回のみ",
      repeatCron: "Cron 式",
      repeatOnExit: "終了時",
      onExitHelp:
        "監視中のコマンドが終了したときに実行します。スケジュールはここでは編集できません。",
      every: "毎",
      at: "時刻",
      cronOption: "Cron",
      runAt: "実行日時",
      ...
      seconds: "秒",
      accountId: "アカウントID",
      accountIdHelp: "マルチアカウント構成向けの任意のチャンネルアカウントID。",
      ...
      failureAlertAfterHelp: "アラート前の連続エラー数。",
