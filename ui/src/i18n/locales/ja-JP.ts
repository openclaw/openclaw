...
export const ja_JP: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "ClawHubを検索",
    ...
    searchClawHubTitle: "ClawHubを検索",
    searchClawHubBody: "コードとバンドルプラグインを探すには、2文字以上入力してください。",
    noClawHubResultsTitle: "プラグインが見つかりません",
