...
export const ja_JP: TranslationMap = {
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "プランモード",
      goal: "目標モード",
      switchConfirm: "モードを切り替えますか？ 現在のモードは停止します。",
    },
    splitView: {
      open: "分割ビューを開く",
      splitRight: "右に分割",
  ...
  plan: {
    ...
    view: "表示",
    approveTitle: "このプランを実行しますか？",
    approveCta: "承認",
    revise: "フィードバックを反映して修正",
    reviseSubmit: "フィードバックを送信",
    revisePlaceholder: "何を変更しますか？",
    cancel: "キャンセル",
