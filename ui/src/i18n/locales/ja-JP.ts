...
export const ja_JP: TranslationMap = {
  ...
  settings: {
    modeForm: "フォーム",
    modeRaw: "Raw",
    formViewUnsafeTooltip: "フォームビューでは一部のフィールドを安全に編集できません",
    rawModeTooltip: "生の JSON/JSON5 設定を編集",
    rawModeUnavailable: "このスナップショットでは Raw モードを使用できません",
    rawModeDisabledNotice:
      "Raw モードは無効です(スナップショットが生テキストを安全に保持できません)。",
    unsavedChanges: "未保存の変更",
    unsavedChangeCount: "{count} 件の未保存の変更",
    unsavedChangesCount: "{count} 件の未保存の変更",
    noChanges: "変更なし",
    open: "開く",
    clear: "破棄",
    apply: "適用",
