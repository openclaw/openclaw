...
export const ja_JP: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "OpenClawが何をいつ実行するかを指定すると、スケジュールに従って実行されます。",
    ...
    detail: {
      ...
      newSubtitle: "OpenClaw に実行させる内容を記述し、実行日時を選択します。",
      overviewTitle: "最近のアクティビティ",
      overviewSubtitle: "スケジュールされたすべてのタスクの最新の実行状況です。",
      historyTitle: "実行履歴",
      detailsSection: "詳細",
      frequencySection: "頻度",
      paused: "一時停止中",
    ...
    form: {
      ...
      promptPlaceholder: "OpenClaw に実行させる内容を記述...",
      repeat: "繰り返し",
      repeatInterval: "間隔",
      repeatOnce: "1回",
      repeatCron: "Cron式",
      repeatOnExit: "終了時",
      onExitHelp:
        "監視対象のコマンドが終了したときに実行されます。ここではスケジュールを編集できません。",
      every: "毎",
      at: "時刻",
      cronOption: "Cron",
      runAt: "実行日時",
