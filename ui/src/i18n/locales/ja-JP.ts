...
export const ja_JP: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "プラン、クォータ、コストが設定されたプロバイダー。",
  ...
  modelProviders: {
    title: "設定済みプロバイダー",
    subtitle: "認証、プラン、クォータ、コストデータを含むモデルプロバイダー。",
    updated: "更新済み {time}",
    refreshing: "更新中…",
    disconnected: "ゲートウェイに接続して、設定済みのモデルプロバイダーを表示します。",
    emptyTitle: "モデルプロバイダーが設定されていません",
    emptySubtitle: "プロバイダーにサインインするか、APIキーを追加してから更新してください。",
    status: {
      ok: "接続済み",
      expiring: "期限切れ間近",
      expired: "期限切れ",
    ...
    expiresIn: "認証情報は{time}で期限切れになります",
    models: "{count} モデル",
    modelOne: "1 モデル",
    modelsAvailable: "{count}モデル中{available}モデルが利用可能",
    noStats: "このプロバイダーからはライブ使用データが報告されていません。",
    localCost: "セッション消費 · {days}日",
    localCostDetail: "{tokens} トークン · {sessions} セッション",
    saving: "保存中…",
