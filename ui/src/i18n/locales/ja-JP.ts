  ...
  cron: {
    ...
    suggestions: {
      ...
      ideas: {
        repoPulse: {
          name: "リポジトリの動向",
          tagline: "夜間のIssue、PR、CIエラーを緊急度順に表示。",
          prompt:
            "リポジトリの夜間のアクティビティ（新しいIssue、プルリクエスト、CIエラー）を確認してください。今日最も対応が必要な3項目を、それぞれリンクと1行の理由を添えて要約してください。",
        },
        standupGhostwriter: {
          name: "スタンドアップ代筆",
          tagline: "昨日の作業をもとに、スタンドアップ用の進捗報告を作成。",
          prompt:
            "昨日のコミット、マージ済みのプルリクエスト、未解決のレビュースレッドをもとに、スタンドアップ用の進捗報告を作成してください。完了、作業中、ブロック中の最大3項目にまとめてください。",
        },
        hackerNewsScout: {
          name: "Hacker Newsスカウト",
          tagline: "コーヒーを飲みながら読む価値のある3つのリンクを、鋭い寸評付きで紹介。",
          prompt:
            "今日のHacker Newsのトップページから、AIエージェント、開発者向けツール、TypeScriptに関する投稿を探してください。最も興味深い3つのリンクを、それぞれ1行の鋭い寸評付きで送ってください。",
        },
        dependencyRadar: {
          name: "依存関係レーダー",
          tagline: "古い、または脆弱な依存関係をアップグレード情報とともに表示。",
          prompt:
            "メインプロジェクトに古い、または脆弱な依存関係がないか確認してください。注目すべき更新を、それぞれ1行のリスク情報とともに一覧表示し、アップグレードコマンド案を作成してください。",
        },
        watchdog: {
          name: "夜間監視",
          tagline: "1時間ごとのヘルスチェックと1行の判定結果。",
          prompt:
            "サービスとGatewayが正常か確認してください。最近のログをスキャンして、新しいエラー、再起動、異常な負荷がないか調べてください。すべて問題なければ、正常であることを示す短い1行だけで返信してください。問題がありそうな場合は、何が失敗したのか、どこから調査を始めるべきかを報告してください。",
        },
        polyglotMinute: {
          name: "多言語の1分間",
          tagline: "朝のコーヒーとともに、役立つ外国語のフレーズを1つ。",
          prompt:
            "役立つ日本語のフレーズを1つ教えてください。フレーズ、発音の仕方、直訳、使う場面を含め、5行以内にまとめてください。",
        },
      },
    },
    stats: {
