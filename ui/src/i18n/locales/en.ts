...
export const en: TranslationMap = {
  ...
  publisherFeedsPage: {
    ...
    noneFollowed: "No publisher feeds followed.",
    unfollowNamed: "Unfollow {name}",
    refreshStatus: "Feed refresh",
    refreshNow: "Refresh publisher feeds",
    scheduler: "Automatic refresh",
    scheduled: "Scheduled",
    stopped: "Stopped",
    noStatus: "Refresh status is unavailable.",
    lastCompleted: "Last completed: {timestamp}",
    lastRun: "Last run",
    lastRunCounts: "{refreshed} of {followed} refreshed · {failed} failed",
