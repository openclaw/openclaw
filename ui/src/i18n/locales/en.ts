...
export const en: TranslationMap = {
  ...
  agents: {
    add: {
      ...
      namePlaceholder: "e.g. research",
      workspaceLabel: "Workspace path",
      workspaceHint: "Leave blank to use the default location.",
      copyAuth: 'Copy auth profiles from "main"',
      authSection: "Model / Auth provider",
      authSectionOptional: "(optional)",
      providerLabel: "Provider",
      providerSkip: "— Skip —",
      authMethodSelect: "— Select —",
      authMethodLabel: "{provider} auth method",
      apiKeySection: "How do you want to provide the API key?",
      useEnvVar: "Use existing env var",
      pasteApiKey: "Paste API key now",
