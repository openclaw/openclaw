...
export const en: TranslationMap & {
  ...
  devices: {
    ...
    localSessions: {
      ...
      statusNotShared: "Not shared",
      statusPending: "Waiting for confirmation",
      statusShared: "Shared",
      pending: "Waiting for {owner} to confirm on this device. Run there:",
      pendingExpires: "The request expires {time}.",
      active: "Shared by {owner} with agent {agent}.",
      lastRequest: "Last request {state}.",
      lastRequestReason: "Last request {state}: {reason}",
      stateDeclined: "declined",
      stateExpired: "expired",
      stateRevoked: "stopped",
      agent: "Agent for shared sessions",
      share: "Share {source} sessions",
  ...
  sessionsView: {
    ...
    localSessionLive: "{source} · working now",
    localSessionOffline: "{source} · device offline",
  },
  agents: {
    noAgents: "No agents",
  ...
  chat: {
    ...
    localSession: {
      liveFrom: "Live from {owner}'s {source}",
      stateActive: "Working now",
      stateConnected: "Connected",
      stateOffline: "Device offline",
      device: "the device",
      deviceOffline: "{owner}'s device is offline. Messages can be sent when it reconnects.",
      ...
      receipt: {
        ...
        deliveredNextTurn: "Delivered to {source}; it reads this at the next turn",
        received: "Received by {source}",
        rejected: "{source} did not accept this message",
        rejectedReason: "{source} did not accept this message: {reason}",
      },
    },
    sessionSuggestions: {
      suggest: "Suggest",
