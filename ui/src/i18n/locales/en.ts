...
export const en: TranslationMap = {
  ...
  config: {
    ...
    diff: {
      pendingChanges: "View {count} pending change(s)",
      path: "Path",
      from: "From",
      to: "To",
    },
    ...
    sections: {
      ...
      update: { label: "Update", description: "Auto-update behavior and channels" },
      apiKeys: { label: "API Keys", description: "Provider keys and authentication tokens" },
      memory: { label: "Memory", description: "Memory indexing, embedding, and recall" },
      history: { label: "History", description: "Conversation history and context window" },
