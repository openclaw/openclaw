...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    missionControl: "Unified control center with equity, strategies, and agent activity.",
    trading: "Real-time trading dashboard with market data and order management.",
    fund: "Fund capital allocation, risk control, and strategy leaderboard.",
    financeDashboard: "Financial overview with portfolio metrics and analytics.",
    commandCenter: "Trading operations hub with real-time controls.",
    evolution: "Strategy evolution engine with genetic optimization.",
    finOverview: "Fund overview — equity, risk, holdings, and alerts.",
    finTrading: "Trading operations — position management, strategy control, orders.",
    finStrategyLab: "Strategy research — evolution, backtesting, capital allocation.",
    finFlow: "Lifecycle pipeline — strategy promotions, demotions, and agent activity.",
    finSetting: "Trading settings — exchanges, risk, agent config, promotion gates.",
