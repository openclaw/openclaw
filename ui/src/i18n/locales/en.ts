...
export const en: TranslationMap & {
  ...
  chat: {
    ...
    errorMoreDetails: "More details",
    errorPermissionDenied: "This connection doesn't have permission.",
    errorRequiredPermission: "Required permission: {scope}.",
    errorSignInAgain: "Your refresh token was already used. Sign in again.",
    errorRefreshTokenReusedDetail: "It was used to create a new access token.",
