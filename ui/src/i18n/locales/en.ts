...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    language: "Choose the dashboard language.",
  ...
  languagePage: {
    ...
    subtitle: "Pick the language used by this dashboard on this device.",
    currentLabel: "Current language",
    localOnly: "Saved instantly in this browser only.",
    availableTitle: "Available languages",
    availableHint: "You can change this any time from the sidebar.",
    selectedBadge: "Selected",
    defaultBadge: "Default",
    previewLabel: "Locale code",
  },
  cron: {
    summary: {
      enabled: "Enabled",
