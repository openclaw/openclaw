...
export const en: TranslationMap = {
  ...
  chat: {
    ...
    welcomeSuggestion1: "What can you do?",
    welcomeSuggestion2: "Summarize my recent sessions",
    welcomeSuggestion3: "Help me configure a channel",
    welcomeSuggestion4: "Check system health",
    ...
    unpin: "Unpin",
    close: "close",
    addMessageOrPasteMore: "Add a message or paste more images...",
    messageAssistant: "Message {name} (Enter to send)",
