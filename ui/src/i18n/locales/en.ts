...
export const en: TranslationMap = {
  common: {
    ...
    searchAriaLabel: "Open command palette",
    themeModeSystem: "System",
    themeModeLight: "Light",
    themeModeDark: "Dark",
    cmdNew: "Start a new session",
    cmdReset: "Reset current session",
    cmdCompact: "Compact session context",
    cmdStop: "Stop current run",
    cmdClear: "Clear chat history",
    cmdFocus: "Toggle focus mode",
    cmdModel: "Show or set model",
    cmdThink: "Set thinking level",
    cmdVerbose: "Toggle verbose mode",
    cmdFast: "Toggle fast mode",
    cmdHelp: "Show available commands",
    cmdStatus: "Show session status",
    cmdExport: "Export session to Markdown",
    cmdUsage: "Show token usage",
    cmdAgents: "List agents",
    cmdKill: "Abort sub-agents",
    cmdSkill: "Run a skill",
    cmdSteer: "Steer a sub-agent",
  },
  nav: {
    chat: "Chat",
    control: "Control",
    ...
    shellCommandDesc: "Run shell",
    debugMode: "Debug Mode",
    debugModeDesc: "Toggle debug",
  ...
  overview: {
    ...
    attention: {
      ...
      cronJobsFailed: "{count} cron job failed",
      cronJobsFailedPlural: "{count} cron jobs failed",
