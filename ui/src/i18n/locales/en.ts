...
export const en: TranslationMap = {
  ...
  workboard: {
    ...
    detailCodefarm: "Code Farm terminal",
    ...
    codefarmObserve: "Observe",
    codefarmRefresh: "Refresh",
    codefarmLoading: "Loading...",
    codefarmPanelTitle: "Code Farm",
    codefarmPanelStatus: "{count} jobs loaded",
    codefarmRepoInput: "Code Farm repo path",
    codefarmRepoPlaceholder: "Repo path",
    codefarmLoadJobs: "Load jobs",
    codefarmNoJobs: "No Code Farm jobs loaded.",
    codefarmNoRef: "No Code Farm job detected on this card.",
    codefarmEmpty: "No terminal output captured yet.",
    codefarmJob: "Job: {job}",
    codefarmRepo: "Repo: {repo}",
    codefarmSource: "Source: {source}",
    codefarmAttach: "Attach: {command}",
    codefarmTruncated: "Showing the most recent captured lines.",
