...
export const en: TranslationMap = {
  ...
  workspaces: {
    teams: {
      ...
      shareThisTab: "Share this tab",
      access: "Access",
      tab: "Tab",
      recipientOptional: "Recipient (optional)",
      createInvite: "Create invite",
      oneTimeInviteLink: "One-time invite link",
      revoke: "Revoke",
      pendingChanges: "Pending changes",
      requestedChange: "{requester} requested “{title}”",
      approve: "Approve",
      reject: "Reject",
      accessRead: "Read",
      accessRequest: "Read + request changes",
      accessWrite: "Read + write",
      inviteStateActive: "active",
      inviteStateRedeemed: "redeemed",
      inviteStateRevoked: "revoked",
      inviteSummary: "{access} {state}",
      inviteSummaryFor: "{access} {state} for {recipient}",
      errors: {
        requestFailed: "Unable to complete the Teams request.",
        tabUnavailable: "The requested Teams tab is unavailable.",
        updatedTabUnavailable: "The updated Teams tab is unavailable.",
        inviteRequired: "An invite link is required.",
        inviteCreateFailed: "The invite could not be created.",
        inviteDestinationUnavailable: "The invite destination is unavailable.",
        authenticationRejected: "Authentication was not accepted.",
        connectionFailed: "The Teams connection could not be established.",
        connectionLost: "The Teams connection was lost.",
        portalLoadFailed: "Unable to load the Teams portal.",
      },
    },
    tabs: {
      label: "Workspaces",
