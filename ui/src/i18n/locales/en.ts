...
export const en: TranslationMap = {
  ...
  sessionsView: {
    ...
    goalNote: "Goal note",
    thinking: "Thinking",
    thinkingTooltip: "Reasoning effort sent to the provider API; only effective when the model supports it.",
    fast: "Fast",
    verbose: "Verbose",
    reasoning: "Reasoning",
  ...
  chat: {
    ...
    selectors: {
      ...
      thinkingLevelTooltip: "Reasoning effort sent to the provider API; only effective when the model supports it.",
      reasoningDisplayTooltip: "Controls how reasoning output is displayed or streamed in the chat.",
    },
    toolCards: {
