...
export const en: TranslationMap = {
  ...
  sessionsView: {
    ...
    searchPlaceholder: "Filter by key, agent, label, kind鈥?,
    ...
    archived: "Archived",
    loadingCheckpoints: "Loading checkpoints鈥?,
  ...
  overview: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} 鈥?re-authenticate with openclaw models auth",
  ...
  dreaming: {
    ...
    diary: {
      ...
      newer: "Newer",
      reload: "Reload",
      reloading: "Reloading鈥?,
    },
    phrases: {
      consolidatingMemories: "consolidating memories鈥?,
      tidyingKnowledgeGraph: "tidying the knowledge graph鈥?,
      replayingConversations: "replaying today's conversations鈥?,
      weavingShortTerm: "weaving short-term into long-term鈥?,
      defragmentingMindPalace: "defragmenting the mind palace鈥?,
      filingLooseThoughts: "filing away loose thoughts鈥?,
      connectingDots: "connecting distant dots鈥?,
      compostingContext: "composting old context windows鈥?,
      alphabetizingSubconscious: "alphabetizing the subconscious鈥?,
      promotingHunches: "promoting promising hunches鈥?,
      forgettingNoise: "forgetting what doesn't matter鈥?,
      dreamingEmbeddings: "dreaming in embeddings鈥?,
      reorganizingAttic: "reorganizing the memory attic鈥?,
      indexingDay: "softly indexing the day鈥?,
      nurturingInsights: "nurturing fledgling insights鈥?,
      simmeringIdeas: "simmering half-formed ideas鈥?,
      whisperingVectorStore: "whispering to the vector store鈥?,
    },
  },
  usage: {
    page: {
    ...
    details: {
      ...
      turnRange: "Turns {start}鈥搟end} of {total}",
    ...
    mosaic: {
      ...
      fourPm: "4pm",
      eightPm: "8pm",
      legend: "Low 鈫?High token density",
      sun: "Sun",
      mon: "Mon",
      tue: "Tue",
      wed: "Wed",
  ...
  chat: {
    ...
    commandPaletteTitle: "Search or jump to鈥?(鈱楰)",
    ...
    welcome: {
      ready: "Ready to chat",
      hint: "Type a message below 璺?/ for commands",
      ...
      startTalk: "Start Talk",
      stopTalk: "Stop Talk",
      messagePlaceholder: "Message OpenClaw (Enter to send)",
  ...
  languages: {
    en: "English",
    zhCN: "绠€浣撲腑鏂?(Simplified Chinese)",
    zhTW: "绻侀珨涓枃 (Traditional Chinese)",
    ptBR: "Portugu锚s (Brazilian Portuguese)",
    de: "Deutsch (German)",
    es: "Espa帽ol (Spanish)",
    jaJP: "鏃ユ湰瑾?(Japanese)",
    ko: "頃滉淡鞏?(Korean)",
    ...
    it: "Italiano (Italian)",
    tr: "T眉rk莽e (Turkish)",
    uk: "校泻褉邪褩薪褋褜泻邪 (Ukrainian)",
    id: "Bahasa Indonesia (Indonesian)",
    pl: "Polski (Polish)",
    th: "喙勦笚喔?(Thai)",
    vi: "Ti岷縩g Vi峄噒 (Vietnamese)",
    nl: "Nederlands (Dutch)",
    fa: "賮丕乇爻蹖 (Persian)",
  },
  cron: {
    quickCreate: {
      schedules: {
        ...
        weekdays: {
          label: "Weekdays",
          description: "Mon鈥揊ri at 9:00 AM",
        },
        weekly: {
          label: "Weekly",
    ...
    form: {
      ...
      jitterHelp: "Need jitter? Use Advanced 鈫?Stagger window / Stagger unit.",
      execution: "Execution",
