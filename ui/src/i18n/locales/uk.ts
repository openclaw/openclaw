...
export const uk: TranslationMap = {
  ...
  overview: {
    ...
    connection: {
      ...
      lead: "OpenClaw Control підключається до запущеного шлюзу. Використовуйте URL шлюзу та токен з машини, на якій працює OpenClaw.",
      beforeStartTitle: "Перед початком",
      beforeStartToken:
        "Зазвичай потрібен токен шлюзу, якщо ви явно не вимкнули автентифікацію Control UI.",
      beforeStartHost:
        "ws://127.0.0.1:18789 працює лише на хост-машині. На іншому пристрої використовуйте IP хоста, URL Tailscale або токенізоване посилання на панель.",
      beforeStartPassword:
        "Пароль шлюзу потрібен лише якщо ваш шлюз налаштовано на його використання.",
      afterConnectTitle: "Що відбувається після підключення",
      afterConnectBody:
        "Після підключення ця сторінка стає вашою живою операційною консоллю для сеансів, каналів, журналів, моделей, пристроїв і автоматизації.",
      authRequiredTitle: "Токен шлюзу відсутній або відхилений",
      authRequiredBody:
        "Якщо ви бачите помилку неавторизованого доступу, токен відсутній, прострочений або належить іншому екземпляру шлюзу.",
