...
export const uk: TranslationMap = {
  ...
  cron: {
    ...
    suggestions: {
      ...
      ideas: {
        repoPulse: {
          name: "Пульс репозиторіїв",
          tagline: "Нічні проблеми, PR і збої CI, упорядковані за терміновістю.",
          prompt:
            "Переглянь нічну активність у моїх репозиторіях: нові проблеми, запити на злиття та збої CI. Підсумуй три речі, які сьогодні найбільше потребують моєї уваги, додавши до кожної посилання й однорядкове пояснення.",
        },
        standupGhostwriter: {
          name: "Автор стендапу",
          tagline: "Чернетка вашого стендап-звіту на основі вчорашньої роботи.",
          prompt:
            "Підготуй чернетку мого стендап-звіту на основі вчорашніх комітів, злитих запитів на злиття та відкритих обговорень перевірки. Максимум три пункти: зроблено, у роботі, заблоковано.",
        },
        hackerNewsScout: {
          name: "Оглядач Hacker News",
          tagline: "Три посилання, варті вашої кави, з гострими коментарями.",
          prompt:
            "Переглянь сьогоднішню головну сторінку Hacker News і знайди дописи про ШІ-агентів, інструменти для розробників і TypeScript. Надішли мені три найцікавіші посилання, кожне з однорядковим гострим коментарем.",
        },
        dependencyRadar: {
          name: "Радар залежностей",
          tagline: "Застарілі або вразливі залежності з примітками щодо оновлення.",
          prompt:
            "Перевір мій основний проєкт на наявність застарілих або вразливих залежностей. Переліч важливі оновлення, додавши до кожного однорядкову примітку про ризик, і підготуй команду оновлення.",
        },
        watchdog: {
          name: "Нічна варта",
          tagline: "Щогодинна перевірка стану з однорядковим вердиктом.",
          prompt:
            "Перевір, чи мої сервіси та Gateway працюють справно: переглянь останні журнали на наявність нових помилок, перезапусків або незвичного навантаження. Якщо все гаразд, дай відповідь одним коротким рядком; якщо щось не працює, повідом, що саме сталося і де почати пошук причини.",
        },
        polyglotMinute: {
          name: "Поліглот за хвилину",
          tagline: "Одна корисна іноземна фраза до ранкової кави.",
          prompt:
            "Навчи мене однієї корисної фрази японською: наведи саму фразу, її вимову, буквальне значення та поясни, коли її вживати. Вкладися в п’ять рядків.",
        },
      },
    },
    stats: {
    ...
    form: {
      ...
      createAndRun: "Створити й запустити зараз",
      cancel: "Скасувати",
    },
    jobState: {
      next: "Наступний",
