  ...
  cron: {
    ...
    suggestions: {
      ...
      ideas: {
        ...
        nightWatch: {
          name: "Нічна варта",
          tagline: "Тихий щогодинний моніторинг — сповіщає лише коли щось ламається.",
          prompt:
            "Перевір, чи мої сервіси та Gateway працюють справно: перегляньте останні логи на наявність нових помилок, перезапусків або незвичного навантаження. Мовчи, якщо все гаразд; якщо щось зламалося — напиши мені, що не так і з чого почати розбиратися.",
        },
        polyglotMinute: {
