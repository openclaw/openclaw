...
export const uk: TranslationMap = {
  ...
  chat: {
    ...
    toolOutput: "Вивід інструмента",
    toolCall: "Виклик інструмента",
    rawDetails: "Необроблені деталі",
    openInSidePanel: "Відкрити на бічній панелі",
    openToolDetailsInSidePanel: "Відкрити деталі інструмента на бічній панелі",
