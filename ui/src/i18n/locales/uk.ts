...
export const uk: TranslationMap = {
  ...
  overview: {
    ...
    operator: {
      ...
      expiredCount: "{count} прострочено",
      expiredCountPlural: "{count} прострочено",
      expiringCount: "{count} скоро спливає",
      expiringCountPlural: "{count} скоро спливає",
      failed: "failed",
