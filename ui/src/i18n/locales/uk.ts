...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Налаштовані постачальники з тарифом, квотою та вартістю.",
  ...
  modelProviders: {
    title: "Налаштовані постачальники",
    subtitle: "Постачальники моделей з автентифікацією, тарифом, квотою та даними про витрати.",
    updated: "Оновлено {time}",
    refreshing: "Оновлення…",
    disconnected: "Підключіться до шлюзу, щоб переглянути налаштованих постачальників моделей.",
    emptyTitle: "Постачальників моделей не налаштовано",
    emptySubtitle: "Увійдіть до постачальника або додайте ключ API, потім оновіть.",
    status: {
      ok: "Підключено",
    ...
    expiresIn: "Термін дії облікових даних закінчується через {time}",
    models: "{count} моделей",
    modelOne: "1 модель",
    modelsAvailable: "{available} з {count} моделей доступно",
    noStats: "Цей постачальник не повідомив дані про використання в реальному часі.",
    localCost: "Витрати за сесію · {days} дн.",
    localCostDetail: "{tokens} токенів · {sessions} сесій",
    saving: "Збереження…",
