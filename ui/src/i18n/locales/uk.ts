...
export const uk: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Пошук у ClawHub",
    ...
    searchClawHubTitle: "Пошук у ClawHub",
    searchClawHubBody: "Введіть щонайменше два символи, щоб знайти код і плагіни пакетів.",
    noClawHubResultsTitle: "Плагінів не знайдено",
    ...
    statEnabled: "Увімкнено",
    statIssues: "Потребують уваги",
    statMcpServers: "MCP-сервери",
