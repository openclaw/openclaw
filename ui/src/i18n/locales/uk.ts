...
export const uk: TranslationMap = {
  ...
  settings: {
    modeForm: "Форма",
    modeRaw: "Вихідний",
    formViewUnsafeTooltip: "У режимі форми деякі поля не можна безпечно редагувати",
    rawModeTooltip: "Редагувати вихідну конфігурацію JSON/JSON5",
    rawModeUnavailable: "Вихідний режим недоступний для цього знімка",
    rawModeDisabledNotice:
      "Вихідний режим вимкнено (знімок не може безпечно зберегти вихідний текст).",
    unsavedChanges: "Незбережені зміни",
    unsavedChangeCount: "{count} незбережена зміна",
    unsavedChangesCount: "{count} незбережених змін",
