...
export const uk: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      filters: "Фільтри",
      shownOf: "{shown} із {total}",
      emptyTitle: "Запланованих завдань ще немає",
      emptyHint: "Опишіть, що й коли має робити OpenClaw — завдання виконуватиметься за розкладом.",
    ...
    detail: {
      ...
      newSubtitle: "Опишіть, що має робити OpenClaw, а потім виберіть час запуску.",
    ...
    form: {
      ...
      promptPlaceholder: "Опишіть, що має робити OpenClaw...",
      repeat: "Повторення",
      repeatInterval: "Інтервал",
      repeatOnce: "Один раз",
      repeatCron: "Вираз Cron",
      repeatOnExit: "Після завершення",
      onExitHelp:
        "Запускається після завершення відстежуваної команди. Розклад не можна редагувати тут.",
      every: "Кожні",
      at: "О",
      cronOption: "Cron",
      runAt: "Запустити о",
      ...
      startEnabled: "Увімкнути відразу",
