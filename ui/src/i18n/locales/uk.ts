...
export const uk: TranslationMap = {
  ...
  filePreview: {
    ...
    emptySubtitle: "Спробуйте іншу назву файлу або пошук за вмістом.",
  ...
  channels: {
    refreshingStaleSnapshot:
      "Статус каналу оновлюється у фоновому режимі; показано останній успішний знімок.",
    config: {
      schemaUnavailable: "Схема недоступна. Використовуйте Raw.",
    ...
    imessage: {
      title: "iMessage",
      subtitle: "Статус моста macOS та конфігурація каналу.",
    },
    signal: {
      title: "Signal",
    ...
    whatsapp: {
      title: "WhatsApp",
      subtitle: "Підключення WhatsApp Web та моніторинг стану з'єднання.",
    },
  ...
  nodes: {
    ...
    binding: {
      ...
      noNodes: "Немає вузлів із доступним system.run.",
      ...
      binding: "Прив'язка",
      useDefault: "Використовувати типове",
      any: "будь-який",
    },
    inventory: {
      title: "Пристрої",
      subtitle: "Один рядок на кожен спарений клієнт: статус, ролі, токени.",
      cleanupStale: "Очистити {count} застарілих",
      pendingApproval: "Очікує схвалення",
      paired: "Спарено",
      empty: "Немає спарених пристроїв.",
      connectedWithoutPairing: "Підключено без спарювання",
      olderPairing: "{count} старіше спарювання {name}",
      olderPairings: "{count} старіших спарювань {name}",
      autoPaired: "автоспарено",
      versionDrift: "розбіжність версій",
      versionDriftTitle:
        "Вузол {nodeVersion}; Gateway {gatewayVersion}. Оновіть старіший компонент, щоб вирівняти парк.",
      ...
      newPairing: "новий запит на з’єднання пристрою",
      repair: "відновити з’єднання",
    ...
    execApprovals: {
      ...
      hostNativePolicy: "Власна політика хоста",
      hostNativeHint: "Тут лише для читання. Редагуйте в застосунку-компаньйоні або CLI.",
      native: "Власний",
      ...
      on: "увімкнено",
      target: "Ціль",
      targetHint: "Gateway редагує локальні підтвердження; вузол редагує вибраний вузол.",
      host: "Хост",
      gateway: "Gateway",
      node: "Вузол",
      selectNode: "Вибрати вузол",
      noNodes: "Жоден вузол ще не оголошує підтвердження виконання.",
      scope: "Область",
      defaults: "Стандартні значення",
      security: "Безпека",
      defaultSecurity: "Стандартний режим безпеки.",
      defaultValue: "За замовчуванням: {value}.",
      mode: "Режим",
      useDefaultValue: "Використовувати за замовчуванням ({value})",
      ask: "Запитувати",
      defaultPrompt: "Стандартна політика запитів.",
      askFallback: "Резервний запит",
      promptUnavailable: "Застосовується, коли запит в UI недоступний.",
      fallback: "Резервний варіант",
      autoAllowSkills: "Автоматично дозволяти CLI навичок",
      autoAllowSkillsHint: "Дозволити виконувані файли навичок, перелічені Gateway.",
      ...
      emptyAllowlist: "Записів у списку дозволених ще немає.",
      newPattern: "Новий шаблон",
      lastUsed: "Востаннє використано: {time}",
      pattern: "Шаблон",
      remove: "Видалити",
      options: {
        deny: "Заборонити",
  ...
  agents: {
    ...
    toolCatalog: {
      ...
      descriptions: {
        read: "Читати вміст файлів",
        write: "Створювати або перезаписувати файли",
        edit: "Робити точні редагування",
        applyPatch: "Патчити файли (OpenAI)",
        exec: "Виконувати команди оболонки",
        process: "Керувати фоновими процесами",
        webSearch: "Шукати в інтернеті",
        webFetch: "Отримувати вебвміст",
        memorySearch: "Семантичний пошук",
        memoryGet: "Читати файли памʼяті",
        sessionsList: "Список сеансів",
        sessionsHistory: "Історія сеансу",
        sessionsSend: "Надіслати в сеанс",
        sessionsSpawn: "Створити субагента",
        sessionStatus: "Статус сеансу",
        browser: "Керувати вебоглядачем",
        canvas: "Керувати полотнами",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Дозволений список Skills для кожного агента та Skills робочого простору.",
      loadConfig: "Завантажте конфігурацію Gateway, щоб налаштувати Skills для кожного агента.",
      customAllowlist: "Цей агент використовує власний дозволений список Skills.",
      allEnabled:
        "Усі Skills увімкнено. Вимкнення будь-якого Skill створить дозволений список для агента.",
      loadAgent:
  ...
  configForm: {
    ...
    unsupportedSchema: "Непідтримувана схема. Використайте Raw.",
    ...
    sections: {
      ...
      update: {
        label: "Оновлення",
        description: "Налаштування автооновлення та каналу випусків",
      },
      agents: {
        label: "Агенти",
      ...
      skills: {
        label: "Skills",
        description: "Набори навичок і можливості",
      },
      tools: {
        label: "Інструменти",
      ...
      models: {
        label: "Моделі",
        description: "Конфігурації моделей ШІ та провайдери",
      },
      bindings: {
        label: "Прив'язки",
      ...
      audio: {
        label: "Аудіо",
        description: "Налаштування аудіовходу/виходу",
      },
      session: {
        label: "Сесія",
        description: "Керування сеансами та збереження",
      },
      cron: {
        label: "Cron",
      ...
      discovery: {
        label: "Discovery",
        description: "Виявлення сервісів і мережа",
      },
      canvasHost: {
        label: "Canvas Host",
      ...
      diagnostics: {
        label: "Діагностика",
        description: "Налаштування інструментування, OpenTelemetry та cache-trace",
      },
      cli: {
        label: "CLI",
      ...
      secrets: {
        label: "Secrets",
        description: "Налаштування провайдера секретів",
      },
      acp: {
        label: "ACP",
        description: "Налаштування середовища виконання та стримінгу Agent Communication Protocol",
      },
      mcp: {
        label: "MCP",
  ...
  quickSettings: {
    ...
    channels: {
      title: "Канали",
      connectedCount: "{count} під'єднано",
    ...
    automation: {
      ...
      installedSkill: "{count} навичку встановлено",
      installedSkills: "{count} навичок встановлено",
      mcpServer: "{count} сервер MCP",
      mcpServers: "{count} серверів MCP",
      manage: "Керувати →",
      browse: "Огляд →",
    ...
    personal: {
      ...
      avatarText: "Текст аватара / емодзі",
      ...
      avatarIssues: {
        ...
        cannotRender: "Не вдається відобразити аватар",
      },
    },
    pending: {
      title: "Незбережені зміни",
      hint: "Збереження зберігає ваші зміни. «Застосувати зараз» також перезавантажує поточну сесію.",
      discard: "Відхилити",
  ...
  configPage: {
    settingsView: "Вигляд налаштувань",
    simple: "Простий",
    advanced: "Розширений",
  ...
  configView: {
    ...
    themes: {
      ...
      dash: {
        label: "Dash",
        description: "Шоколадне креслення",
      },
    },
    textSizes: {
      small: "Малий",
    ...
    notifications: {
      ...
      blocked: "Заблоковано",
      ready: "Готово",
      browserSupport: "Підтримка браузером",
      available: "Доступно",
      ...
      blockedHint:
        "Сповіщення заблоковано. Оновіть дозволи сайту у браузері, щоб дозволити сповіщення.",
    },
    appearance: {
      theme: "Тема",
      ...
      importHint: "Імпортуйте тему tweakcn у цей локальний слот браузера",
      importFromTweakcn: "Імпортувати з tweakcn",
      tweakcnInstructions:
        "Відкрийте tweakcn.com, виберіть або створіть тему, натисніть Share, а потім вставте скопійоване посилання на тему сюди. Приймаються посилання Share, URL-адреси редактора, URL-адреси реєстру, ідентифікатори тем і стандартні назви тем, як-от amethyst-haze.",
      browseTweakcn: "Переглянути теми tweakcn",
      themeLink: "Посилання на тему або ID",
    ...
    rawDisabled:
      "Необроблений режим вимкнено (знімок не може безпечно зберегти необроблений текст).",
    open: "Відкрити",
    clear: "Очистити",
    apply: "Застосувати",
    applying: "Застосування…",
    ...
    formUnsafe:
      "Ваша конфігурація містить поля, які редактор форми не може безпечно відобразити. Використовуйте режим Raw для редагування цих записів.",
    ...
    toggleRawRedaction: "Перемкнути приховування raw config",
    sensitiveHidden:
      "{count} конфіденційне значення приховано. Скористайтеся кнопкою показу вище, щоб редагувати raw config.",
    sensitiveHiddenPlural:
      "{count} конфіденційних значень приховано. Скористайтеся кнопкою показу вище, щоб редагувати raw config.",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    subtitle: "Профіль + перевизначення для окремих інструментів цього агента.",
    enabledSummary: "Увімкнено {enabled}/{total}.",
    ...
    explicitAllowlist:
      "Цей агент використовує явний список дозволів у конфігурації. Перевизначення інструментів керуються на вкладці «Config».",
    globalAllowlist:
      "Встановлено глобальний tools.allow. Перевизначення агента не можуть увімкнути інструменти, які заблоковані глобально.",
    ...
    availableNow: "Доступно прямо зараз",
    ...
    moreLiveTitle: "Ще {count} активних інструментів доступні у групах нижче.",
    ...
    profileSourceGlobal: "глобальне значення за замовчуванням",
    profileSourceDefault: "за замовчуванням",
    ...
    inspectAgent: "Перемкніть чат на цього агента, щоб переглянути активну доступність.",
    linkTool: "Посилання на цей інструмент",
  },
  skillGroups: {
    workspace: "Skills робочої області",
  ...
  skillsPage: {
    ...
    loadingSkillCard: "Завантаження картки навички…",
    skillCardNotLoaded: "Картку навички не завантажено.",
    verdict: {
      unavailable: "Недоступно",
      clean: "Чисто",
      pending: "Очікується",
  ...
  mcpPage: {
    ...
    operatorCommands: "Операторські команди MCP",
    operatorCommandsHint:
      "Стан, діагностика, автентифікація, зондування та перезавантаження середовища виконання.",
    runtimeHint:
      "Зміни середовища виконання застосовуються після збереження та публікації; активні агенти перебудовують середовища виконання MCP під час наступного використання.",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      linear: "Сортуйте задачі, оновлюйте цикли та реєструйте баги прямо з чату.",
      todoist: "Читайте, додавайте та завершуйте завдання й проєкти в Todoist.",
      airtable: "Запитуйте та оновлюйте записи, таблиці й бази в Airtable.",
      jira: "Створюйте, шукайте та сортуйте тикети Jira з чату.",
      canva: "Створюйте й редагуйте дизайни Canva, керуйте ресурсами та експортуйте результати.",
      stripe: "Переглядайте платежі, клієнтів, рахунки та підписки у вашому акаунті Stripe.",
      googleCalendar:
      ...
      pdf: "Витягуйте, об'єднуйте, конвертуйте та розпізнавайте PDF-документи.",
      transcription: "Перетворюйте аудіо та відео на чисті, структуровані транскрипти.",
      github:
        "Черги перевірки PR, сортування задач і питання щодо репозиторіїв через офіційний GitHub MCP.",
      sentry: "Пояснення та сортування сповіщень про збої одразу після їх виникнення.",
      context7:
        "Документація бібліотек для конкретних версій і приклади коду під час програмування. Реєстрація не потрібна.",
      deepwiki:
        "Ставте питання про будь-який публічний репозиторій GitHub. Безкоштовно, без облікового запису.",
      ...
      homeAssistant: "Керуйте освітленням, кліматом і автоматизаціями у всьому домі.",
      spotify: "Шукайте, ставте в чергу та створюйте саундтрек дня з плейлистами за настроєм.",
      sonos: "Аудіо для всього будинку: відтворення, групування кімнат і черга через чат.",
      reddit: "Перегляд, пошук і підсумовування сабредитів та тредів.",
      markets: "Живі акції та криптовалюта зі сповіщеннями про ціни й щоденними дайджестами.",
      travel: "Пошук авіарейсів і готелів зі стеженням за цінами та пам'яттю про поїздки.",
      news: "Персоналізований щоденний брифінг: новини, погода й завдання в одному повідомленні.",
      maps: "Місця, маршрути та відповіді щодо часу в дорозі.",
      translation: "Перекладайте й локалізуйте тексти та документи.",
      notes: "Зберігайте нотатки в Markdown, Obsidian, Notion або Bear.",
    },
  ...
  skillWorkshop: {
    ...
    revision: {
      ...
      description:
        "Повідомте агента, що потрібно змінити. Пропозиція залишиться в очікуванні, а майстерня створить оновлену версію.",
      placeholder:
        "Приклад: зробіть, щоб це використовувало мітки Gmail замість пошуку непрочитаних, і додайте безпечніший крок пробного запуску.",
      preparing: "Підготовка передавання перегляду",
    ...
    empty: {
      ...
      pendingBody: "Нові чернетки з’являться тут, коли потребуватимуть перегляду.",
      appliedTitle: "Ще нічого не застосовано",
      appliedBody:
        "Скористайтеся пропозицією в очікуванні, і вона з’явиться тут як активний навик.",
      ...
      quarantinedTitle: "Немає нічого в карантині",
      quarantinedBody:
        "Тут з’являтимуться пропозиції, заблоковані сканером або утримані з міркувань безпеки.",
      staleTitle: "Немає застарілих пропозицій",
      staleBody: "Тут з’являтимуться пропозиції, які більше не можна коректно застосувати.",
      allTitle: "Тут немає пропозицій",
      allBody: "Пропозиції Skill Workshop з’являтимуться тут, коли ваш агент їх складе.",
      defaultAgent: "Ваш агент",
      noProposalsAria: "Немає пропозицій Skill Workshop",
      noProposalsTitle: "Поки що немає пропозицій",
    ...
    today: {
      ...
      emptyBody: "Ваш агент не створив нічого нового. Перейдіть на Дошку, щоб переглянути історію.",
      new: "НОВЕ",
      waiting: "ОЧІКУЄ",
      ...
      useIt: "Використати",
      addToSkills: "Додати до ваших навичок",
      tweakIt: "Налаштувати",
      ...
      applicabilityHeading: "Коли агенту слід це використовувати",
    },
    relative: {
      secondsAgo: "{count} с тому",
  ...
  dreaming: {
    ...
    wiki: {
      previewFallbackTitle: "Сторінка вікі",
      close: "Закрити",
      loadingPage: "Завантаження сторінки вікі…",
      dreamsTab: "Сни",
      insightsTab: "Імпортовані інсайти",
      palaceTab: "Палац пам’яті",
      dreamsExplainer:
        "Це необроблений щоденник снів, який система пише під час відтворення й консолідації пам’яті; використовуйте його, щоб перевірити, що помічає система пам’яті та де вона все ще виглядає зашумленою чи неповною.",
      insightsExplainer:
        "Це імпортовані інсайти, згруповані із зовнішньої історії; використовуйте їх, щоб переглянути, що виявили імпорти, перш ніж будь-що з цього перетвориться на стійку пам’ять.",
      palaceExplainer:
        "Це скомпільована поверхня вікі пам’яті, яку система може шукати й аналізувати; використовуйте її для перевірки фактичних сторінок пам’яті, тверджень, відкритих питань і суперечностей, а не необроблених імпортованих вихідних чатів.",
      copyArchivePath: "Скопіювати шлях до архіву",
      loadingInsights: "Завантаження імпортованих інсайтів…",
      noInsights: "Поки що немає імпортованих інсайтів",
      noInsightsHint:
        "Запустіть імпорт ChatGPT із застосуванням, щоб показати тут згруповані імпортовані інсайти.",
      candidateSignals: "Потенційно корисні сигнали",
      corrections: "Виправлення або зміни",
      ...
      emptyPalaceHint:
        "Наразі вікі містить переважно необроблені імпорти джерел та операційні звіти. Ця вкладка стане корисною, коли почнуть записуватися синтези, сутності чи концепції.",
      claims: "Твердження",
      ...
      unavailablePluginPrefix: "Imported Insights та Memory Palace надаються вбудованим плагіном",
      unavailablePluginSuffix: ".",
      enablePrefix: "Увімкніть",
      enableSuffix: ", потім перезавантажте цю вкладку.",
  ...
  chat: {
    ...
    actions: {
      dismissError: "Відхилити помилку",
    ...
    compaction: {
      ...
      description:
        "Ущільнений транскрипт зберігається як контрольна точка. Відкрийте контрольні точки сеансу, щоб створити гілку або відновити з цього ущільненого подання.",
    ...
    commands: {
      ...
      redirectDescription: "Перервати та розпочати заново з новим повідомленням",
    ...
    queue: {
      ...
      steer: "Скерувати",
      steered: "Скеровано",
      steerQueuedMessage: "Скерувати повідомлення в черзі",
    ...
    messages: {
      ...
      openInCanvas: "Відкрити на полотні",
    ...
    sideChat: {
      title: "Бічний чат",
      notSaved: "Не збережено в історію чату",
      thinking: "Обмірковую…",
      clear: "Очистити бічний чат",
      close: "Закрити бічний чат",
      followUp: "Уточнення…",
      followUpLabel: "Уточнення в бічному чаті",
    ...
    composer: {
      ...
      compactRecommendedContext: "Стиснути рекомендований контекст сеансу",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Опишіть, що і коли має робити OpenClaw — воно виконується за розкладом.",
    ...
    detail: {
      ...
      newSubtitle: "Опишіть, що має зробити OpenClaw, потім оберіть час запуску.",
    ...
    form: {
      ...
      repeatOnce: "Одноразово",
      repeatCron: "Вираз Cron",
      repeatOnExit: "При виході",
      onExitHelp:
        "Запускається, коли відстежувана команда завершується. Розклад не можна редагувати тут.",
      every: "Кожні",
      at: "О",
      cronOption: "Cron",
      runAt: "Запустити о",
      ...
      runsIn: "Запускається в",
      mainSession: "Основна сесія",
      isolatedSession: "Ізольована сесія",
      ...
      startEnabled: "Увімкнено на старті",
      ...
      accountIdHelp: "Необов’язковий ID акаунта каналу для налаштувань з кількома акаунтами.",
      ...
      failureAlertsHelp: "Керуйте тим, коли це завдання надсилає сповіщення про повторні збої.",
      ...
      failureAlertTo: "Сповіщати",
      failureAlertToPlaceholder: "+1555... або ID чату",
      failureAlertToHelp: "Додаткове перевизначення отримувача для сповіщень про помилки.",
      failureAlertMode: "Режим сповіщень",
      failureAlertAnnounce: "Оголошення (через канал)",
