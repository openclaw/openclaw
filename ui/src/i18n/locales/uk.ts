...
export const uk: TranslationMap = {
  ...
  question: {
    title: "У агента є питання",
    recommended: "Рекомендовано",
    otherLabel: "Інше…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Введіть вашу відповідь",
    secretWarning: "Ваша відповідь може бути видимою для інших учасників у цьому каналі.",
    submit: "Надіслати",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Режим плану",
      goal: "Режим мети",
      switchConfirm: "Перемкнути режим? Це зупинить поточний режим.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Переглянути",
    approveTitle: "Реалізувати цей план?",
    approveCta: "Схвалити",
    revise: "Змінити з урахуванням відгуку",
    reviseSubmit: "Надіслати відгук",
    revisePlaceholder: "Що потрібно змінити?",
    cancel: "Скасувати",
