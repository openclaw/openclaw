...
export const nl: TranslationMap = {
  ...
  settings: {
    modeForm: "Formulier",
    modeRaw: "Ruw",
    formViewUnsafeTooltip: "De formulierweergave kan sommige velden niet veilig bewerken",
    rawModeTooltip: "Ruwe JSON/JSON5-configuratie bewerken",
    rawModeUnavailable: "Ruwe modus niet beschikbaar voor deze snapshot",
    rawModeDisabledNotice:
      "Ruwe modus uitgeschakeld (snapshot kan ruwe tekst niet veilig behouden).",
    unsavedChanges: "Niet-opgeslagen wijzigingen",
    unsavedChangeCount: "{count} niet-opgeslagen wijziging",
    unsavedChangesCount: "{count} niet-opgeslagen wijzigingen",
