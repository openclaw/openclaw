...
export const nl: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Geconfigureerde aanbieders met abonnement, quotum en kosten.",
  ...
  modelProviders: {
    title: "Geconfigureerde aanbieders",
    subtitle: "Modelaanbieders met authenticatie, abonnement, quotum en kostengegevens.",
    updated: "Bijgewerkt {time}",
    refreshing: "Vernieuwen…",
    disconnected: "Verbind met de gateway om geconfigureerde modelaanbieders te zien.",
    emptyTitle: "Geen modelaanbieders geconfigureerd",
    emptySubtitle: "Meld u aan bij een aanbieder of voeg een API-sleutel toe en vernieuw.",
    status: {
      ok: "Verbonden",
      expiring: "Verloopt binnenkort",
      expired: "Verlopen",
      missing: "Niet aangemeld",
      apiKey: "API-sleutel",
    },
    expiresIn: "Inloggegevens verlopen over {time}",
    models: "{count} modellen",
    modelOne: "1 model",
    modelsAvailable: "{available} van {count} modellen beschikbaar",
    noStats: "Geen live gebruiksgegevens gerapporteerd door deze aanbieder.",
    localCost: "Sessieverbruik · {days}d",
    localCostDetail: "{tokens} tokens · {sessions} sessies",
    saving: "Opslaan…",
