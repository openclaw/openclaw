...
export const nl: TranslationMap = {
  ...
  channels: {
    refreshingStaleSnapshot:
      "Kanaalstatus wordt op de achtergrond vernieuwd; de laatste geslaagde momentopname wordt getoond.",
    config: {
    ...
    imessage: {
      title: "iMessage",
      subtitle: "Status van macOS-bridge en kanaalconfiguratie.",
    },
    signal: {
      title: "Signal",
  ...
  nodes: {
    ...
    inventory: {
      ...
      cleanupStale: "{count} verouderde opruimen",
      ...
      versionDrift: "versieafwijking",
      versionDriftTitle:
        "Node {nodeVersion}; Gateway {gatewayVersion}. Werk het oudere onderdeel bij om de fleet uit te lijnen.",
      manualWake: "handmatige activering vereist",
      manualWakeTitle:
        "De Gateway kan een offline Windows-node niet activeren. Start de machine of herstel de netwerkverbinding.",
      ...
      roleUpgrade: "roluitbreiding vereist goedkeuring",
    ...
    execApprovals: {
      ...
      usingDefault: "Standaard wordt gebruikt ({value}).",
      override: "Overschrijven ({value}).",
      enabled: "Ingeschakeld",
      useDefault: "Standaard gebruiken",
      allowlist: "Toegestane lijst",
      allowlistHint: "Niet-hoofdlettergevoelige glob-patronen.",
  ...
  agents: {
    ...
    overview: {
      title: "Overzicht",
      subtitle: "Workspacepaden en identiteitsmetadata.",
    ...
    toolCatalog: {
      ...
      descriptions: {
        ...
        sessionsSpawn: "Subagent starten",
        sessionStatus: "Sessiestatus",
        browser: "Webbrowser besturen",
        canvas: "Canvassen besturen",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Toegestane skills per agent en werkruimte-skills.",
      ...
      loadAgent: "Laad skills voor deze agent om werkruimte-specifieke items te bekijken.",
      filter: "Filteren",
  ...
  configForm: {
    ...
    disableStreamToReveal: "Schakel de streammodus uit om de waarde te tonen",
    ...
    unsupportedArray: "Niet-ondersteund array-schema. Gebruik de Raw-modus.",
    itemCountOne: "{count} item",
    itemCount: "{count} items",
    add: "Toevoegen",
    noItems: 'Nog geen items. Klik op "Toevoegen" om er een te maken.',
    removeItem: "Item verwijderen",
    customEntries: "Aangepaste vermeldingen",
    addEntry: "Vermelding toevoegen",
    noCustomEntries: "Geen aangepaste vermeldingen.",
    key: "Sleutel",
    ...
    unsupportedNode: "Niet-ondersteunde schema-node. Gebruik de Raw-modus.",
    ...
    sections: {
      env: {
        ...
        description: "Omgevingsvariabelen die aan het gateway-proces worden doorgegeven",
      },
      update: {
        label: "Updates",
      ...
      messages: {
        label: "Berichten",
        description: "Instellingen voor berichtverwerking en routering",
      },
      commands: {
        label: "Commando's",
        description: "Aangepaste slash-commando's",
      },
      hooks: {
        label: "Hooks",
      ...
      skills: {
        label: "Skills",
        description: "Skill-pakketten en mogelijkheden",
      },
      tools: {
        label: "Tools",
      ...
      wizard: {
        ...
        description: "Status en geschiedenis van de installatiewizard",
      },
      meta: {
        label: "Metadata",
      ...
      discovery: {
        label: "Discovery",
        description: "Servicedetectie en netwerken",
      },
      canvasHost: {
        label: "Canvas Host",
      ...
      secrets: {
        label: "Secrets",
        description: "Configuratie van secret-provider",
      },
      acp: {
        label: "ACP",
  ...
  quickSettings: {
    ...
    security: {
      ...
      execPolicy: "Exec-beleid",
      deviceAuth: "Apparaatauth",
    ...
    personal: {
      ...
      clearOverride: "Override wissen",
      browserOnly: "Alleen in deze browser opgeslagen.",
      overrideHint:
        "Slaat een Control UI-override op. Wis deze om terug te keren naar de geconfigureerde avatar.",
      uiOverride: "UI-override",
      configuredAvatar: "Geconfigureerde avatar",
      overrideFromSettings: "Override uit instellingen",
  ...
  configView: {
    ...
    themes: {
      ...
      dash: {
        label: "Dash",
        description: "Chocolade-blauwdruk",
      },
    },
    textSizes: {
      small: "Klein",
    ...
    notifications: {
      title: "Pushmeldingen",
      hint: "Ontvang pushmeldingen in de browser vanaf je gateway.",
      ...
      blockedHint:
        "Meldingen zijn geblokkeerd. Werk de sitepermissies van je browser bij om meldingen toe te staan.",
    },
    appearance: {
      theme: "Thema",
      ...
      importedTheme: "Geïmporteerd thema",
      import: "Importeren",
      importedFrom: "Geïmporteerd van tweakcn: {name}",
      importHint: "Importeer een tweakcn-thema in dit browserlokale slot",
      importFromTweakcn: "Importeren van tweakcn",
      tweakcnInstructions:
        "Open tweakcn.com, kies of maak een thema, klik op Share en plak vervolgens de gekopieerde themalink hier. Share-links, editor-URL's, registry-URL's, thema-ID's en standaard themanamen zoals amethyst-haze worden geaccepteerd.",
      ...
      inlineHintAfter:
        "om één browserlokaal tweakcn-thema toe te voegen. Gebruik in tweakcn Share en plak de gekopieerde link hier.",
      textSize: "Tekstgrootte",
    },
    connection: {
      title: "Verbinding",
    ...
    rawTitle: "Ruwe JSON/JSON5-configuratie bewerken",
    rawUnavailableTitle: "Ruwe modus niet beschikbaar voor deze snapshot",
    unsavedChange: "{count} niet-opgeslagen wijziging",
    unsavedChanges: "{count} niet-opgeslagen wijzigingen",
    noChanges: "Geen wijzigingen",
    rawDisabled: "Ruwe modus uitgeschakeld (snapshot kan ruwe tekst niet veilig terugvertalen).",
    open: "Open",
    clear: "Wissen",
    apply: "Toepassen",
    applying: "Toepassen…",
    ...
    formUnsafe:
      "Je configuratie bevat velden die de formuliereditor niet veilig kan weergeven. Gebruik de Raw-modus om die vermeldingen te bewerken.",
    ...
    toggleRawRedaction: "Redactie van raw config schakelen",
    sensitiveHidden:
  ...
  agentTools: {
    ...
    title: "Tooltoegang",
    subtitle: "Profiel + per-tool-overrides voor deze agent.",
    enabledSummary: "{enabled}/{total} ingeschakeld.",
    enableAll: "Alles inschakelen",
    disableAll: "Alles uitschakelen",
    loadConfig: "Laad de gateway-config om toolprofielen aan te passen.",
    explicitAllowlist:
      "Deze agent gebruikt een expliciete allowlist in de config. Tool-overrides worden beheerd in het tabblad Config.",
    globalAllowlist:
    ...
    catalogFallback:
      "Kon de runtime-toolcatalogus niet laden. In plaats daarvan wordt de ingebouwde fallbacklijst weergegeven.",
    ...
    switchAgent: "Wissel de chat naar deze agent om de live runtime-tools te bekijken.",
    loadingAvailable: "Beschikbare tools laden…",
    availableError: "Kan de beschikbare tools voor deze sessie niet laden.",
    noAvailable: "Er zijn op dit moment geen tools beschikbaar voor deze sessie.",
    ...
    unavailableSession: "Op dit moment niet beschikbaar in deze chatsessie.",
  ...
  skillsPage: {
    ...
    tabs: {
      all: "Alle",
      ready: "Gereed",
      needsSetup: "Vereist configuratie",
      disabled: "Uitgeschakeld",
    },
    ...
    close: "Sluiten",
    by: "Door",
    latest: "Nieuwste: v{version}",
    platforms: "Platformen: {platforms}",
  ...
  mcpPage: {
    ...
    operatorCommandsHint: "Status, diagnostiek, authenticatie, probing en runtime herladen.",
    runtimeHint:
      "Runtimewijzigingen worden toegepast na opslaan en publiceren; actieve agents bouwen MCP-runtimes opnieuw op bij het volgende gebruik.",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      airtable: "Bevraag en werk records, tabellen en bases bij in Airtable.",
      ...
      email: "Mailbox sorteren, samenvatten en concepten opstellen met verzenden-na-goedkeuring.",
      pdf: "Extraheer, voeg samen, converteer en OCR PDF-documenten.",
      transcription: "Zet audio en video om in nette, gestructureerde transcripties.",
      github: "PR-reviewwachtrijen, issue-triage en repo-Q&A via de officiële GitHub MCP.",
      sentry: "Crashmeldingen uitgelegd en gesorteerd zodra ze afgaan.",
      context7:
        "Versiespecifieke bibliotheekdocumentatie en codevoorbeelden tijdens het coderen. Geen registratie nodig.",
      ...
      grafana: "Grafana-kennis en community-connectors voor dashboards en waarschuwingen.",
      ...
      spotify: "Zoek, wachtrij en verklank je dag met stemmingsgebaseerde afspeellijsten.",
      sonos:
        "Audio voor je hele huis: afspelen, kamers groeperen en in de wachtrij zetten via chat.",
      reddit: "Blader door, zoek in en vat subreddits en threads samen.",
      markets: "Live aandelen en crypto met prijswaarschuwingen en dagelijkse overzichten.",
      travel: "Vlucht- en hotelzoekopdrachten met tariefbewaking en reisgeheugen.",
      news: "Een gepersonaliseerde dagelijkse briefing: nieuws, weer en taken in één bericht.",
      maps: "Plaatsen, routes en reistijdantwoorden.",
  ...
  skillWorkshop: {
    ...
    revision: {
      ...
      placeholder:
        "Voorbeeld: Laat dit Gmail-labels gebruiken in plaats van zoeken naar ongelezen berichten, en voeg een veiligere dry-run-stap toe.",
      preparing: "Overdracht van herziening voorbereiden",
      send: "Herziening verzenden",
    },
    queue: {
      resize: "Voorstellenlijst vergroten/verkleinen",
    ...
    empty: {
      ...
      allBody: "Skill Workshop-voorstellen verschijnen hier zodra je agent ze opstelt.",
    ...
    today: {
      emptyTitle: "Vandaag niets in de wacht",
      emptyBody:
      ...
      reviewed: "BEOORDEELD",
      agent: "agent",
      proposalsWaiting: "{count} voorstellen in afwachting",
      browseApplied: "Bekijk wat er al is toegepast.",
      ...
      tweakIt: "Pas het aan",
      askAgent: "Vraag de agent om iets te wijzigen",
      skipping: "Overslaan…",
      skip: "Overslaan",
      notForMe: "Niet voor mij",
      upNext: "Volgende · {count} meer in de wacht",
      seeAll: "Bekijk alle voorstellen →",
      collection: "Je collectie · {count} in gebruik",
      manage: "Beheren →",
      workflowHeading: "Hoe de agent het zal gebruiken",
  ...
  dreaming: {
    ...
    wiki: {
      previewFallbackTitle: "Wikipagina",
      close: "Sluiten",
      loadingPage: "Wikipagina laden…",
      dreamsTab: "Dromen",
      insightsTab: "Geïmporteerde inzichten",
      palaceTab: "Geheugenpaleis",
      dreamsExplainer:
        "Dit is het ruwe droomdagboek dat het systeem schrijft terwijl het geheugen wordt afgespeeld en geconsolideerd; gebruik het om te inspecteren wat het geheugensysteem opmerkt en waar het nog rommelig of dun oogt.",
      insightsExplainer:
        "Dit zijn geïmporteerde inzichten die zijn geclusterd uit externe geschiedenis; gebruik ze om te bekijken wat imports naar voren brachten voordat iets ervan overgaat in duurzaam geheugen.",
      palaceExplainer:
        "Dit is het samengestelde geheugenwiki-oppervlak dat het systeem kan doorzoeken en waarover het kan redeneren; gebruik het om echte geheugenpagina's, claims, openstaande vragen en tegenstrijdigheden te inspecteren in plaats van ruwe geïmporteerde bronchats.",
      ...
      noInsightsHint:
        "Voer een ChatGPT-import met toepassen uit om hier geclusterde geïmporteerde inzichten te tonen.",
      ...
      emptyPalaceHint:
        "Op dit moment bevat de wiki vooral onbewerkte bronimporten en operationele rapporten. Dit tabblad wordt nuttig zodra syntheses, entiteiten of concepten worden geschreven.",
      claims: "Beweringen",
  ...
  chat: {
    ...
    compaction: {
      ...
      description:
        "Het gecomprimeerde transcript wordt bewaard als een controlepunt. Open sessiecontrolepunten om vanuit die gecomprimeerde weergave te vertakken of te herstellen.",
      openCheckpoints: "Controlepunten openen",
    },
    commands: {
      arguments: "Commandoargumenten",
      menu: "Slash-opdrachten",
      instant: "direct",
      optionCount: "{count} opties",
      showMoreOne: "1 opdracht meer weergeven",
      showMoreMany: "{count} opdrachten meer weergeven",
      navigate: "navigeren",
      fill: "invullen",
      run: "uitvoeren",
      select: "selecteren",
    ...
    queue: {
      ...
      steer: "Bijsturen",
      steered: "Bijgestuurd",
      steerQueuedMessage: "Bericht in wachtrij bijsturen",
    ...
    sideChat: {
      ...
      clear: "Zijchat wissen",
      close: "Zijchat sluiten",
      followUp: "Vervolgvraag…",
      followUpLabel: "Vervolgen in zijchat",
    ...
    detailPanel: {
      ...
      renderedMarkdown: "Gerenderde Markdown",
    ...
    composer: {
      ...
      responding: "{name} is aan het antwoorden...",
  ...
  cron: {
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "Doordeweeks om 9:00 uur",
        everyMorning: "Dagelijks om 8:00 uur",
        weekly: "Maandags om 9:00 uur",
        hourly: "Elk uur",
      },
      ideas: {
        repoPulse: {
    ...
    detail: {
      ...
      newSubtitle: "Beschrijf wat OpenClaw moet doen en kies wanneer het draait.",
    ...
    form: {
      ...
      repeatOnce: "Eenmalig",
      repeatCron: "Cron-expressie",
      repeatOnExit: "Bij afsluiten",
      onExitHelp:
        "Wordt uitgevoerd wanneer een gevolgde opdracht wordt afgesloten. Het schema kan hier niet worden bewerkt.",
      every: "Elke",
      at: "Om",
      cronOption: "Cron",
      runAt: "Uitvoeren om",
      ...
      sessionKeyHelp: "Optionele routeringssleutel voor taakbezorging en wake-routering.",
      ...
      accountIdHelp: "Optionele kanaalaccount-ID voor configuraties met meerdere accounts.",
      lightContext: "Lichte context",
      lightContextHelp: "Gebruik een lichtgewicht bootstrap-context voor deze agenttaak.",
      model: "Model",
      ...
      failureAlertsHelp: "Bepaal wanneer deze taak meldingen voor herhaalde fouten verstuurt.",
      ...
      failureAlertCooldownHelp: "Minimum aantal seconden tussen waarschuwingen.",
      failureAlertChannel: "Waarschuwingskanaal",
      failureAlertTo: "Waarschuwen aan",
      ...
      failureAlertAccountPlaceholder: "Account-ID voor opstellingen met meerdere accounts",
