...
export const nl: TranslationMap = {
  ...
  question: {
    title: "De agent heeft een vraag",
    recommended: "Aanbevolen",
    otherLabel: "Overig…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Typ je antwoord",
    secretWarning: "Je antwoord kan zichtbaar zijn voor andere deelnemers in dit kanaal.",
    submit: "Verzenden",
    dismiss: "Dismiss",
    pending: "{count} in behandeling",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Planmodus",
      goal: "Doelmodus",
      switchConfirm: "Modus wisselen? Hiermee stopt de huidige modus.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Weergeven",
    approveTitle: "Dit plan uitvoeren?",
    approveCta: "Goedkeuren",
    revise: "Herzien met feedback",
    reviseSubmit: "Feedback verzenden",
    revisePlaceholder: "Wat moet er veranderen?",
    cancel: "Annuleren",
