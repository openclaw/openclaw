...
export const nl: TranslationMap = {
  ...
  chat: {
    ...
    toolInput: "Toolinvoer",
    toolOutput: "Tooluitvoer",
    toolCall: "Toolaanroep",
    rawDetails: "Ruwe details",
    openInSidePanel: "Openen in het zijpaneel",
    openToolDetailsInSidePanel: "Tooldetails openen in het zijpaneel",
