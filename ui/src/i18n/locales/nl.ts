...
export const nl: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "ClawHub zoeken",
    ...
    preparingSearch: "Zoeken voorbereiden…",
    searchClawHubTitle: "ClawHub zoeken",
    searchClawHubBody: "Voer ten minste twee tekens in om code- en bundelplugins te vinden.",
    noClawHubResultsTitle: "Geen plugins gevonden",
    ...
    statInstalled: "Geïnstalleerd",
    statEnabled: "Ingeschakeld",
    statIssues: "Vereist aandacht",
    statMcpServers: "MCP-servers",
