...
export const nl: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Beschrijf wat OpenClaw moet doen en wanneer — het wordt volgens planning uitgevoerd.",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "Op weekdagen om 09:00",
        everyMorning: "Dagelijks om 08:00",
        weekly: "Op maandag om 09:00",
        hourly: "Elk uur",
      },
      ideas: {
        repoPulse: {
    ...
    detail: {
      ...
      newSubtitle:
        "Beschrijf wat OpenClaw moet doen en kies vervolgens wanneer het wordt uitgevoerd.",
    ...
    form: {
      ...
      onExitHelp:
        "Wordt uitgevoerd wanneer een bewaakte opdracht wordt afgesloten. Het schema kan hier niet worden bewerkt.",
      every: "Elke",
      at: "Om",
      cronOption: "Cron",
      runAt: "Uitvoeren om",
