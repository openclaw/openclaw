...
export const it: TranslationMap = {
  ...
  settings: {
    modeForm: "Modulo",
    modeRaw: "Grezzo",
    formViewUnsafeTooltip: "La vista modulo non può modificare alcuni campi in modo sicuro",
    rawModeTooltip: "Modifica la configurazione JSON/JSON5 grezza",
    rawModeUnavailable: "Modalità grezza non disponibile per questo snapshot",
    rawModeDisabledNotice:
      "Modalità grezza disattivata (lo snapshot non può preservare il testo grezzo in modo sicuro).",
    unsavedChanges: "Modifiche non salvate",
    unsavedChangeCount: "{count} modifica non salvata",
    unsavedChangesCount: "{count} modifiche non salvate",
