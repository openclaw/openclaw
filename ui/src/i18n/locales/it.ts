...
export const it: TranslationMap = {
  ...
  question: {
    title: "L'agente ha una domanda",
    recommended: "Consigliato",
    otherLabel: "Altro…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Scrivi la tua risposta",
    secretWarning:
      "La tua risposta potrebbe essere visibile ad altri partecipanti su questo canale.",
    submit: "Invia",
    dismiss: "Dismiss",
    pending: "{count} in sospeso",
  ...
  chat: {
    ...
    mode: {
      ...
      off: "Disattivato",
      plan: "Modalità piano",
      goal: "Modalità obiettivo",
      switchConfirm: "Cambiare modalità? Questo interrompe la modalità corrente.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Visualizza",
    approveTitle: "Implementare questo piano?",
    approveCta: "Approva",
    revise: "Rivedi con feedback",
    reviseSubmit: "Invia feedback",
    revisePlaceholder: "Cosa dovrebbe cambiare?",
    cancel: "Annulla",
