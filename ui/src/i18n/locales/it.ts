...
export const it: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "Nessuna attività pianificata per ora",
      emptyHint:
        "Descrivi cosa deve fare OpenClaw e quando — verrà eseguito in base alla pianificazione.",
      noMatching: "Nessuna attività corrisponde ai filtri attuali.",
      loadMore: "Carica altro",
      loading: "Caricamento...",
      schedulerOff: "Pianificazione disabilitata",
      refresh: "Aggiorna",
      refreshing: "Aggiornamento...",
      paused: "In pausa",
    },
    ...
    detail: {
      ...
      newSubtitle: "Descrivi cosa deve fare OpenClaw, poi scegli quando eseguirlo.",
