...
export const it: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Cerca in ClawHub",
    ...
    preparingSearch: "Preparazione della ricerca…",
    searchClawHubTitle: "Cerca in ClawHub",
    searchClawHubBody: "Inserisci almeno due caratteri per trovare codice e plugin bundle.",
    noClawHubResultsTitle: "Nessun plugin trovato",
