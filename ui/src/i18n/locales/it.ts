...
export const it: TranslationMap = {
  ...
  chat: {
    ...
    toolCall: "Chiamata dello strumento",
    rawDetails: "Dettagli grezzi",
    openInSidePanel: "Apri nel pannello laterale",
    openToolDetailsInSidePanel: "Apri i dettagli dello strumento nel pannello laterale",
