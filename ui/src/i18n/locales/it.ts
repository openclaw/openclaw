...
export const it: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Fornitori configurati con piano, quota e costi.",
  ...
  modelProviders: {
    title: "Fornitori configurati",
    subtitle: "Fornitori di modelli con autenticazione, piano, quota e dati sui costi.",
    updated: "Aggiornato {time}",
    refreshing: "Aggiornamento…",
    disconnected: "Connettiti al gateway per vedere i fornitori di modelli configurati.",
    emptyTitle: "Nessun fornitore di modelli configurato",
    emptySubtitle: "Accedi a un fornitore o aggiungi una chiave API, quindi aggiorna.",
    status: {
      ok: "Connesso",
      expiring: "In scadenza",
      expired: "Scaduto",
      missing: "Accesso non effettuato",
      apiKey: "Chiave API",
    },
    expiresIn: "Le credenziali scadono in {time}",
    models: "{count} modelli",
    modelOne: "1 modello",
    modelsAvailable: "{available} di {count} modelli disponibili",
    noStats: "Nessun dato di utilizzo in tempo reale riportato da questo fornitore.",
    localCost: "Spesa sessione · {days}g",
    localCostDetail: "{tokens} token · {sessions} sessioni",
    saving: "Salvataggio…",
