...
export const it: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      noMatching: "Nessuna attività corrisponde ai filtri correnti.",
      loadMore: "Carica altro",
      loading: "Caricamento...",
      schedulerOff: "Pianificatore disabilitato",
      refresh: "Aggiorna",
      refreshing: "Aggiornamento...",
      paused: "In pausa",
    },
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "Nei giorni feriali alle 9:00",
        everyMorning: "Ogni giorno alle 8:00",
        weekly: "Il lunedì alle 9:00",
        hourly: "Ogni ora",
      },
      ideas: {
        repoPulse: {
    ...
    detail: {
      ...
      newSubtitle: "Descrivi cosa dovrebbe fare OpenClaw, quindi scegli quando eseguirlo.",
      overviewTitle: "Attività recente",
      overviewSubtitle: "Ultime esecuzioni di tutte le attività pianificate.",
      historyTitle: "Cronologia delle esecuzioni",
    ...
    form: {
      ...
      promptPlaceholder: "Descrivi cosa dovrebbe fare OpenClaw...",
      repeat: "Ripeti",
      ...
      onExitHelp:
        "Viene eseguito quando termina un comando monitorato. La pianificazione non può essere modificata qui.",
      every: "Ogni",
      at: "Alle",
      cronOption: "Cron",
      runAt: "Esegui alle",
