...
export const it: TranslationMap = {
  ...
  githubPreview: {
    loading: "Caricamento dettagli GitHub…",
  ...
  channels: {
    refreshingStaleSnapshot:
      "Aggiornamento dello stato del canale in background; viene mostrata l'ultima istantanea riuscita.",
    config: {
    ...
    slack: {
      title: "Slack",
      subtitle: "Stato della modalità socket e configurazione del canale.",
    },
    telegram: {
      title: "Telegram",
      subtitle: "Stato del bot e configurazione del canale.",
    ...
    nostr: {
      title: "Nostr",
      subtitle: "Messaggi diretti decentralizzati tramite relay Nostr (NIP-04).",
      profile: "Profilo",
  ...
  nodes: {
    ...
    binding: {
      ...
      agent: "agente",
      usesDefault: "usa predefinito ({node})",
    ...
    inventory: {
      title: "Dispositivi",
      subtitle: "Una riga per ogni client associato: stato, ruoli, token.",
      cleanupStale: "Rimuovi {count} obsoleti",
      pendingApproval: "In attesa di approvazione",
      paired: "Associato",
      empty: "Nessun dispositivo associato.",
      connectedWithoutPairing: "Connesso senza associazione",
      olderPairing: "{count} associazione precedente di {name}",
      olderPairings: "{count} associazioni precedenti di {name}",
      autoPaired: "associato automaticamente",
      ...
      scopeUpgrade: "l'aggiornamento dell'ambito richiede approvazione",
      roleUpgrade: "l'aggiornamento del ruolo richiede approvazione",
      reapproval: "dettagli di riconnessione cambiati; approvazione richiesta",
      newPairing: "nuova richiesta di associazione dispositivo",
      repair: "ripara",
    ...
    execApprovals: {
      ...
      subtitlePrefix: "Allowlist e criterio di approvazione per",
      loadHint: "Carica le approvazioni exec per modificare le allowlist.",
      hostNativePolicy: "Criterio host-native",
      hostNativeHint: "Sola lettura qui. Modifica dall'app companion o dalla CLI.",
      native: "Nativo",
      ...
      noNodes: "Nessun nodo pubblicizza ancora le approvazioni di esecuzione.",
      scope: "Ambito",
      ...
      promptUnavailable: "Applicato quando la richiesta nell'interfaccia non è disponibile.",
      fallback: "Fallback",
      ...
      emptyAllowlist: "Nessuna voce nell'elenco consentiti.",
  ...
  agents: {
    ...
    overview: {
      title: "Panoramica",
      subtitle: "Percorsi dell'area di lavoro e metadati di identità.",
      selectedSkills: "{count} selezionati",
      allSkills: "tutte le skill",
      unsavedConfig: "Sono presenti modifiche di configurazione non salvate.",
      modelSelection: "Selezione del modello",
    ...
    toolCatalog: {
      ...
      descriptions: {
        ...
        process: "Gestisci i processi in background",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Elenco di Skills consentite per agente e Skills dell'area di lavoro.",
      loadConfig: "Carica la configurazione del gateway per impostare le Skills per agente.",
      customAllowlist: "Questo agente usa un elenco personalizzato di Skills consentite.",
      allEnabled:
        "Tutte le Skills sono abilitate. Disabilitando una Skill verrà creato un elenco di Skills consentite per l'agente.",
      loadAgent:
        "Carica le Skills per questo agente per vedere le voci specifiche dell'area di lavoro.",
      filter: "Filtra",
  ...
  configForm: {
    ...
    structuredSecretRaw: "Valore strutturato (SecretRef) - usa la modalità Raw per modificarlo",
    ...
    unsupportedArray: "Schema di array non supportato. Usa la modalità Raw.",
    ...
    sections: {
      env: {
        ...
        description: "Variabili d'ambiente passate al processo del gateway",
      },
      update: {
        label: "Aggiornamenti",
      ...
      broadcast: {
        label: "Broadcast",
        description: "Impostazioni di broadcast e notifiche",
      },
      audio: {
        label: "Audio",
      ...
      session: {
        label: "Sessione",
        description: "Gestione e persistenza della sessione",
      },
      cron: {
        label: "Cron",
      ...
      web: {
        label: "Web",
        description: "Impostazioni server web e API",
      },
      discovery: {
        label: "Discovery",
        description: "Rilevamento servizi e rete",
      },
      canvasHost: {
        label: "Canvas Host",
        description: "Rendering e visualizzazione canvas",
      },
      talk: {
        label: "Talk",
      ...
      plugins: {
        label: "Plugin",
        description: "Gestione plugin ed estensioni",
      },
      diagnostics: {
        label: "Diagnostica",
      ...
      cli: {
        label: "CLI",
        description: "Banner CLI e comportamento all'avvio",
      },
      secrets: {
        label: "Secrets",
        description: "Configurazione del provider di secret",
      },
      acp: {
        label: "ACP",
      ...
      mcp: {
        label: "MCP",
        description: "Definizioni del server Model Context Protocol",
      },
    },
  },
  quickSettings: {
    ...
    automation: {
      ...
      installedSkills: "{count} Skills installate",
    ...
    personal: {
      ...
      clearAvatar: "Cancella avatar",
      clearOverride: "Cancella override",
      browserOnly: "Memorizzato solo in questo browser.",
      overrideHint:
        "Memorizza un override della Control UI. Cancellalo per tornare all'avatar configurato.",
      ...
      avatarIssues: {
        remoteBlocked: "Gli URL remoti sono bloccati dalla policy immagini della Control UI",
  ...
  configView: {
    ...
    appearance: {
      ...
      tweakcnInstructions:
        "Apri tweakcn.com, scegli o crea un tema, fai clic su Share, quindi incolla qui il link del tema copiato. Sono accettati link di condivisione, URL dell'editor, URL del registro, ID dei temi e nomi di temi predefiniti come amethyst-haze.",
      ...
      inlineHintAfter:
        "per aggiungere un tema tweakcn locale al browser. In tweakcn, usa Share e incolla qui il link copiato.",
    ...
    rawDisabled:
      "Modalità raw disattivata (lo snapshot non può gestire in modo sicuro il testo raw).",
    open: "Apri",
    clear: "Cancella",
    apply: "Applica",
    applying: "Applicazione…",
    ...
    formUnsafe:
      "La tua configurazione contiene campi che l'editor a moduli non può rappresentare in modo sicuro. Usa la modalità Raw per modificare queste voci.",
    ...
    sensitiveHidden:
      "{count} valore sensibile nascosto. Usa il pulsante Mostra qui sopra per modificare la configurazione raw.",
    sensitiveHiddenPlural:
      "{count} valori sensibili nascosti. Usa il pulsante Mostra qui sopra per modificare la configurazione raw.",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    disabledByOverride: "Disabilitato dall'override dell'agente.",
    enabledByProfile: "Abilitato dal profilo corrente.",
    enabledByOverride: "Abilitato dall'override dell'agente.",
    ...
    loadConfig: "Carica la configurazione del gateway per regolare i profili degli strumenti.",
    explicitAllowlist:
    ...
    globalAllowlist:
      "tools.allow globale è impostato. Gli override dell'agente non possono abilitare strumenti bloccati globalmente.",
    ...
    availableNowSubtitle: "Ciò che questo agente può utilizzare nella sessione di chat corrente.",
    ...
    moreLiveTitle: "Altri {count} strumenti live sono disponibili nei gruppi sottostanti.",
    ...
    profileSourceGlobal: "impostazione globale",
    ...
    inspectAgent:
      "Passa questa chat a questo agente per ispezionare la disponibilità in tempo reale.",
  ...
  skillsPage: {
    ...
    filterPlaceholder: "Filtra Skills installate",
    shown: "{count} mostrati",
    clawHub: "ClawHub",
    clawHubSubtitle: "Cerca e installa Skills dal registro",
    searchClawHub: "Cerca Skills su ClawHub…",
  ...
  skillStatus: {
    ...
    blocked: "bloccato",
    disabled: "disabilitato",
    blockedAllowlist: "bloccato dalla allowlist",
    blockedAgentFilter: "bloccato dal filtro agente",
  },
  nav: {
    chat: "Chat",
  ...
  mcpPage: {
    ...
    operatorCommandsHint: "Stato, diagnostica, autenticazione, verifica e ricaricamento runtime.",
    runtimeHint:
      "Le modifiche al runtime si applicano dopo il salvataggio e la pubblicazione; gli agenti attivi ricostruiscono i runtime MCP al prossimo utilizzo.",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      notion: "Cerca, crea e aggiorna pagine e database nel tuo workspace Notion.",
      linear: "Valuta i problemi, aggiorna i cicli e segnala i bug direttamente dalla chat.",
      ...
      canva: "Crea e modifica design Canva, gestisci le risorse ed esporta i risultati.",
      stripe: "Controlla pagamenti, clienti, fatture e abbonamenti nel tuo account Stripe.",
      googleCalendar:
        "Leggi, crea e ricevi riepiloghi sugli eventi: il tuo agente gestisce la tua agenda.",
      email: "Gestione della casella di posta, riepiloghi e bozze con invio previa approvazione.",
      pdf: "Estrai, unisci, converti ed esegui l'OCR su documenti PDF.",
      transcription: "Trasforma audio e video in trascrizioni pulite e strutturate.",
      github:
        "Code di revisione PR, gestione delle issue e domande sul repo tramite l'MCP ufficiale di GitHub.",
      sentry: "Avvisi di crash spiegati e gestiti nel momento in cui si verificano.",
      context7:
        "Documentazione delle librerie specifica per versione ed esempi di codice mentre programmi. Nessuna registrazione richiesta.",
      deepwiki:
        "Poni domande su qualsiasi repo GitHub pubblico. Gratuito, nessun account necessario.",
      huggingFace: "Cerca modelli, dataset e paper; esegui gli Spaces come strumenti.",
      grafana: "Competenze su Grafana e connettori della community per dashboard e avvisi.",
      kubernetes: "Operazioni sui cluster e risoluzione dei problemi dalla chat.",
      homeAssistant: "Controlla luci, clima e automazioni in tutta la tua casa.",
      spotify: "Cerca, metti in coda e accompagna la tua giornata con playlist basate sull'umore.",
      sonos: "Audio per tutta la casa: riproduci, raggruppa stanze e metti in coda via chat.",
      reddit: "Sfoglia, cerca e riassumi subreddit e thread.",
      markets:
      ...
      news: "Un briefing giornaliero personalizzato: notizie, meteo e attività in un solo messaggio.",
  ...
  skillWorkshop: {
    ...
    recency: {
      today: "Oggi",
      yesterday: "Ieri",
      earlier: "All'inizio di questa settimana",
    },
    ...
    revision: {
      title: "{verb} proposta",
      description:
        "Indica all'agente cosa modificare. La proposta resta in sospeso e il workshop creerà una versione rivista.",
      placeholder:
        "Esempio: fai in modo che usi le etichette di Gmail invece della ricerca dei non letti e aggiungi un passaggio dry-run più sicuro.",
      preparing: "Preparazione del passaggio di revisione",
    ...
    queue: {
      ...
      noMatch: "Nessuna proposta corrisponde al filtro attuale.",
    },
    detail: {
      edited: "Modificata {time}",
      created: "Creato {time}",
      ...
      clickToPreview: "· clicca per l'anteprima",
    },
    empty: {
      searchTitle: "Nessuna proposta corrispondente",
      searchBody: "Cancella la ricerca o prova con un'altra parola chiave.",
      ...
      rejectedBody: "Le proposte saltate rimarranno qui per una cronologia di revisione ordinata.",
    ...
    today: {
      emptyTitle: "Nulla in attesa oggi",
      emptyBody:
        "Il tuo agente non ha redatto nulla di nuovo. Passa alla Bacheca per esplorare la cronologia.",
      new: "NUOVO",
      waiting: "IN ATTESA",
      reviewed: "REVISIONATO",
      agent: "agente",
      proposalsWaiting: "{count} proposte in attesa",
      browseApplied: "Esplora ciò che è già applicato.",
      ...
      collection: "La tua raccolta · {count} in uso",
      manage: "Gestisci →",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      close: "Chiudi",
      loadingPage: "Caricamento pagina wiki…",
      dreamsTab: "Sogni",
      insightsTab: "Insight importati",
      palaceTab: "Palazzo della memoria",
      dreamsExplainer:
        "Questo è il diario dei sogni grezzo che il sistema scrive mentre riproduce e consolida la memoria; usalo per esaminare cosa sta notando il sistema di memoria e dove appare ancora rumoroso o scarno.",
      insightsExplainer:
        "Questi sono insight importati raggruppati dalla cronologia esterna; usali per rivedere ciò che le importazioni hanno fatto emergere prima che qualcosa si trasformi in memoria duratura.",
      palaceExplainer:
        "Questa è la superficie della wiki di memoria compilata su cui il sistema può cercare e ragionare; usala per esaminare le pagine di memoria effettive, le affermazioni, le domande aperte e le contraddizioni anziché le chat di origine importate grezze.",
      copyArchivePath: "Copia percorso archivio",
      loadingInsights: "Caricamento insight importati…",
      noInsights: "Nessun insight importato al momento",
      noInsightsHint:
        "Esegui un'importazione di ChatGPT con apply per far emergere qui gli insight importati raggruppati.",
      ...
      emptyPalaceHint:
        "Al momento il wiki contiene principalmente importazioni di origini grezze e report operativi. Questa scheda diventa utile una volta che iniziano a essere scritte sintesi, entità o concetti.",
      claims: "Affermazioni",
      ...
      unavailablePluginPrefix: "Imported Insights e Memory Palace sono forniti dal plugin incluso",
  ...
  chat: {
    ...
    queue: {
      ...
      steer: "Guida",
      steered: "Guidato",
      steerQueuedMessage: "Guida il messaggio in coda",
      removeQueuedMessage: "Rimuovi il messaggio in coda",
    },
    goals: {
      edit: "Modifica obiettivo",
      pause: "Metti in pausa obiettivo",
    ...
    sideChat: {
      title: "Chat laterale",
      notSaved: "Non salvato nella cronologia chat",
      thinking: "Elaborazione…",
      clear: "Cancella chat laterale",
      close: "Chiudi chat laterale",
      followUp: "Rispondi…",
      followUpLabel: "Rispondi nella chat laterale",
      sendFollowUp: "Invia risposta",
    },
    detailPanel: {
      ...
      viewRawText: "Visualizza testo non elaborato",
    ...
    composer: {
      ...
      preparingModel: "Preparazione modello...",
      ...
      compactRecommendedContext: "Comprimi il contesto consigliato della sessione",
  ...
  cron: {
    ...
    list: {
      ...
      loading: "Caricamento...",
      schedulerOff: "Utilità di pianificazione disattivata",
      refresh: "Aggiorna",
      refreshing: "Aggiornamento...",
      paused: "In pausa",
    },
    ...
    detail: {
      ...
      overviewTitle: "Attività recente",
      overviewSubtitle: "Ultime esecuzioni di tutte le attività pianificate.",
      historyTitle: "Cronologia esecuzioni",
      detailsSection: "Dettagli",
      frequencySection: "Frequenza",
      paused: "In pausa",
    },
    actions: {
      runNow: "Esegui ora",
      runIfDue: "Esegui se dovuto",
    ...
    form: {
      ...
      sessionKeyHelp:
        "Chiave di instradamento opzionale per la consegna dei job e l'instradamento del wake.",
      ...
      failureAlertToPlaceholder: "+1555... o id chat",
      failureAlertToHelp: "Destinatario opzionale per gli avvisi di errore.",
      failureAlertMode: "Modalità avviso",
