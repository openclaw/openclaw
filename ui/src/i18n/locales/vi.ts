...
export const vi: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Tìm kiếm ClawHub",
    ...
    searchClawHubTitle: "Tìm kiếm ClawHub",
    searchClawHubBody: "Nhập ít nhất hai ký tự để tìm plugin mã và gói.",
    noClawHubResultsTitle: "Không tìm thấy plugin nào",
    ...
    statEnabled: "Đã bật",
    statIssues: "Cần chú ý",
    statMcpServers: "Máy chủ MCP",
