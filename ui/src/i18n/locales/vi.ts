...
export const vi: TranslationMap = {
  ...
  filePreview: {
    ...
    noMatches: "Không có tệp phù hợp.",
    navigate: "điều hướng",
  },
  mcpApp: {
    title: "Ứng dụng MCP",
  ...
  githubPreview: {
    loading: "Đang tải chi tiết GitHub…",
    unavailable: "Không xem trước được GitHub",
    states: {
      merged: "Đã hợp nhất",
      draft: "Bản nháp",
      open: "Mở",
      closed: "Đã đóng",
      notPlanned: "Không dự kiến",
    },
    file: "{count} tệp",
    files: "{count} tệp",
  ...
  channels: {
    ...
    config: {
      schemaUnavailable: "Không có schema. Dùng Raw.",
    ...
    whatsapp: {
      title: "WhatsApp",
      subtitle: "Liên kết WhatsApp Web và theo dõi tình trạng kết nối.",
    },
    ...
    nostr: {
      title: "Nostr",
      subtitle: "Tin nhắn riêng phi tập trung qua các relay Nostr (NIP-04).",
      profile: "Hồ sơ",
  ...
  nodes: {
    ...
    inventory: {
      title: "Thiết bị",
      subtitle: "Mỗi hàng là một máy khách đã ghép nối: trạng thái, vai trò, token.",
      cleanupStale: "Dọn {count} mục cũ",
      pendingApproval: "Đang chờ phê duyệt",
      paired: "Đã ghép nối",
      empty: "Không có thiết bị nào được ghép nối.",
      connectedWithoutPairing: "Đã kết nối mà không ghép nối",
      ...
      versionDriftTitle:
        "Node {nodeVersion}; Gateway {gatewayVersion}. Cập nhật thành phần cũ hơn để đồng bộ hệ thống.",
      manualWake: "cần đánh thức thủ công",
      manualWakeTitle:
        "Gateway không thể đánh thức node Windows đang ngoại tuyến. Hãy khởi động máy hoặc khôi phục kết nối mạng của nó.",
      approvalNeeded: "cần phê duyệt",
      inputAgo: "nhập cách đây {time}",
      seen: "thấy {time}",
      approved: "đã phê duyệt {time}",
      more: "+{count} nữa",
      details: "Chi tiết",
      deviceId: "ID thiết bị: {id}",
      remoteIp: "IP từ xa: {ip}",
      scopes: "phạm vi: {scopes}",
      tokens: "Token",
      ...
      revoke: "Thu hồi",
      none: "không có",
      rolesAndScopes: "vai trò: {roles} · phạm vi: {scopes}",
      scopeUpgrade: "nâng cấp phạm vi cần phê duyệt",
      roleUpgrade: "nâng cấp vai trò cần phê duyệt",
      reapproval: "thông tin kết nối lại đã thay đổi; cần phê duyệt",
    ...
    execApprovals: {
      ...
      hostNativePolicy: "Chính sách gốc của máy chủ",
      ...
      askFallback: "Hỏi dự phòng",
      promptUnavailable: "Áp dụng khi lời nhắc UI không khả dụng.",
      fallback: "Dự phòng",
      autoAllowSkills: "Tự động cho phép CLI Skills",
      autoAllowSkillsHint: "Cho phép các tệp thực thi skill được Gateway liệt kê.",
      usingDefault: "Đang dùng mặc định ({value}).",
      override: "Ghi đè ({value}).",
      enabled: "Đã bật",
      useDefault: "Dùng mặc định",
      allowlist: "Danh sách cho phép",
      allowlistHint: "Mẫu glob không phân biệt chữ hoa chữ thường.",
      addPattern: "Thêm mẫu",
  ...
  agents: {
    ...
    overview: {
      title: "Tổng quan",
      subtitle: "Đường dẫn workspace và siêu dữ liệu danh tính.",
      selectedSkills: "Đã chọn {count}",
      allSkills: "tất cả Skills",
      unsavedConfig: "Bạn có thay đổi config chưa lưu.",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Danh sách cho phép Skills theo từng agent và Skills không gian làm việc.",
      ...
      allEnabled:
        "Tất cả Skills đã được bật. Vô hiệu hóa bất kỳ Skill nào sẽ tạo danh sách cho phép theo từng agent.",
      loadAgent: "Tải Skills cho agent này để xem các mục dành riêng cho không gian làm việc.",
      filter: "Bộ lọc",
  ...
  configForm: {
    ...
    unsupportedArray: "Lược đồ mảng không được hỗ trợ. Hãy dùng chế độ Raw.",
    itemCountOne: "{count} mục",
    itemCount: "{count} mục",
    add: "Thêm",
    noItems: 'Chưa có mục nào. Nhấp "Thêm" để tạo một mục.',
    removeItem: "Xóa mục",
    ...
    unsupportedSchema: "Lược đồ không được hỗ trợ. Hãy dùng Raw.",
    unsupportedNode: "Nút lược đồ không được hỗ trợ. Hãy dùng chế độ Raw.",
    ...
    sections: {
      env: {
        ...
        description: "Biến môi trường được truyền tới tiến trình gateway",
      },
      update: {
        label: "Cập nhật",
      ...
      hooks: {
        label: "Hooks",
        description: "Webhook và event hook",
      },
      skills: {
        label: "Skills",
      ...
      wizard: {
        ...
        description: "Trạng thái và lịch sử của trình hướng dẫn thiết lập",
      },
      meta: {
        label: "Siêu dữ liệu",
      ...
      bindings: {
        label: "Liên kết phím",
        description: "Liên kết phím và phím tắt",
      },
      broadcast: {
        label: "Phát sóng",
      ...
      session: {
        label: "Phiên",
        description: "Quản lý và duy trì phiên",
      },
      cron: {
        label: "Cron",
        description: "Tác vụ được lên lịch và tự động hóa",
      },
      web: {
        label: "Web",
      ...
      acp: {
        label: "ACP",
        description: "Cài đặt runtime và truyền phát Agent Communication Protocol",
      },
      mcp: {
        label: "MCP",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      you: "Bạn",
      assistant: "Trợ lý",
      localIdentity: "Danh tính trò chuyện cục bộ của bạn",
      assistantIdentity: "Danh tính trợ lý",
      avatarText: "Chữ / emoji cho avatar",
      avatarPlaceholder: "JD hoặc 🦞",
      chooseImage: "Chọn hình ảnh",
      replaceImage: "Thay hình ảnh",
      clearAvatar: "Xóa avatar",
      clearOverride: "Xóa ghi đè",
      browserOnly: "Chỉ lưu trong trình duyệt này.",
      overrideHint: "Lưu một ghi đè của Control UI. Xóa nó để quay lại avatar đã cấu hình.",
    ...
    pending: {
      ...
      hint: "Lưu sẽ lưu trữ các thay đổi của bạn. Áp dụng ngay cũng tải lại phiên hiện tại.",
      discard: "Bỏ",
  ...
  configPage: {
    ...
    themeRemoved: "Đã xóa giao diện tùy chỉnh.",
    channels: {
      telegram: "Telegram",
      discord: "Discord",
      slack: "Slack",
  ...
  configView: {
    ...
    appearance: {
      ...
      tweakcnInstructions:
        "Mở tweakcn.com, chọn hoặc tạo một giao diện, nhấp Share, sau đó dán liên kết giao diện đã sao chép vào đây. Chấp nhận liên kết chia sẻ, URL trình chỉnh sửa, URL registry, ID giao diện và tên giao diện mặc định như amethyst-haze.",
      ...
      inlineHintAfter:
        "để thêm một chủ đề tweakcn cục bộ trên trình duyệt. Trong tweakcn, hãy dùng Share và dán liên kết đã sao chép vào đây.",
      textSize: "Cỡ chữ",
    },
    connection: {
      title: "Kết nối",
    ...
    rawDisabled: "Đã tắt chế độ thô (ảnh chụp không thể chuyển đổi qua lại an toàn văn bản thô).",
    open: "Mở",
    clear: "Xóa",
    apply: "Áp dụng",
    applying: "Đang áp dụng…",
    ...
    secretCountPlural: "{count} khóa bí mật",
    redacted: "đã ẩn",
    visible: "hiển thị",
  ...
  agentTools: {
    ...
    disabledByOverride: "Bị tắt do ghi đè của agent.",
    enabledByProfile: "Được bật bởi hồ sơ hiện tại.",
    enabledByOverride: "Được bật do ghi đè của agent.",
    notIncluded: "Không có trong hồ sơ hiện tại.",
    overrideOff: "Tắt ghi đè",
    enabled: "Đã bật",
    overrideOn: "Bật ghi đè",
    ...
    explicitAllowlist:
      "Agent này đang sử dụng danh sách cho phép rõ ràng trong cấu hình. Các ghi đè công cụ được quản lý trong tab Config.",
    globalAllowlist:
      "tools.allow toàn cục đã được thiết lập. Ghi đè agent không thể bật các công cụ bị chặn toàn cục.",
    ...
    availableNowSubtitle: "Những gì agent này có thể sử dụng trong phiên trò chuyện hiện tại.",
    noSession: "không có phiên",
    switchAgent:
      "Chuyển cuộc trò chuyện sang agent này để xem các công cụ runtime trực tiếp của nó.",
    loadingAvailable: "Đang tải các công cụ có sẵn…",
    availableError: "Không thể tải các công cụ có sẵn cho phiên này.",
    noAvailable: "Hiện không có công cụ nào khả dụng cho phiên này.",
    moreLiveTitle: "Có thêm {count} công cụ trực tiếp khả dụng trong các nhóm bên dưới.",
    ...
    defaultPresets: "Cài đặt mặc định",
    availableVia: "Hiện có sẵn qua {source}.",
    unavailableSession: "Hiện không khả dụng trong phiên trò chuyện này.",
    inspectAgent:
      "Chuyển cuộc trò chuyện sang tác nhân này để kiểm tra tình trạng khả dụng trực tiếp.",
  ...
  mcpPage: {
    ...
    operatorCommandsHint: "Trạng thái, chẩn đoán, xác thực, thăm dò và tải lại runtime.",
    runtimeHint:
      "Thay đổi runtime được áp dụng sau khi lưu và phát hành; các agent đang hoạt động sẽ xây dựng lại runtime MCP trong lần sử dụng tiếp theo.",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      notion: "Tìm kiếm, tạo và cập nhật trang cùng cơ sở dữ liệu trong workspace Notion của bạn.",
      linear: "Phân loại vấn đề, cập nhật chu kỳ và báo lỗi ngay từ chat.",
      todoist: "Đọc, thêm và hoàn thành nhiệm vụ cùng dự án trong Todoist.",
      ...
      stripe:
        "Kiểm tra thanh toán, khách hàng, hóa đơn và gói đăng ký trong tài khoản Stripe của bạn.",
      googleCalendar:
        "Đọc, tạo và nhận tóm tắt sự kiện — trợ lý của bạn nắm giữ lịch trình của bạn.",
      email: "Phân loại hộp thư, tóm tắt và soạn thảo với gửi khi được phê duyệt.",
      pdf: "Trích xuất, hợp nhất, chuyển đổi và OCR tài liệu PDF.",
      transcription: "Biến âm thanh và video thành bản ghi sạch sẽ, có cấu trúc.",
      github:
        "Hàng đợi đánh giá PR, phân loại issue và hỏi đáp repo thông qua GitHub MCP chính thức.",
      sentry: "Cảnh báo sự cố được giải thích và phân loại ngay khi phát sinh.",
      context7:
        "Tài liệu thư viện theo phiên bản cụ thể và ví dụ mã khi lập trình. Không cần đăng ký.",
      ...
      grafana: "Kiến thức Grafana và các connector cộng đồng cho dashboard và cảnh báo.",
      kubernetes: "Vận hành và khắc phục sự cố cụm ngay từ chat.",
      homeAssistant: "Điều khiển đèn, điều hòa và tự động hóa trên toàn bộ ngôi nhà của bạn.",
      spotify:
        "Tìm kiếm, xếp hàng và tạo nhạc nền cho ngày của bạn với danh sách phát theo tâm trạng.",
      sonos: "Âm thanh toàn bộ ngôi nhà: phát, nhóm phòng và xếp hàng qua chat.",
      reddit: "Duyệt, tìm kiếm và tóm tắt các subreddit và chủ đề.",
      markets: "Cổ phiếu và tiền mã hóa trực tiếp với cảnh báo giá và tóm tắt hằng ngày.",
      travel: "Tìm kiếm chuyến bay và khách sạn với theo dõi giá vé và ghi nhớ chuyến đi.",
      news: "Bản tóm tắt hằng ngày được cá nhân hóa: tin tức, thời tiết và công việc trong một tin nhắn.",
      maps: "Câu trả lời về địa điểm, định tuyến và thời gian di chuyển.",
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "{verb} đề xuất",
      description:
        "Cho tác nhân biết những gì cần thay đổi. Đề xuất vẫn ở trạng thái chờ xử lý và workshop sẽ tạo một phiên bản đã chỉnh sửa.",
      placeholder:
        "Ví dụ: Làm cho phần này dùng nhãn Gmail thay vì tìm kiếm chưa đọc, và thêm bước chạy thử an toàn hơn.",
      preparing: "Đang chuẩn bị bàn giao bản chỉnh sửa",
      send: "Gửi bản chỉnh sửa",
    },
    queue: {
      resize: "Thay đổi kích thước danh sách đề xuất",
      search: "Tìm kiếm đề xuất…",
      loadError: "Không thể tải đề xuất.",
    ...
    empty: {
      ...
      searchBody: "Xóa tìm kiếm hoặc thử từ khóa khác.",
      pendingTitle: "Không có đề xuất đang chờ",
      pendingBody: "Các bản nháp mới sẽ xuất hiện ở đây khi cần xem xét.",
      appliedTitle: "Chưa áp dụng gì cả",
      appliedBody:
        "Sử dụng một đề xuất đang chờ và nó sẽ xuất hiện ở đây dưới dạng skill đang hoạt động.",
      rejectedTitle: "Không có đề xuất bị từ chối",
      rejectedBody: "Các đề xuất bị bỏ qua sẽ được giữ lại ở đây để có lịch sử xem xét gọn gàng.",
      quarantinedTitle: "Không có gì bị cách ly",
      quarantinedBody:
        "Các đề xuất bị trình quét chặn hoặc giữ lại vì lý do an toàn sẽ xuất hiện ở đây.",
      staleTitle: "Không có đề xuất lỗi thời",
      staleBody: "Các đề xuất không còn áp dụng được sạch sẽ sẽ xuất hiện ở đây.",
      allTitle: "Không có đề xuất nào ở đây",
      allBody: "Các đề xuất Skill Workshop sẽ xuất hiện ở đây khi agent của bạn soạn thảo chúng.",
      defaultAgent: "Agent của bạn",
      noProposalsAria: "Không có đề xuất Skill Workshop",
      noProposalsTitle: "Chưa có đề xuất nào",
      noProposalsBody: "{agent} chưa soạn thảo bất kỳ đề xuất skill nào.",
      noProposalsFooter: "Đề xuất mới sẽ xuất hiện ở đây để xem xét.",
    },
    today: {
      ...
      upNext: "Tiếp theo · còn {count} đang chờ",
      seeAll: "Xem tất cả đề xuất →",
      collection: "Bộ sưu tập của bạn · {count} đang dùng",
      manage: "Quản lý →",
      workflowHeading: "Cách agent sẽ sử dụng nó",
      applicabilityHeading: "Khi nào agent nên sử dụng nó",
    },
    relative: {
      secondsAgo: "{count} giây trước",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      dreamsExplainer:
        "Đây là nhật ký giấc mơ thô mà hệ thống ghi lại khi phát lại và củng cố ký ức; hãy dùng nó để kiểm tra những gì hệ thống ký ức đang chú ý và nơi nào vẫn còn nhiễu hoặc mỏng.",
      insightsExplainer:
        "Đây là những thông tin đã nhập được nhóm lại từ lịch sử bên ngoài; hãy dùng chúng để xem lại những gì việc nhập đã đưa ra trước khi bất kỳ điều gì được đưa vào ký ức lâu dài.",
      palaceExplainer:
        "Đây là bề mặt wiki ký ức đã biên dịch mà hệ thống có thể tìm kiếm và suy luận; hãy dùng nó để kiểm tra các trang ký ức thực tế, các khẳng định, câu hỏi mở và mâu thuẫn thay vì các cuộc trò chuyện nguồn được nhập thô.",
      copyArchivePath: "Sao chép đường dẫn lưu trữ",
      loadingInsights: "Đang tải thông tin đã nhập…",
      noInsights: "Chưa có thông tin nào được nhập",
      noInsightsHint:
        "Chạy nhập ChatGPT với tùy chọn apply để hiển thị thông tin đã nhập được nhóm lại tại đây.",
      ...
      emptyPalaceHint:
        "Hiện tại wiki chủ yếu chứa các bản nhập nguồn thô và báo cáo vận hành. Tab này trở nên hữu ích khi các bản tổng hợp, thực thể hoặc khái niệm bắt đầu được viết.",
      claims: "Tuyên bố",
      ...
      enablePrefix: "Bật",
      enableSuffix: ", rồi tải lại tab này.",
  ...
  chat: {
    ...
    compaction: {
      ...
      description:
        "Bản ghi đã nén được lưu làm điểm kiểm tra. Mở điểm kiểm tra phiên để phân nhánh hoặc khôi phục từ chế độ xem đã nén đó.",
    ...
    commands: {
      ...
      showMoreOne: "Hiển thị thêm 1 lệnh",
      showMoreMany: "Hiển thị thêm {count} lệnh",
      navigate: "điều hướng",
      fill: "điền",
      run: "chạy",
      select: "chọn",
      ...
      steerDescription: "Chèn một tin nhắn vào lần chạy đang hoạt động",
      categories: {
        session: "Phiên",
        model: "Mô hình",
        agents: "Tác nhân",
    ...
    detailPanel: {
      ...
      renderedMarkdownHint: "Bản xem trước rich-text đã được làm sạch để đọc nhanh.",
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "Tìm kiếm tác vụ đã lên lịch",
      newTask: "Tác vụ mới",
      filters: "Bộ lọc",
      shownOf: "{shown} trên {total}",
      emptyTitle: "Chưa có tác vụ theo lịch",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "Ngày thường lúc 9:00 sáng",
        everyMorning: "Hằng ngày lúc 8:00 sáng",
        weekly: "Thứ Hai lúc 9:00 sáng",
        hourly: "Mỗi giờ",
      },
      ideas: {
        repoPulse: {
    ...
    form: {
      ...
      onExitHelp: "Chạy khi một lệnh được theo dõi thoát. Không thể chỉnh sửa lịch trình ở đây.",
      every: "Mỗi",
      at: "Vào",
      cronOption: "Cron",
      runAt: "Chạy lúc",
      ...
      isolatedSession: "Phiên tách biệt",
      ...
      lightContextHelp: "Sử dụng ngữ cảnh khởi động nhẹ cho tác vụ agent này.",
      model: "Mô hình",
      ...
      failureAlertCustom: "Tùy chỉnh cho từng tác vụ",
