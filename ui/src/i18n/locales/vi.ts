...
export const vi: TranslationMap = {
  ...
  question: {
    title: "Agent có một câu hỏi",
    recommended: "Đề xuất",
    otherLabel: "Khác…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Nhập câu trả lời của bạn",
    secretWarning:
      "Câu trả lời của bạn có thể hiển thị với những người tham gia khác trong kênh này.",
    submit: "Gửi",
    dismiss: "Dismiss",
    pending: "{count} đang chờ",
  ...
  chat: {
    ...
    mode: {
      ...
      goal: "Chế độ mục tiêu",
      switchConfirm: "Chuyển chế độ? Thao tác này sẽ dừng chế độ hiện tại.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Xem",
    approveTitle: "Triển khai kế hoạch này?",
    approveCta: "Phê duyệt",
    revise: "Sửa đổi theo phản hồi",
    reviseSubmit: "Gửi phản hồi",
    revisePlaceholder: "Cần thay đổi điều gì?",
    cancel: "Hủy",
