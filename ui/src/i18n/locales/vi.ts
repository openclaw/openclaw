...
export const vi: TranslationMap = {
  ...
  workboard: {
    ...
    detailTabs: "Các tab chi tiết thẻ",
    detailTabDetails: "Chi tiết",
    detailTabChat: "Chat",
    detailChatPlaceholder: "Nhắn cho agent của thẻ này...",
    detailChatSend: "Gửi",
    detailChatSending: "Đang gửi...",
    ...
    toolbarExpand: "Mở rộng bộ điều khiển Workboard",
    toolbarCollapse: "Thu gọn bộ điều khiển Workboard",
