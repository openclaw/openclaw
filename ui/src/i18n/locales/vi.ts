...
export const vi: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "Chưa có tác vụ nào được lên lịch",
      emptyHint: "Mô tả OpenClaw nên làm gì và khi nào — tác vụ sẽ chạy theo lịch.",
      noMatching: "Không có tác vụ nào khớp với bộ lọc hiện tại.",
      loadMore: "Tải thêm",
      loading: "Đang tải...",
      schedulerOff: "Trình lên lịch đã tắt",
      refresh: "Làm mới",
      refreshing: "Đang làm mới...",
      paused: "Đã tạm dừng",
    },
    ...
    detail: {
      newTitle: "Tác vụ đã lên lịch mới",
      newSubtitle: "Mô tả việc OpenClaw cần làm, rồi chọn thời điểm chạy.",
      overviewTitle: "Hoạt động gần đây",
      overviewSubtitle: "Các lần chạy mới nhất trên tất cả tác vụ đã lên lịch.",
    ...
    form: {
      ...
      startEnabled: "Bắt đầu ở trạng thái bật",
