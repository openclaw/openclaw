...
export const vi: TranslationMap = {
  ...
  settings: {
    modeForm: "Biểu mẫu",
    modeRaw: "Thô",
    formViewUnsafeTooltip: "Chế độ biểu mẫu không thể chỉnh sửa an toàn một số trường",
    rawModeTooltip: "Chỉnh sửa cấu hình JSON/JSON5 thô",
    rawModeUnavailable: "Chế độ thô không khả dụng cho ảnh chụp này",
    rawModeDisabledNotice:
      "Chế độ thô bị tắt (ảnh chụp không thể giữ nguyên văn bản thô một cách an toàn).",
    unsavedChanges: "Thay đổi chưa lưu",
    unsavedChangeCount: "{count} thay đổi chưa lưu",
    unsavedChangesCount: "{count} thay đổi chưa lưu",
