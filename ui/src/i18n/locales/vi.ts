...
export const vi: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Nhà cung cấp đã định cấu hình với gói, hạn mức và chi phí.",
  ...
  modelProviders: {
    title: "Nhà cung cấp đã định cấu hình",
    subtitle: "Nhà cung cấp mô hình với xác thực, gói, hạn mức và dữ liệu chi phí.",
    updated: "Đã cập nhật {time}",
    refreshing: "Đang làm mới…",
    disconnected: "Kết nối với cổng để xem các nhà cung cấp mô hình đã định cấu hình.",
    emptyTitle: "Chưa định cấu hình nhà cung cấp mô hình",
    emptySubtitle: "Đăng nhập vào nhà cung cấp hoặc thêm khóa API, sau đó làm mới.",
    status: {
      ok: "Đã kết nối",
    ...
    expiresIn: "Thông tin xác thực hết hạn sau {time}",
    models: "{count} mô hình",
    modelOne: "1 mô hình",
    modelsAvailable: "{available} trong số {count} mô hình khả dụng",
    noStats: "Không có dữ liệu sử dụng trực tiếp nào được báo cáo bởi nhà cung cấp này.",
    localCost: "Chi tiêu phiên · {days} ngày",
    localCostDetail: "{tokens} token · {sessions} phiên",
    saving: "Đang lưu…",
