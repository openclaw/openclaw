...
export const vi: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Mô tả việc OpenClaw cần làm và thời điểm thực hiện — tác vụ sẽ chạy theo lịch.",
      noMatching: "Không có tác vụ nào khớp với các bộ lọc hiện tại.",
      loadMore: "Tải thêm",
      loading: "Đang tải...",
      schedulerOff: "Trình lập lịch đã bị tắt",
      refresh: "Làm mới",
      refreshing: "Đang làm mới...",
      paused: "Đã tạm dừng",
    },
    suggestions: {
      ...
      schedules: {
        ...
        everyMorning: "Hằng ngày lúc 8:00 SA",
        weekly: "Thứ Hai lúc 9:00 SA",
        hourly: "Mỗi giờ",
      },
      ideas: {
        repoPulse: {
    ...
    detail: {
      ...
      newSubtitle: "Mô tả việc OpenClaw cần làm, sau đó chọn thời điểm chạy.",
      overviewTitle: "Hoạt động gần đây",
      overviewSubtitle: "Các lần chạy mới nhất của tất cả tác vụ đã lên lịch.",
    ...
    form: {
      ...
      promptPlaceholder: "Mô tả việc OpenClaw cần làm...",
      repeat: "Lặp lại",
      ...
      onExitHelp:
        "Chạy khi một lệnh đang được theo dõi kết thúc. Không thể chỉnh sửa lịch biểu tại đây.",
      every: "Mỗi",
      at: "Vào",
      cronOption: "Cron",
      runAt: "Chạy lúc",
      ...
      isolatedSession: "Phiên riêng biệt",
