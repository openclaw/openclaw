...
export const zh_TW: TranslationMap = {
  ...
  channels: {
    health: {
      ...
      warnings: {
        noActiveConnection: "{channel} 正在執行，但未回報作用中的連線/回讀。",
        healthState: "{channel} 健康狀態為 {state}。",
        reports: "{channel} 回報：{error}",
        accountHealthState: "{account} 健康狀態為 {state}。",
        accountReports: "{account} 回報：{error}",
        accountReadback: "{account} 回讀狀態為 {state}。",
        accountReadbackWithError: "{account} 回讀狀態為 {state}：{error}。",
        accountMissingScopes: "{account} 缺少歷史/回讀權限範圍：{scopes}。",
        accountDisconnected: "{account} 正在執行但已中斷連線。",
        accountStaleActivity: "{account} 活動已過期。",
      },
    },
    generic: {
      subtitle: "頻道狀態與設定。",
    ...
    slack: {
      attention: {
        noSocketModeReadback: "Slack Socket Mode 正在執行，但未回報作用中的回讀連線。",
        healthState: "Slack 健康狀態為 {state}；傳入歷史/回讀可能已過期。",
        staleTransport: "Slack 傳輸活動已過期；請驗證 Socket Mode 和歷史權限範圍。",
        readbackWithError: "Slack 訊息回讀狀態為 {state}：{error}。",
        readbackMissingScopes: "Slack 訊息回讀狀態為 {state}；可能缺少歷史/回讀權限範圍。",
        missingScopes: "Slack 缺少歷史/回讀權限範圍：{scopes}。",
      },
    },
