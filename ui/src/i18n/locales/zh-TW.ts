...
export const zh_TW: TranslationMap = {
  ...
  agentTools: {
    connected: "已連線",
    connectedWithPlugin: "已連線：{value}",
    channel: "頻道",
    channelWithId: "頻道：{value}",
    builtIn: "內建",
    toolAccessTitle: "工具存取",
    toolAccessSubtitle: "此代理的設定檔 + 逐工具覆寫。已啟用 {enabled}/{total}。",
    enableAll: "全部啟用",
    disableAll: "全部停用",
    reloadConfig: "重新載入設定",
    save: "儲存",
    saving: "儲存中…",
    loading: "載入中…",
    removeAllowlistTitle: "移除逐代理 allowlist 並使用所有技能",
    filter: "篩選",
    searchSkillsPlaceholder: "搜尋技能",
    shownCount: "顯示 {count} 項",
    skillsTitle: "技能",
    skillsSubtitle: "逐代理技能 allowlist 與工作區技能。{enabled}/{total}",
    skillsSubtitleNoCount: "逐代理技能 allowlist 與工作區技能。",
    reset: "重設",
    loadConfigInfo: "載入網關設定以設定逐代理技能。",
    customAllowlistInfo: "此代理正在使用自訂技能 allowlist。",
    allSkillsInfo: "所有技能皆已啟用。停用任一技能都會建立逐代理 allowlist。",
    loadSkillsInfo: "載入此代理的技能以查看工作區專屬項目。",
    noSkillsFound: "找不到技能。",
    ready: "就緒",
    needsSetup: "需要設定",
  },
