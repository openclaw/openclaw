...
export const zh_TW: TranslationMap = {
  ...
  subtitles: {
    ...
    channels: "頻道和設定。",
    instances: "已連接客戶端和節點。",
    sessions: "活動工作階段和預設設定。",
    usage: "API 使用情況和成本。",
    cron: "喚醒和重複執行。",
    skills: "技能和 API 金鑰。",
    nodes: "配對裝置和命令。",
    chat: "Gateway 聊天，快速干預。",
    config: "編輯 openclaw.json。",
    communications: "頻道、訊息和音訊設定。",
    appearance: "主題、介面和設定精靈設定。",
    automation: "命令、鉤子、定時任務和插件設定。",
    infrastructure: "Gateway、Web、瀏覽器和媒體設定。",
    aiAgents: "代理、模型、技能、工具、記憶和工作階段設定。",
    debug: "快照、事件、RPC。",
    logs: "即時 Gateway 日誌。",
    dreams: "睡眠期間的記憶整合。",
  },
  overview: {
    ...
    stats: {
      ...
      sessions: "工作階段",
      sessionsHint: "Gateway 追蹤的最近工作階段金鑰。",
      cron: "Cron",
      cronNext: "下次喚醒 {time}",
    },
    notes: {
      title: "備註",
      subtitle: "遠程控制設定的快速提醒。",
      tailscaleTitle: "Tailscale serve",
      tailscaleText: "首選 serve 模式以通過 tailnet 身份驗證將 Gateway 保持在回環地址。",
      sessionTitle: "工作階段清理",
    ...
    auth: {
      required: "此 Gateway 需要身份驗證。新增令牌或密碼，然後點按連接。",
      failed: "身份驗證失敗。請使用 {command} 重新複製令牌化 URL，或更新令牌，然後點按連接。",
    },
    pairing: {
      hint: "此裝置需要 Gateway 主機的配對批准。",
    ...
    insecure: {
      hint: "此頁面為 HTTP，因此瀏覽器阻止裝置識別。請使用 HTTPS (Tailscale Serve) 或在 Gateway 主機上打開 {url}。",
      stayHttp: "如果您必須保持 HTTP，請設定 {config} (僅限令牌)。",
    },
    connection: {
      title: "如何連接",
  ...
  chat: {
    ...
    hideCronSessions: "隱藏定時任務工作階段",
    showCronSessions: "顯示定時任務工作階段",
    showCronSessionsHidden: "顯示定時任務工作階段 (已隱藏 {count} 個)",
