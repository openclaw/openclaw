...
export const zh_TW: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "搜尋 ClawHub",
    ...
    preparingSearch: "正在準備搜尋…",
    searchClawHubTitle: "搜尋 ClawHub",
    searchClawHubBody: "輸入至少兩個字元以尋找程式碼和套件外掛程式。",
    noClawHubResultsTitle: "找不到外掛程式",
