...
export const zh_TW: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "已配置的提供者，包含方案、配額與費用資訊。",
  ...
  modelProviders: {
    title: "已配置的提供者",
    subtitle: "包含身分驗證、方案、配額與費用資料的模型提供者。",
    updated: "已於 {time} 更新",
    refreshing: "正在重新整理…",
    disconnected: "連線到 Gateway 以檢視已配置的模型提供者。",
    emptyTitle: "未配置模型提供者",
    emptySubtitle: "登入提供者或新增 API 金鑰，然後重新整理。",
    status: {
      ok: "已連線",
      expiring: "即將過期",
      expired: "已過期",
    ...
    expiresIn: "憑證將於 {time} 過期",
    models: "{count} 個模型",
    modelOne: "1 個模型",
    modelsAvailable: "{count} 個模型中 {available} 個可用",
    noStats: "此提供者未回報即時使用資料。",
    localCost: "工作階段消耗 · {days}天",
    localCostDetail: "{tokens} 權杖 · {sessions} 個工作階段",
    saving: "正在儲存…",
    requestFailed: "要求失敗。",
