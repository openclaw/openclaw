...
export const zh_TW: TranslationMap = {
  ...
  githubPreview: {
    ...
    issue: "issue",
    ariaLabel: "{state} {kind} {repo} #{number}：{title}，由 {author} 提出",
  },
  channels: {
    refreshingStaleSnapshot: "正在後台重新整理頻道狀態；顯示上次成功的快照。",
    config: {
      schemaUnavailable: "無法取得結構描述。請使用 Raw。",
      channelSchemaUnavailable: "無法取得頻道設定結構描述。",
    ...
    whatsapp: {
      title: "WhatsApp",
      subtitle: "連結 WhatsApp Web 並監控連線狀態。",
    },
    ...
    nostr: {
      title: "Nostr",
      subtitle: "透過 Nostr 中繼站的去中心化私訊（NIP-04）。",
      profile: "個人資料",
      editProfile: "編輯個人資料",
  ...
  nodes: {
    ...
    inventory: {
      title: "裝置",
      subtitle: "每個已配對用戶端一列：狀態、角色、權杖。",
      cleanupStale: "清理 {count} 個過時項目",
      pendingApproval: "待核准",
      paired: "已配對",
      empty: "沒有已配對的裝置。",
      ...
      newPairing: "新裝置配對請求",
      repair: "修復",
      requestedAt: "{note} · 於 {time} 請求",
      requestedAccess: "已請求：{access}",
      approvedAccess: "目前已核准：{access}",
    },
    execApprovals: {
      title: "執行核准",
      ...
      hostNativeHint: "此處唯讀。請從隨附應用程式或 CLI 編輯。",
      native: "原生",
      defaultAction: "預設動作",
      rule: "{count} 條規則",
      rules: "{count} 條規則",
      ...
      on: "開啟",
      target: "目標",
      targetHint: "Gateway 編輯本機核准；節點編輯所選節點。",
      host: "主機",
      gateway: "Gateway",
      node: "節點",
      selectNode: "選擇節點",
      ...
      autoAllowSkillsHint: "允許 Gateway 列出的 Skill 可執行檔。",
      usingDefault: "使用預設值（{value}）。",
      override: "覆寫（{value}）。",
      enabled: "已啟用",
      useDefault: "使用預設值",
      allowlist: "允許清單",
      allowlistHint: "不區分大小寫的 glob 樣式。",
      addPattern: "新增樣式",
  ...
  agents: {
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "各代理程式的 Skills 允許清單與工作區 Skills。",
      loadConfig: "載入 gateway 設定以設定各代理程式的 Skills。",
      customAllowlist: "此代理程式使用自訂的 Skills 允許清單。",
      allEnabled: "所有 Skills 皆已啟用。停用任一 Skill 將建立各代理程式的允許清單。",
      loadAgent: "載入此代理程式的 Skills 以檢視工作區特定項目。",
      filter: "篩選",
  ...
  configForm: {
    ...
    structuredSecretRaw: "結構化值 (SecretRef) - 請使用 Raw 模式編輯",
    structuredSecretFile: "結構化值 (SecretRef) - 直接編輯設定檔",
    ...
    sections: {
      ...
      update: {
        label: "更新",
        description: "自動更新設定與發行頻道",
      },
      agents: {
        label: "代理程式",
        description: "代理程式設定、模型與身分",
      },
      auth: {
        label: "驗證",
      ...
      diagnostics: {
        label: "診斷",
        description: "檢測、OpenTelemetry 與 cache-trace 設定",
      },
      cli: {
        label: "CLI",
  ...
  quickSettings: {
    ...
    automation: {
      ...
      mcpServer: "{count} 個 MCP 伺服器",
      mcpServers: "{count} 個 MCP 伺服器",
      manage: "管理 →",
      browse: "瀏覽 →",
      configure: "設定 →",
    },
    ...
    personal: {
      ...
      clearAvatar: "清除頭像",
      clearOverride: "清除覆寫",
      browserOnly: "僅儲存於此瀏覽器。",
      overrideHint: "儲存 Control UI 覆寫。清除後即可回復為所設定的頭像。",
      uiOverride: "UI 覆寫",
      ...
      fallbackLogo: "備用標誌",
      avatarIssues: {
        remoteBlocked: "遠端 URL 已被 Control UI 圖片政策封鎖",
        missing: "找不到檔案",
        unsupported: "不支援的圖片類型",
        outsideWorkspace: "位於工作區之外",
        tooLarge: "圖片太大",
        cannotRender: "無法呈現頭像",
      },
    },
    pending: {
      title: "未儲存的變更",
      hint: "儲存會保存您的變更。立即套用也會重新載入目前的工作階段。",
      discard: "捨棄",
      applying: "套用中…",
      applyNow: "立即套用",
    },
  ...
  configView: {
    ...
    notifications: {
      ...
      subscribing: "訂閱中…",
      enable: "啟用通知",
      blockedHint: "通知已被封鎖。請更新瀏覽器的網站權限以允許通知。",
    },
    appearance: {
      theme: "主題",
      chooseTheme: "選擇主題系列。",
      ...
      importHint: "將 tweakcn 主題匯入到此瀏覽器本機的插槽中",
      importFromTweakcn: "從 tweakcn 匯入",
      tweakcnInstructions:
        "開啟 tweakcn.com，選擇或建立主題，點擊 Share，然後將複製的主題連結貼在此處。可接受分享連結、編輯器網址、registry 網址、主題 ID，以及像 amethyst-haze 這類的預設主題名稱。",
      ...
      inlineHintBefore: "點擊",
      inlineHintAfter:
        "以新增一個瀏覽器本機的 tweakcn 主題。在 tweakcn 中，使用 Share 並將複製的連結貼在此處。",
      textSize: "文字大小",
    },
    connection: {
      title: "連線",
    ...
    form: "表單",
    raw: "原始",
    formUnsafeTitle: "表單檢視無法安全編輯部分欄位",
    rawTitle: "編輯原始 JSON/JSON5 設定",
    rawUnavailableTitle: "此快照無法使用原始模式",
    unsavedChange: "{count} 項未儲存變更",
    unsavedChanges: "{count} 項未儲存變更",
    noChanges: "沒有變更",
    rawDisabled: "原始模式已停用（快照無法安全來回轉換原始文字）。",
    open: "開啟",
    clear: "清除",
    apply: "套用",
    applying: "套用中…",
    ...
    rawDiffUnavailable: "偵測到變更（無法提供 JSON diff）",
    hideEnvValues: "隱藏環境變數值",
    revealEnvValues: "顯示環境變數值",
    peek: "預覽",
    loadingSchema: "正在載入結構描述…",
    formUnsafe: "您的設定包含表單編輯器無法安全表示的欄位。請使用 Raw 模式編輯這些項目。",
    rawConfig: "原始設定 (JSON/JSON5)",
    secretCount: "{count} 個密鑰",
    secretCountPlural: "{count} 個密鑰",
    redacted: "已遮蔽",
    visible: "可見",
    revealSensitive: "顯示敏感值",
    hideSensitive: "隱藏敏感值",
    toggleRawRedaction: "切換原始設定遮蔽",
    sensitiveHidden: "已隱藏 {count} 個敏感值。請使用上方的顯示按鈕來編輯原始設定。",
    sensitiveHiddenPlural: "已隱藏 {count} 個敏感值。請使用上方的顯示按鈕來編輯原始設定。",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    optional: "選用",
    liveNow: "目前上線",
    disabledByOverride: "已由代理覆寫停用。",
    enabledByProfile: "已由目前設定檔啟用。",
    enabledByOverride: "已由代理覆寫啟用。",
    notIncluded: "未包含於目前設定檔中。",
    overrideOff: "覆寫關閉",
    enabled: "已啟用",
    overrideOn: "覆寫開啟",
    profileOff: "設定檔關閉",
    ...
    availableNow: "目前可用",
    availableNowSubtitle: "此代理在目前聊天工作階段中可使用的內容。",
    noSession: "無工作階段",
    switchAgent: "將聊天切換至此代理以檢視其即時執行階段工具。",
    ...
    unavailableSession: "目前無法在此聊天工作階段中使用。",
    inspectAgent: "將對話切換至此代理程式以檢查即時可用性。",
    linkTool: "連結至此工具",
  },
  skillGroups: {
  ...
  skillsPage: {
    ...
    empty: "找不到 skills。",
    noClawHubResults: "在 ClawHub 上找不到 Skills。",
    install: "安裝",
    installing: "安裝中…",
    close: "關閉",
    by: "作者",
  ...
  skillStatus: {
    ...
    blocked: "已封鎖",
    disabled: "已停用",
    blockedAllowlist: "已被允許清單封鎖",
    blockedAgentFilter: "已被代理程式篩選器封鎖",
  },
  nav: {
    chat: "聊天",
    settings: "設置",
  ...
  mcpPage: {
    ...
    runtimeHint:
      "執行階段變更會在儲存並發布後套用；使用中的代理程式會在下次使用時重建 MCP 執行階段。",
    toolFilter: "工具篩選器",
    parallel: "並行",
    missingTransport: "缺少傳輸",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      notion: "在你的 Notion 工作區中搜尋、建立及更新頁面與資料庫。",
      linear: "直接從聊天中分類議題、更新週期並回報錯誤。",
      todoist: "在 Todoist 中讀取、新增及完成任務與專案。",
      airtable: "在 Airtable 中查詢及更新記錄、資料表與資料庫。",
      jira: "從聊天中建立、搜尋及分類 Jira 工單。",
      canva: "建立及編輯 Canva 設計、管理素材並匯出結果。",
      stripe: "在你的 Stripe 帳戶中查看付款、客戶、發票與訂閱。",
      googleCalendar: "讀取、建立並掌握活動摘要——讓你的代理掌管你的行程。",
      email: "信箱分類、摘要及草稿，並可核准後寄出。",
      pdf: "擷取、合併、轉換及 OCR PDF 文件。",
      transcription: "將音訊與影片轉換為乾淨且結構化的逐字稿。",
      github: "透過官方 GitHub MCP 進行 PR 審查佇列、議題分類及儲存庫問答。",
      sentry: "在當機警示觸發的瞬間即獲得解釋與分類。",
      context7: "編寫程式碼時提供特定版本的函式庫文件與程式碼範例。無需註冊。",
      deepwiki: "詢問任何公開 GitHub 儲存庫的相關問題。免費，無需帳號。",
      huggingFace: "搜尋模型、資料集與論文；將 Spaces 作為工具執行。",
      grafana: "提供 Grafana 專業知識與社群連接器，用於儀表板與警示。",
      kubernetes: "透過聊天進行叢集操作與疑難排解。",
      homeAssistant: "控制全家的燈光、空調與自動化。",
      spotify: "搜尋、排入佇列，並以情境播放清單為你的一天配樂。",
      sonos: "全家音訊：透過聊天播放、群組房間與排入佇列。",
      reddit: "瀏覽、搜尋並摘要 subreddit 與討論串。",
      markets: "即時股票與加密貨幣，附價格警示與每日摘要。",
      travel: "航班與飯店搜尋，附票價追蹤與行程記憶。",
      news: "個人化每日簡報：新聞、天氣與待辦事項匯整於一則訊息。",
      maps: "地點、路線與行車時間解答。",
      translation: "翻譯與在地化文字與文件。",
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "{verb}提案",
      description: "告訴代理應該變更什麼。提案將維持待處理狀態，工作坊會建立修訂後的版本。",
      placeholder: "範例：讓這個改用 Gmail 標籤而非未讀搜尋，並加入更安全的 dry-run 步驟。",
      preparing: "正在準備修訂交接",
      send: "傳送修訂",
    },
    queue: {
    ...
    detail: {
      ...
      clickToPreview: "· 點擊以預覽",
    },
    empty: {
      searchTitle: "沒有符合的提案",
      searchBody: "清除搜尋或嘗試其他關鍵字。",
      pendingTitle: "沒有待處理的提案",
      pendingBody: "新草稿需要審查時會顯示在此。",
      appliedTitle: "尚未套用任何項目",
      appliedBody: "使用待處理的提案，它就會以即時 Skill 的形式出現在此。",
      rejectedTitle: "沒有遭拒的提案",
      rejectedBody: "已略過的提案會保留在此，方便您維持清晰的審查紀錄。",
      quarantinedTitle: "沒有已隔離項目",
      quarantinedBody: "被掃描器封鎖或因安全考量保留的提案會顯示在此。",
      staleTitle: "沒有過期提案",
      staleBody: "無法再順利套用的提案會顯示在此。",
      allTitle: "此處沒有提案",
      allBody: "當您的代理程式草擬提案時，Skill Workshop 提案會顯示在此。",
      defaultAgent: "您的代理程式",
      noProposalsAria: "沒有 Skill Workshop 提案",
      noProposalsTitle: "尚無提案",
      noProposalsBody: "{agent} 尚未草擬任何 Skill 提案。",
      noProposalsFooter: "新提案會顯示在此供您審查。",
    },
    today: {
      emptyTitle: "今天沒有待處理項目",
      emptyBody: "您的代理程式尚未草擬任何新內容。切換至 Board 以瀏覽歷史紀錄。",
      new: "新增",
      waiting: "等待中",
      reviewed: "已審查",
      agent: "代理程式",
      proposalsWaiting: "{count} 個提案等待中",
      browseApplied: "瀏覽已套用的內容。",
      ...
      applicabilityHeading: "代理何時應該使用它",
    },
    relative: {
      secondsAgo: "{count} 秒前",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      insightsExplainer:
        "這些是從外部歷史中彙集的匯入洞察；用它們來檢視匯入所呈現的內容，然後其中任何一項才會升級為持久記憶。",
      palaceExplainer:
        "這是系統可以搜尋和推理的已編譯記憶 wiki 介面；使用它來檢查實際的記憶頁面、主張、未解問題和矛盾，而非原始匯入的來源對話。",
      copyArchivePath: "複製封存路徑",
      loadingInsights: "正在載入匯入的洞察…",
      noInsights: "尚無匯入的洞察",
      noInsightsHint: "執行帶有套用的 ChatGPT 匯入，以在此處顯示聚集的匯入洞察。",
      candidateSignals: "可能有用的訊號",
      corrections: "更正或修訂",
      importDetails: "匯入詳細資料",
      startedWith: "開始於：",
      endedOn: "結束於：",
      messages: "訊息：",
      riskReasons: "風險原因：",
      ...
      emptyPalaceHint:
        "目前 wiki 大多只有原始來源匯入和操作報告。當開始寫入綜合、實體或概念時，此分頁就會變得有用。",
      claims: "主張",
      openQuestions: "未解問題",
      contradictions: "矛盾",
      pageDetails: "頁面詳細資料",
      ...
      unavailable: "Memory Wiki 未啟用",
      unavailablePluginPrefix: "Imported Insights 與 Memory Palace 由隨附的",
  ...
  chat: {
    ...
    compaction: {
      label: "已壓縮的歷史記錄",
      description: "壓縮後的對話記錄會保留為檢查點。開啟工作階段檢查點以從該壓縮檢視分支或還原。",
    ...
    commands: {
      ...
      showMoreOne: "顯示另外 1 個指令",
      showMoreMany: "顯示另外 {count} 個指令",
      navigate: "導覽",
      fill: "填入",
      run: "執行",
      select: "選取",
    ...
    detailPanel: {
      ...
      overwrite: "覆寫",
      viewRawText: "檢視原始文字",
      renderedMarkdown: "已算繪的 Markdown",
      renderedMarkdownHint: "經淨化的豐富文字預覽，方便快速閱讀。",
    ...
    composer: {
      ...
      cancelReply: "取消回覆",
      compactRecommendedContext: "精簡建議的工作階段上下文",
  ...
  cron: {
    ...
    form: {
      ...
      repeatCron: "Cron 運算式",
      repeatOnExit: "退出時",
      onExitHelp: "當受監控的命令退出時執行。此處無法編輯排程。",
      every: "每",
      at: "於",
      cronOption: "Cron",
      runAt: "執行時間",
      ...
      lightContext: "輕量上下文",
      lightContextHelp: "為此代理任務使用輕量啟動上下文。",
      model: "模型",
