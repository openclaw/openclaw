...
export const fr: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Décrivez ce qu’OpenClaw doit faire et quand — l’exécution suivra la planification.",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "En semaine à 9:00",
        everyMorning: "Tous les jours à 8:00",
        weekly: "Le lundi à 9:00",
    ...
    form: {
      ...
      startEnabled: "Activer au démarrage",
