...
export const fr: TranslationMap = {
  ...
  settings: {
    ...
    formViewUnsafeTooltip:
      "La vue formulaire ne peut pas modifier certains champs en toute sécurité",
    rawModeTooltip: "Modifier la configuration JSON/JSON5 brute",
    rawModeUnavailable: "Mode brut indisponible pour cet instantané",
    rawModeDisabledNotice:
      "Mode brut désactivé (l'instantané ne peut pas préserver le texte brut en toute sécurité).",
    unsavedChanges: "Modifications non enregistrées",
    unsavedChangeCount: "{count} modification non enregistrée",
    unsavedChangesCount: "{count} modifications non enregistrées",
