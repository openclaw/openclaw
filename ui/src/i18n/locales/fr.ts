...
export const fr: TranslationMap = {
  ...
  question: {
    title: "L'agent a une question",
    recommended: "Recommandé",
    otherLabel: "Autre…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Saisissez votre réponse",
    secretWarning: "Votre réponse peut être visible par les autres participants de ce canal.",
    submit: "Envoyer",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Mode plan",
      goal: "Mode objectif",
      switchConfirm: "Changer de mode ? Cela arrête le mode actuel.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Afficher",
    approveTitle: "Mettre en œuvre ce plan ?",
    approveCta: "Approuver",
    revise: "Réviser avec des commentaires",
    reviseSubmit: "Envoyer les commentaires",
