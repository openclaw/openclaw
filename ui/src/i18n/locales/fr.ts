...
export const fr: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Rechercher dans ClawHub",
    ...
    searchClawHubTitle: "Rechercher dans ClawHub",
    searchClawHubBody:
      "Saisissez au moins deux caractères pour trouver du code et des plugins groupés.",
    noClawHubResultsTitle: "Aucun plugin trouvé",
