...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Fournisseurs configurés avec forfait, quota et coût.",
    memoryImport:
  ...
  modelProviders: {
    ...
    subtitle: "Fournisseurs de modèles avec authentification, forfait, quota et données de coût.",
    updated: "Mis à jour {time}",
    refreshing: "Actualisation…",
    disconnected:
      "Connectez-vous à la passerelle pour voir les fournisseurs de modèles configurés.",
    emptyTitle: "Aucun fournisseur de modèles configuré",
    emptySubtitle: "Connectez-vous à un fournisseur ou ajoutez une clé API, puis actualisez.",
    status: {
      ok: "Connecté",
      expiring: "Expire bientôt",
      expired: "Expiré",
      missing: "Non connecté",
      apiKey: "Clé API",
    },
    expiresIn: "Les informations d'identification expirent dans {time}",
    models: "{count} modèles",
    modelOne: "1 modèle",
    modelsAvailable: "{available} sur {count} modèles disponibles",
    noStats: "Aucune donnée d'utilisation en direct rapportée par ce fournisseur.",
    localCost: "Dépenses de session · {days} j",
    localCostDetail: "{tokens} jetons · {sessions} sessions",
    saving: "Enregistrement…",
