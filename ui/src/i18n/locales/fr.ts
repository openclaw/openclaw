...
export const fr: TranslationMap = {
  ...
  filePreview: {
    ...
    emptySubtitle: "Essayez un autre nom de fichier ou une autre recherche de contenu.",
  ...
  channels: {
    refreshingStaleSnapshot:
      "Actualisation de l'état du canal en arrière-plan ; affichage du dernier instantané réussi.",
    config: {
      schemaUnavailable: "Schéma indisponible. Utilisez le mode Raw.",
    ...
    discord: {
      title: "Discord",
      subtitle: "État du bot et configuration du canal.",
    },
    googleChat: {
      title: "Google Chat",
      subtitle: "État du webhook de l'API Chat et configuration du canal.",
    },
    imessage: {
      title: "iMessage",
      subtitle: "État du pont macOS et configuration du canal.",
    },
    signal: {
      title: "Signal",
      subtitle: "État de signal-cli et configuration du canal.",
    },
    slack: {
      title: "Slack",
      subtitle: "État du mode Socket et configuration du canal.",
    },
    telegram: {
      title: "Telegram",
      subtitle: "État du bot et configuration du canal.",
  ...
  nodes: {
    ...
    execApprovals: {
      ...
      hostNativeHint: "En lecture seule ici. Modifiez depuis l'application compagnon ou la CLI.",
      native: "Native",
      ...
      promptUnavailable: "Appliqué lorsque l'invite de l'interface n'est pas disponible.",
      fallback: "Repli",
      autoAllowSkills: "Autoriser automatiquement les CLI de Skills",
      autoAllowSkillsHint: "Autoriser les exécutables de Skills listés par le Gateway.",
  ...
  agents: {
    ...
    overview: {
      ...
      subtitle: "Chemins de l'espace de travail et métadonnées d'identité.",
      selectedSkills: "{count} sélectionné(s)",
      ...
      inheritDefaultModel: "Hériter par défaut ({model})",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Liste d'autorisation des Skills par agent et Skills du workspace.",
      ...
      loadAgent:
        "Chargez les Skills de cet agent pour afficher les entrées spécifiques au workspace.",
      filter: "Filtrer",
  ...
  configForm: {
    ...
    sections: {
      env: {
        ...
        description: "Variables d'environnement transmises au processus Gateway",
      },
      update: {
        label: "Mises à jour",
      ...
      messages: {
        label: "Messages",
        description: "Paramètres de gestion et de routage des messages",
      },
      commands: {
        label: "Commandes",
      ...
      tools: {
        label: "Outils",
        description: "Configurations des outils (navigateur, recherche, etc.)",
      },
      gateway: {
        label: "Gateway",
      ...
      meta: {
        label: "Métadonnées",
        description: "Métadonnées et informations de version du Gateway",
      },
      logging: {
      ...
      bindings: {
        label: "Raccourcis",
        description: "Raccourcis clavier et affectations de touches",
      },
      broadcast: {
        label: "Diffusion",
      ...
      acp: {
        label: "ACP",
        description:
          "Paramètres d'exécution et de streaming du protocole Agent Communication Protocol",
      },
      mcp: {
        label: "MCP",
        description: "Définitions de serveur du protocole Model Context Protocol",
      },
    },
  },
  quickSettings: {
    ...
    system: {
      ...
      load: "charge",
      used: "utilisé",
      freeOf: "{free} disponibles sur {total}",
    ...
    personal: {
      ...
      avatarText: "Texte / emoji de l'avatar",
      ...
      overrideHint:
        "Stocke un remplacement Control UI. Effacez-le pour revenir à l'avatar configuré.",
      uiOverride: "Remplacement de l'UI",
      ...
      avatarIssues: {
        remoteBlocked: "Les URL distantes sont bloquées par la politique d'images du Control UI",
    ...
    pending: {
      ...
      hint: "Enregistrer conserve vos modifications. Appliquer maintenant recharge aussi la session en cours.",
      discard: "Abandonner",
  ...
  configView: {
    ...
    notifications: {
      ...
      blockedHint:
        "Les notifications sont bloquées. Modifiez les autorisations du site dans votre navigateur pour autoriser les notifications.",
    },
    appearance: {
      theme: "Thème",
      ...
      tweakcnInstructions:
        "Ouvrez tweakcn.com, choisissez ou créez un thème, cliquez sur Partager, puis collez le lien du thème copié ici. Les liens de partage, URL de l'éditeur, URL de registre, ID de thème et noms de thèmes par défaut comme amethyst-haze sont acceptés.",
      browseTweakcn: "Parcourir les thèmes tweakcn",
      themeLink: "Lien ou ID du thème",
      replace: "Remplacer {name}",
      importTheme: "Importer le thème",
      clear: "Effacer {name}",
      loaded: "Chargé",
      inlineHintBefore: "Cliquez sur",
      inlineHintAfter:
        "pour ajouter un thème tweakcn local au navigateur. Dans tweakcn, utilisez Partager et collez le lien copié ici.",
      textSize: "Taille du texte",
    },
    connection: {
      title: "Connexion",
    ...
    viewPendingChange: "Voir {count} modification en attente",
    viewPendingChanges: "Voir {count} modifications en attente",
    viewPendingChangesRaw: "Voir les modifications en attente",
    rawDiffUnavailable: "Modifications détectées (diff JSON non disponible)",
    hideEnvValues: "Masquer les valeurs env",
    revealEnvValues: "Afficher les valeurs env",
    peek: "Aperçu",
    loadingSchema: "Chargement du schéma…",
    formUnsafe:
      "Votre config contient des champs que l'éditeur de formulaire ne peut pas représenter en toute sécurité. Utilisez le mode Raw pour modifier ces entrées.",
    rawConfig: "Config brute (JSON/JSON5)",
    ...
    toggleRawRedaction: "Basculer le masquage de la config brute",
    sensitiveHidden:
      "{count} valeur sensible masquée. Utilisez le bouton d'affichage ci-dessus pour modifier la config brute.",
    sensitiveHiddenPlural:
      "{count} valeurs sensibles masquées. Utilisez le bouton d'affichage ci-dessus pour modifier la config brute.",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    disabledByOverride: "Désactivé par le remplacement de l'agent.",
    enabledByProfile: "Activé par le profil actuel.",
    enabledByOverride: "Activé par le remplacement de l'agent.",
    notIncluded: "Non inclus dans le profil actuel.",
    overrideOff: "Remplacement désactivé",
    enabled: "Activé",
    overrideOn: "Remplacement activé",
    profileOff: "Profil désactivé",
    notLive: "Non actif",
    otherAgent: "Autre agent",
    title: "Accès aux outils",
    subtitle: "Profil + remplacements par outil pour cet agent.",
    ...
    explicitAllowlist:
      "Cet agent utilise une liste d'autorisation explicite dans la configuration. Les remplacements d'outils sont gérés dans l'onglet Config.",
    globalAllowlist:
      "tools.allow global est défini. Les remplacements d'agent ne peuvent pas activer des outils bloqués globalement.",
    loadingCatalog: "Chargement du catalogue d'outils d'exécution…",
    catalogFallback:
      "Impossible de charger le catalogue d'outils d'exécution. Affichage de la liste de secours intégrée à la place.",
    availableNow: "Disponible dès maintenant",
    availableNowSubtitle: "Ce que cet agent peut utiliser dans la session de chat actuelle.",
    noSession: "aucune session",
    switchAgent: "Basculez le chat vers cet agent pour voir ses outils d'exécution en direct.",
    ...
    noAvailable: "Aucun outil n'est disponible pour cette session actuellement.",
    moreLiveTitle:
    ...
    live: "En direct",
    status: "Statut",
    profileSourceAgent: "remplacement d'agent",
    ...
    unavailableSession: "Non disponible dans cette session de discussion pour le moment.",
    inspectAgent:
      "Basculez la discussion vers cet agent pour inspecter la disponibilité en direct.",
    linkTool: "Lier à cet outil",
  },
  skillGroups: {
    workspace: "Skills d'espace de travail",
  ...
  mcpPage: {
    ...
    operatorCommands: "Commandes d'opérateur MCP",
    operatorCommandsHint:
      "Statut, diagnostics, authentification, sondage et rechargement à l'exécution.",
    runtimeHint:
      "Les changements d'exécution s'appliquent après l'enregistrement et la publication ; les agents actifs reconstruisent les environnements d'exécution MCP lors de leur prochaine utilisation.",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      notion:
        "Recherchez, créez et mettez à jour des pages et des bases de données dans votre espace de travail Notion.",
      linear:
        "Triez les tickets, mettez à jour les cycles et signalez des bugs directement depuis le chat.",
      todoist: "Lisez, ajoutez et terminez des tâches et projets dans Todoist.",
      airtable:
        "Interrogez et mettez à jour des enregistrements, des tables et des bases dans Airtable.",
      ...
      stripe: "Consultez les paiements, clients, factures et abonnements dans votre compte Stripe.",
      googleCalendar:
        "Lisez, créez et recevez des résumés d'événements — votre agent gère votre agenda.",
      email: "Triage de boîte mail, résumés et brouillons avec envoi sur approbation.",
      pdf: "Extraire, fusionner, convertir et appliquer l'OCR à des documents PDF.",
      transcription: "Transformez l'audio et la vidéo en transcriptions claires et structurées.",
      github:
        "Files d'attente de revue de PR, tri des tickets et questions-réponses sur les dépôts via le MCP officiel de GitHub.",
      sentry: "Alertes de plantage expliquées et triées dès qu'elles se déclenchent.",
      context7:
        "Documentation de bibliothèques et exemples de code adaptés à chaque version pendant que vous codez. Aucune inscription requise.",
      deepwiki: "Posez des questions sur n'importe quel dépôt GitHub public. Gratuit, sans compte.",
      huggingFace:
        "Recherchez des modèles, des jeux de données et des articles ; exécutez des Spaces en tant qu'outils.",
      grafana:
        "Expertise Grafana et connecteurs communautaires pour les tableaux de bord et les alertes.",
      kubernetes: "Opérations et dépannage de cluster depuis le chat.",
      homeAssistant:
        "Contrôlez l'éclairage, le climat et les automatisations dans toute votre maison.",
      spotify:
        "Recherchez, mettez en file d'attente et rythmez votre journée avec des playlists selon votre humeur.",
      sonos: "Audio multipièce : lisez, regroupez les pièces et mettez en file d'attente par chat.",
      reddit: "Parcourez, recherchez et résumez des subreddits et des fils de discussion.",
      markets: "Actions et cryptomonnaies en direct avec alertes de prix et résumés quotidiens.",
      ...
      maps: "Lieux, itinéraires et estimations de temps de trajet.",
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "Proposition {verb}",
      description:
        "Indiquez à l'agent ce qui doit changer. La proposition reste en attente et le workshop créera une version révisée.",
      placeholder:
        "Exemple : Utilisez les libellés Gmail au lieu de la recherche des non-lus, et ajoutez une étape de simulation plus sûre.",
    ...
    detail: {
      ...
      clickToPreview: "· cliquez pour prévisualiser",
    },
    empty: {
      ...
      pendingBody: "Les nouveaux brouillons apparaîtront ici lorsqu'ils devront être examinés.",
      appliedTitle: "Rien d'appliqué pour l'instant",
      appliedBody:
        "Utilisez une proposition en attente et elle apparaîtra ici en tant que skill actif.",
      rejectedTitle: "Aucune proposition rejetée",
      rejectedBody:
        "Les propositions ignorées resteront ici pour conserver un historique d'examen clair.",
      ...
      staleBody:
        "Les propositions qui ne peuvent plus être appliquées proprement apparaîtront ici.",
      allTitle: "Aucune proposition ici",
      allBody: "Les propositions Skill Workshop apparaîtront ici lorsque votre agent les rédigera.",
      defaultAgent: "Votre agent",
      noProposalsAria: "Aucune proposition Skill Workshop",
      noProposalsTitle: "Aucune proposition pour l'instant",
      noProposalsBody: "{agent} n'a rédigé aucune proposition de skill.",
      noProposalsFooter: "Les nouvelles propositions apparaîtront ici pour examen.",
    },
    today: {
      emptyTitle: "Rien en attente aujourd'hui",
      emptyBody:
        "Votre agent n'a rien rédigé de nouveau. Passez au Board pour parcourir l'historique.",
      new: "NOUVEAU",
      waiting: "EN ATTENTE",
      reviewed: "VÉRIFIÉ",
      agent: "agent",
      ...
      supportFile: "{count} fichier associé",
      supportFiles: "{count} fichiers associés",
      comeWithIt: "sont fournis avec.",
      useIt: "Utiliser",
      addToSkills: "Ajouter à vos Skills",
      tweakIt: "Ajuster",
      askAgent: "Demander à l'agent de changer quelque chose",
      skipping: "Ignorer…",
      skip: "Ignorer",
      notForMe: "Pas pour moi",
      upNext: "À suivre · {count} de plus en attente",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      dreamsTab: "Rêves",
      insightsTab: "Aperçus importés",
      palaceTab: "Palais de la mémoire",
      dreamsExplainer:
        "Il s'agit du journal de rêves brut que le système écrit pendant qu'il rejoue et consolide la mémoire ; utilisez-le pour examiner ce que le système de mémoire remarque et où il paraît encore bruité ou clairsemé.",
      insightsExplainer:
        "Ce sont des aperçus importés regroupés à partir d'un historique externe ; utilisez-les pour examiner ce que les imports ont fait ressortir avant que quoi que ce soit ne passe en mémoire durable.",
      palaceExplainer:
        "Il s'agit de la surface compilée du wiki de mémoire que le système peut rechercher et analyser ; utilisez-la pour inspecter les véritables pages de mémoire, affirmations, questions ouvertes et contradictions plutôt que les discussions sources importées brutes.",
      copyArchivePath: "Copier le chemin de l'archive",
      loadingInsights: "Chargement des aperçus importés…",
      noInsights: "Aucun aperçu importé pour l'instant",
      noInsightsHint:
        "Lancez un import ChatGPT avec application pour faire apparaître ici des aperçus importés regroupés.",
      ...
      unavailable: "Le Memory Wiki n'est pas activé",
  ...
  chat: {
    ...
    compaction: {
      ...
      description:
        "La transcription compactée est conservée comme point de contrôle. Ouvrez les points de contrôle de session pour créer une branche ou restaurer à partir de cette vue compactée.",
    ...
    commands: {
      ...
      select: "sélectionner",
      close: "fermer",
      clearDescription: "Effacer l'historique de discussion",
      redirectDescription: "Abandonner et redémarrer avec un nouveau message",
    ...
    queue: {
      ...
      removeQueuedMessage: "Retirer le message en file d'attente",
    },
    goals: {
    ...
    sideChat: {
      ...
      followUp: "Relancer…",
      followUpLabel: "Suivre dans le chat latéral",
    ...
    detailPanel: {
      ...
      renderedMarkdownHint: "Aperçu en texte enrichi et nettoyé pour une lecture rapide.",
      noPreviewableMarkdown: "Aucun contenu Markdown prévisualisable.",
    ...
    composer: {
      ...
      runStatus: "État de l'exécution : {status}",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Décrivez ce qu'OpenClaw doit faire et quand — il s'exécute selon la planification.",
    ...
    form: {
      ...
      sessionKeyHelp:
        "Clé de routage facultative pour la livraison des tâches et le routage de réveil.",
      ...
      accountIdHelp: "ID de compte de canal facultatif pour les configurations multicomptes.",
      lightContext: "Contexte léger",
      lightContextHelp: "Utiliser un contexte d'amorçage léger pour cette tâche d'agent.",
      model: "Modèle",
      ...
      failureAlertsHelp: "Contrôlez quand cette tâche envoie des alertes d'échecs répétés.",
      ...
      failureAlertCooldownHelp: "Nombre minimum de secondes entre les alertes.",
      failureAlertChannel: "Canal d'alerte",
      failureAlertTo: "Alerter à",
