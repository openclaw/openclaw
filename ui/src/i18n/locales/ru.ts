    ...
    suggestions: {
      ...
      ideas: {
        repoPulse: {
          ...
          tagline: "Ночные проблемы, PR и сбои CI, ранжированные по срочности.",
          prompt:
            "Проверь ночную активность в моих репозиториях: новые проблемы, pull request и сбои CI. Кратко опиши три пункта, которые сегодня больше всего требуют моего внимания, добавив к каждому ссылку и причину в одну строку.",
        },
        standupGhostwriter: {
          name: "Автор стендапов",
          tagline: "Черновик отчёта для стендапа на основе вчерашней работы.",
          prompt:
            "Подготовь черновик моего отчёта для стендапа на основе вчерашних коммитов, объединённых pull request и открытых обсуждений ревью. Не более трёх пунктов: сделано, в работе, заблокировано.",
        },
        hackerNewsScout: {
          name: "Разведчик Hacker News",
          tagline: "Три ссылки к утреннему кофе с краткими мнениями.",
          prompt:
            "Просмотри сегодняшнюю главную страницу Hacker News и найди публикации об ИИ-агентах, инструментах для разработчиков и TypeScript. Пришли мне три самые интересные ссылки, добавив к каждой краткое мнение в одну строку.",
        },
        dependencyRadar: {
          name: "Радар зависимостей",
          tagline: "Устаревшие или уязвимые зависимости с примечаниями по обновлению.",
          prompt:
            "Проверь мой основной проект на наличие устаревших или уязвимых зависимостей. Перечисли важные обновления, добавив к каждому примечание о риске в одну строку, и подготовь команду обновления.",
        },
        watchdog: {
          name: "Ночной дозор",
          tagline: "Ежечасная проверка состояния с вердиктом в одну строку.",
          prompt:
            "Проверь работоспособность моих сервисов и Gateway: просмотри недавние журналы на наличие новых ошибок, перезапусков или необычной нагрузки. Если всё в порядке, ответь одной короткой строкой, что всё работает; если что-то сломано, сообщи, что именно не работает и где начать искать причину.",
        },
        polyglotMinute: {
          name: "Минута полиглота",
          tagline: "Одна полезная иностранная фраза к утреннему кофе.",
          prompt:
            "Научи меня одной полезной фразе на японском: укажи фразу, её произношение, буквальное значение и когда её использовать. Ответ должен занимать не более пяти строк.",
        },
      },
    },
    stats: {
