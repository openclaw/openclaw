...
export const ru: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Поиск в ClawHub",
    ...
    searchClawHubTitle: "Поиск в ClawHub",
    searchClawHubBody: "Введите не менее двух символов, чтобы найти код и пакеты плагинов.",
    noClawHubResultsTitle: "Плагины не найдены",
    ...
    statEnabled: "Включено",
    statIssues: "Требует внимания",
    statMcpServers: "MCP-серверы",
