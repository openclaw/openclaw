...
export const ru: TranslationMap = {
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Режим плана",
      goal: "Режим цели",
      switchConfirm: "Сменить режим? Это остановит текущий режим.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Просмотреть",
    approveTitle: "Реализовать этот план?",
    approveCta: "Одобрить",
    revise: "Изменить с учётом отзыва",
    reviseSubmit: "Отправить отзыв",
    revisePlaceholder: "Что нужно изменить?",
    cancel: "Отмена",
