...
export const ru: TranslationMap = {
  ...
  settings: {
    modeForm: "Форма",
    modeRaw: "Исходный",
    formViewUnsafeTooltip: "В режиме формы некоторые поля нельзя безопасно изменить",
    rawModeTooltip: "Редактировать исходную конфигурацию JSON/JSON5",
    rawModeUnavailable: "Исходный режим недоступен для этого снимка",
    rawModeDisabledNotice:
      "Исходный режим отключён (снимок не может безопасно сохранить исходный текст).",
    unsavedChanges: "Несохранённые изменения",
    unsavedChangeCount: "{count} несохранённое изменение",
    unsavedChangesCount: "{count} несохранённых изменений",
