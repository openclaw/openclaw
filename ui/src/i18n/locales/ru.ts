...
export const ru: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Опишите, что и когда должен сделать OpenClaw — задача будет выполнена по расписанию.",
    ...
    detail: {
      ...
      newSubtitle: "Опишите, что должен сделать OpenClaw, а затем выберите время выполнения.",
    ...
    form: {
      ...
      repeatOnExit: "При завершении",
      onExitHelp:
        "Запускается при завершении отслеживаемой команды. Расписание нельзя изменить здесь.",
      every: "Каждые",
      at: "В",
      cronOption: "Cron",
      runAt: "Запуск в",
      ...
      startEnabled: "Включить при создании",
