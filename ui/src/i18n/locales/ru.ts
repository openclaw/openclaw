...
export const ru: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Настроенные поставщики с тарифом, квотой и стоимостью.",
  ...
  modelProviders: {
    title: "Настроенные поставщики",
    subtitle: "Поставщики моделей с аутентификацией, тарифом, квотой и данными о затратах.",
    updated: "Обновлено {time}",
    refreshing: "Обновление…",
    disconnected: "Подключитесь к шлюзу, чтобы увидеть настроенных поставщиков моделей.",
    emptyTitle: "Поставщики моделей не настроены",
    emptySubtitle: "Войдите в систему поставщика или добавьте ключ API, затем обновите.",
    status: {
      ok: "Подключено",
      expiring: "Истекает",
      expired: "Истек",
      missing: "Не выполнен вход",
      apiKey: "Ключ API",
    },
    expiresIn: "Срок действия учетных данных истекает через {time}",
    models: "{count} моделей",
    modelOne: "1 модель",
    modelsAvailable: "{available} из {count} моделей доступно",
    noStats: "Этот поставщик не сообщил данные об использовании в реальном времени.",
    localCost: "Расходы за сессию · {days} дн.",
    localCostDetail: "{tokens} токенов · {sessions} сессий",
    saving: "Сохранение…",
