...
export const fa: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "جستجوی ClawHub",
    ...
    preparingSearch: "در حال آماده‌سازی جستجو…",
    searchClawHubTitle: "جستجوی ClawHub",
    searchClawHubBody: "برای یافتن افزونه‌های کد و بسته، حداقل دو نویسه وارد کنید.",
    noClawHubResultsTitle: "افزونه‌ای یافت نشد",
    ...
    statInstalled: "نصب‌شده",
    statEnabled: "فعال",
    statIssues: "نیازمند توجه",
    statMcpServers: "سرورهای MCP",
