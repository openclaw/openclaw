...
export const fa: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "ارائه‌دهندگان پیکربندی‌شده با طرح، سهمیه و هزینه.",
  ...
  modelProviders: {
    title: "ارائه‌دهندگان پیکربندی‌شده",
    subtitle: "ارائه‌دهندگان مدل با احراز هویت، طرح، سهمیه و داده‌های هزینه.",
    updated: "به‌روزرسانی‌شده {time}",
    refreshing: "در حال بازخوانی…",
    disconnected: "برای مشاهده ارائه‌دهندگان مدل پیکربندی‌شده به دروازه متصل شوید.",
    emptyTitle: "هیچ ارائه‌دهنده مدلی پیکربندی نشده است",
    emptySubtitle: "به یک ارائه‌دهنده وارد شوید یا یک کلید API اضافه کنید، سپس بازخوانی کنید.",
    status: {
      ok: "متصل",
    ...
    expiresIn: "اعتبارنامه در {time} منقضی می‌شود",
    models: "{count} مدل",
    modelOne: "۱ مدل",
    modelsAvailable: "{available} از {count} مدل در دسترس",
    noStats: "این ارائه‌دهنده هیچ داده مصرف زنده‌ای گزارش نکرده است.",
    localCost: "مصرف جلسه · {days} روز",
    localCostDetail: "{tokens} توکن · {sessions} جلسه",
    saving: "در حال ذخیره…",
