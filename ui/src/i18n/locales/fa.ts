...
export const fa: TranslationMap = {
  ...
  settings: {
    modeForm: "فرم",
    modeRaw: "خام",
    formViewUnsafeTooltip: "نمای فرم نمی‌تواند برخی فیلدها را به‌طور ایمن ویرایش کند",
    rawModeTooltip: "ویرایش پیکربندی خام JSON/JSON5",
    rawModeUnavailable: "حالت خام برای این اسنپ‌شات در دسترس نیست",
    rawModeDisabledNotice: "حالت خام غیرفعال است (اسنپ‌شات نمی‌تواند متن خام را به‌طور ایمن حفظ کند).",
    unsavedChanges: "تغییرات ذخیره‌نشده",
    unsavedChangeCount: "{count} تغییر ذخیره‌نشده",
    unsavedChangesCount: "{count} تغییر ذخیره‌نشده",
