...
export const fa: TranslationMap = {
  ...
  browser: {
    ...
    annotateHint: "روی صفحه رسم کنید، سپس نشانه‌گذاری را به گفت‌وگوی خود ارسال کنید.",
    inspectHint: "برای بازرسی، نشانگر را نگه دارید؛ برای ارسال عنصر به گفت‌وگوی خود کلیک کنید.",
    inspectName: "نام",
    inspectRole: "نقش",
    inspectFocusable: "قابل فوکوس",
    ...
    empty: "هیچ برگهٔ بازی وجود ندارد. برای مرور، یک URL در بالا وارد کنید.",
    refresh: "تازه‌سازی نما",
    noChatTarget: "ابتدا یک نشست گفت‌وگو باز کنید تا حاشیه‌نویسی جایی برای ارسال داشته باشد.",
    inspectUnavailable: "بازرسی عنصر غیرفعال است (browser.evaluateEnabled=false).",
    annotationSent: "حاشیه‌نویسی به کادر نوشتن گفت‌وگو اضافه شد.",
    annotatePrompt: {
      introTitled:
        'من صفحه را در {url} حاشیه‌نویسی کردم (عنوان گزارش‌شده توسط صفحه: "{title}") — اسکرین‌شات پیوست نشانه‌گذاری من را نشان می‌دهد.',
      introUntitled:
        "من صفحه را در {url} حاشیه‌نویسی کردم — تصویر پیوست، نشانه‌گذاری من را نشان می‌دهد.",
      region:
        "ناحیهٔ علامت‌گذاری‌شده {index}: با مرکزیت حدود {x}% از عرض / {y}% از بالا، با پوشش حدود {width}% × {height}% از نما.",
      moreRegions: "…به‌علاوه {count} ناحیهٔ علامت‌گذاری‌شدهٔ دیگر، همگی در تصویر قابل مشاهده‌اند.",
      elementDetail:
        "عنصر علامت‌گذاری‌شده (گزارش‌شده توسط صفحه): {descriptor} — {width}×{height}px در ({x}, {y}).",
      outro: "لطفاً به ناحیهٔ علامت‌گذاری‌شده نگاه کنید و بگویید چه برداشتی از آن دارید.",
    },
  },
  tabs: {
    agents: "عامل‌ها",
