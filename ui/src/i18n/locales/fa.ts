...
export const fa: TranslationMap = {
  ...
  cron: {
    ...
    suggestions: {
      ...
      morningBrief: {
        title: "خلاصه صبحگاهی",
        schedule: "روزهای کاری ساعت 8:00 AM",
        description: "هر روز کاری را با خلاصه‌ای از فعالیت‌های شبانه و اولویت‌ها آغاز کنید.",
        prompt:
          "یک خلاصه صبحگاهی به من بده: فعالیت‌های شبانه، پیام‌های خوانده‌نشده و اولویت‌های اصلی امروز را خلاصه کن.",
      },
      weeklyReview: {
        title: "مرور هفتگی",
        schedule: "جمعه‌ها ساعت 4:00 PM",
        description: "جلسات این هفته را هر جمعه به یک به‌روزرسانی وضعیت کوتاه تبدیل کن.",
        prompt:
          "یک مرور هفتگی بنویس: خلاصه کن این هفته روی چه چیزهایی کار شد، چه چیزهایی منتشر شد، و پیگیری‌های باز چیست.",
      },
      followUps: {
        title: "پایشگر پیگیری‌ها",
        schedule: "روزهای کاری ساعت 9:00 AM",
        description: "گفت‌وگوهای اخیر را مرور کن و هر موردی را که منتظر پاسخ است علامت‌گذاری کن.",
        prompt:
          "گفت‌وگوهای اخیر را مرور کن و هر موردی را که منتظر پاسخ است یا به توجه من نیاز دارد علامت‌گذاری کن.",
      },
    },
    stats: {
      scheduler: "زمان‌بند",
