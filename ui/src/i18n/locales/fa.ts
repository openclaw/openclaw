...
export const fa: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "جست‌وجوی وظایف زمان‌بندی‌شده",
      newTask: "وظیفه جدید",
      filters: "فیلترها",
      shownOf: "{shown} از {total}",
      emptyTitle: "هنوز هیچ وظیفه زمان‌بندی‌شده‌ای وجود ندارد",
      emptyHint: "توضیح دهید OpenClaw چه کاری را و در چه زمانی انجام دهد — طبق برنامه اجرا می‌شود.",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "روزهای کاری ساعت 9:00 صبح",
        everyMorning: "هر روز ساعت 8:00 صبح",
        weekly: "دوشنبه‌ها ساعت 9:00 صبح",
        hourly: "هر ساعت",
      },
      ideas: {
        repoPulse: {
    ...
    actions: {
      runNow: "اکنون اجرا شود",
      runIfDue: "در صورت فرارسیدن موعد اجرا شود",
      pause: "توقف",
      resume: "ادامه",
      clone: "تکثیر",
      remove: "حذف",
    ...
    form: {
      ...
      repeat: "تکرار",
      repeatInterval: "بازه زمانی",
      repeatOnce: "یک‌بار",
      repeatCron: "عبارت Cron",
      repeatOnExit: "هنگام خروج",
      onExitHelp:
        "هنگامی اجرا می‌شود که یک فرمان تحت نظارت خاتمه یابد. زمان‌بندی را نمی‌توان در اینجا ویرایش کرد.",
      every: "هر",
      at: "در",
      cronOption: "Cron",
      runAt: "اجرا در",
      ...
      startEnabled: "فعال‌سازی از ابتدا",
