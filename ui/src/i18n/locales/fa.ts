...
export const fa: TranslationMap = {
  ...
  question: {
    title: "عامل یک سؤال دارد",
    recommended: "توصیه‌شده",
    otherLabel: "سایر…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "پاسخ خود را تایپ کنید",
    secretWarning: "پاسخ شما ممکن است برای سایر شرکت‌کنندگان این کانال قابل مشاهده باشد.",
    submit: "ارسال",
    dismiss: "Dismiss",
    pending: "{count} در انتظار",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "حالت طرح",
      goal: "حالت هدف",
      switchConfirm: "حالت تغییر کند؟ این کار حالت فعلی را متوقف می‌کند.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "مشاهده",
    approveTitle: "این طرح اجرا شود؟",
    approveCta: "تصویب",
    revise: "بازنگری با بازخورد",
    reviseSubmit: "ارسال بازخورد",
    revisePlaceholder: "چه چیزی باید تغییر کند؟",
    cancel: "لغو",
