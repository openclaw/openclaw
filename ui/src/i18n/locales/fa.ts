...
export const fa: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "هنوز وظیفه زمان‌بندی‌شده‌ای وجود ندارد",
      emptyHint: "توضیح دهید OpenClaw چه کاری را چه زمانی انجام دهد — طبق زمان‌بندی اجرا می‌شود.",
    ...
    suggestions: {
      title: "پیشنهادها",
      schedules: {
        weekdayMornings: "روزهای کاری ساعت 9:00 AM",
        everyMorning: "هر روز ساعت ۸:۰۰ صبح",
      ...
      ideas: {
        repoPulse: {
          name: "نبض مخزن",
          tagline: "مشکلات، PRها و خطاهای CI شب گذشته، رتبه‌بندی‌شده بر اساس فوریت.",
          prompt:
            "فعالیت شب گذشته در مخزن‌هایم را بررسی کن: مشکلات جدید، pull requestها و خطاهای CI. سه موردی را که امروز بیش از همه به توجه من نیاز دارند خلاصه کن؛ هرکدام همراه با یک پیوند و دلیلی یک‌خطی.",
        },
        standupGhostwriter: {
          name: "نویسنده پشت‌صحنه استندآپ",
          tagline: "گزارش استندآپ شما، تهیه‌شده از کارهای دیروز.",
          prompt:
            "گزارش استندآپ من را بر اساس commitهای دیروز، pull requestهای ادغام‌شده و رشته‌های بازِ بازبینی تهیه کن. حداکثر سه مورد: انجام‌شده، در حال انجام، مسدودشده.",
        },
        hackerNewsScout: {
          name: "دیدبان Hacker News",
          tagline: "سه پیوند خواندنی برای وقت قهوه، همراه با نظرهای صریح.",
          prompt:
            "صفحه اول امروز Hacker News را برای پست‌های مربوط به عامل‌های هوش مصنوعی، ابزارهای توسعه‌دهندگان و TypeScript بررسی کن. سه پیوند جالب‌تر را برایم بفرست؛ هرکدام همراه با نظری صریح و یک‌خطی.",
        },
        dependencyRadar: {
          name: "رادار وابستگی‌ها",
          tagline: "وابستگی‌های قدیمی یا آسیب‌پذیر، همراه با نکات ارتقا.",
          prompt:
            "پروژه اصلی من را برای یافتن وابستگی‌های قدیمی یا آسیب‌پذیر بررسی کن. به‌روزرسانی‌های مهم را همراه با یک یادداشت یک‌خطی درباره ریسک هرکدام فهرست کن و فرمان ارتقا را آماده کن.",
        },
        watchdog: {
          name: "نگهبان شب",
          tagline: "بررسی ساعتی سلامت با نتیجه‌گیری یک‌خطی.",
          prompt:
            "بررسی کن که سرویس‌ها و Gateway من سالم باشند: گزارش‌های اخیر را برای یافتن خطاهای جدید، راه‌اندازی‌های مجدد یا بار غیرعادی بررسی کن. اگر همه‌چیز درست است، تنها با یک خط کوتاه تأیید کن؛ اگر مشکلی وجود دارد، گزارش بده چه چیزی از کار افتاده و بررسی را از کجا باید آغاز کرد.",
        },
        polyglotMinute: {
          name: "دقیقه چندزبانه",
          tagline: "یک عبارت خارجی کاربردی همراه با قهوه صبحگاهی‌تان.",
          prompt:
            "یک عبارت کاربردی ژاپنی به من یاد بده: خود عبارت، نحوه تلفظ، معنی تحت‌اللفظی و زمان استفاده از آن. پاسخ را در کمتر از پنج خط نگه دار.",
        },
      },
    },
    stats: {
    ...
    detail: {
      newTitle: "وظیفه زمان‌بندی‌شده جدید",
      newSubtitle: "توضیح بده OpenClaw چه کاری باید انجام دهد، سپس زمان اجرای آن را انتخاب کن.",
      overviewTitle: "فعالیت اخیر",
      overviewSubtitle: "آخرین اجراها در همه وظایف زمان‌بندی‌شده.",
      historyTitle: "تاریخچه اجرا",
      detailsSection: "جزئیات",
      frequencySection: "تناوب",
      paused: "متوقف‌شده",
    },
    actions: {
      runNow: "اکنون اجرا کن",
      runIfDue: "اگر موعدش رسیده اجرا کن",
      pause: "توقف",
      resume: "ازسرگیری",
      clone: "تکثیر",
      remove: "حذف",
      more: "اقدام‌های بیشتر",
      history: "تاریخچه",
    },
    jobs: {
      schedule: "زمان‌بندی",
    ...
    form: {
      ...
      promptPlaceholder: "توضیح دهید OpenClaw چه کاری انجام دهد...",
      repeat: "تکرار",
      repeatInterval: "فاصله زمانی",
      repeatOnce: "یک‌بار",
      repeatCron: "عبارت Cron",
      repeatOnExit: "هنگام خروج",
      onExitHelp:
        "وقتی یک فرمان تحت نظارت خارج می‌شود اجرا می‌شود. زمان‌بندی را نمی‌توان اینجا ویرایش کرد.",
      every: "هر",
      at: "در",
      cronOption: "Cron",
      runAt: "اجرا در",
      ...
      startEnabled: "شروع به‌صورت فعال",
