  ...
  cron: {
    ...
    suggestions: {
      ...
      ideas: {
        ...
        nightWatch: {
          name: "نگهبان شب",
          tagline: "بررسی سلامت ساعتی آرام — فقط وقتی چیزی خراب شود صدا می‌زند.",
          prompt:
            "بررسی کن که سرویس‌ها و Gateway من سالم باشند: لاگ‌های اخیر را برای خطاهای جدید، راه‌اندازی مجدد یا بار غیرعادی اسکن کن. اگر همه چیز خوب است، ساکت بمان؛ اگر چیزی خراب به نظر می‌رسد، به من پیام بده چه چیزی خراب شده و از کجا شروع به بررسی کنم.",
        },
        polyglotMinute: {
          name: "دقیقه چندزبانه",
