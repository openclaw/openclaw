...
export const ar: TranslationMap = {
  ...
  settings: {
    modeForm: "نموذج",
    modeRaw: "خام",
    formViewUnsafeTooltip: "لا يمكن لعرض النموذج تحرير بعض الحقول بأمان",
    rawModeTooltip: "تحرير إعدادات JSON/JSON5 الخام",
    rawModeUnavailable: "الوضع الخام غير متاح لهذه اللقطة",
    rawModeDisabledNotice: "الوضع الخام معطّل (لا يمكن للقطة حفظ النص الخام بأمان).",
    unsavedChanges: "تغييرات غير محفوظة",
    unsavedChangeCount: "{count} تغيير غير محفوظ",
