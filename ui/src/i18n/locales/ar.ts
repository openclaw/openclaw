...
export const ar: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "الموفرون المُعدّون مع الخطة والحصة والتكلفة.",
  ...
  modelProviders: {
    title: "الموفرون المُعدّون",
    subtitle: "موفرو النماذج مع المصادقة والخطة والحصة وبيانات التكلفة.",
    updated: "تم التحديث {time}",
    refreshing: "جارٍ التحديث…",
    disconnected: "اتصل بالبوابة لعرض موفري النماذج المُعدّين.",
    emptyTitle: "لم يتم تكوين أي موفر نماذج",
    emptySubtitle: "سجّل الدخول إلى موفر أو أضف مفتاح API، ثم قم بالتحديث.",
    status: {
      ok: "متصل",
      expiring: "تنتهي صلاحيته قريباً",
      expired: "منتهي الصلاحية",
      missing: "لم يتم تسجيل الدخول",
      apiKey: "مفتاح API",
    },
    expiresIn: "تنتهي صلاحية بيانات الاعتماد في {time}",
    models: "{count} نموذج",
    modelOne: "نموذج واحد",
    modelsAvailable: "{available} من {count} نموذج متاح",
    noStats: "لم يبلغ هذا الموفر عن بيانات استخدام مباشر.",
    localCost: "استهلاك الجلسة · {days} يوم",
    localCostDetail: "{tokens} رمز · {sessions} جلسة",
    saving: "جارٍ الحفظ…",
