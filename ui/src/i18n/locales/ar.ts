...
export const ar: TranslationMap = {
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "وضع الخطة",
      goal: "وضع الهدف",
      switchConfirm: "هل تريد تبديل الوضع؟ سيؤدي هذا إلى إيقاف الوضع الحالي.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "عرض",
    approveTitle: "هل تريد تنفيذ هذه الخطة؟",
    approveCta: "موافقة",
    revise: "مراجعة مع الملاحظات",
    reviseSubmit: "إرسال الملاحظات",
