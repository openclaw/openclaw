  ...
  cron: {
    ...
    suggestions: {
      ...
      schedules: {
        ...
        everyMorning: "يوميًا الساعة 8:00 صباحًا",
      ...
      ideas: {
        repoPulse: {
          name: "نبض المستودعات",
          tagline: "المشكلات وطلبات السحب وإخفاقات CI خلال الليل، مرتبة حسب الأولوية.",
          prompt:
            "راجع نشاط الليلة الماضية في مستودعاتي: المشكلات الجديدة وطلبات السحب وإخفاقات CI. لخّص أهم ثلاثة أمور تتطلب انتباهي اليوم، مع رابط وسبب من سطر واحد لكل منها.",
        },
        standupGhostwriter: {
          name: "كاتب تحديث الاجتماع اليومي",
          tagline: "مسودة تحديث اجتماعك اليومي استنادًا إلى عمل الأمس.",
          prompt:
            "أعدّ مسودة تحديث اجتماعي اليومي استنادًا إلى التثبيتات وطلبات السحب المدمجة وسلاسل المراجعة المفتوحة من يوم أمس. ثلاث نقاط كحد أقصى: تم إنجازه، جارٍ تنفيذه، متعثر.",
        },
        hackerNewsScout: {
          name: "مستطلع Hacker News",
          tagline: "ثلاثة روابط تستحق وقت قهوتك، مع آراء جريئة.",
          prompt:
            "تصفّح الصفحة الرئيسية لـ Hacker News اليوم بحثًا عن منشورات حول وكلاء الذكاء الاصطناعي وأدوات المطورين وTypeScript. أرسل إليّ الروابط الثلاثة الأكثر إثارة للاهتمام، مع رأي جريء من سطر واحد لكل منها.",
        },
        dependencyRadar: {
          name: "رادار التبعيات",
          tagline: "تبعيات قديمة أو معرّضة للثغرات، مع ملاحظات الترقية.",
          prompt:
            "تحقق من مشروعي الرئيسي بحثًا عن تبعيات قديمة أو معرّضة للثغرات. أدرج التحديثات المهمة مع ملاحظة عن المخاطر من سطر واحد لكل منها، وأعدّ مسودة أمر الترقية.",
        },
        watchdog: {
          name: "المراقبة الليلية",
          tagline: "فحص سلامة كل ساعة مع خلاصة من سطر واحد.",
          prompt:
            "تحقّق من أن خدماتي وGateway يعملان بشكل سليم: افحص السجلات الحديثة بحثًا عن أخطاء جديدة أو عمليات إعادة تشغيل أو أحمال غير معتادة. أجب بسطر واحد قصير يفيد بأن كل شيء على ما يرام عندما لا توجد مشكلات؛ وإذا بدا أن هناك عطلًا، فأبلغ عمّا تعطل ومن أين أبدأ البحث.",
        },
        polyglotMinute: {
          name: "دقيقة متعددة اللغات",
          tagline: "عبارة أجنبية مفيدة مع قهوة الصباح.",
          prompt:
            "علّمني عبارة مفيدة واحدة باللغة اليابانية: العبارة، وكيفية نطقها، ومعناها الحرفي، ومتى تُستخدم. اجعلها في أقل من خمسة أسطر.",
        },
      },
    },
    stats: {
