...
export const ar: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "البحث في ClawHub",
    ...
    preparingSearch: "جارٍ تحضير البحث…",
    searchClawHubTitle: "البحث في ClawHub",
    searchClawHubBody: "أدخل حرفين على الأقل للعثور على مكوّنات التعليمات البرمجية والحِزم الإضافية.",
    noClawHubResultsTitle: "لم يتم العثور على مكوّنات إضافية",
    ...
    statInstalled: "مثبتة",
    statEnabled: "ممكّنة",
    statIssues: "تحتاج إلى انتباه",
    statMcpServers: "خوادم MCP",
