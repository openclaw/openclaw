  ...
  cron: {
    ...
    suggestions: {
      ...
      ideas: {
        ...
        nightWatch: {
          name: "حارس الليل",
          tagline: "فحص صحة ساعي هادئ — يتحدث فقط عند حدوث خلل.",
          prompt:
            "تحقق من أن خدماتي وGateway بصحة جيدة: افحص السجلات الأخيرة بحثاً عن أخطاء جديدة، أو إعادة تشغيل، أو حمل غير معتاد. ابقَ صامتاً إذا كان كل شيء على ما يرام؛ وإذا بدا شيء معطلاً، أرسل لي رسالة بما فشل وأين أبدأ البحث.",
        },
        polyglotMinute: {
