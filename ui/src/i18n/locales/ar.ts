...
export const ar: TranslationMap = {
  ...
  sessionsView: {
    ...
    reasoning: "الاستدلال",
    actions: "الإجراءات",
    addToWorkboard: "إضافة إلى لوحة العمل",
    openWorkboardCard: "فتح بطاقة لوحة العمل",
  ...
  quickSettings: {
    security: {
      browserEnabled: "المتصفح مفعّل",
      toolProfile: "ملف تعريف الأدوات",
    },
  },
  execApproval: {
  ...
  logsView: {
    ...
    autoFollow: "المتابعة التلقائية",
    file: "الملف: {file}",
    truncated: "تم اقتطاع إخراج السجل؛ تُعرض أحدث دفعة.",
  ...
  workboard: {
    ...
    unarchiveCard: "استعادة من الأرشيف",
    archived: "مؤرشف",
    ...
    detailAutomationSkills: "المهارات: {skills}",
    ...
    agentLinked: "مرتبط بـ {agent}",
    agentDefaultLinked: "يستخدم الوكيل الافتراضي {agent}",
    engineOpenAI: "OpenAI",
    engineClaude: "Claude",
    engineDisabledRuntime:
      "{agent} يستخدم وقت تشغيل ACP {runtime}. استخدم البدء الافتراضي لهذه الجلسة.",
    ...
    showArchived: "إظهار البطاقات المؤرشفة",
    hideArchived: "إخفاء البطاقات المؤرشفة",
    showArchivedShort: "المؤرشفة",
    hideArchivedShort: "إخفاء المؤرشفة",
    layout: "تخطيط البطاقات",
    layoutCompact: "كثافة بطاقات مدمجة",
    layoutComfortable: "كثافة بطاقات مريحة",
    dispatch: "منبّه الموزّع",
    dispatchSummary:
      "اكتمل الإرسال: بدأ {started}، رُقّي {promoted}، حُظر {blocked}، استُعيد {reclaimed}، نُسّق {orchestrated}، إخفاقات {failures}.",
    dispatchSummaryEmpty: "اكتمل الإرسال: لم يتغير أي عمل جاهز.",
    ...
    hideEmptyColumns: "إخفاء الأعمدة الفارغة",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepConnect: "انقر على اتصال مرة أخرى بعد تحديث بيانات الاعتماد.",
      },
      authFailed: {
  ...
  chat: {
    ...
    welcome: {
      ready: "جاهز للدردشة",
      hintBeforeShortcut: "اكتب رسالة أدناه ·",
      hintAfterShortcut: "للأوامر",
      suggestions: {
        whatCanYouDo: "ماذا يمكنك أن تفعل؟",
        summarizeRecentSessions: "لخّص جلساتي الأخيرة",
        configureChannel: "ساعدني في إعداد قناة",
        checkSystemHealth: "تحقّق من صحة النظام",
      },
    },
    runControls: {
      newSession: "جلسة جديدة",
    ...
    composer: {
      placeholder: "رسالة إلى {name} (Enter للإرسال)",
      placeholderWithAttachments: "أضف رسالة أو الصق المزيد من الصور...",
      placeholderDisconnected: "اتصل بالـ Gateway لبدء الدردشة...",
      attachFile: "إرفاق ملف",
      dismissTalkError: "تجاهل خطأ Talk",
      startTalk: "بدء المحادثة الصوتية",
      stillListening: "لا يزال يستمع",
      talkTranscript: "نص الحديث",
      stopTalk: "إيقاف المحادثة الصوتية",
    },
    selectors: {
      agentFilter: "تصفية الجلسات حسب الوكيل",
      session: "جلسة الدردشة",
      sessionSearch: "البحث في الجلسات",
      clearSessionSearch: "مسح البحث في الجلسات",
      loadMoreSessions: "تحميل المزيد من الجلسات",
      model: "نموذج الدردشة",
      thinkingLevel: "مستوى تفكير الدردشة",
    },
    toolCards: {
  ...
  cron: {
    ...
    jobs: {
      ...
      emptyHint: "أنشئ مهمة من مطالبة بلغة بسيطة؛ يمكن تأجيل الحقول المتقدمة.",
      emptyFilteredHint: "امسح عوامل التصفية أو غيّرها لرؤية المهام المجدولة.",
