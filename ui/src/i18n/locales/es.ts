...
export const es: TranslationMap = {
  ...
  agentTools: {
    connected: "Conectado",
    connectedWithPlugin: "Conectado: {value}",
    channel: "Canal",
    channelWithId: "Canal: {value}",
    builtIn: "Integrado",
    toolAccessTitle: "Acceso a herramientas",
    toolAccessSubtitle: "Perfil + sobrescrituras por herramienta para este agente. {enabled}/{total} habilitadas.",
    ...
    saving: "Guardando…",
    loading: "Cargando…",
    removeAllowlistTitle: "Quitar la allowlist por agente y usar todas las habilidades",
    filter: "Filtro",
    searchSkillsPlaceholder: "Buscar habilidades",
    shownCount: "{count} mostradas",
    skillsTitle: "Habilidades",
    skillsSubtitle: "Allowlist de habilidades por agente y habilidades del workspace. {enabled}/{total}",
    skillsSubtitleNoCount: "Allowlist de habilidades por agente y habilidades del workspace.",
    reset: "Restablecer",
    loadConfigInfo: "Carga la configuración del gateway para definir habilidades por agente.",
    customAllowlistInfo: "Este agente usa una allowlist de habilidades personalizada.",
    allSkillsInfo: "Todas las habilidades están habilitadas. Deshabilitar cualquier habilidad creará una allowlist por agente.",
    loadSkillsInfo: "Carga las habilidades de este agente para ver entradas específicas del workspace.",
    noSkillsFound: "No se encontraron habilidades.",
    ready: "Listas",
    needsSetup: "Requieren configuración",
  },
  cron: {
    summary: {
      enabled: "Habilitado",
