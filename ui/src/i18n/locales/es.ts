...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.nexus-agent/nexus-agent.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde nexus-agent dashboard --no-open en tu escritorio.",
    },
    insecure: {
