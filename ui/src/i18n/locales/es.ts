...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    language: "Elegir el idioma del dashboard.",
  ...
  languagePage: {
    title: "Idioma del dashboard",
    subtitle: "Elige el idioma usado por este dashboard en este dispositivo.",
    currentLabel: "Idioma actual",
    localOnly: "Se guarda al instante solo en este navegador.",
    availableTitle: "Idiomas disponibles",
    availableHint: "Puedes cambiarlo en cualquier momento desde la barra lateral.",
