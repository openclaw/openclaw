...
export const es: TranslationMap = {
  ...
  mcpApp: {
    title: "Aplicación MCP",
    unavailable: "Aplicación MCP no disponible: {error}",
  },
  githubPreview: {
  ...
  channels: {
    refreshingStaleSnapshot:
      "Actualizando el estado del canal en segundo plano; mostrando la última captura correcta.",
    config: {
      schemaUnavailable: "Esquema no disponible. Usa Raw.",
      channelSchemaUnavailable: "Esquema de configuración del canal no disponible.",
    ...
    googleChat: {
      title: "Google Chat",
      subtitle: "Estado del webhook de la API de Chat y configuración del canal.",
    },
    imessage: {
      title: "iMessage",
    ...
    nostr: {
      title: "Nostr",
      subtitle: "Mensajes directos descentralizados a través de relés Nostr (NIP-04).",
      profile: "Perfil",
  ...
  nodes: {
    ...
    inventory: {
      ...
      manualWakeTitle:
        "El Gateway no puede activar un nodo Windows sin conexión. Enciende la máquina o restaura su conexión de red.",
    ...
    execApprovals: {
      ...
      hostNativeHint: "Solo lectura aquí. Edita desde la app complementaria o la CLI.",
      native: "Nativo",
      ...
      on: "activado",
      target: "Destino",
      targetHint: "Gateway edita las aprobaciones locales; el nodo edita el nodo seleccionado.",
      host: "Host",
      gateway: "Gateway",
      node: "Nodo",
      selectNode: "Seleccionar nodo",
      noNodes: "Ningún nodo anuncia aprobaciones de ejecución todavía.",
      scope: "Ámbito",
      ...
      askFallback: "Alternativa de solicitud",
      ...
      autoAllowSkillsHint: "Permitir los ejecutables de Skills enumerados por el Gateway.",
      usingDefault: "Usando predeterminado ({value}).",
      override: "Anulación ({value}).",
      enabled: "Activados",
      useDefault: "Usar predeterminado",
      allowlist: "Lista de permitidos",
      allowlistHint: "Patrones glob sin distinción de mayúsculas y minúsculas.",
  ...
  agents: {
    ...
    toolCatalog: {
      ...
      descriptions: {
        ...
        browser: "Controlar el navegador web",
    ...
    skillsPanel: {
      ...
      allEnabled:
        "Todos los Skills están habilitados. Al deshabilitar cualquier Skill se creará una lista de permitidos por agente.",
      loadAgent:
        "Carga los Skills de este agente para ver las entradas específicas del área de trabajo.",
      filter: "Filtrar",
      searchPlaceholder: "Buscar Skills",
      shown: "{count} mostrados",
      empty: "No se encontraron Skills.",
      missing: "Faltantes: {items}",
      reason: "Motivo: {items}",
    },
    channels: {
      title: "Channels",
  ...
  configForm: {
    ...
    noSettingsMatch: 'Ninguna configuración coincide con "{query}"',
    noSettingsInSection: "No hay configuraciones en esta sección",
    sections: {
      env: {
      ...
      gateway: {
        label: "Gateway",
        description: "Ajustes del servidor Gateway (puerto, autenticación, enlace)",
      },
      wizard: {
      ...
      bindings: {
        label: "Asignaciones",
        description: "Asignaciones de teclas y atajos",
      },
      broadcast: {
        label: "Difusión",
      ...
      diagnostics: {
        label: "Diagnósticos",
        description: "Ajustes de instrumentación, OpenTelemetry y cache-trace",
      },
      cli: {
        label: "CLI",
        description: "Banner de CLI y comportamiento de inicio",
      },
      secrets: {
        label: "Secretos",
      ...
      acp: {
        label: "ACP",
        description: "Ajustes de runtime y streaming del Agent Communication Protocol",
      },
      mcp: {
        label: "MCP",
        description: "Definiciones de servidor del Model Context Protocol",
      },
    },
  },
  quickSettings: {
    ...
    security: {
      title: "Seguridad",
      configure: "Configurar →",
      gatewayAuth: "Autenticación del Gateway",
    ...
    personal: {
      ...
      avatarText: "Texto de avatar / emoji",
      ...
      avatarIssues: {
        ...
        cannotRender: "No se puede mostrar el avatar",
      },
    },
    pending: {
  ...
  configView: {
    ...
    sections: {
      ...
      web: "Web",
      browser: "Navegador",
      nodeHost: "Host de nodo",
      canvasHost: "Host de lienzo",
    ...
    notifications: {
      ...
      blockedHint:
        "Las notificaciones están bloqueadas. Actualiza los permisos del sitio en tu navegador para permitir notificaciones.",
    },
    appearance: {
      theme: "Tema",
      ...
      importedTheme: "Tema importado",
      import: "Importar",
      importedFrom: "Importado de tweakcn: {name}",
      importHint: "Importa un tema de tweakcn en este espacio local del navegador",
      importFromTweakcn: "Importar de tweakcn",
      tweakcnInstructions:
        "Abre tweakcn.com, elige o crea un tema, haz clic en Share y pega aquí el enlace del tema copiado. Se aceptan enlaces para compartir, URLs del editor, URLs del registro, IDs de temas y nombres de temas predeterminados como amethyst-haze.",
      ...
      inlineHintAfter:
        "para agregar un tema de tweakcn local del navegador. En tweakcn, usa Share y pega aquí el enlace copiado.",
      textSize: "Tamaño del texto",
    },
    connection: {
      title: "Conexión",
    ...
    rawTitle: "Editar configuración JSON/JSON5 sin formato",
    rawUnavailableTitle: "Modo sin formato no disponible para esta instantánea",
    unsavedChange: "{count} cambio sin guardar",
    unsavedChanges: "{count} cambios sin guardar",
    noChanges: "Sin cambios",
    rawDisabled:
      "Modo sin formato deshabilitado (la instantánea no puede convertir el texto sin formato de forma segura).",
    open: "Abierto",
    clear: "Borrar",
    apply: "Aplicar",
    applying: "Aplicando…",
    ...
    rawDiffUnavailable: "Cambios detectados (diff de JSON no disponible)",
    ...
    rawConfig: "Configuración raw (JSON/JSON5)",
    ...
    toggleRawRedaction: "Alternar ocultación de configuración raw",
    sensitiveHidden:
      "{count} valor sensible oculto. Usa el botón de mostrar de arriba para editar la configuración raw.",
    sensitiveHiddenPlural:
      "{count} valores sensibles ocultos. Usa el botón de mostrar de arriba para editar la configuración raw.",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    disabledByOverride: "Deshabilitado por anulación del agente.",
    ...
    explicitAllowlist:
      "Este agente usa una lista de permitidos explícita en la configuración. Las anulaciones de herramientas se gestionan en la pestaña Config.",
    globalAllowlist:
      "tools.allow global está configurado. Las anulaciones del agente no pueden habilitar herramientas que están bloqueadas globalmente.",
    loadingCatalog: "Cargando catálogo de herramientas en tiempo de ejecución…",
    catalogFallback:
      "No se pudo cargar el catálogo de herramientas en tiempo de ejecución. Mostrando en su lugar la lista integrada de reserva.",
    ...
    switchAgent: "Cambia el chat a este agente para ver sus herramientas de runtime en vivo.",
    ...
    moreLiveTitle: "{count} herramientas en vivo más están disponibles en los grupos siguientes.",
    ...
    profileSourceGlobal: "valor predeterminado global",
  ...
  skillsPage: {
    ...
    close: "Cerrar",
    by: "Por",
    latest: "Más reciente: v{version}",
    platforms: "Plataformas: {platforms}",
    installNamed: "Instalar {name}",
    notFound: "Skill no encontrada.",
    invalidLink: "Enlace de ClawHub inválido",
    overview: "Resumen",
    skillCard: "Tarjeta de Skill",
  ...
  mcpPage: {
    ...
    operatorCommands: "Comandos de operador MCP",
    operatorCommandsHint:
      "Estado, diagnósticos, autenticación, sondeo y recarga en tiempo de ejecución.",
    runtimeHint:
      "Los cambios en tiempo de ejecución se aplican después de guardar y publicar; los agentes activos reconstruyen los entornos de ejecución de MCP en el próximo uso.",
    toolFilter: "filtro de herramientas",
    parallel: "paralelo",
    missingTransport: "falta el transporte",
    tlsVerifyOff: "verificación TLS desactivada",
    mtls: "mTLS",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      linear:
        "Clasifica incidencias, actualiza ciclos y reporta errores directamente desde el chat.",
      ...
      email:
        "Clasificación de bandeja de entrada, resúmenes y borradores con envío tras aprobación.",
      pdf: "Extrae, combina, convierte y aplica OCR a documentos PDF.",
      transcription: "Convierte audio y video en transcripciones limpias y estructuradas.",
      github:
        "Colas de revisión de PR, clasificación de incidencias y preguntas sobre repositorios a través del MCP oficial de GitHub.",
      sentry: "Alertas de fallos explicadas y clasificadas en el momento en que se activan.",
      context7:
        "Documentación de bibliotecas específica de cada versión y ejemplos de código mientras programas. No se necesita registro.",
      deepwiki:
      ...
      kubernetes: "Operaciones de clúster y resolución de problemas desde el chat.",
      homeAssistant: "Controla luces, clima y automatizaciones en toda tu casa.",
      spotify:
        "Busca, pon en cola y ambienta tu día con listas de reproducción según el estado de ánimo.",
      sonos: "Audio para toda la casa: reproduce, agrupa habitaciones y pon en cola desde el chat.",
      reddit: "Navega, busca y resume subreddits e hilos.",
      ...
      news: "Un resumen diario personalizado: noticias, clima y tareas en un solo mensaje.",
      maps: "Respuestas sobre lugares, rutas y tiempos de viaje.",
      translation: "Traduce y localiza texto y documentos.",
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "Propuesta de {verb}",
      description:
        "Indica al agente qué debe cambiar. La propuesta permanece pendiente y el taller creará una versión revisada.",
      placeholder:
        "Ejemplo: Haz que esto use etiquetas de Gmail en lugar de la búsqueda de no leídos, y añade un paso de simulación más seguro.",
      preparing: "Preparando transferencia de revisión",
    ...
    detail: {
      ...
      noSupportFiles: "0 archivos de soporte",
      loading: "Cargando propuesta…",
      supportFilesTitle: "Archivos de soporte",
    ...
    empty: {
      ...
      rejectedBody:
        "Las propuestas omitidas se quedarán aquí para mantener un historial de revisión limpio.",
      quarantinedTitle: "Nada en cuarentena",
      quarantinedBody:
        "Aquí aparecerán las propuestas bloqueadas por el escáner o retenidas por seguridad.",
      staleTitle: "No hay propuestas obsoletas",
      staleBody: "Aquí aparecerán las propuestas que ya no se pueden aplicar correctamente.",
    ...
    today: {
      ...
      browseApplied: "Explora lo que ya se ha aplicado.",
      progress: "{current} de {total}",
      draftedBy: "Redactado por",
      supportFile: "{count} archivo de soporte",
      supportFiles: "{count} archivos de soporte",
      comeWithIt: "vienen incluidos.",
      useIt: "Usarlo",
      ...
      applicabilityHeading: "Cuándo debe usarlo el agente",
    },
    relative: {
      secondsAgo: "hace {count}s",
  ...
  workboard: {
    ...
    templateDraft: {
      bugfixTitle: "Corregir: ",
      bugfixNotes: "Síntoma:\nCausa:\nAceptación:\nPrueba:",
      docsTitle: "Documentación: ",
      docsNotes: "Página:\nCambio:\nPrueba de origen:",
      releaseTitle: "Lanzamiento: ",
  ...
  palette: {
    ...
    descriptions: {
      ...
      verboseMode: "Alternar el modo detallado.",
    },
    footer: {
      navigate: "navegar",
      select: "seleccionar",
  ...
  dreaming: {
    ...
    wiki: {
      previewFallbackTitle: "Página de wiki",
      close: "Cerrar",
      loadingPage: "Cargando página de wiki…",
      dreamsTab: "Sueños",
      insightsTab: "Perspectivas importadas",
      palaceTab: "Palacio de la memoria",
      dreamsExplainer:
        "Este es el diario de sueños en bruto que el sistema escribe mientras reproduce y consolida la memoria; úsalo para inspeccionar qué está notando el sistema de memoria y dónde todavía parece ruidoso o escaso.",
      insightsExplainer:
        "Estas son perspectivas importadas agrupadas a partir del historial externo; úsalas para revisar lo que surgió en las importaciones antes de que algo pase a formar parte de la memoria duradera.",
      palaceExplainer:
        "Esta es la superficie compilada de la wiki de memoria que el sistema puede buscar y razonar; úsala para inspeccionar páginas de memoria reales, afirmaciones, preguntas abiertas y contradicciones, en lugar de los chats de origen importados en bruto.",
      copyArchivePath: "Copiar ruta del archivo",
      loadingInsights: "Cargando conocimientos importados…",
      noInsights: "Aún no hay conocimientos importados",
      noInsightsHint:
        "Ejecuta una importación de ChatGPT con aplicación para mostrar aquí los conocimientos importados agrupados.",
      ...
      emptyPalaceHint:
        "Ahora mismo la wiki tiene principalmente importaciones de origen sin procesar e informes operativos. Esta pestaña se vuelve útil una vez que empiezan a escribirse síntesis, entidades o conceptos.",
      claims: "Afirmaciones",
      ...
      id: "Id:",
      openWikiPage: "Abrir página de wiki",
      unavailable: "Memory Wiki no está habilitado",
      unavailablePluginPrefix:
        "Los Imported Insights y el Memory Palace los proporciona el complemento incluido",
  ...
  chat: {
    ...
    commands: {
      ...
      redirectDescription: "Cancelar y reiniciar con un nuevo mensaje",
    ...
    sideChat: {
      title: "Chat lateral",
      notSaved: "No guardado en el historial de chat",
      thinking: "Pensando…",
    ...
    detailPanel: {
      ...
      renderedMarkdownHint: "Vista previa de texto enriquecido depurada para una lectura rápida.",
      noPreviewableMarkdown: "No hay contenido de markdown con vista previa.",
  ...
  cron: {
    ...
    suggestions: {
      ...
      schedules: {
        ...
        everyMorning: "Todos los días a las 8:00 AM",
    ...
    detail: {
      ...
      newSubtitle: "Describe qué debe hacer OpenClaw y luego elige cuándo se ejecuta.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe qué debe hacer OpenClaw...",
      repeat: "Repetir",
      ...
      lightContextHelp: "Usa un contexto de arranque ligero para este trabajo de agente.",
      model: "Modelo",
      ...
      failureAlertAfter: "Alertar tras",
      ...
      failureAlertToHelp: "Destinatario opcional para las alertas de fallo.",
      ...
      failureAlertAccountPlaceholder: "ID de cuenta para configuraciones multicuenta",
