...
export const es: TranslationMap = {
  ...
  agentsPage: {
    ...
    empty: {
      ...
      subtitle: "Elige un agente para inspeccionar su espacio de trabajo y herramientas.",
    },
    tabs: {
      overview: "Resumen",
      files: "Archivos",
    ...
    overview: {
      title: "Resumen",
      subtitle: "Rutas de espacio de trabajo y metadatos de identidad.",
      ...
      skillsFilterAll: "todas las habilidades",
      skillsFilterSelected: "{count} seleccionadas",
      identityUnavailable: "No disponible",
    },
    models: {
      title: "Selección de modelo",
      primary: "Modelo principal",
      primaryDefault: "Modelo principal (predeterminado)",
      inheritDefault: "Heredar predeterminado",
      inheritDefaultWithValue: "Heredar predeterminado ({value})",
      fallbacks: "Modelos alternativos (separados por comas)",
      fallbacksPlaceholder: "proveedor/modelo, proveedor/modelo",
