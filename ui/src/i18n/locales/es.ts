...
export const es: TranslationMap = {
  ...
  cron: {
    ...
    form: {
      ...
      jitterHelp: "¿Necesitas variación aleatoria? Usa Avanzado → Ventana de escalonado / Unidad de escalonado.",
      execution: "Ejecución",
      ...
      clearAgentHelp:
        "Forzar que esta tarea use el asistente predeterminado del gateway.",
      ...
      thinkingHelp:
        "Usa un nivel sugerido o introduce un valor específico del proveedor.",
      bestEffortDelivery: "Entrega de mejor esfuerzo",
      bestEffortHelp:
        "No fallar la tarea si la entrega en sí misma falla.",
