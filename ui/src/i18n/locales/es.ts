...
export const es: TranslationMap = {
  ...
  settings: {
    modeForm: "Formulario",
    modeRaw: "Sin formato",
    formViewUnsafeTooltip: "La vista de formulario no puede editar algunos campos de forma segura",
    rawModeTooltip: "Editar la configuración JSON/JSON5 sin formato",
    rawModeUnavailable: "Modo sin formato no disponible para esta instantánea",
    rawModeDisabledNotice:
      "Modo sin formato desactivado (la instantánea no puede conservar el texto sin formato de forma segura).",
    unsavedChanges: "Cambios sin guardar",
    unsavedChangeCount: "{count} cambio sin guardar",
    unsavedChangesCount: "{count} cambios sin guardar",
