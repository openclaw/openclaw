...
export const es: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Buscar en ClawHub",
    ...
    searchClawHubTitle: "Buscar en ClawHub",
    searchClawHubBody:
      "Introduce al menos dos caracteres para encontrar código y plugins de paquete.",
    noClawHubResultsTitle: "No se encontraron plugins",
