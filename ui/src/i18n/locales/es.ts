...
export const es: TranslationMap = {
  ...
  question: {
    ...
    secretWarning:
      "Es posible que tu respuesta sea visible para otros participantes en este canal.",
    submit: "Enviar",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      off: "Desactivada",
      plan: "Modo de plan",
      goal: "Modo de objetivo",
      switchConfirm: "¿Cambiar de modo? Esto detendrá el modo actual.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Ver",
    approveTitle: "¿Implementar este plan?",
    approveCta: "Aprobar",
    revise: "Revisar con comentarios",
    reviseSubmit: "Enviar comentarios",
    revisePlaceholder: "¿Qué debería cambiar?",
    cancel: "Cancelar",
