...
export const es: TranslationMap = {
  ...
  chat: {
    ...
    contextCompacting: "Compactando contexto...",
    contextCompacted: "Contexto compactado",
    addMessageOrPasteImages: "Agregar mensaje o pegar más imágenes...",
    messagePlaceholder: "Mensaje (↩ para enviar, Shift+↩ para saltos de línea, pegar imágenes)",
    connectToGateway: "Conectar a la puerta de enlace para comenzar a chatear...",
