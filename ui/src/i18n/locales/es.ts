...
export const es: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe qué debe hacer OpenClaw y cuándo; se ejecutará según lo programado.",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "De lunes a viernes a las 9:00 a. m.",
    ...
    detail: {
      ...
      newSubtitle: "Describe qué debe hacer OpenClaw y luego elige cuándo se ejecutará.",
      overviewTitle: "Actividad reciente",
      overviewSubtitle: "Ejecuciones más recientes de todas las tareas programadas.",
    ...
    form: {
      ...
      startEnabled: "Iniciar habilitada",
