...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Proveedores configurados con plan, cuota y coste.",
  ...
  modelProviders: {
    ...
    subtitle: "Proveedores de modelos con autenticación, plan, cuota y datos de coste.",
    updated: "Actualizado {time}",
    refreshing: "Actualizando…",
    disconnected: "Conéctese al gateway para ver los proveedores de modelos configurados.",
    emptyTitle: "No hay proveedores de modelos configurados",
    emptySubtitle: "Inicie sesión en un proveedor o añada una clave API, luego actualice.",
    status: {
      ok: "Conectado",
      expiring: "Caducando",
      expired: "Caducado",
      missing: "No ha iniciado sesión",
      apiKey: "Clave API",
    },
    expiresIn: "La credencial caduca en {time}",
    models: "{count} modelos",
    modelOne: "1 modelo",
    modelsAvailable: "{available} de {count} modelos disponibles",
    noStats: "Este proveedor no ha reportado datos de uso en vivo.",
    localCost: "Gasto de sesión · {days}d",
    localCostDetail: "{tokens} tokens · {sessions} sesiones",
    saving: "Guardando…",
