...
export const zh_CN: TranslationMap = {
  ...
  tabs: {
    ...
    missionControl: "控制台",
    trading: "交易",
    financeDashboard: "仪表盘",
    finOverview: "总览",
    finTrading: "交易台",
    finStrategyLab: "策略实验室",
    finFlow: "流水线",
    finSetting: "交易设置",
    skills: "技能",
    nodes: "节点",
  ...
  subtitles: {
    ...
    cron: "安排唤醒和重复的代理运行。",
    missionControl: "统一控制台，包含权益、策略赛马和 Agent 活动流。",
    trading: "实时交易仪表盘，包含行情数据和订单管理。",
    financeDashboard: "金融总览，包含投资组合指标和分析。",
    finOverview: "基金总览 — 权益、风险、持仓、告警",
    finTrading: "交易操作 — 持仓管理、策略控制、订单",
    finStrategyLab: "策略研究 — 进化、回测、资金分配",
    finFlow: "生命周期流水线 — 策略晋级、降级、Agent 活动",
    finSetting: "交易设置 — 交易所、风控、Agent、门槛",
