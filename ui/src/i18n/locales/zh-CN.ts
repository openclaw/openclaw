...
export const zh_CN: TranslationMap = {
  ...
  channelsView: {
    ...
    subtitles: {
      ...
      nostr: "通过 Nostr 中继的去中心化私信（NIP-04）。",
    },
    actions: {
      showQr: "显示二维码",
      relink: "重新关联",
    ...
    profile: {
      empty: "尚未设置资料。点击“编辑资料”可添加名称、简介和头像。",
    },
  },
  configFormView: {
  ...
  debugView: {
    ...
    securityAudit: "安全审计：{summary}{infoSuffix}。运行 {command} 查看详情。",
  ...
  gatewayUrlView: {
    ...
    warning: "仅当你信任此 URL 时才确认。恶意 URL 可能危及你的系统。",
  },
};
