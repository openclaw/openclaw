...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    cron: "安排唤醒和重复的代理运行。",
    consent: "模拟经同意授权的工具执行、上下文绑定与遏制控制。",
  ...
  overview: {
    ...
    setupFlow: {
      ...
      subtitle: "按此清单完成首次配置。",
      gateway: "连接网关",
      gatewayHint: "确认 URL 和认证信息后连接。",
      integrations: "配置集成",
      integrationsHint: "完成渠道配置并至少验证一个连接。",
      firstRun: "首次交互",
  ...
  chat: {
    ...
    onboardingBanner: "您正在使用任务控制。使用 ConsentGuard 管理审批、白名单和门控审计。",
    onboardingBannerDismiss: "关闭",
  },
  languages: {
    en: "English",
    zhCN: "简体中文 (简体中文)",
