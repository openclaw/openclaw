...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    ...
    operator: {
      ...
      quota: "Quota",
      quotaLimitLabel: "{label} quota",
      quotaResetShort: "reset {time}",
      quotaTotalDetail: "{total} total",
      quotaUsedDetail: "{used} used",
      quotaUsedOfTotalDetail: "{used} used of {total}",
      ...
      usageQuotaNoWindows:
        "Model auth loaded, but no provider quota limits were returned; showing local session usage.",
