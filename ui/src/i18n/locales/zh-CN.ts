...
export const zh_CN: TranslationMap = {
  ...
  chat: {
    ...
    welcomeSuggestion1: "你可以做什么？",
    welcomeSuggestion2: "总结我最近的会话",
    welcomeSuggestion3: "帮我配置一个频道",
    welcomeSuggestion4: "检查系统健康状态",
    welcomeHint: "在下方输入消息",
    forCommands: "查看命令",
    searchMessages: "搜索消息...",
    you: "你",
    ...
    unpin: "取消置顶",
    close: "关闭",
    addMessageOrPasteMore: "输入消息或继续粘贴更多图片...",
    messageAssistant: "给 {name} 发送消息（回车发送）",
    connectToStart: "连接网关后即可开始聊天...",
    loading: "正在加载聊天",
    noMatchingMessages: "没有匹配的消息",
    queuedCount: "队列中（{count}）",
