...
export const zh_CN: TranslationMap = {
  ...
  channels: {
    health: {
      ...
      warnings: {
        noActiveConnection: "{channel} 正在运行，但未报告活动连接/回读。",
        healthState: "{channel} 健康状态为 {state}。",
        reports: "{channel} 报告：{error}",
        accountHealthState: "{account} 健康状态为 {state}。",
        accountReports: "{account} 报告：{error}",
        accountReadback: "{account} 回读状态为 {state}。",
        accountReadbackWithError: "{account} 回读状态为 {state}：{error}。",
        accountMissingScopes: "{account} 缺少历史/回读权限范围：{scopes}。",
        accountDisconnected: "{account} 正在运行但已断开连接。",
        accountStaleActivity: "{account} 活动已过期。",
      },
    },
    generic: {
      subtitle: "频道状态和配置。",
    ...
    slack: {
      attention: {
        noSocketModeReadback: "Slack Socket Mode 正在运行，但未报告活动回读连接。",
        healthState: "Slack 健康状态为 {state}；入站历史/回读可能已过期。",
        staleTransport: "Slack 传输活动已过期；请验证 Socket Mode 和历史权限范围。",
        readbackWithError: "Slack 消息回读状态为 {state}：{error}。",
        readbackMissingScopes: "Slack 消息回读状态为 {state}；可能缺少历史/回读权限范围。",
        missingScopes: "Slack 缺少历史/回读权限范围：{scopes}。",
      },
    },
