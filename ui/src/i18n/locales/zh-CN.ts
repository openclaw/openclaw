...
export const zh_CN: TranslationMap = {
  ...
  agentTools: {
    connected: "已连接",
    connectedWithPlugin: "已连接：{value}",
    channel: "频道",
    channelWithId: "频道：{value}",
    builtIn: "内置",
    toolAccessTitle: "工具访问",
    toolAccessSubtitle: "此代理的配置档 + 按工具覆盖。已启用 {enabled}/{total}。",
    enableAll: "全部启用",
    disableAll: "全部禁用",
    reloadConfig: "重新加载配置",
    save: "保存",
    saving: "保存中…",
    loading: "加载中…",
    removeAllowlistTitle: "移除按代理 allowlist 并使用全部技能",
    filter: "筛选",
    searchSkillsPlaceholder: "搜索技能",
    shownCount: "显示 {count} 项",
    skillsTitle: "技能",
    skillsSubtitle: "按代理的技能 allowlist 与工作区技能。{enabled}/{total}",
    skillsSubtitleNoCount: "按代理的技能 allowlist 与工作区技能。",
    reset: "重置",
    loadConfigInfo: "加载网关配置以设置按代理的技能。",
    customAllowlistInfo: "此代理正在使用自定义技能 allowlist。",
    allSkillsInfo: "所有技能均已启用。禁用任意技能都会创建按代理的 allowlist。",
    loadSkillsInfo: "加载此代理的技能以查看工作区专属条目。",
    noSkillsFound: "未找到技能。",
    ready: "就绪",
    needsSetup: "需要配置",
  },
