...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    ...
    cards: {
      ...
      skills: "Skills",
      recentSessions: "最近会话",
      judgeGuard: "Judge Guard",
      judgeGuardSubtitle: "Final replies rewritten after Judge did not approve completion.",
      judgeGuardOpenSessions: "会话",
      judgeGuardOpenSession: "Open session transcript",
      judgeGuardInvalid: "INVALID",
      judgeGuardRisk: "risk {risk}",
      judgeGuardRewrites: "{count} rewrites",
      modelAuth: "模型认证",
  ...
  chat: {
    ...
    judgeGuardTargetMissing: "Judge Guard transcript target not found in loaded history.",
    loadJudgeGuardTarget: "Load around target",
    judgeGuardTargetExact: "Judge Guard transcript target loaded by exact run match.",
    judgeGuardTargetFallback: "Judge Guard transcript target loaded by timestamp fallback.",
  },
  languages: {
    en: "英语",
    zhCN: "简体中文 (简体中文)",
