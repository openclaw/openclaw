...
export const zh_CN: TranslationMap = {
  ...
  channels: {
    ...
    subtitles: {
      whatsapp: "连接 WhatsApp Web 并监控连接健康状态。",
      botConfig: "机器人状态和频道配置。",
      googleChat: "Chat API Webhook 状态和频道配置。",
      imessage: "macOS 桥接状态和频道配置。",
      signal: "signal-cli 状态和频道配置。",
      slack: "Socket 模式状态和频道配置。",
      nostr: "通过 Nostr 中继收发去中心化私信（NIP-04）。",
    },
    config: {
      schemaUnavailable: "Schema 不可用。请使用 Raw。",
  ...
  configFormView: {
    unsupportedNode: "不支持的 Schema 节点。请使用 Raw 模式。",
    unsupportedType: "不支持的类型：{type}。请使用 Raw 模式。",
    unsupportedArray: "不支持的数组 Schema。请使用 Raw 模式。",
    hideValue: "隐藏值",
    revealValue: "显示值",
    disableStreamReveal: "禁用流式模式后才能显示值",
    secretRefRawMode: "结构化值 (SecretRef) - 使用 Raw 模式编辑",
    secretRefConfigFile: "结构化值 (SecretRef) - 直接编辑配置文件",
  ...
  agentsView: {
    noAgents: "没有代理",
    selectAgent: "选择一个代理",
    selectAgentSubtitle: "选择代理以查看其工作区和工具。",
    contextTitle: "代理上下文",
    contextSubtitle: "工作区、身份和模型配置。",
    cronContextSubtitle: "工作区和调度目标。",
    actions: {
      copyId: "复制 ID",
    ...
    channels: {
      ...
      noChannels: "未找到频道。",
      connectedSummary: "{connected}/{total} 已连接",
      noAccounts: "无账号",
      configuredSummary: "{count} 已配置",
      notConfigured: "未配置",
      enabledSummary: "{count} 已启用",
      disabledSummary: "已禁用",
      setupGuide: "设置指南",
    },
    scheduler: {
      ...
      jobs: "任务数",
      nextWake: "下次唤醒",
      agentCronJobs: "代理 Cron Jobs",
      agentCronJobsSubtitle: "面向此代理的计划任务。",
      noJobsAssigned: "没有分配任务。",
      runNow: "立即运行",
    },
    files: {
      emptyDraft: "空草稿",
      ...
      previewRenderedMarkdown: "预览渲染后的 Markdown",
      reset: "重置",
      missingCreateHint: "此文件缺失。保存后会在代理工作区中创建它。",
      content: "内容",
      willCreateOnSave: "保存时创建",
  ...
  debugView: {
    ...
    securityAuditRun: "运行",
    securityAuditDetails: "查看详情。",
    manualRpcTitle: "手动 RPC",
    manualRpcSubtitle: "发送原始网关方法及 JSON 参数。",
    method: "方法",
    selectMethod: "选择方法…",
    params: "参数（JSON）",
    modelsTitle: "模型",
  ...
  logsView: {
    ...
    exportVisible: "导出当前可见内容",
    searchPlaceholder: "搜索日志",
    autoFollow: "自动跟随",
    file: "文件：{path}",
    truncated: "日志输出已截断；当前仅显示最新部分。",
    noEntries: "暂无日志条目。",
  },
  execApprovalView: {
    expiresIn: "{value} 后过期",
