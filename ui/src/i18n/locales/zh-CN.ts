...
export const zh_CN: TranslationMap = {
  common: {
    ...
    cmdHelp: "显示可用命令",
    cmdStatus: "显示会话状态",
    cmdExport: "导出会话为 Markdown",
    cmdUsage: "显示 Token 使用量",
    cmdAgents: "列出代理",
    cmdKill: "终止子代理",
    cmdSkill: "运行技能",
    cmdSteer: "引导子代理",
  ...
  overview: {
    ...
    attention: {
      ...
      skillsBlockedPlural: "{count} 个技能被阻止",
      cronJobsFailed: "{count} 个定时任务失败",
      cronJobsFailedPlural: "{count} 个定时任务失败",
      gatewayError: "网关错误",
