...
export const zh_CN: TranslationMap = {
  ...
  nodes: {
    ...
    inventory: {
      ...
      olderPairing: "{name} 的 {count} 个较早配对",
      olderPairings: "{name} 的 {count} 个较早配对",
      autoPaired: "自动配对",
      versionDrift: "版本偏差",
      versionDriftTitle:
        "节点 {nodeVersion}；Gateway {gatewayVersion}。请更新较旧的组件以对齐整个集群。",
      manualWake: "需要手动唤醒",
    ...
    execApprovals: {
      title: "执行审批",
      subtitlePrefix: "允许列表和审批策略，适用于",
      loadHint: "加载执行审批以编辑允许列表。",
      hostNativePolicy: "主机原生策略",
      hostNativeHint: "此处为只读。请从配套应用或 CLI 编辑。",
      native: "原生",
      defaultAction: "默认操作",
      rule: "{count} 条规则",
      rules: "{count} 条规则",
  ...
  agents: {
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "按智能体的 Skills 允许列表和工作区 Skills。",
      loadConfig: "加载 gateway 配置以设置按智能体的 Skills。",
      customAllowlist: "此智能体使用自定义 Skills 允许列表。",
      allEnabled: "所有 Skills 均已启用。禁用任何 Skill 都将创建按智能体的允许列表。",
      loadAgent: "为此智能体加载 Skills 以查看工作区专属条目。",
      filter: "筛选",
  ...
  configForm: {
    ...
    structuredSecretRaw: "结构化值 (SecretRef) - 使用 Raw 模式编辑",
    structuredSecretFile: "结构化值 (SecretRef) - 直接编辑配置文件",
    defaultValue: "默认：{value}",
    resetToDefault: "重置为默认",
    select: "选择...",
    jsonValue: "JSON 值",
    unsupportedArray: "不支持的数组 schema。请使用 Raw 模式。",
    itemCountOne: "{count} 项",
    itemCount: "{count} 项",
    add: "添加",
    noItems: "暂无项目。点击“添加”以创建。",
    removeItem: "移除项目",
    customEntries: "自定义条目",
    addEntry: "添加条目",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      fallbackLogo: "备用徽标",
      avatarIssues: {
        remoteBlocked: "远程 URL 已被 Control UI 图片策略阻止",
        missing: "找不到文件",
    ...
    pending: {
      title: "未保存的更改",
      hint: "保存将存储您的更改。“立即应用”还会重新加载当前会话。",
      discard: "放弃",
      applying: "正在应用…",
      applyNow: "立即应用",
    },
  ...
  configView: {
    ...
    notifications: {
      ...
      subscribing: "正在订阅…",
      enable: "启用通知",
      blockedHint: "通知已被阻止。请更新浏览器的站点权限以允许通知。",
    },
    appearance: {
      theme: "主题",
      ...
      importHint: "将 tweakcn 主题导入此浏览器本地插槽",
      importFromTweakcn: "从 tweakcn 导入",
      tweakcnInstructions:
        "打开 tweakcn.com，选择或创建一个主题，点击 Share，然后将复制的主题链接粘贴到此处。接受分享链接、编辑器 URL、注册表 URL、主题 ID 以及像 amethyst-haze 这样的默认主题名称。",
    ...
    rawDiffUnavailable: "检测到更改（JSON diff 不可用）",
    hideEnvValues: "隐藏环境变量值",
    revealEnvValues: "显示环境变量值",
    peek: "查看",
    loadingSchema: "正在加载 schema…",
    formUnsafe: "您的配置包含表单编辑器无法安全表示的字段。请使用 Raw 模式编辑这些条目。",
    ...
    sensitiveHidden: "已隐藏 {count} 个敏感值。使用上方的显示按钮编辑原始配置。",
    sensitiveHiddenPlural: "已隐藏 {count} 个敏感值。使用上方的显示按钮编辑原始配置。",
  },
  execApproval: {
    expiresIn: "{time} 后过期",
    expired: "已过期",
  ...
  agentTools: {
    ...
    enabledByProfile: "由当前配置文件启用。",
    enabledByOverride: "已被代理覆盖启用。",
  ...
  mcpPage: {
    ...
    operatorCommandsHint: "状态、诊断、认证、探测和运行时重载。",
    runtimeHint: "运行时更改在保存并发布后生效；活动代理会在下次使用时重建 MCP 运行时。",
    toolFilter: "工具过滤器",
    parallel: "并行",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      linear: "直接在聊天中分类问题、更新周期和提交缺陷。",
      todoist: "在 Todoist 中读取、添加和完成任务与项目。",
      airtable: "在 Airtable 中查询和更新记录、表格与库。",
      jira: "在聊天中创建、搜索和分类 Jira 工单。",
      canva: "创建和编辑 Canva 设计、管理素材并导出结果。",
      stripe: "在你的 Stripe 账户中查看付款、客户、发票和订阅。",
      googleCalendar: "读取、创建和了解日程事件——让你的代理掌控你的日程。",
      email: "邮箱分类、摘要和草稿，并支持经批准后发送。",
      pdf: "提取、合并、转换和 OCR 识别 PDF 文档。",
      transcription: "将音频和视频转换为清晰、结构化的转录文本。",
      github: "通过官方 GitHub MCP 处理 PR 审查队列、问题分类和仓库问答。",
      sentry: "崩溃警报触发的瞬间即得到解释和分类。",
      context7: "编码时提供特定版本的库文档和代码示例。无需注册。",
      deepwiki: "对任何公开的 GitHub 仓库提问。免费，无需账户。",
      huggingFace: "搜索模型、数据集和论文；将 Spaces 作为工具运行。",
      grafana: "Grafana 专业知识和社区连接器，用于仪表板和警报。",
      kubernetes: "通过聊天进行集群操作和故障排查。",
      homeAssistant: "控制全屋的灯光、温控和自动化。",
      spotify: "搜索、排队并用基于心情的播放列表为你的一天配乐。",
      sonos: "全屋音频：通过聊天播放、分组房间和排队。",
      reddit: "浏览、搜索并总结 subreddit 和讨论帖。",
      markets: "实时股票和加密货币，提供价格警报和每日摘要。",
      travel: "航班和酒店搜索，具有票价关注和行程记忆功能。",
      news: "个性化每日简报：一条消息中包含新闻、天气和任务。",
      maps: "地点、路线和出行时间解答。",
      translation: "翻译和本地化文本与文档。",
      notes: "将笔记捕获到 Markdown、Obsidian、Notion 或 Bear。",
    },
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "{verb}提案",
      description: "告诉智能体应该修改什么。提案将保持待处理状态，工作室会创建一个修订版本。",
      placeholder: "示例：让它使用 Gmail 标签而不是未读搜索，并添加一个更安全的试运行步骤。",
      preparing: "正在准备修订交接",
      send: "发送修订",
    },
    queue: {
    ...
    empty: {
      ...
      pendingBody: "新草稿在需要审核时会显示在此处。",
      appliedTitle: "尚未应用任何内容",
      appliedBody: "使用待处理的提案后，它将作为实时技能显示在此处。",
      rejectedTitle: "没有被拒绝的提案",
      rejectedBody: "已跳过的提案将保留在此处，以保持清晰的审核记录。",
      quarantinedTitle: "没有隔离的内容",
      quarantinedBody: "被扫描器拦截或因安全原因暂留的提案将显示在此处。",
      staleTitle: "没有过时的提案",
      staleBody: "无法再干净应用的提案将显示在此处。",
      allTitle: "此处没有提案",
      allBody: "当您的智能体起草时，Skill Workshop 提案将显示在此处。",
      defaultAgent: "您的智能体",
    ...
    today: {
      emptyTitle: "今天没有等待处理的内容",
      emptyBody: "您的智能体没有起草任何新内容。切换到 Board 以浏览历史记录。",
      new: "新增",
      waiting: "等待中",
      reviewed: "已审阅",
      agent: "agent",
      ...
      tweakIt: "调整它",
      askAgent: "让 agent 更改内容",
      skipping: "正在跳过…",
      skip: "跳过",
      notForMe: "不适合我",
      upNext: "接下来 · 还有 {count} 个等待处理",
      seeAll: "查看所有提案 →",
      collection: "你的收藏 · 使用中 {count} 个",
      manage: "管理 →",
      workflowHeading: "代理将如何使用它",
      applicabilityHeading: "代理何时应使用它",
    },
    relative: {
      secondsAgo: "{count} 秒前",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      palaceTab: "记忆宫殿",
      dreamsExplainer:
        "这是系统在回放和整合记忆时所写的原始梦境日记；用它来查看记忆系统正在关注什么，以及哪些地方仍显得杂乱或稀薄。",
      insightsExplainer:
        "这些是从外部历史聚类得来的导入洞见；用它们来审阅导入所呈现的内容，然后其中任何部分才会晋升为持久记忆。",
      palaceExplainer:
        "这是系统可以搜索和推理的已编译记忆 wiki 界面；用它来查看实际的记忆页面、论断、未解问题和矛盾之处，而非原始导入的源聊天记录。",
      copyArchivePath: "复制归档路径",
      loadingInsights: "正在加载导入的洞见…",
      noInsights: "尚无导入的洞见",
      noInsightsHint: "运行带应用的 ChatGPT 导入，以在此处呈现聚类的导入洞见。",
      ...
      emptyPalaceHint:
        "目前 wiki 主要包含原始来源导入和运行报告。当开始撰写综述、实体或概念后，此标签页才会变得有用。",
      claims: "主张",
      openQuestions: "未决问题",
      contradictions: "矛盾",
      pageDetails: "页面详情",
      ...
      unavailablePluginPrefix: "导入洞察和记忆宫殿由捆绑的",
  ...
  chat: {
    ...
    compaction: {
      label: "已压缩的历史记录",
      description: "压缩后的对话记录会作为检查点保留。打开会话检查点即可从该压缩视图分支或恢复。",
    ...
    commands: {
      ...
      redirectDescription: "中止并使用新消息重新启动",
      steerDescription: "向活动运行中注入消息",
      categories: {
        session: "会话",
        model: "模型",
        agents: "Agents",
  ...
  cron: {
    ...
    list: {
      ...
      newTask: "新建任务",
      filters: "筛选",
      shownOf: "{total} 中的 {shown}",
      emptyTitle: "暂无计划任务",
      emptyHint: "描述 OpenClaw 应做什么以及何时执行——它将按计划运行。",
    ...
    detail: {
      newTitle: "新建计划任务",
      newSubtitle: "描述 OpenClaw 应做什么，然后选择运行时间。",
      overviewTitle: "近期活动",
      overviewSubtitle: "所有计划任务的最近运行。",
      historyTitle: "运行历史",
      detailsSection: "详情",
      frequencySection: "频率",
      paused: "已暂停",
    ...
    form: {
      ...
      repeatCron: "Cron 表达式",
      repeatOnExit: "退出时",
      onExitHelp: "在受监视的命令退出时运行。此处无法编辑计划。",
      every: "每隔",
      at: "指定时间",
      cronOption: "Cron",
      runAt: "运行时间",
      ...
      seconds: "秒",
      accountId: "账户 ID",
      accountIdHelp: "用于多账户配置的可选渠道账户 ID。",
      lightContext: "轻量上下文",
