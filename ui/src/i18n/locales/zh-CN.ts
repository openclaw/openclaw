...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "已配置的提供商，包含套餐、配额和费用信息。",
  ...
  workspaces: {
    ...
    widget: {
      ...
      customWidgetApprovals: {
        empty: "没有等待审批的自定义小组件。",
        kind: "自定义小组件",
        requestedBy: "由 {agent} 请求",
        approve: "批准",
        reject: "拒绝",
        permissionRequired: "需要审批权限",
      },
      usage: {
        cost: "Cost",
        tokens: "Tokens",
  ...
  modelProviders: {
    title: "已配置的提供商",
    subtitle: "包含身份验证、套餐、配额和费用数据的模型提供商。",
    updated: "已更新 {time}",
    refreshing: "正在刷新…",
    disconnected: "连接到 Gateway 以查看已配置的模型提供商。",
    emptyTitle: "未配置模型提供商",
    emptySubtitle: "登录提供商或添加 API 密钥，然后刷新。",
    status: {
      ok: "已连接",
      expiring: "即将过期",
      expired: "已过期",
    ...
    expiresIn: "凭据将于 {time} 过期",
    models: "{count} 个模型",
    modelOne: "1 个模型",
    modelsAvailable: "{count} 个模型中 {available} 个可用",
    noStats: "此提供商未报告实时使用数据。",
    localCost: "会话消耗 · {days}天",
    localCostDetail: "{tokens} 令牌 · {sessions} 个会话",
    saving: "正在保存…",
    requestFailed: "请求失败。",
