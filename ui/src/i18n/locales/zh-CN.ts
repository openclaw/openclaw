...
export const zh_CN: TranslationMap = {
  ...
  agents: {
    ...
    skillsPanel: {
      architectureTitle: "Architecture Agents",
      architectureInterfacesFrom: "Skill-declared agent interfaces from",
      architectureManifestPath: "agents/openai.yaml",
      architectureNoMatch: "No architecture agents match the current filter.",
      architectureSurfaceFallback: "Skill-declared agent surface.",
      architectureChip: "architecture agent",
  ...
  subtitles: {
    agents: "工作区、工具、身份。",
    overview: "状态、入口点、健康。",
    tradingDesk: "Capital Quotes, agent guardrails, and paper-trading safety.",
    channels: "频道和设置。",
    instances: "已连接客户端和节点。",
    sessions: "活动会话和默认设置。",
    usage: "API 使用情况和成本。",
  ...
  tradingDesk: {
    status: {
      title: "Capital Trading Desk",
      subtitle: "Capital Quotes + Capital API Agent safety snapshot.",
      lastRefresh: "Last refresh: {time}",
      route: "Route",
      routePath: "/trading-desk",
      gateway: "Gateway contract",
      gatewayHint: "Requires trading.snapshot RPC on the active gateway.",
      mode: "Execution mode",
      modeHint: "Paper-only mode is required for this control surface.",
      runtime: "Feed runtime",
      runtimeHint: "Current connected and running channel feed counts.",
      feedsTotal: "total:{count}",
      feedsConnected: "connected:{count}",
      feedsRunning: "running:{count}",
      safety: "Safety gates",
      safetyHint: "All high-risk gates must stay locked unless explicitly approved.",
      liveTradingGate: "Live trading",
      paidProviderGate: "Paid provider actions",
      writesGate: "Write actions",
      highRiskGate: "High-risk actions",
    },
    badges: {
      wired: "Wired",
