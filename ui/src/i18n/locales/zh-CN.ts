...
export const zh_CN: TranslationMap = {
  ...
  chat: {
    ...
    slashCommands: {
      ...
      showMore_one: "显示另外 {count} 个命令",
      showMore_other: "显示另外 {count} 个命令",
      badge: {
        options: "{count} 个选项",
        instant: "即时",
      },
      ariaLabel: "斜杠命令",
      commandAriaLabel: "命令参数",
      commandDescriptions: {
        help: "显示可用命令。",
        commands: "列出所有斜杠命令。",
        tools: "列出可用运行时工具。",
        skill: "按名称运行技能。",
        status: "显示当前状态。",
        diagnostics: "解释网关诊断和 Codex 反馈上传选项。",
        crestodian: "运行 Crestodian 设置和修复助手。",
        tasks: "列出此会话的后台任务。",
        allowlist: "列出/添加/移除白名单条目。",
        approve: "批准或拒绝执行请求。",
        context: "解释上下文的构建和使用方式。",
        btw: "问一个附带问题，不改变未来会话上下文。",
        "export-session": "导出当前会话为包含完整系统提示词的 HTML 文件。",
        "export-trajectory": "导出当前会话的 JSONL 轨迹包。",
        tts: "控制文本转语音 (TTS)。",
        whoami: "显示你的发送者 ID。",
        session: "管理会话级设置（例如 /session idle）。",
        subagents: "列出、终止、查看日志、生成或引导此会话的子代理运行。",
        acp: "管理 ACP 会话和运行时选项。",
        focus: "将此线程（Discord）或主题/对话（Telegram）绑定到会话目标。",
        unfocus: "移除当前线程（Discord）或主题/对话（Telegram）的绑定。",
        agents: "列出绑定到此会话的代理。",
        kill: "终止运行中的子代理（或全部）。",
        steer: "向当前运行注入消息",
        config: "显示或设置配置值。",
        mcp: "显示或设置 OpenClaw MCP 服务器。",
        plugins: "列出、显示、启用或禁用插件。",
        debug: "设置运行时调试覆盖。",
        usage: "使用页脚或成本摘要。",
        stop: "停止当前运行。",
        restart: "重启 OpenClaw。",
        ...
        models: "列出模型提供商/模型。",
        queue: "调整队列设置。",
        bash: "运行主机 shell 命令（仅限主机）。",
        clear: "清空聊天历史",
        redirect: "中止并用新消息重启",
        phone: "启用/禁用高风险手机节点命令（摄像头/屏幕/写入）。",
        voice: "列出/设置 Talk 提供商语音（影响 iOS Talk 播放）。",
      },
      argChoices: {
        on: "开启",
        off: "关闭",
    ...
    talk: {
      ...
      high: "高",
      vadPlaceholder: "0.5",
      silenceMsPlaceholder: "500",
      prefixMsPlaceholder: "300",
    },
    searchMessages: "搜索消息...",
  },
  languages: {
