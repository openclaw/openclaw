...
export const zh_CN: TranslationMap = {
  ...
  config: {
    ...
    diff: {
      pendingChanges: "查看 {count} 项待处理的更改",
      path: "路径",
      from: "原值",
      to: "新值",
    },
    ...
    sections: {
      ...
      update: { label: "更新", description: "自动更新行为和频道" },
      apiKeys: { label: "API 密钥", description: "提供商密钥和认证令牌" },
      memory: { label: "记忆", description: "记忆索引、嵌入和召回" },
      history: { label: "历史记录", description: "对话历史和上下文窗口" },
      ...
      bindings: { label: "快捷键", description: "按键绑定和快捷方式" },
