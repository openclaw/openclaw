...
export const zh_CN: TranslationMap = {
  ...
  cron: {
    ...
    form: {
      ...
      agentTurn: "运行助手任务（隔离）",
      acpTurn: "运行 ACP 工具（Claude Code / Codex / Gemini CLI）",
      systemEventHelp: "将文本发送到网关主时间线（适用于提醒/触发）。",
      agentTurnHelp: "使用您的提示在独立会话中启动助手运行。",
      acpTurnHelp: "直接以单次隔离运行方式调用 ACP 工具（Claude Code、Codex、Gemini CLI 等）。",
      acpAgentId: "ACP 代理",
      acpAgentIdPlaceholder: "如 codex、claude、gemini",
      acpAgentIdHelp: "要调用的 ACP 工具（codex、claude、gemini、opencode、kimi、pi）。",
      timeoutSeconds: "超时（秒）",
