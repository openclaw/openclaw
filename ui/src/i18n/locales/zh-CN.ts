...
export const zh_CN: TranslationMap = {
  ...
  cron: {
    ...
    form: {
      ...
      sessionKey: "会话密钥",
      sessionKeyHelp: "作业投递和唤醒路由的可选路由键。",
      accountId: "账户 ID",
      accountIdHelp: "多账户设置的可选频道账户 ID。",
      lightContext: "轻量上下文",
      lightContextHelp: "对此代理作业使用轻量级引导上下文。",
      failureAlerts: "失败告警",
      failureAlertInherit: "继承全局设置",
      failureAlertDisabled: "为此作业禁用",
      failureAlertCustom: "自定义每项作业设置",
      failureAlertsHelp: "控制此作业何时发送重复失败告警。",
      failureAlertAfter: "失败告警于",
      failureAlertCooldown: "失败告警冷却时间",
      alertAfter: "告警于",
      alertAfterHelp: "告警前的连续错误次数。",
      cooldownSeconds: "冷却时间（秒）",
      cooldownHelp: "告警之间的最短秒数。",
      alertChannel: "告警频道",
      alertTo: "告警收件人",
      alertToPlaceholder: "+1555... 或聊天 ID",
      alertToHelp: "失败告警的可选收件人覆盖。",
      alertMode: "告警模式",
      alertModeAnnounce: "播报（通过频道）",
