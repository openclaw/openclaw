...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    ...
    operator: {
      attentionSubtitle: "Failures, expiring auth, and blocked work.",
      activeSessions: "{active}/{total} active",
      activeWork: "Active work",
      apiKeyOnlyUnavailable: "api-key-only or unavailable",
      connectorsSkillsTitle: "Connectors & Skills",
      connectorsSkillsSubtitle: "Auth and capability health that can break work later.",
      cronSubtitle: "Failures, overdue jobs, and next wake.",
      events: "Events",
      errors: "错误",
      failedOrTimedOutCount: "{count} failed or timed out",
      expiredCount: "{count} 已过期",
      expiredCountPlural: "{count} 已过期",
      expiringCount: "{count} 即将过期",
      expiringCountPlural: "{count} 即将过期",
      failed: "failed",
      failedCount: "{count} failed",
      failedCountPlural: "{count} failed",
      gatewayAuthClear: "Gateway and monitored auth are clear.",
      gateway: "Gateway",
      jobsCount: "{count} jobs",
      killed: "killed",
      lastRunFailed: "last run failed",
      logEventAnomaliesTitle: "Log & Event Anomalies",
      logEventAnomaliesSubtitle: "Raw logs stay behind expanders unless something clusters.",
      logLines: "Log lines",
      messages: "消息",
      monitoredProvidersOk: "{count} monitored providers ok",
      moreAttentionItem: "{count} more attention item",
      moreAttentionItems: "{count} more attention items",
      moreSession: "{count} more session",
      moreSessions: "{count} more sessions",
      noFailedActiveSessions: "no failed active sessions",
      nextRunOverdue: "next run is overdue",
      noExpiringProviders: "No expiring OAuth/token providers reported.",
      noFailedCronJobs: "No failed cron jobs",
      noNextWakeScheduled: "No next wake scheduled.",
      noRecentSessionsMatch: "No recent sessions match the current view.",
      noSessionsLoaded: "No sessions loaded",
      noUrgentAttention: "No urgent attention items",
      okCount: "{count} 正常",
      overdue: "overdue",
      overviewSummary: "Overview summary",
      providerUsageTitle: "Provider Usage",
      providerUsageSubtitle: "Compact view of model usage, costs, and quota signals.",
      quota: "Quota",
      quotaResetShort: "reset {time}",
      recentSessionsSubtitle: "Current work state, model, and recency.",
      refreshed: "refreshed",
      fresh: "fresh",
      sessionDataLoading: "Session data is still loading.",
      skillStatusUnavailable: "Skill status unavailable.",
      skillsEnabled: "{enabled}/{total} enabled",
      skillsEnabledBlocked: "{enabled}/{total} enabled, {blocked} blocked",
      tokens: "Token",
      tokensCount: "{count} tokens",
      timeout: "timeout",
      usageCostMessages: "{cost} / {count} msgs",
      usageQuotaLoading: "Provider quota is still loading; showing local session usage meanwhile.",
      usageQuotaNoWindows:
        "Model auth loaded, but no provider quota windows were returned; showing local session usage.",
      usageQuotaNotConfigured:
        "No OAuth provider quota is configured for this setup; showing local session usage.",
      usageQuotaResets: "{provider} {window} window resets {time}.",
      usageQuotaWindow: "{provider} {window} window.",
      uptime: "uptime {time}",
      warnings: "Warnings",
    },
    eventLog: {
