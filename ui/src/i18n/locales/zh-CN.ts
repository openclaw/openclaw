...
export const zh_CN: TranslationMap = {
  ...
  config: {
    ...
    section: {
      ...
      environmentVariablesDesc: "传递给网关进程的环境变量",
      updates: "更新",
      updatesDesc: "自动更新设置和发布频道",
      agents: "代理",
      agentsDesc: "代理配置、模型和身份",
      authentication: "认证",
      authenticationDesc: "API 密钥和认证配置文件",
      channels: "频道",
      ...
      setupWizard: "设置向导",
      setupWizardDesc: "设置向导状态和历史",
      metadata: "元数据",
      metadataDesc: "网关元数据和版本信息",
      logging: "日志",
      ...
      pluginsDesc: "插件管理和扩展",
      diagnostics: "诊断",
      diagnosticsDesc: "仪器、OpenTelemetry 和缓存跟踪设置",
      cli: "CLI",
      cliDesc: "CLI 横幅和启动行为",
      secrets: "密钥",
      secretsDesc: "密钥提供商配置",
      acp: "ACP",
      acpDesc: "代理通信协议运行时和流设置",
      mcp: "MCP",
      mcpDesc: "模型上下文协议服务器定义",
      theme: "主题",
      wizard: "设置向导",
    },
    themeRoundness: {
    ...
    theme: {
      chromaFamily: "Chroma 系列",
      blackRed: "黑红",
      chocolateBlueprint: "巧克力蓝图",
      importedTheme: "导入的主题",
      import: "导入",
      importedFrom: "从 tweakcn 导入: {name}",
      importDescription: "将 tweakcn 主题导入到此浏览器本地插槽",
      title: "主题",
      chooseFamily: "选择主题系列。",
      importTitle: "从 tweakcn 导入",
      importInstructions:
        "打开 tweakcn.com，选择或创建主题，点击分享，然后在此处粘贴复制的主题链接。接受分享链接、编辑器 URL、注册表 URL、主题 ID 以及 amethyst-haze 等默认主题名称。",
      browse: "浏览 tweakcn 主题",
      linkOrId: "主题链接或 ID",
      linkPlaceholder: "https://tweakcn.com/editor/theme?theme=... 或 amethyst-haze",
      importing: "导入中…",
      replace: "替换 {name}",
      importTheme: "导入主题",
      clear: "清除 {name}",
      loaded: "已加载",
      importHint:
        "点击**导入**添加一个浏览器本地 tweakcn 主题。在 tweakcn 中，使用分享并粘贴复制的链接到这里。",
      roundnessTitle: "圆角",
      roundnessHint: "调整整个 UI 的圆角半径。",
    },
    pushNotifications: {
      title: "推送通知",
      notAvailable: "此浏览器不可用。",
      granted: "已授予",
      denied: "已拒绝",
      notRequested: "未请求",
      unsupported: "不支持",
      subscribeHint: "订阅以从网关接收浏览器推送通知。",
    ...
    mode: {
      form: "表单",
      formTooltip: "表单视图无法安全编辑某些字段",
      raw: "原始",
      rawTooltip: "编辑原始 JSON/JSON5 配置",
      rawUnavailable: "此快照无法使用原始模式",
    },
    changes: {
      unsaved: "未保存的更改",
      none: "无更改",
      unsavedTooltip: "{count} 个未保存的更改",
      rawDisabled: "原始模式已禁用 (快照无法安全地进行原始文本往返)。",
      openPath: "打开 {path}",
      openFile: "打开配置文件",
      open: "打开",
    },
    ...
    diff: {
      ...
      viewPending: "查看待处理的更改",
      noJsonDiff: "检测到更改 (JSON 差异不可用)",
    },
    env: {
      hide: "隐藏环境值",
      reveal: "显示环境值",
    ...
    raw: {
      ...
      secrets: "{count} 个密钥 已隐藏/可见",
      reveal: "显示敏感值",
      hide: "隐藏敏感值",
      toggleAria: "切换原始配置编辑",
      hiddenHint: "{values} 已隐藏。使用上方的显示按钮编辑原始配置。",
    ...
    quick: {
      ...
      import: {
        ...
        outsideWorkspace: "超出工作区范围",
        tooLarge: "图片过大",
        cannotRender: "无法渲染头像",
      },
      personalCard: "个人",
      userIdentity: "你的本地聊天身份",
      user: "用户",
      avatarBrowserLocal: "头像为浏览器本地",
      avatarText: "头像文字 / 表情",
      avatarPlaceholder: "JD 或 🦞",
      chooseImage: "选择图片",
      clearAvatar: "清除头像",
      storedLocally: "仅存储在此浏览器中。",
      ...
      fallbackLogo: "回退 logo",
      replaceImage: "替换图片",
      clearOverride: "清除覆盖",
      overrideHint: "存储 Control UI 覆盖。清除它以返回到 IDENTITY.md。",
      contextProfile: "上下文配置文件",
      pending: "待处理",
      saved: "已保存",
      custom: "自定义",
      bootstrapContext: "引导上下文",
      bootstrapContextHint:
        "选择 OpenClaw 在每个运行中注入多少工作区上下文。这些配置文件不会更改你的模型、工具、频道或主题。",
      selectedProfile: "已选择的配置文件",
      currentValues: "当前值",
      customConfiguration: "自定义配置",
      customDescription: "此配置当前与内置配置文件之一不匹配。",
      customImpact: "选择一个配置文件以对引导大小和后续行为进行有针对性的更改。",
      bootstrapPerFile: "每个文件的引导",
      bootstrapTotal: "引导总计",
      followUpTurns: "后续轮次",
      saveProfile: "保存配置文件",
      saveChanges: "保存更改",
      applyNow: "立即应用",
      savedReady: "已保存并准备就绪。选择另一个配置文件以进行更改。",
      customReady: "当前值为自定义。选择配置文件以进行更改。",
      presetNotSaved: "{preset} 已选择但尚未保存。",
      presetCurrentDefault: "{preset} 是您的当前默认值。",
      profilesOnlyChange: "配置文件仅更改引导大小和后续重新注入行为。",
      customActive: "自定义引导设置已激活。",
      chooseBuiltinProfile: "选择一个内置配置文件以替换当前的自定义值。",
      advanced: "高级",
      themeMode: {
        light: "浅色",
        dark: "深色",
      ...
      charBudget: "{value} 字符",
      everyTurn: "每轮",
      skipFollowUps: "跳过安全的后续",
      reinjectContext: "在每轮中重新注入工作区引导上下文。",
      skipReinjection: "在完成安全的后续后跳过引导重新注入。",
      wasValue: "原为 {value}",
      matchesCurrentDefault: "与当前默认值匹配",
      commitCopyProfile: "保存配置文件会将其设为默认值。立即应用会写入并重新加载当前会话。",
      commitCopyPending: "其他暂存的配置编辑待处理。在此保存将提交所有暂存的配置更改。",
      bootstrapPerFileNote: "从任何单个引导文件注入的最大上下文。",
      bootstrapTotalNote: "所有引导文件允许的总组合上下文。",
    },
    preset: {
      personal: {
        label: "个人助手",
        description: "日常使用的平衡默认值。",
        detail: "适合聊天、文档和轻度编辑，无需大量编码预算。",
        impact: "每轮注入引导上下文，具有适度的提示预算。",
      },
      codeAgent: {
        label: "代码代理",
        description: "仓库工作的最高上下文预算。",
        detail: "最适合多文件更改、长引导文档和代码密集型会话。",
        impact: "使用最大的提示预算，每轮重新注入上下文。",
      },
      teamBot: {
        label: "团队机器人",
        description: "共享机器人的精简后续。",
        detail: "最适合连续性比大型引导负载更重要的多渠道工作流。",
        impact: "通过跳过安全的连续重新注入来保持后续轮次更小。",
      },
      minimal: {
        label: "最小化",
        description: "最小的上下文预算和最低的成本。",
        detail: "最适合快速实用轮次、自动化和成本敏感的工作流。",
        impact: "使用最小的引导预算和最精简的后续行为。",
      },
    },
    form: {
      schemaUnavailable: "架构不可用。",
      unsupportedSchema: "不支持的架构。使用原始模式。",
      noMatch: '无匹配 "{query}" 的设置',
      noSettings: "此部分无设置",
      hideValue: "隐藏值",
      revealValue: "显示值",
      disableStreamToReveal: "禁用流模式以显示值",
      secretRefRaw: "结构化值 (SecretRef) - 使用原始模式编辑",
      secretRefDirect: "结构化值 (SecretRef) - 直接编辑配置文件",
