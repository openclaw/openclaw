...
export const zh_CN: TranslationMap = {
  ...
  channels: {
    refreshingStaleSnapshot: "正在后台刷新频道状态；当前显示最近一次成功获取的快照。",
    config: {
    ...
    nostr: {
      title: "Nostr",
      subtitle: "通过 Nostr 中继进行去中心化私信通信（NIP-04）。",
      profile: "个人资料",
      editProfile: "编辑个人资料",
      profilePicture: "头像",
      noProfile: "尚未设置个人资料。",
  ...
  nodes: {
    ...
    inventory: {
      ...
      paired: "已配对",
      empty: "没有已配对的设备。",
      connectedWithoutPairing: "未配对但已连接",
      olderPairing: "{name} 的 {count} 个较旧配对",
      olderPairings: "{name} 的 {count} 个较旧配对",
      autoPaired: "自动配对",
      versionDrift: "版本不一致",
      versionDriftTitle:
        "节点 {nodeVersion}；Gateway {gatewayVersion}。请更新较旧的组件，使整个设备群版本一致。",
      manualWake: "需要手动唤醒",
      manualWakeTitle: "Gateway 无法唤醒离线的 Windows 节点。请启动计算机或恢复其网络连接。",
      approvalNeeded: "需要批准",
      inputAgo: "{time}前输入",
      seen: "于{time}出现",
      approved: "于{time}批准",
      ...
      revoke: "撤销",
      none: "无",
      rolesAndScopes: "角色：{roles} · 权限范围：{scopes}",
      scopeUpgrade: "权限范围升级需要批准",
      roleUpgrade: "角色升级需要批准",
      reapproval: "重新连接的详细信息已更改；需要批准",
      newPairing: "新设备配对请求",
      repair: "修复",
      requestedAt: "{note} · 请求于 {time}",
      requestedAccess: "请求的访问权限：{access}",
      approvedAccess: "当前已批准：{access}",
    },
    execApprovals: {
      title: "执行审批",
      subtitlePrefix: "以下对象的允许列表和审批策略：",
      loadHint: "加载执行审批以编辑允许列表。",
      hostNativePolicy: "主机原生策略",
      hostNativeHint: "此处为只读。请通过配套应用或 CLI 编辑。",
      native: "原生",
      defaultAction: "默认操作",
      rule: "{count} 条规则",
      rules: "{count} 条规则",
      ...
      askFallback: "询问回退",
      promptUnavailable: "当 UI 提示不可用时应用。",
      fallback: "后备选项",
      autoAllowSkills: "自动允许 Skills CLI",
      autoAllowSkillsHint: "允许 Gateway 列出的 Skills 可执行文件。",
      usingDefault: "正在使用默认值（{value}）。",
      override: "覆盖值（{value}）。",
      enabled: "已启用",
      useDefault: "使用默认值",
      allowlist: "允许列表",
  ...
  agents: {
    ...
    overview: {
      ...
      selectedSkills: "已选择 {count} 项",
      allSkills: "所有技能",
      unsavedConfig: "您有尚未保存的配置更改。",
      modelSelection: "模型选择",
      primaryModel: "主要模型",
    ...
    toolCatalog: {
      ...
      descriptions: {
        ...
        memoryGet: "读取记忆文件",
        sessionsList: "列出会话",
        sessionsHistory: "会话历史记录",
        sessionsSend: "发送至会话",
        sessionsSpawn: "创建子智能体",
        sessionStatus: "会话状态",
        browser: "控制网页浏览器",
        canvas: "控制画布",
        message: "发送消息",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "每个代理的技能允许列表和工作区技能。",
      loadConfig: "加载 Gateway 配置以设置每个代理的技能。",
      customAllowlist: "此代理使用自定义技能允许列表。",
      allEnabled: "所有技能均已启用。禁用任何技能都会创建每个代理的允许列表。",
      loadAgent: "加载此代理的技能以查看工作区特定条目。",
      filter: "筛选",
  ...
  configForm: {
    ...
    structuredSecretRaw: "结构化值 (SecretRef) - 请使用 Raw 模式进行编辑",
    structuredSecretFile: "结构化值 (SecretRef) - 请直接编辑配置文件",
    defaultValue: "默认值：{value}",
    resetToDefault: "重置为默认值",
    select: "选择...",
    jsonValue: "JSON 值",
    unsupportedArray: "不支持的数组架构。请使用 Raw 模式。",
    itemCountOne: "{count} 个项目",
    itemCount: "{count} 个项目",
    add: "添加",
    noItems: "暂无项目。点击“添加”创建一个项目。",
    removeItem: "移除项目",
    customEntries: "自定义条目",
    addEntry: "添加条目",
    ...
    unsupportedNode: "不支持的架构节点。请使用原始模式。",
    ...
    sections: {
      ...
      gateway: {
        label: "Gateway",
        description: "Gateway 服务器设置（端口、身份验证、绑定）",
      },
      wizard: {
        label: "设置向导",
      ...
      models: {
        label: "模型",
        description: "AI 模型配置和提供商",
      },
      bindings: {
        label: "按键绑定",
        description: "按键绑定和快捷键",
      },
      broadcast: {
        label: "广播",
        description: "广播和通知设置",
      ...
      session: {
        label: "会话",
        description: "会话管理和持久化",
      },
      cron: {
        label: "Cron",
        description: "计划任务和自动化",
      },
      web: {
        label: "Web",
        description: "Web 服务器和 API 设置",
      },
      discovery: {
        label: "发现",
        description: "服务发现和网络设置",
      },
      canvasHost: {
        label: "画布主机",
        description: "画布渲染和显示",
      ...
      diagnostics: {
        label: "诊断",
        description: "检测、OpenTelemetry 和缓存跟踪设置",
      },
      cli: {
        label: "CLI",
      ...
      acp: {
        label: "ACP",
        description: "Agent Communication Protocol 运行时和流式传输设置",
      },
      mcp: {
        label: "MCP",
  ...
  quickSettings: {
    ...
    automation: {
      ...
      installedSkills: "已安装 {count} 个 skills",
      mcpServer: "{count} 个 MCP server",
      mcpServers: "{count} 个 MCP servers",
      manage: "管理 →",
      browse: "浏览 →",
      configure: "配置 →",
    },
    ...
    personal: {
      ...
      overrideHint: "存储 Control UI 覆盖设置。清除后将恢复为已配置的头像。",
      uiOverride: "UI 覆盖设置",
      configuredAvatar: "已配置的头像",
      overrideFromSettings: "来自设置的覆盖项",
      fallbackAvatar: "备用头像",
      fallbackLogo: "备用徽标",
      avatarIssues: {
    ...
    pending: {
      title: "未保存的更改",
      hint: "“保存”会存储您的更改。“立即应用”还会重新加载当前会话。",
      discard: "放弃",
      applying: "正在应用…",
      applyNow: "立即应用",
    },
  ...
  configView: {
    ...
    notifications: {
      ...
      subscribing: "正在订阅...",
      enable: "启用通知",
      blockedHint: "通知已被阻止。请更新浏览器的网站权限以允许通知。",
    },
    appearance: {
      theme: "主题",
      chooseTheme: "选择主题系列。",
      ...
      tweakcnInstructions:
        "打开 tweakcn.com，选择或创建一个主题，点击 Share，然后将复制的主题链接粘贴到此处。支持 Share 链接、编辑器 URL、注册表 URL、主题 ID，以及 amethyst-haze 等默认主题名称。",
      ...
      inlineHintBefore: "点击",
      inlineHintAfter:
        "以添加一个浏览器本地 tweakcn 主题。在 tweakcn 中使用 Share，并将复制的链接粘贴到此处。",
      textSize: "文本大小",
    },
    connection: {
      title: "连接",
    ...
    rawUnavailableTitle: "此快照无法使用原始文本模式",
    unsavedChange: "{count} 项未保存的更改",
    unsavedChanges: "{count} 项未保存的更改",
    noChanges: "无更改",
    rawDisabled: "原始文本模式已禁用（快照无法安全地往返转换原始文本）。",
    open: "打开",
    clear: "清除",
    apply: "应用",
    applying: "正在应用…",
    ...
    search: "搜索设置",
    clearSearch: "清除搜索",
    invalidConfig: "您的配置无效。部分设置可能无法按预期工作。",
    dismissWarning: "不再提醒",
    ...
    sensitiveHidden: "已隐藏 {count} 个敏感值。请使用上方的显示按钮编辑原始配置。",
    sensitiveHiddenPlural: "已隐藏 {count} 个敏感值。请使用上方的显示按钮编辑原始配置。",
  },
  execApproval: {
    expiresIn: "{time} 后过期",
    expired: "已过期",
  ...
  agentTools: {
    ...
    optional: "可选",
    liveNow: "当前可用",
    disabledByOverride: "已被智能体覆盖设置禁用。",
    enabledByProfile: "已由当前配置文件启用。",
    enabledByOverride: "已由智能体覆盖设置启用。",
    notIncluded: "未包含在当前配置文件中。",
    overrideOff: "覆盖关闭",
    enabled: "已启用",
    overrideOn: "覆盖开启",
    profileOff: "配置文件关闭",
    ...
    otherAgent: "其他智能体",
    title: "工具访问权限",
    subtitle: "此智能体的配置文件和单项工具覆盖设置。",
    enabledSummary: "已启用 {enabled}/{total}。",
    enableAll: "全部启用",
    disableAll: "全部禁用",
    loadConfig: "加载 Gateway 配置以调整工具配置文件。",
    explicitAllowlist: "此代理正在使用配置中的显式允许列表。工具覆盖设置在“配置”选项卡中管理。",
    globalAllowlist: "已设置全局 tools.allow。代理覆盖设置无法启用被全局阻止的工具。",
    loadingCatalog: "正在加载运行时工具目录…",
    catalogFallback: "无法加载运行时工具目录。改为显示内置备用列表。",
    availableNow: "当前可用",
    availableNowSubtitle: "此代理可在当前聊天会话中使用的工具。",
    noSession: "无会话",
    switchAgent: "将聊天切换到此代理以查看其实时运行时工具。",
    loadingAvailable: "正在加载可用工具…",
    availableError: "无法加载此会话的可用工具。",
    noAvailable: "此会话当前没有可用工具。",
    moreLiveTitle: "下方分组中还有 {count} 个实时工具可用。",
    moreLive: "还有 +{count} 个实时工具",
    quickPresets: "快速预设",
    inherit: "继承",
    profile: "配置文件",
    source: "来源",
    ...
    enableNamed: "启用 {name}",
    defaultPresets: "默认预设",
    availableVia: "现可通过 {source} 使用。",
    unavailableSession: "当前在此聊天会话中不可用。",
    inspectAgent: "将聊天切换到此代理，以检查实时可用性。",
    linkTool: "链接到此工具",
  },
  skillGroups: {
  ...
  skillsPage: {
    ...
    shown: "已显示 {count} 个",
    clawHub: "ClawHub",
    clawHubSubtitle: "从注册表中搜索并安装 Skills",
  ...
  mcpPage: {
    ...
    operatorCommands: "MCP 操作命令",
    operatorCommandsHint: "状态、诊断、身份验证、探测和运行时重新加载。",
    runtimeHint: "运行时更改将在保存并发布后应用；活跃的智能体将在下次使用时重新构建 MCP 运行时。",
    toolFilter: "工具筛选器",
    parallel: "并行",
    missingTransport: "缺少传输方式",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      notion: "在您的 Notion 工作区中搜索、创建和更新页面及数据库。",
      linear: "直接通过聊天分类处理问题、更新周期并提交缺陷。",
      todoist: "在 Todoist 中读取、添加和完成任务及项目。",
      airtable: "查询和更新 Airtable 中的记录、数据表和工作区。",
      jira: "通过聊天创建、搜索和分类处理 Jira 工单。",
      canva: "创建和编辑 Canva 设计、管理素材并导出结果。",
      stripe: "查看您的 Stripe 账户中的付款、客户、发票和订阅。",
      googleCalendar: "读取和创建活动，并获取活动简报 — 让您的智能体管理您的日程。",
      email: "分类处理邮箱、生成摘要和草稿，并在获得批准后发送。",
      pdf: "提取、合并、转换 PDF 文档并对其进行 OCR。",
      transcription: "将音频和视频转换为清晰、结构化的文字稿。",
      github: "通过官方 GitHub MCP 处理 PR 审查队列、议题分类和仓库问答。",
      sentry: "崩溃警报一触发，即刻获得说明并进行分类处理。",
      context7: "在编码时获取特定版本的库文档和代码示例。无需注册。",
      deepwiki: "针对任意公开 GitHub 仓库提问。免费且无需帐户。",
      huggingFace: "搜索模型、数据集和论文；将 Spaces 作为工具运行。",
      grafana: "获取 Grafana 专业知识，以及用于仪表板和警报的社区连接器。",
      kubernetes: "通过聊天执行集群操作和故障排除。",
      homeAssistant: "控制整个家中的灯光、温控和自动化设备。",
      spotify: "搜索歌曲、加入队列，并用契合心情的播放列表为一天配乐。",
      sonos: "全屋音频：通过聊天播放、将房间分组以及添加播放队列。",
      reddit: "浏览、搜索并总结 subreddit 和帖子。",
      markets: "实时股票和加密货币行情，以及价格警报和每日摘要。",
      travel: "搜索航班和酒店，并提供票价监控和行程记忆。",
      news: "个性化每日简报：一条消息汇总新闻、天气和任务。",
      maps: "提供地点、路线和出行时间信息。",
      translation: "翻译文本和文档并进行本地化。",
      notes: "将笔记保存到 Markdown、Obsidian、Notion 或 Bear。",
    },
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "{verb}提案",
      description: "告诉智能体需要更改的内容。提案将保持待处理状态，工作坊会创建修订版本。",
      placeholder: "示例：改为使用 Gmail 标签，而不是搜索未读邮件，并添加更安全的试运行步骤。",
      preparing: "正在准备修订交接",
      send: "发送修订",
    },
    queue: {
    ...
    empty: {
      searchTitle: "没有匹配的提案",
      searchBody: "清除搜索内容或尝试其他关键词。",
      pendingTitle: "没有待处理的提案",
      pendingBody: "需要审核的新草稿会显示在这里。",
      appliedTitle: "尚未应用任何提案",
      appliedBody: "应用待处理的提案后，它将作为已上线的技能显示在这里。",
      rejectedTitle: "没有已拒绝的提案",
      rejectedBody: "已跳过的提案会保留在这里，以便查看清晰的审核历史。",
      quarantinedTitle: "没有已隔离的提案",
      quarantinedBody: "被扫描程序阻止或出于安全原因暂缓的提案会显示在这里。",
      staleTitle: "没有已过期的提案",
      staleBody: "无法再顺利应用的提案会显示在这里。",
      allTitle: "这里没有提案",
      allBody: "当您的代理起草 Skill Workshop 提案后，它们会显示在这里。",
      defaultAgent: "您的代理",
      noProposalsAria: "没有 Skill Workshop 提案",
      noProposalsTitle: "尚无提案",
      noProposalsBody: "{agent} 尚未起草任何技能提案。",
      noProposalsFooter: "新提案会显示在这里以供审核。",
    },
    today: {
  ...
  dreaming: {
    ...
    wiki: {
      ...
      palaceTab: "记忆宫殿",
      dreamsExplainer:
        "这是系统在回放和整合记忆时写入的原始梦境日记；可用它检查记忆系统正在关注什么，以及哪些地方仍显得嘈杂或内容不足。",
      insightsExplainer:
        "这些是从外部历史记录中聚类得出的已导入洞察；可用它们审查导入内容中发现的信息，然后再决定是否将其转化为持久记忆。",
      palaceExplainer:
        "这是系统可搜索和推理的已编译记忆 wiki 界面；可用它检查实际的记忆页面、论断、待解决问题和矛盾，而非原始导入的源聊天记录。",
      copyArchivePath: "复制归档路径",
      loadingInsights: "正在加载已导入的洞察…",
      noInsights: "尚无已导入的洞察",
      noInsightsHint: "运行 ChatGPT 导入并应用，以在此处显示聚类后的已导入洞察。",
      ...
      emptyPalace: "记忆宫殿尚未填充",
      emptyPalaceHint:
        "目前，Wiki 中主要包含原始来源导入内容和运行报告。当系统开始写入综合内容、实体或概念后，此标签页将发挥作用。",
      claims: "论断",
      openQuestions: "开放性问题",
      contradictions: "矛盾",
      pageDetails: "页面详情",
      ...
      unavailable: "记忆 Wiki 未启用",
      unavailablePluginPrefix: "导入的洞见和记忆宫殿由内置的",
      unavailablePluginSuffix: "插件提供。",
      enablePrefix: "启用",
      enableSuffix: "，然后重新加载此标签页。",
      openConfig: "打开配置",
      howToEnable: "如何启用",
    },
    phrases: {
  ...
  usage: {
    ...
    filters: {
      ...
      remove: "移除筛选",
      removeDays: "移除天数筛选条件",
      removeHours: "移除小时数筛选条件",
      removeSession: "移除会话筛选条件",
      all: "全部",
      days: "天",
      hours: "小时",
      session: "会话",
  ...
  chat: {
    ...
    actions: {
      ...
      scrollToLatest: "滚动到最新内容",
    },
    compaction: {
      label: "已压缩的历史记录",
      description:
        "压缩后的对话记录将作为检查点保留。打开会话检查点，可从该压缩视图创建分支或进行恢复。",
    ...
    commands: {
      ...
      steerDescription: "向正在运行的任务中注入消息",
      categories: {
        session: "会话",
        model: "模型",
        agents: "智能体",
    ...
    queue: {
      ...
      steer: "引导",
      steered: "已引导",
      steerQueuedMessage: "引导排队中的消息",
      removeQueuedMessage: "移除排队中的消息",
    },
    goals: {
      edit: "编辑目标",
      pause: "暂停目标",
    ...
    detailPanel: {
      ...
      renderedMarkdownHint: "经过净化的富文本预览，便于快速阅读。",
  ...
  cron: {
    ...
    list: {
      ...
      newTask: "新建任务",
      filters: "筛选条件",
      shownOf: "已显示 {shown} 项，共 {total} 项",
      emptyTitle: "暂无定时任务",
      emptyHint: "描述 OpenClaw 应执行的操作和时间 — 它将按计划运行。",
      noMatching: "没有符合当前筛选条件的任务。",
      loadMore: "加载更多",
      loading: "正在加载...",
      schedulerOff: "调度程序已禁用",
      refresh: "刷新",
      refreshing: "正在刷新...",
      paused: "已暂停",
      tasksTab: "自动化",
    ...
    detail: {
      newTitle: "新建定时任务",
      newSubtitle: "描述 OpenClaw 应执行的操作，然后选择运行时间。",
      back: "所有自动化任务",
      settingsTab: "设置",
      historyTitle: "运行历史",
      generalSection: "通用",
    ...
    form: {
      ...
      repeatOnce: "一次",
      repeatOnExit: "退出时",
      onExitHelp: "监视的命令退出时运行。无法在此处编辑计划。",
      every: "每隔",
      at: "指定时间",
      cronOption: "Cron",
      runAt: "运行时间",
      ...
      sessionKey: "会话密钥",
      sessionKeyHelp: "用于任务交付和唤醒路由的可选路由密钥。",
      ...
      seconds: "秒",
      accountId: "账户 ID",
      accountIdHelp: "多账户设置中可选的渠道账户 ID。",
      lightContext: "轻量上下文",
      ...
      failureAlertDisabled: "对此任务禁用",
      failureAlertCustom: "按任务自定义设置",
      failureAlertsHelp: "控制此任务何时发送重复失败警报。",
      failureAlertAfter: "触发警报阈值",
      failureAlertAfterHelp: "触发警报前允许的连续错误次数。",
      failureAlertCooldown: "冷却时间（秒）",
      failureAlertCooldownHelp: "两次提醒之间的最短间隔秒数。",
      failureAlertChannel: "提醒渠道",
      failureAlertTo: "提醒接收方",
      failureAlertToPlaceholder: "+1555... 或聊天 ID",
      failureAlertToHelp: "可选择覆盖故障提醒的接收方。",
      failureAlertMode: "提醒模式",
      failureAlertAnnounce: "通知（通过渠道）",
      failureAlertWebhook: "Webhook（HTTP POST）",
      failureAlertAccountId: "提醒账户 ID",
