...
export const zh_CN: TranslationMap = {
  ...
  channels: {
    ...
    nostr: {
      ...
      profile: "个人资料",
      editProfile: "编辑资料",
      noProfile: '尚未设置个人资料。点击"编辑资料"添加名称、简介和头像。',
      name: "名称",
      displayName: "显示名称",
      about: "简介",
      account: "账户：{id}",
      username: "用户名",
      usernameHelp: "简短的用户名（如 satoshi）",
      fullDisplayName: "您的完整显示名称",
      bio: "个人简介",
      bioPlaceholder: "向大家介绍一下你自己…",
      bioHelp: "一段简短的自我介绍",
      avatarUrl: "头像 URL",
      avatarUrlHelp: "指向头像图片的 HTTPS URL",
      advanced: "高级",
      bannerUrl: "横幅 URL",
      ...
      nip05Help: "可验证标识符（如 you@domain.com）",
      ...
      profilePictureAlt: "头像",
      profilePreviewAlt: "头像预览",
    },
  },
};
