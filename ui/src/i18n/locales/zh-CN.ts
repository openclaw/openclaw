...
export const zh_CN: TranslationMap = {
  ...
  cron: {
    ...
    form: {
      ...
      agentTurn: "运行助手任务（隔离）",
      acpTurn: "运行 ACP 任务（Cursor / Codex）",
      systemEventHelp: "将文本发送到网关主时间线（适用于提醒/触发）。",
      agentTurnHelp: "使用您的提示在独立会话中启动助手运行。",
      acpTurnHelp: "通过本机 ACP（cursor-agent / acpx）执行一次性任务，需使用隔离会话。",
      acpHarness: "ACP harness",
      acpHarnessPlaceholder: "例如 cursor（默认取配置 acp.defaultAgent）",
      acpHarnessHelp: "ACP 后端 harness 标识；留空则使用配置中的默认 harness。",
      acpCwd: "工作目录",
      acpCwdPlaceholder: "例如 C:\\Users\\你\\project",
      acpCwdHelp: "可选。传给 ACP 运行时的工作目录。",
      timeoutSeconds: "超时（秒）",
