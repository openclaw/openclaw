...
export const zh_CN: TranslationMap = {
  ...
  nodes: {
    ...
    requested: "请求于",
    requestedLabel: "请求于:",
    approvedNowLabel: "当前已批准:",
    approve: "批准",
    reject: "拒绝",
    rolesLabel: "角色: {roles}",
    scopesLabel: "范围: {scopes}",
    noTokens: "令牌: 无",
    tokens: "令牌",
    revoked: "已撤销",
    active: "活跃",
    ...
    revoke: "撤销",
    anyNode: "任意节点",
    noExecNodes: "没有可用 system.run 的节点。",
    noAgents: "未找到代理。",
    defaultAgent: "默认代理",
    agent: "代理",
    usesDefault: "使用默认值 ({binding})",
    override: "覆盖: {binding}",
    bindingLabel: "绑定",
    useDefault: "使用默认值",
    unknown: "未知",
  ...
  execApprovalsConfig: {
    ...
    saving: "保存中…",
    save: "保存",
    loadApprovals: "加载审批配置以编辑允许列表。",
    target: {
      title: "目标",
      description: "Gateway 编辑本地审批；节点编辑所选节点。",
      host: "主机",
      nodeLabel: "节点",
      selectNode: "选择节点",
      noNodes: "暂无节点宣告 exec 审批。",
    },
    scope: "范围",
    defaults: "默认值",
    security: {
    ...
    autoAllowSkills: {
      title: "自动允许技能 CLI",
      description: "允许 Gateway 列出的技能可执行文件。",
