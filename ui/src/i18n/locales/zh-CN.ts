...
export const zh_CN: TranslationMap = {
  ...
  login: {
    ...
    desktop: {
      subtitle: "本机桌面设置",
      startingTitle: "正在启动本机 OpenClaw",
      startingSummary: "正在准备本机 Gateway 和内置插件。",
      connectingTitle: "正在打开 OpenClaw",
      connectingSummary: "桌面应用正在连接本机 Gateway。",
      failedTitle: "无法启动本机 OpenClaw",
      failedSummary: "OpenClaw 无法为本次桌面会话启动本机 Gateway。",
      startingButton: "正在启动",
      retryButton: "重试",
    },
    failure: {
  ...
  desktopModelSetup: {
    title: "配置模型",
    subtitle: "先添加这台电脑可用的模型和凭据，然后再进入 OpenClaw。",
    checkingTitle: "正在检查本机模型设置",
    checkingSummary: "OpenClaw 正在读取本机配置和已配置模型列表。",
    provider: "提供商",
    providerId: "提供商 ID",
    modelId: "模型 ID",
    modelPlaceholder: "gpt-5.4 或 provider/model-id",
    displayName: "显示名称",
    displayNamePlaceholder: "显示在模型选择器中",
    baseUrl: "基础 URL",
    apiKey: "API Key",
    apiKeyOptional: "API Key（可选）",
    apiKeyPlaceholder: "粘贴提供商 API Key",
    apiKeyOptionalPlaceholder: "本地服务不需要认证时可留空",
    errorTitle: "无法保存模型设置",
    save: "保存并打开 OpenClaw",
    saving: "正在保存",
    advanced: "高级设置",
