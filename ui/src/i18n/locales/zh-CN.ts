...
export const zh_CN: TranslationMap = {
  ...
  agentTools: {
    connected: "Connected",
    connectedWithPlugin: "Connected: {value}",
    channel: "Channel",
    channelWithId: "Channel: {value}",
    builtIn: "Built-in",
    toolAccessTitle: "Tool Access",
    toolAccessSubtitle: "Profile + per-tool overrides for this agent. {enabled}/{total} enabled.",
    ...
    skillsTitle: "Skills",
    skillsSubtitle: "Per-agent skill allowlist and workspace skills. {enabled}/{total}",
    skillsSubtitleNoCount: "Per-agent skill allowlist and workspace skills.",
    reset: "Reset",
    loadConfigInfo: "Load the gateway config to set per-agent skills.",
    ...
    loadSkillsInfo: "Load skills for this agent to view workspace-specific entries.",
