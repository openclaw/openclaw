...
export const zh_CN: TranslationMap = {
  ...
  memoryAudit: {
    ...
    settings: {
      ...
      enabled: "Memory audit enabled",
      agent: "Audit agent",
      defaultAgent: "Default agent",
      sessionTarget: "Audit session",
      model: "模型",
      defaultModel: "Default model",
      timezone: "Timezone",
      timezonePlaceholder: "UTC",
      dailyEnabled: "Daily audit enabled",
      dailyTime: "Daily time",
      dailyCron: "Daily cron",
      weeklyEnabled: "Weekly audit enabled",
      ...
      threadId: "Thread ID",
      restartNote: "Saving restarts the Gateway so managed audit schedules are reconciled.",
    },
    delivery: {
      none: "Do not deliver reports",
      announce: "Announce in session or channel",
      webhook: "Webhook",
    },
    errors: {
      sessionTarget: "Use main, isolated, or session:<key>.",
      dailyCron: "Daily cron is required when daily audit is enabled.",
      weeklyCron: "Weekly cron is required when weekly audit is enabled.",
      webhookRequired: "Webhook URL is required for webhook delivery.",
      webhookInvalid: "Webhook URL must start with http:// or https://.",
    },
    weekday: {
      "0": "Sunday",
      "1": "Monday",
