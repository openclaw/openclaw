...
export const ko: TranslationMap = {
  ...
  settings: {
    modeForm: "양식",
    modeRaw: "원본",
    formViewUnsafeTooltip: "양식 보기에서는 일부 필드를 안전하게 편집할 수 없습니다",
    rawModeTooltip: "원본 JSON/JSON5 구성 편집",
    rawModeUnavailable: "이 스냅샷에서는 원본 모드를 사용할 수 없습니다",
    rawModeDisabledNotice:
      "원본 모드 비활성화됨(스냅샷이 원본 텍스트를 안전하게 유지할 수 없습니다).",
    unsavedChanges: "저장되지 않은 변경 사항",
    unsavedChangeCount: "저장되지 않은 변경 사항 {count}개",
    unsavedChangesCount: "저장되지 않은 변경 사항 {count}개",
    noChanges: "변경 사항 없음",
    open: "열기",
    clear: "초기화",
    apply: "적용",
