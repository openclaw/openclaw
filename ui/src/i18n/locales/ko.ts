  ...
  cron: {
    ...
    suggestions: {
      ...
      ideas: {
        ...
        nightWatch: {
          name: "야간 감시",
          tagline: "조용한 시간별 상태 점검 — 문제가 생길 때만 알림.",
          prompt:
            "내 서비스와 Gateway가 정상인지 확인해 주세요: 최근 로그에서 새로운 오류, 재시작, 또는 비정상적인 부하를 스캔하세요. 모든 것이 정상이면 조용히 있어도 됩니다; 문제가 보이면 무엇이 실패했고 어디서부터 확인해야 할지 알려주세요.",
        },
        polyglotMinute: {
          name: "폴리글랏 미닛",
