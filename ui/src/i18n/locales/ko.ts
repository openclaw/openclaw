...
export const ko: TranslationMap = {
  ...
  filePreview: {
    ...
    emptySubtitle: "다른 파일 이름이나 콘텐츠로 검색해 보세요.",
    copyFile: "파일 복사",
  ...
  mcpApp: {
    title: "MCP App",
    unavailable: "MCP App을 사용할 수 없음: {error}",
  },
  githubPreview: {
    loading: "GitHub 세부 정보 로드 중…",
    unavailable: "GitHub 미리 보기를 사용할 수 없음",
    states: {
      merged: "병합됨",
      draft: "초안",
      open: "열림",
  ...
  nodes: {
    ...
    inventory: {
      ...
      versionDrift: "버전 불일치",
      versionDriftTitle:
        "노드 {nodeVersion}; Gateway {gatewayVersion}. 이전 구성 요소를 업데이트하여 플릿을 정렬하세요.",
      manualWake: "수동 깨우기 필요",
      manualWakeTitle:
        "Gateway는 오프라인 상태의 Windows 노드를 깨울 수 없습니다. 컴퓨터를 시작하거나 네트워크 연결을 복구하세요.",
      ...
      reapproval: "재연결 세부정보가 변경되었습니다. 승인이 필요합니다",
      newPairing: "새 기기 페어링 요청",
      repair: "재페어링",
      requestedAt: "{note} · {time} 요청됨",
      requestedAccess: "요청됨: {access}",
      approvedAccess: "지금 승인됨: {access}",
    },
    execApprovals: {
      title: "실행 승인",
      subtitlePrefix: "대상의 허용 목록 및 승인 정책",
      ...
      node: "노드",
      selectNode: "노드 선택",
      noNodes: "아직 exec 승인을 알린 노드가 없습니다.",
      scope: "범위",
      defaults: "기본값",
      security: "보안",
  ...
  agents: {
    ...
    overview: {
      title: "개요",
      subtitle: "작업 공간 경로 및 ID 메타데이터입니다.",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "에이전트별 Skills 허용 목록 및 워크스페이스 Skills.",
      loadConfig: "에이전트별 Skills를 설정하려면 gateway 구성을 로드하세요.",
      customAllowlist: "이 에이전트는 사용자 지정 Skills 허용 목록을 사용합니다.",
      allEnabled:
        "모든 Skills가 활성화되어 있습니다. Skills를 비활성화하면 에이전트별 허용 목록이 생성됩니다.",
      loadAgent: "워크스페이스 관련 항목을 보려면 이 에이전트의 Skills를 로드하세요.",
      filter: "필터",
  ...
  configForm: {
    ...
    add: "추가",
    noItems: '아직 항목이 없습니다. "추가"를 클릭하여 만드세요.',
    removeItem: "항목 제거",
    customEntries: "사용자 지정 항목",
    addEntry: "항목 추가",
    noCustomEntries: "사용자 지정 항목이 없습니다.",
    key: "키",
    removeEntry: "항목 제거",
    ...
    noSettingsMatch: '"{query}"와(과) 일치하는 설정이 없습니다',
    noSettingsInSection: "이 섹션에 설정이 없습니다",
    sections: {
      env: {
        label: "환경 변수",
        description: "Gateway 프로세스에 전달되는 환경 변수",
      },
      update: {
        label: "업데이트",
      ...
      hooks: {
        label: "훅",
        description: "웹훅 및 이벤트 훅",
      },
      skills: {
        label: "Skills",
        description: "스킬 팩 및 기능",
      },
      tools: {
        label: "도구",
      ...
      ui: {
        label: "UI",
        description: "사용자 인터페이스 환경설정",
      },
      models: {
        label: "모델",
        description: "AI 모델 구성 및 제공자",
      },
      bindings: {
        label: "바인딩",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      you: "나",
      assistant: "어시스턴트",
      localIdentity: "로컬 채팅 아이덴티티",
      assistantIdentity: "어시스턴트 아이덴티티",
      ...
      overrideHint: "Control UI 재정의를 저장합니다. 구성된 아바타로 돌아가려면 지우세요.",
      uiOverride: "UI 재정의",
  ...
  configView: {
    ...
    appearance: {
      ...
      tweakcnInstructions:
        "tweakcn.com을 열고 테마를 선택하거나 만든 다음 Share를 클릭하고, 복사된 테마 링크를 여기에 붙여넣으세요. Share 링크, 편집기 URL, 레지스트리 URL, 테마 ID, amethyst-haze 같은 기본 테마 이름을 사용할 수 있습니다.",
      ...
      clear: "{name} 지우기",
      loaded: "로드됨",
      inlineHintBefore: "클릭하여",
      inlineHintAfter:
        "브라우저 로컬 tweakcn 테마 하나를 추가하세요. tweakcn에서 Share를 사용해 복사된 링크를 여기에 붙여넣으세요.",
      textSize: "텍스트 크기",
    },
    connection: {
      title: "연결",
    ...
    unsavedChange: "저장되지 않은 변경사항 {count}개",
    unsavedChanges: "저장되지 않은 변경사항 {count}개",
    noChanges: "변경사항 없음",
    rawDisabled: "Raw 모드 비활성화됨 (스냅샷이 raw 텍스트를 안전하게 왕복 처리할 수 없습니다).",
    open: "열기",
    clear: "지우기",
    apply: "적용",
    applying: "적용 중…",
    ...
    dismissWarning: "다시 알리지 않기",
    viewPendingChange: "대기 중인 변경사항 {count}개 보기",
    viewPendingChanges: "대기 중인 변경사항 {count}개 보기",
    viewPendingChangesRaw: "대기 중인 변경사항 보기",
    rawDiffUnavailable: "변경사항 감지됨 (JSON diff 사용 불가)",
    hideEnvValues: "env 값 숨기기",
    revealEnvValues: "env 값 표시",
    peek: "미리 보기",
    loadingSchema: "스키마 로드 중…",
    formUnsafe:
      "설정에 폼 편집기가 안전하게 표현할 수 없는 필드가 있습니다. 해당 항목을 편집하려면 Raw 모드를 사용하세요.",
    rawConfig: "Raw 설정 (JSON/JSON5)",
    secretCount: "비밀 값 {count}개",
    secretCountPlural: "비밀 값 {count}개",
    redacted: "가려짐",
    visible: "표시됨",
    revealSensitive: "민감한 값 표시",
    hideSensitive: "민감한 값 숨기기",
    toggleRawRedaction: "Raw 설정 가리기 전환",
    sensitiveHidden:
      "민감한 값 {count}개가 숨겨졌습니다. 위의 표시 버튼을 사용해 Raw 설정을 편집하세요.",
  ...
  agentTools: {
    ...
    otherAgent: "다른 에이전트",
    title: "도구 액세스",
    subtitle: "이 에이전트에 대한 프로필 및 도구별 재정의입니다.",
    enabledSummary: "{enabled}/{total}개 사용.",
    enableAll: "모두 사용",
    ...
    globalAllowlist:
      "전역 tools.allow가 설정되어 있습니다. 에이전트 재정의로는 전역적으로 차단된 도구를 사용할 수 없습니다.",
    loadingCatalog: "런타임 도구 카탈로그를 로드하는 중…",
    catalogFallback: "런타임 도구 카탈로그를 로드할 수 없습니다. 대신 내장 대체 목록을 표시합니다.",
    availableNow: "지금 사용 가능",
    availableNowSubtitle: "이 에이전트가 현재 채팅 세션에서 사용할 수 있는 항목입니다.",
    noSession: "세션 없음",
    switchAgent: "이 에이전트의 라이브 런타임 도구를 보려면 채팅을 해당 에이전트로 전환하세요.",
    loadingAvailable: "사용 가능한 도구를 불러오는 중…",
    availableError: "이 세션에 사용 가능한 도구를 불러올 수 없습니다.",
    noAvailable: "지금은 이 세션에 사용 가능한 도구가 없습니다.",
    ...
    toolsOne: "도구 {count}개",
    tools: "도구 {count}개",
    enabledToolsOne: "{count}개의 활성화된 도구",
    enabledTools: "{count}개의 활성화된 도구",
    liveToolsOne: "{count}개의 실시간 도구",
    liveTools: "{count}개의 실시간 도구",
    access: "액세스",
    session: "현재 세션",
    disableNamed: "{name} 비활성화",
    enableNamed: "{name} 활성화",
    defaultPresets: "기본 프리셋",
    availableVia: "{source}을(를) 통해 지금 사용 가능합니다.",
    unavailableSession: "현재 이 채팅 세션에서는 사용할 수 없습니다.",
    inspectAgent: "실시간 가용성을 확인하려면 채팅을 이 에이전트로 전환하세요.",
    linkTool: "이 도구에 연결",
  },
  skillGroups: {
  ...
  mcpPage: {
    ...
    runtimeHint:
      "런타임 변경 사항은 저장 및 게시 후 적용됩니다. 활성 에이전트는 다음 사용 시 MCP 런타임을 다시 빌드합니다.",
    toolFilter: "도구 필터",
    parallel: "병렬",
    missingTransport: "전송 누락",
    tlsVerifyOff: "TLS 확인 꺼짐",
    mtls: "mTLS",
    publishing: "게시 중...",
  },
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      jira: "채팅에서 Jira 티켓을 만들고, 검색하고, 분류합니다.",
      canva: "Canva 디자인을 만들고 편집하며, 자산을 관리하고 결과물을 내보냅니다.",
      stripe: "Stripe 계정에서 결제, 고객, 청구서, 구독을 확인합니다.",
      googleCalendar: "이벤트를 읽고, 만들고, 브리핑받으세요 — 에이전트가 일정을 관리합니다.",
      email: "메일함 분류, 요약, 초안 작성과 승인 후 발송을 지원합니다.",
      pdf: "PDF 문서를 추출, 병합, 변환하고 OCR을 수행합니다.",
      transcription: "오디오와 비디오를 깔끔하고 구조화된 스크립트로 변환합니다.",
      github: "공식 GitHub MCP를 통해 PR 리뷰 대기열, 이슈 분류, 저장소 Q&A를 처리합니다.",
      sentry: "충돌 알림이 발생하는 순간 설명하고 분류합니다.",
      ...
      grafana: "대시보드와 알림을 위한 Grafana 노하우와 커뮤니티 커넥터입니다.",
      kubernetes: "채팅에서 클러스터 운영과 문제 해결을 수행합니다.",
      homeAssistant: "집 전체의 조명, 냉난방, 자동화를 제어합니다.",
      spotify:
        "기분에 맞춘 플레이리스트로 검색하고, 대기열에 추가하고, 하루의 배경음악을 만드세요.",
      sonos: "홈 전체 오디오: 재생하고, 방을 그룹화하고, 채팅으로 대기열을 만드세요.",
      reddit: "서브레딧과 스레드를 탐색하고, 검색하고, 요약합니다.",
      markets: "가격 알림과 일일 요약이 포함된 실시간 주식 및 암호화폐.",
      travel: "요금 관찰과 여행 기록이 포함된 항공편 및 호텔 검색.",
      news: "개인 맞춤형 일일 브리핑: 뉴스, 날씨, 할 일을 하나의 메시지로.",
      maps: "장소, 경로 안내, 이동 시간 답변.",
      translation: "텍스트와 문서를 번역하고 현지화합니다.",
      notes: "Markdown, Obsidian, Notion 또는 Bear에 메모를 기록하세요.",
    },
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "제안 {verb}",
      description:
        "에이전트에게 무엇을 변경해야 하는지 알려주세요. 제안은 보류 상태로 유지되며 워크숍이 수정된 버전을 생성합니다.",
      placeholder:
        "예: 읽지 않은 메일 검색 대신 Gmail 라벨을 사용하도록 하고, 더 안전한 드라이런 단계를 추가하세요.",
    ...
    empty: {
      ...
      searchBody: "검색을 지우거나 다른 키워드를 시도하세요.",
      ...
      quarantinedBody: "스캐너가 차단했거나 안전상 보류된 제안이 여기에 표시됩니다.",
      staleTitle: "오래된 제안 없음",
      staleBody: "더 이상 정상적으로 적용할 수 없는 제안이 여기에 표시됩니다.",
      allTitle: "여기에 제안 없음",
      allBody: "에이전트가 작성한 Skill Workshop 제안이 여기에 표시됩니다.",
      defaultAgent: "내 에이전트",
      noProposalsAria: "Skill Workshop 제안 없음",
      noProposalsTitle: "아직 제안 없음",
      noProposalsBody: "{agent}이(가) 아직 스킬 제안을 작성하지 않았습니다.",
      noProposalsFooter: "새 제안이 검토를 위해 여기에 표시됩니다.",
    },
    today: {
      emptyTitle: "오늘 대기 중인 항목 없음",
      emptyBody: "에이전트가 새로 작성한 항목이 없습니다. Board로 전환하여 기록을 살펴보세요.",
      new: "신규",
      waiting: "대기 중",
      reviewed: "검토됨",
      agent: "에이전트",
      proposalsWaiting: "제안 {count}개 대기 중",
      ...
      addToSkills: "스킬에 추가",
      tweakIt: "수정하기",
      askAgent: "에이전트에게 변경 요청하기",
      skipping: "건너뛰는 중…",
      skip: "건너뛰기",
      notForMe: "나에게 맞지 않음",
      upNext: "다음 · {count}개 대기 중",
      seeAll: "모든 제안 보기 →",
      collection: "내 컬렉션 · {count}개 사용 중",
      manage: "관리 →",
      workflowHeading: "에이전트가 사용하는 방법",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      palaceTab: "기억의 궁전",
      dreamsExplainer:
        "이것은 시스템이 메모리를 재생하고 통합하는 동안 기록하는 원본 꿈 일기입니다. 메모리 시스템이 무엇을 인식하고 있는지, 그리고 어디가 여전히 잡음이 많거나 빈약해 보이는지 검사하는 데 사용하세요.",
      insightsExplainer:
        "이것은 외부 기록에서 클러스터링된 가져온 인사이트입니다. 어떤 것이 지속적인 메모리로 승격되기 전에 가져오기가 무엇을 드러냈는지 검토하는 데 사용하세요.",
      palaceExplainer:
        "이것은 시스템이 검색하고 추론할 수 있는 컴파일된 메모리 위키 표면입니다. 원본 가져온 소스 채팅이 아니라 실제 메모리 페이지, 주장, 미해결 질문, 모순을 검사하는 데 사용하세요.",
      copyArchivePath: "아카이브 경로 복사",
      loadingInsights: "가져온 인사이트 로드 중…",
      noInsights: "아직 가져온 인사이트가 없습니다",
      noInsightsHint:
        "ChatGPT 가져오기를 apply와 함께 실행하여 여기에 클러스터링된 가져온 인사이트를 표시하세요.",
      ...
      loadingPalace: "기억의 궁전 로딩 중…",
      emptyPalace: "기억의 궁전이 아직 채워지지 않았습니다",
      emptyPalaceHint:
        "현재 위키에는 주로 원본 소스 가져오기와 운영 보고서만 있습니다. 이 탭은 종합, 엔터티, 개념이 작성되기 시작하면 유용해집니다.",
      claims: "주장",
      ...
      unavailable: "Memory Wiki가 활성화되지 않았습니다",
      unavailablePluginPrefix: "Imported Insights와 Memory Palace는 번들로 제공됩니다",
  ...
  chat: {
    ...
    compaction: {
      label: "압축된 기록",
      description:
        "압축된 대화 기록은 체크포인트로 보존됩니다. 세션 체크포인트를 열어 해당 압축된 뷰에서 분기하거나 복원하세요.",
    ...
    sideChat: {
      ...
      close: "사이드 채팅 닫기",
      followUp: "후속 질문…",
      followUpLabel: "사이드 채팅에서 후속 질문",
      sendFollowUp: "후속 질문 보내기",
    },
    detailPanel: {
      close: "사이드바 닫기",
      copyPath: "경로 복사",
      ...
      showInFiles: "Files에서 보기",
      previousMatch: "이전 일치 항목",
      nextMatch: "다음 일치 항목",
      overwrite: "덮어쓰기",
      viewRawText: "원본 텍스트 보기",
      renderedMarkdown: "렌더링된 Markdown",
      renderedMarkdownHint: "빠른 읽기를 위한 정제된 서식 있는 텍스트 미리보기입니다.",
    ...
    toolCards: {
      ...
      rawDetails: "원시 세부 정보",
      openFile: "파일 열기",
      openDetails: "측면 패널에서 도구 세부 정보 열기",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "OpenClaw가 무엇을 언제 해야 하는지 설명하세요 — 일정에 따라 실행됩니다.",
    ...
    detail: {
      newTitle: "새 예약 작업",
      newSubtitle: "OpenClaw가 수행할 작업을 설명한 다음 실행 시점을 선택하세요.",
      overviewTitle: "최근 활동",
    ...
    form: {
      ...
      failureAlertsHelp: "이 작업이 반복 실패 알림을 보낼 시점을 제어합니다.",
      failureAlertAfter: "알림 조건",
      failureAlertAfterHelp: "알림 전 연속 오류 횟수입니다.",
      failureAlertCooldown: "대기 시간(초)",
      failureAlertCooldownHelp: "알림 간 최소 시간(초)입니다.",
      ...
      failureAlertAnnounce: "공지(채널을 통해)",
      failureAlertWebhook: "Webhook(HTTP POST)",
      failureAlertAccountId: "알림 계정 ID",
      failureAlertAccountPlaceholder: "다중 계정 설정용 계정 ID",
