...
export const ko: TranslationMap = {
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "플랜 모드",
      goal: "목표 모드",
      switchConfirm: "모드를 전환하시겠습니까? 현재 모드가 중지됩니다.",
    },
    splitView: {
      open: "분할 보기 열기",
      splitRight: "오른쪽으로 분할",
  ...
  plan: {
    ...
    view: "보기",
    approveTitle: "이 플랜을 실행하시겠습니까?",
    approveCta: "승인",
    revise: "피드백으로 수정",
    reviseSubmit: "피드백 보내기",
    revisePlaceholder: "무엇을 변경해야 하나요?",
    cancel: "취소",
