...
export const ko: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "ClawHub 검색",
    ...
    searchClawHubTitle: "ClawHub 검색",
    searchClawHubBody: "코드 및 번들 플러그인을 찾으려면 두 글자 이상 입력하세요.",
    noClawHubResultsTitle: "플러그인을 찾을 수 없음",
