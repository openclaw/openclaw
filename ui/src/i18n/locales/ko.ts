...
export const ko: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "OpenClaw가 수행할 작업과 시간을 설명하세요 — 일정에 따라 실행됩니다.",
    ...
    detail: {
      newTitle: "새 예약 작업",
      newSubtitle: "OpenClaw이 수행할 작업을 설명한 다음, 실행 시점을 선택하세요.",
      overviewTitle: "최근 활동",
      overviewSubtitle: "예약된 모든 작업의 최근 실행 내역입니다.",
      historyTitle: "실행 기록",
      detailsSection: "세부 정보",
      frequencySection: "실행 주기",
      paused: "일시 중지됨",
    },
    actions: {
      runNow: "지금 실행",
    ...
    form: {
      ...
      promptPlaceholder: "OpenClaw이 수행할 작업을 설명하세요...",
      repeat: "반복",
      repeatInterval: "간격",
      repeatOnce: "한 번",
      repeatCron: "Cron 표현식",
      repeatOnExit: "종료 시",
      onExitHelp: "감시 중인 명령이 종료되면 실행됩니다. 여기에서는 일정을 편집할 수 없습니다.",
      every: "매",
      at: "시간",
      cronOption: "Cron",
      runAt: "실행 시각",
