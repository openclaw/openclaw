...
export const ko: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "요금제, 할당량, 비용이 구성된 제공자.",
  ...
  modelProviders: {
    title: "구성된 제공자",
    subtitle: "인증, 요금제, 할당량, 비용 데이터가 포함된 모델 제공자.",
    updated: "업데이트됨 {time}",
    refreshing: "새로 고침 중…",
    disconnected: "구성된 모델 제공자를 보려면 게이트웨이에 연결하세요.",
    emptyTitle: "구성된 모델 제공자 없음",
    emptySubtitle: "제공자에 로그인하거나 API 키를 추가한 다음 새로 고침하세요.",
    status: {
      ok: "연결됨",
      expiring: "만료 예정",
      expired: "만료됨",
    ...
    expiresIn: "자격 증명이 {time} 후에 만료됩니다",
    models: "{count}개 모델",
    modelOne: "1개 모델",
    modelsAvailable: "{count}개 모델 중 {available}개 사용 가능",
    noStats: "이 제공자가 보고한 실시간 사용 데이터가 없습니다.",
    localCost: "세션 소비 · {days}일",
    localCostDetail: "{tokens} 토큰 · {sessions} 세션",
    saving: "저장 중…",
