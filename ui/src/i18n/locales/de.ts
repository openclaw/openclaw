...
export const de: TranslationMap = {
  ...
  agentTools: {
    connected: "Verbunden",
    connectedWithPlugin: "Verbunden: {value}",
    channel: "Kanal",
    channelWithId: "Kanal: {value}",
    builtIn: "Integriert",
    toolAccessTitle: "Tool-Zugriff",
    toolAccessSubtitle: "Profil + Tool-Überschreibungen pro Agent. {enabled}/{total} aktiviert.",
    ...
    removeAllowlistTitle: "Agentenspezifische Allowlist entfernen und alle Skills verwenden",
    filter: "Filter",
    searchSkillsPlaceholder: "Skills durchsuchen",
    shownCount: "{count} angezeigt",
    skillsTitle: "Skills",
    skillsSubtitle: "Agentenspezifische Skill-Allowlist und Workspace-Skills. {enabled}/{total}",
    skillsSubtitleNoCount: "Agentenspezifische Skill-Allowlist und Workspace-Skills.",
    reset: "Zurücksetzen",
    loadConfigInfo: "Laden Sie die Gateway-Konfiguration, um agentenspezifische Skills festzulegen.",
    customAllowlistInfo: "Dieser Agent verwendet eine benutzerdefinierte Skill-Allowlist.",
    allSkillsInfo: "Alle Skills sind aktiviert. Das Deaktivieren eines Skills erstellt eine agentenspezifische Allowlist.",
    loadSkillsInfo: "Laden Sie die Skills dieses Agenten, um workspace-spezifische Einträge anzuzeigen.",
