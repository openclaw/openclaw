...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.mullusi/mullusi.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von mullusi dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
