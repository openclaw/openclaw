...
export const de: TranslationMap = {
  ...
  nodesPage: {
    nodesTitle: "Geräteknoten",
    nodesSubtitle: "Gekoppelte Geräte und Live-Verbindungen.",
    devicesTitle: "Geräte",
    devicesSubtitle: "Pairing-Anfragen + Rollen-Tokens.",
    loading: "Wird geladen…",
    noNodesFound: "Keine Geräteknoten gefunden.",
    pending: "Ausstehend",
    paired: "Gekoppelt",
