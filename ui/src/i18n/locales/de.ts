...
export const de: TranslationMap = {
  ...
  filePreview: {
    ...
    emptySubtitle: "Versuchen Sie einen anderen Dateinamen oder eine Inhaltssuche.",
  ...
  channels: {
    ...
    config: {
      ...
      channelSchemaUnavailable: "Kanalkonfigurationsschema nicht verfügbar.",
    ...
    whatsapp: {
      title: "WhatsApp",
      subtitle: "WhatsApp Web verknüpfen und den Verbindungsstatus überwachen.",
    },
  ...
  nodes: {
    ...
    inventory: {
      ...
      manualWake: "manuelles Wecken erforderlich",
      manualWakeTitle:
        "Das Gateway kann einen offline befindlichen Windows-Node nicht wecken. Starten Sie den Rechner oder stellen Sie seine Netzwerkverbindung wieder her.",
      approvalNeeded: "Freigabe erforderlich",
      inputAgo: "Eingabe vor {time}",
      seen: "gesehen {time}",
      approved: "freigegeben {time}",
      more: "+{count} weitere",
      details: "Details",
      ...
      scopeUpgrade: "Scope-Upgrade erfordert Genehmigung",
      roleUpgrade: "Rollen-Upgrade erfordert Genehmigung",
    ...
    execApprovals: {
      ...
      hostNativeHint: "Hier schreibgeschützt. Über die Companion-App oder CLI bearbeiten.",
      native: "Nativ",
      ...
      ask: "Nachfragen",
      defaultPrompt: "Standard-Nachfrageregel.",
      askFallback: "Nachfrage-Fallback",
      promptUnavailable: "Wird angewendet, wenn die UI-Nachfrage nicht verfügbar ist.",
      fallback: "Fallback",
      autoAllowSkills: "Skill-CLIs automatisch zulassen",
      autoAllowSkillsHint: "Vom Gateway aufgelistete Skill-Executables zulassen.",
      usingDefault: "Standard wird verwendet ({value}).",
      override: "Überschreiben ({value}).",
      enabled: "Aktiviert",
      useDefault: "Standard verwenden",
      allowlist: "Zulassungsliste",
      allowlistHint: "Groß-/Kleinschreibung wird ignoriert – Glob-Muster.",
      ...
      options: {
        ...
        full: "Vollständig",
        off: "Aus",
        onMiss: "Bei Nichtübereinstimmung",
        always: "Immer",
      },
    },
  },
  ...
  agents: {
    ...
    overview: {
      title: "Übersicht",
      subtitle: "Workspace-Pfade und Identitätsmetadaten.",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Skill-Zulassungsliste pro Agent und Workspace-Skills.",
      loadConfig: "Laden Sie die Gateway-Konfiguration, um Skills pro Agent festzulegen.",
      customAllowlist: "Dieser Agent verwendet eine benutzerdefinierte Skill-Zulassungsliste.",
      allEnabled:
        "Alle Skills sind aktiviert. Das Deaktivieren eines Skills erstellt eine Zulassungsliste pro Agent.",
      loadAgent:
        "Laden Sie die Skills für diesen Agent, um workspace-spezifische Einträge anzuzeigen.",
      filter: "Filter",
  ...
  configForm: {
    ...
    disableStreamToReveal: "Stream-Modus deaktivieren, um Wert anzuzeigen",
    ...
    structuredSecretFile: "Strukturierter Wert (SecretRef) – Konfigurationsdatei direkt bearbeiten",
    defaultValue: "Standard: {value}",
    ...
    unsupportedSchema: "Nicht unterstütztes Schema. Verwende Raw.",
    unsupportedNode: "Nicht unterstützter Schema-Knoten. Verwende den Raw-Modus.",
    ...
    sections: {
      ...
      gateway: {
        label: "Gateway",
        description: "Gateway-Servereinstellungen (Port, Authentifizierung, Bindung)",
      },
      wizard: {
      ...
      logging: {
        ...
        description: "Protokollebenen und Ausgabekonfiguration",
      },
      browser: {
        label: "Browser",
        description: "Einstellungen für die Browserautomatisierung",
      },
      ui: {
        label: "UI",
        description: "Einstellungen der Benutzeroberfläche",
      },
      models: {
        label: "Modelle",
      ...
      bindings: {
        label: "Bindungen",
        description: "Tastenbelegungen und Shortcuts",
      },
      broadcast: {
        label: "Broadcast",
      ...
      audio: {
        label: "Audio",
        description: "Audio-Eingabe-/Ausgabeeinstellungen",
      },
      session: {
        label: "Sitzung",
      ...
      talk: {
        label: "Talk",
        description: "Sprach- und Spracherkennungseinstellungen",
      },
      plugins: {
        label: "Plugins",
      ...
      mcp: {
        label: "MCP",
        description: "Definitionen der Model-Context-Protocol-Server",
      },
    },
  },
  quickSettings: {
    ...
    personal: {
      ...
      you: "Sie",
      assistant: "Assistent",
      localIdentity: "Ihre lokale Chat-Identität",
      ...
      overrideHint:
        "Speichert eine Control-UI-Überschreibung. Entferne sie, um zum konfigurierten Avatar zurückzukehren.",
    ...
    pending: {
      ...
      hint: "Speichern sichert deine Änderungen. „Jetzt anwenden“ lädt zusätzlich die aktuelle Sitzung neu.",
      discard: "Verwerfen",
  ...
  configPage: {
    ...
    themeRemoved: "Benutzerdefiniertes Design entfernt.",
    channels: {
      telegram: "Telegram",
      discord: "Discord",
      slack: "Slack",
  ...
  configView: {
    ...
    notifications: {
      ...
      hint: "Erhalten Sie Browser-Push-Benachrichtigungen von Ihrem Gateway.",
      ...
      blockedHint:
        "Benachrichtigungen sind blockiert. Aktualisieren Sie die Website-Berechtigungen Ihres Browsers, um Benachrichtigungen zuzulassen.",
    },
    appearance: {
      theme: "Design",
      ...
      importHint: "Importieren Sie ein tweakcn-Design in diesen browser-lokalen Slot",
      ...
      inlineHintAfter:
        "um ein browser-lokales tweakcn-Design hinzuzufügen. Verwenden Sie in tweakcn die Funktion Share und fügen Sie den kopierten Link hier ein.",
      textSize: "Textgröße",
    },
    connection: {
      title: "Verbindung",
    ...
    dismissWarning: "Nicht erneut erinnern",
    ...
    formUnsafe:
      "Ihre Konfiguration enthält Felder, die der Formulareditor nicht sicher darstellen kann. Verwenden Sie den Raw-Modus, um diese Einträge zu bearbeiten.",
    rawConfig: "Rohkonfiguration (JSON/JSON5)",
    ...
    toggleRawRedaction: "Schwärzung der Rohkonfiguration umschalten",
    sensitiveHidden:
      "{count} vertraulicher Wert ausgeblendet. Verwenden Sie die Anzeigen-Schaltfläche oben, um die Rohkonfiguration zu bearbeiten.",
    sensitiveHiddenPlural:
      "{count} vertrauliche Werte ausgeblendet. Verwenden Sie die Anzeigen-Schaltfläche oben, um die Rohkonfiguration zu bearbeiten.",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    optional: "Optional",
    liveNow: "Jetzt aktiv",
    disabledByOverride: "Durch Agent-Override deaktiviert.",
    enabledByProfile: "Durch das aktuelle Profil aktiviert.",
    enabledByOverride: "Durch Agent-Override aktiviert.",
    ...
    title: "Tool-Zugriff",
    subtitle: "Profil + Tool-spezifische Overrides für diesen Agenten.",
    ...
    globalAllowlist:
      "Globales tools.allow ist gesetzt. Agent-Overrides können keine Tools aktivieren, die global blockiert sind.",
    loadingCatalog: "Laufzeit-Tool-Katalog wird geladen…",
    catalogFallback:
      "Laufzeit-Tool-Katalog konnte nicht geladen werden. Stattdessen wird die integrierte Ersatzliste angezeigt.",
    availableNow: "Jetzt verfügbar",
    availableNowSubtitle: "Was dieser Agent in der aktuellen Chat-Sitzung nutzen kann.",
    noSession: "keine Sitzung",
    switchAgent:
      "Wechseln Sie den Chat zu diesem Agenten, um seine Live-Laufzeit-Tools anzuzeigen.",
    ...
    moreLiveTitle: "{count} weitere Live-Tools sind in den Gruppen unten verfügbar.",
    ...
    live: "Live",
    status: "Status",
    profileSourceAgent: "Agent-Überschreibung",
    ...
    unavailableSession: "Derzeit in dieser Chat-Sitzung nicht verfügbar.",
  ...
  skillsPage: {
    ...
    disconnected: "Nicht mit dem Gateway verbunden.",
    empty: "Keine Skills gefunden.",
  ...
  skillStatus: {
    ...
    blocked: "blockiert",
    disabled: "deaktiviert",
    blockedAllowlist: "durch Positivliste blockiert",
  ...
  mcpPage: {
    ...
    runtimeHint:
      "Laufzeitänderungen werden nach dem Speichern und Veröffentlichen wirksam; aktive Agenten erstellen MCP-Laufzeiten bei der nächsten Verwendung neu.",
    toolFilter: "Tool-Filter",
    parallel: "parallel",
    missingTransport: "Transport fehlt",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      notion:
        "Suchen, erstellen und aktualisieren Sie Seiten und Datenbanken in Ihrem Notion-Workspace.",
      linear:
        "Priorisieren Sie Vorgänge, aktualisieren Sie Zyklen und melden Sie Fehler direkt aus dem Chat.",
      todoist: "Aufgaben und Projekte in Todoist lesen, hinzufügen und abschließen.",
      airtable: "Datensätze, Tabellen und Bases in Airtable abfragen und aktualisieren.",
      jira: "Jira-Tickets aus dem Chat erstellen, durchsuchen und priorisieren.",
      canva: "Canva-Designs erstellen und bearbeiten, Assets verwalten und Ergebnisse exportieren.",
      stripe: "Zahlungen, Kunden, Rechnungen und Abonnements in Ihrem Stripe-Konto prüfen.",
      googleCalendar:
        "Termine lesen, erstellen und Zusammenfassungen erhalten – Ihr Agent verwaltet Ihren Zeitplan.",
      email: "Postfach-Priorisierung, Zusammenfassungen und Entwürfe mit Versand nach Freigabe.",
      pdf: "PDF-Dokumente extrahieren, zusammenführen, konvertieren und per OCR verarbeiten.",
      transcription: "Audio und Video in saubere, strukturierte Transkripte umwandeln.",
      github: "PR-Review-Warteschlangen, Issue-Triage und Repo-FAQ über das offizielle GitHub MCP.",
      sentry: "Absturzwarnungen werden erklärt und priorisiert, sobald sie auftreten.",
      context7:
      ...
      huggingFace: "Modelle, Datensätze und Papers durchsuchen; Spaces als Tools ausführen.",
      grafana: "Grafana-Know-how und Community-Konnektoren für Dashboards und Alerts.",
      kubernetes: "Cluster-Betrieb und Fehlerbehebung direkt aus dem Chat.",
      homeAssistant: "Steuere Licht, Klima und Automatisierungen im gesamten Zuhause.",
      spotify:
        "Suchen, in die Warteschlange stellen und deinen Tag mit stimmungsbasierten Playlists vertonen.",
      sonos:
        "Audio fürs ganze Zuhause: abspielen, Räume gruppieren und per Chat in die Warteschlange stellen.",
      reddit: "Subreddits und Threads durchsuchen, ansehen und zusammenfassen.",
      markets: "Aktien und Krypto in Echtzeit mit Preisalarmen und täglichen Übersichten.",
      ...
      maps: "Orte, Routen und Antworten zu Reisezeiten.",
      translation: "Texte und Dokumente übersetzen und lokalisieren.",
  ...
  skillWorkshop: {
    ...
    revision: {
      ...
      placeholder:
        "Beispiel: Verwende Gmail-Labels statt der Suche nach ungelesenen Nachrichten und füge einen sichereren Testlauf-Schritt hinzu.",
      preparing: "Überarbeitungsübergabe wird vorbereitet",
      send: "Überarbeitung senden",
    },
    queue: {
      resize: "Vorschlagsliste anpassen",
      search: "Vorschläge durchsuchen…",
    ...
    empty: {
      ...
      searchBody: "Suche zurücksetzen oder ein anderes Stichwort versuchen.",
      pendingTitle: "Keine ausstehenden Vorschläge",
      pendingBody: "Neue Entwürfe erscheinen hier, wenn sie geprüft werden müssen.",
      appliedTitle: "Noch nichts angewendet",
      appliedBody: "Verwende einen ausstehenden Vorschlag und er erscheint hier als aktiver Skill.",
      rejectedTitle: "Keine abgelehnten Vorschläge",
      rejectedBody: "Übersprungene Vorschläge bleiben hier für einen sauberen Prüfverlauf.",
      quarantinedTitle: "Nichts in Quarantäne",
      quarantinedBody:
        "Vom Scanner blockierte oder aus Sicherheitsgründen zurückgehaltene Vorschläge erscheinen hier.",
      staleTitle: "Keine veralteten Vorschläge",
      staleBody: "Vorschläge, die sich nicht mehr sauber anwenden lassen, erscheinen hier.",
      allTitle: "Keine Vorschläge hier",
      allBody: "Skill-Workshop-Vorschläge erscheinen hier, sobald Ihr Agent sie entwirft.",
      ...
      noProposalsFooter: "Neue Vorschläge erscheinen hier zur Überprüfung.",
    },
    today: {
      emptyTitle: "Heute wartet nichts",
      emptyBody:
        "Ihr Agent hat nichts Neues entworfen. Wechseln Sie zur Übersicht, um den Verlauf zu durchsuchen.",
      new: "NEU",
      waiting: "WARTET",
      reviewed: "GEPRÜFT",
      agent: "Agent",
      proposalsWaiting: "{count} Vorschläge warten",
      browseApplied: "Durchsuchen Sie, was bereits angewendet wurde.",
      progress: "{current} von {total}",
      draftedBy: "Entworfen von",
      supportFile: "{count} Support-Datei",
      supportFiles: "{count} Support-Dateien",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      dreamsExplainer:
        "Dies ist das rohe Traumtagebuch, das das System schreibt, während es Speicher wiedergibt und konsolidiert; nutze es, um zu prüfen, was das Speichersystem bemerkt und wo es noch verrauscht oder dünn wirkt.",
      insightsExplainer:
        "Dies sind importierte Erkenntnisse, die aus externem Verlauf geclustert wurden; nutze sie, um zu prüfen, was Importe zutage gefördert haben, bevor davon etwas in dauerhaften Speicher übergeht.",
      palaceExplainer:
        "Dies ist die kompilierte Speicher-Wiki-Oberfläche, die das System durchsuchen und über die es schlussfolgern kann; nutze sie, um tatsächliche Speicherseiten, Aussagen, offene Fragen und Widersprüche zu prüfen, statt roher importierter Quellchats.",
      ...
      noInsightsHint:
        "Führe einen ChatGPT-Import mit Anwenden aus, um gruppierte importierte Erkenntnisse hier anzuzeigen.",
      ...
      emptyPalace: "Gedächtnispalast ist noch nicht befüllt",
      emptyPalaceHint:
      ...
      unavailablePluginPrefix: "Importierte Erkenntnisse und Memory Palace werden vom gebündelten",
      unavailablePluginSuffix: "Plugin bereitgestellt.",
      enablePrefix: "Aktivieren Sie",
      enableSuffix: " und laden Sie dann diesen Tab neu.",
  ...
  chat: {
    ...
    compaction: {
      label: "Verdichteter Verlauf",
      description:
        "Das verdichtete Transkript wird als Prüfpunkt gespeichert. Öffnen Sie die Sitzungsprüfpunkte, um von dieser verdichteten Ansicht zu verzweigen oder wiederherzustellen.",
      openCheckpoints: "Prüfpunkte öffnen",
    },
    commands: {
    ...
    queue: {
      ...
      steer: "Steuern",
      steered: "Gesteuert",
      steerQueuedMessage: "Eingereihte Nachricht steuern",
      removeQueuedMessage: "Eingereihte Nachricht entfernen",
    },
    goals: {
    ...
    sideChat: {
      ...
      followUp: "Nachfragen…",
      followUpLabel: "Im Seitenchat nachfragen",
    ...
    detailPanel: {
      ...
      noPreviewableMarkdown: "Kein Markdown-Inhalt für die Vorschau verfügbar.",
  ...
  cron: {
    ...
    stats: {
      ...
      tasks: "Aufgaben",
      nextWake: "Nächste Aktivierung",
    },
    detail: {
      newTitle: "Neue geplante Aufgabe",
      newSubtitle:
        "Beschreibe, was OpenClaw tun soll, und lege dann fest, wann es ausgeführt wird.",
    ...
    form: {
      ...
      sessionKeyHelp:
        "Optionaler Routing-Schlüssel für die Auftragszustellung und das Wake-Routing.",
      ...
      failureAlertsHelp:
        "Steuern, wann dieser Job Benachrichtigungen bei wiederholten Fehlern sendet.",
      ...
      failureAlertCooldownHelp: "Mindestsekunden zwischen Benachrichtigungen.",
      failureAlertChannel: "Benachrichtigungskanal",
      failureAlertTo: "Benachrichtigen an",
      failureAlertToPlaceholder: "+1555... oder Chat-ID",
      failureAlertToHelp: "Optionaler Empfänger-Override für Fehlerbenachrichtigungen.",
      ...
      failureAlertAccountPlaceholder: "Account-ID für Multi-Account-Konfigurationen",
