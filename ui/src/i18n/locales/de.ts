...
export const de: TranslationMap = {
  ...
  chat: {
    ...
    toolInput: "Werkzeugeingabe",
    toolOutput: "Werkzeugausgabe",
    toolCall: "Werkzeugaufruf",
    rawDetails: "Rohdetails",
    openInSidePanel: "Im Seitenbereich öffnen",
    openToolDetailsInSidePanel: "Werkzeugdetails im Seitenbereich öffnen",
