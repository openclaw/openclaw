...
export const de: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "Geplante Aufgaben durchsuchen",
      newTask: "Neue Aufgabe",
      filters: "Filter",
      shownOf: "{shown} von {total}",
      emptyTitle: "Noch keine geplanten Aufgaben",
      emptyHint:
        "Beschreiben Sie, was OpenClaw wann tun soll — die Ausführung erfolgt nach Zeitplan.",
    ...
    detail: {
      ...
      newSubtitle:
        "Beschreiben Sie, was OpenClaw tun soll, und wählen Sie dann aus, wann es ausgeführt wird.",
      overviewTitle: "Letzte Aktivitäten",
    ...
    actions: {
      ...
      runIfDue: "Bei Fälligkeit ausführen",
      pause: "Pausieren",
      resume: "Fortsetzen",
      clone: "Duplizieren",
      remove: "Entfernen",
