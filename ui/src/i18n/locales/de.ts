...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.nexus-agent/nexus-agent.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von nexus-agent dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
