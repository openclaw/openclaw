...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Konfigurierte Anbieter mit Tarif, Kontingent und Kosten.",
  ...
  modelProviders: {
    title: "Konfigurierte Anbieter",
    subtitle: "Modellanbieter mit Authentifizierung, Tarif, Kontingent und Kostendaten.",
    updated: "Aktualisiert {time}",
    refreshing: "Wird aktualisiert…",
    disconnected: "Mit dem Gateway verbinden, um konfigurierte Modellanbieter anzuzeigen.",
    emptyTitle: "Keine Modellanbieter konfiguriert",
    emptySubtitle:
      "Melden Sie sich bei einem Anbieter an oder fügen Sie einen API-Schlüssel hinzu, dann aktualisieren Sie.",
    status: {
      ok: "Verbunden",
      expiring: "Läuft ab",
      expired: "Abgelaufen",
      missing: "Nicht angemeldet",
      apiKey: "API-Schlüssel",
    },
    expiresIn: "Anmeldedaten laufen in {time} ab",
    models: "{count} Modelle",
    modelOne: "1 Modell",
    modelsAvailable: "{available} von {count} Modellen verfügbar",
    noStats: "Dieser Anbieter hat keine Live-Nutzungsdaten gemeldet.",
    localCost: "Sitzungsverbrauch · {days} Tage",
    localCostDetail: "{tokens} Tokens · {sessions} Sitzungen",
    saving: "Wird gespeichert…",
