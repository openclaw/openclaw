...
export const de: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "ClawHub suchen",
    ...
    searchClawHubTitle: "ClawHub durchsuchen",
    searchClawHubBody:
      "Geben Sie mindestens zwei Zeichen ein, um Code- und Bundle-Plugins zu finden.",
    noClawHubResultsTitle: "Keine Plugins gefunden",
