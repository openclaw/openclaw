...
export const de: TranslationMap = {
  ...
  question: {
    title: "Der Agent hat eine Frage",
    recommended: "Empfohlen",
    otherLabel: "Andere…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Geben Sie Ihre Antwort ein",
    secretWarning:
      "Ihre Antwort ist für andere Teilnehmer in diesem Kanal möglicherweise sichtbar.",
    submit: "Absenden",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Planmodus",
      goal: "Zielmodus",
      switchConfirm: "Modus wechseln? Dies beendet den aktuellen Modus.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Ansehen",
    approveTitle: "Diesen Plan umsetzen?",
    approveCta: "Genehmigen",
    revise: "Mit Feedback überarbeiten",
    reviseSubmit: "Feedback senden",
    revisePlaceholder: "Was soll sich ändern?",
    cancel: "Abbrechen",
