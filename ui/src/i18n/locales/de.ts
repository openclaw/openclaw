...
export const de: TranslationMap = {
  ...
  chat: {
    ...
    addMessageOrPasteImages: "Nachricht hinzufügen oder weitere Bilder einfügen...",
    messagePlaceholder: "Nachricht (↩ zum Senden, Shift+↩ für Zeilenumbrüche, Bilder einfügen)",
    connectToGateway: "Mit Gateway verbinden, um zu chatten...",
