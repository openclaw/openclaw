...
export const de: TranslationMap = {
  ...
  settings: {
    modeForm: "Formular",
    modeRaw: "Rohdaten",
    formViewUnsafeTooltip: "Die Formularansicht kann einige Felder nicht sicher bearbeiten",
    rawModeTooltip: "Rohe JSON/JSON5-Konfiguration bearbeiten",
    rawModeUnavailable: "Rohmodus für diesen Snapshot nicht verfügbar",
    rawModeDisabledNotice: "Rohmodus deaktiviert (Snapshot kann Rohtext nicht sicher erhalten).",
    unsavedChanges: "Ungespeicherte Änderungen",
    unsavedChangeCount: "{count} ungespeicherte Änderung",
    unsavedChangesCount: "{count} ungespeicherte Änderungen",
