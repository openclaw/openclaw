...
export const pl: TranslationMap = {
  ...
  question: {
    title: "Agent ma pytanie",
    recommended: "Zalecane",
    otherLabel: "Inne…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Wpisz swoją odpowiedź",
    secretWarning: "Twoja odpowiedź może być widoczna dla innych uczestników na tym kanale.",
    submit: "Wyślij",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Tryb planu",
      goal: "Tryb celu",
      switchConfirm: "Zmienić tryb? To zatrzyma bieżący tryb.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Wyświetl",
    approveTitle: "Wdrożyć ten plan?",
    approveCta: "Zatwierdź",
    revise: "Popraw z opinią",
    reviseSubmit: "Wyślij opinię",
    revisePlaceholder: "Co należy zmienić?",
    cancel: "Anuluj",
