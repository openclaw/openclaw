...
export const pl: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Opisz, co i kiedy OpenClaw ma zrobić — zadanie zostanie wykonane zgodnie z harmonogramem.",
    ...
    detail: {
      ...
      newSubtitle: "Opisz, co OpenClaw ma zrobić, a następnie wybierz, kiedy ma to wykonać.",
    ...
    form: {
      ...
      repeatOnExit: "Po zakończeniu",
      onExitHelp:
        "Uruchamia się po zakończeniu monitorowanego polecenia. Harmonogramu nie można tutaj edytować.",
      every: "Co",
      at: "O",
      cronOption: "Cron",
      runAt: "Uruchom o",
      ...
      startEnabled: "Włączone od początku",
