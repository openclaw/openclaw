...
export const pl: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Szukaj w ClawHub",
    ...
    searchClawHubTitle: "Szukaj w ClawHub",
    searchClawHubBody: "Wpisz co najmniej dwa znaki, aby znaleźć wtyczki kodu i pakietów.",
    noClawHubResultsTitle: "Nie znaleziono wtyczek",
