...
export const pl: TranslationMap = {
  ...
  channels: {
    refreshingStaleSnapshot:
      "Odświeżanie statusu kanału w tle; wyświetlanie ostatniego pomyślnego zrzutu.",
    config: {
  ...
  nodes: {
    ...
    inventory: {
      ...
      manualWakeTitle:
        "Gateway nie może wybudzić wyłączonego węzła Windows. Uruchom maszynę lub przywróć jej połączenie sieciowe.",
      approvalNeeded: "wymagane zatwierdzenie",
      inputAgo: "dane wejściowe {time} temu",
      seen: "widziano {time}",
      approved: "zatwierdzono {time}",
      more: "+{count} więcej",
      details: "Szczegóły",
      deviceId: "ID urządzenia: {id}",
      remoteIp: "Zdalny IP: {ip}",
      ...
      scopeUpgrade: "aktualizacja zakresu wymaga zatwierdzenia",
    ...
    execApprovals: {
      ...
      subtitlePrefix: "Lista dozwolonych i polityka zatwierdzania dla",
      loadHint: "Wczytaj zatwierdzenia exec, aby edytować listy dozwolonych.",
      hostNativePolicy: "Polityka natywna hosta",
      hostNativeHint: "Tutaj tylko do odczytu. Edytuj w aplikacji towarzyszącej lub CLI.",
      native: "Natywna",
      defaultAction: "Domyślna akcja",
      rule: "{count} reguła",
      rules: "{count} reguł",
      ...
      defaultSecurity: "Domyślny tryb bezpieczeństwa.",
      defaultValue: "Domyślnie: {value}.",
      mode: "Tryb",
      useDefaultValue: "Użyj domyślnego ({value})",
      ask: "Pytaj",
      defaultPrompt: "Domyślna zasada monitowania.",
      askFallback: "Rezerwowe pytanie",
      promptUnavailable: "Stosowane, gdy monit UI jest niedostępny.",
      fallback: "Rezerwa",
      autoAllowSkills: "Automatycznie zezwalaj na CLI Skills",
      autoAllowSkillsHint: "Zezwól na pliki wykonywalne Skills wymienione przez Gateway.",
      usingDefault: "Używanie domyślnego ({value}).",
      override: "Zastąp ({value}).",
      enabled: "Włączone",
      useDefault: "Użyj domyślnego",
  ...
  agents: {
    ...
    toolCatalog: {
      ...
      descriptions: {
        ...
        sessionsList: "Wyświetl listę sesji",
        ...
        agentsList: "Wyświetl listę agentów",
        image: "Rozumienie obrazów",
      },
      profiles: {
        minimal: "Minimalny",
        coding: "Kodowanie",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle:
        "Lista dozwolonych Skills dla poszczególnych agentów oraz Skills w obszarze roboczym.",
      loadConfig: "Wczytaj konfigurację Gateway, aby ustawić Skills dla poszczególnych agentów.",
      customAllowlist: "Ten agent używa niestandardowej listy dozwolonych Skills.",
      allEnabled:
        "Wszystkie Skills są włączone. Wyłączenie dowolnego Skilla utworzy listę dozwolonych dla tego agenta.",
      loadAgent:
        "Wczytaj Skills dla tego agenta, aby zobaczyć wpisy specyficzne dla obszaru roboczego.",
      filter: "Filtruj",
      searchPlaceholder: "Szukaj Skills",
      shown: "{count} wyświetlonych",
      empty: "Nie znaleziono Skills.",
      missing: "Brakujące: {items}",
      reason: "Powód: {items}",
    },
    channels: {
      title: "Kanały",
  ...
  configForm: {
    ...
    disableStreamToReveal: "Wyłącz tryb strumieniowy, aby pokazać wartość",
    ...
    sections: {
      ...
      channels: {
        label: "Kanały",
        description: "Kanały wiadomości (Telegram, Discord, Slack itp.)",
      },
      messages: {
        label: "Wiadomości",
      ...
      hooks: {
        label: "Haki",
        description: "Webhooki i haki zdarzeń",
      },
      skills: {
        label: "Skills",
      ...
      tools: {
        label: "Narzędzia",
        description: "Konfiguracje narzędzi (przeglądarka, wyszukiwanie itp.)",
      },
      gateway: {
        label: "Gateway",
        description: "Ustawienia serwera Gateway (port, uwierzytelnianie, powiązanie)",
      },
      wizard: {
      ...
      broadcast: {
        label: "Transmisja",
        description: "Ustawienia transmisji i powiadomień",
      },
      audio: {
        label: "Dźwięk",
        description: "Ustawienia wejścia/wyjścia dźwięku",
      },
      session: {
        label: "Sesja",
  ...
  quickSettings: {
    ...
    channels: {
      ...
      empty: "Nie skonfigurowano kanałów",
      connect: "Połącz →",
    },
    automation: {
      title: "Automatyzacje",
    ...
    personal: {
      ...
      avatarText: "Tekst / emoji awatara",
      ...
      overrideHint:
        "Przechowuje nadpisanie Control UI. Wyczyść je, aby wrócić do skonfigurowanego awatara.",
      uiOverride: "Nadpisanie UI",
      configuredAvatar: "Skonfigurowany awatar",
      overrideFromSettings: "Zastąp z ustawień",
      fallbackAvatar: "Awatar zapasowy",
      fallbackLogo: "Logo zapasowe",
      avatarIssues: {
        remoteBlocked: "Zdalne adresy URL są blokowane przez zasady obrazów Control UI",
        ...
        cannotRender: "Nie można wyświetlić awatara",
      },
    },
    pending: {
      title: "Niezapisane zmiany",
      hint: "Zapisanie przechowuje zmiany. Zastosuj teraz dodatkowo przeładowuje bieżącą sesję.",
      discard: "Odrzuć",
      applying: "Stosowanie…",
  ...
  configPage: {
    ...
    themeRemoved: "Usunięto motyw niestandardowy.",
    channels: {
      telegram: "Telegram",
      discord: "Discord",
      slack: "Slack",
  ...
  configView: {
    ...
    notifications: {
      ...
      hint: "Odbieraj powiadomienia push w przeglądarce ze swojego gateway.",
    ...
    appearance: {
      ...
      importHint: "Zaimportuj motyw tweakcn do tego slotu lokalnego przeglądarki",
      importFromTweakcn: "Importuj z tweakcn",
      tweakcnInstructions:
        "Otwórz tweakcn.com, wybierz lub utwórz motyw, kliknij Share, a następnie wklej tutaj skopiowany link motywu. Akceptowane są linki udostępniania, adresy URL edytora, adresy URL rejestru, identyfikatory motywów oraz domyślne nazwy motywów, takie jak amethyst-haze.",
      browseTweakcn: "Przeglądaj motywy tweakcn",
      themeLink: "Link lub ID motywu",
      replace: "Zastąp {name}",
      ...
      inlineHintAfter:
        "aby dodać jeden motyw tweakcn lokalny dla przeglądarki. W tweakcn użyj opcji Udostępnij i wklej skopiowany link tutaj.",
      textSize: "Rozmiar tekstu",
    },
    connection: {
      title: "Połączenie",
    ...
    rawDisabled: "Tryb surowy wyłączony (migawka nie może bezpiecznie odtworzyć surowego tekstu).",
    open: "Otwarte",
    clear: "Wyczyść",
    apply: "Zastosuj",
    applying: "Stosowanie…",
    ...
    viewPendingChanges: "Wyświetl {count} oczekujących zmian",
    ...
    rawConfig: "Surowa konfiguracja (JSON/JSON5)",
    secretCount: "{count} sekret",
    secretCountPlural: "{count} sekretów",
    redacted: "utajnione",
    visible: "widoczne",
    revealSensitive: "Pokaż wrażliwe wartości",
    hideSensitive: "Ukryj wrażliwe wartości",
    toggleRawRedaction: "Przełącz utajnianie surowej konfiguracji",
    sensitiveHidden:
      "Ukryto {count} wrażliwą wartość. Użyj przycisku pokazywania powyżej, aby edytować surową konfigurację.",
    sensitiveHiddenPlural:
      "Ukryto {count} wrażliwych wartości. Użyj przycisku pokazywania powyżej, aby edytować surową konfigurację.",
  },
  execApproval: {
  ...
  agentTools: {
    ...
    notIncluded: "Nieuwzględnione w bieżącym profilu.",
    overrideOff: "Nadpisanie wył.",
    enabled: "Włączone",
    overrideOn: "Nadpisanie wł.",
    profileOff: "Profil wył.",
    notLive: "Nieaktywne",
    otherAgent: "Inny agent",
    title: "Dostęp do narzędzi",
    subtitle: "Profil i nadpisania poszczególnych narzędzi dla tego agenta.",
    enabledSummary: "Włączono {enabled}/{total}.",
    ...
    explicitAllowlist:
      "Ten agent używa jawnej listy dozwolonych w konfiguracji. Nadpisania narzędzi są zarządzane w karcie Konfiguracja.",
    globalAllowlist:
      "Ustawiono globalną wartość tools.allow. Nadpisania agenta nie mogą włączyć narzędzi zablokowanych globalnie.",
    loadingCatalog: "Wczytywanie katalogu narzędzi środowiska uruchomieniowego…",
    catalogFallback:
      "Nie udało się wczytać katalogu narzędzi środowiska uruchomieniowego. Wyświetlana jest zamiast tego wbudowana lista zapasowa.",
    availableNow: "Dostępne teraz",
    availableNowSubtitle: "Co ten agent może wykorzystać w bieżącej sesji czatu.",
    noSession: "brak sesji",
    switchAgent:
      "Przełącz czat na tego agenta, aby zobaczyć jego aktywne narzędzia środowiska uruchomieniowego.",
    loadingAvailable: "Wczytywanie dostępnych narzędzi…",
    availableError: "Nie udało się wczytać dostępnych narzędzi dla tej sesji.",
    noAvailable: "Dla tej sesji nie ma teraz dostępnych narzędzi.",
    moreLiveTitle: "Jeszcze {count} aktywnych narzędzi jest dostępnych w poniższych grupach.",
    ...
    unavailableSession: "Niedostępne w tej sesji czatu w tej chwili.",
    inspectAgent: "Przełącz czat na tego agenta, aby sprawdzić dostępność na żywo.",
    linkTool: "Link do tego narzędzia",
  },
  skillGroups: {
  ...
  skillsPage: {
    ...
    loadingSkillCard: "Ładowanie karty Skill…",
    skillCardNotLoaded: "Karta Skill nie została załadowana.",
    verdict: {
      unavailable: "Niedostępne",
      clean: "Czyste",
      pending: "Oczekujące",
  ...
  mcpPage: {
    ...
    operatorCommandsHint:
      "Status, diagnostyka, uwierzytelnianie, sondowanie i przeładowanie środowiska.",
    runtimeHint:
      "Zmiany środowiska uruchomieniowego obowiązują po zapisaniu i opublikowaniu; aktywni agenci przebudowują środowiska MCP przy następnym użyciu.",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      todoist: "Odczytuj, dodawaj i kończ zadania oraz projekty w Todoist.",
      airtable: "Odpytuj i aktualizuj rekordy, tabele i bazy w Airtable.",
      ...
      googleCalendar:
        "Odczytuj, twórz i otrzymuj informacje o wydarzeniach — Twój agent zarządza Twoim harmonogramem.",
      ...
      transcription: "Zamień audio i wideo w czyste, uporządkowane transkrypcje.",
      github:
        "Kolejki przeglądu PR, segregacja zgłoszeń i pytania o repozytoria dzięki oficjalnemu GitHub MCP.",
      sentry: "Alerty o awariach wyjaśniane i segregowane w momencie ich wystąpienia.",
      context7:
        "Dokumentacja bibliotek i przykłady kodu specyficzne dla wersji podczas programowania. Bez rejestracji.",
      deepwiki: "Zadawaj pytania o dowolne publiczne repozytorium GitHub. Za darmo, bez konta.",
      huggingFace: "Wyszukuj modele, zbiory danych i publikacje; uruchamiaj Spaces jako narzędzia.",
      grafana: "Wiedza o Grafanie i społecznościowe konektory do dashboardów i alertów.",
      kubernetes: "Operacje na klastrze i rozwiązywanie problemów z poziomu czatu.",
      homeAssistant: "Sterowanie oświetleniem, klimatem i automatyzacjami w całym domu.",
      spotify:
        "Wyszukuj, kolejkuj i twórz ścieżkę dźwiękową dnia dzięki playlistom dopasowanym do nastroju.",
      sonos: "Dźwięk w całym domu: odtwarzaj, grupuj pomieszczenia i kolejkuj przez czat.",
      reddit: "Przeglądaj, wyszukuj i podsumowuj subreddity oraz wątki.",
      markets: "Akcje i kryptowaluty na żywo z alertami cenowymi i codziennymi podsumowaniami.",
      travel: "Wyszukiwanie lotów i hoteli z monitorowaniem cen i pamięcią podróży.",
      news: "Spersonalizowany codzienny brief: wiadomości, pogoda i zadania w jednej wiadomości.",
      maps: "Miejsca, trasy i odpowiedzi o czasie podróży.",
      translation: "Tłumacz i lokalizuj teksty oraz dokumenty.",
  ...
  skillWorkshop: {
    ...
    status: {
      ...
      applied: "Zastosowane",
      rejected: "Odrzucone",
      quarantined: "Poddane kwarantannie",
      stale: "Nieaktualne",
    },
    recency: {
      today: "Dzisiaj",
    ...
    revision: {
      ...
      description:
        "Powiedz agentowi, co należy zmienić. Propozycja pozostaje oczekująca, a warsztat utworzy poprawioną wersję.",
      placeholder:
        "Przykład: Użyj etykiet Gmaila zamiast wyszukiwania nieprzeczytanych i dodaj bezpieczniejszy krok próbnego uruchomienia.",
    ...
    queue: {
      ...
      loadError: "Nie można załadować propozycji.",
      loading: "Ładowanie propozycji…",
    ...
    empty: {
      ...
      rejectedBody: "Pominięte propozycje pozostaną tutaj dla przejrzystej historii przeglądu.",
      ...
      staleBody: "Propozycje, których nie można już poprawnie zastosować, pojawią się tutaj.",
      allTitle: "Brak propozycji tutaj",
      allBody: "Propozycje Skill Workshop pojawią się tutaj, gdy Twój agent je opracuje.",
      defaultAgent: "Twój agent",
      noProposalsAria: "Brak propozycji Skill Workshop",
      noProposalsTitle: "Brak propozycji",
      noProposalsBody: "{agent} nie opracował jeszcze żadnych propozycji umiejętności.",
      noProposalsFooter: "Nowe propozycje pojawią się tutaj do przeglądu.",
    },
    today: {
      emptyTitle: "Nic nie czeka dzisiaj",
      emptyBody:
        "Twój agent nie przygotował nic nowego. Przełącz na Tablicę, aby przeglądać historię.",
      new: "NOWE",
      waiting: "OCZEKUJE",
      reviewed: "PRZEJRZANE",
      agent: "agent",
      proposalsWaiting: "Oczekujące propozycje: {count}",
      ...
      tweakIt: "Dopracuj",
      askAgent: "Poproś agenta o zmianę czegoś",
      skipping: "Pomijanie…",
      skip: "Pomiń",
      notForMe: "Nie dla mnie",
      upNext: "Następne · {count} więcej w kolejce",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      dreamsExplainer:
        "To surowy dziennik snów zapisywany przez system podczas odtwarzania i konsolidacji pamięci; użyj go, aby sprawdzić, co zauważa system pamięci i gdzie nadal wydaje się zaszumiony lub ubogi.",
      insightsExplainer:
        "To zaimportowane spostrzeżenia zgrupowane z zewnętrznej historii; użyj ich, aby przejrzeć, co ujawniły importy, zanim cokolwiek z tego przejdzie do trwałej pamięci.",
      palaceExplainer:
        "To skompilowana powierzchnia wiki pamięci, którą system może przeszukiwać i analizować; użyj jej, aby przeglądać rzeczywiste strony pamięci, twierdzenia, otwarte pytania i sprzeczności, zamiast surowych zaimportowanych czatów źródłowych.",
      ...
      noInsightsHint:
        "Uruchom import z ChatGPT z zastosowaniem, aby wyświetlić tutaj zgrupowane zaimportowane spostrzeżenia.",
      ...
      emptyPalaceHint:
        "Obecnie wiki zawiera głównie surowe importy źródeł i raporty operacyjne. Ta karta stanie się przydatna, gdy zaczną powstawać syntezy, encje lub koncepcje.",
      claims: "Twierdzenia",
      ...
      unavailablePluginPrefix: "Imported Insights i Memory Palace są dostarczane przez dołączony",
      unavailablePluginSuffix: "plugin.",
      enablePrefix: "Włącz",
      enableSuffix: ", a następnie odśwież tę kartę.",
  ...
  chat: {
    ...
    compaction: {
      ...
      description:
        "Skompaktowany zapis jest zachowywany jako punkt kontrolny. Otwórz punkty kontrolne sesji, aby rozgałęzić lub przywrócić z tego skompaktowanego widoku.",
      openCheckpoints: "Otwórz punkty kontrolne",
    },
    commands: {
      arguments: "Argumenty polecenia",
      menu: "Polecenia ukośnika",
      instant: "natychmiast",
      ...
      steerDescription: "Wprowadź wiadomość do aktywnego przebiegu",
      categories: {
        session: "Sesja",
        model: "Model",
        agents: "Agenci",
    ...
    queue: {
      ...
      steer: "Steruj",
      steered: "Sterowano",
      steerQueuedMessage: "Steruj wiadomością w kolejce",
    ...
    sideChat: {
      ...
      sendFollowUp: "Wyślij dalszą wiadomość",
    },
    detailPanel: {
      ...
      noPreviewableMarkdown: "Brak zawartości Markdown do podglądu.",
    ...
    composer: {
      ...
      compactRecommendedContext: "Kompaktowy zalecany kontekst sesji",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Opisz, co OpenClaw ma zrobić i kiedy — działa zgodnie z harmonogramem.",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "W dni powszednie o 9:00",
    ...
    detail: {
      ...
      newSubtitle: "Opisz, co OpenClaw ma zrobić, a następnie wybierz, kiedy ma się uruchomić.",
    ...
    form: {
      ...
      lightContextHelp: "Użyj lekkiego kontekstu startowego dla tego zadania agenta.",
      model: "Model",
      ...
      failureAlertsHelp:
        "Kontroluj, kiedy to zadanie wysyła alerty o powtarzających się niepowodzeniach.",
      failureAlertAfter: "Alert po",
      failureAlertAfterHelp: "Kolejne błędy przed wysłaniem alertu.",
      ...
      failureAlertTo: "Alert do",
      failureAlertToPlaceholder: "+1555... lub identyfikator czatu",
      failureAlertToHelp: "Opcjonalne zastąpienie odbiorcy alertów o błędach.",
      failureAlertMode: "Tryb alertu",
      failureAlertAnnounce: "Ogłoś (przez kanał)",
      failureAlertWebhook: "Webhook (HTTP POST)",
      failureAlertAccountId: "Identyfikator konta alertu",
