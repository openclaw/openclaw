...
export const pl: TranslationMap = {
  ...
  settings: {
    modeForm: "Formularz",
    modeRaw: "Surowy",
    formViewUnsafeTooltip: "Widok formularza nie może bezpiecznie edytować niektórych pól",
    rawModeTooltip: "Edytuj surową konfigurację JSON/JSON5",
    rawModeUnavailable: "Tryb surowy niedostępny dla tej migawki",
    rawModeDisabledNotice:
      "Tryb surowy wyłączony (migawka nie może bezpiecznie zachować surowego tekstu).",
    unsavedChanges: "Niezapisane zmiany",
    unsavedChangeCount: "{count} niezapisana zmiana",
    unsavedChangesCount: "{count} niezapisanych zmian",
