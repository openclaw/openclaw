...
export const pl: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Skonfigurowani dostawcy z planem, limitem i kosztami.",
  ...
  modelProviders: {
    title: "Skonfigurowani dostawcy",
    subtitle: "Dostawcy modeli z uwierzytelnianiem, planem, limitem i danymi kosztów.",
    updated: "Zaktualizowano {time}",
    refreshing: "Odświeżanie…",
    disconnected: "Połącz się z bramką, aby zobaczyć skonfigurowanych dostawców modeli.",
    emptyTitle: "Nie skonfigurowano dostawców modeli",
    emptySubtitle: "Zaloguj się do dostawcy lub dodaj klucz API, a następnie odśwież.",
    status: {
      ok: "Połączono",
      expiring: "Wygasa",
      expired: "Wygasł",
      missing: "Nie zalogowano",
      apiKey: "Klucz API",
    },
    expiresIn: "Dane uwierzytelniające wygasają za {time}",
    models: "{count} modeli",
    modelOne: "1 model",
    modelsAvailable: "{available} z {count} modeli dostępnych",
    noStats: "Ten dostawca nie zgłosił żadnych danych o bieżącym użyciu.",
    localCost: "Wydatki sesji · {days} dni",
    localCostDetail: "{tokens} tokenów · {sessions} sesji",
    saving: "Zapisywanie…",
