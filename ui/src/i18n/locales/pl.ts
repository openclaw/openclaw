...
export const pl: TranslationMap = {
  ...
  browser: {
    ...
    annotate: "Adnotuj stronę",
    inspect: "Sprawdź element",
    annotateSend: "Wyślij do czatu",
    annotateUndo: "Cofnij",
    annotateClear: "Wyczyść",
    annotateDone: "Zamknij tryb adnotacji",
    annotateHint: "Narysuj na stronie, a następnie wyślij oznaczenia do czatu.",
    inspectHint: "Najedź, aby sprawdzić; kliknij, aby wysłać element do czatu.",
    inspectName: "Nazwa",
    inspectRole: "Rola",
    inspectFocusable: "Możliwy fokus",
    ...
    empty: "Brak otwartych kart. Wpisz URL powyżej, aby przeglądać.",
