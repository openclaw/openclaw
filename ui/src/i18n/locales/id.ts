...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    nostr: {
      title: "Nostr",
      subtitle: "DM terdesentralisasi via relay Nostr (NIP-04).",
      profile: "Profil",
  ...
  nodes: {
    ...
    binding: {
      ...
      node: "Node",
      anyNode: "Node apa pun",
      noNodes: "Tidak ada node dengan system.run yang tersedia.",
      noAgents: "Tidak ada agent yang ditemukan.",
    ...
    inventory: {
      ...
      versionDriftTitle:
        "Node {nodeVersion}; Gateway {gatewayVersion}. Perbarui komponen yang lebih lama untuk menyelaraskan fleet.",
      manualWake: "perlu bangun manual",
      manualWakeTitle:
        "Gateway tidak dapat membangunkan node Windows yang offline. Nyalakan mesin atau pulihkan koneksi jaringannya.",
      ...
      reapproval: "detail koneksi ulang berubah; persetujuan diperlukan",
    ...
    execApprovals: {
      ...
      fallback: "Fallback",
      autoAllowSkills: "Izinkan otomatis CLI Skills",
      autoAllowSkillsHint: "Izinkan executable Skills yang tercantum oleh Gateway.",
      usingDefault: "Menggunakan default ({value}).",
      override: "Ganti ({value}).",
      enabled: "Aktif",
      useDefault: "Gunakan bawaan",
      allowlist: "Allowlist",
      allowlistHint: "Pola glob yang tidak peka huruf besar/kecil.",
  ...
  agents: {
    ...
    overview: {
      title: "Ikhtisar",
      subtitle: "Jalur workspace dan metadata identitas.",
      selectedSkills: "{count} dipilih",
      allSkills: "semua Skills",
    ...
    skillsPanel: {
      title: "Skills",
      subtitle: "Daftar izin Skills per agen dan Skills workspace.",
      loadConfig: "Muat konfigurasi gateway untuk mengatur Skills per agen.",
      customAllowlist: "Agen ini menggunakan daftar izin Skills kustom.",
      allEnabled:
        "Semua Skills diaktifkan. Menonaktifkan Skills apa pun akan membuat daftar izin per agen.",
      loadAgent: "Muat Skills untuk agen ini guna melihat entri khusus workspace.",
      filter: "Filter",
      searchPlaceholder: "Cari Skills",
      shown: "{count} ditampilkan",
      empty: "Tidak ada Skills yang ditemukan.",
  ...
  configForm: {
    ...
    structuredSecretFile: "Nilai terstruktur (SecretRef) - edit file konfigurasi secara langsung",
    defaultValue: "Default: {value}",
    ...
    sections: {
      ...
      skills: {
        label: "Skills",
        description: "Paket dan kemampuan Skills",
      },
      tools: {
        label: "Tools",
      ...
      logging: {
        label: "Logging",
        description: "Tingkat log dan konfigurasi output",
      },
      browser: {
        label: "Browser",
      ...
      bindings: {
        label: "Binding",
        description: "Pengikatan tombol dan pintasan",
      },
      broadcast: {
        label: "Broadcast",
  ...
  quickSettings: {
    ...
    channels: {
      ...
      empty: "Tidak ada channel yang dikonfigurasi",
      connect: "Hubungkan →",
    },
    automation: {
      title: "Automations",
      ...
      installedSkills: "{count} skill terpasang",
    ...
    system: {
      ...
      load: "beban",
      used: "terpakai",
      freeOf: "{free} tersedia dari {total}",
    ...
    personal: {
      ...
      assistantIdentity: "Identitas asisten",
      ...
      configuredAvatar: "Avatar yang dikonfigurasi",
    ...
    pending: {
      ...
      hint: "Simpan menyimpan perubahan Anda. Apply Now juga memuat ulang sesi saat ini.",
      discard: "Buang",
      applying: "Menerapkan…",
      applyNow: "Apply Now",
    },
  ...
  configView: {
    ...
    rawDisabled:
      "Mode mentah dinonaktifkan (snapshot tidak dapat menangani teks mentah secara aman).",
    open: "Terbuka",
    clear: "Hapus",
    apply: "Terapkan",
    applying: "Menerapkan…",
    ...
    invalidConfig:
      "Konfigurasi Anda tidak valid. Beberapa pengaturan mungkin tidak berfungsi sebagaimana mestinya.",
    ...
    formUnsafe:
      "Konfigurasi Anda berisi bidang yang tidak dapat direpresentasikan dengan aman oleh editor formulir. Gunakan mode Raw untuk mengedit entri tersebut.",
    rawConfig: "Config mentah (JSON/JSON5)",
  ...
  agentTools: {
    ...
    title: "Akses Alat",
    subtitle: "Penggantian profil + per-alat untuk agen ini.",
    ...
    explicitAllowlist:
      "Agen ini menggunakan allowlist eksplisit di konfigurasi. Penggantian alat dikelola di tab Config.",
    globalAllowlist:
    ...
    availableNowSubtitle: "Yang dapat digunakan agen ini dalam sesi obrolan saat ini.",
    ...
    live: "Live",
    status: "Status",
    profileSourceAgent: "penggantian agent",
    ...
    toolPreview: "Pratinjau tool",
    more: "+{count} lainnya",
    toolsOne: "{count} Tool",
    tools: "{count} Tool",
    enabledToolsOne: "{count} Tool Aktif",
    enabledTools: "{count} Tool Aktif",
    liveToolsOne: "{count} Tool Live",
    liveTools: "{count} Tool Live",
    access: "Akses",
    ...
    unavailableSession: "Tidak tersedia di sesi chat ini saat ini.",
    inspectAgent: "Alihkan chat ke agent ini untuk memeriksa ketersediaan langsung.",
    linkTool: "Tautan ke Tool Ini",
  },
  skillGroups: {
  ...
  skillsPage: {
    ...
    searching: "Mencari…",
    acknowledgeRisk: "Konfirmasi risiko dan pasang",
    ...
    missingRequirements: "Persyaratan yang hilang",
  ...
  skillStatus: {
    ...
    blocked: "terblokir",
    disabled: "dinonaktifkan",
    blockedAllowlist: "diblokir oleh daftar izin",
  ...
  mcpPage: {
    ...
    runtimeHint:
      "Perubahan runtime berlaku setelah disimpan dan dipublikasikan; agen aktif membangun ulang runtime MCP pada penggunaan berikutnya.",
    toolFilter: "filter alat",
    parallel: "paralel",
    missingTransport: "transport tidak ada",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      notion: "Cari, buat, dan perbarui halaman serta basis data di ruang kerja Notion Anda.",
      linear: "Triase isu, perbarui siklus, dan laporkan bug langsung dari obrolan.",
      todoist: "Baca, tambahkan, dan selesaikan tugas serta proyek di Todoist.",
      airtable: "Kueri dan perbarui rekaman, tabel, dan base di Airtable.",
      jira: "Buat, cari, dan triase tiket Jira dari obrolan.",
      ...
      email: "Triase kotak masuk, ringkasan, dan draf dengan kirim setelah persetujuan.",
      ...
      github: "Antrean tinjauan PR, triase isu, dan tanya jawab repo melalui GitHub MCP resmi.",
      sentry: "Peringatan crash dijelaskan dan ditriase begitu terjadi.",
      context7:
        "Dokumentasi pustaka khusus versi dan contoh kode saat coding. Tanpa perlu mendaftar.",
      ...
      grafana: "Keahlian Grafana dan konektor komunitas untuk dasbor dan peringatan.",
      kubernetes: "Operasi klaster dan pemecahan masalah dari chat.",
      ...
      reddit: "Jelajahi, cari, dan ringkas subreddit serta thread.",
      ...
      news: "Briefing harian yang dipersonalisasi: berita, cuaca, dan tugas dalam satu pesan.",
      maps: "Jawaban tentang tempat, rute, dan waktu perjalanan.",
  ...
  skillWorkshop: {
    ...
    revision: {
      title: "{verb} proposal",
      description:
        "Beri tahu agen apa yang harus diubah. Proposal tetap tertunda dan workshop akan membuat versi revisi.",
      placeholder:
    ...
    empty: {
      ...
      appliedBody: "Gunakan proposal tertunda dan itu akan muncul di sini sebagai skill langsung.",
      ...
      allBody: "Proposal Skill Workshop akan muncul di sini saat agen Anda menyusunnya.",
      defaultAgent: "Agen Anda",
      noProposalsAria: "Tidak ada proposal Skill Workshop",
      noProposalsTitle: "Belum ada proposal",
      noProposalsBody: "{agent} belum menyusun proposal skill apa pun.",
      noProposalsFooter: "Proposal baru akan muncul di sini untuk ditinjau.",
    },
    today: {
      emptyTitle: "Tidak ada yang menunggu hari ini",
      emptyBody: "Agen Anda belum membuat draf baru. Beralih ke Board untuk menjelajahi riwayat.",
      new: "BARU",
      waiting: "MENUNGGU",
      reviewed: "DITINJAU",
      agent: "agen",
      ...
      seeAll: "Lihat semua usulan →",
      collection: "Koleksi Anda · {count} sedang digunakan",
      manage: "Kelola →",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      dreamsExplainer:
        "Ini adalah buku harian mimpi mentah yang ditulis sistem saat memutar ulang dan mengonsolidasikan memori; gunakan untuk memeriksa apa yang diperhatikan sistem memori, dan di mana ia masih tampak berisik atau tipis.",
      insightsExplainer:
        "Ini adalah wawasan yang diimpor dan dikelompokkan dari riwayat eksternal; gunakan untuk meninjau apa yang muncul dari impor sebelum salah satunya beralih menjadi memori yang tahan lama.",
      palaceExplainer:
        "Ini adalah permukaan wiki memori terkompilasi yang dapat dicari dan diproses oleh sistem; gunakan untuk memeriksa halaman memori aktual, klaim, pertanyaan terbuka, dan kontradiksi daripada obrolan sumber mentah yang diimpor.",
      copyArchivePath: "Salin jalur arsip",
      loadingInsights: "Memuat wawasan yang diimpor…",
      noInsights: "Belum ada wawasan yang diimpor",
      noInsightsHint:
        "Jalankan impor ChatGPT dengan apply untuk menampilkan wawasan yang diimpor dan dikelompokkan di sini.",
      ...
      emptyPalaceHint:
        "Saat ini wiki sebagian besar hanya berisi impor sumber mentah dan laporan operasional. Tab ini menjadi berguna setelah sintesis, entitas, atau konsep mulai ditulis.",
      claims: "Klaim",
  ...
  usage: {
    ...
    details: {
      ...
      filterByRole: "Filter menurut peran",
      filterByTool: "Filter menurut alat",
      you: "Anda",
  ...
  chat: {
    ...
    actions: {
      dismissError: "Abaikan kesalahan",
    ...
    compaction: {
      ...
      description:
        "Transkrip yang dipadatkan disimpan sebagai checkpoint. Buka checkpoint sesi untuk membuat cabang atau memulihkan dari tampilan yang dipadatkan itu.",
    ...
    goals: {
      edit: "Edit sasaran",
      pause: "Jeda sasaran",
      resume: "Lanjutkan sasaran",
      clear: "Hapus sasaran",
    },
    messages: {
      activity: "Aktivitas",
      deleteMessage: "Hapus pesan",
      openInCanvas: "Buka di kanvas",
    ...
    sideChat: {
      title: "Obrolan sampingan",
      notSaved: "Tidak disimpan ke riwayat obrolan",
      thinking: "Berpikir…",
      clear: "Hapus obrolan sampingan",
    ...
    detailPanel: {
      ...
      renderedMarkdownHint: "Pratinjau teks kaya yang dibersihkan untuk pembacaan cepat.",
    ...
    composer: {
      ...
      runDone: "Selesai",
      runInterrupted: "Terganggu",
      runStatus: "Status proses: {status}",
      cancelReply: "Batalkan balasan",
      compactRecommendedContext: "Ringkas konteks sesi yang direkomendasikan",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Jelaskan apa yang harus dilakukan OpenClaw dan kapan — akan berjalan sesuai jadwal.",
    ...
    detail: {
      ...
      newSubtitle: "Jelaskan apa yang harus dilakukan OpenClaw, lalu pilih kapan akan berjalan.",
      overviewTitle: "Aktivitas terkini",
      overviewSubtitle: "Proses terbaru di seluruh tugas terjadwal.",
    ...
    form: {
      ...
      sessionKeyHelp: "Kunci perutean opsional untuk pengiriman tugas dan perutean wake.",
      ...
      seconds: "Detik",
      accountId: "ID Akun",
      accountIdHelp: "ID akun saluran opsional untuk penyiapan multi-akun.",
      lightContext: "Konteks ringan",
      lightContextHelp: "Gunakan konteks bootstrap ringan untuk tugas agen ini.",
      model: "Model",
      ...
      failureAlertDisabled: "Nonaktifkan untuk tugas ini",
      failureAlertCustom: "Pengaturan khusus per-tugas",
      failureAlertsHelp: "Kontrol kapan tugas ini mengirim peringatan kegagalan berulang.",
      failureAlertAfter: "Peringatan setelah",
      failureAlertAfterHelp: "Kesalahan berturut-turut sebelum memberi peringatan.",
      failureAlertCooldown: "Cooldown (detik)",
      failureAlertCooldownHelp: "Detik minimum antar peringatan.",
      failureAlertChannel: "Saluran peringatan",
      failureAlertTo: "Peringatan ke",
      ...
      failureAlertAnnounce: "Umumkan (via saluran)",
