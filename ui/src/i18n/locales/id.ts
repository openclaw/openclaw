...
export const id: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Penyedia yang dikonfigurasi dengan paket, kuota, dan biaya.",
  ...
  modelProviders: {
    title: "Penyedia yang dikonfigurasi",
    subtitle: "Penyedia model dengan autentikasi, paket, kuota, dan data biaya.",
    updated: "Diperbarui {time}",
    refreshing: "Menyegarkan…",
    disconnected: "Hubungkan ke gateway untuk melihat penyedia model yang dikonfigurasi.",
    emptyTitle: "Tidak ada penyedia model yang dikonfigurasi",
    ...
    expiresIn: "Kredensial kedaluwarsa dalam {time}",
    models: "{count} model",
    modelOne: "1 model",
    modelsAvailable: "{available} dari {count} model tersedia",
    noStats: "Tidak ada data penggunaan langsung yang dilaporkan oleh penyedia ini.",
    localCost: "Pengeluaran sesi · {days}h",
    localCostDetail: "{tokens} token · {sessions} sesi",
    saving: "Menyimpan…",
