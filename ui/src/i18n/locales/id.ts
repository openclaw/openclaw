...
export const id: TranslationMap = {
  ...
  question: {
    title: "Agen memiliki pertanyaan",
    recommended: "Direkomendasikan",
    otherLabel: "Lainnya…",
    otherInlineLabel: "No, and tell OpenClaw what to do differently",
    otherPlaceholder: "Ketik jawaban Anda",
    secretWarning: "Balasan Anda mungkin terlihat oleh peserta lain di saluran ini.",
    submit: "Kirim",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      plan: "Mode rencana",
      goal: "Mode tujuan",
      switchConfirm: "Ganti mode? Ini akan menghentikan mode saat ini.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Lihat",
    approveTitle: "Terapkan rencana ini?",
    approveCta: "Setujui",
    revise: "Revisi dengan masukan",
    reviseSubmit: "Kirim masukan",
    revisePlaceholder: "Apa yang harus diubah?",
    cancel: "Batal",
