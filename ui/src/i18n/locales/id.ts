...
export const id: TranslationMap = {
  ...
  settings: {
    modeForm: "Formulir",
    modeRaw: "Mentah",
    formViewUnsafeTooltip: "Tampilan formulir tidak dapat mengedit beberapa bidang dengan aman",
    rawModeTooltip: "Edit konfigurasi JSON/JSON5 mentah",
    rawModeUnavailable: "Mode mentah tidak tersedia untuk snapshot ini",
    rawModeDisabledNotice:
      "Mode mentah dinonaktifkan (snapshot tidak dapat mempertahankan teks mentah dengan aman).",
    unsavedChanges: "Perubahan belum disimpan",
    unsavedChangeCount: "{count} perubahan belum disimpan",
