...
export const id: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Jelaskan apa yang harus dilakukan OpenClaw dan kapan — tugas akan berjalan sesuai jadwal.",
    ...
    suggestions: {
      title: "Ide otomasi",
      schedules: {
        weekdayMornings: "Hari kerja pukul 09.00",
    ...
    stats: {
      scheduler: "Penjadwal",
      tasks: "Tugas",
      nextWake: "Aktivasi berikutnya",
    },
    detail: {
      newTitle: "Tugas terjadwal baru",
      newSubtitle: "Jelaskan apa yang harus dilakukan OpenClaw, lalu pilih kapan tugas dijalankan.",
      overviewTitle: "Aktivitas terbaru",
      overviewSubtitle: "Eksekusi terbaru dari semua tugas terjadwal.",
    ...
    actions: {
      ...
      runIfDue: "Jalankan jika sudah waktunya",
      pause: "Jeda",
      resume: "Lanjutkan",
      clone: "Duplikat",
      remove: "Hapus",
    ...
    form: {
      ...
      onExitHelp:
        "Berjalan saat perintah yang dipantau selesai. Jadwal tidak dapat diedit di sini.",
      every: "Setiap",
      at: "Pada",
      cronOption: "Cron",
      runAt: "Jalankan pada",
