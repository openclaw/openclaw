...
export const id: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Cari ClawHub",
    ...
    preparingSearch: "Menyiapkan pencarian…",
    searchClawHubTitle: "Cari ClawHub",
    searchClawHubBody: "Masukkan setidaknya dua karakter untuk menemukan kode dan plugin bundle.",
    noClawHubResultsTitle: "Tidak ada plugin yang ditemukan",
    ...
    statInstalled: "Terinstal",
    statEnabled: "Diaktifkan",
    statIssues: "Perlu perhatian",
