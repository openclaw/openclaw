...
export const id: TranslationMap = {
  ...
  cron: {
    ...
    detail: {
      ...
      newSubtitle: "Jelaskan apa yang harus dilakukan OpenClaw, lalu pilih kapan dijalankan.",
      overviewTitle: "Aktivitas terbaru",
      overviewSubtitle: "Eksekusi terbaru di semua tugas terjadwal.",
    ...
    form: {
      ...
      startEnabled: "Mulai dalam keadaan aktif",
