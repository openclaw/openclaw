...
export const pt_BR: TranslationMap = {
  ...
  settings: {
    modeForm: "Formulário",
    modeRaw: "Bruto",
    formViewUnsafeTooltip:
      "A visualização de formulário não pode editar alguns campos com segurança",
    rawModeTooltip: "Editar a configuração JSON/JSON5 bruta",
    rawModeUnavailable: "Modo bruto indisponível para este snapshot",
    rawModeDisabledNotice:
      "Modo bruto desativado (o snapshot não consegue preservar o texto bruto com segurança).",
