...
export const pt_BR: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "Nenhuma tarefa agendada ainda",
      emptyHint:
        "Descreva o que o OpenClaw deve fazer e quando — ele será executado conforme o agendamento.",
    ...
    suggestions: {
      ...
      schedules: {
        weekdayMornings: "De segunda a sexta-feira às 9:00",
    ...
    stats: {
      scheduler: "Agendador",
      tasks: "Tarefas",
      nextWake: "Próxima execução",
    },
    detail: {
      newTitle: "Nova tarefa agendada",
      newSubtitle: "Descreva o que o OpenClaw deve fazer e escolha quando ele será executado.",
    ...
    form: {
      ...
      onExitHelp:
        "É executada quando um comando monitorado é encerrado. A programação não pode ser editada aqui.",
      every: "A cada",
      at: "Às",
      cronOption: "Cron",
      runAt: "Executar às",
