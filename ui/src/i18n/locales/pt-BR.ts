...
export const pt_BR: TranslationMap = {
  ...
  chat: {
    ...
    addMessageOrPasteImages: "Adicionar mensagem ou colar mais imagens...",
    messagePlaceholder: "Mensagem (↩ para enviar, Shift+↩ para quebras de linha, colar imagens)",
    connectToGateway: "Conectar ao gateway para começar a conversar...",
