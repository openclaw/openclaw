...
export const pt_BR: TranslationMap = {
  ...
  agentsPage: {
    ...
    empty: {
      ...
      subtitle: "Escolha um agente para inspecionar seu espaço de trabalho e ferramentas.",
    },
    tabs: {
      overview: "Visão Geral",
      files: "Arquivos",
    ...
    overview: {
      ...
      skillsFilterAll: "todas as habilidades",
      skillsFilterSelected: "{count} selecionadas",
      identityUnavailable: "Indisponível",
    },
    models: {
      title: "Seleção de modelo",
      primary: "Modelo principal",
      primaryDefault: "Modelo principal (padrão)",
      inheritDefault: "Herdar padrão",
      inheritDefaultWithValue: "Herdar padrão ({value})",
      fallbacks: "Modelos alternativos (separados por vírgula)",
