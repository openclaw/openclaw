...
export const pt_BR: TranslationMap = {
  ...
  languagePage: {
    ...
    subtitle: "Escolha o idioma usado neste dashboard neste dispositivo.",
    currentLabel: "Idioma atual",
    localOnly: "A mudança é salva na hora neste navegador.",
    availableTitle: "Idiomas disponíveis",
    availableHint: "Você pode trocar isso a qualquer momento pela barra lateral.",
    selectedBadge: "Selecionado",
    defaultBadge: "Padrão",
    previewLabel: "Código do locale",
  },
};
