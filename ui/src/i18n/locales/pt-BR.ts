...
export const pt_BR: TranslationMap = {
  ...
  agentTools: {
    ...
    builtIn: "Integrado",
    toolAccessTitle: "Acesso a ferramentas",
    toolAccessSubtitle: "Perfil + sobrescritas por ferramenta para este agente. {enabled}/{total} ativadas.",
    ...
    skillsSubtitle: "Allowlist de habilidades por agente e habilidades do workspace. {enabled}/{total}",
    skillsSubtitleNoCount: "Allowlist de habilidades por agente e habilidades do workspace.",
    reset: "Redefinir",
    loadConfigInfo: "Carregue a config do gateway para definir habilidades por agente.",
    customAllowlistInfo: "Este agente usa uma allowlist de habilidades personalizada.",
    allSkillsInfo: "Todas as habilidades estão ativadas. Desativar qualquer habilidade criará uma allowlist por agente.",
    loadSkillsInfo: "Carregue as habilidades deste agente para ver entradas específicas do workspace.",
