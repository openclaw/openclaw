...
export const pt_BR: TranslationMap = {
  ...
  filePreview: {
    ...
    emptySubtitle: "Tente outro nome de arquivo ou busca por conteúdo.",
  ...
  githubPreview: {
    ...
    unavailable: "Pré-visualização do GitHub indisponível",
    states: {
      merged: "Mesclado",
      draft: "Rascunho",
      open: "Aberto",
  ...
  channels: {
    ...
    config: {
      schemaUnavailable: "Schema indisponível. Use Raw.",
      channelSchemaUnavailable: "Schema de configuração do canal indisponível.",
      loadingSchema: "Carregando schema de configuração…",
    },
    health: {
    ...
    googleChat: {
      title: "Google Chat",
      subtitle: "Status do webhook da API do Chat e configuração do canal.",
    },
    imessage: {
      title: "iMessage",
      subtitle: "Status do bridge do macOS e configuração do canal.",
    },
    signal: {
      title: "Signal",
    ...
    nostr: {
      title: "Nostr",
      subtitle: "Mensagens diretas descentralizadas via relays Nostr (NIP-04).",
      profile: "Perfil",
  ...
  nodes: {
    ...
    inventory: {
      ...
      olderPairing: "{count} pareamento anterior de {name}",
      olderPairings: "{count} pareamentos anteriores de {name}",
      ...
      scopeUpgrade: "atualização de escopo requer aprovação",
      roleUpgrade: "atualização de função requer aprovação",
      reapproval: "detalhes de reconexão alterados; aprovação necessária",
      newPairing: "nova solicitação de emparelhamento de dispositivo",
      repair: "reparar",
    ...
    execApprovals: {
      ...
      hostNativeHint: "Somente leitura aqui. Edite pelo app complementar ou pela CLI.",
      native: "Nativo",
      ...
      on: "ligado",
      target: "Destino",
      targetHint: "O Gateway edita aprovações locais; o node edita o node selecionado.",
      host: "Host",
      gateway: "Gateway",
      node: "Nó",
      selectNode: "Selecionar node",
      noNodes: "Nenhum node anuncia aprovações de exec ainda.",
      scope: "Escopo",
      defaults: "Padrões",
      security: "Segurança",
      ...
      ask: "Perguntar",
      defaultPrompt: "Política padrão de prompt.",
      askFallback: "Fallback de pergunta",
      promptUnavailable: "Aplicado quando o prompt da UI está indisponível.",
      fallback: "Alternativa",
      autoAllowSkills: "Permitir CLIs de skills automaticamente",
      autoAllowSkillsHint: "Permitir executáveis de skills listados pelo Gateway.",
  ...
  agents: {
    ...
    overview: {
      ...
      selectedSkills: "{count} selecionadas",
    ...
    skillsPanel: {
      ...
      allEnabled:
        "Todos os Skills estão ativados. Desativar qualquer Skill criará uma lista de permissões por agente.",
      loadAgent: "Carregue os Skills deste agente para ver entradas específicas do workspace.",
      filter: "Filtrar",
  ...
  configForm: {
    ...
    disableStreamToReveal: "Desative o modo stream para revelar o valor",
    ...
    unsupportedSchema: "Esquema não suportado. Use Raw.",
    ...
    sections: {
      ...
      skills: {
        label: "Skills",
        description: "Pacotes de Skills e capacidades",
      },
      tools: {
        label: "Ferramentas",
      ...
      meta: {
        label: "Metadados",
        description: "Metadados do Gateway e informações de versão",
      },
      logging: {
        label: "Registro",
      ...
      broadcast: {
        label: "Transmissão",
        description: "Configurações de transmissão e notificações",
      },
      audio: {
        label: "Áudio",
      ...
      canvasHost: {
        label: "Host do Canvas",
        description: "Renderização e exibição do canvas",
      },
      talk: {
        label: "Fala",
      ...
      cli: {
        label: "CLI",
        description: "Banner da CLI e comportamento de inicialização",
      },
      secrets: {
        label: "Secrets",
        description: "Configuração do provedor de secrets",
      },
      acp: {
        label: "ACP",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      overrideHint:
        "Armazena uma substituição da Control UI. Limpe-a para voltar ao avatar configurado.",
      uiOverride: "Substituição de UI",
      configuredAvatar: "Avatar configurado",
      overrideFromSettings: "Substituição pelas configurações",
      fallbackAvatar: "Avatar alternativo",
      fallbackLogo: "Logotipo alternativo",
      avatarIssues: {
        remoteBlocked: "URLs remotas são bloqueadas pela política de imagens da Control UI",
  ...
  configView: {
    ...
    notifications: {
      ...
      blockedHint:
        "As notificações estão bloqueadas. Atualize as permissões do site no seu navegador para permitir notificações.",
    },
    appearance: {
      theme: "Tema",
      ...
      importHint: "Importe um tema do tweakcn para este slot local do navegador",
      importFromTweakcn: "Importar do tweakcn",
      tweakcnInstructions:
        "Abra tweakcn.com, escolha ou crie um tema, clique em Share e, em seguida, cole aqui o link do tema copiado. São aceitos links de compartilhamento, URLs do editor, URLs de registro, IDs de temas e nomes de temas padrão como amethyst-haze.",
      ...
      inlineHintAfter:
        "para adicionar um tema tweakcn local no navegador. No tweakcn, use Share e cole aqui o link copiado.",
      textSize: "Tamanho do texto",
    },
    connection: {
      title: "Conexão",
    ...
    rawTitle: "Editar config JSON/JSON5 bruto",
    ...
    rawDisabled:
      "Modo raw desativado (o snapshot não pode fazer round-trip do texto raw com segurança).",
    open: "Abrir",
    clear: "Limpar",
    apply: "Aplicar",
    applying: "Aplicando…",
    ...
    revealEnvValues: "Revelar valores de env",
    peek: "Espiar",
  ...
  agentTools: {
    ...
    optional: "Opcional",
    liveNow: "Ativo agora",
    disabledByOverride: "Desativado por substituição do agente.",
    enabledByProfile: "Ativado pelo perfil atual.",
    enabledByOverride: "Ativado por substituição do agente.",
    ...
    explicitAllowlist:
      "Este agente está usando uma lista de permissões explícita na configuração. As substituições de ferramentas são gerenciadas na aba Config.",
    globalAllowlist:
      "O global tools.allow está definido. As substituições do agente não podem ativar ferramentas que estão bloqueadas globalmente.",
    loadingCatalog: "Carregando catálogo de ferramentas de tempo de execução…",
    catalogFallback:
      "Não foi possível carregar o catálogo de ferramentas de tempo de execução. Exibindo lista de reserva integrada.",
    availableNow: "Disponível Agora",
    availableNowSubtitle: "O que este agente pode usar na sessão de chat atual.",
    noSession: "sem sessão",
    switchAgent:
      "Mude o chat para este agente para ver suas ferramentas de tempo de execução ativas.",
    ...
    statusSaved: "salvo",
    toolPreview: "Visualização da ferramenta",
    more: "+{count} mais",
    ...
    inspectAgent: "Mude o chat para este agente para inspecionar a disponibilidade ao vivo.",
  ...
  skillsPage: {
    ...
    filterPlaceholder: "Filtrar Skills instalados",
    shown: "{count} exibido(s)",
    clawHub: "ClawHub",
    ...
    empty: "Nenhum Skill encontrado.",
    noClawHubResults: "Nenhum Skill encontrado no ClawHub.",
    install: "Instalar",
  ...
  mcpPage: {
    ...
    runtimeHint:
      "As mudanças de tempo de execução se aplicam após salvar e publicar; os agentes ativos reconstroem os runtimes MCP no próximo uso.",
  ...
  pluginsPage: {
    ...
    connectorDescriptions: {
      ...
      linear: "Faça a triagem de issues, atualize ciclos e registre bugs direto do chat.",
      ...
      jira: "Crie, pesquise e triague tickets do Jira pelo chat.",
      ...
      googleCalendar: "Leia, crie e receba resumos de eventos — seu agente cuida da sua agenda.",
      ...
      github:
        "Filas de revisão de PR, triagem de issues e perguntas sobre repositórios pelo MCP oficial do GitHub.",
      sentry: "Alertas de falhas explicados e triados assim que são disparados.",
      context7:
        "Documentação de bibliotecas por versão e exemplos de código enquanto você programa. Não precisa de cadastro.",
      deepwiki:
        "Faça perguntas sobre qualquer repositório público do GitHub. Grátis, sem necessidade de conta.",
      huggingFace: "Pesquise modelos, datasets e artigos; execute Spaces como ferramentas.",
      grafana: "Conhecimento sobre Grafana e conectores da comunidade para dashboards e alertas.",
      kubernetes: "Operações e resolução de problemas de cluster pelo chat.",
      homeAssistant: "Controle luzes, climatização e automações por toda a sua casa.",
      spotify:
        "Pesquise, adicione à fila e crie a trilha sonora do seu dia com playlists baseadas no humor.",
      sonos: "Áudio para toda a casa: reproduza, agrupe ambientes e crie filas por chat.",
      ...
      travel: "Busca de voos e hotéis com monitoramento de tarifas e memória de viagens.",
      news: "Um resumo diário personalizado: notícias, clima e tarefas em uma única mensagem.",
      maps: "Locais, rotas e respostas sobre tempo de viagem.",
  ...
  skillWorkshop: {
    ...
    recency: {
      today: "Hoje",
      yesterday: "Ontem",
      earlier: "No início desta semana",
    },
    ...
    revision: {
      ...
      placeholder:
        "Exemplo: Faça isto usar rótulos do Gmail em vez da busca por não lidos, e adicione uma etapa de dry-run mais segura.",
      preparing: "Preparando transferência de revisão",
      send: "Enviar revisão",
    },
    queue: {
      resize: "Redimensionar lista de propostas",
      search: "Pesquisar propostas…",
    ...
    empty: {
      ...
      rejectedBody:
        "As propostas ignoradas permanecerão aqui para um histórico de revisão organizado.",
      ...
      allBody: "As propostas do Skill Workshop aparecerão aqui quando seu agente as esboçar.",
      defaultAgent: "Seu agente",
      noProposalsAria: "Nenhuma proposta do Skill Workshop",
      noProposalsTitle: "Ainda não há propostas",
      noProposalsBody: "{agent} não esboçou nenhuma proposta de skill.",
      noProposalsFooter: "Novas propostas aparecerão aqui para revisão.",
    },
    today: {
      emptyTitle: "Nada esperando hoje",
      emptyBody: "Seu agente não esboçou nada novo. Vá para o Quadro para navegar pelo histórico.",
      new: "NOVA",
      waiting: "AGUARDANDO",
      reviewed: "REVISADA",
      agent: "agente",
      proposalsWaiting: "{count} propostas aguardando",
      browseApplied: "Navegue pelo que já foi aplicado.",
      progress: "{current} de {total}",
      draftedBy: "Esboçado por",
      supportFile: "{count} arquivo de suporte",
      supportFiles: "{count} arquivos de suporte",
      comeWithIt: "vêm junto.",
      useIt: "Usar",
      addToSkills: "Adicionar aos seus skills",
      tweakIt: "Ajustar",
      askAgent: "Peça ao agente para mudar algo",
      skipping: "Ignorando…",
      skip: "Ignorar",
      notForMe: "Não é para mim",
      upNext: "A seguir · {count} mais aguardando",
      seeAll: "Ver todas as propostas →",
      collection: "Sua coleção · {count} em uso",
      manage: "Gerenciar →",
      workflowHeading: "Como o agente vai usar",
      applicabilityHeading: "Quando o agente deve usar",
    },
    relative: {
      secondsAgo: "há {count}s",
  ...
  workboard: {
    ...
    templateDraft: {
      bugfixTitle: "Correção: ",
      bugfixNotes: "Sintoma:\nCausa:\nAceitação:\nComprovação:",
      docsTitle: "Docs: ",
      docsNotes: "Página:\nAlteração:\nComprovação da fonte:",
  ...
  dreaming: {
    ...
    wiki: {
      previewFallbackTitle: "Página da wiki",
      close: "Fechar",
      loadingPage: "Carregando página da wiki…",
      dreamsTab: "Sonhos",
      insightsTab: "Insights Importados",
      palaceTab: "Palácio da Memória",
      dreamsExplainer:
        "Este é o diário de sonhos bruto que o sistema escreve enquanto reproduz e consolida a memória; use-o para inspecionar o que o sistema de memória está percebendo e onde ainda parece ruidoso ou escasso.",
      insightsExplainer:
        "Estes são insights importados agrupados a partir do histórico externo; use-os para revisar o que as importações revelaram antes que qualquer parte disso se torne memória duradoura.",
      palaceExplainer:
        "Esta é a superfície compilada da wiki de memória que o sistema pode pesquisar e raciocinar sobre; use-a para inspecionar páginas de memória reais, afirmações, questões em aberto e contradições, em vez de chats de origem importados brutos.",
      copyArchivePath: "Copiar caminho do arquivo",
      loadingInsights: "Carregando insights importados…",
      noInsights: "Ainda não há insights importados",
      noInsightsHint:
        "Execute uma importação do ChatGPT com aplicar para exibir aqui insights importados agrupados.",
      ...
      emptyPalaceHint:
        "No momento, o wiki tem principalmente importações de origem brutas e relatórios operacionais. Esta aba se torna útil quando sínteses, entidades ou conceitos começam a ser escritos.",
      claims: "Afirmações",
      ...
      id: "Id:",
      openWikiPage: "Abrir página do wiki",
      unavailable: "O Memory Wiki não está habilitado",
      unavailablePluginPrefix:
        "Imported Insights e Memory Palace são fornecidos pelo pacote integrado",
  ...
  chat: {
    ...
    compaction: {
      ...
      description:
        "A transcrição compactada é preservada como um ponto de verificação. Abra os pontos de verificação da sessão para ramificar ou restaurar a partir dessa visualização compactada.",
    ...
    detailPanel: {
      ...
      renderedMarkdownHint: "Prévia de rich text sanitizada para leitura rápida.",
      noPreviewableMarkdown: "Nenhum conteúdo markdown para pré-visualizar.",
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "Pesquisar tarefas agendadas",
      newTask: "Nova tarefa",
      filters: "Filtros",
      shownOf: "{shown} de {total}",
      emptyTitle: "Ainda não há tarefas agendadas",
      emptyHint:
        "Descreva o que o OpenClaw deve fazer e quando — ele será executado no horário programado.",
    ...
    detail: {
      ...
      overviewTitle: "Atividade recente",
      overviewSubtitle: "Execuções mais recentes de todas as tarefas agendadas.",
      historyTitle: "Histórico de execuções",
      detailsSection: "Detalhes",
      frequencySection: "Frequência",
      paused: "Pausada",
    },
    actions: {
      runNow: "Executar agora",
      runIfDue: "Executar se estiver no prazo",
      pause: "Pausar",
      resume: "Retomar",
      clone: "Clonar",
      remove: "Remover",
    ...
    form: {
      ...
      sessionKeyHelp:
        "Chave de roteamento opcional para entrega de trabalhos e roteamento de ativação.",
      ...
      accountIdHelp: "ID de conta de canal opcional para configurações com múltiplas contas.",
      lightContext: "Contexto leve",
      lightContextHelp: "Usar contexto de inicialização leve para este trabalho do agente.",
      model: "Modelo",
      ...
      failureAlertDisabled: "Desativar para este trabalho",
      failureAlertCustom: "Configurações personalizadas por trabalho",
      failureAlertsHelp: "Controle quando este trabalho envia alertas de falhas repetidas.",
      failureAlertAfter: "Alertar após",
      failureAlertAfterHelp: "Erros consecutivos antes de alertar.",
      failureAlertCooldown: "Tempo de espera (segundos)",
