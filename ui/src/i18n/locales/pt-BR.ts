...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    modelProviders: "Provedores configurados com plano, cota e custo.",
    memoryImport:
  ...
  modelProviders: {
    ...
    subtitle: "Provedores de modelos com autenticação, plano, cota e dados de custo.",
    updated: "Atualizado {time}",
    refreshing: "Atualizando…",
    disconnected: "Conecte-se ao gateway para ver os provedores de modelos configurados.",
    emptyTitle: "Nenhum provedor de modelos configurado",
    emptySubtitle: "Faça login em um provedor ou adicione uma chave API e atualize.",
    status: {
      ok: "Conectado",
      expiring: "Expirando",
      expired: "Expirado",
    ...
    expiresIn: "A credencial expira em {time}",
    models: "{count} modelos",
    modelOne: "1 modelo",
    modelsAvailable: "{available} de {count} modelos disponíveis",
    noStats: "Nenhum dado de uso ao vivo relatado por este provedor.",
    localCost: "Gasto da sessão · {days}d",
    localCostDetail: "{tokens} tokens · {sessions} sessões",
    saving: "Salvando…",
