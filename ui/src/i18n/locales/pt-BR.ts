...
export const pt_BR: TranslationMap = {
  ...
  pluginsPage: {
    ...
    clawhubSearchPlaceholder: "Pesquisar no ClawHub",
    ...
    preparingSearch: "Preparando pesquisa…",
    searchClawHubTitle: "Pesquisar no ClawHub",
    searchClawHubBody:
      "Digite pelo menos dois caracteres para encontrar plugins de código e de pacote.",
    noClawHubResultsTitle: "Nenhum plugin encontrado",
