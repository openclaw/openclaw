...
export const pt_BR: TranslationMap = {
  ...
  cron: {
    ...
    detail: {
      ...
      newSubtitle:
        "Descreva o que o OpenClaw deve fazer e, em seguida, escolha quando será executado.",
      overviewTitle: "Atividade recente",
      overviewSubtitle: "Execuções mais recentes em todas as tarefas agendadas.",
    ...
    form: {
      ...
      onExitHelp:
        "Executa quando um comando monitorado é encerrado. O agendamento não pode ser editado aqui.",
      every: "A cada",
      at: "Às",
      cronOption: "Cron",
      runAt: "Executar às",
