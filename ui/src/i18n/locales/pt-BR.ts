...
export const pt_BR: TranslationMap = {
  ...
  question: {
    ...
    secretWarning: "Sua resposta pode ficar visível para outros participantes neste canal.",
    submit: "Enviar",
    dismiss: "Dismiss",
  ...
  chat: {
    ...
    mode: {
      ...
      switchConfirm: "Trocar de modo? Isso interrompe o modo atual.",
    },
    splitView: {
  ...
  plan: {
    ...
    view: "Visualizar",
    approveTitle: "Implementar este plano?",
    approveCta: "Aprovar",
    revise: "Revisar com feedback",
    reviseSubmit: "Enviar feedback",
    revisePlaceholder: "O que deve mudar?",
    cancel: "Cancelar",
