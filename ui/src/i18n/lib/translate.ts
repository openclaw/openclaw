...
export const SUPPORTED_LOCALES: ReadonlyArray<Locale> = ["en", "zh-CN", "zh-TW", "pt-BR", "fil-PH"];
  ...
  private loadLocale() {
    ...
    if (isSupportedLocale(saved)) {
      ...
      if (navLang.startsWith("zh")) {
        ...
        this.locale = "pt-BR";
      } else if (navLang === "fil" || navLang.startsWith("fil-")) {
        this.locale = "fil-PH";
      } else {
        this.locale = "en";
      }
  ...
  public async setLocale(locale: Locale) {
    ...
    if (!this.translations[locale]) {
      try {
        ...
        } else if (locale === "fil-PH") {
          module = await import("../locales/fil-PH.ts");
        } else {
          return;
        }
