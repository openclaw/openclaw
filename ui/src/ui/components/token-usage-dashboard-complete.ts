                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="percentage-bar">
                        <div class="percentage-fill" style="width: ${model.percentage || 0}%"></div>
                      </div>
                    </td>
                  </tr>
                `
        ...
        <div class="stats-grid">
          <div class="stat-card">
            <div class="stat-card-header">
              <div class="stat-title">Peak Usage Day</div>
              <svg class="stat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M12 20v-6M6 20v-12M18 20V8"/>
              </svg>
            </div>
            <div class="stat-value">
              ${this.summaryData?.peakUsage