...
export type ClarityStatusResult = {
  workspace?: string;
  status?: { state?: string; step?: string; ts?: string; extra?: unknown };
  verification?: unknown;
  progressTail?: string[];
  generatedAt?: string;
};

export type ClaritySummaryResult = {
  generated_at?: string;
  period?: string;
  since?: string;
  until?: string;
  ...
  activities?: Array<{ activity_type?: string; n?: number; cost?: number }>;
  proposals?: Array<{ state?: string; n?: number }>;
};

export type ClarityTimelineResult = {
  generatedAt?: string;
  limit?: number;
  timeline?: Array<{
    ts?: string;
...
export type ClarityProposalsResult = {
...
export type ClarityNightlyResult = {
  latest?: unknown;
  files?: string[];
  count?: number;
  generatedAt?: string;
