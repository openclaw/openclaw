      ...
      case "channels":
        return renderLazyView(lazyChannels, (m) =>
          m.renderChannels({
            ...
            expandedChannelIds: state.channelsExpandedIds,
            channelFilter: state.channelsFilter,
            onChannelToggle: (channelId) => state.toggleChannelExpanded(channelId),
            onChannelFilterChange: (filter) => state.setChannelsFilter(filter),
