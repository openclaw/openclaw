...
type ControlChatSurfaceOptions = {
  state: AppViewState;
  ...
  onToggleWorkspaceFilesCollapsed: () => void;
  onRefreshWorkspaceFiles: () => void;
  onBrowseWorkspacePath: (path: string) => void;
  onCopyWorkspacePath: (path: string) => void;
  onOpenWorkspaceFile: (path: string) => void;
  onSearchWorkspaceFiles: (search: string) => void;
  onOpenWorkspaceArtifact: (artifactId: string) => void;
  chatAgentId: string;
...
function renderControlChatSurface(options: ControlChatSurfaceOptions) {
  const {
    ...
    chatViewError,
    chatWorkspaceFiles,
    onToggleWorkspaceFilesCollapsed,
  ...
  return renderChat({
    ...
    sessionWorkspace: {
      ...
      onToggleCollapsed: onToggleWorkspaceFilesCollapsed,
      onRefresh: onRefreshWorkspaceFiles,
      onBrowsePath: onBrowseWorkspacePath,
      onCopyPath: onCopyWorkspacePath,
      onOpenFile: onOpenWorkspaceFile,
      onSearch: onSearchWorkspaceFiles,
      onOpenArtifact: onOpenWorkspaceArtifact,
    },
