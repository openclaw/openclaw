        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="MaxBot" />
            </div>
            <div class="brand-text">
              <div class="brand-title">MAXBOT</div>
        ...
        ${
          state.tab === "sessions"
            ? renderSessions({
                ...
                onViewSession: (key) => loadSessionHistory(state, key),
                sessionHistoryLoading: state.sessionHistoryLoading,
                sessionHistoryKey: state.sessionHistoryKey,
                sessionHistoryMessages: state.sessionHistoryMessages,
                onCloseSessionHistory: () => {
                  state.sessionHistoryKey = null;
