...
import { renderConversations } from "./views/conversations.ts";
  ...
  return html`
    ...
    >
        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="Iris" />
            </div>
      ...
      <div class="sidebar-header">
        ${
          ...
          <div class="sidebar-brand">
            <img class="sidebar-brand__logo" src="${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"}" alt="Iris" />
            <span class="sidebar-brand__title">Iris</span>
          </div>
        `
        }
        <button
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "conversations" ? renderConversations() : nothing}
      </main>
