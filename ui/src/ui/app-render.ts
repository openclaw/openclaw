          ...
          ? renderMeasured(
              ...
              () =>
                renderChat({
                  ...
                  onStartDictation: (selection) => void state.startDictation(selection),
                  onConfirmDictation: () => void state.confirmDictation(),
                  onCancelDictation: () => state.cancelDictation(),
                  onDismissDictationError: () => state.dismissDictationError(),
                  onRequestUpdate: requestHostUpdate,
