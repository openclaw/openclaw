...
export class OpenClawApp extends LitElement {
	...
	@state() sessionsSortColumn: "key" | "kind" | "updated" | "tokens" =
		"updated";
	...
	@state() skillsFilter = "";
	@state() skillsStatusFilter: "all" | "ready" | "needs-setup" | "disabled" =
		"all";
	...
	protected updated(changed: Map<PropertyKey, unknown>) {
		...
		if (
			...
			this.agentsSelectedId === activeSessionAgentId
		) {
	...
	setThemeMode(
		next: ThemeMode,
		context?: Parameters<typeof setThemeModeInternal>[2],
	) {
