  ...
  return html`
    <div class="chat-controls">
      <label class="field chat-controls__session">
        <select
          ...
          @change=${(e: Event) => {
            ...
            (state as unknown as EasyHubApp).chatStreamStartedAt = null;
            state.chatRunId = null;
            (state as unknown as EasyHubApp).resetToolStream();
            (state as unknown as EasyHubApp).resetChatScroll();
            state.applySettings({
              ...state.settings,
              sessionKey: next,
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as EasyHubApp;
