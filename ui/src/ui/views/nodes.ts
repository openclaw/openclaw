...
function renderPendingDevice(req: PendingDevice, props: NodesProps) {
  ...
  const age = typeof req.ts === "number" ? formatRelativeTimestamp(req.ts) : t("nodes.na");
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="muted" style="margin-top: 6px;">
          ${t("nodes.role")}: ${roleValue} · ${t("nodes.scopes")}: ${scopesValue} · ${t("nodes.requested")} ${age}${repair}
        </div>
      </div>
      <div class="list-meta">
              ...
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${
                    !supportsBinding
                      ? html`
                          <div class="muted">${t("nodes.noSystemRunNodes")}</div>
                        `
                      : nothing
                  }
                </div>
        ...
        <div class="list-sub">
          ...
          ${
            bindingValue === "__default__"
              ? t("nodes.usesDefault", { default: state.defaultBinding ?? t("nodes.any") })
              : t("nodes.override", { binding: agent.binding })
          }
        </div>
      </div>
      <div class="list-meta">
