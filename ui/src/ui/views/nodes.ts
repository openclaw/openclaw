    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            ${t("nodes.execBindingSub", { code: "" })}<span class="mono">exec host=node</span>.
          </div>
        </div>
        <button
          class="btn"
        ...
        state.formMode === "raw"
          ? html`
              <div class="callout warn" style="margin-top: 12px">
                ${t("nodes.formModeHint", { mode: "Form" })}
              </div>
            `
          : nothing
      }
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="list-sub">
          ${agent.isDefault ? t("nodes.defaultAgent") : t("nav.agent").toLowerCase()} ·
          ${
      ...
      <div class="list-main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          ...
          <span class="chip ${connected ? "chip-ok" : "chip-warn"}">
            ${connected ? t("common.connected").toLowerCase() : t("common.offline").toLowerCase()}
          </span>
