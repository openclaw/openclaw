...
function renderPendingApprovalNote(kind: PendingDeviceApprovalKind) {
  switch (kind) {
    case "scope-upgrade":
      return t("nodes.approval.scopeUpgrade");
    case "role-upgrade":
      return t("nodes.approval.roleUpgrade");
    case "re-approval":
      return t("nodes.approval.reApproval");
    case "new-pairing":
      return t("nodes.approval.newPairing");
  }
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="muted" style="margin-top: 6px;">
          ${renderPendingApprovalNote(approval.kind)} · ${t("nodes.requested")} ${age}${repair}
        </div>
        <div class="muted" style="margin-top: 6px;">
          ${t("nodes.requestedLabel")} ${formatAccessSummary(approval.requested)}
        </div>
        ${approval.approved
          ? html`
              <div class="muted" style="margin-top: 6px;">
                ${t("nodes.approvedNowLabel")} ${formatAccessSummary(approval.approved)}
              </div>
            `
          : nothing}
      </div>
...
function renderPairedDevice(device: PairedDevice, props: NodesProps) {
  ...
  const roles = t("nodes.rolesLabel", { roles: formatList(device.roles) });
  const scopes = t("nodes.scopesLabel", { scopes: formatList(device.scopes) });
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        ${tokens.length === 0
          ? html` <div class="muted" style="margin-top: 6px">${t("nodes.noTokens")}</div> `
          : html`
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${!supportsBinding
                    ? html` <div class="muted">${t("nodes.noExecNodes")}</div> `
                    : nothing}
                </div>
              </div>
      ...
      <div class="list-main">
        ...
        <div class="list-sub">
          ...
          ${bindingValue === "__default__"
            ? t("nodes.usesDefault", { binding: state.defaultBinding ?? t("nodes.any") })
            : t("nodes.override", { binding: agent.binding ?? t("nodes.unknown") })}
        </div>
      </div>
      <div class="list-meta">
        <label class="field">
