...
function createOverviewProps(overrides: Partial<OverviewProps> = {}): OverviewProps {
  return {
    ...
    eventLog: [],
    overviewLogLines: [],
    mctlConnectStatus: null,
    mctlConnectLoading: false,
    mctlConnectError: null,
    codexConnectStatus: null,
    codexConnectLoading: false,
    codexConnectError: null,
    codexManualInput: "",
    ...
    onStartMctlConnect: () => undefined,
    onDisconnectMctl: () => undefined,
    onStartCodexConnect: () => undefined,
    onCodexManualInputChange: () => undefined,
    onSubmitCodexManualInput: () => undefined,
    onDisconnectCodex: () => undefined,
    ...overrides,
  };
}
