    ...
    <section class="card">
      ...
      <div class="table" style="margin-top: 16px;">
        <div class="table-head">
          <div>${t("sessions.column.key")}</div>
          <div>${t("sessions.column.label")}</div>
          <div>${t("sessions.column.kind")}</div>
          <div>${t("sessions.column.updated")}</div>
          <div>${t("sessions.column.tokens")}</div>
          <div>${t("sessions.column.thinking")}</div>
          <div>${t("sessions.column.verbose")}</div>
          <div>${t("sessions.column.reasoning")}</div>
          <div>${t("sessions.column.actions")}</div>
        </div>
        ${
          rows.length === 0
            ? html`
