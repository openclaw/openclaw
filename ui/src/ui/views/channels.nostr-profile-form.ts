  ...
  const renderPicturePreview = () => {
    ...
    return html`
      <div style="margin-bottom: 12px;">
        <img
          src=${picture}
          alt=${t("channels.nostr.profilePreviewAlt")}
  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        ...
        <div style="font-size: 12px; color: var(--text-muted);">${t("channels.nostr.account", { id: accountId })}</div>
      </div>
      ...
      ${renderField("displayName", t("channels.nostr.displayName"), {
        ...
        maxLength: 256,
        help: t("channels.nostr.fullDisplayName"),
      })}
        ...
        state.showAdvanced
          ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              <div style="font-weight: 500; margin-bottom: 12px; color: var(--text-muted);">${t("channels.nostr.advanced")}</div>
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? t("channels.nostr.savingProfile") : t("channels.nostr.savePublish")}
        </button>
        ...
        >
          ${state.showAdvanced ? t("channels.nostr.hideAdvanced") : t("channels.nostr.showAdvanced")}
        </button>
