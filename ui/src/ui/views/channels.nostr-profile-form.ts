...
export function renderNostrProfileForm(params: {
  ...
  const renderPicturePreview = () => {
    ...
    return html`
      <div style="margin-bottom: 12px;">
        <img
          src=${picture}
          alt=${t("channels.nostrPicturePreview")}
  ...
  return html`
    ...
    >
      ...
      >
        <div style="font-weight: 600; font-size: 16px;">${t("channels.nostrProfileEditTitle")}</div>
        <div style="font-size: 12px; color: var(--text-muted);">${t("channels.nostrAccountLabel")}: ${accountId}</div>
      </div>
        ...
        state.showAdvanced
          ? html`
            ...
            >
              ...
              ${renderField("nip05", t("channels.nostrNip05Identifier"), {
                placeholder: "you@example.com",
                help: t("channels.nostrNip05Help"),
              })}
              ${renderField("lud16", t("channels.nostrLightningAddress"), {
                placeholder: "you@getalby.com",
                help: t("channels.nostrLightningAddressHelp"),
              })}
            </div>
          `
          : nothing
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? t("channels.nostrSaving") : t("channels.nostrSaveAndPublish")}
        </button>
        ...
        >
          ${state.importing ? t("channels.nostrImporting") : t("channels.nostrImportFromRelays")}
        </button>
        ...
        <button class="btn" @click=${callbacks.onCancel} ?disabled=${state.saving}>${t("channels.nostrCancel")}</button>
      </div>
