      ...
      <section class="card agents-sidebar">
        <div class="row" style="justify-content: space-between;">
          <div>
            ...
            <div class="card-sub">
              ${t("agentsPage.sidebar.configuredCount", { count: String(agents.length) })}
            </div>
          </div>
        ...
        <div class="agent-list" style="margin-top: 12px;">
          ${
            agents.length === 0
              ? html`
                  <div class="muted">${t("agentsPage.sidebar.noAgents")}</div>
                `
              : agents.map((agent) => {
      ...
      <section class="agents-main">
        ${
          !selectedAgent
            ? html`
                <div class="card">
                  <div class="card-title">${t("agentsPage.empty.title")}</div>
                  <div class="card-sub">${t("agentsPage.empty.subtitle")}</div>
                </div>
              `
            : html`
                ${renderAgentHeader(
...
function renderAgentOverview(params: {
  ...
  const identityStatus = agentIdentityLoading
    ? t("common.loading")
    : agentIdentityError
      ? t("agentsPage.overview.identityUnavailable")
      : "";
  ...
  return html`
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>
            ${
              skillFilter
                ? t("agentsPage.overview.skillsFilterSelected", { count: String(skillCount ?? 0) })
                : t("agentsPage.overview.skillsFilterAll")
            }
          </div>
        </div>
      </div>
      ...
      <div class="agent-model-select" style="margin-top: 20px;">
        <div class="label">${t("agentsPage.models.title")}</div>
        <div class="row" style="gap: 12px; flex-wrap: wrap;">
          <label class="field" style="min-width: 260px; flex: 1;">
            <span>
              ${isDefault ? t("agentsPage.models.primaryDefault") : t("agentsPage.models.primary")}
            </span>
            <select
                ...
                isDefault
                  ...
                  : html`
                      <option value="">
                        ${
                          defaultPrimary
                            ? t("agentsPage.models.inheritDefaultWithValue", {
                                value: defaultPrimary,
                              })
                            : t("agentsPage.models.inheritDefault")
                        }
                      </option>
                    `
              }
          ...
          <label class="field" style="min-width: 260px; flex: 1;">
            <span>${t("agentsPage.models.fallbacks")}</span>
            <input
              .value=${fallbackText}
              ?disabled=${!configForm || configLoading || configSaving}
              placeholder=${t("agentsPage.models.fallbacksPlaceholder")}
              @input=${(e: Event) =>
                onModelFallbacksChange(
                  agent.id,
        ...
        <div class="row" style="justify-content: flex-end; gap: 8px;">
          <button class="btn btn--sm" ?disabled=${configLoading} @click=${onConfigReload}>
            ${t("agentsPage.models.reloadConfig")}
          </button>
          <button
