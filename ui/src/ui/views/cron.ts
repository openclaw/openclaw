  ...
  return html`
    <section class="card cron-summary-strip">
      ...
      <div class="cron-summary-strip__actions">
        ...
        >
          ${props.loading
            ? t("cron.summary.refreshing")
            : t("cron.summary.refresh")}
        </button>
        ${props.error
          ...
          props.runsHasMore
            ? html`
                <div class="row" style="margin-top: 12px">
                  ...
                  >
                    ${props.runsLoadingMore
                      ? t("cron.jobs.loading")
                      : t("cron.runs.loadMore")}
                  </button>
                </div>
              `
            : nothing}
                ...
                ? html`
                    <label class="field cron-span-2">
                      ...
                      <input
                        ...
                        @input=${(e: Event) =>
                          props.onFormChange({
                            deliveryAccountId: (e.target as HTMLInputElement)
                              .value,
                          })}
                        placeholder="default"
                      />
                    ...
                    <label class="field checkbox cron-checkbox cron-span-2">
                      <input
                        ...
                        @change=${(e: Event) =>
                          props.onFormChange({
                            payloadLightContext: (e.target as HTMLInputElement)
                              .checked,
                          })}
                      />
                      ...
                      ? html`
                          ...
                          <label class="field">
                            ...
                            <input
                              ...
                              aria-invalid=${props.fieldErrors
                                .failureAlertCooldownSeconds
                                ? "true"
                                : "false"}
                              aria-describedby=${ifDefined(
                          ...
                          <label class="field">
                            ...
                            <input
                              ...
                              @input=${(e: Event) =>
                                props.onFormChange({
                                  failureAlertTo: (e.target as HTMLInputElement)
                                    .value,
                                })}
                          ...
                          <label class="field">
                            ...
                            <select
                              .value=${props.form.failureAlertDeliveryMode ||
                              "announce"}
                              @change=${(e: Event) =>
                                props.onFormChange({
    ...
    <div class=${itemClass} @click=${() => props.onLoadRuns(job.id)}>
      ...
      <div class="cron-job-footer">
        ...
        <div class="row cron-job-actions">
          ...
          >
            ${job.enabled
              ? t("cron.jobList.disable")
              : t("cron.jobList.enable")}
          </button>
          <button
            class="btn"
            ?disabled=${props.busy}
...
function formatRunNextLabel(nextRunAtMs: number, nowMs = Date.now()) {
  ...
  return nextRunAtMs > nowMs
    ? t("cron.runEntry.next", { rel })
    : t("cron.runEntry.due", { rel });
}
  ...
  return html`
    <div class="cron-job-state">
      <div class="cron-job-state-row">
        ...
        <span class=${`cron-job-status-pill ${statusClass}`}
          >${statusLabel}</span
        >
      </div>
      <div class="cron-job-state-row">
