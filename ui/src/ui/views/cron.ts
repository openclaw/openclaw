                    ...
                    <label class="field cron-span-2">
                      ...
                      <div class="cron-help">
                        ${uiText(
                          ...
                          "Khóa định tuyến tùy chọn cho gửi kết quả tác vụ và định tuyến đánh thức.",
                        )}
                      </div>
                    </label>
                    ${isCronSchedule
                    ...
                    ${isAgentTurn
                      ? html`
                          ...
                          <label class="field checkbox cron-checkbox cron-span-2">
                            ...
                            />
                            <span class="field-checkbox__label">
                              ${uiText("Light context", "Ngữ cảnh nhẹ")}
                            </span>
                            <div class="cron-help">
                              ${uiText(
                                "Use lightweight bootstrap context for this agent job.",
                                "Dùng ngữ cảnh bootstrap nhẹ cho tác vụ agent này.",
                              )}
                            </div>
                          </label>
                          <label class="field">
                      ...
                      ? html`
                          <label class="field cron-span-2">
                            ...
                            >
                              ...
                              <option value="disabled">
                                ${uiText("Disable for this job", "Tắt cho tác vụ này")}
                              </option>
                              <option value="custom">
                                ${uiText("Custom per-job settings", "Cài đặt riêng cho tác vụ")}
                              </option>
                            </select>
                            <div class="cron-help">
                              ${uiText(
                                "Control when this job sends repeated-failure alerts.",
                                "Kiểm soát thời điểm tác vụ gửi cảnh báo lỗi lặp lại.",
                              )}
                            </div>
                          </label>
                          ${props.form.failureAlertMode === "custom"
                            ? html`
                                ...
                                <label class="field">
                                  ${renderFieldLabel(uiText("Alert to", "Gửi cảnh báo tới"))}
                                  <input
                                  ...
                                  <div class="cron-help">
                                    ${uiText(
                                      ...
                                      "Người nhận tùy chọn ghi đè cho cảnh báo lỗi.",
                                    )}
                                  </div>
                                </label>
                                <label class="field">
                                ...
                                <label class="field">
                                  ${renderFieldLabel(
                                    uiText("Alert account ID", "ID tài khoản cảnh báo"),
                                  )}
                                  <input
