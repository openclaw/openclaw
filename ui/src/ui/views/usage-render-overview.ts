      ...
      <div class="daily-chart">
        <div class="daily-chart-bars" style="--bar-max-width: ${barMaxWidth}px">
          ${daily.map((d, idx) => {
						...
						const labelClass =
							daily.length > 20
								? "daily-bar-label daily-bar-label--compact"
								: "daily-bar-label";
						const segments =
    ...
    <div class="cost-breakdown cost-breakdown-compact">
      ...
      <div class="cost-breakdown-bar">
        ...
        <div
          ...
          style="width: ${(
						isTokenMode ? tokenPcts.cacheWrite : breakdown.cacheWrite.pct
					).toFixed(1)}%"
        ...
        <div
          ...
          style="width: ${(
						isTokenMode ? tokenPcts.cacheRead : breakdown.cacheRead.pct
					).toFixed(1)}%"
...
function renderPeakErrorList(
	...
	const cardClass = ["usage-insight-card", options?.className]
		.filter(Boolean)
		.join(" ");
	const listClass = ["usage-error-list", options?.listClassName]
		.filter(Boolean)
		.join(" ");
	return html`
    <div class=${cardClass}>
      ...
      <div class="usage-overview-layout">
        <div class="usage-summary-grid">
          ...
          ${renderSummaryStat({
						...
						className:
							"usage-summary-card--hero usage-summary-card--throughput",
						compactValue: true,
					})}
          ${renderSummaryStat({
