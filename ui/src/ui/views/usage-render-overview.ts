...
function renderFilterChips(
  ...
  const sessionsLabel = selectedSession
    ...
    : selectedSessions.length === 1
      ...
      : t("usage.sessionsCount", { count: String(selectedSessions.length) });
    ...
    <section class="card" style="margin-top: 16px;">
      ...
      <div class="usage-summary-grid">
        ...
        <div class="usage-summary-card">
          ...
          <div class="usage-summary-sub">
            ${aggregates.messages.errors} ${t("usage.errors").toLowerCase()} · ${avgDurationLabel}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
          ...
          <div class="usage-summary-sub">
            ${formatTokens(totals.cacheRead)} ${t("usage.cacheRead").toLowerCase()} · ${formatTokens(cacheBase)}
          </div>
        </div>
      </div>
    ...
    <div class="card sessions-card">
      <div class="sessions-card-header">
        ...
        <div class="sessions-card-count">
          ${totalSessions !== sessions.length ? t("usage.shownTotal", { count: String(sessions.length), total: String(totalSessions) }) : t("usage.shown", { count: String(sessions.length) })}
        </div>
      </div>
      <div class="sessions-card-meta">
        ...
        <label class="sessions-sort">
          ...
          >
            ...
            <option value="recent" ?selected=${sessionSort === "recent"}>${t("usage.sortRecent")}</option>
        ...
        selectedCount > 1
          ? html`
              <div style="margin-top: 10px;">
                <div class="sessions-card-count">${t("usage.selected", { count: String(selectedCount) })}</div>
