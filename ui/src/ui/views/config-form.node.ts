...
export function renderNode(params: {
  ...
  return html`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${label}</div>
      <div class="cfg-field__error">${t("configFormView.unsupportedType", { type: String(type) })}</div>
    </div>
  `;
}
  ...
  const placeholder =
    ...
    (isSensitive
      ...
      : schema.default !== undefined
        ? t("configFormView.defaultPlaceholder", { value: String(schema.default) })
        : "");
    ...
    <div class="cfg-array">
      <div class="cfg-array__header">
        ...
        <span class="cfg-array__count">${t(
          arr.length === 1 ? "configFormView.itemCount" : "configFormView.itemCountPlural",
      ...
      ${
        arr.length === 0
          ? html`
              <div class="cfg-array__empty">${t("configFormView.noItemsYet")}</div>
            `
          : html`
    ...
    <div class="cfg-map">
      ...
      ${
        visibleEntries.length === 0
          ? html`
              <div class="cfg-map__empty">${t("configFormView.noCustomEntries")}</div>
            `
          : html`
                    ...
                    anySchema
                      ? html`
                        <textarea
                          ...
                          placeholder=${t("configFormView.jsonValue")}
                          rows="2"
                          .value=${fallback}
                          ?disabled=${disabled}
                          @change=${(e: Event) => {
