...
type ControlUiE2eScenarioContext = Pick<TestContext, "signal"> & {
  onTestFinished: (callback: () => void | Promise<void>, timeout?: number) => void;
  task: Pick<TestContext["task"], "result">;
};
