...
export class PositionRailGutterController implements ReactiveController {
  ...
  sync(): void {
    ...
    // The compact left rail reaches 38px from the client edge; keep another
    // 10px clear of messages, including when a saved width fills the pane.
    viewport.toggleAttribute("data-position-rail-gutter", gutter >= 48);
  }
}
