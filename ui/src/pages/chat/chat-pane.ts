  ...
  override render() {
    ...
    const props: ChatProps = {
      ...
      composerControls: renderChatControls({
        ...
        realtimeTranslation: {
          active: state.realtimeTranslationActive,
          status: state.realtimeTranslationStatus,
          detail: state.realtimeTranslationDetail,
          direction: state.realtimeTranslationDirection,
          inputSource: state.realtimeTranslationInputSource,
          transcripts: state.realtimeTranslationTranscripts,
          onDirectionChange: state.setRealtimeTranslationDirection,
          onInputSourceChange: state.setRealtimeTranslationInputSource,
          onToggle: () => void state.toggleRealtimeTranslation(),
        },
