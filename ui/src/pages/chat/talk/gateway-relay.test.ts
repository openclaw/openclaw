...
function emitConsultAndWait(client: RealtimeTalkTransportContext["client"]) {
  emitTalkEvent({
    relaySessionId: "relay-1",
    type: "toolCall",
    callId: "call-1",
  ...
  return waitForFast(() => expect(requestCallsFor(client, "talk.client.toolCall")).toHaveLength(1));
}
