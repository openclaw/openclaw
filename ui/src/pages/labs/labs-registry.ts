...
export const LAB_FEATURES = [
  ...
  {
    id: "skillSearch",
    title: () => t("labsPage.skillSearch.title"),
    description: () => t("labsPage.skillSearch.description"),
    docsUrl: "https://docs.openclaw.ai/tools/skills#skill-search",
    configPath: ["skills", "experimental", "search"],
    onValue: true,
    offValue: false,
    activeValues: [true],
    readEnabled: null,
