...
### ✍️ SNS 콘텐츠 초안 (매주 월요일 07:15 KST)

- 이번 주 MAI Universe 진행 기록에서 포스팅 소재 3가지 추출:
  1. **Build Log** — 지난 주 GitHub 커밋/릴리스 중 가장 임팩트 있는 것
  2. **Learnings** — 개발/운영 중 배운 인사이트 한 가지
  3. **Numbers** — 수치로 보여줄 수 있는 것 (다운로드, 스타, 이슈 등)
- 각 소재에 대해 X(트위터) 포스트 초안 1개 (280자 이내) 작성
- Discord DM으로 전달: "이번 주 SNS 초안 3개입니다 — 검토 후 발행해 주세요"
- **지니님이 할 것:** 검토 5분 → 마음에 드는 것 그대로 발행
