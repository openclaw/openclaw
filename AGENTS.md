...
- Contributor PRs: parsed context requires authored `What Problem This Solves` and `Evidence` sections; reviewers inspect code, tests, and CI for correctness.
