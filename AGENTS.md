...
- Config contract boundary:
  ...
  - For channel/group boolean toggles, `enabled` is the canonical public key. Reserve `allow` for allowlists, policy/routing semantics, or compatibility-only migration inputs.
