...
- When adding a new `AGENTS.md` anywhere in the repo, also add a `CLAUDE.md` as a real copy (not a symlink). Root-level CI enforces sync; subdirectories must be kept in sync manually.
