...
- Fresh issue/PR routing: read `CONTRIBUTING.md`, `.github/ISSUE_TEMPLATE/config.yml`, the relevant `.github/ISSUE_TEMPLATE/*.yml`, `.github/pull_request_template.md`, and `.github/CODEOWNERS` before creating a GitHub item. Blank issues are disabled; do not invent ad hoc issue shapes.
