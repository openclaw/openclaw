...
declare const ProtocolSchemas: {
  ...
  AgentParams: _$typebox.TObject<{
    ...
    continuationTrigger: _$typebox.TOptional<_$typebox.TString>;
    ...
    idempotencyKey: _$typebox.TString;
    label: _$typebox.TOptional<_$typebox.TString>;
    drainsContinuationDelegateQueue: _$typebox.TOptional<_$typebox.TBoolean>;
  }>;
  ...
  ChatEvent: _$typebox.TObject<{
    runId: _$typebox.TString;
    sessionKey: _$typebox.TString;
    spawnedBy: _$typebox.TOptional<_$typebox.TString>;
    seq: _$typebox.TInteger;
    state: _$typebox.TUnion<[_$typebox.TLiteral<"delta">, _$typebox.TLiteral<"final">, _$typebox.TLiteral<"aborted">, _$typebox.TLiteral<"error">]>;
...
//#endregion
export { CronUpdateParams as $, WebLoginStartParams as $n, SkillsBinsParams as $t, ChannelsStatusParams as A, TalkSessionOkResult as An, NodePairRequestParams as At, ConfigPatchParams as B, TasksGetResult as Bn, RequestFrame as Bt, ArtifactsDownloadResult as C, TalkSessionCancelOutputParams as Cn, NodeInvokeParams as Ct, ArtifactsListResult as D, TalkSessionCreateResult as Dn, NodePairListParams as Dt, ArtifactsListParams as E, TalkSessionCreateParams as En, NodePairApproveParams as Et, CommandEntry as F, TalkSpeakResult as Fn, NodePendingEnqueueResult as Ft, CronAddParams as G, ToolsCatalogResult as Gn, SessionsDescribeParams as Gt, ConfigSchemaResponse as H, TasksListResult as Hn, SessionsCleanupParams as Ht, CommandsListParams as I, TaskSummary as In, NodePresenceAlivePayload as It, CronRemoveParams as J, ToolsInvokeParams as Jn, SessionsPreviewParams as Jt, CronJob as K, ToolsEffectiveParams as Kn, SessionsListParams as Kt, CommandsListResult as L, TasksCancelParams as Ln, NodePresenceAliveReason as Lt, ChannelsStopParams as M, TalkSessionTurnParams as Mn, NodePendingDrainParams as Mt, ChatEvent as N, TalkSessionTurnResult as Nn, NodePendingDrainResult as Nt, ChannelsLogoutParams as O, TalkSessionJoinParams as On, NodePairRejectParams as Ot, ChatInjectParams as P, TalkSpeakParams as Pn, NodePendingEnqueueParams as Pt, CronStatusParams as Q, WakeParams as Qn, ShutdownEvent as Qt, ConfigApplyParams as R, TasksCancelResult as Rn, PollParams as Rt, ArtifactsDownloadParams as S, TalkSessionAppendAudioParams as Sn, NodeEventResult as St, ArtifactsGetResult as T, TalkSessionCloseParams as Tn, NodeListParams as Tt, ConfigSetParams as U, TickEvent as Un, SessionsCompactParams as Ut, ConfigSchemaParams as V, TasksListParams as Vn, ResponseFrame as Vt, ConnectParams as W, ToolsCatalogParams as Wn, SessionsDeleteParams as Wt, CronRunParams as X, UpdateRunParams as Xn, SessionsResolveParams as Xt, CronRunLogEntry as Y, ToolsInvokeResult as Yn, SessionsResetParams as Yt, CronRunsParams as Z, UpdateStatusParams as Zn, SessionsUsageParams as Zt, AgentsListParams as _, TalkClientToolCallParams as _n, GatewayFrame as _t, AgentWaitParams as a, SkillsSearchResult as an, WizardStartResult as ar, EnvironmentsListParams as at, AgentsUpdateResult as b, TalkConfigResult as bn, LogsTailResult as bt, AgentsDeleteParams as c, SkillsUploadBeginParams as cn, WizardStep as cr, EnvironmentsStatusResult as ct, AgentsFilesGetParams as d, Snapshot as dn, PROTOCOL_VERSION as dr, ExecApprovalGetParams as dt, SkillsBinsResult as en, WebLoginWaitParams as er, DevicePairApproveParams as et, AgentsFilesGetResult as f, StateVersion as fn, ExecApprovalRequestParams as ft, AgentsFilesSetResult as g, TalkClientCreateResult as gn, ExecApprovalsSnapshot as gt, AgentsFilesSetParams as h, TalkClientCreateParams as hn, ExecApprovalsSetParams as ht, AgentSummary as i, SkillsSearchParams as in, WizardStartParams as ir, EnvironmentSummary as it, ChannelsStatusResult as j, TalkSessionSubmitToolResultParams as jn, NodePairVerifyParams as jt, ChannelsStartParams as k, TalkSessionJoinResult as kn, NodePairRemoveParams as kt, AgentsDeleteResult as l, SkillsUploadChunkParams as ln, ProtocolSchemas as lr, ErrorShape as lt, AgentsFilesListResult as m, TalkCatalogResult as mn, ExecApprovalsGetParams as mt, AgentIdentityParams as n, SkillsDetailResult as nn, WizardNextParams as nr, DevicePairRejectParams as nt, AgentsCreateParams as o, SkillsStatusParams as on, WizardStatusParams as or, EnvironmentsListResult as ot, AgentsFilesListParams as p, TalkCatalogParams as pn, ExecApprovalResolveParams as pt, CronListParams as q, ToolsEffectiveResult as qn, SessionsPatchParams as qt, AgentIdentityResult as r, SkillsInstallParams as rn, WizardNextResult as rr, EnvironmentStatus as rt, AgentsCreateResult as s, SkillsUpdateParams as sn, WizardStatusResult as sr, EnvironmentsStatusParams as st, AgentEvent as t, SkillsDetailParams as tn, WizardCancelParams as tr, DevicePairListParams as tt, AgentsFileEntry as u, SkillsUploadCommitParams as un, MIN_PROBE_PROTOCOL_VERSION as ur, EventFrame as ut, AgentsListResult as v, TalkClientToolCallResult as vn, HelloOk as vt, ArtifactsGetParams as w, TalkSessionCancelTurnParams as wn, NodeInvokeResultParams as wt, ArtifactSummary as x, TalkModeParams as xn, NodeEventParams as xt, AgentsUpdateParams as y, TalkConfigParams as yn, LogsTailParams as yt, ConfigGetParams as z, TasksGetParams as zn, PresenceEntry as zt };