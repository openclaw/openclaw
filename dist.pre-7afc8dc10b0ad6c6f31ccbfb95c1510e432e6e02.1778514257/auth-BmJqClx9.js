...
import { s as loadAuthProfileStoreForRuntime } from "./store-B6VhslyM.js";
import { n as resolvePluginProviders } from "./providers.runtime-Ca605XV3.js";
import "./model-selection-shared-DEFYGBdW.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-BZlI7O8p.js";
import { n as clearAuthProfileCooldown } from "./usage-Cmwzf1CP.js";
import "./workspace-DNXfPZMj.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-CTn3fPef.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-Bsv_7FxN.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DEZsIzgA.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-C9tGlv1A.js");
				await openUrl(url);
			},
