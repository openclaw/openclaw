...
import { L as requireOpenAllowFrom } from "./zod-schema.core-ZZiuAHri.js";
...
import { f as requireChannelOpenAllowFrom } from "./extension-shared-GNA0Bbrh.js";
import { t as zod_exports } from "./zod-BILJI2PX.js";
import { n as createEventCard, t as createAgendaCard } from "./schedule-cards-BBq4VA2j.js";
...
const LineAccountConfigSchema = LineCommonConfigSchemaBase.extend({ groups: zod_exports.z.record(zod_exports.z.string(), LineGroupConfigSchema.optional()).optional() }).strict().superRefine((value, ctx) => {
