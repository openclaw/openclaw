...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-BPONrntu.js";
import "./config-D26edBd1.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-bk5mmOd_.js"), import("./logging-DggFqhra.js")]).then(([sdkModule, loggingModule]) => ({
