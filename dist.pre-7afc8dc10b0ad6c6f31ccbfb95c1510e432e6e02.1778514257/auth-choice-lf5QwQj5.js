...
import "./auth-profiles--UEGvx9j.js";
...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-DjjGW9M-.js";
import { r as loadModelCatalog } from "./model-catalog-DUX-2da-.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-rxI6Xy50.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-DuaXPAa_.js";
import "./provider-auth-choice-preference-stAsU0a1.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-CuDQjrXE.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-CXHa9q7u.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-CvdUyM_B.js");
