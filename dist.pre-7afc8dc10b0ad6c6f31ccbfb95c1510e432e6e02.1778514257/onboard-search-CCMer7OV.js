...
import { t as enablePluginInConfig } from "./enable-Cp0Tjrkn.js";
import { t as resolveWebSearchInstallCatalogEntries } from "./web-search-install-catalog-DW10mwes.js";
import { n as sortWebSearchProviders } from "./web-search-providers.shared-C6db4Ma_.js";
import { t as resolvePluginWebSearchProviders } from "./web-search-providers.runtime.js";
import { t as sortFlowContributionsByLabel } from "./types-B-tLOt2A.js";
...
async function finalizeSearchProviderSetup(params) {
	...
	if (installEntry && next.tools?.web?.search?.enabled !== false) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install--2xswK0a.js");
