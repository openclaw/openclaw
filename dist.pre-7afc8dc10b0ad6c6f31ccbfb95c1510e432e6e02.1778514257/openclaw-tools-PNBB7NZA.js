...
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-BnhYEQue.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-SZbUWF4m.js";
...
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-3HpD8RSS.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-D48EGD_k.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-Wt_psC5v.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-D-QDM7gD.js";
...
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CrLprOU4.js";
import { f as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-Dl9FHzUQ.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-DvmWjXsU.js";
...
import { a as extractDeliveryInfo } from "./sessions-DgIxQTHN.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-D8nuaUJM.js";
import { C as modelKey, b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, w as normalizeModelRef } from "./model-selection-shared-DEFYGBdW.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent } from "./model-selection-DmMcdmk8.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DWiNA0aw.js";
import "./auth-profiles--UEGvx9j.js";
import { t as resolveApiKeyForProfile } from "./oauth-PGmcJQd1.js";
...
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-Bm28t9uc.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES, s as normalizeSubagentTaskName } from "./subagent-spawn-y22ie1jv.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-k1At_GQo.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-Hmfko1cF.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-d6OU1q1F.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DOGm5yak.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BGdCnpZI.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-BsPY0uFn.js";
...
import { r as stripToolMessages } from "./chat-history-text-CUH3vZi5.js";
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-BJmSjY-N.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DX16zuOP.js";
import { t as deriveSessionChatTypeFromKey } from "./session-chat-type-shared-BJtJEDAS.js";
import "./targeting-Bhwc27MJ.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BalSZQnG.js";
import { i as resolveMaxDelegatesPerTurn } from "./config-sNvP4K9b.js";
import { a as getImageMetadata } from "./image-ops-CXDu1pv2.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BPyp67rY.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DuIvuBVG.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-BTyyZGvQ.js";
import { a as resolvePluginTools } from "./tools-CZ_e0oA2.js";
import { n as assertSandboxPath } from "./sandbox-paths-DU2lZdgZ.js";
import "./local-file-access-o0Qf0g_M.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-4qRSQ8vS.js";
import { f as listAllChannelSupportedActions, l as wrapToolWithBeforeToolCallHook, m as listChannelSupportedActions, s as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-DkJi3XgM.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-8s3rjlx8.js";
import { n as extractAssistantText } from "./pi-embedded-utils-CywGElTE.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-CMeHjfaG.js";
import { n as runWithImageModelFallback } from "./model-fallback-G_M26YoR.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-IT-8V0Nw.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-NU_RG5vx.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-Z2io4lb1.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-cg1EE3bc.js";
...
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-JZHhfjmO.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-De1nXOGV.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-BmG8vSE0.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-Bghph8cJ.js";
import { t as inferLegacyName } from "./normalize-HfgjBKad.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-Oyx5nDfb.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-CCCUfzYu.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DCy5LMFC.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-T2vVFjrM.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-D8ywBFap.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BK-lx3nK.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-Z9daalth.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-CUa0Ap2o.js";
import { u as saveMediaBuffer } from "./store-B4S0xbAA.js";
import { t as SsrFBlockedError } from "./ssrf-z-OH9PRk.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-26DXxszJ.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-CZuc415a.js";
import { r as getDefaultLocalRoots } from "./local-media-access-D0aFEXYO.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BDpsgP8o.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-CGlMaOdM.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-9pYcv8Sa.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths--9U0V9V7.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-CmInKSto.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CG7yDL9u.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-hfNfTFQH.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-CLVgZF5j.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-CK_e5ttq.js";
import { s as resolveTimeoutMs } from "./resolve-Ck6KRI6u.js";
import { t as buildProviderRegistry } from "./runner-_eISu6uL.js";
import "./media-understanding-Gi6MO_Yi.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BCapHRo2.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-7uN_lWKe.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-ClFg2-Gq.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-NYPXuOZW.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-CZ3TkeNA.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-2KVOW5xH.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BVOEUKMc.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DpXL5jNP.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-BomA_WWw.js";
...
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-BRIpJEI5.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-JHDZRIAs.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-DFkQUWih.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CbhO_9Oz.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-pQAHGtOR.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-CG6aHB4E.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-R7TgiH0y.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-CTvrQTiX.js";
import { p as registerSubagentRun } from "./subagent-registry-4fTqi9kr.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-D_O3E-Dn.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-YFLtu9ya.js";
import { k as textToSpeech } from "./tts-runtime-CQ9eokvr.js";
import "./tts-D8ZFfjFE.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-BDUv2ToL.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-gI5MhHzk.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-Cvha2uLW.js";
...
import { i as runWebSearch } from "./runtime-oFALgzSl.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-Bdgh4Ru4.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CixzSgM7.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-BjheOUZ3.js"));
