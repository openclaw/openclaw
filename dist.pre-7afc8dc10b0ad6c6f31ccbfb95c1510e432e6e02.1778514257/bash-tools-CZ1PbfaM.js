...
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-CVBQ_Yvd.js";
import { b as escapeRegExp } from "./utils-927g1oFZ.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-DDEl6txh.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-CuQ3FxQd.js";
import { a as logWarn, r as logInfo } from "./logger-C9OJkRW0.js";
import { J as resolveShellEnvFallbackTimeoutMs, K as getShellPathFromLoginShell } from "./io-SZbUWF4m.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-jmMsEY6g.js";
import { E as splitShellArgs } from "./shell-wrapper-resolution-B-rHDxqk.js";
import { t as killProcessTree } from "./kill-tree-Ddzo82f3.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-BSLj6Jk9.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-mN0Xhtlq.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-CrLprOU4.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-oIOH9qX-.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-DOGm5yak.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-BDjd1p69.js";
import { t as formatDurationCompact } from "./format-duration-Be5mH_xz.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-Cse2Yu8o.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-CMbsqJz9.js";
import { o as failedTextResult, y as textResult } from "./common-NU_RG5vx.js";
import { t as callGatewayTool } from "./gateway-Z2io4lb1.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-Dgk8kA3w.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-CsjkGu5e.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-PTRXeG_G.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, _ as normalizeExecSecurity, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-BFIm3jBm.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BLLjBLLt.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-DLQQgcE0.js";
import "./delivery-context-DJ0NiTTU.js";
import { t as sendMessage } from "./message-C4oflnUo.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-DkOhNVlV.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-JHDZRIAs.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-Cg3FTnAF.js";
import { t as getProcessSupervisor } from "./supervisor-BeIJziGm.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-jN3ONPLV.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-Wca-1g1v.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-BfBueLYo.js";
import { n as detectPolicyInlineEval } from "./policy-n_bwPSb_.js";
import { r as registerExecApprovalFollowupElevatedDefaults, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-Gqr3R4m1.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-Bx0-dOu9.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-B2vwKPG0.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-Bl7bvrXd.js";
...
async function buildHostApprovalDecisionParams(params) {
	const commandSpans = params.commandSpans ?? await resolveCommandSpans(params.command ?? params.systemRunPlan?.commandText);
	return {
...
async function sendExecApprovalFollowupResult(target, resultText, deps = {}) {
	...
	const execApprovalFollowupToken = target.direct === true || !target.sessionKey ? void 0 : registerExecApprovalFollowupElevatedDefaults({
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-CjqnPaKm.js"));
...
async function validateScriptFileForShellBleed(params) {
	...
	for (const relOrAbsPath of target.relOrAbsPaths) {
		...
		let content;
		try {
			content = (await workspaceRoot.read(relativePath, {
