import { i as isPathInside, l as resolveSafeBaseDir, p as FsSafeError, r as isNotFoundPathError } from "./path-n_dSWDuU.js";
import { t as normalizeLowercaseStringOrEmpty } from "./string-coerce-b8me7dqA.js";
import { c as assertAsyncDirectoryGuard, u as createAsyncDirectoryGuard } from "./write-queue-DJHVmpyu.js";
import { d as withTimeout, l as writeSiblingTempFile } from "./fs-safe-Cew-WMeL.js";
import { a as resolveOpenedFileRealPathForHandle, o as root, s as getFsSafeTestHooks, t as resolveSecureTempRoot } from "./secure-temp-dir-JZ25IoOE.js";
...
async function removeExtractedDestinationFile(params) {
	...
	await fs$1.rm(destinationPath, { force: true }).catch(() => void 0);
}
async function withStagedArchiveDestination(params) {
	...
	const stagingDir = await fs$1.mkdtemp(path.join(stagingRoot, params.stagingDirPrefix ?? "fs-safe-archive-"));
	try {
...
async function writeZipFileEntry(params) {
	...
	try {
		...
		if (typeof params.entry.unixPermissions === "number") {
			...
			if (mode !== 0) await fs$1.chmod(destinationPath, mode).catch(() => void 0);
		}
	} catch (err) {
		throw err;
	} finally {
