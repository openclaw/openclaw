...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-CGAriml-.js";
...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-BzDKRwLD.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DjHUFtfw.js";
import { o as resetModelCatalogCache } from "./model-catalog-DUX-2da-.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-JZHhfjmO.js";
import { r as resetDirectoryCache } from "./target-resolver-BMre7oXv.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-BCn5aNmk.js";
...
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-Dyh-sg5O.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Dt1RvPGb.js";
...
import { t as buildGatewayCronService } from "./server-cron-5_0TA5r1.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-LUWeFM2p.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-Bz-QrZGm.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BRSEaaOd.js"), import("./gmail-watcher-lifecycle-J2Epfos9.js")]);
