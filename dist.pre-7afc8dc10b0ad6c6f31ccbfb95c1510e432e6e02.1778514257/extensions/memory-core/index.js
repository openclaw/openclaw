...
import "../../memory-core-host-runtime-core-D0S6EfwN.js";
import "../../memory-core-host-runtime-files-CiQJwqaB.js";
import { t as registerShortTermPromotionDreaming } from "../../dreaming-DF1TQ1Ks.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-DZQq11IO.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-B4544roT.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-YXZGV6-x.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-YNoYSQvH.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-DgZFY-gE.js");
				return await handleDreamingCommand(api, ctx);
			}
		});
		api.registerCli(async ({ program }) => {
			const { registerMemoryCli } = await import("../../cli-BYy3C9Z7.js");
