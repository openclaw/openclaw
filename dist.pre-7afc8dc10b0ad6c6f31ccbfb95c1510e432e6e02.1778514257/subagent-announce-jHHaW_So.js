...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-YL9ro8w8.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-DboN0s7s.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-CT5pV31z.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DX16zuOP.js";
import { i as consumePendingDelegates } from "./delegate-store-BalSZQnG.js";
import "./continuation-delegate-store-CsBuxYDi.js";
import { n as resolveContinuationRuntimeConfig } from "./config-sNvP4K9b.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-CMeHjfaG.js";
import "./delivery-context-DJ0NiTTU.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DpXL5jNP.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-CTvrQTiX.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-CMdIjMu1.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-CjvW6-GE.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-gRbwX3mn.js"), import("./store-load-CY_q5RmT.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-_u-On3Yw.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-hYt5JNKB.js");
			const { createSubsystemLogger } = await import("./subsystem-BP5vgtkc.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-DVnlhgYN.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
