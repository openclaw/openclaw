...
import { n as sleepWithAbort } from "./backoff-Dm_Q9Y7p.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-BH3bWazi.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-l4StXZ7L.js";
import "./runtime-env-B1r2kK7q.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-BPABToOl.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DJUA4wt9.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-DUEfpOKW.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-Buz4sCJH.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-UxXmZWci.js";
import "./channel-api-BbUW34El.js";
import { t as parseDiscordTarget } from "./target-parsing-DtkYSwxy.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CNmQsh4h.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-_DVoX0ob.js";
import { t as getDiscordRuntime } from "./runtime-DmdkhIjS.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-C8NcGHKP.js";
import { t as getDiscordApprovalCapability } from "./approval-native-CZImlfG5.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-lzs_c-vw.js";
import { t as discordMessageActions$1 } from "./channel-actions-D5A9hTc5.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-Cv_joTSF.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BVhLkPwR.js";
import { n as discordOutbound } from "./outbound-adapter-DJpf8He4.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-DDjOu6VS.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-Cw877CfB.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CVHczEjr.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CzCCW5bw.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Ctfe92DI.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BUzOxIeh.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-bMFEvu0w.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-DHrSCMMT.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CwQE5SVI.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-D8QUPYg7.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-CF_1CKJV.js");
