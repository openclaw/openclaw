...
import { t as installPluginFromGitSpec } from "./git-install-DqM1tqjc.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-CBtGZ6ex.js";
import { i as isPrereleaseResolutionAllowed, o as parseRegistryNpmSpec, t as compareOpenClawReleaseVersions } from "./npm-registry-spec-COugVM2e.js";
import { o as resolvePluginInstallDir } from "./install-paths-BVekoB1Q.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-CRUVAZgB.js";
import { c as resolveOfficialExternalPluginInstall, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-CGHN3nXa.js";
import { a as resolveNpmSpecMetadata } from "./install-source-utils-BMckGYWy.js";
import { n as recordPluginInstall, t as buildNpmResolutionInstallFields } from "./installs-DwUWosKS.js";
import { i as parseComparableSemver, t as compareComparableSemver } from "./semver-compare-BMf8TmJ_.js";
import { t as linkOpenClawPeerDependencies } from "./plugin-peer-link-IXyzsbF2.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-Bu3AnZFg.js";
import { a as installPluginFromNpmSpec, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-nJv9LniU.js";
import { i as readInstalledPackageVersion, n as installedPackageNeedsOpenClawPeerLinkRepair, r as readInstalledPackagePeerDependencies, t as expectedIntegrityForUpdate } from "./package-update-utils-BvhsJfY8.js";
...
import { t as installPluginFromMarketplace } from "./marketplace-B9stqEEE.js";
...
async function updateNpmInstalledPlugins(params) {
	...
	for (const pluginId of targets) {
		...
		if (params.dryRun) {
			...
			const resolvedProbeVersion = probe.version ?? (record.source === "npm" ? resolveExactNpmSpecVersion(probeSpec) : void 0);
