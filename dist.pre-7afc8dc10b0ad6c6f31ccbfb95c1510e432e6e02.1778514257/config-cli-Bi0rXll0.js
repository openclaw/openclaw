...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CkWV_h16.js";
...
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-SZbUWF4m.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-B9B2kclm.js";
import { n as redactConfigObject } from "./redact-snapshot-DKWguexK.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-MWP8Zsm4.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Dt1RvPGb.js";
import { n as setCommandJsonMode } from "./json-mode-DK28AF4a.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BZ1od-oO.js");
