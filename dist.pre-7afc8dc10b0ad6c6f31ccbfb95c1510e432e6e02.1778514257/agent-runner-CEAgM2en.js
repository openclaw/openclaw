...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-BnhYEQue.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-lNqw1IL2.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-CJzPANyF.js";
import "./config-Cj3XPIio.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-BSLj6Jk9.js";
import { o as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-Tk9OL05P.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-BTA6lwQW.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-D-QDM7gD.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-BnX-evip.js";
...
import { C as resolveGroupSessionKey, c as updateSessionStoreEntry, m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-DjyTbZFp.js";
...
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-DjHUFtfw.js";
import { l as queueEmbeddedPiMessage } from "./runs-YL9ro8w8.js";
...
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-Bnb1rmDj.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-CGE_H8UJ.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-k1At_GQo.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-BGh2C-DM.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-BIKuYUmD.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BDjd1p69.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-DJajTsZu.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DX16zuOP.js";
import { u as stripHeartbeatToken } from "./heartbeat-Dz5PwkSM.js";
import { r as enqueueCommitmentExtraction } from "./runtime-Da7EXeZS.js";
import { c as emitContinuationWorkSpan, i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-Bt2hUk8e.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-B1b_fiGT.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-BpYYgsJ4.js";
import { a as enqueueSystemEvent } from "./system-events-Dh6VKU_z.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-IEYqUrEE.js";
import { n as resolveSendPolicy } from "./send-policy-JpZnIVGc.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-BalSZQnG.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-CsBuxYDi.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-sNvP4K9b.js";
import { t as checkContextPressure } from "./context-pressure-DOMTpZzo.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-BcqNN7dO.js";
import { a as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-Cb7uVOR5.js";
import "./pi-embedded-helpers-CtFVlC7o.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-VvvEbhDM.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-CL6SJsVK.js";
import { t as formatProviderModelRef } from "./model-runtime-op1zDonm.js";
import "./fallback-notice-state-CWcrYevG.js";
import { i as setReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-BQ5OLY8T.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-B5t8JnF3.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-VK2LN6fh.js";
import { t as runCliAgent } from "./cli-runner-Cl1CKJtr.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-DN3vnL4V.js";
import { u as isLikelyExecutionAckPrompt } from "./selection-CuzigoXs.js";
import { o as isAudioFileName } from "./mime-DuIvuBVG.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-Bh5TOWxL.js";
import { h as parseReplyDirectives } from "./deliver-16CUbVI5.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-G_M26YoR.js";
import { i as estimateMessagesTokens } from "./compaction-CVZ7pS3t.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-vcTNMTU3.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-5cxTIhvx.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CfVVVWF4.js";
import { n as hasCotFramePrefix } from "./normalize-reply-BxKjNWDN.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BZZiuYl3.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-DMFYJ5kU.js";
import "./sandbox-DMvzpYRa.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-Dt8lkMMC.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CSUBwpEK.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BCuUPCJV.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-IcLKETse.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-HmBrF7dC.js";
import { n as incrementCompactionCount } from "./session-updates-BWyrbnP5.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-CJbnoUgq.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-KrBNWJMG.js";
import { n as dispatchPostCompactionDelegates, o as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-CsBPJhQM.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Dde5In3_.js";
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-JxiLEh5U.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-Dk5za4L9.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-uwZij6Lh.js"),
					import("./config-DuApcESD.js"),
					import("./state-CMdIjMu1.js"),
					import("./store-By4gWLXw.js")
				]);
