...
import { t as getActiveMatrixClient } from "./active-client-BHKczesh.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-ChK8LBXA.js"), import("./shared-DGuaFZJV.js")]).then(([clientModule, sharedModule]) => ({
