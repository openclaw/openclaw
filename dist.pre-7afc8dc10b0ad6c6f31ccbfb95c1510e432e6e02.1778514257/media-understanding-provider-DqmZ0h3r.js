import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-D1M78QTl.js";
import { s as resolveCodexAppServerRuntimeOptions } from "./config-1bhWEH2b.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-IYiuu8AC.js";
import { r as readModelListResult } from "./models-DScWg7Ng.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-DpRrYflx.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
