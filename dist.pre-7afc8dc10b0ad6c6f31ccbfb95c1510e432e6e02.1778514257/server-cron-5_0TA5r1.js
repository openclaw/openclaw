...
import { s as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-DjyTbZFp.js";
import "./sessions-DgIxQTHN.js";
import "./logging-VNrsN9qb.js";
import { t as abortAndDrainEmbeddedPiRun } from "./runs-YL9ro8w8.js";
import "./session-utils.fs-k1At_GQo.js";
import { i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-GM5WReWA.js";
import { a as isRetryableHeartbeatBusySkipReason, o as requestHeartbeat } from "./heartbeat-wake-B1b_fiGT.js";
...
import { o as resolveFailoverReasonFromError } from "./failover-error-D8XVsnCj.js";
import { l as normalizeCronJobInput } from "./openclaw-tools-PNBB7NZA.js";
import { n as normalizeOptionalAgentId } from "./normalize-HfgjBKad.js";
import { a as resolveCronNotificationSessionKey, i as resolveCronDeliverySessionKey, o as resolveCronSessionTargetSessionKey, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-Oyx5nDfb.js";
...
import { a as failTaskRunByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BVOEUKMc.js";
import { a as cronSchedulingInputsEqual, i as saveCronStore, r as resolveCronStorePath, t as loadCronStore } from "./store-CJbnoUgq.js";
import "./pi-embedded-KrBNWJMG.js";
import { i as markCronJobActive, t as clearCronJobActive } from "./active-jobs-CX77HXTt.js";
import { a as summarizeCronRunDiagnostics, i as normalizeCronRunDiagnostics, n as createCronRunDiagnosticsFromError } from "./run-diagnostics-DXSyadZS.js";
import { a as resolveCronRunLogPath, o as resolveCronRunLogPruneOptions, t as appendCronRunLog } from "./run-log-CPcNj7Tk.js";
...
const CRON_AGENT_PRE_MODEL_WATCHDOG_MS = 6e4;
const CRON_AGENT_PRE_MODEL_MIN_WATCHDOG_MS = 1e3;
/**
...
async function executeJobCoreWithTimeout(state, job) {
	...
	const clearPreModelTimeout = () => {
		if (!preModelTimeoutId) return;
		clearTimeout(preModelTimeoutId);
		preModelTimeoutId = void 0;
	};
...
function preModelTimeoutErrorMessage(execution) {
	const phase = formatCronAgentExecutionPhase(execution);
	if (!phase) return "cron: isolated agent run stalled before first model call";
...
function resolveCronAgentPreModelWatchdogMs(jobTimeoutMs) {
	return Math.max(CRON_AGENT_PRE_MODEL_MIN_WATCHDOG_MS, Math.min(CRON_AGENT_PRE_MODEL_WATCHDOG_MS, Math.floor(jobTimeoutMs / 2)));
}
