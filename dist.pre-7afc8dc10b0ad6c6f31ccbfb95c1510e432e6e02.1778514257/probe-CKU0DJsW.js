...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-BK8vID20.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-DPzneP4N.js";
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-DjX0wpWA.js";
import { i as READ_SCOPE } from "./operator-scopes-mN0Xhtlq.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-BKfLArI7.js");
