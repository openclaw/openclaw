...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-bmagiEt7.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-BnX-evip.js";
...
import { D as findModelInCatalog, r as buildConfiguredModelCatalog } from "./model-selection-shared-DEFYGBdW.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent } from "./model-selection-DmMcdmk8.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BUD1z2SY.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-DUX-2da-.js";
import { f as findCodeRegions, p as isInsideCode, u as stripReasoningTagsFromText } from "./assistant-visible-text-BGh2C-DM.js";
...
import { n as createPreviewMessageReceipt } from "./live-D586eA-B.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-B4oQiCpN.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-B3f0n0oj.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-CoRTCP1S.js";
...
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-B-mxhZsk.js";
...
import { n as buildCommandsMessagePaginated } from "./command-status-builders-C8PsjFJB.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-D_-zigar.js";
import "./command-auth-native-B4ZgewJO.js";
import "./command-primitives-runtime-ByEElhib.js";
import "./command-status-DO2gg7jI.js";
import "./command-detection-Cdvf5Jm7.js";
import "./command-surface-DtOGjwEf.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-QA1KuB3V.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-CLn-5I0_.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-ybWqytWq.js";
...
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-D1GTGHXG.js";
import { A as resolveTelegramReplyId, B as hasBotMention, C as isTelegramCommandsAllowFromConfigured, D as resolveTelegramForumFlag, E as resolveTelegramDirectPeerId, F as buildSenderLabel, G as expandTelegramAllowFromWithAccessGroups, H as normalizeForwardedContext, I as buildSenderName, J as normalizeAllowFrom, K as resolveTelegramDmAllow, L as expandTextLinks, M as resolveTelegramThreadSpec, N as shouldUseTelegramDmThreadSession, O as resolveTelegramForumThreadId, P as withResolvedTelegramForumFlag, R as extractTelegramLocation, S as extractTelegramForumFlag, T as resolveTelegramCommandAuthorization, W as resolveTelegramPrimaryMedia, X as resolveTelegramEffectiveDmPolicy, Y as normalizeDmAllowFromWithStore, _ as buildTelegramParentPeer, b as buildTypingThreadParams, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as resolveTelegramStreamMode, k as resolveTelegramGroupAllowFromContext, m as buildGroupLabel, p as tagTelegramNetworkError, q as isSenderAllowed, t as markdownToTelegramChunks, v as buildTelegramRoutingTarget, x as describeReplyTarget, y as buildTelegramThreadParams, z as getTelegramTextParts } from "./format-CvXYuVdf.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-C0LXD3Hm.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DHjwvlyA.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-3Es0YNMh.js";
import { n as resolveTelegramRequestTimeoutMs } from "./request-timeouts-CPmkltVA.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-JFmilK90.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-BSKBWzOb.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DceyHDr7.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-BhJucbAU.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-Bmkv2Ale.js";
import { C as withTelegramApiErrorLogging, D as sequentialize, E as apiThrottler, T as Bot, a as editMessageTelegram, g as recordSentMessage, w as getOrCreateAccountThrottler, x as buildInlineKeyboard } from "./send-cIuAYNlY.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-7obAYrZP.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-CNJPLmbG.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-C8CmLQuP.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-CoOVqHRN.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-CY-rlFCb.js")).defaultTelegramBotDeps;
								...
								dispatcherOptions: {
									...
									deliver: async (payload, info) => {
										...
										for (const segment of segments) {
											...
											const result = streamMode === "progress" && segment.lane === "answer" && info.kind === "final" ? await deliverProgressModeFinalAnswer(effectivePayload, segment.update.text) : await deliverLaneText({
