...
declare const validateConnectParams: AjvPkg.ValidateFunction<{
  ...
  client: {
    ...
    mode: "probe" | "cli" | "ui" | "webchat" | "test" | "backend" | "node";
    id: "cli" | "webchat-ui" | "openclaw-control-ui" | "openclaw-tui" | "webchat" | "gateway-client" | "openclaw-macos" | "openclaw-ios" | "openclaw-android" | "node-host" | "test" | "fingerprint" | "openclaw-probe";
    version: string;
    platform: string;
  };
}>;
...
declare const validateModelsListParams: AjvPkg.ValidateFunction<{
  view?: "configured" | "default" | "all" | undefined;
}>;
