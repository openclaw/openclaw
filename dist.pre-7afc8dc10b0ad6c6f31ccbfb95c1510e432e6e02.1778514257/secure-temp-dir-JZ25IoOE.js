import { r as getFsSafePythonConfig, t as canFallbackFromPythonError } from "./fs-safe-defaults-PMwkNo6J.js";
import { i as isPathInside, n as hasNodeErrorCode, o as isSymlinkOpenError, p as FsSafeError, r as isNotFoundPathError, t as assertNoNulPathInput } from "./path-n_dSWDuU.js";
...
import { c as assertAsyncDirectoryGuard, d as createNearestExistingDirectoryGuard, n as registerTempPathForExit, s as withAsyncDirectoryGuards, t as serializePathWrite, u as createAsyncDirectoryGuard } from "./write-queue-DJHVmpyu.js";
import { r as resolveRootPath, t as ROOT_PATH_ALIAS_POLICIES } from "./root-path-BYP3ovph.js";
...
async function resolvePinnedWriteTargetInRoot(root, relativePath, requestedMode) {
	...
	if (relativeResolved.startsWith("..") || path.isAbsolute(relativeResolved)) throw new FsSafeError("outside-workspace", "file is outside workspace root");
...
async function resolvePinnedOperationPathInRoot(root, params) {
	...
	if (relativeResolved === "" || relativeResolved === "." || relativeResolved.startsWith("..") || path.isAbsolute(relativeResolved)) throw new FsSafeError("outside-workspace", "file is outside workspace root");
