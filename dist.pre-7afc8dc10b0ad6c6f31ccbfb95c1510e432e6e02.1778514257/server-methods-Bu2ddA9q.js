...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-bmagiEt7.js";
import { p as resolveSessionAgentId } from "./agent-scope-BnhYEQue.js";
import { d as writeJson, i as readJsonIfExists, l as tryReadJson } from "./json-files-DwmWdZ19.js";
...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-SZbUWF4m.js";
import "./archive-BNeBJNaB.js";
...
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-lNqw1IL2.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-C4gXVsBE.js";
...
import { n as isRestartEnabled } from "./commands.flags-B4HzDYlp.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-Bki2Ad5V.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-JBw9nAOk.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-B-HcKjFJ.js";
import { c as isGatewayMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-BSLj6Jk9.js";
import { r as setSafeTimeout } from "./timer-delay-BK8vID20.js";
import { o as gatewayStartupUnavailableDetails } from "./client-DjX0wpWA.js";
import { $ as validateExecApprovalsNodeGetParams, $t as validateSkillsDetailParams, A as validateConfigSchemaParams, B as validateDevicePairApproveParams, Bn as validateWebLoginStartParams, Bt as validateSessionsDeleteParams, Cn as validateTalkSessionJoinParams, D as validateConfigPatchParams, Dn as validateTalkSessionTurnParams, E as validateConfigGetParams, En as validateTalkSessionSubmitToolResultParams, Et as validatePushTestParams, F as validateCronRemoveParams, Fn as validateToolsEffectiveParams, Ft as validateSessionsCompactionBranchParams, G as validateDeviceTokenRotateParams, Gn as validateWebPushVapidPublicKeyParams, Gt as validateSessionsPatchParams, H as validateDevicePairRejectParams, Hn as validateWebPushSubscribeParams, Ht as validateSessionsListParams, I as validateCronRunParams, In as validateToolsInvokeParams, It as validateSessionsCompactionGetParams, Ji as COMMAND_DESCRIPTION_MAX_LENGTH, Jn as validateWizardStartParams, Jt as validateSessionsResetParams, K as validateEnvironmentsListParams, Kn as validateWizardCancelParams, Kt as validateSessionsPluginPatchParams, L as validateCronRunsParams, Ln as validateUpdateRunParams, Lt as validateSessionsCompactionListParams, Mn as validateTasksGetParams, Mt as validateSessionsAbortParams, N as validateCronAddParams, Nn as validateTasksListParams, Nt as validateSessionsCleanupParams, O as validateConfigSchemaLookupParams, Oi as ErrorCodes, P as validateCronListParams, Pn as validateToolsCatalogParams, Pt as validateSessionsCompactParams, Q as validateExecApprovalsGetParams, Qt as validateSkillsBinsParams, R as validateCronStatusParams, Rn as validateUpdateStatusParams, Rt as validateSessionsCompactionRestoreParams, T as validateConfigApplyParams, Tt as validatePollParams, U as validateDevicePairRemoveParams, Un as validateWebPushTestParams, Ut as validateSessionsMessagesSubscribeParams, V as validateDevicePairListParams, Vn as validateWebLoginWaitParams, Vt as validateSessionsDescribeParams, W as validateDeviceTokenRevokeParams, Wn as validateWebPushUnsubscribeParams, Wt as validateSessionsMessagesUnsubscribeParams, Xt as validateSessionsSendParams, Yn as validateWizardStatusParams, Yt as validateSessionsResolveParams, Zt as validateSessionsUsageParams, _ as validateChannelsStatusParams, _n as validateTalkSessionAppendAudioParams, _t as validateNodePendingAckParams, a as validateAgentsCreateParams, an as validateSkillsUploadChunkParams, at as validateNodeDescribeParams, bn as validateTalkSessionCloseParams, c as validateAgentsFilesListParams, ct as validateNodeInvokeParams, d as validateAgentsUpdateParams, dn as validateTalkClientToolCallParams, dt as validateNodePairApproveParams, en as validateSkillsInstallParams, et as validateExecApprovalsNodeSetParams, f as validateArtifactsDownloadParams, ft as validateNodePairListParams, g as validateChannelsStartParams, gn as validateTalkModeParams, gt as validateNodePairVerifyParams, h as validateChannelsLogoutParams, ht as validateNodePairRequestParams, i as validateAgentWaitParams, in as validateSkillsUploadBeginParams, it as validateModelsListParams, j as validateConfigSetParams, jn as validateTasksCancelParams, jt as validateSendParams, k as validateConfigSchemaLookupResult, ki as errorShape, kn as validateTalkSpeakParams, l as validateAgentsFilesSetParams, ln as validateTalkClientCreateParams, lt as validateNodeInvokeResultParams, m as validateArtifactsListParams, mt as validateNodePairRemoveParams, n as validateAgentIdentityParams, nn as validateSkillsStatusParams, nt as validateLogsTailParams, o as validateAgentsDeleteParams, on as validateSkillsUploadCommitParams, ot as validateNodeEventParams, p as validateArtifactsGetParams, pn as validateTalkConfigParams, pt as validateNodePairRejectParams, q as validateEnvironmentsStatusParams, qn as validateWizardNextParams, qt as validateSessionsPreviewParams, r as validateAgentParams, rn as validateSkillsUpdateParams, rt as validateMessageActionParams, s as validateAgentsFilesGetParams, sn as validateTalkCatalogParams, t as formatValidationErrors, tn as validateSkillsSearchParams, tt as validateExecApprovalsSetParams, u as validateAgentsListParams, ut as validateNodeListParams, v as validateChannelsStopParams, vn as validateTalkSessionCancelOutputParams, vt as validateNodePendingDrainParams, w as validateCommandsListParams, wt as validatePluginsUiDescriptorsParams, xn as validateTalkSessionCreateParams, xt as validateNodeRenameParams, yn as validateTalkSessionCancelTurnParams, yt as validateNodePendingEnqueueParams, z as validateCronUpdateParams, zn as validateWakeParams, zt as validateSessionsCreateParams } from "./protocol-BLKEhqRU.js";
import { r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-CxTmAjhY.js";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-DiSdEZeS.js";
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-mN0Xhtlq.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-BwxgjVYa.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-BzDKRwLD.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-Bp6icvuQ.js";
...
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-CH8CSzQH.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-R6BWI-Qz.js";
import { v as patchPluginSessionExtension } from "./loader-Wt_psC5v.js";
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-BgjLdu4s.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-4niICZIF.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-D-QDM7gD.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-CQSXrZy8.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CSc6Nbki.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-BnX-evip.js";
import { h as stringifyRouteThreadId } from "./channel-route-DBwZtt8r.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CrLprOU4.js";
import { t as loadSessionStore } from "./store-load-Dl9FHzUQ.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-DvmWjXsU.js";
...
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-DgIxQTHN.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-DnMiAK3Y.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-WQGmurUf.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-COWXZQe9.js";
import { d as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-DEFYGBdW.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DWiNA0aw.js";
import "./auth-profiles--UEGvx9j.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DKUH7LQI.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DjHUFtfw.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-BKXu6Ih4.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-YL9ro8w8.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-Bm28t9uc.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-B7LhA556.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-Bs2Z3PTe.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-k1At_GQo.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-GM5WReWA.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-DOGm5yak.js";
...
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-B1b_fiGT.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-Dh6VKU_z.js";
import { l as getTotalQueueSize } from "./command-queue-IEYqUrEE.js";
import { n as resolveSendPolicy } from "./send-policy-JpZnIVGc.js";
import { a as isTimeoutError } from "./failover-error-D8XVsnCj.js";
import { c as normalizeCronJobCreate, u as normalizeCronJobPatch } from "./openclaw-tools-PNBB7NZA.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-CZ_e0oA2.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-DKWguexK.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DNXfPZMj.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CstMuPf9.js";
import { i as createOutboundPayloadPlan, u as projectOutboundPayloadPlanForMirror } from "./deliver-16CUbVI5.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-BFIm3jBm.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-JZHhfjmO.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Bghph8cJ.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-Oyx5nDfb.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-CCCUfzYu.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-BdmxFkiT.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-DHPBXmgT.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-NYPXuOZW.js";
import { o as resolveTrustedGroupId } from "./pi-tools.policy-BUvUrUc5.js";
...
import "./target-resolver-BMre7oXv.js";
import { i as resolveReplyToMode } from "./reply-threading-5cxTIhvx.js";
...
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-C_wxoYbi.js";
import { r as resolveOutboundTarget } from "./targets-CqnyLRaA.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-2KVOW5xH.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-DcqH1zCz.js";
import "./runtime-internal-zRVM0Osc.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-BVOEUKMc.js";
import { n as resolveAgentIdentity } from "./identity-CuUMUoav.js";
import { s as clearSessionQueues } from "./queue-DMFYJ5kU.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-DkOhNVlV.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Dq4lLlo9.js";
import { C as setTtsEnabled, E as setTtsProvider, O as synthesizeSpeech, T as setTtsPersona, _ as resolveTtsConfig, f as listTtsPersonas, g as resolveTtsAutoMode, h as resolveExplicitTtsOverrides, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, y as resolveTtsProviderOrder } from "./tts-runtime-CQ9eokvr.js";
...
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DIMHLCRV.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-DNI5DYji.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-wJj8M1wQ.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-DgROG1xj.js";
...
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-CPcNj7Tk.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-5VaBrnN_.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-DUnNPzUO.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-CZu0Lv4z.js";
import "./commands-registry-CoRTCP1S.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-ChduoAyV.js";
import { t as getPluginCommandSpecs } from "./command-specs-CvENjdNc.js";
import { r as listPluginCommands } from "./commands-DZbypD23.js";
import { t as getChannelActivity } from "./channel-activity-DIHw3Wfn.js";
import { t as WizardCancelledError } from "./prompts-cLzdzEn0.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-CXzGBe_M.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-D1O8RDde.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BUnu2mrI.js";
import "./browser-maintenance-riXwYMQM.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-xJIDcrSw.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-CGh9Uw6z.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-BmOYdBGo.js";
import { r as agentCommandFromIngress } from "./agent-command-CQcRxvKA.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-gpLcKhqH.js";
import { n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-DFeHw6gS.js";
import { t as safeParseJson } from "./server-json-4fOMVjmK.js";
import { t as formatForLog } from "./ws-log-qdOXizAX.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CP48t-wS.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-BZxMMIYr.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DeXk_a8H.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-C_TeJh0I.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-BJZBVsLP.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-C8K_JVYk.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-DpMwEPir.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-2nMoeasH.js";
import { n as createOutboundSendDeps } from "./deps-8hw6gtrc.js";
import "./agent-BQ6pAm65.js";
import { n as consumeExecApprovalFollowupElevatedDefaultsFromIdempotencyKey } from "./bash-tools.exec-approval-followup-state-Gqr3R4m1.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-Bx0-dOu9.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-B2vwKPG0.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-CGxEveSS.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BnN1Uzk2.js";
import "./server-constants-YA-jupC1.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-BpTbSSQz.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-DYqNBAJ5.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CKIBPDEh.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-DlccFC69.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-D3zv1Vqu.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-XkVe3p3O.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-C_xPmbuw.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-Bm18NiSG.js";
import { s as performGatewaySessionReset } from "./session-reset-service-C49pkm40.js";
import { t as buildChannelUiCatalog } from "./catalog-DVdggKPf.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-CeQFmGUs.js";
import { s as normalizeUpdateChannel } from "./update-channels-PRDK51ZI.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-MWP8Zsm4.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-Dt1RvPGb.js";
import { t as readConfiguredLogTail } from "./log-tail-SSIOiBvI.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-OtrnobVG.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-BHkGKA8i.js";
import { t as buildChannelAccountSnapshot } from "./status-DR5Wux0v.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-CKMyFTUY.js";
import { t as installSkill } from "./skills-install-D1bvQzg7.js";
import { r as readPackageVersion } from "./package-json-DOggV1NP.js";
import { t as getStatusSummary } from "./status.summary-CbYQ1xDQ.js";
import "./status-CU1Yrzwj.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-DknchscR.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-q74OGyZA.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-Ddzsfzfm.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-DREDL1BU.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-Boc7kfSn.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Bc8I21x6.js";
import { t as diffConfigPaths } from "./config-diff-dHsUsOHm.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-2xj6DtR7.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CjTELDo1.js";
import "./heartbeat-runner-_yO5w_G5.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-Cex55IRm.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-AaoMy9xC.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-CrW2baQU.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-Ba0dwj8q.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-C54CtcG0.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-CXi7VO87.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-dAmJxOeb.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-j3i45eDz.js";
	...
	agent: async ({ params, respond, context, client, isWebchatConnect }) => {
		...
		(async () => {
			...
			try {
				...
				let execApprovalFollowupElevatedDefaults = consumeExecApprovalFollowupElevatedDefaultsFromIdempotencyKey({
					idempotencyKey: idem,
					sessionKey: resolvedSessionKey
				});
				if (!execApprovalFollowupElevatedDefaults && requestedSessionKeyRaw && requestedSessionKeyRaw !== resolvedSessionKey) execApprovalFollowupElevatedDefaults = consumeExecApprovalFollowupElevatedDefaultsFromIdempotencyKey({
					idempotencyKey: idem,
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DMxCoUvy.js");
