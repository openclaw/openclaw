import { i as OpenClawConfig, yn as CliBackendConfig } from "./types.openclaw-C9E_zZnO.js";
import { l as SecretInput } from "./types.secrets-HNR48ili.js";
import { a as ModelCompatConfig, c as ModelProviderAuthMode, l as ModelProviderConfig } from "./types.models-gg_vEQfc.js";
import { Vn as ToolLoopDetectionConfig } from "./types.channels-CZZMDOR0.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-sr9je3I3.js";
import { d as UnifiedModelCatalogKind, l as PluginKind, m as PluginConfigUiHint, u as UnifiedModelCatalogEntry } from "./manifest-registry-DAlzfkU_.js";
import { t as JsonSchemaObject } from "./json-schema.types-CleB-fuS.js";
import { n as ReasoningLevel, r as ThinkLevel } from "./thinking.shared-D3hXUZEF.js";
import { t as ChannelId } from "./channel-id.types-DZJbj8ko.js";
import { c as SessionSystemPromptReport } from "./types-BoPp7-Sf.js";
import { r as AnyAgentTool } from "./common-BTwhyOZ1.js";
import { a as PromptMode, h as EmbeddedPiCompactResult, p as ExecElevatedDefaults, r as RunEmbeddedPiAgentParams, v as EmbeddedRunLivenessState, x as HeartbeatToolResponse, y as MessagingToolSend } from "./params-Ca2aO1q_.js";
import { c as ReplyPayload, o as SourceReplyDeliveryMode } from "./get-reply-options.types-BQuqGiER.js";
import { c as DiagnosticEventPayload, kt as TalkTransport, o as DiagnosticEventInput, s as DiagnosticEventMetadata } from "./diagnostic-events-DtMZzCAw.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-BfzVDSEu.js";
import { t as CommandQueueEnqueueFn } from "./command-queue.types-BJsnyDo5.js";
import { s as SandboxFsBridge } from "./backend-handle.types-BljsYPZk.js";
import { n as FailoverReason } from "./types-D4xoVXc6.js";
import { n as SkillSnapshot } from "./skills-nYgIU10p.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-BN5LqwSr.js";
import { N as WebFetchProviderPlugin, S as OpenClawPluginHookOptions, T as OpenClawPluginToolOptions, p as DetachedTaskLifecycleRuntime, w as OpenClawPluginToolFactory, z as WebSearchProviderPlugin } from "./types-core-aEWdlOh5.js";
import { a as AuthProfileStore, n as AuthProfileCredential, o as OAuthCredential, t as ApiKeyCredential } from "./types-DNLAqYp7.js";
import { f as MediaUnderstandingProvider } from "./types-Bww3J3ev.js";
import { l as ImageGenerationProvider } from "./types-DbQGG85m.js";
import { s as VideoGenerationProvider } from "./types-CkTqub04.js";
import { c as MusicGenerationProvider } from "./types-DhHPQfA22.js";
import { n as RuntimeEnv } from "./runtime-D0p4Vp8x.js";
import { i as WizardPrompter } from "./prompts-lrXrb5IE.js";
import { t as SecretInputMode } from "./provider-auth-types-d0bK_ZwN.js";
import { A as SpeechSynthesisRequest, C as SpeechProviderId, D as SpeechProviderResolveConfigContext, E as SpeechProviderPreparedSynthesis, F as SpeechTelephonySynthesisRequest, I as SpeechTelephonySynthesisResult, L as SpeechVoiceOption, M as SpeechSynthesisStreamRequest, N as SpeechSynthesisStreamResult, O as SpeechProviderResolveTalkConfigContext, S as SpeechProviderConfiguredContext, T as SpeechProviderPrepareSynthesisContext, _ as SpeechDirectiveTokenParseContext, j as SpeechSynthesisResult, k as SpeechProviderResolveTalkOverridesContext, v as SpeechDirectiveTokenParseResult, x as SpeechProviderConfig, y as SpeechListVoicesRequest } from "./tts-runtime.types-CxTU0vS3.js";
import { c as ContextEngine, d as ContextEnginePromptCacheInfo, f as ContextEngineRuntimeContext, t as ContextEngineFactory } from "./registry-P7xrC1Zc.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-Beqf4eaT.js";
import { $ as PluginHookName, $t as PluginHookBeforeAgentStartResult, Ft as PluginJsonValue, Gt as PluginConversationBindingRequestResult, K as PluginHookHandlerMap, Mt as PluginNextTurnInjection, Nt as PluginNextTurnInjectionEnqueueResult, Ut as PluginConversationBinding, Wt as PluginConversationBindingRequestParams, qt as PluginConversationBindingResolvedEvent } from "./hook-types-uik7367C.js";
import { Do as PluginToolMetadataRegistration, Eo as PluginSessionSchedulerJobRegistration, Oo as PluginTrustedToolPolicyRegistration, So as PluginRuntimeLifecycleRegistration, To as PluginSessionSchedulerJobHandle, bo as PluginRunContextGetParams, ko as OperatorScope, vo as PluginAgentEventSubscriptionRegistration, wo as PluginSessionExtensionRegistration, xo as PluginRunContextPatch, yo as PluginControlUiDescriptor } from "./index-FyLSqSFO.js";
import { n as ChannelPlugin } from "./types.public-D_xOTs5v.js";
import { n as GatewayRequestHandler } from "./types-DZSMYXQj.js";
import { r as InternalHookHandler } from "./internal-hook-types-BI3GrwC9.js";
...
import { Api, AssistantMessage, Model } from "@mariozechner/pi-ai";
import { Command } from "commander";
import { AgentMessage, AgentTool, AgentToolResult, StreamFn } from "@mariozechner/pi-agent-core";
...
type OpenClawPluginApi = {
   ...
   */
  registerAgentToolResultMiddleware: (handler: AgentToolResultMiddleware, options?: AgentToolResultMiddlewareOptions) => void; /** Register plugin-owned session state that can be projected into Gateway session rows. */
  registerSessionExtension: (extension: PluginSessionExtensionRegistration) => void; /** Queue one plugin-owned context injection for the next agent turn in a session. */
   ...
   */
  registerToolMetadata: (metadata: PluginToolMetadataRegistration) => void; /** Register a generic Control UI contribution descriptor. */
  registerControlUiDescriptor: (descriptor: PluginControlUiDescriptor) => void; /** Register cleanup hooks for plugin-owned host state and background work. */
  registerRuntimeLifecycle: (lifecycle: PluginRuntimeLifecycleRegistration) => void; /** Subscribe to sanitized agent events through the host-owned plugin lifecycle. */
  registerAgentEventSubscription: (subscription: PluginAgentEventSubscriptionRegistration) => void; /** Store namespaced, JSON-compatible data for the active run. Cleared on run end/error. */
  setRunContext: (patch: PluginRunContextPatch) => boolean; /** Read namespaced plugin data for a run. */
  ...
  clearRunContext: (params: {
    runId: string;
    namespace?: string;
  }) => void; /** Register a plugin-owned session job so reset/delete/disable can clean it deterministically. */
  registerSessionSchedulerJob: (job: PluginSessionSchedulerJobRegistration) => PluginSessionSchedulerJobHandle | undefined; /** Register the active detached task runtime for this plugin (exclusive slot). */
...
//#endregion
export { PluginInteractiveHandlerRegistration as $, CodexAppServerToolResultHandlerResult as $n, AgentHarnessDeliveryDefaults as $r, ProviderPluginWizardSetup as $t, OpenClawPluginHttpRouteParams as A, RealtimeTranscriptionProviderPlugin as An, RealtimeVoiceCloseReason as Ar, ProviderDiscoveryContext as At, OpenClawPluginNodeInvokeTransportResult as B, ProviderExternalAuthProfile as Bn, RealtimeTranscriptionProviderConfig as Br, ProviderModernModelPolicyContext as Bt, OpenClawPluginDefinition as C, listRegisteredMemoryEmbeddingProviders as Ci, ProviderSystemPromptContributionContext as Cn, RealtimeVoiceBargeInOptions as Cr, ProviderCapabilities as Ct, OpenClawPluginHttpRouteAuth as D, ProviderValidateReplayTurnsContext as Dn, RealtimeVoiceBridgeEvent as Dr, ProviderCreateEmbeddingProviderContext as Dt, OpenClawPluginHostedMediaResolver as E, ProviderTransportTurnState as En, RealtimeVoiceBridgeCreateRequest as Er, ProviderCatalogResult as Et, OpenClawPluginNodeInvokeApprovalDecision as F, VideoGenerationProviderPlugin as Fn, RealtimeVoiceProviderResolveConfigContext as Fr, ProviderFailoverErrorContext as Ft, OpenClawPluginServiceContext as G, ProviderSyntheticAuthResult as Gn, RealtimeTranscriptionSessionCallbacks as Gr, ProviderNormalizeToolSchemasContext as Gt, OpenClawPluginSecurityAuditCollector as H, ProviderResolveExternalAuthProfilesContext as Hn, RealtimeTranscriptionProviderId as Hr, ProviderNonInteractiveApiKeyResult as Ht, OpenClawPluginNodeInvokePolicy as I, ProviderDefaultThinkingPolicyContext as In, RealtimeVoiceRole as Ir, ProviderFetchUsageSnapshotContext as It, PluginCommandHandler as J, ProviderResolveConfigApiKeyContext as Jn, AgentHarness as Jr, ProviderPlugin as Jt, PluginCommandContext as K, ProviderApplyConfigDefaultsContext as Kn, RealtimeTranscriptionSessionCreateRequest as Kr, ProviderNormalizeTransportContext as Kt, OpenClawPluginNodeInvokePolicyApprovalRuntime as L, ProviderThinkingPolicyContext as Ln, RealtimeVoiceTool as Lr, ProviderFollowupFallbackRouteContext as Lt, OpenClawPluginModule as M, SpeechProviderPlugin as Mn, RealtimeVoiceProviderConfig as Mr, ProviderDiscoveryResult as Mt, OpenClawPluginNodeCliFeatureOptions as N, UnifiedModelCatalogProviderContext as Nn, RealtimeVoiceProviderConfiguredContext as Nr, ProviderExtraParamsForTransportContext as Nt, OpenClawPluginHttpRouteHandler as O, ProviderWebSocketSessionPolicy as On, RealtimeVoiceBrowserSession as Or, ProviderCreateStreamFnContext as Ot, OpenClawPluginNodeHostCommand as P, UnifiedModelCatalogProviderPlugin as Pn, RealtimeVoiceProviderId as Pr, ProviderExtraParamsForTransportResult as Pt, PluginEmbeddingProvider as Q, CodexAppServerToolResultEvent as Qn, AgentHarnessCompactResult as Qr, ProviderPluginWizardModelPicker as Qt, OpenClawPluginNodeInvokePolicyContext as R, ProviderThinkingProfile as Rn, RealtimeVoiceToolCallEvent as Rr, ProviderFollowupFallbackRouteResult as Rt, OpenClawPluginConfigSchema as S, clearMemoryEmbeddingProviders as Si, ProviderSanitizeReplayHistoryContext as Sn, RealtimeVoiceAudioFormat as Sr, ProviderCacheTtlEligibilityContext as St, OpenClawPluginGatewayRuntimeScopeSurface as T, ProviderTransformSystemPromptContext as Tn, RealtimeVoiceBridgeCallbacks as Tr, ProviderCatalogOrder as Tt, OpenClawPluginSecurityAuditContext as U, ProviderResolveExternalOAuthProfilesContext as Un, RealtimeTranscriptionProviderResolveConfigContext as Ur, ProviderNormalizeModelIdContext as Ut, OpenClawPluginReloadRegistration as V, ProviderExternalOAuthProfile as Vn, RealtimeTranscriptionProviderConfiguredContext as Vr, ProviderNonInteractiveApiKeyCredentialParams as Vt, OpenClawPluginService as W, ProviderResolveSyntheticAuthContext as Wn, RealtimeTranscriptionSession as Wr, ProviderNormalizeResolvedModelContext as Wt, PluginConfigMigration as X, CodexAppServerExtensionFactory as Xn, AgentHarnessAttemptResult as Xr, ProviderPluginDiscovery as Xt, PluginCommandResult as Y, CodexAppServerExtensionContext as Yn, AgentHarnessAttemptParams as Yr, ProviderPluginCatalog as Yt, PluginConfigValidation as Z, CodexAppServerExtensionRuntime as Zn, AgentHarnessCompactParams as Zr, ProviderPluginWizard as Zt, OpenClawPluginChannelRegistration as _, MemoryEmbeddingProvider as _i, ProviderResolveTransportTurnStateContext as _n, AgentToolResultMiddlewareResult as _r, ProviderAuthResult as _t, MigrationItem as a, EmbeddedRunAttemptParams as ai, ProviderReasoningOutputMode as an, CliBackendPreparedExecution as ar, PluginRegistrationMode as at, OpenClawPluginCliRegistrar as b, MemoryEmbeddingProviderCreateResult as bi, ProviderResolvedUsageAuth as bn, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as br, ProviderBuiltInModelSuppressionContext as bt, MigrationItemStatus as c, normalizeUsage as ci, ProviderReplayPolicyContext as cn, CliBackendThinkingLevel as cr, PluginSpeechProviderEntry as ct, MigrationProviderPlugin as d, ToolOutcomeObserver as di, ProviderReplaySessionState as dn, PluginTextTransforms as dr, ProviderAuthContext as dt, AgentHarnessResetParams as ei, ProviderPreferRuntimeResolvedModelContext as en, CliBackendAuthEpochMode as er, PluginInteractiveHandlerResult as et, MigrationSummary as f, isToolWrappedWithBeforeToolCallHook as fi, ProviderReplayToolCallIdMode as fn, AgentToolResultMiddleware as fr, ProviderAuthDoctorHintContext as ft, OpenClawPluginApi as g, MemoryEmbeddingBatchOptions as gi, ProviderResolvePromptOverlayContext as gn, AgentToolResultMiddlewareOptions as gr, ProviderAuthOptionBag as gt, OpenClawGatewayDiscoveryService as h, MemoryEmbeddingBatchChunk as hi, ProviderResolveNonInteractiveApiKeyParams as hn, AgentToolResultMiddlewareHarness as hr, ProviderAuthMethodNonInteractiveContext as ht, MigrationDetection as i, CompactEmbeddedPiSessionParams as ii, ProviderPreparedRuntimeAuth as in, CliBackendPrepareExecutionContext as ir, PluginRealtimeVoiceProviderEntry as it, OpenClawPluginHttpRouteUpgradeHandler as j, RealtimeVoiceProviderPlugin as jn, RealtimeVoiceProviderCapabilities as jr, ProviderDiscoveryOrder as jt, OpenClawPluginHttpRouteMatch as k, ProviderWrapStreamFnContext as kn, RealtimeVoiceBrowserSessionCreateRequest as kr, ProviderDeferSyntheticProfileAuthContext as kt, MigrationPlan as l, AgentRuntimePlan as li, ProviderReplaySanitizeMode as ln, CliBundleMcpMode as lr, PluginTextTransformRegistration as lt, OpenClawGatewayDiscoveryAdvertiseContext as m, resolveEmbeddedAgentRuntime as mi, ProviderResolveDynamicModelContext as mn, AgentToolResultMiddlewareEvent as mr, ProviderAuthMethod as mt, MediaUnderstandingProviderPlugin as n, AgentHarnessSupport as ni, ProviderPrepareExtraParamsContext as nn, CliBackendNormalizeConfigContext as nr, PluginLogger as nt, MigrationItemAction as o, EmbeddedRunAttemptResult as oi, ProviderReasoningOutputModeContext as on, CliBackendResolveExecutionArgs as or, PluginSetupAutoEnableContext as ot, MusicGenerationProviderPlugin as p, wrapToolWithBeforeToolCallHook as pi, ProviderResolveAuthProfileIdContext as pn, AgentToolResultMiddlewareContext as pr, ProviderAuthKind as pt, PluginCommandDiagnosticsSession as q, ProviderNormalizeConfigContext as qn, ProviderSystemPromptContribution as qr, ProviderOAuthProfileIdRepair as qt, MigrationApplyResult as r, AgentHarnessSupportContext as ri, ProviderPrepareRuntimeAuthContext as rn, CliBackendPlugin as rr, PluginRealtimeTranscriptionProviderEntry as rt, MigrationItemKind as s, NormalizedUsage as si, ProviderReplayPolicy as sn, CliBackendResolveExecutionArgsContext as sr, PluginSetupAutoEnableProbe as st, ImageGenerationProviderPlugin as t, AgentHarnessResultClassification as ti, ProviderPrepareDynamicModelContext as tn, CliBackendNativeToolMode as tr, PluginInteractiveRegistration as tt, MigrationProviderContext as u, BuildAgentRuntimePlanParams as ui, ProviderReplaySessionEntry as un, PluginTextReplacement as ur, ProviderAugmentModelCatalogContext as ut, OpenClawPluginCliCommandDescriptor as v, MemoryEmbeddingProviderAdapter as vi, ProviderResolveUsageAuthContext as vn, AgentToolResultMiddlewareRuntime as vr, ProviderBuildMissingAuthMessageContext as vt, OpenClawPluginGatewayMethod as w, registerMemoryEmbeddingProvider as wi, ProviderToolSchemaDiagnostic as wn, RealtimeVoiceBridge as wr, ProviderCatalogContext as wt, OpenClawPluginCommandDefinition as x, MemoryEmbeddingProviderRuntime as xi, ProviderRuntimeProviderConfig as xn, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as xr, ProviderBuiltInModelSuppressionResult as xt, OpenClawPluginCliContext as y, MemoryEmbeddingProviderCreateOptions as yi, ProviderResolveWebSocketSessionPolicyContext as yn, OpenClawAgentToolResult as yr, ProviderBuildUnknownModelHintContext as yt, OpenClawPluginNodeInvokePolicyResult as z, ProviderRuntimeModel as zn, RealtimeVoiceToolResultOptions as zr, ProviderModelSelectedContext as zt };