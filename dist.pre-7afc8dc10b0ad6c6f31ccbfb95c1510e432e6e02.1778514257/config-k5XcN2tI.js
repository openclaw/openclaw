...
import { j as TtsConfigSchema } from "./zod-schema.core-ZZiuAHri.js";
import { r as buildSecretInputSchema } from "./secret-input-X-VlpIj5.js";
import { c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, l as REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES } from "./session-runtime-DpMwEPir.js";
import "./realtime-voice-C7mPJW7r.js";
import { t as zod_exports } from "./zod-BILJI2PX.js";
import "./api-CuCqy0u5.js";
...
const VoiceCallNumberRouteConfigSchema = zod_exports.z.object({
	...
	responseTimeoutMs: zod_exports.z.number().int().positive().optional()
}).strict();
...
const VoiceCallSessionScopeSchema = zod_exports.z.enum(["per-phone", "per-call"]);
...
const VoiceCallRealtimeConsultPolicySchema = zod_exports.z.enum([
	"auto",
	"substantive",
	"always"
]);
...
const VoiceCallRealtimeAgentContextConfigSchema = zod_exports.z.object({
	...
	maxChars: zod_exports.z.number().int().positive().default(6e3),
	/** Include configured agent identity fields. */
	includeIdentity: zod_exports.z.boolean().default(true),
	/** Include agents.defaults/list systemPromptOverride when configured. */
	includeSystemPrompt: zod_exports.z.boolean().default(true),
	/** Include selected workspace files such as SOUL.md and IDENTITY.md. */
	includeWorkspaceFiles: zod_exports.z.boolean().default(true),
	/** Workspace-relative files to include, bounded by maxChars. */
	files: zod_exports.z.array(zod_exports.z.string().min(1)).default([
		"SOUL.md",
		"IDENTITY.md",
		"USER.md"
	])
...
const VoiceCallRealtimeConsultThinkingLevelSchema = zod_exports.z.enum([
	"off",
	"minimal",
	"low",
	"medium",
...
const VoiceCallRealtimeConfigSchema = zod_exports.z.object({
	...
	consultFastMode: zod_exports.z.boolean().optional(),
...
const VoiceCallConfigSchema = zod_exports.z.object({
	...
	numbers: zod_exports.z.record(E164Schema, VoiceCallNumberRouteConfigSchema).default({}),
