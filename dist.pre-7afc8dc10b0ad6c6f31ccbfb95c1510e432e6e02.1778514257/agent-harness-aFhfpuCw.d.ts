...
import { r as ContinueWorkRequest } from "./types-DHF1l1a3.js";
import { r as AnyAgentTool } from "./common-BTwhyOZ1.js";
import { i as RequestCompactionToolOpts, m as ExecToolDefaults } from "./params-Ca2aO1q_.js";
import { o as SourceReplyDeliveryMode } from "./get-reply-options.types-BQuqGiER.js";
...
import { di as ToolOutcomeObserver } from "./types-BOTb5nyG.js";
import { t as ModelAuthMode } from "./model-auth-GeBD2w1s.js";
import { r as SandboxContext } from "./types-DeHLJgQr.js";
import { t as ProcessToolDefaults } from "./bash-tools.process-KD1xgx_A.js";
...
declare function createOpenClawCodingTools(options?: {
  ...
  includeCoreTools?: boolean; /** Limits which tool families are materialized before the shared policy pipeline runs. */
