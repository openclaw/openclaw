import { m as restoreTerminalState } from "./subsystem-DVwhOlEq.js";
import "./paths-BfR2LXbA.js";
import "./boolean-BHdNsbzF.js";
import { Ct as openUrl, Dt as resolveControlUiLinks, Tt as probeGatewayReachable, _t as formatControlUiSshHint, ht as detectBrowserOpenSupport, jt as waitForGatewayReachable } from "./auth-profiles-CAw5gP6f.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-DBEC2O3x.js";
import { m as pathExists, v as resolveUserPath } from "./utils-8QNki08A.js";
...
import { i as isSystemdUserServiceAvailable } from "./systemd-DuQVc30D.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DB3y-xDN.js";
import { r as healthCommand } from "./health-Dpej8X2i.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DO3GwOI9.js";
import { t as resolveOnboardingSecretInputString } from "./onboarding.secret-input-C1X6p_Oh.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Df2GrfwE.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CuYxpvSU.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CuYxpvSU.js");
