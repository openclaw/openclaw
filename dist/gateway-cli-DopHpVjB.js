import { A as theme, M as getLogger, N as getResolvedLoggerSettings, O as colorize, S as logVerbose, a as setConsoleSubsystemFilter, c as sanitizeForLog, j as getChildLogger, k as isRich, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger, w as setVerbose } from "./subsystem-DVwhOlEq.js";
import { g as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-BfR2LXbA.js";
import "./boolean-BHdNsbzF.js";
import { a as logAcceptedEnvOption, i as isTruthyEnvValue } from "./entry.js";
import { $a as buildChannelUiCatalog, $c as validateCronUpdateParams, $f as mergeDeliveryContext, $g as parseByteSize, $h as safeEqualSecret, $i as computeBackoff, $l as validateWizardCancelParams, $m as resolveConfiguredSecretInputString, $n as verifyNodeToken, $s as isSystemEventContextChanged, $u as enqueueCommandInLane, A as resolveAllowedModelRef, Ac as validateAgentsFilesSetParams, Af as estimateBase64DecodedBytes, Ah as readGatewayPasswordEnv, Ai as resolveAnnounceTargetFromKey, Al as validateRequestFrame, An as applyVerboseOverride, Ao as consumeRestartSentinel, Av as DEFAULT_PROVIDER, B as createPluginRuntime, Ba as buildOutboundSessionContext, Bc as validateConfigGetParams, Bd as resolveUserTimezone, Bf as parseSessionThreadInfo, Bg as parseConfigJson5, Bh as isLoopbackHost, Bi as canonicalizeSpawnedByForAgent, Bl as validateSessionsResolveParams, Bn as getRemoteSkillEligibility, Bo as normalizeCronStaggerMs, Bp as isGatewayCliClient, Br as waitForActiveEmbeddedRuns, Bu as resolvePluginTools, Bv as normalizeVerboseLevel, C as isCliProvider, C_ as applyLegacyMigrations, Cc as validateAgentIdentityParams, Ch as authorizeHttpGatewayConnect, Ci as getAgentRunContext, Cl as validateNodePairVerifyParams, Cm as ensurePortAvailable, Cn as runCliAgent, Cp as canonicalizeMainSessionAlias, Cr as extractFileContentFromSource, D as normalizeModelSelection, Dc as validateAgentsDeleteParams, Dl as validateNodeRenameParams, Dp as resolveMainSessionKeyFromConfig, Du as mergeExecApprovalsSocketDefaults, Dv as normalizeSecretInput, Ec as validateAgentsCreateParams, Eg as SsrFBlockedError, Eh as resolveGatewayAuth, El as validateNodePendingEnqueueParams, Ep as resolveMainSessionKey, Er as resolveInputFileLimits, F_ as resolveAgentMaxConcurrent, Fc as validateChatAbortParams, Fd as ToolInputError, Fh as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, Fi as applyModelOverrideToSessionEntry, Fl as validateSessionsDeleteParams, Ft as resolveAssistantAvatarUrl, Fv as normalizeElevatedLevel, G as formatHelpExamples, Gc as validateConfigSetParams, Gd as SILENT_REPLY_TOKEN, Gh as pickPrimaryLanIPv4, Gi as loadSessionEntry, Gl as validateSkillsUpdateParams, Gn as removeRemoteNodeInfo, Go as normalizeOptionalSessionKey, Gr as resolveFastModeState, Gs as buildSystemRunApprovalBinding, Hc as validateConfigSchemaLookupParams, Hf as archiveRemovedSessionTranscripts, Hg as readConfigFileSnapshot, Hh as isTrustedProxyAddress, Hi as listAgentsForGateway, Hl as validateSkillsBinsParams, Hn as recordRemoteNodeInfo, Ho as resolveDefaultCronStaggerMs, Hs as resolveSystemRunApprovalRuntimeContext, Hv as supportsXHighThinking, I as resolveSubagentConfiguredModelSelection, I_ as resolveSubagentMaxConcurrent, Ic as validateChatHistoryParams, Ih as createAuthRateLimiter, Ii as loadProviderUsageSummary, Il as validateSessionsListParams, In as getChannelActivity, Io as writeRestartSentinel, Ir as runEmbeddedPiAgent, Iv as normalizeFastMode, J_ as runGlobalGatewayStopSafely, Jc as validateCronListParams, Jg as OpenClawSchema, Jh as resolveGatewayListenHosts, Ji as resolveSessionModelRef, Jl as validateToolsCatalogParams, Jn as listNodePairing, Jo as normalizeRequiredName, Jp as GATEWAY_CLIENT_MODES, Jr as resolveCronStyleNow, Ka as normalizeReplyPayloadsForDelivery, Kc as validateConnectParams, Kg as writeConfigFile, Kh as resolveClientIp, Ki as pruneLegacyStoreKeys, Kl as validateTalkConfigParams, Kn as setSkillsRemoteRegistry, Ko as normalizeOptionalText$1, Kp as GATEWAY_CLIENT_CAPS, Ks as matchSystemRunApprovalBinding, L as resolveThinkingDefault, Lc as validateChatInjectParams, Lf as resolveAgentSessionDirs, Lg as migrateLegacyConfig, Lh as normalizeRateLimitClientIp, Ll as validateSessionsPatchParams, Lo as normalizeHttpWebhookUrl, Lt as resolveExecApprovalCommandDisplay, Lu as saveExecApprovals, Lv as normalizeReasoningLevel, M as resolveConfiguredModelRef, Ma as resolveSessionDeliveryTarget, Mc as validateAgentsUpdateParams, Ml as validateSecretsResolveResult, Mn as unbindThreadBindingsBySessionKey, Mo as formatRestartSentinelMessage, Mr as isAbortRequestText, Mt as CONTROL_UI_AVATAR_PREFIX, Mu as readExecApprovalsSnapshot, Mv as formatXHighModelHint, N as resolveDefaultModelForAgent, Nc as validateChannelsLogoutParams, Nh as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Ni as resolveNestedAgentLane, Nl as validateSendParams, Nm as rawDataToString, Nr as stopSubagentsForRequester, Nt as buildControlUiAvatarUrl, Oc as validateAgentsFilesGetParams, Og as registerUnhandledRejectionHandler, Ol as validatePollParams, Om as formatPortDiagnostics, Oo as cleanStaleGatewayProcessesSync, Op as snapshotSessionOrigin, Or as normalizeSendPolicy, P as resolveHooksGmailModel, P_ as buildTalkConfigResponse, Pc as validateChannelsStatusParams, Ph as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Pi as resolvePreferredSessionKeyForSessionIdMatches, Pl as validateSessionsCompactParams, Pm as cleanOldMedia, Po as summarizeRestartSentinel, Pt as normalizeControlUiBasePath, Qc as validateCronStatusParams, Qd as resolveAgentIdentity, Qf as deliveryContextFromSession, Qh as pickPrimaryTailnetIPv6, Ql as validateWebLoginWaitParams, Qm as mergeGatewayTailscaleConfig, Qn as updatePairedNodeMetadata, Qr as buildDefaultToolPolicyPipelineSteps, Qs as enqueueSystemEvent, Qu as clearBootstrapSnapshotOnSessionRollover, Rc as validateChatSendParams, Rg as createConfigIO, Rh as isLocalishHost, Rl as validateSessionsPreviewParams, Ro as normalizeCronJobCreate, Rp as INTERNAL_MESSAGE_CHANNEL, Rr as abortEmbeddedPiRun, Rt as sanitizeExecApprovalDisplayText, Rv as normalizeThinkLevel, S as getModelRefStatus, S_ as applyMergePatch, Sc as formatValidationErrors, Sd as getAcpSessionManager, Sh as assertGatewayAuthConfigured, Si as emitAgentEvent, Sl as validateNodePairRequestParams, Sn as setCliSessionId, So as triggerOpenClawRestart, Sp as setSessionRuntimeModel, Sr as DEFAULT_INPUT_TIMEOUT_MS, Su as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, Tc as validateAgentWaitParams, Tg as fetchWithSsrFGuard, Th as isLocalDirectRequest, Ti as registerAgentRunContext, Tl as validateNodePendingDrainParams, Tn as resolveSessionAuthProfileOverride, Tp as resolveExplicitAgentSessionKey, Tr as normalizeMimeList, U as withProgress, Uc as validateConfigSchemaLookupResult, Uf as loadSessionStore, Ug as readConfigFileSnapshotForWrite, Uh as isValidIPv4, Ui as listSessionsFromStore, Ul as validateSkillsInstallParams, Un as refreshRemoteBinsForConnectedNodes, Up as isWebchatClient, Ut as resolveAgentAvatar, Va as deliverOutboundPayloads, Vc as validateConfigPatchParams, Vg as readBestEffortConfig, Vl as validateSessionsUsageParams, Vn as primeRemoteSkillsCache, Vo as resolveCronStaggerMs, Vp as isGatewayMessageChannel, Vr as waitForEmbeddedPiRunEnd, Vs as resolveSystemRunApprovalRequestContext, Wc as validateConfigSchemaParams, Wg as resolveConfigSnapshotHash, Wh as normalizeHostHeader, Wi as loadCombinedSessionStoreForGateway, Wl as validateSkillsStatusParams, Wn as refreshRemoteNodeBins, Wo as normalizeOptionalAgentId, Wp as normalizeMessageChannel, Wr as resolveBootstrapWarningSignaturesSeen, Ws as resolveSystemRunCommandRequest, Xa as applyPluginAutoEnable, Xc as validateCronRunParams, Xl as validateWakeParams, Xm as ensureGatewayStartupAuth, Xn as renamePairedNode, Xo as parseAbsoluteTimeMs, Xp as hasGatewayClientCap, Xr as resolveToolLoopDetectionConfig, Xt as buildHistoryContextFromEntries, Ya as resolveOutboundChannelPlugin, Yc as validateCronRemoveParams, Yh as resolveRequestClientIp, Yl as validateUpdateRunParams, Yn as rejectNodePairing, Yp as GATEWAY_CLIENT_NAMES, Ys as toSystemRunApprovalMismatchError, Yt as createReplyPrefixOptions, Zc as validateCronRunsParams, Zh as pickPrimaryTailnetIPv4, Zi as lookupContextTokens, Zl as validateWebLoginStartParams, Zm as mergeGatewayAuthConfig, Zn as requestNodePairing, Zo as normalizeLegacyDeliveryInput, Zp as normalizeGatewayClientMode, Zr as applyToolPolicyPipeline, Zu as clearBootstrapSnapshot, _a as readChannelAllowFromStoreSync, _d as resolveMemorySearchConfig, _g as resolveCoreToolProfiles, _i as resolveAgentTimeoutMs, _l as validateNodeInvokeResultParams, _m as startBrowserControlServiceFromConfig, _n as buildBareSessionResetPrompt, _o as isGatewaySigusr1RestartExternallyAllowed, _r as registerSkillsChangeListener, _s as getActiveSecretsRuntimeSnapshot, _u as normalizeDevicePublicKeyBase64Url, a_ as AVATAR_MAX_BYTES, ad as setCommandLaneConcurrency, af as resolveTtsApiKey, ag as getTailnetHostname, ai as runBeforeToolCallHook, al as validateDeviceTokenRotateParams, ao as resolveMessageChannelSelection, ap as cleanupArchivedSessionTranscripts, ar as listAgentWorkspaceDirs, au as parseSessionLabel, bc as isNodeRoleMethod, bi as resolveIngressWorkspaceOverrideForSpawnedRun, bl as validateNodePairListParams, bn as saveCronStore, bo as setGatewaySigusr1RestartPolicy, bp as mergeSessionEntry, br as DEFAULT_INPUT_IMAGE_MAX_BYTES, bs as GATEWAY_AUTH_SURFACE_PATHS, bu as verifyDeviceSignature, c_ as looksLikeAvatarPath, cf as resolveTtsPrefsPath, cl as validateExecApprovalsGetParams, co as runWithModelFallback, cp as resolveSessionTranscriptCandidates, cs as buildSafeExternalPrompt, cu as resolveDeviceAuthConnectErrorDetailCode, df as setTtsProvider, dg as collectExplicitAllowlist, dl as validateExecApprovalsSetParams, dp as stripInlineDirectiveTagsForDisplay, ds as isExternalHookSession, du as normalizeDeviceMetadataForAuth, ea as sleepWithAbort, ed as getActiveTaskCount, eg as disableTailscaleFunnel, el as validateDevicePairApproveParams, em as cleanStaleLockFiles, ep as normalizeSessionDeliveryFields, eu as validateWizardNextParams, fa as ensureOutboundSessionEntry, fd as isDiagnosticsEnabled, ff as textToSpeech, fg as mergeAlsoAllowPolicy, fi as listDescendantRunsForRequester, fl as validateLogsTailParams, fp as stripInlineDirectiveTagsFromMessageForDisplay, fs as closeTrackedBrowserTabsForSessions, gc as PAIRING_SCOPE$1, gg as listCoreToolSections, gl as validateNodeInvokeParams, gm as createBrowserControlContext, go as emitGatewayRestart, gp as evaluateSessionFreshness, gr as getSkillsSnapshotVersion, gs as clearSecretsRuntimeSnapshot, gu as loadOrCreateDeviceIdentity, hc as APPROVALS_SCOPE$1, hl as validateNodeEventParams, hm as createBrowserRouteDispatcher, hn as getTotalPendingReplies, ho as deferGatewayRestartUntilIdle, hs as activateSecretsRuntimeSnapshot, hu as deriveDeviceIdFromPublicKey, ia as normalizeGroupActivation, ic as requestHeartbeatNow, id as resetAllLanes, if as isTtsProviderConfigured, il as validateDeviceTokenRevokeParams, im as writeJsonAtomic, ip as capArrayByJsonBytes, it as resolveAgentOutboundIdentity, iu as errorShape, ja as resolveOutboundTarget, jc as validateAgentsListParams, jd as isRestartEnabled, jg as loadModelCatalog, jh as readGatewayTokenEnv, jl as validateSecretsResolveParams, jn as parseVerboseOverride, jo as formatDoctorNonInteractiveHint, jv as formatThinkingLevels, kc as validateAgentsFilesListParams, ki as readLatestAssistantReply, kl as validatePushTestParams, kr as resolveSendPolicy, ku as normalizeExecApprovals, kv as DEFAULT_MODEL, lc as callGateway, ld as startDiagnosticHeartbeat, lf as resolveTtsProviderOrder, ll as validateExecApprovalsNodeGetParams, lp as stripEnvelopeFromMessage, ls as detectSuspiciousPatterns, lu as buildDeviceAuthPayload, mc as ADMIN_SCOPE$3, mf as OPENAI_TTS_VOICES, mg as PROFILE_OPTIONS, ml as validateNodeDescribeParams, mn as createReplyDispatcher, mo as consumeGatewaySigusr1RestartAuthorization, mp as jsonUtf8Bytes, ms as persistBrowserProxyFiles, mu as loadGatewayTlsRuntime$1, na as clearSessionQueues, nd as getTotalQueueSize, nf as getTtsProvider, ng as enableTailscaleFunnel, ni as resolveGroupToolPolicy, nl as validateDevicePairRejectParams, nm as createAsyncLock, no as maybeResolveIdLikeTarget, np as archiveFileOnDisk, nt as buildTelegramExecApprovalButtons, nu as validateWizardStatusParams, o_ as isAvatarHttpUrl, oc as setHeartbeatsEnabled, od as waitForActiveTasks, of as resolveTtsAutoMode, oi as createOpenClawTools, ol as validateExecApprovalRequestParams, on as sendTypingTelegram, oo as normalizePollInput, op as readSessionMessages, or as formatZonedTimestamp, ot as handleSlackHttpRequest, ou as ConnectErrorDetailCodes, pa as resolveOutboundSessionRoute, pf as OPENAI_TTS_MODELS, pg as resolveToolProfilePolicy, pl as validateModelsListParams, pn as dispatchInboundMessage, po as resolveFailoverReasonFromError, pp as normalizeInputProvenance, ps as applyBrowserProxyPaths, pu as normalizeDeviceAuthScopes, q_ as getGlobalHookRunner, qc as validateCronAddParams, qd as isSilentReplyText, qf as updateSessionStore, qg as validateConfigObjectWithPlugins, qh as resolveGatewayBindHost, qi as resolveGatewaySessionStoreTarget, ql as validateTalkModeParams, qn as approveNodePairing, qo as normalizePayloadToSystemText, qp as GATEWAY_CLIENT_IDS, qs as missingSystemRunApprovalBinding, rd as markGatewayDraining, rf as isTtsEnabled, rg as enableTailscaleServe, ri as resolveSubagentToolPolicy, rl as validateDevicePairRemoveParams, rm as readJsonFile, ro as resetDirectoryCache, rp as archiveSessionTranscripts, ru as ErrorCodes, s_ as isAvatarImageDataUrl, sd as CommandLane, sf as resolveTtsConfig, si as countActiveDescendantRuns, sl as validateExecApprovalResolveParams, sp as readSessionPreviewItemsFromTranscript, su as resolveAuthConnectErrorDetailCode, tg as disableTailscaleServe, ti as resolveEffectiveToolPolicy, tl as validateDevicePairListParams, tm as isPidAlive, tu as validateWizardStartParams, ud as stopDiagnosticHeartbeat, uf as setTtsEnabled, ui as initSubagentRegistry, ul as validateExecApprovalsNodeSetParams, up as stripEnvelopeFromMessages, us as getHookType, uu as buildDeviceAuthPayloadV3, vc as WRITE_SCOPE, vd as getMachineDisplayName, vl as validateNodeListParams, vn as loadCronStore, vo as markGatewaySigusr1RestartHandled, vp as resolveSessionResetPolicy, vs as prepareSecretsRuntimeSnapshot, vu as publicKeyRawBase64UrlFromPem, w_ as ensureControlUiAllowedOriginsForNonLoopbackBind, wc as validateAgentParams, wg as extractTextFromChatContent, wh as authorizeWsControlUiGatewayConnect, wi as onAgentEvent, wl as validateNodePendingAckParams, wm as inspectPortUsage, wp as resolveAgentMainSessionKey, wr as extractImageContentFromSource, ws as isKnownSecretTargetId, wu as ensureExecApprovals, xd as stripHeartbeatToken, xi as clearAgentRunContext, xl as validateNodePairRejectParams, xm as movePathToTrash, xn as getCliSessionId, xo as setPreRestartDeferralCheck, xr as DEFAULT_INPUT_IMAGE_MIMES, xs as evaluateGatewayAuthSurfaceStates, xu as buildExecApprovalPendingReplyPayload, y as buildAllowedModelSet, yc as authorizeOperatorScopesForMethod, yi as normalizeSpawnedRunMetadata, yl as validateNodePairApproveParams, yn as resolveCronStorePath, yo as scheduleGatewaySigusr1Restart, ys as resolveCommandSecretsFromActiveRuntimeSnapshot, yt as handleReset, z as loadOpenClawPlugins, zc as validateConfigApplyParams, zf as extractDeliveryInfo, zg as loadConfig, zh as isLoopbackAddress, zl as validateSessionsResetParams, zo as normalizeCronJobPatch, zp as isDeliverableMessageChannel, zr as getActiveEmbeddedRunCount, zu as getPluginToolMeta, zv as normalizeUsageDisplay } from "./auth-profiles-CAw5gP6f.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-DBEC2O3x.js";
import { C as isCronRunSessionKey, E as parseAgentSessionKey, S as isAcpSessionKey, T as isSubagentSessionKey, _ as normalizeAccountId$1, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-GuEQvqMH.js";
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-8QNki08A.js";
import { a as sameFileIdentity, i as openVerifiedFileSync, m as matchesSkillFilter, n as openBoundaryFile, r as openBoundaryFileSync, u as isNotFoundPathError } from "./boundary-file-read-CcBHg_z-.js";
import { i as logWarn, t as logDebug } from "./logger-CDI_b4HB.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-CHkvLtoM.js";
...
import { C as createInternalHookEvent, S as clearInternalHooks, T as triggerInternalHook, b as canonicalizePathVariant, h as createEmptyPluginRegistry, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, w as registerInternalHook, y as canonicalizePathForSecurity } from "./registry-B23eaqdH.js";
import { A as isTestDefaultMemorySlotDisabled, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-D75zdym7.js";
import { f as hasBinary } from "./frontmatter-BsxcWDrh.js";
import "./env-overrides-DWoj3eoQ.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-N--ZkDj4.js";
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-B1FsI6Ow.js";
import { U as resolveWhatsAppAccount, ct as normalizeWhatsAppTarget, g as buildChannelAccountBindings, lt as resolveChannelDefaultAccountId, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BKDaOrHv.js";
import { B as readLocalFileSafely, H as writeFileWithinRoot, L as openFileWithinRoot, N as SafeOpenError, W as detectMime } from "./query-expansion-kdDusy7Q.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-D9pXgQ9w.js";
import { l as isErrno, n as runCommandWithRuntime, o as formatErrorMessage } from "./cli-utils-Cikq4_a8.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-QMxjnO9x.js";
import { c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-6HYiRnfr.js";
...
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-Bll3H05x.js";
...
import { t as readSecretFromFile } from "./secret-file-CkEzu66v.js";
import { n as inheritOptionFromParent } from "./command-options-Ca7QaJTS.js";
import { t as WizardCancelledError } from "./prompts-C1pw879X.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config--ndKAeXM.js";
import { t as isWithinDir } from "./path-safety-CmNS4Puh.js";
...
import { t as buildChannelAccountSnapshot } from "./status-DyBTUE-4.js";
import "./channels-status-issues-BMEgAbeb.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-D_PCrZVR.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-C8h98y41.js";
...
import { u as scheduleDetachedLaunchdRestartHandoff } from "./service-DB3y-xDN.js";
import "./lifecycle-core-D7GxyKe5.js";
import "./systemd-hints-B-g2-fu9.js";
import { t as parsePort$1 } from "./parse-port-CS-89LRy.js";
import { c as parseProcCmdline, n as addGatewayServiceCommands, s as isGatewayArgv } from "./daemon-cli-Dr2knii_.js";
import { r as probeGateway } from "./probe-auth-CQpCFrNo.js";
import "./diagnostics-C6sYQF2z.js";
import "./inspect-BPVIKwVh.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-CgIcHEml.js";
import "./table-D9UWblu1.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CK58sJCf.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-KipM_Nd5.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CQ1G4Rxl.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BcyrXiU7.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-Dpej8X2i.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-Cf5LU1Bc.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DO3GwOI9.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-DB38RRf7.js";
import "./onboarding.secret-input-C1X6p_Oh.js";
import { t as runOnboardingWizard } from "./onboarding-CbAyEwAW.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-BTrtZ61l.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-BZN9F7OC.js";
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-BjQkA1gb.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent-ZpQQi4fz.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-Dck2qLDQ.js";
import { _ as resolveHookTargetAgentId, a as getHookAgentPolicyError, b as resolveFunctionModuleExport, c as normalizeAgentPayload, d as normalizeWakePayload, f as readJsonBody, g as resolveHookSessionKey, h as resolveHookIdempotencyKey, i as extractHookToken, l as normalizeHookDispatchSessionKey, m as resolveHookDeliver, n as collectEnabledInsecureOrDangerousFlags, o as getHookChannelError, p as resolveHookChannel, s as isHookAgentAllowed, u as normalizeHookHeaders, v as resolveHooksConfig, y as applyHookMappings } from "./audit-CCNYmynk.js";
import "./node-service-DKCLz93M.js";
import "./status.update-CD0Rwgeu.js";
import { t as installSkill } from "./skills-install-B8HNZtCp.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-B7kkb03s.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-BruOtN3d.js";
...
function createAgentEventHandler({ broadcast, broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients }) {
	...
	const flushBufferedChatDeltaIfNeeded = (sessionKey, clientRunId, sourceRunId, seq) => {
		...
		const shouldSuppressSilent = normalizedHeartbeatText.suppress || isSilentReplyText(text, "NO_REPLY");
...
async function inspectManualRunDisposition(state, id, mode) {
	return await locked(state, async () => {
		...
		if (!isJobDue(job, state.deps.nowMs(), { forced: mode === "force" })) return {
			ok: true,
			ran: false,
			reason: "not-due"
		};
...
function migrateAndPruneSessionStoreKey$1(params) {
...
async function performGatewaySessionReset(params) {
	...
	const next = await updateSessionStore(storePath, (store) => {
		const { primaryKey } = migrateAndPruneSessionStoreKey$1({
			cfg,
			key: params.key,
			store
		});
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BzJNNSTO.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-6HYiRnfr.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-C_VBmPtQ.js");
...
function resolveUnauthorizedHandshakeContext(params) {
	...
	if (canRetryWithDeviceToken) return {
		authProvided,
	...
	switch (params.failedAuth.reason) {
		...
		case "password_missing_config": return {
			authProvided,
			canRetryWithDeviceToken,
		...
		case "device_token_mismatch": return {
			authProvided,
			canRetryWithDeviceToken,
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-O9EZYTUe.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./auth-profiles-CAw5gP6f.js").then((n) => n.Ha);
