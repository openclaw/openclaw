...
function inferCustomCollectionKind(params) {
	...
	if (haystack.includes("dossier")) return "incident-dossier";
	if (haystack.includes("runbook") || haystack.includes("heartbeat") || haystack.includes("safety")) return "runbook";
	if (haystack.includes("session-summary")) return "session-summary";
	if (haystack.includes("docs") || haystack.includes("readme") || haystack.includes("plan")) return "repo-doc";
}
...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-bf4VLQTn.js");
