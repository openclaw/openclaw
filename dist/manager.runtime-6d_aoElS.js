...
import { B as shouldLogVerbose, Q as resolvePreferredOpenClawTmpDir, R as logVerbose, a as createSubsystemLogger, l as defaultRuntime } from "./logger-C9jPgLFF.js";
import { $t as formatDiscordUserTag, A as isDangerousNameMatchingEnabled, Ar as normalizeAccountId, At as resolveAcpDispatchPolicyError, Bi as buildWorkspaceSkillSnapshot, Br as normalizeChannelId, Bt as normalizeReplyPayload, Cr as emitSessionTranscriptUpdate, Ct as formatAgentInternalEventsForPrompt, Dr as updateSessionStore, Dt as registerAgentRunContext, Et as emitAgentEvent, Fn as toAcpRuntimeError, Fr as resolveSessionResetType, Ft as hasNonzeroUsage, Ir as mergeSessionEntry, It as resolveContextTokensForModel, J as runCliAgent, Jt as resolveAgentRoute, K as getCliSessionId, Lr as setSessionRuntimeModel, Mr as evaluateSessionFreshness, Mt as AGENT_LANE_SUBAGENT, Ni as formatErrorMessage, Nr as resolveChannelResetConfig, Nt as applyModelOverrideToSessionEntry, Ot as resolveAcpSessionCwd, Pn as getAcpSessionManager, Pr as resolveSessionResetPolicy, Pt as deriveSessionTotalTokens, Q as formatMention, Qi as ensureAuthProfileStore, Qn as isSilentReplyText, Qt as resolveDiscordOwnerAccess, Rr as resolveExplicitAgentSessionKey, Sr as resolveSessionTranscriptFile, St as resolveAgentTimeoutMs, Tt as clearAgentRunContext, X as applyVerboseOverride, Xt as resolveOutboundTarget, Y as clearSessionAuthProfileOverride, Zn as isSilentReplyPrefixText, Zt as resolveSessionDeliveryTarget, _ as getAgentRuntimeCommandSecretTargetIds, a as readConfigFileSnapshotForWrite, aa as supportsXHighThinking, an as formatOutboundPayloadLog, ar as textToSpeech, at as resolveSendPolicy, c as buildAllowedModelSet, ca as DEFAULT_PROVIDER, ci as isDeliverableMessageChannel, d as normalizeModelRef, di as normalizeMessageChannel, dt as prepareSessionManagerForRun, f as normalizeProviderId, fi as resolveMessageChannel, fn as runWithModelFallback, fr as buildProviderRegistry, ft as resolveBootstrapWarningSignaturesSeen, gr as runCapability, h as resolveThinkingDefault, ia as normalizeVerboseLevel, in as deliverOutboundPayloads, ir as resolveTtsConfig, jr as resolveSessionKey, jt as AGENT_LANE_NESTED, kn as clearBootstrapSnapshotOnSessionRollover, kt as resolveAcpAgentPolicyError, l as isCliProvider, li as isGatewayMessageChannel, m as resolveDefaultModelForAgent, mr as normalizeMediaAttachments, n as loadConfig, na as formatXHighModelHint, nt as getRemoteSkillEligibility, o as setRuntimeConfigSnapshot, on as normalizeOutboundPayloads, or as parseTtsDirectives, p as resolveConfiguredModelRef, pn as FailoverError, pr as createMediaAttachmentCache, q as setCliSessionId, ra as normalizeThinkLevel, rn as buildOutboundSessionContext, rt as getSkillsSnapshotVersion, sa as DEFAULT_MODEL, si as INTERNAL_MESSAGE_CHANNEL, sn as normalizeOutboundPayloadsForJson, ta as formatThinkingLevels, u as modelKey, ui as isInternalMessageChannel, un as resolveMessageChannelSelection, ut as runEmbeddedPiAgent, v as resolveCommandSecretRefsViaGateway, wr as loadSessionStore, wt as normalizeSpawnedRunMetadata, xa as formatCliCommand, xr as loadModelCatalog, zr as getChannelPlugin } from "./config-8kxbLL5Z.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, gn as resolveAgentIdFromSessionKey, gt as listAgentIds, hn as normalizeMainKey, mn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-D0B6X4Uh.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-TSpb4k5N.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-Dq-mucwQ.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-g2ZAHhUm.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-C41z-efZ.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-7Jz1Qye8.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DIxSUnUI.js");
