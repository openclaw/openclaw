import { A as theme, E as success, p as defaultRuntime, v as danger, y as info } from "./subsystem-DVwhOlEq.js";
import { t as CONFIG_PATH } from "./paths-BfR2LXbA.js";
import "./boolean-BHdNsbzF.js";
import { Hg as readConfigFileSnapshot, Kg as writeConfigFile } from "./auth-profiles-CAw5gP6f.js";
...
import { n as formatConfigIssueLines, r as normalizeConfigIssues } from "./issue-format-jHeRIpoa.js";
import { t as redactConfigObject } from "./redact-snapshot-C8h98y41.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for the setup wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-C4RfOu_V.js");
