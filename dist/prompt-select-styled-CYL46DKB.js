import { N as getResolvedLoggerSettings, p as defaultRuntime } from "./subsystem-DVwhOlEq.js";
...
import { Av as DEFAULT_PROVIDER, Bh as isLoopbackHost, Cg as resolveBootstrapTotalMaxChars, Dn as DEFAULT_OAUTH_WARN_MS, Eh as resolveGatewayAuth, Ep as resolveMainSessionKey, Et as randomToken, Fp as formatSessionArchiveTimestamp, Gv as CODEX_CLI_PROFILE_ID, Hg as readConfigFileSnapshot, Hr as analyzeBootstrapBudget, Ip as isPrimarySessionTranscriptFileName, Kg as writeConfigFile, Lf as resolveAgentSessionDirs, M as resolveConfiguredModelRef, Om as formatPortDiagnostics, On as buildAuthHealthSummary, P as resolveHooksGmailModel, S as getModelRefStatus, Sg as resolveBootstrapMaxChars, Uf as loadSessionStore, Ur as buildBootstrapInjectionStats, V_ as resolveApiKeyForProvider, Wv as CLAUDE_CLI_PROFILE_ID, Xu as resolveBootstrapContextForRun, _d as resolveMemorySearchConfig, bg as DEFAULT_SANDBOX_IMAGE, bn as saveCronStore, cc as buildGatewayConnectionDetails, eh as resolveConfiguredSecretInputWithFallback, em as cleanStaleLockFiles, g as updateAuthProfileStoreWithLock, gd as hasConfiguredMemorySecretInput, i as resolveApiKeyForProfile, jg as loadModelCatalog, jh as readGatewayTokenEnv, kn as formatRemainingShort, kv as DEFAULT_MODEL, l as repairOAuthProfileIdMismatch, lc as callGateway, lg as resolveSandboxScope, p as ensureAuthProfileStore, pt as applyWizardMetadata, qh as resolveGatewayBindHost, r as resolveProfileUnusableUntilForDisplay, tn as resolveDmAllowState, vg as DEFAULT_SANDBOX_BROWSER_IMAGE, vn as loadCronStore, vt as guardCancel, wm as inspectPortUsage, wt as printWizardHeader, xh as hasAmbiguousGatewayAuthModeConfig, yn as resolveCronStorePath, z as loadOpenClawPlugins } from "./auth-profiles-CAw5gP6f.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-DBEC2O3x.js";
import { E as parseAgentSessionKey } from "./session-key-GuEQvqMH.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-8QNki08A.js";
...
import { r as resolveMemoryBackendConfig } from "./search-manager-B1FsI6Ow.js";
import { n as listChannelPlugins } from "./plugins-BKDaOrHv.js";
import { i as isWSLEnv, r as isWSL } from "./fetch-ZNxqGXAR.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-QMxjnO9x.js";
import { _ as resolveGatewayWindowsTaskName, g as resolveGatewaySystemdServiceName, n as stylePromptMessage, p as resolveGatewayLaunchAgentLabel, r as stylePromptTitle, t as stylePromptHint, y as resolveNodeLaunchAgentLabel } from "./prompt-style-2BF77KhS.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DyIMLVt2.js";
import { t as note$1 } from "./note-8rWqI7pr.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BMEgAbeb.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-UU_0Zlnr.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BMkcI5P8.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-JtoqXmal.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-DuQVc30D.js";
import { a as isLaunchAgentLoaded, i as isLaunchAgentListed, n as resolveGatewayService, o as launchAgentPlistExists, s as repairLaunchAgentBootstrap, t as describeGatewayServiceRestart } from "./service-DB3y-xDN.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-B-g2-fu9.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-C6sYQF2z.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-BPVIKwVh.js";
import { r as healthCommand } from "./health-Dpej8X2i.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DO3GwOI9.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DB38RRf7.js";
import { f as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-BjQkA1gb.js";
import { n as logConfigUpdated } from "./logging-4N75Zj7h.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-_UA74bO6.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CpMysOSY.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Df2GrfwE.js";
import { t as formatHealthCheckFailure } from "./health-format-CAtvTWwP.js";
import { n as doctorShellCompletion } from "./doctor-completion-DRcp1YjI.js";
