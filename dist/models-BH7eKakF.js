...
import { r as resolveForwardCompatModel } from "./model-nQlDw9iA.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CtphyBYI.js";
import { An as resolveUsageProviderId, Dn as loadProviderUsageSummary, cn as DEFAULT_OAUTH_WARN_MS, jt as describeFailoverError, kn as formatUsageWindowSummary, ln as buildAuthHealthSummary, sn as maskApiKey, u as runEmbeddedPiAgent, un as formatRemainingShort } from "./subagent-registry-R4GEWTHb.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-DAWfoG1N.js";
import { t as ensureOpenClawModelsJson } from "./models-config-DWIgoa-v.js";
import { n as loadModelCatalog } from "./model-catalog-CO9IOYpD.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-DaYbtRP6.js";
import { f as openUrl } from "./onboard-helpers-CaaiwG16.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BqDQYbDG.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DuR_99EC.js";
import { n as logConfigUpdated } from "./logging-rBFvUkzk.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-CV_kM0vi.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-C39jSzPb.js").then((n) => n.t);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-nQlDw9iA.js").then((n) => n.t);
