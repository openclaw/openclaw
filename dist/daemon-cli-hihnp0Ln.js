...
import { d as resolveIsNixMode, g as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-BJV7vkaX.js";
import { A as theme, N as getResolvedLoggerSettings, O as colorize, k as isRich, p as defaultRuntime } from "./subsystem-DBBM_0ww.js";
import { C as sleep, S as shortenHomePath } from "./utils-JhJvOE-Q.js";
import { $h as trimToUndefined, Am as GATEWAY_CLIENT_MODES, At as resolveControlUiLinks, C_ as readBestEffortConfig, G as withProgress, Ms as killProcessTree, Ws as callGateway, Yl as loadGatewayTlsRuntime, b_ as createConfigIO, ch as inspectPortUsage, dh as classifyPortListener, fh as formatPortDiagnostics, io as parseCmdScriptCommandLine, jm as GATEWAY_CLIENT_NAMES, md as isRestartEnabled, mg as resolveGatewayBindHost, uo as findGatewayPidsOnPortSync, vg as pickPrimaryTailnetIPv4 } from "./reply-kqyKJg4x.js";
import { t as formatCliCommand } from "./command-format-p_4ya3m0.js";
import { i as isWSLEnv } from "./fetch-pr82VtKF.js";
import { T as parseStrictPositiveInteger, g as resolveGatewaySystemdServiceName, p as resolveGatewayLaunchAgentLabel } from "./prompt-style-DxRe6Qmy.js";
import { t as formatDocsLink } from "./links-D5--5M_8.js";
import { n as inheritOptionFromParent } from "./command-options-DqfI-XB8.js";
import { t as formatConfigIssueLine } from "./issue-format-BB8-D-5K.js";
import { n as buildGatewayInstallPlan, t as resolveGatewayInstallToken } from "./gateway-install-token-C9yVvVR4.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BVpor8un.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-BdNlnI5J.js";
import { c as resolveGatewayLogPaths, n as resolveGatewayService } from "./service-D4iDCrGh.js";
import { a as createCliStatusTextStyles, c as parsePortFromArgs, d as renderRuntimeHints, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, l as pickProbeHostForBind, m as buildDaemonServiceSnapshot, n as runServiceStart, o as filterDaemonEnv, p as safeDaemonEnv, r as runServiceStop, s as normalizeListenerAddress, t as runServiceRestart, u as renderGatewayServiceStartHints } from "./lifecycle-core-CIy3MaCd.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CFqMWKt8.js";
import { t as parsePort } from "./parse-port-CPiG944U.js";
import { n as resolveGatewayProbeAuthWithSecretInputs, r as probeGateway } from "./probe-auth-2svt1jzo.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-D8XddHDn.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CThQaXDy.js";
...
//#endregion
export { terminateStaleGatewayPids as a, parseProcCmdline as c, renderRestartDiagnostics as i, runDaemonInstall as l, addGatewayServiceCommands as n, waitForGatewayHealthyRestart as o, runDaemonRestart as r, isGatewayArgv as s, daemon_cli_exports as t };
