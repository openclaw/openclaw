...
import { $n as textToSpeech, $r as INTERNAL_MESSAGE_CHANNEL, $t as normalizeReplyPayload, Ai as formatCliCommand, Ar as resolveExplicitAgentSessionKey, Bt as registerAgentRunContext, Cn as resolveMessageChannelSelection, Cr as resolveSessionKey, Ct as runEmbeddedPiAgent, Di as buildWorkspaceSkillSnapshot, Dr as resolveSessionResetType, En as FailoverError, Er as resolveSessionResetPolicy, Fi as supportsXHighThinking, Fn as toAcpRuntimeError, Ft as resolveAgentTimeoutMs, Gn as isSilentReplyPrefixText, Gt as AGENT_LANE_SUBAGENT, Ht as resolveAcpAgentPolicyError, It as formatAgentInternalEventsForPrompt, Jt as hasNonzeroUsage, Kn as isSilentReplyText, Kt as applyModelOverrideToSessionEntry, Li as DEFAULT_MODEL, Lt as normalizeSpawnedRunMetadata, Mi as formatXHighModelHint, Mr as normalizeChannelId, Ni as normalizeThinkLevel, Or as mergeSessionEntry, Pi as normalizeVerboseLevel, Pn as getAcpSessionManager, Qn as resolveTtsConfig, Ri as DEFAULT_PROVIDER, Rt as clearAgentRunContext, Sr as normalizeAccountId, Tn as runWithModelFallback, Tr as resolveChannelResetConfig, Tt as resolveBootstrapWarningSignaturesSeen, Ut as resolveAcpDispatchPolicyError, Vt as resolveAcpSessionCwd, W as isDangerousNameMatchingEnabled, Wt as AGENT_LANE_NESTED, Yt as resolveContextTokensForModel, _n as deliverOutboundPayloads, _r as emitSessionTranscriptUpdate, a as setRuntimeConfigSnapshot, bi as formatErrorMessage, bn as normalizeOutboundPayloadsForJson, c as modelKey, cr as normalizeMediaAttachments, d as resolveConfiguredModelRef, dn as resolveDiscordOwnerAccess, dt as runCliAgent, ei as isDeliverableMessageChannel, er as parseTtsDirectives, f as resolveDefaultModelForAgent, fn as formatDiscordUserTag, ft as clearSessionAuthProfileOverride, gn as buildOutboundSessionContext, gr as resolveSessionTranscriptFile, gt as getSkillsSnapshotVersion, h as resolveCommandSecretRefsViaGateway, hr as loadModelCatalog, ht as getRemoteSkillEligibility, i as readConfigFileSnapshotForWrite, ii as resolveMessageChannel, ji as formatThinkingLevels, jr as getChannelPlugin, ki as ensureAuthProfileStore, kn as clearBootstrapSnapshotOnSessionRollover, kr as setSessionRuntimeModel, l as normalizeModelRef, ln as resolveOutboundTarget, lt as getCliSessionId, m as getAgentRuntimeCommandSecretTargetIds, ni as isInternalMessageChannel, o as buildAllowedModelSet, or as buildProviderRegistry, p as resolveThinkingDefault, pt as applyVerboseOverride, qt as deriveSessionTotalTokens, r as loadConfig, ri as normalizeMessageChannel, s as isCliProvider, sn as resolveAgentRoute, sr as createMediaAttachmentCache, ti as isGatewayMessageChannel, u as normalizeProviderId, un as resolveSessionDeliveryTarget, ur as runCapability, ut as setCliSessionId, vn as formatOutboundPayloadLog, vr as loadSessionStore, vt as resolveSendPolicy, wr as evaluateSessionFreshness, wt as prepareSessionManagerForRun, xr as updateSessionStore, yn as normalizeOutboundPayloads, z as formatMention, zt as emitAgentEvent } from "./discord-0dvSTuGz.js";
...
import { R as resolveStorePath, Tt as ensureAgentWorkspace, at as listAgentIds, dt as resolveAgentWorkspaceDir, ht as resolveSessionAgentId, pt as resolveEffectiveModelFallbacks, st as resolveAgentDir, ut as resolveAgentSkillsFilter } from "./query-expansion-BGMOt54G.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-DypNjFCT.js";
import "./paths-HD5MsNQn.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-Cgqh_G7v.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-D8okN3CJ.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CPtxbmY_.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-q_T-3ewX.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-DuVk21TP.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-DYI-pLnM.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-CseMLlBy.js");
