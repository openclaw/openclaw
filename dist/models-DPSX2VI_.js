import { A as theme, O as colorize, k as isRich$1 } from "./subsystem-DVwhOlEq.js";
import "./paths-BfR2LXbA.js";
import "./boolean-BHdNsbzF.js";
import { Av as DEFAULT_PROVIDER, B_ as hasUsableCustomProviderApiKey, Ct as openUrl, Dn as DEFAULT_OAUTH_WARN_MS, En as maskApiKey, F as resolveModelRefFromString, G_ as getShellEnvAppliedKeys, Gg as setRuntimeConfigSnapshot, H_ as resolveAwsSdkEnvVarName, Ii as loadProviderUsageSummary, Ir as runEmbeddedPiAgent, J as getModelsCommandSecretTargetIds, K_ as shouldEnableShellEnvFallback, M as resolveConfiguredModelRef, N as resolveDefaultModelForAgent, Ng as shouldSuppressBuiltInModel, O as normalizeProviderId, On as buildAuthHealthSummary, Pg as resolveOpenClawAgentDir, R as resolvePluginProviders, Rg as createConfigIO, Ri as formatUsageWindowSummary, T as modelKey, U_ as resolveEnvApiKey, Ug as readConfigFileSnapshotForWrite, Uv as resolveAuthProfileDisplayLabel, V_ as resolveApiKeyForProvider, W as withProgressTotals, W_ as resolveUsableCustomProviderApiKey, Z as resolveCommandSecretRefsViaGateway, b as buildModelAliasIndex, bf as discoverModels, d as setAuthProfileOrder, f as upsertAuthProfile, fo as describeFailoverError, gf as resolveModelWithRegistry, jg as loadModelCatalog, k as parseModelRef, kn as formatRemainingShort, kv as DEFAULT_MODEL, n as resolveAuthProfileOrder, p as ensureAuthProfileStore, r as resolveProfileUnusableUntilForDisplay, rh as resolveSecretRefString, t as resolveAuthProfileEligibility, u as listProfilesForProvider, v as resolveAuthStorePathForDisplay, x as findNormalizedProviderValue, yf as discoverAuthStorage, yv as isNonSecretApiKeyMarker, z_ as getCustomProviderApiKey, zg as loadConfig, zi as resolveUsageProviderId } from "./auth-profiles-CAw5gP6f.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-DBEC2O3x.js";
...
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-CQ90JO4F.js";
...
import { i as parseDurationMs } from "./search-manager-B1FsI6Ow.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-QMxjnO9x.js";
import "./session-cost-usage-6HYiRnfr.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-2BF77KhS.js";
import "./links-BpBLDDXV.js";
import "./provider-env-vars-DW9Ss6dw.js";
import "./note-8rWqI7pr.js";
import { t as createClackPrompter } from "./clack-prompter-CXacm0PY.js";
...
import { n as redactSecrets } from "./format-BUXoAL7q.js";
...
import { t as loginOpenAICodexOAuth } from "./openai-codex-oauth-BEsM_Kyw.js";
import { n as validateAnthropicSetupToken } from "./auth-token-DhmL38FQ.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-DiQk84Tx.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-CAw5gP6f.js").then((n) => n.Mg);
