...
import { A as theme, N as getResolvedLoggerSettings, O as colorize, k as isRich, p as defaultRuntime } from "./subsystem-DVwhOlEq.js";
import { d as resolveIsNixMode, g as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-BfR2LXbA.js";
import { Co as parseCmdScriptCommandLine, Dm as classifyPortListener, Dt as resolveControlUiLinks, Jp as GATEWAY_CLIENT_MODES, Mh as trimToUndefined, Om as formatPortDiagnostics, Rg as createConfigIO, U as withProgress, Vg as readBestEffortConfig, Yp as GATEWAY_CLIENT_NAMES, Zh as pickPrimaryTailnetIPv4, Zs as killProcessTree, jd as isRestartEnabled, ko as findGatewayPidsOnPortSync, lc as callGateway, mu as loadGatewayTlsRuntime, qh as resolveGatewayBindHost, wm as inspectPortUsage } from "./auth-profiles-CAw5gP6f.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { S as sleep, x as shortenHomePath } from "./utils-8QNki08A.js";
import { i as isWSLEnv } from "./fetch-ZNxqGXAR.js";
import { T as parseStrictPositiveInteger, g as resolveGatewaySystemdServiceName, p as resolveGatewayLaunchAgentLabel } from "./prompt-style-2BF77KhS.js";
import { t as formatDocsLink } from "./links-BpBLDDXV.js";
import { n as inheritOptionFromParent } from "./command-options-Ca7QaJTS.js";
import { t as formatConfigIssueLine } from "./issue-format-jHeRIpoa.js";
import { n as buildGatewayInstallPlan, t as resolveGatewayInstallToken } from "./gateway-install-token-BMkcI5P8.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-JtoqXmal.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-DuQVc30D.js";
import { c as resolveGatewayLogPaths, n as resolveGatewayService } from "./service-DB3y-xDN.js";
import { a as createCliStatusTextStyles, c as parsePortFromArgs, d as renderRuntimeHints, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, l as pickProbeHostForBind, m as buildDaemonServiceSnapshot, n as runServiceStart, o as filterDaemonEnv, p as safeDaemonEnv, r as runServiceStop, s as normalizeListenerAddress, t as runServiceRestart, u as renderGatewayServiceStartHints } from "./lifecycle-core-D7GxyKe5.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-B-g2-fu9.js";
import { t as parsePort } from "./parse-port-CS-89LRy.js";
import { n as resolveGatewayProbeAuthWithSecretInputs, r as probeGateway } from "./probe-auth-CQpCFrNo.js";
