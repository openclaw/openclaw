...
import { Jp as GATEWAY_CLIENT_MODES, Pv as listThinkingLevels, Yp as GATEWAY_CLIENT_NAMES, cc as buildGatewayConnectionDetails, hg as isKnownCoreToolId, xc as GatewayClient, zg as loadConfig, zt as resolveGatewayConnectionAuth } from "./auth-profiles-CAw5gP6f.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-kdDusy7Q.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-DW9Ss6dw.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-CjTbQr89.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-BoWvovsn.js");
