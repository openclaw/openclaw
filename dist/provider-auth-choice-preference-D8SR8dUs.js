...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CQCT2gkW.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-Bl0CDGQM.js");
