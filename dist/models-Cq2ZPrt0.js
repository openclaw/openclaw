...
import { h as theme, m as isRich$1, p as colorize } from "./globals-DqM7Q4km.js";
import { t as CONFIG_PATH } from "./paths-BMo6kTge.js";
import { Ai as DEFAULT_MODEL, Cr as resolveModelRefFromString, Gn as upsertAuthProfile, Hn as listProfilesForProvider, Jn as ensureAuthProfileStore, Mi as resolveAuthProfileDisplayLabel, Wn as setAuthProfileOrder, _r as parseModelRef, br as resolveConfiguredModelRef, ci as resolveApiKeyForProvider, cr as buildModelAliasIndex, er as resolveAuthStorePathForDisplay, fi as getShellEnvAppliedKeys, gr as normalizeProviderId, hi as shouldEnableShellEnvFallback, ji as DEFAULT_PROVIDER, l as resolveProfileUnusableUntilForDisplay, li as resolveAwsSdkEnvVarName, lr as findNormalizedProviderValue, n as resolveAuthProfileEligibility, oi as getCustomProviderApiKey, pr as modelKey, pt as parseDurationMs, r as resolveAuthProfileOrder, tr as resolveOpenClawAgentDir, ui as resolveEnvApiKey, xr as resolveDefaultModelForAgent, y as resolveSecretRefString, z as loadConfig } from "./auth-profiles-B1fxmUx1.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-BXg6mLAy.js";
import { x as shortenHomePath } from "./utils-xLjEf_5u.js";
import { A as coerceSecretRef, F as normalizeSecretInputString } from "./registry-DTmGzx3d.js";
import { r as resolveForwardCompatModel } from "./model-CGh7DugZ.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-BZkmUpaa.js";
import { An as resolveUsageProviderId, Dn as loadProviderUsageSummary, cn as DEFAULT_OAUTH_WARN_MS, jt as describeFailoverError, kn as formatUsageWindowSummary, ln as buildAuthHealthSummary, sn as maskApiKey, u as runEmbeddedPiAgent, un as formatRemainingShort } from "./subagent-registry-CDMg5a-5.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-DAWfoG1N.js";
import { t as ensureOpenClawModelsJson } from "./models-config-C-2ZW1iZ.js";
import { n as loadModelCatalog } from "./model-catalog-0rr7XVYY.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-BR6DP2Oq.js";
import { f as openUrl } from "./onboard-helpers-ZCuxYRVy.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DsMXeXF9.js";
import { r as withProgressTotals } from "./progress-CAPOQFI0.js";
import { t as createClackPrompter } from "./clack-prompter-C4KtlrU1.js";
import { t as renderTable } from "./table-D5wfII-S.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-ByB87mrj.js";
import { n as redactSecrets } from "./format-DgNK4_fI.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-D-SL_YdG.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BAJ-sJcf.js";
import { n as logConfigUpdated } from "./logging-rBFvUkzk.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-z0ltBYP7.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-B1fxmUx1.js").then((n) => n.t);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CGh7DugZ.js").then((n) => n.t);
