...
import { A as theme, O as colorize, k as isRich$1, p as defaultRuntime } from "./subsystem-DBBM_0ww.js";
import { S as shortenHomePath } from "./utils-JhJvOE-Q.js";
import { $ as resolveCommandSecretRefsViaGateway, $d as resolveModelWithRegistry, A as normalizeProviderId, Av as upsertAuthProfile, B as resolvePluginProviders, C as findNormalizedProviderValue, Cf as getCustomProviderApiKey, D as modelKey, D_ as setRuntimeConfigSnapshot, Df as resolveEnvApiKey, Ef as resolveAwsSdkEnvVarName, Et as openUrl, F as resolveDefaultModelForAgent, F_ as parseDurationMs, Gv as DEFAULT_MODEL, Iv as resolveAuthStorePathForDisplay, K as withProgressTotals, Kv as DEFAULT_PROVIDER, L as resolveModelRefFromString, Lv as resolveOpenClawAgentDir, Of as resolveUsableCustomProviderApiKey, Ov as listProfilesForProvider, P as resolveConfiguredModelRef, S as buildModelAliasIndex, Sf as shouldSuppressBuiltInModel, T_ as readConfigFileSnapshotForWrite, Tf as resolveApiKeyForProvider, Tv as shouldEnableShellEnvFallback, X as getModelsCommandSecretTargetIds, b_ as createConfigIO, bf as loadModelCatalog, bi as formatUsageWindowSummary, c as buildAuthHealthSummary, cp as resolveAuthProfileEligibility, e_ as resolveSecretRefString, j as parseModelRef, jv as ensureAuthProfileStore, kv as setAuthProfileOrder, l as formatRemainingShort, lp as resolveAuthProfileOrder, nf as discoverAuthStorage, o as maskApiKey, qa as describeFailoverError, rf as discoverModels, s as DEFAULT_OAUTH_WARN_MS, tp as isNonSecretApiKeyMarker, up as resolveProfileUnusableUntilForDisplay, vi as loadProviderUsageSummary, vr as runEmbeddedPiAgent, wf as hasUsableCustomProviderApiKey, wv as getShellEnvAppliedKeys, x_ as loadConfig, xi as resolveUsageProviderId, zv as resolveAuthProfileDisplayLabel } from "./reply-kqyKJg4x.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-BwZuo7sQ.js";
...
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-d7ZFrG7U.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-DMoIioWo.js";
import "./delivery-queue-DFrlUHFS.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DtZZPyOl.js";
...
import { t as inferParamBFromIdOrName } from "./model-param-b-CDcpSvHL.js";
import { n as redactSecrets } from "./format-BsbAlXon.js";
...
import { n as validateAnthropicSetupToken } from "./auth-token-B-zVa-6k.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-BCfhF9da.js");
	const { ensureOpenClawModelsJson } = await import("./reply-kqyKJg4x.js").then((n) => n.xf);
