import { G as FLAG_TERMINATOR, K as consumeRootOptionToken } from "./globals-DqM7Q4km.js";
import { g as resolveStateDir } from "./paths-BMo6kTge.js";
import { Ai as DEFAULT_MODEL, At as AVATAR_MAX_BYTES, It as isWorkspaceRelativeAvatarPath, Mt as isAvatarHttpUrl, Pt as isPathWithinRoot, Rt as resolveAvatarMime, _r as parseModelRef, br as resolveConfiguredModelRef, dr as inferUniqueProviderFromConfiguredModels, ji as DEFAULT_PROVIDER, jt as isAvatarDataUrl, ki as DEFAULT_CONTEXT_TOKENS, tr as resolveOpenClawAgentDir, xr as resolveDefaultModelForAgent, z as loadConfig } from "./auth-profiles-C39jSzPb.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-BXg6mLAy.js";
import { S as isCronRunSessionKey, T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey } from "./session-key-xF6i12F5.js";
import { a as openBoundaryFileSync } from "./openclaw-root-CUjRHZhy.js";
import { $ as resolveAgentMainSessionKey, C as normalizeSessionDeliveryFields, Q as canonicalizeMainSessionAlias, X as resolveFreshSessionTotalTokens, ct as buildGroupDisplayName, j as readSessionTitleFieldsFromTranscript, o as loadSessionStore, tt as resolveMainSessionKey } from "./sessions-Bx1XJLag.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-CtphyBYI.js").then((n) => n.r);
