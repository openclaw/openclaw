...
import { G as writeConfigFile, V as readConfigFileSnapshot, ct as resolveDefaultSecretProviderAlias } from "./auth-profiles-B1fxmUx1.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-ZCuxYRVy.js";
...
import { t as runOnboardingWizard } from "./onboarding-BEnwkNVk.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BGZTzS_v.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-MP_jbZDX.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CT6VD-M9.js").then((n) => n.i);
