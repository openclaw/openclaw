...
import { h as theme, m as isRich$1, p as colorize } from "./globals-DBA9iEt5.js";
import { S as shortenHomePath } from "./utils-BgHhhQlR.js";
import "./thinking-44rmAw5o.js";
import { Gt as describeFailoverError, a as buildAuthHealthSummary, bt as formatUsageWindowSummary, f as runEmbeddedPiAgent, i as DEFAULT_OAUTH_WARN_MS, o as formatRemainingShort, r as maskApiKey, vt as loadProviderUsageSummary, xt as resolveUsageProviderId } from "./reply-D7sIhxL4.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-DcOd8osz.js";
...
import { $t as loadConfig, Ct as resolveProfileUnusableUntilForDisplay, Dn as parseDurationMs, Ei as resolveAuthProfileDisplayLabel, Ii as DEFAULT_MODEL, Li as DEFAULT_PROVIDER, Nt as resolveSecretRefString, _t as resolveAuthProfileOrder, at as resolveEnvApiKey, bi as resolveAuthStorePathForDisplay, c as modelKey, ci as listProfilesForProvider, d as normalizeProviderId, di as upsertAuthProfile, ei as getShellEnvAppliedKeys, f as parseModelRef, g as resolveDefaultModelForAgent, gt as resolveAuthProfileEligibility, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, it as resolveAwsSdkEnvVarName, mi as ensureAuthProfileStore, r as buildModelAliasIndex, ri as shouldEnableShellEnvFallback, rt as resolveApiKeyForProvider, tt as getCustomProviderApiKey, ui as setAuthProfileOrder, v as resolveModelRefFromString, xi as resolveOpenClawAgentDir } from "./model-selection-Dmiyt9yA.js";
import { A as coerceSecretRef, F as normalizeSecretInputString } from "./registry-DBb6KIXY.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-Bbnk2V2w.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-J0EFKbLQ.js";
...
import { r as resolveForwardCompatModel } from "./model-BI5hxfGH.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-CpHvX-8c.js";
import "./session-cost-usage-B8HS2Edq.js";
import { f as openUrl } from "./onboard-helpers-wSGCHqx6.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-D84-8NYI.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-CbnnSB38.js";
import "./help-format-CHibOmDT.js";
import { r as withProgressTotals } from "./progress-DLnu8mDe.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-Dmiyt9yA.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BI5hxfGH.js").then((n) => n.t);
