...
import { an as writeConfigFile, tn as readConfigFileSnapshot } from "./model-selection-Dmiyt9yA.js";
import { F as normalizeSecretInputString } from "./registry-DBb6KIXY.js";
import { t as formatCliCommand } from "./command-format-DgBEhw5P.js";
import { t as WizardCancelledError } from "./prompts-OFJRqDDg.js";
import { t as resolveOnboardingSecretInputString } from "./onboarding.secret-input-Bf1-4KmZ.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-wSGCHqx6.js").then((n) => n.d);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-DZgmu3Vm.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-B-Y-xxir.js").then((n) => n.r);
	...
	const { applyOnboardingLocalWorkspaceConfig } = await import("./onboard-config-QD4m66NV.js").then((n) => n.n);
	...
	const { promptCustomApiConfig } = await import("./onboard-custom-CqxeMgaz.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-BSNZ1BL3.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-DgZN2Bvn.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-AMIvKjKa.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-CVNXMV8f.js").then((n) => n.i);
		const { setupChannels } = await import("./onboard-channels-Cufn8JSG.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-DaNatZ9j.js").then((n) => n.t);
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-CBY2efpS.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-C5mj-Zk0.js");
