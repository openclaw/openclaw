...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-DIRzXd2H.js";
import "./channel-api-BjhhWmxI.js";
import { t as parseDiscordTarget } from "./target-parsing-D1FhMbX6.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CyNVJMI-.js";
...
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-Dzw3PcHj.js";
import { t as getDiscordApprovalCapability } from "./approval-native-CVNLZRH8.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-Bc_AQBhP.js";
import { t as discordMessageActions$1 } from "./channel-actions-DKJ3xIF3.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-DGBQNoPw.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-_9DIWMBI.js";
import { n as discordOutbound } from "./outbound-adapter-Bw8wq78A.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-DeIHngQV.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-B6haRZDX.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BPIDo9UM.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-snlwJSHc.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DIDWHHFy.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-jS_dIeCz.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-DkLnZ3fp.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-TEpS2mN3.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-WzTjb3Dd.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-ug-iTBRu.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DGKHluTZ.js");
