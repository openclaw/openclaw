...
import { p as resolveUserPath, s as ensureDir } from "./utils-sBTEdeml.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-ChIGfmtH.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-DNWaCF9M.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-DpPnXR38.js");
