...
import { Gt as describeFailoverError, a as buildAuthHealthSummary, bt as formatUsageWindowSummary, f as runEmbeddedPiAgent, i as DEFAULT_OAUTH_WARN_MS, o as formatRemainingShort, r as maskApiKey, vt as loadProviderUsageSummary, xt as resolveUsageProviderId } from "./reply-CtQMdhNT.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-D6yWFKHl.js";
...
import { r as resolveForwardCompatModel } from "./model-DaYWTFLZ.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-OLgKF2ja.js";
import "./session-cost-usage-B8HS2Edq.js";
import { f as openUrl } from "./onboard-helpers-DkoVky3L.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-CdcCUa9n.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CzT3VJDi.js";
import { n as logConfigUpdated } from "./logging-B-Y-xxir.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-ViEXexki.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-COYmqEoi.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-DaYWTFLZ.js").then((n) => n.t);
