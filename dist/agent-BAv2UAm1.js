import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-DBBM_0ww.js";
import { $ as resolveCommandSecretRefsViaGateway, $p as resolveChannelResetConfig, $r as resolveAgentTimeoutMs, A as normalizeProviderId, Ad as isSilentReplyText, Bi as normalizeReplyPayload, Ca as buildOutboundSessionContext, Cm as isGatewayMessageChannel, D as modelKey, D_ as setRuntimeConfigSnapshot, Da as normalizeOutboundPayloads, Dm as resolveMessageChannel, Ea as formatOutboundPayloadLog, Em as normalizeMessageChannel, Er as resolveBootstrapWarningSignaturesSeen, F as resolveDefaultModelForAgent, Fi as resolveContextTokensForModel, Ga as runWithModelFallback, Gv as DEFAULT_MODEL, Ha as resolveMessageChannelSelection, Ip as normalizeAccountId, J as getAgentRuntimeCommandSecretTargetIds, Jv as formatXHighModelHint, Ka as FailoverError, Kt as getRemoteSkillEligibility, Kv as DEFAULT_PROVIDER, Nu as clearBootstrapSnapshotOnSessionRollover, O as normalizeModelRef, Oa as normalizeOutboundPayloadsForJson, Op as updateSessionStore, P as resolveConfiguredModelRef, Qp as evaluateSessionFreshness, Sp as emitSessionTranscriptUpdate, T as isCliProvider, T_ as readConfigFileSnapshotForWrite, Zp as resolveSessionKey, _i as applyModelOverrideToSessionEntry, a as runCliAgent, ad as getAcpSessionManager, bf as loadModelCatalog, bm as INTERNAL_MESSAGE_CHANNEL, ci as resolveAcpSessionCwd, dr as resolveSendPolicy, ei as formatAgentInternalEventsForPrompt, em as resolveSessionResetPolicy, ey as normalizeThinkLevel, fn as getSkillsSnapshotVersion, ha as resolveSessionDeliveryTarget, i as setCliSessionId, ii as emitAgentEvent, im as setSessionRuntimeModel, iy as supportsXHighThinking, jv as ensureAuthProfileStore, kd as isSilentReplyPrefixText, li as resolveAcpAgentPolicyError, ma as resolveOutboundTarget, mi as AGENT_LANE_SUBAGENT, mn as clearSessionAuthProfileOverride, nm as mergeSessionEntry, ny as normalizeVerboseLevel, od as toAcpRuntimeError, pi as AGENT_LANE_NESTED, qv as formatThinkingLevels, r as getCliSessionId, ri as clearAgentRunContext, si as registerAgentRunContext, sm as resolveExplicitAgentSessionKey, ti as normalizeSpawnedRunMetadata, tm as resolveSessionResetType, u as applyVerboseOverride, ui as resolveAcpDispatchPolicyError, vr as runEmbeddedPiAgent, wa as deliverOutboundPayloads, wm as isInternalMessageChannel, wp as loadSessionStore, x as buildAllowedModelSet, x_ as loadConfig, xm as isDeliverableMessageChannel, yp as resolveSessionTranscriptFile, yr as prepareSessionManagerForRun, z as resolveThinkingDefault } from "./reply-kqyKJg4x.js";
import { D as ensureAgentWorkspace, a as resolveAgentDir, d as resolveAgentWorkspaceDir, h as resolveSessionAgentId, p as resolveEffectiveModelFallbacks, r as listAgentIds, u as resolveAgentSkillsFilter } from "./agent-scope-BwZuo7sQ.js";
import { c as normalizeAgentId, l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-DjKQluAa.js";
import { t as formatCliCommand } from "./command-format-p_4ya3m0.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-3AC6GJLt.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-By9GTgrF.js";
import { l as resolveStorePath } from "./paths-DtZZPyOl.js";
import { d as deriveSessionTotalTokens, f as hasNonzeroUsage } from "./session-cost-usage-CUa3Yrhb.js";
import { t as createDefaultDeps } from "./deps-BPwXTRXn.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-DQc5cCo0.js";
