import { v as getResolvedLoggerSettings } from "./globals-DqM7Q4km.js";
...
import { Ai as DEFAULT_MODEL, Bn as repairOAuthProfileIdMismatch, Fi as CODEX_CLI_PROFILE_ID, G as writeConfigFile, Jn as ensureAuthProfileStore, Pi as CLAUDE_CLI_PROFILE_ID, Qn as updateAuthProfileStoreWithLock, Sr as resolveHooksGmailModel, V as readConfigFileSnapshot, br as resolveConfiguredModelRef, ci as resolveApiKeyForProvider, d as resolveApiKeyForProfile, ji as DEFAULT_PROVIDER, l as resolveProfileUnusableUntilForDisplay, lt as secretRefKey, ur as getModelRefStatus, x as resolveSecretRefValues } from "./auth-profiles-B1fxmUx1.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-BXg6mLAy.js";
import { T as parseAgentSessionKey } from "./session-key-xF6i12F5.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-xLjEf_5u.js";
...
import { B as cleanStaleLockFiles, o as loadSessionStore, ot as formatSessionArchiveTimestamp, st as isPrimarySessionTranscriptFileName, tt as resolveMainSessionKey } from "./sessions-DMhNgXSz.js";
import { n as listChannelPlugins } from "./plugins-D8yPNTgi.js";
import { Mn as buildBootstrapInjectionStats, b as loadOpenClawPlugins, cn as DEFAULT_OAUTH_WARN_MS, jn as analyzeBootstrapBudget, ln as buildAuthHealthSummary, un as formatRemainingShort, vr as resolveAgentSessionDirs, wr as resolveBootstrapContextForRun } from "./subagent-registry-CDMg5a-5.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-DAWfoG1N.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-NWndvBdo.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-B5SHg7yf.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-DW_Mx1OF.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-CKkFP0hZ.js";
import { a as resolveGatewayAuth } from "./auth-DoPoYVpx.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-Df6weHId.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-fzkwfwGz.js";
import { n as loadModelCatalog } from "./model-catalog-0rr7XVYY.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-XOgWWHqE.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-CcDUyobo.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-C97w_jhw.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-ZCuxYRVy.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DsMXeXF9.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-0jUpjzpy.js";
import { n as DEFAULT_LOCAL_MODEL, r as resolveMemorySearchConfig } from "./manager-BsdWDVhv.js";
import { t as note$1 } from "./note-BO75rWvI.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-6r_WSDdl.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-BbZ00hfq.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CvZJNtQh.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-BJy9jaA5.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-Fh_FUMvn.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-CADNuKgs.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-DzKD74fc.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-CnK4ms19.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-Cbl1yrjA.js";
import { r as healthCommand } from "./health-CT6VD-M9.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-Q00r4Ix7.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CHy8qtgZ.js";
import { t as runGatewayUpdate } from "./update-runner-BA1ajhJ8.js";
import { n as logConfigUpdated } from "./logging-rBFvUkzk.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-D7MFv5Ms.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-Cg7wB7ry.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BsszvNAq.js";
import { t as formatHealthCheckFailure } from "./health-format-BetMIbuy.js";
import { n as doctorShellCompletion } from "./doctor-completion-DhTEFgHD.js";
