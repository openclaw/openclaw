...
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-c_g9oPLx.js";
import { $n as emitSessionTranscriptUpdate, $r as loadConfig, $t as normalizeOutboundPayloadsForJson, An as isSilentReplyPrefixText, B as clearSessionAuthProfileOverride, Bn as parseTtsDirectives, Cr as isInternalMessageChannel, Ct as AGENT_LANE_SUBAGENT, Dt as resolveContextTokensForModel, Et as hasNonzeroUsage, Fi as formatCliCommand, Ht as resolveSessionDeliveryTarget, J as getSkillsSnapshotVersion, Jn as normalizeMediaAttachments, Kn as buildProviderRegistry, L as getCliSessionId, Qn as resolveSessionTranscriptFile, Qr as loadModelCatalog, Qt as normalizeOutboundPayloads, R as setCliSessionId, Rn as resolveTtsConfig, Sr as isGatewayMessageChannel, St as AGENT_LANE_NESTED, Tr as resolveMessageChannel, Tt as deriveSessionTotalTokens, U as formatMention, Ut as resolveDiscordOwnerAccess, V as applyVerboseOverride, Vt as resolveOutboundTarget, Wt as formatDiscordUserTag, X as resolveSendPolicy, Xn as runCapability, Xt as deliverOutboundPayloads, Yr as formatErrorMessage, Yt as buildOutboundSessionContext, Zt as formatOutboundPayloadLog, _t as emitAgentEvent, a as normalizeModelRef, ai as DEFAULT_MODEL, ar as resolveSessionKey, b as isDangerousNameMatchingEnabled, br as INTERNAL_MESSAGE_CHANNEL, bt as resolveAcpAgentPolicyError, c as resolveDefaultModelForAgent, ci as formatXHighModelHint, cr as resolveSessionResetPolicy, d as resolveCommandSecretRefsViaGateway, di as supportsXHighThinking, dr as setSessionRuntimeModel, ei as readConfigFileSnapshotForWrite, er as loadSessionStore, fr as resolveExplicitAgentSessionKey, gt as clearAgentRunContext, hn as toAcpRuntimeError, ht as normalizeSpawnedRunMetadata, i as modelKey, in as runWithModelFallback, ir as normalizeAccountId, jn as isSilentReplyText, jt as normalizeReplyPayload, l as resolveThinkingDefault, li as normalizeThinkLevel, ln as clearBootstrapSnapshotOnSessionRollover, lr as resolveSessionResetType, mn as getAcpSessionManager, mr as normalizeChannelId, mt as formatAgentInternalEventsForPrompt, n as buildAllowedModelSet, nn as resolveMessageChannelSelection, nt as prepareSessionManagerForRun, o as normalizeProviderId, oi as DEFAULT_PROVIDER, on as FailoverError, or as evaluateSessionFreshness, pr as getChannelPlugin, pt as resolveAgentTimeoutMs, q as getRemoteSkillEligibility, qn as createMediaAttachmentCache, qr as buildWorkspaceSkillSnapshot, r as isCliProvider, rr as updateSessionStore, rt as resolveBootstrapWarningSignaturesSeen, s as resolveConfiguredModelRef, si as formatThinkingLevels, sr as resolveChannelResetConfig, t as ensureAuthProfileStore, ti as setRuntimeConfigSnapshot, tt as runEmbeddedPiAgent, u as getAgentRuntimeCommandSecretTargetIds, ui as normalizeVerboseLevel, ur as mergeSessionEntry, vt as registerAgentRunContext, wr as normalizeMessageChannel, wt as applyModelOverrideToSessionEntry, xr as isDeliverableMessageChannel, xt as resolveAcpDispatchPolicyError, yt as resolveAcpSessionCwd, z as runCliAgent, zn as textToSpeech, zt as resolveAgentRoute } from "./model-auth-BEcD8An6.js";
import "./paths-Dmn791zP.js";
import { B as shouldLogVerbose, R as logVerbose, Z as resolvePreferredOpenClawTmpDir, a as createSubsystemLogger, s as defaultRuntime } from "./logger-BkFMk2O9.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-DSnBsVg9.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CfsDLsef.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-D3xAUqmK.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BNR-8ztp.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-ndAQNOGo.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DozRBBAK.js");
