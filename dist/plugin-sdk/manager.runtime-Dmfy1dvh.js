...
import { At as resolveSessionAgentId, Bt as ensureAgentWorkspace, Et as resolveAgentWorkspaceDir, Ot as resolveEffectiveModelFallbacks, R as resolveStorePath, Sn as resolveAgentIdFromSessionKey, St as resolveAgentDir, Tt as resolveAgentSkillsFilter, bn as normalizeAgentId, bt as listAgentIds, xn as normalizeMainKey } from "./query-expansion-5GTLCC48.js";
import { $a as resolveExplicitAgentSessionKey, $n as applyModelOverrideToSessionEntry, A as buildAllowedModelSet, Ac as formatErrorMessage, An as runEmbeddedPiAgent, Ar as resolveOutboundTarget, Ba as emitSessionTranscriptUpdate, F as resolveConfiguredModelRef, Fr as formatDiscordUserTag, Ga as normalizeAccountId, Gn as clearAgentRunContext, Gt as formatMention, Hn as resolveAgentTimeoutMs, I as resolveDefaultModelForAgent, Ja as resolveChannelResetConfig, Ji as isSilentReplyText, Jn as resolveAcpSessionCwd, Jr as buildOutboundSessionContext, Ka as resolveSessionKey, Kn as emitAgentEvent, L as resolveThinkingDefault, M as modelKey, Mn as resolveBootstrapWarningSignaturesSeen, N as normalizeModelRef, Oa as loadModelCatalog, P as normalizeProviderId, Pr as resolveDiscordOwnerAccess, Qa as setSessionRuntimeModel, Qn as AGENT_LANE_SUBAGENT, Qr as normalizeOutboundPayloadsForJson, R as getAgentRuntimeCommandSecretTargetIds, Si as getAcpSessionManager, Tn as resolveSendPolicy, Un as formatAgentInternalEventsForPrompt, Va as loadSessionStore, Vc as buildWorkspaceSkillSnapshot, Wa as updateSessionStore, Wn as normalizeSpawnedRunMetadata, Xa as resolveSessionResetType, Xn as resolveAcpDispatchPolicyError, Xr as formatOutboundPayloadLog, Ya as resolveSessionResetPolicy, Yn as resolveAcpAgentPolicyError, Yr as deliverOutboundPayloads, Za as mergeSessionEntry, Zn as AGENT_LANE_NESTED, Zr as normalizeOutboundPayloads, _a as createMediaAttachmentCache, _l as DEFAULT_PROVIDER, a as readConfigFileSnapshotForWrite, aa as parseTtsDirectives, ac as isDeliverableMessageChannel, ai as runWithModelFallback, ba as runCapability, br as resolveAgentRoute, cc as normalizeMessageChannel, cn as setCliSessionId, dl as formatXHighModelHint, dn as applyVerboseOverride, el as ensureAuthProfileStore, eo as getChannelPlugin, er as deriveSessionTotalTokens, fi as clearBootstrapSnapshotOnSessionRollover, fl as normalizeThinkLevel, ga as buildProviderRegistry, gl as DEFAULT_MODEL, gt as isDangerousNameMatchingEnabled, i as loadConfig, ia as textToSpeech, ic as INTERNAL_MESSAGE_CHANNEL, j as isCliProvider, ji as toAcpRuntimeError, jn as prepareSessionManagerForRun, jr as resolveSessionDeliveryTarget, lc as resolveMessageChannel, ln as runCliAgent, ml as supportsXHighThinking, nr as resolveContextTokensForModel, o as setRuntimeConfigSnapshot, oc as isGatewayMessageChannel, oi as FailoverError, pl as normalizeVerboseLevel, pn as getRemoteSkillEligibility, qa as evaluateSessionFreshness, qi as isSilentReplyPrefixText, qn as registerAgentRunContext, ra as resolveTtsConfig, ri as resolveMessageChannelSelection, rl as formatCliCommand, sc as isInternalMessageChannel, sn as getCliSessionId, sr as normalizeReplyPayload, to as normalizeChannelId, tr as hasNonzeroUsage, ul as formatThinkingLevels, un as clearSessionAuthProfileOverride, va as normalizeMediaAttachments, xn as getSkillsSnapshotVersion, z as resolveCommandSecretRefsViaGateway, za as resolveSessionTranscriptFile } from "./thread-bindings-ByGU3ehz.js";
import "./paths-DBpXUsXY.js";
import { B as shouldLogVerbose, Q as resolvePreferredOpenClawTmpDir, R as logVerbose, a as createSubsystemLogger, l as defaultRuntime } from "./logger-DarMZ-03.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-CXoSxidH.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-DZFR_6Nb.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-BBxduiBb.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-2dcTByI8.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-DZbB60Bb.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-B_x_3r2r.js");
