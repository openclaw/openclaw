...
import { $t as deliverOutboundPayloads, B as setCliSessionId, Bn as resolveTtsConfig, Br as isInternalMessageChannel, Ci as DEFAULT_MODEL, Ct as resolveAcpDispatchPolicyError, Di as normalizeThinkLevel, Dt as deriveSessionTotalTokens, Ei as formatXHighModelHint, Et as applyModelOverrideToSessionEntry, G as formatMention, Gt as resolveDiscordOwnerAccess, H as clearSessionAuthProfileOverride, Hn as parseTtsDirectives, Hr as resolveMessageChannel, Jn as buildProviderRegistry, Kt as formatDiscordUserTag, Lr as INTERNAL_MESSAGE_CHANNEL, Nn as isSilentReplyPrefixText, Nt as normalizeReplyPayload, Oi as normalizeVerboseLevel, Ot as hasNonzeroUsage, Pn as isSilentReplyText, Q as resolveSendPolicy, Qn as runCapability, Qt as buildOutboundSessionContext, Rr as isDeliverableMessageChannel, S as isDangerousNameMatchingEnabled, St as resolveAcpAgentPolicyError, Ti as formatThinkingLevels, Tt as AGENT_LANE_SUBAGENT, U as applyVerboseOverride, Ut as resolveOutboundTarget, V as runCliAgent, Vn as textToSpeech, Vr as normalizeMessageChannel, Vt as resolveAgentRoute, Wt as resolveSessionDeliveryTarget, X as getSkillsSnapshotVersion, Xn as normalizeMediaAttachments, Y as getRemoteSkillEligibility, Yn as createMediaAttachmentCache, _i as readConfigFileSnapshotForWrite, _n as getAcpSessionManager, _t as normalizeSpawnedRunMetadata, a as normalizeModelRef, an as resolveMessageChannelSelection, ar as updateSessionStore, at as resolveBootstrapWarningSignaturesSeen, bt as registerAgentRunContext, c as resolveDefaultModelForAgent, cr as evaluateSessionFreshness, d as resolveCommandSecretRefsViaGateway, dr as resolveSessionResetType, en as formatOutboundPayloadLog, er as resolveSessionTranscriptFile, fi as formatErrorMessage, fn as clearBootstrapSnapshotOnSessionRollover, fr as mergeSessionEntry, gi as loadConfig, gr as normalizeChannelId, gt as formatAgentInternalEventsForPrompt, hi as loadModelCatalog, hr as getChannelPlugin, ht as resolveAgentTimeoutMs, i as modelKey, it as prepareSessionManagerForRun, ji as formatCliCommand, ki as supportsXHighThinking, kt as resolveContextTokensForModel, l as resolveThinkingDefault, ln as FailoverError, lr as resolveChannelResetConfig, mr as resolveExplicitAgentSessionKey, n as buildAllowedModelSet, nn as normalizeOutboundPayloadsForJson, nr as loadSessionStore, o as normalizeProviderId, or as normalizeAccountId, pr as setSessionRuntimeModel, r as isCliProvider, rt as runEmbeddedPiAgent, s as resolveConfiguredModelRef, sn as runWithModelFallback, sr as resolveSessionKey, t as ensureAuthProfileStore, tn as normalizeOutboundPayloads, tr as emitSessionTranscriptUpdate, u as getAgentRuntimeCommandSecretTargetIds, ui as buildWorkspaceSkillSnapshot, ur as resolveSessionResetPolicy, vi as setRuntimeConfigSnapshot, vn as toAcpRuntimeError, vt as clearAgentRunContext, wi as DEFAULT_PROVIDER, wt as AGENT_LANE_NESTED, xt as resolveAcpSessionCwd, yt as emitAgentEvent, z as getCliSessionId, zr as isGatewayMessageChannel } from "./model-auth-D7JEj3Kz.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-CRFf3IbF.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-Bgnp8zIJ.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-EOhootP_.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-DXglwZyw.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-BVLPb_Gq.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BcvDXoDv.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-DPSONomt.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-CmXPlxHO.js");
