...
export declare function resolveSreAgentExecutionRole(_config: OpenClawConfig | undefined, agentId: string | undefined): SreAgentExecutionRole | undefined;
export declare function wrapToolWithOwnedPathPolicy(params: {
    tool: AnyAgentTool;
    agentId?: string;
