import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-DHFRtnak.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-MKyEVmEb.js";
import { H as parseDurationMs, Kr as resolveSecretInputRef, Mr as getProcessStartTime, Nr as isPidAlive, Pr as formatCliCommand, U as parseByteSize, V as getBlockedNetworkModeReason, Vr as hasConfiguredSecretInput, _t as CHANNEL_IDS, br as secretRefKey, jr as resolveProcessScopedMap, n as loadConfig, ni as parseBooleanValue, o as writeConfigFile, pr as resolveSecretRefValues, t as createConfigIO } from "./config-CLyNhGJB.js";
import { E as resolveUserPath, L as isDevMode, N as truncateUtf16Safe, S as normalizeE164, a as createSubsystemLogger, c as defaultRuntime } from "./logger-Dv6Sz3FH.js";
import { J as normalizeHyphenSlug, d as getChannelDock, o as normalizeThinkLevel } from "./thinking-CZvBic9o.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-BtAdsAjC.js";
import { G as normalizeChatType, r as normalizeChannelId } from "./plugins-C0IHUoNk.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BYsZgUsy.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Bfw4LEdI.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-Bfw4LEdI.js")).closePlaywrightBrowserConnection();
	} catch {}
}
