...
import { $t as normalizeAgentId, R as resolveStorePath, Tt as ensureAgentWorkspace, at as listAgentIds, dt as resolveAgentWorkspaceDir, en as normalizeMainKey, ht as resolveSessionAgentId, pt as resolveEffectiveModelFallbacks, st as resolveAgentDir, tn as resolveAgentIdFromSessionKey, ut as resolveAgentSkillsFilter } from "./query-expansion-DoSmaYz3.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./utils-DbcH71uP.js";
import "./paths-Dmn791zP.js";
import { $n as runCapability, Ai as formatXHighModelHint, At as AGENT_LANE_SUBAGENT, Ci as readConfigFileSnapshotForWrite, Cn as toAcpRuntimeError, Ct as clearAgentRunContext, Di as DEFAULT_MODEL, Dt as resolveAcpAgentPolicyError, Et as resolveAcpSessionCwd, Fi as formatCliCommand, G as setCliSessionId, Gr as normalizeMessageChannel, Hn as textToSpeech, Hr as isDeliverableMessageChannel, J as applyVerboseOverride, K as runCliAgent, Kr as resolveMessageChannel, Mi as normalizeVerboseLevel, Mt as deriveSessionTotalTokens, Ni as supportsXHighThinking, Nn as isSilentReplyPrefixText, Nt as hasNonzeroUsage, Oi as DEFAULT_PROVIDER, Ot as resolveAcpDispatchPolicyError, Pn as isSilentReplyText, Pt as resolveContextTokensForModel, Qt as formatDiscordUserTag, Si as loadConfig, Sn as getAcpSessionManager, St as normalizeSpawnedRunMetadata, T as isDangerousNameMatchingEnabled, Tt as registerAgentRunContext, Un as parseTtsDirectives, Ur as isGatewayMessageChannel, Vn as resolveTtsConfig, Vr as INTERNAL_MESSAGE_CHANNEL, W as getCliSessionId, Wr as isInternalMessageChannel, X as formatMention, Xn as createMediaAttachmentCache, Xt as resolveSessionDeliveryTarget, Yn as buildProviderRegistry, Yt as resolveOutboundTarget, Zn as normalizeMediaAttachments, Zt as resolveDiscordOwnerAccess, _n as clearBootstrapSnapshotOnSessionRollover, _r as normalizeChannelId, a as normalizeModelRef, an as formatOutboundPayloadLog, bt as resolveAgentTimeoutMs, c as resolveDefaultModelForAgent, cr as resolveSessionKey, ct as runEmbeddedPiAgent, d as resolveCommandSecretRefsViaGateway, dr as resolveSessionResetPolicy, et as getRemoteSkillEligibility, fn as runWithModelFallback, fr as resolveSessionResetType, gr as getChannelPlugin, hr as resolveExplicitAgentSessionKey, i as modelKey, in as deliverOutboundPayloads, ji as normalizeThinkLevel, jt as applyModelOverrideToSessionEntry, ki as formatThinkingLevels, kt as AGENT_LANE_NESTED, l as resolveThinkingDefault, lr as evaluateSessionFreshness, lt as prepareSessionManagerForRun, mi as buildWorkspaceSkillSnapshot, mn as FailoverError, mr as setSessionRuntimeModel, n as buildAllowedModelSet, nr as emitSessionTranscriptUpdate, o as normalizeProviderId, on as normalizeOutboundPayloads, or as updateSessionStore, pr as mergeSessionEntry, q as clearSessionAuthProfileOverride, qt as resolveAgentRoute, r as isCliProvider, rn as buildOutboundSessionContext, rr as loadSessionStore, rt as resolveSendPolicy, s as resolveConfiguredModelRef, sn as normalizeOutboundPayloadsForJson, sr as normalizeAccountId, t as ensureAuthProfileStore, tr as resolveSessionTranscriptFile, tt as getSkillsSnapshotVersion, u as getAgentRuntimeCommandSecretTargetIds, un as resolveMessageChannelSelection, ur as resolveChannelResetConfig, ut as resolveBootstrapWarningSignaturesSeen, vi as formatErrorMessage, wi as setRuntimeConfigSnapshot, wt as emitAgentEvent, xi as loadModelCatalog, xt as formatAgentInternalEventsForPrompt, zt as normalizeReplyPayload } from "./model-auth-0V_-Dcft.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-w4PC8hU4.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CBZeHo0a.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-ClaY7qVk.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-DPeJsVLg.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-YkbI5rhs.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-RQv6fLvc.js");
