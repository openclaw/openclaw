...
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-DD_kv3mg.js";
import "./paths-DinMprTu.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-D0gLTTm5.js";
import { $ as resolveSendPolicy, $n as normalizeMediaAttachments, $r as formatErrorMessage, B as getCliSessionId, Ci as getChannelPlugin, Cr as isInternalMessageChannel, Ct as AGENT_LANE_NESTED, Dt as hasNonzeroUsage, Et as deriveSessionTotalTokens, Gn as parseTtsDirectives, H as runCliAgent, In as isSilentReplyPrefixText, Jt as resolveDiscordOwnerAccess, K as formatMention, Ki as formatCliCommand, Kt as resolveOutboundTarget, Ln as isSilentReplyText, Nt as normalizeReplyPayload, Ot as resolveContextTokensForModel, Qn as createMediaAttachmentCache, Sr as isGatewayMessageChannel, St as resolveAcpDispatchPolicyError, Tr as resolveMessageChannel, Tt as applyModelOverrideToSessionEntry, U as clearSessionAuthProfileOverride, Un as resolveTtsConfig, V as setCliSessionId, W as applyVerboseOverride, Wn as textToSpeech, Wt as resolveAgentRoute, X as getRemoteSkillEligibility, Yt as formatDiscordUserTag, Z as getSkillsSnapshotVersion, Zn as buildProviderRegistry, _r as resolveExplicitAgentSessionKey, _t as clearAgentRunContext, a as normalizeModelRef, ai as setRuntimeConfigSnapshot, an as normalizeOutboundPayloadsForJson, ar as loadSessionStore, bn as getAcpSessionManager, br as INTERNAL_MESSAGE_CHANNEL, bt as resolveAcpSessionCwd, c as resolveDefaultModelForAgent, ci as DEFAULT_MODEL, cn as resolveMessageChannelSelection, cr as updateSessionStore, d as resolveCommandSecretRefsViaGateway, di as formatXHighModelHint, dr as evaluateSessionFreshness, fi as normalizeThinkLevel, fn as FailoverError, fr as resolveChannelResetConfig, gr as setSessionRuntimeModel, gt as normalizeSpawnedRunMetadata, hn as clearBootstrapSnapshotOnSessionRollover, hr as mergeSessionEntry, ht as formatAgentInternalEventsForPrompt, i as modelKey, ii as readConfigFileSnapshotForWrite, in as normalizeOutboundPayloads, ir as emitSessionTranscriptUpdate, it as resolveBootstrapWarningSignaturesSeen, l as resolveThinkingDefault, li as DEFAULT_PROVIDER, lr as normalizeAccountId, mi as supportsXHighThinking, mr as resolveSessionResetType, mt as resolveAgentTimeoutMs, n as buildAllowedModelSet, ni as loadModelCatalog, nn as deliverOutboundPayloads, nt as runEmbeddedPiAgent, o as normalizeProviderId, pi as normalizeVerboseLevel, pr as resolveSessionResetPolicy, qr as buildWorkspaceSkillSnapshot, qt as resolveSessionDeliveryTarget, r as isCliProvider, ri as loadConfig, rn as formatOutboundPayloadLog, rr as resolveSessionTranscriptFile, rt as prepareSessionManagerForRun, s as resolveConfiguredModelRef, t as ensureAuthProfileStore, tn as buildOutboundSessionContext, tr as runCapability, u as getAgentRuntimeCommandSecretTargetIds, ui as formatThinkingLevels, un as runWithModelFallback, ur as resolveSessionKey, vt as emitAgentEvent, w as isDangerousNameMatchingEnabled, wi as normalizeChannelId, wr as normalizeMessageChannel, wt as AGENT_LANE_SUBAGENT, xn as toAcpRuntimeError, xr as isDeliverableMessageChannel, xt as resolveAcpAgentPolicyError, yt as registerAgentRunContext } from "./model-auth-BbMK0fKe.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BsYMvLlK.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-Di3DH_H9.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-DT2cu_vj.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-D5lLbaCM.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-CnDwDLzi.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BZjABDA4.js");
