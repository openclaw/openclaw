...
import { Bt as ensureAgentWorkspace, Et as resolveSessionAgentId, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-D0gbMLFj.js";
import { $ as getSkillsSnapshotVersion, $r as formatXHighModelHint, $t as normalizeOutboundPayloads, At as deriveSessionTotalTokens, Bn as parseTtsDirectives, Cr as isGatewayMessageChannel, Ct as registerAgentRunContext, Dt as AGENT_LANE_NESTED, E as isDangerousNameMatchingEnabled, Er as resolveMessageChannel, Et as resolveAcpDispatchPolicyError, G as clearSessionAuthProfileOverride, H as getCliSessionId, Hi as formatCliCommand, Hr as formatErrorMessage, It as normalizeReplyPayload, J as formatMention, Jn as normalizeMediaAttachments, Jt as resolveDiscordOwnerAccess, K as applyVerboseOverride, Kn as buildProviderRegistry, Kt as resolveOutboundTarget, Mn as isSilentReplyText, Mt as resolveContextTokensForModel, Ot as AGENT_LANE_SUBAGENT, Q as getRemoteSkillEligibility, Qr as formatThinkingLevels, Qt as formatOutboundPayloadLog, Rn as resolveTtsConfig, Sr as isDeliverableMessageChannel, St as emitAgentEvent, Tr as normalizeMessageChannel, Tt as resolveAcpAgentPolicyError, U as setCliSessionId, W as runCliAgent, Wt as resolveAgentRoute, Xn as runCapability, Xt as buildOutboundSessionContext, Yr as buildWorkspaceSkillSnapshot, Yt as formatDiscordUserTag, Zr as ensureAuthProfileStore, Zt as deliverOutboundPayloads, _r as getChannelPlugin, ai as DEFAULT_PROVIDER, bt as normalizeSpawnedRunMetadata, c as modelKey, cr as normalizeAccountId, ct as resolveBootstrapWarningSignaturesSeen, d as resolveConfiguredModelRef, dr as resolveChannelResetConfig, ei as normalizeThinkLevel, en as normalizeOutboundPayloadsForJson, f as resolveDefaultModelForAgent, fr as resolveSessionResetPolicy, gn as toAcpRuntimeError, gr as resolveExplicitAgentSessionKey, h as resolveCommandSecretRefsViaGateway, hn as getAcpSessionManager, hr as setSessionRuntimeModel, i as setRuntimeConfigSnapshot, ii as DEFAULT_MODEL, in as resolveMessageChannelSelection, ir as loadSessionStore, jn as isSilentReplyPrefixText, jt as hasNonzeroUsage, kt as applyModelOverrideToSessionEntry, l as normalizeModelRef, lr as resolveSessionKey, m as getAgentRuntimeCommandSecretTargetIds, mr as mergeSessionEntry, n as loadConfig, ni as supportsXHighThinking, nr as resolveSessionTranscriptFile, o as buildAllowedModelSet, on as runWithModelFallback, ot as runEmbeddedPiAgent, p as resolveThinkingDefault, pr as resolveSessionResetType, qn as createMediaAttachmentCache, qt as resolveSessionDeliveryTarget, r as readConfigFileSnapshotForWrite, rr as emitSessionTranscriptUpdate, s as isCliProvider, sn as FailoverError, sr as updateSessionStore, st as prepareSessionManagerForRun, ti as normalizeVerboseLevel, tr as loadModelCatalog, tt as resolveSendPolicy, u as normalizeProviderId, un as clearBootstrapSnapshotOnSessionRollover, ur as evaluateSessionFreshness, vr as normalizeChannelId, vt as resolveAgentTimeoutMs, wr as isInternalMessageChannel, wt as resolveAcpSessionCwd, xr as INTERNAL_MESSAGE_CHANNEL, xt as clearAgentRunContext, yt as formatAgentInternalEventsForPrompt, zn as textToSpeech } from "./onboard-helpers-zkyUeHRr.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-CN2V4oso.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CoGuBn16.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-DeHVvBVh.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-mpk7ITxm.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-CJAWVw5i.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BDJYZMTg.js");
