...
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-DFfVVvF3.js";
import "./paths-DinMprTu.js";
import { $n as normalizeMediaAttachments, At as applyModelOverrideToSessionEntry, B as setCliSessionId, Bi as DEFAULT_MODEL, C as isDangerousNameMatchingEnabled, Ct as emitAgentEvent, Di as readConfigFileSnapshotForWrite, Dt as resolveAcpDispatchPolicyError, Ei as loadConfig, Et as resolveAcpAgentPolicyError, G as formatMention, Gi as normalizeVerboseLevel, Gn as parseTtsDirectives, Gr as isDeliverableMessageChannel, Gt as resolveAgentRoute, H as clearSessionAuthProfileOverride, Hi as formatThinkingLevels, In as isSilentReplyPrefixText, Jr as normalizeMessageChannel, Jt as resolveSessionDeliveryTarget, Ki as supportsXHighThinking, Kr as isGatewayMessageChannel, Ln as isSilentReplyText, Lt as normalizeReplyPayload, Mt as hasNonzeroUsage, Nt as resolveContextTokensForModel, Oi as setRuntimeConfigSnapshot, Ot as AGENT_LANE_NESTED, Qn as createMediaAttachmentCache, Si as formatErrorMessage, St as clearAgentRunContext, Ti as loadModelCatalog, Tt as resolveAcpSessionCwd, U as applyVerboseOverride, Ui as formatXHighModelHint, Un as resolveTtsConfig, V as runCliAgent, Vi as DEFAULT_PROVIDER, Wi as normalizeThinkLevel, Wn as textToSpeech, Wr as INTERNAL_MESSAGE_CHANNEL, Xt as formatDiscordUserTag, Y as getRemoteSkillEligibility, Yr as resolveMessageChannel, Yt as resolveDiscordOwnerAccess, Zn as buildProviderRegistry, _r as resolveExplicitAgentSessionKey, a as modelKey, ar as loadSessionStore, bi as buildWorkspaceSkillSnapshot, bn as getAcpSessionManager, bt as formatAgentInternalEventsForPrompt, c as resolveConfiguredModelRef, cr as updateSessionStore, ct as prepareSessionManagerForRun, d as getAgentRuntimeCommandSecretTargetIds, dn as FailoverError, dr as evaluateSessionFreshness, en as buildOutboundSessionContext, et as getSkillsSnapshotVersion, f as resolveCommandSecretRefsViaGateway, fr as resolveChannelResetConfig, gr as setSessionRuntimeModel, hn as clearBootstrapSnapshotOnSessionRollover, hr as mergeSessionEntry, i as isCliProvider, in as normalizeOutboundPayloadsForJson, ir as emitSessionTranscriptUpdate, jt as deriveSessionTotalTokens, kt as AGENT_LANE_SUBAGENT, l as resolveDefaultModelForAgent, ln as runWithModelFallback, lr as normalizeAccountId, lt as resolveBootstrapWarningSignaturesSeen, mr as resolveSessionResetType, n as ensureAuthProfileStore, nn as formatOutboundPayloadLog, nt as resolveSendPolicy, o as normalizeModelRef, pr as resolveSessionResetPolicy, qi as formatCliCommand, qr as isInternalMessageChannel, qt as resolveOutboundTarget, r as buildAllowedModelSet, rn as normalizeOutboundPayloads, rr as resolveSessionTranscriptFile, s as normalizeProviderId, sn as resolveMessageChannelSelection, st as runEmbeddedPiAgent, tn as deliverOutboundPayloads, tr as runCapability, u as resolveThinkingDefault, ur as resolveSessionKey, vr as getChannelPlugin, wt as registerAgentRunContext, xn as toAcpRuntimeError, xt as normalizeSpawnedRunMetadata, yr as normalizeChannelId, yt as resolveAgentTimeoutMs, z as getCliSessionId } from "./auth-profiles-Cwd0dOGj.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-DjvqYw9a.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BJYHMc19.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CirWmQrM.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-uauPkqKg.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-C0SBO9Jw.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-7mDeiVSr.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-D1DKmToY.js");
