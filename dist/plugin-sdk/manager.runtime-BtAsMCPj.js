...
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-Dz_U9Dfk.js";
import { $t as buildOutboundSessionContext, A as isDangerousNameMatchingEnabled, Ar as isInternalMessageChannel, At as resolveAcpAgentPolicyError, Bn as resolveTtsConfig, Ct as resolveAgentTimeoutMs, Dr as INTERNAL_MESSAGE_CHANNEL, Dt as emitAgentEvent, Et as clearAgentRunContext, Ft as deriveSessionTotalTokens, Hn as parseTtsDirectives, It as hasNonzeroUsage, J as setCliSessionId, Ji as formatCliCommand, Jn as buildProviderRegistry, Jr as formatErrorMessage, Lt as resolveContextTokensForModel, Mr as resolveMessageChannel, Mt as AGENT_LANE_NESTED, Nn as isSilentReplyPrefixText, Nt as AGENT_LANE_SUBAGENT, Or as isDeliverableMessageChannel, Ot as registerAgentRunContext, Pn as isSilentReplyText, Pt as applyModelOverrideToSessionEntry, Qn as runCapability, Qt as resolveSessionDeliveryTarget, T as formatMention, Tt as normalizeSpawnedRunMetadata, Vn as textToSpeech, Vt as normalizeReplyPayload, X as clearSessionAuthProfileOverride, Xn as normalizeMediaAttachments, Y as runCliAgent, Yn as createMediaAttachmentCache, Yt as resolveAgentRoute, Z as applyVerboseOverride, Zt as resolveOutboundTarget, _i as resolveDiscordOwnerAccess, _n as getAcpSessionManager, _r as setSessionRuntimeModel, a as setRuntimeConfigSnapshot, ai as ensureAuthProfileStore, ar as emitSessionTranscriptUpdate, br as normalizeChannelId, c as isCliProvider, ci as normalizeThinkLevel, cn as runWithModelFallback, d as normalizeProviderId, dr as resolveSessionKey, dt as runEmbeddedPiAgent, en as deliverOutboundPayloads, f as resolveConfiguredModelRef, fi as DEFAULT_MODEL, fn as clearBootstrapSnapshotOnSessionRollover, fr as evaluateSessionFreshness, ft as prepareSessionManagerForRun, g as resolveCommandSecretRefsViaGateway, gr as mergeSessionEntry, h as getAgentRuntimeCommandSecretTargetIds, hr as resolveSessionResetType, i as readConfigFileSnapshotForWrite, ir as resolveSessionTranscriptFile, jr as normalizeMessageChannel, jt as resolveAcpDispatchPolicyError, kr as isGatewayMessageChannel, kt as resolveAcpSessionCwd, l as modelKey, li as normalizeVerboseLevel, ln as FailoverError, lr as updateSessionStore, m as resolveThinkingDefault, mr as resolveSessionResetPolicy, nn as normalizeOutboundPayloads, nt as getRemoteSkillEligibility, oi as formatThinkingLevels, on as resolveMessageChannelSelection, or as loadSessionStore, ot as resolveSendPolicy, p as resolveDefaultModelForAgent, pi as DEFAULT_PROVIDER, pr as resolveChannelResetConfig, pt as resolveBootstrapWarningSignaturesSeen, q as getCliSessionId, r as loadConfig, rn as normalizeOutboundPayloadsForJson, rr as loadModelCatalog, rt as getSkillsSnapshotVersion, s as buildAllowedModelSet, si as formatXHighModelHint, ti as buildWorkspaceSkillSnapshot, tn as formatOutboundPayloadLog, u as normalizeModelRef, ui as supportsXHighThinking, ur as normalizeAccountId, vi as formatDiscordUserTag, vn as toAcpRuntimeError, vr as resolveExplicitAgentSessionKey, wt as formatAgentInternalEventsForPrompt, yr as getChannelPlugin } from "./audit-YF6JsF2U.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-CwTHQ-GI.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-Xf0CbRJt.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-CQ7JEuqx.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-CWa8oUtZ.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-BQR7M6aK.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-E6Q2gvyU.js");
