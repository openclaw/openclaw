...
import { $ as getSkillsSnapshotVersion, $t as buildOutboundSessionContext, At as deriveSessionTotalTokens, Br as isInternalMessageChannel, Ci as DEFAULT_PROVIDER, Cn as toAcpRuntimeError, Ct as registerAgentRunContext, Di as normalizeVerboseLevel, Dt as AGENT_LANE_NESTED, E as isDangerousNameMatchingEnabled, Ei as normalizeThinkLevel, Et as resolveAcpDispatchPolicyError, G as clearSessionAuthProfileOverride, Gn as resolveTtsConfig, H as getCliSessionId, Hr as resolveMessageChannel, It as normalizeReplyPayload, J as formatMention, Jn as buildProviderRegistry, Jt as resolveDiscordOwnerAccess, K as applyVerboseOverride, Kn as textToSpeech, Kt as resolveOutboundTarget, Lr as INTERNAL_MESSAGE_CHANNEL, Mt as resolveContextTokensForModel, Oi as supportsXHighThinking, Ot as AGENT_LANE_SUBAGENT, Q as getRemoteSkillEligibility, Qn as runCapability, Rn as isSilentReplyPrefixText, Rr as isDeliverableMessageChannel, Si as DEFAULT_MODEL, Sn as getAcpSessionManager, St as emitAgentEvent, Ti as formatXHighModelHint, Tt as resolveAcpAgentPolicyError, U as setCliSessionId, Vr as normalizeMessageChannel, W as runCliAgent, Wt as resolveAgentRoute, Xn as normalizeMediaAttachments, Yn as createMediaAttachmentCache, Yt as formatDiscordUserTag, _i as loadConfig, _n as clearBootstrapSnapshotOnSessionRollover, a as isCliProvider, ar as updateSessionStore, bt as normalizeSpawnedRunMetadata, c as normalizeProviderId, cr as evaluateSessionFreshness, ct as resolveBootstrapWarningSignaturesSeen, d as resolveThinkingDefault, dr as resolveSessionResetType, en as deliverOutboundPayloads, er as resolveSessionTranscriptFile, f as getAgentRuntimeCommandSecretTargetIds, fn as runWithModelFallback, fr as mergeSessionEntry, gi as loadModelCatalog, gr as normalizeChannelId, hr as getChannelPlugin, i as buildAllowedModelSet, jt as hasNonzeroUsage, ki as formatCliCommand, kt as applyModelOverrideToSessionEntry, l as resolveConfiguredModelRef, lr as resolveChannelResetConfig, mn as FailoverError, mr as resolveExplicitAgentSessionKey, nn as normalizeOutboundPayloads, nr as loadSessionStore, o as modelKey, on as resolveMessageChannelSelection, or as normalizeAccountId, ot as runEmbeddedPiAgent, p as resolveCommandSecretRefsViaGateway, pi as formatErrorMessage, pr as setSessionRuntimeModel, qt as resolveSessionDeliveryTarget, r as ensureAuthProfileStore, rn as normalizeOutboundPayloadsForJson, s as normalizeModelRef, sr as resolveSessionKey, st as prepareSessionManagerForRun, t as parseTtsDirectives, tn as formatOutboundPayloadLog, tr as emitSessionTranscriptUpdate, tt as resolveSendPolicy, u as resolveDefaultModelForAgent, ui as buildWorkspaceSkillSnapshot, ur as resolveSessionResetPolicy, vi as readConfigFileSnapshotForWrite, vt as resolveAgentTimeoutMs, wi as formatThinkingLevels, wt as resolveAcpSessionCwd, xt as clearAgentRunContext, yi as setRuntimeConfigSnapshot, yt as formatAgentInternalEventsForPrompt, zn as isSilentReplyText, zr as isGatewayMessageChannel } from "./tts-core-Cj6HugFk.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-CO0eGZ-2.js";
import "./paths-Dmn791zP.js";
import "./fetch-BIaKGiR8.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, dn as normalizeAgentId, fn as normalizeMainKey, gt as listAgentIds, pn as resolveAgentIdFromSessionKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-B_PjWX-0.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-C0rFQuei.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-Cg3VVR0T.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-C8BYImdy.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-Dvf8JGZa.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-BIUU876A.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-CA5iqffs.js");
