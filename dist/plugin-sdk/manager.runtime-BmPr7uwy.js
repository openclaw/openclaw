...
import { $t as normalizeAgentId, R as resolveStorePath, Tt as ensureAgentWorkspace, at as listAgentIds, dt as resolveAgentWorkspaceDir, en as normalizeMainKey, ht as resolveSessionAgentId, pt as resolveEffectiveModelFallbacks, st as resolveAgentDir, tn as resolveAgentIdFromSessionKey, ut as resolveAgentSkillsFilter } from "./query-expansion-DYHedgXi.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./utils-CGn46_9M.js";
import "./paths-Dmn791zP.js";
import { $n as loadSessionStore, $r as loadModelCatalog, An as isSilentReplyPrefixText, At as hasNonzeroUsage, Cr as resolveMessageChannel, Ct as resolveAcpSessionCwd, Dt as AGENT_LANE_SUBAGENT, Et as AGENT_LANE_NESTED, Ft as normalizeReplyPayload, G as applyVerboseOverride, Gn as buildProviderRegistry, Gr as buildWorkspaceSkillSnapshot, Gt as resolveDiscordOwnerAccess, H as setCliSessionId, Kn as createMediaAttachmentCache, Kt as formatDiscordUserTag, Ln as resolveTtsConfig, Ot as applyModelOverrideToSessionEntry, Q as getSkillsSnapshotVersion, Qn as emitSessionTranscriptUpdate, Rn as textToSpeech, S as isDangerousNameMatchingEnabled, Sr as normalizeMessageChannel, St as registerAgentRunContext, Tt as resolveAcpDispatchPolicyError, U as runCliAgent, Ut as resolveOutboundTarget, V as getCliSessionId, Vt as resolveAgentRoute, W as clearSessionAuthProfileOverride, Wt as resolveSessionDeliveryTarget, Xr as formatErrorMessage, Yn as runCapability, Z as getRemoteSkillEligibility, Zi as formatCliCommand, Zn as resolveSessionTranscriptFile, _t as resolveAgentTimeoutMs, a as normalizeModelRef, ar as evaluateSessionFreshness, at as runEmbeddedPiAgent, bn as toAcpRuntimeError, br as isGatewayMessageChannel, bt as clearAgentRunContext, c as resolveDefaultModelForAgent, ci as formatThinkingLevels, cr as resolveSessionResetType, d as resolveCommandSecretRefsViaGateway, di as normalizeVerboseLevel, dn as FailoverError, dr as resolveExplicitAgentSessionKey, ei as loadConfig, en as buildOutboundSessionContext, et as resolveSendPolicy, fi as supportsXHighThinking, fr as getChannelPlugin, i as modelKey, in as normalizeOutboundPayloadsForJson, ir as resolveSessionKey, jn as isSilentReplyText, jt as resolveContextTokensForModel, kt as deriveSessionTotalTokens, l as resolveThinkingDefault, li as formatXHighModelHint, ln as runWithModelFallback, lr as mergeSessionEntry, mn as clearBootstrapSnapshotOnSessionRollover, n as buildAllowedModelSet, ni as setRuntimeConfigSnapshot, nn as formatOutboundPayloadLog, nr as updateSessionStore, o as normalizeProviderId, oi as DEFAULT_MODEL, or as resolveChannelResetConfig, ot as prepareSessionManagerForRun, pr as normalizeChannelId, q as formatMention, qn as normalizeMediaAttachments, r as isCliProvider, rn as normalizeOutboundPayloads, rr as normalizeAccountId, s as resolveConfiguredModelRef, si as DEFAULT_PROVIDER, sn as resolveMessageChannelSelection, sr as resolveSessionResetPolicy, st as resolveBootstrapWarningSignaturesSeen, t as ensureAuthProfileStore, ti as readConfigFileSnapshotForWrite, tn as deliverOutboundPayloads, u as getAgentRuntimeCommandSecretTargetIds, ui as normalizeThinkLevel, ur as setSessionRuntimeModel, vr as INTERNAL_MESSAGE_CHANNEL, vt as formatAgentInternalEventsForPrompt, wt as resolveAcpAgentPolicyError, xr as isInternalMessageChannel, xt as emitAgentEvent, yn as getAcpSessionManager, yr as isDeliverableMessageChannel, yt as normalizeSpawnedRunMetadata, zn as parseTtsDirectives } from "./model-auth-FOvKHyf_.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-hq33pTia.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-D6Hp9anA.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-1Am0G2Bp.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-C7lrTZsF.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-BAzTb8ye.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-4JtEeMgx.js");
