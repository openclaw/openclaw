import { O as createSubsystemLogger, i as logWarn } from "./logger-DFfVVvF3.js";
import { readFileSync } from "node:fs";
import fs$1 from "node:fs/promises";
import process$1 from "node:process";
import { Agent, EnvHttpProxyAgent, ProxyAgent, fetch as fetch$1 } from "undici";
...
function makeProxyFetch(proxyUrl) {
	...
	const proxyFetch = ((input, init) => fetch$1(input, {
		...init,
...
function resolveTelegramTransport(proxyFetch, options) {
	...
	const undiciSourceFetch = resolveWrappedFetch(fetch$1);
	...
	const resolveStickyIpv4Dispatcher = () => {
		if (!stickyIpv4Dispatcher) stickyIpv4Dispatcher = createTelegramDispatcher(resolveTelegramDispatcherPolicy({
...
//#endregion
export { resolveFetch as a, resolveProxyFetchFromEnv as c, bindAbortRelay as d, fetchWithTimeout as f, isWSLEnv as i, hasEnvHttpProxyConfigured as l, parseBooleanValue as m, resolveTelegramTransport as n, wrapFetchWithAbortSignal as o, isTruthyEnvValue as p, isWSL as r, makeProxyFetch as s, resolveTelegramFetch as t, hasProxyEnvConfigured as u };
