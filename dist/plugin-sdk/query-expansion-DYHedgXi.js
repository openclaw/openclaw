import { B as shouldLogVerbose, D as logWarn, I as danger, J as resolveNodeRequireFromMeta, O as createSubsystemLogger, T as logError, f as pathExists$1, h as resolveUserPath, w as logDebug } from "./utils-CGn46_9M.js";
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix } from "./paths-Dmn791zP.js";
import { createRequire } from "node:module";
import fs from "node:fs/promises";
import path from "node:path";
import { fileTypeFromBuffer } from "file-type";
import fs$1, { constants, readFileSync, statSync } from "node:fs";
...
//#endregion
export { getDefaultRedactPatterns as $, normalizeAgentId as $t, supportsMemoryMultimodalEmbeddings as A, MAX_IMAGE_BYTES as An, canUseBoundaryFileOpen as At, resolveWindowsSpawnProgram as B, resolveAgentModelPrimaryValue as Bt, isFileMissingError as C, extensionForMime as Cn, DEFAULT_TOOLS_FILENAME as Ct, getMemoryMultimodalExtensions as D, isGifMedia as Dn, loadWorkspaceBootstrapFiles as Dt, classifyMemoryMultimodalPath as E, isAudioFileName as En, filterBootstrapFilesForSession as Et, resolveSessionTranscriptPath as F, isNotFoundPathError as Ft, openFileWithinRoot as G, normalizeStringEntriesLower as Gt, appendFileWithinRoot as H, normalizeAtHashSlug as Ht, resolveSessionTranscriptPathInDir as I, isPathInside as It, writeFileFromPathWithinRoot as J, buildAgentMainSessionKey as Jt, readFileWithinRoot as K, DEFAULT_AGENT_ID as Kt, resolveSessionTranscriptsDirForAgent as L, normalizeWindowsPathForComparison as Lt, resolveDefaultSessionStorePath as M, mediaKindFromMime as Mn, openBoundaryFileSync as Mt, resolveSessionFilePath as N, openVerifiedFileSync as Nt, isMemoryMultimodalEnabled as O, kindFromMime as On, resolveOpenClawPackageRoot as Ot, resolveSessionFilePathOptions as P, resolvePathViaExistingAncestorSync as Pt, assertNoPathAliasEscape as Q, isValidAgentId as Qt, resolveStorePath as R, normalizeSkillFilter as Rt, splitTextToUtf8ByteLimit as S, detectMime as Sn, DEFAULT_SOUL_FILENAME as St, buildCaseInsensitiveExtensionGlob as T, imageMimeFromFormat as Tn, ensureAgentWorkspace as Tt, copyFileWithinRoot as U, normalizeHyphenSlug as Ut, SafeOpenError as V, toAgentModelListLike as Vt, createRootScopedReadFile as W, normalizeStringEntries as Wt, runTasksWithConcurrency as X, buildGroupHistoryKey as Xt, writeFileWithinRoot as Y, buildAgentPeerSessionKey as Yt, PATH_ALIAS_POLICIES as Z, classifySessionKeyShape as Zt, remapChunkLines as _, runCommandWithTimeout as _n, DEFAULT_AGENTS_FILENAME as _t, listSessionFilesForAgent as a, toAgentRequestSessionKey as an, listAgentIds as at, estimateStructuredEmbeddingInputBytes as b, spawnWithFallback as bn, DEFAULT_HEARTBEAT_FILENAME as bt, buildMultimodalChunkForIndexing as c, normalizeOptionalAccountId as cn, resolveAgentEffectiveModelPrimary as ct, ensureDir as d, getSubagentDepth as dn, resolveAgentWorkspaceDir as dt, normalizeMainKey as en, redactSensitiveText as et, hashText as f, isAcpSessionKey as fn, resolveDefaultAgentId as ft, parseEmbedding as g, resolveThreadParentSessionKey as gn, resolveSessionAgentIds as gt, normalizeExtraMemoryPaths as h, parseAgentSessionKey as hn, resolveSessionAgentId as ht, buildSessionEntry as i, scopedHeartbeatWakeOptions as in, hasConfiguredModelFallbacks as it, resolveAgentsDirFromSessionStorePath as j, maxBytesForKind as jn, openBoundaryFile as jt, normalizeMemoryMultimodalSettings as k, normalizeMimeType as kn, resolveOpenClawPackageRootSync as kt, chunkMarkdown as l, isBlockedObjectKey as ln, resolveAgentModelFallbacksOverride as lt, listMemoryFiles as m, isSubagentSessionKey as mn, resolveRunModelFallbacksOverride as mt, isQueryStopWordToken as n, resolveThreadSessionKeys as nn, compileSafeRegex as nt, sessionPathForFile as o, DEFAULT_ACCOUNT_ID as on, resolveAgentConfig as ot, isMemoryPath as p, isCronSessionKey as pn, resolveEffectiveModelFallbacks as pt, readLocalFileSafely as q, DEFAULT_MAIN_KEY as qt, requireNodeSqlite as r, sanitizeAgentId as rn, testRegexWithBoundedInput as rt, buildFileEntry as s, normalizeAccountId as sn, resolveAgentDir as st, extractKeywords as t, resolveAgentIdFromSessionKey as tn, redactToolDetail as tt, cosineSimilarity as u, deriveSessionChatType as un, resolveAgentSkillsFilter as ut, runWithConcurrency as v, runExec as vn, DEFAULT_AGENT_WORKSPACE_DIR as vt, statRegularFile as w, getFileExtension as wn, DEFAULT_USER_FILENAME as wt, estimateUtf8Bytes as x, markOpenClawExecEnv as xn, DEFAULT_IDENTITY_FILENAME as xt, hasNonTextEmbeddingParts as y, resolveWindowsCommandShim as yn, DEFAULT_BOOTSTRAP_FILENAME as yt, materializeWindowsSpawnProgram as z, resolveAgentModelFallbackValues as zt };
