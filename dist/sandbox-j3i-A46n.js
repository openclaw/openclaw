...
import { y as resolveUserPath } from "./utils-BgHhhQlR.js";
import { C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, T as DEFAULT_USER_FILENAME, _ as DEFAULT_AGENT_WORKSPACE_DIR, b as DEFAULT_IDENTITY_FILENAME, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, m as resolveSessionAgentId, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-DcOd8osz.js";
import { d as defaultRuntime, t as createSubsystemLogger } from "./subsystem-B6NrUFrh.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-D_MAPrS9.js";
import { i as openBoundaryFile, u as resolvePathViaExistingAncestorSync } from "./openclaw-root-rLmdSaR4.js";
import { $t as loadConfig, wn as getBlockedNetworkModeReason } from "./model-selection-Dmiyt9yA.js";
import { t as CHANNEL_IDS } from "./registry-DBb6KIXY.js";
import { t as formatCliCommand } from "./command-format-DgBEhw5P.js";
import { X as canonicalizeMainSessionAlias, Z as resolveAgentMainSessionKey, st as acquireSessionWriteLock } from "./sessions-oRavjpc9.js";
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-IBWCA-2a.js";
import { I as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, N as DEFAULT_BROWSER_EVALUATE_ENABLED, P as DEFAULT_OPENCLAW_BROWSER_COLOR } from "./chrome-DGhZwihE.js";
import { i as isLoopbackHost } from "./ws-OMv8Zfui.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, o as deriveDefaultBrowserCdpPortRange, r as registerBrowserRoutes, s as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-CVdBixsK.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, g as sanitizeEnvVars, o as syncSkillsToWorkspace } from "./skills-DOWW7Nlf.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DHN0MYP9.js";
import { n as installBrowserCommonMiddleware, t as installBrowserAuthMiddleware } from "./server-middleware-UmRI5cjA.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-BrlFlJEw.js";
import { r as writeJsonAtomic } from "./json-files-CUKYu6i0.js";
