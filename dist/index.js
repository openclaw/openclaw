...
import { St as resolveCommitHash, t as getReplyFromConfig, zt as createDefaultDeps } from "./reply-CtQMdhNT.js";
...
import { $t as loadConfig, Qr as VERSION, ii as loadDotEnv } from "./model-selection-COYmqEoi.js";
...
import { B as resolveSessionKey, l as saveSessionStore, o as loadSessionStore, z as deriveSessionKey } from "./sessions-DICryTKD.js";
import { l as installUnhandledRejectionHandler, v as applyTemplate } from "./audio-transcription-runner-GMqQalEp.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-BpCjWqvq.js";
...
import { i as getCoreCliCommandsWithSubcommands, n as setProgramContext, o as registerProgramCommands, s as getSubCliCommandsWithSubcommands } from "./program-context-BAU5cw7d.js";
import "./plugin-registry-B8cS0SJH.js";
import { n as resolveCliChannelOptions } from "./channel-options-DljXOZpT.js";
...
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-Beu6d9uN.js");
	return configGuardModulePromise;
}
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-B8cS0SJH.js").then((n) => n.n);
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		setVerbose(verbose);
		{
			const { loadConfig } = await import("./model-selection-COYmqEoi.js").then((n) => n.Yt);
