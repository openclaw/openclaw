import { _ as getLogger, g as getChildLogger, h as theme, l as setVerbose, m as isRich, o as logVerbose, p as colorize, r as isDevMode, v as getResolvedLoggerSettings } from "./globals-DqM7Q4km.js";
...
import { a as setConsoleSubsystemFilter, d as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-BXiL6bA6.js";
import "./boolean-DtWR5bt3.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { Ai as DEFAULT_MODEL, At as AVATAR_MAX_BYTES, B as parseConfigJson5, Dr as resolveThinkingDefault, G as writeConfigFile, H as readConfigFileSnapshotForWrite, I as migrateLegacyConfig, In as resolveAgentMaxConcurrent, K as validateConfigObjectWithPlugins, Ln as resolveSubagentMaxConcurrent, Lt as looksLikeAvatarPath, Mt as isAvatarHttpUrl, Nt as isAvatarImageDataUrl, Pn as buildTalkConfigResponse, R as createConfigIO, Sr as resolveHooksGmailModel, Ti as normalizeSecretInput, Tr as resolveSubagentConfiguredModelSelection, U as resolveConfigSnapshotHash, V as readConfigFileSnapshot, ar as isPidAlive, bn as applyLegacyMigrations, br as resolveConfiguredModelRef, fr as isCliProvider, hr as normalizeModelSelection, ji as DEFAULT_PROVIDER, ki as DEFAULT_CONTEXT_TOKENS, mt as parseByteSize, or as buildAllowedModelSet, pt as parseDurationMs, q as OpenClawSchema, ur as getModelRefStatus, vr as resolveAllowedModelRef, xn as ensureControlUiAllowedOriginsForNonLoopbackBind, xr as resolveDefaultModelForAgent, yn as applyMergePatch, z as loadConfig } from "./auth-profiles-C39jSzPb.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-BXg6mLAy.js";
import { S as isCronRunSessionKey, T as parseAgentSessionKey, _ as normalizeAccountId$1, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, w as isSubagentSessionKey } from "./session-key-xF6i12F5.js";
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-xLjEf_5u.js";
import { a as openBoundaryFileSync, f as isNotFoundPathError, g as matchesSkillFilter, i as openBoundaryFile, o as openVerifiedFileSync, s as sameFileIdentity, t as resolveOpenClawPackageRoot } from "./openclaw-root-CUjRHZhy.js";
import { i as logWarn, t as logDebug } from "./logger-hujp-3PD.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-BpP6Q4EB.js";
import { C as clearInternalHooks, E as triggerInternalHook, T as registerInternalHook, h as createEmptyPluginRegistry, j as hasConfiguredSecretInput, t as CHANNEL_IDS, u as getActivePluginRegistry, w as createInternalHookEvent } from "./registry-DTmGzx3d.js";
import "./github-copilot-token-CvN6iidT.js";
import { u as isTestDefaultMemorySlotDisabled } from "./manifest-registry-YpcF6BWJ.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-cke7D5Ak.js";
import "./runtime-overrides-ChuaKEss.js";
import "./dock-CK-Sk5ak.js";
import "./model-nQlDw9iA.js";
import "./pi-model-discovery-CtphyBYI.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-C1NFBVnN.js";
import { d as hasBinary } from "./frontmatter-D2o8_Jfu.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-LzLwUYxz.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards--u7-iWd6.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dm-3bvT9.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-Uz3-Q9E0.js";
import { $ as resolveAgentMainSessionKey, A as readSessionPreviewItemsFromTranscript, B as cleanStaleLockFiles, C as normalizeSessionDeliveryFields, D as capArrayByJsonBytes, E as archiveSessionTranscripts, G as resolveSessionResetPolicy, I as stripInlineDirectiveTagsForDisplay, L as stripInlineDirectiveTagsFromMessageForDisplay, M as resolveSessionTranscriptCandidates, N as stripEnvelopeFromMessage, O as cleanupArchivedSessionTranscripts, P as stripEnvelopeFromMessages, Q as canonicalizeMainSessionAlias, R as jsonUtf8Bytes, T as archiveFileOnDisk, U as evaluateSessionFreshness, Y as mergeSessionEntry, Z as setSessionRuntimeModel, d as updateSessionStore, et as resolveExplicitAgentSessionKey, it as snapshotSessionOrigin, k as readSessionMessages, n as parseSessionThreadInfo, nt as resolveMainSessionKeyFromConfig, o as loadSessionStore, t as extractDeliveryInfo, tt as resolveMainSessionKey, x as mergeDeliveryContext, y as deliveryContextFromSession } from "./sessions-Bx1XJLag.js";
import { D as normalizeWhatsAppTarget, m as buildChannelAccountBindings, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-D8yPNTgi.js";
import { i as resolveWhatsAppAccount } from "./accounts-C8pI_u-9.js";
import "./accounts-Cg8cGZPE.js";
import "./logging-CcxUDNcI.js";
import "./accounts-DBl2tRX-.js";
import "./send-BJLzepxr.js";
import "./send-DuHfSwNa.js";
import { $n as DEFAULT_INPUT_IMAGE_MAX_BYTES, $r as emitAgentEvent, Ar as resolveTtsAutoMode, At as runWithModelFallback, B as resolveAgentAvatar, Bt as normalizeCronJobCreate, Cn as triggerOpenClawRestart, Cr as resolveUserTimezone, D as handleSlackHttpRequest, Dn as loadProviderUsageSummary, Dr as isTtsEnabled, Er as getTtsProvider, Et as resolveOutboundChannelPlugin, F as resolveAgentDeliveryPlan, Fr as setTtsProvider, Gn as requestHeartbeatNow, Gr as waitForActiveTasks, Gt as normalizeOptionalText, Hn as isSystemEventContextChanged, Hr as markGatewayDraining, Ht as inferLegacyName, I as resolveAgentOutboundTarget, Ir as textToSpeech, It as summarizeRestartSentinel, J as buildHistoryContextFromEntries, Jt as migrateLegacyCronPayload, Kr as CommandLane, Kt as normalizePayloadToSystemText, L as createOutboundSendDeps, Lr as OPENAI_TTS_MODELS, Mr as resolveTtsPrefsPath, Mt as consumeRestartSentinel, N as agentCommandFromIngress, Nn as resolveBootstrapWarningSignaturesSeen, Nr as resolveTtsProviderOrder, Nt as formatDoctorNonInteractiveHint, O as readJsonBodyWithLimit, Or as isTtsProviderConfigured, Ot as resetDirectoryCache, Pn as formatZonedTimestamp, Pr as setTtsEnabled, Pt as formatRestartSentinelMessage, Qr as clearAgentRunContext, R as createDefaultDeps, Rr as OPENAI_TTS_VOICES, Rt as writeRestartSentinel, Sn as setPreRestartDeferralCheck, T as resolveAgentOutboundIdentity, Tn as normalizeGroupActivation, Tr as clearBootstrapSnapshot, Tt as resolveSessionDeliveryTarget, Ur as resetAllLanes, Ut as normalizeOptionalAgentId, Vn as enqueueSystemEvent, Vr as getTotalQueueSize, Vt as normalizeCronJobPatch, W as createReplyPrefixOptions, Wr as setCommandLaneConcurrency, Wt as normalizeOptionalSessionKey, Xn as ACP_SESSION_IDENTITY_RENDERER_VERSION, Xt as hasLegacyDeliveryHints, Yt as buildDeliveryFromLegacyPayload, Zr as stripHeartbeatToken, Zt as stripLegacyDeliveryFields, _ as getPluginToolMeta, _n as emitGatewayRestart, _r as getAcpSessionManager, _t as readLatestAssistantReply, an as persistBrowserProxyFiles, ar as normalizeMimeList, at as dispatchInboundMessage, b as loadOpenClawPlugins, bn as scheduleGatewaySigusr1Restart, bt as ensureOutboundSessionEntry, c as runSubagentAnnounceFlow, cr as resolveAgentTimeoutMs, d as abortEmbeddedPiRun, dn as applyModelOverrideToSessionEntry, ei as getAgentRunContext, en as buildSafeExternalPrompt, er as DEFAULT_INPUT_IMAGE_MIMES, f as getActiveEmbeddedRunCount, fn as applyVerboseOverride, ft as resolveCronStyleNow, gn as deferGatewayRestartUntilIdle, gt as createOpenClawTools, h as buildDefaultToolPolicyPipelineSteps, hn as consumeGatewaySigusr1RestartAuthorization, ht as runCliAgent, i as initSubagentRegistry, in as applyBrowserProxyPaths, ir as extractImageContentFromSource, jr as resolveTtsConfig, k as requestBodyErrorToText, kr as resolveTtsApiKey, l as clearSessionQueues, lr as normalizeSendPolicy, m as applyToolPolicyPipeline, mn as buildOutboundSessionContext, mr as stopSubagentsForRequester, mt as setCliSessionId, ni as registerAgentRunContext, nn as getHookType, nr as DEFAULT_INPUT_TIMEOUT_MS, o as listDescendantRunsForRequester, on as resolveSessionAuthProfileOverride, or as resolveInputFileLimits, ot as createReplyDispatcher, p as waitForEmbeddedPiRunEnd, pn as parseVerboseOverride, pr as isAbortRequestText, pt as getCliSessionId, qr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, qt as normalizeRequiredName, rn as isExternalHookSession, rr as extractFileContentFromSource, st as getTotalPendingReplies, t as countActiveDescendantRuns, ti as onAgentEvent, tn as detectSuspiciousPatterns, tr as DEFAULT_INPUT_MAX_REDIRECTS, u as runEmbeddedPiAgent, ur as resolveSendPolicy, ut as buildBareSessionResetPrompt, v as resolvePluginTools, vn as isGatewaySigusr1RestartExternallyAllowed, vr as resolveAgentSessionDirs, vt as resolveAnnounceTargetFromKey, wn as unbindThreadBindingsBySessionKey, wt as resolveOutboundTarget, x as createPluginRuntime, xn as setGatewaySigusr1RestartPolicy, xt as resolveOutboundSessionRoute, yn as markGatewaySigusr1RestartHandled, yr as resolveAgentIdentity, z as createOutboundSendDeps$1, zr as getActiveTaskCount, zt as normalizeHttpWebhookUrl } from "./subagent-registry-R4GEWTHb.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-DAWfoG1N.js";
...
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-djvfM56G.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-BF7ZEz6Z.js";
import { d as mergeGatewayTailscaleConfig, l as ensureGatewayStartupAuth, u as mergeGatewayAuthConfig } from "./server-context-CfF4HsIY.js";
import "./paths-CSIzn_T3.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-LEFt15z2.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-8nIQWcYq.js";
import { i as openFileWithinRoot, l as writeFileWithinRoot, s as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-DS4hJvDc.js";
import { n as SsrFBlockedError } from "./proxy-env-BaaBkV0s.js";
import "./store--dkmRyD9.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-fzkwfwGz.js";
import { t as movePathToTrash } from "./trash-G16GLJQp.js";
import "./server-middleware-84TSGaQH.js";
import "./tool-images-Dpg-bSxD.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-btBo_vAx.js";
...
import { n as loadModelCatalog } from "./model-catalog-CO9IOYpD.js";
import "./fetch-3VWBbN6j.js";
import { g as registerUnhandledRejectionHandler } from "./audio-transcription-runner-DXCMng1Q.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CcL-QGmc.js";
import { b as extractTextFromChatContent } from "./image-r1dGy9BH.js";
...
import { a as ToolInputError } from "./target-errors--OnwKhHe.js";
import { r as isRestartEnabled } from "./commands-BZwK_e0W.js";
import "./commands-registry-gur48hks.js";
import "./fetch-DJ_HuCiB.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-Dsaa5EsC.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-CMViyX-0.js";
import { _ as matchSystemRunApprovalBinding, g as buildSystemRunApprovalBinding, h as resolveSystemRunApprovalRuntimeContext, m as resolveSystemRunApprovalRequestContext, v as missingSystemRunApprovalBinding, y as toSystemRunApprovalMismatchError } from "./nodes-screen-elLUNAE1.js";
import { n as resolveSystemRunCommand } from "./system-run-command-jClrCvFz.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-Q6LDkNTb.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-Dsaw4ZDS.js";
import "./send-YNv2X5cz.js";
import "./outbound-attachment-DFxnYFfk.js";
import "./delivery-queue-D9iUrwC9.js";
import "./send-BKRksrWM.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-CrwGHZQ3.js";
import "./proxy-BW96DoS7.js";
import { f as isKnownSecretTargetId, n as GATEWAY_AUTH_SURFACE_PATHS, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-SWe7Vxff.js";
import "./command-secret-targets-DaYbtRP6.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-CaaiwG16.js";
import "./prompt-style-DsMXeXF9.js";
import "./pairing-labels-CxIWq2TD.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-D5D4MQG4.js";
import { r as resolveMemorySearchConfig } from "./manager-DYi6ULoJ.js";
...
import { t as formatHelpExamples } from "./help-format-DskjS4bd.js";
import { n as withProgress } from "./progress-CAPOQFI0.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-Di68h4sz.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BHEZs5NH.js";
import { n as inheritOptionFromParent } from "./command-options-CRvgER_f.js";
import { t as WizardCancelledError } from "./prompts-B98rp78m.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-DGkTxg6u.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DMkFUiqi.js";
import { t as isWithinDir } from "./path-safety-piNzPkoU.js";
import "./install-safe-path-ChwhEWKt.js";
import "./skill-scanner-CzkqG2pN.js";
import { n as formatConfigIssueLines } from "./issue-format-COD5qdhp.js";
import { t as buildChannelAccountSnapshot } from "./status-vb5OH27e.js";
import "./channels-status-issues-6r_WSDdl.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-ZOKKEi5E.js";
...
import "./lifecycle-core-D9bS5FLe.js";
import "./systemd-hints-Duw-Kt0P.js";
import { t as parsePort$1 } from "./parse-port-B2PrGhHs.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CePUzp-T.js";
import { t as probeGateway } from "./probe-EnkyacKB.js";
import "./diagnostics-CnK4ms19.js";
import "./table-D5wfII-S.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-DhnjZtcQ.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BMEwzGgH.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-q1UI0SJJ.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-B3e1161V.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-tHiOOyVO.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-CsS0TQc5.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-Q00r4Ix7.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-CHy8qtgZ.js";
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DSKrOJul.js";
import "./onboarding.secret-input-BiDIiXUU.js";
import { t as runOnboardingWizard } from "./onboarding-DLXBhEW6.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-CMCHXOPj.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-uKggbpSR.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-BoGzYLtE.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-BoBJtmf8.js";
import "./node-service-By6so7OC.js";
import "./status.update-CPTVOEDL.js";
import { t as installSkill } from "./skills-install-uKSRmGS8.js";
import { t as runGatewayUpdate } from "./update-runner-CzwGkQmV.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-zCXAMyFj.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-B8tuH_2q.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-Ch9HWpOe.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-MmzkMjCb.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-D-Zo5tp9.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-D9iUrwC9.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-DqQqNOvW.js").then((n) => n.n);
