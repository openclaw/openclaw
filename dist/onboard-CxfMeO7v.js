...
import { Sn as resolveDefaultSecretProviderAlias, an as writeConfigFile, tn as readConfigFileSnapshot } from "./model-selection-COYmqEoi.js";
import { N as isValidEnvSecretRefId } from "./registry-DBb6KIXY.js";
import { t as formatCliCommand } from "./command-format-DgBEhw5P.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-DkoVky3L.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BJBwJ_Tq.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C_TweWCD.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-B3ra90mk.js").then((n) => n.i);
