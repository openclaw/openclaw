...
import { t as AGENT_MODEL_CONFIG_KEYS } from "./model-refs-BGL2fwMX.js";
...
function collectCodexAppServerCommandWarnings(cfg) {
	const appServer = asMutableRecord(asMutableRecord(asMutableRecord(asMutableRecord(asMutableRecord(cfg.plugins)?.entries)?.codex)?.config)?.appServer);
