...
import { A as theme, O as colorize, p as defaultRuntime } from "./subsystem-DBBM_0ww.js";
import "./utils-JhJvOE-Q.js";
import { $_ as POSIX_SHELL_WRAPPERS, Am as GATEWAY_CLIENT_MODES, Cu as isInterpreterLikeSafeBin, Du as evaluateExecAllowlist, Ou as evaluateShellAllowlist, Q_ as resolveExecutableFromPathEnv, Qm as startBrowserControlServiceFromConfig, Ts as resolveSystemRunCommandRequest, Tu as resolveExecSafeBinRuntimePolicy, Ut as resolveGatewayConnectionAuth, X_ as resolvePlannedSegmentArgv, Xm as createBrowserRouteDispatcher, Y_ as analyzeArgvCommand, Z_ as resolveCommandResolutionFromArgv, Zl as loadOrCreateDeviceIdentity, Zm as createBrowserControlContext, au as ensureExecApprovals, av as splitShellArgs, cu as mergeExecApprovalsSocketDefaults, ev as normalizeExecutableToken, gu as resolveExecApprovals, hu as requiresExecApproval, iu as addAllowlistEntry, iv as resolveInlineCommandMatch, jm as GATEWAY_CLIENT_NAMES, jr as withTimeout, ks as normalizeSystemRunApprovalPlan, ku as resolveAllowAlwaysPatterns, mh as resolveBrowserConfig, mu as recordAllowlistUse, nc as GatewayClient, nv as unwrapKnownShellMultiplexerInvocation, pu as readExecApprovalsSnapshot, q as formatHelpExamples, rv as POSIX_INLINE_COMMAND_FLAGS, td as getMachineDisplayName, tv as unwrapKnownDispatchWrapperInvocation, uu as normalizeExecApprovals, vu as saveExecApprovals, ws as formatExecCommand, x_ as loadConfig, xv as VERSION, yu as requestJsonlSocket, zm as writeJsonAtomic } from "./reply-kqyKJg4x.js";
import { i as resolveAgentConfig } from "./agent-scope-BwZuo7sQ.js";
import { s as sameFileIdentity } from "./openclaw-root-CGu4EGX8.js";
import { i as logWarn } from "./logger-B7cfoxgB.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-C-ZXrJon.js";
import "./registry-BbhZ8aJW.js";
import "./skills-3AC6GJLt.js";
import "./frontmatter-BngyYhS0.js";
import "./plugins-By9GTgrF.js";
import { N as detectMime } from "./query-expansion-yWVZ1kDa.js";
...
import { b as resolveNodeSystemdServiceName, f as formatNodeServiceDescription, x as resolveNodeWindowsTaskName, y as resolveNodeLaunchAgentLabel } from "./prompt-style-DxRe6Qmy.js";
import { t as formatDocsLink } from "./links-D5--5M_8.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-udml7YHk.js";
import "./runtime-guard-Dgkrqte4.js";
import "./issue-format-BB8-D-5K.js";
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-KjPhJyzI.js";
...
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CIy3MaCd.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CFqMWKt8.js";
import { t as parsePort } from "./parse-port-CPiG944U.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-nhSnTE2I.js";
import { t as resolveNodeService } from "./node-service-Chb_T5c5.js";
...
function unwrapPnpmExecInvocation(argv) {
	...
	while (idx < argv.length) {
		...
		if (!token.startsWith("-")) {
			if (token !== "exec" || idx + 1 >= argv.length) return null;
