...
import { t as collectIncludePathsRecursive } from "./includes-scan-CYsi9J5w.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-CYdMGzKO.js");
...
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-ZLHEJ6Ga.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-5St2MpK_.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-DWyLjE6t.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-CVQXpWoC.js");
