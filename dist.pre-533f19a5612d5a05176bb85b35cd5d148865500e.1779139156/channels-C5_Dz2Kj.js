...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-Dc-_HkVh.js";
import { t as WizardCancelledError } from "./prompts-WaJKTj3-.js";
import { t as createClackPrompter } from "./clack-prompter-BL521G3W.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-Mhy8SVJu.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-D8uT5zfa.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-rIxP9aBV.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-B2ppd6uX.js";
import { n as resolveLogFile } from "./log-tail-CbxJgudV.js";
import { t as parseLogLine } from "./parse-log-line-BNXt_gH7.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-CgFHNfFw.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-BEySpGjo.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-6wahiWIR.js";
import { t as channelsListCommand } from "./list-BPlvzWZP.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-a14aqMJB.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CEccWY-C.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-jj16Mkig.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BJ_tJagp.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-CJfBJ-_j.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DWmYvwnY.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-BI9YSIPN.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-Dofqwhfd.js");
