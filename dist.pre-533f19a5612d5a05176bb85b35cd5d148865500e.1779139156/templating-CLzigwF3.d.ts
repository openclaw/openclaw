...
import { d as MediaUnderstandingOutput, u as MediaUnderstandingDecision } from "./types-N0vvD1GV.js";
import { n as CommandArgs } from "./commands-args.types-DWr4mtVK.js";
...
type MsgContext = {
  ...
  GatewayClientScopes?: string[]; /** System-event authority override for contexts that must never inherit owner semantics. */
  ForceSenderIsOwnerFalse?: boolean; /** Thread identifier (Telegram topic id or Matrix thread event id). */
...
//#endregion
export { applyTemplate as a, createCommandTurnContext as c, isNativeCommandTurn as d, isTextSlashCommandTurn as f, TemplateContext as i, isAuthorizedTextSlashCommandTurn as l, MsgContext as n, CommandTurnContext as o, OriginatingChannelType as r, CommandTurnKind as s, FinalizedMsgContext as t, isExplicitCommandTurn as u };