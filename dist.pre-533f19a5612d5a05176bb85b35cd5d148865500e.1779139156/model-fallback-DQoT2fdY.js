...
import { r as emitFailoverEvent } from "./diagnostic-events-CTnmUQ59.js";
...
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-BE2QcZHI.js";
import { t as resolveAgentHarnessPolicy } from "./policy-BVV92T-W.js";
import { r as getRegisteredAgentHarness } from "./registry-Ds-bZfDD.js";
import { c as updateSessionStoreEntry } from "./store-B2VFp-yy.js";
import "./sessions-BBYUuUjx.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-DoxjMAkA.js";
import { i as buildModelAliasIndex, n as buildConfiguredAllowlistKeys, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-fWnBOAl-.js";
import { n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-B3eh25eT.js";
import { t as isCliProvider } from "./model-selection-cli-5M26oavY.js";
import { i as externalCliDiscoveryForProviders } from "./external-cli-discovery-CIdFH7Ij.js";
import { t as redactIdentifier } from "./redact-identifier-B4X5hGr3.js";
import { o as parseApiErrorInfo } from "./assistant-error-format-UFgypZLY.js";
import { o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-DF4us71R.js";
import { t as stableStringify } from "./stable-stringify-DlXUsXSs.js";
import { m as setCommandLaneConcurrency, u as isCommandLaneTaskTimeoutError } from "./command-queue-C-_VpIyT.js";
import { n as isCliRuntimeAlias } from "./model-runtime-aliases-BjCkEewK.js";
import "./pi-embedded-helpers-DkJj41ky.js";
import { g as isLikelyContextOverflowError, r as classifyProviderRuntimeFailureKind } from "./errors-BJxHmbSD.js";
import { a as isNonProviderRuntimeCoordinationError, i as isFailoverError, n as coerceToFailoverError, o as isTimeoutError, r as describeFailoverError, t as FailoverError } from "./failover-error-Ck_NFSPI.js";
import { i as resolveStoredSessionKeyForSessionId } from "./session-riH-CXKT.js";
...
async function assertModelFallbackCandidateHarnessAvailable(params) {
	...
	if (isCliProvider(params.provider, params.cfg)) return;
	...
	if (agentRuntime !== "auto" && agentRuntime !== "pi" && !(agentRuntime === "codex" && agentRuntimeSource === "implicit") && !getRegisteredAgentHarness(agentRuntime)) throw new MissingAgentHarnessError(agentRuntime);
}
...
//#endregion
export { suspendSession as a, shouldAllowCooldownProbeForReason as c, resolveSessionSuspensionReason as i, buildApiErrorObservationFields as l, runWithImageModelFallback as n, LiveSessionModelSwitchError as o, runWithModelFallback as r, MissingAgentHarnessError as s, isFallbackSummaryError as t, buildTextObservationFields as u };
