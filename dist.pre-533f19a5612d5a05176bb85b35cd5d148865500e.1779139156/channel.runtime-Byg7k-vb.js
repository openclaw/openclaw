...
import "./accounts-kogxAm6H.js";
import "./runtime-api-Cfi5tT1y.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-C2rzixhk.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-D8k2Ye1u.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CEdnxKmY.js");
