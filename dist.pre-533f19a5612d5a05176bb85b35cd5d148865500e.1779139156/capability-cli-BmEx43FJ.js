...
import { r as callGateway, u as randomIdempotencyKey } from "./call-ICzU8dj9.js";
...
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-CB9ykO9b.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-BkTv4N-T.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-riH-CXKT.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DGuburJC.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-DmDTs3cw.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, d as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsProvider, u as listSpeechVoices, w as setTtsPersona } from "./tts-runtime-D7YdgitZ.js";
import "./tts-DlQdgeTN.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BAyAPAad.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-XzRCARNU.js";
import { t as resolveMemorySearchConfig } from "./memory-search-QUs8XflC.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Kje-tJ_A.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-4fI3u6Eh.js";
...
import { t as collectOption } from "./helpers-DX6wAk36.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-CgabgCYK.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Cm42SVjA.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-D5LnxQnc.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-4tQhf4Fb.js");
