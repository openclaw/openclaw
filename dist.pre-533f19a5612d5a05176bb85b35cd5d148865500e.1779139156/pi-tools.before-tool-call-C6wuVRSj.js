...
import { _ as getPluginSessionExtensionStateSync } from "./loader-BYLJKEY2.js";
...
import { a as getActivePluginRegistry } from "./runtime-DjU5FNdN.js";
import { i as resolveSandboxInputPath } from "./sandbox-paths-P3bbVn3i.js";
import { i as listChannelPlugins, t as getChannelPlugin } from "./registry-BstTfco-.js";
...
import { n as copyPluginToolMeta } from "./tools-ZppY3xBL.js";
import { c as resolveMessageActionDiscoveryChannelId, l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext, s as resolveCurrentChannelMessageToolDiscoveryAdapter } from "./message-action-discovery-DGTVJBWu.js";
import { n as channelPluginHasNativeApprovalPromptUi, t as NATIVE_APPROVAL_PROMPT_RUNTIME_CAPABILITY } from "./native-approval-prompt-CohJCqDR.js";
import { r as diagnosticHttpStatusCode, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-DbZAMoVQ.js";
import { a as createLazyRuntimeSurface } from "./lazy-runtime-D1JZEsvL.js";
import { t as adjustedParamsByToolCallId } from "./pi-tools.before-tool-call.state-BP82k6s4.js";
...
//#endregion
export { listChannelSupportedActions as _, hasBeforeToolCallPolicy as a, resolveChannelReactionGuidance as b, isToolWrappedWithBeforeToolCallHook as c, testing as d, wrapToolWithBeforeToolCallHook as f, listChannelAgentTools as g, listAllChannelSupportedActions as h, copyBeforeToolCallHookMarker as i, runBeforeToolCallHook as l, getChannelAgentToolMeta as m, buildBlockedToolResult as n, isAbortSignalCancellation as o, copyChannelAgentToolMeta as p, consumeAdjustedParamsForToolCall as r, isBeforeToolCallBlockedError as s, BeforeToolCallBlockedError as t, setBeforeToolCallDiagnosticsEnabled as u, resolveChannelMessageToolHints as v, resolveChannelPromptCapabilities as y };
