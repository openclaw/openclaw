...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-xUJlrBLy.js";
...
import { a as resetModelCatalogCache } from "./model-catalog-D1vN0p9x.js";
...
import { r as resetDirectoryCache } from "./target-resolver-DvW_-iao.js";
...
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-C6BlrZW3.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CsbK7erf.js";
...
import { t as buildGatewayCronService } from "./server-cron-CHSxmObj.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DCq0N0SU.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-CMxucWmi.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-BrT70O3v.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-DaAy8v8i.js"), import("./gmail-watcher-lifecycle-C7Pw_qMX.js")]);
