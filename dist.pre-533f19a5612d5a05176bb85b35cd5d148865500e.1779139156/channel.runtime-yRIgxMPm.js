...
import { a as sendMessageMatrix, l as sendTypingMatrix, o as sendPollMatrix } from "./send-DKIORsj1.js";
...
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-6nN3_-o9.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));
