...
import { f as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-DmDTs3cw.js";
import { t as formatHelpExamples } from "./help-format-DCj9N3ZZ.js";
import { t as runSecurityAudit } from "./audit-rfah1I_e.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-DslYCkMh.js");
