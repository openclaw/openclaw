...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-rEK73C2c.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-xUJlrBLy.js";
...
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-BYLJKEY2.js";
...
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-mlY-WoBh.js";
...
import { u as extractDeliveryInfo } from "./sessions-BBYUuUjx.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-BjHvxzTf.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-CnUembkB.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-BkTv4N-T.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-MwbyxZGa.js";
import "./auth-profiles-DID26F4z.js";
import { n as resolveApiKeyForProfile } from "./oauth-BBYus6eq.js";
import { n as listProfilesForProvider } from "./profile-list-Brq_BpG5.js";
import { i as resolveAuthProfileOrder } from "./order-cI3DBvhe.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-DD3QApPW.js";
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-BQq0baM1.js";
...
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-C6x4xGkI.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BR86G80s.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, l as resolveSubagentSpawnOwnership, r as SUBAGENT_SPAWN_CONTEXT_MODES, t as spawnSubagentDirect } from "./subagent-spawn-DXI9Mvbh.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-lWC1U0I7.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-BkgriJWb.js";
...
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-TNKBNK4H.js";
...
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-yg18gdq_.js";
...
import { n as resolveContinuationRuntimeConfig, t as clampDelayMs } from "./config-4qzXUepR.js";
...
import { a as resolvePluginTools } from "./tools-ZppY3xBL.js";
...
import { _ as listChannelSupportedActions, c as isToolWrappedWithBeforeToolCallHook, f as wrapToolWithBeforeToolCallHook, h as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-C6wuVRSj.js";
...
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BROtKVUm.js";
...
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-B_TXF-I8.js";
import { n as runWithImageModelFallback } from "./model-fallback-DQoT2fdY.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-C_frAJIj.js";
...
import { a as getActiveSecretsRuntimeSnapshot$1, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-D4FMhBY0.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-D5WBc_qL.js";
...
import { r as parseImageGenerationModelRef } from "./provider-registry-Dm80uWPS.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-Cc5hTPKf.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-Cp0YwUpE.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-0WqfZtW6.js";
...
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-DuYpYO2A.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-yx8ph0pk.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-DfegEQnU.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DPWl9KWR.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BtkOhDV3.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-HDgri2Lz.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-oj8exofi.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CmSrKRxR.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BHot8e36.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-DGuburJC.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-qcuo6BK4.js";
import { s as resolveTimeoutMs } from "./resolve-Cvjruduj.js";
import { t as buildProviderRegistry } from "./runner-DlZpwcRd.js";
...
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-DmDTs3cw.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-CQVK_HjV.js";
...
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-DRKOE2Zq.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-CTm924pa.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BjkbgKHx.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-CMDvHSwk.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-BrIoHDvP.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-DSCaSP8L.js";
import { p as registerSubagentRun } from "./subagent-registry-B9C-kJQH.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DXHJh4J4.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-4pNYubUt.js";
...
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BAyAPAad.js";
...
import { i as runWebSearch } from "./runtime-XzRCARNU.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-CO16Bmcq.js");
		await sendMessage({
			cfg: params.config,
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-DCf43nwa.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-DC86WSRb.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-jDeBMraM.js"));
