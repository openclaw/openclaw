...
import { A as applyConfigOverrides, f as readConfigFileSnapshotWithPluginMetadata } from "./io-rEK73C2c.js";
...
import { a as prepareSecretsRuntimeFastPathSnapshot, o as resolveRefreshAgentDirs } from "./runtime-fast-path-DqgrYyR0.js";
import { a as getActiveSecretsRuntimeSnapshot, l as setPreparedSecretsRuntimeSnapshotRefreshContext, o as getLiveSecretsRuntimeAuthStores, t as activateSecretsRuntimeSnapshotState } from "./runtime-state-DOjm4dlk.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-CDtFakOG.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-B2ia0eod.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = () => {
		secretsRuntimePromise ??= import("./runtime-CLKVzg4S.js");
		return secretsRuntimePromise;
	};
	const loadAuthProfiles = () => {
		authProfilesPromise ??= import("./auth-profiles-DdK_rwkd.js");
