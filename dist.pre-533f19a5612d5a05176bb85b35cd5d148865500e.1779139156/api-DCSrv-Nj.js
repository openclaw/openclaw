...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-C4UtfBWx.js";
import "./ssrf-runtime-R6sAwobj.js";
import "./text-utility-runtime-CHBV36pg.js";
import "./runtime-api-r6f5Ytg_.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-Bk8GfwD_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-DpgjxDwV.js")]);
			return {
