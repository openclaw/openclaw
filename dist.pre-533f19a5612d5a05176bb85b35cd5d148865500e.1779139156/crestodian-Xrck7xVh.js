...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-MrcoLYei.js";
import { r as resolveCrestodianOperation } from "./dialogue-ColFL7ev.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CrTY-WrP.js")).runCrestodianTui;
	opts.onReady?.();
