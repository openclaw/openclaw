import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-COYt_a-Z.js";
import { r as loadCrestodianOverview } from "./overview-MrcoLYei.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-DtGyIRIF.js")).planCrestodianCommand)({
		input,
		overview
	});
