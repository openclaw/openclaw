...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-rw2bYM9R.js";
...
import { s as updateSessionStore, v as resolveGroupSessionKey } from "./store-B2VFp-yy.js";
import "./sessions-BBYUuUjx.js";
import { a as resolveContextTokensForModel } from "./context-Bp9V5D3-.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-fWnBOAl-.js";
import { t as isCliProvider } from "./model-selection-cli-5M26oavY.js";
import { l as resolvePersistedOverrideModelRef } from "./model-selection-BkTv4N-T.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DF4us71R.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-DSifyx0L.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-dY63daNF.js";
...
import { c as resolveCliRuntimeExecutionProvider, o as listLegacyRuntimeModelProviderAliases } from "./model-runtime-aliases-BjCkEewK.js";
import "./pi-embedded-helpers-DkJj41ky.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-sKXsmk-j.js";
import { d as isContextOverflowError, g as isLikelyContextOverflowError, u as isCompactionFailureError, y as isTransientHttpError } from "./errors-BJxHmbSD.js";
import { a as copyReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-Cwph674D.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BxAqgm8A.js";
import { l as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-CJM3mFkO.js";
import { r as getCliSessionBinding } from "./cli-session-B2YEx-Rs.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-po-Uczsi.js";
import "./selection-4iMDCzYv.js";
import { u as parseReplyDirectives } from "./payloads-DSo0PM8D.js";
import { o as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-DQoT2fdY.js";
import { n as hasCotFramePrefix } from "./normalize-reply-BiqnLDvJ.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-X_aytu3k.js";
import { n as buildAgentRuntimeOutcomePlan } from "./build-C45XE-eo.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-D4O1vtMN.js";
import { t as runCliAgent } from "./cli-runner-BhfMEKT_.js";
import { n as HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT, t as GENERIC_EXTERNAL_RUN_FAILURE_TEXT } from "./agent-runner-failure-copy-CSx7Z7Il.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-Dzwum5c_.js";
import { a as resolveAgentTurnAttachments, n as createBlockReplyContentKey } from "./block-reply-pipeline-CuSG0xhB.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-Lu9VVi-B.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-BBc3EAPh.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-D-F97TrN.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-DxNzofAi.js");
						...
						const result = await runEmbeddedPiAgentDefault({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-C94f8ogS.js");
