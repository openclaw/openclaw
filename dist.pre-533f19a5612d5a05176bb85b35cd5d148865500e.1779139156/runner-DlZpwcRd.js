...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-DhlnlIlI.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-DGuburJC.js";
import { t as providerSupportsCapability } from "./provider-supports-BmupYi4k.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-Cvjruduj.js";
...
import { a as runCliEntry, c as extractGeminiResponse, d as isMediaUnderstandingSkipError, l as fileExists, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as MediaUnderstandingSkipError } from "./runner.entries-5P17PELH.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-Dcez4nt0.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-CrstUlGd.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-Bq6JedDd.js");
