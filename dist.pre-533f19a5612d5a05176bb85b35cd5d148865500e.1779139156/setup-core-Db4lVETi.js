...
import { u as prepareScopedSetupConfig } from "./setup-helpers-Dc-_HkVh.js";
import "./setup-DUCOBf0C.js";
import { a as resolveMatrixAccountConfig } from "./account-config-BLnFStw3.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-6WlNcWKM.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-B-M0XX9F.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BSJOo6n3.js";
import { n as updateMatrixAccountConfig } from "./config-update-CqQiSLxS.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DUHp1NrN.js");
