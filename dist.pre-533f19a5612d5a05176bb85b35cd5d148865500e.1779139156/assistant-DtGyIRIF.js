...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-B0aoe_s4.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-BU_uEXyy.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-DJATrT8-.js")).runEmbeddedPiAgent;
}
