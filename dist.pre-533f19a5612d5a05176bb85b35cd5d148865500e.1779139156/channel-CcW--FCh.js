...
import { s as hasConfiguredSecretInput } from "./types.secrets-11Owfj8f.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-9_btbLFO.js";
import { At as boolean, Et as array, Nn as record, Rn as string, Tn as object, Xn as union, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-Bmna8ihM.js";
import { n as ZodIssueCode } from "./compat-ze2wFLca.js";
import { r as buildChannelConfigSchema } from "./config-schema-gd9RYI9s.js";
import { f as renderMessagePresentationFallbackText, l as normalizeMessagePresentation } from "./payload-CB-WF17a.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-D1JZEsvL.js";
import { a as createActionGate } from "./common-DZFnGYgt.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BQh-_Y7d.js";
import { n as getSessionBindingService } from "./session-binding-service-t_H1eP6M.js";
import "./string-coerce-runtime-C6AjCoZ-.js";
import { n as describeAccountSnapshot } from "./account-helpers-DCK6SmeR.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DFuaL5sM.js";
import "./channel-core-DLQQNdcP.js";
import { r as buildSecretInputSchema } from "./secret-input-DEswPn5Z.js";
import { t as formatAllowFromLowercase } from "./allow-from-DpYYjgbt.js";
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-1pwdDcv-.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-ui9UHOCp.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-kbiB3jLp.js";
import { t as createSetupTranslator } from "./i18n-C3v1dWVq.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BjnK4Pvi.js";
import "./setup-DUCOBf0C.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-BIz-aicR.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-DX73ND2M.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CL121ZpD.js";
import "./channel-status-C1bs_3mh.js";
import "./channel-config-primitives-B_8yIkTf.js";
import "./channel-actions-Db6K5Nyn.js";
import { r as defineChannelMessageAdapter } from "./channel-message-De31klp8.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-DuptReVT.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-e1ursjei.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-CIu4RnV-.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-BxLRajML.js";
import { n as createFeishuSendReceipt } from "./send-result-CG-9hAlG.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-CxJxrNm8.js";
import { t as messageActionTargetAliases } from "./security-audit-HQsUZDo5.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-BHWMCk-g.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DYOtHgBW.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-DkNxAbt7.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-C8tsMgv0.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-B8aYeH9D.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-B8aYeH9D.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-BvlZiD-v.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Bpk2mTXu.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-DSOQ2doC.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-BQ7DF73c.js");
