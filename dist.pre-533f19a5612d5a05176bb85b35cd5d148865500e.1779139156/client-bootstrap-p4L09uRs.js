...
import { t as getActiveMatrixClient } from "./active-client-B1dsSBiy.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CxQn7qju.js"), import("./shared-xXAO3eOY.js")]).then(([clientModule, sharedModule]) => ({
