...
import { a as isDiagnosticsEnabled } from "./diagnostic-events-CTnmUQ59.js";
import { r as logVerbose } from "./globals-DaPK6X5S.js";
import { i as emitAgentEvent } from "./agent-events-DkpIHRmj.js";
import { f as markDiagnosticSessionProgress } from "./diagnostic-_EXjWARQ.js";
import { a as toAcpRuntimeError } from "./errors-zyHRqIKC.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-blEDc1ug.js";
import { o as generateSecureUuid } from "./secure-random-CKyp7Fy_.js";
import { l as markReplyPayloadAsTtsSupplement } from "./reply-reference-Cwph674D.js";
import { s as hasOutboundReplyContent } from "./reply-payload-BxAqgm8A.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-KPAekyLc.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-_FSXnKX8.js";
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-BOxlciQI.js";
import { a as resolveAgentTurnAttachments, c as appendRecentHistoryImageContext, i as loadAgentTurnMediaRuntime, o as resolveInlineAgentImageAttachments, r as createBlockReplyPipeline, s as hasInboundMedia } from "./block-reply-pipeline-CuSG0xhB.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-Bgg24lSY.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-CIdvF8uO.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-aVqHt-fJ.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-Cpi-SSoN.js";
import { r as prefixSystemMessage } from "./system-message-CTnhW_KH.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-CizuSO11.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-KaNyoEM0.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-C2vKiMRS.js";
...
const channelPluginRuntimeLoader = createLazyImportLoader(() => import("./plugins-CrANPHnz.js"));
const messageActionRuntimeLoader = createLazyImportLoader(() => import("./message-action-runner-BBrMmY0t.js"));
...
async function maybeApplyAcpTts(params) {
	...
	if (params.payload.isCompactionNotice || params.payload.isFallbackNotice) return params.payload;
