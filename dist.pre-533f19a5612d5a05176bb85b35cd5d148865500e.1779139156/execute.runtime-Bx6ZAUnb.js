...
import { d as resolveEventSessionKey, m as scopedHeartbeatWakeOptions } from "./session-key-CQewiu8n.js";
import { n as resolvePreferredOpenClawTmpDir } from "./tmp-openclaw-dir-DcfgoqmC.js";
import { a as shouldLogVerbose } from "./globals-DaPK6X5S.js";
import { t as applyPluginTextReplacements } from "./plugin-text-transforms-Blblyldv.js";
...
import { t as classifyFailoverReason } from "./errors-BJxHmbSD.js";
import { n as appendBootstrapPromptWarning } from "./bootstrap-budget-CJM3mFkO.js";
import { c as resolveFailoverStatus, t as FailoverError } from "./failover-error-Ck_NFSPI.js";
import { n as applySkillEnvOverridesFromSnapshot } from "./env-overrides-BznoBypi.js";
import "./skills-Cd6RO1yX.js";
import { t as getProcessSupervisor } from "./supervisor-DfpxOgjx.js";
import { a as createCliJsonlStreamingParser, i as shouldUseClaudeLiveSession, o as extractCliErrorMessage, r as runClaudeLiveSessionTurn, s as parseCliOutput } from "./claude-live-session-C1OlGyVc.js";
import { r as cliBackendLog } from "./log-Q5cvDY_N.js";
import { a as prepareCliPromptImagePayload, c as resolveSessionIdToSend, d as buildCliSupervisorScopeKey, f as resolveCliNoOutputTimeoutMs, l as resolveSystemPromptUsage, n as buildCliArgs, o as resolveCliRunQueueKey, r as enqueueCliRun, s as resolvePromptInput, u as writeCliSystemPromptFile } from "./helpers-Cuu9UW3W.js";
...
function appendCliOutputTail(tail, chunk) {
	...
	if (chunkBuffer.byteLength >= CLI_RUNNER_OUTPUT_TAIL_BYTES) return Buffer.from(chunkBuffer.subarray(chunkBuffer.byteLength - CLI_RUNNER_OUTPUT_TAIL_BYTES));
	const next = Buffer.concat([tail, chunkBuffer], tail.byteLength + chunkBuffer.byteLength);
	if (next.byteLength <= CLI_RUNNER_OUTPUT_TAIL_BYTES) return next;
	...
	try {
		return await enqueueCliRun(queueKey, async () => {
			...
			try {
				...
				if (result.exitCode !== 0 || result.reason !== "exit") {
					if (result.reason === "no-output-timeout" || result.noOutputTimedOut) {
						...
						if (params.sessionKey) {
							...
							executeDeps.enqueueSystemEvent(stallNotice, { sessionKey: resolveEventSessionKey(params.sessionKey, watchdogMainKey, watchdogScope) });
							executeDeps.requestHeartbeat(scopedHeartbeatWakeOptions(params.sessionKey, {
								source: "cli-watchdog",
								intent: "event",
								reason: "cli:watchdog:stall"
							}, watchdogMainKey, watchdogScope));
						}
				...
				const parsed = streamedJsonlOutput ?? parseCliOutput({
					raw: stdout,
					backend,
					providerId: context.backendResolved.id,
					outputMode,
