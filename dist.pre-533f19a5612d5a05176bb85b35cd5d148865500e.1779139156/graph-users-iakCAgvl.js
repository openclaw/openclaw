...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-C4UtfBWx.js";
import "./ssrf-runtime-R6sAwobj.js";
import "./security-runtime-DwcJQX5J.js";
import "./provider-http-DCt0yLc9.js";
import { t as getMSTeamsRuntime } from "./runtime-api-BhfCMI_B.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-B1Rf5K9O.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-C-r8H7CR.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-D4E02EO2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-Bt_eFbjt.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-Czvc4kyr.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
