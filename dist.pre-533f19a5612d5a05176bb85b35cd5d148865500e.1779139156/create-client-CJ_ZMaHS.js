...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-BkC7RAd5.js";
import "./config-BdJgQr0Y.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-B7EPrAoH.js"), import("./logging-DY1mP_of.js")]).then(([sdkModule, loggingModule]) => ({
