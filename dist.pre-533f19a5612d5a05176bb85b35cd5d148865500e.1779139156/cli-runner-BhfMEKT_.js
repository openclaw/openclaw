...
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-Didu0n64.js";
import { i as loadCliSessionHistoryMessages, o as buildAgentHookConversationMessages, r as loadCliSessionContextEngineMessages } from "./session-history-C_loOVBA.js";
import { a as buildAgentHookContext, i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-Ccjiz_fa.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-BgH_k2Cs.js");
