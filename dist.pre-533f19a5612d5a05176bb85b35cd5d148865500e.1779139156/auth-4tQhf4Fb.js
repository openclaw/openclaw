...
import { s as loadAuthProfileStoreForRuntime } from "./store-CB9ykO9b.js";
...
import { r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-BOr92Dhj.js";
import { n as clearAuthProfileCooldown } from "./usage-d2Z9YFZK.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-DZLTN2VS.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CEHd74lZ.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: async (url) => {
			const { openUrl } = await import("./onboard-helpers-7RovIH5p.js");
			await openUrl(url);
		},
