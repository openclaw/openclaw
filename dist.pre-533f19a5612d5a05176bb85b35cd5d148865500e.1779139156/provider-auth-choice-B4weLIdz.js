...
import { n as openUrl } from "./browser-open-D7xfDNl1.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DpRFZ4dL.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-C06rxRLT.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CEHd74lZ.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DMGNHgHu.js";
import { t as isRemoteEnvironment } from "./remote-env-BvPP1Pve.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-DkVepDUa.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-c9kG4tfL.js") };
