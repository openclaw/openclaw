...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-B2UNWjpz.js";
import "./channel-message-De31klp8.js";
import "./text-autolink-runtime-C7XOkJKq.js";
import { t as require_src } from "./src-BIt-XL9O.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-RHDCvWVT.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-ufbHNFe7.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-H2uHgAh0.js";
import { t as fromBuffer } from "./lib-ZA09IYgD.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BLqnIJk9.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-CM-ysFqd.js";
import { l as toRatio, n as decodeString } from "./Util-BpvO18QX.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CwGP_G9U.js";
import { t as APEv2Parser } from "./APEv2Parser-BDa2VjnM.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DmsrSmWa.js";
import { i as isStrictDirectRoom } from "./direct-room-BY2kb2il.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-B8nrN9fm.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CpDDTQfo.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CZk_UkoH.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BlZz8Mp3.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-D5a4U3M6.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-D_uOokgN.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-_Pzuk-yY.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-pE7-pspV.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DI42ondy.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DDq7H0rh.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Defdqit6.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DdVTRqDm.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CiHpP61L.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DRonCdLw.js")).WaveParser;
	}
};
//#endregion
