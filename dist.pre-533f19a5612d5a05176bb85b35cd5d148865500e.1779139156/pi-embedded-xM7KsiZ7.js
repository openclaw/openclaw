...
import { X as resolveProviderAuthProfileId, b as prepareProviderRuntimeAuth } from "./provider-runtime-CnUembkB.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CB9ykO9b.js";
import { n as sleepWithAbort } from "./backoff-eS-jP5b6.js";
import "./auth-profiles-DID26F4z.js";
import { n as markAuthProfileSuccess } from "./profiles-BOr92Dhj.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-cI3DBvhe.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-BhPhySxb.js";
...
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-d2Z9YFZK.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared-DD3QApPW.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-BQq0baM1.js";
...
import { i as pickFallbackThinkingLevel, s as normalizeTextForComparison } from "./pi-embedded-helpers-DkJj41ky.js";
import { S as parseImageSizeError, _ as isRateLimitAssistantError, a as formatAssistantErrorText, c as isBillingAssistantError, f as isFailoverAssistantError, g as isLikelyContextOverflowError, i as extractObservedOverflowTokenCount, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, x as parseImageDimensionError } from "./errors-BJxHmbSD.js";
import { a as copyReplyPayloadMetadata, d as setReplyPayloadMetadata, o as getReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-reference-Cwph674D.js";
...
import { C as createEmbeddedRunStageTracker, S as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, T as shouldWarnEmbeddedRunStageSummary, _ as resolveRateLimitProfileRotationLimit, _t as resolveRunLivenessState, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, b as createUsageAccumulator, bt as createEmbeddedRunReplayState, c as buildErrorAgentMeta, ct as extractPlanningOnlyPlanDetails, d as resolveActiveErrorContext, dt as resolveEmptyResponseRetryInstruction, f as resolveFinalAssistantRawText, ft as resolveIncompleteTurnPayloadText, g as resolveOverloadProfileRotationLimit, gt as resolveReplayInvalidFlag, h as resolveOverloadFailoverBackoffMs, ht as resolveReasoningOnlyRetryInstruction, i as selectAgentHarness, l as buildUsageAgentMetaFields, lt as resolveAckExecutionFastPathInstruction, m as resolveMaxRunRetryIterations, mt as resolvePlanningOnlyRetryLimit, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, p as resolveFinalAssistantVisibleText, pt as resolvePlanningOnlyRetryInstruction, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, st as STRICT_AGENTIC_BLOCKED_TEXT, u as createCompactionDiagId, ut as resolveAttemptReplayMetadata, v as resolveReportedModelRef, vt as resolveSilentToolResultReplyPayload, w as formatEmbeddedRunStageSummary, x as mergeUsageIntoAccumulator, xt as observeReplayMetadata, y as scrubAnthropicRefusalMagic, yt as shouldTreatEmptyAssistantReplyAsSilent } from "./selection-4iMDCzYv.js";
import { D as isStrictAgenticExecutionContractActive, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-CGx43QiE.js";
import { p as buildAgentHookContextChannelFields, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-CMZMJvt5.js";
import { i as listActiveProcessSessionReferences, r as resolveContextEngineCapabilities, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-5ad_udX6.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-DpCppZ8v.js";
import { c as resolveFailoverStatus, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-Ck_NFSPI.js";
import { l as runAgentCleanupStep } from "./attempt.tool-run-context-CCUT3K_M.js";
import { c as retireSessionMcpRuntimeForSessionKey, s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-BlDINCWL.js";
import "./pi-bundle-mcp-tools-Bmv0ylMW.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-C4a79nTi.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-Bmxu23e2.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-CjLkX4q8.js";
...
import { u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-B_TXF-I8.js";
import { a as suspendSession, c as shouldAllowCooldownProbeForReason, i as resolveSessionSuspensionReason, l as buildApiErrorObservationFields, o as LiveSessionModelSwitchError } from "./model-fallback-DQoT2fdY.js";
import { t as log$1 } from "./logger-SygyosNn.js";
import { d as resolveLiveToolResultMaxChars, f as sessionLikelyHasOversizedToolResults, p as truncateOversizedToolResultsInSession } from "./preemptive-compaction-BATZoGSj.js";
import "./tool-split-DDWcdoPk.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-zQp_W1Pl.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-riH-CXKT.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-DW5R7qlI.js";
import "./extra-params-C7EyXnxO.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-Cp0ymvoY.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-DA57Q25-.js";
import { r as buildAgentRuntimePlan } from "./build-C45XE-eo.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-C620sjcI.js";
...
import "./compact.queued-A5JROI5N.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-CqR38Pba.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-Cz8FZ_Sb.js";
