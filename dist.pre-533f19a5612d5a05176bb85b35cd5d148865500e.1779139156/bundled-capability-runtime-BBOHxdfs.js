import { t as discoverOpenClawPlugins } from "./discovery-DMZS_8FV.js";
...
import { n as getCachedPluginModuleLoader, t as createPluginModuleLoaderCache } from "./plugin-module-loader-cache-CXUDv7JF.js";
import { g as shouldPreferNativeModuleLoad, t as buildPluginLoaderAliasMap } from "./sdk-alias-BOEr7503.js";
import { t as createSubsystemLogger } from "./subsystem-BCvJ25zm.js";
import { n as withBundledPluginEnablementCompat, r as withBundledPluginVitestCompat } from "./bundled-compat-CdOfTGp4.js";
import { n as resolveBundledPluginRepoEntryPath } from "./bundled-plugin-metadata-DrhD3AM4.js";
import { t as unwrapDefaultModuleExport } from "./module-export-BAPJF_NB.js";
import { t as buildPluginApi } from "./api-builder-db3KLd67.js";
import { F as createEmptyPluginRegistry } from "./runtime-DjU5FNdN.js";
import { n as normalizePluginToolContractNames, o as normalizeAgentToolResultMiddlewareRuntimes, t as findUndeclaredPluginToolNames } from "./tool-contracts-BMY8Z5U4.js";
		...
		api: buildPluginApi({
			...
			handlers: {
				registerCli(registrar, opts) {
					const parentPath = (opts?.parentPath ?? []).map((segment) => segment.trim()).filter(Boolean);
