...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-B_0GcMbf.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-DoHiQuX3.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-Pq143vaT.js");
