...
import { C as resolvePluginControlPlaneFingerprint } from "./plugin-registry-Cb7myZKf.js";
...
import { $ as resolveProviderRuntimePlugin, _ as normalizeProviderToolSchemasWithPlugin, f as inspectProviderToolSchemasWithPlugin } from "./provider-runtime-CnUembkB.js";
...
import { d as isGoogleModelApi } from "./pi-embedded-helpers-DkJj41ky.js";
import { o as normalizeTargetForProvider } from "./target-id-resolution-CvjQCD6d.js";
import { r as splitMediaFromOutput } from "./parse-LbSMA1MA.js";
import { t as pluginRegistrationContractRegistry } from "./registry-oAh9-BCW.js";
import { t as log$1 } from "./logger-SygyosNn.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-DBCMc-LA.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-CbQiRzFi.js");
...
//#endregion
export { supportsModelTools as S, sanitizeToolArgs as _, logAgentRuntimeToolDiagnostics as a, isMessagingTool as b, normalizeProviderToolSchemas as c, extractToolErrorMessage as d, extractToolResultMediaArtifact as f, isToolResultTimedOut as g, isToolResultError as h, shouldAllowProviderOwnedThinkingReplay as i, runAgentCleanupStep as l, filterToolResultMediaUrls as m, createAgentToolResultMiddlewareRunner as n, normalizeAgentRuntimeTools as o, extractToolResultText as p, resolveTranscriptPolicy as r, logProviderToolSchemaDiagnostics as s, buildEmbeddedAttemptToolRunContext as t, extractMessagingToolSend as u, sanitizeToolResult as v, isMessagingToolSendAction as x, collectTextContentBlocks as y };
