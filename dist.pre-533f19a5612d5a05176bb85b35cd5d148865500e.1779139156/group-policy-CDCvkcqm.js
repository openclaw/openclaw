...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-DOgy1dPd.js";
import "./client-C3QUwp3i.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-rVmBrU-y.js";
import { c as parseIMessageTarget } from "./targets-CDQFKaKR.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-D-gyZMfe.js";
import "./probe-BIjGcDpE.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-DF7FECJg.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-DbWOLJOr.js");
