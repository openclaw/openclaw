...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-rEK73C2c.js";
...
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-CZ1LQivk.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-DxmB9DPp.js";
import { t as note } from "./note-DcSFFDmR.js";
import { t as asObjectRecord } from "./object-CU10En3N.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-BLa_6s_Z.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-_ZPrTHo3.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DNoaBMjw.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CZ4lJkuX.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DGEeDw0Y.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DFQJkQpb.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DkwQDK6X.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BXTQdMv2.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CqvzbLFr.js");
		emitDoctorNotes({
			note,
