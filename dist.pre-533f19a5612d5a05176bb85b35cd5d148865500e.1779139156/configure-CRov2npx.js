...
import { t as ConfigMutationConflictError } from "./mutate-BmCvX0sT.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-KYB6brEp.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-Clf7i_Vd.js";
import { n as applyAuthChoice } from "./auth-choice-B_HGsjOX.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Bs4Ld0Zp.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CJQeC2bm.js";
import { t as promptCustomApiConfig } from "./onboard-custom-DwBCetb_.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CJMaiY1P.js";
import { n as formatHealthCheckFailure } from "./health-format-D7gmK9Kd.js";
import { n as healthCommand } from "./health-DW5FDCy7.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-xp-teiEE.js";
import { t as setupSkills } from "./onboard-skills-rQN1G1V9.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-B1A1mwD2.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Crbnf235.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-Q5wX-vXo.js");
