...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-Diobdu-L.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-c9kG4tfL.js");
