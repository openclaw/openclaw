...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-BxAqgm8A.js";
...
import { m as DiscordError } from "./discord-DUWMhlOY.js";
import { t as chunkDiscordTextWithMode } from "./chunk-CMUyFdrO.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-1w7TMgyM.js";
import { t as createDiscordSendReceipt } from "./send.receipt-CR1nqbZA.js";
import { s as readDiscordComponentSpec } from "./components-ukAx6PF1.js";
import { n as notifyDiscordInboundEventOutboundPayloadSuccess } from "./inbound-event-delivery-BFvj-bUf.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-BWNE-ykg.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-D12fwFpA.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-C3xj_a9a.js");
