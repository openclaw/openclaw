...
import { t as resolveChannelApprovalAdapter } from "./plugins-3tO_yYSp.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-C7m_ggTG.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-DP6HewpI.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeEnv } from "./runtime-state-DOjm4dlk.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-D3CL3uMY.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-BEvLoFvD.js";
import { r as createResolverContext } from "./runtime-shared-BmQLY6Bz.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-DqUjvuNg.js";
import { l as roleScopesAllow } from "./pairing-token-F_-DPDtJ.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-B9-YHlDa.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-BcsOmrmz.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CioGglMo.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BFGGstDA.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-CiTYKDGV.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-CsbK7erf.js";
import { t as diffConfigPaths } from "./config-diff-BRcHAjRx.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-qzj_iJng.js";
...
import "./server-aux-methods-DWDQWV-7.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-CLKVzg4S.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-b5ajaxaD.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-DleZRJT1.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-BYY8ENT1.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
