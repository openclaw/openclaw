...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-DAIb1M35.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CcVLUEcR.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-D7xomrmo.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CLv7tX6m.js");
	if (params.argv) {
