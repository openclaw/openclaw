...
import { H as SafeBinProfileFixture } from "./types.tools-BbKI6Ria.js";
import { n as ReasoningLevel, o as VerboseLevel, r as ThinkLevel } from "./thinking.shared-OAMun_iY.js";
import { c as SessionSystemPromptReport, n as CliSessionBinding } from "./types-CeXGWBP7.js";
import { r as ContinueWorkRequest } from "./types-Dp_vFhVC.js";
import { o as enqueueSystemEvent } from "./system-events-CI1kcm2Z.js";
import { Y as PromptImageOrderEntry, c as SourceReplyDeliveryMode, i as PartialReplyPayload, u as ReplyPayload } from "./get-reply-options.types-Dr32ceD1.js";
import { n as InboundEventKind, t as InputProvenance } from "./input-provenance-3g6zMdnU.js";
import { B as DiagnosticRunFireReason } from "./diagnostic-events-Byx5b043.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-CEg4frHx.js";
import { t as CommandQueueEnqueueFn } from "./command-queue.types-BEy-u6my.js";
import { g as ExecAsk, v as ExecSecurity, y as ExecTarget } from "./exec-approvals-DjrRoPuh.js";
import { r as SandboxBackendExecSpec } from "./backend-handle.types-BSskeQcu.js";
import { t as FallbackAttempt } from "./model-fallback.types-Cc6tKGi5.js";
import { n as SkillSnapshot } from "./skills-C2YETeDl.js";
import { t as EmbeddedAgentExecutionPhase } from "./execution-phase-jaNbhGm0.js";
...
//#endregion
//#region src/agents/compaction-attribution.d.ts
...
//#endregion
//#region src/agents/tools/request-compaction-tool.d.ts
type RequestCompactionToolOpts = {
  /** Current session key (e.g. "telegram:12345"). */agentSessionKey?: string; /** Session id (the Pi session UUID). */
...
type RunEmbeddedPiAgentParams = {
  ...
  trigger?: EmbeddedRunTrigger; /** Low-cardinality firing reason for loop diagnostics. */
  fireReason?: DiagnosticRunFireReason; /** Run id that caused this run to be scheduled, when applicable. */
  parentRunId?: string; /** Stable cron job identifier populated for cron-triggered runs. */
  ...
  allowGatewaySubagentBinding?: boolean; /** Whether this run drains continue_delegate work staged during the turn. */
  drainsContinuationDelegateQueue?: boolean; /** Callback for continue_work to request a post-turn continuation. */
  continueWorkOpts?: {
  ...
  agentHarnessId?: string; /** Explicit runtime override selected for this turn. Unlike agentHarnessId, this may force PI. */
   ...
   */
  cleanupBundleMcpOnRunEnd?: boolean; /** Continuation: request_compaction tool opts (injected from execution context). */
...
//#endregion
export { normalizeHeartbeatToolResponse as C, HeartbeatToolResponse as S, EmbeddedPiRunResult as _, PromptMode as a, MessagingToolSourceReplyPayload as b, EmbeddedBlockChunker as c, AgentStreamParams as d, ClientToolDefinition as f, EmbeddedPiRunMeta as g, EmbeddedPiCompactResult as h, RequestCompactionToolOpts as i, AgentInternalEvent as l, ExecToolDefaults as m, EmbeddedRunTrigger as n, SilentReplyPromptMode as o, ExecElevatedDefaults as p, RunEmbeddedPiAgentParams as r, BlockReplyChunking as s, CurrentInboundPromptContext as t, OPENCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE as u, EmbeddedRunLivenessState as v, ReplyOperation as w, HEARTBEAT_RESPONSE_TOOL_NAME as x, MessagingToolSend as y };