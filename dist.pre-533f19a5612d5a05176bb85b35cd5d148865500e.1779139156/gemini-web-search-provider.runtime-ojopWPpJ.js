import { _ as readStringParam, p as readNumberParam } from "./common-DZFnGYgt.js";
import { o as createProviderHttpError, p as readProviderJsonObjectResponse, u as formatProviderHttpErrorMessage } from "./provider-http-errors-CrEd46gC.js";
import { a as wrapWebContent } from "./external-content-Ci5vbIwq.js";
import { a as buildUnsupportedSearchFilterResponse, b as withTrustedWebSearchEndpoint, d as readCachedSearchPayload, f as readConfiguredSecretString, g as resolveSearchTimeoutSeconds, h as resolveSearchCount, i as buildSearchCacheKey, l as parseIsoDateRange, m as resolveSearchCacheTtlMs, p as readProviderEnvValue, s as normalizeFreshness, x as writeCachedSearchPayload } from "./web-search-provider-common-6q1XZSJX.js";
import "./provider-http-DCt0yLc9.js";
import { r as resolveCitationRedirectUrl } from "./provider-web-search-KAb2i66V.js";
import { n as resolveGeminiConfig, r as resolveGeminiModel, t as resolveGeminiBaseUrl } from "./gemini-web-search-provider.shared-UJr6VaA2.js";
...
async function runGeminiSearch(params) {
	...
	return withTrustedWebSearchEndpoint({
		...
		const groundingChunks = groundingMetadata === void 0 ? [] : isRecord(groundingMetadata) && Array.isArray(groundingMetadata.groundingChunks) ? groundingMetadata.groundingChunks : void 0;
