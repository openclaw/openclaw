...
import { D as patchTopLevelChannelConfigSection, f as createStandardChannelSetupStatus } from "../../setup-wizard-helpers-BjnK4Pvi.js";
...
import { t as NostrConfigSchema } from "../../config-schema-lOtYotcb.js";
...
const nostrSetupWizard = createDelegatedSetupWizardProxy({
	channel,
	loadWizard: async () => (await import("../../setup-surface-DanZacU3.js")).nostrSetupWizard,
