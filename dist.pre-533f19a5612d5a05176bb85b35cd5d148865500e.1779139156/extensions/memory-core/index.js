...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-DDQQrAMD.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-2f5nEkSr.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-DSCNNZYG.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-DJFLqIVf.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-CymQAroy.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-CnPVx-Je.js");
