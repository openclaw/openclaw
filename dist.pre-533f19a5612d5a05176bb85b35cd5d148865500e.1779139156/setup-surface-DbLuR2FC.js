...
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BjnK4Pvi.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-B8jPT7Nr.js";
import { a as resolveMatrixAccountConfig } from "./account-config-BLnFStw3.js";
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-B772zx6f.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-6WlNcWKM.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-B-M0XX9F.js";
...
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-DwLO8FdG.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-C0dNfIOJ.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-pCrW7LQF.js");
