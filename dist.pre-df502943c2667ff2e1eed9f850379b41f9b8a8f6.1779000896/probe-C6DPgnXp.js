...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-Bp0llpsE.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-BVbo-XLx.js";
import { f as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-CjEdfzIt.js";
import { i as READ_SCOPE } from "./operator-scopes-Chm67yFb.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-NxKm_msZ.js");
