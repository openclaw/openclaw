...
import "./accounts-B_sLMxJF.js";
import "./runtime-api-M9IWHj45.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-4sV4YXg1.js";
import { t as sendMessageZalo } from "./send-DzHjRkz7.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CgpnPbmT.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-0kUXKf-y.js");
