...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-Cnxmg94X.js";
...
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-C9qItTiF.js";
import "./pi-bundle-mcp-tools-Bu5eBVtc.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-DDLnCAuC.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DZ6Sw2sL.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-DQfgLjnM.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-BWGeg3e7.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Bnk_I8Xx.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-Ul3t5mAs.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Bnk_I8Xx.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-OlZiJ5u0.js").then(({ scheduleOrphanRecovery }) => {
