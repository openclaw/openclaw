...
import { t as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs-DGyu-_25.js";
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-BQIupx5D.js";
import { a as isGatewayMethodClassified, t as CLI_DEFAULT_OPERATOR_SCOPES, u as resolveLeastPrivilegeOperatorScopesForMethod } from "./method-scopes-Dqs2Tf5_.js";
...
async function executeGatewayRequestWithScopes(params) {
	...
	return await new Promise((resolve, reject) => {
		...
		const client = gatewayCallDeps.createGatewayClient({
			...
			minProtocol: opts.minProtocol ?? 5,
			maxProtocol: opts.maxProtocol ?? 5,
