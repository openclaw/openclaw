...
const ProxyTlsConfigSchema = z.object({ caFile: z.string().min(1).optional() }).strict().optional();
const ProxyConfigSchema = z.object({
	enabled: z.boolean().optional(),
	proxyUrl: z.url().refine(isHttpOrHttpsProxyUrl, { message: "proxyUrl must use http:// or https://" }).register(sensitive).optional(),
