...
import { u as prepareScopedSetupConfig } from "./setup-helpers-C2owaOKH.js";
import "./setup-CXB3n1-3.js";
import { a as resolveMatrixAccountConfig } from "./account-config-D7v4hMgV.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-DeRxRjU7.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-DSDgwB-s.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-C9cV1k92.js";
import { n as updateMatrixAccountConfig } from "./config-update-Bq_47Skf.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-Dg4MHHzL.js");
