...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-DA5ZhsU2.js";
import "./client-1zHHktxj.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-IlGuMJcM.js";
import { c as parseIMessageTarget } from "./targets-BJMBKY3l.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-dtlLnEM3.js";
import "./probe-lokqjfED.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-CEUoQ9gH.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-BQgqJIv3.js");
