...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-ClNEONMJ.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-C42hYnXL.js";
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-M8cBnlBl.js";
...
import { i as parseModelRef, n as modelKey } from "./model-selection-normalize-D1wAzSpK.js";
import "./model-selection-Co5pqKAn.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DoGUVgfd.js";
import { t as resolveEnvApiKey } from "./model-auth-env-QEjoulVF.js";
import { r as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-Dc3S8wc9.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-D77BCc_n.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-CtLjrPrF.js";
import { n as loadModelsConfigWithSource } from "./load-config-C4eISroD.js";
import { n as formatErrorWithStack } from "./list.errors-B5pfpEnW.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-BmSostf8.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-C50MvNxK.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-BzmVRvyi.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-hpNVEUvG.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BYyqkQtc.js"),
		import("./agent-scope-Cfm19yoq.js"),
		import("./workspace-huUYKHdb.js")
	]);
