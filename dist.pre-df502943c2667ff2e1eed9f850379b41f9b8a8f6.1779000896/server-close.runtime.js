...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-DBZfkvL4.js";
import { i as listChannelPlugins } from "./registry-BDy7VEax.js";
import "./plugins-BwY4oKrD.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-C9qItTiF.js";
import "./pi-bundle-mcp-tools-Bu5eBVtc.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-C61hcJEB.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-C60IVNas.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-BYy7XoGV.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-B1eSM7i3.js");
