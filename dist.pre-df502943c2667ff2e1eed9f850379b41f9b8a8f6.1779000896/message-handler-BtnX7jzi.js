...
import { c as GATEWAY_STARTUP_PENDING_CLOSE_CAUSE, d as buildDeviceAuthPayloadV3, l as gatewayStartupUnavailableDetails, o as GATEWAY_STARTUP_CLOSE_CODE, s as GATEWAY_STARTUP_CLOSE_REASON, u as buildDeviceAuthPayload } from "./client-CjEdfzIt.js";
...
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-DWyq7dPP.js";
import "./version-BTB2M9zF.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-Chm67yFb.js";
import "./method-scopes-Dqs2Tf5_.js";
import { l as roleScopesAllow } from "./pairing-token-C5xJwFmP.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-OYE9VjyS.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-Emq6qCfi.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-Dou99SOo.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-J7UJoqBN.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-BiMYn2y6.js";
import { n as logWs, t as formatForLog } from "./ws-log-DbR6yKh4.js";
import { a as restoreDeviceBootstrapToken, c as verifyDeviceBootstrapToken, i as redeemDeviceBootstrapTokenProfile, n as getDeviceBootstrapTokenProfile, o as revokeDeviceBootstrapToken } from "./device-bootstrap-CEmu5Okz.js";
import { _ as verifyDeviceToken, c as listDevicePairing, f as requestDevicePairing, g as updatePairedDeviceMetadata, i as getPairedDevice, l as listEffectivePairedDeviceRoles, n as ensureDeviceToken, o as hasEffectivePairedDeviceRole, s as listApprovedPairedDeviceRoles, t as approveDevicePairing } from "./device-pairing-eI4AzeQ3.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-B4qVGzWe.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-Dm5vgWyk.js";
...
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-6XJOM6KL.js";
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			if (!client) {
				...
				const supportsCurrentProtocol = maxProtocol >= 5 && minProtocol <= 5;
				const supportsProbeRestartProtocol = connectParams.client.mode === GATEWAY_CLIENT_MODES.PROBE && maxProtocol >= 5 && minProtocol <= 5;
