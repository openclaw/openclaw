...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-BWnA6LIS.js";
import { u as readConfigFileSnapshot } from "./io-B6jpFTxl.js";
import "./config-BvLwr8dO.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-CxnoJl-o.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-Ck5ll9AX.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
