...
import { n as matrixSetupAdapter } from "./setup-core-4Zuy2Ppm.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-B_t5Cur_.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-C7OP1NRr.js";
import { t as withResolvedActionClient } from "./client-Cb4BxU41.js";
import { r as resolveMatrixAuthContext } from "./config-BpBYASGi.js";
import "./client-BR59k0ud.js";
import "./runtime-api-kdAejR3r.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-CtngaK7D.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CTsG1bjk.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-DlWvhTKN.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-DXI-brjE.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-Dg4MHHzL.js");
