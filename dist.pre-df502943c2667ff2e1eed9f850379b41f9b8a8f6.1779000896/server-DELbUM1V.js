...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-B5ejpWHy.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-_9Rw4bcU.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-C4CUlepl.js");
