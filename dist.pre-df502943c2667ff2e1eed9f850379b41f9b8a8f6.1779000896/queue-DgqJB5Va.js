...
import { n as resolveGlobalDedupeCache } from "./dedupe-Oq2TDGP3.js";
import { n as channelRouteDedupeKey, t as channelRouteCompactKey } from "./channel-route-CGy6-Eam.js";
import { t as getChannelPlugin } from "./registry-BDy7VEax.js";
import "./plugins-BwY4oKrD.js";
import { r as clearCommandLane } from "./command-queue-B_ee8LAq.js";
import { i as normalizeQueueMode, n as normalizePersistedQueueMode, r as normalizeQueueDropPolicy } from "./directive-BFfJUyBZ.js";
import { t as resolveEmbeddedSessionLane } from "./lanes-CW-KJnxG.js";
import { t as isRoutableChannel } from "./route-reply-34U-_Jm0.js";
			...
			while (queue.items.length > 0 || queue.droppedCount > 0) {
				...
				if (queue.mode === "collect") {
					const collectDrainResult = await drainCollectQueueStep({
						collectState,
						isCrossChannel: hasCrossChannelItems(queue.items, resolveCrossChannelKey) || queue.items.some(hasRuntimeOnlyFollowupMetadata),
						items: queue.items,
					...
					for (const groupItems of authGroups) {
						...
						if (pendingSummary) await runWithSummarySourceCleanup(queue, drainGroup);
...
//#endregion
export { clearSessionQueues as a, completeFollowupRunLifecycle as c, getFollowupQueueDepth as i, isFollowupRunAborted as l, resolveQueueSettings$1 as n, scheduleFollowupDrain as o, enqueueFollowupRun as r, refreshQueuedFollowupSession as s, resolveQueueSettings as t };
