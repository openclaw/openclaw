...
import { J as getShellEnvAppliedKeys, Q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-B6jpFTxl.js";
...
import { g as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CPGeF4ie.js";
import { s as openAIProviderUsesCodexRuntimeByDefault, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-M8cBnlBl.js";
...
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-D77BCc_n.js";
import "./workspace-DGfD448Y.js";
import { n as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-CtLjrPrF.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-CyBhknpQ.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-7eRrOc00.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-D_zfsS1y.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-BMQysvxP.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-BDJRyyIV.js");
		runtime.log("");
