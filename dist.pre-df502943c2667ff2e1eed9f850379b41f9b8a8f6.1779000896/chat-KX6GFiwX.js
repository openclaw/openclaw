...
import { o as resolveAgentWorkspaceDir } from "./agent-scope-config-BWnA6LIS.js";
import { d as measureDiagnosticsTimelineSpanSync, u as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-DOP9YWW2.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-C42hYnXL.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-wu-8nEST.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DgtT1s9n.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-B9xZ12q8.js";
import { r as setSafeTimeout } from "./timer-delay-Bp0llpsE.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-DWyq7dPP.js";
import { s as normalizeInputProvenance } from "./input-provenance-uYZeqLog.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-Chm67yFb.js";
...
import { t as isPassThroughRemoteMediaSource } from "./media-source-url-Cy5hK_SU.js";
import { i as resolveSessionFilePath } from "./paths-Bapt3qQT.js";
import "./sessions-Be8CbMNm.js";
import { o as isAudioFileName } from "./mime-DWfYSjGf.js";
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-R0nLubYs.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Pp-VxfGB.js";
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, x as resolveModelRefFromString } from "./model-selection-shared-D-NMyYXW.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-CxY3GBEI.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-Plnuh5up.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-DQ51FnrF.js";
import { n as resolveSendPolicy } from "./send-policy-B0mdpHpi.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-Dxgm53dW.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-Bbpfisa4.js";
import { c as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-YKCwdywY.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-BUr9zBQb.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-B8kwNxlf.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-ZVi1s-1A.js";
import { r as getSessionBindingService } from "./session-binding-service-3nrPrf0a.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BrM1IHEK.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-DCLnEJ7m.js";
import { n as rewriteTranscriptEntriesInSessionFile } from "./context-engine-maintenance-B5rGepXw.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-CNv3_2UU.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-DZADe1Ke.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-DkcuaEkJ.js";
...
import { t as formatForLog } from "./ws-log-DbR6yKh4.js";
import "./channel-message-DSuZIuT2.js";
import { t as logLargePayload } from "./diagnostic-payload-B4qVGzWe.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-Krz5yGbb.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-B8pWGR49.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-Dm5vgWyk.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-2I0z34J7.js";
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-GeiZuKBi.js";
import { a as resolveChatAttachmentLooksLikeImage, i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-ph4_Anzt.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-eEJ5X8g0.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-C8ed-edg.js";
