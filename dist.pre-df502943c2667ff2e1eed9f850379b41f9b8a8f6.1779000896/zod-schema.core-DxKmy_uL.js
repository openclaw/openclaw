...
import { a as formatExecSecretRefIdValidationMessage, o as isValidExecSecretRefId, s as isValidFileSecretRefId } from "./ref-contract-B9WpqK9E.js";
import { t as isSafeExecutableValue } from "./exec-safety-CjE6LosB.js";
...
const ModelAgentRuntimePolicySchema = z.object({ id: z.string().optional() }).strict().optional();
...
const ModelProviderLocalServiceSchema = z.object({
