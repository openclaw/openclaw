...
import { u as isPrivateIpAddress } from "./ssrf-CpTj1CHD.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-JUxmGfQ_.js";
import "./ssrf-runtime-c_uf32me.js";
import "./security-runtime-CWsR4PTL.js";
import "./provider-http-hWemHnGl.js";
import { t as getMSTeamsRuntime } from "./runtime-api-D3KXFMg-.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-LZy5NcB-.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-ChNz3r2g.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-C3-PPqwd.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-QVwr8l7P.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-BL9C0fZx.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
