...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-BAiBMReo.js");
...
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-JUfmN5Sv.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-CkVZ2V8u.js");
...
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-BIQ3pdV0.js");
