import { o as ModelDefinitionConfig } from "./types.models-BWww8ZiS.js";
import { t as ConfiguredModelProviderRequest } from "./types.provider-request-B1lzX_Rm.js";
import { n as RuntimeVersionEnv } from "./version-DcW9ceL0.js";
...
type ProviderEndpointClass = "default" | "anthropic-public" | "cerebras-native" | "chutes-native" | "deepseek-native" | "github-copilot-native" | "groq-native" | "mistral-public" | "moonshot-native" | "modelstudio-native" | "openai-public" | "openai-codex" | "opencode-native" | "azure-openai" | "openrouter" | "xai-native" | "xiaomi-native" | "zai-native" | "google-generative-ai" | "google-vertex" | "local" | "custom" | "invalid";
