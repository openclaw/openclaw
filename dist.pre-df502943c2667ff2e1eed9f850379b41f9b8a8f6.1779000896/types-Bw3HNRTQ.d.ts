...
declare const MIN_CLIENT_PROTOCOL_VERSION: 5;
declare const MIN_PROBE_PROTOCOL_VERSION: 5;
//#endregion
...
declare const ProtocolSchemas: {
  ConnectParams: _$typebox.TObject<{
    ...
    auth: _$typebox.TOptional<_$typebox.TObject<{
      ...
      approvalRuntimeToken: _$typebox.TOptional<_$typebox.TString>;
    }>>;
  ...
  AgentEvent: _$typebox.TObject<{
    ...
    isHeartbeat: _$typebox.TOptional<_$typebox.TBoolean>;
  ...
  MessageActionParams: _$typebox.TObject<{
    ...
    inboundEventKind: _$typebox.TOptional<_$typebox.TString>;
  ...
  AgentParams: _$typebox.TObject<{
    ...
    internalEvents: _$typebox.TOptional<_$typebox.TArray<_$typebox.TObject<{
      ...
      attachments: _$typebox.TOptional<_$typebox.TArray<_$typebox.TObject<{
        ...
        mediaUrl: _$typebox.TOptional<_$typebox.TString>;
        filePath: _$typebox.TOptional<_$typebox.TString>;
    ...
    sourceReplyDeliveryMode: _$typebox.TOptional<_$typebox.TUnion<[_$typebox.TLiteral<"automatic">, _$typebox.TLiteral<"message_tool_only">]>>;
  ...
  SecretsResolveParams: _$typebox.TObject<{
    ...
    providerOverrides: _$typebox.TOptional<_$typebox.TObject<{
      webSearch: _$typebox.TOptional<_$typebox.TString>;
      webFetch: _$typebox.TOptional<_$typebox.TString>;
    }>>;
  }>;
  ...
  SessionOperationEvent: _$typebox.TObject<{
    operationId: _$typebox.TString;
    operation: _$typebox.TLiteral<"compact">;
    phase: _$typebox.TUnion<[_$typebox.TLiteral<"start">, _$typebox.TLiteral<"end">]>;
    sessionKey: _$typebox.TString;
    ts: _$typebox.TInteger;
    completed: _$typebox.TOptional<_$typebox.TBoolean>;
    reason: _$typebox.TOptional<_$typebox.TString>;
  }>;
  ...
  SessionsPatchParams: _$typebox.TObject<{
    ...
    inheritedToolAllow: _$typebox.TOptional<_$typebox.TUnion<[_$typebox.TArray<_$typebox.TString>, _$typebox.TNull]>>;
    inheritedToolDeny: _$typebox.TOptional<_$typebox.TUnion<[_$typebox.TArray<_$typebox.TString>, _$typebox.TNull]>>;
  ...
  CronJob: _$typebox.TObject<{
    ...
    state: _$typebox.TObject<{
      ...
      lastFailureNotificationDelivered: _$typebox.TOptional<_$typebox.TBoolean>;
      lastFailureNotificationDeliveryStatus: _$typebox.TOptional<_$typebox.TUnion<[_$typebox.TLiteral<"delivered">, _$typebox.TLiteral<"not-delivered">, _$typebox.TLiteral<"unknown">, _$typebox.TLiteral<"not-requested">]>>;
      lastFailureNotificationDeliveryError: _$typebox.TOptional<_$typebox.TString>;
  ...
  CronRunLogEntry: _$typebox.TObject<{
    ...
    failureNotificationDelivery: _$typebox.TOptional<_$typebox.TObject<{
      delivered: _$typebox.TOptional<_$typebox.TBoolean>;
      status: _$typebox.TUnion<[_$typebox.TLiteral<"delivered">, _$typebox.TLiteral<"not-delivered">, _$typebox.TLiteral<"unknown">, _$typebox.TLiteral<"not-requested">]>;
      error: _$typebox.TOptional<_$typebox.TString>;
    }>>;
    sessionId: _$typebox.TOptional<_$typebox.TString>;
    sessionKey: _$typebox.TOptional<_$typebox.TString>;
...
//#endregion
export { CronStatusParams as $, ToolsInvokeResult as $n, SessionsResetParams as $t, ChannelsStatusParams as A, TalkSessionCreateParams as An, NodePairRemoveParams as At, ConfigPatchParams as B, TaskSummary as Bn, PluginsSessionActionResult as Bt, ArtifactsDownloadResult as C, TalkConfigParams as Cn, NodeEventResult as Ct, ArtifactsListResult as D, TalkSessionCancelOutputParams as Dn, NodePairApproveParams as Dt, ArtifactsListParams as E, TalkSessionAppendAudioParams as En, NodeListParams as Et, CommandEntry as F, TalkSessionSubmitToolResultParams as Fn, NodePendingEnqueueParams as Ft, CronAddParams as G, TasksListParams as Gn, SessionOperationEvent as Gt, ConfigSchemaResponse as H, TasksCancelResult as Hn, PresenceEntry as Ht, CommandsListParams as I, TalkSessionTurnParams as In, NodePendingEnqueueResult as It, CronListParams as J, ToolsCatalogParams as Jn, SessionsDeleteParams as Jt, CronGetParams as K, TasksListResult as Kn, SessionsCleanupParams as Kt, CommandsListResult as L, TalkSessionTurnResult as Ln, NodePresenceAlivePayload as Lt, ChannelsStopParams as M, TalkSessionJoinParams as Mn, NodePairVerifyParams as Mt, ChatEvent as N, TalkSessionJoinResult as Nn, NodePendingDrainParams as Nt, ChannelsLogoutParams as O, TalkSessionCancelTurnParams as On, NodePairListParams as Ot, ChatInjectParams as P, TalkSessionOkResult as Pn, NodePendingDrainResult as Pt, CronRunsParams as Q, ToolsInvokeParams as Qn, SessionsPreviewParams as Qt, ConfigApplyParams as R, TalkSpeakParams as Rn, NodePresenceAliveReason as Rt, ArtifactsDownloadParams as S, TalkClientToolCallResult as Sn, NodeEventParams as St, ArtifactsGetResult as T, TalkModeParams as Tn, NodeInvokeResultParams as Tt, ConfigSetParams as U, TasksGetParams as Un, RequestFrame as Ut, ConfigSchemaParams as V, TasksCancelParams as Vn, PollParams as Vt, ConnectParams as W, TasksGetResult as Wn, ResponseFrame as Wt, CronRunLogEntry as X, ToolsEffectiveParams as Xn, SessionsListParams as Xt, CronRemoveParams as Y, ToolsCatalogResult as Yn, SessionsDescribeParams as Yt, CronRunParams as Z, ToolsEffectiveResult as Zn, SessionsPatchParams as Zt, AgentsListParams as _, TalkCatalogParams as _n, ExecApprovalsSnapshot as _t, AgentWaitParams as a, SkillsDetailParams as an, WizardCancelParams as ar, EnvironmentSummary as at, AgentsUpdateResult as b, TalkClientCreateResult as bn, LogsTailParams as bt, AgentsDeleteParams as c, SkillsSearchParams as cn, WizardStartParams as cr, EnvironmentsStatusParams as ct, AgentsFilesGetParams as d, SkillsUpdateParams as dn, WizardStatusResult as dr, EventFrame as dt, SessionsResolveParams as en, UpdateRunParams as er, CronUpdateParams as et, AgentsFilesGetResult as f, SkillsUploadBeginParams as fn, WizardStep as fr, ExecApprovalGetParams as ft, AgentsFilesSetResult as g, StateVersion as gn, PROTOCOL_VERSION as gr, ExecApprovalsSetParams as gt, AgentsFilesSetParams as h, Snapshot as hn, MIN_PROBE_PROTOCOL_VERSION as hr, ExecApprovalsGetParams as ht, AgentSummary as i, SkillsBinsResult as in, WebLoginWaitParams as ir, EnvironmentStatus as it, ChannelsStatusResult as j, TalkSessionCreateResult as jn, NodePairRequestParams as jt, ChannelsStartParams as k, TalkSessionCloseParams as kn, NodePairRejectParams as kt, AgentsDeleteResult as l, SkillsSearchResult as ln, WizardStartResult as lr, EnvironmentsStatusResult as lt, AgentsFilesListResult as m, SkillsUploadCommitParams as mn, MIN_CLIENT_PROTOCOL_VERSION as mr, ExecApprovalResolveParams as mt, AgentIdentityParams as n, ShutdownEvent as nn, WakeParams as nr, DevicePairListParams as nt, AgentsCreateParams as o, SkillsDetailResult as on, WizardNextParams as or, EnvironmentsListParams as ot, AgentsFilesListParams as p, SkillsUploadChunkParams as pn, ProtocolSchemas as pr, ExecApprovalRequestParams as pt, CronJob as q, TickEvent as qn, SessionsCompactParams as qt, AgentIdentityResult as r, SkillsBinsParams as rn, WebLoginStartParams as rr, DevicePairRejectParams as rt, AgentsCreateResult as s, SkillsInstallParams as sn, WizardNextResult as sr, EnvironmentsListResult as st, AgentEvent as t, SessionsUsageParams as tn, UpdateStatusParams as tr, DevicePairApproveParams as tt, AgentsFileEntry as u, SkillsStatusParams as un, WizardStatusParams as ur, ErrorShape as ut, AgentsListResult as v, TalkCatalogResult as vn, GatewayFrame as vt, ArtifactsGetParams as w, TalkConfigResult as wn, NodeInvokeParams as wt, ArtifactSummary as x, TalkClientToolCallParams as xn, LogsTailResult as xt, AgentsUpdateParams as y, TalkClientCreateParams as yn, HelloOk as yt, ConfigGetParams as z, TalkSpeakResult as zn, PluginsSessionActionParams as zt };