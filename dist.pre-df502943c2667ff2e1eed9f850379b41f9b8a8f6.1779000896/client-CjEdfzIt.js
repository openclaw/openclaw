...
import { i as isLoopbackHost, s as isSecureWebSocketUrl } from "./net-DW8WQG5I.js";
import { a as publicKeyRawBase64UrlFromPem, o as signDevicePayload, r as loadOrCreateDeviceIdentity } from "./device-identity-CR5QKoIG.js";
import { t as normalizeFingerprint } from "./fingerprint-D7-Q8-Ri.js";
import { i as isSensitiveUrlQueryParamName } from "./redact-sensitive-url-BNvPvpoB.js";
...
import { t as resolveConnectChallengeTimeoutMs } from "./handshake-timeouts-CNgLRAsv.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-C3TwVdBd.js";
import { n as registerManagedProxyGatewayLoopbackBypass, t as ensureInheritedManagedProxyRoutingActive } from "./proxy-lifecycle-Un6POTtC.js";
import { t as rawDataToString } from "./ws-DbLTe5Oa.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-B9phDoFC.js";
import { f as readPairingConnectErrorDetails, l as readConnectErrorDetailCode, s as formatConnectErrorMessage, t as ConnectErrorDetailCodes, u as readConnectErrorRecoveryAdvice } from "./connect-error-details-De6wq2Ku.js";
import { At as validateRequestFrame, Y as validateEventFrame, jt as validateResponseFrame } from "./protocol-DWyq7dPP.js";
...
function formatGatewayClientErrorForLog(err) {
	return redactToolPayloadText(String(err).replace(/\/\/([^@/?#\s]+)@/g, "//***:***@").replace(/([?&])([^=&\s]+)=([^&#\s"'<>)]*)/g, (match, prefix, key) => isSensitiveUrlQueryParamName(key) ? `${prefix}${key}=***` : match));
}
...
var GatewayClient = class {
	...
	sendConnect() {
		...
		const params = {
			minProtocol: this.opts.minProtocol ?? 5,
			maxProtocol: this.opts.maxProtocol ?? 5,
			client: {
...
//#endregion
export { resolveGatewayClientConnectChallengeTimeoutMs as a, GATEWAY_STARTUP_PENDING_CLOSE_CAUSE as c, buildDeviceAuthPayloadV3 as d, loadDeviceAuthToken as f, describeGatewayCloseCode as i, gatewayStartupUnavailableDetails as l, GatewayClient as n, GATEWAY_STARTUP_CLOSE_CODE as o, GatewayClientRequestError as r, GATEWAY_STARTUP_CLOSE_REASON as s, GATEWAY_CLOSE_CODE_HINTS as t, buildDeviceAuthPayload as u };
