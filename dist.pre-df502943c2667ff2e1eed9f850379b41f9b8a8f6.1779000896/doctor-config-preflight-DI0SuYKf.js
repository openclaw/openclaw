...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-B6jpFTxl.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { t as note } from "./note-CJsA14EL.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CNIqgi_p.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-B5_KeIcI.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-B07Eqc39.js");
