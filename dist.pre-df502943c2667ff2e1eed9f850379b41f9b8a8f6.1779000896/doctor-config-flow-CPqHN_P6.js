...
import { n as discoverConfigSecretTargets } from "./target-registry-BFJgB0Tb.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-B6jpFTxl.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { r as normalizeTalkSection } from "./talk-CYT5osDH.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-DU2aLv7r.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DXrVPy_n.js";
import { n as getLoadedChannelPlugin } from "./registry-BDy7VEax.js";
import { i as listRouteBindings } from "./bindings-BnISnf9t.js";
import { i as legacyRuntimeModelAliasRequiresRuntimePolicy, o as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-K5vZoPt4.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-DpoqqJWO.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-CQRQe8_o.js";
import { t as note } from "./note-CJsA14EL.js";
import { t as asObjectRecord } from "./object-DugGaggr.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CNIqgi_p.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-CD8_bhwG.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BfTLPnYL.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DI0SuYKf.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-CuK81hVu.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-CUDLvrFp.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-6fpi8KhF.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-D20QgYdx.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-9_yj7cIv.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BQ4S3_fI.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-M6FU0BUV.js");
		emitDoctorNotes({
			note,
