import { n as BROWSER_REQUEST_GATEWAY_SCOPE, t as BROWSER_REQUEST_GATEWAY_METHOD } from "./browser-gateway-contract-BnHsJ6hf.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-Bqp3kyGG.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-C0bAB0On.js");
