import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue, s as normalizeOptionalLowercaseString, t as hasNonEmptyString } from "./string-coerce-LndEvhRk.js";
...
import { c as isRecord, g as shortenHomePath } from "./utils-CpmNtyoq.js";
import { n as VERSION } from "./version-B2G3zXnp.js";
import "./path-guards-BptIujoz.js";
import { l as tryReadJson, t as writeTextAtomic } from "./json-files-1SmAauRO.js";
...
import { l as BASE_THINKING_LEVELS } from "./thinking-Cq1bOxic.js";
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-D4IYF_Ih.js";
import { o as withFileLock } from "./file-lock-CCOJxG89.js";
import "./file-lock-n2tj_mjJ.js";
import "./config-BvLwr8dO.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-wu-8nEST.js";
...
import { i as asOptionalRecord } from "./record-coerce-DiB_AIRB.js";
import { s as isKnownCoreToolId } from "./tool-policy-shared-C1aFN6-6.js";
import { p as resolveOwnerOnlyToolApprovalClass } from "./tool-policy-Bk3UGpSR.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-CDNKjPyb.js";
import { r as isMutatingToolCall } from "./tool-mutation-CxS9LZ5o.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BnLNi-FX.js";
import { t as resolveGatewayClientBootstrap } from "./client-bootstrap-DdocNZ1S.js";
import { t as readSecretFromFile } from "./secret-file-hLWdylOb.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-_-XJ3sGG.js";
...
function createFileAcpEventLedger(params) {
	...
	const load = async () => {
		state.store = normalizeStore(await tryReadJson(params.filePath));
	};
...
const ACP_LIST_SESSIONS_MAX_FETCH_LIMIT = ACP_LIST_SESSIONS_MAX_CURSOR_OFFSET + ACP_LIST_SESSIONS_MAX_PAGE_SIZE + 1;
let acpCommandsModulePromise;
let acpSdkModulePromise;
async function getAvailableCommandsForAcp() {
	acpCommandsModulePromise ??= import("./commands-CAKL1iFq.js");
