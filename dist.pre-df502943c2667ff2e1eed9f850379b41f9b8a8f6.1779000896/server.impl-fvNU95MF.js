...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-GwU3cB_J.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-CpmNtyoq.js";
import { c as emitDiagnosticsTimelineEvent, l as isDiagnosticsTimelineEnabled } from "./plugin-metadata-snapshot-DOP9YWW2.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-B5w2gMXZ.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-1cnVnnDa.js";
import { n as createDiagnosticTraceContext, o as runWithDiagnosticTraceContext } from "./diagnostic-trace-context-B7EOHOXE.js";
import { a as isDiagnosticsEnabled, l as setDiagnosticsEnabledForProcess } from "./diagnostic-events-QP40Y1ku.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-CwZgZA6E.js";
import { _ as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts, v as isContainerEnvironment } from "./net-DW8WQG5I.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-BF96O9NO.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-D9txGPY0.js";
import { n as resolveGatewayAuth } from "./auth-resolve-gCe3cvBY.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-B6jpFTxl.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-BCdniHcd.js";
import { n as isRestartEnabled } from "./commands.flags-Bh-3SVDK.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-riS3oX7r.js";
import { n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, s as listCoreGatewayMethodNames, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-CwW7zXqN.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-Chm67yFb.js";
import "./method-scopes-Dqs2Tf5_.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-C2qaIpcE.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-CXBbTTBI.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-F7Wh4dvy.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-i-dc6V8W.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-C5J6hl53.js";
import { i as resolveMainSessionKey } from "./main-session-B4hR9U8Q.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-COpeBC3V.js";
import "./sessions-Be8CbMNm.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-C0jcyWM1.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-DOI6ZwF7.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-CjCLucsk.js";
import { a as enqueueSystemEvent } from "./system-events-B4ot3XuJ.js";
import { l as getTotalQueueSize } from "./command-queue-B_ee8LAq.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-Dmd2pqIt.js";
import { o as setFallbackGatewayContextResolver } from "./server-plugins-B6m5Wy9f.js";
import { r as resolveCronStorePath } from "./store-LfCE2GbH.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-Ce-aEyUG.js";
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-C61hcJEB.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BnLNi-FX.js";
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-J7UJoqBN.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-DbR6yKh4.js";
import { t as createDefaultDeps } from "./deps-CVhIlSEz.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-B4qVGzWe.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-Bbvmuo00.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-Dm5vgWyk.js";
import { t as GatewayLockError } from "./gateway-lock-BbBJJ3YZ.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DXE_l4A1.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-DUZSrsXy.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-CcGZs96L.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-D_Ryd3TI.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-eEBqFuLr.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-ZRoGLxhb.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-6XJOM6KL.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-D7r_8sNM.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-D6f5d3PH.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-CkbTFItO.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-JsE5S777.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-CfG9lr2A.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-DltImjuE.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-p5ANMrUT.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DhkH9I3R.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BHOUQOnM.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-CZq8k1K3.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-CGKlkfPa.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-jsjX2NCF.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-hMrrQg_X.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-BUqBnyZ8.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-BPJ-Tbl7.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CCRIvId2.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-BzbOZ64P.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-DzJ1Vxql.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-CACXaWQX.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-BhU-O26i.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-CmRA36dN.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-DLu5h-qM.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-DLu5h-qM.js");
		...
		const resolvePluginNodeCapabilityRoute = (pathContext) => findMatchingPluginNodeCapabilityRoute(resolveActivePluginHttpRouteRegistry(params.pluginRegistry), pathContext)?.nodeCapability;
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-Q5JEiJhj.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-BanumIcB.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-DClT6gMT.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-D8mdSqNy.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-HlxO89fu.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-BistdlfT.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-Q5JEiJhj.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-B_1PAlLR.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-9BscMRNQ.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-Bj0pTGZt.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-BCWfnAnC.js");
	const reloadHandlersModulePromise = import("./server-reload-handlers-YdQgheR6.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-C7AvN4Ne.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-C49BMrkM.js");
	...
	const { createChannelManager } = await import("./server-channels-CpD6Cxuh.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-9uqhSkh7.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-CqhgIhvj.js"), import("./server-runtime-services-Dy2-Cl1u.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-tJ7EveF3.js");
		const { coreGatewayHandlers } = await import("./server-methods-jne1CPm3.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-BnxXQ4Bk.js"),
				import("./server-plugin-bootstrap-C9jDUs7f.js"),
				import("./services-CH7cWxee.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-zdF_X1Hc.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-C9jDUs7f.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-Dc0zOWh5.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-Bxy4rUNL.js");
