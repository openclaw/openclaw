import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BtTxW8SH.js";
import { r as loadCrestodianOverview } from "./overview-DnU2dUdo.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-UcdgMyen.js")).planCrestodianCommand)({
		input,
		overview
	});
