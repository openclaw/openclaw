...
import { d as randomIdempotencyKey, i as callGateway } from "./call-DwPwapQo.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-CPGeF4ie.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-Co5pqKAn.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DWMJnYTM.js";
import { a as getModelsCommandSecretTargetIds, f as getWebFetchCommandSecretTargets, i as getMemoryEmbeddingCommandSecretTargetIds, m as getWebSearchCommandSecretTargets, u as getTtsCommandSecretTargetIds } from "./command-secret-targets-BVE_fG68.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-0DtwBNnk.js";
import "./tts-sZp9mOtm.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DQUT0voq.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-gl_xDk_N.js";
import { t as resolveMemorySearchConfig } from "./memory-search-wg3hOHpJ.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry--RBlnLM5.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-Dx7KRq5O.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-DlgBp3qQ.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-CY4m4tdX.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-DBVfwedm.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BT-fmIgk.js");
