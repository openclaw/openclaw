...
import { n as normalizePollInput } from "./polls-D-WUJM8T.js";
...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-DLzrPvmz.js";
import "./channel-message-DSuZIuT2.js";
import "./text-autolink-runtime-DVlhy2UF.js";
import { t as require_src } from "./src-4wWiBEBe.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-BhjNWf7t.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-BCmaWtYQ.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-Dsa99Faw.js";
import { t as fromBuffer } from "./lib-C-_dD3dI.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-B7lyENMg.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-u2kmHjcz.js";
import { l as toRatio, n as decodeString } from "./Util-bJPGj_zw.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BsPLIQd7.js";
import { t as APEv2Parser } from "./APEv2Parser-DZ-Gug32.js";
import { r as hasID3v1Header } from "./ID3v1Parser-dtlKQMrV.js";
import { i as isStrictDirectRoom } from "./direct-room-Daq7UVpg.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-Eh762mu-.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-PzTsNAR3.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-B_Sk4_PJ.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DnQoWlDX.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BSjJgCGN.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BY-brGY5.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BkSwza5x.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-JrhnYRY6.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-uXsQUJKU.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Ct-3Y3NP.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-D6wUnCGg.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BkzIwa_B.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-Cp_8EQOM.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-FrfTKX7Y.js")).WaveParser;
	}
};
//#endregion
