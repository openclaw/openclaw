...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-sDclNXNT.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-iVgxCrqD.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DpXnmJCi.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-Cwggsbh4.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-DHSjfnu4.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-D7adEcBe.js";
import "./channel-api-ma2ygSSJ.js";
import { t as parseDiscordTarget } from "./target-parsing-Boyot3d6.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DxsPWsiq.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-CWBFc2Qo.js";
import { t as getDiscordRuntime } from "./runtime-B4HGvcuW.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-BUpXuojr.js";
import { t as getDiscordApprovalCapability } from "./approval-native-BiBcdz_X.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-sB5xFmq4.js";
import { t as discordMessageActions$1 } from "./channel-actions-DWEI7r-s.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-CzhJ_FuJ.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-C5Qd8-jn.js";
import { n as discordOutbound } from "./outbound-adapter-D-qJBT3W.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-CP4prn9r.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-BV8an_F_.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BCOK6B49.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-B_KuCjpY.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-D5UJILG6.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-CmbTJ7T_.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-DXgyBeoZ.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-C-oIklNo.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-D4D-51rT.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-i9CSGfPo.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DeMBsgvf.js");
