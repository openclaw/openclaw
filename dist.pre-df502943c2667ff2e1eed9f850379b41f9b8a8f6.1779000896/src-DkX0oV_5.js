...
import { n as require_extend, t as require_package } from "./package-COakrpYA.js";
 ...
 /**
	...
	*/
	static async #getProxyAgent() {
		this.#proxyAgent ||= (await import("./dist-DFtAjnrE.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).HttpsProxyAgent;
		return this.#proxyAgent;
	}
	static async #getFetch() {
		const hasWindow = typeof window !== "undefined" && !!window;
		this.#fetch ||= hasWindow ? window.fetch : (await import("./src-Z0-2NnDb.js")).default;
		return this.#fetch;
	}
	/**
	* Merges headers.
