...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-gCl784XY.js";
import { t as enablePluginInConfig } from "./enable-De3IcG0G.js";
import "./auth-profiles-C4adYJH-.js";
import { o as upsertAuthProfileWithLock } from "./profiles-DMYNfGRA.js";
import "./workspace-DGfD448Y.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-nUBefUHb.js";
import { n as t } from "./i18n-D4Z7i7IV.js";
import { n as openUrl } from "./browser-open-Btl4CrsO.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-xv_G6Sb1.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-D2BOyuZp.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DOo2o0X2.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-BKAdtRC6.js");
		...
		if (codexInstall.installed) {
			const { offerPostInstallMigrations } = await import("./setup.post-install-migration-BYSaYG_Q.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-BP0LNMLp.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-C2EOWU2c.js");
