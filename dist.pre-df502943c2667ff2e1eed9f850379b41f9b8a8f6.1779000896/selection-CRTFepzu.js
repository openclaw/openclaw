...
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-BWnA6LIS.js";
...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-B4kPHBym.js";
import { a as hasInterSessionUserProvenance, i as applyInputProvenanceToUserMessage, r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-uYZeqLog.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BJZ8iszG.js";
import { t as resolveAgentHarnessPolicy } from "./policy-BabvJgc_.js";
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-Csud6ycf.js";
import { T as getCompactionProvider } from "./loader-i-dc6V8W.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-DAMYCUym.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-D9YraNzb.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-C5J6hl53.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-2sJBjayk.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-Cnxmg94X.js";
import { u as resolveStorePath } from "./paths-Bapt3qQT.js";
import { D as isCacheEnabled, O as resolveCacheTtlMs, T as createExpiringMapCache, t as loadSessionStore } from "./store-load-BKsOFpyS.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-CMYyQqdJ.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-Ba2LZdfG.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DWfYSjGf.js";
import { u as redactTranscriptMessage } from "./transcript-R0nLubYs.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Pp-VxfGB.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase, t as extractAssistantTextForPhase } from "./chat-message-content-CjC9AtYE.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-DAM7teg5.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DHlgOVkW.js";
...
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-CuLZvr8h.js";
...
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage } from "./usage-BimSzvmv.js";
import { C as firstEnumerableOwnKeys, S as boundedJsonUtf8Bytes, T as jsonUtf8BytesOrInfinity, _ as stripInternalMetadataForDisplay } from "./session-utils.fs-CxY3GBEI.js";
...
import { d as stripRuntimeContextCustomMessages, l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-B3PZNrKJ.js";
...
import { a as stripDowngradedToolCallText, d as findFinalTagMatches, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-PVZdIXLP.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-CTqsywmA.js";
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-CB4MRZOj.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-CF0uy0oR.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DcasbQCL.js";
import { n as extractToolResultId, o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-BrRsOX_v.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-VBRloEL2.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-fd79Zpvn.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Dxgm53dW.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-BwM1lROq.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-gOxrL_kF.js";
import { A as isEmbeddedMode, O as isStrictAgenticSupportedProviderModel, k as stripProviderPrefix, p as resolveToolLoopDetectionConfig } from "./openclaw-tools-D3btT5iz.js";
import { t as getMachineDisplayName } from "./machine-name-DG3rtvm9.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-_qFWxdgO.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-2y1ojuKk.js";
import { i as getPluginToolMeta } from "./tools-BZacpDf4.js";
import { n as redactConfigObject } from "./redact-snapshot-B-u8szO4.js";
import { n as resolveCommitHash } from "./git-commit-DjCermXe.js";
import { t as resolveOsSummary } from "./os-summary-D0R0dp_G.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CCgJQZrL.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-nlkHI_7m.js";
import { d as parseBooleanValue } from "./frontmatter-Co4m4q9z.js";
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-BILQTCG8.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DGfD448Y.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-BI6Mw6ou.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-DU2JLxqS.js";
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, v as resolveChannelPromptCapabilities, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-adJ5Y3Zd.js";
import { r as optionalStringEnum } from "./typebox-D8A0NJfq.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-lKu3f1lu.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-PFykj2T7.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-CxS9LZ5o.js";
...
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-YKCwdywY.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CLgHKEmp.js";
import { f as buildApiErrorObservationFields, p as buildTextObservationFields } from "./model-fallback-DJ4udacN.js";
import { t as log$5 } from "./logger-drL4w85E.js";
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-CPfeWYJB.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-DO7gY7gQ.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DTxTfAII.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-BV8BmgTu.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-BSCk3vK1.js";
...
import { n as buildSubagentList } from "./subagent-list-B8K8Xb65.js";
import { o as listControlledSubagentRuns } from "./subagent-control-9Vmf2v8j.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-DMMyB0HH.js";
...
import { s as buildCopilotIdeHeaders } from "./provider-auth-B-QKvd6x.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-Josk__NH.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-BOa-Ys6g.js";
import { o as resolveSandboxContext } from "./sandbox-DCLnEJ7m.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-B5rGepXw.js";
import { t as detectRuntimeShell } from "./shell-utils-CDB9z_MV.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DAwFnwE9.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-CSD3_-k7.js";
import "./skills-ZuKyg2SM.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-CbWBLVEi.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-DZOSfCYx.js";
import "./tool-loop-detection-C-py4FTX.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./proxy-stream-wrappers-Bp-K-qYK.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DDj1K2Lu.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-BbeHgpzt.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-3ELS-kbN.js";
import { t as extractSections } from "./post-compaction-context-CLhbGBfL.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-CNfBCRhx.js";
import "./query-D63GHq3l.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-DpoqqJWO.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-BfXz7HtN.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-DOc6EfhQ.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-BGy6Ht1g.js";
...
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-CswAeY9m.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-BVePQMpf.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CFSOQxtx.js";
import { t as detectAndLoadPromptImages } from "./images-JqCIPE2U.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-B_L5Eptz.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-zD2LJwye.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-CwSrZHAQ.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-ByeEwBOe.js"));
