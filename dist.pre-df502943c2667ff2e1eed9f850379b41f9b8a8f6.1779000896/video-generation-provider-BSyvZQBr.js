...
function readXaiStatusResponse(payload) {
	...
	if (!status || ![
		...
		"failed",
		"expired"
	].includes(status)) throw new Error(XAI_VIDEO_MALFORMED_RESPONSE);
