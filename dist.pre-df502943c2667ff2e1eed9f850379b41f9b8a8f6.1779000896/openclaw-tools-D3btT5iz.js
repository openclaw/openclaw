import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue, l as normalizeOptionalStringifiedId, s as normalizeOptionalLowercaseString } from "./string-coerce-LndEvhRk.js";
import { l as redactToolPayloadText } from "./redact-CxqQQvmK.js";
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-iZwpu-40.js";
...
import { S as hasEncodedFileUrlSeparator, T as trySafeFileURLToPath, t as appendFileWithinRoot } from "./fs-safe-D4r8mUJk.js";
import { o as root } from "./secure-temp-dir-GC3bO7Qi.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-CpmNtyoq.js";
import { r as normalizeProviderId } from "./provider-id-Cz7K6wgK.js";
import { a as resolveAgentModelTimeoutMsValue, i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-B9p-bobB.js";
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-C5uhMtO-.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, u as parseThreadSessionSuffix } from "./session-key-utils-CJRKuBJA.js";
import { n as normalizeAccountId } from "./account-id-9_btbLFO.js";
import { c as normalizeAgentId, g as toAgentStoreSessionKey, p as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CQewiu8n.js";
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BWnA6LIS.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-DOP9YWW2.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-M9JN_JCw.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-ClNEONMJ.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-B5w2gMXZ.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-1cnVnnDa.js";
import { a as normalizeDiagnosticTraceparent, t as DIAGNOSTIC_TRACEPARENT_PATTERN } from "./diagnostic-trace-context-pure-BTcJKynq.js";
import "./diagnostic-trace-context-B7EOHOXE.js";
import { t as createSubsystemLogger } from "./subsystem-CwZgZA6E.js";
import { t as logDebug } from "./logger-xPcOTHDV.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-B6jpFTxl.js";
import { h as isWindowsDrivePath } from "./archive-DZMFTTLp.js";
import { n as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-state-D14rXNRL.js";
import { n as modelKey } from "./model-ref-shared-gCl784XY.js";
import { t as applyMergePatch } from "./merge-patch-DwwaG75g.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-BCdniHcd.js";
...
import { n as isRestartEnabled } from "./commands.flags-Bh-3SVDK.js";
import { o as normalizeChannelId } from "./registry-GgtzeCf_.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-wu-8nEST.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DgtT1s9n.js";
import { u as normalizeMessageChannel } from "./message-channel-B9xZ12q8.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-De6wq2Ku.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-uYZeqLog.js";
import { i as callGateway } from "./call-DwPwapQo.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-C2qaIpcE.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-VsQ4bakl.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-i-dc6V8W.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-DbdMmy-5.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-Cnxmg94X.js";
import { n as assertSandboxPath } from "./sandbox-paths-CtvCbuVZ.js";
import "./local-file-access-B6Pr3O2b.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-Bcqfy2Z-.js";
import { h as stringifyRouteThreadId } from "./channel-route-CGy6-Eam.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-mlXU8Wcs.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-Bapt3qQT.js";
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BKsOFpyS.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BDy7VEax.js";
import { n as resolveSessionConversationRef } from "./session-conversation-RwgJsLAv.js";
import { s as updateSessionStore } from "./store-Ba2LZdfG.js";
import "./plugins-BwY4oKrD.js";
import { n as mergeSessionEntry } from "./types-CXS4Fv_X.js";
import { u as extractDeliveryInfo } from "./sessions-Be8CbMNm.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DWfYSjGf.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-Ih5VyHj6.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-D-NMyYXW.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-D1wAzSpK.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-Co5pqKAn.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-C3wPDsUr.js";
import "./auth-profiles-C4adYJH-.js";
import { n as resolveApiKeyForProfile } from "./oauth-CH2DKUWj.js";
import { n as listProfilesForProvider } from "./profile-list-furv_b84.js";
import { i as resolveAuthProfileOrder } from "./order-BQpk4NnE.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-Dc3S8wc9.js";
import { r as getApiKeyForModel } from "./model-auth-D77BCc_n.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-IzGESe5U.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Bln1BF0M.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-C1aFN6-6.js";
import "./tool-policy-Bk3UGpSR.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-CqJVfXB8.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-D15mzfNK.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-ukZWE_8u.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-BdJw_Gl6.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CodaZlaN.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BCmbC9jO.js";
import { r as loadModelCatalog } from "./model-catalog-BWQ8opyK.js";
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, w as jsonUtf8Bytes } from "./session-utils.fs-CxY3GBEI.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-DQ51FnrF.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CpaPlwtM.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CzDAeWnL.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-C1OuF0rr.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-PVZdIXLP.js";
import { n as extractTextFromChatContent } from "./chat-content-CTqsywmA.js";
import { r as stripToolMessages } from "./chat-history-text--EcAJP5d.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-CoyWsRK2.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-CF0uy0oR.js";
import { l as formatActiveContinuationTraceparent } from "./continuation-tracer-BgjZGLwk.js";
import "./targeting-fz9NnAdh.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-C8ETMWnz.js";
import { n as resolveContinuationRuntimeConfig } from "./config-DtUpYAh8.js";
import { t as canonicalizeBase64 } from "./base64-hmanhjai.js";
import { a as getImageMetadata } from "./image-ops-D4C6wL2g.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-VBRloEL2.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability--bO-hy4j.js";
import { a as resolvePluginTools } from "./tools-BZacpDf4.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-dbwIaAv4.js";
import { d as wrapToolWithBeforeToolCallHook, g as listChannelSupportedActions, l as isToolWrappedWithBeforeToolCallHook, m as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-adJ5Y3Zd.js";
...
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-PFykj2T7.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-fNLiFu1z.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DFWnhifO.js";
import { n as extractAssistantText } from "./pi-embedded-utils-Bd_A34WY.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-YKCwdywY.js";
import { n as runWithImageModelFallback } from "./model-fallback-DJ4udacN.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-CPfeWYJB.js";
import "./delivery-context-i0bLgbWP.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-B1bhqubD.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-Dmd2pqIt.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-D9vElIFx.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-C-qM0h0q.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-D7o_qpbv.js";
import { t as inferLegacyName } from "./normalize-Bgba4KKS.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-BEerkfUv.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-C_slVrKw.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-92KF0tSU.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-DKo4quj-.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DMbBhCYj.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BHKKofr1.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-CKwCnXT5.js";
import { u as saveMediaBuffer } from "./store-BUr9zBQb.js";
import { t as SsrFBlockedError } from "./ssrf-CpTj1CHD.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-BQ5V3og6.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BvBApn7y.js";
import { r as getDefaultLocalRoots } from "./local-media-access-ZVi1s-1A.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BmMPbe_h.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-BTucRZdg.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-BBOMQvZ2.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DDLnCAuC.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-ClYcvarm.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-CIHTPjZV.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-DIHRcT1a.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-7KFHIx82.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-O86bk10W.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DHNR4xXQ.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DbSzE97r.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-DWMJnYTM.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-CMumSFKh.js";
import { s as resolveTimeoutMs } from "./resolve-YcDAHtNa.js";
import { t as buildProviderRegistry } from "./runner-CTLi8KVJ.js";
import "./media-understanding-BeJ-dZmj.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CNZiPial.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-DWsGrwSi.js";
import { s as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BVE_fG68.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-CoOpwZqj.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-C5ag6zkq.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-Cz5u5Tcz.js";
import { t as parseTimeoutMs } from "./parse-timeout-Y20l1g03.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-L3hSIXEO.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DTNvCVQF.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-CzFz7dBk.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BhV6rF8a.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CFzY2eTA.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-kkW4jbRk.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DZ6Sw2sL.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-DQfgLjnM.js";
import { p as registerSubagentRun } from "./subagent-registry-ByOvmZLi.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-B8K8Xb65.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-9Vmf2v8j.js";
import { k as textToSpeech } from "./tts-runtime-0DtwBNnk.js";
import "./tts-sZp9mOtm.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-DsKInxD7.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-CsbupPmq.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DQUT0voq.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-15qMsjDL.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DmZJmEmd.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-CUsUjQ_A.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-CvWBVN4o.js";
import { i as runWebSearch } from "./runtime-gl_xDk_N.js";
import "./web-search-provider-common-x6-BsYXI.js";
...
async function appendMemoryFlushContent(params) {
	...
	if (!params.sandbox.bridge.appendFile) throw new Error(`Sandbox file bridge does not support safe append for memory flush: ${params.relativePath}`);
...
function wrapToolMemoryDayFileWriteGuard(tool, options) {
	const patterns = options?.patterns?.length ? options.patterns : [DEFAULT_MEMORY_DAY_FILE_PATTERN];
	const extendedParameters = tool.parameters && typeof tool.parameters === "object" ? {
		...tool.parameters,
		properties: {
	...
	return {
		...
		execute: async (toolCallId, args, signal, onUpdate) => {
			const record = getToolParamsRecord(args);
			const filePath = typeof record?.path === "string" && record.path.trim() ? record.path.trim() : void 0;
			if (!filePath || !patterns.some((p) => p.test(filePath))) return tool.execute(toolCallId, args, signal, onUpdate);
			if (record?.overwrite !== true) return {
				content: [{
					type: "text",
			...
			if (firstTextIdx >= 0) {
				...
				const block = updated[firstTextIdx];
...
function createHostWorkspaceAppendTool(root, options) {
	...
	return {
		...
		execute: async (_toolCallId, args, _signal) => {
			const record = getToolParamsRecord(args);
			const rawPath = typeof record?.path === "string" && record.path.trim() ? record.path.trim() : void 0;
			const content = typeof record?.content === "string" ? record.content : void 0;
			...
			if (workspaceOnly) {
				...
				return {
					content: [{
						type: "text",
						text: `Appended ${content.length} bytes to ${rawPath}`
					}],
...
//#endregion
//#region src/agents/tools/continue-delegate-tool.ts
const log$9 = createSubsystemLogger("continuation/delegate-tool");
...
const ContinueDelegateToolSchema = Type.Object({
	task: Type.String({
		description: "The delegated sub-agent's task. Treat this like a letter to your future self: include scope, chunk/range, desired return shape, and what the parent should do with the result.",
		maxLength: 4096
	}),
	delaySeconds: Type.Optional(Type.Number({
		minimum: 0,
		description: "Seconds to wait before spawning the delegate. 0 or omitted = immediate. Clamped to continuation.minDelayMs / maxDelayMs from config."
	})),
	mode: optionalStringEnum(DELEGATE_MODES, { description: "Return mode. \"normal\" = announces to channel (default). \"silent\" = result injected as internal context only, no channel echo; use for ambient enrichment and future recall. \"silent-wake\" = silent + triggers a new generation cycle so the agent can act on the enrichment immediately. \"post-compaction\" = silent-wake delegate that fires when compaction happens, not on a timer. Use for context evacuation: the shard starts at the moment of compaction and returns to the post-compaction session." }),
	targetSessionKey: Type.Optional(Type.String({ description: "Address one specific session on this host for the delegate's return. Use when a child should return enrichment to an ancestor, sibling, or root session instead of the dispatching session." })),
	targetSessionKeys: Type.Optional(Type.Array(Type.String(), { description: "Address multiple sessions on this host for byte-identical fan-out return. Each listed session receives the same delegate completion payload through the session-delivery queue." })),
	fanoutMode: optionalStringEnum(FANOUT_MODES, { description: "Broadcast return targeting. \"tree\" returns to every ancestor in the current continuation/subagent chain; \"all\" returns to every known session on this host. Do not combine with targetSessionKey/targetSessionKeys." }),
...
function readStrictStringArrayParam(params, key) {
	const raw = readSnakeCaseParamRaw(params, key);
	if (raw === void 0) return;
	if (!Array.isArray(raw)) throw new ToolInputError(`${key} must be an array of non-empty strings.`);
	if (raw.length === 0) throw new ToolInputError(`${key} must include at least one session key.`);
	const values = [];
	for (const entry of raw) {
		if (typeof entry !== "string" || !entry.trim()) throw new ToolInputError(`${key} must contain only non-empty strings.`);
...
*/
function createContinueDelegateTool(opts) {
	let delegatesThisTurn = 0;
	return {
		label: "Continuation",
		name: "continue_delegate",
		description: "Schedule a continuation delegate — a background sub-agent that can run now, later, or at compaction, then return visibly or silently to this session. Use for ambient enrichment, chunked/aspected fan-out, or preserving working state across compaction. Use \"silent-wake\" when the result should quietly enrich context and wake you to act. Can be called multiple times per turn for parallel fan-out while the main session stays free. Return targeting modes: default returns to the dispatching session; targetSessionKey returns to one other session; targetSessionKeys returns byte-identical enrichment to multiple sessions; fanoutMode=tree returns to all ancestors in the chain; fanoutMode=all returns to all known sessions on this host. Prefer this over exec or raw sessions_spawn when the goal is gateway-managed delayed/silent/wake-on-return delegate work. This is the (a)-shape continuation surface: explicit recipient-addressing via the session-delivery-queue substrate (intra-host today). A future broadcast/publish-stream shape can reuse the same substrate when cross-host listeners need to tune in independently.",
		parameters: ContinueDelegateToolSchema,
		execute: async (_toolCallId, args) => {
			const params = args;
			const sessionKey = opts.agentSessionKey;
			if (!sessionKey) throw new ToolInputError("continue_delegate requires an active session. Not available in sessionless contexts.");
			const task = readStringParam$1(params, "task", { required: true });
			if (!task.trim()) throw new ToolInputError("task must be a non-empty string describing the delegated work.");
			const delaySeconds = readNumberParam(params, "delaySeconds");
			const delayMs = delaySeconds !== void 0 ? Math.max(0, delaySeconds) * 1e3 : void 0;
			const modeRaw = typeof params.mode === "string" ? params.mode.trim().toLowerCase() : "";
			if (modeRaw && !DELEGATE_MODES.includes(modeRaw)) throw new ToolInputError(`Unknown mode "${modeRaw}". Valid modes: ${DELEGATE_MODES.join(", ")}`);
			const mode = modeRaw || "normal";
			const isPostCompaction = mode === "post-compaction";
			const targetSessionKey = readStringParam$1(params, "targetSessionKey");
			const targetSessionKeys = readStrictStringArrayParam(params, "targetSessionKeys");
			const fanoutMode = readStringParam$1(params, "fanoutMode")?.toLowerCase();
			if (fanoutMode && !FANOUT_MODES.includes(fanoutMode)) throw new ToolInputError(`Unknown fanoutMode "${fanoutMode}". Valid fanout modes: ${FANOUT_MODES.join(", ")}`);
			if (fanoutMode && (targetSessionKey || targetSessionKeys && targetSessionKeys.length > 0)) throw new ToolInputError("fanoutMode cannot be combined with targetSessionKey or targetSessionKeys.");
			const targetingFields = {
				...targetSessionKey ? { targetSessionKey } : {},
				...targetSessionKeys && targetSessionKeys.length > 0 ? { targetSessionKeys } : {},
				...fanoutMode ? { fanoutMode } : {}
			};
			const traceparentRaw = readStringParam$1(params, "traceparent");
			...
			const hasCrossSessionTargeting = hasCrossSessionDelegateTargeting(targetingFields, sessionKey);
			if (continuationConfig.crossSessionTargeting === "disabled" && hasCrossSessionTargeting) throw new ToolInputError("cross-session continuation targeting is disabled by agents.defaults.continuation.crossSessionTargeting. Use the default return target, targetSessionKey set to this session, or fanoutMode=\"tree\".");
			...
			log$9.debug(`[continue_delegate:enqueue] session=${sessionKey} mode=${mode} delayMs=${delayMs} fanoutMode=${fanoutMode ?? "none"} targets=${targetSessionKeys?.length ?? (targetSessionKey ? 1 : 0)} task=${task.slice(0, 80)}`);
...
//#endregion
//#region src/agents/tools/continue-work-tool.ts
const log$8 = createSubsystemLogger("continuation/continue-work");
const ContinueWorkToolSchema = Type.Object({
	reason: Type.String({
		description: "Why another turn is needed before you yield. Logged for diagnostics and continuation context.",
		maxLength: 1024
	}),
	delaySeconds: Type.Optional(Type.Number({
		minimum: 0,
		description: "Seconds to wait before the next turn fires. 0 or omitted = immediate. Clamped to continuation.minDelayMs / maxDelayMs from config."
	})),
	traceparent: Type.Optional(Type.String({
		description: "Optional W3C traceparent override. When omitted, the tool derives the parent context from the openclaw runtime's active trace scope (set at gateway entry points). Supply this only when injecting cross-process trace context.",
		pattern: DIAGNOSTIC_TRACEPARENT_PATTERN
...
function createContinueWorkTool(opts) {
	return {
		label: "Continuation",
		name: "continue_work",
		description: "Request another turn for this session. Use when you have more work to do but want to yield the current turn first. Equivalent to CONTINUE_WORK bracket syntax but as a structured tool call.",
		parameters: ContinueWorkToolSchema,
		execute: async (_toolCallId, args) => {
			const params = args;
			const sessionKey = opts.agentSessionKey;
			if (!sessionKey) throw new ToolInputError("continue_work requires an active session. Not available in sessionless contexts.");
			const reason = readStringParam$1(params, "reason", { required: true }).slice(0, 1024);
			const parsedDelaySeconds = readNumberParam(params, "delaySeconds", { strict: true });
			if (parsedDelaySeconds !== void 0 && parsedDelaySeconds < 0) throw new ToolInputError("delaySeconds must be a non-negative number.");
			...
			const traceparent = explicitTraceparent ?? formatActiveContinuationTraceparent();
			const traceContextFields = traceparent ? { traceparent } : {};
			log$8.debug(`[continue_work:request] session=${sessionKey} delaySeconds=${delaySeconds} reason=${reason.slice(0, 80)}`);
...
const log$7 = createSubsystemLogger("gateway-tool");
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			if (action === "restart") {
				...
				log$7.info(`gateway tool: restart requested (delayMs=${delayMs ?? "default"}, reason=${reason ?? "none"})`);
...
function buildMediaGenerationTaskStatusText(params) {
	...
	return [
		...
		params.duplicateGuard ? `Do not call ${params.toolName} again for this request. Wait for the completion event; the completion agent will send the finished ${params.completionLabel} here.` : `Wait for the completion event; the completion agent will send the finished ${params.completionLabel} here when it's ready.`
...
function findActiveImageGenerationTaskForSession(sessionKey) {
...
const log$6 = createSubsystemLogger("agents/tools/media-generate-background-shared");
...
function createMediaGenerationTaskRun(params) {
	...
	try {
		...
		log$6.warn("Failed to create media generation task ledger record", {
			sessionKey,
...
async function wakeMediaGenerationTaskCompletion(params) {
	...
	if (!delivery.delivered && delivery.error) log$6.error("Media generation completion wake failed; requester session was not woken", {
		taskId: params.handle.taskId,
		runId: params.handle.runId,
		toolName: params.toolName,
...
function createImageGenerateDuplicateGuardResult(sessionKey) {
...
const log$5 = createSubsystemLogger("agents/tools/image-generate");
...
const defaultScheduleImageGenerateBackgroundWork = createDefaultMediaGenerateBackgroundScheduler({
	toolName: "image_generate",
	onCrash: (message, meta) => log$5.error(message, meta)
});
		...
		execute: async (_toolCallId, args) => {
			...
			if (Boolean(taskHandle && options?.agentSessionKey?.trim())) {
				scheduleMediaGenerationTaskCompletion({
					...
					onWakeFailure: (message, meta) => log$5.warn(message, meta),
...
function buildSendSchema(options) {
	const props = {
		...
		forceDocument: Type.Optional(Type.Boolean({ description: "Send image/GIF/video as document to avoid channel compression." })),
		asDocument: Type.Optional(Type.Boolean({ description: "Send image/GIF/video as document to avoid channel compression. Alias for forceDocument." }))
	};
...
function buildChannelManagementSchema() {
	return {
		name: Type.Optional(Type.String()),
		channelType: Type.Optional(Type.Number({ description: "Numeric channel type (e.g. Discord channel type). Renamed from `type` to avoid JSON Schema keyword collisions that break some OpenAI-compatible providers (notably NVIDIA NIM)." })),
...
function appendMessageToolVisibleReplyHint(description, sourceReplyDeliveryMode, requireExplicitTarget) {
	...
	return `${description} For this turn, use action="send" with message for visible replies to the current source conversation. ${requireExplicitTarget ? "Include target when sending." : "The target defaults to the current source conversation, so omit target unless sending elsewhere."} Normal final answers stay private.`;
}
...
function createMessageTool(options) {
	...
	const currentThreadTs = options?.currentThreadTs ?? (options?.agentThreadId != null ? stringifyRouteThreadId(options.agentThreadId) : void 0);
	...
	return {
		...
		execute: async (_toolCallId, args, signal) => {
			...
			const toolContext = options?.currentChannelId || options?.currentChannelProvider || currentThreadTs || hasCurrentMessageId || replyToMode || options?.hasRepliedRef ? {
				currentChannelId: options?.currentChannelId,
				currentChannelProvider: options?.currentChannelProvider,
				currentThreadTs,
				currentMessageId: options?.currentMessageId,
...
const defaultScheduleMusicGenerateBackgroundWork = createDefaultMediaGenerateBackgroundScheduler({
	toolName: "music_generate",
	onCrash: (message, meta) => log$3.error(message, meta)
});
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			if (Boolean(taskHandle && options?.agentSessionKey?.trim())) {
				scheduleMediaGenerationTaskCompletion({
					...
					onWakeFailure: (message, meta) => log$3.warn(message, meta),
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-Ck5ll9AX.js");
...
async function runSessionsSendA2AFlow(params) {
	...
	try {
		...
		if (announceTarget && announceReply && announceReply.trim() && !isAnnounceSkip(announceReply) && !isNonDeliverableSessionsReply(announceReply)) try {
			...
			log$2.warn("sessions_send announce delivery failed", {
				runId: runContextId,
				channel: announceTarget.channel,
				to: announceTarget.to,
		...
		log$2.warn("sessions_send announce flow failed", {
			runId: runContextId,
			error: formatErrorMessage(err)
		});
	}
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-BItmsC2W.js"));
...
function createSessionsSpawnToolSchema(params) {
	...
	const schema = {
		task: Type.String(),
		taskName: Type.Optional(Type.String({ description: "Stable optional alias for later subagents targeting. Use lowercase letters, digits, and underscores, starting with a letter." })),
		label: Type.Optional(Type.String()),
...
const log$1 = createSubsystemLogger("agents/tools/video-generate");
...
const defaultScheduleVideoGenerateBackgroundWork = createDefaultMediaGenerateBackgroundScheduler({
	toolName: "video_generate",
	onCrash: (message, meta) => log$1.error(message, meta)
});
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			if (Boolean(taskHandle && options?.agentSessionKey?.trim())) {
				scheduleMediaGenerationTaskCompletion({
					...
					onWakeFailure: (message, meta) => log$1.warn(message, meta),
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-QqOA54k8.js"));
...
function createOpenClawTools(options) {
	...
	const sessionToolConfig = options?.liveSessionToolConfig ? { getConfig: getRuntimeConfig } : { config: resolvedConfig };
	const tools = [
		...
		...options?.config?.agents?.defaults?.continuation?.enabled === true && options?.continueWorkOpts ? [createContinueWorkTool({
			agentSessionKey: options?.agentSessionKey,
			...options.continueWorkOpts
		})] : [],
		...options?.config?.agents?.defaults?.continuation?.enabled === true && options?.drainsContinuationDelegateQueue !== false ? [createContinueDelegateTool({ agentSessionKey: options?.agentSessionKey })] : [],
		...options?.config?.agents?.defaults?.continuation?.enabled === true && options?.requestCompactionOpts ? [createRequestCompactionTool({
			agentSessionKey: options?.agentSessionKey,
			sessionId: options?.sessionId,
			runId: options?.runId,
...
//#endregion
export { isEmbeddedMode as A, wrapToolWorkspaceRootGuard as C, isStrictAgenticExecutionContractActive as D, resolveOpenClawPluginToolsForOptions as E, isStrictAgenticSupportedProviderModel as O, wrapToolMemoryFlushAppendOnlyWrite as S, sniffMimeFromBase64 as T, createOpenClawReadTool as _, buildActiveMusicGenerationTaskPromptContextForSession as a, createSandboxedWriteTool as b, listSupportedMusicGenerationModes as c, normalizeCronJobInput as d, normalizeCronJobPatch as f, createHostWorkspaceWriteTool as g, createHostWorkspaceEditTool as h, triggerSessionPatchHook as i, setEmbeddedMode as j, stripProviderPrefix as k, buildActiveImageGenerationTaskPromptContextForSession as l, createHostWorkspaceAppendTool as m, buildActiveVideoGenerationTaskPromptContextForSession as n, generateMusic as o, resolveToolLoopDetectionConfig as p, isParentOwnedBackgroundAcpSession as r, listRuntimeMusicGenerationProviders as s, createOpenClawTools as t, normalizeCronJobCreate as u, createSandboxedEditTool as v, wrapToolWorkspaceRootGuardWithOptions as w, wrapToolMemoryDayFileWriteGuard as x, createSandboxedReadTool as y };
