...
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-eQdcj31v.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-CP7WCSmg.js";
import "./setup-CXB3n1-3.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-JUxmGfQ_.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-MZ4wB2c3.js";
import { a as resolveMatrixAccountConfig } from "./account-config-D7v4hMgV.js";
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-B79OYcB2.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-DeRxRjU7.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-DSDgwB-s.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-DbTd_5oq.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-Csy5_7kT.js");
