...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-BWnA6LIS.js";
...
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-gCe3cvBY.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-B6jpFTxl.js";
import "./archive-DZMFTTLp.js";
...
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-Cq1bOxic.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-CYT5osDH.js";
...
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-79pTX8pk.js";
...
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-wu-8nEST.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-DgtT1s9n.js";
...
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-VaJeTVln.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CPGeF4ie.js";
...
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-jqDWv_-L.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-i-dc6V8W.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-C5J6hl53.js";
...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-B4hR9U8Q.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CQjnzbFR.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-Bapt3qQT.js";
import { t as loadSessionStore } from "./store-load-BKsOFpyS.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BDy7VEax.js";
...
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-Be8CbMNm.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-DRdEFCXw.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-DaFjr7Mb.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-BF0GNcGl.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-C1aFN6-6.js";
import { a as normalizeSpawnedRunMetadata, o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-ukZWE_8u.js";
import { s as consumeSubagentTraceparentHandoff } from "./subagent-spawn-BdJw_Gl6.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CodaZlaN.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DkKPOKmw.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-ySGBawAS.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-CxY3GBEI.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-BfF4bmPx.js";
...
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-z50YY6dQ.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-B4ot3XuJ.js";
import { l as getTotalQueueSize } from "./command-queue-B_ee8LAq.js";
import { n as resolveSendPolicy } from "./send-policy-B0mdpHpi.js";
import { f as normalizeCronJobPatch, i as triggerSessionPatchHook, u as normalizeCronJobCreate } from "./openclaw-tools-D3btT5iz.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-BZacpDf4.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-B-u8szO4.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DGfD448Y.js";
import { a as isTimeoutError } from "./failover-error-BFupdVm2.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CVIMfrKs.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-Bbpfisa4.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-BOJqSlhj.js";
import { a as getActiveSecretsRuntimeSnapshot, o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-Dmd2pqIt.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-D9vElIFx.js";
import { i as parseAbsoluteTimeMs } from "./stagger-D7o_qpbv.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-BEerkfUv.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-B8kwNxlf.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-BTucRZdg.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-h3OoAgB_.js";
import "./runtime-internal-ZR8-RqU6.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-DDLnCAuC.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-C6kPcV0G.js";
...
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-ChQ53EMC.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-B_BjTzWd.js";
...
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-CiIe2wf_.js";
...
import { o as dispatchChannelMessageAction } from "./message-action-runner-CoOpwZqj.js";
import "./target-resolver-XXFGF5KN.js";
...
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-OYE9VjyS.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-Emq6qCfi.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-CU16ZjTU.js";
...
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-BRVC_gb3.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-DtHndya1.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-qEI3rpsD.js";
...
import { r as listChatCommandsForConfig } from "./commands-registry-list-DkHDYq5J.js";
import "./commands-registry-DTkCWJsN.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-Ce-aEyUG.js";
import "./browser-maintenance-WRJRQlWX.js";
...
import { r as listPluginCommands } from "./commands-T8zChuIU.js";
import { t as getChannelActivity } from "./channel-activity-pYpgY5XG.js";
...
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Dpmiyddt.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-CdOdCP1T.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-DH2ILAvy.js";
import { r as agentCommandFromIngress } from "./agent-command-Dme0GMBf.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-J7UJoqBN.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-BiMYn2y6.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-COS7uhlQ.js";
import { t as formatForLog } from "./ws-log-DbR6yKh4.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-B9J8Qxea.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BAtlavoU.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BtkYKcbi.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-eI4AzeQ3.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-C8trhYcC.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-DuoWnw4u.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CgYInOf-.js";
import { n as createOutboundSendDeps } from "./deps-CVhIlSEz.js";
import "./agent-CKz14EKv.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-BLVhaUOI.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-CqbWbhhE.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DyQK2AXx.js";
...
import "./server-constants-Dm5vgWyk.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-KX6GFiwX.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-GeiZuKBi.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-ph4_Anzt.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-C_gJC_bD.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-xVufc_BJ.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DnrReDuV.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-EP9Jxbw5.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-VzAWPMoq.js";
import { t as buildChannelUiCatalog } from "./catalog-BghfcBF5.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-CY4m4tdX.js";
import { s as normalizeUpdateChannel } from "./update-channels-vU9alC4W.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-ffJk7Qnu.js";
...
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BOSe88RV.js";
...
import { r as readPackageVersion } from "./package-json-ztrZr7F9.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-r2L0Cs3w.js";
import { t as getStatusSummary } from "./status.summary-D4UYW6DZ.js";
import "./status-CKMwuzKJ.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-C8ka1gQW.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-C_eiJfeT.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-x8Il3d5g.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-Bgbi3QL2.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-CCEYKDzA.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-DEStPm7O.js";
...
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CQmQVU88.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-Bem-Mbaf.js";
import "./heartbeat-runner-CoRjYACy.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-CfP-VbhN.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-5T74kycJ.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-DUBh95A1.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CM27eSRx.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-p1z58_nW.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-Do9Mncav.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-BN_QQch4.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-J2QXuGxb.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-_OuSTumw.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-B628J7Xp.js");
