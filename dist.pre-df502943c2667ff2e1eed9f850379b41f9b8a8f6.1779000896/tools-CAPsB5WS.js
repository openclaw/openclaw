...
import { U as resolveMemoryCorePluginConfig, W as resolveMemoryDeepDreamingConfig } from "./dreaming-jqDWv_-L.js";
import { u as listMemoryCorpusSupplements } from "./memory-state-DzCkKlf0.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CQjnzbFR.js";
import { o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CzDAeWnL.js";
import { i as stringEnum } from "./typebox-D8A0NJfq.js";
...
import { r as resolveTranscriptStemToSessionKeys, t as extractTranscriptIdentityFromSessionsMemoryHit } from "./session-transcript-hit-CVH7FyS3.js";
import "./memory-core-host-runtime-core-ClkZn_TL.js";
import "./memory-host-core-BpkYmMFz.js";
import "./memory-core-host-status-KWpQtTFc.js";
import { l as recordShortTermRecalls } from "./short-term-promotion-J4xFhQ4Q.js";
...
async function filterMemorySearchHitsBySessionVisibility(params) {
	...
	for (const hit of params.hits) {
		...
		const archivedOwnerAgentId = Boolean(identity.archived && identity.ownerAgentId && (!scopedAgentId || normalizeAgentIdForCompare(identity.ownerAgentId) === normalizeAgentIdForCompare(scopedAgentId))) ? identity.ownerAgentId : void 0;
