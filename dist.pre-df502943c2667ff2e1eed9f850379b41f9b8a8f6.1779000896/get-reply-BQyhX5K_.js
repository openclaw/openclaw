...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-C5uhMtO-.js";
...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-BWnA6LIS.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-Cq1bOxic.js";
...
import { r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-B9xZ12q8.js";
import { o as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-uYZeqLog.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-M8cBnlBl.js";
import { t as resolveAgentHarnessPolicy } from "./policy-BabvJgc_.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-Csud6ycf.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-D9YraNzb.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-mlXU8Wcs.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-Bapt3qQT.js";
import { A as resolveSessionStoreEntry, C as parseSessionThreadInfoFast, t as loadSessionStore, y as resolveMaintenanceConfigFromInput } from "./store-load-BKsOFpyS.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-COpeBC3V.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-BDy7VEax.js";
import { m as deriveSessionMetaPatch, s as updateSessionStore, v as resolveGroupSessionKey } from "./store-Ba2LZdfG.js";
import { t as normalizeChatType } from "./chat-type-CvcsBx3m.js";
import "./plugins-BwY4oKrD.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-CXS4Fv_X.js";
import { c as resolveSessionLifecycleTimestamps } from "./sessions-Be8CbMNm.js";
...
import { l as resolveAndPersistSessionFile } from "./transcript-R0nLubYs.js";
...
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-Co5pqKAn.js";
import { o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-ukZWE_8u.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-BAc7OIVW.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CF0uy0oR.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-DHq9F2jJ.js";
import { a as generateSecureToken } from "./secure-random-BlwDsoUi.js";
import { a as enqueueSystemEvent, u as removeSystemEvents } from "./system-events-B4ot3XuJ.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-B_ee8LAq.js";
import { a as resolveSilentReplySettings, i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-hJyPHqfW.js";
import { r as getCliSessionBinding } from "./cli-session-Bkv33gJT.js";
import { Ct as isReasoningTagProvider } from "./selection-CRTFepzu.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-_qFWxdgO.js";
import { l as ensureAgentWorkspace } from "./workspace-DGfD448Y.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-C1kPkZ7x.js";
import { y as collectTextContentBlocks } from "./attempt.tool-run-context-BoMS9ARY.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-C9qItTiF.js";
import "./pi-bundle-mcp-tools-Bu5eBVtc.js";
import "./delivery-context-i0bLgbWP.js";
import { s as getMediaDir } from "./store-BUr9zBQb.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, s as resolveCommandTurnContext } from "./command-turn-context-DBU_FtZV.js";
import { t as resolveQueueSettings } from "./queue-DgqJB5Va.js";
import { t as buildOutboundSessionContext } from "./session-context-Ly6VNB7d.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BCiKjz_w.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-BfXz7HtN.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BnUsSZjI.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-7IPT8CpI.js";
import { a as noteActiveSessionForShutdown, n as buildSessionStartHookPayload, r as forgetActiveSessionForShutdown, t as buildSessionEndHookPayload } from "./session-hooks-DH4UzZ5A.js";
import { r as drainFormattedSystemEventBlock } from "./session-updates-DdmHBcs8.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-B5mzm_9R.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-Bs-wEU_G.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-BqqfrVgt.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-BVeCysfE.js";
...
import { t as parseSoftResetCommand } from "./commands-reset-mode-8oelPiha.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BSvFT-L5.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-BNln4arn.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-9cCn3XHQ.js";
import { t as finalizeInboundContext } from "./inbound-context-DSFZhNeJ.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-AQCOTJvT.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-O28uiRAp.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-CqHllOOc.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-WRJRQlWX.js";
import { t as hasControlCommand } from "./command-detection-Bojg0DW2.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope--58uPTuK.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-C4RbBugW.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-CYkk1V39.js";
import { t as resolveFastModeState } from "./fast-mode-DeJ3WiKf.js";
import { t as buildCommandContext } from "./commands-context-CpDgIZRj.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-BnpdBiW2.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-C_WvHeJj.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-49Cl6VD2.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DPnTnptT.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-CKZuMnJR.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-BhjP2kit.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-CNL_RS04.js";
import { t as hasInboundMedia } from "./inbound-media-4wD-bQs7.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-D4Uz6MwN.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-mOAv-3uA.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-CCHnpH_n.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-NHU_h62R.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-BhXOxvZ8.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-G8lCFblH.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-CJLulXqK.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-crd5HsY4.js");
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-Ba_ojjoQ.js"));
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-CPnkvpBd.js");
