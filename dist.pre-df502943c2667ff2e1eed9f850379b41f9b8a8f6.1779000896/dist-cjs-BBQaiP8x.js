...
import { F as init_config, P as config_exports, n as protocols_exports, t as init_protocols } from "./protocols-XtF8I7LD.js";
import { n as init_client, t as client_exports } from "./client-BX3h42VE.js";
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await import("./signin-Bltooox3.js");
...
var require_dist_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const resolveCredentialSource = (credentialSource, profileName, logger) => {
		const sourceProvidersMap = {
			EcsContainer: async (options) => {
				const { fromHttp } = await import("./dist-cjs-BqQq_0CN.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				const { fromContainerMetadata } = await import("./dist-cjs-EZLtMryJ.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			...
			Ec2InstanceMetadata: async (options) => {
				...
				const { fromInstanceMetadata } = await import("./dist-cjs-EZLtMryJ.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				return async () => fromInstanceMetadata(options)().then(setNamedProvider);
			},
			Environment: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
				const { fromEnv } = await import("./dist-cjs-3mEdYGVL.js").then((m) => /* @__PURE__ */ __toESM(m.default));
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await import("./sts-B3M-vozy.js");
	...
	const resolveProcessCredentials = async (options, profile) => import("./dist-cjs-B2UJlP2Q.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromProcess }) => fromProcess({
		...options,
		profile
	...
	const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
		const { fromSSO } = await import("./dist-cjs-ChE0Ol2J.js").then((m) => /* @__PURE__ */ __toESM(m.default));
		return fromSSO({
			profile,
			logger: options.logger,
	...
	const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => import("./dist-cjs-hAPDQrJb.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromTokenFile }) => fromTokenFile({
