...
async function runPluginsEnableCommand(id) {
	...
	const { buildPluginRegistrySnapshotReport } = await import("./status-5d2nJTM6.js");
	const { applySlotSelectionForPlugin, logSlotWarnings } = await import("./plugins-command-helpers-C6L7ZuTl.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-B1HTl9Yb.js");
...
async function runPluginsDoctorCommand() {
	const { buildPluginCompatibilityNotices, buildPluginDiagnosticsReport, formatPluginCompatibilityNotice } = await import("./status-5d2nJTM6.js");
...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-BaBBh0OB.js");
	const { createPluginInstallLogger } = await import("./plugins-command-helpers-C6L7ZuTl.js");
