import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, i as normalizeFastMode, s as normalizeOptionalLowercaseString } from "./string-coerce-LndEvhRk.js";
...
import { p as resolveUserPath, r as clampInt } from "./utils-CpmNtyoq.js";
...
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-BIt2fl4B.js";
...
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-Cd_w9tEa.js";
...
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-B6jpFTxl.js";
...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-Cq1bOxic.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-DxCJ9lzV.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-Cm9trf4P.js";
...
import { o as transformConfigFileWithRetry } from "./mutate-79pTX8pk.js";
import "./config-BvLwr8dO.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-Bh-3SVDK.js";
...
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-B9xZ12q8.js";
import { i as callGateway } from "./call-DwPwapQo.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-C2qaIpcE.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-M8cBnlBl.js";
import { t as resolveAgentHarnessPolicy } from "./policy-BabvJgc_.js";
import { t as getActivePluginChannelRegistry } from "./runtime-C5J6hl53.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DbdMmy-5.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-Bapt3qQT.js";
import { t as loadSessionStore } from "./store-load-BKsOFpyS.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BDy7VEax.js";
import { s as updateSessionStore } from "./store-Ba2LZdfG.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-BwY4oKrD.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-R0nLubYs.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-Ih5VyHj6.js";
...
import { f as replyRunRegistry } from "./reply-run-registry-DDPPq6Sw.js";
import "./diagnostic-C0jcyWM1.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-CFFwo_Of.js";
import { a as getActiveEmbeddedRunSnapshot, d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary, o as isEmbeddedPiRunActive, p as resolveActiveEmbeddedRunSessionId } from "./runs-CuLZvr8h.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BCmbC9jO.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CeWDbIl8.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BeGL8W9h.js";
...
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-C1OuF0rr.js";
import { r as isSilentReplyPayloadText } from "./tokens-CF0uy0oR.js";
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-CirFrq6J.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-VBRloEL2.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-BwM1lROq.js";
import { i as selectAgentHarness, n as resolveAvailableAgentHarnessPolicy } from "./selection-CRTFepzu.js";
import { t as formatDurationCompact } from "./format-duration-D2mwWJew.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-4lZ88_B2.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CLgHKEmp.js";
...
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-BTucRZdg.js";
import { a as clearSessionQueues } from "./queue-DgqJB5Va.js";
import { i as resolveReplyToMode } from "./reply-threading-CzuOtuso.js";
import { n as routeReply } from "./route-reply-34U-_Jm0.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-DW4DAoO6.js";
...
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, a as getTtsMaxLength, b as setLastTtsAttempt, c as isSummarizationEnabled, f as listTtsPersonas, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, w as setTtsMaxLength, x as setSummarizationEnabled } from "./tts-runtime-0DtwBNnk.js";
import "./tts-sZp9mOtm.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DMMyB0HH.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-Azf_t2BO.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-BOa-Ys6g.js";
import "./sandbox-DCLnEJ7m.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-CbWBLVEi.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-eyhp7_6C.js";
import { n as formatTimeAgo } from "./format-relative-DWhj65Uu.js";
import { r as resolveModelWithRegistry } from "./model-0vCX3cKa.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry--RBlnLM5.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-BqqfrVgt.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-B2vD2D2T.js";
import "./commands-registry-DTkCWJsN.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-BSvFT-L5.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-AQCOTJvT.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-O28uiRAp.js";
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-B9m3UapA.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-BlILt3B5.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-iOqYIBWw.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-CWk3t2zK.js";
import { n as parseActivationCommand } from "./group-activation-DD2OU6Gr.js";
...
import { t as extractExplicitGroupId } from "./group-id-CbBcXmRV.js";
import { t as formatElevatedUnavailableMessage } from "./elevated-unavailable-8iT8zMFy.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-DYE9o0nX.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-BDARUEwa.js";
import { t as extractBtwQuestion } from "./btw-command-Cm5Jf2pg.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-WzOq-kqz.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-Dhs3vf7k.js";
import { t as handleAcpCommand } from "./commands-acp-fmOJpYgk.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BmMeyJSx.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BAtlavoU.js";
import { r as handleModelsCommand } from "./commands-models-Dy38YiW4.js";
import { r as createExecTool } from "./bash-tools-Bm2B-fE8.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-xVufc_BJ.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-BeNaIH7K.js";
import { t as buildToolsMessage } from "./status-BCTSgdxu.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-Ck4cUNTu.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-CYBnwXol.js";
import "./command-export-Ct_tUynB.js";
import { t as buildStatusReply } from "./commands-status-CZ48T7IA.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-BO8H2ot4.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-DUQe4Mgo.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-DWKaN7X6.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-D3RN6JvN.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-BEyoQGbj.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-CWcERzZX.js";
import "./clawhub-DnrReDuV.js";
import { r as installPluginFromClawHub } from "./clawhub-Cgrzu8wz.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-EP9Jxbw5.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-dbCgwY5y.js");
		killProcessTree(pid);
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-Dt01sZeV.js");
...
const handleSteerCommand = async (params, allowTextCommands) => {
	...
	if (!queueOutcome.queued) return continueWithSteerFallback(params, message, `steer: active session ${sessionId} rejected steering injection: ${formatEmbeddedPiQueueFailureSummary(queueOutcome)}; continuing with /steer payload as a normal prompt`);
	return {
		shouldContinue: false,
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-DfjGhM1j.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-C7TI-6by.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-D_onOSjG.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-C3pG9jbN.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-DRxt6ADH.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-DiPlHQk-.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-EBnsYmIc.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-DciIZZhy.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-BWdt-sV1.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-Bof12tKU.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-BH3kJ_Cv.js"));
