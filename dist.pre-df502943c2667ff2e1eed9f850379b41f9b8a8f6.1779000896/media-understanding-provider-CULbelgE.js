...
import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-CHEoxrTn.js";
import { c as resolveCodexAppServerRuntimeOptions } from "./config-DP4qTgax.js";
import { i as assertCodexTurnStartResponse, l as readCodexTurnCompletedNotification, o as readCodexErrorNotification, r as assertCodexThreadStartResponse } from "./protocol-validators-uwUXSlek.js";
import { r as readModelListResult } from "./models-NMHRhRuw.js";
...
async function runBoundedCodexVisionTurn(params) {
	...
	const client = params.options.clientFactory ? await params.options.clientFactory(appServer.start, params.profile) : await import("./shared-client-CLtJ8uno.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
