...
import { r as normalizeControlUiBasePath } from "./control-ui-shared-VaJeTVln.js";
import { t as resolveOsSummary } from "./os-summary-D0R0dp_G.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-SLmd71pu.js";
import { l as hasConfiguredChannelsForReadOnlyScope } from "./channel-plugin-ids-C6kPcV0G.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-Ds8W_-2b.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-BWgJJz9w.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-BmGpF1kj.js";
import { i as isProbeReachable } from "./helpers-D_UZr1Dp.js";
import { existsSync } from "node:fs";
//#region src/commands/status.scan.shared.ts
const gatewayProbeModuleLoader = createLazyImportLoader(() => import("./status.gateway-probe-M2UaC0FW.js"));
const probeGatewayModuleLoader = createLazyImportLoader(() => import("./probe-Buwu8JEN.js"));
const gatewayCallModuleLoader$1 = createLazyImportLoader(() => import("./call-Ck5ll9AX.js"));
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-exypXC6f.js"));
const statusUpdateModuleLoader = createLazyImportLoader(() => import("./status.update-CBDBC08Y.js"));
const statusScanRuntimeModuleLoader = createLazyImportLoader(() => import("./status.scan.runtime.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("./call-Ck5ll9AX.js"));
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./status.summary-DrzsrFS9.js"));
const configModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-DURXUzlX.js"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-WH0zjKkI.js"));
