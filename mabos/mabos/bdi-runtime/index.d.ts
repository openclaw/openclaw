 ...
 */
export declare function readAgentCognitiveState(agentDir: string, agentId: string): Promise<BdiAgentState>;
/**
 ...
 */
export declare function getAgentsSummary(workspaceDir: string): Promise<Array<{
    agentId: string;
    beliefCount: number;
    goalCount: number;
