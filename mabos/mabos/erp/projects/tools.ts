...
const actions: ErpAction[] = [
  {
    ...
    handler: async (params, ctx) => {
      const project = await q.createProject(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const project = await q.getProject(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listProjects(ctx.pg, params) };
    },
  },
  {
    name: "update_project",
    ...
    handler: async (params, ctx) => {
      ...
      if (!project) {
        return { error: "Project not found or no fields to update" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "projects",
        entityType: "project",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const task = await q.createTask(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "projects",
        entityType: "task",
        entityId: task.id,
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const task = await q.getTask(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listTasks(ctx.pg, params) };
    },
  },
  {
    name: "update_task",
    ...
    handler: async (params, ctx) => {
      ...
      if (!task) {
        return { error: "Task not found or no fields to update" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "projects",
        entityType: "task",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const milestone = await q.createMilestone(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "projects",
  ...
  },
  {
    ...
    handler: async (params, ctx) => {
      return {
        success: true,
        data: await q.listMilestones(ctx.pg, params.project_id),
      };
    },
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const milestone = await q.completeMilestone(ctx.pg, params.id);
      if (!milestone) {
