...
export const ERP_TO_BDI_RULES: SyncRule[] = [
  {
    ...
    toErpUpdate: (_block, _old, newStatus) => {
      if (newStatus === "dropped") {
        return { action: "update", params: { status: "on_hold" } };
      }
      return null;
    },
  },
  {
    ...
    toErpUpdate: (_block, _old, newStatus) => {
      if (newStatus === "dropped") {
        return { action: "update", params: { status: "paused" } };
      }
      return null;
    },
  },
  {
    ...
    toErpUpdate: (_block, _old, newStatus) => {
      ...
      if (map[newStatus]) {
        return { action: "update", params: { status: map[newStatus] } };
      }
      return null;
    },
  },
  {
    ...
    toErpUpdate: (_block, _old, newStatus) => {
      if (newStatus === "expired") {
        return { action: "update", params: { status: "at_risk" } };
      }
      if (newStatus === "completed") {
        return { action: "update", params: { status: "completed" } };
      }
      return null;
    },
  },
