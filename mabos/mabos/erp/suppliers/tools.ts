...
const actions: ErpAction[] = [
  {
    ...
    handler: async (params, ctx) => {
      const supplier = await q.createSupplier(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const supplier = await q.getSupplier(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listSuppliers(ctx.pg, params) };
    },
  },
  {
    ...
    handler: async (params, ctx) => {
      ...
      if (!supplier) {
        return { error: "Supplier not found or no changes" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "suppliers",
        entityType: "supplier",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const po = await q.createPurchaseOrder(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "suppliers",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const po = await q.getPurchaseOrder(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listPurchaseOrders(ctx.pg, params) };
    },
  },
  {
    name: "receive_po",
    ...
    params: {},
    handler: async (params, ctx) => {
      const po = await q.receivePurchaseOrder(ctx.pg, params.id);
      if (!po) {
