...
const actions: ErpAction[] = [
  {
    ...
    handler: async (params, ctx) => {
      const contract = await q.createContract(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const contract = await q.getContract(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listContracts(ctx.pg, params) };
    },
  },
  {
    ...
    handler: async (params, ctx) => {
      ...
      if (!contract) {
        return { error: "Contract not found or no changes" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "legal",
        entityType: "contract",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const legalCase = await q.createCase(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "legal",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const legalCase = await q.getCase(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listCases(ctx.pg, params) };
    },
  },
  {
    name: "update_case",
    ...
    handler: async (params, ctx) => {
      ...
      if (!legalCase) {
        return { error: "Case not found or no changes" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "legal",
        entityType: "legal_case",
...

  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listPartnershipContracts(ctx.pg, params) };
    },
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const contract = await q.createPartnershipContract(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "legal",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listFreelancerContracts(ctx.pg, params) };
    },
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const contract = await q.createFreelancerContract(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "legal",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listCorporateDocuments(ctx.pg, params) };
    },
  },
  {
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listComplianceGuardrails(ctx.pg, params) };
    },
  },
];
