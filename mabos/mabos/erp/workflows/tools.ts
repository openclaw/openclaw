...
const actions: ErpAction[] = [
  /* ── Workflow definitions ─────────────────────────────────────────── */
  {
    ...
    handler: async (params, ctx) => {
      const workflow = await q.createWorkflow(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const workflow = await q.getWorkflow(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listWorkflows(ctx.pg, params) };
    },
  },
  {
  ...
  /* ── Workflow runs ────────────────────────────────────────────────── */
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const run = await q.createRun(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "workflows",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const run = await q.getRun(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listRuns(ctx.pg, params) };
    },
  },
  {
    name: "advance_step",
    ...
    params: {},
    handler: async (params, ctx) => {
      const run = await q.advanceStep(ctx.pg, params.run_id);
      await writeAuditLog(ctx.pg, {
        domain: "workflows",
        entityType: "workflow_run",
        entityId: params.run_id,
        action: "advance_step",
        agentId: ctx.agentId,
      });
      return { success: true, data: run };
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const run = await q.failRun(ctx.pg, params.run_id, params.error);
      if (!run) {
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const run = await q.completeRun(ctx.pg, params.run_id);
      if (!run) {
        return { error: "Run not found" };
      }
      await writeAuditLog(ctx.pg, {
