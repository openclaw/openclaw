...
const actions: ErpAction[] = [
  {
    ...
    handler: async (params, ctx) => {
      const shipment = await q.createShipment(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const shipment = await q.getShipment(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listShipments(ctx.pg, params) };
    },
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const shipment = await q.updateShipmentStatus(ctx.pg, params.id, params.status);
      if (!shipment) {
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const shipment = await q.trackShipment(ctx.pg, params.tracking_number);
      return shipment
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const route = await q.createRoute(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "supply-chain",
        entityType: "route",
        entityId: route.id,
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listRoutes(ctx.pg, params) };
    },
  },
  {
    name: "get_route",
    ...
    params: {},
    handler: async (params, ctx) => {
      const route = await q.getRoute(ctx.pg, params.id);
