...
const actions: ErpAction[] = [
  /* ── Reports ──────────────────────────────────────────────────────── */
  {
    ...
    handler: async (params, ctx) => {
      const report = await q.createReport(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const report = await q.getReport(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listReports(ctx.pg, params) };
    },
  },
  {
    name: "run_report",
    ...
    params: {},
    handler: async (params, ctx) => {
      const snapshot = await q.runReport(ctx.pg, params.report_id);
      await writeAuditLog(ctx.pg, {
        domain: "analytics",
        entityType: "report",
        entityId: params.report_id,
        action: "run_report",
        agentId: ctx.agentId,
      });
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const report = await q.deleteReport(ctx.pg, params.id);
      if (!report) {
  ...
  /* ── Dashboards ───────────────────────────────────────────────────── */
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const dashboard = await q.createDashboard(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "analytics",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const dashboard = await q.getDashboard(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listDashboards(ctx.pg, params) };
    },
  },
  ...
  /* ── Snapshots ────────────────────────────────────────────────────── */
  {
    ...
    handler: async (params, ctx) => {
      return {
        success: true,
        data: await q.getSnapshots(ctx.pg, params.report_id, params.limit),
      };
    },
  },
];
