...
const actions: ErpAction[] = [
  {
    ...
    handler: async (params, ctx) => {
      const campaign = await q.createCampaign(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const campaign = await q.getCampaign(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listCampaigns(ctx.pg, params) };
    },
  },
  {
    ...
    handler: async (params, ctx) => {
      ...
      if (!campaign) {
        return { error: "Campaign not found or no fields to update" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "marketing",
        entityType: "campaign",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const metric = await q.recordMetric(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "marketing",
  ...
  },
  {
    ...
    handler: async (params, ctx) => {
      return {
        success: true,
        data: await q.getCampaignMetrics(ctx.pg, params.campaign_id, params.limit),
      };
    },
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const kpi = await q.createKpi(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "marketing",
        entityType: "kpi",
        entityId: kpi.id,
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listKpis(ctx.pg, params) };
    },
  },
  {
    name: "update_kpi",
    ...
    handler: async (params, ctx) => {
      ...
      if (!kpi) {
        return { error: "KPI not found or no fields to update" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "marketing",
        entityType: "kpi",
