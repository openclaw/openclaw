...
export declare function query<T extends pg.QueryResultRow = pg.QueryResultRow>(
  client: PgClient,
  sql: string,
  values?: unknown[],
): Promise<T[]>;
export declare function queryOne<T extends pg.QueryResultRow = pg.QueryResultRow>(
  client: PgClient,
  sql: string,
  values?: unknown[],
): Promise<T | null>;
