...
const actions: ErpAction[] = [
  {
    ...
    handler: async (params, ctx) => {
      const product = await q.createProduct(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const product = await q.getProduct(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listProducts(ctx.pg, params) };
    },
  },
  {
    name: "update_product",
    ...
    handler: async (params, ctx) => {
      ...
      if (!product) {
        return { error: "Product not found or no changes" };
      }
      await writeAuditLog(ctx.pg, {
        domain: "ecommerce",
        entityType: "product",
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const order = await q.createOrder(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "ecommerce",
        entityType: "order",
        entityId: order.id,
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const order = await q.getOrder(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listOrders(ctx.pg, params) };
    },
  },
  {
