...
const actions: ErpAction[] = [
  {
    ...
    handler: async (params, ctx) => {
      const item = await q.createStockItem(ctx.pg, params);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      const item = await q.getStockItem(ctx.pg, params.id);
  ...
  },
  {
    ...
    params: {},
    handler: async (params, ctx) => {
      return { success: true, data: await q.listStockItems(ctx.pg, params) };
    },
  },
  {
    name: "adjust_stock",
    ...
    params: {},
    handler: async (params, ctx) => {
      const movement = await q.adjustStock(ctx.pg, params);
      await writeAuditLog(ctx.pg, {
        domain: "inventory",
  ...
  },
  {
    ...
    handler: async (params, ctx) => {
      return {
        success: true,
        data: await q.lowStockAlerts(ctx.pg, params.threshold),
      };
    },
  },
  {
    ...
    handler: async (params, ctx) => {
      return {
        success: true,
        data: await q.getStockMovements(ctx.pg, params.stock_item_id, params.limit),
      };
    },
  },
];
