...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-ky-rASNw.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-BCeLYk7a.js";
import { o as resetModelCatalogCache } from "./model-catalog-D50ZQj_F.js";
import { l as getTotalQueueSize } from "./command-queue-xcPRwgcM.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-Cno5pvXr.js";
import "./pi-bundle-mcp-tools-CcEFGmnF.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-mu0ezyK2.js";
...
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BLeVnf07.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DbgmDVMU.js";
...
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-MtAJw9SF.js";
import { t as buildGatewayCronService } from "./server-cron-CZcoa5ay.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Cb8SlXiq.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-B6Ed8IFq.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-DhTLQdPK.js"), import("./gmail-watcher-lifecycle-D9ktG3Wl.js")]);
