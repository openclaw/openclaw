...
import { s as loadAuthProfileStoreForRuntime } from "./store-CWaY5GDh.js";
import { n as resolvePluginProviders } from "./providers.runtime-CWnVo7GB.js";
import "./model-selection-shared-BQtX8Bw-.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-CBkGkiws.js";
import { n as clearAuthProfileCooldown } from "./usage-BPAEZ9Bv.js";
import "./workspace-BY7PlQ5_.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-DJ4C9RBW.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-CuyMvlgj.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DHg7v1Wl.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-D8XLGq11.js");
				await openUrl(url);
			},
