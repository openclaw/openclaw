...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-C04VWQdx.js";
import { n as formatConfigIssueLines } from "./issue-format-DaaH055I.js";
import { r as normalizeTalkSection } from "./talk-CBvuoUZH.js";
import { n as collectConfiguredModelRefs } from "./model-refs-DfGZDxJI.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-B2VAbr_y.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-CSLLmhBN.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-CMELhaVM.js";
import { n as getLoadedChannelPlugin } from "./registry-vjc31mTI.js";
import { i as listRouteBindings } from "./bindings-MczUZiTj.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DHvS2C_F.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-ClBgyOsn.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Dnm-ySLk.js";
import { t as note } from "./note-BiGDHYW2.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-DFsNkQS_.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-Cs-BQQUG.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-bKjElO5N.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-Cbc-evH9.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DTQQVhtL.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-CIQucY63.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-CAPKKf_p.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-p_uHBmj3.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DGlFpYeQ.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-7gQUC_VS.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-Cvljgsrx.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DW6VvITa.js");
		emitDoctorNotes({
			note,
