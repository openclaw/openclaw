...
function isRedactableInlineAttachmentToolName(name) {
...
function hasUnredactedSessionsSpawnAttachments(block) {
	if (!isRedactableInlineAttachmentToolName(block.name)) return false;
...
//#endregion
export { SESSIONS_SPAWN_ATTACHMENT_METADATA_KEYS as a, isRedactableInlineAttachmentToolName as c, REDACTED_SESSIONS_SPAWN_ATTACHMENT_CONTENT as i, isRedactedSessionsSpawnAttachment as l, extractToolResultId as n, hasUnredactedSessionsSpawnAttachments as o, sanitizeToolCallIdsForCloudCodeAssist as r, isAllowedToolCallName as s, extractToolCallsFromAssistant as t, normalizeAllowedToolNames as u };
