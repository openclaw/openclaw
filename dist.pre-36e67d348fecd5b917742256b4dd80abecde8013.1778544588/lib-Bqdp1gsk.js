...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-C1Qv2oNo.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DZ6P6fpT.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-CzZUvTOD.js";
import { l as toRatio, n as decodeString } from "./Util-iHqm7Hx2.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-C2NFJHln.js";
import { t as APEv2Parser } from "./APEv2Parser-BHWEod9a.js";
import { r as hasID3v1Header } from "./ID3v1Parser-Bm6_w8M_.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-wVrWFxKx.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-B58xAnGr.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-CQKMHpMj.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-B8WO8F_k.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CuabcmQa.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Bn3ZKXo1.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-B7kn8_za.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DFSeChKe.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DakHzk0n.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CrYjHwzz.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-VIsKK5uv.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-C4T3sirB.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Dy_7th84.js")).WaveParser;
	}
};
//#endregion
