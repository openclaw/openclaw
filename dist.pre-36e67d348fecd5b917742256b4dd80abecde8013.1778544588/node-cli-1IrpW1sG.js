...
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-BoAYHEfL.js";
import { a as logWarn } from "./logger-M-PaInRe.js";
import { i as getRuntimeConfig } from "./io-C04VWQdx.js";
import { A as unwrapKnownShellMultiplexerInvocation, H as normalizeExecutableToken, L as unwrapKnownDispatchWrapperInvocation, N as resolveInlineCommandMatch, O as isShellWrapperInvocation, P as extractEnvAssignmentKeysFromDispatchWrappers, S as POSIX_SHELL_WRAPPERS, U as splitShellArgs, d as resolveApprovalAuditCandidatePath, j as POSIX_INLINE_COMMAND_FLAGS, k as resolveShellWrapperTransportArgv, p as resolveCommandResolutionFromArgv, y as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-FCWb26AL.js";
import "./config-Dk0DnRek.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-Cn6QCLFy.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-CraHNbwV.js";
import { t as parsePort } from "./parse-port-DDOAYQrk.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-BtfrIxPa.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-cTv8W9zW.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BGPYzYuY.js";
import { a as getActivePluginRegistry } from "./runtime-BOPXy9l1.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-DIHuHxhc.js";
import { t as getMachineDisplayName } from "./machine-name-DwRovTKK.js";
import { c as analyzeArgvCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist, x as describeInterpreterInlineEval } from "./exec-approvals-allowlist-Bk-bNyWO.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-AtVf5IyX.js";
import { N as saveExecApprovals, O as resolveExecApprovals, P as requestJsonlSocket, T as requiresExecApproval, b as readExecApprovalsSnapshot, c as hasDurableExecApproval, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, o as addDurableCommandApproval, s as ensureExecApprovals, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-DfnE2iZn.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CyM65g60.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-CvFAfSsD.js";
import { t as formatHelpExamples } from "./help-format-M6OA6DMb.js";
import { n as detectPolicyInlineEval } from "./policy-BJlD3N1Z.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-DldfR8mq.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-DczwyTUI.js";
import { t as resolveNodeService } from "./node-service-PZg83pJ_.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-CHJPvquq.js");
