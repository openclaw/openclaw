...
import { o as getResolvedLoggerSettings } from "./logger-CQ0p51p4.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-CSLLmhBN.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-vjc31mTI.js";
import "./plugins-B_QXrzEj.js";
import "./logging-C0d6mpPn.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-Bv6Dle-T.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CiDMCezP.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-Oaj_3a8N.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CESD8ZBk.js";
...
import { n as resolveLogFile } from "./log-tail-C2vi1xDM.js";
import { t as parseLogLine } from "./parse-log-line-B5Fnsnxp.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-B-8b1TwS.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-Hoe7SvaX.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-C7g_5Apu.js";
import { t as channelsListCommand } from "./list-DCqLgAIc.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-CsjAIarB.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CY2cybCU.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-D4sMif09.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BKFtfohB.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BVsrQpm7.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-BsTEigHe.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-d1_xEIyG.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-1--ANuFm.js");
