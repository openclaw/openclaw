...
import { a as logWarn, t as logDebug } from "./logger-CeZgWgtG.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-CNF1koEh.js";
import "./auth-Df9rmkQ_.js";
import { t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-ChKVPAci.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-C1mGpjUn.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-DUpVOe8L.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BSgfYlBK.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-CYPYEsB7.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-BD1XQ5lD.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-B3pr-X7V.js";
import { n as formatConfigIssueLines } from "./issue-format-u844k3jY.js";
import { t as applyMergePatch } from "./merge-patch-BzwP7uYW.js";
import { r as DEFAULT_PROVIDER } from "./defaults-CHyQiMS4.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-DIeLKFsV.js";
...
import { o as gatewayStartupUnavailableDetails } from "./client-ChNcX7-h.js";
...
import { h as patchPluginSessionExtension } from "./loader-COn7-q7R.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-B3XP6JAO.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-BIGmqy0n.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-Cqk_-fBI.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-zZSBgwJK.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DfaZN9JD.js";
import { d as isPluginJsonValue } from "./host-hook-runtime-BOwdZl-7.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-CDC1ZOcb.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-J6vxmiJL.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-Dl79wsM6.js";
import { h as stringifyRouteThreadId } from "./channel-route-C_HZkvTX.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-C4S7NY0S.js";
import { t as loadSessionStore } from "./store-load-BJuxv-vp.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-Cl8KmGKt.js";
...
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-DCQidobb.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-B5cDIaF1.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-2YI-i-Tm.js";
...
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-DXB3ip3_.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-D8kG0msf.js";
import "./auth-profiles-ifRisMD7.js";
import { t as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-3fxVmfdh.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-qXGu5GiY.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-5kGdlBIK.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-CkB6zt0i.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-DVaRCKZN.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-c4v86t-7.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-Cpvj0zGb.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-Bt-hwnfd.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-ywrO5Obc.js";
import { i as resolveSandboxConfigForAgent } from "./config-CH6rCqnJ.js";
import { t as extractToolPayload } from "./tool-payload-C5j2HMwp.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-vuAwR4pc.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-CmS57ZTw.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-DNWZXyec.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-DsJ9F4cL.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-BZA-v29I.js";
import "./tts-BbG2fjoP.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-BJnGgOZY.js";
import { a as isTimeoutError } from "./failover-error-CIUKqp9x.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-BKaUMp20.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-DXm9TLRA.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-BphUzQ8_.js";
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-DwM6IijA.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-DLvm6-8V.js";
import { i as parseAbsoluteTimeMs } from "./stagger-V1PKuxgR.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-DodKv86d.js";
import { i as formatDoctorNonInteractiveHint, p as writeRestartSentinel } from "./restart-sentinel-BVIni1iS.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-BS3RJ9If.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-D7PVs_O-.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-BFxN7KEs.js";
import { n as normalizePollInput } from "./polls-DhrLANY3.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-BDat_AT3.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-B1C2EuDx.js";
import "./target-resolver-CStqf4b2.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CNde5YvZ.js";
...
import { n as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-QKWaN5EA.js";
import { r as resolveOutboundTarget } from "./targets-BxqeMD8k.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-C1Twctmt.js";
import { n as resolveAgentIdentity } from "./identity-Be40H-5J.js";
import { s as clearSessionQueues } from "./queue-BR4Rgmvw.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-Dn1I7ca9.js";
import { t as resolveAgentTimeoutMs } from "./timeout-7xlfF7jP.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-CrNr2ieh.js";
import "./skills-BHYsqYYy.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BzLxGkns.js";
...
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DlqwSPAz.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-Cv4g3BH6.js";
...
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-QaD9w_yk.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-BaRGDodV.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-WbnkArsp.js";
...
import { t as getChannelActivity } from "./channel-activity-BxfoYxkn.js";
import { t as WizardCancelledError } from "./prompts-Czejqe3Z.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-Bxxl-nEw.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CeZGjK3-.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-Cnak53k8.js";
import { t as movePathToTrash } from "./browser-trash-QIkbW5Bp.js";
import "./browser-maintenance-Dwyo7ZcQ.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Cmz-WfsA.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-CkNz24Kp.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-BBIoBYYY.js";
...
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-Dp37YJpB.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-CzbbCakf.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-uLqfOmUz.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BlFNHgtx.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-BRo-KFfN.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-B3oRoije.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CkLLYKl1.js";
import { n as createOutboundSendDeps } from "./deps-CwJcL6ee.js";
import "./agent-BXv7cZSs.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-CrTMSWih.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-0S8Qn1UM.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-B_jSSFRN.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DIUwFIKL.js";
import "./server-constants-DNpWRqBv.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-CsGsEOld.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-Bhj1l40B.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BOEkc3to.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-CVXxi381.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-Cwdotqiz.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-Bc84qMmk.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-BBlvZ6ie.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-5Q3iGQfg.js";
import { a as performGatewaySessionReset } from "./session-reset-service-DctXXHDF.js";
import { t as buildChannelUiCatalog } from "./catalog-DpUtJn4H.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-CjH4p4r2.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-B0mu70Kv.js";
...
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DJ0PrN48.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-0PULb_a4.js";
import { t as buildChannelAccountSnapshot } from "./status-BiAIUgps.js";
import { t as installSkill } from "./skills-install-OAyai2f7.js";
import { m as normalizeUpdateChannel } from "./update-check-BIuWc0rq.js";
import { n as readPackageVersion } from "./package-json-CtHtV7sr.js";
import { t as getStatusSummary } from "./status.summary-CTJdAtNS.js";
import "./status-CV9wQzyv.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BWjEKpIs.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-CM7MFnuE.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-Bv1OXBAl.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-VAL54pFY.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-Bc_P3rB8.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-BZqlmAYW.js";
import { C as consumeControlPlaneWriteBudget, _ as resolveVoiceWakeRouteByTrigger, a as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, b as isRoleAuthorizedForMethod, c as nodeWakeById, d as normalizeVoiceWakeTriggers, f as loadVoiceWakeConfig, g as normalizeVoiceWakeRoutingConfig, h as loadVoiceWakeRoutingConfig, l as nodeWakeNudgeById, m as resolveSessionKeyForRun, n as listSystemPresence, o as NODE_WAKE_RECONNECT_WAIT_MS, p as setVoiceWakeTriggers, r as updateSystemPresence, t as broadcastPresenceSnapshot, u as formatError$1, v as setVoiceWakeRoutingConfig, x as parseGatewayRole, y as validateVoiceWakeRoutingConfigInput } from "./presence-events-DWLZlx7H.js";
import { n as resolveGatewayReloadSettings, t as diffConfigPaths } from "./config-reload-BiGXFYSb.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DN_2kBV9.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-CV7_j0bQ.js";
import "./heartbeat-runner-U5tOqhVt.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-CWosfFyT.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-CJRlWmIh.js";
...
async function loadModelsListCatalog(context, view) {
	if (view === "all") return await context.loadGatewayModelCatalog();
	let timeout;
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BFtnD6de.js");
