...
import { i as parseDotPath } from "./shared-C1xGX3xe.js";
import { n as getPath } from "./path-utils-BDjOtfP3.js";
...
function listChannelSecretTargetRegistryEntries(bundledPlugins) {
	const entries = [];
	for (const record of bundledPlugins) {
