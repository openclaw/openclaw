import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-DfbLWVNE.js";
import { r as loadCrestodianOverview } from "./overview-DcG0tj1Q.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-DZodrhEv.js")).planCrestodianCommand)({
		input,
		overview
	});
