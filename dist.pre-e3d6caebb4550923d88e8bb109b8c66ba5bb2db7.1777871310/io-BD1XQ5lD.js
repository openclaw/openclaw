...
import { o as sanitizeHostExecEnv } from "./host-env-security-DKoIiz1v.js";
import { c as isRecord, p as resolveUserPath, x as isPlainObject } from "./utils-CCskKJVV.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-CWwCr2r5.js";
import { r as applyConfigEnvVars } from "./state-dir-dotenv-Bj2f-okz.js";
import { a as coerceSecretRef, f as parseLegacySecretRefEnvMarker, r as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-CyuYZNvB.js";
import { n as VERSION } from "./version-Ew9InAD4.js";
import { n as discoverConfigSecretTargets } from "./target-registry-CUzC34VU.js";
import { i as setPathExistingStrict } from "./path-utils-BDjOtfP3.js";
import { r as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-rXHPD8HR.js";
import { t as isBlockedObjectKey } from "./prototype-keys-RBElZn9Q.js";
import { O as planManifestModelCatalogSuppressions } from "./discovery-B19Xdk1_.js";
import { n as resolveManifestCommandAliasOwnerInRegistry } from "./manifest-command-aliases-S5HPuXVA.js";
import { r as normalizeChatChannelId, t as CHANNEL_IDS } from "./ids-DUzZX4p8.js";
import { r as hasKind } from "./slots-BSAZAn7a.js";
import { a as normalizePluginId, c as resolveEffectivePluginActivationState, o as normalizePluginsConfig, u as resolveMemorySlotDecision } from "./config-state-6n1ivR82.js";
import { s as loadInstalledPluginIndexInstallRecordsSync } from "./manifest-registry-C9Iavh95.js";
import { r as normalizeProviderId } from "./provider-id-dd60CFPS.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-C_ppe0cm.js";
import { c as normalizeAgentId } from "./session-key-BSgfYlBK.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { t as loadDotEnv } from "./dotenv-C7yjdSeK.js";
import { c as writePersistedInstalledPluginIndexInstallRecordsSync, i as resolveInstalledPluginIndexRecordsStorePath } from "./installed-plugin-index-records-HUKXRLZh.js";
import { t as sanitizeTerminalText } from "./safe-text-Dkj_4eVY.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-WnvH4y5C.js";
import { r as formatConfigIssueSummary } from "./issue-format-u844k3jY.js";
import { t as applyMergePatch } from "./merge-patch-BzwP7uYW.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-CHyQiMS4.js";
import { t as resolveBundledProviderPolicySurface } from "./provider-public-artifacts-CNM__6Hg.js";
import { n as normalizeTalkConfig } from "./talk-DIeLKFsV.js";
import { V as normalizeSafeBinProfileFixtures, i as normalizeTrustedSafeBinDirs } from "./exec-safe-bin-trust-BMejNmcg.js";
import { n as stripShippedPluginInstallConfigRecords, t as extractShippedPluginInstallConfigRecords } from "./plugin-install-config-migration-BKa2iLfb.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath } from "./config-paths-D_qJbIXt.js";
import { d as registerRuntimeConfigWriteListener, i as getRuntimeConfigSnapshot, l as loadPinnedRuntimeConfig, n as createRuntimeConfigWriteNotification, o as getRuntimeConfigSnapshotRefreshHandler, r as finalizeRuntimeSnapshotWrite, s as getRuntimeConfigSourceSnapshot, u as notifyRuntimeConfigWriteListeners } from "./runtime-snapshot-BXa0Udtg.js";
import { n as listKnownChannelEnvVarNames } from "./channel-env-vars-Yhiui_jG.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-CSTJHQ7z.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-8joJQ-bD.js";
import { n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-CcQeXllt.js";
import { t as resolveWebSearchInstallCatalogEntries } from "./web-search-install-catalog-DYM2uW0d.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-TizWrrFq.js";
import { t as OpenClawSchema } from "./zod-schema-DAS1ch69.js";
import { r as shouldWarnOnTouchedVersion } from "./version-g1ztCCWD.js";
...
async function maybeRecoverSuspiciousConfigRead(params) {
	...
	if (restoredFromBackup) params.deps.logger.warn(`Config auto-restored from backup: ${params.configPath} (${suspicious.join(", ")})`);
	else params.deps.logger.warn(`Config auto-restore from backup failed: ${params.configPath} (${suspicious.join(", ")}${restoreErrorDetails.message ? `; ${restoreErrorDetails.message}` : ""})`);
...
*/
function validateConfigObjectRaw(raw, _opts) {
...
function validateConfigObjectWithPluginsBase(raw, opts) {
	const base = opts.applyDefaults ? validateConfigObject(raw, { sourceRaw: opts.sourceRaw }) : validateConfigObjectRaw(raw, { sourceRaw: opts.sourceRaw });
	if (!base.ok) return {
		ok: false,
		issues: base.issues,
		warnings: []
	...
	const collectConfiguredModelRefs = () => {
		const refs = [];
		...
		if (Array.isArray(config.agents?.list)) for (const [index, entry] of config.agents.list.entries()) collectFromAgent(`agents.list.${index}`, entry);
		return refs;
	};
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
	if (!raw || typeof raw !== "object") return [];
	const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-C_54UXOs.js");
...
function createConfigIO(overrides = {}) {
	...
	function loadConfig() {
		try {
			...
			const installMigration = migrateAndStripShippedPluginInstallConfigRecords(resolvedConfig, { rootConfigRaw: effectiveParsed });
...
//#endregion
export { resolveShellEnvExpectedKeys as A, applyUnsetPathsForWrite as B, validateConfigObjectRaw as C, collectPluginSchemaMetadata as D, collectChannelSchemaMetadata as E, unsetConfigOverride as F, formatInvalidConfigDetails as G, isPluginLocalInvalidConfigSnapshot as H, asResolvedSourceConfig as I, getShellPathFromLoginShell as J, maintainConfigBackups as K, asRuntimeConfig as L, getConfigOverrides as M, resetConfigOverrides as N, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as O, setConfigOverride as P, resolveOwnerDisplaySetting as Q, materializeRuntimeConfig as R, validateConfigObject as S, validateConfigObjectWithPlugins as T, shouldAttemptLastKnownGoodRecovery as U, resolveManagedUnsetPathsForWrite as V, createInvalidConfigError as W, resolveShellEnvFallbackTimeoutMs as X, loadShellEnvFallback as Y, shouldEnableShellEnvFallback as Z, recoverConfigFromLastKnownGood as _, loadConfig as a, writeConfigFile as b, promoteConfigSnapshotToLastKnownGood as c, readConfigFileSnapshotForWrite as d, readConfigFileSnapshotWithPluginMetadata as f, recoverConfigFromJsonRootSuffix as g, readSourceConfigSnapshotForWrite as h, getRuntimeConfig as i, applyConfigOverrides as j, migrateLegacySecretRefEnvMarkers as k, readBestEffortConfig as l, readSourceConfigSnapshot as m, clearConfigCache as n, parseConfigJson5 as o, readSourceConfigBestEffort as p, getShellEnvAppliedKeys as q, createConfigIO as r, projectConfigOntoRuntimeSourceSnapshot as s, ConfigRuntimeRefreshError as t, readConfigFileSnapshot as u, registerConfigWriteListener as v, validateConfigObjectRawWithPlugins as w, collectUnsupportedSecretRefPolicyIssues as x, resolveConfigSnapshotHash as y, resolveNormalizedProviderModelMaxTokens as z };
