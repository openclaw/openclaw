...
import { l as jsonResult } from "../../common-CBt8chmE.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-BGlRWt5v.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-slQSPuGr.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-BCiLpP1x.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-BeSws0n2.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-B3yy3grg.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-USDYxCGy.js");
