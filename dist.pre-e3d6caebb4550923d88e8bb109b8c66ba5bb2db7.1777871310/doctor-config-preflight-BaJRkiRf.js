...
import { g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-BD1XQ5lD.js";
import { n as formatConfigIssueLines } from "./issue-format-u844k3jY.js";
import { t as note } from "./note-D-SKYdVO.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-D9CwESIM.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-B2CfqI4N.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BKjeoA5M.js");
