...
import { a as defineImportedCommandGroupSpec, i as buildCommandGroupEntries, o as defineImportedProgramCommandGroupSpecs } from "./register.subclis-core-BMrMiVpk.js";
...
const coreEntrySpecs = [
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([
		{
			...
			loadModule: () => import("./register.crestodian-DDW_NKf1.js"),
		...
		{
			commandNames: ["config"],
			loadModule: () => import("./config-cli-dYdSHhjD.js"),
	...
	defineImportedCommandGroupSpec(["agent", "agents"], () => import("./register.agent-tK-wV3RZ.js"), (mod, { program, ctx }) => {
