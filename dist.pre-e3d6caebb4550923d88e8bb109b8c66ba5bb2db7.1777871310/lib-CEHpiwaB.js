...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-BjGQKNA-.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DKZqQKRI.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-BNqk0lJo.js";
import { l as toRatio, n as decodeString } from "./Util-DhSo5yx2.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-C5_I1zmi.js";
import { t as APEv2Parser } from "./APEv2Parser-De6NzWP6.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DAYKTZwC.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CVRowTBs.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-5J3VhyV_.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-macj_N4J.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CHesOa6r.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BfXlVDYt.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-KmltKmE5.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-D_8Vd9Gi.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Ce0V5gKD.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DB11syNu.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DNtPqrnR.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BGJEbUAv.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DJcezikr.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-C96ypPt_.js")).WaveParser;
	}
};
//#endregion
