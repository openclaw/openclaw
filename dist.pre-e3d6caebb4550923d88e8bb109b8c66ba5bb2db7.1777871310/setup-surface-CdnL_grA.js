...
import { u as normalizeSecretInputString } from "./types.secrets-CyuYZNvB.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-DUpVOe8L.js";
import { Q as splitSetupEntries, f as createStandardChannelSetupStatus, g as createTopLevelChannelGroupPolicySetter, m as createTopLevelChannelDmPolicy, p as createTopLevelChannelAllowFromSetter, v as mergeAllowFromEntries } from "./setup-wizard-helpers-D8cUTbTq.js";
import "./setup-C421YIRA.js";
import "./setup-tools-DdUgobpV.js";
import { D as formatUnknownError, g as saveDelegatedTokens, h as resolveMSTeamsCredentials, p as hasConfiguredMSTeamsCredentials } from "./graph-users-Bb6EI2HB.js";
import { c as resolveMSTeamsUserAllowlist, o as parseMSTeamsTeamEntry, s as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-CV8TsB_y.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				try {
					const { loginMSTeamsDelegated } = await import("./oauth-mAs_gzf0.js");
					const { shouldUseManualOAuthFlow } = await import("./oauth.flow-C5tUHOQs.js");
