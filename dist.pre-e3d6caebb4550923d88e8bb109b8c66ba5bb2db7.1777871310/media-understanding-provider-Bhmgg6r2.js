...
import { r as readModelListResult } from "./models-B56N-5AL.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-DQ-3YSZl.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
