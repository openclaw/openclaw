...
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-ChNcX7-h.js";
...
import { i as READ_SCOPE } from "./operator-scopes-CzzqJwKB.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-E3Itu8dq.js");
