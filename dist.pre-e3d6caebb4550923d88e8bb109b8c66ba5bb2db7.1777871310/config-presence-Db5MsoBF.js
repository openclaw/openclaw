...
import { n as listBundledChannelIdsForPackageState, t as hasBundledChannelPackageState } from "./package-state-probes-qnckTJWr.js";
import { t as resolveAgentRuntimePolicy } from "./agent-runtime-policy-GBXGObpb.js";
import { i as listBundledChannelPluginIds } from "./bootstrap-registry-kKk9J215.js";
import { i as hasNonEmptyString } from "./channel-target-Bc_JzNhy.js";
...
function listPotentialConfiguredChannelPresenceSignals(cfg, env = process.env, options = {}) {
	...
	const channelEnvPrefixes = listChannelEnvPrefixes(options.channelIds ?? listBundledChannelPluginIds(env));
	const channels = isRecord(cfg.channels) ? cfg.channels : null;
