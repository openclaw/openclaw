...
import { t as getActiveMatrixClient } from "./active-client-DQhffnEz.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-D4n6rDXa.js"), import("./shared-CzUMUFRW.js")]).then(([clientModule, sharedModule]) => ({
