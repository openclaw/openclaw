...
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-B3pr-X7V.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Bjj9r8Wn.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-CxR7kyT3.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-CRsJHE3b.js";
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName } from "./tool-policy-shared-ywrO5Obc.js";
import { c as mergeAlsoAllowPolicy, i as collectExplicitAllowlist, n as applyOwnerOnlyToolPolicy } from "./tool-policy-Gps1tVLh.js";
import { _ as wrapToolWorkspaceRootGuard, c as createHostWorkspaceAppendTool, d as createOpenClawReadTool, f as createSandboxedEditTool, g as wrapToolMemoryFlushAppendOnlyWrite, h as wrapToolMemoryDayFileWriteGuard, l as createHostWorkspaceEditTool, m as createSandboxedWriteTool, p as createSandboxedReadTool, t as createOpenClawTools, u as createHostWorkspaceWriteTool, v as wrapToolWorkspaceRootGuardWithOptions, y as resolveOpenClawPluginToolsForOptions } from "./openclaw-tools-CmS57ZTw.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-DNWZXyec.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-UHcDq1j4.js";
import { i as listChannelAgentTools, t as copyChannelAgentToolMeta } from "./channel-tools-BqeSuwSs.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-CSW-RVTE.js";
import { t as bindAbortRelay } from "./fetch-timeout-r0xrE0Xt.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DyvqMMGn.js";
import { c as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-C6-HXiI-.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-B75SIh6-.js";
import { n as assertSandboxPath } from "./sandbox-paths-D55Xc0F2.js";
import { a as toRelativeSandboxPath, i as resolvePathFromInput, r as resolveWorkspaceRoot } from "./read-capability-CPsrzS02.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BVH6woOS.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-CAAXa43q.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-DnP9HO2i.js";
import "./codex-native-web-search-DXVjTgw5.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-CrMH8bQo.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-DFIU6owN.js";
...
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-pMVEJlml.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-BrBycE1Q.js"));
...
function createOpenClawCodingTools(options) {
	...
	const base = includeCoreTools ? createCodingTools(workspaceRoot).flatMap((tool) => {
		if (tool.name === "read") {
			if (sandboxRoot) {
	...
	const execTool = includeCoreTools ? createLazyExecTool({
		...execDefaults,
	...
	const pluginToolsOnly = includeCoreTools ? [] : resolveOpenClawPluginToolsForOptions({
		options: {
	...
	const tools = [
		...base,
		...includeCoreTools && sandboxRoot ? allowWorkspaceWrites ? [workspaceOnly ? wrapToolWorkspaceRootGuardWithOptions(createSandboxedEditTool({
			root: sandboxRoot,
			bridge: sandboxFsBridge
		...
		...includeCoreTools && applyPatchTool ? [applyPatchTool] : [],
		...execTool ? [execTool] : [],
		...processTool ? [processTool] : [],
		...includeCoreTools ? listChannelAgentTools({ cfg: options?.config }) : [],
		...includeCoreTools ? createOpenClawTools({
			sandboxBrowserBridgeUrl: sandbox?.browser?.bridgeUrl,
			allowHostBrowserControl: sandbox ? sandbox.browserAllowHostControl : true,
			agentSessionKey: options?.sessionKey,
			agentChannel: resolveGatewayMessageChannel(options?.messageProvider),
