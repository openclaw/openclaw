...
import { T as validateConfigObjectWithPlugins, k as migrateLegacySecretRefEnvMarkers, z as resolveNormalizedProviderModelMaxTokens } from "./io-BD1XQ5lD.js";
import { n as formatConfigIssueLines } from "./issue-format-u844k3jY.js";
import { r as normalizeTalkSection } from "./talk-DIeLKFsV.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-BHP5Fe5O.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-kKk9J215.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DGUlA6fn.js";
import { n as getLoadedChannelPlugin } from "./registry-Cl8KmGKt.js";
import { i as listRouteBindings } from "./bindings-CJZklmri.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DJJTxJ7G.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-B6Z2VMlB.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BFq7nJnd.js";
import { t as note } from "./note-D-SKYdVO.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-D9CwESIM.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, n as LEGACY_CONFIG_MIGRATIONS, o as loadBundledChannelDoctorContractApi, r as migrateLegacyWebSearchConfig, s as applyPluginDoctorCompatibilityMigrations } from "./legacy-config-issues-B2CfqI4N.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-ZXAICtAn.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BaJRkiRf.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-j33jUTYu.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-zAvoCErd.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BaNBNSoH.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-DkREH_qY.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-BICZriwA.js");
		emitDoctorNotes({
			note,
