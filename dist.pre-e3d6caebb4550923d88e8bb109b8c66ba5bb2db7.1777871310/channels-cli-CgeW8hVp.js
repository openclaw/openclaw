...
import { t as hasExplicitOptions } from "./command-options-C2ZTJm5U.js";
...
import { t as danger } from "./globals-C7I_COwU.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-BD1XQ5lD.js";
...
import { a as normalizeChannelId, i as listChannelPlugins } from "./registry-Cl8KmGKt.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-BARcqqfR.js";
import { n as listBundledPackageChannelMetadata } from "./bundled-package-channel-metadata-DMwoQon7.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-C-LPLYSV.js";
import { t as formatCliChannelOptions } from "./channel-options-C20xjF7q.js";
import { t as applyParentDefaultHelpAction } from "./parent-default-help-B3u72EKv.js";
...
const channelsCommandsLoader = createLazyImportLoader(() => import("./channels-DbT2qVgH.js"));
...
function registerChannelsCli(program) {
	...
	channels.command("list").description("List configured channels + auth profiles").option("--no-usage", "Skip model provider usage/quota snapshots").option("--json", "Output JSON", false).action(async (opts) => {
		await runChannelsCommand(async () => {
			const { channelsListCommand } = await import("./list-BoUtd9Ux.js");
	...
	channels.command("status").description("Show gateway channel status (use status --deep for local)").option("--probe", "Probe channel credentials", false).option("--timeout <ms>", "Timeout in ms", "10000").option("--json", "Output JSON", false).action(async (opts) => {
		await runChannelsCommand(async () => {
			const { channelsStatusCommand } = await import("./status-CYI2olWn.js");
