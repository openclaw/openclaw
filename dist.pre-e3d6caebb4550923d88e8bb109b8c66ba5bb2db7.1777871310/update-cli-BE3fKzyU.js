...
import { p as resolveUserPath, u as pathExists$1 } from "./utils-CCskKJVV.js";
...
import { c as resolveGatewayInstallEntrypoint } from "./daemon-install-plan.shared-DZsnpy4W.js";
import { n as VERSION } from "./version-Ew9InAD4.js";
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-WXOsBZRd.js";
...
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-CIw_BLPB.js";
...
import { I as asResolvedSourceConfig, L as asRuntimeConfig, u as readConfigFileSnapshot } from "./io-BD1XQ5lD.js";
...
import { n as getOfficialExternalPluginCatalogManifest, s as resolveOfficialExternalPluginInstall, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-VEKfquQd.js";
import { r as replaceConfigFile, t as ConfigMutationConflictError } from "./mutate-BCZFK4XP.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-Dze7OUs5.js";
import { a as shellEscapeRestartLogValue, i as resolveGatewayRestartLogPath, n as renderPosixRestartLogSetup } from "./restart-logs-C4YIJEWT.js";
import "./config-CshcuIUd.js";
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-BtB0_RAH.js";
import { n as runDaemonInstall } from "./install-CCnqPrSm.js";
import { t as runDaemonRestart } from "./lifecycle-aNzstclo.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-C1w7jJBN.js";
...
import { n as stylePromptMessage } from "./prompt-style-DrlWA6Nb.js";
...
import { i as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-DCX8zxlT.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-CCWOEdjD.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-DPrsHBh5.js";
import { t as doctorCommand } from "./doctor-CVDDsNQK.js";
import { t as selectStyled } from "./prompt-select-styled-pG80a3of.js";
import { _ as resolveUpdateChannelDisplay, d as formatUpdateChannelLabel, g as resolveRegistryUpdateChannel, h as resolveEffectiveUpdateChannel, i as fetchNpmTagVersion, m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus, u as channelToNpmTag } from "./update-check-BIuWc0rq.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-CxzsUW7u.js";
import { n as readPackageVersion, t as readPackageName } from "./package-json-CtHtV7sr.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as normalizePackageTagInput, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-CM7MFnuE.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-yEANRQ9m.js";
...
Plugin update aborted. Reinstall the plugin only if you trust the new artifact.`));
	...
	const repairMissingPayloads = async (records) => {
		const missing = await collectMissingPluginInstallPayloads({ records });
		if (missing.length === 0) return [];
		const missingIds = missing.map((entry) => entry.pluginId);
		if (!params.opts.json) defaultRuntime.log(theme.warn(`Recovering missing plugin install payloads: ${missing.map((entry) => `${entry.pluginId} (${formatMissingPluginPayloadReason(entry)})`).join(", ")}.`));
	...
	const repairedMissingPayloadIds = await repairMissingPayloads(pluginConfig.plugins?.installs ?? {});
	...
	const remainingMissingPayloads = await collectMissingPluginInstallPayloads({ records: pluginConfig.plugins?.installs ?? {} });
	pluginUpdateOutcomes.push(...remainingMissingPayloads.map((entry) => ({
	...
	if (params.opts.json) return {
		status: syncResult.summary.errors.length > 0 || pluginUpdateOutcomes.some((outcome) => outcome.status === "error") ? "error" : "ok",
...
async function continuePostCoreUpdateInFreshProcess(params) {
	...
	const resultDir = params.opts.json === true ? await fs$1.mkdtemp(path.join(os.tmpdir(), "openclaw-update-post-core-")) : null;
	...
	try {
		...
		if (resultDir) await fs$1.rm(resultDir, {
			recursive: true,
			force: true
		}).catch(() => void 0);
	}
