...
import { n as createSafeNpmInstallEnv } from "./safe-package-install-CfBKFKAu.js";
import { a as resolveDefaultPluginNpmDir, i as resolveDefaultPluginGitDir, o as resolvePluginInstallDir } from "./install-paths-imIYZny-.js";
...
function resolveUninstallDirectoryTarget(params) {
	...
	if (gitManagedPath) return gitManagedPath;
	let defaultPath;
	try {
...
function resolveGitManagedInstallPath(params) {
	...
	for (const gitRoot of gitRoots) if (isPathInsideOrEqual(gitRoot, installPath) && resolveComparablePath(gitRoot) !== resolveComparablePath(installPath)) return installPath;
	return null;
}
