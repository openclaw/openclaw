...
import { n as sortWebSearchProviders } from "./web-search-providers.shared-Cz3A41iG.js";
...
async function finalizeSearchProviderSetup(params) {
	...
	if (installEntry && next.tools?.web?.search?.enabled !== false) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-G9cSAWwn.js");
