...
import { n as extractAssistantText } from "./pi-embedded-utils-Cz1rJRIQ.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-D2Lru4O1.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-cLmytlnp.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-PU-Or-jK.js")).runEmbeddedPiAgent;
}
