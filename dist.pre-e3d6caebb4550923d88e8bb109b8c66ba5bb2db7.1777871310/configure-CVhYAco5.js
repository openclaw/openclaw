...
import { t as ConfigMutationConflictError } from "./mutate-BCZFK4XP.js";
...
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-DI26zU0i.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-Ck04u63K.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CRzRppBl.js";
import { n as applyAuthChoice } from "./auth-choice-CDMELgkN.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-uzCGsnxi.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-D9zo4zwW.js";
import { t as applyPrimaryModel } from "./provider-model-primary-C149BevK.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-C4haBJW-.js";
import { t as promptCustomApiConfig } from "./onboard-custom-Du9sPeWo.js";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-49VMu1r6.js";
import { t as setupSkills } from "./onboard-skills-AOHXq7Pb.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-Bks832cD.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Bea_nMgg.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BOYbaE9H.js");
