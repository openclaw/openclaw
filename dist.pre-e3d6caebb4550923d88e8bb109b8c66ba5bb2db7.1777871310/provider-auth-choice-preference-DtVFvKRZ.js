import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BKNk-ROo.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-Qura12sI.js");
