...
import { n as createLazyPromiseLoader, t as createLazyImportLoader } from "./lazy-promise-BWWZqHu4.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-DfaZN9JD.js";
import { u as resolveStorePath } from "./paths-Dl79wsM6.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-C4S7NY0S.js";
...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-D0EA5CqK.js";
import { c as setDetachedTaskDeliveryStatusByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-C1Twctmt.js";
import "./subagent-announce-queue-DOmPe80U.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-Bh68L5Oy.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-ewvtV6UT.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-DhP0LGNV.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BdWXZpNv.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-B-CKe2BY.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BdWXZpNv.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-BWBAQLbD.js").then(({ scheduleOrphanRecovery }) => {
