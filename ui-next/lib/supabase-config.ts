...
export async function deleteSupabaseInstance(request: RequestFn, id: string): Promise<void> {
  await request("supabase.deleteInstance", { id });
}

export async function setDefaultSupabaseInstance(request: RequestFn, id: string): Promise<void> {
