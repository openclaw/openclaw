...
- After implementation passes, run the task packet `finalizeCommand`. Do not stop after `validationCommand`; `finalizeCommand` is what commits scoped changes, pushes the branch, and syncs the PR.
