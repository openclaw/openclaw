...
- `../.local/operator-harness/codex-homes/<role>/`: isolated Codex homes for Paperclip workers
...
- per-role Codex homes used by the local Paperclip workers
...
- aggregates builder + reviewer + spot-check screenshots directly in the PR body
