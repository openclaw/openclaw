...
import { r as readModelListResult } from "./models-L_-Mzhj-.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-CLYBR2tH.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
