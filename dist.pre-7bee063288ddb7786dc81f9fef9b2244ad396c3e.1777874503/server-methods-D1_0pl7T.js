...
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools--M5KsSAV.js";
...
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-_uW54tX2.js";
...
import "./heartbeat-runner-CFeuBqBz.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-Dwleozc6.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-BoCUy5AP.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-yQzmxjS6.js");
