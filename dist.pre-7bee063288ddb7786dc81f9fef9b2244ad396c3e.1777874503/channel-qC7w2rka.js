...
import { n as normalizeAtHashSlug } from "./string-normalization-rJ4BOsjW.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-DUpVOe8L.js";
import { n as sleepWithAbort } from "./backoff-cuqj1EHH.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-CVqwHtSq.js";
...
import { i as createChatChannelPlugin } from "./core-BYja3dMh.js";
import "./channel-core-i4Td4Pcb.js";
import "./error-runtime-B9i9dR6-.js";
import "./channel-policy-CrpCRRGP.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-FPPKm6Kb.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-BY9ds7Zc.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-HNgb0OrQ.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-BvzPNo7p.js";
import "./runtime-env-BBcuHj0d.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-BlD8CzkK.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-lkwKOGNX.js";
import "./channel-api-_30i2wlO.js";
import { n as looksLikeDiscordTargetId, o as parseDiscordTarget, r as normalizeDiscordMessagingTarget } from "./normalize-CXn44Q3y.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-B1rAX9o8.js";
import { t as getDiscordRuntime } from "./runtime-MMWOrcsT.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-DqHc_yyQ.js";
import { t as getDiscordApprovalCapability } from "./approval-native-IWoQVV03.js";
import { t as discordMessageActions$1 } from "./channel-actions-By_7vuYQ.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-CjyjGwIe.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-3gSrAMzc.js";
import { n as discordOutbound } from "./outbound-adapter-D7X2AgQx.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-Bk73n3GR.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-C4JmqbfH.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CrcfEc9D.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-j6iHYPXV.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BsbsKdWL.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DICyXzGX.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-RmX8odRn.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-C7tc4RWN.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DQoT8F5-.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DLFhwlmJ.js");
