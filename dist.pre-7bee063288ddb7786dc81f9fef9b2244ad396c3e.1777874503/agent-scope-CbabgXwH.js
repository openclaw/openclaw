...
import { c as normalizeAgentId, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BSgfYlBK.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-CYPYEsB7.js";
import { t as resolveAgentModelFallbackValues } from "./model-input-DVA3X1TY.js";
import { t as resolveEffectiveAgentSkillFilter } from "./agent-filter-h2bteqMn.js";
import fs from "node:fs";
import path from "node:path";
//#region src/agents/agent-scope-config.ts
let defaultAgentWarned = false;
function warnMultipleDefaultAgents() {
	import("./subsystem-EqO0a2-l.js").then(({ createSubsystemLogger }) => {
