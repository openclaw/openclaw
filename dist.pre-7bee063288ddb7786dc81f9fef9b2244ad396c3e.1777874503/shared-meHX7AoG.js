...
import { n as LogService } from "./logger-DOQh85eU.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-I7jxdqBX.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-PI0HPOby.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-BoIiZq3h.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
