...
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-DKoIiz1v.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-W_9piPld.js";
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DZsnpy4W.js";
import { n as VERSION } from "./version-Ew9InAD4.js";
import { g as buildNodeServiceEnvironment } from "./runtime-paths-ykBd9_J0.js";
...
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-wNul2W2p.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-SlSICztL.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DzXcT_zg.js";
import { a as getActivePluginRegistry } from "./runtime-Cqk_-fBI.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-BOvENks_.js";
import { t as getMachineDisplayName } from "./machine-name-B7JzwQ3F.js";
import { t as splitShellArgs } from "./shell-argv-BjjXLqqr.js";
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-tQTMtu9w.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-B75SIh6-.js";
import { N as saveExecApprovals, O as resolveExecApprovals, P as requestJsonlSocket, T as requiresExecApproval, b as readExecApprovalsSnapshot, c as hasDurableExecApproval, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, o as addDurableCommandApproval, s as ensureExecApprovals, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-DXm9TLRA.js";
...
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CrTMSWih.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-DLX5Zi_0.js";
import { t as resolveNodeService } from "./node-service-DXv-gi2A.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-B10gNxe5.js");
