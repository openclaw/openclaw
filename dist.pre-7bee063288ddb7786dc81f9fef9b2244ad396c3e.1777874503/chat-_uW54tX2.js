...
import { p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { r as setSafeTimeout } from "./timer-delay-CXN8AYgX.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-C_DWi525.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-C7rda51s.js";
import { n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-CxR7kyT3.js";
import { C as validateChatSendParams, S as validateChatInjectParams, Xr as errorShape, Yr as ErrorCodes, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-Coga23eo.js";
import { o as normalizeInputProvenance } from "./input-provenance-CUM8d5rU.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CzzqJwKB.js";
import "./method-scopes-BHFmOSiN.js";
import { i as resolveSessionFilePath } from "./paths-Dl79wsM6.js";
import "./sessions-DCQidobb.js";
import { o as appendSessionTranscriptMessage, s as emitSessionTranscriptUpdate } from "./transcript-5Sw8IXME.js";
import { C as jsonUtf8Bytes, h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes } from "./session-utils.fs-Cpvj0zGb.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-B1b9dtWF.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-l6vzGR0v.js";
import { o as isAudioFileName } from "./mime-B30DelN1.js";
import { a as normalizeReplyPayloadsForDelivery } from "./deliver-BKaUMp20.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-B61Gbdzt.js";
import { a as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-DUItrpyH.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-CUkWYVtg.js";
import { i as deleteMediaBuffer, l as saveMediaBuffer, t as MEDIA_MAX_BYTES } from "./store-CuaIMlC4.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-D8X3Y-o4.js";
...
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-DVbI4dTa.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-Dfo5eVim.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-Cn476Ys4.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch--Q376VdZ.js";
...
import { t as formatForLog } from "./ws-log-D-XPYfqP.js";
import { u as logLargePayload } from "./http-common-BB7WaGsT.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-DMowuAj4.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-KOlUTK71.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-DNpWRqBv.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-DQ9GGG6O.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-Bhj1l40B.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BOEkc3to.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-DS2-4cuV.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-DHYRXXok.js";
