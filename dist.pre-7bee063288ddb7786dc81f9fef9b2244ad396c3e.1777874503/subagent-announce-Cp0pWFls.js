...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-qXGu5GiY.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-B5LCdh_k.js";
import "./delivery-context-DjnXDY-i.js";
import { n as resolveContinuationRuntimeConfig } from "./config-Cko-TbTj.js";
import { i as consumePendingDelegates } from "./delegate-store-BdQs4YDx.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-FHE2xp8J.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-CeHJibOv.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-CxwDScCl.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-DVoSYUZM.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-CpiLrd2n.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-C0rExkeK.js"), import("./store-load-BEm54Zt7.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-DPoY_ohy.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-L8M_FPYQ.js");
			const { createSubsystemLogger } = await import("./subsystem-EqO0a2-l.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-6DwxTV8j.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
