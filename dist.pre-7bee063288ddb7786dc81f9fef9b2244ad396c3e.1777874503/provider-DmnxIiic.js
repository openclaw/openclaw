...
import { b as isVerbose } from "./logger-BK1OY7lv.js";
...
import { n as logError, t as logDebug } from "./logger-CeZgWgtG.js";
...
import { n as readSessionUpdatedAt, o as updateSessionStore } from "./store-IyLBOjUO.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-aDhlumjq.js";
import { r as clearExpiredCooldowns, s as isProfileInCooldown } from "./order-Bqhj-A3k.js";
import { s as resolveProfilesUnavailableReason } from "./usage-B2Hi4H5h.js";
import { i as resolveEffectiveDebugProxyUrl, r as resolveDebugProxySettings } from "./env-9OGxKNw1.js";
import { n as captureWsEvent, t as captureHttpExchange } from "./runtime-D_N5-b_7.js";
import "./provider-model-shared-wmBDALmq.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-C2Af5kcY.js";
import { h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-B61Gbdzt.js";
...
import { i as resolveChannelStreamingBlockEnabled } from "./channel-streaming-BFQKL9hJ.js";
...
import { i as formatDurationSeconds } from "./format-duration-lR2DqIAf.js";
import { t as finalizeInboundContext } from "./inbound-context-7ossg2z_.js";
import { n as chunkItems } from "./text-runtime-icMZVCaq.js";
import { t as summarizeStringEntries } from "./string-sample-CtY8y6HT.js";
...
import { c as parseCommandArgs, d as serializeCommandArgs, i as formatCommandArgMenuTitle, l as resolveCommandArgChoices, n as buildCommandTextFromArgs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-Bv9Wm6ed.js";
...
import { d as upsertChannelPairingRequest } from "./pairing-store-BI1ByK4W.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-o-LATR-A.js";
import { c as buildAllowlistResolutionSummary, d as patchAllowlistUsersInConfigEntries, f as summarizeMapping, l as canonicalizeAllowlistWithResolvedIds, s as addAllowlistUserEntriesFromConfigEntry } from "./allow-from-D94DQVPL.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-BjigiEZz.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-B5hD9Rz4.js";
import { l as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-DAgHnxNz.js";
...
import "./proxy-capture-CwEkRjIv.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-runtime-Bs_-oJdk.js";
...
import { n as dispatchReplyWithDispatcher } from "./reply-dispatch-runtime-X15FNsXA.js";
import "./reply-chunking-CRxdpUGk.js";
import { a as runInboundReplyTurn } from "./inbound-reply-dispatch-BNcsRuO0.js";
import "./web-media-BfqF04MS.js";
import "./system-event-runtime-DQ8QWTAo.js";
import { n as wrapFetchWithAbortSignal } from "./fetch-C1OoqJO0.js";
...
import { n as resolveConfiguredBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CBB1G_vP.js";
import "./conversation-binding-runtime-BPo8eBQs.js";
...
import { t as resolveDirectStatusReplyForSession } from "./command-status-runtime-DTe85kQB.js";
import "./channel-inbound-VYaKf4i3.js";
import "./fetch-runtime-DPrxmB2M.js";
import "./session-store-runtime-kmcykxzs.js";
import "./native-command-config-runtime-DLK_Z9Av.js";
import "./native-command-registry-ChEdThzJ.js";
import "./state-paths-CCjoKEpC.js";
import { t as normalizeDiscordToken } from "./token-BzXoJa86.js";
import { c as resolveDiscordAccountAllowFrom, d as resolveDiscordAccountDmPolicy, f as resolveDiscordMaxLinesPerMessage, s as resolveDiscordAccount } from "./accounts-lkwKOGNX.js";
import { a as chunkDiscordTextWithMode } from "./normalize-CXn44Q3y.js";
import { a as resolveDiscordModalEntryWithPersistence, i as resolveDiscordComponentEntryWithPersistence, t as editDiscordComponentMessage } from "./send.components-D_yAivlk.js";
import { c as setPresence, i as unregisterGateway, r as registerGateway } from "./gateway-registry-VH4YiF1v.js";
import { B as StringSelectMenu, Bt as GatewayIntentBits, E as Modal, Ft as ButtonStyle, It as ChannelType, L as Row, Lt as ComponentType, Nt as overwriteApplicationCommands, Pt as ApplicationCommandOptionType, Rt as GatewayCloseCodes, S as User, V as TextDisplay, Vt as GatewayOpcodes, W as BaseMessageInteractiveComponent, a as PresenceUpdateListener, b as Guild, c as ThreadUpdateListener, d as Plugin, i as MessageReactionRemoveListener, j as Container, k as Button, m as RateLimitError, n as MessageCreateListener, o as ReadyListener, r as MessageReactionAddListener, t as InteractionCreateListener, u as Client, v as Command, x as Message, y as CommandWithSubcommands, z as Separator, zt as GatewayDispatchEvents } from "./discord-COXSKWSt.js";
import { B as validateDiscordProxyUrl, L as DISCORD_REST_TIMEOUT_MS, N as createDiscordRestClient, R as createDiscordRequestClient, V as withValidatedDiscordProxy, z as resolveDiscordProxyFetchForAccount } from "./send.shared-BgtjIk0s.js";
import { i as summarizeDiscordResponseBody, r as isDiscordRateLimitResponseBody } from "./api-Cg7lo8X4.js";
import { n as formatDiscordUserTag, t as formatDiscordReactionEmoji } from "./format-GVI6xk1U.js";
import { _ as resolveGroupDmAllow, a as normalizeDiscordSlug, c as resolveDiscordChannelConfigWithFallback, d as resolveDiscordGuildEntry, f as resolveDiscordMemberAccessState, i as normalizeDiscordDisplaySlug, l as resolveDiscordChannelPolicyCommandAuthorizer, m as resolveDiscordOwnerAccess, n as isDiscordGroupAllowedByPolicy, o as resolveDiscordAllowListMatch, r as normalizeDiscordAllowList, v as shouldEmitDiscordReactionNotification } from "./allow-list-V4K1OMN4.js";
import { t as formatMention } from "./mentions-CpdnYFv3.js";
import { g as parseDiscordModalCustomIdForInteraction, h as parseDiscordModalCustomId, m as parseDiscordComponentCustomIdForInteraction, p as parseDiscordComponentCustomId } from "./components-BoJZFgrt.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers } from "./approval-shared-DqHc_yyQ.js";
import "./approval-native-IWoQVV03.js";
import { t as resolveDiscordConversationIdentity } from "./conversation-identity-CjyjGwIe.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-Dr89EJQE.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-BprZm4Vf.js";
import { a as isThreadArchived } from "./thread-bindings.discord-api-PiZ33bUG.js";
import { i as resolveDiscordChannelParentIdSafe, n as resolveDiscordChannelInfoSafe, o as resolveDiscordChannelTopicSafe, r as resolveDiscordChannelNameSafe, t as resolveDiscordChannelIdSafe } from "./channel-access-DYPt_z4a.js";
import { r as parseApplicationIdFromToken, t as fetchDiscordApplicationId } from "./probe-B6Q1D4sX.js";
import { o as raceWithTimeout, s as withAbortTimeout } from "./timeouts-DSWCWqcp.js";
import { c as resolveDiscordChannelInfo } from "./message-utils-BmS0jxXy.js";
import { s as resolveDiscordThreadParentInfo } from "./threading-DiQdNjvw.js";
import { c as resolveDiscordDmAccessGroupEntries, i as resolveDiscordEffectiveRoute, n as resolveDiscordBoundConversationRoute, o as handleDiscordDmCommandDecision, s as resolveDiscordDmCommandAccess } from "./route-resolution-DB2vSDXy.js";
import { t as resolveDiscordSenderIdentity } from "./sender-identity-DCAbSW1U.js";
import { n as buildDiscordInboundAccessContext, t as buildDiscordGroupSystemPrompt } from "./inbound-context-_JZbHeZI.js";
import { n as resolveDiscordVoiceEnabled, t as authorizeDiscordVoiceIngress } from "./access-nQHqEl_n.js";
import { n as buildDirectLabel, r as buildGuildLabel, t as deliverDiscordReply } from "./reply-delivery-DHyn-l6h.js";
import "./approval-handler.runtime-Dtl3M5Xr.js";
...
function readInteractionString(data, key) {
	if (!data || typeof data !== "object" || !(key in data)) return;
	const value = data[key];
	return typeof value === "string" && value.trim() ? value : void 0;
}
function describeInteractionForLog(data) {
	const id = readInteractionString(data, "id") ?? "<unknown>";
	const rawData = data && typeof data === "object" && "data" in data ? data.data : void 0;
	const nestedCommandName = rawData && typeof rawData === "object" && "name" in rawData ? rawData.name : void 0;
	return `interactionId=${id} command=${readInteractionString(data, "name") ?? (typeof nestedCommandName === "string" && nestedCommandName.trim() ? nestedCommandName : "<unknown>")} type=${readInteractionString(data, "type") ?? "<unknown>"}`;
}
var DiscordInteractionListener = class extends InteractionCreateListener {
	...
	async handle(data, client) {
		...
		Promise.resolve().then(() => client.handleInteraction(data, {})).catch((err) => {
			(this.logger ?? discordEventQueueLog).error(danger(`discord interaction handler failed: ${describeInteractionForLog(data)} phase=receive error=${String(err)}`));
		});
	}
};
...
function formatNativeCommandError(error) {
	if (error instanceof Error) return `${error.name}: ${error.message}`;
	return String(error);
}
function readInteractionId(interaction) {
	const rawId = interaction.rawData?.id;
	...
	return new class extends Command {
		...
		async run(interaction) {
			...
			try {
				...
				if (await safeDiscordInteractionCall("interaction defer", () => interaction.defer({ ephemeral: this.ephemeral })) === null) {
					log.warn(`discord native command defer skipped: interactionId=${interactionId} command=${commandLogName} phase=defer deferAttempted=${diagnostics.deferAttempted ?? false} deferSucceeded=false reason=unknown_interaction`);
					return;
				}
				...
				log.error(`discord native command failed: interactionId=${interactionId} command=${commandLogName} phase=${diagnostics.phase ?? "received"} deferAttempted=${diagnostics.deferAttempted ?? false} deferSucceeded=${diagnostics.deferSucceeded ?? false} authPhase=${diagnostics.authPhase ?? "not-run"} authResult=${diagnostics.authResult ?? "not-run"} error=${formatNativeCommandError(error)}`);
				throw error;
			}
		}
	}();
...
async function dispatchDiscordCommandInteraction(params) {
	const { interaction, prompt, command, commandArgs, cfg, discordConfig, accountId, sessionPrefix, preferFollowUp, threadBindings, responseEphemeral, suppressReplies, diagnostics } = params;
	...
	if (isDirectMessage) {
		...
		if (dmAccess.decision === "allow" && diagnostics) diagnostics.authResult = "allowed";
		if (dmAccess.decision !== "allow") {
			await handleDiscordDmCommandDecision({
				...
				onUnauthorized: async () => {
					if (diagnostics) diagnostics.authResult = "denied";
					log.warn(`discord native command auth denied: interactionId=${interactionId} command=${commandName} phase=dm-auth sender=${sender.id} reason=${dmAccess.decision}`);
	...
	if (!isDirectMessage) {
		...
		if (commandAuthorized && diagnostics) diagnostics.authResult = "allowed";
		if (!commandAuthorized && !await canBypassConfiguredAcpGuildGuards()) {
			if (diagnostics) diagnostics.authResult = "denied";
			log.warn(`discord native command auth denied: interactionId=${interactionId} command=${commandName} phase=guild-auth sender=${sender.id} guild=${interaction.guild?.id ?? "<none>"} channel=${rawChannelId || "<unknown>"} reason=command_authorized_false`);
			await respond("You are not authorized to use this command.", { ephemeral: true });
			return { accepted: false };
		}
		if (!commandAuthorized && diagnostics) diagnostics.authResult = "allowed-bypass";
	}
	if (diagnostics) diagnostics.phase = "dispatch";
...
async function loadTypingRuntime() {
	typingRuntimePromise ??= import("./typing-DQGBlY12.js");
...
async function loadComponentsRuntime() {
	componentsRuntimePromise ??= import("./components-9gkE7CuU.js");
