...
import { r as resolveCrestodianOperation } from "./dialogue-WAdI33vr.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BaCzYBmF.js")).runCrestodianTui;
	opts.onReady?.();
