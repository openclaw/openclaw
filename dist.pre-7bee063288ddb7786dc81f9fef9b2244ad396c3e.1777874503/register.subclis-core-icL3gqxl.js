...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-BRAvRWHL.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-DO3kejKx.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-DhgO2ETk.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-lmxAKwOW.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-CNFNpYv9.js"),
