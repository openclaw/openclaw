...
import { a as freezeDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-Dm49rK_G.js";
import { i as isDiagnosticsEnabled, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-DrCvmHmj.js";
...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-CbabgXwH.js";
import { i as getRuntimeConfig } from "./io-BD1XQ5lD.js";
import "./defaults-CHyQiMS4.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-DAS1ch69.js";
import "./config-CshcuIUd.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-CxR7kyT3.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-BvHoKJBV.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-DfaZN9JD.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-Dl79wsM6.js";
import { t as loadSessionStore } from "./store-load-BJuxv-vp.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-CuAWZ88l.js";
import { b as resolveGroupSessionKey, o as updateSessionStore, p as resolveSessionStoreEntry, s as updateSessionStoreEntry } from "./store-IyLBOjUO.js";
import "./sessions-DCQidobb.js";
import { a as resolveContextTokensForModel } from "./context-BDjWy3Dq.js";
import { g as resolveResponseUsageMode, h as normalizeVerboseLevel } from "./thinking-DXB3ip3_.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-DbwzllLp.js";
import { t as isCliProvider } from "./model-selection-cli-SCVmnYbl.js";
import "./model-selection-aDhlumjq.js";
import { u as resolveModelAuthMode } from "./model-auth-BiJ18q5C.js";
import { _ as ReplyRunAlreadyActiveError, l as queueEmbeddedPiMessage, v as createReplyOperation, y as replyRunRegistry } from "./runs-qXGu5GiY.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-M96bybgF.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CfSM05VC.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-Bn9PFA_4.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-Cpvj0zGb.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-Bt-hwnfd.js";
import { i as resolveSandboxConfigForAgent } from "./config-CH6rCqnJ.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BgCNJn5R.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-BbjDz5HF.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-DJ6vzAk_.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-D52Qj9Us.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-BQWl8f50.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CIYT9xfZ.js";
import { a as resolveCliRuntimeExecutionProvider, t as isCliRuntimeAlias } from "./model-runtime-aliases-DJJTxJ7G.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-B5LCdh_k.js";
import { c as stripHeartbeatToken } from "./heartbeat-8C3o9t4Y.js";
import { o as isAudioFileName } from "./mime-B30DelN1.js";
import { d as isLikelyExecutionAckPrompt } from "./selection-B5pSCvVw.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-C0xP7nOa.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-CTS7hNie.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-DQQcNK65.js";
import "./pi-embedded-helpers-DZV7D3OJ.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-QHA9Eabs.js";
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-DE5sgXDk.js";
import { d as parseReplyDirectives } from "./deliver-BKaUMp20.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-B61Gbdzt.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-CYKaQ95i.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-CGoq01ar.js";
import { i as estimateMessagesTokens } from "./compaction-ChQeUvAE.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-Cko-TbTj.js";
import { c as emitContinuationWorkSpan, i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-qLnr7Ksn.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-DwM6IijA.js";
import { a as enqueueSystemEvent } from "./system-events-DLvm6-8V.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-BdQs4YDx.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-DwFsV-oP.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DChcmm7c.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-Bl7aw3XL.js";
import { n as hasCotFramePrefix } from "./normalize-reply-BlhvC6sE.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BBMVaujs.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-BR4Rgmvw.js";
import "./sandbox-DVbI4dTa.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-Cg2-I9tI.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-BslwMcCY.js";
import { r as enqueueCommitmentExtraction } from "./runtime-Tz79-ve2.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-CqlP1ZKS.js";
import { t as checkContextPressure } from "./context-pressure-BOW-H0L9.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-CK_NHWQA.js";
import { t as formatProviderModelRef } from "./model-runtime-BwrQd-S7.js";
import { t as runCliAgent } from "./cli-runner-BE0qR8sg.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BQkJpEy_.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-BNTYNHXq.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-0wLhlJId.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BHpkIsGl.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-Bv8YUKvr.js";
import { n as incrementCompactionCount } from "./session-updates-BIcsrNz2.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-D_eMq_mW.js";
import { n as dispatchPostCompactionDelegates, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-BUF19YP2.js";
...
function extractContinuationSignal(params) {
	...
	if (payloads.length > 0) {
		...
		log.info(`[continuation:trace] payload-scan: count=${payloads.length} lastTextIdx=${lastTextPayload ? payloads.indexOf(lastTextPayload) : -1} ${payloadSummary} session=${sessionKey ?? "none"}`);
		if (lastTextPayload?.text) {
			...
			if (result.signal) {
				...
				log.info(`[continuation:trace] bracket-parse: kind=${result.signal.kind} delayMs=${result.signal.delayMs ?? "default"} session=${sessionKey ?? "none"}`);
			}
		}
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-C7yblbxt.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-D1sV9gfH.js"));
...
async function buildReplyPayloads(params) {
	...
	return {
		replyPayloads: messagingToolPayloadDedupe.suppressReplies ? [] : filteredPayloads.filter(isRenderablePayload),
		didLogHeartbeatStrip
	};
}
//#endregion
...
function resolveFollowupDeliveryPayloads(params) {
	...
	const dedupedPayloads = messagingToolPayloadDedupe.shouldDedupePayloads ? filterMessagingToolDuplicates({
		payloads: mediaFilteredPayloads,
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-BWAPpxlO.js"),
					import("./config-uakUiYmG.js"),
					import("./state-DVoSYUZM.js"),
					import("./store-CBmd1vNY.js")
				]);
...
async function runReplyAgent(params) {
	...
	if (activeRunQueueAction === "enqueue-followup") {
		...
		if (!queuedBehindActiveRun) finalizeWithFollowup(void 0, queueKey, queuedRunFollowupTurn);
		await touchActiveSessionEntry();
	...
	try {
		...
		if (effectiveContinuationSignal && sessionKey) {
			const { maxChainLength, defaultDelayMs, minDelayMs, maxDelayMs, costCapTokens } = resolveLiveContinuationRuntimeConfig(cfg);
			{
		...
		if (continuationFeatureEnabled && sessionKey) {
			...
			if (toolDelegates.length > 0) {
				const { maxChainLength, minDelayMs, maxDelayMs, costCapTokens, maxDelegatesPerTurn } = resolveLiveContinuationRuntimeConfig(cfg);
