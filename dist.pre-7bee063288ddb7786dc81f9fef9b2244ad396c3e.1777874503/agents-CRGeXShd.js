...
import { g as shortenHomePath, p as resolveUserPath } from "./utils-CCskKJVV.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-Dv8n03pi.js";
import "./account-id-DUpVOe8L.js";
import { c as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-BSgfYlBK.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir, g as listAgentEntries, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { r as replaceConfigFile } from "./mutate-BCZFK4XP.js";
import "./config-CshcuIUd.js";
import { n as isChannelVisibleInConfiguredLists } from "./channel-meta-CmN4S1G0.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-C_DWi525.js";
import "./message-channel-CxR7kyT3.js";
...
import { t as purgeAgentSessionStoreEntries } from "./sessions-DCQidobb.js";
import { i as listRouteBindings, t as isRouteBinding } from "./bindings-CJZklmri.js";
import { i as callGateway, l as isGatewayTransportError } from "./call-BolF1jqz.js";
import "./workspace-BJnGgOZY.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-CwnV1R3v.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-DrODJMht.js";
import { t as createClackPrompter } from "./clack-prompter-CO31wAJL.js";
import { n as logConfigUpdated } from "./logging-C9iUgLGX.js";
import { i as parseIdentityMarkdown, t as identityHasValues } from "./identity-file-CkNz24Kp.js";
import { s as moveToTrash } from "./onboard-helpers-Ck04u63K.js";
import { a as describeBinding } from "./agents.bindings-u5hH1U65.js";
import { i as requireValidConfigFileSnapshot, n as createQuietRuntime, r as requireValidConfig } from "./agents.commands.add-C2rklB-p.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, n as buildAgentSummaries, r as findAgentEntryIndex } from "./agents.config-DJ0PrN48.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-0PULb_a4.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/commands/agents.commands.bind.ts
const agentBindingsModuleLoader = createLazyImportLoader(() => import("./agents.bindings-WCKsjd-K.js"));
