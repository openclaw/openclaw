...
import { c as isRecord$1 } from "./utils-CCskKJVV.js";
...
import { u as isPrivateIpAddress } from "./ssrf-BUVRrita.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-DGCN0k7_.js";
import "./ssrf-runtime-B3HHI4NS.js";
import { t as getMSTeamsRuntime } from "./runtime-api-NQeCe8KZ.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-7XoCkIxV.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-CqhXLz1C.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-C3LwI2To.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-Zfr0x2yA.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-sicF2GRb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
