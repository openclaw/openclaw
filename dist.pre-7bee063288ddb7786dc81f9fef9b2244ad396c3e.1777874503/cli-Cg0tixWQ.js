import { d as createGoogleMeetSpace, f as endGoogleMeetActiveConference, g as fetchLatestGoogleMeetConferenceRecord, h as fetchGoogleMeetSpace, m as fetchGoogleMeetAttendance, p as fetchGoogleMeetArtifacts, u as buildGoogleMeetPreflightReport } from "./chrome-create-BVAgEjBf.js";
import { n as findGoogleMeetCalendarEvent, r as listGoogleMeetCalendarEvents, t as buildGoogleMeetCalendarDayWindow } from "./calendar-DzPfC2zp.js";
import { i as exchangeGoogleMeetAuthCode, n as createGoogleMeetOAuthState, o as resolveGoogleMeetAccessToken, r as createGoogleMeetPkce, s as waitForGoogleMeetAuthCode, t as buildGoogleMeetAuthUrl } from "./oauth-ce5RZ5r8.js";
import { i as resolveCreateSpaceConfig, r as hasCreateSpaceConfigInput } from "./create-BaBilg0J.js";
...
function registerGoogleMeetCli(params) {
	...
	root.command("test-listen").argument("[url]", "Explicit https://meet.google.com/... URL").option("--transport <transport>", "Transport: chrome or chrome-node").option("--timeout-ms <ms>", "How long to wait for fresh captions/transcript movement").action(async (url, options) => {
		writeStdoutJson(await (await params.ensureRuntime()).testListen({
			url: resolveMeetingInput(params.config, url),
			transport: options.transport,
