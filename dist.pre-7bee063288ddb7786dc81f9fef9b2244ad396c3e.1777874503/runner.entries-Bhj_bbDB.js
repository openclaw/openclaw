...
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-DXniHT5I.js";
import { t as resolveSystemBin } from "./resolve-system-bin-iYKCWT52.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-29rR3zs_.js";
import { t as describeImageWithModel } from "./image-runtime-8EFxT11h.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-Caok1Amj.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-DBjBVTd7.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CKDKKbdo.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-8czBZDT4.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-dmX7JpJz.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
