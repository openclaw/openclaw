...
import { a as isSubagentSessionKey, o as parseAgentSessionKey } from "./session-key-utils-C1mGpjUn.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-BSgfYlBK.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-CbabgXwH.js";
import { i as getRuntimeConfig } from "./io-BD1XQ5lD.js";
import "./config-CshcuIUd.js";
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-CXN8AYgX.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-m4JU31o8.js";
import { t as getActivePluginChannelRegistry } from "./runtime-Cqk_-fBI.js";
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-CDC1ZOcb.js";
import { u as resolveStorePath } from "./paths-Dl79wsM6.js";
import { t as loadSessionStore } from "./store-load-BJuxv-vp.js";
import { t as getChannelPlugin } from "./registry-Cl8KmGKt.js";
import { o as updateSessionStore, p as resolveSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-IyLBOjUO.js";
import "./plugins-BznBxQ_f.js";
import { n as isNestedAgentLane } from "./lanes-BSOMY2VP.js";
import { c as getQueueSize, s as getCommandLaneSnapshots } from "./command-queue-CIYT9xfZ.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-B5LCdh_k.js";
import { a as isTaskDue, c as stripHeartbeatToken, i as isHeartbeatContentEffectivelyEmpty, o as parseHeartbeatTasks, s as resolveHeartbeatPrompt$1 } from "./heartbeat-8C3o9t4Y.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-ByYfwB1o.js";
import { r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-BJnGgOZY.js";
import { a as getHeartbeatToolNotificationText, s as resolveHeartbeatToolResponseFromReplyResult } from "./heartbeat-tool-response-DyvqMMGn.js";
...
import { a as isRetryableHeartbeatBusySkipReason, c as setHeartbeatWakeHandler, i as areHeartbeatsEnabled, n as HEARTBEAT_SKIP_LANES_BUSY, o as requestHeartbeat, r as HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT, t as HEARTBEAT_SKIP_CRON_IN_PROGRESS } from "./heartbeat-wake-DwM6IijA.js";
import { c as peekSystemEventEntries, f as resolveSystemEventDeliveryContext, t as consumeSelectedSystemEventEntries } from "./system-events-DLvm6-8V.js";
import { t as buildOutboundSessionContext } from "./session-context-1Swx5J4R.js";
import { n as resolveHeartbeatSenderContext, t as resolveHeartbeatDeliveryTarget } from "./targets-BxqeMD8k.js";
import { t as resolveEmbeddedSessionLane } from "./lanes-Bt8tGQpX.js";
import { n as resolveResponsePrefixTemplate } from "./response-prefix-template-D86LxqtV.js";
import { i as resolveUserTimezone } from "./date-time-DbR7ionQ.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-Ds5zok8P.js";
import { n as listDueCommitmentSessionKeys, o as markCommitmentsAttempted, r as listDueCommitmentsForSession, s as markCommitmentsStatus } from "./store-CqZ2ruAW.js";
import { a as isRelayableExecCompletionEvent, i as isExecCompletionEvent, n as buildExecEventPrompt, r as isCronSystemEvent, t as buildCronEventPrompt } from "./heartbeat-events-filter-CkvAYFdI.js";
import { n as hasActiveCronJobs } from "./active-jobs-j6vrovk-.js";
...
import { a as resolveIndicatorType, t as emitHeartbeatEvent } from "./heartbeat-events-Cmz-WfsA.js";
import { t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CFv8gP-M.js";
import { t as resolveCronSession } from "./session-Dur_2kmC.js";
...
const HEARTBEAT_RESPONSE_TOOL_PROMPT = "If the heartbeat_respond tool is available, call it to record the heartbeat outcome. Use notify=false for quiet/no-change outcomes. Use notify=true with notificationText for a concise user-visible alert.";
function appendHeartbeatResponseToolPrompt(prompt) {
	return prompt.includes("heartbeat_respond") ? prompt : `${prompt}\n\n${HEARTBEAT_RESPONSE_TOOL_PROMPT}`;
}
...
async function runHeartbeatOnce(opts) {
	...
	const ctx = {
		Body: appendCronStyleCurrentTimeLine(appendHeartbeatResponseToolPrompt(prompt), cfg, startedAt),
		From: sender,
		To: sender,
