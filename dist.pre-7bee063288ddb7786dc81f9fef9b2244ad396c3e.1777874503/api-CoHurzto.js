...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-DGCN0k7_.js";
import "./ssrf-runtime-B3HHI4NS.js";
import "./runtime-api-B9O-bPSh.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-BvX6yTDi.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-B737uFQ9.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
			return {
