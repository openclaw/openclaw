...
import { a as freezeDiagnosticTraceContext, i as formatDiagnosticTraceparent, r as createDiagnosticTraceContextFromActiveScope, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-Dm49rK_G.js";
...
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-C1mGpjUn.js";
import { c as normalizeAgentId } from "./session-key-BSgfYlBK.js";
import { g as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-CbabgXwH.js";
import { Q as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-BD1XQ5lD.js";
import "./defaults-CHyQiMS4.js";
import "./config-CshcuIUd.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-B9CFrUKq.js";
...
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BvdsXFIr.js";
import { t as resolveAgentRuntimePolicy } from "./agent-runtime-policy-GBXGObpb.js";
import { S as listRegisteredAgentHarnesses } from "./loader-COn7-q7R.js";
...
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-Cqk_-fBI.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DfaZN9JD.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-BsEaQIa3.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-C0bdSfhc.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-7ACeYwey.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-BFhiKrRj.js";
import { t as sanitizeForConsole } from "./console-sanitize-Ce85Vqsp.js";
import { u as resolveModelAuthMode } from "./model-auth-BiJ18q5C.js";
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-qXGu5GiY.js";
...
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-CtWi33Py.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-Bn9PFA_4.js";
import { t as parseInlineDirectives } from "./directive-tags-B1b9dtWF.js";
...
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-BbjDz5HF.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-C8BtNp8Y.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-D52Qj9Us.js";
import { t as isCliRuntimeAlias } from "./model-runtime-aliases-DJJTxJ7G.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-B5LCdh_k.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-BAe5CIY8.js";
import { C as isEmbeddedMode, S as stripProviderPrefix, x as isStrictAgenticSupportedProviderModel } from "./openclaw-tools--M5KsSAV.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-ByYfwB1o.js";
import { t as getMachineDisplayName } from "./machine-name-B7JzwQ3F.js";
import { m as MAX_IMAGE_BYTES } from "./mime-B30DelN1.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-D7TSvjAr.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CYK_EPWL.js";
import { i as getPluginToolMeta } from "./tools-DNWZXyec.js";
import { n as redactConfigObject } from "./redact-snapshot-DsJ9F4cL.js";
import { n as resolveCommitHash } from "./git-commit-CEiZe4L4.js";
import { t as resolveOsSummary } from "./os-summary-Bj3mtazg.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-BTX1JseC.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-DqzLVdVG.js";
import { n as toTrajectoryToolDefinitions, r as getQueuedFileWriter, t as createTrajectoryRuntimeRecorder } from "./runtime-BNLsgnfX.js";
...
import { t as isReasoningTagProvider } from "./provider-utils-DFNqnFoz.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-C0xP7nOa.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-BJnGgOZY.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-TTD4YyqW.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-D3su56DS.js";
import { a as resolveBootstrapMaxChars, o as resolveBootstrapPromptTruncationWarningMode, s as resolveBootstrapTotalMaxChars } from "./google-v9OQvG5C.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DQQcNK65.js";
import { a as isMessagingToolDuplicateNormalized, c as downgradeOpenAIFunctionCallReasoningPairs, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, o as normalizeTextForComparison, t as validateAnthropicTurns } from "./pi-embedded-helpers-DZV7D3OJ.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-T4CZt2y0.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-UHcDq1j4.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolHints } from "./channel-tools-BqeSuwSs.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-D9zaQ17v.js";
import { a as isTimeoutError } from "./failover-error-CIUKqp9x.js";
import { t as buildModelAliasLines } from "./model-alias-lines-BpJcfd8Y.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-oJ7z1--R.js";
import { g as sanitizeTransportPayloadText, p as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-CaGT_Kgg.js";
import { t as log$4 } from "./logger-88Co-Zqv.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-B7B15Yoh.js";
import { B as collectRuntimeChannelCapabilities, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getDmHistoryLimitFromSessionKey, F as resolveCompactionTimeoutMs, G as releaseWsSession, H as dropReasoningFromHistory, I as isCacheTtlEligibleProvider, K as buildStreamErrorAssistantMessage, L as readLastCacheTtlTimestamp, O as buildEmbeddedExtensionFactories, R as guardSessionManager, S as normalizeAssistantReplayContent, T as buildEmbeddedMessageActionDiscoveryInput, U as dropThinkingBlocks, V as assessLastAssistantMessage, W as isZeroUsageEmptyStopAssistantTurn, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as prewarmSessionFile, c as PI_RESERVED_TOOL_NAMES, d as toSessionToolAllowlist, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, l as collectAllowedToolNames, m as createSystemPromptOverride, o as mapThinkingLevel, p as buildEmbeddedSystemPrompt, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectRegisteredToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as repairSessionFileIfNeeded } from "./compaction-successor-transcript-QHA9Eabs.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-wmBDALmq.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-CtTgp22E.js";
import { t as registerProviderStreamForModel } from "./provider-stream-AKptRcqO.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-CNFpbXz7.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-zzBMxCEv.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-CbzrOnOO.js";
...
import { C as isMessagingToolSendAction, S as isMessagingTool, _ as filterToolResultMediaUrls, b as sanitizeToolArgs, d as runAgentCleanupStep, f as formatToolAggregate, g as extractToolResultText, h as extractToolResultMediaArtifact, l as logAgentRuntimeToolDiagnostics, m as extractToolErrorMessage, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractMessagingToolSend, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as normalizeAgentRuntimeTools, v as isToolResultError, x as sanitizeToolResult, y as isToolResultTimedOut } from "./attempt.tool-run-context-CVzlEQ-t.js";
import { r as parseFenceSpans } from "./fences-BboFqPwp.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-6uOv-CLx.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DE5sgXDk.js";
...
import { n as hasCommittedMessagingToolDeliveryEvidence, r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-CKM-xDZw.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-CYKaQ95i.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-69I7ME1C.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-ChQeUvAE.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CIW7g7Q-.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-gNxs2KNW.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-DgGiJQew.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-CE1Fz9Ob.js";
...
import { t as detectRuntimeShell } from "./shell-utils-B8UH3_Vs.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-SHaEuF5y.js";
import { s as resolveSkillsPromptForRun } from "./workspace-CrNr2ieh.js";
import "./skills-BHYsqYYy.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-CLFayofE.js";
...
import "./tool-loop-detection-DZvfwurA.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-ztOoLFa2.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CU1CtxPn.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-BJnulgM0.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-2Ee-HoTk.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-BaKHDFk7.js";
import { t as parseGeminiAuth } from "./gemini-auth-C1XHeAjb.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-B6Z2VMlB.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-Dx7uFmwG.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-BkeEMl5W.js";
...
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as shouldUseOpenAIWebSocketTransportForAttempt, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DcLfmEcH.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-C37NTcCw.js";
import { t as detectAndLoadPromptImages } from "./images-4rWJt7-s.js";
import { i as resolveRuntimeContextPromptParts, r as queueRuntimeContextForNextTurn, t as buildRuntimeContextSystemContext } from "./runtime-context-prompt-BvtkbrTm.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-BJPJZF7E.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-D6uWYccv.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-DfPHqYcF.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-DAexf3j_.js"));
...
function shouldBuildCoreCodingToolsForAllowlist(toolsAllow) {
	if (!toolsAllow || toolsAllow.length === 0) return true;
	return toolsAllow.some((toolName) => {
		const normalized = normalizeToolName(toolName);
		return normalized === "*" || normalized.startsWith("group:") || normalized === "bundle-mcp" || normalized.includes("__") || CORE_CODING_TOOL_ALLOWLIST_NAMES.has(normalized);
	});
}
			...
			try {
				...
				try {
					...
					if (!skipPromptSubmission) {
						...
						if (promptSubmission.runtimeOnly) await abortable$1(activeSession.prompt(promptSubmission.prompt));
						else {
							...
							try {
								...
								if (imageResult.images.length > 0) await abortable$1(activeSession.prompt(promptSubmission.prompt, { images: imageResult.images }));
								else await abortable$1(activeSession.prompt(promptSubmission.prompt));
							} finally {
