...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-CK_jhe-n.js");
	const { buildPluginSnapshotReport } = await import("./status-BxGWe29U.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-BqXNI2wP.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-5ZyIHkeD.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-BYt-dvQe.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-m0g3B5t0.js");
	const { promptYesNo } = await import("./prompt-C81hVDvl.js");
