import { S as resolveDefaultAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "../../agent-scope-CbabgXwH.js";
import { t as definePluginEntry } from "../../plugin-entry-BzwFWtB2.js";
import { n as resolveLivePluginConfigObject } from "../../plugin-config-runtime-27YfIt4P.js";
import "../../agent-runtime-_7ygFxxf.js";
import { n as MIGRATION_REASON_TARGET_EXISTS, o as createMigrationItem, s as createMigrationManualItem, v as summarizeMigrationItems } from "../../migration-qy8Kh27n.js";
import { i as writeMigrationReport, n as copyMigrationFileItem, t as archiveMigrationItem } from "../../migration-runtime-BfwI9hNh.js";
import { t as createCodexAppServerAgentHarness } from "../../harness-BxCRuqZn.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-kTNZlmfl.js";
import { t as buildCodexProvider } from "../../provider-DhvWoBZM.js";
import { n as handleCodexConversationInboundClaim, t as handleCodexConversationBindingResolved } from "../../conversation-binding-DMLK5UNM.js";
...
async function handleCodexCommand(ctx, options = {}) {
	const { handleCodexSubcommand } = await import("../../command-handlers-BGyzxGv6.js");
