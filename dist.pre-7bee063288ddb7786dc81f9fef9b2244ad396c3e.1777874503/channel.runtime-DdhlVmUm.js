...
import "./accounts-DJH91qwL.js";
import "./runtime-api-VMNP5Mj0.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-F6sT2_Uo.js";
import { t as sendMessageZalo } from "./send-bu13neKi.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BSGuKDVP.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BU6smqqB.js");
