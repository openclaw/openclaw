...
import { i as getChildLogger, y as normalizeLogLevel } from "../../logger-CM9YQbLE.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-nSM7t2rD.js";
...
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-C1JUDoHW.js";
import { m as resolveThinkingDefault } from "../../model-selection-DDEg6aT2.js";
import { o as generateMusic, s as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-DtSB3FwZ.js";
import { _ as mediaKindFromMime, n as detectMime } from "../../mime-DJoNKEsJ.js";
import { l as ensureAgentWorkspace } from "../../workspace-CR1JECjq.js";
import { a as getImageMetadata, l as resizeToJpeg } from "../../image-ops-C9x5bMdH.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "../../lazy-runtime-CHce9E5z.js";
...
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-C21f5b4O.js";
import { n as resolveAgentIdentity } from "../../identity-Kb0CusYZ.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-D-sLbZP8.js";
...
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-B1TdP8HP.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-COMansKo.js";
import { i as setGatewaySubagentRuntime, n as gatewaySubagentState, r as setGatewayNodesRuntime, t as clearGatewaySubagentRuntime } from "../../gateway-bindings-DUXNupHh.js";
import { t as createRuntimeChannel } from "../../runtime-channel-Dw7BLI2o.js";
import { r as isVoiceCompatibleAudio } from "../../audio-p-Y34Cau.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-GMgUCc95.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-BKdlYijJ.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-CXUz8Hv9.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-D92RAGCm.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-DEiN2Tdt.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-BBRnIErL.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-DXGt-OS0.js"), (m) => m.createRuntimeLlm({
