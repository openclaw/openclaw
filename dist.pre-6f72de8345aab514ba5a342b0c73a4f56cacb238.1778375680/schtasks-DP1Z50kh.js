...
import { f as resolveGatewayServiceDescription, m as resolveGatewayWindowsTaskName, t as resolveGatewayStateDir } from "./paths-DGSVeClm.js";
...
import { a as renderCmdSetAssignment, i as parseCmdSetAssignment, n as quoteCmdScriptArg, r as assertNoCmdLineBreak, t as parseCmdScriptCommandLine } from "./cmd-argv-Cgglo4zD.js";
import { a as readWindowsProcessArgsSync, i as readWindowsListeningPidsOnPortSync, n as findGatewayPidsOnPortSync } from "./restart-stale-pids--oGRx5iD.js";
import { i as writeFormattedLines, n as formatLine, t as parseKeyValueOutput } from "./runtime-parse-C7pQbIJ0.js";
import { a as inspectPortUsage } from "./ports-Du8hP9h1.js";
import { t as killProcessTree } from "./kill-tree-C5IZovkL.js";
import { t as execSchtasks } from "./schtasks-exec-CZf7SX8a.js";
...
function shouldFallbackToStartupEntry(params) {
	return /(?:access is denied|acceso denegado)/i.test(params.detail) || params.code === 124 || /schtasks timed out/i.test(params.detail) || /schtasks produced no output/i.test(params.detail);
}
