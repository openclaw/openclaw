...
import { n as hasEnvHttpProxyAgentConfigured, o as resolveEnvHttpProxyAgentOptions } from "./proxy-env-FHNVNjKG.js";
import { o as createPinnedLookup } from "./ssrf-DX8ajhwl.js";
import { n as getProxyUrlFromFetch, r as makeProxyFetch } from "./proxy-fetch-BGacK047.js";
import { i as resolveEffectiveDebugProxyUrl } from "./env-X2FyXEpA.js";
import "./text-runtime-BFTVdjnu.js";
import "./error-runtime-COMansKo.js";
import "./runtime-env-DrpEm7Eb.js";
import { t as captureHttpExchange } from "./runtime-zmbVT-dC.js";
import "./proxy-capture-KLaZWJjx.js";
import { t as resolveFetch } from "./fetch-DPx22LJD.js";
import "./fetch-runtime-BjeJav67.js";
import { t as resolveRequestUrl } from "./request-url-CLy1knrJ.js";
...
function resolveTelegramTransport(proxyFetch, options) {
	...
	const resolvedFetch = (async (input, init) => {
		...
		try {
			...
			if (!callerProvidedDispatcher) recordSuccessfulAttempt(startIndex);
			return response;
		} catch (caught) {
			err = caught;
		}
