...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-BUbm4C3v.js";
import { i as replaceFileAtomicSync } from "./replace-file-BFpDvZ2t.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-BYkpLqJF.js";
...
import { S as findModelInCatalog, r as buildConfiguredModelCatalog } from "./model-selection-shared-C1JUDoHW.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent } from "./model-selection-DDEg6aT2.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-v3JwumhN.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-CWcd3ars.js";
import { f as findCodeRegions, p as isInsideCode, u as stripReasoningTagsFromText } from "./assistant-visible-text-Dn8SLG3L.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-DlkxJ-h2.js";
import { c as projectOutboundPayloadPlanForDelivery, i as createOutboundPayloadPlan } from "./deliver-CpEWupIe.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-PV7DwoHV.js";
import { n as MediaFetchError } from "./fetch-Bs6Mlqzj.js";
...
import { n as createPreviewMessageReceipt } from "./live-DpiAeN-V.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-5BPKTW8P.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-uCNcIVb3.js";
...
import { n as listChatCommands } from "./commands-registry-list-BHS2ZnAu.js";
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-CMB1FU7-.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-CkLGAYkA.js";
...
import { a as getPluginCommandSpecs } from "./commands-BN7g4cxU.js";
...
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-QdPPZYm0.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-PjkImS4N.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-27Z-Dt8E.js";
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-CX-zXSue.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-CLEG1a6O.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-DcKz5Pk9.js";
...
import { n as buildCommandsMessagePaginated } from "./command-status-builders-BdAz_RS-.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-B4xGOloe.js";
import "./command-auth-native-Bg3cqGmk.js";
import "./command-primitives-runtime-O11R6Ets.js";
import "./command-status-CirclOLi.js";
import "./command-detection-DDZgc10W.js";
import "./command-surface-CN4v4P75.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Rn80nuJt.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-DKlTzRsv.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-DhPWe8TR.js";
...
import "./models-provider-runtime-C6S4wJsI.js";
import "./skill-commands-runtime-cpKNvF-B.js";
import "./native-command-config-runtime-CRDuFU7n.js";
import { t as mergeTelegramAccountConfig } from "./account-config-CcgoJxnm.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-zE3oY3C7.js";
import { A as resolveTelegramReplyId, B as hasBotMention, C as isTelegramCommandsAllowFromConfigured, D as resolveTelegramForumFlag, E as resolveTelegramDirectPeerId, F as buildSenderLabel, G as expandTelegramAllowFromWithAccessGroups, H as normalizeForwardedContext, I as buildSenderName, J as normalizeAllowFrom, K as resolveTelegramDmAllow, L as expandTextLinks, M as resolveTelegramThreadSpec, N as shouldUseTelegramDmThreadSession, O as resolveTelegramForumThreadId, P as withResolvedTelegramForumFlag, R as extractTelegramLocation, S as extractTelegramForumFlag, T as resolveTelegramCommandAuthorization, W as resolveTelegramPrimaryMedia, X as resolveSenderAllowMatch, Y as normalizeDmAllowFromWithStore, Z as resolveTelegramEffectiveDmPolicy, _ as buildTelegramParentPeer, b as buildTypingThreadParams, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as resolveTelegramStreamMode, k as resolveTelegramGroupAllowFromContext, m as buildGroupLabel, p as tagTelegramNetworkError, q as isSenderAllowed, t as markdownToTelegramChunks, v as buildTelegramRoutingTarget, x as describeReplyTarget, y as buildTelegramThreadParams, z as getTelegramTextParts } from "./format-CypbuXXj.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-DswEB_5G.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DPNY10F3.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-CWv9DIop.js";
import { n as resolveTelegramRequestTimeoutMs } from "./request-timeouts-aTzPysu0.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-C3HZffQ2.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CoeFhf6f.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-BI9AX4Pc.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-BOKpL1Mg.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-BVsDa2XH.js";
import { C as withTelegramApiErrorLogging, D as sequentialize, E as apiThrottler, T as Bot, a as editMessageTelegram, g as recordSentMessage, w as getOrCreateAccountThrottler, x as buildInlineKeyboard } from "./send-DvMIsaj7.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-D9-oIOhs.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-B0ceyzfH.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-CWHEv7Hc.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-B35roddy.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-CO4iwTAP.js")).defaultTelegramBotDeps;
