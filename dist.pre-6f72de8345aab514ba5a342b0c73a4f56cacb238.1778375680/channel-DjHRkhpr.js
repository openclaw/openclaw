...
import { l as createScopedDmSecurityResolver, u as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-5BPKTW8P.js";
...
import { n as resolveInboundDirectDmAccessWithRuntime, t as createPreCryptoDirectDmAuthorizer } from "./direct-dm-access-GilngvVW.js";
...
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-CVbE9G6s.js";
...
import { t as attachChannelToResult } from "./channel-send-result-8uSDvxtD.js";
import { t as zod_exports } from "./zod-1JZvvpdI.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-BOji4Pqn.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-ulgE0Em0.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-FJ3pY-B2.js");
