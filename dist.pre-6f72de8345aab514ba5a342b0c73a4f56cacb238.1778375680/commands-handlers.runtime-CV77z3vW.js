...
import { p as resolveUserPath, r as clampInt } from "./utils-DG9b7Tlg.js";
...
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-oCQyQKow.js";
import { r as logVerbose } from "./globals-f3TwV797.js";
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-CwtTPcP9.js";
...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-nSM7t2rD.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-CQKyM8eC.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-gUnOSvFw.js";
...
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-BmDYKLEJ.js";
...
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-gMR-i9iN.js";
import { i as callGateway } from "./call-Bl6UQZwm.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-CG8-Z6pO.js";
...
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-1BESwUFb.js";
import { o as resolveFreshSessionTotalTokens } from "./types-ePnHAw38.js";
import { s as updateSessionStore } from "./store-bHMyvLAj.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-BcHLKTqQ.js";
import { a as extractDeliveryInfo } from "./sessions-BPwe-yj6.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-BSKX2IyB.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-DySP-8MF.js";
...
import "./diagnostic-Cw0ETe6T.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-BGgDVtlL.js";
import { a as getActiveEmbeddedRunSnapshot, d as resolveActiveEmbeddedRunSessionId, l as queueEmbeddedPiMessage, o as isEmbeddedPiRunActive } from "./runs-CwUHcnNz.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-DnqCuEOY.js";
...
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-CoU-jKhC.js";
import { g as resolveBootstrapTotalMaxChars, m as resolveBootstrapMaxChars } from "./pi-embedded-helpers-7dqn4kwt.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-CCpLY7if.js";
...
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-5BPKTW8P.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-BjHLOEyU.js";
import { n as routeReply } from "./route-reply-DWBsu3s7.js";
...
import { a as stripToolResultDetails } from "./session-transcript-repair-Cco41NVt.js";
import "./sandbox-Co0p1aM4.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DqevjQSw.js";
import { n as estimateTokensFromChars } from "./cjk-chars-DdWbkUIJ.js";
import { r as resolveModelWithRegistry } from "./model-tl8JaE5V.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-D6k3qg30.js";
import { v as getFinishedSession, y as getSession } from "./bash-tools.exec-runtime-BScX4XYb.js";
...
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-CMB1FU7-.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-T_bOzf4S.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-DJHIOiD3.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-DVVsILXX.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-DJ1AnVYF.js";
import { n as parseActivationCommand } from "./group-activation-l8jd0FwT.js";
...
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-C9SDVdx7.js";
import { t as extractBtwQuestion } from "./btw-command-IVkzwSFN.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-A20Ym1Iw.js";
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-B3TjOJqA.js";
import { t as handleAcpCommand } from "./commands-acp-B8C5QgVj.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BdAz_RS-.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CYCnLxdc.js";
import { r as handleModelsCommand } from "./commands-models-B4xGOloe.js";
import { r as createExecTool } from "./bash-tools-D7AZaELu.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-DKto_-N9.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared--iTlKQXY.js";
import { t as buildToolsMessage } from "./status-aMuxQ5q7.js";
...
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-BgVmQVy1.js";
import "./command-export-s8r-TI9t.js";
import { t as buildStatusReply } from "./commands-status-BGTI96il.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-CuAIRiVU.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-D95PCOE-.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-BqQqr6M2.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-DtsOcEHL.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-CJtfOP4h.js";
...
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-CFxq2P_X.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-DzbrSxmi.js");
		killProcessTree(pid);
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-FgKtmulV.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-C7VBUmxD.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-D9tU257l.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BuWKDdZt.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-CR5cxNIO.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CTPbEGlh.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-Ch96l2Hw.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-Cbe_Trw3.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-BqY7hvXp.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-CQvwa4E4.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-DwWlVxyL.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-BFfjaeuq.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-DMZFAyHT.js"));
