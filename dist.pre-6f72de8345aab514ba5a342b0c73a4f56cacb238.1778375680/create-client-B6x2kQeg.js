...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-yF2vt-5f.js";
import "./config-B0wodwZs.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-CrVZgJl4.js"), import("./logging-BhXo5WMR.js")]).then(([sdkModule, loggingModule]) => ({
