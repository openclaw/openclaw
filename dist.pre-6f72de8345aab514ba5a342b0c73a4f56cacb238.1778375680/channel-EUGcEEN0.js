...
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-DcFfSOGR.js";
...
import { c as normalizeInteractiveReply, l as normalizeMessagePresentation } from "./payload-DOgNoIp1.js";
...
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-BOt3I9VS.js";
import "./text-runtime-BFTVdjnu.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-DrKqe3wh.js";
...
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-DYsvC_52.js";
...
import { i as createAttachedChannelResultAdapter } from "./channel-send-result-8uSDvxtD.js";
import "./param-readers-DzJeDFNl.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-BJQT9DRV.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-B-1xYI2U.js";
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-B33ngceR.js";
...
import { n as resolveSlackThreadTsValue, r as SLACK_TEXT_LIMIT, t as normalizeSlackThreadTsCandidate } from "./thread-ts-BaU9GQlb.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-DWeE9U6v.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-DbraFFK5.js";
import "./channel-api-CKLP86QV.js";
import { r as createSlackWebClient } from "./client-DXij4IMO.js";
import { r as normalizeAllowListLower } from "./allow-list-DjrsdvB2.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-COrmM4us.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-Bq1_Ggbl.js";
import { t as getOptionalSlackRuntime } from "./runtime-Dg6NVkuA.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-C_002ExC.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-CSazIcCG.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-BY49p8Tf.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-DCDaHgvh.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-DBEjj9Pl.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-DA0hAISI.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CdScJff3.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CqGz5n4k.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-D9MyrF9l.js"));
...
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-DEkgkh2Z.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-DI5-8xWI.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-BfbSBKzr.js");
