...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-DYAh0rlj.js";
...
import { i as setPathExistingStrict } from "./path-utils-Dp9T3R6c.js";
import { n as discoverConfigSecretTargets } from "./target-registry-m41ZJCkp.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CwtTPcP9.js";
import { n as formatConfigIssueLines } from "./issue-format-b_3rMHT2.js";
import { r as normalizeTalkSection } from "./talk-B91-SQ6F.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-ChC_fXDk.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BWMFGhtO.js";
import { n as getLoadedChannelPlugin } from "./registry-1BESwUFb.js";
import { i as listRouteBindings } from "./bindings-Cce-K5TC.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-DkJNdXVU.js";
import { r as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-zm4cDos8.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-D8fnwbKE.js";
import { t as note } from "./note-DEtapHvS.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-HLv8B93x.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-BSqDBCzW.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DQodxOzv.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CdbBS-Cp.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-56REZQZs.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-JLU5EoM1.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-B9hi_SnW.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-ChV0QcNM.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DclvMY-2.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BQhbIZgv.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CGopyauX.js");
		emitDoctorNotes({
			note,
