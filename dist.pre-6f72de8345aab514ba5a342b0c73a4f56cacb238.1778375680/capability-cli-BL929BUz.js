...
import { i as callGateway, u as randomIdempotencyKey } from "./call-Bl6UQZwm.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-BjI2Wn-k.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-DvVbAhwV.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-DDEg6aT2.js";
...
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DJoNKEsJ.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-C9x5bMdH.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-B8mmqxoR.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-BOcgQUR-.js";
import "./tts-Bh6RvJAC.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BpNUitH8.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-B1TdP8HP.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CX7nvIbV.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DpwW70VQ.js";
...
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-zK_sOGnh.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-AZmlT3v8.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-B2qfTciT.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-CsM1JIfg.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-DWpShyPm.js");
