...
import { a as freezeDiagnosticTraceContext, i as formatDiagnosticTraceparent, r as createDiagnosticTraceContextFromActiveScope, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-CQzT11Bo.js";
...
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-DHMLl9Cy.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-Ce-6uXgd.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-Cms5CQuT.js";
import { a as listRegisteredAgentHarnesses } from "./registry-BLIWoOwU.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-DR1uyAKa.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BbkdpoaV.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-DSK2FvQP.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-D8Z3uNXS.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-RrB1ssQj.js";
import { u as resolveStorePath } from "./paths-BYkpLqJF.js";
import { t as loadSessionStore } from "./store-load-CR507N_-.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-bHMyvLAj.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-3n84QygN.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-C2N9p6Hh.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-DJi8y86s.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-DySP-8MF.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-DDEg6aT2.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-Cd74aonC.js";
...
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-CwUHcnNz.js";
...
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-DyzQRWMZ.js";
import { t as parseInlineDirectives } from "./directive-tags-BUUa0lFe.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-DcCVbFSf.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-qQaS3sFD.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-D7FuUKMD.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DEFOebxP.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-Dn8SLG3L.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-BW0ThgJt.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-COyt8a6E.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-Z55l1Kbe.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-DpDw32q2.js";
import { D as isEmbeddedMode, E as stripProviderPrefix, T as isStrictAgenticSupportedProviderModel, f as resolveToolLoopDetectionConfig } from "./openclaw-tools-DtSB3FwZ.js";
...
import { m as MAX_IMAGE_BYTES } from "./mime-DJoNKEsJ.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CwYty0gj.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-HkP3G2vG.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-BYTk5hqU.js";
...
import { i as resolveImageSanitizationLimits } from "./tool-images-CCpLY7if.js";
import { _ as resolveChannelReactionGuidance, h as resolveChannelMessageToolHints, m as listChannelSupportedActions } from "./pi-tools.before-tool-call-Jh3fDnry.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-Bwh1VWUB.js";
import { a as isTimeoutError } from "./failover-error-BI_Jr28u.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-BITZyoAR.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BUWs6TYd.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Cew5fxFi.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-DNUbII4u.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-Bkz4OW5p.js";
...
import { f as buildApiErrorObservationFields, p as buildTextObservationFields } from "./model-fallback-CzWXFhh5.js";
import { t as log$4 } from "./logger-I4coJdAX.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-ZmV9xOH_.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-C1eFj2H3.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-4R81grbI.js";
...
import { g as sanitizeTransportPayloadText, m as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-CnM1IfsB.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-Cco41NVt.js";
import { o as resolveSandboxContext } from "./sandbox-Co0p1aM4.js";
import { t as detectRuntimeShell } from "./shell-utils-D3hW22O8.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-CBiFNGLf.js";
...
import { t as buildSystemPromptParams } from "./system-prompt-params-BR0R-sAH.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DqevjQSw.js";
import { n as appendAgentBootstrapSystemPromptSupplement, r as appendModelIdentitySystemPrompt } from "./system-prompt-config-mprv4cZa.js";
import "./tool-loop-detection-Depgm0fn.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-DPCP2aNX.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DMsko41U.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance--ba_svYK.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-dOSiQaN4.js";
...
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-7172FF6K.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-Bd26EVV8.js";
import { a as buildAfterTurnRuntimeContext, c as mergeOrphanedTrailingUserPrompt, d as resolveAttemptPrependSystemContext, f as resolvePromptBuildHookResult, g as shouldWarnOnOrphanedUserRepair, h as shouldInjectHeartbeatPrompt, i as shouldPersistCompletedBootstrapTurn, l as prependSystemPromptAddition, m as resolvePromptSubmissionSkipReason, n as composeSystemPromptWithHookContext, o as buildAfterTurnRuntimeContextFromUsage, p as resolvePromptModeForSession, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded, u as resolveAttemptFsWorkspaceOnly } from "./attempt.thread-helpers-CGOp3bSs.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-D5oMtMfX.js";
import { t as detectAndLoadPromptImages } from "./images-Dw9iwNAW.js";
import { a as resolveRuntimeContextPromptParts, i as queueRuntimeContextForNextTurn, n as buildRuntimeContextSystemContext, t as buildCurrentTurnPromptContextPrefix } from "./runtime-context-prompt-DA4q6iYh.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-C7hIBnr2.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-Bnfrli5h.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-BMdjFfcz.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-BYfCpiUf.js"));
