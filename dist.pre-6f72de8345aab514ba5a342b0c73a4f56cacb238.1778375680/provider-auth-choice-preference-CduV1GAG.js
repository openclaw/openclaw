...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-0ClDyC5H.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-_5LZLZ5F.js");
