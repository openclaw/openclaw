...
import { c as isUsageCountedSessionTranscriptFileName, d as parseUsageCountedSessionIdFromFileName, i as isSessionArchiveArtifactName, n as isCompactionCheckpointTranscriptFileName } from "./artifacts-CgJJF7tR.js";
...
import { n as HEARTBEAT_PROMPT } from "./heartbeat-DHoQZWXb.js";
import { r as isHeartbeatUserMessage } from "./heartbeat-filter-DpDw32q2.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-hOI-tDtt.js";
import { n as normalizeOptionalLowercaseString, t as normalizeLowercaseStringOrEmpty } from "./string-utils-CDpbrr87.js";
import "./query-expansion-DM8rOcJm.js";
...
import { t as hashText } from "./hash-ikGxInJd.js";
...
async function buildSessionEntry(absPath, opts = {}) {
	try {
		...
		const lines = (await readRegularFile({ filePath: absPath })).buffer.toString("utf-8").split("\n");
		const collected = [];
		const lineMap = [];
