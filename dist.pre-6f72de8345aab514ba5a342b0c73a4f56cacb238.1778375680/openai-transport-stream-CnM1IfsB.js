...
import { c as shouldUseEnvHttpProxyForUrl } from "./proxy-env-FHNVNjKG.js";
import { L as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-DySP-8MF.js";
import { r as resolveProviderRequestCapabilities } from "./provider-attribution-Cd74aonC.js";
import { c as resolveProviderRequestPolicyConfig, i as mergeModelProviderRequestOverrides, n as buildProviderRequestDispatcherPolicy, r as getModelProviderRequestTransport } from "./provider-request-config-2kC5ocF6.js";
import { c as detectOpenAICompletionsCompat } from "./provider-model-compat-HkP3G2vG.js";
import { v as ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist } from "./ssrf-DX8ajhwl.js";
import { a as withTrustedEnvProxyGuardedFetchMode, n as fetchWithSsrFGuard } from "./fetch-guard-tUIZwb7g.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-arrUSHBh.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-mkNMPr2i.js";
import { n as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-CqHJnvVM.js";
import { r as resolveDebugProxySettings } from "./env-X2FyXEpA.js";
import { n as repairToolUseResultPairing } from "./session-transcript-repair-Cco41NVt.js";
...
function sanitizeOpenAISdkSseResponse(response) {
	...
	if (!response.ok || !response.body || !/\btext\/event-stream\b/i.test(contentType)) return response;
...
//#endregion
export { transformTransportMessages as _, applyOpenAIResponsesPayloadPolicy as a, flattenCompletionMessagesToStringContent as c, createWritableTransportEventStream as d, failTransportStream as f, sanitizeTransportPayloadText as g, sanitizeNonEmptyTransportPayloadText as h, createOpenAIResponsesTransportStreamFn as i, coerceTransportToolCallArguments as l, mergeTransportHeaders as m, createAzureOpenAIResponsesTransportStreamFn as n, resolveOpenAIResponsesPayloadPolicy as o, finalizeTransportStream as p, createOpenAICompletionsTransportStreamFn as r, resolveOpenAIReasoningEffortForModel as s, buildOpenAICompletionsParams as t, createEmptyTransportUsage as u, buildGuardedModelFetch as v };
