...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-DYAh0rlj.js";
...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-B0NGZjE7.js";
import "./ssrf-runtime-CNU9UpXf.js";
import "./retry-runtime-D5zo57Qu.js";
import "./secret-input-runtime-BtJifKlJ.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CzxkMVd9.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-3_bWhEKy.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DOOJK_tJ.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-DFD6MFcP.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DkroxpfC.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-D1kh_CCV.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-yF2vt-5f.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CrVZgJl4.js"), import("./logging-BhXo5WMR.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-kzZsx8UJ.js").then((credentialsReadModule) => ({
