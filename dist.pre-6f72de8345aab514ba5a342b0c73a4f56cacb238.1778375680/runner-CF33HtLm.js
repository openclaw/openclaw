...
import { n as isAbortError } from "./unhandled-rejections-DSEEnZZL.js";
import { p as FsSafeError } from "./path-n_dSWDuU.js";
import { C as safeFileURLToPath, y as assertNoWindowsNetworkPath } from "./fs-safe-Cwlcdma7.js";
import { r as openLocalFileSafely } from "./secure-temp-dir-JZ25IoOE.js";
import { n as findNormalizedProviderValue } from "./provider-id-C3dkeX_L.js";
import { i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-iH6kLgu0.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-f3TwV797.js";
import { a as logWarn } from "./logger-D3H65hS5.js";
import { i as runExec } from "./exec-CfBtiEiE.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CJySxcj-.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-DJoNKEsJ.js";
import "./local-file-access-BCy2Hv8O.js";
import { r as fetchWithTimeout } from "./fetch-timeout-Dqifo5D9.js";
import { n as MediaFetchError, r as fetchRemoteMedia } from "./fetch-Bs6Mlqzj.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-C6djeJJ3.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-D1N2BiS1.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-B8mmqxoR.js";
import { t as providerSupportsCapability } from "./provider-supports-Cb96g60B.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-DFVxhJxT.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-Dd8BFc9Y.js";
import { t as buildRandomTempFilePath } from "./temp-download-DvpIlWUo.js";
import "./temp-path-S9qiXDku.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-Bpy43n0s.js";
import "./shared-BlU-BtaA.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-Cp6qDI-9.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-B4DR7Spq.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-nYN2M6v1.js");
