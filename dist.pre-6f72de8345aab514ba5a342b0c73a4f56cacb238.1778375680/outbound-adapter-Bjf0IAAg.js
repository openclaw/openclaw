...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-PV7DwoHV.js";
...
import { p as DiscordError } from "./discord-DBmLXTjd.js";
import { t as chunkDiscordTextWithMode } from "./chunk-D1m2Qjc_.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-q1G-A7Au.js";
import { t as createDiscordSendReceipt } from "./send.receipt-hO323EzG.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-C7JxTZnF.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-CJ1Phbk4.js");
...
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-BpYmrVk0.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-AhtZTdn_.js");
