...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-H0lQ7wiG.js";
...
import { n as openUrl } from "./browser-open-BkErz9b7.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-C893Th2Z.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BA8oAJ6f.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-BEaFa_53.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-u1Bo9nNL.js";
import { t as isRemoteEnvironment } from "./remote-env-BNLCFNmh.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-B_WYsoCc.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-_5LZLZ5F.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BGI-ad-N.js");
