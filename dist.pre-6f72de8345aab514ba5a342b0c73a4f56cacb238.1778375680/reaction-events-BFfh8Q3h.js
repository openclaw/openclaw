...
import "./session-binding-runtime-BAUFQRvB.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DOOJK_tJ.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-O1sWYwgz.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-DwPrzlXe.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-XizOmATT.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-7LKTJAUG.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-D1pPALNG.js");
