...
import { u as readConfigFileSnapshot } from "./io-CwtTPcP9.js";
import "./config-OQqPmWUa.js";
import { n as extractAssistantText } from "./pi-embedded-utils-DlkxJ-h2.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CBxDly6R.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-CuAvbSXA.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-D48EhNqw.js")).runEmbeddedPiAgent;
}
