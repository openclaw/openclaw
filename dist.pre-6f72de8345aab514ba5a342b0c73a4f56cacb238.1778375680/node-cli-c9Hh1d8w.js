...
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DxnEJ6aN.js";
import { n as VERSION } from "./version-BHBlW4Qb.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-DSKI0Juc.js";
...
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-d_aEDdtP.js";
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-tH3VLd-2.js";
import { a as logWarn } from "./logger-D3H65hS5.js";
import { i as getRuntimeConfig } from "./io-CwtTPcP9.js";
import { b as resolveExecutableFromPathEnv, d as resolveApprovalAuditCandidatePath, p as resolveCommandResolutionFromArgv } from "./exec-safe-bin-trust-CuRiheeP.js";
import { E as splitShellArgs, T as normalizeExecutableToken, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, h as extractEnvAssignmentKeysFromDispatchWrappers, l as isShellWrapperInvocation, m as resolveInlineCommandMatch, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, y as unwrapKnownDispatchWrapperInvocation } from "./shell-wrapper-resolution-DtKDRL93.js";
import "./config-OQqPmWUa.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DtsQJxpa.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-C2vpH14O.js";
import { t as parsePort } from "./parse-port-eDEBLHoO.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-RtexEltP.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-CIfBvkcX.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DMWPcgHB.js";
import { a as getActivePluginRegistry } from "./runtime-DSK2FvQP.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-ycnRypMq.js";
import { t as getMachineDisplayName } from "./machine-name-BxjjpaxT.js";
import { c as describeInterpreterInlineEval } from "./risks-DrsS8F1j.js";
import { c as analyzeArgvCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-CHlp6deJ.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CoeCF_kN.js";
import { N as saveExecApprovals, O as resolveExecApprovals, P as requestJsonlSocket, T as requiresExecApproval, b as readExecApprovalsSnapshot, c as hasDurableExecApproval, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, o as addDurableCommandApproval, s as ensureExecApprovals, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-Bm2XxiDm.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BsDxPfGE.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DbAljm8f.js";
import { t as formatHelpExamples } from "./help-format-TQoTMqM-.js";
import { n as detectPolicyInlineEval } from "./policy-DM-2JOBG.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CpTZpRPV.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-Dr2-p98W.js";
import { t as resolveNodeService } from "./node-service-Ro9AT6rk.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-CCKWf8UM.js");
