...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-B0NGZjE7.js";
import "./ssrf-runtime-CNU9UpXf.js";
import "./security-runtime-UF5af59f.js";
import { t as getMSTeamsRuntime } from "./runtime-api-Dbf36ILb.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-Ci7tscxL.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-DSkQvtjT.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-UuPskXRx.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-B0tGzyvu.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-YZgMGbOB.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
