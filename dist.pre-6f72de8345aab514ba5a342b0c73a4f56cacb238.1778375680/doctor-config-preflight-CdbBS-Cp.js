import { f as resolveHomeDir } from "./utils-DG9b7Tlg.js";
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CwtTPcP9.js";
import { n as formatConfigIssueLines } from "./issue-format-b_3rMHT2.js";
import { t as note } from "./note-DEtapHvS.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-HLv8B93x.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-B00ZrwW2.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-bc8r8Gx4.js");
