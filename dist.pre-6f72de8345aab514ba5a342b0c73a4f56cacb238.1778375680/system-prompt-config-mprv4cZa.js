...
import { X as resolveOwnerDisplaySetting } from "./io-CwtTPcP9.js";
import { l as listDeliverableMessageChannels } from "./message-channel-gMR-i9iN.js";
import { n as buildMemoryPromptSection } from "./memory-state-D-0Uaz54.js";
import { n as normalizeStructuredPromptSection, t as normalizePromptCapabilityIds } from "./prompt-cache-stability-Btv7t7Iv.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-Z55l1Kbe.js";
import { i as isKnownNativeApprovalPromptChannel, r as hasNativeApprovalPromptRuntimeCapability } from "./native-approval-prompt-Dyyc1GFz.js";
import { t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-vkEfjDrI.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-BOcgQUR-.js";
import "./tts-Bh6RvJAC.js";
import { t as SYSTEM_PROMPT_CACHE_BOUNDARY } from "./system-prompt-cache-boundary-mkNMPr2i.js";
import { t as buildModelAliasLines } from "./model-alias-lines-2-6V-SZk.js";
...
function buildAgentSystemPrompt(params) {
	...
	lines.push("## Runtime", buildRuntimeLine(runtimeInfo, runtimeChannel, runtimeCapabilities, params.defaultThinkLevel), ...modelIdentityLine ? [modelIdentityLine] : [], `Reasoning: ${reasoningLevel} (hidden unless on/stream). Toggle /reasoning; /status shows Reasoning when enabled.`);
	return lines.filter(Boolean).join("\n");
}
