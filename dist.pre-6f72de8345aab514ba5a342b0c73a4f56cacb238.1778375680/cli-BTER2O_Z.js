...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-CyCHONFI.js";
import { n as matrixSetupAdapter } from "./setup-core-B_AQ8Dfm.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-DFQgqXO0.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-MuqeNuHg.js";
import { t as withResolvedActionClient } from "./client-BN92YhsZ.js";
import { r as resolveMatrixAuthContext } from "./config-B0wodwZs.js";
import "./client-CXyM8yyV.js";
import "./runtime-api-D12JmKKw.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-Bg_4k62P.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-BeLDwxzD.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-Qmgfk-6e.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-C_NT2FlX.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-LojARIXJ.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BQK-Fd5g.js");
