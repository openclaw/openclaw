...
import { r as extractFirstTextBlock } from "./chat-message-content-C2N9p6Hh.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-CM4_j3Ba.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-n3jJlJ79.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-DD3Tra9I.js"),
			import("./client-B8iNM0bc.js"),
			import("./client-start-readiness-BPhwT4h8.js"),
			import("./method-scopes-CNoaYgto.js"),
			import("./client-info-F8SDgStP.js")
		]);
