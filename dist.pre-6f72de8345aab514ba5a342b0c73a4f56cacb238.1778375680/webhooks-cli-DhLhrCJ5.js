...
import { a as displayPath } from "./utils-DG9b7Tlg.js";
import { n as defaultRuntime } from "./runtime-Vyd5gFd2.js";
import { t as getWindowsInstallRoots } from "./windows-install-roots-D1p5eesZ.js";
import { t as danger } from "./globals-f3TwV797.js";
import { r as runCommandWithTimeout } from "./exec-CfBtiEiE.js";
import { T as validateConfigObjectWithPlugins, i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CwtTPcP9.js";
import { y as resolveExecutable } from "./exec-safe-bin-trust-CuRiheeP.js";
import { r as replaceConfigFile } from "./mutate-CupOQt-W.js";
import "./config-OQqPmWUa.js";
import { C as normalizeServePath, S as normalizeHooksPath, T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeLogArgs, a as ensureTopic, b as generateHookToken, c as DEFAULT_GMAIL_LABEL, d as DEFAULT_GMAIL_SERVE_PATH, f as DEFAULT_GMAIL_SERVE_PORT, g as buildGogWatchServeArgs, h as buildDefaultHookUrl, i as ensureTailscaleEndpoint, l as DEFAULT_GMAIL_MAX_BYTES, m as DEFAULT_GMAIL_TOPIC, n as ensureGcloudAuth, o as resolveProjectIdFromGogCredentials, p as DEFAULT_GMAIL_SUBSCRIPTION, r as ensureSubscription, s as runGcloud, t as ensureDependency, u as DEFAULT_GMAIL_SERVE_BIND, v as buildGogWatchStartArgs, w as parseTopicPath, x as mergeHookPresets, y as buildTopicPath } from "./gmail-setup-utils-BSWZhZrz.js";
...
async function startGmailWatch(cfg, fatal = false) {
	const result = await runCommandWithTimeout([gogBin ??= resolveExecutable("gog"), ...buildGogWatchStartArgs(cfg)], { timeoutMs: 12e4 });
	if (result.code !== 0) {
