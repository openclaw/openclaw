...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-CzlH3uth.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-3AADoPJZ.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-Du5tZAFD.js";
import { l as toRatio, n as decodeString } from "./Util-DYwtGWkG.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DK-hGOAt.js";
import { t as APEv2Parser } from "./APEv2Parser-D3cLDJgq.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BYYLaIQI.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CDoMBvLa.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-C6G5VUI0.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-gr4xC2hO.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-COencLSS.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DrpWEwAb.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-tZmfHdXS.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DuYFkRk7.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Dsi2ow4q.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CyKOEOM6.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-C-EufgDp.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Bzbj-miw.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CmatUjAt.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-1wr4A2jt.js")).WaveParser;
	}
};
//#endregion
