...
import { n as MANIFEST_KEY } from "./legacy-names-CPal9NH7.js";
import { t as extensionUsesSkippedScannerPath } from "./scan-paths-ks0Xd9Da.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-sCmOwQq7.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-BmSvnEIx.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-kauqWmDg.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-BHTmsXqd.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-D7RHKtP6.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-DQpKUIk0.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-icasS_CG.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-v77xHZeV.js");
