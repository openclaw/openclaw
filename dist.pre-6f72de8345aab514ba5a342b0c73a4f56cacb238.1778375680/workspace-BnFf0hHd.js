...
import { i as resolveOsHomeDir } from "./home-dir-iZwpu-40.js";
import { i as isPathInside } from "./path-n_dSWDuU.js";
import { o as walkDirectorySync } from "./fs-safe-Cwlcdma7.js";
import { i as openRootFileSync } from "./root-file-Bp-CoMOV.js";
import { f as resolveHomeDir, p as resolveUserPath, t as CONFIG_DIR } from "./utils-DG9b7Tlg.js";
import "./path-guards-DzWLExYo.js";
import { n as normalizeSkillFilter } from "./filter-C6LM1yyQ.js";
import { n as resolveEffectiveAgentSkillsLimits, t as resolveEffectiveAgentSkillFilter } from "./agent-filter-TWzATt9R.js";
import "./boundary-file-read-Csu48sMY.js";
import { t as createSubsystemLogger } from "./subsystem--HE_VOOc.js";
import { a as resolveSandboxPath } from "./sandbox-paths-ClWhJgi3.js";
import { a as shouldIncludeSkill, c as resolveSkillInvocationPolicy, o as parseFrontmatter, s as resolveOpenClawMetadata } from "./config-D2H22rTk.js";
import { t as resolvePluginSkillDirs } from "./plugin-skills-Cl-dPOsP.js";
...
function resolveAllowedSymlinkTargetRealPaths(config) {
	return (config?.skills?.load?.allowSymlinkTargets ?? []).map((dir) => normalizeOptionalString(dir) ?? "").filter(Boolean).map((dir) => tryRealpath(resolveUserPath(dir))).filter((dir) => Boolean(dir)).filter((dir, index, all) => all.indexOf(dir) === index);
}
