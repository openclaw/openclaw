...
import { P as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-DSK2FvQP.js";
import { c as initSubagentRegistry } from "./subagent-registry-AQSdoZkb.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-s7XP3dOt.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-CJdn8YmW.js";
import { n as listGatewayMethods } from "./server-methods-list-CB_gqS95.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-DDFs9Lr_.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-COvcfP7p.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-DsNPZEGw.js");
