...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-DbEe1lcf.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-CH7urgMm.js";
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-DaqqkT7C.js";
import { i as READ_SCOPE } from "./operator-scopes-DUhzoOiq.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-Cy7pyKOr.js");
