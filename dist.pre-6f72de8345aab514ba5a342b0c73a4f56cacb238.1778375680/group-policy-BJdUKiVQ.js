...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-CEznNqfA.js";
import "./client-CwG_5W15.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-CgWDITns.js";
import { s as parseIMessageTarget } from "./targets-uxJ9TuGH.js";
import { t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-Dd8q7Vmy.js";
import "./probe-BULMZFy2.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-DVq2j4rI.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-CaSc6Xab.js");
