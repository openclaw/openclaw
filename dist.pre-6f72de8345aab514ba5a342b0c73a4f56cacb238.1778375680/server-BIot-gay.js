...
import { D as sanitizeUntrustedFileName } from "./fs-safe-Cwlcdma7.js";
import { o as root } from "./secure-temp-dir-JZ25IoOE.js";
import { g as shortenHomePath, p as resolveUserPath, s as ensureDir } from "./utils-DG9b7Tlg.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-CRWSycy9.js";
...
import { a as asRecord } from "./record-coerce-vG6M9XAt.js";
import { n as detectMime } from "./mime-DJoNKEsJ.js";
import { t as resolveNodeFromNodeList } from "./node-resolve-DPFa4scx.js";
...
import "./gateway-runtime-BaDbsCuZ.js";
import { n as callGatewayFromCli } from "./gateway-rpc-BkVtn5lX.js";
import { n as runCommandWithRuntime } from "./cli-utils-D-tH5tUz.js";
import "./cli-runtime-6DqPhdrc.js";
import "./state-paths-pqEz81bJ.js";
import { a as CANVAS_HOST_PATH, c as isA2uiPath, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload } from "./a2ui-D8VbcJIr.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-Bm7b9UVJ.js");
