...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-j0xRdcNq.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-CMFAgCpW.js";
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-BHd9kAAe.js";
import { b as parseModelRef, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, v as modelKey } from "./model-selection-shared-C1JUDoHW.js";
import "./model-selection-DDEg6aT2.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-ZhozO8kc.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-CoAt7J2b.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-_xcuTrjV.js";
import { n as loadModelsConfigWithSource } from "./load-config-BKQoG1zF.js";
import { n as formatErrorWithStack } from "./list.errors-DCVsJyHg.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-llhGKH0-.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-DBOuW4lz.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-8GNP9aPk.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BVOnqCpb.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-D3UWRizT.js"),
		import("./agent-scope-kauqWmDg.js"),
		import("./workspace-BBQS8tFJ.js")
	]);
