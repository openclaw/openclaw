...
import { t as getActiveMatrixClient } from "./active-client-CGAAF5pa.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-EZeqnmAs.js"), import("./shared-UiC1HA59.js")]).then(([clientModule, sharedModule]) => ({
