...
import { t as attachChildProcessBridge } from "./child-process-bridge-B2h3a0x4.js";
import { p as resolveUserPath, u as pathExists } from "./utils-DG9b7Tlg.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-BsjIo-qj.js";
import { a as isSystemdUserServiceAvailable } from "./systemd-BE0ropkw.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-d_aEDdtP.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-IcVdBKev.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-A3nyyCFm.js";
import { t as resolveControlUiLinks } from "./control-ui-links-Bgvy_RtQ.js";
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CR1JECjq.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-DtMG1xrE.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-B1TdP8HP.js";
import { i as installCompletion } from "./completion-runtime-w8zx3-rB.js";
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-BkErz9b7.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-CB3cksXu.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CBXcXeLt.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-DXj7raxK.js";
import { n as formatHealthCheckFailure } from "./health-format-B2QgIUf_.js";
import { n as healthCommand } from "./health-J4RhCLai.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-CJ3NEOUv.js";
import { n as TUI_SETUP_AUTH_SOURCE_ENV, t as TUI_SETUP_AUTH_SOURCE_CONFIG } from "./setup-launch-env-BdeutBDm.js";
...
function loadOnboardSearchModule() {
	onboardSearchModulePromise ??= import("./onboard-search-ZLX9OCQx.js");
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Dc0BnFhY.js");
