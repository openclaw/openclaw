...
import { a as requireGatewayClientScopeForInternalChannel } from "./command-gates-B3TjOJqA.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-DfjFA99L.js";
//#region src/auto-reply/reply/commands-acp.ts
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-9NPIhncw.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-C-k4-zvE.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-D1yI0LoB.js"));
