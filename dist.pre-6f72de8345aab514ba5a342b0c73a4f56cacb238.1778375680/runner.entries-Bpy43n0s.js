...
import { T as pathExists, r as writeExternalFileWithinRoot } from "./fs-safe-Cwlcdma7.js";
...
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-2kC5ocF6.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-D1N2BiS1.js";
import { t as describeImageWithModel } from "./image-runtime-BLf1EUGN.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-B8mmqxoR.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-DFVxhJxT.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-B4DR7Spq.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-nYN2M6v1.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
