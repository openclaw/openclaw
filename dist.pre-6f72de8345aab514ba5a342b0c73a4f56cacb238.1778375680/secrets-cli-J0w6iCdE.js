...
import { c as isRecord, d as resolveConfigDir, p as resolveUserPath } from "./utils-DG9b7Tlg.js";
...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, r as resolveAgentConfig } from "./agent-scope-config-BUbm4C3v.js";
import "./agent-scope-CcthxFej.js";
import { n as defaultRuntime } from "./runtime-Vyd5gFd2.js";
import { a as parseEnvValue, i as parseDotPath, l as writeTextFileAtomic, n as isNonEmptyString, s as toDotPath } from "./shared-ClIYHag2.js";
import { n as getPath, r as setPathCreateStrict, t as deletePathStrict } from "./path-utils-Dp9T3R6c.js";
import { a as listAuthProfileSecretTargetEntries, c as resolvePlanTargetAgainstRegistry, n as discoverConfigSecretTargets, t as discoverAuthProfileSecretTargets } from "./target-registry-m41ZJCkp.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, l as resolveDefaultSecretProviderAlias, o as isValidExecSecretRefId, u as secretRefKey } from "./ref-contract-0CmZbVWs.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-CmPYZ6To.js";
import { a as resolveSecretRefValue, o as resolveSecretRefValues, r as isProviderScopedSecretResolutionError } from "./resolve-BmEEukdx.js";
import { t as danger } from "./globals-f3TwV797.js";
import { r as createConfigIO } from "./io-CwtTPcP9.js";
import { r as listKnownSecretEnvVarNames, t as getProviderEnvVars } from "./provider-env-vars-BpKleGs5.js";
import { t as isSafeExecutableValue } from "./exec-safety-CvrARYkX.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Bo8Y8c53.js";
...
import { c as loadAuthProfileStoreForSecretsRuntime, h as loadPersistedAuthProfileStore, m as coercePersistedAuthProfileStore } from "./store-BjI2Wn-k.js";
import "./model-selection-DDEg6aT2.js";
import "./auth-profiles-BwJpHxfd.js";
import { f as isSecretRefHeaderValueMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-ZhozO8kc.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-B6iXC0nd.js";
import { n as hasConfiguredPlaintextSecretValue, r as isExpectedResolvedSecretValue, t as assertExpectedResolvedSecretValue } from "./secret-value-_fahd4SK.js";
...
function registerSecretsCli(program) {
	...
	addGatewayClientOptions(secrets.command("reload").description("Re-resolve secret references and atomically swap runtime snapshot").option("--json", "Output JSON", false)).action(async (opts) => {
		try {
			...
			defaultRuntime.error(danger(`Secrets reload failed: ${formatErrorMessage(err)}. Run ${formatCliCommand("openclaw gateway status --deep")} to inspect the active gateway.`));
