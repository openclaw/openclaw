...
import { J as resolveShellEnvFallbackTimeoutMs, K as getShellPathFromLoginShell } from "./io-CwtTPcP9.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-CuRiheeP.js";
...
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-gMR-i9iN.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-DUhzoOiq.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-qQaS3sFD.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-COyt8a6E.js";
import { o as failedTextResult, y as textResult } from "./common-BA98Cs8a.js";
import { t as callGatewayTool } from "./gateway-BkDq7V1A.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-DrsS8F1j.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-CHlp6deJ.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CoeCF_kN.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-C4TbzOUs.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-CUPXnbKI.js";
...
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-BbU-RfAf.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-BlXZVGhI.js";
import { t as getProcessSupervisor } from "./supervisor-DzXHonLd.js";
import { C as markExited, S as markBackgrounded, T as tail, _ as drainSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listFinishedSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as deleteSession, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getFinishedSession, w as setJobTtlMs, x as listRunningSessions, y as getSession } from "./bash-tools.exec-runtime-BScX4XYb.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-Bk0NI4VU.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-C9CENoU6.js";
import { n as detectPolicyInlineEval } from "./policy-DM-2JOBG.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-CpTZpRPV.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-97nnAGHu.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-CepDZSj0.js";
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-C9XCrm78.js"));
