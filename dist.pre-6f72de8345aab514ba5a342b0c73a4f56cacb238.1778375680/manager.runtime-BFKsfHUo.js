...
import { t as tempWorkspace } from "./private-temp-workspace-BhnKQ2xR.js";
import { i as stripInlineDirectiveTagsForDisplay } from "./directive-tags-BUUa0lFe.js";
import "./temp-path-S9qiXDku.js";
import { i as resolveAgentRoute } from "./resolve-route-uCNcIVb3.js";
import { _ as resolveTtsConfig, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-BOcgQUR-.js";
...
import { r as agentCommandFromIngress } from "./agent-command-BbkdU2p3.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, _ as resolveRealtimeVoiceAgentConsultToolPolicy, d as buildRealtimeVoiceAgentConsultPolicyInstructions, n as resolveConfiguredRealtimeVoiceProvider, p as buildRealtimeVoiceAgentConsultWorkingResponse, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage, v as resolveRealtimeVoiceAgentConsultTools, y as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-BQ7E3M11.js";
import { i as resamplePcm, p as createRealtimeVoiceAgentTalkbackQueue } from "./realtime-voice-BeDKEfGF.js";
import "./speech-Bouip_MS.js";
import { c as resolveDiscordAccountAllowFrom } from "./accounts-Dlnzcg9U.js";
import { t as parseDiscordTarget } from "./target-parsing-v0N57OwY.js";
import { Ft as ChannelType, o as ReadyListener, s as ResumedListener } from "./discord-DBmLXTjd.js";
import { n as formatDiscordUserTag } from "./format-C-n1Bx_9.js";
import { a as normalizeDiscordSlug, m as resolveDiscordOwnerAccess } from "./allow-list-B6-yuYYd.js";
import { t as formatMention } from "./mentions-RibrNHzX.js";
import { t as getDiscordRuntime } from "./runtime-D_x_fsQW.js";
import { t as buildDiscordGroupSystemPrompt } from "./inbound-context-CbPCMrGu.js";
import { n as resolveDiscordVoiceEnabled, t as authorizeDiscordVoiceIngress } from "./access-BDdLNfkK.js";
...
var DiscordRealtimeVoiceSession = class {
	...
	handleToolCall(event, session) {
		...
		const context = this.consumeAgentProxyConsultContext(consultMessage) ?? this.consumePendingSpeakerContext();
		if (!context) {
	...
	async runForcedAgentProxyConsult(pending) {
		...
		try {
			...
			this.bridge?.sendUserMessage(buildDiscordSpeakExactUserMessage(DISCORD_REALTIME_FALLBACK_TEXT));
		}
	}
