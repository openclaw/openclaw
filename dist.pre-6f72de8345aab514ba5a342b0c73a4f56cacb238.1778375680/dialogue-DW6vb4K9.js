import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-DUd-X1Db.js";
import { r as loadCrestodianOverview } from "./overview-BBDr33yA.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-Bh2cb1Ss.js")).planCrestodianCommand)({
		input,
		overview
	});
