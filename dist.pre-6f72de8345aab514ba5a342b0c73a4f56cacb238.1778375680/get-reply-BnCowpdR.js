...
import { y as truncateUtf16Safe } from "./utils-DG9b7Tlg.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-DDEl6txh.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-CuQ3FxQd.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-CBPCnNAj.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-BUbm4C3v.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DgUPESoD.js";
import { l as resolveAgentSkillsFilter, p as resolveSessionAgentId } from "./agent-scope-CcthxFej.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-DArOUCtA.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-UV3n6w0Y.js";
...
import "./defaults-CwXEAnpT.js";
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-nSM7t2rD.js";
import "./config-OQqPmWUa.js";
import { a as normalizeAnyChannelId } from "./registry-BvuNf1X9.js";
import "./message-channel-core-D_9Wjkle.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-gMR-i9iN.js";
import { o as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-Ce-6uXgd.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-BLIWoOwU.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-BbkdpoaV.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BqAHU1Lo.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-Dzp3i8d1.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-BYkpLqJF.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-Bo7Sm_RW.js";
import { f as parseSessionThreadInfoFast, l as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-CR507N_-.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-EXlWBGSN.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-1BESwUFb.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-ePnHAw38.js";
import { _ as deriveSessionMetaPatch, f as resolveSessionStoreEntry, s as updateSessionStore, x as resolveGroupSessionKey } from "./store-bHMyvLAj.js";
import { t as normalizeChatType } from "./chat-type-CmJrk4wJ.js";
import "./plugins-BcHLKTqQ.js";
import { s as resolveSessionLifecycleTimestamps } from "./sessions-BPwe-yj6.js";
...
import { t as resolveAndPersistSessionFile } from "./session-file-C6sboydB.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-C1JUDoHW.js";
import "./model-selection-DDEg6aT2.js";
import { o as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-CwcspjRm.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-ByV9N95O.js";
import { r as applyOwnerOnlyToolPolicy } from "./tool-policy-D7FuUKMD.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DEFOebxP.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-hZxm6KNS.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-Z55l1Kbe.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT } from "./heartbeat-DHoQZWXb.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CwYty0gj.js";
import { Z as isReasoningTagProvider } from "./compaction-successor-transcript-BFmGfuzA.js";
import { l as ensureAgentWorkspace } from "./workspace-CR1JECjq.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CyaM9JKg.js";
import { o as collectTextContentBlocks } from "./tool-result-middleware-BITZyoAR.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Cew5fxFi.js";
import "./pi-bundle-mcp-tools-CcEcbdA7.js";
...
import { n as resolveChannelGroupRequireMention } from "./group-policy-Bt8--O0F.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-nSt5-Ti7.js";
import { n as resolveSilentReplySettings } from "./silent-reply-CfIsliWX.js";
import { t as buildOutboundSessionContext } from "./session-context-BXB4yt8v.js";
import { r as resolveQueueSettings, t as isSteeringQueueMode } from "./queue-CNSs07am.js";
import { r as getSessionBindingService } from "./session-binding-service-D-_7SRXx.js";
import { t as resolveAgentTimeoutMs } from "./timeout-C11nQnnf.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-7172FF6K.js";
import { r as getCliSessionBinding } from "./cli-session-BvjGC-jY.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-NoBCJPiC.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-BHW4kNOl.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-gLp6n8XM.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-lGBXbUJo.js";
import { r as resolveTypingMode, t as resolveActiveRunQueueAction } from "./queue-policy-TEf_4SuM.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-fkK4QX0l.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-Kgs3HIQE.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CMB1FU7-.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-g7mwYGkz.js";
import "./commands-registry-CkLGAYkA.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-CCL0_SEF.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DTCSrP4q.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-CAQOhCMR.js";
import { t as finalizeInboundContext } from "./inbound-context-BemHjyn_.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-T_bOzf4S.js";
import { t as hasControlCommand } from "./command-detection-CcXv0O9N.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-Bx3KlDt1.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-DQlXCMxa.js";
import { t as resolveChannelModelOverride } from "./model-overrides-CBgI0J_N.js";
import { t as normalizeGroupActivation } from "./group-activation-l8jd0FwT.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-DUB04uzR.js";
import { t as resolveFastModeState } from "./fast-mode-Bg5fdL1N.js";
import { t as buildCommandContext } from "./commands-context-B_yYiWKL.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-Cn8w55s8.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-B8EGQNPu.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-B8U5gx0W.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CzYD2FuV.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-DpygiC6d.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DlqhDCTC.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-Bxuj74As.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-BrhsIN1v.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-DTb4Dy4u.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-fqWyuG6C.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-CLxjeymf.js";
import { t as hasInboundMedia } from "./inbound-media-BM1xY4T3.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CKxcp7r9.js";
import { n as resolveResetPreservedSelection, t as clearSessionResetRuntimeState } from "./session-reset-cleanup-D1TOA-UO.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-BvdSnruI.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-B9hD9TxZ.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-DUJEEsQQ.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-BcMKsHLf.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-6Wyl1IuE.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-DwhDwFqw.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DQ9O1egR.js"));
...
function resolveNativeSlashCommandName(ctx) {
	if (ctx.CommandSource !== "native") return;
...
function formatChatWindowStructuredContext(entry, envelope) {
	if (normalizePromptMetadataString(entry.type) !== "chat_window" || !isRecord(entry.payload)) return;
...
function buildInboundUserContextPrefix(ctx, envelope) {
	...
	if (replyChainPayload.length > 0) blocks.push(formatUntrustedJsonBlock("Reply chain of current user message (untrusted, nearest first):", replyChainPayload));
	else if (replyToBody) blocks.push(formatUntrustedJsonBlock("Reply target of current user message (untrusted, for context):", {
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime--s-rWnOU.js");
...
const hookRunnerGlobalLoader = createLazyImportLoader(() => import("./hook-runner-global-Bnfrli5h.js"));
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-CDIF9doI.js"));
	...
	if (sessionEntry?.pendingFinalDelivery && sessionEntry.pendingFinalDeliveryText) {
		...
		if (opts?.isHeartbeat) {
			...
			if (sessionKey && storePath) {
				const { updateSessionStoreEntry } = await import("./sessions-Clqa6650.js");
