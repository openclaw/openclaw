...
import { g as loggingState } from "./logger-CM9YQbLE.js";
import { a as routeLogsToStderr } from "./console-OUQtxr3y.js";
import { t as resolveCliCommandPathPolicy } from "./command-path-policy-SMXN886T.js";
import { t as resolveCliStartupPolicy } from "./command-startup-policy-Yf9SL5BI.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-BGVhX14t.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-7-c0Ek5h.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CwYLyNB2.js");
	if (params.argv) {
