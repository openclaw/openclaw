...
import { w as trySafeFileURLToPath, x as hasEncodedFileUrlSeparator } from "./fs-safe-Cwlcdma7.js";
import { o as root } from "./secure-temp-dir-JZ25IoOE.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-DG9b7Tlg.js";
...
import { o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BUbm4C3v.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-CcthxFej.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-DImMaCM3.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-j0xRdcNq.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-EtjCBQu9.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-D8GB6jPe.js";
import { a as normalizeDiagnosticTraceparent, t as DIAGNOSTIC_TRACEPARENT_PATTERN } from "./diagnostic-trace-context-pure-BN4jlV4a.js";
import "./diagnostic-trace-context-CQzT11Bo.js";
import { t as createSubsystemLogger } from "./subsystem--HE_VOOc.js";
import { t as logDebug } from "./logger-D3H65hS5.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-CwtTPcP9.js";
import { h as isWindowsDrivePath } from "./archive-DlGuLPCX.js";
import { t as applyMergePatch } from "./merge-patch-BHqON3-H.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-DL6u1_8e.js";
...
import { n as isRestartEnabled } from "./commands.flags-BmDYKLEJ.js";
import { o as normalizeChannelId } from "./registry-BvuNf1X9.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-DnODvpW4.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-D_9Wjkle.js";
import { u as normalizeMessageChannel } from "./message-channel-gMR-i9iN.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-CIfBvkcX.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-Ce-6uXgd.js";
import { i as callGateway } from "./call-Bl6UQZwm.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-CG8-Z6pO.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-Bor5jiDF.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-CZdnfmQ-.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-RrB1ssQj.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-BYkpLqJF.js";
import { h as stringifyRouteThreadId } from "./channel-route-DcFfSOGR.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-Bo7Sm_RW.js";
import { S as createExpiringMapCache, f as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-CR507N_-.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-1BESwUFb.js";
import { n as resolveSessionConversationRef } from "./session-conversation-CD_AQv7i.js";
import { n as mergeSessionEntry } from "./types-ePnHAw38.js";
import { s as updateSessionStore } from "./store-bHMyvLAj.js";
import "./plugins-BcHLKTqQ.js";
import { a as extractDeliveryInfo } from "./sessions-BPwe-yj6.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DySP-8MF.js";
import { h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as modelKey, y as normalizeModelRef } from "./model-selection-shared-C1JUDoHW.js";
import { m as resolveThinkingDefault, s as resolveDefaultModelForAgent, t as buildAllowedModelSet } from "./model-selection-DDEg6aT2.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-6D6avB0B.js";
import "./auth-profiles-BwJpHxfd.js";
import { n as listProfilesForProvider } from "./profile-list-rB9AtIp4.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-MFq_5ETz.js";
import { r as getApiKeyForModel } from "./model-auth-CoAt7J2b.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BL4OCRaL.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-v3JwumhN.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-CwcspjRm.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-nS_WHCls.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-DRN5svOP.js";
import { n as ensureOpenClawModelsJson } from "./models-config-hOBlAlAU.js";
import { r as loadModelCatalog } from "./model-catalog-CWcd3ars.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-f7kO9u3y.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-vAiAb0Yq.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-BDk7LHb5.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-qQaS3sFD.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-Bd5YLiAX.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-B52OgTlZ.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-Dn8SLG3L.js";
import { n as extractTextFromChatContent } from "./chat-content-BW0ThgJt.js";
import { r as stripToolMessages } from "./chat-history-text-B_szfMJ8.js";
import { r as normalizeContinuationTargetKeys, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-BWwNaeeF.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-Z55l1Kbe.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DJoNKEsJ.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-6B30inWr.js";
import { a as resolvePluginTools } from "./tools-1cA9xG-m.js";
import { a as getImageMetadata } from "./image-ops-C9x5bMdH.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CCpLY7if.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DePXFkBb.js";
import { f as listAllChannelSupportedActions, l as wrapToolWithBeforeToolCallHook, m as listChannelSupportedActions, s as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-Jh3fDnry.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DzuIRA54.js";
import { n as extractAssistantText } from "./pi-embedded-utils-DlkxJ-h2.js";
import { n as runWithImageModelFallback } from "./model-fallback-CzWXFhh5.js";
import { n as assertSandboxPath } from "./sandbox-paths-ClWhJgi3.js";
import "./local-file-access-BCy2Hv8O.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-BA98Cs8a.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BkDq7V1A.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-DCeDgWTZ.js";
...
import "./delivery-context-Bw6A6x04.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-CuVLSjBX.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-B6iXC0nd.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-sJn6q6QE.js";
import { r as resolveMaxDelegatesPerTurn } from "./config-CeeZL2OF.js";
import { a as enqueuePendingDelegate, o as getContinuationDelegateQueueDepths, u as stagePostCompactionDelegate } from "./delegate-store-B_WXK4Ei.js";
import { a as generateSecureToken } from "./secure-random-CWAlPln7.js";
import "./targeting-CgdebXg-.js";
import { a as enqueueSystemEvent } from "./system-events-DLH2vbkB.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-1W3l6WHM.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-tDnzk4US.js";
import { t as inferLegacyName } from "./normalize-CnTd-PVC.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-31nki1KL.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-CooekXIn.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-C9dQNDoy.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-C99y2kd3.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-ozbYTRye.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-vVOcnlPt.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-Dx8PtO2i.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-cS0JEYhu.js";
import { u as saveMediaBuffer } from "./store-BdZFEXDq.js";
import { t as SsrFBlockedError } from "./ssrf-DX8ajhwl.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-BQGPsjsg.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-Dqifo5D9.js";
import { r as getDefaultLocalRoots } from "./local-media-access-B-jaspGf.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-EdT81nw_.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-BBeHhIj3.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-NfvE4edn.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-ffZbfXRj.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-D1N2BiS1.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CDhs7qs8.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BLf1EUGN.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-B8mmqxoR.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-DzZHbuO_.js";
import { s as resolveTimeoutMs } from "./resolve-DFVxhJxT.js";
import { t as buildProviderRegistry } from "./runner-CF33HtLm.js";
import "./media-understanding-ZpweQbW0.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-D-q_E5vV.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-Ci49htE2.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BHRy2JaN.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-CDA6v06I.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-BmzzbldZ.js";
import { t as deriveSessionChatTypeFromKey } from "./session-chat-type-shared-PMN5YLNp.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-BjHLOEyU.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DmoUpHYP.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-kbfzzjzp.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-CFMNsAEY.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-HNxTcHo4.js";
import { t as parseTimeoutMs } from "./parse-timeout-kc-dVcr1.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-Dq9Yg-aL.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BqXHjBDy.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-DFl9B79x.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CnuUUrQW.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-D-sLbZP8.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-iHiBKa-h.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-DdeI3Fx6.js";
import { p as registerSubagentRun } from "./subagent-registry-AQSdoZkb.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CbPGDmUq.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-CJGmVA9G.js";
import { k as textToSpeech } from "./tts-runtime-BOcgQUR-.js";
import "./tts-Bh6RvJAC.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-BDY2Xtgp.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-CjPbViQH.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BpNUitH8.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-CJBVNNkq.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-iaCVx-1Z.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-ChL8q53M.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-BVQmCiLr.js";
import { i as runWebSearch } from "./runtime-B1TdP8HP.js";
import "./web-search-provider-common-9wZEsKDV.js";
...
function failMediaGenerationTaskRun(params) {
	...
	try {
		const endedAt = Date.now();
		const errorText = formatErrorMessage$1(params.error);
		failTaskRunByRunId({
			runId: params.handle.runId,
			runtime: "cli",
			sessionKey: params.handle.requesterSessionKey,
				...
				scheduleBackgroundWork(async () => {
					try {
						...
						await wakeMusicGenerationTaskCompletion({
							...
							status: "error",
							statusLabel: "failed",
							result: formatErrorMessage$1(error)
						});
						return;
					}
				});
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			try {
				...
				let message = formatErrorMessage$1(err);
...
const log$2 = createSubsystemLogger("continuation/request-compaction");
...
function notifyCompactionFailure(params) {
	try {
		...
		log$2.error(`[request_compaction:failure-event-error] session=${params.sessionKey} runId=${params.runId ?? params.sessionId} diagId=${params.diagId} code=${params.code} error=${formatErrorMessage(err)}`);
	}
}
/**
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			if (pendingCompactionSessions.has(sessionKey)) {
				log$2.debug(`[request_compaction:already-pending] session=${sessionKey}`);
				return jsonResult({
			...
			if (contextUsage === null) {
				log$2.debug(`[request_compaction:context-unknown] session=${sessionKey}`);
				return jsonResult({
					status: "rejected",
			...
			if (contextUsage < MIN_CONTEXT_THRESHOLD) {
				log$2.debug(`[request_compaction:below-threshold] session=${sessionKey} usage=${(contextUsage * 100).toFixed(1)}%`);
				return jsonResult({
					status: "rejected",
					guard: "context_threshold",
			...
			if (guard && now - guard.lastRequestMs < RATE_LIMIT_MS) {
				...
				log$2.debug(`[request_compaction:rate-limited] session=${sessionKey} remainingSec=${remainingSec}`);
				return jsonResult({
					status: "rejected",
					guard: "rate_limit",
			...
			log$2.info(`[request_compaction:enqueuing] session=${sessionKey} runId=${opts.runId ?? opts.sessionId} diagId=${diagId} trigger=volitional usage=${(contextUsage * 100).toFixed(1)}% reason=${reason}`);
			...
			opts.triggerCompaction(request).then((result) => {
				if (result.ok && result.compacted) {
					...
					log$2.info(`[request_compaction:resolved-success] session=${sessionKey} runId=${opts.runId ?? opts.sessionId} diagId=${diagId} trigger=volitional outcome=compacted`);
				...
				if (result.ok && isCompactionSkipCode(code)) {
					log$2.info(`[request_compaction:resolved-skip] session=${sessionKey} runId=${opts.runId ?? opts.sessionId} diagId=${diagId} trigger=volitional outcome=skipped code=${code} reason=${reason}`);
					return;
				}
				log$2.warn(`[request_compaction:resolved-failure] session=${sessionKey} runId=${opts.runId ?? opts.sessionId} diagId=${diagId} trigger=volitional outcome=failed code=${code} ok=${result.ok} compacted=${result.compacted} reason=${reason}`);
				notifyFailure(code, reason);
			}, (err) => {
				const message = formatErrorMessage(err);
				const code = classifyCompactionReason(message);
				log$2.error(`[request_compaction:background-error] session=${sessionKey} runId=${opts.runId ?? opts.sessionId} diagId=${diagId} trigger=volitional outcome=failed code=${code} error=${message}`);
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-B_AoSGXM.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-mr99evCu.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-pmCUzDE3.js"));
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-xBWZEtvY.js"));
...
//#endregion
export { resolveOpenClawPluginToolsForOptions as C, isEmbeddedMode as D, stripProviderPrefix as E, setEmbeddedMode as O, sniffMimeFromBase64 as S, isStrictAgenticSupportedProviderModel as T, createSandboxedReadTool as _, resolveCompactionFailureReason as a, wrapToolWorkspaceRootGuard as b, listSupportedMusicGenerationModes as c, normalizeCronJobPatch as d, resolveToolLoopDetectionConfig as f, createSandboxedEditTool as g, createOpenClawReadTool as h, formatUnknownCompactionReasonDetail as i, normalizeCronJobCreate as l, createHostWorkspaceWriteTool as m, isParentOwnedBackgroundAcpSession as n, generateMusic as o, createHostWorkspaceEditTool as p, classifyCompactionReason as r, listRuntimeMusicGenerationProviders as s, createOpenClawTools as t, normalizeCronJobInput as u, createSandboxedWriteTool as v, isStrictAgenticExecutionContractActive as w, wrapToolWorkspaceRootGuardWithOptions as x, wrapToolMemoryFlushAppendOnlyWrite as y };
