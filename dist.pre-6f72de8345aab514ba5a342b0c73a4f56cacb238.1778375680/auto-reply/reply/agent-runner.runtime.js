...
import { t as hasConfiguredModelFallbacks } from "../../agent-scope-CcthxFej.js";
import { n as defaultRuntime } from "../../runtime-Vyd5gFd2.js";
import { a as freezeDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "../../diagnostic-trace-context-CQzT11Bo.js";
import { a as isDiagnosticsEnabled, i as emitTrustedDiagnosticEvent } from "../../diagnostic-events-CoTy4zDZ.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "../../thinking-nSM7t2rD.js";
import { n as parseNonNegativeByteSize } from "../../zod-schema-P5z1cUk_.js";
import "../../config-OQqPmWUa.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "../../message-channel-gMR-i9iN.js";
import { o as resolveOpenAIRuntimeProviderForPi } from "../../openai-codex-routing-BHd9kAAe.js";
import { x as resolveMemoryFlushPlan } from "../../memory-state-D-0Uaz54.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "../../agent-events-RrB1ssQj.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "../../paths-BYkpLqJF.js";
import { t as loadSessionStore } from "../../store-load-CR507N_-.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "../../types-ePnHAw38.js";
import { c as updateSessionStoreEntry, f as resolveSessionStoreEntry, s as updateSessionStore, x as resolveGroupSessionKey } from "../../store-bHMyvLAj.js";
import "../../sessions-BPwe-yj6.js";
import { a as resolveContextTokensForModel } from "../../context-BngIoVRQ.js";
import { h as resolveModelRefFromString } from "../../model-selection-shared-C1JUDoHW.js";
import { t as isCliProvider } from "../../model-selection-cli-D3XjRbKG.js";
import "../../model-selection-DDEg6aT2.js";
import { u as resolveModelAuthMode } from "../../model-auth-CoAt7J2b.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "../../run-state-DS2AQmP2.js";
import { l as queueEmbeddedPiMessage } from "../../runs-CwUHcnNz.js";
...
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "../../usage-format-DnqCuEOY.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "../../usage-DyzQRWMZ.js";
import { l as readSessionMessagesAsync } from "../../session-utils.fs-f7kO9u3y.js";
import { a as resolveSessionTranscriptCandidates } from "../../session-transcript-files.fs-BjPaDXQR.js";
import { i as resolveSandboxConfigForAgent } from "../../config-C8Ot1iLD.js";
import { n as resolveSandboxRuntimeStatus } from "../../runtime-status-DEFOebxP.js";
import { o as stripLegacyBracketToolCallBlocks } from "../../assistant-visible-text-Dn8SLG3L.js";
import { r as formatRawAssistantErrorForUi } from "../../assistant-error-format-BEPMYuUR.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "../../sanitize-user-facing-text-COyt8a6E.js";
...
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "../../command-queue-hZxm6KNS.js";
import { u as isLikelyExecutionAckPrompt } from "../../selection-C1ON_BJT.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "../../tokens-Z55l1Kbe.js";
import { u as stripHeartbeatToken } from "../../heartbeat-DHoQZWXb.js";
import { o as isAudioFileName } from "../../mime-DJoNKEsJ.js";
import { j as readPostCompactionContext } from "../../compaction-successor-transcript-BFmGfuzA.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "../../bootstrap-budget-CoU-jKhC.js";
import "../../pi-embedded-helpers-7dqn4kwt.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "../../oauth-refresh-failure-BQ3O6S9Y.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "../../errors-BYTk5hqU.js";
import { r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "../../reply-payload-CEMHLTFz.js";
import { h as parseReplyDirectives } from "../../deliver-CpEWupIe.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "../../reply-payload-PV7DwoHV.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "../../model-fallback-CzWXFhh5.js";
import { i as estimateMessagesTokens } from "../../compaction-ZmV9xOH_.js";
import { n as resolveLiveContinuationRuntimeConfig } from "../../config-CeeZL2OF.js";
import { d as stagedPostCompactionDelegateCount, f as takeDelayedContinuationReservation, l as pendingDelegateCount, n as consumePendingDelegates, s as highestDelayedContinuationReservationHop, t as addDelayedContinuationReservation } from "../../delegate-store-B_WXK4Ei.js";
import { c as emitContinuationWorkSpan, i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "../../continuation-tracer-BoLshHwS.js";
import { s as requestHeartbeatNow } from "../../heartbeat-wake-1HVEsGmQ.js";
import { o as generateSecureUuid, t as generateChainId } from "../../secure-random-CWAlPln7.js";
import { a as enqueueSystemEvent } from "../../system-events-DLH2vbkB.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "../../silent-reply-CfIsliWX.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "../../reply-threading-D2dT7wrz.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "../../reply-payloads-dedupe-C5UMsQQC.js";
import { n as routeReply, t as isRoutableChannel } from "../../route-reply-DWBsu3s7.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "../../queue-CNSs07am.js";
import "../../sandbox-Co0p1aM4.js";
import { t as runEmbeddedPiAgent } from "../../pi-embedded-DnXXz-5S.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "../../build-D8wElPtb.js";
import { r as enqueueCommitmentExtraction } from "../../runtime-BzRtDKsL.js";
import { n as resolveSendPolicy } from "../../send-policy-DzsfSEeB.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "../../continuation-delegate-store-DgLXk5Q-.js";
import { t as checkContextPressure } from "../../context-pressure-CtVOvWC0.js";
...
import { t as formatProviderModelRef } from "../../model-runtime-Cl7yimJ8.js";
import { t as runCliAgent } from "../../cli-runner-j0fg0kEE.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "../../cli-session-BvjGC-jY.js";
import { i as resolveCliRuntimeExecutionProvider } from "../../model-runtime-aliases-zm4cDos8.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "../../agent-runner-utils-D6k3qg30.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "../../origin-routing-NoBCJPiC.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "../../block-reply-pipeline-C4xdN5P9.js";
import { t as createReplyMediaContext } from "../../reply-media-paths.runtime-Bg5wKc5E.js";
import { n as incrementCompactionCount } from "../../session-updates-BCg1AiTF.js";
import { r as resolveCronStorePath, t as loadCronStore } from "../../store-BkqDZz6-.js";
import { r as resolveEffectiveBlockStreamingConfig } from "../../block-streaming-lGBXbUJo.js";
import { n as createTypingSignaler, t as resolveActiveRunQueueAction } from "../../queue-policy-TEf_4SuM.js";
import { n as dispatchPostCompactionDelegates, r as persistPendingPostCompactionDelegates } from "../../post-compaction-delegate-dispatch-C8KfHlrO.js";
import { r as resolveSourceReplyVisibilityPolicy } from "../../source-reply-delivery-mode-BvJ35-22.js";
...
async function runEmbeddedPiAgentDefault$1(...args) {
	const { runEmbeddedPiAgent } = await import("../../pi-embedded.runtime-BpbcVmmh.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("../../compact.queued-bGWNE0wk.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("../../pi-embedded-D48EhNqw.js"));
...
const replyPayloadsDedupeRuntimeLoader = createLazyImportLoader(() => import("../../reply-payloads-dedupe.runtime-B5pTdW3c.js"));
...
async function runReplyAgent(params) {
	...
	try {
		...
		if (continuationFeatureEnabled && sessionKey) {
			const turnTokens = (usage?.input ?? 0) + (usage?.output ?? 0);
			const { dispatchToolDelegates, loadContinuationChainState } = await import("../continuation/lazy.runtime.js");
