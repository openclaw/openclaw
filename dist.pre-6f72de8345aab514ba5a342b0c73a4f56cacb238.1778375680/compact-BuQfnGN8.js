...
import { c as runHarnessContextEngineMaintenance, s as isActiveHarnessContextEngine } from "./attempt.tool-run-context-CwSVl1Fx.js";
import { t as log } from "./logger-I4coJdAX.js";
import "./agent-harness-runtime-C5e_g0BT.js";
import { s as resolveCodexAppServerRuntimeOptions } from "./config-3_v5xeLR.js";
import { t as isJsonObject } from "./protocol-B_uanINF.js";
import { i as readCodexAppServerBinding } from "./session-binding-CKLKXpcb.js";
import { n as defaultCodexAppServerClientFactory, t as createCodexAppServerClientFactoryTestHooks } from "./client-factory-CEV7m-jJ.js";
...
async function maybeCompactCodexAppServerSession(params, options = {}) {
	...
	if (activeContextEngine?.info.ownsCompaction) {
		...
		try {
			...
			log.warn("context engine compaction failed; attempting Codex native compaction", {
				sessionId: params.sessionId,
		...
		if (primary?.ok && primary.compacted) try {
			...
			log.warn("context engine compaction maintenance failed; continuing Codex native compaction", {
				sessionId: params.sessionId,
				engineId: activeContextEngine.info.id,
