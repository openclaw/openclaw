...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-CwUHcnNz.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-BAyxgIoE.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-KDx1SIeu.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-Z55l1Kbe.js";
import "./delivery-context-Bw6A6x04.js";
import { t as resolveContinuationRuntimeConfig } from "./config-CeeZL2OF.js";
import { n as consumePendingDelegates } from "./delegate-store-B_WXK4Ei.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-kbfzzjzp.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-CFMNsAEY.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-DdeI3Fx6.js";
import "./continuation-delegate-store-DgLXk5Q-.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-DNvAo4vg.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-D5iab4jT.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-B2owUCSf.js"), import("./store-load-CGN9t_LW.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-DlrbDDCq.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-BWj84BTL.js");
			const { createSubsystemLogger } = await import("./subsystem-OHnlbKRN.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-CaTTlG3X.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
