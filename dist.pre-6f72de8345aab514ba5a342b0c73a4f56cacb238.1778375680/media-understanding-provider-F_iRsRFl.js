import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-CbUGPzUI.js";
import { s as resolveCodexAppServerRuntimeOptions } from "./config-3_v5xeLR.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-CZAqv-lQ.js";
import { r as readModelListResult } from "./models-IMBeJYKg.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-Ddxnr2AM.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
