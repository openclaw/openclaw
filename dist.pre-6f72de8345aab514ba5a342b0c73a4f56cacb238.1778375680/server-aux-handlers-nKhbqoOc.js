...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-DnV3hPS9.js";
import { n as channelRouteDedupeKey } from "./channel-route-DcFfSOGR.js";
import { n as getLoadedChannelPlugin } from "./registry-1BESwUFb.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-BcHLKTqQ.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-Bm2XxiDm.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-B6iXC0nd.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-ObWANoIv.js";
import { l as roleScopesAllow } from "./pairing-token-DzGJuu0m.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Blo8ACHd.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-C9CENoU6.js";
import { r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DnZ_lotV.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-Dv8frUV2.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DWEWFrgG.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BdRkyFXV.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Mpfe2hTA.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-CYivs4ft.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-CKupelCN.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-ClXZ9QCS.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-BU4xTt3f.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
