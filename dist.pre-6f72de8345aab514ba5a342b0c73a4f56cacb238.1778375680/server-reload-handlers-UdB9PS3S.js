...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-DX2_zOGO.js";
import "./installed-plugin-index-records-CCj0kkMO.js";
import { n as formatConfigIssueLines } from "./issue-format-b_3rMHT2.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-DL6u1_8e.js";
import { n as isRestartEnabled } from "./commands.flags-BmDYKLEJ.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-CG8-Z6pO.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DS2AQmP2.js";
import { o as resetModelCatalogCache } from "./model-catalog-CWcd3ars.js";
import { l as getTotalQueueSize } from "./command-queue-hZxm6KNS.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-Cew5fxFi.js";
import "./pi-bundle-mcp-tools-CcEcbdA7.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-B6iXC0nd.js";
import { r as resetDirectoryCache } from "./target-resolver-BVmGizL5.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-D8fQn08t.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-BhSeham0.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-KOalcF-l.js";
import { _ as resolveHooksConfig } from "./hooks-DwkWH_QH.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-DWaAn9r6.js";
import { i as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BdRkyFXV.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-Dy5T_IrD.js";
...
import { t as buildGatewayCronService } from "./server-cron-C9hevTEo.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-D-34n47d.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-CMmoUaot.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-wV5HGW5o.js"), import("./gmail-watcher-lifecycle-BGczqil1.js")]);
