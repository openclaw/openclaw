...
import { u as prepareScopedSetupConfig } from "./setup-helpers-CmIT7u8P.js";
import "./setup-C8PCOSKg.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DOOJK_tJ.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-CVxpdcLW.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-BiEhMb5Q.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DkroxpfC.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-BQK-Fd5g.js");
