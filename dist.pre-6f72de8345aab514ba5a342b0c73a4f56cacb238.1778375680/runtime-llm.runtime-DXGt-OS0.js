...
import { s as normalizePluginsConfig } from "./config-state-CRWSycy9.js";
import { i as getChildLogger } from "./logger-CM9YQbLE.js";
import { t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-Bxi_GGnX.js";
import "./logging-C4L0b5jL.js";
import { y as normalizeModelRef } from "./model-selection-shared-C1JUDoHW.js";
import "./model-selection-DDEg6aT2.js";
import { a as resolveModelCostConfig, n as estimateUsageCost } from "./usage-format-DnqCuEOY.js";
...
async function resolveAgentId(params) {
	...
	const { resolveDefaultAgentId } = await import("./agent-scope-kauqWmDg.js");
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ prepareSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-KAzpVP3I.js"), Promise.resolve(resolveRuntimeConfig(options))]);
		...
		if (requestedModel) {
			...
			assertAllowedModelOverride({
				resolvedModelRef: normalizedSelection ? `${normalizedSelection.provider}/${normalizedSelection.model}` : null,
				pluginPolicyId,
				authorityPolicy,
				pluginPolicy
			});
