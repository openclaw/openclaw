...
import { n as info$1 } from "./globals-f3TwV797.js";
...
import { i as callGateway, l as isGatewayTransportError } from "./call-Bl6UQZwm.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-BYkpLqJF.js";
import { t as loadSessionStore } from "./store-load-CR507N_-.js";
import "./store-bHMyvLAj.js";
import { i as serializeSessionCleanupResult, n as resolveSessionCleanupAction, r as runSessionsCleanup } from "./sessions-BPwe-yj6.js";
import { f as resolveTaskFlowForLookupToken, g as updateFlowRecordByIdExpectedRevision, l as listTaskFlowRecords, r as deleteTaskFlowRecordById, s as getTaskFlowById } from "./task-flow-runtime-internal-DxnrJRWG.js";
import { E as updateTaskNotifyPolicyById, p as listTasksForFlowId, s as getTaskById } from "./task-registry-VropIDh9.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-BcalhIcm.js";
import "./runtime-internal-CWBzOrLy.js";
import { l as getFlowTaskSummary, n as cancelFlowById, t as cancelDetachedTaskRunById } from "./task-executor-C21f5b4O.js";
import { c as resolveCommitmentStorePath, s as markCommitmentsStatus, t as listCommitments } from "./store-CW37G7SB.js";
import { r as resolveCronStorePath } from "./store-BkqDZz6-.js";
import { t as compareTaskAuditFindingSortKeys } from "./task-registry.audit.shared-CqS4QP-L.js";
import { n as listTaskAuditFindings, r as summarizeTaskAuditFindings } from "./task-registry.audit-DtOhv4o4.js";
import { c as reconcileTaskLookupToken, d as runTaskRegistryMaintenance, i as getInspectableTaskRegistrySummary, o as previewTaskRegistryMaintenance, r as getInspectableTaskAuditSummary, s as reconcileInspectableTasks, t as configureTaskRegistryMaintenance } from "./task-registry.maintenance-BhSeham0.js";
import { n as runCommandWithRuntime } from "./cli-utils-D-tH5tUz.js";
import { t as formatHelpExamples } from "./help-format-TQoTMqM-.js";
import { n as parsePositiveIntOrUndefined } from "./helpers-DRNdsexE.js";
import { n as formatTrajectoryCommandExportSummary, t as exportTrajectoryForCommand } from "./command-export-s8r-TI9t.js";
import { n as healthCommand } from "./health-J4RhCLai.js";
import { a as formatSessionModelCell, c as resolveSessionStoreTargetsOrExit, i as formatSessionKeyCell, n as formatSessionAgeCell, o as toSessionDisplayRows, r as formatSessionFlagsCell, s as resolveSessionDisplayModel, t as sessionsCommand } from "./sessions-DqsU280u.js";
import { n as statusCommand } from "./status.command-B_8bgqGV.js";
import "./status-CmQ8C9d5.js";
import { n as summarizeTaskFlowAuditFindings, t as listTaskFlowAuditFindings } from "./task-flow-registry.audit-iGmmne8G.js";
...
async function exportTrajectoryCommand(opts, runtime) {
	...
	if (!sessionKey) {
		runtime.error(`--session-key is required. Run ${formatCliCommand("openclaw sessions list")} to choose a session.`);
		runtime.exit(1);
		return;
	}
	...
	if (!entry?.sessionId) {
		runtime.error(`Session not found: ${sessionKey}. Run ${formatCliCommand("openclaw sessions list")} to see available sessions.`);
		runtime.exit(1);
		return;
	}
	let sessionFile;
