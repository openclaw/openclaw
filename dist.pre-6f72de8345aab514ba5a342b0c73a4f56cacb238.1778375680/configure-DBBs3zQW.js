...
import { g as shortenHomePath, p as resolveUserPath, x as isPlainObject } from "./utils-DG9b7Tlg.js";
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-DYAh0rlj.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-BsjIo-qj.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-BE0ropkw.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-j0xRdcNq.js";
...
import { t as ConfigMutationConflictError } from "./mutate-CupOQt-W.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CB3cksXu.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-Hd5U75py.js";
import { n as applyAuthChoice } from "./auth-choice-DxJiZP4A.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DxB38WS_.js";
...
import { t as promptCustomApiConfig } from "./onboard-custom-BmEz9tHS.js";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CHmZJcyE.js";
import { t as setupSkills } from "./onboard-skills-DXk78F0i.js";
...
async function resolveProviderChoiceModelPrompt(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-_5LZLZ5F.js");
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-CQkdpXzZ.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-IhStmWiZ.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-ZLX9OCQx.js");
