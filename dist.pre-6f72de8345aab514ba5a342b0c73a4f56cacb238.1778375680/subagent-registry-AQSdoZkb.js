...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-RrB1ssQj.js";
...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-BTvtsmAz.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-DmoUpHYP.js";
import "./subagent-announce-queue-DBKzkBbg.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-iHiBKa-h.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-DdeI3Fx6.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-C4jEwpS4.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-B82jLuNS.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-BKcqNeit.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-B82jLuNS.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-86ZTG0Jo.js").then(({ scheduleOrphanRecovery }) => {
