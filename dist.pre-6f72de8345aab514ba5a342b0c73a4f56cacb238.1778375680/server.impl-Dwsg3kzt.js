...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-bRAEOIv1.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-DG9b7Tlg.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-DArOUCtA.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-EtjCBQu9.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-D8GB6jPe.js";
import { n as createDiagnosticTraceContext, s as runWithDiagnosticTraceContext } from "./diagnostic-trace-context-CQzT11Bo.js";
import { a as isDiagnosticsEnabled, l as setDiagnosticsEnabledForProcess } from "./diagnostic-events-CoTy4zDZ.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem--HE_VOOc.js";
import { t as isContainerEnvironment } from "./container-environment-Dv6Wz22u.js";
import { g as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-DrO5tffj.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-loGiSZWT.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-BdM_W7Td.js";
import { n as resolveGatewayAuth } from "./auth-resolve-D_lz4MiV.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-CwtTPcP9.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-DL6u1_8e.js";
import { n as isRestartEnabled } from "./commands.flags-BmDYKLEJ.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CnaUmgqD.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-DUhzoOiq.js";
import "./method-scopes-CP8dO6_m.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-CG8-Z6pO.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DNVUgQrI.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-DSK2FvQP.js";
import { i as resolveMainSessionKey } from "./main-session-Dzp3i8d1.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-EXlWBGSN.js";
import "./sessions-BPwe-yj6.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DS2AQmP2.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-Cw0ETe6T.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-D_0tIO_h.js";
import { l as getTotalQueueSize } from "./command-queue-hZxm6KNS.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-B6iXC0nd.js";
import { a as enqueueSystemEvent } from "./system-events-DLH2vbkB.js";
import { r as resolveCronStorePath } from "./store-BkqDZz6-.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-KOalcF-l.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BsDxPfGE.js";
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-BGMdXXpg.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-BT_pbRJX.js";
...
import { n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-Bl657J4T.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-CuXRp8Uq.js";
import { t as GatewayLockError } from "./gateway-lock-udc7UXHI.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CBXcXeLt.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-ppCcLQCz.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-BYaeyorR.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Cc8H_B9n.js";
...
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-DBb-cwEE.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-B9tukBfv.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-QOPaxOQ6.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-D-34n47d.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-CB_gqS95.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-CpIXoz89.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-BMQN96Vd.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-BjVfcYji.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-B17WdiAa.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-DIaCsVzI.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-BA48GPer.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DN-iCrWJ.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-D0SpQZUn.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-CuBpUhp9.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-BuXZHxGn.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DNIRZa7k.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-BZ2dLe1D.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DEdBSADK.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-BCZmZ51T.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-AhlM4W8R.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-CT7el5aM.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-DjQtFVKs.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-4Z21ypbh.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DTW-jgcU.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-CQwg4bE3.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-RUA-ErtE.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-RUA-ErtE.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-DKsNYl4p.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-CeTWh2xN.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-CEsGLPwF.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-BBz0JVJa.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-D8QJIrzZ.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-BjMrFSJV.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-DKsNYl4p.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-BH_jw9LV.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-CBuQxk2I.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-OhwczHKH.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-CjuQ8OEd.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins--WemmlAn.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-Cg_9zm6C.js");
	...
	const { createChannelManager } = await import("./server-channels-BHFoz0Qk.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-ayErnqL-.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-B1W_DZ0g.js"), import("./server-runtime-services-LhyNXCiB.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-nKhbqoOc.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-sgVD6tZy.js"),
				import("./server-plugin-bootstrap-DsNPZEGw.js"),
				import("./services-BF_JtEb5.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-CIjNiDDq.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-DsNPZEGw.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-DEnlG8CU.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-D2QIRrqk.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-UdB9PS3S.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-Bnfrli5h.js");
