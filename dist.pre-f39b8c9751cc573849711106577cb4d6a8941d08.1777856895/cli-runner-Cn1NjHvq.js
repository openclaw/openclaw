...
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-DEYYRlWS.js";
import "./pi-embedded-helpers-BTvKbJ6F.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-BQkZNf2j.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-BMChcxgR.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-QaRcGKLP.js");
