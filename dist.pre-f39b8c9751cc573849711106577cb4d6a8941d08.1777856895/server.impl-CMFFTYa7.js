...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-CNalhgr6.js";
...
import { i as isKnownSecretTargetId } from "./target-registry-DYig1YDH.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-CcH6lCHZ.js";
import { d as runWithDiagnosticTraceContext, n as createDiagnosticTraceContext } from "./diagnostic-trace-context-IHDWx_7D.js";
import { c as setDiagnosticsEnabledForProcess, i as isDiagnosticsEnabled } from "./diagnostic-events-Cxscc9Dh.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-CgTF-J8V.js";
import { i as runExec } from "./exec-uw0kHiSj.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-vdqwUjbw.js";
import { o as getTailnetHostname } from "./tailscale-CYyfWpFz.js";
import { t as isContainerEnvironment } from "./container-environment-BDEE_m0v.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-Cb8sEJNr.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, g as resolveRequestClientIp, h as resolveHostName, i as isLoopbackHost, l as isValidIPv4, m as resolveGatewayListenHosts, n as isLocalishHost, o as isPrivateOrLoopbackHost, p as resolveGatewayBindHost, r as isLoopbackAddress, t as defaultGatewayBindMode } from "./net-BA-PIAub.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-TWbIOZkw.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-C_D-Efrd.js";
...
import { n as isRestartEnabled } from "./commands.flags-DsT7KNsH.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-XP7CTBMn.js";
...
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-B0Hwc40C.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-CU0kvz_Z.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-Us4pz684.js";
import { Dt as validateSecretsResolveParams, J as validateExecApprovalRequestParams, M as validateConnectParams, Ot as validateSecretsResolveResult, Tt as validateRequestFrame, Xr as errorShape, Y as validateExecApprovalResolveParams, Yr as ErrorCodes, bt as validatePluginApprovalRequestParams, q as validateExecApprovalGetParams, t as formatValidationErrors, xt as validatePluginApprovalResolveParams } from "./protocol-Bj4aFpjA.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-CU0WuleM.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE$1, o as WRITE_SCOPE, r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-CGmIJmv-.js";
import "./method-scopes-rlD7_7jW.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-Bk6lUW_W.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-CDODwnH_.js";
import { l as loadAuthProfileStoreWithoutExternalProfiles } from "./store-kA9k3QAn.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DwerrEpn.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-WDuMzUkg.js";
import "./loader-BPHnZ58g.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-j8teApmQ.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-BB5JwDDz.js";
import { f as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext } from "./agent-events-CoDXyyM4.js";
...
import { n as getLoadedChannelPluginEntryById } from "./registry-loaded-g4bERNx7.js";
import { i as listChannelPlugins, n as getLoadedChannelPlugin, r as getLoadedChannelPluginOrigin, t as getChannelPlugin } from "./registry-BVxojULH.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-DgDChB_6.js";
...
import { g as getActiveEmbeddedRunCount } from "./runs-CSw2NUeT.js";
import { g as stopDiagnosticHeartbeat, h as startDiagnosticHeartbeat } from "./diagnostic-5w-8kHIX.js";
import { n as onSessionLifecycleEvent } from "./session-lifecycle-events-BMdmf5uq.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-B0a85bLc.js";
import { l as getTotalQueueSize } from "./command-queue-QKZipqu-.js";
import { t as getMachineDisplayName } from "./machine-name-B6-tlnP8.js";
import { n as detectMime } from "./mime-CkDF7kDr.js";
import { D as resolveExecApprovalRequestAllowedDecisions, E as resolveExecApprovalAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-COAWUMW4.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-B7bEM-4s.js";
import { r as cleanOldMedia } from "./store-BhTQkKvz.js";
import { a as CANVAS_HOST_PATH, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload, t as handleA2uiHttpRequest } from "./a2ui-BCO_4mZm.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-Dwl1e73V.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-Bn_K4DTL.js";
import { r as resetDirectoryCache } from "./target-resolver-Bj0tfZi1.js";
...
import { c as initSubagentRegistry } from "./subagent-registry-CFxiGQ69.js";
import { r as registerSkillsChangeListener } from "./refresh-state-zcU0w5co.js";
import "./refresh-BWgbHrnv.js";
import { l as roleScopesAllow } from "./pairing-token-3n8KZK_r.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-BfvB6T3-.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, i as recordRemoteNodeInfo, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./skills-remote-DvjKePu0.js";
import { r as resolveCronStorePath } from "./store-DcmkSoko.js";
import { i as getInspectableTaskRegistrySummary, m as stopTaskRegistryMaintenance, p as startTaskRegistryMaintenance, t as configureTaskRegistryMaintenance } from "./task-registry.maintenance-BI7laq8w.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-BEKmK4tm.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-kQdTkCHv.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CObIfQrT.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-RDCNaOyW.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CD76epHA.js";
import { a as isExecApprovalChannelRuntimeTerminalStartError } from "./approval-native-runtime-Ce7DIThq.js";
import { n as sanitizeExecApprovalDisplayText, r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-EQMyUFe2.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-OXHpq1-c.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-uwKiQWXo.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BRbYY9ps.js";
import { r as onHeartbeatEvent } from "./heartbeat-events-Bzhdfkgm.js";
import { a as resolveNodeCommandAllowlist, i as normalizeDeclaredNodeCommands } from "./node-command-policy-CkIP_Ndb.js";
import { t as safeParseJson } from "./server-json-BOsoxFRv.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-D8SwuruL.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-B53f4e4r.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-DntqIYgg.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-BwQsxwcE.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-G3BNVYLq.js";
import { t as createDefaultDeps } from "./deps-C3zffM1D.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BcdCDt9H.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-DkXsNk35.js";
import { d as logRejectedLargePayload, n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-CwoGZWf3.js";
import { _ as resolveHooksConfig } from "./hooks-CyfWf6QO.js";
import { n as loadGatewayModelCatalog, t as __resetModelCatalogCacheForTest } from "./server-model-catalog-D08-OTlb.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, r as HEALTH_REFRESH_INTERVAL_MS, s as TICK_INTERVAL_MS, t as DEDUPE_MAX } from "./server-constants-BeWL-JJN.js";
import { t as abortChatRunById } from "./chat-abort-DHtToOss.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-C5raAt9z.js";
import { t as GatewayLockError } from "./gateway-lock-BTGs1NjO.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-Cm4Tdc9b.js";
import { t as getHealthSnapshot } from "./health-BTxag8xN.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-B5uR6o1y.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-Dd4BAK9w.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-m2JipO-x.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-mqVN2y9d.js";
import { a as createToolEventRecipientRegistry, i as createSessionMessageSubscriberRegistry, n as createChatRunState, r as createSessionEventSubscriberRegistry } from "./server-chat-state-CzVVcweF.js";
import { S as roleCanSkipDeviceIdentity, f as loadVoiceWakeConfig, h as loadVoiceWakeRoutingConfig, i as upsertPresence, m as resolveSessionKeyForRun, n as listSystemPresence, s as clearNodeWakeState, t as broadcastPresenceSnapshot, u as formatError, w as pruneStaleControlPlaneBuckets, x as parseGatewayRole } from "./presence-events-CiHByO-B.js";
import { i as buildGatewayReloadPlan, t as diffConfigPaths } from "./config-reload-DMUNCjuh.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DLr-ok5d.js";
import { i as normalizeCanvasScopedUrl, n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-BuEgC9G3.js";
import { a as mergeActivationSectionsIntoRuntimeConfig, i as setFallbackGatewayContextResolver, t as loadGatewayStartupPlugins } from "./server-plugin-bootstrap-0-9G9OOk.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-6BmmFKvC.js";
import { a as getRequiredSharedGatewaySessionGeneration, d as DEFAULT_CHANNEL_CONNECT_GRACE_MS, f as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, g as enqueueConfigRecoveryNotice, h as buildGatewayCronService, i as enforceSharedGatewaySessionGenerationForConfigWrite, m as applyGatewayLaneConcurrency, n as disconnectAllSharedGatewayAuthClients, o as setCurrentSharedGatewaySessionGeneration, p as evaluateChannelHealth, r as disconnectStaleSharedGatewayAuthClients, s as activateGatewayScheduledServices, t as resolveHookClientIpConfig, u as startGatewayRuntimeServices } from "./hook-client-ip-config-Ug7kHkcd.js";
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext, n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-BLVVWkRc.js";
import "./paths-DJfQoB2p.js";
import { t as getUpdateAvailable } from "./update-startup-C-Vw4qgw.js";
import { t as hasConfiguredInternalHooks } from "./configured-IvGjrSMu.js";
import { t as truncateCloseReason } from "./close-reason-DB04k_-d.js";
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-CcPLwzY7.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-DAzHWJL6.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-B15mXSmE.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-DboO9VvN.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-Bxi4Orau.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-4kHUzjsO.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DN9NLHMP.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DMGkObTx.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CMpOszYP.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-B28BrXsY.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-W8w_fS3d.js");
	return voiceClawRealtimeUpgradeModulePromise;
}
function getCanvasAuthModule() {
	canvasAuthModulePromise ??= import("./http-auth-Q59jbznS.js");
	return canvasAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-mTmTTCaa.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DToVtdKQ.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-lQUXsA8x.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-ykTWU4X3.js");
...
function startGatewayEventSubscriptions(params) {
	...
	const getAgentEventHandler = () => {
		agentEventHandlerPromise ??= import("./server-chat-d_I6QnQl.js").then(({ createAgentEventHandler }) => createAgentEventHandler({
			broadcast: params.broadcast,
			broadcastToConnIds: params.broadcastToConnIds,
			nodeSendToSession: params.nodeSendToSession,
			agentRunSeq: params.agentRunSeq,
	...
	const getTranscriptUpdateHandler = () => {
		transcriptUpdateHandlerPromise ??= import("./server-session-events-7UkFPr3g.js").then(({ createTranscriptUpdateBroadcastHandler }) => createTranscriptUpdateBroadcastHandler({
			broadcastToConnIds: params.broadcastToConnIds,
			sessionEventSubscribers: params.sessionEventSubscribers,
	...
	const getLifecycleEventHandler = () => {
		lifecycleEventHandlerPromise ??= import("./server-session-events-7UkFPr3g.js").then(({ createLifecycleEventBroadcastHandler }) => createLifecycleEventBroadcastHandler({
			broadcastToConnIds: params.broadcastToConnIds,
			sessionEventSubscribers: params.sessionEventSubscribers
		}));
...
function scheduleGatewayMemoryBackend(params) {
	...
	const start = () => {
		import("./server-startup-memory-FEnb3F-u.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
			cfg: params.cfg,
			log: params.log
		})).catch((err) => {
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-C3hMPT24.js");
	return hasInternalHookListeners("gateway", "startup");
}
async function waitForAcpRuntimeBackendReady(params) {
	const { getAcpRuntimeBackend } = await import("./registry-CaKoCq5q.js");
...
async function prewarmConfiguredPrimaryModel(params) {
	const { resolveAgentModelPrimaryValue } = await import("./model-input-DLF5AWSx.js");
	...
	const [{ resolveOpenClawAgentDir }, { resolveAgentWorkspaceDir, resolveDefaultAgentId }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { isCliProvider, resolveConfiguredModelRef }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-BXnPVfB2.js"),
		import("./agent-scope-QKgVHvZT.js"),
		import("./defaults-BQ7-bnfY.js"),
		import("./model-selection-CC-iBYGv.js"),
	...
	const { ensureOpenClawModelsJson } = await import("./models-config-D421m4Lr.js");
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				...
				import("./session-write-lock-K0Eb2QLO.js")
			]);
			...
			for (const sessionsDir of sessionDirs) {
				...
				if (result.cleaned.length > 0) {
					const { markRestartAbortedMainSessionsFromLocks } = await import("./main-session-restart-recovery-CHNe4gZL.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-PL_pWZVv.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-BQ7-bnfY.js"),
				import("./model-catalog-ag1JFsOa.js"),
				import("./model-selection-CC-iBYGv.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-C3hMPT24.js"), import("./loader-YGb_VX6E.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-C3hMPT24.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-Biu8WxcK.js");
	...
	if (params.cfg.acp?.enabled) (async () => {
		...
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-BbjCF5JY.js"), import("./session-identifiers-WGtM6WZA.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-VdJl2X7G.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-BuE7XXjW.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-D9we1-Y0.js");
		scheduleSubagentOrphanRecovery();
	});
	await measureStartup(params.startupTrace, "sidecars.main-session-recovery", async () => {
		const { scheduleRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-CHNe4gZL.js");
		scheduleRestartAbortedMainSessionRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-BAAgKrGr.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-lu8_H7v7.js")).logGatewayStartup(params),
	refreshLatestUpdateRestartSentinel: async () => (await import("./server-restart-sentinel-BuE7XXjW.js")).refreshLatestUpdateRestartSentinel(),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-D0c26m4H.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-BAMThyHY.js")).startGatewayTailscaleExposure(...args)
};
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-D9nE2CIK.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-06Ubtzc0.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-QwIsVh8M.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-B80gPNOl.js");
	await closeMcpLoopbackServer();
}
let gatewayCloseModulePromise = null;
function loadGatewayCloseModule() {
	gatewayCloseModulePromise ??= import("./server-close-qI3h6Zvk.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-CfzdsX4q.js");
	...
	try {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-B9Yu_nVa.js"),
				import("./server-plugin-bootstrap-BWble12r.js"),
				import("./services-Biu8WxcK.js")
			]);
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-BWble12r.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-D3Ss_yEe.js");
