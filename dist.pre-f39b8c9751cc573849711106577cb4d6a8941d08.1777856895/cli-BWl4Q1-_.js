...
import { n as resolveMatrixConfigPath } from "./config-paths-BqVcEfLr.js";
import { t as updateMatrixAccountConfig } from "./config-update-IhqrrnMx.js";
import { n as matrixSetupAdapter } from "./setup-core-BsdCZZdP.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-D4ugO692.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BwpilB0K.js";
import { t as withResolvedActionClient } from "./client-CAfrDgc9.js";
import { r as resolveMatrixAuthContext } from "./config-07jpn67U.js";
import "./client-BVMORozN.js";
import "./runtime-api-B1xwY_j4.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-CtPIXeAI.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CA1M2-LQ.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-Zka8Q3qP.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CoUPDtrd.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-B83IIL1z.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-Df71Mmgt.js");
