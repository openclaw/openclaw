...
import { a as unregisterAcpRuntimeBackend, r as registerAcpRuntimeBackend } from "./registry-D8e4nAfk.js";
import "./text-runtime-CFBwIeh_.js";
import "./error-runtime-D_Qslcoe.js";
import { s as formatPluginConfigIssue } from "./extension-shared-c-v8UC0e.js";
...
async function resolveInstalledAcpPackageBinPath(packageName, binName) {
	try {
		...
		const manifest = JSON.parse(await fs$1.readFile(packageJsonPath, "utf8"));
...
async function prepareIsolatedCodexHome(baseDir) {
	...
	await fs$1.writeFile(path.join(codexHome, "config.toml"), "# Generated by OpenClaw for Codex ACP sessions.\n", "utf8");
	return codexHome;
}
...
function loadRuntimeModule() {
	runtimeModulePromise ??= import("./runtime-BWb93tYg.js");
