...
import { u as isPrivateIpAddress } from "./ssrf-hMo3P7lU.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-GUXpg_az.js";
import "./ssrf-runtime-Bozc6A2_.js";
import { t as getMSTeamsRuntime } from "./runtime-api-CzxkRQdW.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-CzeYAyeY.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-DyJ4-l69.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DfEdNCpE.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DTuOaHmb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-Csui46Eb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
