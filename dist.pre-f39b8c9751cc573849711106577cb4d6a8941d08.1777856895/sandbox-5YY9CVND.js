...
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-D4pXK3zL.js";
import { i as getRuntimeConfig } from "./io-DJ0qH7nz.js";
import "./config-BxdAfCU3.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, y as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-Bzi1u1Mi.js";
import { n as isToolAllowed } from "./tool-policy-RsOmKSsU.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-hQPEfx75.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-B-1IxU2s.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-CE_ex45Q.js";
import { f as isSameSsrFPolicy } from "./ssrf-hMo3P7lU.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-DjKatMfT.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-CfD6DdQR.js";
import { C as removeRegistryEntry, E as computeSandboxBrowserConfigHash, S as removeBrowserRegistryEntry, T as updateRegistry, _ as resolveSandboxScopeKey, a as execDocker, b as readBrowserRegistry, c as isDockerDaemonUnavailable, d as readDockerNetworkDriver, f as readDockerNetworkGateway, g as resolveSandboxAgentId, h as appendWorkspaceMountArgs, l as readDockerContainerEnvVar, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxWorkspaceDir, w as updateBrowserRegistry, x as readRegistry, y as slugifySessionKey } from "./docker-0kIGteSQ.js";
import { a as splitSandboxBindSpec, i as resolveSandboxHostPathViaExistingAncestor, n as validateNetworkMode } from "./validate-sandbox-security-BM7q1B2A.js";
import { C as buildPinnedAppendPlan, D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedMkdirpPlan, y as normalizeContainerPath } from "./browser-bridges-v2PpuH4N.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-DYiUka2K.js"),
				import("./exec-defaults-D_6yRh9-.js"),
				import("./skills-DFa1YpQR.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-Dsl2jp73.js")).maybePruneSandboxes(cfg);
