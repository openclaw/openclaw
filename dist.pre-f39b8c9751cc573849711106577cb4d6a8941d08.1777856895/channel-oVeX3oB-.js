...
import { l as createScopedDmSecurityResolver, u as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-DAD0c7H8.js";
...
import { n as resolveInboundDirectDmAccessWithRuntime, t as createPreCryptoDirectDmAuthorizer } from "./direct-dm-access-CbXVhnpZ.js";
import { t as createDirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-DSWMpqvL.js";
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-c-v8UC0e.js";
import { t as attachChannelToResult } from "./channel-send-result-Dm1suRln.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-CnlkoU_K.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes$1, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-BRn5Rb42.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-S7b7KdP_.js");
