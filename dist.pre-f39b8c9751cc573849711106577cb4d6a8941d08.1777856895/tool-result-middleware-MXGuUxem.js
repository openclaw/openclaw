...
import { a as resolvePluginControlPlaneFingerprint } from "./plugin-metadata-snapshot-CcH6lCHZ.js";
import { r as normalizeProviderId } from "./provider-id-dd60CFPS.js";
import { t as createSubsystemLogger } from "./subsystem-CgTF-J8V.js";
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-7IfUFCM-.js";
import "./model-selection-DqTgZ6sy.js";
import { n as isGoogleModelApi, t as isGemma4ModelRequiringReasoningStrip } from "./google-CpBx9Jzo.js";
import { t as log$1 } from "./logger-U0HIdILh.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-yPXLOOoM.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BkJ_WvDG.js");
