...
import { c as parseThreadSessionSuffix } from "./session-key-utils-Dnbck33i.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-Dmz-NJqC.js";
import { a as createActionGate, f as readNumberParam, g as readStringParam, n as ToolAuthorizationError } from "./common-O8axt5-B.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-DAD0c7H8.js";
import { n as describeAccountSnapshot } from "./account-helpers-CZufvFy_.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-ngWNyrdr.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-DJOjUZtD.js";
import "./channel-core-zFYC7MML.js";
import "./routing-mgXN0NdW.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-B2y9ydxC.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-C-zSpkxA.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-Cle2_iRP.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-CrR7NJDE.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-CQAMfMKv.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-UfwPeD2I.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Bt2mvr5s.js";
import { t as extractToolSend } from "./tool-send-D45UOfF5.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-BiEbriT0.js";
import "./approval-delivery-runtime-CyHvP3zm.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-CD76epHA.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-DtcwSZeT.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-rD1BmUS5.js";
import "./approval-native-runtime-DhugDjvI.js";
import "./outbound-runtime-B8ijXNfq.js";
...
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-D-DvOZSf.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-1ttWi-vP.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-D_lycAmT.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DweLlUGC.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BqUwiwKD.js";
import { n as normalizeMatrixUserId } from "./allowlist-BxHYSZPX.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-DljLfESz.js";
...
import { t as formatMatrixErrorMessage } from "./errors-CsHQrGhh.js";
import { n as matrixConfigAdapter, t as MatrixConfigSchema } from "./config-schema-vVS7YN22.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-De0p1Thk.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-cT8ooGFg.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CUqjASGA.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-Dp7xD7NA.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-Drp1QwJx.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-U3Vy3SlR.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-GRfGtHAQ.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-cX54A1FS.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BQJDFkmv.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-Ds7PclHm.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-Ds7PclHm.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-B2daAb5e.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
