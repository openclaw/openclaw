...
import { T as validateConfigObjectWithPlugins, k as migrateLegacySecretRefEnvMarkers, z as resolveNormalizedProviderModelMaxTokens } from "./io-DJ0qH7nz.js";
import { n as formatConfigIssueLines } from "./issue-format-CIl7cU3M.js";
import { r as normalizeTalkSection } from "./talk-Cp-0hhv1.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-CLIYaHBU.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-Cz-tF5PY.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-Dzt8ZpBy.js";
import { n as getLoadedChannelPlugin } from "./registry-BVxojULH.js";
import { i as listRouteBindings } from "./bindings-av58ftQa.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DErHRtSD.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-m0a57oiY.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-CY-pVmdN.js";
import { t as note } from "./note-CZdKFNS6.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-BwyYllKL.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, n as LEGACY_CONFIG_MIGRATIONS, o as loadBundledChannelDoctorContractApi, r as migrateLegacyWebSearchConfig, s as applyPluginDoctorCompatibilityMigrations } from "./legacy-config-issues-BtioiwJY.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-Bz6lp7by.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-Dbo0oRlE.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-C5B-XhpB.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BNV5Png3.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-XBJ4_BLY.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-VQJCseQy.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CMCdND02.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CNHpxcZb.js");
		emitDoctorNotes({
			note,
