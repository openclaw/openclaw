...
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-Dnbck33i.js";
import { n as normalizeAccountId } from "./account-id-fkYplFFW.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CTLAw4n4.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-CzfWAE9r.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-DJ0qH7nz.js";
import { t as isWindowsDrivePath } from "./archive-path-o3TBzHA8.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-CSAZtaEC.js";
import { t as applyMergePatch } from "./merge-patch-DYl-hh68.js";
import { g as selectApplicableRuntimeConfig } from "./runtime-snapshot-BbDqBMPM.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-LHRBn9J1.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CoDXyyM4.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CJq5T6t4.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-oaTdaZI8.js";
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-CPVa0fsE.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BVxojULH.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BSlyB7AP.js";
...
import { a as extractDeliveryInfo } from "./sessions-hf7PWp-q.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-7IfUFCM-.js";
import { S as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, x as modelKey } from "./model-selection-shared-HUsqLCFt.js";
...
import { r as getApiKeyForModel } from "./model-auth-GPbTx0dF.js";
...
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-DpikmHBB.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-DzADw2sc.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-D59mRZNQ.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-CvFQ7deQ.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-Ct3Hnzq-.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, i as normalizeToolName, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, n as expandToolGroups, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Vdojn8h0.js";
...
import { a as imageMimeFromFormat, n as detectMime } from "./mime-CkDF7kDr.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-RXiJ2TY4.js";
import { D as textToSpeech } from "./tts-runtime-BYfYsVJk.js";
import "./tts-B8iX9KQ8.js";
import { a as getImageMetadata } from "./image-ops-BVbYALwV.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BUo2E8V0.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-DAz6vE9P.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-DFFAwqNi.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BNJCyu6x.js";
import { t as SsrFBlockedError } from "./ssrf-hMo3P7lU.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-CTyHn3i6.js";
...
import { n as runWithImageModelFallback } from "./model-fallback-eL2z2dsH.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DYNGTENL.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-O8axt5-B.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-C9XWmH6g.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-QN-0PWli.js";
import { n as assertSandboxPath } from "./sandbox-paths-DjKatMfT.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-DLqKSG4V.js";
...
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-B7bEM-4s.js";
import "./delivery-context-CNTx8wAg.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-219VYdNw.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-Cf0CbwCc.js";
import { r as resolveMaxDelegatesPerTurn } from "./config-5i0YqEIQ.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-cA5uBg4A.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-IiW6Trte.js";
...
import { i as formatDoctorNonInteractiveHint, l as removeRestartSentinelFile, n as buildRestartSuccessContinuation, p as writeRestartSentinel } from "./restart-sentinel-DdN9gk2U.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-C_vYl5VI.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-Dheo_I_w.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-Co8RoFva.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-xwzUNfOk.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-0Ofq5ksI.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-p2MVOP9Y.js";
import { l as saveMediaBuffer } from "./store-BhTQkKvz.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-D-i9NlRo.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-6Qsb4tBS.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-4pHybGyD.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CEz4W5oP.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BBIxTOw4.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-DZhJ4PSV.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-tlBJsPrf.js";
import { s as resolveTimeoutMs } from "./resolve--g7QIJpK.js";
import { t as buildProviderRegistry } from "./runner-DE9PkFIN.js";
...
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-DU4_aBq8.js";
import { t as sendMessage } from "./message-9KyzROks.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-gRwwFagm.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-BsBTdpgE.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-D3YxAxXH.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime--EaiLk_4.js";
import "./task-registry-delivery-runtime-D5Soszev.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DmmfJqqR.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-D5BRVuCY.js";
...
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-DE8hqH2v.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DgO4NUu8.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CNldp-06.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-CQdt0o6e.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-B2jo08Zk.js";
import { p as registerSubagentRun } from "./subagent-registry-CFxiGQ69.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DeEJart0.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-CknjTDSA.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-8jHFeu3D.js";
...
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-KNapChot.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-BXoddHp-.js";
...
import { i as runWebSearch } from "./runtime-BkQ_jjxG.js";
import "./web-search-provider-common-CG5da0nC.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-lyNoQnFa.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-DpmPf-r3.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-CRJbbS3m.js"));
