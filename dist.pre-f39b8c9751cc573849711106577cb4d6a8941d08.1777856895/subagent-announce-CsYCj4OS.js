...
import { i as isCronSessionKey } from "./session-key-utils-Dnbck33i.js";
...
import { h as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive } from "./runs-CSw2NUeT.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-DJ3sCDR5.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-Dao2HVOa.js";
import "./delivery-context-CNTx8wAg.js";
import { n as resolveContinuationRuntimeConfig } from "./config-5i0YqEIQ.js";
import { i as consumePendingDelegates } from "./delegate-store-cA5uBg4A.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DmmfJqqR.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-D5BRVuCY.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-B2jo08Zk.js";
import "./continuation-delegate-store-BlU9S5zR.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-C0X8E76w.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-Bevwox5x.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-BrWvNxO7.js");
			const { createSubsystemLogger } = await import("./subsystem-DxO_-M1k.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-BtSt8qib.js");
				requestHeartbeatNow({
