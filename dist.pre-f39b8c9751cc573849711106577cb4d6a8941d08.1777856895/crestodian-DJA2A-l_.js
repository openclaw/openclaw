...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-CfsahVVT.js";
import { r as resolveCrestodianOperation } from "./dialogue-COPqV5P9.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BUffwgIB.js")).runCrestodianTui;
	opts.onReady?.();
