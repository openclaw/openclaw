...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-BUj4xgiy.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-CkDF7kDr.js";
...
import { a as getDefaultMediaLocalRoots } from "./local-roots-CUkd8RXw.js";
import { n as MediaFetchError, r as fetchRemoteMedia } from "./fetch-Dq0yQNGS.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-C0xoy3M7.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-DZhJ4PSV.js";
import { t as providerSupportsCapability } from "./provider-supports-v90nTFsB.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve--g7QIJpK.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-B53RYavY.js";
import { t as buildRandomTempFilePath } from "./temp-download-CZV0dXz0.js";
import "./temp-path-DITRKDIS.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-CsmZYmel.js";
import "./shared-CiGprYoi.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-ag1JFsOa.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-CSk7Gn-G.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-CLGSjyGR.js");
