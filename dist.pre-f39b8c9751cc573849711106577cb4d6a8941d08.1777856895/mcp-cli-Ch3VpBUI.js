...
import { i as extractFirstTextBlock } from "./chat-message-content-Cga1Sfvg.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-oRNWRtOW.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-BjhQazak.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-BgPIM4vx.js"),
			import("./client-cQNYdmEq.js"),
			import("./client-start-readiness-_8DazZNR.js"),
			import("./method-scopes-BfG-3M6w.js"),
			import("./client-info-DaBjNEY1.js")
		]);
