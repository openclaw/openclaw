...
import { u as prepareScopedSetupConfig } from "./setup-helpers-Bdc21zG9.js";
import "./setup-CTJ3OOzC.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DweLlUGC.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-BqUwiwKD.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Dp7xD7NA.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-Df71Mmgt.js");
