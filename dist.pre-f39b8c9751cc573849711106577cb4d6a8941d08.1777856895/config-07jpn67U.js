...
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-fkYplFFW.js";
import { n as retryAsync } from "./retry-ByJlaaOT.js";
import "./error-runtime-D_Qslcoe.js";
import { t as requireRuntimeConfig } from "./plugin-config-runtime-Cw3yGmqP.js";
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-GUXpg_az.js";
import "./ssrf-runtime-Bozc6A2_.js";
import "./retry-runtime-BPt2WLA2.js";
import "./secret-input-runtime-BTG3Jsny.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-D_lycAmT.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BVZ8ZgZM.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DweLlUGC.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-Bj9OiuPv.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BqVcEfLr.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-Ceo2-own.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-Csc_NDUr.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-Bc0XQL9c.js"), import("./logging-DSQKHeHb.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-DsZZTXnS.js").then((credentialsReadModule) => ({
