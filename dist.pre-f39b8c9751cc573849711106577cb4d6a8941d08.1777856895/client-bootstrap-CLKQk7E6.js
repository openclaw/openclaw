...
import { t as getActiveMatrixClient } from "./active-client-8SZ3vyjE.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DKIBe9Dd.js"), import("./shared-sEebu1rF.js")]).then(([clientModule, sharedModule]) => ({
