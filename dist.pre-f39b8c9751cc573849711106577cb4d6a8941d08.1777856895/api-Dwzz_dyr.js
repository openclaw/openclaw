...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-GUXpg_az.js";
import "./ssrf-runtime-Bozc6A2_.js";
import "./runtime-api-Dv0AXhnI.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-4r0h5Imh.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-BPmk2aFN.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
			return {
