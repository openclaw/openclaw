...
import { d as resolveConfigDir, p as resolveUserPath } from "./utils-CCskKJVV.js";
import { s as normalizeStringEntries } from "./string-normalization-rJ4BOsjW.js";
import { r as normalizeChatChannelId } from "./ids-DUzZX4p8.js";
import { n as normalizeAccountId } from "./account-id-fkYplFFW.js";
import { T as validateConfigObjectWithPlugins } from "./io-DJ0qH7nz.js";
import { s as setCanonicalDmAllowFrom } from "./dm-access-CahNNzSG.js";
import { a as readChannelAllowFromStore } from "./pairing-store-DFgmKCqc.js";
import { a as collectChannelDoctorRepairMutations, s as createChannelDoctorEmptyAllowlistPolicyHooks } from "./channel-doctor-CkYkFXrR.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-C-A8qsCO.js";
import { t as asObjectRecord } from "./object-BahxEJYN.js";
import { n as maybeRepairOpenPolicyAllowFrom, r as resolveAllowFromMode } from "./open-policy-allowfrom-Bj6y20xw.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-iPrn9e8F.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-BVlEeyAC.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-YAaN7NnK.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-DCNZtl5z.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-CYCJxwy6.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-BtHAW7B6.js";
...
async function cleanupLegacyPluginDependencyState(params) {
	...
	const changes = [];
	const warnings = [];
	for (const target of await collectLegacyPluginDependencyTargets(env, { packageRoot: params.packageRoot })) {
...
async function runDoctorRepairSequence(params) {
	...
	if (missingConfiguredPluginInstallRepair.changes.length > 0) changeNotes.push(sanitizeLines(missingConfiguredPluginInstallRepair.changes));
