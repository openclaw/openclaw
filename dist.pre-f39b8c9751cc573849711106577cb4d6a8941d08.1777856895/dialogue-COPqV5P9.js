import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-5UC2bYOM.js";
import { r as loadCrestodianOverview } from "./overview-CfsahVVT.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-BsFl90Jw.js")).planCrestodianCommand)({
		input,
		overview
	});
