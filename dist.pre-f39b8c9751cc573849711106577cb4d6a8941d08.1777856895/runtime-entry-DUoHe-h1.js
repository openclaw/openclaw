...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-CXAa0Cdn.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, h as parseRealtimeVoiceAgentConsultArgs, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-WZKkWO1r.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-B1VSJ5ic.js";
...
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-DqDVEDlH.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-7yqz7X8N.js";
import { t as resolveVoiceResponseModel } from "./response-model-BshvwcyV.js";
import { t as isProviderStatusTerminal } from "./call-status-DMTAIgwG.js";
import { t as getHeader } from "./http-headers-BtopGG47.js";
...
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-BeeRifBM.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-CAZx_UKe.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-YTBqiV0z.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-Q5tQPEQZ.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-CThgwtGU.js");
...
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-DByemvjF.js");
