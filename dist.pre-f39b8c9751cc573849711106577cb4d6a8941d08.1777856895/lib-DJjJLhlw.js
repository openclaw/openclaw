...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-EZCBsso4.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-W0VReODV.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DuqcgMQp.js";
import { l as toRatio, n as decodeString } from "./Util-DMuOd3HM.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-ky5moywB.js";
import { t as APEv2Parser } from "./APEv2Parser-YDbvh4qJ.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CjAVcHiQ.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-Bzyg6beA.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DLZWLSyp.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-v4mxmMY3.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser--6qwCtKE.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CaZgcAqe.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Bvrt4DIT.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-B0DmO-F3.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-F-WcoxjV.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-COBnpN8w.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BTU4THP6.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Rp8Ddqzn.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-B0TQuuxG.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DnoMYIdz.js")).WaveParser;
	}
};
//#endregion
