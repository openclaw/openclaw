...
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "./webhook-request-guards-CXAa0Cdn.js";
import { t as normalizeWebhookPath } from "./webhook-path-DOiDitxK.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-DCbxM9jo.js";
import "./security-runtime-BLjjn6ez.js";
import "./string-coerce-runtime-B-12iPWS.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-CSbKOI0M.js";
import { t as getBlueBubblesRuntime } from "./runtime-BeLOQ6Tz.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-BrCPsCZA.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-CFWy4rgH.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-B-MrgQzo.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-D_djw3IX.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
