...
import { g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-DJ0qH7nz.js";
import { n as formatConfigIssueLines } from "./issue-format-CIl7cU3M.js";
import { t as note } from "./note-CZdKFNS6.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-BwyYllKL.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BtioiwJY.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DKe1hOq-.js");
