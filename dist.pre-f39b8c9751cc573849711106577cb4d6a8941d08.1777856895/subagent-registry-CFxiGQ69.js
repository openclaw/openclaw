...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-CoDXyyM4.js";
...
import { r as configureSubagentRegistrySpawnRuntime, t as emitSessionLifecycleEvent } from "./session-lifecycle-events-BMdmf5uq.js";
import { i as callGateway } from "./call-Bo0kEGD9.js";
import { A as SUBAGENT_TARGET_KIND_SUBAGENT, C as resolveSubagentSessionStatus, D as SUBAGENT_ENDED_REASON_COMPLETE, E as SUBAGENT_ENDED_OUTCOME_TIMEOUT, O as SUBAGENT_ENDED_REASON_ERROR, S as getSubagentSessionStartedAt, T as SUBAGENT_ENDED_OUTCOME_KILLED, a as countActiveDescendantRunsFromRuns, c as countPendingDescendantRunsFromRuns, d as listDescendantRunsForRequesterFromRuns, f as listRunsForControllerFromRuns, j as subagentRuns, k as SUBAGENT_ENDED_REASON_KILLED, l as getSubagentRunByChildSessionKeyFromRuns, n as persistSubagentRunsToDisk, o as countActiveRunsForSessionFromRuns, r as restoreSubagentRunsFromDisk, t as getSubagentRunsSnapshotForRead, w as SUBAGENT_ENDED_OUTCOME_ERROR, x as getSubagentSessionRuntimeMs, y as isStaleUnendedSubagentRun } from "./subagent-registry-state-DEZ6z64I.js";
import { a as isSilentReplyText } from "./tokens-Dao2HVOa.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-CrJSBjtp.js";
import "./pi-bundle-mcp-tools-BGpYmlIy.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-DzUTaVq1.js";
import { c as setDetachedTaskDeliveryStatusByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime--EaiLk_4.js";
import "./subagent-announce-queue-DTAIZaS_.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-CQdt0o6e.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-B2jo08Zk.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-UjCZht2V.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BPMe8Rdp.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-CsYCj4OS.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-BPMe8Rdp.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-2LoxMdTA.js").then(({ scheduleOrphanRecovery }) => {
