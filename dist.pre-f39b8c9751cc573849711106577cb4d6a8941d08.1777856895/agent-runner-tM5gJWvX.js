...
import { a as freezeDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-IHDWx_7D.js";
import { i as isDiagnosticsEnabled, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-Cxscc9Dh.js";
...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-CzfWAE9r.js";
...
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-B0Hwc40C.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-BjCWnlv2.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-CoDXyyM4.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-CJq5T6t4.js";
...
import { b as resolveGroupSessionKey, o as updateSessionStore, p as resolveSessionStoreEntry, s as updateSessionStoreEntry } from "./store-C0WV070A.js";
import "./sessions-hf7PWp-q.js";
import { a as resolveContextTokensForModel } from "./context-krMZP6XB.js";
import { g as resolveResponseUsageMode, h as normalizeVerboseLevel } from "./thinking-BUnhRQfd.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-HUsqLCFt.js";
...
import { _ as ReplyRunAlreadyActiveError, l as queueEmbeddedPiMessage, v as createReplyOperation, y as replyRunRegistry } from "./runs-CSw2NUeT.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-DpikmHBB.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-ynZM9tuJ.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-DInOj93q.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CCItx9bC.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-C8OOPiUY.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-IRoFYnES.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-QKZipqu-.js";
import { a as resolveCliRuntimeExecutionProvider, t as isCliRuntimeAlias } from "./model-runtime-aliases-DErHRtSD.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-Dao2HVOa.js";
import { c as stripHeartbeatToken } from "./heartbeat-C0n-SWz4.js";
import { o as isAudioFileName } from "./mime-CkDF7kDr.js";
import { d as isLikelyExecutionAckPrompt } from "./selection-GVWmwsw9.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-CDzci2Db.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-BYDB72hl.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-DEYYRlWS.js";
...
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-DCZMZQLY.js";
import { d as parseReplyDirectives } from "./deliver-Df2ttLb0.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-DzIzmJMz.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-eL2z2dsH.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-DJVw9xqK.js";
import { i as estimateMessagesTokens } from "./compaction-9RgCg-8V.js";
import { n as resolveContinuationRuntimeConfig } from "./config-5i0YqEIQ.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-cA5uBg4A.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-BdtlkwAh.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-drdq0XLk.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BX1QBARe.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-CwvHqCrf.js";
import { a as enqueueSystemEvent } from "./system-events-Djz7KlwF.js";
import { n as hasCotFramePrefix } from "./normalize-reply-CvJVUSgg.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DsVgG4b9.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-C4p6Cck9.js";
import "./sandbox-5YY9CVND.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-mz3aqRri.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CuOVxO5X.js";
import { r as enqueueCommitmentExtraction } from "./runtime-DdEPwEjE.js";
import { i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, o as emitContinuationWorkFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-BwWpxyXe.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-BlU9S5zR.js";
import { t as checkContextPressure } from "./context-pressure-BdBIUYrq.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-BzKPO7sN.js";
import { t as formatProviderModelRef } from "./model-runtime-Du65r88e.js";
import { t as runCliAgent } from "./cli-runner-Cn1NjHvq.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BXcnlEFV.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DzgVkdyo.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-CYHXxP1F.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-DZGASho7.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-BJQ4Zskr.js";
import { n as incrementCompactionCount } from "./session-updates-WQ2gNOij.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-DcmkSoko.js";
import { n as dispatchPostCompactionDelegates, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-BvRQqG9-.js";
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-DijUBULN.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-BQ7DuIrC.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-YWArPz52.js"),
					import("./config-BXnMIsY7.js"),
					import("./state-C0X8E76w.js"),
					import("./store-DBMaRSjR.js")
				]);
