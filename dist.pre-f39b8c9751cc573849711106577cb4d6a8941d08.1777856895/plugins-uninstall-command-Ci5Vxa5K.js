...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-B19Xdk1_.js";
import { n as defaultRuntime } from "./runtime-Dv8n03pi.js";
import { u as readConfigFileSnapshot } from "./io-DJ0qH7nz.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-CzC3LyTr.js");
	const { buildPluginSnapshotReport } = await import("./status-CI_ZhTti.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-D5iPWQL9.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-LTz8rYow.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-BqpWyz-V.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-C3nhCNBA.js");
	const { promptYesNo } = await import("./prompt-eQFpdaHe.js");
