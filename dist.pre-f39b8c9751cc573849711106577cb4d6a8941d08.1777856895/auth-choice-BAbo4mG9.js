...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-GPbTx0dF.js";
import { r as loadModelCatalog } from "./model-catalog-BJ0-BpCv.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-CLx1XLI9.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-BY664c6j.js";
import "./provider-auth-choice-preference-BnedCX3W.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-Dul2KojF.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-IWm-k5iA.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-D2I9cENe.js");
