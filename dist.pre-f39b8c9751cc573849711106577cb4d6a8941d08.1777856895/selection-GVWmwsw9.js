...
import { a as freezeDiagnosticTraceContext, i as formatDiagnosticTraceparent, r as createDiagnosticTraceContextFromActiveScope, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-IHDWx_7D.js";
...
import { g as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-CzfWAE9r.js";
import { Q as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-DJ0qH7nz.js";
import "./defaults-DNihGLJv.js";
import "./config-BxdAfCU3.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-C0UODYFe.js";
...
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-rw2VIOPg.js";
import { t as resolveAgentRuntimePolicy } from "./agent-runtime-policy-DdtTRuVv.js";
import { S as listRegisteredAgentHarnesses } from "./loader-BPHnZ58g.js";
import { D as listRegisteredPluginAgentPromptGuidance } from "./types-DKtGzgHs.js";
import { c as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-j8teApmQ.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BB5JwDDz.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-CoDXyyM4.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-Cga1Sfvg.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-Cj3_3mBL.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-7IfUFCM-.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-h_knWqVv.js";
...
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-CSw2NUeT.js";
...
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-DInOj93q.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-B8FFA-Q5.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-C8OOPiUY.js";
import { t as isCliRuntimeAlias } from "./model-runtime-aliases-DErHRtSD.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-Dao2HVOa.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-D8Jk4dbU.js";
import { C as isEmbeddedMode, S as stripProviderPrefix, x as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-Bj_kRWhg.js";
...
import { m as MAX_IMAGE_BYTES } from "./mime-CkDF7kDr.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-B2essgzW.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-77Mi9w2y.js";
...
import { t as resolveOsSummary } from "./os-summary-FOYwYvU8.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-u9fOx7jT.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-B3gh8c_4.js";
import { n as toTrajectoryToolDefinitions, r as getQueuedFileWriter, t as createTrajectoryRuntimeRecorder } from "./runtime-uNW0uj83.js";
...
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-CDzci2Db.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CE_ex45Q.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-x1hUV64J.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DEYYRlWS.js";
import { a as isMessagingToolDuplicateNormalized, c as downgradeOpenAIFunctionCallReasoningPairs, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, o as normalizeTextForComparison, t as validateAnthropicTurns } from "./pi-embedded-helpers-BTvKbJ6F.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-DcZS3Co9.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BUo2E8V0.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolHints } from "./channel-tools-DFFAwqNi.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-2uFYejRM.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-Cq99uKrg.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DCZMZQLY.js";
...
import { n as hasCommittedMessagingToolDeliveryEvidence, r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-BtGumuc5.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-eL2z2dsH.js";
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-DYNGTENL.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-9RgCg-8V.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BDCABwYO.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-8DT0zxc1.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-Dw1LgS9u.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-CzOISLA2.js";
...
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-BUphityl.js";
...
import "./tool-loop-detection-ATi3NpbD.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-BGzoIsk9.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CSQMtQXR.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-DQikkFHB.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-BNj2Isjd.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt--xdJEfr-.js";
...
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-CgxdzVMi.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-BkR-1qTL.js";
...
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as shouldUseOpenAIWebSocketTransportForAttempt, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-CdnpHc5y.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-DQbKXDj-.js";
import { t as detectAndLoadPromptImages } from "./images-B96NQDrj.js";
import { i as resolveRuntimeContextPromptParts, r as queueRuntimeContextForNextTurn, t as buildRuntimeContextSystemContext } from "./runtime-context-prompt-Bw17grjC.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-DKsmp5Jv.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-BAAgKrGr.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-BKpAtrYp.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-DkwghmpW.js"));
