...
import "./accounts-DLo7Us9k.js";
import "./runtime-api-wchwlj6-.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-D1ifEL49.js";
import { t as sendMessageZalo } from "./send-8BsmSkFW.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-1SNDL_bt.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CSw4dx32.js");
