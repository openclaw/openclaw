...
import { h as loggingState } from "./logger-CbfAwt-Z.js";
...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-D56_kmX7.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CLO3Ra4D.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-Dieyyqfj.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BlobV7an.js");
	if (params.argv) {
