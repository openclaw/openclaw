...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-Bk6lUW_W.js";
import { g as getActiveEmbeddedRunCount, n as abortEmbeddedPiRun } from "./runs-CSw2NUeT.js";
import { o as resetModelCatalogCache } from "./model-catalog-BJ0-BpCv.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-B7bEM-4s.js";
import { r as resetDirectoryCache } from "./target-resolver-Bj0tfZi1.js";
import { i as getInspectableTaskRegistrySummary, n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-BI7laq8w.js";
...
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-D08-OTlb.js";
import { r as startGatewayConfigReloader } from "./config-reload-DMUNCjuh.js";
import { c as startGatewayChannelHealthMonitor, g as enqueueConfigRecoveryNotice, h as buildGatewayCronService, l as startGatewayCronWithLogging, m as applyGatewayLaneConcurrency, o as setCurrentSharedGatewaySessionGeneration, r as disconnectStaleSharedGatewayAuthClients, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Ug7kHkcd.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-CgHAFoHs.js"), import("./gmail-watcher-lifecycle-PL_pWZVv.js")]);
