...
import { t as InstallRecordShape } from "./zod-schema.installs-BTTy8dt-.js";
import { t as parseDurationMs } from "./parse-duration-BN0AM1mL.js";
import { a as AgentSandboxSchema, c as MemorySearchSchema, d as AgentModelSchema, i as AgentRuntimePolicySchema, n as AgentEmbeddedHarnessSchema, o as ElevatedAllowFromSchema, r as AgentEntrySchema, s as HeartbeatSchema, t as AgentContextLimitsSchema, u as ToolsSchema } from "./zod-schema.agent-runtime-BCC1nYgp.js";
import { C as SecretInputSchema, E as SecretsConfigSchema, L as createAllowDenyChannelRulesSchema, P as TypingModeSchema, _ as NativeCommandsSettingSchema, c as GroupChatSchema, d as HumanDelaySchema, g as ModelsConfigSchema, i as ContextVisibilityModeSchema, j as TtsConfigSchema, k as TranscribeAudioSchema, l as GroupPolicySchema, n as BlockStreamingCoalesceSchema, p as InboundDebounceSchema, r as CliBackendSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, y as QueueSchema } from "./zod-schema.core-CPi3jzrG.js";
import { t as sensitive } from "./zod-schema.sensitive-vJZn1Y0L.js";
import { t as collectBundledChannelConfigs } from "./bundled-channel-config-metadata-C5ZfJyZy.js";
import { l as ChannelHeartbeatVisibilitySchema } from "./zod-schema.providers-whatsapp-BGYiCmAE.js";
...
function getDirectChannelRuntimeSchema(channelId, registry) {
	const record = registry.plugins.find((plugin) => plugin.origin === "bundled" && plugin.channels.includes(channelId));
	if (!record) return;
