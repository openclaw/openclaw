import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-BXa0Ww1F.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-CVmqAfsu.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-Cg-Bl4Jq.js";
import { r as readModelListResult } from "./models-EJZgigTH.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-sMnHR-Er.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
