...
import { t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-BVd2RwYd.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-Dnbck33i.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-fkYplFFW.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CTLAw4n4.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-D4pXK3zL.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-CzfWAE9r.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-DJ0qH7nz.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-CSAZtaEC.js";
...
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-Cp-0hhv1.js";
...
import { o as gatewayStartupUnavailableDetails } from "./client-XP7CTBMn.js";
...
import { h as patchPluginSessionExtension } from "./loader-BPHnZ58g.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BrTWJxMr.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-DjsWUfDD.js";
...
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-CShVH53_.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-CoDXyyM4.js";
import { d as isPluginJsonValue } from "./host-hook-runtime-DiP9En9h.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-Ba7XoDmR.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BOAhDWo8.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-CJq5T6t4.js";
...
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BVxojULH.js";
...
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-hf7PWp-q.js";
...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-E0P-GaIt.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-Dxsp8o8C.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-BUnhRQfd.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-BBVMiIqq.js";
import "./auth-profiles-CTRxy_8C.js";
import { t as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-yomk1YD5.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-CSw2NUeT.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-b1fOHPVh.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BsdPwSIH.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-BxcPc7cB.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-CRxLZt9G.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-D59mRZNQ.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-DzUwPYyq.js";
...
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Vdojn8h0.js";
import { i as resolveSandboxConfigForAgent } from "./config-hQPEfx75.js";
import { t as extractToolPayload } from "./tool-payload-MVxg45mO.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-CgjGcGJp.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-Bj_kRWhg.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-RXiJ2TY4.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-StObOulh.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-BYfYsVJk.js";
import "./tts-B8iX9KQ8.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-CE_ex45Q.js";
import { a as isTimeoutError } from "./failover-error-BQkZNf2j.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-Df2ttLb0.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-COAWUMW4.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-B7bEM-4s.js";
import { i as parseAbsoluteTimeMs } from "./stagger-BtoiOMLh.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-CddisblC.js";
import { i as formatDoctorNonInteractiveHint, p as writeRestartSentinel } from "./restart-sentinel-DdN9gk2U.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-1EKED5OO.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-DU4_aBq8.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-C_FRranG.js";
...
import "./target-resolver-Bj0tfZi1.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-Ckcxscqb.js";
import { i as resolveReplyToMode } from "./reply-threading-drdq0XLk.js";
...
import { l as setHeartbeatsEnabled } from "./heartbeat-wake-CwvHqCrf.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-Djz7KlwF.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime--EaiLk_4.js";
import { n as resolveAgentIdentity } from "./identity-lKkG3jFv.js";
import { s as clearSessionQueues } from "./queue-C4p6Cck9.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CIhame1J.js";
...
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-BfvB6T3-.js";
...
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-ctW1glrB.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-BQGvU2fF.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-4bttyFjm.js";
import "./commands-registry-Bm3jh0xy.js";
import { n as resolveSendPolicy } from "./send-policy-IWnExD1I.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-BCoApLcG.js";
import { t as getChannelActivity } from "./channel-activity-2mNrAZrc.js";
...
import { t as movePathToTrash } from "./browser-trash-BVzB0OFD.js";
import "./browser-maintenance-CJ8zdiO5.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Bzhdfkgm.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-C3vqEf5P.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-DAFIUsii.js";
...
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BFwQHESd.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-lD2JIRfO.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CJBHotW2.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BKsT4omo.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-BwQsxwcE.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-WZKkWO1r.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-BtSd2l5R.js";
import { n as createOutboundSendDeps } from "./deps-C3zffM1D.js";
import "./agent-fvC4PLKS.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BcdCDt9H.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DkXsNk35.js";
...
import "./server-constants-BeWL-JJN.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-BT-QgEGx.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-DHtToOss.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CtVPHSJO.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-faT4XCvt.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-RZW9xFZV.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-CyouiCKz.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-B3OvA23R.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-CTzxO6-3.js";
import { a as performGatewaySessionReset } from "./session-reset-service-0d31pG4d.js";
import { t as buildChannelUiCatalog } from "./catalog-DctSGam3.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-D7Ev9UN3.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CRJTfIE8.js";
import { t as readConfiguredLogTail } from "./log-tail-AKFAjVdi.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CkmHdR5V.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-CUoekS2W.js";
import { t as buildChannelAccountSnapshot } from "./status-CxdtqoX_.js";
import { t as installSkill } from "./skills-install-CYXDMHWO.js";
import { m as normalizeUpdateChannel } from "./update-check-D-kMUcFd.js";
import { n as readPackageVersion } from "./package-json-LsV_6k58.js";
import { t as getStatusSummary } from "./status.summary-CiEzSN12.js";
import "./status-znXN36AM.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-DiKL2PJ7.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-DplMnfq9.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-DCZdfnAC.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-tEBueewS.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BEN-LcvU.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-mqVN2y9d.js";
import { C as consumeControlPlaneWriteBudget, _ as resolveVoiceWakeRouteByTrigger, a as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, b as isRoleAuthorizedForMethod, c as nodeWakeById, d as normalizeVoiceWakeTriggers, f as loadVoiceWakeConfig, g as normalizeVoiceWakeRoutingConfig, h as loadVoiceWakeRoutingConfig, l as nodeWakeNudgeById, m as resolveSessionKeyForRun, n as listSystemPresence, o as NODE_WAKE_RECONNECT_WAIT_MS, p as setVoiceWakeTriggers, r as updateSystemPresence, t as broadcastPresenceSnapshot, u as formatError$1, v as setVoiceWakeRoutingConfig, x as parseGatewayRole, y as validateVoiceWakeRoutingConfigInput } from "./presence-events-CiHByO-B.js";
import { i as buildGatewayReloadPlan, n as resolveGatewayReloadSettings, t as diffConfigPaths } from "./config-reload-DMUNCjuh.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DLr-ok5d.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-BuEgC9G3.js";
import "./heartbeat-runner-C9plSES7.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-tDdLRRYR.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-CcyFsh-D.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-Dm5UjYta.js");
