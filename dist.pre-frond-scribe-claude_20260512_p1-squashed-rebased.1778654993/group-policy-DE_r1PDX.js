...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-B13bfVQo.js";
import "./client-CWBBGMIQ.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-DnGlg9zi.js";
import { s as parseIMessageTarget } from "./targets-B-aakSgq.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-BGlMi-cr.js";
import "./probe-DUMAAtAM.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-CJ-efbdb.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-m8EKgXCJ.js");
