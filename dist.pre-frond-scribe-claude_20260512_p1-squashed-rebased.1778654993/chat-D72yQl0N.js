...
import { b as assertNoWindowsNetworkPath, w as safeFileURLToPath } from "./fs-safe-DKdSS9ZL.js";
import { r as openLocalFileSafely } from "./secure-temp-dir-DP1EBfnW.js";
import { o as parseAgentSessionKey } from "./session-key-utils-bmH32UOR.js";
import { o as resolveAgentWorkspaceDir } from "./agent-scope-config-Du7CC6LK.js";
import { p as resolveSessionAgentId } from "./agent-scope-q0THteOR.js";
import { l as measureDiagnosticsTimelineSpan, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-CLU4J6Ex.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-D90Mj6ey.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DJXAFDBX.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-HzKd5Jx-.js";
import { r as setSafeTimeout } from "./timer-delay-T4ckBiWL.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-C4iANhUL.js";
import { s as normalizeInputProvenance } from "./input-provenance-CT12gp5q.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-DPQmWKJu.js";
import "./method-scopes-CR-ZOZ-i.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Bot_zBB8.js";
import "./local-file-access-5WBL-AS9.js";
import { i as resolveSessionFilePath } from "./paths-B3IZXng3.js";
import "./sessions-CaK_EJUM.js";
import { o as isAudioFileName } from "./mime-CjtIvQCF.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-h5b0CIgV.js";
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-Bn47vYZw.js";
import { C as jsonUtf8Bytes, h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes } from "./session-utils.fs-CIDIR5tX.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-Cz53KOhR.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-BMexUtaa.js";
import { n as resolveSendPolicy } from "./send-policy--uL8-xOA.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-rqEpnBqp.js";
import { s as normalizeReplyPayloadsForDelivery } from "./deliver-CVchSGaL.js";
import { d as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-DQiqvCKj.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-CMDlTGZ-.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-DRoVT-K7.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-3wylHOsh.js";
import { r as getSessionBindingService } from "./session-binding-service-DGeCl3cy.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BvXKASTh.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-kfl2MPcK.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-CQXm0DJ0.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-DT3T7fyx.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-Cfv0JGnG.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-DB5GLJpE.js";
...
import { t as formatForLog } from "./ws-log-DP7FQRe3.js";
import "./channel-message-C3RkR_ru.js";
import { t as logLargePayload } from "./diagnostic-payload-BpnSQOTv.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-xOSOyjue.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-D_Pax9qK.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-Cw_pG2lF.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-Bxr8XBFd.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-Cu6rDn7p.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CHaUVEH2.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-BqrJq5vG.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-B322YRV6.js";
...
function shouldPreserveDisplayMediaUrl(mediaUrl) {
