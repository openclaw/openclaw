...
import { i as setPathExistingStrict } from "./path-utils-LiJRt4a_.js";
import { n as discoverConfigSecretTargets } from "./target-registry-BOTA66S4.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-D39r-SPY.js";
import { n as formatConfigIssueLines } from "./issue-format-yh3srOrh.js";
import { r as normalizeTalkSection } from "./talk-0_UhPUKM.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-B8wLDOq0.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-D3Aqdu5J.js";
import { n as getLoadedChannelPlugin } from "./registry-CkSYsHAS2.js";
import { i as listRouteBindings } from "./bindings-BXxGfRPi.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DP8zuckx.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-BZYiSKvA.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-qLTyelN0.js";
import { t as note } from "./note-BqU1IO3P.js";
import { t as asObjectRecord } from "./object-BluhegsB.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CgFqBNg6.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-uRUxhHb8.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-1FWd_MQd.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BsMHiPuQ.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-PDVTMC_W.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-BmNAPonq.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DGTfQ9gT.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-CoGE8ui8.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DCLzK_rH.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-B7BsJ9qk.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DDJ7xsbi.js");
		emitDoctorNotes({
			note,
