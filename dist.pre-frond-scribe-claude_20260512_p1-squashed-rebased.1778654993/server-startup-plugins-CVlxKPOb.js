...
import { I as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-DyYwRtfT.js";
import { c as initSubagentRegistry } from "./subagent-registry-BLGisQn8.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-B6zPTBIk.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-YkJ6Yvki.js";
import { n as listGatewayMethods } from "./server-methods-list-BO3hciey.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-qht5u7Sz.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-CscPzDcJ.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-CCwD_BWI.js");
