import { n as getFsSafeLockConfig, t as createSidecarLockManager } from "./sidecar-lock-BlXjYbBU.js";
import { i as isPathInside, p as FsSafeError, u as resolveSafeRelativePath } from "./path-Bv_HaZDb.js";
import { f as createSyncDirectoryGuard, l as assertSyncDirectoryGuard$1 } from "./write-queue-BOD4ekDx.js";
import { a as resolveOpenedFileRealPathForHandle, o as root, s as getFsSafeTestHooks, t as resolveSecureTempRoot } from "./secure-temp-dir-DP1EBfnW.js";
...
import { o as writeSecretFileAtomic } from "./secret-file-wDy6AUxS.js";
...
function ensureParentSync(params) {
	...
	if (relative.startsWith("..") || path.isAbsolute(relative)) throw new FsSafeError("outside-workspace", "file path escapes store root");
