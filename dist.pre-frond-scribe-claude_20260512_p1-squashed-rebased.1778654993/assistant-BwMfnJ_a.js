...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-BsVOQ5BU.js";
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-DM70l1Pt.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-ixBKotk8.js")).runEmbeddedPiAgent;
}
