...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-0GsiwJ5t.js";
...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-CBhBKNla.js";
import "./ssrf-runtime-DeVcz7VH.js";
import "./retry-runtime-kyHXbEeR.js";
import "./secret-input-runtime-Ck7PFCXr.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-Bi9EjoBP.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-Dq-LqnhK.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-E5zu0_D1.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CENuLzic.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BN89iuuf.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CMg1uaJF.js"), import("./logging-CvBeyYVk.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-NRaHpF80.js").then((credentialsReadModule) => ({
