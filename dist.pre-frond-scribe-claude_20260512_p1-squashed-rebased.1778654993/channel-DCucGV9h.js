...
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-Cf18EYJ9.js";
...
import { c as normalizeInteractiveReply, l as normalizeMessagePresentation } from "./payload-Do3ge4kp.js";
import { t as readBooleanParam } from "./boolean-param-D-oJV5bC.js";
import { n as resolveOutboundSendDep } from "./send-deps-Ddh0XfCI.js";
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-BmQQzD3f.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-B2ZbJLiD.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-Dxr9afWD.js";
import "./string-coerce-runtime-Eud5uIH2.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-DJqj23Pm.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BY4oP6ej.js";
...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-qrLj8SK8.js";
...
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-D9c-uphY.js";
...
import { i as createAttachedChannelResultAdapter } from "./channel-send-result-CwmevcEc.js";
import "./param-readers-CSXsIFrT.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-Bw7jvbuJ.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-Bwukc7R8.js";
import { a as resolveSlackExecApprovalTarget, n as isSlackExecApprovalAuthorizedSender, o as shouldHandleSlackExecApprovalRequest, r as isSlackExecApprovalClientEnabled, s as shouldSuppressLocalSlackExecApprovalPrompt, t as getSlackExecApprovalApprovers } from "./exec-approvals-BbZmOg0g.js";
import { t as isSlackApprovalAuthorizedSender } from "./approval-auth-Cat8iopL.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-c8Tpltfh.js";
import { n as resolveSlackThreadTsValue, r as SLACK_TEXT_LIMIT, t as normalizeSlackThreadTsCandidate } from "./thread-ts-BadtnDre.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-CqDavW9F.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-BDaC1KnZ.js";
import "./channel-api-81sXyxeA.js";
import { r as createSlackWebClient } from "./client-DEknJ8nQ.js";
import { r as normalizeAllowListLower } from "./allow-list-BLHKJkZm.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-D4udoQCI.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-BM06YQFi.js";
import { t as getOptionalSlackRuntime } from "./runtime-B9fyJvYU.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-C2Q5R1jg.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-C4PQaydy.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-lehGpo0I.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-MJbI0hMT.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-D9t4oLy7.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-DQYpOQHV.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BGGwxaU-.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-DbgZg1sI.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-8TaIPNaK.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-CnUYsKoE.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-B9lfwrhE.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-BuaWuh2y.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-DN7qej4q.js");
