...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-BzNzF2n0.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-B_qH_1MT.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-Dy6A2G2r.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-D0T19Xdn.js");
	if (params.argv) {
