...
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-m6hv_8K5.js";
import { o as normalizeChannelId } from "./registry-BonjjDpb.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-B8wLDOq0.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CkSYsHAS2.js";
import "./plugins-J90h611X.js";
import "./logging-CVyWyl3G.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-C-aMG_-N.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-GptId3py.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BDbgzl55.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CIcTlEPx.js";
...
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BQBA9nLv.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-BxjFp4AE.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-NpWYbi_2.js";
import { n as resolveLogFile } from "./log-tail-DXUieyXh.js";
import { t as parseLogLine } from "./parse-log-line-BFUSnttw.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-BytaAUQn.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-C5lbMQ-u.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-BHYo_F75.js";
import { t as channelsListCommand } from "./list-wFucIpAB.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-CFkkv1JR.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-DKVpYK-R.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-Cb21uQSc.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-DSc_bf_n.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-CkSEBcCa.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-CmPi0vUn.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-DvDkwB3X.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DgSY5ahP.js");
