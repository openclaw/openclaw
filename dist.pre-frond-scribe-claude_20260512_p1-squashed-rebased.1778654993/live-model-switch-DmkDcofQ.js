...
import { i as normalizeStoredOverrideModel, s as resolveDefaultModelForAgent, u as resolvePersistedSelectedModelRef } from "./model-selection-OBfqg2ku.js";
...
async function ensureSelectedAgentHarnessPlugin(params) {
	...
	const { ensurePluginRegistryLoaded } = await import("./runtime-registry-loader-eRmvQPhT.js");
