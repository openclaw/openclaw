import { o as resolveConfigPath, u as resolveGatewayPort } from "./paths-Cnwfh6dH.js";
...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-Du7CC6LK.js";
import { n as resolveAgentEffectiveModelPrimary } from "./agent-scope-q0THteOR.js";
import { u as readConfigFileSnapshot } from "./io-D39r-SPY.js";
import "./config-2mokfqk4.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-DWsxFytx.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-CcrSa5XS.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
