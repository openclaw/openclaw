...
import { O as sanitizeUntrustedFileName } from "./fs-safe-DKdSS9ZL.js";
import { o as root } from "./secure-temp-dir-DP1EBfnW.js";
import { g as shortenHomePath, p as resolveUserPath, s as ensureDir } from "./utils-CRkrr5e6.js";
...
import { a as asRecord } from "./record-coerce-BuxRKQTs.js";
import { n as detectMime } from "./mime-CjtIvQCF.js";
import { t as resolveNodeFromNodeList } from "./node-resolve-DIIqrH5G.js";
...
import { a as CANVAS_HOST_PATH, c as isA2uiPath, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload } from "./a2ui-DwONmMvy.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-6c_QxvVD.js");
