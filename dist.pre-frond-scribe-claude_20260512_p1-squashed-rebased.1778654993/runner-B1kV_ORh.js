...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-BEdjDbP7.js";
import "./local-file-access-5WBL-AS9.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-CjtIvQCF.js";
...
import { t as providerSupportsCapability } from "./provider-supports-DXr1sKlY.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-C5oK3U-k.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-DZD63v6s.js";
import { t as buildRandomTempFilePath } from "./temp-download-DYm6Dm14.js";
import "./temp-path-CwQ04ToL.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-D1VCFhGa.js";
import "./shared-BmfsfC5_.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-DyEtPafU.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-1NjtL__u.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-Bi-zeZ6Y.js");
