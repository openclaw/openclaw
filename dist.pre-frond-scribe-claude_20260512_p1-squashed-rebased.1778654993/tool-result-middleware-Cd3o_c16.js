...
import { a as resolvePluginControlPlaneFingerprint } from "./plugin-metadata-snapshot-CLU4J6Ex.js";
import { t as createSubsystemLogger } from "./subsystem-DT3cKML_.js";
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-XII5ljKL.js";
import "./model-selection-OBfqg2ku.js";
import { u as isGoogleModelApi } from "./pi-embedded-helpers-BCXdh6eu.js";
import { t as log$1 } from "./logger-DWmi6KYD.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-Bukkx1JT.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BLFSpy0u.js");
