...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-rqEpnBqp.js";
...
import { m as DiscordError } from "./discord-b4LsQHRR.js";
import { t as chunkDiscordTextWithMode } from "./chunk-zvHdc12R.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-CLnDmQWp.js";
import { t as createDiscordSendReceipt } from "./send.receipt-CmLqbPpN.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-D9W6QJu1.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-CLLILRd3.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-DUycBOKS.js");
