...
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-HzKd5Jx-.js";
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-C7vbwXJD.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-J90h611X.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-D_XnSsNw.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-CRAszIxP.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-Dw7MkjFh.js";
import { l as roleScopesAllow } from "./pairing-token-DmdsFprM.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-BXUfPdxk.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-Ci5VIUH9.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CZqxgaRy.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-Opeiu0A9.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-GMJpUn1q.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-CfsG9TFg.js";
import { t as diffConfigPaths } from "./config-diff-lEVKTzxj.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CyPhvi7W.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-f05FkJMZ.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-DwUUqJ5H.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-BXesD9nA.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-5SRtt3KB.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
