...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-B3gf6RRT.js";
...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-7cOk3nCp.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-sub2tqnp.js";
import "./subagent-announce-queue-1S_cHf-r.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-D8O00tQC.js";
import { d as withSubagentOutcomeTiming, f as importRuntimeModule, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-Cinurd9x.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-BXFRWQi8.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Dx7AMpf4.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-EhONuevP.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Dx7AMpf4.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-DPL3gwTN.js").then(({ scheduleOrphanRecovery }) => {
