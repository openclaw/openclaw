...
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DvnpjHQG.js";
import { n as VERSION } from "./version-BHBlW4Qb.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-BbJ1pyLE.js";
...
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-Ddbf_v84.js";
import { a as logWarn } from "./logger-DN3suabW.js";
import { i as getRuntimeConfig } from "./io-D39r-SPY.js";
import { b as resolveExecutableFromPathEnv, d as resolveApprovalAuditCandidatePath, p as resolveCommandResolutionFromArgv } from "./exec-safe-bin-trust-CDkFvkpm.js";
import { D as normalizeExecutableToken, O as splitShellArgs, _ as extractEnvAssignmentKeysFromDispatchWrappers, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, h as resolveInlineCommandMatch, l as isShellWrapperInvocation, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, x as unwrapKnownDispatchWrapperInvocation } from "./shell-wrapper-resolution-DZ592zGM.js";
import "./config-2mokfqk4.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-m6hv_8K5.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-BHhYpIKr.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-DQg_YY59.js";
import { t as parsePort } from "./parse-port-8z1pr9Q4.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-D5jXjhss.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-CHINfPpv.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CIC4AUII.js";
import { a as getActivePluginRegistry } from "./runtime-DyYwRtfT.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-DMbP9JRQ.js";
import { t as getMachineDisplayName } from "./machine-name-dExUOD3B.js";
import { c as describeInterpreterInlineEval } from "./risks-Co-rCf4A.js";
import { c as analyzeArgvCommand, d as buildSafeBinsShellCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-C-0VfdCi.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CKOMt1Re.js";
import { N as saveExecApprovals, O as resolveExecApprovals, P as requestJsonlSocket, T as requiresExecApproval, b as readExecApprovalsSnapshot, c as hasDurableExecApproval, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, o as addDurableCommandApproval, s as ensureExecApprovals, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-D_XnSsNw.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D-fMhdXw.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-D6FEhhgq.js";
import { t as formatHelpExamples } from "./help-format-DfuYG68F.js";
import { n as detectPolicyInlineEval } from "./policy-DLsBR34V.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-C2M_N_eo.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-BqmvRp64.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-eRmvQPhT.js");
