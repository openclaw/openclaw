import { o as onDiagnosticEvent } from "./diagnostic-events-QP40Y1ku.js";
...
function assignContinuationQueueSummary(record, event) {
	if (!("continuationQueue" in event) || !event.continuationQueue) return;
	...
	record.continuationQueue = {
		...
		...event.continuationQueue.drainRatePerMinute !== void 0 ? { drainRatePerMinute: event.continuationQueue.drainRatePerMinute } : {}
	};
}
