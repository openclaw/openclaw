...
import { n as openUrl } from "./browser-open-FAdO9fZS.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-Bds5AQ6m.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CX9IfksV.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CSggq1lp.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-blezKyYW.js");
		...
		if (codexInstall.installed) {
			const { offerPostInstallMigrations } = await import("./setup.post-install-migration-3eVD2JxB.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-2Ygq2OQ-.js") };
