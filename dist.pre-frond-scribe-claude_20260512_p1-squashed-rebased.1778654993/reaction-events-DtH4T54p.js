...
import "./session-binding-runtime-gCThzEBN.js";
import { a as resolveMatrixAccountConfig } from "./account-config-E5zu0_D1.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-BCp3wC37.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-CCd6TbUy.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-D3-78b_p.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-DmMGyJQC.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-Lb032IDl.js");
