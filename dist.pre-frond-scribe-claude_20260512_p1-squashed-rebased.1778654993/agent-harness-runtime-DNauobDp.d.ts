...
import { A as MemoryCitationsMode } from "./types.tools-CYAgVUUp.js";
import { n as EmbeddedRunTrigger } from "./params-BSELFVTT.js";
import { i as DiagnosticTraceContext } from "./diagnostic-trace-context-C1ReWeJV.js";
import { n as FailoverReason, t as EmbeddedContextFile } from "./types-CHIGFCDr.js";
import { t as WorkspaceBootstrapFile } from "./workspace-BnXwbsdU.js";
import { a as AssembleResult, c as ContextEngine, d as ContextEnginePromptCacheInfo, f as ContextEngineRuntimeContext, y as TranscriptRewriteResult } from "./registry-B3cqGUBQ.js";
import { Dr as OpenClawAgentToolResult, Sr as AgentToolResultMiddlewareEvent, _i as NormalizedUsage, bi as BuildAgentRuntimePlanParams, br as AgentToolResultMiddleware, gi as EmbeddedRunAttemptResult, hi as EmbeddedRunAttemptParams, ir as CodexAppServerExtensionFactory, or as CodexAppServerToolResultEvent, qn as ProviderRuntimeModel, rr as CodexAppServerExtensionContext, xr as AgentToolResultMiddlewareContext, yi as AgentRuntimePlan } from "./types-ItMBrbf4.js";
import { J as PluginHookLlmInputEvent, Y as PluginHookLlmOutputEvent, d as PluginHookBeforeAgentFinalizeEvent, u as PluginHookAgentEndEvent } from "./hook-types-CwlKbUPV.js";
import { t as SessionWriteLockAcquireTimeoutConfig } from "./sessions-Bf8ixkYH.js";
import { Go as OperatorScope } from "./index-BiA_1_q_.js";
import { t as SubsystemLogger } from "./subsystem-CVkBUUYw.js";
import { t as ProviderRuntimePluginHandle } from "./provider-hook-runtime-DKlZBt38.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BZ2XkPn1.js";
import { a as EmbeddedPiQueueMessageOptions } from "./runs-DKNreKhS.js";
