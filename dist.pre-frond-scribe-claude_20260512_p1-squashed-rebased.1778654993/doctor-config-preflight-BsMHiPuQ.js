...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-D39r-SPY.js";
import { n as formatConfigIssueLines } from "./issue-format-yh3srOrh.js";
import { t as note } from "./note-BqU1IO3P.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CgFqBNg6.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DnhweOeZ.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-EUTikFsP.js");
