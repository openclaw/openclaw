...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-BqgscKIP.js";
import { n as getActivePluginChannelRegistrySnapshotFromState } from "./runtime-channel-state-DtXAIAzr.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-CWOZnybN.js")]);
