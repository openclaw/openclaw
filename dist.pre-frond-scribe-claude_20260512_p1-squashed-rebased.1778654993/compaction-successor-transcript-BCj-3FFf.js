...
import { a as redactSensitiveText, o as redactToolDetail } from "./redact-R2-EdHUS.js";
import { i as formatErrorMessage } from "./errors-VfATXfah.js";
import { n as isAbortError } from "./unhandled-rejections-BKIyIiWA.js";
import { r as openRootFile } from "./root-file-lqGTwlnZ.js";
import { x as isPlainObject } from "./utils-CRkrr5e6.js";
...
import { n as replaceFileAtomic } from "./replace-file-CPhhiRlN.js";
import { t as createSubsystemLogger } from "./subsystem-DT3cKML_.js";
import { n as logError, t as logDebug } from "./logger-DN3suabW.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-q2a3Ic6o.js";
import { t as parseDurationMs } from "./parse-duration-P1Kg1gzS.js";
import { t as resolveAccountEntry } from "./account-lookup-urFQXkMR.js";
import { a as normalizeAnyChannelId } from "./registry-BonjjDpb.js";
import { a as hasInterSessionUserProvenance, i as applyInputProvenanceToUserMessage, r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-CT12gp5q.js";
import { S as getCompactionProvider } from "./loader-DieBnSI-.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Bot_zBB8.js";
import { S as createExpiringMapCache, T as resolveCacheTtlMs, w as isCacheEnabled } from "./store-load-B202ZRGn.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-h5b0CIgV.js";
import { A as resolveProviderReasoningOutputModeWithPlugin, E as resolveProviderCacheTtlEligibility, U as sanitizeProviderReplayHistoryWithPlugin, q as validateProviderReplayTurnsWithPlugin } from "./provider-runtime-XII5ljKL.js";
import { t as sanitizeForConsole } from "./console-sanitize-CPABptKw.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CTmveUgN.js";
import { a as makeZeroUsageSnapshot, o as normalizeUsage } from "./usage-CZQrMKAY.js";
import { S as firstEnumerableOwnKeys, w as jsonUtf8BytesOrInfinity, x as boundedJsonUtf8Bytes } from "./session-utils.fs-CIDIR5tX.js";
import { d as stripRuntimeContextCustomMessages } from "./internal-runtime-context-n9kAgyh9.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-uAUhli7F.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-4JO_uNsM.js";
import { i as normalizeToolName } from "./tool-policy-shared-C87JPsbp.js";
import "./tool-policy-Bmp2N959.js";
import { a as isSilentReplyText } from "./tokens-BMZyVX0z.js";
import { u as stripHeartbeatToken } from "./heartbeat-CaYzhkB_.js";
import { c as downgradeOpenAIFunctionCallReasoningPairs, g as sanitizeGoogleTurnOrdering, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns } from "./pi-embedded-helpers-BCXdh6eu.js";
import { n as extractToolResultId, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-BBh0Mmb4.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-DPPUz314.js";
import { a as isTimeoutError } from "./failover-error-DZwiRgyR.js";
import { _ as resolveChannelPromptCapabilities, c as isToolWrappedWithBeforeToolCallHook, l as runBeforeToolCallHook, r as buildBlockedToolResult, s as isBeforeToolCallBlockedError } from "./pi-tools.before-tool-call-C3tWEqLF.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-Cd3o_c16.js";
import "./logger-DWmi6KYD.js";
import { a as pruneHistoryForContextShare, h as formatContextLimitTruncationNotice, i as estimateMessagesTokens, m as truncateToolResultMessage, n as SUMMARIZATION_OVERHEAD_TOKENS, o as resolveContextWindowTokens$1, r as computeAdaptiveChunkRatio, s as summarizeInStages, u as resolveLiveToolResultMaxChars } from "./compaction-Cb-nfw8n.js";
import { a as resolveEffectiveCompactionMode } from "./pi-settings-DWDEMrP4.js";
import { f as payloadTextResult, l as jsonResult } from "./common-BOm6KbbL.js";
import { r as wrapUntrustedPromptDataBlock } from "./sanitize-for-prompt-BcJwuFXc.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-DYFr2oii.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-D-XpjEou.js";
import { s as buildCopilotIdeHeaders } from "./provider-auth-C46UBVw-.js";
import { b as buildCopilotDynamicHeaders, x as hasCopilotVisionInput } from "./openai-transport-stream-Cs4hYkLx.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-6p1t2A6p.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-CQXm0DJ0.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-xT-qxNf7.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Y4lc-NK-.js";
import "./skills-CMmz7lUg.js";
import { t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-no_X5hBW.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./proxy-stream-wrappers-DA9pMygS.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-CdpPyHro.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-CtcfwJM1.js";
import { t as extractSections } from "./post-compaction-context-Bce-BEVV.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-DHrjNqrR.js";
import "./query-Ct-IAeF9.js";
import { t as estimateStringChars } from "./cjk-chars-BV3g4MIQ.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-Bz7W4itr.js";
...
async function resolveModelAuth(ctx, model) {
	...
	const headers = model.provider === "github-copilot" ? {
...
//#endregion
export { buildEmbeddedExtensionFactories as A, repairSessionFileIfNeeded as B, createEmbeddedPiResourceLoader as C, buildEmbeddedMessageActionDiscoveryInput as D, validateReplayTurns as E, compactWithSafetyTimeout as F, findClientToolNameConflicts as G, buildUsageWithNoCost as H, resolveCompactionTimeoutMs as I, assessLastAssistantMessage as J, isClientToolNameConflictError as K, isCacheTtlEligibleProvider as L, isRealConversationMessage as M, consumeCompactionSafeguardCancelReason as N, getHistoryLimitFromSessionKey as O, setCompactionSafeguardCancelReason as P, isReasoningTagProvider as Q, readLastCacheTtlTimestamp as R, trackSessionManagerAccess as S, sanitizeSessionHistory as T, collectRuntimeChannelCapabilities as U, buildStreamErrorAssistantMessage as V, createClientToolNameConflictError as W, dropThinkingBlocks as X, dropReasoningFromHistory as Y, isZeroUsageEmptyStopAssistantTurn as Z, resolveEmbeddedAgentApiKey as _, flushPendingToolResultsAfterIdle as a, resolveEmbeddedRunSkillEntries as b, PI_RESERVED_TOOL_NAMES as c, collectRegisteredToolNames as d, toSessionToolAllowlist as f, describeEmbeddedAgentStreamStrategy as g, createSystemPromptOverride as h, dedupeDuplicateUserMessagesForCompaction as i, hasMeaningfulConversationContent as j, limitHistoryTurns as k, collectAllowedToolNames as l, buildEmbeddedSystemPrompt as m, rotateTranscriptFileAfterCompaction as n, mapThinkingLevel as o, applySystemPromptOverrideToSession as p, toClientToolDefinitions as q, shouldRotateCompactionTranscript as r, splitSdkTools as s, rotateTranscriptAfterCompaction as t, collectCoreBuiltinToolNames as u, resolveEmbeddedAgentBaseStreamFn as v, normalizeAssistantReplayContent as w, prewarmSessionFile as x, resolveEmbeddedAgentStreamFn as y, guardSessionManager as z };
