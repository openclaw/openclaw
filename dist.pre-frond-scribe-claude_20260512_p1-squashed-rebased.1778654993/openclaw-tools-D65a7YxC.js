...
import { o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-Du7CC6LK.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-q0THteOR.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-D39r-SPY.js";
import { h as isWindowsDrivePath } from "./archive-Di2NGtg3.js";
import { n as modelKey } from "./model-ref-shared-zvUQll00.js";
...
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-CHINfPpv.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-DIuE55Gx.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-CxcVaocj.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-DieBnSI-.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-B3gf6RRT.js";
import { n as assertSandboxPath } from "./sandbox-paths-9AsMzWUn.js";
import "./local-file-access-5WBL-AS9.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-C66o3Evr.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-B3IZXng3.js";
import { b as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-B202ZRGn.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-CkSYsHAS2.js";
import { n as resolveSessionConversationRef } from "./session-conversation-C_Y85yY3.js";
...
import { a as imageMimeFromFormat, n as detectMime } from "./mime-CjtIvQCF.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-XII5ljKL.js";
import { C as modelKey$1, b as resolveModelRefFromString, i as buildModelAliasIndex, w as normalizeModelRef } from "./model-selection-shared-Cg9vhmE4.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-OBfqg2ku.js";
...
import { r as getApiKeyForModel } from "./model-auth-qZxGsUoI.js";
...
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-CBUYETkA.js";
import { c as normalizeSubagentTaskName, i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-Be0jqnMd.js";
...
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-CIDIR5tX.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-BMexUtaa.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-DqoHW0gP.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-C87JPsbp.js";
import "./tool-policy-Bmp2N959.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-DYxvJVj6.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-ca8hIDEX.js";
...
import { r as stripToolMessages } from "./chat-history-text-DgyErdRW.js";
import { a as normalizeContinuationTargetKeys, r as hasCrossSessionDelegateTargeting, t as CONTINUATION_DELEGATE_FANOUT_MODES } from "./targeting-pure-Bd-K2vvh.js";
...
import { t as completionRequiresMessageToolDelivery } from "./completion-delivery-policy-6aJVHzTd.js";
import "./targeting-DzKpnqFN.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BOahxg3W.js";
...
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-DPPUz314.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-BqbXZ2AG.js";
import { a as resolvePluginTools } from "./tools-C1NRLZ5F.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-GptId3py.js";
import { c as isToolWrappedWithBeforeToolCallHook, h as listChannelSupportedActions, p as listAllChannelSupportedActions, u as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-C3tWEqLF.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-CHPrmEU8.js";
import { n as extractAssistantText } from "./pi-embedded-utils-CAm0mCkM.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DQiqvCKj.js";
import { n as runWithImageModelFallback } from "./model-fallback-BsAf7Slo.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-D8xIxGVb.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-BOm6KbbL.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-Lub3vQBa.js";
...
import "./delivery-context-BJQ3ttxS.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BDVWdAus.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-CRAszIxP.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-C0NjNbhZ.js";
...
import { t as inferLegacyName } from "./normalize-BSkmzrjy.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BRw3HTxP.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-qtRGNesz.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CYwu5CCh.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-CMt0O9IW.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-RPR4JNQC.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-B6WzU25y.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CNO8EnLf.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DYf8UQZR.js";
import { u as saveMediaBuffer } from "./store-CMDlTGZ-.js";
import { t as SsrFBlockedError } from "./ssrf-D5Rni7q6.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-CXIClzlU.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-u0Vbff-2.js";
import { r as getDefaultLocalRoots } from "./local-media-access-3wylHOsh.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BZJV8MOH.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-D06Jsb33.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-l4i__4RF.js";
...
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-D9HYZAr4.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-fF_g7Wci.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-CzGFNPpB.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BLQ9kNwD.js";
import { s as resolveTimeoutMs } from "./resolve-C5oK3U-k.js";
import { t as buildProviderRegistry } from "./runner-B1kV_ORh.js";
...
import { a as resolveAllowedMessageActions, n as runMessageAction, o as POLL_CREATION_PARAM_DEFS, s as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-DUAhtVQC.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-BmEZx4za.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-oSjg2eMG.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-sub2tqnp.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BZ6yaJZg.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-B1nRTxpQ.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-BgvXW9us.js";
import { t as parseTimeoutMs } from "./parse-timeout-TvSV1OQe.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-BwR9Sizl.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-Cxhqdzii.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-pkn5bv5z.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CncRcB2J.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-kpFmzRwM.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-3Rm_u8QG.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-D8O00tQC.js";
import { _ as isNonDeliverableSessionsReply, g as isAnnounceSkip, h as REPLY_SKIP_TOKEN, m as ANNOUNCE_SKIP_TOKEN, p as runAgentStep, v as isReplySkip } from "./subagent-session-cleanup-Cinurd9x.js";
import { p as registerSubagentRun } from "./subagent-registry-BLGisQn8.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-ucGTwmZc.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-Baoh_1e4.js";
import { k as textToSpeech } from "./tts-runtime-BJT2AK5F.js";
import "./tts-CjcCEGR4.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-BfulLwnp.js";
...
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-CVHTcb3A.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DQ-xOyKF.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-3yKBqKgE.js";
...
import { i as runWebSearch } from "./runtime-BUSJroCF.js";
import "./web-search-provider-common-CTTLaqLr.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-CcrSa5XS.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-CC0doi1b.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-BohD_tZ8.js"));
