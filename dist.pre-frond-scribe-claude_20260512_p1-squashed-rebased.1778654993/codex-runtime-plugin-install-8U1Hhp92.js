...
import { n as loadInstalledPluginIndexInstallRecords } from "./channel-catalog-registry-BJUt9H1v.js";
import "./installed-plugin-index-records-DwBg0SaS.js";
import { t as enablePluginInConfig } from "./enable-Dq0aSriX.js";
import { i as modelSelectionShouldEnsureCodexPlugin } from "./openai-codex-routing-B7r66K2q.js";
...
async function ensureCodexRuntimePluginForModelSelection(params) {
	...
	const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BU-SmRQB.js");
...
async function repairCodexRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-BDtBaHqY.js");
