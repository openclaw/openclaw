...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-Du7CC6LK.js";
import { m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks } from "./agent-scope-q0THteOR.js";
...
import { i as isMarkdownCapableMessageChannel } from "./message-channel-HzKd5Jx-.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-T4ckBiWL.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CrThufrk.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Bot_zBB8.js";
import { a as resolveContextEngineOwnerPluginId, i as resolveContextEngine } from "./registry-D4nPBln4.js";
import { s as emitAgentPlanEvent } from "./agent-events-B3gf6RRT.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-DP2ZGAAJ.js";
import { X as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-XII5ljKL.js";
import { n as sleepWithAbort } from "./backoff-CAvwS5bm.js";
import "./auth-profiles-BHzABKxY.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-CCzbktPD.js";
import { t as markAuthProfileSuccess } from "./profiles-gK7C7L6h.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-BVR6FQ3H.js";
import { t as redactIdentifier } from "./redact-identifier-BMvA7Q8J.js";
import { t as sanitizeForConsole } from "./console-sanitize-CPABptKw.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-S_7w5458.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-qZxGsUoI.js";
import "./runs-BGXUi35R.js";
import { t as ensureContextEnginesInitialized } from "./init-DqQyQkAR.js";
import { n as ensureOpenClawModelsJson } from "./models-config-DNBKtLSS.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-CZQrMKAY.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-xqNisYpM.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-CLsR8TdP.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-B3DmMvKC.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-BMZyVX0z.js";
...
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BCXdh6eu.js";
import { a as formatAssistantErrorText, b as parseImageSizeError, c as isBillingAssistantError, f as isFailoverAssistantError, h as isRateLimitAssistantError, i as extractObservedOverflowTokenCount, m as isLikelyContextOverflowError, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, y as parseImageDimensionError } from "./errors-CxCv-kMc.js";
import { s as hasOutboundReplyContent } from "./reply-payload-rqEpnBqp.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-D_y7IyZ7.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-DZwiRgyR.js";
import { C as observeReplayMetadata, S as createEmbeddedRunReplayState, _ as resolveReasoningOnlyRetryInstruction, a as formatEmbeddedRunStageSummary, b as resolveSilentToolResultReplyPayload, c as STRICT_AGENTIC_BLOCKED_TEXT, d as resolveAckExecutionFastPathInstruction, f as resolveAttemptReplayMetadata, g as resolvePlanningOnlyRetryLimit, h as resolvePlanningOnlyRetryInstruction, i as createEmbeddedRunStageTracker, l as extractPlanningOnlyPlanDetails, m as resolveIncompleteTurnPayloadText, n as runAgentHarnessAttempt, o as shouldWarnEmbeddedRunStageSummary, p as resolveEmptyResponseRetryInstruction, r as selectAgentHarness, v as resolveReplayInvalidFlag, x as shouldTreatEmptyAssistantReplyAsSilent, y as resolveRunLivenessState } from "./selection-Js_CCfYb.js";
import { T as isStrictAgenticExecutionContractActive, d as resolveToolLoopDetectionConfig } from "./openclaw-tools-D65a7YxC.js";
import "./compaction-successor-transcript-BCj-3FFf.js";
import { r as listActiveProcessSessionReferences, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-Cbcn4_cK.js";
import { c as retireSessionMcpRuntime, l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-D3gtsIzX.js";
import "./pi-bundle-mcp-tools-Dba3w0wt.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-CHPrmEU8.js";
import { d as runAgentCleanupStep } from "./attempt.tool-run-context-DfdWazUA.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-CAm0mCkM.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-CR9f2bWi.js";
...
import { p as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-DQiqvCKj.js";
import { a as suspendSession, c as resolveSessionKeyForRequest, d as shouldAllowCooldownProbeForReason, f as buildApiErrorObservationFields, i as resolveSessionSuspensionReason, l as resolveStoredSessionKeyForSessionId, u as LiveSessionModelSwitchError } from "./model-fallback-BsAf7Slo.js";
import { t as log$1 } from "./logger-DWmi6KYD.js";
import { d as sessionLikelyHasOversizedToolResults, f as truncateOversizedToolResultsInSession, u as resolveLiveToolResultMaxChars } from "./compaction-Cb-nfw8n.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-B6dfq0WL.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-UVE2on8V.js";
import "./extra-params-CdpPyHro.js";
import { t as resolveContextEngineCapabilities } from "./context-engine-capabilities-DSGXL7cK.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-CVJX0_Us.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-CtcfwJM1.js";
import { s as forgetPromptBuildDrainCacheForRun } from "./attempt.thread-helpers-6WWi0eXd.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-ogJiPgYa.js";
import { r as buildAgentRuntimePlan } from "./build-DUg4gu1R.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-COUC3PS0.js";
...
import "./compact.queued-CD4e7RP_.js";
import { n as shouldSwitchToLiveModel, r as ensureSelectedAgentHarnessPlugin, t as clearLiveModelSwitchPending } from "./live-model-switch-DmkDcofQ.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-DPwviraP.js";
...
async function handleAssistantFailover(params) {
	...
	if (decision.action === "rotate_profile") {
		...
		if (params.timedOut && !params.isProbeSession && failedProfileId) params.warn(`Profile ${failedProfileId} timed out. Trying next account...`);
...
function buildEmbeddedRunPayloads(params) {
	...
	const reasoningText = suppressAssistantArtifacts ? "" : params.lastAssistant && params.reasoningLevel === "on" && params.thinkingLevel !== "off" ? extractAssistantThinking(params.lastAssistant) : "";
	...
	const answerTexts = suppressAssistantArtifacts ? [] : (shouldUseCanonicalFinalAnswer ? [fallbackAnswerSourceText] : shouldPreferRawAnswerText && fallbackRawAnswerText ? [fallbackRawAnswerText] : hasAssistantTextPayload ? nonEmptyAssistantTexts : fallbackAnswerText ? [fallbackAnswerText] : []).filter((text) => !shouldSuppressRawErrorText(text));
