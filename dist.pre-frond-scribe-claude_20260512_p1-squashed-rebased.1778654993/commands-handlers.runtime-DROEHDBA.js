...
import { p as resolveUserPath, r as clampInt } from "./utils-CRkrr5e6.js";
...
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-DXLPTot1.js";
...
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-zibPqhwC.js";
...
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-D39r-SPY.js";
...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-B7Zymbv5.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-DCDp0VO1.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-Bs9czgu4.js";
...
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-BqLz3DkM.js";
...
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-HzKd5Jx-.js";
import { i as callGateway } from "./call-BlP6aenI.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-DIuE55Gx.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-B3IZXng3.js";
import { t as loadSessionStore } from "./store-load-B202ZRGn.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CkSYsHAS2.js";
import { s as updateSessionStore } from "./store-Dn6p-fz_.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-J90h611X.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-Bn47vYZw.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-XII5ljKL.js";
...
import "./diagnostic-iMdq7RIT.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-DhPvMBjE.js";
import { a as formatEmbeddedPiQueueFailureSummary, d as queueEmbeddedPiMessageWithOutcome, o as getActiveEmbeddedRunSnapshot, p as resolveActiveEmbeddedRunSessionId, s as isEmbeddedPiRunActive } from "./runs-BGXUi35R.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-uUhl_7HG.js";
...
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-BCXdh6eu.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-DPPUz314.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-DHhOLfHm.js";
import { r as selectAgentHarness } from "./selection-Js_CCfYb.js";
import { t as formatDurationCompact } from "./format-duration-Cs0JvQzN.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-B-Vg8gJI.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-k8gFUpJ3.js";
import { a as isCompactionSkipReason } from "./request-compaction-tool-D8xIxGVb.js";
...
import { i as resolveReplyToMode } from "./reply-threading-BNANHMe_.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-BmQQzD3f.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-oSjg2eMG.js";
import { n as routeReply } from "./route-reply-faD9MIq9.js";
...
import { a as stripToolResultDetails } from "./session-transcript-repair-6p1t2A6p.js";
import "./sandbox-kfl2MPcK.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-CgpJkUTy.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BV3g4MIQ.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-CdqBWGpS.js";
import { n as formatTimeAgo } from "./format-relative-Ds1W9wk4.js";
import { r as resolveModelWithRegistry } from "./model-BW6PP4QS.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-C7VV6X1s.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-Bys_LC5i.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-wEqhn4qz.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CTYozMx1.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-COorcLKG.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-C5mCdVnM.js";
import { t as isApprovalNotFoundError } from "./approval-errors-CK6S1pgS.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-qjmvsU_d.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-DdbxuNeO.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-CW3Cm-54.js";
import { n as parseActivationCommand } from "./group-activation-DQtVrFAV.js";
import { t as resolveFastModeState } from "./fast-mode-D-9qgOaO.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-W3x0N1jA.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-Btp_gkKV.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-C88RdXu-.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CjOvlyQ-.js";
import { t as extractBtwQuestion } from "./btw-command-B3CyoKoc.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-B4888rmW.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-DqkbvJuX.js";
import { t as handleAcpCommand } from "./commands-acp-DVkAJIye.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-CelRMT5V.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DXRor69n.js";
import { r as handleModelsCommand } from "./commands-models-81bDEVdX.js";
import { r as createExecTool } from "./bash-tools-DnFcwKli.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-CM-nFepo.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-BLl6m9tW.js";
import { t as buildToolsMessage } from "./status-DjIJpdGd.js";
...
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-CckHlPUM.js";
import "./command-export-DodQ-I9C.js";
import { t as buildStatusReply } from "./commands-status-B-XeSajp.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-C7wmp3wb.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-HlhPZgJ_.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-Cp9BUMaw.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-CEoZojgv.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-BXLKVFhA.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BQBA9nLv.js";
import "./clawhub-BP8Mwi8C.js";
import { r as installPluginFromClawHub } from "./clawhub-CyS8Rvon.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-71rzriem.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-C5KyKAXJ.js");
		killProcessTree(pid);
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-h6YmVcVM.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-CWOz3ECk.js");
...
function formatSteerQueueFailureReply(reason) {
	if (reason === "no_active_run") return "⚠️ This session no longer has an active run to steer.";
	if (reason === "not_streaming") return "⚠️ Current run is active but not accepting steering right now.";
	if (reason === "compacting") return "⚠️ Current run is compacting; retry after compaction finishes.";
...
const handleSteerCommand = async (params, allowTextCommands) => {
	...
	if (!queueOutcome.queued) {
		logVerbose(`steer: active session ${sessionId} rejected steering injection: ${formatEmbeddedPiQueueFailureSummary(queueOutcome)}`);
		return {
			shouldContinue: false,
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-Dj2lIPs_.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-DwF6YUzn.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-Cd5L_drS.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info--1L4LGir.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-BTfUOvRB.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-w7_EDt-f.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-BNiHhKEE.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-C-E-E7mW.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-BjEHmE1e.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-DJi4UpBd.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-AbF1kBR3.js"));
