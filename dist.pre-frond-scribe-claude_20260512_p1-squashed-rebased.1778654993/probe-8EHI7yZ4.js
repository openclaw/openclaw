...
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-T4ckBiWL.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-68V9900k.js";
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-DotWM0a7.js";
import { i as READ_SCOPE } from "./operator-scopes-DPQmWKJu.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-C8PWBOKx.js");
