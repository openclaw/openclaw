...
import { t as getActiveMatrixClient } from "./active-client-xV1xIRRN.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-NFJOS0bj.js"), import("./shared-bPNGZ3wO.js")]).then(([clientModule, sharedModule]) => ({
