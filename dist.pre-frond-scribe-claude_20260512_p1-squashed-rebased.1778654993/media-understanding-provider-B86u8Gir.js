import { t as validateJsonSchemaValue } from "./schema-validator-B6ZsKZfc.js";
import "./json-schema-runtime-CbHuPRJw.js";
import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-CnJt47FD.js";
import { s as resolveCodexAppServerRuntimeOptions } from "./config-Cdigy6v1.js";
import { i as assertCodexTurnStartResponse, l as readCodexTurnCompletedNotification, o as readCodexErrorNotification, r as assertCodexThreadStartResponse } from "./protocol-validators-BkAJF6F4.js";
import { r as readModelListResult } from "./models-DCsGRfZ0.js";
...
async function runBoundedCodexVisionTurn(params) {
	...
	const client = params.options.clientFactory ? await params.options.clientFactory(appServer.start, params.profile) : await import("./shared-client-DI8enB_J.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
