...
import { t as hasConfiguredModelFallbacks } from "./agent-scope-q0THteOR.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-CLU4J6Ex.js";
...
import "./defaults-q2a3Ic6o.js";
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-B7Zymbv5.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-DLRP6N1_.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-HzKd5Jx-.js";
import { o as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-B7r66K2q.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-FRBesR_s.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-B3gf6RRT.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-B3IZXng3.js";
import { t as loadSessionStore } from "./store-load-B202ZRGn.js";
import { b as resolveGroupSessionKey, c as updateSessionStoreEntry, m as resolveSessionStoreEntry, s as updateSessionStore } from "./store-Dn6p-fz_.js";
...
import { b as resolveModelRefFromString } from "./model-selection-shared-Cg9vhmE4.js";
import { t as isCliProvider } from "./model-selection-cli-CeMVbOIq.js";
import "./model-selection-OBfqg2ku.js";
import { u as resolveModelAuthMode } from "./model-auth-qZxGsUoI.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-DvmR9joq.js";
import { a as formatEmbeddedPiQueueFailureSummary, d as queueEmbeddedPiMessageWithOutcome } from "./runs-BGXUi35R.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-Be0jqnMd.js";
import { t as resolveAgentHarnessPolicy } from "./policy-rAUF-L6V.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-uUhl_7HG.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-CZQrMKAY.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-CIDIR5tX.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-D9gFGePe.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-DOAMhN_4.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-xqNisYpM.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-CLsR8TdP.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-B3DmMvKC.js";
import { r as hasCrossSessionDelegateTargeting } from "./targeting-pure-Bd-K2vvh.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-BMZyVX0z.js";
import { u as stripHeartbeatToken } from "./heartbeat-CaYzhkB_.js";
import { r as enqueueCommitmentExtraction } from "./runtime-DFgqdIKR.js";
import { c as emitContinuationWorkSpan, g as startContinuationDelegateSpan, i as emitContinuationDisabledSpan, m as resolveContinuationTraceparent, n as emitContinuationDelegateFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkFireSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-CcOePyUp.js";
import { s as requestHeartbeatNow } from "./heartbeat-wake-DjNikKcy.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-DSvyNjX7.js";
import { a as enqueueSystemEvent } from "./system-events-BMlqgK-p.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-BjY2_yTh.js";
import { n as resolveSendPolicy } from "./send-policy--uL8-xOA.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-BOahxg3W.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-BzEjlhwE.js";
import { r as resolveLiveContinuationRuntimeConfig } from "./config-BlQylcPr.js";
import { t as checkContextPressure } from "./context-pressure-D9Ev2uG9.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-BlGQqgfC.js";
import { a as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-DP8zuckx.js";
import "./pi-embedded-helpers-BCXdh6eu.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-DIFnlQS7.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-CxCv-kMc.js";
import { t as formatProviderModelRef } from "./model-runtime-GodkvdGw.js";
import "./fallback-notice-state-Djw-HmHu.js";
import { i as setReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-TsuPWbQx.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-rqEpnBqp.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-DHhOLfHm.js";
import { t as runCliAgent } from "./cli-runner-BFp1kdy8.js";
import { r as getCliSessionBinding } from "./cli-session-Dy1H5h9G.js";
import { u as isLikelyExecutionAckPrompt } from "./selection-Js_CCfYb.js";
import { h as parseReplyDirectives } from "./deliver-CVchSGaL.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-BsAf7Slo.js";
import { i as estimateMessagesTokens } from "./compaction-Cb-nfw8n.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-Cd8pAVC4.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-BNANHMe_.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-B3UZNN1P.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-DFhFNvQs.js";
import { n as hasCotFramePrefix } from "./normalize-reply-ZCjCteyc.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-faD9MIq9.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-E0sdjX1n.js";
import "./sandbox-kfl2MPcK.js";
import { n as readPostCompactionContext } from "./post-compaction-context-Bce-BEVV.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-DUg4gu1R.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CdqBWGpS.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BXMikqrG.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BE5Vx1G1.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-DT3T7fyx.js";
import { n as incrementCompactionCount } from "./session-updates-D0dfyabn.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-DXgPjcoU.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-CtFn3VgF.js";
import { n as persistRunSessionUsage, t as incrementRunCompactionCount } from "./session-run-accounting-D68aJ58t.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-DpNNTnGd.js";
import { i as dispatchPostCompactionDelegates, s as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-GaBVvGCr.js";
...
async function releaseQueuedCompactionCompletion(params) {
	...
	const { incrementRunCompactionCount } = await import("./session-run-accounting-BRPxK43B.js");
	...
	const { dispatchPostCompactionDelegates } = await import("./post-compaction-delegate-dispatch-bP0pkW_e.js");
	...
	const { emitContinuationCompactionReleasedSpan } = await import("./continuation-tracer-BnZOAhRd.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									...
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-BKXyWkkS.js");
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-ixBKotk8.js"));
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveLiveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-DjLeoMWF.js"),
					import("./config-89nrXpKu.js"),
					import("./state-BBzjWR6V.js"),
					import("./store-COtMwNh_.js")
				]);
