...
import { i as normalizeProviderIdForAuth } from "./provider-id-BvxMxU5i.js";
...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-DlzzBJu5.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-D2Ya2c1Z.js";
import { a as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-B7r66K2q.js";
import { C as modelKey, T as parseModelRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-Cg9vhmE4.js";
import "./model-selection-OBfqg2ku.js";
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-BKMgl4YB.js";
...
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-qZxGsUoI.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-B3QGREdE.js";
import { n as loadModelsConfigWithSource } from "./load-config-TmKLjYV4.js";
import { n as formatErrorWithStack } from "./list.errors-BXC1Nfat.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-Dk0SvXHD.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-YajR5Vb8.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-Bt9mNXis.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-DwRtugHK.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BAZucOkh.js"),
		import("./agent-scope-7LV8YhEs.js"),
		import("./workspace-B0vzfpa6.js")
	]);
