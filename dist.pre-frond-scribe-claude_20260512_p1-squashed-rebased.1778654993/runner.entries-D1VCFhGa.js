...
import { E as pathExists, i as writeExternalFileWithinRoot } from "./fs-safe-DKdSS9ZL.js";
...
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-BVR6FQ3H.js";
...
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-CzGFNPpB.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-C5oK3U-k.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-DzmIdgJ3.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-1NjtL__u.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-Bi-zeZ6Y.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
