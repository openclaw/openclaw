...
import { _ as waitForEmbeddedPiRunEnd, s as isEmbeddedPiRunActive } from "./runs-BGXUi35R.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-D2Ly1JBb.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-B611Hi8x.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-BMZyVX0z.js";
import { i as consumePendingDelegates } from "./delegate-store-BOahxg3W.js";
import "./continuation-delegate-store-BzEjlhwE.js";
import { n as resolveContinuationRuntimeConfig } from "./config-BlQylcPr.js";
import { a as resolveSubagentAnnounceTimeoutMs, c as resolveAnnounceOrigin, i as loadSessionEntryByKey, l as buildAnnounceIdFromChildRun, o as resolveSubagentCompletionOrigin, r as loadRequesterSessionEntry, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement, u as buildAnnounceIdempotencyKey } from "./subagent-announce-delivery-DQiqvCKj.js";
import "./delivery-context-BJQ3ttxS.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BZ6yaJZg.js";
import { a as captureSubagentCompletionReply, c as readLatestSubagentOutputWithRetry, f as importRuntimeModule, g as isAnnounceSkip, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-Cinurd9x.js";
...
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-BBzjWR6V.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-DTQ_Xrif.js");
	return subagentSpawnRuntimePromise;
}
async function listKnownSessionKeysOnHost(cfg) {
	const [{ resolveAllAgentSessionStoreTargetsSync }, { loadSessionStore }] = await Promise.all([import("./targets-DkscLc0n.js"), import("./store-load-Do0G38XP.js")]);
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (Boolean(params.continuationTargetSessionKey || params.continuationTargetSessionKeys && params.continuationTargetSessionKeys.length > 0 || params.continuationFanoutMode)) {
			const { enqueueContinuationReturnDeliveries, resolveContinuationReturnTargetSessionKeys } = await import("./targeting-CiYfcEqh.js");
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-UNQyA2rs.js");
			const { createSubsystemLogger } = await import("./subsystem-Rl1XhKhr.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-Ce8svjBN.js");
				requestHeartbeatNow({
					sessionKey: targetRequesterSessionKey,
