...
import { r as resolveCrestodianOperation } from "./dialogue-BSd5CRJK.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BUFMoBos.js")).runCrestodianTui;
	opts.onReady?.();
