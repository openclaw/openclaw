...
import { u as prepareScopedSetupConfig } from "./setup-helpers-CIcTlEPx.js";
import "./setup-DsFVj4-e.js";
import { a as resolveMatrixAccountConfig } from "./account-config-E5zu0_D1.js";
import { r as resolveDefaultMatrixAccountId } from "./accounts-DJ2BBem1.js";
import { i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-D_DzikGt.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-X4UPALHu.js";
import { n as updateMatrixAccountConfig } from "./config-update-BiX-fdpm.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-CjKXU1Ka.js");
