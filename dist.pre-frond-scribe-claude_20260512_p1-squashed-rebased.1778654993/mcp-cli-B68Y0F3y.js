...
import { r as extractFirstTextBlock } from "./chat-message-content-DP2ZGAAJ.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-BYuU-qsM.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-wsl__Q29.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-IMxal1-h.js"),
			import("./client-C9YuGCzk.js"),
			import("./client-start-readiness-q6AMPxdc.js"),
			import("./method-scopes-G_uh-yQp.js"),
			import("./client-info-CiCCKnvD.js")
		]);
