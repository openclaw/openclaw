...
import { p as normalizeThinkLevel } from "./thinking-B7Zymbv5.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-ChRTbHeU.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-DPQmWKJu.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-BlP6aenI.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-CrThufrk.js";
...
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-CjtIvQCF.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-OBfqg2ku.js";
import "./auth-profiles-BHzABKxY.js";
import { n as listProfilesForProvider } from "./profile-list-n1TD7PIF.js";
import { r as loadModelCatalog } from "./model-catalog-Ckh9dF4z.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-DTetaanQ.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-CzGFNPpB.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-BJT2AK5F.js";
import "./tts-CjcCEGR4.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BWwR-Utt.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-BUSJroCF.js";
import { t as resolveMemorySearchConfig } from "./memory-search-aAGzWFTR.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-C7VV6X1s.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-fKchSHxF.js";
...
import { t as collectOption } from "./helpers-Dv71N4N9.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-BwLvoTQu.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-CFootoOd.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Ds1wy1O-.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BywvCkLH.js");
