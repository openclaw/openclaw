...
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-Dpr-pD-p.js";
import { i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-BTrgsxzQ.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-C7c9beQI.js";
import { i as getRuntimeConfig } from "./io-D39r-SPY.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-D5jXjhss.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-D90Mj6ey.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-HzKd5Jx-.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-DotWM0a7.js";
import { t as rawDataToString } from "./ws-BrR9AW7y.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-CIcPVbs8.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-CHINfPpv.js";
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-C4iANhUL.js";
import "./version-BlPESGKY.js";
...
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-DuJJqETE.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-DhyXwi-D.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-D3ImI03i.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist } from "./node-command-policy-B0mSkL25.js";
import { n as logWs, t as formatForLog } from "./ws-log-DP7FQRe3.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-CsD4-aJt.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-GMJpUn1q.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-Bjf62Yi1.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BpnSQOTv.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-Cw_pG2lF.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-B3u067in.js";
import { r as upsertPresence } from "./system-presence-CTVcVG-k.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-CxT_f3Af.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DRrTS1Sw.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-DjHOcw7B.js";
import { t as truncateCloseReason } from "./close-reason-Du7sLvSC.js";
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-ocJ_Tzsn.js");
