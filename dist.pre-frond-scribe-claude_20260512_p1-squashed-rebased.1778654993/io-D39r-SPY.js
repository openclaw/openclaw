...
import { c as isRecord, p as resolveUserPath, x as isPlainObject } from "./utils-CRkrr5e6.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-abv6Jc9R.js";
import { i as applyConfigEnvVars } from "./state-dir-dotenv-4IyZI5EB.js";
...
import { i as replaceFileAtomicSync, n as replaceFileAtomic } from "./replace-file-CPhhiRlN.js";
import { c as planManifestModelCatalogSuppressions } from "./manifest-8uHwb2L7.js";
import { n as resolveManifestCommandAliasOwnerInRegistry } from "./manifest-command-aliases-D1uq4XIa.js";
...
import { r as hasKind } from "./slots-Dh7F6Zi7.js";
import { d as resolveMemorySlotDecision, l as resolveEffectivePluginActivationState, o as normalizePluginId, s as normalizePluginsConfig } from "./config-state-CPpdD1WJ.js";
import { c as resolveOfficialExternalPluginInstall, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-zibPqhwC.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-LqTIKV1x.js";
import { t as loadDotEnv } from "./dotenv-DHFq7YXx.js";
import { c as writePersistedInstalledPluginIndexInstallRecordsSync, i as resolveInstalledPluginIndexRecordsStorePath } from "./installed-plugin-index-records-DwBg0SaS.js";
import { t as sanitizeTerminalText } from "./safe-text-Dw_rwKEN.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-OSLFmeUO.js";
import { a as formatConfigOverwriteLogMessage, i as finalizeConfigWriteAuditRecord, n as appendConfigAuditRecordSync, r as createConfigWriteAuditRecordBase, s as snapshotConfigAuditProcessInfo, t as appendConfigAuditRecord } from "./io.audit-DDAxkkYE.js";
import { r as formatConfigIssueSummary } from "./issue-format-yh3srOrh.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-zvUQll00.js";
import { t as applyMergePatch } from "./merge-patch-43tTozsA.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-q2a3Ic6o.js";
import { v as resolveBundledProviderPolicySurface } from "./thinking-B7Zymbv5.js";
import { n as normalizeTalkConfig } from "./talk-0_UhPUKM.js";
import { T as normalizeSafeBinProfileFixtures, i as normalizeTrustedSafeBinDirs } from "./exec-safe-bin-trust-CDkFvkpm.js";
...
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath } from "./config-paths-Bs9czgu4.js";
import { d as registerRuntimeConfigWriteListener, i as getRuntimeConfigSnapshot, l as loadPinnedRuntimeConfig, n as createRuntimeConfigWriteNotification, o as getRuntimeConfigSnapshotRefreshHandler, r as finalizeRuntimeSnapshotWrite, s as getRuntimeConfigSourceSnapshot, u as notifyRuntimeConfigWriteListeners } from "./runtime-snapshot-BfgtKruQ.js";
import { n as listKnownChannelEnvVarNames } from "./channel-env-vars-CA923jOC.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-d09s-ran.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-FITtdNqJ.js";
import { n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-B6ZsKZfc.js";
import { t as resolveWebSearchInstallCatalogEntries } from "./web-search-install-catalog-6TRLfzZs.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-kZ8ScAdf.js";
import { n as collectConfiguredModelRefs } from "./model-refs-Brk2Sx4v.js";
...
function normalizeAgentDefaultModelRefsForWrite(config) {
	const defaults = getPathValue(config, ["agents", "defaults"]);
	if (!isRecord(defaults)) return config;
	let next = config;
	if (Object.prototype.hasOwnProperty.call(defaults, "model")) {
		...
		if (normalizedModel !== defaults.model) next = setPathValue(next, [
			"agents",
			"defaults",
			"model"
		], normalizedModel);
	...
	if (isRecord(defaults.models)) {
		...
		if (normalizedModels !== defaults.models) next = setPathValue(next, [
			"agents",
			"defaults",
			"models"
		], normalizedModels);
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
	if (!raw || typeof raw !== "object") return [];
	const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DVabO9u4.js");
...
//#endregion
export { applyConfigOverrides as A, resolveManagedUnsetPathsForWrite as B, validateConfigObjectRaw as C, collectPluginSchemaMetadata as D, collectChannelSchemaMetadata as E, asResolvedSourceConfig as F, maintainConfigBackups as G, shouldAttemptLastKnownGoodRecovery as H, asRuntimeConfig as I, loadShellEnvFallback as J, getShellEnvAppliedKeys as K, resolveNormalizedProviderModelMaxTokens as L, resetConfigOverrides as M, setConfigOverride as N, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as O, unsetConfigOverride as P, normalizeProviderConfigForConfigDefaults as R, validateConfigObject as S, validateConfigObjectWithPlugins as T, createInvalidConfigError as U, isPluginLocalInvalidConfigSnapshot as V, formatInvalidConfigDetails as W, shouldEnableShellEnvFallback as X, resolveShellEnvFallbackTimeoutMs as Y, resolveOwnerDisplaySetting as Z, recoverConfigFromLastKnownGood as _, loadConfig as a, writeConfigFile as b, promoteConfigSnapshotToLastKnownGood as c, readConfigFileSnapshotForWrite as d, readConfigFileSnapshotWithPluginMetadata as f, recoverConfigFromJsonRootSuffix as g, readSourceConfigSnapshotForWrite as h, getRuntimeConfig as i, getConfigOverrides as j, resolveShellEnvExpectedKeys as k, readBestEffortConfig as l, readSourceConfigSnapshot as m, clearConfigCache as n, parseConfigJson5 as o, readSourceConfigBestEffort as p, getShellPathFromLoginShell as q, createConfigIO as r, projectConfigOntoRuntimeSourceSnapshot as s, ConfigRuntimeRefreshError as t, readConfigFileSnapshot as u, registerConfigWriteListener as v, validateConfigObjectRawWithPlugins as w, collectUnsupportedSecretRefPolicyIssues as x, resolveConfigSnapshotHash as y, applyUnsetPathsForWrite as z };
