...
import { i as resolveMainSessionKey } from "./main-session-DjMvSvTs.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath } from "./paths-B3IZXng3.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-CMbEWlHU.js";
import "./sessions-CaK_EJUM.js";
import { a as resolveContextTokensForModel } from "./context-BV4ufm0E.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-Cg9vhmE4.js";
import "./model-selection-OBfqg2ku.js";
import { u as resolveModelAuthMode } from "./model-auth-qZxGsUoI.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount$1 } from "./usage-format-uUhl_7HG.js";
import { s as readRecentSessionUsageFromTranscript } from "./session-utils.fs-CIDIR5tX.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-Mnwns4vU.js";
import { d as pendingDelegateCount, p as stagedPostCompactionDelegateCount } from "./delegate-store-BOahxg3W.js";
import { n as resolveContinuationRuntimeConfig } from "./config-BlQylcPr.js";
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-DP8zuckx.js";
import { n as resolveSelectedAndActiveModel, t as formatProviderModelRef } from "./model-runtime-GodkvdGw.js";
import { t as resolveActiveFallbackState } from "./fallback-notice-state-Djw-HmHu.js";
import { n as resolveCommitHash } from "./git-commit-DfcJBhaP.js";
import { n as getVolitionalCompactionCount } from "./request-compaction-tool-D8xIxGVb.js";
import { n as findDecisionReason, s as summarizeDecisionReason } from "./runner.entries-D1VCFhGa.js";
import "./sandbox-kfl2MPcK.js";
import { y as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-DA9pMygS.js";
import { i as resolveExtraParams } from "./extra-params-CdpPyHro.js";
import { n as formatTimeAgo } from "./format-relative-Ds1W9wk4.js";
import { t as resolveAgentRuntimeLabel } from "./agent-runtime-label-BZHYqAAT.js";
import { t as resolveChannelModelOverride } from "./model-overrides-DD2P3-_m.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-DpZ85web.js";
...
*/
function formatContinuationStatusLine(args) {
	if (!(args.config?.agents?.defaults?.continuation)?.enabled || !args.sessionKey) return null;
	...
	if (chainCount === 0 && pending === 0 && staged === 0 && volitional === 0) return null;
	const parts = [`chain ${chainCount}/${maxChainLength}`];
	if (pending > 0) parts.push(`${pending} ${pending === 1 ? "delegate" : "delegates"} pending`);
...
function buildStatusMessage(args) {
	...
	const contextTokens = runtimeDiffersFromSelected ? explicitRuntimeContextTokens ?? (() => {
		...
		...contextLookupProvider ? { provider: contextLookupProvider } : {},
		model: contextLookupModel,
		contextTokensOverride: channelOverrideContextTokens ?? persistedContextTokens ?? cappedConfiguredContextTokens ?? cappedAgentContextTokens ?? explicitRuntimeContextTokens,
	...
	const runtimeAliasModelEquivalent = areRuntimeModelRefsEquivalent(selectedModelLabel, activeModelLabel);
	...
	const selectedAuthLabelValue = rawSelectedAuthLabelValue ?? (runtimeAliasModelEquivalent ? activeAuthLabelValue : void 0);
	...
	const costConfig = showCost && hasUsage ? resolveModelCostConfig({
		provider: activeProvider,
		model: activeModel,
		config: args.config,
		allowPluginNormalization: false
