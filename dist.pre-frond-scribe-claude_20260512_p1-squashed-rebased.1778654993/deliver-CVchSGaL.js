...
import { n as emitDiagnosticEvent } from "./diagnostic-events-QP40Y1ku.js";
import { t as createSubsystemLogger } from "./subsystem-DT3cKML_.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-Bot_zBB8.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-mBygzFVk.js";
import { s as resolveMirroredTranscriptText } from "./transcript-Bn47vYZw.js";
import { t as parseInlineDirectives } from "./directive-tags-Cz53KOhR.js";
import { r as isSilentReplyPayloadText } from "./tokens-BMZyVX0z.js";
import { C as createReplyToDeliveryPolicy, m as resolveSendableOutboundReplyParts } from "./reply-payload-rqEpnBqp.js";
import { r as splitMediaFromOutput } from "./parse-D1PfsVvp.js";
import { t as diagnosticErrorCategory } from "./diagnostic-error-metadata-Fgk9zk--.js";
import { a as hasReplyPayloadContent, f as renderMessagePresentationFallbackText, l as normalizeMessagePresentation, n as hasMessagePresentationBlocks, r as hasReplyChannelData, t as hasInteractiveReplyBlocks } from "./payload-Do3ge4kp.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-BT81Etxl.js";
import { n as resolveOutboundChannelMessageAdapter } from "./channel-resolution-C_sJsEfj.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, n as chunkByParagraph, s as resolveChunkMode } from "./chunk-CVo5aUOt.js";
import { t as loadChannelOutboundAdapter } from "./load-DgT-8rZH.js";
import { a as toInternalMessageSentContext, d as toPluginMessageSentEvent, l as toPluginMessageContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-DkFMOHOI.js";
import { _ as runOutboundDeliveryCommitHooks, c as enqueueDelivery, g as attachOutboundDeliveryCommitHook, m as markDeliveryPlatformSendAttemptStarted, o as withActiveDeliveryClaim, p as markDeliveryPlatformOutcomeUnknown, s as ackDelivery, u as failDelivery } from "./delivery-queue-B-m8RkMB.js";
import { c as shouldSuppressReasoningPayload, n as resolveSilentReplySettings, o as formatBtwTextForExternalDelivery, r as resolveSilentReplyRewriteText, s as isRenderablePayload } from "./silent-reply-Cd8pAVC4.js";
import { n as resolvePendingSpawnedChildren } from "./pending-spawn-query-7cOk3nCp.js";
import { n as stripInternalRuntimeScaffolding } from "./sanitize-text-lQhIA_Vn.js";
...
async function loadChannelBootstrapRuntime() {
	channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-BXD3fVo8.js");
