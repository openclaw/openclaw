...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-io3nuPDO.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-CRvU7R1n.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-BpTFKtCM.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-CfiLjIY9.js");
