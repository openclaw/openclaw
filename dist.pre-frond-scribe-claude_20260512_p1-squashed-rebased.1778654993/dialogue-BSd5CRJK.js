import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BTylOks7.js";
import { r as loadCrestodianOverview } from "./overview-DPMBr9pl.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-BwMfnJ_a.js")).planCrestodianCommand)({
		input,
		overview
	});
