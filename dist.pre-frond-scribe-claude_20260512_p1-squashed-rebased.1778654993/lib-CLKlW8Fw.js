...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DJjAtK6L.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BAq2A8LP.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-7rfvRusb.js";
import { l as toRatio, n as decodeString } from "./Util-CGNazeif.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BV8z5VW6.js";
import { t as APEv2Parser } from "./APEv2Parser-3prFsA3u.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BRw_6SEW.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-C20PIH1E.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-0kOohqyN.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DfIwPt4J.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-Clz7z76J.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BCsiCgLd.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DOC84BXn.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-Cfn8T2ol.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-bajmA3vq.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DEetZ2yB.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CHNAX8ft.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-0-kuLKSm.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-Gj0YQrHA.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BAKfDUUO.js")).WaveParser;
	}
};
//#endregion
