...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-BJUt9H1v.js";
import "./installed-plugin-index-records-DwBg0SaS.js";
import { n as formatConfigIssueLines } from "./issue-format-yh3srOrh.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-BfgtKruQ.js";
import { n as isRestartEnabled } from "./commands.flags-BqLz3DkM.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-DIuE55Gx.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-DvmR9joq.js";
import { o as resetModelCatalogCache } from "./model-catalog-Ckh9dF4z.js";
import { l as getTotalQueueSize } from "./command-queue-BjY2_yTh.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-D3gtsIzX.js";
import "./pi-bundle-mcp-tools-Dba3w0wt.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-CRAszIxP.js";
import { r as resetDirectoryCache } from "./target-resolver-DfzTta21.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-Db16Ewx2.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-DXWdUSd2.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-oUCJMbuW.js";
import { _ as resolveHooksConfig } from "./hooks-BegEHEMF.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-aIDImb_0.js";
import { n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CfsG9TFg.js";
import { t as diffConfigPaths } from "./config-diff-lEVKTzxj.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-nzS3jXvC.js";
...
import { t as buildGatewayCronService } from "./server-cron-BVx07SSN.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-pEtMyNLC.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DvfBctmN.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-CfiLjIY9.js"), import("./gmail-watcher-lifecycle-2VOy0G2L.js")]);
