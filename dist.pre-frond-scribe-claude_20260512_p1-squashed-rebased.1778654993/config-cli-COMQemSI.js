...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-BOTA66S4.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-BWBcXOig.js";
import { a as resolveSecretRefValue } from "./resolve-BtLCJamG.js";
import { n as info, o as success, t as danger } from "./globals-CsZphy1u.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-D39r-SPY.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-yh3srOrh.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-m6hv_8K5.js";
import { n as redactConfigObject } from "./redact-snapshot-BQtUAWgN.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CVO8WS61.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-CfsG9TFg.js";
import { n as setCommandJsonMode } from "./json-mode-Cvy6Xcmm.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BJt-xECf.js");
