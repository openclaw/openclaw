...
import { Y as resolveShellEnvFallbackTimeoutMs, q as getShellPathFromLoginShell } from "./io-D39r-SPY.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-CDkFvkpm.js";
import { D as normalizeExecutableToken, O as splitShellArgs, c as isShellWrapperExecutable, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-DZ592zGM.js";
import { t as killProcessTree } from "./kill-tree-XwfsqFvx.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-HzKd5Jx-.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-DPQmWKJu.js";
...
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-C87JPsbp.js";
import { d as sanitizeUserFacingText, f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText } from "./sanitize-user-facing-text-CLsR8TdP.js";
import { t as formatDurationCompact } from "./format-duration-Cs0JvQzN.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-B-Vg8gJI.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-B_Owf0D8.js";
import { o as failedTextResult, y as textResult } from "./common-BOm6KbbL.js";
import { t as callGatewayTool } from "./gateway-Lub3vQBa.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-Co-rCf4A.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-C-0VfdCi.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CKOMt1Re.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-Cq2EKsrU.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-BaQmjmfB.js";
import "./delivery-context-BJQ3ttxS.js";
import { t as sendMessage } from "./message-BS_70W_2.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-DvSCJAeA.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-Cxhqdzii.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CtV4Jq0F.js";
import { t as getProcessSupervisor } from "./supervisor-w-1hmQTi.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-oduFkB1d.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-B8_nbWK6.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-Ci5VIUH9.js";
import { n as detectPolicyInlineEval } from "./policy-DLsBR34V.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-CRhBPoCD.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-C2M_N_eo.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-D2-sv2Au.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-Bz1jeJBw.js";
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-BIf970RH.js"));
