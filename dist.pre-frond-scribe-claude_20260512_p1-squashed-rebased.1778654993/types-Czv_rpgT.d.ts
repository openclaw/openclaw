...
import { i as resolveHumanDelayConfig, r as resolveEffectiveMessagesConfig } from "./identity-1vxK0FKU.js";
import { J as ReadSessionUpdatedAt$1, X as UpdateLastRoute$1, Y as RecordSessionMetaFromInbound$1, o as PluginRuntimeCore } from "./types-core-Bn6U9u2F.js";
import { m as resolveStorePath } from "./store-ufgXKu5o.js";
import { _ as resolveChunkMode, f as chunkByNewline, g as chunkTextWithMode, h as chunkText, m as chunkMarkdownTextWithMode, n as ChannelOutboundAdapter, p as chunkMarkdownText, v as resolveTextChunkLimit } from "./outbound.types-DsiI6f93.js";
import { n as ReplyDispatcher } from "./reply-dispatcher.types-4amVez5e.js";
import { s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-8oCVfZ54.js";
import { i as MatchesMentionWithExplicit$1, r as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-DCG0xX5b.js";
import { n as RecordInboundSession$1 } from "./session.types-B4kMWfzp.js";
import { c as SessionBindingRecord } from "./session-binding.types-BvHHQXaH.js";
import { t as hasControlCommand } from "./command-detection-CCebmQXH.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-Bhhgx4Hj.js";
import { t as convertMarkdownTables } from "./tables-Dn-FNBhk.js";
import { n as DispatchReplyFromConfig } from "./dispatch-from-config.types-Bnm8bgTq.js";
import { t as finalizeInboundContext } from "./inbound-context-BF3siopz.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-B49hkRHq.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-BW_9VNYz.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-DgZO-NM7.js";
import { t as buildPairingReply } from "./pairing-messages-Ds2eToej.js";
import { o as fetchRemoteMedia } from "./fetch-p0_5FAeJ.js";
import { p as saveMediaBuffer } from "./store-Cui2VcZ4.js";
import { n as getChannelActivity, r as recordChannelActivity } from "./channel-activity-BVfc1ush.js";
import { f as implicitMentionKindWhen, p as resolveInboundMentionDecision } from "./mention-gating-Dic5PYOZ.js";
import { a as createAckReactionHandle, c as shouldAckReaction, o as removeAckReactionAfterReply, s as removeAckReactionHandleAfterReply } from "./ack-reactions-ozMEkDUO.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-CZfYRI_m.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-DTuSumxP.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-Dv6PMyxE.js";
import { o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-jAT9jYDJ.js";
import { r as buildChannelTurnContext } from "./context-DP56ACdq.js";
import { a as runResolvedChannelTurn, i as runPreparedChannelTurn, r as runChannelTurn, t as dispatchAssembledChannelTurn } from "./kernel-KsIaT1zc.js";
