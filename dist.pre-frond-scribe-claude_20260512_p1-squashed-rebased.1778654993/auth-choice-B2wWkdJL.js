...
import { c as hasUsableCustomProviderApiKey } from "./model-auth-qZxGsUoI.js";
import { t as resolveAgentHarnessPolicy } from "./policy-rAUF-L6V.js";
import { r as loadModelCatalog } from "./model-catalog-Ckh9dF4z.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-CXYOa9sN.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-X8FtC-gM.js";
import "./provider-auth-choice-preference-BNE-sEH4.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-nML215Ib.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-B4illaSw.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-D5uKRwA9.js");
