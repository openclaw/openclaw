...
import { a as isSubagentSessionKey, i as isCronSessionKey } from "./session-key-utils-bmH32UOR.js";
import { a as resolveAgentDir } from "./agent-scope-config-Du7CC6LK.js";
import { f as resolveRunModelFallbacksOverride, m as resolveSessionAgentIds } from "./agent-scope-q0THteOR.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-Bkq-oXSK.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-q2a3Ic6o.js";
import { u as normalizeMessageChannel } from "./message-channel-HzKd5Jx-.js";
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-DP_hm1Ak.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Bot_zBB8.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-Bj7k_jmK.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-XII5ljKL.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as resolveModelAuthMode } from "./model-auth-qZxGsUoI.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-DGNwWilF.js";
import { n as ensureOpenClawModelsJson } from "./models-config-DNBKtLSS.js";
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-B4m_cDan.js";
import { f as ensureSessionHeader, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BCXdh6eu.js";
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-DZwiRgyR.js";
import { t as getMachineDisplayName } from "./machine-name-dExUOD3B.js";
import { n as extractModelCompat } from "./provider-model-compat-1tmLlTox.js";
import { A as buildEmbeddedExtensionFactories, B as repairSessionFileIfNeeded, C as createEmbeddedPiResourceLoader, D as buildEmbeddedMessageActionDiscoveryInput, E as validateReplayTurns, F as compactWithSafetyTimeout, I as resolveCompactionTimeoutMs, M as isRealConversationMessage, N as consumeCompactionSafeguardCancelReason, O as getHistoryLimitFromSessionKey, P as setCompactionSafeguardCancelReason, Q as isReasoningTagProvider, S as trackSessionManagerAccess, T as sanitizeSessionHistory, U as collectRuntimeChannelCapabilities, a as flushPendingToolResultsAfterIdle, b as resolveEmbeddedRunSkillEntries, d as collectRegisteredToolNames, f as toSessionToolAllowlist, h as createSystemPromptOverride, i as dedupeDuplicateUserMessagesForCompaction, j as hasMeaningfulConversationContent, k as limitHistoryTurns, l as collectAllowedToolNames, m as buildEmbeddedSystemPrompt, o as mapThinkingLevel, p as applySystemPromptOverrideToSession, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, v as resolveEmbeddedAgentBaseStreamFn, x as prewarmSessionFile, y as resolveEmbeddedAgentStreamFn, z as guardSessionManager } from "./compaction-successor-transcript-BCj-3FFf.js";
import { n as resolveEmbeddedCompactionTarget, r as listActiveProcessSessionReferences } from "./compaction-runtime-context-Cbcn4_cK.js";
import { a as resolveBootstrapContextForRun, c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-Cw5JVIYi.js";
import { g as resolveChannelMessageToolHints, h as listChannelSupportedActions, v as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-C3tWEqLF.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-DWsxFytx.js";
import { s as supportsModelTools } from "./tool-result-middleware-Cd3o_c16.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BPqmkIgs.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-Ba28j0sQ.js";
import "./pi-bundle-mcp-tools-Dba3w0wt.js";
import { r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BsAf7Slo.js";
import { t as log } from "./logger-DWmi6KYD.js";
import { i as formatUnknownCompactionReasonDetail, o as resolveCompactionFailureReason, r as classifyCompactionReason, s as createCompactionDiagId } from "./request-compaction-tool-D8xIxGVb.js";
import { g as createPreparedEmbeddedPiSettingsManager } from "./compaction-Cb-nfw8n.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DWDEMrP4.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-B6dfq0WL.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DYFr2oii.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-6p1t2A6p.js";
import { o as resolveSandboxContext } from "./sandbox-kfl2MPcK.js";
import { c as readTranscriptFileState, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-CQXm0DJ0.js";
import { t as detectRuntimeShell } from "./shell-utils-94sOCtvk.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-xT-qxNf7.js";
import { s as resolveSkillsPromptForRun } from "./workspace-Y4lc-NK-.js";
import "./skills-CMmz7lUg.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-BkYa7mAH.js";
import { t as applyExtraParamsToAgent } from "./extra-params-CdpPyHro.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-RHQsVblP.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-CtcfwJM1.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-DlXy6Mcm.js";
...
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-DLz2zHdc.js";
import { n as resolveModelAsync } from "./model-BW6PP4QS.js";
import fs from "node:fs/promises";
import os from "node:os";
import { SessionManager, createAgentSession, estimateTokens } from "@earendil-works/pi-coding-agent";
