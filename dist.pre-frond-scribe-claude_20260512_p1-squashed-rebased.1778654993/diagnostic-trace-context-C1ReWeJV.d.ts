...
type DiagnosticTraceContext = {
  ...
  readonly traceFlags?: string; /** Marks a current span id parsed from a remote W3C traceparent. */
  readonly spanIdSource?: "remote"; /** Marks a parent span id inherited from a remote W3C traceparent. */
