...
import { b as resolveModelRefFromString, g as resolveBareModelDefaultProvider, i as buildModelAliasIndex } from "./model-selection-shared-Cg9vhmE4.js";
...
import { r as rejectUnauthorizedCommand } from "./command-gates-DqkbvJuX.js";
import { t as resolveModelAuthLabel } from "./model-auth-label-DC6vnERp.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BluRz15b.js";
import { n as isModelPickerVisibleProvider } from "./model-picker-visibility-D9dw5AKy.js";
...
async function buildModelsProviderData(cfg, agentId, options = {}) {
	...
	const add = (p, m) => {
		...
		if (restrictToProviderWildcards && !visibilityPolicy.allows({
			provider: key,
			model: m
		})) return;
