...
import { Bl as splitSetupEntries, Cl as formatDocsLink, El as mergeAllowFromEntries, Ll as setTopLevelChannelAllowFrom, Rl as setTopLevelChannelDmPolicyWithAllowFrom, b as createPluginRuntimeStore, zl as setTopLevelChannelGroupPolicy } from "./auth-profiles-CuJtivJK.js";
import { U as isPrivateIpAddress } from "./external-content-vZzOHxnd.js";
import { n as isHttpsUrlAllowedByHostnameSuffixAllowlist, r as normalizeHostnameSuffixAllowlist, t as buildHostnameAllowlistPolicyFromSuffixAllowlist, y as mapAllowlistResolutionInputs } from "./compat-DDXNEdAm.js";
...
async function loadMSTeamsSdk() {
	return await import("./src-CNYZHReV.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
}
