...
import { i as hasConfiguredSecretInput } from "./types.secrets-Br5ssFsN.js";
import { Ao as feishuSetupWizard, Bo as resolveFeishuAccount, Fm as mapAllowFromEntries, Kd as buildProbeChannelStatusSummary, Lo as listEnabledFeishuAccounts, O as collectAllowlistProviderRestrictSendersWarnings, Po as createFeishuClient, Ro as listFeishuAccountIds, So as parseFeishuConversationId, Vo as resolveFeishuCredentials, Xd as createDefaultChannelRuntimeState, Xo as buildSecretInputSchema, jo as feishuSetupAdapter, qd as buildRuntimeAccountStatusSnapshot, wt as formatAllowFromLowercase, zo as resolveDefaultFeishuAccountId } from "./auth-profiles-B70DPAVa.js";
import { _ as createActionGate } from "./external-content-CxoN_TKD.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-XB3y4bUE.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-CI0691ej.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-CsBHeL2R.js";
...
async function loadFeishuChannelRuntime() {
	return await import("./channel.runtime-BxwnrojJ.js");
}
...
const feishuPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorFeishuProvider } = await import("./monitor-CPWS-brN.js");
		const account = resolveFeishuAccount({
			cfg: ctx.cfg,
