import { g as resolveOAuthDir, h as resolveNewStateDir, i as init_paths, m as resolveLegacyStateDirs, t as CONFIG_PATH, v as resolveStateDir } from "./paths-DqbqmTPe.js";
import { n as init_subsystem } from "./subsystem-CZwunM2N.js";
import { d as init_utils, f as isRecord, v as resolveHomeDir } from "./utils-BiUV1eIQ.js";
import { $ as applyPluginAutoEnable, $b as OpenClawSchema, Au as formatSetExplicitDefaultToConfiguredInstruction, Bs as listInterpreterLikeSafeBins, Cx as isTrustedSafeBinPath, Dx as resolveCommandResolutionFromArgv, Eu as resolveTelegramAccount, Gu as isWithinDir, Hs as resolveMergedSafeBinProfileFixtures, Hx as resolveSlackNativeStreaming, Jv as canonicalizeMainSessionAlias, KS as shouldMoveSingleAccountChannelKey, Mb as migrateLegacyConfig, Ou as formatChannelAccountsDefaultPath, Rx as formatSlackStreamModeMigrationMessage, Su as inspectTelegramAccount, Sx as getTrustedSafeBinDirs, Ub as readConfigFileSnapshot, Ux as resolveSlackStreamingMode, Va as resolveCommandSecretRefsViaGateway, Vx as resolveDiscordPreviewStreamMode, Wx as resolveTelegramPreviewStreamMode, _u as normalizeTelegramAllowFromEntry, gu as isNumericTelegramUserId, hu as fetchTelegramChatId, jb as parseToolsBySenderTypedKey, ku as formatSetExplicitDefaultInstruction, sm as saveSessionStore, wu as listTelegramAccountIds, wx as normalizeTrustedSafeBinDirs, zx as formatSlackStreamingBooleanMigrationMessage } from "./auth-profiles-DAOR1fRn.js";
import { a as init_registry, l as normalizeChatChannelId } from "./registry-ep1yQ6WN.js";
import { i as normalizeOptionalAccountId, r as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-DSKLJ_RM.js";
import { l as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, s as init_session_key } from "./session-key-B-Mu-04L.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-7sQA1Mwd.js";
import { o as listRouteBindings } from "./identity-file-GRgHESaI.js";
import { _ as readChannelAllowFromStore, b as resolveChannelAllowFromPath } from "./dm-policy-shared-QWD8iFx0.js";
import { n as formatConfigIssueLines } from "./issue-format-CBjhFckx.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-qouO4mvQ.js";
import { t as note } from "./note-DNiLBVhx.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-D1BZY1ls.js";
...
async function maybeRepairTelegramAllowFromUsernames(cfg) {
	...
	if (tokens.length === 0) return {
		config: cfg,
		changes: [hasConfiguredUnavailableToken ? `- Telegram allowFrom contains @username entries, but configured Telegram bot credentials are unavailable in this command path; cannot auto-resolve (start the gateway or make the secret source available, then rerun doctor --fix).` : `- Telegram allowFrom contains @username entries, but no Telegram bot token is configured; cannot auto-resolve (run setup or replace with numeric sender IDs).`]
	};
