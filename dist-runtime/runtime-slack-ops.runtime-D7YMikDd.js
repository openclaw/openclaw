import { $ as shouldDebounceTextInbound, $i as shouldHandleTextCommands, $o as resolveSlackChannelAllowlist, $s as resolveSlackReplyToMode, As as createSlackWebClient, At as resolveChannelConfigWrites, Ba as updateLastRoute, Bi as recordPendingHistoryEntryIfEnabled, Bs as normalizeSlackWebhookPath, Ci as issuePairingChallenge, Cs as resolveSlackAttachmentContent, Cu as resolveDefaultGroupPolicy, Di as resolveAgentOutboundIdentity, Dl as resolveSlackChannelId, Ds as sendMessageSlack, Du as buildChannelKeyCandidates, El as parseSlackTarget, Es as resolveSlackThreadStarter, Eu as applyChannelMatchMeta, Fi as logAckFailure, Ga as resolveSessionKey, Gc as finalizeInboundContext, Gs as imageResultFromFile, Hi as matchesMentionWithExplicit, Hl as createDedupeCache, Hs as parseSlackBlocksInput, Ii as logInboundDrop, Js as readReactionParams, Kc as resolveConversationLabel, Ks as jsonResult, La as readSessionUpdatedAt, Li as logTypingFailure, Mi as createReplyPrefixOptions, Ni as resolveAckReaction, Ou as resolveChannelEntryMatchWithFallback, Pi as resolveHumanDelayConfig, Pu as normalizeResolvedSecretInputString, Q as createChannelInboundDebouncer, Qo as resolveSlackUserAllowlist, Qs as resolveSlackAccount, Ri as buildPendingHistoryContextFromMap, Ss as unpinSlackMessage, Tc as generateSecureToken, Tn as enqueueSystemEvent, Ts as resolveSlackThreadHistory, Tu as warnMissingProviderGroupPolicyFallbackOnce, Ul as pruneMapToMaxSize, Vi as buildMentionRegexes, Vl as dispatchPluginInteractiveHandler, Vs as registerSlackHttpHandler, Ws as createActionGate, Xc as writeConfigFile, Xl as resolvePluginConversationBindingApproval, Yl as parsePluginBindingApprovalCustomId, Ys as readStringParam, Zo as truncateSlackText, _s as reactSlackMessage, _t as dispatchInboundMessage, bs as removeSlackReaction, ct as resolveControlCommandGate, ds as editSlackMessage, ec as resolveSlackAppToken, et as withTimeout, fs as getSlackMemberInfo, gs as pinSlackMessage, gt as resolveEnvelopeFormatOptions, hl as withNormalizedTimestamp, hs as listSlackReactions, ht as formatInboundEnvelope, il as resolveSlackStreamingMode, in as sleepWithAbort, it as resolveMentionGatingWithBypass, ji as createTypingCallbacks, js as resolveSlackWebClientOptions, ki as installRequestBodyLimitGuard, ks as normalizeSlackOutboundText, la as resolveAgentRoute, ls as deleteSlackMessage, lt as removeAckReactionAfterReply, ms as listSlackPins, na as resolveNativeSkillsEnabled, os as hasSlackThreadParticipation, ot as recordInboundSession, ps as listSlackEmojis, qc as loadConfig, ql as buildPluginBindingResolvedText, qs as readNumberParam, ri as upsertChannelPairingRequest, rl as resolveSlackNativeStreaming, rn as computeBackoff, rt as resolvePinnedMainDmOwnerFromAllowlist, ss as recordSlackThreadParticipation, st as resolveCommandAuthorizedFromAuthorizers, ta as resolveNativeCommandsEnabled, tc as resolveSlackBotToken, tl as mapStreamingModeToSlackLegacyDraftStreamMode, tt as readStoreAllowFromForDmPolicy, us as downloadSlackFile, ut as shouldAckReaction, vs as readSlackMessages, vt as createReplyDispatcherWithTyping, ws as resolveSlackMedia, wu as resolveOpenProviderRuntimeGroupPolicy, x as createConnectedChannelStatusPatch, xs as sendSlackMessage, ys as removeOwnSlackReactions, yt as hasControlCommand, yu as evaluateGroupRouteAccessForPolicy, zi as clearHistoryEntriesIfEnabled, zs as resolveTextChunkLimit } from "./model-selection-BJ_ZbQnz.js";
import { Ft as normalizeStringEntriesLower, Nt as normalizeHyphenSlug, Pt as normalizeStringEntries, R as resolveStorePath } from "./query-expansion-CG1BbCN9.js";
import { _ as warn, f as logVerbose, h as shouldLogVerbose, i as createNonExitingRuntime, l as danger, x as getChildLogger } from "./subsystem-BrPedHYO.js";
import { H as normalizeMainKey, W as resolveThreadSessionKeys, X as normalizeAccountId } from "./workspace-CwIhVocA.js";
import "./logger-DllG7Y73.js";
import "./frontmatter-Dzevz_N6.js";
import "./fetch-CrgptZf7.js";
import "./boolean-Cuaw_-7j.js";
import { a as patchAllowlistUsersInConfigEntries, c as chunkItems, d as formatAllowlistMatchMeta, f as resolveCompiledAllowlistMatch, i as mergeAllowlist, l as buildUntrustedChannelMetadata, n as buildAllowlistResolutionSummary, o as summarizeMapping, t as addAllowlistUserEntriesFromConfigEntry, u as compileAllowlist } from "./resolve-utils-B0ObEjVG.js";
import { t as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-q9dzkI3m.js";
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-CgoFJOp3.js";
import { n as createDraftStreamLoop, t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-CObBQJCx.js";
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-BJp6ew6G.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-Cnjltqdm.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-Cv0n2V1g.js");
