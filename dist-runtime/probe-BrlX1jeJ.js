import { o as compileSafeRegex, s as testRegexWithBoundedInput } from "./redact-qojvLPM7.js";
import { i as formatUncaughtError, r as formatErrorMessage } from "./errors-nCFRNLA6.js";
import { a as registerUnhandledRejectionHandler } from "./unhandled-rejections-DGuis5pC.js";
import { d as warn, f as getChildLogger, l as shouldLogVerbose, o as logVerbose, r as init_globals, t as danger } from "./globals-B6h30oSy.js";
import { i as init_paths, v as resolveStateDir } from "./paths-DqbqmTPe.js";
import { d as defaultRuntime, f as init_runtime, n as init_subsystem, t as createSubsystemLogger, u as createNonExitingRuntime } from "./subsystem-CZwunM2N.js";
import { $c as resolveModelSelection, $f as listNativeCommandSpecs, $l as resolveTelegramDirectPeerId, Aa as buildCanonicalSentMessageHookContext, Ac as logWebhookReceived, Al as isSafeToRetrySendError, An as shouldDebounceTextInbound, Ap as loadModelCatalog, Bc as resolveTelegramExecApprovalConfig, Bf as logTypingFailure, Bh as recordChannelActivity, Bl as buildSenderLabel, Cp as resolveCommandAuthorization, Cr as buildCommandsPaginationKeyboard, Df as readJsonBodyWithLimit, Eg as buildOutboundMediaLoadOptions, Eu as resolveTelegramAccount, F as resolveDefaultModelForAgent, Fl as markdownToTelegramHtml, Gf as recordPendingHistoryEntryIfEnabled, Gl as buildTelegramThreadParams, Hc as shouldEnableTelegramExecApprovalButtons, Hf as buildPendingHistoryContextFromMap, Hl as buildTelegramGroupFrom, Hp as formatReasoningMessage, Il as renderTelegramHtmlText, Iv as resolveChannelGroupPolicy, Jb as writeConfigFile, Jc as buildModelsKeyboard, Jl as expandTextLinks, Jr as isBtwRequestText, Kf as buildMentionRegexes, Kl as buildTypingThreadParams, Lc as getTelegramExecApprovalApprovers, Ll as wrapFileReferencesInHtml, Lv as resolveChannelGroupRequireMention, Ma as toPluginMessageContext, Mc as stopDiagnosticHeartbeat, Ml as isTelegramPollingNetworkError, Na as toPluginMessageSentEvent, Nf as createReplyPrefixOptions, Nl as tagTelegramNetworkError, Ob as finalizeInboundContext, Oc as logWebhookError, Ol as wasSentByBot, Pa as fireAndForgetHook, Pc as isDiagnosticsEnabled, Pf as resolveAckReaction, Pl as markdownToTelegramChunks, Qc as parseModelCallbackData, Ql as normalizeForwardedContext, Qm as resolveThreadBindingSpawnPolicy, Qn as resolveMentionGatingWithBypass, Rc as isTelegramExecApprovalApprover, Rf as logAckFailure, Rl as splitTelegramCaption, Sl as sendTypingTelegram, Sr as formatModelsAvailableHeader, Uc as shouldSuppressLocalTelegramExecApprovalPrompt, Uf as clearHistoryEntriesIfEnabled, Ul as buildTelegramGroupPeerId, Vc as resolveTelegramExecApprovalTarget, Vl as buildSenderName, Wc as buildExecApprovalPendingReplyPayload, Wi as applyModelOverrideToSessionEntry, Wl as buildTelegramParentPeer, Wt as resolveStoredModelOverride, Xc as calculateTotalPages, Xf as findCommandByNativeName, Xl as getTelegramTextParts, Yc as buildProviderKeyboard, Yf as buildCommandTextFromArgs, Yl as extractTelegramLocation, Ym as resolveThreadBindingIdleTimeoutMsForChannel, Zc as getModelsPageSize, Zl as hasBotMention, Zm as resolveThreadBindingMaxAgeMsForChannel, Zr as resolveChannelConfigWrites, _r as hasControlCommand, aa as buildCommandsMessagePaginated, al as cacheSticker, au as resolveTelegramThreadSpec, av as MediaFetchError, ca as computeBackoff, cb as findCodeRegions, cl as getCachedSticker, cr as formatInboundEnvelope, cu as normalizeDmAllowFromWithStore, cv as chunkMarkdownTextWithMode, cx as TELEGRAM_COMMAND_NAME_PATTERN, du as toLocationContext, ep as listNativeCommandSpecsForConfig, er as waitForAbortSignal, eu as resolveTelegramForumThreadId, fu as withTelegramApiErrorLogging, gp as resolveInboundLastRouteSessionKey, hl as editMessageTelegram, hp as resolveAgentRoute, im as readSessionUpdatedAt, in as createTelegramThreadBindingManager, ip as resolveCommandArgMenu, ir as dispatchReplyWithBufferedBlockDispatcher, iu as resolveTelegramStreamMode, iv as getAgentScopedMediaLocalRoots, ja as toInternalMessageSentContext, jc as startDiagnosticHeartbeat, jf as createTypingCallbacks, jl as isTelegramClientRejection, jp as modelSupportsVision, jy as saveMediaBuffer, k_ as resolveGlobalSingleton, kc as logWebhookProcessed, kl as isRecoverableTelegramNetworkError, kp as findModelInCatalog, la as sleepWithAbort, lb as isInsideCode, lm as updateSessionStore, lp as getGlobalHookRunner, ls as enqueueSystemEvent, lu as resolveSenderAllowMatch, lv as resolveChunkMode, lx as normalizeTelegramCommandName, ml as editMessageReplyMarkupTelegram, mp as deriveLastRoutePolicy, mu as resolveTelegramInlineButtonsScope, np as parseCommandArgs, nr as removeAckReactionAfterReply, nu as resolveTelegramMediaPlaceholder, of as issuePairingChallenge, ol as describeStickerImage, om as resolveSessionStoreEntry, or as createInboundDebouncer, ou as isSenderAllowed, ov as fetchRemoteMedia, pp as buildAgentSessionKey, qf as matchesMentionWithExplicit, ql as describeReplyTarget, qx as resolveAgentMaxConcurrent, rm as loadSessionStore, rr as shouldAckReaction, ru as resolveTelegramReplyId, sb as stripReasoningTagsFromText, sr as resolveInboundDebounceMs, su as normalizeAllowFrom, sv as resolveMarkdownTableMode, tp as normalizeCommandBody, tr as recordInboundSession, tu as resolveTelegramGroupAllowFromContext, tv as loadWebMedia, ul as buildInlineKeyboard, ur as resolveEnvelopeFormatOptions, uu as formatLocationText, uv as resolveTextChunkLimit, ux as resolveTelegramCustomCommands, vr as isAbortRequestText, wl as resolveTelegramVoiceSend, wr as listSkillCommandsForAgents, xr as buildModelsProviderData, yl as sendMessageTelegram, zb as loadConfig, zc as isTelegramExecApprovalClientEnabled, zf as logInboundDrop, zl as buildGroupLabel } from "./auth-profiles-DAOR1fRn.js";
import { $ as parsePluginBindingApprovalCustomId, $t as resolveOpenProviderRuntimeGroupPolicy, B as executePluginCommand, D as createDedupeCache, E as init_interactive, H as init_commands, O as init_dedupe, Rn as createInternalHookEvent, T as dispatchPluginInteractiveHandler, V as getPluginCommandSpecs, Vn as triggerInternalHook, W as matchPluginCommand, Wt as evaluateMatchedGroupAccessForPolicy, X as init_conversation_binding, Xt as init_runtime_group_policy, Z as isPluginOwnedSessionBindingRecord, et as resolvePluginConversationBindingApproval, fn as init_retry, mn as retryAsync, nt as getSessionBindingService, q as buildPluginBindingResolvedText, qt as init_group_access, rt as init_session_binding_service, zn as init_internal_hooks } from "./registry-ep1yQ6WN.js";
import { r as normalizeAccountId } from "./account-id-DSKLJ_RM.js";
import { d as resolveAgentIdFromSessionKey, f as resolveThreadSessionKeys, p as sanitizeAgentId, r as buildAgentMainSessionKey, s as init_session_key, w as parseAgentSessionKey } from "./session-key-B-Mu-04L.js";
import { a as fetchWithTimeout, o as init_fetch_timeout } from "./fetch-COjVSrBr.js";
import { a as resolveAgentDir, f as resolveDefaultAgentId } from "./agent-scope-C0PckUtv.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled, n as isNativeCommandsExplicitlyDisabled } from "./commands-BfMCtxuV.js";
import { o as isGifMedia, s as kindFromMime } from "./mime-h80iV1FL.js";
import { l as resolveStorePath } from "./paths-55bRPK_d.js";
import { n as resolveTelegramTransport, o as makeProxyFetch, r as shouldRetryTelegramIpv4Fallback, t as resolveTelegramFetch } from "./fetch-wLdC1F30.js";
import { l as formatDurationPrecise } from "./account-summary-DtY_0EC1.js";
import { _ as readChannelAllowFromStore, c as resolveCommandAuthorizedFromAuthorizers, d as firstDefined, l as resolveControlCommandGate, s as resolvePinnedMainDmOwnerFromAllowlist, x as upsertChannelPairingRequest } from "./dm-policy-shared-QWD8iFx0.js";
import { n as resolveConfiguredAcpRoute, t as ensureConfiguredAcpRouteReady } from "./persistent-bindings.route-aPw61fHc.js";
import { t as recordInboundSessionMetaSafe } from "./session-meta-AGbRkyJY.js";
import { n as readTelegramUpdateOffset, r as writeTelegramUpdateOffset } from "./update-offset-store-CGbP4bwS.js";
import { t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-0PfuVfLg.js";
import { t as resolveExecApprovalSessionTarget } from "./exec-approval-session-target-CghyecLF.js";
import { a as createOperatorApprovalsGatewayClient, i as createStatusReactionController, n as DEFAULT_EMOJIS, t as createFinalizableDraftLifecycle } from "./draft-stream-controls-CLK0xcoh.js";
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./audio-preflight-Dz1NOSeB.js");
