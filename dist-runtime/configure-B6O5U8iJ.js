...
import { $u as guardCancel, Bb as loadConfig, Ju as applyWizardMetadata, Wb as readConfigFileSnapshot, Yb as writeConfigFile, Z as resolvePluginProviders, Zu as ensureWorkspaceAndSessions, ad as probeGatewayReachable, cd as resolveControlUiLinks, dd as validateGatewayPasswordInput, fd as waitForGatewayReachable, id as printWizardHeader, nd as normalizeGatewayTokenInput, nn as withProgress, od as randomToken, p as ensureAuthProfileStore, qu as DEFAULT_WORKSPACE, ud as summarizeExistingConfig } from "./auth-profiles-DqxBs6Au.js";
import { X as getChannelPlugin, Z as listChannelPlugins } from "./registry-DrRO3PZ7.js";
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-CgNgVfYE.js";
...
import { i as resolveProviderPluginChoice } from "./provider-wizard-C9NLHf1_.js";
...
import { n as applyAuthChoice } from "./auth-choice-t3Spv_cJ.js";
...
import { a as promptModelAllowlist, i as promptDefaultModel, n as applyModelFallbacksFromSelection, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-CfbgTNF1.js";
import { i as promptCustomApiConfig } from "./onboard-custom-Y3CVKmg1.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, applySearchKey, hasKeyInEnv } = await import("./onboard-search-C5V0CGzG.js");
