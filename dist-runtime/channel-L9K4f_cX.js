...
import { Hn as PAIRING_APPROVED_MESSAGE, Zn as buildChannelConfigSchema } from "./resolve-route-CQsiaDZO.js";
import { Kd as buildProbeChannelStatusSummary, O as collectAllowlistProviderRestrictSendersWarnings, Sp as MSTeamsConfigSchema, Xd as createDefaultChannelRuntimeState, qd as buildRuntimeAccountStatusSnapshot, wt as formatAllowFromLowercase } from "./auth-profiles-B70DPAVa.js";
import { a as normalizeMSTeamsMessagingTarget, c as parseMSTeamsTeamChannelInput, g as resolveMSTeamsCredentials, i as msteamsSetupAdapter, l as resolveMSTeamsChannelAllowlist, o as normalizeMSTeamsUserInput, r as msteamsSetupWizard, s as parseMSTeamsConversationId, t as getMSTeamsRuntime, u as resolveMSTeamsUserAllowlist } from "./runtime-D9KaAwmQ.js";
import { r as resolveMSTeamsGroupToolPolicy } from "./policy-DdFkvaRO2.js";
...
async function loadMSTeamsChannelRuntime() {
	return await import("./channel.runtime-CLjgyoUm.js");
}
const msteamsPlugin = {
	id: "msteams",
	meta: {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorMSTeamsProvider } = await import("./src-DrcKYZ33.js");
