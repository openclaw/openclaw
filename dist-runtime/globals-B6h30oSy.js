...
var NODE_VERSIONED_PATTERN;
var init_runtime_binary = __esmMin((() => {
	NODE_VERSIONED_PATTERN = /^node(?:-\d+|\d+)(?:\.\d+)*(?:\.exe)?$/;
}));
//#endregion
...
var HELP_FLAGS, VERSION_FLAGS, ROOT_VERSION_ALIAS_FLAG;
var init_argv = __esmMin((() => {
	init_runtime_binary();
	init_cli_root_options();
	HELP_FLAGS = new Set(["-h", "--help"]);
	VERSION_FLAGS = new Set(["-V", "--version"]);
...
//#endregion
export { isNodeRuntime as $, init_config as A, getVerboseFlag as B, init_state as C, levelToMinLevel as D, init_levels as E, getCommandPathWithRootOptions as F, isRootHelpInvocation as G, hasHelpOrVersion as H, getCommandPositionalsWithRootOptions as I, consumeRootOptionToken as J, isRootVersionInvocation as K, getFlagValue as L, init_tmp_openclaw_dir as M, resolvePreferredOpenClawTmpDir as N, normalizeLogLevel as O, buildParseArgv as P, isBunRuntime as Q, getPositiveIntFlagValue as R, resolveEnvLogLevelOverride as S, ALLOWED_LOG_LEVELS as T, hasRootVersionAlias as U, hasFlag as V, init_argv as W, isValueToken as X, init_cli_root_options as Y, init_runtime_binary as Z, toPinoLikeLogger as _, isYes as a, isValidTimeZone as b, setVerbose as c, warn as d, getChildLogger as f, isFileLogLevelEnabled as g, init_logger as h, isVerbose as i, readLoggingConfig as j, tryParseLogLevel as k, shouldLogVerbose as l, getResolvedLoggerSettings as m, info as n, logVerbose as o, getLogger as p, shouldMigrateStateFromPath as q, init_globals as r, logVerboseConsole as s, danger as t, success as u, formatLocalIsoWithOffset as v, loggingState as w, init_env_log_level as x, init_timestamps as y, getPrimaryCommand as z };
