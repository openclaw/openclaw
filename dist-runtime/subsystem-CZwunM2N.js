...
import { n as resolveNodeRequireFromMeta, t as init_node_require } from "./node-require-BoQgKjNI.js";
import { A as init_config, C as init_state, D as levelToMinLevel, E as init_levels, O as normalizeLogLevel, S as resolveEnvLogLevelOverride, f as getChildLogger, g as isFileLogLevelEnabled, h as init_logger, i as isVerbose, j as readLoggingConfig, p as getLogger, r as init_globals, v as formatLocalIsoWithOffset, w as loggingState, x as init_env_log_level, y as init_timestamps } from "./globals-B6h30oSy.js";
...
var requireConfig, loadConfigFallbackDefault, loadConfigFallback, SUPPRESSED_CONSOLE_PREFIXES, SUPPRESSED_DISCORD_EVENTQUEUE_LISTENERS;
var init_console = __esmMin((() => {
	...
	SUPPRESSED_DISCORD_EVENTQUEUE_LISTENERS = [
...
//#endregion
export { registerActiveProgressLine as _, init_console as a, setConsoleTimestampPrefix as c, defaultRuntime as d, init_runtime as f, init_progress_line as g, clearActiveProgressLine as h, enableConsoleCapture as i, shouldLogSubsystemToConsole as l, restoreTerminalState as m, init_subsystem as n, routeLogsToStderr as o, init_restore as p, runtimeForLogger as r, setConsoleSubsystemFilter as s, createSubsystemLogger as t, createNonExitingRuntime as u, unregisterActiveProgressLine as v };
