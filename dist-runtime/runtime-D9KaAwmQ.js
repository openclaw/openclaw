...
import { Kt as init_group_access, Yt as init_runtime_group_policy } from "./resolve-route-CQsiaDZO.js";
...
import { l as init_utils } from "./utils-CMc9mmF8.js";
import { Bu as setTopLevelChannelDmPolicyWithAllowFrom, Hu as splitSetupEntries, Ou as mergeAllowFromEntries, Tu as formatDocsLink, Vu as setTopLevelChannelGroupPolicy, y as createPluginRuntimeStore, zu as setTopLevelChannelAllowFrom } from "./auth-profiles-B70DPAVa.js";
import { U as isPrivateIpAddress } from "./external-content-CxoN_TKD.js";
import { n as isHttpsUrlAllowedByHostnameSuffixAllowlist, r as normalizeHostnameSuffixAllowlist, t as buildHostnameAllowlistPolicyFromSuffixAllowlist, y as mapAllowlistResolutionInputs } from "./compat-CwB8x8Tr.js";
...
async function loadMSTeamsSdk() {
	return await import("./src-BFX9CrLM.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
}
...
//#endregion
export { isUrlAllowed as A, applyAuthorizationHeaderForUrl as C, isDownloadableAttachment as D, inferPlaceholder as E, safeFetchWithPolicy as F, safeHostForUrl as I, resolveAttachmentFetchPolicy as M, resolveMediaSsrfPolicy as N, isLikelyImageAttachment as O, resolveRequestUrl as P, IMG_SRC_RE as S, extractInlineImageCandidates as T, readAccessToken as _, normalizeMSTeamsMessagingTarget as a, ATTACHMENT_TAG_RE as b, parseMSTeamsTeamChannelInput as c, searchGraphUsers as d, listChannelsForTeam as f, resolveMSTeamsCredentials as g, resolveGraphToken as h, msteamsSetupAdapter as i, normalizeContentType as j, isRecord as k, resolveMSTeamsChannelAllowlist as l, normalizeQuery as m, setMSTeamsRuntime as n, normalizeMSTeamsUserInput as o, listTeamsByName as p, msteamsSetupWizard as r, parseMSTeamsConversationId as s, getMSTeamsRuntime as t, resolveMSTeamsUserAllowlist as u, createMSTeamsAdapter as v, extractHtmlFromAttachment as w, GRAPH_ROOT as x, loadMSTeamsSdkWithAuth as y };
