...
import { i as theme, n as init_theme, t as colorize } from "./theme-CL08MjAq.js";
...
import { As as recordAllowlistUse, Ax as normalizeExecutableToken, Ci as withTimeout, Dx as resolveCommandResolutionFromArgv, Es as normalizeExecApprovals, Ex as resolvePlannedSegmentArgv, Fs as requestJsonlSocket, Gs as resolveAllowAlwaysPatterns, Md as getMachineDisplayName, Ms as resolveExecApprovals, Mx as unwrapKnownShellMultiplexerInvocation, Nx as POSIX_INLINE_COMMAND_FLAGS, Ox as resolveExecutableFromPathEnv, Ps as saveExecApprovals, Px as resolveInlineCommandMatch, Tx as analyzeArgvCommand, Us as evaluateExecAllowlist, Vs as resolveExecSafeBinRuntimePolicy, Ws as evaluateShellAllowlist, _y as createBrowserControlContext, bs as addAllowlistEntry, gy as createBrowserRouteDispatcher, js as requiresExecApproval, jx as unwrapKnownDispatchWrapperInvocation, ks as readExecApprovalsSnapshot, kx as POSIX_SHELL_WRAPPERS, my as redactCdpUrl, ns as resolveSystemRunCommandRequest, os as normalizeSystemRunApprovalPlan, rn as formatHelpExamples, ts as formatExecCommand, vy as startBrowserControlServiceFromConfig, ws as mergeExecApprovalsSocketDefaults, xs as ensureExecApprovals, zb as loadConfig, zs as isInterpreterLikeSafeBin } from "./auth-profiles-DAOR1fRn.js";
...
import { En as GATEWAY_CLIENT_NAMES, Tn as GATEWAY_CLIENT_MODES, rn as loadOrCreateDeviceIdentity, u as GatewayClient } from "./method-scopes-CLHNYIU6.js";
...
import { b as sanitizeHostExecEnv, x as sanitizeSystemRunEnvOverrides } from "./env-overrides-Dbt5eAZJ.js";
import "./safe-text-BN5UJvnR.js";
import { n as VERSION } from "./version-Dubp0iGu.js";
import { n as resolveBrowserConfig } from "./config-DZ3oWznn.js";
import "./workspace-dirs-Ejflbukt.js";
import { a as splitShellArgs } from "./search-manager-CVctuSlw.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-C8ub4F0Y.js";
...
import { i as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-C-C6Cfb3.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-BAKbI1QA.js";
...
import { f as buildDaemonServiceSnapshot, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles, u as resolveRuntimeStatusColor } from "./shared-CCPEqzJi.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CyeYGmDG.js";
import { t as parsePort } from "./parse-port-CfABYuqb.js";
import "./issue-format-CBjhFckx.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-_e-4cOok.js";
...
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-EFipWhU2.js";
