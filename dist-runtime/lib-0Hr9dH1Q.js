...
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-CrFlghez.js";
import { t as fromBuffer } from "./lib-BPhRo--R.js";
import { l as toRatio, n as decodeString } from "./Util-D0u1g-Ih.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CkU2N1nB.js";
import { t as APEv2Parser } from "./APEv2Parser-CGbu4tbE.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DliTZyxO.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-9ARrMyoq.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-KY-XoWz8.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DiGJlFFE.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BEY7qEvd.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BhYmGRpK.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DRToxWGd.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser--jylp4xM.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-kat401RZ.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DzCqoduh.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CYy_M-cE.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CGLJRXMk.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-B7eweAEF.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DkDnTLJm.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BwcRp6Hr.js")).WaveParser;
	}
};
//#endregion
