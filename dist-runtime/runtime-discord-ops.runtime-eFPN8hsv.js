import { d as isAcpRuntimeError } from "./provider-env-vars-BfZUtZAn.js";
import { d as resolveThreadSessionKeys, g as normalizeAccountId, u as resolveAgentIdFromSessionKey } from "./session-key-BfFG0xOA.js";
import { At as GROUP_POLICY_BLOCKED_LABEL, Ct as resolveDiscordSystemLocation, E as dispatchPluginInteractiveHandler, F as matchPluginCommand, Jt as resolveDiscordAccount, K as getSessionBindingService, M as executePluginCommand, Mt as resolveDefaultGroupPolicy, N as getPluginCommandSpecs, Nt as resolveOpenProviderRuntimeGroupPolicy, Pt as warnMissingProviderGroupPolicyFallbackOnce, Qt as resolveAccountEntry, R as buildPluginBindingResolvedText, St as formatDiscordUserTag, U as parsePluginBindingApprovalCustomId, V as isPluginOwnedSessionBindingRecord, W as resolvePluginConversationBindingApproval, Xt as resolveDiscordMaxLinesPerMessage, Zt as normalizeDiscordToken, _t as resolveDiscordOwnerAllowFrom, bt as shouldEmitDiscordReactionNotification, ct as listDiscordDirectoryPeersLive, dt as normalizeDiscordSlug, ft as resolveDiscordAllowListMatch, gt as resolveDiscordOwnerAccess, ht as resolveDiscordMemberAccessState, i as resolveAgentRoute, lt as isDiscordGroupAllowedByPolicy, mt as resolveDiscordGuildEntry, n as deriveLastRoutePolicy, pt as resolveDiscordChannelConfigWithFallback, st as listDiscordDirectoryGroupsLive, t as buildAgentSessionKey, ut as normalizeDiscordAllowList, vt as resolveDiscordShouldRequireMention, wt as resolveTimestampMs, xt as formatDiscordReactionEmoji, yt as resolveGroupDmAllow } from "./resolve-route-BZ4hHpx2.js";
import { t as getChildLogger } from "./logger-CRwcgB9y.js";
import "./tmp-openclaw-dir-Bz3ouN_i.js";
import { c as resolveStateDir, f as resolveRequiredHomeDir } from "./paths-Byjx7_T6.js";
import { _ as warn, d as isVerbose, f as logVerbose, h as shouldLogVerbose, i as createNonExitingRuntime, l as danger, t as createSubsystemLogger } from "./subsystem-CsP80x3t.js";
import { C as truncateUtf16Safe } from "./utils-o1tyfnZ_.js";
import { n as fetchWithTimeout } from "./fetch-timeout-csbOmT9G.js";
import { n as wrapFetchWithAbortSignal, t as resolveFetch } from "./fetch-Dx857jUp.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-BY_ggjbn.js";
import { V as normalizeStringEntries } from "./agent-scope-DV_aCIyi.js";
import "./exec-BLi45_38.js";
import { n as logError, t as logDebug } from "./logger-Bsnck4bK.js";
import { a as withFileLock } from "./paths-OqPpu-UR.js";
import { $o as resolveCommandArgMenu, Ac as sendMessageDiscord, Ao as createTypingCallbacks, At as resolveDmGroupAccessWithLists, Bc as pinMessageDiscord, Bs as setPresence, Cc as formatDiscordComponentEventText, Dc as parseDiscordModalCustomIdForCarbon, Ds as loadSessionStore, Du as resolveChunkMode, Ec as parseDiscordModalCustomId, Et as withTimeout, Fc as convertMarkdownTables, Fo as logAckFailure, Ft as resolveMentionGatingWithBypass, Gd as formatErrorMessage, Go as buildCommandTextFromArgs, Gs as reconcileAcpThreadBindingsOnStartup, Hc as editChannelDiscord, Ho as buildMentionRegexes, Hs as unregisterGateway, Ht as recordInboundSession, Ic as recordChannelActivity, Io as logInboundDrop, Jc as chunkDiscordTextWithMode, Js as createThreadBindingManager, Jt as dispatchReplyWithBufferedBlockDispatcher, Kc as createDiscordClient, Ko as findCommandByNativeName, L as createConnectedChannelStatusPatch, Lc as createThreadDiscord, Lf as normalizeMessageChannel, Lo as logTypingFailure, Mc as sendVoiceMessageDiscord, Mo as createReplyPrefixOptions, Ms as updateSessionStore, Mt as resolvePinnedMainDmOwnerFromAllowlist, Nc as sendWebhookMessageDiscord, No as resolveAckReaction, Oc as resolveDiscordComponentEntry, Od as saveMediaBuffer, Os as readSessionUpdatedAt, Ot as readStoreAllowFromForDmPolicy, Ou as resolveTextChunkLimit, Pc as formatMention, Po as resolveHumanDelayConfig, Qo as resolveCommandArgChoices, Qs as resolveThreadBindingIdleTimeoutMs, Qt as formatInboundEnvelope, Rc as deleteMessageDiscord, Ro as buildPendingHistoryContextFromMap, Sc as createDiscordFormModal, So as resolveAgentAvatar, Su as getAgentScopedMediaLocalRoots, Tc as parseDiscordComponentCustomIdForCarbon, Tf as resolveDiscordPreviewStreamMode, Tt as shouldDebounceTextInbound, Tu as resolveMarkdownTableMode, Uc as sendDiscordText, Uo as matchesMentionWithExplicit, Ut as resolveCommandAuthorizedFromAuthorizers, Vc as unpinMessageDiscord, Vo as recordPendingHistoryEntryIfEnabled, Vs as registerGateway, Wc as stripUndefinedFields, Wt as resolveControlCommandGate, X as resolveStoredModelOverride, Xs as isThreadArchived, Yo as listNativeCommandSpecsForConfig, Yt as dispatchReplyWithDispatcher, Zd as stripReasoningTagsFromText, Zo as parseCommandArgs, Zr as getExecApprovalApproverDmNoticeText, Zs as isRecentlyUnboundThreadWebhookMessage, _r as formatDurationSeconds, an as hasControlCommand, bc as sendTypingDiscord, cc as resolveDiscordUserAllowlist, cn as buildModelsProviderData, dc as normalizeDiscordListenerTimeoutMs, dn as listSkillCommandsForAgents, ec as resolveThreadBindingMaxAgeMs, en as resolveEnvelopeFormatOptions, es as serializeCommandArgs, fc as runDiscordTaskWithTimeout, gc as auditDiscordChannelPermissions, ic as formatThreadBindingDurationLabel, io as buildPairingReply, is as resolveNativeSkillsEnabled, jc as sendPollDiscord, kc as resolveDiscordModalEntry, kn as EmbeddedBlockChunker, lc as resolveDiscordChannelAllowlist, ls as getAcpSessionManager, n as isProfileInCooldown, ns as isNativeCommandsExplicitlyDisabled, of as loadConfig, oo as readJsonFileWithFallback, qc as createDiscordRetryRunner, qo as listChatCommands, qs as createNoopThreadBindingManager, qt as shouldAckReaction, r as resolveProfilesUnavailableReason, rc as resolveThreadBindingsEnabled, rf as finalizeInboundContext, rn as createReplyDispatcherWithTyping, ro as issuePairingChallenge, rs as resolveNativeCommandsEnabled, sa as upsertChannelPairingRequest, so as writeJsonFileAtomically, t as clearExpiredCooldowns, tn as dispatchInboundMessage, ts as shouldHandleTextCommands, uc as normalizeDiscordInboundWorkerTimeoutMs, us as KeyedAsyncQueue, vc as reactMessageDiscord, vr as enqueueSystemEvent, wc as parseDiscordComponentCustomId, wt as createChannelInboundDebouncer, wu as fetchRemoteMedia, xc as sendDiscordComponentMessage, xu as loadWebMedia, yc as removeReactionDiscord, zc as editMessageDiscord, zo as clearHistoryEntriesIfEnabled } from "./auth-profiles-CuJtivJK.js";
import { a as ensureAuthProfileStore, l as normalizeProviderId } from "./profiles-CV7WLKIX.js";
...
import { a as compileSafeRegex, o as testRegexWithBoundedInput } from "./redact-BefI-5cC.js";
import "./mime-33LCeGh-.js";
import { a as patchAllowlistUsersInConfigEntries, l as formatAllowlistMatchMeta, n as buildAllowlistResolutionSummary, o as summarizeMapping, r as canonicalizeAllowlistWithResolvedIds, s as summarizeStringEntries, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-BpDGEQsl.js";
...
import { n as resolveConfiguredAcpRoute, t as ensureConfiguredAcpRouteReady } from "./persistent-bindings.route-ewa6bH8d.js";
import { a as createOperatorApprovalsGatewayClient, i as createStatusReactionController, o as resolveExecApprovalCommandDisplay, r as DEFAULT_TIMING, t as createFinalizableDraftLifecycle } from "./draft-stream-controls-5gJVEGoJ.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-B4oD1LUD.js";
import { t as createReplyReferencePlanner } from "./reply-reference-D8gKKP5A.js";
import { n as buildUntrustedChannelMetadata, t as chunkItems } from "./chunk-items-BZvcGSNp.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./audio-preflight-CryVcaiN.js");
			if (params.abortSignal?.aborted) {return {
				hasAudioAttachment,
				hasTypedText
			};}
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-BifLKxii.js");
