import { n as isRich$1, r as theme, t as colorize } from "./theme-UkqnBJaj.js";
import { S as shortenHomePath } from "./utils-Do8MzKyM.js";
import { $S as findNormalizedProviderValue, $x as getShellEnvAppliedKeys, Bb as loadConfig, F as resolveDefaultModelForAgent, Gb as readConfigFileSnapshotForWrite, Gt as maskApiKey, Ha as resolveCommandSecretRefsViaGateway, Ja as describeFailoverError, Jt as formatRemainingShort, Ki as loadProviderUsageSummary, Kt as DEFAULT_OAUTH_WARN_MS, L as resolveModelRefFromString, Lb as createConfigIO, M as parseModelRef, P as resolveConfiguredModelRef, Qx as DEFAULT_PROVIDER, Sb as isNonSecretApiKeyMarker, T as buildModelAliasIndex, Xi as resolveUsageProviderId, Yi as formatUsageWindowSummary, Z as resolvePluginProviders, Zx as DEFAULT_MODEL, _b as hasUsableCustomProviderApiKey, bb as resolveEnvApiKey, d as setAuthProfileOrder, dc as resolveModelWithRegistry, eC as normalizeProviderId, eS as shouldEnableShellEnvFallback, f as upsertAuthProfile, fi as runEmbeddedPiAgent, gb as getCustomProviderApiKey, gc as shouldSuppressBuiltInModel, h as loadAuthProfileStoreForRuntime, hb as resolveOpenClawAgentDir, hc as discoverModels, jp as loadModelCatalog, k as modelKey, mc as discoverAuthStorage, n as resolveAuthProfileOrder, o as resolveProfileUnusableUntilForDisplay, p as ensureAuthProfileStore, qb as setRuntimeConfigSnapshot, qt as buildAuthHealthSummary, r as clearAuthProfileCooldown, rd as openUrl, rn as withProgressTotals, t as resolveAuthProfileEligibility, tb as resolveSecretRefString, u as listProfilesForProvider, uC as resolveAuthProfileDisplayLabel, vb as resolveApiKeyForProvider, xb as resolveUsableCustomProviderApiKey, y as resolveAuthStorePathForDisplay, yb as resolveAwsSdkEnvVarName } from "./auth-profiles-DqxBs6Au.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-CgNgVfYE.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-CCDDcVy8.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-DHbnLF6u.js");
