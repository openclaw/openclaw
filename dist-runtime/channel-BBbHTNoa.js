...
import { Bu as buildProbeChannelStatusSummary, Vu as buildRuntimeAccountStatusSnapshot, Wu as createDefaultChannelRuntimeState, bt as formatAllowFromLowercase, hf as MSTeamsConfigSchema, k as collectAllowlistProviderRestrictSendersWarnings } from "./auth-profiles-CuJtivJK.js";
...
import { r as resolveMSTeamsGroupToolPolicy } from "./policy-DwUgDkFA.js";
...
async function loadMSTeamsChannelRuntime() {
	return await import("./channel.runtime-Dzd4hIgX.js");
}
const msteamsPlugin = {
	id: "msteams",
	meta: {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorMSTeamsProvider } = await import("./src-A8cinUvb.js");
