...
import { US as migrateBaseNameToDefaultAccount, VS as applyAccountNameToChannelSection, bp as KeyedAsyncQueue, c_ as promptSingleChannelSecretInput, e_ as addWildcardAllowFrom, g_ as setTopLevelChannelGroupPolicy, n_ as mergeAllowFromEntries, t_ as buildSingleChannelSecretPromptState } from "./auth-profiles-DAOR1fRn.js";
import { C as fetchWithSsrFGuard } from "./plugins-allowlist-E4LSkJ7R.js";
import { Dn as init_account_helpers, En as createAccountListHelpers, Xt as init_runtime_group_policy, qt as init_group_access } from "./registry-ep1yQ6WN.js";
...
import { T as mapAllowlistResolutionInputs, s as runPluginCommandWithTimeout, w as formatResolvedUnresolvedNote } from "./compat-aC6dpiEb.js";
import { n as loadMatrixCredentials, s as getMatrixRuntime, t as credentialsMatchConfig } from "./credentials-C_qNG-_b.js";
...
async function resolveMatrixAuth(params) {
	...
	const { loadMatrixCredentials, saveMatrixCredentials, credentialsMatchConfig, touchMatrixCredentials } = await import("./credentials-B342kgoP.js");
...
async function createMatrixClient(params) {
	...
	if (params.encryption) {
		...
		try {
			const { StoreType } = await import("./matrix-sdk-crypto-nodejs-BssJ5v5y.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function resolveMediaDurationMs(params) {
	...
	try {
		const { parseBuffer } = await import("./lib-0Hr9dH1Q.js");
...
//#endregion
export { listMatrixAccountIds as C, isBunRuntime as D, resolveMatrixAccountConfig as E, resolveMatrixTargets as S, resolveMatrixAccount as T, createMatrixClient as _, sendTypingMatrix as a, matrixSetupWizard as b, getActiveMatrixClient as c, isPollStartType as d, parsePollStartContent as f, stopSharedClientForAccount as g, resolveSharedMatrixClient as h, sendReadReceiptMatrix as i, setActiveMatrixClient as l, listMatrixDirectoryPeersLive as m, sendMessageMatrix as n, resolveMatrixRoomId as o, listMatrixDirectoryGroupsLive as p, sendPollMatrix as r, createPreparedMatrixClient as s, reactMatrixMessage as t, formatPollAsText as u, resolveMatrixAuth as v, resolveDefaultMatrixAccountId as w, matrixSetupAdapter as x, loadMatrixSdk as y };
