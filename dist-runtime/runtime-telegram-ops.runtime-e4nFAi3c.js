import { $ as shouldDebounceTextInbound, $c as normalizeTelegramCommandName, $n as buildModelsKeyboard, $r as normalizeDmAllowFromWithStore, $t as buildCommandsMessagePaginated, Aa as isInsideCode, Ai as readJsonBodyWithLimit, Ar as buildGroupLabel, At as resolveChannelConfigWrites, Au as retryAsync, Bc as formatErrorMessage, Bi as recordPendingHistoryEntryIfEnabled, Bn as stopDiagnosticHeartbeat, Br as extractTelegramLocation, Ca as modelSupportsVision, Ci as issuePairingChallenge, Cn as formatDurationPrecise, Cr as isTelegramPollingNetworkError, Ct as formatModelsAvailableHeader, Da as formatReasoningMessage, Dr as renderTelegramHtmlText, Er as markdownToTelegramHtml, F as createTelegramThreadBindingManager, Fi as logAckFailure, Fr as buildTelegramParentPeer, Fs as fetchRemoteMedia, Gc as finalizeInboundContext, Gl as getPluginCommandSpecs, Gn as isTelegramExecApprovalApprover, Gr as resolveTelegramForumThreadId, Hi as matchesMentionWithExplicit, Hl as createDedupeCache, Hn as isDiagnosticsEnabled, Hr as hasBotMention, I as auditTelegramGroupMembership, Ia as loadSessionStore, Ii as logInboundDrop, In as logWebhookError, Ir as buildTelegramThreadParams, Is as resolveMarkdownTableMode, Ji as normalizeCommandBody, Jl as isPluginOwnedSessionBindingRecord, Jn as resolveTelegramExecApprovalTarget, Jr as resolveTelegramReplyId, Ki as listNativeCommandSpecs, Kl as matchPluginCommand, Kn as isTelegramExecApprovalClientEnabled, Kr as resolveTelegramGroupAllowFromContext, L as collectTelegramUnmentionedGroupIds, La as readSessionUpdatedAt, Li as logTypingFailure, Ln as logWebhookProcessed, Lr as buildTypingThreadParams, Ls as chunkMarkdownTextWithMode, Mi as createReplyPrefixOptions, Mo as recordChannelActivity, Mr as buildSenderName, Ms as loadWebMedia, N as resolveStoredModelOverride, Ni as resolveAckReaction, Nr as buildTelegramGroupFrom, Ns as getAgentScopedMediaLocalRoots, Oa as stripReasoningTagsFromText, Or as wrapFileReferencesInHtml, Ot as isBtwRequestText, Pr as buildTelegramGroupPeerId, Ps as MediaFetchError, Qc as TELEGRAM_COMMAND_NAME_PATTERN, Ql as writeJsonAtomic, Qr as normalizeAllowFrom, Qt as applyModelOverrideToSessionEntry, Ri as buildPendingHistoryContextFromMap, Rn as logWebhookReceived, Rr as describeReplyTarget, Rs as resolveChunkMode, Sa as loadModelCatalog, Sr as isTelegramClientRejection, St as buildModelsProviderData, Tn as enqueueSystemEvent, Tr as markdownToTelegramChunks, Tt as listSkillCommandsForAgents, Ui as buildCommandTextFromArgs, Ur as normalizeForwardedContext, Va as updateSessionStore, Vc as formatUncaughtError, Vi as buildMentionRegexes, Vl as dispatchPluginInteractiveHandler, Vr as getTelegramTextParts, Wi as findCommandByNativeName, Wl as executePluginCommand, Wn as getTelegramExecApprovalApprovers, Wo as buildOutboundMediaLoadOptions, Wr as resolveTelegramDirectPeerId, Xc as writeConfigFile, Xl as resolvePluginConversationBindingApproval, Xn as shouldSuppressLocalTelegramExecApprovalPrompt, Xr as resolveTelegramThreadSpec, Yi as parseCommandArgs, Yl as parsePluginBindingApprovalCustomId, Yn as shouldEnableTelegramExecApprovalButtons, Yr as resolveTelegramStreamMode, Zi as resolveCommandArgMenu, Zl as getSessionBindingService, Zn as buildExecApprovalPendingReplyPayload, Zr as isSenderAllowed, _r as unpinMessageTelegram, ai as toLocationContext, al as resolveAgentMaxConcurrent, ao as resolveThreadBindingSpawnPolicy, ar as cacheSticker, at as waitForAbortSignal, br as isRecoverableTelegramNetworkError, bt as isAbortRequestText, bu as evaluateMatchedGroupAccessForPolicy, ca as deriveLastRoutePolicy, cr as buildInlineKeyboard, cs as resolveGlobalSingleton, ct as resolveControlCommandGate, dr as editMessageTelegram, dt as dispatchReplyWithBufferedBlockDispatcher, ea as isNativeCommandsExplicitlyDisabled, ei as resolveSenderAllowMatch, el as resolveTelegramCustomCommands, er as buildProviderKeyboard, fn as buildCanonicalSentMessageHookContext, fr as pinMessageTelegram, gn as fireAndForgetHook, gr as sendTypingTelegram, gt as resolveEnvelopeFormatOptions, ha as resolveCommandAuthorization, hn as toPluginMessageSentEvent, hr as sendPollTelegram, ht as formatInboundEnvelope, ia as getGlobalHookRunner, ii as formatLocationText, in as sleepWithAbort, io as resolveThreadBindingMaxAgeMsForChannel, ir as resolveModelSelection, it as resolveMentionGatingWithBypass, ji as createTypingCallbacks, jr as buildSenderLabel, ka as findCodeRegions, kc as saveMediaBuffer, kr as splitTelegramCaption, la as resolveAgentRoute, li as resolveTelegramAccount, lr as deleteMessageTelegram, lt as removeAckReactionAfterReply, mn as toPluginMessageContext, mr as sendMessageTelegram, mt as resolveInboundDebounceMs, na as resolveNativeSkillsEnabled, nc as resolveChannelGroupPolicy, ni as readChannelAllowFromStore, no as resolveThreadBindingIdleTimeoutMsForChannel, nr as getModelsPageSize, oi as withTelegramApiErrorLogging, on as resolveSessionDeliveryTarget, or as describeStickerImage, ot as recordInboundSession, pn as toInternalMessageSentContext, pr as renameForumTopicTelegram, pt as createInboundDebouncer, qc as loadConfig, qi as listNativeCommandSpecsForConfig, ql as buildPluginBindingResolvedText, qn as resolveTelegramExecApprovalConfig, qr as resolveTelegramMediaPlaceholder, rc as resolveChannelGroupRequireMention, ri as upsertChannelPairingRequest, rn as computeBackoff, rr as parseModelCallbackData, rt as resolvePinnedMainDmOwnerFromAllowlist, s as resolveDefaultModelForAgent, sa as buildAgentSessionKey, si as resolveTelegramInlineButtonsScope, sr as getCachedSticker, st as resolveCommandAuthorizedFromAuthorizers, ta as resolveNativeCommandsEnabled, ti as firstDefined, tr as calculateTotalPages, ua as resolveInboundLastRouteSessionKey, ui as resolveTelegramToken, ur as editMessageReplyMarkupTelegram, ut as shouldAckReaction, vr as resolveTelegramVoiceSend, wa as registerUnhandledRejectionHandler, wr as tagTelegramNetworkError, wt as buildCommandsPaginationKeyboard, wu as resolveOpenProviderRuntimeGroupPolicy, xa as findModelInCatalog, xr as isSafeToRetrySendError, yr as wasSentByBot, yt as hasControlCommand, za as resolveSessionStoreEntry, zi as clearHistoryEntriesIfEnabled, zn as startDiagnosticHeartbeat, zr as expandTextLinks, zs as resolveTextChunkLimit } from "./model-selection-BJ_ZbQnz.js";
import { Et as resolveDefaultAgentId, G as kindFromMime, R as resolveStorePath, W as isGifMedia, bt as resolveAgentDir, ht as testRegexWithBoundedInput, mt as compileSafeRegex } from "./query-expansion-CG1BbCN9.js";
import { I as resolveStateDir, _ as warn, a as defaultRuntime, f as logVerbose, h as shouldLogVerbose, i as createNonExitingRuntime, l as danger, t as createSubsystemLogger, x as getChildLogger } from "./subsystem-BrPedHYO.js";
import { G as sanitizeAgentId, I as buildAgentMainSessionKey, U as resolveAgentIdFromSessionKey, W as resolveThreadSessionKeys, X as normalizeAccountId$1, it as parseAgentSessionKey } from "./workspace-CwIhVocA.js";
import "./logger-DllG7Y73.js";
import { h as createInternalHookEvent, y as triggerInternalHook } from "./frontmatter-Dzevz_N6.js";
import { f as fetchWithTimeout, i as makeProxyFetch, n as resolveTelegramTransport, r as shouldRetryTelegramIpv4Fallback, t as resolveTelegramFetch } from "./fetch-CrgptZf7.js";
import "./boolean-Cuaw_-7j.js";
import { t as recordInboundSessionMetaSafe } from "./session-meta-DHcAYKG8.js";
import { a as createFinalizableDraftLifecycle, c as createStatusReactionController, i as resolveConfiguredAcpRoute, n as createOperatorApprovalsGatewayClient, o as DEFAULT_EMOJIS, r as ensureConfiguredAcpRouteReady, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CbkZQFbK.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-CObBQJCx.js";
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight) {try {
		const { transcribeFirstAudio } = await import("./audio-preflight-EN1O9wbv.js");
