...
import { Fn as MarkdownConfigSchema, bn as buildChannelConfigSchema } from "../../resolve-route-BZ4hHpx2.js";
...
import { A as CustomError, B as __spreadArray, C as handleTwitchApiResponseError, D as extractUserName, E as extractUserId, F as mapNullable, G as isAccountConfigured, H as twitchSetupAdapter, I as mapOptional, J as normalizeTwitchChannel, K as missingTargetError, L as arrayToObject, M as rawDataSymbol, N as accessTokenIsExpired, O as HellFreezesOverError, P as promiseWithResolvers, R as __decorate, S as callTwitchApiRaw, T as HttpStatusCodeError, U as twitchSetupWizard, V as Enumerable, W as generateMessageId, X as getAccountConfig, Y as DEFAULT_ACCOUNT_ID, Z as listAccountIds, _ as StaticAuthProvider, a as stripMarkdownForTwitch, b as InvalidTokenError, c as resolveTwitchToken, d as Cacheable, f as PartitionedTimeBasedRateLimiter, g as require_detect_node, h as createLogger$1, i as chunkTextForTwitch, j as DataObject, k as rtfm, l as ChatClient, m as CustomError$1, o as getClientManager, p as RateLimitReachedError, q as normalizeToken, r as setTwitchRuntime, s as removeClientManager, t as monitorTwitchProvider, u as CachedGetter, v as EventEmitter, w as transformTwitchApiResponse, x as callTwitchApi, y as TokenInfo, z as __read } from "../../monitor-DimIRC6y.js";
import { z } from "zod";
...
const twitchPlugin = {
	...
	gateway: {
		startAccount: async (ctx) => {
			...
			const { monitorTwitchProvider } = await import("../../monitor-DimIRC6y.js").then((n) => n.n);
...
//#endregion
export { plugin as default, monitorTwitchProvider };
