...
import { Yn as TtsConfigSchema } from "../../resolve-route-BZ4hHpx2.js";
...
import { Do as readRequestBodyWithLimit, Oo as requestBodyErrorToText, To as isRequestBodyLimitError } from "../../auth-profiles-CuJtivJK.js";
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("../../response-generator-ClFLt4cR.js");
