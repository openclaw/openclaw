...
import { En as DmPolicySchema, Fn as MarkdownConfigSchema, _n as setAccountEnabledInConfigSection, bn as buildChannelConfigSchema, dn as PAIRING_APPROVED_MESSAGE, fn as buildAccountScopedDmSecurityPolicy, gn as deleteAccountFromConfigSection, kn as GroupPolicySchema, vn as AllowFromListSchema, yn as buildCatchallMultiAccountChannelSchema } from "./resolve-route-BZ4hHpx2.js";
import { c as normalizeSecretInputString } from "./types.secrets-apkw3WZr.js";
import { t as createAccountStatusSink } from "./channel-lifecycle-h2DwjEdV.js";
import { Cp as mapAllowFromEntries, D as buildOpenGroupPolicyWarning, E as buildOpenGroupPolicyRestrictSendersWarning, Hu as buildTokenChannelStatusSummary, Lu as buildBaseAccountStatusSnapshot, N as collectOpenProviderGroupPolicyWarnings, bt as formatAllowFromLowercase, ci as extractToolSend, gp as listDirectoryUserEntriesFromAllowFrom, ko as buildSecretInputSchema } from "./auth-profiles-CuJtivJK.js";
import { E as readStringParam, b as jsonResult } from "./external-content-vZzOHxnd.js";
import { _ as buildChannelSendResult, f as sendPayloadWithChunkedTextAndMedia, i as chunkTextForOutbound, l as isNumericTargetId } from "./compat-DDXNEdAm.js";
import { _ as zaloSetupAdapter, c as sendMessage, d as zaloSetupWizard, f as listEnabledZaloAccounts, g as resolveZaloToken, h as resolveZaloAccount, i as getMe, l as sendPhoto, m as resolveDefaultZaloAccountId, n as ZaloApiError, p as listZaloAccountIds, t as resolveZaloProxyFetch } from "./proxy-0RkxgP3l.js";
...
const zaloPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		const { monitorZaloProvider } = await import("./monitor-4vxI2SfR.js");
