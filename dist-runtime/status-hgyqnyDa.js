...
import { Hb as readBestEffortConfig, Rd as buildGatewayConnectionDetails, Tr as getRemoteSkillEligibility, Ub as readConfigFileSnapshot, Va as resolveCommandSecretRefsViaGateway, XS as hasPotentialConfiguredChannels, co as summarizeRestartSentinel, md as normalizeControlUiBasePath, rm as loadSessionStore, sd as resolveControlUiLinks, so as readRestartSentinel, tn as withProgress, zd as callGateway } from "./auth-profiles-DAOR1fRn.js";
...
import { R as readTailscaleStatusJson } from "./config-DZ3oWznn.js";
...
import { t as formatHealthChannelLines } from "./health-BcAvG-SY.js";
import { h as resolveUpdateChannelDisplay, i as formatGitInstallLabel, p as normalizeUpdateChannel, t as checkUpdateStatus } from "./update-check-C55miNMy.js";
...
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-KDWYuIrV.js";
...
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-DEwAk0EZ.js");
