...
import { r as theme, t as colorize } from "./theme-UkqnBJaj.js";
...
import { As as readExecApprovalsSnapshot, Ax as POSIX_SHELL_WRAPPERS, Bb as loadConfig, Bs as isInterpreterLikeSafeBin, Ds as normalizeExecApprovals, Dx as resolvePlannedSegmentArgv, Ex as analyzeArgvCommand, Fs as saveExecApprovals, Fx as resolveInlineCommandMatch, Gs as evaluateShellAllowlist, Hs as resolveExecSafeBinRuntimePolicy, Is as requestJsonlSocket, Ks as resolveAllowAlwaysPatterns, Ms as requiresExecApproval, Mx as unwrapKnownDispatchWrapperInvocation, Nd as getMachineDisplayName, Ns as resolveExecApprovals, Nx as unwrapKnownShellMultiplexerInvocation, Ox as resolveCommandResolutionFromArgv, Px as POSIX_INLINE_COMMAND_FLAGS, Ss as ensureExecApprovals, Ts as mergeExecApprovalsSocketDefaults, Ws as evaluateExecAllowlist, _y as createBrowserRouteDispatcher, hy as redactCdpUrl, in as formatHelpExamples, js as recordAllowlistUse, jx as normalizeExecutableToken, kx as resolveExecutableFromPathEnv, ns as formatExecCommand, rs as resolveSystemRunCommandRequest, ss as normalizeSystemRunApprovalPlan, vy as createBrowserControlContext, wi as withTimeout, xs as addAllowlistEntry, yy as startBrowserControlServiceFromConfig } from "./auth-profiles-DqxBs6Au.js";
...
import { En as GATEWAY_CLIENT_NAMES, Tn as GATEWAY_CLIENT_MODES, rn as loadOrCreateDeviceIdentity, u as GatewayClient } from "./method-scopes-DDb5C1xl.js";
...
import { b as sanitizeHostExecEnv, x as sanitizeSystemRunEnvOverrides } from "./env-overrides-ArVaLl04.js";
...
import { a as splitShellArgs } from "./search-manager-DIDe1qlM.js";
...
import { i as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-B7RGrAF1.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-cQOj5Aup.js";
...
import { f as buildDaemonServiceSnapshot, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles, u as resolveRuntimeStatusColor } from "./shared-ApzUiU3S.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-DDKGngJK.js";
import { t as parsePort } from "./parse-port-CfABYuqb.js";
import "./issue-format-B2YddtHw.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CVDjXfID.js";
