import { E_ as validateApiKeyInput, S_ as normalizeTokenProviderInput, T_ as normalizeApiKeyInput, b_ as ensureApiKeyFromOptionEnvOrPrompt, n as resolveAuthProfileOrder, p as ensureAuthProfileStore, v_ as createAuthChoiceDefaultModelApplierForMutableState, x_ as normalizeSecretInputModeInput } from "./auth-profiles-DAOR1fRn.js";
import { r as applyAuthProfileConfig } from "./onboard-auth.config-shared-B0GfsgVQ.js";
import { i as LITELLM_DEFAULT_MODEL_REF, n as applyLitellmProviderConfig, o as setLitellmApiKey, t as applyLitellmConfig } from "./onboard-auth-Vt8VHD8O.js";
import { a as resolveManifestProviderAuthChoice, i as resolveManifestProviderApiKeyChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-DTPPkr0E.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const [{ resolveProviderPluginChoice }, { resolvePluginProviders }] = await Promise.all([import("./provider-wizard-DvtcqR7E.js"), import("./providers-Bp2unoal.js")]);
