import { l as normalizeAgentId, s as init_session_key } from "./session-key-BSZsryCD.js";
import { d as init_home_dir, l as resolveStateDir, m as resolveRequiredHomeDir, r as init_paths, u as expandHomePrefix } from "./paths-CbmqEZIn.js";
import { n as init_subsystem, t as createSubsystemLogger } from "./subsystem-CsPxmH8p.js";
import { A as BOUNDARY_PATH_ALIAS_POLICIES, F as isPathInside, I as isSymlinkOpenError, N as hasNodeErrorCode, P as isNotFoundPathError, j as resolveBoundaryPath, q as sameFileIdentity } from "./agent-scope-CM8plEdu.js";
import { i as logWarn } from "./logger-C833gw0R.js";
import { n as redactSensitiveText } from "./redact-BZcL_gJG.js";
...
//#endregion
export { supportsMemoryMultimodalEmbeddings as A, appendFileWithinRoot as B, isFileMissingError as C, getMemoryMultimodalExtensions as D, classifyMemoryMultimodalPath as E, resolveSessionTranscriptPath as F, readFileWithinRoot as G, createRootScopedReadFile as H, resolveSessionTranscriptPathInDir as I, writeFileWithinRoot as J, readLocalFileSafely as K, resolveSessionTranscriptsDirForAgent as L, resolveDefaultSessionStorePath as M, resolveSessionFilePath as N, isMemoryMultimodalEnabled as O, resolveSessionFilePathOptions as P, resolveStorePath as R, splitTextToUtf8ByteLimit as S, buildCaseInsensitiveExtensionGlob as T, openFileWithinRoot as U, copyFileWithinRoot as V, openWritableFileWithinRoot as W, assertNoPathAliasEscape as X, PATH_ALIAS_POLICIES as Y, runTasksWithConcurrency as Z, remapChunkLines as _, listSessionFilesForAgent as a, estimateStructuredEmbeddingInputBytes as b, buildMultimodalChunkForIndexing as c, ensureDir as d, hashText as f, parseEmbedding as g, normalizeExtraMemoryPaths as h, buildSessionEntry as i, resolveAgentsDirFromSessionStorePath as j, normalizeMemoryMultimodalSettings as k, chunkMarkdown as l, listMemoryFiles as m, isQueryStopWordToken as n, sessionPathForFile as o, isMemoryPath as p, writeFileFromPathWithinRoot as q, requireNodeSqlite as r, buildFileEntry as s, extractKeywords as t, cosineSimilarity as u, runWithConcurrency as v, statRegularFile as w, estimateUtf8Bytes as x, hasNonTextEmbeddingParts as y, SafeOpenError as z };
