...
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-CSRv9UUV.js";
import { t as fromBuffer } from "./lib-CbsdtN_V.js";
import { l as toRatio, n as decodeString } from "./Util-822Z40lv.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DJdxMJS5.js";
import { t as APEv2Parser } from "./APEv2Parser-BjYRB_Uk.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BQVgS29p.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-C--zTMFK.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-D_1yc2qc.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-D9buznQF.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-I0Hjp7xP.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BpHNkcm-.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CPf_zuY3.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-zjTkhgJG.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-GTl3SMX6.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-p0Rg4vvL.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DNJihMFs.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BfsMJ70_.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CMOWz8yY.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CkDmftc3.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BO1Oo2EA.js")).WaveParser;
	}
};
//#endregion
