...
import { t as installUnhandledRejectionHandler } from "./unhandled-rejections-DGuis5pC.js";
import process from "node:process";
import { fileURLToPath } from "node:url";
//#region src/index.ts
const library = await import("./library-E42og6Rz.js");
...
async function runLegacyCliEntry(argv = process.argv) {
	const [{ installGaxiosFetchCompat }, { runCli }] = await Promise.all([import("./gaxios-fetch-compat-DMWiCyPj.js"), import("./run-main-C5flUylF.js")]);
