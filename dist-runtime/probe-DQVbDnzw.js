import { O as parseAgentSessionKey, d as resolveAgentIdFromSessionKey, f as resolveThreadSessionKeys, p as sanitizeAgentId, r as buildAgentMainSessionKey, s as init_session_key, v as normalizeAccountId } from "./session-key-BSZsryCD.js";
import { $ as resolvePluginConversationBindingApproval, A as createDedupeCache, B as getPluginCommandSpecs, Fn as init_internal_hooks, In as triggerInternalHook, K as buildPluginBindingResolvedText, Kt as init_group_access, O as dispatchPluginInteractiveHandler, Pn as createInternalHookEvent, Q as parsePluginBindingApprovalCustomId, Qt as resolveOpenProviderRuntimeGroupPolicy, U as matchPluginCommand, Ut as evaluateMatchedGroupAccessForPolicy, V as init_commands, X as isPluginOwnedSessionBindingRecord, Y as init_conversation_binding, Yt as init_runtime_group_policy, a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute, j as init_dedupe, k as init_interactive, n as deriveLastRoutePolicy, nt as init_session_binding_service, t as buildAgentSessionKey, tt as getSessionBindingService, z as executePluginCommand } from "./resolve-route-CQsiaDZO.js";
import { t as getChildLogger } from "./logger-BOdgfoqz.js";
import { l as resolveStateDir, r as init_paths } from "./paths-CbmqEZIn.js";
import { C as warn, c as defaultRuntime, g as init_globals, l as init_runtime, m as danger, n as init_subsystem, s as createNonExitingRuntime, t as createSubsystemLogger, v as logVerbose, x as shouldLogVerbose } from "./subsystem-CsPxmH8p.js";
import { n as fetchWithTimeout, r as init_fetch_timeout } from "./fetch-timeout-DtFP6dT0.js";
import { r as retryAsync, t as init_retry } from "./retry-CgLvWye-.js";
import { i as resolveAgentDir, l as resolveDefaultAgentId } from "./agent-scope-CM8plEdu.js";
import { $f as formatUncaughtError, $i as describeReplyTarget, $n as sleepWithAbort, $o as createReplyPrefixOptions, $r as buildExecApprovalPendingReplyPayload, $s as updateSessionStore, Ad as resolveMarkdownTableMode, Bi as markdownToTelegramChunks, Br as logWebhookReceived, Bs as modelSupportsVision, Ca as resolveTelegramInlineButtonsScope, Ci as editMessageReplyMarkupTelegram, Cs as isNativeCommandsExplicitlyDisabled, Dd as getAgentScopedMediaLocalRoots, Dp as normalizeTelegramCommandName, Ds as getGlobalHookRunner, Ep as TELEGRAM_COMMAND_NAME_PATTERN, Fa as resolveTelegramAccount, Ff as saveMediaBuffer, Fi as isRecoverableTelegramNetworkError, Fp as resolveAgentMaxConcurrent, Gi as buildGroupLabel, Gn as applyModelOverrideToSessionEntry, Gs as formatReasoningMessage, Hi as renderTelegramHtmlText, Hr as stopDiagnosticHeartbeat, Hs as registerUnhandledRejectionHandler, Ii as isSafeToRetrySendError, It as resolvePinnedMainDmOwnerFromAllowlist, Ji as buildTelegramGroupFrom, Jn as buildCommandsMessagePaginated, Jr as isTelegramExecApprovalClientEnabled, Js as loadSessionStore, Jt as resolveControlCommandGate, Ki as buildSenderLabel, Kr as getTelegramExecApprovalApprovers, Kt as recordInboundSession, Li as isTelegramClientRejection, Md as resolveChunkMode, Ms as resolveCommandAuthorization, Nd as resolveTextChunkLimit, Ni as resolveTelegramVoiceSend, Od as MediaFetchError, Oi as sendMessageTelegram, Op as resolveTelegramCustomCommands, Pi as wasSentByBot, Qf as formatErrorMessage, Qi as buildTypingThreadParams, Qn as computeBackoff, Qr as shouldSuppressLocalTelegramExecApprovalPrompt, Qt as dispatchReplyWithBufferedBlockDispatcher, Qu as resolveGlobalSingleton, Ri as isTelegramPollingNetworkError, Rr as logWebhookError, Rs as findModelInCatalog, Sc as resolveThreadBindingIdleTimeoutMsForChannel, Sr as enqueueSystemEvent, Tc as resolveThreadBindingSpawnPolicy, Ts as resolveNativeSkillsEnabled, Ui as wrapFileReferencesInHtml, Vi as markdownToTelegramHtml, Vr as startDiagnosticHeartbeat, Vt as waitForAbortSignal, Wi as splitTelegramCaption, Xi as buildTelegramParentPeer, Xr as resolveTelegramExecApprovalTarget, Xt as removeAckReactionAfterReply, Yi as buildTelegramGroupPeerId, Yr as resolveTelegramExecApprovalConfig, Ys as readSessionUpdatedAt, Zi as buildTelegramThreadParams, Zl as buildOutboundMediaLoadOptions, Zo as createTypingCallbacks, Zr as shouldEnableTelegramExecApprovalButtons, Zs as resolveSessionStoreEntry, Zt as shouldAckReaction, _a as readChannelAllowFromStore, _i as getCachedSticker, _p as writeConfigFile, _s as normalizeCommandBody, aa as resolveTelegramDirectPeerId, af as resolveChannelGroupPolicy, ai as calculateTotalPages, ap as findCodeRegions, as as buildPendingHistoryContextFromMap, ba as toLocationContext, bn as resolveChannelConfigWrites, br as formatDurationPrecise, bs as resolveCommandArgMenu, ca as resolveTelegramMediaPlaceholder, ci as resolveModelSelection, cr as toInternalMessageSentContext, cs as recordPendingHistoryEntryIfEnabled, da as resolveTelegramThreadSpec, dr as fireAndForgetHook, ea as expandTextLinks, en as createInboundDebouncer, es as resolveAckReaction, et as resolveStoredModelOverride, fa as isSenderAllowed, fl as recordChannelActivity, fn as buildModelsProviderData, fs as buildCommandTextFromArgs, ga as firstDefined, gs as listNativeCommandSpecsForConfig, ha as resolveSenderAllowMatch, hi as describeStickerImage, hn as listSkillCommandsForAgents, hs as listNativeCommandSpecs, ia as normalizeForwardedContext, ii as buildProviderKeyboard, in as resolveEnvelopeFormatOptions, ip as stripReasoningTagsFromText, is as logTypingFailure, jd as chunkMarkdownTextWithMode, ji as sendTypingTelegram, kd as fetchRemoteMedia, kt as shouldDebounceTextInbound, la as resolveTelegramReplyId, ln as hasControlCommand, lr as toPluginMessageContext, ls as buildMentionRegexes, ma as normalizeDmAllowFromWithStore, mi as cacheSticker, mn as buildCommandsPaginationKeyboard, na as getTelegramTextParts, nn as formatInboundEnvelope, ns as logAckFailure, nt as createTelegramThreadBindingManager, oa as resolveTelegramForumThreadId, of as resolveChannelGroupRequireMention, oi as getModelsPageSize, op as isInsideCode, os as clearHistoryEntriesIfEnabled, pa as normalizeAllowFrom, pn as formatModelsAvailableHeader, pp as loadConfig, ps as findCommandByNativeName, qi as buildSenderName, qo as readJsonBodyWithLimit, qr as isTelegramExecApprovalApprover, qt as resolveCommandAuthorizedFromAuthorizers, ra as hasBotMention, ri as buildModelsKeyboard, rs as logInboundDrop, sa as resolveTelegramGroupAllowFromContext, si as parseModelCallbackData, sr as buildCanonicalSentMessageHookContext, ta as extractTelegramLocation, tn as resolveInboundDebounceMs, tr as resolveSessionDeliveryTarget, u as resolveDefaultModelForAgent, ua as resolveTelegramStreamMode, un as isAbortRequestText, up as finalizeInboundContext, ur as toPluginMessageSentEvent, us as matchesMentionWithExplicit, va as upsertChannelPairingRequest, vn as isBtwRequestText, vs as parseCommandArgs, wc as resolveThreadBindingMaxAgeMsForChannel, wd as loadWebMedia, wi as editMessageTelegram, wo as issuePairingChallenge, ws as resolveNativeCommandsEnabled, xa as withTelegramApiErrorLogging, ya as formatLocationText, yi as buildInlineKeyboard, zi as tagTelegramNetworkError, zr as logWebhookProcessed, zs as loadModelCatalog, zt as resolveMentionGatingWithBypass } from "./auth-profiles-B70DPAVa.js";
import { n as resolveTelegramTransport, r as shouldRetryTelegramIpv4Fallback, s as makeProxyFetch, t as resolveTelegramFetch } from "./fetch-BX2RRCzB.js";
import { R as resolveStorePath } from "./query-expansion-Do6vyPvH.js";
import { a as compileSafeRegex, o as testRegexWithBoundedInput } from "./redact-BZcL_gJG.js";
import { o as isGifMedia, s as kindFromMime } from "./mime-33LCeGh-.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-CIaOYozH.js";
import { n as resolveConfiguredAcpRoute, t as ensureConfiguredAcpRouteReady } from "./persistent-bindings.route-B997Djeo.js";
import { a as createOperatorApprovalsGatewayClient, i as createStatusReactionController, n as DEFAULT_EMOJIS, o as resolveExecApprovalCommandDisplay, t as createFinalizableDraftLifecycle } from "./draft-stream-controls-DuBDAC-Y.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-CGUuHJty.js";
import { t as recordInboundSessionMetaSafe } from "./session-meta-DWPXbWDr.js";
import { n as readTelegramUpdateOffset, r as writeTelegramUpdateOffset } from "./update-offset-store-D1cd-oPv.js";
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./audio-preflight-BVk1gE6G.js");
