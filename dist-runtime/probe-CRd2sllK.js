import { d as resolveThreadSessionKeys, f as sanitizeAgentId, g as normalizeAccountId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey, w as parseAgentSessionKey } from "./session-key-BfFG0xOA.js";
import { D as createDedupeCache, E as dispatchPluginInteractiveHandler, Et as evaluateMatchedGroupAccessForPolicy, F as matchPluginCommand, K as getSessionBindingService, M as executePluginCommand, N as getPluginCommandSpecs, Nt as resolveOpenProviderRuntimeGroupPolicy, R as buildPluginBindingResolvedText, U as parsePluginBindingApprovalCustomId, V as isPluginOwnedSessionBindingRecord, W as resolvePluginConversationBindingApproval, a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute, n as deriveLastRoutePolicy, on as createInternalHookEvent, sn as triggerInternalHook, t as buildAgentSessionKey } from "./resolve-route-BZ4hHpx2.js";
import { t as getChildLogger } from "./logger-CRwcgB9y.js";
import { c as resolveStateDir } from "./paths-Byjx7_T6.js";
import { _ as warn, a as defaultRuntime, f as logVerbose, h as shouldLogVerbose, i as createNonExitingRuntime, l as danger, t as createSubsystemLogger } from "./subsystem-CsP80x3t.js";
import { n as fetchWithTimeout } from "./fetch-timeout-csbOmT9G.js";
import { n as retryAsync } from "./retry-BY_ggjbn.js";
import { i as resolveAgentDir, l as resolveDefaultAgentId } from "./agent-scope-DV_aCIyi.js";
import { $d as isInsideCode, $i as resolveTelegramStreamMode, $o as resolveCommandArgMenu, $r as buildModelsKeyboard, $s as resolveThreadBindingIdleTimeoutMsForChannel, $u as resolveChannelGroupRequireMention, Ai as markdownToTelegramHtml, Ao as createTypingCallbacks, As as resolveSessionStoreEntry, Bi as buildTelegramThreadParams, Ci as wasSentByBot, Cu as MediaFetchError, Di as isTelegramPollingNetworkError, Ds as loadSessionStore, Du as resolveChunkMode, Ei as isTelegramClientRejection, Eo as readJsonBodyWithLimit, Eu as chunkMarkdownTextWithMode, Fi as buildSenderLabel, Fo as logAckFailure, Fr as logWebhookProcessed, Ft as resolveMentionGatingWithBypass, Gd as formatErrorMessage, Gi as getTelegramTextParts, Go as buildCommandTextFromArgs, Gr as isTelegramExecApprovalClientEnabled, Hi as describeReplyTarget, Ho as buildMentionRegexes, Ht as recordInboundSession, Ic as recordChannelActivity, Ii as buildSenderName, Io as logInboundDrop, Ir as logWebhookReceived, Ji as resolveTelegramDirectPeerId, Jn as computeBackoff, Jo as listNativeCommandSpecs, Jr as shouldEnableTelegramExecApprovalButtons, Jt as dispatchReplyWithBufferedBlockDispatcher, Kd as formatUncaughtError, Ki as hasBotMention, Ko as findCommandByNativeName, Kr as resolveTelegramExecApprovalConfig, Kt as removeAckReactionAfterReply, Li as buildTelegramGroupFrom, Lo as logTypingFailure, Lr as startDiagnosticHeartbeat, Lt as waitForAbortSignal, Mi as wrapFileReferencesInHtml, Mo as createReplyPrefixOptions, Ms as updateSessionStore, Mt as resolvePinnedMainDmOwnerFromAllowlist, Ni as splitTelegramCaption, No as resolveAckReaction, Od as saveMediaBuffer, Of as resolveAgentMaxConcurrent, Oi as tagTelegramNetworkError, Os as readSessionUpdatedAt, Ou as resolveTextChunkLimit, Pi as buildGroupLabel, Pr as logWebhookError, Q as createTelegramThreadBindingManager, Qd as findCodeRegions, Qi as resolveTelegramReplyId, Qt as formatInboundEnvelope, Qu as resolveChannelGroupPolicy, Ri as buildTelegramGroupPeerId, Ro as buildPendingHistoryContextFromMap, Rr as stopDiagnosticHeartbeat, Si as resolveTelegramVoiceSend, Su as getAgentScopedMediaLocalRoots, Ti as isSafeToRetrySendError, Tt as shouldDebounceTextInbound, Tu as resolveMarkdownTableMode, Ui as expandTextLinks, Uo as matchesMentionWithExplicit, Ur as getTelegramExecApprovalApprovers, Ut as resolveCommandAuthorizedFromAuthorizers, Vi as buildTypingThreadParams, Vn as applyModelOverrideToSessionEntry, Vo as recordPendingHistoryEntryIfEnabled, Wi as extractTelegramLocation, Wn as buildCommandsMessagePaginated, Wr as isTelegramExecApprovalApprover, Wt as resolveControlCommandGate, X as resolveStoredModelOverride, Xi as resolveTelegramGroupAllowFromContext, Xl as resolveGlobalSingleton, Xo as normalizeCommandBody, Xr as buildExecApprovalPendingReplyPayload, Xt as createInboundDebouncer, Yc as buildOutboundMediaLoadOptions, Yi as resolveTelegramForumThreadId, Yn as sleepWithAbort, Yo as listNativeCommandSpecsForConfig, Yr as shouldSuppressLocalTelegramExecApprovalPrompt, Zd as stripReasoningTagsFromText, Zi as resolveTelegramMediaPlaceholder, Zn as resolveSessionDeliveryTarget, Zo as parseCommandArgs, Zt as resolveInboundDebounceMs, _s as findModelInCatalog, aa as firstDefined, an as hasControlCommand, ar as toPluginMessageContext, bf as normalizeTelegramCommandName, bi as sendTypingTelegram, ca as formatLocationText, cn as buildModelsProviderData, da as resolveTelegramInlineButtonsScope, di as getCachedSticker, dn as listSkillCommandsForAgents, ds as resolveCommandAuthorization, ea as resolveTelegramThreadSpec, ei as buildProviderKeyboard, en as resolveEnvelopeFormatOptions, fi as buildInlineKeyboard, gn as resolveChannelConfigWrites, gr as formatDurationPrecise, hi as editMessageTelegram, ia as resolveSenderAllowMatch, ii as resolveModelSelection, ir as toInternalMessageSentContext, is as resolveNativeSkillsEnabled, ji as renderTelegramHtmlText, ki as markdownToTelegramChunks, la as toLocationContext, li as cacheSticker, ln as formatModelsAvailableHeader, mi as editMessageReplyMarkupTelegram, mn as isBtwRequestText, na as normalizeAllowFrom, nc as resolveThreadBindingSpawnPolicy, ni as getModelsPageSize, ns as isNativeCommandsExplicitlyDisabled, oa as readChannelAllowFromStore, of as loadConfig, on as isAbortRequestText, or as toPluginMessageSentEvent, os as getGlobalHookRunner, qi as normalizeForwardedContext, qr as resolveTelegramExecApprovalTarget, qt as shouldAckReaction, ra as normalizeDmAllowFromWithStore, rf as finalizeInboundContext, ri as parseModelCallbackData, ro as issuePairingChallenge, rr as buildCanonicalSentMessageHookContext, rs as resolveNativeCommandsEnabled, sa as upsertChannelPairingRequest, sr as fireAndForgetHook, ta as isSenderAllowed, tc as resolveThreadBindingMaxAgeMsForChannel, ti as calculateTotalPages, u as resolveDefaultModelForAgent, ua as withTelegramApiErrorLogging, uf as writeConfigFile, ui as describeStickerImage, un as buildCommandsPaginationKeyboard, vi as sendMessageTelegram, vr as enqueueSystemEvent, vs as loadModelCatalog, wi as isRecoverableTelegramNetworkError, ws as formatReasoningMessage, wu as fetchRemoteMedia, xf as resolveTelegramCustomCommands, xs as registerUnhandledRejectionHandler, xu as loadWebMedia, ya as resolveTelegramAccount, yf as TELEGRAM_COMMAND_NAME_PATTERN, ys as modelSupportsVision, zi as buildTelegramParentPeer, zo as clearHistoryEntriesIfEnabled } from "./auth-profiles-CuJtivJK.js";
import { n as resolveTelegramTransport, r as shouldRetryTelegramIpv4Fallback, s as makeProxyFetch, t as resolveTelegramFetch } from "./fetch-D2ZOzaXt.js";
...
import { n as isDiagnosticsEnabled } from "./diagnostic-events-TnjwArTt.js";
import { n as resolveConfiguredAcpRoute, t as ensureConfiguredAcpRouteReady } from "./persistent-bindings.route-ewa6bH8d.js";
import { a as createOperatorApprovalsGatewayClient, i as createStatusReactionController, n as DEFAULT_EMOJIS, o as resolveExecApprovalCommandDisplay, t as createFinalizableDraftLifecycle } from "./draft-stream-controls-5gJVEGoJ.js";
...
import { r as writeTelegramUpdateOffset, t as readTelegramUpdateOffset } from "./update-offset-store-B4-hCJHJ.js";
