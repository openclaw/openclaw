...
import { HS as applyAccountNameToChannelSection, WS as migrateBaseNameToDefaultAccount, __ as setTopLevelChannelGroupPolicy, l_ as promptSingleChannelSecretInput, n_ as buildSingleChannelSecretPromptState, r_ as mergeAllowFromEntries, t_ as addWildcardAllowFrom, xp as KeyedAsyncQueue } from "./auth-profiles-DqxBs6Au.js";
import { C as fetchWithSsrFGuard } from "./plugins-allowlist-CTOQWcBK.js";
...
import { T as mapAllowlistResolutionInputs, s as runPluginCommandWithTimeout, w as formatResolvedUnresolvedNote } from "./compat-Dz_94m24.js";
import { n as loadMatrixCredentials, s as getMatrixRuntime, t as credentialsMatchConfig } from "./credentials-CbR3GxLe.js";
...
async function resolveMatrixAuth(params) {
	...
	const { loadMatrixCredentials, saveMatrixCredentials, credentialsMatchConfig, touchMatrixCredentials } = await import("./credentials-BjQPGc1C.js");
...
async function createMatrixClient(params) {
	...
	if (params.encryption) {
		...
		try {
			const { StoreType } = await import("./matrix-sdk-crypto-nodejs-D3gM8xLw.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function resolveMediaDurationMs(params) {
	...
	try {
		const { parseBuffer } = await import("./lib-B7aQOgez.js");
