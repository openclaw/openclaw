...
import { ch as DISCORD_DEFAULT_INBOUND_WORKER_TIMEOUT_MS, lh as DISCORD_DEFAULT_LISTENER_TIMEOUT_MS, zS as sensitive } from "./auth-profiles-DqxBs6Au.js";
import { s as stripUrlUserInfo } from "./account-snapshot-fields-B_ffWpeH.js";
...
function normalizeTag(tag) {
	...
	return CONFIG_TAGS.has(normalized) ? normalized : null;
}
