...
import { Jn as setAccountEnabledInConfigSection, Un as buildAccountScopedDmSecurityPolicy, Xn as buildCatchallMultiAccountChannelSchema, Yn as AllowFromListSchema, Zn as buildChannelConfigSchema, fr as MarkdownConfigSchema, or as GroupPolicySchema, qn as deleteAccountFromConfigSection, rr as DmPolicySchema } from "./resolve-route-CQsiaDZO.js";
import { t as createAccountStatusSink } from "./channel-lifecycle-h2DwjEdV.js";
import { Fm as mapAllowFromEntries, Ud as buildBaseAccountStatusSnapshot, kp as ToolPolicySchema, wt as formatAllowFromLowercase } from "./auth-profiles-B70DPAVa.js";
import { _ as buildChannelSendResult, f as sendPayloadWithChunkedTextAndMedia, l as isNumericTargetId } from "./compat-CwB8x8Tr.js";
...
const zalouserPlugin = {
	...
	gateway: {
		startAccount: async (ctx) => {
			...
			const { monitorZalouserProvider } = await import("./monitor-BBxZWEjE.js");
