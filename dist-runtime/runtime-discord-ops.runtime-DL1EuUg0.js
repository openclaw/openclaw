import { C as warn, O as getChildLogger, Q as init_home_dir, W as init_paths, X as resolveStateDir, _ as isVerbose, g as init_globals, l as init_runtime, m as danger, n as init_subsystem, s as createNonExitingRuntime, t as createSubsystemLogger, tt as resolveRequiredHomeDir, v as logVerbose, x as shouldLogVerbose } from "./subsystem-CMvFcqxZ.js";
import { Pt as normalizeStringEntries, R as resolveStorePath, ht as testRegexWithBoundedInput, mt as compileSafeRegex } from "./query-expansion-BRXofpTG.js";
import { B as init_session_key, G as resolveThreadSessionKeys, Q as normalizeAccountId, W as resolveAgentIdFromSessionKey, Z as init_account_id } from "./workspace-BPUYxH8-.js";
import { D as truncateUtf16Safe, f as init_utils, n as logError, t as logDebug } from "./logger-C5Xia9ob.js";
import { $a as deriveLastRoutePolicy, $f as normalizeDiscordAllowList, $o as resolveThreadBindingMaxAgeMs, Aa as clearHistoryEntriesIfEnabled, Ap as retryAsync, As as resolveDiscordComponentEntry, At as hasControlCommand, Ba as parseCommandArgs, Bf as getSessionBindingService, Bs as createThreadDiscord, Ca as createReplyPrefixOptions, Cc as chunkDiscordTextWithMode, Co as isProfileInCooldown, Cp as warnMissingProviderGroupPolicyFallbackOnce, Cs as createDiscordFormModal, Ct as dispatchReplyWithDispatcher, Da as logInboundDrop, Dd as normalizeMessageChannel, Do as loadSessionStore, Ds as parseDiscordModalCustomId, Dt as resolveEnvelopeFormatOptions, Ea as logAckFailure, Ef as init_interactive, El as loadWebMedia, Es as parseDiscordComponentCustomIdForCarbon, Et as formatInboundEnvelope, Fa as findCommandByNativeName, Ff as buildPluginBindingResolvedText, Fl as resolveTextChunkLimit, Fn as formatDurationSeconds, Fp as resolveDiscordAccount, Fs as sendVoiceMessageDiscord, Ga as isNativeCommandsExplicitlyDisabled, Go as reconcileAcpThreadBindingsOnStartup, Ha as resolveCommandArgMenu, Ho as unregisterGateway, Hp as resolveAccountEntry, Hs as editMessageDiscord, Ia as listChatCommands, If as init_conversation_binding, In as enqueueSystemEvent, Ip as resolveDiscordMaxLinesPerMessage, Is as sendWebhookMessageDiscord, It as listSkillCommandsForAgents, Jf as init_directory_live, Jo as createThreadBindingManager, Ka as resolveNativeCommandsEnabled, Ks as pinMessageDiscord, Lf as isPluginOwnedSessionBindingRecord, Lp as init_token, Ls as formatMention, Ma as buildMentionRegexes, Mf as getPluginCommandSpecs, Ml as resolveMarkdownTableMode, Mo as updateSessionStore, Mp as init_accounts, Ms as sendMessageDiscord, Na as matchesMentionWithExplicit, Nf as init_commands, Ns as sendPollDiscord, Nt as buildModelsProviderData, Oa as logTypingFailure, Oc as inspectDiscordAccount, Oo as readSessionUpdatedAt, Op as init_retry, Os as parseDiscordModalCustomIdForCarbon, Ot as dispatchInboundMessage, Pa as buildCommandTextFromArgs, Pf as matchPluginCommand, Pl as resolveChunkMode, Qa as buildAgentSessionKey, Qf as isDiscordGroupAllowedByPolicy, Qu as formatErrorMessage, Ra as listNativeCommandSpecsForConfig, Rf as parsePluginBindingApprovalCustomId, Rp as normalizeDiscordToken, Rs as convertMarkdownTables, Sa as createTypingCallbacks, Sc as createDiscordRetryRunner, So as clearExpiredCooldowns, Sp as resolveOpenProviderRuntimeGroupPolicy, Ss as sendDiscordComponentMessage, St as dispatchReplyWithBufferedBlockDispatcher, Ta as resolveHumanDelayConfig, Tf as dispatchPluginInteractiveHandler, Ti as upsertChannelPairingRequest, Ts as parseDiscordComponentCustomId, Ua as serializeCommandArgs, Up as normalizeProviderId, Va as resolveCommandArgChoices, Vf as init_session_binding_service, Vo as registerGateway, Vp as init_account_lookup, Vs as deleteMessageDiscord, Vu as saveMediaBuffer, W as resolveStoredModelOverride, Wa as shouldHandleTextCommands, Xf as listDiscordDirectoryPeersLive, Xo as isRecentlyUnboundThreadWebhookMessage, Yf as listDiscordDirectoryGroupsLive, Yo as isThreadArchived, Ys as unpinMessageDiscord, Zf as init_allow_list, Zo as resolveThreadBindingIdleTimeoutMs, _a as writeJsonFileAtomically, _c as sendDiscordText, _t as recordInboundSession, ad as loadConfig, ap as resolveDiscordOwnerAccess, bs as removeReactionDiscord, cp as resolveGroupDmAllow, dp as formatDiscordUserTag, ds as normalizeDiscordInboundWorkerTimeoutMs, dt as withTimeout, en as EmbeddedBlockChunker, eo as resolveAgentRoute, ep as normalizeDiscordSlug, fp as init_format, fs as normalizeDiscordListenerTimeoutMs, ft as readStoreAllowFromForDmPolicy, ga as readJsonFileWithFallback, ha as buildPairingReply, hs as auditDiscordChannelPermissions, ht as resolveMentionGatingWithBypass, io as isAcpRuntimeError, ip as resolveDiscordMemberAccessState, ja as recordPendingHistoryEntryIfEnabled, jf as executePluginCommand, jl as fetchRemoteMedia, js as resolveDiscordModalEntry, k as createConnectedChannelStatusPatch, ka as buildPendingHistoryContextFromMap, kl as getAgentScopedMediaLocalRoots, kp as resolveRetryConfig, kt as createReplyDispatcherWithTyping, lp as shouldEmitDiscordReactionNotification, lt as createChannelInboundDebouncer, ma as issuePairingChallenge, mp as resolveTimestampMs, mt as resolvePinnedMainDmOwnerFromAllowlist, nd as withFileLock, no as getAcpSessionManager, np as resolveDiscordChannelConfigWithFallback, ns as resolveThreadBindingsEnabled, op as resolveDiscordOwnerAllowFrom, os as resolveDiscordUserAllowlist, pc as editChannelDiscord, pp as resolveDiscordSystemLocation, ps as runDiscordTaskWithTimeout, pt as resolveDmGroupAccessWithLists, qa as resolveNativeSkillsEnabled, qo as createNoopThreadBindingManager, rd as finalizeInboundContext, ro as KeyedAsyncQueue, rp as resolveDiscordGuildEntry, rs as formatThreadBindingDurationLabel, sp as resolveDiscordShouldRequireMention, ss as resolveDiscordChannelAllowlist, td as ensureAuthProfileStore, tp as resolveDiscordAllowListMatch, up as formatDiscordReactionEmoji, ur as getExecApprovalApproverDmNoticeText, ut as shouldDebounceTextInbound, vc as stripUndefinedFields, vp as GROUP_POLICY_BLOCKED_LABEL, vs as reactMessageDiscord, vt as resolveCommandAuthorizedFromAuthorizers, wa as resolveAckReaction, wo as resolveProfilesUnavailableReason, ws as formatDiscordComponentEventText, xc as createDiscordClient, xp as resolveDefaultGroupPolicy, xs as sendTypingDiscord, xt as shouldAckReaction, ya as resolveAgentAvatar, yd as resolveDiscordPreviewStreamMode, yo as stripReasoningTagsFromText, yp as init_runtime_group_policy, yt as resolveControlCommandGate, zf as resolvePluginConversationBindingApproval, zo as setPresence, zs as recordChannelActivity } from "./model-selection-DTQXVq3-.js";
import "./frontmatter-D0JIibvS.js";
import { d as resolveFetch, f as wrapFetchWithAbortSignal, h as init_fetch_timeout, m as fetchWithTimeout, u as init_fetch } from "./fetch-3gMSdRzB.js";
import "./boolean-Cuaw_-7j.js";
import { a as patchAllowlistUsersInConfigEntries, c as chunkItems, d as formatAllowlistMatchMeta, l as buildUntrustedChannelMetadata, n as buildAllowlistResolutionSummary, o as summarizeMapping, r as canonicalizeAllowlistWithResolvedIds, s as summarizeStringEntries, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-CNCwVTqP.js";
...
import { a as createFinalizableDraftLifecycle, c as createStatusReactionController, i as resolveConfiguredAcpRoute, n as createOperatorApprovalsGatewayClient, r as ensureConfiguredAcpRouteReady, s as DEFAULT_TIMING, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CSh18Pdb.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BjI5eIx1.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./audio-preflight-8ZG91nnx.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-BkxhpVnk.js");
