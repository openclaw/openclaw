...
import { Hn as PAIRING_APPROVED_MESSAGE, Qn as buildNestedDmConfigSchema, Yn as AllowFromListSchema, Zn as buildChannelConfigSchema, fr as MarkdownConfigSchema, or as GroupPolicySchema } from "./resolve-route-CQsiaDZO.js";
import { Am as createScopedAccountConfigAccessors, D as collectAllowlistProviderGroupPolicyWarnings, E as buildOpenGroupPolicyWarning, Kd as buildProbeChannelStatusSummary, Mm as createScopedDmSecurityResolver, Xo as buildSecretInputSchema, Yd as collectStatusIssuesFromLastError, jm as createScopedChannelConfigBase, kp as ToolPolicySchema } from "./auth-profiles-B70DPAVa.js";
import { C as readReactionParams, E as readStringParam, S as readNumberParam, _ as createActionGate, b as jsonResult } from "./external-content-CxoN_TKD.js";
import { r as buildTrafficStatusSummary } from "./channel-status-summary-DPOZ4DXQ.js";
import { D as isBunRuntime, S as resolveSharedMatrixClient, T as resolveMatrixAuth, _ as resolveDefaultMatrixAccountId, c as getActiveMatrixClient, g as listMatrixAccountIds, m as matrixSetupAdapter, n as sendMessageMatrix, o as resolveMatrixRoomId, p as matrixSetupWizard, s as createPreparedMatrixClient, t as reactMatrixMessage, v as resolveMatrixAccount, y as resolveMatrixAccountConfig } from "./send-DNnFxfme.js";
import { s as getMatrixRuntime } from "./credentials-DVM78uq2.js";
import { a as resolveMatrixRoomConfig, c as summarizeMatrixRawEvent, d as RelationType, l as EventType, n as normalizeMatrixUserId, o as fetchEventSummary, s as readPinnedEvents, t as normalizeMatrixAllowList, u as MsgType } from "./allowlist-CxaoknYd.js";
import { z } from "zod";
...
async function loadMatrixChannelRuntime() {
	return await import("./channel.runtime-DxTOYeCB.js");
}
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		try {
			monitorMatrixProvider = (await import("./matrix-DQ3KwzD9.js")).monitorMatrixProvider;
		} finally {
			releaseLock();
		}
