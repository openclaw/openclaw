import { p as getResolvedLoggerSettings } from "./globals-I5DlBD2D.js";
...
import { t as isTruthyEnvValue$1 } from "./env-Bdj-riuG.js";
import { C as sleep, S as shortenHomePath, y as resolveUserPath } from "./utils-Do8MzKyM.js";
import { $u as guardCancel, Bd as callGateway, Dl as resolveCronStorePath, Dy as resolveGoogleChromeExecutableForPlatform, E as getModelRefStatus, El as loadCronStore, Ey as readBrowserVersion, I as resolveHooksGmailModel, Js as resolveBootstrapContextForRun, Jt as formatRemainingShort, Ju as applyWizardMetadata, Kt as DEFAULT_OAUTH_WARN_MS, Md as hasConfiguredMemorySecretInput, Ol as saveCronStore, P as resolveConfiguredModelRef, Q as loadOpenClawPlugins, Qp as resolveAgentSessionDirs, Qv as resolveMainSessionKey, Qx as DEFAULT_PROVIDER, Qy as resolveConfiguredSecretInputWithFallback, Ty as parseBrowserMajorVersion, Wb as readConfigFileSnapshot, Yb as writeConfigFile, Z as resolvePluginProviders, Zx as DEFAULT_MODEL, _ as updateAuthProfileStoreWithLock, ab as hasAmbiguousGatewayAuthModeConfig, bi as buildBootstrapInjectionStats, c as resolveApiKeyForProfile, ey as formatSessionArchiveTimestamp, id as printWizardHeader, im as loadSessionStore, jp as loadModelCatalog, l as repairOAuthProfileIdMismatch, o as resolveProfileUnusableUntilForDisplay, ob as resolveBootstrapMaxChars, od as randomToken, p as ensureAuthProfileStore, qt as buildAuthHealthSummary, sb as resolveBootstrapTotalMaxChars, ty as isPrimarySessionTranscriptFileName, vb as resolveApiKeyForProvider, yi as analyzeBootstrapBudget, zd as buildGatewayConnectionDetails } from "./auth-profiles-DqxBs6Au.js";
...
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-tkfLX5MZ.js";
...
import { B as resolveSandboxScope, it as DEFAULT_SANDBOX_BROWSER_IMAGE, k as cleanStaleLockFiles, ot as DEFAULT_SANDBOX_IMAGE } from "./workspace-dirs-D1oDbsnN.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-DIDe1qlM.js";
import { a as isLoopbackHost, f as resolveGatewayBindHost } from "./device-metadata-normalization-a2oQYp64.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-DeHp-MTZ.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-YN5WLIkL.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-C8ub4F0Y.js";
import { a as isWSLEnv, i as isWSL } from "./fetch-CzYOE42F.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-qfNerugD.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BI0f8wZY.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DqOsOwLH.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-cQOj5Aup.js";
...
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-BbDrm470.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DC_Pq39i.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-Bb__IPfT.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-DDKGngJK.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-C5x1GrBv.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-D7tu172r.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BnGfb4xp.js";
import { r as healthCommand } from "./health-D7ZxsaPF.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-AIHB76qG.js";
import { p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-DMn8YpUs.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DH9mhah5.js";
import { n as logConfigUpdated } from "./logging-DySkJB06.js";
import { t as note$1 } from "./note-DjpUEsPR.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-G2xaBDs-.js";
...
import { n as doctorShellCompletion } from "./doctor-completion-CML35nn7.js";
import { a as runLegacyStateMigrations, i as detectLegacyStateMigrations, r as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-DTiUQxXq.js";
...
function collectChromeMcpProfiles(cfg) {
	...
	for (const [profileName, rawProfile] of Object.entries(configuredProfiles)) {
		const profile = asRecord$1(rawProfile);
...
async function noteOpenAIOAuthTlsPrerequisites(params) {
	...
	note$1(formatOpenAIOAuthTlsPreflightFix(result), "OAuth TLS prerequisites");
}
//#endregion
