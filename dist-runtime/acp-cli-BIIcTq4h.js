...
import { Bb as loadConfig, Db as omitEnvKeysCaseInsensitive, H as listThinkingLevels, Tb as listKnownProviderAuthEnvVarNames, zd as buildGatewayConnectionDetails } from "./auth-profiles-DqxBs6Au.js";
...
import { $ as isKnownCoreToolId } from "./workspace-dirs-D1oDbsnN.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-wAr9-kfm.js");
