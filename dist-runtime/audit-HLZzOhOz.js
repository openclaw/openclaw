import { i as init_paths, s as resolveConfigPath, v as resolveStateDir } from "./paths-DqbqmTPe.js";
import { Bs as listInterpreterLikeSafeBins, Hs as resolveMergedSafeBinProfileFixtures, Ky as resolveBrowserControlAuth, XS as hasPotentialConfiguredChannels, my as redactCdpUrl, wx as normalizeTrustedSafeBinDirs } from "./auth-profiles-DAOR1fRn.js";
import { $ as isBlockedHostnameOrIp, tt as isPrivateNetworkAllowedByPolicy } from "./plugins-allowlist-E4LSkJ7R.js";
import { a as hasConfiguredSecretInput, o as init_types_secrets } from "./types.secrets-Cu0Lz6pi.js";
import { t as formatCliCommand } from "./command-format-CS805JpF.js";
import { m as resolveGatewayAuth, n as resolveBrowserConfig, r as resolveProfile } from "./config-DZ3oWznn.js";
import { M as formatPermissionDetail, N as formatPermissionRemediation, P as inspectPathPermissions, z as resolveSandboxConfigForAgent } from "./workspace-dirs-Ejflbukt.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-ACVy39Yu.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CnZ_Yvu6.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-CFkQe_IR.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-CIz6eSzB.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-DB4Df3tB.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-eI2_fQJD.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-CDkmhXB8.js"),
		import("./probe-auth-Cc6tCZxX.js"),
		import("./probe-CHAqlo2L.js")
