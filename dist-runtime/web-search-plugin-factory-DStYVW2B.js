...
import { f as logVerbose } from "./subsystem-CsP80x3t.js";
import { E as readStringParam, S as readNumberParam, a as readResponseText, b as jsonResult, c as writeCache, d as withTrustedWebToolsEndpoint, i as readCache, n as wrapWebContent, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as withStrictWebToolsEndpoint, w as readStringArrayParam } from "./external-content-vZzOHxnd.js";
...
function isSearchProvider(value) {
	return SEARCH_PROVIDERS.has(value);
}
...
function resolvePerplexitySchemaTransportHint(perplexity) {
	return perplexity?.baseUrl && perplexity.baseUrl.trim() || perplexity?.model && perplexity.model.trim() ? "chat_completions" : void 0;
}
