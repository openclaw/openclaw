...
import { l as defaultRuntime, u as restoreTerminalState } from "./subsystem-EnljYYs1.js";
import { y as resolveUserPath } from "./utils-Do8MzKyM.js";
import { Ju as applyWizardMetadata, Wb as readConfigFileSnapshot, Yb as writeConfigFile, Zu as ensureWorkspaceAndSessions, cd as resolveControlUiLinks, ed as handleReset, fd as waitForGatewayReachable, nd as normalizeGatewayTokenInput, od as randomToken, qu as DEFAULT_WORKSPACE } from "./auth-profiles-DqxBs6Au.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-CgNgVfYE.js";
...
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, s as resolveManifestProviderOnboardAuthFlags } from "./auth-choice-legacy-aidPRzV-.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-BKO5Qti2.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BHhppQ13.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Lem9GDaE.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DSq9PtVS.js");
