import { $l as getChannelPlugin, A as getCliSessionId, Bt as normalizeReplyPayload, Dt as getSkillsSnapshotVersion, En as clearBootstrapSnapshotOnSessionRollover, Et as getRemoteSkillEligibility, Fa as emitSessionTranscriptUpdate, Fl as formatCliCommand, Ga as resolveSessionKey, Ha as normalizeAccountId, Hc as buildWorkspaceSkillSnapshot, Ht as prepareSessionManagerForRun, Hu as DEFAULT_PROVIDER, Ia as loadSessionStore, Iu as normalizeProviderId, Jc as readConfigFileSnapshotForWrite, Jt as resolveAcpAgentPolicyError, Kt as normalizeSpawnedRunMetadata, Lu as formatXHighModelHint, M as runCliAgent, P as applyVerboseOverride, Pa as resolveSessionTranscriptFile, Qt as applyModelOverrideToSessionEntry, Ru as normalizeThinkLevel, Sa as loadModelCatalog, Uc as ensureAuthProfileStore, Va as updateSessionStore, Vt as runEmbeddedPiAgent, Vu as DEFAULT_MODEL, Wt as resolveBootstrapWarningSignaturesSeen, Xt as AGENT_LANE_NESTED, Yc as setRuntimeConfigSnapshot, Yt as resolveAcpDispatchPolicyError, Zt as AGENT_LANE_SUBAGENT, _i as emitAgentEvent, _l as isSilentReplyPrefixText, _n as resolveMessageChannelSelection, ac as evaluateSessionFreshness, an as resolveOutboundTarget, bn as runWithModelFallback, c as resolveThinkingDefault, cc as resolveSessionResetType, cl as isGatewayMessageChannel, cn as deliverOutboundPayloads, da as getAcpSessionManager, dl as resolveMessageChannel, dn as normalizeOutboundPayloadsForJson, en as deriveSessionTotalTokens, eu as normalizeChannelId, fc as resolveExplicitAgentSessionKey, gi as clearAgentRunContext, i as normalizeModelRef, j as setCliSessionId, kt as clearSessionAuthProfileOverride, l as formatThinkingLevels, lc as mergeSessionEntry, ll as isInternalMessageChannel, ln as formatOutboundPayloadLog, ma as toAcpRuntimeError, ml as resolveAgentTimeoutMs, n as isCliProvider, nn as resolveContextTokensForModel, o as resolveConfiguredModelRef, oc as resolveChannelResetConfig, ol as INTERNAL_MESSAGE_CHANNEL, on as resolveSessionDeliveryTarget, qc as loadConfig, qt as resolveAcpSessionCwd, r as modelKey, ra as resolveSendPolicy, s as resolveDefaultModelForAgent, sc as resolveSessionResetPolicy, sl as isDeliverableMessageChannel, sn as buildOutboundSessionContext, t as buildAllowedModelSet, tn as hasNonzeroUsage, u as supportsXHighThinking, uc as setSessionRuntimeModel, ul as normalizeMessageChannel, un as normalizeOutboundPayloads, vi as registerAgentRunContext, vl as isSilentReplyText, vn as getAgentRuntimeCommandSecretTargetIds, xn as FailoverError, yn as resolveCommandSecretRefsViaGateway, zt as formatAgentInternalEventsForPrompt, zu as normalizeVerboseLevel } from "./model-selection-BJ_ZbQnz.js";
import { Dt as resolveEffectiveModelFallbacks, R as resolveStorePath, Tt as resolveAgentWorkspaceDir, bt as resolveAgentDir, kt as resolveSessionAgentId, vt as listAgentIds, wt as resolveAgentSkillsFilter } from "./query-expansion-CG1BbCN9.js";
import { a as defaultRuntime, t as createSubsystemLogger } from "./subsystem-BrPedHYO.js";
import { H as normalizeMainKey, U as resolveAgentIdFromSessionKey, V as normalizeAgentId, l as ensureAgentWorkspace } from "./workspace-CwIhVocA.js";
...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./model-selection-BJ_ZbQnz.js").then((n) => n.g), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./model-selection-BJ_ZbQnz.js").then((n) => n.Un), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./model-selection-BJ_ZbQnz.js").then((n) => n.Ka), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./model-selection-BJ_ZbQnz.js").then((n) => n.Jo), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./model-selection-BJ_ZbQnz.js").then((n) => n.di), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./imessage-DV7Phosg.js"), "sendMessageIMessage")
	};
}
//#endregion
...
//#endregion
export { agentCommandFromIngress as n, createDefaultDeps as r, agentCommand as t };
