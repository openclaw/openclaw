...
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, s as init_session_key, u as normalizeMainKey } from "./session-key-BSZsryCD.js";
import { Mt as resolveDiscordOwnerAccess, Rt as formatDiscordUserTag, ct as getChannelPlugin, dt as normalizeChannelId, i as resolveAgentRoute, wt as init_allow_list, zt as init_format } from "./resolve-route-CQsiaDZO.js";
...
import { c as defaultRuntime, g as init_globals, l as init_runtime, n as init_subsystem, t as createSubsystemLogger, v as logVerbose, x as shouldLogVerbose } from "./subsystem-CsPxmH8p.js";
import "./utils-CMc9mmF8.js";
import "./fetch-BgkAjqxB.js";
import "./retry-CgLvWye-.js";
import { S as ensureAgentWorkspace, c as resolveAgentWorkspaceDir, f as resolveSessionAgentId, i as resolveAgentDir, n as listAgentIds, s as resolveAgentSkillsFilter, u as resolveEffectiveModelFallbacks } from "./agent-scope-CM8plEdu.js";
import "./exec-CWMR162-.js";
import "./logger-C833gw0R.js";
import "./paths-DAoqckDF.js";
import { $ as runCliAgent, $s as updateSessionStore, An as normalizeReplyPayload, As as getAcpSessionManager, Bn as resolveAcpSessionCwd, Bp as INTERNAL_MESSAGE_CHANNEL, Cr as clearBootstrapSnapshotOnSessionRollover, Er as parseTtsDirectives, Es as resolveSendPolicy, Fs as normalizeMediaAttachments, Gm as formatXHighModelHint, Gn as applyModelOverrideToSessionEntry, Gp as resolveMessageChannel, Hn as resolveAcpDispatchPolicyError, Hp as isGatewayMessageChannel, Jp as resolveAgentTimeoutMs, Js as loadSessionStore, Km as normalizeThinkLevel, Ks as resolveSessionTranscriptFile, Lp as DEFAULT_MODEL, Ls as runCapability, Mn as prepareSessionManagerForRun, Ns as buildProviderRegistry, Pn as resolveBootstrapWarningSignaturesSeen, Ps as createMediaAttachmentCache, Q as setCliSessionId, Qf as formatErrorMessage, Rp as DEFAULT_PROVIDER, Tr as textToSpeech, Un as AGENT_LANE_NESTED, Up as isInternalMessageChannel, Vn as resolveAcpAgentPolicyError, Vp as isDeliverableMessageChannel, Wn as AGENT_LANE_SUBAGENT, Wp as normalizeMessageChannel, Xn as hasNonzeroUsage, Yn as deriveSessionTotalTokens, Z as getCliSessionId, Zn as resolveContextTokensForModel, _f as resolveExplicitAgentSessionKey, _n as getSkillsSnapshotVersion, a as buildAllowedModelSet, ao as clearAgentRunContext, ar as normalizeOutboundPayloads, c as normalizeModelRef, d as resolveThinkingDefault, df as evaluateSessionFreshness, em as isSilentReplyPrefixText, er as resolveOutboundTarget, f as formatThinkingLevels, ff as resolveChannelResetConfig, gf as setSessionRuntimeModel, gn as getRemoteSkillEligibility, gp as setRuntimeConfigSnapshot, hf as mergeSessionEntry, hp as readConfigFileSnapshotForWrite, hr as resolveCommandSecretRefsViaGateway, ic as resolveSessionKey, ir as formatOutboundPayloadLog, jn as runEmbeddedPiAgent, kn as formatAgentInternalEventsForPrompt, l as resolveConfiguredModelRef, mf as resolveSessionResetType, mr as getAgentRuntimeCommandSecretTargetIds, nc as normalizeAccountId, nr as buildOutboundSessionContext, o as isCliProvider, oo as emitAgentEvent, or as normalizeOutboundPayloadsForJson, p as supportsXHighThinking, pf as resolveSessionResetPolicy, pp as loadConfig, pr as resolveMessageChannelSelection, qm as normalizeVerboseLevel, qs as emitSessionTranscriptUpdate, rr as deliverOutboundPayloads, s as modelKey, so as registerAgentRunContext, tm as isSilentReplyText, tp as buildWorkspaceSkillSnapshot, tr as resolveSessionDeliveryTarget, tt as applyVerboseOverride, u as resolveDefaultModelForAgent, ul as formatMention, vr as runWithModelFallback, wr as resolveTtsConfig, yn as clearSessionAuthProfileOverride, yr as FailoverError, zn as normalizeSpawnedRunMetadata, zs as loadModelCatalog } from "./auth-profiles-B70DPAVa.js";
...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./whatsapp-DSn1UBrE.js"), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./telegram-Cn2wcB2-.js"), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./discord-CUw6SQdg.js"), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./slack-DJM27gqm.js"), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./signal-JxbUjIuw.js"), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./imessage-BZxmIeUy.js"), "sendMessageIMessage")
	};
}
//#endregion
