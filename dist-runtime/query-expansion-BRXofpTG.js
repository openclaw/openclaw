import { M as init_node_require, N as resolveNodeRequireFromMeta, Q as init_home_dir, W as init_paths, X as resolveStateDir, Z as expandHomePrefix, n as init_subsystem, t as createSubsystemLogger, tt as resolveRequiredHomeDir } from "./subsystem-CMvFcqxZ.js";
import { A as isNotFoundPathError, B as init_session_key, D as resolveBoundaryPath, E as BOUNDARY_PATH_ALIAS_POLICIES, H as normalizeAgentId, M as isSymlinkOpenError, P as DEFAULT_AGENT_ID, T as sameFileIdentity, W as resolveAgentIdFromSessionKey, j as isPathInside, k as hasNodeErrorCode, p as resolveDefaultAgentWorkspaceDir, st as parseAgentSessionKey } from "./workspace-BPUYxH8-.js";
import { b as resolveUserPath, f as init_utils, i as logWarn } from "./logger-C5Xia9ob.js";
import { createRequire } from "node:module";
import fs from "node:fs/promises";
import os from "node:os";
import path from "node:path";
import syncFs, { constants, readFileSync, statSync } from "node:fs";
...
//#endregion
export { createRootScopedReadFile as $, supportsMemoryMultimodalEmbeddings as A, resolveSessionAgentIds as At, extensionForMime as B, isFileMissingError as C, resolveAgentModelFallbacksOverride as Ct, getMemoryMultimodalExtensions as D, resolveEffectiveModelFallbacks as Dt, classifyMemoryMultimodalPath as E, resolveDefaultAgentId as Et, resolveSessionTranscriptPath as F, normalizeStringEntriesLower as Ft, kindFromMime as G, imageMimeFromFormat as H, resolveSessionTranscriptPathInDir as I, resolveAgentModelFallbackValues as It, maxBytesForKind as J, normalizeMimeType as K, resolveSessionTranscriptsDirForAgent as L, resolveAgentModelPrimaryValue as Lt, resolveDefaultSessionStorePath as M, normalizeAtHashSlug as Mt, resolveSessionFilePath as N, normalizeHyphenSlug as Nt, isMemoryMultimodalEnabled as O, resolveRunModelFallbacksOverride as Ot, resolveSessionFilePathOptions as P, normalizeStringEntries as Pt, copyFileWithinRoot as Q, resolveStorePath as R, toAgentModelListLike as Rt, splitTextToUtf8ByteLimit as S, resolveAgentIdByWorkspacePath as St, buildCaseInsensitiveExtensionGlob as T, resolveAgentWorkspaceDir as Tt, isAudioFileName as U, getFileExtension as V, isGifMedia as W, SafeOpenError as X, mediaKindFromMime as Y, appendFileWithinRoot as Z, remapChunkLines as _, hasConfiguredModelFallbacks as _t, listSessionFilesForAgent as a, writeFileWithinRoot as at, estimateStructuredEmbeddingInputBytes as b, resolveAgentDir as bt, buildMultimodalChunkForIndexing as c, PATH_ALIAS_POLICIES as ct, ensureDir as d, redactSensitiveText as dt, openFileWithinRoot as et, hashText as f, redactToolDetail as ft, parseEmbedding as g, runTasksWithConcurrency as gt, normalizeExtraMemoryPaths as h, testRegexWithBoundedInput as ht, buildSessionEntry as i, writeFileFromPathWithinRoot as it, resolveAgentsDirFromSessionStorePath as j, normalizeSkillFilter as jt, normalizeMemoryMultimodalSettings as k, resolveSessionAgentId as kt, chunkMarkdown as l, assertNoPathAliasEscape as lt, listMemoryFiles as m, compileSafeRegex as mt, isQueryStopWordToken as n, readFileWithinRoot as nt, sessionPathForFile as o, materializeWindowsSpawnProgram as ot, isMemoryPath as p, compileConfigRegexes as pt, MAX_IMAGE_BYTES as q, requireNodeSqlite as r, readLocalFileSafely as rt, buildFileEntry as s, resolveWindowsSpawnProgram as st, extractKeywords as t, openWritableFileWithinRoot as tt, cosineSimilarity as u, getDefaultRedactPatterns as ut, runWithConcurrency as v, listAgentIds as vt, statRegularFile as w, resolveAgentSkillsFilter as wt, estimateUtf8Bytes as x, resolveAgentEffectiveModelPrimary as xt, hasNonTextEmbeddingParts as y, resolveAgentConfig as yt, detectMime as z };
