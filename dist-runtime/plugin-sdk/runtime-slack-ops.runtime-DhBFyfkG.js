import { d as resolveThreadSessionKeys, g as normalizeAccountId, l as normalizeMainKey } from "./session-key-CbP51u9x.js";
import { C as parsePluginBindingApprovalCustomId, Ct as warnMissingProviderGroupPolicyFallbackOnce, Jt as normalizeResolvedSecretInputString, Ot as resolveChannelEntryMatchWithFallback, Tt as buildChannelKeyCandidates, bt as resolveDefaultGroupPolicy, c as dispatchPluginInteractiveHandler, ft as evaluateGroupRouteAccessForPolicy, l as createDedupeCache, u as pruneMapToMaxSize, v as buildPluginBindingResolvedText, w as resolvePluginConversationBindingApproval, wt as applyChannelMatchMeta, xt as resolveOpenProviderRuntimeGroupPolicy } from "./runtime-DRRlb-lt.js";
import { $c as normalizeSlackOutboundText, $o as updateLastRoute, Ac as hasSlackThreadParticipation, Bc as pinSlackMessage, Cl as resolveSlackReplyToMode, Co as shouldHandleTextCommands, Dc as truncateSlackText, Eo as resolveNativeSkillsEnabled, Fc as editSlackMessage, Gc as sendSlackMessage, Hc as readSlackMessages, Ic as getSlackMemberInfo, Iu as finalizeInboundContext, Jc as resolveSlackMedia, Kc as unpinSlackMessage, Lc as listSlackEmojis, Lt as createChannelInboundDebouncer, Lu as resolveConversationLabel, Nc as deleteSlackMessage, Oc as resolveSlackUserAllowlist, Pc as downloadSlackFile, Rc as listSlackPins, Rt as shouldDebounceTextInbound, Ru as loadConfig, Sl as resolveSlackAccount, Tl as resolveSlackBotToken, To as resolveNativeCommandsEnabled, Uc as removeOwnSlackReactions, Vc as reactSlackMessage, Vt as readStoreAllowFromForDmPolicy, Vu as writeConfigFile, Wa as issuePairingChallenge, Wc as removeSlackReaction, Xc as resolveSlackThreadStarter, Xl as generateSecureToken, Xo as readSessionUpdatedAt, Xt as resolveMentionGatingWithBypass, Yc as resolveSlackThreadHistory, Za as resolveAgentOutboundIdentity, Zc as sendMessageSlack, _l as jsonResult, _n as hasControlCommand, ao as buildPendingHistoryContextFromMap, ar as sleepWithAbort, as as resolveSessionKey, bl as readStringParam, dl as normalizeSlackWebhookPath, do as buildMentionRegexes, el as createSlackWebClient, eo as createTypingCallbacks, fl as registerSlackHttpHandler, fn as resolveEnvelopeFormatOptions, fo as matchesMentionWithExplicit, gl as imageResultFromFile, hl as createActionGate, hn as createReplyDispatcherWithTyping, in as resolveControlCommandGate, ir as computeBackoff, jc as recordSlackThreadParticipation, jn as resolveChannelConfigWrites, kc as resolveSlackChannelAllowlist, kd as installRequestBodyLimitGuard, kr as enqueueSystemEvent, ll as resolveTextChunkLimit, nd as withNormalizedTimestamp, nn as recordInboundSession, no as logInboundDrop, pa as upsertChannelPairingRequest, pl as parseSlackBlocksInput, pn as dispatchInboundMessage, qc as resolveSlackAttachmentContent, qt as resolvePinnedMainDmOwnerFromAllowlist, rn as resolveCommandAuthorizedFromAuthorizers, ro as logTypingFailure, so as clearHistoryEntriesIfEnabled, tl as resolveSlackWebClientOptions, to as logAckFailure, tt as createConnectedChannelStatusPatch, un as formatInboundEnvelope, uo as recordPendingHistoryEntryIfEnabled, vl as readNumberParam, wl as resolveSlackAppToken, yl as readReactionParams, zc as listSlackReactions, zt as withTimeout } from "./setup-wizard-helpers-Bds9SZeS.js";
import "./provider-env-vars-CWXfFyDU.js";
import { t as getChildLogger } from "./logger-DEV1v8zB.js";
import "./tmp-openclaw-dir-DGafsubg.js";
import { _ as warn, f as logVerbose, h as shouldLogVerbose, i as createNonExitingRuntime, l as danger } from "./subsystem-BunQspj4.js";
...
import { B as resolveSlackStreamingMode, L as mapStreamingModeToSlackLegacyDraftStreamMode, z as resolveSlackNativeStreaming } from "./signal-Bycwzc0M.js";
import "./config-helpers-C9J9Kf27.js";
import "./fetch-CokEYQHV.js";
import "./exec-LHBFP7K9.js";
import { A as normalizeHyphenSlug, M as normalizeStringEntriesLower, j as normalizeStringEntries } from "./agent-scope-BAdJcjtf.js";
import { S as resolveSlackChannelId, i as resolveAckReaction, n as createReplyPrefixOptions, s as resolveHumanDelayConfig, x as parseSlackTarget } from "./reply-prefix-B-13vT7e.js";
...
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-DbjS-djs.js";
import { a as patchAllowlistUsersInConfigEntries, i as mergeAllowlist, n as buildAllowlistResolutionSummary, o as summarizeMapping, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-D-PSzOHf.js";
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-BYEb4pPT.js";
import { n as createDraftStreamLoop, t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-D1Opk5OF.js";
import { n as buildUntrustedChannelMetadata, t as chunkItems } from "./chunk-items-CHoAXWF4.js";
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-BFRxBJQL.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-CtJIpoAB.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-D2jSD1pU.js");
