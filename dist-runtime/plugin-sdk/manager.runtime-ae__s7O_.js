import { c as normalizeAgentId, l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-CbP51u9x.js";
import { N as normalizeChannelId, j as getChannelPlugin, lt as formatDiscordUserTag, rt as resolveDiscordOwnerAccess } from "./runtime-DRRlb-lt.js";
import { $n as applyModelOverrideToSessionEntry, A as supportsXHighThinking, Aa as registerAgentRunContext, An as clearSessionAuthProfileOverride, Ar as clearBootstrapSnapshotOnSessionRollover, Bn as formatAgentInternalEventsForPrompt, Bu as setRuntimeConfigSnapshot, C as isCliProvider, Cr as FailoverError, D as resolveDefaultModelForAgent, Do as resolveSendPolicy, E as resolveConfiguredModelRef, Eu as formatErrorMessage, Fl as resolveSessionResetType, Fo as normalizeMediaAttachments, Gn as resolveBootstrapWarningSignaturesSeen, Gu as DEFAULT_MODEL, Hn as runEmbeddedPiAgent, Il as mergeSessionEntry, Jn as resolveAcpSessionCwd, Jo as emitSessionTranscriptUpdate, Ju as isDeliverableMessageChannel, Ku as DEFAULT_PROVIDER, Ll as setSessionRuntimeModel, Lo as runCapability, Ml as evaluateSessionFreshness, Mr as textToSpeech, Nl as resolveChannelResetConfig, No as buildProviderRegistry, Nr as parseTtsDirectives, O as resolveThinkingDefault, Oa as clearAgentRunContext, On as getSkillsSnapshotVersion, Pl as resolveSessionResetPolicy, Po as createMediaAttachmentCache, Qn as AGENT_LANE_SUBAGENT, Qu as resolveMessageChannel, Rl as resolveExplicitAgentSessionKey, Ru as loadConfig, S as buildAllowedModelSet, Sr as runWithModelFallback, T as normalizeModelRef, Un as prepareSessionManagerForRun, Vn as normalizeReplyPayload, Xn as resolveAcpDispatchPolicyError, Xu as isInternalMessageChannel, Yn as resolveAcpAgentPolicyError, Yo as loadSessionStore, Yu as isGatewayMessageChannel, Zn as AGENT_LANE_NESTED, Zu as normalizeMessageChannel, ad as isSilentReplyText, as as resolveSessionKey, br as getAgentRuntimeCommandSecretTargetIds, cr as buildOutboundSessionContext, dr as normalizeOutboundPayloads, dt as getCliSessionId, es as updateSessionStore, fr as normalizeOutboundPayloadsForJson, ft as setCliSessionId, gd as normalizeVerboseLevel, hd as normalizeThinkLevel, ht as applyVerboseOverride, id as isSilentReplyPrefixText, jo as getAcpSessionManager, jr as resolveTtsConfig, k as formatThinkingLevels, ka as emitAgentEvent, ku as buildWorkspaceSkillSnapshot, lr as deliverOutboundPayloads, md as formatXHighModelHint, nr as hasNonzeroUsage, or as resolveOutboundTarget, pd as normalizeProviderId, pt as runCliAgent, qn as normalizeSpawnedRunMetadata, qo as resolveSessionTranscriptFile, qs as formatMention, qu as INTERNAL_MESSAGE_CHANNEL, rr as resolveContextTokensForModel, rs as normalizeAccountId, sr as resolveSessionDeliveryTarget, td as resolveAgentTimeoutMs, tr as deriveSessionTotalTokens, ur as formatOutboundPayloadLog, w as modelKey, wn as getRemoteSkillEligibility, x as ensureAuthProfileStore, xr as resolveCommandSecretRefsViaGateway, yr as resolveMessageChannelSelection, zo as loadModelCatalog, zu as readConfigFileSnapshotForWrite } from "./setup-wizard-helpers-Bds9SZeS.js";
import { f as toAcpRuntimeError } from "./provider-env-vars-CWXfFyDU.js";
import "./logger-DEV1v8zB.js";
import { n as resolvePreferredOpenClawTmpDir } from "./tmp-openclaw-dir-DGafsubg.js";
import { a as defaultRuntime, f as logVerbose, h as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-BunQspj4.js";
...
import { ot as formatCliCommand } from "./config-helpers-C9J9Kf27.js";
import "./fetch-CokEYQHV.js";
import "./exec-LHBFP7K9.js";
import { S as ensureAgentWorkspace, c as resolveAgentWorkspaceDir, f as resolveSessionAgentId, i as resolveAgentDir, n as listAgentIds, s as resolveAgentSkillsFilter, u as resolveEffectiveModelFallbacks } from "./agent-scope-BAdJcjtf.js";
...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./setup-wizard-helpers-Bds9SZeS.js").then((n) => n.I), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./setup-wizard-helpers-Bds9SZeS.js").then((n) => n.Qr), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./setup-wizard-helpers-Bds9SZeS.js").then((n) => n.os), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./setup-wizard-helpers-Bds9SZeS.js").then((n) => n.Cc), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./setup-wizard-helpers-Bds9SZeS.js").then((n) => n.Ca), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./imessage-kRERU9IZ.js"), "sendMessageIMessage")
	};
}
//#endregion
