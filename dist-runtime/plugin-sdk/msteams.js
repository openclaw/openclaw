...
import { Et as normalizeChannelSlug, Gt as hasConfiguredSecretInput, Jt as normalizeResolvedSecretInputString, Ot as resolveChannelEntryMatchWithFallback, Tt as buildChannelKeyCandidates, Yt as normalizeSecretInputString, bt as resolveDefaultGroupPolicy, gt as resolveSenderScopedGroupPolicy, ht as evaluateSenderGroupAccessForPolicy, kt as resolveNestedAllowlistDecision, yt as resolveAllowlistProviderRuntimeGroupPolicy } from "./runtime-DRRlb-lt.js";
import { Dd as DEFAULT_WEBHOOK_MAX_BODY_BYTES, Gt as resolveDmGroupAccessWithLists, Ja as writeJsonFileAtomically, Jt as resolveInboundSessionEnvelopeContext, Ka as createScopedPairingAccess, Kt as resolveEffectiveAllowFromLists, Ol as resolveToolsBySender, Vt as readStoreAllowFromForDmPolicy, Yt as resolveMentionGating, ad as isSilentReplyText, an as resolveDualTextControlCommandGate, ao as buildPendingHistoryContextFromMap, eo as createTypingCallbacks, g as splitSetupEntries, h as setTopLevelChannelGroupPolicy, in as resolveControlCommandGate, io as DEFAULT_GROUP_HISTORY_LIMIT, m as setTopLevelChannelDmPolicyWithAllowFrom, nl as loadWebMedia, no as logInboundDrop, p as setTopLevelChannelAllowFrom, qa as readJsonFileWithFallback, r as mergeAllowFromEntries, rd as SILENT_REPLY_TOKEN, ro as logTypingFailure, so as clearHistoryEntriesIfEnabled, t as addWildcardAllowFrom, tu as extractOriginalFilename, uo as recordPendingHistoryEntryIfEnabled } from "./setup-wizard-helpers-Bds9SZeS.js";
...
import { i as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist, r as isHttpsUrlAllowedByHostnameSuffixAllowlist, u as mapAllowlistResolutionInputs } from "./plugin-sdk-VLbTPvOr.js";
import "./webhook-targets-DPRi3syU.js";
import { n as keepHttpServerTaskAlive } from "./channel-lifecycle-DEuCqmjW.js";
import { G as buildProbeChannelStatusSummary, K as buildRuntimeAccountStatusSnapshot, U as buildBaseChannelStatusSummary, Y as createDefaultChannelRuntimeState, l as MSTeamsConfigSchema, t as resolveChannelMediaMaxBytes } from "./signal-Bycwzc0M.js";
...
import { s as isPrivateIpAddress, t as fetchWithSsrFGuard } from "./fetch-guard-COmtEumo.js";
import "./resolve-route-5UJLanKQ.js";
import "./pairing-token-BUkoGEse.js";
import { B as extensionForMime, V as getFileExtension, z as detectMime } from "./query-expansion-DrHj090u.js";
...
async function loadMSTeamsSdk() {
	return await import("./src-DAYmqL9E.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
}
