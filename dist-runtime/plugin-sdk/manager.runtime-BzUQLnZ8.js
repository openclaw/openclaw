import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, s as init_session_key, u as normalizeMainKey } from "./session-key-BwICpQs5.js";
import { B as getChannelPlugin, Ct as formatDiscordUserTag, U as normalizeChannelId, _t as resolveDiscordOwnerAccess, lt as init_allow_list, wt as init_format } from "./runtime-CDMAx_h4.js";
import { $n as resolveAcpAgentPolicyError, A as supportsXHighThinking, As as emitSessionTranscriptUpdate, C as isCliProvider, Cd as setSessionRuntimeModel, Cr as resolveMessageChannelSelection, D as resolveDefaultModelForAgent, Dr as FailoverError, E as resolveConfiguredModelRef, Ef as setRuntimeConfigSnapshot, Er as runWithModelFallback, Ff as isGatewayMessageChannel, Fr as resolveTtsConfig, Gc as formatMention, Gn as normalizeReplyPayload, If as isInternalMessageChannel, Ir as textToSpeech, Is as updateSessionStore, Jf as isSilentReplyText, Kn as runEmbeddedPiAgent, Lf as normalizeMessageChannel, Lr as parseTtsDirectives, Mf as DEFAULT_PROVIDER, Mn as getSkillsSnapshotVersion, Nf as INTERNAL_MESSAGE_CHANNEL, O as resolveThinkingDefault, On as getRemoteSkillEligibility, Pf as isDeliverableMessageChannel, Pn as clearSessionAuthProfileOverride, Pr as clearBootstrapSnapshotOnSessionRollover, Qn as resolveAcpSessionCwd, Rf as resolveMessageChannel, S as buildAllowedModelSet, Sd as mergeSessionEntry, T as normalizeModelRef, Tf as readConfigFileSnapshotForWrite, Tr as resolveCommandSecretRefsViaGateway, Vf as resolveAgentTimeoutMs, Vs as resolveSessionKey, Wn as formatAgentInternalEventsForPrompt, Yn as resolveBootstrapWarningSignaturesSeen, Zn as normalizeSpawnedRunMetadata, _s as normalizeMediaAttachments, _t as runCliAgent, ap as formatXHighModelHint, ar as deriveSessionTotalTokens, bd as resolveSessionResetPolicy, do as emitAgentEvent, dr as resolveSessionDeliveryTarget, er as resolveAcpDispatchPolicyError, ff as formatErrorMessage, fo as registerAgentRunContext, fr as buildOutboundSessionContext, gr as normalizeOutboundPayloadsForJson, gs as createMediaAttachmentCache, gt as setCliSessionId, hf as buildWorkspaceSkillSnapshot, hr as normalizeOutboundPayloads, hs as buildProviderRegistry, ht as getCliSessionId, ip as normalizeProviderId, jf as DEFAULT_MODEL, js as loadSessionStore, k as formatThinkingLevels, ks as resolveSessionTranscriptFile, ls as resolveSendPolicy, mr as formatOutboundPayloadLog, nr as AGENT_LANE_SUBAGENT, op as normalizeThinkLevel, or as hasNonzeroUsage, pr as deliverOutboundPayloads, ps as getAcpSessionManager, qf as isSilentReplyPrefixText, qn as prepareSessionManagerForRun, rr as applyModelOverrideToSessionEntry, sp as normalizeVerboseLevel, sr as resolveContextTokensForModel, tr as AGENT_LANE_NESTED, uo as clearAgentRunContext, ur as resolveOutboundTarget, vd as evaluateSessionFreshness, w as modelKey, wd as resolveExplicitAgentSessionKey, wf as loadConfig, wr as getAgentRuntimeCommandSecretTargetIds, x as ensureAuthProfileStore, xd as resolveSessionResetType, xs as loadModelCatalog, yd as resolveChannelResetConfig, ys as runCapability, yt as applyVerboseOverride, zs as normalizeAccountId } from "./setup-wizard-helpers-BPw-E_P4.js";
...
import { c as defaultRuntime, g as init_globals, l as init_runtime, n as init_subsystem, t as createSubsystemLogger, v as logVerbose, x as shouldLogVerbose } from "./subsystem-0lZt3jI5.js";
...
import { S as ensureAgentWorkspace, c as resolveAgentWorkspaceDir, f as resolveSessionAgentId, i as resolveAgentDir, n as listAgentIds, s as resolveAgentSkillsFilter, u as resolveEffectiveModelFallbacks } from "./agent-scope-CgozsAuQ.js";
...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./whatsapp-AEBAjKcb.js"), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./telegram-DlEHXGpd.js"), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./discord-Yi5swIZK.js"), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./slack-COnhdoNb.js"), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./signal-Xwws1I20.js"), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./imessage-jC_TShDk.js"), "sendMessageIMessage")
	};
}
//#endregion
