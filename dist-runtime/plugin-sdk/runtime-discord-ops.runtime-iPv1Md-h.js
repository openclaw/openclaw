import { d as resolveThreadSessionKeys, g as normalizeAccountId, u as resolveAgentIdFromSessionKey } from "./session-key-CbP51u9x.js";
import { $ as resolveDiscordAllowListMatch, Bt as normalizeDiscordToken, C as parsePluginBindingApprovalCustomId, Ct as warnMissingProviderGroupPolicyFallbackOnce, E as getSessionBindingService, J as listDiscordDirectoryGroupsLive, Lt as resolveDiscordAccount, Q as normalizeDiscordSlug, X as isDiscordGroupAllowedByPolicy, Y as listDiscordDirectoryPeersLive, Z as normalizeDiscordAllowList, Zt as resolveAccountEntry, _t as GROUP_POLICY_BLOCKED_LABEL, at as resolveDiscordShouldRequireMention, bt as resolveDefaultGroupPolicy, c as dispatchPluginInteractiveHandler, ct as formatDiscordReactionEmoji, dt as resolveTimestampMs, et as resolveDiscordChannelConfigWithFallback, f as executePluginCommand, h as matchPluginCommand, it as resolveDiscordOwnerAllowFrom, lt as formatDiscordUserTag, nt as resolveDiscordMemberAccessState, ot as resolveGroupDmAllow, p as getPluginCommandSpecs, rt as resolveDiscordOwnerAccess, st as shouldEmitDiscordReactionNotification, tt as resolveDiscordGuildEntry, ut as resolveDiscordSystemLocation, v as buildPluginBindingResolvedText, w as resolvePluginConversationBindingApproval, x as isPluginOwnedSessionBindingRecord, xt as resolveOpenProviderRuntimeGroupPolicy, zt as resolveDiscordMaxLinesPerMessage } from "./runtime-DRRlb-lt.js";
import { $s as pinMessageDiscord, As as auditDiscordChannelPermissions, Bs as parseDiscordModalCustomIdForCarbon, Cn as listSkillCommandsForAgents, Co as shouldHandleTextCommands, Cs as resolveDiscordUserAllowlist, Ds as runDiscordTaskWithTimeout, Eo as resolveNativeSkillsEnabled, Es as normalizeDiscordListenerTimeoutMs, Eu as formatErrorMessage, Fs as createDiscordFormModal, Ga as buildPairingReply, Gs as sendVoiceMessageDiscord, Gt as resolveDmGroupAccessWithLists, Hs as resolveDiscordModalEntry, Is as formatDiscordComponentEventText, Iu as finalizeInboundContext, Ja as writeJsonFileAtomically, Js as convertMarkdownTables, Ks as sendWebhookMessageDiscord, Ls as parseDiscordComponentCustomId, Lt as createChannelInboundDebouncer, Ms as removeReactionDiscord, Ns as sendTypingDiscord, Nu as stripReasoningTagsFromText, Or as formatDurationSeconds, Ps as sendDiscordComponentMessage, Qa as resolveAgentAvatar, Qs as editMessageDiscord, Rs as parseDiscordComponentCustomIdForCarbon, Rt as shouldDebounceTextInbound, Ru as loadConfig, So as serializeCommandArgs, Ss as formatThreadBindingDurationLabel, To as resolveNativeCommandsEnabled, Ts as normalizeDiscordInboundWorkerTimeoutMs, Us as sendMessageDiscord, Vs as resolveDiscordComponentEntry, Vt as readStoreAllowFromForDmPolicy, Wa as issuePairingChallenge, Wn as EmbeddedBlockChunker, Ws as sendPollDiscord, Xo as readSessionUpdatedAt, Xs as createThreadDiscord, Xt as resolveMentionGatingWithBypass, Yo as loadSessionStore, Ys as recordChannelActivity, Zs as deleteMessageDiscord, Zu as normalizeMessageChannel, _n as hasControlCommand, _o as listNativeCommandSpecsForConfig, ac as createDiscordRetryRunner, al as fetchRemoteMedia, ao as buildPendingHistoryContextFromMap, b as resolveProfilesUnavailableReason, bn as buildModelsProviderData, bo as resolveCommandArgChoices, cc as inspectDiscordAccount, cl as resolveChunkMode, cs as setPresence, do as buildMentionRegexes, ds as reconcileAcpThreadBindingsOnStartup, ec as unpinMessageDiscord, eo as createTypingCallbacks, es as updateSessionStore, fn as resolveEnvelopeFormatOptions, fo as matchesMentionWithExplicit, fs as createNoopThreadBindingManager, gs as resolveThreadBindingIdleTimeoutMs, hn as createReplyDispatcherWithTyping, ho as listChatCommands, hs as isRecentlyUnboundThreadWebhookMessage, ic as createDiscordClient, in as resolveControlCommandGate, jo as getAcpSessionManager, js as reactMessageDiscord, kr as enqueueSystemEvent, ll as resolveTextChunkLimit, ls as registerGateway, mo as findCommandByNativeName, ms as isThreadArchived, mt as resolveStoredModelOverride, nc as sendDiscordText, nl as loadWebMedia, nn as recordInboundSession, no as logInboundDrop, nu as saveMediaBuffer, oc as chunkDiscordTextWithMode, ol as resolveMarkdownTableMode, on as dispatchReplyWithBufferedBlockDispatcher, pa as upsertChannelPairingRequest, pd as normalizeProviderId, pn as dispatchInboundMessage, po as buildCommandTextFromArgs, ps as createThreadBindingManager, qa as readJsonFileWithFallback, qs as formatMention, qt as resolvePinnedMainDmOwnerFromAllowlist, rc as stripUndefinedFields, rl as getAgentScopedMediaLocalRoots, rn as resolveCommandAuthorizedFromAuthorizers, ro as logTypingFailure, si as getExecApprovalApproverDmNoticeText, sn as dispatchReplyWithDispatcher, so as clearHistoryEntriesIfEnabled, tc as editChannelDiscord, to as logAckFailure, tt as createConnectedChannelStatusPatch, un as formatInboundEnvelope, uo as recordPendingHistoryEntryIfEnabled, us as unregisterGateway, v as clearExpiredCooldowns, vs as resolveThreadBindingMaxAgeMs, wo as isNativeCommandsExplicitlyDisabled, ws as resolveDiscordChannelAllowlist, x as ensureAuthProfileStore, xo as resolveCommandArgMenu, xs as resolveThreadBindingsEnabled, y as isProfileInCooldown, yo as parseCommandArgs, zs as parseDiscordModalCustomId, zt as withTimeout } from "./setup-wizard-helpers-Bds9SZeS.js";
import { d as isAcpRuntimeError } from "./provider-env-vars-CWXfFyDU.js";
import { b as resolveStateDir, t as getChildLogger, w as resolveRequiredHomeDir } from "./logger-DEV1v8zB.js";
import "./tmp-openclaw-dir-DGafsubg.js";
import { _ as warn, d as isVerbose, f as logVerbose, h as shouldLogVerbose, i as createNonExitingRuntime, l as danger, t as createSubsystemLogger } from "./subsystem-BunQspj4.js";
import { S as truncateUtf16Safe } from "./utils-C9epF7GR.js";
import { i as fetchWithTimeout, n as wrapFetchWithAbortSignal, t as resolveFetch } from "./fetch-s6LpGbVn.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-Bdb5CNwD.js";
import { t as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-0CmwkA_V.js";
import { A as withFileLock } from "./paths-BoU0P6Xb.js";
import { KeyedAsyncQueue } from "./keyed-async-queue.js";
import { R as resolveDiscordPreviewStreamMode } from "./signal-Bycwzc0M.js";
...
import { i as resolveAckReaction, n as createReplyPrefixOptions, s as resolveHumanDelayConfig } from "./reply-prefix-B-13vT7e.js";
import { n as logError, t as logDebug } from "./logger-kC9I1OJ3.js";
import "./fetch-guard-COmtEumo.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-5UJLanKQ.js";
...
import { n as shouldAckReaction } from "./ack-reactions-DbjS-djs.js";
import { t as buildMediaPayload } from "./media-payload-BkjfKf0h.js";
import { a as patchAllowlistUsersInConfigEntries, n as buildAllowlistResolutionSummary, o as summarizeMapping, r as canonicalizeAllowlistWithResolvedIds, s as summarizeStringEntries, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-D-PSzOHf.js";
import { t as createReplyReferencePlanner } from "./reply-reference-CYkJPFl7.js";
import { a as createFinalizableDraftLifecycle, c as createStatusReactionController, i as resolveConfiguredAcpRoute, n as createOperatorApprovalsGatewayClient, r as ensureConfiguredAcpRouteReady, s as DEFAULT_TIMING, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DUFzVLVQ.js";
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-ae__s7O_.js");
