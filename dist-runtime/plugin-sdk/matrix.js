...
import { Bt as warnMissingProviderGroupPolicyFallbackOnce, Dt as evaluateGroupRouteAccessForPolicy, Gt as resolveChannelEntryMatch, Ht as buildChannelKeyCandidates, It as resolveAllowlistProviderRuntimeGroupPolicy, Lt as resolveDefaultGroupPolicy, Mt as resolveSenderScopedGroupPolicy, Nt as GROUP_POLICY_BLOCKED_LABEL, Pt as init_runtime_group_policy, Un as createAccountListHelpers, Wn as init_account_helpers, _n as normalizeSecretInputString, fn as hasConfiguredSecretInput, gn as normalizeResolvedSecretInputString, jt as init_group_access, pn as init_types_secrets } from "./runtime-CDMAx_h4.js";
import { $u as jsonResult, Aa as toLocationContext, Eo as issuePairingChallenge, Fo as buildSecretInputSchema, Gt as readStoreAllowFromForDmPolicy, Io as createTypingCallbacks, Oo as createScopedPairingAccess, Qt as resolveInboundSessionEnvelopeContext, Ro as logInboundDrop, Yt as resolveDmGroupAccessWithLists, Zu as createActionGate, c as promptSingleChannelSecretInput, cn as resolveControlCommandGate, ed as readNumberParam, h as setTopLevelChannelGroupPolicy, ka as formatLocationText, n as buildSingleChannelSecretPromptState, nd as readStringParam, r as mergeAllowFromEntries, t as addWildcardAllowFrom, td as readReactionParams, zo as logTypingFailure } from "./setup-wizard-helpers-BPw-E_P4.js";
...
import { o as formatResolvedUnresolvedNote, u as mapAllowlistResolutionInputs } from "./plugin-sdk-DQMac3M2.js";
import "./webhook-targets-DiwYmBno.js";
import { A as ToolPolicySchema, G as buildProbeChannelStatusSummary, J as collectStatusIssuesFromLastError } from "./signal-FT4PyBH3.js";
...
import { n as resolveRuntimeEnv, t as createLoggerBackedRuntime } from "./runtime-YgND8u9Q.js";
...
import "./compat.js";
import { n as loadMatrixCredentials, s as getMatrixRuntime, t as credentialsMatchConfig } from "./credentials-B06oA9jv.js";
...
//#region extensions/matrix/src/secret-input.ts
init_group_access();
...
async function resolveMatrixAuth(params) {
	...
	const { loadMatrixCredentials, saveMatrixCredentials, credentialsMatchConfig, touchMatrixCredentials } = await import("./credentials-DtHkhLHh.js");
