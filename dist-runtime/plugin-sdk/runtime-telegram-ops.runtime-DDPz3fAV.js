import { d as resolveThreadSessionKeys, f as sanitizeAgentId, g as normalizeAccountId$1, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey, w as parseAgentSessionKey } from "./session-key-CbP51u9x.js";
import { C as parsePluginBindingApprovalCustomId, E as getSessionBindingService, an as triggerInternalHook, c as dispatchPluginInteractiveHandler, f as executePluginCommand, h as matchPluginCommand, in as createInternalHookEvent, l as createDedupeCache, p as getPluginCommandSpecs, pt as evaluateMatchedGroupAccessForPolicy, v as buildPluginBindingResolvedText, w as resolvePluginConversationBindingApproval, x as isPluginOwnedSessionBindingRecord, xt as resolveOpenProviderRuntimeGroupPolicy } from "./runtime-DRRlb-lt.js";
import { $i as normalizeForwardedContext, $n as applyModelOverrideToSessionEntry, $r as getTelegramExecApprovalApprovers, Ai as isRecoverableTelegramNetworkError, Bi as buildGroupLabel, Bo as modelSupportsVision, Ci as renameForumTopicTelegram, Cn as listSkillCommandsForAgents, D as resolveDefaultModelForAgent, Di as unpinMessageTelegram, Dl as resolveChannelGroupRequireMention, Dr as formatDurationPrecise, Du as formatUncaughtError, Ei as sendTypingTelegram, El as resolveChannelGroupPolicy, Eo as resolveNativeSkillsEnabled, Eu as formatErrorMessage, Fi as markdownToTelegramChunks, Fu as isInsideCode, Gi as buildTelegramParentPeer, Hi as buildSenderName, Ii as markdownToTelegramHtml, Iu as finalizeInboundContext, Ji as describeReplyTarget, Jr as logWebhookReceived, Ki as buildTelegramThreadParams, Ko as formatReasoningMessage, Kr as logWebhookError, Li as renderTelegramHtmlText, Mc as resolveGlobalSingleton, Mi as isTelegramClientRejection, Mo as resolveCommandAuthorization, Ni as isTelegramPollingNetworkError, Nu as stripReasoningTagsFromText, Oi as resolveTelegramVoiceSend, Oo as getGlobalHookRunner, Pi as tagTelegramNetworkError, Pu as findCodeRegions, Qi as hasBotMention, Qo as resolveSessionStoreEntry, Ri as wrapFileReferencesInHtml, Ro as findModelInCatalog, Rt as shouldDebounceTextInbound, Ru as loadConfig, Si as pinMessageTelegram, Sn as buildCommandsPaginationKeyboard, Ti as sendPollTelegram, To as resolveNativeCommandsEnabled, Ui as buildTelegramGroupFrom, Uo as registerUnhandledRejectionHandler, Uu as resolveAgentMaxConcurrent, Vi as buildSenderLabel, Vu as writeConfigFile, Wa as issuePairingChallenge, Wi as buildTelegramGroupPeerId, Xi as extractTelegramLocation, Xo as readSessionUpdatedAt, Xr as stopDiagnosticHeartbeat, Xt as resolveMentionGatingWithBypass, Yi as expandTextLinks, Yo as loadSessionStore, Yr as startDiagnosticHeartbeat, Ys as recordChannelActivity, Zi as getTelegramTextParts, Zt as waitForAbortSignal, _a as resolveTelegramInlineButtonsScope, _i as getCachedSticker, _n as hasControlCommand, _o as listNativeCommandSpecsForConfig, _r as fireAndForgetHook, _s as resolveThreadBindingIdleTimeoutMsForChannel, _t as auditTelegramGroupMembership, aa as resolveTelegramStreamMode, ai as shouldSuppressLocalTelegramExecApprovalPrompt, al as fetchRemoteMedia, ao as buildPendingHistoryContextFromMap, ar as sleepWithAbort, ba as resolveTelegramToken, bi as editMessageReplyMarkupTelegram, bn as buildModelsProviderData, bs as resolveThreadBindingSpawnPolicy, ca as normalizeAllowFrom, ci as buildModelsKeyboard, cl as resolveChunkMode, cn as createInboundDebouncer, da as firstDefined, di as getModelsPageSize, do as buildMentionRegexes, ea as resolveTelegramDirectPeerId, ei as isTelegramExecApprovalApprover, eo as createTypingCallbacks, er as buildCommandsMessagePaginated, es as updateSessionStore, fa as readChannelAllowFromStore, fi as parseModelCallbackData, fn as resolveEnvelopeFormatOptions, fo as matchesMentionWithExplicit, ga as withTelegramApiErrorLogging, gi as describeStickerImage, go as listNativeCommandSpecs, gr as toPluginMessageSentEvent, gt as createTelegramThreadBindingManager, ha as toLocationContext, hi as cacheSticker, hr as toPluginMessageContext, ia as resolveTelegramReplyId, ii as shouldEnableTelegramExecApprovalButtons, il as MediaFetchError, in as resolveControlCommandGate, ir as computeBackoff, jd as readJsonBodyWithLimit, ji as isSafeToRetrySendError, jn as resolveChannelConfigWrites, ki as wasSentByBot, kn as isBtwRequestText, kr as enqueueSystemEvent, la as normalizeDmAllowFromWithStore, li as buildProviderKeyboard, ll as resolveTextChunkLimit, ln as resolveInboundDebounceMs, ma as formatLocationText, mo as findCommandByNativeName, mr as toInternalMessageSentContext, mt as resolveStoredModelOverride, na as resolveTelegramGroupAllowFromContext, ni as resolveTelegramExecApprovalConfig, nl as loadWebMedia, nn as recordInboundSession, no as logInboundDrop, nu as saveMediaBuffer, oa as resolveTelegramThreadSpec, oi as buildExecApprovalPendingReplyPayload, ol as resolveMarkdownTableMode, on as dispatchReplyWithBufferedBlockDispatcher, pa as upsertChannelPairingRequest, pi as resolveModelSelection, po as buildCommandTextFromArgs, pr as buildCanonicalSentMessageHookContext, qi as buildTypingThreadParams, qr as logWebhookProcessed, qt as resolvePinnedMainDmOwnerFromAllowlist, ra as resolveTelegramMediaPlaceholder, ri as resolveTelegramExecApprovalTarget, rl as getAgentScopedMediaLocalRoots, rn as resolveCommandAuthorizedFromAuthorizers, ro as logTypingFailure, sa as isSenderAllowed, sc as buildOutboundMediaLoadOptions, sl as chunkMarkdownTextWithMode, so as clearHistoryEntriesIfEnabled, sr as resolveSessionDeliveryTarget, ta as resolveTelegramForumThreadId, ti as isTelegramExecApprovalClientEnabled, to as logAckFailure, ua as resolveSenderAllowMatch, ui as calculateTotalPages, un as formatInboundEnvelope, uo as recordPendingHistoryEntryIfEnabled, vi as buildInlineKeyboard, vn as isAbortRequestText, vo as normalizeCommandBody, vt as collectTelegramUnmentionedGroupIds, wi as sendMessageTelegram, wo as isNativeCommandsExplicitlyDisabled, xi as editMessageTelegram, xn as formatModelsAvailableHeader, xo as resolveCommandArgMenu, ya as resolveTelegramAccount, yi as deleteMessageTelegram, yo as parseCommandArgs, ys as resolveThreadBindingMaxAgeMsForChannel, zi as splitTelegramCaption, zo as loadModelCatalog } from "./setup-wizard-helpers-Bds9SZeS.js";
import "./provider-env-vars-CWXfFyDU.js";
import { b as resolveStateDir, t as getChildLogger } from "./logger-DEV1v8zB.js";
import "./tmp-openclaw-dir-DGafsubg.js";
import { _ as warn, a as defaultRuntime, f as logVerbose, h as shouldLogVerbose, i as createNonExitingRuntime, l as danger, t as createSubsystemLogger } from "./subsystem-BunQspj4.js";
import "./utils-C9epF7GR.js";
import { i as fetchWithTimeout } from "./fetch-s6LpGbVn.js";
import { n as retryAsync } from "./retry-Bdb5CNwD.js";
import { r as writeJsonAtomic } from "./json-files-D9UnRp_W.js";
import "./paths-BoU0P6Xb.js";
import { h as resolveTelegramCustomCommands, m as normalizeTelegramCommandName, p as TELEGRAM_COMMAND_NAME_PATTERN } from "./signal-Bycwzc0M.js";
import "./config-helpers-C9J9Kf27.js";
import { c as makeProxyFetch, n as resolveTelegramTransport, r as shouldRetryTelegramIpv4Fallback, t as resolveTelegramFetch } from "./fetch-CokEYQHV.js";
import "./exec-LHBFP7K9.js";
import { i as resolveAgentDir, l as resolveDefaultAgentId } from "./agent-scope-BAdJcjtf.js";
import { i as resolveAckReaction, n as createReplyPrefixOptions } from "./reply-prefix-B-13vT7e.js";
import "./logger-kC9I1OJ3.js";
import "./fetch-guard-COmtEumo.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-5UJLanKQ.js";
import "./pairing-token-BUkoGEse.js";
import { G as kindFromMime, R as resolveStorePath, W as isGifMedia } from "./query-expansion-DrHj090u.js";
import { a as compileSafeRegex, o as testRegexWithBoundedInput } from "./redact-DDISwu8-.js";
import "./channel-plugin-common-cMzLzrLW.js";
import "./secret-file-B_1xic5c.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-Bfj6BS_O.js";
...
import { a as createFinalizableDraftLifecycle, c as createStatusReactionController, i as resolveConfiguredAcpRoute, n as createOperatorApprovalsGatewayClient, o as DEFAULT_EMOJIS, r as ensureConfiguredAcpRouteReady, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DUFzVLVQ.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-D1Opk5OF.js";
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight) {try {
		const { transcribeFirstAudio } = await import("./audio-preflight-g-3EqHvA.js");
