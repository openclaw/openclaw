...
import { B as getChannelPlugin, Dn as init_targets, En as ensureTargetId, On as parseMentionPrefixOrAtUserTarget, Tn as buildMessagingTarget, V as init_registry, kn as requireTargetKind } from "./runtime-CDMAx_h4.js";
import { c as init_utils, f as normalizeE164, s as formatTerminalLink } from "./utils-DknlDzAi.js";
import { i as buildAccountScopedDmSecurityPolicy, n as deleteAccountFromConfigSection, r as setAccountEnabledInConfigSection } from "./config-helpers-BQX8LEv1.js";
import { j as normalizeStringEntries, r as resolveAgentConfig } from "./agent-scope-CgozsAuQ.js";
...
function loadDiscordInspectModule() {
	discordInspectModulePromise ??= import("./read-only-account-inspect.discord.runtime-CaZEWS3c.js");
	return discordInspectModulePromise;
}
function loadSlackInspectModule() {
	slackInspectModulePromise ??= import("./read-only-account-inspect.slack.runtime-BvMQQpFZ.js");
	return slackInspectModulePromise;
}
function loadTelegramInspectModule() {
	telegramInspectModulePromise ??= import("./read-only-account-inspect.telegram.runtime-KvppvG8g.js");
