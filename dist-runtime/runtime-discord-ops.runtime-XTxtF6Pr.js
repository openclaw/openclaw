...
import { a as logVerbose, c as shouldLogVerbose, d as getChildLogger, r as isVerbose, t as danger, u as warn } from "./globals-I5DlBD2D.js";
import { _ as resolveStateDir, x as resolveRequiredHomeDir } from "./paths-1qR_mW4i.js";
import "./theme-UkqnBJaj.js";
import { c as createNonExitingRuntime, t as createSubsystemLogger } from "./subsystem-EnljYYs1.js";
import "./ansi-YpD2Ho3J.js";
import "./boolean-B938tROv.js";
import "./env-Bdj-riuG.js";
import "./warning-filter-xAwZkSAQ.js";
import { E as truncateUtf16Safe } from "./utils-Do8MzKyM.js";
import "./links-Cx-Xmp-Y.js";
import { $n as resolveMentionGatingWithBypass, An as createChannelInboundDebouncer, Bb as loadConfig, Bf as logInboundDrop, Cg as createDiscordClient, Ch as sendDiscordComponentMessage, Dh as parseDiscordComponentCustomIdForCarbon, Eh as parseDiscordComponentCustomId, Ff as resolveAckReaction, Gm as createThreadBindingManager, Hh as createThreadDiscord, Hm as reconcileAcpThreadBindingsOnStartup, Hx as resolveDiscordPreviewStreamMode, Ih as sendVoiceMessageDiscord, Im as setPresence, Jf as matchesMentionWithExplicit, Jh as pinMessageDiscord, Jm as isRecentlyUnboundThreadWebhookMessage, Kc as getExecApprovalApproverDmNoticeText, Kf as recordPendingHistoryEntryIfEnabled, Lh as sendWebhookMessageDiscord, Mf as createTypingCallbacks, Mh as resolveDiscordModalEntry, Mn as withTimeout, My as saveMediaBuffer, Nh as sendMessageDiscord, Oh as parseDiscordModalCustomId, Pf as createReplyPrefixOptions, Ph as sendPollDiscord, Qf as listChatCommands, Rf as resolveHumanDelayConfig, Rh as formatMention, Rm as registerGateway, Sh as sendTypingDiscord, Sp as isAcpRuntimeError, Sr as buildModelsProviderData, Tg as chunkDiscordTextWithMode, Th as formatDiscordComponentEventText, Tr as listSkillCommandsForAgents, Uf as buildPendingHistoryContextFromMap, Uh as deleteMessageDiscord, Vf as logTypingFailure, Vh as recordChannelActivity, Wf as clearHistoryEntriesIfEnabled, Wh as editMessageDiscord, Wm as createNoopThreadBindingManager, Wt as resolveStoredModelOverride, Xf as buildCommandTextFromArgs, Ym as resolveThreadBindingIdleTimeoutMs, Zf as findCommandByNativeName, Zh as unpinMessageDiscord, Zm as resolveThreadBindingMaxAgeMs, a as isProfileInCooldown, ah as resolveDiscordUserAllowlist, am as readSessionUpdatedAt, ap as resolveCommandArgMenu, ar as dispatchReplyWithBufferedBlockDispatcher, av as getAgentScopedMediaLocalRoots, bg as stripUndefinedFields, bp as getAcpSessionManager, cb as stripReasoningTagsFromText, cf as buildPairingReply, cv as resolveMarkdownTableMode, dh as normalizeDiscordListenerTimeoutMs, dr as resolveEnvelopeFormatOptions, dv as resolveTextChunkLimit, eC as normalizeProviderId, eh as resolveThreadBindingsEnabled, fh as runDiscordTaskWithTimeout, fr as dispatchInboundMessage, gh as auditDiscordChannelPermissions, gp as resolveAgentRoute, hg as editChannelDiscord, hp as deriveLastRoutePolicy, hr as createReplyDispatcherWithTyping, i as clearExpiredCooldowns, im as loadSessionStore, ip as resolveCommandArgChoices, ir as shouldAckReaction, jh as resolveDiscordComponentEntry, jn as shouldDebounceTextInbound, kb as finalizeInboundContext, kh as parseDiscordModalCustomIdForCarbon, lr as formatInboundEnvelope, mp as buildAgentSessionKey, nr as recordInboundSession, nv as loadWebMedia, oh as resolveDiscordChannelAllowlist, op as serializeCommandArgs, or as dispatchReplyWithDispatcher, p as ensureAuthProfileStore, qf as buildMentionRegexes, qm as isThreadArchived, rp as parseCommandArgs, s as resolveProfilesUnavailableReason, sf as issuePairingChallenge, sp as shouldHandleTextCommands, sv as fetchRemoteMedia, th as formatThreadBindingDurationLabel, tp as listNativeCommandSpecsForConfig, uh as normalizeDiscordInboundWorkerTimeoutMs, um as updateSessionStore, us as enqueueSystemEvent, uv as resolveChunkMode, vi as EmbeddedBlockChunker, vr as hasControlCommand, wf as resolveAgentAvatar, wg as createDiscordRetryRunner, wh as createDiscordFormModal, xh as removeReactionDiscord, xp as KeyedAsyncQueue, xt as createConnectedChannelStatusPatch, yg as sendDiscordText, yh as reactMessageDiscord, zf as logAckFailure, zh as convertMarkdownTables, zm as unregisterGateway } from "./auth-profiles-DqxBs6Au.js";
import "./plugins-allowlist-CTOQWcBK.js";
import { $t as normalizeDiscordToken, B as isPluginOwnedSessionBindingRecord, Ct as resolveTimestampMs, G as getSessionBindingService, H as parsePluginBindingApprovalCustomId, L as buildPluginBindingResolvedText, M as getPluginCommandSpecs, Mt as resolveOpenProviderRuntimeGroupPolicy, Nt as warnMissingProviderGroupPolicyFallbackOnce, P as matchPluginCommand, Qt as resolveDiscordMaxLinesPerMessage, S as dispatchPluginInteractiveHandler, St as resolveDiscordSystemLocation, U as resolvePluginConversationBindingApproval, Ut as resolveRetryConfig, Wt as retryAsync, Xt as resolveDiscordAccount, _t as resolveDiscordShouldRequireMention, bt as formatDiscordReactionEmoji, ct as isDiscordGroupAllowedByPolicy, dt as resolveDiscordAllowListMatch, ft as resolveDiscordChannelConfigWithFallback, gt as resolveDiscordOwnerAllowFrom, ht as resolveDiscordOwnerAccess, j as executePluginCommand, jt as resolveDefaultGroupPolicy, kt as GROUP_POLICY_BLOCKED_LABEL, lt as normalizeDiscordAllowList, mt as resolveDiscordMemberAccessState, ot as listDiscordDirectoryGroupsLive, pt as resolveDiscordGuildEntry, st as listDiscordDirectoryPeersLive, ut as normalizeDiscordSlug, vt as resolveGroupDmAllow, xt as formatDiscordUserTag, yt as shouldEmitDiscordReactionNotification } from "./registry-DrRO3PZ7.js";
import { n as normalizeAccountId } from "./account-id-CYKfwqh7.js";
import { d as resolveThreadSessionKeys, u as resolveAgentIdFromSessionKey } from "./session-key-D2lHwVVl.js";
import { t as resolveAccountEntry } from "./account-lookup-DJ9MQH4g.js";
import { i as fetchWithTimeout, n as wrapFetchWithAbortSignal, t as resolveFetch } from "./fetch-DM2X1MUS.js";
import "./config-state-Dtu4rsXl.js";
import "./filter-Qe6Ch68_.js";
import "./manifest-registry-CA0yK887.js";
import { bn as normalizeMessageChannel } from "./method-scopes-DDb5C1xl.js";
...
import { n as logError, t as logDebug } from "./logger-BwHrL168.js";
...
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled, n as isNativeCommandsExplicitlyDisabled } from "./commands-BRfqrztE.js";
...
import { u as formatDurationSeconds } from "./account-summary-DtY_0EC1.js";
import { D as writeJsonFileAtomically, E as readJsonFileWithFallback, T as withFileLock, a as resolveDmGroupAccessWithLists, c as resolveCommandAuthorizedFromAuthorizers, l as resolveControlCommandGate, n as readStoreAllowFromForDmPolicy, s as resolvePinnedMainDmOwnerFromAllowlist, x as upsertChannelPairingRequest } from "./dm-policy-shared-qfNerugD.js";
...
import { t as buildMediaPayload } from "./media-payload-BBAvJf0p.js";
import { a as patchAllowlistUsersInConfigEntries, n as buildAllowlistResolutionSummary, o as summarizeMapping, r as canonicalizeAllowlistWithResolvedIds, s as summarizeStringEntries, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-Bz_rfQcP.js";
import { n as resolveConfiguredAcpRoute, t as ensureConfiguredAcpRouteReady } from "./persistent-bindings.route-jQBcgRV1.js";
import { t as createReplyReferencePlanner } from "./reply-reference-yf4XPm9E.js";
import "./connection-auth-9G-gDHEA.js";
import { t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-0PfuVfLg.js";
import { t as DiscordUiContainer } from "./ui-BgYglRRG.js";
import { a as createOperatorApprovalsGatewayClient, i as createStatusReactionController, r as DEFAULT_TIMING, t as createFinalizableDraftLifecycle } from "./draft-stream-controls-DE4_njDv.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-9bKl8VVH.js";
import { n as buildUntrustedChannelMetadata, t as chunkItems } from "./chunk-items-DfMbAL1E.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./audio-preflight-C02s4Pgu.js");
			if (params.abortSignal?.aborted) {return {
				hasAudioAttachment,
				hasTypedText
			};}
...
const COMMAND_CONTEXTS = new Set(["model", "models"]);
...
function isValidCommandContext(value) {
	return COMMAND_CONTEXTS.has(value);
}
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-oCfjC_Mh.js");
