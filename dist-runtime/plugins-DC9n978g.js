import { d as init_utils, h as normalizeE164 } from "./utils-BiUV1eIQ.js";
import { Fn as parseMentionPrefixOrAtUserTarget, In as requireTargetKind, Mn as buildMessagingTarget, Nn as ensureTargetId, Pn as init_targets, lt as getChannelPlugin, ut as init_registry } from "./registry-ep1yQ6WN.js";
...
function loadDiscordInspectModule() {
	discordInspectModulePromise ??= import("./read-only-account-inspect.discord.runtime-DSG0enhr.js");
	return discordInspectModulePromise;
}
function loadSlackInspectModule() {
	slackInspectModulePromise ??= import("./read-only-account-inspect.slack.runtime-q3zic4ZL.js");
	return slackInspectModulePromise;
}
function loadTelegramInspectModule() {
	telegramInspectModulePromise ??= import("./read-only-account-inspect.telegram.runtime-Cq-cEyU6.js");
