...
import { p as getResolvedLoggerSettings, t as danger } from "./globals-I5DlBD2D.js";
...
import { Ba as resolveMessageChannelSelection, Bb as loadConfig, Bd as callGateway, GS as moveSingleAccountChannelSectionToDefaultAccount, Ha as resolveCommandSecretRefsViaGateway, Ki as loadProviderUsageSummary, Wb as readConfigFileSnapshot, XS as listChannelPluginCatalogEntries, Yb as writeConfigFile, m as loadAuthProfileStore, nn as withProgress, qi as formatUsageReportLines } from "./auth-profiles-DqxBs6Au.js";
import "./plugins-allowlist-CTOQWcBK.js";
import { Q as normalizeChannelId, X as getChannelPlugin, Z as listChannelPlugins } from "./registry-DrRO3PZ7.js";
...
import { H as parseOptionalDelimitedEntries, U as resolveChannelDefaultAccountId } from "./plugins-CygWjihb.js";
...
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-YOIg2wWK.js";
...
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-s6IkPzJw.js";
import { t as isCatalogChannelInstalled } from "./discovery-CTmRKSls.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-CrByjbp8.js"), import("./onboard-channels-Dkyduvaw.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-Dof5s4uN.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-Dof5s4uN.js");
			const prompter = createClackPrompter();
