...
import { C as resolveRequiredHomeDir, b as init_home_dir, d as resolveGatewayPort, f as resolveIsNixMode, g as resolveOAuthDir, i as init_paths, t as CONFIG_PATH, v as resolveStateDir } from "./paths-DqbqmTPe.js";
import { d as defaultRuntime, f as init_runtime } from "./subsystem-CZwunM2N.js";
import { t as isTruthyEnvValue$1 } from "./env--LwFRA3k.js";
import { C as shortenHomePath, b as resolveUserPath, d as init_utils, w as sleep } from "./utils-BiUV1eIQ.js";
import { $v as formatSessionArchiveTimestamp, Ap as loadModelCatalog, Dl as saveCronStore, E as getModelRefStatus, El as resolveCronStorePath, Ey as resolveGoogleChromeExecutableForPlatform, I as resolveHooksGmailModel, Jb as writeConfigFile, Jt as formatRemainingShort, Kt as DEFAULT_OAUTH_WARN_MS, P as resolveConfiguredModelRef, Q as loadOpenClawPlugins, Qu as guardCancel, Rd as buildGatewayConnectionDetails, Tl as loadCronStore, Ty as readBrowserVersion, Ub as readConfigFileSnapshot, Xx as DEFAULT_MODEL, Z as resolvePluginProviders, Zp as resolveAgentSessionDirs, Zv as resolveMainSessionKey, Zx as DEFAULT_PROVIDER, Zy as resolveConfiguredSecretInputWithFallback, _ as updateAuthProfileStoreWithLock, _b as resolveApiKeyForProvider, ab as resolveBootstrapMaxChars, ad as randomToken, c as resolveApiKeyForProfile, ey as isPrimarySessionTranscriptFileName, ib as hasAmbiguousGatewayAuthModeConfig, jd as hasConfiguredMemorySecretInput, l as repairOAuthProfileIdMismatch, o as resolveProfileUnusableUntilForDisplay, ob as resolveBootstrapTotalMaxChars, p as ensureAuthProfileStore, qs as resolveBootstrapContextForRun, qt as buildAuthHealthSummary, qu as applyWizardMetadata, rd as printWizardHeader, rm as loadSessionStore, vi as analyzeBootstrapBudget, wy as parseBrowserMajorVersion, yi as buildBootstrapInjectionStats, zd as callGateway } from "./auth-profiles-DAOR1fRn.js";
import { dt as listChannelPlugins } from "./registry-ep1yQ6WN.js";
import { w as parseAgentSessionKey, y as init_session_key_utils } from "./session-key-B-Mu-04L.js";
import { a as hasConfiguredSecretInput, f as resolveSecretInputRef, o as init_types_secrets } from "./types.secrets-Cu0Lz6pi.js";
...
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-C0PckUtv.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-BmPfiSbq.js";
import { m as resolveGatewayAuth, w as readGatewayTokenEnv } from "./config-DZ3oWznn.js";
import { B as resolveSandboxScope, it as DEFAULT_SANDBOX_BROWSER_IMAGE, k as cleanStaleLockFiles, ot as DEFAULT_SANDBOX_IMAGE } from "./workspace-dirs-Ejflbukt.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-CVctuSlw.js";
import { a as isLoopbackHost, f as resolveGatewayBindHost } from "./device-metadata-normalization-a2oQYp64.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-D4BnBb9r.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-55bRPK_d.js";
...
import { a as isWSLEnv, i as isWSL } from "./fetch-wLdC1F30.js";
...
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-BAKbI1QA.js";
...
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-CYc1PBHk.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BRvD766e.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-Ca2xqSN-.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CyeYGmDG.js";
...
import { p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-BPWEGx1E.js";
...
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-DE73Iui7.js";
...
import { n as doctorShellCompletion } from "./doctor-completion-D-C7dX9r.js";
import { a as runLegacyStateMigrations, i as detectLegacyStateMigrations, r as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CWFac0Fu.js";
