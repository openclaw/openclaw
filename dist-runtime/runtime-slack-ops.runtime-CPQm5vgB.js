...
import { a as logVerbose, c as shouldLogVerbose, d as getChildLogger, t as danger, u as warn } from "./globals-I5DlBD2D.js";
import "./paths-1qR_mW4i.js";
import "./theme-UkqnBJaj.js";
import { c as createNonExitingRuntime } from "./subsystem-EnljYYs1.js";
...
import { $_ as createSlackWebClient, $n as resolveMentionGatingWithBypass, Ab as resolveConversationLabel, An as createChannelInboundDebouncer, B_ as readSlackMessages, Bb as loadConfig, Bf as logInboundDrop, Cf as resolveAgentOutboundIdentity, Ef as installRequestBodyLimitGuard, F_ as listSlackEmojis, Ff as resolveAckReaction, Fv as resolveSlackAppToken, G_ as resolveSlackAttachmentContent, H_ as removeSlackReaction, I_ as listSlackPins, Iv as resolveSlackBotToken, J_ as resolveSlackThreadStarter, Jf as matchesMentionWithExplicit, K_ as resolveSlackMedia, Kf as recordPendingHistoryEntryIfEnabled, L_ as listSlackReactions, M_ as downloadSlackFile, Mf as createTypingCallbacks, Mm as resolveSessionKey, Mn as withTimeout, N_ as editSlackMessage, Nv as resolveSlackAccount, O_ as hasSlackThreadParticipation, P_ as getSlackMemberInfo, Pf as createReplyPrefixOptions, Pv as resolveSlackReplyToMode, Q_ as normalizeSlackOutboundText, Qg as resolveSlackChannelAllowlist, Qr as resolveChannelConfigWrites, R_ as pinSlackMessage, Rf as resolveHumanDelayConfig, U_ as sendSlackMessage, Uf as buildPendingHistoryContextFromMap, Ux as resolveSlackNativeStreaming, V_ as removeOwnSlackReactions, Vf as logTypingFailure, Vx as mapStreamingModeToSlackLegacyDraftStreamMode, W_ as unpinSlackMessage, Wf as clearHistoryEntriesIfEnabled, Wx as resolveSlackStreamingMode, X_ as sendMessageSlack, Yb as writeConfigFile, Yg as truncateSlackText, Zg as resolveSlackUserAllowlist, am as readSessionUpdatedAt, dr as resolveEnvelopeFormatOptions, dv as resolveTextChunkLimit, ev as resolveSlackWebClientOptions, fr as dispatchInboundMessage, gp as resolveAgentRoute, gv as parseSlackBlocksInput, hr as createReplyDispatcherWithTyping, hv as registerSlackHttpHandler, ir as shouldAckReaction, j_ as deleteSlackMessage, jn as shouldDebounceTextInbound, k_ as recordSlackThreadParticipation, kb as finalizeInboundContext, la as computeBackoff, lm as updateLastRoute, lr as formatInboundEnvelope, mv as normalizeSlackWebhookPath, nr as recordInboundSession, oS as withNormalizedTimestamp, q_ as resolveSlackThreadHistory, qf as buildMentionRegexes, rr as removeAckReactionAfterReply, sf as issuePairingChallenge, sp as shouldHandleTextCommands, ua as sleepWithAbort, us as enqueueSystemEvent, vr as hasControlCommand, xt as createConnectedChannelStatusPatch, z_ as reactSlackMessage, zf as logAckFailure } from "./auth-profiles-DqxBs6Au.js";
import { A as imageResultFromFile, L as readStringParam, N as readNumberParam, O as createActionGate, P as readReactionParams, j as jsonResult } from "./plugins-allowlist-CTOQWcBK.js";
import { C as createDedupeCache, Ft as buildChannelKeyCandidates, H as parsePluginBindingApprovalCustomId, L as buildPluginBindingResolvedText, Mt as resolveOpenProviderRuntimeGroupPolicy, Nt as warnMissingProviderGroupPolicyFallbackOnce, Pt as applyChannelMatchMeta, Rt as resolveChannelEntryMatchWithFallback, S as dispatchPluginInteractiveHandler, U as resolvePluginConversationBindingApproval, jt as resolveDefaultGroupPolicy, w as pruneMapToMaxSize, wt as evaluateGroupRouteAccessForPolicy } from "./registry-DrRO3PZ7.js";
import { n as normalizeAccountId } from "./account-id-CYKfwqh7.js";
import { d as resolveThreadSessionKeys, l as normalizeMainKey } from "./session-key-D2lHwVVl.js";
...
import { g as resolveSlackChannelId, h as parseSlackTarget, n as formatAllowlistMatchMeta } from "./plugins-CygWjihb.js";
...
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-BRfqrztE.js";
import "./ports-DeHp-MTZ.js";
import "./ports-lsof-CCbcofNf.js";
import "./ssh-tunnel-Cu8erp19.js";
import "./mime-h80iV1FL.js";
import { d as generateSecureToken } from "./delivery-queue-CfAp_q6e.js";
...
import { c as resolveCommandAuthorizedFromAuthorizers, l as resolveControlCommandGate, n as readStoreAllowFromForDmPolicy, s as resolvePinnedMainDmOwnerFromAllowlist, x as upsertChannelPairingRequest } from "./dm-policy-shared-qfNerugD.js";
...
import { a as patchAllowlistUsersInConfigEntries, i as mergeAllowlist, n as buildAllowlistResolutionSummary, o as summarizeMapping, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-Bz_rfQcP.js";
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-BgFMX_kQ.js";
import { a as normalizeSlackSlug, i as normalizeSlackAllowOwnerEntry, n as normalizeAllowList, o as resolveSlackAllowListMatch, r as normalizeAllowListLower, s as resolveSlackUserAllowed, t as allowListMatches } from "./allow-list-9IoDEYAN.js";
import { n as createDraftStreamLoop, t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-9bKl8VVH.js";
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-TQ9jUEdr.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-CkH-ZFti.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-BQk3Mn9I.js");
