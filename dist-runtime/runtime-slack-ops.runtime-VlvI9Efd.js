import { C as warn, O as getChildLogger, g as init_globals, l as init_runtime, m as danger, s as createNonExitingRuntime, v as logVerbose, x as shouldLogVerbose } from "./subsystem-CMvFcqxZ.js";
import { Ft as normalizeStringEntriesLower, Nt as normalizeHyphenSlug, Pt as normalizeStringEntries, R as resolveStorePath } from "./query-expansion-BRXofpTG.js";
import { B as init_session_key, G as resolveThreadSessionKeys, Q as normalizeAccountId, U as normalizeMainKey } from "./workspace-BPUYxH8-.js";
import "./logger-C5Xia9ob.js";
import { $c as hasSlackThreadParticipation, Aa as clearHistoryEntriesIfEnabled, Af as pruneMapToMaxSize, At as hasControlCommand, Bp as normalizeResolvedSecretInputString, Ca as createReplyPrefixOptions, Cl as createSlackWebClient, Cp as warnMissingProviderGroupPolicyFallbackOnce, Da as logInboundDrop, Df as createDedupeCache, Dp as resolveChannelEntryMatchWithFallback, Dt as resolveEnvelopeFormatOptions, Ea as logAckFailure, Ef as init_interactive, Ep as init_channel_config, Et as formatInboundEnvelope, Ff as buildPluginBindingResolvedText, Fl as resolveTextChunkLimit, Gc as resolveSlackChannelAllowlist, Gl as imageResultFromFile, Hc as truncateSlackText, If as init_conversation_binding, In as enqueueSystemEvent, Io as resolveSessionKey, Jl as readReactionParams, Ka as resolveNativeCommandsEnabled, Kl as jsonResult, Ll as normalizeSlackWebhookPath, Lu as generateSecureToken, Ma as buildMentionRegexes, Md as withNormalizedTimestamp, Na as matchesMentionWithExplicit, Oa as logTypingFailure, Of as init_dedupe, Oo as readSessionUpdatedAt, Ot as dispatchInboundMessage, Rf as parsePluginBindingApprovalCustomId, Rl as registerSlackHttpHandler, Sa as createTypingCallbacks, Sl as normalizeSlackOutboundText, Sp as resolveOpenProviderRuntimeGroupPolicy, Ta as resolveHumanDelayConfig, Tf as dispatchPluginInteractiveHandler, Ti as upsertChannelPairingRequest, Tp as buildChannelKeyCandidates, Vt as resolveChannelConfigWrites, Wa as shouldHandleTextCommands, Wc as resolveSlackUserAllowlist, Wl as createActionGate, Yl as readStringParam, _l as resolveSlackMedia, _p as init_group_access, _t as recordInboundSession, ad as loadConfig, af as resolveSlackChannelId, al as getSlackMemberInfo, ba as installRequestBodyLimitGuard, bd as resolveSlackNativeStreaming, bl as sendMessageSlack, bt as removeAckReactionAfterReply, cd as writeConfigFile, cl as listSlackReactions, cu as resolveSlackReplyToMode, dl as readSlackMessages, dt as withTimeout, el as recordSlackThreadParticipation, eo as resolveAgentRoute, fl as removeOwnSlackReactions, ft as readStoreAllowFromForDmPolicy, gl as resolveSlackAttachmentContent, hl as unpinSlackMessage, hn as sleepWithAbort, hp as evaluateGroupRouteAccessForPolicy, ht as resolveMentionGatingWithBypass, id as resolveConversationLabel, if as parseSlackTarget, il as editSlackMessage, ja as recordPendingHistoryEntryIfEnabled, jo as updateLastRoute, k as createConnectedChannelStatusPatch, ka as buildPendingHistoryContextFromMap, kf as init_map_size, kt as createReplyDispatcherWithTyping, ll as pinSlackMessage, lt as createChannelInboundDebouncer, lu as resolveSlackAppToken, ma as issuePairingChallenge, ml as sendSlackMessage, mn as computeBackoff, mt as resolvePinnedMainDmOwnerFromAllowlist, nl as deleteSlackMessage, ol as listSlackEmojis, pl as removeSlackReaction, qa as resolveNativeSkillsEnabled, ql as readNumberParam, rd as finalizeInboundContext, rl as downloadSlackFile, sl as listSlackPins, su as resolveSlackAccount, ul as reactSlackMessage, ut as shouldDebounceTextInbound, uu as resolveSlackBotToken, va as resolveAgentOutboundIdentity, vd as mapStreamingModeToSlackLegacyDraftStreamMode, vl as resolveSlackThreadHistory, vt as resolveCommandAuthorizedFromAuthorizers, wa as resolveAckReaction, wl as resolveSlackWebClientOptions, wp as applyChannelMatchMeta, xd as resolveSlackStreamingMode, xp as resolveDefaultGroupPolicy, xt as shouldAckReaction, yl as resolveSlackThreadStarter, yp as init_runtime_group_policy, yt as resolveControlCommandGate, zf as resolvePluginConversationBindingApproval, zl as parseSlackBlocksInput, zp as init_types_secrets } from "./model-selection-DTQXVq3-.js";
import "./frontmatter-D0JIibvS.js";
import "./fetch-3gMSdRzB.js";
import "./boolean-Cuaw_-7j.js";
import { a as patchAllowlistUsersInConfigEntries, c as chunkItems, d as formatAllowlistMatchMeta, f as resolveCompiledAllowlistMatch, i as mergeAllowlist, l as buildUntrustedChannelMetadata, n as buildAllowlistResolutionSummary, o as summarizeMapping, t as addAllowlistUserEntriesFromConfigEntry, u as compileAllowlist } from "./resolve-utils-CNCwVTqP.js";
import { t as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-DCmYInXT.js";
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-Bip3Bz8o.js";
import { n as createDraftStreamLoop, t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BjI5eIx1.js";
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-BaxPJZQg.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-DOXwY0Uv.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-RP3kfiEs.js");
