...
import { Cn as createAccountListHelpers, Hr as applyAccountNameToChannelSection, Kt as init_group_access, Wr as migrateBaseNameToDefaultAccount, Yt as init_runtime_group_policy, wn as init_account_helpers } from "./resolve-route-CQsiaDZO.js";
...
import { Du as buildSingleChannelSecretPromptState, Eu as addWildcardAllowFrom, Ou as mergeAllowFromEntries, Pu as promptSingleChannelSecretInput, Tu as formatDocsLink, Vu as setTopLevelChannelGroupPolicy, js as KeyedAsyncQueue } from "./auth-profiles-B70DPAVa.js";
import { f as fetchWithSsrFGuard } from "./external-content-CxoN_TKD.js";
import { v as formatResolvedUnresolvedNote, y as mapAllowlistResolutionInputs } from "./compat-CwB8x8Tr.js";
import { t as runPluginCommandWithTimeout } from "./run-command-B9zmAfEF.js";
import { n as loadMatrixCredentials, s as getMatrixRuntime, t as credentialsMatchConfig } from "./credentials-DVM78uq2.js";
...
async function resolveMatrixAuth(params) {
	...
	const { loadMatrixCredentials, saveMatrixCredentials, credentialsMatchConfig, touchMatrixCredentials } = await import("./credentials-CBPFKoub.js");
...
async function createMatrixClient(params) {
	...
	if (params.encryption) {
		...
		try {
			const { StoreType } = await import("./matrix-sdk-crypto-nodejs-B4AEefnU.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function resolveMediaDurationMs(params) {
	...
	try {
		const { parseBuffer } = await import("./lib-Db7MnEXq.js");
