import { i as compileConfigRegex, s as testRegexWithBoundedInput } from "./redact-CPjO5IzK.js";
import { a as hasErrnoCode, r as formatErrorMessage } from "./errors-CHvVoeNX.js";
import { a as registerUnhandledRejectionHandler } from "./unhandled-rejections-BUxLQs1F.js";
import { a as logVerbose, d as getChildLogger, f as getLogger, p as getResolvedLoggerSettings, s as setVerbose } from "./globals-I5DlBD2D.js";
...
import { a as setConsoleSubsystemFilter, l as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-EnljYYs1.js";
import { t as sanitizeForLog } from "./ansi-YpD2Ho3J.js";
import "./boolean-B938tROv.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-Bdj-riuG.js";
import "./warning-filter-xAwZkSAQ.js";
import { C as sleep, D as isPlainObject, E as truncateUtf16Safe, S as shortenHomePath, c as ensureDir, l as escapeRegExp, r as clamp, t as CONFIG_DIR, y as resolveUserPath } from "./utils-Do8MzKyM.js";
import { t as formatDocsLink } from "./links-Cx-Xmp-Y.js";
import { n as inheritOptionFromParent } from "./command-options-CwQM9XPT.js";
import { $ as applyPluginAutoEnable, $a as isGatewaySigusr1RestartExternallyAllowed, $b as validateConfigObjectWithPlugins, $i as listAgentsForGateway, $r as countActiveDescendantRuns, $s as isTtsProviderConfigured, $v as snapshotSessionOrigin, Aa as normalizeReplyPayloadsForDelivery, Af as requestBodyErrorToText, Ai as resolveGroupToolPolicy, Am as jsonUtf8Bytes, Ar as refreshRemoteNodeBins, As as readExecApprovalsSnapshot, Ay as cleanOldMedia, B as formatThinkingLevels, Ba as resolveMessageChannelSelection, Bb as loadConfig, Bd as callGateway, Bh as getChannelActivity, Bi as resolveAnnounceTargetFromKey, Bo as activateSecretsRuntimeSnapshot, Bp as normalizeMimeList, Bt as buildBareSessionResetPrompt, Ca as resolveOutboundTarget, Cc as markGatewayDraining, Cf as resolveAgentOutboundIdentity, Cm as readSessionMessages, Co as normalizeRequiredName, Cy as movePathToTrash, D as isCliProvider, Dc as CommandLane, Di as buildDefaultToolPolicyPipelineSteps, Dl as resolveCronStorePath, Dm as stripEnvelopeFromMessages, Dr as primeRemoteSkillsCache, Ds as normalizeExecApprovals, E as getModelRefStatus, Ea as deliverOutboundPayloads, Ec as waitForActiveTasks, Eg as normalizePollInput, Ei as applyToolPolicyPipeline, El as loadCronStore, Em as stripEnvelopeFromMessage, Eo as normalizeLegacyDeliveryInput, Er as getRemoteSkillEligibility, F as resolveDefaultModelForAgent, Fc as isDiagnosticsEnabled, Fd as emitAgentEvent, Fi as resolveIngressWorkspaceOverrideForSpawnedRun, Fp as DEFAULT_INPUT_IMAGE_MAX_BYTES, Fr as rejectNodePairing, Fs as saveExecApprovals, Ft as getLastHeartbeatEvent, Gb as readConfigFileSnapshotForWrite, Gi as applyModelOverrideToSessionEntry, Go as GATEWAY_AUTH_SURFACE_PATHS, Gr as formatZonedTimestamp, Gv as mergeSessionEntry, Hf as buildHistoryContextFromEntries, Ho as getActiveSecretsRuntimeSnapshot, Ht as setCliSessionId, I as resolveHooksGmailModel, Id as getAgentRunContext, If as resolveAgentIdentity, Ip as DEFAULT_INPUT_IMAGE_MIMES, Ir as renamePairedNode, It as onHeartbeatEvent, Ix as applyMergePatch, Jd as loadGatewayTlsRuntime$1, Jr as registerSkillsChangeListener, Jv as resolveMainSessionKeyFromConfig, Jx as resolveAgentMaxConcurrent, Jy as ensureGatewayStartupAuth, Ka as runWithModelFallback, Kb as resolveConfigSnapshotHash, Ki as loadProviderUsageSummary, Ko as evaluateGatewayAuthSurfaceStates, Ku as isWithinDir, La as maybeResolveIdLikeTarget, Lb as createConfigIO, Ld as onAgentEvent, Lf as resolveEffectiveMessagesConfig, Lo as closeTrackedBrowserTabsForSessions, Lp as DEFAULT_INPUT_TIMEOUT_MS, Lr as requestNodePairing, Ls as getPluginToolMeta, Lt as resolveIndicatorType, Lx as applyLegacyMigrations, Mc as startDiagnosticHeartbeat, Mi as runBeforeToolCallHook, Mr as setSkillsRemoteRegistry, N as resolveAllowedModelRef, Nb as migrateLegacyConfig, Nc as stopDiagnosticHeartbeat, Nd as getMachineDisplayName, Ni as createOpenClawTools, Nr as approveNodePairing, Nt as resolveHeartbeatVisibility, Of as readJsonBodyWithLimit, Ol as saveCronStore, Om as stripInlineDirectiveTagsForDisplay, Or as recordRemoteNodeInfo, P as resolveConfiguredModelRef, Pd as clearAgentRunContext, Pf as createReplyPrefixOptions, Pi as normalizeSpawnedRunMetadata, Pr as listNodePairing, Pt as emitHeartbeatEvent, Q as loadOpenClawPlugins, Qa as emitGatewayRestart, Qp as resolveAgentSessionDirs, Qs as isTtsEnabled, Qt as setGatewaySubagentRuntime, Qv as resolveMainSessionKey, Qx as DEFAULT_PROVIDER, R as resolveSubagentConfiguredModelSelection, Ra as resetDirectoryCache, Rd as registerAgentRunContext, Ro as applyBrowserProxyPaths, Rp as extractFileContentFromSource, Rr as updatePairedNodeMetadata, Rs as resolvePluginTools, Rx as ensureControlUiAllowedOriginsForNonLoopbackBind, Sa as resolveHeartbeatSenderContext, Sc as getTotalQueueSize, Si as resolveFastModeState, Sm as cleanupArchivedSessionTranscripts, So as normalizePayloadToSystemText, Ss as ensureExecApprovals, Ta as buildOutboundSessionContext, Tc as setCommandLaneConcurrency, Ti as resolveToolLoopDetectionConfig, Tm as resolveSessionTranscriptCandidates, To as parseAbsoluteTimeMs, Ts as mergeExecApprovalsSocketDefaults, U as supportsXHighThinking, Ub as readBestEffortConfig, Ui as resolveNestedAgentLane, Uo as prepareSecretsRuntimeSnapshot, Ut as runCliAgent, Uv as resolveSessionResetPolicy, Va as resolveOutboundChannelPlugin, Vb as parseConfigJson5, Vo as clearSecretsRuntimeSnapshot, Vp as resolveInputFileLimits, Vt as getCliSessionId, Vv as evaluateSessionFreshness, Wb as readConfigFileSnapshot, Wi as resolvePreferredSessionKeyForSessionIdMatches, Wo as resolveCommandSecretsFromActiveRuntimeSnapshot, Xa as consumeGatewaySigusr1RestartAuthorization, Xs as clearBootstrapSnapshotOnSessionRollover, Xt as parseVerboseOverride, Xv as resolveAgentMainSessionKey, Xy as mergeGatewayTailscaleConfig, YS as buildChannelUiCatalog, Ya as resolveFailoverReasonFromError, Yb as writeConfigFile, Ys as clearBootstrapSnapshot, Yt as applyVerboseOverride, Yv as canonicalizeMainSessionAlias, Yx as resolveSubagentMaxConcurrent, Yy as mergeGatewayAuthConfig, Za as deferGatewayRestartUntilIdle, Zi as canonicalizeSpawnedByForAgent, Zr as resolveSessionAuthProfileOverride, Zs as getTtsProvider, Zt as createPluginRuntime, Zv as resolveExplicitAgentSessionKey, Zx as DEFAULT_MODEL, Zy as resolveConfiguredSecretInputString, _a as parseTimeoutMsWithFallback, _i as waitForEmbeddedPiRunEnd, _m as normalizeSessionDeliveryFields, _o as resolveDefaultCronStaggerMs, _s as setHeartbeatWakeHandler, _x as looksLikeAvatarPath, _y as createBrowserRouteDispatcher, aC as normalizeReasoningLevel, aS as resolveUserTimezone, aa as resolveSessionModelRef, ac as setTtsEnabled, ao as consumeRestartSentinel, as as matchSystemRunApprovalBinding, bS as resolveWhatsAppAccount, ba as resolveOutboundSessionRoute, bc as getActiveTaskCount, bm as archiveSessionTranscripts, bo as normalizeOptionalSessionKey, bp as getAcpSessionManager, br as stopSubagentsForRequester, bs as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, cC as normalizeVerboseLevel, cc as OPENAI_TTS_MODELS, cm as saveSessionStore, cp as normalizeSendPolicy, cs as toSystemRunApprovalMismatchError, dS as stripHeartbeatToken, da as normalizeGroupActivation, db as extractTextFromChatContent, do as writeRestartSentinel, dp as runGlobalGatewayStopSafely, ds as isSystemEventContextChanged, ea as listSessionsFromStore, ec as resolveTtsApiKey, ed as handleReset, em as extractDeliveryInfo, eo as markGatewaySigusr1RestartHandled, es as resolveSystemRunApprovalRequestContext, ex as OpenClawSchema, fS as HEARTBEAT_TOKEN, fi as runEmbeddedPiAgent, fo as normalizeHttpWebhookUrl, fr as dispatchInboundMessage, fs as peekSystemEventEntries, gd as resolveAssistantAvatarUrl, gi as waitForActiveEmbeddedRuns, gm as mergeDeliveryContext, go as resolveCronStaggerMs, gr as getTotalPendingReplies, gs as requestHeartbeatNow, gx as isAvatarImageDataUrl, hS as isSilentReplyText, hd as normalizeControlUiBasePath, hi as getActiveEmbeddedRunCount, hm as deliveryContextFromSession, ho as normalizeCronStaggerMs, hs as areHeartbeatsEnabled, hx as isAvatarHttpUrl, iC as normalizeFastMode, iS as resolveCronStyleNow, ia as resolveGatewaySessionStoreTarget, ic as resolveTtsProviderOrder, ii as listDescendantRunsForRequester, im as loadSessionStore, in as formatHelpExamples, io as triggerOpenClawRestart, is as buildSystemRunApprovalBinding, j as normalizeModelSelection, ji as resolveSubagentToolPolicy, jp as loadModelCatalog, jr as removeRemoteNodeInfo, ki as resolveEffectiveToolPolicy, km as stripInlineDirectiveTagsFromMessageForDisplay, kr as refreshRemoteBinsForConnectedNodes, lS as isHeartbeatContentEffectivelyEmpty, la as computeBackoff, lc as OPENAI_TTS_VOICES, lo as summarizeRestartSentinel, lp as resolveSendPolicy, md as buildControlUiAvatarUrl, mi as abortEmbeddedPiRun, mo as normalizeCronJobPatch, mr as createReplyDispatcher, mx as AVATAR_MAX_BYTES, nC as formatXHighModelHint, nS as resolveHeartbeatReplyPayload, na as loadSessionEntry, nc as resolveTtsConfig, ni as initSubagentRegistry, nn as withProgress, no as setGatewaySigusr1RestartPolicy, oC as normalizeThinkLevel, oc as setTtsProvider, oo as formatDoctorNonInteractiveHint, os as missingSystemRunApprovalBinding, pS as SILENT_REPLY_TOKEN, pd as CONTROL_UI_AVATAR_PREFIX, po as normalizeCronJobCreate, pv as handleSlackHttpRequest, px as parseByteSize, qr as getSkillsSnapshotVersion, qv as setSessionRuntimeModel, qx as buildTalkConfigResponse, rC as normalizeElevatedLevel, rS as appendCronStyleCurrentTimeLine, ra as migrateAndPruneGatewaySessionStoreKey, rc as resolveTtsPrefsPath, rm as archiveRemovedSessionTranscripts, ro as setPreRestartDeferralCheck, rs as resolveSystemRunCommandRequest, sC as normalizeUsageDisplay, sa as lookupContextTokens, sc as textToSpeech, so as formatRestartSentinelMessage, tS as resolveAgentTimeoutMs, ta as loadCombinedSessionStoreForGateway, tc as resolveTtsAutoMode, tm as parseSessionThreadInfo, to as scheduleGatewaySigusr1Restart, ts as resolveSystemRunApprovalRuntimeContext, uS as resolveHeartbeatPrompt$1, ua as sleepWithAbort, ui as clearSessionQueues, um as updateSessionStore, up as getGlobalHookRunner, us as enqueueSystemEvent, vp as buildChannelAccountBindings, vs as setHeartbeatsEnabled, vx as applyConfigOverrides, vy as createBrowserControlContext, w as buildAllowedModelSet, wa as resolveSessionDeliveryTarget, wc as resetAllLanes, wf as resolveAgentAvatar, wm as readSessionPreviewItemsFromTranscript, xa as resolveHeartbeatDeliveryTarget, xc as getQueueSize, xi as resolveBootstrapWarningSignaturesSeen, xm as capArrayByJsonBytes, xo as normalizeOptionalText$1, ya as ensureOutboundSessionEntry, yc as enqueueCommandInLane, ym as archiveFileOnDisk, yo as normalizeOptionalAgentId, yr as isAbortRequestText, ys as resolveHeartbeatReasonKind, yy as startBrowserControlServiceFromConfig, z as resolveThinkingDefault, zi as readLatestAssistantReply, zo as persistBrowserProxyFiles, zp as extractImageContentFromSource, zr as verifyNodeToken, zt as getReplyFromConfig } from "./auth-profiles-DqxBs6Au.js";
import { C as fetchWithSsrFGuard, D as ToolInputError, Q as SsrFBlockedError, U as estimateBase64DecodedBytes, a as detectSuspiciousPatterns, at as normalizeSecretInput, i as buildSafeExternalPrompt, o as getHookType, s as isExternalHookSession } from "./plugins-allowlist-CTOQWcBK.js";
import { D as canonicalizePathForSecurity, E as PROTECTED_PLUGIN_ROUTE_PREFIXES, O as canonicalizePathVariant, Q as normalizeChannelId, X as getChannelPlugin, Z as listChannelPlugins, _ as resolveActivePluginHttpRouteRegistry, cn as createInternalHookEvent, ln as registerInternalHook, m as releasePinnedPluginHttpRouteRegistry, p as pinActivePluginHttpRouteRegistry, sn as clearInternalHooks, t as CHANNEL_IDS, u as getActivePluginRegistry, un as triggerInternalHook, y as createEmptyPluginRegistry } from "./registry-DrRO3PZ7.js";
import { n as normalizeAccountId$1, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-CYKfwqh7.js";
import { S as parseAgentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, v as isAcpSessionKey, x as isSubagentSessionKey, y as isCronRunSessionKey } from "./session-key-D2lHwVVl.js";
...
import { n as isTestDefaultMemorySlotDisabled } from "./config-state-Dtu4rsXl.js";
import { a as openBoundaryFileSync, i as openBoundaryFile, t as matchesSkillFilter, u as isNotFoundPathError } from "./filter-Qe6Ch68_.js";
import { n as sameFileIdentity, t as openVerifiedFileSync } from "./safe-open-sync-BmiTH5-j.js";
import "./manifest-registry-CA0yK887.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-0nFkqMDM.js";
import { $ as validateExecApprovalsNodeSetParams, $t as buildDeviceAuthPayloadV3, A as validateConfigPatchParams, At as validateSessionsUsageParams, B as validateCronRunsParams, Bt as validateWebLoginStartParams, C as validateChannelsStatusParams, Cn as GATEWAY_CLIENT_CAPS, Ct as validateSessionsCompactParams, D as validateChatSendParams, Dn as hasGatewayClientCap, Dt as validateSessionsPreviewParams, E as validateChatInjectParams, En as GATEWAY_CLIENT_NAMES, Et as validateSessionsPatchParams, F as validateConnectParams, Ft as validateTalkConfigParams, G as validateDevicePairRejectParams, Gt as validateWizardStatusParams, H as validateCronUpdateParams, Ht as validateWizardCancelParams, I as validateCronAddParams, It as validateTalkModeParams, J as validateDeviceTokenRotateParams, Jt as parseSessionLabel, K as validateDevicePairRemoveParams, Kt as ErrorCodes, L as validateCronListParams, Lt as validateToolsCatalogParams, M as validateConfigSchemaLookupResult, Mt as validateSkillsInstallParams, N as validateConfigSchemaParams, Nt as validateSkillsStatusParams, O as validateConfigApplyParams, On as normalizeGatewayClientMode, Ot as validateSessionsResetParams, P as validateConfigSetParams, Pt as validateSkillsUpdateParams, Q as validateExecApprovalsNodeGetParams, Qt as buildDeviceAuthPayload, R as validateCronRemoveParams, Rt as validateUpdateRunParams, S as validateChannelsLogoutParams, St as validateSendParams, T as validateChatHistoryParams, Tn as GATEWAY_CLIENT_MODES, Tt as validateSessionsListParams, U as validateDevicePairApproveParams, Ut as validateWizardNextParams, V as validateCronStatusParams, Vt as validateWebLoginWaitParams, W as validateDevicePairListParams, Wt as validateWizardStartParams, X as validateExecApprovalResolveParams, Xt as resolveAuthConnectErrorDetailCode, Y as validateExecApprovalRequestParams, Yt as ConnectErrorDetailCodes, Z as validateExecApprovalsGetParams, Zt as resolveDeviceAuthConnectErrorDetailCode, _ as validateAgentsFilesGetParams, _t as validatePollParams, an as publicKeyRawBase64UrlFromPem, at as validateNodeInvokeParams, b as validateAgentsListParams, bn as normalizeMessageChannel, bt as validateSecretsResolveParams, c as isNodeRoleMethod, ct as validateNodePairApproveParams, d as formatValidationErrors, dn as rawDataToString, dt as validateNodePairRequestParams, en as normalizeDeviceAuthScopes, et as validateExecApprovalsSetParams, f as validateAgentIdentityParams, fn as INTERNAL_MESSAGE_CHANNEL, ft as validateNodePairVerifyParams, g as validateAgentsDeleteParams, gt as validateNodeRenameParams, h as validateAgentsCreateParams, hn as isGatewayMessageChannel, ht as validateNodePendingEnqueueParams, i as PAIRING_SCOPE$1, in as normalizeDevicePublicKeyBase64Url, it as validateNodeEventParams, j as validateConfigSchemaLookupParams, jt as validateSkillsBinsParams, k as validateConfigGetParams, kt as validateSessionsResolveParams, lt as validateNodePairListParams, m as validateAgentWaitParams, mn as isGatewayCliClient, mt as validateNodePendingDrainParams, n as APPROVALS_SCOPE$1, nn as deriveDeviceIdFromPublicKey, nt as validateModelsListParams, o as WRITE_SCOPE, ot as validateNodeInvokeResultParams, p as validateAgentParams, pn as isDeliverableMessageChannel, pt as validateNodePendingAckParams, q as validateDeviceTokenRevokeParams, qt as errorShape, rn as loadOrCreateDeviceIdentity, rt as validateNodeDescribeParams, s as authorizeOperatorScopesForMethod, sn as verifyDeviceSignature, st as validateNodeListParams, t as ADMIN_SCOPE$3, tt as validateLogsTailParams, un as normalizeInputProvenance, ut as validateNodePairRejectParams, v as validateAgentsFilesListParams, vn as isWebchatClient, vt as validatePushTestParams, w as validateChatAbortParams, wn as GATEWAY_CLIENT_IDS, wt as validateSessionsDeleteParams, x as validateAgentsUpdateParams, xt as validateSecretsResolveResult, y as validateAgentsFilesSetParams, yt as validateRequestFrame, z as validateCronRunParams, zt as validateWakeParams } from "./method-scopes-DDb5C1xl.js";
import { t as formatCliCommand } from "./command-format-CS805JpF.js";
import { I as normalizeWhatsAppTarget, U as resolveChannelDefaultAccountId } from "./plugins-CygWjihb.js";
import "./brew-BBTHZkpM.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceSetupCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-tkfLX5MZ.js";
import { i as logWarn, t as logDebug } from "./logger-BwHrL168.js";
...
import { n as VERSION, o as resolveRuntimeServiceVersion } from "./version-Dubp0iGu.js";
import { A as normalizeRateLimitClientIp, C as readGatewayPasswordEnv, D as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, E as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, F as enableTailscaleServe, L as getTailnetHostname, M as disableTailscaleFunnel, N as disableTailscaleServe, O as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, P as enableTailscaleFunnel, d as authorizeHttpGatewayConnect, f as authorizeWsControlUiGatewayConnect, j as safeEqualSecret, k as createAuthRateLimiter, m as resolveGatewayAuth, p as isLocalDirectRequest, u as assertGatewayAuthConfigured, w as readGatewayTokenEnv } from "./config-VO8zzMSR.js";
import { G as collectExplicitAllowlist, Q as PROFILE_OPTIONS, Z as resolveToolProfilePolicy, et as listCoreToolSections, k as cleanStaleLockFiles, q as mergeAlsoAllowPolicy, t as listAgentWorkspaceDirs, tt as resolveCoreToolProfiles } from "./workspace-dirs-D1oDbsnN.js";
import { i as parseDurationMs, n as getMemorySearchManager, r as resolveMemoryBackendConfig } from "./search-manager-DIDe1qlM.js";
import "./ip-Cdtea-sx.js";
import { _ as pickPrimaryTailnetIPv6, a as isLoopbackHost, c as isValidIPv4, d as resolveClientIp, f as resolveGatewayBindHost, g as pickPrimaryTailnetIPv4, i as isLoopbackAddress, l as normalizeHostHeader, m as resolveRequestClientIp, p as resolveGatewayListenHosts, r as isLocalishHost, s as isTrustedProxyAddress, t as normalizeDeviceMetadataForAuth, u as pickPrimaryLanIPv4 } from "./device-metadata-normalization-a2oQYp64.js";
import { M as readLocalFileSafely, P as writeFileWithinRoot, T as SafeOpenError, k as openFileWithinRoot } from "./query-expansion-CcKf_qr0.js";
import { d as isKnownSecretTargetId } from "./command-secret-targets-7sQA1Mwd.js";
import { f as hasBinary } from "./frontmatter-UI6LO8NQ.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-SF-nwQor.js";
import { o as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-eb8njEg8.js";
import { c as isPidAlive, r as isRestartEnabled } from "./commands-BRfqrztE.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-YN5WLIkL.js";
import { a as loadSessionUsageTimeSeries, c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-DeAwWk6A.js";
import "./fetch-CzYOE42F.js";
import "./identity-file-Dh-pAEVE.js";
import { v as readChannelAllowFromStoreSync } from "./dm-policy-shared-qfNerugD.js";
...
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-BbDrm470.js";
import { c as parseProcCmdline, s as isGatewayArgv } from "./service-DC_Pq39i.js";
...
import { n as addGatewayServiceCommands } from "./daemon-cli-BQENvUtu.js";
...
import { t as readSecretFromFile } from "./secret-file-DBR6Ect0.js";
import { r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-DDJhum8r.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-CKQ4DI9B.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-Blycw4Da.js";
import "./table-BFTFgs1v.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Pi2PaJiQ.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Dgeu2DcV.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-f_ogmGQk.js";
import { f as pickGatewaySelfPresence, t as getStatusSummary } from "./status.summary-BuyxSRkJ.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-Cn7gQrEE.js";
import { i as styleHealthChannelLine, n as getHealthSnapshot, t as formatHealthChannelLines } from "./health-D7ZxsaPF.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-AIHB76qG.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-0PfuVfLg.js";
import { t as resolveExecApprovalSessionTarget } from "./exec-approval-session-target-HLnENtKt.js";
import { a as resolveNpmChannelTag, n as compareSemverStrings, p as normalizeUpdateChannel, t as checkUpdateStatus } from "./update-check-CC-MBAhO.js";
import "./setup.secret-input-DnnKHt6m.js";
import { t as runSetupWizard } from "./setup-ihzmDcnw.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-oVEicfhp.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-BzhVeN61.js";
import { g as computePreviousRunAtMs, h as computeNextRunAtMs, m as coerceFiniteScheduleNumber, p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-DMn8YpUs.js";
import { i as loadAgentIdentity, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-i0GrLAwv.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-BpJOJ1gA.js";
import { t as buildChannelAccountSnapshot } from "./status-YOIg2wWK.js";
import "./status-CE7uhuUt.js";
...
import { t as resolveAllowedAgentIds } from "./hooks-policy-DI042Efx.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CnZ_Yvu6.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-DziU9j0v.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-BNKcL56D.js";
...
function loadSshConfigModule() {
	sshConfigModulePromise ??= import("./ssh-config-Bg6mOaEg.js");
	return sshConfigModulePromise;
}
function loadSshTunnelModule() {
	sshTunnelModulePromise ??= import("./ssh-tunnel-C9GVwpuc.js");
...
//#endregion
//#region src/cron/hooks.ts
const DEFAULT_PRIORITY$1 = 10;
const HOOK_TIMEOUT_MS = 1e4;
/**
...
*/
function loadHookEntries(hookPoint, cronConfig, job, workflow = "cron") {
	const skipGlobal = job.hooks?.skipGlobal?.includes(hookPoint) ?? false;
	const globalEntries = [];
	if (!skipGlobal) {
		const raw = cronConfig?.hooks?.[hookPoint];
		if (raw) {
			for (const entry of raw) {if (matchesFilter(entry, job, workflow)) globalEntries.push({
				...entry,
				priority: entry.priority ?? DEFAULT_PRIORITY$1
			});}
		}
	}
	const jobScripts = job.hooks?.[hookPoint];
	const jobEntries = [];
	if (jobScripts) {for (const script of jobScripts) {
		if (!isValidJobHookPath(script)) continue;
		jobEntries.push({
			script,
...
*/
async function runCronHooks(hookPoint, ctx, entries) {
	if (entries.length === 0) {return { aborted: false };}
	for (const entry of entries) {try {
		...
		const timeout = createTimeout(entry.timeoutMs ?? HOOK_TIMEOUT_MS);
		let result;
		try {
		...
		if (hookPoint === "beforeRun" && isAbortResult(result)) {
			const reason = "reason" in result && typeof result.reason === "string" ? result.reason : "aborted by hook";
			ctx.log.info({
				hookPoint,
				script: entry.script,
				reason
		...
		(err instanceof Error && (err.message.includes("Cannot find module") || err.message.includes("MODULE_NOT_FOUND")) ? ctx.log.warn : ctx.log.error).call(ctx.log, {
			hookPoint,
			script: entry.script,
			err: String(err)
...
function isAbortResult(value) {
	return value != null && typeof value === "object" && "abort" in value && Boolean(value.abort);
}
function matchesFilter(entry, job, workflow) {
	const f = entry.filter;
	if (!f) {return true;}
	if (f.workflow && f.workflow.length > 0 && !f.workflow.includes(workflow)) {return false;}
	if (f.jobId && f.jobId.length > 0 && !f.jobId.includes(job.id)) {return false;}
	if (f.jobName && f.jobName.length > 0) {
		const nameLower = job.name.toLowerCase();
		if (!f.jobName.some((pattern) => nameLower.includes(pattern.toLowerCase()))) {return false;}
	}
	if (f.agentId && f.agentId.length > 0 && (!job.agentId || !f.agentId.includes(job.agentId))) {return false;}
	return true;
}
async function loadHookModule(scriptPath, basePath) {
	...
	return resolveFunctionModuleExport({
		mod: await importFileModule({
			modulePath: path.isAbsolute(expanded) ? expanded : path.resolve(basePath ?? process.cwd(), expanded),
			cacheBust: true
		}),
...
*/
function isValidJobHookPath(scriptPath) {
	if (path.isAbsolute(scriptPath)) {return false;}
	if (path.normalize(scriptPath).startsWith("..")) {return false;}
	return true;
}
function createTimeout(ms) {
	...
	return {
		promise: new Promise((_, reject) => {
			id = setTimeout(() => reject(/* @__PURE__ */ new Error(`cron hook timed out after ${ms}ms`)), ms);
		}),
...
function assertSupportedJobSpec(job) {
	...
	if (isIsolatedLike && job.payload.kind !== "agentTurn" && job.payload.kind !== "script") {throw new Error("isolated/current/session cron jobs require payload.kind=\"agentTurn\" or \"script\"");}
}
...
function mergeCronPayload(existing, patch) {
	...
	if (patch.kind === "script") {
		...
		return {
			kind: "script",
			command: typeof patch.command === "string" && patch.command ? patch.command : existing.command,
	...
	if (existing.kind !== "agentTurn" || patch.kind !== "agentTurn") {return buildPayloadFromPatch(patch);}
	const next = { ...existing };
...
function buildPayloadFromPatch(patch) {
	...
	if (patch.kind === "script") {
		if (typeof patch.command !== "string" || patch.command.length === 0) {throw new Error("cron.update payload.kind=\"script\" requires command");}
		return {
			kind: "script",
	...
	if (patch.kind !== "agentTurn") {throw new Error(`cron.update unsupported payload.kind: ${String(patch.kind)}`);}
...
//#endregion
//#region src/cron/exec-script.ts
/**
...
*/
async function execCronScript(params) {
	const { payload, basePath, abortSignal } = params;
	if (abortSignal?.aborted) {return {
		status: "error",
		error: "script execution aborted (timeout)"
	};}
	...
	if (!fs.existsSync(resolvedCommand)) {return {
		status: "error",
	...
	if (payload.cwd && !fs.existsSync(resolvedCwd)) {return {
		status: "error",
	...
	return new Promise((resolve) => {
		...
		const child = execFile(execCmd, execArgs, {
			env: childEnv,
			cwd: resolvedCwd,
...
*/
function resolveScriptPath(input, basePath) {
...
function resolveCronJobTimeoutMs(job) {
	const configuredTimeoutMs = (job.payload.kind === "agentTurn" || job.payload.kind === "script") && typeof job.payload.timeoutSeconds === "number" && Number.isFinite(job.payload.timeoutSeconds) ? Math.floor(job.payload.timeoutSeconds * 1e3) : void 0;
...
async function onTimer(state) {
	...
	try {
		...
		const runDueJob = async (params) => {
			...
			const makeHookCtx = (hookPoint, extra) => ({
				hookPoint,
				workflow: "cron",
				job: {
					id: job.id,
			...
			if (beforeEntries.length > 0) {
				...
				if (beforeResult.aborted) {
					...
					if (afterRunEntries.length > 0) {await runCronHooks("afterRun", makeHookCtx("afterRun", {
						status: "skipped",
			...
			if (coreResult.status === "ok") {
				...
				if (entries.length > 0) {await runCronHooks("afterComplete", makeHookCtx("afterComplete", {
					status: "ok",
					durationMs
				}), entries);}
			} else if (coreResult.status === "error") {
				const entries = loadHookEntries("onFailure", state.deps.cronConfig, job);
				if (entries.length > 0) {await runCronHooks("onFailure", makeHookCtx("onFailure", {
...
async function executeJobCore(state, job, abortSignal) {
	...
	if (job.payload.kind === "script") {
		...
		const scriptResult = await execCronScript({
			payload: job.payload,
			basePath,
			abortSignal
		});
		const scriptDeliveryPlan = resolveCronDeliveryPlan(job);
		if (scriptResult.status === "ok" && scriptDeliveryPlan.requested && scriptResult.summary && state.deps.announceScriptOutput) {try {
...
function buildGatewayCronService(params) {
	...
	const cron = new CronService({
		...
		announceScriptOutput: async ({ job, text }) => {
			const delivery = job.delivery;
			if (!delivery || delivery.mode !== "announce") {return {
				delivered: false,
...
const chatHandlers = {
	...
	"chat.send": async ({ params, respond, context, client }) => {
		...
		try {
			...
			const commandBody = p.thinking && trimmedMessage && !trimmedMessage.startsWith("/") ? `/think ${p.thinking} ${parsedMessage}` : parsedMessage;
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BHh_KlSW.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) {return;}
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-DZXr4Iba.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CpRYEg46.js");
...
function mergeActionIntoArgsIfSupported(params) {
	...
	if (!(schemaObj && typeof schemaObj === "object" && schemaObj.properties && "action" in schemaObj.properties)) {return args;}
	return {
		...args,
		action
	};
...
function createGatewayBroadcaster(params) {
	...
	const broadcastInternal = (event, payload, opts, targetConnIds) => {
		...
		const eventSeq = targetConnIds ? void 0 : ++seq;
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) {(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-D8HOQPGz.js");
		const { deliverOutboundPayloads } = await import("./deliver-BCMRrmLZ.js");
