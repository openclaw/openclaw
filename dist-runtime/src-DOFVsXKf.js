...
import { Bf as logTypingFailure, Gf as recordPendingHistoryEntryIfEnabled, Hf as buildPendingHistoryContextFromMap, Nf as createReplyPrefixOptions, Td as resolveChannelMediaMaxBytes, Uf as clearHistoryEntriesIfEnabled, Yn as resolveInboundSessionEnvelopeContext, Zn as resolveMentionGating, cf as createScopedPairingAccess, jf as createTypingCallbacks, wf as DEFAULT_WEBHOOK_MAX_BODY_BYTES, zf as logInboundDrop } from "./auth-profiles-DAOR1fRn.js";
import { C as fetchWithSsrFGuard } from "./plugins-allowlist-E4LSkJ7R.js";
import { Jt as resolveSenderScopedGroupPolicy, Kt as evaluateSenderGroupAccessForPolicy, Qt as resolveDefaultGroupPolicy } from "./registry-ep1yQ6WN.js";
...
import { n as formatAllowlistMatchMeta } from "./plugins-DC9n978g.js";
...
import { a as resolveDmGroupAccessWithLists, n as readStoreAllowFromForDmPolicy, o as resolveEffectiveAllowFromLists, u as resolveDualTextControlCommandGate } from "./dm-policy-shared-QWD8iFx0.js";
...
import { p as dispatchReplyFromConfigWithSettledDispatcher } from "./compat-aC6dpiEb.js";
import { r as keepHttpServerTaskAlive } from "./inbound-envelope-aY_xfQcC.js";
...
import { C as resolveMediaSsrfPolicy, E as safeHostForUrl, F as resolveMSTeamsUserAllowlist, O as resolveMSTeamsCredentials, P as resolveMSTeamsChannelAllowlist, S as resolveAttachmentFetchPolicy, T as safeFetchWithPolicy, _ as isDownloadableAttachment, b as isUrlAllowed, c as createMSTeamsAdapter, d as GRAPH_ROOT, f as IMG_SRC_RE, g as inferPlaceholder, h as extractInlineImageCandidates, l as loadMSTeamsSdkWithAuth, m as extractHtmlFromAttachment, p as applyAuthorizationHeaderForUrl, t as getMSTeamsRuntime, u as ATTACHMENT_TAG_RE, v as isLikelyImageAttachment, w as resolveRequestUrl, x as normalizeContentType, y as isRecord } from "./runtime-DP3qTCtk.js";
import { _ as createMSTeamsConversationStoreFs, a as buildConversationReference, c as withRevokedProxyFallback, d as buildFileInfoCard, f as parseFileConsentInvoke, g as formatUnknownError, h as formatMSTeamsSendErrorHint, l as getPendingUpload, m as classifyMSTeamsSendError, o as renderReplyPayloadsToMessages, p as uploadToConsentUrl, s as sendMSTeamsMessages, u as removePendingUpload, v as createMSTeamsPollStoreFs, y as extractMSTeamsPollVote } from "./probe-B_3iQ9am.js";
import { a as resolveMSTeamsRouteConfig, i as resolveMSTeamsReplyPolicy, n as resolveMSTeamsAllowlistMatch, t as isMSTeamsGroupAllowed } from "./policy-CTy7KIcp.js";
