...
import { i as formatUncaughtError, r as formatErrorMessage } from "./errors-CHvVoeNX.js";
...
import { c as createNonExitingRuntime, l as defaultRuntime, t as createSubsystemLogger } from "./subsystem-EnljYYs1.js";
import { $c as parseModelCallbackData, $l as normalizeForwardedContext, $m as resolveThreadBindingSpawnPolicy, $n as resolveMentionGatingWithBypass, A_ as resolveGlobalSingleton, Ac as logWebhookProcessed, Al as isRecoverableTelegramNetworkError, Ap as findModelInCatalog, Bb as loadConfig, Bc as isTelegramExecApprovalClientEnabled, Bf as logInboundDrop, Bl as buildGroupLabel, Cl as sendTypingTelegram, Cr as formatModelsAvailableHeader, Dg as buildOutboundMediaLoadOptions, Du as resolveTelegramAccount, F as resolveDefaultModelForAgent, Fa as fireAndForgetHook, Fc as isDiagnosticsEnabled, Ff as resolveAckReaction, Fl as markdownToTelegramChunks, Gc as buildExecApprovalPendingReplyPayload, Gi as applyModelOverrideToSessionEntry, Gl as buildTelegramParentPeer, Hc as resolveTelegramExecApprovalTarget, Hl as buildSenderName, Il as markdownToTelegramHtml, Jf as matchesMentionWithExplicit, Jl as describeReplyTarget, Jx as resolveAgentMaxConcurrent, Kf as recordPendingHistoryEntryIfEnabled, Kl as buildTelegramThreadParams, Ll as renderTelegramHtmlText, Lv as resolveChannelGroupPolicy, Ma as toInternalMessageSentContext, Mc as startDiagnosticHeartbeat, Mf as createTypingCallbacks, Ml as isTelegramClientRejection, Mp as modelSupportsVision, My as saveMediaBuffer, Na as toPluginMessageContext, Nc as stopDiagnosticHeartbeat, Nl as isTelegramPollingNetworkError, Of as readJsonBodyWithLimit, Pa as toPluginMessageSentEvent, Pf as createReplyPrefixOptions, Pl as tagTelegramNetworkError, Qc as getModelsPageSize, Ql as hasBotMention, Qm as resolveThreadBindingMaxAgeMsForChannel, Qr as resolveChannelConfigWrites, Rc as getTelegramExecApprovalApprovers, Rl as wrapFileReferencesInHtml, Rv as resolveChannelGroupRequireMention, Sr as buildModelsProviderData, Tl as resolveTelegramVoiceSend, Tr as listSkillCommandsForAgents, Uc as shouldEnableTelegramExecApprovalButtons, Uf as buildPendingHistoryContextFromMap, Ul as buildTelegramGroupFrom, Up as formatReasoningMessage, Vc as resolveTelegramExecApprovalConfig, Vf as logTypingFailure, Vh as recordChannelActivity, Vl as buildSenderLabel, Wc as shouldSuppressLocalTelegramExecApprovalPrompt, Wf as clearHistoryEntriesIfEnabled, Wl as buildTelegramGroupPeerId, Wt as resolveStoredModelOverride, Xc as buildProviderKeyboard, Xf as buildCommandTextFromArgs, Xl as extractTelegramLocation, Xm as resolveThreadBindingIdleTimeoutMsForChannel, Yb as writeConfigFile, Yc as buildModelsKeyboard, Yl as expandTextLinks, Yr as isBtwRequestText, Zc as calculateTotalPages, Zf as findCommandByNativeName, Zl as getTelegramTextParts, _p as resolveInboundLastRouteSessionKey, am as readSessionUpdatedAt, an as createTelegramThreadBindingManager, ap as resolveCommandArgMenu, ar as dispatchReplyWithBufferedBlockDispatcher, au as resolveTelegramStreamMode, av as getAgentScopedMediaLocalRoots, bl as sendMessageTelegram, cb as stripReasoningTagsFromText, cr as resolveInboundDebounceMs, cu as normalizeAllowFrom, cv as resolveMarkdownTableMode, dl as buildInlineKeyboard, dr as resolveEnvelopeFormatOptions, du as formatLocationText, dv as resolveTextChunkLimit, dx as resolveTelegramCustomCommands, el as resolveModelSelection, ep as listNativeCommandSpecs, eu as resolveTelegramDirectPeerId, fu as toLocationContext, gl as editMessageTelegram, gp as resolveAgentRoute, hl as editMessageReplyMarkupTelegram, hp as deriveLastRoutePolicy, hu as resolveTelegramInlineButtonsScope, im as loadSessionStore, ir as shouldAckReaction, iu as resolveTelegramReplyId, ja as buildCanonicalSentMessageHookContext, jc as logWebhookReceived, jl as isSafeToRetrySendError, jn as shouldDebounceTextInbound, jp as loadModelCatalog, kb as finalizeInboundContext, kc as logWebhookError, kl as wasSentByBot, la as computeBackoff, lb as findCodeRegions, ll as getCachedSticker, lr as formatInboundEnvelope, lu as normalizeDmAllowFromWithStore, lv as chunkMarkdownTextWithMode, lx as TELEGRAM_COMMAND_NAME_PATTERN, mp as buildAgentSessionKey, np as normalizeCommandBody, nr as recordInboundSession, nu as resolveTelegramGroupAllowFromContext, nv as loadWebMedia, oa as buildCommandsMessagePaginated, ol as cacheSticker, ou as resolveTelegramThreadSpec, ov as MediaFetchError, pu as withTelegramApiErrorLogging, qf as buildMentionRegexes, ql as buildTypingThreadParams, rp as parseCommandArgs, rr as removeAckReactionAfterReply, ru as resolveTelegramMediaPlaceholder, sf as issuePairingChallenge, sl as describeStickerImage, sm as resolveSessionStoreEntry, sr as createInboundDebouncer, su as isSenderAllowed, sv as fetchRemoteMedia, tp as listNativeCommandSpecsForConfig, tr as waitForAbortSignal, tu as resolveTelegramForumThreadId, ua as sleepWithAbort, ub as isInsideCode, um as updateSessionStore, up as getGlobalHookRunner, us as enqueueSystemEvent, uu as resolveSenderAllowMatch, uv as resolveChunkMode, ux as normalizeTelegramCommandName, vr as hasControlCommand, wp as resolveCommandAuthorization, wr as buildCommandsPaginationKeyboard, yr as isAbortRequestText, zc as isTelegramExecApprovalApprover, zf as logAckFailure, zl as splitTelegramCaption } from "./auth-profiles-DqxBs6Au.js";
import { B as isPluginOwnedSessionBindingRecord, C as createDedupeCache, G as getSessionBindingService, H as parsePluginBindingApprovalCustomId, L as buildPluginBindingResolvedText, M as getPluginCommandSpecs, Mt as resolveOpenProviderRuntimeGroupPolicy, P as matchPluginCommand, S as dispatchPluginInteractiveHandler, Tt as evaluateMatchedGroupAccessForPolicy, U as resolvePluginConversationBindingApproval, Wt as retryAsync, cn as createInternalHookEvent, j as executePluginCommand, un as triggerInternalHook } from "./registry-DrRO3PZ7.js";
import { n as normalizeAccountId } from "./account-id-CYKfwqh7.js";
import { S as parseAgentSessionKey, d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-D2lHwVVl.js";
import { i as fetchWithTimeout } from "./fetch-DM2X1MUS.js";
import { a as resolveAgentDir, f as resolveDefaultAgentId } from "./agent-scope-tkfLX5MZ.js";
...
import { n as resolveTelegramTransport, o as makeProxyFetch, r as shouldRetryTelegramIpv4Fallback, t as resolveTelegramFetch } from "./fetch-CzYOE42F.js";
import { l as formatDurationPrecise } from "./account-summary-DtY_0EC1.js";
import { _ as readChannelAllowFromStore, c as resolveCommandAuthorizedFromAuthorizers, d as firstDefined, l as resolveControlCommandGate, s as resolvePinnedMainDmOwnerFromAllowlist, x as upsertChannelPairingRequest } from "./dm-policy-shared-qfNerugD.js";
import { n as resolveConfiguredAcpRoute, t as ensureConfiguredAcpRouteReady } from "./persistent-bindings.route-jQBcgRV1.js";
import { t as recordInboundSessionMetaSafe } from "./session-meta-BHQWT2ZN.js";
import { n as readTelegramUpdateOffset, r as writeTelegramUpdateOffset } from "./update-offset-store-CeWMtw_s.js";
...
import { a as createOperatorApprovalsGatewayClient, i as createStatusReactionController, n as DEFAULT_EMOJIS, t as createFinalizableDraftLifecycle } from "./draft-stream-controls-DE4_njDv.js";
